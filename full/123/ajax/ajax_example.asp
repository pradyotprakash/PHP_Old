...
<style>a.menu_ajax_example{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>AJAX <span class="color_h1">Example</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ajax_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ajax_xmlhttprequest_create.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">To understand how AJAX works, we will create a small AJAX application:</p>
...
<br><a target="_blank" href="tryit.asp?filename=tryajax_first" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The AJAX application above contains one div section and one 
button.</p>
<p>The div 
section will be used to display information returned from a server.  
The button calls a function named loadXMLDoc(), if it is clicked:</p>
...
<p>Next, add a &lt;script&gt; tag to the page's head section. The script section contains the loadXMLDoc() function: </p>
...
<p>The next chapters will explain how AJAX works.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ajax_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ajax_xmlhttprequest_create.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_example.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_example.asp#top" target="_top">TOP</a> |
		<a href="ajax_example.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
