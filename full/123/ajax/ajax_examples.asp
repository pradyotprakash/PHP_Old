...
<style>a.menu_ajax_examples{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>AJAX <span class="color_h1">Examples</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ajax_xmlfile.asp">&laquo; Previous</a></div>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryajax_first">A simple AJAX example</a><br>
Create a simple XMLHttpRequest, and retrieve data from a TXT file.
</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryajax_xml">Load an XML file with AJAX</a><br>
Create an XMLHttpRequest to retrieve data from an XML file.
</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryajax_header">Retrieve header information with AJAX</a><br>
Retrieve header information of a resource (file).
</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryajax_lastmodified">Retrieve specific header information with AJAX</a><br>
Retrieve specific header information of a resource (file).
</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryajax_suggest">Retrieve the content of an ASP file</a><br>
How a web page can communicate with a web server while a user type characters in an input field.
</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryajax_database">Retrieve content from a database</a><br>
How a web page can fetch information from a database with AJAX.
</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryajax_xml2">Retrieve the content of an XML file</a><br>
Create an XMLHttpRequest to retrieve data from an XML file and display the data in an HTML table.
</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryajax_callback">An AJAX example with a callback function</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_examples.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_examples.asp#top" target="_top">TOP</a> |
		<a href="ajax_examples.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
