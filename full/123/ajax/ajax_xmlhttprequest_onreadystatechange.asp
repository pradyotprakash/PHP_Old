...
<title>AJAX The XMLHttpRequest onreadystatechange Event</title>
<style>a.menu_ajax_xmlhttprequest_onreadystatechange{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>AJAX - The <span class="color_h1">onreadystatechange</span> Event</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ajax_xmlhttprequest_response.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ajax_aspphp.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>If you have more than one AJAX task on your website, you should create ONE 
standard function for creating the XMLHttpRequest object, and call this for each 
AJAX task.</p>
<p>The function call should contain the URL and what to do on onreadystatechange 
(which is probably different for each call):</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryajax_callback">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_xmlhttprequest_onreadystatechange.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_xmlhttprequest_onreadystatechange.asp#top" target="_top">TOP</a> |
		<a href="ajax_xmlhttprequest_onreadystatechange.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
