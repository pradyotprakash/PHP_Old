...
<title>ADO Supports Method</title>
<style>a.menu_met_rs_supports{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Supports</span> Method</h1>
<hr>
...
<hr>
<p>The Supports method returns a boolean value that defines whether or not a Recordset
object supports a specific
type of functionality.&nbsp;
</p>

<p><b>Note:</b> This method returns true if the specified feature is supported,
false if not.
</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>cursoroptions </td>
    <td>   Required. One or more <a href="met_rs_supports.asp#cursoroptionenum"> CursorOptionEnum</a>
      values that specifies what functionality this method should test for</td>
  </tr>
</table>
<br>
<hr>

<a name="cursoroptionenum"><h3>CursorOptionEnum</h3></a>
<table class="reference notranslate">
      <tr>
        <th>Constant</th>
        <th>Value</th>
      ...
      <tr>
        <td>adHoldRecords</td>
        <td>0x100</td>
        <td>Retrieves more records or changes the next position
          without committing all pending changes</td>
      </tr>
      <tr>
        <td>adMovePrevious</td>
        <td>0x200</td>
        <td>Supports the MoveFirst
          and MovePrevious
          methods, and Move
          or GetRows
          methods</td>
      ...
      <tr>
        <td>adBookmark</td>
        <td>0x2000</td>
        <td>Supports the Bookmark
          property</td>
      </tr>
      <tr>
        <td>adApproxPosition</td>
        <td>0x4000</td>
        <td>Supports the AbsolutePosition
          and AbsolutePage properties</td>
      </tr>
      <tr>
        <td>adUpdateBatch</td>
        <td>0x10000</td>
        <td>Supports UpdateBatch
          and CancelBatch methods</td>
      </tr>
      <tr>
        <td>adResync</td>
        <td>0x20000</td>
        <td>Supports the Resync
          method</td>
      </tr>
      <tr>
        <td>adNotify</td>
        <td>0x40000</td>
        <td>Indicates that the data provider supports
      ...
      <tr>
        <td>adFind</td>
        <td>0x80000</td>
        <td>Supports the Find
          method</td>
      </tr>
      <tr>
        <td>adIndex</td>
        <td>0x100000</td>
        <td>Supports the Index
          property</td>
      </tr>
      <tr>
        <td>adSeek</td>
        <td>0x200000</td>
        <td>Supports the Seek
          method</td>
      </tr>
      <tr>
        <td>adAddNew</td>
        <td>0x1000400</td>
        <td>Supports the AddNew
          method</td>
      </tr>
      <tr>
        <td>adDelete</td>
        <td>0x1000800</td>
        <td>Supports the Delete
          method</td>
      </tr>
      <tr>
        <td>adUpdate</td>
        <td>0x1008000</td>
        <td>Supports the Update
          method</td>
      </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_supports.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_supports.asp#top" target="_top">TOP</a> |
		<a href="met_rs_supports.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
