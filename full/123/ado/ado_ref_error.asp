...
<style>a.menu_ado_ref_error{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Error</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_ref_connection.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_ref_field.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>Error Object</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_err_description.asp">Description</a></td>
    <td>Returns an error description</td>
  </tr>
  <tr>
    <td><a href="prop_err_helpcontext.asp">HelpContext</a></td>
    <td>Returns the context ID of a topic in
      the Microsoft Windows help system</td>
  </tr>
  <tr>
    <td><a href="prop_err_helpfile.asp">HelpFile</a></td>
    <td>Returns the full path of the help
      file in the Microsoft Windows help system</td>
  </tr>
  <tr>
    <td><a href="prop_err_nativeerror.asp">NativeError</a></td>
    <td>Returns an error code from the provider or the data source</td>
  </tr>
  <tr>
    <td><a href="prop_err_number.asp">Number</a></td>
    <td>Returns a unique number that identifies the error</td>
  </tr>
  <tr>
    <td><a href="prop_err_source.asp">Source</a></td>
    <td>Returns the name of the object or application that generated the
      error</td>
  </tr>
  <tr>
    <td><a href="prop_err_sqlstate.asp">SQLState</a></td>
    <td>Returns a 5-character SQL error code</td>
  </tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_ref_error.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_ref_error.asp#top" target="_top">TOP</a> |
		<a href="ado_ref_error.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
