...
<title>ADO CommandType Property</title>
<style>a.menu_prop_comm_commandtype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">CommandType</span> Property</h1>
<hr>
...
<hr>
<p>The CommandType property sets or returns a <a href="prop_comm_commandtype.asp#commandtypeenum"> CommandTypeEnum</a>
value that defines the type of the Command object. Default is adCmdUnknown.
</p>

<p>If you do not specify the type, ADO will need to contact the provider to determine the type of the command.
...
comm.CommandType=adCmdTable<br>
response.write(comm.CommandType)<br>
<br>
conn.close<br>
%&gt;
...
<table class="reference notranslate">
    ...
    <tr>
      <td>adCmdUnknown</td>
      <td>8</td>
      <td>Default. Indicates that the type of command in the CommandText
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_comm_commandtype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_comm_commandtype.asp#top" target="_top">TOP</a> |
		<a href="prop_comm_commandtype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
