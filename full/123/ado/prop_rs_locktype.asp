...
<title>ADO LockType Property</title>
<style>a.menu_prop_rs_locktype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">LockType</span> Property</h1>
<hr>
...
<hr>
<p>The LockType property sets or returns a <a href="prop_rs_locktype.asp#LockTypeEnum"> LockTypeEnum</a> value that specifies the type of locking
...
<p><b>Note:</b> Set this property before opening the Recordset.
</p>

<p><b>Note:</b> Not all providers support all lock types. If the requested LockType
...
<p><b>Note:</b> adLockPessimistic is not supported if CursorLocation is set to
adUseClient.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>1</td>
    <td>Read-only records</td>
  </tr>
  <tr>
    <td>adLockPessimistic</td>
    <td>2</td>
    <td>Pessimistic locking, record by record. The provider lock records
      immediately after editing</td>
  </tr>
  <tr>
    <td>adLockOptimistic</td>
    <td>3</td>
    <td>Optimistic locking, record by record. The provider lock records only
      when calling update</td>
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_locktype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_locktype.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_locktype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
