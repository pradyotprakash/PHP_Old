...
<title>ADO Data Types</title>
<style>a.menu_ado_datatypes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Data Types</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_ref_stream.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_summary.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p>The table below shows the ADO Data Type mapping between Access, SQL Server, and Oracle:</p>
<table class="reference notranslate">
  <tr>
    <th style="width:20%">DataType Enum</th>
  ...
  <tr>
    <td>adGUID</td>
    <td>72</td>
    <td>ReplicationID (Access 97 (OLEDB)), (Access 2000 (OLEDB))</td>
    <td>UniqueIdentifier (SQL Server 7.0 +)</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>adIDispatch</td>
...
&nbsp;</td>
  ...
  <tr>
    ...
    <td>203</td>
    <td>Memo (Access 2000 (OLEDB))<br>
    Hyperlink (Access 2000 (OLEDB))</td>
    <td>NText (SQL Server 7.0 +)</td>
    <td>NClob (Oracle 8.1.x)</td>
  </tr>
  <tr>
    <td>adNumeric</td>
    <td>131</td>
    <td>Decimal (Access 2000 (OLEDB))</td>
    <td>Decimal<br>
    Numeric</td>
    <td>Decimal<br>
    Integer<br>
  ...
  <tr>
    ...
    <td>12</td>
    <td>&nbsp;</td>
    <td>Sql_Variant (SQL Server 2000 +)</td>
    <td>VarChar2</td>
  </tr>
  <tr>
    <td>adVarWChar</td>
    <td>202</td>
    <td>Text (Access 2000 (OLEDB))</td>
    <td>NVarChar (SQL Server 7.0 +)</td>
    <td>NVarChar2</td>
  </tr>
  <tr>
    <td>adWChar</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_datatypes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_datatypes.asp#top" target="_top">TOP</a> |
		<a href="ado_datatypes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
