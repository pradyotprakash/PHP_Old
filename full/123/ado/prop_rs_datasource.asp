...
<title>ADO DataSource Property</title>
<style>a.menu_prop_rs_datasource{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">DataSource</span> Property</h1>
<hr>
...
<hr>
<p>The DataSource property specifies an object containing data to be represented
as a Recordset object
</p>

<p>The DataSource property is used to create data-bound controls with the Data Environment in Visual Basic 6.
</p>

<p><b>Note:</b> The DataMember and DataSource properties must be used in conjunction.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_datasource.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_datasource.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_datasource.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
