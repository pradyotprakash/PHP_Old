...
<title>ADO BeginTransComplete, CommitTransComplete, and RollbackTransComplete Events</title>
<style>a.menu_ev_conn_transcomplete{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">BeginTransComplete</span>, 
<span class="color_h1">CommitTransComplete</span>, and 
<span class="color_h1">RollbackTransComplete</span> Events</h1>
<hr>
<a href="ado_ref_connection.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Connection Object Reference" /> Complete Connection Object Reference</a>
<hr>
<p>An event is a subroutine that can be called automatically after a specific operation has occurred.
</p>

<ul>
  <li>The <b>BeginTransComplete</b> event can be fired after a BeginTrans call
    is completed.</li>
  <li>The <b> CommitTransComplete</b> event can be fired after a CommitTrans call is completed.</li>
  <li>The <b>RollbackTransComplete </b>event can be fired after a RollbackTrans
    call is completed</li>
</ul>
...
BeginTransComplete translevel,objerror,status,objconn<br>
<br>
CommitTransComplete objerror,status,objconn<br>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>translevel </td>
    <td>   The transaction level of the BeginTrans method that
      fired the event
    </td>
  </tr>
  <tr>
    <td>objerror </td>
    <td>   An Error object that contains the errors that occurred
      <p><b>Note:</b> The EventStatusEnum value must be set to adStatusErrorsOccurred
      to create the Error object</p>
    </td>
  </tr>
  <tr>
    <td>status </td>
    <td>   Specifies the status of the execution of an event. Takes
      an <a href="ev_conn_transcomplete.asp#eventstatusenum">EventStatusEnum</a>
      value      
    </td>
  </tr>
  <tr>
    <td>objconn </td>
    <td>   The Connection object that fired the event      
    </td>
  </tr>
</table>
...
<table class="reference notranslate">
    ...
    <tr>
      ...
      <td>2</td>
      <td>The operation that fired the event failed</td>
    </tr>
    <tr>
      <td>adStatusCantDeny</td>
      <td>3</td>
      <td>Cannot cancel the pending operation</td>
    </tr>
    <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_conn_transcomplete.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_conn_transcomplete.asp#top" target="_top">TOP</a> |
		<a href="ev_conn_transcomplete.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
