...
<title>ADO MaxRecords Property</title>
<style>a.menu_prop_rs_maxrecords{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">MaxRecords</span> Property</h1>
<hr>
...
<hr>
<p>The MaxRecords property sets or returns a long value that indicates the
maximum number of records to return to a Recordset object from a query. Default is zero
(which means that the provider returns all requested records).
</p>
<p>This property is read/write on a closed Recordset and read-only on an open Recordset.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_maxrecords.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_maxrecords.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_maxrecords.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
