...
<title>ADO NumericScale Property</title>
<style>a.menu_prop_field_numericscale{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">NumericScale</span> Property</h1>
<hr>
...
<hr>
<p>The NumericScale property sets or returns a byte value that indicates the
number of digits stored to the right side of the decimal point for a numeric value
of a Field or Parameter object.
</p>

<table class="reference notranslate">
    <tr>
      <th style="width:20%">Object</th>
      <th>Description of the NumericScale Property</th>
    </tr>
    <tr>
      <td>Field</td>
      <td>
        <p>The NumericScale has read/write permissions when used to
    ...
    <tr>
      <td>Parameter</td>
      <td>The NumericScale property has read/write permissions on a Parameter
        object</td>
    </tr>
</table>
...
<br>
response.write(rs.Fields(0).NumericScale)<br>
<br>
rs.Close<br>
conn.close<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_field_numericscale.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_field_numericscale.asp#top" target="_top">TOP</a> |
		<a href="prop_field_numericscale.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
