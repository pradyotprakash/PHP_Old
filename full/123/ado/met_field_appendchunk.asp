...
<title>ADO AppendChunk Method</title>
<style>a.menu_met_field_appendchunk{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">AppendChunk</span> Method</h1>
<hr>
...
<p>The AppendChunk method is used to append long binary or character data to a Parameter or Field object.</p>
<p><b>Tip:</b> Use this method to manipulate long values
in portions.</p>

<table class="reference notranslate">
<tr>
 <th style="width:20%">Object</th>
 <th>Description of the AppendChunk Method</th>
</tr>  
<tr>
 <td>Parameter </td>
 <td><p>You can use the AppendChunk method for a Parameter object if the Attributes property is set to adFldLong.</p>
  <p>First time you call the AppendChunk method on a Parameter object it
  overwrites any existing data. The next AppendChunk calls add data to existing parameter data.</p>
 </td>
</tr>
<tr>
 <td>Field </td>
 <td><p>You can use the AppendChunk method for a Field object if the Attributes property is set to adFldLong.</p>
  <p>First time you call the AppendChunk method on a Field object it overwrites any existing data.
 ...
 Accessing fields in other Recordset objects that are not clones of the first Recordset object will not disrupt AppendChunk operations.
  ...
  object.</p>
 <p><b>Note:</b> This method does not work on Field objects of a Record object.</p>
</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_field_appendchunk.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_field_appendchunk.asp#top" target="_top">TOP</a> |
		<a href="met_field_appendchunk.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
