...
<title>ADO BeginTrans, CommitTrans, and RollbackTrans Methods</title>
<style>a.menu_met_conn_begintrans{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">BeginTrans, CommitTrans,</span> and <span class="color_h1">RollbackTrans</span> Methods</h1>
<hr>
...
<p>These 3 methods is used with the Connection object to save or cancel changes made to the
data source.
</p>

<p><b>Note:</b>  Not all providers support transactions.</p>

<p><b>Note:</b> These 3 methods are not available on a client-side Connection object.</p>

<h3>BeginTrans</h3>

<p>The BeginTrans method starts a new transaction.</p>

<p>This method can also be used to return a long value that is the level of nested transactions.
A top level transaction has a return value of 1. Each additional level increments by one.</p>

<h3>CommitTrans</h3>

<p>The CommitTrans method saves all changes made since the last BeginTrans method call,
and ends the current transaction.</p>

<p>Since transactions can be nested, all lower-level transactions must be resolved before you can resolve higher-level transactions.</p>

<h3>RollbackTrans</h3>

<p>The RollbackTrans method cancels all changes made since the last BeginTrans method call, and ends the transaction.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_conn_begintrans.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_conn_begintrans.asp#top" target="_top">TOP</a> |
		<a href="met_conn_begintrans.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
