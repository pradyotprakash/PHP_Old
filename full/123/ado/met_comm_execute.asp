...
<style>a.menu_met_comm_execute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<hr>
<p>The Execute method executes the query, SQL statement or procedure specified in the
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>ra </td>
    <td>   Optional. Returns the number of records affected by a
      query. For a row-returning query, use the RecordCount property of the Recordset object to
      count of how many records are in the object.</td>
  </tr>
  <tr>
    <td>parameters </td>
    <td>   Optional. Parameter values passed with an SQL
      statement. Used to change, update, or insert new parameter values into the Parameters Collection.      
    </td>
  </tr>
  <tr>
    <td>options </td>
    <td>Optional. Sets how the provider should evaluate the CommandText property.
      Can be one or more <a href="met_comm_execute.asp#commandtypeenum"> CommandTypeEnum</a> or <a href="met_comm_execute.asp#executeoptionenum"> ExecuteOptionEnum</a> values.
...
&lt;%<br>
Set objcommand.CommandText=&quot;SELECT * FROM Customers&quot;<br>
objCommand.Execute<br>
%&gt;<br>
<br>
or<br>
<br>
&lt;%<br>
Set objcommand.CommandText=&quot;Customers&quot;<br>
objCommand.Execute(,,adCmdTableDirect)<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_comm_execute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_comm_execute.asp#top" target="_top">TOP</a> |
		<a href="met_comm_execute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
