...
<title>ADO Summary</title>
<style>a.menu_ado_summary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>You Have Learned ADO, <span class="color_h1">Now What?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_datatypes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>ADO Summary</h2>
<p>This tutorial has taught you how to access data in a database from a web 
site.</p>
<p>You have learned how to display data from a database on a web site, and how 
to edit, add and delete the data with ADO.</p>
<p>For more information on ADO, please look at our <a href="ado_examples.asp">
ADO examples</a>.</p>
<hr>
<h2>Now You Know ADO, What's Next?</h2>
<p>The next step is to learn SQL.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_summary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_summary.asp#top" target="_top">TOP</a> |
		<a href="ado_summary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
