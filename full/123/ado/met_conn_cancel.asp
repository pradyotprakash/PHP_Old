...
<title>ADO Cancel Method</title>
<style>a.menu_met_conn_cancel{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Cancel</span> Method</h1>
<hr>
...
<hr>
<p>The Cancel method cancels an execution of a method call.
</p>

<p>The Cancel method cancels different tasks for each object. The table below shows what task is
cancelled when this method is called:</p>
<table class="reference notranslate"> 
  ...
  <tr>
    <td>Command </td>
    <td>   Execute.
      <p><b>Note:</b> The Options parameter of the Execute method must be set to
      adAsyncExecute or adAsyncFetch, before the Cancel method is called,
      otherwise a run-time error will occur</p>
    </td>
  </tr>
  <tr>
    <td>Connection </td>
    <td>   Execute or Open.
      <p><b>Note:</b> The Options parameter of the Open method must be set to adSyncConnect, or
      the Options parameter of the Execute method be set to adAsyncExecute or adAsyncFetch,
      before the Cancel method is called, otherwise a run-time error will occur</p>
    </td>
  </tr>
  <tr>
    <td>Record </td>
    <td>CopyRecord, DeleteRecord, MoveRecord, or Open
      <p><b>Note:</b> The Options parameter of the Execute method must be set to
      adAsyncExecute or adAsyncFetch, before the Cancel method is called,
      otherwise a run-time error will occur</p>
    </td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_conn_cancel.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_conn_cancel.asp#top" target="_top">TOP</a> |
		<a href="met_conn_cancel.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
