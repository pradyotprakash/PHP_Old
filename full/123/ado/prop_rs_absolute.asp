...
<title>ADO AbsolutePage and AbsolutePosition Properties</title>
<style>a.menu_prop_rs_absolute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">AbsolutePage</span> and <span class="color_h1">AbsolutePosition</span> Property</h1>
<hr>
...
<p>The AbsolutePage property sets or returns a long value that specifies the page
number in the Recordset object. It sets or returns a value from 1 to the number
of pages in the Recordset, or it returns a <a href="prop_rs_absolute.asp#PositionEnum">PositionEnum</a> value.
The value is 1 when the current record is the first record in the Recordset.</p>
<p><b>Tip:</b> To get the total number of pages in the Recordset, use the PageCount
property.</p>
<p><b>Tip:</b> To divide the Recordset into a series of pages, use the PageSize property.</p>

<p><b>Note:</b> This property can only be used if the AbsolutePage, PageCount, and PageSize
properties are supported by the provider.</p>
<h3>AbsolutePosition</h3>

<p>The AbsolutePosition property sets or returns a long value that specifies the
...
returns a <a href="prop_rs_absolute.asp#PositionEnum">PositionEnum</a> value. The value is 1 when
the current record is the first record in the Recordset.</p>
<p>When you set this property to a number, you will be moved to the record at the
numeric position.</p>
<p><b>Tip:</b> To get the total number of records in the Recordset, use the
RecordCount property.</p>
<p><b>Note:</b> Do not use this property to uniquely identify a record!</p>

<h3>Syntax</h3>
<div class="code notranslate"><div>

objRecordset.AbsolutePage<br>
<br>
...
<a name="PositionEnum"><h3>PositionEnum Values</h3></a>
<table class="reference notranslate">
    ...
    <tr>
      <td>adPosUnknown</td>
      <td>-1</td>
      <td>Indicates that the Recordset is empty, the current position is
        unknown, or the provider does not support the AbsolutePage or
        AbsolutePosition property</td>
    </tr>
    <tr>
      <td>adPosBOF</td>
      <td>-2</td>
      <td>Indicates that the current record pointer is before the first record (BOF)</td>
    </tr>
    <tr>
      <td>adPosEOF</td>
      <td>-3</td>
      <td>Indicates that the current record pointer is after the last record (EOF)</td>
    </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_absolute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_absolute.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_absolute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
