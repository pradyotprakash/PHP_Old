...
<style>a.menu_ado_recordset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Recordset</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_connect.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_display.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">To be able to read database data, the data must first be loaded
into a
recordset.&nbsp;</p>
<hr>
<h2>Create an ADO Table Recordset</h2>
<p>After an ADO Database Connection has been created, as demonstrated in the
previous chapter, it is possible to create an ADO Recordset.&nbsp;&nbsp;</p>
<p>Suppose we have a database named &quot;Northwind&quot;, we can get access to the
...
<p>We can also get access to the data in the &quot;Customers&quot; table using
SQL:</p>
<div class="code notranslate"><div>
...
<p>After a recordset is opened, we can extract data from recordset.&nbsp;&nbsp;</p>
<p>Suppose we have a database named &quot;Northwind&quot;, we can get access to the
&quot;Customers&quot; table inside the database with
the following lines:</p>
<div class="code notranslate"><div>
...
<p>The ADO Recordset object is used to hold a set of records from a database table.&nbsp;</p>
<p><a href="ado_ref_recordset.asp">View all methods and properties of the Recordset object</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_connect.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_display.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_recordset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_recordset.asp#top" target="_top">TOP</a> |
		<a href="ado_recordset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
