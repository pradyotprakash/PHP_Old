...
<title>ADO Direction Property</title>
<style>a.menu_prop_para_direction{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Direction</span> Property</h1>
<hr>
...
<hr>
<p>The Direction property sets or returns a <a href="prop_para_direction.asp#parameterdirectionenum"> ParameterDirectionEnum</a>
value that specifies how a parameter is passed to or from a
procedure.
Default value is adParamInput.
</p>

<p>Is it an input parameter, an output parameter, an input and an output parameter, or
a return value from a procedure?
</p>
...
<a name="parameterdirectionenum"><h3>ParameterDirectionEnum Values</h3></a>
<table class="reference notranslate">
      ...
      <tr>
        <td>adParamInput</td>
        <td>1</td>
        <td>Default. Input parameter</td>
      </tr>
      <tr>
        <td>adParamInputOutput</td>
        <td>3</td>
        <td>Input
          and output parameter</td>
      </tr>
      <tr>
        <td>adParamOutput</td>
        <td>2</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_para_direction.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_para_direction.asp#top" target="_top">TOP</a> |
		<a href="prop_para_direction.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
