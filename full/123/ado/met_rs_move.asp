...
<title>ADO Move Method</title>
<style>a.menu_met_rs_move{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Move</span> Method</h1>
<hr>
...
<hr>
<p>The Move method moves the record pointer in a Recordset object.
</p>

<p><b>Note:</b> This method can be used on all Recordset objects.
</p>
...
<table class="reference notranslate">
    ...
    <tr>
      <td>numrec</td>
      <td>   Required. Specifies how many records the record pointer will
        move.<p><b>Example:</b> If this parameter is set to 3, the record
        pointer moves 3 records forward.<p><b>Example:</b> If this parameter is
        set to -3, the record pointer moves 3 records backward
      </td>
    </tr>
    <tr>
      <td>start</td>
      <td>   
   Optional. Where to start. Can be a bookmark or a <a href="met_rs_move.asp#bookmarkenum"> BookmarkEnum</a> value</td>
    </tr>
</table>
<br>
<hr>

<a name="bookmarkenum"><h3>BookmarkEnum</h3></a>
<table class="reference notranslate">
      <tr>
        <th>Constant</th>
        <th>Value</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_move.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_move.asp#top" target="_top">TOP</a> |
		<a href="met_rs_move.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
