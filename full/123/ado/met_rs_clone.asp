...
<style>a.menu_met_rs_clone{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Clone</span> Method</h1>
<hr>
...
<hr>
<p>The Clone method allows you to create a duplicate Recordset from an existing Recordset.
...
<p>When you clone a Recordset you actually just create a new pointer to the same
...
<p>The provider must support bookmarks on the Recordset object to create clones. Bookmarks are interchangeable;
a bookmark reference from one Recordset object refers to the same record in any of its clones.
</p>

<p><b>Note:</b> The filter of the original Recordset will not be applied to the clone.
To copy an existing filter: objRecordsetNew.Filter=objRecordsetOriginal.Filter
</p>

<p><b>Note:</b> When you close the original Recordset none of the copies will be
...
<table class="reference notranslate">
  <tbody>
    ...
    <tr>
      <td>objRecordsetClone</td>
      <td>The clone Recordset to be created</td>
    </tr>
    <tr>
      <td>objRecordset</td>
      <td>The Recordset to be cloned</td>
    </tr>
    <tr>
      <td>locktype</td>
      <td>Optional. A <a href="met_rs_clone.asp#locktypeenum">LockTypeEnum</a>
        value that specifies the lock type</td>
    </tr>
  </tbody>
</table>
<br>
...
<table class="reference notranslate">
    ...
    <tr>
      ...
      <td>-1</td>
      <td>The clone is created with
        the same lock type as the original Recordset</td>
    </tr>
    <tr>
      <td>adLockReadOnly</td>
      <td>1</td>
      <td>The clone is a read-only Recordset</td>
    </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_clone.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_clone.asp#top" target="_top">TOP</a> |
		<a href="met_rs_clone.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
