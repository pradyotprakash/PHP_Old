...
<title>ADO ReadText Method</title>
<style>a.menu_met_stream_readtext{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">ReadText</span> Method</h1>
<hr>
...
<hr>
<p>The ReadText method is used to read the entire stream, a line, or a specified number of
characters from
a text Stream object and returns the resulting data as a string.</p>
<p><b>Note:</b> This method is only used with text Stream objects, for binary
Stream objects, use the Read method.</p>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
      <td>numchars</td>
      <td>   Optional. The number of characters to read from the file,
        or a <a href="met_stream_readtext.asp#streamreadenum"> StreamReadEnum</a> value. Default is adReadAll
        <p>If you have specified more than the number of characters left in the
...
<a name="streamreadenum"><h3>StreamReadEnum Values</h3></a>
<table class="reference notranslate">
      <tr>
        <th>Constant</th>
        <th>Value</th>
      ...
      <tr>
        <td>adReadAll</td>
        <td>-1</td>
        <td>Default. Reads all characters from the stream, from the
      ...
      <tr>
        <td>adReadLine</td>
        <td>-2</td>
        <td>Reads the next line from the stream</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_stream_readtext.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_stream_readtext.asp#top" target="_top">TOP</a> |
		<a href="met_stream_readtext.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
