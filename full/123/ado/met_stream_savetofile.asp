...
<title>ADO SaveToFile Method</title>
<style>a.menu_met_stream_savetofile{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">SaveToFile</span> Method</h1>
<hr>
...
<hr>
<p>The SaveToFile method is used to save the binary contents of an open Stream object
to a local file.</p>
<p><b>Note:</b> After a call to this method, the current position in the stream is set to the beginning of the stream
(Position=0).</p>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
      <td>filename</td>
      <td>   Required. The name of the file to save the contents of the Stream
        object
      </td>
    </tr>
    <tr>
      <td>opt</td>
      <td>   Optional. A <a href="met_stream_savetofile.asp#SaveOptionsEnum"> SaveOptionsEnum</a> value that specifies whether a
...
<a name="SaveOptionsEnum"><h3>SaveOptionsEnum Values</h3></a>
<table class="reference notranslate">
      <tr>
        <th>Constant</th>
        <th>Value</th>
      ...
      <tr>
        <td>adSaveCreateNotExist</td>
        <td>1</td>
        <td> Default. Creates a new file if the file does not already
          exist
        </td>
      </tr>
      <tr>
        <td>adSaveCreateOverWrite</td>
        <td>2</td>
        <td> Overwrites the file with the data from the currently open Stream object, if the file
          already exists </td>
      </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_stream_savetofile.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_stream_savetofile.asp#top" target="_top">TOP</a> |
		<a href="met_stream_savetofile.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
