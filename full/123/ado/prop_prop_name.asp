...
<title>ADO Name Property</title>
<style>a.menu_prop_prop_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Name</span> Property</h1>
<hr>
...
<hr>
<p>The Name property sets or returns a string that contains the name of a Command, Property, Field, or Parameter object.
</p>

<table class="reference notranslate">
    <tr>
      <th style="width:20%">Object</th>
      <th>Description of the Name
        Property</th>
    </tr>
    <tr>
      <td>Command</td>
      <td>The Name property has read/write permissions on a
        Connection object</td>
    </tr>
    <tr>
      <td>Property</td>
      <td>The Name property has read-only permissions on a Property
        object</td>
    </tr>
    <tr>
      <td>Field</td>
      <td>
        <p>The Name property has read/write permissions when used to
        create a Recordset, but it has read-only permissions when you open an
        existing Recordset</p>
      </td>
    </tr>
    <tr>
      <td>Parameter</td>
      <td>The Name property has read/write permissions on a Parameter
        object that is not added to the Parameters Collection, but it has read-only
        permissions after the object is added to the Collection</td>
    </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_prop_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_prop_name.asp#top" target="_top">TOP</a> |
		<a href="prop_prop_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
