...
<title>ADO Source Property</title>
<style>a.menu_prop_rs_source{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Source</span> Property</h1>
<hr>
...
<hr>
<p>The Source property sets a string value or a Command object reference, or returns
a String value that indicates the data source of the Recordset object.
</p>

<p>The data source can be one of the following:
</p>
...
<p>This property is read/write on a closed Recordset objects and read-only for
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_source.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_source.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_source.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
