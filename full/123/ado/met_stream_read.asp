...
<title>ADO Read Method</title>
<style>a.menu_met_stream_read{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Read</span> Method</h1>
<hr>
...
<hr>
<p>The Read method is used to read the entire stream or a specified number of bytes from
a binary Stream object and returns the resulting data as a variant.</p>
<p><b>Note:</b> This method is only used with binary Stream objects, for text
Stream objects, use the ReadText method.</p>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
      <td>numbytes</td>
      <td>   Optional. The number of bytes to read from the file,
        or a <a href="met_stream_read.asp#streamreadenum"> StreamReadEnum</a> value. Default is adReadAll
        <p>If you have specified more than the number of bytes left in the
...
<table class="reference notranslate">
      ...
      <tr>
        <td>adReadAll</td>
        <td>-1</td>
        <td>Default. Reads all bytes from the stream, from the
          current position to EOS.
          <p><b>Note:</b> This is the only valid value with binary Stream objects</p>
        </td>
      </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_stream_read.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_stream_read.asp#top" target="_top">TOP</a> |
		<a href="met_stream_read.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
