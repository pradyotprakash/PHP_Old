...
<style>a.menu_prop_comm_activeconn{font-weight:bold;}</style>
<meta charset="utf-8">
...
<hr>
<p>The ActiveConnection property tells which Connection object the
Command object belongs to.
</p>

<p>If the connection is closed, it sets or returns a definition for a
connection. If the connection is open it sets or returns the current Connection
object.</p>
...
response.write(comm.ActiveConnection)<br>
<br>
conn.close<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_comm_activeconn.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_comm_activeconn.asp#top" target="_top">TOP</a> |
		<a href="prop_comm_activeconn.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
