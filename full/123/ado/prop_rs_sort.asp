...
<title>ADO Sort Property</title>
<style>a.menu_prop_rs_sort{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Sort</span> Property</h1>
<hr>
...
<hr>
<p>The Sort property sets or returns a string value that specifies the field names in the Recordset
...
<p><b>Note:</b> This property can only be used if the CursorLocation property is
set to adUseClient.
</p>

<p><b>Tip:</b> If you set this property to an empty string (rs.Sort=&quot;&quot;)
...
&lt;%<br>
rs.Sort=&quot;CompanyName,ContactName&quot;<br>
%&gt;<br>
<br>
or<br>
<br>
&lt;%<br>
rs.Sort=&quot;CompanyName DESC,ContactName&quot;<br>
%&gt;<br>
<br>
or<br>
<br>
&lt;%<br>
rs.Sort=&quot;CompanyName,ContactName,[Ship Address]&quot;<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_sort.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_sort.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_sort.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
