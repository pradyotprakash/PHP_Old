...
<style>a.menu_ado_ref_stream{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Stream</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_ref_recordset.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_datatypes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_stream_charset.asp">CharSet</a></td>
    <td>Sets or returns a value that specifies into which character set the contents
      are to be
      translated. This property is only used with text Stream objects (type is
      adTypeText)</td>
  </tr>
  <tr>
    <td><a href="prop_stream_eos.asp">EOS</a></td>
    <td>Returns whether the current position is at the end of the
      stream or not</td>
  </tr>
  <tr>
    <td><a href="prop_stream_lineseparator.asp">LineSeparator</a></td>
    <td>Sets or returns the line separator character used in a text Stream
      object</td>
  </tr>
  <tr>
    <td><a href="prop_stream_mode.asp">Mode</a></td>
    <td>Sets or returns the available permissions for modifying
      data</td>
  </tr>
  <tr>
    <td><a href="prop_stream_position.asp">Position</a></td>
    <td>Sets or returns the current position (in bytes) from the
      beginning of a Stream object</td>
  </tr>
  <tr>
    <td><a href="prop_stream_size.asp">Size</a></td>
    <td>Returns the size of an open Stream
      object</td>
  </tr>
  <tr>
    <td><a href="prop_stream_state.asp">State</a></td>
    <td>Returns a value describing if the Stream object is open or
      closed</td>
  </tr>
  <tr>
    <td><a href="prop_stream_type.asp">Type</a></td>
    <td>Sets or returns the type of data in a Stream object</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="met_stream_cancel.asp">Cancel</a></td>
    <td>Cancels an execution of an Open call on a Stream object</td>
  </tr>
  <tr>
    <td><a href="met_stream_close.asp">Close</a></td>
    <td>Closes a Stream object</td>
  </tr>
  <tr>
    <td><a href="met_stream_copyto.asp">CopyTo</a></td>
    <td>Copies a specified number of characters/bytes from one
      Stream object into another Stream object</td>
  </tr>
  <tr>
    <td><a href="met_stream_flush.asp">Flush</a></td>
    <td>Sends the contents of the Stream buffer to the associated
      underlying object</td>
  </tr>
  <tr>
    <td> <a href="met_stream_loadfromfile.asp"> LoadFromFile</a></td>
    <td>Loads the contents of a file into a Stream object</td>
  </tr>
  <tr>
    <td><a href="met_stream_open.asp">Open</a></td>
    <td>Opens a Stream object</td>
  </tr>
  <tr>
    <td><a href="met_stream_read.asp">Read</a></td>
    <td>Reads the entire stream or a specified number of bytes from
      a binary Stream object</td>
  </tr>
  <tr>
    <td> <a href="met_stream_readtext.asp"> ReadText</a></td>
    <td>Reads the entire stream, a line, or a specified number of
      characters from a text Stream object</td>
  </tr>
  <tr>
    <td> <a href="met_stream_savetofile.asp"> SaveToFile</a></td>
    <td>Saves the binary contents of a Stream object to a file</td>
  </tr>
  <tr>
    <td> <a href="met_stream_seteos.asp"> SetEOS</a></td>
    <td>Sets the current position to be the end of the stream (EOS)</td>
  </tr>
  <tr>
    <td><a href="met_stream_skipline.asp">SkipLine</a></td>
    <td>Skips a line when reading a text Stream</td>
  </tr>
  <tr>
    <td><a href="met_stream_write.asp">Write</a></td>
    <td>Writes binary data to a binary Stream object</td>
  </tr>
  <tr>
    <td><a href="met_stream_writetext.asp">WriteText</a></td>
    <td>Writes character data to a text Stream object</td>
  </tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_ref_stream.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_ref_stream.asp#top" target="_top">TOP</a> |
		<a href="ado_ref_stream.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
