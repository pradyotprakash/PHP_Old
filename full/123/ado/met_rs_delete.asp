...
<style>a.menu_met_rs_delete{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Delete</span> Method</h1>
<hr>
...
<hr>
<p>The Delete method is used to delete the current record or a group of records. After deleting
a record, the deleted record remains current until you move to a different record.
</p>

<p><b>Note:</b> If you are in batch update mode the deletion happens when you call the UpdateBatch
method.
</p>

<p><b>Note:</b> To use this method assure that the Recordset object allows record
deletion.
</p>

<p><b>Note:</b> If this method fails, the provider will not stop the execution,
but it will send a warning to the Errors Collection.&nbsp;
</p>
...
<table class="reference notranslate">
    ...
    <tr>
      <td>affectrecords</td>
      <td>   An <a href="met_rs_delete.asp#affectenum">AffectEnum</a> value that
        specifies which records this method will delete. Default is
        adAffectCurrent</td>
    </tr>
</table>
<br>
...
<table class="reference notranslate">
      ...
      <tr>
        ...
        <td>1</td>
        <td>Deletes only the current record</td>
      </tr>
      <tr>
        <td>adAffectGroup</td>
        <td>2</td>
        <td>Deletes only records that satisfy the Filter setting (Filter must be
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_delete.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_delete.asp#top" target="_top">TOP</a> |
		<a href="met_rs_delete.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
