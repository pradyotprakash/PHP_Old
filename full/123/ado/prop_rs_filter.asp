...
<title>ADO Filter Property</title>
<style>a.menu_prop_rs_filter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Filter</span> Property</h1>
<hr>
...
<hr>
<p>The Filter property sets or returns a variant that contains a filter for the data in a
Recordset object. The filter allows you to select records that fit a specific
criteria.
</p>

<p>The Filter property can contain one of the following:
</p>

<ul>
  <li>A criteria string</li>
  <li>An array of bookmarks</li>
  <li>A <a href="prop_rs_filter.asp#filtergroupenum"> FilterGroupEnum</a>
    value</li>
</ul>
<p>Examples of a criteria string:
</p>

<ul>
  <li>rs.Filter=&quot;Lastname='Smith'&quot;</li>
  <li>rs.Filter=&quot;Lastname='Smith' AND Birthdate &gt;= #4/10/70#&quot;</li>
  <li>rs.Filter=&quot;Lastname='Jonson' OR Lastname='Johnson'&quot;</li>
  <li>rs.Filter= &quot;Lastname LIKE Jon*&quot;</li>
  <li>rs.Filter=&quot;[Company Name]='Alfred Futterkiste' OR Orders&gt;$300.00&quot;</li>
</ul>
<p>Example of an array of bookmarks:
</p>

<p>dim fname(10)<br>
fname(2)=rs.Bookmark<br>
rs.Filter=fname(2)
</p>

<p>When the Filter property is set, the cursor moves to the first record in the filtered
...
<a name="filtergroupenum"><h3>FilterGroupEnum Values</h3></a>
<table class="reference notranslate">
      ...
      <tr>
        <td>adFilterNone</td>
        <td>0</td>
        <td>Removes the current filter</td>
      </tr>
      <tr>
        <td>adFilterPendingRecords</td>
        <td>1</td>
        <td>Filter that displays only edited records that have not yet been sent to the
          server</td>
      </tr>
      <tr>
        <td>adFilterAffectedRecords</td>
        <td>2</td>
        <td>Filter that displays only records affected by the last Delete, Resync,
          UpdateBatch,
          or CancelBatch call</td>
      </tr>
      <tr>
        <td>adFilterFetchedRecords</td>
        <td>3</td>
        <td>Filter that displays the records in the current cache</td>
      </tr>
      <tr>
        <td>adFilterConflictingRecords</td>
        <td>5</td>
        <td>Filter that displays those records that failed the last
          batch update</td>
      </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_filter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_filter.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_filter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
