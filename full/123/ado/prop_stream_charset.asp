...
<title>ADO CharSet Property</title>
<style>a.menu_prop_stream_charset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">CharSet</span> Property</h1>
<hr>
...
<hr>
<p>The CharSet property sets or returns a value that specifies into which
character-set the contents of the Stream are to be translated (when stored in the Stream object’s
buffer).
Default is "Unicode".
</p>

<p>This property is used for converting data going into the Stream or coming out of the Stream. For example, if the Stream contains ISO-8859-1 data and that data is copied to a BSTR, the Stream object will convert the data to Unicode. The reverse is also true.
</p>

<p><b>Note:</b> This property is only used with text Stream objects (type is
adTypeText).
</p>

<p><b>Note:</b> For an open Stream object, the current position must be at the beginning of the Stream (0) to
set this property.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_stream_charset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_stream_charset.asp#top" target="_top">TOP</a> |
		<a href="prop_stream_charset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
