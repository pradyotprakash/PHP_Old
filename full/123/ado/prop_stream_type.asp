...
<style>a.menu_prop_stream_type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<hr>
<p>The Type property sets or returns a <a href="prop_stream_type.asp#streamtypeenum"> StreamTypeEnum</a> value that specifies the
type of data in a Stream object. Default is adTypeText.
</p>

<p><b>Note:</b> This property is read/write when the position is at the beginning of the Stream (Position=0),
...
<a name="streamtypeenum"><h3>StreamTypeEnum</h3></a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_stream_type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_stream_type.asp#top" target="_top">TOP</a> |
		<a href="prop_stream_type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
