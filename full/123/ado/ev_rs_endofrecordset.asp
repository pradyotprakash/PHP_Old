...
<title>ADO EndOfRecordset Event</title>
<style>a.menu_ev_rs_endofrecordset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">EndOfRecordset</span> Event</h1>
<hr>
...
<p>The EndOfRecordset event is triggered when you try to move to a record after the
last record in a Recordset. This event can occur if the record pointer is at the
end of the Recordset and the MoveNext method is called.</p>

<p><b>Tip:</b> You can use this event to retrieve more records from a database and append them to the end of the Recordset,
and then repeat the MoveNext call.</p>

<p><b>Note:</b> Before this method returns, set the status parameter to adStatusUnwantedEvent to prevent subsequent notifications.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>moredata </td>
    <td>   <p>A boolean value that if true it allows to append more data to the end of the
      Recordset</p>
  ...
  <tr>
    <td>status </td>
    <td><p>An <a href="ev_rs_endofrecordset.asp#EventStatusEnum"> EventStatusEnum</a> value that indicates the status of the
      execution of the event</p>
    </td>
  </tr>
  <tr>
    <td>objrs </td>
    <td>   The name of the Recordset Object that triggered this event      
    </td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_rs_endofrecordset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_rs_endofrecordset.asp#top" target="_top">TOP</a> |
		<a href="ev_rs_endofrecordset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
