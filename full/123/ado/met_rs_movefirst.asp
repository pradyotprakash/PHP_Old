...
<title>ADO MoveFirst, MoveLast, MoveNext, and MovePrevious Methods</title>
<style>a.menu_met_rs_movefirst{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">MoveFirst, MoveLast, MoveNext,</span> and <span class="color_h1">MovePrevious</span> Methods</h1>
<hr>
...
<hr>
<h3>The MoveFirst Method
</h3>

<p>This method is used to move to the first record in a Recordset object. It
also makes the first record the current record.
</p>

<p><b>Note:</b> If you call MoveFirst() when the Recordset is empty, it generates an error.
</p>

<h3>The MoveLast Method
</h3>

<p>This method is used to move to the last record in a Recordset object. It also
makes the last record the current record.
</p>

<p><b>Note:</b> If you call MoveLast() when the Recordset is empty, it generates an error.
</p>

<p><b>Note:</b>  An error will also occur if the Recordset object does not support bookmarks or backward cursor
movement.
</p>

<h3>The MoveNext Method
</h3>

<p>This method is used to move to the next record in a Recordset object. It also
makes the &quot;next&quot; record the current record.
</p>

<p><b>Note:</b> If you call MoveNext() when the current record is the last
record, it generates an error.
</p>

<h3>The MovePrevious Method
</h3>

<p>This method is used to move to the previous record in a Recordset object. It
also makes the &quot;previous&quot; record the current record.
</p>

<p><b>Note:</b>  An error will occur if the Recordset object does not support bookmarks or backward cursor
movement.
</p>

<p><b>Note:</b> If you call MovePrevious() when the current record is the first
record, it generates an error.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_movefirst.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_movefirst.asp#top" target="_top">TOP</a> |
		<a href="met_rs_movefirst.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
