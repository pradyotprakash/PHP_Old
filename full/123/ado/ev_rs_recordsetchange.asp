...
<title>ADO The WillChangeRecordset and RecordsetChangeComplete Events</title>
<style>a.menu_ev_rs_recordsetchange{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">WillChangeRecordset</span> and 
<span class="color_h1">RecordsetChangeComplete</span> Events</h1>
<hr>
...
<h3>The WillChangeRecordset Event</h3>
<p>The WillChangeRecordset event is triggered before an operation changes the
Recordset.</p>

<p><b>Note:</b> Before this event returns, set the status parameter to adStatusCancel to
cancel the operation that caused this event or set it to adStatusUnwantedEvent to prevent subsequent notifications.</p>

<h3> The RecordsetChangeComplete Event
</h3>

<p>The RecordsetChangeComplete event is triggered after a Recordset has changed.
</p>
...
<p><b>Note:</b>   The WillChangeRecordset and the RecordsetChangeComplete event can occur when calling the Requery method or the Open
...
WillChangeRecord reason,status,objRs<br>
<br>
...
An <a href="ev_rs_recordsetchange.asp#eventreasonenum">EventReasonEnum</a> value that specifies the
reason for this event
  ...
  <tr>
    <td>status </td>
    <td>   An <a href="ev_rs_recordsetchange.asp#EventStatusEnum">EventStatusEnum</a> value
...
<table class="reference notranslate">
      ...
      <tr>
        <td>adRsnResynch</td>
        <td>8</td>
        <td>An operation resynchronized the Recordset with the
          database</td>
      </tr>
      <tr>
        <td>adRsnClose</td>
        <td>9</td>
        <td>An operation closed the Recordset</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_rs_recordsetchange.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_rs_recordsetchange.asp#top" target="_top">TOP</a> |
		<a href="ev_rs_recordsetchange.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
