...
<title>ADO Requery Method</title>
<style>a.menu_met_rs_requery{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Requery</span> Method</h1>
<hr>
...
<hr>
<p>The Requery method updates the data in a Recordset by re-executing the query
that made the original Recordset.
</p>

<p><b>Tip:</b> Use this method to refresh the entire contents of a Recordset.
</p>

<p><b>Note:</b> With this method you call the Close and Open methods in one.
</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>options </td>
    <td>   Optional. Specifies how to execute this command. Can be an
      <a href="met_rs_requery.asp#ExecuteOptionEnum">ExecuteOptionEnum</a>
      value</td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_requery.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_requery.asp#top" target="_top">TOP</a> |
		<a href="met_rs_requery.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
