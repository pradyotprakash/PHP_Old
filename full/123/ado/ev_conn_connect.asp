...
<title>ADO WillConnect, ConnectComplete, and Disconnect Events</title>
<style>a.menu_ev_conn_connect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">WillConnect</span>, 
<span class="color_h1">ConnectComplete</span>, and 
<span class="color_h1">Disconnect</span> Events</h1>
<hr>
...
<ul>
  <li>The <b>WillConnect</b> event can be fired before a connection starts.</li>
  <li>The <b> ConnectComplete</b> event can be fired after a connection starts.</li>
  <li>The <b>Disconnect</b> event can be fired after a connection ends.</li>
</ul>
...
WillConnect ConnectionString,userid,psword,options,status,objcon<br>
<br>
ConnectComplete objerror,status,objconn<br>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>   A string that contains the information required for the
      connection      
    </td>
  </tr>
  <tr>
    <td>userid </td>
    <td>   A string that contains the user name for the connection      
    </td>
  </tr>
  <tr>
    <td>psword </td>
    <td>   A string that contains the password for the connection      
    </td>
  </tr>
  <tr>
    <td>options </td>
    <td>   A long value that specifies how the provider should
  ...
  <tr>
    <td>status </td>
    <td>   An <a href="ev_conn_connect.asp#eventstatusenum">EventStatusEnum</a> value.
      Default is adStatusOK
      <p>However, when the ConnectComplete event is called, this parameter is set to adStatusCancel
      IF a WillConnect event calls for cancelling of the pending connection</p>
    </td>
  </tr>
  <tr>
    <td>objconn </td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_conn_connect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_conn_connect.asp#top" target="_top">TOP</a> |
		<a href="ev_conn_connect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
