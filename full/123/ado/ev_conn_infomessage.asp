...
<title>ADO InfoMessage Event</title>
<style>a.menu_ev_conn_infomessage{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">InfoMessage</span> Event</h1>
<hr>
...
<p>The InfoMessage event can be fired if a warning occurs in a connection operation.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>objerror </td>
    <td>   An Error object that contains the errors that are
      returned      
    </td>
  </tr>
  <tr>
    <td>status </td>
    <td>   An <a href="ev_conn_infomessage.asp#eventstatusenum">EventStatusEnum</a> value. If a warning occurs,
      status is set to adStatusOK and the objerror contains the warning      
    </td>
  </tr>
  <tr>
    <td>objconn </td>
    <td>   A Connection object. The connection for which the warning
      occurred      
    </td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_conn_infomessage.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_conn_infomessage.asp#top" target="_top">TOP</a> |
		<a href="ev_conn_infomessage.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
