...
<title>ADO Find Method</title>
<style>a.menu_met_rs_find{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Find</span> Method</h1>
<hr>
...
<hr>
<p>The Find method searches for a record in a Recordset that satisfies a specified criteria.
If the search is successful, the record pointer will point to the first found
record.
</p>

<p><b>Note:</b> A current row position (like MoveFirst) must be set before calling this
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
      <td>criteria</td>
      <td>   Required. The column name, comparison operator, and value to use in the
        search.
        <p><b>Examples:</b></p>
        <p>&quot;Country='Norway'&quot;<br>
        &quot;Date>#7/22/97#&quot;<br>
        &quot;Country LIKE N*&quot;</p>
        <p><b>Note:</b> This method does not support multi-column searches (AND
        or OR)</p>
      </td>
    </tr>
    <tr>
      <td>skiprows</td>
      <td>   Optional. Specifies how many records beyond the current
        record to skip before beginning the
        search. Default is 0&nbsp;</td>
    </tr>
    <tr>
      <td>direction</td>
      <td>   Optional. A <a href="met_rs_find.asp#searchdirectionenum">SearchDirectionEnum</a>
        value that specifies the search direction</td>
    </tr>
    <tr>
      <td>start</td>
      <td>   Optional. The starting position for the search</td>
    </tr>
</table>
<br>
<hr>

<a name="searchdirectionenum"><h3>SearchDirectionEnum Values</h3></a>
<table class="reference notranslate">
      <tr>
        <th>Constant</th>
        <th>Value</th>
      ...
      <tr>
        <td>adSearchBackward</td>
        <td>-1</td>
        <td>Searches backward from the starting position. Stops at the beginning of the
          Recordset.
          If no match, the record pointer is placed at the beginning of the
          Recordset</td>
      </tr>
      <tr>
        <td>adSearchForward</td>
        <td>1</td>
        <td>Searches forward from the starting position. Stops at the end of the
          Recordset.
          If no match, the record pointer is placed at the end of the Recordset</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_find.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_find.asp#top" target="_top">TOP</a> |
		<a href="met_rs_find.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
