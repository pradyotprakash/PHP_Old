...
<title>ADO Write Method</title>
<style>a.menu_met_stream_write{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Write</span> Method</h1>
<hr>
...
<hr>
<p>The Write method is used to write binary data to a binary Stream object.</p>
<p>If there is data in the Stream object and the current position is EOS, the new data will be appended
beyond the existing data. If the current position is not EOS,
the existing data will be overwritten.&nbsp;</p>
<p>If you write past EOS, the size of the Stream will increase. EOS will be set to the last
byte in the Stream. If you don't write past EOS, the current position will be set to the next byte after the newly
added data. Previously existing data will not be truncated. Call the SetEOS method to truncate.&nbsp;</p>
<p><b>Note:</b> This method is used only with binary Stream objects, for
textStream objects, use the WriteText method.</p>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
      <td>buffer</td>
      <td>   Required. An array of bytes to be written to a binary
        Stream object
      </td>
    </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_stream_write.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_stream_write.asp#top" target="_top">TOP</a> |
		<a href="met_stream_write.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
