...
<style>a.menu_met_conn_open{font-weight:bold;}</style>
<meta charset="utf-8">
...
<hr>
<p>The Open method opens a connection to a data source.&nbsp;When the connection
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>   Optional. A string value that contains information about the connection.
      The string is composed of a series of parameter=value statements separated by semicolons.
      <p>Provider= the name of the provider<br>
      File Name= the file that contains the connection information<br>
      Remote Provider= the name of the provider to open a client-side connection<br>
      Remote Server= the path name to the server to open a client-side
      connection<br>
      URL= the absolute URL address to use for the connection.&nbsp;</p>
      <p>See the <a href="prop_conn_connectionstring.asp">ConnectionString</a> property for details.</p>
    </td>
  </tr>
  <tr>
    <td>userID </td>
    <td>   Optional. A String value that contains a user name for the connection      
    </td>
  </tr>
  <tr>
    <td>password </td>
    <td>   Optional. A String value that contains a password for the connection      
    </td>
  </tr>
  <tr>
    <td>options </td>
    <td>   Optional. A <a href="met_conn_open.asp#connectoptionenum">ConnectOptionEnum</a>
...
%&gt;<br>
<br>
A DSN-less connection with userID and password<br>
(write the conn.open statement in ONE line):<br>
<br>
&lt;%<br>
set conn=Server.CreateObject(&quot;ADODB.Connection&quot;)<br>
conn.Open &quot;Provider=Microsoft.Jet.OLEDB.4.0;<br>
data source=c:/webdata/northwind.mdb;<br>
userID=xxx;<br>
password=yyy&quot;<br>
%&gt;<br>
<br>
An ODBC Database Connection:<br>
<br>
&lt;%<br>
set conn=Server.CreateObject(&quot;ADODB.Connection&quot;)<br>
...
<br>
<hr>
<a name="connectoptionenum"><h3>ConnectOptionEnum</h3></a>
<table class="reference notranslate">
    <tr>
    ...
    <tr>
      <td>adConnectUnspecified</td>
      <td>-1</td>
      <td>Default. Opens the connection synchronously (after).</td>
    </tr>
    <tr>
      <td>adAsyncConnect</td>
      <td>16</td>
      <td>Opens the connection asynchronously (before).</td>
    </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_conn_open.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_conn_open.asp#top" target="_top">TOP</a> |
		<a href="met_conn_open.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
