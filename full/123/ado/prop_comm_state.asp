...
<style>a.menu_prop_comm_state{font-weight:bold;}</style>
<meta charset="utf-8">
...
closed, connecting, executing or retrieving data. The value returns an <a href="prop_comm_state.asp#ObjectStateEnum">ObjectStateEnum</a> value.
Default is adStateClosed.
</p>

<p>This property can be used with the <b>Command</b>, <b>Connection</b>, <b>Record</b>,
<b>Recordset</b>, and <b>Stream</b> object.</p>

<p>The State property can have a combination of values. If a statement is executing, this property will have a combined value of adStateOpen and
adStateExecuting.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_comm_state.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_comm_state.asp#top" target="_top">TOP</a> |
		<a href="prop_comm_state.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
