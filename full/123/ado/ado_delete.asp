...
<title>ADO Delete Records</title>
<style>a.menu_ado_delete{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Delete Records</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_update.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_demo.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">We may use the SQL DELETE command to delete a record in a 
table in a database.&nbsp;</p>
<hr>
<h2>Delete a Record in a Table</h2>
<p>We want to delete a record in the Customers table in the Northwind database. 
...
&lt;% do until rs.EOF %&gt;<br>
&lt;tr&gt;<br>
&lt;form method=&quot;post&quot; action=&quot;demo_delete.asp&quot;&gt;<br>
&lt;%<br>
for each x in rs.Fields<br>
&nbsp;&nbsp;if x.name=&quot;customerID&quot; then%&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;td&gt;<br>
...
that will delete the current record:</p>
<div class="code notranslate"><div>
...
&nbsp;&nbsp;else<br>
&nbsp;&nbsp;&nbsp;&nbsp;response.write(&quot;Record &quot; &amp; cid &amp; &quot; was deleted!&quot;)<br>
&nbsp;&nbsp;end if<br>
end if<br>
conn.close<br>
%&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_delete.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_delete.asp#top" target="_top">TOP</a> |
		<a href="ado_delete.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
