...
<title>ADO Display</title>
<style>a.menu_ado_display{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Display</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_recordset.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_query.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The most common way to display data from a recordset, is to
display the data in an HTML table.&nbsp;</p>
<hr>

<h2>Display the Field Names and Field Values</h2>
<p>We have a database named &quot;Northwind&quot; and we want to display the
...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a target="_blank" href="showasp.asp?filename=demo_display1" class="showbtn">Show example &raquo;</a>
</div>
<br>
<hr>

<h2>Display the Field Names and Field Values in an HTML Table</h2>
<p>We can also display the data from the &quot;Customers&quot; table inside an HTML
...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a target="_blank" href="showasp.asp?filename=demo_display2" class="showbtn">Show example &raquo;</a>
</div>
...
<p>We want to add headers to the HTML
...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a target="_blank" href="showasp.asp?filename=demo_display3" class="showbtn">Show example &raquo;</a>
</div>
<br>
<hr>
...
<p><a target="_blank" href="showasp.asp?filename=demo_display4">Add colors to the HTML table</a><br>
How to add colors to the HTML table to make it look nice.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_recordset.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_query.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_display.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_display.asp#top" target="_top">TOP</a> |
		<a href="ado_display.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
