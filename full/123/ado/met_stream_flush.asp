...
<title>ADO Flush Method</title>
<style>a.menu_met_stream_flush{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Flush</span> Method</h1>
<hr>
...
<hr>
<p>The Flush method is used when you need to send the contents of the Stream
...
object. This will ensure that all changes made to the contents have been written.</p>
<p><b>Note:</b> ADO flushes the buffer as much as possible in the background,
therefore; it is not usually necessary to call this method.</p>
<h3>Syntax</h3>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_stream_flush.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_stream_flush.asp#top" target="_top">TOP</a> |
		<a href="met_stream_flush.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
