...
<title>ADO GetChildren Method</title>
<style>a.menu_met_rec_getchildren{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">GetChildren</span> Method</h1>
<hr>
...
<hr>
<p>The GetChildren method returns a Recordset object where each row represents a
child of the current Record object.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rec_getchildren.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rec_getchildren.asp#top" target="_top">TOP</a> |
		<a href="met_rec_getchildren.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
