...
<title>ADO ActiveCommand and ActiveConnection Properties</title>
<style>a.menu_prop_rs_active{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">ActiveCommand</span> and <span class="color_h1">ActiveConnection</span> Properties</h1>
<hr>
...
<p>The ActiveCommand property returns a variant that contains the Command object associated with the
Recordset object.
</p>

<p><b>Note:</b>  If the Recordset object was not created by a Command object,
Null is returned.
</p>
...
<p>The ActiveConnection property sets or returns a string or variant that
contains the Connection object associated with the
Recordset object. If the connection is closed, this property sets or returns a
definition for a connection.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_active.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_active.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_active.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
