...
<title>ADO Parameter Object</title>
<style>a.menu_ado_ref_parameter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Parameter</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_ref_field.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_ref_property.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>Parameter Object</h2>
<p>The ADO Parameter object provides information about a single parameter used in a stored procedure or
query.&nbsp;&nbsp;</p>
<p>A Parameter object is added to the Parameters Collection when it is created.
The Parameters Collection is associated with a specific Command object, which uses the
Collection to pass parameters in and out of stored procedures and queries.</p>
<p>Parameters can be used to create Parameterized Commands. These commands are (after they have been
...
criteria of a WHERE clause.</p>
<p>There are four types of parameters: input parameters, output parameters, input/output
parameters and return parameters.</p>
<h3>Syntax</h3>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Appends long binary or character data to a Parameter object</td>
  </tr>
  <tr>
    <td><a href="met_para_delete.asp">Delete</a></td>
    <td>Deletes an object from the Parameters Collection</td>
  </tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_ref_parameter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_ref_parameter.asp#top" target="_top">TOP</a> |
		<a href="ado_ref_parameter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
