...
<style>a.menu_prop_field_attributes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>The Attributes property has read/write permissions on a Connection
      object. Its value can be the sum of one or more <a href="prop_field_attributes.asp#XactAttributeEnum">XactAttributeEnum</a>  values.
      Default value is 0</td>
  </tr>
  <tr>
    <td>Parameter </td>
    <td>   The Attributes property has read/write permissions on a Parameter
      object. Its value can be the sum of one or more <a href="prop_field_attributes.asp#ParameterAttributesEnum">ParameterAttributesEnum</a> values.
  ...
  <tr>
    ...
    <td>   <p>The Attributes property has read/write permissions when
      ...
      existing Recordset. Its value can be the sum of one or more <a href="prop_field_attributes.asp#FieldAttributeEnum">FieldAttributeEnum</a> 
      values
</p>
  ...
  <tr>
    ...
    <td>   The Attributes property is read-only for a Property
      object. Its value can be the sum of one or more <a href="prop_field_attributes.asp#PropertyAttributesEnum">PropertyAttributesEnum</a>
      values
    </td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_field_attributes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_field_attributes.asp#top" target="_top">TOP</a> |
		<a href="prop_field_attributes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
