...
<title>ADO HelpContext Property</title>
<style>a.menu_prop_err_helpcontext{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">HelpContext</span> Property</h1>
<hr>
...
<hr>
<p>The HelpContext property returns a long value that is the context ID of a
topic in the Microsoft Windows help system.
</p>

<p>This property allows you to interact with the Windows help system, i.e. you
can call the Windows API Help functions.
</p>

<p>The HelpContext property returns zero if you do not have access to interact with the
Windows help system.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_err_helpcontext.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_err_helpcontext.asp#top" target="_top">TOP</a> |
		<a href="prop_err_helpcontext.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
