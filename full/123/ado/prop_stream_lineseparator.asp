...
<title>ADO LineSeparator Property</title>
<style>a.menu_prop_stream_lineseparator{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">LineSeparator</span> Property</h1>
<hr>
...
<hr>
<p>The LineSeparator property sets or returns a <a href="prop_stream_lineseparator.asp#lineseparatorsenum"> LineSeparatorsEnum</a> value that
indicates the line separator character used in a text Stream object. Default is
adCRLF.
</p>
...
<a name="lineseparatorsenum"><h3>LineSeparatorsEnum</h3></a>
<table class="reference notranslate">
      ...
      <tr>
        <td>adCRLF</td>
        <td>-1</td>
        <td>Default. Carriage return line feed</td>
      </tr>
      <tr>
        <td>adLF</td>
        <td>10</td>
        <td>Line feed only</td>
      </tr>
      <tr>
        <td>adCR</td>
        <td>13</td>
        <td>Carriage return only</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_stream_lineseparator.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_stream_lineseparator.asp#top" target="_top">TOP</a> |
		<a href="prop_stream_lineseparator.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
