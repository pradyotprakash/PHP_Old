...
<title>ADO Sort</title>
<style>a.menu_ado_sort{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Sort</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_query.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_add.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">We may use SQL to specify how to sort the data in the record 
set.&nbsp;</p>
<hr>
<h2>Sort the Data</h2>
<p>We want to display the &quot;Companyname&quot; and &quot;Contactname&quot; fields from the &quot;Customers&quot; 
table, ordered by &quot;Companyname&quot; (remember to save the file with an .asp extension):</p>
<div class="example">
...
sql=&quot;SELECT Companyname, Contactname FROM<br>
Customers ORDER BY CompanyName&quot;<br>
rs.Open sql, conn<br>
%&gt;<br>
<br>
...
<br><a target="_blank" href="showasp.asp?filename=demo_sort_1" class="showbtn">Show example &raquo;</a>
</div>
...
<p><a target="_blank" href="showasp.asp?filename=demo_sort_2">Sort the records on a specified fieldname 
descending</a><br>
How to sort the data on a specified fieldname.</p>
<p><a target="_blank" href="showasp.asp?filename=demo_sort_3">Let the user choose what column to sort on</a><br>
Let the user choose what column to sort on.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_query.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_add.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_sort.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_sort.asp#top" target="_top">TOP</a> |
		<a href="ado_sort.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
