...
<title>ADO UpdateBatch Method</title>
<style>a.menu_met_rs_updatebatch{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">UpdateBatch</span> Method</h1>
<hr>
...
<hr>
<p>The UpdateBatch method is used to save all changes in a Recordset to the database. This
method is used when you are working on a Recordset in batch update mode.
</p>

<p>If the save operation fails, a
run-time error occurs and the errors are stored in the Errors collection.
</p>

<p><b>Tip:</b> The CancelBatch method cancels all batch updates.
</p>

<p><b>Note:</b> Not all Recordset objects supports batch updating.
</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>affectrecords </td>
    <td>   Optional. An <a href="met_rs_updatebatch.asp#affectenum"> AffectEnum</a> value
      that specifies which records this method will affect.
      <p><b>Note:</b> The value adAffectGroup will generate an error if there
      are no visible records in the Recordset</p>
    </td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_updatebatch.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_updatebatch.asp#top" target="_top">TOP</a> |
		<a href="met_rs_updatebatch.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
