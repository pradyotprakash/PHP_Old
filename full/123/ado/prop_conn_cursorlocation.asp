...
<title>ADO CursorLocation Property</title>
<style>a.menu_prop_conn_cursorlocation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">CursorLocation</span> Property</h1>
<hr>
...
<hr>
<p>The CursorLocation property sets or returns a long value that indicates the location of the cursor service.
It can be set to one of the <a href="prop_conn_cursorlocation.asp#cursorlocationenum">CursorLocationEnum</a>
values. Default value is AdUseServer.
</p>

<p>A cursor is used to:
</p>

<ul>
  <li>control record navigation</li>
  <li>control the visibility of changes in the database</li>
  <li>control the updatability of data</li>
</ul>

<p><b>Note:</b> A Recordset object inherits this setting from the associated
Connection object.
</p>

<p><b>Note:</b> This property is read-only on an open Recordset object, and read/write on a Connection
object or
...
objConnection.CursorLocation<i><br>
</i>objRecordset.CursorLocation
...
rs.LockType=adLockBatchOptimistic<br>
<br>
rs.Open sql,conn<br>
<br>
rs.Close<br>
...
<br>
<hr>
<a name="cursorlocationenum"><h3>CursorLocationEnum Values</h3></a>
<table class="reference notranslate">
  <tbody>
    ...
    <tr>
      <td>adUseNone</td>
      <td>1</td>
      <td>OBSOLETE (appears only for backward compatibility). Does not use cursor
        services</td>
    </tr>
    <tr>
      <td>adUseServer</td>
      <td>2</td>
      <td>Default. Uses a server-side cursor</td>
    </tr>
    <tr>
      <td>adUseClient</td>
      <td>3</td>
      <td>Uses a client-side cursor supplied by a local cursor library. For backward compatibility,
        the synonym adUseClientBatch is also supported</td>
    </tr>
  </tbody>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_conn_cursorlocation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_conn_cursorlocation.asp#top" target="_top">TOP</a> |
		<a href="prop_conn_cursorlocation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
