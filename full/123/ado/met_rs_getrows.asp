...
<style>a.menu_met_rs_getrows{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">GetRows</span> Method</h1>
<hr>
...
<table class="reference notranslate">
    ...
    <tr>
      <td>rows</td>
      <td>   Optional. A <a href="met_rs_getrows.asp#getrowsoptionenum">GetRowsOptionEnum</a>
        value that specifies the number of records to retrieve.
        Default is adGetRowsRest.<p><b>Note:</b> If you omit this argument it will retrieve all
    ...
    <tr>
      <td>start</td>
      <td>   
        <p>   Optional. What record to start on, a record number or a <a href="met_rs_getrows.asp#bookmarkenum"> BookmarkEnum</a>
        value</td>
    </tr>
    <tr>
      <td>fields</td>
      <td>   Optional. If you want to specify only the fields that the GetRows call
...
<br>
'The first number indicates how many records to copy<br>
'The second number indicates what recordnumber to start on<br>
p=rs.GetRows(2,0)<br>
rs.close<br>
conn.close<br>
<br>
'This example returns the value of the first<br>
'column in the first two records<br>
response.write(p(0,0))<br>
response.write(&quot;&lt;br>&quot;)<br>
response.write(p(0,1))<br>
<br>
'This example returns the value of the first<br>
'three columns in the first record<br>
response.write(p(0,0))<br>
response.write(&quot;&lt;br>&quot;)<br>
response.write(p(1,0))<br>
response.write(&quot;&lt;br>&quot;)<br>
response.write(p(2,0))<br>
%&gt;

</div></div>
<br>
<hr>
<a name="getrowsoptionenum"><h3>GetRowsOptionEnum Values</h3></a>
<table class="reference notranslate">
      <tr>
      ...
      <tr>
        <td>adGetRowsRest</td>
        <td>-1</td>
        <td>Retrieves the rest of the records in the Recordset object</td>
      </tr>
  </table>
<br>
<hr>

<a name="bookmarkenum"><h3>BookmarkEnum Values</h3></a>
<table class="reference notranslate">
      <tr>
        <th style="width:30%">Constant</th>
        <th style="width:10%">Value</th>
      ...
      <tr>
        <td>adBookmarkCurrent</td>
        <td>0</td>
        <td>Starts at the current record</td>
      </tr>
      <tr>
        <td>adBookmarkFirst</td>
        <td>1</td>
        <td>Starts at the first record</td>
      </tr>
      <tr>
        <td>adBookmarkLast</td>
        <td>2</td>
        <td>Starts at the last record</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_getrows.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_getrows.asp#top" target="_top">TOP</a> |
		<a href="met_rs_getrows.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
