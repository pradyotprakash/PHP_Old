...
<title>ADO IsolationLevel Property</title>
<style>a.menu_prop_conn_isolationlevel{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">IsolationLevel</span> Property</h1>
<hr>
...
<hr>
<p>The IsolationLevel property sets or returns the isolation level of a Connection object.
The value is an <a href="prop_conn_isolationlevel.asp#isolationlevelenum">IsolationLevelEnum</a> value.
Default is adXactChaos.
</p>

<p><b>Note:</b> The IsolationLevel settings will not work until next time BeginTrans
is called.
</p>
...
conn.IsolationLevel=adXactIsolated<br>
conn.Open(Server.Mappath(&quot;northwind.mdb&quot;))<br>
<br>
response.write(conn.IsolationLevel)<br>
<br>
conn.Close<br>
%&gt;
...
<br>
<hr>
<a name="isolationlevelenum"><h3>IsolationLevelEnum</h3></a>
<table class="reference notranslate">
    ...
    <tr>
      <td>adXactUnspecified</td>
      <td>-1</td>
      <td>Cannot use the specified isolation level, because the
        provider is using a different isolation level, and that level cannot be
        determined.</td>
    </tr>
    <tr>
      <td>adXactChaos</td>
      <td>16</td>
      <td>Cannot overwrite higher level transactions.</td>
    </tr>
    <tr>
      <td>adXactBrowse</td>
      <td>256</td>
      <td>Can view uncommitted changes in other transactions.</td>
    </tr>
    <tr>
      <td>adXactReadUncommitted</td>
      <td>256</td>
      <td>Same as adXactBrowse.</td>
    </tr>
    <tr>
      <td>adXactCursorStability</td>
      <td>4096</td>
      <td>Can view committed changes in other transactions.</td>
    </tr>
    <tr>
      <td>adXactReadCommitted</td>
      <td>4096</td>
      <td>Same as adXactCursorStability.</td>
    </tr>
    <tr>
      <td>adXactRepeatableRead</td>
      <td>65536</td>
      <td>Cannot see changes in other transactions, but you can
        requery</td>
    </tr>
    <tr>
      <td>adXactIsolated</td>
      <td>1048576</td>
      <td>Your transactions are isolated from all other
        transactions.</td>
    </tr>
    <tr>
      <td>adXactSerializable</td>
      <td>1048576</td>
      <td>Same as adXactIsolated.</td>
    </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_conn_isolationlevel.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_conn_isolationlevel.asp#top" target="_top">TOP</a> |
		<a href="prop_conn_isolationlevel.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
