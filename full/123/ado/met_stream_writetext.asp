...
<title>ADO WriteText Method</title>
<style>a.menu_met_stream_writetext{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">WriteText</span> Method</h1>
<hr>
...
<hr>
<p>The WriteText method is used to write a text to a text Stream object.</p>
<p>If there is data in the Stream object and the current position is EOS, the new
data will be appended beyond the existing data. If the current position is not
EOS,
the existing data will be overwritten.</p>
<p>If you write past EOS, the size of the Stream will increase. EOS will be set to the last character in the Stream.
If you don't write past EOS, the current position will be set to the next
character after the newly
added data. Previously existing data will not be truncated. Call the SetEOS method to truncate.&nbsp;</p>
<p><b>Note:</b> This method is used only with text Stream objects, for binary
Stream objects, use the Write method.</p>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
      <td>data</td>
      <td>   Required. The text to be written to a text Stream
        object
      </td>
    </tr>
    <tr>
      <td>opt</td>
      <td>   Optional. A <a href="met_stream_writetext.asp#streamwriteenum"> StreamWriteEnum</a> value that specifies whether a line separator
        must be
        added to the text
      </td>
    </tr>
...
<a name="streamwriteenum"><h3>StreamWriteEnum Value</h3></a>
<table class="reference notranslate">
      <tr>
        <th>Constant</th>
        <th>Value</th>
      ...
      <tr>
        <td>adWriteChar</td>
        <td>0</td>
        <td>Default. Writes the specified text to a Stream object</td>
      </tr>
      <tr>
        <td>adWriteLine</td>
        <td>1</td>
        <td>Writes the specified text and a line separator to a Stream object. If the
          LineSeparator
          property is not defined, a run-time error will occur</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_stream_writetext.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_stream_writetext.asp#top" target="_top">TOP</a> |
		<a href="met_stream_writetext.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
