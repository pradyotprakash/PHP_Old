...
<title>ADO Type Property</title>
<style>a.menu_prop_prop_type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Type</span> Property</h1>
<hr>
...
<hr>
<p>The Type property sets or returns a <a href="prop_prop_type.asp#datatypeenum">DataTypeEnum</a>
 value that indicates the type of a Parameter, Field, or a Property object.</p>

<table class="reference notranslate">
  <tr>
    <th style="width:20%">Object</th>
    <th>Description of the Type
      Property</th>
  </tr>  
  <tr>
    <td>Parameter </td>
    <td>   The Type property has read/write permissions on a Parameter
      object
    </td>
  </tr>
  <tr>
    <td>Field </td>
    <td>   <p>The Type property is read/write, with one exception; for new Field objects that
  ...
  <tr>
    <td>Property </td>
    <td>   The Type property is read-only for a Property object
    </td>
  </tr>
</table>
...
<br>
response.write(rs.Fields(0).Type)<br>
<br>
rs.Close<br>
conn.close<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_prop_type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_prop_type.asp#top" target="_top">TOP</a> |
		<a href="prop_prop_type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
