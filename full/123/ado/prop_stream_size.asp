...
<title>ADO Size Property</title>
<style>a.menu_prop_stream_size{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Size</span> Property</h1>
<hr>
...
<hr>
<p>The Size property returns a long value that indicates the size (in bytes) of a Stream object.
</p>

<p><b>Note:</b> This property can only be used on an open Stream object.
</p>

<p><b>Note:</b> This property returns -1 if the size of the stream is unknown.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_stream_size.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_stream_size.asp#top" target="_top">TOP</a> |
		<a href="prop_stream_size.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
