...
<title>ADO ActiveConnection Property</title>
<style>a.menu_prop_rec_activeconn{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">ActiveConnection</span> Property</h1>
<hr>
...
<hr>
<p>The ActiveConnection property sets or returns a string or variant that tells which Connection object the Record object
belongs to.
</p>

<p>If the connection is closed, it sets or returns a string definition for a
connection. If the connection is open it sets or returns a variant that is a
reference to the current Connection
object.</p>

<p><b>Tip:</b> The ActiveConnection parameter of the Open method of the Record object
can also be used to set this property.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rec_activeconn.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rec_activeconn.asp#top" target="_top">TOP</a> |
		<a href="prop_rec_activeconn.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
