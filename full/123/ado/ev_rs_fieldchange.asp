...
<title>ADO The WillChangeField and FieldChangeComplete Events</title>
<style>a.menu_ev_rs_fieldchange{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">WillChangeField</span> and 
<span class="color_h1">FieldChangeComplete</span> Events</h1>
<hr>
...
<h3>The WillChangeField Event
</h3>

<p>The WillChangeField event is triggered before the values of one or more Field
Objects are changing.
</p>

<p><b>Note:</b> Before this event returns, set the status parameter to adStatusCancel to
cancel the operation that caused this event.&nbsp;
</p>

<h3>The FieldChangeComplete Event
</h3>

<p>The FieldChangeComplete event is triggered after the values of one or more
...
<p><b>Note:</b> The WillChangeField event and the FieldChangeComplete event may occur when
you set the Value property and calls the Update method with field and value array parameters.
</p>
...
WillChangeField numfields,fields,status,objRs<br>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>numfields </td>
    <td>   The number of Field objects in fields      
    </td>
  </tr>
  <tr>
    <td>fields </td>
    <td>   An array that contains Field objects with changes      
    </td>
  </tr>
  <tr>
    <td>status </td>
    <td>   An <a href="ev_rs_fieldchange.asp#EventStatusEnum"> EventStatusEnum</a> 
      value that indicates the status of the execution of the event      
    </td>
  </tr>
  <tr>
    <td>objErr </td>
    <td>   The name of an Error object that describes the error if
      status is
      set to adStatusErrorsOccurred, otherwise it is not set      
    </td>
  </tr>
  <tr>
    <td>objRs </td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_rs_fieldchange.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_rs_fieldchange.asp#top" target="_top">TOP</a> |
		<a href="ev_rs_fieldchange.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
