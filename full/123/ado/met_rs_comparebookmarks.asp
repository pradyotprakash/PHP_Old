...
<title>ADO CompareBookmarks Method</title>
<style>a.menu_met_rs_comparebookmarks{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">CompareBookmarks</span> Method</h1>
<hr>
...
<hr>
<p>The CompareBookmarks method compares two bookmarks. This method returns a <a href="met_rs_comparebookmarks.asp#compareenum">CompareEnum</a>
value
that indicates the bookmark's relative row positions.
</p>

<p><b>Note:</b> The two bookmarks must be within the same Recordset, or
within a Recordset and its clone.
</p>

<p><b>Note:</b> You can use this method only if the provider support bookmarks.
</p>
...
<table class="reference notranslate">
    ...
    <tr>
      <td>mark1</td>
      <td>   The bookmark of the first row</td>
    </tr>
    <tr>
      <td>mark2</td>
      <td>   The bookmark of the second row</td>
    </tr>
</table>
<br>
<hr>

<a name="compareenum"><h3>CompareEnum Values</h3></a>
<table class="reference notranslate">
      <tr>
        <th>Constant</th>
        <th>Value</th>
      ...
      <tr>
        <td>adCompareLessThan</td>
        <td>0</td>
        <td>The first bookmark is before the second</td>
      </tr>
      <tr>
        <td>adCompareEqual</td>
        <td>1</td>
        <td>The bookmarks are equal</td>
      </tr>
      <tr>
        <td>adCompareGreaterThan</td>
        <td>2</td>
        <td>The first bookmark is after the second</td>
      </tr>
      <tr>
        <td>adCompareNotEqual</td>
        <td>3</td>
        <td>The bookmarks are not equal</td>
      </tr>
      <tr>
        <td>adCompareNotComparable</td>
        <td>4</td>
        <td>The bookmarks cannot be compared</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_comparebookmarks.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_comparebookmarks.asp#top" target="_top">TOP</a> |
		<a href="met_rs_comparebookmarks.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
