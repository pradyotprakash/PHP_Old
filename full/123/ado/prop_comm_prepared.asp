...
<title>ADO Prepared Property</title>
<style>a.menu_prop_comm_prepared{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Prepared</span> Property</h1>
<hr>
...
<hr>
<p>The Prepared property sets or returns a Boolean value that, if set to True,
indicates that the command should save a prepared version of the query specified in the CommandText property
before execution.
</p>

<p>This could slow down the command's first execution, but after the
first execution the provider will use the compiled version, which results in a
faster execution.
</p>
...
comm.ActiveConnection=conn<br>
comm.CommandText=&quot;orders&quot;<br>
comm.Prepared=true<br>
response.write(comm.Prepared)<br>
<br>
conn.close<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_comm_prepared.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_comm_prepared.asp#top" target="_top">TOP</a> |
		<a href="prop_comm_prepared.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
