...
<title>ADO ConnectionString Property</title>
<style>a.menu_prop_conn_connectionstring{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">ConnectionString</span> Property</h1>
<hr>
...
<hr>
<p>The ConnectionString property sets or returns the details used to create a
connection to a data source.
</p>

<p><b>Note:</b> You can not use both the Provider and File Name parameters.
</p>
...
<p>The ConnectionString property has these parameters:</p>
<table class="reference notranslate">
    ...
    <tr>
      <td>Provider</td>
      <td>The provider to use for the connection</td>
    </tr>
    <tr>
      <td>File Name</td>
      <td>A provider-specific file that contains connection
        information</td>
    </tr>
    <tr>
      <td>
Remote Provider</td>
      <td>The provider to use when opening a client-side connection</td>
    </tr>
    <tr>
      <td>
Remote Server</td>
      <td>A path name of the server to use when opening a client-side
        connection</td>
    </tr>
    <tr>
      <td>url</td>
      <td>An absolute URL identifying a resource, such as a file or
        directory</td>
    </tr>
</table>
<h3>Example</h3>
...
conn.open server.mappath(&quot;database.mdb&quot;)<br>
<br>
conn.close<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_conn_connectionstring.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_conn_connectionstring.asp#top" target="_top">TOP</a> |
		<a href="prop_conn_connectionstring.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
