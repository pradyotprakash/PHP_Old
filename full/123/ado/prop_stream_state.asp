...
<title>ADO State Property</title>
<style>a.menu_prop_stream_state{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">State</span> Property</h1>
<hr>
...
<hr>
<p>The State property returns a value that describes if the object is open,
closed, connecting, executing or retrieving data. The value returns an <a href="prop_stream_state.asp#ObjectStateEnum">ObjectStateEnum</a> value.
Default is adStateClosed.
</p>

<p>This property can be used with the <b>Command</b>, <b>     Connection</b>, <b>     Record</b>,
<b>     Recordset</b>, and <b>Stream</b> object.
</p>

<p>
The State property can have a combination of values. If a statement is executing, this property will have a combined value of adStateOpen and
adStateExecuting.
</p>
...
<h3>Example - For a Command object:</h3>
<div class="code notranslate"><div>
...
<br>
set comm=Server.CreateObject(&quot;ADODB.Command&quot;)<br>
response.write(comm.State)<br>
<br>
conn.close<br>
%&gt;
</div></div>
...
<h3>ObjectStateEnum Values</h3>
<p>Specifies whether an object is open or closed, connecting to a data source,
executing a command, or retrieving data.</p>
...
<tr>
  <td>adStateClosed</td>
  <td>0</td>
  <td>The object is closed</td>
</tr>
<tr>
  <td>adStateOpen</td>
  <td>1</td>
  <td>The object is open</td>
</tr>
<tr>
  <td>adStateConnecting</td>
  <td>2</td>
  <td>The object is connecting</td>
</tr>
<tr>
  <td>adStateExecuting</td>
  <td>4</td>
  <td>The object is executing a command</td>
</tr>
<tr>
  <td>adStateFetching</td>
  <td>8</td>
  <td>The rows of the object are being retrieved</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_stream_state.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_stream_state.asp#top" target="_top">TOP</a> |
		<a href="prop_stream_state.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
