...
<title>ADO StayInSync Property</title>
<style>a.menu_prop_rs_stayinsync{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">StayInSync</span> Property</h1>
<hr>
...
<hr>
<p>The StayInSync property sets or returns a boolean value that indicates whether the reference to the
child records will change when the parent record position changes. Default value is
true, which means that the child records will be updated if the parent Recordset object changes
record position.
</p>

<p><b>Note:</b> This property is used with hierarchical recordsets.
</p>

<p><b>Note:</b> This property must be set on the parent Recordset before the child Recordset is retrieved.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_stayinsync.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_stayinsync.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_stayinsync.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
