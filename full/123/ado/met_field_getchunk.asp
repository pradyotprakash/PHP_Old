...
<title>ADO GetChunk Method</title>
<style>a.menu_met_field_getchunk{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">GetChunk</span> Method</h1>
<hr>
...
<hr>
<p>The GetChunk method returns a variant that contains all or a part of the
contents of a large text or binary data Field object.
</p>

<p>This method can divide long values into small portions, so if the system
memory is limited and can't deal with long values, this method can be used.
</p>

<p>When the GetChunk method is called, it starts to retrieve data from where the previous GetChunk call
ended, as long as you stay on the same field in the current record.
</p>

<p>You can use the GetChunk method for a field if the Attributes property of a
Field object is set to adFldLong.
</p>

<p><b>Note:</b> There has to be a current record when you use the GetChunk method on a Field
object.
</p>

<p><b>Note:</b> This method does not work on Field objects of a Record object.
</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>size </td>
    <td>   A long value that is the number of bytes or characters to be returned.
      <p> If size&gt;remaining data, this method returns only the remaining data without
      empty spaces. If the field is empty, it returns a null value.</p>
    </td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_field_getchunk.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_field_getchunk.asp#top" target="_top">TOP</a> |
		<a href="met_field_getchunk.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
