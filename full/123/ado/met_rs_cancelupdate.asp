...
<title>ADO CancelUpdate Method</title>
<style>a.menu_met_rs_cancelupdate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">CancelUpdate</span> Method</h1>
<hr>
...
<hr>
<p>The CancelUpdate method cancels changes made to a record of a Recordset object, or the Fields collection of a Record object, before calling the Update
method.
</p>

<h3><b>Recordset object</b>
</h3>

<p>This method is used to cancel any changes made to the current record or to a newly added
record. This method can only be called before the Update method of the Recordset
is called.
</p>
...
<p>This method is used to cancel any changes (insertions or deletions) of Field
objects.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_cancelupdate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_cancelupdate.asp#top" target="_top">TOP</a> |
		<a href="met_rs_cancelupdate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
