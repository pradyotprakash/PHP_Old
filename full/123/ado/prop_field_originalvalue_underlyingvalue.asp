...
<title>ADO OriginalValue and UnderlyingValue Properties</title>
<style>a.menu_prop_field_originalvalue_underlyingvalue{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">OriginalValue</span> and <span class="color_h1">UnderlyingValue</span> Properties</h1>
<hr>
...
<hr>
<p>The <b>OriginalValue</b> property returns a variant that contains the field value as
it existed right after the last Update or UpdateBatch method call.</p>

<p>The <b>UnderlyingValue</b> property returns a variant that contains the
current value of a field. This value does not necessarily show changes made by other users and may not be the latest value.</p>

<p><b>Tip:</b> Use the Resync property of the Recordset object to get the latest values for all of the Field objects in the Fields Collection.</p>
<p><b>Tip:</b> These properties can be used together to prevent update conflicts.</p>

<h3>Syntax</h3>
<div class="code notranslate"><div>

objField.OriginalValue<br>
<br>
...
<br>
set objfield=rs.fields(&quot;companyname&quot;)<br>
<br>
'Some code..................<br>
<br>
...
&nbsp;&nbsp;if objfield.OriginalValue&lt;&gt;objfield.UnderlyingValue then<br>
&nbsp;&nbsp;&nbsp;&nbsp;response.write(&quot;Data has changed!&lt;br>&quot;)<br>
&nbsp;&nbsp;&nbsp;&nbsp;response.write(&quot;Original value: &quot;)<br>
&nbsp;&nbsp;&nbsp;&nbsp;response.write(objfield.OriginalValue &amp; &quot;&lt;br>&quot;)<br>
&nbsp;&nbsp;&nbsp;&nbsp;response.write(&quot;Current value: &quot;)<br>
&nbsp;&nbsp;&nbsp;&nbsp;response.write(objfield.UnderlyingValue &amp; &quot;&lt;br>&quot;)<br>
&nbsp;&nbsp;end if<br>
&nbsp;&nbsp;rs.movenext<br>
next<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_field_originalvalue_underlyingvalue.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_field_originalvalue_underlyingvalue.asp#top" target="_top">TOP</a> |
		<a href="prop_field_originalvalue_underlyingvalue.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
