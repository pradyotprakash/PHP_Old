...
<title>ADO CopyTo Method</title>
<style>a.menu_met_stream_copyto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">CopyTo</span> Method</h1>
<hr>
...
<hr>
<p>The CopyTo method is used to copy a specified number of characters or bytes from an
open Stream object into another open Stream object.</p>
<p>The type of the two Stream objects should be the same. However, text Stream objects can be
copied into binary Stream objects, but not vice-versa, and the CharSet property of the destination Stream object
can be different than the source Stream object.&nbsp;</p>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
      <td>dest</td>
      <td>   Required. Where to copy the Stream (contains a reference to an open Stream object)
      </td>
    </tr>
    <tr>
      <td>numchars</td>
      <td>   Optional. An integer that specifies the number of characters
        or bytes to be copied from the current position in the source Stream to
        the destination Stream. Default is -1 (will copy all data from the current position to
        EOS)
        <p><b>Note:</b> If the specified number is greater than the available number of bytes/characters until EOS, then only
        bytes/characters from the current position to EOS are copied</p>
      </td>
    </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_stream_copyto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_stream_copyto.asp#top" target="_top">TOP</a> |
		<a href="met_stream_copyto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
