...
<title>ADO GetString Method</title>
<style>a.menu_met_rs_getstring{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">GetString</span> Method</h1>
<hr>
...
<hr>
<p>The GetString method returns the specified Recordset as a string. This method
can be used to fill HTML tables in ASP files.</p>
...
<table class="reference notranslate">
    ...
    <tr>
      <td>format</td>
      <td>   Optional. A <a href="met_rs_getstring.asp#stringformatenum"> StringFormatEnum</a>
    ...
    <tr>
      <td>n</td>
      <td>   
        <p>Optional. The number of rows to be converted in the Recordset</td>
    </tr>
    <tr>
      <td>coldel</td>
      <td>   Optional. If format is set to adClipString it is a column delimiter.
    ...
    <tr>
      <td>rowdel</td>
      <td>   Optional. If format is set to adClipString it is a row delimiter.
    ...
    <tr>
      <td>nullexpr</td>
      <td>   Optional. If format is set to adClipString it is an expression used
...
<h2>Example</h2>
<p>To create an HTML table with data from a recordset, we only need to use three of the parameters above:</p>
<ul>
...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a target="_blank" href="showasp.asp?filename=demo_display5" class="showbtn">Show example &raquo;</a>
</div>
<hr>

<a name="stringformatenum"><h3>StringFormatEnum Values</h3></a>
<table class="reference notranslate">
      <tr>
        <th>Constant</th>
        <th>Value</th>
      ...
      <tr>
        <td>adClipString</td>
        <td>2</td>
        <td>Delimits rows by the rowdel parameter, columns by the coldel
          parameter,
          and null values by the nullexpr parameter</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_getstring.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_getstring.asp#top" target="_top">TOP</a> |
		<a href="met_rs_getstring.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
