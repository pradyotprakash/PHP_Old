...
<title>ADO CommandTimeout Property</title>
<style>a.menu_prop_conn_commandtimeout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">CommandTimeout</span> Property</h1>
<hr>
...
<hr>
<p>The CommandTimeout property sets or returns the number of seconds to wait
while attempting to execute a command, before canceling the attempt and generate
an error. Default is 30.
</p>
...
comm.CommandTimeout=10<br>
response.write(comm.CommandTimeout)<br>
<br>
conn.close<br>
%&gt;<br>
<br>
...
conn.Open &quot;c:/webdata/northwind.mdb&quot;<br>
<br>
conn.CommandTimeout=10<br>
response.write(conn.CommandTimeout)<br>
<br>
conn.close<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_conn_commandtimeout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_conn_commandtimeout.asp#top" target="_top">TOP</a> |
		<a href="prop_conn_commandtimeout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
