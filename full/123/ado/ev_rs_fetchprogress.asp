...
<title>ADO FetchProgress Event</title>
<style>a.menu_ev_rs_fetchprogress{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">FetchProgress</span> Event</h1>
<hr>
...
<hr>
<p>The FetchProgress event is triggered periodically in an asynchronous operation, to
...
<p>The number of records that have been fetched by the operation
</p>
...
<p>The maximum number of records that are expected to be fetched
</p>
  ...
  <tr>
    <td>status </td>
    <td>   An <a href="ev_rs_fetchprogress.asp#EventStatusEnum">EventStatusEnum</a> value
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_rs_fetchprogress.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_rs_fetchprogress.asp#top" target="_top">TOP</a> |
		<a href="ev_rs_fetchprogress.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
