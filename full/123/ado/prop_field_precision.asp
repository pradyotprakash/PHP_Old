...
<title>ADO Precision Property</title>
<style>a.menu_prop_field_precision{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Precision</span> Property</h1>
<hr>
...
<hr>
<p>The Precision property sets or returns a byte value that is the maximum number of digits allowed
when representing numeric values in a Parameter or Field object.
</p>
...
<table class="reference notranslate">
    ...
    <tr>
      <td>Field</td>
      <td>
        <p>The Precision property is normally read-only on a Field object, but
        for new Field objects that have been added to the Fields collection of a Record,
        it is read/write after the Value property for the Field has been specified and the
        provider has successfully added the new Field by calling the Update method of the Fields
        collection</p>
      </td>
    </tr>
    <tr>
      <td>Parameter</td>
      <td>The Precision property has read/write permissions on a Parameter
        object</td>
    </tr>
</table>
...
<br>
response.write(rs.Fields(0).Precision)<br>
<br>
rs.Close<br>
conn.close<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_field_precision.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_field_precision.asp#top" target="_top">TOP</a> |
		<a href="prop_field_precision.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
