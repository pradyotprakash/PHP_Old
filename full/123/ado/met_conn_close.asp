...
<style>a.menu_met_conn_close{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Close</span> Method</h1>
<hr>
...
<hr>
<p>The Close method is used to close a <b> Connection</b> object, a <b> Record</b> object, a
<b>
Recordset</b> object, or a <b> Stream</b> object to free
system resources.&nbsp;
</p>

<p><b>Note:</b> When an object is closed, it will <b> not</b> be removed from the memory. It is
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_conn_close.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_conn_close.asp#top" target="_top">TOP</a> |
		<a href="met_conn_close.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
