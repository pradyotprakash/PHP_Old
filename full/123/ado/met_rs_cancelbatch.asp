...
<title>ADO CancelBatch Method</title>
<style>a.menu_met_rs_cancelbatch{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">CancelBatch</span> Method</h1>
<hr>
...
<p>The CancelBatch method cancels a batch update. The Recordset must be in batch update
mode when calling this method.</p>

<p>Since you do not know what the current record will be after calling this property,
you will have to move to a known record. For example, you could call the MoveFirst
or MoveLast method, after a call to this method.</p>

<p>If this method fails, the provider will not stop the execution, but it will send
a warning to the Errors Collection.&nbsp;</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>affectrec </td>
    <td>   Optional. An <a href="met_rs_cancelbatch.asp#affectenum"> AffectEnum</a> value that
      indicates which records this method will affect      
    </td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_cancelbatch.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_cancelbatch.asp#top" target="_top">TOP</a> |
		<a href="met_rs_cancelbatch.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
