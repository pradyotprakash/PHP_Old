...
<title>ADO Save Method</title>
<style>a.menu_met_rs_save{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Save</span> Method</h1>
<hr>
...
<hr>
<p>The Save method saves a Recordset object to a file or a Stream object. When
the save method is finished, the record pointer will point at the first record
of the Recordset.
</p>

<p><b>Note:</b> If there is a filter applied to the Recordset, only the
&quot;filtered&quot; records will be saved.&nbsp;
</p>

<p><b>Note:</b> This method can only be called on an open Recordset.
</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>destination </td>
    <td>   Optional. Specifies where to save the Recordset object;
      the
      path name of a file or a reference to a Stream object</td>
  </tr>
  <tr>
    <td>persistformat </td>
    <td>   Optional. A <a href="met_rs_save.asp#persistformatenum">
      PersistFormatEnum</a> value that specifies the format of the Recordset (XML or
      ADTG). Default is adPersistADTG</td>
  </tr>
</table>
...
You can save a Recordset in XML format:<br>
<br>
&lt;%<br>
...
'Save the Recordset into a DOM tree<br>
rs.Save xmldoc, 1<br>
%&gt;
...
<h3><a name="persistformatenum">PersistFormatEnum Values</a></h3>
<table class="reference notranslate">
      <tr>
        <th>Constant</th>
        <th>Value</th>
      ...
      <tr>
        <td>adPersistADTG</td>
        <td>0</td>
        <td>Saves in a Microsoft Advanced Data TableGram (ADTG) format.</td>
      </tr>
      <tr>
        <td>adPersistXML</td>
        <td>1</td>
        <td>Saves in Extensible Markup Language (XML) format</td>
      </tr>
      <tr>
        <td>adPersistADO</td>
        <td>1</td>
        <td>Saves in ADO's own Extensible Markup Language
          (XML) format. This value is the same as adPersistXML and
          is included for backwards compatibility</td>
      </tr>
      <tr>
        <td>adPersistProviderSpecific</td>
        <td>2</td>
        <td>The provider will persist the Recordset
          using its own format</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_save.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_save.asp#top" target="_top">TOP</a> |
		<a href="met_rs_save.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
