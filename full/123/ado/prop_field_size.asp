...
<title>ADO DefinedSize and ActualSize Properties</title>
<style>a.menu_prop_field_size{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">DefinedSize</span> and <span class="color_h1">ActualSize</span> Properties</h1>
<hr>
...
<hr>
<p>The <b>DefinedSize</b> property returns a long value that indicates the
defined size of a field (in bytes).
</p>

<p>The <b> ActualSize</b> property is a read-only property. It returns a long value that
...
<p>The DefinedSize property defines how long a field's value can be, while ActualSize
...
objrs.Fields(number).DefinedSize<br>
<br>
...
<br>
response.write(rs.Fields(0).DefinedSize)<br>
response.write(rs.Fields(0).ActualSize)<br>
<br>
rs.Close<br>
conn.close<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_field_size.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_field_size.asp#top" target="_top">TOP</a> |
		<a href="prop_field_size.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
