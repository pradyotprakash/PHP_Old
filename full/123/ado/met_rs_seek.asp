...
<title>ADO Seek Method</title>
<style>a.menu_met_rs_seek{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Seek</span> Method</h1>
<hr>
...
<hr>
<p>The Seek method searches the index of a Recordset to find a record that matches
the values specified in the keyvalues parameter. If there is a match, the pointer will point to
the record specified by the seekoption parameter. If there is no match, the record pointer will be placed at the end of the
Recordset.
</p>

<p><b>Note:</b> To use this method, the provider must support this method and the use of indexes on
a Recordset (the Index property). Use the Supports method to determine whether the
provider supports seek and indexes.
</p>

<p><b>Note:</b> Set the Index property to the desired index before executing this method.
</p>

<p><b>Note:</b> This method can only be used with server-side cursors (not supported when the
CursorLocation property value is adUseClient).
</p>

<p><b>Note:</b> This method can only be used when the Recordset object was opened with
the CommandTypeEnum value of adCmdTableDirect.
</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>keyvalues </td>
    <td>   Required. An array of values to compare with the values
      in each column&nbsp;</td>
  </tr>
  <tr>
    <td>seekoption </td>
    <td>   Required. A <a href="met_rs_seek.asp#seekenum">SeekEnum</a> value that
      specifies the type of seek</td>
  </tr>
</table>
<br>
<hr>

<a name="seekenum"><h3>SeekEnum Values</h3></a>
<table class="reference notranslate">
      <tr>
        <th>Constant</th>
        <th>Value</th>
      ...
      <tr>
        <td>adSeekFirstEQ</td>
        <td>1</td>
        <td>Seeks the first key equal to keyvalues</td>
      </tr>
      <tr>
        <td>adSeekLastEQ</td>
        <td>2</td>
        <td>Seeks the last key equal to keyvalues</td>
      </tr>
      <tr>
        <td>adSeekAfterEQ</td>
        <td>4</td>
        <td>Seeks either a key equal to keyvalues or just
          after where that match would have occurred</td>
      </tr>
      <tr>
        <td>adSeekAfter</td>
        <td>8</td>
        <td>Seeks a key just after where a match with keyvalues would
          have occurred</td>
      </tr>
      <tr>
        <td>adSeekBeforeEQ</td>
        <td>16</td>
        <td>Seeks either a key equal to keyvalues<b> </b>or
          just before where that match would have occurred</td>
      </tr>
      <tr>
        <td>adSeekBefore</td>
        <td>32</td>
        <td>Seeks a key just before where a match with keyvalues would
          have occurred</td>
      </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_seek.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_seek.asp#top" target="_top">TOP</a> |
		<a href="met_rs_seek.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
