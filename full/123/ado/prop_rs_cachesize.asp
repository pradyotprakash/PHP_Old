...
<title>ADO CacheSize Property</title>
<style>a.menu_prop_rs_cachesize{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">CacheSize</span> Property</h1>
<hr>
...
<hr>
<p>The CacheSize property sets or returns a long value that specifies the number of records that
can be cached locally in memory.
The value must be greater than 0.</p>

<p><b>Note:</b> You can change this property any time, as long as the Recordset exists, but
remember that the cached content will not change until the next retrieval from the database.</p>

<p>The default value for this property is 1. This means that only one record is fetched and cached at a time. For
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_cachesize.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_cachesize.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_cachesize.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
