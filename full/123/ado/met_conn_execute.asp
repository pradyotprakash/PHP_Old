...
<style>a.menu_met_conn_execute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Execute</span> Method</h1>
<hr>
...
<hr>
<p>The Execute method executes a specified query, SQL statement, stored procedure, or provider-specific
text.
</p>

<p>The results are stored in a new Recordset object if it is a row-returning
query. A closed Recordset object will be returned if it is not a row-returning
query.&nbsp;</p>

<p><b>Note:</b> The returned Recordset is always a read-only, forward-only 
Recordset!</p>
<p><b>Tip:</b> To create a Recordset with more functionality, first create a 
Recordset object. Set the desired properties, and then use the Recordset 
object's Open method to execute the query.</p>

<h3>Syntax for row-returning</h3>
...
<h3>Syntax for non-row-returning</h3>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>commandtext </td>
    <td>   Required. The SQL statement, stored procedure, or provider-specific text to
      execute</td>
  </tr>
  <tr>
    <td>ra </td>
    <td>   Optional. The number of records
      affected by the query      
    </td>
  </tr>
  <tr>
    <td>options </td>
    <td>   Optional. Sets how the provider should evaluate the commandtext parameter. Can be one or more <a href="met_conn_execute.asp#commandtypeenum"> CommandTypeEnum</a> or
      <a href="met_conn_execute.asp#executeoptionenum"> ExecuteOptionEnum</a>
      values. Default is adCmdUnspecified
    </td>
  </tr>
</table>
<h3>Example</h3>
...
&lt;%<br>
sql=&quot;SELECT companyname FROM Customers&quot;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_conn_execute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_conn_execute.asp#top" target="_top">TOP</a> |
		<a href="met_conn_execute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
