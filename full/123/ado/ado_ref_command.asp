...
<style>a.menu_ado_ref_command{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Command</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_getstring.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_ref_connection.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_comm_activeconn.asp">ActiveConnection</a></td>
    <td>Sets or returns a definition for a connection if the connection is closed, or
      the current Connection object if the connection is open</td>
  </tr>
  <tr>
    <td><a href="prop_comm_commandtext.asp">CommandText</a></td>
    <td>Sets or returns a provider command</td>
  </tr>
  <tr>
    <td><a href="prop_commandtimeout.asp">CommandTimeout</a></td>
    <td>Sets or returns the number of seconds to wait while attempting to execute a
      command</td>
  </tr>
  <tr>
    <td><a href="prop_comm_commandtype.asp">CommandType</a></td>
    <td>Sets or returns the type of a Command object</td>
  </tr>
  <tr>
    <td><a href="prop_comm_name.asp">Name</a></td>
    <td>Sets or returns the name of a Command
      object</td>
  </tr>
  <tr>
    <td><a href="prop_comm_prepared.asp">Prepared</a></td>
    <td>Sets or returns a Boolean value that, if set to True, indicates that the command should
      save a prepared version of the query before the first execution</td>
  </tr>
  <tr>
    <td><a href="prop_comm_state.asp">State</a></td>
    <td>Returns a value that describes if the Command object is open, closed, connecting, executing or
      retrieving data</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="met_comm_cancel.asp">Cancel</a></td>
    <td>Cancels an execution of a method</td>
  </tr>
  <tr>
    <td><a href="met_comm_createparameter.asp">CreateParameter</a></td>
    <td>Creates a new Parameter object</td>
  </tr>
  <tr>
    <td><a href="met_comm_execute.asp">Execute</a></td>
    <td>Executes the query, SQL statement or procedure in the
...
<table class="reference notranslate">
  ...
  <tr>
    <td>Parameters</td>
    <td>Contains all the Parameter objects of a Command Object</td>
  </tr>
  <tr>
    <td>Properties</td>
    <td>Contains all the Property objects of a Command Object</td>
  </tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_ref_command.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_ref_command.asp#top" target="_top">TOP</a> |
		<a href="ado_ref_command.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
