...
<title>ADO Value Property</title>
<style>a.menu_prop_prop_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Value</span> Property</h1>
<hr>
<a href="ado_ref_property.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Property Object Reference" /> Complete Property Object Reference</a>
<hr>
<p>The Value property sets or returns the value of a Parameter, Field, or
Property object.
</p>
...
<table class="reference notranslate">
  <tr>
    ...
    <th>Description of the Value
      Property</th>
  </tr>  
  <tr>
    <td>Parameter </td>
    <td>   The Value property sets or returns a variant that
      indicates the value of the Parameter object
      <p><b>Note:</b> The Recordset should be closed before you try to read the Value
      property. ADO can only read the Value property once from the provider</p>
    </td>
  </tr>
  <tr>
    <td>Field </td>
    <td>   <p>The Value property sets or returns a variant that
      indicates the current value of the Field object
</p>

      <p><b>Note:</b> For a new Field object
    that are added to the Fields collection of a Record, you must first set the Value property and perform an update before you can set any other
      property
</p>
  ...
  <tr>
    <td>Property </td>
    <td>   The Value property sets or returns a variant that
      indicates the current value of the Property object
      <p><b>Note:</b> You cannot set the Value for properties that are read-only</p>
    </td>
  </tr>
</table>
...
<h3>Example - For a Parameter object:</h3>
<div class="code notranslate"><div>

&lt;%<br>
set comm=Server.CreateObject(&quot;ADODB.Command&quot;)<br>
set para=Server.CreateObject(&quot;ADODB.Parameter&quot;)<br>
<br>
para.Type=adVarChar<br>
para.Size=25<br>
para.Direction=adParamInput<br>
para.Value=varfname<br>
<br>
comm.Parameters.Append para<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_prop_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_prop_value.asp#top" target="_top">TOP</a> |
		<a href="prop_prop_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
