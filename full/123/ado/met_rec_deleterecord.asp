...
<title>ADO DeleteRecord Method</title>
<style>a.menu_met_rec_deleterecord{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">DeleteRecord</span> Method</h1>
<hr>
...
<hr>
<p>The DeleteRecord method deletes a file or directory.
</p>

<p><b>Tip:</b> Close the Record object after calling this method to prevent
unpredictable behaviors of the Record.
</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>async </td>
    <td>   Optional. A Boolean value that, when True, sets the
      delete operation
      to be asynchronous
    </td>
  </tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rec_deleterecord.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rec_deleterecord.asp#top" target="_top">TOP</a> |
		<a href="met_rec_deleterecord.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
