...
<title>ADO BOF and EOF Properties</title>
<style>a.menu_prop_rs_bofeof{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">BOF</span> and <span class="color_h1">EOF</span> Properties</h1>
<hr>
...
<hr>
<p>The <b> BOF property</b> returns True (-1) if the current record position is
before the first record in the Recordset, otherwise it returns False (0).</p>

<p>The <b> EOF property</b> returns True (-1) if the current record position is
after the last record in the Recordset, otherwise it returns False (0).
</p>

<p><b>Note:</b> The BOF and EOF properties are set to True if you open an empty Recordset.
RecordCount property is zero.
</p>

<p><b>Note:</b> If a Recordset holds at least one record, the first record is the current
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_bofeof.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_bofeof.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_bofeof.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
