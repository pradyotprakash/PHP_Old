...
<title>ADO NextRecordset Method</title>
<style>a.menu_met_rs_nextrecordset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">NextRecordset</span> Method</h1>
<hr>
...
<hr>
<p>The NextRecordset method is used to clear the current Recordset object and
return the next Recordset object by looping through a series of commands. This
method returns a Recordset object.
</p>

<p>Use this method to return the results of the next command in a compound
...
<p>If a row-returning command executes successfully but returns no records, the returned Recordset object will be open but
...
<p><b>Note:</b>  objRecordset1 and objRecordset2 can be the same Recordset object.</p>
...
<table class="reference notranslate">
  <tbody>
    ...
    <tr>
      <td>ra</td>
      <td>   Optional. Returns the number of records affected by
        the operation
      </td>
    </tr>
  </tbody>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_nextrecordset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_nextrecordset.asp#top" target="_top">TOP</a> |
		<a href="met_rs_nextrecordset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
