...
<title>ADO Provider Property</title>
<style>a.menu_prop_conn_provider{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Provider</span> Property</h1>
<hr>
...
<hr>
<p>The Provider property sets or returns a string value that contains the provider name
for a specific Connection object. Default is MSDASQL (Microsoft OLE DB provider for ODBC).
Look at <a href="prop_conn_provider.asp#providercodes">Provider Codes</a>
</p>

<p>This property is read/write when the connection is closed.
</p>

<p>The provider name can also be set with the ConnectionString property of the
Connection object or the ConnectionString parameter of the Open
method.
</p>

<p><b>Note:</b> Never set the provider for a specific Connection in more than one place.
</p>
...
<br>
response.write(conn.Provider)<br>
<br>
conn.close<br>
%&gt;
...
<br>
<hr>
<a name="providercodes"><h3>Provider Codes</h3></a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_conn_provider.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_conn_provider.asp#top" target="_top">TOP</a> |
		<a href="prop_conn_provider.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
