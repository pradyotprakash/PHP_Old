...
<title>ADO SkipLine Method</title>
<style>a.menu_met_stream_skipline{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">SkipLine</span> Method</h1>
<hr>
...
<hr>
<p>The SkipLine method is used to skip a line when reading a text Stream. All characters
including the line separator, are skipped. Default line separator is adCRLF.</p>

<p><b>Note:</b> This method is only used with text Stream objects.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_stream_skipline.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_stream_skipline.asp#top" target="_top">TOP</a> |
		<a href="met_stream_skipline.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
