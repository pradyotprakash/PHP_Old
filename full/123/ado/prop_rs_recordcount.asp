...
<title>ADO RecordCount Property</title>
<style>a.menu_prop_rs_recordcount{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">RecordCount</span> Property</h1>
<hr>
...
<hr>
<p>The RecordCount property returns a long value that indicates the number of records
in a Recordset object.
</p>

<p>If the Recordset object supports AbsolutePosition and AbsolutePage properties or
...
<p><b>Note:</b> This property will return -1 for a forward-only cursor; the actual count for a static or keyset cursor; and -1 or the actual count for a dynamic
cursor.
</p>

<p><b>Note:</b> The Recordset object must be open when calling this property. If
...
rs.Open sql,conn<br>
<br>
if rs.Supports(adApproxPosition)=true then<br>
&nbsp;&nbsp;i=rs.RecordCount<br>
&nbsp;&nbsp;response.write(&quot;The number of records is: &quot; &amp; i)<br>
end if<br>
<br>
rs.Close<br>
conn.Close<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_recordcount.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_recordcount.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_recordcount.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
