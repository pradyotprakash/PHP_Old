...
<style>a.menu_ev_conn_execute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<table class="reference notranslate">
  ...
  <tr>
    <td>src </td>
    <td>   A string that contains an SQL command or a stored procedure name      
    </td>
  </tr>
  <tr>
    <td>cursortyp </td>
    <td>   Specifies the type of cursor to be used. One of the <a href="ev_conn_execute.asp#cursortypeenum">CursorTypeEnum</a>
      values      
    </td>
  </tr>
  <tr>
    <td>locktyp </td>
    <td>   Specifies the type of lock to be used. One of the <a href="ev_conn_execute.asp#locktypeenum">LockTypeEnum</a>
      values      
    </td>
  </tr>
  <tr>
    <td>options </td>
    <td>   One or more of the <a href="ev_conn_execute.asp#commandtypeenum"> CommandTypeEnum</a> or
      <a href="ev_conn_execute.asp#executeoptionenum"> ExecuteOptionEnum</a> values      
    </td>
  </tr>
  <tr>
    <td>recaffected </td>
    <td>   The number of records affected by the execution      
    </td>
  </tr>
  <tr>
    <td>objerror </td>
  ...
  <tr>
    <td>status </td>
    <td>   An <a href="ev_conn_execute.asp#eventstatusenum">EventStatusEnum</a> value      
    </td>
  </tr>
  <tr>
    <td>objcomm </td>
    <td>   For <b>WillExecute</b>: Set to the Command object that was executed or to
      Nothing
  ...
  <tr>
    <td>objrs </td>
    <td>   For <b>WillExecute</b>: Set to the Recordset object that resulted from the execution of the command or to
      Nothing
  ...
  <tr>
    <td>objconn </td>
    <td>   The Connection object that is associated with the execution of the
      command      
    </td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_conn_execute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_conn_execute.asp#top" target="_top">TOP</a> |
		<a href="ev_conn_execute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
