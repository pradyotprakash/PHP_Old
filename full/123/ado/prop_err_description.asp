...
<title>ADO Description Property</title>
<style>a.menu_prop_err_description{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Description</span> Property</h1>
<hr>
...
<hr>
<p>The Description property returns a string that contains a description of the
error.
</p>

<p>This is the default property for the Error object. Both the provider and ADO can
be the source of the error.
</p>

<p>The provider should pass error information to ADO. When an error occurs, ADO
should create an Error object, which contains error information. ADO should also add
the Error object to the Errors Collection.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_err_description.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_err_description.asp#top" target="_top">TOP</a> |
		<a href="prop_err_description.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
