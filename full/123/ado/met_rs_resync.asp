...
<title>ADO Resync Method</title>
<style>a.menu_met_rs_resync{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Resync</span> Method</h1>
<hr>
...
<hr>
<p>The Resync method refreshes the data in a Recordset.
</p>

<p><b>Tip:</b> Use this method to resynchronize the Recordset with the database.
If you want to see
changes in the database and you are using a static or forward-only Recordset,
this method is useful.
</p>

<p><b>Note:</b> This method does not re-execute the Recordset, so new records in the
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>affectrecords </td>
    <td>   Optional. An <a href="met_rs_resync.asp#affectenum"> AffectEnum</a> 
      value that specifies which records this method will
      affect. Default is adAffectAll</td>
  </tr>
  <tr>
    <td>resyncvalues </td>
    <td>   Optional. A <a href="met_rs_resync.asp#resyncenum">ResyncEnum</a>  value
      that specifies if underlying values are overwritten. Default is adResyncAllValues</td>
  </tr>
</table>
<br>
<hr>

<a name="affectenum"><h3>AffectEnum Values</h3></a>
<table class="reference notranslate">
      <tr>
      ...
      <tr>
        <td>adAffectCurrent</td>
        <td>1</td>
        <td>Affects only the current record</td>
      </tr>
      <tr>
        <td>adAffectGroup</td>
        <td>2</td>
        <td>Affects only records that satisfy the Filter setting (Filter must be
          set to a FilterGroupEnum
          value or an array of Bookmarks)</td>
      </tr>
      <tr>
        <td>adAffectAll</td>
        <td>3</td>
        <td>Affects all records if there is no Filter. Affects only visible
          records in the current chapter if Filter is set to a string criteria.
          Affect all rows of the Recordset if Filter is set to a FilterGroupEnum
          value or an array of Bookmarks
        </td>
      </tr>
      <tr>
        <td>adAffectAllChapters</td>
        <td>4</td>
        <td>Affects all records in all child Recordset, including those hidden
          by a currently applied filter</td>
      </tr>
  </table>
<br>
<hr>

<a name="resyncenum"><h3>ResyncEnum Values</h3></a>
<table class="reference notranslate">
      <tr>
        <th style="width:40%">Constant</th>
        <th style="width:5%">Value</th>
      ...
      <tr>
        <td>adResyncAllValues</td>
        <td>2</td>
        <td>Default. Overwrites data, and pending updates are canceled</td>
      </tr>
      <tr>
        <td>adResyncUnderlyingValues</td>
        <td>1</td>
        <td>Does not overwrite data, and pending updates are not canceled</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_resync.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_resync.asp#top" target="_top">TOP</a> |
		<a href="met_rs_resync.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
