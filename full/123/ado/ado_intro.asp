...
<title>ADO Introduction</title>
<style>a.menu_ado_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_connect.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">ADO can be used to access databases from your web pages.</p>
<hr>
...
following:</p>
<ul>
	<li>WWW, HTML and the basics of building Web pages</li>
	<li>Active Server Pages (ASP)</li>
	<li>Structured Query Language (SQL)</li>
</ul>
<p>If you want to study these subjects first, go to our <a href="../default.asp">Home page</a></p>
<hr>
<h2>What is ADO?</h2>
<ul>
...
<p>The common way to access a database from inside an ASP page is to:</p>
<ol>
  <li>Create an ADO connection to a database</li>
  <li>Open the database connection</li>
  <li>Create an ADO recordset</li>
  <li>Open the recordset</li>
  <li>Extract the data you need from the recordset</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_intro.asp#top" target="_top">TOP</a> |
		<a href="ado_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
