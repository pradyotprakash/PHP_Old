...
<title>ADO EOS Property</title>
<style>a.menu_prop_stream_eos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">EOS</span> Property</h1>
<hr>
...
<hr>
<p>The EOS property returns a boolean value that indicates whether the current position is at the end of the stream.
True indicates that the current position is at the end of the stream.
</p>

<p><b>Tip:</b> To set the current position to the end of the stream, use the SetEOS method.
</p>

<p><b>Tip:</b> To determine the current position of the stream, use the Position property.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_stream_eos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_stream_eos.asp#top" target="_top">TOP</a> |
		<a href="prop_stream_eos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
