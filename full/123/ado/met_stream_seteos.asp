...
<title>ADO SetEOS Method</title>
<style>a.menu_met_stream_seteos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">SetEOS</span> Method</h1>
<hr>
...
<hr>
<p>The SetEOS method is used to set the current position to be the end of the
stream (EOS). This method also updates the EOS property.</p>

<p><b>Note:</b> Any data beyond the new
EOS will be truncated and lost.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_stream_seteos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_stream_seteos.asp#top" target="_top">TOP</a> |
		<a href="met_stream_seteos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
