...
<title>ADO Update Method</title>
<style>a.menu_met_rs_update{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Update</span> Method</h1>
<hr>
...
<hr>
<p>The Update method is used to save all changes made to a single record in a
Recordset.
</p>

<p><b>Note:</b> This method will not work if the Recordset does not support updates.
</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>fields </td>
    <td>   Optional. A field name, or an array of field names or field positions
      to update</td>
  </tr>
  <tr>
    <td>values </td>
    <td>   Optional. A value or an array of values for the field or array of fields
      you want to update</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_rs_update.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_rs_update.asp#top" target="_top">TOP</a> |
		<a href="met_rs_update.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
