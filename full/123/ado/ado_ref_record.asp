...
<style>a.menu_ado_ref_record{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Record</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_ref_property.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_ref_recordset.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_rec_activeconn.asp">ActiveConnection</a></td>
    <td>Sets or returns which Connection object a Record object
      belongs to</td>
  </tr>
  <tr>
    <td><a href="prop_rec_mode.asp">Mode</a></td>
    <td>Sets or returns the permission for modifying data in a
      Record object</td>
  </tr>
  <tr>
    <td><a href="prop_rec_parenturl.asp">ParentURL</a></td>
    <td>Returns the absolute URL of the parent Record</td>
  </tr>
  <tr>
    <td><a href="prop_rec_recordtype.asp">RecordType</a></td>
    <td>Returns the type of a Record object</td>
  </tr>
  <tr>
    <td><a href="prop_rec_source.asp">Source</a></td>
    <td>Sets or returns the src parameter of the Open method of a Record
      object</td>
  </tr>
  <tr>
    <td><a href="prop_rec_state.asp">State</a></td>
    <td>Returns the status of a Record object</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="met_rec_cancel.asp">Cancel</a></td>
    <td>Cancels an execution of a CopyRecord, DeleteRecord,
      MoveRecord, or Open call</td>
  </tr>
  <tr>
    <td><a href="met_rec_close.asp">Close</a></td>
    <td>Closes a Record object</td>
  </tr>
  <tr>
    <td><a href="met_rec_copy_move_record.asp">CopyRecord</a></td>
    <td>Copies a file or directory to another location</td>
  </tr>
  <tr>
    <td><a href="met_rec_deleterecord.asp">DeleteRecord</a></td>
    <td>Deletes a file or directory</td>
  </tr>
  <tr>
    <td> <a href="met_rec_getchildren.asp"> GetChildren</a></td>
    <td>Returns a Recordset object where each row represents the
      files in the directory</td>
  </tr>
  <tr>
    <td><a href="met_rec_copy_move_record.asp">MoveRecord</a></td>
    <td>Moves a file or a directory to another location</td>
  </tr>
  <tr>
    <td><a href="met_rec_open.asp">Open</a></td>
    <td>Opens an existing Record object or creates a new file or
      directory</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>Properties</td>
    <td>A collection of provider-specific properties</td>
  </tr>
  <tr>
    <td>Fields</td>
    <td>Contains all the Field objects in the Record object</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>Count</td>
    <td>Returns the number of items in the fields collection.
      Starts at zero.
      <p>Example:</p>
	  <p>countfields=rec.Fields.Count</p>
    </td>
  </tr>
  <tr>
    ...
    <td>Returns a specified item in the fields collection.
      <p>Example:</p>
      <p>itemfields=rec.Fields.Item(1)<br>
      or<br>
      itemfields = rec.Fields.Item(&quot;Name&quot;)</p>
    </td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_ref_record.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_ref_record.asp#top" target="_top">TOP</a> |
		<a href="ado_ref_record.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
