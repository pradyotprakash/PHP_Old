...
<title>ADO Bookmark Property</title>
<style>a.menu_prop_rs_bookmark{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Bookmark</span> Property</h1>
<hr>
...
<hr>
<p>The Bookmark property specifies a bookmark. The bookmark saves the position
of the current record.
</p>

<p>To save the bookmark for the current record, assign the value of the Bookmark property to a variable. To
return to the &quot;bookmarked&quot; record, set the Bookmark property to the value of that variable.
</p>

<p><b>Note:</b> The Bookmark property is available only in Recordset objects that support bookmarks.
</p>
...
rs.MoveFirst<br>
<br>
'Store bookmark of the current record<br>
bkmark=rs.Bookmark<br>
<br>
rs.MoveLast<br>
<br>
'Go to the bookmarked record<br>
rs.Bookmark=bkmark<br>
<br>
rs.Close<br>
conn.Close<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_bookmark.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_bookmark.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_bookmark.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
