...
<title>ADO Demonstration</title>
<style>a.menu_ado_demo{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Demonstration</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_delete.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_getstring.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">To demonstrate a small real life ADO application, we have put together a few
ADO demos.</p>

<hr>
<h2>Read this First</h2>

<p>If you try to update the database, you will get the error message: &quot;You
do not have permission to update this database&quot;. You get this error because
you don't have write access to our server.
</p>
<p>BUT, if you copy the code and run it on your own system, you might get the
...
<p>Open Windows Explorer, find the .mdb file. Right-click on the .mdb file and 
select Properties. Go to the Security tab and set the access-rights here.</p>

<hr>
<h2>List, Edit, Update, and Delete Database Records</h2>

<p><a target="_blank" href="demo_db_list.asp">List, edit, update, and delete database records</a></p>
...
<p><a href="demo_db_add.asp" target="_blank">Add a new record</a>
</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_delete.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_demo.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_demo.asp#top" target="_top">TOP</a> |
		<a href="ado_demo.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
