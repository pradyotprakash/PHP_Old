...
<style>a.menu_ado_connect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">Database Connection</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ado_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ado_recordset.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>Note, from the example above, that you have to specify the Microsoft Access
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ado_connect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ado_connect.asp#top" target="_top">TOP</a> |
		<a href="ado_connect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
