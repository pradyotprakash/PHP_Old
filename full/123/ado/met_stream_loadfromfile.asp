...
<title>ADO LoadFromFile Method</title>
<style>a.menu_met_stream_loadfromfile{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">LoadFromFile</span> Method</h1>
<hr>
...
<hr>
<p>The LoadFromFile method is used to load the contents of an existing file into an open Stream object.
All existing data in the Stream object will be overwritten.
</p>
<p><b>Note:</b> After a call to this method, the current position is set to the
beginning of the Stream (Position=0).&nbsp;
</p>
<p><b>Tip:</b> This method can be used to upload the contents of a file to a server.
</p>
<h3>Syntax</h3>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
      <td>filename</td>
      <td>   Required. The name of an existing file to be loaded
        into a the Stream object
      </td>
    </tr>
</table>
...
&lt;%<br>
objStream.LoadFromFile &quot;c:/temp/w3schools.txt&quot;<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_stream_loadfromfile.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_stream_loadfromfile.asp#top" target="_top">TOP</a> |
		<a href="met_stream_loadfromfile.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
