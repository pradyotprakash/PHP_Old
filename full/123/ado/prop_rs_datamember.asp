...
<title>ADO DataMember Property</title>
<style>a.menu_prop_rs_datamember{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">DataMember</span> Property</h1>
<hr>
...
<hr>
<p>The DataMember property sets or returns a string value that contains the name of the data member that will be retrieved from the object
referenced by the DataSource property. The name is not case sensitive.
</p>

<p>This property is used to create data-bound controls with the Data Environment
in Visual Basic 6.
</p>

<p><b>Note:</b> The DataMember and DataSource properties must be used in
conjunction.
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_datamember.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_datamember.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_datamember.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
