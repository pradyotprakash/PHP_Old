...
<title>ADO RecordType Property</title>
<style>a.menu_prop_rec_recordtype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">RecordType</span> Property</h1>
<hr>
...
<hr>
<p>The RecordType property returns a <a href="prop_rec_recordtype.asp#recordtypeenum">RecordTypeEnum</a>
 value that indicates the type of a Record object.
</p>
...
<br>
<hr>
<a name="recordtypeenum"><h3>RecordTypeEnum Values</h3></a>
<table class="reference notranslate">
      ...
      <tr>
        <td>adRecordUnknown</td>
        <td>-1</td>
        <td>An unknown Record type</td>
      </tr>
      <tr>
        <td>adSimpleRecord</td>
        <td>0</td>
        <td>A simple Record type that does not contain child nodes</td>
      </tr>
      <tr>
        <td>adCollectionRecord</td>
        <td>1</td>
        <td>A collection Record type that contains child nodes</td>
      </tr>
      <tr>
        <td>adStructDoc</td>
        <td>2</td>
        <td>A Record type that represents COM structured
          documents</td>
      </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rec_recordtype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rec_recordtype.asp#top" target="_top">TOP</a> |
		<a href="prop_rec_recordtype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
