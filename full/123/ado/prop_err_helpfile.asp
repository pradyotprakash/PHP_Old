...
<title>ADO HelpFile Property</title>
<style>a.menu_prop_err_helpfile{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">HelpFile</span> Property</h1>
<hr>
...
<hr>
<p>The HelpFile property returns a string that contains the full path of the help file in
the
Microsoft Windows help system.
</p>

<p>This property allows you to interact with the Windows help system, i.e. you
can call the Windows API Help functions.</p>
<p>The HelpFile property returns &quot;&quot; if you do not have access to
interact with the Windows help system.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_err_helpfile.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_err_helpfile.asp#top" target="_top">TOP</a> |
		<a href="prop_err_helpfile.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
