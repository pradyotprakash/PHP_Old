...
<title>ADO PageCount Property</title>
<style>a.menu_prop_rs_pagecount{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">PageCount</span> Property</h1>
<hr>
...
<hr>
<p>The PageCount property returns a long value that indicates the number of
pages with data in a Recordset object.</p>
<p><b>Tip:</b> To divide the Recordset into a series of pages, use the PageSize property.</p>
<p><b>Note:</b> If the last page contains fewer records than specified in PageSize, it
still counts as an additional page in the PageCount property.
</p>
<p><b>Note:</b> If this method is not supported it returns -1.</p>
...
<br>
i=rs.PageCount<br>
response.write(&quot;The number of pages in RS=&quot; &amp; i)<br>
<br>
rs.Close<br>
conn.Close<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_pagecount.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_pagecount.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_pagecount.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
