...
<style>a.menu_prop_rs_status{font-weight:bold;}</style>
<meta charset="utf-8">
...
<hr>
<p>The Status property returns one or more <a href="prop_rs_status.asp#recordstatusenum">RecordStatusEnum</a> value that
indicates the status of the current record with regard to batch updates or other bulk operations.
</p>
...
<a name="recordstatusenum"><h3>RecordStatusEnum</h3></a>
<table class="reference notranslate">
      ...
      <tr>
        <td>adRecOK</td>
        <td>0</td>
        <td>Record successfully updated</td>
      </tr>
      <tr>
        <td>adRecNew</td>
        <td>0x1</td>
      ...
      <tr>
        <td>adRecUnmodified</td>
        <td>0x8</td>
        <td>Record not modified</td>
      </tr>
      <tr>
        <td>adRecInvalid</td>
        <td>0x10</td>
        <td>Record not saved; invalid bookmark</td>
      </tr>
      <tr>
        <td>adRecMultipleChanges</td>
        <td>0x40</td>
        <td>Record not saved; would
          have affected multiple records</td>
      </tr>
      <tr>
        <td>adRecPendingChanges</td>
        <td>0x80</td>
        <td>Record not saved; refers to a pending insert</td>
      </tr>
      <tr>
        <td>adRecCanceled</td>
        <td>0x100</td>
        <td>Record not saved; operation was canceled</td>
      </tr>
      <tr>
        <td>adRecCantRelease</td>
        <td>0x400</td>
        <td>New record not saved; existing record was locked</td>
      </tr>
      <tr>
        <td>adRecConcurrencyViolation</td>
        <td>0x800</td>
        <td>Record not saved; optimistic concurrency was in use</td>
      </tr>
      <tr>
        <td>adRecIntegrityViolation</td>
        <td>0x1000</td>
        <td>Record not saved; user
          violated integrity constraints</td>
      </tr>
      <tr>
        <td>adRecMaxChangesExceeded</td>
        <td>0x2000</td>
        <td>Record not saved; too many pending changes</td>
      </tr>
      <tr>
        <td>adRecObjectOpen</td>
        <td>0x4000</td>
        <td>Record not saved; conflict with an open storage object</td>
      </tr>
      <tr>
        <td>adRecOutOfMemory</td>
        <td>0x8000</td>
        <td>Record not saved; computer has run out of memory</td>
      </tr>
      <tr>
        <td>adRecPermissionDenied</td>
        <td>0x10000</td>
        <td>Record not saved; user
          has insufficient permissions</td>
      </tr>
      <tr>
        <td>adRecSchemaViolation</td>
        <td>0x20000</td>
        <td>Record not saved; violates the structure of the
          database</td>
      </tr>
      <tr>
        <td>adRecDBDeleted</td>
        <td>0x40000</td>
        <td>Record already deleted from
          the data source</td>
      </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_status.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_status.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_status.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
