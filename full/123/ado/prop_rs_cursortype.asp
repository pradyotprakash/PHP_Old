...
<title>ADO CursorType Property</title>
<style>a.menu_prop_rs_cursortype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">CursorType</span> Property</h1>
<hr>
...
<p>The CursorType property sets or returns the cursor type to use when opening a Recordset
object. This
property can take a <a href="prop_rs_cursortype.asp#CursorTypeEnum">CursorTypeEnum</a> value.
Default is adOpenForwardOnly.
</p>

<p><b>Note:</b> If the CursorLocation property is set to adUseClient, the only
valid setting for the CursorType property is adOpenStatic.
</p>

<p><b>Note:</b>  No error will occur if an unsupported value is set, the
provider will just change to a supported CursorType instead.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_cursortype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_cursortype.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_cursortype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
