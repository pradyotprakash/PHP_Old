...
<title>ADO EditMode Property</title>
<style>a.menu_prop_rs_editmode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ADO <span class="color_h1">EditMode</span> Property</h1>
<hr>
...
<p>
The EditMode property returns an <a href="prop_rs_editmode.asp#editmodeenum">EditModeEnum</a>
...
<a name="editmodeenum"><h3>EditModeEnum Values</h3></a>
<table class="reference notranslate">
      ...
      <tr>
        <td>adEditNone</td>
        <td>0</td>
        <td>No editing operation is in progress</td>
      </tr>
      <tr>
        <td>adEditInProgress</td>
        <td>1</td>
        <td>The current record has been edited but not saved</td>
      </tr>
      <tr>
        <td>adEditAdd</td>
        <td>2</td>
        <td>The current record in the copy buffer is a new record and has not been saved in the
          database</td>
      </tr>
      <tr>
        <td>adEditDelete</td>
        <td>4</td>
        <td>The current record has been deleted</td>
      </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_rs_editmode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_rs_editmode.asp#top" target="_top">TOP</a> |
		<a href="prop_rs_editmode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
