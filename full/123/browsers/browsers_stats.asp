...
<style>a.menu_browsers_stats{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="browsers_os.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">What is the trend in browser usage?</p>
<hr>

<h2>Browser Statistics and Trends</h2>
<img src="pic_chart.jpg" alt="Chart" style="float:left;margin-right:20px;margin-bottom:10px;height:128px;width:128px;">
<p>Statistics are important information.</p>
<p>From the statistics below (collected from W3Schools' log-files since 2002),
you can read the long term trends of browser usage.</p>
<p>We see that Google Chrome, Firefox, and Internet Explorer are the most used browsers today.</p>
<hr>

<h2>Browser Statistics</h2>
<table class="reference notranslate">
    <tr>
    <th style="width:17%">2014</th>
    <th style="width:20%;text-align:right"><a href="browsers_explorer.asp">Internet Explorer</a></th>
    <th style="width:16%;text-align:right"><a href="browsers_firefox.asp">Firefox</a></th>
    <th style="width:16%;text-align:right"><a href="browsers_chrome.asp">Chrome</a></th>
    <th style="width:16%;text-align:right"><a href="browsers_safari.asp">Safari</a></th>
    <th style="width:16%;text-align:right"><a href="browsers_opera.asp">Opera</a></th>
    </tr>
	<tr>
    <td>January</td>
    ...
    <tr>
    <th>2013</th>
    <th class="right">Internet Explorer</th>
...
<table class="reference notranslate">
  <tr>
    <td style="width:20%"><b>Internet Explorer</b></td>
    <td style="width:80%">Microsoft Internet Explorer</td>
  </tr>
  <tr>
    <td><b>Firefox</b></td>
...
<p>You cannot - as a web developer - rely ONLY on statistics. Statistics can be misleading.</p>
<p><b>Note:</b> W3Schools is a website for people with an interest for web technologies. 
These people are more interested in using alternative browsers than the average 
user. The average user tends to use the browser that comes 
preinstalled with their computer, and do not seek out other browser alternatives. </p>
<p><b>Tip:</b> Global averages may not be relevant to your web site. Different sites 
attract different audiences. Some web sites attract professional developers 
using professional hardware, while other sites attract hobbyists using old  computers.</p>
<p>Anyway, our data, collected from W3Schools' log-files over many years, clearly shows the long 
term trends.</p>
<hr>
...
<h2>Quotes</h2>
<p><i>&quot;<b>The pure and simple truth is rarely pure and never simple</b>.&quot;<br>
</i>Oscar Wilde</p>
<p><i>&quot;<b>First get your facts; then you can distort them at your leisure</b>.&quot;<br>
</i>Mark Twain</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="browsers_stats.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="browsers_stats.asp#top" target="_top">TOP</a> |
		<a href="browsers_stats.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
