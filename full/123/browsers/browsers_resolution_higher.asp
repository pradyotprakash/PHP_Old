...
<html lang="en-US">
<head>
<title>High Screen Resolution Statistics</title>
<style>a.menu_browsers_resolution_higher{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>High Screen <span class="color_h1">Resolution</span> Statistics</h1>
<p><a href="browsers_display.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Browser Display Statistics"> Browser Display Statistics</a></p><hr>

<h2>High Screen Resolution Statistics</h2>
<p>The tables below are a breakdown of &quot;other high resolutions&quot; from our <a href="browsers_display.asp">Browser Display Statistics</a>:</p>
<table class="reference notranslate">
    <tr>
    <th style="width:50%">Resolution</th>
    <th style="width:50%;text-align:right">January 2014</th>
    </tr>
	<tr>
    <td>1440x900</td>
    <td class="right">7%</td>
...
<table class="reference notranslate">
    <tr>
    <th style="width:50%">Resolution</th>
    <th style="width:50%;text-align:right">January 2013</th>
    </tr>
	<tr>
    <td>1440x900</td>
    <td class="right">7%</td>
...
<table class="reference notranslate">
    <tr>
    <th style="width:50%">Resolution</th>
    <th style="width:50%;text-align:right">January 2012</th>
    </tr>
	<tr>
    <td>1440x900</td>
    <td class="right">8%</td>
...
<table class="reference notranslate">
    <tr>
    <th style="width:50%">Resolution</th>
    <th style="width:50%;text-align:right">January 2011</th>
    </tr>
	<tr>
    <td>1366x768</td>
    <td class="right">10%</td>
...
<table class="reference notranslate">
  <tr>
    <th style="width:50%">Resolution</th>
    <th style="width:50%;text-align:right">January 2010</th>
    </tr>
	<tr>
    <td>1440x900</td>
...
<br>
<br>
<a href="browsers_display.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Browser Display Statistics"> Browser Display Statistics</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="browsers_resolution_higher.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="browsers_resolution_higher.asp#top" target="_top">TOP</a> |
		<a href="browsers_resolution_higher.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
