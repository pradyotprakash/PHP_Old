...
<style>a.menu_browsers_os{font-weight:bold;}</style>
<meta charset="utf-8">
...
<hr>
<h2>OS Platform Statistics and Trends</h2>
...
<p>From the statistics below (collected from W3Schools' log-files since 2003), you can read the long 
...
<table class="reference notranslate">
    ...
    <th class="right">Win8</th>
    <th class="right">Win7</th>
    <th class="right">Vista</th>
    <th class="right">NT*</th>
    <th class="right">WinXP</th>
    <th class="right">Linux</th>
    <th class="right">Mac</th>
    <th class="right"><a href="browsers_mobile.asp">Mobile</a></th>
    </tr>
	<tr>
    <td>January</td>
  ...
  <tr>
    ...
    <th>&nbsp;</th>
    <th class="right">Vista</th>
    <th class="right">W2003</th>
    <th class="right">WinXP</th>
    <th class="right">W2000</th>
    <th class="right">Win98</th>
    <th class="right">Linux</th>
    <th class="right">Mac</th>
  </tr>
	<tr>
...
<p>Platforms that count for less than 0.5% are not listed.</p>
<p>* NT includes all Windows Server operating systems (like Windows 2000, Windows Server 2003 and 2008)</p>
<hr>

<h2>Other Statistics</h2>
<p><a href="browsers_stats.asp">Browser statistics</a></p>
...
<p>Anyway, our data, collected from W3Schools' log-files, over many years, clearly shows the long term trends.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="browsers_os.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="browsers_os.asp#top" target="_top">TOP</a> |
		<a href="browsers_os.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
