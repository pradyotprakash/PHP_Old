...
<style>a.menu_browsers_display{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="browsers_mobile.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">What is the trend in screen resolution and color depth?</p>
<hr>

<h2>Web Statistics and Trends</h2>
<img src="pic_screen.jpg" alt="Screen" style="float:left;margin-right:20px;margin-bottom:10px;">
<p>Statistics are important information.</p>
<p>W3Schools.com is for people with an interest for web technologies. 
This fact indicates that the numbers below might not be 100% true for the average internet users. 
...
<p>As of today, 99% of our visitors have a screen resolution higher than 1024x768 pixels:</p>
<table class="reference notranslate">
  <tr>
    <th style="width:15%">Date</th>
    <th style="text-align:right"><a href="browsers_resolution_higher.asp">Other 	high</a></th>
    <th style="text-align:right">1920x1080</th>
    <th style="text-align:right">1366x768</th>
    <th style="text-align:right">1280x1024</th>
    <th style="text-align:right">1280x800</th>
    <th style="text-align:right">1024x768</th>
    <th style="text-align:right">800x600</th>
...
<h2>Color Depth Statistics</h2>
<p>Today, most computers use 24 or 32 bits hardware to display 16,777,216 different colors.</p>
<p>Older computers use 16 bits display hardware, which gives a maximum of 65,536 different colors.</p>
<p>Very old computers use 8 bits color hardware, which gives a maximum of 256 colors.</p>
<table class="reference notranslate">
  <tr>
    <th style="width:20%">Date</th>
    <th style="width:30%;text-align:right">16,777,216</th>
    <th style="width:25%;text-align:right">65,536</th>
    <th style="width:25%;text-align:right">256</th>
  </tr>
	<tr>
    <td>January 2014</td>
...
<p><a href="../html/html_colors.asp">Read more about the display of colors</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="browsers_display.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="browsers_display.asp#top" target="_top">TOP</a> |
		<a href="browsers_display.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
