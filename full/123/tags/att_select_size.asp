...
<style>a.menu_att_select_size{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;select&gt; <span class="color_h1">size</span> Attribute</h1>
...
<p>A drop-down list with three visible options:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_select_size" class="tryitbtn">Try it yourself &raquo;</a>
...
<p><strong>Note:</strong> In Chrome and Safari, this attribute may not work as 
expected for size=&quot;2&quot; and size=&quot;3&quot;.</p>
<hr>

<h2>Definition and Usage </h2>
<p>The size attribute specifies the number of visible options in a drop-down list.</p>
<p>If the value of the size attribute is greater than 1, but lower than the 
total number of options in the list, the browser will add a scroll bar to 
indicate that there are more options to view.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>number</i></td>
    <td>The number of visible options in the drop-down list. Default value is 1. 
	If the multiple attribute is present, the default value is 4</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_select_size.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_select_size.asp#top" target="_top">TOP</a> |
		<a href="att_select_size.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
