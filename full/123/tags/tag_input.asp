...
<style>a.menu_tag_input{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;input&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_ins.asp">&lt;ins&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br><a target="_blank" href="tryit.asp?filename=tryhtml_form_submit" class="tryitbtn">Try it yourself &raquo;</a><br>
</div>
<hr>
...
<p>The &lt;input&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;input&gt; tag specifies an input field where the user can
enter data.</p>
<p>&lt;input&gt; elements are used within a &lt;form&gt; element to declare input 
controls that allow users to input data.</p>
<p>An input field can vary in many ways, depending on the type attribute.</p>
<hr>

<h2>Tips and Notes</h2>
<p><b>Note: </b>The &lt;input&gt; element is empty, it contains attributes only.</p>
<p><b>Tip:</b> Use the <a href="tag_label.asp">&lt;label&gt;</a> element to define labels for &lt;input&gt; elements.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>In HTML 4.01, the "align" attribute is <a href="javascript:NewWindow('deprecated.htm')">deprecated</a>, and 
it is not supported in HTML5. 
Use CSS to align &lt;input&gt; elements.</p>
<p>In HTML5, the &lt;input&gt; tag has several new attributes, and the type attribute 
has several new values.</p>

<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In HTML, the &lt;input&gt; tag has no end tag.</p>
<p>In XHTML, the &lt;input&gt; tag must be properly closed, like this &lt;input /&gt;.</p>

<hr>

<h2>Attributes</h2>
<p><span class="new" style="float:left;">New</span>&nbsp;: New in HTML5.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_input_accept.asp">accept</a></td>
    <td>audio/*<br>
	video/*<br>
	image/*<br>
	<i>MIME_type</i></td>
    <td>Specifies the types of files that the server accepts 
	(only for type=&quot;file&quot;)</td>
  </tr>
  <tr>
    <td><a href="att_input_align.asp">align</a></td>
    <td>left<br>
	right<br>
	top<br>
    middle<br>
    bottom</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
	Specifies the alignment of an image input (only for type=&quot;image&quot;)</td>
  </tr>
  <tr>
    <td><a href="att_input_alt.asp">alt</a></td>
    <td><i>text</i></td>
    <td>Specifies an alternate text for images (only for type=&quot;image&quot;)</td>
  </tr>
	<tr>
    <td class="style1"><a href="att_input_autocomplete.asp">autocomplete</a><span class="new">New</span></td>
    <td>on<br>
	off</td>
    <td>Specifies whether an &lt;input&gt; element should have autocomplete 
	enabled</td>
  </tr>
  <tr>
    <td><a href="att_input_autofocus.asp">autofocus</a><span class="new">New</span></td>
    <td>autofocus</td>
    <td>Specifies that an &lt;input&gt; element should automatically get focus when the page 
	loads</td>
  </tr>
  <tr>
    <td><a href="att_input_checked.asp">checked</a></td>
    <td>checked</td>
    <td>Specifies that an &lt;input&gt; element should be pre-selected when the page 
	loads (for type=&quot;checkbox&quot; or type=&quot;radio&quot;)</td>
  </tr>
  <tr>
    <td><a href="att_input_disabled.asp">disabled</a></td>
    <td>disabled</td>
    <td>Specifies that an &lt;input&gt; element should be disabled</td>
  </tr>
  <tr>
    <td><a href="att_input_form.asp">form</a><span class="new">New</span></td>
    <td><i>form_id</i></td>
    <td>Specifies one or more forms the &lt;input&gt; element belongs to</td>
  </tr>
  <tr>
    <td><a href="att_input_formaction.asp">formaction</a><span class="new">New</span></td>
    <td><i>URL</i></td>
    <td>Specifies the URL of the file that will process the input control when 
	the form is submitted (for type=&quot;submit&quot; and type=&quot;image&quot;)</td>
  </tr>
  <tr>
    <td><a href="att_input_formenctype.asp">formenctype</a><span class="new">New</span></td>
    <td>application/x-www-form-urlencoded<br>
	multipart/form-data<br>
	text/plain</td>
    <td>Specifies how the form-data should be encoded when submitting it to the 
	server (for type=&quot;submit&quot; and type=&quot;image&quot;)</td>
  </tr>
  <tr>
    <td><a href="att_input_formmethod.asp">formmethod</a><span class="new">New</span></td>
    <td>get<br>post</td>
    <td>Defines the HTTP 
	method for sending data to the action URL (for type=&quot;submit&quot; and type=&quot;image&quot;)</td>
  </tr>
  <tr>
    <td><a href="att_input_formnovalidate.asp">formnovalidate</a><span class="new">New</span></td>
    <td>formnovalidate</td>
    <td>Defines that form elements should not be validated when submitted</td>
  </tr>
  <tr>
    <td><a href="att_input_formtarget.asp">formtarget</a><span class="new">New</span></td>
    <td>_blank<br>
_self<br>
_parent<br>
_top<br>
	...
	the form (for type=&quot;submit&quot; and type=&quot;image&quot;)</td>

  </tr>
  <tr>
    <td><a href="att_input_height.asp">height</a><span class="new">New</span></td>
    <td><i>pixels</i></td>
    <td>Specifies the height of an &lt;input&gt; element (only for type=&quot;image&quot;)</td>
  </tr>
	<tr>
    <td><a href="att_input_list.asp">list</a><span class="new">New</span></td>
    <td><i>datalist_id</i></td>
    <td>Refers to a &lt;datalist&gt; element that contains pre-defined options for an 
	&lt;input&gt; element</td>
  </tr>
	<tr>
    <td><a href="att_input_max.asp">max</a><span class="new">New</span></td>
    <td><i>number<br>
	date</i></td>
    <td>Specifies the maximum value for an &lt;input&gt; element</td>
  </tr>
	<tr>
    <td><a href="att_input_maxlength.asp">maxlength</a></td>
    <td><i>number</i></td>
    <td>Specifies the maximum number of characters allowed in an &lt;input&gt; element</td>
  </tr>
  <tr>
    <td><a href="att_input_min.asp">min</a><span class="new">New</span></td>
    <td><i>number<br>
	date</i></td>
    <td>Specifies a minimum value for an &lt;input&gt; element</td>
  </tr>
  <tr>
    <td><a href="att_input_multiple.asp">multiple</a><span class="new">New</span></td>
    <td>multiple</td>
    <td>Specifies that a user can enter more than one value in an &lt;input&gt; 
	element</td>
  </tr>
  <tr>
    <td><a href="att_input_name.asp">name</a></td>
    <td><i>text</i></td>
    <td>Specifies the name of an &lt;input&gt; element</td>
  </tr>
  <tr>
    <td><a href="att_input_pattern.asp">pattern</a><span class="new">New</span></td>
    <td><em>regexp</em></td>
    <td>Specifies a regular expression that an &lt;input&gt; element's value is 
	checked against</td>
  </tr>
  <tr>
    <td><a href="att_input_placeholder.asp">placeholder</a><span class="new">New</span></td>
    <td><i>text</i></td>
    <td>Specifies a short hint that describes the expected value of an &lt;input&gt; 
	element</td>
  </tr>
	<tr>
    <td><a href="att_input_readonly.asp">readonly</a></td>
    <td>readonly</td>
    <td>Specifies that an input field is read-only</td>
  </tr>
  <tr>
    <td><a href="att_input_required.asp">required</a><span class="new">New</span></td>
    <td>required</td>
    <td>Specifies that an input field must be filled out before submitting the 
	form</td>
  </tr>
  <tr>
    <td><a href="att_input_size.asp">size</a></td>
    <td><i>number</i></td>
    <td>Specifies the width, in characters, of an &lt;input&gt; element</td>
  </tr>
  <tr>
    <td><a href="att_input_src.asp">src</a></td>
    <td><i>URL</i></td>
    <td>Specifies the URL of the image to use as a submit button (only for 
    type=&quot;image&quot;)</td>
  </tr>
	<tr>
    <td><a href="att_input_step.asp">step</a><span class="new">New</span></td>
    <td>
	<i>number</i></td>
    <td>Specifies the legal number intervals for an input field</td>
  </tr>
  <tr>
    <td><a href="att_input_type.asp">type</a></td>
    <td>button<br>
      checkbox<br>
	color<br>
      date <br>
  ...
  <tr>
    <td><a href="att_input_value.asp">value</a></td>
    <td><i>text</i></td>
    <td>Specifies the value of an &lt;input&gt; element<b><br>
	&nbsp;</b></td>
  </tr>
	<tr>
    <td><a href="att_input_width.asp">width</a><span class="new">New</span></td>
    <td><i>pixels</i></td>
...
<p>The &lt;input&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;input&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_input.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_input.asp#top" target="_top">TOP</a> |
		<a href="tag_input.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
