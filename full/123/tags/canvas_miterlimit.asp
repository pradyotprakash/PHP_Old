...
<title>HTML canvas miterLimit Property</title>
<style>a.menu_canvas_miterlimit{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">miterLimit</span> Property</h1>
...
<p>Draw lines with the maximum miter length of 5:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_miterlimit" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>The miter length is the distance between the inner corner and the outer corner where two lines meet.</p>
<img src="img_miterlimitFig.gif" alt="Miter Limit figure 1" />
<p><b>Tip:</b> The miterLimit property works only if the lineJoin attribute is "miter".</p>
<p>The miter length grows bigger as the angle of the corner gets smaller.</p>
<p>To prevent the miter length from being <em>too</em> long, we can use the miterLimit property.</p>
<p>If the miter length exceeds the miterLimit value, the corner will be displayed as lineJoin type "bevel" (Fig 3):</p>
<img src="img_miterlimitBevelFig.gif" alt="Miter Limit figure 2" />
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.miterLimit=<i>number</i>;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>number</i></td>
		<td>A positive number that specifies the maximum miter length. If the 
		current miter length exceeds the miterLimit, the corner will display as lineJoin 
		&quot;bevel&quot;</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_miterLimit">Play it &raquo;</a></td>
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_miterlimit.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_miterlimit.asp#top" target="_top">TOP</a> |
		<a href="canvas_miterlimit.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
