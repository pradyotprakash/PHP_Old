...
<title>HTML onunload Event Attribute</title>
<style>a.menu_ev_onunload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onunload</span> Event Attribute</h1>
...
<div class="example_code notranslate">
    &lt;body onunload=&quot;goodbye()&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml5_ev_onunload">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The onunload event attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onunload attribute fires once a page has unloaded (or the browser window has been closed).</p>
...
<p><b>Note:</b> If you reload a page, you will also trigger the unload event (and the <a href="ev_onload.asp">onload</a> event).</p>
<hr>
...
<div class="code notranslate"><div>
    &lt;<i>element</i> onunload=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onunload</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_onunload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_onunload.asp#top" target="_top">TOP</a> |
		<a href="ev_onunload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
