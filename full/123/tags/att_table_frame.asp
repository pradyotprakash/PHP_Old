...
<title>HTML table frame Attribute</title>
<style>a.menu_att_table_frame{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;table&gt; <span class="color_h1">frame</span> Attribute</h1>
<p><a href="tag_table.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML table Reference" /> HTML &lt;table&gt; tag</a></p>
<div class="example">


<h2 class="example">Example</h2>
<p>Display only the outside borders of a table:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_table_frame" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The frame attribute is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> The frame attribute of the &lt;table&gt; tag is not supported in Internet Explorer 8 and earlier versions.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;table&gt; frame attribute is not supported in HTML5. 
Use CSS instead.</span></p>
<p>The frame attribute specifies which parts of the outside table borders that should be visible.</p>
<p><b>Tip:</b> It may be better to NOT specify a frame, and use CSS to apply
<a href="../css/css_border.asp">borders</a> 
instead.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>void</td>
    <td>The outside borders are not shown</td>
  </tr>
  <tr>
    <td>above</td>
    <td>The top outside border is shown</td>
  </tr>
	<tr>
    <td>below</td>
    <td>The bottom outside border is shown</td>
  </tr>
	<tr>
    <td>hsides</td>
    <td>The top and bottom outside borders are shown</td>
  </tr>
	<tr>
    <td>vsides</td>
    <td>The left and right outside borders are shown</td>
  </tr>
  <tr>
    <td>lhs</td>
    <td>The left outside border is shown</td>
  </tr>
	<tr>
    <td>rhs</td>
    <td>The right outside border is shown</td>
  </tr>
	<tr>
    <td>box</td>
    <td>The outside borders are shown on all four sides</td>
  </tr>
  <tr>
    <td>border</td>
    <td>The outside borders are shown on all four sides</td>
...
<br>
<hr>
<a href="tag_table.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML table Reference" /> HTML &lt;table&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_table_frame.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_table_frame.asp#top" target="_top">TOP</a> |
		<a href="att_table_frame.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
