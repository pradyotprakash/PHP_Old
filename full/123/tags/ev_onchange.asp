...
<title>HTML onchange Event Attribute</title>
<style>a.menu_ev_onchange{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onchange</span> Event Attribute</h1>
...
<p>Check an input field when the value is changed:</p>
<div class="example_code notranslate">
    &lt;input type=&quot;text&quot; name=&quot;txt&quot; value=&quot;Hello&quot; onchange=&quot;checkField(this.value)&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml5_ev_onchange">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The onchange event attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onchange attribute fires the moment when the value of the element is changed.</p>
<p>The onchange attribute can be used with the &lt;input&gt;, &lt;textarea&gt;, and &lt;select&gt; elements.</p>
<hr>
...
<div class="code notranslate"><div>
    &lt;<i>element</i> onchange=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onchange</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_onchange.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_onchange.asp#top" target="_top">TOP</a> |
		<a href="ev_onchange.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
