...
<title>HTML canvas fillRect() Method</title>
<style>a.menu_canvas_fillrect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">fillRect()</span> Method</h1>
...
<p>Draw a filled 150*100 pixels rectangle:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_fillrect" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the fillRect() 
method.</p>
...
<p>The fillRect() method draws a &quot;filled&quot; rectangle. The default color 
of the fill is black.</p>
<p><b>Tip:</b> Use the <a href="canvas_fillstyle.asp">fillStyle</a> property to 
set a color, gradient, or pattern used to fill the drawing.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.fillRect(<i>x,y,width,height</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_fillrectx">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y-coordinate of the upper-left corner of the rectangle</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_fillrecty">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>width</i></td>
		<td>The width of the rectangle, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_fillrectw">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>height</i></td>
		<td>The height of the rectangle, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_fillrecth">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_fillrect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_fillrect.asp#top" target="_top">TOP</a> |
		<a href="canvas_fillrect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
