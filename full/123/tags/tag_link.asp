...
<style>a.menu_tag_link{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;link&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_main.asp">&lt;main&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_link_tag" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>When used for style sheets, the &lt;link&gt; tag is supported in all major browsers. No real support for anything else. </p>
<hr>
...
<p><b>Note:</b> The &lt;link&gt; element is an empty element, it contains attributes only.</p>
<p><b>Note:</b>&nbsp;This element goes only in the head section, but it can appear any number of times.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>Some HTML 4.01 attributes are not supported in HTML5.</p>
<p>The "sizes" attribute is new in HTML5.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In HTML the &lt;link&gt; tag has no end tag.</p>
<p>In XHTML the &lt;link&gt; tag must be properly closed.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_link_charset.asp">charset</a></td>
    <td><i>char_encoding</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the character encoding of the linked document</td>
  </tr>
  <tr>
    <td><a href="att_link_href.asp">href</a></td>
    <td><i>URL</i></td>
    <td>Specifies the location of the linked document</td>
  </tr>
  <tr>
    <td><a href="att_link_hreflang.asp">hreflang</a></td>
    <td><i>language_code</i></td>
    <td>Specifies the language of the text in the linked document</td>
  </tr>
  <tr>
    <td><a href="att_link_media.asp">media</a></td>
    <td><em>media_query</em></td>
    <td>Specifies on what device the linked document will be displayed</td>
      </tr>
  <tr>
    <td><a href="att_link_rel.asp">rel</a></td>
    <td>alternate<br>
	archives<br>
	author<br>
	bookmark<br>
	...
	tag<br>
	up</td>
    <td>Required. Specifies the relationship between the current document and the linked 
	document</td>
  </tr>
  <tr>
    <td><a href="att_link_rev.asp">rev</a></td>
  ...
  <tr>
    <td><a href="att_link_sizes.asp">sizes</a><span class="new">New</span></td>
    <td><i>Height</i>x<i>Width<br>
	</i>any</td>
    <td>Specifies the size of the linked resource. Only for rel=&quot;icon&quot;</td>
  </tr>
  <tr>
    <td><a href="att_link_target.asp">target</a></td>
    <td>_blank<br>
_self<br>
_top<br>
_parent<br>
<i>frame_name</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies where the linked document is to be loaded</td>
  </tr>
  <tr>
    <td><a href="att_link_type.asp">type</a></td>
...
<p>The &lt;link&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;link&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_css.asp">HTML Styles</a></p>
<p>HTML DOM reference: <a href="../jsref/dom_obj_link.asp">Link object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_main.asp">&lt;main&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_link.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_link.asp#top" target="_top">TOP</a> |
		<a href="tag_link.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
