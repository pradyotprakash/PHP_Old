...
<title>HTML param value Attribute</title>
<style>a.menu_att_param_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;param&gt; <span class="color_h1">value</span> Attribute</h1>
<p><a href="tag_param.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML param Tag Reference" /> HTML &lt;param&gt; tag</a></p>
<div class="example">
...
<br>
<a class="tryitbtn" target="_blank" href="tryit.asp?filename=tryhtml_param">Try it yourself &raquo;</a>
...
<p>The value attribute is supported in all major browsers. However, the file 
format defined in &lt;object&gt; may not be supported in all browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The value attribute specifies the value of a &lt;param&gt; element.</p>
<p>This attribute is used together with the name attribute to specify 
parameters for the plugin specified with the <a href="tag_object.asp">&lt;object&gt;</a> 
tag.</p>
<p>The value can be any value supported by the specified object.</p>
<hr>
...
<br>
<hr>
<a href="tag_param.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML param Tag Reference" /> HTML &lt;param&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_param_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_param_value.asp#top" target="_top">TOP</a> |
		<a href="att_param_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
