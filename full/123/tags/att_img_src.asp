...
<style>a.menu_att_img_src{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;img&gt; <span class="color_h1">src</span> Attribute</h1>
...
<p>The required src attribute specifies the URL of the image.</p>
<p><b>Note:</b> When a web page loads; it is the browser, at that moment, 
that gets the image from a web server and inserts it into the page. 
Therefore, make sure that the image actually stay in the same spot in relation 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>URL</i></td>
    <td>The URL of the image.<p>Possible values:</p>
<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_img_src.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_img_src.asp#top" target="_top">TOP</a> |
		<a href="att_img_src.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
