...
<style>a.menu_tag_label{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;label&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_legend.asp">&lt;legend&gt; Tag &raquo;</a></div>
</div>
<br>
<div class="example">
...
<p>The &lt;label&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;label&gt; tag defines a label for an &lt;input&gt; element.</p>
<p>The &lt;label&gt; element does not render as anything special for the user. 
However, it provides a usability improvement for mouse users, because if the 
user clicks on the text within the &lt;label&gt; element, it toggles the control.</p>
<p>The for attribute of the &lt;label&gt; tag should be equal to the id attribute of 
the related element to bind them together.</p>

<hr>

<h2>Tips and Notes</h2>

<p><b>Tip:</b> A label can be bound to an element either by using the &quot;for&quot; 
attribute, or by placing the element inside the &lt;label&gt; element.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_label_for.asp">for</a></td>
    <td><i>element_id</i></td>
    <td>Specifies which form element a label is bound to</td>
  </tr>
  <tr>
    <td><a href="att_label_form.asp">form</a><span class="new">New</span></td>
    <td><i>form_id</i></td>
    <td>Specifies one or more forms the label belongs to</td>
  </tr>
</table>
<br>
<hr>
...
<p>The &lt;label&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;label&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_legend.asp">&lt;legend&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_label.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_label.asp#top" target="_top">TOP</a> |
		<a href="tag_label.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
