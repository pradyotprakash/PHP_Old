...
<title>HTML canvas beginPath() Method</title>
<style>a.menu_canvas_beginpath{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">beginPath()</span> Method</h1>
...
<p>Draw two paths on the canvas; one green and one purple:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_beginpath" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the beginPath() 
method.</p>
...
<p><b>Tip:</b> Use moveTo(), lineTo(), quadricCurveTo(), bezierCurveTo(), arcTo(), and arc(), to create paths.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_beginpath.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_beginpath.asp#top" target="_top">TOP</a> |
		<a href="canvas_beginpath.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
