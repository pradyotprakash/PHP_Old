...
<style>a.menu_canvas_arc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">arc()</span> Method</h1>
...
<div class="example_code notranslate">
	...
	ctx.beginPath();<br>ctx.arc(100,75,50,0,2*Math.PI);<br>ctx.stroke();</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_arc" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the arc() 
method.</p>
...
<p><b>Tip:</b> To create a circle with arc(): Set start 
angle to 0 and end angle to 2*Math.PI. </p>
<p><b>Tip:</b> Use the <a href="canvas_stroke.asp">stroke()</a> or the
<a href="canvas_fill.asp">fill()</a> method to actually draw the arc on the canvas.</p>
<img src="img_arc.gif" alt="An arc" />
<br>
<br>
<div style="float:left;background-color:#00ff00;width:4px;height:4px;margin:5px;"></div> <div style="width:100px;float:left;">Center</div> arc(<strong>100,75</strong>,50,0*Math.PI,1.5*Math.PI)<br>
<div style="float:left;background-color:#ff0000;width:4px;height:4px;margin:5px;"></div> <div style="width:100px;float:left;">Start angle</div> arc(100,75,50,<strong>0</strong>,1.5*Math.PI)<br>
<div style="float:left;background-color:#0000ff;width:4px;height:4px;margin:5px;"></div> <div style="width:100px;float:left;">End angle</div> arc(100,75,50,0*Math.PI,<strong>1.5*Math.PI</strong>)
<br>
<br>
<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.arc(<i>x,y,r,sAngle,eAngle,counterclockwise</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arcx">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y-coordinate of the center of the circle</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arcy">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>r</i></td>
		<td>The radius of the circle</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arcr">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>sAngle</i></td>
		<td>The starting angle, in radians (0 is at the 3 o'clock position of 
		the arc's circle)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arcsangle">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>eAngle</i></td>
		<td>The ending angle, in radians</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arceangle">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>counterclockwise</i></td>
		<td>Optional. Specifies whether the drawing should be counterclockwise 
		or clockwise. False is default, and indicates clockwise, while true 
		indicates counter-clockwise.</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arcclockwise">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_arc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_arc.asp#top" target="_top">TOP</a> |
		<a href="canvas_arc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
