...
<title>HTML canvas globalAlpha Property</title>
<style>a.menu_canvas_globalalpha{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">globalAlpha</span> Property</h1>
...
<p>First, draw a red rectangle, then set transparency (globalAlpha) to 0.5, and then draw a blue and a green rectangle:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_globalalpha" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the globalAlpha property.</p>
...
<p>The globalAlpha property value must be a number between 0.0 (fully 
transparent) and 1.0 (no transparancy).</p>
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.globalAlpha=<i>number</i>;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>number</em></td>
		<td>The transparency value. Must be a number between 0.0 (fully 
		transparent) and 1.0 (no transparancy)</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalAlpha&amp;preval=0.5">Play it &raquo;</a></td>
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_globalalpha.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_globalalpha.asp#top" target="_top">TOP</a> |
		<a href="canvas_globalalpha.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
