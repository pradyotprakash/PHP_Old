...
<title>HTML Audio/Video DOM currentTime Property</title>
<style>a.menu_av_prop_currenttime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">currentTime</span> Property</h1>
...
<p>Set time position to 5 seconds:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_currenttime" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The currentTime property sets or returns the current position (in seconds) of the audio/video 
playback.</p>
<p>When setting this property, the playback will jump to the specified position.</p>
<hr>
...
<p>The currentTime property is supported in all major browsers.</p>
<p><strong>Note:</strong> This property is not supported in Internet 
Explorer 8 and earlier.</p>
<hr>
<h2>Syntax</h2>
<p>Set the currentTime property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.currentTime=&quot;<i>seconds</i>&quot;
</div></div>
<p>Return the currentTime property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.currentTime
</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>seconds</i></td>
    <td>Indicates the position for the playback of the audio/video, in 
	seconds</td>
  </tr>
  </table>
...
<tr>
	...
	<td>A Number, representing seconds</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_currenttime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_currenttime.asp#top" target="_top">TOP</a> |
		<a href="av_prop_currenttime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
