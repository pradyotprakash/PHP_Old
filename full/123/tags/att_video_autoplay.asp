...
<style>a.menu_att_video_autoplay{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;video&gt; <span class="color_h1">autoplay</span> Attribute</h1>
...
<p>A video that will automatically start playing:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_video_autoplay" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The autoplay attribute is supported in all major browsers.</p>
...
<p>When present, the video will automatically start playing as soon as it can do so without stopping.</p>
<hr>
...
be defined as &lt;video autoplay=&quot;autoplay&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_video_autoplay.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_video_autoplay.asp#top" target="_top">TOP</a> |
		<a href="att_video_autoplay.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
