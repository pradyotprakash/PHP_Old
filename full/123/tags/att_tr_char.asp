...
<title>HTML tr char Attribute</title>
<style>a.menu_att_tr_char{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;tr&gt; <span class="color_h1">char</span> Attribute</h1>
...
<p>Align the content of the second and the third row to the &quot;.&quot; character:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_tr_char" class="tryitbtn">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The &lt;tr&gt; char attribute is not supported in HTML5.</span></p>
<p>The char attribute specifies the alignment of the content in a table row to a character.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_tr_char.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_tr_char.asp#top" target="_top">TOP</a> |
		<a href="att_tr_char.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
