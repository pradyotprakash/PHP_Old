...
<title>HTML textarea rows Attribute</title>
<style>a.menu_att_textarea_rows{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;textarea&gt; <span class="color_h1">rows</span> Attribute</h1>
...
<p>The rows attribute specifies the visible height of a text area, in lines.</p>
<p><strong>Note:</strong>
The size of a textarea can also be specified by the CSS height and width properties.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>number</i></td>
    <td>Specifies the height of the text area (in lines). Default value is 2</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_textarea_rows.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_textarea_rows.asp#top" target="_top">TOP</a> |
		<a href="att_textarea_rows.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
