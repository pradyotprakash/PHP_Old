...
<title>HTML tbody valign Attribute</title>
<style>a.menu_att_tbody_valign{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;tbody&gt; <span class="color_h1">valign</span> Attribute</h1>
...
<p>Vertical aligns the content inside the &lt;tbody&gt; element to the bottom:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_tbody_valign" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The valign attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;tbody&gt; valign attribute is not supported in HTML5. Use CSS instead.</span></p>
<p>The valign attribute specifies the vertical alignment of the content in a &lt;tbody&gt; element.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	However, 
	if the fonts are in different sizes, baseline looks better. Look at the illustration below</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_tbody_valign.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_tbody_valign.asp#top" target="_top">TOP</a> |
		<a href="att_tbody_valign.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
