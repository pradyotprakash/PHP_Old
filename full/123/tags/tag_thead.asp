...
<style>a.menu_tag_thead{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;thead&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_time.asp">&lt;time&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>An HTML table with a &lt;thead&gt;, &lt;tfoot&gt;, and a &lt;tbody&gt; element:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_tbody" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;thead&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;thead&gt; tag is used to group header content in an HTML table.</p>
<p>The &lt;thead&gt; element is used in conjunction with the <a href="tag_tbody.asp">
&lt;tbody&gt;</a> and <a href="tag_tfoot.asp">&lt;tfoot&gt;</a> elements to specify each 
part of a table (header, body, footer).</p>
<p>Browsers can use these elements to enable scrolling of the table body 
...
be printed at the top and bottom of each page.</p>
<p>The &lt;thead&gt; tag must be used in the following context: As a child of a 
&lt;table&gt; element, after any &lt;caption&gt;, and &lt;colgroup&gt; elements, and before any &lt;tbody&gt;, 
&lt;tfoot&gt;, and &lt;tr&gt; elements.</p>
<hr>

<h2>Tips and Notes</h2>
<p><b>Note:</b> The &lt;thead&gt; element must have one or more &lt;tr&gt; tags inside.</p>
<p><b>Tip:</b> The &lt;thead&gt;, &lt;tbody&gt;, and &lt;tfoot&gt; elements will not affect the 
...
<p>None of the HTML 4.01 attributes are supported in HTML5.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_thead_align.asp">align</a></td>
    <td>right<br>
      left<br>
      center<br>
      justify<br>
      char</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Aligns the content inside the &lt;thead&gt; element</td>
  </tr>
  <tr>
    <td><a href="att_thead_char.asp">char</a></td>
    <td><i>character</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Aligns the content inside the &lt;thead&gt; element to a character</td>
  </tr>
  <tr>
    <td><a href="att_thead_charoff.asp">charoff</a></td>
    <td><i>number</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Sets the number of characters the content inside the &lt;thead&gt; 
	element will be aligned 
	from the character specified by the char attribute</td>
  </tr>
  <tr>
    <td><a href="att_thead_valign.asp">valign</a></td>
    <td>top<br>
      middle<br>
      bottom<br>
      baseline</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Vertical aligns the content inside the &lt;thead&gt; element</td>
  </tr>
</table>
...
<p>The &lt;thead&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;thead&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_time.asp">&lt;time&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_thead.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_thead.asp#top" target="_top">TOP</a> |
		<a href="tag_thead.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
