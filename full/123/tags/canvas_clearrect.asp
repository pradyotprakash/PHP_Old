...
<title>HTML canvas clearRect() Method</title>
<style>a.menu_canvas_clearrect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">clearRect()</span> Method</h1>
...
<p>Clear a rectangle within a given rectangle:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_clearrect" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the clearRect() 
method.</p>
...
<table class="tecspec">
    ...
    <td><i>context</i>.clearRect(<i>x,y,width,height</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>x</i></td>
		<td>The x-coordinate of the upper-left corner of the rectangle to clear</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_clearrectx">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y-coordinate of the upper-left corner of the rectangle to clear</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_clearrecty">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>width</i></td>
		<td>The width of the rectangle to clear, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_clearrectw">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>height</i></td>
		<td>The height of the rectangle to clear, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_clearrecth">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_clearrect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_clearrect.asp#top" target="_top">TOP</a> |
		<a href="canvas_clearrect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
