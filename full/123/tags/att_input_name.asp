...
<title>HTML input name Attribute</title>
<style>a.menu_att_input_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">name</span> Attribute</h1>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_input_name" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The name attribute specifies the name of an &lt;input&gt; element.</p>
<p>The name attribute is used to reference elements in a JavaScript, or to 
reference form data after a form is submitted.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>text</i></td>
    <td>Specifies the name of the &lt;input&gt; element</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_name.asp#top" target="_top">TOP</a> |
		<a href="att_input_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
