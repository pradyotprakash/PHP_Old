...
<title>HTML audio preload Attribute</title>
<style>a.menu_att_audio_preload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;audio&gt; <span class="color_h1">preload</span> Attribute</h1>
...
<p>Author thinks that the sound should NOT be loaded when the page loads:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_audio_preload" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The preload attribute specifies if and how the author thinks that the audio 
file should be loaded when the page loads.</p>
...
may be ignored in some instances.</p>
...
<table class="reference notranslate">
	...
	<tr>
		<td>auto</td>
		<td>The author thinks that the browser should load the entire audio file when the page loads</td>
	</tr>
	<tr>
		<td>metadata</td>
	...
	<tr>
		<td>none</td>
		<td>The author thinks that the browser should NOT load the audio file when the page loads</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_audio_preload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_audio_preload.asp#top" target="_top">TOP</a> |
		<a href="att_audio_preload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
