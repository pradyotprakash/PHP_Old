...
<style>a.menu_tag_tfoot{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;tfoot&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_th.asp">&lt;th&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>The &lt;tfoot&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;tfoot&gt; tag is used to group footer content in an HTML table.</p>
<p>The &lt;tfoot&gt; element is used in conjunction with the <a href="tag_thead.asp">
&lt;thead&gt;</a> and <a href="tag_tbody.asp">&lt;tbody&gt;</a> elements to specify each 
part of a table (footer, header, body).</p>
...
<p>The &lt;tfoot&gt; tag must be used in the following context: As a child of a 
&lt;table&gt; element, after any &lt;caption&gt;, &lt;colgroup&gt;, and &lt;thead&gt; elements and 
before any &lt;tbody&gt; and &lt;tr&gt; elements.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_tfoot_align.asp">align</a></td>
    <td>right<br>
      left<br>
      center<br>
      justify<br>
...
content inside the &lt;tfoot&gt; element</td>
  </tr>
  <tr>
    <td><a href="att_tfoot_char.asp">char</a></td>
    <td><i>character</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Aligns the content inside the &lt;tfoot&gt; element to a character</td>
  </tr>
  <tr>
    <td><a href="att_tfoot_charoff.asp">charoff</a></td>
    <td><i>number</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Sets the number of characters the content inside the &lt;tfoot&gt; 
	element will be aligned 
	from the character specified by the char attribute</td>
  </tr>
  <tr>
    <td><a href="att_tfoot_valign.asp">valign</a></td>
    <td>top<br>
      middle<br>
      bottom<br>
      baseline</td>
...
<p>The &lt;tfoot&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;tfoot&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_th.asp">&lt;th&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_tfoot.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_tfoot.asp#top" target="_top">TOP</a> |
		<a href="tag_tfoot.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
