...
<title>HTML canvas rotate() Method</title>
<style>a.menu_canvas_rotate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">rotate()</span> Method</h1>
...
<p>Rotate the rectangle 20 degrees:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_rotate" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the rotate() 
method.</p>
...
<p>The rotate() method rotates the current drawing.</p>
<p><b>Note:</b> The rotation will only affect drawings made AFTER the rotation is done.<br>
</p>
<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.rotate(<em>angle</em>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>angle</i></td>
		<td>The rotation angle, in radians.<br><br>To calculate from degrees to radians: <i>degrees</i>*Math.PI/180.<br>
Example: to rotate 5 degrees, specify the following: 5*Math.PI/180</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_rotate">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_rotate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_rotate.asp#top" target="_top">TOP</a> |
		<a href="canvas_rotate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
