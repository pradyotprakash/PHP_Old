...
<title>HTML canvas createLinearGradient() Method</title>
<style>a.menu_canvas_createlineargradient{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">createLinearGradient()</span> Method</h1>
...
<p>Define a gradient (left to right) that goes from black to white, as the fill style for the rectangle:</p>
...
<div class="example_code notranslate">
	...
	<br>var grd=ctx.createLinearGradient(0,0,170,0);<br>
	grd.addColorStop(0,&quot;black&quot;);<br>
	grd.addColorStop(1,&quot;white&quot;);<br>
	<br>
	ctx.fillStyle=grd;<br>
	ctx.fillRect(20,20,150,100);</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_createlineargradient" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the createLinearGradient() method.</p>
...
<p><b>Tip:</b> Use this object as the value to the <a href="canvas_strokestyle.asp">strokeStyle</a> 
or <a href="canvas_fillstyle.asp">fillStyle</a> properties.</p>
<p><b>Tip:</b> Use the <a href="canvas_addcolorstop.asp">addColorStop()</a> method to 
specify different colors, and where to position the colors in the gradient object.</p>

<table class="tecspec">
	<tr>
    <th style="width:25%">JavaScript syntax:</th>
    <td><i>context</i>.createLinearGradient(<i>x0,y0,x1,y1</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>x0</i></td>
		<td>The x-coordinate of the start point of the gradient</td>
	</tr>
	<tr>
		<td><i>y0</i></td>
		<td>The y-coordinate of the start point of the gradient</td>
	</tr>
	<tr>
		<td><i>x1</i></td>
		<td>The x-coordinate of the end point of the gradient</td>
	</tr>
	<tr>
		<td><i>y1</i></td>
		<td>The y-coordinate of the end point of the gradient</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_createlineargradient.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_createlineargradient.asp#top" target="_top">TOP</a> |
		<a href="canvas_createlineargradient.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
