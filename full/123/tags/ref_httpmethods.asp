...
<style>a.menu_ref_httpmethods{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTTP <span class="color_h1">Methods: GET vs. POST</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ref_httpmessages.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ref_keyboardshortcuts.asp">Next Reference &raquo;</a></div>
</div>
<hr>
<p class="intro">The two most used HTTP methods are: GET and POST.</p>
<hr>
...
<p>A web browser may be the client, and an application on a 
computer that hosts a web site may be the server.</p>
<p>Example: A client (browser) submits an HTTP request to the server; then the server 
...
<h2>Two HTTP Request Methods: GET and POST</h2>
...
<p><b>Note that query strings (name/value pairs) is sent in the URL of 
a GET request:</b></p>
<div class="code notranslate">
<div>
/test/demo_form.asp<b>?name1=value1&amp;name2=value2</b>
</div></div>
...
<div class="code notranslate">
	<div>
POST /test/demo_form.asp HTTP/1.1<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	length of a URL is limited (maximum URL length is 2048 characters)</td>
...
<h2>Other HTTP Request Methods</h2>
<p>The following table lists some other HTTP request methods:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_httpmethods.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_httpmethods.asp#top" target="_top">TOP</a> |
		<a href="ref_httpmethods.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
