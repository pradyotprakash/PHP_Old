...
<title>HTML select name Attribute</title>
<style>a.menu_att_select_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;select&gt; <span class="color_h1">name</span> Attribute</h1>
...
<p>A drop-down list with a name attribute:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_select_name" class="tryitbtn">Try it yourself &raquo;</a>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>text</i></td>
    <td>The name of the drop-down list</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_select_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_select_name.asp#top" target="_top">TOP</a> |
		<a href="att_select_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
