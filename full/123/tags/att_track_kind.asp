...
<title>HTML track kind Attribute</title>
<style>a.menu_att_track_kind{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;track&gt; <span class="color_h1">kind</span> Attribute</h1>
<p><a href="tag_track.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML track Tag Reference" /> HTML &lt;track&gt; tag</a></p>
...
<p>The kind attribute is supported in Internet Explorer 10, Opera, and Chrome.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The kind attribute specifies the kind of text track.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		<td>captions</td>
		<td>The track defines translation of dialogue and sound effects (suitable for deaf users)</td>
	</tr>
	<tr>
		<td>chapters</td>
		<td>The track defines chapter titles (suitable for navigating the media resource)</td>
	</tr>
	<tr>
		<td>descriptions</td>
		<td>The track defines a textual description of the video content (suitable for blind users)</td>
	</tr>
	<tr>
		<td>metadata</td>
		<td>The track defines content used by scripts. Not visible for the user</td>
	</tr>
	<tr>
		<td>subtitles</td>
		<td>The track defines subtitles, used to display subtitles in a video</td>
	</tr>
</table>
<br>
<hr>
<a href="tag_track.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML track Tag Reference" /> HTML &lt;track&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_track_kind.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_track_kind.asp#top" target="_top">TOP</a> |
		<a href="att_track_kind.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
