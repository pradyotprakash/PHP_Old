...
<title>HTML Audio/Video DOM networkState Property</title>
<style>a.menu_av_prop_networkstate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">networkState</span> Property</h1>
...
<p>Get the current network state of the video:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>alert(myVid.networkState);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_networkstate" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The networkState property returns the current network state (activity) of the 
audio/video.</p>
<hr>
...
<p>The networkState property is supported in all major browsers.</p>
...
<div class="code notranslate">
	<div>
		<em>audio|video</em>.networkState</div></div>
<h2>Return Value</h2>
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>Number</td>
    <td>Represents the current network state of the audio/video element:<ul><li>
		0 
		= NETWORK_EMPTY - audio/video has not yet been initialized</li>
		<li>1 = NETWORK_IDLE - audio/video is active and has selected a 
		resource, but is not using the network</li>
		<li>2 = NETWORK_LOADING - browser is downloading data</li>
		<li>3 = NETWORK_NO_SOURCE - no audio/video source found</li></ul>
		</td>
    </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_networkstate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_networkstate.asp#top" target="_top">TOP</a> |
		<a href="av_prop_networkstate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
