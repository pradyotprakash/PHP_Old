...
<style>a.menu_canvas_beziercurveto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">bezierCurveTo()</span> Method</h1>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_beziercurveto" target="_blank">
...
bezierCurveTo() method.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the 
&lt;canvas&gt; element.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The bezierCurveTo() method adds a point to the current path by using the 
specified control points that represent a cubic Bézier curve.</p>
...
Control point 1</div> bezierCurveTo(<strong>20,100</strong>,200,100,200,20)<br>
<div style="float:left;background-color:#FF0000;width:4px;height:4px;margin:5px;"></div> <div style="width:100px;float:left;">
Control point 2</div> bezierCurveTo(20,100,<strong>200,100</strong>,200,20)<br>
<div style="float:left;background-color:#b0ef4e;width:4px;height:4px;margin:5px;"></div> <div style="width:100px;float:left;">
End point</div> bezierCurveTo(20,100,200,100,<strong>200,20</strong>)
<br>
<p><b>Tip: </b>Check out the <a href="canvas_quadraticcurveto.asp">
quadraticCurveTo()</a> method. It has one control point instead of two.</p>
<br>
<table class="tecspec">
	<tr>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_beziercurvetocp1x">
		Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>cp1y</i></td>
		<td>The y-coordinate of the first Bézier control point</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_beziercurvetocp1y">
		Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>cp2x</i></td>
		<td>The x-coordinate of the second Bézier control point</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_beziercurvetocp2x">
		Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>cp2y</i></td>
		<td>The y-coordinate of the second Bézier control point</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_beziercurvetocp2y">
		Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>x</i></td>
		<td>The x-coordinate of the ending point</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_beziercurvetox">
		Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y-coordinate of the ending point</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_beziercurvetoy">
		Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_beziercurveto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_beziercurveto.asp#top" target="_top">TOP</a> |
		<a href="canvas_beziercurveto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
