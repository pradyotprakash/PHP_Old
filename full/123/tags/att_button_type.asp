...
<title>HTML button type Attribute</title>
<style>a.menu_att_button_type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;button&gt; <span class="color_h1">type</span> Attribute</h1>
...
<p>Two button elements that act as one submit button and one reset button (in a form):</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_button_type" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The type attribute specifies the type of button.</p>
<p><b>Tip:</b> Always specify the type attribute for the &lt;button&gt; element. 
Different browsers may use different default types for the &lt;button&gt; element.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>button</td>
    <td>The button is a clickable button</td>
  </tr>
  <tr>
    <td>submit</td>
    <td>The button is a submit button (submits form-data)</td>
  </tr>
	<tr>
    <td>reset</td>
    <td>The button is a reset button (resets the form-data to its initial 
	values)</td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_button_type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_button_type.asp#top" target="_top">TOP</a> |
		<a href="att_button_type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
