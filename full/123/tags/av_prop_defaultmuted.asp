...
<title>HTML Audio/Video DOM defaultMuted Property</title>
<style>a.menu_av_prop_defaultmuted{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">defaultMuted</span> Property</h1>
...
<p>Set video to be muted by default:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.defaultMuted=true;</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_defaultmuted" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The defaultMuted property sets or returns if the audio/video 
is muted by default.</p>
<p>Setting this property will only change the default muted state, not the 
current. To change the current muted state, use the 
<a href="av_prop_muted.asp">muted</a> property.</p>
<hr>
...
<p>The defaultMuted property is only supported in Chrome and Safari 6.</p>
<hr>

<h2>Syntax</h2>
<p>Set the defaultMuted property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.defaultMuted=true|false</div></div>
<p>Return the defaultMuted property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.defaultMuted</div></div>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>true</td>
    <td>Indicates that the audio/video is muted by default</td>
    </tr>
  <tr>
    <td>false</td>
    <td>Default. Indicates that the audio/video is NOT muted by default</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_defaultmuted.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_defaultmuted.asp#top" target="_top">TOP</a> |
		<a href="av_prop_defaultmuted.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
