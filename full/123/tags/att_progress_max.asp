...
<title>HTML progress max Attribute</title>
<style>a.menu_att_progress_max{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;progress&gt; <span class="color_h1">max</span> Attribute</h1>
...
<p>The max attribute is supported in Internet Explorer 10, Firefox, Opera, Chrome, and Safari 6.</p>
<p><strong>Note:</strong> The max attribute of the &lt;progress&gt; tag is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The max attribute specifies how much work the task requires in total.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>number</em></td>
		<td>A floating point number that specifies how much work the task requires in total</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_progress_max.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_progress_max.asp#top" target="_top">TOP</a> |
		<a href="att_progress_max.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
