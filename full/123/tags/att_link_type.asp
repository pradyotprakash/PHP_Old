...
<title>HTML link type Attribute</title>
<style>a.menu_att_link_type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;link&gt; <span class="color_h1">type</span> Attribute</h1>
...
<p>In the following example, the type attribute indicates that the linked document is an 
...
<p>The type attribute specifies the MIME type of the linked document/resource.</p>
<p>This attribute is only used if the href attribute is set.</p>
<p>A very common MIME type for &lt;link&gt; is &quot;text/css&quot;, which specifies a 
style sheet.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	Look at <a target="_blank" href="http://www.iana.org/assignments/media-types/">IANA MIME types</a> 
	for a complete list of standard MIME types</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_link_type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_link_type.asp#top" target="_top">TOP</a> |
		<a href="att_link_type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
