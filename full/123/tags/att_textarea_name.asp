...
<title>HTML textarea name Attribute</title>
<style>a.menu_att_textarea_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;textarea&gt; <span class="color_h1">name</span> Attribute</h1>
...
<p>A text area with a name attribute:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_textarea_name">Try it yourself &raquo;</a>
...
<p>The name attribute specifies a name for a text area.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_textarea_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_textarea_name.asp#top" target="_top">TOP</a> |
		<a href="att_textarea_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
