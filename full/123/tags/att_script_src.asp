...
<title>HTML script src Attribute</title>
<style>a.menu_att_script_src{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;script&gt; <span class="color_h1">src</span> Attribute</h1>
...
<p>Point to an external JavaScript file:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_script_src" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The src attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The src attribute specifies the URL of an external script file.</p>
<p>If you want to run the same JavaScript on several pages in a web site, you 
should create an external JavaScript file, instead of writing the same script 
over and over again. Save the script file with a .js extension, and then refer 
to it using the src attribute in the &lt;script&gt; tag.</p>
<p><b>Note:</b> The external script file cannot contain the &lt;script&gt; tag.</p>
<p><b>Note:</b> Point to the external script file exactly where you would have 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>URL</i></td>
    <td>The URL of the external script file.<p>Possible values:</p>
<ul>
	<li>An absolute URL - points to another web site (like src=&quot;http://www.example.com/example.js&quot;)</li>
	<li>A relative URL - points to a file within a web site (like src=&quot;/scripts/example.js&quot;)</li>
</ul>
	</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_script_src.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_script_src.asp#top" target="_top">TOP</a> |
		<a href="att_script_src.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
