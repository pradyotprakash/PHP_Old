...
<style>a.menu_tag_option{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;option&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_output.asp">&lt;output&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_option" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;option&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;option&gt; tag defines an option in a select list.</p>
<p>&lt;option&gt; elements go inside a <a href="tag_select.asp">&lt;select&gt;</a> 
or <a href="tag_datalist.asp">&lt;datalist&gt;</a> element.</p>

<hr>
<h2>Tips and Notes</h2>
<p><b>Note:</b> The &lt;option&gt; tag can be used without any attributes, but
you usually need the <b>value</b> attribute, which indicates what is sent to the
server.</p>
<p><b>Tip:</b> If you have a long list of options, you can group related options with the <a href="tag_optgroup.asp">&lt;optgroup&gt;</a> tag.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_option_disabled.asp">disabled</a></td>
    <td>disabled</td>
    <td>Specifies that an option should be disabled</td>
  </tr>
  <tr>
    <td><a href="att_option_label.asp">label</a></td>
    <td><i>text</i></td>
    <td>Specifies a shorter label for an option</td>
  </tr>
  <tr>
    <td><a href="att_option_selected.asp">selected</a></td>
    <td>selected</td>
    <td>Specifies that an option should be pre-selected when the page loads</td>
  </tr>
  <tr>
    <td><a href="att_option_value.asp">value</a></td>
    <td><i>text</i></td>
    <td>Specifies the value to be sent to a server</td>
  </tr>
  </table>
...
<p>The &lt;option&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;option&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="../jsref/dom_obj_option.asp">Option object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_output.asp">&lt;output&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_option.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_option.asp#top" target="_top">TOP</a> |
		<a href="tag_option.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
