...
<title>HTML canvas setTransform() Method</title>
<style>a.menu_canvas_settransform{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">setTransform()</span> Method</h1>
...
<p>Draw a rectangle, reset and create a new transformation matrix with setTransform(), draw 
the rectangle again, reset and create a new transformation matrix, then draw the 
rectangle again. Notice that each time you call setTransform(), it resets the 
previous transformation matrix and then builds the new matrix, so in the example 
below, the red rectangle is not shown, because it is under the blue rectangle:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_setTransform" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the setTransform() 
method.</p>
...
<p>The setTransform() method resets the current transform to the identity 
matrix, and then runs <a href="canvas_transform.asp">transform()</a> 
with the same arguments.</p>
<p>In other words, the setTransform() method lets you scale, rotate, move, and skew the 
current context.</p>
<p><b>Note:</b> The transformation will only affect drawings made after the setTransform method is called.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.setTransform(<em>a,b,c,d,e,f</em>);</td>
  </tr>
</table>
<h2>Parameter Values</h2>
<table class="reference notranslate">
	<tr>
    <th style="width:13%">Parameter</th>
    <th style="width:58%">Description</th>
    <th>Play it</th>                
	</tr>
	<tr>
		<td><i>a</i></td>
		<td>Scales the drawings horizontally</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_setTransforma&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>b</i></td>
		<td>Skew the the drawings horizontally</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_setTransformb&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>c</i></td>
		<td>Skew the the drawings vertically</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_setTransformc&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>d</i></td>
		<td>Scales the drawings vertically</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_setTransformd&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>e</i></td>
		<td>Moves the the drawings horizontally</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_setTransforme&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>f</i></td>
		<td>Moves the the drawings vertically</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_setTransformf&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_settransform.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_settransform.asp#top" target="_top">TOP</a> |
		<a href="canvas_settransform.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
