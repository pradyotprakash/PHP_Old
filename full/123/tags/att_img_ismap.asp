...
<title>HTML img ismap Attribute</title>
<style>a.menu_att_img_ismap{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;img&gt; <span class="color_h1">ismap</span> Attribute</h1>
...
<p>A server-side image-map:</p>
<div class="example_code notranslate">
  
    &lt;a href=&quot;demo_form.asp&quot;&gt;<br>
	&lt;img src=&quot;w3html.gif&quot; alt=&quot;W3Schools.com&quot; ismap&gt;<br>
	&lt;/a&gt;
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_img_ismap" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The ismap attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage </h2>
<p>The ismap attribute is a boolean attribute.</p>
<p>When present, it specifies that the image is part of a server-side image-map 
(an image-map is an image with clickable areas).</p>
<p>When clicking on a server-side image-map, the click coordinates are sent to the 
server as a URL query string.</p>
<p><b>Note:</b> The ismap attribute is allowed only if the &lt;img&gt; element is a 
descendant of an &lt;a&gt; element with a valid href attribute.</p>
<hr>
...
<p>In XHTML, attribute minimization is forbidden, and the ismap attribute must 
be defined as &lt;img ismap=&quot;ismap&quot; /&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_img_ismap.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_img_ismap.asp#top" target="_top">TOP</a> |
		<a href="att_img_ismap.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
