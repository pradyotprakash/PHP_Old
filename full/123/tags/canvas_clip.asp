...
<title>HTML canvas clip() Method</title>
<style>a.menu_canvas_clip{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">clip()</span> Method</h1>
...
<p>Clip of a rectangular region of 200*120 pixels from the canvas. Then, draw a 
red rectangle. Only the part of the red rectangle that is inside the clipped 
area is visible:</p>
...
&lt;/script&gt;</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_clip" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the clip() 
method.</p>
...
<p>The clip() method clips a region of any shape and size from the original 
canvas.</p>
<p><b>Tip:</b> Once a region is clipped, all future drawing will be limited to 
the clipped region (no access to other regions on the canvas). You 
can however save the current canvas region using the save() method before using 
the clip() method, and restore it (with the restore() method) any time in the future. </p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.clip();</td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_clip.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_clip.asp#top" target="_top">TOP</a> |
		<a href="canvas_clip.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
