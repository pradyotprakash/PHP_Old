...
<style>a.menu_att_input_src{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">src</span> Attribute</h1>
...
<p>An HTML form with an image that represents the submit button:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_input_src" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The src attribute specifies the URL of the image to use as a submit button.</p>
<p><b>Note:</b> The src attribute is required for &lt;input type=&quot;image&quot;&gt;, and can 
only be used with &lt;input type=&quot;image&quot;&gt;.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>URL</i></td>
    <td>Specifies the URL of the image to use as a submit button.<p>Possible values:</p>
<ul>
	<li>An absolute URL - points to another web site (like src=&quot;http://www.example.com/submit.gif&quot;)</li>
	<li>A relative URL - points to a file within a web site (like src=&quot;submit.gif&quot;)</li>
</ul></td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_src.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_src.asp#top" target="_top">TOP</a> |
		<a href="att_input_src.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
