...
<style>a.menu_att_video_src{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;video&gt; <span class="color_h1">src</span> Attribute</h1>
...
<div class="example_code notranslate">
    &lt;video src=&quot;movie.ogg&quot; controls&gt;<br>
	&nbsp;
	Your browser does not support the video tag.<br>
	&lt;/video&gt;
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_video_src" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The src attribute is supported in all major browsers. However, the file format defined may not be supported in all browsers.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;video&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The src attribute specifies the location (URL) of the video file.</p>
<p>The example above uses an Ogg file, and will work in Firefox, Opera and Chrome.</p>
<p>To play the video in Internet Explorer and Safari, we must use an MPEG4 file.</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_video_all" target="_blank">Try it yourself  &raquo;</a>
</div>
<br>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>URL</i></td>
    <td>The URL of the video file.<p>Possible values:</p>
<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_video_src.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_video_src.asp#top" target="_top">TOP</a> |
		<a href="att_video_src.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
