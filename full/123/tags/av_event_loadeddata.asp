...
<title>HTML Audio/Video DOM loadeddata Event</title>
<style>a.menu_av_event_loadeddata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">loadeddata</span> Event</h1>
...
<p>Alert that data for the current frame is available:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.onloadeddata=alert(&quot;Browser 
	has loaded the current frame&quot;);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_loadeddata" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The loadeddata event occurs when data for the current frame is 
loaded, but not enough data to play next frame of the specified audio/video.</p>
...
<p>The loadeddata event is supported in all major browsers.</p>
...
<div class="code notranslate"><div>
	<em>&lt;audio|video</em> onloadeddata="<em>SomeJavaScriptCode</em>"&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.onloadeddata=<em>SomeJavaScriptCode</em>;</div></div>
<p>Using addEventListener():</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;loadeddata&quot;, function()<br>&nbsp; {<br>&nbsp; <em>
...
<p><a href="tryit.asp?filename=tryhtml5_av_event_loadeddata_html" target="_blank">Use the onloadeddata attribute on an HTML element</a></p>
<p><a href="tryit.asp?filename=tryhtml5_av_event_loadeddata_el" target="_blank">Use addEventListener() to listen for the loadeddata event</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_event_loadeddata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_event_loadeddata.asp#top" target="_top">TOP</a> |
		<a href="av_event_loadeddata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
