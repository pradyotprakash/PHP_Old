...
<title>HTML Audio/Video DOM preload Property</title>
<style>a.menu_av_prop_preload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">preload</span> Property</h1>
...
<p>Start loading the video as soon as the page loads:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_preload" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The preload property sets or returns if the audio/video should start loading 
as soon as the page loads.</p>
<p>The preload property allows the author to provide a hint to the browser about 
what he/she thinks will lead to the best user experience. This attribute may be 
ignored in some instances.</p>
<hr>
...
<p>The preload property is supported in all major browsers.</p>
<p><strong>Note:</strong> This property is not supported in Internet 
Explorer 8 and earlier.</p>
<hr>
<h2>Syntax</h2>
<p>Set the preload property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.preload=&quot;auto|metadata|none&quot;</div></div>
<p>Return the preload property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.preload</div></div>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>auto</td>   
    <td>Indicates that the audio/video should start loading as soon as the page 
	loads</td>
    </tr>
    <tr>
    <td>metadata</td>
    <td>Indicates that only the metadata for the audio/video should be 
	loaded when the page loads</td>
    </tr>
  <tr>
    <td>none</td>
    <td>Indicates that the audio/video should NOT start loading as soon as the 
	page loads</td>
  </tr>
  </table>
...
<tr>
	...
	<td>A String. auto|metadata|none</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_preload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_preload.asp#top" target="_top">TOP</a> |
		<a href="av_prop_preload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
