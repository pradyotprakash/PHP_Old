...
<title>HTML audio autoplay Attribute</title>
<style>a.menu_att_audio_autoplay{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;audio&gt; <span class="color_h1">autoplay</span> Attribute</h1>
...
<p>An audio file that will automatically start playing:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_audio_autoplay" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The autoplay attribute is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;audio&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The autoplay attribute is a boolean attribute.</p>
<p>When present, the audio will automatically start playing as soon as it can do so without stopping.</p>
<hr>
...
<p>In XHTML, attribute minimization is forbidden, and the autoplay attribute must 
be defined as &lt;audio autoplay=&quot;autoplay&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_audio_autoplay.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_audio_autoplay.asp#top" target="_top">TOP</a> |
		<a href="att_audio_autoplay.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
