...
<title>HTML input min Attribute</title>
<style>a.menu_att_input_min{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">min</span> Attribute</h1>
...
<p>Use of the min and max attributes:</p>
<div class="example_code notranslate">
    &lt;form action=&quot;demo_form.asp&quot;&gt;<br><br>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_input_max_min" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The min attribute is supported in Internet Explorer 10, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> The min attribute of the &lt;input&gt; tag is not supported in Internet Explorer 9 and earlier versions, or in Firefox.</p>
<p><strong>Note:</strong> The min attribute will not work for dates and time in Internet Explorer 10, since IE 10 does not support these input types.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The min attribute specifies the minimum value for an &lt;input&gt; element.</p>
<p><b>Tip:</b> Use the min attribute together with the <a href="att_input_max.asp">max</a> 
attribute to create a range of legal values.</p>
<p><strong>Note:</strong> The max and min attributes works with the following 
input types: number, range, date, datetime, datetime-local, month, time and week.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The min attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
		&lt;input min=&quot;<em>number</em><em style="font-style: normal">|</em><em>date</em>&quot;&gt;
</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_min.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_min.asp#top" target="_top">TOP</a> |
		<a href="att_input_min.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
