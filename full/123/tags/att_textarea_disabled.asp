...
<style>a.menu_att_textarea_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;textarea&gt; <span class="color_h1">disabled</span> Attribute</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_textarea_disabled">Try it yourself &raquo;</a>
...
<p>When present, it specifies that the text area should be disabled.</p>
<p>A disabled text area is unusable and the text is not selectable (cannot be 
copied).</p>
<p>The disabled attribute can be set to keep a user from using the text area 
until some other condition has been met (like selecting a checkbox, etc.). Then, 
a JavaScript could remove the disabled value, and make the text area usable.</p>
<hr>
...
be defined as &lt;textarea disabled=&quot;disabled&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_textarea_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_textarea_disabled.asp#top" target="_top">TOP</a> |
		<a href="att_textarea_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
