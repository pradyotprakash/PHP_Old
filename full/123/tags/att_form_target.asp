...
<style>a.menu_att_form_target{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Display the response received in a new window or tab:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_form_target" class="tryitbtn">Try it yourself &raquo;</a> 
...
<p>The target attribute defines a name of, or keyword for, a browsing context 
(e.g. tab, window, or inline frame).</p>

<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>The target attribute is supported in HTML5.</p>

<p>The target attribute was <a href="javascript:NewWindow('deprecated.htm')">deprecated</a> 
in HTML 4.01.</p>

<p><strong>Note:</strong> Frames and 
framesets are not supported in HTML5, so the _parent, _top and <i>framename</i> values are now mostly used with iframes.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;form target=&quot;_blank|_self|_parent|_top<em style="font-style: normal;">|</em><em>framename</em>&quot;&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_form_target.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_form_target.asp#top" target="_top">TOP</a> |
		<a href="att_form_target.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
