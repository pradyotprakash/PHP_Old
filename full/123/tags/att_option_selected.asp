...
<title>HTML option selected Attribute</title>
<style>a.menu_att_option_selected{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;option&gt; <span class="color_h1">selected</span> Attribute</h1>
...
<p>A drop-down list with a pre-selected option:</p>
<div class="example_code notranslate">
	...
	&nbsp;
	&lt;option value=&quot;audi&quot; selected&gt;Audi&lt;/option&gt;<br>
	&lt;/select&gt;
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_option_selected" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The selected attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The selected attribute is a boolean attribute.</p>
<p>When present, it specifies that an option should be pre-selected when 
the page loads.</p>
<p>The pre-selected option will be displayed first in the drop-down list.</p>
<p><b>Tip:</b> The selected attribute can also be set after the page loads, with a 
JavaScript.</p>
<hr>
...
<p>In XHTML, attribute minimization is forbidden, and the selected attribute must 
be defined as &lt;option selected=&quot;selected&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_option_selected.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_option_selected.asp#top" target="_top">TOP</a> |
		<a href="att_option_selected.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
