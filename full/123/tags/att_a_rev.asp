...
<title>HTML a rev Attribute</title>
<style>a.menu_att_a_rev{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_a_rel" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The rev attribute is supported in all major browsers.</p>
<p><b>Note</b>: Browsers do not use this attribute in any way. However, 
search engines can use this attribute to get more information 
about a link.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;a&gt; rev attribute is not supported in HTML5.</span></p>
<p>The rev attribute specifies the relationship between the linked document and 
the current document.</p>

<p>The rev attribute is the reverse of the <a href="att_a_rel.asp">rel</a> 
attribute.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_a_rev.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_a_rev.asp#top" target="_top">TOP</a> |
		<a href="att_a_rev.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
