...
<title>HTML audio controls Attribute</title>
<style>a.menu_att_audio_controls{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;audio&gt; <span class="color_h1">controls</span> Attribute</h1>
...
<p>An &lt;audio&gt; element with browser default controls:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_audio_controls" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The controls attribute is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;audio&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The controls attribute is a boolean attribute.</p>When present, it specifies 
that audio controls should be displayed.<p>Audio controls should include:</p>
<ul>
	<li>Play</li>
	<li>Pause</li>
	<li>Seeking</li>
...
<p>In XHTML, attribute minimization is forbidden, and the controls attribute must 
be defined as &lt;audio controls=&quot;controls&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_audio_controls.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_audio_controls.asp#top" target="_top">TOP</a> |
		<a href="att_audio_controls.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
