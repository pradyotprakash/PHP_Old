...
<style>a.menu_att_audio_src{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;audio&gt; <span class="color_h1">src</span> Attribute</h1>
<p><a href="tag_audio.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML audio Tag Reference" /> HTML &lt;audio&gt; tag</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>An audio player:</p>
<div class="example_code notranslate">
    &lt;audio src=&quot;horse.ogg&quot; controls&gt;<br>
	Your browser does not support the audio element.<br>
	&lt;/audio&gt;
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_audio_src" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The src attribute is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari. However, the file format defined may not be supported in all browsers.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;audio&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The src attribute specifies the location (URL) of the audio file.</p>
<p>The example above uses an Ogg file, and will work in Firefox, Opera and Chrome.</p>
<p>To play the audio file in Internet Explorer and Safari, we must use an MP3 file.</p>
<p>To make it work in all browsers - use <a href="tag_source.asp">&lt;source&gt;</a> 
elements inside the &lt;audio&gt; element. &lt;source&gt; elements can link to 
different audio files. The browser will use the first recognized format:</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>URL</i></td>
    <td>The URL of the audio file.<p>Possible values:</p>
<ul>
	<li>An absolute URL - points to another web site (like src=&quot;http://www.example.com/horse.ogg&quot;)</li>
	<li>A relative URL - points to a file within a web site (like src=&quot;horse.ogg&quot;)</li>
</ul>
    </td>
  </tr>
  </table>
<br>
<hr>
<a href="tag_audio.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML audio Tag Reference" /> HTML &lt;audio&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_audio_src.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_audio_src.asp#top" target="_top">TOP</a> |
		<a href="att_audio_src.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
