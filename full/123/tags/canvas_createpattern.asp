...
<title>HTML canvas createPattern() Method</title>
<style>a.menu_canvas_createpattern{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">createPattern()</span> Method</h1>
...
<p>Repeat an image both horizontally and vertically:</p>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the createPattern() method.</p>
...
<table class="tecspec">
    ...
    <td><i>context</i>.createPattern(<i>image</i>,"repeat|repeat-x|repeat-y|no-repeat");</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>image</i></td>		
		<td>Specifies the image, canvas, or video element of the pattern to use</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>repeat</td>		
		<td>Default. The pattern repeats both horizontally and vertically</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_createpattern&amp;preval=repeat">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>repeat-x</td>
		<td>The pattern repeats only horizontally</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_createpattern&amp;preval=repeat-x">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>repeat-y</td>
		<td>The pattern repeats only vertically</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_createpattern&amp;preval=repeat-y">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>no-repeat</td>
		<td>The pattern will be displayed only once (no repeat)</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_createpattern&amp;preval=no-repeat">Play it &raquo;</a></td>
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_createpattern.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_createpattern.asp#top" target="_top">TOP</a> |
		<a href="canvas_createpattern.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
