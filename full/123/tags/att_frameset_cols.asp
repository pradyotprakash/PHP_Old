...
<style>a.menu_att_frameset_cols{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;frameset&gt; <span class="color_h1">cols</span> Attribute</h1>
...
<p>A frameset with three columns:</p>
...
<p>The cols attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage </h2>
<p><span class="deprecated">The &lt;frameset&gt; tag is not supported in HTML5.</span></p>
<p>The cols attribute specifies the size of, and the number of columns in a &lt;frameset&gt;.</p>
<p>Each frame's width is specified in the cols attribute in a comma-separated list.</p>
<p><b>Note</b>: The number of cols attribute values specified, defines the number of columns in the 
&lt;frameset&gt;.</p>
<hr>
...
<div class="code notranslate"><div>
    ...
    &lt;frameset cols=&quot;<i>pixels</i>|<i>%</i>|<i>*</i>&quot;&gt;
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>%</i></td>
    <td>The column size in percent of the available space (like 
	&quot;50%&quot;)</td>
  </tr>
	<tr>
    <td><i>*</i></td>
    <td>The rest of the available space should be assigned this 
	column</td>
  </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_frameset_cols.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_frameset_cols.asp#top" target="_top">TOP</a> |
		<a href="att_frameset_cols.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
