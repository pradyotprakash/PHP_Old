...
<title>HTML canvas lineCap Property</title>
<style>a.menu_canvas_linecap{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">lineCap</span> Property</h1>
...
<p>Draw a line with rounded end caps:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_linecap" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p><b>Note:</b> The value &quot;round&quot; and &quot;square&quot; make the lines slightly longer. </p>
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.lineCap=&quot;butt|round|square&quot;;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td>butt</td>
		<td>Default. A flat edge is added to each end of the line</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_lineCap">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>round</td>
		<td>A rounded end cap is added to each end of the line</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_lineCap&amp;preval=round">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>square</td>
		<td>A square end cap is added to each end of the line</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_lineCap&amp;preval=square">Play it &raquo;</a></td>
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_linecap.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_linecap.asp#top" target="_top">TOP</a> |
		<a href="canvas_linecap.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
