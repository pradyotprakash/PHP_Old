...
<title>HTML source src Attribute</title>
<style>a.menu_att_source_src{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;source&gt; <span class="color_h1">src</span> Attribute</h1>
...
<p>The src attribute is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;source&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The src attribute specifies the URL of the media file to play.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>URL</i></td>
    <td>Specifies the URL of the media file.<p>Possible values:</p>
<ul>
	<li>An absolute URL - points to another web site (like href=&quot;http://www.example.com/horse.ogg&quot;)</li>
	<li>A relative URL - points to a file within a web site (like href=&quot;horse.ogg&quot;)</li>
</ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_source_src.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_source_src.asp#top" target="_top">TOP</a> |
		<a href="att_source_src.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
