...
<style>a.menu_att_table_cellspacing{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;table&gt; <span class="color_h1">cellspacing</span> Attribute</h1>
...
<p>Set the space between the cells to 10 pixels:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_table_cellspacing" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The cellspacing attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;table&gt; cellspacing attribute is not supported in HTML5.</span></p>
<p>The cellspacing attribute specifies the space, in pixels, between cells.</p>
<p><b>Note:</b> Do not confuse this with the <a href="att_table_cellpadding.asp"> cellpadding</a> attribute, which 
specifies the space between the cell wall and the cell content.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;table cellspacing=&quot;<i>pixels</i>&quot;&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_table_cellspacing.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_table_cellspacing.asp#top" target="_top">TOP</a> |
		<a href="att_table_cellspacing.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
