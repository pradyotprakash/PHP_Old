...
<title>HTML canvas fill() Method</title>
<style>a.menu_canvas_fill{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">fill()</span> Method</h1>
...
<p>Draw a 150*100 pixels rectangle, and fill it with the color red:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_fill" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the fill() 
method.</p>
...
<p>The fill() method fills the current drawing (path). The default color is black.</p>
<p><b>Tip:</b> Use the <a href="canvas_fillstyle.asp">fillStyle</a> 
property to fill with another color/gradient.</p>

<p><b>Note:</b> If the path is not closed, the fill() method will add a line from the last point to the startpoint of the path 
to close the path (like <a href="canvas_closepath.asp">closePath()</a>), and 
then fill the path.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.fill(<i></i>);</td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_fill.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_fill.asp#top" target="_top">TOP</a> |
		<a href="canvas_fill.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
