...
<style>a.menu_tag_th{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;th&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_thead.asp">&lt;thead&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>A simple HTML table with two header cells and two data cells:</p>
...
<p>The &lt;th&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;th&gt; tag defines a header cell in an HTML table.</p>
<p>An HTML table has two kinds of cells:</p>
<ul>
	<li>Header cells - contains header information (created with the
	&lt;th&gt; element)</li>
	<li>Standard cells - contains data (created with the <a href="tag_td.asp">&lt;td&gt;</a> element)</li>
</ul>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_th_abbr.asp">abbr</a></td>
    <td><i>text</i></td>
    <td>Specifies an abbreviated version of the content in a 
	header cell</td>
  </tr>
  <tr>
    <td><a href="att_th_align.asp">align</a></td>
    <td>left<br>
      right<br>
      center<br>
      justify<br>
  ...
  <tr>
    <td><a href="att_th_axis.asp">axis</a></td>
    <td><i>category_name</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br> 
	Categorizes header cells</td>
  </tr>
  <tr>
    <td><a href="att_th_bgcolor.asp">bgcolor</a></td>
    <td><i>rgb(x,x,x)<br>
    #xxxxxx<br>
    colorname</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
  ...
  <tr>
    <td><a href="att_th_char.asp">char</a></td>
    <td><i>character</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br> 
	Aligns the content in a header cell to a character</td>
  </tr>
  <tr>
    <td><a href="att_th_charoff.asp">charoff</a></td>
    <td><i>number</i>&nbsp;</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br> 
	Sets the number of characters the content will be aligned 
	from the character specified by the char attribute</td>
  </tr>
  <tr>
    <td><a href="att_th_colspan.asp">colspan</a></td>
    <td><i>number</i></td>
    <td>Specifies the number of columns a header cell should span</td>
  </tr>
  <tr>
    <td><a href="att_th_headers.asp">headers</a></td>
    <td><i>header_id</i></td>
    <td>Specifies one or more header cells a cell is related to</td>
  </tr>
  <tr>
    <td><a href="att_th_height.asp">height</a></td>
    <td><i>pixels<br>
	%</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
    ...
    <tr>
    <td><a href="att_th_nowrap.asp">nowrap</a></td>
    <td>nowrap</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
	Specifies that the content inside a header cell should not wrap</td>
    </tr>
  <tr>
    <td><a href="att_th_rowspan.asp">rowspan</a></td>
    <td><i>number</i></td>
    <td>Specifies the number of rows a header cell should span</td>
  </tr>
  <tr>
    <td><a href="att_th_scope.asp">scope</a></td>
    <td>col<br>
      colgroup<br>
      row<br>
      rowgroup</td>
    <td>Specifies whether a header cell is a header for a column, row, or group 
	of columns or rows </td>
  </tr>
  <tr>
    <td>sorted</td>
    <td>reversed<br><em>number</em><br>reversed <em>number</em><br><em>number</em> 
	reversed</td>
    <td>Defines the sort direction of a column</td>
  </tr>
    <tr>
    <td><a href="att_th_valign.asp">valign</a></td>
    <td>top<br>
      middle<br>
      bottom<br>
      baseline</td>
...
content in a header cell</td>
    ...
    <tr>
    <td><a href="att_th_width.asp">width</a></td>
    <td><i>pixels<br>
    %</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
...
<p>The &lt;th&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;th&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
...
<a href="../jsref/dom_obj_tabledata.asp">Th object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_thead.asp">&lt;thead&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_th.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_th.asp#top" target="_top">TOP</a> |
		<a href="tag_th.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
