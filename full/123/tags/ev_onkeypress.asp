...
<title>HTML onkeypress Event Attribute</title>
<style>a.menu_ev_onkeypress{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onkeypress</span> Event Attribute</h1>
...
<p>Execute a JavaScript when a user presses a key:</p>
<div class="example_code notranslate">
    &lt;input type=&quot;text&quot; onkeypress=&quot;displayResult()&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml5_ev_onkeypress">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The onkeypress event attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onkeypress attribute fires when the user presses a key (on the keyboard).</p>
<p><b>Tip:</b> The order of events related to the onkeypress event:</p>
<ol>
	<li>onkeydown</li>
	<li>onkeypress</li>
	<li>onkeyup</li>
</ol>
<p><b>Note:</b> The onkeypress event is not fired for all keys (e.g. ALT, CTRL, 
SHIFT, ESC) in all browsers. To detect only whether the user has pressed a key, 
use <a href="ev_onkeydown.asp">onkeydown</a> instead, because it works for all keys.</p>
<p><b>Note:</b> The onkeypress attribute CANNOT be used with: &lt;base&gt;, &lt;bdo&gt;, &lt;br&gt;, 
...
<div class="code notranslate"><div>
    &lt;<i>element</i> onkeypress=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onkeypress</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_onkeypress.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_onkeypress.asp#top" target="_top">TOP</a> |
		<a href="ev_onkeypress.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
