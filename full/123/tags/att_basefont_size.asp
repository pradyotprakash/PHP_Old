...
<title>HTML basefont size Attribute</title>
<style>a.menu_att_basefont_size{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;basefont&gt; <span class="color_h1">size</span> Attribute</h1>
...
<p>Specify the default font-size for text on page:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_basefont_size" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The size attribute is only supported in Internet Explorer 9, and earlier versions.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The size attribute specifies the default font-size for the text in a document.</p>
<hr>

<h2>Compatibility Notes</h2>
<p><span class="deprecated">The size attribute of &lt;basefont&gt; is not supported in HTML5. Use 
CSS instead.</span></p>
<p>CSS syntax (in the &lt;head&gt; section): &lt;style&gt;body{font-size: 10px}&lt;/style&gt;</p>
<p><a target="_blank" href="tryit.asp?filename=tryhtml_basefont_size_css">CSS 
Example: Specify a default font-size for a page</a></p>
<p>In our CSS tutorial you can find more details about the
<a href="../cssref/pr_font_font-size.asp">font-size property</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;basefont size=&quot;<i>number</i>&quot;&gt;
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>number</i></td>
    <td>A number from 1 to 7 that defines the size of the text. Browser default 
	is 3</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_basefont_size.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_basefont_size.asp#top" target="_top">TOP</a> |
		<a href="att_basefont_size.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
