...
<style>a.menu_ref_urlencode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">URL Encoding</span> Reference</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ref_charactersets.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ref_language_codes.asp">Next 
	Reference &raquo;</a></div>
</div>
<hr>
<p class="intro">URL encoding converts characters into a format that can be 
...
<p>The URL is the address of a web page, like: <b>http://www.w3schools.com.</b></p>
<hr>
<h2>URL Encoding</h2>
<p>URLs can only be sent over the Internet using the <a href="../charsets/ref_html_ascii.asp">
ASCII character-set</a>.</p>
<p>Since URLs often contain characters outside the ASCII set, the URL has to be 
converted into a valid ASCII format.</p>
<p>URL encoding replaces unsafe ASCII characters with a "%" followed by two 
hexadecimal digits.<br>
</p>
<p>URLs cannot contain spaces. URL encoding normally replaces a space with a 
plus (+) sign or with %20.</p>
<hr>
...
input.</p>
<form name="input" target="_blank" action="http://www.w3schools.com/tags/html_form_submit.asp" method="get">
<input type="text" value="Hello Günter" name="text" size="30" />
<input type="submit" value="Submit" />
</form>

<p>
Try some other input and click Submit again.</p>
<hr>

<h2>URL Encoding Functions</h2>
<p>In JavaScript, PHP, and ASP there are functions that can be used to URL 
encode a string.</p>
<p>In JavaScript you can use the encodeURI() function. PHP has the 
rawurlencode() function and ASP has the Server.URLEncode() function.</p>
<p>Click the "URL Encode" button to see how the JavaScript function encodes the 
text.</p>
<form name="changeform" action="ref_urlencode.asp">
...
<p><b>Note: </b>The JavaScript function encodes space as %20.</p>
<hr>
...
<p>The ASCII device control characters %00-%1f were originally designed to 
control hardware devices. Control characters have nothing to do inside a URL.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_urlencode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_urlencode.asp#top" target="_top">TOP</a> |
		<a href="ref_urlencode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
