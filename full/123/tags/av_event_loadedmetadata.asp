...
<title>HTML Audio/Video DOM loadedmetadata Event</title>
<style>a.menu_av_event_loadedmetadata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">loadedmetadata</span> Event</h1>
...
<p>Alert when meta data for the video is loaded:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.onloadedmetadata=alert(&quot;Meta 
	data for video loaded&quot;);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_loadedmetadata" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The loadedmetadata event occurs when meta data for the specified audio/video has been loaded.</p>
<p>Meta data for audio/video consists of: duration, dimensions (video only) and text tracks.</p>
...
<ol>
	...
	<li><a href="av_event_durationchange.asp">durationchange</a></li>
...
<p>The loadedmetadata event is supported in all major browsers.</p>
...
<div class="code notranslate"><div>
	<em>&lt;audio|video</em> onloadedmetadata="<em>SomeJavaScriptCode</em>"&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.onloadedmetadata=<em>SomeJavaScriptCode</em>;</div></div>
<p>Using addEventListener():</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;loadedmetadata&quot;, function()<br>&nbsp; {<br>&nbsp; <em>
...
<p><a href="tryit.asp?filename=tryhtml5_av_event_loadedmetadata_html" target="_blank">Use the onloadedmetadata attribute on an HTML element</a></p>
<p><a href="tryit.asp?filename=tryhtml5_av_event_loadedmetadata_el" target="_blank">Use addEventListener() to listen for the loadedmetadata event</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_event_loadedmetadata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_event_loadedmetadata.asp#top" target="_top">TOP</a> |
		<a href="av_event_loadedmetadata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
