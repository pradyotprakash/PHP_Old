...
<title>HTML optgroup label Attribute</title>
<style>a.menu_att_optgroup_label{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;optgroup&gt; <span class="color_h1">label</span> Attribute</h1>
...
<p>Two option-groups with labels:</p>
...
<p>The label attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The label attribute specifies a label for an option-group.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>text</i></td>
    <td>Specifies a label/description for the option-group</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_optgroup_label.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_optgroup_label.asp#top" target="_top">TOP</a> |
		<a href="att_optgroup_label.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
