...
<style>a.menu_tag_noframes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;noframes&gt;</span> Tag. <span class="deprecated">Not Supported in HTML5.</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_noscript.asp">&lt;noscript&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>A three-framed page, with a &lt;noframes&gt; tag:</p>
...
&nbsp; &lt;frame src=&quot;frame_c.htm&quot;&gt;<br>
	&nbsp; &lt;noframes&gt;Sorry, your browser does not handle frames!&lt;/noframes&gt;<br>
	&lt;/frameset&gt;<br><br>
	&lt;/html&gt;
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_noframes" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;noframes&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;noframes&gt; tag is not supported in HTML5.</span></p>
<p>The &lt;noframes&gt; tag is a fallback tag for browsers that do not support frames. 
It can contain all the HTML elements that you can find inside the 
&lt;body&gt; element of a normal HTML page.</p>
<p>The &lt;noframes&gt; element can be used to link to a non-frameset version of the web site or to display a message to users that frames are required.</p>
<p>The &lt;noframes&gt; element goes inside the &lt;frameset&gt; element.</p>
...
<p>The &lt;noframes&gt; tag is not supported in HTML5, but is supported in HTML 4.01.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p><b>Important:</b> In XHTML Frameset DTD, the <b>text</b> in the &lt;noframes&gt; element must be enclosed in a 
&lt;body&gt; element.</p>
<hr>

<h2>Standard Attributes</h2>
<p>The &lt;noframes&gt; tag supports the following standard attributes in HTML 
4.01:</p>
<table class="reference notranslate"> 
  ...
  <tr>
    <td>xml:lang</td>
    <td><i>language_code</i></td>
    <td>Specifies a language code for the content in an element, in 
	XHTML documents</td>
  </tr>
</table>
...
<p>The &lt;noframes&gt; tag supports the following event attributes in HTML 4.01:</p>
<table class="reference notranslate"> 
  <tr>
    <th style="width:20%">Attribute</th>
    <th style="width:20%">Value</th>
  ...
  <tr>
    <td>onmousedown</td>
    <td><i>script</i></td>
    <td>Script to be run when mouse button is pressed</td>
  </tr>
  <tr>
    <td>onmousemove</td>
    <td><i>script</i></td>
    <td>Script to be run when mouse pointer moves</td>
  </tr>
	<tr>
    <td>onmouseout</td>
    <td><i>script</i></td>
    <td>Script to be run when mouse pointer moves out of an
      element</td>
  </tr>
	<tr>
    <td>onmouseover</td>
    <td><i>script</i></td>
    <td>Script to be run when mouse pointer moves over an
      element</td>
  </tr>
  <tr>
    <td>onmouseup</td>
    <td><i>script</i></td>
    <td>Script to be run when mouse button is released</td>
  </tr>
  <tr>
    <td>onkeydown</td>
    <td><i>script</i></td>
    <td>Script to be run when a key is pressed</td>
  </tr>
  <tr>
    <td>onkeypress</td>
    <td><i>script</i></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_noframes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_noframes.asp#top" target="_top">TOP</a> |
		<a href="tag_noframes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
