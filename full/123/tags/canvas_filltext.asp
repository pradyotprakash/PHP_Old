...
<title>HTML canvas fillText() Method</title>
<style>a.menu_canvas_filltext{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">fillText()</span> Method</h1>
...
<p>Write "Hello world!" and &quot;Big smile!&quot; (with gradient) on the canvas, 
using fillText():</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_filltext" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the fillText() 
method.</p>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_filltexttext">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>x</i></td>
		<td>The x coordinate where to start painting the text (relative to the 
		canvas)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_filltextx">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y coordinate where to start painting the text (relative to the 
		canvas)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_filltexty">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td><i>maxWidth</i></td>
		<td>Optional. The maximum allowed width of the text, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_filltextmaxwidth">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_filltext.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_filltext.asp#top" target="_top">TOP</a> |
		<a href="canvas_filltext.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
