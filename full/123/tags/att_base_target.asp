...
<style>a.menu_att_base_target{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;base&gt; <span class="color_h1">target</span> Attribute</h1>
<p><a href="tag_base.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML base Tag Reference" /> HTML &lt;base&gt; tag</a></p>
<div class="example">


<h2 class="example">Example</h2>
<p>Specify a default target for all hyperlinks and forms on a page:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_base_target" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The target attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The target attribute specifies the default target for all hyperlinks and 
forms in the page.</p>
<p>This attribute can be overridden by using the target attribute for each 
hyperlink/form.</p>
<hr>
...
<p>Frames and 
framesets are no longer supported in HTML5. Therefore, the _parent, _top and <i>framename</i> values are now mostly used with iframes.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;base target=&quot;_blank|_self|_parent|_top|<i>framename</i>&quot;&gt;
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>_blank</td>
    <td>Opens the link in a new window or tab</td>
  </tr>
  <tr>
    <td>_self</td>
    <td>Default. Opens the link in the same frame as it was clicked</td>
  </tr>
	<tr>
    <td>_parent</td>
    <td>Opens the link in the parent frame</td>
  </tr>
	<tr>
    <td>_top</td>
    <td>Opens the link in the full body of the window</td>
  </tr>
  <tr>
    <td><i>framename</i></td>
    <td>Opens the link in a named frame</td>
  </tr>
  </table>
<br>
<hr>
<a href="tag_base.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML base Tag Reference" /> HTML &lt;base&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_base_target.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_base_target.asp#top" target="_top">TOP</a> |
		<a href="att_base_target.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
