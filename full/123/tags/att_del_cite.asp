...
<title>HTML del cite Attribute</title>
<style>a.menu_att_del_cite{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;del&gt; <span class="color_h1">cite</span> Attribute</h1>
...
<p>A deleted text, with a URL to a document that explains why the text was 
deleted:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_del_cite" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The cite attribute specifies a URL to a document that explains the reason why the text was deleted.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>URL</i></td>
    <td>Specifies the address to the document that explains why the text was deleted.<p>Possible values:</p>
<ul>
	<li>An absolute URL - Points to another web site (like cite=&quot;http://www.example.com/page.htm&quot;)</li>
	<li>A relative URL - Points to a page within a web site (like cite=&quot;page.htm&quot;)</li>
</ul>
	</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_del_cite.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_del_cite.asp#top" target="_top">TOP</a> |
		<a href="att_del_cite.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
