...
<title>HTML del datetime Attribute</title>
<style>a.menu_att_del_datetime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;del&gt; <span class="color_h1">datetime</span> Attribute</h1>
<p><a href="tag_del.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML del Tag Reference" /> HTML &lt;del&gt; tag</a></p>
<div class="example">


<h2 class="example">Example</h2>
<p>A deleted text, with a date and time of when the text was deleted:</p>
<div class="example_code notranslate">
  
    &lt;p&gt;<br>
	&lt;del datetime=&quot;2011-11-15T22:55:03Z&quot;&gt;This text has been deleted&lt;/del&gt;<br>
	&lt;/p&gt;
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_del_datetime" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The datetime attribute has no visual effect in ordinary web browsers, but can be 
used by screen readers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The datetime attribute specifies the date and time when the text was deleted.</p>
<hr>
...
<div class="code notranslate"><div>
    ...
    &lt;del datetime=&quot;<i>YYYY-MM-DDThh:mm:ssTZD</i>&quot;&gt;
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>The date and time of when the text was deleted.<p>Explanation of components:</p>
	<ul>
		<li>YYYY - year (e.g. 2012)</li>
		<li>MM - month (e.g. 01 for January)</li>
		<li>DD - day of the month (e.g. 08)</li>
		<li>T - a required separator</li>
		<li>hh - hour (e.g. 22 for 10.00pm)</li>
		<li>mm - minutes (e.g. 55)</li>
		<li>ss - seconds (e.g. 03)</li>
		<li>TZD - Time Zone Designator (Z denotes Zulu, also known as Greenwich Mean Time)</li>
	</ul>
	</td>
  </tr>
  </table>
<br>
<hr>
<a href="tag_del.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML del Tag Reference" /> HTML &lt;del&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_del_datetime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_del_datetime.asp#top" target="_top">TOP</a> |
		<a href="att_del_datetime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
