...
<title>HTML Global spellcheck Attribute</title>
<style>a.menu_att_global_spellcheck{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">spellcheck</span> Attribute</h1>
...
<p>An editable paragraph with spellcheck:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_global_spellcheck" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The spellcheck attribute is supported in Internet Explorer 10, Firefox, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> The spellcheck attribute is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The spellcheck attribute specifies whether the element is to have its 
spelling and grammar checked or not.</p>
<p>The following can be spellchecked:</p>
<ul>
...
<p>The spellcheck attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	
		&lt;<i>element</i> spellcheck=&quot;true|false&quot;&gt;
...
<table class="reference notranslate">
	...
	<tr>
		<td>true</td>
		<td>The element is to have its spelling and grammar checked</td>
	</tr>
	<tr>
		<td>false</td>
		<td>The element is not to be checked</td>
	</tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_global_spellcheck.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_global_spellcheck.asp#top" target="_top">TOP</a> |
		<a href="att_global_spellcheck.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
