...
<title>HTML canvas rect() Method</title>
<style>a.menu_canvas_rect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">rect()</span> Method</h1>
...
<p>Draw a 150*100 pixels rectangle:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_rect" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the rect() 
method.</p>
...
<a href="canvas_fill.asp">fill()</a> method to actually draw the rectangle on the canvas.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.rect(<i>x,y,width,height</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_rectx">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y-coordinate of the upper-left corner of the rectangle</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_recty">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>width</i></td>
		<td>The width of the rectangle, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_rectw">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>height</i></td>
		<td>The height of the rectangle, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_recth">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Create three rectangles with the rect() method:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_rect2" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_rect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_rect.asp#top" target="_top">TOP</a> |
		<a href="canvas_rect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
