...
<title>HTML Audio/Video DOM duration Property</title>
<style>a.menu_av_prop_duration{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">duration</span> Property</h1>
...
<p>Get the length of the current video:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>
	alert(myVid.duration);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_duration" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>

<h2>Definition and Usage</h2>
<p>The duration property returns the length of the current audio/video, 
in seconds.</p>
<p>If no audio/video is set, NaN (Not-a-Number) is returned.</p>
<hr>
...
<p>The duration property is supported in all major browsers.</p>
<p><strong>Note:</strong> This property is not supported in Internet 
Explorer 8 and earlier.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>audio|video</em>.duration</div></div>
<h2>Technical Details</h2>
<table class="reference notranslate">
<tr>
	<th style="width:20%">Return Value:</th>
	<td>A Number, representing the length of the video, in seconds</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_duration.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_duration.asp#top" target="_top">TOP</a> |
		<a href="av_prop_duration.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
