...
<style>a.menu_att_a_href{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;a&gt; <span class="color_h1">href</span> Attribute</h1>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_a_href" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The href attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The href attribute specifies the URL of the page the link goes to.</p>
<p>If the href attribute is not present, the &lt;a&gt; tag is not a hyperlink.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>In HTML5, if the &lt;a&gt; tag has no href attribute, it is 
a placeholder for a hyperlink.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;a href=&quot;<i>URL</i>&quot;&gt;</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>URL</i></td>
    <td>The URL of the link.<p>Possible values:</p>
<ul>
	<li>An absolute URL - points to another web site (like href=&quot;http://www.example.com/default.htm&quot;)</li>
	<li>A relative URL - points to a file within a web site (like href=&quot;default.htm&quot;)</li>
	<li>Link to an element with a specified id within the page (like href=&quot;#top&quot;)</li>
	<li>Other protocols (like https://, ftp://, mailto:, file:, etc..)</li>
	<li>A script (like href="javascript:alert('Hello');"</li>
</ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_a_href.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_a_href.asp#top" target="_top">TOP</a> |
		<a href="att_a_href.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
