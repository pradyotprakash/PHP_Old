...
<title>HTML form novalidate Attribute</title>
<style>a.menu_att_form_novalidate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;form&gt; <span class="color_h1">novalidate</span> Attribute</h1>
...
<p>Indicate that the form is not to be validated on submit:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_form_novalidate" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The novalidate attribute is supported in Internet Explorer 10, Firefox, Opera, and Chrome.</p>
<p><strong>Note:</strong> The novalidate attribute is not supported in Internet Explorer 9 and earlier version, or in Safari.</p>
<hr>
...
<p>The novalidate attribute is new in HTML5.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In XHTML, attribute minimization is forbidden, and the novalidate attribute must 
be defined as &lt;form novalidate=&quot;novalidate&quot;&gt;. </p>
<hr>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_form_novalidate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_form_novalidate.asp#top" target="_top">TOP</a> |
		<a href="att_form_novalidate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
