...
<style>a.menu_att_iframe_sandbox{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;iframe&gt; <span class="color_h1">sandbox</span> Attribute</h1>
...
<p>An &lt;iframe&gt; with extra restrictions:</p>
<div class="example_code notranslate">
    &lt;iframe src=&quot;demo_iframe_sandbox.htm&quot; 
	sandbox=&quot;&quot;&gt;&lt;/iframe&gt;
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_iframe_sandbox" target="_blank">Try it yourself &raquo;</a>
...
<p>The sandbox attribute is supported in Internet Explorer 10, Firefox, Chrome, and Safari.</p>
...
<p>If specified as an empty string (sandbox=&quot;&quot;), the sandbox attribute enables a set of 
extra restrictions for the content in the inline frame.</p>
<p>The value of the sandbox attribute can either be an empty string (all the 
restrictions is applied), or a space-separated list of pre-defined values that 
will REMOVE particular restrictions.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The sandbox attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
		&lt;iframe sandbox=&quot;<i>value</i>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		<td>&quot;&quot;</td>
		<td>Applies all restrictions below</td>
	</tr>
	<tr>
		<td>allow-same-origin</td>
		<td>Allows the iframe content to be treated as being from the same 
		origin as the containing document</td>
	</tr>
	<tr>
		<td>allow-top-navigation</td>
		<td>Allows the iframe content to navigate (load) content from the 
...
<p><a target="_blank" href="tryit.asp?filename=tryhtml5_iframe_sandbox_form">An &lt;iframe&gt; sandbox allowing form submission</a><br>
Enable a set of extra restrictions, but allow form submission.</p>
<p><a target="_blank" href="tryit.asp?filename=tryhtml5_iframe_sandbox_origin">An &lt;iframe&gt; sandbox allowing scripts and access to server content</a><br>
Enable a set of extra restrictions, but allow scripts and access to server content.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_iframe_sandbox.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_iframe_sandbox.asp#top" target="_top">TOP</a> |
		<a href="att_iframe_sandbox.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
