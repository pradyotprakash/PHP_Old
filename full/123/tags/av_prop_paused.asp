...
<title>HTML Audio/Video DOM paused Property</title>
<style>a.menu_av_prop_paused{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">paused</span> Property</h1>
...
<p>Check if the video is paused:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>
	alert(myVid.paused);<br></div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_paused" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The paused property returns if the audio/video is paused.</p>
<hr>
...
<p>The paused property is supported in all major browsers.</p>
...
<div class="code notranslate">
	<div>
		<em>audio|video</em>.paused</div></div>
<h2>Technical Details</h2>

<table class="reference notranslate">
<tr>
	<th style="width:20%">Return Value:</th>
	<td>Boolean, true|false.<br>true indicates that the audio/video is paused. 
	Otherwise false</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_paused.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_paused.asp#top" target="_top">TOP</a> |
		<a href="av_prop_paused.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
