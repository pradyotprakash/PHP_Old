...
<title>HTML Audio/Video DOM load() Method</title>
<style>a.menu_av_met_load{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">load()</span> Method</h1>
...
<p>Change the video source and re-load the video:</p>
<div class="example_code notranslate">
  
    document.getElementById(&quot;mp4_src&quot;).src=&quot;movie.mp4&quot;;<br>
	document.getElementById(&quot;ogg_src&quot;).src=&quot;movie.ogg&quot;;<br>
	document.getElementById(&quot;video1&quot;).load();</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_met_load" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>

<h2>Definition and Usage</h2>
<p>The load() method re-loads the audio/video element.</p>
<p>The load() method is used to update the audio/video element after changing 
the source or other settings.</p>
<hr>
...
<p>The load() method is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari 6.</p>
<p><strong>Note:</strong> The load() method is not supported in Internet Explorer 8 and earlier versions.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	
		<em>audio|video</em>.load()
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_met_load.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_met_load.asp#top" target="_top">TOP</a> |
		<a href="av_met_load.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
