...
<title>HTML form enctype Attribute</title>
<style>a.menu_att_form_enctype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;form&gt; <span class="color_h1">enctype</span> Attribute</h1>
...
<p>Send form-data encoded as &quot;multipart/form-data&quot;:</p>
<div class="example_code notranslate">
  
    &lt;form action=&quot;demo_post_enctype.asp&quot;<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_form_enctype" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The enctype attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The enctype attribute specifies how the form-data should be encoded when 
submitting it to the server.</p>
<p><b>Note:</b> The enctype attribute can be used only if method=&quot;post&quot;.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_form_enctype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_form_enctype.asp#top" target="_top">TOP</a> |
		<a href="att_form_enctype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
