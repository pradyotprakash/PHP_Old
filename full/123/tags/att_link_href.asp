...
<title>HTML link href Attribute</title>
<style>a.menu_att_link_href{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;link&gt; <span class="color_h1">href</span> Attribute</h1>
...
<p>Link to an external stylesheet:</p>
...
<p>The href attribute specifies the location (URL) of the external resource 
(most often a style sheet file).</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>URL</i></td>
    <td>The URL of the linked resource/document.<p>Possible values:</p>
	<ul>
		<li>An absolute URL - points to another web site (like href=&quot;http://www.example.com/theme.css&quot;) 
		</li>
		<li>A relative URL - points to a file within a web site (like href=&quot;/themes/theme.css&quot;)</li>
	</ul>
	</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_link_href.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_link_href.asp#top" target="_top">TOP</a> |
		<a href="att_link_href.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
