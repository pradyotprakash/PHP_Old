...
<style>a.menu_tag_colgroup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;colgroup&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_command.asp">&lt;command&gt; Tag &raquo;</a></div>
</div>
<br>
<div class="example">
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_colgroup_test" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;colgroup&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;colgroup&gt; tag specifies a group of one or more columns in a table for formatting.</p>
<p>The &lt;colgroup&gt; tag is useful for applying styles to entire columns, instead of repeating the styles for each cell, for each row.</p>
<p><b>Note:</b> The &lt;colgroup&gt; tag must be a child of a &lt;table&gt; element, 
after any &lt;caption&gt; elements and before any &lt;thead&gt;, &lt;tbody&gt;, &lt;tfoot&gt;, and &lt;tr&gt; 
elements.</p>
<p><b>Tip:</b> To define different properties to a column within a &lt;colgroup&gt;, 
use the <a href="tag_col.asp">&lt;col&gt;</a> tag within the &lt;colgroup&gt; tag.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>Most of the attributes in HTML 4.01 are not supported in HTML5.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_colgroup_align.asp">align</a></td>
    <td>left<br>
      right<br>
      center<br>
      justify<br>
...
content in a column group</td>
      </tr>
      <tr>
    <td><a href="att_colgroup_char.asp">char</a></td>
    <td><i>character</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Aligns the content in a column group to a character</td>
      </tr>
      <tr>
    <td><a href="att_colgroup_charoff.asp">charoff</a></td>
    <td><i>number</i></td>
  ...
  <tr>
    <td><a href="att_colgroup_span.asp">span</a></td>
    <td><i>number</i></td>
    <td>Specifies the number of columns a column group should span</td>
  </tr>
        <tr>
    <td><a href="att_colgroup_valign.asp">valign</a></td>
    <td>top<br>
      middle<br>
      bottom<br>
      baseline</td>
...
content in a column group</td>
  ...
  <tr>
    <td><a href="att_colgroup_width.asp">width</a></td>
    <td><i>pixels<br>
    %<br>
	relative_length</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the width of a column group</td>
  </tr>
  </table>
...
<p>The &lt;colgroup&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;colgroup&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_command.asp">&lt;command&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_colgroup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_colgroup.asp#top" target="_top">TOP</a> |
		<a href="tag_colgroup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
