...
<title>HTML Audio/Video DOM pause() Method</title>
<style>a.menu_av_met_pause{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">pause()</span> Method</h1>
...
<div class="example_code notranslate">
	...
	<br>function playVid()<br>&nbsp; { <br>&nbsp; myVideo.play(); <br>&nbsp; }
	<br>function pauseVid()<br>&nbsp; { <br>&nbsp; myVideo.pause(); <br>&nbsp; 
	}&nbsp;
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_met_play_pause" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The pause() method halts (pauses) the currently playing audio or video.</p>
<hr>
...
<p>The pause() method is supported in all major browsers.</p>
...
<div class="code notranslate"><div>
		...
		<em>audio|video</em>.pause()
	
</div></div>
<br>
<hr>
<a href="ref_av_dom.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML audio Tag Reference" /> HTML Audio/Video DOM Reference</a>				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_met_pause.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_met_pause.asp#top" target="_top">TOP</a> |
		<a href="av_met_pause.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
