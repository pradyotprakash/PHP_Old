...
<title>HTML command icon Attribute</title>
<style>a.menu_att_command_icon{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;command&gt; <span class="color_h1">icon</span> Attribute</h1>
...
<p>An image that represents the &lt;command&gt; element:</p>
<div class="example_code notranslate">
    &lt;menu&gt;<br>
	&lt;command type=&quot;radio&quot; label=&quot;Left&quot; icon=&quot;left.png&quot;<br>
	onclick=&quot;setAlign('left')&quot;&gt;Left&lt;/command&gt;<br>
	&lt;/menu&gt;
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_command_icon" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The icon attribute is currently not supported in any of the major 
browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The icon attribute specifies an image that represents the command.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>URL</em></td>
		<td>Specifies the picture that represents the command.<p>Possible values:</p>
<ul>
	<li>An absolute URL - points to another web site (like icon=&quot;http://www.example.com/lamp.jpg&quot;)</li>
	<li>A relative URL - points to a file within the web site (like icon=&quot;lamp.jpg&quot;)</li>
</ul>
		</td>
	</tr>
	</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_command_icon.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_command_icon.asp#top" target="_top">TOP</a> |
		<a href="att_command_icon.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
