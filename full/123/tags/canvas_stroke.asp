...
<title>HTML canvas stroke() Method</title>
<style>a.menu_canvas_stroke{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">stroke()</span> Method</h1>
...
<p>Draw a path, shaped as the letter L - in a red color:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_stroke" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the stroke() 
method.</p>
...
<p>The stroke() method actually draws the path you have defined with all those 
moveTo() and lineTo() methods. The 
default color is black.</p>
<p><b>Tip:</b> Use the <a href="canvas_strokestyle.asp">strokeStyle</a> 
property to draw with another color/gradient.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.stroke(<i></i>);</td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_stroke.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_stroke.asp#top" target="_top">TOP</a> |
		<a href="canvas_stroke.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
