...
<title>HTML source media Attribute</title>
<style>a.menu_att_source_media{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;source&gt; <span class="color_h1">media</span> Attribute</h1>
<p><a href="tag_source.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML source Tag Reference" /> HTML &lt;source&gt; tag</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Use of the media attribute:</p>
<div class="example_code notranslate">
    &lt;source src=&quot;movie.ogg&quot; type=&quot;video/ogg&quot;<br>
	media=&quot;screen and (min-width:320px)&quot;&gt;
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_source_media" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Browser Support</h2>
<p>
<img src="http://www.w3schools.com/images/incompatible_ie.gif" width="31" height="30" alt="Internet Explorer" title="Internet Explorer" />
<img src="http://www.w3schools.com/images/incompatible_firefox.gif" width="31" height="30" alt="Firefox" title="Firefox" />
<img src="http://www.w3schools.com/images/incompatible_opera.gif" width="28" height="30" alt="Opera" title="Opera" />
<img src="http://www.w3schools.com/images/incompatible_chrome.gif" width="31" height="30" alt="Google Chrome" title="Google Chrome" />
<img src="http://www.w3schools.com/images/incompatible_safari.gif" width="28" height="30" alt="Safari" title="Safari" /></p>
<p>The media attribute is not supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The media attribute specifies the type of media resource (what media/device the file is optimized for).</p>
<p>The browser can use this attribute to determine whether it can play the file 
or not. If it cannot, it can choose not to download it.</p>
<p><b>Note:</b> This attribute can accept several values.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The &lt;source&gt; tag is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
    &lt;source media=&quot;<i>value</i>&quot;&gt;
</div></div>

<h2>Possible Operators</h2>
<table class="reference notranslate"> 
  ...
  <tr>
    <td>and</td>
    <td>Specifies an AND operator</td>
  </tr>
	<tr>
    <td>not</td>
    <td>Specifies a NOT operator</td>
    </tr>
	<tr>
    <td>,</td>
    <td>Specifies an OR operator</td>
    </tr>
	</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td>all</td>
		<td>Suitable for all devices. This is default</td>
	</tr>
	<tr>
		<td>aural</td>
	...
	<tr>
		<td>braille</td>
		<td>Braille feedback devices</td>
	</tr>
	<tr>
		<td>handheld</td>
		<td>Handheld devices (small screen, limited bandwidth)</td>
	</tr>
	<tr>
		<td>projection</td>
		<td>Projectors</td>
	...
	<tr>
		<td>print</td>
		<td>Print preview mode/printed pages</td>
	</tr>
	<tr>
		<td>screen</td>
	...
	<tr>
		<td>tty</td>
		<td>Teletypes and similar media using a fixed-pitch character grid</td>
	</tr>
	<tr>
		<td>tv</td>
		<td>Television type devices (low resolution, limited scroll ability)</td>
	</tr>
</table>
<h2>Values</h2>
<table class="reference notranslate"> 
  ...
  <tr>
    <td>width</td>
    <td>Specifies the width of the targeted display area.<br>
	&quot;min-&quot; and &quot;max-&quot; prefixes can be used.<br>
	Example: media=&quot;screen and (min-width:500px)&quot;</td>
  </tr>
	<tr>
    <td>height</td>
    <td>Specifies the height of the&nbsp;targeted display area.<br>
	&quot;min-&quot; and 
	&quot;max-&quot; prefixes can be used.<br>
	Example: media=&quot;screen and (max-height:700px)&quot;</td>
    </tr>
	<tr>
    <td>device-width</td>
    <td>Specifies the width of the target display/paper.<br>
	&quot;min-&quot; and &quot;max-&quot; prefixes can be used.<br>
	Example: media=&quot;screen and (device-width:500px)&quot;</td>
    </tr>
	<tr>
    <td>device-height</td>
    <td>Specifies the height of the target display/paper.<br>
	&quot;min-&quot; and &quot;max-&quot; prefixes can be used.<br>
	Example: media=&quot;screen and (device-height:500px)&quot;</td>
    </tr>
	<tr>
    <td>orientation</td>
    <td>Specifies the orientation of the target display/paper.<br>
	Possible values: &quot;portrait&quot; or &quot;landscape&quot;<br>
	Example: media=&quot;all and (orientation: landscape)&quot;</td>
    </tr>
	<tr>
    <td>aspect-ratio</td>
    <td>Specifies the width/height ratio of the targeted display area.<br>
	&quot;min-&quot; and &quot;max-&quot; prefixes can be used.<br>
	Example: media=&quot;screen and (aspect-ratio:16/9)&quot;</td>
    </tr>
	<tr>
    <td>device-aspect-ratio</td>
    <td>Specifies the device-width/device-height ratio of the target 
	display/paper.<br>
	&quot;min-&quot; and &quot;max-&quot; prefixes can be used.<br>
	Example: media=&quot;screen and (aspect-ratio:16/9)&quot;</td>
    </tr>
	<tr>
    <td>color</td>
    <td>Specifies the bits per color of target display.<br>
	&quot;min-&quot; and &quot;max-&quot; prefixes can be used.<br>
	Example: media=&quot;screen and (color:3)&quot;</td>
    </tr>
	<tr>
    <td>color-index</td>
    <td>Specifies the number of colors the target display can handle.<br>
	&quot;min-&quot; and &quot;max-&quot; prefixes can be used.<br>
	Example: media=&quot;screen and (min-color-index:256)&quot;</td>
    </tr>
	<tr>
    <td>monochrome</td>
    <td>Specifies the bits per pixel in a monochrome frame buffer.<br>
	&quot;min-&quot; and &quot;max-&quot; prefixes can be used.<br>
	Example: media=&quot;screen and (monochrome:2)&quot;</td>
    </tr>
	<tr>
    <td>resolution</td>
    <td>Specifies the pixel density (dpi or dpcm) of the target display/paper.<br>
	&quot;min-&quot; and &quot;max-&quot; prefixes can be used.<br>
	Example: media=&quot;print and (resolution:300dpi)&quot;</td>
    </tr>
	<tr>
    <td>scan</td>
    <td>Specifies scanning method of a tv display.<br>
	Possible values are &quot;progressive&quot; and &quot;interlace&quot;.<br>
	Example: media=&quot;tv and (scan:interlace)&quot;</td>
    </tr>
	<tr>
    <td>grid</td>
    <td>Specifies if the output device is grid or bitmap.<br>
	Possible values are &quot;1&quot; for grid, and &quot;0&quot; otherwise.<br>
	Example: media=&quot;handheld and (grid:1)&quot;</td>
    </tr>
	</table>
<br>
<hr>
<a href="tag_source.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML source Tag Reference" /> HTML &lt;source&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_source_media.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_source_media.asp#top" target="_top">TOP</a> |
		<a href="att_source_media.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
