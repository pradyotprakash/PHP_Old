...
<style>a.menu_att_input_autocomplete{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">autocomplete</span> Attribute</h1>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_input_autocomplete" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The autocomplete attribute is supported in all major browsers.</p>
<p><strong>Tip:</strong> In some browsers you may need to activate an autocomplete function for this to work 
(Look under &quot;Preferences&quot; in the browser's menu).</p>
<hr>

<h2>Definition and Usage</h2>
<p>The autocomplete attribute specifies whether or not an input field should have autocomplete enabled.</p>
<p>Autocomplete allows the browser to predict the value. When a 
user starts to type in a field, the browser should display options to fill in 
the field, based on earlier typed values.</p>
<p><strong>Note:</strong> The autocomplete attribute works with the 
...
<table class="reference notranslate">
	...
	<tr>
		<td>on</td>
		<td>Default. Specifies that autocomplete is on (enabled)</td>
	</tr>
	<tr>
		<td>off</td>
		<td>Specifies that autocomplete is off (disabled)</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_autocomplete.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_autocomplete.asp#top" target="_top">TOP</a> |
		<a href="att_input_autocomplete.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
