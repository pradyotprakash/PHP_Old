...
<title>HTML canvas strokeRect() Method</title>
<style>a.menu_canvas_strokerect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">strokeRect()</span> Method</h1>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_strokerect" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>The strokeRect() method draws a rectangle (no fill). The default color of the 
stroke is black.</p>
<p><b>Tip:</b> Use the <a href="canvas_strokestyle.asp">strokeStyle</a> property 
to set a color, gradient, or pattern to style the stroke.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.strokeRect(<i>x,y,width,height</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_strokerectx">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y-coordinate of the upper-left corner of the rectangle</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_strokerecty">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>width</i></td>
		<td>The width of the rectangle, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_strokerectw">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>height</i></td>
		<td>The height of the rectangle, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_strokerecth">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_strokerect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_strokerect.asp#top" target="_top">TOP</a> |
		<a href="canvas_strokerect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
