...
<style>a.menu_att_iframe_srcdoc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;iframe&gt; <span class="color_h1">srcdoc</span> Attribute</h1>
...
<p>An &lt;iframe&gt; with a srcdoc attribute:</p>
<div class="example_code notranslate">
    &lt;iframe srcdoc=&quot;&lt;p&gt;Hello world!&lt;/p&gt;&quot; src=&quot;demo_iframe_srcdoc.htm&quot;&gt;&lt;/iframe&gt;<br>
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_iframe_srcdoc" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> The srcdoc attribute of the &lt;iframe&gt; tag is supported only in 
Firefox, Chrome and Safari 6.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The srcdoc attribute specifies the HTML content of the page to show in the inline frame.</p>
<p><b>Tip:</b> This attribute is expected to be used together with the sandbox and seamless attributes.</p>
<p>If a browser supports the srcdoc attribute, it will override the content specified in the src attribute (if present).</p>
<p>If a browser does NOT support the srcdoc attribute, it will show the file specified in the src attribute instead (if present).</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The srcdoc attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
		&lt;iframe srcdoc=&quot;<i>HTML_code</i>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td>The HTML content to show in the iframe. Must be valid HTML syntax</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_iframe_srcdoc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_iframe_srcdoc.asp#top" target="_top">TOP</a> |
		<a href="att_iframe_srcdoc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
