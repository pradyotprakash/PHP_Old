...
<title>HTML input accept Attribute</title>
<style>a.menu_att_input_accept{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">accept</span> Attribute</h1>
...
<p>Specify that the server accepts only image files in the file upload:</p>
...
<br>
<a class="tryitbtn" target="_blank" href="tryit.asp?filename=tryhtml_input_accept">Try it yourself &raquo;</a>
...
<p>The accept attribute is supported in Internet Explorer 10, Firefox, Opera, Chrome, and Safari 6.</p>
...
<p><b>Note:</b> The accept attribute can only be used with &lt;input type=&quot;file&quot;&gt;.</p>
...
<div class="code notranslate"><div>
    ...
    &lt;input accept=&quot;audio/*|video/*|image/*|<i>MIME_type</i>&quot;&gt;

</div></div>

<p><b>Tip:</b> To specify more than one value, separate the values with a comma 
(e.g. &lt;input accept=&quot;audio/*,video/*,image/*&quot; /&gt;.</p>
...
<br>
<hr>
<a href="tag_input.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML input Tag Reference" /> HTML &lt;input&gt; tag</a>				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_accept.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_accept.asp#top" target="_top">TOP</a> |
		<a href="att_input_accept.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
