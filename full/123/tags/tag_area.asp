...
<style>a.menu_tag_area{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;area&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_article.asp">&lt;article&gt; Tag &raquo;</a></div>
</div><br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_areamap" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;area&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;area&gt; tag defines an area inside an image-map (an image-map is an image with clickable areas).</p>
<p>The &lt;area&gt; element is always nested inside a &lt;map&gt; tag.</p>
<p><b>Note:</b> The usemap attribute in the <a href="tag_img.asp">&lt;img&gt;</a> tag is associated with 
the <a href="tag_map.asp">&lt;map&gt;</a> element's name attribute, and creates a relationship between the image and the map.</p>
<hr>
...
<p>In HTML the &lt;area&gt; tag has no end tag.</p>
<p>In XHTML the &lt;area&gt; tag must be properly closed.</p>
<hr>
...
<table class="reference notranslate" id="table1">
  ...
  <tr>
    <td><a href="att_area_download.asp">download</a><span class="new">New</span></td>
    <td><i>filename</i></td>
  ...
  <tr>
	...
	search<br>
	tag</td>
    <td>Specifies the relationship between the current document and 
	the target URL</td>
      </tr>
  <tr>
  ...
  <tr>
	...
	<tr>
    <td><a href="att_area_type.asp">type</a><span class="new">New</span></td>
    <td><i>MIME_type</i></td>
    <td>Specifies the MIME  
	type of the target URL</td>
    </tr>
</table>

<h2>Global Attributes</h2>
<p>The &lt;area&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;area&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML DOM reference: 
<a href="../jsref/dom_obj_area.asp">Area object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_article.asp">&lt;article&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_area.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_area.asp#top" target="_top">TOP</a> |
		<a href="tag_area.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
