...
<style>a.menu_att_table_border{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;table&gt; <span class="color_h1">border</span> Attribute</h1>
...
<p>The following HTML table will be displayed with borders around the table 
cells:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_table_border" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The border attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;table&gt; border attribute is not supported in HTML5. Use CSS instead.</span></p>
<p>The border attribute specifies if a border should be displayed around the 
table cells or not.</p>
<p><b>Tip:</b> It may be better to NOT specify a border, and use CSS 
to apply the <a href="../css/css_table.asp">border</a> 
instead.&nbsp;</p>
<p><a href="tryit.asp?filename=tryhtml_table_border_css" target="_blank">CSS 
Example: Add borders to a table</a></p>
<hr>
...
<table class="reference notranslate" id="table1">
  <tr>
    ...
    <tr>
		<td><em style="font-style: normal">&quot;&quot;</em></td>
		<td>No borders around the table cells (the table could be used for 
		layout purposes)</td>
	</tr>
    <tr>
		<td><em style="font-style: normal">&quot;1&quot;</em></td>
		<td>Add borders around the table cells (the table is NOT being used for 
		layout purposes)</td>
	</tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_table_border.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_table_border.asp#top" target="_top">TOP</a> |
		<a href="att_table_border.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
