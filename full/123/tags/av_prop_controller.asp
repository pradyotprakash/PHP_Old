...
<title>HTML Audio/Video DOM controller Property</title>
<style>a.menu_av_prop_controller{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">controller</span> Property</h1>
...
<p>Check if the video has a media controller:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>alert(&quot;Controller: &quot; + 
	myVid.controller);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_controller" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The controller property returns the current media controller of the 
audio/video.</p>
<p>By default the audio/video element does not have a media controller. If a 
media controller is specified, the controller property will return it as a 
MediaController object.</p>
<hr>
...
<p>The controller property is not supported in any major browser.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate">
	<div>
		<em>audio|video</em>.controller</div></div>
<h2>Return Value</h2>
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>MediaController Object</td>
    <td>Represents the media controller of the audio/video.<p>
	MediaController Object properties/methods:</p>
	<ul>
		<li>buffered - get the buffered ranges of the audio/video</li>
		<li>seekable - get the seekable ranges of the audio/video</li>
		<li>duration - get the duration of the audio/video</li>
		<li>currentTime - get or set the current playback position of the 
		audio/video</li>
		<li>paused - check if the audio/video is paused</li>
		<li>play() - play the audio/video</li>
		<li>pause() - pause the audio/video</li>
		<li>played - check if the audio/video has been played</li>
		<li>defaultPlaybackRate - get or set the default playback rate of the 
		audio/video</li>
		<li>playbackRate - get or set the current playback rate of the 
		audio/video</li>
		<li>volume - get or set the volume of the audio/video</li>
		<li>muted - get or set if the audio/video is muted</li>
	</ul>
		</td>
    </tr>
    </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_controller.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_controller.asp#top" target="_top">TOP</a> |
		<a href="av_prop_controller.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
