...
<style>a.menu_tag_table{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;table&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_tbody.asp">&lt;tbody&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_table_test" class="tryitbtn">Try it Yourself &raquo;</a>
...
<p>The &lt;table&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;table&gt; tag defines an HTML table.</p>
<p>An HTML table consists of the &lt;table&gt; element and one or more <a href="tag_tr.asp">&lt;tr&gt;</a>, 
<a href="tag_th.asp">&lt;th&gt;</a>, and <a href="tag_td.asp">&lt;td&gt;</a> elements.</p>
<p>The &lt;tr&gt; element defines a table row, the &lt;th&gt; element defines a table header, and the 
&lt;td&gt; element defines a table cell.</p>
<p>A more complex HTML table may also include &lt;caption&gt;, &lt;col&gt;, &lt;colgroup&gt;, &lt;thead&gt;, 
&lt;tfoot&gt;, and &lt;tbody&gt; elements. </p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>HTML5 does not support any of the HTML 4 attributes: align, bgcolor, border, 
cellpadding, cellspacing, frame, rules, summary, and with.</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
Originally, there was some disagreement in W3C, about removing the border attribute from HTML5.<br>
Finally, it has been removed from the specification.<br><br>
Use CSS instead!<br>
</td>
</tr></table>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_table_align.asp">align</a></td>
    <td>left<br>
    center<br>
    right</td>
  ...
  <tr>
    <td><a href="att_table_bgcolor.asp">bgcolor</a></td>
    <td><i>rgb(x,x,x)<br>
    #xxxxxx<br>
    colorname</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
  ...
  <tr>
    <td><a href="att_table_border.asp">border</a></td>
    <td>1<br>
	&quot;&quot;</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies whether the table cells should have borders or not</td>
  </tr>
  <tr>
    <td><a href="att_table_cellpadding.asp">cellpadding</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the space between the cell wall and the cell 
	content</td>
  </tr>
  <tr>
    <td><a href="att_table_cellspacing.asp">cellspacing</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the space between cells</td>
  </tr>
    <tr>
    <td><a href="att_table_frame.asp">frame</a></td>
    <td>void<br>
      above<br>
      below<br>
      hsides<br>
      ...
      box<br>
      border</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies which parts of the outside borders that should be visible</td>
      </tr>
      <tr>
    <td><a href="att_table_rules.asp">rules</a></td>
    <td>none<br>
      groups<br>
      rows<br>
      cols<br>
      all</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies which parts of the inside borders that should be 
	visible</td>
      </tr>
      <tr>
    <td>sortable</td>
    <td>sortable</td>
    <td>Specifies that the table should be sortable</td>
      </tr>
      <tr>
    <td><a href="att_table_summary.asp">summary</a></td>
    <td><i>text</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies a summary of the content of a table</td>
      </tr>
  <tr>
    <td><a href="att_table_width.asp">width</a></td>
    <td><i>pixels<br>
      %</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the width of a table</td>
  </tr>
  </table>
<br>
<hr>
...
<p>The &lt;table&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;table&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryhtml_table_span">Cells that span more than one row/column</a><br>
...
<p>HTML DOM reference: <a href="../jsref/dom_obj_table.asp">Table object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_tbody.asp">&lt;tbody&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_table.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_table.asp#top" target="_top">TOP</a> |
		<a href="tag_table.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
