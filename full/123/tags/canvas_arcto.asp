...
<title>HTML canvas arcTo() Method</title>
<style>a.menu_canvas_arcto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">arcTo()</span> Method</h1>
...
<p>Create an arc between two tangents on the canvas:</p>
...
<div class="example_code notranslate">
	...
	// Draw it</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_arcto" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Chrome, and Safari support the arcTo() 
method.</p>
<p><b>Note:</b> Opera does not support the 
arcTo() method.</p>
...
<p><b>Tip:</b> Use the <a href="canvas_stroke.asp">stroke()</a> method to actually draw the arc on the canvas.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.arcTo(<i>x1,y1,x2,y2,r</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>x1</i></td>
		<td>The x-coordinate of the beginning of the arc</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arctox1">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y1</i></td>
		<td>The y-coordinate of the beginning of the arc</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arctoy1">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>x2</i></td>
		<td>The x-coordinate of the end of the arc</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arctox2">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y2</i></td>
		<td>The y-coordinate of the end of the arc</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arctoy2">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>r</i></td>
		<td>The radius of the arc</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_arctor&amp;preval=100,20,100,70,50">Play it &raquo;</a></td>		
	</tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_arcto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_arcto.asp#top" target="_top">TOP</a> |
		<a href="canvas_arcto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
