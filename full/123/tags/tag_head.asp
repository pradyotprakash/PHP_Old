...
<style>a.menu_tag_head{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;head&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_header.asp">&lt;header&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>An HTML document, with a required &lt;title&gt; tag in the head section:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_basic" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;head&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;head&gt; element is a container for all the head elements.</p>
<p>The &lt;head&gt; element must include a title for the document, and can include scripts, styles, meta information, and more.</p>
<p>The following elements can go inside the &lt;head&gt; element:</p>
<ul>
<li><a href="tag_title.asp">&lt;title&gt;</a> (this element is required in the head section)</li>
<li><a href="tag_style.asp">&lt;style&gt;</a></li>
<li><a href="tag_base.asp">&lt;base&gt;</a></li>
<li><a href="tag_link.asp">&lt;link&gt;</a></li>
<li><a href="tag_meta.asp">&lt;meta&gt;</a></li>
<li><a href="tag_script.asp">&lt;script&gt;</a></li>
<li><a href="tag_noscript.asp">&lt;noscript&gt;</a></li>
</ul>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The profile attribute is not supported in HTML5.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>profile</td>
    <td><i>URL</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies a URL to a document that contains a set of rules. 
	The rules can be read by browsers to clearly understand the information in 
	the &lt;meta&gt; tag's content attribute</td>
  </tr>
</table>
<br>
<hr>
...
<p>The &lt;head&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhtml_base_test">Use of the &lt;base&gt; tag in &lt;head&gt;</a><br>
How to use the &lt;base&gt; tag to specify a default URL and a default target for all links on a page.</p>

<p><a target="_blank" href="tryit.asp?filename=tryhtml_style">Use of the &lt;style&gt; tag in &lt;head&gt;</a><br>
How to add style information to the &lt;head&gt; section.</p>

<p><a target="_blank" href="tryit.asp?filename=tryhtml_link_tag">Use of the &lt;link&gt; tag in &lt;head&gt;</a><br>
How to use the &lt;link&gt; tag to link to an external style sheet.</p>

<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_head.asp">HTML Head</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_header.asp">&lt;header&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_head.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_head.asp#top" target="_top">TOP</a> |
		<a href="tag_head.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
