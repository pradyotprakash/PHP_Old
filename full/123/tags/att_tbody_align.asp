...
<title>HTML tbody align Attribute</title>
<style>a.menu_att_tbody_align{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;tbody&gt; <span class="color_h1">align</span> Attribute</h1>
...
<p>Right-align the content inside the &lt;tbody&gt; element:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_tbody_align" class="tryitbtn">Try it yourself &raquo;</a>
...
<p><b>Note:</b> IE does not handle the &quot;justify&quot; value properly in tables, IE will center the content instead.</p>
<p><b>Note:</b> None of the major browsers supports the &quot;char&quot; value.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;tbody&gt; align attribute is not supported in HTML5. Use CSS instead.</span></p>
<p>The align attribute specifies the horizontal alignment of the content inside the 
&lt;tbody&gt; element.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>left</td>
    <td>Left-aligns content (default for table data)</td>
  </tr>
  <tr>
    <td>right</td>
  ...
  <tr>
    <td>char</td>
    <td>Aligns the content to a specific character</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_tbody_align.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_tbody_align.asp#top" target="_top">TOP</a> |
		<a href="att_tbody_align.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
