...
<title>HTML area alt Attribute</title>
<style>a.menu_att_area_alt{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;area&gt; <span class="color_h1">alt</span> Attribute</h1>
<p><a href="tag_area.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML area Tag" /> 
HTML &lt;area&gt; tag</a></p>
<div class="example">
...
<p>The alt attribute specifies an alternate text for an area, if the image 
...
<p>The alt attribute is required if the href attribute is present.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>In HTML 4.01 the alt attribute is required.</p>
<p>In HTML5, the alt attribute is only required if the href attribute is 
present. If the href attribute is not present, the alt attribute should not be 
used.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>text</i></td>
    <td>Specifies the alternate text for the area, if the image cannot be 
	displayed</td>
  </tr>
	</table>
<br>
<hr>
<a href="tag_area.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML area Tag" /> HTML &lt;area&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_area_alt.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_area_alt.asp#top" target="_top">TOP</a> |
		<a href="att_area_alt.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
