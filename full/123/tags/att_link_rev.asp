...
<title>HTML link rev Attribute</title>
<style>a.menu_att_link_rev{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;link&gt; <span class="color_h1">rev</span> Attribute</h1>
...
<p>In the following example, the rev attribute indicates that the current document is the parent of the &quot;wildcats.htm&quot; page:</p>
<div class="example_code notranslate">
  
    &lt;head&gt;<br>
      &lt;link rev=&quot;parent&quot; href=&quot;wildcats.htm&quot;&gt;<br>
    &lt;/head&gt;
...
<p><b>Note:</b> The rev attribute is not supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;link&gt; rev attribute is not supported in HTML5.</span></p>
<p>The rev attribute specifies the relationship between the linked document and the current document.</p>
<p>The rev attribute is the reverse of the <a href="att_a_rel.asp">rel</a> attribute.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>alternate</td>
    <td>An alternate version of the document (i.e. print page, 
	translated or mirror)</td>
  </tr>
	<tr>
    <td>stylesheet</td>
    <td>An external style sheet for the document</td>
  </tr>
	<tr>
    <td>start</td>
    <td>The first document in a selection</td>
  </tr>
	<tr>
    <td>next</td>
	...
	<tr>
    <td>contents</td>
    <td>A table of contents for the document</td>
  </tr>
	<tr>
    <td>index</td>
    <td>An index for the document</td>
  </tr>
	<tr>
    <td>glossary</td>
    <td>A glossary (explanation) of words used in the document</td>
  </tr>
	<tr>
    <td>copyright</td>
    <td>A document containing copyright information</td>
  </tr>
	<tr>
    <td>chapter</td>
    <td>A chapter of the document</td>
  </tr>
  <tr>
    <td>section</td>
    <td>A section of the document</td>
  </tr>
  <tr>
    <td>subsection</td>
    <td>A subsection of the document</td>
  </tr>
	<tr>
    <td>appendix</td>
    <td>An appendix for the document</td>
  </tr>
	<tr>
    <td>help</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_link_rev.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_link_rev.asp#top" target="_top">TOP</a> |
		<a href="att_link_rev.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
