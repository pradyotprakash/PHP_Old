...
<style>a.menu_tag_html{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;html&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_i.asp">&lt;i&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>The &lt;html&gt; tag is supported in all major browsers.</p>
<hr>


<h2>Definition and Usage</h2>
<p>The &lt;html&gt; tag tells the browser that this is an HTML document.</p>
<p>The &lt;html&gt; tag represents the root of an HTML document.</p>
<p>The &lt;html&gt; tag is the container for all other HTML elements (except for the
<a href="tag_doctype.asp">&lt;!DOCTYPE&gt;</a> tag).</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>HTML5 has added a new attribute: manifest.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>The xmlns attribute is required in XHTML, but is invalid in HTML.</p>
<p>However, the HTML validator at <a target="_blank" href="http://w3.org">
http://w3.org</a> does not complain when the xmlns attribute is missing in an XHTML document. This is because 
the namespace &quot;xmlns=http://www.w3.org/1999/xhtml&quot; is default, and will be added to the &lt;html&gt; tag even if you do not include it.</p>
<hr>
...
<table class="reference notranslate" id="table1">
  ...
  <tr>
    <td><a href="att_html_manifest.asp">manifest</a><span class="new">New</span></td>
    <td><i>URL</i></td>
    <td>Specifies the address of the document's cache manifest (for offline browsing)</td>
    </tr>
  <tr>
    <td><a href="att_html_xmlns.asp">xmlns</a></td>
    <td>http://www.w3.org/1999/xhtml</td>
    <td>Specifies the XML namespace attribute (If you need your content to conform to XHTML)</td>
    </tr>
    </table>
<br>
<hr>
<h2>Global Attributes</h2>
<p>The &lt;html&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_i.asp">&lt;i&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_html.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_html.asp#top" target="_top">TOP</a> |
		<a href="tag_html.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
