...
<title>HTML video preload Attribute</title>
<style>a.menu_att_video_preload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;video&gt; <span class="color_h1">preload</span> Attribute</h1>
<p><a href="tag_video.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML video Tag Reference" /> HTML &lt;video&gt; tag</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Author thinks that the video should NOT be loaded when the page loads:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_video_preload" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The preload attribute is supported in all major browsers, except Internet Explorer.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The preload attribute specifies if and how the author thinks that the video should be loaded when the page loads.</p>
<p>The preload attribute allows the author to provide a hint to the browser 
about what he/she thinks will lead to the best user experience. This attribute may be ignored in some instances.</p>
<p><b>Note:</b> The preload attribute is ignored if autoplay is present.</p>
<hr>
...
<div class="code notranslate"><div>
		&lt;video preload=&quot;<em style="font-style: normal">auto|metadata|none</em>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		<td>auto</td>
		<td>The author thinks that the browser should load the entire video when the page loads</td>
	</tr>
	<tr>
		<td>metadata</td>
		<td>The author thinks that the browser should load only metadata when the page loads</td>
	</tr>
	<tr>
		<td>none</td>
		<td>The author thinks that the browser should NOT load the video when the page loads</td>
	</tr>
</table>
<br>
<hr>
<a href="tag_video.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML video Tag Reference" /> HTML &lt;video&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_video_preload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_video_preload.asp#top" target="_top">TOP</a> |
		<a href="att_video_preload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
