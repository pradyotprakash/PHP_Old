...
<title>HTML output name Attribute</title>
<style>a.menu_att_output_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;output&gt; <span class="color_h1">name</span> Attribute</h1>
...
<p>The name attribute is supported in Firefox, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> The &lt;output&gt; tag is not supported in Internet Explorer.</p>

<hr>

<h2>Definition and Usage</h2>
<p>The name attribute specifies the name of an &lt;output&gt; element.</p>
<p>The name attribute is used to reference form data after it has been submitted, or to reference the element in a JavaScript.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>name</em></td>
		<td>Specifies the name of the &lt;output&gt; element</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_output_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_output_name.asp#top" target="_top">TOP</a> |
		<a href="att_output_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
