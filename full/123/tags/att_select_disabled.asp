...
<style>a.menu_att_select_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;select&gt; <span class="color_h1">disabled</span> Attribute</h1>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_select_disabled" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>When present, it specifies that the drop-down list should be disabled.</p>
<p>A disabled drop-down list is unusable and un-clickable.</p>
<p>The disabled attribute can be set to keep a user from using the drop-down 
list until some other condition has been met (like selecting a checkbox, etc.). 
Then, a JavaScript can remove the disabled value, and make the 
drop-down list usable.</p>
<hr>
...
be defined as &lt;select disabled=&quot;disabled&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_select_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_select_disabled.asp#top" target="_top">TOP</a> |
		<a href="att_select_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
