...
<title>HTML output for Attribute</title>
<style>a.menu_att_output_for{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;output&gt; <span class="color_h1">for</span> Attribute</h1>
...
<br>
<a class="tryitbtn" target="_blank" href="tryit.asp?filename=tryhtml5_output">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The for attribute is supported in Firefox, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> The &lt;output&gt; tag is not supported in Internet Explorer.</p>

<hr>

<h2>Definition and Usage</h2>
<p>The for attribute specifies the relationship between the result of the 
calculation, and the elements used in the calculation.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td>Specifies a space separated list of ids of one or more elements that 
		specifies the relationship between the result of the calculation, and 
		the elements used in the calculation</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_output_for.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_output_for.asp#top" target="_top">TOP</a> |
		<a href="att_output_for.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
