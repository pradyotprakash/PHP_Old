...
<title>HTML script type Attribute</title>
<style>a.menu_att_script_type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;script&gt; <span class="color_h1">type</span> Attribute</h1>
...
<p>A script with the type attribute specified:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_script_type" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The type attribute specifies the MIME type of a script.</p>
<p>The type attribute identifies the content between the &lt;script&gt; and &lt;/script&gt; 
tags.</p>
<p>The MIME type consists of two parts: one media type and one subtype. For 
JavaScript, the MIME type is &quot;text/javascript&quot;.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>In HTML5, the type attribute is no longer required. The default value is 
&quot;text/javascript&quot;.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>MIME_type</i></td>
    <td>Specifies the MIME type of the script.<br>
	<br>
	Some common values:<ul>
		<li>text/javascript (this is default)</li>
	...
	<p>Look at
	<a target="_blank" href="http://www.iana.org/assignments/media-types/">IANA MIME types</a> 
	for a complete list of standard MIME types.</p>
	</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_script_type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_script_type.asp#top" target="_top">TOP</a> |
		<a href="att_script_type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
