...
<title>HTML object data Attribute</title>
<style>a.menu_att_object_data{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;object&gt; <span class="color_h1">data</span> Attribute</h1>
...
<br>
<a class="tryitbtn" target="_blank" href="tryit.asp?filename=tryhtml_object">Try it yourself &raquo;</a>
...
<p>The data attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The data attribute specifies the URL of the resource to be used by the object.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
    <td><i>URL</i></td>
    <td>Specifies the URL of the resource to be used by the object.<p>Possible values:</p>
<ul>
	<li>An absolute URL - points to data on another web site (like href=&quot;http://www.example.com/helloworld.swg&quot;)</li>
	<li>A relative URL - points to data within a web site (like href=&quot;helloworld.swg&quot;)</li>
</ul>
	</td>
    </tr>
	</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_object_data.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_object_data.asp#top" target="_top">TOP</a> |
		<a href="att_object_data.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
