...
<style>a.menu_tag_video{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;video&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_wbr.asp">&lt;wbr&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_video" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;video&gt; tag is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;video&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;video&gt; tag specifies video, such as a movie clip or other video streams.</p>
...
<hr><h2>MIME Types for Video Formats</h2>
...
<p>The &lt;video&gt; tag is new in HTML5.</p>
<hr>

<h2>Tips and Notes</h2>
<p><b>Tip:</b> Any text between the &lt;video&gt; and &lt;/video&gt; tags will be 
displayed in browsers that do not support the &lt;video&gt; element.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_video_autoplay.asp">autoplay</a><span class="new">New</span></td>
    <td>autoplay</td>
    <td>Specifies that the video will start playing as soon as it is ready</td>
  </tr>
  <tr>
    <td><a href="att_video_controls.asp">controls</a><span class="new">New</span></td>
    <td>controls</td>
    <td>Specifies that video controls should be displayed (such as a play/pause button etc).</td>
  </tr>
  <tr>
    <td><a href="att_video_height.asp">height</a><span class="new">New</span></td>
    <td><i>pixels</i></td>
    <td>Sets the height of the video player</td>
      </tr>
  <tr>
    <td><a href="att_video_loop.asp">loop</a><span class="new">New</span></td>
    <td>loop</td>
    <td>Specifies that the video will start over again, every time it is finished</td>
  </tr>
    <tr>
    <td><a href="att_video_muted.asp">muted</a><span class="new">New</span></td>
    <td>muted</td>
    <td>Specifies that the audio output of the video should be muted</td>
  </tr>
    <tr>
    <td><a href="att_video_poster.asp">poster</a><span class="new">New</span></td>
    <td><em>URL</em></td>
    <td>Specifies an image to be shown while the video is downloading, or until the user hits the play button</td>
    </tr>
  <tr>
    <td><a href="att_video_preload.asp">preload</a><span class="new">New</span></td>
    <td>auto<br>
	metadata<br>
	none</td>
  ...
  <tr>
    <td><a href="att_video_src.asp">src</a><span class="new">New</span></td>
    <td><i>URL</i></td>
    <td>Specifies the URL of the video file</td>
  </tr>
  <tr>
    <td><a href="att_video_width.asp">width</a><span class="new">New</span></td>
    <td><i>pixels</i></td>
    <td>Sets the width of the video player</td>
  </tr>
</table>
<h2>Global Attributes</h2>
<p>The &lt;video&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;video&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_wbr.asp">&lt;wbr&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_video.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_video.asp#top" target="_top">TOP</a> |
		<a href="tag_video.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
