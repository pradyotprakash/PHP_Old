...
<title>HTML command disabled Attribute</title>
<style>a.menu_att_command_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;command&gt; <span class="color_h1">disabled</span> Attribute</h1>
...
<p>A disabled &lt;command&gt; element:</p>
<div class="example_code notranslate">
    &lt;menu&gt;<br>
	&lt;command type=&quot;radio&quot; label=&quot;Center&quot; disabled<br>
	onclick=&quot;setAlign('center')&quot;&gt;Center&lt;/command&gt;<br>
	&lt;/menu&gt;
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_command_disabled" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The disabled attribute is currently not supported in any of the major browsers.</p>
<p><b>Note:</b> Internet Explorer 9 (not earlier or later versions), supports the disabled attribute.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The disabled attribute is a boolean attribute.</p>
<p>When present, it specifies that the command element should be disabled.</p>
<hr>
...
<p>In XHTML, attribute minimization is forbidden, and the disabled attribute must 
be defined as &lt;command disabled=&quot;disabled&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_command_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_command_disabled.asp#top" target="_top">TOP</a> |
		<a href="att_command_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
