...
<title>HTML dialog open Attribute</title>
<style>a.menu_att_dialog_open{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;dialog&gt; <span class="color_h1">open</span> Attribute</h1>
<p><a href="tag_dialog.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML dialog Tag Reference" /> HTML &lt;dialog&gt; tag</a></p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_dialog" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The open attribute is currently supported only in Chrome, and Safari 6.</p>

<hr>

<h2>Definition and Usage</h2>
<p>The open attribute is a boolean attribute.</p>
<p>When present, it specifies that the dialog element is active and that the user can 
	interact with it.</p>
<hr>
...
<p>In XHTML, attribute minimization is forbidden, and the open attribute must 
be defined as &lt;dialog open=&quot;open&quot;&gt;. </p>
<hr>
...
<br>
<hr>
<a href="tag_dialog.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML dialog Tag Reference" /> HTML &lt;dialog&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_dialog_open.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_dialog_open.asp#top" target="_top">TOP</a> |
		<a href="att_dialog_open.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
