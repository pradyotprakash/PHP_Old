...
<title>HTML Audio/Video DOM playbackRate Property</title>
<style>a.menu_av_prop_playbackrate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">playbackRate</span> Property</h1>
...
<p>Set video to play in slow motion:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.playbackRate=0.5;</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_playbackrate" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The playbackRate property sets or returns the current playback speed 
...
<p>The playbackRate property is supported in all major browsers.</p>
<p><strong>Note:</strong> The playbackRate property is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>

<h2>Syntax</h2>
<p>Set the playbackRate property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.playbackRate=<em>playbackspeed</em></div></div>
<p>Return the playbackRate property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.playbackRate</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Indicates the current playback speed of the audio/video.<br>Example 
	values:<ul><li>1.0 is normal speed</li>
		...
		<li>-0.5 is backwards, half speed</li>
	</ul>
	  </td>
  </tr>
  </table>
...
<tr>
	...
	<td>Number, the current playback speed</td>
</tr>
<tr>
	<th>Default Value:</th>
	<td>1.0</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_playbackrate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_playbackrate.asp#top" target="_top">TOP</a> |
		<a href="av_prop_playbackrate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
