...
<style>a.menu_att_optgroup_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;optgroup&gt; <span class="color_h1">disabled</span> Attribute</h1>
<p><a href="tag_optgroup.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML optgroup Tag Reference" /> HTML &lt;optgroup&gt; tag</a></p>
<div class="example">


<h2 class="example">Example</h2>
<p>A disabled option-group:</p>
<div class="example_code notranslate">
  
    &lt;select&gt;<br>
      &nbsp;
      &lt;optgroup label=&quot;German Cars&quot; disabled&gt;<br>
      &nbsp;&nbsp;&nbsp;
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_optgroup_disabled" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The disabled attribute is supported by all major browsers.</p>
<p><strong>Note:</strong> The disabled attribute of the &lt;optgroup&gt; tag is not supported in Internet Explorer 7 and earlier versions.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The disabled attribute is a boolean attribute.</p>
<p>When present, it specifies that an option-group should be disabled.</p>
<p>A disabled option-group is unusable and un-clickable.</p>
<p>The disabled attribute can be set to keep a user from selecting the 
option-group until some other condition has been met (like selecting a checkbox, 
etc.). Then, a JavaScript is required to remove the disabled value, and make the 
option-group selectable.</p>
<hr>
...
be defined as &lt;optgroup disabled=&quot;disabled&quot;&gt;. </p>
<hr>
...
<br>
<hr>
<a href="tag_optgroup.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML optgroup Tag Reference" /> HTML &lt;optgroup&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_optgroup_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_optgroup_disabled.asp#top" target="_top">TOP</a> |
		<a href="att_optgroup_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
