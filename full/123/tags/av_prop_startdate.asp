...
<title>HTML Audio/Video DOM startDate Property</title>
<style>a.menu_av_prop_startdate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">startDate</span> Property</h1>
...
<p>Get the current timeline offset of the video:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>
	alert(myVid.startDate);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_startdate" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>

<h2>Definition and Usage</h2>
<p>The startDate property returns a Date object representing the current 
timeline offset of the audio/video.</p>
<p>The startDate property is used to enable accurate synchronization of 
audio/video streamed live over the internet.</p>
<hr>
...
<p>The startDate property is not supported in any major browser</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>audio|video</em>.startDate</div></div>
<h2>Technical Details</h2>
<table class="reference notranslate">
<tr>
	<th style="width:20%">Return Value:</th>
	<td>A Date Object, representing current timeline offset</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_startdate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_startdate.asp#top" target="_top">TOP</a> |
		<a href="av_prop_startdate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
