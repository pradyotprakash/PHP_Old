...
<title>HTML menu label Attribute</title>
<style>a.menu_att_menu_label{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;menu&gt; <span class="color_h1">label</span> Attribute</h1>
...
<p>The label attribute is not currently supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The label attribute specifies a visible label for the menu.</p>
<p>The label attribute is often used to label nested menus within a menu.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The &lt;menu&gt; element is redefined in HTML5, and the label attribute is new.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_menu_label.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_menu_label.asp#top" target="_top">TOP</a> |
		<a href="att_menu_label.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
