...
<title>HTML Audio/Video DOM buffered Property</title>
<style>a.menu_av_prop_buffered{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">buffered</span> Property</h1>
...
<p>Get the first buffered range (part) of the video in seconds:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>alert(&quot;Start: &quot; + 
	myVid.buffered.start(0)<br>+ &quot; End: &quot; + myVid.buffered.end(0));</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_buffered" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The buffered property returns a TimeRanges object.</p>
<p>The TimeRanges object represents the user's buffered ranges of the audio/video.</p>
<p>A buffered range is a time-range of buffered audio/video. The user gets several 
buffered ranges if he/she skips in the audio/video.</p>
<hr>
...
<p>The buffered property is supported in all major browsers.</p>
...
<div class="code notranslate">
	<div>
		<em>audio|video</em>.buffered</div></div>
<h2>Return Value</h2>
<table class="reference notranslate">
  <tr>
    ...
    <td>Represents the buffered parts of the audio/video.<p>TimeRanges Object 
	Properties:</p>
	<ul>
		<li>length - get the number of buffered ranges in the audio/video</li>
		<li>start(<em>index</em>) - get the start position of a buffered range</li>
		<li>end(<em>index</em>) - get the end position of a buffered range</li>
	</ul>
	<p><strong>Note: </strong>The first buffered range is <em>index</em> 0</p>
		</td>
    </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_buffered.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_buffered.asp#top" target="_top">TOP</a> |
		<a href="av_prop_buffered.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
