...
<title>HTML onload Event Attribute</title>
<style>a.menu_ev_onload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onload</span> Event Attribute</h1>
...
<p>Execute a JavaScript immediately after a page has been loaded:</p>
<div class="example_code notranslate">
    &lt;body onload=&quot;load()&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml5_ev_onload">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The onload event attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onload attribute fires when an object has been loaded.</p>
<p>onload is most often used within the &lt;body&gt; element to execute a script once 
a web page has completely loaded all content (including images, script files, CSS files, etc.).</p>
<hr>
...
<div class="code notranslate"><div>
    &lt;<i>element</i> onload=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onload</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_onload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_onload.asp#top" target="_top">TOP</a> |
		<a href="ev_onload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
