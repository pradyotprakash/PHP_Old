...
<style>a.menu_tag_keygen{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;keygen&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_label.asp">&lt;label&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_keygen" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;keygen&gt; tag is supported in Firefox, Opera, Chrome, and Safari 6.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;keygen&gt; tag specifies a key-pair generator field used for forms.</p>
<p>When the form is submitted, the private key is stored locally, and the public key is sent to the server.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The &lt;keygen&gt; element is new in HTML5.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_keygen_autofocus.asp">autofocus</a><span class="new">New</span></td>
    <td>autofocus</td>
    <td>Specifies that a &lt;keygen&gt; element should automatically get focus when the page loads</td>
  </tr>
  <tr>
    <td>challenge<span class="new">New</span></td>
    <td>challenge</td>
    <td>Specifies that the value of the &lt;keygen&gt; element should be challenged when submitted</td>
  </tr>
  <tr>
    <td><a href="att_keygen_disabled.asp">disabled</a><span class="new">New</span></td>
    <td>disabled</td>
    <td>Specifies that a &lt;keygen&gt; element should be disabled</td>
  </tr>
  <tr>
    <td><a href="att_keygen_form.asp">form</a><span class="new">New</span></td>
    <td><i>form_id</i></td>
    <td>Specifies one or more forms the &lt;keygen&gt; element belongs to</td>
  </tr>
  <tr>
    <td><a href="att_keygen_keytype.asp">keytype</a><span class="new">New</span></td>
    <td>rsa<br>
	dsa<br>
	ec</td>
    <td>Specifies the security algorithm of the key</td>
  </tr>
  <tr>
    <td><a href="att_keygen_name.asp">name</a><span class="new">New</span></td>
    <td><i>name</i></td>
    <td>Defines a name for the &lt;keygen&gt; element</td>
  </tr>
</table>

<h2>Global Attributes</h2>
<p>The &lt;keygen&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;keygen&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_label.asp">&lt;label&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_keygen.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_keygen.asp#top" target="_top">TOP</a> |
		<a href="tag_keygen.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
