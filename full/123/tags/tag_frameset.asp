...
<style>a.menu_tag_frameset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;frameset&gt;</span> Tag. <span class="deprecated">Not Supported in HTML5.</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_head.asp">&lt;head&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>The &lt;frameset&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;frameset&gt; tag is not supported in HTML5.</span></p>
<p>The &lt;frameset&gt; tag defines a frameset.</p>
<p>The &lt;frameset&gt; element holds one or more <a href="tag_frame.asp">&lt;frame&gt;</a> elements. Each 
&lt;frame&gt; element can hold a separate document.</p>
<p>The &lt;frameset&gt; element specifies HOW MANY columns or rows there will be in the 
frameset, and HOW MUCH percentage/pixels of space will occupy each of them.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_frameset_cols.asp">cols</a></td>
    <td><i>pixels<br>
      %<br>
      *</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the number and size of columns in a frameset</td>
  </tr>
  <tr>
    <td><a href="att_frameset_rows.asp">rows</a></td>
    <td><i>pixels<br>
      %<br>
      *</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the number and size of rows in a frameset</td>
  </tr>
</table>
...
<p>The &lt;frameset&gt; tag supports the following standard attributes in HTML 
4.01:</p>
<table class="reference notranslate"> 
  <tr>
    <th style="width:20%">Attribute</th>
...
<p>The &lt;frameset&gt; tag supports the following event attributes in HTML 4.01:</p>
<table class="reference notranslate"> 
  <tr>
    <th style="width:20%">Attribute</th>
    <th style="width:20%">Value</th>
    ...
    <td>onload</td>
    <td><i>script</i></td>
    <td>Script to be run when a document load</td>
  </tr>
	<tr>
    <td>onunload</td>
    <td><i>script</i></td>
    <td>Script to be run when a document unload</td>
  </tr>
  </table>
...
<p><a target="_blank" href="tryit.asp?filename=tryhtml_frame_noresize">Frameset with noresize=&quot;noresize&quot;</a><br>
How to use the &quot;noresize&quot; attribute. The frames are not resizable. Move the 
mouse over the borders between the frames and notice that you can not move the borders.</p>

<hr>

<h2>Related Pages</h2>
<p>HTML DOM reference: 
<a href="../jsref/dom_obj_frameset.asp">Frameset object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_head.asp">&lt;head&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_frameset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_frameset.asp#top" target="_top">TOP</a> |
		<a href="tag_frameset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
