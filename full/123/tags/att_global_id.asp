...
<title>HTML Global id Attribute</title>
<style>a.menu_att_global_id{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">id</span> Attribute</h1>
...
<div class="example_code notranslate">
		...
		{<br>
		document.getElementById(&quot;myHeader&quot;).innerHTML=&quot;Have a nice day!&quot;;<br>
		}<br>
		&lt;/script&gt;<br>
		&lt;/head&gt;<br>
		<br>
		&lt;body&gt;<br>
		&lt;h1 id=&quot;myHeader&quot;&gt;Hello World!&lt;/h1&gt;<br>
		&lt;button onclick=&quot;displayResult()&quot;&gt;Change text&lt;/button&gt;<br>
		&lt;/body&gt;<br>
		<br>
		&lt;/html&gt;
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_global_id_js" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The id attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The id attribute specifies a unique id for an HTML element (the  
value must be unique within the HTML document).</p>
<p>The id attribute is most used to point to a style in a style sheet, and by JavaScript (via the HTML DOM) to 
manipulate the element with the specific id.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>In HTML5, the id attribute can be used on <b>any</b> HTML element (it will 
validate on any HTML element. However, it is not necessarily useful).</p>
<p>In HTML 4.01, the id attribute cannot be used with: 
&lt;base&gt;, &lt;head&gt;, &lt;html&gt;, &lt;meta&gt;, &lt;param&gt;, &lt;script&gt;, &lt;style&gt;, and &lt;title&gt;.</p>
<p><b>Note:</b> HTML 4.01 has greater restrictions on the content of id values 
(for example; in HTML 4.01 id values cannot start with a number).</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	
		&lt;<i>element</i> id=&quot;<i>id</i>&quot;&gt;
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>id</em></td>
		<td>Specifies a unique id for the element.
		Naming rules:<ul>
			<li>Must contain at least one character</li>
			<li>Must not contain any space characters</li>
			<li>In HTML, all values are case-insensitive</li>
		</ul>
		</td>
	</tr>
</table>
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td width="48">
		<img alt="Examples" height="46" src="http://www.w3schools.com/images/tryitimg.gif" width="40" /></td>
		<td>
		<h2>Try it Yourself - Examples</h2>
		</td>
	</tr>
</table>
<p><a target="_blank" href="tryit.asp?filename=tryhtml5_global_id_css">Add an id 
attribute to an HTML element, and use it in CSS</a><br>
Use the id attribute to style text with CSS.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_global_id.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_global_id.asp#top" target="_top">TOP</a> |
		<a href="att_global_id.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
