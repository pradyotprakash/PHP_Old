...
<title>HTML Global title Attribute</title>
<style>a.menu_att_global_title{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">title</span> Attribute</h1>
...
<p>Use of the title attribute in an HTML document:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_global_title" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The title attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The title attribute specifies extra information about an element.</p>
<p>The information is most often shown as a tooltip text when the mouse moves 
over the element.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>In HTML5, the title attribute can be used on <b>any</b> HTML element (it will 
validate on any HTML element. However, it is not necessarily useful).</p>
<p>In HTML 4.01, the title attribute cannot be used with: 
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>text</em></td>
		<td>A tooltip text for an element</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_global_title.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_global_title.asp#top" target="_top">TOP</a> |
		<a href="att_global_title.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
