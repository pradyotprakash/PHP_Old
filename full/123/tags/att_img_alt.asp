...
<style>a.menu_att_img_alt{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;img&gt; <span class="color_h1">alt</span> Attribute</h1>
...
<p>An image with an alternate text specified:</p>
...
<p>The alt attribute is supported in all major browsers.</p>
<p><b>Note:</b> Internet Explorer 7 (and earlier) displays the value of the alt attribute as a tooltip, when mousing over the 
image. This is NOT the correct behavior, according to the HTML specification.&nbsp;</p>
<hr>

<h2>Definition and Usage </h2>
<p>The required alt attribute specifies an alternate text for an image, if the image cannot be displayed.</p>
<p>The alt attribute provides alternative information for an image if a user for some reason cannot view 
it (because of slow connection, an error in the src attribute, or if the user uses a screen reader).</p>
<p><b>Tip:</b> To create a tooltip for an image, use the 
<a href="ref_standardattributes.asp">title</a> attribute!</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>text</i></td>
    <td>Specifies an alternate text for an image.<p>Guidelines for the alt text:</p>
		<ul>
			<li>The text should describe the image if the image contains 
			information</li>
			<li>The text should explain where the link goes if the image is 
			inside an &lt;a&gt; element</li>
			<li>Use alt=&quot;&quot; if the image is only for decoration</li>
		</ul>
		</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_img_alt.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_img_alt.asp#top" target="_top">TOP</a> |
		<a href="att_img_alt.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
