...
<title>HTML pre width Attribute</title>
<style>a.menu_att_pre_width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;pre&gt; <span class="color_h1">width</span> Attribute</h1>
<p><a href="tag_pre.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML pre Tag Reference" /> HTML &lt;pre&gt; tag</a></p>
<div class="example">


<h2 class="example">Example</h2>
<p>Preformatted text with a width of 30 characters:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_pre_width" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The width attribute is only supported by Firefox.</p>
<hr>

<h2>Definition and Usage </h2>
<p>The width attribute specifies the maximum number of characters per line.</p>
<hr>

<h2>Compatibility Notes</h2>
<p><span class="deprecated">The width attribute of &lt;pre&gt; is not supported in HTML5. Use CSS instead.</span></p>
<p>CSS syntax: &lt;div style=&quot;width:200px;overflow:auto&quot;&gt;&lt;pre&gt;Some text&lt;/pre&gt;&lt;/div&gt;</p>
<p><a target="_blank" href="tryit.asp?filename=tryhtml_pre_width_css">CSS 
Example: Pre-formatted text with a fixed width</a></p>
<p>In our CSS tutorial you can find more details about the
<a href="../cssref/pr_dim_width.asp">width property</a>.</p>
<p><b>Tip:</b> The overflow property adds a scrollbar if the width of the text exceeds the width of the surrounding element.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;pre width=&quot;<i>number</i>&quot;&gt;
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>number</i></td>
    <td>Sets the width in number of characters</td>
  </tr>
  </table>
<br>
<hr>
<a href="tag_pre.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML pre Tag Reference" /> HTML &lt;pre&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_pre_width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_pre_width.asp#top" target="_top">TOP</a> |
		<a href="att_pre_width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
