...
<title>HTML audio loop Attribute</title>
<style>a.menu_att_audio_loop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;audio&gt; <span class="color_h1">loop</span> Attribute</h1>
...
<p>A song that will start over again, every time it is finished:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_audio_loop" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The loop attribute is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;audio&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The loop attribute is a boolean attribute.</p>
<p>When present, it specifies that the audio will start over again, every time it is finished.</p>
<hr>
...
<p>In XHTML, attribute minimization is forbidden, and the loop attribute must 
be defined as &lt;audio loop=&quot;loop&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_audio_loop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_audio_loop.asp#top" target="_top">TOP</a> |
		<a href="att_audio_loop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
