...
<title>HTML canvas lineJoin Property</title>
<style>a.menu_canvas_linejoin{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">lineJoin</span> Property</h1>
...
<p>Create a rounded corner when the two lines meet:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_linejoin" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the lineJoin property.</p>
...
<p><b>Note:</b> The &quot;miter&quot; value is affected by the
<a href="canvas_miterlimit.asp">miterLimit</a> property.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.lineJoin=&quot;bevel|round|miter&quot;;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td>bevel</td>
		<td>Creates a beveled corner</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_lineJoin">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>round</td>
		<td>Creates a rounded corner</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_lineJoin&amp;preval=round">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>miter</td>
		<td>Default. Creates a sharp corner</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_lineJoin&amp;preval=miter">Play it &raquo;</a></td>
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_linejoin.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_linejoin.asp#top" target="_top">TOP</a> |
		<a href="canvas_linejoin.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
