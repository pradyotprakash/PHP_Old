...
<title>HTML input formaction Attribute</title>
<style>a.menu_att_input_formaction{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">formaction</span> Attribute</h1>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_input_formaction" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The formaction attribute specifies the URL of the file that will process the input control when the form is submitted.</p>
<p>The formaction attribute overrides the <a href="att_form_action.asp">action</a> attribute of the &lt;form&gt; element.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>URL</i></td>
    <td>Specifies the URL of the file that will process the input control when the form is submitted.<p>Possible values:</p>
<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_formaction.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_formaction.asp#top" target="_top">TOP</a> |
		<a href="att_input_formaction.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
