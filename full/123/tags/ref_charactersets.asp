...
<style>a.menu_ref_charactersets{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="ref_colormixer.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ref_urlencode.asp">Next Reference &raquo;</a></div>
</div>
<hr>
<p class="intro">To display an HTML page correctly, the browser must know what character set 
(character encoding) to use.</p>
<hr>
<h2>HTML Character Sets</h2>
<p>What is the correct character encoding to use in HTML?</p>
<p><strong>For HTML5, the default character encoding is UTF-8.</strong></p>
<p>This has not always been the case. The character encoding for the early web was ASCII.</p>
<p>Later, from HTML 2.0 to HTML 4.01, ISO-8859-1 was 
considered the standard.</p>
<p>With XML and HTML5, UTF-8 finally arrived, and 
solved a lot of character encoding problems.</p>
<p>Below is a brief description of the character encoding standards. </p>
<hr>
<h2>In the Beginning: ASCII</h2>
<p>Computer information (numbers, texts, and pictures) is stored 
as binary ones and zeros (01000101) in the electronics.</p>
<p>To standardize the storing of alphanumeric characters, the American Standard Code for Information 
Interchange (ASCII) was created. It defined a unique binary 7-bits number for 
each storable character to support the numbers from 0-9, the upper/lower case English alphabet (a-z, A-Z), and some special 
characters like ! $ + - ( ) @ &lt; &gt; .</p>
<p>Since ASCII used one byte (7 bits for the character, and one of  
bit for transmission parity control), it could only represent 128 
different characters. In addition 32 of these characters were reserved for 
other control purposes.</p>
<p>The biggest weakness with ASCII was that it excluded non English letters.</p>
<p>ASCII is still in widespread use today, especially in large mainframe 
computer systems.</p>
<p>For a closer look, please study our <a href="../charsets/ref_html_ascii.asp">Complete ASCII 
Reference</a>.</p>
<hr>
<h2>In Windows: ANSI</h2>
<p>ANSI (also called Windows-1252) was the default character set in Windows, up to Windows 95.</p>

<p>ANSI is an extension to ASCII, with added international characters. It 
uses a full byte (8-bits) to represent 256 different characters. </p>
<p>Since ANSI has been the default character set in Windows, it is supported by all 
browsers.</p>
<p>For a closer look, please study our <a href="../charsets/ref_html_ansi.asp">Complete ANSI 
Reference</a>.</p>
<hr>
<h2>In HTML 4: ISO-8859-1</h2>
<p>Since most countries use characters outside ASCII, the default character 
encoding 
in the HTML 2.0 standard was changed to ISO-8859-1. </p>
<p>ISO-8859-1 is an extension to ASCII, with added international characters. 
Like ANSI, it 
uses a full byte to represent 
twice as many characters than ASCII. </p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>When browsers detect ISO-8859-1 in a web page, they normally default to 
ANSI, because ANSI is identical to ISO-8859-1 except that ANSI has 32 extra 
characters. </td>
</tr></table>

<p>If an HTML 4 web page uses a different character-set than ISO-8859-1, it should be 
specified in the &lt;meta&gt; tag like:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;meta http-equiv=&quot;Content-Type&quot; content=&quot;text/html;charset=ISO-8859-8&quot;&gt;
</div>
<br><a target="_blank" href="../charsets/tryit.asp?filename=tryhtml_charsets" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
<p>
The default character set for HTML5 is UTF-8.<br>All HTML 4 processors support 
UTF-8, and all HTML5 and XML processors support both UTF-8 and UTF-16.</p>
</td>
</tr></table>
<p>For a closer look, please study our <a href="../charsets/ref_html_8859.asp">Complete ISO-8859-1 
Reference</a>.</p>
<hr>

<h2>In HTML5: Unicode UTF-8</h2>

<p>Because the character sets listed above are 
limited, and not compatible in multilingual environments, the 
Unicode Consortium developed the Unicode Standard.</p>
...
transport of text, independent of platform and language.</p>

<p><strong>The default character encoding in HTML5 is UTF-8.</strong></p>
<p>For a closer look, please study our <a href="../charsets/ref_html_utf8.asp">Complete 
Unicode Reference</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ref_colormixer.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ref_urlencode.asp">Next Reference &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_charactersets.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_charactersets.asp#top" target="_top">TOP</a> |
		<a href="ref_charactersets.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
