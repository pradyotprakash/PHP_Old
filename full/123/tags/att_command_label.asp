...
<title>HTML command label Attribute</title>
<style>a.menu_att_command_label{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;command&gt; <span class="color_h1">label</span> Attribute</h1>
...
<p>A &lt;command&gt; element with a label:</p>
<div class="example_code notranslate">
    &lt;menu&gt;<br>
	&lt;command type=&quot;command&quot; label=&quot;Save changes&quot;<br>
	onclick=&quot;save()&quot;&gt;Save&lt;/command&gt;<br>
	&lt;/menu&gt;
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_command_label" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The label attribute is currently not supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The required label attribute specifies the name of the command, as shown to the user.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>text</em></td>
		<td>Specifies the visible label of the command</td>
	</tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_command_label.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_command_label.asp#top" target="_top">TOP</a> |
		<a href="att_command_label.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
