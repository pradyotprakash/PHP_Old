...
<style>a.menu_ev_onresize{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onresize</span> Event Attribute</h1>
...
<div class="example_code notranslate">
    &lt;body onresize=&quot;showMsg()&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml5_ev_onresize">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The onresize event attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onresize attribute fires when an object is resized.</p>
<p>The onresize attribute is most often used when the browser window is resized.</p>
<hr>
...
<div class="code notranslate"><div>
    &lt;<i>element</i> onresize=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onresize</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_onresize.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_onresize.asp#top" target="_top">TOP</a> |
		<a href="ev_onresize.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
