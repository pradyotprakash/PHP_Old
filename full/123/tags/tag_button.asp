...
<style>a.menu_tag_button{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;button&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_canvas.asp">&lt;canvas&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_button_test" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;button&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;button&gt; tag defines a clickable button.</p>
<p>Inside a &lt;button&gt; element you can put content, like text or images. This is the difference between this element and buttons created with the 
&lt;input&gt; element.</p>
<p><b>Tip:</b> Always specify the type attribute for a &lt;button&gt; element. Different browsers use 
different default types for the &lt;button&gt; element.</p>
<hr>

<h2>Tips and Notes</h2>
<p><b>Note:</b> If you use the &lt;button&gt; element in an HTML form, different browsers may submit different values.
Use <a href="tag_input.asp">&lt;input&gt;</a> to create buttons in an HTML form.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>HTML5 has the following new attributes: autofocus, form, formaction, formenctype, formmethod, formnovalidate, and
formtarget.</p>
<hr>
...
<table class="reference notranslate" id="table1">
  ...
  <tr>
    <td><a href="att_button_autofocus.asp">autofocus</a><span class="new">New</span></td>
    <td>autofocus</td>
    <td>Specifies that a button should automatically get focus when the page loads</td>
  </tr>
  <tr>
    <td><a href="att_button_disabled.asp">disabled</a></td>
    <td>disabled</td>
    <td>Specifies that a button should be disabled</td>
  </tr>
  <tr>
    <td><a href="att_button_form.asp">form</a><span class="new">New</span></td>
    <td><i>form_id</i></td>
    <td>Specifies one or more forms the button belongs to</td>
  </tr>
  <tr>
    <td><a href="att_button_formaction.asp">formaction</a><span class="new">New</span></td>
    <td><i>URL</i></td>
    <td>Specifies where to send the form-data when a form is submitted. Only for type=&quot;submit&quot;</td>
  </tr>
  <tr>
    <td><a href="att_button_formenctype.asp">formenctype</a><span class="new">New</span></td>
    <td>application/x-www-form-urlencoded<br>
	multipart/form-data<br>
	text/plain</td>
    <td>Specifies how form-data should be encoded before sending it to a server. Only for type=&quot;submit&quot;</td>
  </tr>
  <tr>
    <td><a href="att_button_formmethod.asp">formmethod</a><span class="new">New</span></td>
    <td>get<br>post</td>
    <td>Specifies how to send the form-data (which HTTP method to use). Only for type=&quot;submit&quot;</td>
  </tr>
  <tr>
    <td><a href="att_button_formnovalidate.asp">formnovalidate</a><span class="new">New</span></td>
    <td>formnovalidate</td>
    <td>Specifies that the form-data should not be validated on submission. Only for type=&quot;submit&quot; </td>
  </tr>
  <tr>
    <td><a href="att_button_formtarget.asp">formtarget</a><span class="new">New</span></td>
    <td>_blank<br>
    _self<br>
    _parent<br>
    _top<br>
    <i>framename</i></td>
    <td>Specifies where to display the response after submitting the form. Only for type=&quot;submit&quot;</td>
  </tr>
  <tr>
    <td><a href="att_button_name.asp">name</a></td>
    <td><i>name</i></td>
    <td>Specifies a name for the button</td>
  </tr>
  <tr>
    <td><a href="att_button_type.asp">type</a></td>
    <td>button<br>
      reset<br>
      submit&nbsp;</td>
  ...
  <tr>
    <td><a href="att_button_value.asp">value</a></td>
    <td><i>text</i></td>
    <td>Specifies an initial value for the button</td>
  </tr>
</table>
<br>
<hr>
...
<p>The &lt;button&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;button&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: 
<a href="../jsref/dom_obj_pushbutton.asp">Button object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_canvas.asp">&lt;canvas&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_button.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_button.asp#top" target="_top">TOP</a> |
		<a href="tag_button.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
