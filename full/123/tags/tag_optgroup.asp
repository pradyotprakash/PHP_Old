...
<style>a.menu_tag_optgroup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;optgroup&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_option.asp">&lt;option&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_optgroup" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;optgroup&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;optgroup&gt; is used to group related options in a drop-down list.</p>
<p>If you have a long list of options, groups of related options are easier to handle for a user.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_optgroup_disabled.asp">disabled</a></td>
    <td>disabled</td>
    <td>Specifies that an option-group should be disabled</td>
    </tr>
  <tr>
    <td><a href="att_optgroup_label.asp">label</a></td>
    <td><i>text</i></td>
    <td>Specifies a label for an option-group</td>
  </tr>
</table>
<br>
<hr>
...
<p>The &lt;optgroup&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;optgroup&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_option.asp">&lt;option&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_optgroup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_optgroup.asp#top" target="_top">TOP</a> |
		<a href="tag_optgroup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
