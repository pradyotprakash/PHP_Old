...
<title>HTML Audio/Video DOM durationchange Event</title>
<style>a.menu_av_event_durationchange{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">durationchange</span> Event</h1>
...
<p>Alert that the duration of the video has changed:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.ondurationchange=alert(&quot;The 
	video duration has changed&quot;);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_durationchange" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The durationchange event occurs when the duration data of the specified audio/video is 
changed.</p>
<p>When an audio/video is loaded, the duration will change from &quot;NaN&quot; to the 
actual duration of the audio/video.</p>
<p>During the loading process of an audio/video, the following events occur, in 
this order:</p>
<ol>
	<li><a href="av_event_loadstart.asp">loadstart</a></li>
	<li>durationchange</li>
	<li><a href="av_event_loadedmetadata.asp">loadedmetadata</a></li>
	<li><a href="av_event_loadeddata.asp">loadeddata</a></li>
	<li><a href="av_event_progress.asp">progress</a></li>
	<li><a href="av_event_canplay.asp">canplay</a></li>
	<li><a href="av_event_canplaythrough.asp">canplaythrough</a></li>
</ol>
<hr>
...
<p>The durationchange event is supported in all major browsers.</p>
<p><strong>Note:</strong> This property is not supported in Internet 
Explorer 8 and earlier.</p>
<hr>

<h2>Syntax</h2>
<p>In HTML:</p>
<div class="code notranslate"><div>
	<em>&lt;audio|video</em> ondurationchange="<em>SomeJavaScriptCode</em>"&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.ondurationchange=<em>SomeJavaScriptCode</em>;</div></div>
<p>Using addEventListener():</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;durationchange&quot;, function()<br>&nbsp; {<br>&nbsp; <em>
	//SomeJavaScriptCode</em><br>&nbsp; 
	}<br>);</div></div>
...
<tr>
	<th style="width:33%">Supported HTML tags:</th>
	<td>&lt;audio&gt;, &lt;video&gt;</td>
</tr>
<tr>
	<th>Supported JavaScript objects:</th>
	<td>Audio, Video</td>
</tr>
</table>
<br>
...
<p><a href="tryit.asp?filename=tryhtml5_av_event_durationchange_html" target="_blank">Use the ondurationchange attribute on an HTML element</a></p>
<p><a href="tryit.asp?filename=tryhtml5_av_event_durationchange_el" target="_blank">Use addEventListener() to listen for the durationchange event</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_event_durationchange.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_event_durationchange.asp#top" target="_top">TOP</a> |
		<a href="av_event_durationchange.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
