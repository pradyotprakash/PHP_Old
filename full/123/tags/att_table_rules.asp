...
<title>HTML table rules Attribute</title>
<style>a.menu_att_table_rules{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;table&gt; <span class="color_h1">rules</span> Attribute</h1>
...
<p>Display only the borders between the rows:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_table_rules" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The rules attribute is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> The rules attribute of the &lt;table&gt; tag is not supported in Internet Explorer 8 and earlier versions.</p>
<p><b>Note:</b> Chrome and Safari displays this attribute incorrectly: They add the affected outside borders in addition to the inside borders.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;table&gt; rules attribute is not supported in HTML5. 
Use CSS instead.</span></p>
<p>The rules attribute specifies which parts of the inside borders that should be visible.</p>
<p>For practical reasons, it may be better to not specify any rules, and use CSS instead.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;table rules=&quot;<i>value</i>&quot;&gt;
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>groups</td>
    <td>Lines between row groups and column groups</td>
  </tr>
	<tr>
    <td>rows</td>
    <td>Lines between rows</td>
  </tr>
	<tr>
    <td>cols</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_table_rules.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_table_rules.asp#top" target="_top">TOP</a> |
		<a href="att_table_rules.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
