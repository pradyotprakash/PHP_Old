...
<title>HTML track default Attribute</title>
<style>a.menu_att_track_default{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;track&gt; <span class="color_h1">default</span> Attribute</h1>
...
<p>A video with two subtitle tracks. &quot;English&quot; subtitle is the default:</p>
...
&nbsp; &lt;track src=&quot;subtitles_en.vtt&quot; kind=&quot;subtitles&quot; srclang=&quot;en&quot; label=&quot;English&quot; default&gt;<br>
...
<p>The default attribute is supported in Internet Explorer 10, Opera, and 
Chrome.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The default attribute is a boolean attribute.</p>
<p>When present, it specifies that the track is to be enabled if the user's 
preferences do not indicate that another track would be more appropriate.</p>
<p><b>Note:</b> There must not be more than one track element with a default attribute per media element.</p>
<hr>
...
<p>In XHTML, attribute minimization is forbidden, and the default attribute must 
be defined as &lt;track default=&quot;default&quot; /&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_track_default.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_track_default.asp#top" target="_top">TOP</a> |
		<a href="att_track_default.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
