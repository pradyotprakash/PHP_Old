...
<title>HTML input required Attribute</title>
<style>a.menu_att_input_required{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">required</span> Attribute</h1>
...
<p>An HTML form with a required input field:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_input_required" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The required attribute is supported in Internet Explorer 10, Firefox, Opera, and Chrome.</p>
...
<p><b>Note:</b> The required attribute works with the following input types: 
text, search, url, tel, email, password, date pickers, number, checkbox, radio, and file.</p>
<hr>
...
be defined as &lt;input required=&quot;required&quot; /&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_required.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_required.asp#top" target="_top">TOP</a> |
		<a href="att_input_required.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
