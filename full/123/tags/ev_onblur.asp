...
<title>HTML onblur Event Attribute</title>
<style>a.menu_ev_onblur{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onblur</span> Event Attribute</h1>
...
<p>Validate an input field when the user leaves it:</p>
<div class="example_code notranslate">
    &lt;input type=&quot;text&quot; name=&quot;fname&quot; id=&quot;fname&quot; onblur=&quot;upperCase()&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml5_ev_onblur">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The onblur event attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onblur attribute fires the moment that the element loses focus.</p>
<p>Onblur is most often used with form validation code (e.g. when the user leaves a form field).</p>
<p><b>Tip:</b> The onblur attribute is the opposite of the <a href="ev_onfocus.asp">onfocus</a> attribute.</p>
<hr>
...
<div class="code notranslate"><div>
    &lt;<i>element</i> onblur=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onblur</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_onblur.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_onblur.asp#top" target="_top">TOP</a> |
		<a href="ev_onblur.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
