...
<style>a.menu_att_param_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;param&gt; <span class="color_h1">name</span> Attribute</h1>
...
<p>The name attribute is supported in all major browsers. However, the file 
format defined in &lt;object&gt; may not be supported in all browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The name attribute specifies the name of a &lt;param&gt; element.</p>
<p>This attribute is used together with the value attribute to specify 
parameters for the plugin specified with the <a href="tag_object.asp">&lt;object&gt;</a> 
tag.</p>
<p>The name attribute value can be any name supported by the specified object.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_param_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_param_name.asp#top" target="_top">TOP</a> |
		<a href="att_param_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
