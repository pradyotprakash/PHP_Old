...
<style>a.menu_att_a_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_a_name" class="tryitbtn">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The &lt;a&gt; name attribute is not supported in HTML5. 
Use the id attribute instead.</span></p>
<p>The name attribute specifies the name of an anchor.</p>
<p>The name attribute is used to create a bookmark inside a document.</p>
<p>The href or the name attribute must be present in the &lt;a&gt; tag.</p>
<p><b>Tip:</b> In XHTML, the name attribute of the &lt;a&gt; tag is deprecated, 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_a_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_a_name.asp#top" target="_top">TOP</a> |
		<a href="att_a_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
