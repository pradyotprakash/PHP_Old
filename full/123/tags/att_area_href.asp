...
<title>HTML area href Attribute</title>
<style>a.menu_att_area_href{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;area&gt; <span class="color_h1">href</span> Attribute</h1>
...
<p>The href attribute specifies the hyperlink target for the area.</p>
<p>If the href attribute is not present, the &lt;area&gt; tag is not a hyperlink.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>In HTML5, if the &lt;area&gt; tag has no href attribute, it is 
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>URL</i></td>
    <td>Specifies the hyperlink target for the area.<p>Possible values:</p>
<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_area_href.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_area_href.asp#top" target="_top">TOP</a> |
		<a href="att_area_href.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
