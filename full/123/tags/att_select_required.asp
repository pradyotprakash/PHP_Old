...
<style>a.menu_att_select_required{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;select&gt; <span class="color_h1">required</span> Attribute</h1>
<p><a href="tag_select.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML select Tag Reference"> HTML &lt;select&gt; tag</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>An HTML form with a required drop-down list:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_select_required" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The required attribute is not supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The required attribute is a boolean attribute.</p>
<p>When present, it specifies the user is required to select a value before 
submitting the form.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The required attribute is new in HTML5.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In XHTML, attribute minimization is forbidden, and the required attribute must 
be defined as &lt;select required=&quot;required&quot; /&gt;. </p>
<hr>
...
<br>
<hr>
<a href="tag_select.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML select Tag Reference"> HTML &lt;select&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_select_required.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_select_required.asp#top" target="_top">TOP</a> |
		<a href="att_select_required.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
