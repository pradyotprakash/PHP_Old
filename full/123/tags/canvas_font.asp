...
<style>a.menu_canvas_font{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">font</span> Property</h1>
...
<p>Write a 30px high text on the canvas, using the font &quot;Arial&quot;:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_font" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the font 
property.</p>
...
<p>The font property sets or returns the current font properties for text 
content on the canvas.</p>
<p>The font property uses the same syntax as the <a href="../cssref/pr_font_font.asp">CSS font property</a>.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.font=&quot;italic small-caps bold 12px arial&quot;;</td>
  </tr>
</table>
<h2>Property Values</h2>
<table class="reference notranslate">
	<tr>
    <th style="width:23%">Values</th>    
    <th style="width:65%">Description</th>
    <th style="width:12%">Play it</th>                
	</tr>
	<tr>
		<td><i>font-style</i></td>
		<td>Specifies the font style. Possible values:<ul>
			<li>normal</li>
			<li>italic</li>
			<li>oblique</li>
		</ul>
		</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_fontstyle">Play it &raquo;</a></td>				
	</tr>
	<tr>
		<td><i>font-variant</i></td>
		<td>Specifies the font variant. Possible values:<ul>
			<li>normal</li>
			<li>small-caps</li>
		</ul>
		</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_fontvariant">Play it &raquo;</a></td>				
	</tr>
	<tr>
		<td><i>font-weight</i></td>
		<td>Specifies the font weight. Possible values:<ul>
			<li>normal</li>
			<li>bold</li>
			<li>bolder</li>
			<li>lighter</li>
		...
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_fontweight">Play it &raquo;</a></td>						
	</tr>
	<tr>
		<td><i>font-size/line-height</i></td>
		<td>Specifies the font size and the line-height, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_fontsize">Play it &raquo;</a></td>				
	</tr>
	<tr>
		<td><i>font-family</i></td>
		<td>Specifies the font family</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_fontfamily">Play it &raquo;</a></td>				
	</tr>
	<tr>
		<td>caption</td>
		<td>Use the font captioned controls (like buttons, drop-downs, etc.)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_font">Play it &raquo;</a></td>						
	</tr>
	<tr>
		<td>icon</td>
		<td>Use the font used to label icons</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_font&amp;preval=icon">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>menu</td>
		<td>Use the font used in menus (drop-down menus and menu lists)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_font&amp;preval=menu">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>message-box</td>
		<td>Use the font used in dialog boxes</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_font&amp;preval=message-box">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>small-caption</td>
		<td>Use the font used for labeling small controls</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_font&amp;preval=small-caption">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>status-bar</td>
		<td>Use the fonts used in window status bar</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_font&amp;preval=status-bar">Play it &raquo;</a></td>
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_font.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_font.asp#top" target="_top">TOP</a> |
		<a href="canvas_font.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
