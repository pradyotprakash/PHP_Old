...
<style>a.menu_tag_meta{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;meta&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_meter.asp">&lt;meter&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_meta" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;meta&gt; tag is supported in all major browsers.</p>
<hr>
...
<p><b>Note: </b>&lt;meta&gt; tags always goes inside the &lt;head&gt;
element.</p>

<p><b>Note:</b> Metadata is always passed as name/value pairs.</p>
<p><b>Note:</b> The content attribute MUST be defined if the name or the 
http-equiv attribute is defined. If none of these are defined, the content 
attribute CANNOT be defined.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>The scheme attribute is not supported in HTML5.</p>
<p>HTML5 has a new attribute, charset, which makes it easier to define charset:<br>
<ul>
	<li>HTML 4.01:
...
<p>In HTML the &lt;meta&gt; tag has no end tag.</p>
<p>In XHTML the &lt;meta&gt; tag must be properly closed.</p>
<hr>

<h2>Examples</h2>

<p><b>Example 1 - Define keywords for search engines:</b></p>
<div class="code notranslate">
<div>&lt;meta name=&quot;keywords&quot; content=&quot;HTML, CSS, XML, XHTML, JavaScript&quot;&gt;</div>
</div>

<p><b>Example 2 - Define a description of your web page:</b></p>
<div class="code notranslate">
<div>&lt;meta name=&quot;description&quot; content=&quot;Free Web tutorials on HTML and CSS&quot;&gt;</div>
</div>

<p><b>Example 3 - Define the author of a page:</b></p>
<div class="code notranslate">
<div>&lt;meta name=&quot;author&quot; content=&quot;Hege Refsnes&quot;&gt;</div>
</div>

<p><b>Example 4 - Refresh document every 30 seconds:</b></p>
<div class="code notranslate">
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_meta_charset.asp">charset</a><span class="new">New</span></td>
    <td><i>character_set</i></td>
    <td>Specifies the character encoding for the HTML document </td>
  </tr>
  <tr>
    <td><a href="att_meta_content.asp">content</a></td>
    <td><i>text</i></td>
    <td>Gives the value associated with the http-equiv or name attribute</td>
  </tr>
  <tr>
    <td><a href="att_meta_http_equiv.asp">http-equiv</a></td>
    <td>content-type<br>
      default-style<br>
      refresh</td>
    <td>Provides an HTTP header for the information/value of the content 
	attribute</td>
    </tr>
  <tr>
    <td><a href="att_meta_name.asp">name</a></td>
  ...
  <tr>
    <td><a href="att_meta_scheme.asp">scheme</a></td>
    <td><i>format/URI</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies a scheme to be used to interpret the value of the 
...
<p>The &lt;meta&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
...
<a href="../jsref/dom_obj_meta.asp">Meta object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_meter.asp">&lt;meter&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_meta.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_meta.asp#top" target="_top">TOP</a> |
		<a href="tag_meta.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
