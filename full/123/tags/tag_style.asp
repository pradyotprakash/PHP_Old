...
<style>a.menu_tag_style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;style&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_sub.asp">&lt;sub&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>Use of the &lt;style&gt; element in an HTML document:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_style" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;style&gt; tag is supported in all major browsers.</p>
<hr>
...
<p><b>Tip:</b> To link to an external style sheet, use the <a href="tag_link.asp">&lt;link&gt;</a> tag.</p>
<p><b>Tip:</b> To learn more about style sheets, please read our <a href="../css/default.asp">CSS Tutorial</a>.</p>
<p><b>Note:</b> If the &quot;scoped&quot; attribute is not used, each &lt;style&gt; tag must be 
located in the head section.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The &quot;scoped&quot; attribute is new in HTML5, which allows to define styles for 
a specified section of the document. If the &quot;scoped&quot; attribute is present, the styles only apply to the style 
element's parent element and that element's child elements.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_style_media.asp">media</a></td>
    <td><i>media_query</i></td>
    <td>Specifies what media/device the media resource is optimized for</td>
    </tr>
	<tr>
    <td><a href="att_style_scoped.asp">scoped</a><span class="new">New</span></td>
    <td>scoped</td>
    <td>Specifies that the styles only apply to this element's parent element 
	and that element's child elements</td>
  </tr>
  <tr>
    <td><a href="att_style_type.asp">type</a></td>
    <td>text/css</td>
    <td>Specifies the MIME type of the style sheet</td>
  </tr>
  </table>
<br>
<hr>
...
<p>The &lt;style&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;style&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_css.asp">HTML CSS</a></p>
<p>HTML DOM reference: <a href="../jsref/dom_obj_style.asp">Style object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_sub.asp">&lt;sub&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_style.asp#top" target="_top">TOP</a> |
		<a href="tag_style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
