...
<title>HTML canvas measureText() Method</title>
<style>a.menu_canvas_measuretext{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">measureText()</span> Method</h1>
...
<p>Check the width of the text, before writing it on the canvas:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_measuretext" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the measureText() 
method.</p>
...
<p>The measureText() method returns an object that contains the width of the 
specified text, in pixels.</p>
<p><b>Tip:</b> Use this method if you need to know the width of a text, before 
writing it on the canvas.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.measureText(<i>text</i>).width;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_measuretext">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_measuretext.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_measuretext.asp#top" target="_top">TOP</a> |
		<a href="canvas_measuretext.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
