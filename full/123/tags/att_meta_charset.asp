...
<style>a.menu_att_meta_charset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;meta&gt; <span class="color_h1">charset</span> Attribute</h1>
...
<p>Specify the character encoding for the HTML document:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_meta_charset" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The charset attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The charset attribute specifies the character encoding for the HTML document.</p>
<p><b>Tip:</b> The charset attribute can be locally overridden using the lang attribute on any element.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The charset attribute is new in HTML5, and replaces the need for: &lt;meta 
http-equiv=&quot;Content-Type&quot; content=&quot;text/html; charset=UTF-8&quot;&gt;</p>
<p>Specifying the character-set using the http-equiv attribute is still allowed, but the new 
way requires less code. <br>
</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
		&lt;meta charset=&quot;<i>character_set</i>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td>Specifies the character encoding for the HTML document.<p>Common values:</p>
		<ul>
			<li>UTF-8 - Character encoding for Unicode</li>
			<li>ISO-8859-1 - Character encoding for the Latin alphabet</li>
		</ul>
		<p>In theory, any character encoding can be used, but no browser 
		understands all of them. The more widely a character encoding is used, 
		the better the chance that a browser will understand it.</p>
		To view all available character encodings, look at
		<a target="_blank" href="http://www.iana.org/assignments/character-sets">
		IANA character sets</a>.</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_meta_charset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_meta_charset.asp#top" target="_top">TOP</a> |
		<a href="att_meta_charset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
