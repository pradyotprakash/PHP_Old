...
<style>a.menu_tag_address{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;address&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_applet.asp">&lt;applet&gt; Tag &raquo;</a></div>
</div><br>
<div class="example">
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_address" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;address&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;address&gt; tag defines the contact information for the author/owner of a document 
or an article.</p>
<p>If the &lt;address&gt; element is inside the &lt;body&gt; element, it represents contact information 
for the document.</p>
<p>If the &lt;address&gt; element is inside an &lt;article&gt; element, it represents contact information 
for that article.</p>
<p>The text in the &lt;address&gt; element usually renders in <i>italic</i>. Most browsers will
add a line break before and after the address element.</p>
<hr>

<h2>Tips and Notes</h2>
<p><b>Tip:</b> The &lt;address&gt; tag should NOT be used to describe a postal address, 
unless it is a part of the contact information.</p>
<p><b>Tip:</b> The &lt;address&gt; element will typically be included along with other 
information in a <a href="tag_footer.asp">&lt;footer&gt;</a> element.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>HTML 4.01 does not support the &lt;article&gt; tag, so in HTML 4.01 the &lt;address&gt; 
tag always defines the contact information of the <i>document's</i> author/owner.</p>
<hr>

<h2>Global Attributes</h2>
<p>The &lt;address&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;address&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_applet.asp">&lt;applet&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_address.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_address.asp#top" target="_top">TOP</a> |
		<a href="tag_address.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
