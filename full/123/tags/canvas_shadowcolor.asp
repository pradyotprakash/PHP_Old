...
<title>HTML canvas shadowColor Property</title>
<style>a.menu_canvas_shadowcolor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">shadowColor</span> Property</h1>
...
<p>Draw a red rectangle with a black shadow:</p>
...
<div class="example_code notranslate">
	...
	ctx=c.getContext(&quot;2d&quot;);<br>ctx.shadowBlur=20;<br>
	ctx.shadowColor=&quot;black&quot;;<br>ctx.fillStyle=&quot;red&quot;;<br>ctx.fillRect(20,20,100,80);</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_shadowcolor" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the shadowColor property.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;canvas&gt; element.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The shadowColor property sets or returns the color to use for shadows.</p>
<p><b>Note:</b> Use the shadowColor property together with the <a href="canvas_shadowblur.asp">shadowBlur</a> 
property to create a shadow.</p>
<p><b>Tip:</b> Adjust the shadow by using the <a href="canvas_shadowoffsetx.asp">shadowOffsetX</a> 
and <a href="canvas_shadowoffsety.asp">shadowOffsetY</a> properties.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.shadowColor=<i>color</i>;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>color</i></td>
		<td>The <a href="../cssref/css_colors_legal.asp">CSS color value</a> to 
		use for shadows. Default value is #000000</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_shadowColor">Play it &raquo;</a></td>
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_shadowcolor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_shadowcolor.asp#top" target="_top">TOP</a> |
		<a href="canvas_shadowcolor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
