...
<title>HTML a charset Attribute</title>
<style>a.menu_att_a_charset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_a_charset" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The charset attribute is not supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;a&gt; charset attribute is not supported in HTML5.</span></p>
<p>The charset attribute specifies the character-set of the linked document (the document referenced in the href attribute).</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>The character-set of the linked document.<p>Common 
	character sets:</p>
<ul>
	<li>UTF-8 - Character encoding for Unicode</li>
	<li>ISO-8859-1 - Character encoding for the Latin alphabet</li>
</ul>
<p>In theory, any character-set can be used, but no browser understands all of them. The more widely a 
character-set is used, the better the chance that a browser will understand it.</p>
<p>To view all available character-sets, go to our <a href="ref_charactersets.asp">Character sets reference</a>.</p>
	</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_a_charset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_a_charset.asp#top" target="_top">TOP</a> |
		<a href="att_a_charset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
