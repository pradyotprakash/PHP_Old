...
<title>HTML li value Attribute</title>
<style>a.menu_att_li_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;li&gt; <span class="color_h1">value</span> Attribute</h1>
...
<p>Use of the value attribute in an ordered list:</p>
<div class="example_code notranslate">
  
    &lt;ol&gt;<br>
      &nbsp;
      &lt;li value=&quot;100&quot;&gt;Coffee&lt;/li&gt;<br>
      &nbsp;
      &lt;li&gt;Tea&lt;/li&gt;<br>
      &nbsp;
      &lt;li&gt;Milk&lt;/li&gt;<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_li_value" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The value attribute sets the value of a list item. The following list items 
will increment from that number.</p>
<p>The value must be a number and can only be used in ordered lists (&lt;ol&gt;).</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>number</i></td>
    <td>Specifies the value of the list item</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_li_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_li_value.asp#top" target="_top">TOP</a> |
		<a href="att_li_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
