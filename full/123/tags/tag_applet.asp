...
<style>a.menu_tag_applet{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;applet&gt;</span> Tag. <span class="deprecated">Not Supported in HTML5.</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_area.asp">&lt;area&gt; Tag &raquo;</a></div>
</div><br>

<div class="example">
<h2 class="example">Example</h2>
<p>An embedded Java applet:</p>
<div class="example_code notranslate">
    &lt;applet code=&quot;Bubbles.class&quot; 
	width=&quot;350&quot; height=&quot;350&quot;&gt;<br>
	Java applet that draws animated bubbles.<br>
	&lt;/applet&gt;
</div>
<br>
</div>
...
<p><b>Note</b>: There is still some support for the &lt;applet&gt; tag in some browsers, but it requires additional plug-ins/installations to work.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;applet&gt; tag is not supported in HTML5. Use the <a href="tag_object.asp">&lt;object&gt;</a> tag instead.</span></p>
<p>The &lt;applet&gt; tag defines an embedded applet.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The &lt;applet&gt; tag is not supported in HTML5.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>code</td>
    <td><i>URL</i></td>
    <td>Specifies the file name of a Java applet</td>
  </tr>
	<tr>
    <td>object</td>
    <td><i>name</i></td>
    <td>Specifies a reference to a serialized representation of an 
	applet</td>
    </tr>
  </table>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    middle<br>
    baseline</td>
    <td>Specifies the alignment of an applet according to 
	surrounding elements</td>
  </tr>
  <tr>
    <td>alt</td>
    <td><i>text</i></td>
    <td>Specifies an alternate text for an applet</td>
  </tr>
  <tr>
    <td>archive</td>
    <td><i>URL</i></td>
    <td>Specifies the location of an archive file</td>
  </tr>
  <tr>
    <td>codebase</td>
    <td><i>URL</i></td>
    <td>Specifies a relative base URL for applets specified in the 
	code attribute</td>
  </tr>
    <tr>
    <td>height</td>
    <td><i>pixels</i></td>
    <td>Specifies the height of an applet</td>
  </tr>
    <tr>
    <td>hspace</td>
    <td><i>pixels</i></td>
    <td>Defines the horizontal spacing around an applet</td>
    </tr>
    <tr>
    <td>name</td>
    <td><i>name</i></td>
    <td>Defines the name for an applet (to use in scripts)</td>
    </tr>
  <tr>
    <td>vspace</td>
    <td><i>pixels</i></td>
    <td>Defines the vertical spacing around an applet</td>
    </tr>
  <tr>
    <td>width</td>
    <td><i>pixels</i></td>
    <td>Specifies the width of an applet</td>
  </tr>
  </table>
...
<p>The &lt;applet&gt; tag supports the following standard attributes in HTML 
4.01:</p>
<table class="reference notranslate"> 
  <tr>
    <th style="width:20%">Attribute</th>
...
<p>The &lt;applet&gt; tag does not support any event attributes in HTML 4.01.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_applet.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_applet.asp#top" target="_top">TOP</a> |
		<a href="tag_applet.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
