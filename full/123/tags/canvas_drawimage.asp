...
<title>HTML canvas drawImage() Method</title>
<style>a.menu_canvas_drawimage{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">drawImage()</span> Method</h1>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_drawimage" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the drawImage() 
method.</p>
...
<p>The drawImage() method draws an image, canvas, or video onto the canvas.</p>
<p>The drawImage() method can also draw parts of an image, and/or increase/reduce the image size.</p>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_drawimagedx&amp;preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>sy</i></td>
		<td>Optional. The y coordinate where to start clipping</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_drawimagedy&amp;preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>swidth</i></td>
		<td>Optional. The width of the clipped image</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_drawimagedwidth&amp;preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>sheight</i></td>
		<td>Optional. The height of the clipped image</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_drawimagedheight&amp;preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>x</i></td>
		<td>The x coordinate where to place the image on the canvas</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_drawimagex&amp;preval=img,10,10">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y coordinate where to place the image on the canvas</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_drawimagey&amp;preval=img,10,10">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>width</i></td>
		<td>Optional. The width of the image to use (stretch or reduce the image)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_drawimagewidth&amp;preval=img,10,10,220,277">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>height</i></td>
		<td>Optional. The height of the image to use (stretch or reduce the image)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_drawimageheight&amp;preval=img,10,10,220,277">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
<hr>
...
var c=document.getElementById(&quot;myCanvas&quot;);<br>var 
	ctx=c.getContext(&quot;2d&quot;);<br>var 
	img=document.getElementById(&quot;scream&quot;);<br>
	ctx.drawImage(img,10,10,150,180);</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_drawimage2" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
var c=document.getElementById(&quot;myCanvas&quot;);<br>var 
	ctx=c.getContext(&quot;2d&quot;);<br>var 
	img=document.getElementById(&quot;scream&quot;);<br>
	ctx.drawImage(img,90,130,50,60,10,10,50,60);</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_drawimage3" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
yourbrowserdoesnotsupportthecanvastag</canvas>
...
<p>JavaScript (the code draws the current frame of the video every 20 
millisecond):</p>
<div class="example_code notranslate">
var v=document.getElementById(&quot;video1&quot;);<br>
var c=document.getElementById(&quot;myCanvas&quot;);<br>
ctx=c.getContext('2d');<br>
v.addEventListener('play',function() {var i=window.setInterval(function() 
{ctx.drawImage(v,5,5,260,125)},20);},false);<br>
v.addEventListener('pause',function() {window.clearInterval(i);},false);<br>
v.addEventListener('ended',function() {clearInterval(i);},false);</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_drawimage_video" target="_blank">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_drawimage.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_drawimage.asp#top" target="_top">TOP</a> |
		<a href="canvas_drawimage.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
