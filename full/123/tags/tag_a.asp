...
<style>a.menu_tag_a{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="tag_abbr.asp">&lt;abbr&gt; Tag &raquo;</a></div>
</div>
<br>
<div class="example">
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_link_test" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;a&gt; tag defines a hyperlink, which is used to link from one page to 
another.</p>
<p>The most important attribute of the &lt;a&gt; element is the href attribute, which 
indicates the link's destination.</p>
...
<p><b>Tip:</b> Use CSS to style links.</p>
<hr>
...
<table class="reference notranslate" id="table1">
  ...
  <tr>
    <td><a href="att_a_charset.asp">charset</a></td>
  ...
  <tr>
    <td><a href="att_a_coords.asp">coords</a></td>
    <td><i>coordinates</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the coordinates of a link</td>
  </tr>
  <tr>
    <td><a href="att_a_download.asp">download</a><span class="new">New</span></td>
    <td><i>filename</i></td>
    <td>Specifies the hyperlink target to be downloaded</td>
  </tr>
  <tr>
    <td><a href="att_a_href.asp">href</a></td>
    <td><i>URL</i></td>
    <td>Specifies the URL of the page the link goes to</td>
  </tr>
  <tr>
    <td><a href="att_a_hreflang.asp">hreflang</a></td>
    <td><i>language_code</i></td>
    <td>Specifies the language of the linked document</td>
  </tr>
  <tr>
    <td><a href="att_a_media.asp">media</a><span class="new">New</span></td>
    <td><i>media_query</i></td>
    <td>Specifies what media/device the linked document is optimized for</td>
  </tr>
  <tr>
    <td><a href="att_a_name.asp">name</a></td>
    <td><i>section_name</i></td>
    <td><span class="deprecated">Not supported in HTML5. Use the id attribute 
	instead.</span> Specifies the name of an anchor</td>
  </tr>
  <tr>
    <td><a href="att_a_rel.asp">rel</a></td>
    <td>alternate<br>
	author<br>
	bookmark<br>
	help<br>
    ...
    <td>Specifies the relationship between the current document and the linked document</td>
      ...
      <tr>
    <td><a href="att_a_rev.asp">rev</a></td>
    <td><i>text</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the relationship between the linked document and the current document</td>
      ...
      <tr>
    <td><a href="att_a_shape.asp">shape</a></td>
    <td>default<br>
	rect<br>
    circle<br>
    poly</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the shape of a link</td>
      ...
      <tr>
    <td><a href="att_a_target.asp">target</a></td>
    <td>_blank<br>
      _parent<br>
      _self<br>
      _top<br>
    ...
    <tr>
    <td><a href="att_a_type.asp">type</a><span class="new">New</span></td>
    <td><i>MIME_type</i></td>
    <td>Specifies the MIME  
	type of the linked document</td>
    </tr>
</table>

<h2>Global Attributes</h2>
<p>The &lt;a&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;a&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhtml_link">Create hyperlinks</a><br>
How to create hyperlinks.</p>
<p><a target="_blank" href="tryit.asp?filename=tryhtml_link_image">An image as a link</a><br>
How to use an image as a link.</p>
<p><a target="_blank" href="tryit.asp?filename=tryhtml_link_target">Open a link in a new browser window</a><br>
How to open a link in a new browser window, so that the visitor does not have to leave your Web site. </p>
<p><a target="_blank" href="tryit.asp?filename=tryhtml_link_mailto">Create a mailto link</a><br>
How to link to a mail message (will only work if you have mail installed).</p>
<p><a target="_blank" href="tryit.asp?filename=tryhtml_link_mailto2">Create a mailto link 2</a><br>
Another mailto link.</p>
<p><a target="_blank" href="tryit.asp?filename=tryhtml5_a_href_anchor">Link to 
...
<p><a target="_blank" href="tryit.asp?filename=tryhtml5_a_href_script">Link to a JavaScript</a><br>
How to add a JavaScript inside the href attribute.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_links.asp">HTML Links</a></p>
<p>HTML DOM reference: 
<a href="../jsref/dom_obj_anchor.asp">Anchor object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_abbr.asp">&lt;abbr&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_a.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_a.asp#top" target="_top">TOP</a> |
		<a href="tag_a.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
