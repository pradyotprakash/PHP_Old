...
<style>a.menu_tag_textarea{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;textarea&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_tfoot.asp">&lt;tfoot&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>An HTML text area:</p>
<div class="example_code notranslate">
  
    &lt;textarea rows="4" cols=&quot;50&quot;&gt;<br>
      At w3schools.com you will learn how to make a website. We offer free 
	tutorials in all web development technologies. <br>
      &lt;/textarea>
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_textarea">Try it yourself &raquo;</a>
...
<p>The &lt;textarea&gt; tag is supported in all major browsers.</p>
<hr>
...
<p>The size of a text area can be specified by the cols and rows attributes, or even 
better; through CSS' height and width properties.</p>

<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>HTML5 has added several new attributes.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_textarea_autofocus.asp">autofocus</a><span class="new">New</span></td>
    <td>autofocus</td>
    <td>Specifies that a text area should automatically get focus when the page 
	loads</td>
  </tr>
  <tr>
    <td><a href="att_textarea_cols.asp">cols</a></td>
    <td><i>number</i></td>
    <td>Specifies the visible width of a text area</td>
  </tr>
  <tr>
    <td><a href="att_textarea_disabled.asp">disabled</a></td>
    <td>disabled</td>
    <td>Specifies that a text area should be disabled</td>
  </tr>
	<tr>
    <td><a href="att_textarea_form.asp">form</a><span class="new">New</span></td>
    <td><i>form_id</i></td>
    <td>Specifies one or more forms the text area belongs to</td>
  </tr>
	<tr>
    <td><a href="att_textarea_maxlength.asp">maxlength</a><span class="new">New</span></td>
    <td><i>number</i></td>
    <td>Specifies the maximum number of characters allowed in the text area</td>
  </tr>
	<tr>
    <td><a href="att_textarea_name.asp">name</a></td>
    <td><i>text</i></td>
    <td>Specifies a name for a text area</td>
  </tr>
	<tr>
    <td><a href="att_textarea_placeholder.asp">placeholder</a><span class="new">New</span></td>
    <td><i>text</i></td>
    <td>Specifies a short hint that describes the expected value of a text area</td>
  </tr>
	<tr>
    <td><a href="att_textarea_readonly.asp">readonly</a></td>
    <td>readonly</td>
    <td>Specifies that a text area should be read-only</td>
  </tr>
	<tr>
    <td><a href="att_textarea_required.asp">required</a><span class="new">New</span></td>
    <td>required</td>
    <td>Specifies that a text area is required/must be filled out</td>
  </tr>
  <tr>
    <td><a href="att_textarea_rows.asp">rows</a></td>
    <td><i>number</i></td>
    <td>Specifies the visible number of lines in a text area</td>
  </tr>
  <tr>
    <td><a href="att_textarea_wrap.asp">wrap</a><span class="new">New</span></td>
    <td>hard<br>
	soft</td>
...
<p>The &lt;textarea&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;textarea&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="../jsref/dom_obj_textarea.asp">Textarea object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_tfoot.asp">&lt;tfoot&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_textarea.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_textarea.asp#top" target="_top">TOP</a> |
		<a href="tag_textarea.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
