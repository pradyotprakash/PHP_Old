...
<style>a.menu_ev_onsubmit{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onsubmit</span> Event Attribute</h1>
...
<p>Execute a JavaScript when a form is submitted:</p>
<div class="example_code notranslate">
    &lt;form action=&quot;demo_form.asp&quot; onsubmit=&quot;checkForm()&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml5_ev_onsubmit">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The onsubmit event attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onsubmit attribute fires when a form is submitted.</p>
<p>The onsubmit attribute is only used within: &lt;form&gt;.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onsubmit</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_onsubmit.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_onsubmit.asp#top" target="_top">TOP</a> |
		<a href="ev_onsubmit.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
