...
<style>a.menu_tag_script{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;script&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_section.asp">&lt;section&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>Write &quot;Hello world&quot; with JavaScript:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_script" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;script&gt; tag is supported in all major browsers.</p>
<hr>
...
<p><b>Note:</b> If the &quot;src&quot; attribute is present, the &lt;script&gt; element must be 
empty.</p>
<p><b>Tip:</b> Also look at the <a href="tag_noscript.asp">&lt;noscript&gt;</a> element for users that have disabled scripts in their browser, or have a browser that 
doesn't support client-side scripting.</p>

<p><b>Note:</b> There are several ways an external script can be executed:</p>
<ul>
	<li>If async=&quot;async&quot;: The script is executed asynchronously with 
	the rest of the page (the script will be executed while the page continues 
	the parsing)</li>
	<li>If async is not present and defer=&quot;defer&quot;: The script 
	is executed when the page has finished parsing</li>
	<li>If neither async or defer is present: The script is fetched and executed immediately, 
	before the browser 
continues parsing the page</li>
</ul>
...
<p>The &quot;type&quot; attribute is required in HTML 4, but optional in HTML5.</p>
<p>The &quot;async&quot; attribute is new in HTML5.</p>
<p>The HTML 4.01 attribute: &quot;xml:space&quot;, is not supported in HTML5.</p>

<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In XHTML, the content inside scripts is declared as #PCDATA (instead of CDATA), which means that 
	entities will be parsed.</p>
<p>This means that in XHTML, all special characters should be encoded, or all content should be wrapped inside a CDATA 
section:</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_script_async.asp">async</a><span class="new">New</span></td>
    <td>async</td>
    <td>Specifies that the script is executed asynchronously (only for external scripts)</td>
  </tr>
  <tr>
    <td><a href="att_script_charset.asp">charset</a></td>
    <td><i>charset</i></td>
    <td>Specifies the character encoding used in an external script 
	file</td>
  </tr>
	<tr>
    <td><a href="att_script_defer.asp">defer</a></td>
    <td>defer</td>
    <td>Specifies that the script is executed when the page has finished parsing 
	(only for external scripts)</td>
  </tr>
	<tr>
    <td><a href="att_script_src.asp">src</a></td>
    <td><i>URL</i></td>
    <td>Specifies the URL of an external script file</td>
  </tr>
  <tr>
    <td><a href="att_script_type.asp">type</a></td>
    <td><i>MIME-type</i></td>
    <td>Specifies the MIME type of the script</td>
  </tr>
  <tr>
    <td>xml:space</td>
    <td>preserve</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies whether whitespace in code should be preserved</td>
  </tr>
</table>
<br>
<hr>
...
<p>The &lt;script&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_scripts.asp">HTML Scripts</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_section.asp">&lt;section&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_script.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_script.asp#top" target="_top">TOP</a> |
		<a href="tag_script.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
