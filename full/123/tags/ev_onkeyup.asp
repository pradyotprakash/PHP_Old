...
<title>HTML onkeyup Event Attribute</title>
<style>a.menu_ev_onkeyup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onkeyup</span> Event Attribute</h1>
...
<div class="example_code notranslate">
    &lt;input type=&quot;text&quot; onkeyup=&quot;displayResult()&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml5_ev_onkeyup">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The onkeyup event attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onkeyup attribute fires when the user releases a key (on the keyboard).</p>
...
<p><b>Note:</b> The onkeyup attribute CANNOT be used with: &lt;base&gt;, &lt;bdo&gt;, &lt;br&gt;, 
...
<div class="code notranslate"><div>
    &lt;<i>element</i> onkeyup=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onkeyup</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_onkeyup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_onkeyup.asp#top" target="_top">TOP</a> |
		<a href="ev_onkeyup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
