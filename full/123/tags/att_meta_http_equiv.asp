...
<title>HTML meta http-equiv Attribute</title>
<style>a.menu_att_meta_http_equiv{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;meta&gt; <span class="color_h1">http-equiv</span> Attribute</h1>
<p><a href="tag_meta.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML meta Tag Reference" /> HTML &lt;meta&gt; tag</a></p>
<div class="example">
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_meta_http_equiv" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The http-equiv attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The http-equiv attribute provides an HTTP header for the information/value of the <a href="att_meta_content.asp">content</a> attribute.</p>
...
<p>Using http-equiv is no longer the only way to specify the character set of an 
HTML document:</p>
<ul>
	<li>HTML 4.01:
...
<table class="reference notranslate" id="table1">
	...
	<tr>
		<td>content-type</td>
		<td>Specifies the character encoding for the document.<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;content-type&quot; content=&quot;text/html; charset=UTF-8&quot;&gt;</p></td>
	</tr>
	<tr>
		<td>default-style</td>
		<td>Specified the preferred style sheet to use.<p>Example:</p>
		...
		match the value of the title attribute on a link element in the same 
	...
	<tr>
		...
		<p>Note: The value &quot;refresh&quot; should be used carefully, as it takes the 
		control of a page away from the user. Using &quot;refresh&quot; will cause a failure in
		<a target="_blank" href="http://www.w3.org/WAI/intro/wcag.php">W3C's Web Content Accessibility Guidelines</a>.</p></td>
	</tr>
	</table>
<br>
<hr>

<a href="tag_meta.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML meta Tag Reference" /> HTML &lt;meta&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_meta_http_equiv.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_meta_http_equiv.asp#top" target="_top">TOP</a> |
		<a href="att_meta_http_equiv.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
