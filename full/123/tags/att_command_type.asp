...
<title>HTML command type Attribute</title>
<style>a.menu_att_command_type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;command&gt; <span class="color_h1">type</span> Attribute</h1>
...
<p>A &lt;command&gt; element of type &quot;command&quot;:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_command_type" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The type attribute is currently not supported in any of the major browsers.</p>
<p><b>Note:</b> Internet Explorer 9 (not earlier or later versions), supports the type attribute. However it only supports the &quot;command&quot; type.</p>

<hr>

<h2>Definition and Usage</h2>
<p>The type attribute specifies the type of command.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		<td>command</td>
		<td>Default. Specifies a normal command with an action</td>
	</tr>
	<tr>
		<td>checkbox</td>
		<td>Specifies a command that can be toggled using a checkbox</td>
	</tr>
	<tr>
		<td>radio</td>
		<td>Specifies a command that can be toggled using a radio button</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_command_type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_command_type.asp#top" target="_top">TOP</a> |
		<a href="att_command_type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
