...
<title>HTML Global class Attribute</title>
<style>a.menu_att_global_class{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">class</span> Attribute</h1>
...
<p>Use of the class attribute in an HTML document:</p>
<div class="example_code notranslate">
  
    &lt;html&gt;<br>
	&lt;head&gt;<br>
	&lt;style&gt;<br>
	h1.intro {color:blue;}<br>
	p.important {color:green;}<br>
	&lt;/style&gt;<br>
	&lt;/head&gt;<br>
	&lt;body&gt;<br>
	<br>
	&lt;h1 class=&quot;intro&quot;&gt;Header 1&lt;/h1&gt;<br>
	&lt;p&gt;A paragraph.&lt;/p&gt;<br>
	&lt;p class=&quot;important&quot;&gt;Note that this is an important paragraph. :)&lt;/p&gt;<br>
	<br>
	&lt;/body&gt;<br>
	&lt;/html&gt;
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_global_class" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The class attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The class attribute specifies one or more classnames for an element.</p>
<p>The class attribute is mostly used to point to a class in a style sheet. 
However, it can also be used by a JavaScript (via the HTML DOM) to make changes 
to HTML elements with a specified class.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>In HTML5, the class attribute can be used on <b>any</b> HTML element (it will 
validate on any HTML element. However, it is not necessarily useful).</p>
<p>In HTML 4.01, the class attribute cannot be used with: 
...
<div class="code notranslate"><div>
	...
	&lt;<i>element</i> class=&quot;<i>classname</i>&quot;&gt;
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>classname</i></td>
		<td>Specifies one or more class names for an element. To specify multiple classes, separate 
...
<p><a href="tryit.asp?filename=tryhtml5_global_class2" target="_blank">Add multiple classes to one element</a><br>
How to add multiple classes to one HTML element.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_global_class.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_global_class.asp#top" target="_top">TOP</a> |
		<a href="att_global_class.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
