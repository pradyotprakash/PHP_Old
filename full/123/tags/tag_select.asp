...
<style>a.menu_tag_select{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;select&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_small.asp">&lt;small&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_select" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;select&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;select&gt; element is used to create a drop-down list.</p>
<p>The <a href="tag_option.asp">&lt;option&gt;</a> tags inside the &lt;select&gt; element define the available options in 
the list.</p>
<hr>

<h2>Tips and Notes</h2>
<p><b>Tip:</b> The &lt;select&gt; element is a form control and can be used in a form to collect user input.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>HTML5 has added some new attributes.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_select_disabled.asp">disabled</a></td>
    <td>disabled</td>
    <td>Specifies that a drop-down list should be disabled</td>
  </tr>
  <tr>
    <td><a href="att_select_form.asp">form</a><span class="new">New</span></td>
    <td><i>form_id</i></td>
    <td>Defines one or more forms the select field belongs to</td>
  </tr>
  <tr>
    <td><a href="att_select_multiple.asp">multiple</a></td>
    <td>multiple</td>
    <td>Specifies that multiple options can be selected at once</td>
  </tr>
  <tr>
    <td><a href="att_select_name.asp">name</a></td>
    <td><i>name</i></td>
    <td>Defines a name for the drop-down list</td>
  </tr>
    <tr>
    <td><a href="att_select_required.asp">required</a><span class="new">New</span></td>
    <td>required</td>
    <td>Specifies that the user is required to select a value before submitting 
	the form</td>
    </tr>
  <tr>
    <td><a href="att_select_size.asp">size</a></td>
    <td><i>number</i></td>
...
<p>The &lt;select&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;select&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: 
<a href="../jsref/dom_obj_select.asp">Select object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_small.asp">&lt;small&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_select.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_select.asp#top" target="_top">TOP</a> |
		<a href="tag_select.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
