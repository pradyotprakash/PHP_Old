...
<title>HTML canvas scale() Method</title>
<style>a.menu_canvas_scale{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">scale()</span> Method</h1>
...
<p>Draw a rectangle, scale to 200%, then draw rectangle again:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_scale" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the scale() 
method.</p>
...
<p><b>Note:</b> If you scale a drawing, all future drawings will also be scaled. 
The positioning will also be scaled. If you scale(2,2); drawings will be positioned twice as far from the left and top of the canvas 
as you specify.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.scale(<em>scalewidth,scaleheight</em>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td>Scales the width of the current drawing (1=100%, 0.5=50%, 2=200%, etc.)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_scalex&amp;preval=1,1">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>scaleheight</i></td>
		<td>Scales the height of the current drawing (1=100%, 0.5=50%, 2=200%, etc.)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_scaley&amp;preval=1,1">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Draw a rectangle, scale to 200%, draw rectangle again, scale to 200%, draw 
rectangle again, scale to 200%, draw rectangle again:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_scale2" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_scale.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_scale.asp#top" target="_top">TOP</a> |
		<a href="canvas_scale.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
