...
<title>HTML ins datetime Attribute</title>
<style>a.menu_att_ins_datetime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;ins&gt; <span class="color_h1">datetime</span> Attribute</h1>
...
<p>An inserted text, with a date and time of when the text was inserted:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_ins_datetime" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The datetime attribute specifies the date and time of when the text was 
inserted/changed.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Specifies the date and time of when the text was inserted/changed.<p>Explanation of components:</p>
	<ul>
		<li>YYYY - year (e.g. 2009)</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_ins_datetime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_ins_datetime.asp#top" target="_top">TOP</a> |
		<a href="att_ins_datetime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
