...
<title>HTML Audio/Video DOM canplay Event</title>
<style>a.menu_av_event_canplay{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">canplay</span> Event</h1>
...
<p>Alert that the video is ready to start playing:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.oncanplay=alert(&quot;Can 
	start playing video&quot;);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_canplay" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The canplay event occurs when the browser can start playing the specified audio/video.</p>
...
<p>The canplay event is supported in all major browsers.</p>
...
<div class="code notranslate"><div>
	<em>&lt;audio|video</em> oncanplay="<em>SomeJavaScriptCode</em>"&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.oncanplay=<em>SomeJavaScriptCode</em>;</div></div>
<p>Or:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;canplay&quot;, function()<br>&nbsp; {<br>&nbsp; <em>
...
<p><a href="tryit.asp?filename=tryhtml5_av_event_canplay_html" target="_blank">Use the oncanplay attribute on an HTML element</a></p>
<p><a href="tryit.asp?filename=tryhtml5_av_event_canplay_el" target="_blank">Use addEventListener() to listen for the canplay event</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_event_canplay.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_event_canplay.asp#top" target="_top">TOP</a> |
		<a href="av_event_canplay.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
