...
<title>HTML Audio/Video DOM played Property</title>
<style>a.menu_av_prop_played{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">played</span> Property</h1>
...
<p>Get the first played range (part) of the video in seconds:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>alert(&quot;Start: &quot; + 
	myVid.played.start(0)<br>+ &quot; End: &quot; + myVid.played.end(0));</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_played" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The played property returns a TimeRanges object.</p>
<p>The TimeRanges object represents ranges of the audio/video that has already 
been played (seen) by the user.</p>
<p>A played range is a time-range of played audio/video. The user gets several 
played ranges if he/she skips in the audio/video.</p>
<hr>
...
<p>The played property is supported in all major browsers.</p>
<p><strong>Note:</strong> This property is not supported in Internet Explorer 8 and earlier.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate">
	<div>
		<em>audio|video</em>.played</div></div>
<h2>Return Value</h2>
<table class="reference notranslate">
  <tr>
    ...
    <td>Represents the played parts of the audio/video.<p>TimeRanges Object 
	Properties:</p>
	<ul>
		<li>length - get the number of played ranges in the audio/video</li>
		<li>start(<em>index</em>) - get the start position of a played range</li>
		<li>end(<em>index</em>) - get the end position of a played range</li>
	</ul>
	<p><strong>Note: </strong>The first played range is <em>index</em> 0</p>
		</td>
    </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_played.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_played.asp#top" target="_top">TOP</a> |
		<a href="av_prop_played.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
