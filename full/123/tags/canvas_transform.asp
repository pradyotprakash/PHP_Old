...
<title>HTML canvas transform() Method</title>
<style>a.menu_canvas_transform{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">transform()</span> Method</h1>
...
<p>Draw a rectangle, add a new transformation matrix with transform(), draw 
the rectangle again, add a new transformation matrix, then draw the rectangle 
again. Notice that each time you call transform(), it builds on the previous 
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_transform" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the transform() 
method.</p>
...
<p>The transform() method replaces the current transformation matrix. It multiplies the current transformation matrix with the matrix 
described by:</p>
...
<p>In other words, the transform() method lets you scale, rotate, move, and skew the 
current context.</p>
<p><b>Note:</b> The transformation will only affect drawings made after the transform() method is called.</p>
<p><b>Note:</b> The transform() method behaves relatively to other transformations made by rotate(), scale(), translate(), 
or transform().
Example: If you already have set your drawing to scale by two, and the transform() method scales your drawings by two,
your drawings will now scale by four.</p>
<p><b>Tip:</b> Check out the <a href="canvas_settransform.asp">setTransform()</a> method, which does not behave relatively to other transformations.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.transform(<em>a,b,c,d,e,f</em>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>a</i></td>
		<td>Scales the drawing horizontally</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_transforma&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>b</i></td>
		<td>Skew the the drawing horizontally</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_transformb&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>c</i></td>
		<td>Skew the the drawing vertically</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_transformc&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>d</i></td>
		<td>Scales the drawing vertically</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_transformd&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>e</i></td>
		<td>Moves the the drawing horizontally</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_transforme&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>f</i></td>
		<td>Moves the the drawing vertically</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_transformf&amp;preval=1,0,0,1,0,0">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_transform.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_transform.asp#top" target="_top">TOP</a> |
		<a href="canvas_transform.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
