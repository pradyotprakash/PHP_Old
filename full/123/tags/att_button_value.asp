...
<style>a.menu_att_button_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;button&gt; <span class="color_h1">value</span> Attribute</h1>
...
<p>Two buttons with equal names, that submit different values when clicked:</p>
<div class="example_code notranslate">
	...
	&nbsp;
	&lt;button name=&quot;subject&quot; type=&quot;submit&quot; value=&quot;fav_CSS&quot;&gt;CSS&lt;/button&gt;<br>
	&lt;/form&gt;
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_button_value2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><b>Important:</b> If you use the &lt;button&gt; element in an HTML form, 
Internet Explorer, prior version 8, will submit the text between the &lt;button&gt; 
and &lt;/button&gt; tags, while the other browsers will submit the content of the value 
attribute.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The value attribute specifies the initial value for a &lt;button&gt; in a &lt;form&gt;.</p>
<p><b>Note:</b> In a form, the button and its value is only submitted if the 
button itself was used to submit the form.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_button_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_button_value.asp#top" target="_top">TOP</a> |
		<a href="att_button_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
