...
<title>HTML canvas createImageData() Method</title>
<style>a.menu_canvas_createimagedata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">createImageData()</span> Method</h1>
...
<p>Create a 100*100 pixels ImageData object where every pixel is red, and put it 
onto the canvas:</p>
...
<div class="example_code notranslate">
	...
	var ctx=c.getContext(&quot;2d&quot;);<br>var imgData=ctx.createImageData(100,100);<br>for (var i=0;i&lt;imgData.data.length;i+=4)<br>&nbsp; {<br>&nbsp; 
	imgData.data[i+0]=255;<br>&nbsp; imgData.data[i+1]=0;<br>&nbsp; 
	imgData.data[i+2]=0;<br>&nbsp; imgData.data[i+3]=255;<br>&nbsp; }<br>
	ctx.putImageData(imgData,10,10);</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_createimagedata" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the createImageData() 
method.</p>
...
<p>The createImageData() method creates a new, blank ImageData object. The new 
object's pixel values are transparent black by default.</p>
<p>For every pixel in an ImageData object there are four pieces of information, the 
RGBA values:</p>
<p>R - The color red (from 0-255)<br>
G - The color green (from 0-255)<br>
B - The color blue (from 0-255)<br>
A - The alpha channel (from 0-255; 0 is transparent and 255 is fully visible)</p>
<p>So, transparent black indicates: (0,0,0,0).</p>
<p>The color/alpha information is held in an array, and since the array contains 4 pieces of 
information for every pixel, the array&#39;s size is 4 
times the size of the ImageData object: width*height*4. (An easier way to find 
the size of the array, is to use ImageDataObject.data.length)</p>
<p>The array containing the color/alpha information is stored in the 
<a href="canvas_imagedata_data.asp">data</a> property of the ImageData object.</p>
<p><b>Tip:</b> After you have manipulated the color/alpha information in the 
array, you can copy the image data back onto the canvas with the
<a href="canvas_putimagedata.asp">putImageData()</a> method.</p>
<p><b>Examples:</b></p>
<p>The syntax for making the first pixel in the ImageData object red:</p>
<div class="example_code notranslate">
...
<p>The syntax for making the second pixel in the ImageData object green:</p>
<div class="example_code notranslate">
imgData=ctx.createImageData(100,100);<br>
<br>
imgData.data[4]=0;<br>
...
<p>There are two versions of the createImageData() method:</p>
<p>1. This creates a new ImageData object with the specified dimensions (in 
pixels):</p>
<table class="tecspec">
	<tr>
...
<p>2. This creates a new ImageData object with the same dimensions as the object 
specified by anotherImageData (this does not copy the image data):</p>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>width</i></td>
		<td>The width of the new ImageData object, in pixels</td>
	</tr>
	<tr>
		<td><i>height</i></td>
		<td>The height of the new ImageData object, in pixels</td>
	</tr>
	<tr>
		<td><i>imageData</i></td>
		<td>anotherImageData object</td>
	</tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_createimagedata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_createimagedata.asp#top" target="_top">TOP</a> |
		<a href="canvas_createimagedata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
