...
<style>a.menu_tag_frame{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;frame&gt;</span> Tag. <span class="deprecated">Not Supported in HTML5.</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_frameset.asp">&lt;frameset&gt; Tag &raquo;</a></div>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>A simple three-framed page:</p>
<div class="example_code notranslate">
    &lt;frameset cols=&quot;25%,50%,25%&quot;&gt;<br>
&nbsp; &lt;frame src=&quot;frame_a.htm&quot;&gt;<br>
&nbsp; &lt;frame src=&quot;frame_b.htm&quot;&gt;<br>
&nbsp; &lt;frame src=&quot;frame_c.htm&quot;&gt;<br>
	&lt;/frameset&gt;
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_frame_cols" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;frame&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The &lt;frame&gt; tag is not supported in HTML5.</span></p>
<p>The &lt;frame&gt; tag defines one particular window (frame) within a &lt;frameset&gt;.</p>
<p>Each &lt;frame&gt; in a &lt;frameset&gt; can have different attributes, such as border, scrolling, the ability to resize, etc.</p>
<p><b>Note:</b> If you want to validate a page containing frames, be sure the 
<a href="tag_doctype.asp">&lt;!DOCTYPE&gt;</a> is set to either &quot;HTML Frameset DTD&quot; 
or &quot;XHTML Frameset DTD&quot;.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The &lt;frame&gt; tag is not supported in HTML5, but is supported in HTML 4.01.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In HTML, the &lt;frame&gt; tag has no end tag. In XHTML, the &lt;frame&gt; tag must be properly closed.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_frame_frameborder.asp">frameborder</a></td>
    <td>0<br>
      1</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies whether or not to display a border around a frame</td>
    </tr>
  <tr>
    <td><a href="att_frame_longdesc.asp">longdesc</a></td>
    <td><i>URL</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies a page that contains a long description of the 
	content of a frame</td>
  </tr>
  <tr>
    <td><a href="att_frame_marginheight.asp">marginheight</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the top and bottom margins of a frame</td>
  </tr>
  <tr>
    <td><a href="att_frame_marginwidth.asp">marginwidth</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the left and right margins of a frame</td>
  </tr>
    <tr>
    <td><a href="att_frame_name.asp">name</a></td>
    <td><i>text</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the name of a frame</td>
    </tr>
  <tr>
    <td><a href="att_frame_noresize.asp">noresize</a></td>
    <td>noresize</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies that a frame is not resizable</td>
  </tr>
  <tr>
    <td><a href="att_frame_scrolling.asp">scrolling</a></td>
    <td>yes<br>
      no<br>
      auto</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies whether or not to display scrollbars in a frame</td>
  </tr>
  <tr>
    <td><a href="att_frame_src.asp">src</a></td>
    <td><i>URL</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the URL of the document to show in a frame</td>
  </tr>
</table>
...
<p>The &lt;frame&gt; tag supports the following standard attributes in HTML 4.01:</p>
<table class="reference notranslate"> 
  <tr>
    <th style="width:20%">Attribute</th>
    <th style="width:20%">Value</th>
  ...
  <tr>
    <td>class</td>
    <td><i>classname</i></td>
    <td>Specifies a classname for an element</td>
  </tr>
  <tr>
    <td>id</td>
    <td><i>id</i></td>
...
<p>According to the W3C, the &lt;frame&gt; tag does not support any event attributes 
in HTML 4.01.</p>
<p>However, the onload event is supported in all browsers.</p>
...
How to make a horizontal frameset with three different documents.</p>

<p><a target="_blank" href="tryit.asp?filename=tryhtml_frame_mix">Mixed frameset</a><br>
How to make a frameset with three documents, and how to mix them in rows and columns. </p>

<p><a target="_blank" href="tryit.asp?filename=tryhtml_frame_noresize">Frameset 
with noresize=&quot;noresize&quot;</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_frame.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_frame.asp#top" target="_top">TOP</a> |
		<a href="tag_frame.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
