...
<title>HTML area coords Attribute</title>
<style>a.menu_att_area_coords{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;area&gt; <span class="color_h1">coords</span> Attribute</h1>
...
<p>The coords attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The coords attribute specifies the coordinates of an area in an 
image-map.</p>
<p>The coords attribute is used together with the <a href="att_area_shape.asp">shape</a> attribute to specify the size, shape, and placement of an area.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Specifies the coordinates of the left, top, right, bottom corner of the 
	rectangle (for shape=&quot;rect&quot;)</td>
  </tr>
	<tr>
    <td><i>x,y,radius</i></td>
    <td>Specifies the coordinates of the circle center and the radius (for 
	shape=&quot;circle&quot;)</td>
  </tr>
  <tr>
    <td><i>x1,y1,x2,y2,..,xn,yn</i></td>
    <td>Specifies the coordinates of the edges of the polygon. If the first and 
	last coordinate pairs are not the same, the browser will add the last 
	coordinate pair to close the polygon (for shape=&quot;poly&quot;)</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_area_coords.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_area_coords.asp#top" target="_top">TOP</a> |
		<a href="att_area_coords.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
