...
<style>a.menu_att_textarea_readonly{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;textarea&gt; <span class="color_h1">readonly</span> Attribute</h1>
<p><a href="tag_textarea.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML textarea Tag Reference" /> HTML &lt;textarea&gt; tag</a></p>
<div class="example">


<h2 class="example">Example</h2>
<p>A read-only text area:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_textarea_readonly">Try it yourself &raquo;</a>
...
<p>The readonly attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The readonly attribute is a boolean attribute.</p>
<p>When present, it specifies that a text area should be read-only.</p>
<p>In a read-only text area, the content cannot be changed, but a user can tab 
to it, highlight it and copy content from it.</p>
<p>The readonly attribute can be set to keep a user from using a text area until 
some other condition has been met (like selecting a checkbox, etc.). Then, a 
JavaScript is required to remove the readonly value, and make the text area 
editable.</p>
<hr>
...
<p>In XHTML, attribute minimization is forbidden, and the readonly attribute must 
be defined as &lt;textarea readonly=&quot;readonly&quot;&gt;. </p>
<hr>
...
<br>
<hr>
<a href="tag_textarea.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML textarea Tag Reference" /> HTML &lt;textarea&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_textarea_readonly.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_textarea_readonly.asp#top" target="_top">TOP</a> |
		<a href="att_textarea_readonly.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
