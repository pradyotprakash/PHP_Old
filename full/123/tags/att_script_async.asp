...
<title>HTML script async Attribute</title>
<style>a.menu_att_script_async{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;script&gt; <span class="color_h1">async</span> Attribute</h1>
<p><a href="tag_script.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML script Tag Reference" /> HTML &lt;script&gt; tag</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>A script that will be run asynchronously as soon as it is available:</p>
<div class="example_code notranslate">
    &lt;script src=&quot;demo_async.js&quot; async&gt;&lt;/script&gt;
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_script_async" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The async attribute is supported in Internet Explorer 10, Firefox, Opera, Chrome, and Safari.</p>
...
<p>The async attribute is a boolean attribute.</p>
<p>When present, it specifies that the script will be executed asynchronously as soon as it is available.</p>
<p><b>Note:</b> The async attribute is only for external scripts (and should only be used if the src attribute is present).</p>
<p><b>Note:</b> There are several ways an external script can be executed:</p>
<ul>
	<li>If async is present: The script is executed asynchronously with 
	the rest of the page (the script will be executed while the page continues the parsing)</li>
	...
	before the browser continues parsing the page</li>
</ul>
<hr>
...
<p>In XHTML, attribute minimization is forbidden, and the async attribute must 
be defined as &lt;script async=&quot;async&quot;&gt;. </p>
<hr>
...
<br>
<hr>
<a href="tag_script.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML script Tag Reference" /> HTML &lt;script&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_script_async.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_script_async.asp#top" target="_top">TOP</a> |
		<a href="att_script_async.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
