...
<title>HTML ins cite Attribute</title>
<style>a.menu_att_ins_cite{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;ins&gt; <span class="color_h1">cite</span> Attribute</h1>
<p><a href="tag_ins.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML ins Tag Reference" /> HTML &lt;ins&gt; tag</a></p>
<div class="example">


<h2 class="example">Example</h2>
<p>An inserted text, with a URL to a document that explains why the text was 
inserted:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_ins_cite" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The cite attribute has no visual effect in ordinary web browsers, but can be 
used by screen readers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The cite attribute specifies a URL to a document that explains the reason why 
the text was inserted/changed.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>URL</i></td>
    <td>Specifies the address to the document that explains why the text was 
	inserted/changed.<p>Possible values:</p>
<ul>
	<li>An absolute URL - Points to another web site (like cite=&quot;http://www.example.com&quot;)</li>
	<li>A relative URL - Points to a page within a web site (like cite=&quot;example.html&quot;)</li>
</ul>
	</td>
  </tr>
  </table>
<br>
<hr>
<a href="tag_ins.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML ins Tag Reference" /> HTML &lt;ins&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_ins_cite.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_ins_cite.asp#top" target="_top">TOP</a> |
		<a href="att_ins_cite.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
