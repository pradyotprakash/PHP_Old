...
<title>HTML form autocomplete Attribute</title>
<style>a.menu_att_form_autocomplete{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;form&gt; <span class="color_h1">autocomplete</span> Attribute</h1>
...
<p>A form with autocomplete on:</p>
<div class="example_code notranslate">
    &lt;form action=&quot;demo_form.asp&quot; method=&quot;get&quot; autocomplete=&quot;on&quot;&gt;<br>
	&nbsp;
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_form_autocomplete" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The autocomplete attribute is supported in all major browsers, except Opera.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The autocomplete attribute specifies whether a form should have autocomplete on or off.</p>
...
<p>The autocomplete attribute is new in HTML5.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		<td>on</td>
		<td>Default. The browser will automatically complete values based on values that the user has entered before</td>
	</tr>
	<tr>
		<td>off</td>
		<td>The user must enter a value into each field for every use. The browser does not automatically complete entries</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_form_autocomplete.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_form_autocomplete.asp#top" target="_top">TOP</a> |
		<a href="att_form_autocomplete.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
