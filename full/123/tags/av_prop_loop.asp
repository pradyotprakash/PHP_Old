...
<title>HTML Audio/Video DOM loop Property</title>
<style>a.menu_av_prop_loop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">loop</span> Property</h1>
...
<div class="example_code notranslate">
	...
	myVid.loop=true;</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_loop" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The loop property sets or returns if the audio/video should start playing 
over again when it is finished.</p>
<hr>
...
<p>The loop property is supported in all major browsers.</p>
...
<div class="code notranslate"><div>
	<em>audio|video</em>.loop=true|false
</div></div>
<p>Return the loop property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.loop</div></div>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>true</td>
    <td>Indicates that the audio/video should start playing again when it is 
	finished</td>
    </tr>
  <tr>
    <td>false</td>
    <td>Default. Indicates that the audio/video should NOT start playing again when it is 
	finished</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_loop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_loop.asp#top" target="_top">TOP</a> |
		<a href="av_prop_loop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
