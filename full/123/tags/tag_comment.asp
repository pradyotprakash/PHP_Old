...
<style>a.menu_tag_comment{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="tag_doctype.asp">&lt;!DOCTYPE&gt; Declaration &raquo;</a></div>
</div>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_comment" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The comment tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The comment tag is used to insert comments in the source code. Comments are 
not displayed in the browsers.</p>
<p>You can use comments to explain your
code, which can help you when you edit the source code at a later date. This is 
especially useful if you have a lot of code.</p>
<p>It is also a good practice to use the comment tag to &quot;hide&quot; scripts from 
browsers without support for it (so they don't show them as plain text):</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_comment.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_comment.asp#top" target="_top">TOP</a> |
		<a href="tag_comment.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
