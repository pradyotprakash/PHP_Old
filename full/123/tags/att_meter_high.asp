...
<title>HTML meter high Attribute</title>
<style>a.menu_att_meter_high{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;meter&gt; <span class="color_h1">high</span> Attribute</h1>
...
<p>The high attribute of the &lt;meter&gt; tag is supported in Firefox, Opera, Chrome, and Safari 6.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The high attribute specifies the range where the gauge's value is considered to be a high value.</p>
<p>The high attribute value must be less than the max attribute value, and it 
also must be greater than the low and min attribute values.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>number</i></td>
		<td>Specifies a floating point number that is considered to be a high value</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_meter_high.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_meter_high.asp#top" target="_top">TOP</a> |
		<a href="att_meter_high.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
