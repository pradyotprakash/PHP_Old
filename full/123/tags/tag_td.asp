...
<style>a.menu_tag_td{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;td&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_textarea.asp">&lt;textarea&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>A simple HTML table, with two table cells:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_td">Try it yourself &raquo;</a>
...
<p>The &lt;td&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;td&gt; tag defines a standard cell in an HTML table.</p>
<p>An HTML table has two kinds of cells:</p>
<ul>
	<li>Header cells - contains header information (created with the
	<a href="tag_th.asp">&lt;th&gt;</a> element)</li>
	<li>Standard cells - contains data (created with the &lt;td&gt; element)</li>
</ul>
<p>The text in &lt;th&gt; elements are bold and centered by default.</p>
<p>The text in &lt;td&gt; elements are regular and left-aligned by default.</p>
<hr>

<h2>Tips and Notes</h2>
<p><b>Tip:</b> Use the colspan and rowspan attribute to let the content span over multiple columns or rows!</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>Some HTML 4.01 attributes are not 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_td_abbr.asp">abbr</a></td>
    <td><i>text</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies an abbreviated version of the content in a cell</td>
  </tr>
  <tr>
    <td><a href="att_td_align.asp">align</a></td>
    <td>left<br>
      right<br>
      center<br>
      justify<br>
      char</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Aligns the 
content in a cell</td>
  </tr>
  <tr>
    <td><a href="att_td_axis.asp">axis</a></td>
    <td><i>category_name</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Categorizes cells</td>
  </tr>
  <tr>
    <td><a href="att_td_bgcolor.asp">bgcolor</a></td>
    <td><i>rgb(x,x,x)<br>
    #xxxxxx<br>
    colorname</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
	Specifies the background color of a cell</td>
  </tr>
  <tr>
    <td><a href="att_td_char.asp">char</a></td>
    <td><i>character</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Aligns the content in a cell to a character</td>
  </tr>
  <tr>
    <td><a href="att_td_charoff.asp">charoff</a></td>
    <td><i>number</i>&nbsp;</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Sets the number of characters the content will be aligned 
	from the character specified by the char attribute</td>
  </tr>
  <tr>
    <td><a href="att_td_colspan.asp">colspan</a></td>
    <td><i>number</i></td>
    <td>Specifies the number of columns a cell should span</td>
  </tr>
  <tr>
    <td><a href="att_td_headers.asp">headers</a></td>
    <td><i>header_id</i></td>
    <td>Specifies one or more header cells a cell is related to</td>
  </tr>
  <tr>
    <td><a href="att_td_height.asp">height</a></td>
    <td><i>pixels<br>
    %</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
	Sets the height of a cell</td>
  </tr>
    <tr>
    <td><a href="att_td_nowrap.asp">nowrap</a></td>
    <td>nowrap</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
	Specifies that the content inside a cell should not wrap</td>
    </tr>
  <tr>
    <td><a href="att_td_rowspan.asp">rowspan</a></td>
    <td><i>number</i></td>
    <td>Sets the number of rows a cell should span</td>
  </tr>
  <tr>
    <td><a href="att_td_scope.asp">scope</a></td>
    <td>col<br>
      colgroup<br>
      row<br>
      rowgroup</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Defines a way to associate header cells and data cells in a 
	table</td>
  </tr>
    <tr>
    <td><a href="att_td_valign.asp">valign</a></td>
    <td>top<br>
      middle<br>
      bottom<br>
      baseline</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Vertical aligns the 
content in a cell</td>
    </tr>
    <tr>
    <td><a href="att_td_width.asp">width</a></td>
    <td><i>pixels<br>
    %</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
	Specifies the width of a cell</td>
    </tr>
</table>
<br>
<hr>
...
<p>The &lt;td&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;td&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryhtml_table_header">Table headers</a><br>
How to create table headers.</p>
<p>
<a target="_blank" href="tryit.asp?filename=tryhtml_caption_test">Table with a caption</a><br>
An HTML table with a caption.</p>
<p>
...
<p>
<a href="tryit.asp?filename=tryhtml_table_span">C</a><a target="_blank" href="tryit.asp?filename=tryhtml_table_span">ells that span more than one row/column</a><br>
...
<a href="../jsref/dom_obj_tabledata.asp">Td object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_textarea.asp">&lt;textarea&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_td.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_td.asp#top" target="_top">TOP</a> |
		<a href="tag_td.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
