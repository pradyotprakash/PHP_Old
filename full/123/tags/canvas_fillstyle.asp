...
<title>HTML canvas fillStyle Property</title>
<style>a.menu_canvas_fillstyle{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">fillStyle</span> Property</h1>
...
<p>Define a red fill-color for the rectangle:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_fillstyle" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the fillStyle 
property.</p>
...
<p>The fillStyle property sets or returns the color, gradient, or pattern used to 
fill the drawing.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.fillStyle=<i>color</i>|<i>gradient</i>|<i>pattern</i>;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>color</i></td>
		<td>A <a href="../cssref/css_colors_legal.asp">CSS color value</a> that indicates the fill color of the drawing. Default value is #000000</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_fillstyle">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td><i>gradient</i></td>
		<td>A gradient object (<a href="canvas_createlineargradient.asp">linear</a> 
		or <a href="canvas_createradialgradient.asp">radial</a>) used to fill the drawing</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td><i>pattern</i></td>
		<td>A <a href="canvas_createpattern.asp">pattern</a> object to use to fill the drawing</td>
		<td>&nbsp;</td>
	</tr>
</table>
<br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Define a gradient (top to bottom) as the fill style for the rectangle:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_fillstyle_gradient" target="_blank">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Define a gradient (left to right) as the fill style for the rectangle:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_fillstyle_gradient2" target="_blank">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Define a gradient that goes from black, to red, to white, as the fill style for the rectangle:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_fillstyle_gradient3" target="_blank">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Image to use:</h2>
<p><img src="img_lamp.jpg" id="lamp" alt="Lamp" /></p>
<h2 class="example">Example</h2>
<p>Use an image to fill the drawing:</p>
<canvas id="myCanvas5" width="300" height="150" style="border:1px solid #d3d3d3;background:#ffffff;">
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_createpattern" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_fillstyle.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_fillstyle.asp#top" target="_top">TOP</a> |
		<a href="canvas_fillstyle.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
