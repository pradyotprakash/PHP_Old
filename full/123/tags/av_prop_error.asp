...
<title>HTML Audio/Video DOM error Property</title>
<style>a.menu_av_prop_error{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">error</span> Property</h1>
...
<p>Get the error state of the video:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>alert(myVid.error.code);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_error" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The error property returns a MediaError object.</p>
<p>The MediaError object has a code property containing the error state of the audio/video.</p>
<hr>
...
<p>The error property is only supported in Internet Explorer 9.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate">
	<div>
		<em>audio|video</em>.error.code</div></div>
<h2>Return Value</h2>
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>Number</td>
    <td>The code property of the MediaError Object returns a number representing the error state of the audio/video:<ul><li>1 
		= MEDIA_ERR_ABORTED - fetching process aborted by user</li>
		<li>2 = MEDIA_ERR_NETWORK - error occurred when downloading</li>
		<li>3 = MEDIA_ERR_DECODE - error occurred when decoding</li>
		<li>4 = MEDIA_ERR_SRC_NOT_SUPPORTED - audio/video not supported</li></ul>
		</td>
    </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_error.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_error.asp#top" target="_top">TOP</a> |
		<a href="av_prop_error.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
