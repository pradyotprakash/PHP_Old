...
<title>HTML html manifest Attribute</title>
<style>a.menu_att_html_manifest{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;html&gt; <span class="color_h1">manifest</span> Attribute</h1>
<p><a href="tag_html.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML html Tag Reference" /> HTML &lt;html&gt; tag</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>A HTML document with a cache manifest (for offline browsing):</p>
<div class="example_code notranslate">
    &lt;!DOCTYPE HTML&gt;<br>
    &lt;html manifest=&quot;demo<span name="KonaFilter">.appcache</span>&quot;&gt;<br>
	&lt;head&gt;<br>
	...
	&lt;/html&gt;</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_html_manifest" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The manifest attribute is supported in Internet Explorer 10, Firefox, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> Internet Explorer 9 and earlier versions, do not support the manifest attribute.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The manifest attribute specifies the location of the document's cache manifest.</p>
<p>HTML5 introduces application cache, which means that a web application is 
cached, and accessible without an internet connection.</p>
...
<p>The manifest file is a simple text file that lists the resources the browser should cache for offline access.</p>
<p>To learn more about how to create the manifest file, please read our
<a href="../html/html5_app_cache.asp">HTML5 Application Cache</a> chapter.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The manifest attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
		&lt;html manifest=&quot;<i>URL</i>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>URL</em></td>
		<td>The address of the document's cache manifest.<p>Possible values:</p>
<ul>
	<li>An absolute URL - points to another web site (like href=&quot;http://www.example.com/demo.appcache&quot;)</li>
	<li>A relative URL - points to a file within a web site (like href=&quot;demo.appcache&quot;)</li>
</ul>
...
<br>
<hr>
<a href="tag_html.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML html Tag Reference" /> HTML &lt;html&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_html_manifest.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_html_manifest.asp#top" target="_top">TOP</a> |
		<a href="att_html_manifest.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
