...
<title>HTML track label Attribute</title>
<style>a.menu_att_track_label{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;track&gt; <span class="color_h1">label</span> Attribute</h1>
...
<p>A video with two subtitle tracks, both with a label defined:</p>
...
<p>The label attribute is supported in Internet Explorer 10, Opera, and Chrome.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The label attribute specifies the title of the text track.</p>
<p>The title of the text track is used by the browser when listing available text tracks.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_track_label.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_track_label.asp#top" target="_top">TOP</a> |
		<a href="att_track_label.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
