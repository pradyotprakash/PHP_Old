...
<title>HTML Audio/Video DOM canplaythrough Event</title>
<style>a.menu_av_event_canplaythrough{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">canplaythrough</span> Event</h1>
...
<p>Alert that the video can be played all the way through, without stopping:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.oncanplaythrough=alert(&quot;Can 
	play through video without stopping&quot;);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_canplaythrough" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The canplaythrough event occurs when the browser estimates it can play through the 
specified audio/video 
without having to stop for buffering.</p>
...
<p>The canplaythrough event is supported in all major browsers.</p>
...
<div class="code notranslate"><div>
	<em>&lt;audio|video</em> oncanplaythrough="<em>SomeJavaScriptCode</em>"&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.oncanplaythrough=<em>SomeJavaScriptCode</em>;</div></div>
<p>Using addEventListener():</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;canplaythrough&quot;, function()<br>&nbsp; {<br>&nbsp; <em>
...
<p><a href="tryit.asp?filename=tryhtml5_av_event_canplaythrough_html" target="_blank">Use the oncanplaythrough attribute on an HTML element</a></p>
<p><a href="tryit.asp?filename=tryhtml5_av_event_canplaythrough_el" target="_blank">Use addEventListener() to listen for the canplaythrough event</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_event_canplaythrough.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_event_canplaythrough.asp#top" target="_top">TOP</a> |
		<a href="av_event_canplaythrough.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
