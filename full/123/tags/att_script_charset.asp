...
<title>HTML script charset Attribute</title>
<style>a.menu_att_script_charset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;script&gt; <span class="color_h1">charset</span> Attribute</h1>
...
<p>An external JavaScript with an UTF-8 character set:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_script_charset" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The charset attribute specifies the character encoding used in an external script file.</p>
<p>The charset attribute is used when the character encoding in an external script file differs from the encoding in the 
HTML document.</p>

<hr>

<h2>Tips and Notes</h2>
<p><b>Note:</b> The charset attribute is only for external scripts (can only be 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>charset</i></td>
    <td>Specifies the character encoding of an external script file.
    <p>Some common values:</p>
<ul>
	<li>&quot;ISO-8859-1&quot; - Standard encoding for the Latin alphabet</li>
	<li>&quot;UTF-8&quot; - Character encoding for Unicode. Compatible with ASCII</li>
</ul>
	<p>Look at our <a target="_blank" href="ref_charactersets.asp">Character-sets reference</a> 
	for a complete list of character sets.</p>
	</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_script_charset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_script_charset.asp#top" target="_top">TOP</a> |
		<a href="att_script_charset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
