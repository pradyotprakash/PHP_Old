...
<title>HTML map name Attribute</title>
<style>a.menu_att_map_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;map&gt; <span class="color_h1">name</span> Attribute</h1>
<p><a href="tag_map.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML map Tag Reference" /> HTML &lt;map&gt; tag</a></p>
<div class="example">
...
<p>The required name attribute specifies the name of an image-map.</p>
<p>The name attribute is associated with the &lt;img&gt;'s usemap attribute and creates a relationship between the image and the map.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>mapname</i></td>
    <td>The name of the image-map</td>
  </tr>
  </table>
<br>
<hr>
<a href="tag_map.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML map Tag Reference" /> HTML &lt;map&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_map_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_map_name.asp#top" target="_top">TOP</a> |
		<a href="att_map_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
