...
<style>a.menu_tag_col{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;col&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_colgroup.asp">&lt;colgroup&gt; Tag &raquo;</a></div>
</div>
<br>
...
&nbsp; &lt;/tr&gt;<br>
	&lt;/table&gt;</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_col_test" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;col&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;col&gt; tag specifies column properties for each column within a 
<a href="tag_colgroup.asp">&lt;colgroup&gt;</a> element.</p>
<p>The &lt;col&gt; tag is useful for applying styles to entire columns, instead of repeating the styles for each cell, for each row.</p>
<hr>
...
<p>In HTML the &lt;col&gt; tag has no end tag.</p>
<p>In XHTML, the &lt;col&gt; tag must be properly closed.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_col_align.asp">align</a></td>
    <td>left<br>
      right<br>
      center<br>
      justify<br>
      char</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the alignment of the content related to a &lt;col&gt; element</td>
  </tr>
  <tr>
    <td><a href="att_col_char.asp">char</a></td>
    <td><i>character</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the alignment of the content related to a &lt;col&gt; element to a character</td>
  </tr>
  <tr>
    <td><a href="att_col_charoff.asp">charoff</a></td>
    <td><i>number</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the number of characters the content will be aligned 
	from the character specified by the char attribute</td>
  </tr>
  <tr>
    <td><a href="att_col_span.asp">span</a></td>
    <td><i>number</i></td>
    <td>Specifies the number of columns a &lt;col&gt; element should span</td>
  </tr>
  <tr>
    <td><a href="att_col_valign.asp">valign</a></td>
    <td>top<br>
      middle<br>
      bottom<br>
      baseline</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the vertical alignment of the content related to a &lt;col&gt; element</td>
  </tr>
  <tr>
    <td><a href="att_col_width.asp">width</a></td>
    <td><i>%<br>
      pixels<br>
      relative_length</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the width of a &lt;col&gt; element</td>
  </tr>
</table>
<br>
<hr>
...
<p>The &lt;col&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;col&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_colgroup.asp">&lt;colgroup&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_col.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_col.asp#top" target="_top">TOP</a> |
		<a href="tag_col.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
