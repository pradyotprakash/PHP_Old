...
<style>a.menu_tag_audio{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;audio&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_b.asp">&lt;b&gt; Tag &raquo;</a></div>
</div><br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_audio" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;audio&gt; tag is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;audio&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;audio&gt; tag defines sound, such as music or other audio streams.</p>
<p>Currently, there are 3 supported file formats for the &lt;audio&gt; element: MP3, Wav, and Ogg:</p>
...
Windows Vista, and Android now supports MP3</td>
<td>YES</td>
<td>YES</td>
</tr>
<tr>
...
<br>
<hr><h2>MIME Types for Audio Formats</h2>
...
<p>The &lt;audio&gt; tag is new in HTML5.</p>
<hr>

<h2>Tips and Notes</h2>
<p><b>Tip:</b> Any text inside the between &lt;audio&gt; and &lt;/audio&gt; will be displayed in browsers that do not support 
the &lt;audio&gt; tag.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_audio_autoplay.asp">autoplay</a><span class="new">New</span></td>
    <td>autoplay</td>
    <td>Specifies that the audio will start playing as soon as it is ready</td>
  </tr>
    <tr>
    <td><a href="att_audio_controls.asp">controls</a><span class="new">New</span></td>
    <td>controls</td>
    <td>Specifies that audio controls should be displayed (such as a play/pause 
	button etc). </td>
    </tr>
  <tr>
    <td><a href="att_audio_loop.asp">loop</a><span class="new">New</span></td>
    <td>loop</td>
    <td>Specifies that the audio will start over again, every time it 
	is finished</td>
  </tr>
    <tr>
    <td><a href="att_audio_muted.asp">muted</a><span class="new">New</span></td>
    <td>muted</td>
    <td>Specifies that the audio output should be muted</td>
    </tr>
  <tr>
    <td><a href="att_audio_preload.asp">preload</a><span class="new">New</span></td>
    <td>auto<br>
	metadata<br>
	none</td>
  ...
  <tr>
    <td><a href="att_audio_src.asp">src</a><span class="new">New</span></td>
    <td><i>URL</i></td>
    <td>
	Specifies the URL of the audio file</td>
  </tr>
</table>
      
<h2>Global Attributes</h2>
<p>The &lt;audio&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;audio&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_b.asp">&lt;b&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_audio.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_audio.asp#top" target="_top">TOP</a> |
		<a href="tag_audio.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
