...
<style>a.menu_att_button_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;button&gt; <span class="color_h1">disabled</span> Attribute</h1>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_button_disabled" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>When present, it specifies that the button should be disabled.</p>
<p>A disabled button is unusable and un-clickable.</p>
<p>The disabled attribute can be set to keep a user from clicking on the button 
until some other condition has been met (like selecting a checkbox, etc.). Then, 
a JavaScript could remove the disabled value, and make the button usable.</p>
<hr>
...
be defined as &lt;button disabled=&quot;disabled&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_button_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_button_disabled.asp#top" target="_top">TOP</a> |
		<a href="att_button_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
