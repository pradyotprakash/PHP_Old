...
<title>HTML Audio/Video DOM videoTracks Property</title>
<style>a.menu_av_prop_videotracks{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">videoTracks</span> Property</h1>
<p><a href="ref_av_dom.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML audio Tag Reference" /> HTML Audio/Video DOM Reference</a></p>
<div class="example">


<h2 class="example">Example</h2>
<p>Get the number of available video tracks:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>alert(myVid.videoTracks.length);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_videotracks" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The videoTracks property returns a VideoTrackList object.</p>
<p>The VideoTrackList object represents the available video tracks for the video.</p>
<p>Each available video track is represented by an VideoTrack Object.</p>
<hr>
...
<p>The videoTracks property is not supported in any major browser.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate">
	<div>
		<em>video</em>.videoTracks</div></div>
<h2>Return Value</h2>
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>VideoTrackList Object</td>
    <td>Represents the available video tracks for the video.<p>
	VideoTrackList Object:</p>
	<ul>
		<li>videoTracks.length - get the number of video tracks available in the video</li>
		<li>videoTracks.getTrackById(<em>id</em>) - get VideoTrack object by id</li>
		<li>videoTracks[<em>index</em>] - get VideoTrack object by index</li>
		<li>videoTracks.selectedIndex - get the index of the current VideoTrack 
		object</li>
	</ul>
	<p><strong>Note: </strong>The first available VideoTrack object is <em>index</em> 0</p>
		</td>
    </tr>
    <tr>
    <td>VideoTrack Object</td>
    <td>Represents a video track.<p>VideoTrack Object Properties:</p>
	<ul>
		<li>id - get the id of the video track</li>
		<li>kind - get the type of the video track (can be: &quot;alternative&quot;, 
		&quot;captions&quot;, &quot;main&quot;, &quot;sign&quot;, &quot;subtitles&quot;, &quot;commentary&quot;, or &quot;&quot; (empty 
		string))&nbsp; </li>
		<li>label - get the label of the video track</li>
		<li>language - get the language of the video track</li>
		<li>selected - get or set if the track is active (true|false)</li>
	</ul>
		</td>
    </tr>
  </table>
...
<hr>
<a href="ref_av_dom.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML audio Tag Reference" /> HTML Audio/Video DOM Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_videotracks.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_videotracks.asp#top" target="_top">TOP</a> |
		<a href="av_prop_videotracks.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
