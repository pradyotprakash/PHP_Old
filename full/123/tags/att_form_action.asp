...
<title>HTML form action Attribute</title>
<style>a.menu_att_form_action{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;form&gt; <span class="color_h1">action</span> Attribute</h1>
...
<p>On submit, send the form-data to a file named &quot;demo_form.asp&quot; (to process 
the input):</p>
...
<p>The action attribute is supported in all major browsers.</p>
<hr>
...
<p>In HTML5, the action attribute is no longer required.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>URL</i></td>
    <td>Where to send the form-data when the form is submitted.<p>
	Possible values:</p>
	<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_form_action.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_form_action.asp#top" target="_top">TOP</a> |
		<a href="att_form_action.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
