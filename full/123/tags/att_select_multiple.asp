...
<title>HTML select multiple Attribute</title>
<style>a.menu_att_select_multiple{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;select&gt; <span class="color_h1">multiple</span> Attribute</h1>
...
<p>A drop-down list that allows multiple selections:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_select_multiple" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The multiple attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The multiple attribute is a boolean attribute.</p>
<p>When present, it specifies that multiple options can be selected at 
once.</p>
<p>Selecting multiple options vary in different operating systems and browsers:</p>
<ul>
	<li>For windows: Hold down the control (ctrl) button to select multiple 
	options</li>
	<li>For Mac: Hold down the command button to select multiple options</li>
</ul>
<p>Because of the different ways of doing this, and because you have to inform 
the user that multiple selection is available, it is more user-friendly to use 
checkboxes instead.</p>
<hr>
...
<p>In XHTML, attribute minimization is forbidden, and the multiple attribute must 
be defined as &lt;select multiple=&quot;multiple&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_select_multiple.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_select_multiple.asp#top" target="_top">TOP</a> |
		<a href="att_select_multiple.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
