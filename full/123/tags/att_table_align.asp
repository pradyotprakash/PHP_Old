...
<style>a.menu_att_table_align{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;table&gt; <span class="color_h1">align</span> Attribute</h1>
...
<p>A right-aligned HTML table:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_table_align" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The align attribute specifies the alignment of a table according to surrounding text.</p>
<p>Normally, an HTML table will have a break before and after it. The align attribute allows other HTML elements to wrap around the table.</p>
<hr>

<h2>Compatibility Notes</h2>
<p><span class="deprecated">The align attribute of &lt;table&gt; is not supported in HTML5. Use CSS instead.</span></p>
<p>CSS syntax: &lt;table style=&quot;float:right&quot;&gt;</p>
<p><a target="_blank" href="tryit.asp?filename=tryhtml_table_align_css">CSS Example: table alignment</a></p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>left</td>
    <td>Left-aligns the table</td>
  </tr>
  <tr>
    <td>right</td>
    <td>Right-aligns the table</td>
  </tr>
	<tr>
    <td>center</td>
    <td>Center-aligns the table</td>
  </tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_table_align.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_table_align.asp#top" target="_top">TOP</a> |
		<a href="att_table_align.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
