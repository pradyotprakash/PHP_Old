...
<title>HTML input placeholder Attribute</title>
<style>a.menu_att_input_placeholder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">placeholder</span> Attribute</h1>
...
<p>Two input fields with a placeholder text:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_input_placeholder" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
of an input field (e.g. a sample value or a short description of the expected format).</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_placeholder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_placeholder.asp#top" target="_top">TOP</a> |
		<a href="att_input_placeholder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
