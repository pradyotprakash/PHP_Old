...
<title>HTML canvas strokeText() Method</title>
<style>a.menu_canvas_stroketext{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">strokeText()</span> Method</h1>
...
<p>Write "Hello world!" and &quot;Big smile!&quot; (with gradient) on the canvas, using strokeText():</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_stroketext" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the strokeText() 
method.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the 
&lt;canvas&gt; element.</p>

<p><b>Note:</b> The maxWidth parameter is not supported in Safari.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The strokeText() method draws text (with no fill) on the canvas. The 
default color of the text is black.</p>
<p><b>Tip:</b> Use the <a href="canvas_font.asp">font</a> property to specify 
font and font size, and use the <a href="canvas_strokestyle.asp">strokeStyle</a> 
property to render the text in another color/gradient.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.strokeText(<i>text,x,y,maxWidth</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>text</i></td>
		<td>Specifies the text that will be written on the canvas</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_stroketexttext">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>x</i></td>
		<td>The x coordinate where to start painting the text (relative to the 
		canvas)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_stroketextx">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y coordinate where to start painting the text (relative to the 
		canvas)</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_stroketexty">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td><i>maxWidth</i></td>
		<td>Optional. The maximum allowed width of the text, in pixels</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_stroketextmaxwidth">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_stroketext.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_stroketext.asp#top" target="_top">TOP</a> |
		<a href="canvas_stroketext.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
