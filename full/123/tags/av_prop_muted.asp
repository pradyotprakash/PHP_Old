...
<style>a.menu_av_prop_muted{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
	...
	myVid.muted=true;</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_muted" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The muted property sets or returns if the audio/video should be muted (sound 
turned off).</p>
<hr>
...
<p>The muted property is supported in all major browsers.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_muted.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_muted.asp#top" target="_top">TOP</a> |
		<a href="av_prop_muted.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
