...
<title>HTML tfoot valign Attribute</title>
<style>a.menu_att_tfoot_valign{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;tfoot&gt; <span class="color_h1">valign</span> Attribute</h1>
...
<p>Vertical align the content inside the &lt;tfoot&gt; element to 
the bottom:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_tfoot_valign" class="tryitbtn">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The &lt;tfoot&gt; valign attribute is not supported in HTML5. Use CSS instead.</span></p>
<p>The valign attribute specifies the vertical alignment of the content in a &lt;tfoot&gt; element.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_tfoot_valign.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_tfoot_valign.asp#top" target="_top">TOP</a> |
		<a href="att_tfoot_valign.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
