...
<title>HTML Global data-* Attributes</title>
<style>a.menu_att_global_data{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">data-*</span> Attributes</h1>
...
<p>Use the data-* attribute to embed custom data:</p>
<div class="example_code notranslate">
	
		&lt;ul&gt;<br>&lt;li data-animal-type=&quot;bird&quot;&gt;Owl&lt;/li&gt;<br>&lt;li 
		data-animal-type=&quot;fish&quot;&gt;Salmon&lt;/li&gt; <br>&lt;li 
		data-animal-type=&quot;spider&quot;&gt;Tarantula&lt;/li&gt; <br>&lt;/ul&gt;
	
</div>
<br>
	<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_global_data" target="_blank">Try it yourself &raquo;</a>
...
<p>The data-* attributes are supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The data-* attributes is used to store custom data private to the page or 
application.</p>
<p>The data-* attributes gives us the ability to embed custom data attributes on 
all HTML elements.</p>
<p>The stored (custom) data can then be used in the page's JavaScript to create 
a more engaging user experience (without any Ajax calls or server-side database 
queries).</p>
<p>The data-* attributes consist of two parts:</p>
<ol>
	<li>The attribute name should not contain any uppercase letters, and must be at least one character long 
	after the prefix &quot;data-&quot;</li>
	<li>The attribute value can be any string</li>
</ol>
<p><strong>Note:</strong> Custom attributes prefixed with &quot;data-&quot; will be 
completely ignored by the user agent.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>The data-* attributes are new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	
		&lt;<i>element</i> data-*=&quot;<em>somevalue</em>&quot;&gt;
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>somevalue</em></td>
		<td>Specifies the value of the attribute (as a string)</td>
	</tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_global_data.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_global_data.asp#top" target="_top">TOP</a> |
		<a href="att_global_data.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
