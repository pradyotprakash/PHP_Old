...
<title>HTML tr valign Attribute</title>
<style>a.menu_att_tr_valign{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;tr&gt; <span class="color_h1">valign</span> Attribute</h1>
...
<p>An HTML table with different vertical-aligned rows:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_tr_valign" class="tryitbtn">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The &lt;tr&gt; valign attribute is not supported in HTML5. Use CSS instead.</span></p>
<p>The valign attribute specifies the vertical alignment of the content in a table row.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_tr_valign.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_tr_valign.asp#top" target="_top">TOP</a> |
		<a href="att_tr_valign.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
