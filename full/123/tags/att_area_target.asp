...
<title>HTML area target Attribute</title>
<style>a.menu_att_area_target{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;area&gt; <span class="color_h1">target</span> Attribute</h1>
...
<p>An image-map, with clickable areas, and a target attribute:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_areamap_target" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>Frames and 
framesets are no longer supported. The _parent, _top and <i>framename</i> 
attribute values are mostly used with iframes.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;area target=&quot;_blank|_self|_parent|_top|<i>framename</i>&quot;&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_area_target.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_area_target.asp#top" target="_top">TOP</a> |
		<a href="att_area_target.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
