...
<title>HTML Audio/Video DOM seekable Property</title>
<style>a.menu_av_prop_seekable{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">seekable</span> Property</h1>
...
<p>Get the first seekable range (part) of the video in seconds:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>alert(&quot;Start: &quot; + 
	myVid.seekable.start(0)<br>+ &quot; End: &quot; + myVid.seekable.end(0));</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_seekable" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The seekable property returns a TimeRanges object.</p>
<p>The TimeRanges object represents ranges of the audio/video that are available 
for seeking for user.</p>
<p>A seekable range is a time-range of audio/video where the user can seek (move 
playback position) to.</p>
<p>For non-streaming videos it is often possible to seek anywhere in the video 
even before it has been buffered.</p>
<hr>
...
<p>The seekable property is supported in all major browsers.</p>
...
<div class="code notranslate">
	<div>
		<em>audio|video</em>.seekable</div></div>
<h2>Return Value</h2>
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>TimeRanges Object</td>
    <td>Represents the seekable parts of the audio/video.<p>TimeRanges Object 
	Properties:</p>
	<ul>
		<li>length - get the number of seekable ranges in the audio/video</li>
		<li>start(<em>index</em>) - get the start position of a seekable range</li>
		<li>end(<em>index</em>) - get the end position of a seekable range</li>
	</ul>
	<p><strong>Note: </strong>The first seekable range is <em>index</em> 0</p>
		</td>
    </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_seekable.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_seekable.asp#top" target="_top">TOP</a> |
		<a href="av_prop_seekable.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
