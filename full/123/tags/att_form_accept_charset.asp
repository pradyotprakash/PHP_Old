...
<title>HTML form accept-charset Attribute</title>
<style>a.menu_att_form_accept_charset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;form&gt; <span class="color_h1">accept-charset</span> Attribute</h1>
...
<p>A form with an accept-charset attribute:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_form_accept_charset" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The accept-charset attribute is supported by all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The accept-charset attribute specifies the character encodings that are to be 
used for the form submission.</p>
...
<p>In HTML 4.01, the list of character encodings could be delimited by spaces 
or commas. In HTML5, the list must be space-separated.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;form accept-charset=&quot;<i>character_set</i>&quot;&gt;
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>A space-separated list of one or more character encodings that 
	are to be used for the form submission.<p>Common values:</p>
<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_form_accept_charset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_form_accept_charset.asp#top" target="_top">TOP</a> |
		<a href="att_form_accept_charset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
