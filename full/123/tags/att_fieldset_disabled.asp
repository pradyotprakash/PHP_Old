...
<style>a.menu_att_fieldset_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;fieldset&gt; <span class="color_h1">disabled</span> Attribute</h1>
<p><a href="tag_fieldset.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML fieldset Tag Reference" /> HTML &lt;fieldset&gt; tag</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Disable a group of related form elements:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_fieldset_disabled" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The disabled attribute is supported in all major browsers, except Internet 
Explorer and Safari.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The disabled attribute is a boolean attribute.</p>
<p>When present, it specifies that a group of related form elements (a fieldset) should be disabled.</p>
<p>A disabled fieldset is unusable and un-clickable.</p>
<p>The disabled attribute can be set to keep a user from using the fields 
until some other condition has been met (like selecting a checkbox, etc.). Then, 
a JavaScript could remove the disabled value, and make the fieldset usable.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The disabled attribute is new for the &lt;fieldset&gt; tag in HTML5.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In XHTML, attribute minimization is forbidden, and the disabled attribute must 
be defined as &lt;fieldset disabled=&quot;disabled&quot;&gt;. </p>
<hr>
...
<br>
<hr>
<a href="tag_fieldset.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML fieldset Tag Reference" /> HTML &lt;fieldset&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_fieldset_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_fieldset_disabled.asp#top" target="_top">TOP</a> |
		<a href="att_fieldset_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
