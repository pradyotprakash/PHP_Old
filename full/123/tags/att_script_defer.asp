...
<title>HTML script defer Attribute</title>
<style>a.menu_att_script_defer{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;script&gt; <span class="color_h1">defer</span> Attribute</h1>
...
<p>A script that will not run until after the page has loaded:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_script_defer" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The defer attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The defer attribute is a boolean attribute.</p>
<p>When present, it specifies that the script is executed when the page has 
finished parsing.</p>
<p><b>Note:</b> The defer attribute is only for external scripts (should only be used if the src attribute is present).</p>
...
<ul>
	...
	the parsing)</li>
	<li>If async is not present and defer is present: The script 
...
<p>In XHTML, attribute minimization is forbidden, and the defer attribute must 
be defined as &lt;script defer=&quot;defer&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_script_defer.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_script_defer.asp#top" target="_top">TOP</a> |
		<a href="att_script_defer.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
