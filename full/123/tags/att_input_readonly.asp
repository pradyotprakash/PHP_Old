...
<style>a.menu_att_input_readonly{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">readonly</span> Attribute</h1>
...
<p>An HTML form with a read-only input field:</p>
<div class="example_code notranslate">
    &lt;form 
    action=&quot;demo_form.asp&quot;&gt;<br>
    &nbsp;
    Country: 
    &lt;input type=&quot;text&quot; name=&quot;country&quot; value=&quot;Norway&quot; readonly&gt;&lt;br&gt;<br>
    &nbsp;
    &lt;input type=&quot;submit&quot; value=&quot;Submit&quot;&gt;<br>
    &lt;/form&gt;
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_input_readonly" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>When present, it specifies that an input field is read-only.</p>
<p>A read-only input field cannot be modified (however, a user can tab to it, highlight it, and copy the text from it).</p>
<p>The readonly attribute can be set to keep a user from changing the value 
until some other conditions have been met (like selecting a checkbox, etc.). Then, 
a JavaScript can remove the readonly value, and make the input field editable.</p>
<hr>
...
be defined as &lt;input readonly=&quot;readonly&quot; /&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_readonly.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_readonly.asp#top" target="_top">TOP</a> |
		<a href="att_input_readonly.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
