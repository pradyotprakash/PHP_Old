...
<title>HTML canvas getImageData() Method</title>
<style>a.menu_canvas_getimagedata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">getImageData()</span> Method</h1>
...
<p>The code below copies the pixel data for a specified rectangle on the canvas 
with getImageData(), and then put the image data back onto the canvas with putImageData():</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_getimagedata" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the getImageData() 
method.</p>
...
<p><b>Note:</b> The ImageData object is not a picture, it specifies a part (rectangle) on 
the canvas, and holds information of every pixel inside that rectangle.</p>
<p>For every pixel in an ImageData object there are four pieces of information, the RGBA values:</p>
...
<p>The color/alpha information is held in an array, and is stored in the 
...
array, you can copy the image data back onto the canvas with the <a href="canvas_putimagedata.asp">putImageData()</a> method.</p>
<p><b>Example:</b></p>
<p>The code for getting color/alpha information of the first pixel in the returned ImageData object:</p>
<div class="example_code notranslate">
...
<p><a href="tryit.asp?filename=tryhtml5_canvas_getimagedata_firstpx" target="_blank">Try it yourself</a></p>

<p><b>Tip:</b> You can also use the getImageData() method to invert the color of every pixels of an image on the canvas.</p>
<p>Loop through all the pixels and change the color values using this formula:</p>
...
<p>See below for a try it yourself example!</p>
...
<table class="tecspec">
    ...
    <td><i>context</i>.getImageData(<i>x,y,width,height</i>);</td>
  </tr>
</table>  
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>x</i></td>
		<td>The x coordinate (in pixels) of the upper-left corner to start copy 
		from </td>
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y coordinate (in pixels) of the upper-left corner to start copy 
		from</td>
	</tr>
	<tr>
		<td><i>width</i></td>
		<td>The width of the rectangular area you will copy</td>
	</tr>
	<tr>
		<td><i>height</i></td>
		<td>The height of the rectangular area you will copy</td>
	</tr>
	</table>
<br>
<hr>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_getimagedata2" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_getimagedata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_getimagedata.asp#top" target="_top">TOP</a> |
		<a href="canvas_getimagedata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
