...
<title>HTML img width Attribute</title>
<style>a.menu_att_img_width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;img&gt; <span class="color_h1">width</span> Attribute</h1>
...
<p>An image with a height and a width of 42 pixels:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_img_height" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The width attribute specifies the width of an image, in pixels.</p>
<p><b>Tip:</b> Always specify both the height and width attributes for images. 
...
<p><b>Tip:</b> Downsizing a large image with the height and width attributes forces a user to 
download the large image (even if it looks small on the page). To avoid this, rescale the image with a program before using it on a page.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>In HTML 4.01, the width could be defined in pixels or in % 
of the containing element. In HTML5, the value must be in pixels.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;img width=&quot;<i>pixels</i>&quot;&gt;
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>pixels</i></td>
    <td>The width in pixels (e.g. width=&quot;100&quot;)</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_img_width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_img_width.asp#top" target="_top">TOP</a> |
		<a href="att_img_width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
