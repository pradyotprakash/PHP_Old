...
<style>a.menu_tag_object{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;object&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_ol.asp">&lt;ol&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>How to use the &lt;object&gt; element to embed a Flash file:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_object" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;object&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>

<p>The &lt;object&gt; tag defines an embedded object within an HTML document. Use this 
element to embed multimedia (like audio, video, Java applets, ActiveX, PDF, and 
Flash) in your web pages.</p>
<p>You can also use the &lt;object&gt; tag to embed another webpage into your HTML 
document.</p>
<p>You can use the <a href="tag_param.asp">&lt;param&gt;</a> tag to pass parameters to 
plugins that have been embedded with the &lt;object&gt; tag.</p>
<hr>

<h2>Tips and Notes</h2>

<p><b>Note: </b>An &lt;object&gt; element must appear inside the &lt;body&gt;
element. The text between the &lt;object&gt; and &lt;/object&gt; is an alternate 
text, for browsers that do not support this tag.</p>

<p><b>Tip: </b>For images use the &lt;img&gt; tag instead of the &lt;object&gt;
tag.</p>
<p><b>Tip:</b> At least one of the &quot;data&quot; or &quot;type&quot; attribute MUST be defined.</p>

<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>Some HTML 4.01 attributes are not supported in HTML5.</p>
<p>The &quot;form&quot; attribute is new in HTML5.</p>
<p>In HTML5, objects can be used and submitted in forms.</p>
<p>In HTML5, objects can no longer appear inside the &lt;head&gt; element of a document.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_object_align.asp">align</a></td>
    <td>top<br>
      bottom<br>
      middle<br>
      left<br>
	...
	Specifies the alignment of the &lt;object&gt; element according to surrounding elements</td>
  </tr>
  <tr>
    <td>archive</td>
    <td><i>URL</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>A space separated list of URL's to archives. The archives contains
      resources relevant to the object</td>
  </tr>
  <tr>
    <td><a href="att_object_border.asp">border</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
	Specifies the width of the border around an &lt;object&gt;</td>
  </tr>
  <tr>
    <td>classid</td>
    <td><i>class_ID</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Defines a class ID value as set in the Windows Registry or 
    a URL</td>
  </tr>
  <tr>
    <td>codebase</td>
    <td><i>URL</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Defines where to find the code for the object</td>
  </tr>
  <tr>
    <td>codetype</td>
    <td><i>MIME_type</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>The internet media type of the code referred to by the 
    classid attribute</td>
  </tr>
  <tr>
    <td><a href="att_object_data.asp">data</a></td>
    <td><i>URL</i></td>
  ...
  <tr>
    <td>declare</td>
    <td>declare</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Defines that the object should only be declared, not 
    created or instantiated until needed</td>
  </tr>
  <tr>
    <td><a href="att_object_form.asp">form</a><span class="new">New</span></td>
    <td><i>form_id</i></td>
    <td>Specifies one or more forms the object belongs to</td>
  </tr>
  <tr>
    <td><a href="att_object_height.asp">height</a></td>
    <td><i>pixels</i></td>
    <td>Specifies the height of the object</td>
  </tr>
    <tr>
    <td><a href="att_object_hspace.asp">hspace</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
	Specifies the whitespace on left and right side of an object</td>
    </tr>
    <tr>
    <td><a href="att_object_name.asp">name</a></td>
    <td><i>name</i></td>
    <td>Specifies a name for the object</td>
    </tr>
    <tr>
    <td>standby</td>
    <td><i>text</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Defines a text to display while the object is loading</td>
    </tr>
    <tr>
    <td><a href="att_object_type.asp">type</a></td>
    <td><i>MIME_type</i></td>
    <td>Specifies the MIME type of data specified in the data attribute</td>
    </tr>
    <tr>
    <td><a href="att_object_usemap.asp">usemap</a></td>
    <td><em>#mapname</em></td>
    <td>Specifies the name of a client-side image map to be used with the object</td>
    </tr>
  <tr>
    <td><a href="att_object_vspace.asp">vspace</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
	Specifies the whitespace on top and bottom of an object</td>
    </tr>
  <tr>
    <td><a href="att_object_width.asp">width</a></td>
    <td><i>pixels</i></td>
    <td>Specifies the width of the object</td>
  </tr>
  </table>
<br>
<hr>
...
<p>The &lt;object&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;object&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_object.asp">HTML Object Element</a></p>
<p>HTML DOM reference: <a href="../jsref/dom_obj_object.asp">Object object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_ol.asp">&lt;ol&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_object.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_object.asp#top" target="_top">TOP</a> |
		<a href="tag_object.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
