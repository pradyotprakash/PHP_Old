...
<title>HTML Global hidden Attribute</title>
<style>a.menu_att_global_hidden{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">hidden</span> Attribute</h1>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_global_hidden" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The hidden attribute is supported in all major browsers, except Internet 
Explorer.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The hidden attribute is a boolean attribute.</p>
<p>When present, it specifies 
that an element is not yet, or is no longer, 
relevant.</p>
<p>Browsers should not display elements that have the hidden attribute 
specified.</p>
<p>The hidden attribute can also be used to keep a user from seeing an element 
until some other condition has been met (like selecting a checkbox, etc.). Then, 
a JavaScript could remove the hidden attribute, and make the element visible.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The hidden attribute is new in HTML5.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In XHTML, attribute minimization is forbidden, and the hidden attribute must 
be defined as &lt;<i>element</i> hidden=&quot;hidden&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_global_hidden.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_global_hidden.asp#top" target="_top">TOP</a> |
		<a href="att_global_hidden.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
