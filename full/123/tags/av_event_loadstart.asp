...
<title>HTML Audio/Video DOM loadstart Event</title>
<style>a.menu_av_event_loadstart{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">loadstart</span> Event</h1>
...
<p>Alert that the video is starting to load:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.onloadstart=alert(&quot;Starting 
	to load video&quot;);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_loadstart" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The loadstart event occurs when the browser starts looking for the specified audio/video. 
This is when the loading process starts.</p>
...
<p>The loadstart event is supported in all major browsers.</p>
...
<div class="code notranslate"><div>
	<em>&lt;audio|video</em> onloadstart="<em>SomeJavaScriptCode</em>"&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.onloadstart=<em>SomeJavaScriptCode</em>;</div></div>
<p>Using addEventListener():</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;loadstart&quot;, function()<br>&nbsp; {<br>&nbsp; <em>
...
<p><a href="tryit.asp?filename=tryhtml5_av_event_loadstart_html" target="_blank">Use the onloadstart attribute on an HTML element</a></p>
<p><a href="tryit.asp?filename=tryhtml5_av_event_loadstart_el" target="_blank">Use addEventListener() to listen for the loadstart event</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_event_loadstart.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_event_loadstart.asp#top" target="_top">TOP</a> |
		<a href="av_event_loadstart.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
