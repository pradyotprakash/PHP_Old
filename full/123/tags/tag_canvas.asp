...
<style>a.menu_tag_canvas{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;canvas&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_caption.asp">&lt;caption&gt; Tag &raquo;</a></div>
</div>
<br>
<div class="example">

<h2 class="example">Example</h2>
<p>Draw a red square, on the fly, and show it inside the &lt;canvas&gt; element:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_canvas" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;canvas&gt; tag is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;canvas&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;canvas&gt; tag is used to draw graphics, on the fly, via scripting 
(usually JavaScript).</p>
<p>The &lt;canvas&gt; tag is only a container for graphics, you must use 
a script to actually draw the graphics. </p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>The &lt;canvas&gt; tag is new in HTML5.</p>

<hr>

<h2>Tips and Notes</h2>
<p><b>Note:</b> Any text inside the &lt;canvas&gt; element will be displayed in browsers that does not support &lt;canvas&gt;.</p>
<p><b>Tip:</b>For a complete reference of all the properties and methods that can be used with the canvas object, go to our
<a href="ref_canvas.asp">HTML Canvas Reference</a>.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_canvas_height.asp">height</a><span class="new">New</span></td>
    <td><i>pixels</i></td>
    <td>Specifies the height of the canvas</td>
      </tr>
  <tr>
    <td><a href="att_canvas_width.asp">width</a><span class="new">New</span></td>
    <td><i>pixels</i></td>
    <td>Specifies the width of the canvas</td>
  </tr>
</table>

<h2>Global Attributes</h2>
<p>The &lt;canvas&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;canvas&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_caption.asp">&lt;caption&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_canvas.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_canvas.asp#top" target="_top">TOP</a> |
		<a href="tag_canvas.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
