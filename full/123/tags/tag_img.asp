...
<style>a.menu_tag_img{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;img&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_input.asp">&lt;input&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_image_test" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;img&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;img&gt; tag defines an image in an HTML page.</p>
<p>The &lt;img&gt; tag has two required attributes: src and alt.</p>
<p><b>Note:</b> Images are not technically inserted into an HTML page, images 
are linked to HTML pages. The &lt;img&gt; tag creates a holding space for the 
referenced image.</p>
<p><b>Tip:</b> To link an image to another document, simply nest the &lt;img&gt; tag 
inside &lt;a&gt; tags.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>The following attributes: align, border, hspace, longdesc, and vspace are not 
supported 
in HTML5.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In HTML the &lt;img&gt; tag has no end tag.</p>
<p>In XHTML the &lt;img&gt; tag must be properly closed.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_img_align.asp">align</a></td>
    <td>top<br>
      bottom<br>
      middle<br>
      left<br>
    ...
    Specifies the alignment of an image according to surrounding elements</td>
      </tr>
  <tr>
    <td><a href="att_img_alt.asp">alt</a></td>
    <td><i>text</i></td>
    <td>Specifies an alternate text for an image</td>
  </tr>
  <tr>
    <td><a href="att_img_border.asp">border</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
    Specifies the width of the border around an image</td>
  </tr>
      <tr>
    <td>crossorigin<span class="new">New</span></td>
    <td>anonymous <br>
	use-credentials</td>
    <td>Allow images from third-party sites that allow cross-origin access to be 
	used with canvas</td>
        </tr>
      <tr>
    <td><a href="att_img_height.asp">height</a></td>
    <td><i>pixels</i></td>
    <td>Specifies the height of an image</td>
        </tr>
        <tr>
    <td><a href="att_img_hspace.asp">hspace</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
    Specifies the whitespace on left and right side of an image</td>
        </tr>
        <tr>
    <td><a href="att_img_ismap.asp">ismap</a></td>
    <td>ismap</td>
    <td>Specifies an image as a server-side image-map</td>
        </tr>
  <tr>
    <td><a href="att_img_longdesc.asp">longdesc</a></td>
    <td><i>URL</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
    ...
    image</td>
        ...
        <tr>
    <td><a href="att_img_src.asp">src</a></td>
    <td><i>URL</i></td>
    <td>Specifies the URL of an image</td>
  </tr>
        <tr>
    <td><a href="att_img_usemap.asp">usemap</a></td>
   <td><i>#mapname</i></td>
    <td>Specifies an image as a client-side image-map</td>
        </tr>
  <tr>
    <td><a href="att_img_vspace.asp">vspace</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>
    Specifies the whitespace on top and bottom of an image</td>
  </tr>
  <tr>
    <td><a href="att_img_width.asp">width</a></td>
    <td><i>pixels</i></td>
...
<p>The &lt;img&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;img&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhtml_image_diffloc">Insert images from different locations</a><br>
How to insert images from another folder or from another web site.</p>

<p><a target="_blank" href="tryit.asp?filename=tryhtml_image_link">Make a hyperlink of an image</a><br>
How to add a hyperlink to an image.</p>
...
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_images.asp">HTML Images</a></p>
<p>HTML DOM reference: 
<a href="../jsref/dom_obj_image.asp">Image object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_input.asp">&lt;input&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_img.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_img.asp#top" target="_top">TOP</a> |
		<a href="tag_img.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
