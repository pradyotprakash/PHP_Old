...
<title>HTML menu type Attribute</title>
<style>a.menu_att_menu_type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;menu&gt; <span class="color_h1">type</span> Attribute</h1>
<p><a href="tag_menu.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML menu Tag Reference" /> HTML &lt;menu&gt; tag</a></p>
...
<br>
<a class="tryitbtn" target="_blank" href="tryit.asp?filename=tryhtml5_menu">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The type attribute is not currently supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The type attribute specifies the type of menu.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The &lt;menu&gt; element is redefined in HTML5, and the type attribute is new.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		<td>list</td>
		<td>Default. Specifies a list menu. A list of commands (li elements), 
		that the user can perform or activate</td>
	</tr>
	<tr>
		<td>context</td>
		<td>Specifies a context menu. The menu must be activated before the user 
		can interact with the commands</td>
	</tr>
	<tr>
		<td>toolbar</td>
		<td>Specifies a toolbar menu. Active commands, allows the user to 
		interact with the commands immediately</td>
	</tr>
	</table>
<br>
<hr>
<a href="tag_menu.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML menu Tag Reference" /> HTML &lt;menu&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_menu_type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_menu_type.asp#top" target="_top">TOP</a> |
		<a href="att_menu_type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
