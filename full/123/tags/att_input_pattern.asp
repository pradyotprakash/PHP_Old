...
<title>HTML input pattern Attribute</title>
<style>a.menu_att_input_pattern{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">pattern</span> Attribute</h1>
...
<p>An HTML form with an input field that can contain only three letters (no numbers or special characters):</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_input_pattern" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The pattern attribute is supported in Internet Explorer 10, Firefox, Opera, and Chrome.</p>
...
<p><b>Note:</b> The pattern attribute works with the following input types: 
text, search, url, tel, email, and password.</p>
<p><strong>Tip:</strong> Use the global <a href="att_global_title.asp">title</a> attribute to describe the pattern to help the user.</p>
...
<p>The pattern attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
		&lt;input pattern=&quot;<i>regexp</i>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>regexp</em></td>
		<td>Specifies a regular expression that the &lt;input&gt; element's value is 
		checked against</td>
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_pattern.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_pattern.asp#top" target="_top">TOP</a> |
		<a href="att_input_pattern.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
