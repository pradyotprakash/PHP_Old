...
<title>HTML Audio/Video DOM audioTracks Property</title>
<style>a.menu_av_prop_audiotracks{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">audioTracks</span> Property</h1>
...
<p>Get the number of available audio tracks:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>alert(myVid.audioTracks.length);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_audiotracks" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The audioTracks property returns a AudioTrackList object.</p>
<p>The AudioTrackList object represents the available audio tracks for the audio/video.</p>
<p>Each available audio track is represented by an AudioTrack Object.</p>
<hr>
...
<p>The audioTracks property is not supported in any major browser.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate">
	<div>
		<em>audio|video</em>.audioTracks</div></div>
<h2>Return Value</h2>
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>AudioTrackList Object</td>
    <td>Represents the available audio tracks for the audio/video.<p>
	AudioTrackList Object:</p>
	<ul>
		<li>audioTracks.length - get the number of audio tracks available</li>
		<li>audioTracks.getTrackById(<em>id</em>) - get AudioTrack object by id</li>
		<li>audioTracks[<em>index</em>] - get AudioTrack object by index</li>
	</ul>
	<p><strong>Note: </strong>The first available AudioTrack object is <em>index</em> 0</p>
		</td>
    </tr>
    <tr>
    <td>AudioTrack Object</td>
    <td>Represents an audio track.<p>AudioTrack Object Properties:</p>
	<ul>
		<li>id - get the id of the audio track</li>
		<li>kind - get the type of the audio track (can be: &quot;alternative&quot;, 
		&quot;description&quot;, &quot;main&quot;, &quot;translation&quot;, &quot;commentary&quot;, or &quot;&quot; (empty 
		string))&nbsp; </li>
		<li>label - get the label of the audio track</li>
		<li>language - get the language of the audio track</li>
		<li>enabled - get or set if the track is active (true|false)</li>
	</ul>
		</td>
    </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_audiotracks.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_audiotracks.asp#top" target="_top">TOP</a> |
		<a href="av_prop_audiotracks.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
