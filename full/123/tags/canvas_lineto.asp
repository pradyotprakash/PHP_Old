...
<style>a.menu_canvas_lineto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">lineTo()</span> Method</h1>
...
<p>Begin a path, move to position 0,0. Create a line to position 300,150:</p>
...
<div class="example_code notranslate">
	...
	ctx.beginPath();<br>ctx.moveTo(0,0);<br>ctx.lineTo(300,150);<br>
	ctx.stroke();</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_lineto" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the lineTo() 
method.</p>
...
<p>The lineTo() method adds a new point and creates a line from that point to 
the last specified point in the canvas (this method does not draw the line).</p>
<p><b>Tip:</b> Use the <a href="canvas_stroke.asp">stroke()</a> method to actually draw the path on the canvas.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.lineTo(<i>x,y</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>x</i></td>
		<td>The x-coordinate of where to create the line to</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_linetox">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y-coordinate of where to create the line to</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_linetoy">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Draw a path, shaped as the letter L:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_lineto2" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_lineto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_lineto.asp#top" target="_top">TOP</a> |
		<a href="canvas_lineto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
