...
<title>HTML meta name Attribute</title>
<style>a.menu_att_meta_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;meta&gt; <span class="color_h1">name</span> Attribute</h1>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_meta_name" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The name attribute is supported in all major browsers.</p>
<hr>

<p>The name attribute specifies the name for the metadata.</p>
<p>The name attribute specifies a name for the information/value of the
<a href="att_meta_content.asp">content</a> attribute.</p>
<p><b>Note:</b> If the http-equiv attribute is set, the name attribute should not be set.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_meta_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_meta_name.asp#top" target="_top">TOP</a> |
		<a href="att_meta_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
