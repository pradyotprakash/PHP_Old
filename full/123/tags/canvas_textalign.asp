...
<title>HTML canvas textAlign Property</title>
<style>a.menu_canvas_textalign{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">textAlign</span> Property</h1>
...
<p>Create a red line in position 150. Position 150 is the anchor point for all 
the text defined in the example below. Study the effect of each textAlign property value:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_textalign" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the textAlign 
property.</p>
...
<p>The textAlign property sets or returns the current alignment for text 
content, according to the anchor point.</p>
<p>Normally, the text will <b>START</b> in the position specified, however, if you 
set textAlign=&quot;right&quot; and place the text in position 150, it means that the text 
should 
<strong>END</strong><strong style="font-weight: 400"> in </strong>position 150.</p>
<p><b>Tip:</b> Use the <a href="canvas_filltext.asp">fillText()</a> or the
<a href="canvas_stroketext.asp">strokeText()</a> method to actually draw and 
position the text on the canvas.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.textAlign=&quot;center|end|left|right|start&quot;;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td>start</td>
		<td>Default. The text starts at the specified position</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textalign&amp;preval=start">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>end</td>
		<td>The text ends at the specified position</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textalign&amp;preval=end">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>center</td>
		<td>The center of the text is placed at the specified position</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textalign&amp;preval=center">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>left</td>
		<td>The text starts at the specified position</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textalign&amp;preval=left">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>right</td>
		<td>The text ends at the specified position</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textalign&amp;preval=right">Play it &raquo;</a></td>
	</tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_textalign.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_textalign.asp#top" target="_top">TOP</a> |
		<a href="canvas_textalign.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
