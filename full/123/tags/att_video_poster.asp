...
<style>a.menu_att_video_poster{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_video_poster" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The poster attribute is supported in all major browsers.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;video&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The poster attribute specifies an image to be shown while the 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_video_poster.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_video_poster.asp#top" target="_top">TOP</a> |
		<a href="att_video_poster.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
