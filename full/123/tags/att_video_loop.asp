...
<style>a.menu_att_video_loop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;video&gt; <span class="color_h1">loop</span> Attribute</h1>
...
<p>A video that will start over again, every time it is finished:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_video_loop" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The loop attribute is supported in all major browsers.</p>
...
<p>When present, it specifies that the video will start over again, every time it is finished.</p>
<hr>
...
be defined as &lt;video loop=&quot;loop&quot;&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_video_loop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_video_loop.asp#top" target="_top">TOP</a> |
		<a href="att_video_loop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
