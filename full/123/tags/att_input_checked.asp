...
<title>HTML input checked Attribute</title>
<style>a.menu_att_input_checked{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">checked</span> Attribute</h1>
...
<p>An HTML form with a pre-selected checkbox:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_input_checked" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The checked attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The checked attribute is a boolean attribute.</p>
<p>When present, it specifies that an &lt;input&gt; element should be pre-selected (checked) when the page loads.</p>
<p>The checked attribute can be used with &lt;input type=&quot;checkbox&quot;&gt; and &lt;input 
type=&quot;radio&quot;&gt;.</p>
<p>The checked attribute can also be set after the page load, with a JavaScript.</p>
<hr>
...
be defined as &lt;input checked=&quot;checked&quot; /&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_checked.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_checked.asp#top" target="_top">TOP</a> |
		<a href="att_input_checked.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
