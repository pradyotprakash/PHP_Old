...
<title>HTML video width Attribute</title>
<style>a.menu_att_video_width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;video&gt; <span class="color_h1">width</span> Attribute</h1>
...
<p>A video player with a specified width and height:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_video_width_height" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The width attribute specifies the width of a video player, in pixels.</p>
<p><b>Tip:</b> Always specify both the height and width 
attributes for videos. If height and width are set, the space required for the 
...
during loading (while the video loads).</p>
<p><b>Note:</b> Do not rescale video with the height and width attributes! 
Downsizing a large video with the height and width attributes forces a user to 
download the original video (even if it looks small on the page). The correct 
way to rescale a video is with a program, before using it on a page.</p>
<hr>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>pixels</i></td>
		<td>The width of the video, in pixels (i.e. width=&quot;100&quot;)</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_video_width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_video_width.asp#top" target="_top">TOP</a> |
		<a href="att_video_width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
