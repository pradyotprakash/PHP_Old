...
<title>HTML Audio/Video DOM currentSrc Property</title>
<style>a.menu_av_prop_currentsrc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">currentSrc</span> Property</h1>
...
<p>Get the current video URL:</p>
<div class="example_code notranslate">
    myVid=document.getElementById(&quot;video1&quot;);<br>
	alert(myVid.currentSrc);  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_currentsrc" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The currentSrc property returns the URL of the current audio/video.</p>
<p>If no audio/video is set, an empty string is returned.</p>
<hr>
...
<p>The currentSrc property is supported in all major browsers.</p>
<p><strong>Note:</strong> This property is not supported in Internet 
Explorer 8 and earlier.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>audio|video</em>.currentSrc</div></div>
<h2>Technical Details</h2>
<table class="reference notranslate">
<tr>
	<th style="width:20%">Return Value:</th>
	<td>A String, representing the URL of the current audio/video</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_currentsrc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_currentsrc.asp#top" target="_top">TOP</a> |
		<a href="av_prop_currentsrc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
