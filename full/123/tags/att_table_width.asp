...
<title>HTML table width Attribute</title>
<style>a.menu_att_table_width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;table&gt; <span class="color_h1">width</span> Attribute</h1>
...
<p>An HTML table with a width of 400 pixels:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_table_width" class="tryitbtn">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The &lt;table&gt; width attribute is not supported in HTML5. Use CSS instead.</span></p>
<p>The width attribute specifies the width of a table.</p>
<p>If the width attribute is not set, a table takes up the space it needs to display the table data.</p>
<p><b>Tip:</b> It may be better to NOT specify a width, and use CSS 
to apply the <a href="../css/css_dimension.asp">width</a> 
instead.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_table_width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_table_width.asp#top" target="_top">TOP</a> |
		<a href="att_table_width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
