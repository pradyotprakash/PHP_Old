...
<title>HTML keygen disabled Attribute</title>
<style>a.menu_att_keygen_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;keygen&gt; <span class="color_h1">disabled</span> Attribute</h1>
...
<p>A disabled &lt;keygen&gt; element:</p>
<div class="example_code notranslate">
    &lt;form action=&quot;demo_keygen.asp&quot; method=&quot;get&quot;&gt;<br>
	&nbsp;
	Username: &lt;input type=&quot;text&quot; name=&quot;usr_name&quot;&gt;<br>
	&nbsp;
	Encryption: &lt;keygen name=&quot;security&quot; disabled&gt;<br>
	&nbsp;
	&lt;input type=&quot;submit&quot;&gt;<br>
	&lt;/form&gt;
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_keygen_disabled" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The disabled attribute for the &lt;keygen&gt; tag is supported in Firefox, Opera, Chrome, and Safari 6.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The disabled attribute is a boolean attribute.</p>
<p>When present, it specifies that a &lt;keygen&gt; element should be disabled. A disabled field is unusable and un-editable.</p>
<p>The disabled attribute can be set to keep a user from using the field 
until some other condition has been met (like selecting a checkbox, etc.). Then, 
a JavaScript could remove the disabled value, and make the field usable.</p>
<hr>
...
be defined as &lt;keygen disabled=&quot;disabled&quot; /&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_keygen_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_keygen_disabled.asp#top" target="_top">TOP</a> |
		<a href="att_keygen_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
