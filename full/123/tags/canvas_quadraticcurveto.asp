...
<title>HTML canvas quadraticCurveTo() Method</title>
<style>a.menu_canvas_quadraticcurveto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">quadraticCurveTo()</span> Method</h1>
<p><a href="ref_canvas.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML canvas Reference" /> 
HTML Canvas Reference</a></p>
<div class="example">
...
<div class="example_code notranslate">
	...
	ctx.quadraticCurveTo(20,100,200,20);<br>ctx.stroke();</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_quadraticcurveto" target="_blank">
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the 
quadraticCurveTo() method.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the 
&lt;canvas&gt; element.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The quadraticCurveTo() method adds a point to the current path by using the 
specified control points that represent a quadratic Bézier curve.</p>
<p>A quadratic Bézier curve requires two points. The first point is a control 
point that is used in the quadratic Bézier calculation and the second point is 
the ending point for the curve. The starting point for the curve is the last 
...
moveTo() 
</a>methods to define a starting point.</p>
<img src="img_quadraticcurve.gif" alt="A quadratic Bézier curve" />
<br>
<br>
<div style="float:left;background-color:#ff9000;width:4px;height:4px;margin:5px;"></div> <div style="width:100px;float:left;">
Start point:</div> moveTo(<strong>20,20</strong>)<br>
<div style="float:left;background-color:#FF0000;width:4px;height:4px;margin:5px;"></div> <div style="width:100px;float:left;">
Control point:</div> quadraticCurveTo(<strong>20,100</strong>,200,20)<br>
<div style="float:left;background-color:#b0ef4e;width:4px;height:4px;margin:5px;"></div> <div style="width:100px;float:left;">
End point:</div> quadraticCurveTo(20,100,<strong>200,20</strong>)
<br>
<p><b>Tip: </b>Check out the <a href="canvas_beziercurveto.asp">bezierCurveTo()</a> 
method. It has two control-points instead of one.</p>
<br>
<table class="tecspec">
	<tr>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_quadraticcurvetocpx">
		Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>cpy</i></td>
		<td>The y-coordinate of the Bézier control point</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_quadraticcurvetocpy">
		Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>x</i></td>
		<td>The x-coordinate of the ending point</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_quadraticcurvetox">
		Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y-coordinate of the ending point</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_quadraticcurvetoy">
		Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<hr>
<a href="ref_canvas.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML canvas Reference" /> 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_quadraticcurveto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_quadraticcurveto.asp#top" target="_top">TOP</a> |
		<a href="canvas_quadraticcurveto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
