...
<title>HTML Audio/Video DOM textTracks Property</title>
<style>a.menu_av_prop_texttracks{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">textTracks</span> Property</h1>
...
<p>Get the number of available text tracks:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>alert(myVid.textTracks.length);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_texttracks" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The textTracks property returns a TextTrackList object.</p>
<p>The TextTrackList object represents the available text tracks for the audio/video.</p>
<p>Each available text track is represented by an TextTrack Object.</p>
<hr>
...
<p>The textTracks property is supported in Internet Explorer 10, Opera, Chrome, and Safari 6.</p>
<p><strong>Note:</strong> The textTracks property is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate">
	<div>
		<em>audio|video</em>.textTracks</div></div>
<h2>Return Value</h2>
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>TextTrackList Object</td>
    <td>Represents the available text tracks for the the audio/video.<p>
	TextioTrackList Object:</p>
	<ul>
		<li>length - get the number of text tracks available in the audio/video</li>
		<li>[<em>index</em>] - get TextTrack object by index</li>
	</ul>
	<p><strong>Note: </strong>The first available TextTrack object is <em>index</em> 0</p>
		</td>
    </tr>
    <tr>
    <td>TextTrack Object</td>
    <td>Represents an text track.<p>TextTrack Object Properties:</p>
	<ul>
		<li>kind - get the type of the text track (can be: &quot;subtitles&quot;, 
		&quot;caption&quot;, &quot;descriptions&quot;, &quot;chapters&quot;, or &quot;metadata&quot;) </li>
		<li>label - get the label of the text track</li>
		<li>language - get the language of the text track</li>
		<li>mode - get or set if the track is active (&quot;disabled&quot;|&quot;hidden&quot;|&quot;showing&quot;)</li>
		<li>cues - get a list of cues as a TextTrackCueList object</li>
		<li>activeCues - get the currently active text track cues as a 
		TextTrackCueList object</li>
		<li>addCue(<em>cue</em>) - add a cue to the list of cues</li>
		<li>removeCue(<em>cue</em>) - remove a cue from the list of cues</li>
	</ul>
		</td>
    </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_texttracks.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_texttracks.asp#top" target="_top">TOP</a> |
		<a href="av_prop_texttracks.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
