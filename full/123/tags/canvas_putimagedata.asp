...
<title>HTML canvas putImageData() Method</title>
<style>a.menu_canvas_putimagedata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">putImageData()</span> Method</h1>
...
with getImageData(), and then put the image data back onto the canvas with 
putImageData():</p>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the putImageData() method.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;canvas&gt; element.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The putImageData() method puts the image data (from a specified ImageData object) 
back onto the canvas.</p>
<p><b>Tip:</b> Read about the <a href="canvas_getimagedata.asp">getImageData()</a> method that copies the pixel data for 
a specified rectangle on a canvas.</p>
<p><b>Tip:</b> Read about the <a href="canvas_createimagedata.asp">createImageData()</a> method 
that creates a new, blank ImageData object.</p>
<hr>
...
<table class="tecspec">
    ...
    <td><i>context</i>.putImageData(<i>imgData,x,y,</i><i>dirtyX,dirtyY,dirtyWidth,dirtyHeight</i>);</td>
  </tr>
</table>  
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>imgData</i></td>
		<td>Specifies the ImageData object to put back onto the canvas</td>
	</tr>
	<tr>
		<td><i>x</i></td>
		<td>The x-coordinate, in pixels, of the upper-left corner of the 
		ImageData object</td>
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y-coordinate, in pixels, of the upper-left corner of the 
		ImageData object</td>
	</tr>
	<tr>
		<td><i>dirtyX</i></td>
		<td>Optional. The horizontal (x) value, in pixels, where to place the 
		image on the canvas</td>
	</tr>
	<tr>
		<td><i>dirtyY</i></td>
		<td>Optional. The vertical (y) value, in pixels, where to place the 
		image on the canvas</td>
	</tr>
	<tr>
		<td><i>dirtyWidth</i></td>
		<td>Optional. The width to use to draw the image on the canvas</td>
	</tr>
	<tr>
		<td><i>dirtyHeight</i></td>
		<td>Optional. The height to use to draw the image on the canvas</td>
	</tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_putimagedata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_putimagedata.asp#top" target="_top">TOP</a> |
		<a href="canvas_putimagedata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
