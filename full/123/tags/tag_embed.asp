...
<style>a.menu_tag_embed{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;embed&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_fieldset.asp">&lt;fieldset&gt; Tag &raquo;</a></div>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>An embedded flash animation:</p>
<div class="example_code notranslate">
    &lt;embed src=&quot;helloworld.swf&quot;&gt;
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_embed" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;embed&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;embed&gt; tag defines a container for an external application or interactive content (a plug-in).</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The &lt;embed&gt; tag is new in HTML5.</p>
<p><strong>Note:</strong> Many web browsers have supported the &lt;embed&gt; tag for a 
long time. However, the &lt;embed&gt; tag has not been a part of the HTML 4 
specification. The &lt;embed&gt; tag is new in HTML5, and will validate in an HTML5 
page. However, if you use it in an HTML 4 page, the page will not validate.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_embed_height.asp">height</a><span class="new">New</span></td>
    <td><i>pixels</i></td>
    <td>Specifies the height of the embedded content</td>
      </tr>
  <tr>
    <td><a href="att_embed_src.asp">src</a><span class="new">New</span></td>
    <td><i>URL</i></td>
    <td>
	Specifies the address of the external file to embed</td>
  </tr>
  <tr>
    <td><a href="att_embed_type.asp">type</a><span class="new">New</span></td>
    <td><i>MIME_type</i></td>
    <td>Specifies the MIME type of the embedded content</td>
      </tr>
  <tr>
    <td><a href="att_embed_width.asp">width</a><span class="new">New</span></td>
    <td><i>pixels</i></td>
    <td>Specifies the width of the embedded content</td>
  </tr>
</table>

<h2>Global Attributes</h2>
<p>The &lt;embed&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;embed&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_fieldset.asp">&lt;fieldset&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_embed.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_embed.asp#top" target="_top">TOP</a> |
		<a href="tag_embed.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
