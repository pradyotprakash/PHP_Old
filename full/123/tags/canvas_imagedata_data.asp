...
<title>HTML canvas ImageData data Property</title>
<style>a.menu_canvas_imagedata_data{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas ImageData <span class="color_h1">data</span> Property</h1>
...
<p>Create a 100*100 pixels ImageData object where every pixel is set to the 
color red:</p>
<h2 class="example">Canvas</h2>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the ImageData 
data property.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;canvas&gt; element.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The data property returns an object that contains image data of the specified 
ImageData object.</p>
...
<p>The color/alpha information is held in an array, and is stored in the data property of the ImageData object.</p>
<p><b>Examples:</b></p>
...
<p><b>Tip:</b> Look at <a href="canvas_createimagedata.asp">createImageData()</a>,
<a href="canvas_getimagedata.asp">getImageData()</a>, and
<a href="canvas_putimagedata.asp">putImageData()</a> to learn more about the 
ImageData object.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_imagedata_data.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_imagedata_data.asp#top" target="_top">TOP</a> |
		<a href="canvas_imagedata_data.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
