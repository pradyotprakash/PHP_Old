...
<title>HTML canvas closePath() Method</title>
<style>a.menu_canvas_closepath{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">closePath()</span> Method</h1>
...
<p>Draw a path, shaped as the letter L, and then draw a line back to the starting point:</p>
...
<div class="example_code notranslate">
	...
	ctx.beginPath();<br>ctx.moveTo(20,20);<br>ctx.lineTo(20,100);<br>
	ctx.lineTo(70,100);<br>ctx.closePath();<br>ctx.stroke();</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_closepath" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the closePath() 
method.</p>
...
<p>The closePath() method creates a path from the current point back to the starting point.</p>
<p><b>Tip:</b> Use the <a href="canvas_stroke.asp">stroke()</a> method to actually draw the path on the canvas.</p>
<p><b>Tip:</b> Use the <a href="canvas_fill.asp">fill()</a> method to fill the 
drawing (black is default). Use the <a href="canvas_fillstyle.asp">fillStyle</a> 
property to fill with another color/gradient.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.closePath();</td>
  </tr>
</table>
<br>
<hr>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_closepath2" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_closepath.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_closepath.asp#top" target="_top">TOP</a> |
		<a href="canvas_closepath.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
