...
<title>HTML style media Attribute</title>
<style>a.menu_att_style_media{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;style&gt; <span class="color_h1">media</span> Attribute</h1>
<p><a href="tag_style.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML style Tag Reference" /> HTML &lt;style&gt; tag</a></p>
<div class="example">


<h2 class="example">Example</h2>
<p>Specify the style to use for print:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_style_media" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The media attribute specifies what media/device the CSS style is optimized 
for.</p>
<p>This attribute is used to specify that the style is for special 
devices (like iPhone), speech or print media.</p>
<p><b>Tip:</b> This attribute can accept several values.</p>
<hr>
...
<br>
<hr>
<a href="tag_style.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML style Tag Reference" /> HTML &lt;style&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_style_media.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_style_media.asp#top" target="_top">TOP</a> |
		<a href="att_style_media.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
