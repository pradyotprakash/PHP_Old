...
<title>HTML Audio/Video DOM src Property</title>
<style>a.menu_av_prop_src{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">src</span> Property</h1>
...
<p>Change the source of the video:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.src=&quot;movie.ogg&quot;;</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_src" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The src property sets or returns the current source of the audio/video.</p>
<hr>
...
<p>The src property is supported in Internet Explorer 10, Firefox, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> The src property is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>

<h2>Syntax</h2>
<p>Set the src property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.src=<em>URL</em></div></div>
<p>Return the src property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.src</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>URL</i></td>
    <td>Specifies the URL of the audio/video source.
	<p>Possible values:</p>
	<ul>
		<li>An absolute URL - points to another web site (like src=&quot;http://www.example.com/movie.ogg&quot;)</li>
		<li>A relative URL - points to a file within a web site (like src=&quot;movie.ogg)</li>
	</ul>
	  </td>
  </tr>
  </table>
...
<tr>
	...
	<td>A String, the current audio/video source</td>
</tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_src.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_src.asp#top" target="_top">TOP</a> |
		<a href="av_prop_src.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
