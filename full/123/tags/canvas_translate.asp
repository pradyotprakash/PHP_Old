...
<title>HTML canvas translate() Method</title>
<style>a.menu_canvas_translate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">translate()</span> Method</h1>
...
<p>Draw a rectangle in position (10,10), set new (0,0) position to (70,70). Draw 
same rectangle again (notice that the rectangle now starts in position (80,80):</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_translate" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the translate() 
method.</p>
...
<p><b>Note:</b> When you call a method such as fillRect() after translate(), the 
value is added to the x- and y-coordinate values. </p>
<img src="img_translate.gif" alt="Illustration of the translate() method"/>
<br>
<br>
<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.translate(<em>x,y</em>);</td>
  </tr>
</table>
<h2>Parameter Values</h2>
<p><b>Note:</b> You can specify one or both parameters.</p>
<table class="reference notranslate">
	...
	<tr>
		<td><i>x</i></td>
		<td>The value to add to horizontal (x) coordinates</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_translatex">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The value to add to vertical (y) coordinates</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_translatey">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_translate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_translate.asp#top" target="_top">TOP</a> |
		<a href="canvas_translate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
