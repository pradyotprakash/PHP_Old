...
<title>HTML input max Attribute</title>
<style>a.menu_att_input_max{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">max</span> Attribute</h1>
...
<p>The max attribute is supported in Internet Explorer 10, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> The max attribute of the &lt;input&gt; tag is not supported in Internet Explorer 9 and earlier versions, or in Firefox.</p>
<p><strong>Note:</strong> The max attribute will not work for dates and time in Internet Explorer 10, since IE 10 does not support these input types.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The max attribute specifies the maximum value for an &lt;input&gt; element.</p>
<p><b>Tip:</b> Use the max attribute together with the <a href="att_input_min.asp">min</a> 
...
<p>The max attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
		&lt;input max=&quot;<i>number</i>|<i>date</i>&quot;&gt;
</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_max.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_max.asp#top" target="_top">TOP</a> |
		<a href="att_input_max.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
