...
<title>HTML canvas shadowOffsetX Property</title>
<style>a.menu_canvas_shadowoffsetx{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">shadowOffsetX</span> Property</h1>
...
<p>Draw a rectangle with a shadow placed 20 pixels to the right (from the rectangle's left position):</p>
...
<div class="example_code notranslate">
	...
	ctx=c.getContext(&quot;2d&quot;);<br>ctx.shadowBlur=10;<br>
	ctx.shadowOffsetX=20;<br>
	ctx.shadowColor=&quot;black&quot;;<br>
	ctx.fillStyle=&quot;red&quot;;<br>
	ctx.fillRect(20,20,100,80);</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_shadowoffsetx" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the shadowOffsetX property.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;canvas&gt; element.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The shadowOffsetX property sets or returns the horizontal distance of the shadow from the shape.</p>
<p>shadowOffsetX=0 indicates that the shadow is right behind the shape.</p>
<p>shadowOffsetX=20 indicates that the shadow starts 20 pixels to the right (from the shape's left position).</p>
<p>shadowOffsetX=-20 indicates that the shadow starts 20 pixels to the left (from the shape's left position).</p>
<p><b>Tip:</b> To adjust the vertical distance of the shadow 
from the shape, use the <a href="canvas_shadowoffsety.asp">shadowOffsetY</a> property.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.shadowOffsetX=<i>number</i>;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>number</i></td>
		<td>A positive or negative number that defines the horizontal distance of the shadow 
		from the shape</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_shadowoffsetx">Play it &raquo;</a></td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_shadowoffsetx.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_shadowoffsetx.asp#top" target="_top">TOP</a> |
		<a href="canvas_shadowoffsetx.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
