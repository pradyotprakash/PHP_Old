...
<style>a.menu_tag_command{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;command&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_datalist.asp">&lt;datalist&gt; Tag &raquo;</a></div>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>A &lt;command&gt; element can be marked up as follows:</p>
<div class="example_code notranslate">
    &lt;menu&gt;<br>
	&lt;command type=&quot;command&quot; label=&quot;Save&quot; onclick=&quot;save()&quot;&gt;Save&lt;/command&gt;<br>
	&lt;/menu&gt;
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_command" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;command&gt; tag is currently not supported in any of the major browsers.</p>
<p><b>Note:</b> Internet Explorer 9 (not earlier or later versions), supports the &lt;command&gt; tag.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;command&gt; tag defines a command (a radiobutton, a checkbox, or a command button) that the user can invoke.</p>
<p>A command can be part of a context menu or toolbar, using the &lt;menu&gt; element, 
or can be put anywhere else in the page, to define a keyboard shortcut.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The &lt;command&gt; tag is new in HTML5.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_command_checked.asp">checked</a><span class="new">New</span></td>
    <td>checked</td>
    <td>Specifies that the command should be checked when the page loads. Only 
	for type=&quot;radio&quot; or type=&quot;checkbox&quot;</td>
      </tr>
	<tr>
    <td><a href="att_command_disabled.asp">disabled</a><span class="new">New</span></td>
    <td>disabled</td>
    <td>Specifies that the command should be disabled</td>
      </tr>
	<tr>
    <td><a href="att_command_icon.asp">icon</a><span class="new">New</span></td>
    <td><i>URL</i></td>
    <td>Specifies an image that represents the command</td>
      </tr>
	<tr>
    <td><a href="att_command_label.asp">label</a><span class="new">New</span></td>
    <td><i>text</i></td>
    <td>Required. Specifies the name of the command, as shown to the user</td>
      </tr>
	<tr>
    <td><a href="att_command_radiogroup.asp">radiogroup</a><span class="new">New</span></td>
    <td><i>groupname</i></td>
    <td>Specifies the name of the group of commands that will be toggled when the command itself is toggled. 
	Only for type=&quot;radio&quot;</td>
      </tr>
	<tr>
    <td><a href="att_command_type.asp">type</a><span class="new">New</span></td>
    <td>checkbox<br>
	command<br>
	radio</td>
    <td>Specifies the type of command</td>
      </tr>
      </table>
<h2>Global Attributes</h2>
<p>The &lt;command&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;command&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_datalist.asp">&lt;datalist&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_command.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_command.asp#top" target="_top">TOP</a> |
		<a href="tag_command.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
