...
<title>HTML Audio/Video DOM autoplay Property</title>
<style>a.menu_av_prop_autoplay{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">autoplay</span> Property</h1>
...
<p>Enable autoplay, and reload video:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>
	myVid.autoplay=true;<br>myVid.load();  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_autoplay" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The autoplay property sets or returns if the audio/video should start playing 
...
<p>The autoplay property is supported in all major browsers.</p>
<p><strong>Note:</strong> This property is not supported in Internet 
Explorer 8 and earlier.</p>
<hr>
<h2>Syntax</h2>
<p>Set the autoplay property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.autoplay=true|false
</div></div>
<p>Return the autoplay property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.autoplay</div></div>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>true</td>   
    <td>Indicates that the audio/video should start playing as soon as it is 
	loaded</td>
    </tr>
  <tr>
    <td>false</td>
    <td>Default. Indicates that the audio/video should NOT start playing as soon as it is 
	loaded</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_autoplay.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_autoplay.asp#top" target="_top">TOP</a> |
		<a href="av_prop_autoplay.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
