...
<style>a.menu_att_option_label{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_option_label" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The label attribute is supported in all major browsers, except Firefox.</p>
<p><strong>Note:</strong> The label attribute of the &lt;option&gt; tag is not supported in Internet Explorer 7 and earlier versions.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The label attribute specifies a shorter version of an option.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_option_label.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_option_label.asp#top" target="_top">TOP</a> |
		<a href="att_option_label.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
