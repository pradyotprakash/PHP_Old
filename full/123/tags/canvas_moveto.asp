...
<title>HTML canvas moveTo() Method</title>
<style>a.menu_canvas_moveto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">moveTo()</span> Method</h1>
...
<div class="example_code notranslate">
	...
	ctx.stroke();</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_moveto" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the moveTo() 
method.</p>
...
<p><b>Tip:</b> Use the <a href="canvas_stroke.asp">stroke()</a> method to 
actually draw the path on the canvas.</p>

<table class="tecspec">
	<tr>
    <th>JavaScript syntax:</th>
    <td><i>context</i>.moveTo(<i>x,y</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>x</i></td>
		<td>The x-coordinate of where to move the path to</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_movetox">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The x-coordinate of where to move the path to</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_movetoy">Play it &raquo;</a></td>		
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_moveto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_moveto.asp#top" target="_top">TOP</a> |
		<a href="canvas_moveto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
