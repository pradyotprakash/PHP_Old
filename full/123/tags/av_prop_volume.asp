...
<title>HTML Audio/Video DOM volume Property</title>
<style>a.menu_av_prop_volume{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">volume</span> Property</h1>
...
<p>Set video volume to 20%:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.volume=0.2;</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_volume" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The volume property sets or returns the current volume of the audio/video.</p>
<hr>
...
<p>The volume property is supported in all major browsers.</p>
<p><strong>Note:</strong> This property is not supported in Internet 
Explorer 8 and earlier.</p>
<hr>

<h2>Syntax</h2>
<p>Set the volume property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.volume=<em>volumevalue</em></div></div>
<p>Return the volume property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.volume</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Specifies the current volume of the audio/video. Must be a number 
	between 0.0 and 1.0.<br>Example 
	values:<ul><li>1.0 is highest volume (default)</li>
		<li>0.5 is half volume (50%)</li>
		<li>0.0 is silent</li>
	</ul>
	  </td>
  </tr>
...
<tr>
	...
	<td>A Number, indicating the current volume</td>
</tr>
<tr>
	<th>Default Value:</th>
	<td>1.0</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_volume.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_volume.asp#top" target="_top">TOP</a> |
		<a href="av_prop_volume.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
