...
<title>HTML input formmethod Attribute</title>
<style>a.menu_att_input_formmethod{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">formmethod</span> Attribute</h1>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_input_formmethod" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The formmethod attribute overrides the <a href="att_form_method.asp">method</a>  attribute of the 
&lt;form&gt; element.</p>
<p><b>Note:</b> The formmethod attribute can be used with type=&quot;submit&quot; and type=&quot;image&quot;.</p>
<p>The form-data can be sent as URL variables (method=&quot;get&quot;) or as an HTTP 
post transaction (method=&quot;post&quot;).</p>
...
<ul>
	...
	browsers), therefore, you cannot be sure that all of the form-data will be correctly transferred</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_formmethod.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_formmethod.asp#top" target="_top">TOP</a> |
		<a href="att_input_formmethod.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
