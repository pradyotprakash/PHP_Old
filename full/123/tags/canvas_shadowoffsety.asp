...
<title>HTML canvas shadowOffsetY Property</title>
<style>a.menu_canvas_shadowoffsety{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">shadowOffsetY</span> Property</h1>
...
<p>Draw a rectangle with a shadow placed 20 pixels below the rectangle's top position:</p>
...
<div class="example_code notranslate">
	...
	ctx.shadowOffsetY=20;<br>
	ctx.shadowColor=&quot;black&quot;;<br>
	ctx.fillStyle=&quot;red&quot;;<br>
	ctx.fillRect(20,20,100,80);</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_shadowoffsety" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the shadowOffsetY property.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;canvas&gt; element.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The shadowOffsetY property sets or returns the vertical distance of the shadow from the shape.</p>
<p>shadowOffsety=0 indicates that the shadow is right behind the shape.</p>
<p>shadowOffsetY=20 indicates that the shadow starts 20 pixels below the shape's top position.</p>
<p>shadowOffsetY=-20 indicates that the shadow starts 20 pixels above the shape's top position.</p>
<p><b>Tip:</b> To adjust the horizontal distance of the shadow 
from the shape, use the <a href="canvas_shadowoffsetx.asp">shadowOffsetX</a> property.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.shadowOffsetY=<i>number</i>;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>number</i></td>
		<td>A positive or negative number that defines the vertical distance of the shadow 
		from the shape</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_shadowoffsety">Play it &raquo;</a></td>
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_shadowoffsety.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_shadowoffsety.asp#top" target="_top">TOP</a> |
		<a href="canvas_shadowoffsety.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
