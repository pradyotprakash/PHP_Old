...
<style>a.menu_att_input_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">disabled</span> Attribute</h1>
...
<p>An HTML form with a disabled input field:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_input_disabled" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The disabled attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The disabled attribute is a boolean attribute.</p>
<p>When present, it specifies that the &lt;input&gt; element should be disabled.</p>
<p>A disabled input element is unusable and un-clickable.</p>
<p>The disabled attribute can be set to keep a user from using the &lt;input&gt; element 
until some other condition has been met (like selecting a checkbox, etc.). Then, 
a JavaScript could remove the disabled value, and make the &lt;input&gt; element usable.</p>
<p><strong>Tip:</strong> Disabled &lt;input&gt; elements in a form will not be submitted.</p>
<p><b>Note:</b> The disabled attribute will not work with &lt;input type=&quot;hidden&quot;&gt;.</p>
<hr>
...
be defined as &lt;input disabled=&quot;disabled&quot; /&gt;. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_disabled.asp#top" target="_top">TOP</a> |
		<a href="att_input_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
