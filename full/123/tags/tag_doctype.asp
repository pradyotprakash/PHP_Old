...
<style>a.menu_tag_doctype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;!DOCTYPE&gt;</span> Declaration</h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_a.asp">&lt;a&gt; Tag &raquo;</a></div>
</div><br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_doctype" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The &lt;!DOCTYPE&gt; declaration is supported in all major browsers.</p>
<hr>
...
<p>There are three different &lt;!DOCTYPE&gt; declarations in HTML 4.01. In HTML5 there is only one:</p>
...
<h2>HTML Elements and Doctypes</h2>
<p>Look at our table of all <a href="ref_html_dtd.asp">HTML elements, and what Doctype each element appears in</a>.</p>
<hr>

<h2>Tips and Notes</h2>
<p><b>Note: </b>The &lt;!DOCTYPE&gt; tag does not have an end tag.</p>
<p><b>Tip:</b> The &lt;!DOCTYPE&gt; declaration is NOT case sensitive.</p>
<p><b>Tip:</b> Use <a target="_blank" href="http://validator.w3.org/">W3C's Validator</a> to check that you have written a valid HTML / XHTML document!</p>
<hr>

<h2>Common DOCTYPE Declarations</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_doctype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_doctype.asp#top" target="_top">TOP</a> |
		<a href="tag_doctype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
