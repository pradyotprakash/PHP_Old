...
<style>a.menu_att_frame_src{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;frame&gt; <span class="color_h1">src</span> Attribute</h1>
...
<p>The src attribute specifies the location of the document to show in a &lt;frame&gt;:</p>
...
<p>The src attribute specifies the URL of the document to show in a frame.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>URL</i></td>
    <td>The address to the document to show in the frame.<p>Possible values:</p>
		<ul>
			<li>An absolute URL - points to another web site (like src=&quot;http://www.example.com/default.htm&quot;)</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_frame_src.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_frame_src.asp#top" target="_top">TOP</a> |
		<a href="att_frame_src.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
