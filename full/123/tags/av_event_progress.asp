...
<title>HTML Audio/Video DOM progress Event</title>
<style>a.menu_av_event_progress{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">progress</span> Event</h1>
...
<p>Alert that the video is downloading:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.onprogress=alert(&quot;Downloading 
	video&quot;);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_event_progress" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The progress event occurs when the browser is downloading the specified audio/video.</p>
...
<p>The progress event is supported in all major browsers.</p>
...
<div class="code notranslate"><div>
	<em>&lt;audio|video</em> onprogress="<em>SomeJavaScriptCode</em>"&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.onprogress=<em>SomeJavaScriptCode</em>;</div></div>
<p>Using addEventListener():</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;progress&quot;, function()<br>&nbsp; {<br>&nbsp; <em>
...
<p><a href="tryit.asp?filename=tryhtml5_av_event_progress_html" target="_blank">Use the onprogress attribute on an HTML element</a></p>
<p><a href="tryit.asp?filename=tryhtml5_av_event_progress_el" target="_blank">Use addEventListener() to listen for the progress event</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_event_progress.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_event_progress.asp#top" target="_top">TOP</a> |
		<a href="av_event_progress.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
