...
<title>HTML style type Attribute</title>
<style>a.menu_att_style_type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;style&gt; <span class="color_h1">type</span> Attribute</h1>
...
<p>Use the type attribute to specify the MIME type of the style:</p>
...
<p>The type attribute specifies the MIME type of the style sheet.</p>
<p>The type attribute identifies the content between the &lt;style&gt; and &lt;/style&gt; 
tags.</p>
<p>The value &quot;text/css&quot; indicates that the content is CSS.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>

<p>In HTML5, the type attribute is no longer required. Default value is 
&quot;text/css&quot;.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>MIME_type</i></td>
    <td>The MIME type of the style sheet. For now, the only supported value is &quot;text/css&quot;. 
	Look at
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_style_type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_style_type.asp#top" target="_top">TOP</a> |
		<a href="att_style_type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
