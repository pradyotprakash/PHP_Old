...
<title>HTML canvas textBaseline Property</title>
<style>a.menu_canvas_textbaseline{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">textBaseline</span> Property</h1>
...
<p>Draw a red line at y=100, then place each word at y=100 with different 
textBaseline values:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_textbaseline" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the textBaseline 
property.</p>
<p><b>Note:</b> The textBaseline property works differently in different 
browsers, especially when using "hanging" or "ideographic".</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the 
&lt;canvas&gt; element.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The textBaseline property sets or returns the current text baseline used when drawing text.</p>

<p>The illustration below demonstrates the various baselines supported by the 
textBaseline attribute:</p>
<img src="img_textbaseline.gif" alt="textBaseline illustration" />


<p><b>Note:</b> The <a href="canvas_filltext.asp">fillText()</a> and
<a href="canvas_stroketext.asp">strokeText()</a> methods will use the specified 
textBaseline value when positioning the text on the canvas.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.textBaseline=&quot;alphabetic|top|hanging|middle|ideographic|bottom&quot;;</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td>alphabetic</td>
		<td>Default. The text baseline is the normal alphabetic baseline</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textbaseline&amp;preval=alphabetic">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>top</td>
		<td>The text baseline is the top of the em square</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textbaseline&amp;preval=top">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>hanging</td>
		<td>The text baseline is the hanging baseline</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textbaseline&amp;preval=hanging">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>middle</td>
		<td>The text baseline is the middle of the em square</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textbaseline&amp;preval=middle">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>ideographic</td>
		<td>The text baseline is the ideographic baseline</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textbaseline&amp;preval=ideographic">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>bottom</td>
		<td>The text baseline is the bottom of the bounding box</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_textbaseline&amp;preval=bottom">Play it &raquo;</a></td>
	</tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_textbaseline.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_textbaseline.asp#top" target="_top">TOP</a> |
		<a href="canvas_textbaseline.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
