...
<title>HTML Audio/Video DOM controls Property</title>
<style>a.menu_av_prop_controls{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">controls</span> Property</h1>
...
<p>Enable controls for a video:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>
	myVid.controls=true;</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_controls" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The controls property sets or returns if the browser should display standard 
audio/video 
controls.</p>
<p>Standard audio/video controls should include:</p>
<ul>
	<li>Play</li>
	<li>Pause</li>
	<li>Seeking</li>
	<li>Volume</li>
	<li>Fullscreen toggle (for video)</li>
...
<p>The controls property is supported in all major browsers.</p>
<p><strong>Note:</strong> This property is not supported in Internet 
Explorer 8 and earlier.</p>
<hr>
<h2>Syntax</h2>
<p>Set the controls property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.controls=true|false
</div></div>
<p>Return the controls property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.controls</div></div>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>true</td>
    <td>Indicates that controls are displayed</td>
    </tr>
  <tr>
    <td>false</td>
    <td>Default. Indicates that controls are NOT displayed</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_controls.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_controls.asp#top" target="_top">TOP</a> |
		<a href="av_prop_controls.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
