...
<title>HTML input formnovalidate Attribute</title>
<style>a.menu_att_input_formnovalidate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;input&gt; <span class="color_h1">formnovalidate</span> Attribute</h1>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_input_formnovalidate" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The formnovalidate attribute overrides the <a href="att_form_novalidate.asp">novalidate</a> attribute of the 
&lt;form&gt; element.</p>
...
<p><b>Note:</b> The formnovalidate attribute is a boolean attribute, and can be set in the following ways:</p>
<ul>
	<li>&lt;input formnovalidate&gt;</li>
	<li>&lt;input formnovalidate=&quot;formnovalidate&quot;&gt;</li>
	<li>&lt;input formnovalidate=&quot;&quot;&gt;</li>
</ul>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_input_formnovalidate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_input_formnovalidate.asp#top" target="_top">TOP</a> |
		<a href="att_input_formnovalidate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
