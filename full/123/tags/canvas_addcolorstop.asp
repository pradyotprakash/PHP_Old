...
<title>HTML canvas addColorStop() Method</title>
<style>a.menu_canvas_addcolorstop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">addColorStop()</span> Method</h1>
...
<p>Define a gradient that goes from black to white, as the fill style 
for the rectangle:</p>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the addColorStop() 
method.</p>
...
<p>The addColorStop() method specifies the colors and position in a gradient 
object.</p>
<p>The addColorStop() method is used together with
<a href="canvas_createlineargradient.asp">createLinearGradient()</a> or 
<a href="canvas_createradialgradient.asp">createRadialGradient()</a>.</p>
<p><b>Note:</b> You can call the addColorStop() method multiple times to change 
a gradient. If you omit this method for gradient objects, the gradient will not 
be visible. You need to create at least one color stop to have a visible 
gradient.</p>

<table class="tecspec">
	<tr>
    <th style="width:25%">JavaScript syntax:</th>
    <td><i>gradient</i>.addColorStop(<i>stop</i>,<i>color</i>);</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>stop</i></td>
		<td>A value between 0.0 and 1.0 that represents the position between 
		start and end in a gradient</td>
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_addcolorstop">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>color</i></td>
		<td>A <a href="../cssref/css_colors_legal.asp">CSS color value</a> to display at the <i>stop</i> position</td>		
		<td><a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_addcolorstop">Play it &raquo;</a></td>				
	</tr>
</table>
<br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Define a gradient with multiple addColorStop() methods:</p>
...
grd.addColorStop(1,&quot;red&quot;);<br>
<br>
ctx.fillStyle=grd;<br>
ctx.fillRect(20,20,150,100);
</div>
<br>
<a class="tryitbtn" target="_blank" href="tryit.asp?filename=tryhtml5_canvas_addcolorstop_multiple">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_addcolorstop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_addcolorstop.asp#top" target="_top">TOP</a> |
		<a href="canvas_addcolorstop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
