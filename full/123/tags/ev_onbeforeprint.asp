...
<title>HTML onbeforeprint Event Attribute</title>
<style>a.menu_ev_onbeforeprint{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onbeforeprint</span> Event Attribute</h1>
<p><a href="ref_eventattributes.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Event Attributes"> HTML Event Attributes</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Execute a JavaScript after a page is set to print, but before the print 
dialogue box appears:</p>
<div class="example_code notranslate">
    &lt;body onbeforeprint=&quot;printmsg()&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml5_ev_onbeforeprint">Try it yourself &raquo;</a>
</div>
<hr>
...
<img src="http://www.w3schools.com/images/incompatible_safari.gif" width="28" height="30" alt="Safari" title="Safari">
</p>
<p>The onafterprint event attribute is only supported in Internet Explorer and Firefox.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onbeforeprint attribute fires immediately after the user has set the page to print, but before the print dialogue box appears.</p>
<p><b>Tip:</b> The onbeforeprint attribute is often used together with the <a href="ev_onafterprint.asp">onafterprint</a> attribute.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The onbeforeprint attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
    &lt;<i>element</i> onbeforeprint=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onbeforeprint</td>
  </tr>
  </table>
<br>
<hr>
<a href="ref_eventattributes.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Event Attributes"> HTML Event Attributes</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_onbeforeprint.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_onbeforeprint.asp#top" target="_top">TOP</a> |
		<a href="ev_onbeforeprint.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
