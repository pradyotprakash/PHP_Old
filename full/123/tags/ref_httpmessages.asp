...
<style>a.menu_ref_httpmessages{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTTP <span class="color_h1">Status Messages</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ref_language_codes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ref_httpmethods.asp">Next Reference &raquo;</a></div>
</div>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>100 Continue</td>
    <td> The server has received the request headers, and the client should 
	proceed to send the request body</td>
  </tr>
  <tr>
    <td>101 Switching Protocols</td>
    <td>The requester has asked the server to switch protocols</td>
  </tr>
  <tr>
    <td>103 Checkpoint</td>
    <td>Used in the resumable requests proposal to resume aborted PUT or POST 
	requests</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>200 OK</td>
    <td>The request is OK (this is the standard response for successful HTTP 
	requests)</td>
  </tr>
  <tr>
    <td>201 Created</td>
    <td>The request has been fulfilled, and a new resource is
      created&nbsp;
    </td>
  </tr>
  <tr>
    <td>202 Accepted</td>
    <td>The request has been accepted for processing, but the processing
      has not been completed
    </td>
  </tr>
  <tr>
    <td>203 Non-Authoritative Information</td>
    <td>The request has been successfully processed, but is returning 
	information that may be from another source</td>
  </tr>
  <tr>
    <td>204 No Content</td>
    <td>The request has been successfully processed, but is not returning any 
	content</td>
  </tr>
  <tr>
    <td>205 Reset Content</td>
    <td>The request has been successfully processed, but is not returning any 
	content, and requires that the requester reset the document view</td>
  </tr>
  <tr>
    <td>206 Partial Content</td>
    <td>The server is delivering only part of the resource due to a range header 
	sent by the client</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>A link list. The user can select a link and go to that
  ...
  <tr>
    ...
    <td>Indicates the requested page has not been modified since last requested</td>
  </tr>
  <tr>
    <td>306 Switch Proxy</td>
    <td><i>No longer used</i></td>
  </tr>
  <tr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>The request was a legal request, but the server is refusing to respond 
  ...
  <tr>
    <td>404 Not Found</td>
    <td>The requested page could not be found but may be available again in the 
	future</td>
  </tr>
  <tr>
    <td>405 Method Not Allowed</td>
    <td>A request was made of a page using a request method not supported by 
	that page</td>
  </tr>
  <tr>
    <td>406 Not Acceptable</td>
    <td>The server can only generate a response that is not
      accepted by the client
    </td>
  </tr>
  <tr>
    <td>407 Proxy Authentication Required</td>
    <td>The client must first authenticate itself with the proxy
    </td>
  </tr>
  <tr>
    <td>408 Request Timeout</td>
    <td>The server timed out waiting for the request
    </td>
  </tr>
  <tr>
    <td>409 Conflict</td>
    <td>The request could not be completed because of a conflict
    in the request</td>
  </tr>
  <tr>
    <td>410 Gone</td>
  ...
  <tr>
    ...
    <td>The &quot;Content-Length&quot; is not defined. The server
      will not accept the request without it&nbsp;
    </td>
  </tr>
  <tr>
    <td>412 Precondition Failed</td>
    <td>The precondition given in the request evaluated to false by
      the server
    </td>
  </tr>
  <tr>
    <td>413 Request Entity Too Large</td>
    <td>The server will not accept the request, because the request entity is
      too large
    </td>
  </tr>
  <tr>
    <td>414 Request-URI Too Long</td>
    <td>The server will not accept the request, because the URL is
  ...
  <tr>
    ...
    <td>The server will not accept the request, because the media
      type is not supported&nbsp;
    </td>
  </tr>
  <tr>
    <td>416&nbsp;Requested Range Not Satisfiable</td>
    <td>The client has asked for a portion of the file, but the server cannot 
	supply that portion</td>
  </tr>
  <tr>
    <td>417 Expectation Failed</td>
    <td>The server cannot meet the requirements of the Expect request-header 
	field</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>The server either does not recognize the request method, or it lacks the 
	ability to fulfill the request</td>
  </tr>
  <tr>
    <td>502 Bad Gateway</td>
    <td>The server was acting as a gateway or proxy and received an invalid 
	response from the upstream server</td>
  </tr>
  <tr>
    <td>503 Service Unavailable</td>
    <td>The server is currently unavailable (overloaded or down)
    </td>
  </tr>
  <tr>
    <td>504 Gateway Timeout</td>
    <td>The server was acting as a gateway or proxy and did not receive a timely 
	response from the upstream server</td>
  </tr>
  <tr>
    <td>505 HTTP Version Not Supported</td>
    <td>The server does not support the HTTP protocol version used in the 
	request
    </td>
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_httpmessages.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_httpmessages.asp#top" target="_top">TOP</a> |
		<a href="ref_httpmessages.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
