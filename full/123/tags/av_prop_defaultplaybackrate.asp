...
<title>HTML Audio/Video DOM defaultPlaybackRate Property</title>
<style>a.menu_av_prop_defaultplaybackrate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">defaultPlaybackRate</span> Property</h1>
...
<p>Set video to slow motion by default:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>myVid.defaultPlaybackRate=0.5;</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_defaultplaybackrate" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The defaultPlaybackRate property sets or returns the default playback speed 
of the audio/video.</p>
<p>Setting this property will only change the default playback speed, not the 
current. To change the current playback speed, use the 
<a href="av_prop_playbackrate.asp">playbackRate</a> property.</p>
<hr>
...
<p>The defaultPlaybackRate property is only supported in Internet Explorer 10, 
Firefox, and Chrome.</p>
<p><strong>Note:</strong> The defaultPlaybackRate property is not supported in Internet Explorer 9 and earlier, Opera, or Safari.</p>

<hr>

<h2>Syntax</h2>
<p>Set the defaultPlaybackRate property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.defaultPlaybackRate=<em>playbackspeed</em></div></div>
<p>Return the defaultPlaybackRate property:</p>
<div class="code notranslate"><div>
	<em>audio|video</em>.defaultPlaybackRate</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>playbackspeed</i></td>
    <td>Indicates the default playback speed of the audio/video.<br>Example 
	values:<ul><li>1.0 is normal speed</li>
		<li>0.5 is half speed (slower)</li>
		<li>2.0 is double speed (faster)</li>
		<li>-1.0 is backwards, normal speed</li>
		<li>-0.5 is backwards, half speed</li></ul>
	  </td>
  </tr>
  </table>
...
<tr>
	...
	<td>Number, the default playback speed</td>
</tr>
<tr>
	<th>Default Value:</th>
	<td>1.0</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_defaultplaybackrate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_defaultplaybackrate.asp#top" target="_top">TOP</a> |
		<a href="av_prop_defaultplaybackrate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
