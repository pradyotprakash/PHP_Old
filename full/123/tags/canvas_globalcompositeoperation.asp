...
<title>HTML canvas globalCompositeOperation Property</title>
<style>a.menu_canvas_globalcompositeoperation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML canvas <span class="color_h1">globalCompositeOperation</span> Property</h1>
<p><a href="ref_canvas.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML canvas Reference" /> HTML Canvas Reference</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Draw rectangles using two different globalCompositeOperation values. Red rectangles are 
<i>destination images</i>. Blue rectangles are <i>source images</i>:</p>
<div>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_globalcompop" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the globalCompositeOperation property.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the &lt;canvas&gt; element.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The globalCompositeOperation property sets or returns how a source (new) image are 
drawn onto a destination (existing) image.</p>
<p> <em>source image = </em>drawings you 
are about to place onto the canvas.</p>
<p> <em>destination image = </em>drawings that are already placed onto the canvas.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td><i>context</i>.globalCompositeOperation="source-in";</td>
  </tr>
</table>
...
<table class="reference notranslate">
	...
	<tr>
		<td>source-over</td>
		<td>Default. Displays the <em>source image</em> over the <em>
		destination image</em></td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=source-over">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>source-atop</td>
		<td>Displays the <em>source image </em>on top of the <em>destination 
		image</em>. The part of the <i>source image</i> that is outside the <i>destination 
		image</i> is not shown</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=source-atop">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>source-in</td>
		<td>Displays the <em>source image </em>in to the <em>destination image</em>. 
		Only the part of the <i>source image</i> that is INSIDE the <i>destination 
		image</i> is shown, and the <i>destination image</i> is transparent</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=source-in">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>source-out</td>
		<td>Displays the <em>source image </em>out of the <em>destination image</em>. 
		Only the part of the <i>source image</i> that is OUTSIDE the <i>destination 
		image</i> is shown, and the <i>destination image</i> is transparent</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=source-out">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>destination-over</td>
		<td>Displays the <em>
		destination image</em> over the <em>
		source image</em></td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=destination-over">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>destination-atop</td>
		<td>Displays the <em>
		destination image</em> on top of the <em>
		source image</em>. The part of the <i>destination image</i> that is outside the 
		<i>source 
		image</i> is not shown</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=destination-atop">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>destination-in</td>
		<td>Displays the <em>
		destination image</em> in to the <em>
		source image</em>. Only the part of the <i>destination image</i> that is 
		INSIDE the <i>source 
		image</i> is shown, and the <i>source image</i> is transparent</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=destination-in">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>destination-out</td>
		<td>Displays the <em>
		destination image</em> out of the <em>
		source image</em>. Only the part of the <i>destination image</i> that is 
		OUTSIDE the <i>source 
		image</i> is shown, and the <i>source image</i> is transparent</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=destination-out">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>lighter</td>
		<td>Displays the <em>source image </em>+ the <em>destination image</em></td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=lighter">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>copy</td>
		<td>Displays the <em>source image. </em>The <em>destination image</em> is ignored</td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=copy">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>xor</td>
		<td>The <em>source image</em> is combined by using an exclusive OR with the <em>destination image</em></td>
		<td>
		<a target="_blank" class="playitbtn" href="playcanvas.asp?filename=playcanvas_globalcompop&amp;preval=xor">Play it &raquo;</a></td>
	</tr>
</table>
<br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>All the globalCompositeOperation property values:</p>
...
for (n=0;n<gco.length;n++)
	{
	document.write("<div class='gcoDIV' id='p_" + n + "'>" + gco[n] + ":<br>");
...
<div style="clear:both"></div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_canvas_globalcompop_all" target="_blank">Try it yourself &raquo;</a>
</div>
<br>

<hr>
<a href="ref_canvas.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML canvas Reference" /> HTML Canvas Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="canvas_globalcompositeoperation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="canvas_globalcompositeoperation.asp#top" target="_top">TOP</a> |
		<a href="canvas_globalcompositeoperation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
