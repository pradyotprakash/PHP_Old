...
<title>HTML textarea cols Attribute</title>
<style>a.menu_att_textarea_cols{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;textarea&gt; <span class="color_h1">cols</span> Attribute</h1>
...
<p>A text area with a specified height and width:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_textarea_cols">Try it yourself &raquo;</a>
...
<p>The cols attribute specifies the visible width of a text area.</p>
<p><strong>Tip:</strong>
The size of a textarea can also be set by the CSS height and width properties.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>number</i></td>
    <td>Specifies the width of the text area (in average character width). 
		Default value is 20</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_textarea_cols.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_textarea_cols.asp#top" target="_top">TOP</a> |
		<a href="att_textarea_cols.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
