...
<style>a.menu_tag_title{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;title&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_tr.asp">&lt;tr&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>The &lt;title&gt; tag is supported in all major browsers.</p>
<hr>
...
<p><b>Note:</b> You can NOT have more than one &lt;title&gt; element in an HTML 
document.</p>
<p><b>Tip:</b> If you omit the &lt;title&gt; tag, the document will not validate as 
HTML.</p>
...
<p>The &lt;title&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_title.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_title.asp#top" target="_top">TOP</a> |
		<a href="tag_title.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
