...
<title>HTML body background Attribute</title>
<style>a.menu_att_body_background{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;body&gt; <span class="color_h1">background</span> Attribute</h1>
<p><a href="tag_body.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML body Tag Reference" /> HTML &lt;body&gt; tag</a></p>
<div class="example">


<h2 class="example">Example</h2>
<p>Specify a background image for an HTML document:</p>
<div class="example_code notranslate">
  
    &lt;html&gt;<br>
	&lt;body background=&quot;bgimage.jpg&quot;&gt;<br>
	&lt;h1&gt;Hello world!&lt;/h1&gt;<br>
	&lt;p&gt;&lt;a href=&quot;http://www.w3schools.com&quot;&gt;Visit W3Schools.com!&lt;/a&gt;&lt;/p&gt;<br>
	&lt;/body&gt;<br>
	&lt;/html&gt;
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_body_background" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The background attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The background attribute specifies a background image for a document.</p>
<hr>

<h2>Compatibility Notes</h2>
<p><span class="deprecated">The &lt;body&gt; background attribute is not supported in HTML5. Use CSS instead.</span></p>
<p>CSS syntax: &lt;body style=&quot;background-image:url(bgimage.jpg)&quot;&gt;</p>
<p><a target="_blank" href="tryit.asp?filename=tryhtml_body_background_css">CSS Example: Add a background image to a document</a></p>
<p>In our CSS tutorial you can find more details about the
<a href="../cssref/pr_background-image.asp">background-image property</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
  
    &lt;body background=&quot;<i>URL</i>&quot;&gt;
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>URL</i></td>
    <td>The URL of the background image.<p>Possible values:</p>
	<ul>
		<li>An absolute URL - points to another web site (like href=&quot;http://www.example.com/bgimage.gif&quot;) 
		</li>
		<li>A relative URL - points to a file within a web site (like href=&quot;/images/bgimage.gif&quot;)</li>
	</ul>
	</td>
  </tr>
  </table>
<br>
<hr>
<a href="tag_body.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML body Tag Reference" /> HTML &lt;body&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_body_background.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_body_background.asp#top" target="_top">TOP</a> |
		<a href="att_body_background.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
