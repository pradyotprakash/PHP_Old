...
<style>a.menu_ev_onclick{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onclick</span> Event Attribute</h1>
...
<p>Execute a JavaScript when a button is clicked:</p>
<div class="example_code notranslate">
    &lt;button onclick=&quot;copyText()&quot;&gt;Copy Text&lt;/button&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml5_ev_onclick">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The onclick event attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onclick attribute fires on a mouse click on the element.</p>
<p><b>Note:</b> The onclick attribute CANNOT be used with: &lt;base&gt;, &lt;bdo&gt;, &lt;br&gt;, 
...
<div class="code notranslate"><div>
    &lt;<i>element</i> onclick=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onclick</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_onclick.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_onclick.asp#top" target="_top">TOP</a> |
		<a href="ev_onclick.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
