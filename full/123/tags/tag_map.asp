...
<style>a.menu_tag_map{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;map&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_mark.asp">&lt;mark&gt; Tag &raquo;</a></div>
</div>
<br>
...
<p>The &lt;map&gt; tag is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;map&gt; tag is used to define a client-side image-map. An image-map is an image with clickable areas.</p>
<p>The required name attribute of the &lt;map&gt; element is associated 
with the &lt;img&gt;'s usemap attribute and creates a relationship between the image 
and the map.</p>
<p>The &lt;map&gt; element contains a number of <a href="tag_area.asp">&lt;area&gt;</a> elements, that defines the clickable areas in the image map.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p><b>Note:</b> In HTML5, if the id attribute of the &lt;map&gt; tag is also 
specified, it must have the same value as the name attribute.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In XHTML, the name attribute is deprecated, and will be 
removed. Use the id attribute instead.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_map_name.asp">name</a></td>
    <td><i>mapname</i></td>
...
<p>The &lt;map&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;map&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_mark.asp">&lt;mark&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_map.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_map.asp#top" target="_top">TOP</a> |
		<a href="tag_map.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
