...
<style>a.menu_tag_iframe{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;iframe&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_img.asp">&lt;img&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_iframe" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;iframe&gt; tag is supported in all major browsers.</p>
<hr>
...
<p><b>Tip: </b>To deal with browsers that do not support &lt;iframe&gt;, add a text between the opening &lt;iframe&gt; tag and the closing &lt;/iframe&gt; tag.</p>

<p><b>Tip:</b> Use CSS to style the &lt;iframe&gt; (even to include scrollbars).</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>HTML5 has added some new attributes, and several HTML 4.01 attributes are removed from HTML5.</p>
<hr>

<h2>Differences Between HTML and XHTML</h2>
<p>In XHTML, the name attribute is deprecated, and will be removed. Use the id attribute instead.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><a href="att_iframe_align.asp">align</a></td>
    <td>left<br>
    right<br>
    top<br>
    middle<br>
    ...
    Specifies the alignment of an 	&lt;iframe&gt; according to surrounding elements</td>
  </tr>
  <tr>
    <td><a href="att_iframe_frameborder.asp">frameborder</a></td>
    <td>1<br>
      0</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies whether or not to display a border around an 
	&lt;iframe&gt;</td>
    </tr>
    <tr>
    <td><a href="att_iframe_height.asp">height</a></td>
    <td><i>pixels</i></td>
    <td>Specifies the height of an &lt;iframe&gt;</td>
      </tr>
      <tr>
    <td><a href="att_iframe_longdesc.asp">longdesc</a></td>
    <td><i>URL</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies a page that contains a long description of the 
	content of an &lt;iframe&gt;</td>
      </tr>
      <tr>
    <td><a href="att_iframe_marginheight.asp">marginheight</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the top and bottom margins of the content of an &lt;iframe&gt;</td>
      </tr>
      <tr>
    <td><a href="att_iframe_marginwidth.asp">marginwidth</a></td>
    <td><i>pixels</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies the left and right margins of the content of an &lt;iframe&gt;</td>
      </tr>
      <tr>
    <td><a href="att_iframe_name.asp">name</a></td>
    <td><i>text</i></td>
    <td>Specifies the name of an &lt;iframe&gt;</td>
      </tr>
      <tr>
    <td><a href="att_iframe_sandbox.asp">sandbox</a><span class="new">New</span></td>
    <td>&quot;&quot;<br>
      allow-forms<br>
      allow-same-origin<br>
      allow-scripts<br>
      allow-top-navigation</td>
    <td>Enables a set of extra restrictions for the content in the &lt;iframe&gt;</td>
    </tr>
      <tr>
    <td><a href="att_iframe_scrolling.asp">scrolling</a></td>
    <td>yes<br>
      no<br>
      auto</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies whether or not to display scrollbars in an &lt;iframe&gt;</td>
    </tr>
  <tr>
    <td><a href="att_iframe_seamless.asp">seamless</a><span class="new">New</span></td>
    <td>seamless</td>
    <td>Specifies that the &lt;iframe&gt; should look like it is a part of the containing document</td>
    </tr>
  <tr>
    <td><a href="att_iframe_src.asp">src</a></td>
    <td><i>URL</i></td>
    <td>Specifies the address of the document to embed in the &lt;iframe&gt;</td>
  </tr>
  <tr>
    <td><a href="att_iframe_srcdoc.asp">srcdoc</a><span class="new">New</span></td>
    <td><i>HTML_code</i></td>
    <td>Specifies the HTML content of the page to show in the &lt;iframe&gt;</td>
  </tr>
  <tr>
    <td><a href="att_iframe_width.asp">width</a></td>
    <td><i>pixels</i></td>
    <td>Specifies the width of an &lt;iframe&gt;</td>
  </tr>
  </table>
<br>
<hr>
...
<p>The &lt;iframe&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;iframe&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<hr>
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_iframe.asp">HTML Iframes</a></p>
<p>HTML DOM reference: <a href="../jsref/dom_obj_frame.asp">IFrame object</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_img.asp">&lt;img&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_iframe.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_iframe.asp#top" target="_top">TOP</a> |
		<a href="tag_iframe.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
