...
<title>HTML form method Attribute</title>
<style>a.menu_att_form_method{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;form&gt; <span class="color_h1">method</span> Attribute</h1>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml_form_method" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The method attribute is supported in all major browsers.</p>
<hr>
...
<p>The form-data can be sent as URL variables (with method=&quot;get&quot;) or as HTTP post 
transaction (with method=&quot;post&quot;).</p>
...
<ul>
	...
	<li>Useful for form submissions where a user want to bookmark 
	the result</li>
	<li>GET is better for non-secure data, like query strings in Google</li>
</ul>
<p><b>Notes on POST:</b> </p>
<ul>
	<li>Appends form-data inside the body of the HTTP request (data is not shown 
	is in URL)</li>
	<li>Has no size limitations</li>
	<li>Form submissions 
	with POST cannot be bookmarked</li>
</ul>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>get</td>
    <td>Default. Appends the form-data to the URL in name/value pairs: URL?name=value&amp;name=value</td>
  </tr>
  <tr>
    <td>post</td>
...
<p><a target="_blank" href="tryit.asp?filename=tryhtml_form_method_post">Submit 
a form using the &quot;post&quot; method</a><br>
Send form data with the &quot;post&quot; method.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_form_method.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_form_method.asp#top" target="_top">TOP</a> |
		<a href="att_form_method.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
