...
<title>HTML button formmethod Attribute</title>
<style>a.menu_att_button_formmethod{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;button&gt; <span class="color_h1">formmethod</span> Attribute</h1>
<p><a href="tag_button.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML button Tag Reference" /> HTML &lt;button&gt; tag</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>A form with two submit buttons.The first submit button submits the form data 
with method=&quot;get&quot;, and the second submits the form data with method=&quot;post&quot;:</p>
<div class="example_code notranslate">
	...
	formaction=&quot;demo_post.asp&quot;&gt;<br>
	Submit using 
	POST&lt;/button&gt;<br>
	&lt;/form&gt;
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryhtml5_button_formmethod" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The formmethod attribute is supported in Internet Explorer 10, Firefox, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> Internet Explorer 9 and earlier versions, do not support the formmethod attribute.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The formmethod attribute specifies which HTTP method to use when sending the 
form-data. This attribute overrides the form's <a href="att_form_method.asp">method</a> attribute.</p>
<p>The formmethod attribute is only used for buttons with type=&quot;submit&quot;.</p>
<p>The form-data can be sent as URL variables (with method=&quot;get&quot;) or as HTTP 
post (with method=&quot;post&quot;).</p>
<p>Notes on the &quot;get&quot; method:</p>
<ul>
	<li>it appends the form-data to the URL in name/value pairs</li>
	<li>it is useful for form submissions where a user want to bookmark the result</li>
...
<p>Notes on the &quot;post&quot; method:</p>
<ul>
	<li>it sends the form-data as an HTTP post transaction</li>
	<li>Form submissions with the &quot;post&quot; method cannot be bookmarked</li>
	<li>it is more robust and secure than &quot;get&quot;</li>
	<li>it does not have size limitations</li>
</ul>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The formmethod attribute is new in HTML5.</p>
<hr>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>get</td>
    <td>Appends the form-data to the URL: URL?name=value&amp;name=value</td>
    </tr>
	<tr>
    <td>post</td>
    <td>Sends the form-data as an HTTP post transaction</td>
    </tr>
	</table>
<br>
<hr>
<a href="tag_button.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML button Tag Reference" /> HTML &lt;button&gt; tag</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_button_formmethod.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_button_formmethod.asp#top" target="_top">TOP</a> |
		<a href="att_button_formmethod.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
