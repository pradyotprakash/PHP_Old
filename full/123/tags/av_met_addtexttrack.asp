...
<title>HTML Audio/Video DOM addTextTrack() Method</title>
<style>a.menu_av_met_addtexttrack{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">addTextTrack()</span> Method</h1>
...
<p>Add a new text track to the video:</p>
<div class="example_code notranslate">
  
    text1=myVid.addTextTrack(&quot;caption&quot;);<br>text1.addCue(new TextTrackCue(&quot;Test 
	text&quot;, 01.000, 04.000,&quot;&quot;,&quot;&quot;,&quot;&quot;,true));</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_met_addtexttrack" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>

<h2>Definition and Usage</h2>
<p>The addTextTrack() method creates and returns a new TextTrack object.</p>
<p>The new TextTrack object is added to the list of text tracks for the audio/video element.</p>
<hr>
...
<p>The addTextTrack() method is not supported in any major browser.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	
		<em>audio|video</em>.addTextTrack(<em>kind</em>,<em>label</em>,<em>language</em>)
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>kind</em></td>
		<td>Specifies the kind of text track.<p>Possible values:</p>
		<ul>
			<li>&quot;subtitles&quot;</li>
			<li>&quot;caption&quot;</li>
			<li>&quot;descriptions&quot;</li>
	...
	<tr>
		<td><em>label</em></td>
		<td>A string specifying the label for the text track. Is used to 
		identify the text track for the users</td>
	</tr>
	<tr>
		<td><em>language</em></td>
		<td>A two-letter language code that specifies the language of the text track.<br>
		To view all available language codes, go to our <a href="ref_language_codes.asp">Language code reference</a></td>
	</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
	...
	<tr>
		...
		<td>Represents the new text track</td>
	</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_met_addtexttrack.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_met_addtexttrack.asp#top" target="_top">TOP</a> |
		<a href="av_met_addtexttrack.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
