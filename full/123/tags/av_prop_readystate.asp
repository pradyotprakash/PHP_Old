...
<title>HTML Audio/Video DOM readyState Property</title>
<style>a.menu_av_prop_readystate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML Audio/Video DOM <span class="color_h1">readyState</span> Property</h1>
...
<p>Get the current ready state of the video:</p>
<div class="example_code notranslate">
  
    myVid=document.getElementById(&quot;video1&quot;);<br>alert(myVid.readyState);</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_av_prop_readystate" class="tryitbtn">Try it yourself &raquo;</a>

</div>
<hr>
<h2>Definition and Usage</h2>
<p>The readyState property returns the current ready state of the 
audio/video.</p>
<p>The ready state indicates if the audio/video is ready to play or not.</p>
<hr>
...
<p>The readyState property is supported in all major browsers.</p>
...
<div class="code notranslate">
	<div>
		<em>audio|video</em>.readyState</div></div>
<h2>Return Value</h2>
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td>Number</td>
    <td>Represents the ready state of the audio/video element:<ul><li>
		0 
		= HAVE_NOTHING - no information whether or not the audio/video is ready</li>
		<li>1 = HAVE_METADATA - metadata for the audio/video is ready</li>
		<li>2 = HAVE_CURRENT_DATA - data for the current playback position is 
		available, but not enough data to play next frame/millisecond</li>
		<li>3 = H<span lang="no-bok">AVE_FUTURE_DATA</span> - data for the 
		current and at least the next frame is available</li>
		<li>4 = HAVE_ENOUGH_DATA - enough data available to start playing</li></ul>
		</td>
    </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="av_prop_readystate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="av_prop_readystate.asp#top" target="_top">TOP</a> |
		<a href="av_prop_readystate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
