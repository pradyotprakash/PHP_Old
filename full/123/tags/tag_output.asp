...
<style>a.menu_tag_output{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">&lt;output&gt;</span> Tag</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_p.asp">&lt;p&gt; Tag &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_output" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The &lt;output&gt; tag is supported in Firefox, Opera, Chrome, and Safari.</p>
<p><strong>Note:</strong> The &lt;output&gt; tag is not supported in Internet Explorer.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;output&gt; tag represents the result of a calculation (like one performed by a script).</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="att_output_for.asp">for</a><span class="new">New</span></td>
    <td><i>element_id</i></td>
    <td>Specifies the relationship between the result of the calculation, and the elements used in the calculation</td>
  </tr>
	<tr>
    <td><a href="att_output_form.asp">form</a><span class="new">New</span></td>
    <td><i>form_id</i></td>
    <td>Specifies one or more forms the output element belongs to</td>
  </tr>
  <tr>
    <td><a href="att_output_name.asp">name</a><span class="new">New</span></td>
    <td><i>name</i></td>
    <td>Specifies a name for the output element</td>
  </tr>
  </table>

<h2>Global Attributes</h2>
<p>The &lt;output&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
<hr>
<h2>Event Attributes</h2>
<p>The &lt;output&gt; tag also supports the <a href="ref_eventattributes.asp">Event Attributes in HTML</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; HTML Reference</a></div>
<div class="next"><a class="chapter" href="tag_p.asp">&lt;p&gt; Tag &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="tag_output.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="tag_output.asp#top" target="_top">TOP</a> |
		<a href="tag_output.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
