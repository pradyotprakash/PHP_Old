...
<style>a.menu_att_area_rel{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;area&gt; <span class="color_h1">rel</span> Attribute</h1>
...
<div class="example_code notranslate">
	...
	href=&quot;sun.htm&quot; rel=&quot;alternate&quot;&gt;<br>
		&lt;/map&gt;
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryhtml5_area_rel" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The rel attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The rel attribute specifies the relationship between the current document and the linked document.</p>
<p>Only used if the href attribute is present.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>The rel attribute is new for the &lt;area&gt; tag in HTML5.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>alternate</td>
    <td>Links to an alternate version of the document (i.e. print page, translated or mirror)</td>
  </tr>
	<tr>
    <td>author</td>
    <td>Links to the author of the document</td>
    </tr>
	<tr>
    <td>bookmark</td>
    <td>Permanent URL used for bookmarking</td>
    </tr>
	<tr>
    <td>help</td>
    <td>Links to a help document</td>
    </tr>
	<tr>
    <td>license</td>
    <td>Links to copyright information for the document</td>
    </tr>
	<tr>
    <td>next</td>
	...
	<tr>
    <td>nofollow</td>
    <td>Links to an unendorsed document, like a paid link.<br>
	(&quot;nofollow&quot; is used by Google, to specify that the Google search spider 
	should not follow that link)</td>
    </tr>
	<tr>
    <td>noreferrer</td>
	...
	<tr>
    <td>search</td>
    <td>Links to a search tool for the document</td>
    </tr>
	<tr>
    <td>tag</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_area_rel.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_area_rel.asp#top" target="_top">TOP</a> |
		<a href="att_area_rel.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
