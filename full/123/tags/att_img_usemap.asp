...
<style>a.menu_att_img_usemap{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML &lt;img&gt; <span class="color_h1">usemap</span> Attribute</h1>
...
<p>The usemap attribute is supported in all major browsers.</p>
<hr>

<h2>Definition and Usage </h2>
<p>The usemap attribute specifies an image as a client-side image-map (an image-map is an image with clickable areas).</p>
<p>The usemap attribute is associated with a <a href="tag_map.asp">&lt;map&gt;</a> 
element's name or id attribute, and creates a relationship between the &lt;img&gt; and the 
&lt;map&gt;.</p>
<p><b>Note:</b> The usemap attribute cannot be used if the &lt;img&gt; element is a 
descendant of an &lt;a&gt; or &lt;button&gt; element.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>#mapname</i></td>
    <td>A hash character (&quot;#&quot;) plus the name or id of the &lt;map&gt; element to use</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="att_img_usemap.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="att_img_usemap.asp#top" target="_top">TOP</a> |
		<a href="att_img_usemap.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
