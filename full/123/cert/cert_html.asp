...
<style>a.menu_cert_html{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">HTML</span> Certification</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="cert_html5.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The HTML Certification requires skills in HTML.</p>
<hr>
<table style="width:100%">
<tr>
<td style="width:155px;height:210px">
<img src="pic_html_cert_small.gif" alt="HTML Certificate" height="206" width="146" style="border:1px solid #888888" />
</td>
<td style="padding:10px">
	<h2 style="margin-top:0px;">HTML Certificate</h2>
	...
	<br>
	<a class="tryitbtn" style="width:200px;font-size:120%;margin-top:5px;" href="cert_html_reg.asp">Get Certified now!</a>
</td>
</tr>
</table>
<br>
<hr>
<h2>The HTML Developer Certificate</h2>
<p>HTML is the foundation of web development.</p>
<p>HTML is used to format text, create hyperlinks, tables, lists, forms, display images and more.</p>
<p>By mastering HTML you will be able to develop and maintain web pages unlimited to a particular software program's features.</p>
<p>The HTML Developer Certificate proves fundamental knowledge of web development using HTML.</p>
<p><a target="_blank" href="cert_pic.asp?imgsrc=HTML">HTML Developer Certificate</a></p>
<hr>

<h2>Prerequisites</h2>
<p>Before you apply for your exam, you should have a fundamental knowledge of:</p>
<ul>
  <li>The Hypertext Markup Language - HTML 4.01</li>
</ul>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="../html/default.asp">HTML Tutorial</a></td>
    <td><a href="http://www.w3schools.com/quiztest/quiztest.asp?qtest=HTML">HTML Quiz</a></td>
  </tr>
  </table>
<br>
<hr>
...
<h2>The HTML Exam</h2>
<p>The HTML exam will be taken over the Internet, at any time and from any location, but the exam should be supervised by a person selected by the exam candidate.</p>
...
you an HTML Developer Certificate. The document will contain your personal data acknowledging your status as a Certified HTML Developer.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="cert_html.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="cert_html.asp#top" target="_top">TOP</a> |
		<a href="cert_html.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
