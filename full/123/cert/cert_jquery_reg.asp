...
<style>a.menu_cert_jquery_reg{font-weight:bold;}</style>
<meta charset="utf-8">
...
function submitForm()
{
var x="@",os0=document.forms.regform.os0.value;
os0=TRIM(os0);
if (os0=="")
	{
	alert("Enter an e-mail address and register");
	return false;
	}
if (os0.indexOf("@")>0 && os0.indexOf(",")==-1)
	{
	document.forms.regform.business.value="exam" + x;
...
<p>Registration is easy! Type your e-mail address and pay with PayPal or a credit card.</p>
<p>When payment is done, you will receive an e-mail with login information.</p>
<div>Price:<span style="font-size:150%;color:#900B09"> $95.00</span></div>

<br><br>
<form name="regform" target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post" onsubmit="submitForm();return false;">
<input type="hidden" name="lc" value="US" />
<input type="hidden" name="cmd" value="_xclick" />
<input type="hidden" name="business" value="" />
<input type="hidden" name="item_name" value="jQuery Certification" />
<input type="hidden" name="item_number" value="jQuery" />
<input type="hidden" name="amount" value="95.00" />
<input type="hidden" name="no_note" value="1" />
<input type="hidden" name="currency_code" value="USD" />
<input type="hidden" name="on0" value="Email" />E-mail address:<br>
<input type="text" name="os0" maxlength="200" size="30" />
<a onclick="clickRegister();return false;" class="tryitbtn" style="display:inline;padding-left:10px;padding-right:10px;font-size:120%;" href="cert_jquery_reg.asp">Register Now</a>
<br><br>
<img src="icon_paypal.gif" alt="PayPal" />&nbsp;
<img src="icon_visa.gif" alt="Visa" />&nbsp;
<img src="icon_mastercard.gif" alt="MasterCard" />&nbsp;
<img src="icon_discover.gif" alt="Discover" />&nbsp;
<img src="icon_amex.gif" alt="Amex" />&nbsp;
<br>
</form>
<br>
<br><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="cert_jquery_reg.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="cert_jquery_reg.asp#top" target="_top">TOP</a> |
		<a href="cert_jquery_reg.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
