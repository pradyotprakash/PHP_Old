...
<title>CSS Certification</title>
<style>a.menu_cert_css{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">CSS</span> Certification</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="cert_html5.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="cert_javascript.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The CSS Certification requires skills in CSS.</p>
<hr>
<table style="width:100%">
<tr>
<td style="width:155px;height:210px">
<img src="pic_css_cert_small.gif" alt="CSS Certificate" height="207" width="146" style="border:1px solid #888888" />
</td>
<td style="padding:10px">
	<h2 style="margin-top:0px;">CSS Certificate</h2>
	<p>The CSS Developer Certificate proves fundamental knowledge of web development using 
	advanced CSS.</p>
	<br>
	<div><span style="color:#444444;">Price:</span><span style="font-size:150%;color:#900B09"> $95.00</span></div>
	<br>
	<a class="tryitbtn" style="width:200px;font-size:120%;margin-top:5px;" href="cert_css_reg.asp">Get Certified now!</a>
</td>
</tr>
</table>
<br>
<hr>
<h2>The CSS Developer Certificate</h2>
<p>CSS is used to control the style and layout of multiple web pages all at 
once.</p>
<p>CSS enables you to change the appearance and layout of all the pages in a Web 
site.</p>
<p>The CSS Developer Certificate proves fundamental knowledge of web development using 
advanced CSS.</p>
<p><a target="_blank" href="cert_pic.asp?imgsrc=CSS">CSS Developer Certificate</a></p>
<hr>

<h2>Prerequisites</h2>
<p>Before you apply for your exam, you should have a fundamental knowledge of:</p>
<ul>
  <li>Cascading Style Sheets - CSS1 and CSS2</li>
</ul>
<hr>

<h2>Recommended Studies And Training</h2>
<p>All questions in the exam are based on the content of W3Schools' CSS 
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="../css/default.asp">CSS Tutorial</a></td>
    <td><a href="http://www.w3schools.com/quiztest/quiztest.asp?qtest=CSS">CSS Quiz</a></td>
  </tr>
</table>
<br>
<hr>
...
<h2>The CSS Exam</h2>
<p>The CSS exam will be taken over the Internet, at any time and from any location, but the exam should be supervised by a person selected by the exam candidate.</p>
...
you a CSS Developer Certificate. The document will contain your personal data acknowledging your status as a Certified 
CSS Developer.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="cert_css.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="cert_css.asp#top" target="_top">TOP</a> |
		<a href="cert_css.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
