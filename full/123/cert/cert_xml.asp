...
<title>XML Certification</title>
<style>a.menu_cert_xml{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">XML</span> Certification</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="cert_jquery.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="cert_asp.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The XML Certification requires skills in XML, XML DOM and XSLT.</p>
<hr>
<table style="width:100%">
<tr>
<td style="width:155px;height:210px">
<img src="pic_xml_cert_small.gif" alt="XML Certificate" height="206" width="146" style="border:1px solid #888888" />
</td>
<td style="padding:10px">
	<h2 style="margin-top:0px;">XML Certificate</h2>
	...
	<br>
	<a class="tryitbtn" style="width:200px;font-size:120%;margin-top:5px;" href="cert_xml_reg.asp">Get Certified now!</a>
</td>
</tr>
</table>
<br>
<hr>
<h2>The XML Developer Certificate</h2>
<p>XML is used in many aspects of web development, often to simplify data storage and data sharing. XML is the most common tool for data-transmissions 
between all sorts of applications.</p>
<p>The XML DOM (XML Document Object Model) defines a standard way for accessing and manipulating XML documents.</p>
<p>XSLT is the style sheet language of XML.</p>
<p>The XML Developer Certificate proves fundamental knowledge of web development using XML, XML DOM and XSLT.</p>
<p><a target="_blank" href="cert_pic.asp?imgsrc=XML">XML Developer Certificate</a></p>
<hr>
...
<p>All questions in the exam are based on the content of W3Schools' XML, XML DOM and XSLT tutorials. We 
strongly recommend the following tutorials and quizzes:</p>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="../xml/default.asp">XML Tutorial</a></td>
    <td><a href="http://www.w3schools.com/quiztest/quiztest.asp?qtest=XML">XML Quiz</a></td>
  </tr>
  <tr>
    <td><a href="../dom/default.asp">XML DOM Tutorial</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><a href="../xsl/default.asp">XSLT Tutorial</a></td>
    <td>&nbsp;</td>
  </tr>
  </table>
<br>
...
<h2>The XML Exam</h2>
<p>The XML exam will be taken over the Internet, at any time and from any location, but the exam should be supervised by a person selected by the exam candidate.</p>
...
you an XML Developer Certificate. The document will contain your personal data acknowledging your status as a Certified XML Developer.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="cert_xml.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="cert_xml.asp#top" target="_top">TOP</a> |
		<a href="cert_xml.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
