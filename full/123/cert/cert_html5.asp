...
<title>HTML5 Certification</title>
<style>a.menu_cert_html5{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">HTML5</span> Certification</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="cert_html.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="cert_css.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The HTML5 Certification requires skills in HTML5.</p>
<hr>
<table style="width:100%">
<tr>
<td style="width:155px;height:210px">
<img src="pic_html5_cert_small.gif" alt="HTML5 Certificate" height="206" width="146" style="border:1px solid #888888" />
</td>
<td style="padding:10px">
	<h2 style="margin-top:0px;">HTML5 Certificate</h2>
	<p>The HTML5 Developer Certificate proves fundamental knowledge of web development using HTML5.</p>
	<br>
	<div><span style="color:#444444;">Price:</span><span style="font-size:150%;color:#900B09"> $95.00</span></div>
	<br>
	<a class="tryitbtn" style="width:200px;font-size:120%;margin-top:5px;" href="cert_html5_reg.asp">Get Certified now!</a>
</td>
</tr>
</table>
<br>
<hr>
<h2>The HTML5 Developer Certificate</h2>
<p>HTML5 is the new HTML standard.</p>
<p>The previous version of HTML, HTML 4.01, came in 1999. The web has changed a lot since then. </p>
<p>HTML5 is still a work in progress. However, the major 
browsers support many of the new HTML5 elements and APIs.</p>
<p>This exam covers the new elements, attributes and objects introduced in 
HTML5. </p>
<p><a target="_blank" href="cert_pic.asp?imgsrc=HTML5">HTML5 Developer Certificate</a></p>
<hr>
...
<p>All questions in the exam are based on the content of W3Schools' HTML tutorial. We strongly recommend the following tutorial and quiz:</p>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="../html/html5_intro.asp">HTML5 Tutorial</a></td>
    <td><a href="http://www.w3schools.com/quiztest/quiztest.asp?qtest=HTML5">HTML5 Quiz</a></td>
  </tr>
  </table>
<br>
<hr>

<h2>The HTML5 Exam</h2>
<p>The HTML5 exam will be taken over the Internet, at any time and from any location, but the exam should be supervised by a person selected by the exam candidate.</p>
...
you an HTML5 Developer Certificate. The document will contain your personal data acknowledging your status as a Certified HTML5 Developer.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="cert_html5.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="cert_html5.asp#top" target="_top">TOP</a> |
		<a href="cert_html5.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
