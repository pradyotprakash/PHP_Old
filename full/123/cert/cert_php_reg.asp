...
<style>a.menu_cert_php_reg{font-weight:bold;}</style>
<meta charset="utf-8">
...
<input type="hidden" name="item_name" value="PHP Certification" />
...
<a onclick="clickRegister();return false;" class="tryitbtn" style="display:inline;padding-left:10px;padding-right:10px;font-size:120%;" href="cert_php_reg.asp">Register Now</a>
<br><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="cert_php_reg.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="cert_php_reg.asp#top" target="_top">TOP</a> |
		<a href="cert_php_reg.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
