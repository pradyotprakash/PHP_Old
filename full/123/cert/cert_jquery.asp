...
<title>jQuery Certification</title>
<style>a.menu_cert_jquery{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">jQuery</span> Certification</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="cert_javascript.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="cert_xml.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The jQuery Certification requires skills in jQuery.</p>
<hr>
<table style="width:100%">
<tr>
<td style="width:155px;height:210px">
<img src="pic_jquery_cert_small.gif" alt="jQuery Certificate" height="207" width="146" style="border:1px solid #888888" />
</td>
<td style="padding:10px">
	<h2 style="margin-top:0px;">jQuery Certificate</h2>
	<p>The jQuery Developer Certificate proves fundamental knowledge of web development using 
	the jQuery library.</p>
	<br>
	<div><span style="color:#444444;">Price:</span><span style="font-size:150%;color:#900B09"> $95.00</span></div>
	<br>
	<a class="tryitbtn" style="width:200px;font-size:120%;margin-top:5px;" href="cert_jquery_reg.asp">Get Certified now!</a>
</td>
</tr>
</table>
<br>
<hr>
<h2>The jQuery Developer Certificate</h2>
...
<p><a target="_blank" href="cert_pic.asp?imgsrc=JQUERY">jQuery Developer Certificate</a></p>
<hr>

<h2>Prerequisites</h2>
<p>Before you apply for the exam, you should have a fundamental knowledge of:</p>
<ul>
  <li>jQuery</li>
</ul>
<hr>
...
<p>All questions in the exam are based on the content of W3Schools' jQuery 
tutorial. We strongly recommend the following tutorial and quiz:</p>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="../jquery/default.asp">jQuery Tutorial</a></td>
    <td><a href="http://www.w3schools.com/quiztest/quiztest.asp?qtest=jQuery">jQuery Quiz</a></td>
  </tr>
</table>
<br>
<hr>

<h2>The jQuery Exam</h2>
<p>The jQuery exam will be taken over the Internet, at any time and from any location, but the exam should be supervised by a person selected by the exam candidate.</p>
...
you a jQuery Developer Certificate. The document will contain your personal data acknowledging your status as a Certified 
jQuery Developer.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="cert_jquery.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="cert_jquery.asp#top" target="_top">TOP</a> |
		<a href="cert_jquery.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
