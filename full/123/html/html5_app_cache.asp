...
<style>a.menu_html5_app_cache{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML5 <span class="color_h1">Application Cache</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="html5_webstorage.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html5_webworkers.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">With HTML5 it is easy to make an offline version of a web application, by creating a cache manifest file.</p>
<hr>
...
<ol>
	...
	<li>Reduced server load - the browser will only download updated/changed resources 
	from the server</li>
</ol>
<hr>
...
<p>Internet Explorer 10, Firefox, Chrome, Safari and Opera support Application cache.</p>
<hr>

<h2>HTML5 Cache Manifest Example</h2>
<p>The example below shows an HTML document with a cache manifest (for offline browsing):</p>
<div class="example">
...
<div class="example_code notranslate">
	...
	&lt;/html&gt;</div>
<br>
<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml5_html_manifest" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Cache Manifest Basics</h2>
...
<p>Every page with the manifest attribute specified will be cached when the user visits it. If the 
...
<td>A manifest file needs to be served with the 
<b>correct MIME-type</b>, which is &quot;text/cache-manifest&quot;. Must be configured on the web server.</td>
</tr></table>
<br>
...
<p>The manifest file has three sections:</p>
<ul>
...
<p>The first line, CACHE MANIFEST, is required:</p>
<div class="code notranslate"><div>
CACHE MANIFEST<br>
/theme.css<br>
/logo.gif<br>
...
<p>The manifest file above lists three resources: a CSS file, a GIF image, and a 
...
not connected to the internet, the resources will still be available.</p>

<h3>NETWORK</h3>
<p>The NETWORK section below specifies 
that the file &quot;login.asp&quot; should never be cached, and will not be 
available offline:</p>
...
<p>An asterisk can be used to indicate that all other resources/files require an internet connection:</p>
...
<h3>FALLBACK</h3>
<p>The FALLBACK section below specifies that &quot;offline.html&quot; will be served 
in place of all files in the /html/ catalog, in case an internet connection 
...
<p><strong>Note:</strong> The first URI is the resource, the second is the fallback.</p>
<hr>
...
<h2>Example - Complete Cache Manifest File</h2>
<div class="code notranslate"><div>
CACHE MANIFEST<br>
...
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Tip:</b> Lines starting with a &quot;#&quot; are comment lines, but can also serve another 
purpose. An application's cache is only updated when its manifest file changes. If you edit an image or change a JavaScript function,
those changes will not be re-cached. Updating the date and version in a comment line is one way to make the browser re-cache your files.</td>
</tr></table>
<br>

<hr>
<h2>Notes on Application Cache</h2>
<p>Be careful with what you cache.</p>
<p>Once a file is cached, the browser will continue to show the cached version, even if you change the file on the server. To ensure the browser 
updates the cache, you need to change the manifest file.</p>
<p><strong>Note:</strong> Browsers may have different size limits for cached data (some browsers have a 5MB limit per site).</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="html5_webstorage.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html5_webworkers.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html5_app_cache.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html5_app_cache.asp#top" target="_top">TOP</a> |
		<a href="html5_app_cache.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
