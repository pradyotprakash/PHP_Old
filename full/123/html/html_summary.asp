...
<style>a.menu_html_summary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>You Have Learned HTML, <span class="color_h1">Now What?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="html5_exam.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="../tags/default.asp">Next Chapter &raquo;</a></div>
</div>
<hr><h2>HTML Summary</h2>
<p>This tutorial has taught you how to use HTML to create your own web site.</p>
<p>HTML is the universal markup language for the Web. HTML lets you format text, add graphics, 
create links, input forms, frames and tables, etc., and save it all in a text file that any
browser can read and display.</p>
<p>The key to HTML is the tags, which indicates what content is coming up.</p>
<p>For more information on HTML, please take a look at our <a href="html_examples.asp">
HTML examples</a> and our <a href="../tags/default.asp">HTML reference</a>.</p>
<hr>
...
<p>To learn how to create style sheets, please visit our <a href="../css/default.asp">CSS tutorial</a>.</p>
<hr>
...
<p>If you want to learn more about JavaScript, please visit our <a href="../js/default.asp">JavaScript tutorial</a>.</p>
<hr>

<h2>Hosting your own Web site</h2>
<p>Hosting your web site on your own server is always an option. Here are some 
points to consider:</p>

<h3>Hardware Expenses</h3>
<p>To run a &quot;real&quot; web site, you will have to buy some powerful 
server hardware. Don't expect that a low cost PC will do the job. You will also 
need a permanent (24 hours a day ) high-speed connection.</p>

<h3>Software Expenses</h3>
<p>Remember that server-licenses often are higher than client-licenses.
Also note that server-licenses might have limits on number of users.</p>

<h3>Labor Expenses</h3>
<p>Don't expect low labor expenses. You have to install your own hardware and software.
You also have to deal with bugs and viruses, and keep your server constantly running in
an environment where &quot;everything could happen&quot;.</p>
<hr>

<h2>Using an Internet Service Provider</h2>
<p>Renting a server from an Internet Service Provider (ISP) is a common option. </p>
<p>Most small companies store their web site on a server provided by an ISP. Here are some advantages:</p>

<h3>Connection Speed</h3>
<p>Most ISPs have very fast connections to the internet.</p>

<h3>Powerful Hardware</h3>
<p>ISPs often have powerful web servers that can be shared by several companies.
You can also expect them to have an effective load balancing, and necessary backup servers. </p>

<h3>Security and Stability</h3>
<p>ISPs are specialists on web hosting. Expect their servers to have more than 99% up time,
the latest software patches, and the best virus protection.</p>
<hr>

<h2>Things to Consider with an ISP</h2>

<h3>24-hour support</h3>
<p>Make sure your ISP offers 24-hours support. Don't put 
...
want to pay for long distance calls.</p>

<h3>Daily Backup</h3>
<p>Make sure your ISP runs a daily backup routine, otherwise you may lose some valuable data.</p>

<h3>Traffic Volume</h3>
<p>Study the ISP's traffic volume restrictions. Make sure that you don't have to pay a fortune for unexpected
high traffic if your web site becomes popular.</p>

<h3>Bandwidth or Content Restrictions</h3>
<p>Study the ISP's bandwidth and content restrictions. If you plan to publish pictures or broadcast video or sound, make sure that you can.</p>

<h3>E-mail Capabilities</h3>
<p>Make sure your ISP supports the e-mail capabilities you need.</p>

<h3>Database Access</h3>
<p>If you plan to use data from databases on your web site, make sure your ISP supports the database access you need.</p>
<hr>

<div style="width:auto;margin:auto">
<a href="../cert/default.asp"><img src="http://www.w3schools.com/images/w3cert.gif" style="float:left;margin-right:40px;margin-top:40px;margin-bottom:40px" alt="W3Schools Certification" /></a> 
<br>
...
<p><a class="tryitbtn" style="width:200px;font-size:14px;margin-left:0px;margin-top:5px;" href="../cert/default.asp">Get Your Certificate &raquo;</a></p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_summary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_summary.asp#top" target="_top">TOP</a> |
		<a href="html_summary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
