...
<h1>HTML4 and HTML5<span class="color_h1"> Tutorial</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="../default.asp">&laquo; W3Schools Home</a></div>
<div class="next"><a class="chapter" href="html_intro.asp">Next Chapter &raquo;</a></div>
</div>
<br>

<div class="tutintro">
<img src="http://www.w3schools.com/images/w3html.gif" alt="HTML" width="100" height="132">
...
<br>
<a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_intro" class="tryitbtn">Try it yourself &raquo;</a>
<p>Click on the &quot;Try it yourself&quot; button to see how it works</p>
</div>

<p><a href="html_intro.asp">Start learning HTML now!</a></p>

<hr><h2>HTML Examples</h2>

<p>At the end of the HTML tutorial you will find more than 100 examples you can 
edit and test yourself.</p>
<p><a href="html_examples.asp">Goto HTML Examples!</a></p>

<hr><h2>HTML Quiz Test</h2>
<p>Test your HTML skills at W3Schools!</p>
<p><a href="html_quiz.asp">Start HTML Quiz!</a></p>

<hr><h2>HTML References</h2>
<p>At W3Schools you will find complete references about tags, standard 
attributes, standard events, colornames, entities, character-sets, URL encoding, 
language codes, HTTP messages, and more.</p>
<p>
<a href="../tags/default.asp">HTML Tag Reference</a>
</p>

<hr><h2>HTML Exam - Get Your Diploma!</h2>
