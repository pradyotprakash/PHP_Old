...
<style>a.menu_html_paragraphs{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">Paragraphs</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="html_headings.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_formatting.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">HTML documents are divided into paragraphs.</p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_paragraphs1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p><b>Note:</b> Browsers automatically add an empty line before and after a paragraph.</p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_paragraphs0" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>The example above will work in most browsers, but don't rely on it.
Forgetting the end tag can produce unexpected results or errors.</p>
<p><b>Note:</b> Future version of HTML will not allow you to skip end tags.</p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_paragraphs" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>The &lt;br&gt; element is an empty HTML element. It has no end tag.</p>
<hr>

<h2>HTML Output - Useful Tips</h2>
<p>You cannot be sure how HTML will be displayed. Large or small screens,
and resized windows will create different results. </p>
<p>With HTML, you cannot change the output by adding extra spaces or extra lines in your HTML code.</p>
<p>The browser will remove extra spaces and extra lines when the page is displayed.
Any number of lines count as one line, and any number of spaces count as one space.</p>
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_poem">Try it yourself</a></p>
<p>(The example demonstrates some HTML formatting problems)</p>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_paragraphs1">HTML paragraphs</a><br>
How HTML paragraphs are displayed in a browser.
</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_paragraphs">Line breaks</a><br>
The use of line breaks in an HTML document.
</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_poem">Poem problems</a><br>
Some problems with HTML formatting.
</p>

<h2>More Examples</h2>
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_paragraphs2">More paragraphs</a><br>
The default behaviors of paragraphs.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_paragraphs.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_paragraphs.asp#top" target="_top">TOP</a> |
		<a href="html_paragraphs.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
