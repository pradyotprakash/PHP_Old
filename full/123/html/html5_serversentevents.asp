...
<style>a.menu_html5_serversentevents{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html5_webworkers.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_media.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">HTML5 Server-Sent Events allow a web page to get updates from a server.</p>
<hr>
...
<p>Server-Sent Events are supported in all major browsers, except Internet Explorer.</p>
<hr>
...
<div class="example_code notranslate">
	var source = new EventSource(&quot;demo_sse.php&quot;);<br>source.onmessage = function(event) {<br>&nbsp; 
	document.getElementById(&quot;result&quot;).innerHTML + =event.data + &quot;&lt;br&gt;&quot;;<br>&nbsp; 
	};</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml5_sse" target="_blank">Try it yourself  &raquo;</a>
</div>
...
<div class="code notranslate"><div>
	...
	header('Cache-Control: no-cache');<br><br>$time = date('r');<br>echo &quot;data: 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html5_serversentevents.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html5_serversentevents.asp#top" target="_top">TOP</a> |
		<a href="html5_serversentevents.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
