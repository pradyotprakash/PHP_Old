...
<style>a.menu_html_images{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html_css.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_tables.asp">Next Chapter &raquo;</a></div>
</div>
<br>
<div class="example">
...
<img style="border:0px" src="http://www.w3schools.com/images/pulpit.jpg" alt="Pulpit Rock"></div>
<br><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_pulpitimage" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_images">Insert images</a><br>
How to insert images into an HTML document.</p>
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_images2">Insert images from different locations</a><br>
How to insert an image from another folder or another server.</p>
<p>(You can find more examples at the bottom of this page).</p>
<hr>

<h2>HTML Images - The &lt;img&gt; Tag and the Src Attribute</h2>
<p>In HTML, images are defined with the &lt;img&gt; tag.</p>
<p>The &lt;img&gt; tag&nbsp;is empty, which means that it contains attributes only, and has no closing tag.</p>
<p>To display an image on a page, you need to use the src attribute. Src stands for &quot;source&quot;.
The value of the src attribute is the URL of the image you want to display.</p>
<p><b>Syntax for defining an image:</b></p>
<div class="code notranslate"><div>
&lt;img src=&quot;<i>url</i>&quot; alt=&quot;<i>some_text</i>&quot;&gt;</div></div>

<p>The URL points to the location where the image is stored. An image named &quot;boat.gif&quot;, located in the 
&quot;images&quot; directory on &quot;www.w3schools.com&quot; has the URL: http://www.w3schools.com/images/boat.gif.</p>
<p>The browser displays the image where the &lt;img&gt; tag occurs in the document. If you put an image tag between two
paragraphs, the browser shows the first paragraph, then the image, and then the second paragraph.</p>
<hr>

<h2>HTML Images - The Alt Attribute</h2>
<p>The required alt attribute specifies an alternate text for an image, if the image cannot be displayed.</p>
<p>The value of the alt attribute is an author-defined text:</p>

<div class="code notranslate"><div>
&lt;img src=&quot;smiley.gif&quot; alt=&quot;Smiley face&quot;&gt;</div></div>

<p>The alt attribute provides alternative information for an image if a user for 
some reason cannot view it (because of slow connection, an error in the src 
attribute, or if the user uses a screen reader).</p>
<hr>

<h2>HTML Images - Set Height and Width of an Image</h2>
<p>The height and width attributes are used to specify the height and width of an image.</p>
<p>The attribute values are specified in pixels by default:</p>
<div class="code notranslate"><div>
&lt;img src=&quot;smiley.gif&quot; alt=&quot;Smiley face&quot; width=&quot;42&quot; height=&quot;42&quot;&gt;</div></div>
<p>
<strong>Tip:</strong> It is a good practice to specify both the height and width 
...
page layout will change during loading (while the images load).</p>
<hr>

<h2>Basic Notes - Useful Tips</h2>
<p><b>Note:</b> If an HTML file contains ten images - eleven files are required to display the page
right. Loading images takes time, so my best advice is: Use images carefully.</p>
<p><b>Note:</b> When a web page is loaded, it is the browser, at that moment, 
...
link icon is shown if the browser cannot find the image.</p>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_image_float">Let an image float to the left and to the right</a><br>
How to let an image float to the left or right of a paragraph.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_imglink">Make a hyperlink of an image</a><br>
How to use an image as a link.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_areamap">Create an image map</a><br>
How to create an image map, with clickable regions. Each region is a hyperlink.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_images.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_images.asp#top" target="_top">TOP</a> |
		<a href="html_images.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
