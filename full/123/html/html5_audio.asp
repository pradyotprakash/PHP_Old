...
<style>a.menu_html5_audio{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html5_video.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html5_geolocation.asp">Next Chapter &raquo;</a></div>
</div>
<hr><p class="intro">HTML5 provides a standard for playing audio files.</p>
<hr><h2>Audio on the Web</h2>
<p>Before HTML5, there was no standard for playing audio files on a web page.</p>
<p>Before HTML5, audio 
files had to be played with a plug-in (like flash). However, different browsers 
supported different plug-ins.</p>
<p>HTML5 defines a new element which specifies a standard way to embed an audio 
file on a web page: 
the &lt;audio&gt; 
element.</p>
...
<p>Internet Explorer 9+, Firefox, Opera, Chrome, and Safari support the &lt;audio&gt; element.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the 
&lt;audio&gt; element.</p>
<hr><h2>HTML5 Audio - How It Works</h2>
...
<br>
<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml5_audio_all" target="_blank">Try it yourself  &raquo;</a>
</div>

<p>The control attribute adds audio controls, like play, pause, and volume.</p>
<p>You should also insert text content between the &lt;audio&gt; and &lt;/audio&gt; tags for browsers that do not 
support the &lt;audio&gt; element.</p>
<p>The &lt;audio&gt; element allows multiple &lt;source&gt; elements. &lt;source&gt; elements can link to 
different audio 
files. The browser will use the first recognized format.</p>
<hr><h2>Audio Formats and Browser Support</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html5_audio.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html5_audio.asp#top" target="_top">TOP</a> |
		<a href="html5_audio.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
