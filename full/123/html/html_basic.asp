...
<style>a.menu_html_basic{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html_editors.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_elements.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Don't worry if the examples use tags you have not learned.</p>
...
<p><b>Note:</b> The link address is specified in the href attribute.</p>
<p>(You will learn about attributes in a later chapter of this tutorial).</p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_basic_img" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p><b>Note:</b> The filename and the size of the image are provided as attributes.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_basic.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_basic.asp#top" target="_top">TOP</a> |
		<a href="html_basic.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
