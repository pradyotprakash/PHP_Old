...
<title>Multimedia Introduction</title>
<style>a.menu_html_media{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML<span class="color_h1"> Multimedia</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="html5_serversentevents.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_object.asp">Next Chapter &raquo;</a></div>
</div>
<hr><p class="intro">Multimedia on the web is sound, music, videos, movies, and animations.</p>
<hr><h2>What is Multimedia?</h2>
<p>Multimedia comes in many different formats. It can be almost anything you can hear or see.</p>
<p>Examples: Pictures, music, 
sound, videos, records, films, animations, and more.</p>

<p>Modern web pages often have 
embedded multimedia elements, and modern browsers have 
support for various multimedia formats. </p>

<p>In this tutorial you will learn about the different multimedia formats.</p>
<hr><h2>Internet Browser Support</h2>
<p>The first Internet browsers had support for text only, and even the text 
support was limited to a single font in a single color. Then came browsers with support for colors, fonts and text styles, and 
support for pictures was also added.</p>
<p>The support for sounds, animations, and videos is handled in different ways 
by various browsers. Some multimedia elements is supported, and some requires an 
extra helper program (a plug-in) to work.</p>
<p>You will learn more about plug-ins in the next chapters. </p>
<hr><h2>Multimedia Formats</h2>
<p>Multimedia elements (like sounds or videos) are stored in media files. </p>
<p>The most common way to discover the type of a file, is to look at the file 
extension. When a browser sees the file extension .htm or .html, it will treat the 
file as an HTML file. The .xml extension indicates an XML file, and the .css 
extension indicates a style sheet file. Pictures are recognized by extensions like .gif, 
.png and .jpg.</p>
<p>Multimedia files also have their own formats and different extensions 
like: .swf, .wav, .mp3, .mp4, .mpg, .wmv, and .avi.</p>

<hr><h2>Video Formats</h2>
<table>
<tr><td>
<img alt="Videoformats" height="109" src="pic_video.jpg"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td style="vertical-align:top">MP4 is the new and upcoming format for internet video.<br>
<br>MP4 is 
recommended by YouTube.<br><br>MP4 is supported by Flash players and HTML5. <br>
<br>
</td>
</tr></table>
...
playable on all Windows computers. It is commonly used in video cameras and TV 
hardware, but is difficult to play on non-Windows computers.</td>
</tr>
<tr>
<td>WMV</td>
<td>.wmv</td>
<td>
WMV (Windows Media Video) was developed by Microsoft, and is therefore playable 
on all Windows computers. It is commonly used in video cameras and by TV 
hardware, but is difficult to play on non-Windows computers.</td>
</tr>
<tr>
<td>QuickTime</td>
...
computers. It is commonly used in video cameras and by TV hardware, but is 
difficult to play on non-Apple computers.</td>
</tr>
<tr>
<td>RealVideo</td>
<td>.rm<br>.ram</td>
...
bandwidths. It is still used for online video and Internet TV, but because of 
the low bandwidth priority, the quality is also low.</td>
</tr>
<tr>
<td>Flash</td>
<td>.swf<br>.flv</td>
<td>
Flash was developed by Macromedia. Flash requires an extra component to play in 
a browser.</td>
</tr>
<tr>
<td>Ogg</td>
<td>.ogg</td>
<td>
Theora Ogg was developed by the Xiph.Org Foundation.</td>
</tr>
<tr>
<td>WebM</td>
<td>.webm</td>
<td>
WebM is a project (www.webmproject.org) by the web giants, Mozilla, 
Opera, Adobe, and Google.</td>
</tr>
<tr>
<td>MPEG</td>
<td>.mpg<br>.mpeg</td>
<td>
MPEG, developed by 
the Moving Pictures Expert Group, used to be the most popular video format on 
the Internet. It used to be supported by all major browsers, but it is 
not supported by HTML5. </td>
</tr>
<tr>
<td>MPEG-4<br>or MP4</td>
<td>.mp4</td>
<td>
MP4 is the upcoming format 
on the 
internet. It is supported by all major browsers in HTML5. YouTube recommends using MP4, 
and it is 
commonly used in newer video cameras and TV hardware. 
</td>
</tr>
</table>
<br>
...
<td>Only MP4, WebM, and Ogg video is supported by the newest HTML5 standard.</td>
</tr></table>
<br>
<hr>

<h2>Sound Formats</h2>
<p>MP3 is the newest format for compressed recorded music. The 
...
<td>.mid<br>.midi</td>
<td>
MIDI (Musical Instrument Digital Interface) is a format for electronic 
music devices like synthesizers and PC sound cards. MIDI files do not contain sound, but digital musical 
instructions (notes) that can be played by electronics (like your PC's sound card).
<p><a target="_blank" href="beatles.mid">Click here to play The Beatles</a>.</p>
Since MIDI files only contains instructions; they are extremely small. The example above is only 23K in 
size, but it plays for nearly 5 minutes. MIDI is supported by many software systems/platforms. 
Because it is the main format for binary music, it is supported by most 
...
<td>.rm<br>.ram</td>
<td>
RealAudio was developed Real Media 
to allow streaming of audio (online music, Internet radio) with low 
bandwidths.</td>
</tr>
<tr>
<td>WMA</td>
<td>.wma</td>
<td>
WMA (Windows Media Audio), compares in quality to MP3, and is compatible with 
most music players, except the iPod. WMA files can be delivered as a continuous 
flow of data, which makes it practical for use in Internet radio or on-line 
music.</td>
</tr>
<tr>
<td>AAC</td>
<td>.aac</td>
<td>
AAC (Advanced Audio Coding) was developed by Apple as the default format for 
iTunes.</td>
</tr>
<tr>
<td>WAV</td>
...
is compatible 
with Windows, Macintosh, and Linux operating systems.</td>
</tr>
<tr>
<td>Ogg</td>
<td>.ogg</td>
<td>
&nbsp;Ogg was developed by the Xiph.Org Foundation.</td>
</tr>
<tr>
<td>MP3</td>
<td>.mp3</td>
...
MP3 is the most popular format for music players. The encoding system combines good 
compression (small files) with high quality. It is supported by all major browsers.</td>
</tr>
<tr>
<td>MP4</td>
<td>.mp4</td>
<td>
MP4 
is a video format, but it can also be used with audio only. MP4 
video is the upcoming video format on the internet. This can lead to an 
automatic support for MP4 audio by all major browsers.</td>
</tr>
</table>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>Only MP3, WAV, and Ogg audio is supported by the newest HTML5 standard.</td>
</tr></table>
<br>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_media.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_media.asp#top" target="_top">TOP</a> |
		<a href="html_media.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
