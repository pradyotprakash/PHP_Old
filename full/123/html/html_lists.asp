...
<style>a.menu_html_lists{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html_tables.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_blocks.asp">Next Chapter &raquo;</a></div>
</div>
<hr><p class="intro">The most common HTML lists are ordered and unordered lists:</p>

<div class="example">
<h2 class="example">HTML Lists</h2>
...
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_lists4">Unordered list</a><br>
How to create an unordered list in an HTML document.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_lists">Ordered list</a><br>
How to create an ordered list in an HTML document.</p>

<p>(You can find more examples at the bottom of this page).</p>
<hr><h2>HTML Unordered Lists</h2>
<p>An unordered list starts with the &lt;ul&gt; tag. Each list item starts with the &lt;li&gt; tag.</p>

<p>The list items are marked with bullets (typically
...
<p>How the HTML code above looks in a browser:</p>
<ul>
  <li>Coffee</li>
  <li>Milk</li>
</ul>
<hr><h2>HTML Ordered Lists</h2>
<p>An ordered list starts with the &lt;ol&gt; tag. Each list item starts with the &lt;li&gt; tag.</p>
<p>The list items are marked with
numbers.</p>
<div class="code notranslate"><div>
...
<hr><h2>HTML Description Lists</h2>
<p>A description list is a list of terms/names, with a description of each 
term/name.</p>
<p>The &lt;dl&gt; tag defines a description list.</p>
<p>The &lt;dl&gt; tag is used in conjunction with &lt;dt&gt; (defines 
terms/names) 
and &lt;dd&gt; (describes each term/name):</p>
<div class="code notranslate"><div>
...
<hr><h2>Basic Notes - Useful Tips</h2>
<p><b>Tip:</b> Inside a list item you can put text, line breaks, images, links, other lists, etc.</p>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_lists_ordered">Different types of ordered lists</a><br>
Demonstrates different types of ordered lists.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_lists_unordered">Different types of unordered lists</a><br>
Demonstrates different types of unordered lists.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_lists2">Nested list</a><br>
Demonstrates how you can nest lists.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_nestedlists2">Nested list 2</a><br>
Demonstrates a more complicated nested list.</p>

<p><a href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_lists3" target="_blank">Description list</a><br>
Demonstrates a definition list.</p>
<hr><h2>HTML List Tags</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_lists.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_lists.asp#top" target="_top">TOP</a> |
		<a href="html_lists.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
