...
<style>a.menu_html_symbols{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">Symbols</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="html_entities.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_charset.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>HTML Symbol Entities</h2>
<p>HTML entities was described in the previous chapter.</p>
<p>HTML symbols like mathematical operators, arrows, technical symbols and shapes, 
are not present on a normal keyboard.</p>
<p>To add these symbols to an HTML page, you can use the HTML entity name.</p>
<p>If no entity name exists, you can use the entity number.</p>
<p>If the character does not have an entity name, you can use a decimal (or hexadecimal) reference.</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>If you use an HTML entity name, or number, the character will always display 
...
<br>
<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryutf_euro" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p><a href="../charsets/ref_utf_currency.asp">Full Currency Reference</a></p>
<p><a href="../charsets/ref_utf_arrows.asp">Full Arrows Reference</a></p>
<p><a href="../charsets/ref_utf_symbols.asp">Full Symbols Reference</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="html_entities.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_charset.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_symbols.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_symbols.asp#top" target="_top">TOP</a> |
		<a href="html_symbols.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
