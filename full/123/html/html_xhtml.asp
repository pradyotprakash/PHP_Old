...
<style>a.menu_html_xhtml{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html_urlencode.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html5_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr><p class="intro">XHTML is HTML written as XML.</p>
<hr><h2>What Is XHTML?</h2>
<ul>
...
<p>The following HTML code will work fine if you view it in a browser (even if it does 
NOT follow the HTML rules):</p>
...
<p>XML is a markup language where documents must be marked up correctly and &quot;well-formed&quot;.</p>
...
small devices. Smaller devices often lack the resources or power to interpret a &quot;bad&quot; markup language.</p>
<p>Therefore - by combining the strengths of HTML and XML, XHTML was developed. XHTML is HTML redesigned as XML.</p>
<hr><h2>The Most Important Differences from HTML:</h2>
<h3>Document Structure</h3>
<ul>
	<li>XHTML DOCTYPE is <strong>mandatory</strong></li>
	<li>The XML namespace attribute in &lt;html&gt; is <strong>mandatory</strong></li>
	<li>&lt;html&gt;, &lt;head&gt;, &lt;title&gt;, and &lt;body&gt; is <strong>mandatory</strong></li>
</ul>
...
<hr><h2>&lt;!DOCTYPE ....&gt; Is Mandatory</h2>
<p>An XHTML document must have an XHTML DOCTYPE declaration.</p>

<p>A complete list of all the <a href="../tags/tag_doctype.asp">XHTML Doctypes</a> is found in 
our HTML Tags Reference.</p>
<p>The &lt;html&gt;, &lt;head&gt;, &lt;title&gt;, and &lt;body&gt; elements must also be present, and the xmlns attribute in &lt;html&gt;, 
must specify the xml namespace for 
the document.</p>

<p>The example below shows an XHTML document with a minimum of required tags:</p>
<div class="code notranslate"><div>
&lt;!DOCTYPE html
...
&lt;/html&gt;</div></div>
<br>
<hr><h2>XHTML Elements Must Be Properly Nested</h2>
...
<br>
<hr><h2>XHTML Elements Must Always Be Closed</h2>
...
<br>
<hr><h2>Empty Elements Must Also Be Closed</h2>
<p>This is wrong:</p>
<div class="code notranslate"><div>
A break: &lt;br&gt;<br>
...
An image: &lt;img src=&quot;happy.gif&quot; alt=&quot;Happy face&quot; /&gt;</div></div>
<br>
<hr><h2>XHTML Elements Must Be In Lower Case</h2>
...
&lt;/body&gt;</div></div>
<br>
<hr><h2>Attribute Names Must Be In Lower Case</h2>
<p>This is wrong:</p>
<div class="code notranslate"><div>
...
&lt;table width=&quot;100%&quot;&gt;</div></div>
<br>
<hr><h2>Attribute Values Must Be Quoted</h2>
<p>This is wrong:</p>
<div class="code notranslate"><div>
&lt;table width=100%&gt;</div></div>
...
&lt;table width=&quot;100%&quot;&gt;</div></div>
<br>
<hr><h2>Attribute Minimization Is Forbidden</h2>
<p>This is wrong:</p>
<div class="code notranslate"><div>
&lt;input checked&gt;<br>
&lt;input readonly&gt;<br>
...
&lt;input readonly=&quot;readonly&quot;&gt;<br>
	...
	&lt;option selected=&quot;selected&quot;&gt;</div></div>
<br>
<hr><h2>How to Convert from HTML to XHTML</h2>
<ol>
...
<hr><h2>Validate XHTML With The W3C Validator</h2>
<form method="get" action="http://validator.w3.org/check" target="_blank">
<p>Put your web address in the box below:</p>
<p><input name="uri" size="60" value="http://www.w3schools.com/html/demo_xhtml.asp"/></p>
<input type="submit" value="Validate the page"></form>
<hr><h2>XHTML Quiz Test</h2>
<p>The test contains 20 questions and there is no time limit.</p>
<p>The test is not official, it's just a nice way to see how much you know, or don't know, about XHTML.</p>
<p>You will get 1 point for each correct answer. At the end of the Quiz, your total score will be displayed.
Maximum score is 20 points.</p>
<p><a target="_top" href="http://www.w3schools.com/quiztest/quiztest.asp?qtest=XHTML">Start the XHTML Quiz</a><br>
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_xhtml.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_xhtml.asp#top" target="_top">TOP</a> |
		<a href="html_xhtml.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
