...
<style>a.menu_html_css{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html_head.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_images.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">CSS (Cascading Style Sheets) is used to style HTML elements.</p>
...
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_styles">Try it yourself</a></p>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_style">Using styles in HTML</a><br>
How to add style information inside the &lt;head&gt; section.</p>
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_linknoline">Link that is not underlined</a><br>
How to make a link that is not underlined, with the style attribute.</p>
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_link">Link to an external style sheet</a><br>
How to use the &lt;link&gt; tag to link to an external style sheet.</p>
<hr>

<h2>Styling HTML with CSS</h2>
<p>CSS was introduced together with HTML 4, to provide a better way to style HTML elements.</p>
<p>CSS can be added to HTML in the following ways:</p>
<ul>
	<li>Inline - using the style<strong> attribute</strong> in HTML elements</li>
	<li>Internal - using the &lt;style&gt;<strong> element</strong> in the &lt;head&gt; section</li>
	<li>External - using an external CSS<strong> file</strong></li>
</ul>
<p>The preferred way to add CSS to HTML, is to put CSS syntax in separate CSS files.</p>
...
the code and try it yourself. </p>
<p>You can learn everything about CSS in our <a href="../css/default.asp">CSS Tutorial</a>.</p>
<hr>

<h2>Inline Styles</h2>
<p>An inline style can be used if a unique style is to be applied to one single occurrence of an element.</p>
<p>To use inline styles, use the style attribute in the relevant tag. The
style attribute can contain any CSS property. The example below shows how to change
the text color and the left margin of a paragraph:</p>
<div class="code notranslate"><div>
&lt;p style=&quot;color:blue;margin-left:20px;&quot;&gt;This is a paragraph.&lt;/p&gt;
</div></div>
<p>
To learn more about style sheets, visit our <a href="../css/default.asp"> CSS tutorial</a>.
</p>
<hr>

<h2>HTML Style Example - Background Color</h2>
<p>The background-color property defines the background color for an element:</p>
<div class="example">
...
&lt;h2 style=&quot;background-color:red;&quot;&gt;This is a heading&lt;/h2&gt;<br>
&lt;p style=&quot;background-color:green;&quot;&gt;This is a paragraph.&lt;/p&gt;<br>
&lt;/body&gt;<br><br>
&lt;/html&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_bodybgstyle" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>The background-color property makes the &quot;old&quot; bgcolor attribute obsolete.</p>
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_bodybgcol">Try it yourself: Background color the old way</a></p>
<hr>

<h2>HTML Style Example - Font, Color and Size</h2>
<p>The font-family, color, and font-size properties defines the font, color, and size of the text in an element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;!DOCTYPE html&gt;<br>
&lt;html&gt;<br><br>
&lt;body&gt;<br>
&lt;h1 style=&quot;font-family:verdana;&quot;&gt;A heading&lt;/h1&gt;<br>
&lt;p style=&quot;font-family:arial;color:red;font-size:20px;&quot;&gt;A paragraph.&lt;/p&gt;<br>
&lt;/body&gt;<br><br>
&lt;/html&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_newfont" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>The font-family, color, and font-size properties make the old &lt;font&gt; tag obsolete.</p>
<hr>

<h2>HTML Style Example - Text Alignment</h2>
...
&lt;html&gt;<br><br>
&lt;body&gt;<br>
&lt;h1 style=&quot;text-align:center;&quot;&gt;Center-aligned heading&lt;/h1&gt;<br>
&lt;p&gt;This is a paragraph.&lt;/p&gt;<br>
&lt;/body&gt;<br><br>
&lt;/html&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_headeralign" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>The text-align property makes the old &lt;center&gt; tag obsolete.</p>
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_header">Try it yourself: 
Centered heading the old way</a></p>
<hr>

<h2>Internal Style Sheet</h2>
<p>An internal style sheet can be used if one single document has a unique
style. Internal styles are defined in the &lt;head&gt; section of an HTML page, by 
using the &lt;style&gt; tag, like this:</p>
<div class="code notranslate"><div>
&lt;head&gt;<br>
	&lt;style&gt;<br>
...
<p>In HTML 4, several tags and attributes were used to style documents. These tags are not supported in newer versions of HTML.</p>
<p>Avoid using the elements: &lt;font&gt;, &lt;center&gt;, and &lt;strike&gt;, and the attributes: color and bgcolor.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_css.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_css.asp#top" target="_top">TOP</a> |
		<a href="html_css.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
