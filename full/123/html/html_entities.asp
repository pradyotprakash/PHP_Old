...
<style>a.menu_html_entities{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html_scripts.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_symbols.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Reserved characters in HTML must be replaced with character 
entities.</p>
<p class="intro">Characters, not present on your keyboard, can also be replaced 
by entities.</p>
<hr>
<h2>HTML Entities</h2>
...
<td>The advantage of using an entity name, instead of a number, is that the name 
is easier to remember.<br>The disadvantage is that browsers may not support 
all entity names, but the support for numbers is 
good.</td>
</tr></table>
<br>

<hr><h2>Non Breaking Space</h2>
...
<hr><h2>Combining Diacritical Marks</h2>
<p>A diacritical mark is a &quot;glyph&quot; added to a letter.</p>
<p>Some diacritical marks, like acute (&nbsp; &#768;) and grave (&nbsp; &#769;) are called accents. </p>
...
<br>
<hr><h2>Some Other Useful HTML Character Entities</h2>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
...
<p>
You will see more about HTML symbols in the next chapter of this tutorial.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_entities.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_entities.asp#top" target="_top">TOP</a> |
		<a href="html_entities.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
