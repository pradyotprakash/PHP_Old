...
<style>a.menu_html_blocks{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">Blocks</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="html_lists.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_layout.asp">Next Chapter &raquo;</a></div>
</div>
<hr><p class="intro">HTML elements can be grouped together with &lt;div&gt; and &lt;span&gt;.</p>
<hr><h2>HTML Block Elements</h2>
<p>Most HTML elements are defined as <strong>block level</strong> elements or as
...
<hr><h2>HTML Inline Elements</h2>
<p>Inline elements are normally displayed without starting a new line. </p>
<p>Examples: &lt;b&gt;, &lt;td&gt;, &lt;a&gt;, &lt;img&gt;</p>
<hr><h2>The HTML &lt;div&gt; Element</h2>
<p>The HTML &lt;div&gt; element is a block level element that can be used as a 
container for grouping other HTML elements.</p>
<p>&nbsp;The &lt;div&gt; element has no special meaning. Except that, because it is a 
block level element, the browser will display a line break before and after it.</p>
<p>When used together with CSS, the &lt;div&gt; element can be used to set style 
attributes to large blocks of content.</p>
<p>Another common use of the &lt;div&gt; element, is for document layout. It replaces 
the &quot;old way&quot; of defining layout using tables. Using &lt;table&gt; elements 
for layout is not the correct use of &lt;table&gt;. The purpose of the &lt;table&gt; element is to display 
tabular data.</p>
<hr><h2>The HTML &lt;span&gt; Element</h2>
<p>The HTML &lt;span&gt; element is an inline element that can be used as a container 
for text.</p>
<p>The &lt;span&gt; element has no special meaning. </p>
<p>When used together with CSS, the &lt;span&gt; element can be used to set style 
attributes to parts of the text.</p>
<hr><h2>HTML Grouping Tags</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_blocks.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_blocks.asp#top" target="_top">TOP</a> |
		<a href="html_blocks.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
