...
<style>a.menu_html_editors{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_basic.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>Writing HTML Using Notepad or TextEdit</h2>
<p>HTML can be edited by using a professional HTML editor like:</p>
<ul>
	<li>Adobe Dreamweaver</li>
	<li>Microsoft Expression Web</li>
	<li>CoffeeCup HTML Editor</li>
</ul>
<p>However, for learning HTML we recommend a text editor like Notepad (PC) or TextEdit (Mac).
We believe using a simple text editor is a good way to learn HTML.</p>
<p>Follow the 4 steps below to create your first web page with Notepad.</p>
<hr>

<h2>Step 1: Start Notepad</h2>
<p>To start Notepad go to:</p>
<p><b>Start<br>&nbsp;&nbsp;&nbsp; All Programs<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
Accessories<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Notepad</b></p>
<hr>

<h2>Step 2: Edit Your HTML with Notepad</h2>
<p>Type your HTML code into your Notepad:</p>
<p><img alt="Notepad" height="232" src="pic_notepad.jpg" width="571"></p>
<hr>

<h2>Step 3: Save Your HTML</h2>
<p>Select <strong>Save as..</strong> in Notepad's file menu.</p>
<p>When you save an HTML file, you can use either the .htm or the .html file extension.
There is no difference, it is entirely up to you.</p>
<p>Save the file in a folder that is easy to remember, like <strong>w3schools.</strong></p>
<hr>

<h2>Step 4: Run the HTML in Your Browser</h2>
<p>Start your web browser and open your html file from the <strong>File</strong>,
<strong>Open</strong> menu, or just browse the folder and double-click your HTML file.</p>
<p>The result should look much like this:</p>
<p><img alt="View in Browser" height="304" src="pic_ie.jpg" width="569"></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_editors.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_editors.asp#top" target="_top">TOP</a> |
		<a href="html_editors.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
