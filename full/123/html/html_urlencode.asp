...
<style>a.menu_html_urlencode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html_charset.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_xhtml.asp">Next Chapter &raquo;</a></div>
</div>
<hr><p class="intro">A URL is another word for a web address.</p>
<p class="intro">A URL can be composed of words, such as "w3schools.com", or an 
Internet Protocol (IP) address: 192.68.20.50. Most people enter the name of the 
website when surfing, because names are easier to remember than numbers.</p>
<hr><h2>URL - Uniform Resource Locator</h2>
<p>Web browsers request pages from web servers by using a URL.</p>
<p>When you click on a link in an HTML page, an underlying &lt;a&gt; tag points to an 
address on the world wide web.</p>
<p>A Uniform Resource Locator (URL) is used to address a document (or other 
data) on the world wide web.</p>
<p>A web address, like this:
<a target="_blank" href="default.asp">
http://www.w3schools.com/html/default.asp</a>
follows these syntax rules:</p>

<div class="code notranslate"><div>
<b>scheme://host.domain:port/path/filename</b>
</div></div>

<p>Explanation:</p>
<ul>
	<li><b>scheme</b> - defines the <b>type</b> of Internet service. The most 
	common type is <b>http</b></li>
	<li><b>host</b> - defines the <b>domain host</b> (the default host for http 
	is <b>www</b>)</li>
	<li><b>domain</b> - defines the Internet <b>domain name</b>, like 
	w3schools.com</li>
	<li><b>port</b> - defines the <b>port number </b>at the host (the default 
	port number for http is <b>80</b>)</li>
	<li><b>path</b> - defines a <b>path</b> at the server (If omitted, the 
	document must be stored at the root directory of the web site)</li>
	<li><b>filename</b> - defines the name of a document/resource</li>
</ul>

<hr><h2>Common URL Schemes</h2>
...
<th style="width:53%">Which pages will the scheme be used for...</th>
</tr>
<tr>
<td>http</td>
<td>HyperText Transfer Protocol</td>
<td>Common web pages starts with http://. Not encrypted</td>
</tr>
<tr>
<td>https</td>
<td>Secure HyperText Transfer Protocol</td>
<td>Secure web pages. All information exchanged are encrypted</td>
</tr>
<tr>
<td>ftp</td>
<td>File Transfer Protocol</td>
<td>For downloading or uploading files to a website. Useful for domain 
maintenance</td>
</tr>
<tr>
<td>file</td>
...
<p>URL encoding converts characters into a format that can be transmitted over 
the Internet.</p>
<p>URL encoding replaces non ASCII characters with a "%" followed by two 
hexadecimal digits.</p>
<p>URLs cannot contain spaces. URL encoding normally replaces a space with a + 
sign.</p>
<hr><h2>Try It Yourself</h2>

<p>If you click the "Submit" button below, the browser will URL encode the input 
...
<input type="text" value="Hello Günter" name="text" size="30"><input type="submit" value="Submit"></form>

<p>Try some other input and click Submit again.</p>
<hr><h2>URL Encoding Examples</h2>
<table class="reference notranslate">
    <tr>
      <th>Character</th>
      <th>URL-encoding</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_urlencode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_urlencode.asp#top" target="_top">TOP</a> |
		<a href="html_urlencode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
