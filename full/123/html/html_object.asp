...
<title>The HTML Plug-Ins</title>
<style>a.menu_html_object{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html_media.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_sounds.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The purpose of a plug-in, is to extend the functionality of the 
HTML browser.</p>
<hr>
<h2>HTML Helpers (Plug-ins)</h2>
<p>A helper application is a small computer program that extends the standard 
functionality of the browser. Helper applications are also called plug-ins.</p>
<p>Examples of well-known plug-ins are Java applets and Adobe Flash Player.</p>
<p>Plug-ins can be added to web pages with the &lt;object&gt; tag or the &lt;embed&gt; tag.&nbsp; </p>
<p>Plug-ins can be used for many purposes: to display 
maps, scan for viruses, verify your bank id, and much more. The restrictions 
are few.</p>
<hr>
<h2>What is The Best Way to Play Audio or Video in HTML?</h2>
<p>The best way to embed audio in a web page is to use the HTML5 &lt;audio&gt; 
element.</p>
<p>The best way to embed video in a web page is to use the HTML5 &lt;video&gt; 
element.</p>
<hr>

<h2>The &lt;object&gt; Element</h2>
<p>The &lt;object&gt; element is supported in all major browsers.</p>

<p>The &lt;object&gt; element defines an embedded object within an HTML document.</p>
<p>It is used to to embed plug-ins (like Java applets, ActiveX, PDF, and 
Flash) in web pages.</p>
<p>It can also be used to embed another webpage, or web content like images, into 
HTML documents.</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>The text between &lt;object&gt; and &lt;/object&gt; is displayed if the 
browser doesn't support the tag.<br><br>
The HTML <a href="../tags/tag_param.asp">&lt;param&gt;</a> tag is used to pass parameters to 
the plug in.
</td>
</tr></table>
<br>
...
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_object_plugin" target="_blank">Try it yourself &raquo;</a>
...
<p>The &lt;embed&gt; element is supported in all major browsers.</p>
<p>The &lt;embed&gt; element defines a container for an external application or interactive content (a plug-in).</p>
<p>Many web browsers have supported the &lt;embed&gt; element for a 
long time. However, it has not been a part of the HTML  
specification before HTML5. </p>
<p>The &lt;embed&gt; element will validate in an HTML5 
page, but not in an HTML 4 page.</p>
...
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_embed_plugin" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>Note that the &lt;embed&gt; element does not have a closing tag. It can not 
contain alternative text.</td>
</tr></table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_object.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_object.asp#top" target="_top">TOP</a> |
		<a href="html_object.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
