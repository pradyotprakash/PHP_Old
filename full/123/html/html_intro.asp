...
<div class="next"><a class="chapter" href="html_editors.asp">Next Chapter &raquo;</a></div>
</div>
<br>
<div class="example">
...
<td>The &lt;!DOCTYPE html&gt; declaration is the doctype for HTML5.</td>
</tr></table>
<br>
<hr>
...
<li>HTML is a <b>markup </b>language</li>
<li>A markup language is a set of markup<b> tags</b></li>
<li>The tags <b>describe</b> document content </li>
...
<ul>
<li>HTML tags are keywords (tag names) surrounded by <b>angle brackets </b>like &lt;html&gt;</li>
...
<li>The end tag is written like the start tag, with a <strong>forward slash</strong> before the tag name </li>
...
<span style="color:#98bf21">&lt;tagname&gt;</span>content<span style="color:#98bf21">&lt;/tagname&gt;</span></div>
<br>
<hr>

<h2>HTML Elements</h2>
<p>&quot;HTML tags&quot; and &quot;HTML elements&quot; are often used to describe the same thing.</p>
<p>But strictly speaking, an HTML element is everything between the start tag and the end tag, including the tags: </p>
<p>HTML Element:</p>
<div style="width:610px;border:1px solid lightgray;font-size:20px;padding:10px;">
<span style="color:#98bf21">&lt;p&gt;</span>This is a paragraph.<span style="color:#98bf21">&lt;/p&gt;</span></div>
<br>
<hr>

<h2>Web Browsers</h2>
<p>The purpose of a web browser (such as Google Chrome, Internet Explorer, Firefox, 
Safari) is to read HTML documents and display them as web pages.</p>
<p>The browser does not display the HTML tags, but uses the tags to determine 
how the content of the HTML page is to be presented/displayed to the user:</p>
<p><img alt="Browser" height="304" src="pic_ie.jpg" width="569"></p>
<hr>
...
<p>The &lt;!DOCTYPE&gt; declaration helps the browser to display a web page correctly.</p>
<p>There are many different documents on the web, and a browser can only display 
an HTML page 100% correctly if it knows the HTML type and version used.</p>
<hr>

<h2>Common Declarations</h2>
<h3>HTML5</h3>
...
<p>For a complete list of document type declarations, go to our
<a href="../tags/tag_doctype.asp">DOCTYPE Reference</a>.</p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_intro.asp#top" target="_top">TOP</a> |
		<a href="html_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
