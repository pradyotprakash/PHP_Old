...
<style>a.menu_html_videos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">Videos</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="html_sounds.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_youtube.asp">Next Chapter &raquo;</a></div>
</div>
<hr><p class="intro">Videos can be embedded in HTML pages with several methods.</p>
<hr><h2>Playing Videos in HTML</h2>
<div class="example">
...
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_video_html5_4" target="_blank">Try it yourself  &raquo;</a>

</div>
<br>
<hr><h2>Problems, Problems, and Solutions</h2>
<p>Playing videos in HTML is not easy!</p>
<p>You must add a lot of tricks to make sure your video will play in all browsers 
(Internet Explorer, Chrome, Firefox, Safari, Opera) and on all hardware (PC, Mac , 
iPad, iPhone). </p>
<p>In this chapter W3Schools summarizes the problems and the solutions.</p>
<hr><h2>HTML Video - Using &lt;embed&gt;</h2>
<p>The &lt;embed&gt; tag defines a container for external (non-HTML) content.</p>
<p>The following HTML fragment displays a Flash video embedded in a web page:</p>
...
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_videoembed" target="_blank">Try it yourself &raquo;</a>
</div>
<p><b>Problems</b></p>
<ul>
	<li>If the browser does not support Flash, the video will not play</li>
	<li>iPad and iPhone do not support Flash videos</li>
</ul>
<hr><h2>HTML Video - Using &lt;object&gt;</h2>
<p>The &lt;object&gt; tag tag can also define a container for external (non-HTML) 
content.</p>
<p>The following HTML fragment displays a Flash video embedded in a web page:</p>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;object data=&quot;intro.swf&quot; height=&quot;200&quot; width=&quot;200&quot;&gt;&lt;/object&gt;</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_videoobject" target="_blank">Try it yourself &raquo;</a>
</div>
...
<hr><h2>The HTML5 &lt;video&gt; Element</h2>

<p>The HTML5 &lt;video&gt; tag defines a video or movie.</p>
<p>The &lt;video&gt; element  
works in all modern browsers.</p>

<p>The following example uses the HTML5 &lt;video&gt; tag, which specifies one MP4 file (for 
...
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_video_html5" target="_blank">Try it yourself  &raquo;</a>
</div>
<p><strong>Problems:</strong></p>
<ul>
	<li>You must convert your videos to many different formats</li>
	<li>The &lt;video&gt; element does not work in older browsers</li>
</ul>
<hr><h2>HTML Video - The Best Solution</h2>

<p>The best solution is to use the HTML5 &lt;video&gt; element + the &lt;embed&gt; element.</p>
<p>The example below uses the &lt;video&gt; element and tries to play the 
video either as MP4 or OGG. If that fails, the code &quot;falls back&quot; to try the 
&lt;embed&gt; element:</p>
<div class="example">
...
<hr><h2>HTML Video - YouTube Solution</h2>
<p><b>However, maybe the easiest way to display videos in HTML pages, is to use YouTube (see next 
chapter)!</b></p>

<hr><h2>HTML Video - Using A Hyperlink</h2>
<p>If a web page includes a hyperlink to a media file, most browsers will use a 
&quot;helper application&quot; to play the file.</p>
<p>The following code fragment displays a link to a Flash video. If a user clicks on 
...
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_videolink" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr><h2>Tips About Inline Videos</h2>
<p>When a video is included in a web page it is called inline video.</p>
<p>If you plan to use inline videos, be aware that many 
people find it annoying. Also note that some users might have turned 
off the inline video option in their browser.</p>
<p>Our best advice is to include inline videos only in pages where the user 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_videos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_videos.asp#top" target="_top">TOP</a> |
		<a href="html_videos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
