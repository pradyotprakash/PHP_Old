...
<div class="chapter">
<div class="prev"><a class="chapter" href="html_images.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_lists.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_basic">Basic HTML Tables</a><br>
How to create basic tables in HTML.</p>
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_border">A table with borders</a><br>
How to add borders to a table.</p>
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_collapse">A table with collapsed borders</a><br>
How to make the borders collapse.</p>
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_padding">A table with padding</a><br>
How to add padding to a table.</p>
<p>(You can find more examples at the bottom of this page).</p>
<hr>

<h2>HTML Tables</h2>
<p>Tables are defined with the <strong>&lt;table&gt;</strong> tag.</p>
<p>A table is divided into rows with the <strong>&lt;tr&gt;</strong> tag. (tr 
stands for table row)</p>
<p>A row is divided into data cells
with the <strong>&lt;td&gt;</strong> tag. (td stands for table data)</p>
<p>A row can also be divided into headings
with the <strong>&lt;th&gt;</strong> tag. (th stands for table heading)</p>
<p>The &lt;td&gt; elements are the data containers in the table. </p>
<p>The &lt;td&gt; elements can contain 
all sorts of HTML elements like text, images, lists, other tables, etc.</p>
<p>The width of a table can be defined using CSS.</p>
...
&lt;/tr&gt;<br>&lt;tr&gt;<br>&nbsp; 
&lt;td&gt;Eve&lt;/td&gt;<br>&nbsp; &lt;td&gt;Jackson&lt;/td&gt; <br>&nbsp; &lt;td&gt;94&lt;/td&gt;<br>&lt;/tr&gt;<br>&lt;/table&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<br>
<hr><h2>An HTML Table with a Border Attribute</h2>
<p>If you do not specify a border style, the table will be displayed without
borders. 
</p>
<p>A border can be adding using the border attribute:</p>
...
<br><a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_border_attribute" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
<p>The border attribute is on its way out of the HTML standard.<br>
It is better to use CSS.</p>
</td>
</tr></table>
<br>
...
&lt;/style&gt;</div>
<br><a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_border" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>If you want the table border, and the table cells borders to collapse into 
one border, add border-collapse to your CSS.</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;style&gt;<br>table,th,td<br>{<br>border-collapse:collapse<br>}<br>&lt;/style&gt;
</div>
<br><a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_collapse" target="_blank">Try it yourself &raquo;</a>
</div>
<br>

<hr><h2>An HTML Table with Cell Padding</h2>
<p>If you do not specify padding, the table cells will be displayed without
padding. 
</p>
<p>To display a table with padding, use CSS to &quot;style&quot; the padding:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	th,td<br>{<br>padding:5px;<br>}</div>
<br><a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_padding" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>Headings are defined with the &lt;th&gt; tag.</p>
<p>All major browsers display headings as bold and centered.</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;table style=&quot;width:300px&quot;&gt;<br>
&lt;tr&gt;<br>&nbsp; &lt;th&gt;First&lt;/th&gt;<br>&nbsp; &lt;th&gt;Last&lt;/th&gt; <br>&nbsp; &lt;th&gt;Points&lt;/th&gt;<br>
&lt;/tr&gt;<br>&lt;tr&gt;<br>&nbsp; 
&lt;td&gt;Eve&lt;/td&gt;<br>&nbsp; &lt;td&gt;Jackson&lt;/td&gt; <br>&nbsp; &lt;td&gt;94&lt;/td&gt;<br>&lt;/tr&gt;<br>&lt;/table&gt;
</div>
<br><a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_headings" target="_blank">Try it yourself &raquo;</a>
</div>
<p>To left-justify your headings use CSS:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	th<br>{<br>text-align:left;<br>}
</div>
<br><a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_headings_left" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr><h2>An HTML Table with Cell Spacing</h2>
<p>To display a table with cell spacing, use CSS to &quot;style&quot; the 
spacing:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	table<br>{<br>border-spacing:5px;<br>}</div>
<br><a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_cellspacing" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<div class="tryit_ex">
...
<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_tables3">Tables without borders</a><br>
How to create tables without borders.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_headers">Table headers</a><br>
How to create table headers.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_tables2">Table with a caption</a><br>
How to add a caption to a table.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_span">Table cells that span more than one row/column</a><br>
How to define table cells that span more than one row or one column.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_elements">Tags inside a table</a><br>
How to display elements inside other elements.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_cellpadding">Cell padding</a><br>
How to use padding to create more white space between the cell content and its borders.</p>

<p><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml_table_cellspacing">Cell spacing</a><br>
How to use spacing to increase the distance between the cells.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_tables.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_tables.asp#top" target="_top">TOP</a> |
		<a href="html_tables.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
