...
<style>a.menu_html_colornames{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">Color Names</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="html_colors.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_colorvalues.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>Color Names Supported by All Browsers</h2>
<p>140 color names are defined in the HTML and CSS color specification (17 standard colors plus 123 more).
The table below lists them all, along with their hexadecimal values.</p>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Tip:</b> The 17 standard colors are: aqua, black, blue, fuchsia, gray, green, lime, 
maroon, navy, olive, orange, purple, red, silver, teal, white, and yellow.</td>
</tr></table>
<br>
<hr>

<h2>Sorted by Color Name</h2>
<p><a href="html_colorvalues.asp">Colors sorted by HEX values</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_colornames.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_colornames.asp#top" target="_top">TOP</a> |
		<a href="html_colornames.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
