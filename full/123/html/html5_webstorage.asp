...
<style>a.menu_html5_webstorage{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="html5_draganddrop.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html5_app_cache.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">HTML5 web storage, better than cookies.</p>
<hr>

<h2>What is HTML5 Web Storage?</h2>
<p>With HTML5, web pages can store data locally within the user's browser.</p>
<p>Earlier, this was done with cookies. However, Web Storage is more secure and 
faster. The data is not included with every server request, but used ONLY when 
asked for. It is also possible to store large amounts of data, without affecting the website's performance.</p>
<p>The data is stored in name/value pairs, and a web page can only access data stored by itself.</p>
<p>Unlike cookies, 
...
<p>Web storage is supported in Internet Explorer 8+, Firefox, Opera, Chrome, and Safari.</p>
<p><b>Note:</b> Internet Explorer 7 and earlier versions, do not support Web Storage.</p>
<hr>

<h2>HTML5 Web Storage Objects</h2>
<p>HTML5 Web Storage provides two new objects for storing data on the client:</p>
<ul>
	<li>window.localStorage - stores data with no expiration date</li>
	<li>code.sessionStorage - stores data for one session (data is lost when the 
	tab is closed)</li>
</ul>
...
<br><a target="_blank" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml5_webstorage_local" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>Example explained:</p>
<ul>
	<li>Create a localStorage name/value pair with name=&quot;lastname&quot; and value=&quot;Smith&quot;</li>
	<li>Retrieve the value of &quot;lastname&quot; and insert it into the element 
	with id=&quot;result&quot;</li>
</ul>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	if (localStorage.clickcount)<br>&nbsp; {<br>&nbsp; localStorage.clickcount = Number(localStorage.clickcount) + 1;<br>&nbsp; 
	}<br>else<br>&nbsp; {<br>&nbsp; localStorage.clickcount = 1;<br>&nbsp; }<br>
	document.getElementById(&quot;result&quot;).innerHTML=&quot;You have clicked the button &quot; +<br>localStorage.clickcount + &quot; time(s).&quot;;</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml5_webstorage_local_clickcount" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
that it stores the data for only one session. The data is deleted when the user closes the browser window.</p>
<p>The following example counts the number of times a user has clicked a button, in the current session:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	if (sessionStorage.clickcount)<br>&nbsp; {<br>&nbsp; 
	sessionStorage.clickcount = Number(sessionStorage.clickcount) + 1;<br>&nbsp; }<br>
	else<br>&nbsp; {<br>&nbsp; sessionStorage.clickcount = 1;<br>&nbsp; }<br>
	document.getElementById(&quot;result&quot;).innerHTML=&quot;You have clicked the button &quot; +<br>sessionStorage.clickcount + &quot; time(s) in this session.&quot;;
</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/html/tryit.asp?filename=tryhtml5_webstorage_session" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html5_webstorage.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html5_webstorage.asp#top" target="_top">TOP</a> |
		<a href="html5_webstorage.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
