...
<style>a.menu_html5_quiz{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML5 <span class="color_h1">Quiz</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="html_quiz.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="html_exam.asp">Next Chapter &raquo;</a></div>
</div>
<hr><p class="intro">You can test your HTML5 skills with W3Schools' Quiz.</p>
<hr><h2>The Test</h2>
<p>The test contains 20 questions and there is no time
limit.&nbsp;</p>
<p>The test is not official, it's just a nice way to see how much you know,
or
don't know, about HTML5.</p>
<hr><h2>Count Your Score</h2>
...
<p>Good luck! <a target="_top" href="http://www.w3schools.com/quiztest/quiztest.asp?qtest=HTML5">Start
the HTML5 Quiz</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html5_quiz.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html5_quiz.asp#top" target="_top">TOP</a> |
		<a href="html5_quiz.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
