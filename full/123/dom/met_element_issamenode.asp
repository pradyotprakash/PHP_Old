...
<style>a.menu_met_element_issamenode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The isSameNode() method checks if the specified node is the same as the 
existing node.</p>
<p>This function returns TRUE if the two nodes are the same, and FALSE 
otherwise.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>node</td>
    <td>Required. The node to check</td>
  </tr>
</table>
<br>
...
loadXMLDoc()</a> and checks if two nodes are the same:</p>
<div class="example">
...
y=xmlDoc.getElementsByTagName(&quot;book&quot;)[1];<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_issamenode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_issamenode.asp#top" target="_top">TOP</a> |
		<a href="met_element_issamenode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
