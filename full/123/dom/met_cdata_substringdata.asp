...
<style>a.menu_met_cdata_substringdata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The substringData() method gets a string from the CDATA node.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the &quot;Stun&quot; string form the first CDATA element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_cdata_substringdata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_cdata_substringdata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_cdata_substringdata.asp#top" target="_top">TOP</a> |
		<a href="met_cdata_substringdata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
