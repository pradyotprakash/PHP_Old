...
<style>a.menu_dom_nodes_replace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Replace Nodes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_remove.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_create.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_replacechild">Replace an element node</a><br>
This example uses replaceChild() to replace the first &lt;book&gt; node.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_replacedata2">Replace data in a text node</a><br>
This example uses the nodeValue property to replace data in a text node.</p>
<hr>

<h2>Replace an Element Node</h2>

<p>The replaceChild() method is used to replace a node.</p>
<p>The following code fragment replaces the first &lt;book&gt; element:</p>
<div class="example">
...
<br>
//create a book element, title element and a text node<br>
newNode=xmlDoc.createElement(&quot;book&quot;);<br>
newTitle=xmlDoc.createElement(&quot;title&quot;);<br>
newText=xmlDoc.createTextNode(&quot;A Notebook&quot;);<br>
<br>
//add the text node to the title node,<br>
newTitle.appendChild(newText);<br>
//add the title node to the book node<br>
newNode.appendChild(newTitle);<br>
<br>
y=xmlDoc.getElementsByTagName(&quot;book&quot;)[0]<br>
//replace the first book node with the new node<br>
x.replaceChild(newNode,y);
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_replacechild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_replacedata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p><ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
	into xmlDoc using <a href="dom_loadxmldoc.asp">loadXMLDoc()</a> </li>
	<li>Get the text node of the first &lt;title&gt; element node</li><li>Use the replaceData method to replace the eight first characters from the 
	text node with &quot;Easy&quot;</li>
</ol>
<hr>

<h2>Use the nodeValue Property Instead</h2><p>It is easier to replace the data in a text node using the 
nodeValue property.</p><p>The following code fragment will replace the text 
node value in the first 
&lt;title&gt; 
element with &quot;Easy Italian&quot;:</p><div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_replacedata2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p><ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
	into xmlDoc using <a href="dom_loadxmldoc.asp">loadXMLDoc()</a></li>
	<li>Get the text node of the first &lt;title&gt; element node</li><li>Use the nodeValue property to change the text of the text node</li>
</ol>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_replace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_replace.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_replace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
