...
<title>XML DOM setAttributeNS() Method</title>
<style>a.menu_met_element_setattributens{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">setAttributeNS()</span> Method</h1><hr>
...
<p>The setAttributeNS() method adds a new attribute (with a namespace).</p>
<p>If an attribute with that name or namespace already exists in the element, 
its value is changed to be that of the prefix and value parameter</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>ns</td>
    <td>Required. Specifies the namespace URI of the attribute to set</td>
  </tr>
  <tr>
    <td>name</td>
    <td>Required. Specifies the name of the attribute to set</td>
  </tr>
  <tr>
    <td>value</td>
    <td>Required. Specifies the value of the attribute to set</td>
  </tr>
</table>
<br>
<hr>
...
<h2>Example 1</h2>
<p>The following code fragment loads &quot;<a target="_blank" href="books_ns.xml">books_ns.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and adds an &quot;edition&quot; attribute to the first &lt;book&gt; 
element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc=loadXMLDoc(&quot;books_ns.xml&quot;);<br>
<br>
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>
ns=&quot;http://www.w3schools.com/edition/&quot;;<br>
<br>
x.setAttributeNS(ns,&quot;edition&quot;,&quot;first&quot;);<br>
<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_setattributens" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The following code fragment loads &quot;<a target="_blank" href="books_ns.xml">books_ns.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and changes the &quot;lang&quot; value of the first &lt;title&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc=loadXMLDoc(&quot;books_ns.xml&quot;);<br>
...
ns=&quot;http://www.w3schools.com/children/&quot;;<br>
<br>
x.setAttributeNS(ns,&quot;c:lang&quot;,&quot;italian&quot;);<br>
<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_setattributens2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_setattributens.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_setattributens.asp#top" target="_top">TOP</a> |
		<a href="met_element_setattributens.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
