...
<title>XML DOM isSupported() Method</title>
<style>a.menu_met_node_issupported{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">isSupported()</span> Method</h1><hr>
...
<p>The isSupported() method checks whether the DOM implementation supports a specific feature 
and that the feature is supported by the specified node.</p>
...
<p>The isSupported() method is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet Explorer 9 and earlier does not support this method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>nodeObject</i>.isSupported(<i>feature</i>,<i>version</i>)</div></div>
...
<td><em>feature</em></td>
<td>String</td>
<td>Required. Specifies the name of the feature to test</td>
</tr>
<tr>
<td><em>version</em></td>
<td>String</td>
<td>Optional. Specifies the version number of the feature to test</td>
</tr>
</table>
...
<tr>
<td>Boolean</td>
<td><em>true</em> if the feature is supported on this node, otherwise <em>false</em></td>
</tr>
</table>
...
loadXMLDoc()</a>, and checks whether the DOM implementation supports a specific 
feature:</p>
<div class="example">
...
<br>
	x = xmlDoc.getElementsByTagName(&quot;book&quot;)[1];<br>document.write(x.isSupported(&quot;Events&quot;, 
	&quot;2.0&quot;));</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_issupported" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_issupported.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_issupported.asp#top" target="_top">TOP</a> |
		<a href="met_node_issupported.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
