...
<title>XML DOM lastChild Property</title>
<style>a.menu_prop_node_lastchild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">lastChild</span> Property</h1><hr>
...
<p>The lastChild property returns the last child node of the specified node.</p>
<h2>Syntax</h2>
...
the node type of the last child node.</p>
<p>Element nodes has a nodeType of 1, so if the last child node is not an 
element node, it moves to the previous node, and checks if this node is an element 
node. This continues until the last child node (which must be an element node) 
...
loadXMLDoc()</a> and displays the node name and node type of the 
last child node of the document:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
//check if the last node is an element node<br>
function get_lastchild(n)<br>
{<br>
x=n.lastChild;<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_doc_lastchild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Try-It-Yourself Demos</h2>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_doc_firstchild">Get the 
first child node of the document</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_lastchild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_lastchild.asp#top" target="_top">TOP</a> |
		<a href="prop_node_lastchild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
