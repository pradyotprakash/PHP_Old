...
<style>a.menu_prop_document_lastchild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The lastChild property returns the last child node of the document.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the last child node of the document:</p>
<div class="example">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_document_lastchild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_document_lastchild.asp#top" target="_top">TOP</a> |
		<a href="prop_document_lastchild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
