...
<title>XML DOM isSameNode() Method</title>
...
<h1>XML DOM <span class="color_h1">isSameNode()</span> Method</h1><hr>
...
<p>The isSameNode() method tests whether two nodes are the same node.</p>
<p><strong>Tip:</strong> Use the <a href="met_node_isequalnode.asp">isEqualNode()</a> 
method to determine if two nodes are equal.</p>
<hr>
...
<p>The isSameNode() method is supported in all major browsers.</p>
...
<i>nodeObject</i>.isSameNode(<i>nodetocheck</i>)</div></div>
...
<tr>
<td>Boolean</td>
<td><em>true</em> if the two nodes are the same, otherwise <em>false</em></td>
</tr>
</table>
...
loadXMLDoc()</a> and tests whether the two nodes are the same node:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	xmlDoc = loadXMLDoc(&quot;books.xml&quot;);<br><br>x = xmlDoc.getElementsByTagName(&quot;book&quot;)[1];<br>
	y = xmlDoc.getElementsByTagName(&quot;book&quot;)[1];<br><br>document.write(x.isSameNode(y));
</div>
<p>Output:</p>
<div class="example_code notranslate">
	true</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_issamenode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
