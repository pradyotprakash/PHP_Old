...
<title>XML DOM deleteData() Method</title>
<style>a.menu_met_comment_deletedata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">deleteData()</span> Method</h1><hr>
...
<p>The deleteData() method deletes data from a comment node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>start</td>
    <td>Required. Specifies where to begin removing characters. Start value starts at zero</td>
  </tr>
  <tr>
    <td>length</td>
    <td>Required. Specifies how many characters to delete</td>
  </tr>
</table>
<br>
...
loadXMLDoc()</a> and deletes some characters from first comment node:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_comment_deletedata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_comment_deletedata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_comment_deletedata.asp#top" target="_top">TOP</a> |
		<a href="met_comment_deletedata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
