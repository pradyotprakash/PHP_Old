...
<title>XML DOM hasChildNodes() Method</title>
...
<h1>XML DOM <span class="color_h1">hasChildNodes()</span> Method</h1><hr>
...
child nodes, otherwise <em>false</em>.</p>
<hr>
...
<i>nodeObject</i>.hasChildNodes()</div></div>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_haschildnodes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
