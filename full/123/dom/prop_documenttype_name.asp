...
<title>XML DOM name Property</title>
<style>a.menu_prop_documenttype_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">name</span> Property</h1>
<hr>
...
<p>The name property returns the name of the DTD (the name immediately following the 
	DOCTYPE keyword).</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and displays the name of the DTD:</p>
<div class="example">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_documenttype_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_documenttype_name.asp#top" target="_top">TOP</a> |
		<a href="prop_documenttype_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
