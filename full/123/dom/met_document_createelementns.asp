...
<title>XML DOM createElementNS() Method</title>
<style>a.menu_met_document_createelementns{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">createElementNS()</span> Method</h1><hr>
...
<p>The createElementNS() method creates an element node with a namespace.</p>
<p>This method returns an Element object.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>ns</td>
    <td>A string that specifies the namespace name for the element node</td>
  </tr>
  <tr>
    <td>name</td>
    <td>A string that specifies the name for the element node</td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_createelementns.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_createelementns.asp#top" target="_top">TOP</a> |
		<a href="met_document_createelementns.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
