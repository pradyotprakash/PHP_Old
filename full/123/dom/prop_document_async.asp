...
<title>XML DOM async Property</title>
<style>a.menu_prop_document_async{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">async</span> Property</h1>
<hr>
...
<p>The async property specifies whether downloading of an XML file should be 
	handled asynchronously or not.</p>
<p>True means that the load() method returns the 
	control to the caller before the download is complete.</p>
<p>False means that the 
	download must be completed before the caller gets the control back.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a>. The loadXMLDoc() 
function uses the async property:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_document_async.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_document_async.asp#top" target="_top">TOP</a> |
		<a href="prop_document_async.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
