...
<title>XML DOM doctype Property</title>
...
<h1>XML DOM <span class="color_h1">doctype</span> Property</h1>
<hr>
...
<p>The doctype property returns the Document Type Declaration associated with 
the document.</p>
<p>For XML documents without a DTD this returns null.</p>
<p>This provides direct access to the <a href="dom_documenttype.asp">
DocumentType object</a> (a child node of this Document).</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and returns a DocumentType object:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_doctype" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
