...
<title>XML DOM lookupPrefix() Method</title>
<style>a.menu_met_node_lookupprefix{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">lookupPrefix()</span> Method</h1><hr>
...
<p>The lookupPrefix() method returns the prefix associated with a given namespace 
URI.</p>
<hr/>
...
<p>The lookupPrefix() method is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet Explorer 9 and earlier does not support this method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>nodeObject</em>.lookupPrefix(<em>namespaceURI</em>)
</div></div>
...
<td>String</td>
<td>Required. Specifies the namespace URI to look for</td>
</tr>
</table>
...
<tr>
<td>String</td>
<td>The prefix associated with the specified namespace URI</td>
</tr>
</table>
...
loadXMLDoc()</a> and finds the prefix for the given namespace URI:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_lookupprefix" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_lookupprefix.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_lookupprefix.asp#top" target="_top">TOP</a> |
		<a href="met_node_lookupprefix.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
