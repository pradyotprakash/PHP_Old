...
<style>a.menu_dom_nodes_create{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Create Nodes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_replace.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_add.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>The examples below use the XML file <a target="_blank" href="books.xml">books.xml</a>. <br>
A function, <a href="dom_loadxmldoc.asp">loadXMLDoc()</a>, in an external JavaScript is used to load the XML file.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createelement1">Create an element node</a><br>
This example uses createElement() to create a new element node, and appendChild() to add it to a node.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createattribute">Create an attribute node using createAttribute </a><br>
This example uses createAttribute() to create a new attribute node, and setAttributeNode() to insert it to an element.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createattribute3">Create an attribute node using setAttribute </a><br>
This example uses setAttribute() to create a new attribute for an element.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createelement1">Create a text node</a><br>
This example uses createTextNode() to create a new text node, and appendChild() to add it to an element.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createcdatasection1">Create a CDATA section node</a><br>
This example uses createCDATAsection() to create a CDATA section node, and appendChild() to add it to an element.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createcomment1">Create a comment node</a><br>
This example uses createComment() to create a comment node, and appendChild() to add it to an element.</p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createelement2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createelement">Try 
it yourself</a><br>
</p>
<hr>
...
newatt.nodeValue=&quot;first&quot;;<br>
<br>
x=xmlDoc.getElementsByTagName(&quot;title&quot;);<br>
x[0].setAttributeNode(newatt);
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createattribute" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createattribute2">Try 
it yourself</a></p>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createattribute3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createattribute4">Try 
it yourself</a></p>
<hr>
...
newel.appendChild(newtext);<br>
<br>
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>
x.appendChild(newel);
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createelement1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);<br>
<br>
newCDATA=xmlDoc.createCDATASection(&quot;Special Offer &amp; Book Sale&quot;);<br>
<br>
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>
x.appendChild(newCDATA);
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createcdatasection1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createcdatasection">Try 
it yourself</a><br>
</p>
<hr>
...
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);<br>
<br>
newComment=xmlDoc.createComment(&quot;Revised March 2008&quot;);<br>
<br>
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>
x.appendChild(newComment);
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createcomment1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createcomment">Try 
it yourself</a><br>
</p>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_create.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_create.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_create.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
