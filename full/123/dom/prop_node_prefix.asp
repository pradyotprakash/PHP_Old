...
<title>XML DOM prefix Property</title>
<style>a.menu_prop_node_prefix{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">prefix</span> Property</h1><hr>
...
<p>The prefix property sets or returns the namespace prefix of a node.</p>
...
<p>The prefix property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Set the namespace prefix:</p>
<div class="code notranslate"><div>
<em>nodeObject</em>.prefix=<em>prefix</em></div></div>
<p>Return the namespace prefix:</p>
<div class="code notranslate"><div>
<em>nodeObject</em>.prefix</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td>A String representing the namespace prefix of the node, or <em>null</em> if the 
	node does not have a namespace
	</td>
</tr>
<tr>
	<th>DOM Version</th>
...
loadXMLDoc()</a> and returns the namespace prefix of the &lt;title&gt; 
elements:</p>
<div class="example">
...
{<br>
&nbsp;
document.write(x.item(i).prefix);<br>
&nbsp;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_prefix.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_prefix.asp#top" target="_top">TOP</a> |
		<a href="prop_node_prefix.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
