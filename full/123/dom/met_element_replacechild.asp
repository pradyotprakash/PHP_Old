...
<style>a.menu_met_element_replacechild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The replaceChild() method replaces a child node with another.</p>
<p>This function returns the replaced node on success, or NULL on failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>new_node</td>
    <td>Required. Specifies the new node</td>
  </tr>
  <tr>
    <td>old_node</td>
    <td>Required. Specifies the child node to replace</td>
  </tr>
</table>
<br>
<hr>
...
loadXMLDoc()</a> and replaces the first &lt;book&gt; element:</p>
<div class="example">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_replacechild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_replacechild.asp#top" target="_top">TOP</a> |
		<a href="met_element_replacechild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
