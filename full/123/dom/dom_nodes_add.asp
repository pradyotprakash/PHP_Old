...
<style>a.menu_dom_nodes_add{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Add Nodes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_create.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_clone.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createelement2">Add a node after the last child node</a><br>
This example uses appendChild() to add a child node to an existing node.</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_insertbefore">Add a node before a specified child node</a><br>
This example uses insertBefore() to insert a node before a specified child node.</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createattribute3">Add a new attribute</a><br>
This example uses the setAttribute() method to add a new attribute.</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_insertdata">Add data to a text node</a><br>
This example uses insertData() to insert data into an existing text node.</p>
<hr>
...
<p>The following code fragment creates an element (&lt;edition&gt;), and adds it after the last child of the first &lt;book&gt; element:</p>
...
<p>Loop through and append an element to all &lt;book&gt; elements:<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createelement">Try it yourself</a></p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_insertbefore" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_insertdata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_create.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_add.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_add.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_add.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
