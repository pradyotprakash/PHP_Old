...
<title>XML DOM parentNode Property</title>
<style>a.menu_prop_element_parentnode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">parentNode</span> Property</h1><hr>
...
<p>The parentNode property returns the parent node of the specified element.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the parent node from the first 
&lt;title&gt; element in &quot;books.xml&quot;:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_parentnode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_parentnode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_parentnode.asp#top" target="_top">TOP</a> |
		<a href="prop_element_parentnode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
