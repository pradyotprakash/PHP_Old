...
<title>XML DOM removeNamedItem() Method</title>
<style>a.menu_met_nodemap_removenameditem{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">removeNamedItem()</span> Method</h1>
<hr>
...
<p>The removeNamedItem() method removes the specified node.</p>
<p>If the removed attribute has a default value, a new attribute immediately 
appears containing the default value as well as the namespace URI, local name, 
and prefix, if any.</p>
<p>This method returns the removed node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>nodename</td>
    <td>The name of the node to remove</td>
  </tr>
  </table>
&nbsp;<hr>
...
loadXMLDoc()</a>, loops through the &lt;book&gt; elements and 
removes the category attributes:</p>
<div class="example">
...
{<br>
x.item(i).attributes.removeNamedItem(&quot;category&quot;);<br>
}
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removenameditem" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_nodemap_removenameditem.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_nodemap_removenameditem.asp#top" target="_top">TOP</a> |
		<a href="met_nodemap_removenameditem.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
