...
<style>a.menu_prop_cdata_data{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The data property returns the data of the selected node</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the data from all the &lt;html&gt; 
elements:</p>
<div class="example">
...
<br>
x=xmlDoc.getElementsByTagName(&quot;html&quot;);<br>
<br>
for (i=0;i&lt;x.length;i++)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;document.write(x[i].childNodes[0].data);<br>
...
<div class="example_code notranslate">
<b>Stunning!</b><br>
<i>Magic! Six stars!</i><br>
<a href="../xquery.1">Learn XQuery</a><br>
<a href="../xml.1">Learn XML</a>
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_cdata_data" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_cdata_data.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_cdata_data.asp#top" target="_top">TOP</a> |
		<a href="prop_cdata_data.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
