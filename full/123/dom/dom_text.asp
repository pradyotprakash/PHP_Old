...
<title>XML DOM - Text object</title>
<style>a.menu_dom_text{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM - The <span class="color_h1">Text</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_attribute.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_cdatasection.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>The Text object</h2>
<p>The Text object represents the textual content of an element or attribute.</p>
...
<tr>
	...
	<td>Sets or returns the text of the element or attribute</td>
</tr>
<tr>
	<td>isElementContentWhitespace</td>
	<td>Returns true if the text node contains content whitespace, 
	otherwise it returns false</td>
</tr>
<tr>
	<td><a href="prop_text_length.asp">length</a></td>
	<td>Returns the length of the text of the element or attribute</td>
</tr>
<tr>
	<td>wholeText</td>
	<td>Returns all text of text nodes adjacent to this node, 
	concatenated in document order</td>
</tr>
</table>
...
<tr>
	<td>replaceWholeText(text)</td>
	<td>Replaces the text of this node and all adjacent text nodes with the specified text</td>
</tr>
<tr>
	<td><a href="met_text_splittext.asp">splitText()</a></td>
	<td>Splits this node into two nodes at the specified offset, 
	and returns the new node that contains the text after the offset</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_text.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_text.asp#top" target="_top">TOP</a> |
		<a href="dom_text.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
