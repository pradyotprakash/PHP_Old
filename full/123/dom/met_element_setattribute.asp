...
<title>XML DOM setAttribute() Method</title>
<style>a.menu_met_element_setattribute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">setAttribute()</span> Method</h1><hr>
...
<p>The setAttribute() method adds a new attribute.</p>
<p>If an attribute with that name already exists in the element, its value is 
...
<h2>Example</h2><p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and adds an &quot;edition&quot; attribute to all &lt;book&gt; 
elements:</p>
<div class="example">
...
{<br>
x.item(i).setAttribute(&quot;edition&quot;,&quot;first&quot;);<br>
}<br>
<br>
//Output book title and edition value<br>
x=xmlDoc.getElementsByTagName(&quot;title&quot;);<br>
for (i=0;i&lt;x.length;i++)<br>
{<br>
document.write(x[i].childNodes[0].nodeValue);<br>
document.write(&quot; - Edition: &quot;);<br>
document.write(x[i].parentNode.getAttribute('edition'));<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_setattribute2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Try-It-Yourself Demos</h2>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_setattribute">
setAttribute() - Change an attribute's value</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_setattribute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_setattribute.asp#top" target="_top">TOP</a> |
		<a href="met_element_setattribute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
