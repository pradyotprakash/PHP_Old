...
<style>a.menu_dom_nodes_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Get Node Values</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_navigate.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_set.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>In the DOM, everything is a node. Element nodes do not have a text value.</p>
<p>The text of an element node is stored in a child node. This node is called a text node.</p>
<p>The way to get the text of an element is to get the value of the child node (text node).</p>
<hr>

<h2>Get an Element Value</h2>
<p>The getElementsByTagName() method returns a node list containing all elements with the specified tag name in the same order as they appear in the source document.</p>
<p>The following code loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; into xmlDoc using
<a href="dom_loadxmldoc.asp">loadXMLDoc()</a> and retrieves the first &lt;title&gt; element:</p>
...
<p>The childNodes property returns a list of child nodes. The &lt;title&gt; element has only one child node. It is a text node.</p>
<p>The following code retrieves the text node of the &lt;title&gt; element:</p>
...
<p>The nodeValue property returns the text value of the text node:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getelementsbytagname" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Result:&nbsp; txt = &quot;Everyday Italian&quot;</p>
<p>Loop through all &lt;title&gt; elements:
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getelementsbytagname1">Try it yourself</a></p>
<hr>

<h2>Get the Value of an Attribute</h2>
<p>In the DOM, attributes are nodes. Unlike element nodes, attribute nodes have text values.</p>
<p>The way to get the value of an attribute, is to get its text value.</p>
<p>This can be done using the getAttribute() method or using the nodeValue property of the attribute node.</p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getattribute" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Result:&nbsp; txt = &quot;en&quot;</p>
...
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getattribute1">Try 
it yourself</a><br>
</p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getattributenode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Result:&nbsp; txt = &quot;en&quot;</p>
<p>Example explained:</p>
<ol>
...
<p>Loop through all &lt;book&gt; elements and get their &quot;category&quot; attributes:
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getattributenode2">Try 
it yourself</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_navigate.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_get.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
