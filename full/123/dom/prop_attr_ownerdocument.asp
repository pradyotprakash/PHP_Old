...
<title>XML DOM ownerDocument Property</title>
<style>a.menu_prop_attr_ownerdocument{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">ownerDocument</span> Property</h1><hr>
...
<p>The ownerDocument property returns the root element (document object) for a node.</p>
...
loadXMLDoc()</a> and returns the root element 
of the first category attribute node:</p>
<div class="example">
...
<br>
document.write(x.item(0).attributes[0].ownerDocument);<br>
document.write(&quot;<br>&quot;);<br>
document.write(x.item(0).attributes[0].ownerDocument.nodeName);<br>
document.write(&quot;<br>&quot;);<br>
document.write(x.item(0).attributes[0].ownerDocument.nodeType);
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
[object XMLDocument]<br>
#document<br>
9
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_attr_ownerdocument" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_attr_ownerdocument.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_attr_ownerdocument.asp#top" target="_top">TOP</a> |
		<a href="prop_attr_ownerdocument.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
