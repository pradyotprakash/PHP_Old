...
<title>XML DOM Load Function</title>
<style>a.menu_dom_loadxmldoc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Load Functions</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_parser.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_methods.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">
...
<h2>The loadXMLDoc() Function</h2>
<p>To make the code 
from the previous page simpler to maintain (and check for older browsers), it should be written as a function: </p>

<div class="code notranslate"><div>

function loadXMLDoc(filename)<br>
{<br>
...
xhttp.open("GET",filename,false);<br>
xhttp.send();<br>
return xhttp.responseXML;<br>
}
</div></div>

<p>The function above can be stored in the &lt;head&gt; section of an HTML page, and called from a script in the page.</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>The function described above, is used in all XML document examples in this tutorial!</td>
</tr></table>
<br>
<hr>

<h2>An External JavaScript for loadXMLDoc()</h2>
<p>To make the code above even easier to maintain, and to make sure the same 
code is used in all pages, we store the function in an external file.</p>
<p>The file is called &quot;loadxmldoc.js&quot;, and will be loaded in the head section of an HTML page. 
Then, the loadXMLDoc() 
function can be called from a script in the page.</p>


<p>The following example uses the loadXMLDoc() function to load <a target="_blank" href="books.xml">books.xml</a>:</p>
...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_parsertest" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>How to get the data from the XML file, will be explained in the next 
chapters.</p>
<hr>

<h2>The loadXMLString() Function</h2>
<p>To make the code 
from the previous page simpler to maintain (and check for older browsers), it should be written as a function: </p>

<div class="code notranslate"><div>

function loadXMLString(txt) <br>
{<br>
if (window.DOMParser)<br>
&nbsp; {<br>
&nbsp; parser=new DOMParser();<br>
&nbsp; xmlDoc=parser.parseFromString(txt,&quot;text/xml&quot;);<br>
&nbsp; }<br>
else // code for IE<br>
&nbsp; {<br>
&nbsp; xmlDoc=new ActiveXObject(&quot;Microsoft.XMLDOM&quot;);<br>
&nbsp; xmlDoc.async=false;<br>
&nbsp; xmlDoc.loadXML(txt); <br>
&nbsp;&nbsp;}<br>
return xmlDoc;<br>
}</div></div>
...
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>The function described above, is used in all XML string examples in this tutorial!</td>
</tr></table>
<br>
<hr>

<h2>An External JavaScript for loadXMLString()</h2>
<p>We have stored the loadXMLString() function in a file called &quot;loadxmlstring.js&quot;.</p>
...
&lt;html&gt;<br>
&lt;head&gt;<br>
&lt;script src=&quot;loadxmlstring.js&quot;&gt;&lt;/script&gt;<br>
&lt;/head&gt;<br>
&lt;body&gt;<br>
&lt;script&gt;<br>
text=&quot;&lt;bookstore&gt;&quot;<br>
text=text+&quot;&lt;book&gt;&quot;;<br>
text=text+&quot;&lt;title&gt;Everyday Italian&lt;/title&gt;&quot;;<br>
text=text+&quot;&lt;author&gt;Giada De Laurentiis&lt;/author&gt;&quot;;<br>
text=text+&quot;&lt;year&gt;2005&lt;/year&gt;&quot;;<br>
text=text+&quot;&lt;/book&gt;&quot;;<br>
text=text+&quot;&lt;/bookstore&gt;&quot;;<br>
<br>
	var
xmlDoc=loadXMLString(text);<br>
<br>
<i>code goes here.....<br>
<br>
</i>&lt;/script&gt;<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_parsertest2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_parser.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_loadxmldoc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_loadxmldoc.asp#top" target="_top">TOP</a> |
		<a href="dom_loadxmldoc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
