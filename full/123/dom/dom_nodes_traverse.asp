...
<style>a.menu_dom_nodes_traverse{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Traverse Node Tree</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_nodelist.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_mozilla_vs_ie.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Traversing means looping through or traveling across the node tree.</p>
<hr>

<h2>Traversing the Node Tree</h2>
<p>Often you want to loop an XML document, for example: when you want to extract the value of each element.</p>
<p>This is called &quot;Traversing the node tree&quot;</p>
<p>The example below loops through all child nodes of &lt;book&gt;, and displays their names and values:</p>
...
<br>
// documentElement always represents the root node<br>
	var
x=xmlDoc.documentElement.childNodes;<br>
	<br>for (i=0;i&lt;x.length;i++)<br>
&nbsp;
{<br>
&nbsp;
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_parsertest3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_traverse.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_traverse.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_traverse.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
