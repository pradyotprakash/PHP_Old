...
<style>a.menu_dom_nodes_nodelist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Node List</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_info.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_traverse.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A list of nodes is returned by the getElementsByTagName() method and the childNodes property.</p>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodelist_length">Loop through 
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_attributes">Get the 
...
<img src="nodelist.gif" alt="DOM node list" /><br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodelist" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<p>The following code fragment uses the length property to loop through the list of &lt;title&gt; elements:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var
...
<br>
//the x variable will hold a node list<br>
	var
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodelist_length" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);<br>
	var
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0].attributes;<br>
<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_attributes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_nodelist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_nodelist.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_nodelist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
