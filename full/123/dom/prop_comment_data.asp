...
<title>XML DOM data Property</title>
<style>a.menu_prop_comment_data{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">data</span> Property</h1>
<hr>
...
<p>The data property sets or returns the text of a comment.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and outputs comment text from the first &lt;book&gt; 
element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_comment_data" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_comment_data.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_comment_data.asp#top" target="_top">TOP</a> |
		<a href="prop_comment_data.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
