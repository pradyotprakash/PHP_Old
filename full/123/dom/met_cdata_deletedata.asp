...
<style>a.menu_met_cdata_deletedata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The deleteData() method deletes data from a CDATA node.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and deletes some characters (the &quot;&lt;b&gt;&quot; tag) from the text node of the 
first &lt;html&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_cdata_deletedata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_cdata_deletedata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_cdata_deletedata.asp#top" target="_top">TOP</a> |
		<a href="met_cdata_deletedata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
