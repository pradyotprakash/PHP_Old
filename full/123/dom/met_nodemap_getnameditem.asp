...
<title>XML DOM getNamedItem() Method</title>
<style>a.menu_met_nodemap_getnameditem{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">getNamedItem()</span> Method</h1>
<hr>
<a href="dom_namednodemap.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="NamedNodeMap Object Reference" /> NamedNodeMap Object</a>
<hr>

<h2>Definition and Usage</h2>
<p>The getNamedItem() method returns the node with the specific name (from a namedNodeMap).</p>
<hr/>
...
<p>The getNamedItem() method is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet Explorer 8 and earlier does not support this method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>namedNodeMap</i>.getNamedItem(<em>nodeName</em>)</div></div>
...
<td>String</td>
<td>Required. The name of the node to return</td>
</tr>
</table>
...
<tr>
<td>Node object</td>
<td>The node with the specified name, , or <em>null</em> if it does not identify 
any node in the map</td>
</tr>
</table>
...
loadXMLDoc()</a>, loops through the &lt;book&gt; elements and prints the 
values of the category attributes:</p>
<div class="example">
...
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;att = x.item(i).attributes.getNamedItem(&quot;category&quot;);<br>
&nbsp;&nbsp;document.write(att.value + &quot;&lt;br&gt;&quot;);<br>
&nbsp;&nbsp;}
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
	cooking<br>children<br>web<br>web
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getnameditem" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Try-It-Yourself Demos</h2>
<p><a href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getnameditem2" target="_blank">
getNamedItem() - Change an attribute's value</a></p>
<hr>
<a href="dom_namednodemap.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="NamedNodeMap Object Reference" /> NamedNodeMap Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_nodemap_getnameditem.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_nodemap_getnameditem.asp#top" target="_top">TOP</a> |
		<a href="met_nodemap_getnameditem.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
