...
<style>a.menu_dom_errors{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Parse Error</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_http.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_errors_crossbrowser.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Microsoft's parseError object can be used to retrieve error information from the Microsoft XML parser.</p>
<p class="intro">To see how Firefox handles parser errors, check out the next page of this tutorial.</p>
<hr>

<h2>The parseError Object</h2>
<p>When trying to open an XML document, a parser-error may occur.</p>
<p>With the parseError object, you can retrieve the error code, the error text, the line that caused the error, and more.</p>
<p><b>Note:</b> The parseError object is not a part of the W3C DOM standard!</p>
<hr>

<h2>File Error</h2>
<p>In the following code we will try to load a non-existing file, and display some of its error properties:</p>
...
xmlDoc.load(&quot;ksdjf.xml&quot;);<br>
<br>
document.write(&quot;Error code: &quot; + xmlDoc.parseError.errorCode);<br>
document.write(&quot;Error reason: &quot; + xmlDoc.parseError.reason);<br>
document.write(&quot;Error line: &quot; + xmlDoc.parseError.line);
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=note_error" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>XML Error</h2>
<p>In the following code we let the parser load an XML document that is not well-formed.</p>
<p>(You can read more about well-formed and valid XML in our <a href="../xml/default.asp">XML tutorial</a>)</p>
...
xmlDoc=new ActiveXObject(&quot;Microsoft.XMLDOM&quot;);<br>
xmlDoc.async=false;<br>
xmlDoc.load(&quot;note_error.xml&quot;);<br>
<br>
document.write(&quot;Error code: &quot; + xmlDoc.parseError.errorCode);<br>
document.write(&quot;Error reason: &quot; + xmlDoc.parseError.reason);<br>
document.write(&quot;Error line: &quot; + xmlDoc.parseError.line);
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=note_error_two" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Look at the XML file: <a target="_blank" href="note_error.xml">note_error.xml</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_errors.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_errors.asp#top" target="_top">TOP</a> |
		<a href="dom_errors.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
