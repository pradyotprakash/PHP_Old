...
<style>a.menu_prop_attr_localname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The localName property returns the local part of the name of an attribute.</p>
...
loadXMLDoc()</a> and returns the local name of the &quot;lang&quot; 
attributes:</p>
<div class="example">
...
{<br>
document.write(x.item(i).attributes[0].localName);<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_attr_localname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_attr_localname.asp#top" target="_top">TOP</a> |
		<a href="prop_attr_localname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
