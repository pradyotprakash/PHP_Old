...
<style>a.menu_prop_text_length{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The length property returns the length of the text of a node (in characters).</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and prints the text node data and length from the first &lt;title&gt; 
element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_text_length" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_text_length.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_text_length.asp#top" target="_top">TOP</a> |
		<a href="prop_text_length.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
