...
<style>a.menu_prop_nodemap_length{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The length property returns the number of nodes in a NamedNodeMap.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the number of attributes in the first &lt;book&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodemap_length" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Try-It-Yourself Demos</h2>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_length">length - Return the number of nodes in a node list</a></p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_length2">length - Loop through the nodes in a node list</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_nodemap_length.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_nodemap_length.asp#top" target="_top">TOP</a> |
		<a href="prop_nodemap_length.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
