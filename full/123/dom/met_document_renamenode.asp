...
<title>XML DOM renameNode() Method</title>
...
<h1>XML DOM <span class="color_h1">renameNode()</span> Method</h1><hr>
...
<p>The renameNode() method renames an existing element or attribute node.</p>
<p>When possible, this changes the name of the given node, otherwise this 
	creates a new node with the specified name and replaces the existing node 
	with the new node.</p>
<p>This method returns the renamed node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  <tr>
    <th style="width:20%">Parameter</th><th>Description</th></tr><tr>
    <td>node</td><td>The element or attribute node to rename</td></tr><tr>
    <td>uri</td><td>A string that specifies the new namespace name</td></tr><tr>
    <td>name</td><td>A string that specifies the new name</td></tr></table><br>
