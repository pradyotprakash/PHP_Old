...
<title>XML DOM nodeValue Property</title>
<style>a.menu_prop_document_nodevalue{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">nodeValue</span> Property</h1><hr>
...
<p>The nodeValue property sets or returns the value of a node, depending on its 
	type.</p>
<h2>Syntax</h2>
...
<h2>Example</h2>
<p>The following code fragment displays the node name and node value of the root 
node:</p>
<div class="example">
...
<br>
document.write(&quot;Nodename: &quot; + xmlDoc.nodeName);<br>
document.write(&quot; (value: &quot; + xmlDoc.childNodes[0].nodeValue);
</div>
<p>Output:</p>
<div class="example_code notranslate">
Nodename: #document (value: version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodevalue" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_document_nodevalue.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_document_nodevalue.asp#top" target="_top">TOP</a> |
		<a href="prop_document_nodevalue.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
