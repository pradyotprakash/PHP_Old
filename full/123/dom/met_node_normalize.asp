...
<title>XML DOM normalize() Method</title>
<style>a.menu_met_node_normalize{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">normalize()</span> Method</h1><hr>
...
<p>The normalize() method puts all Text nodes underneath a node (including 
	...
	separates Text nodes, i.e., there are neither adjacent Text nodes nor empty Text nodes.</p>
<p>The normal form is useful for operations that require a particular document 
tree structure and ensures that the XML DOM view of a document is identical when 
saved and reloaded.</p>
...
<p>The normalize() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>nodeObject</i>.normalize()</div></div>
<h2>Parameters</h2>
<p>None.</p>
...
<tr>
	...
	<td>Core Level 2 Node Object. Modified in DOM Level 3</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_normalize.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_normalize.asp#top" target="_top">TOP</a> |
		<a href="met_node_normalize.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
