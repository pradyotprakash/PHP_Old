...
<style>a.menu_met_element_haschildnodes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The hasChildNodes() method returns TRUE if the current element node has child 
nodes, and FALSE otherwise.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_haschildnodes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_haschildnodes.asp#top" target="_top">TOP</a> |
		<a href="met_element_haschildnodes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
