...
<title>XML DOM textContent Property</title>
<style>a.menu_prop_element_textcontent{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">textContent</span> Property</h1><hr>
...
<p>The textContent property returns or sets the text from the selected 
element.</p>
<p>On returning text, this property returns the value of all text nodes within 
the element node.</p>
<p>On setting text, this property removes all child nodes and replaces them with 
a single text node.</p>
<h2>Syntax</h2>
<p>Return text:</p>
...
<p><b>Tip:</b> For setting and returning the text value from a node you should 
use the text node <a href="prop_node_nodevalue.asp">nodeValue property</a>.</p>
<hr>
...
loadXMLDoc()</a> and gets text nodes from the first &lt;title&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_textcontent" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Example 2</h2>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and gets text nodes from the first &lt;book&gt; element, and replaces all nodes with a new text node:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);<br>
...
document.write(x.textContent);<br>
<br>
document.write(&quot;<br>&quot;);<br>
x.textContent=&quot;hello&quot;;<br>
<br>
...
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
Before: Everyday Italian Giada De Laurentiis 2005 30.00<br>
After: hello
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_textcontent2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_textcontent.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_textcontent.asp#top" target="_top">TOP</a> |
		<a href="prop_element_textcontent.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
