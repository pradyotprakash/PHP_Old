...
<title>XML DOM firstChild Property</title>
<style>a.menu_prop_element_firstchild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">firstChild</span> Property</h1><hr>
...
<p>The firstChild property returns the first child node of the selected 
element</p>
...
the node type of the first child node.</p>
<p>Element nodes has a nodeType of 1, so if the first child node is not an 
...
loadXMLDoc()</a> and gets the first child node:</p>
<div class="example">
...
firstNode=get_firstchild(x);<br>
<br>
for (i=0;i&lt;firstNode.childNodes.length;i++)<br>
{<br>
if (firstNode.childNodes[i].nodeType==1)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;//Process only element nodes<br>
&nbsp;&nbsp;document.write(firstNode.childNodes[i].nodeName);<br>
&nbsp;&nbsp;document.write(&quot; = &quot;);<br>
&nbsp;&nbsp;document.write(firstNode.childNodes[i].childNodes[0].nodeValue);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_firstchild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_firstchild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_firstchild.asp#top" target="_top">TOP</a> |
		<a href="prop_element_firstchild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
