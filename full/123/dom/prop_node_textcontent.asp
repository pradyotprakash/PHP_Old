...
<p>The textContent property sets or returns the textual content of a node and its 
	descendants.</p>
<p>On setting, any child nodes are removed and replaced by a 
	single Text node containing the string this property is set to.</p>
...
loadXMLDoc()</a> and returns the textual content of the &lt;book&gt; 
elements:</p>
<div class="example">
...
{<br>
document.write(x.item(i).textContent);<br>
document.write(&quot;<br>&quot;);<br>
}
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
Everyday Italian Giada De Laurentiis 2005 30.00<br> 
Harry Potter J K. Rowling 2005 29.99 <br>
XQuery Kick Start James McGovern Per Bothner Kurt Cagle James Linn<br>
Vaidyanathan Nagarajan 2003 49.99 <br>
Learning XML Erik T. Ray 2003 39.95
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_node_textcontent" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Try-It-Yourself Demos</h2>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_node_textcontent_set">
textContent - Set the textual content of a node</a></p>
<hr>
