...
<title>XML DOM getAttributeNodeNS() Method</title>
<style>a.menu_met_element_getattributenodens{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">getAttributeNodeNS()</span> Method</h1><hr>
...
<p>The getAttributeNS() method gets an attribute node by namespace URI and name.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>ns</td>
    <td>Required. Specifies the namespace URI to get the attribute value from</td>
  </tr>
  <tr>
    <td>name</td>
    <td>Required. Specifies the attribute to get the attribute value from</td>
  </tr>
</table>
<br>
<hr>
...
loadXMLDoc()</a> and gets the &quot;lang&quot; attribute node from the first &lt;title&gt; element:</p>
<div class="example">
...
<br>
y=x.getAttributeNodeNS(ns,&quot;lang&quot;);<br>
<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_getattributenodens" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_getattributenodens.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_getattributenodens.asp#top" target="_top">TOP</a> |
		<a href="met_element_getattributenodens.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
