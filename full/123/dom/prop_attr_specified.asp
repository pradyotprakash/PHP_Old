...
<title>XML DOM specified Property</title>
...
<h1>XML DOM <span class="color_h1">specified</span> Property</h1>
<hr>
...
<p>The specified property returns true if the attribute value is set in the 
document, and false if it's a default value in a DTD/Schema.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and displays the name and value of the category 
attribute:</p>
<div class="example">
...
{<br>
document.write(x.item(i).attributes[0].specified);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_attr_specified" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
