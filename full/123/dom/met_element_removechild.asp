...
<style>a.menu_met_element_removechild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The removeChild() method removes a child node.</p>
<p>This function returns the removed node on success, or NULL on failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>node</td>
    <td>Required. Specifies the child node to remove</td>
  </tr>
</table>
<br>
<hr>
...
loadXMLDoc()</a> and removes a child node in the first &lt;book&gt; 
element:</p>
<div class="example">
...
x=xmlDoc.documentElement.removeChild(y);<br>
<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removechild2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Try-It-Yourself Demos</h2><p>
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removechild3">removeChild() - 
Remove the last child node from a nodelist</a></p><hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_removechild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_removechild.asp#top" target="_top">TOP</a> |
		<a href="met_element_removechild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
