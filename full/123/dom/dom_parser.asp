...
<style>a.menu_dom_parser{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Parser</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodetree.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_loadxmldoc.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">All major browsers have a built-in XML parser to read and manipulate XML.</p>
<p class="intro">The XML parser converts XML into an XML DOM object that can be 
accessed with JavaScript.</p>
<hr>

<h2>XML Parser</h2>
<p>The XML DOM contains methods to traverse XML trees, access, 
...
<p>An XML parser reads XML, and converts it into an XML DOM object that can be accessed with JavaScript. </p>
<p>Most browsers have a built-in XML parser.</p>
<hr>

<h2>Load an XML Document</h2>
<p>The following JavaScript fragment loads an XML document (&quot;<a target="_blank" href="books.xml">books.xml</a>&quot;):</p>
...
&nbsp; }<br>
xhttp.open(&quot;GET&quot;,&quot;books.xml&quot;,false);<br>
xhttp.send();<br>
xmlDoc=xhttp.responseXML;
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_loadxml" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p><b>Code explained:</b></p>
<ul>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_loadxmltext" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p><b>Note:</b> Internet Explorer uses the loadXML() method to parse an XML string, while other browsers use the DOMParser object.</p>
<hr>
...
<p>If you want to use the example above on one of your web pages, the XML files you load must be located on your own server.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodetree.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_loadxmldoc.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_parser.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_parser.asp#top" target="_top">TOP</a> |
		<a href="dom_parser.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
