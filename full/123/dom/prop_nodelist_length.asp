...
<p>The length property returns the number of nodes in a node list.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the number of &lt;title&gt; elements:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_length" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
