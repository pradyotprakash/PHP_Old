...
<title>XML DOM - DocumentImplementation object</title>
<style>a.menu_dom_documentimplementation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM - The <span class="color_h1">DocumentImplementation</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_document.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_documenttype.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>The DocumentImplementation object</h2>
<p>The DOMImplementation object performs 
operations that are independent of any particular instance of the document 
object model.</p>

<h2>DocumentImplementation Object Methods</h2>
...
<tr>
	<td>createDocument(nsURI, name, doctype)</td>
	<td>Creates a new DOM Document object of the specified doctype </td>
</tr>
<tr>
	<td>createDocumentType(name, pubId, systemId)</td>
	<td>Creates an empty DocumentType node</td>
</tr>
<tr>
	<td>getFeature(feature, version)</td>
	<td>Returns an object which implements the APIs of 
	the specified feature and version, if the is any</td>
</tr>
<tr>
	<td>hasFeature(feature, version)</td>
	<td>Checks whether the DOM implementation implements a specific 
	feature and version</td>
</tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_documentimplementation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_documentimplementation.asp#top" target="_top">TOP</a> |
		<a href="dom_documentimplementation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
