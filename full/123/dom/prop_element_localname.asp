...
<style>a.menu_prop_element_localname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The localName property returns the local name (element name) of the selected 
element</p>
<p>If the selected node is not an element or attribute, this property returns NULL.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the local name from the first &lt;book&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_localname" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and gets the local name from the last child node:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_localname2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_localname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_localname.asp#top" target="_top">TOP</a> |
		<a href="prop_element_localname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
