...
<title>XML DOM nextSibling Property</title>
<style>a.menu_prop_node_nextsibling{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">nextSibling</span> Property</h1><hr>
...
<p>The nextSibling property returns the node immediately following a node (the following node 
in the same tree level).</p>
...
the node type of the next sibling node.</p>
<p>Element nodes has a nodeType of 1, so if the next sibling node is not an 
...
loadXMLDoc()</a> and gets the next sibling node from the first &lt;title&gt; 
element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
//check if the next sibling node is an element node<br>
...
<br>
y=get_nextsibling(x);<br>
<br>
document.write(&quot;<br>Next sibling: &quot;);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nextsibling2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Try-It-Yourself Demos</h2>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_previoussibling">previousSibling - Get the previous sibling of a node</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_nextsibling.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_nextsibling.asp#top" target="_top">TOP</a> |
		<a href="prop_node_nextsibling.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
