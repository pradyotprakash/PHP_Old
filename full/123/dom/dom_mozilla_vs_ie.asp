...
<style>a.menu_dom_mozilla_vs_ie{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Browser Differences</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_traverse.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_navigate.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
between browsers. One important difference is:</p>
<ul>
...
&lt;book&gt;<br>
  &nbsp;
  &lt;title&gt;Everyday Italian&lt;/title&gt;<br>
  &nbsp;
...
<p>Internet Explorer 9 and earlier do NOT treat empty white-spaces, or new lines as text 
nodes, while other browsers do.</p>
<p>The following example will output the number of child nodes the root element 
(of <a href="books.xml" target="_blank">books.xml</a>) has. IE9 and earlier will output 4 child nodes, while IE10 and 
later versions, 
	and other browsers 
	will output 9 child nodes:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodetype_ievsmozilla" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_mozilla_vs_ie.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_mozilla_vs_ie.asp#top" target="_top">TOP</a> |
		<a href="dom_mozilla_vs_ie.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
