...
<style>a.menu_dom_nodes_remove{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Remove Nodes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_set.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_replace.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removechild">Remove an element node</a><br>
This example uses removeChild() to remove the first &lt;book&gt; element.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removecurrent">Remove the current element node</a><br>
This example uses parentNode and removeChild() to remove the current &lt;book&gt; element.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removetextnode">Remove a text node</a><br>
This example uses removeChild() to remove the text node from the first &lt;title&gt; element.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_remove_nodevalue">Clear the text of a text node</a><br>
This example uses the nodeValue() property to clear the text node of the first &lt;title&gt; element.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removeattribute">Remove an attribute by name</a><br>
This example uses removeAttribute() to remove the &quot;category&quot; attribute from the first &lt;book&gt; element.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removeattributenode">Remove attributes by object</a><br>
This example uses removeAttributeNode() to remove all attributes from all &lt;book&gt; elements.</p>
<hr>
...
<br>
y=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>
<br>
xmlDoc.documentElement.removeChild(y);
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removechild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<p>The removeChild() method is the only way to remove a specified node.</p>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removecurrent" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removetextnode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_remove_nodevalue" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_remove_nodevalue2">Try 
it yourself</a><br>
</p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removeattribute" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removeattribute2">Try 
it yourself</a></p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_removeattributenode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_remove.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_remove.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_remove.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
