...
<title>XML DOM isId Property</title>
...
<h1>XML DOM <span class="color_h1">isId</span> Property</h1><hr>
...
<p>The isId property returns true if an attribute is known to be of type ID 
	(e.g. contains an identifier for its owner element), otherwise it returns 
	false.</p>
...
loadXMLDoc()</a> and returns whether the category attribute is an ID 
attribute of the &lt;book&gt; element:</p>
<div class="example">
...
{<br>
document.write(x.item(i).attributes[0].isId);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_attr_isid" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
