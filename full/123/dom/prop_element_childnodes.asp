...
<title>XML DOM childNodes Property</title>
<style>a.menu_prop_element_childnodes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">childNodes</span> Property</h1><hr>
...
<p>The childNodes property returns a NodeList containing the child nodes of 
the selected node</p>
<p>If the selected node has no children, this property returns a NodeList 
containing no nodes.</p>
<h2>Syntax</h2>
...
<p><b>Tip:</b> To loop through a childNodes list, it is more efficient to use the 
...
loadXMLDoc()</a> and gets the text node from the first &lt;title&gt; 
...
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and gets the number of child nodes from the first &lt;book&gt; element in &quot;books.xml&quot;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);<br>
...
<p>In Internet Explorer the output of the code above will be:</p>
<div class="example_code notranslate">
4
</div>
<p>In Mozilla browsers the output of the code above will be:</p>
<div class="example_code notranslate">
9
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_childnodes_length" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Firefox, and most other browsers, will treat empty white-spaces or new lines 
as text nodes, Internet Explorer will not. So, in the example 
above, the output will be different.</p>
<p>To read more about the differences between browsers, visit our
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_childnodes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_childnodes.asp#top" target="_top">TOP</a> |
		<a href="prop_element_childnodes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
