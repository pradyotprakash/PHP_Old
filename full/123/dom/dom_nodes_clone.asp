...
<title>XML DOM - Clone Nodes</title>
<style>a.menu_dom_nodes_clone{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Clone Nodes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_add.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_httprequest.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_clonenode">Copy a node and append it to an existing node</a><br>
This example uses cloneNode() to copy a node and append it to the root node of the XML document</p>
<hr>

<h2>Copy a Node</h2>
<p>The cloneNode() method creates a copy of a specified node.</p>
<p>The cloneNode() method has a parameter (true or false). This parameter indicates if the cloned node should include all attributes and child 
nodes of the original node.</p>
<p>The following code fragment copies the first &lt;book&gt; node and appends it to the root node of the document:</p>
...
<br>
oldNode=xmlDoc.getElementsByTagName('book')[0];<br>
newNode=oldNode.cloneNode(true);<br>
xmlDoc.documentElement.appendChild(newNode);<br>
<br>
//Output all titles<br>
y=xmlDoc.getElementsByTagName(&quot;title&quot;);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_clonenode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
	into xmlDoc using <a href="dom_loadxmldoc.asp">loadXMLDoc()</a> </li>
	<li>Get the node to copy</li>
	<li>Copy the node into &quot;newNode&quot; using the cloneNode method</li>
	<li>Append the new node to the the root node of the XML document</li>
	<li>Output all titles for all books in the document</li>
</ol>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_add.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_clone.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_clone.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_clone.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
