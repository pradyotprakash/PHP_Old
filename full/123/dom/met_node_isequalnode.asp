...
<title>XML DOM isEqualNode() Method</title>
...
<h1>XML DOM <span class="color_h1">isEqualNode()</span> Method</h1><hr>
...
<p>The isEqualNode() method tests whether two nodes are equal.</p>
<p>Two nodes are equal when their names are the same, their attributes have the 
same name and value (does not have to be in the same order), and their child 
nodes are equal and in same order.</p>
<p><strong>Tip:</strong> Use the <a href="met_node_issamenode.asp">isSameNode()</a> 
method to determine if two nodes are the same node.</p>
<hr>
...
<p><strong>Note:</strong> Internet Explorer 9 and earlier do not support the 
isEqualNode() method.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>nodeObject</i>.isEqualNode(<i>nodetocheck</i>)</div></div>
...
<tr>
<td><em>nodetocheck</em></td>
<td>Node object</td>
<td>Required. The node to compare with the current node</td>
</tr>
</table>
...
loadXMLDoc()</a> and returns whether two nodes are equal:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	xmlDoc = loadXMLDoc(&quot;books.xml&quot;);<br><br>x = xmlDoc.getElementsByTagName(&quot;book&quot;)[1];<br>
	y = xmlDoc.getElementsByTagName(&quot;book&quot;)[2];<br><br>document.write(x.isEqualNode(y));
</div>
<p>Output:</p>
<div class="example_code notranslate">
	false
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_isequalnode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
