...
<style>a.menu_prop_text_data{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The data property sets or returns the text of an element or attribute.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and outputs the text from the first &lt;title&gt; 
element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_text_data" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_text_data.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_text_data.asp#top" target="_top">TOP</a> |
		<a href="prop_text_data.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
