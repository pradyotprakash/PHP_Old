...
<title>XML DOM appendChild() Method</title>
<style>a.menu_met_element_appendchild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">appendChild()</span> Method</h1><hr>
...
<p>The appendChild() method adds a node after the last child node of the 
specified element node.</p>
<p>This method returns the new child node.</p>
<h2>Syntax</h2>

<div class="code notranslate"><div>

appendChild(node)</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>node</td>
    <td>Required. The node to append</td>
  </tr>
</table>
<br>
...
loadXMLDoc()</a> and creates an element (&lt;edition&gt;), and adds it after the last 
...
<h2>Example 2</h2><p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and appends a new node to all &lt;book&gt; elements:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);<br>
...
<br>
//Output all titles and editions<br>
y=xmlDoc.getElementsByTagName(&quot;title&quot;);<br>
z=xmlDoc.getElementsByTagName(&quot;edition&quot;);<br>
for (i=0;i&lt;y.length;i++)<br>
{<br>
document.write(y[i].childNodes[0].nodeValue);<br>
document.write(&quot; - Edition: &quot;);<br>
document.write(z[i].childNodes[0].nodeValue);<br>
document.write(&quot;<br>&quot;);<br>
}
</div>
<p>Output:</p>
<div class="example_code notranslate">
Everyday Italian - Edition: First<br>
Harry Potter - Edition: First<br>
XQuery Kick Start - Edition: First<br>
Learning XML - Edition: First
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createelement" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_appendchild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_appendchild.asp#top" target="_top">TOP</a> |
		<a href="met_element_appendchild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
