...
<title>XML DOM removeAttributeNode() Method</title>
...
<h1>XML DOM <span class="color_h1">removeAttributeNode()</span> Method</h1><hr>
...
<p>The removeAttributeNode() method removes a specified attribute node.</p>
<p>If a default value for the attribute is defined in a 
	DTD, a new attribute immediately appears with the default value.</p>
<p>This function returns the removed attribute node.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and removes the &quot;category&quot; attribute nodes from all &lt;book&gt; elements:</p>
<div class="example">
...
{<br>
attnode=x.item(i).getAttributeNode(&quot;category&quot;);<br>
old_att=x.item(i).removeAttributeNode(attnode);<br>
document.write(&quot;Removed attribute: &quot; + old_att.name + &quot;<br>&quot;);<br>
}
</div>
<p>Output:</p>
<div class="example_code notranslate">
Removed attribute: category<br>
Removed attribute: category<br>
Removed attribute: category<br>
