...
<title>XML DOM insertData() Method</title>
<style>a.menu_met_comment_insertdata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">insertData()</span> Method</h1><hr>
...
<p>The insertData() method inserts data to a comment node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>start</td>
    <td>Required. Specifies where to begin inserting characters. Start value starts at zero</td>
  </tr>
  <tr>
    <td>string</td>
...
loadXMLDoc()</a> and inserts a string to the first comment node:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_comment_insertdata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_comment_insertdata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_comment_insertdata.asp#top" target="_top">TOP</a> |
		<a href="met_comment_insertdata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
