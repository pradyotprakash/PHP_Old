...
<title>XML DOM implementation Property</title>
...
<h1>XML DOM <span class="color_h1">implementation</span> Property</h1>
<hr>
...
<p>The implementation property returns the DOMImplementation object that handles the
      document.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and returns the DOMImplementation object that handles 
the document:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_implementation" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
