...
<title>XML DOM cloneNode() Method</title>
...
<h1>XML DOM <span class="color_h1">cloneNode()</span> Method</h1><hr>
...
<p>The cloneNode() method creates a copy of a node, and returns the newly clone node.</p>
<hr>
...
<i>nodeObject</i>.cloneNode(<i>deep</i>)</div></div>
...
<td><em>deep</em></td>
<td>Boolean</td>
<td><em>true</em> clones the node, its attributes, and its descendants.
<em>false</em> clones the node and its attributes.<br>
</td>
</tr>
</table>
...
loadXMLDoc()</a>, clones the first &lt;book&gt; node and then adds 
it to the end of the node list:</p>
<div class="example">
...
cloneNode = x.cloneNode(true);<br>
xmlDoc.documentElement.appendChild(cloneNode);<br>
<br>
