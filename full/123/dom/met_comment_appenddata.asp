...
<title>XML DOM appendData() Method</title>
<style>a.menu_met_comment_appenddata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">appendData()</span> Method</h1>
<hr>
...
<p>The appendData() method adds data at the end of a comment node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>string</td>
    <td>Required. The string to add to the comment node</td>
  </tr>
</table>
<br>
...
loadXMLDoc()</a> and appends text to the first comment element:</p>
<div class="example">
...
&nbsp; x[i].appendData(&quot; Special Offer&quot;);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_comment_appenddata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_comment_appenddata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_comment_appenddata.asp#top" target="_top">TOP</a> |
		<a href="met_comment_appenddata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
