...
<style>a.menu_met_element_comparedocumentposition{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The compareDocumentPosition() method compares the document position of the 
current node, with a specified node, according to the document order.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>node</td>
    <td>Required. Specifies the node to compare with the current 
	node</td>
  </tr>
</table>
<br>
...
loadXMLDoc()</a> and compares the first and the third &lt;book&gt; nodes:</p>
<div class="example">
...
browsers will output 4, while Internet Explorer will output 2.</p><p>To read more about the differences between browsers, visit our
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_comparedocumentposition.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_comparedocumentposition.asp#top" target="_top">TOP</a> |
		<a href="met_element_comparedocumentposition.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
