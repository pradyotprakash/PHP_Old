...
<html lang="en-US">
<head>
<title>XML DOM Node Information</title>
<style>a.menu_dom_nodes_info{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Node Information</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodes_access.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_nodelist.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The nodeName, nodeValue, and nodeType properties contain information about nodes.</p>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodename3">Get the node 
name of an element node</a><br>
This example uses the nodeName property to get the node name of the root element in &quot;books.xml&quot;.</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getelement">Get the text 
from a text node</a><br>
This example uses the nodeValue property to get the text of the first &lt;title&gt; 
element in &quot;books.xml&quot;.</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_changeelement">Change the 
text in a text node</a><br>
This example uses the nodeValue property to change the text of the first &lt;title&gt; 
element in &quot;books.xml&quot;.</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_root">Get the node name 
and type of an element node</a><br>
...
<p>In the XML DOM, each node is an <b>object</b>.</p>
...
<ul>
	...
	<li>nodeName of an attribute 
node is the attribute name</li>
	<li>nodeName of a text node is always #text</li>
	<li>nodeName of the document node is always #document</li>
</ul>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodename3">Try it yourself.</a></p>
...
<p>
The following code retrieves the text node value of the first &lt;title&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getelement" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<ol>
	...
	<li>Get text node of the first &lt;title&gt; element node</li>
...
<p>
The following code changes the text node value of the first &lt;title&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_changeelement" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
	into xmlDoc using <a href="dom_loadxmldoc.asp">loadXMLDoc()</a> </li>
	<li>Get text node of the first &lt;title&gt; element node</li>
	<li>Change the value of the text node to &quot;Easy Cooking&quot;</li>
</ol>
<hr>

<h2>The nodeType Property</h2>
<p>The nodeType property specifies the type of node.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_info.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_info.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_info.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
