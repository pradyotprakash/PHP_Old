...
<title>XML DOM previousSibling Property</title>
<style>a.menu_prop_node_previoussibling{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">previousSibling</span> Property</h1><hr>
...
<p>The previousSibling property returns the node immediately before a node (the 
following node in the same tree level).</p>
<p>If there is no such node, this property returns null.</p>
<h2>Syntax</h2>
...
<p><b>Note:</b> Firefox, and most other browsers, will treat empty white-spaces 
or new lines as text nodes, Internet Explorer will not. o, in the example below, 
we have a function that checks the node type of the previous sibling node.</p>
<p>Element nodes has a nodeType of 1, so if the previous sibling node is not an 
element node, it moves to the next node, and checks if this node is an element 
node. This continues until the previous sibling node (which must be an element node) 
is found. This way, the result will be correct in all browsers.</p>
<p><b>Tip:</b> To read more about the differences between browsers, visit our
<a href="dom_mozilla_vs_ie.asp">DOM Browsers</a> chapter in our XML DOM 
Tutorial.</p>
<hr>
...
loadXMLDoc()</a> and gets the previous sibling node from the first &lt;author&gt; 
element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
//check if the previous sibling node is an element node<br>
...
<br>
x=xmlDoc.getElementsByTagName(&quot;author&quot;)[0];<br>
document.write(x.nodeName);<br>
document.write(&quot; = &quot;);<br>
document.write(x.childNodes[0].nodeValue);<br>
<br>
y=get_previoussibling(x);<br>
<br>
document.write(&quot;<br>Previous sibling: &quot;);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_previoussibling" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Try-It-Yourself Demos</h2>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nextsibling2">nextSibling - Get the next sibling of a node</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_previoussibling.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_previoussibling.asp#top" target="_top">TOP</a> |
		<a href="prop_node_previoussibling.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
