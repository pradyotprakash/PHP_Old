...
<title>XML DOM - CDATASection object</title>
<style>a.menu_dom_cdatasection{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM - The <span class="color_h1">CDATASection</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_text.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_comment.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<div class="tryit_ex">
...
An <a href="dom_loadxmldoc.asp">external JavaScript</a> is used to load the XML file.</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createcdatasection">createCDATASection() - Create a CDATA section node</a></p>
<hr>

<h2>The CDATASection object</h2>
<p>The CDATASection object represents a CDATA section in a document.</p>
<p>A CDATA section contains text that will NOT be parsed by a parser. Tags inside a CDATA section will NOT be treated as markup and entities will not be expanded. 
The primary purpose is for including material such as XML fragments, without needing to escape all the delimiters.</p>
<p>The only delimiter that is recognized in a CDATA section is &quot;]]&gt;&quot; - which indicates the end of the CDATA section. CDATA sections cannot be nested.</p>

<h2>CDATASection Object Properties</h2>
...
<tr>
	<td><a href="prop_cdata_data.asp">data</a></td>
	<td>Sets or returns the text of this node</td>
</tr>
<tr>
	<td><a href="prop_cdata_length.asp">length</a></td>
	<td>Returns the length of the CDATA section</td>
</tr>
</table>

<h2>CDATASection Object Methods</h2>
<table class="reference notranslate">
<tr>
<th style="width:25%">Property</th>
<th>Description</th>
...
<tr>
	<td><a href="met_cdata_appenddata.asp">appendData()</a></td>
	<td>Appends data to the node</td>
</tr>
<tr>
	<td><a href="met_cdata_deletedata.asp">deleteData()</a></td>
	<td>Deletes data from the node</td>
</tr>
<tr>
	<td><a href="met_cdata_insertdata.asp">insertData()</a></td>
	<td>Inserts data into the node</td>
</tr>
<tr>
	<td><a href="met_cdata_replacedata.asp">replaceData()</a></td>
	<td>Replaces data in the node</td>
</tr>
<tr>
	<td><a href="met_cdata_splittext.asp">splitText()</a></td>
	<td>Splits the CDATA node into two nodes</td>
</tr>
<tr>
	<td><a href="met_cdata_substringdata.asp">substringData()</a></td>
	<td>Extracts data from the node</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_cdatasection.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_cdatasection.asp#top" target="_top">TOP</a> |
		<a href="dom_cdatasection.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
