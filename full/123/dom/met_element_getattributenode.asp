...
<title>XML DOM getAttributeNode() Method</title>
...
<h1>XML DOM <span class="color_h1">getAttributeNode()</span> Method</h1><hr>
...
<p>The getAttributeNode() method gets an attribute node by name from the current 
element.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>Required. Specifies the attribute node to get</td>
  </tr>
</table>
<br>
<hr>
...
loadXMLDoc()</a> and gets the &quot;category&quot; attribute from all &lt;book&gt; 
elements:</p>
<div class="example">
...
document.write(attnode.name);<br>
document.write(&quot; = &quot;);<br>
document.write(attnode.value);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_getattributenode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
