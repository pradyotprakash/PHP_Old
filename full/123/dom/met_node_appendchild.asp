...
<p>The appendChild() method appends the new child node to the end of the list of children of a node.</p>
...
<i>nodeObject</i>.appendChild(newchild)
</div></div>
<br>
...
loadXMLDoc()</a> and creates a node (&lt;edition&gt;), and appends it after the last 
child of the first &lt;book&gt; node:</p>
<div class="example">
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createelement">appendChild() - Append a child node to all &lt;book&gt; nodes</a></p>
<hr>
