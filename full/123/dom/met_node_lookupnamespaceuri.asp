...
<title>XML DOM lookupNamespaceURI() Method</title>
<style>a.menu_met_node_lookupnamespaceuri{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">lookupNamespaceURI()</span> Method</h1>
<hr>
...
<p>The lookupNameSpaceURI() method returns the namespace URI associated with a given prefix.</p>
<hr/>
...
<p>The lookupNamespaceURI() method is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet Explorer 9 and earlier does not support this method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>nodeObject</em>.lookupNamespaceURI(<em>prefix</em>)
</div></div>
...
<td><em>prefix</em></td>
<td>String</td>
<td>Required. Specifies the prefix to look for</td>
</tr>
</table>
...
<tr>
<td>String</td>
<td>The namespace URI associated with the specified prefix</td>
</tr>
</table>
...
loadXMLDoc()</a> and finds the namespace URI for the given &quot;c&quot; prefix:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc = loadXMLDoc(&quot;books_ns.xml&quot;);<br>
	<br>x = xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_lookupnamespaceuri" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_lookupnamespaceuri.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_lookupnamespaceuri.asp#top" target="_top">TOP</a> |
		<a href="met_node_lookupnamespaceuri.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
