...
<style>a.menu_met_cdata_appenddata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">appendData()</span> Method</h1><hr>
...
<p>The appendData() method adds data at the end of a CDATA node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>string</td>
    <td>Required. The string to add to the CDATA node</td>
  </tr>
</table>
<br>
...
loadXMLDoc()</a> and appends text to the first &lt;html&gt; element:</p>
<div class="example">
...
<br>
x.appendData(&quot; Wonderful!&quot;);<br>
document.write(x.data);
</div>
<p>Output:</p>
<div class="example_code notranslate">
<b>Stunning!</b> Wonderful!
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_cdata_appenddata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_cdata_appenddata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_cdata_appenddata.asp#top" target="_top">TOP</a> |
		<a href="met_cdata_appenddata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
