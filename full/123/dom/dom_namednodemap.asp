...
<title>XML DOM - NamedNodeMap object</title>
<style>a.menu_dom_namednodemap{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM - The <span class="color_h1">NamedNodeMap</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_nodelist.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_document.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The NamedNodeMap object represents an unordered list of nodes. </p>
<hr>

<h2>The NamedNodeMap object</h2>
<p>The nodes in the NamedNodeMap can be accessed through their name.</p>
<p>The NamedNodeMap keeps itself up-to-date. If an element is deleted or added,
in the node list or the XML document, the list is automatically updated.</p>
<p><b>Note:</b> In a named node map, the nodes are not returned in any particular order.</p>

<h2>NamedNodeMap Object Properties</h2>
...
<tr>
	<td><a href="prop_nodemap_length.asp">length</a></td>
	<td>Returns the number of nodes in the list</td>
</tr>
</table>

<h2>NamedNodeMap Object Methods</h2>
<table class="reference notranslate">
<tr>
...
<tr>
	<td><a href="met_nodemap_getnameditem.asp">getNamedItem()</a></td>
	<td>Returns the node with the specific name</td>
</tr>
<tr>
	<td>getNamedItemNS()</td>
	<td>Returns the node with the specific name and namespace</td>
</tr>
<tr>
	<td><a href="met_nodemap_item.asp">item()</a></td>
	<td>Returns the node at the specified index</td>
</tr>
<tr>
	<td><a href="met_nodemap_removenameditem.asp">removeNamedItem()</a></td>
	<td>Removes the node with the specific name</td>
</tr>
<tr>
	<td>removeNamedItemNS()</td>
	<td>Removes the node with the specific name and namespace</td>
</tr>
<tr>
	<td>setNamedItem()</td>
	<td>Sets the specified node (by name)</td>
</tr>
<tr>
	<td>setNamedItemNS()</td>
	<td>Sets the specified node (by name and namespace)</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_namednodemap.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_namednodemap.asp#top" target="_top">TOP</a> |
		<a href="dom_namednodemap.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
