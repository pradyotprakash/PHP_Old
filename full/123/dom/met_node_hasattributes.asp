...
<title>XML DOM hasAttributes() Method</title>
<style>a.menu_met_node_hasattributes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">hasAttributes()</span> Method</h1><hr>
...
<p>The hasAttributes() method returns <em>true</em> if the specified node has any attributes, otherwise <em>false</em>.</p>
<p><strong>Note:</strong> If the specified node is not an Element node, the return value is always <em>false</em>.</p>
<hr>
...
<p>The hasAttributes() method is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet Explorer 9 and earlier do not support the hasAttributes() method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>nodeObject</i>.hasAttributes()</div></div>
...
loadXMLDoc()</a> and returns whether the first &lt;book&gt; element has any 
attributes:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_hasattributes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_hasattributes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_hasattributes.asp#top" target="_top">TOP</a> |
		<a href="met_node_hasattributes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
