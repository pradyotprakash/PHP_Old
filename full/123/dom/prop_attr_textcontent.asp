...
<style>a.menu_prop_attr_textcontent{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The textContent property sets or returns the textual content of an attribute.</p>
...
loadXMLDoc()</a> and returns the textual content of the category attributes:</p>
<div class="example">
...
{<br>
document.write(x.item(i).attributes[0].textContent);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_attr_textcontent" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Try-It-Yourself Demos</h2>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_attr_textcontent_set">
textContent - Set the textual content of an attribute</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_attr_textcontent.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_attr_textcontent.asp#top" target="_top">TOP</a> |
		<a href="prop_attr_textcontent.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
