...
<style>a.menu_met_element_lookupprefix{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The lookupPrefix() method returns the prefix matching the 
specified namespace URI on the current node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
	...
	<tr>
		<td>URI</td>
		<td>Required. The namespace URI for the prefix to find</td>
	</tr>
	</table>
<br>
<hr>
...
loadXMLDoc()</a> and finds the prefix for a namespace URI in the 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_lookupprefix.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_lookupprefix.asp#top" target="_top">TOP</a> |
		<a href="met_element_lookupprefix.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
