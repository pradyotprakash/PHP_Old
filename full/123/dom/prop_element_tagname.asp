...
<title>XML DOM tagName Property</title>
...
<h1>XML DOM <span class="color_h1">tagName</span> Property</h1><hr>
...
<p>The tagName property returns the tag name of the selected 
element.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the tag name from the first &lt;title&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_tagname2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
