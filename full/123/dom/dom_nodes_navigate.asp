...
<style>a.menu_dom_nodes_navigate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM - <span class="color_h1">Navigating Nodes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_mozilla_vs_ie.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_get.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><img src="navigate.gif" alt="Node tree" width="335" height="354" /></p>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nav_parentnode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
&lt;/script&gt;<br>
&lt;script&gt;<br>
//check if the first node is an element node<br>
function get_firstChild(n)<br>
{<br>
y=n.firstChild;<br>
while (y.nodeType!=1)<br>
&nbsp;&nbsp;{<br>
...
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);<br>
	var
x=get_firstChild(xmlDoc.getElementsByTagName(&quot;book&quot;)[0]);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nav_firstchild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
	into xmlDoc using <a href="dom_loadxmldoc.asp">loadXMLDoc()</a> </li>
	<li>Use the get_firstChild function on the first &lt;book&gt; element node 
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nav_lastchild">lastChild()</a><br>
This example uses the lastChild() method and a custom function to get the last child node of a node</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nav_nextsibling">nextSibling()</a><br>
This example uses the nextSibling() method and a custom function to get the next sibling node of a node</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nav_prevsibling">previousSibling()</a><br>
This example uses the previousSibling() method and a custom function to get the previous sibling node of a node</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_mozilla_vs_ie.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_get.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_navigate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_navigate.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_navigate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
