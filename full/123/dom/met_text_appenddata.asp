...
<style>a.menu_met_text_appenddata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The appendData() method adds a string at the end of a text node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>string</td>
    <td>Required. The string to add to the text node</td>
  </tr>
</table>
<br>
<hr>
...
loadXMLDoc()</a> and appends text to the first &lt;title&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_text_appenddata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_text_appenddata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_text_appenddata.asp#top" target="_top">TOP</a> |
		<a href="met_text_appenddata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
