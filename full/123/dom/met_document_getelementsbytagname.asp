...
<title>XML DOM getElementsByTagName() Method</title>
...
<h1>XML DOM <span class="color_h1">getElementsByTagName()</span> Method</h1><hr>
...
<p>The getElementsByTagName() method returns a NodeList of all elements with the specified name.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and displays the value of the first &lt;title&gt; element:</p>
<div class="example">
