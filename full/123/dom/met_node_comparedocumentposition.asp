...
<title>XML DOM compareDocumentPosition() Method</title>
...
<h1>XML DOM <span class="color_h1">compareDocumentPosition()</span> Method</h1><hr>
...
<p>The compareDocumentPosition() method compares the placement of two nodes in 
the DOM hierarchy (document).</p>
<hr>
...
<p><strong>Note:</strong> Internet Explorer 9 and earlier do not support this method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>nodeObject</i>.compareDocumentPosition(<i>node</i>)</div></div>
<h2>Parameters</h2>
...
<tr>
<td>Number</td>
<td>A Number representing where the two nodes are positioned compared to each other. The possible return values 
are:
<p>1 - No relationship, the two nodes do not belong to the same document.</p>
<p>2 - The specified node precedes the current node.</p>
<p>4 - The specified node follows the current node.</p>
<p>8 - The specified node contains the current node.</p>
<p>16 - The specified node is contained by the current node.</p>
<p>32 - The specified and the current node have no common container node or the two nodes are 
different attributes of the same node.</p>
<p><strong>Note:</strong> The return value could also be a combination of 
values. E.g. a return value of 20 means that the specified node is contained by 
the current node (16) AND the specified node follows the current node (4).</p>
</td>
</tr>
</table>
...
loadXMLDoc()</a> and compares the placement of two nodes (the first and 
the third &lt;book&gt; element) in the DOM hierarchy:</p>
<div class="example">
...
y = xmlDoc.getElementsByTagName('book')[2];<br>
<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_comparedocumentposition" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
