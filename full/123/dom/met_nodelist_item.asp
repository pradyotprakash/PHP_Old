...
<title>XML DOM item() Method</title>
<style>a.menu_met_nodelist_item{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">item()</span> Method</h1>
<hr>
<a href="dom_nodelist.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="NodeList Object Reference" /> NodeList Object</a>
<hr>

<h2>Definition and Usage</h2>
<p>The item() method returns the node at the specified index in a node list.</p>
<p><strong>Note:</strong> The items in a node list are accessible via an index, 
starting from 0.</p>
<hr/>
...
<p>The item() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>nodelist</i>.item(<em>index</em>)</div></div>
<h2>Parameters</h2>
...
<td><em>index</em></td>
<td>Number</td>
<td>Required. The index of the node in the node list. The index starts at 0</td>
</tr>
</table>
...
<tr>
<td>Node object</td>
<td>The node at the specified index, or <em>null</em> if the index is out of 
rangex</td>
</tr>
</table>
...
<tr>
	...
	<td>Core Level 1 Nodelist Object</td>
</tr>
</table>
<br>
<hr>
...
<h2>Example</h2>
<p><b>Note:</b> All major browsers, except Internet Explorer, treat empty white-spaces or new lines as text nodes. So, in the example 
below, there is a function that checks on node type, and displays only Element nodes.
This way, the result will be equal in all browsers. To read more about the differences between browsers, 
please read our
<a href="dom_mozilla_vs_ie.asp">DOM Browsers</a> chapter.</p>
...
loadXMLDoc()</a> and loops through all <strong>child element nodes</strong> of the &lt;bookstore&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodelist_item" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<a href="dom_nodelist.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="NodeList Object Reference" /> NodeList Object</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_nodelist_item.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_nodelist_item.asp#top" target="_top">TOP</a> |
		<a href="met_nodelist_item.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
