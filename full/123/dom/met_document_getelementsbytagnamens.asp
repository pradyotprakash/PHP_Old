...
<title>XML DOM getElementsByTagNameNS() Method</title>
<style>a.menu_met_document_getelementsbytagnamens{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">getElementsByTagNameNS()</span> Method</h1><hr>
...
<p>The getElementsByTagNameNS() method returns a NodeList of all elements with 
the specified 
...
<table class="reference notranslate">
  ...
  <tr>
    <td>ns</td><td>A string that specifies the namespace name to search for. 
	The value &quot;*&quot; matches all tags</td>
  </tr>
  <tr>
    <td>name</td><td>A string that specifies the tagname to search for. The 
	value &quot;*&quot; matches all tags</td>
  </tr>
</table>
<br>
...
loadXMLDoc()</a> and adds an element node with a namespace to each &lt;book&gt; element:</p>
<div class="example">
...
{<br>
newel=xmlDoc.createElementNS('p','edition');<br>
...
z=xmlDoc.getElementsByTagNameNS(&quot;p&quot;,&quot;edition&quot;);<br>
<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createelementns" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_getelementsbytagnamens.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_getelementsbytagnamens.asp#top" target="_top">TOP</a> |
		<a href="met_document_getelementsbytagnamens.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
