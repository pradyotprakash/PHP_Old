...
<title>XML DOM getAttributeNS() Method</title>
<style>a.menu_met_element_getattributens{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">getAttributeNS()</span> Method</h1><hr>
...
<p>The getAttributeNS() method gets an attribute value by namespace URI and name.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the &quot;lang&quot; attribute value from the first &lt;title&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_getattributens" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_getattributens.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_getattributens.asp#top" target="_top">TOP</a> |
		<a href="met_element_getattributens.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
