...
<title>XML DOM hasAttributeNS() Method</title>
<style>a.menu_met_element_hasattributens{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">hasAttributeNS()</span> Method</h1><hr>
...
<p>The hasAttributeNS() method returns TRUE if the current element node has the 
attribute specified 
by namespace and name, and FALSE otherwise.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>ns</td>
    <td>Required. Specifies the namespace of the attribute to find</td>
  </tr>
  <tr>
    <td>name</td>
    <td>Required. Specifies the name of the attribute to find</td>
  </tr>
  </table>
<br>
...
loadXMLDoc()</a> and checks if the first &lt;title&gt; element 
has any attributes of the specified namespace and name:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_hasattributens" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_hasattributens.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_hasattributens.asp#top" target="_top">TOP</a> |
		<a href="met_element_hasattributens.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
