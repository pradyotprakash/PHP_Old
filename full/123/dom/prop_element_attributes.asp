...
<title>XML DOM attributes Property</title>
<style>a.menu_prop_element_attributes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">attributes</span> Property</h1>
<hr>
...
<p>The attributes property returns a NamedNodeMap (attribute list) containing the attributes of 
the selected node</p>
<p>If the selected node is not an element, this property returns NULL.</p>
<h2>Syntax</h2>
...
<p><b>Tip:</b> This property only works on element nodes.</p>
<hr>
...
loadXMLDoc()</a> and gets the number of attributes in the first &lt;title&gt; element in &quot;books.xml&quot;:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_attributes_length" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Example 2</h2>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and gets the value of the &quot;category&quot; 
attribute in the first &lt;book&gt; element&quot;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);<br>
<br>
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0].attributes;<br>
att=x.getNamedItem(&quot;category&quot;);<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_attributes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_attributes.asp#top" target="_top">TOP</a> |
		<a href="prop_element_attributes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
