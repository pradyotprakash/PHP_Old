...
<title>XML DOM replaceData() Method</title>
<style>a.menu_met_comment_replacedata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">replaceData()</span> Method</h1><hr>
<a href="dom_comment.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Comment Object Reference" /> Comment Object</a>
<hr>

<h2>Definition and Usage</h2>
<p>The replaceData() method replaces data in a comment node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>start</td>
    <td>Required. Specifies where to begin replacing characters. Start value starts at zero</td>
  </tr><tr>
    <td>length</td>
    <td>Required. Specifies how many characters to replace</td>
  </tr><tr>
    <td>string</td>
...
<h2>Example</h2>
<p>The following code fragment loads &quot;<a target="_blank" href="books_comment.xml">books_comment.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and replace &quot;Simple&quot; with &quot;Easy&quot; in the 
comment node of the first &lt;book&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc=loadXMLDoc(&quot;books_comment.xml&quot;);<br>
<br>
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0].childNodes;<br>
<br>
for (i=0;i&lt;x.length;i++)<br>
{<br>
if (x[i].nodeType==8)<br>
&nbsp; {<br>
&nbsp; //Process only comment nodes<br>
&nbsp; x[i].replaceData(4,6,&quot;Easy&quot;);<br>
&nbsp; document.write(x[i].data);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_comment_replacedata" class="tryitbtn">Try it yourself &raquo;</a>
</div>		

<p>In the example above we use a loop and an if-test to make sure we only 
process comment nodes. A comment node has a node type of 8.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_comment_replacedata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_comment_replacedata.asp#top" target="_top">TOP</a> |
		<a href="met_comment_replacedata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
