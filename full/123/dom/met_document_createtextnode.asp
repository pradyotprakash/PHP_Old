...
<title>XML DOM createTextNode() Method</title>
...
<h1>XML DOM <span class="color_h1">createTextNode()</span> Method</h1><hr>
...
<p>The createTextNode() method creates a text node.</p>
<p>This method returns a Text object.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>text</td>
    <td>A string that specifies the text for the node</td>
  </tr>
</table>
<br>
...
loadXMLDoc()</a> and adds an element node with a containing text node to each &lt;book&gt; element:</p>
<div class="example">
...
newtext=xmlDoc.createTextNode('First');v
