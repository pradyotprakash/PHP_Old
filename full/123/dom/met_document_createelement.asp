...
<title>XML DOM createElement() Method</title>
...
<h1>XML DOM <span class="color_h1">createElement()</span> Method</h1><hr>
...
<p>The createElement() method creates an element node.</p>
