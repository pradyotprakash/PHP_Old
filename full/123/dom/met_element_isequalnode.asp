...
<style>a.menu_met_element_isequalnode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The isEqualNode() method returns true if a node is equal to the given 
	one, otherwise it returns false.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and checks if two nodes are equal:</p>
<div class="code notranslate"><div>

xmlDoc=loadXMLDoc(&quot;books.xml&quot;);<br>
<br>
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[1];<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_isequalnode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_isequalnode.asp#top" target="_top">TOP</a> |
		<a href="met_element_isequalnode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
