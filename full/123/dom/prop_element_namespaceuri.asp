...
<style>a.menu_prop_element_namespaceuri{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The namespaceURI property returns URI of the namespace for the selected 
element</p>
<p>If the selected node is not an element or attribute, this property always returns NULL.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets namespace URI from the first &lt;title&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_namespaceuri" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_namespaceuri.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_namespaceuri.asp#top" target="_top">TOP</a> |
		<a href="prop_element_namespaceuri.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
