...
<title>XML DOM - DocumentType object</title>
<style>a.menu_dom_documenttype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM - The <span class="color_h1">DocumentType</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_documentimplementation.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_processinginstruction.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>The DocumentType object</h2>

<p>Each document has a DOCTYPE attribute that whose value is either null or a DocumentType object.</p>
<p>The DocumentType object provides an interface to the entities defined for an 
XML document.</p>

<h2>DocumentType Object Properties</h2>
...
<tr>
	<td><a href="prop_documenttype_entities.asp">entities</a></td>
	<td>Returns a NamedNodeMap containing the entities declared in the DTD</td>
</tr>
<tr>
	<td><a href="prop_documenttype_internalsubset.asp">internalSubset</a></td>
	<td>Returns the internal DTD as a string</td>
</tr>
<tr>
	<td><a href="prop_documenttype_name.asp">name</a></td>
	<td>Returns the name of the DTD</td>
</tr>
<tr>
	<td>notations</td>
	<td>Returns a NamedNodeMap containing the notations declared in	the DTD</td>
</tr>
<tr>
	<td><a href="prop_documenttype_systemid.asp">systemId</a></td>
	<td>Returns the system identifier of the external DTD</td>
</tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_documenttype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_documenttype.asp#top" target="_top">TOP</a> |
		<a href="dom_documenttype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
