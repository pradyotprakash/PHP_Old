...
<title>XML DOM createComment() Method</title>
...
<h1>XML DOM <span class="color_h1">createComment()</span> Method</h1><hr>
...
<p>The createComment() method creates a comment node.</p>
<p>This method returns a Comment object.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and adds a comment node to the &lt;book&gt; element:</p>
<div class="example">
...
var newComment,newtext;<br>
newtext=&quot;Revised April 2008&quot;;<br>
<br>
for (i=0;i&lt;x.length;i++)<br>
{<br>
newComment=xmlDoc.createComment(newtext);<br>
x[i].appendChild(newComment);<br>
}
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createcomment" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
