...
<style>a.menu_dom_http{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_comment.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_errors.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_xmlhttprequest_first">A 
simple XMLHttpRequest example</a><br>
Create a simple XMLHttpRequest, and retrieve data from a TXT file.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_xmlhttprequest_header">
Retrieve header information with getAllResponseHeaders()</a><br>
Retrieve header information of a resource (file).</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_xmlhttprequest_lastmodified">
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_xmlhttprequest_suggest">Retrieve the content of an ASP file</a><br>
How a web page can communicate with a web server while a user type characters in an input field.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_xmlhttprequest_database">Retrieve content from a database</a><br>
How a web page can fetch information from a database with the XMLHttpRequest object.</p>

<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_xmlhttprequest_xml">Retrieve the content of an XML file</a><br>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Specifies the type of request, the URL, if the request should be handled 
	asynchronously or not, and other optional attributes of a request
...
<table class="reference notranslate">
  ...
  <tr>
    <td>status</td>
    <td>Returns the status-number (e.g. &quot;404&quot; for &quot;Not Found&quot; or &quot;200&quot; for 
	&quot;OK&quot;)</td>
  </tr>
  <tr>
    <td>statusText</td>
    <td>Returns the status-text (e.g. &quot;Not Found&quot; or  
	&quot;OK&quot;)</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_http.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_http.asp#top" target="_top">TOP</a> |
		<a href="dom_http.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
