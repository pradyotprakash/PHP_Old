...
<style>a.menu_met_element_hasattributes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The hasAttributes() method returns TRUE if the current element node has any 
attributes, and FALSE otherwise.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and checks if the first &lt;book&gt; element has any attributes:</p>
<div class="example">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_hasattributes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_hasattributes.asp#top" target="_top">TOP</a> |
		<a href="met_element_hasattributes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
