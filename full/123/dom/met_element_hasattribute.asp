...
<title>XML DOM hasAttribute() Method</title>
...
<h1>XML DOM <span class="color_h1">hasAttribute()</span> Method</h1><hr>
...
<p>The hasAttribute() method returns TRUE if the current element node has the 
attribute specified 
by name, and FALSE otherwise.</p>
<h2>Syntax</h2>
...
<h2>Example</h2>
<p>TThe following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and checks if the first &lt;book&gt; element 
has any &quot;category&quot; attributes:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_hasattribute" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
