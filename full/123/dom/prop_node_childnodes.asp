...
<style>a.menu_prop_node_childnodes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">childNodes</span> Property</h1>
<hr>
...
<p>The childNodes property returns a NodeList of child nodes for the specified node.</p>
<p>
<strong>Tip: </strong>You can use the length property to determine the number of child nodes, then you can loop through all child nodes and extract the info you want.</p>
...
<p>The childNodes property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>nodeObject</em>.childNodes
</div></div>
...
<tr>
	...
	<td>A NodeList object representing a collection of nodes</td>
</tr>
<tr>
	<th>DOM Version</th>
	<td>Core Level 1</td>
...
loadXMLDoc()</a> and displays the child nodes of the XML document:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc = loadXMLDoc(&quot;books.xml&quot;);<br>
<br>
x = xmlDoc.childNodes;<br>
...
&nbsp;
document.write(&quot; (nodetype: &quot; + x[i].nodeType + &quot;)&lt;br&gt;&quot;);<br>
&nbsp;
}
</div>
<p>Output IE:</p>
<div class="example_code notranslate">
Nodename: xml (nodetype: 7)<br>
Nodename: #comment (nodetype: 8)<br>
Nodename: bookstore (nodetype: 1)
</div>
<p>Output Firefox, Opera, Chrome, and Safari :</p>
<div class="example_code notranslate">
Nodename: #comment (nodetype: 8)<br>
Nodename: bookstore (nodetype: 1)
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_document_childnodes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Try-It-Yourself Demos</h2>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodetype">Display all child 
nodes of all the elements in the XML document</a></p><hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_childnodes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_childnodes.asp#top" target="_top">TOP</a> |
		<a href="prop_node_childnodes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
