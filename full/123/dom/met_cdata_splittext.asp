...
<title>XML DOM splitText() Method</title>
<style>a.menu_met_cdata_splittext{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">splitText()</span> Method</h1><hr>
...
<p>The splitText() method splits the text node into two nodes at the specified 
offset.</p>
<p>This function returns the node containing the text after the offset.</p>
<p>The text before the offset remains in the original text node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>offset</td>
    <td>Required. Specifies where to split the text node. Offset value starts at zero</td>
  </tr>
</table>
<br>
...
loadXMLDoc()</a> and splits the text in the first CDATA node:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_cdata_splittext" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<a href="dom_cdatasection.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="CDATA Object Reference" /> CDATA Object</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_cdata_splittext.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_cdata_splittext.asp#top" target="_top">TOP</a> |
		<a href="met_cdata_splittext.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
