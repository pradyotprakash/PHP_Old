...
<title>XML DOM removeChild() Method</title>
<style>a.menu_met_node_removechild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">removeChild()</span> Method</h1><hr>
...
<p>The removeChild() method removes a specified child node from the current 
node.</p>
<p><strong>Tip:</strong> The removed child node can be inserted later into any 
...
importNode() method to insert the removed node into another document.</p>
<hr/>
...
<p>The removeChild() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>nodeObject</i>.removeChild(<i>child</i>)</div></div>
...
<td><em>child</em></td>
<td>Node object</td>
<td>Required. The node to remove</td>
</tr>
</table>
...
<tr>
<td>Node object</td>
<td>Returns the removed node as a Node object</td>
</tr>
</table>
...
loadXMLDoc()</a> and removes the first child node in the first &lt;book&gt; node:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	xmlDoc = loadXMLDoc(&quot;books.xml&quot;);<br><br>root = xmlDoc.documentElement;<br>
	currNode = root.childNodes[1];<br>removedNode = currNode.removeChild(currNode.childNodes[1]);<br>
	document.write(&quot;Removed node: &quot; + removedNode.nodeName);</div>
<p>Output:</p>
<div class="example_code notranslate">
	Removed node: title</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_removechild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_removechild.asp#top" target="_top">TOP</a> |
		<a href="met_node_removechild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
