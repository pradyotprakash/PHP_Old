...
<style>a.menu_met_element_clonenode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The cloneNode() method creates an exact copy of a specified node.</p>
<p>This method returns the cloned node.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and copies the first &lt;book&gt; node, then adds the 
copy to the end of the node list:</p>
<div class="example">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_clonenode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_clonenode.asp#top" target="_top">TOP</a> |
		<a href="met_element_clonenode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
