...
<style>a.menu_prop_document_childnodes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The childNodes property returns a NodeList of child nodes for the document.</p>
<h2>Syntax</h2>
...
<p><b>Tip:</b> Use the NodeLists's length property to determine the number of 
nodes in a node list. When you know the length of a node list, you can easily 
loop through it and extract the values you want!</p>
<hr>
...
nodes of all the elements in the XML document</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_document_childnodes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_document_childnodes.asp#top" target="_top">TOP</a> |
		<a href="prop_document_childnodes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
