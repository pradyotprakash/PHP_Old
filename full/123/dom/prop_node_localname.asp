...
<title>XML DOM localName Property</title>
<style>a.menu_prop_node_localname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">localName</span> Property</h1><hr>
...
<p>The localName property returns the local part of the name of a node.</p>
<p>For nodes of other types than <strong>ELEMENT_NODE,</strong> <strong>
ATTRIBUTE_NODE</strong>, and nodes created with a DOM Level 1 method, the return value is always <em>null</em>.</p>
<hr>
...
<p>The localName property is supported in all major browsers, except Internet Explorer.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>nodeObject</em>.localName</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td>A String representing the local name of the node</td>
</tr>
<tr>
	<th>DOM Version</th>
...
loadXMLDoc()</a> and returns the local name of the &lt;title&gt; elements:</p>
<div class="example">
...
{<br>
&nbsp;
document.write(x.item(i).localName);<br>
&nbsp;
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_node_prefix" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_localname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_localname.asp#top" target="_top">TOP</a> |
		<a href="prop_node_localname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
