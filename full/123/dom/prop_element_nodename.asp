...
<style>a.menu_prop_element_nodename{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The nodeName property returns the tag name of the selected 
element.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the tag name from the first &lt;title&gt; 
element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_nodename2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_nodename.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_nodename.asp#top" target="_top">TOP</a> |
		<a href="prop_element_nodename.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
