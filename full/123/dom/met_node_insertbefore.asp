...
<title>XML DOM insertBefore() Method</title>
...
<h1>XML DOM <span class="color_h1">insertBefore()</span> Method</h1><hr>
...
<p>The insertBefore() method inserts a new child node before a specified child 
node of the current node.</p>
<p><strong>Note:</strong> If the <em>newchild</em> is already in the tree, it is 
first removed.</p>
...
<i>nodeObject</i>.insertBefore(<i>newchild,existingnode</i>)</div></div>
...
<td>Node object</td>
<td>Required. The new child node to insert</td>
</tr>
<tr>
<td><em>existingnode</em></td>
<td>Node object</td>
<td>Required. The node to insert the new child node before. If <em>existingnode</em> 
is null, insert <em>newchild</em> at the end of the list of children</td>
</tr>
</table>
...
loadXMLDoc()</a>, creates a new &lt;book&gt; node and inserts it before 
the last &lt;book&gt; node:</p>
<div class="example">
