...
<div class="next"><a class="chapter" href="dom_intro.asp">Next Chapter &raquo;</a></div>
</div>
<br>
<div class="tutintro">
<img src="http://www.w3schools.com/images/w3xmldom.gif" alt="XML DOM" />
<p>The XML DOM defines a standard way for accessing and manipulating XML documents.</p>
<p>The DOM presents an XML document as a tree-structure.</p>
<p>Knowing the XML DOM is a must for anyone working with XML.</p>
<p><a href="dom_intro.asp"><b>Start learning the XML DOM now!</b></a></p>
</div>
<div class="example">
...
<br>
<hr><h2>XML DOM Objects Reference</h2>
<p>At W3Schools you will find a complete DOM reference, with all the objects and their properties and methods.</p>
<p><a href="dom_attribute.asp">XML DOM Reference</a></p>

<hr><h2>XML DOM Examples</h2>
<p>Learn by 50 examples! With our editor, you can edit the source, and click on a test button to view the result.</p>
<p> <a href="dom_examples.asp">Try-It-Yourself!</a></p>
