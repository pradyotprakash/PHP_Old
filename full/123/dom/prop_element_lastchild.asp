...
<style>a.menu_prop_element_lastchild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The lastChild property returns the last child node of the selected 
element</p>
<p>If the selected node has no children, this property returns NULL.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the last child node:</p>
<div class="example">
...
lastNode=get_lastchild(x);<br>
<br>
for (i=0;i&lt;lastNode.childNodes.length;i++)<br>
{<br>
if (lastNode.childNodes[i].nodeType==1)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;//Process only element nodes<br>
&nbsp;&nbsp;document.write(lastNode.childNodes[i].nodeName);<br>
&nbsp;&nbsp;document.write(&quot; = &quot;);<br>
&nbsp;&nbsp;document.write(lastNode.childNodes[i].childNodes[0].nodeValue);<br>
...
<div class="example_code notranslate">
title = Learning XML<br>
author = Erik T. Ray<br>
year = 2003<br>
price = 39.95
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_lastchild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_lastchild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_lastchild.asp#top" target="_top">TOP</a> |
		<a href="prop_element_lastchild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
