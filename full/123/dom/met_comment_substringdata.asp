...
<title>XML DOM substringData() Method</title>
<style>a.menu_met_comment_substringdata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">substringData()</span> Method</h1><hr>
...
<p>The substringData() method gets a string from the comment node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>start</td>
    <td>Required. Specifies where to begin extracting characters. Start value starts at zero</td>
  </tr>
  <tr>
    <td>length</td>
    <td>Required. Specifies how many characters to extract</td>
  </tr>
</table>
<br>
<hr>

<h2>Example</h2><p>The following code fragment loads &quot;<a target="_blank" href="books_comment.xml">books_comment.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and gets the &quot;(Hardcover)&quot; string form the first 
comment element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_comment_substringdata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_comment_substringdata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_comment_substringdata.asp#top" target="_top">TOP</a> |
		<a href="met_comment_substringdata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
