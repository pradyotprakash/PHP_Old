...
<style>a.menu_met_element_insertbefore{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The insertBefore() method inserts a new child node before an existing child 
node.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>new_node</td>
    <td>Required. The node to insert</td>
  </tr>
  <tr>
    <td>existing_node</td>
    <td>Required. The existing node. The new node is inserted before this node.</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_insertbefore.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_insertbefore.asp#top" target="_top">TOP</a> |
		<a href="met_element_insertbefore.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
