...
<title>XML DOM internalSubset Property</title>
<style>a.menu_prop_documenttype_internalsubset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">internalSubset</span> Property</h1>
<hr>
...
<p>The internalSubset property returns the internal DTD as a string (without the 
delimiting square brackets), or null if there 
	is none.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and displays the internal DTD as a string:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_documenttype_internalsubset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_documenttype_internalsubset.asp#top" target="_top">TOP</a> |
		<a href="prop_documenttype_internalsubset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
