...
<style>a.menu_prop_cdata_length{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The length property returns the number of characters in the selected node</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the text node data and length from the first &lt;title&gt; 
element:</p>
<div class="example">
...
<br>
document.write(x.data);<br>
document.write(&quot; - Length: &quot;);<br>
document.write(x.length);
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
<b>Stunning!</b> - Length: 16
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_cdata_length" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Remember that the length above is from the entire CDATA section 
(&lt;b&gt;Stunning!&lt;/b&gt;), not just the text.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_cdata_length.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_cdata_length.asp#top" target="_top">TOP</a> |
		<a href="prop_cdata_length.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
