...
<style>a.menu_dom_element{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM - The <span class="color_h1">Element</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_processinginstruction.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_attribute.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>The Element object</h2>
<p>The Element object represents an element in an XML document. Elements may contain attributes,
...
<p>Because the Element object is also a Node, it inherits the Node object's properties and methods. </p>

<h2>Element Object Properties</h2>
...
<tr>
	...
	<td>Sets or returns the text content of the element and its 
	descendants</td>
</tr>
</table>

<h2>Element Object Methods</h2>
<table class="reference notranslate">
<tr>
...
<tr>
	...
	object must first have been set to this node by calling setUserData with the same key</td>
</tr>
<tr>
...
<tr>
	<td><a href="met_element_issamenode.asp">isSameNode()</a></td>
	<td>Checks if two nodes are the same node</td>
</tr>
<tr>
	<td>isSupported(feature,version)</td>
	<td>Returns whether a specified feature is supported on the element</td>
</tr>
<tr>
...
<tr>
	...
	and entity references) separates Text nodes, i.e., there are neither adjacent Text nodes nor empty 
	Text nodes</td>
</tr>
<tr>
...
<tr>
	...
	<td>If the isId property of the Attribute object is true, this 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_element.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_element.asp#top" target="_top">TOP</a> |
		<a href="dom_element.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
