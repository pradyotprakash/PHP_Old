...
<p>The getElementsByTagName() method returns a NodeList of all a elements with a specified name.</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a> and gets the value of all &lt;title&gt; elements:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_getelementsbytagname1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
