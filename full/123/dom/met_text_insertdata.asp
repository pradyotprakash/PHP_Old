...
<style>a.menu_met_text_insertdata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The insertData() method inserts data to a text node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>start</td>
    <td>Required. Specifies where to begin inserting characters. 
...
loadXMLDoc()</a> and inserts a string to the text node of the first &lt;title&gt; element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_text_insertdata" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_text_insertdata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_text_insertdata.asp#top" target="_top">TOP</a> |
		<a href="met_text_insertdata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
