...
<title>XML DOM value Property</title>
...
<h1>XML DOM <span class="color_h1">value</span> Property</h1>
<hr>
...
{<br>
document.write(x.item(i).attributes[0].name);<br>
document.write(&quot; = &quot;);<br>
document.write(x.item(i).attributes[0].value);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_attr_name" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
