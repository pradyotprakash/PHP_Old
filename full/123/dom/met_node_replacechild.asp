...
<title>XML DOM replaceChild() Method</title>
<style>a.menu_met_node_replacechild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">replaceChild()</span> Method</h1><hr>
<a href="dom_node.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Node Object Reference" /> Node Object</a>
<hr>

<h2>Definition and Usage</h2>
<p>The replaceChild() method replaces a child node with a new node.</p>
<p>The new node could be an existing node in the document, or you can create a new node.</p>
<p><strong>Tip:</strong> The replaced child node can be inserted later into any 
element in the same document. Use the <a href="met_element_insertbefore.asp">
insertBefore()</a> or <a href="met_node_appendchild.asp">appendChild()</a> 
method to insert it later into the same document, or use the adoptNode() or 
importNode() method to insert the replaced node into another document.&nbsp;</p>
<hr/>
...
<p>The replaceChild() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>nodeObject</i>.replaceChild(<i>newchild</i>,<i>oldchild</i>)</div></div>
...
<tr>
<td><em>newchild</em></td>
<td>Node object</td>
<td>Required. The new node to put in the child list</td>
</tr>
<tr>
<td><em>oldchild</em></td>
<td>Node object</td>
<td>Required. The node that will be replaced in the child list</td>
</tr>
</table>
...
<tr>
<td>Node object</td>
<td>The replaced node (<em>oldchild</em>)</td>
</tr>
</table>
...
<tr>
	...
	<td>Core Level 1 Node Object. Modified in DOM Level 3</td>
</tr>
</table>
<br>
<hr>
...
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a> and replaces the first &lt;book&gt; node with a new book node:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc = loadXMLDoc(&quot;books.xml&quot;);<br>
x = xmlDoc.documentElement;<br><br>// Create a book element, title element and a 
	text node<br>newNode = xmlDoc.createElement(&quot;book&quot;);<br>newTitle = 
	xmlDoc.createElement(&quot;title&quot;);<br>newText = xmlDoc.createTextNode(&quot;A 
	Notebook&quot;);<br><br>// Add a text node to the title node<br>
	newTitle.appendChild(newText);<br><br>// Add the title node to the book node<br>
	newNode.appendChild(newTitle);<br><br>y = xmlDoc.getElementsByTagName(&quot;book&quot;)[0]<br>
	<br>// Replace the first book node with the new book node<br>
	x.replaceChild(newNode,y);</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_element_replacechild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_replacechild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_replacechild.asp#top" target="_top">TOP</a> |
		<a href="met_node_replacechild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
