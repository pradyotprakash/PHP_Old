...
<title>XML DOM setAttributeNode() Method</title>
...
<h1>XML DOM <span class="color_h1">setAttributeNode()</span> Method</h1><hr>
...
<p>The setAttributeNode() method adds a new attribute node.</p>
<p>If an attribute with that name 
	...
	returned, otherwise it returns null.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>att_node</td>
    <td>Required. Specifies the attribute node to set</td>
  </tr>
</table>
<br>
<hr>
...
loadXMLDoc()</a> and adds a &quot;edition&quot; attribute to all &lt;book&gt; 
elements:</p>
<div class="example">
...
newatt.value=&quot;first&quot;;<br>
x[i].setAttributeNode(newatt);<br>
}<br>
<br>
//Output all &quot;edition&quot; attribute values<br>
for (i=0;i&lt;x.length;i++)<br>
{<br>
document.write(&quot;Edition: &quot;);<br>
document.write(x[i].getAttribute(&quot;edition&quot;));<br>
