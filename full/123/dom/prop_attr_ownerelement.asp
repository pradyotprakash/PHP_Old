...
<title>XML DOM ownerElement Property</title>
<style>a.menu_prop_attr_ownerelement{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">ownerElement</span> Property</h1><hr>
...
<p>The ownerElement property returns the element node the attribute is attached 
to.</p>
...
loadXMLDoc()</a> and returns the element node the first category attribute is 
attached to:</p>
<div class="example">
...
<br>
document.write(x.item(0).attributes[0].ownerElement);<br>
document.write(&quot;<br>&quot;);<br>
document.write(x.item(0).attributes[0].ownerElement.nodeName);<br>
document.write(&quot;<br>&quot;);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_attr_ownerelement" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_attr_ownerelement.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_attr_ownerelement.asp#top" target="_top">TOP</a> |
		<a href="prop_attr_ownerelement.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
