...
<title>XML DOM baseURI Property</title>
<style>a.menu_prop_node_baseuri{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">baseURI</span> Property</h1>
<hr>
...
<p>The baseURI property returns the absolute base URI of a node.</p>
...
<p>The baseURI property is supported in all major browsers, except Internet Explorer.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>nodeObject</em>.baseURI
</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td>A String representing the absolute base URI of a node</td>
</tr>
<tr>
	<th>DOM Version</th>
...
loadXMLDoc()</a> and returns the base URI of the &lt;title&gt; elements:</p>
<div class="example">
...
{<br>
&nbsp;
document.write(x.item(i).baseURI);<br>
&nbsp;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_baseuri.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_baseuri.asp#top" target="_top">TOP</a> |
		<a href="prop_node_baseuri.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
