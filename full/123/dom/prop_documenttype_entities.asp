...
<title>XML DOM entities Property</title>
<style>a.menu_prop_documenttype_entities{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">entities</span> Property</h1>
<hr>
<a href="dom_documenttype.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="DocumentType Object Reference" /> DocumentType Object</a>
<hr>

<h2>Definition and Usage</h2>
<p>The entities property returns a NamedNodeMap containing both the external and 
internal entities declared in the DTD.</p>
<h2>Syntax</h2>
...
<h2>Example</h2>
<p>The following code fragment loads &quot;<a target="_blank" href="note_internal_dtd.xml">note_internal_dtd.xml</a>&quot; 
into xmlDoc using <a href="dom_loadxmldoc.asp">
loadXMLDoc()</a>, displays the node name and the node type of the 
entities declared in the DTD:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
xmlDoc=loadXMLDoc(&quot;note_internal_dtd.xml&quot;);<br>
<br>
x=xmlDoc.doctype.entities;<br>
<br>
for (i=0;i&lt;x.length;i++)<br>
{<br>
document.write(&quot;Nodename: &quot; + x.item(i).nodeName);<br>
document.write(&quot;<br>&quot;);<br>
document.write(&quot;Nodetype: &quot; + x.item(i).nodeType);<br>
document.write(&quot;<br>&quot;);<br>
}
</div>
<p>Output:</p>
...
Nodename: writer<br>
Nodetype: 6<br>
Nodename: copyright<br>
Nodetype: 6
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_documenttype_entities" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_documenttype_entities.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_documenttype_entities.asp#top" target="_top">TOP</a> |
		<a href="prop_documenttype_entities.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
