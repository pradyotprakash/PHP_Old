...
<title>XML DOM createCDATASection() Method</title>
<style>a.menu_met_document_createcdatasection{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">createCDATASection()</span> Method</h1>
<hr>
...
<p>The createCDATASection() method creates a CDATA section node.</p>
<p>This method returns a CDATASection object.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>data</td>
    <td>A string that specifies the data for the node</td>
  </tr>
</table>
<br>
...
loadXMLDoc()</a> and adds a CDATA section node to the &lt;book&gt; element:</p>
<div class="example">
...
var newCDATA,newtext;<br>
<br>
newtext=&quot;Special Offer &amp; Book Sale&quot;;<br>
<br>
for (i=0;i&lt;x.length;i++)<br>
{<br>
newCDATA=xmlDoc.createCDATASection(newtext);<br>
x[i].appendChild(newCDATA);<br>
}
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_createcdatasection" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_createcdatasection.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_createcdatasection.asp#top" target="_top">TOP</a> |
		<a href="met_document_createcdatasection.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
