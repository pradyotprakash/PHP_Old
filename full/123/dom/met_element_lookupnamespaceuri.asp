...
<style>a.menu_met_element_lookupnamespaceuri{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">lookupNamespaceURI()</span> Method</h1><hr>
...
<p>The lookupNamespaceURI() method returns the namespace matching the 
specified prefix on the current node.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
	...
	<tr>
		<td>prefix</td>
		<td>Required. A string that specifies prefix to find</td>
	</tr>
	</table>
<br>
<hr>
...
loadXMLDoc()</a> and finds the namespace URI for the &quot;c&quot; prefix in the 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_lookupnamespaceuri.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_lookupnamespaceuri.asp#top" target="_top">TOP</a> |
		<a href="met_element_lookupnamespaceuri.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
