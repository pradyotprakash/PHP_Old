...
<style>a.menu_dom_nodes_access{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM - <span class="color_h1">Accessing Nodes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_methods.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_nodes_info.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
This example uses the getElementsByTagname() method to get the third &lt;title&gt; element in &quot;books.xml&quot;</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_list_loop">Loop through nodes using the length property</a><br>
This example uses the length property to loop through all &lt;title&gt; elements in &quot;books.xml&quot;</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_root">See the node type of an element</a><br>
This example uses the nodeType property to get node type of the root element in &quot;books.xml&quot;.</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_loop">Loop through element nodes</a><br>
This example uses the nodeType property to only process element nodes in &quot;books.xml&quot;.</p>
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_navigate">Loop through 
element nodes using node relationships</a><br>
This example uses the nodeType property and the nextSibling property to process element nodes in &quot;books.xml&quot;.</p>
<hr>
...
<p>The following code loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; into xmlDoc using
<a href="dom_loadxmldoc.asp">loadXMLDoc()</a> and stores a list of &lt;title&gt; nodes (a node list) in the variable x:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_list_loop" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<p><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_root">Try it yourself</a></p>
...
xmlDoc=loadXMLDoc(&quot;books.xml&quot;);<br>
	var
x=xmlDoc.documentElement.childNodes;<br>
<br>
for (i=0;i&lt;x.length;i++)<br>
&nbsp;
{<br>
&nbsp; // Process only element nodes (type 1)<br>
&nbsp;&nbsp;if (x[i].nodeType==1)<br>
&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; document.write(x[i].nodeName);<br>
&nbsp;&nbsp;&nbsp; document.write(&quot;&lt;br&gt;&quot;);<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;
}
</div>
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_loop" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
...
<br>
	var
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0].childNodes;<br>
	var
y=xmlDoc.getElementsByTagName(&quot;book&quot;)[0].firstChild;<br>
<br>
for (i=0;i&lt;x.length;i++)<br>
&nbsp;
{<br>&nbsp; // Process only element nodes (type 1)<br>
&nbsp;
if (y.nodeType==1)<br>
&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; document.write(y.nodeName + &quot;&lt;br&gt;&quot;);<br>
&nbsp;
&nbsp;&nbsp;}<br>
&nbsp;
y=y.nextSibling;<br>
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_navigate" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<ol>
	<li>Load &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
	into xmlDoc using <a href="dom_loadxmldoc.asp">loadXMLDoc()</a> </li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodes_access.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodes_access.asp#top" target="_top">TOP</a> |
		<a href="dom_nodes_access.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
