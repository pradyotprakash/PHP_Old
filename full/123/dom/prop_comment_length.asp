...
<title>XML DOM length Property</title>
<style>a.menu_prop_comment_length{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">length</span> Property</h1>
<hr>
...
<p>The length property returns the length of the text in a comment node (in characters).</p>
<h2>Syntax</h2>
...
loadXMLDoc()</a>, gets the text node data and length from the first &lt;title&gt; 
element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/dom/tryit.asp?filename=try_dom_comment_length" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_comment_length.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_comment_length.asp#top" target="_top">TOP</a> |
		<a href="prop_comment_length.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
