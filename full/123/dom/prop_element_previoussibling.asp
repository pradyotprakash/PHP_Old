...
<style>a.menu_prop_element_previoussibling{font-weight:bold;}</style>
<meta charset="utf-8">
...
<a href="dom_element.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Element Object Reference" /> Element Object</a>
<hr>

<h2>Definition and Usage</h2>
<p>The previousSibling property returns the previous sibling node (the 
previous node 
...
below, we have a function that checks the node type of the previous sibling node.</p>
<p>Element nodes has a nodeType of 1, so if the previous sibling node is not an element 
...
node) is found. This way, the result will be correct in all browsers.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_previoussibling.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_previoussibling.asp#top" target="_top">TOP</a> |
		<a href="prop_element_previoussibling.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
