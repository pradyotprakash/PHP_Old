...
<title>XML DOM - NodeList object</title>
<style>a.menu_dom_nodelist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM - The <span class="color_h1">NodeList</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_node.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_namednodemap.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The NodeList object represents an ordered list of nodes. </p>
<hr>

<h2>The NodeList object</h2>
<p>The nodes in the node list can be accessed through their index number (starting from 0).</p>
<p>The node list keeps itself up-to-date. If an element is deleted or added, in the node list or the XML document,
the list is automatically updated.</p>
<p><b>Note:</b> In a node list, the nodes are returned in the order in which they are specified in the XML 
document.</p>

<h2>NodeList Object Properties</h2>
...
<tr>
	<td><a href="prop_nodelist_length.asp">length</a></td>
	<td>Returns the number of nodes in a node list</td>
</tr>
</table>

<h2>NodeList Object Methods</h2>
<table class="reference notranslate">
<tr>
...
<tr>
	<td><a href="met_nodelist_item.asp">item()</a></td>
	<td>Returns the node at the specified index in a node list</td>
</tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_nodelist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_nodelist.asp#top" target="_top">TOP</a> |
		<a href="dom_nodelist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
