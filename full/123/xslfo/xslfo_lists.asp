...
<title>XSL-FO Lists</title>
<style>a.menu_xslfo_lists{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">Lists</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xslfo_blocks.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xslfo_tables.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XSL-FO uses the &lt;fo:list-block&gt; element to define lists.</p>
<hr>

<h2>XSL-FO List Blocks</h2>
...
<table style="padding:5;width:50%;border:1px solid black">
<tr><td>
&nbsp;* Volvo<br>
&nbsp;* Saab<br>
</td></tr></table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xslfo_lists.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xslfo_lists.asp#top" target="_top">TOP</a> |
		<a href="xslfo_lists.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
