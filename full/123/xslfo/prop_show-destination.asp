...
<title>XSL-FO show-destination Property</title>
<style>a.menu_prop_show-destination{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">show-destination</span> Property</h1>
...
<p>The show-destination property specifies where the link resource should be 
displayed.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>replace</td>
    <td>Default. The current document should be replaced. However, 
	if the link resource is in the page, it should be scrolled into sight</td>
  </tr>
  <tr>
    <td>new</td>
    <td>A new document should be opened</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_show-destination.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_show-destination.asp#top" target="_top">TOP</a> |
		<a href="prop_show-destination.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
