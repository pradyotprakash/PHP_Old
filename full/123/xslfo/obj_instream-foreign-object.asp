...
<title>XSL-FO instream-foreign-object Object</title>
<style>a.menu_obj_instream-foreign-object{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">instream-foreign-object</span> Object</h1>
...
<p>The &lt;fo:instream-foreign-object&gt; object is used for inline graphics or for &quot;generic&quot; objects where 
...
SVG).</p>
<p>The content size of this object is defined by taking the size of the object 
and scaling specified by the content-height, content-width, and scaling 
properties. </p>
<p>If the content is too large for the area after scaling, the overflow property 
controls the clipping and scroll bars.</p>
...
&lt;fo:instream-foreign-object&gt;<br>
&nbsp;&nbsp;&lt;!--<br>
&nbsp;&nbsp;&nbsp;&nbsp;Contents:(see below)<br>
&nbsp;&nbsp;--&gt;<br>
&lt;/fo:instream-foreign-object&gt;

</div></div>
<p>This object has a child from a non-XSL namespace. It also may have additional 
attributes in the non-XSL namespace.</p>
<h2>Properties</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_instream-foreign-object.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_instream-foreign-object.asp#top" target="_top">TOP</a> |
		<a href="obj_instream-foreign-object.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
