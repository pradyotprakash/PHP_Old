...
<title>XSL-FO page-height Property</title>
<style>a.menu_prop_page-height{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">page-height</span> Property</h1>
...
<p>The page-height property defines the height of a page.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. The height shall be set from the size of the 
	browser window or from the size of the media</td>
  </tr>
  <tr>
    <td>indefinite</td>
    <td>The height of the page is set from the size of the laid-out 
	content</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Defines a fixed height for the page</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_page-height.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_page-height.asp#top" target="_top">TOP</a> |
		<a href="prop_page-height.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
