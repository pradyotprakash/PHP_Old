...
<title>XSL-FO border color Property</title>
<style>a.menu_prop_border_color{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">border color Properties</span> Property</h1>
...
<p>The <b>border-before-color</b> property specifies the color of the border on the 
before-edge of the area.</p>
<p>The <b>border-after-color</b> property specifies the color of the border on the 
after-edge of the area.</p>
<p>The <b>border-top-color</b> property specifies the color of the border on the 
top-edge of the area.</p>
<p>The <b>border-bottom-color</b> property specifies the color of the border on the 
bottom-edge of the area.</p>
<p>The <b>border-start-color</b> property specifies the color of the border on the 
start-edge of the area.</p>
<p>The <b>border-end-color</b> property specifies the color of the border on the 
end-edge of the area.</p>
<p>The <b>border-left-color</b> property specifies the color of the border on the 
left-edge of the area.</p>
<p>The <b>border-right-color</b> property specifies the color of the border on the 
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>color</i></td>
    <td>Any valid color specification</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_border_color.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_border_color.asp#top" target="_top">TOP</a> |
		<a href="prop_border_color.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
