...
<title>XSL-FO border width Property</title>
<style>a.menu_prop_border_width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">border width Properties</span> Property</h1>
...
<p>The <b>border-before-width</b> property specifies the width of the border on the 
before-edge.</p>
<p>The <b>border-after-width</b> property specifies the width of the border on the 
after-edge.</p>
<p>The <b>border-top-width</b> property specifies the width of the border on the 
top-edge.</p>
<p>The <b>border-bottom-width</b> property specifies the width of the border on the 
bottom-edge.</p>
<p>The <b>border-start-width</b> property specifies the width of the border on the 
start-edge.</p>
<p>The <b>border-end-width</b> property specifies the width of the border on the 
end-edge.</p>
<p>The <b>border-left-width</b> property specifies the width of the border on the 
left-edge.</p>
<p>The <b>border-right-width</b> property specifies the width of the border on the 
right-edge.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_border_width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_border_width.asp#top" target="_top">TOP</a> |
		<a href="prop_border_width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
