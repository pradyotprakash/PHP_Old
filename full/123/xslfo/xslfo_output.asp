...
<title>XSL-FO Output</title>
<style>a.menu_xslfo_output{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">Output</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xslfo_areas.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xslfo_flow.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XSL-FO defines output inside &lt;fo:flow&gt; elements.</p>
<hr>

<h2>XSL-FO Page, Flow, and Block</h2>
<p>&quot;Blocks&quot; of content &quot;Flows&quot; into &quot;Pages&quot; and then to the output media.</p>
<p>XSL-FO output is normally nested inside &lt;fo:block&gt; elements, 
nested inside &lt;fo:flow&gt; elements, nested inside &lt;fo:page-sequence&gt; elements:</p>
...
<p>It is time to look at a real XSL-FO example:</p>
...
<p>The output from this code would be something like this:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xslfo_output.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xslfo_output.asp#top" target="_top">TOP</a> |
		<a href="xslfo_output.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
