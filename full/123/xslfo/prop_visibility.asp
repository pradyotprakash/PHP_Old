...
<title>XSL-FO visibility Property</title>
<style>a.menu_prop_visibility{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">visibility</span> Property</h1>
...
<p>The visibility property specifies whether the box generated are visible or 
not.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>visible</td>
    <td>Default. The box is visible</td>
  </tr>
  <tr>
    <td>hidden</td>
    <td>The box is invisible, but still affects layout</td>
  </tr>
  <tr>
    <td>collapse</td>
    <td>When used in table elements, this value removes a row or 
	column, but it does not affect the table layout. The space taken up by the 
	row or column will be available for other content. If this value is used on 
	other elements, it renders as &quot;hidden&quot;</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_visibility.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_visibility.asp#top" target="_top">TOP</a> |
		<a href="prop_visibility.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
