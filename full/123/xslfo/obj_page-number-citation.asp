...
<title>XSL-FO page-number-citation Object</title>
<style>a.menu_obj_page-number-citation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">page-number-citation</span> Object</h1>
...
<p>The &lt;fo:page-number-citation&gt; object references the page-number for the 
page that contains the first normal area returned by the cited object.</p>
<p>The cited page-number is the number of the page containing, as a descendant, 
the first normal area returned with an id matching the ref-id of the &lt;fo:page-number-citation&gt;.</p>
<p>This object can be used to provide the page-numbers in the table of contents, 
cross-references, and indexes.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_page-number-citation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_page-number-citation.asp#top" target="_top">TOP</a> |
		<a href="obj_page-number-citation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
