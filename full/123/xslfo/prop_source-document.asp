...
<title>XSL-FO source-document Property</title>
<style>a.menu_prop_source-document{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">source-document</span> Property</h1>
...
<p>The source-document property provides a pointer back to the original XML document used to 
create the XSL-FO tree.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Specifies a URI to the source document. This URI is useful for 
    alternate renderers 
when the structure of the XSL-FO tree is inappropriate for that renderer</td>
  </tr>
  <tr>
    <td>none</td>
    <td>The source document is unspecified</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_source-document.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_source-document.asp#top" target="_top">TOP</a> |
		<a href="prop_source-document.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
