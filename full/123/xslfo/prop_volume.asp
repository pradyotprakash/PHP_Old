...
<title>XSL-FO volume Property</title>
<style>a.menu_prop_volume{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">volume</span> Property</h1>
...
<p>The volume property is used only in <b>Aural Stylesheets</b>.</p>
...
<p>The volume property specifies the volume of the speaking voice. User agents 
should allow the volume to be changed by the listener.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>number</i></td>
    <td>A number between 0 and 100. 0 represents the lowest 
	possible volume and 100 represents the maximum volume</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>A % calculated relative to the inherited value</td>
  </tr>
  <tr>
    <td>silent</td>
    <td>No sound at all. Note: silent is not the same as 0</td>
  </tr>
  <tr>
    <td>x-soft</td>
    <td>Same as 0</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_volume.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_volume.asp#top" target="_top">TOP</a> |
		<a href="prop_volume.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
