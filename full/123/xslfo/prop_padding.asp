...
<title>XSL-FO padding Property</title>
<style>a.menu_prop_padding{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">padding Properties</span> Property</h1>
...
<p>The <b>padding-start</b> property specifies the padding on the 
start-edge of the area.</p>

<p>The <b>padding-end</b> property specifies the padding on the 
end-edge of the area.</p>
<p>The <b>padding-before</b> property specifies the padding on the 
before-edge of the area.</p>
<p>The <b>padding-after</b> property specifies the padding on the 
after-edge of the area.</p>

<p>The <b>padding-top</b> property specifies the padding on the 
top-edge of the area.</p>

<p>The <b>padding-bottom</b> property specifies the padding on the 
bottom-edge of the area.</p>

<p>The <b>padding-left</b> property specifies the padding on the 
left-edge of the area.</p>

<p>The <b>padding-right</b> property specifies the padding on the 
right-edge of the area.</p>
<hr>

<h2>Details</h2>
<ul>
  <li>Inherited: no</li>
  <li>Percentages: refer to width of containing block</li>
  <li>Media: visual</li>
</ul>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>The browser sets the padding</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Default 0 pt. Specifies a fixed width</td>
  </tr>
  <tr>
    <td><i>percentage</i></td>
    <td>Specifies a width in %. The % is calculated with respect to 
	the width of the box's containing block</td>
  </tr>
  <tr>
    <td><i>length-conditional</i></td>
    <td>A compound value that specifies the width and any 
	conditionality of the padding</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_padding.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_padding.asp#top" target="_top">TOP</a> |
		<a href="prop_padding.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
