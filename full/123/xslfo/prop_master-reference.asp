...
<title>XSL-FO master-reference Property</title>
<style>a.menu_prop_master-reference{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">master-reference</span> Property</h1>
...
<p>The master-reference property defines a reference to a master.</p>
<p>For the &lt;fo:page-sequence&gt; object this property defines a reference to 
the &lt;fo:simple-page-master&gt; or a &lt;fo:page-sequence-master&gt;.</p>
<p>For the &lt;fo:single-page-master-reference&gt; object this property specifies the name of the 
page-master (&lt;fo:simple-page-master&gt;) to be used to create a single page.</p>
<p>For the &lt;fo:repeatable-page-master-reference&gt; object this property specifies the name of 
the page-master (&lt;fo:simple-page-master&gt;) to be used in repetition until the content is exhausted or the 
maximum-repeats limit is reached.</p>
<p>For the &lt;fo:conditional-page-master-reference&gt; object this property specifies the name 
of the page-master (&lt;fo:simple-page-master&gt;) to be used whenever this alternative is chosen.</p>
<p>If the name is empty or if a name-conflict occurs, an error shall be 
reported. However, the processor may continue processing.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>name</i></td>
    <td>
	<p>Default: an empty name. The name does not have to be unique, but must 
	refer to a master-name that exists in the document</p></td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_master-reference.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_master-reference.asp#top" target="_top">TOP</a> |
		<a href="prop_master-reference.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
