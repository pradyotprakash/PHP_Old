...
<title>XSL-FO table-row Object</title>
<style>a.menu_obj_table-row{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">table-row</span> Object</h1>
...
<p>The &lt;fo:table-row&gt; object defines a table row.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td height="28">border-before-precedence</td>
    <td height="28">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_table-row.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_table-row.asp#top" target="_top">TOP</a> |
		<a href="obj_table-row.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
