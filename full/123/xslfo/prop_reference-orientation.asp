...
<title>XSL-FO reference-orientation Property</title>
<style>a.menu_prop_reference-orientation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">reference-orientation</span> Property</h1>
...
<p>The reference-orientation property defines the direction for top for the 
content-rectangle of the reference-area.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>0</td>
    <td>Default. The orientation of this area has the same 
	orientation as the containing reference-area</td>
  </tr>
  <tr>
    <td>90</td>
    <td>The orientation is rotated 90 degrees from the orientation 
	of the containing reference-area</td>
  </tr>
  <tr>
    <td>180</td>
    <td>The orientation is rotated 180 degrees from the orientation 
	of the containing reference-area</td>
  </tr>
  <tr>
    <td>270</td>
    <td>The orientation is rotated 270 degrees from the orientation 
	of the containing reference-area</td>
  </tr>
  <tr>
    <td>-90</td>
    <td>Same as specifying 270</td>
  </tr>
  <tr>
    <td>-180</td>
    <td>Same as specifying 180</td>
  </tr>
  <tr>
    <td>-270</td>
    <td>Same as specifying 90</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_reference-orientation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_reference-orientation.asp#top" target="_top">TOP</a> |
		<a href="prop_reference-orientation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
