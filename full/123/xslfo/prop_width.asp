...
<title>XSL-FO width Property</title>
<style>a.menu_prop_width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">width</span> Property</h1>
...
<p>The width property specifies the content width of a box.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. The browser calculates the actual width</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Specifies a fixed width in px, cm, etc. Negative values are not allowed</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Defines the width in % of the parent element's width</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_width.asp#top" target="_top">TOP</a> |
		<a href="prop_width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
