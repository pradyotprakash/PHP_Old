...
<title>XSL-FO play-during Property</title>
<style>a.menu_prop_play-during{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">play-during</span> Property</h1>
...
<p>The play-during property is used only in <b>Aural Stylesheets</b>.</p>
...
<p>The play-during property specifies a background-sound to be played while the 
content of an element is spoken.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>URI</i></td>
    <td>An URI to an audio file</td>
  </tr>
  <tr>
    <td>mix</td>
    <td>The sound from the parent element's play-during 
	property continues to play + the sound specified in <i>URI</i> is mixed 
	with it.<p>Example: play-during: url(&quot;sea.wav&quot;) mix</p>
	</td>
  </tr>
  <tr>
    <td>repeat</td>
    <td>The sound will be repeated if it stops before the entire content 
	is spoken.<p>Example: play-during: url(&quot;sea.wav&quot;) repeat</p></td>
  </tr>
  <tr>
    <td>auto</td>
    <td>Default. The sound of the parent element continues to play</td>
  </tr>
  <tr>
    <td>none</td>
    <td>Silence</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_play-during.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_play-during.asp#top" target="_top">TOP</a> |
		<a href="prop_play-during.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
