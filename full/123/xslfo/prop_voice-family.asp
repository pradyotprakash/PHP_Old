...
<title>XSL-FO voice-family Property</title>
<style>a.menu_prop_voice-family{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">voice-family</span> Property</h1>
...
<p>The voice-family property is used only in <b>Aural Stylesheets</b>.</p>
...
<p>The voice-family property specifies a comma-separated list of voice-family 
names for the speaking voice.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>generic-voice</i></td>
    <td>Specifies a voice-family. Possible values are:<ul>
		<li>male</li>
		<li>female</li>
		<li>child</li>
	</ul>
  ...
  <tr>
    <td><i>specific-voice</i></td>
    <td>A specific instance (e.g. comedian, carlos)</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_voice-family.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_voice-family.asp#top" target="_top">TOP</a> |
		<a href="prop_voice-family.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
