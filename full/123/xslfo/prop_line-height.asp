...
<title>XSL-FO line-height Property</title>
<style>a.menu_prop_line-height{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">line-height</span> Property</h1>
...
<p><b>CSS2 definition:</b></p>

<p>If the line-height property is set on a block-level element, it specifies the minimal height of each 
generated inline box.</p>

<p>If the line-height property is set on an inline-level element, it specifies 
the exact height of each box generated by the element.</p>

<p><b>XSL modifications</b>:</p>

<p>In XSL the line-height property is used to determine the half-leading trait. </p>
...
<ul>
  <li>Inherited: yes </li>
  <li>Percentages: refer to the font size of the element itself </li>
  <li>Media: visual </li>
</ul>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>normal</td>
    <td>Default. Sets the line-height to a  reasonable value 
    based on the font size (between 1.0 and 1.2)</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Specifies the height of the box. Negative values are 
    not allowed</td>
  </tr>
  <tr>
    <td><i>number</i></td>
    <td>Sets the line-height to a number that will be multiplied 
    with the element's font size. Negative values are not allowed</td>
  </tr>
  <tr>
    <td><i>percentage</i></td>
    <td>Sets the line-height to a percentage 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_line-height.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_line-height.asp#top" target="_top">TOP</a> |
		<a href="prop_line-height.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
