...
<title>XSL-FO media-usage Property</title>
<style>a.menu_prop_media-usage{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">media-usage</span> Property</h1>
...
<p>The media-usage property controls how the display medium is used to present 
the page.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. The user agent determines which value of 
    &quot;media-usage&quot; is to be used</td>
  </tr>
  <tr>
    <td>paginate</td>
    <td>A sequence of pages is generated from the &lt;fo:page-sequence&gt; 
    objects that are children of the &lt;fo:root&gt;</td>
  </tr>
  <tr>
    <td>bounded-in-one-dimension</td>
    <td>Only one page is generated per &lt;fo:page-sequence&gt;. One 
...
<p>Only one page is generated per &lt;fo:page-sequence&gt;. Neither &quot;page-height&quot; nor 
&quot;page-width&quot; may be specified on any page master that is used</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_media-usage.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_media-usage.asp#top" target="_top">TOP</a> |
		<a href="prop_media-usage.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
