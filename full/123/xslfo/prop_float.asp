...
<title>XSL-FO float Property</title>
<style>a.menu_prop_float{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">float</span> Property</h1>
...
<p>The float property specifies whether a box should float to the left, right, 
or not at all.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>before</td>
    <td>Specifies that the box shall be descendant of a 
	before-float-reference-area generated by a sub-region of a region-body</td>
  </tr>
  <tr>
    <td>start</td>
    <td>Specifies that the box shall float toward the start-edge of 
	the reference area</td>
  </tr>
  <tr>
    <td>end</td>
    <td>Specifies that the box shall float toward the end-edge of 
	the reference area</td>
  </tr>
  <tr>
    <td>left</td>
    <td>Specifies that the box shall float to the left. Content 
	flows on the right side of the box. Interpreted as float='start'</td>
  </tr>
  <tr>
    <td>right</td>
    <td>Specifies that the box shall float to the right. Content 
	flows on the left side of the box. Interpreted as float='end'</td>
  </tr>
  <tr>
    <td>none</td>
    <td>Default. The box is not floated</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_float.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_float.asp#top" target="_top">TOP</a> |
		<a href="prop_float.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
