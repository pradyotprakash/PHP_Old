...
<title>XSL-FO repeatable-page-master-alternatives Object</title>
<style>a.menu_obj_repeatable-page-master-alternatives{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">repeatable-page-master-alternatives</span> Object</h1>
...
<p>The &lt;fo:repeatable-page-master-alternatives&gt; object specifies repetition 
of a set of simple-page-masters.</p>
<p>The children of this object are fo:conditional-page-master-references (called 
alternatives).</p>
<p>Which alternative should be used depends on the evaluation of the condition 
(the conditions allow different page-masters to be used for the first page, for 
odd and even pages, and for blank pages).</p>
<p>The conditions are tested in order, and the last alternative should reference 
the page-master to be used for all pages without a special layout.</p>
...
&nbsp;&nbsp;&lt;!--<br>
&nbsp;&nbsp;&nbsp;&nbsp;Contents:(conditional-page-master-reference+)<br>
&nbsp;&nbsp;--&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_repeatable-page-master-alternatives.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_repeatable-page-master-alternatives.asp#top" target="_top">TOP</a> |
		<a href="obj_repeatable-page-master-alternatives.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
