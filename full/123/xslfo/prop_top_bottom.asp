...
<title>XSL-FO top and bottom Property</title>
<style>a.menu_prop_top_bottom{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">top and bottom</span> Property</h1>
...
<p>The <b>top</b> property specifies how far the box's top position is below the 
top edge of the box's containing block.</p>
<p>The <b>botttom</b> property specifies how far the box's bottom position is 
above the bottom edge of the box's containing block.</p>
<p><b>Note:</b> If the height property of the object is &quot;auto&quot; and both the top 
and bottom properties have a value other than &quot;auto&quot;, the height is overridden! </p>
...
<ul>
  <li>Inherited: no</li>
  <li>Percentages: refer to height of containing block</li>
  <li>Media: visual</li>
</ul>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. The browser calculates the top/bottom position</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Sets the top/bottom position in px, cm, etc. from the 
	top/bottom edge of the containing block</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>&nbsp;</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_top_bottom.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_top_bottom.asp#top" target="_top">TOP</a> |
		<a href="prop_top_bottom.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
