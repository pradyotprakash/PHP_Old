...
<title>XSL-FO conditional-page-master-reference Object</title>
<style>a.menu_obj_conditional-page-master-reference{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">conditional-page-master-reference</span> Object</h1>
...
<p>The &lt;fo:conditional-page-master-reference&gt; object specifies a 
page-master to be used when the conditions defined are true.</p>
<p>This allows different page-masters to be used for different pages (e.g. odd 
and even pages, first page, blank pages).</p>
<p>Three properties, page-position, odd-or-even, blank-or-not-blank, specifies 
the conditions. All three conditions must be true for the 
&lt;fo:conditional-page-master-reference&gt; to be true.</p>
<ul>
	<li>page-position is true if the generated page has the specified position 
	(first, last, rest, any)</li>
	<li>odd-or-even is true if the value is &quot;any&quot; or if the value (odd, even) 
	matches the page number</li>
	<li>blank-or-not-blank is true, if the value is &quot;not-blank&quot; and the page has 
	areas generated by descendants of &lt;fo:flow&gt;; if the value is &quot;blank&quot; and the 
	page has no areas from &lt;fo:flow&gt;; or if the value is &quot;any&quot;</li>
</ul>
...
&lt;fo:conditional-page-master-reference&gt;<br>
&nbsp;&nbsp;&lt;!--<br>
&nbsp;&nbsp;&nbsp;&nbsp;Contents:EMPTY<br>
&nbsp;&nbsp;--&gt;<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_master-reference.asp">master-reference</a></td>
    </tr>
  <tr>
    <td>odd-or-even</td>
    </tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_conditional-page-master-reference.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_conditional-page-master-reference.asp#top" target="_top">TOP</a> |
		<a href="obj_conditional-page-master-reference.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
