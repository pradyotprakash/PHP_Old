...
<title>XSL-FO background-color Property</title>
<style>a.menu_prop_background-color{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">background-color</span> Property</h1>
...
<p>The background-color property sets the background color of an object.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>transparent</td>
    <td>Default. The background color is transparent (means that 
	the underlying color will shine through)</td>
  </tr>
  <tr>
    <td><i>color</i></td>
    <td>The color value can be a color name (red), a rgb value 
	(rgb(255,0,0)), or a hex number (#ff0000)</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_background-color.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_background-color.asp#top" target="_top">TOP</a> |
		<a href="prop_background-color.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
