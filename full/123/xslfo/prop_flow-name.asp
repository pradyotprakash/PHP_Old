...
<title>XSL-FO flow-name Property</title>
<style>a.menu_prop_flow-name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">flow-name</span> Property</h1>
...
<p>The flow-name property defines where the content of the &lt;fo:flow&gt; or &lt;fo:static-content&gt; object will go.</p>
<p>The flow-name property assigns the flow's or static-content's content to a specific region in the 
layout. This is done by specifying the name of the target region as the 
flow-name. (e.g. flow-name=&quot;xsl-region-body&quot;).</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>name</i></td>
    <td>Default is an empty name. Defines the name of the flow.<p>
	Flow-names reserved in XSL:</p>
	<ul>
		<li>xsl-region-body</li>
		<li>xsl-region-before</li>
		<li>xsl-region-after</li>
		<li>xsl-region-start</li>
		<li>xsl-region-end</li>
		<li>xsl-before-float-separator</li>
		<li>xsl-footnote-separator</li>
	</ul>
	</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_flow-name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_flow-name.asp#top" target="_top">TOP</a> |
		<a href="prop_flow-name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
