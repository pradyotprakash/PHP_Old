...
<title>XSL-FO speak Property</title>
<style>a.menu_prop_speak{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">speak</span> Property</h1>
...
<p>The speak property is used only in <b>Aural Stylesheets</b>.</p>
...
<p>The speak property specifies whether or not the text will be rendered 
aurally.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>normal</td>
    <td>Default. Uses language-dependent pronunciation rules for 
	rendering an element and its children</td>
  </tr>
  <tr>
    <td>none</td>
    <td>Suppresses aural rendering (the element requires no time to 
	render)</td>
  </tr>
  <tr>
    <td>spell-out</td>
    <td>Spells the text letter by letter</td>
  </tr>
  </table>
<p>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_speak.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_speak.asp#top" target="_top">TOP</a> |
		<a href="prop_speak.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
