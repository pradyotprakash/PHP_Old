...
<title>XSL-FO multi-switch Object</title>
<style>a.menu_obj_multi-switch{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">multi-switch</span> Object</h1>
...
<p>The &lt;fo:multi-switch&gt; object holds one or more &lt;fo:multi-case&gt; objects 
and controls the switching between them (activated by &lt;fo:multi-toggle&gt;)</p>
<p>This object can be used for interactive tasks such as table-of-content views 
and next/previous views.</p>
<p>The children of this object are one or more &lt;fo:multi-case&gt; objects. However, 
...
switching of the &lt;fo:multi-switch&gt;.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_multi-switch.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_multi-switch.asp#top" target="_top">TOP</a> |
		<a href="obj_multi-switch.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
