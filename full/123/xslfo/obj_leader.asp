...
<title>XSL-FO leader Object</title>
<style>a.menu_obj_leader{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">leader</span> Object</h1>
...
<p>The &lt;fo:leader&gt; object can be used used to:</p>
<ul>
	<li>generate &quot;.&quot; to separate titles from page numbers in table of contents</li>
	<li>create input fields in forms</li>
	<li>create horizontal rules</li>
</ul>
<p>If the leader's length is too long to fit in the area, the leader will begin 
a new line.</p>
<p>The children of the &lt;fo:leader&gt; object are ignored unless the leader-pattern 
property is &quot;use-content&quot;. If the &lt;fo:leader&gt; has no children and the 
leader-pattern property is &quot;use-content&quot;, the leader is filled with blank space.</p>
<p>If the leader should fill all space on a line, the max length of the leader 
should be at least as large as the width of the column.</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;inline|page-number|page-number-citation|<br>
&nbsp;&nbsp;&nbsp;&nbsp;basic-link|multi-toggle)*<br>
&nbsp;&nbsp;--&gt;<br>
&lt;/fo:leader&gt;
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>
    <a href="prop_letter-spacing.asp">letter-spacing</a></td>
    </tr>
  <tr>
  ...
  <tr>
    <td>
    <a href="prop_top_bottom.asp">bottom</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_leader.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_leader.asp#top" target="_top">TOP</a> |
		<a href="obj_leader.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
