...
<title>XSL-FO elevation Property</title>
<style>a.menu_prop_elevation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">elevation</span> Property</h1>
...
<p>The elevation property is used only in <b>Aural Stylesheets</b>.</p>
...
<p>The elevation property specifies if the sound should come from above, below 
or in level with the listener.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>angle</i></td>
    <td>A fixed value within the range -90deg to 90deg.<ul>
		<li>0deg means in level with the listener</li>
		<li>90deg means above</li>
		<li>-90deg means below</li>
	</ul>
	</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>higher</td>
    <td>Current elevation + 10deg</td>
  </tr>
  <tr>
    <td>lower</td>
    <td>Currents elevation - 10deg</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_elevation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_elevation.asp#top" target="_top">TOP</a> |
		<a href="prop_elevation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
