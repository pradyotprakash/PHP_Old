...
<title>XSL-FO end-indent Property</title>
<style>a.menu_prop_end-indent{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">end-indent</span> Property</h1>
...
<p>The end-indent property specifies the distance from the end-edge of the 
content-rectangle of the block-area to the end-edge of the content-rectangle of 
the containing reference-area.</p>
<p><b>Note:</b> If this property has a negative value, it indicates an outdent.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Default is 0pt. The end-indent specified as a fixed 
	length</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>The end-indent specified as a % of the 
	inline-progression-dimension of the containing reference-area</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_end-indent.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_end-indent.asp#top" target="_top">TOP</a> |
		<a href="prop_end-indent.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
