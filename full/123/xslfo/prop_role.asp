...
<title>XSL-FO role Property</title>
<style>a.menu_prop_role{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">role</span> Property</h1>
...
<p>The role property defines a hint for alternate renderers (aural readers, 
etc.) as to the role of the XML element that was used to construct 
this XSL-FO object. This information can be used to use alternate renderings when 
the normal rendering of an XSL-FO object is not appropriate.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>uri-specification</i></td>
    <td>Defines a URI-specification that indicates an RDF resource (that 
    is, an XML object that is valid with respect to the RDF grammar)</td>
  </tr>
  <tr>
    <td><i>string</i></td>
    <td>Specifies a semantic identifier 
    to be used in rendering this XSL-FO object</td>
  </tr>
  <tr>
    <td>none</td>
    <td>Indicates that no semantic tag is cited by this XSL-FO object</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_role.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_role.asp#top" target="_top">TOP</a> |
		<a href="prop_role.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
