...
<title>XSL-FO pitch Property</title>
<style>a.menu_prop_pitch{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">pitch</span> Property</h1>
...
<p>The pitch property is used only in <b>Aural Stylesheets</b>.</p>
...
<p>The pitch property specifies the average pitch (a frequency) of the speaking 
voice.</p>
<p>The average pitch depends on the voice family. The average pitch for a male 
voice is 120Hz, and for a female voice, it's 210Hz.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>frequency</i></td>
    <td>The average pitch of the speaking voice is specified in 
	hertz</td>
  </tr>
  <tr>
    <td>x-low</td>
    <td>Defines an extra low frequency (the value depend on the 
	voice family)</td>
  </tr>
  <tr>
    <td>low</td>
    <td>Defines a low frequency (the value depend on the voice 
	family)</td>
  </tr>
  <tr>
    <td>medium</td>
    <td>Default. Defines a medium frequency (the value depend on 
	the voice family)</td>
  </tr>
  <tr>
    <td>high</td>
    <td>Defines a high frequency (the value depend on the voice 
	family)</td>
  </tr>
  <tr>
    <td>x-high</td>
    <td>Defines an extra high frequency (the value depend on the 
	voice family)</td>
  </tr>
  </table>
<p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_pitch.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_pitch.asp#top" target="_top">TOP</a> |
		<a href="prop_pitch.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
