...
<title>XSL-FO azimuth Property</title>
<style>a.menu_prop_azimuth{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">azimuth</span> Property</h1>
...
<p>The azimuth property is used only in <b>Aural Stylesheets</b>.</p>
<p>The aural rendering of a document combines sounds and voices to go through 
the content of a document. Aural presentation occurs often by converting the 
document to plain text and then feeding this to a screen reader.</p>
<p>Situations and markets for listening to information could be:</p>
<ul>
	<li>for blind people</li>
	<li>in the car</li>
	<li>help users learning to read </li>
</ul>
<p>Azimuth and elevation are important properties for aural presentation. These 
properties are used to keep several voices apart. In real life, all the people 
do not stand in the same spot in a room. </p>
<p>The azimuth property specifies what side the sound should come from.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>angle</i></td>
    <td>A fixed value within the range -360deg to 360deg.<ul>
		<li>0deg means ahead in the center</li>
		<li>90deg is to the right</li>
		<li>180deg is behind</li>
		<li>270deg (or -90deg) is to the left</li>
	</ul>
	</td>
  </tr>
  <tr>
    <td>left-side</td>
    <td>270deg and behind 270deg</td>
  </tr>
  <tr>
    <td>far-left</td>
    <td>300deg and behind 240deg</td>
  </tr>
  <tr>
    <td>left</td>
    <td>320deg and behind 220deg</td>
  </tr>
  <tr>
    <td>center-left</td>
    <td>340deg and behind 200deg</td>
  </tr>
  <tr>
    <td>center</td>
    <td>Default. 0deg and behind 180deg</td>
  </tr>
  <tr>
    <td>center-right</td>
    <td>20deg and behind 160deg</td>
  </tr>
  <tr>
    <td>right</td>
    <td>40deg and behind 140deg</td>
  </tr>
  <tr>
    <td>far-right</td>
    <td>60deg and behind 120deg</td>
  </tr>
  <tr>
    <td>right-side</td>
    <td>90deg and behind 90deg</td>
  </tr>
  <tr>
    <td>leftwards</td>
    <td>The sound moves to the left</td>
  </tr>
  <tr>
    <td>rightwards</td>
    <td>The sound moves to the right</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_azimuth.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_azimuth.asp#top" target="_top">TOP</a> |
		<a href="prop_azimuth.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
