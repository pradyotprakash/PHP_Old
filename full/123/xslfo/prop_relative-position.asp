...
<title>XSL-FO relative-position Property</title>
<style>a.menu_prop_relative-position{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">relative-position</span> Property</h1>
...
<p>The relative-position property is used to place the area in a static or 
relative position.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>static</td>
    <td>Default. The area is placed in a normal position (according 
	to the normal flow)</td>
  </tr>
  <tr>
    <td>relative</td>
    <td>Moves the area relative to its normal position</td>
  </tr>
  </table>
<p>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_relative-position.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_relative-position.asp#top" target="_top">TOP</a> |
		<a href="prop_relative-position.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
