...
<title>XSL-FO hyphenation-keep Property</title>
<style>a.menu_prop_hyphenation-keep{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">hyphenation-keep</span> Property</h1>
...
<p>The hyphenation-keep property specifies whether hyphenation can be performed 
on the last line in a given area.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. No restriction. The word may be hyphenated</td>
  </tr>
  <tr>
    <td>column</td>
    <td>Both parts of a hyphenated word shall lie within a single 
    column</td>
  </tr>
  <tr>
    <td>page</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_hyphenation-keep.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_hyphenation-keep.asp#top" target="_top">TOP</a> |
		<a href="prop_hyphenation-keep.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
