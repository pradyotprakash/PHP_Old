...
<title>XSL-FO left and right Property</title>
<style>a.menu_prop_left_right{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">left and right</span> Property</h1>
...
<p>The <b>left</b> property specifies how far the box's left edge is to the 
right of the left edge of the box's containing block.</p>
<p>The <b>right</b> property specifies how far the box's right edge is to the 
left of the right edge of the box's containing block.</p>
<p><b>Note:</b> If the width property of the object is &quot;auto&quot; and both the left 
and right properties have a value other than &quot;auto&quot;, the width is overridden!</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. The browser calculates the left/right position</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Sets the left/right position in px, cm, etc. from the 
	left/right edge of the containing block</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>&nbsp;</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_left_right.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_left_right.asp#top" target="_top">TOP</a> |
		<a href="prop_left_right.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
