...
<title>XSL-FO writing-mode Property</title>
<style>a.menu_prop_writing-mode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">writing-mode</span> Property</h1>
...
<p>For &lt;fo:simple-page-master&gt; the <b>writing-mode property</b> is used to 
specify the placement of the five regions on the master.</p>
<p>For &lt;fo:region-*&gt; the <b>writing-mode property</b> defines the 
column-progression within each region.</p>
<p>For &lt;fo:table&gt; the <b>writing-mode property</b> controls the layout of the 
rows and columns.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>lr-tb</td>
    <td>Default. Text are written left-to-right and top-to-bottom 
	(normal &quot;alphabetic&quot; text)</td>
  </tr>
  <tr>
    <td>rl-tb</td>
    <td>Text are written right-to-left and top-to-bottom (Arabic 
	and Hebrew text)</td>
  </tr>
  <tr>
    <td>tb-rl</td>
    <td>Text are written top-to-bottom and right-to-left (Chinese 
	and Japanese text)</td>
  </tr>
  <tr>
    <td>lr</td>
    <td>Same as lr-tb</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_writing-mode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_writing-mode.asp#top" target="_top">TOP</a> |
		<a href="prop_writing-mode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
