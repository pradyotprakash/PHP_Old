...
<title>XSL-FO pitch-range Property</title>
<style>a.menu_prop_pitch-range{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">pitch-range</span> Property</h1>
...
<p>The pitch-range property is used only in <b>Aural Stylesheets</b>.</p>
...
<p>The pitch-range property specifies the variation in the average pitch of the speaking 
voice.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>number</i></td>
    <td>Default is 50. Specifies a value between 0 and 100. 
	<ul>
		<li>0 = a flat, monotonic voice</li>
		<li>50 = normal voice</li>
		<li>Above 50 = an animated voice</li>
	</ul>
	</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_pitch-range.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_pitch-range.asp#top" target="_top">TOP</a> |
		<a href="prop_pitch-range.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
