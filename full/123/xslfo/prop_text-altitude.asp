...
<title>XSL-FO text-altitude Property</title>
<style>a.menu_prop_text-altitude{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">text-altitude</span> Property</h1>
...
<p>The text-altitude property specifies the &quot;height&quot; for the ascent 
above the dominant baseline.</p>
<hr>

<h2>Details</h2>
<ul>
  <li>Inherited: no</li>
  <li>Percentages: refer to the font's em-height</li>
  <li>Media: visual</li>
</ul>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>use-font-metrics</td>
    <td>Default. Uses a value for the  height of the font above 
    the baseline</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Replaces the  height value in the font with a specified 
    length</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_text-altitude.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_text-altitude.asp#top" target="_top">TOP</a> |
		<a href="prop_text-altitude.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
