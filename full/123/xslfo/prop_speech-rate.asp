...
<title>XSL-FO speech-rate Property</title>
<style>a.menu_prop_speech-rate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">speech-rate</span> Property</h1>
...
<p>The speech-rate property is used only in <b>Aural Stylesheets</b>.</p>
...
<p>The speech-rate property specifies how fast the text should be read - the 
speaking rate.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>number</i></td>
    <td>A number that specifies the speaking rate in words per 
	minute</td>
  </tr>
  <tr>
    <td>x-slow</td>
    <td>80 words per minute</td>
  </tr>
  <tr>
    <td>slow</td>
    <td>120 words per minute</td>
  </tr>
  <tr>
    <td>medium</td>
    <td>Default. 180-200 words per minute</td>
  </tr>
  <tr>
    <td>fast</td>
    <td>300 words per minute</td>
  </tr>
  <tr>
    <td>x-fast</td>
    <td>500 words per minute</td>
  </tr>
  <tr>
    <td>faster</td>
    <td>Current speech-rate + 40</td>
  </tr>
  <tr>
    <td>slower</td>
    <td>Current speech-rate - 40</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_speech-rate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_speech-rate.asp#top" target="_top">TOP</a> |
		<a href="prop_speech-rate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
