...
<title>XSL-FO height Property</title>
<style>a.menu_prop_height{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">height</span> Property</h1>
...
<p>The height property specifies the content height of a box.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. The browser calculates the actual height</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Specifies a fixed height in px, cm, etc. Negative values are not allowed</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Defines the height in % of the parent element's height</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_height.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_height.asp#top" target="_top">TOP</a> |
		<a href="prop_height.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
