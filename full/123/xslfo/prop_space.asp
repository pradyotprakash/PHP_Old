...
<title>XSL-FO space-before and space-after Property</title>
<style>a.menu_prop_space{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">space-before</span> and <span class="color_h1">space-after</span> Properties</h1>
...
<p>The <b>space-before</b> property specifies the value of the space-specifier 
for the space before the areas generated by this XSL-FO object.</p>

<p>The <b>space-after</b> property specifies the value of the space-specifier 
for the space after the areas generated by this XSL-FO object.</p>
<p>A space-specifier have the following components: minimum, optimum, maximum, 
conditionality, and precedence.</p>
<p>Minimum, optimum, and maximum are lengths that define a constraint on a 
distance, specifying that the distance should preferably be the optimum, in no 
case less than the minimum or more than the maximum.</p>
<p>The conditionality component specifies whether a space-specifier has effect 
at the beginning or end of an area. Possible values are retain and discard.</p>
<p>Precedence is either an integer or the special token force.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>space</i></td>
    <td>Specifies the minimum, optimum, and maximum values for the 
	space before or after areas generated by this XSL-FO object and the 
	conditionality and precedence of this space.<p>Default value is: 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_space.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_space.asp#top" target="_top">TOP</a> |
		<a href="prop_space.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
