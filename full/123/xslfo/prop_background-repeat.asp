...
<title>XSL-FO background-repeat Property</title>
<style>a.menu_prop_background-repeat{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">background-repeat</span> Property</h1>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>repeat</td>
    <td>The background image will be repeated vertically and 
	horizontally</td>
  </tr>
  <tr>
    <td>repeat-x</td>
    <td>The background image will be repeated horizontally</td>
  </tr>
  <tr>
    <td>repeat-y</td>
    <td>The background image will be repeated vertically</td>
  </tr>
  <tr>
    <td>no-repeat</td>
    <td>The background-image will be displayed only once</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_background-repeat.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_background-repeat.asp#top" target="_top">TOP</a> |
		<a href="prop_background-repeat.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
