...
<title>XSL-FO region-body Object</title>
<style>a.menu_obj_region-body{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">region-body</span> Object</h1>
...
<p>The &lt;fo:region-body&gt; object defines the body region of a page.</p>

<p>XSL-FO uses the following elements to define the regions of a page:</p>

<ul type="square">
  <li>&lt;fo:region-body&gt; defines the body region</li>
  <li>&lt;fo:region-before&gt; defines the top region (header)</li>
  <li>&lt;fo:region-after&gt; defines the bottom region (footer)</li>
  <li>&lt;fo:region-start&gt; defines the left region (left sidebar)</li>
  <li>&lt;fo:region-end&gt; defines the right region (right sidebar)</li>
</ul>

<p><b>Note:</b> region-before, region-after, region-start, and region-end is a 
part of the region-body. To avoid text in the region-body to overwrite text in 
the other regions, the region-body must have margins at least the size of these 
regions. </p>

<p><b>Tip:</b> To provide multiple columns in the region-body set the 
column-count property to greater than 1!</p>
<p><b>Note:</b> If the overflow property has the value of &quot;scroll&quot;, you cannot 
specify a column-count other than 1!</p>
<p><b>Note:</b> According to version 1.0 of the XSL-FO Recommendation, the 
padding and border-width properties must be 0. </p>
...
&lt;fo:simple-page-master master-name=&quot;intro&quot;&gt;<br>
&nbsp;&nbsp;&lt;fo:region-body margin=&quot;5in&quot; /&gt;<br>
&lt;/fo:simple-page-master&gt;<br>
<br>
&lt;fo:simple-page-master master-name=&quot;left&quot;&gt;<br>
&nbsp;&nbsp;&lt;fo:region-body margin-left=&quot;2in&quot; margin-right=&quot;3in&quot; /&gt;<br>
&lt;/fo:simple-page-master&gt;<br>
<br>
&lt;fo:simple-page-master master-name=&quot;right&quot;&gt;<br>
&nbsp;&nbsp;&lt;fo:region-body margin-left=&quot;3in&quot; margin-right=&quot;2in&quot; /&gt;<br>
...
&lt;fo:simple-page-master master-name=&quot;A4&quot;<br>
 page-width=&quot;297mm&quot; page-height=&quot;210mm&quot;<br>
 margin-top=&quot;1cm&quot;   margin-bottom=&quot;1cm&quot;<br>
 margin-left=&quot;1cm&quot;  margin-right=&quot;1cm&quot;&gt;<br>
&nbsp;&nbsp;&lt;fo:region-body   margin=&quot;3cm&quot;/&gt;<br>
&nbsp;&nbsp;&lt;fo:region-before extent=&quot;2cm&quot;/&gt;<br>
&nbsp;&nbsp;&lt;fo:region-after  extent=&quot;2cm&quot;/&gt;<br>
&nbsp;&nbsp;&lt;fo:region-start  extent=&quot;2cm&quot;/&gt;<br>
&nbsp;&nbsp;&lt;fo:region-end    extent=&quot;2cm&quot;/&gt;<br>
&lt;/fo:simple-page-master&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_region-body.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_region-body.asp#top" target="_top">TOP</a> |
		<a href="obj_region-body.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
