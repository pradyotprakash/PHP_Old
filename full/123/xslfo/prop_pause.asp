...
<title>XSL-FO pause-before and pause-after Property</title>
<style>a.menu_prop_pause{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">pause-before and pause-after Properties</h1>
...
<p>The pause-before and pause-after properties are used only in <b>Aural Stylesheets</b>.</p>
...
<p>The pause-before property specifies a pause to be inserted before speaking 
the content of a specific element.</p>
<p>The pause-after property specifies a pause to be inserted after speaking a 
content of a specific element.</p>
<hr>

<h2>Details</h2>
<ul>
  <li>Inherited: no</li>
  <li>Percentages: yes</li>
  <li>Media: aural</li>
</ul>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>time</i></td>
    <td>Specifies the pause in seconds and milliseconds</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Specifies the pause in % of the speech-rate 
	property (e.g. if the speech-rate is 120 words/minute and a 
	word takes 500ms to read, then a pause-before of 100% means a 
	pause of 500ms - a half second)&nbsp; </td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_pause.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_pause.asp#top" target="_top">TOP</a> |
		<a href="prop_pause.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
