...
<title>XSL-FO linefeed-treatment Property</title>
<style>a.menu_prop_linefeed-treatment{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">linefeed-treatment</span> Property</h1>
...
<p>The linefeed-treatment property specifies the treatment of linefeeds.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>ignore</td>
    <td>Any character with Unicode U+000A (linefeed) 
    will be discarded</td>
  </tr>
  <tr>
    <td>preserve</td>
    <td>Specifies no special action</td>
  </tr>
  <tr>
    <td>treat-as-space</td>
    <td>Default. Any character with Unicode U+000A 
    (linefeed) shall be converted into Unicode U+0020 (space)</td>
  </tr>
  <tr>
    <td>treat-as-zero-width-space</td>
    <td>Any character with Unicode U+000A (linefeed) 
    shall be converted into Unicode U+200B (zero-width space)</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_linefeed-treatment.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_linefeed-treatment.asp#top" target="_top">TOP</a> |
		<a href="prop_linefeed-treatment.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
