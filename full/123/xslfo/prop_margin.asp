...
<title>XSL-FO margin-top, margin-bottom, margin-left, margin-right Property</title>
<style>a.menu_prop_margin{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">margin</span> Properties</h1>
...
<p>The <b>margin-top</b> property specifies the top margin of a box.</p>
<p>The <b>margin-bottom</b> property specifies the bottom margin of a box.</p>
<p>The <b>margin-left</b> property specifies the left margin of a box.</p>
<p>The <b>margin-right</b> property specifies the right margin of a box.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>The browser sets the margins</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Default 0 pt. Specifies a fixed width.<p><b>Note:</b> Negative values are allowed, but there may 
be browser-specific limits!</p></td>
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_margin.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_margin.asp#top" target="_top">TOP</a> |
		<a href="prop_margin.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
