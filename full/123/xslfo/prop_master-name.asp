...
<title>XSL-FO master-name Property</title>
<style>a.menu_prop_master-name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">master-name</span> Property</h1>
...
<p>The master-name property identifies the name of the master.</p>
<p>For the &lt;fo:simple-page-master&gt; object this property identifies the name of 
the master. This name is referenced as the value of properties on the following 
objects: &lt;fo:single-page-master-reference&gt;, &lt;fo:repeatable-page-master-reference&gt;, 
and &lt;fo:conditional-page-master-reference&gt; to request the use of this master 
when creating a page instance. It may also be used on &lt;fo:page-sequence&gt; to 
specify the use of this master when creating page instances.</p>
<p>For the &lt;fo:page-sequence-master&gt; object this property identifies the name of 
the master. This name is referenced as the value of properties on the &lt;fo:page-sequence&gt; 
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>name</i></td>
    <td>
	<p>Default: an empty name. A name that identifies a master. The name must be unique 
	across all page-masters and page-sequence-masters</p></td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_master-name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_master-name.asp#top" target="_top">TOP</a> |
		<a href="prop_master-name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
