...
<title>XSL-FO letter-spacing Property</title>
<style>a.menu_prop_letter-spacing{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">letter-spacing</span> Property</h1>
...
<p>The letter-spacing property defines the space between characters.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>normal</td>
    <td>Default is 0pt. The letter-spacing is normal</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Indicates inter-character space in addition to the default 
	space. Negative values are allowed</td>
  </tr>
  <tr>
    <td><i>space</i></td>
    <td>The user may specify a range of adjustments in addition to 
	the default space</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_letter-spacing.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_letter-spacing.asp#top" target="_top">TOP</a> |
		<a href="prop_letter-spacing.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
