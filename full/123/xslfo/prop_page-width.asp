...
<title>XSL-FO page-width Property</title>
<style>a.menu_prop_page-width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">page-width</span> Property</h1>
...
<p>The page-width property defines the width of a page.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. The width shall be set from the size of the 
	browser window or from the size of the media</td>
  </tr>
  <tr>
    <td>indefinite</td>
    <td>The width of the page is set from the size of the laid-out 
	content</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Defines a fixed width for the page</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_page-width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_page-width.asp#top" target="_top">TOP</a> |
		<a href="prop_page-width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
