...
<title>XSL-FO start-indent Property</title>
<style>a.menu_prop_start-indent{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">start-indent</span> Property</h1>
...
<p>The start-indent property specifies the distance from the start-edge of the 
content-rectangle of the containing reference-area to the start-edge of the 
content-rectangle of that block-area.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Default is 0pt. The start-indent specified as a fixed 
	length</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>The start-indent specified as a % of the 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_start-indent.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_start-indent.asp#top" target="_top">TOP</a> |
		<a href="prop_start-indent.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
