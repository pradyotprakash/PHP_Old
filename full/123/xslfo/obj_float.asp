...
<title>XSL-FO float Object</title>
<style>a.menu_obj_float{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">float</span> Object</h1>
...
<p>The &lt;fo:float&gt; object is typically used to position an image in a separate 
area at the beginning of a page OR to position an image to one side, with the 
content flowing along-side of the image.</p>
<p>It is an error if &lt;fo:float&gt; is a descendant of a flow that is not assigned 
to a region-body.</p>
<p>It is also an error if &lt;fo:float&gt; is a descendant of an fo:block-container 
that generates an absolutely positioned area.</p>
<p>&lt;fo:float&gt; cannot have an &lt;fo:float&gt;, &lt;fo:footnote&gt; or &lt;fo:marker&gt; as a 
descendant.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_float.asp">float</a></td>
    </tr>
  <tr>
    <td>clear</td>
    </tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_float.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_float.asp#top" target="_top">TOP</a> |
		<a href="obj_float.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
