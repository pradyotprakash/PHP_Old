...
<title>XSL-FO speak-header Property</title>
<style>a.menu_prop_speak-header{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">speak-header</span> Property</h1>
...
<p>The speak-header property is used only in <b>Aural Stylesheets</b>.</p>
...
<p>The speak-header property specifies whether table headers will be spoken 
before each cell OR spoken only once (before the series of 
	cells associated with the header ).</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>once</td>
    <td>Default. The table header will be spoken once (before the series of 
	cells associated with the header )</td>
  </tr>
  <tr>
    <td>always</td>
    <td>The table header will be spoken before each cell</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_speak-header.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_speak-header.asp#top" target="_top">TOP</a> |
		<a href="prop_speak-header.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
