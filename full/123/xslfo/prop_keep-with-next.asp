...
<title>XSL-FO keep-with-next Property</title>
<style>a.menu_prop_keep-with-next{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">keep-with-next</span> Property</h1>
...
<p>The keep-with-next property creates keep-with-next conditions on XSL-FO objects.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. No keep-with-next conditions created</td>
  </tr>
  <tr>
    <td>always</td>
    <td>Creates a keep-with-next condition with the strength of &quot;always&quot;</td>
  </tr>
  <tr>
    <td><i>integer</i></td>
    <td>Creates a keep-with-next condition with strength of a 
    given integer</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_keep-with-next.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_keep-with-next.asp#top" target="_top">TOP</a> |
		<a href="prop_keep-with-next.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
