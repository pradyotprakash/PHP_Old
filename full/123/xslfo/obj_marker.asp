...
<title>XSL-FO marker Object</title>
<style>a.menu_obj_marker{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">marker</span> Object</h1>
...
<p>The &lt;fo:marker&gt; object is used with &lt;fo:retrieve-marker&gt; to create 
running headers or footers (e.g. headers showing the page's chapter and section 
titles).</p>
<p><b>Note:</b> An &lt;fo:marker&gt; object is only permitted as the descendant of an &lt;fo:flow&gt;.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_marker.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_marker.asp#top" target="_top">TOP</a> |
		<a href="obj_marker.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
