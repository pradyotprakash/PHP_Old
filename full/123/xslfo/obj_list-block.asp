...
<title>XSL-FO list-block Object</title>
<style>a.menu_obj_list-block{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">list-block</span> Object</h1>
...
<p>The &lt;fo:list-block&gt; object is used to format the whole list.</p>
<p>There are four XSL-FO objects used to create lists: </p>
<ul>
	<li>fo:list-block (contains the whole list)</li>
	<li>fo:list-item (contains each item in the list)</li>
	<li>fo:list-item-label (contains the label for the list-item - typically an 
	&lt;fo:block&gt; containing a number, character, etc.)</li>
	<li>fo:list-item-body (contains the content/body of the list-item - 
	typically one or more &lt;fo:block&gt; objects)</li>
</ul>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>
    provisional-distance-between-starts</td>
  </tr>
  <tr>
    <td><a href="prop_border_color.asp">border-right-color</a></td>
    <td>
    provisional-label-separation</td>
  </tr>
  <tr>
...
<p>The output from this code would be:</p>
<table style="padding:3;width:40%;border:1px solid black">
  <tr>
    <td><br>
&nbsp;* Volvo<br>
&nbsp;* Saab<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_list-block.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_list-block.asp#top" target="_top">TOP</a> |
		<a href="obj_list-block.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
