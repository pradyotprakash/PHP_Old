...
<title>XSL-FO footnote Object</title>
<style>a.menu_obj_footnote{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">footnote</span> Object</h1>
...
<p>The &lt;fo:footnote&gt; object defines a footnote within the region-body of a 
page.</p>
<p>It is an error if an &lt;fo:footnote&gt; occurs as a descendant of a flow that is 
not assigned to a region-body.</p>
<p>It is also an error if an &lt;fo:footnote&gt; occurs as a descendant of an fo:block-container 
that generates absolutely positioned areas.</p>
<p>Additionally the &lt;fo:footnote&gt; object cannot have an &lt;fo:float&gt;, &lt;fo:footnote&gt;, 
...
&lt;fo:footnote&gt;<br>
&nbsp;&nbsp;&lt;!--<br>
&nbsp;&nbsp;&nbsp;&nbsp;Contents:(inline|footnote-body)<br>
&nbsp;&nbsp;--&gt;<br>
&lt;/fo:footnote&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="obj_footnote.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="obj_footnote.asp#top" target="_top">TOP</a> |
		<a href="obj_footnote.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
