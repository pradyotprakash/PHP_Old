...
<title>XSL-FO text-depth Property</title>
<style>a.menu_prop_text-depth{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">text-depth</span> Property</h1>
...
<p>The text-depth property specifies the &quot;depth&quot; for the descent 
below the dominant baseline.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Default. Uses a value for the  depth of the font below the 
    baseline</td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Replaces the  depth value in the font with a specified 
    length</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_text-depth.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_text-depth.asp#top" target="_top">TOP</a> |
		<a href="prop_text-depth.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
