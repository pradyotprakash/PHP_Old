...
<title>XSL-FO border style Property</title>
<style>a.menu_prop_border_style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL-FO <span class="color_h1">border style Properties</span> Property</h1>
...
<p>The <b>border-before-style</b> property specifies the border-style on the 
before-edge.</p>
<p>The <b>border-after-style</b> property specifies the border-style on the 
after-edge.</p>
<p>The <b>border-top-style</b> property specifies the border-style on the 
top-edge.</p>
<p>The <b>border-bottom-style</b> property specifies the border-style on the 
bottom-edge.</p>
<p>The <b>border-start-style</b> property specifies the border-style on the 
start-edge.</p>
<p>The <b>border-end-style</b> property specifies the border-style on the 
end-edge.</p>
<p>The <b>border-left-style</b> property specifies the border-style on the 
left-edge.</p>
<p>The <b>border-right-style</b> property specifies the border-style on the 
right-edge.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>none</td>
    <td>Default. No border</td>
  </tr>
  <tr>
    <td>hidden</td>
    <td>A hidden border</td>
  </tr>
  <tr>
    <td>dotted</td>
    <td>The border is a dotted line</td>
  </tr>
  <tr>
    <td>dashed</td>
    <td>The border is a series of short line segments</td>
  </tr>
  <tr>
    <td>solid</td>
    <td>The border is a solid line</td>
  </tr>
  <tr>
    <td>double</td>
    <td>The border is two solid lines</td>
  </tr>
  <tr>
    <td>groove</td>
    <td>The border looks like it were carved into the canvas</td>
  </tr>
  <tr>
    <td>ridge</td>
    <td>The border &quot;comes out&quot; of the canvas</td>
  </tr>
  <tr>
    <td>inset</td>
    <td>The border looks like it were embedded in the canvas</td>
  </tr>
  <tr>
    <td>outset</td>
    <td>The border &quot;comes out&quot; of the canvas</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_border_style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_border_style.asp#top" target="_top">TOP</a> |
		<a href="prop_border_style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
