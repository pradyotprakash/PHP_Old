...
<style>a.menu_xml_xpath{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">and XPath</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_applications.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_xsl.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">With XSLT you can transform an XML document into HTML.</p>
<hr>
<h2>What is XPath?</h2>
<p>XPath (XML Path Language) is a language used to point to (or select) parts of 
XML documents.</p>
<p>XPath is not a complete language, but a syntax to be used by other 
languages.</p>
<p>XPath was designed by W3C, as a major element in the W3C standards, XSLT, 
XQuery, XLink, and XPointer.</p>
<p>Today XPath can also be used in JavaScript and Java, XML Schema, PHP, Python, 
C and C++, and lots of other languages.</p>
<hr>

<h2>XML Example</h2>
<p>We will use the following XML document for the syntax examples below:</p>
...
<h2>XPath Syntax</h2>
<p>In the table below we have listed some XPath expressions and the result of the 
expressions:</p>
...
but according to the W3C standard it should have been [1]!!</p></td>
    </tr>
  <tr>
...
<p>If you want to learn more about XPath, find our XPath tutorial on our <a href="../default.asp">homepage</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_applications.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_xsl.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_xpath.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_xpath.asp#top" target="_top">TOP</a> |
		<a href="xml_xpath.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
