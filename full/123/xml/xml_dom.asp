...
<title>XML DOM</title>
<style>a.menu_xml_dom{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">DOM</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_parser.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_to_html.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">
...
<p>
The XML DOM views an XML document as a tree-structure.</p>
<p>
All 
...
<p>
You can learn more about the HTML DOM in our <a href="../js/default.asp">
JavaScript tutorial</a>.</p>

<hr>
<h2>Load an XML File - Cross-browser Example</h2>

<p>The following example parses an XML document (&quot;<a target="_blank" href="note.xml">note.xml</a>&quot;) 
into an XML DOM object and then extracts some info from it with a JavaScript:</p>
<div class="example">
...
&nbsp; }<br>
xmlhttp.open(&quot;GET&quot;,&quot;note.xml&quot;,false);<br>
xmlhttp.send();<br>
...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a target="_blank" href="tryit.asp?filename=tryxml_parsertest" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Important Note!</h2>
<p>To extract the text &quot;Tove&quot; from the &lt;to&gt; element in the XML file 
above (&quot;note.xml&quot;), the syntax is:</p>

<div class="code notranslate"><div>
getElementsByTagName(&quot;to&quot;)[0].childNodes[0].nodeValue</div></div>

<p>Notice that even if the XML file contains 
only ONE &lt;to&gt; element you still have to specify the array index [0]. This 
is because the getElementsByTagName() method returns an array. </p>
<hr>

<h2>Load an XML String - Cross-browser Example</h2>

<p>The following example parses an XML string into an XML DOM object and then 
extracts some info from it with a JavaScript:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;html&gt;<br>
...
&lt;script&gt;<br>
txt=&quot;&lt;note&gt;&quot;;<br>
txt=txt+&quot;&lt;to&gt;Tove&lt;/to&gt;&quot;;<br>
txt=txt+&quot;&lt;from&gt;Jani&lt;/from&gt;&quot;;<br>
txt=txt+&quot;&lt;heading&gt;Reminder&lt;/heading&gt;&quot;;<br>
txt=txt+&quot;&lt;body&gt;Don't forget me this weekend!&lt;/body&gt;&quot;;<br>
txt=txt+&quot;&lt;/note&gt;&quot;;<br>
<br>
...
<br><a target="_blank" href="tryit.asp?filename=tryxml_parsertest2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_dom.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_dom.asp#top" target="_top">TOP</a> |
		<a href="xml_dom.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
