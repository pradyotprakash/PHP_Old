...
<style>a.menu_xml_examples{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">Examples</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_summary.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_quiz.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<a target="_blank" href="simplexsl.xml">Display the food menu styled with an XSLT 
style sheet</a></p>
<p><b><a href="xml_xsl.asp">Examples explained</a></b></p>
<hr>
<p><b>Parsing XML and the XML DOM</b></p>
<p>
<a target="_blank" href="note.xml">View a simple XML file (note.xml)</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_parsertest">Parse the XML file - Crossbrowser example</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_parsertest2">Parse an XML string - Crossbrowser example</a>
</p>
<p>
<b><a href="xml_dom.asp">Examples explained</a></b></p>
<hr>
<p><b>XML to HTML</b></p>
<p>
<a target="_blank" href="cd_catalog.xml">View an XML CD catalog</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_display_table">Display XML data in an HTML table</a></p>
<p><b><a href="xml_to_html.asp">Examples explained</a></b></p>
<hr>

<p><b>XML Applications</b></p>
<p>
<a target="_blank" href="cd_catalog.xml">View an XML CD catalog</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_app_first">Show XML data inside an HTML div element</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_app_navigate">Navigate through XML nodes</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_app">A simple CD catalog application</a>
</p>
...
<p><a target="_blank" href="tryit.asp?filename=tryxml_dom_getelement">Get the value of an XML element</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_dom_getattribute">Get the value of an XML attribute</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_dom_changeelement">Change the value of an XML element</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_dom_addattribute">Add a new attribute to an XML element</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_dom_createelement">Create a new XML element</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_dom_removeelement">Remove an XML element</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_examples.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_examples.asp#top" target="_top">TOP</a> |
		<a href="xml_examples.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
