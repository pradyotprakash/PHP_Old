...
<style>a.menu_xml_dom_advanced{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML DOM <span class="color_h1">Advanced</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_server.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_real_life.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>The XML DOM - Advanced</h2>
<p>In an <a href="xml_dom.asp">earlier chapter of this tutorial</a> we introduced 
the XML DOM, and we used the getElementsByTagName() method to retrieve data from an XML document.</p>
<p>In this chapter we will explain some other important XML DOM methods.</p>
<p>You can learn more about the XML DOM in our <a href="../dom/default.asp">XML DOM tutorial</a>.</p>
<hr>

<h2>Get the Value of an Element</h2>
<p>The XML file used in the examples below: <a target="_blank" href="books.xml">books.xml</a>.</p>
<p>The following example retrieves the text value of the first &lt;title&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
txt=xmlDoc.getElementsByTagName(&quot;title&quot;)[0].childNodes[0].nodeValue;</div>
<br><a target="_blank" href="tryit.asp?filename=tryxml_dom_getelement" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Get the Value of an Attribute</h2>
<p>The following example retrieves the text value of the &quot;lang&quot; attribute of the first 
&lt;title&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="tryit.asp?filename=tryxml_dom_getattribute" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>
The following example changes the text value of the first &lt;title&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="tryit.asp?filename=tryxml_dom_changeelement" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Create a New Attribute</h2>
<p>The XML DOM setAttribute() method can be used to change the value of an existing attribute, or to create a new attribute.</p>
<p>The following example adds a new attribute (edition=&quot;first&quot;) to each &lt;book&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryxml_dom_addattribute">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Create an Element</h2>
<p>The XML DOM createElement() method creates a new element node.</p><p>The XML 
DOM createTextNode() method creates a new text node.</p>
<p>The XML DOM appendChild() method adds a child node to a node (after the last child).</p>
<p>To create a new element with text content, it is necessary to both create a 
new element node and a new text node, and then append it to an existing node.</p>
<p>The following example creates a new element (&lt;edition&gt;), with the 
following text: First, and adds it to the 
first &lt;book&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="tryit.asp?filename=tryxml_dom_createelement" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ul>
	<li>Create an &lt;edition&gt; element</li>
	<li>Create a text node with the following text: First</li>
	<li>Append the text node to the new &lt;edition&gt; element</li>
	<li>Append the &lt;edition&gt; element to the first &lt;book&gt; element</li>
</ul>
<hr>

<h2>Remove an Element</h2>
<p>The following example removes the first node in the first &lt;book&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2><div class="example_code notranslate">
x=xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>
x.removeChild(x.childNodes[0]);
</div><br><a target="_blank" href="tryit.asp?filename=tryxml_dom_removeelement" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p><b>Note:</b> The result of the example above may be different depending on what browser you use. Firefox treats new lines as empty text nodes, Internet 
Explorer does not. You can read more about this and how to avoid it in our <a href="../dom/default.asp">XML DOM tutorial</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_dom_advanced.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_dom_advanced.asp#top" target="_top">TOP</a> |
		<a href="xml_dom_advanced.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
