...
<style>a.menu_xml_encoding{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">Encoding</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_namespaces.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_view.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XML documents can contain international characters, like Norwegian 
æøå, or French êèé.</p>
<p class="intro">To avoid errors, you should specify the encoding used, or save your XML files as 
UTF-8.</p>
<hr>
<h2>Character Encoding</h2>
<p>Character encoding defines a unique binary code for each different character used 
in a document.</p>
<p>In computer terms, character encoding are also called character set, character 
map, code set, and code page.</p>
<hr>
<h2>Unicode</h2>
<p>Unicode is an industry standard for character encoding of text documents. It deﬁnes (nearly) every possible international character by a 
name and a number. </p>
<p>Unicode has two variants: UTF-8 and UTF-16. </p>
<p>UTF = <strong>U</strong>niversal character set <strong>T</strong>ransformation
<strong>F</strong>ormat.</p>
<p>UTF-8 uses a single 
byte (8-bits) to represent commonly used characters and two (or three) bytes for 
the rest. </p>
<p>UTF-16 uses two bytes (16 bits) for most characters, and three bytes 
for the rest.</p>
<hr>
<h2>UTF-8 - The Web Standard</h2>
<p>UTF-8 is the standard character encoding on the web.</p>
<p>UTF-8 is the default character encoding for HTML-5, CSS, JavaScript, PHP, 
SQL, and XML.</p>
<hr>
<h2>XML Encoding</h2>
<p>The ﬁrst line in an XML document is called the <strong>prolog</strong>:</p>
...
<p>The prolog is optional. Normally it contains the XML version 
number. </p>
<p>It can also contain information about the encoding used in the 
document. This prolog specifies UTF-8 encoding:</p>

<div class="code notranslate">
<div>
&lt;?xml version="1.0" encoding="UTF-8<strong>"</strong>?&gt;
</div>
</div>

<p>The XML standard states that all XML software must understand both UTF-8 and 
UTF-16. </p>
<p>UTF-8 is the default for documents without encoding information. </p>
<p>In addition, most XML software systems understand encodings like ISO-8859-1, 
Windows-1252, and ASCII.</p>
<hr>
<h2>XML Errors</h2>
<p>Most often, XML documents are created on one computer, uploaded to a server 
on a second computer, and displayed by a browser on a third computer. </p>
<p>If the encoding is not correctly interpreted by all the three computers, the 
browser might display meaningless text, or you might get an error message.</p>
<p>Look at these two XML files:
<a href="note_with_right_encoding.xml" target="_blank">
Note saved with right encoding</a> and
<a href="note_with_wrong_encoding.xml" target="_blank">
Note saved with wrong encoding</a>.</p>
<p>For high quality XML documents, UTF-8 encoding is be the best to use. UTF-8 covers 
international characters, and it is also the default, if no encoding is declared. </p>
<hr>
<h2>Conclusion</h2>
<p>When you write an XML document:</p>
<ul>
	<li>Use an XML editor that supports encoding</li>
	<li>Make sure you know what encoding the editor uses</li>
	<li>Describe the encoding in the encoding attribute</li>
	<li>UTF-8 is the safest encoding to use</li>
	<li>UTF-8 is the web standard </li>
</ul>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_namespaces.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_encoding.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_encoding.asp#top" target="_top">TOP</a> |
		<a href="xml_encoding.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
