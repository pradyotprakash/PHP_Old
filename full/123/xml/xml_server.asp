...
<style>a.menu_xml_server{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">on the Server</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_cdata.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_dom_advanced.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XML files are plain text files just like HTML files. </p>
<p class="intro">XML can easily be stored and generated by a standard web server.</p>
<hr>

<h2>Storing XML Files on the Server</h2>
<p>XML files can be stored on an Internet server exactly the same way as HTML files.</p>
<p>Start Windows Notepad and write the following lines:</p>

<div class="code notranslate"><div>

&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8<strong>"</strong>?&gt;<br>
&lt;note&gt;<br>
  &nbsp;
  &lt;from&gt;Jani&lt;/from&gt;<br>
  &nbsp;
...
<p>Save the file on your web server with a proper name like &quot;note.xml&quot;.</p>
<hr>

<h2>Generating XML with ASP</h2>
<p>XML can be generated on a server without any installed XML software.</p>
<p>To generate an XML response from the server - simply write the following code and save it as an ASP file on the web server:</p>

<div class="code notranslate"><div>

&lt;%<br>
response.ContentType=&quot;text/xml&quot;<br>
response.Write(&quot;&lt;?xml version='1.0' encoding='UTF-8<strong>'</strong>?&gt;&quot;)<br>
...
<p>Note that the content type of the response must be set to &quot;text/xml&quot;.</p>
<p><a target="_blank" href="note.asp">See how the ASP file will be returned from the server</a>.</p>
<p>If you want to study ASP, you will find our ASP tutorial on our <a href="../default.asp">homepage</a>.</p>
<hr>

<h2>Generating XML with PHP</h2>
<p>To generate an XML response from the server using PHP, use following code:</p>

<div class="code notranslate"><div>

&lt;?php<br>
header(&quot;Content-type: text/xml&quot;);<br>
echo &quot;&lt;?xml version='1.0' encoding='UTF-8<strong>'</strong>?&gt;&quot;;<br>
echo &quot;&lt;note&gt;&quot;;<br>
...
<p>Note that the content type of the response header must be set to &quot;text/xml&quot;.</p>
<p><a target="_blank" href="note.php">See how the PHP file will be returned from the server</a>.</p>
<p>If you want to study PHP, you will find our PHP tutorial on our <a href="../default.asp">homepage</a>.</p>
<hr>

<h2>Generating XML From a Database</h2>
<p>XML can be generated from a database without any installed XML software.</p>
<p>To generate an XML database response from the server, simply write the following code and save it as an ASP file on the web server:</p>
...
<p><a target="_blank" href="guestbook.asp">See the real life database output from the ASP file above</a>.</p>
<p>The example above uses ASP with ADO.</p>
<p>If you want to study ASP and ADO, you will find the tutorials on our <a href="../default.asp">homepage</a>.</p>
<hr>

<h2>Transforming XML with XSLT on the Server</h2>
<p>This ASP transforms an XML file to XHTML on the server:</p>
...
<ul>
	<li>The first block of code creates an instance of the Microsoft XML parser (XMLDOM), and loads the XML file into memory.</li>
	<li>The second block of code creates another instance of the parser and loads the XSL file into memory.</li>
	<li>The last line of code transforms the XML document using the XSL document, and sends the result as XHTML to your browser. Nice!</li>
</ul>
<p><a target="_blank" href="simple.asp">See how it works</a>.</p>
<hr>

<h2>Saving XML To a File Using ASP</h2>
<p>This ASP example creates a simple XML document and saves it on the server:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_server.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_server.asp#top" target="_top">TOP</a> |
		<a href="xml_server.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
