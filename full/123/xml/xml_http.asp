...
<style>a.menu_xml_http{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_schema.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_parser.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>The XMLHttpRequest Object</h2>
<p>The XMLHttpRequest object is used to exchange data with a server behind the 
scenes.</p>
<p>The XMLHttpRequest object is <b>a developer's dream</b>, because you can:</p>
<ul>
...
<p>
To learn more about the XMLHttpRequest object, study our
...
<table width="100%" style="border:1px solid #d4d4d4;background-color:#e5eecc;background-image:url('http://www.w3schools.com/images/bgfadegreen.gif');background-repeat:repeat-x" id="table18">
...
<p>In the next chapter, we will use the XMLHttpRequest object to retrieve XML information from a server. </p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_http.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_http.asp#top" target="_top">TOP</a> |
		<a href="xml_http.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
