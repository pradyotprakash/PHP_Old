...
<title>XML Introduction - What is XML?</title>
<style>a.menu_xml_whatis{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">Introduction to</span> XML</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_usedfor.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XML was designed to transport and store data.</p>
<p class="intro">HTML was designed to display data.</p>
<hr>
...
<p><b>XML is a complement to HTML.</b></p>
...
<p><b>XML is a software- and hardware-independent tool for carrying information.</b></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_whatis.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_whatis.asp#top" target="_top">TOP</a> |
		<a href="xml_whatis.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
