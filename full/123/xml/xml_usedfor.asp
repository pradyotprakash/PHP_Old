...
<title>XML Usage</title>
<style>a.menu_xml_usedfor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>How Can XML be <span class="color_h1">Used?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_whatis.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_tree.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XML is used in many aspects of web development, often to 
simplify data storage and sharing.</p>

<hr>
<h2>XML Separates Data from HTML</h2>
<p>If you need to display dynamic data in your HTML document, it will take a lot 
of work to edit the HTML each time the data changes.</p>
<p>With XML, data can be stored in separate XML files. This way
you can concentrate on using HTML/CSS for display and layout, and be sure that changes in the underlying data will not
require any changes to the HTML.</p>

<p>With a few lines of JavaScript code, you can read an external XML file and update 
the data content of your web page. </p>

<hr>
<h2>XML Simplifies Data Sharing</h2>

<p>In the real world, computer systems and databases contain data in 
incompatible formats.</p>
<p>XML data is stored in plain text format. This provides a software- and
hardware-independent way of storing data.</p>

<p>This makes it much easier to create
data that can be shared by different applications.</p>
...
<p>One of the
most time-consuming
challenges for developers is to exchange data between incompatible systems over the Internet.</p>

<p>Exchanging data as
XML greatly reduces this complexity, since the data can be read by different 
incompatible applications.</p>

<hr>
<h2>XML Simplifies Platform Changes</h2>
<p>Upgrading to new systems (hardware or software platforms), is always  
time consuming. Large amounts of data must be converted and incompatible data is 
often lost.</p>
<p>XML data is stored in text format. This makes it easier to expand or upgrade 
...
<p>Different
applications can access your data, not only in HTML pages, but also from XML data sources.</p>
<p>With XML, your data can be available to all kinds of &quot;reading
machines&quot; (Handheld computers, voice machines, news feeds, etc.), and make it more available for blind
people, or people with other disabilities.</p>
...
<p><b>If they DO have sense, future applications will exchange their data in
XML.</b></p>
<p>The future might give us word processors, spreadsheet
applications and databases that can read each other's data in XML format,
without any conversion utilities in between.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_whatis.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_tree.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_usedfor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_usedfor.asp#top" target="_top">TOP</a> |
		<a href="xml_usedfor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
