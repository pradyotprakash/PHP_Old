...
<title>XML DTD</title>
<style>a.menu_xml_dtd{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">DTD</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_validator.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_schema.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An XML document with correct syntax is called &quot;Well Formed&quot;.</p>
<p class="intro">An XML document validated against a DTD is &quot;Well Formed&quot; 
and &quot;Valid&quot;.</p>
<hr>

<h2>Valid XML Documents</h2>
<p>A &quot;Valid&quot; XML document is a &quot;Well Formed&quot; XML document, which also conforms to the rules of a 
DTD:</p>

<div class="code notranslate"><div>
&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8<strong>"</strong>?&gt;<br>
<span class="marked">&lt;!DOCTYPE note SYSTEM &quot;Note.dtd&quot;&gt;</span><br>
&lt;note&gt;<br>
&lt;to&gt;Tove&lt;/to&gt;<br>
&lt;from&gt;Jani&lt;/from&gt;<br>
...
<p>The DOCTYPE declaration, in the example above, is a reference to an external DTD file. The content of the file is shown in the paragraph below.</p>
<hr>

<h2>XML DTD</h2>
<p>The purpose of a DTD is to define the structure of an XML document. It defines the structure with a list of legal elements:</p>
...
<ul>
	<li>!DOCTYPE note  defines that the root element of the document is 
	note</li>
	<li>!ELEMENT note  defines that the note element contains four elements: &quot;to, from, heading, body&quot;</li>
...
<h2>Using DTD for Entity Declaration</h2>
<p>A doctype declaration can also be used to define special characters and 
character strings, used in the document:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;<br><br>&lt;!DOCTYPE note [<br>&lt;!ENTITY nbsp 
	&quot;&amp;#xA0;&quot;&gt; <br>&lt;!ENTITY writer &quot;Writer: Donald Duck.&quot;&gt;<br>
&lt;!ENTITY copyright &quot;Copyright: W3Schools.&quot;&gt;<br>]&gt;<br><br>
	&lt;note&gt;<br>&lt;to&gt;Tove&lt;/to&gt;<br>&lt;from&gt;Jani&lt;/from&gt;<br>
	&lt;heading&gt;Reminder&lt;/heading&gt;<br>&lt;body&gt;Don't forget me this weekend!&lt;/body&gt;<br>
	&lt;footer&gt;&amp;writer;&amp;nbsp;&amp;copyright;&lt;/footer&gt;<br>
	&lt;/note&gt;
</div>
<br><a target="_blank" href="note_entities.xml" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
<p>An entity has three parts: an ampersand (&amp;), an entity name, and a semicolon 
(;).</p>
</td>
</tr></table>
...
<h2>Why Use a DTD?</h2>
<p>With a DTD, your XML files can carry a description of its own format.</p>
<p>With a DTD, independent groups of people can agree on a standard for interchanging data.</p>
<p>With a DTD, you can verify that the data you receive from the outside world is valid.</p>

<p>If you want to study DTD, you will find our DTD tutorial on our <a href="../default.asp">homepage</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_validator.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_schema.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_dtd.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_dtd.asp#top" target="_top">TOP</a> |
		<a href="xml_dtd.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
