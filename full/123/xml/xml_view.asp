...
<title>Viewing XML files</title>
<style>a.menu_xml_view{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">Viewing</span> XML Files</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_encoding.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_display.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Raw XML files can be viewed in all major browsers.</p>
<p class="intro">Don't expect XML files to be displayed as HTML pages.</p>
<hr>

<h2>Viewing XML Files</h2>
<table width="100%" border="1" cellpadding="3" cellspacing="0" id="table1">
<tr><td>
<div style="font-size:120%" >
<div style="color:blue">&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8<strong>"</strong>?&gt;</div>
<div><span style="color:red">&nbsp;- </span><span style="color:blue">&lt;</span><span style="color:maroon">note</span><span style="color:blue">&gt;</span></div>
<div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">to</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Tove</span><span style="color:blue">&lt;/</span><span style="color:maroon">to</span><span style="color:blue">&gt;</span>
</div>
<div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">from</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Jani</span><span style="color:blue">&lt;/</span><span style="color:maroon">from</span><span style="color:blue">&gt;</span>
</div>
<div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">heading</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Reminder</span><span style="color:blue">&lt;/</span><span style="color:maroon">heading</span><span style="color:blue">&gt;</span>
</div>
<div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">body</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Don't forget me this weekend!</span><span style="color:blue">&lt;/</span><span style="color:maroon">body</span><span style="color:blue">&gt;</span>
</div>
<div>&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;/</span><span style="color:maroon">note</span><span style="color:blue">&gt;</span></div>
</div>
</td></tr></table>

<p>Look at this XML file: <a target="_blank" href="note.xml">note.xml</a></p>
<p>The XML document will be displayed with color-coded root and child elements. A plus (+) or minus sign (-) to the left
of the elements can be clicked to expand or collapse the element structure.&nbsp;To view the raw XML source (without the 
+ and - signs), select &quot;View Page Source&quot; or &quot;View Source&quot; from the browser menu.</p>
<p><b>Note:</b> In Safari, only the element text will be displayed. To view the raw XML, you must right click the page and select &quot;View Source&quot;</p>
<hr>

<h2>Viewing an Invalid XML File</h2>
<p>If an erroneous XML file is opened, some browsers might report the error, 
some may display it incorrectly.</p>
<p>Try to open this XML file in Chrome, IE, Firefox, Opera, and Safari : <a target="_blank" href="note_error.xml">note_error.xml</a></p>
<hr>

<h2>Other XML Examples</h2>
<p>Viewing some XML documents will help you get the XML feeling.</p>
<p><a target="_blank" href="cd_catalog.xml">An XML CD catalog</a><br>
This is a CD collection, stored as XML data.
</p>
<p><a target="_blank" href="plant_catalog.xml">An XML plant catalog</a><br>
This is a plant catalog from a plant shop, stored as XML data.
</p>
<p><a target="_blank" href="simple.xml">A Simple Food Menu</a><br>
This is a breakfast food menu from a restaurant, stored as XML data.
</p>
<hr>

<h2>Why Does XML Display Like This?</h2>
<p>XML documents do not carry information about how to display the data.</p>
<p>Since XML tags are &quot;invented&quot; by the author of the XML document, browsers do not know if a tag like &lt;table&gt; describes an HTML table or a dining table.</p>
<p>Without any information about how to display the data, most browsers will just display the XML document as it is.</p>
<p>In the next chapters, we will look at different solutions for the display problem, using CSS, XSLT, and JavaScript.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_encoding.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_display.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_view.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_view.asp#top" target="_top">TOP</a> |
		<a href="xml_view.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
