...
<style>a.menu_xml_syntax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">Syntax Rules</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_tree.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_elements.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The syntax rules of XML are very simple and logical. The rules are easy to learn, and easy to use.</p>
<hr>
...
<p>In XML, it is illegal to omit the closing tag. All elements <b>must</b> have a closing tag:</p>
...
<p><b>Note</b>: You might have noticed from the previous example that the XML declaration
did not have a closing tag. This is not an error. The declaration is not a part of the
XML document itself, and it has no closing tag.</p>
<hr>
...
&lt;Message&gt;This is incorrect&lt;/message&gt;<br>
&lt;message&gt;This is correct&lt;/message&gt;</div></div>

<p><b>Note:</b> &quot;Opening and closing tags&quot; are often referred to as &quot;Start and 
end tags&quot;. Use whatever you prefer. It is exactly the same thing.</p>
<hr>
...
<p>In XML, all elements <b>must</b> be properly nested within each other:</p>

<div class="code notranslate"><div>
&lt;b&gt;&lt;i&gt;This text is bold and italic&lt;/i&gt;&lt;/b&gt;</div></div>

<p>In the example above, &quot;Properly nested&quot; simply means that since the &lt;i&gt; 
element is opened inside the &lt;b&gt; element, it must be closed inside the &lt;b&gt; element.</p>
<hr>

<h2>XML Documents Must Have a Root Element</h2>
<p>XML documents must contain one element that is the <b>parent</b> of all other 
elements. This element is called the <b>root</b> element.</p>
...
<p>Study the two XML documents below.
The first one is incorrect, the second is correct:</p>
...
<p>If you place a character like &quot;&lt;&quot; inside an XML element, it will generate an error because the parser interprets it as the
start of a new element.</p>
<p>This will generate an XML error:</p>

<div class="code notranslate"><div>
&lt;message&gt;if salary &lt; 1000 then&lt;/message&gt;</div></div>

<p>To avoid this error, replace the &quot;&lt;&quot; character with an <b>entity reference</b>:</p>

<div class="code notranslate"><div>
&lt;message&gt;if salary <span class="marked">&amp;lt;</span> 1000 then&lt;/message&gt;</div></div>  

<p>There are 5 predefined entity references in XML:</p>
<table class="reference notranslate" style="width:50%">
<tr>
<td>&amp;lt;</td>
<td>&lt;</td>
<td>less than</td>
...
<p>
<b>Note:</b> Only the characters &quot;&lt;&quot; and &quot;&amp;&quot; are strictly illegal in XML. The greater than character is
legal, but it is a good habit to replace it.</p>
<hr>
...
<p>Windows applications stores a new line as: carriage return and line feed (CR+LF).</p>
<p>Unix 
and Mac OSX uses LF.</p>
<p>Old Mac systems uses CR.</p>
<p>XML stores a new line as LF.</p>
<hr>

<h2>Well Formed XML</h2>
<p>XML documents that conform to the syntax rules above are said to be &quot;Well 
Formed&quot; XML documents.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_tree.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_elements.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_syntax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_syntax.asp#top" target="_top">TOP</a> |
		<a href="xml_syntax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
