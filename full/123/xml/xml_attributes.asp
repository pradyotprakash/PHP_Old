...
<style>a.menu_xml_attributes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">Attributes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_elements.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_namespaces.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XML elements can have attributes, just like HTML.</p>
<p class="intro">Attributes provide additional information about an element.</p>
<hr>

<h2>XML Attributes</h2>
<p>In HTML, attributes provide additional information about elements:</p>

<div class="code notranslate"><div>
&lt;img src=&quot;computer.gif&quot;&gt;<br>
&lt;a href=&quot;demo.asp&quot;&gt;</div></div>

<p>Attributes often provide information that is not a part of the data. In the example below, the file type is irrelevant to the data, but
can be important to the software that wants to manipulate the element:</p>

<div class="code notranslate"><div>
&lt;file type=&quot;gif&quot;&gt;computer.gif&lt;/file&gt;</div></div>
<br>
<hr>

<h2>XML Attributes Must be Quoted</h2>
<p>Attribute values must always be quoted. Either single or double quotes can be used. For a person's sex, the person 
element can be written like this:</p>

<div class="code notranslate"><div>
&lt;person sex=&quot;female&quot;&gt;</div></div>
...
<p>If the attribute value itself contains double quotes you can use single quotes, like in this example:</p>                

<div class="code notranslate"><div>
&lt;gangster name='George &quot;Shotgun&quot; Ziegler'&gt;</div></div>

<p>or you can use character entities:</p>
...
<h2>XML Elements vs. Attributes</h2>
...
<p>There are no rules about when to use attributes or when to use elements. Attributes are handy in HTML. In XML my advice is to avoid them. Use elements instead.</p>
<hr>
...
<p>Don't end up like this:</p>

<div class="code notranslate"><div>
&lt;note day=&quot;10&quot; month=&quot;01&quot; year=&quot;2008&quot;<br>
...
<h2>XML Attributes for Metadata</h2>
<p>Sometimes ID references are assigned to elements. These IDs can be used to identify XML elements in much the same way as the 
id attribute in HTML. This example demonstrates this:</p>
...
&lt;messages&gt;<br>
  ...
  &lt;/note&gt;<br>
&lt;/messages&gt;</div></div>
<p>The id attributes above are for identifying the different notes. It is not a part of the note itself.</p>
<p>What I'm trying to say here is that metadata (data about data) should be stored as attributes, and the data itself should be stored as elements.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_elements.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_namespaces.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_attributes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_attributes.asp#top" target="_top">TOP</a> |
		<a href="xml_attributes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
