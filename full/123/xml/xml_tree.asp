...
<style>a.menu_xml_tree{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">Tree</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_usedfor.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_syntax.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XML documents form a tree structure that starts at &quot;the root&quot; and branches to &quot;the leaves&quot;.</p>
<hr>
...
<p>The first line is the XML declaration. It defines the XML version (1.0).</p>
<p>The next line describes the <b>root element </b>of the document (like saying: &quot;this document is a note&quot;):</p>

<div class="code notranslate"><div>
&lt;note&gt;</div></div>

<p>The next 4 lines describe 4 <b>child elements</b> of the root (to, from, heading, and body):</p>
...
<p>XML documents must contain a <b>root element</b>. This element is &quot;the parent&quot; of all other elements.</p>
...
<p>The terms parent, child, and sibling are used to describe the relationships between 
elements. Parent elements have children. Children on the same level are called siblings (brothers or sisters).</p>
<p>All elements can have text content and attributes (just like in HTML).</p>
<hr>

<h2>Example:</h2>
<img src="nodetree.gif" alt="DOM node tree" width="486" height="275" />
...
<p>The root element in the example is &lt;bookstore&gt;. All &lt;book&gt; elements in the document are 
contained within &lt;bookstore&gt;.<p>The &lt;book&gt; element has 4 children: &lt;title&gt;,&lt; author&gt;, &lt;year&gt;, &lt;price&gt;.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_usedfor.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_syntax.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_tree.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_tree.asp#top" target="_top">TOP</a> |
		<a href="xml_tree.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
