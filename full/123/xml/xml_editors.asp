...
<style>a.menu_xml_editors{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">Editors</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_real_life.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_summary.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">If you are serious about XML, you will benefit from using a professional XML Editor.</p>
<hr>

<h2>XML is Text-based</h2>
<p>XML is a text-based markup language.</p>
<p>One great thing about XML is that XML files can be created and edited using a 
simple text-editor like Notepad.</p>
<p>However, when you start working with XML, you will soon find that it is 
better to edit XML documents using a professional XML editor.</p>
<hr>

<h2>Why Not Notepad?</h2>
<p>Many web developers use Notepad to edit both HTML and XML 
documents because Notepad is included with the most common OS and it is simple to use. 
Personally I often use 
Notepad for quick editing of simple HTML, CSS, and XML files.</p>
<p>But, if you use Notepad for XML editing, you will soon run into problems.</p>
<p>Notepad does not know that you are writing XML, so it will not be able to 
assist you. </p>
<hr>

<h2>Why an XML Editor?</h2>
<p>Today XML is an important technology, and development projects use XML-based 
technologies like:</p>
<ul>
  <li>XML Schema to define XML structures and data types</li>
  <li>XSLT to transform XML data</li>
  <li>SOAP to exchange XML data between applications</li>
  <li>WSDL to describe web services</li>
  <li>RDF to describe web resources</li>
  <li>XPath and  XQuery to access XML data</li>
  <li>SMIL to define graphics</li>
</ul>
<p>To be able to write error-free XML documents, you will need an intelligent XML editor!</p>
<hr>

<h2>XML Editors</h2>
<p>Professional XML editors will help you to write error-free XML documents, 
validate your XML against a DTD or a schema, and force you to stick to a valid XML structure.</p>
<p>An XML editor should be able to:</p>
<ul>
  <li>Add closing tags to your opening tags automatically</li>
  <li>Force you to write valid XML</li>
  <li>Verify your XML against a DTD</li>
  <li>Verify your XML against a Schema</li>
  <li>Color code your XML syntax</li>
</ul>
<hr>

<img src="http://www.w3schools.com/banners/altova_2014_xmlspy.gif" alt="XMLSPY" /><br>
<p>At W3Schools we have been using XMLSpy for many years. XMLSpy is our favorite 
XML editor. These are some of the features we especially like:</p>
<ul>
<li>Available in 32-bit and 64-bit versions</li>
<li>Easy to use</li>
<li>Context-sensitive entry helpers</li>
<li>Syntax coloring and pretty printing</li>
<li>Smart Fix validation with auto-correction of errors</li>
<li>Easy switching between text view and grid view</li>
<li>Graphical XML Schema 1.0/1.1 editor</li> 
<li>Database import and export for all major databases</li>
<li>SharePoint Server support</li>
<li>Built in templates for many XML document types</li>
<li>Chart creation for displaying XML data</li>
<li>Intelligent XPath 1.0/2.0/3.0 auto-completion</li>
<li>XSLT 1.0/2.0/3.0 editor, profiler &amp; debugger</li>
<li>XQuery 1.0/3.0 editor, profiler, &amp; debugger</li>
<li>SOAP client and debugger</li>
<li>Graphical WSDL 1.1/2.0 editor</li>
<li>XBRL validation &amp; taxonomy editing</li>
<li>Support for OOXML in MS Office docs</li>
<li>Code generation in Java, C++, and C#</li>
<li>HTML5 and CSS3 support</li>
</ul>
<p>
<a target="_blank" href="http://www.altova.com/ref/?s=w3s_xmledit&amp;q=xmlspy">Read more about XMLSpy</a></p>
<p>XMLSpy is just one of the six tools in the Altova MissionKit XML software suite.
<br>
<a target="_blank" href="http://www.altova.com/ref/?s=w3s_xmledit&amp;q=missionkitxml">Read more about the Altova MissionKit for XML Developers.</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_real_life.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_summary.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_editors.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_editors.asp#top" target="_top">TOP</a> |
		<a href="xml_editors.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
