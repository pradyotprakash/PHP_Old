...
<title>XML Document Types</title>
<style>a.menu_xml_doctypes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML<span class="color_h1"> Document Types</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_display.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_validator.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An XML document with correct syntax is called &quot;Well Formed&quot;.</p>
<p class="intro">A &quot;Valid&quot; XML document must also conform to a specified 
document type.</p>
<hr>

<h2>Well Formed XML Documents</h2>
<p>An XML document with correct syntax is &quot;Well Formed&quot;.</p>
<p>The syntax rules were described in the previous chapters:</p>
<ul>
...
<h2>An XML Validator</h2>
<p>To help you check the syntax of your XML files, we have created an XML validator to syntax-check your XML.</p>
<p>Please see the next chapter.</p>
<hr>

<h2>Valid XML Documents</h2>
<p>A valid XML document is not the same as a well formed XML document.</p>
<p>The first rule, for a valid XML document, is that it must be well formed (see 
previous paragraph).</p>
<p>The second rule is that a valid XML document must conform to a  
document type.</p>
<p>Rules that defines legal elements and attributes 
for XML documents are often called document definitions, or document schemas.</p>
<hr>

<h2>When to Use a Document Definition?</h2>
<p>A document definition is the easiest way to provide a reference to the legal 
elements and attributes of a document.</p>
<p>A document definition also provides a common reference that many users 
(developers) can share.</p>
<p>A document definition provides a standardization that makes life 
easier.</p>
<hr>

<h2>When NOT to Use a Document Definition?</h2>
<p>XML does not require a document definition.</p>
<p>When you are experimenting with XML, or when you are working with small XML 
files, creating document definitions may be a waste of time.</p>
<p>If you develop applications, 
wait until the specification is stable, before you add a document definition. 
Otherwise your&nbsp; software might stop working, because of validation errors,</p>
<hr>

<h2>Document Definitions</h2>
<p>There are different types of document definitions that can be used with XML:</p>
<ul>
	<li>The original Document Type Definition (DTD)</li>
	<li>The newer, and XML based, XML Schema</li>
</ul>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_display.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_doctypes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_doctypes.asp#top" target="_top">TOP</a> |
		<a href="xml_doctypes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
