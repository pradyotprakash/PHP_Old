...
<style>a.menu_xml_cdata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">CDATA</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_xpointer.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_server.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">All text in an XML document will be parsed by the parser.</p>
<p class="intro">But text inside a CDATA section will be ignored by the parser.</p>
<hr>
<h2>PCDATA - Parsed Character Data</h2>
<p>XML parsers normally parse all the text in an XML document.</p>
<p>When an XML element is parsed, the text between the XML tags is also parsed:</p>

<div class="code notranslate"><div>
&lt;message&gt;<span class="marked">This text is also parsed</span>&lt;/message&gt;</div></div>

<p>The parser does this because XML elements can contain other elements, as in this example, where the &lt;name&gt; element contains two other elements (first and last):</p>

<div class="code notranslate"><div>
&lt;name&gt;&lt;first&gt;Bill&lt;/first&gt;&lt;last&gt;Gates&lt;/last&gt;&lt;/name&gt;</div></div>

<p>and the parser will break it up into sub-elements like this:</p>
...
<p>Parsed Character Data (PCDATA) is a term used about text data that will be parsed by the XML parser. </p>
<hr>

<h2>CDATA - (Unparsed) Character Data</h2>
...
<p>A CDATA section starts with &quot;<b>&lt;![CDATA[</b>&quot; and ends with &quot;<b>]]&gt;</b>&quot;:</p>
...
&lt;/script&gt;</div></div>
<p>In the example above, everything inside the CDATA section is ignored by the parser.</p>
<p><b>Notes on CDATA sections:</b></p>
<p>A CDATA section cannot contain the string &quot;]]&gt;&quot;. Nested CDATA sections are not allowed.</p>
<p>The &quot;]]&gt;&quot; that marks the end of the CDATA section cannot contain spaces or line breaks. </p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_xpointer.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_server.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_cdata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_cdata.asp#top" target="_top">TOP</a> |
		<a href="xml_cdata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
