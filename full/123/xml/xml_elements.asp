...
<style>a.menu_xml_elements{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">Elements</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_syntax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_attributes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An XML document contains XML Elements.</p>
<hr>

<h2>What is an XML Element?</h2>
<p>An XML element is everything from (including) the element's start tag to 
(including) the element's end tag.</p>
...
<p>In the example above, &lt;bookstore&gt; and &lt;book&gt; have <b>element contents</b>, 
because they contain other elements. &lt;book&gt; also has an <b>attribute</b> 
(category="CHILDREN"). &lt;title&gt;, &lt;author&gt;, &lt;year&gt;, and &lt;price&gt; have <b>text 
content</b> because they contain text.</p>
<hr>

<h2>Empty XML Elements</h2>
<p>An alternative syntax can be used for XML elements with no content:</p>
<p>Instead of writing a book element (with no content) like this:</p>
...
<p>This sort of element syntax is called self-closing.</p>
<hr>
...
<p>Any name can be used, no words are reserved.</p>
<hr>

<h2>Best Naming Practices</h2>
<p>Make names descriptive: 
&lt;first_name&gt;, &lt;last_name&gt;.</p>
<p>Make names short and simple, like this: &lt;book_title&gt; not like this: 
&lt;the_title_of_the_book&gt;.</p>
<p>Avoid "-". If you name something "first-name," some software may 
think you want to subtract name from first.</p>
<p>Avoid ".". If you name something "first.name," some software may 
think that "name" is a property of the object "first."</p>
<p>Avoid ":". Colons are reserved to be used for something called 
namespaces (more later).</p>
<p>Non-English letters like éòá are perfectly legal in XML, but watch out for 
problems if your software doesn't support them.</p>
<hr>

<h2>Naming Styles</h2>
<p>There are no naming styles defined for XML elements. But here are some commonly 
used:</p>
...
<tr>
	<td>Lower case</td>
	<td>&lt;firstname&gt;</td>
	<td>All letters lower case</td>
</tr>
<tr>
	<td>Upper case</td>
	<td>&lt;FIRSTNAME&gt;</td>
	<td>All letters upper case</td>
</tr>
<tr>
	<td>Underscore</td>
	<td>&lt;first_name&gt;</td>
	<td>Underscore separates words</td>
</tr>
<tr>
	<td>Pascal case</td>
	<td>&lt;FirstName&gt;</td>
	<td>Uppercase first letter in each word</td></tr>
<tr>
	<td>Camel case</td>
	<td>&lt;firstName&gt;</td>
	<td>Uppercase first letter in each words exept the first</td>
</tr>
</table>
<p>If you choose a naming style, it is good to be consistent!</p>
<p>XML documents often have a corresponding database. A good practice is to use 
the naming rules of your database for the elements in the XML documents.</p>
<hr>

<h2>XML Elements are Extensible</h2>
<p>XML elements can be extended to carry more information.</p>
<p>Look at the following XML example:</p>
...
<p>Let's imagine that we created an application that extracted the &lt;to&gt;, &lt;from&gt;, 
and &lt;body&gt; elements from the XML document to produce this output:</p>
...
<p>Imagine that the author of the XML document added some extra information to 
it:</p>

<div class="code notranslate"><div>
	&lt;note&gt;<br>
	&lt;date&gt;2008-01-10&lt;/date&gt;<br>
	&lt;to&gt;Tove&lt;/to&gt;<br>
	&lt;from&gt;Jani&lt;/from&gt;<br>
...
<p>Should the application break or crash?</p>
<p>No. The application should still be able to find the &lt;to&gt;, &lt;from&gt;, and &lt;body&gt; 
elements in the XML document and produce the same output.</p>
<p>One of the beauties of XML, is that it can be extended without breaking 
applications.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_syntax.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_elements.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_elements.asp#top" target="_top">TOP</a> |
		<a href="xml_elements.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
