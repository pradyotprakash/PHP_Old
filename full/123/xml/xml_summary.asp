...
<style>a.menu_xml_summary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Summary. <span class="color_h1">What is Next?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_editors.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>XML Summary</h2>
<p>XML can be used to exchange, share, and store 
data.</p>
<p>XML documents form <a href="xml_tree.asp">a tree structure</a> that starts at 
&quot;the root&quot; and branches to &quot;the leaves&quot;.</p>
<p>XML has very simple <a href="xml_syntax.asp">syntax rules</a>. XML with 
correct syntax is &quot;Well Formed&quot;. Valid XML also validates against a
<a href="xml_dtd.asp">DTD</a>.</p>
<p><a href="xml_xsl.asp">XSLT</a> is used to transform XML into other formats 
like HTML.</p>
<p>All modern browsers have a built-in <a href="xml_parser.asp">XML parser</a> 
that can read and manipulate XML.</p>
<p>The <a href="xml_dom.asp">DOM</a> (Document Object Model) defines a standard 
way for accessing XML.</p>
<p>The <a href="xml_http.asp">XMLHttpRequest</a> object provides a way to 
communicate with a server after a web page has loaded.</p>
<p><a href="xml_namespaces.asp">XML Namespaces</a> provide a method to avoid 
element name conflicts.</p>
<p>Text inside a <a href="xml_cdata.asp">CDATA</a> section is ignored by the 
parser.</p>
<p>Our <a href="xml_examples.asp">
XML examples</a> also represent a summary of this XML tutorial.</p>
<hr>
<h2>What to Study Next?</h2>
<p>Our recommendation is to learn about the XML DOM and XSLT.</p>
...
<hr>
<h2>XML DOM (Document Object Model)</h2>
<p>The XML DOM defines a standard way for accessing and manipulating XML 
documents.</p>
<p>The
XML DOM is platform and language independent and can be used by any programming 
language like Java, JavaScript, and VBScript.</p>
<p>If you want to learn more about the DOM, please 
visit our <a href="../dom/default.asp">XML DOM tutorial</a>.</p>
<hr>
<h2>XSLT (XML Stylesheet Language Transformations)</h2>
...
<hr>
<h2>XML DTD (Document Type Definition)</h2>
<p>The purpose of a DTD is to define what elements, attributes and entities are 
...
<p>Unlike DTD, XML Schemas has support for data types, and XML Schema use XML 
Syntax.</p>
<p>If you want to learn more about XML Schema, please 
visit our <a href="../schema/default.asp">XML Schema tutorial</a>.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_summary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_summary.asp#top" target="_top">TOP</a> |
		<a href="xml_summary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
