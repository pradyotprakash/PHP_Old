...
<style>a.menu_xml_applications{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_to_html.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_xpath.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">This chapter demonstrates some small XML applications built on 
XML, HTML, XML DOM and JavaScript.</p>
<hr>

<h2>The XML Document Used</h2>
<p>In this application we will use the <a target="_blank" href="cd_catalog.xml">&quot;cd_catalog.xml&quot;</a> 
file.</p>
<hr>

<h2>Display the First CD in an HTML div Element</h2>
<p>The following example gets the 
XML data from the first CD element and displays it in an HTML element with id=&quot;showCD&quot;. 
The displayCD() function is called when the page is loaded:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
x=xmlDoc.getElementsByTagName(&quot;CD&quot;);<br>
i=0;<br>
<br>
function displayCD()<br>
{<br>
...
document.getElementById(&quot;showCD&quot;).innerHTML=txt;<br>
}</div>
<br><a target="_blank" href="tryit.asp?filename=tryxml_app_first" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="example_code notranslate">
function next()<br>
{ // display the next CD, unless you are on the last CD<br>
if (i&lt;x.length-1)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;i++;<br>
&nbsp;&nbsp;displayCD();<br>
...
{ // displays the previous CD, unless you are on the first CD <br>
if (i&gt;0)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;i--;<br>
&nbsp;&nbsp;displayCD();<br>
...
<br><a target="_blank" href="tryit.asp?filename=tryxml_app_navigate" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryxml_app">Try it yourself</a>.</p>
<p>For more information about using JavaScript and the XML DOM, visit our <a href="../dom/default.asp">XML 
DOM tutorial.</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_to_html.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_applications.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_applications.asp#top" target="_top">TOP</a> |
		<a href="xml_applications.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
