...
<title>Display XML Data in an HTML Page</title>
<style>a.menu_xml_to_html{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">in HTML</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_dom.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xml_applications.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>Display XML Data in an HTML Page</h2>
<p>In the following example, we open an XML file (&quot;<a target="_blank" href="cd_catalog.xml">cd_catalog.xml</a>&quot;), 
then we loop through each CD element, and display the value of the ARTIST 
element and the TITLE element in an HTML table:</p>
<div class="example">
...
&nbsp; document.write(x[i].getElementsByTagName(&quot;ARTIST&quot;)[0].childNodes[0].nodeValue);<br>
...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a target="_blank" href="tryit.asp?filename=tryxml_display_table" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>For more information about using JavaScript and the XML DOM, visit our 
<a href="../dom/default.asp">XML 
DOM tutorial.</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xml_dom.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xml_to_html.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xml_to_html.asp#top" target="_top">TOP</a> |
		<a href="xml_to_html.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
