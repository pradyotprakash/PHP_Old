...
<title>Maps API getHeading() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_ref_getheading{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Maps API <span class="color_h1">getHeading()</span> Method</h1>
...
<p class="example">Return the compass heading of aerial imagery:</p>
<div class="example_code notranslate">
map.getHeading();</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_ref_getheading">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getHeading() method returns the compass heading of aerial imagery.</p>
<p>The getHeading() method can only be used with map type: SATELLITE or HYBRID 
(which support a 45° perspective imagery view for certain locations, at high 
zoom levels).</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>mapvariable</i>.getHeading();</div></div>
<br>
<hr>
...
<table class="reference notranslate" id="table4">
  <tr>
	...
	<tr>
    <td><i>number</i></td>
    <td>The compass heading in degrees</td>
  </tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_getheading.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_getheading.asp#top" target="_top">TOP</a> |
		<a href="ref_getheading.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
