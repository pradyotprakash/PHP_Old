...
<title>Maps API getMapTypeId() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_ref_getmaptypeid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Maps API <span class="color_h1">getMapTypeId()</span> Method</h1>
...
<p class="example">Return the current map type:</p>
<div class="example_code notranslate">
map.getMapTypeId();</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_ref_getmaptypeid">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getMapTypeId() method returns the current map type.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>mapvariable</i>.getMapTypeId();</div></div>
<br>
<hr>
...
<table class="reference notranslate" id="table4">
  <tr>
	...
	<tr>
    <td>HYBRID</td>
    <td>A photographic map + roads and city names</td>
  </tr>
	<tr>
    <td>ROADMAP</td>
    <td>A normal, default 2D map</td>
  </tr>  <tr>
    <td>SATELLITE</td>
    <td>A photographic map</td>
  </tr>
	<tr>
    <td>TERRAIN</td>
    <td>A map with mountains, rivers, etc.</td>
  </tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_getmaptypeid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_getmaptypeid.asp#top" target="_top">TOP</a> |
		<a href="ref_getmaptypeid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
