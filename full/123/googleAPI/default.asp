...
<title>Google API Tutorial</title>
...
<h1>Google Maps API <span class="color_h1">Tutorial</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="../default.asp">&laquo; W3Schools Home</a></div>
<div class="next"><a class="chapter" href="google_maps_api_key.asp">Next Chapter &raquo;</a></div>
</div>
<br>
<div class="tutintro">
<img src="http://www.w3schools.com/images/w3css.gif" alt="CSS" />
<p>Learn how to create interactive maps using Google Maps API v3.</p>
<p><b><a href="google_maps_api_key.asp">Start learning Google Maps API now!</a></b></p>
</div>
<br>
<hr>
...
<p>An API is a specification used by software components to communicate with each other.</p>
<p>An API may describe the ways in which a particular task is performed.</p>
