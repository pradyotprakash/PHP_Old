...
<title>Maps API getDiv() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_ref_getdiv{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Maps API <span class="color_h1">getDiv()</span> Method</h1>
...
<p class="example">Return the DOM object that contains the map:</p>
<div class="example_code notranslate">
map.getDiv();</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_ref_getdiv">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getDiv() method returns a DOM object that contains the map.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>mapvariable</i>.getDiv();</div></div>
<br>
<hr>
...
<table class="reference notranslate" id="table4">
  <tr>
	...
	<tr>
    <td><i>DOMobject</i></td>
    <td>The DOM object that contains the map</td>
  </tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_getdiv.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_getdiv.asp#top" target="_top">TOP</a> |
		<a href="ref_getdiv.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
