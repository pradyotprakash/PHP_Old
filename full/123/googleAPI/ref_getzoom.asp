...
<title>Maps API getZoom() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_ref_getzoom{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Maps API <span class="color_h1">getZoom()</span> Method</h1>
...
<p class="example">Return the current zoom level of the 
map:</p>
<div class="example_code notranslate">
map.getZoom();</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_ref_getzoom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getZoom() method returns the current zoom level 
of the map.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>mapvariable</i>.getZoom();</div></div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_getzoom.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_getzoom.asp#top" target="_top">TOP</a> |
		<a href="ref_getzoom.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
