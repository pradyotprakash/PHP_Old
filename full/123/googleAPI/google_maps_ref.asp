...
<title>Google Maps Reference</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_google_maps_ref{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Google Maps API <span class="color_h1">Reference</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="google_maps_types.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ref_map.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>Google Maps API Reference</h2>
...
<table class="reference notranslate" id="table1">
  <tr>
	...
	<tr>
    <td><a href="ref_map.asp">Map()</a></td>
    <td>Creates a new map inside a specified HTML element (typically a &lt;div&gt; element)</td>
  </tr>
	</table>
<h2>Overlays</h2>
<table class="reference notranslate" id="table3">
  <tr>
	...
	<tr>
    <td>Marker</td>
    <td>Creates a marker. (Note that the position must be set for the marker to 
	display)</td>
  </tr>
	<tr>
    <td>MarkerOptions</td>
	...
	<tr>
    <td>MarkerShape</td>
    <td>Defines the marker shape to use in determination of a marker's clickable 
	region (type and coord)</td>
  </tr>
	<tr>
    <td>Animation</td>
...
<table class="reference notranslate" id="table5">
  <tr>
    ...
    <td>It has no methods and no constructor. Its instances are returned from 
...
<table class="reference notranslate" id="table4">
  <tr>
    ...
    <td>Specifies what kind of map control to display (Drop-down menu or 
	buttons) </td>
  </tr>  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="google_maps_ref.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="google_maps_ref.asp#top" target="_top">TOP</a> |
		<a href="google_maps_ref.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
