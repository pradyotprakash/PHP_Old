...
<title>Maps API setMapTypeId() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_ref_setmaptypeid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Maps API <span class="color_h1">setMapTypeId()</span> Method</h1>
...
<p class="example">Change the kind of map to display:</p>
<div class="example_code notranslate">
map.setMapTypeId(google.maps.MapTypeId.TERRAIN);</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_ref_setmaptypeid">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The setMapTypeId() method is used to change the kind of map to display.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>mapvariable</i>.setMapTypeId(google.maps.MapTypeId.<i>CONSTANT</i>);</div></div>
<br>
<hr>


<h2>Constants of MapTypeId</h2>
<table class="reference notranslate" id="table4">
  <tr>
	...
	<tr>
    <td>HYBRID</td>
    <td>Displays a photographic map + roads and city names</td>
  </tr>
	<tr>
    <td>ROADMAP</td>
    <td>Displays a normal, default 2D map</td>
  </tr>  <tr>
    <td>SATELLITE</td>
    <td>Displays a photographic map</td>
  </tr>
	<tr>
    <td>TERRAIN</td>
    <td>Displays a map with mountains, rivers, etc.</td>
  </tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_setmaptypeid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_setmaptypeid.asp#top" target="_top">TOP</a> |
		<a href="ref_setmaptypeid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
