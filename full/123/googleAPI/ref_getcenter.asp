...
<title>Maps API getCenter() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_ref_getcenter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Maps API <span class="color_h1">getCenter()</span> Method</h1>
...
<p class="example">Return the latitude/longitude of the current center of the 
map:</p>
<div class="example_code notranslate">
map.getCenter();</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_ref_getcenter">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getCenter() method returns the latitude/longitude of the current center 
of the map.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>mapvariable</i>.getCenter();</div></div>
<br>
<hr>
...
<table class="reference notranslate" id="table4">
  <tr>
    ...
    <td>The latitude/longitude of the current center of the map</td>
  </tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_getcenter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_getcenter.asp#top" target="_top">TOP</a> |
		<a href="ref_getcenter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
