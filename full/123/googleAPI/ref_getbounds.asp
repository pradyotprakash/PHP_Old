...
<title>Maps API getBounds() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_ref_getbounds{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Maps API <span class="color_h1">getBounds()</span> Method</h1>
...
<p class="example">Returns the south-west latitude/longitude and the north-east latitude/longitude 
of the current viewport:</p>
<div class="example_code notranslate">
map.getBounds();</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryhtml_ref_getbounds">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getBounds() method returns the south-west latitude/longitude and the 
north-east latitude/longitude of the current 
viewport.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>mapvariable</i>.getBounds();</div></div>
<br>
<hr>
...
<table class="reference notranslate" id="table4">
  <tr>
	...
	<tr>
    <td>(south-west latitude, longitude),(north-east latitude, longitude)</td>
    <td>Specifies a rectangle from the points at its south-west and north-east 
	corners</td>
  </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ref_getbounds.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ref_getbounds.asp#top" target="_top">TOP</a> |
		<a href="ref_getbounds.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
