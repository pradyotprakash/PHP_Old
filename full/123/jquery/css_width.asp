...
<style>a.menu_css_width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">width()</span> Method</h1>
...
<p>Return the width of a  &lt;div&gt; element:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; alert($(&quot;div&quot;).width());<br>});&nbsp;   
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_css_width_ref">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The width() method sets or returns the width of the selected elements.</p>
<p>When this method is used to <strong>return</strong> width, it returns the width of the FIRST matched element.</p>
<p>When this method is used to <strong>set</strong> width, it sets the width of ALL matched elements.</p>
<p>As the image below illustrates, this method does not include padding, border, or margin. </p>
<p style="text-align:center;"><img border="0" alt="jQuery Dimensions" src="img_width.gif"></p>
<hr>

<p>Related methods:</p>
<ul>
	<li><a href="css_height.asp">height()</a> - Sets or returns the height of an element</li>
...
<p>Set the width:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).width(<i>value</i>)
</div>
</div>

<p>Set the width using a function:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).width(function<i>(index,currentwidth)</i>)
</div>
</div>
<br>
...
<table class="reference notranslate"> 
  <tr>
   ...
   <tr>
    <td><em>value</em></td>
    <td>Required for setting width. Specifies the width in px, em, pt, etc. Default unit is px</td>
  </tr>
  <tr>
    <td>function<i>(index,currentwidth)</i></td>
    <td>Optional. Specifies a function that returns the new width of selected elements<ul>
		<li><i>index</i> - Returns the index position of the element in the set</li>
		<li><i>currentwidth</i> - Returns the current width of the selected element</li>
	</ul></td>
  </tr>
</table>
<br>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_css_width_set_values">Set the width of an element</a><br>
How to set the width of an element using different units.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_css_width_set_func">Decrease the width using a function</a><br>
How to use a function to decrease the width of an element.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_css_width_doc_win">Return the width of the document and window elements</a><br>
How to return the current width of the document and window elements.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_width.asp#top" target="_top">TOP</a> |
		<a href="css_width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
