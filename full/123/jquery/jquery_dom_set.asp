...
<title>jQuery Set Content and Attributes</title>
<style>a.menu_jquery_dom_set{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery - <span class="color_h1">Set Content and Attributes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_dom_get.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_dom_add.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>Set Content - text(), html(), and val()</h2>
<p>We will use the same three methods from the previous page to <b>set content</b>:</p>
<ul>
	<li>text() - Sets or returns the text content of selected elements</li>
	<li>html() - Sets or returns the content of selected elements (including 
	HTML markup)</li>
	<li>val() - Sets or returns the value of form fields</li>
</ul>
<p>The following example demonstrates how to set content with the jQuery text(), html(), 
and val() methods:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;#btn1&quot;).click(function(){<br>
&nbsp; $(&quot;#test1&quot;).text(&quot;Hello world!&quot;);<br>
});<br>
$(&quot;#btn2&quot;).click(function(){<br>
&nbsp; $(&quot;#test2&quot;).html(&quot;&lt;b&gt;Hello world!&lt;/b&gt;&quot;);<br>
});<br>
$(&quot;#btn3&quot;).click(function(){<br>
&nbsp; $(&quot;#test3&quot;).val(&quot;Dolly Duck&quot;);<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_html_set">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>A Callback Function for text(), html(), and val()</h2>
<p>All of the three jQuery methods above: text(), html(), 
...
new value from the function.</p>
<p>The following example demonstrates text() and html() with a callback 
function:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;#btn1&quot;).click(function(){<br>
&nbsp; $(&quot;#test1&quot;).text(function(i,origText){<br>
&nbsp;&nbsp;&nbsp; return &quot;Old text: &quot; + origText + &quot; New text: Hello world!<br>
&nbsp;&nbsp;&nbsp; (index: &quot; + i + &quot;)&quot;; <br>
&nbsp; });<br>
});<br>
<br>
$(&quot;#btn2&quot;).click(function(){<br>
&nbsp; $(&quot;#test2&quot;).html(function(i,origText){<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_html_callback">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Set Attributes - attr()</h2>
<p>The jQuery attr() method is also used to set/change attribute values.</p>
<p>The following example demonstrates how to change (set) the value of the href attribute 
in a link:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; $(&quot;#w3s&quot;).attr(&quot;href&quot;,&quot;http://www.w3schools.com/jquery&quot;);<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_attr_set">Try it yourself &raquo;</a>
</div>
<p>The attr() method also allows you to set multiple attributes at the same 
time.</p>
<p>The following example demonstrates how to set both the href and title attributes 
at the same time:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; $(&quot;#w3s&quot;).attr({<br>
&nbsp;&nbsp;&nbsp; &quot;href&quot; : &quot;http://www.w3schools.com/jquery&quot;,<br>
&nbsp;&nbsp;&nbsp; &quot;title&quot; : &quot;W3Schools jQuery Tutorial&quot;<br>
&nbsp; });<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_attr_set2">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>A Callback Function for attr()</h2>
<p>The jQuery method attr(), also come with a callback function. The callback function has two 
parameters: the index of the current element in the list of elements selected 
and the original (old) attribute value. You then return the string you wish to use as the 
new attribute value from the function.</p>
<p>The following example demonstrates attr() with a callback 
function:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; $(&quot;#w3s&quot;).attr(&quot;href&quot;, function(i,origValue){<br>
&nbsp;&nbsp;&nbsp; return origValue + &quot;/jquery&quot;; <br>
&nbsp; });<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_attr_callback">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_dom_set.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_dom_set.asp#top" target="_top">TOP</a> |
		<a href="jquery_dom_set.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
