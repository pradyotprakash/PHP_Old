...
<style>a.menu_html_innerheight{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">innerHeight()</span> Method</h1>
...
<p>Return the inner height of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>
&nbsp; alert($(&quot;div&quot;).innerHeight());<br>});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_innerheight_ref">Try it yourself &raquo;</a>
...
<p>The innerHeight() method returns the inner height of <span lang="no-bok">the 
FIRST matched element</span>.</p>
<p>As the image below illustrates, this method includes padding, but not border and margin.</p>

<p style="text-align:center;">
<img border="0" alt="jQuery Dimensions" src="img_innerheight.gif"></p>
<hr>
<p>Related methods:</p>
<ul>
    ...
    <li><a href="html_outerheight.asp">outerHeight()</a> - Returns the height of an element (includes padding and border).</li>
...
$(<i>selector</i>).innerHeight()</div></div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_innerheight.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_innerheight.asp#top" target="_top">TOP</a> |
		<a href="html_innerheight.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
