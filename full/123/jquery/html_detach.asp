...
<style>a.menu_html_detach{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">detach()</span> Method</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_detach">Try it yourself &raquo;</a>
...
<p>The detach() method removes the selected elements, 
including all text and child nodes. However, it keeps data and events.</p>
<p>This method also keeps a copy of the removed 
elements, which allows them to be reinserted at a later time.</p>
<p><b>Tip:</b> To remove the elements and its data and events, use the <a href="html_remove.asp">remove()</a> 
method instead.</p>

<p><b>Tip:</b> To remove only the content from the selected elements, use the <a href="html_empty.asp">empty()</a> method.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).detach()</div></div>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_detach_move">
Remove and restore an element</a><br>
How to use the detach() method to remove and restore an element.</p>
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_detach_remove">
Difference between detach() and remove()</a><br>
Show the difference between the detach() and remove() methods.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_detach.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_detach.asp#top" target="_top">TOP</a> |
		<a href="html_detach.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
