...
<style>a.menu_html_wrap{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">wrap()</span> Method</h1>
...
<p>Wrap a &lt;div&gt; element around each &lt;p&gt; element:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_wrap">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The wrap() method wraps specified HTML element(s) around each selected element.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).wrap(<i>wrappingElement</i>,function<i>(index)</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>wrappingElement</em></td>
    <td>Required. Specifies what HTML element(s) to wrap around each selected 
	element<p>Possible values:</p>
	<ul>
		<li>HTML elements</li>
		<li>jQuery objects <br>
		<li>DOM elements</li>
		</ul>
    </td>
  </tr>
  <tr>
    ...
    <td>Optional. Specifies a function that returns the wrapping element
    <ul>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_wrap_element">Create a new element with the DOM</a><br>
How to use document.createElement() to create an element, and wrap it around each selected element.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_wrap_func">Wrap elements using a function</a><br>
Using a function to specify what to wrap around each selected element.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_wrap_unwrap">Wrap and unwrap an element</a><br>
How to toggle between wrapping and unwrapping an element.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_wrap.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_wrap.asp#top" target="_top">TOP</a> |
		<a href="html_wrap.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
