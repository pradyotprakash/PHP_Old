...
<style>a.menu_event_submit{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">submit()</span> Method</h1>
...
<p>Display an alert when a form is submitted:</p>
<div class="example_code notranslate">
  
    $(&quot;form&quot;).submit(function(){<br>&nbsp; alert(&quot;Submitted&quot;);<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_submit">Try it yourself &raquo;</a>
...
<p>This event can only be be used on &lt;form&gt; elements.</p>
<p>The submit() method triggers the submit event, or attaches a function to run 
when a submit event occurs.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the submit event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).submit()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_submit_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the submit event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).submit(<i>function</i>)

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_submit">Try it</a>  
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the submit event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_event_submit_prevent">
Prevent the default action of a submit button</a><br>
How to prevent the form being submitted using the event.preventDefault() method.<br>
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_submit.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_submit.asp#top" target="_top">TOP</a> |
		<a href="event_submit.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
