...
<style>a.menu_event_scroll{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">scroll()</span> Method</h1>
...
<p>Count the number of times the scroll is used for an element:</p>
<div class="example_code notranslate">
  
    $(&quot;div&quot;).scroll(function(){<br>&nbsp; $(&quot;span&quot;).text(x+=1);<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_scroll">Try it yourself &raquo;</a>
...
<p>The scroll event occurs when the user scrolls in the specified element.</p>
<p>The scroll event works for all scrollable elements and the window object 
(browser window).</p>
<p>The scroll() method triggers the scroll event, or attaches a function to run 
when a scroll event occurs.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the scroll event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).scroll()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_scroll_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the scroll event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).scroll(<i>function</i>)

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_scroll">Try it</a>  
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the scroll event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_scroll.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_scroll.asp#top" target="_top">TOP</a> |
		<a href="event_scroll.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
