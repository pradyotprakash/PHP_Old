...
<title>jQuery Get and Set CSS Classes</title>
<style>a.menu_jquery_css_classes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery - <span class="color_h1">Get and Set CSS Classes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_dom_remove.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_css.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p id="test">With jQuery, it is easy to manipulate the CSS of elements. <button id="btnEx">Toggle class</button></p>
<hr>
<h2>jQuery Manipulating CSS</h2>
<p>jQuery has several methods for CSS manipulation. We will look at the 
following methods:</p>
<ul>
...
<p>The following stylesheet will be used for all the examples on this page:</p>
...
<p>The following example shows how to add class attributes to different 
elements. Of course you can select multiple elements, when adding classes:</p>
<div class="example">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_addclass">Try it yourself &raquo;</a>
</div>
<p>You can also specify multiple classes within the addClass() method:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_addclass2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery removeClass() Method</h2>
<p>The following example shows how to remove a specific class attribute from different 
elements:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_removeclass">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery toggleClass() Method</h2>
<p>The following example will show how to use the jQuery toggleClass() method. 
This method toggles between adding/removing classes from the selected elements:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_toggleclass">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery css() Method</h2>
<p>The jQuery css() method will be explained in the next chapter.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_css_classes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_css_classes.asp#top" target="_top">TOP</a> |
		<a href="jquery_css_classes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
