...
<style>a.menu_traversing_contents{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">contents()</span> Method</h1>
...
<p>Find all the text nodes inside a &lt;div&gt; element and wrap them with a &lt;b&gt; element:</p>
<div class="example_code notranslate">
  
    $("div").contents().filter("em").wrap("&lt;b/&gt;");</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_contents">Try it yourself &raquo;</a>
...
<p>The contents() method returns all direct children, 
including text and comment nodes, of the 
selected element.</p>
<p>A text node is the actual text displayed by an element.</p>
<p>This method is similar to the <a href="traversing_children.asp">children()</a> 
method, except that it returns text and comment nodes as well. The contents() 
method can also access the HTML of an iframe, if it is in the same domain.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).contents()</div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_contents.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_contents.asp#top" target="_top">TOP</a> |
		<a href="traversing_contents.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
