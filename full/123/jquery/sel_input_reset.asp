...
<style>a.menu_sel_input_reset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:reset</span> Selector</h1>
...
<p>Select &lt;input&gt; and &lt;button&gt; elements with type=&quot;reset&quot;:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_reset">Try it yourself &raquo;</a>
...
<p>The :reset selector selects button and input elements with type=reset.</p>
<p><b>Tip:</b> Using input:reset as a selector will not select the 
button element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_input_reset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_input_reset.asp#top" target="_top">TOP</a> |
		<a href="sel_input_reset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
