...
<style>a.menu_event_toggle{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Toggle between colors when clicking on a &lt;p&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).toggle(<br>&nbsp; function(){$(&quot;p&quot;).css({&quot;color&quot;:&quot;red&quot;});},<br>&nbsp; 
	function(){$(&quot;p&quot;).css({&quot;color&quot;:&quot;blue&quot;});},<br>&nbsp; function(){$(&quot;p&quot;).css({&quot;color&quot;:&quot;green&quot;});<br>});</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_toggle" target="_blank">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The toggle() method was <a href="javascript:NewWindow('deprecated.htm')">deprecated</a> in jQuery version 1.8, 
and removed in version 1.9.</span></p>
<p>The toggle() method attaches two or more functions to toggle between for the click 
event for the selected elements.</p>
<p>When clicking on an element, the first specified function fires, when 
clicking again, the second function fires, and so on.</p>
<p><strong>Note:</strong> There is also a <a href="jquery_ref_effects.asp">jQuery Effects</a> 
method called toggle(). Which one is called, depends on the parameters. </p>
<hr>
...
<div class="code notranslate"><div>
    ...
    $(<i>selector</i>).trigger(<em>function</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. A function to run every time the selected element is clicked</td>
  </tr>
...
<p><a href="tryit.asp?filename=tryjquery_event_toggle_multiple" target="_blank">
Toggle between multiple functions</a><br>
How to toggle between multiple functions.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_toggle.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_toggle.asp#top" target="_top">TOP</a> |
		<a href="event_toggle.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
