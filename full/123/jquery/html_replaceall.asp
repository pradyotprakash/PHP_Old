...
<style>a.menu_html_replaceall{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">replaceAll()</span> Method</h1>
...
<p>Replace all &lt;p&gt; elements with &lt;h2&gt; elements:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>
	&nbsp;&nbsp; $(&quot;&lt;h2&gt;Hello world!&lt;/h2&gt;&quot;).replaceAll(&quot;p&quot;);<br>
	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_replaceall">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The replaceAll() method replaces selected elements with new HTML elements.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>content</i>).replaceAll(<i>selector</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>content</em></td>
    <td>Required. Specifies the content to insert (must contain HTML tags)</td>
  </tr>
	<tr>
    <td><em>selector</em></td>
    <td>Required. Specifies which elements to be replaced</td>
  </tr>
</table>
<br>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjquery_html_replaceall2" target="_blank">Replace 
every &lt;p&gt; element that is the last child</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_replaceall.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_replaceall.asp#top" target="_top">TOP</a> |
		<a href="html_replaceall.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
