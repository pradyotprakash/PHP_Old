...
<style>a.menu_event_mouseover{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">mouseover()</span> Method</h1>
...
<p>Set the background color to yellow, when the mouse pointer is over a &lt;p&gt; 
element:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).mouseover(function(){<br>&nbsp; $(&quot;p&quot;).css(&quot;background-color&quot;,&quot;yellow&quot;);<br>	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_mouseover_mouseout" target="_blank">Try it yourself &raquo;</a>
...
<p>The mouseover event occurs when the mouse pointer is over the selected 
element.</p>
<p>The mouseover() method triggers the mouseover event, or attaches a function 
to run when a mouseover event occurs.</p>
<p><b>Note:</b> Unlike the <a href="event_mouseenter.asp">mouseenter</a> event, the mouseover event triggers if 
a mouse pointer enters any child elements as well as the selected element. The mouseenter 
...
<p><strong>Tip:</strong> This event is often used together with the <a href="event_mouseout.asp">
mouseout</a> event.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the mouseover event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mouseover()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_mover_mout_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the mouseover event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mouseover(<i>function</i>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the mouseover event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
The difference between mouseover() and mouseenter()</a><br>
Demonstrates the difference between mouseover() and mouseenter().</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_mouseover.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_mouseover.asp#top" target="_top">TOP</a> |
		<a href="event_mouseover.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
