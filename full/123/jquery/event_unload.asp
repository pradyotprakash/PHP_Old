...
<style>a.menu_event_unload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">unload()</span> Method</h1>
...
<p>Alert a message when navigating away from the page:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_unload">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The unload() method was <a href="javascript:NewWindow('deprecated.htm')">deprecated</a> 
 in jQuery version 1.8.</span></p>

<p>The unload event occurs when the user navigates away from the page.</p>
<p>The unload event is triggered when:</p>
<ul>
	<li>a link to leave the page is clicked</li>
	<li>a new URL is typed in the address bar</li>
	<li>the forward or back buttons are used</li>
	<li>the browser window is closed</li>
	<li>the page is reloaded</li>
</ul>
<p>The unload() method specifies what happens when a unload event occurs.</p>
<p>The unload() method should only be used on the window object.</p>
<p><strong>Note:</strong> The unload event might work differently in different 
browsers. Be sure to test this method in all browsers, before use.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).unload(<i>function</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the unload event is 
	triggered</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_unload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_unload.asp#top" target="_top">TOP</a> |
		<a href="event_unload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
