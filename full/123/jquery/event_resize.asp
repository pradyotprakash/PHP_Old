...
<style>a.menu_event_resize{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">resize()</span> Method</h1>
...
<p>Count the number of times the browser window is resized:</p>
<div class="example_code notranslate">
  
    $(window).resize(function(){<br>&nbsp; $('span').text(x+=1);<br>	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_resize" target="_blank">Try it yourself &raquo;</a>
...
<p>The resize event occurs when the browser window changes size.</p>
<p>The resize() method triggers the resize event, or attaches a function to run 
when a resize event occurs.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the resize event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).resize()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_resize_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the reisize event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).resize(<i>function</i>)

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_resize">Try it</a>  
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the resize event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_resize.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_resize.asp#top" target="_top">TOP</a> |
		<a href="event_resize.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
