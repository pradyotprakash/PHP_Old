...
<style>a.menu_html_removeattr{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">removeAttr()</span> Method</h1>
...
<p>Remove the style attribute from all &lt;p&gt; elements:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;p&quot;).removeAttr(&quot;style&quot;);<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_removeattr">Try it yourself &raquo;</a>
...
<p>The removeAttr() method removes one or more attributes from the selected 
elements.</p>
...
$(<i>selector</i>).removeAttr(<i>attribute</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies one or more attributes to remove. To remove several 
	attributes, separate the attribute names with a space</td>
  </tr>
  </table>
<br>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_removeattr_id">
Remove several attributes from the selected elements</a><br>
How to remove the id and class attribute from the selected elements.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_removeattr.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_removeattr.asp#top" target="_top">TOP</a> |
		<a href="html_removeattr.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
