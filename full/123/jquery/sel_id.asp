...
<style>a.menu_sel_id{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">#id</span> Selector</h1>
...
<p>Select the element with the id &quot;intro&quot;:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_id">Try it yourself &raquo;</a>
...
<p>The #id selector selects the element with the specific id.</p>
<p>The id refers to the id attribute of an HTML element.</p>
<p><strong>Note:</strong> The id attribute must be unique within a document.</p>
<p><b>Note:</b> Do not start an id attribute with a number. It may cause problems in 
some browsers.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>id</em></td>
    <td>Required. Specifies the id of the element to select<br>
	  </td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_id.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_id.asp#top" target="_top">TOP</a> |
		<a href="sel_id.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
