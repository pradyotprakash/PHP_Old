...
<style>a.menu_event_change{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">change()</span> Method</h1>
...
<p>Alert a text when an &lt;input&gt; field is changed:</p>
<div class="example_code notranslate">
  
    $(&quot;input&quot;).change(function(){<br>&nbsp; alert(&quot;The text has been changed.&quot;);<br>
	});</div>
<br><a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_change_ref">Try it yourself &raquo;</a>
...
<p>The change event occurs when the value of an element is changed (only works 
on form fields).</p>
<p>The change() method triggers the change event, or attaches a function to run when 
a change event occurs.</p>
<p><b>Note:</b> For select menus, the change event occurs when an 
option is selected. For text fields or text areas, the change event occurs 
when the field loses focus.</p>

<hr>

<h2>Syntax</h2>
<p>Trigger the change event for the selected elements:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).change() <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_change_trigger">Try it</a></div>
</div>
<p>Attach a function to the change event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).change(<i>function</i>) <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_change">Try it</a></div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the change event occurs for 
	the selected elements</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_change.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_change.asp#top" target="_top">TOP</a> |
		<a href="event_change.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
