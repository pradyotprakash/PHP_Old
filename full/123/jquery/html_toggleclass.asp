...
<style>a.menu_html_toggleclass{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">toggleClass()</span> Method</h1>
...
<p>Toggle between adding and removing the &quot;main&quot; class name for all &lt;p&gt; elements:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;p&quot;).toggleClass(&quot;main&quot;);<br>	});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_toggleclass">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The toggleClass() method toggles between adding and removing one or more class names from the selected elements.</p>
<p>This method checks each element for the specified class names. The class names are 
added if missing, and removed if already set - This creates a toggle effect.</p>
<p>However, by using the &quot;switch&quot; parameter, you can specify to only remove, or only add a class name.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).toggleClass(<i>classname,</i>function<i>(index,currentclass),switch</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies one or more class names to add or remove.
	To specify several classes, separate the class names with a space</td>
  </tr>
  <tr>
    <td>function<i>(index,currentclass)</i></td>
    <td>Optional. Specifies a function that returns one or more class names to add/remove<ul>
		<li><i>index</i> - Returns the index position of the element in the set</li>
		<li><i>currentclass</i> - Returns current class name of selected elements</li>
	</ul></td>
    </tr>
  <tr>
    <td><em>switch</em></td>
    <td>Optional. A Boolean value specifying if the class should only be added (true), or only be removed (false)</td>
  </tr>
</table>
<br>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_toggleclass_2">Toggle between adding and removing a class name</a> <br>
How to use the toggleClass() method to toggle between adding and removing a class name.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_toggleclass_func">Toggle classes using a function</a><br>
Using a function to specify which class names should be toggled for the selected elements.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_toggleclass_switch">Using the switch parameter</a><br>
How to use the switch parameter to only add or remove a class name.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_toggleclass.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_toggleclass.asp#top" target="_top">TOP</a> |
		<a href="html_toggleclass.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
