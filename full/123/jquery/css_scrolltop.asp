...
<style>a.menu_css_scrolltop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">scrollTop()</span> Method</h1>
...
<p>Return the vertical scrollbar position for a &lt;div&gt; element:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>&nbsp;&nbsp; alert($(&quot;div&quot;).scrollTop());<br>
});
</div>
<br>
<a class="tryitbtn" target="_blank" href="tryit.asp?filename=tryjquery_css_scrolltop_get">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The scrollTop() method sets or returns the vertical scrollbar position for the selected elements.</p>
<p><b>Tip:</b> When the scrollbar is on the top, the position is 0.</p>
<p><strong>When used to return the position:</strong><br>
This method returns the vertical position of the scrollbar for the FIRST matched element.</p>
<p><strong>When used to set the position:</strong><br>
This method sets the vertical position of the scrollbar for ALL matched elements.</p>
<hr>

<h2>Syntax</h2>
<p>Return vertical scrollbar position:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).scrollTop()</div>
</div>

<p>Set vertical scrollbar position:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).scrollTop(<em>position</em>)</div>
</div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Specifies the vertical scrollbar position in pixels</td>
  </tr>
</table>
<br>
<hr>
...
<p><a href="tryit.asp?filename=tryjquery_css_scrolltop_set" target="_blank">Set the vertical scrollbar position</a><br>
How to set the vertical scrollbar position for an element.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_scrolltop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_scrolltop.asp#top" target="_top">TOP</a> |
		<a href="css_scrolltop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
