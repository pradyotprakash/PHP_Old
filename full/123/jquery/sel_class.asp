...
<style>a.menu_sel_class{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">.class</span> Selector</h1>
...
<p>Select all elements with class &quot;intro&quot;:</p>
<div class="example_code notranslate">  
    $(".intro")  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_class">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The .class selector selects all elements with the specific class.</p>
<p>The class refers to the class attribute of an HTML element.</p>
<p>The class attribute is used to set a particular style for several HTML 
elements.</p>
<p><b>Note:</b> Do not start a class attribute with a number. It may cause problems in 
some browsers.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>class</em></td>
    <td>Required. Specifies the class of the elements to select</td>
  </tr>
  </table>
  <br>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjquery_sel_class_element" target="_blank">Select all 
p elements with class "intro"</a><br>
How to select all p elements with class "intro".</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_class.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_class.asp#top" target="_top">TOP</a> |
		<a href="sel_class.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
