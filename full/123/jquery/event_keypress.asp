...
<style>a.menu_event_keypress{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">keypress()</span> Method</h1>
...
<p>Count the number of key presses in an &lt;input&gt; field:</p>
<div class="example_code notranslate">
  
    $(&quot;input&quot;).keypress(function(){<br>&nbsp; $(&quot;span&quot;).text(i+=1);<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_keypress">Try it yourself &raquo;</a>
...
<p>The order of events related to the keypress event:</p>
<ol>
	<li><a href="event_keydown.asp">keydown</a> - The key is on its way down</li>
	<li>keypress - The key is pressed down</li>
	<li><a href="event_keyup.asp">keyup</a> - The key is released</li>
</ol>
<p>The keypress() method triggers the keypress event, or attaches a function to 
run when a keypress event occurs.</p>
<p>The keypress event is similar to the keydown event. The event occurs when a 
button is pressed down. </p>
<p>However, the keypress event is not fired for all keys (e.g. ALT, CTRL, SHIFT, 
ESC). Use the keydown() method to also check these keys.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the keypress event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).keypress()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_keypress_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the keypress event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).keypress(<i>function</i>)

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_keypress">Try it</a>  
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the keypress event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_keypress.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_keypress.asp#top" target="_top">TOP</a> |
		<a href="event_keypress.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
