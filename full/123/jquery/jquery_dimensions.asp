...
<style>a.menu_jquery_dimensions{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery - <span class="color_h1">Dimensions</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_css.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_traversing.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">With jQuery, it is easy to work with the dimensions of elements and browser window.</p>
<hr>
<h2>jQuery Dimension Methods</h2>
<p>jQuery has several important methods for working with dimensions:</p>
<ul>
	<li>width()</li>
	<li>height()</li>
	<li>innerWidth()</li>
...
<img alt="jQuery Dimensions" src="img_jquerydim.gif" width="488" height="340"></p>

<hr>
<h2>jQuery width() and height() Methods</h2>

<p>The width() method sets or returns the width of an element (includes NO 
padding, border, or margin).</p>

<p>The height() method sets or returns the height of an element (includes NO 
padding, border, or margin).</p>
<p>The following example returns the width and height of a specified &lt;div&gt; 
element:</p>
<div class="example">
...
&nbsp; var txt=&quot;&quot;;<br>
&nbsp; txt+=&quot;Width: &quot; + $(&quot;#div1&quot;).width() + &quot;&lt;/br&gt;&quot;;<br>
&nbsp; txt+=&quot;Height: &quot; + $(&quot;#div1&quot;).height();<br>
&nbsp; $(&quot;#div1&quot;).html(txt);<br>
});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dim_width_height">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery innerWidth() and innerHeight() Methods</h2>
...
<p>The following example returns the inner-width/height of a specified &lt;div&gt; 
element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; var txt=&quot;&quot;;<br>
&nbsp; txt+=&quot;Inner width: &quot; + $(&quot;#div1&quot;).innerWidth() + &quot;&lt;/br&gt;&quot;;<br>
&nbsp; txt+=&quot;Inner height: &quot; + $(&quot;#div1&quot;).innerHeight();<br>
&nbsp; $(&quot;#div1&quot;).html(txt);<br>
});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dim_innerwidth_height">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>jQuery outerWidth() and outerHeight() Methods</h2>

<p>The outerWidth() method returns the width of an element (includes padding and 
border).</p>

<p>The outerHeight() method returns the height of an element (includes padding 
and border).</p>
<p>The following example returns the outer-width/height of a specified &lt;div&gt; 
element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; var txt=&quot;&quot;;<br>
&nbsp; txt+=&quot;Outer width: &quot; + $(&quot;#div1&quot;).outerWidth() + &quot;&lt;/br&gt;&quot;;<br>
&nbsp; txt+=&quot;Outer height: &quot; + $(&quot;#div1&quot;).outerHeight();<br>
&nbsp; $(&quot;#div1&quot;).html(txt);<br>
});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dim_outerwidth_height">
Try it yourself &raquo;</a>
</div>

<p>The outerWidth(true) method returns the width of an element (includes 
padding, border, and margin).</p>

<p>The outerHeight(true) method returns the height of an element (includes 
padding, border, and margin).</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; var txt=&quot;&quot;;<br>
&nbsp; txt+=&quot;Outer width (+margin): &quot; + $(&quot;#div1&quot;).outerWidth(true) + &quot;&lt;/br&gt;&quot;;<br>
&nbsp; txt+=&quot;Outer height (+margin): &quot; + $(&quot;#div1&quot;).outerHeight(true);<br>
&nbsp; $(&quot;#div1&quot;).html(txt);<br>
});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dim_outerwidth_height2">
Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>jQuery More width() and height()</h2>

<p>The following example returns the width and height of the document (the HTML 
document) and window (the browser viewport):</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; var txt=&quot;&quot;;<br>
&nbsp; txt+=&quot;Document width/height: &quot; + $(document).width();<br>
&nbsp; txt+=&quot;x&quot; + $(document).height() + &quot;\n&quot;;<br>
&nbsp; txt+=&quot;Window width/height: &quot; + $(window).width();<br>
&nbsp; txt+=&quot;x&quot; + $(window).height();<br>
&nbsp; alert(txt);<br>
});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dim_width_height2">Try it yourself &raquo;</a>
</div>
<p>The following example sets the width and height of a specified &lt;div&gt; 
element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dim_width_height_set">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>jQuery CSS Reference</h2>
<p>For a complete overview of all jQuery CSS methods, please go to our <a href="jquery_ref_html.asp">jQuery HTML/CSS Reference</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_dimensions.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_dimensions.asp#top" target="_top">TOP</a> |
		<a href="jquery_dimensions.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
