...
<style>a.menu_jquery_traversing_ancestors{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Traversing - <span class="color_h1">Ancestors</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_traversing.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_traversing_descendants.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An ancestor is a parent, grandparent, great-grandparent, and so 
on.</p>
<p class="intro">With jQuery you can traverse up the DOM tree to 
find ancestors of an element.</p>
<hr>
<h2>Traversing Up the DOM Tree</h2>
<p>Three useful jQuery methods for traversing up the DOM tree are:</p>
<ul>
	<li>parent()</li>
	<li>parents()</li>
	<li>parentsUntil()</li>
...
<hr>
<h2>jQuery parent() Method</h2>
<p>The parent() method returns the direct parent element of the selected 
	element.</p>
<p>This method only traverse a single level up the DOM tree.</p>
<p>The following example returns the direct parent element of each &lt;span&gt; 
elements:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;span&quot;).parent();<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_parent">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery parents() Method</h2>
<p>The parents() method returns all ancestor elements of the selected element, 
all the way up to the document's root element (&lt;html&gt;).</p>
<p>The following example returns all&nbsp;ancestors of all 
&lt;span&gt; elements:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;span&quot;).parents();<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_parents">Try it yourself &raquo;</a>
</div>
<p>You can also use an optional parameter to filter the search for ancestors.</p>
<p>The following example returns all ancestors of all &lt;span&gt; elements that are &lt;ul&gt; 
elements:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;span&quot;).parents(&quot;ul&quot;);<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_parents2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery parentsUntil() Method</h2>
<p>The parentsUntil() method returns all ancestor elements between two given 
arguments.</p>
<p>The following example returns all&nbsp;ancestor elements 
between a &lt;span&gt; and a &lt;div&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;span&quot;).parentsUntil(&quot;div&quot;);<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_parentsuntil">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_traversing_ancestors.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_traversing_ancestors.asp#top" target="_top">TOP</a> |
		<a href="jquery_traversing_ancestors.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
