...
<style>a.menu_sel_input_submit{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:submit</span> Selector</h1>
...
<p>Select &lt;input&gt; and &lt;button&gt; elements with type=&quot;submit&quot;:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_submit">Try it yourself &raquo;</a>
...
<p>The :submit selector selects button and input elements with type=submit.</p>
<p>If a button element has no defined type, most browsers will use it as a 
button with type=submit.</p>
<p><b>Tip:</b> Using input:submit as a selector will not select the 
button element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_input_submit.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_input_submit.asp#top" target="_top">TOP</a> |
		<a href="sel_input_submit.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
