...
<style>a.menu_sel_last{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:last</span> Selector</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_last">Try it yourself &raquo;</a>
...
<p>The :last selector selects the last element.</p>
<p><strong>Note:</strong> This selector can only select one single element. Use 
the <a href="sel_lastchild.asp">:last-child</a> selector to select more than one 
element (one for each parent). </p>
<p>This is mostly used together with another selector to select the 
last 
element in a group (like in the example above).</p>
<p><strong>Tip:</strong> To select the first element in a group, use the <a href="sel_first.asp">:first</a> selector.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_last.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_last.asp#top" target="_top">TOP</a> |
		<a href="sel_last.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
