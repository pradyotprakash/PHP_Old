...
<title>jQuery Misc param() Method</title>
<style>a.menu_misc_param{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Misc <span class="color_h1">param()</span> Method</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_param">Try it yourself &raquo;</a>
...
<p>The param() method creates a serialized representation of an array or an 
object.</p>
<p>The serialized values can be used in the URL query string when making an AJAX 
request.</p>
...
<table class="reference notranslate"> 
  <tr>
	...
	<tr>
    <td><em>trad</em></td>
    <td>Optional. A Boolean value specifying whether or not to use the traditional style 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="misc_param.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="misc_param.asp#top" target="_top">TOP</a> |
		<a href="misc_param.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
