...
<style>a.menu_eff_stop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">stop()</span> Method</h1>
...
<p>Stop the currently running animation:</p>
<div class="example_code notranslate">
  
    $(&quot;#stop&quot;).click(function(){<br>&nbsp; $(&quot;div&quot;).stop();<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_stop">Try it yourself &raquo;</a>
...
<p>The stop() method stops the currently running animation for the selected elements.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>stopAll</em></td>
    <td>Optional. A Boolean value specifying whether or not to stop the queued 
	animations as well. Default is false</td>
  </tr>
  <tr>
    <td><em>goToEnd</em></td>
    <td>Optional. A Boolean value specifying whether or not to complete all 
	animations immediately. Default is false</td>
  </tr>
  </table>
  &nbsp;<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_eff_stop_queue">Stop 
queued animations as well</a><br>
How to stop the queued animations.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_eff_stop_queue_end">
Complete all animations immediately</a><br>
How to complete all 
animations immediately.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_stop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_stop.asp#top" target="_top">TOP</a> |
		<a href="eff_stop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
