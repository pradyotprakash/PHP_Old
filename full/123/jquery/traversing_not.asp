...
<style>a.menu_traversing_not{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">not()</span> Method</h1>
...
<p>Return all &lt;p&gt; elements that do <strong>not</strong> have the class 
name &quot;intro&quot;:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).not(&quot;.intro&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_not">Try it yourself &raquo;</a>
...
<p>The not() method returns elements that do not match a certain criteria.</p>
<p>This method lets you specify a criteria. Elements that do not match the 
criteria are returned from the selection, and those that match will be removed.</p>
<p>This method is often used to remove one or more elements from a group of selected elements.</p>
<p><strong>Tip:</strong> The not() method is the opposite of the
<a href="traversing_filter.asp">filter()</a> method.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).not(<em>criteria,</em>function<em>(index)</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>criteria</i></td>
    <td>Optional. Specifies a selector expression, a jQuery object or one or 
	more elements to be removed from a group of selected elements.<br><br>
	<strong>Tip:</strong> To specify multiple criteria, use comma.</td>
  </tr>
<tr>
    <td>function(<em>index</em>)</td>
    <td>Optional. Specifies a function to run for each element in a group. If it 
	returns true, the element is removed. Otherwise, the element is kept.<ul>
		<li><i>index</i> - The index position of the element in the set</li>
	</ul>
	<strong>Note:</strong> <em>this</em> is the current DOM element.</td>
</tr>
</table>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_traversing_not_even" target="_blank">
Return 
all &lt;p&gt; elements that are not even</a><br>
Using the :even selector together with not() to return 
all &lt;p&gt; elements that are not even.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_not_multiple" target="_blank">
Multiple criteria</a><br>
How to 
return all &lt;p&gt; elements that do not have the class &quot;intro&quot; and id &quot;outro&quot;.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_not_obj" target="_blank">Using 
a jQuery object</a><br>
How to return all &lt;p&gt; elements that do not have the class &quot;intro&quot; inside of a 
&lt;div&gt; element, with a jQuery object.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_not_dom" target="_blank">DOM</a><br>
How 
to return all &lt;p&gt; elements that do not have the id &quot;intro&quot;, with a DOM element.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_not_func" target="_blank">
Using a function</a><br>
How use a function to select all &lt;p&gt; elements that do not have two &lt;span&gt; elements 
inside of them.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_not.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_not.asp#top" target="_top">TOP</a> |
		<a href="traversing_not.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
