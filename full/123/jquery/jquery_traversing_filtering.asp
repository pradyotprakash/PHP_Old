...
<title>jQuery Traversing Filtering Selections</title>
<style>a.menu_jquery_traversing_filtering{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Traversing - <span class="color_h1">Filtering</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_traversing_siblings.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_ajax_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>Narrow Down The Search For Elements</h2>
<p>The three most basic filtering methods are first(), last() and eq(), which 
allow you to select a specific element based on its position in a group of 
elements. </p>
<p>Other filtering methods, like filter() and not() allow you to select elements 
that match, or not match, a certain criteria. </p>
<hr>
<h2>jQuery first() Method</h2>
<p>The first() method returns the first element of the selected elements.</p>
<p>The following example selects the first &lt;p&gt; element inside the first &lt;div&gt; 
element:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;div p&quot;).first();<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_first">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery last() Method</h2>
<p>The last() method returns the last element of the selected elements.</p>
<p>The following example selects the last &lt;p&gt; element inside the last &lt;div&gt; 
element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;div p&quot;).last();<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_last">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery eq() method</h2>
<p>The eq() method returns an element with a specific index number of the 
selected elements.</p>
<p>The index numbers start at 0, so the first element will have the index number 
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;p&quot;).eq(1);<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eq">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery filter() Method</h2>
<p>The filter() method lets you specify a criteria. Elements that do not match 
the criteria are removed from the selection, and those that match will be 
returned.</p>
<p>The following example returns all &lt;p&gt; elements with class name &quot;intro&quot;:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;p&quot;).filter(".intro");<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_filter">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery not() Method</h2>
<p>The not() method returns all elements that do not match the criteria.</p>
<p><strong>Tip:</strong> The not() method is the opposite of filter().</p>
<p>The following example returns all &lt;p&gt; elements that do not have class name 
&quot;intro&quot;:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;p&quot;).not(".intro");<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_not">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_traversing_filtering.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_traversing_filtering.asp#top" target="_top">TOP</a> |
		<a href="jquery_traversing_filtering.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
