...
<h1>jQuery <span class="color_h1">event.type</span> Property</h1>
...
<p>Return which event type was triggered:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_type" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.type property returns which event type was triggered.</p>
