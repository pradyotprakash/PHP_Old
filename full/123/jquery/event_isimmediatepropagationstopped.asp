...
<style>a.menu_event_isimmediatepropagationstopped{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.isImmediatePropagationStopped()</span> Method</h1>
...
<p>Check if event.stopImmediatePropagation() was called:</p>
<div class="example_code notranslate">
  
    $(&quot;div&quot;).click(function(event){<br>&nbsp; 
	event.stopImmediatePropagation();<br>&nbsp; alert(event.isImmediatePropagationStopped());<br>});<br></div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_isimmediatepropstopped" target="_blank">Try it yourself &raquo;</a>
...
<p>This method checks whether the <a href="event_stopimmediatepropagation.asp">event.stopImmediatePropagation()</a> 
was called for the event.</p>
<p>This method returns true if event.stopImmediatePropagation() is called, and 
false if not. </p>
...
<i>event</i>.isImmediatePropagationStopped()
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_isimmediatepropagationstopped.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_isimmediatepropagationstopped.asp#top" target="_top">TOP</a> |
		<a href="event_isimmediatepropagationstopped.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
