...
<style>a.menu_event_click{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">click()</span> Method</h1>
...
<p>Click on a &lt;p&gt; element to alert a text:</p>
<div class="example_code notranslate">
    $(&quot;p&quot;).click(function(){<br>&nbsp; alert(&quot;The paragraph was clicked.&quot;);<br>
	});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_click">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The click event occurs when an element is clicked. </p>
<p>The click() method triggers the click event, or attaches a function to run when a click event occurs.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the click event for the selected elements:</p>
<div class="code notranslate"><div>
    $(<i>selector</i>).click()
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_click_trigger">Try it</a>
</div>
</div>

<p>Attach a function to the click event:</p>
<div class="code notranslate"><div>
    $(<i>selector</i>).click(<i>function</i>)
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_click_func">Try it</a>
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the click event occurs</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_click.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_click.asp#top" target="_top">TOP</a> |
		<a href="event_click.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
