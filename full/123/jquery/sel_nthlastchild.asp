...
<style>a.menu_sel_nthlastchild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:nth-last-child()</span> Selector</h1>
...
<p>Select each &lt;p&gt; element that is the third child of its parent, 
counting from the last child:</p>
<div class="example_code notranslate">
  
    $(&quot;p:nth-last-child(3)&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_nthlastchild">Try it yourself &raquo;</a>
...
<p>The :nth-last-child(<em>n</em>) selector selects all elements that are the <em>n</em>th child, 
regardless of type, 
of 
their parent, counting from the last child.</p>
<p><strong>Tip:</strong> Use the <a href="sel_nthlastoftype.asp">:nth-last-of-type()</a> selector to select all 
elements that are the <em>n</em>th child, <strong>of a particular type</strong>, 
of 
their parent, counting from the last child.</p>
...
<div class="code notranslate"><div>
	:nth-last-child(<em>n</em>|even|odd|<em>formula</em>)</div></div>
  <br>
...
<p><a href="tryit.asp?filename=tryjquery_sel_nthlastchild2" target="_blank">
Select each &lt;p&gt; element that is the first child of all &lt;div&gt; element, counting from the last 
child</a><br>
How to select 
a &lt;p&gt; element that is the first child of all &lt;div&gt; elements, counting from 
the last child.</p>

<p><a href="tryit.asp?filename=tryjquery_sel_nthlastchild_formula" target="_blank">Using a 
formula (an + b)</a><br>
How to use a formula (<em>an</em> + <em>b</em>) to select different child elements, 
counting from the last child.</p>

<p><a href="tryit.asp?filename=tryjquery_sel_nthlastchild_evenodd" target="_blank">Using 
&quot;even&quot; and &quot;odd&quot;</a><br>
How to use even and odd to select different child elements, counting from the 
last child.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_nthlastchild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_nthlastchild.asp#top" target="_top">TOP</a> |
		<a href="sel_nthlastchild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
