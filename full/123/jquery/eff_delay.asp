...
<title>jQuery Effect delay() Method</title>
<style>a.menu_eff_delay{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">delay()</span> Method</h1>
...
<p>Delay different &lt;div&gt; elements:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_delay" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
$(<i>selector</i>).delay(<i>speed,queueName</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>speed</em></td>
    <td>Optional. Specifies the speed of the delay<p>Possible values:</p>
	<ul>
		<li>milliseconds</li>
		<li>&quot;slow&quot;</li>
		<li>&quot;fast&quot;</li>
  ...
  <tr>
    ...
    <td>Optional. Specifies the name of the queue<br><br>
...
<p><a href="tryit.asp?filename=tryjquery_eff_delay2" target="_blank">delay() and animate()</a><br>
How to delay an animation.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_delay.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_delay.asp#top" target="_top">TOP</a> |
		<a href="eff_delay.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
