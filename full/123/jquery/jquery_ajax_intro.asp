...
<style>a.menu_jquery_ajax_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery - <span class="color_h1">AJAX Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_traversing_filtering.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_ajax_load.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">AJAX is the art of exchanging data with a server, and updating 
parts of a web page - without reloading the whole page.</p>
<div class="example">
<h2 class="example">jQuery AJAX Example</h2>
<div class="example_code notranslate">
<div id="div1"><h2>Let jQuery AJAX Change This Text</h2></div>
<button id="btn1" type="button">Get External Content</button>
</div>
<br>
<a target="_blank" href="tryit.asp?filename=tryjquery_ajax_load" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>In short; AJAX is about loading data in the background and display it on the 
webpage, without reloading the whole page.</p>
<p>Examples of applications using AJAX: Gmail, Google Maps, Youtube, and 
Facebook tabs.</p>
<p>You can learn more about AJAX in our <a href="../ajax/default.asp">AJAX 
tutorial</a>.<br>
</p>
<hr>
<h2>What About jQuery and AJAX?</h2>
<p>jQuery provides several methods for AJAX functionality.</p>
<p>With the jQuery AJAX methods, you can request text, HTML, XML, or JSON from a remote 
...
<td><b>Without jQuery, AJAX coding can be a bit tricky!</b><br><br>
...
for us, so that we can write AJAX functionality with only one single line of code.</td>
</tr></table>
<br>
<hr>

<h2>jQuery AJAX Methods</h2>
<p>In the next chapters we will look at the most important jQuery AJAX methods.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_ajax_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_ajax_intro.asp#top" target="_top">TOP</a> |
		<a href="jquery_ajax_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
