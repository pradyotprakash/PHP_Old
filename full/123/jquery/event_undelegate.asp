...
<style>a.menu_event_undelegate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">undelegate()</span> Method</h1>
...
<p>Remove all event handlers added with the delegate() method from all elements:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_undelegate" target="_blank">Try it yourself &raquo;</a>
...
<p>The undelegate() method removes one or more event handlers, added with the
<a href="event_delegate.asp">delegate()</a> method.</p>
...
$(<i>selector</i>).undelegate(<i>selector,event,function</i>)
...
<table class="reference notranslate"> 
  <tr>
    ...
    <td>Optional. Specifies the selector to remove event handlers from</td>
    </tr>
    <tr>
    <td><em>event</em></td>
    <td>Optional. Specifies one or more event types to remove handler functions 
	from</td>
    </tr>
  <tr>
    <td><em>function</em></td>
    <td>Optional. Specifies a specific event handler function to remove</td>
  </tr>
  </table>
<br>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjquery_event_undelegate_event" target="_blank">
Remove all click event handlers</a><br>
How to use the undelegate() method to remove all click event handlers for all 
&lt;p&gt; elements.</p>
<p><a href="tryit.asp?filename=tryjquery_event_undelegate_func" target="_blank">
Remove a specific function added with delegate()</a><br>
How to use the undelegate() method to remove only a specific function.</p>
<hr>
<p><a href="jquery_ref_events.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Event Methods" /> jQuery Event Methods</a></p>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_undelegate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_undelegate.asp#top" target="_top">TOP</a> |
		<a href="event_undelegate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
