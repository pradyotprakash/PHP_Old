...
<style>a.menu_html_clone{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">clone()</span> Method</h1>
...
<p>Clone all &lt;p&gt; elements and insert them at the end of the &lt;body&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>
&nbsp; $(&quot;p&quot;).clone().appendTo(&quot;body&quot;);<br>
	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_clone">Try it yourself &raquo;</a>
...
<p>The clone() method makes a copy of selected elements, 
including child nodes, text and attributes.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).clone(true|false)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em style="font-style: normal">true</em></td>
    <td>Specifies that event handlers also should be copied</td>
  </tr>
  <tr>
    <td>false</td>
    <td>Default. Specifies that event handlers should not be copied</td>
  </tr>
  </table>
  <br>
<hr>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_html_clone_eventhandler">
Copy an element including event handlers</a><br>
How to use the clone() method to copy an element, including event handlers.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_clone.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_clone.asp#top" target="_top">TOP</a> |
		<a href="html_clone.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
