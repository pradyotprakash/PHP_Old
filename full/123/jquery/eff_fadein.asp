...
<style>a.menu_eff_fadein{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">fadeIn()</span> Method</h1>
...
<p>The fadeIn() method gradually changes the opacity, for selected elements, from hidden to 
visible (fading effect).<p><b>Note</b>: Hidden elements will not be displayed at all (no longer affects 
the layout of the page).</p>

<p><strong>Tip:</strong> This method is often used together with the <a href="eff_fadeout.asp">fadeOut()</a> method.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).fadeIn(<i>speed,easing,callback</i>)</div></div>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_eff_fadeout_fadein_speed" target="_blank">
fadeIn() - Using the speed parameter</a><br>
...
How to use the callback parameter when fading in and out an element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_fadein.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_fadein.asp#top" target="_top">TOP</a> |
		<a href="eff_fadein.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
