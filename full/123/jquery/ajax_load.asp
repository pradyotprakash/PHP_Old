...
<style>a.menu_ajax_load{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">load()</span> Method</h1>
...
<p>Load the content of the file &quot;demo_test.txt&quot; into a specific &lt;div&gt; element:</p>
...
<p><strong>Note:</strong> There is also a jQuery <a href="jquery_ref_events.asp">Event</a> method called load. Which one is called, depends on the parameters.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).load(<i>url,data,function(response,status,xhr</i>))</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>url</em></td>
    <td>Required. Specifies the URL you wish to load</td>
    </tr>
	<tr>
    <td><em>data</em></td>
    <td>Optional. Specifies data to send to the server along with the request</td>
    </tr>
	<tr>
    <td><em>function(response,status,xhr)</em></td>
    <td>Optional. Specifies a callback function to run when the load() method is completed.<br><br>
    Additional parameters:<br>
	<ul><li><em>response</em> - contains the result data from the request</li>
		<li><em>status</em> - contains the status of the request (&quot;success&quot;, &quot;notmodified&quot;, &quot;error&quot;, &quot;timeout&quot;, or &quot;parsererror&quot;)</li>
		<li><em>xhr</em> - contains the XMLHttpRequest object</li></ul>
	</td>
  </tr>
</table>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_ajax_load_data" target="_blank">Make an AJAX request, and send data with the request</a><br>
How to use the data parameter to send data with the AJAX request (this example uses the an example explained in our
<a href="../ajax/ajax_aspphp.asp">AJAX Tutorial</a>)</p>
<p>
<a href="tryit.asp?filename=tryjquery_ajax_load_func" target="_blank">Make an AJAX request and use a callback function</a><br>
How to use the function parameter to work with the data result from the AJAX request.</p>
<p>
<a href="tryit.asp?filename=tryjquery_ajax_load_err" target="_blank">Make an AJAX request with an error</a><br>
How to use the function parameter to deal with errors in an AJAX request (using the XMLHttpRequest parameter).</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_load.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_load.asp#top" target="_top">TOP</a> |
		<a href="ajax_load.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
