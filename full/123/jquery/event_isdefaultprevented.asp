...
<style>a.menu_event_isdefaultprevented{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.isDefaultPrevented()</span> Method</h1>
...
<p>Prevent a link from opening the URL, and check if preventDefault() was 
called:</p>
<div class="example_code notranslate">
  
    $(&quot;a&quot;).click(function(event){<br>&nbsp;&nbsp;event.preventDefault();<br>
&nbsp; alert(&quot;Was preventDefault() called: &quot; + event.isDefaultPrevented());<br>
	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_isdefaultprevented" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.isDefaultPrevented() method checks whether the 
<a href="event_preventdefault.asp">preventDefault()</a> method 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_isdefaultprevented.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_isdefaultprevented.asp#top" target="_top">TOP</a> |
		<a href="event_isdefaultprevented.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
