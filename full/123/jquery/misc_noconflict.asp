...
<title>jQuery Misc noConflict() Method</title>
<style>a.menu_misc_noconflict{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Misc <span class="color_h1">noConflict()</span> Method</h1>
...
<p>Use the noConflict() method to specify a new name for the jQuery variable:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_noconflict" target="_blank">Try it yourself &raquo;</a>
...
<p>The noConflict() method releases jQuery's control of the $ variable.</p>
<p>This method can also be used to specify a new custom name for the jQuery 
variable.</p>
<p><strong>Tip:</strong> This method is useful when other JavaScript libraries 
use the $ for their functions.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$.noConflict(<i>removeAll</i>)</div></div>
<br>
<table class="reference notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>removeAll</em></td>
    <td>Optional. A Boolean value that specifies whether or not to release 
	jQuery's control of ALL jQuery variables (including &quot;jQuery&quot;)</td>
    </tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="misc_noconflict.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="misc_noconflict.asp#top" target="_top">TOP</a> |
		<a href="misc_noconflict.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
