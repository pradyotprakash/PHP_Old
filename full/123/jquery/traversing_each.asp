...
<title>jQuery Misc each() Method</title>
<style>a.menu_traversing_each{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">each()</span> Method</h1>
...
<p>Alert the text of each &lt;li&gt; element:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_each" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The each() method specifies a function to run for each matched element.</p>
<p><strong>Tip:</strong> return false can be used to stop the loop early.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).each(function<i>(index,element)</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td>function<i>(index,element)</i></td>
    <td>Required. A function to run for each matched element.<ul>
		<li><i>index</i> - The index position of the selector</li>
		<li><i>element</i> - The current element (the &quot;this&quot; selector can also be used)</li>
	</ul>
	</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_each.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_each.asp#top" target="_top">TOP</a> |
		<a href="traversing_each.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
