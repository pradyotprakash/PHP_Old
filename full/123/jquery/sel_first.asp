...
<style>a.menu_sel_first{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:first</span> Selector</h1>
...
<p>Select the first &lt;p&gt; element:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_first">Try it yourself &raquo;</a>
...
<p>The :first selector selects the first element.</p>
<p><strong>Note:</strong> This selector can only select one single element. Use 
the <a href="sel_firstchild.asp">:first-child</a> selector to select more than 
one element (one for each parent). </p>
<p>This is mostly used together with another selector to select the first 
element in a group (like in the example above).</p>
<p><strong>Tip:</strong> To select the last element in a group, use the <a href="sel_last.asp">:last</a> selector.</p>
...
<p><a href="tryit.asp?filename=tryjquery_sel_firstchild_first" target="_blank">Difference 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_first.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_first.asp#top" target="_top">TOP</a> |
		<a href="sel_first.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
