...
<style>a.menu_html_html{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">html()</span> Method</h1>
...
<p>Change the content of all &lt;p&gt; elements:</p>
<div class="example_code notranslate">
    $(&quot;button&quot;).click(function(){<br>
	&nbsp;
	$(&quot;p&quot;).html(&quot;Hello &lt;b&gt;world&lt;/b&gt;!&quot;);<br>
	});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_set">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The html() method sets or returns the content (innerHTML) of the selected elements.</p>
<p>When this method is used to <strong>return</strong> content, it returns the content of 
the FIRST matched element.</p>
<p>When this method is used to <strong>set</strong> content, it overwrites the content of ALL 
matched elements.</p>
<p><b>Tip:</b> To set or return only the text content of the selected elements, 
use the <a href="html_text.asp">text()</a> method.</p>
<hr>
...
<div class="code notranslate"><div>
    ...
    $(<i>selector</i>).html(<em>content</em>)
  
</div>
</div>
<p>Set content using a function:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).html(function<i>(index,currentcontent)</i>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>content</i></td>
    <td>Required. Specifies the new content for the selected elements (can contain HTML 
	tags)</td>
  </tr>
   <tr>
    <td>function(<i>index,currentcontent</i>)</td>
    <td>Optional. Specifies a function that returns the new content for the selected elements<ul>
		<li><i>index</i> - Returns the index position of the element in the set</li>
		<li><i>currentcontent</i> - Returns the current HTML content of the selected element</li>
	</ul></td>
  </tr>
</table>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_html_get" target="_blank">Return element 
content</a><br>
How to return the content of an element.</p>

<p>
<a href="tryit.asp?filename=tryjquery_html_set_func" target="_blank">Set 
element content using a function</a><br>
Using a function to set the content of all selected elements.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_html.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_html.asp#top" target="_top">TOP</a> |
		<a href="html_html.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
