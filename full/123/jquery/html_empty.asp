...
<style>a.menu_html_empty{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">empty()</span> Method</h1>
...
<p>Remove the content of all &lt;div&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_empty">Try it yourself &raquo;</a>
...
<p>The empty() method removes all child nodes and content from the selected elements.</p>
<p><strong>Note:</strong> This method does not remove the element itself, or its 
attributes.</p>
<p><b>Tip:</b> To remove the elements without removing data and events, use the <a href="html_detach.asp">detach()</a> method.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_empty.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_empty.asp#top" target="_top">TOP</a> |
		<a href="html_empty.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
