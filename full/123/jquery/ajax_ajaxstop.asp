...
<style>a.menu_ajax_ajaxstop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">ajaxStop()</span> Method</h1>
...
<p>Trigger an alert box when all AJAX requests have completed:</p>
<div class="example_code notranslate">
$(document).ajaxStop(function(){<br>
&nbsp; alert(&quot;All AJAX requests completed&quot;);<br>
});
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_ajaxstop" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ajaxStop() method specifies a function to run when ALL AJAX requests have completed.</p>
<p>When an AJAX request completes, jQuery checks if there are any more AJAX 
requests. The function specified with the ajaxStop() method will run if no other requests are pending.</p>
<p><strong>Note:</strong> As of jQuery version 1.8, this method should only be attached to document.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(document).ajaxStop(<i>function())</i></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when all AJAX requests have completed</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_ajaxstop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_ajaxstop.asp#top" target="_top">TOP</a> |
		<a href="ajax_ajaxstop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
