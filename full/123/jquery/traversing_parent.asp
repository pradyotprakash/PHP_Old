...
<style>a.menu_traversing_parent{font-weight:bold;}</style>
<meta charset="utf-8">
...
$(document).ready(function(){
  $("span.ex").parent().css({"color":"red","border":"2px solid red"});
});
</script>
<style>
.ancestors *
...
<h1>jQuery <span class="color_h1">parent()</span> Method</h1>
...
<p>Return the direct parent element of &lt;span&gt;:</p>
<div class="example_code notranslate">
  
    $(document).ready(function(){<br>&nbsp; $(&quot;span&quot;).parent().css({&quot;color&quot;:&quot;red&quot;,&quot;border&quot;:&quot;2px 
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_parent">Try it yourself &raquo;</a>
</div>
<hr>
...
element.</p>
<p><strong>The DOM tree:</strong> This method only traverse a single level up 
the DOM tree. To traverse all the way up to the document's root element (to 
return grandparents or other ancestors), use the <a href="traversing_parents.asp">
parents() </a>or the <a href="traversing_parentsUntil.asp">parentsUntil()</a> 
method. </p>
<p><strong>Tip:</strong> To traverse a single level down the DOM tree, or all 
the way down to the last descendant (to return children or other descendants), 
use the <a href="traversing_children.asp">children()</a> or
<a href="traversing_find.asp">
find()</a> method.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).parent(<em>filter</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>filter</i></td>
    <td>Optional. Specifies a selector expression to narrow down the parent 
	search</td>
  </tr>
</table>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_traversing_parent_all" target="_blank">
Return the direct parent of each &lt;span&gt; element</a><br>
How to 
return the direct parent of each &lt;span&gt; element.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_parent_class" target="_blank">
Narrow down the search</a><br>
How to use the filter parameter to 
return the parent &lt;li&gt; element with class name &quot;1&quot; of each &lt;span&gt;.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_parent2">Return 
the direct parent &lt;div&gt; element of each &lt;p&gt; element</a><br>
How to return all the direct parent &lt;div&gt; element of each &lt;p&gt; element.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_parent3">Show 
the ancestor elements of an element by tag names</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_parent.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_parent.asp#top" target="_top">TOP</a> |
		<a href="traversing_parent.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
