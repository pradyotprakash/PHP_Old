...
<title>jQuery Traversing Descendants</title>
<style>a.menu_jquery_traversing_descendants{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Traversing - <span class="color_h1">Descendants</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_traversing_ancestors.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_traversing_siblings.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A descendant is a child, grandchild, great-grandchild, and so 
on.</p>
<p class="intro">With jQuery you can traverse down the DOM tree to 
find descendants of an element.</p>
<hr>
<h2>Traversing Down the DOM Tree</h2>
<p>Two useful jQuery methods for traversing down the DOM tree are:</p>
<ul>
	<li>children()</li>
	<li>find()</li>
</ul>
<hr>
<h2>jQuery children() Method</h2>
<p>The children() method returns all direct children of the selected element.</p>
<p>This method only traverse a single level down the DOM tree.</p>
<p>The following example returns all elements that are direct children of each &lt;div&gt; elements:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;div&quot;).children();<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_children">Try it yourself &raquo;</a>
</div>
<p>You can also use an optional parameter to filter the search for children.</p>
<p>The following example returns all &lt;p&gt; elements with the class name &quot;1&quot;, that 
are direct children of &lt;div&gt;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;div&quot;).children(&quot;p.1&quot;);<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_children2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery find() Method</h2>
<p>The find() method returns descendant elements of the selected element, all 
the way down to the last descendant.</p>
<p>The following example returns all &lt;span&gt; elements that are 
descendants of &lt;div&gt;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;div&quot;).find(&quot;span&quot;);<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_find">Try it yourself &raquo;</a>
</div>
<p>The following example returns all 
descendants of &lt;div&gt;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;div&quot;).find(&quot;*&quot;);<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_find2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_traversing_descendants.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_traversing_descendants.asp#top" target="_top">TOP</a> |
		<a href="jquery_traversing_descendants.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
