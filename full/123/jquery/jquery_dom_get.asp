...
<title>jQuery Get Content and Attributes</title>
<style>a.menu_jquery_dom_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery - <span class="color_h1">Get Content and Attributes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_chaining.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_dom_set.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">jQuery contains powerful methods for changing and manipulating HTML elements and attributes.</p>
<hr>
<h2>jQuery DOM Manipulation</h2>
<p>One very important part of jQuery is the possibility to manipulate the DOM.</p>
<p>jQuery comes with a bunch of DOM related methods that make it easy to 
access and manipulate elements and attributes.</p>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>DOM = Document Object Model</b><br><br>
...
content, structure, and style of a document.&quot;</i></td>
</tr></table>
<br>
<hr>

<h2>Get Content - text(), html(), and val()</h2>
...
<p>The following example demonstrates how to get content with the jQuery text() and html() methods:</p>
<div class="example">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_html_get">Try it yourself &raquo;</a>
</div>
<p>The following example demonstrates how to get the value of an input field with the jQuery val() method:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;#btn1&quot;).click(function(){<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_val_get">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Get Attributes - attr()</h2>
<p>The jQuery attr() method is used to get attribute values.</p>
<p>The following example demonstrates how to get the value of the href attribute 
in a link:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; alert($(&quot;#w3s&quot;).attr(&quot;href&quot;));<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_attr_get">Try it yourself &raquo;</a>
</div>
<p>The next chapter explains how to set (change) content and attribute values.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_dom_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_dom_get.asp#top" target="_top">TOP</a> |
		<a href="jquery_dom_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
