...
<title>jQuery serializeArray() Method</title>
<style>a.menu_ajax_serializearray{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">serializeArray()</span> Method</h1>
...
<p>Output the result of form values serialized as arrays:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>
&nbsp; x=$(&quot;form&quot;).serializeArray();<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_serializearray">Try it yourself &raquo;</a>
...
<p>The serializeArray() method creates an array of objects (name and value) by serializing form 
values.</p>
<p>You can select one or more form elements (like input and/or text 
area), or the form element itself.</p> 
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).serializeArray()</div></div>
<br>
<hr>
<p><a href="jquery_ref_ajax.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery AJAX Methods" /> jQuery AJAX Methods</a></p>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_serializearray.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_serializearray.asp#top" target="_top">TOP</a> |
		<a href="ajax_serializearray.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
