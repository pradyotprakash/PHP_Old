...
<style>a.menu_event_currenttarget{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.currentTarget</span> Property</h1>
...
<p>event.currentTarget is typically equal to <em>this</em>:</p>
<div class="example_code notranslate">
    $(&quot;h1,h2,p&quot;).click(function(event){<br>&nbsp; alert(event.currentTarget === 
	this);<br>});   
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_currenttarget2" target="_blank">Try it yourself </a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The event.currentTarget property is the current DOM element within the event 
bubbling phase, and is typically equal to <em>this</em>.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>event</i>.currentTarget</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>event</em></td>
    <td>Required. The <em>event</em> parameter comes from the event binding function</td>
  </tr>
</table>
<br>
<hr>
...
<p><a href="tryit.asp?filename=tryjquery_event_currenttarget" target="_blank">
Return the content of elements</a><br>
Using event.currentTarget.innerHTML to return content of elements.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_currenttarget.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_currenttarget.asp#top" target="_top">TOP</a> |
		<a href="event_currenttarget.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
