...
<style>a.menu_event_which{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.which</span> Property</h1>
...
<p>Return which keyboard key was pressed:</p>
<div class="example_code notranslate">
  
    $(&quot;input&quot;).keydown(function(event){ <br>
&nbsp; $(&quot;div&quot;).html(&quot;Key: &quot; + event.which);<br>
	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_which" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.which property returns which keyboard key or mouse button was pressed for the event.</p>
...
<p><a href="tryit.asp?filename=tryjquery_event_which2" target="_blank">Return 
which mouse button was pressed</a><br>
Show which mouse button was pressed for the event.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_which.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_which.asp#top" target="_top">TOP</a> |
		<a href="event_which.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
