...
<title>jQuery Misc data() Method</title>
<style>a.menu_misc_data{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Misc <span class="color_h1">data()</span> Method</h1>
...
<p>Attach data to a &lt;div&gt; element, then retrieve the data:</p>
<div class="example_code notranslate">
$(&quot;#btn1&quot;).click(function(){<br>
&nbsp; $(&quot;div&quot;).data(&quot;greeting&quot;, &quot;Hello World&quot;);<br>
});<br>
$(&quot;#btn2&quot;).click(function(){<br>
&nbsp; alert($(&quot;div&quot;).data(&quot;greeting&quot;));<br>
});
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_data_set_get" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The data() method attaches data to, or gets data from, selected elements.</p>
<p><b>Tip:</b> To remove data, use the <a href="misc_removedata.asp">removeData()</a> method.</p>
<hr>

<h2>Return Data from an Element</h2>
<p>Returns attached data from a selected element.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).data(<i>name</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>name</i></td>
    <td>Optional. Specifies the name of data to retrieve.<br>
	If no name is specified, this method will return all stored data for the 
	element as an object</td>
  </tr>
  </table>
<br>
<hr>

<h2>Attach Data to an Element</h2>
<p>Attach data to selected elements.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).data(<em>na</em><i>me,value</i>)</div></div>
<br>
<table class="reference notranslate"> 
  <tr>
    <th style="width:27%">Parameter</th>
    ...
    <tr>
    <td><i>name</i></td>
    <td>Required. Specifies the name of data to set</td>
    </tr>
  <tr>
    <td><i>value</i></td>
    <td>Required. Specifies the value of data to set</td>
  </tr>
  </table>
<br>
<hr>

<h2>Attach Data to an Element Using an Object</h2>
<p>Attach data to selected elements using an object with name/value pairs.</p>
<h2>Syntax</h2>
<div class="example">
<div class="example_code notranslate">
$(<i>selector</i>).data(<em>object</em>)
</div>
<br><a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_data_set_obj" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
<table class="reference notranslate"> 
  <tr>
    ...
    <tr>
    <td><i>object</i></td>
    <td>Required. Specifies an object containing name/value pairs</td>
    </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="misc_data.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="misc_data.asp#top" target="_top">TOP</a> |
		<a href="misc_data.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
