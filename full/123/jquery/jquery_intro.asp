...
<style>a.menu_jquery_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_install.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The purpose of jQuery is to make it much easier to use JavaScript on your website.</p>
<hr>
...
<p>jQuery takes a lot of common tasks that require many lines of JavaScript code to accomplish,
and wraps them into methods that you can call with a single line of code.</p>
...
<h2>Why jQuery?</h2>
<p>There are lots of other JavaScript frameworks out there, but jQuery seems 
...
<td><b>Will jQuery work in all browsers?<br>
</b><br>The jQuery team knows all about cross-browser issues, and they have 
written this knowledge into the jQuery library. jQuery will run exactly the same 
in all major browsers, including Internet Explorer 6!</td>
</tr></table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_intro.asp#top" target="_top">TOP</a> |
		<a href="jquery_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
