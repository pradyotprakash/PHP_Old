...
<style>a.menu_css_height{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">height()</span> Method</h1>
<p><a href="jquery_ref_html.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery HTML/CSS Methods" /> jQuery HTML/CSS Methods</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the height of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; alert($(&quot;div&quot;).height());<br>});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_css_height_ref">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The height() method sets or returns the height of the selected elements.</p>
<p>When this method is used to <strong>return</strong> height, it returns the height of the FIRST matched element.</p>
<p>When this method is used to <strong>set</strong> height, it sets the height of ALL matched elements.</p>
<p>As the image below illustrates, this method does not include padding, border, or margin.</p>
<p style="text-align:center;"><img border="0" alt="jQuery Dimensions" src="img_height.gif"></p>
<hr>

<p>Related methods:</p>
<ul>
	<li><a href="css_width.asp">width()</a> - Sets or returns the width of an element</li>
	<li><a href="html_innerwidth.asp">innerWidth()</a> - Returns the width of an element (includes padding)</li>
    <li><a href="html_innerheight.asp">innerHeight()</a> - Returns the height of an element (includes padding)</li>
	<li><a href="html_outerwidth.asp">outerWidth()</a> - Returns the width of an element (includes padding and border).</li>
	<li><a href="html_outerheight.asp">outerHeight()</a> - Returns the width of an element (includes padding and border).</li>	
</ul>
<hr>
...
<p>Set the height:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).height(<i>value</i>)
</div>
</div>

<p>Set the height using a function:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).height(function<i>(index,currentheight)</i>)
</div>
</div>
<br>
...
<table class="reference notranslate"> 
  <tr>
   ...
   <tr>
    <td><em>value</em></td>
    <td>Required for setting height. Specifies the height in px, em, pt, etc. <br>Default unit is px</td>
  </tr>
  <tr>
    <td>function<i>(index,currentheight)</i></td>
    <td>Optional. Specifies a function that returns the new height of selected elements<ul>
		<li><i>index</i> - Returns the index position of the element in the set</li>
		<li><i>currentheight</i> - Returns the current height of the selected element</li>
	</ul>
	</td>
  </tr>
</table>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_css_height_set_unit">Set the height of an element</a><br>
How to set the height of an element using different units.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_css_height_func">Increase the height using a function</a><br>
How to use a function to increase the height of an element.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_css_height_doc_win">Return the height of the document and window elements</a><br>
How to return the current height of the document and window elements.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_all_dimensions_ref">Display dimensions with related methods</a><br>
How to use width(), height(), innerHeight(), innerWidth(), outerWidth() and outerHeight().</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_height.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_height.asp#top" target="_top">TOP</a> |
		<a href="css_height.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
