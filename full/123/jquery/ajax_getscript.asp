...
<title>jQuery getScript() Method</title>
<style>a.menu_ajax_getscript{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">getScript()</span> Method</h1>
...
<p>Get and run a JavaScript using an AJAX request:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_getscript" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getScript() method is used to get and execute a JavaScript using an AJAX HTTP GET request.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).getScript(<i>url,success(response,status))</i></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>success(response,status)</em></td>
    <td>Optional. Specifies the function to run if the request succeeds<br>
    Additional parameters:<br>
	<ul>
	<li><em>response</em> - contains the result data from the request</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_getscript.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_getscript.asp#top" target="_top">TOP</a> |
		<a href="ajax_getscript.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
