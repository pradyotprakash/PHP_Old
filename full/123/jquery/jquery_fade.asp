...
<style>a.menu_jquery_fade{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Effects - <span class="color_h1">Fading</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_hide_show.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_slide.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">With jQuery you can fade elements in and out of visibility.</p>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_fadetoggle">jQuery 
fadeToggle()</a><br>
...
<h2>jQuery Fading Methods</h2>
<p>With jQuery you can fade an element in and out of visibility.</p>
<p>jQuery has the following fade methods:</p>
<ul>
	<li>fadeIn()</li>
	<li>fadeOut()</li>
	<li>fadeToggle()</li>
...
fading completes.</p>
<p>The following example demonstrates the fadeIn() method with different 
parameters:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_fadein">Try it yourself &raquo;</a>
</div>
<br>
...
<p>The optional callback parameter is a function to be executed after the 
fading completes.</p>
<p>The following example demonstrates the fadeOut() method with different 
parameters:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_fadeout">Try it yourself &raquo;</a>
</div>
<br>

<hr>

<h2>jQuery fadeToggle() Method</h2>
<p>The jQuery fadeToggle() method toggles between the fadeIn() and fadeOut() 
methods.</p>
<p>If the elements are faded out, fadeToggle() will fade them in.</p>
<p>If the elements are faded in, fadeToggle() will fade them out. </p>
<p><b>Syntax:</b></p>
<div class="code notranslate"><div>
...
<p>The optional callback parameter is a function to be executed after the 
fading completes.</p>
<p>The following example demonstrates the fadeToggle() method with different 
parameters:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_fadetoggle">Try it yourself &raquo;</a>
</div>
<br>

<hr>

<h2>jQuery fadeTo() Method</h2>
...
<p>The required speed parameter specifies the duration of the effect. It can take the following values: &quot;slow&quot;, &quot;fast&quot;, or 
milliseconds.</p>
<p>The required opacity parameter in the fadeTo() method specifies fading to a given opacity (value between 0 and 1).</p>

<p>The optional callback parameter is a function to be executed after the function completes.</p>
<p>The following example demonstrates the fadeTo() method with different 
parameters:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_fadeto">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>jQuery Effects Reference</h2>
<p>For a complete overview of all jQuery effects, please go to our <a href="jquery_ref_effects.asp">
jQuery Effect Reference</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_fade.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_fade.asp#top" target="_top">TOP</a> |
		<a href="jquery_fade.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
