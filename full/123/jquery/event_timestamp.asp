...
<style>a.menu_event_timestamp{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.timeStamp</span> Property</h1>
...
<p>Return the number of milliseconds since Jan 1, 1970, when the click event 
occurs for a button:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(event){<br>
	&nbsp; $(&quot;span&quot;).text(event.timeStamp);<br>
	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_timestamp" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.timeStamp property returns the number of milliseconds since January 1, 
1970, when the event is triggered.</p>
...
<p><a href="tryit.asp?filename=tryjquery_event_timestamp2" target="_blank">Display the number of milliseconds since last click event</a><br>
Show how to use event.timeStamp to display the number of milliseconds since last click event.</p>
<hr>
<p><a href="jquery_ref_events.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Event Methods" /> jQuery Event Methods</a></p>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_timestamp.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_timestamp.asp#top" target="_top">TOP</a> |
		<a href="event_timestamp.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
