...
<style>a.menu_traversing_closest{font-weight:bold;}</style>
<meta charset="utf-8">
...
$(document).ready(function(){
  $("span.ex").closest("ul").css({"color":"red","border":"2px solid red"});
});
</script>
<style>
.ancestors *
...
<h1>jQuery <span class="color_h1">closest()</span> Method</h1>
...
<p>Return the first ancestor of &lt;span&gt;, that is an &lt;ul&gt; element:</p>
<div class="example_code notranslate">
  
    $(document).ready(function(){<br>&nbsp; $(&quot;span&quot;).closest(&quot;ul&quot;).css({&quot;color&quot;:&quot;red&quot;,&quot;border&quot;:&quot;2px 
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
<div class="example_code notranslate ancestors">body (great-great-grandparent)
  <div class="ex">div (great-grandparent)
    <ul> ul (second ancestor - second grandparent) <ul> ul (first ancestor - 
		first grandparent) <li> li (direct parent)&nbsp; <span class="ex">span</span> &nbsp;</ul>
&nbsp;</ul>  
  </div>
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_closest">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The closest() method returns the first ancestor of the selected 
element.</p>
<p>An ancestor is a parent, grandparent, great-grandparent, and so on.</p>
<p><strong>The DOM tree:</strong> This method traverse upwards from the current 
element, all the way up to the document's root element (&lt;html&gt;), to find the first ancestor 
of DOM elements.</p>
<p>This method is similar to <a href="traversing_parents.asp">parents()</a>, in 
...
<ul>
	...
	<li>Travels up the DOM tree and returns the first (single) ancestor that 
...
<h2>Syntax</h2>
<p>Return the first ancestor of the selected element:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).closest(<em>filter</em>)</div></div>
<p>Return the first ancestor using a DOM context to look up the DOM tree 
within:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).closest(<em>filter,context</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>filter</i></td>
    <td>Required. Specifies a selector expression, element or jQuery object to 
	narrow down the ancestor 
	search</td>
  </tr>
<tr>
    <td><i>context</i></td>
    <td>Optional. A DOM element within which a matching element may be found</td>
</tr>
</table>
<br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_closest2">
Return 
the first ancestor of &lt;span&gt;, that is a &lt;span&gt; element</a><br>
Because this method begins with the current element, a search for the first 
&lt;span&gt; of &lt;span&gt;, will return &lt;span&gt;.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_closest_dom">
Pass in a DOM element as the context within which to search for the first 
ancestor element</a><br>
Using both parameters to pass in a DOM element as the context within which to 
search for the first &lt;ul&gt; element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_closest.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_closest.asp#top" target="_top">TOP</a> |
		<a href="traversing_closest.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
