...
<h1>jQuery <span class="color_h1">:first-child</span> Selector</h1>
...
<p>Select every &lt;p&gt; element that is the first child of its parent:</p>
<div class="example_code notranslate">
  
    $(&quot;p:first-child&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_firstchild">Try it yourself &raquo;</a>
...
<p>The :first-child selector selects all elements that are the first child of 
their parent.</p>
<p><strong>Tip:</strong> Use the <a href="sel_lastchild.asp">:last-child</a>
selector to select elements that are the last child of their parent.</p>
...
<p>
<a href="tryit.asp?filename=tryjquery_sel_firstchild2" target="_blank">Select 
the first &lt;p&gt; element of all &lt;div&gt; elements</a><br>
How to select the first &lt;p&gt; element of all &lt;div&gt; elements.</p>
<p>
<a href="tryit.asp?filename=tryjquery_sel_firstchild_first" target="_blank">Difference 
between :first and :first-child</a><br>
Show the difference between the :first and :first-child selectors.</p>
<p>
<a href="tryit.asp?filename=tryjquery_sel_firstoftypediff" target="_blank">Difference 
between :first, :first-child and :first-of-type</a><br>
Show the difference between the :first, :first-child and :first-of-type selectors.</p>
