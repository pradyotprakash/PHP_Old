...
<style>a.menu_eff_clearqueue{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">clearQueue()</span> Method</h1>
...
<p>Stop the remaining functions in the queue:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;div&quot;).clearQueue();<br>	});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_clearqueue">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The clearQueue() method removes all items from the queue that have not yet 
been run. Note that when a function has started to run, it runs until it is completed.</p>
<p>Related methods:</p>
<ul>
	<li><a href="eff_queue.asp">queue()</a> - Shows the queued functions</li>
	<li><a href="eff_dequeue.asp">dequeue()</a> - Removes the next function from 
	the queue, and then executes the function</li>
</ul>
<p><b>Tip:</b> Unlike the <a href="eff_stop.asp">stop()</a> method (that only works with animation), the clearQueue() 
method can remove any queued functions.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).clearQueue(<i>queueName</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>queueName</i></td>
    <td>Optional. Specifies the name of the queue<br>
	<br>
	The default is &quot;fx&quot;, the standard effects queue</td>
  </tr>
  </table>
<br>
<hr>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_eff_queue_all">Using queue-related methods together</a><br>
How to use queue(), dequeue() and clearQueue() together.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_clearqueue.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_clearqueue.asp#top" target="_top">TOP</a> |
		<a href="eff_clearqueue.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
