...
<style>a.menu_traversing_prevuntil{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">prevUntil()</span> Method</h1>
...
<p>Return all sibling elements between two &lt;li&gt; elements with class name &quot;start&quot; 
and &quot;stop&quot;:</p>
<div class="example_code notranslate">
  
    $(document).ready(function(){<br>&nbsp; $(&quot;li.start&quot;).prevUntil(&quot;li.stop&quot;).css({&quot;color&quot;:&quot;red&quot;,&quot;border&quot;:&quot;2px 
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
<div class="example_code notranslate siblings">
  <ul>ul (parent)  
...
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_prevuntil">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The prevUntil() method returns all previous sibling elements between the <em>selector</em> 
and <em>stop</em>. </p>
<p>Sibling elements are elements that share the same parent. </p>
<p><strong>The DOM tree:</strong> This method traverse backwards along siblings 
of DOM elements.</p>
<p><strong>Note:</strong> If both parameters are empty, this method will return 
all previous sibling elements (same as the <a href="traversing_prevall.asp">prevAll()</a> 
method).</p>
<p>Related methods:</p>
<ul>
	<li><a href="traversing_prev.asp">prev()</a> -&nbsp; returns the previous 
	sibling element of the selected element</li>
	<li><a href="traversing_prevall.asp">prevAll()</a> -&nbsp; returns all 
	previous sibling elements of the selected element</li>
</ul>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).prevUntil(<em>stop,filter</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	where to stop the search for previous matching siblings elements</td>
  </tr>
    <tr>
    <td><i>filter</i></td>
    <td>Optional. Specifies a selector expression to narrow down the search for 
	sibling elements between 
	the <em>selector</em> and <em>stop</em><br><br><strong>Note:</strong> To 
	return multiple siblings, separate each expression with a comma.</td>
  </tr>
</table>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_traversing_prevuntil2" target="_blank">
Narrow down the search</a><br>
Using both parameters to filter the search for previous sibling elements 
between two arguments.</p>
<p>
<a href="tryit.asp?filename=tryjquery_traversing_prevuntil_multi" target="_blank">
Return multiple siblings</a><br>
How to return multiple sibling elements between two arguments.</p>
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_prevuntil_dom">
DOM</a><br>
Using a DOM element instead of a selector to return sibling elements between two 
arguments.</p>
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_prevuntil_dom2">
Using the DOM with both 
parameters</a><br>
Using a DOM element instead of a selector and both parameters to filter the 
previous sibling search between two arguments.</p>
<hr>
<p><a href="jquery_ref_traversing.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery HTML Methods" /> jQuery 
Traversing Methods</a></p>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_prevuntil.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_prevuntil.asp#top" target="_top">TOP</a> |
		<a href="traversing_prevuntil.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
