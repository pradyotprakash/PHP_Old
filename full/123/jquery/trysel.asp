...
<html lang="en-US">
<head>
<title>Try jQuery Selector</title>
...
w3SelDescriptions.push('All &lt;p&gt; elements with an id attribute.');
w3SelDescriptions.push('All &lt;p&gt; elements with an id attribute value equal to "my-Address"');
...
function w3jQuerySelectorLoad() {
	...
	for (i = 0; i < l; i++) {
		x = x + "<div onclick='clickSelOpt(\"" + w3Sels[i] + "\");'>$(\"" + w3Sels[i] + "\")</div>";
	}
	document.getElementById("selectorOptions").innerHTML = x;
}

function clickSelOpt(sel) {
	var l = w3Sels.length, x, y, patt, arrPos;
	for (i = 0; i < l; i++) {
...
<body style="background-color:#e5eecc;" onload="w3jQuerySelectorLoad();">
<div id="ads">
...
<div id="content">
	<div id="sourcecode" style="width:500px;">
		<div class="headerText">Click a selector to see which element(s) gets selected int the Result: </div>
		<div class="code_input" id="textareaCode" style="overflow:scroll;">
			<div id="selectorOptions" style="margin:10px;margin-right:0px;">
			</div>
			<div id="selectorDescription" style="padding:10px;display:none;width:225px;background-color:#f1f1f1;border:1px solid #d3d3d3;position:fixed;top:150px;left:230px;text-align:center;font-family:Verdana;font-size:12px;"></div>
		</div>
	</div>
	<div id="result" style="position:absolute;width:auto;xtop:105px;left:530px;min-width:700px; xbottom:60px;">
		...
		<div id="iframeResult" style="xdisplay:none;overflow:scroll" class="result_output">



       <div id="selectorResult" style="margin-left:20px;" class="noSel">
       <div class="noSel">
...
<div class="noSel newsletter" style="background-color:#99D6FF;border:1px solid #0099FF;width:380px;position:absolute;left:260px;top:480px;padding:10px;font-size:12px;">
<form>
	<h4 style="margin:0px;font-size:14px;text-align:center;">Subscribe to my newsletter:</h4>
	<div style="width:260px;float:left;">
		<div style="width:65px;float:left;">Name:</div><div style="width:180px;float:left;"><input type="text" style="width:150px" class="markup" /></div>
		<div class="noSel" style="clear:both;"></div>			
		<div style="width:65px;float:left;">E-mail:</div><div style="width:180px;float:left;"><input type="text" style="width:150px" class="markup" /></div>
		<div class="noSel" style="clear:both;"></div>			
	...
	<div style="float:left;">
		<div style="margin:2px;font-weight:bold;">Newscategories:</div>
		<div style="width:60px;float:left;text-align:right;">Ducks:</div><div style="width:20px;float:left;"><input id="cc1" type="checkbox" checked="checked" style="outline:2px solid transparent" /></div>
		<div class="noSel" style="clear:both;"></div>			
		<div style="width:60px;float:left;text-align:right;">Dogs:</div><div style="width:20px;float:left;"><input id="cc2" type="checkbox" style="outline:2px solid transparent" /></div>
		<div class="noSel" style="clear:both;"></div>			
		<div style="width:60px;float:left;text-align:right;">Humans:</div><div style="width:20px;float:left;"><input id="cc3" type="checkbox" style="outline:2px solid transparent" /></div>
		<div class="noSel" style="clear:both;"></div>						
	</div>
	<div class="noSel" style="clear:both;"></div>			
	...
	<div style="margin-top:10px;">
		...
		<div style="width:250px;float:left;">
			<h4 style="xmargin:0px;font-size:14px;margin-top:0px;">Upload image:</h4>
			<input type="file" />
		</div>
