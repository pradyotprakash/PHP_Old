...
<title>jQuery Effect fadeOut() Method</title>
<style>a.menu_eff_fadeout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Effect <span class="color_h1">fadeOut()</span> Method</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_fadeout_fadein">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The fadeOut() method gradually changes the opacity, for selected elements, from 
visible to hidden (fading effect).<p><b>Note</b>: Hidden elements will not 
be displayed at all (no longer affects the layout of the page).</p>
<p><strong>Tip:</strong> This method is often used together with the <a href="eff_fadein.asp">fadeIn()</a> method.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).fadeOut(<i>speed,easing,callback</i>)</div></div>
<br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_eff_fadeout_fadein_speed">fadeOut() - Using the speed parameter</a><br>
How to use the speed parameter to specify the speed of the fading effect.</p>

<p>
<a href="tryit.asp?filename=tryjquery_eff_fadeout_fadein_callback" target="_blank">
fadeIn() - Using the callback parameter</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_fadeout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_fadeout.asp#top" target="_top">TOP</a> |
		<a href="eff_fadeout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
