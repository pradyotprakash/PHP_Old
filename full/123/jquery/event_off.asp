...
<style>a.menu_event_off{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">off()</span> Method</h1>
...
<p>Remove the click event for all &lt;p&gt; elements:</p>
	<div class="example_code notranslate">
  
    	$(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;p&quot;).off(&quot;click&quot;);<br>});<br></div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_off" target="_blank">Try it yourself &raquo;</a>
</div>

<hr>

<h2>Definition and Usage</h2>
<p>The off() method is most often used to remove event handlers attached with the
<a href="event_on.asp">on()</a> method.</p>
<p>As of jQuery version 1.7, the off() method is the new replacement for the unbind(), die() and undelegate() 
...
<p><strong>Note:</strong> To remove specific event handlers, the selector string 
must match the one passed to the on() method, when the event handler was 
attached.&nbsp; </p>
...
$(<i>selector</i>).off(<i>event,selector,function(eventObj),map</i>)
...
<table class="reference notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>event</em></td>
    <td>Required. Specifies one or more events or namespaces to remove from the 
	selected element(s).<br>
	<br>
	Multiple event values are separated by a space. Must be a valid event</td>
    </tr>
    <tr>
    <td><em>selector</em></td>
    <td>Optional. A selector which should match the one originally passed to the on() 
	method when attaching event handlers</td>
    </tr>
	  <tr>
    <td><em>function(eventObj)</em></td>
    <td>Optional. Specifies the function to run when the event occurs</td>
  </tr>
  <tr>
    <td><em>map</em></td>
    <td>Specifies an event map (<em>{event:function, event:function, ...})</em> containing one or more event to attach to the 
	elements, and functions to run when the events occur</td>
  </tr>
  </table>
<br>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjquery_event_off_unbind" target="_blank">
Changing from unbind() to off()</a><br>
How to use off() to achieve the same effect as unbind().</p>

<p>
<a href="tryit.asp?filename=tryjquery_event_off_undelegate" target="_blank">
Changing from undelegate() to off()</a><br>
How to use off() to achieve the same effect as undelegate().</p>

<p>
<a href="tryit.asp?filename=tryjquery_event_off_die" target="_blank">
Changing from die() to off()</a><br>
How to use off() to achieve the same effect as die().</p>

<p><a href="tryit.asp?filename=tryjquery_event_off_event" target="_blank">
Remove all click event handlers, added with on()</a><br>
How to remove all click event handlers for all &lt;p&gt; elements added with the on() 
method.</p>

<p><a href="tryit.asp?filename=tryjquery_event_off_func" target="_blank">Remove 
one specific event 
function added with on()</a><br>
How to remove a specific function added with the on() method. </p>

<p><a href="tryit.asp?filename=tryjquery_event_off_object" target="_blank">Remove 
an event handler using an event object</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_off.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_off.asp#top" target="_top">TOP</a> |
		<a href="event_off.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
