...
<style>a.menu_sel_attribute_contains_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Select all &lt;input&gt; elements with a name attribute that contains the 
specific word 
&quot;nation&quot;:</p>
<div class="example_code notranslate">
  
    $(&quot;input[name~='nation']&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_attributecontainsvalue">Try it yourself &raquo;</a>
...
<p>The [attribute~=value] selector selects each element with a specific 
attribute, with a value containing a specific string.</p>
<p><strong>Tip:</strong> The string can contain whitespace. </p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>value</em></td>
    <td>Required. Specifies the string value</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_attribute_contains_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_attribute_contains_value.asp#top" target="_top">TOP</a> |
		<a href="sel_attribute_contains_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
