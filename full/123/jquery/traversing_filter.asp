...
<style>a.menu_traversing_filter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">filter()</span> Method</h1>
...
<p>Return all &lt;p&gt; elements with class 
name &quot;intro&quot;:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).filter(&quot;.intro&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_filter">Try it yourself &raquo;</a>
...
<p>The filter() method returns elements that match a certain criteria.</p>
<p>This method lets you specify a criteria. Elements that do not match the 
criteria are removed from the selection, and those that match will be returned.</p>
<p>This method is often used to narrow down the search for an element in a group of selected elements.</p>
<p><strong>Tip:</strong> The filter() method is the opposite of the
<a href="traversing_not.asp">not()</a> method.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).filter(<em>criteria,</em>function<em>(index)</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	more elements to be returned from a group of selected elements.<br><br>
	<strong>Tip:</strong> To specify multiple criteria, use comma.</td>
  </tr>
  <tr>
    <td>function(<em>index</em>)&nbsp;</td>
    <td>
	Optional. Specifies a function to run for each element in the set.&nbsp;If 
	it returns true, the element is kept. Otherwise, the element is removed.
	<ul>
...
<p>
<a href="tryit.asp?filename=tryjquery_traversing_filter_even" target="_blank">
Return all &lt;p&gt; elements that are even</a><br>
Using the :even selector together with filter() to return all &lt;p&gt; elements that are even.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_filter_multiple" target="_blank">
Multiple criteria</a><br>
How to return all &lt;p&gt; elements with class &quot;intro&quot; and id &quot;outro&quot;.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_filter_obj" target="_blank">Using 
a jQuery object</a><br>
How to return all &lt;p&gt; elements with class &quot;intro&quot; inside of a 
&lt;div&gt; element, with a jQuery object.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_filter_dom" target="_blank">DOM</a><br>
How to return a &lt;p&gt; element with id &quot;intro&quot;, with a DOM element.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_filter_func" target="_blank">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_filter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_filter.asp#top" target="_top">TOP</a> |
		<a href="traversing_filter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
