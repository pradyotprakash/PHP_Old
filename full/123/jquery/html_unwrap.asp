...
<style>a.menu_html_unwrap{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">unwrap()</span> Method</h1>
...
<p>Remove the parent element of all &lt;p&gt; elements:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_html_unwrap" target="_blank">Try it yourself &raquo;</a>
...
<p>The unwrap() method removes the parent element of the selected elements.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).unwrap()</div></div>
  <br>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_wrap_unwrap">Wrap 
and unwrap an element</a><br>
How to toggle between wrapping and unwrapping an element.<br>
</p>
<hr>
<p><a href="jquery_ref_html.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery HTML/CSS Methods" /> jQuery HTML/CSS Methods</a></p>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_unwrap.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_unwrap.asp#top" target="_top">TOP</a> |
		<a href="html_unwrap.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
