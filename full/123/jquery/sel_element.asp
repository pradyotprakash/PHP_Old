...
<h1>jQuery <span class="color_h1">element</span> Selector</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_element">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The element selector selects all elements with the specific element name.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>element</em></td>
    <td>Required. Specifies the element to select</td>
  </tr>
  </table>
<br>
<hr>
