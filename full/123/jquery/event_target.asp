...
<title>jQuery event.target Property</title>
<style>a.menu_event_target{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.target</span> Property</h1>
...
<p>Return which DOM element triggered the event:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_target" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.target property returns which DOM element triggered the event.</p>
<p>It is often useful to compare event.target to <em>this</em> in order to 
determine if the event is being handled due to event bubbling.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_target.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_target.asp#top" target="_top">TOP</a> |
		<a href="event_target.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
