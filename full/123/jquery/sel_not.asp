...
<style>a.menu_sel_not{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:not()</span> Selector</h1>
...
<p>Select all &lt;p&gt; elements except those with class=&quot;intro&quot;:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_not">Try it yourself &raquo;</a>
...
<p>The :not() selector selects all elements except the specified 
element.</p>
<p>This is mostly used together with another selector to select everything 
except the specified element in a group (like in the example above).</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(":not(<i>selector</i>)")</div></div>
  <br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the element to not select.<br>
	This parameter accepts any kind of selector</td>
  </tr>
  </table>
&nbsp;<hr>
<p><a href="jquery_ref_selectors.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Selectors" /> jQuery Selectors</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_not.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_not.asp#top" target="_top">TOP</a> |
		<a href="sel_not.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
