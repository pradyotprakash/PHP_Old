...
<style>a.menu_event_on{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">on()</span> Method</h1>
<p><a href="jquery_ref_events.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Event Methods" /> jQuery Event Methods</a></p>

<div class="example">


<h2 class="example">Example</h2>
<p>Attach a click event handler to the &lt;p&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).on(&quot;click&quot;,function(){<br>&nbsp; alert(&quot;The 
	paragraph was 
	clicked.&quot;);<br>});</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_on" target="_blank">Try it yourself &raquo;</a>
...
<p>The on() method attaches one or more event handlers for the selected elements 
and child elements.</p>
<p>As of jQuery version 1.7, the on() method is the new replacement for the bind(), live() and delegate() 
methods. This method brings a lot of consistency to the API, and we recommend 
that you use this method, as it simplifies the jQuery code base.</p>
<p>
...
<strong>Note:</strong> Event handlers attached using the on() method will work 
for both current and FUTURE elements (like a new element created by a script).</span>&nbsp; </p>
<p>
<strong>Tip:</strong> To remove event handlers, use the <a href="event_off.asp">off()</a> method. </p>
<p><strong>Tip:</strong> To attach an event that only runs once and then removes 
itself, use the <a href="event_one.asp">one()</a> method.</p>
...
$(<i>selector</i>).on(<i>event,childSelector,data,function,map</i>)
...
<table class="reference notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>event</em></td>
    <td>Required. Specifies one or more event(s) or namespaces to attach to the 
    ...
    <td>Optional. Specifies that the event handler should only be attached to 
	the specified child elements (and not the selector itself, like the 
	deprecated delegate() method).</td>
    </tr>
	<tr>
    <td><em>data</em></td>
  ...
  <tr>
    <td><em>map</em></td>
    <td>Specifies an event map (<em>{event:function, event:function, ...})</em> containing one or more event to attach to the 
	selected elements, and functions to run when the events occur</td>
  </tr>
  </table>
<br>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjquery_event_on_bind" target="_blank">
Changing from bind() to on()</a><br>
How to use on() to achieve the same effect as bind().</p>

<p>
<a href="tryit.asp?filename=tryjquery_event_on_delegate" target="_blank">
Changing from delegate() to on()</a><br>
How to use on() to achieve the same effect as delegate().</p>

<p>
<a href="tryit.asp?filename=tryjquery_event_on_live" target="_blank">
Changing from live() to on()</a><br>
How to use on() to achieve the same effect as live().</p>

<p>
<a href="tryit.asp?filename=tryjquery_event_on_multiple" target="_blank">
Attach multiple event handlers</a><br>
How to attach multiple event handlers to an element.</p>

<p><a href="tryit.asp?filename=tryjquery_event_on_map" target="_blank">Attach multiple event handlers using 
the map parameter</a><br>
How to attach multiple event handlers to the selected elements using the map 
parameter.</p>

<p><a href="tryit.asp?filename=tryjquery_event_on_namespace" target="_blank">
Attach a custom event on an element</a><br>
How to attach a customized namespace event on an element.</p>

<p><a href="tryit.asp?filename=tryjquery_event_on_data" target="_blank">Pass along data to the function</a><br>
How to pass along data to the function.</p>

<p><a href="tryit.asp?filename=tryjquery_event_on_newel" target="_blank">Add event 
handlers for future elements </a><br>
Show that the on() method also works for elements not yet created.</p>

<p><a href="tryit.asp?filename=tryjquery_event_off" target="_blank">Remove an event handler</a><br>
How to remove an event handler using the off() method.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_on.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_on.asp#top" target="_top">TOP</a> |
		<a href="event_on.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
