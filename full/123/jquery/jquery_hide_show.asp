...
<style>a.menu_jquery_hide_show{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Effects - <span class="color_h1">Hide and Show</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_events.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_fade.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
Demonstrates a simple jQuery hide() method.</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_hide_show">Try it yourself &raquo;</a>
</div>
<p><b>Syntax:</b></p>
...
<p>The optional speed parameter specifies the speed of the hiding/showing, and 
can take the following values: &quot;slow&quot;, &quot;fast&quot;, or milliseconds.</p>
<p>The optional callback parameter is a function to be executed after  
the hide() or show() method completes (you will learn more about callback functions in a 
later chapter).</p>
<p>The following example demonstrates the speed parameter with hide():</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_hide_slow">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_toggle">Try it yourself &raquo;</a>
</div>
...
<p>The optional speed parameter can take the following values: &quot;slow&quot;, &quot;fast&quot;, or milliseconds.</p>
<p>The optional callback parameter is a function to be executed after  
toggle() completes.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_hide_show.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_hide_show.asp#top" target="_top">TOP</a> |
		<a href="jquery_hide_show.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
