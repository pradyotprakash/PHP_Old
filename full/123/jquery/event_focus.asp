...
<style>a.menu_event_focus{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">focus()</span> Method</h1>
...
<p>Attach a function to the focus event. The focus event occurs when the &lt;input&gt; 
field gets focus:</p>
<div class="example_code notranslate">
  
    $(&quot;input&quot;).focus(function(){<br>&nbsp; $(&quot;span&quot;).css(&quot;display&quot;,&quot;inline&quot;).fadeOut(2000);<br>
	});</div>
<br>
	<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_focus_ref">Try it yourself &raquo;</a>
...
<p>The focus event occurs when an element gets focus (when selected by a mouse click or by 
&quot;tab-navigating&quot; to it).</p>
<p>The focus() method triggers the focus event, or attaches a function to run when a focus event occurs.</p>
<p><strong>Tip:</strong> This method is often used together with the
<a href="event_blur.asp">blur()</a> method. </p>
<hr>

<h2>Syntax</h2>
<p>Trigger the focus event for selected elements:</p>
...
<p>Attach a function to the focus event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).focus(<i>function</i>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the focus event occurs</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_focus.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_focus.asp#top" target="_top">TOP</a> |
		<a href="event_focus.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
