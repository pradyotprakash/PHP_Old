...
<style>a.menu_ajax_ajaxerror{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">ajaxError()</span> Method</h1>
...
<p>Trigger an alert box when an AJAX request fails:</p>
<div class="example_code notranslate">
$(document).ajaxError(function(){<br>
&nbsp; alert(&quot;An error occurred!&quot;);<br>
});
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_ajaxerror" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ajaxError() method specifies a function to be run when an AJAX request fails.</p>
<p><strong>Note:</strong> As of jQuery version 1.8, this method should only be attached to document.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(document).ajaxError(<i>function(event,xhr,options,exc))</i></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>function(event,xhr,options,exc)</em></td>
    <td>
	Required. Specifies the function to run if the request fails<br>
	...
	<ul><li><em>event</em> - contains the event object</li>
		...
		<li><em>exc</em> - contains the JavaScript exception, if one occured</li></ul>
		</td>
  </tr>
</table>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_ajax_ajaxerror_options" target="_blank">
Use the xhr and options parameter</a><br>
How to use the options parameter to get a more useful error message.</p>
<hr>
<p><a href="jquery_ref_ajax.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery AJAX Methods" /> jQuery AJAX Methods</a></p>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_ajaxerror.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_ajaxerror.asp#top" target="_top">TOP</a> |
		<a href="ajax_ajaxerror.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
