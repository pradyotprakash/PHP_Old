...
<style>a.menu_event_live{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">live()</span> Method</h1>
...
<p>Hide or show a &lt;p&gt; element when a button is clicked:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).live(&quot;click&quot;,function(){<br>&nbsp; $(&quot;p&quot;).slideToggle();<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_live">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The live() method was <a href="javascript:NewWindow('deprecated.htm')">deprecated</a> 
 in jQuery version 1.7, and removed in version 1.9. Use the <a href="event_on.asp">on()</a> method instead.</span></p>
<p>The live() method attaches one or more event handlers for selected elements, 
and specifies a function to run when the events occur.</p>
<p>Event handlers attached using the live() method will work for both current 
and FUTURE elements matching the selector (like a new element created by a 
script).</p>
<p><strong>Tip:</strong> To remove event handlers, use the<span style="color: rgb(0, 0, 0); font-family: verdana, helvetica, arial, sans-serif; font-size: 12px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); display: inline !important; float: none; ">
<a href="event_die.asp">die()</a> method.</span></p>
...
$(<i>selector</i>).live(<i>event,data,function</i>)
...
<p><a href="tryit.asp?filename=tryjquery_event_live_newel" target="_blank">Add event 
handlers for future elements </a><br>
How to use the live() method to add event handlers for elements not yet created.</p>
<hr>
<p><a href="jquery_ref_events.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Event Methods" /> jQuery Event Methods</a></p>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_live.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_live.asp#top" target="_top">TOP</a> |
		<a href="event_live.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
