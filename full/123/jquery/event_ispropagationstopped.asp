...
<style>a.menu_event_ispropagationstopped{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.isPropagationStopped()</span> Method</h1>
...
<p>Check if event.stopPropagation() was called:</p>
<div class="example_code notranslate">
  
    $(&quot;div&quot;).click(function(event){<br>&nbsp; event.stopPropagation();<br>
	&nbsp; alert(event.isPropagationStopped());<br>	});
  
<br></div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_ispropagationstopped" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.isPropagationStopped() method checks whether 
<a href="event_stoppropagation.asp">event.stopPropagation()</a> was called for 
the event.</p>
<p>This method returns true if event.stopPropagation() is called, and false if 
not. </p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_ispropagationstopped.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_ispropagationstopped.asp#top" target="_top">TOP</a> |
		<a href="event_ispropagationstopped.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
