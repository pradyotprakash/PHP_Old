...
<style>a.menu_event_load{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Alert a text when an image is fully loaded:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_load">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The load() method was <a href="javascript:NewWindow('deprecated.htm')">deprecated</a> 
 in jQuery version 1.8.</span></p>

<p>The load() method attaches an event handler to the load event.</p>
<p>The load event occurs when a specified element has been 
loaded.</p>
<p>This event works with elements associated with a URL (image, script, frame, iframe), 
and the window object.</p>
<p>Depending on the browser, the load event may not trigger if the image is 
cached (Firefox and IE).</p>
<p><strong>Note:</strong> There is also a jQuery <a href="jquery_ref_ajax.asp">
AJAX</a> method called load(). Which one is called, depends on the parameters.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).load(<i>function</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the specified element is 
	done loading</td>
  </tr>
  </table>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_event_load2" target="_blank">Show some 
text when an image is fully loaded</a><br>
How to change the text of a &lt;div&gt; element when an image is 
fully loaded.<br>
</p>

<p>
<a href="tryit.asp?filename=tryjquery_event_load_window" target="_blank">Alert a 
text when the page is fully loaded</a><br>
How to alert a text when the window object is fully loaded including images.<br>
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_load.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_load.asp#top" target="_top">TOP</a> |
		<a href="event_load.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
