...
<style>a.menu_css_css{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">css()</span> Method</h1>
...
<p>Set the color property of all &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_css_name_value">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The css() method sets or returns one or more style properties for the selected elements.</p>
<p><strong>When used to return properties:</strong><br>
...
fully supported and may give different results in different browsers.</p>
<p><strong>When used to set properties:</strong><br>This method sets the specified CSS property for ALL matched elements.</p>
<hr>

<h2>Syntax</h2>
<p>Return the CSS property value:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).css(<em>property</em>)</div>
</div>

<p>Set the CSS property and value:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).css(<i>property,value</i>)</div>
</div>

<p>Set CSS property and value using a function:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).css(<i>property,</i>function<i>(index,currentvalue)</i>)
</div>
</div>

<p>Set multiple properties and values:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).css({<i>property:value</i>,<i> property:value</i>, 
...})
</div>
</div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>property</i></td>
    <td>Specifies the CSS property name, like &quot;color&quot;, &quot;font-weight&quot;, etc.</td>
  </tr>
  <tr>
    <td><i>value</i></td>
    <td>Specifies the value of the CSS property, like &quot;red&quot;, &quot;bold&quot;, etc.</td>
  </tr>
  <tr>
    <td>function(<i>index,currentvalue</i>)</td>
    <td>Specifies a function that returns the new value for the CSS property<ul>
		<li><i>index</i> - Returns the index position of the element in the set</li>
		<li><i>currentvalue</i> - Returns the current value of the CSS property</li>
	</ul>
	</td>
  </tr>
</table>
...
<p><a href="tryit.asp?filename=tryjquery_css_name" target="_blank">Return CSS property value</a><br>
Return the specified CSS property value of the FIRST matched element.</p>

<p><a href="tryit.asp?filename=tryjquery_css_name_value_func" target="_blank">Set CSS property and value using a function</a><br>
Using a function to change a CSS property for the selected elements.</p>
<p>
<a href="tryit.asp?filename=tryjquery_css_property_sets" target="_blank">Set multiple CSS properties and value pairs</a><br>
How to set multiple CSS properties and values for the selected elements.</p>
<hr>

<p><a href="jquery_ref_html.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery HTML/CSS Methods" /> jQuery 
HTML/CSS Methods</a></p>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_css.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_css.asp#top" target="_top">TOP</a> |
		<a href="css_css.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
