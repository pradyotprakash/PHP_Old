...
<style>a.menu_html_val{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">val()</span> Method</h1>
...
<p>Set the value of the &lt;input&gt; field:</p>
<div class="example_code notranslate">
    $(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;input:text&quot;).val(&quot;Glenn Quagmire&quot;);<br>	});
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_html_val_set" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The val() method returns or sets the value attribute of the selected elements.</p>
<p><strong>When used to return value: <br></strong>This method returns returns 
the value of the value attribute of the FIRST matched element.</p>
<p><strong>When used to set value: <br></strong>This method sets the value of the value attribute for ALL matched elements.</p>
<p><b>Note:</b> The val() method is mostly used with HTML form elements.</p>
<hr>

<h2>Syntax</h2>
<p>Return the value attribute:</p>
<div class="code notranslate"><div>
    $(<i>selector</i>).val()
</div>
</div>
<p>Set the value attribute:</p>
<div class="code notranslate"><div>
    $(<i>selector</i>).val(<i>value</i>)
</div>
</div>
<p>Set the value attribute using a function:</p>
<div class="code notranslate"><div>
    $(<i>selector</i>).val(function<i>(index,currentvalue)</i>)
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>value</i></td>
    <td>Required. Specifies the value of the value attribute</td>
  </tr>
   <tr>
    <td>function(<i>index,currentvalue</i>)</td>
    <td>Optional. Specifies a function that returns the value to set.<ul>
		<li><i>index</i> - Returns the index position of the element in the set</li>
		<li><i>currentvalue</i> - Returns the current value attribute of selected elements</li>
	</ul></td>
  </tr>
</table>
<br>
...
<p><a href="tryit.asp?filename=tryjquery_html_val_get" target="_blank">Return the value attribute</a><br>
How to return the value of the value attribute of the FIRST matched element.</p>

<p><a href="tryit.asp?filename=tryjquery_html_val_func" target="_blank">Set the value attribute using a function</a><br>
Using a function to set the value of the value attribute.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_val.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_val.asp#top" target="_top">TOP</a> |
		<a href="html_val.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
