...
<style>a.menu_event_keydown{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">keydown()</span> Method</h1>
...
<p>Set the background color of an &lt;input&gt; field when a keyboard key is pressed 
down:</p>
<div class="example_code notranslate">
  
    $(&quot;input&quot;).keydown(function(){<br>&nbsp; $(&quot;input&quot;).css(&quot;background-color&quot;,&quot;yellow&quot;);<br>	});
...
<p>The order of events related to the keydown event:</p>
<ol>
	<li>keydown - The key is on its way down</li>
	<li><a href="event_keypress.asp">keypress</a> - The key is pressed down</li>
	<li><a href="event_keyup.asp">keyup</a> - The key is released</li>
</ol>
<p>The keydown event occurs when a keyboard key is pressed down.</p>
<p>The keydown() method triggers the keydown event, or attaches a function to 
run when a keydown event occurs.</p>
<p><b>Tip:</b> Use the <a href="event_which.asp">event.which</a> property to return which keyboard 
key was pressed.</p>

<hr>

<h2>Syntax</h2>
<p>Trigger the keydown event for the selected elements:</p>
...
<p>Attach a function to the keydown event:</p>
<div class="code notranslate"><div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the keydown event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<p><a href="tryit.asp?filename=tryjquery_event_which" target="_blank">Determine which key was pressed</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_keydown.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_keydown.asp#top" target="_top">TOP</a> |
		<a href="event_keydown.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
