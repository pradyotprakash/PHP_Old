...
<style>a.menu_jquery_install{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">Install</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_syntax.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>Adding jQuery to Your Web Pages</h2>
...
<p>Both versions can be downloaded from <a target="_blank" href="http://jquery.com/download/">jQuery.com</a>.</p>
<p>The jQuery library is a single JavaScript file, and you reference it with the HTML &lt;script&gt; tag 
(notice that the &lt;script&gt; tag should be inside the &lt;head&gt; section):</p>


<div class="code notranslate"><div>
&lt;head&gt;<br>
&lt;script src=&quot;jquery-1.10.2.min.js&quot;&gt;&lt;/script&gt;<br>
&lt;/head&gt;
</div></div>
<p><b>Tip:</b> Place the downloaded file in the same directory as the pages where you wish to use it.<br>
</p>
...
<h2>Alternatives to Downloading</h2>
<p>If you don't want to download and host jQuery yourself, you can include it from a CDN (Content Delivery Network).</p>
<p>Both Google and Microsoft host jQuery.</p>
<p>To use jQuery from Google or Microsoft, use one of the following:</p>
<div class="example">
...
<br><a target="_blank" href="tryit.asp?filename=tryjquery_lib_google" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Get the latest available version with Google CDN:</b><br><br>
If you look at the Google URL above - the version of jQuery is specified in the 
URL (1.10.2). If you would like to use the latest version of jQuery, you can 
...
return the latest version available in the 1 series (from 1.1.0 to 1.10.2).</td>
</tr></table>
<br>
...
<div class="example_code notranslate">
&lt;head&gt;<br>
&lt;script src=&quot;http://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.10.2.min.js&quot;&gt;<br>
&lt;/script&gt;<br>
&lt;/head&gt;
</div>
<br><a target="_blank" href="tryit.asp?filename=tryjquery_lib_microsoft" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>One big advantage of using the hosted jQuery from Google or Microsoft:</b><br><br>
...
from the server closest to them, which also leads to faster loading time.</td>
</tr></table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_install.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_install.asp#top" target="_top">TOP</a> |
		<a href="jquery_install.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
