...
<style>a.menu_event_ready{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">ready()</span> Method</h1>
...
<p>Use ready() to make a function available after the document is loaded:</p>
<div class="example_code notranslate">
  
    $(document).ready(function(){<br>&nbsp; $(&quot;button&quot;).click(function(){<br>&nbsp;&nbsp;&nbsp; $(&quot;p&quot;).slideToggle();<br>&nbsp; });<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_ready">Try it yourself &raquo;</a>
...
<p>Because this event occurs after the document is ready, it is a good place to 
have all other jQuery events and functions. Like in the example above.</p>
...
$(document).ready(<i>function</i>)</div></div>
<p>The ready() method can only be used on the current document, so no selector 
is required:</p>
<div class="code notranslate"><div>
$(<i>function</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run after the document is 
	loaded</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_ready.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_ready.asp#top" target="_top">TOP</a> |
		<a href="event_ready.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
