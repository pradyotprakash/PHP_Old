...
<style>a.menu_event_data{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.data</span> Property</h1>
...
<p>Return the data passed with the on() method for each &lt;p&gt; element:</p>
<div class="example_code notranslate">
    $(&quot;p&quot;).each(function(i){<br>&nbsp;$(this).on(&quot;click&quot;,{x:i},function(event){<br>&nbsp;alert(&quot;The 
	&quot; + $(this).index() + &quot;. paragraph has data: &quot; + event.data.x);<br>&nbsp;});<br>
	});</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_data" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The event.data property contains the optional data passed to an event method when the current executing handler 
is bound.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>event</i>.data</div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_data.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_data.asp#top" target="_top">TOP</a> |
		<a href="event_data.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
