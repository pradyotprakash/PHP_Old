...
<style>a.menu_traversing_next{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">next()</span> Method</h1>
...
<p>Return the next sibling element of each &lt;li&gt; element with class name &quot;start&quot;:</p>
<div class="example_code notranslate">
  
    $(document).ready(function(){<br>&nbsp; $(&quot;li.start&quot;).next().css({&quot;color&quot;:&quot;red&quot;,&quot;border&quot;:&quot;2px 
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
...
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_next">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><strong>The DOM tree:</strong> This method traverse forward along the next 
sibling 
of DOM elements.</p>
<p>Related methods:</p>
<ul>
...
$(<i>selector</i>).next(<em>filter</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>filter</i></td>
    <td>Optional. Specifies a selector expression to narrow down the next 
	sibling search</td>
  </tr>
</table>
<br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_next2">Select 
the next sibling of each &lt;div&gt; element</a><br>
How to select the next sibling element of each &lt;div&gt; element.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_next3" target="_blank">Narrow 
down the search</a><br>
How to 
select the next sibling &lt;p&gt; element of each &lt;div&gt; element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_next.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_next.asp#top" target="_top">TOP</a> |
		<a href="traversing_next.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
