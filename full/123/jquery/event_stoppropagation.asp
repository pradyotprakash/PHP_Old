...
<style>a.menu_event_stoppropagation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.stopPropagation()</span> Method</h1>
...
<p>Stop the click event from bubbling to parent elements:</p>
<div class="example_code notranslate">
  
    $(&quot;span&quot;).click(function(event){<br>&nbsp; event.stopPropagation();<br>&nbsp; 
	alert(&quot;The span element was clicked.&quot;);<br>});<br>
	$(&quot;p&quot;).click(function(event){<br>&nbsp; alert(&quot;The p element was clicked.&quot;);<br>
	});<br>$(&quot;div&quot;).click(function(){<br>&nbsp; alert(&quot;The div element was 
	clicked.&quot;);<br>});</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_stoppropagation" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.stopPropagation() method stops the bubbling of an event to parent 
elements, preventing any parent event handlers from being executed.</p>
<p><strong>Tip: </strong>Use the <a href="event_ispropagationstopped.asp">event.isPropagationStopped()</a> method to 
check whether this method was called for the event.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_stoppropagation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_stoppropagation.asp#top" target="_top">TOP</a> |
		<a href="event_stoppropagation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
