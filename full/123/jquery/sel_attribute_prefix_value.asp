...
<style>a.menu_sel_attribute_prefix_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">[attribute|=value]</span> Selector</h1>
...
<p>Select all &lt;p&gt; elements with a title attribute that starts with the value &quot;Tomorrow&quot;:</p>
<div class="example_code notranslate">
$(&quot;p[title|='Tomorrow']&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_attributeprefix">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The [attribute|=value] selector selects each element with a specified 
attribute, with a value equal to a specified string (like &quot;en&quot;) or starting with that
string followed by a hyphen (like &quot;en-us&quot;).</p>
<p><strong>Tip:</strong> This selector is often used to handle language attributes. </p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$("[<i>attribute|</i>=<i>'value'</i>]")</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the attribute to find</td>
  </tr>
  <tr>
    <td><em>value</em></td>
    <td>Required. Specifies the string the attribute value should start with</td>
  </tr>
  </table>
<br>
<hr>
...
<p><a href="tryit.asp?filename=tryjquery_sel_attributeprefix2" target="_blank">
Handle language attributes</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_attribute_prefix_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_attribute_prefix_value.asp#top" target="_top">TOP</a> |
		<a href="sel_attribute_prefix_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
