...
<style>a.menu_sel_input_button{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:button</span> Selector</h1>
...
<p>Select &lt;button&gt; elements and &lt;input&gt; elements with type=&quot;button&quot;:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_button">Try it yourself &raquo;</a>
...
<p>The :button selector selects button elements, and input elements with type=button.</p>
<p><b>Tip:</b> Using input:button as a selector will not select the button element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_input_button.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_input_button.asp#top" target="_top">TOP</a> |
		<a href="sel_input_button.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
