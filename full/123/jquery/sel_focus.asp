...
<h1>jQuery <span class="color_h1">:focus</span> Selector</h1>
...
<p>Select the element that currently has focus:</p>
<div class="example_code notranslate">
  
    $(":focus")   
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_focus">Try it yourself &raquo;</a>
...
<p>The :focus selector selects the element that currently has focus.</p>
<p><strong>Tip:</strong> This selector is often used with a tag name or another 
selector, if not, this selector will be the same as (&quot;*:focus&quot;). </p>
