...
<style>a.menu_event_triggerhandler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">triggerHandler()</span> Method</h1>
...
<p>Trigger the select event of an &lt;input&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;input&quot;).triggerHandler(&quot;select&quot;);<br>	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_triggerhandler" target="_blank">Try it yourself &raquo;</a>
...
<p>The triggerHandler() method triggers the specified event for the selected element.</p>
<p>This method is similar to the <a href="event_trigger.asp">trigger()</a> 
method, except that trigger() also triggers the default behavior of an event 
(like form submission).</p>
<hr>
...
$(<i>selector</i>).triggerHandler(<i>event,param1,param2,...</i>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>event</em></td>
    <td>Required. Specifies the event to trigger for the specified element<br>
	</td>
  </tr>
  <tr>
    <td><i>param1,param2,...</i></td>
    <td>Optional. Additional parameters to pass on to the event handler.<br>Additional parameters are especially useful with custom events</td>
  </tr>
  </table>
<br>
<hr>
...
<p><a href="tryit.asp?filename=tryjquery_event_triggerhandler_param" target="_blank">
Pass additional parameters on to a custom event</a><br>
How to pass along additional parameters to a custom event handler.</p>

<p><a href="tryit.asp?filename=tryjquery_event_triggerhandler_trigger" target="_blank">
The difference between trigger() and triggerHandler()</a><br>
Demonstrates the difference between trigger() and triggerHandler().</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_triggerhandler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_triggerhandler.asp#top" target="_top">TOP</a> |
		<a href="event_triggerhandler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
