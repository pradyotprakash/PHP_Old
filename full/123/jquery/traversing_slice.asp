...
<style>a.menu_traversing_slice{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">slice()</span> Method</h1>
...
<p>Start the selection of &lt;p&gt; elements from the &lt;p&gt; element with index number 
2:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).slice(2)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_slice">Try it yourself &raquo;</a>
...
<p>The slice() method selects a subset of elements based on its index.</p>
<p>A subset is a set that is a part of a larger set.</p>
<p>This method is used to limit the selection of elements in a group, by a start and end point: the <em>start</em> parameter is a starting index 
(starts at 0) from which to create the subset, and the <em>stop</em> parameter is an optional ending point.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).slice(<em>start,stop</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>start</i></td>
    <td>Required. Specifies where to start the selection of elements. The index 
	numbers start at 0.<br><br><strong>Note:</strong> Using a negative number 
	will select elements from the end of the selected elements, instead of 
	the beginning.</td>
  </tr>
  <tr>
    <td><i>stop</i></td>
    <td>Optional. Specifies where to end the selection of elements. If omitted, the selection continues until the end of the 
	set. The index 
	numbers start at 0.<br><br><strong>Note:</strong> Using a negative number 
	will select elements from the end of the selected elements, instead of the 
	beginning.</td>
  </tr>
</table>
<br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_slice2">Start 
and stop</a><br>
How to 
use both parameters to select &lt;p&gt; elements from a start point and an end point.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_slice_neg">Using a 
negative number</a><br>
Using a negative number to start the selection of &lt;p&gt; elements counting from the 
end, instead of the beginning.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_slice_neg2">Using 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_slice.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_slice.asp#top" target="_top">TOP</a> |
		<a href="traversing_slice.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
