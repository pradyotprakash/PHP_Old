...
<style>a.menu_ajax_serialize{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">serialize()</span> Method</h1>
...
<p>Output the result of serialized form values:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_serialize">Try it yourself &raquo;</a>
...
<p>The serialize() method creates a URL encoded text string by serializing form 
values.</p>
...
$(<i>selector</i>).serialize()</div></div>
<br>
<hr>
<p><a href="jquery_ref_ajax.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery AJAX Methods" /> jQuery AJAX Methods</a></p>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_serialize.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_serialize.asp#top" target="_top">TOP</a> |
		<a href="ajax_serialize.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
