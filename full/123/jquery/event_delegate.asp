...
<style>a.menu_event_delegate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">delegate()</span> Method</h1>
...
<p>When a &lt;p&gt; element inside a &lt;div&gt; element is clicked, change the background 
color of all &lt;p&gt; elements:</p>
<div class="example_code notranslate">
  
    $(&quot;div&quot;).delegate(&quot;p&quot;,&quot;click&quot;,function(){<br>&nbsp; $(&quot;p&quot;).css(&quot;background-color&quot;,&quot;pink&quot;);<br>
	});</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_delegate" target="_blank">Try it yourself &raquo;</a>
...
<p>The delegate() method attaches one or more event handlers for specified elements 
that are children of selected elements, 
and specifies a function to run when the events occur.</p>
<p>Event handlers attached using the delegate() method will work for both 
current and FUTURE elements (like a new element created by a 
script).</p>
...
$(<i>selector</i>).delegate(<i>childSelector,event,data,function</i>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies one or more child elements to attach the event 
	handler to</td>
    </tr>
    <tr>
    <td><em>event</em></td>
...
<p><a href="tryit.asp?filename=tryjquery_event_delegate_newel" target="_blank">Add event 
handlers for future elements </a><br>
How to use the delegate() method to add event handlers for elements not yet created.</p>

<p><a href="tryit.asp?filename=tryjquery_event_delegate_data" target="_blank">Pass along data to the function</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_delegate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_delegate.asp#top" target="_top">TOP</a> |
		<a href="event_delegate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
