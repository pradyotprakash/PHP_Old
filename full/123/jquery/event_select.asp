...
<style>a.menu_event_select{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">select()</span> Method</h1>
...
<p>Alert a message when a text is selected in a text field:</p>
<div class="example_code notranslate">
  
    $(&quot;input&quot;).select(function(){<br>&nbsp; alert(&quot;Text marked!&quot;);<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_select_ref">Try it yourself &raquo;</a>
...
<p>The select event occurs when a text is selected (marked) in a text area 
or a text field.</p>
<p>The select() method triggers the select event, or attaches a function to run 
when a select event occurs.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the select event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).select()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_select_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the select event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).select(<i>function</i>)
    
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_select">Try it</a>  
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the select event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_select.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_select.asp#top" target="_top">TOP</a> |
		<a href="event_select.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
