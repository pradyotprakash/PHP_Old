...
<style>a.menu_event_bind{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">bind()</span> Method</h1>
...
<p>Attach a click event to the &lt;p&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).bind(&quot;click&quot;,function(){<br>&nbsp; alert(&quot;The 
	paragraph was 
	clicked.&quot;);<br>});</div>
<br>
	<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_bind_ref" target="_blank">Try it yourself &raquo;</a>
...
<p>The bind() method attaches one or more event handlers for selected elements, 
and specifies a function to run when the event occurs.</p>
<p style="color:red">As of jQuery version 1.7, the <a href="event_on.asp">on()</a> method is the preferred method for attaching event handlers for selected elements.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
    $(<i>selector</i>).bind(<i>event,data,function,map</i>)
</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>event</em></td>
    <td>Required. Specifies one or more events to attach to the elements.<br>
	<br>	Multiple event values are separated by space. Must be a valid event.</td>
  </tr>
  <tr>
    <td><em>data</em></td>
  ...
  <tr>
    <td><em>map</em></td>
    <td>Specifies an event map (<em>{event:function, event:function, ...})</em> containing one or more events to attach to the 
	elements, and functions to run when the event occurs</td>
  </tr>
</table>
<br>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjquery_event_bind_multiple" target="_blank">
Attach multiple events</a><br>
How to attach multiple events to an element.</p>
<p>
<a href="tryit.asp?filename=tryjquery_event_bind_map" target="_blank">Using an event map</a><br>
How to use an event map to attach several events/functions to the selected elements.</p>

<p><a href="tryit.asp?filename=tryjquery_event_bind_data" target="_blank">Pass along data to the function</a><br>
How to pass along data to a custom named event handler.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_bind.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_bind.asp#top" target="_top">TOP</a> |
		<a href="event_bind.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
