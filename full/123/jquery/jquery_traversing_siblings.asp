...
<style>a.menu_jquery_traversing_siblings{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Traversing - <span class="color_h1">Siblings</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_traversing_descendants.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_traversing_filtering.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Siblings share the same parent.</p>
<p class="intro">With jQuery you can traverse sideways in the DOM 
tree to find siblings of an element.</p>
<hr>
<h2>Traversing Sideways in The DOM Tree</h2>
<p>There are many useful jQuery methods for traversing sideways in the DOM tree:</p>
<ul>
	<li>siblings()</li>
	<li>next()</li>
	<li>nextAll()</li>
...
<p>The siblings() method returns all sibling elements of the selected element.</p>
<p>The following example returns all sibling elements of &lt;h2&gt;:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;h2&quot;).siblings();<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_siblings">Try it yourself &raquo;</a>
</div>
<p>You can also use an optional parameter to filter the search for siblings.</p>
<p>The following example returns all sibling elements of &lt;h2&gt; that are &lt;p&gt; 
elements:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;h2&quot;).siblings(&quot;p&quot;);<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_siblings2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery next() Method</h2>
<p>The next() method returns the next sibling element of the selected element.</p>
<p>The following example returns the next sibling of &lt;h2&gt;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;h2&quot;).next();<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_next">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery nextAll() Method</h2>
<p>The nextAll() method returns all next sibling elements of the selected element.</p>
<p>The following example returns all next sibling elements of 
&lt;h2&gt;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;h2&quot;).nextAll();<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_nextall">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery nextUntil() Method</h2>
<p>The nextUntil() method returns all next sibling elements between two given 
arguments.</p>
<p>The following example returns all&nbsp;sibling elements 
between a &lt;h2&gt; and a &lt;h6&gt; element:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).ready(function(){<br>&nbsp; $(&quot;h2&quot;).nextUntil(&quot;h6&quot;);<br>}); </div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_nextuntil">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery prev(), prevAll() &amp; prevUntil() Methods</h2>
<p>The prev(), prevAll() and prevUntil() methods work just like the methods above but with reverse functionality: they 
return previous sibling elements (traverse backwards along sibling 
elements in the DOM tree, instead of forward).</p>

<hr>
<h2>jQuery Traversing Reference</h2>
<p>For a complete overview of all jQuery Traversing methods, please go to our
<a href="jquery_ref_traversing.asp">jQuery Traversing Reference</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_traversing_descendants.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_traversing_filtering.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_traversing_siblings.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_traversing_siblings.asp#top" target="_top">TOP</a> |
		<a href="jquery_traversing_siblings.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
