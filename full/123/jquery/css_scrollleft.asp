...
<style>a.menu_css_scrollleft{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">scrollLeft()</span> Method</h1>
...
<p>Return the horizontal scrollbar position for a &lt;div&gt; element:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>&nbsp;&nbsp; alert($(&quot;div&quot;).scrollLeft());<br>
});
</div>
<br>
<a class="tryitbtn" target="_blank" href="tryit.asp?filename=tryjquery_css_scrollleft_get">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The scrollLeft() method sets or returns the horizontal scrollbar position for the selected elements.</p>
<p><b>Tip:</b> When the scrollbar is on the far left side, the position is 0.</p>
<p><strong>When used to return the position:</strong><br>
This method returns the horizontal position of the scrollbar for the FIRST matched element.</p>
<p><strong>When used to set the position:<br></strong>
This method sets the horizontal position of the scrollbar for ALL matched elements.</p>
<hr>

<h2>Syntax</h2>
<p>Return horizontal scrollbar position:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).scrollLeft()
</div>
</div>

<p>Set horizontal scrollbar position:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).scrollLeft(<em>position</em>)
</div>
</div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Specifies the horizontal scrollbar position in pixels</td>
  </tr>
   </table>
<br>
<hr>
...
<p><a href="tryit.asp?filename=tryjquery_css_scrollleft_set" target="_blank">Set the horizontal scrollbar position</a><br>
How to set the horizontal scrollbar position for an element.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_scrollleft.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_scrollleft.asp#top" target="_top">TOP</a> |
		<a href="css_scrollleft.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
