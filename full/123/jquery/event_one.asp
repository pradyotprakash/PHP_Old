...
<style>a.menu_event_one{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">one()</span> Method</h1>
...
<p>Increase the text size of a &lt;p&gt; element when it is clicked (the event 
will only trigger once for each &lt;p&gt; element):</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).one(&quot;click&quot;,function(){<br>
&nbsp; $(this).animate({fontSize:&quot;+=6px&quot;});<br>
	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_one">Try it yourself &raquo;</a>
...
<p>The one() method attaches one or more event handlers for the selected elements, 
and specifies a function to run when the event occurs.</p>
<p>When using the one() method, the event handler function is only run <strong>ONCE</strong> for 
each element.</p>
...
$(<i>selector</i>).one(<i>event,data,function</i>)
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_one.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_one.asp#top" target="_top">TOP</a> |
		<a href="event_one.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
