...
<style>a.menu_html_addclass{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">addClass()</span> Method</h1>
...
<p>Add a class name to the first &lt;p&gt; element:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;p:first&quot;).addClass(&quot;intro&quot;);<br>	});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_addclass">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The addClass() method adds one or more class names to the selected elements.</p>
<p>This method does not remove existing class attributes, it only adds one or more class names to the class attribute.</p>
<p><b>Tip:</b> To add more than one class, separate the class names with spaces.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).addClass(<i>classname</i>,function(<i>index,oldclass</i>))</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>classname</i></td>
    <td>Required. Specifies one or more class names to be added</td>
  </tr>
  <tr>
  <td>function(<i>index,currentclass</i>)</td>
    <td>Optional. Specifies a function that returns one or more class names to be added<ul>
		<li><i>index</i> - Returns the index position of the element in the set</li>
		<li><i>currentclass</i> - Returns the current class name of the selected 
		element</li>
	</ul>
	</td>
  </tr>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_addclass_two">Add two classes to an element</a><br>
How to add two class names to a specified element.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_addclass_func">Add classes using a function</a><br>
How to add classes to selected elements using a function.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_addclass.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_addclass.asp#top" target="_top">TOP</a> |
		<a href="html_addclass.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
