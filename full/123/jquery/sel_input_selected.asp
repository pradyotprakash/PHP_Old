...
<style>a.menu_sel_input_selected{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:selected</span> Selector</h1>
...
<p>Select the pre-selected item(s) in a drop-down list:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_selected">Try it yourself &raquo;</a>
...
<p>The :selected selector selects option elements that are pre-selected.</p>
<p><b>Note</b>: This selector will not work on checkboxes or radio buttons. Use the
<a href="sel_input_checked.asp">:checked</a> selector instead.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_input_selected.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_input_selected.asp#top" target="_top">TOP</a> |
		<a href="sel_input_selected.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
