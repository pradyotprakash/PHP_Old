...
<style>a.menu_ajax_getjson{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">getJSON()</span> Method</h1>
...
<p>Get JSON data using an AJAX request, and output the result:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; $.getJSON(&quot;demo_ajax_json.js&quot;,function(result){<br>
&nbsp;&nbsp;&nbsp; $.each(result, function(i, field){<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $(&quot;div&quot;).append(field + &quot; &quot;);<br>
&nbsp;&nbsp;&nbsp; });<br>
&nbsp; });<br>
});
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_getjson" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getJSON() method is used to get JSON data using an AJAX HTTP GET request.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).getJSON(<i>url,data,success(data,status,xhr))</i></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td><em>data</em></td>
    <td>Optional. Specifies data to be sent to the server</td>
    </tr>
	<tr>
    <td><em>success(<i>data,status,xhr</i>)</em></td>
    <td>Optional. Specifies the function to run if the request succeeds<br>
	Additional parameters:<ul>
		<li><em>data</em> - contains the data returned from the server.</li>
		<li><em>status</em> - contains a string containing request status 
	(&quot;success&quot;, &quot;notmodified&quot;, &quot;error&quot;, &quot;timeout&quot;, or &quot;parsererror&quot;).</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_getjson.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_getjson.asp#top" target="_top">TOP</a> |
		<a href="ajax_getjson.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
