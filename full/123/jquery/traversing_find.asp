...
<style>a.menu_traversing_find{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">find()</span> Method</h1>
...
<p>Return all &lt;span&gt; elements that are descendants of &lt;ul&gt;:</p>
<div class="example_code notranslate">
  
    $(document).ready(function(){<br>&nbsp; $(&quot;ul&quot;).find(&quot;span&quot;).css({&quot;color&quot;:&quot;red&quot;,&quot;border&quot;:&quot;2px 
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
<div class="example_code notranslate">body (great-grandparent)
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_find">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The find() method returns descendant elements of the selected element.</p>
<p>A descendant is a child, grandchild, great-grandchild, and so on.</p>
<p><strong>The DOM tree:</strong> This method traverse downwards along 
descendants of DOM elements, all the way down to the last descendant. To only 
traverse a single level down the DOM tree (to return direct children), use the <a href="traversing_children.asp">
children()</a> method.</p>
<p><strong>Note:</strong> The <em>filter</em> parameter is required for the 
find() method, unlike the rest of the tree traversal methods.</p>
<p><strong>Tip:</strong> To return all of the descendant elements, use the &quot;*&quot; 
selector.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).find(<em>filter</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>filter</i></td>
    <td>Required. A selector expression, element or jQuery object to filter the 
	search for descendants<br><br><strong>Note:</strong> To return multiple descendants, separate 
	each expression with a comma.</td>
  </tr>
</table>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_traversing_find_all" target="_blank">Return 
all descendant elements of &lt;html&gt;</a><br>
Using the &quot;*&quot; selector to return all elements that are descendants of &lt;html&gt;.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_find2">Return 
all &lt;span&gt; elements that are descendants of &lt;ul&gt;</a><br>
How to return all &lt;span&gt; elements that are descendants of an &lt;ul&gt; element.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_find3">Only select descendants with a given class name</a><br>
How to return 
descendant elements with class name &quot;1&quot;.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_find4">Return 
multiple descendants</a><br>
How to 
return multiple descendant elements.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_find5">Filter 
the descendant search with a jQuery collection of all &lt;ul&gt; elements</a><br>
How to 
return all &lt;span&gt; elements that are descendants of an &lt;ul&gt; element with a jQuery 
object.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_find6">Show 
the descendants of an element by tag names</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_find.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_find.asp#top" target="_top">TOP</a> |
		<a href="traversing_find.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
