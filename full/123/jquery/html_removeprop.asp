...
<title>jQuery removeProp() Method</title>
<style>a.menu_html_removeprop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">removeProp()</span> Method</h1>
...
<p>The removeProp() method removes a property set by the <a href="html_prop.asp">
prop()</a> method.</p>
<p><b>Note:</b> Do not use this method to remove HTML attributes like style, id, 
or checked. Use the <a href="html_removeattr.asp">removeAttr()</a> method 
instead.</p>
...
$(<i>selector</i>).removeProp(<i>property</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Specifies the name of the property to remove</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_removeprop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_removeprop.asp#top" target="_top">TOP</a> |
		<a href="html_removeprop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
