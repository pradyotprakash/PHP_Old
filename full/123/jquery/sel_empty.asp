...
<h1>jQuery <span class="color_h1">:empty</span> Selector</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_empty">Try it yourself &raquo;</a>
...
<p>The :empty selector selects empty elements.</p>
<p>An empty element is an element without child elements or text.</p>
