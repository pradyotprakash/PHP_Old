...
<style>a.menu_event_stopimmediatepropagation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.stopImmediatePropagation()</span> Method</h1>
...
<p>Execute the first event handler, and stop the rest of the event handlers from being 
executed:</p>
<div class="example_code notranslate">
  
    $(&quot;div&quot;).click(function(event){<br>&nbsp; alert(&quot;Event handler 1 executed&quot;);<br>&nbsp; 
	event.stopImmediatePropagation();<br>});<br>$(&quot;div&quot;).click(function(event){<br>&nbsp; 
	alert(&quot;Event handler 2 executed&quot;);<br>});<br>$(&quot;div&quot;).click(function(event){<br>&nbsp; 
	alert(&quot;Event handler 3 executed&quot;);<br>});<br></div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_stopimmediateprop" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.stopImmediatePropagation() method stops the rest of the event handlers from being 
executed.</p>
<p>This method also stops the event from bubbling up the DOM tree.</p>
<p><strong>Tip: </strong>Use the 
<a href="event_isimmediatepropagationstopped.asp">event.isImmediatePropagationStopped()</a> 
method to check whether this method was called for the event.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_stopimmediatepropagation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_stopimmediatepropagation.asp#top" target="_top">TOP</a> |
		<a href="event_stopimmediatepropagation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
