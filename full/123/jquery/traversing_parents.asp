...
<style>a.menu_traversing_parents{font-weight:bold;}</style>
<meta charset="utf-8">
...
$(document).ready(function(){
  $("span.ex").parents(".ex,div.example_code").css({"color":"red","border":"2px solid red"});
});
</script>
<style>
.ancestors *
...
<h1>jQuery <span class="color_h1">parents()</span> Method</h1>
<p><a href="jquery_ref_traversing.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery HTML Methods" /> jQuery Traversing Methods</a></p>
<div class="example">
<h2 class="example">Example</h2>
<p>Return all ancestor elements of &lt;span&gt;:</p>
<div class="example_code notranslate">
    $(document).ready(function(){<br>&nbsp; $(&quot;span&quot;).parents().css({&quot;({&quot;color&quot;:&quot;red&quot;,&quot;border&quot;:&quot;2px 
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
<div class="example_code notranslate ancestors">body (great-great-grandparent)
  <div class="ex">div (great-grandparent)
    <ul class="ex">ul (grandparent)  
      <li class="ex">li (direct parent)
        <span class="ex">span</span>
      </li>
    </ul>   
  </div>
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_parents">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The parents() method returns all ancestor elements of the selected element.</p>
<p>An ancestor is a parent, grandparent, great-grandparent, and so on.</p>
<p><strong>The DOM tree:</strong> This method traverse upwards from the parent 
element along ancestors of DOM elements, all the way up to the document's root 
element (&lt;html&gt;).</p>
<p><strong>Note:</strong> If the filter parameter is empty, this function will select all ancestors of a set of 
elements, from the direct parent and all the way up to &lt;body&gt; and &lt;html&gt;. It is 
therefore often useful to pass a selector expression to narrow down the search 
result.</p>
<p>This method is similar to <a href="traversing_closest.asp">closest()</a>, in 
that they both traverse up the DOM tree. The differences are as follows:</p>
<p><strong><em>parents()</em></strong></p>
<ul>
	<li>Begins with the parent element</li>
	<li>Travels up the DOM tree and returns all ancestors that matches the 
	passed expression</li>
	<li>The returned jQuery object contains zero or more than one element</li>
</ul>
<p><strong><em>closest()</em></strong></p>
<ul>
	<li>Begins with the current element</li>
	<li>Travels up the DOM tree and returns the first ancestor that 
	matches the passed expression</li>
	<li>The returned jQuery object contains zero or one element</li>
</ul>
<p><strong>Other related methods:</strong></p>
<ul>
	<li><a href="traversing_parent.asp">parent()</a> - returns the direct parent 
	element of the selected element</li>
	<li><a href="traversing_parentsuntil.asp">parentsUntil()</a> - returns all 
	ancestor elements between two given arguments</li>
</ul>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).parents(<em>filter</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>filter</i></td>
    <td>Optional. Specifies a selector expression to narrow down the search for 
	ancestors<br><br><strong>Note:</strong> To return multiple ancestors, 
	separate each expression with a comma.</td>
  </tr>
</table>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_traversing_parents2" target="_blank">
Narrow down the search</a><br>
How to use the filter parameter to 
return all ancestors of &lt;span&gt; that are &lt;ul&gt; elements.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_parents_multiple" target="_blank">
Return multiple ancestors</a><br>
How to use the filter parameter to 
return all ancestors of &lt;span&gt; that are &lt;li&gt; and &lt;div&gt; elements.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_parent3">Show 
the ancestors of an element by tag names</a><br>
A demonstration which shows who the ancestors of a &lt;span&gt; element 
actually are.</p>

<hr>
<p><a href="jquery_ref_traversing.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery HTML Methods" /> jQuery 
Traversing Methods</a></p>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_parents.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_parents.asp#top" target="_top">TOP</a> |
		<a href="traversing_parents.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
