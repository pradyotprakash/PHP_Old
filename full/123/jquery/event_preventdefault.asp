...
<style>a.menu_event_preventdefault{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.preventDefault()</span> Method</h1>
...
<p>Prevent a link from opening the URL:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_preventdefault" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.preventDefault() method stops the default action of an element from 
happening.</p>
<p>For example:</p>
<ul>
...
<p><strong>Tip: </strong>Use the <a href="event_isdefaultprevented.asp">event.isDefaultPrevented()</a> 
method to check whether the preventDefault() method was called for the event.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_preventdefault.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_preventdefault.asp#top" target="_top">TOP</a> |
		<a href="event_preventdefault.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
