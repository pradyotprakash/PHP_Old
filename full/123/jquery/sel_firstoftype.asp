...
<style>a.menu_sel_firstoftype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:first-of-type</span> Selector</h1>
...
<p>Select every &lt;p&gt; element that is the first &lt;p&gt; element of its parent:</p>
<div class="example_code notranslate">
  
    $(&quot;p:first-of-type&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_firstoftype">Try it yourself &raquo;</a>
...
<p>The :first-of-type selector selects all elements that are the first child, of 
a particular type, of their parent.</p>
<p><strong>Tip:</strong> This is the same as :nth-of-type(1).</p>
<p><strong>Tip:</strong> Use the <a href="sel_lastoftype.asp">:last-of-type</a> 
selector to select all elements that are the last child, of a particular type, 
of their parent.</p>
...
<p>
<a href="tryit.asp?filename=tryjquery_sel_firstoftype2" target="_blank">Select 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_firstoftype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_firstoftype.asp#top" target="_top">TOP</a> |
		<a href="sel_firstoftype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
