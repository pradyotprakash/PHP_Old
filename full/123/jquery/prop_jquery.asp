...
<title>jQuery jquery Property</title>
<style>a.menu_prop_jquery{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">jquery</span> Property</h1>
...
<p>Alert the current running jQuery version:</p>
<div class="example_code notranslate">
    $(&quot;button&quot;).on(&quot;click&quot;,function(){ <br>&nbsp; var version = $().jquery; <br>&nbsp; 
	alert(&quot;You are running jQuery version: &quot; + version);<br>});</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_prop_jquery" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The jquery property returns a string containing the jQuery version number.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_jquery.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_jquery.asp#top" target="_top">TOP</a> |
		<a href="prop_jquery.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
