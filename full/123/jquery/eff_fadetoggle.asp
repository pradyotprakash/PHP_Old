...
<style>a.menu_eff_fadetoggle{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">fadeToggle()</span> Method</h1>
...
<p>Toggle between fading in and fading out different boxes:</p>
...
<p>The fadeToggle() method toggles between the <a href="eff_fadein.asp">fadeIn()</a> and <a href="eff_fadeout.asp">fadeOut()</a> methods.</p>
...
$(<i>selector</i>).fadeToggle(<i>speed,easing,callback</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>speed</em></td>
    <td>Optional. Specifies the speed of the fading effect. Default value is 400 
  ...
  <tr>
	...
	effect. Default value is &quot;swing&quot;<p>Possible values:</p>
	<ul>
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the fadeToggle() method is 
	completed
	<br><br>To learn more about callback, please read our <a href="jquery_callback.asp">jQuery Callback</a>	chapter
	</td>
  </tr>
  </table>
  <br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_fadetoggle2">fadeToggle() 
- Using the speed parameter</a><br>
How to use the speed parameter to specify the speed of the fading effect.</p>
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_fadetoggle3">fadeToggle() 
- Using the callback parameter</a><br>
How to use the callback parameter to execute a function after the fadeToggle() method is completed.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_fadetoggle.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_fadetoggle.asp#top" target="_top">TOP</a> |
		<a href="eff_fadetoggle.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
