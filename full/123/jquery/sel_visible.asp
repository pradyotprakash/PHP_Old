...
<style>a.menu_sel_visible{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:visible</span> Selector</h1>
...
<p>Select all visible &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_visible">Try it yourself &raquo;</a>
...
<p>The :visible selector selects every element that is currently visible.</p>
<p>Visible elements are elements that are not:</p>
<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_visible.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_visible.asp#top" target="_top">TOP</a> |
		<a href="sel_visible.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
