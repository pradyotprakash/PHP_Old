...
<title>jQuery Effect show() Method</title>
<style>a.menu_eff_show{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Effect <span class="color_h1">show()</span> Method</h1>
...
<p>Show all hidden &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_show_hide">Try it yourself &raquo;</a>
...
<p>The show() method shows the hidden, selected elements.</p>
<p><b>Note:</b> show() works on elements hidden with jQuery methods and display:none in CSS (but not visibility:hidden).</p>
<p><b>Tip:</b> To hide elements, look at the <a href="eff_hide.asp">hide()</a> method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).show(<i>speed,easing,callback</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>speed</em></td>
    <td>Optional. Specifies the speed of the show effect. Default value is 400 
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the show() method is completed
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_eff_show_hide_speed">show() - 
Using the speed parameter</a><br>
How to use the speed parameter when hiding/showing an element.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_eff_show_hide_callback">show() - 
Using the callback parameter</a><br>
How to use the callback parameter when hiding/showing an element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_show.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_show.asp#top" target="_top">TOP</a> |
		<a href="eff_show.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
