...
<style>a.menu_sel_odd{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:odd</span> Selector</h1>
...
<p>Select every other (odd) &lt;tr&gt; element:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_odd">Try it yourself &raquo;</a>
...
<p>The :odd selector selects each element with an odd index number (like: 1, 3, 
5, etc.).</p>
<p>The index numbers start at 0.</p>
<p>This is mostly used together with another selector to select every odd 
indexed element in a group (like in the example above).</p>
<p><b>Tip:</b> Use the <a href="sel_even.asp">:even</a> selector to select 
elements with even index numbers.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_odd.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_odd.asp#top" target="_top">TOP</a> |
		<a href="sel_odd.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
