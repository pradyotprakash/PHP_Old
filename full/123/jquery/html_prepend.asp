...
<style>a.menu_html_prepend{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">prepend()</span> Method</h1>
...
<p>Insert content at the beginning of all &lt;p&gt; elements:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; $(&quot;p&quot;).prepend(&quot;&lt;b&gt;Prepended text&lt;/b&gt;&quot;);<br>
});
</div>
<br>
...
<p>The prepend() method inserts specified content at the beginning of the selected elements.</p>
<p><b>Tip:</b> To insert content at the end of the selected elements, use the 
<a href="html_append.asp">append()</a> method. </p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).prepend(<i>content</i>,function<i>(index,html)</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>content</i></td>
    <td>Required. Specifies the content to insert (can contain HTML tags)
	  <p>Possible values:</p>
	<ul>
		<li>HTML elements</li>
    ...
    <tr>
    <td>function<i>(index,html)</i></td>
    <td>Optional. Specifies a function that returns the content to insert
    <ul>
		<li><i>index</i> - Returns the index position of the element in the set</li>
		<li><i>html</i> - Returns the current HTML of the selected element</li>
	</ul>
	</td>
    </tr>
  </table>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_prepend_ref">prepend() - Create content with HTML, jQuery and DOM</a><br>
Insert content with the prepend() method.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_prepend_func">Prepend content using a function</a><br>
Using a function to insert content at the beginning of the selected elements. </p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_prepend.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_prepend.asp#top" target="_top">TOP</a> |
		<a href="html_prepend.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
