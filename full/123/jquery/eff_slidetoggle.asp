...
<style>a.menu_eff_slidetoggle{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">slideToggle()</span> Method</h1>
...
<p>Toggle between slideUp() and slideDown() for all &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_slidetoggle">Try it yourself &raquo;</a>
...
<p>The slideToggle() method toggles between <a href="eff_slideup.asp">slideUp()</a> 
and <a href="eff_slidedown.asp">slideDown()</a> for the selected elements.</p>
<p>This method checks the selected elements for visibility. slideDown() is run if an 
element is hidden. slideUp() is run if an element is visible - This creates a 
toggle effect.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).slideToggle(<i>speed,easing,callback</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>speed</em></td>
    <td>Optional. Specifies the speed of the slide effect. Default value is 400 
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the 
	slideToggle() method is completed
	<p>To learn more about callback, visit our <a href="jquery_callback.asp">jQuery Callback chapter</a></p>
	</td>
  </tr>
  </table>
  <br>
...
<p>
<a href="tryit.asp?filename=tryjquery_eff_slidetoggle_speed" target="_blank">
slideToggle() - Using the speed parameter</a><br>
How to use the speed parameter to specify the speed of the slide effect.</p>

<p>
<a href="tryit.asp?filename=tryjquery_eff_slidetoggle_callback" target="_blank">
slideToggle() - Using the callback parameter</a><br>
How to use the callback parameter when toggling between slideUp() and slideDown().</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_slidetoggle.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_slidetoggle.asp#top" target="_top">TOP</a> |
		<a href="eff_slidetoggle.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
