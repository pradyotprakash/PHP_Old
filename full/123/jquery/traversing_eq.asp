...
<style>a.menu_traversing_eq{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">eq()</span> Method</h1>
...
<p>Select the second &lt;p&gt; element (index number 1):</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).eq(1).css(&quot;background-color&quot;,&quot;yellow&quot;);</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_eq">Try it yourself &raquo;</a>
...
<p>The eq() method returns an element with a specific index number  
...
$(<i>selector</i>).eq(<em>index</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>index</i></td>
    <td>Required. Specifies the index of the element. Can either be a positive 
	or negative number.<br><br><strong>Note:</strong> Using a negative number 
	will start the index count from the end of the selected elements, instead of the beginning.</td>
  </tr>
</table>
<br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_eq2">Using a 
negative number</a><br>
Using a negative number to return the second &lt;p&gt; element from the end of the 
selected elements.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_eq.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_eq.asp#top" target="_top">TOP</a> |
		<a href="traversing_eq.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
