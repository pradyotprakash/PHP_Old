...
<title>jQuery mousedown() Method</title>
<style>a.menu_event_mousedown{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">mousedown()</span> Method</h1>
...
<p>Press down the left mouse button over a &lt;div&gt; element to insert some text:</p>
<div class="example_code notranslate">
  
    $(&quot;div&quot;).mousedown(function(){<br>&nbsp; $(this).after(&quot;Mouse 
	button pressed down.&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_mup_mdown_ref">Try it yourself &raquo;</a>
...
<p>The mousedown event occurs when the left mouse button is pressed down over 
the selected element.</p>
<p>The mousedown() method triggers the mousedown event, or attaches a function 
to run when a mousedown event occurs.</p>
<p><strong>Tip:</strong> This method is often used together with the
<a href="event_mouseup.asp">mouseup()</a> method. </p>
<hr>

<h2>Syntax</h2>
<p>Trigger the mousedown event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mousedown()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_mousedown_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the mousedown event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mousedown(<i>function</i>)

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_mousedown">Try it</a>  
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the mousedown event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_mousedown.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_mousedown.asp#top" target="_top">TOP</a> |
		<a href="event_mousedown.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
