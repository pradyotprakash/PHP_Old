...
<style>a.menu_html_outerheight{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">outerHeight()</span> Method</h1>
...
<p>Return the outer height of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>
&nbsp; alert($(&quot;div&quot;).outerHeight());<br>});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_outerheight_ref">Try it yourself &raquo;</a>
...
<p>
The outerHeight() method returns the outer height of <span lang="no-bok">the 
FIRST matched element.</span></p>
<p>
As the image below illustrates, this method includes padding and border.</p>

<p><b>Tip:</b> To include the margin, use outerHeight(true).</p>

<p style="text-align:center;">
<img border="0" alt="jQuery Dimensions" src="img_outerheight.gif"></p>
...
$(<i>selector</i>).outerHeight(<em>includeMargin</em>)</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>includeMargin</em></td>
    <td>Optional. A Boolean value specifying whether or not to include the 
	margin 
    <ul>
		<li><i>false</i> - Default. Does not include the margin</li>
		<li><i>true</i> - Includes the margin</li>
	</ul>
    </td>
  </tr>
   </table>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_html_outerheightmargin_ref">
Include the margin</a><br>
Specifiy whether or not to include the margin.</p>


<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_html_all_dimensions_ref">Display dimensions with related methods</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_outerheight.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_outerheight.asp#top" target="_top">TOP</a> |
		<a href="html_outerheight.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
