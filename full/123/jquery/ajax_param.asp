...
<title>jQuery param() Method</title>
<style>a.menu_ajax_param{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">param()</span> Method</h1>
...
<p>Output the result of a serialized object:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; $(&quot;div&quot;).text($.param(personObj));<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_param">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The param() method creates a serialized representation of an array or an object.</p>
<p>The serialized values can be used in the URL query string when making an AJAX request.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$.param(<i>object,trad</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>object</em></td>
    <td>Required. Specifies an array or object to serialize</td>
  </tr>
  <tr>
    <td><em>trad</em></td>
    <td>Optional. A Boolean value specifying whether or not to use the traditional style of param serialization</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_param.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_param.asp#top" target="_top">TOP</a> |
		<a href="ajax_param.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
