...
<style>a.menu_jquery_ajax_load{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery - <span class="color_h1">AJAX load() Method</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_ajax_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_ajax_get_post.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>jQuery load() Method</h2>
<p>The jQuery load() method is a simple, but powerful AJAX method.</p>
<p>The load() method loads data from a 
server and puts the returned data into the selected element.</p>
<p><b>Syntax:</b></p>
<div class="code notranslate">
	<div>
$(<i>selector</i>).load(<i>URL,data,callback</i>);
</div></div>
<p>The required URL parameter specifies the URL you wish to load.</p>
<p>The optional data parameter specifies a set of querystring key/value pairs to send along with 
the request.</p>
<p>The optional callback parameter is the name of a function to be executed 
after the load() method is completed.</p>
<p><b>Here is the content of our example file: &quot;demo_test.txt&quot;:</b></p>
<div class="code notranslate">
	<div>
&lt;h2&gt;jQuery and AJAX is FUN!!!&lt;/h2&gt;<br>
&lt;p id=&quot;p1&quot;&gt;This is some text in a paragraph.&lt;/p&gt;</div></div>
<p>The following example loads the content of the file &quot;demo_test.txt&quot; into a 
specific &lt;div&gt; element:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;#div1&quot;).load(&quot;demo_test.txt&quot;);</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_load">Try it yourself &raquo;</a>
</div>
<p>It is also possible to add a jQuery selector to the URL parameter. </p>
<p>The following example loads the content of the element with id=&quot;p1&quot;, inside 
the file &quot;demo_test.txt&quot;, into a specific &lt;div&gt; element:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;#div1&quot;).load(&quot;demo_test.txt #p1&quot;);</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_load2">Try it yourself &raquo;</a>
</div>
<p>The optional callback parameter specifies a callback function to run when the 
load() method is completed. The callback function can have different parameters:</p>
<ul>
...
<p>The following example displays an alert box after the load() method 
completes. If the load() method has succeed, it displays &quot;External content 
loaded successfully!&quot;, and if it fails it displays an error message:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp; $(&quot;#div1&quot;).load(&quot;demo_test.txt&quot;,function(responseTxt,statusTxt,xhr){<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_load_callback">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>jQuery AJAX Reference</h2>

<p>For a complete overview of all jQuery AJAX methods, please go to our <a href="jquery_ref_ajax.asp">jQuery 
AJAX Reference</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_ajax_load.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_ajax_load.asp#top" target="_top">TOP</a> |
		<a href="jquery_ajax_load.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
