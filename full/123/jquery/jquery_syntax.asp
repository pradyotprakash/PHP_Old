...
<style>a.menu_jquery_syntax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">Syntax</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_install.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_selectors.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">With jQuery you select (query) HTML elements and perform &quot;actions&quot; on them.</p>
<hr>
...
<td><b>Are you familiar with CSS selectors?</b><br><br>
jQuery uses CSS syntax to select elements. You will learn more about the selector syntax in the next chapter of this tutorial.</td>
</tr>
</table>
<br>
<hr>
...
<br>&nbsp;&nbsp; <i>// jQuery methods go here...</i><br><br>
});
</div>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_syntax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_syntax.asp#top" target="_top">TOP</a> |
		<a href="jquery_syntax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
