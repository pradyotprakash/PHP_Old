...
<title>jQuery finish() Method</title>
<style>a.menu_eff_finish{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">finish()</span> Method</h1>
...
<p>Finish the currently running animation:</p>
<div class="example_code notranslate">
  
    $(&quot;#complete&quot;).click(function(){<br>&nbsp; $(&quot;div&quot;).finish();<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_finish">Try it yourself &raquo;</a>
...
<p>The finish() method stops the currently-running animations, removes all 
queued animations, and completes all animations for the selected elements.</p>
<p>This method is similar to the .stop(true,true) method, except that finish() also 
causes the CSS property of all queued animations to stop. </p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).finish(<i>queueName</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>queueName</i></td>
    <td>Optional. Specifies the name of the queue to stop animations</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_finish.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_finish.asp#top" target="_top">TOP</a> |
		<a href="eff_finish.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
