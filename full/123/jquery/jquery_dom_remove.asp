...
<style>a.menu_jquery_dom_remove{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery - <span class="color_h1">Remove Elements</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_dom_add.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_css_classes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">With jQuery, it is easy to remove existing HTML elements.</p>

<hr>
<h2>Remove Elements/Content</h2>
<p>To remove elements and content, there are mainly two jQuery methods:</p>
<ul>
...
<p>The jQuery remove() method removes the selected element(s) and its child 
elements.</p>
<div class="example">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_remove">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>jQuery empty() Method</h2>

<p>The jQuery empty() method removes the child elements of the selected element(s).</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;#div1&quot;).empty();</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_empty">Try it yourself &raquo;</a>
</div>

<br>
<hr>
<h2>Filter the Elements to be Removed</h2>
<p>The jQuery remove() method also accepts one parameter, which allows you to 
filter the elements to be removed.</p>
<p>The parameter can be any of the jQuery selector syntaxes.</p>
<p>The following example removes all &lt;p&gt; elements with class=&quot;italic&quot;:&nbsp;&nbsp; </p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;p&quot;).remove(&quot;.italic&quot;);</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_dom_remove2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_dom_remove.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_dom_remove.asp#top" target="_top">TOP</a> |
		<a href="jquery_dom_remove.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
