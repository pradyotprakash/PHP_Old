...
<style>a.menu_event_die{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">die()</span> Method</h1>
...
<p>Remove all event handlers added with the live() method for all &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_die">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The die() method was <a href="javascript:NewWindow('deprecated.htm')">deprecated</a> 
 in jQuery version 1.7, and removed in version 1.9. Use the <a href="event_off.asp">off()</a> method instead.</span></p>

<p>The die() method removes one or more event handlers, added with the
<a href="event_live.asp">live()</a> method, for the selected elements.</p>
...
$(<i>selector</i>).die(<i>event,function</i>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>event</em></td>
    <td>Required. Specifies one or more event handlers to remove.<br><br>
	Multiple event values are separated by space. Must be a valid event</td>
  </tr>
  <tr>
    <td><em>function</em></td>
    <td>Optional. Specifies a specific function to remove</td>
  </tr>
</table>
<br>
<hr>
...
<p><a href="tryit.asp?filename=tryjquery_event_die_func" target="_blank">Remove 
one specific event handler</a><br>
How to use the die() method to remove only one specific event 
handler from the selected elements.</p>
<hr>
<p><a href="jquery_ref_events.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Event Methods" /> jQuery Event Methods</a></p>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_die.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_die.asp#top" target="_top">TOP</a> |
		<a href="event_die.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
