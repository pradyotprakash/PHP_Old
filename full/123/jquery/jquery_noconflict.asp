...
<title>jQuery The noConflict() Method</title>
<style>a.menu_jquery_noconflict{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery - <span class="color_h1">The noConflict() Method</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_ajax_get_post.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">What if you wish to use other frameworks on your pages, 
while still using jQuery?</p>
<hr>

<h2>jQuery and Other JavaScript Frameworks</h2>
<p>As you already know; jQuery uses the $ sign as a shortcut for jQuery.</p>
<p><b>What if other JavaScript frameworks also use the $ sign as a shortcut?</b></p>
<p>Some other popular JavaScript frameworks are: MooTools, Backbone, Sammy, 
Cappuccino, Knockout, JavaScript MVC, Google Web Toolkit, Google Closure, Ember, 
Batman, and Ext JS.</p>
<p>Some of the other frameworks also use the $ character as a shortcut (just 
like jQuery), and then you suddenly have two different frameworks using the same 
shortcut, which might result in that your scripts stop working.</p>
<p>The jQuery team have already thought about  
this, and implemented the noConflict() method.</p>
<hr>

<h2>The jQuery noConflict() Method</h2>
<p>The noConflict() method releases the hold on the $ shortcut identifier, 
so that other scripts can use it.</p>
<p>You can of course still use jQuery, simply by 
writing the full name instead of the shortcut:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$.noConflict();<br>
jQuery(document).ready(function(){<br>
&nbsp; jQuery(&quot;button&quot;).click(function(){<br>
&nbsp;&nbsp;&nbsp; jQuery(&quot;p&quot;).text(&quot;jQuery is still working!&quot;);<br>
&nbsp; });<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_noconflict">Try it yourself &raquo;</a>
</div>
<p>You can also create your 
own shortcut very easily. The noConflict() method returns a reference to jQuery, 
that you can save in a&nbsp; variable, for later use. Here is an example:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
var jq = $.noConflict();<br>
jq(document).ready(function(){<br>
&nbsp; jq(&quot;button&quot;).click(function(){<br>
&nbsp;&nbsp;&nbsp; jq(&quot;p&quot;).text(&quot;jQuery is still working!&quot;);<br>
&nbsp; });<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_noconflict2">Try it yourself &raquo;</a>
</div>
<p>If you have a block of jQuery code which uses the $ shortcut and you do not 
...
&nbsp;&nbsp;&nbsp; $(&quot;p&quot;).text(&quot;jQuery is still working!&quot;);<br>
&nbsp; });<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_noconflict3">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>jQuery Misc Reference</h2>
<p>For a complete overview of all jQuery Misc methods, please go to our
<a href="jquery_ref_misc.asp">jQuery Misc Reference</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_noconflict.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_noconflict.asp#top" target="_top">TOP</a> |
		<a href="jquery_noconflict.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
