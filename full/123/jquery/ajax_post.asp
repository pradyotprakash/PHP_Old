...
<style>a.menu_ajax_post{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">post()</span> Method</h1>
...
&nbsp; $.post(&quot;demo_test.asp&quot;,function(data,status){<br>
&nbsp;&nbsp;&nbsp; alert(&quot;Data: &quot; + data + &quot;\nStatus: &quot; + status);<br>
&nbsp; });<br>
});
</div>
<br>
<a class="tryitbtn" target="_blank" href="tryit.asp?filename=tryjquery_ajax_post">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Change the text of a &lt;div&gt; element using an AJAX POST request:</p>
<div class="example_code notranslate">
$(&quot;input&quot;).keyup(function(){<br>
&nbsp; txt=$(&quot;input&quot;).val();<br>
&nbsp; $.post(&quot;demo_ajax_gethint.asp&quot;,{suggest:txt},function(result){<br>
&nbsp;&nbsp;&nbsp; $(&quot;span&quot;).html(result);<br>
&nbsp; });<br>
});
</div>
<br>
<a class="tryitbtn" target="_blank" href="tryit.asp?filename=tryjquery_ajax_post2">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The $.post() method loads data from the server using a HTTP POST request.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).post(<i>URL,data,function(data,status,xhr),dataType)</i></div></div>
<br>
<table class="reference notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>URL</em></td>
    <td>Required. Specifies the url to send the request to</td>
    </tr>
	<tr>
    <td><em>data</em></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_post.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_post.asp#top" target="_top">TOP</a> |
		<a href="ajax_post.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
