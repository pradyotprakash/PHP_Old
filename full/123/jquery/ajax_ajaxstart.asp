...
<title>jQuery ajaxStart() Method</title>
<style>a.menu_ajax_ajaxstart{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">ajaxStart()</span> Method</h1>
...
<p>Show a &quot;loading&quot; indicator image when an AJAX request starts:</p>
<div class="example_code notranslate">
$(document).ajaxStart(function(){<br>
&nbsp; $(this).html(&quot;&lt;img src='demo_wait.gif' /&gt;&quot;);<br>
});
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_ajaxstart" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ajaxStart() method specifies a function to be run when an AJAX request starts.</p>
<p><strong>Note:</strong> As of jQuery version 1.8, this method should only be attached to document.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(document).ajaxStart(<i>function())</i></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the AJAX request starts</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_ajaxstart.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_ajaxstart.asp#top" target="_top">TOP</a> |
		<a href="ajax_ajaxstart.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
