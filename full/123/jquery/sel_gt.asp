...
<style>a.menu_sel_gt{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:gt()</span> Selector</h1>
...
<p>Select all &lt;tr&gt; elements after the 4 first:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_gt">Try it yourself &raquo;</a>
...
<p>The :gt() selector selects elements with an index number higher than a specified 
number.</p>
<p>The index numbers start at 0.</p>
<p>This is mostly used together with another selector to select the last 
elements in a group (like in the example above).</p>

<p><b>Tip:</b> Use the <a href="sel_lt.asp">:lt selector</a> to select elements 
index numbers lesser than the specified number.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(":gt(<i>index</i>)")</div></div>
  <br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>index</em></td>
    <td>Required. Specifies which element to select.<br>
	Elements 
	with an index higher than the specified number is selected.</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_gt.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_gt.asp#top" target="_top">TOP</a> |
		<a href="sel_gt.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
