...
<style>a.menu_html_hasclass{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">hasClass()</span> Method</h1>
...
<p>Check if any &lt;p&gt; element has a class named &quot;intro&quot;:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>&nbsp; alert($(&quot;p&quot;).hasClass(&quot;intro&quot;));<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_hasclass">Try it yourself &raquo;</a>
...
<p>The hasClass() method checks if any of the selected elements have a specified class 
name.</p>
<p>If ANY of the selected elements has the specified class name, 
...
$(<i>selector</i>).hasClass(<i>classname</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the class name to search for in the selected elements</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_hasclass.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_hasclass.asp#top" target="_top">TOP</a> |
		<a href="html_hasclass.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
