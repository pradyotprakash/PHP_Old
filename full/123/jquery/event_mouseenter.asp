...
<style>a.menu_event_mouseenter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">mouseenter()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p>Set the background color to yellow, when the mouse pointer enters a &lt;p&gt; 
	element:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).mouseenter(function(){<br>&nbsp; $(&quot;p&quot;).css(&quot;background-color&quot;,&quot;yellow&quot;);<br>	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_mouseenter_mouseleave" target="_blank">Try it yourself &raquo;</a>
...
<p>The mouseenter event occurs when the mouse pointer is over (enters) the 
selected 
element.</p>
<p>The mouseenter() method triggers the mouseenter event, or attaches a function 
to run when a mouseenter event occurs..</p>
<p><b>Note:</b> Unlike the <a href="event_mouseover.asp">mouseover</a> event, the mouseenter event only 
triggers when the mouse pointer enters the selected element. The mouseover 
event is triggered if a mouse pointer enters any child elements as well. See the 
example at the end of the page for a demonstration.</p>
<p><strong>Tip:</strong> This event is often used together with the <a href="event_mouseleave.asp">
mouseleave</a> event.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the mouseenter event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mouseenter()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_menter_mleave_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the mouseenter event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mouseenter(<i>function</i>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the mouseenter event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_event_mouseenter_mouseover">
The difference between mouseenter() and mouseover()</a><br>
Demonstrates the difference between mouseenter() and mouseover().</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_mouseenter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_mouseenter.asp#top" target="_top">TOP</a> |
		<a href="event_mouseenter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
