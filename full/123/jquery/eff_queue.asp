...
<style>a.menu_eff_queue{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">queue()</span> Method</h1>
...
<p>Display the length of a queue in a &lt;span&gt; element:</p>
<div class="example_code notranslate">
    $(&quot;span&quot;).text(div.queue().length);&nbsp;
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_queue">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The queue() method can be used together with the <a href="eff_dequeue.asp">dequeue()</a> 
method.<p>An element can have several queues. Most often it has only one, the &quot;fx&quot; queue, which is the default jQuery queue.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).queue(<i>queueName</i>)</div></div>
<br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_eff_queue2">Count the 
length of the queue + loop the queue</a><br>
How to count the length of the queue + loop the queue.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_queue.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_queue.asp#top" target="_top">TOP</a> |
		<a href="eff_queue.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
