...
<style>a.menu_event_mouseout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">mouseout()</span> Method</h1>
...
<p>Set the background color to gray, when the mouse pointer leaves a 
&lt;p&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).mouseout(function(){<br>&nbsp; $(&quot;p&quot;).css(&quot;background-color&quot;,&quot;gray&quot;);<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_mouseover_mouseout">Try it yourself &raquo;</a>
...
<p>The mouseout event occurs when the mouse pointer leaves the selected element.</p>
<p>The mouseout() method triggers the mouseout event, or attaches a function 
to run when a mouseout event occurs.</p>
<p><b>Note:</b> Unlike the <a href="event_mouseleave.asp">
mouseleave</a> event, the mouseout event is triggered 
if a mouse pointer leaves any child elements as well as the selected element. The mouseleave 
event only 
triggers when the mouse pointer leaves the selected element. See the example at the end of the page for a demonstration.</p>
<p><strong>Tip:</strong> This event is often used together with the <a href="event_mouseover.asp">
mouseover</a> event.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the mouseout event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mouseout()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_mover_mout_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the mouseout event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mouseout(<i>function</i>)

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_mouseover_mouseout">Try it</a>  
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the mouseout event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_event_mouseleave_mouseout">
The difference between mouseout() and mouseleave()</a><br>
Demonstrates the difference between mouseout() and mouseleave().<br>
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_mouseout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_mouseout.asp#top" target="_top">TOP</a> |
		<a href="event_mouseout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
