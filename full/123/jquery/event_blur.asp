...
<style>a.menu_event_blur{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">blur()</span> Method</h1>
...
<p>Attach a function to the blur event. The blur event occurs when the &lt;input&gt; field loses focus:</p>
<div class="example_code notranslate">
    $(&quot;input&quot;).blur(function(){<br>&nbsp; alert(&quot;This input field has lost its 
	focus.&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_blur_alert">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The blur event occurs when an element loses focus.</p>
<p>The blur() method triggers the blur event, or attaches a function to run when a blur event occurs.</p>
<p><strong>Tip:</strong> This method is often used together with the <a href="event_focus.asp">focus()</a> method. </p>
<hr>

<h2>Syntax</h2>
<p>Trigger the blur event for the selected elements:</p>
<div class="code notranslate"><div>
    $(<i>selector</i>).blur()
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_focus_blur_trigger">Try it</a>
</div>
</div>
<p>Attach a function to the blur event:</p>
<div class="code notranslate"><div>
    $(<i>selector</i>).blur(<i>function</i>)
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_focus_blur">Try it</a>
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the blur event occurs</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_blur.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_blur.asp#top" target="_top">TOP</a> |
		<a href="event_blur.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
