...
<title>jQuery AJAX get() and post() Methods</title>
<style>a.menu_jquery_ajax_get_post{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery - <span class="color_h1">AJAX get() and post() Methods</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_ajax_load.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_noconflict.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The jQuery get() and post() methods are used to request data from the server 
with an HTTP GET 
or POST request.</p>
<hr>

<h2>HTTP Request: GET vs. POST</h2>
...
<p>GET is basically used for just getting (retrieving) some data from the server.
<b>Note:</b> The GET method may return cached data.</p>
<p>POST can also be used to get some data from the server. However, the POST 
method NEVER caches data, and is often used to send data along with the request.</p>
<p>To learn more about GET and POST, and the differences between the two 
methods, please read our <a href="../tags/ref_httpmethods.asp">HTTP Methods GET vs 
POST</a> chapter.</p>
<hr>

<h2>jQuery $.get() Method</h2>
<p>The $.get() method requests data from the server with an HTTP GET request.</p>
<p><b>Syntax:</b></p>
<div class="code notranslate">
	<div>
$.get(<i>URL,callback</i>);
</div></div>
<p>The required URL parameter specifies the URL you wish to request.</p>
<p>The optional callback parameter is the name of a function to be executed 
if the request succeeds.</p>
<p>The following example uses the $.get() method to retrieve data from a file on 
the server:</p>
...
&nbsp; $.get(&quot;demo_test.asp&quot;,function(data,status){<br>
&nbsp;&nbsp;&nbsp; alert(&quot;Data: &quot; + data + &quot;\nStatus: &quot; + status);<br>
&nbsp; });<br>
});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_get">Try it yourself &raquo;</a>
</div>
<p>The first parameter of $.get() is the URL we wish to request (&quot;demo_test.asp&quot;).</p>
<p>The second 
...
the request.</p>
<p><b>Tip:</b> Here is how the ASP file looks like (&quot;demo_test.asp&quot;):</p>
<div class="code notranslate">
	<div>
&lt;%<br>
...
<p>The $.post() method requests data from the server using an HTTP POST request.</p>
<p><b>Syntax:</b></p>
<div class="code notranslate">
	<div>
...
<p>The required URL parameter specifies the URL you wish to request.</p>
<p>The optional data parameter specifies some data to send along with the 
request.</p>
<p>The optional callback parameter is the name of a function to be executed 
if the request succeeds.</p>
<p>The following example uses the $.post() method to send some data along with the 
request:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_post">Try it yourself &raquo;</a>
</div>
<p>The first parameter of $.post() is the URL we wish to request (&quot;demo_test_post.asp&quot;).</p>
<p>Then we pass in some data to send along with the request (name and city).</p>
<p>The ASP script in &quot;demo_test_post.asp&quot; reads the parameters, 
processes them, and returns a result.</p>
<p>The third 
parameter is a callback function. The first callback parameter holds the content of 
the page requested, and the second callback parameter holds the status of 
the request.</p>
<p><b>Tip:</b> Here is how the ASP file looks like (&quot;demo_test_post.asp&quot;):</p>
<div class="code notranslate">
	<div>
&lt;%<br>
dim fname,city<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_ajax_get_post.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_ajax_get_post.asp#top" target="_top">TOP</a> |
		<a href="jquery_ajax_get_post.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
