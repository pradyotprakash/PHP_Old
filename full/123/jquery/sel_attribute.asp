...
<h1>jQuery <span class="color_h1">[attribute]</span> Selector</h1>
...
<p>Select every element with an id attribute:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_attribute">Try it yourself &raquo;</a>
...
<p>The [attribute] selector selects each element with the specified attribute.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$("[<i>attribute</i>]")</div></div>
  <br>
