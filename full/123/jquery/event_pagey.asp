...
<style>a.menu_event_pagey{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.pageY</span> Property</h1>
...
<p>The event.pageY property returns the position of the mouse pointer, relative to the 
top edge of the document.</p>
<p><strong>Tip:</strong> This event property is often used together with the
<a href="event_pagex.asp">event.pageX</a> property.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pagey.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pagey.asp#top" target="_top">TOP</a> |
		<a href="event_pagey.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
