...
<title>jQuery event.delegateTarget Property</title>
<style>a.menu_event_delegatetarget{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.delegateTarget</span> Property</h1>
...
<p>Change the background color of the &lt;div&gt; element (an ancestor of the 
&lt;button&gt; element): </p>
	<div class="example_code notranslate">
  
    	$(&quot;div&quot;).on(&quot;click&quot;,&quot;button&quot;,function(event){<br>&nbsp; $(event.delegateTarget).css(&quot;background-color&quot;, 
		&quot;pink&quot;);<br>});</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_delegatetarget" target="_blank">Try it yourself &raquo;</a>

</div>
<hr>

<h2>Definition and Usage</h2>
<p>The event.delegateTarget property returns the element where the currently-called jQuery event handler 
was attached.</p>
<p>This property is useful for delegated events attached by the&nbsp;<a href="event_on.asp">on()</a> method, 
where the event handler is attached at an ancestor of the element being 
processed.</p>
<p><strong>Tip:</strong> event.delegateTarget is equal to
<a href="event_currenttarget.asp">event.currentTarget</a>, if the event is directly-bound to 
an element and no delegation occurs (see example below).</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>

<i>event</i>.delegateTarget</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>event</em></td>
    <td>Required. The <em>
	event</em> parameter comes from the event binding function</td>
  </tr>
  </table>
  <br>
...
<p><a href="tryit.asp?filename=tryjquery_event_delegate_current" target="_blank">
Difference between delegateTarget and currentTarget with delegation</a><br>
Show the difference between delegateTarget and currentTarget when delegation occurs.</p>

<p>
<a href="tryit.asp?filename=tryjquery_event_delegate_current2" target="_blank">
The delegateTarget and currentTarget are equal for directly bound events</a><br>
Show that delegateTarget and currentTarget are equal for directly bound events.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_delegatetarget.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_delegatetarget.asp#top" target="_top">TOP</a> |
		<a href="event_delegatetarget.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
