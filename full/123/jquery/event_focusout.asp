...
<style>a.menu_event_focusout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">focusout()</span> Method</h1>
...
<p>Set background color of a &lt;div&gt; element when the &lt;div&gt; element or any child 
elements loses focus:</p>
<div class="example_code notranslate">
  
    $(&quot;div&quot;).focusout(function(){<br>&nbsp; $(this).css(&quot;background-color&quot;,&quot;#FFFFFF&quot;);<br>	});
...
<p>The focusout event occurs when an element (or any elements inside it) loses focus.</p>
<p>The focusout() method attaches a function to run when a focusout event occurs 
on the element, or any elements inside it.</p>
<p>Unlike the <a href="event_blur.asp">blur()</a> method, the focusout() method 
also triggers if any child elements 
lose focus.</p>
<p><strong>Tip:</strong> This method is often used together with the
<a href="event_focusin.asp">focusin()</a> method.</p>
...
$(<i>selector</i>).focusout(<i>function</i>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the focusout event occurs</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_focusout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_focusout.asp#top" target="_top">TOP</a> |
		<a href="event_focusout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
