...
<style>a.menu_jquery_slide{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Effects - <span class="color_h1">Sliding</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_fade.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_animate.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The jQuery slide methods slides elements up and down.</p>
<p class="flip">Click to slide down/up the panel</p>
<div class="panel">
...
<p>With jQuery you can create a sliding effect on elements.</p>
<p>jQuery has the following slide methods:</p>
<ul>
	<li>slideDown()</li>
	<li>slideUp()</li>
	<li>slideToggle()</li>
...
$(<i>selector</i>).slideDown(<i>speed,callback</i>);</div></div>
<p>The optional speed parameter specifies the duration of the effect. It can take the following values: &quot;slow&quot;, &quot;fast&quot;, or 
milliseconds.</p>
<p>The optional callback parameter is a function to be executed after the sliding completes.</p>
<p>The following example demonstrates the slideDown() method:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;#flip&quot;).click(function(){<br>
&nbsp;
$(&quot;#panel&quot;).slideDown();<br>
});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_slide_down">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p><b>Syntax:</b></p>
<div class="code notranslate"><div>
$(<i>selector</i>).slideUp(<i>speed,callback</i>);</div></div>
<p>The optional speed parameter specifies the duration of the effect. It can take the following values: &quot;slow&quot;, &quot;fast&quot;, or 
milliseconds.</p>
<p>The optional callback parameter is a function to be executed after the sliding completes.</p>
<p>The following example demonstrates the slideUp() method:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
$(&quot;#flip&quot;).click(function(){<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_slide_up">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>jQuery slideToggle() Method</h2>
<p>The jQuery slideToggle() method toggles between the slideDown() and slideUp() 
methods.</p>
<p>If the elements have been slid down, slideToggle() will slide them up.</p>
<p>If the elements have been slid up, slideToggle() will slide them down. </p>
<div class="code notranslate"><div>
$(<i>selector</i>).slideToggle(<i>speed,callback</i>);</div></div>
<p>The optional speed parameter can take the following values: &quot;slow&quot;, &quot;fast&quot;, milliseconds.</p>
<p>The optional callback parameter is a function to be executed after the 
sliding completes.</p>
<p>The following example demonstrates the slideToggle() method:</p>
...
$(&quot;#flip&quot;).click(function(){<br>
&nbsp;
$(&quot;#panel&quot;).slideToggle();<br>
});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_slide_toggle">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_slide.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_slide.asp#top" target="_top">TOP</a> |
		<a href="jquery_slide.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
