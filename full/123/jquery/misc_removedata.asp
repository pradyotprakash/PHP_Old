...
<title>jQuery Misc removeData() Method</title>
<style>a.menu_misc_removedata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Misc <span class="color_h1">removeData()</span> Method</h1>
...
<p>Remove previously attached data from a &lt;div&gt; element:</p>
<div class="example_code notranslate">
$(&quot;#btn2&quot;).click(function(){<br>
&nbsp; $(&quot;div&quot;).removeData(&quot;greeting&quot;);<br>
&nbsp; alert(&quot;Greeting is: &quot; + $(&quot;div&quot;).data(&quot;greeting&quot;));<br>
});
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_removedata" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The removeData() method removes data previously set with the <a href="misc_data.asp">data()</a> method.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).removeData(<i>name</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>name</i></td>
    <td>Optional. Specifies the name of data to remove.<br>
	If no name is specified, this method will remove all stored data from the 
	selected elements</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="misc_removedata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="misc_removedata.asp#top" target="_top">TOP</a> |
		<a href="misc_removedata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
