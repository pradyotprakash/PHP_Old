...
<title>jQuery Effect fadeTo() Method</title>
<style>a.menu_eff_fadeto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Effect <span class="color_h1">fadeTo()</span> Method</h1>
...
<p>Gradually change the opacity of all &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_fadeto">Try it yourself &raquo;</a>
...
<p>The fadeTo() method gradually changes the opacity, for selected elements, to a specified opacity 
(fading effect).</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).fadeTo(<i>speed,opacity,easing,callback</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>speed</em></td>
    <td>Required. Specifies the speed of the fading effect. <p>Possible values:</p>
	<ul>
		<li>milliseconds </li>
		<li>&quot;slow&quot;</li>
		<li>&quot;fast&quot;</li>
  ...
  <tr>
    <td><em>opacity</em></td>
    <td>Required. Specifies the opacity to fade to. Must be a 
	number between 0.00 and 1.00</td>
  </tr>
  <tr>
    <td><em>easing</em></td>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_eff_fadeto_callback">fadeTo() - Using the callback parameter</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_fadeto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_fadeto.asp#top" target="_top">TOP</a> |
		<a href="eff_fadeto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
