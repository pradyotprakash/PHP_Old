...
<style>a.menu_html_replacewith{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">replaceWith()</span> Method</h1>
...
<p>Replace the first &lt;p&gt; element with new text:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp;&nbsp; $(&quot;p:first&quot;).replaceWith(&quot;Hello world!&quot;);<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_replacewith">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The replaceWith() method replaces selected elements with new content.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).replaceWith(<i>content,</i>function(<i>index</i>))</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies a function that returns the content to replace
    <ul>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_replacewith_element">Replace content using a function</a><br>
How to use a function to replace selected elements with new content.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_replacewith.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_replacewith.asp#top" target="_top">TOP</a> |
		<a href="html_replacewith.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
