...
<style>a.menu_traversing_parentsUntil{font-weight:bold;}</style>
<meta charset="utf-8">
...
$(document).ready(function(){
  $("span.ex").parentsUntil("div.ex").css({"color":"red","border":"2px solid red"});
});
</script>
<style>
.ancestors *
...
<h1>jQuery <span class="color_h1">parentsUntil()</span> Method</h1>
...
<p>Return all ancestor elements between &lt;span&gt; and &lt;div&gt;:</p>
<div class="example_code notranslate">
  
    $(document).ready(function(){<br>&nbsp; $(&quot;span&quot;).parentsUntil(&quot;div&quot;).css({&quot;color&quot;:&quot;red&quot;,&quot;border&quot;:&quot;2px 
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_parentsuntil">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The parentsUntil() method returns all ancestor elements between the <em>selector</em> 
and <em>stop</em>.</p>
...
element, until it reaches a specific element.</p>
<p><strong>Note:</strong> If both parameters are empty, this method will 
return all ancestor elements (same as the <a href="traversing_parents.asp">
parents()</a> 
method).</p>
<p>Related methods:</p>
<ul>
	<li><a href="traversing_parent.asp">parent()</a> -&nbsp; returns the direct 
	parent element of the selected element</li>
	<li><a href="traversing_parents.asp">parents()</a> - returns all ancestor 
	elements of the selected element</li>
	<li><a href="traversing_closest.asp">closest()</a> - returns the first 
	ancestor of the selected element</li>
</ul>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).parentsUntil(<em>stop,filter</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>stop</i></td>
    <td>Optional. A selector expression, element or jQuery object indicating 
	where to stop the search for matching ancestor elements</td>
  </tr>
    <tr>
    <td><i>filter</i></td>
    <td>Optional. Specifies a selector expression to narrow down the search for 
	ancestors between <em>selector</em> and <em>stop</em><br><br><strong>Note:</strong> To 
	return multiple ancestors, separate each expression with a comma.</td>
  </tr>
</table>
<br>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjquery_traversing_parentsuntil2" target="_blank">
Narrow down the search</a><br>
How to use both parameters to filter the search for a specific element between &lt;span&gt; and 
&lt;div&gt;.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_parentsuntil_multi" target="_blank">
Return multiple ancestors</a><br>
How to return multiple ancestors between &lt;span&gt; and &lt;body&gt;.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_parentsuntil_dom">
DOM</a><br>
Return all ancestors between &lt;span&gt; and &lt;div&gt; using a DOM element.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_parentsuntil_dom2">
Using a DOM element and a selector expression to filter the search</a><br>
Using a DOM element to narrow down the ancestor search for &lt;ul&gt; elements between &lt;span&gt; and &lt;div&gt;.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_parentsUntil.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_parentsUntil.asp#top" target="_top">TOP</a> |
		<a href="traversing_parentsUntil.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
