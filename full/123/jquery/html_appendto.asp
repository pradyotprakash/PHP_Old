...
<style>a.menu_html_appendto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">appendTo()</span> Method</h1>
...
<p>Insert a &lt;span&gt; element at the end of each &lt;p&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>
	&nbsp; $(&quot;&lt;span&gt;Hello World!&lt;/span&gt;&quot;).appendTo(&quot;p&quot;);<br>
	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_appendto">Try it yourself &raquo;</a>
...
<p>The appendTo() method inserts HTML elements at the end of the selected elements.</p>
<p><b>Tip:</b> To insert HTML elements at the beginning of the selected elements, use the
<a href="html_prependto.asp">prependTo()</a> method.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>content</i>).appendTo(<i>selector</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>content</i></td>
    <td>Required. Specifies the content to insert (must contain HTML 
	tags).<br>
	<br>
	<b>Note:</b> If <i>content</i> is an existing element, it will be moved from 
	its 
current position, and inserted at the end of the selected elements.</td>
  </tr>
  <tr>
    <td><i>selector</i></td>
    <td>Required. Specifies on which elements to append the 
	content to</td>
  </tr>
  </table>
  <br>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_appendto_sel">Insert an existing element</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_appendto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_appendto.asp#top" target="_top">TOP</a> |
		<a href="html_appendto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
