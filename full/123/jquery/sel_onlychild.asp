...
<style>a.menu_sel_onlychild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:only-child</span> Selector</h1>
...
<p>Select each &lt;p&gt; element that is the only child of its parent:</p>
<div class="example_code notranslate">
  
    $(&quot;p:only-child&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_onlychild">Try it yourself &raquo;</a>
...
<p>The :only-child selector selects every element that is the only child of its 
parent. </p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_onlychild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_onlychild.asp#top" target="_top">TOP</a> |
		<a href="sel_onlychild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
