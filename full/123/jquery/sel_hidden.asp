...
<style>a.menu_sel_hidden{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:hidden</span> Selector</h1>
...
<p>Show hidden elements:</p>
<div class="example_code notranslate">
  
    $(&quot;:hidden&quot;).show();</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_hidden">Try it yourself &raquo;</a>
...
<p>The :hidden selector selects hidden elements.</p>
<p>Hidden elements are elements that are:</p>
<ul>
	<li>Set to display:none</li>
	<li>Form elements with type=&quot;hidden&quot;</li>
	<li>Width and height set to 0</li>
	<li>A hidden parent element (this also hides child elements)</li>
</ul>

<p><b>Note</b>: This selector will not work on elements with visibility:hidden.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_hidden.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_hidden.asp#top" target="_top">TOP</a> |
		<a href="sel_hidden.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
