...
<style>a.menu_html_removeclass{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">removeClass()</span> Method</h1>
...
<p>Remove the class name &quot;intro&quot; from all &lt;p&gt; elements:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;p&quot;).removeClass(&quot;intro&quot;);<br>	});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_removeclass">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The removeClass() method removes one or more class names from the selected elements.</p>
<p><b>Note:</b> If no parameter is specified, this method will remove ALL class names from the selected elements.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).removeClass(<i>classname</i>,function<i>(index,currentclass)</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies one or more class names to remove. To remove several 
	classes, separate the class names with space<br><br>
	<b>Note:</b> If this parameter is empty, all class names will be removed</td>
  </tr>
  <tr>
    <td>function<i>(index,currentclass)</i></td>
    <td>Optional. A function that returns one or more class names to remove<ul>
		<li><i>index</i> - Returns the index position of the element in the set</li>
		<li><i>currentclass</i> - Returns the current class name of selected elements</li>
	</ul>
	</td>
  </tr>
</table>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_addremoveclass">Change the class name of an element</a><br>
How to use addClass() and removeClass() to remove one class name, and add a new class name.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_removeclass_func">Remove class using a function</a><br>
Using a function to remove a class from the selected elements.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_removeclass_several">Remove several class names</a><br>
How to remove several class names from the selected elements.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_removeclass.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_removeclass.asp#top" target="_top">TOP</a> |
		<a href="html_removeclass.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
