...
<style>a.menu_event_mouseleave{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">mouseleave()</span> Method</h1>
...
<p>Set the background color to gray, when the mouse pointer leaves a &lt;p&gt; 
element:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).mouseleave(function(){<br>&nbsp; $(&quot;p&quot;).css(&quot;background-color&quot;,&quot;gray&quot;);<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_mouseenter_mouseleave">Try it yourself &raquo;</a>
...
<p>The mouseleave event occurs when the mouse pointer leaves the selected 
element.</p>
<p>The mouseleave() method triggers the mouseleave event, or attaches a function 
to run when a mouseleave event occurs.</p>
<p><b>Note:</b> Unlike the <a href="event_mouseout.asp">mouseout</a> event, the mouseleave event 
only triggers when the mouse pointer leaves the selected elements. The mouseout 
event is triggered if a mouse pointer leaves any child elements as well as the 
selected element.&nbsp; See the example at the end of the page for a demonstration.</p>
<p><strong>Tip:</strong> This event is often used together with the
<a href="event_mouseenter.asp">mouseenter</a> event.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the mouseleave event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mouseleave()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_menter_mleave_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the mouseleave event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mouseleave(<i>function</i>)

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_mouseenter_mouseleave">Try it</a>  
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the mouseleave event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<p>
<a href="tryit.asp?filename=tryjquery_event_mouseleave_mouseout" target="_blank">
The difference between mouseleave() and mouseout()</a><br>
Demonstrates the difference between mouseleave() and mouseout().<br>
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_mouseleave.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_mouseleave.asp#top" target="_top">TOP</a> |
		<a href="event_mouseleave.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
