...
<style>a.menu_sel_attribute_notequal_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Select all &lt;p&gt; elements <strong>NOT</strong> containing a class attribute with the value &quot;intro&quot;:</p>
<div class="example_code notranslate">
  
    $(&quot;p[class!='intro']&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_attributenotvalue">Try it yourself &raquo;</a>
...
<p>The [attribute!=value] selector selects each element that does <strong>NOT</strong> have the specified attribute 
and value.</p>
<p>Elements with the selected attribute, but with a different value, will be 
selected.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_attribute_notequal_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_attribute_notequal_value.asp#top" target="_top">TOP</a> |
		<a href="sel_attribute_notequal_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
