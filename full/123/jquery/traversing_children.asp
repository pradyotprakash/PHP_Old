...
<style>a.menu_traversing_children{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">children()</span> Method</h1>
...
<p>Return elements that are direct children of &lt;ul&gt;:</p>
<div class="example_code notranslate">
  
    $(document).ready(function(){<br>&nbsp; $(&quot;ul&quot;).children().css({&quot;color&quot;:&quot;red&quot;,&quot;border&quot;:&quot;2px 
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
<div class="example_code notranslate descendants">body (great-grandparent)
  <div>div (grandparent)
    <ul>ul (parent)  
      <li>li (child)
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_children">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The children() method returns all direct children of the selected element.</p>
<p><strong>The DOM tree:</strong> This method only traverse a single level down 
the DOM tree. To traverse down multiple levels (to 
return grandchildren or other descendants), use the <a href="traversing_find.asp">
find()</a> method.</p>
<p><strong>Tip:</strong> To traverse a single level up the DOM tree, or all the way up 
to the document's root element (to return parents or other ancestors), use the
<a href="traversing_parent.asp">parent()</a> or <a href="traversing_parents.asp">
parents()</a> method.</p>
<p><strong>Note:</strong> This method does not return text nodes. To return all 
children including text nodes, use the <a href="traversing_contents.asp">contents()</a> method.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).children(<em>filter</em>)</div></div>
<br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_children2">
Return all direct children of &lt;ul&gt;</a><br>
How to return all direct children of an &lt;ul&gt; element.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_children3" target="_blank">
Narrow down the search</a><br>
How to use the filter parameter to 
return all &lt;li&gt; elements with the class name &quot;1&quot;, that are direct children of &lt;ul&gt;.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_children4" target="_blank">Return all &lt;p&gt; elements that are direct children of 
&lt;div&gt;</a><br>
How to select all &lt;p&gt; elements that are direct children of their parent &lt;div&gt; 
element.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_children5">Show 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_children.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_children.asp#top" target="_top">TOP</a> |
		<a href="traversing_children.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
