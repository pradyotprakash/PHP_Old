...
<title>jQuery Misc get() Method</title>
<style>a.menu_misc_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Misc <span class="color_h1">get()</span> Method</h1>
...
<p>Get the name and value of the first &lt;p&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>
&nbsp; x=$(&quot;p&quot;).get(0);<br>
&nbsp; $(&quot;div&quot;).text(x.nodeName + &quot;: &quot; + x.innerHTML);<br>
	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_get" target="_blank">Try it yourself &raquo;</a>
...
<p>The get() method gets the DOM elements specified by the selector.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).get(<i>index</i>)</div></div>
<br>
<table class="reference notranslate"> 
  <tr>
    ...
    <tr>
    <td><i>index</i></td>
    <td>Optional. Specifies which of the matching elements to get (by index 
	number)</td>
    </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="misc_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="misc_get.asp#top" target="_top">TOP</a> |
		<a href="misc_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
