...
<title>jQuery Effect dequeue() Method</title>
<style>a.menu_eff_dequeue{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">dequeue()</span> Method</h1>
...
<p>Remove the next function from the queue, and then execute the function:</p>
<div class="example_code notranslate">
$(&quot;div&quot;).queue(function(){<br>&nbsp; $(&quot;div&quot;).css(&quot;background-color&quot;,&quot;red&quot;); <br>&nbsp; $(&quot;div&quot;).dequeue();<br>	});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_dequeue">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The dequeue() method removes the next function from the queue, and then executes the function.</p>
<p>A queue is one or more function(s) waiting to run.</p>
<p>The dequeue() method is used together with the <a href="eff_queue.asp">queue()</a> method.
<p>An element can have several queues. Most often it has only one, the &quot;fx&quot; queue, which is the default jQuery queue.</p>
<p><b>Note:</b> You should ensure that the dequeue() method is called after adding a function with queue(), to allow the process to continue.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).dequeue(<i>queueName</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>queueName</em></td>
    <td>Optional. Specifies the name of the queue<p>
	Default is &quot;fx&quot;, the standard effects queue</td>
  </tr>
   </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_dequeue.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_dequeue.asp#top" target="_top">TOP</a> |
		<a href="eff_dequeue.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
