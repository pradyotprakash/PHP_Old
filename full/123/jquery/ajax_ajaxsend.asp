...
<style>a.menu_ajax_ajaxsend{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">ajaxSend()</span> Method</h1>
...
<p>Change the content of a &lt;div&gt; element when an AJAX requests is about to be 
sent:</p>
<div class="example_code notranslate">
$(document).ajaxSend(function(e,xhr,opt){<br>
&nbsp; $(&quot;div&quot;).append(&quot;&lt;p&gt;Requesting: &quot; + opt.url + &quot;&lt;/p&gt;&quot;);<br>
});
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_ajaxsend" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ajaxSend() method specifies a function to run when an AJAX requests is about to be sent.</p>
<p><strong>Note:</strong> As of jQuery version 1.8, this method should only be attached to document.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(document).ajaxSend(<i>function(event,xhr,options))</i></div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_ajaxsend.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_ajaxsend.asp#top" target="_top">TOP</a> |
		<a href="ajax_ajaxsend.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
