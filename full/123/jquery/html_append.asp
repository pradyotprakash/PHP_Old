...
<style>a.menu_html_append{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">append()</span> Method</h1>
...
<p>Insert content at the end of all &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_append_ref">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The append() method inserts specified content at the end of the selected elements.</p>
<p><b>Tip:</b> To insert content at the beginning of the selected elements, use the <a href="html_prepend.asp">prepend()</a> method.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).append(<i>content,</i>function(<i>index,html</i>))</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>content</i></td>
    <td>Required. Specifies the content to insert (can contain HTML 
	tags)
	    <p>Possible values:</p>
	<ul>
		<li>HTML elements</li>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_append2">append() - Create content with HTML, jQuery and DOM</a><br>
Insert content with the append() method.</p>

<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_append_func">Append content using a function</a><br>
Using a function to insert content at the end of the selected elements.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_append.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_append.asp#top" target="_top">TOP</a> |
		<a href="html_append.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
