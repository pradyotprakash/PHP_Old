...
<style>a.menu_eff_hide{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">hide()</span> Method</h1>
...
<p>The hide() method hides the selected elements.</p>
<p><b>Tip:</b> This is similar to the CSS property display:none.</p>
<p><b>Note</b>: Hidden elements will not be displayed at all (no longer affects 
the layout of the page).</p>
<p><b>Tip:</b> To show hidden elements, look at the <a href="eff_show.asp">
show()</a> method.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).hide(<i>speed,easing,callback</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>speed</em></td>
    <td>Optional. Specifies the speed of the hide effect. Default value is 400 
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the hide() method is completed
...
<p><a href="tryit.asp?filename=tryjquery_eff_show_hide_speed" target="_blank">
hide() - Using the speed parameter</a><br>
How to use the speed parameter when hiding/showing an element.</p>

<p>
<a href="tryit.asp?filename=tryjquery_eff_show_hide_callback" target="_blank">
hide() - Using the callback parameter</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_hide.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_hide.asp#top" target="_top">TOP</a> |
		<a href="eff_hide.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
