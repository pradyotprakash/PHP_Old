...
<title>jQuery Misc size() Method</title>
<style>a.menu_misc_size{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Misc <span class="color_h1">size()</span> Method</h1>
...
<p>Alert the number of elements matched by the jQuery selector:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_size" target="_blank">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The size() method was <a href="javascript:NewWindow('deprecated.htm')">deprecated</a> 
 in jQuery version 1.8. Use the <a href="prop_length.asp">length</a> property instead.</span></p>

<p>The size() method returns the number of elements matched by the jQuery 
selector.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="misc_size.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="misc_size.asp#top" target="_top">TOP</a> |
		<a href="misc_size.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
