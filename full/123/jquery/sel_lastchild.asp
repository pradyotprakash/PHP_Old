...
<style>a.menu_sel_lastchild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:last-child</span> Selector</h1>
...
<p>Select every &lt;p&gt; element that is the last child of its parent:</p>
<div class="example_code notranslate">
  
    $(&quot;p:last-child&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_lastchild">Try it yourself &raquo;</a>
...
<p>The :last-child selector selects all elements that are the last child of their parent.</p>
<p><strong>Tip:</strong> Use the <a href="sel_firstchild.asp">:first-child</a> 
selector to select elements that are the first child of their parent.</p>
...
<p>
<a href="tryit.asp?filename=tryjquery_sel_lastchild2" target="_blank">Select the 
last &lt;p&gt; element of all &lt;div&gt; elements</a><br>
How to select the last &lt;p&gt; element of all &lt;div&gt; elements.</p>
<p>
<a href="tryit.asp?filename=tryjquery_sel_lastchild_last" target="_blank">Difference 
between :last and :last-child</a><br>
Show the difference between the :last and :last-child selectors.</p>
<p>
<a href="tryit.asp?filename=tryjquery_sel_lastoftypediff" target="_blank">Difference 
between :last, :last-child and :last-of-type</a><br>
Show the difference between the :last, :last-child and :last-of-type selectors.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_lastchild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_lastchild.asp#top" target="_top">TOP</a> |
		<a href="sel_lastchild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
