...
<title>jQuery focusin() Method</title>
<style>a.menu_event_focusin{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">focusin()</span> Method</h1>
...
<p>Set background color of a &lt;div&gt; element when the &lt;div&gt; element or any 
child elements get focus:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_focusout" target="_blank">Try it yourself &raquo;</a>
...
<p>The focusin event occurs when an element (or any elements inside it) gets focus.</p>
<p>The focusin() method attaches a function to run when a focus event occurs on 
the element, or any elements inside it. </p>
<p>Unlike the <a href="event_focus.asp">focus()</a> method, the focusin() method 
also triggers if any child elements 
get focus.</p>
<p><strong>Tip:</strong> An element gets focus when selected by a mouse click or by 
&quot;tab-navigating&quot; to it.</p>
<p><strong>Tip:</strong> This method is often used together with the
<a href="event_focusout.asp">focusout()</a> method.</p>
...
$(<i>selector</i>).focusin(<i>function</i>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the focusin event occurs.</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_focusin.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_focusin.asp#top" target="_top">TOP</a> |
		<a href="event_focusin.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
