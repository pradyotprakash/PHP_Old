...
<style>a.menu_jquery_callback{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">Callback</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_stop.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_chaining.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A callback function is executed after the current effect is 100% finished.</p>
<hr>

<h2>jQuery Callback Functions</h2>
<p>JavaScript statements are executed line by line. However, with effects, 
...
<p>Typical syntax: <b>$(<i>selector</i>).hide(<i>speed,callback</i>);</b></p>
...
<div class="example">
<h2 class="example">Example with Callback</h2>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_hide_callback">Try it yourself &raquo;</a>
</div>

<p>The example below has no callback parameter, and the alert box will be displayed before the hide effect is completed:</p>
<div class="example">
<h2 class="example">Example without Callback</h2>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>
&nbsp;
$(&quot;p&quot;).hide(1000);<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_hide_no_callback">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_callback.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_callback.asp#top" target="_top">TOP</a> |
		<a href="jquery_callback.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
