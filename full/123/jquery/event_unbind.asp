...
<style>a.menu_event_unbind{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">unbind()</span> Method</h1>
...
<p>Remove all event handlers for all &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_unbind">Try it yourself &raquo;</a>
...
<p>The unbind() method removes event handlers from selected elements.</p>
<p>This method can remove all or selected event handlers, or stop specified 
functions from running when the event occurs.</p>
<p>This method can also unbind event handlers using an event object. This is 
used to unbind an event from within itself (like removing an event handler after 
the event has been triggered a certain number of times).</p>
<p><strong>Note:</strong> If no parameters are specified, the unbind() method will remove ALL event 
handlers from the specified element.</p>
<p><strong>Note:</strong> The unbind() method works on any event handler attached with jQuery.</p>
<p style="color:red">As of jQuery version 1.7, the <a href="event_on.asp">on()</a> 
and <a href="event_off.asp">off()</a> methods are preferred to attach and remove event handlers 
on elements.</p>
...
<div class="code notranslate"><div>
    ...
    $(<i>selector</i>).unbind(<i>event,function,eventObj</i>)
...
<table class="reference notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>event</em></td>
    <td>Optional. Specifies one or more events to remove from the elements.<br>
	Multiple event values are separated by space.<br>
	If this is the only parameter specified, all functions bound to the 
	specified event will be removed.</td>
    </tr>
  <tr>
    <td><em>function</em></td>
    <td>Optional. Specifies the name of the function to unbind from the 
	specified event for the element</td>
  </tr>
   <tr>
    <td><em>eventObj</em></td>
    <td>Optional. Specifies the event object to remove to use. The <em>
	eventObj</em> parameter comes from the event binding function<br>
		</td>
    </tr>
  </table>
...
<p><a href="tryit.asp?filename=tryjquery_event_unbind_func" target="_blank">Unbind a specific function</a><br>
How to use the unbind() method to unbind a specific function from a specified event for an element.</p>
<p><a href="tryit.asp?filename=tryjquery_event_unbind_eventobj" target="_blank">Unbind an event handler using an event object</a><br>
Specifies an event object to remove.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_unbind.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_unbind.asp#top" target="_top">TOP</a> |
		<a href="event_unbind.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
