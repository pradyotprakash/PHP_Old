...
<style>a.menu_html_before{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">before()</span> Method</h1>
...
<p>Insert content before each &lt;p&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>
	&nbsp; $(&quot;p&quot;).before(&quot;&lt;p&gt;Hello world!&lt;/p&gt;&quot;);<br>
	});
  
</div>
<br>
	<a class="tryitbtn" href="tryit.asp?filename=tryjquery_html_before_ref" target="_blank">Try it yourself &raquo;</a>
...
<p><b>Tip:</b>&nbsp; To insert content after selected elements, use the
<a href="html_after.asp">after()</a> method.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).before(<i>content,</i>function<i>(index)</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>content</i></td>
    <td>Specifies the content to insert (can contain HTML tags)
    <p>Possible values:</p>
	<ul>
		<li>HTML elements</li>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_html_before2">before() - Create content 
with HTML, jQuery and DOM</a><br>
Insert content with the before() method.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_html_before_func">Insert content using a function</a><br>
How to use a function to insert content before selected elements.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_before.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_before.asp#top" target="_top">TOP</a> |
		<a href="html_before.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
