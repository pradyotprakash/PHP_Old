...
<style>a.menu_sel_contains{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:contains()</span> Selector</h1>
...
<p>Select all &lt;p&gt; elements containing &quot;is&quot;:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_contains">Try it yourself &raquo;</a>
...
<p>The :contains() selector selects elements containing the specified string.</p>
<p>The string can be contained directly in the element as text, or in a child 
element.</p>
<p>This is mostly used together with another selector to select the 
elements containing the text in a group (like in the example above).</p>
<p><strong>Note:</strong> The text is case sensitive.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(":contains(<i>text</i>)")</div></div>
  <br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>text</em></td>
    <td>Required. Specifies the text to find</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_contains.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_contains.asp#top" target="_top">TOP</a> |
		<a href="sel_contains.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
