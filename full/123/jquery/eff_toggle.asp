...
<style>a.menu_eff_toggle{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">toggle()</span> Method</h1>
...
<p>Toggle between hide and show for all &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_toggle">Try it yourself &raquo;</a>
...
<p>The toggle() method toggles between <a href="eff_hide.asp">hide()</a> and
<a href="eff_show.asp">show()</a> for the selected elements.</p>
<p>This method checks the selected elements for visibility. show() is run if an element is hidden. 
hide() is run if an element is visible - This creates a toggle effect.</p>
<p><b>Note</b>: Hidden elements will not be displayed at all (no longer affects 
the layout of the page).</p>
<p><b>Tip:</b> This method can also be used to toggle between custom functions.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).toggle(<i>speed,easing,callback</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>speed</em></td>
    <td>Optional. Specifies the speed of the hide/show effect<p>Possible values:</p>
	<ul>
		<li>milliseconds </li>
		<li>&quot;slow&quot;</li>
		<li>&quot;fast&quot;</li>
  ...
  <tr>
	...
	animation. Default value is &quot;swing&quot;<p>Possible values:</p>
	<ul>
		<li>&quot;swing&quot; - moves slower at the beginning/end, but faster in the middle</li>
		<li>&quot;linear&quot; - moves in a constant speed</li>
	</ul>
	<b>Tip:</b> More easing functions are available in external plugins
	</td>
  </tr>
  <tr>
    <td><em>callback</em></td>
    <td>Optional. A function to be executed after the toggle() method is 
	completed<p>To learn more about callback, visit our <a href="jquery_callback.asp">jQuery Callback chapter</a></p>
	</td>
  </tr>
	</table>
  <br>
...
<p><a href="tryit.asp?filename=tryjquery_eff_toggle_speed" target="_blank">
toggle() - Using the speed parameter</a><br>
How to use the speed parameter to specify the speed of the hide/show effect.</p>

<p>
<a href="tryit.asp?filename=tryjquery_eff_toggle_callback" target="_blank">
toggle() - Using the callback parameter</a><br>
How to use the callback parameter when toggling between the hide/show effect.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_toggle.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_toggle.asp#top" target="_top">TOP</a> |
		<a href="eff_toggle.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
