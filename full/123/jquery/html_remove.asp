...
<style>a.menu_html_remove{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">remove()</span> Method</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_remove">Try it yourself &raquo;</a>
...
<p>The remove() method removes the selected elements, 
including all text and child nodes.</p>
<p>This method also removes data and events of the selected elements.</p>
<p><b>Tip:</b> To remove the elements without removing data and events, use the <a href="html_detach.asp">detach()</a> method 
instead.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_remove.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_remove.asp#top" target="_top">TOP</a> |
		<a href="html_remove.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
