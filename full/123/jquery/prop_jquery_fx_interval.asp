...
<title>jQuery jQuery.fx.interval Property</title>
<style>a.menu_prop_jquery_fx_interval{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">jQuery.fx.interval</span> Property</h1>
<p><a href="jquery_ref_prop.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Properties" /> jQuery Properties</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Cause the animation of a &lt;div&gt; element to run with less frames:</p>
<div class="example_code notranslate">
    $(&quot;#toggle&quot;).on(&quot;click&quot;,function(){<br>&nbsp; $(&quot;div&quot;).toggle(5000);<br>});<br>
	$(&quot;#interval&quot;).on(&quot;click&quot;,function(){<br>&nbsp; jQuery.fx.interval = 500;<br>
	});</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_prop_jq_fx_interval" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The jQuery.fx.interval property is used to change the animation firing rate 
in milliseconds.</p>
<p>The default value is 13 milliseconds. This property is often used to 
modify the number of frames per second at which animations will run. Lowering 
the firing rate can make animations to run smoother. However, it may cause 
performance and CPU implications.</p>
<p><strong>Note:</strong> For any changes to this property to take effect, no 
animation should be running or all animations should be stopped first.</p>
<p><strong>Note:</strong> This property has no effect in browsers that support 
the requestAnimationFrame property.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	jQuery.fx.interval = <em>milliseconds</em>;</div></div>
  <br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the animation firing rate in milliseconds. Default 
	is 13 milliseconds</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_jquery_fx_interval.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_jquery_fx_interval.asp#top" target="_top">TOP</a> |
		<a href="prop_jquery_fx_interval.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
