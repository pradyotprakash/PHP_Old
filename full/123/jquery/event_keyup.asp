...
<style>a.menu_event_keyup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">keyup()</span> Method</h1>
...
<p>Set the background color of an &lt;input&gt; field when a keyboard key is released:</p>
<div class="example_code notranslate">
  
    $(&quot;input&quot;).keyup(function(){<br>&nbsp; $(&quot;input&quot;).css(&quot;background-color&quot;,&quot;pink&quot;);<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_keydown_keyup">Try it yourself &raquo;</a>
...
<p>The order of events related to the keyup event:</p>
<ol>
	<li><a href="event_keydown.asp">keydown</a> - The key is on its way down</li>
	<li><a href="event_keypress.asp">keypress</a> - The key is pressed down</li>
	<li>keyup - The key is released</li>
</ol>
<p>The keyup event occurs when a keyboard key is released. </p>
<p>
...
The keyup() method triggers the keyup event, or attaches a function to run when 
a keyup event occurs.</span></p>
<p><b>Tip:</b> Use the <a href="event_which.asp">event.which</a> property to return which key was pressed.</p>

<hr>

<h2>Syntax</h2>
<p>Trigger the keyup event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).keyup()

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_keydown_keyup_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the keyup event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).keyup(<i>function</i>)

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_keydown_keyup">Try it</a>  
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the keyup event is 
	triggered.</td>
  </tr>
  </table>
  <br>
...
<p><a href="tryit.asp?filename=tryjquery_event_keyup_which" target="_blank">Determine which key was pressed</a><br>
How use the event.which property to determine which key was pressed.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_keyup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_keyup.asp#top" target="_top">TOP</a> |
		<a href="event_keyup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
