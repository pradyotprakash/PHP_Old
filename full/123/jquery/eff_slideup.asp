...
<style>a.menu_eff_slideup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">slideUp()</span> Method</h1>
...
<p>Slide-up (hide) all &lt;p&gt; elements:</p>
...
<p><b>Tip:</b> To slide-down (show) elements, look at the
<a href="eff_slidedown.asp">slideDown()</a> method.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).slideUp(<i>speed,easing,callback</i>)</div></div>
<br>
...
slideUp() - Using the speed parameter</a><br>
How to use the speed parameter to specify the speed of the slide effect.</p>

<p>
<a href="tryit.asp?filename=tryjquery_eff_slideup_slidedown_call" target="_blank">slideUp() - Using the callback parameter</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_slideup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_slideup.asp#top" target="_top">TOP</a> |
		<a href="eff_slideup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
