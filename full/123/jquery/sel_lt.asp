...
<style>a.menu_sel_lt{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:lt()</span> Selector</h1>
...
<p>Select the 4 first &lt;tr&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_lt">Try it yourself &raquo;</a>
...
<p>The :lt() selector selects elements with an index number less than a specified 
number.</p>
...
<p><b>Tip:</b> Use the <a href="sel_gt.asp">:gt selector</a> to select 
elements index numbers greater than the specified number.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(":lt(<i>index</i>)")</div></div>
  <br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	Elements 
	with an index lesser than the specified number is selected.</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_lt.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_lt.asp#top" target="_top">TOP</a> |
		<a href="sel_lt.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
