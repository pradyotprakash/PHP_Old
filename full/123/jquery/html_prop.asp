...
<style>a.menu_html_prop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">prop()</span> Method</h1>
...
<p>Add and remove a property named &quot;color&quot;:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>&nbsp; var $x = $(&quot;div&quot;);<br>
&nbsp; $x.prop(&quot;color&quot;,&quot;FF0000&quot;);<br>
&nbsp; $x.append(&quot;The color property: &quot; + $x.prop(&quot;color&quot;));<br>
&nbsp; $x.removeProp(&quot;color&quot;);<br>
});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_removeprop">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The prop() method sets or returns properties and values of the selected elements.</p>
<p>When this method is used to <strong>return</strong> the property value, it returns the value of 
the FIRST matched element.</p>
<p>When this method is used to <strong>set</strong> property values, it sets one or more 
property/value pairs for the set of matched elements.</p>
<p><b>Note:</b> The prop() method should be used to retrieve property values, 
e.g. DOM properties (like tagName, nodeName, defaultChecked) or your own custom made properties.</p>
<p><b>Tip:</b> To retrieve HTML attributes, use the <a href="html_attr.asp">attr()</a> method instead.</p>
<p><b>Tip:</b> To remove a property use the <a href="html_removeprop.asp">removeProp()</a> method.</p>
<hr>

<h2>Syntax</h2>
<p>Return the value of a property:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).prop(<i>property</i>)</div>
</div>

<p>Set the property and value:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).prop(<i>property,value</i>)</div>
</div>

<p>Set property and value using a function:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).prop(<i>property,</i>function(<i>index,</i><em>currentvalue</em>))</div>
</div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>property</i></td>
    <td>Specifies the name of the property</td>
  </tr>
  <tr>
    <td><i>value</i></td>
  ...
  <tr>
    ...
    <td>Specifies a function that returns the property value to set<ul>
		<li><i>index</i> - Receives the index position of the element in the set</li>
		<li><i>currentvalue</i> - Receives the current property value of 
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_prop_attr">Difference between prop() and attr()</a><br>
prop() and attr() might return different values. This example shows the differences when used to return
the &quot;checked&quot; status of a checkbox.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_prop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_prop.asp#top" target="_top">TOP</a> |
		<a href="html_prop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
