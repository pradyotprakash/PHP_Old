...
<title>jQuery event.namespace Property</title>
<style>a.menu_event_namespace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.namespace</span> Property</h1>
...
<p>Add and remove a custom namespace:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).on(&quot;custom.someNamespace&quot;,function(event){<br>&nbsp; alert(event.namespace);<br>
	});<br>$(&quot;p&quot;).click(function(event){<br>&nbsp; $(this).trigger(&quot;custom.someNamespace&quot;);<br>
	}); <br>$(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;p&quot;).off(&quot;custom.someNamespace&quot;);<br>
	});</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_namespace" target="_blank">Try it yourself &raquo;</a>

</div>
<hr>

<h2>Definition and Usage</h2>
<p>The event.namespace property returns the custom namespace when the event was 
triggered.</p>
<p>This property can be used by plugin authors to handle tasks differently depending on the namespace used.</p>
<p><strong>Tip:</strong> Namespaces beginning with an underscore are reserved 
for jQuery. </p>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjquery_event_namespace2" target="_blank">Remove a 
custom namespace for a particular click event</a><br>
Remove a cucstom namespace for a particular click event, without removing any 
other click event handlers.<br>
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_namespace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_namespace.asp#top" target="_top">TOP</a> |
		<a href="event_namespace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
