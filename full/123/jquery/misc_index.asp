...
<title>jQuery Misc index() Method</title>
<style>a.menu_misc_index{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Misc <span class="color_h1">index()</span> Method</h1>
<p><a href="jquery_ref_misc.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Misc Methods" /> jQuery Misc Methods</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Get the index of the clicked &lt;li&gt; element, relative to its siblings:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_index" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The index() method returns the index position of specified elements relative to other specified elements.</p>
<p>The elements can be specified by jQuery selectors, or a DOM element.</p>
<p><strong>Note:</strong> If the element is not found, index() will return -1.</p>
<hr>

<h2>Index of First Matched Element, Relative to Sibling elements.</h2>
<p>Get the index position of the first matched selected element relative to its sibling elements.</p>
...
<br><a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_index" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Index of an Element, Relative to the Selector.</h2>
<p>Get the index position of an element, relative to the selector.</p>
<p>The element can be specified using a DOM element, or a jQuery selector.</p>
<h2>Syntax</h2>
<div class="example">
<div class="example_code notranslate">
$(<i>selector</i>).index(<em>element</em>)
</div>
<br><a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_index_sel" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>element</i></td>
    <td>Optional. Specifies the element to get the index position of. Can be a 
	DOM element or a jQuery selector</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="misc_index.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="misc_index.asp#top" target="_top">TOP</a> |
		<a href="misc_index.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
