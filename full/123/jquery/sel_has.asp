...
<style>a.menu_sel_has{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:has()</span> Selector</h1>
...
<p>Select all &lt;p&gt; elements that have a &lt;span&gt; element inside of them:</p>
<div class="example_code notranslate">
  
    $(&quot;p:has(span)&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_has">Try it yourself &raquo;</a>
...
<p>The :has() selector selects all elements that have one or more elements inside 
of them, that matches the specified selector. </p>
<p><strong>Tip:</strong> To select an element that have multiple elements inside 
of it, use 
comma (see example below).</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(":has(<em>selector</em>)")</div></div>
  <br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the element to select.<br>This parameter accepts any 
	kind of selector</td>
  </tr>
  </table>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_sel_has2" target="_blank">
Select an element with multiple elements inside</a><br>
How to select an element that has multiple elements inside of it.</p>

<p>
<a href="tryit.asp?filename=tryjquery_sel_has3" target="_blank">
Select elements that does NOT have a specified element inside</a><br>
Using the :not selector together with :has to select elements that does NOT have an element inside of it.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_has.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_has.asp#top" target="_top">TOP</a> |
		<a href="sel_has.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
