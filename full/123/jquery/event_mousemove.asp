...
<title>jQuery mousemove() Method</title>
<style>a.menu_event_mousemove{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">mousemove()</span> Method</h1>
...
<p>Get the position of the mouse pointer within a page:</p>
<div class="example_code notranslate">
  
    $(document).mousemove(function(event){<br>&nbsp; $(&quot;span&quot;).text(event.pageX + &quot;, &quot; + event.pageY);<br>	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_mousemove">Try it yourself &raquo;</a>
...
<p>The mousemove event occurs whenever the mouse pointer moves within the 
selected element.</p>
<p>The mousemove() method triggers the mousemove event, or attaches a function 
to run when a mousemove event occurs.</p>
<p><b>Note:</b> Each time a user moves the mouse one pixel, a mousemove event 
occurs. It takes system resources to process all mousemove events. Use this 
event carefully.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the mousemove event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mousemove()
  
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_mousemove_trigger">Try it</a>  
</div>
</div>
<p>Attach a function to the mousemove event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mousemove(<i>function</i>)

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_mousemove">Try it</a>  
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the mousemove event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_mousemove.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_mousemove.asp#top" target="_top">TOP</a> |
		<a href="event_mousemove.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
