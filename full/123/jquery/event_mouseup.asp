...
<style>a.menu_event_mouseup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">mouseup()</span> Method</h1>
...
<p>Release the left mouse button over a &lt;div&gt; element to insert some text:</p>
<div class="example_code notranslate">
  
    $(&quot;div&quot;).mouseup(function(){<br>&nbsp; $(this).after(&quot;Mouse button 
	released.&quot;);<br>});</div>
<br>
...
<p>The mouseup event occurs when the left mouse button is released over the 
selected element.</p>
<p>The mouseup() method triggers the mouseup event, or attaches a function to 
run when a mouseup event occurs.</p>
<p><strong>Tip:</strong> This method is often used together with the
<a href="event_mousedown.asp">mousedown()</a> method. </p>
<hr>

<h2>Syntax</h2>
<p>Trigger the mouseup event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mouseup()
    
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_mouseup_trigger">Try it</a>    
</div>
</div>
<p>Attach a function to the mouseup event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).mouseup(<i>function</i>)
    
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_mouseup">Try it</a>    
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the mouseup event is 
	triggered</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_mouseup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_mouseup.asp#top" target="_top">TOP</a> |
		<a href="event_mouseup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
