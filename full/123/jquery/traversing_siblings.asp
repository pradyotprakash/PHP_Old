...
<style>a.menu_traversing_siblings{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">siblings()</span> Method</h1>
...
<p>Return all sibling elements of each &lt;li&gt; element with class name &quot;start&quot;:</p>
<div class="example_code notranslate">
  
    $(document).ready(function(){<br>&nbsp; $(&quot;li.start&quot;).siblings().css({&quot;color&quot;:&quot;red&quot;,&quot;border&quot;:&quot;2px 
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
...
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_siblings">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><strong>The DOM tree:</strong> This method traverse forward and backwards 
along siblings 
of DOM elements.</p>
<p><strong>Tip:</strong> Use the <a href="traversing_prev.asp">prev()</a> 
or <a href="traversing_next.asp">next()</a> method to narrow down the search for 
only previous or next sibling elements. </p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).siblings(<em>filter</em>)</div></div>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_traversing_siblings2" target="_blank">
Narrow down the search</a><br>
How to 
use both parameters to filter the search for sibling elements.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_siblings3">Select 
all sibling &lt;p&gt; elements of each &lt;div&gt; element</a><br>
How to narrow down the search for all sibling &lt;p&gt; elements of each &lt;div&gt; element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_siblings.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_siblings.asp#top" target="_top">TOP</a> |
		<a href="traversing_siblings.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
