...
<style>a.menu_event_dblclick{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">dblclick()</span> Event</h1>
...
<p>Double-click on a &lt;p&gt; element to alert a text:</p>
<div class="example_code notranslate">
    $(&quot;p&quot;).dblclick(function(){<br>&nbsp; alert(&quot;The paragraph was 
	double-clicked.&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_dblclick">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The dblclick event occurs when an element is double-clicked.</p>
<p>The dblclick() method triggers the dblclick event, or attaches a function to run when a dblclick event occurs.</p>
<p><b>Tip:</b> The dblclick event also generates a click event. This can cause 
problems if both events are applied to the same element.</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the dblclick event for the selected elements:</p>
<div class="code notranslate"><div>
    $(<i>selector</i>).dblclick()
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_dblclick_trigger">Try it</a>
</div>
</div>
<p>Attach a function to the dblclick event:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).dblclick(<i>function</i>)
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_dblclick_func">Try it</a>    
</div>
</div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the dblclick event occurs </td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_dblclick.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_dblclick.asp#top" target="_top">TOP</a> |
		<a href="event_dblclick.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
