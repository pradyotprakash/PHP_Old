...
<style>a.menu_html_wrapall{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">wrapAll()</span> Method</h1>
...
<p>Wrap a &lt;div&gt; element around all &lt;p&gt; elements:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>
	&nbsp; $(&quot;p&quot;).wrapAll(&quot;&lt;div&gt;&lt;/div&gt;&quot;);<br>
	});
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_wrapall">Try it yourself &raquo;</a>
...
<p>The wrapAll() method wraps specified HTML element(s) around all selected elements.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).wrapAll(<i>wrappingElement</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies what HTML element(s) to wrap around the selected 
	elements<p>Possible values:</p>
	<ul>
		<li>HTML elements</li>
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_wrapall_element">
Create a new element with the DOM</a><br>
How to use document.createElement() to create an element, and wrap it around all selected elements.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_wrapall.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_wrapall.asp#top" target="_top">TOP</a> |
		<a href="html_wrapall.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
