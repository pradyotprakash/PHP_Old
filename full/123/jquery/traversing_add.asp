...
<style>a.menu_traversing_add{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">add()</span> Method</h1>
...
<p>Add &lt;p&gt; and &lt;span&gt; elements to an existing group of elements (&lt;h1&gt;):</p>
<div class="example_code notranslate">
  
    $(&quot;h1&quot;).add(&quot;p&quot;).add(&quot;span&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_add">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The add() method adds elements to an existing group of elements.</p>
<p>This method adds elements on the whole document, or just inside context 
elements if the <em>context</em> parameter is specified.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).add(<em>element,context</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>element</i></td>
    <td>Required. Specifies a selector expression, a jQuery object, one or more elements or an HTML snippet to be added to an existing 
	group of elements</td>
  </tr>
  <tr>
    <td><em>context</em>&nbsp;</td>
    <td>Optional. Specifies the point in the document at which the selector 
	expression should begin matching</td>
  </tr>
</table>
<br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_add_dom">DOM</a><br>
Add a &lt;span&gt; element to an existing group of &lt;p&gt; elements, by using a reference to 
a DOM element.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_add_snippet">HTML 
snippet</a><br>
Using an HTML snippet to add a &lt;span&gt; element to an existing &lt;p&gt; element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_add.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_add.asp#top" target="_top">TOP</a> |
		<a href="traversing_add.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
