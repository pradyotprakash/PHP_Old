...
<style>a.menu_event_hover{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">hover()</span> Method</h1>
...
<p>Change background color of a &lt;p&gt; element when the mouse pointer hovers over 
it:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_hover">Try it yourself &raquo;</a>
...
<p>The hover() method specifies two functions to run when the mouse pointer 
hovers over the selected elements.</p>
<p>This method triggers both the <a href="event_mouseenter.asp">mouseenter</a> 
and <a href="event_mouseleave.asp">mouseleave</a> events.</p>
<p><strong>Note:</strong> If only one function is specified, it will be run for 
both the mouseenter and mouseleave events.</p>
<hr>
...
$(<i>selector</i>).hover(<i>inFunction,outFunction</i>)
...
<table class="reference notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>inFunction</em></td>
    <td>Required. Specifies the function to run when the mouseenter event occurs</td>
    </tr>
  <tr>
    <td><em>outFunction</em></td>
    <td>Optional. Specifies the function to run when the mouseleave event occurs</td>
  </tr>
  </table>
  <br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_hover.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_hover.asp#top" target="_top">TOP</a> |
		<a href="event_hover.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
