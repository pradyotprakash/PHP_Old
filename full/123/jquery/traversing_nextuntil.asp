...
<style>a.menu_traversing_nextuntil{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">nextUntil()</span> Method</h1>
...
<div class="example_code notranslate">
    $(document).ready(function(){<br>&nbsp; $(&quot;li.start&quot;).nextUntil(&quot;li.stop&quot;).css({&quot;color&quot;:&quot;red&quot;,&quot;border&quot;:&quot;2px 
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
...
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_nextuntil">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The nextUntil() method returns all next sibling elements between the <em>selector</em> 
and <em>stop</em>. </p>
<p>Sibling elements are elements that share the same parent. </p>
<p><strong>The DOM tree:</strong> This method traverse forward along siblings 
of DOM elements.</p>
<p><strong>Note:</strong> If both parameters are empty, this method will 
return all next sibling elements (same as the <a href="traversing_nextall.asp">nextAll()</a> 
method).</p>
<p>Related methods:</p>
<ul>
	<li><a href="traversing_next.asp">next()</a> - returns the next sibling 
	element of the selected element</li>
	<li><a href="traversing_nextall.asp">nextAll()</a> - returns all next 
	sibling elements of the selected element</li>
</ul>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).nextUntil(<em>stop,filter</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	where to stop the search for next matching siblings elements</td>
  </tr>
    <tr>
    <td><i>filter</i></td>
...
<p>
<a href="tryit.asp?filename=tryjquery_traversing_nextuntil2" target="_blank">
Narrow down the search</a><br>
Using both parameters to filter the search for next sibling elements 
between two arguments.</p>
<p>
<a href="tryit.asp?filename=tryjquery_traversing_nextuntil_multi" target="_blank">
Return multiple siblings</a><br>
How to return multiple sibling elements between two arguments.</p>
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_nextuntil_dom">
DOM</a><br>
Using a DOM element instead of a selector to return all sibling elements two 
given arguments.</p>
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_nextuntil_dom2">
Using the DOM with both 
parameters</a><br>
Using a DOM element instead of a selector and both parameters to filter the 
next sibling search between two arguments.</p>
<hr>
<p><a href="jquery_ref_traversing.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery HTML Methods" /> jQuery 
Traversing Methods</a></p>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_nextuntil.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_nextuntil.asp#top" target="_top">TOP</a> |
		<a href="traversing_nextuntil.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
