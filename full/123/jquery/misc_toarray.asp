...
<title>jQuery Misc toArray() Method</title>
<style>a.menu_misc_toarray{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Misc <span class="color_h1">toArray()</span> Method</h1>
...
<p>Convert the &lt;li&gt; elements to an array, then alert the innerHTML of the array elements:</p>
...
&nbsp;&nbsp;&nbsp; {<br>
&nbsp;&nbsp;&nbsp; alert(x[i].innerHTML);<br>
&nbsp;&nbsp;&nbsp; }<br>
	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_misc_toarray" target="_blank">Try it yourself &raquo;</a>
...
<p>The toArray() method returns the elements matched by the jQuery 
selector as an array.</p>

<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).toArray()</div></div>
<br>
<hr>
<p><a href="jquery_ref_misc.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Misc Methods" /> jQuery Misc Methods</a></p>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="misc_toarray.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="misc_toarray.asp#top" target="_top">TOP</a> |
		<a href="misc_toarray.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
