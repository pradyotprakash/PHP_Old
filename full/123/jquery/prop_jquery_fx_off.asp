...
<title>jQuery jQuery.fx.off Property</title>
<style>a.menu_prop_jquery_fx_off{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">jQuery.fx.off</span> Property</h1>
...
<div class="example_code notranslate">
    $(&quot;#true&quot;).click(function(){<br>&nbsp; jQuery.fx.off = true;<br>});<br>
	$(&quot;#false&quot;).click(function(){<br>&nbsp; jQuery.fx.off = false;<br>});<br>
	$(&quot;#toggle&quot;).click(function(){<br>&nbsp; $(&quot;div&quot;).toggle(&quot;slow&quot;);<br>});</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_prop_jq_fx_off" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The jQuery.fx.off property is used to globally disable/enable all animations.</p>
<p>Default value is false, which allows animations to run normally. When set to 
true, all animation methods will be disabled, which will immediately set 
elements to their final state, instead of displaying an effect.</p>
<p><strong>Tip:</strong> To shorten the code, it is possible to use $.fx.off 
instead of jQuery.fx.off.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	jQuery.fx.off = true|false;</div></div>
  <br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td>true</td>
    <td>Specifies that animations should be disabled</td>
  </tr>
   <tr>
    <td>false&nbsp;</td>
    <td>Default. Specifies that animations should be enabled</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_jquery_fx_off.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_jquery_fx_off.asp#top" target="_top">TOP</a> |
		<a href="prop_jquery_fx_off.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
