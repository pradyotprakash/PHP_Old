...
<style>a.menu_event_trigger{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">trigger()</span> Method</h1>
...
<div class="example_code notranslate">
    ...
    $(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;input&quot;).trigger(&quot;select&quot;);<br>	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_trigger" target="_blank">Try it yourself &raquo;</a>
...
<p>The trigger() method triggers the specified event and the default behavior of 
an event (like form submission) for the selected elements.</p>
<p>This method is similar to the <a href="event_triggerhandler.asp">triggerHandler()</a> 
method, except that triggerHandler() does not trigger the default behavior of 
the event.</p>
<hr>
...
<div class="code notranslate"><div>
    ...
    $(<i>selector</i>).trigger(<i>event,eventObj,param1,param2,...</i>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>event</em></td>
    <td>Required. Specifies the event to trigger for the specified 
	element.<br>
	Can be a custom event, or 
  ...
  <tr>
    ...
    <td>Optional. Additional parameters to pass on to 
	the event handler.<br>
	Additional parameters are especially useful with custom events</td>
...
<p><a href="tryit.asp?filename=tryjquery_event_trigger_param" target="_blank">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_trigger.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_trigger.asp#top" target="_top">TOP</a> |
		<a href="event_trigger.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
