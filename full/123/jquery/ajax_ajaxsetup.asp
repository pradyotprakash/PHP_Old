...
<style>a.menu_ajax_ajaxsetup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">ajaxSetup()</span> Method</h1>
<p><a href="jquery_ref_ajax.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery AJAX Methods" /> jQuery 
AJAX Methods</a></p>
...
<p>Set the default URL and success function for all AJAX requests:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>
&nbsp; $.ajaxSetup({url:&quot;demo_ajax_load.txt&quot;,success:function(result){<br>
&nbsp;&nbsp;&nbsp; $(&quot;div&quot;).html(result);}});<br>
&nbsp; $.ajax();<br>
	});
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_ajaxsetup" target="_blank">Try it yourself &raquo;</a>
...
<p>The ajaxSetup() method sets default values for future AJAX requests.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$.ajaxSetup(<i>{name:value, name:value, ... }</i>)</div></div>
<p>The parameters specifies the settings for AJAX requests with one or more name/value pairs.</p>
...
<table class="reference notranslate"> 
  <tr>
	...
	<tr>
    <td>context</td>
    <td>Specifies the &quot;this&quot; value for all AJAX related callback functions</td>
    </tr>
	<tr>
    <td>data</td>
...
<p>
<a href="tryit.asp?filename=tryjquery_ajax_ajaxsetup_error" target="_blank">
Specify an error handler for AJAX requests</a><br>
How to use the error setting to specify an error handler for AJAX requests.</p>
<hr>
<p><a href="jquery_ref_ajax.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery AJAX Methods" /> jQuery 
AJAX Methods</a></p>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_ajaxsetup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_ajaxsetup.asp#top" target="_top">TOP</a> |
		<a href="ajax_ajaxsetup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
