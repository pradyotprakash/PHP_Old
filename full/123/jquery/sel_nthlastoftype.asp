...
<style>a.menu_sel_nthlastoftype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:nth-last-of-type()</span> Selector</h1>
<p><a href="jquery_ref_selectors.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Selectors" /> jQuery Selectors</a></p>

<div class="example">


<h2 class="example">Example</h2>
<p>Select each &lt;p&gt; element that is the third &lt;p&gt; element of its parent, 
counting from the last child:</p>
<div class="example_code notranslate">
  
    $(&quot;p:nth-last-of-type(3)&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_nthlastoftype">Try it yourself &raquo;</a>
...
<p>The :nth-last-of-type(<em>n</em>) selector selects all elements that are the <em>n</em>th 
child, of a particular type, 
of 
their parent, counting from the last child.</p>
<p><strong>Tip:</strong> Use the <a href="sel_nthlastchild.asp">:nth-last-child()</a> selector to select all 
elements that are the <em>n</em>th child, <strong>regardless of type</strong>, 
of 
their parent, counting from the last child.</p>
...
<div class="code notranslate"><div>
	:nth-last-of-type(<em>n</em>|even|odd|<em>formula</em>)</div></div>
  <br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>n</em></td>
    <td>The index of each child to match.<br><br>Must be a number. The first 
	element has the index number 1.<br>
	  </td>
  </tr>
   
  <tr>
    <td>even</td>
    <td>Selects each even child element</td>
  </tr>
   
  <tr>
    <td>odd</td>
    <td>Selects each odd child element</td>
  </tr>
   
  <tr>
    <td><em>formula</em></td>
    <td>Specifies which child element(s) to be selected with a formula (<em>an</em> + <em>b</em>). 
	Example: p:nth-last-child(3n+2) selects each 3rd paragraph, starting at the 
	last 2nd 
	paragraph</td>
  </tr>
...
<p><a href="tryit.asp?filename=tryjquery_sel_nthlastoftype2" target="_blank">
Select each &lt;p&gt; element that is the first &lt;p&gt; element&gt; of all &lt;div&gt; element, counting from the last 
child</a><br>
How to select each &lt;p&gt; element that is the first &lt;p&gt; element of all &lt;div&gt; elements, counting from 
the last child.</p>

<p><a href="tryit.asp?filename=tryjquery_sel_nthlastoftype_formula" target="_blank">Using a 
formula (an + b)</a><br>
How to use a formula (<em>an</em> + <em>b</em>) to select different &lt;p&gt; elements, 
counting from the last child.</p>

<p><a href="tryit.asp?filename=tryjquery_sel_nthlastoftype_evenodd" target="_blank">Using 
&quot;even&quot; and &quot;odd&quot;</a><br>
How to use even and odd to select different &lt;p&gt; elements, counting from the 
last child.</p>
<p><a href="tryit.asp?filename=tryjquery_sel_nthchild_nthoftype" target="_blank">
Difference between :nth-child(), :nth-last-child(), :nth-of-type() and 
:nth-of-last-type()</a><br>
The difference between p:nth-child(2), p:nth-last-child(2), p:nth-of-type(2) and 
p:nth-of-last-type(2).</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_nthlastoftype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_nthlastoftype.asp#top" target="_top">TOP</a> |
		<a href="sel_nthlastoftype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
