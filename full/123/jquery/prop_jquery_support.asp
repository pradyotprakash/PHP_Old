...
<title>jQuery jQuery.support Property</title>
<style>a.menu_prop_jquery_support{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">jQuery.support</span> Property</h1>
...
<p>Test whether the browser can create an XMLHttpRequest object:</p>
<div class="example_code notranslate">
    $(document).ready(function(){<br>&nbsp; $(&quot;p&quot;).html(&quot;This browser can create 
	XMLHttpRequest object: &quot; + jQuery.support.ajax);<br>});   
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_prop_jq_support" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The jQuery.support property contains a collection of properties representing different browser features or bugs.</p>
<p>This property was primarily intended for jQuery’s internal use.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	jQuery.support.<em>propvalue</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>propvalue</em></td>
    <td>Required. Specifies the function to test for. The tests included are:
    <ul>
		<li>ajax</li>
		<li>boxModel</li>
		<li>changeBubbles</li>
		...
		<li>cors</li>
		<li>cssFloat</li>
		<li>hrefNormalized</li>
		<li>htmlSerialize</li>
		<li>leadingWhitespace</li>
		<li>noCloneChecked</li>
		<li>noCloneEvent</li>
		<li>opacity</li>
		<li>optDisabled</li>
		<li>optSelected</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_jquery_support.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_jquery_support.asp#top" target="_top">TOP</a> |
		<a href="prop_jquery_support.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
