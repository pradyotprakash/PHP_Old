...
<style>a.menu_sel_eq{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:eq()</span> Selector</h1>
...
<p>Select the second &lt;p&gt; element:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_eq">Try it yourself &raquo;</a>
...
<p>The :eq() selector selects an element with a specific index number.</p>
<p>The index numbers start at 0, so the first element will have the index number 0 
(not 1).</p>
<p>This is mostly used together with another selector to select a specifically 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>index</em></td>
    <td>Required. Specifies the index of the element</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_eq.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_eq.asp#top" target="_top">TOP</a> |
		<a href="sel_eq.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
