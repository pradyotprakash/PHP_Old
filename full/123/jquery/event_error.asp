...
<style>a.menu_event_error{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">error()</span> Method</h1>
...
<p>If the image element encounters an error, replace it with a text:</p>
<div class="example_code notranslate">
  
    &nbsp;$(&quot;img&quot;).error(function(){<br>&nbsp; $(&quot;img&quot;).replaceWith(&quot;&lt;p&gt;Error 
	loading image!&lt;/p&gt;&quot;);<br>});   
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_error_trigger">Try it yourself &raquo;</a>
...
<p><span class="deprecated">The error() method was <a href="javascript:NewWindow('deprecated.htm')">deprecated</a> 
 in jQuery version 1.8.</span></p>

<p>The error event occurs when an element encounters an error (if the element is not 
loaded correctly).</p>
<p>The error() method triggers the error event, or attaches a function to run 
when an error event occurs.</p>
<p><b>Tip:</b> This method is a shortcut for bind('error', handler).</p>
<hr>

<h2>Syntax</h2>
<p>Trigger the error event for the selected elements:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).error()
  
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_error_trigger">Try it</a>    
</div>
</div>
<p>Attach a function to the error event:</p>
<div class="code notranslate"><div>
  
    $(<i>selector</i>).error(<i>function</i>)
  
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_error">Try it</a>      
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the function to run when the error event occurs</td>
  </tr>
  </table>
  <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_error.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_error.asp#top" target="_top">TOP</a> |
		<a href="event_error.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
