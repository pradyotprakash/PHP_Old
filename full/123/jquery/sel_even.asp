...
<style>a.menu_sel_even{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">:even</span> Selector</h1>
...
<p>Select every other (even) &lt;tr&gt; element:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_even">Try it yourself &raquo;</a>
...
<p>The :even selector selects each element with an even index number (like: 0, 2, 
4, etc.).</p>
<p>The index numbers start at 0.</p>
<p>This is mostly used together with another selector to select every even 
indexed element in a group (like in the example above).</p>
<p><b>Tip:</b> Use the <a href="sel_odd.asp">:odd</a> selector to select 
elements with odd index numbers.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_even.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_even.asp#top" target="_top">TOP</a> |
		<a href="sel_even.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
