...
<style>a.menu_jquery_animate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<button id="bDemo">Start Animation</button><br><br>
<div id="divDemo" style="background:#98bf21;height:100px;width:210px;position:relative;">jQuery</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_animate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_animate.asp#top" target="_top">TOP</a> |
		<a href="jquery_animate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
