...
<title>jQuery parent descendant Selector</title>
<style>a.menu_sel_parent_descendant{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">parent descendant</span> Selector</h1>
...
<p>Select all &lt;span&gt; elements that are descendants of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
  
    $(&quot;div span&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_sel_parent_descendant">Try it yourself &raquo;</a>
...
<p>The (&quot;parent descendant&quot;) selector selects all elements that are descendants of a 
specified element. </p>
<p>A descendant of an element could be a child, grandchild, 
great-grandchild, etc, of that element.</p>

<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
	(&quot;<em>parent descendant</em>&quot;)</div></div>
  <br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>parent</em></td>
    <td>Required. Specifies the parent element to be selected<br>
	  </td>
  </tr>
   
  <tr>
    <td><em>descendant</em></td>
    <td>Required. Specifies the descendant element (of the specified parent element) to be selected </td>
  </tr>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_sel_parent_descendant2">
Select all &lt;li&gt; elements that are descendants of an &lt;ul&gt; element</a><br>
How to select all &lt;li&gt; elements that are descendants of an &lt;ul&gt; 
element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_parent_descendant.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_parent_descendant.asp#top" target="_top">TOP</a> |
		<a href="sel_parent_descendant.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
