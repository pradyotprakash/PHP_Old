...
<style>a.menu_html_attr{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">attr()</span> Method</h1>
...
<p>Set the width attribute of an image:</p>
<div class="example_code notranslate">
$(&quot;button&quot;).click(function(){<br>&nbsp; $(&quot;img&quot;).attr(&quot;width&quot;,&quot;500&quot;);<br>	});
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_attr_set">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The attr() method sets or returns attributes and values of the selected elements.</p>
<p>When this method is used to <strong>return</strong> the attribute value, it returns the value of the FIRST matched element.</p>
<p>When this method is used to <strong>set</strong> attribute values, it sets one or more attribute/value pairs for the set of 
matched elements.</p>
<hr>
...
$(<i>selector</i>).attr(<i>attribute</i>)</div>
</div>

<p>Set the attribute and value:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).attr(<i>attribute,value</i>)</div>
</div>

<p>Set attribute and value using a function:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).attr(<i>attribute,</i>function(<i>index,currentvalue</i>))</div>
</div>

<p>Set multiple attributes and values:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).attr({<i>attribute</i>:<i>value</i>, <i>attribute</i>:<i>value</i>,...})</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>value</i></td>
    <td>Specifies the value of the attribute</td>
  </tr>
  <tr>
    <td>function(<i>index,currentvalue</i>)</td>
    <td>Specifies a function that returns the attribute value to set<ul>
		<li><i>index</i> - Receives the index position of the element in the set</li>
		<li><i>currentvalue</i> - Receives the current attribute value of 
...
<p><a target="_blank" href="tryit.asp?filename=tryjquery_html_attr_get">Return attribute value</a><br>
How to return the value of an attribute for an element.</p>

<p><a href="tryit.asp?filename=tryjquery_html_attr_set_func" target="_blank">Set attribute and value using a function</a><br>
How to use a function to set the attribute value for an element.</p>

<p><a href="tryit.asp?filename=tryjquery_html_attr_set_pairs" target="_blank">Set multiple attribute and value pairs</a><br>
How to set multiple attributes/values for an element.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_attr.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_attr.asp#top" target="_top">TOP</a> |
		<a href="html_attr.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
