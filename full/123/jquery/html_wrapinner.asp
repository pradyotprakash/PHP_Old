...
<style>a.menu_html_wrapinner{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">wrapInner()</span> Method</h1>
...
<p>Wrap a &lt;b&gt; element around the content of each &lt;p&gt; element:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_wrapinner">Try it yourself &raquo;</a>
...
<p>The wrapInner() method wraps specified HTML element(s) around the content (innerHTML) 
of each selected element.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).wrapInner(<i>wrappingElement</i>,function<i>(index)</i>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies what HTML element(s) to wrap around the content of 
	each selected element<p>Possible values:</p>
	<ul>
		<li>HTML elements</li>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_html_wrapinner_element">
Create a new element with the DOM</a><br>
How to use document.createElement() to create an element, and wrap it around the 
content of each selected element.</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_html_wrapinner_func">Wrap content using a function</a><br>
Using a function to specify what to wrap around the content of each selected element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_wrapinner.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_wrapinner.asp#top" target="_top">TOP</a> |
		<a href="html_wrapinner.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
