...
<style>a.menu_eff_slidedown{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">slideDown()</span> Method</h1>
...
<p>Slide-down (show) all hidden &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_eff_slideup_slidedown">Try it yourself &raquo;</a>
...
<p><b>Note:</b> slideDown() works on elements hidden with jQuery methods and display:none in CSS (but not visibility:hidden).</p>
<p><b>Tip:</b> To slide-up (hide) elements, look at the
<a href="eff_slideup.asp">slideUp()</a> method.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).slideDown(<i>speed,easing,callback</i>)</div></div>
<br>
...
<p>
<a href="tryit.asp?filename=tryjquery_eff_slideup_slidedown_speed" target="_blank">
slideDown() - Using the speed parameter</a><br>
How to use the speed parameter to specify the speed of the slide effect.</p>

<p>
<a href="tryit.asp?filename=tryjquery_eff_slideup_slidedown_call" target="_blank">
slideDown() - Using the callback parameter</a><br>
How to use the callback parameter when sliding up and down the selected elements.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="eff_slidedown.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="eff_slidedown.asp#top" target="_top">TOP</a> |
		<a href="eff_slidedown.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
