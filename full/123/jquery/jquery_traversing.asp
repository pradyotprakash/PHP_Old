...
<style>a.menu_jquery_traversing{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">Traversing</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquery_dimensions.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquery_traversing_ancestors.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>What is Traversing?</h2>
<p>jQuery traversing, which means &quot;move through&quot;, are used to &quot;find&quot; (or select) 
...
<p>The image below illustrates a family tree. With jQuery traversing, you can 
easily move up (ancestors), down (descendants) and sideways (siblings) in the family tree,  starting from the 
selected (current) element. This movement is called traversing - or moving 
through - the DOM.</p>

<p style="text-align:center;">
<img alt="jQuery Dimensions" src="img_travtree.png" width="350" height="165"></p>

<p>Illustration explained:</p>
<ul>
	<li>The &lt;div&gt; element is the<strong> parent</strong> of &lt;ul&gt;, and an <strong>
	ancestor</strong> of everything inside of it </li>
	<li>The &lt;ul&gt; element is the <strong>parent</strong> of both &lt;li&gt; elements, and a 
	<strong>child</strong> of 
	&lt;div&gt;</li>
	<li>The left &lt;li&gt; element is the <strong>parent</strong> of &lt;span&gt;,
	<strong>child</strong> of &lt;ul&gt; and a <strong>descendant</strong> of &lt;div&gt;</li>
	<li>The &lt;span&gt; element is a <strong>child</strong> of the left &lt;li&gt; and a
	<strong>descendant</strong> of &lt;ul&gt; 
	and &lt;div&gt; </li>
	<li>The two &lt;li&gt; elements are <strong>siblings</strong> (they share 
	the same parent)</li>
	<li>The right &lt;li&gt; element is the <strong>parent</strong> of &lt;b&gt;, 
	<strong>child</strong> of &lt;ul&gt; and a <strong>descendant</strong> of &lt;div&gt; 
	</li>
	<li>The &lt;b&gt; element is a <strong>child</strong> of the right &lt;li&gt; and a
	<strong>descendant</strong> of &lt;ul&gt; 
	and &lt;div&gt;</li>
</ul>
<br>
...
<td>An ancestor is a parent, grandparent, great-grandparent, and so on.<br>A 
descendant is a child, grandchild, great-grandchild, and so on.<br>
Siblings share the same parent.</td>
</tr>
</table>
<br>
<hr>
<h2>Traversing the DOM</h2>
<p>jQuery provides a variety of methods that allows us to traverse the DOM.</p>
<p>The largest category of traversal methods are tree-traversal.</p>
<p>The next chapters will show us how to travel up, down and sideways in 
the DOM tree.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquery_traversing.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquery_traversing.asp#top" target="_top">TOP</a> |
		<a href="jquery_traversing.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
