...
<style>a.menu_ajax_ajaxcomplete{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">ajaxComplete()</span> Method</h1>
...
<p>Show a &quot;loading&quot; indicator image while an AJAX request is going on:</p>
<div class="example_code notranslate">
$(document).ajaxStart(function(){<br>
&nbsp; $(&quot;#wait&quot;).css(&quot;display&quot;,&quot;block&quot;);<br>
});<br>
$(document).ajaxComplete(function(){<br>
&nbsp; $(&quot;#wait&quot;).css(&quot;display&quot;,&quot;none&quot;);<br>
});
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_ajaxcomplete" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ajaxComplete() method specifies a function to be run when an AJAX request completes.</p>
<p><strong>Note:</strong> As of jQuery version 1.8, this method should only be attached to document.</p>
<p>Unlike ajaxSuccess(), functions specified with the ajaxComplete() method will run when the request is completed,
even it is not successful. </p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(document).ajaxComplete(<i>function(event,xhr,options))</i></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>
	Required. Specifies the function to run when the request completes<br>
	Additional parameters:<br>
	<ul><li><em>event</em> - contains the event object</li>
		<li><em>xhr</em> - contains the XMLHttpRequest object</li>
		<li><em>options</em> - contains the options used in the AJAX request</li></ul>
		</td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_ajaxcomplete.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_ajaxcomplete.asp#top" target="_top">TOP</a> |
		<a href="ajax_ajaxcomplete.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
