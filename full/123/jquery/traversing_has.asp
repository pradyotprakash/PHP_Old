...
<style>a.menu_traversing_has{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">has()</span> Method</h1>
...
<p>Return all &lt;p&gt; elements that have a &lt;span&gt; element inside of them:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).has(&quot;span&quot;)</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_traversing_has">Try it yourself &raquo;</a>
...
<p>The has() method returns all elements that have one or more elements inside 
of them, that matches the specified selector. </p>
<p><strong>Tip:</strong> To select elements that have multiple elements inside 
of them, use comma (see example below).</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).has(<em>element</em>)</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>element</i></td>
    <td>Required. Specifies a selector expression or an element to match 
	elements against</td>
  </tr>
</table>
<br>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjquery_traversing_has_multi">Return 
an element with multiple elements inside</a><br>
How to return an element that has multiple elements inside of it.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_has2" target="_blank">Return 
all &lt;p&gt;, &lt;h3&gt; and &lt;div&gt; elements that have a &lt;span&gt; element inside of them</a><br>
How to return all &lt;p&gt;, &lt;h3&gt; and &lt;div&gt; elements that have a &lt;span&gt; element inside 
of them.</p>

<p>
<a href="tryit.asp?filename=tryjquery_traversing_has_links" target="_blank">
Return elements containing links</a><br>
How to return a &lt;span&gt; element that has a hyperlink.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="traversing_has.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="traversing_has.asp#top" target="_top">TOP</a> |
		<a href="traversing_has.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
