...
<style>a.menu_event_proxy{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">$.proxy()</span> Method</h1>
...
<p>Enforce the context of the &quot;test&quot; function, inside objPerson:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click($.proxy(objPerson,&quot;test&quot;));</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_event_proxy">Try it yourself &raquo;</a>
...
<p>The $.proxy method takes an existing function and returns a new one with a particular context.</p>
<p>This method is often used for attaching events to an element where the 
context is pointing back to a different object. </p>
<p><strong>Tip:</strong> If you bind the function returned from $.proxy, jQuery 
will still unbind the correct function if passed the original. </p>

<hr>

<h2>Syntax 1</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).proxy(<i>function,context</i>)

<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_proxy2">Try it</a>  
</div>
</div>
<br>
...
<h2>Syntax 2</h2>
<div class="code notranslate"><div>
$(<i>selector</i>).proxy(<i>context,name</i>)
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjquery_event_proxy">Try it</a>  
</div>
</div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>The existing function to be called</td>
  </tr>
  <tr>
    <td><em>context</em></td>
    <td>The name of the object where the function lies</td>
  </tr>
  <tr>
    <td><em>name</em></td>
    <td>The existing function whose context will be changed (should be a property of the context object).</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_proxy.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_proxy.asp#top" target="_top">TOP</a> |
		<a href="event_proxy.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
