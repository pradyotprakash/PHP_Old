...
<title>jQuery event.pageX Property</title>
<style>a.menu_event_pagex{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.pageX</span> Property</h1>
...
<p>Return the position of the mouse pointer:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_pagex_pagey" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.pageX property returns the position of the mouse pointer, relative to the 
left edge of the document.</p>
<p><strong>Tip:</strong> This event property is often used together with the
<a href="event_pagey.asp">event.pageY</a> property.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td style="height: 20px"><em>event</em></td>
    <td style="height: 20px">Required. The <em>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pagex.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pagex.asp#top" target="_top">TOP</a> |
		<a href="event_pagex.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
