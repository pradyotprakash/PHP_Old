...
<style>a.menu_ajax_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">get()</span> Method</h1>
...
<p>Send an HTTP GET request to a page and get a result back:</p>
...
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_get" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The $.get() method loads data from the server using a HTTP GET request.</p>
<hr>

<h2>Examples</h2>
<p>Request &quot;test.php&quot;, but ignore return results:</p>
<div class="code notranslate"><div>
$.get(&quot;test.php&quot;);</div></div>
<p>Request &quot;test.php&quot; and send some additional data along with the request 
(ignore return results):</p>
<div class="code notranslate"><div>
$.get(&quot;test.php&quot;, { name:&quot;Donald&quot;, town:&quot;Ducktown&quot; });</div></div>
<p>Request &quot;test.php&quot; and pass arrays of data to the server (ignore return 
results):</p>
<div class="code notranslate"><div>
$.get(&quot;test.php&quot;, { 'colors[]' : [&quot;Red&quot;,&quot;Green&quot;,&quot;Blue&quot;] });</div></div>
<p>Request &quot;test.php&quot; and alert the result of the request:</p>
<div class="code notranslate"><div>
...
<h2>Syntax</h2>
<div class="code notranslate"><div>
$.get(<i>URL,data,function(data,status,xhr),dataType)</i></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>URL</em></td>
    <td>Required. Specifies the URL you wish to request</td>
    </tr>
	<tr>
    <td><em>data</em></td>
    ...
    <td>Optional. Specifies a function to run if the request succeeds<br>
    Additional parameters:<br>
	<ul><li><em>data</em> - contains the resulting data from the request</li>
    ...
    <td>Optional. Specifies the data type expected of the server response.<br>
	By default jQuery performs an automatic guess.<br>
	Possible types:<ul>
		<li>&quot;xml&quot; - An XML document</li>
		<li>&quot;html&quot; - HTML as plain text</li>
		<li>&quot;text&quot; - A plain text string</li>
		<li>&quot;script&quot; - Runs the response as JavaScript, and 
		returns it as plain text</li>
		<li>&quot;json&quot; - Runs the response as JSON, and returns a 
		JavaScript object</li>
		<li>&quot;jsonp&quot; - Loads in a JSON block using JSONP. Will add an  
	&quot;?callback=?&quot; to the URL to specify the callback</li>
	</ul>
	</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_get.asp#top" target="_top">TOP</a> |
		<a href="ajax_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
