...
<style>a.menu_ajax_ajaxsuccess{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">ajaxSuccess()</span> Method</h1>
...
<p>Trigger an alert box when an AJAX request completes successfully:</p>
<div class="example_code notranslate">
$(document).ajaxSuccess(function(){<br>
&nbsp; alert(&quot;AJAX request successfully completed&quot;);<br>
});
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_ajax_ajaxsuccess" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ajaxSuccess() method specifies a function to be run when an AJAX request is successfully completed.</p>
<p><strong>Note:</strong> As of jQuery version 1.8, this method should only be attached to document.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
$(document).ajaxSuccess(<i>function(event,xhr,options))</i></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>function(event,xhr,options)</em></td>
    <td>
	Required. Specifies the function to run if the request succeeds<br>
	Additional parameters:<br>
	<ul><li><em>event</em> - contains the event object</li>
		<li><em>xhr</em> - contains the XMLHttpRequest object</li>
		<li><em>options</em> - contains the options used in the AJAX request</li>
	</ul>
	</td>
  </tr>
</table>
...
<p>
<a href="tryit.asp?filename=tryjquery_ajax_ajaxsuccess_options" target="_blank">
Use the options parameter</a><br>
How to use the options parameter to restrict the function to AJAX requests for a 
specific file.</p>
<hr>
<p><a href="jquery_ref_ajax.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery AJAX Methods" /> jQuery AJAX Methods</a></p>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ajax_ajaxsuccess.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ajax_ajaxsuccess.asp#top" target="_top">TOP</a> |
		<a href="ajax_ajaxsuccess.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
