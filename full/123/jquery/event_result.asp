...
<style>a.menu_event_result{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">event.result</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p>Return value of the previous click event:</p>
<div class="example_code notranslate">
  
    $(&quot;button&quot;).click(function(){<br>&nbsp; return &quot;Hello world!&quot;;<br>});<br>$(&quot;button&quot;).click(function(event){<br>
&nbsp; $(&quot;p&quot;).html(event.result);<br>
	});
  
</div>
<br>
<a class="tryitbtn" href="tryit.asp?filename=tryjquery_event_result" target="_blank">Try it yourself &raquo;</a>
...
<p>The event.result property contains the last/previous value returned by an event handler 
triggered by the specified event.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_result.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_result.asp#top" target="_top">TOP</a> |
		<a href="event_result.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
