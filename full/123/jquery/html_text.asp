...
<style>a.menu_html_text{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">text()</span> Method</h1>
...
<p>Set text content for all &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjquery_html_text_set">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The text() method sets or returns the text content of the selected elements.</p>
<p>When this method is used to<strong> return</strong> content, it returns the text 
content of all matched elements (HTML markup will be removed).</p>
<p>When this method is used to <strong>set</strong> content, it overwrites the content of ALL matched elements.</p>
<p><b>Tip:</b> To set or return the innerHTML (text + HTML markup) of the selected elements, 
use the <a href="html_html.asp">html()</a> method.</p>
<hr>

<h2>Syntax</h2>
<p>Return text content:</p>
...
<div class="code notranslate"><div>
$(<i>selector</i>).text(<em>content</em>)
</div>
</div>
<p>Set text content using a function:</p>
<div class="code notranslate"><div>
$(<i>selector</i>).text(function<i>(index,currentcontent)</i>)
</div>
</div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>content</i></td>
    <td>Required. Specifies the new text content for the selected elements<br><br>
    <b>Note:</b> Special characters will be encoded</td>
  </tr>
   <tr>
    <td>function(<i>index,currentcontent</i>)</td>
    <td>Optional. Specifies a function that returns the new text content for the selected elements
    <ul>
		<li><i>index</i> - Returns the index position of the element in the set</li>
		<li><i>currentcontent</i> - Returns current content of selected elements</li>
	</ul></td>
  </tr>
</table>
<br>
...
<p><a href="tryit.asp?filename=tryjquery_html_text_get" target="_blank">Return text content</a><br>
How to return text content of the selected elements.</p>

<p><a href="tryit.asp?filename=tryjquery_html_text_func" target="_blank">Set text content using a function</a><br>
Using a function to set the text content of the selected elements.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="html_text.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="html_text.asp#top" target="_top">TOP</a> |
		<a href="html_text.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
