...
<title>XML Schema String Datatypes</title>
<style>a.menu_schema_dtypes_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD <span class="color_h1">String</span> Data Types</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_example.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_dtypes_date.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">String data types are used for values that contains character strings.</p>
<hr>

<h2>String Data Type</h2>
<p>The string data type can contain characters, line feeds, carriage returns, and tab characters.</p>
<p>The following is an example of a string declaration in a schema:</p>
...
<p><b>Note:</b> The XML processor will not modify the value if you use the string data type.</p>
<hr>

<h2>NormalizedString Data Type</h2>
<p>The normalizedString data type is derived from the String data type.</p>
<p>The normalizedString data type also contains characters, but the XML processor will remove line feeds, carriage returns, and tab characters.</p>
<p>The following is an example of a normalizedString declaration in a schema:</p>
...
<p><b>Note:</b> In the example above the XML processor will replace the tabs with spaces.</p>
<hr>

<h2>Token Data Type</h2>
<p>The token data type is also derived from the String data type.</p>
<p>The token data type also contains characters, but the XML processor will 
remove line feeds, carriage returns, tabs, leading and trailing spaces, and multiple spaces.</p>
<p>The following is an example of a token declaration in a schema:</p>
...
<p><b>Note:</b> In the example above the XML processor will remove the tabs.</p>
<hr>

<h2>String Data Types</h2>
<p>Note that all of the data types below derive from the String data type (except for string itself)!</p>
<table class="reference notranslate">
  ...
  <tr>
    <td>ID</td>
    <td>A string that represents the ID attribute in XML (only used 
    with schema attributes)</td>
  </tr>
  <tr>
    <td>IDREF</td>
    <td>A string that represents the IDREF attribute in XML (only 
    used with schema attributes)</td>
  </tr>
  <tr>
    <td>IDREFS</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>language</td>
    <td>A string that contains a valid language id</td>
  </tr>
  <tr>
    <td>Name</td>
  ...
  <tr>
    <td>NMTOKEN</td>
    <td>A string that represents the NMTOKEN attribute in XML (only 
    used with schema attributes)</td>
  </tr>
  <tr>
    <td>NMTOKENS</td>
...
<br>
<hr>
<h2>Restrictions on String Data Types</h2>
<p>Restrictions that can be used with String data types:</p>
<ul>
  <li>enumeration</li>
  <li>length</li>
  <li>maxLength</li>
  <li>minLength</li>
  <li>pattern (NMTOKENS, IDREFS, and ENTITIES cannot use this constraint)</li>
  <li>whiteSpace</li>
</ul>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_dtypes_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_dtypes_string.asp#top" target="_top">TOP</a> |
		<a href="schema_dtypes_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
