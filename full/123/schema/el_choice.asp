...
<title>XML Schema choice Element</title>
<style>a.menu_el_choice{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">choice</span> Element</h1>
<hr>
...
<p>XML Schema choice element allows only one of the elements contained in the &lt;choice&gt; 
declaration to be present within the containing element.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>maxOccurs</td>
    <td>Optional. Specifies the maximum number of times the choice 
  ...
  <tr>
    <td>minOccurs</td>
    <td>Optional. Specifies the minimum number of times the choice 
...
<p>The example above defines an element named &quot;person&quot; which must 
contain either a &quot;employee&quot; element or a &quot;member&quot; element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_choice.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_choice.asp#top" target="_top">TOP</a> |
		<a href="el_choice.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
