...
<title>XML Schema Date/Time Datatypes</title>
<style>a.menu_schema_dtypes_date{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD <span class="color_h1">Date and Time</span> Data Types</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_dtypes_string.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_dtypes_numeric.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Date and time data types are used for values that contain date and time.</p>
<hr>

<h2>Date Data Type</h2>
<p>The date data type is used to specify a date.</p>
<p>The date is specified in the following form &quot;YYYY-MM-DD&quot; where:</p>
<ul>
  <li>YYYY indicates the year</li>
  <li>MM indicates the month</li>
  <li>DD indicates the day</li>
</ul>
<p><b>Note:</b> All components are required!</p>
<p>The following is an example of a date declaration in a schema:</p>
<div class="code notranslate"><div>
&lt;xs:element name=&quot;start&quot; type=&quot;xs:date&quot;/&gt;
</div></div>

<p>An element in your document might look like this:</p>
...
<h3>Time Zones</h3>
<p>To specify a time zone, you can either enter a date in UTC time by 
adding a &quot;Z&quot; behind the date - like this:</p>

<div class="code notranslate"><div>
&lt;start&gt;2002-09-24Z&lt;/start&gt;
</div></div>

<p>or you can specify an offset from the UTC time by adding a positive or negative time 
behind the date - like this:</p>

<div class="code notranslate"><div>

&lt;start&gt;2002-09-24-06:00&lt;/start&gt;<br><br>
or<br><br>
...
<p>The time data type is used to specify a time.</p>
<p>The time is specified in the following form &quot;hh:mm:ss&quot; where:</p>
<ul>
...
<p><b>Note:</b> All components are required!</p>
<p>The following is an example of a time declaration in a schema:</p>
...
<h3>Time Zones</h3>
<p>To specify a time zone, you can either enter a time in UTC time by adding a &quot;Z&quot; behind the time - like this:</p>

<div class="code notranslate"><div>
&lt;start&gt;09:30:10Z&lt;/start&gt;
</div></div>

<p>or you can specify an offset from the UTC time by adding a positive or negative time behind the time - like this:</p>

<div class="code notranslate"><div>

&lt;start&gt;09:30:10-06:00&lt;/start&gt;<br><br>
or<br><br>
...
<h2>DateTime Data Type</h2>
<p>The dateTime data type is used to specify a date and a time.</p>
<p>The dateTime is specified in the following form &quot;YYYY-MM-DDThh:mm:ss&quot; where:</p>
<ul>
  <li>YYYY indicates the year</li>
  <li>MM indicates the month</li>
  <li>DD indicates the day</li>
...
<p><b>Note:</b> All components are required!</p>
<p>The following is an example of a dateTime declaration in a schema:</p>
...
<h3>Time Zones</h3>
<p>To specify a time zone, you can either enter a dateTime in UTC time by 
adding a &quot;Z&quot; behind the time - like this:</p>
...
<p>or you can specify an offset from the UTC time by adding a positive or negative time 
behind the time - like this:</p>

<div class="code notranslate"><div>

&lt;startdate&gt;2002-05-30T09:30:10-06:00&lt;/startdate&gt;<br><br>
or<br><br>
...
<h2>Duration Data Type</h2>
<p>The duration data type is used to specify a time interval.</p>
<p>The time interval is specified in the following form &quot;PnYnMnDTnHnMnS&quot; where:</p>
<ul>
  ...
  <li>T indicates the start of a time section (required if you are going to 
  specify hours, minutes, or seconds)</li>
  <li>nH indicates the number of hours</li>
  <li>nM indicates the number of minutes</li>
  <li>nS indicates the number of seconds</li>
</ul>
<p>The following is an example of a duration declaration in a schema:</p>
...
<p>The example above indicates a period of five years.</p>
<p>Or it might look like this:</p>
...
<p>The example above indicates a period of five years, two months, and 10 days.</p>
<p>Or it might look like this:</p>
...
<p>The example above indicates a period of five years, two months, 10 days, and 15 hours.</p>
<p>Or it might look like this:</p>
...
<p>The example above indicates a period of 15 hours.</p>

<h3>Negative Duration</h3>
<p>To specify a negative duration, enter a minus sign before the P:</p>

<div class="code notranslate"><div>
&lt;period&gt;-P10D&lt;/period&gt;
</div></div>

<p>The example above indicates a period of minus 10 days.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>gYear</td>
    <td>Defines a part of a date - the year (YYYY)</td>
  </tr>
  <tr>
    <td>gYearMonth</td>
    <td>Defines a part of a date - the year and month (YYYY-MM)</td>
  </tr>
  <tr>
    <td>time</td>
...
<br>
<hr>
<h2>Restrictions on Date Data Types</h2>
<p>Restrictions that can be used with Date data types:</p>
<ul>
  <li>enumeration</li>
  <li>maxExclusive</li>
  <li>maxInclusive</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_dtypes_date.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_dtypes_date.asp#top" target="_top">TOP</a> |
		<a href="schema_dtypes_date.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
