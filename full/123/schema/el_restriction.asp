...
<title>XML Schema restriction Element</title>
<style>a.menu_el_restriction{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">restriction</span> Element</h1>
<hr>
...
<p>The restriction element defines restrictions on a simpleType, simpleContent, 
or complexContent definition.</p>

<h3>Element Information</h3>

<ul>
  <li><b>Parent elements:</b> simpleType, simpleContent, complexContent</li>
</ul>
...
&gt;<br>
<br>
Content for simpleType:<br>
(annotation?,(simpleType?,(minExclusive|minInclusive|<br>
maxExclusive|maxInclusive|totalDigits|fractionDigits|<br>
length|minLength|maxLength|enumeration|whiteSpace|pattern)*))<br>
<br>
Content for simpleContent:<br>
(annotation?,(simpleType?,(minExclusive |minInclusive|<br>
maxExclusive|maxInclusive|totalDigits|fractionDigits|<br>
length|minLength|maxLength|enumeration|whiteSpace|pattern)*)?,<br>
((attribute|attributeGroup)*,anyAttribute?))<br>
<br>
Content for complexContent:<br>
(annotation?,(group|all|choice|sequence)?,<br>
((attribute|attributeGroup)*,anyAttribute?))<br>
<br>
&lt;/restriction&gt;
...
inside the restriction element)</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>base</td>
    <td>
<p>Required. Specifies the name of a built-in data type, simpleType element, or 
complexType element defined in this schema or another schema</p>
...
<p>This example defines an element called &quot;age&quot; with a restriction. The value of 
age can NOT be lower than 0 or greater than 100:</p>
<div class="code notranslate"><div>
...
<p>This example also defines an element called &quot;initials&quot;. The &quot;initials&quot; 
element is a simple type with a restriction. The only acceptable value is THREE 
of the LOWERCASE OR UPPERCASE letters from a to z:</p>
<div class="code notranslate"><div>
...
<p>This example defines an element called &quot;password&quot;. The &quot;password&quot; element is 
a simple type with a restriction. The value must be minimum five characters and 
maximum eight characters:</p>
<div class="code notranslate"><div>
...
<p>This example shows a complex type definition using restriction. The complex 
type &quot;Norwegian_customer&quot; is derived from a general customer complex type and 
its country element is fixed to &quot;Norway&quot;:</p>
<div class="code notranslate"><div>
...
&lt;/xs:complexType&gt;<br>
<br>
&lt;xs:complexType name=&quot;Norwegian_customer&quot;&gt;<br>
&nbsp;&nbsp;&lt;xs:complexContent&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:restriction base=&quot;customer&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:sequence&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element name=&quot;firstname&quot; type=&quot;xs:string&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element name=&quot;lastname&quot; type=&quot;xs:string&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element name=&quot;country&quot; type=&quot;xs:string&quot; fixed=&quot;Norway&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/xs:sequence&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/xs:restriction&gt;<br>
&nbsp;&nbsp;&lt;/xs:complexContent&gt;<br>
&lt;/xs:complexType&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_restriction.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_restriction.asp#top" target="_top">TOP</a> |
		<a href="el_restriction.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
