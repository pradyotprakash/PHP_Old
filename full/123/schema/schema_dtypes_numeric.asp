...
<title>XML Schema Numeric Datatypes</title>
<style>a.menu_schema_dtypes_numeric{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD <span class="color_h1">Numeric</span> Data Types</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_dtypes_date.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_dtypes_misc.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Decimal data types are used for numeric values.</p>
<hr>

<h2>Decimal Data Type</h2>
<p>The decimal data type is used to specify a numeric value.</p>

<p>The following is an example of a decimal declaration in a schema:</p>
...
<p><b>Note:</b> The maximum number of decimal digits you can specify is 18.</p>
<hr>

<h2>Integer Data Type</h2>
<p>The integer data type is used to specify a numeric value without a fractional component.</p>

<p>The following is an example of an integer declaration in a schema:</p>
<div class="code notranslate"><div>
...
<p>Note that all of the data types below derive from the Decimal data type 
(except for decimal itself)!</p>
...
<br>
<hr>
<h2>Restrictions on Numeric Data Types</h2>
<p>Restrictions that can be used with Numeric data types:</p>
<ul>
  <li>enumeration</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_dtypes_numeric.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_dtypes_numeric.asp#top" target="_top">TOP</a> |
		<a href="schema_dtypes_numeric.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
