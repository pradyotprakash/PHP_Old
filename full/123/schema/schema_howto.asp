...
<title>XML Schema How To</title>
<style>a.menu_schema_howto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD <span class="color_h1">How To?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_why.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_schema.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XML documents can have a reference to a DTD or to an XML Schema.</p>
<hr>

<h2>A Simple XML Document</h2>
<p>Look at this simple XML document called &quot;note.xml&quot;:</p>
...
<h2>A DTD File</h2>
<p>The following example is a DTD file called &quot;note.dtd&quot; that
defines the elements of the XML document above (&quot;note.xml&quot;):</p>
...
<p>The first line defines the note element to have four child elements: &quot;to, from, heading, body&quot;.</p>
<p>Line 2-5 defines the to, from, heading, body  elements  to be of type &quot;#PCDATA&quot;.</p>
<hr>

<h2>An XML Schema</h2>
<p>The following example is an XML Schema file called &quot;note.xsd&quot; that defines the elements of the XML 
document above (&quot;note.xml&quot;):</p>
...
<p>The note element is a <b> complex type</b> because it contains other elements. 
The other elements (to, from, heading, body) are <b>simple types</b> because they do
not contain other elements. You will learn more about simple and complex types 
in the following chapters.</p>
<hr>

<h2>A Reference to a DTD</h2>
<p>This XML document has a reference to a DTD:</p>

<div class="code notranslate"><div>

&lt;?xml version=&quot;1.0&quot;?&gt;<br><br>
&lt;!DOCTYPE note SYSTEM<br>
&quot;http://www.w3schools.com/dtd/note.dtd&quot;&gt;<br><br>
&lt;note&gt;<br>
&nbsp;
&lt;to&gt;Tove&lt;/to&gt;<br>
&nbsp;
...
<h2>A Reference to an XML Schema</h2><p>This XML document has a reference to an XML Schema:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_howto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_howto.asp#top" target="_top">TOP</a> |
		<a href="schema_howto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
