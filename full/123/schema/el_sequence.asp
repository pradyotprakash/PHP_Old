...
<title>XML Schema sequence Element</title>
<style>a.menu_el_sequence{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">sequence</span> Element</h1>
<hr>
...
<p>The sequence element specifies that the child elements must appear in a 
sequence. Each child element can occur from 0 to any number of times.</p>

<h3>Element Information</h3>
<ul>
  <li><b>Parent elements:</b> group, choice, sequence, complexType, restriction 
...
&gt;<br>
<br>
(annotation?,(element|group|choice|sequence|any)*)<br>
<br>
&lt;/sequence&gt;

</div></div>
<p>(The ? sign declares that the element can occur zero or one time inside the 
sequence element)</p>
<table class="reference notranslate">
  ...
  <tr>
    <td>maxOccurs</td>
    <td>Optional. Specifies the maximum number of times the 
    sequence 
  ...
  <tr>
    <td>minOccurs</td>
    <td>Optional. Specifies the minimum number of times the 
    sequence 
...
<h3>Example 1</h3>
<p>This example shows a declaration for an element called &quot;personinfo&quot;, which 
must contain the following five elements in order; &quot;firstname&quot;, &quot;lastname&quot;, 
&quot;address&quot;, &quot;city&quot;, and &quot;country&quot;:</p>

<div class="code notranslate"><div>

&lt;xs:element name=&quot;personinfo&quot;&gt;<br>
&nbsp;&nbsp;&lt;xs:complexType&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:sequence&gt;<br>
...
<h3>Example 2</h3>
<p>This example shows a declaration for an element called &quot;pets&quot; that 
can have zero or more of the following elements, dog and cat, in the sequence 
element:</p>

<div class="code notranslate"><div>

&lt;xs:element name=&quot;pets&quot;&gt;<br>
&nbsp;&nbsp;&lt;xs:complexType&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:sequence minOccurs=&quot;0&quot; maxOccurs=&quot;unbounded&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element name=&quot;dog&quot; type=&quot;xs:string&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element name=&quot;cat&quot; type=&quot;xs:string&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/xs:sequence&gt;<br>
&nbsp;&nbsp;&lt;/xs:complexType&gt;<br>
&lt;/xs:element&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_sequence.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_sequence.asp#top" target="_top">TOP</a> |
		<a href="el_sequence.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
