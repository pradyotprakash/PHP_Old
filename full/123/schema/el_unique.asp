...
<title>XML Schema unique Element</title>
<style>a.menu_el_unique{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">unique</span> Element</h1>
<hr>
...
<p>The unique element defines that an element or an attribute value must be 
unique within the scope.</p>

<p>The unique element MUST contain the following (in order):</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>Required. Specifies a name for the element</td>
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_unique.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_unique.asp#top" target="_top">TOP</a> |
		<a href="el_unique.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
