...
<title>XML Schema key Element</title>
...
<h1>XML Schema <span class="color_h1">key</span> Element</h1>
<hr>
...
<p>The key element specifies an attribute or element value as a key (unique, 
non-nullable, and always present) within the containing element in an instance 
document.</p>

<p>The key element MUST contain the following (in order):</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>Required. Specifies the name of the key element</td>
  </tr>
  <tr>
