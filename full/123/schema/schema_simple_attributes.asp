...
<title>XML Schema Attributes</title>
<style>a.menu_schema_simple_attributes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD <span class="color_h1">Attributes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_simple.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_facets.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">All attributes are declared as simple types.</p>
<hr>
<h2>What is an Attribute?</h2>
<p>Simple elements cannot have attributes. If an element has attributes, it is considered to be of a complex type. But the attribute itself is always declared 
as a simple type.</p>
<hr>

<h2>How to Define an Attribute?</h2>
<p>The syntax for defining an attribute is:</p>

<div class="code notranslate"><div>
&lt;xs:attribute name=&quot;xxx&quot; type=&quot;yyy&quot;/&gt;
</div></div>

<p>where xxx is the name of the attribute and yyy specifies the data type of the attribute.</p>
<p>XML Schema has a lot of built-in data types. The most common types are:</p>
<ul>
	<li>xs:string</li>
	<li>xs:decimal</li>
	<li>xs:integer</li>
...
<h3>Example</h3>
<p>Here is an XML element with an attribute:</p>

<div class="code notranslate"><div>
&lt;lastname lang=&quot;EN&quot;&gt;Smith&lt;/lastname&gt;
</div></div>

<p>And here is the corresponding attribute definition:</p>
<div class="code notranslate"><div>
...
<h2>Default and Fixed Values for Attributes</h2>
<p>Attributes may have a default value OR a fixed value specified.</p>
<p>A default value is automatically assigned to the attribute when no other value is specified.</p>
<p>In the following example the default value is &quot;EN&quot;:</p>

<div class="code notranslate"><div>
&lt;xs:attribute name=&quot;lang&quot; type=&quot;xs:string&quot; default=&quot;EN&quot;/&gt;
</div></div>

<p>A fixed value is also automatically assigned to the attribute, and you cannot specify another value.</p>
<p>In the following example the fixed value is &quot;EN&quot;:</p>
...
<h2>Optional and Required Attributes</h2>
<p>Attributes are optional by default. To specify that the attribute is required, use the &quot;use&quot; attribute:</p>
...
<h2>Restrictions on Content</h2>
<p>When an XML element or attribute has a data type defined, it puts restrictions on the
element's or attribute's content.</p>
<p>If an XML element is of type &quot;xs:date&quot; and contains a string like &quot;Hello
World&quot;, the element will not validate.</p>
<p>With XML Schemas, you can also add your own restrictions to your XML
elements and attributes. These restrictions are called facets.&nbsp;You can read more about
facets in the next chapter.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_simple.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_facets.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_simple_attributes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_simple_attributes.asp#top" target="_top">TOP</a> |
		<a href="schema_simple_attributes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
