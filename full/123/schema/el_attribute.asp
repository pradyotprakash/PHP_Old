...
<title>XML Schema attribute Element</title>
<style>a.menu_el_attribute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">attribute</span> Element</h1>
<hr>
...
<p>The attribute element defines an attribute.</p>

<h3>Element Information</h3>
<ul>
  <li><b>Parent elements:</b> attributeGroup, schema, complexType, 
    restriction (both simpleContent and complexContent), extension (both simpleContent 
  and complexContent)</li>
</ul>
...
ref=QName<br>
type=QName<br>
use=optional|prohibited|required<br>
...
inside the attribute element)</p>
<table class="reference notranslate">
  ...
  <tr>
    <td>default</td>
    <td>Optional. Specifies a default value for the attribute. Default 
    and fixed attributes cannot both be present</td>
  </tr>
  <tr>
    <td>fixed</td>
    <td>Optional. Specifies a fixed value for the attribute. 
    Default and fixed attributes cannot both be present</td>
  </tr>
  <tr>
    <td>form</td>
    <td>Optional. Specifies the form for the attribute. The default value is 
    the value of the attributeFormDefault attribute of the element 
    containing the attribute. Can be set to one of the following:<ul>
      <li>&quot;qualified&quot; - indicates that this attribute 
    must be qualified with the namespace prefix and the no-colon-name (NCName) of the attribute</li>
      <li>unqualified - indicates that this attribute is not required to be qualified 
  ...
  <tr>
    <td>name</td>
    <td>Optional. Specifies the name of the attribute. Name and ref attributes cannot 
    both be present</td>
  </tr>
  <tr>
    <td>ref</td>
    <td>Optional. Specifies a reference to a named attribute. Name 
    and ref attributes cannot both be present. If ref is present, simpleType 
    element, form, and type cannot be present</td>
  </tr>
  <tr>
    <td>type</td>
    <td>Optional. Specifies a built-in data type or a simple type. The type attribute can only be present when the content does not 
    contain a simpleType element</td>
  </tr>
  <tr>
    <td>use</td>
    <td>Optional. Specifies how the attribute is used. Can be one 
...
<p>The example above indicates that the &quot;code&quot; attribute has a 
restriction. The only acceptable value is two of the uppercase letters from a to 
z.</p>

<h3>Example 2</h3>

<p>To declare an attribute using an existing attribute definition within a 
complex type, use the ref attribute:</p>
<div class="code notranslate"><div>
...
&lt;/xs:attribute&gt;<br>
<br>
&lt;xs:complexType name=&quot;someComplexType&quot;&gt;<br>
&nbsp;&nbsp;&lt;xs:attribute ref=&quot;code&quot;/&gt;<br>
&lt;/xs:complexType&gt;

</div></div>
<h3>Example 3</h3>
<p>Attributes can have either a default value OR a fixed value specified. A 
default value is automatically assigned to the attribute when no other value is 
specified. In the following example the default value is &quot;EN&quot;:</p>
<div class="code notranslate"><div>

&lt;xs:attribute name=&quot;lang&quot; type=&quot;xs:string&quot; default=&quot;EN&quot;/&gt;

</div></div>
<p>A fixed value is also automatically assigned to the attribute when no other 
...
<h3>Example 4</h3>
<p>All attributes are optional by default. To explicitly specify that the 
attribute is optional, use the &quot;use&quot; attribute:</p>
<div class="code notranslate"><div>

&lt;xs:attribute name=&quot;lang&quot; type=&quot;xs:string&quot; use=&quot;optional&quot;/&gt;

</div></div>
<p>To make an attribute required:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_attribute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_attribute.asp#top" target="_top">TOP</a> |
		<a href="el_attribute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
