...
<title>XML Schema Complex Type - Text Elements</title>
<style>a.menu_schema_complex_text{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD <span class="color_h1">Text-Only Elements</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_complex_elements.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_complex_mixed.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A complex text-only element can contain text and attributes.</p>
<hr>

<h2>Complex Text-Only Elements</h2>
<p>This type contains only simple content (text and attributes), therefore we 
add a simpleContent element around the content. When using simple content, you 
must define an extension OR a restriction within the simpleContent element, like this:</p>

<div class="code notranslate"><div>

&lt;xs:element name=&quot;somename&quot;&gt;<br>
  &nbsp;
  &lt;xs:complexType&gt;<br>
    &nbsp;&nbsp;&nbsp;
    &lt;xs:simpleContent&gt;<br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &lt;xs:extension base=&quot;basetype&quot;&gt;<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ....<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ....<br>
...
&lt;xs:element name=&quot;somename&quot;&gt;<br>
  ...
  &lt;xs:complexType&gt;<br>
    ...
    &lt;xs:simpleContent&gt;<br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &lt;xs:restriction base=&quot;basetype&quot;&gt;<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ....<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ....<br>
...
<p><b>Tip:</b> Use the extension/restriction element to expand or to limit the base simple type for the element.</p>
...
<p>The following example declares a complexType, &quot;shoesize&quot;. The content is defined as an 
integer value, and the &quot;shoesize&quot; element also contains an attribute named &quot;country&quot;:</p>

<div class="code notranslate"><div>

&lt;xs:element name=&quot;shoesize&quot;&gt;<br>
  &nbsp;
  &lt;xs:complexType&gt;<br>
    &nbsp;&nbsp;&nbsp;
    &lt;xs:simpleContent&gt;<br>
...
this method, several elements can refer to the same complex type):</p>

<div class="code notranslate"><div>

&lt;xs:element name=&quot;shoesize&quot; type=&quot;shoetype&quot;/&gt;<br><br>
&lt;xs:complexType name=&quot;shoetype&quot;&gt;<br>
  &nbsp;
  &lt;xs:simpleContent&gt;<br>
    &nbsp;&nbsp;&nbsp;
    &lt;xs:extension base=&quot;xs:integer&quot;&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_complex_text.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_complex_text.asp#top" target="_top">TOP</a> |
		<a href="schema_complex_text.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
