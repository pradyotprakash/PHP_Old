...
<style>a.menu_el_schema{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML <span class="color_h1">Schema</span> Element</h1>
<hr>
...
<p>The schema element defines the root element of a schema.</p>

<h3>Element Information</h3>

<ul>
  <li><b>Parent elements:</b> NONE</li>
</ul>
...
&lt;schema<br>
id=ID<br>
attributeFormDefault=qualified|unqualified<br>
elementFormDefault=qualified|unqualified<br>
blockDefault=(#all|list of (extension|restriction|substitution))<br>
finalDefault=(#all|list of (extension|restriction|list|union))<br>
...
&gt;<br>
<br>
((include|import|redefine|annotation)*,(((simpleType|complexType|<br>
group|attributeGroup)|element|attribute|notation),annotation*)*)<br>
<br>
&lt;/schema&gt;
...
from the target namespace must be qualified with the namespace prefix</td>
  </tr>
  <tr>
    <td>blockDefault</td>
    <td>
...
is a subset of extension, restriction, or substitution:<ul>
...
simpleType elements, this value can additionally contain list and union:<ul>
  ...
  <tr>
    ...
    <td>
Optional. A URI reference of the namespace of this schema</td>
  </tr>
  <tr>
    <td>version</td>
    <td>
Optional. Specifies the version of the schema</td>
  </tr>
  <tr>
    <td>xmlns</td>
    <td>
...
<br>
&lt;xs:element name=&quot;values&quot; type=&quot;xs:string&quot;&gt;<br>
<br>
&lt;/xs:schema&gt;
...
<p>In this example, the schema components (element name, type) in the 
...
xmlns:wsc=&quot;http://www.w3schools.com/w3shoolsschema&quot;&gt;<br>
<br>
&lt;element name=&quot;fname&quot; type=&quot;wsc:mystring&quot;/&gt;<br>
<br>
&lt;/schema&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_schema.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_schema.asp#top" target="_top">TOP</a> |
		<a href="el_schema.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
