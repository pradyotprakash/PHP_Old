...
<style>a.menu_el_annotation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">annotation</span> Element</h1>
<hr>
...
<p>The annotation element is a top level element that specifies schema 
comments. The comments serve as inline documentation.</p>

<h3>Element Information</h3>
<ul>
  <li><b>Parent elements:</b> Any element</li>
</ul>
...
&gt;<br>
<br>
(appinfo|documentation)*<br>
<br>
&lt;/annotation&gt;

</div></div>
<p>(The * sign declares that the element can occur zero or more times 
inside the annotation element)</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_annotation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_annotation.asp#top" target="_top">TOP</a> |
		<a href="el_annotation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
