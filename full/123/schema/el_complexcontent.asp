...
<title>XML Schema complexContent Element</title>
<style>a.menu_el_complexcontent{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">complexContent</span> Element</h1>
<hr>
...
<p>The complexContent element defines extensions or restrictions on a complex 
type that contains mixed content or elements only.</p>

<h3>Element Information</h3>
<ul>
  <li><b>Parent elements:</b> complexType</li>
</ul>
...
&lt;complexContent<br>
id=ID<br>
mixed=true|false<i><br>
any attributes</i><br>
&gt;<br>
<br>
(annotation?,(restriction|extension))<br>
<br>
&lt;/complexContent&gt;

</div></div>
<p>(The ? sign declares that the element can occur zero or one time 
inside the complexContent element)</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_complexcontent.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_complexcontent.asp#top" target="_top">TOP</a> |
		<a href="el_complexcontent.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
