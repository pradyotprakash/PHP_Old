...
<title>XML Schema Complex Type - Empty Elements</title>
<style>a.menu_schema_complex_empty{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD <span class="color_h1">Empty Elements</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_complex.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_complex_elements.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An empty complex element cannot have contents, only attributes.</p>
<hr>

<h2>Complex Empty Elements</h2>
...
<p>The &quot;product&quot; element above has no content at all. To define a type 
with no content, we must define a type that allows elements in its content, 
but we do not actually declare any elements, like this:</p>
...
<p>In the example above, we define a complex type with a complex content. The complexContent element signals that we intend to restrict or 
extend the content model of a complex type, and the restriction of integer declares one attribute but does not introduce any element content.</p>
...
<p>Or you can give the complexType element a name, and let the &quot;product&quot; element 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_complex_empty.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_complex_empty.asp#top" target="_top">TOP</a> |
		<a href="schema_complex_empty.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
