...
<style>a.menu_schema_complex_any{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD The <span class="color_h1">&lt;any&gt;</span> Element</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_complex_indicators.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_complex_anyattribute.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The &lt;any&gt; element enables us to extend the XML document with elements not specified by the schema!</p>
<hr>

<h2>The &lt;any&gt; Element</h2>
<p>The &lt;any&gt; element enables us to extend the XML document with elements not specified by the schema.</p>
...
can extend (after &lt;lastname&gt;) the content of &quot;person&quot; with any element:</p>
...
<p>Now we want to extend the &quot;person&quot; element with a &quot;children&quot; element. In this 
case we can do so, even if the author of the schema above never declared any &quot;children&quot; element.</p>

<p>Look at this schema file, called &quot;children.xsd&quot;:</p>
...
two different schemas; &quot;family.xsd&quot; and &quot;children.xsd&quot;:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_complex_any.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_complex_any.asp#top" target="_top">TOP</a> |
		<a href="schema_complex_any.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
