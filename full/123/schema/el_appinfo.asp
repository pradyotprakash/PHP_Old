...
<title>XML Schema appinfo Element</title>
<style>a.menu_el_appinfo{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">appinfo</span> Element</h1>
<hr>
...
<p>The appinfo element specifies information to be used by the application. 
This element must go 
within an annotation element.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>source</td>
    <td>Optional. A URI reference that specifies the source of the 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_appinfo.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_appinfo.asp#top" target="_top">TOP</a> |
		<a href="el_appinfo.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
