...
<title>XML Schema Miscellaneous Datatypes</title>
<style>a.menu_schema_dtypes_misc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD <span class="color_h1">Miscellaneous</span> Data Types</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_dtypes_numeric.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_editor.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Other miscellaneous data types are boolean, base64Binary, hexBinary, float, double, anyURI, QName, and NOTATION.</p>
<hr>

<h2>Boolean Data Type</h2>
<p>The boolean data type is used to specify a true or false value.</p>
<p>The following is an example of a boolean declaration in a schema:</p>
...
<p><b>Note:</b> Legal values for boolean are true, false, 1 (which indicates true), and 0 (which indicates false).</p>
<hr>

<h2>Binary Data Types</h2>
<p>Binary data types are used to express binary-formatted data.</p>
<p>We have two binary data types:</p>
<ul>
  <li>base64Binary (Base64-encoded binary data)</li>
  <li>hexBinary (hexadecimal-encoded binary data)</li>
</ul>
<p>The following is an example of a hexBinary declaration in a schema:</p>
...
<h2>AnyURI Data Type</h2>
<p>The anyURI data type is used to specify a URI.</p>
<p>The following is an example of an anyURI declaration in a schema:</p>
...
<p><b>Note:</b> If a URI has spaces, replace them with %20.</p>
<hr>

<h2>Miscellaneous Data Types</h2>
...
<br>
<hr>
<h2>Restrictions on Miscellaneous Data Types</h2>
<p>Restrictions that can be used with the other data types:</p>
<ul>
  <li>enumeration (a Boolean data type cannot use this constraint)</li>
  <li>length (a Boolean data type cannot use this constraint)</li>
  <li>maxLength (a Boolean data type cannot use this constraint)</li>
  <li>minLength (a Boolean data type cannot use this constraint)</li>
  <li>pattern</li>
  <li>whiteSpace</li>
</ul>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_dtypes_misc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_dtypes_misc.asp#top" target="_top">TOP</a> |
		<a href="schema_dtypes_misc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
