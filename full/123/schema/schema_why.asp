...
<style>a.menu_schema_why{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Why Use <span class="color_h1">XML Schemas?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_howto.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XML Schemas are much more powerful than DTDs.</p>
<hr>
<h2>XML Schemas Support Data Types</h2>

<p>One of the greatest strength of XML Schemas is the support for data types.</p>

<p>With support for data types:</p>

<ul>
	<li>It is easier to describe allowable document content</li>
	<li>It is easier to validate the correctness of data</li>
	<li>It is easier to work with data from a database</li>
...
<hr>
<h2>XML Schemas use XML Syntax</h2>
<p>Another great strength about XML Schemas is that they are written in XML.</p>
<p>Some benefits of that XML Schemas are written in XML:</p>
<ul>
...
<hr>
<h2>XML Schemas Secure Data Communication</h2>
<p>When sending data from a sender to a receiver, it is essential that both parts
have the same &quot;expectations&quot; about the content.</p>
<p>With XML Schemas, the sender can describe the data in a way that the receiver
will understand.</p>
<p>A date like: &quot;03-11-2004&quot; will, in some countries, be interpreted as 3.November
and in other countries as 11.March.</p>
<p>However, an XML element with a data type
like this:</p>
<p>&lt;date type=&quot;date&quot;&gt;2004-03-11&lt;/date&gt;</p>
<p>ensures a mutual understanding of the content, because the XML data type &quot;date&quot;
requires the format &quot;YYYY-MM-DD&quot;.</p>
<hr>
<h2>XML Schemas are Extensible</h2>
...
<hr>
<h2>Well-Formed is not Enough</h2>

<p>A well-formed XML document is a document that conforms to the XML syntax
rules, like:</p>
<ul>
  <li>it must begin with the XML declaration</li>
  <li>it must have one unique root element</li>
  <li>start-tags must have matching end-tags</li>
  ...
  <li>entities must be used for special characters</li>
</ul>
<p>Even if documents are well-formed they can still contain errors, and those errors can have serious consequences.</p>
<p>Think of the following situation: you order 5 gross of laser printers, instead of 5 laser
printers. With XML Schemas, most of these errors can be caught by your
validating software.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_howto.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_why.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_why.asp#top" target="_top">TOP</a> |
		<a href="schema_why.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
