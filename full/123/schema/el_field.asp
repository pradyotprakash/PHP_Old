...
<title>XML Schema field Element</title>
<style>a.menu_el_field{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">field</span> Element</h1>
<hr>
...
<p>The field element specifies an XPath expression that specifies the value 
used to define an identity constraint.</p>

<h3>Element Information</h3>
<ul>
  <li><b>Parent elements:</b> key, keyref, unique </li>
</ul>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>xpath</td>
    <td>Required. Identifies a single element or attribute whose 
    content or value is used for the constraint</td>
  </tr>
  <tr>
...
<h3>Example 1</h3>
<p>The following example shows a field element that specifies the &quot;userID&quot; 
attribute as the field to use for the identity constraint:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_field.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_field.asp#top" target="_top">TOP</a> |
		<a href="el_field.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
