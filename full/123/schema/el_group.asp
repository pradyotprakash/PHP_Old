...
<title>XML Schema group Element</title>
<style>a.menu_el_group{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">group</span> Element</h1>
<hr>
...
<ul>
  <li><b>Parent elements:</b> schema, choice, sequence, complexType, restriction 
  (both simpleContent 
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>Optional. Specifies a name for the group. This attribute 
    is used only when the schema element is the parent of this group element. Name and ref attributes cannot 
    both be present</td>
  </tr>
  <tr>
    <td>ref</td>
    <td>Optional. Refers to the name of another group. 
    Name and ref attributes cannot both be present</td>
  </tr>
  <tr>
    <td>maxOccurs</td>
    <td>Optional. Specifies the maximum number of times the group 
  ...
  <tr>
    <td>minOccurs</td>
    <td>Optional. Specifies the minimum number of times the group 
...
<p>The following example defines a group containing a sequence of four elements 
and uses the group element in a complex type definition:</p>
<div class="code notranslate"><div>

&lt;?xml version=&quot;1.0&quot;?&gt;<br>
&lt;xs:schema xmlns:xs=&quot;http://www.w3.org/2001/XMLSchema&quot;&gt;<br>
<br>
&lt;xs:group name=&quot;custGroup&quot;&gt;<br>
&nbsp;&nbsp;&lt;xs:sequence&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element name=&quot;customer&quot; type=&quot;xs:string&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element name=&quot;orderdetails&quot; type=&quot;xs:string&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element name=&quot;billto&quot; type=&quot;xs:string&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element name=&quot;shipto&quot; type=&quot;xs:string&quot;/&gt;<br>
&nbsp;&nbsp;&lt;/xs:sequence&gt;<br>
&lt;/xs:group&gt;<br>
<br>
&lt;xs:element name=&quot;order&quot; type=&quot;ordertype&quot;/&gt;<br>
<br>
&lt;xs:complexType name=&quot;ordertype&quot;&gt;<br>
&nbsp;&nbsp;&lt;xs:group ref=&quot;custGroup&quot;/&gt;<br>
&nbsp;&nbsp;&lt;xs:attribute name=&quot;status&quot; type=&quot;xs:string&quot;/&gt;<br>
&lt;/xs:complexType&gt;<br>
<br>
&lt;/xs:schema&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_group.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_group.asp#top" target="_top">TOP</a> |
		<a href="el_group.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
