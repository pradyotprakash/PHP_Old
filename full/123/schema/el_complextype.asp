...
<style>a.menu_el_complextype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">complexType</span> Element</h1>
<hr>
...
<p>The complexType element defines a complex type. A complex type element is an 
XML element that contains other elements and/or attributes.</p>

<h3>Element Information</h3>
<ul>
  <li><b>Parent elements:</b> element, redefine, schema</li>
</ul>
...
&gt;<br>
<br>
(annotation?,(simpleContent|complexContent|((group|all|<br>
choice|sequence)?,((attribute|attributeGroup)*,anyAttribute?))))<br>
<br>
&lt;/complexType&gt;
...
inside the complexType element)</p>
<table class="reference notranslate">
  ...
  <tr>
    <td>abstract</td>
    <td>Optional. Specifies whether the complex type can be used in 
  ...
  <tr>
    <td>mixed</td>
    <td>Optional. Specifies whether character data is allowed to 
  ...
  <tr>
    <td>block</td>
    <td>Optional. Prevents a complex type that has a specified type 
  ...
  <tr>
    <td>final</td>
    <td>Optional. Prevents a specified type of derivation of this 
    complex type element. Can contain #all or a list that is a subset of 
    extension or restriction.<ul>
...
<h3>Example 1</h3>
<p>The following example has an element named &quot;note&quot; that is of a complex type:</p>
<div class="code notranslate"><div>
...
<h3>Example 2</h3>
<p>The following example has a complex type, &quot;fullpersoninfo&quot;, that 
derives from another complex type, &quot;personinfo&quot;, by extending the 
inherited type with three additional elements (address, city and country):</p>
<div class="code notranslate"><div>

&lt;xs:element name=&quot;employee&quot; type=&quot;fullpersoninfo&quot;/&gt;<br>
<br>
...
<p>In the example above the &quot;employee&quot; element must contain, in sequence, the 
following elements: &quot;firstname&quot;, &quot;lastname&quot;, &quot;address&quot;, &quot;city&quot;, and &quot;country&quot;.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_complextype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_complextype.asp#top" target="_top">TOP</a> |
		<a href="el_complextype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
