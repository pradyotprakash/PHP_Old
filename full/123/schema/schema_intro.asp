...
<style>a.menu_schema_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">Introduction</span> to XML Schema</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_why.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XML Schema is an XML-based alternative to DTD.</p>
<p class="intro">An XML schema describes the structure of an XML document.</p>
...
<ul>
	...
	<li>A basic understanding of DTD</li>
</ul>
...
<hr>
<h2>What is an XML Schema?</h2>

<p>The purpose of an XML Schema is to define the legal building blocks of an XML
document, just like a DTD.</p>
...
<hr>
<h2>XML Schemas are the Successors of DTDs</h2>

<p>We think that very soon XML Schemas will be used in most Web applications as a
replacement for DTDs. Here are some reasons:</p>

<ul>
  <li>XML Schemas are extensible to future additions</li>
  <li>XML Schemas are richer and more powerful than DTDs</li>
  <li>XML Schemas are written in XML</li>
  <li>XML Schemas support data types</li>
  <li>XML Schemas support namespaces</li>
</ul>
<hr>
<h2>XML Schema is a W3C Recommendation</h2>
<p>XML Schema became a W3C Recommendation 02. May 2001.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_why.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_intro.asp#top" target="_top">TOP</a> |
		<a href="schema_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
