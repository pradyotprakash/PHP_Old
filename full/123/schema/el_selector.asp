...
<title>XML Schema selector Element</title>
<style>a.menu_el_selector{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">selector</span> Element</h1>
<hr>
...
<p>The selector element specifies an XPath expression that selects a set of 
elements for an identity constraint (unique, key, and keyref elements).</p>
...
&lt;selector<br>
id=ID<br>
xpath=a subset of XPath expression<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>xpath</td>
    <td>Required. Specifies an XPath expression, relative to 
    the element being declared, that identifies the child elements to which the identity constraint applies</td>
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_selector.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_selector.asp#top" target="_top">TOP</a> |
		<a href="el_selector.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
