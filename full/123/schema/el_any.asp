...
<style>a.menu_el_any{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">any</span> Element</h1>
<hr>
...
<p>The any element enables the author to extend the XML document with elements 
not specified by the schema.</p>

<h3>Element Information</h3>
<ul>
  <li><b>Parent elements:</b> choice, sequence</li>
</ul>
...
processContents=lax|skip|strict<br>
...
<p>(The ? sign declares that the element can occur zero or one time inside the any element)</p>
<table class="reference notranslate">
  ...
  <tr>
    <td>maxOccurs</td>
    <td>Optional. Specifies the maximum number of times the any 
    ...
    &quot;unbounded&quot;. Default value is 1</td>
  </tr>
  <tr>
    <td>minOccurs</td>
    <td>Optional. Specifies the minimum number of times the any 
    element can occur in the parent element. The value can be any number &gt;= 
    0. Default value is 1 </td>
  </tr>
  <tr>
    <td>namespace</td>
    <td>Optional. Specifies the namespaces containing the elements 
    that can be used. Can be set to one of the following:<ul>
      <li>##any - elements from any namespace is allowed (this is default)</li>
      <li>##other - elements from any namespace that is not the namespace of the 
      parent element can be present</li>
      <li>##local - elements must come from no namespace</li>
      <li>##targetNamespace - elements from the namespace of the parent element 
      can be present</li>
      <li>List of {URI references of namespaces, ##targetNamespace, ##local} - 
      elements from a space-delimited list of the namespaces can be present</li>
    </ul>
    </td>
  </tr>
  <tr>
    <td>processContents</td>
    <td>Optional. Specifies how the XML processor should handle 
    validation against the elements specified by this any element. Can be set to 
    one of the following:<ul>
      <li>strict - the XML processor must obtain the schema for the required 
      namespaces and validate the elements (this is default)</li>
      <li>lax - same as strict but; if the schema cannot be obtained, no errors 
      will occur</li>
      <li>skip - The XML processor does not attempt to validate any elements 
      from the specified namespaces</li>
    </ul>
    </td>
  </tr>
  <tr>
...
<h3>Example 1</h3>
<p>The following example shows a declaration for an element called &quot;person&quot;. 
By using the &lt;any&gt; element the author can extend (after &lt;lastname&gt;) the content 
of &quot;person&quot; with any element:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_any.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_any.asp#top" target="_top">TOP</a> |
		<a href="el_any.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
