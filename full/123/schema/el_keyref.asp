...
<title>XML Schema keyref Element</title>
<style>a.menu_el_keyref{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">keyref</span> Element</h1>
<hr>
...
<p>The keyref element specifies that an attribute or element value correspond to 
those of the specified key or unique element.</p>

<p>The keyref element MUST contain the following (in order):</p>

<ul>
  <li>one and only one selector element&nbsp; (contains an XPath expression that 
  specifies the set of elements across which the values specified by field must 
  be unique)</li>
  <li>one or more field elements (contains an XPath expression that specifies 
...
<ul>
  <li><b>Parent elements:</b> element</li>
</ul>
...
&gt;<br>
<br>
(annotation?,(selector,field+))<br>
<br>
&lt;/include&gt;

</div></div>
<p>(The ? sign declares that the element can occur zero or one time, and the + 
sign declares that the element must occur one or more times 
inside the keyref element)</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>Required. Specifies the name of the keyref element</td>
  </tr>
  <tr>
    <td>refer</td>
    <td>Required. Specifies the name of a key or unique element 
    defined in this or another schema</td>
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_keyref.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_keyref.asp#top" target="_top">TOP</a> |
		<a href="el_keyref.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
