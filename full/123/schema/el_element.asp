...
<style>a.menu_el_element{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">element</span> Element</h1>
<hr>
<a href="schema_elements_ref.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XML Schema Reference" /> Complete XML Schema Reference</a>
<hr>

<h2>Definition and Usage</h2>
<p>The element element defines an element.</p>

<h3>Element Information</h3>
<ul>
  <li><b>Parent elements:</b> schema, choice, all, sequence, group </li>
</ul>
...
ref=QName<br>
type=QName<br>
substitutionGroup=QName<br>
default=string<br>
fixed=string<br>
form=qualified|unqualified<br>
maxOccurs=nonNegativeInteger|unbounded<br>
minOccurs=nonNegativeInteger<br>
nillable=true|false<br>
...
&gt;<br>
<br>
annotation?,(simpleType|complexType)?,(unique|key|keyref)*<br>
<br>
&lt;/element&gt;

</div></div>
<p>(The ? sign declares that the element can occur zero or one time, and the * sign declares that the element can occur zero or more times 
inside the element element)</p>
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>Optional. Specifies a name for the element. This attribute 
    is required if the parent element is the schema element</td>
  </tr>
  <tr>
    <td>ref</td>
    <td>Optional. Refers to the name of another element. The ref 
    attribute can include a namespace prefix. This attribute cannot be used if 
    the parent element is the schema element</td>
  </tr>
  <tr>
    <td>type</td>
    <td>Optional. Specifies either the name of a built-in data 
    type, or the name of a simpleType or complexType element</td>
  </tr>
  <tr>
    <td>substitutionGroup</td>
    <td>Optional. Specifies the name of an element that can be 
    substituted with this element. This attribute cannot be used if the parent 
    element is not the schema element</td>
  </tr>
  <tr>
    <td>default</td>
    <td>Optional. Specifies a default value for the element (can 
    only be used if the element's content is a simple type or text only)</td>
  </tr>
  <tr>
    <td>fixed</td>
    <td>Optional. Specifies a fixed value for the element (can only 
    be used if the element's content is a simple type or text only)</td>
  </tr>
  <tr>
    <td>form</td>
    <td>Optional. Specifies the form for the element. &quot;unqualified&quot; 
    ...
    used if the parent element is the schema element</td>
  </tr>
  <tr>
    <td>maxOccurs</td>
    <td>Optional. Specifies the maximum number of times this 
  ...
  <tr>
    <td>minOccurs</td>
    <td>Optional. Specifies the minimum number of times this 
    ...
    is the schema element</td>
  </tr>
  <tr>
    <td>nillable</td>
    <td>Optional. Specifies whether an explicit null value can be 
    ...
    Schema namespace for instances. Default is false</td>
  </tr>
  <tr>
    <td>abstract</td>
    <td>Optional. Specifies whether the element can be used in 
  ...
  <tr>
    <td>block</td>
    <td>Optional. Prevents an element with a specified type 
  ...
  <tr>
    <td>final</td>
    <td>Optional. Sets the default value of the final attribute on 
    ...
    that is a subset of extension or restriction:<ul>
      <li>extension - prevents elements derived by extension</li>
      <li>restriction - prevents elements derived by restriction</li>
      <li>#all - prevents all derived elements</li>
    </ul>
...
<h3>Example 1</h3>
      <p>The following example is a schema with four simple elements named &quot;fname&quot;, 
      &quot;lname&quot;, &quot;age&quot;, and &quot;dateborn&quot;, which are of type string, 
      nonNegativeInteger, and date:</p>
<div class="code notranslate"><div>
...
&lt;xs:element name=&quot;dateborn&quot; type=&quot;xs:date&quot;/&gt;<br>
<br>
&lt;/xs:schema&gt;
...
<h3>Example 2</h3>
<p>The following example is a schema with an element named &quot;note&quot; that is of a complex type. 
...
<h3>Example 3</h3>
<p>This example is equal to Example 2, but here we have chosen to use the 
ref attribute to refer to the element names:</p>
<div class="code notranslate"><div>
...
&nbsp;&nbsp;&lt;xs:complexType&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:sequence&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element ref=&quot;to&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element ref=&quot;from&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xs:element ref=&quot;heading&quot;/&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_element.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_element.asp#top" target="_top">TOP</a> |
		<a href="el_element.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
