...
<style>a.menu_schema_complex_subst{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD <span class="color_h1">Element Substitution</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_complex_anyattribute.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_example.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>The type of the substitutable elements must be the same as, or derived from, 
...
the substitutable element.</p>
<p>Note that all elements in the substitutionGroup (the head element and the 
substitutable elements) must be declared as global elements, otherwise it will 
not work! </p>
<hr>
<h2>What are Global Elements?</h2>
<p>Global elements are elements that are immediate children of the &quot;schema&quot; 
element! Local elements are elements nested within other elements.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_complex_anyattribute.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_example.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_complex_subst.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_complex_subst.asp#top" target="_top">TOP</a> |
		<a href="schema_complex_subst.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
