...
<title>XML Schema Simple Elements</title>
<style>a.menu_schema_simple{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD <span class="color_h1">Simple Elements</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_schema.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_simple_attributes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XML Schemas define the elements of your XML files.</p>
<p class="intro">A simple element is an XML element that contains only text. It cannot contain any other elements or attributes.</p>
<hr>

<h2>What is a Simple Element?</h2>
<p>A simple element is an XML element that can contain only text. It cannot contain any other elements or attributes.</p>
<p>However, the &quot;only text&quot; restriction is quite misleading. The text can be of many different types. It can be one of the types included in
the XML Schema definition (boolean, string, date, etc.), or it can be a custom type that you can define yourself.</p>
<p>You can also add restrictions (facets) to a data type in order to limit its content, or you can require the data to match a specific pattern.</p>
<hr>

<h2>Defining a Simple Element</h2>
<p>The syntax for defining a simple element is: </p>

<div class="code notranslate"><div>
&lt;xs:element name=&quot;xxx&quot; type=&quot;yyy&quot;/&gt;
</div></div>

<p>where xxx is the name of the element and yyy is the data type of the element.<p>XML Schema has a lot of built-in data types. The most
common types are:</p>
<ul>
	<li>xs:string</li>
	<li>xs:decimal</li>
...
<h3>Example</h3>
<p>Here are some XML elements:</p>
...
<p>And here are the corresponding simple element definitions:</p>
...
<br>
<hr>
<h2>Default and Fixed Values for Simple Elements</h2>
<p>Simple elements may have a default value OR a fixed value specified.</p>
<p>A default value is automatically assigned to the element when no other value is specified.</p>
<p>In the following example the default value is &quot;red&quot;:</p>

<div class="code notranslate"><div>
&lt;xs:element name=&quot;color&quot; type=&quot;xs:string&quot; default=&quot;red&quot;/&gt;
</div></div>

<p>A fixed value is also automatically assigned to the element, and you cannot specify another value.</p>
<p>In the following example the fixed value is &quot;red&quot;:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_simple.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_simple.asp#top" target="_top">TOP</a> |
		<a href="schema_simple.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
