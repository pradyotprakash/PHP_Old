...
<style>a.menu_el_anyattribute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">anyAttribute</span> Element</h1>
<hr>
...
<p>The anyAttribute element enables the author to extend the XML document with 
attributes not specified by the schema.</p>

<h3>Element Information</h3>
<ul>
  <li><b>Parent elements:</b> complexType, restriction (both simpleContent and complexContent), 
    extension (both simpleContent and complexContent), attributeGroup</li>
</ul>
...
inside the anyAttribute element)</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>namespace</td>
    <td>Optional. Specifies the namespaces containing the 
    attributes 
    that can be used. Can be set to one of the following:<ul>
      <li>##any - attributes from any namespace is allowed (this is default)</li>
      <li>##other - attributes from any namespace that is not the namespace of the 
      parent element can be present</li>
      <li>##local - attributes must come from no namespace</li>
      <li>##targetNamespace - attributes from the namespace of the parent element 
      can be present</li>
      <li>List of {URI references of namespaces, ##targetNamespace, ##local} - 
      attributes from a space-delimited list of the namespaces can be present</li>
    </ul>
    </td>
  </tr>
  <tr>
...
attributes to the &quot;person&quot; element:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_anyattribute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_anyattribute.asp#top" target="_top">TOP</a> |
		<a href="el_anyattribute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
