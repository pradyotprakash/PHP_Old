...
<style>a.menu_el_simpletype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XML Schema <span class="color_h1">simpleType</span> Element</h1>
<hr>
...
<p>The simpleType element defines a simple type and specifies the constraints 
and information about the values of attributes or text-only elements.</p>

<h3>Element Information</h3>
<ul>
  <li><b>Parent elements:</b> attribute, element, list, restriction, schema, 
  union</li>
</ul>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>Specifies a name for the element. This attribute is 
    required if the simpleType element is a child of the schema element, 
    otherwise it is not allowed</td>
  </tr>
  <tr>
...
<h3>Example 1</h3>
<p>This example defines an element called &quot;age&quot; that is a simple type with a 
restriction. The value of age can NOT be lower than 0 or greater than 100:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_simpletype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_simpletype.asp#top" target="_top">TOP</a> |
		<a href="el_simpletype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
