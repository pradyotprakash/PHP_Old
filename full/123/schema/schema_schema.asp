...
<title>XML schema Element</title>
<style>a.menu_schema_schema{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD - The <span class="color_h1">&lt;schema&gt;</span> Element</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_howto.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_simple.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The &lt;schema&gt; element is the root element of every XML Schema.</p>
<hr>

<h2>The &lt;schema&gt; Element</h2>
<p>The &lt;schema&gt; element is the root element of every XML Schema:</p>
...
<p>The &lt;schema&gt; element may contain some attributes. A schema declaration often looks something like this:</p>
...
<p>indicates that the elements and data types used in the schema come from the &quot;http://www.w3.org/2001/XMLSchema&quot; 
namespace. It also specifies that the elements and data types that come from the &quot;http://www.w3.org/2001/XMLSchema&quot; namespace should be prefixed with <b>xs:</b></p>
<p>This fragment:</p>
...
<p>indicates that the elements defined by this schema (note, to, from, heading, body.) come from the &quot;http://www.w3schools.com&quot; namespace.</p>
<p>This fragment:</p>

<div class="code notranslate"><div>
xmlns=&quot;http://www.w3schools.com&quot;</div></div>

<p>indicates that the default namespace is &quot;http://www.w3schools.com&quot;.</p>
<p>This fragment:</p>

<div class="code notranslate"><div>
elementFormDefault=&quot;qualified&quot;</div></div>

<p>indicates that any elements used by the XML instance document which were 
declared in this schema must be namespace qualified.</p>
<hr>

<h2>Referencing a Schema in an XML Document</h2>
<p>This XML document has a reference to an XML Schema:</p>
...
xsi:schemaLocation=&quot;http://www.w3schools.com note.xsd&quot;&gt;<br><br>
&lt;to&gt;Tove&lt;/to&gt;<br>
&lt;from&gt;Jani&lt;/from&gt;<br>
...
<p>specifies the default namespace declaration. This declaration tells the 
schema-validator that all the elements used in this XML document are declared in 
the &quot;http://www.w3schools.com&quot; namespace.</p>
<p>Once you have the XML Schema Instance namespace available:</p>

<div class="code notranslate"><div>
xmlns:xsi=&quot;http://www.w3.org/2001/XMLSchema-instance&quot;
</div></div>

<p>you can use the schemaLocation attribute. This attribute has two values, 
separated by a space. The first value is the namespace to use. The second value is the location of the XML schema to use for that namespace:</p>

<div class="code notranslate"><div>
xsi:schemaLocation=&quot;http://www.w3schools.com note.xsd&quot;</div></div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_howto.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_simple.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_schema.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_schema.asp#top" target="_top">TOP</a> |
		<a href="schema_schema.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
