...
<style>a.menu_schema_complex_anyattribute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSD The <span class="color_h1">&lt;anyAttribute&gt;</span> Element</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_complex_any.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_complex_subst.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The &lt;anyAttribute&gt; element enables us to extend the XML document with attributes not specified by the schema!</p>
<hr>

<h2>The &lt;anyAttribute&gt; Element</h2>
<p>The &lt;anyAttribute&gt; element enables us to extend the XML document with attributes not specified by the schema.</p>
<p>The following example is a fragment from an XML schema called &quot;family.xsd&quot;. 
It shows a declaration for the &quot;person&quot; element. By using the &lt;anyAttribute&gt; element we 
can add any number of attributes to the &quot;person&quot; element:</p>
...
<p>Now we want to extend the &quot;person&quot; element with a &quot;gender&quot; attribute. In this 
case we can do so, even if the author of the schema above never declared any &quot;gender&quot; attribute.</p>
<p>Look at this schema file, called &quot;attribute.xsd&quot;:</p>
...
<p>The XML file below (called &quot;Myfamily.xml&quot;), uses components from 
two different schemas; &quot;family.xsd&quot; and &quot;attribute.xsd&quot;:</p>
...
http://www.w3schools.com attribute.xsd&quot;&gt;<br><br>
...
<p>The XML file above is valid because the schema &quot;family.xsd&quot; allows us to 
add an attribute to the &quot;person&quot; element.</p>
<p>The &lt;any&gt; and &lt;anyAttribute&gt; elements are used to make EXTENSIBLE 
documents! They allow documents to contain additional elements that are not 
declared in the main XML schema.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="schema_complex_any.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="schema_complex_subst.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="schema_complex_anyattribute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="schema_complex_anyattribute.asp#top" target="_top">TOP</a> |
		<a href="schema_complex_anyattribute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
