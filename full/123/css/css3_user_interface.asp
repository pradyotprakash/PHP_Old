...
<style>a.menu_css3_user_interface{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">User Interface</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css3_multiple_columns.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_summary.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>CSS3 User Interface</h2>
<p>In CSS3, some of the new user interface features are resizing elements, box sizing, and outlining.</p>
<p>In this chapter you will learn about the following user interface properties:</p>
<ul>
	<li>resize</li>
	<li>box-sizing</li>
...
<p>The resize property is supported in Firefox, Chrome, and Safari.</p>
<p>The box-sizing is supported in Internet Explorer, Chrome, Safari, and Opera. Firefox requires the prefix -moz-.</p>
<p>The outline-offset property is supported in all major browsers, except Internet Explorer.</p>
<hr>

<h2>CSS3 Resizing</h2>
<p>In CSS3, the resize property specifies whether or not an element should be resizable by the user.</p>
<div id="resize">This div element is resizable by the user (in Firefox, Chrome, and Safari).</div>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_resize">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS3 Box Sizing</h2>
<p>The box-sizing property allows you to define certain elements to fit an area in a certain way:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_box-sizing">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS3 Outline Offset</h2>
<p>The outline-offset property offsets an outline, and draws it beyond the border edge.</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_outline-offset">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS3 User-interface Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="../cssref/css3_pr_appearance.asp">appearance</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_user_interface.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_user_interface.asp#top" target="_top">TOP</a> |
		<a href="css3_user_interface.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
