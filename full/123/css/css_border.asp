...
<style>a.menu_css_border{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Border</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_boxmodel.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_outline.asp">Next Chapter &raquo;</a></div>
</div>
<br>
...
<td><b>Note:</b> None of the border properties will have ANY effect unless the <b>border-style</b> property is set!</td>
</tr></table>
...
<p>Try it yourself: <a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border-style">Set the style of the border</a></p>
<hr>

<h2>Border Width</h2>
<p>The border-width property is used to set the width of the border.</p>
<p>The width is set in pixels, or by using one of the three pre-defined values: 
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border-width" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border-color1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border-side" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>The example above can also be set with a single property:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
border-style:dotted solid;</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border-side2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<ul>
	...
	<li>left border is dashed</li></ul>
	<br>
	</li>
...
<p>The border-style property is used in the example above. However, it also works with border-width 
and border-color.</p>
<hr>
...
one property. This is called a shorthand property.</p>
<p>The border property is a shorthand for the following individual border properties:</p>
<ul>
	<li>border-width</li>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border-top">All the top border properties in one declaration</a><br>
This example demonstrates a shorthand property for setting all of the properties for the top border in one declaration.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border-bottom-style">Set the style of the bottom border</a><br>
This example demonstrates how to set the style of the bottom border.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border-left-width">Set the width of the left border</a><br>
This example demonstrates how to set the width of the left border.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border-color">Set the color of the four borders</a><br>
This example demonstrates how to set the color of the four borders. It can have from one to four colors.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_border-right-color">Set the color of the right border</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_border.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_border.asp#top" target="_top">TOP</a> |
		<a href="css_border.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
