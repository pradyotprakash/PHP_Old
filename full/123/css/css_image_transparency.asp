...
<style>a.menu_css_image_transparency{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS Image <span class="color_h1">Opacity / Transparency</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_image_gallery.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_image_sprites.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Creating transparent images with CSS is easy.</p>
<p class="intro">The CSS opacity property is a part of the W3C CSS3 recommendation.</p>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_image_transparency">
Creating transparent images - Hover effect</a></p>
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_transparency">Creating a transparent box with text on a background image</a></p>
<hr>

<h2>Example 1 - Creating a Transparent Image</h2>
<p>The CSS3 property for transparency is <b>opacity</b>.</p>
...
<img src="klematis.jpg" alt="klematis" width="150" height="113" style="opacity:0.4;filter:alpha(opacity=40)" />

<p>Look at the following CSS:</p>
...
<p>IE9, Firefox, Chrome, Opera, and Safari use the property <b>opacity</b> for transparency. 
The opacity property can take a value from 0.0 - 1.0. A lower value makes the element more transparent.</p>
<p>IE8 and earlier use <b>filter:alpha(opacity=x)</b>. The x can take a value from 0 - 100. A lower value makes the element more transparent.</p>
<hr>

<h2>Example 2 - Image Transparency - Hover Effect</h2>
<p>Mouse over the images:</p>
<img id="klem1" src="klematis.jpg" alt="klematis" width="150" height="113" />
<img id="klem2" src="klematis2.jpg" alt="klematis" width="150" height="113" />
...
<p>The first CSS block is similar to the code in Example 1. In addition, we have added 
what should happen when a user hover over one of the images. In this case we want the image to NOT be 
transparent when the user hover over it.</p>
<p>The CSS for this is: <b>opacity=1</b>.</p>
<p>IE8 and earlier: <b>filter:alpha(opacity=100)</b>.</p>
...
&lt;/body&gt;<br>
&lt;/html&gt;</div></div>
<p>First, we create a div element (class=&quot;background&quot;) with a fixed height and width, a background image, and a border.
Then we create a smaller div (class=&quot;transbox&quot;) inside the first div element. The 
&quot;transbox&quot; div have a fixed width, a background color, and a border - and it is transparent. Inside the transparent div, we add some text inside a p element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_image_transparency.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_image_transparency.asp#top" target="_top">TOP</a> |
		<a href="css_image_transparency.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
