...
<style>a.menu_css_mediatypes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Media Types</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_image_sprites.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_attribute_selectors.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">By using the @media rule, a website can have a different layout for screen,  
print, mobile phone, tablet, etc.&nbsp;</p>
...
that the paragraph under &quot;Media Types&quot; will be displayed in another font, and have a
smaller font size than the rest of the text.</p>
<hr>

<h2>Other Media Types</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_mediatypes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_mediatypes.asp#top" target="_top">TOP</a> |
		<a href="css_mediatypes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
