...
<style>a.menu_css_summary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>You Have Learned CSS, <span class="color_h1">Now What?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css3_user_interface.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>CSS Summary</h2>
<p>This tutorial has taught you how to create style sheets to control the style 
and layout of multiple web sites at once.</p>
<p>You have learned how to use CSS to add backgrounds, format text, 
add and format borders, and specify padding and margins of elements.</p>
<p>You have learned how to position an element, control the visibility and 
size of an element, set the shape of an element, place an element behind 
another, and to add special effects to some selectors, like links.</p>
<p>You have also learned about many of the new features in CSS3: rounded 
borders, box and text shadows, gradient backgrounds, 2D and 3D transformations, 
transitions, animations, multiple columns, and more.</p>
<p>To learn more about CSS, please take a look at our
<a href="css_examples.asp">CSS examples</a> and <a href="../cssref/default.asp">
CSS reference</a>.</p>
<hr>
<h2>Now You Know CSS, What's Next?</h2>
<p>The next step is to learn <strong>JavaScript</strong>.</p>
<p>JavaScript is <em>the</em> scripting language of the Web. All modern HTML 
pages are using JavaScript.</p>
<p>JavaScript was designed to add interactivity to HTML pages.</p>
<p>JavaScript is a language with a 
very simple syntax, and anyone can put small &quot;snippets&quot; of JavaScript code 
into HTML pages.</p>

<p>If you want to learn more about JavaScript, please 
visit our <a href="../js/default.asp">JavaScript tutorial</a>.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_summary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_summary.asp#top" target="_top">TOP</a> |
		<a href="css_summary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
