...
<title>CSS Styling Lists</title>
<style>a.menu_css_list{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="css_link.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_table.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The CSS list properties allow you to:</p>
<ul style="list-style-type:none;padding:0px;margin:0px;">
  <li style="background-image:url(sqorange.gif);background-repeat:no-repeat;background-position:40px 3px; padding-left:56px;">Set different list item markers for ordered lists</li>
  <li style="background-image:url(sqorange.gif);background-repeat:no-repeat;background-position:40px 3px; padding-left:56px;">Set different list item markers for unordered lists</li>
  <li style="background-image:url(sqorange.gif);background-repeat:no-repeat;background-position:40px 3px; padding-left:56px;">Set an image as the list item marker</li>
</ul>
<br>
<hr>
...
<p>The type of list item marker is specified with the 
list-style-type property:</p>
<div class="example">
...
ol.d {list-style-type: lower-alpha;}</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_list-style-type_ex" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_list-style-image" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_list-style-image_crossbrow" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<ul>
	...
	<li>Position the image where you want 
	it (left 0px and 
	down 5px)</li>
...
<p>It is also possible to specify all 
the list properties in one, single property. This is called a shorthand property.</p>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_list-style" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_list-style-type_all">All the different list-item markers for lists</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_list.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_list.asp#top" target="_top">TOP</a> |
		<a href="css_list.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
