...
<style>a.menu_css_table{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="css_list.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_boxmodel.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_table_border" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>

<p>Notice that the table in the example above has double borders. This is 
because both the table and the th/td elements have separate borders.</p>
<p>To display a single border for the table, use the border-collapse property.</p>

<h2>Collapse Borders</h2>
<p>The border-collapse property sets whether the table borders are collapsed 
into a single border or separated:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	table<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_table_border-collapse">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_table_width">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_table_align">
	Try it yourself &raquo;</a>
</div>

<p>The vertical-align property sets the vertical alignment, like top, bottom, or 
middle:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_table_vertical-align">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<h2>Table Padding</h2>
<p>To control the space between the border and content in a table, use the 
padding property on td and th elements:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	td<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_table_padding">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<h2>Table Color</h2>
<p>The example below specifies the color of the borders, and the text and 
background color of th elements:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	table, td, th<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_table_color">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_table_fancy">Make a fancy 
table</a><br>
This example demonstrates how to create a fancy table.</p>
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_table_caption-side">Set 
the position of the table caption</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_table.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_table.asp#top" target="_top">TOP</a> |
		<a href="css_table.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
