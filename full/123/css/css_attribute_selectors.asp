...
<style>a.menu_css_attribute_selectors{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="css_mediatypes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css3_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<td><b>Note:</b> IE7 and IE8 support attribute selectors only if a !DOCTYPE is specified.</td>
</tr></table>
<br>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_attselector_att" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_attselector_value" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Attribute and Value Selector - Multiple Values</h2>
<p>The example below styles all elements with a title attribute that contains a 
specified value. This works even if the attribute has space separated values:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
[title~=hello]
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_attselector_valuelist_space" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>The example below styles all elements with a lang attribute that begins with a 
specified value:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_attselector_valuelist_hyphen" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_attselector_form" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_attribute_selectors.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_attribute_selectors.asp#top" target="_top">TOP</a> |
		<a href="css_attribute_selectors.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
