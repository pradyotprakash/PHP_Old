...
<style>a.menu_css_outline{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Outlines</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_border.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_margin.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An outline is a line that is drawn around elements (outside the borders) 
to make the element &quot;stand out&quot;.</p>
<p class="intro">The outline properties specify the style, color, and width of an outline.</p>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_outline-style">Set the style of an outline</a><br>
This example demonstrates how to set the style of an outline.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_outline-color">Set the color of an outline</a><br>
This example demonstrates how to set the color of an outline.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_outline-width">Set the width of an outline</a><br>
This example demonstrates how to set the width of an outline.</p>
<hr>

<h2>CSS Outline</h2>
<p>An outline is a line that is drawn around elements (outside the borders) to make the element &quot;stand out&quot;. </p>
<p>However, the outline property is different from the border property.</p>
<p>The outline is not a part of an element's dimensions; the element's total width and height
is not affected by the width of the outline.</p>
<img src="box_outline.gif" alt="Outline" width="536" height="289" />
<br>
<br>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="../cssref/pr_outline.asp">outline</a>
    </td>
    <td>Sets all the outline properties in
      one declaration</td>
  ...
  <tr>
    <td>
      <a href="../cssref/pr_outline-color.asp">
      outline-color</a>
    </td>
  ...
  <tr>
    <td>
      <a href="../cssref/pr_outline-style.asp">
      outline-style</a>
    </td>
  ...
  <tr>
    <td>
      <a href="../cssref/pr_outline-width.asp">
      outline-width</a>
    </td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_outline.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_outline.asp#top" target="_top">TOP</a> |
		<a href="css_outline.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
