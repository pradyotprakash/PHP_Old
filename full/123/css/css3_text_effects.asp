...
<style>a.menu_css3_text_effects{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">Text Effects</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css3_gradients.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css3_fonts.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>CSS3 Text Effects</h2>
<p>CSS3 contains several new text features.</p>
<p>In this chapter you will learn about the following text properties:</p>
<ul>
	<li>text-shadow</li>
	<li>word-wrap</li>
</ul>
...
<p>Internet Explorer 10, Firefox, Chrome, Safari, and Opera support the text-shadow property.</p>
<p>All major browsers support the word-wrap property.</p>
<p><strong>Note:</strong> Internet Explorer 9 and earlier versions, does not support the text-shadow property.</p>
<hr>

<h2>CSS3 Text Shadow</h2>
<p>In CSS3, the text-shadow property applies shadow to text.</p>
<p><img src="text_shadow_effect.gif" alt="Text shadow effect!"></p>
<p>You specify the horizontal shadow, the vertical shadow, the blur distance, and the color of the shadow:</p>

<div class="example">
<h2 class="example">Example</h2>
<p>Add a shadow to a header:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_text-shadow_tut">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS3 Word Wrapping</h2>
...
<p>In CSS3, the word-wrap property allows you to force the text to wrap - even if it means splitting it in the middle of a word:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_word-wrap">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS3 Text Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="../cssref/css3_pr_hanging-punctuation.asp">hanging-punctuation</a></td>
    <td>Specifies whether a punctuation character may be placed outside the line box</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="../cssref/css3_pr_punctuation-trim.asp">punctuation-trim</a></td>
  ...
  <tr>
    <td><a href="../cssref/css3_pr_text-emphasis.asp">text-emphasis</a></td>
    <td>Applies emphasis marks, and the foreground color of the emphasis marks, 
	to the element's text </td>
    <td>3</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="../cssref/css3_pr_text-outline.asp">text-outline</a></td>
  ...
  <tr>
    <td><a href="../cssref/css3_pr_text-wrap.asp">text-wrap</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_text_effects.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_text_effects.asp#top" target="_top">TOP</a> |
		<a href="css3_text_effects.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
