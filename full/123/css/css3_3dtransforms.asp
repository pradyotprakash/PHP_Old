...
<style>a.menu_css3_3dtransforms{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">3D Transforms</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css3_2dtransforms.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css3_transitions.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>3D Transforms</h2>
<p>CSS3 allows you to format your elements using 3D transforms.</p>
<p>In this chapter you will learn about some of the 3D transform methods:</p>
<ul>
	<li>rotateX()</li>
	<li>rotateY()</li>
</ul>
<p class="example">Click on the elements below, to see the difference between a 2D transform and a 3D transform:</p>
...
<p>Internet Explorer 10 and Firefox supports 3D transforms.</p>
<p>Chrome and Safari requires the prefix -webkit-.</p>
<p>Opera does not yet support 3D transforms (It supports <a href="css3_2dtransforms.asp">2D transforms</a> only).</p>
<hr>

<h2>The rotateX() Method</h2>
<img src="transform_rotatex.gif" alt="Rotate X" />
<p>With the rotateX() method, the element rotates around its X-axis at a given degree.</p>
<div class="example">
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_transform_rotateX">Try it yourself &raquo;</a>
</div>
<br>
...
<img src="transform_rotatey.gif" alt="Rotate Y" />
<p>With the rotateY() method, the element rotates around its Y-axis at a given degree.</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
div<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_transform_rotateY">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_3dtransforms.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_3dtransforms.asp#top" target="_top">TOP</a> |
		<a href="css3_3dtransforms.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
