...
<style>a.menu_css3_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_attribute_selectors.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css3_borders.asp">Next Chapter &raquo;</a></div>
</div>
<br>
<div class="tutintro" >
<img id="animated_img" src="http://www.w3schools.com/images/w3css3_nomirror.gif" alt="CSS3" />
<p style="margin-left:120px;">CSS3 is the latest standard for CSS.</p>
<p style="margin-left:120px;">CSS3 is completely backwards-compatible with earlier versions of CSS.</p>
<p style="margin-left:120px;">This section teaches you about the new features in CSS3!</p>
</div>
<br>
<img src="transforms.gif" alt="CSS3 Transforms" width="625" height="124" />
<br>
<br>
<hr>

<h2>CSS3 Modules</h2>
<p>CSS3 has been split into &quot;modules&quot;. It contains the &quot;old CSS specification&quot; 
(which has 
been split into smaller pieces). In addition, new modules are added.</p>
<p>Some of the most important CSS3 
modules are:</p>
<ul>
	<li>Selectors</li>
	<li>Box Model</li>
...
<h2>CSS3
Recommendation</h2>
<p>The CSS3 specification is still under development by W3C.</p>
<p>However, many of the new CSS3 properties have been implemented in modern 
browsers.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_intro.asp#top" target="_top">TOP</a> |
		<a href="css3_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
