...
<title>CSS Dimension Properties</title>
<style>a.menu_css_dimension{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Dimension</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_grouping_nesting.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_display_visibility.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The CSS dimension properties allow you to control the height and
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_dim_height">Set the height of elements</a><br>
This example demonstrates how to set the height of different elements.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_dim_height_percent">Set the height of an image using percent</a><br>
This example demonstrates how to set the height of an element using a percent value.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_dim_width">Set the width of an element using a pixel value</a><br>
This example demonstrates how to set the width of an element using a pixel value.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_dim_max-height">Set the maximum height of an element</a><br>
This example demonstrates how to set the maximum height of an element.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_dim_max-width_percent">Set the maximum width of an element using percent</a><br>
This example demonstrates how to set the maximum width of an element using a percent value.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_dim_min-height">Set the minimum height of an element</a><br>
This example demonstrates how to set the minimum height of an element.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_dim_min-width">Set the minimum width of an element using a pixel value</a><br>
This example demonstrates how to set the minimum width of an element using a pixel value.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_dimension.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_dimension.asp#top" target="_top">TOP</a> |
		<a href="css_dimension.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
