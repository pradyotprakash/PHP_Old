...
<style>a.menu_css_positioning{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Positioning</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_display_visibility.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_float.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<h2>Positioning</h2>
<p>The CSS positioning properties allow you to position an element. It can also place an element behind another,
and specify what should happen when an element's content is too big.</p>
<p>Elements can be positioned using the top, bottom, left, and right properties. 
However, these properties will not work unless the position property is set first. 
They also work differently depending on the positioning method.</p>
<p>There are four different positioning methods.</p>
<hr>

<h2>Static Positioning</h2>
<p>HTML elements are positioned static by default. A static positioned element 
is always positioned according to the normal flow of the page.</p>
<p>Static positioned elements are not affected by the top, bottom, left, and 
right properties.</p>
<hr>

<h2>Fixed Positioning</h2>
<p>An element with fixed position is positioned relative to the browser window.</p>
<p>It will not move even if the window is scrolled:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_position_fixed" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
...
<p>Fixed positioned elements are removed from the normal flow. The 
document and other elements behave like the fixed positioned element does not exist.</p>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_position_relative" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>The content of relatively positioned elements can be moved and overlap other elements,
but the reserved space for the element is still preserved in the normal flow.</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
h2.pos_top<br>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_position_relative2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Relatively positioned elements are often used as container blocks for absolutely positioned elements.</p>
<hr>

<h2>Absolute Positioning</h2>
<p>An absolute position element is positioned relative to the first parent element that has a position other 
than static. If no such element is found, the containing block is &lt;html&gt;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
h2<br>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_position_absolute" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Absolutely positioned elements are removed from the normal flow. The 
document and other elements behave like the absolutely positioned element does not exist.</p>
...
<p>The z-index property specifies the stack order of an element (which element should be placed 
in front of, or behind, the others).</p>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_zindex" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>An element with greater stack order is always in front of an element with a lower stack order.</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><strong>Note:</strong> If two positioned elements overlap without a z-index 
specified, the element positioned last in the HTML code will be shown on top.</td>
</tr></table>
<br>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_clip">Set the shape of an element</a><br>
This example demonstrates how to set the shape of an element. The element is clipped into this shape, and displayed.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_overflow">How to show overflow in an element using scroll</a><br>
This example demonstrates how to set the overflow property to create a scroll bar when an element's content is too big to fit in a specified area.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_pos_overflow_auto">How to set the browser to automatically handle overflow</a><br>
This example demonstrates how to set the browser to automatically handle overflow.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_cursor">Change the cursor</a><br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="../cssref/pr_pos_overflow.asp">overflow</a><br>
    </td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_positioning.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_positioning.asp#top" target="_top">TOP</a> |
		<a href="css_positioning.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
