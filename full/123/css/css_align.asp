...
<style>a.menu_css_align{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Horizontal Align</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_float.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_pseudo_classes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<h2>In CSS, several properties are used to align elements horizontally.</h2>
</div>
</div>
<hr>

<h2>Aligning Block Elements</h2>
<p>A block element is an element that takes up the full width available, and has a line break before and after it.</p>
...
<p>For aligning text, see the
<a href="css_text.asp">CSS Text</a> chapter.</p>
<p>In this chapter we will show you how to horizontally align block elements for 
layout purposes.</p>
<hr>

<h2>Center Aligning Using the margin Property</h2>
<p>Block elements can be center-aligned by setting the left and right margins to &quot;auto&quot;.</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Note: </b>Using margin:auto; will not work in IE8 and earlier, <b>unless a !DOCTYPE is declared.</b></td>
</tr></table>
<p>Setting the left and right margins to auto specifies that they should split the available margin equally.
The result is a centered element:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_align_container" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p><b>Tip:</b> Center-aligning has no effect if the width is 100%.</p>
<hr>

<h2>Left and Right Aligning Using the position Property</h2>
<p>One method of aligning elements is to use absolute positioning:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
.right<br>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_align_pos" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p><b>Note:</b> Absolute positioned elements are removed from the 
normal flow, and can overlap elements.</p>
<hr>

<h2>Crossbrowser Compatibility Issues</h2>
<p>When aligning elements like this, it is always a good idea to predefine margin and padding for
the &lt;body&gt; element. This is to avoid visual differences in different browsers.</p>
<p>There is a problem with IE8 and earlier, when using the position property. If 
...
declaration when using the position property:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
body<br>
...
<br>
<a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_align_pos_crossbrowser" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>Left and Right Aligning Using the float Property</h2>
<p>One method of aligning elements is to use the float property:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
.right<br>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_align_float" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Crossbrowser Compatibility Issues</h2>
<p>When aligning elements like this, it is always a good idea to predefine 
margin and padding for the &lt;body&gt; element. This is to avoid visual differences in different browsers.</p>
<p>There is a problem with IE8 and earlier when using the float property. If 
the !DOCTYPE declaration is missing, IE8 and earlier versions will add a 17px margin on 
the right side. This seems to be space reserved for a scrollbar. Always set the !DOCTYPE 
declaration when using the float property:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
body<br>
...
<br>
<a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_align_float_crossbrowser" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_align.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_align.asp#top" target="_top">TOP</a> |
		<a href="css_align.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
