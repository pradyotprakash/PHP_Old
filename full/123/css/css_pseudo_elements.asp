...
<style>a.menu_css_pseudo_elements{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Pseudo-elements</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_pseudo_classes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_navbar.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">CSS pseudo-elements are used to add special effects to some selectors.</p>
<hr>

<h2>Syntax</h2>
<p>The syntax of pseudo-elements:</p>
<div class="code notranslate"><div>
selector:pseudo-element {property:value;}</div></div>
<p>CSS classes can also be used with pseudo-elements:</p>
<div class="code notranslate"><div>
selector.class:pseudo-element {property:value;}</div></div>
<br>
<hr>
...
<p>The &quot;first-line&quot; pseudo-element can only be applied to block-level 
elements.</p>
<div class="example">
	<h2 class="example">Example</h2>
	<p class="example">Format the first line of the text in p 
elements:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_firstline" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>The following properties apply to the &quot;first-line&quot; 
pseudo-element:</p>
<ul>
...
<p>The &quot;first-letter&quot; pseudo-element is used to add a special style to the first 
letter of a text.</p>

<p>The &quot;first-letter&quot; pseudo-element can only be applied to 
block-level elements.&nbsp;</p>
<div class="example">
	<h2 class="example">Example</h2>
<p>Format the first letter of the text in p elements:&nbsp;</p>
<div class="example_code notranslate">
p:first-letter <br>
{<br>
color:#ff0000;<br>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_firstletter" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="code notranslate"><div>
p.article:first-letter {color:#ff0000;}<br><br>
&lt;p class=&quot;article&quot;&gt;A paragraph in an article&lt;/p&gt;</div></div>
...
<p class="example">In the following example, the first letter of a paragraph will be red, in 
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_firstline_letter" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_before" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_after" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_pseudo_elements.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_pseudo_elements.asp#top" target="_top">TOP</a> |
		<a href="css_pseudo_elements.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
