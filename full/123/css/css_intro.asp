...
<style>a.menu_css_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="css_syntax.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>If you want to study these subjects first, find the tutorials on our <a target="_top" href="../default.asp">Home page</a>.</p>
<hr>
...
<ul>
  ...
  <li><b>External Style Sheets</b> can save a lot of work</li>
  <li>External Style Sheets are stored in <b>CSS files</b></li>
</ul>
<hr>

<h2>CSS Demo</h2>
<p>An HTML document can be displayed with different styles:
<a href="demo_default.htm" target="_blank">See how it works</a></p>
<hr>
...
<p>In HTML 4.0, all formatting could be removed from the HTML document, and stored 
in a separate CSS file.</p>
<p>All browsers support CSS today.</p>
<hr>

<h2>CSS Saves a Lot of Work!</h2>
<p>CSS defines HOW HTML elements are to be displayed.</p>
<p>Styles are normally saved in external .css files. External style sheets enable you to change the
appearance and layout of all the pages in a Web site, just by editing one single file!</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_syntax.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_intro.asp#top" target="_top">TOP</a> |
		<a href="css_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
