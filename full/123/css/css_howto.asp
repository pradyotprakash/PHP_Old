...
<style>a.menu_css_howto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="css_id_class.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_background.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">When a browser reads a style sheet, it will format the document according to it.</p>
<hr>
...
Each page must link to the style sheet using the &lt;link&gt; tag. The &lt;link&gt; tag goes inside the head section:</p>
...
<p>An external style sheet can be written in any text editor. The file should not contain any html tags. Your style sheet should be saved with a .css extension.
An example of a style sheet file is shown below:</p>
<div class="code notranslate"><div>
hr {color:sienna;}<br>
p {margin-left:20px;}<br>
body {background-image:url(&quot;images/back40.gif&quot;);}</div></div>
<br>
<table class="lamp"><tr>
...
<p>An internal style sheet should be used when a single document has a unique style. You define internal styles in the head section 
of an HTML page, by using the &lt;style&gt; tag, like this:</p>
<div class="code notranslate"><div>
&lt;head&gt;<br>
&lt;style&gt;<br>
hr {color:sienna;}<br>
...
<div class="code notranslate"><div>
&lt;p style=&quot;color:sienna;margin-left:20px;&quot;&gt;This is a paragraph.&lt;/p&gt;</div></div>
<br>
<hr>
...
<p><b>Tip:</b> Even multiple external style sheets can be referenced inside a single HTML document.</p>
...
sheet by the following rules, where number four has the highest priority:</p>
<ol>
...
<p>So, an inline style (inside an HTML element) has the highest priority, which means that it will override a style defined inside the &lt;head&gt; tag, or in
an external style sheet, or in a browser (a default value).</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Note:</b> If the link to the external style sheet is placed after the internal style sheet in HTML
&lt;head&gt;, the external style sheet will override the internal style sheet!</td>
</tr></table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_howto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_howto.asp#top" target="_top">TOP</a> |
		<a href="css_howto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
