...
<title>CSS3 Fonts</title>
<style>a.menu_css3_fonts{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">Fonts</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css3_text_effects.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css3_2dtransforms.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<img src="font.gif" alt="With CSS3, web designers are no longer forced to use only web-safe fonts" />
<hr>
<h2>The CSS3 @font-face Rule</h2>
<p>Before CSS3, web designers had to use fonts that were already installed on the user's computer.</p>
<p>With CSS3, web designers can use whatever font he/she likes.</p>
<p>When you have found/bought the font you wish to use, include the font 
file on your web server, and it will be automatically downloaded to the user when needed.</p>
<p>Your &quot;own&quot; fonts are defined in the CSS3 @font-face rule.</p>
<hr>
...
<p>Internet Explorer 9+, Firefox, Chrome, Safari, and Opera support the WOFF (Web Open Font Format) font.</p>
<p>Firefox, Chrome, Safari, and Opera also support fonts of type TTF (True Type Fonts) and OTF (OpenType Fonts).</p>
<p>Chrome, Safari and Opera also support SVG fonts/shapes.</p>
<p>Internet Explorer also supports EOT (Embedded OpenType) fonts.</p>
<p><b>Note:</b> Internet Explorer 8 and earlier versions, do not support the @font-face rule.</p>
<hr>
...
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="width:32px;height:32px"></th>
<td><strong>Tip:</strong> Use lowercase letters for the font URL. Uppercase letters can give unexpected results in IE.</td>
</tr></table>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_font-face_rule">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_font-face_rule_bold">Try it yourself &raquo;</a>
</div>
...
<h2>CSS3 Font Descriptors</h2>
<p>The following table lists all the font descriptors that can be defined inside the @font-face rule:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_fonts.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_fonts.asp#top" target="_top">TOP</a> |
		<a href="css3_fonts.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
