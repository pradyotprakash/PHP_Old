...
<style>a.menu_css_display_visibility{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Display</span> and <span class="color_h1">Visibility</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_dimension.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_positioning.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The display property specifies if/how an element 
...
<img class="thumbnail" src="klematis_small.jpg" width="107" height="90" alt="Klematis"><br>
...
<h2>Hiding an Element - display:none or visibility:hidden</h2>
<p>Hiding an element can be done by setting the display property to &quot;none&quot;
or the visibility property to &quot;hidden&quot;. However, notice that these two methods 
produce different results:</p>
<p>visibility:hidden hides an element, but it will still take up the 
same space as before. The element will be hidden, but still affect the layout.</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
h1.hidden {visibility:hidden;}</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_visibility_hidden" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>display:none hides an element, and it will not take up any space. 
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_display_none" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS Display - Block and Inline Elements</h2>
<p>A block element is an element that takes up the full width available, and 
has a line break before and after it.</p>
...
<p>An inline element only takes up as much width as necessary, and does not force 
line breaks.</p>
...
<h2>Changing How an Element is Displayed</h2>
<p>Changing an inline element to a block element, or vice versa, can be useful for 
making the page look a specific way, and still follow web standards.</p>
<p>The following example displays list items as inline elements:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
li {display:inline;}</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_display_inline_list" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_display_block2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Note:</b> Setting the display property of an element only changes <strong>how the element is displayed</strong>, 
NOT what kind of element it is. So, an inline element with display:block is not allowed
to have other block elements inside of it.</td>
</tr></table>
<br>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_display">How to display an element as an inline element.</a><br>
This example demonstrates how to display an element as an inline element.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_display_block">How to display an element as a block element</a><br>
This example demonstrates how to display an element as a block element.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_visibility_collapse">How to make a table element collapse</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_display_visibility.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_display_visibility.asp#top" target="_top">TOP</a> |
		<a href="css_display_visibility.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
