...
<style>a.menu_css_text{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="css_background.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_font.asp">Next Chapter &raquo;</a></div>
</div>
<br>
...
<a style="text-decoration:none" target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_text">&quot;Try it yourself&quot;</a> link.</p>
</div>
<br>
<hr>
...
body {color:blue;}<br>
h1 {color:#00ff00;}<br>
h2 {color:rgb(255,0,0);}</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_color" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Note:</b> For W3C compliant CSS: If you define the color property, you must also define the background-color 
property.</td>
</tr></table>
<br>
<hr>
...
<p>Text can be 
centered, or aligned to the left or right, or justified.</p>
<p>When text-align is set to &quot;justify&quot;, each line is stretched so that every line has equal width, and the left and right 
margins are straight (like in magazines and newspapers).</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_text-align_all" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_text-decoration_link" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>It can also be used to decorate text:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
h1 {text-decoration:overline;}<br>
h2 {text-decoration:line-through;}<br>
h3 {text-decoration:underline;}</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_text-decoration" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Note:</b> It is not recommended to underline text that is not a link, as this often confuses users.</td>
</tr></table>
<br>
<hr>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
p.uppercase {text-transform:uppercase;}<br>
p.lowercase {text-transform:lowercase;}<br>
p.capitalize {text-transform:capitalize;}</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_text-transform" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
p {text-indent:50px;}</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_text-indent" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_letter-spacing">Specify the space between characters</a><br>
This example demonstrates how to increase or decrease the space between characters.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_line-height">Specify the space between lines</a><br>
This example demonstrates how to specify the space between the lines in a paragraph.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_text_direction">Set the text direction of an element</a><br>
This example demonstrates how to change the text direction of an element.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_text_word-spacing">Increase the white space between words</a><br>
This example demonstrates how to increase the white space between words in a paragraph.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_text_white-space">Disable text wrapping inside an element</a><br>
This example demonstrates how to disable text wrapping inside an element.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_vertical-align">Vertical alignment of an image</a><br>
This example demonstrates how to set the vertical align of an image in a text.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_text-shadow">Add shadow to text</a><br>
This example demonstrates how to add shadow to text.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Used together with the <a href="../cssref/pr_text_direction.asp">direction</a> 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_text.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_text.asp#top" target="_top">TOP</a> |
		<a href="css_text.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
