...
<style>a.menu_css_quiz{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Quiz</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_examples.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_exam.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">You can test your CSS skills with W3Schools' Quiz.</p>
<hr>
<h2>The Test</h2>
<p>The test contains 20 questions and there is no time limit.&nbsp;</p>
<p>The test is not official, it's just a nice way to see how much you know, or don't know, about CSS.</p>
<hr>
...
<p>Good luck! <a href="http://www.w3schools.com/quiztest/quiztest.asp?qtest=CSS" target="_top">Start the CSS Quiz</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_quiz.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_quiz.asp#top" target="_top">TOP</a> |
		<a href="css_quiz.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
