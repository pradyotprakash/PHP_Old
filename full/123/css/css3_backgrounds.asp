...
<style>a.menu_css3_backgrounds{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">Backgrounds</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css3_borders.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css3_gradients.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>CSS3 contains several new background properties,<br> which allow greater control of the background element.</p>
<p>In this chapter you will learn about the following background properties:</p>
<ul>
	<li>background-size</li>
	<li>background-origin</li>
</ul>
<p>You will also learn how to use multiple background images.</p>
</div>
<hr>
...
<table class="browserref notranslate">
  <tr>
    <th style="width:15%;font-size:16px;text-align:left;">Property</th>
...
<p>The numbers in the table above indicates the earliest browser version that supports the property.</p>
<p>-webkit-, -moz-, and -o- indicates that the property only works with the specified prefix.</p>
<hr>


<h2>CSS3 The background-size Property</h2>
<div style="height:60px;
background:url('img_flwr_small.jpg') no-repeat top left;
background-repeat: no-repeat;
background-origin: content-box;">
</div>

<p>The background-size property specifies the size of the background image.</p>
<p>Before CSS3, the background image size was determined by the actual size of 
the image. In CSS3 it is possible to specify the size of the background image, 
which allows us to re-use background images in different contexts.</p>
<p>You can specify the size in pixels or in percentages. If 
you specify the size as a percentage, the size is relative to the width and 
height of the parent element.</p>

<div class="example">
<h2 class="example">Example 1</h2>
<p>Resize a background image:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_background-size">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Stretch the background image to completely fill the content area:</p>
<div class="example_code notranslate">
    div<br>
	{<br>
	background:url(img_flwr.gif);<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_background-size2">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS3 The background-origin Property</h2>
<p>The background-origin property specifies the positioning area of the background images.</p>
<p>The background image can be placed within the content-box, padding-box, or border-box area.</p>
<p><img src="background-origin.gif"></p>
<div class="example">
<h2 class="example">Example</h2>
<p>Position the background image within the content-box:</p>
<div class="example_code notranslate">
    div<br>
	{<br>
	background:url(img_flwr.gif);<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_background-origin">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<table>
<tr>
<td><h2>CSS3 Multiple Background Images</h2></td>
<td rowspan="2">
<div style="height:150px;
width:100px;
background:url('img_tree_flwr.gif');
background-repeat: no-repeat;"></div>
</td>
</tr>
<tr>
<td>
<p>CSS3 allows you to use several background images for an element.</p>
</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set two background images for the body element:</p>
<div class="example_code notranslate">
    body<br>{<br>background:url(img_tree.gif),url(img_flwr.gif);<br>
	background-size:100% 100%;<br>background-repeat:no-repeat;<br>}
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_background_multiple">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_backgrounds.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_backgrounds.asp#top" target="_top">TOP</a> |
		<a href="css3_backgrounds.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
