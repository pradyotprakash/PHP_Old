...
<style>a.menu_css_grouping_nesting{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Grouping</span> and <span class="color_h1">Nesting</span> Selectors</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_padding.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_dimension.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>Grouping Selectors</h2>
<p>In style sheets there are often elements with the same style.</p>
...
<p>To minimize the code, you can group selectors.</p>
<p>Separate each selector with a comma.</p>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_grouping" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Nesting Selectors</h2>
<p>It is possible to apply a style for a selector within a selector.</p>
<p>In the example below, one style is specified for all p elements, one style is 
specified for all elements with class=&quot;marked&quot;, and a 
third style is specified only for p elements within elements with class=&quot;marked&quot;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
p<br>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_nesting" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_grouping_nesting.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_grouping_nesting.asp#top" target="_top">TOP</a> |
		<a href="css_grouping_nesting.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
