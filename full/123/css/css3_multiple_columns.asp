...
<style>a.menu_css3_multiple_columns{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">Multiple Columns</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css3_animations.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css3_user_interface.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>CSS3 Multiple Columns</h2>
<p>With CSS3, you can create multiple columns for laying out text - like in newspapers!</p>
<p>In this chapter you will learn about the following multiple column properties:</p>
<ul>
	<li>column-count</li>
	<li>column-gap</li>
	<li>column-rule</li>
...
<p>Internet Explorer 10 and Opera supports multiple columns properties.</p>
<p>Firefox requires the prefix -moz-.</p>
<p>Chrome and Safari requires the prefix -webkit-.</p>
<p><strong>Note:</strong> Internet Explorer 9, and earlier versions, does not support the multiple columns properties.</p>
<hr>

<h2>CSS3 Create Multiple Columns</h2>
<p>The column-count property specifies the number of columns an element should be divided into:</p>
...
-webkit-column-count:3; /* Safari and Chrome */<br>
column-count:3;<br>
}
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_column-count">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS3 Specify the Gap Between Columns</h2>
...
div<br>
{<br>
-moz-column-gap:40px; /* Firefox */<br>
-webkit-column-gap:40px; /* Safari and Chrome */<br>
column-gap:40px;<br>
}
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_column-gap">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS3 Column Rules</h2>
...
div<br>
{<br>
-moz-column-rule:3px outset #ff00ff; /* Firefox */<br>
-webkit-column-rule:3px outset #ff00ff; /* Safari and Chrome */<br>
column-rule:3px outset #ff00ff;<br>
}
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_column-rule">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="../cssref/css3_pr_column-count.asp">column-count</a></td>
    <td>Specifies the number of columns an element should be divided into</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="../cssref/css3_pr_column-fill.asp">column-fill</a></td>
  ...
  <tr>
    <td><a href="../cssref/css3_pr_column-rule.asp">column-rule</a></td>
    <td>A shorthand property for setting all the column-rule-* properties</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="../cssref/css3_pr_column-rule-color.asp">column-rule-color</a></td>
    <td>Specifies the color of the rule between columns</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="../cssref/css3_pr_column-rule-style.asp">column-rule-style</a></td>
    <td>Specifies the style of the rule between columns</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="../cssref/css3_pr_column-rule-width.asp">column-rule-width</a></td>
    <td>Specifies the width of the rule between columns</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="../cssref/css3_pr_column-span.asp">column-span</a></td>
    <td>Specifies how many columns an element should span across</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="../cssref/css3_pr_column-width.asp">column-width</a></td>
    <td>Specifies the width of the columns</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="../cssref/css3_pr_columns.asp">columns</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_multiple_columns.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_multiple_columns.asp#top" target="_top">TOP</a> |
		<a href="css3_multiple_columns.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
