...
<style>a.menu_css_margin{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Margin</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_outline.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_padding.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<h2>Margin</h2>
<p>The margin clears an area around an element (outside the border). The margin 
does not have a background color, and is completely transparent.</p>
<p>The top, right, bottom, and left margin can be changed independently using separate properties.
A shorthand margin property can also be used, to change all margins at once.</p>
...
<table class="reference notranslate">
	...
	<tr>
		<td>inherit</td>
		<td>Specifies that the margin should be inherited 
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_margin_sides" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
margin:100px 50px;</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_margin_shorthand" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_margin-top">Set the top margin of a text using a cm value</a><br>
This example demonstrates how to set the top margin of a text using a cm value.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_margin-bottom_percent">Set the bottom margin of a text using a percent value</a><br>
This example demonstrates how to set the bottom margin in percent, relative to the width of the containing element.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_margin.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_margin.asp#top" target="_top">TOP</a> |
		<a href="css_margin.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
