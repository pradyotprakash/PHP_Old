...
<style>a.menu_css3_transitions{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">Transitions</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css3_3dtransforms.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css3_animations.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>CSS3 Transitions</h2>
<p>With CSS3, we can add an effect when changing from one style to another, without using Flash animations or JavaScripts.</p>
<hr>

<p>Mouse over the element below:</p>
...
<p>Internet Explorer 10, Firefox, Chrome, and Opera supports the transition property.</p>
<p>Safari requires the prefix -webkit-.</p>
<p><strong>Note:</strong> Internet Explorer 9, and earlier versions, does not support the transition property.</p>
<p><strong>Note:</strong> Chrome 25, and earlier versions, requires the prefix -webkit-.</p>
<hr>

<h2>How does it work?</h2>
<p>CSS3 transitions are effects that let an element gradually change from one style to another.</p>
...
<p class="example">Transition effect on the width property, duration: 2 seconds:</p>
...
<p><b>Note:</b> If the duration is not specified, the transition will have no effect, because default value is 0.</p>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Specify :hover for &lt;div&gt; elements:</p>
<div class="example_code notranslate">
div:hover<br>
{<br>
width:300px;<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_transition1">Try it yourself &raquo;</a>
</div>
<p><b>Note:</b> When the cursor mouse out of the element, it gradually changes back to its original style.</p>
<hr>

<h2>Multiple changes</h2>
<p>To add a transitional effect for more than one style, add more properties, separated by commas:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_transition2">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS3 Transition Properties</h2>
<p>The following table lists all the transition properties:</p>
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>A shorthand property for setting the four transition properties into a 
	single property</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="../cssref/css3_pr_transition-property.asp">transition-property</a></td>
    <td>Specifies the name of the CSS property to which the transition is applied</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="../cssref/css3_pr_transition-duration.asp">transition-duration</a></td>
    <td>Defines the length of time that a transition takes. Default 0</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="../cssref/css3_pr_transition-timing-function.asp">transition-timing-function</a></td>
    <td>Describes how the speed during a transition will be calculated. Default &quot;ease&quot;</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="../cssref/css3_pr_transition-delay.asp">transition-delay</a></td>
    <td>Defines when the transition will start. Default 0</td>
    <td>3</td>
  </tr>
</table>

<p>The two examples below sets all transition properties:</p>
<div class="example">
<h2 class="example">Example</h2>
<p>Use all transition properties in one example:</p>
<div class="example_code notranslate">
div<br>
{<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_transition4">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>The same transition effects as above, using the shorthand transition property:</p>
<div class="example_code notranslate">
div<br>
{<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss3_transition5">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_transitions.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_transitions.asp#top" target="_top">TOP</a> |
		<a href="css3_transitions.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
