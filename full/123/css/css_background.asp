...
<style>a.menu_css_background{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Background</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_howto.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_text.asp">Next Chapter &raquo;</a></div>
</div>
<br>
<div style="width:96.5%;border:1px solid gray;padding:8px;background:#e1efbb url('img_flwr.png') no-repeat bottom right">
<p style="margin-right:150px;">CSS background properties are used to define the background effects of an element.</p>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background-color_body" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
h1 {background-color:#6495ed;}<br>
p {background-color:#e0ffff;}<br>
div {background-color:#b0c4de;}</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background-color_elements" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background-image" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background-image_bad" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br>
<a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background-image_gradient1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>If the image is repeated only horizontally (repeat-x), the background will look 
better:</p>
...
<br>
<a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background-image_gradient2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<td><b>Note:</b> When using a background image, use an image that does not disturb the text.</td>
</tr></table>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background-image_norepeat" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background-image_position" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Background - Shorthand property</h2>
<p>As you can see from the examples above, there are many properties to consider 
when dealing with backgrounds.</p>
<p>To shorten the code, it is also possible to specify all the properties in one 
single property. This is called a shorthand property.</p>
<p>The shorthand property for background is simply &quot;background&quot;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
body {background:#ffffff url('img_tree.png') no-repeat right top;}</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background_shorthand" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>
...
ones that are present are in this order.</p>
<p>This example uses more advanced CSS. Take a look:
<a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background_shorthand2">
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_background-attachment">How to set a fixed background image</a><br>
This example demonstrates how to set a fixed background image. The image will not scroll with the rest of the page.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Sets all the background 
	properties in one declaration</td>
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_background.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_background.asp#top" target="_top">TOP</a> |
		<a href="css_background.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
