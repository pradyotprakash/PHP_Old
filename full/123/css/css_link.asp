...
<style>a.menu_css_link{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="css_font.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_list.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Links can be styled in different ways.</p>

<hr>

<h2>Styling Links</h2>
<p>Links can be styled with any CSS property (e.g. color, font-family, 
background, etc.).</p>
...
<p>In the example above the link changes color depending on what 
state it is in.</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_link_decoration">Try it yourself &raquo;</a>
</div>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
a:link {background-color:#B2FF99;}<br>
a:visited {background-color:#FFFF85;}<br>
a:hover {background-color:#FF704D;}<br>
a:active {background-color:#FF704D;}
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_link_background">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_link2">Add different 
styles to hyperlinks</a><br>
This example demonstrates how to add other styles to hyperlinks.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_link_advanced">Advanced - 
Create link boxes</a><br>
This example demonstrates a more advanced example where we combine several CSS 
properties to display links as boxes.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_link.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_link.asp#top" target="_top">TOP</a> |
		<a href="css_link.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
