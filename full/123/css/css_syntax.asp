...
<style>a.menu_css_syntax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Syntax</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_id_class.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>Examples</h2>
<ul>
  <li>Look at <a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=ex1">Example 1</a></li>
  <li>Look at <a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=ex2">Example 2</a></li>
</ul>
<hr>
<h2>CSS Syntax</h2>
<p>A CSS rule has two main parts: a selector, and one or more declarations:</p>
<p><img src="selector.gif" alt="CSS selector" style="width:569px;height:119px;"></p>
<p>The selector is normally the HTML element you want to style.</p>
<p>Each declaration consists of a property and a value.</p>
<p>The property is the
style attribute you want to change. Each property has a value.</p>
<hr>
<h2>CSS Example</h2>
<p>A CSS declaration always ends with a semicolon, and declaration groups are 
surrounded by curly brackets:</p>
<div class="code notranslate"><div>
p {color:red;text-align:center;}</div></div>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_syntax1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>CSS Comments</h2>
<p>Comments are used to explain your code, and may help you when you edit the source code at a later date. 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_syntax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_syntax.asp#top" target="_top">TOP</a> |
		<a href="css_syntax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
