...
<style>a.menu_css_padding{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Padding</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_margin.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_grouping_nesting.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
element. The padding is affected by the background color of the element.</p>
<p>The top, right, bottom, and left padding can be changed independently using separate properties.
A shorthand padding property can also be used, to change all paddings at once.</p>
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_padding_sides" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
padding:25px 50px;</div>
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_padding_shorthand" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_padding">All the padding properties in one declaration</a><br>
This example demonstrates a shorthand property for setting all of the padding properties in one declaration, can have from one to four values.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_padding-left">Set the left padding</a><br>
This example demonstrates how to set the left padding of a p element.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_padding-right">Set the right padding</a><br>
This example demonstrates how to set the right padding of a p element.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_padding-top">Set the top padding</a><br>
This example demonstrates how to set the top padding of a p element.</p>

<p><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_padding-bottom">Set the bottom padding</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_padding.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_padding.asp#top" target="_top">TOP</a> |
		<a href="css_padding.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
