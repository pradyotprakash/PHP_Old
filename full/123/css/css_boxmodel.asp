...
<style>a.menu_css_boxmodel{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="css_table.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_border.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>The CSS box model is essentially a box that wraps around HTML elements, and 
...
<br>
<img src="box-model.gif" alt="CSS box-model" width="536" height="289" />
<p>Explanation of the different parts:</p>
<ul>
	<li><b>Margin</b> - Clears an area around the border. The margin does not have a 
	background color, it is completely transparent</li>
	<li><b>Border</b> - A border that goes around the padding and content. The 
	border is inherited from the color property of the box</li>
	<li><b>Padding</b> - Clears an area around the content. The 
	padding is affected by the background color of the box</li>
	<li><b>Content</b> - The content of the box, where text and images appear</li>
</ul>
<p>In order to set the width and height of an element correctly in all browsers, 
you need to know how the box model works.</p>
<hr>
...
<td><b>Important:</b> When you set the width and height properties of an 
element with CSS, you just set the width and height of the <b>content area</b>. To 
calculate the full size of an element, you must also add the padding, borders and margins.</td>
</tr></table>
...
+ 20px (left + right margin)<br>
= 300px</p>
<p>Assume that you had only 250px of space. Let's make an element with a total 
width of 250px:</p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/css/tryit.asp?filename=trycss_boxmodel_width" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<p>IE8 and earlier versions of IE, included padding and border in the width 
property.</p>
<p>To fix this problem, add a &lt;!DOCTYPE html&gt; to the HTML page.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_table.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_border.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_boxmodel.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_boxmodel.asp#top" target="_top">TOP</a> |
		<a href="css_boxmodel.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
