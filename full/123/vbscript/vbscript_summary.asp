...
<title>VBScript Summary</title>
<style>a.menu_vbscript_summary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>You Have Learned VBScript, <span class="color_h1">Now What?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="vbscript_looping.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="vbscript_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>VBScript Summary</h2>
<p>This tutorial has taught you VBScript.</p>
<p>You have learned about variables and functions, and how to 
make different scripts run in response to different scenarios.</p>
<p>For more information on VBScript, please look at our
<a href="vbscript_examples.asp">VBScript examples</a> and our
<a href="vbscript_ref_functions.asp">VBScript references</a>.</p>
<hr>
<h2>Now You Know VBScript, What's Next?</h2>
<p>The next step is to learn ASP.</p>
<p>While scripts in an HTML file are executed on the client (in the browser), scripts in an ASP file are 
executed on the server.</p>
<p>With ASP you can dynamically edit, change or add any content of a Web page, respond to data submitted from HTML forms, 
access any data or databases and return the results to a browser, customize a Web page to make it more
    useful for individual users.</p>
<p>Since ASP files are returned as plain HTML, they can be viewed in any browser.</p>
<p>If you want to learn more about ASP, please 
visit our <a href="../asp/default.asp">ASP tutorial</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="vbscript_looping.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="vbscript_examples.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="vbscript_summary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="vbscript_summary.asp#top" target="_top">TOP</a> |
		<a href="vbscript_summary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
