...
<html lang="en-US">
<head>
<title>VBScript Round Function</title>
<style>a.menu_func_round{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Round</span> Function</h1>
<hr>
...
<p>The Round function rounds a number.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>expression</td>
    <td>   Required. The numeric expression to be rounded</td>
  </tr>
  <tr>
    <td>numdecimalplaces</td>
    <td>   Optional. Specifies how many places to the right of the 
    decimal are included in the rounding. Default is 0</td>
  </tr>
  </table>
<h2>Examples</h2>
...
&lt;%<br><br>
response.write(Round(24.13278) & "&lt;br /&gt;")<br>
response.write(Round(24.75122))<br>
<br>
%&gt;
</div>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_round_func" class="tryitbtn">Show Example &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example 2</h2>
<p>How to round a number, keeping 2 decimals:</p>
<div class="example_code notranslate">
&lt;%<br><br>
response.write(Round(24.13278,2))<br>
<br>
%&gt;
</div>
<p>The output of the code above will be:</p>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_round_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_round.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_round.asp#top" target="_top">TOP</a> |
		<a href="func_round.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
