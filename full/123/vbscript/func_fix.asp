...
<html lang="en-US">
<head>
<title>VBScript Fix Function</title>
<style>a.menu_func_fix{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Fix</span> Function</h1>
<hr>
...
<p>The Fix function returns the integer part of a specified number.</p>
<p><b>Note:</b> If the number parameter contains Null, Null will be returned.</p>
<p><b>Tip:</b> Also look at the Int function.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>number</td>
    <td>   Required. A valid numeric expression</td>
  </tr>
  </table>
...
&lt;%<br><br>
response.write(Fix(6.83227) &amp; &quot;&lt;br /&gt;&quot;)<br>
response.write(Fix(6.23443))<br>
<br>
%&gt;
</div>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_fix_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="example_code notranslate">
&lt;%<br><br>
response.write(Fix(-6.13443) &amp; &quot;&lt;br /&gt;&quot;)<br>
response.write(Fix(-6.93443))<br>
<br>
%&gt;
</div>
<p>The output of the code above will be:</p>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_fix_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_fix.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_fix.asp#top" target="_top">TOP</a> |
		<a href="func_fix.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
