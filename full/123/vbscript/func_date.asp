...
<h1>VBScript <span class="color_h1">Date</span> Function</h1>
<hr>
...
<p>The Date function returns the current system date.</p>
...
&lt;%<br><br>
response.write(&quot;The current system date is: &quot;)<br>
response.write(Date)<br><br>
%&gt;</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
The current system date is: 2/19/2014
</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_date_func" class="tryitbtn">Show Example &raquo;</a>
</div>
<hr>
<a href="vbscript_ref_functions.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="VBScript Reference" /> Complete VBScript Reference</a>
				<hr />
