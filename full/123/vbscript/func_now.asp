...
<html lang="en-US">
<head>
<title>VBScript Now Function</title>
<style>a.menu_func_now{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Now</span> Function</h1>
<hr>
...
<p>The Now function returns the current date and time according to the setting 
of your computer's system date and time.</p>
...
&lt;%<br><br>
response.write(&quot;The current system date and time is: &quot;)<br>
response.write(Now)<br><br>
%&gt;</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
The current system date and time is: 2/19/2014 6:02:45 AM
</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_now_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_now.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_now.asp#top" target="_top">TOP</a> |
		<a href="func_now.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
