...
<html lang="en-US">
<head>
<title>VBScript Time Function</title>
<style>a.menu_func_time{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Time</span> Function</h1>
<hr>
...
<p>The  Time function returns the current system time.</p>
...
&lt;%<br><br>
response.write(&quot;The current system time is: &quot;)<br>
response.write(Time)<br><br>
%&gt;</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
The current system time is: 6:02:48 AM
</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_time_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_time.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_time.asp#top" target="_top">TOP</a> |
		<a href="func_time.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
