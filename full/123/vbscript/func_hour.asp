...
<html lang="en-US">
<head>
<title>VBScript Hour Function</title>
<style>a.menu_func_hour{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Hour</span> Function</h1>
<hr>
...
<p>The Hour function returns a number between 0 and 23 that represents the hour 
of the day.</p>
...
&lt;%<br><br>
response.write(Hour("13:45"))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
13</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_hour_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="example_code notranslate">
&lt;%<br><br>
response.write(Hour(Now()))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
6</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_hour_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_hour.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_hour.asp#top" target="_top">TOP</a> |
		<a href="func_hour.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
