...
<html lang="en-US">
<head>
<title>VBScript Timer Function</title>
<style>a.menu_func_timer{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Timer</span> Function</h1>
<hr>
...
<p>The Timer function returns the number of seconds, and milliseconds, since 12:00 AM.</p>
...
&lt;%<br><br>
response.write(&quot;Number of seconds and milliseconds since 12:00 AM: &quot;)<br>
response.write(Timer)<br><br>
%&gt;</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
Number of seconds and milliseconds since 12:00 AM: 21769.45
</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_timer_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_timer.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_timer.asp#top" target="_top">TOP</a> |
		<a href="func_timer.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
