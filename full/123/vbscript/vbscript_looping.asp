...
<style>a.menu_vbscript_looping{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Looping</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="vbscript_conditionals.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="vbscript_summary.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<ul>
<li><b>For...Next statement </b>- runs code a specified number of times</li>
<li><b>For Each...Next statement </b>- runs code for each item in a collection or each element of an array</li>
...
<h2>For...Next Loop</h2>
<p>Use the <b>For...Next</b> statement to run a block of code a specified number of times.
</p>
...
&lt;%<br>
For i = 0 To 5<br>
&nbsp; response.write(&quot;The number is &quot; &amp; i &amp; &quot;&lt;br /&gt;&quot;)<br>
Next<br>
%&gt;<br><br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_fornext" class="tryitbtn">Show Example &raquo;</a>
</div>

<h3>The Step Keyword</h3>
<p>With the <b> Step</b> keyword, you can increase or decrease the counter variable by the value you specify.</p>
<p>In the example below, the counter variable (<b>i</b>) is INCREASED by two, each time the loop repeats.</p>
...
<p>To decrease the counter variable, you must use a negative <b> Step</b> value. You must specify an end value that is less than the start value.</p>
<p>In the example below, the counter variable (<b>i</b>) is DECREASED by two, each time the loop repeats.</p>
...
<p>A <b>For Each...Next</b> loop repeats a block of code for each item in a collection, or for each element of an array.</p>
...
cars(2)=&quot;BMW&quot;<br>
<br>
For Each x In cars<br>
&nbsp;&nbsp;response.write(x &amp; &quot;&lt;br /&gt;&quot;)<br>
Next<br>
%&gt;<br><br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_foreach" class="tryitbtn">Show Example &raquo;</a>
</div>
<br>
<hr>
...
<h2>Do...Loop</h2>
<p>
If you don't know how many repetitions you want, use a Do...Loop statement.</p>
<p>
...
<p>
<a target="_blank" href="showasp.asp?filename=demo_vb_fornext2">Looping through headers</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="vbscript_looping.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="vbscript_looping.asp#top" target="_top">TOP</a> |
		<a href="vbscript_looping.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
