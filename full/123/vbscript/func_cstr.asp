...
<html lang="en-US">
<head>
<title>VBScript CStr Function</title>
<style>a.menu_func_cstr{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">CStr</span> Function</h1>
<hr>
...
<p>The CStr function converts an expression to type String.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>expression</td>
    <td>   Required. Any valid expression<p>If expression is:</p>
    <ul>
      <li>Boolean - then the CStr function will return a string containing true 
      or false.</li>
      <li>Date - then the CStr function will return a string that contains a 
      date in the short-date format.</li>
      <li>Null - then a run-time error will occur.</li>
      <li>Empty - then the CStr function will return an empty string (&quot;&quot;).</li>
      <li>Error - then the CStr function will return a string that contains the 
      word &quot;Error&quot; followed by an error number.</li>
      <li>Other numeric - then the CStr function will return a string that 
      contains the number.</li>
    </ul>
    </td>
  </tr>
  </table>
...
&lt;%<br><br>
response.write(CStr("300000") &amp; &quot;&lt;br /&gt;&quot;)<br>
response.write(CStr(#10-05-25#) &amp; &quot;&lt;br /&gt;&quot;)<br>
<br>
%&gt;
</div>
...
300000<br>
10/5/2025</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_cstr_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cstr.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cstr.asp#top" target="_top">TOP</a> |
		<a href="func_cstr.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
