...
<html lang="en-US">
<head>
<title>VBScript Second Function</title>
<style>a.menu_func_second{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Second</span> Function</h1>
<hr>
...
<p>The Second function returns a number between 0 and 59 that represents the second of the minute.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>time</td>
    <td>   Required. Any expression that can represent a time</td>
  </tr>
  </table>
...
&lt;%<br><br>
response.write(Second("13:45:21"))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
21</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_second_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="example_code notranslate">
&lt;%<br><br>
response.write(Second(Now()))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
46</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_second_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_second.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_second.asp#top" target="_top">TOP</a> |
		<a href="func_second.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
