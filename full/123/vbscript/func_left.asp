...
<html lang="en-US">
<head>
<title>VBScript Left Function</title>
<style>a.menu_func_left{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Left</span> Function</h1>
<hr>
...
<p>The Left function returns a specified number of characters from the left side of a string.</p>
<p><b>Tip:</b> Use the Len function to find the number of characters in a string.</p>
<p><b>Tip:</b> Also look at the Right function.</p>
...
<div class="example_code notranslate">
This is a beaut</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_left_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_left_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_left.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_left.asp#top" target="_top">TOP</a> |
		<a href="func_left.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
