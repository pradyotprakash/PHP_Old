...
<html lang="en-US">
<head>
<title>VBScript Year Function</title>
<style>a.menu_func_year{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Year</span> Function</h1>
<hr>
...
<p>The Year function returns a number that represents the year.</p>
...
&lt;%<br><br>
response.write(Year("2010-02-16"))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
2010</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_year_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_year.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_year.asp#top" target="_top">TOP</a> |
		<a href="func_year.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
