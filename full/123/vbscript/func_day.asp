...
<html lang="en-US">
<head>
<title>VBScript Day Function</title>
<style>a.menu_func_day{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Day</span> Function</h1>
<hr>
...
<p>The Day function returns a number between 1 and 31 that represents the day of the month.</p>
...
&lt;%<br><br>
response.write(Day("2010-02-16"))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
16</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_day_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_day.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_day.asp#top" target="_top">TOP</a> |
		<a href="func_day.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
