...
<html lang="en-US">
<head>
<title>VBScript IsNull Function</title>
<style>a.menu_func_isnull{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">IsNull</span> Function</h1>
<hr>
...
<p>The IsNull function returns a Boolean value that indicates whether a 
specified expression contains no valid data (Null). It returns True if 
expression is Null; otherwise, it returns False.</p>
...
False<br>
True</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_isnull_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_isnull.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_isnull.asp#top" target="_top">TOP</a> |
		<a href="func_isnull.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
