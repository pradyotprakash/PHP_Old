...
<html lang="en-US">
<head>
<title>VBScript IsDate Function</title>
<style>a.menu_func_isdate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">IsDate</span> Function</h1>
<hr>
...
<p>The IsDate function returns a Boolean value that indicates if the evaluated 
expression can be converted to a date. It returns True if the expression is a 
date or can be converted to a date; otherwise, it returns False.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>expression</td>
    <td>   Required. The expression to be evaluated</td>
  </tr>
  </table>
...
response.write(IsDate(#01/31/10#))<br><br>
%&gt;
</div>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_isdate_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="example_code notranslate">
&lt;%<br><br>
response.write(IsDate("#01/31/10#"))<br>
response.write("&lt;br /&gt;")<br>
response.write(IsDate("52/17/2010"))<br>
response.write("&lt;br /&gt;")<br>
response.write(IsDate("Hello World!"))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_isdate_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_isdate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_isdate.asp#top" target="_top">TOP</a> |
		<a href="func_isdate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
