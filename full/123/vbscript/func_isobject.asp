...
<html lang="en-US">
<head>
<title>VBScript IsObject Function</title>
<style>a.menu_func_isobject{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">IsObject</span> Function</h1>
<hr>
...
<p>The IsObject function returns a Boolean value that indicates whether the 
specified expression is an automation object. It returns True if expression 
is an automation object; otherwise, it returns False.</p>
...
&lt;%<br>
<br>
	Set x=CreateObject(&quot;vbscript.regexp&quot;)<br>
response.write(IsObject(x))<br>
<br>
%&gt;</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
True</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_isobject_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="example_code notranslate">
False</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_isobject_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_isobject.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_isobject.asp#top" target="_top">TOP</a> |
		<a href="func_isobject.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
