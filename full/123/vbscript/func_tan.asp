...
<html lang="en-US">
<head>
<title>VBScript Tan Function</title>
<style>a.menu_func_tan{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Tan</span> Function</h1>
<hr>
...
<p>The Tan function returns the tangent of a specified number (angle).</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>number</td>
    <td>   Required. A valid numeric expression that expresses an 
    angle in radians</td>
  </tr>
  </table>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_tan_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_tan.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_tan.asp#top" target="_top">TOP</a> |
		<a href="func_tan.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
