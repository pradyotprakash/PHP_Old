...
<html lang="en-US">
<head>
<title>VBScript Array Function</title>
...
<h1>VBScript <span class="color_h1">Array</span> Function</h1>
<hr>
...
<p>The Array function returns a variant containing an array.</p>

<p><b>Note:</b> The first element in the array is zero.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>arglist</td>
    <td>   Required. A list (separated by commas) of values that is 
    the elements in the array</td>
  </tr>
  </table>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_array_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_array_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<p>Looping through all items in an array:</p>
<div class="example_code notranslate">
&lt;%<br><br>
a=Array(5,10,15,20)<br>
for each x in a<br>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_array_func3" class="tryitbtn">Show Example &raquo;</a>
</div>
