...
<style>a.menu_func_datepart{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">DatePart</span> Function</h1>
<hr>
...
<p>The DatePart function returns the specified part of a given date.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>interval</td>
    <td>   Required. The interval of time to return.<p>Can take the 
    following values:</p>
    <ul>
      <li>yyyy - Year</li>
      <li>q - Quarter</li>
  ...
  <tr>
    <td>date</td>
    <td>   Required. Date expression to evaluate</td>
  </tr>
  <tr>
...
<p>Get the month from a date:</p>
<div class="example_code notranslate">
&lt;%<br><br>
d=CDate("2010-02-16")<br>
response.write(DatePart(&quot;m&quot;,d))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
2</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_datepart_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<p>Get the month we are in:</p>
<div class="example_code notranslate">
&lt;%<br><br>
response.write(DatePart(&quot;m&quot;,Now()))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_datepart_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="example_code notranslate">
&lt;%<br><br>
response.write(DatePart(&quot;h&quot;,Now())<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
6</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_datepart_func3" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_datepart.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_datepart.asp#top" target="_top">TOP</a> |
		<a href="func_datepart.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
