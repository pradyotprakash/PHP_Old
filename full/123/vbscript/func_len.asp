...
<html lang="en-US">
<head>
<title>VBScript Len Function</title>
<style>a.menu_func_len{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Len</span> Function</h1>
<hr>
...
<p>The Len function returns the number of characters in a string.</p>
...
<div class="example_code notranslate">
24</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_len_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<p>You can also put the string directly into the Len function:</p>
<div class="example_code notranslate">
&lt;%<br><br>
response.write(Len("This is a beautiful day!"))<br>
<br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
24</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_len_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_len.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_len.asp#top" target="_top">TOP</a> |
		<a href="func_len.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
