...
<html lang="en-US">
<head>
<title>VBScript RTrim Function</title>
<style>a.menu_func_rtrim{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">RTrim</span> Function</h1>
<hr>
...
<p>The RTrim function removes spaces on the right side of a string.</p>
<p><b>Tip:</b> Also look at the LTrim and the Trim functions.</p>
...
&lt;%<br><br>
fname=&quot; Jack "<br>
response.write("Hello" &amp; RTrim(fname) &amp; &quot;and welcome.&quot;)<br>
<br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
Hello Jackand welcome.</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_rtrim_func" class="tryitbtn">Show Example &raquo;</a>
</div>
<hr>
<a href="vbscript_ref_functions.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="VBScript Reference" /> Complete VBScript Reference</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_rtrim.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_rtrim.asp#top" target="_top">TOP</a> |
		<a href="func_rtrim.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
