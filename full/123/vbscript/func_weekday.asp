...
<html lang="en-US">
<head>
<title>VBScript Weekday Function</title>
<style>a.menu_func_weekday{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Weekday</span> Function</h1>
<hr>
...
<p>The  Weekday function returns a number between 1 and 7, that represents the day of the week.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>date</td>
    <td>   Required. The date expression to evaluate</td>
  </tr>
  <tr>
...
&lt;%<br><br>
response.write(Weekday("2010-02-16",0) & "&lt;br /&gt;")<br>
response.write(Weekday("2010-02-16",1) & "&lt;br /&gt;")<br>
response.write(Weekday("2010-02-16",2) & "&lt;br /&gt;")<br>
response.write(Weekday("2010-02-16",3) & "&lt;br /&gt;")<br>
response.write(Weekday("2010-02-16",4) & "&lt;br /&gt;")<br>
response.write(Weekday("2010-02-16",5) & "&lt;br /&gt;")<br>
response.write(Weekday("2010-02-16",6) & "&lt;br /&gt;")<br><br>
%&gt;
</div>
...
6<br>
5</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_weekday_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_weekday.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_weekday.asp#top" target="_top">TOP</a> |
		<a href="func_weekday.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
