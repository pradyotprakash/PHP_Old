...
<html lang="en-US">
<head>
<title>VBScript Minute Function</title>
<style>a.menu_func_minute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Minute</span> Function</h1>
<hr>
...
<p>The Minute function returns a number between 0 and 59 that represents the minute of the hour.</p>
...
&lt;%<br><br>
response.write(Minute("13:45"))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
45</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_minute_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="example_code notranslate">
&lt;%<br><br>
response.write(Minute(Now()))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
2</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_minute_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_minute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_minute.asp#top" target="_top">TOP</a> |
		<a href="func_minute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
