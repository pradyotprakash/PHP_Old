...
<html lang="en-US">
<head>
<title>VBScript Abs Function</title>
<style>a.menu_func_abs{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Abs</span> Function</h1>
<hr>
...
<p>The Abs function returns the absolute value of a specified number.</p>

<p><b>Note:</b> If the number parameter contains Null, Null will be returned</p>

<p><b>Note:</b> If the number parameter is an uninitialized variable, zero will be returned.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>number</td>
    <td>   Required. A numeric expression</td>
  </tr>
  </table>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_abs_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_abs_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_abs.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_abs.asp#top" target="_top">TOP</a> |
		<a href="func_abs.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
