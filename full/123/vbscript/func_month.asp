...
<html lang="en-US">
<head>
<title>VBScript Month Function</title>
<style>a.menu_func_month{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Month</span> Function</h1>
<hr>
...
<p>The Month function returns a number between 1 and  12 that represents the month of the year.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>date</td>
    <td>   Required. Any expression that can represent a date</td>
  </tr>
  </table>
<h2>Example</h2>
...
&lt;%<br><br>
response.write(Month("2010-02-16"))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
2</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_month_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_month.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_month.asp#top" target="_top">TOP</a> |
		<a href="func_month.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
