...
<html lang="en-US">
<head>
<title>VBScript IsNumeric Function</title>
<style>a.menu_func_isnumeric{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">IsNumeric</span> Function</h1>
<hr>
...
<p>The IsNumeric function returns a Boolean value that indicates whether a 
specified expression can be evaluated as a number. It returns True if 
the expression is recognized as a number; otherwise, it returns False.</p>
<p><b>Note:</b> If expression is a date the IsNumeric function will return False.</p>
...
Dim x<br>
x=10<br>
response.write(IsNumeric(x) &amp; &quot;&lt;br /&gt;&quot;)<br>
x=Empty<br>
response.write(IsNumeric(x) &amp; &quot;&lt;br /&gt;&quot;)<br>
x=Null<br>
response.write(IsNumeric(x) &amp; &quot;&lt;br /&gt;&quot;)<br>
...
True<br>
False </div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_isnumeric_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_isnumeric.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_isnumeric.asp#top" target="_top">TOP</a> |
		<a href="func_isnumeric.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
