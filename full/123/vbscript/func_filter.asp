...
<html lang="en-US">
<head>
<title>VBScript Filter Function</title>
<style>a.menu_func_filter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Filter</span> Function</h1>
<hr>
...
<p>The Filter function returns a zero-based array that contains a subset of a 
string array based on a filter criteria.</p>

<p><b>Note:</b> If no matches of the value parameter are found, the Filter 
function will return an empty array.</p>

<p><b>Note:</b> If the parameter inputstrings is Null or is NOT a 
one-dimensional array, an error will occur.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>inputstrings</td>
    <td>   Required. A one-dimensional array of strings to be 
    searched</td>
  </tr>
  <tr>
    <td>value</td>
  ...
  <tr>
    <td>include</td>
    <td>   Optional. A Boolean value that indicates whether to 
    ...
    the array that does not contain value as a substring. Default is True.</td>
  </tr>
  <tr>
    <td>compare</td>
...
<p>Filter: items that contains "S"</p>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_filter_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<p>Filter: items that does NOT contain "S" (include=False):</p>

<div class="example_code notranslate">
&lt;%<br>
<br>
a=Array(&quot;Sunday&quot;,&quot;Monday&quot;,&quot;Tuesday&quot;,&quot;Wednesday&quot;,&quot;Thursday&quot;,&quot;Friday&quot;,&quot;Saturday&quot;)<br>
b=Filter(a,&quot;S&quot;,False)<br>
for each x in b<br>
&nbsp;&nbsp;&nbsp;&nbsp;response.write(x &amp; &quot;&lt;br /&gt;&quot;)<br>
next<br>
<br>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_filter_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<p>Filter: items that contains "S", with a textual comparison (compare=1):</p>
...
Thursday<br>
Saturday</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_filter_func3" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filter.asp#top" target="_top">TOP</a> |
		<a href="func_filter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
