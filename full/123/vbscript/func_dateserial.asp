...
<html lang="en-US">
<head>
<title>VBScript DateSerial Function</title>
<style>a.menu_func_dateserial{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">The DateSerial</span> Function</h1>
<hr>
...
<p>The DateSerial function returns a Variant of subtype Date for a specified 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>year</td>
    <td>   Required. A number between 100 and 9999, or a numeric 
    expression. Values between 0 and 99 are interpreted as the years 1900–1999. 
    For all other year arguments, use a complete four-digit year</td>
  </tr>
  <tr>
    <td>month</td>
    <td>   Required. Any numeric expression</td>
  </tr>
  <tr>
    <td>day</td>
    <td>   Required. Any numeric expression</td>
...
&lt;%<br><br>
response.write(DateSerial(2010,2,3))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
2/3/2010</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_dateserial_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<p>Subtract 10 days:</p>
<div class="example_code notranslate">
&lt;%<br><br>
response.write(DateSerial(2010,2,3-10))<br><br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
1/24/2010</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_dateserial_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_dateserial.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_dateserial.asp#top" target="_top">TOP</a> |
		<a href="func_dateserial.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
