...
<html lang="en-US">
<head>
<title>VBScript Trim Function</title>
<style>a.menu_func_trim{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Trim</span> Function</h1>
<hr>
...
<p>The Trim function removes spaces on both sides of a string.</p>
<p><b>Tip:</b> Also look at the LTrim and the RTrim functions.</p>
...
&lt;%<br><br>
fname=&quot; Jack "<br>
response.write("Hello" &amp; Trim(fname) &amp; &quot;and welcome.&quot;)<br>
<br>
%&gt;
</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
HelloJackand welcome.</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_trim_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_trim.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_trim.asp#top" target="_top">TOP</a> |
		<a href="func_trim.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
