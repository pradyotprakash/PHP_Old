...
<html lang="en-US">
<head>
<title>VBScript Right Function</title>
<style>a.menu_func_right{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Right</span> Function</h1>
<hr>
...
<p>The Right function returns a specified number of characters from the right side of a string.</p>
<p><b>Tip:</b> Use the Len function to find the number of characters in a string.</p>
<p><b>Tip:</b> Also look at the Left function.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>string</td>
    <td>   Required. The string to return characters 
    from</td>
  </tr>
  <tr>
    <td>length</td>
    <td>   Required. Specifies how many characters to return. If 
    set to 0, an empty string (&quot;&quot;) is returned. If set to greater than or equal 
    to the length of the string, the entire string is returned</td>
  </tr>
  </table>
...
response.write(Right(txt,10))<br>
<br>
%&gt;
</div>
...
<div class="example_code notranslate">
tiful day!</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_right_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<p>Return the whole string:</p>
<div class="example_code notranslate">
&lt;%<br><br>
txt=&quot;This is a beautiful day!&quot;<br>
x=Len(txt)<br>
response.write(Right(txt,x))<br>
<br>
%&gt;
</div>
<p>The output of the code above will be:</p>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_right_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_right.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_right.asp#top" target="_top">TOP</a> |
		<a href="func_right.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
