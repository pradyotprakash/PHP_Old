...
<html lang="en-US">
<head>
<title>VBScript Rnd Function</title>
<style>a.menu_func_rnd{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">Rnd</span> Function</h1>
<hr>
...
<p>The Rnd function returns a random number. The number is always less than 1 
but greater or equal to 0.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>number</td>
    <td>   Optional. A valid numeric expression<p>If number is:</p>
    <ul>
...
<p>Note that you will get the same number every time. To avoid this, use the Randomize statement like in Example 2</p>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
0.7055475
</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_rnd_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<p>To avoid getting the same number every time, like in Example 1, use the Randomize statement:</p>
<div class="example_code notranslate">
&lt;%<br><br>
Randomize<br>
response.write(Rnd)<br>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_rnd_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<p>Here is how to produce random integers in a given range:
</p>
<div class="example_code notranslate">
&lt;%<br><br>
Dim max,min<br>
...
min=1<br>
Randomize<br>
response.write(Int((max-min+1)*Rnd+min))<br>
<br>
%&gt;
</div>
<p>The output of the code above will be:</p>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_rnd_func3" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_rnd.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_rnd.asp#top" target="_top">TOP</a> |
		<a href="func_rnd.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
