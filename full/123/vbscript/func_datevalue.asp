...
<style>a.menu_func_datevalue{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">DateValue</span> Function</h1>
<hr>
...
<p>The DateValue function converts a string to a Date.</p>
<p><b>Note:</b> If the year part of date is omitted this function will use the 
current year from the computer's system date.</p>
<p><b>Note:</b> If the date parameter includes time information it will not be 
returned. However, if date includes invalid time information, a run-time error 
will occur.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>date</td>
    <td>   Required. A date from January 1, 100 through December 
    31, 9999 or any expression that can represent a date, a time, or both a date 
    and time</td>
  </tr>
  </table>
<h2>Example</h2>
...
&lt;%<br><br>
response.write(DateValue(&quot;31-Jan-10&quot;))<br>
response.write("&lt;br /&gt;")<br>
response.write(DateValue(&quot;31-Jan&quot;))<br><br>
%&gt;
</div>
...
1/31/2010<br>
1/31/2010</div>
<br><a target="_blank" href="showasp.asp?filename=demo_vb_datevalue_func" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_datevalue.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_datevalue.asp#top" target="_top">TOP</a> |
		<a href="func_datevalue.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
