...
<html lang="en-US">
<head>
<title>VBScript RGB Function</title>
<style>a.menu_func_rgb{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>VBScript <span class="color_h1">RGB</span> Function</h1>
<hr>
...
<p>The RGB function returns a number that represents an RGB color value.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>red</td>
    <td>   Required. A number from 0 to 255, inclusive, representing the red 
    component of the color</td>
  </tr>
  <tr>
    <td>green</td>
    <td>   Required. A number from 0 to 255, inclusive, representing the 
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_rgb_func" class="tryitbtn">Show Example &raquo;</a>
</div>
<br>
<div class="example">
...
<div class="example_code notranslate">
&lt;%<br><br>
response.write(rgb(255,30,30))<br>
<br>
%&gt;
</div>
<p>The output of the code above will be:</p>
...
<br><a target="_blank" href="showasp.asp?filename=demo_vb_rgb_func2" class="tryitbtn">Show Example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_rgb.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_rgb.asp#top" target="_top">TOP</a> |
		<a href="func_rgb.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
