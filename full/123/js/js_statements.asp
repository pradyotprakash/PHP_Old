...
<style>a.menu_js_statements{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_whereto.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_comments.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">JavaScript is a sequence of statements to be executed by the browser.</p>
<hr>

<h2>JavaScript Statements</h2>
<p>JavaScript statements are &quot;commands&quot; to the browser.</p>
<p>The purpose of 
the statements is to tell the browser what to do.</p>
<p>This JavaScript statement tells the browser to write &quot;Hello Dolly&quot; 
inside 
an HTML element with id=&quot;demo&quot;:</p>

<div class="code notranslate"><div>
document.getElementById(&quot;demo&quot;).innerHTML=&quot;Hello Dolly&quot;;</div></div>
<br>
<hr>

<h2>Semicolon ;</h2>

<p>Semicolon separates JavaScript statements.</p>
<p>Normally you add a semicolon at the end of each executable statement. </p>
<p>Using semicolons 
also makes it possible to write many statements on one line. </p>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
You might see examples without semicolons. <br>
Ending statements with semicolon is optional in JavaScript.</td>
</tr></table>
<br>
<hr>
...
<p>This example will manipulate two HTML elements:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
document.getElementById(&quot;demo&quot;).innerHTML=&quot;Hello Dolly&quot;;<br>document.getElementById(&quot;myDIV&quot;).innerHTML=&quot;How 
	are you?&quot;;<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_statements" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>Blocks start with a left curly bracket, and end with a right curly bracket.</p>
<p>The purpose of a block is to make the sequence of statements execute together. </p>
<p>A good example of statements grouped together in blocks, are JavaScript <strong>
functions</strong>. </p>
<p>This example will run a function that will manipulate two HTML elements:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_blocks" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>You will learn more about functions in later chapters.</p>
<hr>
<h2>JavaScript is Case Sensitive</h2>
<p>JavaScript is case sensitive.</p>
<p>Watch your capitalization closely when you write JavaScript statements:</p>
<p>A function getElementById is not the same as getElementbyID.<br>
</p>
<p>A variable named myVariable is not the same as MyVariable.</p>
<hr>
...
<p>You can break up a code line <b>within a text string</b> with a backslash. The example below will be displayed properly:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_statements.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_statements.asp#top" target="_top">TOP</a> |
		<a href="js_statements.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
