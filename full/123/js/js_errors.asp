...
<html lang="en-US">
<head>
<title>JavaScript Errors Try Catch Throw</title>
<style>a.menu_js_errors{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_break.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_form_validation.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>When the JavaScript engine is executing JavaScript code, different errors can 
occur:</p>
<p>It can be syntax errors, typically coding errors or typos made by the 
programmer.</p>
<p>It can be misspelled or missing features in the language (maybe due to 
browser differences).</p>
<p>It can be errors due to wrong input, from a user, or from an Internet server.</p>
<p>And, of course, it can be many other unforeseeable things.</p>
<hr>

<h2>JavaScript Throws Errors</h2>
<p>When an error occurs, when something goes wrong, the JavaScript engine will 
normally stop, and generate an error message.</p>
<p>The technical term for this is: JavaScript will <strong>throw</strong> an 
error.</p>
<hr>
...
<h2>Examples</h2>
<p>In the example below we have deliberately made a typo in the code in the try 
block.</p>
<p>The catch block catches the error in the try block, and executes code 
to handle it:</p>
...
&lt;/body&gt;<br><br>
&lt;/html&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_try_catch" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>The correct technical term is to create or <strong>throw an exception</strong>.</p>
<p>If you use the throw statement together with try and catch, you can control program 
flow and generate custom error messages.</p>

<h3><strong>Syntax</strong></h3>
<div class="code notranslate"><div>
throw <i>exception</i></div></div>

<p>The exception can be a JavaScript String, a Number, a Boolean or an Object.</p>

<h2>Example</h2>
<p>This example examines the value of an input variable. If the value is wrong, 
an exception (error) is thrown.
The error is caught by the catch statement and a custom error message is displayed:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;script&gt;<br>function myFunction()<br>{<br>var y=document.getElementById(&quot;mess&quot;);<br>y.innerHTML=&quot;&quot;;<br>try<br>&nbsp; { <br>&nbsp; var x=document.getElementById(&quot;demo&quot;).value;<br>&nbsp; if(x==&quot;&quot;)&nbsp;&nbsp;&nbsp; 
	throw &quot;empty&quot;;<br>&nbsp; if(isNaN(x)) throw &quot;not a 
	number&quot;;<br>&nbsp; if(x&gt;10)&nbsp;&nbsp;&nbsp;&nbsp; throw &quot;too high&quot;;<br>&nbsp; if(x&lt;5)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	throw &quot;too low&quot;;<br>&nbsp; }<br>catch(err)<br>&nbsp; {<br>&nbsp; y.innerHTML=&quot;Error: 
	&quot; + err + &quot;.&quot;;<br>&nbsp; }<br>}<br>&lt;/script&gt;<br><br>&lt;h1&gt;My First 
	JavaScript&lt;/h1&gt;<br>&lt;p&gt;Please input a number between 5 and 10:&lt;/p&gt;<br>&lt;input 
	id=&quot;demo&quot; type=&quot;text&quot;&gt;<br>&lt;button type=&quot;button&quot; onclick=&quot;myFunction()&quot;&gt;Test 
	Input&lt;/button&gt;<br>&lt;p id=&quot;mess&quot;&gt;&lt;/p&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_throw_error" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Note that the example above will also throw an error if the getElementById 
function fails.</p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_errors.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_errors.asp#top" target="_top">TOP</a> |
		<a href="js_errors.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
