...
<style>a.menu_js_window{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_htmldom_nodelist.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_window_screen.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>The <strong>window</strong> object is supported by all browsers. It represent 
...
<h2>Window Size</h2>
<p>Three different properties can be used to determine the size of the browser 
window (the browser viewport, NOT including toolbars and scrollbars).</p>
<p>For Internet Explorer, Chrome, Firefox, Opera, and Safari:</p>
<ul>
	<li>window.innerHeight - the inner height of the browser window</li>
	<li>window.innerWidth - the inner width of the browser window</li>
</ul>
...
<div class="example_code notranslate">
	var w=window.innerWidth<br>|| document.documentElement.clientWidth<br>|| 
	document.body.clientWidth;<br><br>var h=window.innerHeight<br>|| 
	document.documentElement.clientHeight<br>|| document.body.clientHeight; </div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_win_inner" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_window.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_window.asp#top" target="_top">TOP</a> |
		<a href="js_window.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
