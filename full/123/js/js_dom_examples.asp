...
<html lang="en-US">
<head>
<title>JavaScript HTML DOM Examples</title>
<style>a.menu_js_dom_examples{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">HTML DOM</span> Examples</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_ex_objects.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_input_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_text">Write text to the output with document.write()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_formattext">Write formatted text to the output with document.write()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_anchors">Return the number of anchors in a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_anchors2">Return the innerHTML of the first anchor in a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_forms">Return the number of forms in a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_forms2">Return the name of the first form in a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_images">Return the number of images in a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_images2">Return the id of the first image in a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_links">Return the number of links in a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_links2">Return the id of the first link in a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_cookie">Return all name/value pairs of cookies in a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_domain">Return the domain name of the server that loaded the document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_lastmodified">Return the date and time the document was last modified</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_referrer">Return the URL of the document that loaded the current document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_title">Return the title of a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_url">Return the full URL of a document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_open">Open an output stream, and add some text</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_open2">Open an output stream in a new window, and add some text</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_writeln">Difference between write() and writeln()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_getelementbyid">Alert innerHTML of an element with a specific ID</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_getelementsbyname">Alert the number of elements with a specific name</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_doc_getelementsbytagname">Alert the number of elements with a specific tagname</a>
</p>
<p><b><a href="js_htmldom.asp">Document Object Explained</a></b></p>

<hr>

<h2>CSS Manipulation</h2>
<p>
<a href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_visibility" target="_blank">Change the 
visibility of an HTML element</a><br>
<a href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_css_bgcolor" target="_blank">Change the background color 
of an HTML element</a>
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_dom_examples.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_dom_examples.asp#top" target="_top">TOP</a> |
		<a href="js_dom_examples.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
