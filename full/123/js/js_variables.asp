...
<style>a.menu_js_variables{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_comments.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_datatypes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">JavaScript variables are &quot;containers&quot; for storing information:</p>

<div class="example">
<h2 class="example_head">Example</h2>
	<div class="example_code notranslate">
		var x=5;<br>var y=6;<br>
var z=x+y;<br>
</div>
<br>
<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_data1" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
y=6<br>
z=x+y</p>
<p>In algebra we use letters (like x) to hold values (like 5).</p>
<p>From the expression z=x+y above, we can calculate the value of z to be 11.</p>
<p>In JavaScript these letters are called <b>variables.</b> </p>
...
<p>As with algebra, JavaScript variables can be used to hold values 
(x=5) or expressions (z=x+y).</p>

<p>Variable can have short names (like x and y) or more descriptive names (age, sum, totalvolume).</p>
<ul>
  <li>Variable names must begin with a letter</li>
	<li>Variable names can also begin with $ and _ (but we will not use it) </li>
...
<p>JavaScript variables can also hold other types of data, like text values 
(person=&quot;John 
Doe&quot;).</p>
<p>In JavaScript a text like &quot;John Doe&quot; is called a string.</p>
<p>There are many types of JavaScript variables, but for now, just think of numbers and strings. </p>

<p>When you assign a text value to a variable, put double or single quotes around the value.</p>

<p>When you assign a numeric value to a variable, do not put quotes around the value. 
If you put quotes around a numeric value, it will be treated as text.</p>

<div class="example">
<h2 class="example_head">Example</h2>
<div class="example_code notranslate">
	var pi=3.14;<br>var person=&quot;John Doe&quot;;<br>var answer='Yes I am!';<br>
</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_data2" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Declaring (Creating) JavaScript Variables</h2>
<p>Creating a variable in JavaScript is most often referred to as &quot;declaring&quot; a variable. </p>
<p>You declare JavaScript variables with the <b>var</b> keyword:</p>
...
<p>After the declaration, the variable is empty (it has no value).</p>
...
<p>However, you can also assign a value to the variable when you declare it:</p>

<div class="code notranslate"><div>
var carname=&quot;Volvo&quot;;</div></div>

<p>In the example below we create a variable called carname, assigns the value 
&quot;Volvo&quot; to it, and put the value inside the HTML paragraph with id=&quot;demo&quot;:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_variables1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
It's a good programming practice to declare all the variables you will need, in 
one place, at the beginning of your code.
</td>
</tr></table>
<br>
<hr>
...
<p>You can declare many variables in one statement. Just start the statement 
with <b>var</b> and separate the variables by comma:</p>
...
<p>Your declaration can also span multiple lines: </p>
...
later, like user input. Variable declared without a value will have the value <b>
undefined</b>.</p>
<p>The variable <i>carname</i> will have the value <i>undefined</i> after the execution of the following statement:</p>
<div class="code notranslate">
<div>
var carname;</div>
</div>
...
<p>The value of the variable <i>carname</i> will still have the value &quot;<i>Volvo</i>&quot; after the execution of the following two statements:</p>
<div class="code notranslate">
<div>
var
carname="Volvo"; <br>
...
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_add" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>You will learn more about JavaScript operators in a later chapter of this tutorial.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_comments.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_datatypes.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_variables.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_variables.asp#top" target="_top">TOP</a> |
		<a href="js_variables.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
