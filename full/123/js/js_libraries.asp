...
<style>a.menu_js_libraries{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">Libraries</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_cookies.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_lib_jquery.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">JavaScript libraries - jQuery, Prototype, MooTools.</p>
<hr>

<h2>JavaScript Frameworks (Libraries)</h2>
<p>Advanced JavaScript programming (especially the complex handling of browser 
differences), can often be very difficult and time-consuming to work with.</p>
<p>To deal with these difficulties, a lot of <strong>JavaScript (helper) 
libraries</strong> have been developed.</p>
<p>These JavaScript libraries are often called <strong>JavaScript frameworks</strong>.</p>
<p>In this tutorial, we will take a look at some of the most popular JavaScript 
frameworks:</p>
<ul>
	<li>jQuery</li>
	<li>Prototype</li>
...
<p>All of these frameworks have functions for common JavaScript tasks like 
animations, DOM manipulation, and Ajax handling.</p>
<p>In this tutorial we will teach you how start using them, to make JavaScript 
programming easier, safer, and much more exciting.</p>
<hr>

<h2>jQuery</h2>
<p><strong>jQuery</strong> is the most popular JavaScript framework on the 
Internet today.</p>
<p>It uses CSS selectors to access and manipulate HTML elements (DOM Objects) on 
a web page. </p>
<p>jQuery also provides a companion UI (user interface) framework and numerous 
other plug-ins.</p>
<p>Many of the largest companies on the Web use jQuery:</p>
<ul>
	<li>Google</li>
	<li>Microsoft</li>
	<li>IBM</li>
...
<p>You will find an excellent <a href="../jquery/default.asp">jQuery Tutorial</a> here at W3Schools.</p>
<hr>

<h2>Prototype</h2>
<p><strong>Prototype</strong> is a JavaScript library that provides a simple API 
to perform common web tasks.</p>
<p><strong>API</strong> is short for Application Programming Interface. It is a 
library of properties and methods for manipulating the HTML DOM.</p>
<p>Prototype enhances JavaScript by providing classes and inheritance.</p>
<hr>

<h2>MooTools</h2>
<p><strong>MooTools</strong> is also a framework that offers an API to make 
common JavaScript programming easier.</p>
<p>MooTools also includes some lightweight effects and animation functions.</p>
<hr>

<h2>Other Frameworks</h2>
<p>Here are some other frameworks not covered in this short overview:</p>
<p><strong>YUI</strong>  - The Yahoo! User Interface Framework is a large library 
that covers a lot of functions, from simple JavaScript utilities to complete 
internet widgets.</p>
<p><strong>Ext JS</strong> - Customizable widgets for building rich Internet 
applications.</p>
<p><strong>Dojo</strong> - A toolkit designed around packages for DOM 
manipulation, events, widgets, and more.</p>
<p><strong>script.aculo.us</strong> - Open-source JavaScript framework for visual 
effects and interface behaviors.</p>
<p><strong>UIZE</strong> - Widgets, AJAX, DOM, templates, and more.</p>
<hr>

<h2>CDN - Content Delivery Networks</h2>
<p>You always want your web pages to be as fast as possible. You want to keep 
the size of your pages as small as possible, and you want the browser to cache 
as much as possible.</p>
<p>If many different web sites use the same JavaScript framework, it makes sense 
to host the framework library in a common location for every web page to share.</p>
<p>A CDN (Content Delivery Network) solves this. A CDN is a network of servers 
containing shared code libraries.<br>
<br>
Google provides a free CDN for a number of JavaScript libraries, including:</p>
<ul>
	<li>jQuery</li>
	<li>Prototype</li>
	<li>MooTools</li>
...
<p>To use a JavaScript framework library in your web pages, just  
include the library in a &lt;script&gt; tag:</p>
...
<p>Before you decide to use a JavaScript framework for your web pages, it might 
be a good idea to test the framework first.</p>
<p>JavaScript frameworks are very easy to test. You don't have to install them 
on your computer, and there are no setup programs. </p>
<p>Normally you just have to reference a library file from your web page. </p>
<p>In the next chapter of this tutorial we will walk you through a test process 
for jQuery.</p>
<p>
<br>
</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_libraries.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_libraries.asp#top" target="_top">TOP</a> |
		<a href="js_libraries.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
