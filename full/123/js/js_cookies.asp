...
<style>a.menu_js_cookies{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="js_libraries.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>JavaScript can create cookies, read cookies, and delete cookies with the property <strong>document.cookie</strong>.</p>
...
<p>You can also add an expiry date (in UTC or GMT time).
...
<td>document.cookie will return all cookies in one string much like: cookie1=value; cookie2=value; cookie3=value;</td>
</tr></table>
<br>
<hr>
...
<p>The document.cookie property look like a normal text string. But is it not.</p>
...
<button type="button" onclick="document.cookie='firstname=John'">Create Cookie 1</button>&nbsp;
<button type="button" onclick="document.cookie='lastname=Smith'">Create Cookie 2</button>
<button type="button" onclick="document.cookie='firstname=John;expires=-1'">Delete Cookie 1</button>&nbsp;
<button type="button" onclick="document.cookie='lastname=Smith;expires=-1'">Delete Cookie 2</button>
...
<div class="code notranslate" style="color: #404040"><div>
	function setCookie(cname,cvalue,exdays)<br>{<br>
	var d = new Date();<br>d.setTime(d.getTime()+(exdays*24*60*60*1000));<br>var 
	expires = &quot;expires=&quot;+d.toGMTString();<br>document.cookie = 
	cname + &quot;=&quot; + cvalue + &quot;; &quot; + expires;<br>}
</div></div>
...
&nbsp; {<br>
&nbsp; var c = ca[i].trim();<br>
&nbsp; if (c.indexOf(name)==0) return c.substring(name.length,c.length);<br>&nbsp; }<br>
return &quot;&quot;;<br>
}
</div>
</div>
...
<div class="code notranslate"><div>
function checkCookie()<br>{<br>var 
username=getCookie(&quot;username&quot;);<br>if (username!=&quot;&quot;)<br>&nbsp; {<br>&nbsp; 
alert(&quot;Welcome again &quot; + username);<br>&nbsp; }<br>else <br>&nbsp; {<br>&nbsp; 
username = prompt(&quot;Please enter your name:&quot;,&quot;&quot;);<br>&nbsp; if (username!=&quot;&quot; 
	&amp;&amp; username!=null)<br>&nbsp;&nbsp;&nbsp; 
{<br>&nbsp;&nbsp;&nbsp; setCookie(&quot;username&quot;,username,365);<br>&nbsp;&nbsp;&nbsp; 
}<br>&nbsp; }<br>}
</div>
</div>
<br>
...
<div class="example_code notranslate">
	&lt;function setCookie(cname,cvalue,exdays)<br>{<br>var d = new Date();<br>
	d.setTime(d.getTime()+(exdays*24*60*60*1000));<br>var expires = &quot;expires=&quot;+d.toGMTString();<br>document.cookie = cname + &quot;=&quot; + cvalue + 
	&quot;; &quot; + expires;<br>
	}<br><br>function getCookie(cname)<br>{<br>var name = cname + &quot;=&quot;;<br>var ca 
	= document.cookie.split(';');<br>for(var i=0; i&lt;ca.length; i++) <br>&nbsp; {<br>&nbsp; 
	var c = ca[i].trim();<br>&nbsp; if (c.indexOf(name)==0) return 
	c.substring(name.length,c.length);<br>}<br>return &quot;&quot;;<br>}<br><br>function 
	checkCookie()<br>{<br>var user=getCookie(&quot;username&quot;);<br>if (user!=&quot;&quot;)<br>&nbsp; 
	{<br>&nbsp; alert(&quot;Welcome again &quot; + user);<br>&nbsp; }<br>else <br>&nbsp; {<br>&nbsp; 
	user = prompt(&quot;Please enter your name:&quot;,&quot;&quot;);<br>&nbsp; if (user!=&quot;&quot; &amp;&amp; 
	user!=null)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
	setCookie(&quot;username&quot;,user,365);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}<br>
<br>
&lt;body onload=&quot;checkCookie()&quot;&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_cookie_username" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_cookies.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_cookies.asp#top" target="_top">TOP</a> |
		<a href="js_cookies.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
