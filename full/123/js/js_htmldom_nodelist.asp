...
<html lang="en-US">
<head>
<title>JavaScript HTML DOM Nodelist</title>
<style>a.menu_js_htmldom_nodelist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">HTML DOM Nodelist</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_htmldom_nodes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_window.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A nodelist is an array of nodes (like an array of all HTML 
elements)</p>
<hr>

<h2>HTML DOM Node List</h2>
<p>The getElementsByTagName() method returns a <b>node list</b>. A node list is an 
array of nodes.</p>
...
<p>The nodes can be accessed by index number. To access the 
second &lt;p&gt; you can write:</p>
<div class="example_code notranslate">
y=x[1];
</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_nodelist" target="_blank">Try it yourself &raquo;</a>
</div>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
x=document.getElementsByTagName(&quot;p&quot;);<br>
<br>
...
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_nodelist_length" target="_blank">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_htmldom_nodelist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_htmldom_nodelist.asp#top" target="_top">TOP</a> |
		<a href="js_htmldom_nodelist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
