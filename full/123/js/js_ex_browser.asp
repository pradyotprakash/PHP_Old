...
<html lang="en-US">
<head>
<title>JavaScript Browser Object Examples</title>
<style>a.menu_js_ex_browser{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">Browser Objects</span> Examples</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_events_examples.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_quiz.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Examples of using JavaScript to access and manipulate the Browser objects.</p>
<hr>

<h2>Window Object</h2>
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_alert">Display an alert box</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_alert2">Display an alert box with line-breaks</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_confirm">Display a confirm box, and alert what the visitor clicked</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_prompt">Display a prompt box</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_window_popup">Create a pop-up window</a>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_openwindow">Open a new window when clicking on a button</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_openallwindow">Open a new window and control its appearance</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_multiwindows">Open multiple new windows</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_win_blur">Assure that the new window does NOT get focus (send it to the background)</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_win_focus">Assure that the new window GETS focus</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_win_close">Close the new window</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_win_closed">Checks whether the new window has been closed or not</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_win_name">Return the name of the new window</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_win_opener">Write some text to the source (parent) window</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_win_moveby">Move the new window relative to its current position</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_win_moveto">Move the new window to the specified position</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_print">Print the current page</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_window_resizeby">Resize a window by the specified pixels</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_window_resizeto">Resize a window to a specified size</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_window_scrollby">Scroll the content by the specified number of pixels</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_window_scrollto">Scroll the content to a specified position</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_timing2">A simple timing</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_timing_stop">Set and stop a timer with setTimeout() and clearTimeout()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_setinterval">Set and stop a timer with setInterval() and clearInterval()</a>
</p>
<p>More Window object examples in our <a href="../jsref/obj_window.asp">JavaScript reference</a>.</p>

<h2>Navigator Object</h2>
<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_nav_all">All details about the visitor's browser</a></p>
<p>More Navigator object examples in our <a href="../jsref/obj_navigator.asp">JavaScript reference</a>.</p>

<h2>Screen Object</h2>
<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_screen_all">All details about the visitor's screen</a></p>
<p>More Screen object examples in our <a href="../jsref/obj_screen.asp">JavaScript reference</a>.</p>

<h2>History Object</h2>
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_his_length">Return the number of URLs in the history list</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_his_back">Create a back button on a page</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_his_forward">Create a forward button on a page</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_his_go">Load a specific URL from the history list</a>
</p>
<p>More History object examples in our <a href="../jsref/obj_history.asp">JavaScript reference</a>.</p>

<h2>Location Object</h2>
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_loc_host">Return the hostname and port of the current URL</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_loc_href">Return the entire URL of the current page</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_loc_pathname">Return the path name of the current URL</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_loc_protocol">Return the protocol portion of the current URL</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_loc_assign">Load a new document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_loc_reload">Reload the current document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_loc_replace">Replace the current document</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_breakout">Break out of a frame</a>
</p>
<p>More Location object examples in our <a href="../jsref/obj_location.asp">JavaScript reference</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_ex_browser.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_ex_browser.asp#top" target="_top">TOP</a> |
		<a href="js_ex_browser.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
