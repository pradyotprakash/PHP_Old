...
<style>a.menu_js_summary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>You Have Learned JavaScript, <span class="color_h1">Now What?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_exam.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="../jsref/default.asp">JavaScript References &raquo;</a></div>
</div>
<hr>
<h2>JavaScript Summary</h2>
<p>This tutorial has taught you how to add JavaScript to your HTML pages, to make 
your web site more dynamic and interactive.</p>
<p>You have learned how to create responses to events, validate forms and how to 
make different scripts run in response to different scenarios.</p>
<p>You have also learned how to create and use objects, and how to use JavaScript's built-in objects.</p>
<p>For more information on JavaScript, please look at our
<a href="js_examples.asp">JavaScript examples</a> and our
<a href="../jsref/default.asp">JavaScript reference</a>.</p>
<hr>
<h2>Now You Know JavaScript, What's Next?</h2>
<p>The next step is to learn about the HTML DOM, jQuery, and AJAX.</p>
<p>If you want to learn about server-side scripting, the next step is to learn 
ASP</p>

<p><b>jQuery</b></p>
<p>jQuery is a JavaScript Library.</p>
<p>jQuery greatly simplifies JavaScript programming.</p>
<p>If you want to learn more about jQuery, please visit our
<a href="../jquery/default.asp">jQuery tutorial</a>.</p>
...
<p>AJAX is about exchanging data with a server, and update parts of a web page 
- without reloading the whole page.</p>
<p>Examples of applications using AJAX: Google Maps, Gmail, Youtube, and Facebook 
tabs.</p>
<p>If you want to learn more about AJAX, please visit our
<a href="../ajax/default.asp">AJAX tutorial</a>.</p>

<p><b>ASP / PHP / .NET</b></p>


<p>In this tutorial we have created dynamic web pages by using 
scripts on the client (in the browser).</p>
<p>Web pages can also be made more dynamic by using scripts on the server. </p>
<p>With server-side scripting you can edit, add, or change any web page content. You 
...
<p><a href="../website/web_php_demo.asp">PHP Demo/Tutorial</a></p>
<p><a href="../website/web_asp_demo.asp">ASP Demo/Tutorial</a></p>
<p><a href="../website/webpages_demo.asp">.NET Demo/Tutorial</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_summary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_summary.asp#top" target="_top">TOP</a> |
		<a href="js_summary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
