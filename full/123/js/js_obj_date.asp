...
<style>a.menu_js_obj_date{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">Date</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_obj_string.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_obj_array.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_date">Return today's date and time</a><br>
How to use the Date() method to get today's date.</p>
		
<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_getfullyear">getFullYear()</a><br>
Use getFullYear() to get the year.</p>

<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_gettime">getTime()</a><br>
getTime() returns the number of milliseconds since 01.01.1970.</p>

<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_setfullyear2">setFullYear()</a><br>
How to use setFullYear() to set a specific date.</p>

<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_toutcstring">toUTCString()</a><br>
How to use toUTCString() to convert today's date (according to UTC) to a string.</p>

<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_date_weekday">getDay()</a><br>
Use getDay() and an array to write a weekday, and not just a number.</p>

<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_timing_clock">Display a clock</a><br>
How to display a clock on your web page.</p>
<hr>

<h2>Complete Date Object Reference</h2>
<p>For a complete reference of all the properties and methods that can be used with the Date object,
go to our <a href="../jsref/jsref_obj_date.asp">complete Date object reference</a>.</p>
...
<p>There are four ways of initiating a date:</p>

<div class="code notranslate"><div>

new Date() // current date and time<br>
new Date(milliseconds) //milliseconds since 1970/01/01<br>
new Date(dateString)<br>
new Date(year, month, day, hours, minutes, seconds, milliseconds)</div></div>

<p>Most parameters above are optional. Not specifying, causes 0 to be passed in.</p>
<p>Once a Date object is created, a number of methods allow you to operate on 
it. Most methods allow you to get and set the year, month, day, hour, 
minute, second, and milliseconds of the object, using either local time or UTC 
...
<p>Some examples of initiating a date:</p>
...
var
d3 = new Date(79,5,24,11,33,0)</div></div>
<br>
<hr>
...
myDate.setFullYear(2010,0,14);</div></div>
...
var myDate=new Date();<br>
myDate.setDate(myDate.getDate()+5);</div></div>

<p><b>Note:</b> If adding five days to a date shifts the month or year, the changes are handled automatically by the Date object itself!</p>
<hr>
...
var x=new Date();<br>
x.setFullYear(2100,0,14);<br>var today = new Date();<br><br>
if (x&gt;today)<br>
&nbsp;
{<br>
&nbsp;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_obj_date.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_obj_date.asp#top" target="_top">TOP</a> |
		<a href="js_obj_date.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
