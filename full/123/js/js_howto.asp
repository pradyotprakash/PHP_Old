...
<style>a.menu_js_howto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">How To</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_whereto.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">JavaScripts in HTML must be inserted between &lt;script&gt; and &lt;/script&gt; tags.</p>
<p class="intro">JavaScripts can be put in the &lt;body&gt; and in the &lt;head&gt; section of 
an HTML page.</p>
<hr>

<h2>The &lt;script&gt; Tag</h2>
<p>To insert a JavaScript into an HTML page, use the &lt;script&gt; tag.</p>

<p>The &lt;script&gt; and &lt;/script&gt; tells where the JavaScript starts and ends.</p>
<p>The lines between the &lt;script&gt; and &lt;/script&gt; contain the JavaScript:</p>
...
<span class="marked">
	&lt;script&gt;<br>
alert(&quot;My First JavaScript&quot;);<br>
&lt;/script&gt;</span></div>
</div>
<p>You
don't have to understand the code above. Just take it for a fact, that the browser will interpret 
and execute the JavaScript code between the &lt;script&gt; and &lt;/script&gt; tags.&nbsp;
</p>
<table class="lamp"><tr>
...
no longer required. JavaScript is the default scripting language 
in all modern browsers and in HTML5. </td>
</tr></table>
<br>
<hr>
...
<p>In this example, JavaScript writes into the HTML &lt;body&gt; while the page loads:</p>
...
.<br>
.<br>
<span class="marked">&lt;script&gt;<br>
document.write(&quot;&lt;h1&gt;This is a heading&lt;/h1&gt;&quot;);<br>document.write(&quot;&lt;p&gt;This is a paragraph&lt;/p&gt;&quot;);<br>
&lt;/script&gt;<br>
</span>.<br>
.<br>
&lt;/body&gt;<br>
...
<p>The JavaScript statements, in the example above, are executed while the page 
loads.</p>
<p>More often, we want to execute code when an <b>event</b> occurs, like when 
the user clicks a button.</p>
<p>If we put JavaScript code 
inside a <b>function</b>, we can call that function when an event occurs.</p>
<p>You will learn much more about JavaScript functions and events in later chapters.</p>
<hr>

<h2>JavaScript in &lt;head&gt; or &lt;body&gt;</h2>
<p>You can place an unlimited number of scripts in an HTML document.</p>
<p>Scripts can be in the &lt;body&gt; or in the &lt;head&gt; section of HTML, 
and/or in both.</p>
<p>It is a common practice to put functions in the &lt;head&gt; section, or at the 
bottom of the page. This way they are all in one place and do not interfere with 
page content.</p>
<hr>

<h2>A JavaScript Function in &lt;head&gt;</h2>

<p>In this example, a JavaScript function is placed in the &lt;head&gt; section 
of an HTML page.</p>
<p>The function is called when a button is clicked:</p>
...
document.getElementById(&quot;demo&quot;).innerHTML=&quot;My 
	First JavaScript Function&quot;;<br>
}<br>
&lt;/script&gt;</span><br>
&lt;/head&gt;</p>
<p>&lt;body&gt;</p>
<p>&lt;h1&gt;My Web Page&lt;/h1&gt;</p>
<p>&lt;p id=&quot;demo&quot;&gt;A Paragraph&lt;/p&gt;</p>
<p>&lt;button type=&quot;button&quot; <span class="marked">onclick=&quot;myFunction()&quot;</span>&gt;Try 
it&lt;/button&gt;</p>
<p>&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_whereto_head" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>A JavaScript Function in &lt;body&gt;</h2>

<p>In this example, a JavaScript function is placed in the &lt;body&gt; section 
of an HTML page.</p>
<p>The function is called when a button is clicked:</p>
...
<p>&lt;h1&gt;My Web Page&lt;/h1&gt;</p>
<p>&lt;p id=&quot;demo&quot;&gt;A Paragraph&lt;/p&gt;</p>
<p>&lt;button type=&quot;button&quot; onclick=&quot;<span class="marked">myFunction()</span>&quot;&gt;Try 
it&lt;/button&gt;</p>
	<p>
<span class="marked">&lt;script&gt;<br>
	function myFunction()<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_whereto_body">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>External JavaScripts</h2>
<p>Scripts can also be placed in external files. External files often contain code to be used 
by several different 
web pages. </p>
<p>External JavaScript files have the file extension .js.</p>
<p>To use an external script, point to the .js file in the &quot;src&quot; attribute of the &lt;script&gt; tag:</p>
...
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
&lt;body&gt;<br>
<span class="marked">&lt;script src=&quot;myScript.js&quot;&gt;&lt;/script&gt;</span><br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_externalexample" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>You can place the script in the &lt;head&gt; or &lt;body&gt; as you like. The script will 
behave as if it was located exactly where you put the &lt;script&gt; tag in the document.<br>
</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
External scripts cannot contain &lt;script&gt; tags.</td>
</tr></table>
<br>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_howto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_howto.asp#top" target="_top">TOP</a> |
		<a href="js_howto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
