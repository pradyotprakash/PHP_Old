...
<html lang="en-US">
<head>
<title>JavaScript HTML DOM Methods</title>
<style>a.menu_js_htmldom_methods{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_htmldom.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_htmldom_document.asp">Next Chapter &raquo;</a></div>
</div>
...
<h2>Example</h2>
<p>The following code gets the content (the innerHTML) of the &lt;p&gt; element with id=&quot;intro&quot;:</p>
<div class="example">
...
&lt;script&gt;<br>
var
txt=document.getElementById(&quot;intro&quot;).innerHTML;<br>
document.write(txt);<br>
&lt;/script&gt;<br><br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br><a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_dom_method" target="_blank">Try it yourself &raquo;</a>
</div>
...
element.</p>
<p>In the example above the getElementById method used id=&quot;intro&quot; to find the 
element.</p>
<hr>
...
<td>The innerHTML property can be used to get or change any HTML element, 
including &lt;html&gt; and &lt;body&gt;.</td>
</tr></table>
<br>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_htmldom_methods.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_htmldom_methods.asp#top" target="_top">TOP</a> |
		<a href="js_htmldom_methods.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
