...
<style>a.menu_js_quiz{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">Quiz Test</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_ex_browser.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_exam.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">You can test your JavaScript skills with W3Schools' Quiz.</p>
<hr>
<h2>The Test</h2>
<p>The test contains 20 questions and there is no time limit.</p>
<p>The test is not official, it's just a nice way to see how much you know, or don't know, about JavaScript.</p>
<hr>
<h2>Count Your Score</h2>
<p>You will get 1 point for each correct answer. At the end of the Quiz,
your total score will be displayed. Maximum score is 20 points.</p>
<p>Good luck! <a href="http://www.w3schools.com/quiztest/quiztest.asp?qtest=JavaScript" target="_top">Start the JavaScript Quiz</a></p>
<hr><div style="width:auto;margin:auto">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_quiz.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_quiz.asp#top" target="_top">TOP</a> |
		<a href="js_quiz.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
