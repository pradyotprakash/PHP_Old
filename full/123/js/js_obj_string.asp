...
<style>a.menu_js_obj_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">String</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_obj_number.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_obj_date.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The String object is used for storing and manipulating text.</p>
<hr>

<h2>JavaScript Strings</h2>
<p>A string simply stores a series of characters like &quot;John Doe&quot;.</p>
...
<p>You can access each character in a string with its position (index):</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<p>String indexes are zero-based, which means the first character is [0], the 
...
<p>Or you can put quotes inside a string by using the \ escape character:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
var answer='It\'s alright';<br>
var answer=&quot;He is called \&quot;Johnny\&quot;&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_datatypes_string">Try 
it yourself &raquo;</a></div>
<br>
<hr>
<h2>String Length</h2>
<p>The length of a string (a string object) is found in the built in property
<strong>length</strong>:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var txt=&quot;Hello World!&quot;;<br>document.write(txt.length);<br>
	<br>var txt=&quot;ABCDEFGHIJKLMNOPQRSTUVWXYZ&quot;;<br>document.write(txt.length);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_string_length">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Finding a String in a String</h2>
<p>The <strong>indexOf()</strong> method returns the position (as a number) of 
the first found occurrence of a specified text inside a string:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var str=&quot;Hello world, welcome to the universe.&quot;;<br>var n=str.indexOf(&quot;welcome&quot;);</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_string_indexof" target="_blank">Try it yourself &raquo;</a>
</div>
<p>The method returns -1 if the specified text is not found.</p>
<p>The lastIndexOf() method starts searching at the end of the string instead of 
at the beginning.</p>
<hr>

<h2>Matching Content</h2>
<p>The <strong>match()</strong> method can be used to search for a 
matching content in a string:</p>

<div class="example">
<h2 class="example">Example</h2>
	<div class="example_code notranslate">
		var str=&quot;Hello world!&quot;;<br>document.write(str.match(&quot;world&quot;) + &quot;&lt;br&gt;&quot;);<br>
	document.write(str.match(&quot;World&quot;) + &quot;&lt;br&gt;&quot;);<br>document.write(str.match(&quot;world!&quot;));</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_string_match" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Replacing Content</h2>
<p>The <strong>replace()</strong> method replaces a specified value 
with another value in a string.</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	str=&quot;Please visit Microsoft!&quot;<br>var n=str.replace(&quot;Microsoft&quot;,&quot;W3Schools&quot;);<br>
</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_string_replace" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>Upper Case and Lower Case</h2>
<p>A string is converted to upper/lower case with the methods <strong>toUpperCase() </strong>
/<strong> toLowerCase()</strong>:</p>
...
var txt=&quot;Hello World!&quot;;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // 
String<br>
var txt1=txt.toUpperCase();&nbsp;&nbsp; // txt1 is txt converted 
to upper<br>
var txt2=txt.toLowerCase();&nbsp;&nbsp; // txt2 is txt converted 
to lower</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_string_toupper" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>Convert a String to an Array</h2>
<p>A string is converted to an array with the built in 
method string.<strong>split()</strong>:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
txt=&quot;a,b,c,d,e&quot;&nbsp;&nbsp; // String<br>
txt.split(&quot;,&quot;);&nbsp;&nbsp; // Split on commas<br>txt.split(&quot; &quot;);&nbsp;&nbsp; // Split on 
	spaces<br>txt.split(&quot;|&quot;);&nbsp;&nbsp; // Split on pipe&nbsp;
</div>
<br>
<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_string_split" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>Special Characters</h2>
<p>The backslash (\) can be used to insert apostrophes, new lines, quotes, and other special characters into a string.</p>
<p>Look at the following JavaScript code:</p>

<div class="code notranslate"><div>

var txt=&quot;We are the so-called &quot;Vikings&quot; from the north.&quot;;<br>
...
<hr>
<h2>Strings Can be Strings or Objects</h2>

<p>JavaScript strings can be primitive values created from literals, like var 
x = &quot;John&quot;;</p>
<p>JavaScript strings can also be objects created with the new keyword, like var y = new 
String(&quot;John&quot;);</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var x = &quot;John&quot;;<br>var y = new String(&quot;John&quot;);<br>typeof(x) // returns 
	String<br>
	typeof(y) // returns Object</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_object_string_type" target="_blank">Try 
it yourself &raquo;</a></div>
<p>Normally, because of some nasty side effects, you will not define strings as 
objects.</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var x = &quot;John&quot;;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>var y = new 
	String(&quot;John&quot;);<br>(x === y) // 
	is false 
	because x is a string and y is an object.</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_object_string" target="_blank">Try 
it yourself &raquo;</a></div>
<p><strong>Note:</strong> Primitive values, like &quot;John&quot;, cannot have properties 
or methods (because they are not objects). </p>
<p>With JavaScript, all methods and properties of the string object are also available to 
primitive values, because Javascript will temporarily transfer primitive values 
to objects before executing the methods or properties.</p>
<hr>
...
<h2>Complete String Object Reference</h2>
<p>For a complete reference of all the properties and methods that can be used with the String object,
go to our <a href="../jsref/jsref_obj_string.asp">Complete String Object Reference</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_obj_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_obj_string.asp#top" target="_top">TOP</a> |
		<a href="js_obj_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
