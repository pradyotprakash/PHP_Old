...
<div class="next"><a class="chapter" href="js_intro.asp">Next Chapter &raquo;</a></div>
</div>
<br>
<div class="tutintro">
<img src="http://www.w3schools.com/images/w3javascript.gif" alt="JavaScript" />
<p>JavaScript is the scripting language of the Web.</p>
<p>All modern HTML pages are using JavaScript.</p>
	<p>This tutorial will teach you JavaScript from basic to advanced.</p>
</div>
<hr>
<h2>Try it Yourself Examples in Every Chapter</h2>
<p>In every chapter, you can edit examples online, and click on a button to view 
the result.</p>
<div class="example">
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_myfirst">Try it yourself &raquo;</a>
</div>
<p>Use the &quot;Try it yourself&quot; examples !!!</p>
<p>Experiment with the code examples !!!</p>
<p>Learn a lot about JavaScript in a very short time !!!</p>
<hr>
<h2>What You Should Already Know</h2>
<p>This tutorial is about JavaScript and how it works with HTML and CSS.</p>
<p>Therefore, before you continue, you should have a basic understanding of the following:</p>
<ul>
	<li>HTML and CSS</li>
</ul>
<hr>
<h2>JavaScript Examples</h2>
<p>This tutorial contains hundreds of examples!</p>
<p>With &quot;Try it yourself&quot;, you can edit the source code and click on a
button to view the result.</p>
<ul>
<li><a href="js_examples.asp">JavaScript Basic Examples</a></li>
<li><a href="js_ex_objects.asp">JavaScript Objects Examples</a></li>
<li><a href="js_dom_examples.asp">JavaScript HTML DOM Examples</a></li>
	<li><a href="js_ex_browser.asp">JavaScript Browser Objects Examples</a></li>
</ul>
<hr>
...
<p>At W3Schools you will find a complete reference of all JavaScript objects, 
all Browser objects, and all HTML DOM objects.</p>
<p>The references contain examples for every object, every property, and every method.</p>
