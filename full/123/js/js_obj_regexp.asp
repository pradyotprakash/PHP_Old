...
<style>a.menu_js_obj_regexp{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_obj_math.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_htmldom.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">RegExp, is short for regular expression.</p>
<hr>
...
go to our <a href="../jsref/jsref_obj_regexp.asp">complete RegExp object reference</a>.</p>
...
var patt=new RegExp(pattern,modifiers);<br>
<br>
...
<div class="example_code notranslate">
Visit <span class="marked">W3Schools</span>
</div>
<br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_regexp_i" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<p>The <span class="marked">marked</span> text below shows where the expression gets a match:</p>
<div class="example_code notranslate">
Is th<span class="marked">is</span> all there <span class="marked">is</span>?
</div>
<br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_regexp_g" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<p>The <span class="marked">marked</span> text below shows where the expression gets a match:</p>
<div class="example_code notranslate">
<span class="marked">Is</span> th<span class="marked">is</span> all there <span class="marked">is</span>?
</div>
<br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_regexp_g_2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<h2>test()</h2>
<p>The test() method searches a string for a specified value, and returns true 
...
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_regexp_test" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>exec()</h2>
<p>The exec() method searches a string for a specified value, and returns the text of the found value. If no match is found, it returns <i>null.</i></p>
<p>The following example searches a string for the character &quot;e&quot;:</p>

<div class="example">
<h2 class="example">Example 1</h2><div class="example_code notranslate">
var patt1=new RegExp(&quot;e&quot;);<br>document.write(patt1.exec(&quot;The best things in life are free&quot;));</div>
<p>Since there is an &quot;e&quot; in the string, the output of the code above will be:</p>
<div class="example_code notranslate">
e</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_regexp_exec" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_obj_regexp.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_obj_regexp.asp#top" target="_top">TOP</a> |
		<a href="js_obj_regexp.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
