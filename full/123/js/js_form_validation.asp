...
<style>a.menu_js_form_validation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">Form Validation</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_errors.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_objects.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>The function below checks if a field has been left empty. If the field is blank, an alert box alerts a message, the function returns 
false, and the form will not be submitted:</p>
...
&lt;/form&gt;</div>
<br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_form_validation" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>This means that the input data must contain an @ sign and at least one dot (.). 
Also, the @ must not be the first character of the email address, and the last 
dot must be present after the @ sign, and minimum 2 characters before the end:</p>
...
&lt;/form&gt;</div>
<br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_form_validate_email" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_form_validation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_form_validation.asp#top" target="_top">TOP</a> |
		<a href="js_form_validation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
