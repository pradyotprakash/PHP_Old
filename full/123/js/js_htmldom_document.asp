...
<style>a.menu_js_htmldom_document{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_htmldom_methods.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_htmldom_elements.asp">Next Chapter &raquo;</a></div>
</div>

<hr>
<p class="intro">With the HTML DOM, the document object is your web page.</p>
<hr>

<h2>The HTML DOM Document</h2>
<p>In the HTML DOM object model, the document object represents your web page.</p>
<p>The document object is the owner of all other objects in your web page.</p>
<p>If you want to access objects in an HTML page, you always start with accessing the 
document object.</p>
<p>Below are some examples of how you can use the document object to access and 
manipulate HTML. </p>
<p>The next chapters demonstrate all the methods.</p>
<hr>
...
<tr>
	...
	<td>Writing into the HTML output stream</td>
</tr>
<tr>
	<td>document.getElementById(<i>id</i>).innerHTML=</td>
	<td>Changing the inner HTML of an element</td>
</tr>
<tr>
	<td>document.getElementById(<em>id</em>).<em>attribute</em>=</td>
	<td>Changing the attribute of an element</td>
</tr>
<tr>
	<td>document.getElementById(<em>id)</em>.style.<em>attribute=</em></td>
	<td>Changing the style of an HTML element</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_htmldom_document.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_htmldom_document.asp#top" target="_top">TOP</a> |
		<a href="js_htmldom_document.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
