...
<html lang="en-US">
<head>
<title>JavaScript Testing Prototype</title>
<style>a.menu_js_lib_prototype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<!--
      ...
      code.snippet { white-space: nowrap; }
-->
</style>
</head>
<body>
...
<h1>JavaScript <span class="color_h1">- Testing Prototype</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_lib_jquery.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Testing JavaScript Framework Libraries - Prototype</p>
<hr>

<h2>Including Prototype</h2>
...
<div class="example">
<h2 class="example">Including Prototype</h2>
<div class="example_code notranslate">
&lt;!DOCTYPE html&gt;<br>
&lt;html&gt;<br>
&lt;head&gt;<br>
&lt;script<br>
src=&quot;http://ajax.googleapis.com/ajax/libs/<br>
prototype/1.7.1.0/prototype.js&quot;&gt;<br>
&lt;/script&gt;<br>
&lt;/head&gt;<br>
&lt;body&gt;<br>
&lt;/body&gt;<br>
...
<h2>
Prototype Described</h2>
<p>Prototype provides functions to make HTML DOM programming easier.</p>
<p>Like jQuery, Prototype has its $() function.</p>
<p>The $() function accepts HTML DOM element id values (or DOM elements), and 
adds new functionality to DOM objects.</p>
<p>Unlike jQuery, Prototype has no ready() method to take the place of 
window.onload(). Instead, Prototype adds extensions to the browser and the HTML 
DOM.</p>
...
<p>The Prototype equivalent is different:</p>
<div class="example">
<h2 class="example">The Prototype Way:</h2>
<div class="example_code notranslate">
function myFunction()<br>
{<br>
$(&quot;h01&quot;).insert(&quot;Hello Prototype!&quot;);<br>
}<br>
Event.observe(window,&quot;load&quot;,myFunction);</div>
</div>

<p>Event.observe() accepts three arguments: </p>
<ul>
	<li>The HTML DOM or BOM (Browser Object Model) object you want to handle</li>
	<li>The event you want to handle</li>
	<li>The function you want to call</li>
</ul>
<hr>

<h2>Testing Prototype</h2>
<p>
...
&lt;html&gt;<br>
&lt;script<br>
src=&quot;https://ajax.googleapis.com/ajax/libs/<br>
prototype/1.7.1.0/prototype.js&quot;&gt;<br>
&lt;/script&gt;<br>
&lt;script&gt;<br>
function myFunction()<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_lib_prototype">Try it yourself &raquo;</a>
</div>
<p>
Also try this one:</p>
...
function myFunction()<br>
{<br>
$(&quot;h01&quot;).writeAttribute(&quot;style&quot;,&quot;color:red&quot;).insert(&quot;Hello Prototype!&quot;);<br>
}<br>
Event.observe(window,&quot;load&quot;,myFunction);<br>
&lt;/script&gt;<br>
&lt;/head&gt;<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_lib_prototype2">Try it yourself &raquo;</a>
</div>
<p>
As you can see from the example above, like jQuery, Prototype allows chaining.</p>
<p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_lib_prototype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_lib_prototype.asp#top" target="_top">TOP</a> |
		<a href="js_lib_prototype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
