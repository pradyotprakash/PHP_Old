...
<style>a.menu_js_obj_boolean{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_obj_array.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_obj_math.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The Boolean object is used to convert a non-Boolean value to a Boolean value (true or false).</p>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_boolean">Check Boolean value</a><br>
Check if a Boolean object is true or false.</p>
<hr>

<h2>Complete Boolean Object Reference</h2>
<p>For a complete reference of all the properties and methods that can be used with 
the Boolean object, go to our <a href="../jsref/jsref_obj_boolean.asp">complete Boolean object reference</a>.</p>
...
var myBoolean=new Boolean();</div></div>

<p>If the Boolean object has no initial value, or if the passed value is one of 
the following:</p>
...
<p>the object is set to false. For any other value it is set to true (even 
with the string &quot;false&quot;)!</p>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_obj_array.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_obj_math.asp">Next Chapter &raquo;</a></div>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_obj_boolean.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_obj_boolean.asp#top" target="_top">TOP</a> |
		<a href="js_obj_boolean.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
