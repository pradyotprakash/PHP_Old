...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_operators.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_if_else.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<th style="width:18%">Comparing</th>
<th style="width:17%">Returns</th>
...
<td>x==8</td>
<td><em>false</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison1">Try it &raquo;</a></td>	
</tr>
<tr style="background-color:#ffffff;">
<td>x==5</td>
<td><em>true</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison2">Try it &raquo;</a></td>	
</tr>
<tr class="fixzebra">
<td rowspan="2">===</td>
<td rowspan="2">exactly equal to (equal value and equal type)</td>
<td>x===&quot;5&quot;</td>
<td><em>false</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison3">Try it &raquo;</a></td>
</tr>
<tr class="fixzebra">
<td>x===5</td>
<td><em>true</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison4">Try it &raquo;</a></td>
</tr>
<tr>
<td>!=</td>
<td>&nbsp;not equal</td>
<td>x!=8</td>
<td><em>true</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison5">Try it &raquo;</a></td>
</tr>
<tr>
<td rowspan="2">!==</td>
<td rowspan="2">&nbsp;not equal (different value or different type)</td>
<td>x!=="5"</td>
<td><em>true</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison6">Try it &raquo;</a></td>
</tr>
<tr class="fixzebra">
<td>x!==5</td>
<td><em>false</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison7">Try it &raquo;</a></td>
</tr>
<tr style="background-color:#ffffff;">
<td>&gt;</td>
<td>&nbsp;greater than</td>
<td>x&gt;8</td>
<td><em>false</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison8">Try it &raquo;</a></td>
</tr>
<tr class="fixzebra">
<td>&lt;</td>
<td>&nbsp;less than</td>
<td>x&lt;8</td>
<td><em>true</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison9">Try it &raquo;</a></td>
</tr>
<tr style="background-color:#ffffff;">
<td>&gt;=</td>
...
<td>x&gt;=8</td>
<td><em>false</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison10">Try it &raquo;</a></td>
</tr>
<tr class="fixzebra">
<td>&lt;=</td>
...
<td>x&lt;=8</td>
<td><em>true</em></td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison11">Try it &raquo;</a></td>
</tr>
</table>
<br>
<hr>
...
<p class="example">If the variable <em>age</em> is a value below 18, the value 
of the variable <em>voteable</em> will be &quot;Too young&quot;, otherwise the value of <em>voteable</em> will be &quot;Old enough&quot;:</p>
<div class="example_code notranslate">
voteable=(age<18)?"Too young":"Old enough";</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_comparison">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_comparisons.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_comparisons.asp#top" target="_top">TOP</a> |
		<a href="js_comparisons.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
