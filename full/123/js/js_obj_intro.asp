...
<style>a.menu_js_obj_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_datatypes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_functions.asp">Next Chapter &raquo;</a></div>
</div>

<hr>
<p class="intro">Almost everything in JavaScript can be an Object: Strings, 
Functions, 
Arrays, Dates.... </p>
<p class="intro">Objects are just data, with properties and 
methods.</p>
<hr>

<h2>Properties and Methods</h2>
<p><strong>Properties</strong> are <strong>values</strong> associated with objects. </p>

<p><strong>Methods</strong> are <strong>actions</strong> that objects can 
perform.</p>
<hr>

<h2>A Real Life Object. A Car:</h2>
...
<p>The <strong>properties</strong> of the car include name, model, weight, color, etc.</p>
<p>All cars have these properties, but the property values differ from 
car to car.</p>
<p>The <strong>methods</strong> of the car could be start(), drive(), brake(), etc.</p>
<p>All cars have these methods, but they are performed at different times.</p>
<hr>

<h2>Objects in JavaScript:</h2>
<p>In JavaScript, objects are data (variables), with properties and 
methods.</p>
<p>You create a JavaScript String object when you declare a string variable like this:</p>

<div class="code notranslate"><div>
var txt = new String(&quot;Hello World&quot;);</div></div>
<p>&nbsp;String objects have 
...
<p>The string object above has a length property 
of 11, and the indexOf(&quot;World&quot;) method will return 6.</p>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
<p>In object oriented languages, properties and methods are often called <strong>object members</strong>.</p>
	</td>
</tr></table>

<p>
You will learn more about properties and the methods of the String object in a 
later chapter of this tutorial.</p>
<hr>

<h2>Creating JavaScript Objects</h2>
<p>Almost &quot;everything&quot; in JavaScript can be objects. Strings, Dates, Arrays, 
Functions....</p>
<p>You can also create your own objects.</p>
<p>This example creates an object called &quot;person&quot;, and adds four properties to it:</p>
...
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_create_object" target="_blank">Try it yourself &raquo;</a>
</div>
<p>There are many different ways to create new JavaScript objects, and you can also 
add new properties and methods to already existing objects.</p>
<p>You will learn much more about this in a later chapter of this tutorial. </p>
...
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"><br></th>
<td>It is common, in object oriented languages, to use camel-case names.<br>
You will often see names like someMethod(), instead of some_method().</td>
</tr></table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_obj_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_obj_intro.asp#top" target="_top">TOP</a> |
		<a href="js_obj_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
