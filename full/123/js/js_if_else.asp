...
<style>a.menu_js_if_else{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">If...Else</span> Statements</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_comparisons.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_switch.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<ul>
  <li><b>if statement</b> - use this statement to execute some code only if a specified condition is true</li>
  <li><b>if...else statement</b> - use this statement to execute some code if the condition is true and another code if the condition is false</li>
	<li><b>if...else if....else statement</b>  - use this statement to select one of many blocks of code to be executed</li>
  <li><b>switch statement</b> - use this statement to select one of many blocks of code to be executed</li>
</ul>
<hr>
...
<p>Note that <em>if</em> is written in lowercase letters. Using uppercase letters (IF) will generate a JavaScript error!</p>

<div class="example">
<h2 class="example">Example</h2>
<p class="example">Make a &quot;Good day&quot; greeting if the time is less than 20:00:</p>
...
<br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_ifthen" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>Notice that there is no ..else.. in this syntax. You tell the browser to execute some code <b>only if the specified condition is true</b>.</p>
<hr>

<h2>If...else Statement</h2>
<p>Use the if....else statement to execute some code if a condition is true and 
...
<div class="example">
<h2 class="example">Example</h2>
<p class="example">If the time is less than 20:00, you will get a &quot;Good day&quot; 
greeting, otherwise you will get a &quot;Good evening&quot; greeting</p>
<div class="example_code notranslate">
if (time&lt;20)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;x=&quot;Good day&quot;;<br>
...
<br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_ifthenelse" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>If...else if...else Statement</h2>
<p>Use the if....else if...else statement to select one of several blocks of code to be executed.</p>
...
<div class="example">
<h2 class="example">Example</h2>
<p class="example">If the time is less than 10:00, you will get a &quot;Good 
morning&quot; 
greeting, if not, but the time is less than 20:00, you will get a &quot;Good day&quot; greeting, 
otherwise you will get a &quot;Good evening&quot; greeting:</p>
<div class="example_code notranslate">
if (time&lt;10)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;x=&quot;Good morning&quot;;<br>
...
<br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_elseif" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_randomlink">Random link</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_if_else.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_if_else.asp#top" target="_top">TOP</a> |
		<a href="js_if_else.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
