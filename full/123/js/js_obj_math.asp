...
<style>a.menu_js_obj_math{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">Math</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_obj_boolean.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_obj_regexp.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The Math object allows you to perform mathematical tasks.</p>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_round">round()</a><br>
How to use round().</p>

<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_random">random()</a><br>
How to use random() to return a random number between 0 and 1.</p>

<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_max">max()</a><br>
How to use max() to return the number with the highest value of two specified numbers.</p>

<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_min">min()</a><br>
...
the Math object, go to our <a href="../jsref/jsref_obj_math.asp">complete Math object reference</a>.</p>
...
<p><b>Syntax for using properties/methods of Math:</b></p>

<div class="code notranslate"><div>

var x=Math.PI;<br>
var y=Math.sqrt(16);</div></div>

<p><b>Note:</b> Math is not a constructor. All properties and methods of Math can be called by using Math as an object without creating it.</p>
<hr>

<h2>Mathematical Constants</h2>
<p>JavaScript provides eight mathematical constants that can be accessed from the Math object. These are: E, PI, square root of 2, square root 
of 1/2, natural log of 2, natural log of 10, base-2 log of E, and base-10 log of E.</p>
...
<div class="code notranslate"><div>
document.write(Math.round(4.7));</div></div>
...
<div class="code notranslate"><div>
document.write(Math.random());</div></div>

<p>The code above can result in the following output:</p>

<div class="code notranslate"><div>
<script>document.write(Math.random())</script></div></div>
...
<div class="code notranslate"><div>
document.write(Math.floor(Math.random()*11));</div></div>

<p>The code above can result in the following output:</p>

<div class="code notranslate"><div>
<script>	document.write(Math.floor(Math.random()*11))</script></div></div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_obj_boolean.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_obj_regexp.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_obj_math.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_obj_math.asp#top" target="_top">TOP</a> |
		<a href="js_obj_math.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
