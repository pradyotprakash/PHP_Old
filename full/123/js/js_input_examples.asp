...
<html lang="en-US">
<head>
<title>JavaScript HTML Input Examples</title>
<style>a.menu_js_input_examples{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">HTML Input </span>Examples</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_dom_examples.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_ex_dom.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Examples of using JavaScript to access and manipulate HTML 
input objects.</p>
<hr>
<h2>Button Object</h2>
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_button_disabled">Disable a button</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_button_name">Find the name of a button</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_button_type">Find the type of a button</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_button_value">Find the text displayed on a button</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_button_form">Find the id of the form a button belongs to</a>
</p>
<br>
<hr>
<h2>Form Object</h2>
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_submit">Submit a form</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_reset">Reset a form</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_elements">Find the value of each element in a form</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_acceptcharset">Find the value of the accept-charset attribute in a form</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_action">Find the value of the action attribute in a form</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_enctype">Find the value of the enctype attribute in a form</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_length">Find the number of elements in a form</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_method">Find the method for sending form data</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_name">Find the name of a form</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_target">Find the value of the target attribute in a form</a><br>
</p>
<hr>
<h2>Option and Select Objects</h2>
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_select_disabled">Disable and enable a dropdown list</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_select_form">Get the id of the form that contains the dropdown list</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_select_length">Get the number of options in the dropdown list</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_select_size">Turn the dropdown list into a multiline list</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_select_multiple">Select multiple options in a dropdown list</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_select_option">Alert the selected option in a dropdown list</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_select_options">Alert all options from a dropdown list</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_option_index">Alert the index of the selected option in a dropdown list</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_option_settext">Change the text of the selected option</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_select_remove">Remove options from a dropdown list</a>
</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_dom_examples.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_input_examples.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_input_examples.asp#top" target="_top">TOP</a> |
		<a href="js_input_examples.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
