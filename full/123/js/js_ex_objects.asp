...
<style>a.menu_js_ex_objects{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">Objects</span> Examples</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_examples.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_dom_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<h2>String Object</h2>
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_length_string">Find the length of a string</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_indexof">Find the position of the first occurrence of a text in a string - indexOf()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_match">Search for a text in a string and return the text if found - match()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_replace">Replace characters in a string - replace()</a>
</p>
<p><b><a href="js_obj_string.asp">String Object Explained</a></b></p>
<hr>
<h2>Date Object</h2>
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_date">Use Date() to return today's date and time</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_gettime">Use getTime() 
to calculate the number of milliseconds since 1970</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_setfullyear2">Use setFullYear() to set a specific date</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_toutcstring">Use toUTCString() to convert today's date (according to UTC) to a string</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_date_weekday">Use getDay() and an array to write a weekday, and not just a number</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_timing_clock">Display a clock</a>
</p>
<p><b><a href="js_obj_date.asp">Date Object Explained</a></b></p>

<hr>
<h2>Array Object</h2>
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_array">Create an array</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_concat">Join two arrays - concat()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_concat2">Join three arrays - concat()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_join">Join all elements of an array into a string - join()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_pop">Remove the last element of an array - pop()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_push">Add new elements to the end of an array - push()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_reverse">Reverse the order of the elements in an array - reverse()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_shift">Remove the first element of an array - shift()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_slice_array">Select elements from an array - slice()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_sort">Sort an array (alphabetically and ascending) - sort()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_sort2">Sort numbers (numerically and ascending) - sort()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_sort3">Sort numbers (numerically and descending) - sort()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_splice">Add an element to position 2 in an array - splice()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_tostring_array">Convert an array to a string - toString()</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_unshift">Add new elements to the beginning of an array - unshift()</a>
</p>
<p><b><a href="js_obj_array.asp">Array Object Explained</a></b></p>

<hr>

<h2>Boolean Object</h2>
<p><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_boolean">Check Boolean value</a></p>
<p><b><a href="js_obj_boolean.asp">Boolean Object Explained</a></b></p>

<hr>

<h2>Math Object</h2>
<p>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_round">Use round() to round a number</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_random">Use random() to return a random number between 0 and 1</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_max">Use max() to return the number with the highest value of two specified numbers</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_min">Use min() to return the number with the lowest value of two specified numbers</a><br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_celsius">Convert Celsius to Fahrenheit</a>
</p>
<p><b><a href="js_obj_math.asp">Math Object Explained</a></b></p>
<hr>
<h2>
General</h2>
<p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_ex_objects.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_ex_objects.asp#top" target="_top">TOP</a> |
		<a href="js_ex_objects.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
