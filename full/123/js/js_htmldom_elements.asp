...
<html lang="en-US">
<head>
<title>JavaScript HTML DOM Elements</title>
<style>a.menu_js_htmldom_elements{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_htmldom_document.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_htmldom_html.asp">Next Chapter &raquo;</a></div>
</div>
...
<p>The easiest way to find HTML elements in the DOM, is by using the element id.</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_getelementbyid">Try it yourself &raquo;</a>
</div>
<p>If the element is found, the method will return the element as an object (in 
x).</p>
<p>If the element is not found, x will contain null.</p>
<hr>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_getelementsbytagname">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>The example above returns a list of all elements with class=&quot;intro&quot;.</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>Finding elements by class name does not work in Internet Explorer 5,6,7, and 8.</td>
</tr></table>
<br>
<hr>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;frm1&quot;);<br>var txt = &quot;&quot;;<br>for (var 
	i=0;i&lt;x.length;i++)<br>&nbsp; {<br>&nbsp; txt = txt + x.elements[i].value + 
	&quot;&lt;br&gt;&quot;;<br>&nbsp; }<br>document.getElementById(&quot;demo&quot;).innerHTML=txt;</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjsref_form_elements" target="_blank">Try it yourself &raquo;</a>
</div>
<p>The following HTML object collections are accesible:</p>
<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_htmldom_elements.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_htmldom_elements.asp#top" target="_top">TOP</a> |
		<a href="js_htmldom_elements.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
