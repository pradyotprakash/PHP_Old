...
<style>a.menu_js_switch{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_if_else.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_loop_for.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The switch statement is used to perform different action based on different conditions.</p>
<hr>
...
<p>This is how it works: First we have a single expression <i>n</i> (most often a
...
<p class="example">Display today's weekday-name. Note that Sunday=0, Monday=1, Tuesday=2, etc:</p>
<div class="example_code notranslate">
var day=new Date().getDay();<br>
switch (day)<br>
{<br>
case 0:<br>
&nbsp;&nbsp;x=&quot;Today is Sunday&quot;;<br>
&nbsp;&nbsp;break;<br>
case 1:<br>
&nbsp;&nbsp;x=&quot;Today is Monday&quot;;<br>
&nbsp;&nbsp;break;<br>
case 2:<br>
&nbsp;&nbsp;x=&quot;Today is Tuesday&quot;;<br>
&nbsp;&nbsp;break;<br>
case 3:<br>
&nbsp;&nbsp;x=&quot;Today is Wednesday&quot;;<br>
&nbsp;&nbsp;break;<br>
case 4:<br>
&nbsp;&nbsp;x=&quot;Today is Thursday&quot;;<br>
&nbsp;&nbsp;break;<br>
case 5:<br>
&nbsp;&nbsp;x=&quot;Today is Friday&quot;;<br>
&nbsp;&nbsp;break;<br>
case 6:<br>
&nbsp;&nbsp;x=&quot;Today is Saturday&quot;;<br>
&nbsp;&nbsp;break;<br>
}
</div>
...
<br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_switch" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<h2>The <em>default</em> Keyword</h2>

<p>Use the <em>default</em> keyword to specify what to do if there is no match:</p>

<div class="example">
<h2 class="example">Example</h2>
<p class="example">If the day is NOT Saturday or Sunday, then write a default message:</p>
<div class="example_code notranslate">
var day=new Date().getDay();<br>
switch (day)<br>
{<br>
...
&nbsp;&nbsp;break;<br>
default:<br>
&nbsp;&nbsp;x=&quot;Looking forward to the Weekend&quot;;<br>
}
</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_switch2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_if_else.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_switch.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_switch.asp#top" target="_top">TOP</a> |
		<a href="js_switch.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
