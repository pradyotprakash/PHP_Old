...
<style>a.menu_js_obj_number{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">Number</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_objects.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_obj_string.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">JavaScript has only one type of number.</p>
<p class="intro">Numbers can be written 
with, or without decimals.</p>
<hr>

<h2>JavaScript Numbers</h2>
<p>JavaScript numbers can be written with, or without decimals:<br>
...
var
pi=3.14;&nbsp;&nbsp;&nbsp; // A number written with decimals<br>
var
x=34;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // A number written without decimals</div>
</div>
...
<h2>JavaScript Numbers are 64-bit Floating Point</h2>
<p>JavaScript is not a typed language. Unlike many other programming languages, 
it does not define different types of numbers, like integers, short, long, 
...
<p>Integers (numbers without a period or exponent notation) are considered 
accurate up to 15 digits.</p>
<p>The maximum number of decimals is 17, but floating point arithmetic is not 
always 100% accurate:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
var x = 0.2+0.1; // result will be 0.30000000000000004</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_inaccurate">Try 
it yourself &raquo;</a></div>
<br>

<hr>
<h2>Octal and Hexadecimal</h2>
<p>JavaScript interprets numeric constants as octal if they are preceded by a 
zero, and as hexadecimal if they are preceded by a zero and "x".</p>
...
var z = 0xFF;</div>
<br>
<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_octal_hex" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
Never write a number with a leading zero, unless you want an octal conversion.&nbsp; </td>
</tr></table>
<p>
By default, Javascript displays numbers as base 10 decimals.</p>
<p>But you can use the toString() method to output numbers as base 16 (hex), 
base 8 (octal), or base 2 (binary).</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var myNumber=128;<br>myNumber.toString(16);&nbsp;&nbsp; // returns 80<br>
	myNumber.toString(8);&nbsp;&nbsp;&nbsp; // returns 200<br>
	myNumber.toString(2);&nbsp;&nbsp;&nbsp; // returns 10000000<br>
</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_tostring" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
<p>If you calculate a number outside the largest number provided by Javascript, 
Javascript will return the value of Infinity or -Infinity (positive or negative 
overflow):</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	myNumber=2;<br>while (myNumber!=Infinity)<br>{<br>
	myNumber=myNumber*myNumber; 
	// Calculate until Infinity<br>}
</div>
<br>
<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_infinity" target="_blank">Try 
it yourself &raquo;</a></div>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
var x = 2/0;<br>var y = -2/0;
</div>
<br>
<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_infinity_zero" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
Note: Infinity is a number (typeof(Infinity) returns a number).&nbsp; </td>
</tr></table>
<br>
...
<p>NaN is JavaScript reserved word indicating that the result of a numeric 
operation was not a number.</p>
<p>You can use the global JavaScript function isNaN(value) to find out if a value 
is a number.</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var x = 1000 / &quot;Apple&quot;;<br>isNaN(x); // returns true<br>var y = 100 / 
	&quot;1000&quot;;<br>isNaN(y); // returns false</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_isnan_false" target="_blank">Try 
it yourself &raquo;</a></div>

<p>Division by 0 (zero) generates Infinity, but Infinity is a number:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var x = 1000 / 0;<br>isNaN(x); // returns false</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_isnan_true" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<br>
<hr>
<h2>Numbers Can be Numbers or Objects</h2>

<p>JavaScript numbers can be primitive values created from literals, like var 
x = 123;</p>
<p>JavaScript number can also be objects created with the new keyword, like var y = new 
Number(123);</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var x = 123;<br>var y = new Number(123);<br>typeof(x) // returns Number<br>
	typeof(y) // returns Object</div>
<br>
	<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_object_number_type" target="_blank">Try 
it yourself &raquo;</a></div>
<p>Normally, because of some nasty side effects, you will not define numbers as 
objects.</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var x = 123;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>var y = new Number(123);<br>(x === y) // 
	is false 
	because x is a number and y is an object.</div>
<br>
<a class="tryitbtn" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_object_number" target="_blank">Try 
it yourself &raquo;</a></div>
<br>
<hr>
...
<p>All number properties are properties of JavaScripts' number object wrapper 
called <strong>Number</strong>.</p>
<p>These properties can only be accessed as <strong>Number</strong>.MAX_VALUE.</p>
<p>Using <strong>num</strong>.MAX_VALUE, where <strong>num</strong> is a 
created object or a primitive number value, will return 
undefined.</p>
<hr>
...
<p><strong>Note:</strong> Primitive values, like 3.14, cannot have properties 
and methods (because they are not objects). </p>
<p>With JavaScript, all methods of the number object are also available to 
primitive values, because Javascript will temporarily transfer primitive values 
to objects before executing the methods.</p>
<hr>

<h2>Complete Number Object Reference</h2>
<p>For a complete reference of all the properties and methods that can be used with the 
Number object,
go to our <a href="../jsref/jsref_obj_number.asp">Complete Number Object Reference</a>.</p>
<p>The reference contains both descriptions and examples, for each  
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_obj_number.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_obj_number.asp#top" target="_top">TOP</a> |
		<a href="js_obj_number.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
