...
<style>a.menu_js_operators{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="js_functions.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_comparisons.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">= is used to assign values.</p>
<p class="intro">+ is used to add values.</p>
<hr>
<p>The assignment operator <b>=</b> is used to assign values to JavaScript variables.</p>
<p>The arithmetic operator + is used to add values together.</p>

<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Assign values to variables and add them together:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_operators1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<th style="width:15%">Result of x</th>
<th style="width:15%">Result of y</th>
...
<td>7</td>
<td>5</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_add">Try it &raquo;</a></td>
</tr>
<tr>
<td>-</td>
<td>Subtraction</td>
...
<td>3</td>
<td>5</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_sub">Try it &raquo;</a></td>
</tr>
<tr>
<td>*</td>
...
<td>10</td>
<td>5</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_mult">Try it &raquo;</a></td>
</tr>
<tr>
<td>/</td>
<td>Division</td>
...
<td>2.5</td>
<td>5</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_div">Try it &raquo;</a></td>
</tr>
<tr>
<td>%</td>
...
<td>1</td>
<td>5</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_mod">Try it &raquo;</a></td>
</tr>
<tr>
<td rowspan="2">++</td>
...
<td>6</td>
<td>6</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_incr">Try it &raquo;</a></td>
</tr>
<tr class="fixzebra">
<td>x=y++</td>
<td>5</td>
<td>6</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_incr2">Try it &raquo;</a></td>
</tr>
...
<td>4</td>
<td>4</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_decr">Try it &raquo;</a></td>
</tr>
<tr style="background-color:#ffffff;">
<td>x=y--</td>
<td>5</td>
<td>4</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_decr2">Try it &raquo;</a></td>
</tr>
</table>
<br>
<hr>
...
<td>&nbsp;</td>
<td>x=5</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_equal">Try it &raquo;</a></td>
</tr>
<tr>
<td>+=</td>
<td>x+=y</td>
<td>x=x+y</td>
<td>x=15</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_plusequal">Try it &raquo;</a></td>
</tr>
<tr>
<td>-=</td>
<td>x-=y</td>
<td>x=x-y</td>
<td>x=5</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_minequal">Try it &raquo;</a></td>
</tr>
<tr>
<td>*=</td>
<td>x*=y</td>
<td>x=x*y</td>
<td>x=50</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_multequal">Try it &raquo;</a></td>
</tr>
<tr>
<td>/=</td>
<td>x/=y</td>
<td>x=x/y</td>
<td>x=2</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_divequal">Try it &raquo;</a></td>
</tr>
<tr>
<td>%=</td>
<td>x%=y</td>
<td>x=x%y</td>
<td>x=0</td>
<td><a target="_blank" class="tryitbtn" style="float:right;width:55px;padding-top:0px;padding-bottom:1px" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_oper_modequal">Try it &raquo;</a></td>
</tr>
</table>
<br>
<hr>
...
<p>The + operator can also be used to add string variables or text values together.</p>

<div class="example">
<h2 class="example">Example</h2>
	<p class="example">To add two or more string variables together, use the + operator.</p>
<div class="example_code notranslate">
txt1=&quot;What a very&quot;;<br>
txt2=&quot;nice day&quot;;<br>
txt3=txt1+txt2;
</div>
<p>The result of <em>txt3</em> will be:</p>
<div class="example_code notranslate">
What a verynice day</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_operators2" class="tryitbtn">Try it yourself &raquo;</a>
</div>


<p>To add a space between the two strings, insert a space into one of the strings:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_operators3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="example_code notranslate">
What a very nice day</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_operators4" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
55<br/>
Hello5</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=tryjs_operators5" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>The rule is: <b>If you add a number and a string, the result will be a string!</b></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="js_functions.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="js_comparisons.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="js_operators.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="js_operators.asp#top" target="_top">TOP</a> |
		<a href="js_operators.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
