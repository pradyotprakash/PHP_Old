...
div.image {box-shadow: 0px 10px 20px 3px #d3d3d3;width:100px;height:80px;border-radius:4px;float:left;background-image:url('http://www.w3schools.com/images/w3logo.png');background-repeat:no-repeat;background-position:center;}
...
.bottom {width:1200px;margin:auto;margin-top:0px;margin-bottom:340px;}
...
<div id="page">
	<div id="leftcol">
		...
		<a href="aspnet/webpages_website.asp" target="_top">Web Building</a><br>
	...
	<div id="maincol">
		...
		<a class="colorpicker" href="tags/ref_colorpicker.asp" target="_top">
			<div style="width:100px;height:70px;margin-left:26px;margin-top:14px;background-image:url('http://www.w3schools.com/images/colorpicker.gif');background-repeat:no-repeat;"></div>
...
<div style="margin-top:15px;">
	<div style="width:1160px;margin:auto;height:55px;padding-left:20px;padding-right:20px;">
		<div style="width:520px;float:left;padding-top:6px;">
			<a href="index.html"><img style="width:150px;height:28px;border:0" src="http://www.w3schools.com/images/w3schoolscom_gray.gif" alt="W3Schools.com"></a>
		</div>
		<div style="width:40px;float:left;padding-top:6px;">
			<a target="_blank" href="https://facebook.com/w3schoolscom">
				<div style="float:left;width:30px;height:24px;background-color:#555555;box-shadow: 0px 10px 20px 3px #d3d3d3;border-radius:4px;float:left;background-image:url('http://www.w3schools.com/images/w3logo.png');background-repeat:no-repeat;background-position:center;background-size:24px;"></div>
			</a>
		</div>
