...
<html lang="en-US">
<head>
<title>CSS flex-wrap property</title>
<style>a.menu_css3_pr_flex-wrap{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
	display:flex;<br>flex-wrap: wrap;</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_flex-wrap" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The flex-wrap property is supported in Firefox, Opera, and Chrome.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_flex-wrap">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_flex-wrap&amp;preval=nowrap">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>wrap</td>
    <td>Specifies that the flexible items will wrap if necessary</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_flex-wrap&amp;preval=wrap">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>wrap-reverse</td>
    <td>Specifies that the flexible items will wrap, if necessary, in reverse order</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_flex-wrap&amp;preval=wrap-reverse">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_flex-wrap&amp;preval=initial">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_flex-wrap.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_flex-wrap.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_flex-wrap.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
