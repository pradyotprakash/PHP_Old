...
<style>a.menu_css3_pr_text-outline{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">text-outline</span> Property</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; CSS Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_text-overflow.asp">text-overflow Property &raquo;</a></div>
</div>
<br>
...
<p>Set a text-outline:</p>
<div class="example_code notranslate">
  
    p.test<br>
	{<br>
	text-outline: 2px 2px #ff0000;<br>
	}
...
<p>The text-outline property is not supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The text-outline property specifies a text outline.</p>
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.textOutline=&quot;2px 2px #ff0000&quot;</td>
  </tr>
	</table>
<br>
<hr>
...
text-outline: <i>thickness blur color</i>;</div></div>
<br>
<table class="reference notranslate">
  ...
  <tr>
    <td><i>thickness</i></td>
    <td>Required. The thickness of the outline</td>
  </tr>
  <tr>
    <td><i>blur</i></td>
    <td>Optional. The blur radius of the outline</td>
  </tr>
  <tr>
    <td><i>color</i></td>
    <td>Required. The color of the outline. Look at <a href="css_colors_legal.asp">CSS Color Values</a> 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_text-outline.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_text-outline.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_text-outline.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
