...
<style>a.menu_pr_gen_content{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_gen_content" class="tryitbtn">Try it yourself &raquo;</a>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_content">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>normal</td>
    <td>Default value. Sets the content, if specified, to normal, which default is &quot;none&quot; 
	(which is nothing)</td>
    <td>
	<a target="_blank" class="tryitbtn" style="width:55px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_normal">Try it &raquo;</a></td>
  </tr>
  <tr>
    <td>none</td>
    <td>Sets the content, if specified, to nothing</td>
    <td>
	<a target="_blank" class="tryitbtn" style="width:55px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_none">Try it &raquo;</a></td>
  </tr>
  <tr>
    <td>counter</td>
    <td>Sets the content as a counter</td>
    <td>
	<a target="_blank" class="tryitbtn" style="width:55px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_counter">Try it &raquo;</a></td>
  </tr>
	<tr>
    <td>attr<i>(attribute)</i></td>
    <td>Sets the content as one of the selector's attribute</td>
    <td>
	<a target="_blank" class="tryitbtn" style="width:55px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_attr">Try it &raquo;</a></td>
  </tr>
	<tr>
    <td><i>string</i></td>
    <td>Sets the content to the text you specify</td>
    <td>
	<a target="_blank" class="tryitbtn" style="width:55px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_string">Try it &raquo;</a></td>
  </tr>
	<tr>
    <td>open-quote</td>
    <td>Sets the content to be an opening quote</td>
    <td>
	<a target="_blank" class="tryitbtn" style="width:55px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_quote">Try it &raquo;</a></td>
  </tr>
	<tr>
    <td>close-quote</td>
    ...
    <td>
	<a target="_blank" class="tryitbtn" style="width:55px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_noquote">Try it &raquo;</a></td>
  </tr>
	<tr>
  ...
  <tr>
    <td>url(<i>url</i>)</td>
    <td>Sets the content to be some kind of media (an image, a sound, a video, 
	etc.)</td>
    <td>
	<a target="_blank" class="tryitbtn" style="width:55px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_url">Try it &raquo;</a></td>
  </tr>
	<tr>
    <td>initial</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_gen_content.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_gen_content.asp#top" target="_top">TOP</a> |
		<a href="pr_gen_content.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
