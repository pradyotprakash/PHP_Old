...
<style>a.menu_pr_dim_width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_dim_height" class="tryitbtn">Try it yourself &raquo;</a>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_width">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_width&amp;preval=auto">Play it &raquo;</a></td>		              
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Defines the width in px, cm, etc.&nbsp;</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_width&amp;preval=150px">Play it &raquo;</a></td>		              
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Defines the width in percent of the containing block</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_width&amp;preval=50%25">Play it &raquo;</a></td>		              
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_width&amp;preval=initial">Play it &raquo;</a></td>		              
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss_dim_width_percent">Set the width of an element using percent</a><br>
This example demonstrates how to set the width of an element using a percent value.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_dim_width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_dim_width.asp#top" target="_top">TOP</a> |
		<a href="pr_dim_width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
