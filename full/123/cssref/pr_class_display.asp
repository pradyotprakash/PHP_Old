...
<style>a.menu_pr_class_display{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_display_inline" class="tryitbtn">Try it yourself &raquo;</a>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_display">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_display&amp;preval=inline">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>block</td>
    <td>Displays an element as a block element (like &lt;p&gt;)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_display&amp;preval=block">Play it &raquo;</a></td>    
    </tr>
	<tr>
    <td>inline-block</td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_display&amp;preval=list-item">Play it &raquo;</a></td>    	
    </tr>
  <tr>
    <td>run-in</td>
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_display&amp;preval=none">Play it &raquo;</a></td>    
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_display&amp;preval=initial">Play it &raquo;</a></td>    
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss_display_inline2">Using the inherit value</a><br>
This example demonstrates how to use the inherit property value.</p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_class_display.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_class_display.asp#top" target="_top">TOP</a> |
		<a href="pr_class_display.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
