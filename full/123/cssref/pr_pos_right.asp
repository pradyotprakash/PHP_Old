...
<html lang="en-US">
<head>
<title>CSS right property</title>
<style>a.menu_pr_pos_right{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Set the right edge of the image 5px to the left of the right edge of its containing element:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_position_right" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>For absolutely positioned elements, the right property sets the right edge of an element to a unit to the left/right of the right edge of its containing element.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_right">Try it</a>
</td>
  </tr>
</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	default</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_right">Play it &raquo;</a></td>		                      	
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Sets the right edge position in px, cm, etc. Negative values are allowed
    </td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_right&amp;preval=50px">Play it &raquo;</a></td>		                              
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Sets the right edge position in % of containing element. 
	Negative values are allowed </td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_right&amp;preval=10%25">Play it &raquo;</a></td>		
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_right&amp;preval=initial">Play it &raquo;</a></td>		
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_pos_right.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_pos_right.asp#top" target="_top">TOP</a> |
		<a href="pr_pos_right.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
