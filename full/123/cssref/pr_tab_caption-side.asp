...
<style>a.menu_pr_tab_caption-side{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_table_caption-side" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The caption-side property is supported in all major browsers.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_caption-side">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_caption-side">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td>bottom</td>
		<td>Puts the caption below the table</td>
		<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_caption-side&amp;preval=bottom">Play it &raquo;</a></td>
	</tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
		<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_caption-side&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_tab_caption-side.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_tab_caption-side.asp#top" target="_top">TOP</a> |
		<a href="pr_tab_caption-side.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
