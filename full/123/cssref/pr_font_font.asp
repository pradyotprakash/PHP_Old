...
<style>a.menu_pr_font_font{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_font" class="tryitbtn">Try it yourself &raquo;</a>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_font">Try it</a>
</td>
  </tr>
	</table>
<br>
...
font: <i>font-style</i> <i>font-variant</i> <i>font-weight</i> <i>font-size/line-height</i>|caption|icon|menu|message-box|small-caption|status-bar|initial|inherit;</div></div>
...
<p><a target="_blank" href="tryit.asp?filename=trycss_font_caption">Some of the other font property values</a><br>
This example demonstrates some of the other font property values.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_font_font.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_font_font.asp#top" target="_top">TOP</a> |
		<a href="pr_font_font.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
