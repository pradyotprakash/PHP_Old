...
<style>a.menu_pr_list-style-position{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_list-style-position" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The list-style-position property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_list-style-position">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	the content flow</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_list-style-position&amp;preval=inside">Play it &raquo;</a></td>		              
  </tr>
  <tr>
    <td>outside</td>
    <td>Keeps the marker to the left of the text. The bullets 
	appears outside the content flow. This is default</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_list-style-position&amp;preval=outside">Play it &raquo;</a></td>		              	
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_list-style-position&amp;preval=initial">Play it &raquo;</a></td>		              	
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_list-style-position.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_list-style-position.asp#top" target="_top">TOP</a> |
		<a href="pr_list-style-position.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
