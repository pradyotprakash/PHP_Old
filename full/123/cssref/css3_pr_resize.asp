...
<style>a.menu_css3_pr_resize{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_resize">Try it yourself &raquo;</a>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_resize">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_resize&amp;preval=none">Play it &raquo;</a></td>   		
  </tr>
  <tr>
    <td> both</td>
    <td>The user can adjust both the height and the width of the element</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_resize&amp;preval=both">Play it &raquo;</a></td>   		    
  </tr>
  <tr>
    <td> horizontal</td>
    <td>The user can adjust the width of the element</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_resize&amp;preval=horizontal">Play it &raquo;</a></td>   		    
  </tr>
  <tr>
    <td> vertical</td>
    <td>The user can adjust the height of the element</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_resize&amp;preval=vertical">Play it &raquo;</a></td>   		    
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_resize&amp;preval=initial">Play it &raquo;</a></td>   		    
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_resize.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_resize.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_resize.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
