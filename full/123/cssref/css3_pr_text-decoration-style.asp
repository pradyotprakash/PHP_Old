...
<style>a.menu_css3_pr_text-decoration-style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Display a wavy line under the paragraph:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_text-decoration-style" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The text-decoration-style property is not supported in any of the major browsers.</p>
<p>Firefox supports an alternative, the -moz-text-decoration-style property.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_text-decoration-style">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=solid">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>double</td>
    <td>The line will display as a double line</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=double">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>dotted</td>
    <td>The line will display as a dotted line</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=dotted">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>dashed</td>
    <td>The line will display as a dashed line</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=dashed">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>wavy</td>
    <td>The line will display as a wavy line</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=wavy">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-style&amp;preval=initial">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_text-decoration-style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_text-decoration-style.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_text-decoration-style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
