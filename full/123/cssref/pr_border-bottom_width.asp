...
<html lang="en-US">
<head>
<title>CSS border-bottom-width property</title>
<style>a.menu_pr_border-bottom_width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="pr_tab_border-collapse.asp">Next &raquo;</a></div>
</div>
<br>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-width" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The border-bottom-width property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_border-bottom-width">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-width&amp;preval=medium">Play it &raquo;</a></td>		      
  </tr>
  <tr>
    <td>thin</td>
    <td>Specifies a thin bottom border</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-width&amp;preval=thin">Play it &raquo;</a></td>		      
  </tr>
  <tr>
    <td>thick</td>
    <td>Specifies a thick bottom border</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-width&amp;preval=thick">Play it &raquo;</a></td>		          
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Allows you to define the thickness of the bottom border</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-width&amp;preval=10px">Play it &raquo;</a></td>		      
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-width&amp;preval=initial">Play it &raquo;</a></td>		      
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_border-bottom_width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_border-bottom_width.asp#top" target="_top">TOP</a> |
		<a href="pr_border-bottom_width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
