...
<html lang="en-US">
<head>
<title>CSS3 appearance property</title>
<style>a.menu_css3_pr_appearance{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">appearance</span> Property</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; CSS Reference</a></div>
<div class="next"><a class="chapter" href="css3_pr_backface-visibility.asp">backface-visibility Property &raquo;</a></div>
</div>
<br>
...
<p>Make a div element look like a button:</p>
<div class="example_code notranslate">
  
    div<br>
	{<br>
	appearance:button;<br>
	-moz-appearance:button; /* Firefox */<br>
	-webkit-appearance:button; /* Safari and Chrome */<br>
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_appearance">Try it yourself &raquo;</a>
...
<p>The appearance property is not supported in any of the major browsers.</p>
<p>Firefox supports an alternative, the -moz-appearance property.</p>
<p>Safari and Chrome support an alternative, the -webkit-appearance property.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The appearance property allows you to make an element look like a standard 
...
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.appearance=&quot;button&quot;</td>
  </tr>
	</table>
<br>
<hr>
...
appearance: normal|icon|window|button|menu|field;</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>normal</td>
    <td>Render the element as normal</td>
  </tr>
  <tr>
    <td>icon</td>
    <td>Render the element as a small picture</td>
  </tr>
  <tr>
    <td>window</td>
    <td>Render the element as a viewport</td>
  </tr>
  <tr>
    <td>button</td>
    <td>Render the element as a button</td>
  </tr>
  <tr>
    <td>menu</td>
    <td>Render the element as a set of options for the user to choose from</td>
  </tr>
  <tr>
    <td>field</td>
    <td>Render the element as an input field</td>
  </tr>
  </table>
<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_appearance.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_appearance.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_appearance.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
