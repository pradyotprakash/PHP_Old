...
<h1>CSS <span class="color_h1">.<i>class</i></span> Selector</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_class">Try it yourself &raquo;</a>
...
<p>The <i>.class</i> selector styles all elements with the specified class.</p>
<hr>
...
<p>The .<i>class</i> selector is supported in all major browsers.</p>
...
<h2 class="example">Example</h2>
<p>Style all &lt;p&gt; elements with class="hometown":</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_class_more" class="tryitbtn">Try it yourself &raquo;</a>
