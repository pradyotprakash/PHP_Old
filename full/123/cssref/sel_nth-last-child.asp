...
<title>CSS3 :nth-last-child() Selector</title>
<style>a.menu_sel_nth-last-child{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:nth-last-child()</span> Selector</h1>
<p><a href="css_selectors.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Complete CSS Selector Reference" /> Complete CSS Selector Reference</a></p>

<div class="example">


<h2 class="example">Example</h2>
<p>Specify a background color for every p element that is the second child of 
its parent, counting from the last child:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_nth-last-child">Try it yourself &raquo;</a>
...
<p>The :nth-last-child(<i>n</i>) selector 
matches every element that is the <i>n</i>th child, regardless of 
type, of its parent, counting from the last child.</p>
<p><i>n</i> can be a number, a keyword, or a formula.</p>
<p><b>Tip:</b> Look at the <a href="sel_nth-last-of-type.asp">
:nth-last-of-type()</a> selector 
to select the element that is the <i>n</i>th child,<b> of a specified 
type</b>, of its parent, counting 
	from the last child.</p>
<hr>
...
<p>The :nth-last-child() selector is supported in all major browsers, except IE8 and earlier.</p>
<hr>
...
<p>Odd and even are keywords that can be used to match child elements whose index 
is odd or even.</p>
<p>Here, we specify two different background colors for odd and even p elements, 
counting from the last child:</p>
<div class="example_code notranslate">
  
    p:nth-last-child(odd)<br>
	{<br>
	background:#ff0000;<br>
	}<br>
	p:nth-last-child(even)<br>
	{<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_nth-last-child_odd_even">Try it yourself &raquo;</a>
...
<p>Using a formula (<i>an</i> + <i>b</i>). Description: <i>a</i> represents a 
cycle size, <i>n</i> is a counter (starts at 0), and <i>b</i> is an 
offset value.</p>
<p>Here, we specify a background color for all p elements whose index is a 
multiple of 3, counting from the last child:</p>
<div class="example_code notranslate">
  
    p:nth-last-child(3n+0)<br>
	{<br>
	background:#ff0000;<br>
	}
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_nth-last-child_formula">Try it yourself &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_nth-last-child.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_nth-last-child.asp#top" target="_top">TOP</a> |
		<a href="sel_nth-last-child.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
