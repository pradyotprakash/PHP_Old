...
<html lang="en-US">
<head>
<title>CSS3 text-shadow property</title>
<style>a.menu_css3_pr_text-shadow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_text-shadow">Try it yourself &raquo;</a>
...
<p>The text-shadow property is supported in all major browsers.</p>
<p><strong>Note:</strong> The text-shadow property is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The text-shadow property applies shadow to text.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_text-shadow">Try it</a>
</td>
  </tr>
	</table>
<br>
...
text-shadow: <i>h-shadow v-shadow blur color</i>|none|initial|inherit;</div></div>
<p><b>Note:</b> The text-shadow property attaches one or more shadows to text. The property is a comma-separated list of shadows, each specified by 2 
or 3 
...
<table class="reference notranslate">
  ...
  <tr>
	...
	allowed</td>
    <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-shadow">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>v-shadow</i></td>
  ...
  <tr>
    ...
    <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-shadow&amp;preval=5px&#32;5px&#32;5px&#32;red">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td><i>color</i></td>
    ...
    <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-shadow&amp;preval=5px&#32;5px&#32;10px&#32;blue">Play it &raquo;</a></td>
  </tr>
	<tr>
    <td>none</td>
    <td>Default value. No shadow</td>
    <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-shadow&amp;preval=none">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
    <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-shadow&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss3_text-shadow_blur">
Text-shadow with a blur effect</a><br>
This example demonstrates a text-shadow with a blur effect.</p>
<p><a target="_blank" href="tryit.asp?filename=trycss3_text-shadow_white">
Text-shadow on white text</a><br>
This example demonstrates text-shadow on a white text.</p>
<p><a target="_blank" href="tryit.asp?filename=trycss3_text-shadow_neon">
Text-shadow with neon glow</a><br>
This example demonstrates text-shadow with a neon glow.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_text-shadow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_text-shadow.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_text-shadow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
