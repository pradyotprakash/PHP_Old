...
<style>a.menu_pr_tab_table-layout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_table_table-layout" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The table-layout property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_table-layout">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<ul>
			<li>The column width is set by the widest unbreakable content in the cells</li>
			<li>Can be slow, since it needs to read through all the content in the table, before determining the final layout</li>
		</ul>
		</td>
		<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_table-layout">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td>fixed</td>
		<td>Fixed table layout algorithm:
		<ul>
			<li>The horizontal layout only depends on the table's width and the width of the columns, not the contents of the cells</li>
		...
		<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_table-layout&amp;preval=fixed">Play it &raquo;</a></td>				
	</tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
		<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_table-layout&amp;preval=initial">Play it &raquo;</a></td>				
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_tab_table-layout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_tab_table-layout.asp#top" target="_top">TOP</a> |
		<a href="pr_tab_table-layout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
