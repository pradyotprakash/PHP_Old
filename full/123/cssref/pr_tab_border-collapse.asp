...
<html lang="en-US">
<head>
<title>CSS border-collapse property</title>
<style>a.menu_pr_border-collapse{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_table_border-collapse" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The border-collapse property is supported in all major browsers.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_border-collapse">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-collapse&amp;preval=separate">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>collapse</td>
    <td>Borders are collapsed into a single border when 
	possible (border-spacing and empty-cells properties will be ignored)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-collapse&amp;preval=collapse">Play it &raquo;</a></td>		                      		
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-collapse&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_tab_border-collapse.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_tab_border-collapse.asp#top" target="_top">TOP</a> |
		<a href="pr_tab_border-collapse.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
