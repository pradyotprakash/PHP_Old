...
<html lang="en-US">
<head>
<title>CSS3 icon property</title>
<style>a.menu_css3_pr_icon{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">icon</span> Property</h1>
<div class="nav">
...
<p>Style an img element with an iconic equivalent:</p>
<div class="example_code notranslate">
  
    img<br>
	{<br>
	content:icon;<br>
	icon:url(imgicon.png);<br>
	}
...
<p>The icon property is not supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The icon property provides the author the ability to style an element with an iconic 
	equivalent.</p>
<p><b>Note:</b> An element's icon is not used unless the &quot;content&quot; property is 
set to the value &quot;icon&quot;! </p>
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.icon=&quot;url(image.png)&quot;</td>
  </tr>
	</table>
<br>
<hr>
...
icon: auto|<i>URL</i>|initial|inherit;</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Uses a default generic icon provided by the browser</td>
  </tr>
  <tr>
    <td><i>URL</i></td>
    <td>Refers to one or more icons in a comma separated list</td>
  </tr>
	<tr>
    <td>initial</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_icon.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_icon.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_icon.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
