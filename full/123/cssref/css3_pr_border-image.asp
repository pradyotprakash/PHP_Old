...
<style>a.menu_css3_pr_border-image{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    div<br>
	{<br>
	-webkit-border-image:url(border.png) 30 30 round; /* Safari 5 */<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_border-image">Try it yourself &raquo;</a>
...
<p>The border-image property is supported in Internet Explorer 11, Firefox, 
Opera 15, Chrome, and Safari 6.</p>
<p>Safari 5 supports an alternative, the -webkit-border-image property.</p>
<hr>
...
<p><b>Tip:</b> Use the border-image-* properties to construct beautiful scalable 
buttons!</p>
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.borderImage=&quot;url(border.png) 30 30 round&quot;
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_border-image">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td> <i><a href="css3_pr_border-image-source.asp">border-image-source</a></i></td>
    <td>The path to the image to be used as a border</td>
    <td></td>
  </tr>
  <tr>
    <td> <i><a href="css3_pr_border-image-slice.asp">border-image-slice</a></i></td>
    <td>The inward offsets of the image-border</td>
    <td></td>
  </tr>
  <tr>
    <td> <i><a href="css3_pr_border-image-width.asp">border-image-width</a></i></td>
    <td>The widths of the image-border</td>
    <td></td>
  </tr>
  <tr>
    <td> <i><a href="css3_pr_border-image-outset.asp">border-image-outset</a></i></td>
    <td>The amount by which the border image area extends beyond the border box</td>
    <td></td>
  </tr>
  <tr>
    <td> <i><a href="css3_pr_border-image-repeat.asp">border-image-repeat</a></i></td>
    <td>Whether the image-border should be repeated, rounded or stretched</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image">Play it &raquo;</a></td>
  </tr>
	<tr>
    <td>initial</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss3_border-image_button">
Border-image button</a><br>
This example demonstrates how to create a button with the border-image property.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_border-image.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_border-image.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_border-image.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
