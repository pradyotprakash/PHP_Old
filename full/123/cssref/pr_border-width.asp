...
<style>a.menu_pr_border-width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_border-width" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The border-width property is supported in all major browsers.</p>
<hr>
...
<p>Examples:</p>
<ul>
	<li><b>border-width:thin medium thick 10px; </b>
	<ul><li>top border is thin</li>
	<li>right border is medium</li>
	<li>bottom border is thick</li>
	<li>left border is 10px</li></ul>
	<br>
	</li>
	<li><b>border-width:thin medium thick;</b>
	<ul><li>top border is thin</li>
	<li>right and left borders are medium</li>
	<li>bottom border is thick</li></ul>
	<br>
    </li>
	<li><b>border-width:thin medium;</b>
	<ul><li>top and bottom borders are thin</li>
	<li>right and left borders are medium</li></ul>
	<br>
	</li>
	<li><b>border-width:thin;</b><ul><li>all four borders are thin</li></ul>
	</li>
</ul>

<p><b>Note:</b> Always declare the border-style property before the border-width
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_border-width">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-width&amp;preval=medium">Play it &raquo;</a></td>		      
  </tr>
  <tr>
    <td>thin</td>
    <td>Specifies a thin border</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-width&amp;preval=thin">Play it &raquo;</a></td>		      
  </tr>
  <tr>
    <td>thick</td>
    <td>Specifies a thick border</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-width&amp;preval=thick">Play it &raquo;</a></td>		          
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Allows you to define the thickness of the border</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-width&amp;preval=10px">Play it &raquo;</a></td>		      
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-width&amp;preval=initial">Play it &raquo;</a></td>		      
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_border-width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_border-width.asp#top" target="_top">TOP</a> |
		<a href="pr_border-width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
