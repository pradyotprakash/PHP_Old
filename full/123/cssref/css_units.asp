...
<style>a.menu_css_units{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="css_colors.asp">Next Reference &raquo;</a></div>
</div>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>em</td>
    <td>1em is equal to the current font size. 2em means 2 times 
  ...
  <tr>
    <td>ex</td>
    <td>one ex is the x-height of a font (x-height is usually
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_units.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_units.asp#top" target="_top">TOP</a> |
		<a href="css_units.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
