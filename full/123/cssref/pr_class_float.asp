...
<style>a.menu_pr_class_float{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_float" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The float property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_float">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_float&amp;preval=none">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>left</td>
    <td>The element floats to the left</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_float&amp;preval=left">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>right</td>
    <td>The element floats the right</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_float&amp;preval=right">Play it &raquo;</a></td>        
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_float&amp;preval=initial">Play it &raquo;</a></td>    
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_class_float.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_class_float.asp#top" target="_top">TOP</a> |
		<a href="pr_class_float.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
