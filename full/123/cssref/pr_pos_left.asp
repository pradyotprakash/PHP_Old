...
<html lang="en-US">
<head>
<title>CSS left property</title>
<style>a.menu_pr_pos_left{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Set the left edge of the image 5px to the right of the left edge of its containing element:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_position_left" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>For absolutely positioned elements, the left property sets the left edge of an element to a unit to the left/right of the left edge of its containing element.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_left">Try it</a>
</td>
  </tr>
</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_left">Play it &raquo;</a></td>		                      
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Sets the left edge position in px, cm, etc. Negative values are allowed</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_left&amp;preval=50px">Play it &raquo;</a></td>		                          
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Sets the left edge position in % of containing element. 
	Negative values are allowed </td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_left&amp;preval=10%25">Play it &raquo;</a></td>	
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_left&amp;preval=initial">Play it &raquo;</a></td>	
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_pos_left.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_pos_left.asp#top" target="_top">TOP</a> |
		<a href="pr_pos_left.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
