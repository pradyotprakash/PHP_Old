...
<html lang="en-US">
<head>
<title>CSS3 overflow-x property</title>
<style>a.menu_css3_pr_overflow-x{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The overflow-x property is supported in all of the major browsers.</p>
<p><b>Note:</b> The overflow-x property does not work properly in IE8 and 
earlier.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The overflow-x property specifies whether or not to clip the left/right edges 
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_overflow-x">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	box</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow-x">Play it &raquo;</a></td>   		
  </tr>
  <tr>
    <td>hidden</td>
    <td>The content is clipped - and no scrolling mechanism is provided</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow-x&amp;preval=hidden">Play it &raquo;</a></td>   		    
  </tr>
  <tr>
    <td>scroll</td>
    <td>The content is clipped and a scrolling mechanism is provided</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow-x&amp;preval=scroll">Play it &raquo;</a></td>   		        
  </tr>
  <tr>
    <td>auto</td>
    <td>Should cause a scrolling mechanism to be provided for overflowing boxes</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow-x&amp;preval=auto">Play it &raquo;</a></td>   		        
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow-x&amp;preval=initial">Play it &raquo;</a></td>   		    	
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_overflow-x.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_overflow-x.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_overflow-x.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
