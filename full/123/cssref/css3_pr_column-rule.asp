...
<html lang="en-US">
<head>
<title>CSS3 column-rule property</title>
<style>a.menu_css3_pr_column-rule{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    div<br>
	{<br>
	column-rule:3px outset #ff00ff;<br>-moz-column-rule:3px outset #ff00ff; /* Firefox */<br>
	-webkit-column-rule:3px outset #ff00ff; /* Safari and Chrome */<br>
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_column-rule">Try it yourself &raquo;</a>
...
<p>The column-rule property is supported in Internet Explorer 10 and Opera.</p>
<p>Firefox supports an alternative, the -moz-column-rule property.</p>
<p>Safari and Chrome support an alternative, the -webkit-column-rule property.</p>
<p><strong>Note:</strong> The column-rule property is not supported in Internet Explorer 9 and earlier versions.&nbsp;</p>
<hr>

<h2>Definition and Usage</h2>
<p>The column-rule property is a shorthand property for setting all the 
column-rule-* properties.</p>
<p>The column-rule property sets the width, style, and color of the rule between 
columns.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_column-rule">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td> <i><a href="css3_pr_column-rule-width.asp">column-rule-width</a></i></td>
    <td>Sets the width of the rule between columns. Default value is medium</td>
  </tr>
  <tr>
    <td> <i><a href="css3_pr_column-rule-style.asp">column-rule-style</a></i></td>
    <td>Sets the style of the rule between columns. Default value is none</td>
  </tr>
  <tr>
    <td> <i><a href="css3_pr_column-rule-color.asp">column-rule-color</a></i></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_column-rule.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_column-rule.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_column-rule.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
