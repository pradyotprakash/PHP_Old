...
<style>a.menu_pr_pos_vertical-align{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_vertical-align" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The vertical-align property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_vertical-align">Try it</a>
</td>
  </tr>
</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	This is default</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=baseline">Play it &raquo;</a></td>                		
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Raises or lower an element by the specified length. 
	Negative values are allowed</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=25px">Play it &raquo;</a></td>                	
  </tr>
	<tr>
    <td>%</td>
    <td>Raises or lower an element in a percent of the &quot;line-height&quot;
      property. Negative values are allowed</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=50%25">Play it &raquo;</a></td>                	
  </tr>
  <tr>
    <td>sub</td>
    <td>Aligns the element as if it was subscript</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=sub">Play it &raquo;</a></td>                	
  </tr>
  <tr>
    <td>super</td>
    <td>Aligns the element as if it was superscript</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=super">Play it &raquo;</a></td>                	    
  </tr>
  <tr>
    <td>top</td>
    <td>The top of the element is aligned with the top of the 
    tallest element on the line</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=top">Play it &raquo;</a></td>                	    
  </tr>
  <tr>
    <td>text-top</td>
    <td>The top of the element is aligned with the top of
      the parent element's font</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=text-top">Play it &raquo;</a></td>                	      
  </tr>
  <tr>
    <td>middle</td>
    <td>The element is placed in the middle of the parent element</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=middle">Play it &raquo;</a></td>                	
  </tr>
  <tr>
    <td>bottom</td>
    <td>The bottom of the element is aligned with the
      lowest element on the line</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=bottom">Play it &raquo;</a></td>                	      
  </tr>
  <tr>
    <td>text-bottom</td>
    <td>The bottom of the element is aligned with the
      bottom of the parent element's font</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=text-bottom">Play it &raquo;</a></td>                	
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_vertical-align&amp;preval=initial">Play it &raquo;</a></td>                	
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_pos_vertical-align.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_pos_vertical-align.asp#top" target="_top">TOP</a> |
		<a href="pr_pos_vertical-align.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
