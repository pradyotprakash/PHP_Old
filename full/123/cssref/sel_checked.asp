...
<title>CSS3 :checked Selector</title>
<style>a.menu_sel_checked{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:checked</span> Selector</h1>
...
<p>Set a background color for all checked input elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_checked">Try it yourself &raquo;</a>
...
<p>The :checked selector 
matches every checked input element (only for radio buttons or checkboxes).</p>
<hr>
...
<p>The :checked selector is only supported in Opera.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_checked.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_checked.asp#top" target="_top">TOP</a> |
		<a href="sel_checked.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
