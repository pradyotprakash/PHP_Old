...
<style>a.menu_css3_pr_align-content{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Align the items of the flexible &lt;div&gt; element:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_align-content" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The align-content property is supported in Chrome and Opera.</p>
<hr>

<h2>Definition and Usage</h2>

<p>The align-content property aligns the flexible container's items when the items do not use all available space on the cross-axis (vertically).</p>

<p><strong>Tip:</strong> Use the justify-content property to align the items on the main-axis (horizontally).</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_align-content">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<tr>
    <td>stretch</td>
    <td>Default value. Items are stretched to fit the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-content&amp;preval=stretch">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>center</td>
    <td>Items are positioned at the center of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-content&amp;preval=center">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>flex-start</td>
    <td>Items are positioned at the beginning of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-content&amp;preval=flex-start">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>flex-end</td>
    <td>Items are positioned at the end of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-content&amp;preval=flex-end">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>space-between</td>
    <td>Items are positioned with space between the lines</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-content&amp;preval=space-between">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>space-around</td>
    <td>Items are positioned with space before, between, and after the lines</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-content&amp;preval=space-around">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="http://www.w3schools.com/cssref/css3_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-content&amp;preval=initial">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>inherit</td>
    <td>Inherits this property from its parent element. <a href="http://www.w3schools.com/cssref/css3_inherit.asp">Read about <em>inherit</em></a></td>
	<td></td>
    </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_align-content.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_align-content.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_align-content.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
