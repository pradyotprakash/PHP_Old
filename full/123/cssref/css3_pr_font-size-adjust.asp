...
<html lang="en-US">
<head>
<title>CSS3 font-size-adjust property</title>
<style>a.menu_css3_pr_font-size-adjust{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_font-size-adjust">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The font-size-adjust property is only supported in Firefox.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_font-size-adjust">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_font-size-adjust.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_font-size-adjust.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_font-size-adjust.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
