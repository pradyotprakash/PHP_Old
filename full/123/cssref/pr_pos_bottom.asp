...
<style>a.menu_pr_pos_bottom{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Set the bottom edge of the image to 5px above the bottom edge of its containing element:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_position_bottom" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>For absolutely positioned elements, the bottom property sets the bottom edge of an element to a unit above/below the bottom edge of its containing element.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_bottom">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	default</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_bottom">Play it &raquo;</a></td>		                  
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Sets the bottom edge position in px, cm, etc. Negative values are allowed
    </td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_bottom&amp;preval=50px">Play it &raquo;</a></td>		                  
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Sets the bottom edge position in % of containing element. 
	Negative values are allowed </td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_bottom_percent&amp;preval=10%25">Play it &raquo;</a></td>		                  
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_bottom_percent&amp;preval=initial">Play it &raquo;</a></td>		                  
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_pos_bottom.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_pos_bottom.asp#top" target="_top">TOP</a> |
		<a href="pr_pos_bottom.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
