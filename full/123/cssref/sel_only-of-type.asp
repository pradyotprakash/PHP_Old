...
<title>CSS3 :only-of-type Selector</title>
<style>a.menu_sel_only-of-type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:only-of-type</span> Selector</h1>
...
<p>Specify a background color for every p element that is the only child of its 
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_only-of-type">Try it yourself &raquo;</a>
...
<p>The :only-of-type selector 
matches every element that is the only child of its type, of its parent.</p>
<hr>
...
<p>The :only-of-type selector is supported in all major browsers, except IE8 
and earlier.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_only-of-type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_only-of-type.asp#top" target="_top">TOP</a> |
		<a href="sel_only-of-type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
