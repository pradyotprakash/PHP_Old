...
<style>a.menu_css3_pr_justify-content{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="nav">
<div class="prev"><a class="chapter" href="css3_pr_icon.asp">&laquo; Previous</a></div>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_justify-content" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The justify-content property is supported in Firefox, Opera, and Chrome.</p>
<hr>
...
<p><strong>Tip:</strong> Use the align-content property to align the items on the cross-axis (vertically).</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_justify-content">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_justify-content&amp;preval=flex-start">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>flex-end</td>
    <td>Items are positioned at the end of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_justify-content&amp;preval=flex-end">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>center</td>
    <td>Items are positioned at the center of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_justify-content&amp;preval=center">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>space-between</td>
    <td>Items are positioned with space between the lines</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_justify-content&amp;preval=space-between">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>space-around</td>
    <td>Items are positioned with space before, between, and after the lines</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_justify-content&amp;preval=space-around">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_justify-content&amp;preval=initial">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_justify-content.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_justify-content.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_justify-content.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
