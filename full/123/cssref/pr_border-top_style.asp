...
<style>a.menu_pr_border-top_style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-style" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The border-top-style property is supported in all major browsers.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_border-top-style">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
	  ...
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=none">Play it &raquo;</a></td>		      
    </tr>
    <tr>
      <td>hidden</td>
      <td>The same as &quot;none&quot;, except in border conflict
        resolution for table elements</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=hidden">Play it &raquo;</a></td>		
    </tr>
    <tr>
      <td>dotted</td>
      <td>Specifies a dotted border</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=dotted">Play it &raquo;</a></td>		
    </tr>
    <tr>
      <td>dashed</td>
      <td>Specifies a dashed border</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=dashed">Play it &raquo;</a></td>
    </tr>
    <tr>
      <td>solid</td>
      <td>Specifies a solid border</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=solid">Play it &raquo;</a></td>
    </tr>
    <tr>
      <td>double</td>
      <td>Specifies a double border</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=double">Play it &raquo;</a></td>
    </tr>
    <tr>
      <td>groove</td>
      <td>Specifies a 3D grooved border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=groove">Play it &raquo;</a></td>
    </tr>
    <tr>
      <td>ridge</td>
      <td>Specifies a 3D ridged border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=ridge">Play it &raquo;</a></td>
    </tr>
    <tr>
      <td>inset</td>
      <td>Specifies a 3D inset border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=inset">Play it &raquo;</a></td>
    </tr>
    <tr>
      <td>outset</td>
      <td>Specifies a 3D outset border. The effect depends on the
        border-color value</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=outset">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-top-style&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_border-top_style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_border-top_style.asp#top" target="_top">TOP</a> |
		<a href="pr_border-top_style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
