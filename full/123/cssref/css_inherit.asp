...
<style>a.menu_css_inherit{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">inherit</span> Keyword</h1>
<div class="chapter">
...
<p>Set the text-color for &lt;span&gt; elements to blue, except those inside elements with class="extra":</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_inherit" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The inherit keyword is supported in all major browsers.</p>
<p>The inherit keyword is not supported in IE7 and earlier. IE8 requires a !DOCTYPE.</p>

<hr>

<h2>Definition and Usage</h2>

<p>The inherit keyword specifies that a property should inherit its value from its parent element.</p>

<p>The inherit keyword can be used for any CSS property, and on any HTML element.</p>
...
<table class="tecspec">
    ...
    <td><i>object</i>.style.<em>property</em>=&quot;inherit&quot;
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_inherit">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<em>property</em>: inherit;</div></div>

<br>
<hr>

<h2>Related Pages</h2>
<p>CSS initial Keyword: <a href="css_initial.asp">initial keyword</a></p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_inherit.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_inherit.asp#top" target="_top">TOP</a> |
		<a href="css_inherit.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
