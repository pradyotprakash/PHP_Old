...
<h1>CSS <span class="color_h1">#<i>id</i></span> Selector</h1>
...
<p>Style the element with id=&quot;firstname":</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_id">Try it yourself &raquo;</a>
...
<p>The #<i>id</i> selector styles the element with the specified id.</p>
<hr>
...
<p>The #<i>id</i> selector is supported in all major browsers.</p>
