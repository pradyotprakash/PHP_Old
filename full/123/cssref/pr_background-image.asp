...
<style>a.menu_pr_background-image{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_background-image" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The background-image property is supported in all major browsers.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_background-image">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<p><a target="_blank" href="tryit.asp?filename=trycss3_background_multiple">
Multiple background images</a><br>
Set multiple background images for the document.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_background-image.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_background-image.asp#top" target="_top">TOP</a> |
		<a href="pr_background-image.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
