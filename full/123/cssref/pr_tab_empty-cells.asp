...
<html lang="en-US">
<head>
<title>CSS Empty-cells Property</title>
<style>a.menu_pr_tab_empty-cells{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_table_empty-cells" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The empty-cells property is supported in all major browsers.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_empty-cells">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
	...
	<tr>
		...
		is default</td>
		<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_empty-cells&amp;preval=show">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td>hide</td>
		<td>No background or borders are shown on empty cells</td>
		<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_empty-cells&amp;preval=hide">Play it &raquo;</a></td>
	</tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
		<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_empty-cells&amp;preval=initial">Play it &raquo;</a></td>		
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_tab_empty-cells.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_tab_empty-cells.asp#top" target="_top">TOP</a> |
		<a href="pr_tab_empty-cells.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
