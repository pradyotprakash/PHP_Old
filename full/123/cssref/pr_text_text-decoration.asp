...
<style>a.menu_pr_text_text-decoration{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_text-decoration" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The text-decoration property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_text-decoration">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration">Play it &raquo;</a></td>            
  </tr>
  <tr>
    <td>underline</td>
    <td>Defines a line below the text</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration&amp;preval=underline">Play it &raquo;</a></td>            
  </tr>
  <tr>
    <td>overline</td>
    <td>Defines a line above the text</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration&amp;preval=overline">Play it &raquo;</a></td>            
  </tr>
  <tr>
    <td>line-through</td>
    <td>Defines a line through the text</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration&amp;preval=line-through">Play it &raquo;</a></td>            
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration&amp;preval=initial">Play it &raquo;</a></td>            
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_text_text-decoration.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_text_text-decoration.asp#top" target="_top">TOP</a> |
		<a href="pr_text_text-decoration.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
