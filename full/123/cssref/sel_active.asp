...
<style>a.menu_sel_active{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:active</span> Selector</h1>
...
<p>Select and style the active link:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_active">Try it yourself &raquo;</a>
...
<p>A link becomes active when you click on it.</p>
...
<a href="sel_hover.asp">:hover</a> selector to style links when you mouse over 
them.</p>
<p><b>Note:</b> :active MUST come after :hover (if present) in the CSS 
...
<p>The :active selector is supported in all major browsers.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_active.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_active.asp#top" target="_top">TOP</a> |
		<a href="sel_active.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
