...
<style>a.menu_pr_class_position{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_position_absolute" class="tryitbtn">Try it yourself &raquo;</a>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_position">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_position">Play it &raquo;</a></td>		                  	
  </tr>
  <tr>
    <td>absolute</td>
    <td>The element is positioned relative to its first positioned (not static) 
	ancestor element</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_position&amp;preval=absolute">Play it &raquo;</a></td>		                  		
  </tr>
	<tr>
    <td>fixed</td>
    <td>The element is positioned relative to the browser window</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_position&amp;preval=fixed">Play it &raquo;</a></td>		                  		
  </tr>
  <tr>
    <td>relative</td>
    <td>The element is positioned relative to its normal position, so &quot;left:20&quot;
      adds 20 pixels to the element's LEFT position</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_position&amp;preval=relative">Play it &raquo;</a></td>		                  		      
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_position&amp;preval=initial">Play it &raquo;</a></td>		                  		      
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_class_position.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_class_position.asp#top" target="_top">TOP</a> |
		<a href="pr_class_position.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
