...
<html lang="en-US">
<head>
<title>CSS3 border-bottom-left-radius property</title>
<style>a.menu_css3_pr_border-bottom-left-radius{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_border-bottom-left-radius">Try it yourself &raquo;</a>
...
<p>The border-bottom-left-radius property is supported in IE9+, Firefox, Chrome, Safari, and Opera.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_border-bottom-left-radius">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-left-radius">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Defines the shape of the 
	bottom-left corner in %</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-left-radius&amp;preval=10%25">Play it &raquo;</a></td>	
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-left-radius&amp;preval=initial">Play it &raquo;</a></td>	
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_border-bottom-left-radius.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_border-bottom-left-radius.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_border-bottom-left-radius.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
