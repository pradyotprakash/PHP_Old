...
<html lang="en-US">
<head>
<title>CSS3 animation-name Property</title>
<style>a.menu_css3_pr_animation-name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    -webkit-animation-name:mymove; /* Safari and Chrome */</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_animation-name">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The animation-name property is supported in Internet Explorer 10, Firefox, and Opera.</p>
<p>Safari and Chrome support an alternative, the -webkit-animation-name property.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_animation-name">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_animation-name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_animation-name.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_animation-name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
