...
<style>a.menu_sel_hover{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:hover</span> Selector</h1>
...
<p>Select and style a link when you mouse over it:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_hover">Try it yourself &raquo;</a>
...
<p>The :hover selector is used to select elements when you mouse over them.</p>
<p><b>Tip:</b> The :hover selector can be used on all elements, not only 
on links.</p>
<p><b>Tip:</b> Use the <a href="sel_link.asp">:link</a> selector to style links to 
unvisited pages, the <a href="sel_visited.asp">:visited</a> selector to style 
links to visited pages, and the 
<a href="sel_active.asp">:active</a> selector to style the active link.</p>
<p><b>Note:</b> :hover MUST come after :link and :visited (if they are present) in the CSS definition, in order to be effective!</p>
<hr>
...
<p>The :hover selector is supported in all major browsers.</p>
<p><b>Note:</b> In IE there must be declared a&nbsp; <a href="../tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> 
for the :hover selector to work on other elements than the &lt;a&gt; element.</p>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="../css/css_link.asp">CSS Links</a></p>
<p>CSS tutorial: <a href="../css/css_pseudo_classes.asp">CSS Pseudo classes</a></p>
<hr>
...
<h2 class="example">Example</h2>
<p>Select and style unvisited, visited, hover, and active links:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_link_more1" class="tryitbtn">Try it yourself &raquo;</a>
...
<h2 class="example">Example</h2>
<p>Style links with different styles:</p>
<div class="example_code notranslate">
  
    a.ex1:hover,a.ex1:active {color:red;}<br>
	a.ex2:hover,a.ex2:active {font-size:150%;}<br>

  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_link_more2" class="tryitbtn">Try it yourself &raquo;</a>
...
<hr>
<a href="css_selectors.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Complete CSS Selector Reference" /> Complete CSS Selector Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_hover.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_hover.asp#top" target="_top">TOP</a> |
		<a href="sel_hover.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
