...
<style>a.menu_sel_lang{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:lang</span> Selector</h1>
...
<p>Select and style every &lt;p&gt; element with a lang attribute value equal to &quot;it" 
(Italian):</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_lang">Try it yourself &raquo;</a>
...
<p>The :lang() selector is used to select elements with a lang attribute with 
the specified value.</p>
<p><b>Note:</b> The lang attribute value is most often a two-letter language 
code, like lang=&quot;fr&quot; (for French), 
or two language codes combined, like lang=&quot;fr-ca&quot; (for Canadian French).</p>
...
<p>The :lang() selector is supported in all major browsers.</p>
<p><b>Note:</b> For :lang() to work in IE8, a <a href="../tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> must be declared.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_lang.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_lang.asp#top" target="_top">TOP</a> |
		<a href="sel_lang.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
