...
<style>a.menu_pr_text_text-transform{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_text-transform" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The text-transform property is supported in all major browsers.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_text-transform">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	default</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-transform">Play it &raquo;</a></td>                	
  </tr>
  <tr>
    <td>capitalize</td>
    <td>Transforms the first character of each word to uppercase</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-transform&amp;preval=capitalize">Play it &raquo;</a></td>                    
  </tr>
  <tr>
    <td>uppercase</td>
    <td>Transforms all characters to uppercase</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-transform&amp;preval=uppercase">Play it &raquo;</a></td>                    
  </tr>
  <tr>
    <td>lowercase</td>
    <td>Transforms all characters to lowercase</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-transform&amp;preval=lowercase">Play it &raquo;</a></td>                    
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-transform&amp;preval=initial">Play it &raquo;</a></td>                    
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_text_text-transform.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_text_text-transform.asp#top" target="_top">TOP</a> |
		<a href="pr_text_text-transform.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
