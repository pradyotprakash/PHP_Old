...
<style>a.menu_sel_attribute_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Style &lt;a&gt; elements with a target="_blank":</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_attribute_value">Try it yourself &raquo;</a>
...
<p>The [<i>attribute</i>=<i>value</i>] selector is used to select elements with the specified attribute and value.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_attribute_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_attribute_value.asp#top" target="_top">TOP</a> |
		<a href="sel_attribute_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
