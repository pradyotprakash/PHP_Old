...
<html lang="en-US">
<head>
<title>CSS3 animation-iteration-count Property</title>
<style>a.menu_css3_pr_animation-iteration-count{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    -webkit-animation-iteration-count:3; /*Safari and Chrome*/</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_animation-iteration-count">Try it yourself &raquo;</a>
...
<p>The animation-iteration-count property is supported in Internet Explorer 10, Firefox, and Opera.</p>
<p>Safari and Chrome support an alternative, the -webkit-animation-iteration-count property.</p>
...
<p>The animation-iteration-count property defines how many times an animation should be 
played.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_animation-iteration-count">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_animation-iteration-count&amp;preval=1">Play it &raquo;</a></td>			    
  </tr>
  <tr>
    <td>infinite</td>
    <td>Specifies that the animation should be played infinite times (for ever)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_animation-iteration-count&amp;preval=infinite">Play it &raquo;</a></td>			        
  </tr>
	<tr>
    <td>initial</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_animation-iteration-count.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_animation-iteration-count.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_animation-iteration-count.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
