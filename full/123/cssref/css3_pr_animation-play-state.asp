...
<html lang="en-US">
<head>
<title>CSS3 animation-play-state Property</title>
<style>a.menu_css3_pr_animation-play-state{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    -webkit-animation-play-state:paused; /* Safari and Chrome */</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_animation-play-state">Try it yourself &raquo;</a>
...
<p>The animation-play-state property is supported in Internet Explorer 10, Firefox, and Opera.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_animation-play-state">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_animation-play-state&amp;preval=paused">Play it &raquo;</a></td>			    
  </tr>
  <tr>
    <td>running</td>
    <td>Default value. Specifies that the animation is running</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_animation-play-state&amp;preval=running">Play it &raquo;</a></td>			        
  </tr>
	<tr>
    <td>initial</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_animation-play-state.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_animation-play-state.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_animation-play-state.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
