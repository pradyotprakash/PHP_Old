...
<style>a.menu_css3_pr_box-sizing{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_box-sizing">Try it yourself &raquo;</a>
...
<p>The box-sizing property is supported in Internet Explorer, Opera, Chrome, and 
Safari.</p>
<p>Firefox supports an alternative, the -moz-box-sizing property.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The box-sizing property allows you to define certain elements to fit an area 
in a certain way.</p>
<p>For example, if you want two bordered boxes side by side, it can be 
achieved through setting box-sizing to &quot;border-box&quot;. This forces the browser to 
render the box with the specified width and height, and place the border and 
padding inside the box.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_box-sizing">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td> content-box</td>
    <td>Default value. This is the behavior of width and height as specified by CSS2.1. The 
	specified width and height (and min/max properties) apply to the width and 
	height respectively of the content box of the element. The padding and 
	border of the element are laid out and drawn outside the specified width and 
	height</td>
  </tr>
  <tr>
    <td> border-box</td>
    <td>The specified width and height (and min/max properties) on this element 
	determine the border box of the element. That is, any padding or border 
	specified on the element is laid out and drawn inside this specified width 
	and height. The content width and height are calculated by subtracting the 
	border and padding widths of the respective sides from the specified 'width' 
	and 'height' properties</td>
  </tr>
	<tr>
    <td>initial</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_box-sizing.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_box-sizing.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_box-sizing.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
