...
<html lang="en-US">
<head>
<title>CSS3 transform property</title>
<style>a.menu_css3_pr_transform{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_transform">Try it yourself &raquo;</a>
...
<p>The transform property is supported in Internet Explorer 10 and Firefox.</p>
<p>Internet Explorer 9 supports an alternative, the -ms-transform property (2D transforms only).</p>
<p>Opera, Chrome and Safari support an alternative, the -webkit-transform property (3D 
and 2D transforms).</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_transform">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_rotate&amp;preval=none">Play it &raquo;</a></td>   			
  </tr>
  <tr>
    <td>matrix(<i>n,n,n,n,n,n</i>)</td>
    <td>Defines a 2D transformation, using a matrix of six values</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_matrix">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>matrix3d<br>
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_translate">Play it &raquo;</a></td>   			
  </tr>
  <tr>
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_translatex">Play it &raquo;</a></td>   			
  </tr>
  <tr>
    <td>translateY(<i>y</i>)</td>
    <td>Defines a translation, using only the value for the Y-axis</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_translatey">Play it &raquo;</a></td>   			
  </tr>
  <tr>
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_scale">Play it &raquo;</a></td>   			
  </tr>
  <tr>
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_scalex">Play it &raquo;</a></td>   			
  </tr>
  <tr>
    <td>scaleY(<i>y</i>)</td>
    <td>Defines a scale transformation by giving a value for the Y-axis</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_scaley">Play it &raquo;</a></td>   			
  </tr>
  <tr>
    <td>scaleZ(<i>z</i>)</td>
  ...
  <tr>
    ...
    <td>Defines a 2D rotation, the angle is specified in the 
		parameter</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_rotate">Play it &raquo;</a></td>   			
  </tr>
  <tr>
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_rotatex">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>rotateY(<i>angle</i>)</td>
    <td>Defines a 3D rotation along the Y-axis</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_rotatey">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>rotateZ(<i>angle</i>)</td>
    <td>Defines a 3D rotation along the Z-axis</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_rotatez">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>skew(<i>x-angle,y-angle</i>)</td>
    <td>Defines a 2D skew transformation along the X- and the Y-axis</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_skew">Play it &raquo;</a></td>   			
  </tr>
  <tr>
    <td>skewX(<i>angle</i>)</td>
    <td>Defines a 2D skew transformation along the X-axis</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_skewx">Play it &raquo;</a></td>   			
  </tr>
  <tr>
    <td>skewY(<i>angle</i>)</td>
    <td>Defines a 2D skew transformation along the Y-axis</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_transform_skewy">Play it &raquo;</a></td>   			
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_transform.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_transform.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_transform.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
