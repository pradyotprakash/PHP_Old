...
<html lang="en-US">
<head>
<title>CSS3 transition-property Property</title>
<style>a.menu_css3_pr_transition-property{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
	...
	-moz-transition-property: width; /* Firefox 4 */<br>
    -webkit-transition-property:width; /* Safari and Chrome */<br>
    -o-transition-property:width; /* Opera */<br>
	}<br>
	<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_transition-property">Try it yourself &raquo;</a>
...
<p>The transition-property property is supported in Internet Explorer 10, Firefox, Opera, and Chrome.</p>
<p>Safari supports an alternative, the -webkit-transition-property property.</p>
<p><strong>Note:</strong> The transition-property property is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>
...
changes).</p>
<p><b>Tip:</b> A transition effect could typically occur when a user hover over an 
element.</p>
<p><b>Note:</b> Always specify the transition-duration property, otherwise the duration 
is 0, and the transition will have no effect.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_transition-property">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<p><a target="_blank" href="tryit.asp?filename=trycss3_transition-property2">
Transition effect - change two properties</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_transition-property.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_transition-property.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_transition-property.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
