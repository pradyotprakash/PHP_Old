...
<html lang="en-US">
<head>
<title>CSS3 column-span property</title>
<style>a.menu_css3_pr_column-span{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    h2<br>
	{<br>
	column-span:all;<br>-webkit-column-span:all; /* Safari and Chrome */<br>
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_column-span">Try it yourself &raquo;</a>
...
<p>The column-span property is supported in Internet Explorer 10 and Opera.</p>
<p>Safari and Chrome support an alternative, the -webkit-column-span property.</p>
<p><strong>Note:</strong> The column-span property is not supported in Internet Explorer 9 and earlier versions.&nbsp;</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_column-span">Try it</a>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-span">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>all</td>
    <td>The element should span across all columns</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-span&amp;preval=all">Play it &raquo;</a></td>    
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-span&amp;preval=initial">Play it &raquo;</a></td>    
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_column-span.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_column-span.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_column-span.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
