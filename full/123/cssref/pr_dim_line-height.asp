...
<style>a.menu_pr_dim_line-height{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    p.small {line-height:90%}<br>
	p.big {line-height:200%}
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss_line-height" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The line-height property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_line-height">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_line-height">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td><i>number</i></td>
    <td>A number that will be multiplied with the current
      font size to set the line height</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_line-height&amp;preval=3">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>A fixed line height in px, pt, cm, etc.</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_line-height&amp;preval=25px">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>A line height in percent of the current font
      size</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_line-height&amp;preval=150%25">Play it &raquo;</a></td>          
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_line-height&amp;preval=initial">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss_dim_line-height_pixel">
Specify the space between lines using a pixel value</a><br>
This example demonstrates how to specify the space between the lines in a paragraph 
using a pixel value.</p>
<p><a target="_blank" href="tryit.asp?filename=trycss_dim_line-height_number">
Specify the space between lines using a number value</a><br>
This example demonstrates how to specify the space between the lines in a paragraph 
using a number value.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_dim_line-height.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_dim_line-height.asp#top" target="_top">TOP</a> |
		<a href="pr_dim_line-height.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
