...
<title>CSS3 :last-child Selector</title>
<style>a.menu_sel_last-child{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:last-child</span> Selector</h1>
...
<p>Specify a background color for the p element that is the last child of its 
parent:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_last-child">Try it yourself &raquo;</a>
...
<p>The :last-child selector 
matches every element that is the last child of its parent.</p>
<p><b>Tip:</b> p:last-child is equal to p:nth-last-child(1).</p>
<hr>
...
<p>The :last-child selector is supported in all of the major browsers.</p>
<p><b>Note:</b> The :last-child selector is not supported in IE8 and earlier 
versions.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_last-child.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_last-child.asp#top" target="_top">TOP</a> |
		<a href="sel_last-child.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
