...
<html lang="en-US">
<head>
<title>CSS3 background-origin property</title>
<style>a.menu_css3_pr_background-origin{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Position the background image relative to the content box:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_background-origin">Try it yourself &raquo;</a>
...
<p>The background-origin property is supported in IE9+, Firefox, Opera, Chrome, 
and Safari.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The background-origin property specifies what the background-position 
property should be relative to.</p>
<p><b>Note:</b> If the background-attachment property for the background image 
is &quot;fixed&quot;, this property has no effect.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_background-origin">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>padding-box</td>
    <td>Default value. The background image is positioned relative to the padding box</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-origin">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>border-box</td>
    <td>The background image is positioned relative to the border box</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-origin&amp;preval=border-box">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>content-box</td>
    <td>The background image is positioned relative to the content box</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-origin&amp;preval=content-box">Play it &raquo;</a></td>
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-origin&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_background-origin.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_background-origin.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_background-origin.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
