...
<title>CSS3 element1~element2 Selector</title>
<style>a.menu_sel_gen_sibling{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1"><i>element1</i>~<i>element2</i></span> Selector</h1>
...
<p>Set a background color for all ul elements that are preceded by a p element 
with the same parent:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_gen_sibling">Try it yourself &raquo;</a>
...
<p>The <i>element1</i>~<i>element2</i> selector 
matches occurrences of <i>element2</i> that are preceded 
by <i>element1</i>.</p>
<p>Both elements must have the same parent, but <i>element2</i> does not have to 
be immediately preceded by <i>element1</i>.</p>
<hr>
...
<p>The <i>element1</i>~<i>element2</i> selector is supported in all major browsers.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_gen_sibling.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_gen_sibling.asp#top" target="_top">TOP</a> |
		<a href="sel_gen_sibling.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
