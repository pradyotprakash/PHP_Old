...
<style>a.menu_sel_all{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">*</span> Selector</h1>
...
<p>Select all elements, and set their background color:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_all" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The * selector can also select all elements inside another element:</p>

<div class="example">


<h2 class="example">Example</h2>
<p>Select all elements inside &lt;div&gt; elements:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_all_div" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The * selector is supported in all major browsers.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_all.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_all.asp#top" target="_top">TOP</a> |
		<a href="sel_all.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
