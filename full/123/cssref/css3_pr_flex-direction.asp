...
<style>a.menu_css3_pr_flex-direction{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_flex-direction" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The flex-direction property is supported in Firefox, Opera, and Chrome.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_flex-direction">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_flex-direction&amp;preval=row">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>row-reverse</td>
    <td>Same as row, but in reverse order</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_flex-direction&amp;preval=row-reverse">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>column</td>
    <td>The flexible items are displayed vertically, as a column</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_flex-direction&amp;preval=column">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>column-reverse</td>
    <td>Same as column, but in reverse order</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_flex-direction&amp;preval=column-reverse">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_flex-direction&amp;preval=initial">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_flex-direction.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_flex-direction.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_flex-direction.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
