...
<style>a.menu_sel_visited{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:visited</span> Selector</h1>
...
<p>Select and style visited links:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_visited">Try it yourself &raquo;</a>
...
<p>The :visited selector is used to select visited links.</p>
<p><b>Tip:</b> Use the <a href="sel_link.asp">:link</a> selector to style links to 
unvisited pages, the <a href="sel_hover.asp">:hover</a> selector to style links when you mouse over them, and the 
...
<p>The :visited selector is supported in all major browsers.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_visited.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_visited.asp#top" target="_top">TOP</a> |
		<a href="sel_visited.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
