...
<html lang="en-US">
<head>
<title>CSS margin-bottom property</title>
<style>a.menu_pr_margin-bottom{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_margin-bottom" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The margin-bottom property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_margin-bottom">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_margin-bottom&amp;preval=10px">Play it &raquo;</a></td>		                  
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Specifies a bottom margin in percent of the width of the 
	containing element</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_margin-bottom&amp;preval=10%25">Play it &raquo;</a></td>		                  
  </tr>
  <tr>
    <td>auto</td>
    <td>The browser calculates a bottom margin</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_margin-bottom&amp;preval=auto">Play it &raquo;</a></td>		                  
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_margin-bottom&amp;preval=initial">Play it &raquo;</a></td>		                  
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_margin-bottom.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_margin-bottom.asp#top" target="_top">TOP</a> |
		<a href="pr_margin-bottom.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
