...
<style>a.menu_sel_link{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:link</span> Selector</h1>
...
<p>Select and style unvisited links:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_link">Try it yourself &raquo;</a>
...
<p><b>Note:</b> The :link selector does not style links you have already visited.</p>
<p><b>Tip:</b> Use the <a href="sel_visited.asp">:visited</a> selector to style links to visited pages, the 
<a href="sel_hover.asp">:hover</a> selector to style links when you mouse over them, and the 
<a href="sel_active.asp">:active</a> selector to style links when you click on them.</p>
<hr>
...
<p>The :link selector is supported in all major browsers.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_link.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_link.asp#top" target="_top">TOP</a> |
		<a href="sel_link.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
