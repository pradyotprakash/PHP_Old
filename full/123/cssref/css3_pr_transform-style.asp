...
<html lang="en-US">
<head>
<title>CSS3 transform-style property</title>
<style>a.menu_css3_pr_transform-style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
	...
	-webkit-transform: rotateY(60deg); /* Safari and Chrome */<br>
	-webkit-transform-style: preserve-3d; /* Safari and Chrome */<br>
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_transform-style">Try it yourself &raquo;</a>
...
<p>The transform-style property is supported in Firefox.</p>
<p>Chrome and Safari support an alternative, the -webkit-transform-style property.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_transform-style">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>flat</td>
    <td>Default value. The child elements will NOT preserve its 
	3D position</td>
  </tr>
  <tr>
    <td>preserve-3d</td>
    <td>The child elements will preserve its 3D position</td>
  </tr>
	<tr>
    <td>initial</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_transform-style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_transform-style.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_transform-style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
