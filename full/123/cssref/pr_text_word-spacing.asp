...
<style>a.menu_pr_text_word-spacing{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Specify that the space between words in paragraphs should be 30 pixels:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_text_word-spacing" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The word-spacing property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_word-spacing">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_word-spacing">Play it &raquo;</a></td>                	
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Defines an extra space between words in px, pt, cm, em, 
	etc. Negative values are allowed&nbsp;</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_word-spacing&amp;preval=10px">Play it &raquo;</a></td>                		
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_word-spacing&amp;preval=initial">Play it &raquo;</a></td>                		
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_text_word-spacing.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_text_word-spacing.asp#top" target="_top">TOP</a> |
		<a href="pr_text_word-spacing.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
