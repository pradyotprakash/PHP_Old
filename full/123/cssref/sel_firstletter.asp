...
<style>a.menu_sel_firstletter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:first-letter</span> Selector</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_firstletter">Try it yourself &raquo;</a>
...
<p>The :first-letter selector is used to add a style to the first letter of the specified selector.</p>

<p><b>Note:</b> The following properties can be used with :first-letter:&nbsp;</p>
<ul>
...
<p><b>Note:</b> The &quot;first-letter&quot; selector can only be used with block-level elements.</p>
<hr>
...
<p>The :first-letter selector is supported in all major browsers.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_firstletter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_firstletter.asp#top" target="_top">TOP</a> |
		<a href="sel_firstletter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
