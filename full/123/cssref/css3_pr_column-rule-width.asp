...
<html lang="en-US">
<head>
<title>CSS3 column-rule-width property</title>
<style>a.menu_css3_pr_column-rule-width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    div<br>
	{<br>
	column-rule-width:10px;<br>-moz-column-rule-width:10px; /* Firefox */<br>
	-webkit-column-rule-width:10px; /* Safari and Chrome */<br>
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_column-rule-width">Try it yourself &raquo;</a>
...
<p>The column-rule-width property is supported in Internet Explorer 10 and 
Opera.</p>
<p>Firefox supports an alternative, the -moz-column-rule-width property.</p>
<p>Safari and Chrome support an alternative, the -webkit-column-rule-width property.</p>
<p><strong>Note:</strong> The column-rule-width property is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_column-rule-width">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-width&amp;preval=medium">Play it &raquo;</a></td>			    	            
  </tr>
  <tr>
    <td> thin</td>
    <td>Defines a thin rule</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-width&amp;preval=thin">Play it &raquo;</a></td>			    	        
  </tr>
  <tr>
    <td> thick</td>
    <td>Defines a thick rule</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-width&amp;preval=thick">Play it &raquo;</a></td>			    	                
  </tr>
  <tr>
    <td> <i>length</i></td>
    <td>Specifies the width of the rule</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-width&amp;preval=1px">Play it &raquo;</a></td>			    	                
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-width&amp;preval=initial">Play it &raquo;</a></td>			    	                
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_column-rule-width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_column-rule-width.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_column-rule-width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
