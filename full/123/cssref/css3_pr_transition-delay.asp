...
<html lang="en-US">
<head>
<title>CSS3 transition-delay  Property</title>
<style>a.menu_css3_pr_transition-delay{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_transition-delay">Try it yourself &raquo;</a>
...
<p>The transition-delay property is supported in Internet Explorer 10, Firefox, Opera, 
and Chrome.</p>
<p>Safari supports an alternative, the -webkit-transition-delay property.</p>
<p><strong>Note:</strong> The transition-delay property is not supported in Internet Explorer 9 and earlier versions.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_transition-delay">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_transition-delay.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_transition-delay.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_transition-delay.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
