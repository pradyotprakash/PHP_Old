...
<style>a.menu_sel_firstline{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:first-line</span> Selector</h1>
...
<p>Select and style the first line of every &lt;p&gt; element:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_firstline">Try it yourself &raquo;</a>
...
<p>The :first-line selector is used to add a style to the first line of the specified selector.</p>
<p><b>Note:</b> The following properties can be used with :first-line:&nbsp;</p>
<ul>
...
<p><b>Note:</b> The &quot;first-line&quot; selector can only be used with block-level elements.</p>
<hr>
...
<p>The :first-line selector is supported in all major browsers.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_firstline.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_firstline.asp#top" target="_top">TOP</a> |
		<a href="sel_firstline.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
