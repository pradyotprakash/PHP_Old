...
<html lang="en-US">
<head>
<title>CSS3 column-rule-color property</title>
<style>a.menu_css3_pr_column-rule-color{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    div<br>
	{<br>
	column-rule-color:#ff0000;<br>-moz-column-rule-color:#ff0000; /* Firefox */<br>
	-webkit-column-rule-color:#ff0000; /* Safari and Chrome */<br>
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_column-rule-color">Try it yourself &raquo;</a>
...
<p>The column-rule-color property is supported in Internet Explorer 10 and Opera.</p>
<p>Firefox supports an alternative, the -moz-column-rule-color property.</p>
<p>Safari and Chrome support an alternative, the -webkit-column-rule-color property.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_column-rule-color">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-color">Play it &raquo;</a></td>			    	
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-color&amp;preval=initial">Play it &raquo;</a></td>			    	
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_column-rule-color.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_column-rule-color.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_column-rule-color.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
