...
<html lang="en-US">
<head>
<title>CSS border-top property</title>
<style>a.menu_pr_border-top{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_border-top" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The border-top property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_border-top">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i><a href="pr_border-top_width.asp">border-top-width</a></i></td>
    <td>Specifies the width of the top border. Default value is "medium"</td>
  </tr>
  <tr>
    <td><i><a href="pr_border-top_style.asp">border-top-style</a></i></td>
    <td>Specifies the style of the top border. Default value is "none"</td>
  </tr>
  <tr>
    <td><i><a href="pr_border-top_color.asp">border-top-color</a></i></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_border-top.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_border-top.asp#top" target="_top">TOP</a> |
		<a href="pr_border-top.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
