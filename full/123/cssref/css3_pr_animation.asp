...
<html lang="en-US">
<head>
<title>CSS3 animation Property</title>
<style>a.menu_css3_pr_animation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_animation">Try it yourself &raquo;</a>
...
<p>The animation property is supported in Internet Explorer 10, Firefox, and Opera.</p>
<p>Safari and Chrome support an alternative, the -webkit-animation property.</p>
<p><strong>Note:</strong> The animation property is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>
<h2>Definition and Usage</h2>
<p>The animation property is a shorthand property for six of the animation properties:</p>
<p>animation-name<br>
...
<p><b>Note:</b> Always specify the animation-duration property, otherwise the duration 
is 0, and will never be played.</p>
<table class="tecspec">
  <tr>
    <th style="width:25%">Default value:</th>
    <td width="75%">none 0 ease 0 1 normal none running</td>
  </tr>
	<tr>
    <th>Inherited:</th>
    <td>no</td>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_animation">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_animation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_animation.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_animation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
