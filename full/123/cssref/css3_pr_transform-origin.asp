...
<html lang="en-US">
<head>
<title>CSS3 transform-origin property</title>
<style>a.menu_css3_pr_transform-origin{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
	...
	-webkit-transform: rotate(45deg); /* Safari and Chrome */<br>
	-webkit-transform-origin:20% 40%; /* Safari and Chrome */<br>
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_transform-origin">Try it yourself &raquo;</a>
...
<p>The transform-origin property is supported in Internet Explorer 10, Firefox, 
and Opera.</p>
<p>Internet Explorer 9 supports an alternative, the -ms-transform-origin property, but only for 2D-transforms.</p>
<p>Safari and Chrome supports an alternative, the -webkit-transform-origin property, on both 2D- and 3D-transfoms.</p>
<p>Opera supports 2D transforms only.</p>

<hr>

<h2>Definition and Usage</h2>
<p>The transform-origin property allows you to change the position on transformed elements.</p>
<p>2D transformed element can change the x- and y-axis of the element. 3D transformed element can also 
change the z-axis of the element.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_transform-origin">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
    <th style="width:20%">Property Value</th>
    <th>Description</th>
  </tr>  
  <tr>
    <td><i>x-axis</i></td>
    <td>Defining where the view is placed at the x-axis. Possible values:<ul>
		<li>left</li>
		<li>center</li>
		<li>right</li>
		<li><i>length</i></li>
  ...
  <tr>
    <td><i>y-axis</i></td>
    <td>Defining where the view is placed at the y-axis. Possible values:<ul>
		<li>top</li>
		<li>center</li>
		<li>bottom</li>
		<li><i>length</i></li>
  ...
  <tr>
    <td><i>z-axis</i></td>
    <td>Defining where the view is placed at the z-axis. Possible values:<ul>
		<li><i>length</i></li>
	</ul>
	</td>
  </tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_transform-origin.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_transform-origin.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_transform-origin.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
