...
<style>a.menu_css3_pr_background-clip{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_background-clip">Try it yourself &raquo;</a>
...
<p>The background-clip property is supported in Internet Explorer 9+, Firefox, Opera, Chrome, and Safari.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_background-clip">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>border-box</td>
    <td>The background is clipped to the border box</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-clip">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>padding-box</td>
    <td>The background is clipped to the padding box</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-clip&amp;preval=padding-box">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>content-box</td>
    <td>The background is clipped to the content box</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-clip&amp;preval=content-box">Play it &raquo;</a></td>
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-clip&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_background-clip.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_background-clip.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_background-clip.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
