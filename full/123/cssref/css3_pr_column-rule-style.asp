...
<html lang="en-US">
<head>
<title>CSS3 column-rule-style property</title>
<style>a.menu_css3_pr_column-rule-style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    div<br>
	{<br>
	column-rule-style:dotted;<br>-moz-column-rule-style:dotted; /* Firefox */<br>
	-webkit-column-rule-style:dotted; /* Safari and Chrome */<br>
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_column-rule-style">Try it yourself &raquo;</a>
...
<p>The column-rule-style property is supported in Internet Explorer 10 and 
Opera.</p>
<p>Firefox supports an alternative, the -moz-column-rule-style property.</p>
<p>Safari and Chrome support an alternative, the -webkit-column-rule-style property.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_column-rule-style">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style">Play it &raquo;</a></td>			    	    
  </tr>
  <tr>
    <td> hidden</td>
    <td>Defines a hidden rule</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style&amp;preval=hidden">Play it &raquo;</a></td>			    	        
  </tr>
  <tr>
    <td> dotted</td>
    <td>Defines a dotted rule</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style&amp;preval=dotted">Play it &raquo;</a></td>			    	            
  </tr>
  <tr>
    <td> dashed</td>
    <td>Defines a dashed rule</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style&amp;preval=dashed">Play it &raquo;</a></td>			    	            
  </tr>
  <tr>
    <td> solid</td>
    <td>Defines a solid rule</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style&amp;preval=solid">Play it &raquo;</a></td>			    	            
  </tr>
  <tr>
    <td> double</td>
    <td>Defines a double rule</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style&amp;preval=double">Play it &raquo;</a></td>			    	            
  </tr>
  <tr>
    <td> groove</td>
    <td>Specifies a 3D grooved rule. The effect depends on the width and color 
	values</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style&amp;preval=groove">Play it &raquo;</a></td>			    	        	
  </tr>
  <tr>
    <td> ridge</td>
    <td>Specifies a 3D ridged rule. The effect depends on the width and color 
	values</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style&amp;preval=ridge">Play it &raquo;</a></td>			    	        	
  </tr>
  <tr>
    <td> inset</td>
    <td>Specifies a 3D inset rule. The effect depends on the width and color 
	values</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style&amp;preval=inset">Play it &raquo;</a></td>			    	        	
  </tr>
  <tr>
    <td> outset</td>
    <td>Specifies a 3D outset rule. The effect depends on the width and color 
	values</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style&amp;preval=outset">Play it &raquo;</a></td>			    	        	
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-rule-style&amp;preval=initial">Play it &raquo;</a></td>			    	        	
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss3_column-count">
Column-count</a><br>
Divide the text in a div element into three columns.</p>
<p><a target="_blank" href="tryit.asp?filename=trycss3_column-gap">Column-gap</a><br>
Divide the text in a div element into three columns, and specify a 30 pixels gap 
between the columns.</p>
<p><a target="_blank" href="tryit.asp?filename=trycss3_column-rule">Column-rule</a><br>
Specify the width, style and color of the rule between columns.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_column-rule-style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_column-rule-style.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_column-rule-style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
