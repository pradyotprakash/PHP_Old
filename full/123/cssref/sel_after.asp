...
<style>a.menu_sel_after{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:after</span> Selector</h1>
...
<p>Insert content after every &lt;p&gt; element:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_after">Try it yourself &raquo;</a>
...
<p>The :after selector inserts content after the selected element(s).</p>
...
<p>The :after selector is supported in all major browsers.</p>
<p><b>Note:</b> For :after to work in IE8, a <a href="../tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> 
must be declared.</p>
...
<p>CSS Selector Reference: <a href="sel_before.asp">CSS :before selector</a></p>
...
<h2 class="example">Example</h2>
<p>Insert content after every &lt;p&gt; element, and style the inserted content:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_after_style" class="tryitbtn">Try it yourself &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_after.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_after.asp#top" target="_top">TOP</a> |
		<a href="sel_after.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
