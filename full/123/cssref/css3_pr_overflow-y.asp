...
<html lang="en-US">
<head>
<title>CSS3 overflow-y property</title>
<style>a.menu_css3_pr_overflow-y{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_overflow-xy">Try it yourself &raquo;</a>
...
<p>The overflow-y property is supported in all of the major browsers.</p>
<p><b>Note:</b> The overflow-y property does not work properly in IE8 and 
earlier.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The overflow-y property specifies whether or not to clip the top/bottom edges 
of the content - if it overflows the element's 
	content area.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_overflow-y">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	box</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow-y">Play it &raquo;</a></td>   		        	
  </tr>
  <tr>
    <td>hidden</td>
    <td>The content is clipped - and no scrolling mechanism is provided</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow-y&amp;preval=hidden">Play it &raquo;</a></td>   		        
  </tr>
  <tr>
    <td>scroll</td>
    <td>The content is clipped and a scrolling mechanism is provided</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow-y&amp;preval=scroll">Play it &raquo;</a></td>   		            
  </tr>
  <tr>
    <td>auto</td>
    <td>Should cause a scrolling mechanism to be provided for overflowing boxes</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow-y&amp;preval=auto">Play it &raquo;</a></td>   		            
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow-y&amp;preval=initial">Play it &raquo;</a></td>   		            
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_overflow-y.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_overflow-y.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_overflow-y.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
