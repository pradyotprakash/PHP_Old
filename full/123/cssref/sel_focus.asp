...
<style>a.menu_sel_focus{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:focus</span> Selector</h1>
...
<p>Select and style an input field when it gets focus:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_focus">Try it yourself &raquo;</a>
...
<p><b>Tip:</b> The :focus selector is allowed on elements that accept keyboard events or other user inputs.</p>
<hr>
...
<p>The :focus selector is supported in all major browsers.</p>
<p><b>Note:</b> For :focus to work in IE8, a <a href="../tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> must be declared.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_focus.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_focus.asp#top" target="_top">TOP</a> |
		<a href="sel_focus.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
