...
<style>a.menu_pr_text_text-align{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_text-align" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The text-align property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_text-align">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align">Play it &raquo;</a></td>        
  </tr>
  <tr>
    <td>right</td>
    <td>Aligns the text to the right</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align&amp;preval=right">Play it &raquo;</a></td>            
  </tr>
  <tr>
    <td>center</td>
    <td>Centers the text</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align&amp;preval=center">Play it &raquo;</a></td>                
  </tr>
  <tr>
    <td>justify</td>
    <td>Stretches the lines so that each line has equal width (like 
	in newspapers and magazines)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align&amp;preval=justify">Play it &raquo;</a></td>            	
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align&amp;preval=initial">Play it &raquo;</a></td>            	
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss_text-align_all">More advanced text-align example</a><br>
This example demonstrates a more advanced text-align example.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_text_text-align.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_text_text-align.asp#top" target="_top">TOP</a> |
		<a href="pr_text_text-align.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
