...
<title>CSS3 :empty Selector</title>
<style>a.menu_sel_empty{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:empty</span> Selector</h1>
...
<p>Specify a background color for empty p elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_empty">Try it yourself &raquo;</a>
...
<p>The :empty selector 
matches every element that has no children (including text nodes).</p>
<hr>
...
<p>The :empty selector is supported in all major browsers, except IE8 and 
earlier.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_empty.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_empty.asp#top" target="_top">TOP</a> |
		<a href="sel_empty.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
