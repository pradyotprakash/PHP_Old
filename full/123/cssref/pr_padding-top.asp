...
<html lang="en-US">
<head>
<title>CSS padding-top property</title>
<style>a.menu_pr_padding-top{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_padding-top" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The padding-top property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_padding-top">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_padding-top">Play it &raquo;</a></td>		                  
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Specifies a top padding in percent of the width of the 
	containing element</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_padding-top&amp;preval=20%25">Play it &raquo;</a></td>		                  	
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_padding-top&amp;preval=initial">Play it &raquo;</a></td>		                  	
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_padding-top.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_padding-top.asp#top" target="_top">TOP</a> |
		<a href="pr_padding-top.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
