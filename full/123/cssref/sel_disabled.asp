...
<title>CSS3 :disabled Selector</title>
<style>a.menu_sel_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:disabled</span> Selector</h1>
...
<p>Set a background color for all disabled input elements of type=&quot;text&quot;:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_enabled_disabled">Try it yourself &raquo;</a>
...
<p>The :disabled selector 
matches every disabled element (mostly used on form elements).</p>
<hr>
...
<p>The :disabled selector is supported in all major browsers, except IE8 and 
earlier.</p>
<hr>
...
<h2 class="example">Example</h2>
<p>Set a background color for all disabled input elements:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_enabled_disabled2">Try it yourself &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_disabled.asp#top" target="_top">TOP</a> |
		<a href="sel_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
