...
<html lang="en-US">
<head>
<title>CSS3 background-size property</title>
<style>a.menu_css3_pr_background-size{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_background-size">Try it yourself &raquo;</a>
...
<p>The background-size property is supported in IE9+, Firefox, Opera, Chrome, 
and Safari.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_background-size">Try it</a>
</td>
  </tr>
	</table>
<br>
...
background-size: auto|<i>length</i>|cover|contain|intial|inherit;</div></div>
<br>
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-size&amp;preval=auto">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><em>length</em></td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-size&amp;preval=200px">Play it &raquo;</a></td>
  </tr>
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-size&amp;preval=50%25">Play it &raquo;</a></td>	
  </tr>
  <tr>
    <td> cover</td>
	...
	area</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-size&amp;preval=cover">Play it &raquo;</a></td>		
  </tr>
  <tr>
    <td> contain</td>
    <td>Scale the image to the largest size such that both its width and its 
	height can fit inside the content area</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-size&amp;preval=contain">Play it &raquo;</a></td>		
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-size&amp;preval=initial">Play it &raquo;</a></td>		
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss3_background-size2">Stretch 
the background-image</a><br>
Stretch the background image to completely cover the content area.</p>
<p><a target="_blank" href="tryit.asp?filename=trycss3_background-size3">Stretch 
the background-image to four copies horizontally</a><br>
Stretch the background image so that exactly four copies fit horizontally.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_background-size.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_background-size.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_background-size.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
