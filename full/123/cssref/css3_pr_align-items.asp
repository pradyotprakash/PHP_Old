...
<style>a.menu_css3_pr_align-items{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_align-items" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The align-items property is supported in IE11, Firefox, Chrome and Opera</p>
<p>The align-items property is not supported in Safari, IE 9 or earlier. IE 10 requires the prefix -ms-.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_align-items">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-items&amp;preval=stretch">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>center</td>
    <td>Items are positioned at the center of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-items&amp;preval=center">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>flex-start</td>
    <td>Items are positioned at the beginning of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-items&amp;preval=flex-start">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>flex-end</td>
    <td>Items are positioned at the end of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-items&amp;preval=flex-end">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>baseline</td>
    <td>Items are positioned at the baseline of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-items&amp;preval=baseline">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>initial</td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-items&amp;preval=initial">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_align-items.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_align-items.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_align-items.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
