...
<html lang="en-US">
<head>
<title>CSS order property</title>
<style>a.menu_css3_pr_order{font-weight:bold;}</style>
<meta charset="utf-8">
...
div#myRedDIV   {order:2;}<br>
div#myBlueDIV  {order:4;}<br>
div#myGreenDIV {order:3;}<br>
div#myPinkDIV  {order:1;}<br>
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_order" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The order property is supported in Firefox, Opera, and Chrome.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_order">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_order.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_order.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_order.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
