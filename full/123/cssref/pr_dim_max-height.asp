...
<style>a.menu_pr_dim_max-height{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Set the maximum height of a paragraph:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_dim_max-height" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The max-height property is supported in all major browsers.</p>
<p><strong>Note:</strong> IE6 and earlier versions do not support the max-height property.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_max-height">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_max-height">Play it &raquo;</a></td>		              
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Defines the maximum height in px, cm, etc.&nbsp;</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_max-height&amp;preval=270px">Play it &raquo;</a></td>		              
  </tr>
  <tr>
    <td><i>%</i></td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_max-height&amp;preval=initial">Play it &raquo;</a></td>		              
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_dim_max-height.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_dim_max-height.asp#top" target="_top">TOP</a> |
		<a href="pr_dim_max-height.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
