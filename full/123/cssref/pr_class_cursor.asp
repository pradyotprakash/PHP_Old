...
<style>a.menu_pr_class_cursor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_cursor" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The cursor property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_cursor">Try it</a>
</td>
  </tr>
</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=alias">Play it &raquo;</a></td>		                      
  </tr>
  <tr>
    <td>all-scroll</td>
    <td>The cursor indicates that something can be scrolled in any direction</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=all-scroll">Play it &raquo;</a></td>		                      
  </tr>
  <tr>
    <td>auto</td>
    <td>Default. The browser sets a cursor</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor">Play it &raquo;</a></td>		                  
  </tr>
	<tr>
    <td>cell</td>
    <td>The cursor indicates that a cell (or set of cells) may be selected</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=cell">Play it &raquo;</a></td>		                      
  </tr>
	<tr>
    <td>context-menu</td>
    <td>The cursor indicates that a context-menu is available</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=context-menu">Play it &raquo;</a></td>		                      
  </tr>
	<tr>
    <td>col-resize</td>
    <td>The cursor indicates that the column can be resized horizontally</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=col-resize">Play it &raquo;</a></td>		                      
  </tr>
	<tr>
    <td>copy</td>
    <td>The cursor indicates something is to be copied</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=copy">Play it &raquo;</a></td>		                      
  </tr>
	<tr>
    <td>crosshair</td>
    <td>The cursor render as a crosshair</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=crosshair">Play it &raquo;</a></td>		                      
  </tr>
  <tr>
    <td>default</td>
    <td>The default cursor</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=default">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>e-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved right (east)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=e-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>ew-resize</td>
    <td>Indicates a bidirectional resize cursor</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=ew-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>help</td>
    <td>The cursor indicates that help is available</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=help">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>move</td>
    <td>The cursor indicates something is to be moved</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=move">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>n-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved up (north)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=n-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>ne-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved up and right (north/east)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=ne-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>nesw-resize</td>
    <td>Indicates a bidirectional resize cursor</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=nesw-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>ns-resize</td>
    <td>Indicates a bidirectional resize cursor</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=ns-resize">Play it &raquo;</a></td>
  </tr>
    <tr>
    <td>nw-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved up and left (north/west)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=nw-resize">Play it &raquo;</a></td>
	</tr>
  <tr>
    <td>nwse-resize</td>
    <td>Indicates a bidirectional resize cursor</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=nwse-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>no-drop</td>
    <td>The cursor indicates that the dragged item cannot be dropped here</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=no-drop">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>none</td>
    <td>No cursor is rendered for the element</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=none">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>not-allowed</td>
    <td>The cursor indicates that the requested action will not be executed</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=not-allowed">Play it &raquo;</a></td>
  </tr>
	<tr>
    <td>pointer</td>
    <td>The cursor is a pointer and indicates a link</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=pointer">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>progress</td>
    <td>The cursor indicates that the program is busy (in progress)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=progress">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>row-resize</td>
    <td>The cursor indicates that the row can be resized vertically</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=row-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>s-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved down (south)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=s-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>se-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved down and right (south/east)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=se-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>sw-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved down and left (south/west)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=sw-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>text</td>
    <td>The cursor indicates text that may be selected</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=text">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>URL</i></td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=url(smiley.gif),url(myBall.cur),auto">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>vertical-text</td>
    <td>The cursor indicates vertical-text that may be selected</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=vertical-text">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>w-resize</td>
    <td>The cursor indicates that an edge of a box is to be moved left (west)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=w-resize">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>wait</td>
    <td>The cursor indicates that the program is busy</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=wait">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>zoom-in</td>
    <td>The cursor indicates that something can be zoomed in</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=zoom-in">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>zoom-out</td>
    <td>The cursor indicates that something can be zoomed out</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=zoom-out">Play it &raquo;</a></td>
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_cursor&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<a href="../jsref/prop_style_cursor.asp">cursor property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_class_cursor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_class_cursor.asp#top" target="_top">TOP</a> |
		<a href="pr_class_cursor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
