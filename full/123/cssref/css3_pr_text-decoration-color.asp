...
<style>a.menu_css3_pr_text-decoration-color{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_text-decoration-color" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The text-decoration-color property is not supported in any of the major browsers.</p>
<p>Firefox supports an alternative, the -moz-text-decoration-color property.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_text-decoration-color">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-color&amp;preval=red">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-color&amp;preval=initial">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_text-decoration-color.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_text-decoration-color.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_text-decoration-color.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
