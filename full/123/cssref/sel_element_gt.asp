...
<style>a.menu_sel_element_gt{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1"><i>element>element</i></span> Selector</h1>
...
<p>Select and style every &lt;p&gt; element where the parent is a &lt;div&gt; element:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_element_gt" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The <i>element&gt;element</i> selector is used to select elements with a specific parent.</p>
<p><b>Note:</b> Elements that are not directly a child of the specified parent, 
are not selected.</p>
<hr>
...
<p>The <i>element&gt;element</i> selector is supported in all major browsers.</p>
<p><b>Note:</b> For <i>element&gt;element</i> to work in IE8 and earlier, a <a href="../tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> must be declared.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_element_gt.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_element_gt.asp#top" target="_top">TOP</a> |
		<a href="sel_element_gt.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
