...
<html lang="en-US">
<head>
<title>CSS3 nav-down property</title>
<style>a.menu_css3_pr_nav-down{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The nav-down property is currently supported only in Opera.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_nav-down.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_nav-down.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_nav-down.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
