...
<html lang="en-US">
<head>
<title>CSS3 border-image-slice property</title>
<style>a.menu_css3_pr_border-image-slice{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Specify the inward offsets of the image-border:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_border-image-slice">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The border-image-slice property is not supported in Opera.</p>
<p>The border-image-slice property is not supported in Internet Explorer 10 and earlier.</p>
<p>The border-image-slice property is not supported in Safari 5 and earlier.</p>
<p>Look at the <a href="css3_pr_border-image.asp">border-image</a> property 
instead!</p>
<hr>

<h2>Definition and Usage</h2>
<p>The border-image-slice property specifies the inward offsets of the 
image-border.</p>
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.borderImageSlice=&quot;50% 10%&quot;
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_border-image-slice">Try it</a>
...
border-image-slice: <i>number</i>|<i>%</i>|fill;</div></div>
<p><b>Note:</b> This property specifies the inward offsets from the top, right, 
bottom, and left edges of the image, dividing it into nine regions: four 
corners, four edges and a middle. The middle image part is discarded (treated as 
fully transparent) unless the fill keyword is present. If the fourth 
number/percentage is omitted, it is the same as the second. If the third one is 
...
<table class="reference notranslate">
  ...
  <tr>
    <td> <i>number</i></td>
    <td>Numbers represent pixels in the image (if the image is a raster image) 
	or vector coordinates (if the image is a vector image)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-slice">Play it &raquo;</a></td>              
  </tr>
  <tr>
    <td> <i>%</i></td>
    <td>Percentages are relative to the size of the image: the width of the 
	image for the horizontal offsets, the height for vertical offsets. Default value is 100%</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-slice2">Play it &raquo;</a></td>              
  </tr>
  <tr>
    <td> fill</td>
    <td>Causes the middle part of the border-image to be preserved</td>
	<td></td>              
  </tr>
	<tr>
    <td>initial</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_border-image-slice.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_border-image-slice.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_border-image-slice.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
