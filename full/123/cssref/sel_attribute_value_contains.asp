...
<style>a.menu_sel_attribute_value_contains{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Select and style elements with a title attribute containing the word "flower":</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_attribute_value_contains">Try it yourself &raquo;</a>
...
<p>The [<i>attribute</i>~=<i>value</i>] selector is used to select elements with 
an attribute 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_attribute_value_contains.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_attribute_value_contains.asp#top" target="_top">TOP</a> |
		<a href="sel_attribute_value_contains.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
