...
<style>a.menu_css_initial{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">initial</span> Keyword</h1>
<div class="chapter">
...
<p>Set the text-color inside a &lt;div&gt; element to red, but keep the initial color for &lt;h1&gt; elements:</p>
<div class="example_code notranslate">
    div {color: red; }<br>
	h1 {color: initial; }
</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss_initial" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The initial keyword is supported in all major browsers, except in Internet Explorer.</p>
<p>The initial keyword is not supported in Opera before version 15.</p>
<hr>

<h2>Definition and Usage</h2>

<p>The initial keyword is used to set a CSS property to its default value.</p>

<p>The initial keyword can be used for any CSS property, and on any HTML element.</p>
...
<table class="tecspec">
    ...
    <td><i>object</i>.style.<em>property</em>=&quot;initial&quot;
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_initial">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<em>property</em>: initial;</div></div>

<br>
<hr>

<h2>Related Pages</h2>
<p>CSS inherit Keyword: <a href="css_inherit.asp">inherit keyword</a></p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_initial.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_initial.asp#top" target="_top">TOP</a> |
		<a href="css_initial.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
