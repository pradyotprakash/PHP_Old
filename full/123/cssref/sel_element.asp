...
<style>a.menu_sel_element{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1"><i>element</i></span> Selector</h1>
...
<p>Select and style all &lt;p&gt; elements:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_element" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The <i>element</i> selector selects all elements with the specified element name.</p>
<hr>
...
<p>The <i>element</i> selector is supported in all major browsers.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_element.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_element.asp#top" target="_top">TOP</a> |
		<a href="sel_element.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
