...
<title>CSS3 :first-of-type Selector</title>
<style>a.menu_sel_first-of-type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:first-of-type</span> Selector</h1>
...
<p>Specify a background color for the first p element  
of its parent:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_first-of-type">Try it yourself &raquo;</a>
...
<p>The :first-of-type selector 
matches every element that is the first child, of a particular type, of its 
parent.</p>
<p><b>Tip:</b> This is the same as :nth-of-type(1).</p>
<hr>
...
<p>The :first-of-type selector is supported in all major browsers, except IE8 
and earlier.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_first-of-type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_first-of-type.asp#top" target="_top">TOP</a> |
		<a href="sel_first-of-type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
