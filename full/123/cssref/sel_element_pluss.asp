...
<style>a.menu_sel_element_pluss{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Select and style every &lt;p&gt; element that are placed immediately after &lt;div&gt; 
elements:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_element_pluss">Try it yourself &raquo;</a>
...
<p>The <i>element+element</i> selector is used to select elements that is 
placed immediately after (not inside) the first specified element.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_element_pluss.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_element_pluss.asp#top" target="_top">TOP</a> |
		<a href="sel_element_pluss.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
