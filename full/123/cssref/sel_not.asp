...
<h1>CSS3 <span class="color_h1">:not</span> Selector</h1>
...
<p>Set a background color for all elements that are not a &lt;p&gt; element:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_not">Try it yourself &raquo;</a>
...
<p>The :not(<i>selector</i>) selector 
matches every element that is NOT the specified element/selector.</p>
<hr>
...
<p>The :not selector is supported in all major browsers.</p>
<p><b>Note:</b> IE8 and earlier do not support the :not selector.</p>
<hr>
