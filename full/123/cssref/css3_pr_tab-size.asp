...
<html lang="en-US">
<head>
<title>CSS tab-size property</title>
<style>a.menu_css3_pr_tab-size{font-weight:bold;}</style>
<meta charset="utf-8">
...
pre {tab-size: 16; }<br>
pre {-moz-tab-size: 16; } /* Code for Firefox */<br>
pre {-o-tab-size: 16; } /* Code for Opera */<br>
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_tab-size" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The tab-size property is currnetly only supported in Chrome.</p>
<p>Firefox supports an alternative, the -moz-tab-size property.</p>
<p>Opera supports an alternative, the -o-tab-size property.</p>
<p>No browser is currently supporting the value as a length unit.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.tabIndex=&quot;16&quot;
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_tab-size">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_tab-size&amp;preval=8">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td><em>length</em></td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_tab-size&amp;preval=initial">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_tab-size.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_tab-size.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_tab-size.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
