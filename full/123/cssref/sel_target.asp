...
<title>CSS3 :target Selector</title>
<style>a.menu_sel_target{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:target</span> Selector</h1>
...
<p>Highlight active HTML anchor:</p>
<div class="example_code notranslate">
    :target<br>
    {<br>
    border: 2px solid #D4D4D4;<br>
    background-color: #e5eecc;<br>
	}<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_target">Try it yourself &raquo;</a>
...
<p>URLs with an # followed by an anchor name, link to a certain element within a 
document. The element being linked to is the target element. </p>
<p>The :target selector can be used to style the current active target element.</p>
<hr>
...
<p>The :target selector is supported in all major browsers.</p>
<p><strong>Note:</strong> The :target selector is not supported in Internet Explorer 8, and earlier versions.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_target.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_target.asp#top" target="_top">TOP</a> |
		<a href="sel_target.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
