...
<html lang="en-US">
<head>
<title>CSS3 column-width property</title>
<style>a.menu_css3_pr_column-width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Specify the width of the columns:</p>
<div class="example_code notranslate">
  
    div<br>
	{<br>
	column-width:100px;<br>-moz-column-width:100px; /* Firefox */<br>
	-webkit-column-width:100px; /* Safari and Chrome */<br>	
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_column-width">Try it yourself &raquo;</a>
...
<p>The column-width property is supported in Internet Explorer 10 and Opera.</p>
<p>Firefox supports an alternative, the -moz-column-width property.</p>
<p>Safari and Chrome support an alternative, the -webkit-column-width property.</p>
<p><strong>Note:</strong> The column-width property is not supported in Internet Explorer 9 and earlier versions.&nbsp;</p>
<hr>

<h2>Definition and Usage</h2>
<p>The column-width property specifies the width of the columns.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_column-width">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-width">Play it &raquo;</a></td>   
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>A length that specifies the width of the columns</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-width&amp;preval=50px">Play it &raquo;</a></td>       
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-width&amp;preval=initial">Play it &raquo;</a></td>       
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_column-width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_column-width.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_column-width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
