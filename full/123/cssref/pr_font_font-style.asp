...
<style>a.menu_pr_font_font-style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_font-style" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The font-style property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_font-style">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-style">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>italic</td>
    <td>The browser displays an italic font style</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-style&amp;preval=italic">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>oblique</td>
    <td>The browser displays an oblique font style</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-style&amp;preval=oblique">Play it &raquo;</a></td>        
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-style&amp;preval=initial">Play it &raquo;</a></td>        
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_font_font-style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_font_font-style.asp#top" target="_top">TOP</a> |
		<a href="pr_font_font-style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
