...
<style>a.menu_pr_dim_min-width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Set the minimum width of a paragraph:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_dim_min-width" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The min-width property is supported in all major browsers.</p>
<p><strong>Note:</strong> IE6 and earlier versions do not support the 
min-width property.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_min-width">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_min-width&amp;preval=150px">Play it &raquo;</a></td>		              
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Defines the minimum width in percent of the containing block</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_min-width&amp;preval=100%25">Play it &raquo;</a></td>		              
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_min-width&amp;preval=initial">Play it &raquo;</a></td>		              
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_dim_min-width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_dim_min-width.asp#top" target="_top">TOP</a> |
		<a href="pr_dim_min-width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
