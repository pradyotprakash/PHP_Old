...
<title>CSS3 ::selection Selector</title>
<style>a.menu_sel_selection{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">::selection</span> Selector</h1>
...
<p>Make the selected text red on a yellow background:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_selection">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ::selection selector matches the portion of an element that is selected by a user.</p>
<p>Only a few CSS properties can be applied to the ::selection selector: color, background, cursor, and outline.</p>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><p><strong>Note:</strong> The ::selection pseudo-element was drafted for CSS Selectors Level 3, 
but removed before the Recommendation status. So, at the moment, the 
::selection pseudo-element is not in any specification. (However, it may be 
re-added to future CSS specifications.)</p>
</td>
</tr></table>
<br>
<hr>
...
<p>The ::selection selector is supported in IE9+, Opera, Google Chrome and Safari.</p>
<p>Firefox supports an alternative, the ::-moz-selection.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_selection.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_selection.asp#top" target="_top">TOP</a> |
		<a href="sel_selection.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
