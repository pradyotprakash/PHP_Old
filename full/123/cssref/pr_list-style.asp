...
<style>a.menu_pr_list-style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_list-style" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The list-style property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_list-style">Try it</a>
</td>
  </tr>
	</table>
<br>
...
float: <i>list-style-type</i> <i>list-style-position</i> <i>list-style-image</i>|initial|inherit;</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_list-style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_list-style.asp#top" target="_top">TOP</a> |
		<a href="pr_list-style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
