...
<style>a.menu_pr_font_weight{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    p.normal {font-weight:normal;}<br>
	p.thick {font-weight:bold;}<br>
	p.thicker {font-weight:900;}
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss_font-weight" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The font-weight property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_font-weight">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-weight">Play it &raquo;</a></td>            
  </tr>
  <tr>
    <td>bold</td>
    <td>Defines thick characters</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-weight&amp;preval=bold">Play it &raquo;</a></td>            
  </tr>
  <tr>
    <td>bolder</td>
    <td>Defines thicker characters</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-weight&amp;preval=bolder">Play it &raquo;</a></td>                
  </tr>
  <tr>
    <td>lighter</td>
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-weight&amp;preval=900">Play it &raquo;</a></td>            
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-weight&amp;preval=initial">Play it &raquo;</a></td>            
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_font_weight.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_font_weight.asp#top" target="_top">TOP</a> |
		<a href="pr_font_weight.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
