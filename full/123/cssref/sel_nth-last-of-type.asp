...
<title>CSS3 :nth-last-of-type() Selector</title>
<style>a.menu_sel_nth-last-of-type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:nth-last-of-type()</span> Selector</h1>
...
<p>Specify a background color for every p element that is the second p element 
of its parent, counting from the last child:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_nth-last-of-type">Try it yourself &raquo;</a>
...
<p>The :nth-last-of-type(<i>n</i>) selector 
matches every element that is the <i>n</i>th child, of a particular type, of its 
parent, counting 
	from the last child.</p>
<p><i>n</i> can be a number, a keyword, or a formula.</p>
<p><b>Tip:</b> Look at the <a href="sel_nth-last-child.asp">:nth-last-child()</a> selector 
to select the element that is the <i>n</i>th child, <b>regardless of 
...
<p>The :nth-last-of-type() selector is supported in all major browsers, except 
IE8 and earlier.</p>
<hr>
...
is odd or even (the index of the first child is 1).</p>
<p>Here, we specify two different background colors for odd and even p elements:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_nth-last-of-type_odd_even">Try it yourself &raquo;</a>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_nth-last-of-type_formula">Try it yourself &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_nth-last-of-type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_nth-last-of-type.asp#top" target="_top">TOP</a> |
		<a href="sel_nth-last-of-type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
