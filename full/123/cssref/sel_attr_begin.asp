...
<style>a.menu_sel_attr_begin{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Set a background color on all div elements that have a class attribute value that 
begins with &quot;test&quot;:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_attr_begin">Try it yourself &raquo;</a>
...
matches every element whose <i>attribute</i> value begins with a specified <i>value</i>.</p>
<hr>
...
<h2 class="example">Example</h2>
<p>Set a background color on all elements that have a class attribute value that 
begins with &quot;test&quot;:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_attr_begin2">Try it yourself &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_attr_begin.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_attr_begin.asp#top" target="_top">TOP</a> |
		<a href="sel_attr_begin.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
