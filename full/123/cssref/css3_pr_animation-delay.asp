...
<html lang="en-US">
<head>
<title>CSS3 animation-delay Property</title>
<style>a.menu_css3_pr_animation-delay{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    -webkit-animation-delay:2s; /* Safari and Chrome */</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_animation-delay">Try it yourself &raquo;</a>
...
<p>The animation-delay property is supported in Internet Explorer 10, Firefox, and Opera.</p>
<p>Safari and Chrome support an alternative, the -webkit-animation-delay property.</p>
<p><strong>Note:</strong> The animation-delay property is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The animation-delay property defines when the animation will start.</p>
<p>The animation-delay value is defined in seconds (s) or milliseconds (ms).</p>
<p><b>Tip:</b> Negative values are allowed, -2s makes the animation start at once, but 
starts 2 seconds into the animation.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_animation-delay">Try it</a>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>time</i></td>
    <td>Optional. Defines the number of seconds or milliseconds to wait before the animation will start. Default value is 0</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_animation-delay&amp;preval=1s">Play it &raquo;</a></td>			    
  </tr>
	<tr>
    <td>initial</td>
...
<h2 class="example">Example</h2>
<p>Negative values, notice that the animation starts 2 seconds into the 
animation cycle:</p>
<div class="example_code notranslate">
  
    animation-delay: -2s /* W3C and Opera */<br>
    -moz-animation-delay: -2s /* Firefox */<br>
    -webkit-animation-delay: -2s /* Safari and Chrome */</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_animation-delay2">Try it yourself &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_animation-delay.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_animation-delay.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_animation-delay.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
