...
<style>a.menu_css3_pr_text-decoration-line{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_text-decoration-line" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The text-decoration-line property is not supported in any of the major browsers.</p>
<p>Firefox supports an alternative, the -moz-text-decoration-line property.</p>
...
<p><strong>Note:</strong> You can also combin more than one value, like underline <em>and</em> overline to display line both under and over the text.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_text-decoration-line">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-line&amp;preval=none">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>underline</td>
    <td>Specifies that a line will be displayed under the text</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-line&amp;preval=underline">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>overline</td>
    <td>Specifies that a line will be displayed over the text</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-line&amp;preval=overline">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>line-through</td>
    <td>Specifies that a line will be displayed through the text</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-line&amp;preval=line-through">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-decoration-line&amp;preval=initial">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_text-decoration-line.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_text-decoration-line.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_text-decoration-line.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
