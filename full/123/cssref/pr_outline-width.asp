...
<html lang="en-US">
<head>
<title>CSS Outline-width Property</title>
<style>a.menu_pr_outline-width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_outline-width" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The outline-width property is supported in all major browsers.</p>
<p><b>Note:</b> IE8 supports the outline-width property only if a !DOCTYPE 
is specified.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_outline-width">Try it</a>
</td>
  </tr>
	</table>
<br>
...
outline-style: medium|thin|thick|<i>length</i>|initial|inherit;</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-width&amp;preval=medium">Play it &raquo;</a></td>		      
  </tr>
  <tr>
    <td>thin</td>
    <td>Specifies a thin outline</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-width&amp;preval=thin">Play it &raquo;</a></td>		      
  </tr>
  <tr>
    <td>thick</td>
    <td>Specifies a thick outline</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-width&amp;preval=thick">Play it &raquo;</a></td>		          
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Allows you to define the thickness of the outline</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-width&amp;preval=10px">Play it &raquo;</a></td>		      
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-width&amp;preval=initial">Play it &raquo;</a></td>		      
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_outline-width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_outline-width.asp#top" target="_top">TOP</a> |
		<a href="pr_outline-width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
