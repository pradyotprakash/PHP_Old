...
<style>a.menu_pr_background-repeat{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_background-repeaty" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The background-repeat property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_background-repeat">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-repeat">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>repeat-x</td>
    <td>The background image will be repeated only horizontally</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-repeat&amp;preval=repeat-x">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>repeat-y</td>
    <td>The background image will be repeated only vertically</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-repeat&amp;preval=repeat-y">Play it &raquo;</a></td>        
  </tr>
  <tr>
    <td>no-repeat</td>
    <td>The background-image will not be repeated</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-repeat&amp;preval=no-repeat">Play it &raquo;</a></td>    
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-repeat&amp;preval=initial">Play it &raquo;</a></td>    
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss_background-repeat">How to 
repeat a background image both vertically and horizontally</a><br>
This example demonstrates how to repeat a background image both vertically and
      horizontally.</p>

<p><a target="_blank" href="tryit.asp?filename=trycss_background-repeatx">How to 
repeat a background image only horizontally</a><br>
This example demonstrates how to repeat a background image only horizontally.</p>
<p>
<a target="_blank" href="tryit.asp?filename=trycss_background-repeat_no-repeat">
How to display a background image only one time</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_background-repeat.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_background-repeat.asp#top" target="_top">TOP</a> |
		<a href="pr_background-repeat.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
