...
<style>a.menu_pr_background-color{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
	...
	p<br>
	{<br>
	background-color:rgb(255,0,255);<br>
	}
  
</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss_background-color" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The background-color property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_background-color">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-color">Play it &raquo;</a></td>	
  </tr>
	<tr>
    <td>transparent</td>
    <td>Specifies that the background color should be transparent. 
	This is default</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-color&amp;preval=transparent">Play it &raquo;</a></td>
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-color&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss_text_background">Set the background-color of a part of the text</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_background-color.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_background-color.asp#top" target="_top">TOP</a> |
		<a href="pr_background-color.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
