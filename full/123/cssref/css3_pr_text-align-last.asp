...
<html lang="en-US">
<head>
<title>CSS text-align-last property</title>
<style>a.menu_css3_pr_text-align-last{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Align the last line of a pragraph to the right:</p>
<div class="example_code notranslate">
p<br>
{<br>
text-align: justify;<br>
text-align-last: right;<br>
-moz-text-align-last: right; } /* Code for Firefox */<br>
}
</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_text-align-last" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The text-align-last property is only supported in Internet Explorer.</p>
<p>Firefox supports an alternative, the -moz-text-align-last property.</p>
<p>The values "start" and "end" are not supported in Internet Explorer.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_text-align-last">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align-last&amp;preval=auto">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>left</td>
    <td>The last line is aligned to the left</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align-last&amp;preval=left">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>right</td>
    <td>The last line is aligned to the right</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align-last&amp;preval=right">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>center</td>
    <td>The last line is center-aligned</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align-last&amp;preval=center">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>justify</td>
    <td>The last line is justified as the rest of the lines</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align-last&amp;preval=justify">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>start</td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align-last&amp;preval=start">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>end</td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align-last&amp;preval=end">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-align-last&amp;preval=initial">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_text-align-last.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_text-align-last.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_text-align-last.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
