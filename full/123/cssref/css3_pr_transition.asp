...
<html lang="en-US">
<head>
<title>CSS3 transition Property</title>
<style>a.menu_css3_pr_transition{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_transition">Try it yourself &raquo;</a>
...
<p>The transition property is supported in Internet Explorer 10, Firefox, Opera, 
and Chrome.</p>
<p>Safari supports an alternative, the -webkit-transition property.</p>
<p><strong>Note:</strong> The transition property is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_transition">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i><a href="css3_pr_transition-property.asp">transition-property</a></i></td>
    <td>Specifies the name of the CSS property the transition effect is for</td>
  </tr>
	<tr>
    <td><i><a href="css3_pr_transition-duration.asp">transition-duration</a></i></td>
    <td>Specifies how many seconds or milliseconds the transition effect takes to 
	complete</td>
  </tr>
	<tr>
    <td><i><a href="css3_pr_transition-timing-function.asp">transition-timing-function</a></i></td>
    <td>Specifies the speed curve of the transition effect</td>
  </tr>
	<tr>
    <td><i><a href="css3_pr_transition-delay.asp">transition-delay</a></i></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_transition.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_transition.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_transition.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
