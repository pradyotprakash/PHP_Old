...
<style>a.menu_css_colors_legal{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="css_colors.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_colornames.asp">Next Reference &raquo;</a></div>
</div>
<hr>
<h2>CSS Colors</h2>
...
<p>Hexadecimal color values are supported in all major browsers.</p>
...
All values must be between 0 and FF.</p>
<p>For example, the #0000ff value is rendered as blue, because the blue component is set to its highest value (ff) and the others are set to 0.</p>

<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Define different HEX colors:</p>
<div class="example_code notranslate">
	#p1 {background-color:#ff0000;} / * red */<br>#p2 {background-color:#00ff00;} 
	/ * green */<br>#p3 {background-color:#0000ff;} / * blue */
</div>
<br><a target="_blank" href="tryit.asp?filename=trycss_color_hex" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>RGB Colors</h2>
<p>RGB color values are supported in all major browsers.</p>
<p>An RGB color 
...
<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Define different RGB colors:</p>
<div class="example_code notranslate">
	#p1 {background-color:rgb(255,0,0);} / * red */<br>#p2 {background-color:rgb(0,255,0);} 
	/ * green */<br>#p3 {background-color:rgb(0,0,255);} / * blue */
</div>
<br><a target="_blank" href="tryit.asp?filename=trycss_color_rgb" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>RGBA Colors</h2>
<p>RGBA color values are supported in IE9+, Firefox 3+, Chrome, Safari, and in Opera 10+.</p>
...
<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Define different RGB colors with opacity:</p>
<div class="example_code notranslate">
	#p1 {background-color:rgba(255,0,0,0.3);} / * red 
	with opacity */<br>#p2 {background-color:rgba(0,255,0,0.3);} 
	/ * green with opacity */<br>#p3 {background-color:rgba(0,0,255,0.3);} / * blue 
	with opacity */
</div>
<br><a target="_blank" href="tryit.asp?filename=trycss_color_rgba" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>HSL Colors</h2>
<p>HSL color values are supported in IE9+, Firefox, Chrome, Safari, and in Opera 
10+.</p>
...
<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Define different HSL colors:</p>
<div class="example_code notranslate">
	#p1 {background-color:hsl(120,100%,50%);} / * green */<br>#p2 {background-color:hsl(120,100%,75%);} 
	/ * light green */<br>#p3 {background-color:hsl(120,100%,25%);} / * dark 
	green */<br>#p4 {background-color:hsl(120,60%,70%);} / * pastel green */
</div>
<br><a target="_blank" href="tryit.asp?filename=trycss_color_hsl" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>HSLA Colors</h2>
<p>HSLA color values are supported in IE9+, Firefox 3+, Chrome, Safari, and in 
Opera 10+.</p>
...
<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Define different HSL colors with opacity:</p>
<div class="example_code notranslate">
	#p1 {background-color:hsla(120,100%,50%,0.3);} / * green with opacity */<br>#p2 {background-color:hsla(120,100%,75%,0.3);} 
	/ * light green with opacity */<br>#p3 {background-color:hsla(120,100%,25%,0.3);} / * dark 
	green with opacity */<br>#p4 {background-color:hsla(120,60%,70%,0.3);} / * pastel green 
	with opacity */
</div>
<br><a target="_blank" href="tryit.asp?filename=trycss_color_hsla" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Predefined/Cross-browser Color Names</h2>
<p>140 color names are predefined in the HTML and CSS color specification. Look at our table of
<a href="css_colornames.asp">predefined color names</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_colors.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_colornames.asp">Next Reference &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_colors_legal.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_colors_legal.asp#top" target="_top">TOP</a> |
		<a href="css_colors_legal.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
