...
<html lang="en-US">
<head>
<title>CSS unicode-bidi property</title>
<style>a.menu_pr_text_unicode-bidi{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_text_unicode-bidi" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The unicode-bidi property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_unicode-bidi">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_unicode-bidi">Play it &raquo;</a></td>
  </tr>
	<tr>
    <td>embed</td>
    <td>Creates an additional level of embedding</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_unicode-bidi&amp;preval=embed">Play it &raquo;</a></td>    
  </tr>
	<tr>
    <td>bidi-override</td>
    <td>Creates an additional level of embedding. Reordering depends on the direction property</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_unicode-bidi&amp;preval=bidi-override">Play it &raquo;</a></td>    
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_unicode-bidi&amp;preval=initial">Play it &raquo;</a></td>    
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_text_unicode-bidi.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_text_unicode-bidi.asp#top" target="_top">TOP</a> |
		<a href="pr_text_unicode-bidi.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
