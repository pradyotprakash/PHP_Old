...
<html lang="en-US">
<head>
<title>CSS3 animation-fill-mode Property</title>
<style>a.menu_css3_pr_animation-fill-mode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    -webkit-animation-fill-mode:forwards; /* Safari and Chrome */</div>
<br>
	<a class="tryitbtn" href="tryit.asp?filename=trycss3_animation-fill-mode" target="_blank">Try it yourself &raquo;</a>
...
<p>The animation-fill-mode property is supported in Internet Explorer 10, Firefox, and Opera.</p>
<p>Safari and Chrome support an alternative, the -webkit-animation-play-state property.</p>
...
<p>The animation-fill-mode property specifies what styles will apply for the element when the animation is not playing (when it is finished, or when it has a "delay").</p>
<p>By default, CSS animations will not affect the element you are animating until the first keyframe is &quot;played&quot;, and then stops affecting it once the last 
keyframe has completed. The animation-fill-mode property can override this 
behavior. </p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_animation-fill-mode">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>none</td>
    <td>Default value. The animation will not apply any styles to the target before or after it 
	is executing</td>
  </tr>
  <tr>
    <td>forwards</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_animation-fill-mode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_animation-fill-mode.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_animation-fill-mode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
