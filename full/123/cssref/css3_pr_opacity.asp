...
<html lang="en-US">
<head>
<title>CSS3 opacity property</title>
<style>a.menu_css3_pr_opacity{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_opacity">Try it yourself &raquo;</a>
...
<p>The opacity property is supported in all major browsers.</p>
<p><strong>Note:</strong> IE8 and earlier supports an alternative, the filter property. Like: filter:Alpha(opacity=50).</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_opacity">Try it</a>
</td>
  </tr>
	</table>
<br>
...
opacity: <i>value</i>|initial|inherit;</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	(fully opaque) </td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_opacity">Play it &raquo;</a></td>   	
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_opacity&amp;preval=initial">Play it &raquo;</a></td>   	
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss3_opacity_js">
Change the opacity for an element</a><br>
This example demonstrates how to use a JavaScript to change the opacity for an element.</p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_opacity.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_opacity.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_opacity.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
