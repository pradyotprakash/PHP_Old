...
<html lang="en-US">
<head>
<title>CSS3 text-emphasis property</title>
<style>a.menu_css3_pr_text-emphasis{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">text-emphasis</span> Property</h1>
<p><a href="default.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="CSS Reference" /> Complete CSS Reference</a></p>

<div class="example">


<h2 class="example">Example</h2>
<p>Justification changes spacing at word separators (feil eksempel):</p>
...
<p>The text-emphasis property is not supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The text-emphasis property is a shorthand for setting text-emphasis-style and 
text-emphasis-color in one declaration.</p>
<p><b>Tip:</b> A good font for emphasis marks is Adobe's &quot;Kenten Generic 
OpenType Font&quot;, which is specially designed for the emphasis marks.</p>
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.textEmphasis=&quot;filled blue&quot;</td>
  </tr>
	</table>
<br>
<hr>
...
text-emphasis: <i>text-emphasis-style</i> <i>text-emphasis-color</i>;</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>text-emphasis-style</i></td>
    <td>Applies emphasis marks to the element's text</td>
  </tr>
  <tr>
    <td><i>text-emphasis-color</i></td>
    <td>Defines the foreground color of the emphasis marks</td>
  </tr>
  </table>
<br>
<hr>

<a href="default.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="CSS Reference" /> Complete CSS Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_text-emphasis.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_text-emphasis.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_text-emphasis.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
