...
<style>a.menu_css3_pr_flex{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    #main div<br>{<br>flex:1;<br>}</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_flex" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The flex property is supported in all major browsers, except for Safari.</p>
<p>The flex property is not supported IE 9 or earlier, in IE 10 this property is supported with the prefix -ms-.</p>
<hr>

<h2>Definition and Usage</h2>

<p>The flex property specifies the length of the item, relative to the rest of the
flexibel items inside the same container.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.flex=&quot;auto&quot;
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_flex">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_flex.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_flex.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_flex.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
