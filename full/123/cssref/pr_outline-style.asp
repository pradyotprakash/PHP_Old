...
<style>a.menu_pr_outline-style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_outline-color" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The outline-style property is supported in all major browsers.</p>
<p><b>Note:</b> IE8 supports the outline-style 
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_outline-style">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
    ...
    <tr>
	  ...
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style">Play it &raquo;</a></td>		      	
    </tr>
    <tr>
      <td>hidden</td>
      <td>Specifies a hidden outline</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style&amp;preval=hidden">Play it &raquo;</a></td>		      	      
    </tr>
    <tr>
      <td>dotted</td>
      <td>Specifies a dotted outline</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style&amp;preval=dotted">Play it &raquo;</a></td>		      	      
    </tr>
    <tr>
      <td>dashed</td>
      <td>Specifies a dashed outline</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style&amp;preval=dashed">Play it &raquo;</a></td>		      	      
    </tr>
    <tr>
      <td>solid</td>
      <td>Specifies a solid outline</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style&amp;preval=solid">Play it &raquo;</a></td>		      	      
    </tr>
    <tr>
      <td>double</td>
      <td>Specifies a double outliner</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style&amp;preval=double">Play it &raquo;</a></td>		      	      
    </tr>
    <tr>
      <td>groove</td>
      <td>Specifies a 3D grooved outline. The effect depends on the outline-color value</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style&amp;preval=groove">Play it &raquo;</a></td>		      	              
    </tr>
    <tr>
      <td>ridge</td>
      <td>Specifies a 3D ridged outline. The effect depends on the outline-color value</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style&amp;preval=ridge">Play it &raquo;</a></td>		      	              
    </tr>
    <tr>
      <td>inset</td>
      <td>Specifies a 3D inset outline. The effect depends on the outline-color value</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style&amp;preval=inset">Play it &raquo;</a></td>		      	              
    </tr>
    <tr>
      <td>outset</td>
      <td>Specifies a 3D outset outline. The effect depends on the outline-color value</td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style&amp;preval=outset">Play it &raquo;</a></td>		      	              
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	  <td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_outline-style&amp;preval=initial">Play it &raquo;</a></td>		      	              
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss_outline-style">Set the style of an outline</a><br>
This example demonstrates how to set the style of an outline.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_outline-style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_outline-style.asp#top" target="_top">TOP</a> |
		<a href="pr_outline-style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
