...
<html lang="en-US">
<head>
<title>CSS3 border-image-width property</title>
<style>a.menu_css3_pr_border-image-width{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Specify the widths of the image-border:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_border-image-width">Try it yourself &raquo;</a>
...
<p>The border-image-width property is not supported in Opera.</p>
<p>The border-image-width property is not supported in Internet Explorer 10 and earlier.</p>
<p>The border-image-width property is not supported in Safari 5 and earlier.</p>
<p>Look at the <a href="css3_pr_border-image.asp">border-image</a> property 
instead!</p>
<hr>

<h2>Definition and Usage</h2>
<p>The border-image-width property specifies the widths of the 
image-border.</p>
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.borderImageWidth=&quot;20px 30px&quot;
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_border-image-width">Try it</a>
...
border-image-width: <i>number</i>|<i>%</i>|auto;</div></div>
<p><b>Note:</b> The four values of border-image-width specify offsets that are 
used to divide the border image area into nine parts. They represent the inward 
distances from the the top, right, bottom, and left sides of the area. If the 
...
the same as the first. Negative values are not allowed for any 
border-image-width values.</p>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-width">Play it &raquo;</a></td>              
  </tr>
  <tr>
    <td><i>number</i></td>
    <td>Default value 1. Represents multiples of the corresponding border-width</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-width2&amp;preval=1">Play it &raquo;</a></td>              
  </tr>
  <tr>
    <td><i>%</i></td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-width3">Play it &raquo;</a></td>              
  </tr>
  <tr>
    <td>auto</td>
    <td>If specified, the width is the intrinsic width or height of the 
	corresponding image slice</td>
 	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-width&amp;preval=auto">Play it &raquo;</a></td>              
 </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-width2&amp;preval=initial">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_border-image-width.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_border-image-width.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_border-image-width.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
