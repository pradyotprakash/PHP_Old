...
<style>a.menu_pr_print_pagebi{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The page-break-inside property is supported in all major browsers.</p>
<p><b>Note:</b> Internet Explorer 7 and earlier do not support the 
page-break-inside property.</p>
<hr>


<h2>Definition and Usage</h2>

<p>The page-break-inside property sets whether a page break is allowed inside a 
specified
element.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_print_pagebi.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_print_pagebi.asp#top" target="_top">TOP</a> |
		<a href="pr_print_pagebi.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
