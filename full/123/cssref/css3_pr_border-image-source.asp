...
<html lang="en-US">
<head>
<title>CSS3 border-image-source property</title>
<style>a.menu_css3_pr_border-image-source{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Use an image as the border around a div element:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_border-image-source">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The border-image-source property is not supported in Opera.</p>
<p>The border-image-source property is not supported in Internet Explorer 10 and earlier.</p>
<p>The border-image-source property is not supported in Safari 5 and earlier.</p>
<p>Look at the <a href="css3_pr_border-image.asp">border-image</a> property 
instead!</p>
<hr>

<h2>Definition and Usage</h2>
<p>The border-image-source property specifies an image to be used, instead of the 
border styles given by the border-style properties.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_border-image-source">Try it</a>
...
<p>CSS Reference: <a href="css3_pr_border-image-source.asp">border-image-outset property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_border-image-source.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_border-image-source.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_border-image-source.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
