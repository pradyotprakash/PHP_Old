...
<title>CSS border-bottom-color property</title>
<style>a.menu_pr_border-bottom_color{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-color" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The border-bottom-color property is supported in all major browsers.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_border-bottom-color">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-color">Play it &raquo;</a></td>		
  </tr>
	<tr>
    <td>transparent</td>
    <td>Specifies that the border color should be transparent</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-color&amp;preval=transparent">Play it &raquo;</a></td>			
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-bottom-color&amp;preval=initial">Play it &raquo;</a></td>			
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_border-bottom_color.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_border-bottom_color.asp#top" target="_top">TOP</a> |
		<a href="pr_border-bottom_color.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
