...
<style>a.menu_pr_border-color{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="nav">
<div class="prev"><a class="chapter" href="pr_tab_border-collapse.asp">&laquo; Previous</a></div>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_border-color" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The border-color property is supported in all major browsers.</p>
...
<p>Examples:</p>
<ul>
	<li><b>border-color:red green blue pink; </b>
	<ul><li>top border is red</li>
	<li>right border is green</li>
	<li>bottom border is blue</li>
	<li>left border is pink</li></ul>
	<br>
	</li>
	<li><b>border-color:red green blue;</b>
	<ul><li>top border is red</li>
	<li>right and left borders are green</li>
	<li>bottom border is blue</li></ul>
	<br>
    </li>
	<li><b>border-color:red green;</b>
	<ul><li>top and bottom borders are red</li>
	<li>right and left borders are green</li></ul>
	<br>
	</li>
	<li><b>border-color:red;</b><ul><li>all four borders are red</li></ul>
	</li>
</ul>

<p><b>Note:</b> Always declare the border-style property before the border-color
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_border-color">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	color is black</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-color">Play it &raquo;</a></td>		
  </tr>
	<tr>
    <td>transparent</td>
    <td>Specifies that the border color should be transparent</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-color&amp;preval=transparent">Play it &raquo;</a></td>			
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-color&amp;preval=initial">Play it &raquo;</a></td>			
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_border-color.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_border-color.asp#top" target="_top">TOP</a> |
		<a href="pr_border-color.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
