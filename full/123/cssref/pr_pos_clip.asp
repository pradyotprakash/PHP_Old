...
<style>a.menu_pr_pos_clip{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_clip" class="tryitbtn">Try it yourself &raquo;</a>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_clip">Try it</a>
</td>
  </tr>
</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>No clipping will be applied. This is default</td>
 	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_clip&amp;preval=auto">Play it &raquo;</a></td>		                  
 </tr>
  <tr>
    <td><i>shape</i></td>
    <td>Clips an element. The only valid value is: rect (<i>top, right, bottom, left</i>)</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_clip&amp;preval=rect(0px,25px,25px,0px)">Play it &raquo;</a></td>		                  
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
 	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_clip&amp;preval=initial">Play it &raquo;</a></td>		                  
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_pos_clip.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_pos_clip.asp#top" target="_top">TOP</a> |
		<a href="pr_pos_clip.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
