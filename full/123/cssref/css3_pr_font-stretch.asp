...
<html lang="en-US">
<head>
<title>CSS3 font-stretch property</title>
<style>a.menu_css3_pr_font-stretch{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Make all div elements' text wider:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_font-stretch">Try it yourself &raquo;</a>
</div>
<hr>
...
font-stretch: 
	wider|narrower|ultra-condensed|extra-condensed|condensed|semi-condensed|normal|semi-expanded|expanded|extra-expanded|ultra-expanded|initial|inherit;</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>wider</td>
    <td>Makes the text wider</td>
  </tr>
	<tr>
    <td>narrower</td>
    <td>Makes the text narrower</td>
  </tr>
	<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_font-stretch.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_font-stretch.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_font-stretch.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
