...
<style>a.menu_pr_class_clear{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>No floating elements allowed on the left or the right
      side of a specified paragraph:</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_class-clear" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The clear property specifies which side(s) of an element other floating elements are not
allowed.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_clear">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_class_clear.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_class_clear.asp#top" target="_top">TOP</a> |
		<a href="pr_class_clear.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
