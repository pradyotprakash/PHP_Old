...
<html lang="en-US">
<head>
<title>CSS3 punctuation-trim property</title>
<style>a.menu_css3_pr_punctuation-trim{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">punctuation-trim</span> Property</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; CSS Reference</a></div>
<div class="next"><a class="chapter" href="pr_gen_quotes.asp">quotes Property &raquo;</a></div>
</div>
<br>
...
<p>Trim opening punctuation at the beginning of each line in the p element:</p>
<div class="example_code notranslate">
  
    p<br>
	{<br>
	punctuation-trim:start;<br>
	}
...
<p>The punctuation-trim property is not supported in any of the major browsers.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The punctuation-trim property specifies whether a punctuation character 
should be trimmed if it appears at the start or end of a line, or adjacent to 
another fullwidth punctuation character.</p>
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.punctuationTrim=&quot;start&quot;</td>
  </tr>
	</table>
<br>
<hr>
...
punctuation-trim: none|start|end|allow-end|adjacent;</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>none</td>
    <td>Do not trim opening or closing punctuation marks</td>
  </tr>
  <tr>
    <td>start</td>
    <td>Trim opening punctuation at the beginning of each line</td>
  </tr>
  <tr>
    <td>end</td>
    <td>Trim closing punctuation at the end of each line</td>
  </tr>
  <tr>
    <td>allow-end</td>
    <td>Trim closing punctuation at the end of each line if it does not 
	otherwise fit prior to justification</td>
  </tr>
  <tr>
    <td>adjacent</td>
    <td>Trim opening punctuation if its previous adjacent character is a 
	...
	closing or middle dot punctuation, or ideographic space</td>
  </tr>
  </table>
<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_punctuation-trim.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_punctuation-trim.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_punctuation-trim.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
