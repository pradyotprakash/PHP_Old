...
<style>a.menu_css_websafe_fonts{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Web Safe Font Combinations</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="css_ref_aural.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_units.asp">Next Reference &raquo;</a></div>
</div>
<hr>
<h2>Commonly Used Font Combinations</h2>
<p>The font-family property should hold several font names as a &quot;fallback&quot; 
system, to ensure maximum compatibility between browsers/operating systems. If 
the browser does not support the first font, it tries the next font.</p>
...
<br><a target="_blank" href="tryit.asp?filename=trycss_font-family" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css_websafe_fonts.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css_websafe_fonts.asp#top" target="_top">TOP</a> |
		<a href="css_websafe_fonts.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
