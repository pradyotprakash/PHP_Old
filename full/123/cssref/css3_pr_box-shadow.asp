...
<style>a.menu_css3_pr_box-shadow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_box-shadow">Try it yourself &raquo;</a>
...
<p>The box-shadow property is supported in IE9+, Firefox, Chrome, Opera, and 
Safari 5.1.1.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The box-shadow property attaches one or more drop-shadows to the box.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_box-shadow">Try it</a>
</td>
  </tr>
	</table>
<br>
...
box-shadow: none|<i>h-shadow v-shadow blur spread color inset</i>|initial|inherit;</div></div>
<p><b>Note:</b> The box-shadow property attaches one or more drop-shadows to the 
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_box-shadow&amp;preval=none">Play it &raquo;</a></td>		
  </tr>
  <tr>
    <td><i>h-shadow</i></td>
    <td>Required. The position of the horizontal shadow. Negative values are 
	allowed</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_box-shadow">Play it &raquo;</a></td>		
  </tr>
  <tr>
    <td><i>v-shadow</i></td>
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_box-shadow&amp;preval=50px&#32;50px&#32;5px&#32;black">Play it &raquo;</a></td>		    
  </tr>
  <tr>
    <td><i>spread</i></td>
    <td>Optional. The size of shadow</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_box-shadow&amp;preval=50px&#32;50px&#32;50px&#32;5px&#32;black">Play it &raquo;</a></td>		        
  </tr>
  <tr>
    <td><i>color</i></td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_box-shadow&amp;preval=50px&#32;50px&#32;50px&#32;20px&#32;red">Play it &raquo;</a></td>		        	
  </tr>
  <tr>
    <td>inset</td>
    <td>Optional. Changes the shadow from an outer shadow (outset) to an inner 
	shadow</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_box-shadow&amp;preval=10px&#32;10px&#32;50px&#32;20px&#32;pink&#32;inset">Play it &raquo;</a></td>		        		
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_box-shadow&amp;preval=initial">Play it &raquo;</a></td>		        		
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_box-shadow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_box-shadow.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_box-shadow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
