...
<style>a.menu_css3_pr_animation-keyframes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Make a div element move gradually 200px down:</p>
<div class="example_code notranslate">
	...
	<br>@-webkit-keyframes mymove /* Safari and Chrome */<br>
	{<br>
	from {top:0px;}<br>
	to {top:200px;}<br>
	}
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_keyframes">Try it yourself &raquo;</a>
...
<p>The @keyframes rule is supported in Internet Explorer 10, Firefox, and Opera.</p>
<p>Safari and Chrome support an alternative, the @-webkit-keyframes rule.</p>
<p><strong>Note:</strong> The @keyframes rule is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>

<h2>Definition and Usage</h2>
<p>With the @keyframes rule, you can create animations.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Required. Percentage of the animation duration.<p>Legal values:<p>0-100%<br>
	from (same as 0%)<br>
	to (same as 100%)<p><b>Note:</b> You can have many keyframes-selectors in one 
	animation.</td>
  </tr>
  <tr>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_keyframes2">Try it yourself &raquo;</a>
</div>
<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_keyframes3">Try it yourself &raquo;</a>
</div>
<br>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_keyframes4">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_animation-keyframes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_animation-keyframes.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_animation-keyframes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
