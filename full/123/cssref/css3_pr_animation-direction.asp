...
<html lang="en-US">
<head>
<title>CSS3 animation-direction Property</title>
<style>a.menu_css3_pr_animation-direction{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_animation-direction">Try it yourself &raquo;</a>
...
<p>The animation-direction property is supported in Internet Explorer 10, Firefox, and Opera.</p>
<p>Safari and Chrome support an alternative, the -webkit-animation-direction property.</p>
...
<p>The animation-direction property defines whether or not the animation should play 
in reverse on alternate cycles.</p>
<p><b>Note:</b> If the animation is set to played only once, this property will 
have no effect.</p>
<table class="tecspec">
  <tr>
    ...
    <td>  <i>object</i>.style.animationDirection=&quot;alternate&quot;
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_animation-direction">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_animation-direction&amp;preval=normal">Play it &raquo;</a></td>			    
  </tr>
  <tr>
    <td>reverse</td>
    <td>The animation should play in reverse direction</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_animation-direction&amp;preval=reverse">Play it &raquo;</a></td>			        
  </tr>
  <tr>
    <td>alternate</td>
    <td>The animation will be played as normal every odd time (1,3,5,etc..) and 
	in reverse direction every even time (2,4,6,etc...) </td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_animation-direction&amp;preval=alternate">Play it &raquo;</a></td>			        
  </tr>
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_animation-direction&amp;preval=alternate-reverse">Play it &raquo;</a></td>			        
  </tr>
	<tr>
    <td>initial</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_animation-direction.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_animation-direction.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_animation-direction.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
