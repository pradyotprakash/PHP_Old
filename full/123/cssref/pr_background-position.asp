...
<style>a.menu_pr_background-position{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_background-position" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The background-position property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_background-position">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-position">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>x% y%</i></td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-position&amp;preval=50%25&#32;50%25">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>xpos ypos</i></td>
    <td>The first value&nbsp;is the horizontal position and the second
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-position&amp;preval=10px&#32;200px">Play it &raquo;</a></td>
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_background-position&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<p><a target="_blank" href="tryit.asp?filename=trycss_background-position">How to place a background image</a><br>
This example demonstrates how to place a background-image on the page.</p>
<p>
<a target="_blank" href="tryit.asp?filename=trycss_background-position_percent">
How to position a background image using %</a><br>
This example demonstrates how to position an image on the page using percent.</p>
<p>
<a target="_blank" href="tryit.asp?filename=trycss_background-position_pixel">
How to position a background image using pixels</a><br>
This example demonstrates how to position an image on the page using pixels.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_background-position.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_background-position.asp#top" target="_top">TOP</a> |
		<a href="pr_background-position.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
