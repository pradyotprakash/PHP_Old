...
<style>a.menu_sel_attribute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">[<i>attribute</i>]</span> Selector</h1>
...
<p>Style &lt;a&gt; elements with a target attribute:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_attribute">Try it yourself &raquo;</a>
...
<p>The [<i>attribute</i>] selector is used to select elements with the specified attribute.</p>
...
<p>The [<i>attribute</i>] selector is supported in all major browsers.</p>
<p><b>Note:</b> For [<i>attribute</i>] to work in IE8 and earlier, a <a href="../tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> 
must be declared.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_attribute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_attribute.asp#top" target="_top">TOP</a> |
		<a href="sel_attribute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
