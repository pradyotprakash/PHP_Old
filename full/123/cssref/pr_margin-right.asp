...
<html lang="en-US">
<head>
<title>CSS margin-right property</title>
<style>a.menu_pr_margin-right{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_margin-right" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The margin-right property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_margin-right">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_margin-right&amp;preval=10px">Play it &raquo;</a></td>		                  
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Specifies a right margin in percent of the width of the 
	containing element</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_margin-right&amp;preval=10%25">Play it &raquo;</a></td>		                  	
  </tr>
  <tr>
    <td>auto</td>
    <td>The browser calculates a right margin</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_margin-right&amp;preval=auto">Play it &raquo;</a></td>		                  
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_margin-right&amp;preval=initial">Play it &raquo;</a></td>		                  	
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_margin-right.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_margin-right.asp#top" target="_top">TOP</a> |
		<a href="pr_margin-right.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
