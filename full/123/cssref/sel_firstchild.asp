...
<title>CSS :first-child pseudo-element</title>
<style>a.menu_sel_firstchild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:first-child</span> Selector</h1>
...
<p>Select and style every &lt;p&gt; element that is the first child of its parent:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_firstchild">Try it yourself &raquo;</a>
...
<p>The :first-child selector is used to select the specified selector, only if it is the first child of its parent.</p>
<hr>
...
<p>The :first-child selector is supported in all major browsers.</p>
<p><b>Note:</b> For :first-child to work in IE8 and earlier, a <a href="../tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> must be declared.</p>
<hr>
...
<h2 class="example">Example</h2>
<p>Select and style every &lt;i&gt; element of every &lt;p&gt; element, where the &lt;p&gt; element is 
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_firstchild_more2" class="tryitbtn">Try it yourself &raquo;</a>
...
<h2 class="example">Example</h2>
<p>Select and style the first &lt;li&gt; element in lists:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_firstchild_more3" class="tryitbtn">Try it yourself &raquo;</a>
...
<h2 class="example">Example</h2>
<p>Select and style the first child element of every &lt;ul&gt; element:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_firstchild_more4" class="tryitbtn">Try it yourself &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_firstchild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_firstchild.asp#top" target="_top">TOP</a> |
		<a href="sel_firstchild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
