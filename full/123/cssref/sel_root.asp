...
<title>CSS3 :root Selector</title>
<style>a.menu_sel_root{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:root</span> Selector</h1>
...
<p>Set the background color for the HTML document:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_root">Try it yourself &raquo;</a>
...
<p>The :root selector 
matches the document’s root element.</p>
<p>In HTML, the root element is always 
	the html element.</p>
<hr>
...
<p>The :root selector is supported in all major browsers, except IE8 and 
earlier.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_root.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_root.asp#top" target="_top">TOP</a> |
		<a href="sel_root.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
