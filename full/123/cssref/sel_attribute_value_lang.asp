...
<style>a.menu_sel_attribute_value_lang{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">[<i>attribute</i>|=<i>value</i>]</span> Selector</h1>
...
<p>Select and style elements, where the lang attribute's value starts with "en":</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_attribute_value_lang">Try it yourself &raquo;</a>
...
<p>The [<i>attribute</i>|=<i>value</i>] selector is used to select elements with the specified attribute 
starting with the specified value.</p>
<p><b>Note:</b> The value has to be a whole word, either alone, like lang=&quot;en&quot;, 
or followed by a hyphen( - ), like lang=&quot;en-us&quot;.</p>
...
<p>The [<i>attribute</i>|=<i>value</i>] selector is supported in all major browsers.</p>
<p><b>Note:</b> For [<i>attribute</i>|=<i>value</i>] to work in IE8 and earlier, a <a href="../tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> 
must be declared.</p>

<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="../css/css_attribute_selectors.asp">CSS Attribute Selectors</a></p>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Select and style elements, where the class attribute's value starts with 
&quot;top&quot;:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_attribute_hyphen" class="tryitbtn">Try it yourself &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_attribute_value_lang.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_attribute_value_lang.asp#top" target="_top">TOP</a> |
		<a href="sel_attribute_value_lang.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
