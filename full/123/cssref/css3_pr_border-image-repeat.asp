...
<html lang="en-US">
<head>
<title>CSS3 border-image-repeat property</title>
<style>a.menu_css3_pr_border-image-repeat{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Specify how to repeat the image-border:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_border-image-repeat">Try it yourself &raquo;</a>
...
<p>The border-image-repeat property is not supported in Opera.</p>
<p>The border-image-repeat property is not supported in Internet Explorer 10 and earlier.</p>
<p>The border-image-repeat property is not supported in Safari 5 and earlier.</p>
<p>Look at the <a href="css3_pr_border-image.asp">border-image</a> property 
instead!</p>
<hr>

<h2>Definition and Usage</h2>
<p>The border-image-repeat property specifies whether the image-border should be repeated, rounded or stretched.</p>
<table class="tecspec">
  <tr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_border-image-repeat">Try it</a>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-repeat&amp;preval=stretch">Play it &raquo;</a></td>              

  </tr>
  <tr>
    <td> repeat</td>
    <td>The image is tiled (repeated) to fill the area</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-repeat&amp;preval=repeat">Play it &raquo;</a></td>              
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-repeat&amp;preval=round">Play it &raquo;</a></td>              
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_border-image-repeat&amp;preval=initial">Play it &raquo;</a></td>              
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_border-image-repeat.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_border-image-repeat.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_border-image-repeat.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
