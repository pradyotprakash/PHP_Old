...
<html lang="en-US">
<head>
<title>CSS3 text-justify property</title>
<style>a.menu_css3_pr_text-justify{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_text-justify">Try it yourself &raquo;</a>
...
<p>The text-justify property is currently supported only in Internet Explorer.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-justify">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>inter-word</td>
    <td>Increases/Decreases the space between words</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-justify&amp;preval=inter-word">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>inter-ideograph</td>
    <td>Justifies content with ideographic text</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-justify&amp;preval=inter-ideograph">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>inter-cluster</td>
    <td>Only content that does not contain any inter-word spacing (such as Asian 
	languages) is justified</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-justify&amp;preval=inter-cluster">Play it &raquo;</a></td>	
  </tr>
  <tr>
    <td>distribute</td>
    <td>Like the newspaper value, except that in East Asian languages (such as 
	Thai) the last line is not justified</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-justify&amp;preval=distribute">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>kashida</td>
    <td>Justifies content by elongating characters</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-justify&amp;preval=kashida">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>trim</td>
    <td>&nbsp;</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-justify&amp;preval=trim">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>none</td>
    <td>The justification is disabled</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-justify&amp;preval=none">Play it &raquo;</a></td>
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_text-justify&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_text-justify.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_text-justify.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_text-justify.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
