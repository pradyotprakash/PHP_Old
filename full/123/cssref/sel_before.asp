...
<title>CSS :before Selector</title>
<style>a.menu_sel_before{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:before</span> Selector</h1>
...
<p>Insert content before every &lt;p&gt; element's content:</p>
<div class="example_code notranslate">
  
    p:before<br>
	{ <br>
	content:"Read this: ";<br>
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_sel_before">Try it yourself &raquo;</a>
...
<p>The :before selector inserts content before the content of the selected element(s).</p>
<p>Use the <a href="pr_gen_content.asp">content</a> property to specify the content 
to insert.</p>
...
<p>The :before selector is supported in all major browsers.</p>
<p><b>Note:</b> For :before to work in IE8, a <a href="../tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> 
must be declared.</p>

<hr>
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="../css/css_pseudo_elements.asp">CSS Pseudo-elements</a></p>
<p>CSS Selector Reference: <a href="sel_after.asp">CSS :after selector</a></p>
...
<h2 class="example">Example</h2>
<p>Insert content before every &lt;p&gt; element's content, and style the inserted content:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_sel_before_style" class="tryitbtn">Try it yourself &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_before.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_before.asp#top" target="_top">TOP</a> |
		<a href="sel_before.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
