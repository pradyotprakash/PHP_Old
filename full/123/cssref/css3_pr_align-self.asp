...
<style>a.menu_css3_pr_align-self{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss3_align-self" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The align-self property is supported in Firefox, Opera, and Chrome.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_align-self">Try it</a>
    </td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-self&amp;preval=auto">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>stretch</td>
    <td>The element is positioned to fit the conatiner</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-self&amp;preval=stretch">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>center</td>
    <td>The element is positioned at the center of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-self&amp;preval=center">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td>flex-start</td>
    <td>The element is are positioned at the beginning of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-self&amp;preval=flex-start">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>flex-end</td>
    <td>The element is positioned at the end of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-self&amp;preval=flex-end">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>baseline</td>
    <td>The element is positioned at the baseline of the container</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-self&amp;preval=baseline">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_align-self&amp;preval=initial">Play it &raquo;</a></td>          
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_align-self.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_align-self.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_align-self.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
