...
<title>CSS3 :enabled Selector</title>
<style>a.menu_sel_enabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">:enabled</span> Selector</h1>
...
<p>Set a background color for all enabled input elements of type=&quot;text&quot;:</p>
...
<p>The :enabled selector 
matches every enabled element (mostly used on form elements).</p>
<hr>
...
<p>The :enabled selector is supported in all major browsers, except IE8 and 
earlier.</p>
<hr>
...
<h2 class="example">Example</h2>
<p>Set a background color for all enabled input elements:</p>
<div class="example_code notranslate">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_enabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_enabled.asp#top" target="_top">TOP</a> |
		<a href="sel_enabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
