...
<title>CSS3 [attribute*=value] Selector</title>
<style>a.menu_sel_attr_contain{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>CSS3 <span class="color_h1">[<i>attribute*</i>=<i>value</i>]</span> Selector</h1>
...
<p>Set a background color on all div elements that have a class attribute value 
containing &quot;test&quot;:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_attr_contain">Try it yourself &raquo;</a>
...
<p>The [<i>attribute*</i>=<i>value</i>] selector 
matches every element whose <i>attribute</i> value containing a specified <i>value</i>.</p>
<hr>
...
<p><b>Note:</b> For this selector to work in IE8 and earlier, a <a href="../tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> must be declared.</p>
...
<h2 class="example">Example</h2>
<p>Set a background color on all elements that have a class attribute value 
containing &quot;test&quot;:</p>
<div class="example_code notranslate">
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_attr_contain2">Try it yourself &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sel_attr_contain.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sel_attr_contain.asp#top" target="_top">TOP</a> |
		<a href="sel_attr_contain.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
