...
<style>a.menu_css3_pr_background{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Set all the background properties in one declaration:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss_background">Try it yourself &raquo;</a>
...
<p>The properties that can be set, are: background-color, 
background-position, background-size, background-repeat, background-origin, 
background-clip, background-attachment, and background-image.</p>
...
<table class="tecspec">
  <tr>
    ...
    <td width="75%"><i>see individual properties</i></td>
  </tr>
	<tr>
    <th>Inherited:</th>
    <td>no</td>
	...
	no-repeat&quot;
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_background">Try it</a>
</td>
  </tr>
	</table>
<br>
...
background: <i>color position size 
	repeat origin clip attachment 
	image</i>|initial|inherit;</div></div>
<br>
<table class="reference notranslate">
  ...
  <tr>
    <td><i><a href="css3_pr_background-size.asp">background-size</a></i></td>
  ...
  <tr>
    <td><i><a href="css3_pr_background-origin.asp">background-origin</a></i></td>
    <td>Specifies the positioning area of the background images</td>
    <td>3</td>
  </tr>
  <tr>
    <td><i><a href="css3_pr_background-clip.asp">background-clip</a></i></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_background.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_background.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_background.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
