...
<html lang="en-US">
<head>
<title>CSS3 column-gap property</title>
<style>a.menu_css3_pr_column-gap{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="example_code notranslate">
    ...
    div<br>
	{<br>
	column-gap:40px;<br>-moz-column-gap:40px; /* Firefox */<br>
	-webkit-column-gap:40px; /* Safari and Chrome */<br>
	}
  
</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=trycss3_column-gap">Try it yourself &raquo;</a>
...
<p>The column-gap property is supported in Internet Explorer 10 and Opera.</p>
<p>Firefox supports an alternative, the -moz-column-gap property.</p>
<p>Safari and Chrome support an alternative, the -webkit-column-gap property.</p>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss3_js_column-gap">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-gap">Play it &raquo;</a></td>			    
  </tr>
  <tr>
    <td>normal</td>
    <td>Default value. Specifies a normal gap between the columns. W3C suggests a value of 1em</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-gap&amp;preval=normal">Play it &raquo;</a></td>			        
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_column-gap&amp;preval=initial">Play it &raquo;</a></td>			        
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="css3_pr_column-gap.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="css3_pr_column-gap.asp#top" target="_top">TOP</a> |
		<a href="css3_pr_column-gap.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
