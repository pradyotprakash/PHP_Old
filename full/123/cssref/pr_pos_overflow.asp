...
<style>a.menu_pr_pos_overflow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_overflow" class="tryitbtn">Try it yourself &raquo;</a>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_overflow">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	box. 
	This is default</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow">Play it &raquo;</a></td>		                  	
  </tr>
	<tr>
    <td>hidden</td>
    <td>The overflow is clipped, and the rest of the content&nbsp;will 
	be invisible</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow&amp;preval=hidden">Play it &raquo;</a></td>		                  		
  </tr>
	<tr>
    <td>scroll</td>
    <td>The overflow is clipped, but a scroll-bar is added to see the rest of the content</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow&amp;preval=scroll">Play it &raquo;</a></td>		                  		  
  </tr>
	<tr>
    <td>auto</td>
    <td>If overflow is clipped, a
      scroll-bar should be added to see the rest of the content</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow&amp;preval=auto">Play it &raquo;</a></td>		                  		
  </tr>
	<tr>
    <td>initial</td>
    <td>Sets this property to its default value. <a href="css_initial.asp">Read about <em>initial</em></a></td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_overflow&amp;preval=initial">Play it &raquo;</a></td>		                  		
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_pos_overflow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_pos_overflow.asp#top" target="_top">TOP</a> |
		<a href="pr_pos_overflow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
