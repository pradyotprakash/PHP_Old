...
<style>a.menu_pr_font_font-size{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_font-size" class="tryitbtn">Try it yourself &raquo;</a>
...
<p>The font-size property is supported in all major browsers.</p>
<hr>
...
<a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=trycss_js_font-size">Try it</a>
</td>
  </tr>
	</table>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=medium">Play it &raquo;</a></td>        
  </tr>
  <tr>
    <td>xx-small</td>
    <td>Sets the font-size to an xx-small size</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=xx-small">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>x-small</td>
    <td>Sets the font-size to an extra small size</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=x-small">Play it &raquo;</a></td>        
  </tr>
  <tr>
    <td>small</td>
    <td>Sets the font-size to a small size</td>
   	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=small">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>large</td>
    <td>Sets the font-size to a large size</td>
   	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=large">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>x-large</td>
    <td>Sets the font-size to an extra large size</td>
   	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=x-large">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>xx-large</td>
    <td>Sets the font-size to an xx-large size</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=xx-large">Play it &raquo;</a></td>        
  </tr>
  <tr>
    <td>smaller</td>
    <td>Sets the font-size to a smaller size than the parent
      element</td>
     	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=smaller">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>larger</td>
    <td>Sets the font-size to a larger size than the parent element</td>
   	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=larger">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Sets the font-size to a fixed size in px, cm, etc.</td>
   	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=10px">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Sets the font-size to a percent of&nbsp; the parent element's 
	font size</td>
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=50%25">Play it &raquo;</a></td>    
  </tr>
	<tr>
    <td>initial</td>
	...
	<td><a target="_blank" class="playitbtn" href="playit.asp?filename=playcss_font-size&amp;preval=initial">Play it &raquo;</a></td>
    </tr>
	<tr>
    <td>inherit</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="pr_font_font-size.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="pr_font_font-size.asp#top" target="_top">TOP</a> |
		<a href="pr_font_font-size.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
