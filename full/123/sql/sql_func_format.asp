...
<title>SQL FORMAT() Function</title>
<style>a.menu_sql_func_format{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">FORMAT()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_now.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_quickref.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
SELECT FORMAT(column_name,format) FROM table_name;</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>column_name</td>
    <td>Required. The field to be formatted.</td>
  </tr>
  <tr>
    <td>format</td>
    <td>Required. Specifies the format.</td>
  </tr>
  </table>
<br>
<hr>
...
<p>The following SQL statement selects the product name, and price for today 
(formatted like YYYY-MM-DD) from the &quot;Products&quot; table:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT ProductName, Price, FORMAT(Now(),'YYYY-MM-DD') AS PerDate<br>FROM 
	Products; </div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_format&amp;ss=-1" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_now.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_format.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_format.asp#top" target="_top">TOP</a> |
		<a href="sql_func_format.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
