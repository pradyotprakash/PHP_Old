...
<style>a.menu_sql_orderby{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_and_or.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_insert.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The ORDER BY keyword is used to sort the result-set.</p>
<hr>

<h2>The SQL ORDER BY Keyword</h2>
<p>The ORDER BY keyword is used to sort the result-set by one or more columns.</p>
<p>The ORDER BY keyword sorts the records in ascending order by default. To sort 
...
<div class="code notranslate"><div>
	...
	ORDER BY <em>column_name</em>,<em>column_name</em> ASC|DESC;</div></div>
<br>
<hr>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_orderby" class="tryitbtn">
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_orderby_desc" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_orderby2" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_orderby.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_orderby.asp#top" target="_top">TOP</a> |
		<a href="sql_orderby.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
