...
<style>a.menu_func_date_sub{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The DATE_SUB() function subtracts a specified time interval from a date.</p>

<h3><b>Syntax</b></h3>
<div class="code notranslate"><div>
DATE_SUB(date,INTERVAL expr type)</div></div>
<p>Where date is a valid date expression and expr is the number of interval you want to subtract.</p>

<p>type can be one of the following:</p>
<table class="reference notranslate" style="width:50%">
<tr><th>Type Value</th></tr>
...
<p>Now we want to subtract 5 days from the &quot;OrderDate&quot; date.</p>
<p>We use the following SELECT statement:</p>

<div class="code notranslate"><div>
SELECT OrderId,DATE_SUB(OrderDate,INTERVAL 5 DAY) AS SubtractDate<br>
FROM Orders</div></div>

<p>Result:</p>
<table class="reference notranslate" style="width:50%">
<tr><th>OrderId</th><th>SubtractDate</th></tr>
<tr><td>1</td><td>2008-11-06 13:23:44.657</td></tr></table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_sub.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_sub.asp#top" target="_top">TOP</a> |
		<a href="func_date_sub.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
