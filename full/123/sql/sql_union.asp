...
<style>a.menu_sql_union{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_join_full.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_select_into.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The SQL UNION operator combines the result of two or more 
SELECT statements.</p>
<hr>

<h2>The SQL UNION Operator</h2>
<p>The UNION operator is used to combine the result-set of two or more SELECT 
statements.</p>
<p>Notice that each SELECT statement within the UNION must have the same number 
of columns. The columns must also have similar data types. Also, the columns in 
each SELECT statement must be in the same order.</p>
...
<p><b>Note:</b> The UNION operator selects only distinct values by default. To 
allow duplicate values, use the ALL keyword with UNION.</p>
...
<p><b>PS:</b> The column names in the result-set of a UNION are usually equal to 
the column names in the first SELECT statement in the UNION.</p>
<hr>
<h2>Demo Database</h2>
...
<p>The following SQL statement selects all the <strong>different</strong> cities 
(only distinct values) from the "Customers" and the "Suppliers" tables:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT City FROM Customers<br>UNION<br>SELECT City FROM Suppliers<br>ORDER 
	BY City;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_union" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>

<p><b>Note:</b> UNION cannot be used to list ALL cities from the two tables. If 
...
<p>The following SQL statement uses UNION ALL to select <strong>all</strong> 
(duplicate values also) cities from the "Customers" and "Suppliers" tables:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_union_all" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>The following SQL statement uses UNION ALL to select <strong>all</strong> 
(duplicate values also) <strong>German</strong> cities from the "Customers" and 
"Suppliers" tables:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT City, Country FROM Customers<br>WHERE Country='Germany'<br>UNION ALL<br>
	SELECT City, Country FROM Suppliers<br>WHERE Country='Germany'<br>ORDER BY 
	City;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_union_all2" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_union.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_union.asp#top" target="_top">TOP</a> |
		<a href="sql_union.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
