...
<style>a.menu_sql_alias{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_between.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_join.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">SQL aliases are used to temporarily rename a table or a column 
heading.</p>
<hr>
<h2>SQL Aliases</h2>
<p>SQL aliases are used to give a database table, or a column in a table, a 
temporary name.</p>
<p>Basically aliases are created to make column names more readable.</p>
<h3>SQL Alias Syntax for Columns</h3>
<div class="code notranslate"><div>
	SELECT <em>column_name</em> AS <em>alias_name</em><br>
...
<h2>Alias Example for Table Columns</h2>
<p>The following SQL statement specifies two aliases, one for the CustomerName 
column and one for the ContactName column. <strong>Tip:</strong> It require 
double quotation marks or square brackets if the column name contains spaces:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT CustomerName AS Customer, ContactName AS [Contact Person]<br>
	FROM Customers;</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_alias_column" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>

<p>In the following SQL statement we combine four columns (Address, City, 
PostalCode, and Country) and create an alias named "Address":</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	...
	Address<br>
	FROM Customers;</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_alias_column2&amp;ss=-1" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>

<p><strong>Note:</strong> To get the SQL statement above to work in MySQL use 
the following:</p>

<div class="code notranslate"><div>
	SELECT CustomerName, CONCAT(Address,', ',City,', ',PostalCode,', ',Country) 
	AS Address<br>
	FROM Customers;</div></div>
<br>
<hr>

<h2>Alias Example for Tables</h2>
...
give them the table aliases of "c" and "o" respectively (Here we have used 
aliases to make the SQL shorter):</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT o.OrderID, o.OrderDate, c.CustomerName<br>FROM Customers AS c, Orders 
	AS o<br>WHERE c.CustomerName="Around the Horn" AND 
	c.CustomerID=o.CustomerID;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_alias_table" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>

<p>The same SQL statement without aliases:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT Orders.OrderID, Orders.OrderDate, Customers.CustomerName<br>FROM 
	Customers, Orders<br>WHERE Customers.CustomerName="Around the Horn" AND 
	Customers.CustomerID=Orders.CustomerID;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_alias_no" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_alias.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_alias.asp#top" target="_top">TOP</a> |
		<a href="sql_alias.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
