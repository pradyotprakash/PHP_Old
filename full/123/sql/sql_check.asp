...
<style>a.menu_sql_check{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_foreignkey.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_default.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>The following SQL creates a CHECK constraint on the &quot;P_Id&quot; column when the &quot;Persons&quot; table is created.
The CHECK constraint specifies that the column &quot;P_Id&quot; must only include integers greater than 0.</p>
...
ADD CHECK (P_Id&gt;0)</div></div>

<p>To allow naming of a CHECK constraint, and for defining a CHECK constraint on multiple columns, use the following SQL syntax:</p>
<p><b>MySQL / SQL Server / Oracle / MS Access:</b></p>
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
ADD CONSTRAINT chk_Person CHECK (P_Id&gt;0 AND City='Sandnes')</div></div>
<br>
<hr>
...
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
DROP CONSTRAINT chk_Person</div></div>

<p><b>MySQL:</b></p>
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
DROP CHECK chk_Person</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_check.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_check.asp#top" target="_top">TOP</a> |
		<a href="sql_check.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
