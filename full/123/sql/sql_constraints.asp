...
<style>a.menu_sql_constraints{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_create_table.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_notnull.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>SQL Constraints</h2>
<p>SQL constraints are used to specify rules for the data in a table.</p>
<p>&nbsp;If there is any violation between the constraint and the data action, 
the action is aborted by the constraint.</p>
...
<h3>SQL CREATE TABLE + CONSTRAINT Syntax</h3>
<div class="code notranslate"><div>
CREATE TABLE <em>table_name</em><br>
(<br>
	<em>column_name1 data_type</em>(<em>size</em>) <em>constraint_name</em>,<br>
	<em>column_name2 data_type</em>(<em>size</em>) <em>constraint_name</em>,<br>
	<em>column_name3 data_type</em>(<em>size</em>) <em>constraint_name</em>,<br>
....<br>
);</div></div>

<p>&nbsp;In SQL, we have the following constraints:</p>
<ul>
	<li><strong>NOT NULL</strong> - Indicates that a column cannot store NULL 
	value</li>
	<li><strong>UNIQUE</strong> - Ensures that each row for a column must have 
	a unique value</li>
	<li><strong>PRIMARY KEY</strong> - A combination of a NOT NULL and UNIQUE. 
	Ensures that a column (or combination of two or more columns) have an unique 
	identity which helps to find a particular record in a table more easily and 
	quickly</li>
	<li><strong>FOREIGN KEY</strong> - Ensure the referential integrity of the 
	data in one table to match values in another table</li>
	<li><strong>CHECK</strong> - Ensures that the value in a column meets a 
	specific condition</li>
	<li><strong>DEFAULT</strong> - Specifies a default value when specified none 
	for this column</li>
</ul>
<p>The next chapters will describe each constraint in detail.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_create_table.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_notnull.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_constraints.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_constraints.asp#top" target="_top">TOP</a> |
		<a href="sql_constraints.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
