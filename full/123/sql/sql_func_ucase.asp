...
<title>SQL UCASE() Function</title>
<style>a.menu_sql_func_ucase{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">UCASE()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_having.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_lcase.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<div class="code notranslate"><div>
	SELECT UCASE(column_name) FROM table_name;</div></div>

<h3>Syntax for SQL Server</h3>
<div class="code notranslate"><div>
	SELECT UPPER(column_name) FROM table_name;</div></div>
<br>
<hr>
...
from the "Customers" table, and converts the "CustomerName" column to uppercase:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT UCASE(CustomerName) AS Customer, City<br>FROM Customers; </div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_ucase&amp;ss=-1" class="tryitbtn">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_ucase.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_ucase.asp#top" target="_top">TOP</a> |
		<a href="sql_func_ucase.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
