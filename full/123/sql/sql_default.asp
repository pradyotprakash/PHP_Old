...
<style>a.menu_sql_default{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_check.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_create_index.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
ALTER City SET DEFAULT 'SANDNES'</div></div>

<p><b>SQL Server / MS Access:</b></p>
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
ALTER COLUMN City SET DEFAULT 'SANDNES'</div></div>

<p><b>Oracle:</b></p>
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
MODIFY City DEFAULT 'SANDNES'</div></div>
<br>
<hr>
...
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
ALTER City DROP DEFAULT</div></div>

<p><b>SQL Server / Oracle / MS Access:</b></p>
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
ALTER COLUMN City DROP DEFAULT</div></div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_check.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_create_index.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_default.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_default.asp#top" target="_top">TOP</a> |
		<a href="sql_default.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
