...
<style>a.menu_sql_primarykey{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_unique.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_foreignkey.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><b>Note:</b> In the example above there is only ONE PRIMARY KEY (pk_PersonID). 
...
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
ADD CONSTRAINT pk_PersonID PRIMARY KEY (P_Id,LastName)</div></div>

<p><b>Note:</b> If you use the ALTER TABLE statement to add a primary key, the primary key column(s) must
already have been declared to not contain NULL values (when the table was first created).</p>
<hr>
...
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
DROP PRIMARY KEY</div></div>

<p><b>SQL Server / Oracle / MS Access:</b></p>
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
DROP CONSTRAINT pk_PersonID</div></div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_unique.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_foreignkey.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_primarykey.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_primarykey.asp#top" target="_top">TOP</a> |
		<a href="sql_primarykey.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
