...
<title>SQL RIGHT JOIN Keyword</title>
<style>a.menu_sql_join_right{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_join_left.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_join_full.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>SQL RIGHT JOIN Keyword</h2>
<p>The RIGHT JOIN keyword returns all rows from the right table (table2), with the 
...
FROM <em>table1</em><br>
	RIGHT JOIN <em>table2</em><br>
ON <em>table1.column_name</em>=<em>table2.column_name</em>;</div></div>

<p>or:</p>
<div class="code notranslate"><div>
SELECT <em>column_name(s)</em><br>
FROM <em>table1</em><br>
	RIGHT OUTER JOIN <em>table2</em><br>
ON <em>table1.column_name</em>=<em>table2.column_name</em>;</div></div>
<p><b>PS!</b> In some databases RIGHT JOIN is called RIGHT OUTER JOIN.</p>
<p style="text-align:center;"><img alt="SQL RIGHT JOIN" height="145" src="img_rightjoin.gif" width="200"></p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>12/8/1968</td>
    <td>EmpID1.pic</td>
    <td>Education includes a BA in psychology.....</td>
  </tr>
  <tr>
    <td>2</td>
    <td>Fuller</td>
    ...
    <td>2/19/1952</td>
    <td>EmpID2.pic</td>
    <td>Andrew received his BTS commercial and....</td>
  </tr>
  <tr>
    <td>3</td>
    <td>Leverling</td>
    ...
    <td>8/30/1963</td>
    <td>EmpID3.pic</td>
    <td>Janet has a BS degree in chemistry....</td>
  </tr>
  </table>
<br>
<hr>
...
<p>The following SQL statement will return all employees, and any orders they have placed:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT Orders.OrderID, Employees.FirstName<br>FROM Orders<br>RIGHT JOIN 
	Employees<br>ON Orders.EmployeeID=Employees.EmployeeID<br>ORDER BY 
	Orders.OrderID;</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_join_right&amp;ss=-1" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p><strong>Note:</strong> The RIGHT JOIN keyword returns all the rows from the right table (Employees), even if there are no matches in the left table (Orders).</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_join_left.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_join_full.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_join_right.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_join_right.asp#top" target="_top">TOP</a> |
		<a href="sql_join_right.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
