...
<style>a.menu_func_date{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>MySQL <span class="color_h1">DATE()</span> Function</h1>
<hr>
<a href="sql_dates.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="SQL Dates" /> MySQL Date Functions</a>
<hr>

<h2>Definition and Usage</h2>
<p>The DATE() function extracts the date part of a date or date/time expression.</p>

<h3><b>Syntax</b></h3>
<div class="code notranslate"><div>
DATE(date)</div></div>
<p>Where date is a valid date expression.</p>
<hr>
...
<div class="code notranslate"><div>
SELECT ProductName, DATE(OrderDate) AS OrderDate<br>
FROM Orders<br>
WHERE OrderId=1</div></div>

<p>will result in this:</p>
<table class="reference notranslate" style="width:50%">
<tr><th>ProductName</th><th>OrderDate</th></tr>
<tr><td>Jarlsberg Cheese</td><td>2008-11-11</td></tr></table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date.asp#top" target="_top">TOP</a> |
		<a href="func_date.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
