...
<style>a.menu_sql_having{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">HAVING</span> Clause</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_groupby.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_ucase.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>The following SQL statement finds if any of the employees has registered more than 10 orders:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT Employees.LastName, COUNT(Orders.OrderID) AS NumberOfOrders FROM 
	(Orders<br>INNER JOIN Employees<br>ON 
	Orders.EmployeeID=Employees.EmployeeID)<br>GROUP BY LastName<br>HAVING 
	COUNT(Orders.OrderID) &gt; 10;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_having" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Now we want to find the if the employees &quot;Davolio&quot; or &quot;Fuller&quot; 
have more than 25 orders</p>
<p>We add an ordinary WHERE clause to the SQL statement:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT Employees.LastName, COUNT(Orders.OrderID) AS NumberOfOrders FROM 
	Orders<br>INNER JOIN Employees<br>ON Orders.EmployeeID=Employees.EmployeeID<br>
	WHERE LastName='Davolio' OR LastName='Fuller'<br>GROUP BY LastName<br>HAVING 
	COUNT(Orders.OrderID) &gt; 25;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_having_where" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_groupby.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_having.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_having.asp#top" target="_top">TOP</a> |
		<a href="sql_having.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
