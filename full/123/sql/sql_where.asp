...
<style>a.menu_sql_where{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_distinct.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_and_or.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The WHERE clause is used to filter records.</p>
<hr>

<h2>The SQL WHERE Clause&nbsp;</h2>
<p>The WHERE clause is used to extract only those records that fulfill a 
...
<div class="code notranslate"><div>
	...
	WHERE <em>column_name operator value</em>;</div></div>
<br>
<hr>
<h2>Demo Database</h2>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_where" class="tryitbtn">
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_where_number" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>&lt;&gt;</td>
    <td>Not equal. <b>Note:</b> In some versions of SQL this operator may be 
	written as !=</td>
  </tr>
  <tr>
    <td>&gt;</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_where.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_where.asp#top" target="_top">TOP</a> |
		<a href="sql_where.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
