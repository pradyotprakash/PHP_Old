...
<style>a.menu_sql_alter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_drop.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_autoincrement.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
ADD column_name datatype</div></div>
...
<div class="code notranslate"><div>
ALTER TABLE table_name<br>
DROP COLUMN column_name</div></div>
...
<div class="code notranslate"><div>
ALTER TABLE table_name<br>
ALTER COLUMN column_name datatype</div></div>

<p><b>My SQL / Oracle:</b></p>

<div class="code notranslate"><div>
ALTER TABLE table_name<br>
MODIFY COLUMN column_name datatype</div></div>

<p><b>Oracle 10G and later:</b></p>

<div class="code notranslate"><div>
ALTER TABLE table_name<br>
MODIFY column_name datatype</div></div>
<br>
<hr>
...
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
ALTER COLUMN DateOfBirth year</div></div>
...
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
DROP COLUMN DateOfBirth</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_alter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_alter.asp#top" target="_top">TOP</a> |
		<a href="sql_alter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
