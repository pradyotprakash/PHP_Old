...
<title>Date Functions in SQL Server and MySQL</title>
<style>a.menu_sql_dates{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">Date</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_view.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_null_values.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>SQL Dates</h2>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>The most difficult part when working with dates is to be sure that the format of the date you are trying to insert,
matches the format of the date column in the database.</td>
</tr></table>
...
<p><b>MySQL</b> comes with the following data types for storing a date or a date/time value in the database:</p>
<ul>
...
<p><b>SQL Server</b> comes with the following data types for storing a date or a date/time value in the database:</p>
<ul>
	<li>DATE - format YYYY-MM-DD</li>
	<li>DATETIME - format: YYYY-MM-DD HH:MM:SS</li>
...
<p><b>Note:</b> The date types are chosen for a column when you create a new table in your database!</p>
<p>For an overview of all data types available, go to our complete <a href="sql_datatypes.asp">Data Types reference</a>.</p>
<hr>

<h2>SQL Working with Dates</h2>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>You can compare two dates easily if there is no time component involved!</td>
</tr></table>
...
<p><b>Tip:</b> If you want to keep your queries simple and easy to maintain, do not allow time components in your dates!</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_view.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_null_values.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_dates.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_dates.asp#top" target="_top">TOP</a> |
		<a href="sql_dates.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
