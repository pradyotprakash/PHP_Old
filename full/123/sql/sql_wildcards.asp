...
<style>a.menu_sql_wildcards{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">Wildcards</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_like.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_in.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A wildcard character can be used to substitute for any other 
character(s) in a string.</p>
<hr>

<h2>SQL Wildcard Characters</h2>
<p>In SQL, wildcard characters are used with the SQL LIKE operator. </p>
<p>SQL wildcards are used to search for data within a table.&nbsp;</p>
<p>With SQL, the wildcards are:</p>
<table class="reference notranslate">
  <tr>
    <th style="width:15%">Wildcard</th>
    <th>Description</th>
  </tr>
  <tr>
    <td>%</td>
  ...
  <tr>
	...
	<tr>
    <td>[^<em>charlist</em>]<br>or<br>[!<em>charlist</em>]</td>
...
<br>
<hr>
<h2>Using the SQL % Wildcard</h2>
<p>The following SQL statement selects all customers with a City starting with 
"ber":</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_percent" class="tryitbtn">
	Try it yourself &raquo;</a>

</div>

<p>The following SQL statement selects all customers with a City containing the 
pattern "es":&nbsp;</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_percent_pattern" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Using the SQL _ Wildcard</h2>

<p>The following SQL statement selects all customers with a City starting with 
any character, followed by "erlin":</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_underscore" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<p>The following SQL statement selects all customers with a City starting with 
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_underscore2" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Using the SQL [charlist] Wildcard</h2>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_charlist&amp;ss=-1" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_charlist2&amp;ss=-1" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>

<p>The following SQL statement selects all customers with a City NOT starting 
with "b", "s", or "p":</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_not_charlist&amp;ss=-1" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_wildcards.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_wildcards.asp#top" target="_top">TOP</a> |
		<a href="sql_wildcards.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
