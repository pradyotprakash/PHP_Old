...
<style>a.menu_sql_func_max{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">MAX()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_last.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_min.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
SELECT MAX(column_name) FROM table_name;</div></div>
<br>
<hr>
<h2>Demo Database</h2>
...
<p>The following SQL statement gets the largest value of the &quot;Price&quot; column from the &quot;Products&quot; table:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT MAX(Price) AS HighestPrice FROM Products;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_max" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_last.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_max.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_max.asp#top" target="_top">TOP</a> |
		<a href="sql_func_max.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
