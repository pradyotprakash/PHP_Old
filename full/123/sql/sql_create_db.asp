...
<style>a.menu_sql_create_db{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_insert_into_select.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_create_table.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
CREATE DATABASE <em>dbname</em>;</div></div>
<br>
<hr>

<h2>SQL CREATE DATABASE Example</h2>
<p>The following SQL statement creates a database called &quot;my_db&quot;:</p>
<div class="code notranslate"><div>
CREATE DATABASE my_db;</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_create_db.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_create_db.asp#top" target="_top">TOP</a> |
		<a href="sql_create_db.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
