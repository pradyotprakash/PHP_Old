...
<title>SQL SELECT TOP, LIMIT, ROWNUM</title>
<style>a.menu_sql_top{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">SELECT TOP</span> Clause</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_injection.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_like.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>The SQL SELECT TOP Clause</h2>
<p>The SELECT TOP clause is used to specify the number of records to return.</p>
<p>The SELECT TOP clause can be very useful on large tables with thousands of 
records. Returning a large number of records can impact on performance.</p>
<p><b>Note:</b> Not all database systems support the SELECT TOP clause.</p>

<h3>SQL Server / MS Access Syntax</h3>
<div class="code notranslate"><div>
	SELECT TOP <em>number</em>|<em>percent</em> <em>column_name(s)</em><br>
...
<div class="code notranslate"><div>
	SELECT <em>column_name(s)</em><br>
	FROM <em>table_name</em><br>
	WHERE ROWNUM &lt;= <em>number</em>;</div></div>

<h3>Example</h3>
<div class="code notranslate"><div>
	SELECT *<br>
	FROM Persons<br>
	WHERE ROWNUM &lt;=5;</div></div>
<br>
<hr>
<h2>Demo Database</h2>
...
<h2>SQL SELECT TOP Example</h2>
<p>The following SQL statement selects the two first records from the 
"Customers" table:</p>
<div class="example">
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_top&amp;ss=-1" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>SQL SELECT TOP PERCENT Example</h2>
<p>The following SQL statement selects the first 50% of the records from the 
"Customers" table:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_top_percent&amp;ss=-1" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_top.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_top.asp#top" target="_top">TOP</a> |
		<a href="sql_top.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
