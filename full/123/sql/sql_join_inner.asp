...
<title>SQL INNER JOIN Keyword</title>
<style>a.menu_sql_join_inner{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_join.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_join_left.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>SQL INNER JOIN Keyword</h2>
<p>The INNER JOIN keyword selects all rows from both tables as long as there is 
a match between the columns in both tables.</p>

<h3>SQL INNER JOIN Syntax</h3>
<div class="code notranslate"><div>
	SELECT <em>column_name(s)</em><br>
	FROM <em>table1</em><br>
	INNER JOIN <em>table2</em><br> 
...
<div class="code notranslate"><div>
	SELECT <em>column_name(s)</em><br>
	FROM <em>table1</em><br>
	JOIN <em>table2</em><br> 
	ON <em>table1.column_name</em>=<em>table2.column_name</em>;</div></div>
<p><b>PS!</b> INNER JOIN is the same as JOIN.</p>
<p style="text-align:center;"><img alt="SQL INNER JOIN" height="145" src="img_innerjoin.gif" width="200"></p>
<hr>
...
<p>The following SQL statement will return all customers with orders:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT Customers.CustomerName, Orders.OrderID<br>FROM Customers<br>INNER 
	JOIN Orders<br>
	ON Customers.CustomerID=Orders.CustomerID<br>ORDER BY 
	Customers.CustomerName;</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_join_inner" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>

<p><strong>Note:</strong> The INNER JOIN keyword selects all rows from both 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_join_inner.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_join_inner.asp#top" target="_top">TOP</a> |
		<a href="sql_join_inner.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
