...
<title>SQL Server DATEADD() Function</title>
...
<h1>SQL Server <span class="color_h1">DATEADD()</span> Function</h1>
<hr>
...
<p>The DATEADD() function adds or subtracts a specified time interval from a date.</p>

<h3><b>Syntax</b></h3>
<div class="code notranslate"><div>
DATEADD(datepart,number,date)</div></div>
<p>Where date is a valid date expression and number is the number of interval 
you want to add. The number can either be positive, for dates in the future, or 
negative, for dates in the past.</p>
<p>datepart can be one of the following:</p>

<table class="reference notranslate">
<tr><th>datepart</th><th>Abbreviation</th></tr>
...
<div class="code notranslate"><div>
SELECT OrderId,DATEADD(day,45,OrderDate) AS OrderPayDate<br>
FROM Orders</div></div>

<p>Result:</p>
<table class="reference notranslate" style="width:50%">
<tr><th>OrderId</th><th>OrderPayDate</th></tr>
<tr><td>1</td><td>2008-12-26 13:23:44.657</td></tr></table>
<br>
<hr>
