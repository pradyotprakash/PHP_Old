...
<h1>SQL Server <span class="color_h1">DATEDIFF()</span> Function</h1>
<hr>
...
DATEDIFF(datepart,startdate,enddate)</div></div>
...
<div class="code notranslate"><div>
SELECT DATEDIFF(day,'2008-06-05','2008-08-05') AS DiffDate</div></div>
<p>Result:</p>

<table class="reference notranslate" style="width:50%">
<tr><th>DiffDate</th></tr>
<tr><td>61</td></tr></table>

<h3><b>Example</b></h3>
<p>Now we want to get the number of days between two dates (notice that the 
second date is &quot;earlier&quot; than the first date, and will result in a negative 
number).</p>

<p>We use the following SELECT statement:</p>
<div class="code notranslate"><div>
SELECT DATEDIFF(day,'2008-08-05','2008-06-05') AS DiffDate</div></div>
