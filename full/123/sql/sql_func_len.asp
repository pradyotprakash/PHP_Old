...
<title>SQL LEN() Function</title>
<style>a.menu_sql_func_len{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">LEN()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_mid.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_round.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<div class="code notranslate"><div>
	SELECT LEN(column_name) FROM table_name;</div></div>
<br>
<hr>
...
<p>The following SQL statement selects the "CustomerName" and the length of the 
values in the "Address" column from the "Customers" table:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT CustomerName,LEN(Address) as LengthOfAddress<br>FROM Customers;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_len&amp;ss=-1" class="tryitbtn">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_len.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_len.asp#top" target="_top">TOP</a> |
		<a href="sql_func_len.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
