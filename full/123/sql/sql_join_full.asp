...
<title>SQL FULL OUTER JOIN Keyword</title>
<style>a.menu_sql_join_full{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_join_right.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_union.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>SQL FULL OUTER JOIN Keyword</h2>
<p>The FULL OUTER JOIN keyword returns all rows from the left table (table1) and 
from the right table (table2).</p>
<p>The FULL OUTER JOIN keyword combines the result of both LEFT and RIGHT joins.</p>

<h3>SQL FULL OUTER JOIN Syntax</h3>
<div class="code notranslate"><div>
	SELECT <em>column_name(s)</em><br>
	FROM <em>table1</em><br>
	FULL OUTER JOIN <em>table2</em><br>
	ON <em>table1.column_name</em>=<em>table2.column_name</em>;</div></div>
<p style="text-align:center;"><img alt="SQL FULL OUTER JOIN" height="145" src="img_fulljoin.gif" width="200"></p>
<hr>
...
<p><strong>Note:</strong> The FULL OUTER JOIN keyword returns all the rows from 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_join_full.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_join_full.asp#top" target="_top">TOP</a> |
		<a href="sql_join_full.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
