...
<style>a.menu_func_datediff_mysql{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>MySQL <span class="color_h1">DATEDIFF()</span> Function</h1>
<hr>
...
DATEDIFF(date1,date2)</div></div>

<p>Where date1 and date2 are valid date or date/time expressions.</p>
<p><b>Note:</b> Only the date parts of the values are used in the calculation.</p>
<hr>

<h3><b>Example</b></h3>
<p>The following SELECT statement:</p>
<div class="code notranslate"><div>
SELECT DATEDIFF('2008-11-30','2008-11-29') AS DiffDate</div></div>
...
<p>The following SELECT statement:</p>
<div class="code notranslate"><div>
SELECT DATEDIFF('2008-11-29','2008-11-30') AS DiffDate</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_datediff_mysql.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_datediff_mysql.asp#top" target="_top">TOP</a> |
		<a href="func_datediff_mysql.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
