...
<style>a.menu_sql_func_count{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">COUNT()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_avg.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_first.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The COUNT() function returns the number of rows that matches a specified criteria.</p>
<hr>
...
SELECT COUNT(column_name) FROM table_name;</div></div>

<h3>SQL COUNT(*) Syntax</h3>
<p>The COUNT(*) function returns the number of records in a table:</p>

<div class="code notranslate"><div>
SELECT COUNT(*) FROM table_name;</div></div>

<h3>SQL COUNT(DISTINCT column_name) Syntax</h3>
<p>The COUNT(DISTINCT column_name) function returns the number of distinct 
values of the specified column:</p>

<div class="code notranslate"><div>
SELECT COUNT(DISTINCT column_name) FROM table_name;</div></div>

<p><b>Note:</b> COUNT(DISTINCT) works with ORACLE and Microsoft SQL Server, but not with Microsoft Access.</p>
<hr>
<h2>Demo Database</h2>
...
<p>The following SQL statement counts the number of orders from &quot;CustomerID&quot;=7 from the &quot;Orders&quot; table:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT COUNT(CustomerID) AS OrdersFromCustomerID7 FROM Orders<br>WHERE 
	CustomerID=7;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_count" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>SQL COUNT(*) Example</h2>
<p>The following SQL statement counts the total number of orders in the &quot;Orders&quot; table:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT COUNT(*) AS NumberOfOrders FROM Orders;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_count_all" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>SQL COUNT(DISTINCT column_name) Example</h2>

<p>The following SQL statement counts the number of unique customers in the 
&quot;Orders&quot; table:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="trysql.asp?filename=trysql_func_count_distinct" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_count.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_count.asp#top" target="_top">TOP</a> |
		<a href="sql_func_count.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
