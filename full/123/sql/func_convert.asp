...
<title>SQL Server CONVERT() Function</title>
<style>a.menu_func_convert{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">CONVERT()</span> Function</h1>
<hr>
<a href="sql_dates.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="SQL Dates" /> SQL Server Date Functions</a>
<hr>

<h2>Definition and Usage</h2>
<p>The CONVERT() function is a general function that converts an expression of 
one data type to another.</p>
<p>The CONVERT() function can be used to display date/time data in different formats.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
CONVERT(<i>data_type(length)</i>,<i>expression</i>,<i>style</i>)</div></div>
<br>
<table class="reference notranslate">
  ...
  <tr>
    <td><i>data_type(length)</i></td>
    <td>Specifies the target data type (with an optional length)</td>
  </tr>
  <tr>
    <td><i>expression</i></td>
    <td>Specifies the value to be converted</td>
  </tr>
  <tr>
    <td><i>style</i></td>
    <td>Specifies the output format for the date/time</td>
  </tr>
	</table>
<p>The table below represent the style values for datetime or smalldatetime 
conversion to character data:</p>

<table class="reference notranslate">
<tr>
<th style="width:15%">Value<br>
(century yy)</th>
<th style="width:17%">Value<br>
(century yyyy)</th>
<th style="width:48%">Input/Output</th>
<th>Standard</th>
</tr>
<tr><td>-</td><td>0 or 100</td><td>mon dd yyyy hh:miAM (or PM)</td><td>Default</td></tr>
<tr><td>1</td><td>101</td><td>mm/dd/yy</td><td>USA</td></tr>
<tr><td>2</td><td>102</td><td>yy.mm.dd</td><td>ANSI</td></tr>
<tr><td>3</td><td>103</td><td>dd/mm/yy</td><td>British/French</td></tr>
<tr><td>4</td><td>104</td><td>dd.mm.yy</td><td>German</td></tr>
<tr><td>5</td><td>105</td><td>dd-mm-yy</td><td>Italian</td></tr>
<tr><td>6</td><td>106</td><td>dd mon yy</td><td>&nbsp;</td></tr>
<tr><td>7</td><td>107</td><td>Mon dd, yy</td><td>&nbsp;</td></tr>
<tr><td>8</td><td>108</td><td>hh:mm:ss</td><td>&nbsp;</td></tr>
<tr><td>-</td><td>9 or 109</td><td>mon dd yyyy hh:mi:ss:mmmAM (or PM)</td><td>
	Default+millisec</td></tr>
<tr><td>10</td><td>110</td><td>mm-dd-yy</td><td>USA</td></tr>
<tr><td>11</td><td>111</td><td>yy/mm/dd</td><td>Japan</td></tr>
<tr><td>12</td><td>112</td><td>yymmdd</td><td>ISO</td></tr>
<tr><td>-</td><td>13 or 113</td><td>dd mon yyyy hh:mi:ss:mmm (24h)</td><td>&nbsp;</td></tr>
<tr><td>14</td><td>114</td><td>hh:mi:ss:mmm (24h)</td><td>&nbsp;</td></tr>
<tr><td>-</td><td>20 or 120</td><td>yyyy-mm-dd hh:mi:ss (24h)</td><td>&nbsp;</td></tr>
<tr><td>-</td><td>21 or 121</td><td>yyyy-mm-dd hh:mi:ss.mmm (24h)</td><td>&nbsp;</td></tr>
<tr><td>-</td><td>126</td><td>yyyy-mm-ddThh:mi:ss.mmm (no spaces)</td><td>
	ISO8601</td></tr>
...
<h3><b>Example</b></h3>
<p>The following script uses 
the CONVERT() function to display different formats. We will use the GETDATE() function to get the current date/time:</p>

<div class="code notranslate"><div>
CONVERT(VARCHAR(19),GETDATE())<br>
CONVERT(VARCHAR(10),GETDATE(),10)<br>
CONVERT(VARCHAR(10),GETDATE(),110)<br>
CONVERT(VARCHAR(11),GETDATE(),6)<br>
CONVERT(VARCHAR(11),GETDATE(),106)<br>
CONVERT(VARCHAR(24),GETDATE(),113)<br>
</div></div>

<p>The result would look something like this:</p>
<div class="code notranslate"><div>
Nov 04 2011 11:45 PM<br>
	11-04-11<br>
	11-04-2011<br>
	04 Nov 11<br>
	04 Nov 2011<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_convert.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_convert.asp#top" target="_top">TOP</a> |
		<a href="func_convert.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
