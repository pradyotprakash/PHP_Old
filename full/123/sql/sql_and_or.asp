...
<style>a.menu_sql_and_or{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">AND &amp; OR</span> Operators</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_where.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_orderby.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The AND &amp; OR operators are used to filter records based on more 
than one condition.</p>
<hr>

<h2>The SQL AND &amp; OR Operators</h2>
<p>The AND operator displays a record if both the first condition AND the second 
condition are true.</p>
<p>The OR operator displays a record if either the first condition OR the second 
condition is true.</p>
<hr>
<h2>Demo Database</h2>
...
<p>The following SQL statement selects all customers from the country "Germany" 
AND the city "Berlin", in the "Customers" table:</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_where_and" class="tryitbtn">
...
<p>The following SQL statement selects all customers from the city "Berlin" OR 
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_where_or" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>Combining AND &amp; OR</h2>
<p>You can also combine AND and OR (use parenthesis to form complex 
expressions).</p>
<p>The following SQL statement selects all customers from the country "Germany" 
AND the city must be equal to "Berlin" OR "München", in the "Customers" table:</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_where_and_or" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_and_or.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_and_or.asp#top" target="_top">TOP</a> |
		<a href="sql_and_or.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
