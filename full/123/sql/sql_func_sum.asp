...
<style>a.menu_sql_func_sum{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">SUM()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_min.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_groupby.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
SELECT SUM(column_name) FROM table_name;</div></div>
<br>
<hr>

<h2>Demo Database</h2>
<p>In this tutorial we will use the well-known Northwind sample database.</p>
<p>Below is a selection from the &quot;OrderDetails&quot; table:</p>
...
<p>The following SQL statement finds the sum of all the &quot;Quantity&quot; 
fields for the &quot;OrderDetails&quot; table:</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_func_sum" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_sum.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_sum.asp#top" target="_top">TOP</a> |
		<a href="sql_func_sum.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
