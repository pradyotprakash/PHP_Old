...
<style>a.menu_sql_create_index{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_drop.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
ON table_name (column_name)</div></div>
...
ON table_name (column_name)</div></div>
<p><b>Note:</b> The syntax for creating indexes varies amongst different databases. Therefore: Check the syntax for creating indexes in your database.</p>
<hr>
...
<div class="code notranslate"><div>
CREATE INDEX PIndex<br>
ON Persons (LastName, FirstName)</div></div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_drop.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_create_index.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_create_index.asp#top" target="_top">TOP</a> |
		<a href="sql_create_index.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
