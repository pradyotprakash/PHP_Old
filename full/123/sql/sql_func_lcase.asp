...
<title>SQL LCASE() Function</title>
<style>a.menu_sql_func_lcase{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">LCASE()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_ucase.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_mid.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<div class="code notranslate"><div>
	SELECT LCASE(column_name) FROM table_name;</div></div>

<h3>Syntax for SQL Server</h3>
<div class="code notranslate"><div>
	SELECT LOWER(column_name) FROM table_name;</div></div>
<br>
<hr>
<h2>Demo Database</h2>
...
from the "Customers" table, and converts the "CustomerName" column to lowercase:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT LCASE(CustomerName) AS Customer, City<br>FROM Customers; </div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_lcase&amp;ss=-1" class="tryitbtn">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_lcase.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_lcase.asp#top" target="_top">TOP</a> |
		<a href="sql_func_lcase.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
