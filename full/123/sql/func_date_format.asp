...
<style>a.menu_func_date_format{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>MySQL <span class="color_h1">DATE_FORMAT()</span> Function</h1>
<hr>
<a href="sql_dates.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="SQL Dates" /> MySQL Date Functions</a>
<hr>

<h2>Definition and Usage</h2>
<p>The DATE_FORMAT() function is used to display date/time data in different formats.</p>

<h3><b>Syntax</b></h3>
<div class="code notranslate"><div>
DATE_FORMAT(date,format)</div></div>
<p>Where date is a valid date and format specifies the output format for the date/time.</p>

<p>The formats that can be used are:</p>
...
<tr><td>%c</td><td>Month, numeric</td></tr>
<tr><td>%D</td><td>Day of month with English suffix</td></tr>
<tr><td>%d</td><td>Day of month, numeric (00-31)</td></tr>
<tr><td>%e</td><td>Day of month, numeric (0-31)</td></tr>
<tr><td>%f</td><td>Microseconds</td></tr>
...
<tr><td>%M</td><td>Month name</td></tr>
<tr><td>%m</td><td>Month, numeric (00-12)</td></tr>
<tr><td>%p</td><td>AM or PM</td></tr>
<tr><td>%r</td><td>Time, 12-hour (hh:mm:ss AM or PM)</td></tr>
<tr><td>%S</td><td>Seconds (00-59)</td></tr>
<tr><td>%s</td><td>Seconds (00-59)</td></tr>
<tr><td>%T</td><td>Time, 24-hour (hh:mm:ss)</td></tr>
<tr><td>%U</td><td>Week (00-53) where Sunday is the first day of week</td></tr>
<tr><td>%u</td><td>Week (00-53) where Monday is the first day of week</td></tr>
<tr><td>%V</td><td>Week (01-53) where Sunday is the first day of week, used with %X</td></tr>
<tr><td>%v</td><td>Week (01-53) where Monday is the first day of week, used with %x</td></tr>
<tr><td>%W</td><td>Weekday name</td></tr>
<tr><td>%w</td><td>Day of the week (0=Sunday, 6=Saturday)</td></tr>
<tr><td>%X</td><td>Year of the week where Sunday is the first day of week, four digits, used with %V</td></tr>
<tr><td>%x</td><td>Year of the week where Monday is the first day of week, four digits, used with %v</td></tr>
...
<h3>Example</h3>
<p>The following script uses the DATE_FORMAT() function to display different formats. We will use the NOW() function to get the current date/time:</p>

<div class="code notranslate"><div>
DATE_FORMAT(NOW(),'%b %d %Y %h:%i %p')<br>
DATE_FORMAT(NOW(),'%m-%d-%Y')<br>
DATE_FORMAT(NOW(),'%d %b %y')<br>
DATE_FORMAT(NOW(),'%d %b %Y %T:%f')
</div></div>

<p>The result would look something like this:</p>
<div class="code notranslate"><div>
Nov 04 2008 11:45 PM<br>
	11-04-2008<br>
	04 Nov 08<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_format.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_format.asp#top" target="_top">TOP</a> |
		<a href="func_date_format.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
