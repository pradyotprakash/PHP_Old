...
<title>SQL AUTO INCREMENT a Field</title>
<style>a.menu_sql_autoincrement{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_alter.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_view.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Auto-increment allows a unique number to be generated when a new record is inserted into a table.</p>
<hr>
...
<div class="code notranslate"><div>
ALTER TABLE Persons AUTO_INCREMENT=100</div></div>

<p>To insert a new record into the &quot;Persons&quot; table, we will NOT have to specify a value for the &quot;ID&quot;
column (a unique value will be added automatically):</p>

<div class="code notranslate"><div>
INSERT INTO Persons (FirstName,LastName)<br>
VALUES ('Lars','Monsen')</div></div>

<p>The SQL statement above would insert a new record into the &quot;Persons&quot; table. The 
&quot;ID&quot; column would be assigned a unique value. The &quot;FirstName&quot; column would be set to 
...
<p><strong>Tip:</strong> To specify that the &quot;ID&quot; column should start at value 10 and increment by 5, change 
it to IDENTITY(10,5).</p>
...
<p>To insert a new record into the &quot;Persons&quot; table, we will NOT have to specify a value for the &quot;ID&quot; column (a unique value will be added 
automatically):</p>
...
<div class="code notranslate"><div>
INSERT INTO Persons (ID,FirstName,LastName)<br>
VALUES (seq_person.nextval,'Lars','Monsen')</div></div>

<p>The SQL statement above would insert a new record into the &quot;Persons&quot; table. The &quot;ID&quot; column would be assigned the next number from the seq_person 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_autoincrement.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_autoincrement.asp#top" target="_top">TOP</a> |
		<a href="sql_autoincrement.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
