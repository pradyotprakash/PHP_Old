...
<title>SQL CREATE VIEW, CREATE OR REPLACE VIEW, DROP VIEW Statements</title>
<style>a.menu_sql_view{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_autoincrement.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_dates.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A view is a virtual table.</p>
<p class="intro">This chapter shows how to create, update, and delete a view. </p>
<hr>
...
<p><b>Note:</b> A view always shows up-to-date data! The database engine recreates the data, using the view's SQL statement, every time a user queries a view.</p>
<hr>
...
<p>The view &quot;Current Product List&quot; lists all active products (products that are not 
discontinued) from the &quot;Products&quot; table. The view is created with the following SQL:</p>
...
<p>Another view in the Northwind sample database selects every product in the &quot;Products&quot; table 
with a unit price higher than the average unit price:</p>
...
<p>Another view in the Northwind database calculates 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_view.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_view.asp#top" target="_top">TOP</a> |
		<a href="sql_view.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
