...
<style>a.menu_sql_insert_into_select{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_select_into.asp">&laquo; Previous</a></div>
...
<p class="intro">The INSERT INTO SELECT statement copies data from one table and 
inserts it into an existing table.</p>
<hr>

<h2>The SQL INSERT INTO SELECT Statement</h2>
<p>The INSERT INTO SELECT statement selects data from one table and inserts it 
into an existing table. Any existing rows in the target table are unaffected.</p>

<h3>SQL INSERT INTO SELECT Syntax</h3>
<p>We can copy all columns from one table to another, existing table:</p>

<div class="code notranslate"><div>
	INSERT INTO <em>table2</em><br>
	SELECT * FROM <em>table1;</em>
</div></div>

<p>Or we can copy only the columns we want to into another, existing table:</p>

<div class="code notranslate"><div>
	INSERT INTO <em>table2</em><br>
<em>(column_name(s))</em><br>
...
<p>Copy only a few columns from "Suppliers" into "Customers":</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	INSERT INTO Customers (CustomerName, Country)<br>
	SELECT SupplierName, Country FROM Suppliers;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_insert_into_select" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>

<p>Copy only the German suppliers into "Customers":</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	INSERT INTO Customers (CustomerName, Country)<br>
	SELECT SupplierName, Country FROM Suppliers<br>WHERE Country='Germany';
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_insert_into_select_where" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_insert_into_select.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_insert_into_select.asp#top" target="_top">TOP</a> |
		<a href="sql_insert_into_select.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
