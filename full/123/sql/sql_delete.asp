...
<style>a.menu_sql_delete{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">DELETE</span> Statement</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_update.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_injection.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The DELETE statement is used to delete records in a table.</p>
<hr>
...
<div class="code notranslate"><div>
	DELETE FROM <em>table_name</em><br>
	WHERE <em>some_column</em>=<em>some_value</em>;</div></div>

<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><strong>Notice the WHERE clause in the SQL DELETE statement!</strong><br>
The WHERE clause specifies which record or records that should be deleted. If 
you omit the WHERE clause, all records will be deleted!</td>
</tr></table>
<br>
<hr>
...
<p>Assume we wish to delete the customer "Alfreds Futterkiste" from the 
"Customers" table.</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_delete" class="tryitbtn">
...
<p>It is possible to delete all rows in a table without deleting the table. This 
means that the table structure, attributes, and indexes will be intact:</p>

<div class="code notranslate"><div>
	DELETE FROM <em>table_name</em>;<br><br>
	or<br><br>
	DELETE * FROM <em>table_name</em>;</div></div>
<p><b>Note:</b> Be very careful when deleting records. You cannot undo this 
statement!</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_delete.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_delete.asp#top" target="_top">TOP</a> |
		<a href="sql_delete.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
