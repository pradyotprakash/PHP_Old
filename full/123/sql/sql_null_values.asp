...
<style>a.menu_sql_null_values{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_dates.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_isnull.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">NULL values represent missing unknown data.</p>
<p class="intro">By default, a table column can hold NULL values.</p>
<p class="intro">This chapter will explain the IS NULL and IS NOT NULL operators.</p>
<hr>

<h2>SQL NULL Values</h2>
<p>If a column in a table is optional, we can insert a new record or update an existing record without adding a value to this column. This 
means that the field will be saved with a NULL value.</p>
...
<td><b>Note:</b> It is not possible to compare NULL and 0; they are not equivalent.</td>
</tr></table>
<br>
...
<p>Suppose that the &quot;Address&quot; column in the &quot;Persons&quot; table is optional. This means that if we insert a record with no value for the
&quot;Address&quot; column, the &quot;Address&quot; column will be saved with a NULL value.</p>
...
SELECT LastName,FirstName,Address FROM Persons<br>
WHERE Address IS NULL</div></div>
...
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Tip:</b> Always use IS NULL to look for NULL values.</td>
</tr></table>
<br>
<hr>
...
<div class="code notranslate"><div>
SELECT LastName,FirstName,Address FROM Persons<br>
WHERE Address IS NOT NULL</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_null_values.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_null_values.asp#top" target="_top">TOP</a> |
		<a href="sql_null_values.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
