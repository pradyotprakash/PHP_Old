...
<title>SQL LAST() Function</title>
<style>a.menu_sql_func_last{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">LAST()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_first.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_max.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<div class="code notranslate"><div>
	SELECT LAST(column_name) FROM table_name;</div></div>
<p><b>Note:</b> The LAST() function is only supported in MS Access.</p>
<hr>

<h2>SQL LAST() Workaround in SQL Server, MySQL and Oracle</h2>

<h3>SQL Server Syntax</h3>
<div class="code notranslate"><div>
	SELECT TOP 1 <em>column_name</em>
	FROM <em>table_name<br></em>ORDER BY<em> column_name </em>DESC;</div></div>
<h3>Example</h3>
<div class="code notranslate"><div>
	SELECT TOP 1 CustomerName FROM Customers<br>ORDER BY CustomerID DESC;</div></div>

<h3>MySQL Syntax</h3>
<div class="code notranslate"><div>
	SELECT <em>column_name</em> FROM <em>table_name</em><br>
	ORDER BY <em>column_name</em> DESC<br>LIMIT 1;</div></div>
<h3>Example</h3>
<div class="code notranslate"><div>
	SELECT CustomerName FROM Customers<br>ORDER BY CustomerID DESC<br>LIMIT 1;</div></div>

<h3>Oracle Syntax</h3>
<div class="code notranslate"><div>
	SELECT <em>column_name </em>FROM <em>table_name</em><br>ORDER BY <em>
	column_name </em>DESC<br>WHERE ROWNUM &lt;=1;</div></div>
<h3>Example</h3>
<div class="code notranslate"><div>
	SELECT CustomerName FROM Customers<br>ORDER BY CustomerID DESC<br>WHERE 
	ROWNUM &lt;=1;</div></div>
<br>
<hr>
<h2>Demo Database</h2>
...
<p>The following SQL statement selects the last value of the "CustomerName" 
...
<br><a target="_blank" href="trysql.asp?filename=trysql_func_last&amp;ss=-1" class="tryitbtn">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_last.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_last.asp#top" target="_top">TOP</a> |
		<a href="sql_func_last.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
