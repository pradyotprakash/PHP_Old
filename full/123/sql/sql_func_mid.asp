...
<title>SQL MID() Function</title>
<style>a.menu_sql_func_mid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">MID()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_lcase.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_len.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<div class="code notranslate"><div>
	...
	AS <em>some_name</em> FROM table_name;</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>column_name</td>
    <td>Required. The field to extract characters from</td>
  </tr>
  <tr>
    <td>start</td>
    <td>Required. Specifies the starting position (starts at 1)</td>
  </tr>
  <tr>
    <td>length</td>
    <td>Optional. The number of characters to return. If omitted, the MID() 
	function returns the rest of the text</td>
  </tr>
  </table>
<p><strong>Note:</strong> The equivalent function for SQL Server is SUBSTRING():</p>
<div class="code notranslate"><div>
...
<p>The following SQL statement selects the first four characters from the "City" 
column from the "Customers" table:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT MID(City,1,4) AS ShortCity<br>FROM Customers;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_mid&amp;ss=-1" class="tryitbtn">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_mid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_mid.asp#top" target="_top">TOP</a> |
		<a href="sql_func_mid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
