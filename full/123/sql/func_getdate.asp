...
<title>SQL Server GETDATE() Function</title>
<style>a.menu_func_getdate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL Server <span class="color_h1">GETDATE()</span> Function</h1>
<hr>
...
<div class="code notranslate"><div>
SELECT GETDATE() AS CurrentDateTime</div></div>

<p>will result in something like this:</p>
<table class="reference notranslate" style="width:50%">
<tr><th>CurrentDateTime</th></tr>
<tr><td>2008-11-11 12:45:34.243</td></tr></table>
<p><b>Note:</b> The time part above goes all the way to milliseconds.</p>
...
<p>Notice that the OrderDate column specifies GETDATE() as the default value. As 
a result, when you insert a row into the table, the current date and time are 
automatically inserted into the column.</p>

<p>Now we want to insert a record into the &quot;Orders&quot; table:</p>
<div class="code notranslate"><div>
INSERT INTO Orders (ProductName) VALUES ('Jarlsberg Cheese')</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_getdate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_getdate.asp#top" target="_top">TOP</a> |
		<a href="func_getdate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
