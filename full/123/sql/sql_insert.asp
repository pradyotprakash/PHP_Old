...
<style>a.menu_sql_insert{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_orderby.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_update.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The INSERT INTO statement is used to insert new records in a table.</p>
<hr>
...
<p>The first form does not specify the column names where the data will be inserted, only their values:</p>
<div class="code notranslate"><div>
INSERT INTO <em>table_name</em><br>
VALUES (<em>value1</em>,<em>value2</em>,<em>value3</em>,...);</div></div>
...
<p>Assume we wish to insert a new row in the &quot;Customers&quot; table.</p>
<p>We can use the following SQL statement:</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_insert_colname" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<td><strong>Did you notice that we did not insert any number into the CustomerID 
field?</strong><br>The CustomerID column is 
automatically updated with a unique number for each record in the table.</td>
</tr></table>
<br>
<hr>
...
<p>The following SQL statement will insert a new row, but only insert data in the &quot;CustomerName&quot;, 
&quot;City&quot;, and &quot;Country&quot; columns (and the CustomerID field will 
of course also be updated automatically):</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_insert_cols" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_insert.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_insert.asp#top" target="_top">TOP</a> |
		<a href="sql_insert.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
