...
<style>a.menu_sql_groupby{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_sum.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_having.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Aggregate functions often need an added GROUP BY statement.</p>
<hr>
...
<p>Now we want to find the number of orders sent by each shipper.</p>
...
<div class="example_code notranslate">
	...
	Orders<br>LEFT JOIN Shippers<br>ON Orders.ShipperID=Shippers.ShipperID<br>
	GROUP BY ShipperName;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_groupby" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT Shippers.ShipperName, Employees.LastName,<br> COUNT(Orders.OrderID) AS 
	NumberOfOrders<br> FROM ((Orders<br>INNER JOIN Shippers<br>ON 
	Orders.ShipperID=Shippers.ShipperID)<br>INNER JOIN Employees<br>ON 
	Orders.EmployeeID=Employees.EmployeeID)<br>GROUP BY ShipperName,LastName;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_groupby_2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_sum.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_groupby.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_groupby.asp#top" target="_top">TOP</a> |
		<a href="sql_groupby.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
