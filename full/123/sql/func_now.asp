...
OrderDate datetime NOT NULL DEFAULT NOW(),<br>
PRIMARY KEY (OrderId)<br>
)</div></div>
<p>Notice that the OrderDate column specifies NOW() as the default value. As 
