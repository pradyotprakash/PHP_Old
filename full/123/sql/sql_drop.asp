...
<title>SQL DROP INDEX, DROP TABLE, DROP DATABASE</title>
<style>a.menu_sql_drop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">DROP INDEX, DROP TABLE,</span> and <span class="color_h1">DROP DATABASE</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_create_index.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_alter.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Indexes, tables, and databases can easily be deleted/removed with the DROP statement.</p>
<hr>
...
DROP INDEX index_name ON table_name</div></div>

<h3>DROP INDEX Syntax for MS SQL Server:</h3>
<div class="code notranslate"><div>
DROP INDEX table_name.index_name</div></div>

<h3>DROP INDEX Syntax for DB2/Oracle:</h3>
<div class="code notranslate"><div>
DROP INDEX index_name</div></div>

<h3>DROP INDEX Syntax for MySQL:</h3>
<div class="code notranslate"><div>
ALTER TABLE table_name DROP INDEX index_name</div></div>
<br>
<hr>
...
<div class="code notranslate"><div>
DROP DATABASE database_name</div></div>
<br>
<hr>
...
<div class="code notranslate"><div>
TRUNCATE TABLE table_name</div></div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_create_index.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_alter.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_drop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_drop.asp#top" target="_top">TOP</a> |
		<a href="sql_drop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
