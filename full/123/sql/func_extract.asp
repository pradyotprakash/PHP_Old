...
<title>MySQL EXTRACT() Function</title>
<style>a.menu_func_extract{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>MySQL <span class="color_h1">EXTRACT()</span> Function</h1>
<hr>
<a href="sql_dates.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="SQL Dates" /> MySQL Date Functions</a>
<hr>

<h2>Definition and Usage</h2>
<p>The EXTRACT() function is used to return a single part of a date/time, such as year, month, day, hour, minute, etc.</p>

<h3><b>Syntax</b></h3>
<div class="code notranslate"><div>
EXTRACT(unit FROM date)</div></div>

<p>Where date is a valid date expression and unit can be one of the following:</p>
<table class="reference notranslate" style="width:50%">
<tr><th>Unit Value</th></tr>
...
<div class="code notranslate"><div>
SELECT EXTRACT(YEAR FROM OrderDate) AS OrderYear,<br>
EXTRACT(MONTH FROM OrderDate) AS OrderMonth,<br>
EXTRACT(DAY FROM OrderDate) AS OrderDay,<br>
FROM Orders<br>
WHERE OrderId=1
</div></div>
...
<table class="reference notranslate" style="width:50%">
<tr><th>OrderYear</th><th>OrderMonth</th><th>OrderDay</th></tr>
<tr><td>2008</td><td>11</td><td>11</td></tr></table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_extract.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_extract.asp#top" target="_top">TOP</a> |
		<a href="func_extract.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
