...
<style>a.menu_sql_foreignkey{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_primarykey.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_check.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<table class="reference notranslate" style="width:50%">
  <tr>
    <th style="width:15%">O_Id</th>
    <th style="width:20%">OrderNo</th>
    <th>P_Id</th>
  </tr>
  <tr>
    <td>1</td>
...
<p>The FOREIGN KEY constraint also prevents invalid data from being inserted into the foreign key column,
because it has to be one of the values contained in the table it points to.</p>
<hr>
...
REFERENCES Persons(P_Id)</div></div>
...
<div class="code notranslate"><div>
ALTER TABLE Orders<br>
DROP FOREIGN KEY fk_PerOrders</div></div>

<p><b>SQL Server / Oracle / MS Access:</b></p>
<div class="code notranslate"><div>
ALTER TABLE Orders<br>
DROP CONSTRAINT fk_PerOrders</div></div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_primarykey.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_check.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_foreignkey.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_foreignkey.asp#top" target="_top">TOP</a> |
		<a href="sql_foreignkey.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
