...
<style>a.menu_sql_join{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_alias.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_join_inner.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">SQL joins are used to combine rows from two or more tables.</p>
<hr>

<h2>SQL JOIN</h2>
<p>An SQL JOIN clause is used to combine rows from two or more tables, based on 
a common field between them.</p>
<p>The most common type of join is: <strong>SQL INNER JOIN (simple join)</strong>. 
...
<p>Then, have a look at a selection from the "Customers" table:</p>
<table class="reference notranslate">
  <tr>
...
customer in the "Customers" table. The relationship between the two tables above 
is the "CustomerID" column.</p>
<p>Then, if we run the following SQL statement (that contains an INNER JOIN):</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT Orders.OrderID, Customers.CustomerName, Orders.OrderDate<br>FROM 
	Orders<br>INNER JOIN Customers<br>ON Orders.CustomerID=Customers.CustomerID;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_join" class="tryitbtn">
...
<p>Before we continue with examples, we will list the types the different SQL 
JOINs you can use:</p>
<ul>
	<li><b>INNER JOIN</b>: Returns all rows when there is at least one match in 
	BOTH tables</li>
	<li><b>LEFT JOIN</b>: Return all rows from the left table, and the matched 
	rows from the right table</li>
	<li><b>RIGHT JOIN</b>: Return all rows from the right table, and the matched 
	rows from the left table</li>
	<li><b>FULL JOIN</b>: Return all rows when there is a match in ONE of the 
	tables</li>
</ul>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_join.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_join.asp#top" target="_top">TOP</a> |
		<a href="sql_join.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
