...
<style>a.menu_sql_functions{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">Functions</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_datatypes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_avg.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">SQL has many built-in functions for performing calculations on data.</p>
<hr>
...
<ul>
	...
	<li>ROUND() - Rounds a numeric field to the number of 
      decimals specified</li>
	<li>NOW() - Returns the current system date and time</li>
	<li>FORMAT() - Formats how a field is to be displayed</li>
</ul>
<p><b>Tip:</b> The aggregate functions and the scalar functions will be explained in details in the next chapters.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_datatypes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_avg.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_functions.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_functions.asp#top" target="_top">TOP</a> |
		<a href="sql_functions.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
