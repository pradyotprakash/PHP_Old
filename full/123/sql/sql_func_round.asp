...
<title>SQL ROUND() Function</title>
<style>a.menu_sql_func_round{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">ROUND()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_len.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_now.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
SELECT ROUND(column_name,decimals) FROM table_name;</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>column_name</td>
    <td>   Required. The field to round.</td>
  </tr>
  <tr>
    <td>decimals</td>
    <td>   Required. Specifies the number of decimals to be 
	returned.</td>
  </tr>
  </table>
<br>
...
<p>The following SQL statement selects the product name and the price rounded to 
the nearest integer from the &quot;Products&quot; table:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT ProductName, ROUND(Price,0) AS RoundedPrice<br>FROM Products; </div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_round" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_func_len.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_round.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_round.asp#top" target="_top">TOP</a> |
		<a href="sql_func_round.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
