...
<style>a.menu_sql_injection{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_delete.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_top.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An SQL Injection can destroy your database.</p>
<hr>
...
<div class="example">
<h2 class="example">Server Code</h2>
...
<p>Injected SQL commands can alter SQL statement and compromises the security of a web application.</p>
<hr>
...
<div class="example">
<h2 class="example">Server Result</h2>
<div class="example_code notranslate">
...
<p>The SQL above will return all rows in the Customers table, and then delete the table called Suppliers.</p>
...
<h2>Parameters for Protection</h2>
<p>Some web developers use a &quot;blacklist&quot; of words or characters to search for in SQL input, to 
prevent SQL injection attacks.</p>
<p>This is not a very good idea. Many of these words (like delete or drop) and characters 
(like semicolons and quotation marks), are used in common language, and should be 
allowed in many types of input.</p>
...
<div class="example">
<h2 class="example">ASP.NET Razor Example</h2>
<div class="example_code notranslate">
txtUserId = getRequestString(&quot;UserId&quot;);<br>txtSQL = &quot;SELECT *
...
<div class="example">
<h2 class="example">Another Example</h2>
<div class="example_code notranslate">
	...
	Values(@0,@1,@2)&quot;;<br>db.Execute(txtSQL,txtNam,txtAdd,txtCit);</div>
</div>
<br>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
<p>You have just learned to avoid SQL injection. One of the top website vulnerabilities.</p>
</td>
</tr></table>
<br>
<hr>
...
<p>ASP.NET INSERT INTO</p>
<div class="example">
<div class="example_code notranslate">
	txtNam = getRequestString(&quot;CustomerName&quot;);<br>txtAdd = getRequestString(&quot;Address&quot;);<br>txtCit = getRequestString(&quot;City&quot;);<br>
	txtSQL = &quot;INSERT INTO Customers (CustomerName,Address,City) 
	Values(@0,@1,@2)&quot;;<br>command = new SqlCommand(txtSQL);<br>
...
<div class="example_code notranslate">
	...
	$stmt-&gt;bindParam(':val', $txtAdd);<br>$stmt-&gt;bindParam(':cit', $txtCit);<br>
	$stmt-&gt;execute();</div>
</div>
<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_injection.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_injection.asp#top" target="_top">TOP</a> |
		<a href="sql_injection.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
