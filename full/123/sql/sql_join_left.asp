...
<title>SQL LEFT JOIN Keyword</title>
<style>a.menu_sql_join_left{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_join_inner.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_join_right.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>SQL LEFT JOIN Keyword</h2>
<p>The LEFT JOIN keyword returns all rows from the left table (table1), with the 
...
<div class="code notranslate"><div>
	SELECT <em>column_name(s)</em><br>
	FROM <em>table1</em><br>
	LEFT OUTER JOIN <em>table2</em><br>
	ON <em>table1.column_name</em>=<em>table2.column_name</em>;</div></div>
<p><b>PS!</b> In some databases LEFT JOIN is called LEFT OUTER JOIN.</p>
<p style="text-align:center;"><img alt="SQL LEFT JOIN" height="145" src="img_leftjoin.gif" width="200"></p>
<hr>
...
<p>The following SQL statement will return all customers, and any orders they 
might have:</p>
<div class="example">
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_join_left" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<p><strong>Note:</strong> The LEFT JOIN keyword returns all the rows from the 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_join_left.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_join_left.asp#top" target="_top">TOP</a> |
		<a href="sql_join_left.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
