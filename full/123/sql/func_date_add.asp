...
<style>a.menu_func_date_add{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>MySQL <span class="color_h1">DATE_ADD()</span> Function</h1>
<hr>
<a href="sql_dates.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="SQL Dates" /> MySQL Date Functions</a>
<hr>

<h2>Definition and Usage</h2>
<p>The DATE_ADD() function adds a specified time interval to a date.</p>

<h3><b>Syntax</b></h3>
<div class="code notranslate"><div>
DATE_ADD(date,INTERVAL expr type)</div></div>
<p>Where date is a valid date expression and expr is the number of interval you want to add.</p>
...
<div class="code notranslate"><div>
SELECT OrderId,DATE_ADD(OrderDate,INTERVAL 45 DAY) AS OrderPayDate<br>
FROM Orders</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_add.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_add.asp#top" target="_top">TOP</a> |
		<a href="func_date_add.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
