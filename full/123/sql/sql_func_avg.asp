...
<title>SQL AVG() Function</title>
<style>a.menu_sql_func_avg{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">AVG()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_functions.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_func_count.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
SELECT AVG(column_name) FROM table_name</div></div>
<br>
<hr>
...
<p>The following SQL statement gets the average value of the &quot;Price&quot; column from the &quot;Products&quot; table:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
SELECT AVG(Price) AS PriceAverage FROM Products;
</div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_avg" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>The following SQL statement selects the &quot;ProductName&quot; and &quot;Price&quot; records that have an above average price:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
SELECT ProductName, Price FROM Products<br>WHERE Price&gt;(SELECT AVG(Price) FROM 
	Products); </div>
<br><a target="_blank" href="trysql.asp?filename=trysql_func_avg_high" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_functions.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_func_avg.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_func_avg.asp#top" target="_top">TOP</a> |
		<a href="sql_func_avg.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
