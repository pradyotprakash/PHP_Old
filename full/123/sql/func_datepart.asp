...
<title>SQL Server DATEPART() Function</title>
...
<h1>SQL Server <span class="color_h1">DATEPART()</span> Function</h1>
<hr>
...
DATEPART(datepart,date)</div></div>
...
<div class="code notranslate"><div>
SELECT DATEPART(yyyy,OrderDate) AS OrderYear,<br>
