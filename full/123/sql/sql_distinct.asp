...
<style>a.menu_sql_distinct{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">SELECT DISTINCT</span> Statement</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_select.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_where.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The SELECT DISTINCT statement is used to return only distinct 
(different) values.</p>
<hr>

<h2>The SQL SELECT DISTINCT Statement</h2>
<p>In a table, a column may contain many duplicate values; and sometimes you 
only want to list the different (distinct) values.</p>
<p>The DISTINCT keyword can be used to return only distinct (different) values.</p>

<h3>SQL SELECT DISTINCT Syntax</h3>
<div class="code notranslate"><div>
	SELECT DISTINCT <em>column_name</em>,<em>column_name</em><br>
...
<p>The following SQL statement selects only the distinct values from the "City" 
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_distinct" class="tryitbtn">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_distinct.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_distinct.asp#top" target="_top">TOP</a> |
		<a href="sql_distinct.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
