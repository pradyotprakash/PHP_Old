...
<style>a.menu_sql_unique{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_notnull.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_primarykey.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
ADD CONSTRAINT uc_PersonID UNIQUE (P_Id,LastName)</div></div>
<br>
<hr>
...
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
DROP INDEX uc_PersonID</div></div>

<p><b>SQL Server / Oracle / MS Access:</b></p>
<div class="code notranslate"><div>
ALTER TABLE Persons<br>
DROP CONSTRAINT uc_PersonID</div></div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_notnull.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_primarykey.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_unique.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_unique.asp#top" target="_top">TOP</a> |
		<a href="sql_unique.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
