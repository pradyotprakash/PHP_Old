...
<style>a.menu_sql_select_into{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="sql_insert_into_select.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">With SQL, you can copy information from one table into another.</p>
<p class="intro">The SELECT INTO statement copies data from one table and 
inserts it into a new table.</p>
<hr>

<h2>The SQL SELECT INTO Statement</h2>
<p>The SELECT INTO statement selects data from one table and inserts it into a 
new table. </p>

<h3>SQL SELECT INTO Syntax</h3>
<p>We can copy all columns into the new table:</p>

<div class="code notranslate"><div>
SELECT *<br>
INTO <em>newtable</em> [IN <em>externaldb</em>]<br>
FROM <em>table1;</em></div></div>

<p>Or we can copy only the columns we want into the new table:</p>
...
<td><p><strong>Tip:</strong> The new table will be created with the column-names 
and types as defined in the SELECT statement. You can apply new names using the AS 
clause.</p>
</td>
</tr></table>
<br>
...
<p>Create a backup copy of Customers:</p>

<div class="code notranslate"><div>
SELECT *<br>
INTO CustomersBackup2013<br>
FROM Customers;</div></div>

<p>Use the IN clause to copy the table into another database:</p>

<div class="code notranslate"><div>
SELECT *<br>
INTO CustomersBackup2013 IN 'Backup.mdb'<br>
FROM Customers;</div></div>

<p>Copy only a few columns into the new table:</p>
...
INTO CustomersBackup2013<br>
FROM Customers;</div></div>
<p>Copy only the German customers into the new table:</p>

<div class="code notranslate"><div>
SELECT *<br>
INTO CustomersBackup2013<br>
FROM Customers<br>
WHERE Country='Germany';</div></div>
<p>Copy data from more than one table into the new table:</p>

<div class="code notranslate"><div>
	SELECT Customers.CustomerName, Orders.OrderID<br>
INTO CustomersOrderBackup2013<br>
FROM Customers<br>
	LEFT JOIN Orders<br>
	ON Customers.CustomerID=Orders.CustomerID;</div>
</div>

<p><strong>Tip:</strong> The SELECT INTO statement can also be used to create a 
new, empty table using the schema of another. Just add a WHERE clause that 
causes the query to return no data:</p>

<div class="code notranslate">
<div>
SELECT *<br>INTO <em>newtable</em><br>FROM <em>table1</em><br>WHERE 1=0;</div>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_select_into.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_select_into.asp#top" target="_top">TOP</a> |
		<a href="sql_select_into.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
