...
<title>MySQL CURDATE() Function</title>
<style>a.menu_func_curdate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="code notranslate"><div>
SELECT NOW(),CURDATE(),CURTIME()</div></div>

<p>will result in something like this:</p>
<table class="reference notranslate">
<tr>
<th style="width:34%">NOW()</th>
<th style="width:33%">CURDATE()</th>
<th>CURTIME()</th>
</tr>
<tr>
<td>2008-11-11 12:45:34</td>
<td>2008-11-11</td>
<td>12:45:34</td>
</tr>
</table>
...
OrderDate datetime NOT NULL DEFAULT CURDATE(),<br>
PRIMARY KEY (OrderId)<br>
)</div></div>

<p>Notice that the OrderDate column specifies CURDATE() as the default value. As 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_curdate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_curdate.asp#top" target="_top">TOP</a> |
		<a href="func_curdate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
