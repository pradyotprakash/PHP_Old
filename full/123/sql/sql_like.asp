...
<style>a.menu_sql_like{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">LIKE</span> Operator</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_top.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_wildcards.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The LIKE operator is used in a WHERE clause to search for a 
specified pattern in a column.</p>
<hr>
...
<div class="code notranslate"><div>
	...
	WHERE <em>column_name</em> LIKE <em>pattern</em>;</div></div>
<br>
<hr>
<h2>Demo Database</h2>
...
<h2>SQL LIKE Operator Examples</h2>
...
<div class="example_code notranslate">
	...
	WHERE City LIKE 's%'; </div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_like" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> The "%" sign is used to define wildcards (missing 
letters)&nbsp;both before and after the pattern. You will learn more about wildcards 
in the next chapter.</p>
<p>The following SQL statement selects all customers with a City ending with the 
letter "s":</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT * FROM Customers<br>
	WHERE City LIKE '%s'; </div>
<br><a target="_blank" href="trysql.asp?filename=trysql_select_like_ending" class="tryitbtn">
	Try it yourself &raquo;</a>

</div>

<p>The following SQL statement selects all customers with a Country containing 
the pattern "land":</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_like_pattern" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<p>Using the NOT keyword allows you to select records that does NOT match the 
pattern.</p>
<p>The following SQL statement selects all customers with a Country NOT 
containing the pattern "land":</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	SELECT * FROM Customers<br>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_select_like_not" class="tryitbtn">
	Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_like.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_like.asp#top" target="_top">TOP</a> |
		<a href="sql_like.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
