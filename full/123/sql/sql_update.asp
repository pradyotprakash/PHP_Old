...
<style>a.menu_sql_update{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_insert.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_delete.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The UPDATE statement is used to update records in a table.</p>
<hr>
...
<div class="code notranslate"><div>
	UPDATE <em>table_name</em><br>
	SET <em>column1</em>=<em>value1</em>,<em>column2</em>=<em>value2</em>,...<br>
...
<td><strong>Notice the WHERE clause in the SQL UPDATE statement!</strong><br>
The WHERE clause specifies which record or records that should be updated. If 
you omit the WHERE clause, all records will be updated!</td>
</tr></table>
<br>
<hr>
...
<p>Assume we wish to update the customer "Alfreds Futterkiste" with a new 
contact person and city.</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_update" class="tryitbtn">
...
<p>Be careful when updating records. If we had omitted the WHERE clause, in the 
...
<p>The "Customers" table would have looked like this:</p>
<table class="reference notranslate">
  <tr>
    <th>CustomerID</th>
    <th>CustomerName</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_update.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_update.asp#top" target="_top">TOP</a> |
		<a href="sql_update.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
