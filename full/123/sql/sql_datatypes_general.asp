...
<title>SQL General Data Types</title>
<style>a.menu_sql_datatypes_general{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">General Data Types</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_isnull.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_datatypes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A data type defines what kind of value a column can contain.</p>
<hr>

<h2>SQL General Data Types</h2>
<p>Each column in a database table is required to have a name and a data type.</p>
<p>SQL developers have to decide what types of data will be stored inside each 
and every table column when creating a SQL table. The data type is a label and a 
...
<p>The following table lists the general data types in SQL:</p>
<table class="reference notranslate">
    ...
    <tr>
      <td>INTERVAL</td>
      <td>Composed of a number of integer fields, representing a period of time, 
	  depending on the type of interval</td>
    </tr>
    <tr>
      <td>ARRAY</td>
...
<h2>SQL Data Type Quick Reference</h2>
<p>However, different databases offer different choices for the data 
type definition.</p>
<p>The following table shows some of the common names of data types between 
the various database platforms:</p>
<table class="reference notranslate">
    <tr>
      <th style="width:17%">Data type</th>
      <th style="width:17%">Access</th>
      <th style="width:21%">SQLServer</th>
      <th style="width:15%">Oracle</th>
      <th style="width:15%">MySQL</th>
      <th style="width:15%">PostgreSQL</th>
    </tr>
    <tr>
      <td><i>boolean</i></td>
      <td>Yes/No</td>
...
<td><p><strong>Note:</strong>&nbsp;Data types might have different names in different database.
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_datatypes_general.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_datatypes_general.asp#top" target="_top">TOP</a> |
		<a href="sql_datatypes_general.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
