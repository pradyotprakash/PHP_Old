...
<style>a.menu_sql_create_table{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_create_db.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_constraints.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>The SQL CREATE TABLE Statement</h2>
<p>The CREATE TABLE statement is used to create a table in a database.</p>
<p>Tables are organized into rows and columns; and each table must have a name.</p>

<h3>SQL CREATE TABLE Syntax</h3>
<div class="code notranslate"><div>
CREATE TABLE <em>table_name</em><br>
(<br>
	<em>column_name1 data_type</em>(<em>size</em>),<br>
	<em>column_name2 data_type</em>(<em>size</em>),<br>
	<em>column_name3 data_type</em>(<em>size</em>),<br>
....<br>
);</div></div>

<p>The column_name parameters specify the names of the columns of the table.</p>
<p>The data_type parameter specifies what type of data the column can hold (e.g. 
varchar, integer, decimal, date, etc.).</p>

<p>The size parameter specifies the maximum length of the column of the table.</p>
<p><strong>Tip:</strong> For an overview of the data types available in MS Access, MySQL, and SQL Server, 
go to our complete <a href="sql_datatypes.asp">Data Types Reference</a>.</p>
<hr>

<h2>SQL CREATE TABLE Example</h2>
<p>Now we want to create a table called &quot;Persons&quot; that contains five columns: 
PersonID, LastName, FirstName, Address, and City.</p>
...
<br><a target="_blank" href="trysql.asp?filename=trysql_create_table" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> The empty table can be filled with data with the INSERT INTO statement.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="sql_create_db.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="sql_constraints.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="sql_create_table.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="sql_create_table.asp#top" target="_top">TOP</a> |
		<a href="sql_create_table.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
