...
<style>a.menu_prop_nav_product{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Navigator <span class="color_h1">product</span> Property</h1>
...
<p>Return the browser's engine name:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nav_product">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The product property returns the engine (product) name of the browser.</p>
<p><strong>Note:</strong> This property may not work as expected. 
Both Gecko and WebKit browsers return &quot;Gecko&quot;.</p>
<hr>
...
<p>The product property is only supported in Firefox, Chrome and Safari.</p>
<p><strong>Note:</strong> The product property is not supported in Internet 
Explorer or Opera.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
navigator.product</div></div>
<h2>Return Value</h2>
...
<tr>
<td>String</td>
<td>Specifies the engine name of the browser</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_nav_product.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_nav_product.asp#top" target="_top">TOP</a> |
		<a href="prop_nav_product.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
