...
<title>HTML DOM Table createTFoot() Method</title>
<style>a.menu_met_table_createtfoot{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Table <span class="color_h1">createTFoot()</span> Method</h1>
...
<p>Create a &lt;tfoot&gt; element (and insert a &lt;tr&gt; and &lt;td&gt; element to it):</p>
<div class="example_code notranslate">
	// Find a &lt;table&gt; element with id=&quot;myTable&quot;:<br>var table = document.getElementById(&quot;myTable&quot;);<br>
	<br>// Create an empty &lt;tfoot&gt; element and add it to the table:<br>var footer = 
	table.createTFoot();<br>
	<br>// Create an empty &lt;tr&gt; element and add it to the first position of 
	&lt;tfoot&gt;:<br>var row = 
	footer.insertRow(0);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br><br>// Insert a new 
	cell (&lt;td&gt;) at the first position of the &quot;new&quot; &lt;tr&gt; element:<br>var cell = row.insertCell(0);<br>
	<br>// Add some bold text in the new cell:<br>cell.innerHTML = &quot;&lt;b&gt;This is a 
	table footer&lt;/b&gt;&quot;;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_createtfoot" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The createTFoot() method creates an empty &lt;tfoot&gt; element and adds it to the table.</p>
<p><b>Note:</b> If a &lt;tfoot&gt; element already exists on the table, the createTFoot() 
method returns the existing one, and does not create a new one.</p>
<p><strong>Note:</strong> The &lt;tfoot&gt; element must have one or more &lt;tr&gt; 
tags inside.</p>
<p><b>Tip: </b>To remove the &lt;tfoot&gt; element from a table, use the
<a href="met_table_deletetfoot.asp">deleteTFoot()</a> method.</p>
<hr>
...
<p>The createTFoot() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>tableObject</em>.createTFoot()
</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
...
<tr>
<td>The newly created (or an existing) &lt;tfoot&gt; element</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Create and delete a &lt;tfoot&gt; element:</p>
<div class="example_code notranslate">
	function myCreateFunction()<br>{<br>var table = document.getElementById(&quot;myTable&quot;);<br>&nbsp; {<br>&nbsp; var footer = 
	table.createTFoot();<br>&nbsp; 
	var row = footer.insertRow(0);<br>&nbsp; var cell = row.insertCell(0);<br>&nbsp; 
	cell.innerHTML = &quot;&lt;b&gt;This is a table footer&lt;/b&gt;&quot;;<br>&nbsp; }<br>}<br>
	function myDeleteFunction()<br>{<br>
	document.getElementById(&quot;myTable&quot;).deleteTFoot();<br>} </div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_create_deletetfoot">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_table_createtfoot.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_table_createtfoot.asp#top" target="_top">TOP</a> |
		<a href="met_table_createtfoot.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
