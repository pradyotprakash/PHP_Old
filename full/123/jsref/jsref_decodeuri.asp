...
<style>a.menu_jsref_decodeuri{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">decodeURI()</span> Function</h1>
...
<p>Decode a URI after encoding it:</p>
<div class="example_code notranslate">
	var uri = "my test.asp?name=ståle&amp;car=saab";<br>var enc = "Encoded URI: " + 
	encodeURI(uri);<br>var dec = "Decoded URI: " + decodeURI(uri);<br>var res = 
	enc + "&lt;br&gt;" + dec;</div>
<p>The result of <em>res</em> will be:</p>
<div class="example_code notranslate">
	Encoded URI: my%20test.asp?name=st%C3%A5le&amp;car=saab<br>Decoded URI: my 
	test.asp?name=ståle&amp;car=saab</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_decodeuri" class="tryitbtn">
	Try it yourself »</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The decodeURI() function is used to decode a URI.</p>

<p><b>Tip:</b> Use the <a href="jsref_encodeuri.asp">encodeURI()</a> function to 
encode a URI.</p>
<hr>
...
<p>The decodeURI() function is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	decodeURI(<em>uri</em>)</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_decodeuri.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_decodeuri.asp#top" target="_top">TOP</a> |
		<a href="jsref_decodeuri.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
