...
<title>HTML DOM Style cursor Property</title>
<style>a.menu_prop_style_cursor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">cursor</span> Property</h1>
...
document.getElementById(&quot;myP&quot;).style.cursor=&quot;pointer&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_cursor">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The cursor property sets or returns the type of cursor to display for the mouse pointer.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the cursor property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.cursor
</div></div>
<p>Set the cursor property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.cursor=<i>value</i></div></div>
<br>
<table class="reference notranslate">
  ...
  <tr>
    <td>inherit</td>
    <td>Specifies that the value of the cursor property should be inherited from the parent element</td>
	<td></td>
  </tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the displayed mouse cursor when the mouse pointer 
	is over an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS2</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Show all available cursors:</p>
<div class="example_code notranslate">
	var whichSelected = x.selectedIndex;<br>document.body.style.cursor=x.options[whichSelected].text;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_cursor2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the type of cursor:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myP&quot;).style.cursor);<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_cursor3">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/pr_class_cursor.asp">cursor property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_cursor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_cursor.asp#top" target="_top">TOP</a> |
		<a href="prop_style_cursor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
