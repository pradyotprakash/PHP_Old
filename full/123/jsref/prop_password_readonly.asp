...
<title>HTML DOM Password readOnly Property</title>
<style>a.menu_prop_password_readonly{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Password <span class="color_h1">readOnly</span> Property</h1>
...
<p>Find out if a password field is read-only or not:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myPsw&quot;).readOnly;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">true</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_password_readonly">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The readOnly property sets or returns whether a password field is read-only, or not.</p>
<p>A read-only field cannot be modified. However, a user can tab to it, highlight it, and copy the text from it.</p>
<p><b>Tip:</b> To prevent the user from interacting with the field, use the
<a href="prop_password_disabled.asp">disabled</a> property instead.</p>
<hr>
...
<div class="code notranslate"><div>
	<em>passwordObject</em>.readOnly
</div></div>
<p>Set the readOnly property:</p>
<div class="code notranslate"><div>
	<em>passwordObject</em>.readOnly=true|false
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>true|false&nbsp;</td>
		<td>
		Specifies whether a password field should be read-only or not.
		<ul>
			<li>true - The password field is read-only</li>
			<li>false - Default. The password field is changeable</li>
		</ul>
		</td>
	</tr>
</table>
...
<tr>
<td>Boolean</td>
<td>Returns true if the password field is read-only, otherwise it returns false</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set a password field to be read-only:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myPsw&quot;).readOnly=true;
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_password_readonly2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_password_readonly.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_password_readonly.asp#top" target="_top">TOP</a> |
		<a href="prop_password_readonly.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
