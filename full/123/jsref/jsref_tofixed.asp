...
<style>a.menu_jsref_tofixed{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">toFixed()</span> Method</h1>
...
<p>Convert a number into a string, keeping only two decimals:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tofixed" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The toFixed() method converts a number into a string, keeping a specified number of decimals.</p>
<p><strong>Note:</strong> if the desired number of decimals are higher than the 
actual number, nulls are added to create the desired decimal length.</p>
<hr>
...
<p>The toFixed() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>number</i>.toFixed(<em>x</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>x</em></td>
    <td>Optional. The number of digits after the decimal point. Default is 0 (no 
...
<tr>
<td>String</td>
<td>The number, with the exact number of decimals</td>
</tr>
</table>
...
<table class="tecspec">
<tr>
	<th style="width:20%">JavaScript Version:</th>
	<td>1.5</td>
</tr>
</table>
<br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Convert a number, without keeping any decimals:</p>
<div class="example_code notranslate">
var num = 5.56789;<br>
var n=num.toFixed();
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tofixed2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example</h2>
<p>Convert a number which has fewer decimal places than requested:</p>
<div class="example_code notranslate">
var num = 5.56789;<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tofixed3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_tofixed.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_tofixed.asp#top" target="_top">TOP</a> |
		<a href="jsref_tofixed.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
