...
<style>a.menu_jsref_setutcfullyear{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">setUTCFullYear()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcfullyear" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<hr>

<h2>Definition and Usage</h2>
<p>The setUTCFullYear() method sets the year (four digits) of a date object, according the UTC time. </p>
...
<p>The setUTCFullYear() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.setUTCFullYear(<em>year</em>,<em>month</em>,<em>day</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>month</em></td>
    <td>Optional. An integer representing the month
  ...
  <tr>
    <td><em>day</em></td>
    <td>Optional. An integer representing the day of month
...
<tr>
<td>Number</td>
<td>Milliseconds between the date object and midnight January 1 1970</td>
</tr>
</table>
...
<p>Set the date to November 3, 2020:</p>
<div class="example_code notranslate">
var d = new Date();<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcfullyear2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example</h2>
<p>Set the date to six months <em>ago</em>, UTC time:</p><div class="example_code notranslate">
var d=new Date();<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcfullyear3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_setutcfullyear.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_setutcfullyear.asp#top" target="_top">TOP</a> |
		<a href="jsref_setutcfullyear.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
