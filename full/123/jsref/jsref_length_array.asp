...
<style>a.menu_jsref_length_array{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Array <span class="color_h1">length</span> Property</h1>
...
<div class="example_code notranslate">
	4</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_length_array" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<hr>
<h2>Syntax</h2>
<p>Set the length of an array:</p>
<div class="code notranslate"><div>
<i>array</i>.length=<em>number</em></div></div>
<p>Return the length of an array:</p>
<div class="code notranslate"><div>
<i>array</i>.length</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A Number, representing the number of elements in the array object</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_length_array.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_length_array.asp#top" target="_top">TOP</a> |
		<a href="jsref_length_array.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
