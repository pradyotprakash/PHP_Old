...
<style>a.menu_met_element_removeattributenode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">removeAttributeNode()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Remove the style attribute node from a header element:</p>
<div class="example_code notranslate">
	var n=document.getElementsByTagName(&quot;INPUT&quot;)[0];<br>var a=n.getAttributeNode(&quot;type&quot;);<br>
	n.removeAttributeNode(a)</div>
	<p>Before removing the attribute:</p>
<div class="example_code notranslate">
<h1 style="color:red;margin:0px;">Hello World</h1>
</div>
	<p>After removing the attribute:</p>
<div class="example_code notranslate">
<h1 style="margin:0px;">Hello World</h1>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_element_removeattributenode" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<h2>Definition and Usage</h2>
<p>The removeAttributeNode() method removes the specified attribute, and returns the removed attribute, as an Attr Node object.</p>
<p>The difference between this method and the removeAttribute() method is that the 
removeAttribute() method removes the attribute with the specified <em>name</em>, 
while this method removes the specified Attr <em>object</em>. The result will be 
the same. Also, the removeAttribute() method has <em>no return value</em>, while this 
method returns the removed attribute, as an Attr object.</p>
<p>See also the <a href="met_element_removeattribute.asp">removeAttribute()</a> 
method</p>
<hr/>
...
<p>The removeAttributeNode() method is supported in all major browsers, except Internet Explorer.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>element</em>.removeAttributeNode(<em>attributenode</em>)</div></div>
<h2>Parameters</h2>
...
<tr>
<td><em>attributenode</em></td>
<td>Attr object</td>
<td>Required. The attribute node you want to remove</td>
</tr>
</table>
...
<tr>
<td>Attr object</td>
<td>The removed attribute node</td>
</tr>
</table>
...
<tr>
	...
	<td>Core Level 1 Element Object</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_removeattributenode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_removeattributenode.asp#top" target="_top">TOP</a> |
		<a href="met_element_removeattributenode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
