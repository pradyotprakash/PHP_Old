...
<title>bubbles Event Property</title>
<style>a.menu_event_bubbles{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">bubbles</span> Event Property</h1>
...
<p>The bubbles event property returns a Boolean value that indicates whether or not the event is a bubbling event.</p>
<p>Event bubbling directs an event to its intended target, it works like this:</p>
<ul>
	...
	<li>If no event handler is set for that object, the event bubbles up (like a 
	bubble in water) to the objects parent </li>
</ul>
<p>The event bubbles up from parent to parent until it is handled, or until it 
reaches the document object.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>event</em>.bubbles</div></div>
<br>
<hr  />
...
<p>The following example checks if the triggered event is a bubbling event:</p>
<div class="example_code notranslate">
&lt;html&gt;<br>
&lt;head&gt;<br>
<br>
&lt;script&gt;<br>
function myFunction(e)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;alert(e.bubbles);<br>
&nbsp;&nbsp;}<br>
&lt;/script&gt;<br>
...
&lt;body&gt;<br>
<br>
&lt;p onclick=&quot;myFunction(event)&quot;&gt;Click this paragraph.<br>
An alert box will tell if the<br>
event is a bubbling event.&lt;/p&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_event_bubbles" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_bubbles.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_bubbles.asp#top" target="_top">TOP</a> |
		<a href="event_bubbles.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
