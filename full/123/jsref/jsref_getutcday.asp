...
<style>a.menu_jsref_getutcday{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">getUTCDay()</span> Method</h1>
...
<p>Return the day of the week, according to universal time:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutcday" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<p>The getUTCDay() method returns the day of the week (from 0 to 6) for the specified date, according to universal time.</p>
<p><b>Note:</b> Sunday is 0, Monday is 1, and so on.</p>
...
<p>The getUTCDay() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.getUTCDay()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the name of the weekday (not just a number):</p>
<div class="example_code notranslate">
var d=new Date();<br>
var weekday=new Array();<br>
weekday[0]=&quot;Sunday&quot;;<br>
weekday[1]=&quot;Monday&quot;;<br>
...
document.write(weekday[d.getUTCDay()]); </script>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_date_weekday_utc" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_getutcday.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_getutcday.asp#top" target="_top">TOP</a> |
		<a href="jsref_getutcday.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
