...
<style>a.menu_jsref_getutcmonth{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">getUTCMonth()</span> Method</h1>
...
<p>Return the month, according to universal time:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutcmonth" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<p>The getMonth() method returns the month (from 0 to 11) for the 
...
<p>The getUTCMonth() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.getUTCMonth()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>Number</td>
<td>A Number, from 0-11, representing the month</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the name of the month (not just a number):</p>
<div class="example_code notranslate">
&lt;script&gt;<br>
<br>
var d=new Date()<br>
...
month[10]="November"
month[11]="December"
document.write(month[d.getUTCMonth()])
</script>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_date_getutcmonth" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_getutcmonth.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_getutcmonth.asp#top" target="_top">TOP</a> |
		<a href="jsref_getutcmonth.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
