...
<title>HTML DOM Style borderStyle Property</title>
<style>a.menu_prop_style_borderstyle{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">borderStyle</span> Property</h1>
...
<p>Add a &quot;solid&quot; border to a &lt;div&gt; element:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.borderStyle=&quot;solid&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderstyle">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The borderStyle property sets or returns the style of an element's border.</p>
<p>This property can take from one to four values:</p>
<ul>
	<li>One value, like: p {border-style: solid} - all four 
	borders will be solid</li>
	<li>Two values, like: p {border-style: solid dotted} -  
	top and bottom border will be solid, left and right border will be dotted</li>
	<li>Three values, like: p {border-style: solid dotted double}- top border will be 
	solid, left and right border will be dotted, bottom 
	border will be double</li>
	<li>Four values, like: p {border-style: solid dotted double dashed} - top border will be 
	solid, right border will be dotted, bottom 
	border will be double, left border will be dashed</li>
</ul>
<hr>
...
<p>The borderStyle property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the borderStyle property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderStyle
</div></div>
<p>Set the borderStyle property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderStyle=<i>value</i></div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>none</td>
		<td>Defines no border. This is default</td>
	</tr>
	<tr>
		<td>hidden</td>
	...
	<tr>
		<td>double</td>
		<td>Defines two borders. The width of the two borders are 
		the same as the border-width value</td>
	</tr>
	<tr>
		<td>groove</td>
		<td>Defines a 3D grooved border. The effect depends on the 
		border-color value</td>
	</tr>
	<tr>
		<td>ridge</td>
		<td>Defines a 3D ridged border. The effect depends on the 
		border-color value</td>
	</tr>
	<tr>
		<td>inset</td>
		<td>Defines a 3D inset border. The effect depends on the 
		border-color value</td>
	</tr>
	<tr>
		<td>outset</td>
		<td>Defines a 3D outset border. The effect depends on the 
		border-color value</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The style of the border is inherited from the 
		parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the style of an element's border</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the style of the four borders of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myDiv&quot;).style.borderStyle=&quot;dotted solid double 
	dashed&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderstyle2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the border style of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.borderStyle);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderstyle3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>A demonstration of all the different values:</p>
<div class="example_code notranslate">
	var listValue = selectTag.options[selectTag.selectedIndex].text;<br>
	document.getElementById(&quot;myDiv&quot;).style.borderStyle=listValue;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderstyle_all">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_border-style.asp">border-style property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_borderstyle.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_borderstyle.asp#top" target="_top">TOP</a> |
		<a href="prop_style_borderstyle.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
