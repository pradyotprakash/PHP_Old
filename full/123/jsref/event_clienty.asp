...
<title>clientY Event Attribute</title>
<style>a.menu_event_clienty{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">clientY</span> Event Attribute</h1>
...
<p>The clientY event attribute returns the vertical coordinate (according to the client area) of the mouse pointer when an event was triggered.</p>
<p>The client area is the current window.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
event.clientY</div></div>
<br>
<hr  />
...
<p>The following example alerts the coordinates of the mouse pointer when the mouse button 
was 
clicked:</p>
...
&lt;head&gt;<br>
&lt;script&gt;<br>
function show_coords(event)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;var x=event.clientX<br>
&nbsp;&nbsp;var y=event.clientY<br>
&nbsp;&nbsp;alert(&quot;X coords: &quot; + x + &quot;, Y coords: &quot; + y)<br>
&nbsp;&nbsp;}<br>
&lt;/script&gt;<br>
&lt;/head&gt;<br>
<br>
&lt;body&gt;<br>
<br>
&lt;p onmousedown=&quot;show_coords(event)&quot;&gt;Click this paragraph, and an alert box will alert
the x and y coordinates of the mouse pointer.&lt;/p&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_event_clientxy" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_clienty.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_clienty.asp#top" target="_top">TOP</a> |
		<a href="event_clienty.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
