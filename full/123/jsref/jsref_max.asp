...
<title>JavaScript max() Method</title>
<style>a.menu_jsref_max{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">max()</span> Method</h1>
...
<div class="example_code notranslate">
10</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_max" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The max() method returns the number with the highest value.</p>
<hr>
...
<p>The max() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.max(<em>n1</em>,<em>n2</em>,<em>n3</em>,...,nX)</div></div>
...
<tr>
<td>Number</td>
<td>The highest number of the arguments, or <em>-Infinity</em> if no arguments are given, or <em>NaN</em> if one or more arguments are not numbers</td>
</tr>
</table>
...
<p>Return the number with the highest value:</p>
<div class="example_code notranslate">
var a=Math.max(5,10);<br>
var b=Math.max(0,150,30,20,38);<br>
var c=Math.max(-5,10);<br>
var d=Math.max(-5,-10);<br>
...
-5<br>
2.5</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_max2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_max.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_max.asp#top" target="_top">TOP</a> |
		<a href="jsref_max.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
