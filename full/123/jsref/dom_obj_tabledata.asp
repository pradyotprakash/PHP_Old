...
<html lang="en-US">
<head>
<title>HTML DOM td Object</title>
<style>a.menu_dom_obj_tabledata{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">td</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_table.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_tablehead.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>td Object</h2>
<p>The td object represents a data cell in an HTML table.</p>
<p>For each &lt;td&gt; tag in an HTML table, a td object is created.</p>

<hr>

<h2>td Object Properties</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>abbr</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Sets or 
	returns the value of the abbr attribute</td>
  </tr>
  <tr>
    <td>align</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_textalign.asp">style.textAlign</a> instead.<br></span>Sets or returns the 
	horizontal alignment of the content in a data cell<br></td>
  </tr>
  <tr>
    <td>axis</td>
  ...
  <tr>
	...
	style.background</a> instead.<br></span>Sets or returns the 
  ...
  <tr>
	...
	style.backgroundColor</a> instead.<br></span>Sets or returns the 
  ...
  <tr>
    <td>height</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_height.asp">style.height</a> instead.<br></span>Sets or returns the height 
	of a data cell<br></td>
  </tr>
  <tr>
    <td>noWrap</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_whitespace.asp">
	style.whiteSpace</a> instead.<br></span>Sets or returns whether the 
	content in a cell can be wrapped<br></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>vAlign</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_verticalalign.asp">style.verticalAlign</a> 
	instead.<br></span>Sets or returns the vertical alignment of the content within a 
	cell<br></td>
  </tr>
  <tr>
    <td>width</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_width.asp">style.width</a> instead.<br></span>Sets or returns the width of 
	a data cell<br></td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The td object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_tabledata.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_tabledata.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_tabledata.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
