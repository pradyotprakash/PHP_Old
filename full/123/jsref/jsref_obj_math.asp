...
<style>a.menu_jsref_obj_math{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="jsref_obj_date.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jsref_obj_number.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Math Object</h2>
<p>The Math object allows you to perform mathematical tasks.</p>
<p>Math is not a constructor. All properties/methods of Math can be called by using Math as an object, without creating it.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>

var x = Math.PI; // Returns PI<br>
var y = Math.sqrt(16); // Returns the square root of 16</div></div>
<p>For a tutorial about the Math object, read our <a href="../js/js_obj_math.asp">JavaScript Math Object tutorial</a>.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns the arctangent of x as a numeric value between 
  ...
  <tr>
    ...
    <td>Returns x, rounded upwards to the 
	nearest integer</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Returns x, rounded downwards to the 
	nearest integer</td>
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_obj_math.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_obj_math.asp#top" target="_top">TOP</a> |
		<a href="jsref_obj_math.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
