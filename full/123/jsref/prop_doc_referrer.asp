...
<title>HTML DOM referrer Property</title>
<style>a.menu_prop_doc_referrer{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">referrer</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the referrer of the current document:</p>
<div class="example_code notranslate">
	document.referrer;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_doc_referrer" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The referrer property returns the URL of the document that loaded the current document.</p>
<hr>
...
<p>The referrer property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
document.referrer</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A string containing the URL of the document that loaded the 
	current document. If the current document was not opened through a link (for 
	example, through a bookmark), an empty string is returned.</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_doc_referrer.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_doc_referrer.asp#top" target="_top">TOP</a> |
		<a href="prop_doc_referrer.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
