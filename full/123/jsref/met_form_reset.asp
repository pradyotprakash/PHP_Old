...
<title>HTML DOM Form reset() Method</title>
<style>a.menu_met_form_reset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Form <span class="color_h1">reset()</span> Method</h1>
...
document.getElementById(&quot;myForm&quot;).reset();</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_form_reset" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The reset() method resets the values of all elements in a form (same as clicking 
the Reset button).</p>
<p><strong>Tip:</strong> Use the <a href="met_form_submit.asp">submit()</a> 
method to submit the form.</p>
<hr>
...
<p>The reset() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>formObject</em>.reset()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_form_reset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_form_reset.asp#top" target="_top">TOP</a> |
		<a href="met_form_reset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
