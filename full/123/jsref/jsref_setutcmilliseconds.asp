...
<style>a.menu_jsref_setutcmilliseconds{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">setUTCMilliseconds()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcmilliseconds" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The setUTCMilliseconds() method sets the milliseconds (from 0 to 999), according to 
universal time.</p>
...
<p>The setUTCMilliseconds() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_setutcmilliseconds.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_setutcmilliseconds.asp#top" target="_top">TOP</a> |
		<a href="jsref_setutcmilliseconds.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
