...
<title>HTML DOM Option defaultSelected Property</title>
<style>a.menu_prop_option_defaultselected{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Option <span class="color_h1">defaultSelected</span> Property</h1>
...
<p>Check if the selected option is checked by default:</p>
<div class="example_code notranslate">
var x = document.getElementById(&quot;mySelect&quot;).selectedIndex;<br>
var y = document.getElementsByTagName(&quot;option&quot;);<br>
alert(&quot;Is &quot; + y[x].text + &quot; selected by default? &quot; + y[x].defaultSelected);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_option_defaultselected">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The defaultSelected property returns the default value of the selected 
attribute.</p>
<p>This property returns true if an option is selected by default, otherwise it 
returns false.</p>
<p><b>Note:</b> If an option is selected by default, it is displayed first in 
...
<p>The defaultSelected property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>optionObject</em>.defaultSelected
</div></div>
<br>
...
<tr>
<td>Boolean</td>
<td>Returns true if the option is selected by default, otherwise it returns 
false.</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_option_defaultselected.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_option_defaultselected.asp#top" target="_top">TOP</a> |
		<a href="prop_option_defaultselected.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
