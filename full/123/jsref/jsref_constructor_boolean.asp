...
<style>a.menu_jsref_constructor_boolean{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Boolean <span class="color_h1">constructor</span> Property</h1>
...
<p>Return the function that created the <em>myvar</em> object's prototype:</p>
<div class="example_code notranslate">
var myvar = new Boolean(1);<br>
myvar.constructor;<br>
</div>
<p>The result will be:</p>
<div class="example_code notranslate">
function Boolean() { [native code] }</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_constructor_boolean" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The constructor property returns the function that created the boolean object's 
prototype.</p>
<hr>
...
<i>boolean</i>.constructor</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:23%">Return Value:</th>
	<td width="77%">A Function object. The function that created the boolean object's prototype</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_constructor_boolean.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_constructor_boolean.asp#top" target="_top">TOP</a> |
		<a href="jsref_constructor_boolean.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
