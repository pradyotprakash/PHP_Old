...
<title>HTML DOM Area protocol Property</title>
<style>a.menu_prop_area_protocol{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Area <span class="color_h1">protocol</span> Property</h1>
...
<p>Return the protocol of the href attribute for a specific area in an 
image-map:</p>
<div class="example_code notranslate">
	var x =
	document.getElementById(&quot;venus&quot;).protocol;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	http:</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_area_protocol" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The protocol property sets or returns the protocol part of the href attribute value.</p>
<p>The protocol is a standard that specifies how data are transmitted between 
computers.</p>
<hr>
...
<p>The protocol property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the portocol property:</p>
<div class="code notranslate"><div>
	<em>areaObject</em>.protocol</div></div>
<p>Set the protocol property:</p>
<div class="code notranslate"><div>
	<em>areaObject</em>.protocol=<em>protocol</em></div></div>
<br>
...
<tr>
<td>String</td>
<td>The protocol part of the href attribute value, including the colon sign (:)</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_area_protocol.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_area_protocol.asp#top" target="_top">TOP</a> |
		<a href="prop_area_protocol.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
