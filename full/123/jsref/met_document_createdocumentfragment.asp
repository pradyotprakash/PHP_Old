...
<style>a.menu_met_document_createdocumentfragment{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">createDocumentFragment()</span> Method</h1>
<p><a href="dom_obj_document.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p class="example">Create a documentFragment node and append a child to it (a list item).
Then, change the list item's node value and insert it as the last child of the list:</p>
<div class="example_code notranslate">
var d=document.createDocumentFragment();<br>
d.appendChild(document.getElementsByTagName(&quot;LI&quot;)[0]);<br>
d.childNodes[0].childNodes[0].nodeValue=&quot;Milk&quot;;<br>
document.getElementsByTagName(&quot;UL&quot;)[0].appendChild(d);</div>
...
<div class="example_code notranslate">
<ul><li>Tea</li><li>Milk</li></ul>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_createdocfrag" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The createDocumentFragment() method creates a imaginary Node object, with all the properties and methods of the Node object.</p>
<p>The createDocumentFragment() method is usefull when you want to extract parts of your document, change, add, or delete, some of the content, and insert it back to your document.</p>
<p>You can also use the document's Document object to perform these changes, but to prevent destroying the document structure, it can be safer to 
extraxt only parts of the document, make the changes, and insert the part back 
to the document.</p>
<p><strong>Note:</strong> Nodes being appended to the document fragment, from the document, will be removed from the document.</p>
<hr>
...
<p>The createDocumentFragment() method is supported in all major browsers.</p>
<hr>
...
<tr>
<td>DocumentFragment object</td>
<td>The created DocumentFragment node</td>
</tr>
</table>
...
<table class="tecspec">
<tr>
	<th style="width:28%;">DOM Version</th>
	<td>Core Level 1 Document Object</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_createdocumentfragment.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_createdocumentfragment.asp#top" target="_top">TOP</a> |
		<a href="met_document_createdocumentfragment.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
