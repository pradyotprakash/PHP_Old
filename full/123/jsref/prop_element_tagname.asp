...
<style>a.menu_prop_element_tagname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">tagName</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Get the tagName of an element:</p>
<div class="example_code notranslate">
	document.getElementById("demo").tagName;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
	P
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_element_tagname" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The tagName property returns the tag name of the element.</p>
<p>In HTML the returned value of the tagName property is always in UPPERCASE.</p>
<hr>
...
<p>The tagName property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>element</em>.tagName</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A String, representing the tag name of the element</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_element_tagname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_element_tagname.asp#top" target="_top">TOP</a> |
		<a href="prop_element_tagname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
