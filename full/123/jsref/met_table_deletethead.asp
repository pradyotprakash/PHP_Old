...
<title>HTML DOM Table deleteTHead() Method</title>
<style>a.menu_met_table_deletethead{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Table <span class="color_h1">deleteTHead()</span> Method</h1>
...
<p>Remove a &lt;thead&gt; element from a table:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myTable&quot;).deleteTHead();</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_deletethead" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The deleteTHead() method removes the &lt;thead&gt; element (and its content) from the table.</p>
<p><b>Tip: </b>To create a new &lt;thead&gt; element for a table, use the
<a href="met_table_createthead.asp">createTHead()</a> method.</p>
<hr>
...
<p>The deleteTHead() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>tableObject</em>.deleteTHead()
</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_table_deletethead.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_table_deletethead.asp#top" target="_top">TOP</a> |
		<a href="met_table_deletethead.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
