...
<title>HTML DOM childNodes Property</title>
...
<h1>HTML DOM <span class="color_h1">childNodes</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Get a collection of the body element's child nodes:</p>
<div class="example_code notranslate">
	document.body.childNodes;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_childnodes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The childNodes property returns a collection of a node&#39;s child 
nodes, as a NodeList.</p>
<p>
<strong>Tip: </strong>You can use the length property to determine the number of child nodes, then you can loop through all child nodes and extract the info you want.
...
<div class="code notranslate"><div>
	<em>element</em>.childNodes</div></div>
