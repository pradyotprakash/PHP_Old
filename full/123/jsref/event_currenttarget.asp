...
<title>currentTarget Event Property</title>
...
<h1><span class="color_h1">currentTarget</span> Event Property</h1>
...
<p>The currentTarget event property returns the element whose event listeners 
triggered the event.</p>
<p>This is particularly useful during capturing and bubbling.</p>
<h2>Syntax</h2>

<div class="code notranslate"><div>
	<em>event</em>.currentTarget</div></div>
<br>
<hr>
...
<p>The following example gets the element whose event listeners triggered the event:</p>
...
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;var x=e.currentTarget;<br>
&nbsp;&nbsp;alert(&quot;The id of the triggered element: &quot; + x.id);<br>
&nbsp;&nbsp;}<br>
&lt;/script&gt;<br>
&lt;/head&gt;<br>
<br>
&lt;body&gt;<br>
<br>
&lt;p id=&quot;p1&quot; onclick=&quot;myFunction(event)&quot;&gt;<br>
Click on this paragraph. An alert box will<br>
show which element triggered the event.&lt;/p&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_event_currenttarget" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
