...
<title>HTML DOM getAttributeNode() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_element_getattributenode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">getAttributeNode()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the target attribute of a link:</p>
<div class="example_code notranslate">
	document.getElementsByTagName("a")[0].getAttributeNode("target");</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_element_getattributenode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getAttributeNode() method returns the attribute with the specified name, as an Attr object.</p>
<p><strong>Tip:</strong> Use the <a href="met_element_getattribute.asp">getAttribute</a> 
if you just want to return the attribute value.</p>
<hr/>
...
<p>The getAttributeNode() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>element</i>.getAttributeNode(<em>attributename</em>)</div></div>
...
<td>String</td>
<td>Required. The name of the attribute you want to return</td>
</tr>
</table>
...
<tr>
<td>Attr object</td>
<td>The specified attribute node</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_getattributenode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_getattributenode.asp#top" target="_top">TOP</a> |
		<a href="met_element_getattributenode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
