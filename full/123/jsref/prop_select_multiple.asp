...
<title>HTML DOM Select multiple Property</title>
<style>a.menu_prop_select_multiple{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Select <span class="color_h1">multiple</span> Property</h1>
...
<p>Find out if more than one option in a drop-down list can be selected: </p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;).multiple;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">false</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_multiple">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The multiple property sets or returns whether more than one option/item can be selected 
...
<p>The multiple property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the multiple property:</p>
<div class="code notranslate"><div>
	<em>selectObject</em>.multiple
</div></div>
<p>Set the multiple property:</p>
<div class="code notranslate"><div>
	<em>selectObject</em>.multiple=true|false
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>true|false</td>
		<td>
		Specifies whether more than one option in a drop-down list can be 
		selected
		<ul>
			<li>true - Multiple selection is allowed</li>
			<li>false - Default. Multiple selection is not allowed</li>
		</ul>
		</td>
	</tr>
</table>
...
<tr>
<td>Boolean</td>
<td>Returns true if multiple selection in the drop-down list is enabled, otherwise it returns false</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Allow multiple selection in a drop-down list:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;mySelect&quot;).multiple=true;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_multiple2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_select_multiple.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_select_multiple.asp#top" target="_top">TOP</a> |
		<a href="prop_select_multiple.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
