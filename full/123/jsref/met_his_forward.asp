...
<title>History forward() Method</title>
<style>a.menu_met_his_forward{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>History <span class="color_h1">forward()</span> Method</h1>
...
<p>Create a forward button on a page (This example will not work if the next 
page does not exist in the history list):</p>
...
&lt;/script&gt;<br>
	<br>
&lt;body&gt;<br>
	&lt;button onclick=&quot;goForward()&quot;&gt;Go Forward&lt;/button&gt;<br>
&lt;/body&gt;</div>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_his_forward">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The forward() method loads the next URL in the history list.</p>
<p>This is the same as clicking the &quot;Forward button&quot; in your browser, or history.go(1).</p>
<p><strong>Note:</strong> This method will not work if the next page does not 
exist in the history list.</p>
<p><strong>Tip:</strong> To load the previous URL in the history list, use the
<a href="met_his_back.asp">history.back()</a> 
method.</p>
<hr>
...
<p>The forward() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
history.forward()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_his_forward.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_his_forward.asp#top" target="_top">TOP</a> |
		<a href="met_his_forward.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
