...
<style>a.menu_jsref_setutcmonth{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">setUTCMonth()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcmonth" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The setUTCMonth() method sets the month (from 0 to 11), according to 
universal time.</p>
<p><b>Note:</b> January is 0, February is 1, and so on.</p>
<p>This method can also be used to set the day of the month.</p>
...
<p>The setUTCMonth() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.setUTCMonth(<em>month</em>,<em>day</em>)</div></div>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set the month to 4 (May) and the day to the 20th:</p>
<div class="example_code notranslate">
var d = new Date();<br>
d.setUTCMonth(4,20);
</div>
<p>The result of <em>d</em>, local time, will be:</p>
<div class="example_code notranslate">
<script>
var d=new Date()
d.setUTCMonth(4,20)
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcmonth2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example</h2>
<p>Set the date to be the last day of last month:</p>
<div class="example_code notranslate">
var d = new Date();<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcmonth3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_setutcmonth.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_setutcmonth.asp#top" target="_top">TOP</a> |
		<a href="jsref_setutcmonth.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
