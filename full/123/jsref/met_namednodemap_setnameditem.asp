...
<title>HTML DOM setNamedItem() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_namednodemap_setnameditem{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">setNamedItem()</span> Method</h1>
<p><a href="dom_obj_attributes.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Attribute Object Reference" /> Attribute Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Set a H1's class attribute:</p>
<div class="example_code notranslate">
var btn=document.getElementsByTagName("h1")[0];<br>var 
	typ=document.createAttribute(&quot;class&quot;);<br>
	typ.nodeValue=&quot;democlass&quot;;<br>
	btn.attributes.setNamedItem(typ);</div>
<p class="example">Before setting the attribute:</p>
<div class="example_code notranslate">
<h1 style="margin-bottom:0px;">Hello world</h1></div>
<p class="example">After setting the attribute:</p>
<div class="example_code notranslate">
<h1 style="color:red;margin-bottom:0px;">Hello world</h1></div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_namednodemap_setnameditem" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The setNamedItem() method adds the specified node to the nodeMap.</p>
<p>If the node allready exists, it will be replaced, and the replaced node will 
be the return value, otherwise the return value will be <em>null</em>.</p>
<hr/>
...
<p>The setNamedItem() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>namednodemap</i>.setNamedItem(<em>node</em>)</div></div>
...
<td><em>node</em></td>
<td>Node object</td>
<td>Required. The node you want to add/replace in the namedNodeMap collection</td>
</tr>
</table>
...
<tr>
<td>Node object</td>
<td>The replaced node, if any, otherwise <em>null</em></td>
</tr>
</table>
...
<table class="tecspec">
<tr>
	<th style="text-align:left;width:18%;">DOM Version</th>
	<td>Core Level 1</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_namednodemap_setnameditem.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_namednodemap_setnameditem.asp#top" target="_top">TOP</a> |
		<a href="met_namednodemap_setnameditem.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
