...
<title>HTML DOM removeNamedItem() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_namednodemap_removenameditem{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">removeNamedItem()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Remove the type attribute from an input button:</p>
<div class="example_code notranslate">
var btn=document.getElementsByTagName("INPUT")[0];
btn.attributes.removeNamedItem("type");</div>
<p class="example">Before removing the attribute:</p>
<div class="example_code notranslate">
<input type="button" value="OK" /></div>
<p class="example">After removing the attribute:</p>
<div class="example_code notranslate">
<input value="OK" /></div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_namednodemap_removenameditem" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The removeNamedItem() method removes the node with the specified name in a namedNodeMap.</p>
<hr/>
...
<p>The removeNamedItem() method is supported in all major browsers.</p>
<p><strong>Note:</strong> In Internet Explorer 8 and earlier, when using the removedNamedItem method to remove an attribute, the method returns the attribute as it should, but it does not remove the attribute.</p>

<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>namednodemap</i>.removeNamedItem(<em>nodename</em>)</div></div>

<h2>Parameters</h2>
<table class="reference notranslate">
<tr>
<th style="text-align:left;width:16%;">Parameter</th>
...
<td>String</td>
<td>Required. The name of the node in the namedNodeMap you want to remove</td>
</tr>
</table>
...
<tr>
<td>Node object</td>
<td>The node that was removed</td>
</tr>
</table>
...
<table class="tecspec">
<tr>
	<th style="text-align:left;width:16%;">DOM Version</th>
	<td>Core Level 1</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_namednodemap_removenameditem.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_namednodemap_removenameditem.asp#top" target="_top">TOP</a> |
		<a href="met_namednodemap_removenameditem.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
