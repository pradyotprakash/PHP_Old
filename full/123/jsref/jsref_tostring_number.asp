...
<title>JavaScript Number toString() Method</title>
<style>a.menu_jsref_tostring_number{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Number <span class="color_h1">toString()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tostring_number" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The toString() method converts a Number object to a string.</p>
<hr (>
...
<p>The toString() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>number</i>.toString(<em>radix</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>radix</em></td>
    <td>Optional. Which base to use for representing a numeric value. Must be an integer between 2 and 36.<ul>
		<li>2 - The number will show as a binary value</li>
		<li>8 - The number will show as an octal value</li>
		<li>16 - The number will show as an hexadecimal value</li>
	</ul>
	</td>
  </tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Convert a number to a string, using different bases:</p>
<div class="example_code notranslate">
var num = 15;<br>
var a = num.toString();<br>
var b = num.toString(2);<br>
var c = num.toString(8);<br>
var d = num.toString(16);<br>
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tostring_number2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_tostring_number.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_tostring_number.asp#top" target="_top">TOP</a> |
		<a href="jsref_tostring_number.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
