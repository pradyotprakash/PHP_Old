...
<title>HTML DOM Anchor rel Property</title>
<style>a.menu_prop_anchor_rel{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Anchor <span class="color_h1">rel</span> Property</h1>
<p><a href="dom_obj_anchor.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Anchor Object Reference" /> Anchor Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the value of the rel attribute of a link:</p>
<div class="example_code notranslate">
var x = document.getElementById(&quot;w3s&quot;).rel;
</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	nofollow</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_anchor_rel" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The rel property sets or returns the value of the rel attribute of a link.</p>
<p>The rel attribute specifies the relationship between the current document and 
the linked document.</p>
<hr>
...
<p>The rel property is supported in all major browsers.</p>
<p><b>Note</b>: Browsers do not use this property in any way. However, search 
engines can use this property to get more information about a link.</p>
<hr>

<h2>Syntax</h2>
<p>Return the rel property:</p>
<div class="code notranslate"><div>
	<em>anchorObject</em>.rel
</div></div>
<p>Set the rel property:</p>
<div class="code notranslate"><div>
	<em>anchorObject</em>.rel=&quot;<i>relationship</i>&quot;</div></div>
<p>The supported <i>relationship</i> values are:</p>
<table class="reference notranslate"> 
  ...
  <tr>
    <td>alternate</td>
    <td>An alternate version of the document (i.e. print page, translated or mirror)</td>
  </tr>
    <tr>
    <td>author</td>
   ...
   <tr>
    <td>bookmark</td>
    <td>A related document</td>
  </tr>
  	<tr>
    <td>help</td>
    <td>A help document</td>
  </tr>
  <tr>
    <td>licence</td>
    <td>Copyright information for the document</td>
  </tr>
  <tr>
    <td>next</td>
    <td>The next document in a selection</td>
  </tr>
	<tr>
    <td>nofollow</td>
    <td>&quot;nofollow&quot; is used by Google, to specify that the Google search spider should not follow that link (mostly used for paid links)</td>
  </tr>
   <tr>
    <td>noreferrer</td>
    <td>Specifies that the browser should not send a HTTP referer header if the 
	user follows the hyperlink</td>
  </tr>
  <tr>
    <td>prefetch</td>
    <td>Specifies that the target document should be cached</td>
  </tr>
  <tr>
    <td>prev</td>
    <td>The previous document in a selection</td>
  </tr>
    <tr>
    <td>search</td>
    <td>A search tool for the document</td>
  </tr>
	<tr>
    <td>tag</td>
    <td>A tag (keyword) for the current document</td>
</table>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td>A String, representing the value of the rel attribute of the link</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set the value of the rel attribute to &quot;nofollow&quot;:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;w3s&quot;).rel=&quot;nofollow&quot;;
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_anchor_rel2">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_a_rel.asp">HTML &lt;a&gt; rel attribute</a></p>
<hr>

<a href="dom_obj_anchor.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Anchor Object Reference" /> Anchor Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_anchor_rel.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_anchor_rel.asp#top" target="_top">TOP</a> |
		<a href="prop_anchor_rel.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
