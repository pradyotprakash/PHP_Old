...
<title>HTML DOM open() Method</title>
<style>a.menu_met_doc_open{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">open()</span> Method</h1>
...
<p>The open() method opens an output stream to collect the output from any 
<a href="met_doc_write.asp">document.write()</a> or 
<a href="met_doc_writeln.asp">document.writeln()</a> methods.</p>
<p>Once all the writes are performed, the <a href="met_doc_close.asp">
document.close()</a> method causes any output written to the output stream to be 
displayed.</p>
<p><b>Note:</b> If a document already exists in the target, it will be cleared. If this method has no arguments, a new window 
(about:blank) is displayed.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
document.open(<i>MIMEtype</i>,replace)</div></div>
<br>
<table class="reference notranslate">
    ...
    <tr>
    <td>MIMEtype</td>
    <td>Optional. The type of document you are writing to. Default value is &quot;text/html&quot;</td>
    </tr>
    <tr>
    <td>replace</td>
    <td>Optional. If set, the history entry for the new document inherits the history entry from the document 
	which opened this document</td>
    </tr>
    </table>
<br>
<hr>
...
<p>Open an output stream, add some text, then close the output stream:</p>
<div class="example_code notranslate">
	document.open(&quot;text/html&quot;,&quot;replace&quot;);<br>document.write(&quot;&lt;h2&gt;Learning about 
	the HTML DOM is fun!&lt;/h2&gt;&quot;);<br>document.close();</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_doc_open">Try it yourself &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example 2</h2>
<p>Open an output stream (in a new window; about:blank), add some text, then close the output stream:</p>
<div class="example_code notranslate">
&lt;html&gt;<br>
&lt;body&gt;<br>
<br>
...
w=window.open();<br>
w.document.open();<br>
w.document.write(&quot;&lt;h1&gt;Hello World!&lt;/h1&gt;&quot;);<br>
w.document.close();<br>
&lt;/script&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_doc_open2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_document.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Document Object Reference" /> Document Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_doc_open.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_doc_open.asp#top" target="_top">TOP</a> |
		<a href="met_doc_open.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
