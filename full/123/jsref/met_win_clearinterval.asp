...
<title>Window clearInterval() Method</title>
<style>a.menu_met_win_clearinterval{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">clearInterval()</span> Method</h1>
...
once every 1 second, just like a digital watch). Use clearInterval() to 
stop time:</p>
	...
	{<br>clearInterval(myVar);<br>}
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_clearinterval" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The clearInterval() method clears a timer set with the 
<a href="met_win_setinterval.asp">setInterval()</a> method.</p>
<p>The ID value returned by setInterval() is used as the parameter for the clearInterval() method.</p>
<p><strong>Note:</strong> To be able to use the clearInterval() method, you must 
use a global variable when creating the interval method:</p>
...
<p>The clearInterval() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
clearInterval(<i>id_of_setinterval</i>)</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>id_of_setinterval</em></td>
    <td>Required. The ID of the timer returned by the setInterval() method</td>
</table>
<h2>Return Value</h2>
<table class="tecspec">
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_clearinterval.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_clearinterval.asp#top" target="_top">TOP</a> |
		<a href="met_win_clearinterval.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
