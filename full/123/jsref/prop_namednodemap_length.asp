...
<title>HTML DOM length Property</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_prop_namednodemap_length{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">length</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the number of attributes of a button element:</p>
<div class="example_code notranslate">
	document.getElementsByTagName("BUTTON")[0].attributes.length;</div>
<p class="example">The result could be:</p>
<div class="example_code notranslate">
1</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_namednodemap_length" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The length property return the number of nodes in a collection.</p>
<p>A Node object's attributes is an example of a NamedNodeMap object</p>
<hr>
...
<p><strong>Note:</strong> In Internet Explorer 8 and earlier, the length property for attributes will return the number of 
<em>all possible</em> attributes for an element.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>namednodemap</em>.length</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A Number, representing the number of nodes in the nodemap</td>
</tr>
<tr>
	<th>DOM Version</th>
	<td>Core Level 1</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_namednodemap_length.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_namednodemap_length.asp#top" target="_top">TOP</a> |
		<a href="prop_namednodemap_length.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
