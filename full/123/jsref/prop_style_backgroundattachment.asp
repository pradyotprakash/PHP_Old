...
<title>HTML DOM Style backgroundAttachment Property</title>
<style>a.menu_prop_style_backgroundattachment{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">backgroundAttachment</span> Property</h1>
...
<p>Set a background-image to be fixed (will not scroll):</p>
...
<p>The backgroundAttachment property sets or returns whether a background image should scroll with the content, or be fixed.</p>
<hr>
...
<p>The backgroundAttachment property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the backgroundAttachment property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.backgroundAttachment
</div></div>
<p>Set the backgroundAttachment property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.backgroundAttachment=&quot;scroll|fixed|local&quot;
</div></div>
<br>
...
<tr>
	...
	<td width="80%">scroll</td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A String, representing how the background image is attached to the 
	object within the document</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Toggle between scroll and fixed:</p>
<div class="example_code notranslate">
	var x = document.body.style.backgroundAttachment;<br>document.getElementById(&quot;toggle&quot;).innerHTML=(x==&quot;scroll&quot;)? 
	&quot;Set bg image to scroll!&quot;:&quot;Set bg image to fixed!&quot;;<br>
	document.body.style.backgroundAttachment=(x==&quot;scroll&quot;)? &quot;fixed&quot;:&quot;scroll&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundattachment2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the value of the background-attachment property:</p>
<div class="example_code notranslate">
	alert(document.body.style.backgroundAttachment);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundattachment3">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_background-attachment.asp">background-attachment property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_backgroundattachment.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_backgroundattachment.asp#top" target="_top">TOP</a> |
		<a href="prop_style_backgroundattachment.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
