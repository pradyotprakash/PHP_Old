...
<style>a.menu_jsref_settime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">setTime()</span> Method</h1>
...
<p>Add 1332403882588 milliseconds to January 1, 1970, and display the new date and 
time:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_settime" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The setTime() method sets a date and time by adding or subtracting a specified number of milliseconds to/from midnight January 1, 1970.</p>
<hr>
...
<p>The setTime() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.setTime(<em>millisec</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. The number of milliseconds to be added to, or subtracted from, midnight January 1, 1970</td>
  </tr>  
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<div class="example">
<h2 class="example">Example</h2>
<p>Subtract 1332403882588 milliseconds from January 1, 1970, and display the new date and time:</p>
<div class="example_code notranslate">
var d = new Date();<br>
d.setTime(-1332403882588);
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_settime2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_settime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_settime.asp#top" target="_top">TOP</a> |
		<a href="jsref_settime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
