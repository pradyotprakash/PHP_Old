...
<title>Window moveTo() Method</title>
<style>a.menu_met_win_moveto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">moveTo()</span> Method</h1>
...
<p>Open a new window, and move the new window to the top left corner of the screen:</p>
...
myWindow.document.write(&quot;&lt;p&gt;This is 'myWindow'&lt;/p&gt;&quot;);&nbsp;&nbsp;&nbsp; 
	// Some text in the new window<br>
}<br>
<br>
function moveWin()<br>
{<br>
myWindow.moveTo(0,0);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Moves the new window&nbsp;&nbsp;&nbsp; <br>
myWindow.focus();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Assures that the new window gets focus<br>
}</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_moveto" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The moveTo() method moves a window's left and top edge to the specified coordinates.</p>
<p><strong>Related methods:</strong></p>
<ul>
	<li><a href="met_win_moveby.asp">moveBy()</a> - Moves a window relative to 
	its current position</li>
	<li><a href="met_win_resizeby.asp">resizeBy()</a> - Resizes the window by 
	the specified pixels</li>
...
<p>The moveTo() method is supported in all major browsers.</p>
<p><b>Note:</b> Specifying moveTo(0,0) in Opera, results in moving the window to 
the top left corner of the browser, not the screen.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.moveTo(<em>x,y</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>x</em></td>
    <td>Required. A positive or negative number that specifies the horizontal 
	coordinate to be moved to</td>
  </tr>
   <tr>
    <td><em>y</em></td>
    <td>Required. A positive or negative number specifies the vertical 
	coordinate to be moved to</td>
  </tr>
</table>
<h2>Return Value</h2>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Using moveBy() together with moveTo():</p>
<div class="example_code notranslate">
	function moveWinTo()<br>{<br>myWindow.moveTo(0,0);<br>myWindow.focus();<br>
	}<br><br>function moveWinBy()<br>{<br>myWindow.moveBy(75,50);<br>
	myWindow.focus();<br>}</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_moveby_moveto" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_moveto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_moveto.asp#top" target="_top">TOP</a> |
		<a href="met_win_moveto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
