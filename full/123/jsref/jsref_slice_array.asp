...
<style>a.menu_jsref_slice_array{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Array <span class="color_h1">slice()</span> Method</h1>
...
<div class="example_code notranslate">
Orange,Lemon</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_slice_array" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The slice() method returns the selected elements in an array, as a new array object.</p>
<p>The slice() method selects the elements starting at the given <em>start</em> argument, and ends at, <em>but does not include</em>, the given <em>end</em> argument.</p>
<p><b>Note:</b> The original array will not be changed.</p>
<hr>
...
<i>array</i>.slice(<em>start</em>,<em>end</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>start</em></td>
    <td>Required. An integer that specifies where to start the selection (The 
	first element has an index of 0). Use negative numbers to 
	select from the end of an array</td>
  </tr>
  <tr>
    <td><em>end</em></td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Select elements using negative values:</p>
<div class="example_code notranslate">
var fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Lemon&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
var myBest = fruits.slice(-3,-1);
</div>
<p>The result of <em>myBest</em> will be:</p>
<div class="example_code notranslate">
Lemon,Apple</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_slice_array2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_slice_array.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_slice_array.asp#top" target="_top">TOP</a> |
		<a href="jsref_slice_array.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
