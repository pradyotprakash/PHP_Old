...
<style>a.menu_prop_win_defaultstatus{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">defaultStatus</span> Property</h1>
...
<p>Set a default text in the status bar:</p>
<div class="example_code notranslate">
window.defaultStatus = &quot;This is the default text in the status bar!!&quot;<br>
</div>
<br><a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_defaultstatus">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The defaultStatus property sets or returns the default text in the status bar at the bottom of the browser (the text will be displayed when the page loads).</p>
<p><b>Note:</b> The defaultStatus property does not work in the default configuration of IE, Firefox, 
...
JavaScript / Advanced - Allow scripts to change status bar text&quot;).</p>
<hr>
...
<p>The defaultStatus property is only supported in Opera.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.defaultStatus</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The default text displayed in the status bar</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_win_defaultstatus.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_win_defaultstatus.asp#top" target="_top">TOP</a> |
		<a href="prop_win_defaultstatus.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
