...
<style>a.menu_jsref_toexponential{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">toExponential()</span> Method</h1>
...
<p>Convert a number into an exponential notation:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_toexponential" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The toExponential() method converts a number into an exponential notation.</p>
<hr>
...
<p>The toExponential() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>number</i>.toExponential(<em>x</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>x</em></td>
    <td>Optional. An integer between 0 and 20 representing the number of digits 
	in the notation after the decimal point. If omitted, it is set to as many 
	digits as necessary to represent the value</td>
  </tr>
  </table>
...
<tr>
<td>String</td>
<td>The number as an exponential notation</td>
</tr>
</table>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_toexponential2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_toexponential.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_toexponential.asp#top" target="_top">TOP</a> |
		<a href="jsref_toexponential.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
