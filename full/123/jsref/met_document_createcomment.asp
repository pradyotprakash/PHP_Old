...
<title>HTML DOM createComment() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_document_createcomment{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">createComment()</span> Method</h1>
...
<p class="example">Create a comment node, and insert it to the HTML document:</p>
<div class="example_code notranslate">
var c=document.createComment(&quot;My personal comments&quot;);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_createcomment" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The createComment() method creates a Comment node with the specified text.</p>
<hr>
...
<p>The createComment() method is supported in all major browsers.</p>
<hr>
...
<td><em>text</em></td>
<td>String</td>
<td>Optional. The text you want to be your comment, in the Comment object</td>
</tr>
</table>
...
<td>The created Comment node</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_createcomment.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_createcomment.asp#top" target="_top">TOP</a> |
		<a href="met_document_createcomment.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
