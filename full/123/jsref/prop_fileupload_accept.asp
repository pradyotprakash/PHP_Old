...
<title>HTML DOM FileUpload accept Property</title>
<style>a.menu_prop_fileupload_accept{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>FileUpload <span class="color_h1">accept</span> Property</h1>
<p><a href="dom_obj_fileupload.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Fileupload Object Reference" /> Fileupload Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Display the accepted content type of a &lt;input type=&quot;file&quot;&gt; element:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myFile&quot;).accept;</div>
<p>The result of <em>x</em> could be:</p>
<div class="example_code notranslate">image/*</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_fileupload_accept">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The accept property sets or returns the value of the accept attribute of the 
FileUpload object.</p>
<p>The accept attribute specifies the types of files that the server accepts 
(that can be submitted through a file upload).</p>
<hr>
...
<p>The accept property is supported in all major browsers! However, Safari and Internet Explorer 9 (and earlier versions) do not filter out the proper file types when  
the user browse for files.</p>
<hr>

<h2>Syntax</h2>
<p>Return the accept property:</p>
<div class="code notranslate"><div>
	<em>fileuploadObject</em>.accept
</div></div>
<p>Set the accept property:</p>
<div class="code notranslate"><div>
	<em>fileuploadObject</em>.accept=&quot;audio/*,video/*,image/*,<i>MIME_type</i>&quot;
</div></div>  
<p><strong>Tip:</strong> To specify more than one value, separate the values with a comma.</p>
<table class="reference notranslate">
  ...
  <tr>
    <td>audio/*</td>
    <td>All sound files are accepted</td>
  </tr>
  <tr>
    <td>video/*</td>
    <td>All video files are accepted</td>
  </tr>
  <tr>
    <td>image/*</td>
    <td>All image files are accepted</td>
  </tr>
  <tr>
    <td><i>MIME_type</i></td>
    <td>A valid MIME type, with no parameters. Look at
	<a target="_blank" href="http://www.iana.org/assignments/media-types/">IANA 
	MIME types</a> for a complete list of standard MIME types</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>&nbsp;A comma-separated list of accepted 
content types.</td>
</tr>
</table>
<br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the accepted content type:</p>
<div class="example_code notranslate">
	// The server will only accept audio files in the file upload<br>document.getElementById(&quot;myFile&quot;).accept=&quot;audio/*&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_fileupload_accept2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Accept multiple content types:</p>
<div class="example_code notranslate">
	// The server will only accept audio and video files in the file upload<br>document.getElementById(&quot;myFile&quot;).accept=&quot;audio/*,video/*&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_fileupload_accept3">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_fileupload.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Fileupload Object Reference" /> Fileupload Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_fileupload_accept.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_fileupload_accept.asp#top" target="_top">TOP</a> |
		<a href="prop_fileupload_accept.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
