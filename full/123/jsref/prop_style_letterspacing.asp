...
<title>HTML DOM Style letterSpacing Property</title>
<style>a.menu_prop_style_letterspacing{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">letterSpacing</span> Property</h1>
...
<p>Set the space between characters in a &lt;p&gt; element to 15 pixels:</p>
	<div class="example_code notranslate">
document.getElementById(&quot;myP&quot;).style.letterSpacing=&quot;15px&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_letterspacing">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The letterSpacing property sets or returns the space between characters in a text.</p>
<p><strong>Tip:</strong> To set or return the spacing between words in a text, 
use the <a href="prop_style_wordspacing.asp">wordSpacing</a> property.</p>
<hr>
...
<p>The letterSpacing property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the letterSpacing property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.letterSpacing
</div></div>
<p>Set the letterSpacing property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.letterSpacing=&quot;normal|<i>length</i>|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>normal</td>
		<td>Normal space between characters. This is default</td>
	</tr>
	<tr>
		<td><i>length</i></td>
		<td>Defines the space in length units. Negative values are allowed</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the letterSpacing property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the space between characters in the text</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example_code notranslate">
document.getElementById(&quot;myP&quot;).style.letterSpacing=&quot;-2px&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_letterspacing2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the letter spacing of a &lt;p&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myP&quot;).style.letterSpacing);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_letterspacing3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Difference between the letterSpacing property and the wordSpacing property:</p>
<div class="example_code notranslate">
	function changeLetters()<br>{<br>document.getElementById(&quot;myP1&quot;).style.letterSpacing=&quot;15px&quot;;<br>
	}<br>function changeWords()<br>{<br>document.getElementById(&quot;myP2&quot;).style.wordSpacing=&quot;15px&quot;;<br>
	}</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_letter_wordspacing">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_text_letter-spacing.asp">letter-spacing property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_letterspacing.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_letterspacing.asp#top" target="_top">TOP</a> |
		<a href="prop_style_letterspacing.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
