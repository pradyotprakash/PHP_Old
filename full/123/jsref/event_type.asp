...
<title>type Event Attribute</title>
<style>a.menu_event_type{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">type</span> Event Attribute</h1>
...
<p>The type event attribute returns the type of the triggered event.</p>

<h2>Syntax</h2>

<div class="code notranslate"><div>
event.type</div></div><br>
<hr  />

<h2>Example</h2>
<div class="example">
<h2 class="example">Example</h2>
<p>The following example returns the type of event that was triggered:</p>
<div class="example_code notranslate">
&lt;html&gt;<br>
&lt;head&gt;<br>
&lt;script&gt;<br>
function getEventType(event)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;alert(event.type);<br>
&nbsp;&nbsp;}<br>
&lt;/script&gt;<br>
&lt;/head&gt;<br>
<br>
&lt;body onmousedown=&quot;getEventType(event)&quot;&gt;<br>
<br>
&lt;p&gt;Click somewhere in the document.<br>
An alert box will tell what event <br>
type you triggered.&lt;/p&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_event_type" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_type.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_type.asp#top" target="_top">TOP</a> |
		<a href="event_type.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
