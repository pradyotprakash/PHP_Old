...
<title>HTML DOM Table createCaption() Method</title>
<style>a.menu_met_table_createcaption{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Table <span class="color_h1">createCaption()</span> Method</h1>
...
<p>Create a &lt;caption&gt; element with some text for a table:</p>
<div class="example_code notranslate">
	var table = document.getElementById(&quot;myTable&quot;).createCaption();<br>
	table.innerHTML = 
	&quot;&lt;b&gt;My table caption&lt;/b&gt;&quot;;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_createcaption" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The createCaption() method creates an empty &lt;caption&gt; element and adds it to the table.</p>
<p><b>Note:</b> If a &lt;caption&gt; element already exists on the table, the createCaption() method returns the existing one, and does not create a new one.</p>
<p><b>Tip: </b>To remove the &lt;caption&gt; element from a table, use the
<a href="met_table_deletecaption.asp">deleteCaption()</a> method.</p>
<hr>
...
<p>The createCaption() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>tableObject</em>.createCaption()
</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
...
<tr>
<td>The newly created (or an existing) &lt;caption&gt; element</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Create and delete a &lt;caption&gt; element:</p>
<div class="example_code notranslate">
	function myCreateFunction()<br>{<br>var table = document.getElementById(&quot;myTable&quot;).createCaption();<br>
	table.innerHTML = &quot;&lt;b&gt;My table caption&lt;/b&gt;&quot;;<br>}<br><br>function 
	myDeleteFunction()<br>{<br>document.getElementById(&quot;myTable&quot;).deleteCaption();<br>
	}</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_create_deletecaption">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_table_createcaption.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_table_createcaption.asp#top" target="_top">TOP</a> |
		<a href="met_table_createcaption.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
