...
<style>a.menu_prop_win_status{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">status</span> Property</h1>
...
<p>Set the text in the status bar:</p>
<div class="example_code notranslate">
window.status = &quot;Some text in the status bar!!&quot;;<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_statusbar" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The status property sets the text in the status bar at the bottom of the 
browser, or returns the previously set text.</p>
<p><strong>Note:</strong> Do not confuse this property with the
<a href="prop_win_defaultstatus.asp">defaultStatus</a> property, which specifies 
the default text displayed in the status bar.</p>
<p><b>Note:</b> The status property does not work in the default configuration of IE, Firefox, 
...
<p>The status property is only supported in Opera.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.status</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The text displayed in the status bar</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_win_status.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_win_status.asp#top" target="_top">TOP</a> |
		<a href="prop_win_status.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
