...
<title>clientX Event Attribute</title>
<style>a.menu_event_clientx{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">clientX</span> Event Attribute</h1>
...
<p>The clientX event attribute returns the horizontal coordinate (according to 
the client area) of the mouse 
pointer when an event was triggered.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_clientx.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_clientx.asp#top" target="_top">TOP</a> |
		<a href="event_clientx.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
