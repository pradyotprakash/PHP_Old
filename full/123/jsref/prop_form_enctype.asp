...
<title>HTML DOM Form enctype Property</title>
<style>a.menu_prop_form_enctype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Form <span class="color_h1">enctype</span> Property</h1>
...
<p>Return how form-data should be encoded before sending it to the server:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myForm&quot;).enctype;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	application/x-www-form-urlencoded</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_form_enctype" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The enctype property sets or returns the value of the enctype attribute in a form.</p>
<p>The enctype attribute specifies how form-data should be encoded before sending it to the server.</p>
<p>The form-data is encoded to &quot;application/x-www-form-urlencoded&quot; by default. 
This means that all characters are encoded before they are sent to the server 
(spaces are converted to &quot;+&quot; symbols, and special characters are converted to ASCII HEX values).</p>
<hr>
...
<p>The enctype property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the enctype property:</p>
<div class="code notranslate"><div>
	<em>formObject</em>.enctype</div></div>
<p>Set the enctype property:</p>
<div class="code notranslate"><div>
	<em>formObject</em>.enctype=&quot;application/x-www-form-urlencoded,multipart/form-data,text/plain&quot;</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>All characters are encoded before sent (this is default)</td>
  </tr>
  <tr>
	...
	<tr>
    <td>text/plain</td>
    <td>Spaces are converted to &quot;+&quot; symbols, but no special characters are 
	encoded</td>
  </tr>
</table>
<h2>Return Value</h2>
...
<tr>
<td>String</td>
<td>The value of the enctype attribute in the form element</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the enctype value for how form-data should be encoded before sending it to the server:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myForm&quot;).enctype=multipart/form-data;
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_form_enctype2">Try it yourself &raquo;</a>
</div>
<br><hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_form_enctype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_form_enctype.asp#top" target="_top">TOP</a> |
		<a href="prop_form_enctype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
