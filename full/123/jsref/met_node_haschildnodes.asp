...
<title>HTML DOM hasChildNodes Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_node_haschildnodes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>DOM Node <span class="color_h1">hasChildNodes()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">See if an element has any childNodes:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myList&quot;).hasChildNodes()</div>
<p>The result will be:</p>
<div class="example_code notranslate">
	true</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_haschildnodes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The hasChildNodes() method returns <em>true</em> if the specified node has any 
childNodes, otherwise <em>false</em>.</p>
<hr/>
...
<p>The hasChildNodes() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>node</i>.hasChildNodes()</div></div>
...
<td>Boolean</td>
<td>
<em>true</em> if the node has childnodes, otherwise <em>false</em></td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_haschildnodes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_haschildnodes.asp#top" target="_top">TOP</a> |
		<a href="met_node_haschildnodes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
