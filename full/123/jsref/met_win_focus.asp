...
<title>Window focus() Method</title>
<style>a.menu_met_win_focus{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">focus()</span> Method</h1>
...
<p>Assure that the new window GETS focus (send the new window to the 
front):</p>
<div class="example_code notranslate">
	var
myWindow = window.open(&quot;&quot;,&quot;&quot;,&quot;width=200,height=100&quot;);&nbsp;&nbsp; // 
	Opens a new window<br>
myWindow.document.write(&quot;&lt;p&gt;A new window!&lt;/p&gt;&quot;);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Some text in the new window<br>
myWindow.focus();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Assures that the new window gets focus</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_focus" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The focus() method sets focus to the current window. </p>
<p><strong>Tip:</strong> Use the <a href="met_win_blur.asp">blur()</a> method to remove focus from the current 
window.</p>
<p><strong>Note:</strong> This method makes a request to bring the current 
window to the foreground. It may not work as you expect in all browsers, due to 
different user settings.</p>
<hr>
...
<p>The focus() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.focus()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Assure that the new window does NOT get focus (send the new window to the 
background):</p>
<div class="example_code notranslate">
	var
myWindow = window.open(&quot;&quot;,&quot;myWindow&quot;,&quot;width=200,height=100&quot;);<br>
myWindow.document.write(&quot;&lt;p&gt;This is 'myWindow'&lt;/p&gt;&quot;);<br>
myWindow.blur();&nbsp;&nbsp;// Assures that the new window does NOT get focus);</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_blur" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_focus.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_focus.asp#top" target="_top">TOP</a> |
		<a href="met_win_focus.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
