...
<title>HTML DOM tr insertCell() Method</title>
<style>a.menu_met_tablerow_insertcell{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>tr <span class="color_h1">insertCell()</span> Method</h1>
<p><a href="dom_obj_tablerow.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="tr Object Reference" /> tr Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Insert new cell(s) with content at the beginning of a table row with id=&quot;myRow&quot;:</p>
<div class="example_code notranslate">
	var row = document.getElementById(&quot;myRow&quot;);<br>var x = row.insertCell(0);<br>
	x.innerHTML=&quot;New cell&quot;;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tr_insertcell" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The insertCell() method inserts a cell into the current row.</p>
<p><strong>Tip:</strong> Use the <a href="met_tablerow_deletecell.asp">deleteCell()</a> method to delete a cell in the 
current table row.</p>
<hr>
...
<p>The insertCell() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>trObject</em>.insertCell(<i>index</i>)</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>index</i></td>
		<td>Required in Firefox and Opera, optional in IE, Chrome and Safari. A number (starts at 0) that specifies the position of the new cell in the current row. 
		The value of 0 results in that the new cell will be inserted at the 
		first position. The value of -1 can also be used; which results in that the new cell will be 
		inserted at the last position.<br><br>
		If this parameter is omitted, insertCell() inserts the new cell at the 
		last position in IE and at the first position in Chrome and Safari.<br><br>
		This parameter is required in Firefox and Opera, but optional in Internet Explorer, Chrome and Safari.</td>
	</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>The inserted cell element</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Insert new cell(s) with content at the end of a table row with id=&quot;myRow&quot;:</p>
<div class="example_code notranslate">
	var row = document.getElementById(&quot;myRow&quot;);<br>var x = row.insertCell(-1);<br>
	x.innerHTML=&quot;New cell&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tr_insertcell2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Insert new cell(s) with content at the index position 2 of a table row with id=&quot;myRow&quot;:</p>
<div class="example_code notranslate">
	var row = document.getElementById(&quot;myRow&quot;);<br>var x = row.insertCell(2);<br>
	x.innerHTML=&quot;New cell&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tr_insertcell3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Insert new cell(s) at the beginning of the first table row. The table rows 
collection (.rows[0]) returns a collection of all &lt;tr&gt; elements in the table 
with id &quot;myTable&quot;. The number [0] specifies the element to retrieve, in this 
example, the first table row. Then we use insertcell() to insert new cell(s) at 
index position -1:</p>
<div class="example_code notranslate">
var firstRow = document.getElementById(&quot;myTable&quot;).rows[0];<br>
var x = firstRow.insertCell(-1);<br>
x.innerHTML=&quot;New cell&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tr_insertcell4">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Delete the first cell(s) from a table row with id=&quot;myRow&quot;:</p>
<div class="example_code notranslate">
var row = document.getElementById(&quot;myRow&quot;);<br>row.deleteCell(0);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tr_deletecell">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Insert new row(s) at the beginning of a table. The insertRow() method inserts a 
new row at the specified index in a table, in this example, the first position 
(the beginning) of a table with id=&quot;myTable&quot;. Then we use the insertCell() 
method to add cells in the new row.</p>
<div class="example_code notranslate">
var table = document.getElementById(&quot;myTable&quot;);<br>var row = table.insertRow(0);<br>
	var cell1 = row.insertCell(0);<br>var cell2 = row.insertCell(1);<br>
	cell1.innerHTML = &quot;NEW CELL1&quot;;<br>cell2.innerHTML = &quot;NEW CELL2&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_insertrow">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<a href="dom_obj_tablerow.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="tr Object Reference" /> tr Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_tablerow_insertcell.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_tablerow_insertcell.asp#top" target="_top">TOP</a> |
		<a href="met_tablerow_insertcell.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
