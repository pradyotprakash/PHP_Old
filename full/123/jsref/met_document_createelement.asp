...
<style>a.menu_met_document_createelement{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">createElement()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Create a button:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_createelement" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<p>HTML elements often contains text. To create a button <em>with text</em> you must also create a Text Node which you append to the button element:</p>

<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Create a button with text:</p>
<div class="example_code notranslate">
	var btn=document.createElement(&quot;BUTTON&quot;);<br>
	var t=document.createTextNode("CLICK ME");<br>
	btn.appendChild(t);
	</div>
	<p>The result will be:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_createelement2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The createElement() method creates an Element Node with the specified name.</p>
<hr/>
...
<p>The createElement() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
document.createElement(<em>nodename</em>)</div></div>
...
<td>String</td>
<td>Required. The name of the element you want to create</td>
</tr>
</table>
...
<td>The created Element node</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_createelement.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_createelement.asp#top" target="_top">TOP</a> |
		<a href="met_document_createelement.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
