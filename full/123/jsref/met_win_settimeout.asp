...
<style>a.menu_met_win_settimeout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">setTimeout()</span> Method</h1>
...
<p>Display an alert box after 3 seconds:</p>
<div class="example_code notranslate">
	setTimeout(function(){alert(&quot;Hello&quot;)},3000);<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_settimeout" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><b>Tip:</b> 1000 ms = 1 second.</p>
<p><strong>Tip:</strong> The function is only executed once. If you need to 
repeat execution, use the <a href="met_win_setinterval.asp">setInterval()</a> 
method.</p>
<p><strong>Tip:</strong> Use the <a href="met_win_cleartimeout.asp">
clearTimeout()</a> method to prevent the function to run.</p>
<hr>
...
<p>The setTimeout() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
setTimeout(<em>function,milliseconds,lang</em>)</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Required. The function that will be executed</td>
  </tr>
  <tr>
    <td><em>milliseconds</em></td>
    <td>Required. The number of milliseconds to wait before executing the code</td>
  </tr>
    <tr>
    <td><em>lang</em></td>
    <td>Optional. The scripting language: JScript | VBScript | JavaScript</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="tecspec">
<tr>
<td>An integer with the ID value of the timer that is set. Use this value with the clearTimeout() method to cancel the timer.</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Display a timed text:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;txt&quot;);<br>setTimeout(function(){x.value=&quot;2 seconds&quot;},2000);<br>setTimeout(function(){x.value=&quot;4 seconds&quot;},4000);<br>setTimeout(function(){x.value=&quot;6 
	seconds&quot;},6000);</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_settimeout2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Open a new window and close the window after three seconds (3000 
milliseconds):</p>
<div class="example_code notranslate">
	var myWindow = window.open(&quot;&quot;,&quot;&quot;,&quot;width=200,height=100&quot;);<br>
	myWindow.document.write(&quot;&lt;p&gt;This is 'myWindow'&lt;/p&gt;&quot;);<br>setTimeout(function(){myWindow.close()},3000);</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_settimeout3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Using clearTimeout to prevent the function to run:</p>
<div class="example_code notranslate">
	var myVar;<br><br>function myFunction()<br>{<br>myVar = setTimeout(function(){alert(&quot;Hello&quot;)},3000);<br>
	}<br><br>function myStopFunction()<br>{<br>clearTimeout(myVar);<br>}</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_settimeout_cleartimeout" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Count forever - with a 
Stop button:</p>
<div class="example_code notranslate">
	function startCount()<br>function stopCount()</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_settimeout_cleartimeout2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>A clock created with timing events:</p>
<div class="example_code notranslate">
	function startTime()<br>{<br>var today = new Date();<br>var h = 
	today.getHours();<br>var m = today.getMinutes();<br>var s = today.getSeconds();<br>
	// add a zero in front of numbers&lt;10<br>m = checkTime(m);<br>s = checkTime(s);<br>
	document.getElementById(&quot;txt&quot;).innerHTML=h+&quot;:&quot;+m+&quot;:&quot;+s;<br>t = setTimeout(function(){startTime()},500);<br>
	}<br><br>function checkTime(i)<br>{<br>if (i&lt;10)<br>{<br>i=&quot;0&quot; + i;<br>}<br>return i;<br>}</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_settimeout_clock" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_settimeout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_settimeout.asp#top" target="_top">TOP</a> |
		<a href="met_win_settimeout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
