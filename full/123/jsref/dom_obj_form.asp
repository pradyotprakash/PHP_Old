...
<html lang="en-US">
<head>
<title>HTML DOM Form Object</title>
<style>a.menu_dom_obj_form{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Form</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_pushbutton.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_frame.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Form Object</h2>
<p>The Form object represents an HTML form.</p>
<p>For each &lt;form&gt; tag in an HTML document, a Form object is created.</p>
<p>Forms are used to collect user input, and contain input elements like text 
fields, checkboxes, radio-buttons, submit buttons and more. A form can also 
contain select menus, textarea, fieldset, legend, and label elements.</p>
<p>Forms are used to pass data to a server.</p>

<hr>

<h2>Form Object Collections</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="coll_form_elements.asp">elements</a></td>
    <td>Returns a a collection of all elements in a form</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_form_acceptcharset.asp">acceptCharset</a></td>
    <td>Sets or returns the value of the accept-charset attribute in a 
	form</td>
  </tr>
  <tr>
    <td><a href="prop_form_action.asp">action</a></td>
    <td>Sets or returns the value of the action attribute in a 
	form</td>
  </tr>
  <tr>
    <td><a href="prop_form_enctype.asp">enctype</a></td>
    <td>Sets or returns the value of the enctype attribute in a 
	form</td>
  </tr>
  <tr>
    <td><a href="prop_form_length.asp">length</a></td>
    <td>Returns the number of elements in a form</td>
  </tr>
  <tr>
    <td><a href="prop_form_method.asp">method</a></td>
    <td>Sets or returns the value of the method attribute in a 
	form</td>
  </tr>
  <tr>
    <td><a href="prop_form_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute in a 
	form</td>
  </tr>
  <tr>
    <td><a href="prop_form_target.asp">target</a></td>
    <td>Sets or returns the value of the target attribute in a 
	form</td>
  </tr>
</table>

<h2>Form Object Methods</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_form_reset.asp">reset()</a></td>
    <td>Resets a form</td>
  </tr>
  <tr>
    <td><a href="met_form_submit.asp">submit()</a></td>
    <td>Submits a form</td>
    </tr>
</table>

<!--
<h2>Form Object Events</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="event_form_onreset.asp">onreset</a></td>
    <td>The reset button is clicked</td>
  </tr>
  <tr>
    <td><a href="event_form_onsubmit.asp">onsubmit</a></td>
...
<p>The Form object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_form.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_form.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_form.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
