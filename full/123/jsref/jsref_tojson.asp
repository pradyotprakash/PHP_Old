...
<title>JavaScript toJSON() Method</title>
<style>a.menu_jsref_tojson{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">toJSON()</span> Method</h1>
...
<p>Return a Date object as a String, formatted as a JSON date:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tojson" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The toJSON() method converts a Date object into a string, formatted as a JSON date.</p>
...
<p>The toJSON() method is supported in all major browsers.</p>
<p><b>Note:</b> Internet explorer 8 and earlier does not support this method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.toJSON()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>String </td>
<td>The date and time formated as a JSON date</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_tojson.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_tojson.asp#top" target="_top">TOP</a> |
		<a href="jsref_tojson.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
