...
<style>a.menu_jsref_getutcmilliseconds{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">getUTCMilliseconds()</span> Method</h1>
...
<p>Return the milliseconds, according to UTC:</p>
<div class="example_code notranslate">
var d = new Date();<br>
var n = d.getUTCMilliseconds();
</div>
<p>The result of <em>n</em> could be:</p>
<div class="example_code notranslate">
<script>
var d = new Date()
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutcmilliseconds" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<p>The getUTCMilliseconds() method returns the milliseconds (from 0 to 999) of the 
specified date and time, according to universal time.</p>
<p>The UTC methods calculate their date assuming that the date object is of local time and date.</p>
...
<p>The getUTCMilliseconds() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.getUTCMilliseconds()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>Number</td>
<td>A Number, from 0-999, representing milliseconds</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the UTC milliseconds from a specific date and time:</p>
<div class="example_code notranslate">
var d = new Date(&quot;July 21, 1983 01:15:00:195&quot;);<br>
var n = d.getUTCMilliseconds();
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutcmilliseconds2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<div class="tryit_ex">
<img src="http://www.w3schools.com/images/tryitimg.gif" style="width:40px;height:46px" alt="Examples">
<p><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_datetime_millisec_utc">
Display the UTC time (with milliseconds)</a><br>
How to use getHours(), getMinutes(), getSeconds(), and getMilliseconds() to display the time.</p>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_getutcmilliseconds.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_getutcmilliseconds.asp#top" target="_top">TOP</a> |
		<a href="jsref_getutcmilliseconds.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
