...
<title>JavaScript Number prototype Property</title>
<style>a.menu_jsref_prototype_num{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Number <span class="color_h1">prototype</span> Property</h1>
<p><a href="jsref_obj_number.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Date Object Reference" /> JavaScript Number Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Create a method that gives the number object a property that returns the number's half value:</p>
<div class="example_code notranslate">
Number.prototype.myMet=function()<br>
{<br>
this.myProp=this.valueOf()/2;<br>
}</div>
<p>Make a Number object, then call the myMet method:</p>
<div class="example_code notranslate">
var n = new Number(55);<br>
n.myMet();<br>
var x = n.myProp;
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_prototype_number" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<hr>

<h2>Definition and Usage</h2>
<p>The prototype constructor allows you to add new properties and methods to the Number() object.</p>
<p>When constructing a property, ALL number objects will be given the property, and its value, as default.</p>
<p>When constructing a method, ALL number objects will have this method available.</p>
<p><b>Note:</b> Number.prototype does not refer to a single number object, but to the Number() object itself.</p>
...
object.prototype.<em>name</em>=<em>value</em></div></div>
<br>
<hr>


<a href="jsref_obj_number.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Date Object Reference" /> JavaScript Number Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_prototype_num.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_prototype_num.asp#top" target="_top">TOP</a> |
		<a href="jsref_prototype_num.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
