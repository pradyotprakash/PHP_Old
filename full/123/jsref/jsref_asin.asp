...
<title>JavaScript asin() Method</title>
<style>a.menu_jsref_asin{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">asin()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_asin" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<hr>

<h2>Definition and Usage</h2>
<p>The asin() method returns the arcsine of a number as a value between -PI/2 and PI/2 radians.</p>
<p><b>Note:</b> If the parameter x is outside the range -1 to 1, the browser will return NaN.</p>
<p><b>Tip:</b> 1 will return the value of PI/2.</p>
<hr>
...
<p>The asin() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.asin(<em>x</em>)</div></div>
...
<tr>
<td>Number</td>
<td>A Number, from -PI/2 to PI/2, or NaN if the value is outside the range of -1 to 1</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_asin.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_asin.asp#top" target="_top">TOP</a> |
		<a href="jsref_asin.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
