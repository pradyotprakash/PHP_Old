...
<title>HTML DOM Textarea select() Method</title>
<style>a.menu_met_textarea_select{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Textarea <span class="color_h1">select()</span> Method</h1>
...
<p>Select the contents of a text area:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myTextarea&quot;).select();</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_textarea_select" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The select() method selects the entire contents of a text area.</p>
<hr>
...
<p>The select() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>textareaObject</em>.select()
</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_textarea_select.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_textarea_select.asp#top" target="_top">TOP</a> |
		<a href="met_textarea_select.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
