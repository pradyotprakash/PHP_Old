...
<html lang="en-US">
<head>
<title>HTML DOM Button Object</title>
<style>a.menu_dom_obj_button{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Button</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_image.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_checkbox.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Button Object</h2>
<p>The Button object represents a clickable button in an HTML form.</p>
<p>A button is often used to activate a JavaScript when a user 
clicks on it.</p>
<p>For each instance of an &lt;input type=&quot;button&quot;&gt; tag in an HTML form, a Button object is created.</p>
<p>You can access a Button object by searching through the elements[] array of a form, or by using document.getElementById().</p>

<hr>

<h2>Button Object Properties</h2>
<table class="reference notranslate">
  <tr>
    ...
    <tr>
    <td><a href="prop_button_disabled.asp">disabled</a></td>
    <td>Sets or returns whether an input button is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_button_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the input button</td>
  </tr>
  <tr>
    <td><a href="prop_button_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of an input button</td>
  </tr>
  <tr>
    <td><a href="prop_button_type.asp">type</a></td>
    <td>Returns which type of form element the input button is</td>
  </tr>
  <tr>
    <td><a href="prop_button_value.asp">value</a></td>
    <td>Sets or returns the value of the value attribute of an input button</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Button object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_button.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_button.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_button.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
