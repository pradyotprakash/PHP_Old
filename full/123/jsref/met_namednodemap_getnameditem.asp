...
<title>HTML DOM getNamedItem() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_namednodemap_getnameditem{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">getNamedItem()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the value of the onclick attribute of a button element:</p>
<div class="example_code notranslate">
var btn=document.getElementsByTagName("BUTTON")[0];<br>btn.attributes.getNamedItem("onclick").textContent;</div>
<p class="example">The result could be:</p>
<div class="example_code notranslate">
myFunction()</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_namednodemap_getnameditem" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getNamedItem() method returns the attribute node with the specified name 
from a namedNodeMap.</p>
<hr/>
...
<i>namednodemap</i>.getNamedItem(<em>name</em>)</div></div>
...
<td>String</td>
<td>Required. The name of the node in the namedNodeMap you want to return</td>
</tr>
</table>
...
<tr>
<td>Node object</td>
<td>The node with the specified name</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_namednodemap_getnameditem.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_namednodemap_getnameditem.asp#top" target="_top">TOP</a> |
		<a href="met_namednodemap_getnameditem.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
