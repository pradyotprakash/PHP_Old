...
<style>a.menu_jsref_sort{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Array <span class="color_h1">sort()</span> Method</h1>
<p><a href="jsref_obj_array.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Array Object Reference" /> JavaScript Array Object</a></p>
<div class="example">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_sort" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The sort() method sorts the items of an array.</p>
<p>The sort order can be either alphabetic or numeric, and either ascending or descending.</p>
<p>Default sort order is alphabetic and ascending.</p>
<p><strong>Note:</strong> When numbers are sorted alphabetically, "40" comes before "5".</p>
<p>To perform a numeric sort, you must pass a function as an argument when calling the sort method.</p>
<p>The function specifies whether the numbers should be sorted ascending or 
descending.</p>
<p>It can be difficult to understand how this function works, but see the examples at the bottom of this page.</p>
<p><b>Note:</b> This method changes the original array.</p>
<hr>
...
<p>The sort() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>array</i>.sort(<em>sortfunction</em>)</div></div>
...
<tr>
<td><em>sortfunction</em></td>
<td>Optional. A function that defines the sort order</td>
</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>Array </td>
<td>The Array object, with the items sorted</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Sort numbers (numerically and ascending):</p>
<div class="example_code notranslate">
var points = [40,100,1,5,25,10];<br>
points.sort(function(a,b){return a-b});<br>
</div>
<p>The result of points will be:</p>
<div class="example_code notranslate">
1,5,10,25,40,100</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_sort2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example</h2>
<p>Sort numbers (numerically and descending):</p>
<div class="example_code notranslate">
var points = [40,100,1,5,25,10];<br>
...
<p>The result of points will be:</p>
<div class="example_code notranslate">
100,40,25,10,5,1</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_sort3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example</h2>
<p>Sort numbers (alphabetically and descending):</p>
<div class="example_code notranslate">
var fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
fruits.sort();<br>
fruits.reverse();
</div>
<p>The result of fruits will be:</p>
<div class="example_code notranslate">
Orange,Mango,Banana,Apple</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_sort4" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="jsref_obj_array.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Array Object Reference" /> JavaScript Array Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_sort.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_sort.asp#top" target="_top">TOP</a> |
		<a href="jsref_sort.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
