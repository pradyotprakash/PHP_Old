...
<title>HTML DOM firstChild Property</title>
...
<h1>HTML DOM <span class="color_h1">firstChild</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the first child node of the document:</p>
<div class="example_code notranslate">
	document.firstChild;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_firstchild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The firstChild property returns the first child node of the specified node, as a Node object.</p>
<p><strong>Note:</strong> In HTML, the document itself is the parent node of the HTML element, HEAD and BODY are child nodes of the HTML element.</p>
<hr>
...
<p>The firstChild property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>node</em>.firstChild</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The first child of the node, as a Node object</td>
</tr>
<tr>
	<th>DOM Version</th>
