...
<title>DOM Element getAttribute() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_element_getattribute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">getAttribute()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Get the target attribute value of a link:</p>
<div class="example_code notranslate">
	document.getElementsByTagName("a")[0].getAttribute("target");</div>
<p>The result will be:</p>
<div class="example_code notranslate">
_blank
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_element_getattribute" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getAttribute() method returns the value of the attribute with the specified 
name.</p>
<p><strong>Tip:</strong> Use the <a href="met_element_getattributenode.asp">
getAttributeNode</a> 
if you want to return the attribute as an Attr object.</p>
<hr/>
...
<p>The getAttribute() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>element</i>.getAttribute(<em>attributename</em>)</div></div>
...
<td>String</td>
<td>Required. The name of the attribute you want to get the value from</td>
</tr>
</table>
...
<tr>
<td>String</td>
<td>The specified attribute's value</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_getattribute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_getattribute.asp#top" target="_top">TOP</a> |
		<a href="met_element_getattribute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
