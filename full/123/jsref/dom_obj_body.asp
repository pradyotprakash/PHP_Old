...
<style>a.menu_dom_obj_body{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Body</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_base.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_pushbutton.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Body Object</h2>
<p>The Body object represents the HTML body element.</p>
<p>The body element defines a document's body.</p>
<p>The body element contains all the contents of an HTML document, such as text, 
hyperlinks, images, tables, lists, etc.</p>

<hr>

<h2>Body Object Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_body_alink.asp">aLink</a></td>
    <td>Sets or returns the value of the alink attribute of the body element</td>
  </tr>
  <tr>
    <td><a href="prop_body_background.asp">background</a></td>
    <td>Sets or returns the value of the background attribute of the body 
	element</td>
  </tr>
  <tr>
    <td><a href="prop_body_bgcolor.asp">bgColor</a></td>
    <td>Sets or returns the value of the bgcolor attribute of the body element</td>
  </tr>
  <tr>
    <td><a href="prop_body_link.asp">link</a></td>
    <td>Sets or returns the value of the link attribute of the body element</td>
  </tr>
  <tr>
    <td><a href="prop_body_text.asp">text</a></td>
    <td>Sets or returns the value of the text attribute of the body element</td>
  </tr>
  <tr>
    <td><a href="prop_body_vlink.asp">vLink</a></td>
    <td>Sets or returns the value of the vlink attribute of the body element</td>
  </tr>
</table>

<h2>Body Object Events</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="event_body_onload.asp">onload</a></td>
    <td>Script to be run immediately after a page is loaded</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Body object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_body.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_body.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_body.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
