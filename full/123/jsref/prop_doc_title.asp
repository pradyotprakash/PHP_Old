...
<style>a.menu_prop_doc_title{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The title property returns the title of the current document (the text inside the HTML title element).</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
document.title</div></div><br>
<hr>
...
<p>Return the title of the current document:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_doc_title">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_document.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Document Object Reference" /> Document Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_doc_title.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_doc_title.asp#top" target="_top">TOP</a> |
		<a href="prop_doc_title.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
