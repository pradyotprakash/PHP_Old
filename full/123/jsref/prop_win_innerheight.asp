...
<title>Window innerWidth and innerHeight Property</title>
<style>a.menu_prop_win_innerheight{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">innerWidth</span> and <span class="color_h1">
innerHeight</span> Properties</h1>
...
<p>Get the window&#39;s height and width: (NOT including toolbars/scrollbars):</p>
<div class="example_code notranslate">
	var w = window.innerWidth;<br>var h = window.innerHeight;<br>
	</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_innerheight">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The innerWidth property returns the inner width of a window's content area.</p>

<p>The innerHeight property returns the inner height of a window's 
content area.</p>

<p><strong>Note:</strong> Use the <a href="prop_win_outerheight.asp">
outerWidth and outerHeight</a> properties to get the width/height with toolbars/scrollbars.</p>
<hr>
...
<p>The innerWidth and innerHeight properties are supported in all major browsers.</p>
<p><strong>Note:</strong> These properties are not supported in IE8 and earlier.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.innerWidth<br>
window.innerHeight</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td width="80%">An integer, representing the inner width and/or the inner height of the browser window's content area, in pixels</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_win_innerheight.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_win_innerheight.asp#top" target="_top">TOP</a> |
		<a href="prop_win_innerheight.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
