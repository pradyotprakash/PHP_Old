...
<html lang="en-US">
<head>
<title>HTML DOM Textarea Object</title>
<style>a.menu_dom_obj_textarea{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Textarea</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_tablerow.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="default.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Textarea Object</h2>
<p>The Textarea object represents a text-area in an HTML form.</p>
<p>For each &lt;textarea&gt; tag in an HTML form, a Textarea object is created.</p>
<p>You can access a Textarea object by indexing the elements array (by number or 
name) of the form or by using getElementById().</p>


<hr>

<h2>Textarea Object Properties</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_textarea_cols.asp">cols</a></td>
    <td>Sets or returns the value of the cols attribute of a text area</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_defaultvalue.asp">defaultValue</a></td>
    <td>Sets or returns the default value of a text area</td>
  </tr>
    <tr>
    <td><a href="prop_textarea_disabled.asp">disabled</a></td>
    <td>Sets or returns whether the text area is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_textarea_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the text area</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of a text area</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_readonly.asp">readOnly</a></td>
    <td>Sets or returns whether the contents of a text area is 
    read-only</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_rows.asp">rows</a></td>
    <td>Sets or returns the value of the rows attribute of a text area</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_type.asp">type</a></td>
    <td>Returns the type of the form element the text area is</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_value.asp">value</a></td>
    <td>Sets or returns the contents of a text area</td>
  </tr>
  </table>

<h2>Textarea Object Methods</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_textarea_select.asp">select()</a></td>
    <td>Selects the entire contents of a text area</td>
    </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Textarea object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_textarea.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_textarea.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_textarea.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
