...
<style>a.menu_jsref_regexp_constructor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript RegExp <span class="color_h1">constructor</span> Property</h1>
...
<p>Return the function that created the RegExp object's prototype:</p>
<div class="example_code notranslate">
	var patt = new RegExp(&quot;Hello World&quot;,&quot;g&quot;);<br>var res = patt.constructor;</div>
<p>The result of <em>res</em> will be:</p>
<div class="example_code notranslate">
function RegExp() { [native code] }</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_constructor" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The constructor property returns the function that created the RegExp object's prototype.</p>
<p><strong>Note:</strong> The value of this property is a reference to the 
function itself, and not a string that contains the name of the function.</p>
<hr>
...
<p>The constructor property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>RegExpObject</em>.constructor</div></div>

<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:23%">Return Value:</th>
	<td>The function that created the RegExp object's prototype</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_regexp_constructor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_regexp_constructor.asp#top" target="_top">TOP</a> |
		<a href="jsref_regexp_constructor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
