...
<style>a.menu_jsref_getutchours{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">getUTCHours()</span> Method</h1>
...
<p>Return the hour, according to universal time:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutchours" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getUTCHours() method returns the hour (from 0 to 23) of the 
...
<p>The getUTCHours() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.getUTCHours()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>Number</td>
<td>A Number, from 0 to 23, representing the hour</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the UTC hour from a specific date and time:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutchours2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="tryit_ex">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_getutchours.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_getutchours.asp#top" target="_top">TOP</a> |
		<a href="jsref_getutchours.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
