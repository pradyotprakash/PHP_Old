...
<title>HTML DOM Option form Property</title>
<style>a.menu_prop_option_form{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Option <span class="color_h1">form</span> Property</h1>
...
<p>Return the id of the form containing the &lt;option&gt; element with 
id=&quot;apple&quot;:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;apple&quot;).form.id;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">myForm</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_option_form">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The form property returns a reference to the form that contains an option.</p>
...
<tr>
<td>A reference to the form element containing the option. If the option is not 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_option_form.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_option_form.asp#top" target="_top">TOP</a> |
		<a href="prop_option_form.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
