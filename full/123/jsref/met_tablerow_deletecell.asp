...
<title>HTML DOM tr deleteCell() Method</title>
<style>a.menu_met_tablerow_deletecell{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>tr <span class="color_h1">deleteCell()</span> Method</h1>
...
<div class="example_code notranslate">
	var row = document.getElementById(&quot;myRow&quot;);<br>row.deleteCell(0);<br>
	</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tr_deletecell" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The deleteCell() method deletes a cell in the current table row.</p>
<p><strong>Tip:</strong> Use the <a href="met_tablerow_insertcell.asp">insertCell()</a> method to delete a cell in the 
current table row.</p>
<hr>
...
<p>The deleteCell() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>trObject</em>.deleteCell(<i>index</i>)</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>index</i></td>
		<td>Required in Firefox and Opera, optional in IE, Chrome and Safari. An integer (starts at 0) that specifies the position of the cell to delete in the current row. 
		The value of 0 results in that the first cell will be deleted. 
		The value of -1 can also be used; which result in that the last cell will be deleted.<br><br>
		If this parameter is omitted, deleteCell() removes the last cell in IE and the first cell in Chrome and Safari.<br><br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Delete the last cell(s) from the a table row with id=&quot;myRow&quot;:</p>
<div class="example_code notranslate">
	var row = document.getElementById(&quot;myRow&quot;);<br>row.deleteCell(-1);<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tr_deletecell2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Delete cell(s) from the index position 1 in a table row with id=&quot;myRow&quot;:</p>
<div class="example_code notranslate">
	var row = document.getElementById(&quot;myRow&quot;);<br>row.deleteCell(1);<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tr_deletecell3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Delete cell(s) at the beginning of the first table row. The table rows 
...
example, the first table row. Then we use deleteCell() to delete cells from 
index position 0:</p>
<div class="example_code notranslate">
var firstRow = document.getElementById(&quot;myTable&quot;).rows[0];<br>
	firstRow.deleteCell(0);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tr_deletecell4">Try it yourself &raquo;</a>
</div>
<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tr_insertcell">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_tablerow_deletecell.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_tablerow_deletecell.asp#top" target="_top">TOP</a> |
		<a href="met_tablerow_deletecell.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
