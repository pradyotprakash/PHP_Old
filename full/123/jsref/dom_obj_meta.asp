...
<html lang="en-US">
<head>
<title>HTML DOM Meta Object</title>
<style>a.menu_dom_obj_meta{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Meta</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_link.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_object.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Meta Object</h2>
<p>The Meta object represents an HTML meta element.</p>
<p>&lt;meta&gt; tags must be placed inside the head section of an HTML document, and 
they provide metadata about the HTML document.</p>
<p>Meta elements are typically used to specify page description, keywords, 
author of the document, last modified, and other metadata. Metadata can be used 
by browsers (e.g. how to display content or reload pages), search engines (e.g. 
keywords), or other web services.</p>


<hr>

<h2>Meta Object Properties</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_meta_content.asp">content</a></td>
    <td>Sets or returns the value of the content attribute of a meta element</td>
  </tr>
  <tr>
    <td><a href="prop_meta_httpequiv.asp">httpEquiv</a></td>
    <td>Sets or returns an HTTP header for the information in the content 
	attribute</td>
  </tr>
  <tr>
    <td><a href="prop_meta_name.asp">name</a></td>
    <td>Sets or returns a name for the information in the content attribute</td>
  </tr>
  <tr>
    <td>scheme</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns how the value of content should be interpreted</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Meta object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_meta.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_meta.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_meta.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
