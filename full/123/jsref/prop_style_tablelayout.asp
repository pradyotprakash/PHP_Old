...
<title>HTML DOM Style tableLayout Property</title>
<style>a.menu_prop_style_tablelayout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">tableLayout</span> Property</h1>
...
<p>Set a fixed table layout:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myTable&quot;).style.tableLayout=&quot;fixed&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_tablelayout">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The tableLayout property sets or returns the way to lay out table cells, rows, and columns.</p>
<hr>
...
<p>The tableLayout property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the tableLayout property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.tableLayout
</div></div>
<p>Set the tableLayout property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.tableLayout=&quot;automatic|fixed|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>auto</td>
		<td>Column width is set by the widest unbreakable content. This is default.
		<ul><li>This layout is sometimes slow since it needs to access all the content before the table can be fully displayed</li></ul>
		</td>
	</tr>
	<tr>
		<td>fixed</td>
		<td>Column width is set by the width of table and columns (not the content of the cells)
		<ul><li>Fixed is faster than auto layout, because the user agent can begin to display the table once the first row has been received</li></ul>
		</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the tableLayout property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the table layout algorithm used for a table</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS2</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the table layout:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myTable&quot;).style.tableLayout);
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_tablelayout2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_tab_table-layout.asp">table-layout 
property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_tablelayout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_tablelayout.asp#top" target="_top">TOP</a> |
		<a href="prop_style_tablelayout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
