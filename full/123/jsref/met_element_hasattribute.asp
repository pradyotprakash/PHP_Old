...
<title>HTML DOM hasAttribute() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_element_hasattribute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">hasAttribute()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Check if the button element has an onclick attribute:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_element_hasattribute" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<h2>Definition and Usage</h2>
<p>The hasAttribute() method returns <em>true</em> if the specified attribute exists, otherwise it returns <em>false</em>.</p>
<hr/>
...
<p>The hasAttribute() method is supported in all major browsers.</p>
<p>Internet Explorer 8 and earlier does not support this method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>element</em>.hasAttribute(<em>attributename</em>)</div></div>
<h2>Parameters</h2>
...
<td>String</td>
<td>Required. The name of the attribute you want to check if exists</td>
</tr>
</table>
...
<tr>
<td>Boolean</td>
<td><em>true</em> if the element has attributes, otherwise <em>false</em></td>
</tr>
</table>
...
<tr>
	...
	<td>Core Level 2 Element Object</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_hasattribute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_hasattribute.asp#top" target="_top">TOP</a> |
		<a href="met_element_hasattribute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
