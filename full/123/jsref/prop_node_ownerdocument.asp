...
<title>HTML DOM ownerDocument Property</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_prop_node_ownerdocument{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">ownerDocument</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the ownerDocument of an element:</p>
<div class="example_code notranslate">
	document.getElementById("demo").ownerDocument;</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_ownerdocument" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ownerDocument property returns the owner document of a node, as a Document object.</p>
<p>In HTML, the HTML document itself is always the ownerDocument of an element.</p>
<p>Read more about the Document object in our <a href="dom_obj_document.asp">Document object reference</a>.</p>
...
<p>The ownerDocument property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>node</em>.ownerDocument</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The owner document of the node, as a Document object</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_ownerdocument.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_ownerdocument.asp#top" target="_top">TOP</a> |
		<a href="prop_node_ownerdocument.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
