...
<title>HTML DOM Style pageBreakAfter Property</title>
<style>a.menu_prop_style_pagebreakafter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">pageBreakAfter</span> Property</h1>
...
<p>Always set a page break after each &lt;p&gt; element with id=&quot;footer&quot;:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;footer&quot;).style.pageBreakAfter=&quot;always&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="tryjsref_style_pagebreakafter.htm">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The pageBreakAfter property sets or returns the page-break behavior after an element (for printing or print preview).</p>
<p><b>Note:</b> The pageBreakAfter property has no effect on absolutely positioned elements. 
...
<p>The pageBreakAfter property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the pageBreakAfter property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.pageBreakAfter
</div></div>
<p>Set the pageBreakAfter property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.pageBreakAfter=&quot;auto|always|avoid|emptystring|left|right|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>auto</td>
		<td>Insert a page break after the element if necessary. This is default</td>
	</tr>
	<tr>
		<td>always</td>
	...
	<tr>
		<td>&quot;&quot; (empty string)</td>
		<td>Page break is not inserted after the element</td>
	</tr>
	<tr>
		<td>left</td>
		<td>Insert one or two page breaks after the element, so the next page is 
	...
	<tr>
		<td>inherit</td>
		<td>The value of the pageBreakAfter property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the page-break behavior after an element when 
	printing</td>
</tr>
<tr>
	<th>CSS Version</th>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/pr_print_pageba.asp">page-break-after property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_pagebreakafter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_pagebreakafter.asp#top" target="_top">TOP</a> |
		<a href="prop_style_pagebreakafter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
