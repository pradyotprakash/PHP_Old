...
<style>a.menu_jsref_getutcminutes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">getUTCMinutes()</span> Method</h1>
...
<p>Return the minutes, according to universal time:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutcminutes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<p>The getUTCMinutes() method returns the minutes (from 0 to 59) of the 
...
<p>The getUTCMinutes() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.getUTCMinutes()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>Number</td>
<td>A Number, from 0-59, representing the minutes</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the UTC minutes from a specific date and time:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutcminutes2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="tryit_ex">
<img src="http://www.w3schools.com/images/tryitimg.gif" style="width:40px;height:46px" alt="Examples">
<p><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_datetime_utc">Display the UTC time</a><br>
How to use getUTCHours(), getUTCMinutes(), and getUTCSeconds() to display the universal time.</p>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_getutcminutes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_getutcminutes.asp#top" target="_top">TOP</a> |
		<a href="jsref_getutcminutes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
