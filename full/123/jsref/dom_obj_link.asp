...
<html lang="en-US">
<head>
<title>HTML DOM Link Object</title>
<style>a.menu_dom_obj_link{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Link</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_text.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_meta.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Link Object</h2>
<p>The Link object represents an HTML link element.</p>
<p>The link element must be placed inside the head section of an HTML document, 
and it specifies a link to an external resource.</p>
<p>A common use of the &lt;link&gt; tag is to link to external style sheets.</p>


<hr>

<h2>Link Object Properties</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>charset</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns the character encoding of a linked document</td>
  </tr>
  <tr>
    <td><a href="prop_link_href.asp">href</a></td>
    <td>Sets or returns the URL of a linked document</td>
  </tr>
  <tr>
    <td><a href="prop_link_hreflang.asp">hreflang</a></td>
    <td>Sets or returns the language code of the linked document</td>
  </tr>
  <tr>
    <td><a href="prop_link_media.asp">media</a></td>
    <td>Sets or returns the media type for the link element</td>
  </tr>
  <tr>
    <td><a href="prop_link_rel.asp">rel</a></td>
    <td>Sets or returns the relationship between the current 
	document and the linked document</td>
  </tr>
  <tr>
    <td>rev</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns the reverse relationship from the linked document to 
	the current document</td>
  </tr>
  <tr>
    <td><a href="prop_link_type.asp">type</a></td>
    <td>Sets or returns the content type of the linked document</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Link object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_link.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_link.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_link.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
