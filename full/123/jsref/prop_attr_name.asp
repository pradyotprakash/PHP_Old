...
<style>a.menu_prop_attr_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">name</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the name of an attribute:</p>
<div class="example_code notranslate">
	document.getElementsByTagName("button")[0].attributes[0].name;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
	onclick
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_attr_name" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The name property returns the name of the attribute.</p>
<hr>
...
<em>attribute</em>.name</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A String, representing the name of the attribute</td>
</tr>
<tr>
	<th>DOM Version</th>
	<td>Core Level 1</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_attr_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_attr_name.asp#top" target="_top">TOP</a> |
		<a href="prop_attr_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
