...
<title>HTML DOM Reset Object</title>
<style>a.menu_dom_obj_reset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Reset</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_radio.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_submit.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Reset Object</h2>
<p>The Reset object represents a reset button in an HTML form.</p>
<p>Clicking on a reset button resets all controls within the form to their 
default values.</p>
<p>For each &lt;input type=&quot;reset&quot;&gt; tag in an HTML form, a Reset object is created.</p>
<p>You can access a reset button by searching through the elements[] array of the form, or by using document.getElementById().</p>
<p><b>Tip:</b> Clicking on a reset button fires the onreset event!</p>
<hr>

<h2>Reset Object Properties</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_reset_disabled.asp">disabled</a></td>
    <td>Sets or returns whether the reset button is disabled, or not</td>
    </tr>  
  <tr>
    <td><a href="prop_reset_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the reset button</td>
  </tr>
  <tr>
    <td><a href="prop_reset_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of a reset button</td>
  </tr>
  <tr>
    <td><a href="prop_reset_type.asp">type</a></td>
    <td>Returns which type of form element the reset button is</td>
  </tr>
  <tr>
    <td><a href="prop_reset_value.asp">value</a></td>
    <td>Sets or returns the value of the value attribute of the reset button</td>
  </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Reset object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_radio.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_submit.asp">Next Reference &raquo;</a></div>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_reset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_reset.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_reset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
