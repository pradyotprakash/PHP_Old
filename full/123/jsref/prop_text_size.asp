...
<title>HTML DOM Text size Property</title>
<style>a.menu_prop_text_size{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Text <span class="color_h1">size</span> Property</h1>
...
<p>Return the width of a text field:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myText&quot;).size;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">30</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_text_size">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The size property sets or returns the value of the size attribute of a text 
field.</p>
<p>The size attribute specifies the width of a text field (in number of 
characters).</p>
<p>The default value is 20.</p>
<p><strong>Tip:</strong> To set or return the maximum number of characters 
allowed in the password field, use the <a href="prop_text_maxlength.asp">
...
<div class="code notranslate"><div>
	<em>textObject</em>.size
</div></div>
<p>Set the size property:</p>
<div class="code notranslate"><div>
	<em>textObject</em>.size=<i>number</i>
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><em>number</em></td>
		<td>
		Specifies the width of the text field, in characters. Default value 
		is 20</td>
	</tr>
</table>
<h2>Return Value</h2>
...
<tr>
<td>Number</td>
<td>The value of the size attribute of the text field</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set the width of a text field:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myText&quot;).size=50;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_text_size2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_text_size.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_text_size.asp#top" target="_top">TOP</a> |
		<a href="prop_text_size.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
