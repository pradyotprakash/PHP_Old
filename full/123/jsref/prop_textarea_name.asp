...
<title>HTML DOM Textarea name Property</title>
<style>a.menu_prop_textarea_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Textarea <span class="color_h1">name</span> Property</h1>
...
<p>Return the value of the name attribute of a text area:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myTextarea&quot;).name;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">comment</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_textarea_name">Try it yourself &raquo;</a>
</div>
<hr>
...
text area.</p>
<p>The name attribute is used to reference elements in a JavaScript, or to reference form data after a form is submitted.</p>
<hr>
...
<div class="code notranslate"><div>
	<em>textareaObject</em>.name
</div></div>
<p>Set the name property:</p>
<div class="code notranslate"><div>
	<em>textareaObject</em>.name=<i>text</i></div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><i>text</i></td>
		<td>Specifies the name of the text area</td>
	</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>The value of the name attribute of the text area</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the value of the name attribute of a text area:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myTextarea&quot;).name=&quot;newTxtName&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_textarea_name2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_textarea_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_textarea_name.asp#top" target="_top">TOP</a> |
		<a href="prop_textarea_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
