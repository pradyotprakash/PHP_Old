...
<title>RegExp \f Metacharacter</title>
<style>a.menu_jsref_regexp_formfeed{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript RegExp <span class="color_h1">\f</span> Metacharacter</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_f" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The \f metacharacter is used to find a form feed character.</p>
<p>\f returns the position where the form feed character was found. If no 
...
<p>The \f metacharacter is supported in all major browsers.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_regexp_formfeed.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_regexp_formfeed.asp#top" target="_top">TOP</a> |
		<a href="jsref_regexp_formfeed.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
