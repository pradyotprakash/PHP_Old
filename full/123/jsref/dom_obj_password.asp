...
<html lang="en-US">
<head>
<title>HTML DOM Password Object</title>
<style>a.menu_dom_obj_password{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Password</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_hidden.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_radio.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Password Object</h2>
<p>The Password object represents a single-line password field in an HTML form.</p>
<p>The content of a password field will be masked (appear as blobs or asterisks) 
in a browser.</p>
<p>For each &lt;input type=&quot;password&quot;&gt; tag in an HTML form, a Password object is created.</p>
<p>You can access a password field by searching through the elements[] array of the form, or by using document.getElementById().</p>

<hr>

<h2>Password Object Properties</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_password_defaultvalue.asp">defaultValue</a></td>
    <td>Sets or returns the default value of a password field</td>
  </tr>
  <tr>
    <td><a href="prop_password_disabled.asp">disabled</a></td>
    <td>Sets or returns whether the password field is disabled, or not</td>
    </tr>

  <tr>
    <td><a href="prop_password_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the password field</td>
  </tr>
  <tr>
    <td><a href="prop_password_maxlength.asp">maxLength</a></td>
    <td>Sets or returns the value of the maxlength attribute of a password field</td>
  </tr>
  <tr>
    <td><a href="prop_password_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of a password field</td>
  </tr>
  <tr>
    <td><a href="prop_password_readonly.asp">readOnly</a></td>
    <td>Sets or returns whether a password field is read-only, or not</td>
  </tr>
  <tr>
    <td><a href="prop_password_size.asp">size</a></td>
    <td>Sets or returns the value of the size attribute of a password field</td>
  </tr>
  <tr>
    <td><a href="prop_password_type.asp">type</a></td>
    <td>Returns which type of form element a password field is</td>
  </tr>
  <tr>
    <td><a href="prop_password_value.asp">value</a></td>
    <td>Sets or returns the value of the value attribute of the password field</td>
  </tr>
  </table>

<h2>Password Object Methods</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_password_select.asp">select()</a></td>
    <td>Selects the content of a password field</td>
    </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Password object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_hidden.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_radio.asp">Next Reference &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_password.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_password.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_password.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
