...
<style>a.menu_event_onmouseup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">onmouseup</span> Event</h1>
...
<p>Execute a JavaScript when releasing a mouse button over a paragraph:</p>
<div class="example_code notranslate">
&lt;p onmouseup=&quot;mouseUp()&quot;&gt;Click the text!&lt;/p&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onmousedown">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onmouseup event occurs when a user releases a mouse button over an element.</p>
<p><b>Tip:</b> The order of events related to the onmouseup event (for the left/middle mouse button):</p>
<ol>
	<li>onmousedown</li>
	<li>onmouseup</li>
	<li>onclick</li>
</ol>
<p>The order of events related to the onmouseup event (for the right mouse button):</p>
<ol>
	<li>onmousedown</li>
	<li>onmouseup</li>
	<li>oncontextmenu</li>
...
&lt;<i>element</i>
onmouseup=&quot;<i>SomeJavaScriptCode</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>object</em>.onmouseup=function(){<i>SomeJavaScriptCode</i>};</div></div>
<br>
...
onmouseup event is supported in all major browsers.</p>
<hr>

<h2>onmouseup In HTML</h2>
<p>The onmouseup attribute can be used within ALL HTML elements, EXCEPT: &lt;base&gt;, &lt;bdo&gt;, &lt;br&gt;, 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_onmouseup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_onmouseup.asp#top" target="_top">TOP</a> |
		<a href="event_onmouseup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
