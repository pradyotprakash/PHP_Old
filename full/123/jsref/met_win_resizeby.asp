...
<style>a.menu_met_win_resizeby{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">resizeBy()</span> Method</h1>
...
<p>Open a new window, and resize the width and height 250px relative to its 
current position:</p>
<div class="example_code notranslate">
	function openWin()<br>{<br>myWindow = window.open(&quot;&quot;,&quot;&quot;,&quot;width=100,height=100&quot;); 
	// Opens a new window<br>}<br><br>function resizeWin()<br>{<br>myWindow.resizeBy(250,250);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Resizes the new window<br>
	myWindow.focus();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Assures that the new window gets focus<br>}<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_resizeby" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The resizeBy() method resizes a window by the specified amount, relative to 
its current size.</p>
<p><b>Note:</b> This method moves the bottom right corner of the window by the 
specified number of pixels defined. The top left corner will not be moved (it 
stays in its original coordinates).</p>
<p><strong>Related methods:</strong></p>
<ul>
	<li><a href="met_win_resizeto.asp">resizeTo()</a> - Resizes the window to 
	the specified width and height</li>
	<li><a href="met_win_moveby.asp">moveBy()</a> - Moves a window relative to 
	its current position</li>
	<li><a href="met_win_moveto.asp">moveTo()</a> - Moves a window to the 
...
<p>The resizeBy() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
resizeBy(<i>width,height</i>)</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>width</em></td>
    <td>Required. A positive or a negative number that specifies how many pixels to resize the width by</td>
  </tr>
  <tr>
    <td><em>height</em></td>
    <td>Required. A positive or a negative number that specifies how many pixels to resize the 
	height by</td>
  </tr>
</table>
<h2>Return Value</h2>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Open a new window, and decrease the width by 50px and increase the height by 
50px:</p>
<div class="example_code notranslate">
	myWindow.resizeBy(-50,50);</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_resizeby2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Using the resizeBy() method together with resizeTo():</p>
	<div class="example_code notranslate">
		function resizeWinTo()<br>{<br>myWindow.resizeTo(800,600);<br>
		myWindow.focus();<br>}<br><br>function resizeWinBy()<br>{<br>
		myWindow.resizeBy(-100,-50);<br>myWindow.focus();<br>}<br>
</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_resizeby_resizeto" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Resize the topmost browser window with 100px each way:</p>
	<div class="example_code notranslate">
		top.resizeBy(100,100);<br>
</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_resizeby4" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_resizeby.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_resizeby.asp#top" target="_top">TOP</a> |
		<a href="met_win_resizeby.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
