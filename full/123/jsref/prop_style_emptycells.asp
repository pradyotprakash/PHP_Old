...
<title>HTML DOM Style emptyCells Property</title>
<style>a.menu_prop_style_emptycells{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">emptyCells</span> Property</h1>
...
<p>Change how empty cells are shown:</p>
<div class="example_code notranslate">
function show()<br>
{<br>
document.getElementById(&quot;myTable&quot;).style.emptyCells=&quot;show&quot;;<br>
}<br>
function hide()<br>
{<br>
document.getElementById(&quot;myTable&quot;).style.emptyCells=&quot;hide&quot;;<br>
}</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_emptycells">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The emptyCells property sets or returns whether to show the border and 
background of empty cells, or not.</p>
<hr>
...
<p>The emptyCells property is supported in all major browsers.</p>
<p><b>Note:</b> The default value is different in different browsers. In IE, 
Chrome and Safari, the default value is &quot;show&quot;, while in Firefox and Opera the default value is &quot;hide&quot;.</p>
<p><b>Note:</b> The emptyCells property is not supported in IE7 and earlier. IE8 
requires a !DOCTYPE. IE9 supports it.</p>
<hr>

<h2>Syntax</h2>
<p>Return the emptyCells property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.emptyCells
</div></div>
<p>Set the emptyCells property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.emptyCells=&quot;show|hide|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>show</td>
		<td>Border and background are shown in empty cells. This is default</td>
	</tr>
	<tr>
		<td>hide</td>
		<td>Border and background are hidden in empty cells</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the emptyCells property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the border and background of empty cells</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS2</td>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_emptycells2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_tab_empty-cells.asp">empty-cells property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_emptycells.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_emptycells.asp#top" target="_top">TOP</a> |
		<a href="prop_style_emptycells.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
