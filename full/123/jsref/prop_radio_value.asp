...
<title>HTML DOM Radio value Property</title>
<style>a.menu_prop_radio_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Radio <span class="color_h1">value</span> Property</h1>
...
<p>Return the value of the value attribute of a radio button:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myRadio&quot;).value;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">red</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_radio_value">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The value property sets or returns the value of the value attribute of the radio button.</p>
<p>For radio buttons, the contents of the value property do not appear in the 
...
button is not checked, no information is sent).</p>
<p><b>Tip:</b> Define different values for radio buttons in the same group, to 
identify (on the server side) which one was checked.</p>
<hr>
...
<div class="code notranslate"><div>
	<em>radioObject</em>.value
</div></div>
<p>Set the value property:</p>
<div class="code notranslate"><div>
	<em>radioObject</em>.value=<i>text</i></div></div>
<br>
...
<tr>
<td>String</td>
<td>The value of the value attribute of the radio button</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example </h2>
<p>Change the value of the value attribute of a radio button:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myRadio&quot;).value=&quot;newRadioValue&quot;;
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_radio_value2">Try it yourself &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example </h2>
<p>Using radio buttons together with a text input field to display the value of the selected radio button:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;result&quot;).value=browser;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_radio_value3">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_radio_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_radio_value.asp#top" target="_top">TOP</a> |
		<a href="prop_radio_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
