...
<title>HTML DOM getElementsByName() Method</title>
<style>a.menu_met_doc_getelementsbyname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">getElementsByName()</span> Method</h1>
...
<p>The getElementsByName() method accesses all elements with the specified name.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
document.getElementsByName(<i>name</i>)</div></div>
<br>
<table class="reference notranslate">
    ...
    <tr>
    <td><i>name</i></td>
    <td>Required. The name of the element you want to access/manipulate</td>
    </tr>
    </table>
<br>
<hr>
...
<p>The getElementsByName() method is supported in all major browsers.</p>
<hr>

<h2>Example</h2>
<div class="example">
<h2 class="example">Example</h2>
<p>Alert the number of elements with a specific name:</p>
<div class="example_code notranslate">
&lt;script&gt;<br>
	<br>var x=document.getElementsByName(&quot;x&quot;);<br>
	alert(x.length);<br>
	<br>
&lt;/script&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_doc_getelementsbyname" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_document.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Document Object Reference" /> Document Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_doc_getelementsbyname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_doc_getelementsbyname.asp#top" target="_top">TOP</a> |
		<a href="met_doc_getelementsbyname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
