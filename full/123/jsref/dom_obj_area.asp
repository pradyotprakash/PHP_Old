...
<html lang="en-US">
<head>
<title>HTML DOM Area Object</title>
<style>a.menu_dom_obj_area{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Area</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_anchor.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_base.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Area Object</h2>
<p>The Area object represents an area inside an HTML image-map (an image-map is an image with clickable 
areas).</p>
<p>For each &lt;area&gt; tag in an HTML document, an Area object is created.</p>

<hr>

<h2>Area Object Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_area_alt.asp">alt</a></td>
    <td>Sets or returns the value of the alt attribute of an area</td>
  </tr>
  <tr>
    <td><a href="prop_area_coords.asp">coords</a></td>
    <td>Sets or returns the value of the coords attribute of an area</td>
  </tr>
  <tr>
    <td><a href="prop_area_hash.asp">hash</a></td>
    <td>Sets or returns the anchor part of the href attribute value</td>
  </tr>
  <tr>
    <td><a href="prop_area_host.asp">host</a></td>
    <td>Sets or returns the hostname:port part of the href attribute value</td>
  </tr>
  <tr>
    <td><a href="prop_area_hostname.asp">hostname</a></td>
    <td>Sets or returns the hostname part of the href attribute value</td>
  </tr>
  <tr>
    <td><a href="prop_area_href.asp">href</a></td>
    <td>Sets or returns the value of the href attribute of an area</td>
  </tr>
  <tr>
    <td>noHref</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns the value of the nohref attribute of an area</td>
  </tr>
  <tr>
    <td><a href="prop_area_pathname.asp">pathname</a></td>
    <td>Sets or returns the pathname part of the href attribute value</td>
  </tr>
  <tr>
    <td><a href="prop_area_port.asp">port</a></td>
    <td>Sets or returns the port part of the href attribute value</td>
  </tr>
  <tr>
    <td><a href="prop_area_protocol.asp">protocol</a></td>
    <td>Sets or returns the protocol part of the href attribute value</td>
  </tr>
  <tr>
    <td><a href="prop_area_search.asp">search</a></td>
    <td>Sets or returns the querystring part of the href attribute value</td>
  </tr>
  <tr>
    <td><a href="prop_area_shape.asp">shape</a></td>
    <td>Sets or returns the value of the shape attribute of an area</td>
  </tr>
  <tr>
    <td><a href="prop_area_target.asp">target</a></td>
    <td>Sets or returns the value of the target attribute of an area</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Area object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_area.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_area.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_area.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
