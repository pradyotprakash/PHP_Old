...
<style>a.menu_jsref_unshift{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Array <span class="color_h1">unshift()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_unshift" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The unshift() method adds new items to the beginning of an array, and returns the new length.</p>
<p><b>Note:</b> This method changes the length of an array.</p>
<p><b>Tip:</b> To add new items at the end of an array, use the <a href="jsref_push.asp">push()</a> method.</p>
<hr>
...
<p>The unshift() method is supported in all major browsers.</p>
<p><strong>Note:</strong> The unshift() method returns <em>undefined</em> in Internet Explorer 8 and earlier.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>array</i>.unshift(<em>item1</em>,<em>item2</em>, ..., <em>itemX</em>)</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_unshift.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_unshift.asp#top" target="_top">TOP</a> |
		<a href="jsref_unshift.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
