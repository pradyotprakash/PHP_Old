...
<title>Window pageXOffset and pageYOffset Property</title>
<style>a.menu_prop_win_pagexoffset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">pageXOffset</span> and <span class="color_h1">pageYOffset</span> Properties</h1>
...
<p>Scroll the content by 100 pixels, and alert the pageXOffset and pageYOffset:</p>
<div class="example_code notranslate">
	window.scrollBy(100,100);<br>
	alert(&quot;pageXOffset: &quot; + window.pageXOffset + &quot;, pageYOffset: &quot; + window.pageYOffset);<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_pagexoffset">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pageXOffset and pageYOffset properties returns the pixels the current 
document has been scrolled from the upper left corner of the window, 
horizontally and vertically.</p>
<p>The pageXOffset and pageYOffset properties are equal to the scrollX and 
scrollY properties.</p>
<hr>
...
<p>The pageXOffset and pageYOffset properties are supported in all major browsers.</p>
<p><b>Note:</b> IE 8 and earlier does not support this property, but may use &quot;document.body.scrollLeft&quot; and &quot;document.body.scrollTop&quot; instead.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.pageXOffset<br>
window.pageYOffset</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The number of pixels that the document has already been 
	scrolled from the upper left corner of the window, horizontally and 
	vertically</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_win_pagexoffset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_win_pagexoffset.asp#top" target="_top">TOP</a> |
		<a href="prop_win_pagexoffset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
