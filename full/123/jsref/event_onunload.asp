...
<style>a.menu_event_onunload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Execute a JavaScript when a user unloads the document:</p>
<div class="example_code notranslate">
  
    &lt;body onunload=&quot;myFunction()&quot;&gt;
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onunload">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onunload event occurs once a page has unloaded (or the browser window has 
been closed).</p>
<p>onunload occurs when the user navigates away from the page (by clicking on a 
link, submitting a form, closing the browser window, etc.)</p>
<p><b>Note:</b> The onunload event is also triggered when a user reloads the 
page 
(+ the <a href="event_onload.asp">onload</a> event).</p>
<h2>Syntax</h2>
<p>In HTML:</p>
<div class="code notranslate"><div>
&lt;body
onunload=&quot;<i>SomeJavaScriptCode</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	window.onunload=function(){<i>SomeJavaScriptCode</i>};</div></div>
<br>
...
<p>The onunload event is supported in IE, Firefox, and Safari, but not supported properly in Chrome or Opera.</p>
<hr>

<h2>onunload is Supported by the Following HTML Tags:</h2>
<div class="code notranslate"><div>
&lt;body&gt;, &lt;frameset&gt;
</div>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_onunload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_onunload.asp#top" target="_top">TOP</a> |
		<a href="event_onunload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
