...
<title>Window createPopup() Method</title>
<style>a.menu_met_win_createpopup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">createPopup()</span> Method</h1>
...
<p>Create a pop-up window:</p>
<div class="example_code notranslate">
function show_popup()<br>
{<br>
var p = window.createPopup()<br>
var pbody = p.document.body<br>
pbody.style.backgroundColor = &quot;lime&quot;<br>
pbody.style.border = &quot;solid black 1px&quot;<br>
pbody.innerHTML = &quot;This is a pop-up! Click outside to close.&quot;<br>
p.show(150,150,200,50,document.body)<br>
}</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_window_popup" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The createPopup() method is used to create a pop-up window.</p>
<hr>
...
<p><b>Note:</b> The createPopup() method is an IE-only method, and does not work 
in other browsers!</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.createPopup()</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The created popup window</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_createpopup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_createpopup.asp#top" target="_top">TOP</a> |
		<a href="met_win_createpopup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
