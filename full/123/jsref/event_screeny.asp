...
<title>screenY Event Attribute</title>
<style>a.menu_event_screeny{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">screenY</span> Event Attribute</h1>
...
<p>The screenY event attribute returns the vertical coordinate (according to the 
...
<p>The following example alerts the coordinates of the mouse pointer when the mouse button was clicked:</p>
...
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;var x=event.screenX<br>
&nbsp;&nbsp;var y=event.screenY<br>
...
the x and y coordinates of the cursor.&lt;/p&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_event_screenxy" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_screeny.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_screeny.asp#top" target="_top">TOP</a> |
		<a href="event_screeny.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
