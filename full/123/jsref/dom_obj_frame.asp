...
<html lang="en-US">
<head>
<title>HTML DOM IFrame Objects</title>
<style>a.menu_dom_obj_frame{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">IFrame</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_form.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_image.asp">Next Reference &raquo;</a></div>
</div>

<hr>

<h2>IFrame Object</h2>
<p>The IFrame object represents an HTML iframe.</p>
<p>The &lt;iframe&gt; tag defines an inline frame that contains another document.</p>

<p>For each &lt;iframe&gt; tag in an HTML document, an IFrame object is created.</p>

<hr>

<h2>IFrame Object Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
	...
	style.cssFloat instead.</span> <br>Sets or returns the value of the align attribute in an iframe</td>
  </tr>
  <tr>
    <td><a href="prop_frame_contentdocument.asp">contentDocument</a></td>
    <td>Returns the document object generated by an iframe</td>
  </tr>
  <tr>
    <td><a href="prop_frame_contentwindow.asp">contentWindow</a></td>
    <td>Returns the window object generated by an iframe</td>
  </tr>
  <tr>
    <td>frameBorder</td>
    <td><span class="deprecated">Not supported in HTML5. Use
	style.border instead.</span> <br>Sets or returns the value of the frameborder attribute in an iframe</td>
  </tr>
  <tr>
    <td><a href="prop_iframe_height.asp">height</a></td>
    <td>Sets or returns the value of the height attribute in an iframe</td>
  </tr>
  <tr>
    <td>longDesc</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns the value of the longdesc attribute in an iframe</td>
  </tr>
  <tr>
    <td>marginHeight</td>
    <td><span class="deprecated">Not supported in HTML5. Use style.margin instead.</span> <br>Sets or returns the value of the marginheight attribute in an iframe</td>
  </tr>
  <tr>
    <td>marginWidth</td>
    <td><span class="deprecated">Not supported in HTML5. Use style.margin 
	instead.</span> <br>Sets or returns the value of the marginwidth attribute in an iframe</td>
  </tr>
  <tr>
    <td><a href="prop_frame_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute in an iframe</td>
  </tr>
  <tr>
    <td>scrolling</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns the value of the scrolling attribute in an iframe</td>
  </tr>
  <tr>
    <td><a href="prop_frame_src.asp">src</a></td>
    <td>Sets or returns the value of the src attribute in an iframe</td>
  </tr>
	<tr>
    <td><a href="prop_iframe_width.asp">width</a></td>
    <td>Sets or returns the value of the width attribute in an iframe</td>
  </tr>
</table>

<!--
<h2>IFrame Object Events</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="event_frame_onload.asp">onload</a></td>
    <td>Script to be run immediately after an iframe is loaded</td>
  </tr>
</table>
-->

<h2>Standard Properties and Events</h2>
<p>The IFrame object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_frame.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_frame.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_frame.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
