...
<html lang="en-US">
<head>
<title>HTML DOM Hidden Object</title>
<style>a.menu_dom_obj_hidden{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Hidden</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_fileupload.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_password.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Hidden Object</h2>
<p>The Hidden object represents a hidden input field in an HTML form (this input 
field is invisible for the user).</p>
<p>With this element you can send hidden form data to a server.</p>
<p>For each &lt;input type=&quot;hidden&quot;&gt; tag in an HTML form, a Hidden object is created.</p>
<p>You can access a hidden input field by searching through the elements[] array of the form, or by using document.getElementById().</p>

<hr>

<h2>Hidden Object Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_hidden_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the hidden input field</td>
  </tr>
  <tr>
    <td><a href="prop_hidden_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of the hidden input field</td>
  </tr>
  <tr>
    <td><a href="prop_hidden_type.asp">type</a></td>
    <td>Returns which type of form element a hidden input field is</td>
  </tr>
  <tr>
    <td><a href="prop_hidden_value.asp">value</a></td>
    <td>Sets or returns the value of the value attribute of the 
    hidden input field</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Hidden object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_hidden.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_hidden.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_hidden.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
