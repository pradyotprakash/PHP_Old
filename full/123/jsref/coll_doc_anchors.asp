...
<style>a.menu_coll_doc_anchors{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">anchors</span> Collection</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the number of anchors in the document:</p>
<div class="example_code notranslate">
	document.anchors.length;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_doc_anchors" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The anchors collection returns a collection of all the anchors in the current document.</p>
<p>The anchors collection contains anchors created with the name attribute.</p>
<p><span class="deprecated">The &lt;a&gt; name attribute is not supported in HTML5.</span></p>
<hr>
...
<p>The anchors collection is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
document.anchors</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A NodeList object, representing a collection of anchors</td>
</tr>
<tr>
	<th>DOM Version</th>
	<td>Core Level 2 Node Object</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Return the innerHTML of the first anchor in the document:</p>
<div class="example_code notranslate">
	document.anchors[0].innerHTML;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_doc_anchors2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="coll_doc_anchors.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="coll_doc_anchors.asp#top" target="_top">TOP</a> |
		<a href="coll_doc_anchors.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
