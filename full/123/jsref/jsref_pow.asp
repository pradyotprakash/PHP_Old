...
<title>JavaScript pow() Method</title>
<style>a.menu_jsref_pow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">pow()</span> Method</h1>
...
<p>Return the value of the number 4 to be the power of 3 (4*4*4):</p>
...
<div class="example_code notranslate">
64</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_pow" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pow() method returns the value of x to the power of y (x<sup>y</sup>).</p>
<hr>
...
<p>The pow() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.pow(<em>x</em>,<em>y</em>)</div></div>
...
<tr>
<td>Number</td>
<td>The value of x to the power of y (x<sup>y</sup>).</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Use the pow() method on different numbers:</p>
<div class="example_code notranslate">
var a=Math.pow(0,1);<br>
var b=Math.pow(1,1);<br>
var c=Math.pow(1,10);<br>
var d=Math.pow(3,3);<br>
var e=Math.pow(-3,3);<br>
var f=Math.pow(2,4);
</div>
<p>The result of a,b,c,d,e, and f will be:</p>
<div class="example_code notranslate">
0<br>
1<br>
1<br>
...
-27<br>
16</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_pow2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_pow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_pow.asp#top" target="_top">TOP</a> |
		<a href="jsref_pow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
