...
<h1><span class="color_h1">timeStamp</span> Event Property</h1>
...
<p>The timeStamp event property returns the number of in milliseconds since 
midnight of January 1, 1970.</p>
<p>It can be used as a time stamp of when the event was triggered.</p>
<p>Not all systems provide this information, therefore, timeStamp may be not 
available for all systems/events.</p>

<h2>Syntax</h2>

<div class="code notranslate"><div>

	<em>event</em>.timeStamp
...
<p>The following example gets the timestamp from the system start:</p>
...
&lt;body&gt;<br>
<br>
&lt;p onclick=&quot;myFunction(event)&quot;&gt;Click this paragraph. An alert<br>
box will alert the timestamp.&lt;/p&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_event_timestamp" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
