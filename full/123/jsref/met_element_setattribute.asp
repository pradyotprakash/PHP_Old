...
<title>DOM Element setAttribute() Method</title>
...
<h1>HTML DOM <span class="color_h1">setAttribute()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Set the type attribute of an input element:</p>
<div class="example_code notranslate">
	document.getElementsByTagName(&quot;INPUT&quot;)[0].setAttribute(&quot;type&quot;,&quot;button&quot;);
</div>
	<p>Before setting the attribute:</p>
<div class="example_code notranslate">
<input value="OK" />
</div>
	<p>After setting the attribute:</p>
<div class="example_code notranslate">
<input type="button" value="OK" />
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_element_setattribute" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<h2>Definition and Usage</h2>
<p>The setAttribute() method adds the specified attribute, and gives it the specified value.</p>
<p>If the specified attribute allready exists, only the value is set/changed</p>
...
<p>The setAttribute() method is supported in all major browsers.</p>
<p>Internet Explorer 8 and earlier does not support this method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>element</em>.setAttribute(<em>attributename</em>,<em>attributevalue</em>)</div></div>
<h2>Parameters</h2>
...
<td>String</td>
<td>Required. The name of the attribute you want to add</td>
</tr>
<tr>
<td><em>attributevalue</em></td>
<td>String</td>
<td>Required. The value of the attribute you want to add</td>
</tr>
</table>
