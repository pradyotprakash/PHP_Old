...
<title>JavaScript min() Method</title>
<style>a.menu_jsref_min{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">min()</span> Method</h1>
...
<div class="example_code notranslate">
5</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_min" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The min() method returns the number with the lowest value.</p>
<hr>
...
<p>The min() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.min(<em>n1</em>,<em>n2</em>,<em>n3</em>,...,nX)</div></div>
...
<tr>
<td>Number</td>
<td>The lowest number of the arguments, or <em>-Infinity</em> if no arguments are given, or <em>NaN</em> if one or more arguments are not numbers</td>
</tr>
</table>
...
<p>Return the number with the lowest value:</p>
<div class="example_code notranslate">
var a=Math.min(5,10);<br>
var b=Math.min(0,150,30,20,38);<br>
var c=Math.min(-5,10);<br>
var d=Math.min(-5,-10);<br>
...
-10<br>
1.5</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_min2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_min.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_min.asp#top" target="_top">TOP</a> |
		<a href="jsref_min.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
