...
<title>HTML DOM domain Property</title>
<style>a.menu_prop_doc_domain{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">domain</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the domain name of the server that loaded the document:</p>
<div class="example_code notranslate">
	document.domain;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_doc_domain" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The domain property returns the domain name of the server that loaded the current document.</p>
<hr>
...
<p>The domain property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
document.domain</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A string that specifies the domain name of the server that 
	loaded the current document, or null if the domain of the document cannot be 
	identified</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_doc_domain.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_doc_domain.asp#top" target="_top">TOP</a> |
		<a href="prop_doc_domain.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
