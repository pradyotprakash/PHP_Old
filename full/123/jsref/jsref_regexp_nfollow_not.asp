...
<style>a.menu_jsref_regexp_nfollow_not{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_notahead" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ?!<i>n</i> quantifier matches any string that is not followed by a specific string <i>n</i>.</p>
<p><strong>Tip:</strong> Use the <a href="jsref_regexp_nfollow.asp">?=<em>n</em></a> 
quantifier to match any string that IS followed by a specific string <em>n</em>.</p>
<hr>
...
new RegExp(&quot;<i>regexp</i>(?!<i>n)</i>&quot;)<br>
<br>
or<br>
<br>
/<i>regexp</i>(?!<i>n)</i>/
...
<div class="code notranslate"><div>
new RegExp(&quot;<i>regexp</i>(?!<i>n)</i>&quot;,&quot;g&quot;)<br>
<br>
or simply:<br>
<br>
	/\<i>regexp</i>(?!<i>n)</i>/g</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_regexp_nfollow_not.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_regexp_nfollow_not.asp#top" target="_top">TOP</a> |
		<a href="jsref_regexp_nfollow_not.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
