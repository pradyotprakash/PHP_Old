...
<title>HTML DOM tr Object</title>
<style>a.menu_dom_obj_tablerow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">tr</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_tablehead.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_textarea.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>tr Object</h2>
<p>The tr object represents an HTML table row.</p>
<p>For each &lt;tr&gt; tag in an HTML document, a tr object is created.</p>

<hr>

<h2>tr Object Collections</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="coll_tr_cells.asp">cells</a></td>
    <td>Returns a collection of all &lt;td&gt; or &lt;th&gt; elements in a table 
	row</td>
  </tr>
  </table>

<h2>tr Object Properties</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>align</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_textalign.asp">style.textAlign</a> instead.</span><br>
    Sets or returns the horizontal alignment of the content 
	within a table row. <br></td>
  </tr>
  <tr>
    <td>bgColor</td>
  ...
  <tr>
    <td>height</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_height.asp">style.height</a> instead.</span><br>
    Sets or returns the height of a table row. <br></td>
  </tr>
  <tr>
    <td><a href="prop_tablerow_rowindex.asp">rowIndex</a></td>
    <td>Returns the position of a row in the <a href="coll_table_rows.asp">rows</a> 
    collection of a table</td>
  </tr>
  <tr>
    <td><a href="prop_tablerow_sectionrowindex.asp">sectionRowIndex</a></td>
    <td>Returns the position of a row in the <a href="coll_table_rows.asp">rows</a> 
  ...
  <tr>
	...
	<a href="prop_style_verticalalign.asp">style.verticalAlign</a> instead.</span><br>
	Sets or returns the vertical alignment of the content within a 
	table row</td>
  </tr>
  </table>

<h2>tr Object Methods</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_tablerow_deletecell.asp">deleteCell()</a></td>
    <td>Deletes a cell from the current table row</td>
  </tr>
  <tr>
    <td><a href="met_tablerow_insertcell.asp">insertCell()</a></td>
    <td>Inserts a cell into the current table row</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The TR object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_tablerow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_tablerow.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_tablerow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
