...
<style>a.menu_jsref_todatestring{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">toDateString()</span> Method</h1>
...
<p>Convert today's date into a readable string:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_todatestring" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The toDateString() method converts the date (not the time) of a Date object into a readable string.</p>
<hr>
...
<p>The toDateString() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.toDateString()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_todatestring.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_todatestring.asp#top" target="_top">TOP</a> |
		<a href="jsref_todatestring.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
