...
<title>HTML DOM Table rows Collection</title>
<style>a.menu_coll_table_rows{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Table <span class="color_h1">rows</span> Collection</h1>
<p><a href="dom_obj_table.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Table Object Reference" /> Table Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Show the number of rows in a table:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myTable&quot;).rows.length;<br>
	document.getElementById(&quot;demo&quot;).innerHTML=x;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	2</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_rows" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The rows collection returns a collection of all &lt;tr&gt; elements in a table.</p>

<p><b>Note:</b> The elements in the collection are sorted as they appear in the 
source code.</p>
<p><strong>Tip:</strong> Use the <a href="met_table_insertrow.asp">insertRow()</a> 
method to create a new row (&lt;tr&gt;).</p>
<p><strong>Tip:</strong> Use the <a href="met_table_deleterow.asp">deleteRow()</a> 
method to remove a row.</p>
<p><strong>Tip:</strong> Use the <a href="met_tablerow_insertcell.asp">
insertCell()</a> method to create a new cell (&lt;td&gt;).</p>
<p><strong>Tip:</strong> Use the <a href="met_tablerow_deletecell.asp">
deleteCell()</a> method to delete a cell.</p>
<p><strong>Tip:</strong> Use the <a href="coll_table_cells.asp">cells</a> 
collection to return a collection of all &lt;tr&gt; elements in a table.</p>
<hr>
...
<p>The rows collection is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>tableObject</em>.rows</div></div>
<h2>Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of &lt;tr&gt; elements in the collection</td>
  </tr>
  </table>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>[<i>name_or_index</i>]</td>
    <td>A string or integer that specifies the element to retrieve (index starts at 0)</td>
    </tr>
  <tr>
    <td>item(<i>name_or_index</i>)</td>
    <td>Returns the element from the collection with the specified index/name/id</td>
    </tr>
  <tr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>[<em>name_or_index</em>]</p>
	<p>Alert the innerHTML of the first &lt;tr&gt; element (index 0) in the table:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myTable&quot;).rows[0].innerHTML;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_rows_index">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>item(<em>name_or_index</em>)</p>
	<p>Alert the innerHTML of the first &lt;tr&gt; element (index 0) in the table:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myTable&quot;).rows.item(0).innerHTML);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_rows_item">Try it yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>name_or_id</em>)</p>
	<p>Alert the innerHTML of the &lt;tr&gt; element with id=&quot;myRow&quot; in the table:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myTable&quot;).rows.namedItem(&quot;myRow&quot;).innerHTML);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_rows_nameditem">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myTable&quot;).rows[0].cells;<br>x[0].innerHTML=&quot;NEW 
	CONTENT&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_rows_cells">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<a href="dom_obj_table.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Table Object Reference" /> Table Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="coll_table_rows.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="coll_table_rows.asp#top" target="_top">TOP</a> |
		<a href="coll_table_rows.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
