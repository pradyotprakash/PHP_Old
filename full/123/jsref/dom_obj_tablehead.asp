...
<html lang="en-US">
<head>
<title>HTML DOM th Object</title>
<style>a.menu_dom_obj_tablehead{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">th</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_tabledata.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_tablerow.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>th Object</h2>
<p>The th object represents a table header cell in an HTML table.</p>
<p>For each &lt;th&gt; tag in an HTML table, a th object is created.</p>
<hr>

<h2>th Object Properties</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_tabledata_abbr.asp">abbr</a></td>
    <td>Sets or returns the value of the abbr attribute</td>
  </tr>
  <tr>
    <td>align</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_textalign.asp">style.textAlign</a> instead.</span><br>Sets or returns the horizontal alignment of the content in a data cell</td>
  </tr>
  <tr>
    <td>axis</td>
    <td><span class="deprecated">Not supported in HTML5.<br></span>Sets or returns a comma-separated list of related data 
	cells</td>
  </tr>
  <tr>
    <td>background</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_background.asp">
	style.background</a> instead.</span><br>Sets or returns the 
	background image of a data cell<br></td>
  </tr>
  <tr>
    <td>bgColor</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_backgroundcolor.asp">
	style.backgroundColor</a> instead.</span><br>Sets or returns the 
	background color of a table<br></td>
  </tr>
  <tr>
    <td><a href="prop_tablehead_cellindex.asp">cellIndex</a></td>
    <td>Returns the position of a cell in the cells collection of 
    a table row</td>
  </tr>
  <tr>
    <td>ch</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Sets or returns an alignment character for a data cell</td>
  </tr>
  <tr>
    <td>chOff</td>
  ...
  <tr>
    <td><a href="prop_tablehead_colspan.asp">colSpan</a></td>
    <td>Sets or returns the value of the colspan attribute</td>
  </tr>
  <tr>
    <td><a href="prop_tablehead_headers.asp">headers</a></td>
    <td>Sets or returns the value of the headers attribute</td>
  </tr>
  <tr>
    <td>height</td>
    <td><span class="deprecated">Not supported in HTML5.</span> Sets or returns the height of a 
	data cell<br>Use <a href="prop_style_height.asp">style.height</a> instead</td>
  </tr>
  <tr>
    <td>noWrap</td>
    <td><span class="deprecated">Not supported in HTML5.</span> Sets or returns whether the 
	content in a cell can be wrapped<br>Use <a href="prop_style_whitespace.asp">
	style.whiteSpace</a> instead</td>
  </tr>
  <tr>
    <td><a href="prop_tablehead_rowspan.asp">rowSpan</a></td>
    <td>Sets or returns the value of the rowspan attribute</td>
  </tr>
  <tr>
    <td>vAlign</td>
    <td><span class="deprecated">Not supported in HTML5.</span> Sets or returns the vertical alignment of the content within a 
	cell<br>Use <a href="prop_style_verticalalign.asp">style.verticalAlign</a> 
	instead</td>
  </tr>
  <tr>
    <td>width</td>
    <td><span class="deprecated">Not supported in HTML5.</span> Sets or returns the width of a 
	data cell<br>Use <a href="prop_style_width.asp">style.width</a> instead</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The th object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_tablehead.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_tablehead.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_tablehead.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
