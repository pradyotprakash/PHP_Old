...
<title>HTML DOM hasAttributes Method</title>
...
<h1>HTML DOM <span class="color_h1">hasAttributes()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">See if the body element has any attributes:</p>
<div class="example_code notranslate">
	document.body.hasAttributes()</div>
<p>The result will be:</p>
<div class="example_code notranslate">
false
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_hasattributes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The hasAttributes() method returns <em>true</em> if the specified node has any attributes, otherwise <em>false</em>.</p>
<p>If the specified node is not an Element node, the return value is always <em>false</em>.</p>
<hr/>
...
<i>node</i>.hasAttributes()</div></div>
...
<td>Boolean</td>
<td>
<em>true</em> if the node has attributes, otherwise <em>false</em></td>
</tr>
</table>
