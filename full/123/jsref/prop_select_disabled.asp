...
<title>HTML DOM Select disabled Property</title>
<style>a.menu_prop_select_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Select <span class="color_h1">disabled</span> Property</h1>
...
<p>Find out if a drop-down list is disabled or not:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;).disabled;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">true</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_disabled">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a drop-down list is disabled, or not.</p>
...
<div class="code notranslate"><div>
	<em>selectObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="code notranslate"><div>
	<em>selectObject</em>.disabled=true|false
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		...
		<td>
		Specifies whether 
		a drop-down list should be disabled or not.
		<ul>
			<li>true - The drop-down list is disabled</li>
			<li>false - Default. The drop-down list is not disabled</li>
		</ul>
		</td>
	</tr>
</table>
...
<tr>
<td>Boolean</td>
<td>Returns true if the drop-down list is disabled, otherwise it returns false</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example </h2>
<p>Disable a drop-down list:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;mySelect&quot;).disabled=true;<br>
	</div>
	<p>The result will be:</p>
<div class="example_code notranslate">
	<select disabled="disabled"><option>Cats</option><option>Dogs</option></select>
</div>

<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_disabled2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_select_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_select_disabled.asp#top" target="_top">TOP</a> |
		<a href="prop_select_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
