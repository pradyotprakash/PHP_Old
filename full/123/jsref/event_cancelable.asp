...
<style>a.menu_event_cancelable{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">cancelable</span> Event Property</h1>
...
<p>The cancelable event property returns whether or not the event is a cancelable 
event.</p>
<p>The event is cancelable if it is possible to prevent the events default 
action.</p>
...
<p>The following example checks if the triggered event is a cancelable event:</p>
...
<br>
&lt;p 
	onclick=&quot;myFunction(event)&quot;&gt;Click this paragraph.<br>
An alert box will tell if the<br>
event is a cancelable event.&lt;/p&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_event_cancelable" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_cancelable.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_cancelable.asp#top" target="_top">TOP</a> |
		<a href="event_cancelable.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
