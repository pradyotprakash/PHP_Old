...
<style>a.menu_jsref_pop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Array <span class="color_h1">pop()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_pop" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The pop() method removes the last element of an array, and returns that element.</p>
<p><b>Note:</b> This method changes the length of an array.</p>
<p><b>Tip:</b> To remove the first element of an array, use the <a href="jsref_shift.asp">shift()</a> method.</p>
<hr>
...
<p>The pop() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>array</i>.pop()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_pop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_pop.asp#top" target="_top">TOP</a> |
		<a href="jsref_pop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
