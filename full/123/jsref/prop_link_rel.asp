...
<title>HTML DOM Link rel Property</title>
<style>a.menu_prop_link_rel{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Link <span class="color_h1">rel</span> Property</h1>
<p><a href="dom_obj_link.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Link Object Reference" /> Link Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the relationship between the current document and the linked document:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myLink&quot;).rel;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	stylesheet</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_link_rel" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The rel property sets or returns a space-separated list that defines the relationship between the current 
document and the linked document.</p>
<hr>
...
<p><b>Note:</b> The value &quot;search&quot; is 
not supported in Opera or Safari.</p>
<p><b>Note:</b> The value &quot;sidebar&quot; is 
not supported in IE, Safari, or Chrome.<br>
</p>
<hr>
...
<div class="code notranslate"><div>
	<em>linkObject</em>.rel
</div></div>
<p>Set the rel property:</p>
<div class="code notranslate"><div>
	<em>linkObject</em>.rel=<i>relationship</i></div></div>
...
<table class="reference notranslate">
	...
	<tr>
		<td>alternate</td>
		<td>Linked page is an alternative version of the current 
		document</td>
	</tr>
	<tr>
		<td>appendix</td>
		<td>Linked page is the appendix page for the current 
		document</td>
	</tr>
	<tr>
		<td>chapter</td>
		<td>Refers to a chapter</td>
	</tr>
	<tr>
		<td>contents</td>
		<td>Linked page is the table of contents for the current document</td>
	</tr>
	<tr>
		<td>copyright</td>
		<td>Linked page is the copyright/policy for the current document</td>
	</tr>
	<tr>
		<td>glossary</td>
		<td>Linked page is the glossary page for the current document</td>
	</tr>
	<tr>
		<td>help</td>
		<td>Linked page is the help page for the current document</td>
	</tr>
	<tr>
		<td>index</td>
		<td>Linked page is the index page for the current document</td>
	</tr>
	<tr>
		<td>next</td>
		<td>Refers to the next page</td>
	</tr>
	<tr>
		<td>offline</td>
		<td>Refers to a location that contains a path to the CDF 
		file</td>
	</tr>
	<tr>
		<td>prev</td>
		<td>Refers to the previous page</td>
	</tr>
	<tr>
		<td>search</td>
		<td>Refers to an XML file in OpenSearch description format</td>
	</tr>
	<tr>
		<td>section</td>
	...
	<tr>
		<td>shortcut icon</td>
		<td>Refers to an icon location</td>
	</tr>
	<tr>
		<td>sidebar</td>
		<td>Refers to the bookmark panel</td>
	</tr>
	<tr>
		<td>start</td>
		<td>Refers to the first page (used 
		by search engines to show the first page)</td>
	</tr>
	<tr>
		<td>stylesheet</td>
		<td>Linked page is the style sheet for the current document</td>
	</tr>
	<tr>
		<td>subsection</td>
		<td>Linked page is a subsection for the current document</td>
	</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>A space-separated list of relationship types</td>
</tr>
</table>

<br>
<hr>
<a href="dom_obj_link.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Link Object Reference" /> Link Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_link_rel.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_link_rel.asp#top" target="_top">TOP</a> |
		<a href="prop_link_rel.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
