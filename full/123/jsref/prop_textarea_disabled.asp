...
<title>HTML DOM Textarea disabled Property</title>
<style>a.menu_prop_textarea_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Textarea <span class="color_h1">disabled</span> Property</h1>
<p><a href="dom_obj_textarea.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Textarea Object Reference" /> Textarea Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Find out if a text area is disabled, or not:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myTextarea&quot;).disabled;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">false</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_textarea_disabled">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether a text area is disabled, or not.</p>
<p>A disabled element is unusable and un-clickable. Disabled elements are usually rendered in gray by default in browsers.</p>
<hr>
...
<p>The disabled property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the disabled property:</p>
<div class="code notranslate"><div>
	<em>textareaObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="code notranslate"><div>
	<em>textareaObject</em>.disabled=true|false
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		...
		<ul>
			<li>true - The text area is disabled</li>
			<li>false - Default. The text area is not disabled</li>
		</ul>
		</td>
	</tr>
</table>
...
<tr>
<td>Boolean</td>
<td>Returns true if the text area is disabled, otherwise it returns false</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Disable a text area:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myTextarea&quot;).disabled=true;<br>
	</div>
	<p>The result will be:</p>
<div class="example_code notranslate">
	<textarea disabled="disabled" style="font-family:'Courier New', Courier, monospace">342 Alvin Road
Ducksburg</textarea>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_textarea_disabled2">Try it yourself &raquo;</a>
</div>

<br>
<div class="example">
<h2 class="example">Example</h2>
<p>Disable and undisable a text area:</p>
<div class="example_code notranslate">
	function disableTxt()<br>&nbsp; {<br>&nbsp; document.getElementById(&quot;myTextarea&quot;).disabled=true;<br>&nbsp; 
	}<br>function undisableTxt()<br>&nbsp; {<br>&nbsp; document.getElementById(&quot;myTextarea&quot;).disabled=false;<br>&nbsp; 
	}<br>
	</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_textarea_disabled3">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_textarea.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Textarea Object Reference" /> Textarea Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_textarea_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_textarea_disabled.asp#top" target="_top">TOP</a> |
		<a href="prop_textarea_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
