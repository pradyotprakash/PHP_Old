...
<title>JavaScript POSITIVE_INFINITY Property</title>
<style>a.menu_jsref_positive_infinity{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">POSITIVE_INFINITY</span> Property</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_positive_infinity" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The POSITIVE_INFINITY property represents positive infinity.</p>
<p>Positive infinity can be explained as something that is higher than any other number.</p>
<hr>

<h2>Always Use Number.POSITIVE_INFINITY</h2>
<p>POSITIVE_INFINITY a static property of the JavaScript Number object.</p>
<p>You can 
ony use it 
as Number.POSITIVE_INFINITY.</p>
<p>Using x.POSITIVE_INFINITY, where x is a number or Number object, will return 
undefined:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var x = 100;<br>x.NEGATIVE_INFINITY;</div>
<p>The value of x will be:</p>
<div class="example_code notranslate">
	undefined</div>
<br><a class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_positive_infinity_obj" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>The POSITIVE_INFINITY property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Number.POSITIVE_INFINITY;</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The numeric value: Infinity</td>
</tr>
<tr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Create a positive infinity:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_positive_infinity2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_positive_infinity.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_positive_infinity.asp#top" target="_top">TOP</a> |
		<a href="jsref_positive_infinity.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
