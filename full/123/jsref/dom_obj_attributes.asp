...
<style>a.menu_dom_obj_attributes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="dom_obj_event.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>In the HTML DOM, the <strong>NamedNodeMap object</strong> represents an unordered collection of 
an elements attribute nodes.</p>
...
<tr>
	<td><a href="prop_attr_isid.asp"><em>attr</em>.isId</a></td>
	<td>Returns <em>true</em> if the attribute is of type Id, otherwise it returns <em>false</em></td>
</tr>
<tr>
	<td><a href="prop_attr_name.asp"><em>attr</em>.name</a></td>
	<td>Returns the name of an attribute</td>
</tr>
<tr>
	<td><a href="prop_attr_value.asp"><em>attr</em>.value</a></td>
	<td>Sets or returns the value of the attribute</td>
</tr>
<tr>
	<td><a href="prop_attr_specified.asp"><em>attr</em>.specified</a></td>
	<td>Returns <em>true</em> if the attribute has been specified, otherwise it returns <em>false</em></td>
</tr>
<tr>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
...
<tr>
	<td><a href="met_namednodemap_getnameditem.asp"><em>nodemap</em>.getNamedItem()</a></td>
	<td>Returns a specified attribute node from a NamedNodeMap.</td>
</tr>
<tr>
	<td><a href="met_namednodemap_item.asp"><em>nodemap</em>.item()</a></td>
	<td>Returns the node at a specified index in a NamedNodeMap</td>
</tr>
<tr>
	<td><a href="prop_namednodemap_length.asp"><em>nodemap</em>.length</a></td>
	<td>Returns the number of nodes in a NamedNodeMap</td>
</tr>
<tr>
	<td><a href="met_namednodemap_removenameditem.asp"><em>nodemap</em>.removeNamedItem()</a></td>
	<td>Removes a specified attribute node</td>
</tr>
<tr>
	<td><a href="met_namednodemap_setnameditem.asp"><em>nodemap</em>.setNamedItem()</a></td>
...
<h2>DOM 4 Warning !!!</h2>
<p>In the W3C DOM Core, the Attr (attribute) object 
inherits all properties and methods from the Node object.</p>
<p>In DOM 4, the Attr object no longer inherits from Node.</p>
<p><strong>For future code quality, you should avoid using node object properties 
and methods on 
attribute objects:</strong></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_attributes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_attributes.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_attributes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
