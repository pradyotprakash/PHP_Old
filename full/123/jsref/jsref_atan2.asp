...
<title>JavaScript atan2() Method</title>
<style>a.menu_jsref_atan2{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">atan2()</span> Method</h1>
...
<h2>Examples </h2>
<div class="example">
<h2 class="example">Example 1 - atan2(y,x)</h2>
...
<p>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_atan2">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The atan2() method returns the arctangent of the quotient of its arguments, as a numeric value between PI and -PI radians.</p>
<p>
The number returned represents the counterclockwise angle in radians (not degrees) between the positive X axis and 
the point (x, y).</p>
<p><b>Note:</b> With atan2(), the y coordinate is passed as the first argument 
and the x coordinate is passed as the second argument.</p>
...
<p>The atan2() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.atan2(<em>y</em>,<em>x</em>)
</div></div>
<br>
...
<tr>
<td>Number</td>
<td>A Number, from PI to -PI, or NaN if the value(s) are empty</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_atan2.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_atan2.asp#top" target="_top">TOP</a> |
		<a href="jsref_atan2.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
