...
<title>HTML DOM createTextNode() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_document_createtextnode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">createTextNode()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Create a text node:</p>
<div class="example_code notranslate">
	var btn=document.createTextNode(&quot;Hello World&quot;);<br>
</div>
	<p>The result will be:</p>
<div class="example_code notranslate">
Hello World
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_createtextnode" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>HTML elements often consists of both an element node <em>and</em> a text node.</p>
<p>To create a header (H1), you must create both an "H1" element <em>and</em> a text 
node:</p>

<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Create a header:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_createtextnode2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The createTextNode() method creates a Text Node with the specified text.</p>
<hr/>
...
<p>The createTextNode() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
document.createTextNode(<em>text</em>)</div></div>
...
<td><em>text</em></td>
<td>String</td>
<td>Required. The text of the Text node</td>
</tr>
</table>
...
<tr>
<td>Text Node object</td>
<td>The created Text node</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_createtextnode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_createtextnode.asp#top" target="_top">TOP</a> |
		<a href="met_document_createtextnode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
