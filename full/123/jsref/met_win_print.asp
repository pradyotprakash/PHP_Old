...
<style>a.menu_met_win_print{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">print()</span> Method</h1>
...
<p>Print the current page:</p>
<div class="example_code notranslate">
	window.print();<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_print" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The print() method prints the contents of the current window.</p>
<p>The print() method opens the Print Dialog Box, which lets the user to select 
preferred printing options.</p>
<hr>
...
<p>The print() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.print()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_print.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_print.asp#top" target="_top">TOP</a> |
		<a href="met_win_print.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
