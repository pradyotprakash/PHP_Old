...
<title>HTML DOM Style display Property</title>
<style>a.menu_prop_style_display{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">display</span> Property</h1>
...
<p>Set a &lt;p&gt; element to not be displayed:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myP&quot;).style.display=&quot;none&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_display">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The display property sets or returns the element's display type.</p>
<p>Elements in HTML are mostly &quot;inline&quot; or &quot;block&quot; elements: An inline element 
has floating content on its left and right side. A block element fills the 
entire line, and nothing can be displayed on its left or right side.</p>
<p>The display property also allows the author to show or hide an element. It is 
similar to the <a href="prop_style_visibility.asp">visibility</a> property. However, if you set display:none, it hides 
the entire element, while visibility:hidden means that the contents of the 
element will be invisible, but the element stays in its original position and 
size.</p>
<p><b>Tip: </b>If an element is a block element, its display type can also be 
changed with the float property. </p>
<hr>
...
<p>The display property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the display property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.display
</div></div>
<p>Set the display property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.display=<i>value</i></div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>block</td>
		<td>Element is rendered as a block-level element</td>
	</tr>
	<tr>
		<td>compact</td>
		<td>Element is rendered as a block-level or inline 
		element. Depends on context</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the display property is inherited from parent element</td>
	</tr>
	<tr>
		<td>inline</td>
		<td>Element is rendered as an inline element. This is default</td>
	</tr>
	<tr>
		<td>inline-block</td>
		<td>Element is rendered as a block box inside an inline box</td>
	</tr>
	<tr>
		<td>inline-table</td>
		<td>Element is rendered as an inline table (like 
		&lt;table&gt;), with no line break before or after the table</td>
	</tr>
	<tr>
		<td>list-item</td>
		<td>Element is rendered as a list</td>
	</tr>
	<tr>
		<td>marker</td>
		<td>This value sets content before or after a box to be a 
		marker (used with :before and 
		:after pseudo-elements. Otherwise this value is identical to &quot;inline&quot;)</td>
	</tr>
	<tr>
		<td>none</td>
		<td>Element will not be displayed</td>
	</tr>
	<tr>
		<td>run-in</td>
		<td>Element is rendered as block-level or inline 
		element. Depends on context</td>
	</tr>
	<tr>
		<td>table</td>
		<td>Element is rendered as a block table (like 
		&lt;table&gt;), with a line break before and after the table</td>
	</tr>
	<tr>
		<td>table-caption</td>
		<td>Element is rendered as a table caption (like 
		&lt;caption&gt;)</td>
	</tr>
	<tr>
		<td>table-cell</td>
		<td>Element is rendered as a table cell (like 
		&lt;td&gt; and &lt;th&gt;)</td>
	</tr>
	<tr>
		<td>table-column</td>
		<td>Element is rendered as a column of cells 
		(like &lt;col&gt;)</td>
	</tr>
	<tr>
		<td>table-column-group</td>
		<td>Element is rendered as a group of one or more 
		columns (like &lt;colgroup&gt;)</td>
	</tr>
	<tr>
		<td>table-footer-group</td>
		<td>Element is rendered as a table footer 
		row (like &lt;tfoot&gt;)</td>
	</tr>
	<tr>
		<td>table-header-group</td>
		<td>Element is rendered as a table header row (like &lt;thead&gt;)</td>
	</tr>
	<tr>
		<td>table-row</td>
		<td>Element is rendered as a table row (like 
		&lt;tr&gt;)</td>
	</tr>
	<tr>
...
<tr>
	...
	<td width="80%">inline</td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A String, representing the display type of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Difference between the display property and the visibility property:</p>
<div class="example_code notranslate">
	function demoDisplay()<br>{<br>document.getElementById("myP1").style.display="none";<br>
	}<br><br>function demoVisibility()<br>{<br>document.getElementById("myP2").style.visibility="hidden";<br>
	}</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_display2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Difference between &quot;inline&quot;, &quot;block&quot; and &quot;none&quot;:</p>
<div class="example_code notranslate">
	function myFunction(x) <br>{<br>var whichSelected = x.selectedIndex;<br>var 
	sel = x.options[whichSelected].text;<br>var elem = document.getElementById(&quot;mySpan&quot;);<br>
	elem.style.display=sel;<br>}</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_display3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the display type of a &lt;p&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myP&quot;).style.display);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_display4">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="../css/css_display_visibility.asp">CSS Display and visibility</a></p>
<p>CSS reference: <a href="../cssref/pr_class_display.asp">display property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_display.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_display.asp#top" target="_top">TOP</a> |
		<a href="prop_style_display.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
