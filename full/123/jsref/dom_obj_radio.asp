...
<html lang="en-US">
<head>
<title>HTML DOM Radio Object</title>
<style>a.menu_dom_obj_radio{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Radio</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_password.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_reset.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Radio Object</h2>
<p>The Radio object represents a radio button in an HTML form.</p>
<p>Radio buttons allow the user to select only ONE of a predefined set of 
options. You define groups with the name property (radio buttons with the same 
name belong to the same group).</p>
<p>For each &lt;input type=&quot;radio&quot;&gt; tag in an HTML form, a Radio object is created.</p>
<p>You can access a radio object by searching through the elements[] array of the form, or by using document.getElementById().</p>

<hr>

<h2>Radio Object Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_radio_checked.asp">checked</a></td>
    <td>Sets or returns the checked state of a radio button</td>
  </tr>
  <tr>
    <td><a href="prop_radio_defaultchecked.asp">defaultChecked</a></td>
    <td>Returns the default value of the checked attribute</td>
  </tr>
  <tr>
    <td><a href="prop_radio_disabled.asp">disabled</a></td>
    <td>Sets or returns whether the radio button is disabled, or not</td>
    </tr>  
  <tr>
    <td><a href="prop_radio_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the radio button</td>
  </tr>
  <tr>
    <td><a href="prop_radio_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of a radio button</td>
  </tr>
  <tr>
    <td><a href="prop_radio_type.asp">type</a></td>
    <td>Returns which type of form element the radio button is</td>
  </tr>
  <tr>
    <td><a href="prop_radio_value.asp">value</a></td>
    <td>Sets or returns the value of the value attribute of the radio button</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Radio object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_radio.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_radio.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_radio.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
