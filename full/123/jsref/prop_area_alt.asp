...
<title>HTML DOM Area alt Property</title>
<style>a.menu_prop_area_alt{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Area <span class="color_h1">alt</span> Property</h1>
...
<p>Return the alternate text for a specific area in an image-map:</p>
<div class="example_code notranslate">
	var x =
	document.getElementById(&quot;venus&quot;).alt;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	A beautiful planet</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_area_alt" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The alt property sets or returns the value of the alt attribute of an area.</p>
<p>The required alt attribute specifies an alternate text for an area, if the 
...
<div class="code notranslate"><div>
	<em>areaObject</em>.alt</div></div>
<p>Set the alt property:</p>
<div class="code notranslate"><div>
	<em>areaObject</em>.alt=<i>text</i></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>text</em></td>
    <td>The alternate text for the area</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>The value of the alt attribute of the area</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the alternate text for a specific area in an image-map:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;venus&quot;).alt=&quot;The planet Venus&quot;;
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_area_alt2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_area_alt.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_area_alt.asp#top" target="_top">TOP</a> |
		<a href="prop_area_alt.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
