...
<title>HTML DOM Style quotes Property</title>
<style>a.menu_prop_style_quotes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">quotes</span> Property</h1>
...
<p>Change quotation marks:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myQ&quot;).style.quotes=&quot;'&lt;' '&gt;' '[start]' '[end]'&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_quotes">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The quotes property sets or returns the type of quotation marks for embedded 
quotations.</p>
<hr>
...
<p>The quotes property is supported in all major browsers.</p>
<p><strong>Note:</strong> IE8 supports the quotes property only if a !DOCTYPE is 
specified.</p>
<hr>

<h2>Syntax</h2>
<p>Return the quotes property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.quotes
</div></div>
<p>Set the quotes property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.quotes=&quot;none|<i>string string string string</i>|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>none</td>
		<td>Specifies that the open-quote and close-quote values will not 
		produce any quotation marks. This is default</td>
	</tr>
	<tr>
		<td><i>string string string string</i></td>
		<td>Specifies which quotation marks to use. The first two values 
		specifies the first level of quotation embedding, the next two values 
		specifies the next level of quote embedding, etc</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the quotes property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the type of quotation marks for embedded 
	quotations</td>
</tr>
<tr>
	<th>CSS Version</th>
...
<p>Return the quotes property:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myQ&quot;).style.quotes);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_quotes2">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/pr_gen_quotes.asp">quotes property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_quotes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_quotes.asp#top" target="_top">TOP</a> |
		<a href="prop_style_quotes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
