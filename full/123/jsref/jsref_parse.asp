...
<style>a.menu_jsref_parse{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Date <span class="color_h1">parse()</span> Method</h1>
...
<p>Return the number of milliseconds between January 1, 1970 and March 21, 2012:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_parse" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The parse() method parses a date string and returns the number of milliseconds 
between the date string and midnight of January 1, 1970.</p>
<hr>
...
<p>The parse() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>Date</em>.parse(<em>datestring</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>datestring</em></td>
    <td>Required. A string representing a date</td>
  </tr>
  </table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<div class="example">
<h2 class="example">Example</h2>
<p>Calculate the number of years between  January 1, 1970 to March 21, 2012:</p>
<div class="example_code notranslate">
var d=Date.parse(&quot;March 21, 2012&quot;);<br>
var minutes=1000*60;<br>
...
document.write(Math.round(d/years));
</script>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_parse2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_parse.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_parse.asp#top" target="_top">TOP</a> |
		<a href="jsref_parse.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
