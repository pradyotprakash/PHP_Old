...
<title>JavaScript Array prototype Constructor</title>
<style>a.menu_jsref_prototype_array{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Array <span class="color_h1">prototype</span> Constructor</h1>
...
<p>Make a new array method that transforms array values into upper case:</p>
<div class="example_code notranslate">
	Array.prototype.myUcase=function()<br>{<br>&nbsp; for (i=0;i&lt;this.length;i++)<br>&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp; this[i]=this[i].toUpperCase();<br>&nbsp;&nbsp;&nbsp; 
	}<br>}</div>
<p>Make an array, then call the myUcase method:</p>
<div class="example_code notranslate">
var fruits=["Banana","Orange","Apple","Mango"];<br>
fruits.myUcase();</div>
<p>The values in the <em>fruits</em> array is now:</p>
<div class="example_code notranslate">
BANANA,ORANGE,APPLE,MANGO
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_prototype_array" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The prototype constructor allows you to add new properties and methods to the Array() object.</p>
<p>When constructing a property, ALL arrays will be given the property, and it's value, as default.</p>
<p>When constructing a method, ALL arrays will have this method available.</p>
<p><b>Note:</b> Array.prototype does not refer to a single array, but to the Array() object itself.</p>
...
Array.prototype.<i>name</i>=<em>value</em>
</div></div><br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_prototype_array.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_prototype_array.asp#top" target="_top">TOP</a> |
		<a href="jsref_prototype_array.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
