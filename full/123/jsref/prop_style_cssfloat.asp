...
<title>HTML DOM Style cssFloat Property</title>
<style>a.menu_prop_style_cssfloat{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">cssFloat</span> Property</h1>
...
<p>Let an image float to the left/right of the text, when 
clicking on two buttons:</p>
<div class="example_code notranslate">
function floatRight()<br>
{<br>
document.getElementById(&quot;myImg&quot;).style.cssFloat=&quot;right&quot;;<br>
}<br>
function floatLeft()<br>
{<br>
document.getElementById(&quot;myImg&quot;).style.cssFloat=&quot;left&quot;;<br>
}</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_cssfloat">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The cssFloat property sets or returns the horizontal alignment of an element.</p>
<p><b>Note: </b>If there is too little space on a line for the floating element, 
it will jump down to the next line that has enough space.</p>
<hr>
...
<p>The cssFloat property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the cssFloat property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.cssFloat
</div></div>
<p>Set the cssFloat property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.cssFloat=&quot;left|right|none|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>none</td>
		<td>The object/element is not floated. This is default</td>
	</tr>
	<tr>
		<td>left</td>
		<td>The object/element will float to the left in the parent 
		element</td>
	</tr>
	<tr>
		<td>right</td>
		<td>The object/element will float to the right in the parent 
		element</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the cssFloat property is inherited from the 
		parent element</td>
	</tr>
</table>
...
<table class="tecspec">
<tr>
	<th style="width:20%" class="auto-style1">Default Value:</th>
	<td width="80%">none</td>
</tr>
<tr>
	<th class="auto-style1">Return Value:</th>
	<td>A String, representing the horizontal alignment of an element</td>
</tr>
<tr>
	<th class="auto-style1">DOM Version</th>
	<td>DOM Level 2</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_cssfloat.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_cssfloat.asp#top" target="_top">TOP</a> |
		<a href="prop_style_cssfloat.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
