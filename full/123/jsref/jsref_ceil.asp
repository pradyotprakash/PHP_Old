...
<title>JavaScript ceil() Method</title>
<style>a.menu_jsref_ceil{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">ceil()</span> Method</h1>
<p><a href="jsref_obj_math.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Math Object Reference" /> JavaScript Math Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Round a number upward to it's nearest integer:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_ceil" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ceil() method rounds a number UPWARDS to the nearest integer, and returns the result.</p>
<p>If the passed argument is an integer, the value will not be rounded.</p>
<hr>
...
<p>The ceil() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.ceil(<em>x</em>)</div></div>
...
<tr>
<td>Number</td>
<td>The nearest integer when rounding upwards</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Use the ceil() method on different numbers:</p>
<div class="example_code notranslate">
var a=Math.ceil(0.60);<br>
var b=Math.ceil(0.40);<br>
var c=Math.ceil(5);<br>
var d=Math.ceil(5.1);<br>
var e=Math.ceil(-5.1);<br>
var f=Math.ceil(-5.9);
</div>
<p> 
The result of a,b,c,d,e, and f will be:</p>
<div class="example_code notranslate">
1<br>
1<br>
5<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_ceil2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="jsref_obj_math.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Math Object Reference" /> JavaScript Math Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_ceil.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_ceil.asp#top" target="_top">TOP</a> |
		<a href="jsref_ceil.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
