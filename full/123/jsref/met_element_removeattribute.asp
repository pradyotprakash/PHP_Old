...
<title>HTML DOM removeAttribute() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_element_removeattribute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">removeAttribute()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Remove the style attribute from a header element:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_element_removeattribute" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<h2>Definition and Usage</h2>
<p>&nbsp;The removeAttribute() method removes the specified attribute.</p>
<p>The difference between this method and the removeAttributeNode() method is that 
the removeAttributeNode() method removes the specified Attr <em>object</em>, while 
this method removes the attribute with the specified <em>name</em>. The result 
will be the same. Also this method has no return value, while the 
removeAttributeNode() method returns the removed attribute, as an Attr object.</p>
<p>See also the <a href="met_element_removeattributenode.asp">
removeAttributeNode()</a> method</p>
<hr/>
...
<p>The removeAttribute() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>element</em>.removeAttribute(<em>attributename</em>)
</div></div>
...
<tr>
<td><em>attributename</em></td>
<td>String</td>
<td>Required. The name of the attribute you want to remove</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_removeattribute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_removeattribute.asp#top" target="_top">TOP</a> |
		<a href="met_element_removeattribute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
