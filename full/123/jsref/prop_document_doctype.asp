...
<style>a.menu_prop_document_doctype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">doctype</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the doctype object of an HTML document:</p>
<div class="example_code notranslate">
	document.doctype;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_doctype" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The doctype property returns the doctype of the HTML document, as a DocumentType object.</p>
<p>Read more about the DocumentType object in our <a href="http://www.w3schools.com/jsref/dom_obj_documenttype.asp">DocumentType object reference</a>.</p>
<p><strong>Note:</strong> If the document has no doctype specified, the return value is <em>null</em>.</p>
<hr>
...
<p>The doctype property is supported in all major browsers.</p>
<p><strong>Note:</strong> In Internet Explorer 8 and earlier, this property returns <em>null</em> for HTML and XHTML documents, and will only work for XML documents.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
document.doctype</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The document's doctype, as a DocumentType object.</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_document_doctype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_document_doctype.asp#top" target="_top">TOP</a> |
		<a href="prop_document_doctype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
