...
<style>a.menu_prop_loc_port{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Location <span class="color_h1">port</span> Property</h1>
...
<p>Return the port number of the current URL:</p>
<div class="example_code notranslate">
	var x = &quot;Port: &quot; + location.port;</div>
<p>The result of <em>x</em> will be (If the port number is 80, which is default, 
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_loc_port">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The port property sets or returns the port number the server uses for a URL.</p>
<p><strong>Note:</strong> If the port part is not specified in the URL (or if it 
is the scheme's default port - like 80, or 443), some browsers will not display 
the port number.</p>
<hr>
...
<p>The port property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the port property:</p>
<div class="code notranslate"><div>
	location.port</div></div>
<p>Set the port property:</p>
<div class="code notranslate"><div>
	location.port=<em>port</em></div></div>
<br>
...
<td>String</td>
<td>
Specifies the port number of the URL</td>
</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>The port number of a URL.<br><br><strong>Note:</strong> If the port number 
is not specified or if it is the scheme's default port (like 80 or 443), an empty string is returned</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_loc_port.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_loc_port.asp#top" target="_top">TOP</a> |
		<a href="prop_loc_port.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
