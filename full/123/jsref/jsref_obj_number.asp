...
<style>a.menu_jsref_obj_number{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="jsref_obj_math.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jsref_obj_string.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Number Object</h2>
<p>The Number object is an object wrapper for primitive numeric values.</p>

<p>Number objects are created with new Number().</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
var num = new Number(value);</div></div>
<p><b>Note:</b> If the value parameter cannot be converted into a number, it returns NaN 
(Not-a-Number).</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns the function that created the Number object's prototype</td>
  </tr>
  <tr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Converts a Number object to a string</td>
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_obj_number.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_obj_number.asp#top" target="_top">TOP</a> |
		<a href="jsref_obj_number.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
