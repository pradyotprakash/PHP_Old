...
<style>a.menu_dom_obj_anchor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Anchor</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_event.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_area.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Anchor Object</h2>
<p>The Anchor object represents an HTML hyperlink.</p>
<p>For each &lt;a&gt; tag in an HTML document, an Anchor object is created.</p>
<p>An anchor allows you to create a link to another document (with the href attribute), or to 
a different point in the same document (with the name attribute).</p>
<p>You can access an anchor by using getElementById(), or by searching through the anchors 
collection property 
of the Document object.</p>

<hr>

<h2>Anchor Object Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td>charset</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns the value of the charset attribute 
	of a link</td>
  </tr>
  <tr>
    <td><a href="prop_anchor_download.asp">download</a></td>
    <td>Sets or returns the value of the download attribute of a link</td>
  </tr>
  <tr>
    <td><a href="prop_anchor_hash.asp">hash</a></td>
    <td>Sets or returns the anchor portion of a link</td>
  </tr>
  <tr>
    <td><a href="prop_anchor_host.asp">host</a></td>
    <td>Sets or returns the hostname and port number of a link</td>
  </tr>
  <tr>
    <td><a href="prop_anchor_hostname.asp">hostname</a></td>
    <td>Sets or returns the hostname of a link</td>
  </tr>
  <tr>
    <td><a href="prop_anchor_href.asp">href</a></td>
    <td>Sets or returns the value of the href attribute of a link</td>
  </tr>
  <tr>
    <td><a href="prop_anchor_hreflang.asp">hreflang</a></td>
    <td>Sets or returns the value of the hreflang attribute of a link</td>
  </tr>
  <tr>
    <td><a href="prop_anchor_id.asp">id</a></td>
    <td>Sets or returns the value of the id attribute of a link</td>
  </tr>
  <tr>
    <td>name</td>
    <td><span class="deprecated">Not supported in HTML5. Use id instead.</span> 
	<br>Sets or returns the value of the name attribute of a link</td>
  </tr>
  <tr>
    <td><a href="prop_anchor_rel.asp">rel</a></td>
    <td>Sets or returns the value of the rel attribute of a link</td>
  </tr>
  <tr>
    <td>rev</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns the value of the rev attribute 
	of a link</td>
  </tr>
  <tr>
    <td><a href="prop_anchor_target.asp">target</a></td>
    <td>Sets or returns the value of the target attribute of a link</td>
  </tr>
  <tr>
    <td><a href="prop_anchor_type.asp">type</a></td>
    <td>Sets or returns the value of the type attribute of a link</td>
  </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Anchor object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_anchor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_anchor.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_anchor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
