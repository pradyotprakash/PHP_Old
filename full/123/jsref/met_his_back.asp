...
<title>History back() Method</title>
<style>a.menu_met_his_back{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>History <span class="color_h1">back()</span> Method</h1>
...
&nbsp;&nbsp;}<br>
&lt;/script&gt;<br><br>
&lt;body&gt;<br>&lt;button onclick=&quot;goBack()&quot;&gt;Go Back&lt;/button&gt;<br>
&lt;/body&gt;</div>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_his_back">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The back() method loads the previous URL in the history list.</p>
<p>This is the same as clicking the &quot;Back button&quot; in your browser, or history.go(-1).</p>
<p><strong>Note:</strong> This method will not work if the previous page does 
not exist in the history list.</p>
<p><strong>Tip:</strong> To load the next URL in the history list, use the
<a href="met_his_forward.asp">history.forward()</a> 
method.</p>
<hr>
...
<p>The back() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
history.back()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_his_back.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_his_back.asp#top" target="_top">TOP</a> |
		<a href="met_his_back.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
