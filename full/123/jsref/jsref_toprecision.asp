...
<style>a.menu_jsref_toprecision{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">toPrecision()</span> Method</h1>
<p><a href="jsref_obj_number.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Number Object Reference" /> JavaScript Number Object</a></p>
<div class="example">
<h2 class="example">Example</h2>
<p>Format a number into a specified length:</p>
<div class="example_code notranslate">
var num = new Number(13.3714);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_toprecision" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<h2>Definition and Usage</h2>
<p>The toPrecision() method formats a number to a specified length.</p>
<p>A decimal point and nulls are added (if needed), to create the specified 
length.</p>
<hr>
...
<p>The toPrecision() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>number</i>.toPrecision(x)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>x</em></td>
    <td>Optional. The number of digits. If omitted, it returns the entire number 
	(without any formatting)</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>The number formatted to the specified precision</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Format a number to a specified length:</p>
<div class="example_code notranslate">
var num = new Number(13.3714);<br>
var a = num.toPrecision();<br>
var b = num.toPrecision(2);<br>
var c = num.toPrecision(3);<br>
var d = num.toPrecision(10);
</div>
<p>The result of <em>a</em>,<em>b</em>,<em>c</em>, and <em>d</em> will be:</p>
<div class="example_code notranslate">
<script>
var num = new Number(13.3714);
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_toprecision2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example</h2>
<p>Format a number between 0 and 1:</p>
<div class="example_code notranslate">
var num = new Number(0.001658853);<br>
var a = num.toPrecision();<br>
var b = num.toPrecision(2);<br>
var c = num.toPrecision(3);<br>
var d = num.toPrecision(10);
...
<div class="example_code notranslate">
<script>
var num = new Number(0.001658853);
document.write(num.toPrecision()+"<br>");
document.write(num.toPrecision(2)+"<br>");
document.write(num.toPrecision(3)+"<br>");
document.write(num.toPrecision(10));
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_toprecision3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<a href="jsref_obj_number.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Number Object Reference" /> JavaScript Number Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_toprecision.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_toprecision.asp#top" target="_top">TOP</a> |
		<a href="jsref_toprecision.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
