...
<title>JavaScript Boolean toString() Method</title>
<style>a.menu_jsref_tostring_boolean{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Boolean <span class="color_h1">toString()</span> Method</h1>
...
<p>Convert a Boolean value to a string:</p>
<div class="example_code notranslate">
var bool = new Boolean(1);<br>
var myvar = bool.toString();
</div>
<p>The result of <em>myvar</em> will be:</p>
<div class="example_code notranslate">
true</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tostring_boolean" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The toString() method converts a Boolean value to a string, and returns the result.</p>
<p><b>Note:</b> This method is called by JavaScript automatically whenever a Boolean object is used in a situation requiring a string.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_tostring_boolean.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_tostring_boolean.asp#top" target="_top">TOP</a> |
		<a href="jsref_tostring_boolean.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
