...
<title>HTML DOM Table insertRow() Method</title>
<style>a.menu_met_table_insertrow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Table <span class="color_h1">insertRow()</span> Method</h1>
...
<p>Insert new row(s) at the first position of a table (and insert a &lt;td&gt; element 
with some content to it):</p>
<div class="example_code notranslate">
	// Find a &lt;table&gt; element with id=&quot;myTable&quot;:<br>var table = 
	document.getElementById(&quot;myTable&quot;);<br><br>// Create an empty &lt;tr&gt; element 
	and add it to the 1st position of the table:<br>var row = table.insertRow(0);<br><br>// Insert 
	new cells (&lt;td&gt; elements) at the 1st and 2nd position of the &quot;new&quot; &lt;tr&gt; element:<br>var cell1 = 
	row.insertCell(0);<br>var cell2 = row.insertCell(1);<br><br>// Add some text 
	to the new cells:<br>
	cell1.innerHTML = &quot;NEW CELL1&quot;;<br>cell2.innerHTML = 
	&quot;NEW CELL2&quot;;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_insertrow" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The insertRow() method creates an empty &lt;tr&gt; element and adds it to a table.</p>
<p>The insertRow() method inserts the new row(s) at the specified index in the table.</p>
<p><strong>Note:</strong> A &lt;tr&gt; element must contain one or more &lt;th&gt; or &lt;td&gt; 
elements.</p>
...
<p>The insertRow() method is supported in all major browsers.<br>
</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>tableObject</em>.insertRow(<i>index</i>)
</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>index</i></td>
		<td>Required in Firefox and Opera, optional in IE, Chrome and Safari. A number that specifies the position of the row to insert (starts 
		at 0). The value of 0 results in that the new row will be inserted at 
		the first position.<p>The value of -1 can also be used, this results in a new row being inserted at the last position.</p>
		This parameter is required in Firefox and Opera, but optional in Internet 
		Explorer, Chrome and Safari.</p>
		If this parameter is omitted, insertRow() inserts a new row at the last 
		position in IE and 
		at the first position in Chrome and Safari.</td>
	</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<div class="example">
<h2 class="example">Example</h2>
<p>Create and delete row(s):</p>
<div class="example_code notranslate">
	function myCreateFunction()<br>{<br>var table = document.getElementById(&quot;myTable&quot;);<br>
	&nbsp;
	{<br>&nbsp; var row = table.insertRow(0);<br>&nbsp; var cell1 = 
	row.insertCell(0);<br>&nbsp; var cell2 = row.insertCell(1);<br>&nbsp; 
	cell1.innerHTML = &quot;NEW CELL1&quot;;<br>&nbsp; cell2.innerHTML = &quot;NEW CELL2&quot;;<br>&nbsp; }<br>}<br>function myDeleteFunction()<br>{<br>
	document.getElementById(&quot;myTable&quot;).deleteRow(0);<br>}</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_insert_deleterow">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_table_insertrow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_table_insertrow.asp#top" target="_top">TOP</a> |
		<a href="met_table_insertrow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
