...
<html lang="en-US">
<head>
<title>HTML DOM Text Object</title>
<style>a.menu_dom_obj_text{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Text</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_submit.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_link.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Text Object</h2>
<p>The Text object represents a single-line text input field in an HTML form.</p>
<p>For each &lt;input type=&quot;text&quot;&gt; tag in an HTML form, a Text object is created.</p>
<p>You can access a text input field by searching through the elements[] array of the form, or by using document.getElementById().</p>

<hr>

<h2>Text Object Properties</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_text_defaultvalue.asp">defaultValue</a></td>
    <td>Sets or returns the default value of a text field</td>
  </tr>
  <tr>
    <td><a href="prop_text_disabled.asp">disabled</a></td>
    <td>Sets or returns whether the text field is disabled, or not</td>
    </tr>    
  <tr>
    <td><a href="prop_text_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the text field</td>
  </tr>
  <tr>
    <td><a href="prop_text_maxlength.asp">maxLength</a></td>
    <td>Sets or returns the value of the maxlength attribute of a text field</td>
  </tr>
  <tr>
    <td><a href="prop_text_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of a text field</td>
  </tr>
  <tr>
    <td><a href="prop_text_readonly.asp">readOnly</a></td>
    <td>Sets or returns whether a text field is read-only, or not</td>
  </tr>
  <tr>
    <td><a href="prop_text_size.asp">size</a></td>
    <td>Sets or returns the value of the size attribute of a text field</td>
  </tr>
  <tr>
    <td><a href="prop_text_type.asp">type</a></td>
    <td>Returns which type of form element a text field is</td>
  </tr>
  <tr>
    <td><a href="prop_text_value.asp">value</a></td>
    <td>Sets or returns the value of the value attribute of the 
    text field</td>
  </tr>
  </table>

<h2>Text Object Methods</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="met_text_select.asp">select()</a></td>
    <td>Selects the content of a text field</td>
    </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Text object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_text.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_text.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_text.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
