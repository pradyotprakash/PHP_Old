...
<style>a.menu_jsref_regexp_lastindex{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">lastIndex</span> Property</h1>
...
<p>Do a global search for &quot;ain&quot; in a string, and output the index after a match is found:</p>
<div class="example_code notranslate">
var str = &quot;The rain in Spain stays mainly in the plain&quot;;<br>
var patt1 = /ain/g;<br><br>
...
<div class="example_code notranslate">
	'ain' found. Index now at: 8<br>'ain' found. Index now at: 17<br>'ain' 
	found. Index now at: 28<br>'ain' found. Index now at: 43</div>

<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_lastindex" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The lastIndex property specifies the index at which to start the next match.</p>
<p><b>Note:</b> This property only works if the &quot;g&quot; modifier is set.</p>
<p>This property returns an integer that specifies the character position 
immediately after the last match found by exec( ) or test( ) methods.</p>
<p><b>Note:</b> exec( ) and test( ) reset lastIndex to 0 if they do not get a 
match.</p>
<hr>
...
<p>The lastIndex property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>RegExpObject</em>.lastIndex</div></div>
<h2>Return Value</h2>
...
<tr>
<td>Number</td>
<td>An integer that specifies the character position immediately after the last 
match found by exec( ) or test( ) methods</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_regexp_lastindex.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_regexp_lastindex.asp#top" target="_top">TOP</a> |
		<a href="jsref_regexp_lastindex.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
