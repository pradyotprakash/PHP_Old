...
<style>a.menu_met_node_clonenode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">cloneNode()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Copy a list item from one list to another:</p>
<div class="example_code notranslate">
	var node=document.getElementById(&quot;myList2&quot;).lastChild.cloneNode(true);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_clonenode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cloneNode() method creates a copy of a node, and returns the clone.</p>
<p>The cloneNode() method clones all attributes and their values.</p>
<p>Set the <em>deep</em> parameter value to <em>true</em> if you want to clone all descendants, otherwise <em>false</em>.</p>
<hr/>
...
<p>The cloneNode() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>node</i>.cloneNode(<i>deep</i>)</div></div>
...
<td><em>deep</em></td>
<td>Boolean</td>
<td>Optional. Default is <em>false</em><br><em>true</em> if you want to clone the node, its attributes, <em>and</em> its descendants<br>
<em>false</em> if you want to clone only the node and its attributes<br>
</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_clonenode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_clonenode.asp#top" target="_top">TOP</a> |
		<a href="met_node_clonenode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
