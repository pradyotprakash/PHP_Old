...
<style>a.menu_prop_node_nodetype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">nodeType</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Get the node type of the body element:</p>
<div class="example_code notranslate">
	document.body.nodeType;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
1
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_nodetype" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The nodeType property returns the node type, as a number, of the specified node.</p>
<p>If the node is an element node, the nodeType property will return 1.</p>
<p>If the node is an attribute node, the nodeType property will return 2.</p>
<hr>
...
<p>The nodeType property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>node</em>.nodeType</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A String, representing the node type of the node</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<h2><a name="nodetypes">Node Types</a></h2>
<p>Documents, elements, attributes, and other aspects of an HTML or XML document has different node types.</p>
<p>There are 12 different node types, which may have children of various node types:</p>

<table class="reference notranslate">
<tr>
<th style="width:30%" colspan="2">Node type</th>
<th style="width:40%">Description</th>
<th style="width:30%">Children</th>
</tr>
	<tr>
	<td>1</td>
	<td>Element</td>
...
<p>The return value of the nodeName and the nodeValue properties for each node type:</p>
<table class="reference notranslate">

<tr>
<th style="width:30%" colspan="2">Node type</th>
<th style="width:40%">nodeName returns</th>
<th style="width:30%">nodeValue returns</th>
</tr>
	<tr>
	<td>1</td>
	<td>Element</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_nodetype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_nodetype.asp#top" target="_top">TOP</a> |
		<a href="prop_node_nodetype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
