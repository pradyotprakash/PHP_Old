...
<title>HTML DOM Style overflow Property</title>
<style>a.menu_prop_style_overflow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">overflow</span> Property</h1>
...
<p>Use the overflow property to scroll overflowing content:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myDiv&quot;).style.overflow=&quot;scroll&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_overflow">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The overflow property sets or returns what to do with content that renders 
outside the element box.</p>
<p><b>Tip: </b>If you want to hide the scrollbars of the entire document, use 
the overflow property on the body or the html element.</p>
<hr>
...
<p>The overflow property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the overflow property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.overflow
</div></div>
<p>Set the overflow property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.overflow=&quot;visible|hidden|scroll|auto|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>visible</td>
		<td>Content is NOT clipped and may be shown 
		outside the element box. This is default</td>
	</tr>
	<tr>
		<td>hidden</td>
		<td>Content outside the element box 
		is not shown</td>
	</tr>
	<tr>
		<td>scroll</td>
		<td>Scroll bars are added, and content is clipped when necessary</td>
	</tr>
	<tr>
		<td>auto</td>
		<td>Content is clipped and scroll bars are added when necessary</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the overflow property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the content that renders outside the element box</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS2</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Use the overflow property to hide overflowing content:</p>
	<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.overflow=&quot;hidden&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_overflow2">Try it yourself &raquo;</a>
</div>
<br>
...
<p>Return the overflow property:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.overflow);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_overflow3">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_pos_overflow.asp">overflow property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_overflow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_overflow.asp#top" target="_top">TOP</a> |
		<a href="prop_style_overflow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
