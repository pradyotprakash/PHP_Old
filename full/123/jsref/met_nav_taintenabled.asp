...
<title>Navigator taintEnabled() Method</title>
<style>a.menu_met_nav_taintenabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Navigator <span class="color_h1">taintEnabled()</span> Method</h1>
...
<p>Determine whether your browser has data tainting enabled:</p>
<div class="example_code notranslate">
document.write(&quot;Data tainting enabled: &quot; + navigator.taintEnabled());<br>
</div>
<p>Output:</p>
<div class="example_code notranslate">
<script>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nav_taintenabled" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The taintEnabled() method was removed in JavaScript version 1.2</span>, and should be avoided to 
prevent run-time errors in the future.</p>
<p>The taintEnabled() method returns a Boolean value that specifies whether the browser has data tainting enabled.</p>
<hr>
...
<p>The taintEnabled() method is only supported in Internet Explorer and Opera. </p>
<p><strong>Note:</strong> Internet Explorer 5 and earlier versions does not 
support data tainting and will therefore always return false.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
navigator.taintEnabled()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>Boolean</td>
<td>Specifies whether the browser has data tainting enabled: &quot;true&quot; if data 
tainting is supported and enabled, otherwise it returns &quot;false&quot;.</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_nav_taintenabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_nav_taintenabled.asp#top" target="_top">TOP</a> |
		<a href="met_nav_taintenabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
