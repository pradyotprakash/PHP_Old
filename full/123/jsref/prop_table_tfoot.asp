...
<title>HTML DOM Table tFoot Property</title>
<style>a.menu_prop_table_tfoot{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Table <span class="color_h1">tFoot</span> Property</h1>
...
<p>Alert the innerHTML of &lt;tfoot&gt;:</p>
<div class="example_code notranslate">
alert(document.getElementById(&quot;myTable&quot;).tFoot.innerHTML);</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_tfoot" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The tFoot property returns a reference to the &lt;tfoot&gt; element of a table.</p>
<p>The &lt;tfoot&gt; element is used to group the footer content in an HTML table.</p>
<p><strong>Tip:</strong> The <a href="prop_table_thead.asp">tHead</a> property 
returns a reference to the &lt;thead&gt; element of a table.</p>
<hr>
...
<p>The tFoot property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>tableObject</em>.tFoot</div></div>
<h2>Return Value</h2>
...
<tr>
<td>A reference to the &lt;tfoot&gt; element of the table, or null if it is not defined</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_table_tfoot.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_table_tfoot.asp#top" target="_top">TOP</a> |
		<a href="prop_table_tfoot.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
