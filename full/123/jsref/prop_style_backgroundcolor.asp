...
<title>HTML DOM Style backgroundColor Property</title>
<style>a.menu_prop_style_backgroundcolor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">backgroundColor</span> Property</h1>
...
<p>The backgroundColor property sets or returns the background color of an element.</p>
<hr>
...
<p>The backgroundColor property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the backgroundColor property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.backgroundColor</div></div>
<p>Set the backgroundColor property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.backgroundColor=&quot;<i>color</i>|inherit|transparent&quot;</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>color</i></td>
		<td>Specifies the background color.
		Look at <a href="../cssref/css_colors_legal.asp">CSS Color Values</a> for a 
		complete list of possible color values</td>
	</tr>
	<tr>
		<td>transparent</td>
		<td>Default. The background color is transparent (underlying content will shine through)</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The background color is inherited from the parent element</td>
	</tr>
</table>
...
<tr>
	...
	<td width="80%">transparent</td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A String, representing the background color</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example </h2>
<p>Set a background color of a specific &lt;div&gt; element:</p>
<div class="example_code notranslate">
	document.getElementById("myDiv").style.backgroundColor="red";</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundcolor2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example </h2>
<p>Return the background color of a specific &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.backgroundColor);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundcolor3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example </h2>
<p>Return the background color of a document:</p>
<div class="example_code notranslate">
	alert(document.body.style.backgroundColor);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundcolor4">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_background-color.asp">background-color property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_backgroundcolor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_backgroundcolor.asp#top" target="_top">TOP</a> |
		<a href="prop_style_backgroundcolor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
