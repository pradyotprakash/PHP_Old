...
<title>HTML DOM Style borderColor Property</title>
<style>a.menu_prop_style_bordercolor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">borderColor</span> Property</h1>
...
<p>Change the color of the four borders of a &lt;div&gt; element to red:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.borderColor=&quot;red&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_bordercolor">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The borderColor property sets or returns the color of an element's border.</p>
<p>This property can take from one to four values:</p>
<ul>
	<li>One value, like: p {border-color: red} - all four 
	borders will be red</li>
	<li>Two values, like: p {border-color: red transparent} -  
	top and bottom border will be red, left and right border will be transparent</li>
	<li>Three values, like: p {border-color: red green blue}- top border will be red, left and right border will be green, bottom 
	border will be blue</li>
	<li>Four values, like: p {border-color: red green blue 
	yellow} - top border will be red, right border will be green, bottom 
	border will be blue, left border will be yellow</li>
</ul>
<hr>
...
<p>The borderColor property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the borderColor property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderColor
</div></div>
<p>Set the borderColor property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderColor=&quot;<i>color</i>|transparent|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
  ...
  <tr>
    <td><i>color</i></td>
    <td>Specifies the color of the border. Look at <a href="../cssref/css_colors_legal.asp">CSS Color Values</a> 
	for a complete list of possible color values. Default color is black</td>
  </tr>
  <tr>
    <td>transparent</td>
    <td>The color of the border is transparent (underlying content will shine 
	through)</td>
  </tr>
  <tr>
    <td>inherit</td>
    <td>The color of the border is inherited from the 
		parent element</td>
  </tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the color of an element's border</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the color of the top and bottom border to green, and left and right 
border to purple, of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.borderColor=&quot;green purple&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_bordercolor2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the border color of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.borderColor);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_bordercolor3">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_border-color.asp">border-color property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_bordercolor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_bordercolor.asp#top" target="_top">TOP</a> |
		<a href="prop_style_bordercolor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
