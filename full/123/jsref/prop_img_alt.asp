...
<title>HTML DOM Image alt Property</title>
<style>a.menu_prop_img_alt{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Image <span class="color_h1">alt</span> Property</h1>
<p><a href="dom_obj_image.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Image Object Reference" /> Image Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the alternate text of an image:</p>
<div class="example_code notranslate">
var x = document.getElementById("myImg").alt;
</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	Crazy computerman</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_img_alt" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The alt property sets or returns the value of the alt attribute of an image.</p>
<p>The required alt attribute specifies an alternate text for an image, if the 
image for some reason cannot be displayed (because of slow connection, an error 
in the src attribute, or if the user uses a screen reader).</p>
<p><b>Note:</b> Internet Explorer displays the value of the alt attribute as a 
tooltip when mousing over the &lt;img&gt; element. This is NOT the correct behavior, 
according to the HTML specification. All other browsers are following the 
specification, and will only display the alt text if the image cannot be 
displayed.</p>
<p><b>Tip:</b> If you want to create a tooltip for an image, use the title 
attribute.</p>
<hr>
...
<p>The alt property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the alt property:</p>
<div class="code notranslate"><div>
	<em>imageObject</em>.alt</div></div>
<p>Set the alt property:</p>
<div class="code notranslate"><div>
	<em>imageObject</em>.alt=<em>text</em></div></div>
<br>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>text</i></td>
		<td>
		Specifies an alternate text for an image.<br><br>Guidelines for the alt 
		text:
		<ul>
			<li>The text should describe the image if the image contains 
			information<br></li>
			<li>The text should explain where the link goes if the 
			image is inside an &lt;a&gt; element<br></li>
			<li>Use alt=&quot;&quot; if the image is only 
			for decoration</li>
		</ul>
		</td>
	</tr>
...
<tr>
<td>String</td>
<td>The value of the alt attribute of the image</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the alternate text of an image:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myImg&quot;).alt=&quot;newAlternateText&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_img_alt2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_image.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Image Object Reference" /> Image Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_img_alt.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_img_alt.asp#top" target="_top">TOP</a> |
		<a href="prop_img_alt.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
