...
<title>metaKey Event Attribute</title>
<style>a.menu_event_metakey{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">metaKey</span> Event Attribute</h1>
...
<p>The metaKey event attribute returns a Boolean value that indicates whether or not the &quot;meta&quot; key was 
pressed when an event was triggered.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
event.metaKey</div></div>
<br>
<hr  />
...
<p>The following example alerts whether or not the &quot;meta&quot; key was pressed when a 
...
{<br>
if (event.metaKey==1)<br>
  {<br>
  alert(&quot;The meta key was pressed!&quot;)<br>
  }<br>
else<br>
  {<br>
  alert(&quot;The meta key was NOT pressed!&quot;)<br>
  }<br>
}<br>
&lt;/script&gt;<br>
&lt;/head&gt;<br>
...
pressed the meta key or not.&lt;/p&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_event_metakey" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_metakey.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_metakey.asp#top" target="_top">TOP</a> |
		<a href="event_metakey.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
