...
<title>HTML DOM IFrame contentDocument Property</title>
<style>a.menu_prop_frame_contentdocument{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>IFrame <span class="color_h1">contentDocument</span> Property</h1>
<p><a href="dom_obj_frame.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="IFrame Object Reference" /> IFrame Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>A crossbrowser example on how to change the background color of the document contained in 
an iframe:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myframe&quot;);<br>var y = (x.contentWindow || 
	x.contentDocument);<br>if (y.document)y = y.document;<br>
	y.body.style.backgroundColor=&quot;red&quot;;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_iframe_contentdocument" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The contentDocument property returns the Document object generated by a frame 
or iframe element.</p>
<p>This property can be used in the host window to access the Document object 
that belongs to a frame or iframe element.</p>
<p><b>Note:</b> Because of security reasons, the contents of a document can be 
accessed from another document only if the two documents are located in the same 
domain.</p>
<hr>
...
<p>The contentDocument property is supported in all major browsers.</p>
<p><b>Note:</b> Internet Explorer 8 (and higher) supports the contentDocument 
property only if a !DOCTYPE is specified. For earlier versions of IE, use 
the <a href="prop_frame_contentwindow.asp">contentWindow</a> property.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>

	<em>iframeObject</em>.contentDocument
...
<tr>
<td>Reference to the document object. If there is no document, the returned 
value is null.</td>
</tr>
</table>
<br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Another example of how to access the document of an iframe to change the 
background color:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myframe&quot;);<br>var y = x.contentDocument;<br>
	y.body.style.backgroundColor=&quot;red&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_iframe_contentdocument2">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<a href="dom_obj_frame.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="IFrame Object Reference" /> IFrame Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_frame_contentdocument.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_frame_contentdocument.asp#top" target="_top">TOP</a> |
		<a href="prop_frame_contentdocument.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
