...
<style>a.menu_jsref_match{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">match()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_match_regexp" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<hr>
<h2>Definition and Usage</h2>
<p>The match() method searches a string for a match against a regular expression, and returns the matches, as an Array object.</p>
...
<p><strong>Note:</strong> If the regular expression does not include the <em>g</em> modifier (to perform a <em>global</em> search), the match() method will return only the first match in the string.</p>
<p>This method returns <em>null</em> if no match is found.</p>
<hr>
...
<p>The match() method is supported in all major browsers.</p>
<hr>
...
<tr>
<td>Array</td>
<td>An array containing the matches, one item for each match, or <em>null</em> if no match is found</td>
</tr>
</table>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_match_regexp2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_match.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_match.asp#top" target="_top">TOP</a> |
		<a href="jsref_match.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
