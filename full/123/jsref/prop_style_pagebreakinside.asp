...
<title>HTML DOM Style pageBreakInside Property</title>
<style>a.menu_prop_style_pagebreakinside{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">pageBreakInside</span> Property</h1>
...
<p>Avoid a page break inside the &lt;p&gt; element with id=&quot;footer&quot;:</p>
<div class="example_code notranslate">
document.getElementById(&quot;footer&quot;).style.pageBreakInside=&quot;avoid&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="tryjsref_style_pagebreakinside.htm">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The pageBreakInside property sets or returns the page-break behavior inside an element 
(for printing or print preview).</p>
<p><b>Note:</b> The pageBreakInside property has no effect on absolutely positioned elements. 
The page break is only visible in a print preview or when printing.</p>
<p><b>Tip:</b> Avoid page-break properties inside tables, floating elements, and block 
...
<p>The pageBreakInside property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<p><b>Note:</b> Firefox, Chrome, and Safari do not support the property value 
&quot;avoid&quot;.&nbsp;</p>
<hr>

<h2>Syntax</h2>
<p>Return the pageBreakInside property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.pageBreakInside
</div></div>
<p>Set the pageBreakInside property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.pageBreakInside=&quot;auto|avoid|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>auto</td>
		<td>Insert a page break inside the element if necessary. This is default</td>
	</tr>
	<tr>
		<td>avoid</td>
		<td>Avoid a page break inside an element</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the pageBreakInside property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the page-break behavior inside an element when 
	printing</td>
</tr>
<tr>
	<th>CSS Version</th>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/pr_print_pagebi.asp">page-break-inside property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_pagebreakinside.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_pagebreakinside.asp#top" target="_top">TOP</a> |
		<a href="prop_style_pagebreakinside.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
