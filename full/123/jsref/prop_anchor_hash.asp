...
<title>HTML DOM Anchor hash Property</title>
<style>a.menu_prop_anchor_hash{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Anchor <span class="color_h1">hash</span> Property</h1>
...
<p>Return the anchor portion of a link:</p>
...
<div class="example_code notranslate">
	#part2</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_anchor_hash" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The hash property sets or returns the anchor portion of a URL.</p>
<p><strong>Note:</strong> When this property is used to set the anchor portion, 
do not include the hash sign (#).</p>
<hr>
...
<p>The hash property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the hash property:</p>
<div class="code notranslate"><div>
	<em>anchorObject</em>.hash
</div></div>
<p>Set the hash property:</p>
<div class="code notranslate"><div>
	<em>anchorObject</em>.hash=<i>anchorname</i></div></div>
<br>
...
<table class="reference notranslate">
	...
	<tr>
		<td><em>anchorname</em></td>
		<td>
		Specifies the anchor portion of the URL</td>
	</tr>
</table>
...
<tr>
	...
	<td>A String, representing the anchor portion of a URL, including the hash 
	sign (#). If there is no hash sign, an empty string is returned</td>
</tr>
</table>
<br>
<hr>
...
<h2>Related Pages</h2>
<p>JavaScript reference: <a href="prop_loc_hash.asp">location.hash Property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_anchor_hash.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_anchor_hash.asp#top" target="_top">TOP</a> |
		<a href="prop_anchor_hash.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
