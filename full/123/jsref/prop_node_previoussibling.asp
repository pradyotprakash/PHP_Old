...
<title>HTML DOM previousSibling Property</title>
...
<h1>HTML DOM <span class="color_h1">previousSibling</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the previousSibling of a list item:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;item2&quot;).previousSibling;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_previoussibling" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The previousSibling property returns the previous node of the specified node, in the same tree level.</p>
<p>The returned node is returned as a Node object.</p>
<p><strong>Note:</strong> If there is no previousSibling node, the return value is <em>null</em>.</p>
<hr>
...
<p>The previousSibling property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>node</em>.previousSibling</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The previous sibling of the node, as a Node object</td>
</tr>
<tr>
	<th>DOM Version</th>
