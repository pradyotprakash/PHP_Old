...
<style>a.menu_jsref_tolocaledatestring{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">toLocaleDateString()</span> Method</h1>
...
<p>Return the Date object as a string, using locale conventions:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tolocaledatestring" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The toLocaleDateString() method converts the date (not the time) of a Date object into a readable string, using locale conventions.</p>
<hr>
...
<p>The toLocaleDateString() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.toLocaleDateString()</div></div>
<h2>Return Value</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_tolocaledatestring.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_tolocaledatestring.asp#top" target="_top">TOP</a> |
		<a href="jsref_tolocaledatestring.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
