...
<title>HTML DOM Style borderSpacing Property</title>
<style>a.menu_prop_style_borderspacing{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">borderSpacing</span> Property</h1>
...
<p>Set the space between cells in a table:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myTable&quot;).style.borderSpacing=&quot;20px&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderspacing">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The borderSpacing property sets or returns the space between cells in a 
table.</p>
<p><b>Note:</b> This property has no effect if 
<a href="prop_style_bordercollapse.asp">borderCollapse</a> is set to 
collapse.</p>
<hr>
...
<p>The borderSpacing property is supported in all major browsers.</p>
<p><b>Note:</b> The borderSpacing property is not supported in IE7 and earlier. 
IE8 requires a !DOCTYPE. IE9 supports it.</p>
<hr>

<h2>Syntax</h2>
<p>Return the borderSpacing property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderSpacing
</div></div>
<p>Set the borderSpacing property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderSpacing=&quot;<i>length length</i>|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		...
		<td>Specifies the space between cells in length units. Negative values are not allowed. Default value is 0.
		<ul>
		<li>If one length value is specified, it specifies both the horizontal and vertical spacing</li>
		<li>If two length values are specified, the first sets the horizontal spacing and the second sets the vertical spacing</li>
        </ul>
		</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the borderSpacing property is inherited from parent element</td>
	</tr>
	</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the space between cells in a table</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS2</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the space between cells in a table:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myTable&quot;).style.borderSpacing);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderspacing2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_tab_border-spacing.asp">border-spacing 
property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_borderspacing.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_borderspacing.asp#top" target="_top">TOP</a> |
		<a href="prop_style_borderspacing.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
