...
<title>HTML DOM Style backgroundImage Property</title>
<style>a.menu_prop_style_backgroundimage{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">backgroundImage</span> Property</h1>
...
<p>The backgroundImage property sets or returns the background image of an element.</p>
<p><b>Tip:</b> In addition to the background-image you should also specify a 
background-color. The background-color will be used if the image is unavailable.</p>
<hr>
...
<p>The backgroundImage property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the backgroundImage property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.backgroundImage
</div></div>
<p>Set the backgroundImage property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.backgroundImage=&quot;url('<i>URL</i>')|none|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>url(<i>'URL'</i>)</td>
		<td>The location of the image file</td>
	</tr>
	<tr>
		<td>none</td>
		<td>No background image. This is default</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The setting of the background-image property is 
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the background image</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example </h2>
<p>Set a background image of a specific &lt;div&gt; element:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myDiv&quot;).style.backgroundImage=&quot;url('img_tree.png')&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundimage2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example </h2>
<p>Return the background image of a specific &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.backgroundImage);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundimage3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example </h2>
<p>Return the background image of a document:</p>
<div class="example_code notranslate">
	alert(document.body.style.backgroundImage);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundimage4">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_backgroundimage.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_backgroundimage.asp#top" target="_top">TOP</a> |
		<a href="prop_style_backgroundimage.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
