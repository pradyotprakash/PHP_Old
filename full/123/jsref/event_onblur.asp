...
<style>a.menu_event_onblur{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">onblur</span> Event</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onblur" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onblur event occurs when an object loses focus.</p>
<p>Onblur is most often used with form validation code (e.g. when the user 
leaves a form field).</p>
<p><b>Tip:</b> The onblur event is the opposite of the
<a href="event_onfocus.asp">onfocus</a> event.</p>
...
&lt;<i>element</i>
onblur=&quot;<i>SomeJavaScriptCode</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>object</em>.onblur=function(){<i>SomeJavaScriptCode</i>};</div></div>
<br>
...
<p>The onblur event is supported in all major browsers.</p>

<hr>

<h2>onblur In HTML</h2>
<p>The onblur attribute can be used within ALL HTML elements, EXCEPT: &lt;base&gt;, &lt;bdo&gt;, &lt;br&gt;, 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_onblur.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_onblur.asp#top" target="_top">TOP</a> |
		<a href="event_onblur.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
