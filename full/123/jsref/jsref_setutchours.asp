...
<style>a.menu_jsref_setutchours{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">setUTCHours()</span> Method</h1>
...
<p>Set the hour to 15, according to UTC time:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutchours" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<hr>

<h2>Definition and Usage</h2>
<p>The setUTCHours() method sets the hour of a date object, according to the UTC time.</p>
<p>This method can also be used to set the minutes, seconds and milliseconds.</p>
...
<p>The setUTCHours() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.setUTCHours(<em>hour</em>,<em>min</em>,<em>sec</em>,<em>millisec</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>hour</em></td>
    <td>Required. An integer representing the hour.
  ...
  <tr>
    <td><em>min</em></td>
    <td>Optional. An integer representing the minutes.
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set the time to 15:35:01 UTC time</p>
<div class="example_code notranslate">
var d = new Date();<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutchours2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Set the time to 48 hours <em>ago</em>, using UTC methods:</p>
<div class="example_code notranslate">
var d = new Date();<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutchours3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_setutchours.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_setutchours.asp#top" target="_top">TOP</a> |
		<a href="jsref_setutchours.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
