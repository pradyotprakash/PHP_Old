...
<style>a.menu_prop_his_length{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>History <span class="color_h1">length</span> Property</h1>
...
<p>Return the number of URLs in the history list:</p>
<div class="example_code notranslate">
document.write(&quot;Number of URLs in history list: &quot; + history.length);</div>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_his_length">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The length property returns the number of URLs in the history list of the 
current browser window.</p>
<p>The property returns at least 1, because the list includes the currently 
loaded page.</p>
<p><strong>Tip:</strong> This property is useful to find out how many pages the 
user has visited in the current browsing session.</p>
<p><b>Note:</b> Internet Explorer and Opera start at 0, while Firefox, Chrome, 
and Safari start at 1.</p>
<p><strong>Note:</strong> Maximum length is 50.</p>
<hr>
...
<p>The length property is supported in all major browsers.</p>
<hr>
...
<tr>
	...
	<td width="75%">An integer representing the number of entries in the session 
	history</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_his_length.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_his_length.asp#top" target="_top">TOP</a> |
		<a href="prop_his_length.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
