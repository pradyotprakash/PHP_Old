...
<title>Location search Property</title>
<style>a.menu_prop_loc_search{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Location <span class="color_h1">search</span> Property</h1>
...
<p>Return the query portion of a URL. Assume that the current URL is http://www.w3schools.com/submit.htm?email=someone@example.com:</p>
<div class="example_code notranslate">
	var x = location.search;<br>
	</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
?email=someone@example.com</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The search property sets or returns the query portion of a URL, including the question mark (?).</p>
...
<div class="code notranslate"><div>
	location.search</div></div>
<p>Set the search property:</p>
<div class="code notranslate"><div>
	location.search=<em>querystring</em></div></div>
<br>
...
<td>String</td>
<td>
Specifies the search part of the URL</td>
</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>The query portion of a URL, including the question mark (?)</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_loc_search.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_loc_search.asp#top" target="_top">TOP</a> |
		<a href="prop_loc_search.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
