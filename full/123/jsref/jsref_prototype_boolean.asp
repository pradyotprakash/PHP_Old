...
<title>JavaScript Boolean prototype Constructor</title>
<style>a.menu_jsref_prototype_boolean{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Boolean <span class="color_h1">prototype</span> Constructor</h1>
<p><a href="jsref_obj_boolean.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Boolean Object Reference" /> JavaScript Boolean Object</a></p>
<div class="example">
<h2 class="example">Example</h2>
<p>Make a new method for the Boolean object:</p>
<div class="example_code notranslate">
	Boolean.prototype.myColor=function()<br>{<br>if 
	(this.valueOf()==true)<br>&nbsp; {<br>&nbsp; this.color=&quot;green&quot;;<br>&nbsp; }<br>else<br>&nbsp; 
	{<br>&nbsp; this.color=&quot;red&quot;;<br>&nbsp; 
	}<br>}</div>
<p>Make a Boolean object, then calls the myColor method:</p>
<div class="example_code notranslate">
var a=new Boolean(1);<br>
	a.myColor();<br>var b=a.color;</div>
<p>The value of <em>b</em> is now:</p>
<div class="example_code notranslate">
	green </div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_prototype_boolean" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The prototype constructor allows you to add new properties and methods to the 
Boolean() object.</p>
<p>When constructing a property, ALL booleans will be given the property, and it's value, as default.</p>
<p>When constructing a method, ALL booleans will have this method available.</p>
<p><b>Note:</b>  Boolean.prototype does not refer to a single boolean, but to the 
Boolean() object itself.</p>
...
<div class="code notranslate"><div>
	Boolean.prototype.<i>name</i>=<em>value</em>
</div></div><br>
<hr>
<a href="jsref_obj_boolean.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Boolean Object Reference" /> JavaScript Boolean Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_prototype_boolean.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_prototype_boolean.asp#top" target="_top">TOP</a> |
		<a href="jsref_prototype_boolean.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
