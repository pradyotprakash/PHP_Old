...
<style>a.menu_jsref_touppercase{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">toUpperCase()</span> Method</h1>
...
<div class="example_code notranslate">
	var str = &quot;Hello World!&quot;;<br>var res = str.toUpperCase();
</div>
<p>The result of <em>res</em> will be:</p>
<div class="example_code notranslate">
	HELLO WORLD!</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_touppercase" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The toUpperCase() method converts a string to uppercase letters.</p>
<p><strong>Note:</strong> The toUpperCase() method does not change the original 
string.</p>
<p><strong>Tip:</strong> Use the <a href="jsref_tolowercase.asp">toLowerCase()</a> method to convert a string to 
lowercase letters.</p>
<hr>
...
<p>The toUpperCase() method is supported in all major browsers.</p>
<hr>
...
<tr>
<td>String</td>
<td>The value of a string converted to uppercase</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_touppercase.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_touppercase.asp#top" target="_top">TOP</a> |
		<a href="jsref_touppercase.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
