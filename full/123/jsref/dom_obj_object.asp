...
<style>a.menu_dom_obj_object{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Object</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_meta.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_option.asp">Next Reference &raquo;</a></div>
</div>

<hr>
<h2>Object Object</h2>
<p>The Object object represents an HTML object element.</p>
<p>The &lt;object&gt; tag is used to include objects such as images, audio, videos, 
Java applets, ActiveX, PDF, and Flash into a webpage.</p>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<a href="prop_style_cssfloat.asp">style.cssFloat</a> instead.</span> <br>Sets or returns the alignment of the object according to the surrounding text</td>
  </tr>
  <tr>
    <td>archive</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Sets or returns a string that can be used to implement your 
    own archive functionality for the object</td>
  </tr>
  <tr>
    <td>border</td>
    <td><span class="deprecated">Not supported in HTML5. Use
	<a href="prop_style_border.asp">style.border</a> instead.</span> <br>Sets or returns the border around the object</td>
  </tr>
  <tr>
    <td>code</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns the URL of the file that contains the 
    compiled Java class</td>
  </tr>
  <tr>
    <td>codeBase</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns the URL of the component</td>
  </tr>
  <tr>
    <td>codeType</td>
    <td><span class="deprecated">Not supported in HTML5.</span> </td>
  </tr>
  <tr>
    <td>data</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>form</td>
    <td>Returns a reference to the object's parent form</td>
  </tr>
  <tr>
    <td>height</td>
    <td>Sets or returns the height of the object</td>
  </tr>
  <tr>
    <td>hspace</td>
    <td><span class="deprecated">Not supported in HTML5. Use
	<a href="prop_style_margin.asp">style.margin</a> instead.</span> <br>Sets or returns the horizontal margin of the object</td>
  </tr>
  <tr>
    <td>name</td>
    <td>Sets or returns the name of the object</td>
  </tr>
  <tr>
    <td>standby</td>
    <td><span class="deprecated">Not supported in HTML5.</span> <br>Sets or returns a message when loading the object</td>
  </tr>
  <tr>
    <td>type</td>
    <td>Sets or returns the content type for data downloaded via 
    the data attribute</td>
  </tr>
  <tr>
    <td>useMap</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>vspace</td>
    <td><span class="deprecated">Not supported in HTML5. Use
	<a href="prop_style_margin.asp">style.margin</a> instead.</span> <br>Sets or returns the vertical margin of the object</td>
  </tr>
  <tr>
    <td>width</td>
    <td>Sets or returns the width of the object</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Object object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_object.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_object.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_object.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
