...
<title>HTML DOM Style minWidth Property</title>
<style>a.menu_prop_style_minwidth{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">minWidth</span> Property</h1>
...
document.getElementById(&quot;myP&quot;).style.minWidth=&quot;200px&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_minwidth">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The minWidth property sets or returns the minimum width of an element.</p>
<p>The minWidth property has effect only on block-level elements or on elements 
with absolute or fixed position.</p>
<p><strong>Tip:</strong> To set or return the maximum width of an element, use 
the <a href="prop_style_maxwidth.asp">maxWidth</a> property.</p>
<hr>
...
<p>The minWidth property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the minWidth property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.minWidth
</div></div>
<p>Set the minWidth property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.minWidth=&quot;<i>length|%</i>|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><i>length</i></td>
		<td>Defines the minimum width in length units. Default is 0</td>
	</tr>
	<tr>
		<td><i>%</i></td>
		<td>Defines the minimum width in % of the parent element</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the minWidth property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the minimum width of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS2</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the minimum width of a &lt;p&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myP&quot;).style.minWidth);
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_minwidth2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_dim_min-width.asp">min-width property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_minwidth.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_minwidth.asp#top" target="_top">TOP</a> |
		<a href="prop_style_minwidth.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
