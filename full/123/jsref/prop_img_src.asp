...
<title>HTML DOM Image src Property</title>
<style>a.menu_prop_img_src{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Image <span class="color_h1">src</span> Property</h1>
...
<p>Return the URL of an image:</p>
<div class="example_code notranslate">
var x = document.getElementById("myImg&quot;).src;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	http://www.w3schools.com/jsref/compman.gif</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_img_src" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The src property sets or returns the value of the src attribute of an image.</p>
<p>The required src attribute specifies the URL of an image.</p>
<p><strong>Note:</strong> The src property can be changed at any time. However, 
the new image inherits the height and width attributes of the original image, if 
not new <a href="prop_img_height.asp">height</a> and
<a href="prop_img_width.asp">width</a> properties are specified.</p>
<hr>
...
<p>The src property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the src property:</p>
<div class="code notranslate"><div>

	<em>imageObject</em>.src</div></div>
<p>Set the src property:</p>
<div class="code notranslate"><div>

	<em>imageObject</em>.src=<em>URL</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>URL</em></td>
    <td>
	Specifies the URL of the image.<br><br>Possible values:
	<ul>
		<li>An absolute URL - points to another web site (like src=&quot;http://www.example.com/default.htm&quot;)<br>
		</li>
		<li>A relative URL - points to a file within a web site (like src=&quot;default.htm&quot;)</li>
	</ul>
	  </td>
  </tr>
</table>
...
<tr>
<td>String</td>
<td>The value of the src attribute of the image. Returns the entire 
URL, including the protocol (like http://)</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the src attribute of an image:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myImg&quot;).src=&quot;hackanm.gif&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_img_src2">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_img_src.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_img_src.asp#top" target="_top">TOP</a> |
		<a href="prop_img_src.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
