...
<title>HTML DOM Meta name Property</title>
<style>a.menu_prop_meta_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Meta <span class="color_h1">name</span> Property</h1>
...
<p>Return the value of the content attribute of all meta elements:</p>
<div class="example_code notranslate">
	var x = document.getElementsByTagName(&quot;meta&quot;);<br>var txt = &quot;&quot;;<br>for (var i=0;i&lt;x.length;i++)<br>&nbsp; {<br>&nbsp; txt = 
	txt + &quot;Name of &quot;+(i+1)+&quot;. meta tag: &quot;+x[i].name+&quot;&lt;br&gt;&quot;;<br>&nbsp; }<br>
	document.getElementById(&quot;demo&quot;).innerHTML=txt;</div>
<p>The result of <em>txt</em> will be:</p>
<div class="example_code notranslate">
	Name of 1. meta tag: description<br>Name of 2. meta tag: keywords<br>Name 
	of 3. meta tag: author</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_meta_name" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The name property sets or returns a name for the information in the content 
attribute.</p>
<p>The value of the name attribute depends on the value of the content 
attribute.</p>
<p>There is also an extended list defined in the WHATWG Wiki MetaExtensions Page - Anyone is free to edit the page at any time to add a new type. None are formally accepted, but may be in the future. For more information, visit
<a href="http://wiki.whatwg.org/wiki/MetaExtensions" target="_blank">WHATWG Wiki 
MetaExtensions page</a>.</p>
<p><b>Note:</b> If the http-equiv attribute is set, the name attribute should 
not be set.</p>
<hr>
...
<p>The name property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the name property:</p>
<div class="code notranslate"><div>
	<em>metaObject</em>.name
</div></div>
<p>Set the name property:</p>
<div class="code notranslate"><div>
	<em>metaObject</em>.name=&quot;application-name|author|description|generator|keywords&quot;</div>
</div>
<br>
<table class="reference notranslate">
	...
	<tr>
		...
		<td>Specifies the name of the Web application that the page represents</td>
	</tr>
	<tr>
		<td>author</td>
		<td>Specifies the name of the author of the document.<br><br>
		Example:
		&lt;meta name="author" content="Hege Refsnes"&gt;</td>
	</tr>
	<tr>
		<td>description</td>
		<td>Specifies a description of the page. Search engines can pick up this description to show with the results of searches.<br><br>
		Example:
		&lt;meta name="description" content="Free web tutorials"&gt;</td>
	</tr>
	<tr>
		<td>generator</td>
		<td>Specifies one of the software packages used to generate the document 
		(not used on hand-authored pages)<br><br>
		Example:
		&lt;meta name="generator" content="FrontPage 4.0"&gt;</td>
	</tr>
	<tr>
		<td>keywords</td>
		<td>Specifies a comma-separated list of keywords - relevant to the page 
		(Informs search engines what the page is about).<br><br>
		<b>Tip:</b> Always specify keywords (needed by search engines to catalogize the page).<br><br>
		Example:
...
<tr>
<td>String</td>
<td>A name for the information in the content attribute</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_meta_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_meta_name.asp#top" target="_top">TOP</a> |
		<a href="prop_meta_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
