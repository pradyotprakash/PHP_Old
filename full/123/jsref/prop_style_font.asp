...
<style>a.menu_prop_style_font{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">font</span> Property</h1>
...
document.getElementById(&quot;myP&quot;).style.font=&quot;italic bold 20px arial,serif&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_font">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The font property sets or returns up to six separate font 
properties, in a shorthand form.</p>
<p>With this property, you can set/return the following (in this 
order):</p>
<ul>
	<li>font-style</li>
	<li>font-variant</li>
...
<p>The font-size and font-family are required. If one of the other valeus are 
missing, the default values will be inserted, if any.</p>
...
<p>The font property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the font property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.font
</div></div>
<p>Set the font property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.font=&quot;[<i>style variant weight size/lineHeight family</i>]<i> 
or </i>[<i>reserved word</i>]&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><i><a href="prop_style_fontstyle.asp">style</a></i></td>
		<td>Sets the font-style</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_fontvariant.asp">variant</a></i></td>
		<td>Sets the text in a small-caps font</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_fontweight.asp">weight</a></i></td>
		<td>Sets the boldness of the font</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_fontsize.asp">size</a></i></td>
		<td>Sets the size of the font</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_lineheight.asp">lineHeight</a></i></td>
		<td>Sets the distance between lines</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_fontfamily.asp">family</a></i></td>
		<td>Sets the font face</td>
	</tr>
	<tr>
		<td>caption</td>
		<td>The font used for captioned controls 
		(like buttons, drop-downs, etc.)</td>
	</tr>
	<tr>
		<td>icon</td>
	...
	<tr>
		<td>small-caption</td>
		<td>The font used in small controls</td>
	</tr>
	<tr>
		<td>status-bar</td>
	...
	<tr>
		<td>inherit</td>
		<td>The value of the font property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing different font properties of the element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myP&quot;).style.font);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_font2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_font_font.asp">font property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_font.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_font.asp#top" target="_top">TOP</a> |
		<a href="prop_style_font.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
