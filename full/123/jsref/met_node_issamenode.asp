...
<title>HTML DOM isSameNode Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_node_issamenode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">isSameNode()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Check if two nodes are, in fact, the same node:</p>
<div class="example_code notranslate">
	var item1=document.getElementById(&quot;myList1&quot;);<br>
	var item2=document.getElementsByTagName(&quot;UL&quot;)[0];<br>
	item1.isSameNode(item2);</div>
	<p>The result will be:</p>
<div class="example_code notranslate">
true
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_issamenode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isSameNode() method checks if two nodes are the same node.</p>
<p>The isSameNode() method returns <em>true</em> if the two nodes are the same node, otherwise <em>false</em>.</p>
<p><strong>Tip:</strong> Use the <a href="met_node_isequalnode.asp">isEqualNode() method</a> to check if two nodes are equal, but not necessarily the same node.</p>
...
<p>The isSameNode() method is supported in all major browsers, except Firefox.</p>
<p><strong>Note:</strong> Firefox stopped supported this method as of version 10, because the method has been deprecated in the DOM version 4. Instead, you should use === to compare if two nodes are the same.</p>
<p><strong>Note:</strong> Internet Explorer 8 and earlier does not support this method.</p>

<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>node</i>.isSameNode(<i>node</i>)</div></div>

<h2>Parameters</h2>
<table class="reference notranslate">
<tr>
<th style="text-align:left;width:17%;">Parameter</th>
...
<td><em>node</em></td>
<td>Node object</td>
<td>Required. The node you want to compare the specified node with</td>
</tr>
</table>
...
<table class="reference notranslate">
<tr>
<th style="text-align:left;width:17%;">Type</th>    
<th style="text-align:left;">Description</th>
</tr>
<tr>
<td>Boolean</td>
<td><em>true</em> if the two nodes are the same node, otherwise <em>false</em></td>
</tr>
</table>
...
<table class="tecspec">
<tr>
	<th style="text-align:left;width:17%;">DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_issamenode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_issamenode.asp#top" target="_top">TOP</a> |
		<a href="met_node_issamenode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
