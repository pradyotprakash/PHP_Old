...
<title>Window top Property</title>
<style>a.menu_prop_win_top{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">top</span> Property</h1>
...
<p>When the &quot;Check window&quot; button is clicked, the function check() is called and 
...
the current window, then fire the else statement: </p>
<div class="example_code notranslate">
function check()<br>
{<br>
if (window.top!=window.self) <br>
&nbsp; {<br>
&nbsp; document.write(&quot;&lt;p&gt;This window is not the topmost window! Am I in a 
frame?&lt;/p&gt;&quot;)<br>
&nbsp; }<br>
else<br>
&nbsp; { <br>
&nbsp; document.write(&quot;&lt;p&gt;This window is the topmost window!&lt;/p&gt;&quot;)<br>
&nbsp; } <br>
}</div>
<br><a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_self_top">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The top property returns the topmost browser window of the current window.</p>
<hr>
...
<tr>
	...
	<td width="75%">A reference to the topmost window in the window hierarchy</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_win_top.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_win_top.asp#top" target="_top">TOP</a> |
		<a href="prop_win_top.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
