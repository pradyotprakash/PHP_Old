...
<style>a.menu_jsref_gettimezoneoffset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">getTimezoneOffset()</span> Method</h1>
...
<p>Return the timezone difference between UTC and Local Time:</p>
<div class="example_code notranslate">
var d = new Date()<br>
var n = d.getTimezoneOffset();<br>
</div>
<p>The result <em>n</em> will be:</p>
<div class="example_code notranslate">
<script>
var d = new Date()
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_gettimezoneoffset" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getTimezoneOffset() method returns the time difference between UTC time and local time, in minutes.</p>
<p>For example, If your time zone is GMT+2, -120 will be returned.</p>
<p><b>Note:</b> The returned value is not a constant, because of the practice of using Daylight Saving Time.</p>
...
<p>The getTimezoneOffset() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.getTimezoneOffset()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>Number</td>
<td>The time difference between UTC and Local Time, in minutes</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_gettimezoneoffset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_gettimezoneoffset.asp#top" target="_top">TOP</a> |
		<a href="jsref_gettimezoneoffset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
