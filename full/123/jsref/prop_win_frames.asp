...
<style>a.menu_prop_win_frames{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">frames</span> Property</h1>
...
<p>The frames property returns an array of all the frames (including iframes) in the 
current window.</p>
<p><b>Tip:</b> Use <a href="prop_win_length.asp">frames.length</a> to find the number of frames.</p>
<hr>
...
<p>The frames property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.frames</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">Returns an array, listing all of the frames in the current 
window</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_win_frames.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_win_frames.asp#top" target="_top">TOP</a> |
		<a href="prop_win_frames.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
