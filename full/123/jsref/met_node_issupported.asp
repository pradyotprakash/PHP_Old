...
<title>HTML DOM isSupported Method</title>
...
<h1>HTML DOM Node <span class="color_h1">isSupported()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Check if the feature Core, version 2.0, is supported for the button element:</p>
<div class="example_code notranslate">
	var item=document.getElementsByTagName(&quot;BUTTON&quot;)[0];<br>
	item.isSupported("Core","2.0");</div>
	<p>The result will be:</p>
<div class="example_code notranslate">
true
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_issupported" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isSupported() method checks if a specified feature is supported for the specified node.</p>
...
<i>node</i>.isSupported(<i>feature</i>,<i>version</i>)</div></div>
...
<td><em>feature</em></td>
<td>String</td>
<td>Required. Defines the feature you want to check if is supported</td>
</tr>
<tr>
<td><em>version</em></td>
<td>String</td>
<td>Optional. Defines the version of the feature you want to check if is supported</td>
</tr>
</table>
...
<tr>
<td>Boolean</td>
<td><em>true</em> if the feature is supported, otherwise <em>false</em></td>
</tr>
</table>
