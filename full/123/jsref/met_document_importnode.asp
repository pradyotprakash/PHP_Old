...
<title>HTML DOM importNode() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_document_importnode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">importNode()</span> Method</h1>
...
<p>Return the first H1 element that appears in an iframe:</p>
<div class="example_code notranslate">
	var frame=document.getElementsByTagName(&quot;iframe&quot;)[0]<br>var 
	h=frame.contentWindow.document.getElementsByTagName(&quot;h1&quot;)[0];<br>var 
	x=document.importNode(h,true);</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_importnode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The importNode() method imports a node from another document.</p>
<p>The imported node can be of all node types.</p>
<p>If the second parameter is set to <em>true</em>, the nodes&#39;s child nodes will 
also be imported.</p>
...
<p>The importNode() method is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet explorer 8 and earlier does not support this method.</p>

<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
document.importNode(<em>node</em>,<em>deep</em>)</div></div>
...
<td><em>deep</em></td>
<td>Boolean</td>
<td>Required. If set to <em>false</em>, only the node itself is imported, if set 
to <em>true</em>, all child nodes (descendants) are also imported</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_importnode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_importnode.asp#top" target="_top">TOP</a> |
		<a href="met_document_importnode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
