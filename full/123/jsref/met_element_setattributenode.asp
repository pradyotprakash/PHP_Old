...
<title>HTML DOM setAttributeNode() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_element_setattributenode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">setAttributeNode()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Set the class attribute node of a header element:</p>
<div class="example_code notranslate">
var atr=document.createAttribute("class");<br>
atr.nodeValue="democlass";<br>
document.getElementsByTagName("H1")[0].setAttributeNode(atr); 
</div>
	<p>Before setting the attribute node:</p>
<div class="example_code notranslate">
<h1 style="margin:0px;">Hello World</h1>
</div>
	<p>After setting the attribute node:</p>
<div class="example_code notranslate">
<h1 style="margin:0px;color:red;">Hello World</h1>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_element_setattributenode" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<h2>Definition and Usage</h2>
<p>The setAttributeNode() method adds the specified attribute node to an element.</p>
<p>If the specified attribute allready exists, this method replaces it.</p>
...
<p>The setAttributeNode() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>element</em>.setAttributeNode(<em>attributenode</em>)</div></div>
<h2>Parameters</h2>
...
<td>Attr object</td>
<td>Required. The attribute node you want to add</td>
</tr>
</table>
...
<tr>
<td>Attr object</td>
<td>The replaced attribute node, if any, otherwise <em>null</em></td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_setattributenode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_setattributenode.asp#top" target="_top">TOP</a> |
		<a href="met_element_setattributenode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
