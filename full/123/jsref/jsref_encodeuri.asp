...
<style>a.menu_jsref_encodeuri{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">encodeURI()</span> Function</h1>
...
<div class="example_code notranslate">
	var uri = "my test.asp?name=ståle&amp;car=saab";<br>var res = encodeURI(uri);</div>
<p>The result of <em>res</em> will be:</p>
<div class="example_code notranslate">
	my%20test.asp?name=st%C3%A5le&amp;car=saab</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_encodeuri" class="tryitbtn">
	Try it yourself »</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The encodeURI() function is used to encode a URI.</p>
<p>This function encodes special characters, except: , / ? : @ &amp; = + $ # (Use <a href="jsref_encodeuricomponent.asp">
encodeURIComponent()</a> to encode these characters).</p>
<p><b>Tip:</b> Use the <a href="jsref_decodeuri.asp">decodeURI()</a> function to 
decode an encoded URI.</p>
<hr>
...
<p>The encodeURI() function is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	encodeURI(<em>uri</em>)</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_encodeuri.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_encodeuri.asp#top" target="_top">TOP</a> |
		<a href="jsref_encodeuri.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
