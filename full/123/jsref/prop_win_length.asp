...
<style>a.menu_prop_win_length{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">length</span> Property</h1>
...
<p>Find the number of frames on a page:</p>
<div class="example_code notranslate">
	alert(window.length);</div>
<br><a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_length">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The length property returns the number of frames (including iframes) in the 
current window.</p>
<p><strong>Tip:</strong> This property is often used together with the 
<a href="prop_win_frames.asp">window.frames</a> property.</p>
<hr>
...
window.length</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The number of frames (including iframes) in the current window</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Find the number of frames on a page, and change the src property of every frame element to 
&quot;w3schools.com&quot;:</p>
<div class="example_code notranslate">
	for (var i=0; i&lt;frames.length; i++)<br>&nbsp; {<br>&nbsp; 
	frames[i].location=&quot;<a href="../index.html">http://www.w3schools.com</a>&quot;<br>&nbsp; 
	}
</div>
<br><a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_frames">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_win_length.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_win_length.asp#top" target="_top">TOP</a> |
		<a href="prop_win_length.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
