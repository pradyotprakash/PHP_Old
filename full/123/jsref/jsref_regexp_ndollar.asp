...
<style>a.menu_jsref_regexp_ndollar{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_dollar" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <i>n</i>$ quantifier matches any string with <i>n</i> at the end of it.</p>
<p><strong>Tip:</strong> Use the <i><a href="jsref_regexp_ncaret.asp">^n</a></i> quantifier 
to match any string with <i>n</i> at the BEGINNING of it.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_regexp_ndollar.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_regexp_ndollar.asp#top" target="_top">TOP</a> |
		<a href="jsref_regexp_ndollar.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
