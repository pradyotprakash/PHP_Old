...
<style>a.menu_jsref_setfullyear{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">setFullYear()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setfullyear" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The setFullYear() method sets the year (four digits) of the date object.</p>
<p>This method can also be used to set the month and day of month.</p>
<hr>
...
<p>The setFullYear() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.setFullYear(<em>year</em>,<em>month</em>,<em>day</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <ul>
    	<li>0 will result in the last day of the previous month</li>
    	<li>-1 will result in the day before the last day of the previous month</li>
    </ul>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set the date to November 3, 2020:</p><div class="example_code notranslate">
var d=new Date();<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setfullyear2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Set the date to six months <em>ago</em>:</p><div class="example_code notranslate">
var d=new Date();<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setfullyear3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_setfullyear.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_setfullyear.asp#top" target="_top">TOP</a> |
		<a href="jsref_setfullyear.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
