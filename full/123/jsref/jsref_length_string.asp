...
<style>a.menu_jsref_length_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">length</span> Property</h1>
...
<p>Return the number of characters in a string:</p>
<div class="example_code notranslate">
	var str = &quot;Hello World!&quot;;<br>var n = str.length;</div>
<p>The result of <em>n</em> will be:</p>
<div class="example_code notranslate">
	12</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_length_string" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The length property returns the length of a string (number of characters).</p>
<p>The length of an empty string is 0.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_length_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_length_string.asp#top" target="_top">TOP</a> |
		<a href="jsref_length_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
