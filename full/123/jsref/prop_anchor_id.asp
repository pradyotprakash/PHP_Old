...
<title>HTML DOM Anchor id Property</title>
<style>a.menu_prop_anchor_id{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Anchor <span class="color_h1">id</span> Property</h1>
...
<p>Return the id of a link:</p>
<div class="example_code notranslate">
var x = document.getElementById("w3s").id;
</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	w3s</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_anchor_id" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The id property sets or returns the value of the id attribute of a link.</p>
<p>The id attribute specifies the id of an anchor, and can be used to create a 
bookmark inside a document.</p>
<hr>
...
<p>The id property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the id property:</p>
<div class="code notranslate"><div>
	<em>anchorObject</em>.id
</div></div>
<p>Set the id property:</p>
<div class="code notranslate"><div>
	<em>anchorObject</em>.id=<i>id</i></div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><em>id</em></td>
		<td>Specifies the id of the anchor</td>
	</tr>
</table>
...
<tr>
	...
	<td>A String, representing the value of the id attribute of the link</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the id of a link:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;w3s&quot;).id=&quot;newid&quot;;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_anchor_id2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>A demonstration of how to change the id of an anchor to create a bookmark inside a 
document:</p>
<div class="example_code notranslate">
	document.getElementById("typo").id=&quot;C6&quot;;
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_anchor_id3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_global_id.asp">HTML id attribute</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_anchor_id.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_anchor_id.asp#top" target="_top">TOP</a> |
		<a href="prop_anchor_id.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
