...
<style>a.menu_jsref_tolowercase{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">toLowerCase()</span> Method</h1>
...
<div class="example_code notranslate">
	var str = &quot;Hello World!&quot;;<br>var res = str.toLowerCase();
</div>
<p>The result of <em>res</em> will be:</p>
<div class="example_code notranslate">
	hello world!</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tolowercase" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The toLowerCase() method converts a string to lowercase letters.</p>
<p><strong>Note:</strong> The toLowerCase() method does not change the original 
string.</p>
<p><strong>Tip:</strong> Use the <a href="jsref_touppercase.asp">toUpperCase()</a> 
method to convert a string to uppercase letters.</p>
<hr>
...
<p>The toLowerCase() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>string</i>.toLowerCase()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>String</td>
<td>The value of a string converted to lowercase</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_tolowercase.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_tolowercase.asp#top" target="_top">TOP</a> |
		<a href="jsref_tolowercase.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
