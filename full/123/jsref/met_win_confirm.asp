...
<style>a.menu_met_win_confirm{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">confirm()</span> Method</h1>
...
<p>Display a confirmation box:</p>
<div class="example_code notranslate">
	confirm(&quot;Press a button!&quot;);<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_confirm" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The confirm() method displays a dialog box with a specified message, along 
with an OK and a Cancel button.</p>
<p>A confirm box is often used if you want the user to verify or accept 
something.</p>
<p><strong>Note:</strong> The confirm box takes the focus away from the current window, and forces the 
browser to read the message. Do not overuse this method, as it prevent the user 
from accessing other parts of the page until the box is closed.</p>
<p>The confirm() method returns true if the user clicked &quot;OK&quot;, and false otherwise.</p>
<hr>
...
<p>The confirm() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	confirm(<em>message</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>message</em></td>
    <td>Optional. Specifies the text to display in the confirm 
	box. This parameter is required in Firefox.</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<td>Boolean</td>
<td>
A boolean value indicating whether &quot;OK&quot; or &quot;Cancel&quot; was clicked in the dialog 
box:
<ul>
	<li>true - the user clicked &quot;OK&quot;</li>
	<li>false - the user clicked &quot;Cancel&quot; or the &quot;x&quot; (close) button that is 
	available in all major browsers, except Firefox.</li>
</ul>
	</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Display a confirm box, and write what the user clicked:</p>
<div class="example_code notranslate">
	var r = confirm(&quot;Press a button!&quot;);<br>if (r == true)<br>&nbsp; {<br>&nbsp; x = 
	&quot;You pressed OK!&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; x = &quot;You pressed Cancel!&quot;;<br>&nbsp; }</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_confirm2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Confirm box with line-breaks:</p>
<div class="example_code notranslate">
	confirm(&quot;Press a button!\nEither OK or Cancel.&quot;);</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_confirm3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_confirm.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_confirm.asp#top" target="_top">TOP</a> |
		<a href="met_win_confirm.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
