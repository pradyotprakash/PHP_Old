...
<style>a.menu_prop_anchor_download{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Anchor <span class="color_h1">download</span> Property</h1>
...
<p>Return the value of the download attribute of a link:</p>
<div class="example_code notranslate">
var x = document.getElementById("w3s").download;
</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	w3logo</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_anchor_download" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The download property sets or returns the value of the download attribute of a link.</p>
<p>The download attribute specifies the hyperlink target to be downloaded.</p>
<hr>
...
<p>The download property is supported in Firefox, Opera and Chrome.</p>
<p><strong>Note:</strong> The download property is not supported in Internet 
Explorer, Safari or Opera 12 
and earlier versions.</p>
<hr>

<h2>Syntax</h2>
<p>Return the download property:</p>
<div class="code notranslate"><div>
	<em>anchorObject</em>.download
</div></div>
<p>Set the download property:</p>
<div class="code notranslate"><div>
	<em>anchorObject</em>.download=<i>filename</i></div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><i>filename</i></td>
		<td>
		Specifies some text to be used as the filename (no need to specify the 
		file extension - the browser will automatically detect the correct file 
		extension and add it to the file, e.g. .img, .pdf. .txt, .html, etc.)</td>
	</tr>
</table>
...
<tr>
	...
	<td>A String, representing the value of the download attribute of the link</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the value of the download attribute of a link:</p>
<div class="example_code notranslate">
	document.getElementById("w3s").download=&quot;newValue&quot;;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_anchor_download2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/att_a_download.asp">HTML &lt;a&gt; download attribute</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_anchor_download.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_anchor_download.asp#top" target="_top">TOP</a> |
		<a href="prop_anchor_download.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
