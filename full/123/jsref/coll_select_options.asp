...
<title>HTML DOM Select options Collection</title>
<style>a.menu_coll_select_options{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Select <span class="color_h1">options</span> Collection</h1>
<p><a href="dom_obj_select.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Select Object Reference" /> Select Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Loop through all options in a drop-down list, and output the text:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;);<br>var txt = &quot;&quot;;<br>for (var i=0; 
	i&lt;x.length; i++)<br>&nbsp; {<br>&nbsp; txt = txt + x.options[i].text + &quot;&lt;br&gt;&quot;;<br>&nbsp; 
	}<br>document.getElementById(&quot;demo&quot;).innerHTML=txt;</div>
<p>The result of <em>txt</em> will be:</p>
<div class="example_code notranslate">

	Apple<br>
	Orange<br>
	Pineapple<br>Banana</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_options">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The options collection returns a collection of all the options in a drop-down list.</p>
<p><b>Note:</b> There will be one array element for each &lt;option&gt; tag - starting at 0.</p>
<p><b>Note:</b> The elements in the collection are sorted as they appear in the 
source code.</p>
<hr>
...
<p>The options collection is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>selectObject</em>.options</div></div>
<h2>Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of option elements in the collection</td>
  </tr>
  <tr>
    <td>selectedIndex</td>
    <td>Sets or returns the index of the selected option in a select object 
	(starts at 0)</td>
  </tr>
  </table>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>An integer that specifies the element to retrieve (starts at 0)</td>
    </tr>
  <tr>
    <td>[add(<i>option</i>[,<i>index</i>])]</td>
    <td>Adds an option element into the collection at the specified index. If no 
	index is specified, it inserts the option element at the end of the 
	collection </td>
    </tr>
  <tr>
    <td>item(<i>index</i>)</td>
    <td>Returns the element from the collection with the specified index 
	(starts at 0)</td>
    </tr>
  <tr>
    <td>namedItem(<i>name_or_id</i>)</td>
    <td>Returns the element from the collection with the specified name (name or 
	id attribute)</td>
    </tr>
  <tr>
    <td>remove(<i>index</i>)</td>
    <td>Removes the element with the specified index from the collection</td>
    </tr>
  </table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Show the number of options in a drop-down list:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;).options.length;<br>
	document.getElementById(&quot;demo&quot;).innerHTML=&quot;Found &quot; + x + &quot; option elements 
	in the list.&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_options2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Change the items in a drop-down list depending on the selected option in 
another drop-down list:</p>
<div class="example_code notranslate">
	var carsAndModels = {};<br>carsAndModels['VO'] = ['V70','XC60','XC90'];<br>
	carsAndModels['VW'] = ['Golf','Polo','Scirocco','Touareg'];<br>carsAndModels['BMW'] 
	= ['M6','X5','Z3'];<br><br>function ChangeCarList()<br>{<br>var carList = 
	document.getElementById(&quot;car&quot;);<br>var modelList = document.getElementById(&quot;carmodel&quot;);<br>
	var selCar = carList.options[carList.selectedIndex].value;<br>while (modelList.options.length)<br>&nbsp; 
	{<br>&nbsp; modelList.remove(0);<br>&nbsp; }<br>var cars = carsAndModels[selCar];<br>
	if (cars)<br>&nbsp; {<br>&nbsp; for (var i=0; i&lt;cars.length; i++)<br>&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp; var car = new Option(cars[i],i);<br>&nbsp;&nbsp;&nbsp; 
	modelList.options.add(car);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_options3">Try it yourself &raquo;</a>
</div>
<br>
...
<h2 class="example">Example</h2>
<p>[<em>index</em>]</p>
	<p>Return the text of the first option (index 0) in a drop-down list:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;).options[0].text;<br>
	document.getElementById(&quot;demo&quot;).innerHTML=x;</div>
			<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	Apple</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_options4">Try it yourself &raquo;</a>
</div>
<br>
...
<p>item(<em>index</em>)</p>
	<p>Return the text of the first option (index 0) in a drop-down list:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;).options.item(0).text;<br>
	document.getElementById(&quot;demo&quot;).innerHTML=x;</div>
		<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	Apple</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_options5">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>namedItem(<em>name_or_id</em>)</p>
	<p>Return the text of the option with id=&quot;apple&quot; in a drop-down list:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;).options.namedItem(&quot;apple&quot;).text;<br>
	document.getElementById(&quot;demo&quot;).innerHTML=x;</div>
		<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	Apple</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_options6">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Add a &quot;Kiwi&quot; option at index position &quot;1&quot; of a drop-down list:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;);<br>var option = 
	document.createElement(&quot;option&quot;);<br>option.text = &quot;Kiwi&quot;;<br>x.options.add(option,1);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_options7">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Remove the option with index &quot;1&quot; from a drop-down list:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;);<br>x.options.remove(1);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_options8">Try it yourself &raquo;</a>
</div>
<br>

<hr>
<a href="dom_obj_select.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Select Object Reference" /> Select Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="coll_select_options.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="coll_select_options.asp#top" target="_top">TOP</a> |
		<a href="coll_select_options.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
