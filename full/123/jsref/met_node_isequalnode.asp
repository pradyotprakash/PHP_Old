...
<title>HTML DOM isEqualNode Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_node_isequalnode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">isEqualNode()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Check if two list items in two different list are equal:</p>
<div class="example_code notranslate">
	var item1=document.getElementById(&quot;myList1&quot;).firstChild;<br>
	var item2=document.getElementById(&quot;myList2&quot;).firstChild;<br>
	item1.isEqualNode(item2);</div>
	<p>The result will be:</p>
<div class="example_code notranslate">
false
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_isequalnode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isEqualNode() method checks if two nodes are equal.</p>
<p>Two nodes are equal if all the following conditions are true:</p>
<ul>
<li>They have the same Node Type</li>
	<li>They have the same nodeName, NodeValue, localName, nameSpaceURI and 
	prefix</li>
	<li>They have the same childNodes with all the descendants</li>
	<li>They have the same attributes and attribute values (the attributes does 
	not have be in the same order)</li>
</ul>
<p><strong>Tip:</strong> Use the <a href="met_node_issamenode.asp">isSameNode() method</a> to 
determine if two nodes are the same node.</p>
<hr>
...
<p>The isEqualNode() method is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet Explorer 8 and earlier does not support this method.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>node</i>.isEqualNode(<i>node</i>)</div></div>
...
<tr>
<td>Boolean</td>
<td><em>true</em> if the two nodes are equal, otherwise <em>false</em></td>
</tr>
</table>
...
<table class="tecspec">
<tr>
	<th style="width:17%;">DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_isequalnode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_isequalnode.asp#top" target="_top">TOP</a> |
		<a href="met_node_isequalnode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
