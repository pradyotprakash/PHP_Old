...
<title>Window stop() Method</title>
<style>a.menu_met_win_stop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">stop()</span> Method</h1>
...
<p>Stop the window from loading:</p>
<div class="example_code notranslate">
	window.stop();<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_stop" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The stop() method stops window loading. </p>
<p>This method is the same as clicking on the browser's stop button.</p>
<p>This method may be useful if the loading of an image or frame takes too long.</p>
...
<p>The stop() method is supported in all major browsers, except Internet 
Explorer.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_stop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_stop.asp#top" target="_top">TOP</a> |
		<a href="met_win_stop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
