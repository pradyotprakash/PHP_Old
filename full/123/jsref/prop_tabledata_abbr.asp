...
<title>HTML DOM th abbr Property</title>
<style>a.menu_prop_tabledata_abbr{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>th <span class="color_h1">abbr</span> Property</h1>
...
<p>Return the value of the abbr attribute of a &lt;th&gt; element with id &quot;myTh&quot;:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myTh&quot;).abbr;<br>document.getElementById(&quot;demo&quot;).innerHTML=x;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	Make</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_th_abbr" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The abbr property sets or returns the value of the abbr attribute.</p>
<p>The abbr attribute specifies an abbreviated version of the content in a 
data cell (for non-visual media such as speech or Braille).</p>
<p>If this property is set, the user will only hear the value of the abbr 
attribute (not the whole content of the cell).</p>
<hr>
...
<p>The abbr property is supported in all major browsers. However, the 
functionality of this property is not implemented in any of the major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the abbr property:</p>
<div class="code notranslate"><div>
	<em>thObject</em>.abbr
</div></div>
<p>Set the abbr property:</p>
<div class="code notranslate"><div>
	<em>thObject</em>.abbr=<i>text</i></div></div>
<p><b>Tip:</b> There is no default value for the abbr property.<br></p>
<table class="reference notranslate">
	...
	<tr>
		<td><i>text</i></td>
		<td>Specifies a short description of the header cell content</td>
	</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_tabledata_abbr.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_tabledata_abbr.asp#top" target="_top">TOP</a> |
		<a href="prop_tabledata_abbr.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
