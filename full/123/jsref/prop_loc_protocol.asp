...
<style>a.menu_prop_loc_protocol{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Location <span class="color_h1">protocol</span> Property</h1>
...
<p>Return the protocol portion of the current URL:</p>
<div class="example_code notranslate">
	var x = location.protocol;</div>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_loc_protocol">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The protocol property sets or returns the protocol of the current URL, 
including the colon (:).</p>
...
<h2>Syntax</h2>
<p>Return the protocol property:</p>
<div class="code notranslate"><div>
	location.protocol</div></div>
<p>Set the protocol property:</p>
<div class="code notranslate"><div>
	location.protocol=<em>protocol</em></div></div>
<br>
...
<td>String</td>
<td>
The protocol of the current URL, including the colon (:)</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_loc_protocol.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_loc_protocol.asp#top" target="_top">TOP</a> |
		<a href="prop_loc_protocol.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
