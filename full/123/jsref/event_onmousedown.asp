...
<style>a.menu_event_onmousedown{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">onmousedown</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Execute a JavaScript when pressing a mouse button over a paragraph:</p>
<div class="example_code notranslate">
&lt;p onmousedown=&quot;myFunction()&quot;&gt;Click the text!&lt;/p&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onmousedown" class="tryitbtn">Try it yourself &raquo;</a>
...
<p><b>Tip:</b> The order of events related to the onmousedown event (for the left/middle mouse button):</p>
<ol>
	<li>onmousedown</li>
	<li>onmouseup</li>
	<li>onclick</li>
</ol>
<p>The order of events related to the onmousedown event (for the right mouse button):</p>
<ol>
	<li>onmousedown</li>
	<li>onmouseup</li>
	<li>oncontextmenu</li>
...
onmousedown=&quot;<i>SomeJavaScriptCode</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>object</em>.onmousedown=function(){<i>SomeJavaScriptCode</i>};</div></div>
<br>
...
<table class="reference notranslate" id="table1">
  ...
  <tr>
    <td><i>SomeJavaScriptCode</i></td>
    <td>Required. Specifies a JavaScript to be executed when the event occurs</td>
  </tr>
</table>
<br>
<hr>
...
onmousedown event is supported in all major browsers.</p>
<hr>

<h2>onmousedown In HTML</h2>
<p>The onmousedown attribute can be used within ALL HTML elements, EXCEPT: &lt;base&gt;, &lt;bdo&gt;, &lt;br&gt;, 
...
<p><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onmousedown2">Alert which mouse button that was pressed</a><br>
Alert which mouse button the user pressed.</p>

<p><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_event_srcelement">Alert the element the user clicked on</a><br>
Alert the name of the element the user clicked on.</p>

<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_onmousedown.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_onmousedown.asp#top" target="_top">TOP</a> |
		<a href="event_onmousedown.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
