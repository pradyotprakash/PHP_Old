...
<style>a.menu_prop_node_nodevalue{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">nodeValue</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Get the node value of the first button element:</p>
<div class="example_code notranslate">
	document.getElementsByTagName("BUTTON")[0].childNodes[0].nodeValue;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
Try it yourself
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_nodevalue" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The nodeValue property sets or returns the node value of the specified node.</p>
<p><strong>Note:</strong> If you want to return the text of an element, remember 
that text is always inside a <em>Text node</em>, and you will have to return the
<em>Text node's</em> node value (<em>element</em>.childNodes[0].nodeValue).</p>
<p><strong>Tip:</strong> An alternative to the nodeValue property can be the <a href="prop_node_textcontent.asp">
textContent property</a>.</p>
<hr>
...
<p>The nodeValue property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<p>Set the node value:</p>
<div class="code notranslate"><div>
<em>node</em>.nodeValue=<em>value</em>
</div></div>
<p>Return the node value:</p>
<div class="code notranslate"><div>
<em>node</em>.nodeValue</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A String, representing the value of the node</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_nodevalue.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_nodevalue.asp#top" target="_top">TOP</a> |
		<a href="prop_node_nodevalue.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
