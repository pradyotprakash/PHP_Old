...
<title>HTML DOM attributes Property</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_prop_node_attributes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">attributes</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Get a collection of an element's attributes:</p>
<div class="example_code notranslate">
	document.getElementsByTagName("BUTTON")[0].attributes;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_attributes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The attributes property returns a collection of the specified node&#39;s attributes, as a NamedNodeMap.</p>
<p>
<strong>Tip: </strong>You can use the length property to determine the number of attributes, then you can loop through all attributes nodes and extract the info you want.
</p>
<p>
<strong>Tip: </strong>Each attribute is a Node object, with all the properties available for the Node object.
</p>
<hr>
...
<p>The attributes property is supported in all major browsers.</p>
<p><strong>Note:</strong> In Internet Explorer 8 and earlier, the attributes property will return a collection of 
<em>all possible</em> attributes for an element.</p>
<hr>
<h2>Syntax</h2>
...
<tr>
	...
	<td width="75%">A NamedNodeMap object, representing a collection of attributes</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_attributes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_attributes.asp#top" target="_top">TOP</a> |
		<a href="prop_node_attributes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
