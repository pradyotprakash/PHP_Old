...
<title>HTML DOM replaceChild Method</title>
...
<h1>HTML DOM <span class="color_h1">replaceChild()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Replace an item in a list with a new item:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myList&quot;).replaceChild(<em>newnode</em>,<em>oldnode</em>);</div>
<p>Before removing:</p>
<div class="example_code notranslate">
...
<p>After removing:</p>
<div class="example_code notranslate">
<ul><li>Water</li><li>Tea</li><li>Milk</li></ul>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_replacechild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<i>node</i>.replaceChild(<i>newnode</i>,<i>oldnode</i>)</div></div>
...
<td><em>oldnode</em></td>
<td>Node object</td>
<td>Required. The node object you want to remove</td>
</tr>
</table>
