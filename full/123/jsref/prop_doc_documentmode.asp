...
<title>HTML DOM documentMode Property</title>
<style>a.menu_prop_doc_documentmode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">documentMode</span> Property</h1>
...
<p>The documentMode property returns the mode used by the browser to render the current document.</p>
<p>IE8 can render a page in different modes, depending on the !DOCTYPE or the presence of certain HTML elements.</p>
<p>This property returns one of following values:</p>
<ul>
	<li>5 - The page is displayed in IE5 mode</li>
	<li>7 - The page is displayed in IE7 mode</li>
	<li>8 - The page is displayed in IE8 mode</li>
	<li>9 - The page is displayed in IE9 mode</li>
</ul>
<p><b>Note:</b> If no !DOCTYPE is specified, IE8 renders the page in IE5 mode!</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>
document.documentMode</div></div><br>
<hr>
...
<p>The documentMode is an IE only property, supported in IE8+.</p>
<hr>

<h2>Example</h2>
<div class="example">
<h2 class="example">Example</h2>
<p>Return the mode used by the browser to render the current document:</p>
<div class="example_code notranslate">
&lt;html&gt;<br>
&lt;body&gt;<br>
<br>
This document is displayed in:<br>
&lt;script&gt;<br>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_doc_documentmode">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_document.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Document Object Reference" /> Document Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_doc_documentmode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_doc_documentmode.asp#top" target="_top">TOP</a> |
		<a href="prop_doc_documentmode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
