...
<style>a.menu_met_win_prompt{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">prompt()</span> Method</h1>
...
<p>Display a prompt box which ask the user for her/his name, and then write a 
greeting to the page:</p>
<div class="example_code notranslate">
	var person = prompt(&quot;Please enter your name&quot;,&quot;Harry Potter&quot;);<br>
	<br>if (person!=null)<br>&nbsp; {<br>&nbsp; x = &quot;Hello &quot; + person + &quot;! How are you 
	today?&quot;;<br>&nbsp; document.getElementById(&quot;demo&quot;).innerHTML=x;<br>} </div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_prompt" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The prompt() method displays a dialog box that prompts the visitor for input.</p>
<p>A prompt box is often used if you want the user to input a value before 
entering a page.</p>
<p><strong>Note:</strong> When a prompt box pops up, the user will have to click either &quot;OK&quot; or 
&quot;Cancel&quot; to proceed after entering an input value. Do not overuse this 
method, as it prevent the user from accessing other parts of the page until the 
box is closed.</p>
<p>The prompt() method returns the input value if the user clicks &quot;OK&quot;. If the 
user clicks &quot;cancel&quot; the method returns null.</p>
<hr>
...
<p>The prompt() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	prompt(<i>text,defaultText</i>)</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <tr>
    <td><em>defaultText</em></td>
    <td>Optional. The default input value</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<td>String</td>
<td>
If the user clicks &quot;OK&quot;, the input value is returned. If the user clicks 
&quot;cancel&quot;, null is returned. If the user clicks OK without entering any text, an 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_prompt.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_prompt.asp#top" target="_top">TOP</a> |
		<a href="met_win_prompt.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
