...
<title>Window moveBy() Method</title>
<style>a.menu_met_win_moveby{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">moveBy()</span> Method</h1>
...
<p>Open a new window, and move the new window 250px relative to its current 
position:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_moveby" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The moveBy() method moves a window a specified number of pixels relative to its current coordinates. </p>
...
<p>The moveBy() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.moveBy(<em>x,y</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>x</em></td>
    <td>Required. A positive or negative number that specifies the amount of pixels to move the window horziontally</td>
  </tr>
   <tr>
    <td><em>y</em></td>
    <td>Required. A positive or negative number that specifies the amount of 
	pixels to move the window vertically</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="tecspec">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_moveby.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_moveby.asp#top" target="_top">TOP</a> |
		<a href="met_win_moveby.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
