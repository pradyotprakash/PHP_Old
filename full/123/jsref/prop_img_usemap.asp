...
<title>HTML DOM Image useMap Property</title>
<style>a.menu_prop_img_usemap{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Image <span class="color_h1">useMap</span> Property</h1>
...
<p>Return the value of the usemap attribute of an image:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;planets&quot;).useMap;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	#planetmap</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_img_usemap" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The useMap property sets or returns the value of the usemap attribute of an 
image.</p>
<p>The usemap attribute specifies an image as a client-side image-map (an 
image-map is an image with clickable areas).</p>
<p>The usemap attribute is associated with a map element's name attribute, and 
creates a relationship between the image and the map.</p>
<hr>
...
<p>The useMap property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the useMap property:</p>
<div class="code notranslate"><div>

	<em>imageObject</em>.useMap</div></div>
<p>Set the useMap property:</p>
<div class="code notranslate"><div>

	<em>imageObject</em>.useMap=<em>#mapname</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td>#<i>mapname</i></td>
    <td>A hash character (&quot;#&quot;) plus the name of the map element to use</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>The value of the usemap attribute of the image, including the hash character 
(&quot;#&quot;)</td>
</tr>
</table>
<br>
...
<p>Set the useMap property:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;planets&quot;).useMap=&quot;#planetmap&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_img_usemap2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_img_usemap.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_img_usemap.asp#top" target="_top">TOP</a> |
		<a href="prop_img_usemap.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
