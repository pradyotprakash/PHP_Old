...
<title>shiftKey Event Attribute</title>
<style>a.menu_event_shiftkey{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">shiftKey</span> Event Attribute</h1>
...
<p>The shiftKey event attribute returns a Boolean value that indicates whether or not the &quot;SHIFT&quot; key was 
...
<p>The following example alerts whether or not the &quot;SHIFT&quot; key was pressed when 
a mouse button is clicked:</p>
...
pressed the shift key or not.&lt;/p&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_event_shiftkey" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_shiftkey.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_shiftkey.asp#top" target="_top">TOP</a> |
		<a href="event_shiftkey.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
