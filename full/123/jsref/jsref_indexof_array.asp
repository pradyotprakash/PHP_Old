...
<style>a.menu_jsref_indexof_array{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Array <span class="color_h1">indexOf()</span> Method</h1>
...
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_indexof_array" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The indexOf() method searches the array for the specified item, and returns its position.</p>
<p>The search will start at the specified position, or at the beginning if no start position is specified, and end the search at the end of the array.</p>
<p>Returns -1 if the item is not found.</p>
<p>If the item is present more than once, the indexOf method returns the position of the first occurence.</p>
<p><strong>Note:</strong> The first item has position 0, the second item has position 1, and so on.</p>
<p><strong>Tip:</strong> If you want to search from end to start, use the <a href="jsref_lastindexof_array.asp">lastIndexOf() method</a></p>
<hr>
...
<p>The indexOf() method is not supported in Internet Explorer 8 and earlier.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>array</i>.indexOf(<em>item</em>,<em>start</em>)</div></div>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_indexof_array2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_indexof_array.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_indexof_array.asp#top" target="_top">TOP</a> |
		<a href="jsref_indexof_array.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
