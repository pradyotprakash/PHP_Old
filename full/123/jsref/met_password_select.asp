...
<title>HTML DOM Password select() Method</title>
<style>a.menu_met_password_select{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Password <span class="color_h1">select()</span> Method</h1>
...
<p>Select the content of a password field:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myPsw&quot;).select();</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_password_select" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The select() method is used to select the content of a 
password field.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_password_select.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_password_select.asp#top" target="_top">TOP</a> |
		<a href="met_password_select.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
