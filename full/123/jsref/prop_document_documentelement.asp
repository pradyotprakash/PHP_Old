...
<title>HTML DOM documentElement Property</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_prop_document_documentelement{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">documentElement</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the document's documentElement:</p>
<div class="example_code notranslate">
	document.documentElement;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_documentelement" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The documentElement property returns the documentElement of a document, as an Element object.</p>
<p>For HTML documents the returned object is the HTML element.</p>
<p><strong>Note:</strong> If the HTML element is missing, the return value is <em>null</em>.</p>
<hr>
...
<p>The documentElement property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
document.documentElement</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The document's documentElement, as an Element object.</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_document_documentelement.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_document_documentelement.asp#top" target="_top">TOP</a> |
		<a href="prop_document_documentelement.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
