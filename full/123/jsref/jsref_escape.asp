...
<title>JavaScript escape() Function</title>
<style>a.menu_jsref_escape{font-weight:bold;}</style>
<meta charset="utf-8">
...
{
  win=window.open(text,'','top=0,left=0,width=400,height=345');
}
</script>
</head>
<body>
...
<h1>JavaScript <span class="color_h1">escape()</span> Function</h1>
...
<div class="example_code notranslate">
Need%20tips%3F%20Visit%20W3Schools%21</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_escape" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p><span class="marked">The escape() function was 
<a href="javascript:NewWindow('deprecated.htm')">deprecated</a>  in JavaScript version 1.5.</span> Use
<a href="jsref_encodeuri.asp">encodeURI()</a> or
<a href="jsref_encodeuricomponent.asp">encodeURIComponent()</a> instead.</p>
<p>The escape() function encodes a string.</p>
<p>This function makes a string portable, so it can be transmitted across 
any network to any computer that supports ASCII characters.</p>
<p>This function encodes special characters, with the exception of: * @ - _ + . /</p>
<hr>
...
<p>The escape() function is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
escape(<em>string</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. The string to be encoded</td>
  </tr>
  </table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_escape.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_escape.asp#top" target="_top">TOP</a> |
		<a href="jsref_escape.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
