...
<style>a.menu_prop_nodelist_length{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h2 class="example">Example</h2>
	<p class="example">Return the number of child nodes of the body element:</p>
<div class="example_code notranslate">
	document.body.childNodes.length;</div>
<p class="example">The result could be:</p>
<div class="example_code notranslate">
	8</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nodelist_length" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The length property returns the number of nodes in a collection.</p>
<p>A Node object's collection of child nodes is an example of a NodeList object</p>
<hr>
...
<tr>
	...
	<td width="75%">A Number, representing the number of nodes in the nodelist</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_nodelist_length.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_nodelist_length.asp#top" target="_top">TOP</a> |
		<a href="prop_nodelist_length.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
