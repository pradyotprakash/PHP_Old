...
<style>a.menu_jsref_regexp_nfollow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_ahead" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ?=<i>n</i> quantifier matches any string that is followed by a specific string <i>n</i>.</p>
<p><strong>Tip:</strong> Use the <a href="jsref_regexp_nfollow_not.asp">?!<i>n</i></a> 
quantifier to match any string that is NOT followed by a specific string <em>n</em>.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_regexp_nfollow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_regexp_nfollow.asp#top" target="_top">TOP</a> |
		<a href="jsref_regexp_nfollow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
