...
<title>HTML DOM Input Button disabled Property</title>
<style>a.menu_prop_button_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Input Button <span class="color_h1">disabled</span> Property</h1>
<p><a href="dom_obj_button.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Input Button Object Reference" /> Input Button Object</a>
</p>

<div class="example">
<h2 class="example">Example</h2>
<p>Find out if a button is disabled or not:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myBtn&quot;).disabled;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">true</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_button_disabled">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether an input button is disabled, or not.</p>
...
<div class="code notranslate"><div>
	<em>buttonObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="code notranslate"><div>
	<em>buttonObject</em>.disabled=true|false</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>true|false</td>
		<td>
		Specifies whether a input button 
		should be disabled or not.
		<ul>
			<li>true - The input button is disabled</li>
			<li>false - Default. The input button is not disabled</li>
		</ul>
		</td>
	</tr>
</table>
...
<tr>
<td>Boolean</td>
<td>Returns true if the input button is disabled, otherwise it returns false</td>
</tr>
</table>
<br>
<hr>
...
<div class="example_code notranslate">
	document.getElementById(&quot;myBtn&quot;).disabled=true;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
	<button disabled="disabled">My Button</button>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_button_disabled2">Try it yourself &raquo;</a>
</div>

<br>
<div class="example">
<h2 class="example">Example</h2>
<p>Disable and undisable a button:</p>
<div class="example_code notranslate">
	function disableBtn()<br>&nbsp; {<br>&nbsp; document.getElementById(&quot;myBtn&quot;).disabled=true;<br>&nbsp; 
	}<br>function undisableBtn()<br>&nbsp; {<br>&nbsp; document.getElementById(&quot;myBtn&quot;).disabled=false;<br>&nbsp; 
	}<br>
	</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_button_disabled3">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<a href="dom_obj_button.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Input Button Object Reference" /> Input Button Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_button_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_button_disabled.asp#top" target="_top">TOP</a> |
		<a href="prop_button_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
