...
<style>a.menu_prop_nav_useragent{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Navigator <span class="color_h1">userAgent</span> Property</h1>
...
<p>The user-agent header sent by your browser:</p>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nav_useragent">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The userAgent property returns the value of the user-agent header sent by the 
browser to the server.</p>
<p>The value returned, contains information about the name, version and platform 
of the browser.</p>
<hr>
...
<p>The userAgent property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
navigator.userAgent</div></div>
<h2>Return Value</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_nav_useragent.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_nav_useragent.asp#top" target="_top">TOP</a> |
		<a href="prop_nav_useragent.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
