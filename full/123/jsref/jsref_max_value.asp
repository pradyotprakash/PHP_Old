...
<title>JavaScript MAX_VALUE Property</title>
<style>a.menu_jsref_max_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">MAX_VALUE</span> Property</h1>
...
<p>Return the largest number possible in JavaScript.</p>
<div class="example_code notranslate">
Number.MAX_VALUE;
</div>
<p>The result will be:</p>
<div class="example_code notranslate">
1.7976931348623157e+308</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_max_value" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Sice MAX_VALUE is a property of the Number object wrapper, you always use it 
as Number.MAX_VALUE.</p>
<p>Using x.MAX_VALUE, where x a Number object you have created, will return 
undefined.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The MAX_VALUE property returns the largest number possible in JavaScript.</p>
<p>This static property has a value of
1.7976931348623157e+308.</p>
<p><b>Note:</b> Numbers larger than MAX_VALUE are represented as infinity.</p>
<hr>

<h2>Always Use Number.MAX_VALUE</h2>
<p>MAX_VALUE is a static property of the JavaScript Number object. You can 
ony use it 
as Number.MAX_VALUE.</p>
<p>Using x.MAX_VALUE, where x is a number or Number object, will return 
undefined:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var x = 100;<br>x.MAX_VALUE;</div>
<p>The value of x will be:</p>
<div class="example_code notranslate">
	undefined</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_max_value_obj" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>The MAX_VALUE property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Number.MAX_VALUE</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A Number, 1.7976931348623157e+308</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_max_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_max_value.asp#top" target="_top">TOP</a> |
		<a href="jsref_max_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
