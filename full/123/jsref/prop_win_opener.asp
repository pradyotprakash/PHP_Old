...
<title>Window opener Property</title>
<style>a.menu_prop_win_opener{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">opener</span> Property</h1>
...
<p>Write some text to the source (parent) window:</p>
...
<p>The opener property returns a reference to the window that created the window.</p>
<p>When opening a window with the <a href="met_win_open.asp">window.open()</a> 
method, you can use this property from the 
destination window to return details of the source (parent) window.</p>
<p><b>Coding Tip:</b> window.opener.close() will close the source (parent) 
window.</p>
<hr>
...
<p>The opener property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.opener</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A reference to the window that created the window</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_win_opener.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_win_opener.asp#top" target="_top">TOP</a> |
		<a href="prop_win_opener.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
