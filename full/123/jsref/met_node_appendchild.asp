...
<title>HTML DOM appendChild() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_node_appendchild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">appendChild()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Append an item in a list:</p>
<div class="example_code notranslate">
	document.getElementById("myList").appendChild(<em>newListItem</em>);</div>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_appendchild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The appendChild() method appends a node as the last child of a node.</p>
<p><strong>Tip:</strong> If you want create a new paragraph, with text, remember to create the text as a Text node which you append to the paragraph, <em>then</em> append the paragraph to the document.</p>
<p>You can also use the appendChild() method to move an element from one element to another.</p>
<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Move a list item from one list to another:</p>
<div class="example_code notranslate">
	var node=document.getElementById(&quot;myList2&quot;).lastChild;<br>
	document.getElementById(&quot;myList1&quot;).appendChild(node);</div>
<p>Before appending:</p>
<div class="example_code notranslate">
<ul><li>Coffee</li><li>Tea</li></ul>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_appendchild2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The appendChild() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>node</em>.appendChild(<em>node</em>)</div></div>
...
<td><em>node</em></td>
<td>Node object</td>
<td>Required. The node object you want to append</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_appendchild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_appendchild.asp#top" target="_top">TOP</a> |
		<a href="met_node_appendchild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
