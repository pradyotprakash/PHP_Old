...
<title>HTML DOM Form submit() Method</title>
<style>a.menu_met_form_submit{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Form <span class="color_h1">submit()</span> Method</h1>
...
document.getElementById(&quot;myForm&quot;).submit();</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_form_submit" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The submit() method submits the form (same as clicking the Submit button).</p>
<p><strong>Tip:</strong> Use the <a href="met_form_reset.asp">reset()</a> method 
to reset the form.</p>
<hr>
...
<p>The submit() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>formObject</em>.submit()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_form_submit.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_form_submit.asp#top" target="_top">TOP</a> |
		<a href="met_form_submit.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
