...
<style>a.menu_jsref_getminutes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">getMinutes()</span> Method</h1>
...
<p>Return the minutes, according to local time:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getminutes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getMinutes() method returns the minutes (from 0 to 59) of the 
...
<p>The getMinutes() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.getMinutes()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>Number</td>
<td>A Number, from 0 to 59, representing minutes</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the minutes from a specific date and time:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getminutes2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<div class="tryit_ex">
<img src="http://www.w3schools.com/images/tryitimg.gif" style="width:40px;height:46px" alt="Examples">
<p><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_datetime">Display the time</a><br>
How to use getHours(), getMinutes(), and getSeconds() to display the time.</p>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_getminutes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_getminutes.asp#top" target="_top">TOP</a> |
		<a href="jsref_getminutes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
