...
<html lang="en-US">
<head>
<title>HTML DOM Image Object</title>
<style>a.menu_dom_obj_image{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Image</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_frame.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_button.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Image Object</h2>
<p>The Image object represents an embedded image.</p>
<p>For each &lt;img&gt; tag in an HTML document, an Image object is created.</p>
<p>Notice that images are not technically inserted into an HTML page, images are 
linked to HTML pages. The &lt;img&gt; tag creates a holding space for the referenced 
image.</p>

<hr>

<h2>Image Object Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
	...
	<a href="prop_style_cssfloat.asp">style.cssFloat</a> instead.</span><br>Sets or returns the value of the align attribute of an image</td>
  </tr>
  <tr>
    <td><a href="prop_img_alt.asp">alt</a></td>
    <td>Sets or returns the value of the alt attribute of an image</td>
  </tr>
  <tr>
    <td>border</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_border.asp">style.border</a> 
	instead.</span><br>Sets or returns the value of the border attribute of an image</td>
  </tr>
  <tr>
    <td><a href="prop_img_complete.asp">complete</a></td>
    <td>Returns whether or not the browser is finished loading an image</td>
  </tr>
  <tr>
    <td><a href="prop_img_height.asp">height</a></td>
    <td>Sets or returns the value of the height attribute of an image</td>
  </tr>
  <tr>
    <td>hspace</td>
    <td><span class="deprecated">Not supported in HTML5. Use
	<a href="prop_style_margin.asp">style.margin</a> instead.</span><br>Sets or returns the value of the hspace attribute of an image</td>
  </tr>
  <tr>
    <td>longDesc</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Sets or returns the value of the longdesc attribute of an image</td>
  </tr>
   <tr>
    <td>name</td>
    <td><span class="deprecated">Not supported in HTML5. Use id instead.</span><br>Sets or returns the value of the 
	name attribute of an image</td>
  </tr>
  <tr>
    <td><a href="prop_img_src.asp">src</a></td>
    <td>Sets or returns the value of the src attribute of an image</td>
  </tr>
  <tr>
    <td><a href="prop_img_usemap.asp">useMap</a></td>
    <td>Sets or returns the value of the usemap attribute of an image</td>
  </tr>
  <tr>
    <td>vspace</td>
    <td><span class="deprecated">Not supported in HTML5. Use
	<a href="prop_style_margin.asp">style.margin</a> instead.</span><br>Sets or returns the value of the vspace attribute of an image</td>
  </tr>
  <tr>
    <td><a href="prop_img_width.asp">width</a></td>
    <td>Sets or returns the value of the width attribute of an image</td>
  </tr>
</table>

<!--
<h2>Image Object Events</h2>
<table class="reference notranslate">
  <tr>
    <th style="width:20%">Event</th>
    <th>The event occurs when...</th>
  </tr>
  <tr>
    <td><a href="event_img_onabort.asp">onabort</a></td>
    <td>Loading of an image is interrupted</td>
  </tr>
  <tr>
    <td><a href="event_img_onerror.asp">onerror</a></td>
    <td>An error occurs when loading an image</td>
    </tr>
  <tr>
    <td><a href="event_img_onload.asp">onload</a></td>
    <td>An image is finished loading</td>
    </tr>
</table>
-->

<h2>Standard Properties and Events</h2>
<p>The Image object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_image.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_image.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_image.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
