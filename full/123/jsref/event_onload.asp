...
<style>a.menu_event_onload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">onload</span> Event</h1>
...
<p>Execute a JavaScript when a page is finished loading:</p>
<div class="example_code notranslate">
&lt;body onload=&quot;myFunction()&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_body_onload">Try it yourself &raquo;</a>
...
<p>onload is most often used within the &lt;body&gt; element to execute a script once 
...
&lt;body
onload=&quot;<i>SomeJavaScriptCode</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	window.onload=function(){<i>SomeJavaScriptCode</i>};</div>
</div>
<br>
...
<p>The onload event is supported in all major browsers.</p>
<hr>

<h2>onload is Supported by the Following HTML Tags:</h2>
<div class="code notranslate"><div>

&lt;body&gt;, &lt;frame&gt;, &lt;frameset&gt;, &lt;iframe&gt;, &lt;img&gt;, &lt;input type=&quot;image&quot;&gt;, 
&lt;link&gt;, &lt;script&gt;, &lt;style&gt;</div>
</div>
<br>
<hr>
...
<p><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_img_onload">onload on &lt;img&gt;</a><br>
Alert &quot;Image is loaded&quot; immediately after an image has been loaded.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_onload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_onload.asp#top" target="_top">TOP</a> |
		<a href="event_onload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
