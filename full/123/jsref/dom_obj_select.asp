...
<html lang="en-US">
<head>
<title>HTML DOM Select Object</title>
<style>a.menu_dom_obj_select{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Select</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_option.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_style.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Select Object</h2>
<p>The Select object represents a drop-down list in an HTML form.</p>
<p>A drop-down list lets a user select one or more options of a limited number of 
choices.</p>
<p>For each &lt;select&gt; tag in an HTML form, a Select object is created.</p>
<p>You can access a Select object by searching through the elements[] array of a form, or by using document.getElementById().</p>


<hr>

<h2>Select Object Collections</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="coll_select_options.asp">options</a></td>
    <td>Returns a collection of all the options in a drop-down list</td>
  </tr>
  </table>

<h2>Select Object Properties</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="prop_select_disabled.asp">disabled</a></td>
    <td>Sets or returns whether the drop-down list is disabled, or not</td>
    </tr>    
  <tr>
    <td><a href="prop_select_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_length.asp">length</a></td>
    <td>Returns the number of &lt;option&gt; elements in a drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_multiple.asp">multiple</a></td>
    <td>Sets or returns whether more than one option can be selected from the 
	drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of a drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_selectedindex.asp">selectedIndex</a></td>
    <td>Sets or returns the index of the selected option in a 
	drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_size.asp">size</a></td>
    <td>Sets or returns the value of the size of a drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_type.asp">type</a></td>
    <td>Returns which type of form element a drop-down list is</td>
  </tr>
  </table>

<h2>Select Object Methods</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_select_add.asp">add()</a></td>
    <td>Adds an option to a drop-down list</td>
    </tr>
  <tr>
    <td><a href="met_select_remove.asp">remove()</a></td>
    <td>Removes an option from a drop-down list</td>
    </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Select object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_select.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_select.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_select.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
