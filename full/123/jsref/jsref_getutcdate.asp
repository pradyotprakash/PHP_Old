...
<style>a.menu_jsref_getutcdate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">getUTCDate()</span> Method</h1>
...
<p>Return the day of the month, according to universal time:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutcdate" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getUTCDate() method returns the day of the month (from 1 to 31) of the 
date object, according to universal time.</p>
...
<p>The getUTCDate() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
...
<tr>
<td>Number</td>
<td>A Number, from 1 to 31, representing the day of the month</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the UTC day of the month of a specific, local time, date-time:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutcdate2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_getutcdate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_getutcdate.asp#top" target="_top">TOP</a> |
		<a href="jsref_getutcdate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
