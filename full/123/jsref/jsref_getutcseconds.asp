...
<style>a.menu_jsref_getutcseconds{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">getUTCSeconds()</span> Method</h1>
...
<p>Return the seconds, according to universal time:</p>
<div class="example_code notranslate">
var d = new Date();<br>
var n = d.getUTCSeconds();
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getutcseconds" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getUTCSeconds() method returns the seconds (from 0 to 59) of the 
...
<p>The getUTCSeconds() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.getUTCSeconds()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>Number</td>
<td>A Number, from 0-59, representing the seconds</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_getutcseconds.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_getutcseconds.asp#top" target="_top">TOP</a> |
		<a href="jsref_getutcseconds.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
