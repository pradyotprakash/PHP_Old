...
<style>a.menu_jsref_shift{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Array <span class="color_h1">shift()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_shift" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<h2>Definition and Usage</h2>
<p>The shift() method removes the first item of an array, and returns that item.</p>
<p><b>Note:</b> This method changes the length of an array!</p>
<p><b>Tip:</b> To remove the last item of an array, use the <a href="jsref_pop.asp">pop()</a> method.</p>
<hr>
...
<p>The shift() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>array</i>.shift()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<p>*An array item can be a string, a number, an array, a boolean, or any other object types that are allowed in an array.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_shift.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_shift.asp#top" target="_top">TOP</a> |
		<a href="jsref_shift.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
