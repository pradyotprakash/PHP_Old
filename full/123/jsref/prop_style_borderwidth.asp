...
<title>HTML DOM Style borderWidth Property</title>
<style>a.menu_prop_style_borderwidth{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">borderWidth</span> Property</h1>
...
<p>Change the width of the four borders of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.borderWidth=&quot;thick&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderwidth">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The borderWidth property sets or returns the width of an element's border.</p>
<p>This property can take from one to four values:</p>
<ul>
	<li>One value, like: p {border-width: thick} - all four 
	borders will be thick</li>
	<li>Two values, like: p {border-width: thick thin} - the 
	top and bottom border will be thick, left and right border will be thin</li>
	<li>Three values, like: p {border-width: thick thin medium}- 
	the top border will be thick, left and right border will be thin, bottom 
	border will be medium</li>
	<li>Four values, like: p {border-width: thick thin medium 
	10px} - the top border will be thick, right border will be thin, bottom 
	border will be medium, left border will be 10px</li>
</ul>
<hr>
...
<p>The borderWidth property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the borderWidth property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderWidth
</div></div>
<p>Set the borderWidth property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderWidth=&quot;thin|medium|thick|<i>length</i>|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>medium</td>
		<td>Defines a medium border. This is default</td>
	</tr>
	<tr>
		<td>thick</td>
	...
	<tr>
		<td><i>length</i></td>
		<td>The width of the border in length units</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The width of the border is inherited from the 
		parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the width of an element's border</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the width of the top and bottom border to thick, and the left and 
right border to thin of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.borderWidth=&quot;thick thin&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderwidth2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Change the width of the four borders of a &lt;div&gt; element, using the <em>length</em> 
value:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.borderWidth=&quot;1px 5px 10px 
	20px&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderwidth3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the width of the border of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.borderWidth);<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderwidth4">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_border-width.asp">border-width property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_borderwidth.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_borderwidth.asp#top" target="_top">TOP</a> |
		<a href="prop_style_borderwidth.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
