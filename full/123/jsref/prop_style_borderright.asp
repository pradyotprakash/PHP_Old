...
<title>HTML DOM Style borderRight Property</title>
<style>a.menu_prop_style_borderright{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">borderRight</span> Property</h1>
...
<p>Add a right border to a &lt;div&gt; element:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.borderRight=&quot;thick solid #0000FF&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderright">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The borderRight property sets or returns up to three separate border-right properties, in a shorthand form.</p>
...
<p>The borderRight property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the borderRight property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderRight
</div></div>
<p>Set the borderRight property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderRight=&quot;<i>width style color</i>&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><i><a href="prop_style_borderrightwidth.asp">width</a></i></td>
		<td>Sets the width of the right border</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_borderrightstyle.asp">style</a></i></td>
		<td>Sets the style of the right border</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_borderrightcolor.asp">color</a></i></td>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the width, style and/or color of the right border of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the width, style and color of the right border of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myDiv&quot;).style.borderLeft=&quot;thin dotted red&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderright2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the border-right property values of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.borderLeft);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderright3">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_border-right.asp">border-right property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_borderright.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_borderright.asp#top" target="_top">TOP</a> |
		<a href="prop_style_borderright.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
