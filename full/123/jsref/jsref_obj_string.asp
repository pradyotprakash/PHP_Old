...
<style>a.menu_jsref_obj_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="jsref_obj_regexp.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>String Object</h2>
<p>The String object is used to manipulate a stored piece of text.</p>
<p>String objects are created with new String().</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
var txt = new String(&quot;<i>string</i>&quot;);<p>or more simply:</p>
var txt = &quot;<i>string</i>&quot;;</div></div>
<p>For a tutorial about the String object, read our <a href="../js/js_obj_string.asp">JavaScript String Object tutorial</a>.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns the function that created the String object's prototype</td>
  </tr>
  <tr>
...
<p>The HTML wrapper methods return the string wrapped inside the appropriate 
HTML tag.</p>
<p><span class="marked">These are not standard methods, and may not work as 
expected in all browsers.</span></p>
<table class="reference notranslate">
  <tr>
    <th style="width:24%">Method</th>
    <th>Description</th>
  ...
  <tr>
    ...
    <td>Creates an anchor</td>
  </tr>
  <tr>
    <td><a href="jsref_big.asp">big()</a></td>
    <td>Displays a string using a big font</td>
  </tr>
  <tr>
    <td><a href="jsref_blink.asp">blink()</a></td>
    <td>Displays a blinking string</td>
  </tr>
  <tr>
    <td><a href="jsref_bold.asp">bold()</a></td>
    <td>Displays a string in bold</td>
  </tr>
  <tr>
    <td><a href="jsref_fixed.asp">fixed()</a></td>
    <td>Displays a string using a fixed-pitch font</td>
  </tr>
  <tr>
    <td><a href="jsref_fontcolor.asp">fontcolor()</a></td>
    <td>Displays a string using a specified color</td>
  </tr>
  <tr>
    <td><a href="jsref_fontsize.asp">fontsize()</a></td>
    <td>Displays a string using a specified size</td>
  </tr>
  <tr>
    <td><a href="jsref_italics.asp">italics()</a></td>
    <td>Displays a string in italic</td>
  </tr>
  <tr>
    <td><a href="jsref_link.asp">link()</a></td>
    <td>Displays a string as a hyperlink</td>
  </tr>
  <tr>
    <td><a href="jsref_small.asp">small()</a></td>
    <td>Displays a string using a small font</td>
  </tr>
  <tr>
    <td><a href="jsref_strike.asp">strike()</a></td>
    <td>Displays a string with a strikethrough</td>
  </tr>
  <tr>
    <td><a href="jsref_sub.asp">sub()</a></td>
    <td>Displays a string as subscript text</td>
  </tr>
  <tr>
    <td><a href="jsref_sup.asp">sup()</a></td>
    <td>Displays a string as superscript text</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_obj_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_obj_string.asp#top" target="_top">TOP</a> |
		<a href="jsref_obj_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
