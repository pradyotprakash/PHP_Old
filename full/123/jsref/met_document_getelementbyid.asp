...
<style>a.menu_met_document_getelementbyid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">getElementById()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the element with the specified ID:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;demo&quot;);<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_getelementbyid" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<h2>Definition and Usage</h2>
<p>The getElementById() method returns the element that has the ID attribute with the specified value.</p>
...
<p>Returns <em>null</em> if no elements with the specified ID exists.</p>
<p>If more than one element with the specified ID exists, the getElementById() method returns the first element.</p>
<hr/>
...
<p>The getElementById() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
document.getElementById(<em>elementID</em>)</div></div>
...
<td>String</td>
<td>Required. The ID attribute's value of the element you want to get</td>
</tr>
</table>
...
<td>The element with the specified ID</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_getelementbyid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_getelementbyid.asp#top" target="_top">TOP</a> |
		<a href="met_document_getelementbyid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
