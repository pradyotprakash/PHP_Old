...
<title>HTML DOM Style fontSizeAdjust Property</title>
<style>a.menu_prop_style_fontsizeadjust{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">fontSizeAdjust</span> Property</h1>
...
document.getElementById(&quot;myP&quot;).style.fontSizeAdjust=&quot;0.58&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_fontsizeadjust">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The fontSizeAdjust property sets or returns the font aspect value of a text.</p>
<p>All fonts have an <b>aspect value</b> which is the size-difference between 
the lowercase letter &quot;x&quot; and the uppercase letter &quot;X&quot;.</p>
<p>The fontSizeAdjust property gives you better control of the font size when 
...
the font size. To prevent this, use this property.</p>
<p>When the browser knows the aspect value for the first choice-font, the 
...
<p>The fontSizeAdjust property is only supported in Firefox.</p>
<hr>

<h2>Syntax</h2>
<p>Return the fontSizeAdjust property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.fontSizeAdjust
</div></div>
<p>Set the fontSizeAdjust property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.fontSizeAdjust=&quot;none|<i>value</i>|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>none</td>
		<td>Do not preserve x-height of first-choice font. This is default</td>
	</tr>
	<tr>
		<td><i>value</i></td>
		<td>Preserve the first-choice font's x-height, and calculate the aspect value ratio for the font.<br><br>
		The formula that is used:	font-size of first-choice font*(aspect value of first-choice font/aspect value of available font)=font-size to use on available font<br><br>
		Example: If 14px Verdana (aspect value of 0.58) was unavailable, but the available font, Times New Roman, has an aspect value of 0.46, the adjusted font-size to use would be 14*(0.58/0.46) = 17.65px.</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the fontSizeAdjust property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the font aspect value of a text</td>
</tr>
</table>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_font_font-size.asp">font-size property</a></p>
<p>HTML DOM reference: <a href="prop_style_font.asp">font property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_fontsizeadjust.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_fontsizeadjust.asp#top" target="_top">TOP</a> |
		<a href="prop_style_fontsizeadjust.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
