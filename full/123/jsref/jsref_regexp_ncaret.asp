...
<title>RegExp ^ Quantifier</title>
<style>a.menu_jsref_regexp_ncaret{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript RegExp <span class="color_h1">^</span> Quantifier</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_caret" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <i>^n</i> quantifier matches any string with <i>n</i> at the beginning of it.</p>
<p><strong>Tip:</strong> Use the <a href="jsref_regexp_ndollar.asp"> <i>n</i>$</a> quantifier 
to match any string with <i>n</i> at the END of it.</p>
<hr>
...
<p>The ^ quantifier is supported in all major browsers.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_regexp_ncaret.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_regexp_ncaret.asp#top" target="_top">TOP</a> |
		<a href="jsref_regexp_ncaret.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
