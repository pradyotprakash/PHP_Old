...
<title>Window clearTimeout() Method</title>
<style>a.menu_met_win_cleartimeout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">clearTimeout()</span> Method</h1>
...
<p>Prevent the function set with the setTimeout() to execute:</p>
<div class="example_code notranslate">
	var myVar;<br><br>function myFunction()<br>{<br>myVar = setTimeout(function(){alert(&quot;Hello&quot;)},3000);<br>
	}<br><br>function myStopFunction()<br>{<br>clearTimeout(myVar);<br>}<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_cleartimeout" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The clearTimeout() method clears a timer set with the 
<a href="met_win_settimeout.asp">setTimeout()</a> method.</p>

<p>The ID value returned by setTimeout() is used as the parameter for the clearTimeout() method.</p>
<p><strong>Note:</strong> To be able to use the clearTimeout() method, you must 
use a global variable when creating the timeout method:</p>
<div class="code notranslate"><div>
myVar = setTimeout(&quot;<i>javascript function</i>&quot;,<i>milliseconds</i>);</div>
</div>
<p>Then, if the function has not already been executed, you will be able to stop 
the execution by calling the clearTimeout() method.</p>
<hr>
...
<p>The clearTimeout() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
clearTimeout(<i>id_of_settimeout</i>)</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>id_of_settimeout</em></td>
    <td>Required. The ID value of the timer returned by the setTimeout() method</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="tecspec">
...
<div class="example">
<h2 class="example">Example</h2>
<p>The following example has a &quot;Start count!&quot; button to start a timer, an input 
field that will count forever, and a &quot;Stop count!&quot; button that will stop the 
timer:</p>
<div class="example_code notranslate">
	&lt;button onclick=&quot;startCount()&quot;&gt;Start count!&lt;/button&gt;<br>&lt;input type=&quot;text&quot; 
	id=&quot;txt&quot;&gt;<br>&lt;button onclick=&quot;stopCount()&quot;&gt;Stop count!&lt;/button&gt;<br><br>
	&lt;script&gt;<br>var c = 0;<br>var t;<br>var timer_is_on = 0;<br><br>
	function timedCount()<br>{<br>document.getElementById(&quot;txt&quot;).value=c;<br>c = 
	c+1;<br>t = setTimeout(function(){timedCount()},1000);<br>}<br><br>function 
	startCount()<br>{<br>if (!timer_is_on)<br>{<br>timer_is_on=1;<br>timedCount();<br>
	}<br>}<br><br>function stopCount()<br>{<br>clearTimeout(t);<br>timer_is_on=0;<br>
	}<br>&lt;/script&gt;</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_cleartimeout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_cleartimeout.asp#top" target="_top">TOP</a> |
		<a href="met_win_cleartimeout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
