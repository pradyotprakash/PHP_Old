...
<style>a.menu_jsref_obj_date{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="jsref_obj_boolean.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jsref_obj_math.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Date Object</h2>
<p>The Date object is used to work with dates and times.</p>
<p>Date objects are created with new Date().</p>
...
var d =
new Date(<em>dateString</em>);<br>
var d =
new Date(<em>year</em>, <em>month</em>, <em>day</em>, <em>hours</em>, <em>minutes</em>, <em>seconds</em>, <em>milliseconds</em>);
</div></div>

<p>For a tutorial about date and times, read our <a href="../js/js_obj_date.asp">
JavaScript Date Object tutorial</a>.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns the year, according to universal time (four digits)</td>
  </tr>
	<tr>
  ...
  <tr>
	...
	<a href="jsref_getfullyear.asp">getFullYear()</a> method instead</td>
  </tr>
  <tr>
    <td><a href="jsref_parse.asp">parse()</a></td>
    <td>Parses a date string and returns the number of milliseconds since midnight of January 1, 1970</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Sets the year (four digits) of a date object</td>
  </tr>
	<tr>
  ...
  <tr>
    ...
    <td>Sets a date and time by adding or subtracting a specified number of milliseconds to/from midnight January 1, 1970</td>
  </tr>
	<tr>
    ...
    <td>Sets the year of a date object, according to universal time (four digits)</td>
  </tr>
	<tr>
  ...
  <tr>
    <td>setYear()</td>
    <td><span class="deprecated">Deprecated.</span> Use the 
	<a href="jsref_setfullyear.asp">setFullYear()</a> method instead</td>
  </tr>
  <tr>
    ...
    <td>toGMTString()</td>
    <td><span class="deprecated">Deprecated.</span> Use the 
	<a href="jsref_toutcstring.asp">toUTCString()</a> method instead</td>
  </tr>
	<tr>
    <td><a href="jsref_toisostring.asp">toISOString()</a></td>
    <td>Returns the date as a string, using the ISO standard</td>
  </tr>
	<tr>
    <td><a href="jsref_tojson.asp">toJSON()</a></td>
    ...
    <td>Returns the date portion of a Date object as a string, using locale 
	conventions</td>
  </tr>
	<tr>
    <td><a href="jsref_tolocaletimestring.asp">toLocaleTimeString()</a></td>
    <td>Returns the time portion of a Date object as a string, using locale 
	conventions</td>
  </tr>
	<tr>
  ...
  <tr>
    ...
    <td>Returns the number of milliseconds in a date string since midnight of January 1, 1970, according to universal time</td>
  </tr>
  <tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_obj_date.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_obj_date.asp#top" target="_top">TOP</a> |
		<a href="jsref_obj_date.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
