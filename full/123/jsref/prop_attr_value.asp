...
<style>a.menu_prop_attr_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">value</span> Property</h1>
<p><a href="dom_obj_attributes.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Attributes Object Reference" /> Attribute Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Return the value of an attribute:</p>
<div class="example_code notranslate">
	document.getElementsByTagName("button")[0].attributes[0].value;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
	myFunction()
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_attr_value" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>Setting the value of an attribute</p>
<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Set the style attribute for a header Element:</p>
<div class="example_code notranslate">
var h=document.getElementsByTagName("H1")[0];<br>
h.getAttributeNode("style").value="color:green";</div>
<p>Before changing the style:</p>
<div class="example_code notranslate">
	<h1 style="color:red">Hello World</h1>
</div>
<p>After changing the style:</p>
<div class="example_code notranslate">
	<h1 style="color:green">Hello World</h1>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_attr_value2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The value property sets  or returns the value of the attribute.</p>
<hr>
...
<em>attribute</em>.value=<em>value</em>
</div></div>
<p>Return the attribute value</p>
<div class="code notranslate"><div>
<em>attribute</em>.value</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A String, representing the value of the attribute</td>
</tr>
<tr>
	<th>DOM Version</th>
	<td>Core Level 1</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_attr_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_attr_value.asp#top" target="_top">TOP</a> |
		<a href="prop_attr_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
