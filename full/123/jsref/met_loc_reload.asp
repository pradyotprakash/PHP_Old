...
<style>a.menu_met_loc_reload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Location <span class="color_h1">reload()</span> Method</h1>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_loc_reload">Try it yourself &raquo;</a>
</div>

<h2>Definition and Usage</h2>
<p>The reload() method is used to reload the current document.</p>
<p>The reload() method does the same as the reload button in your browser.</p>
<p>By default, the reload() method reloads from the cache, but by you can force the the reload to get the page from server by setting the forceGet parameter to
<strong>true</strong>: location.reload(true).</p>
...
<p>The reload() method is supported in all major browsers.</p>

<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
location.reload(<em>forceGet</em>)</div></div>
...
<tr>
<td><em>forceGet</em></td>
<td>Boolean</td>
<td>
Optional. Specifies the type of reloading:
<ul>
	<li>false - Default. Reloads the current page from the cache. </li>
	<li>true - The current page must be reloaded from the server</li>
</ul>
	</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_loc_reload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_loc_reload.asp#top" target="_top">TOP</a> |
		<a href="met_loc_reload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
