...
<title>JavaScript cos() Method</title>
<style>a.menu_jsref_cos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">cos()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_cos" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cos() method returns the cosine of a number.</p>

<p><b>Note:</b> The cos() method returns a numeric value between -1 and 1, which represents the cosine of the angle.</p>
<hr>
...
<p>The cos() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.cos(<em>x</em>)</div></div>
...
<tr>
<td>Number</td>
<td>A Number, from -1 to 1, representing the cosine of an angle, or NaN if the value is empty</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the  cosine PI and 2*PI:</p>
<div class="example_code notranslate">
var a=Math.cos(Math.PI);<br>
var b=Math.cos(2*Math.PI);
</div>
<p>The result of <em>a</em> and <em>b</em> will be:</p>
<div class="example_code notranslate">
-1<br>
1
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_cos2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_cos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_cos.asp#top" target="_top">TOP</a> |
		<a href="jsref_cos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
