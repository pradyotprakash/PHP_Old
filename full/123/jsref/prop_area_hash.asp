...
<title>HTML DOM Area hash Property</title>
<style>a.menu_prop_area_hash{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Area <span class="color_h1">hash</span> Property</h1>
...
<p>Return the anchor part of the href attribute for a specific area in an 
image-map:</p>
<div class="example_code notranslate">
	var x =
	document.getElementById(&quot;venus&quot;).hash;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	#description</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_area_hash" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The hash property sets or returns the anchor part of the href attribute value.</p>
<p>The anchor part is the part of the URL after the hash sign (#).</p>
<p><strong>Note:</strong> Do not use the hash sign (#) when you set the value of 
this property.</p>
<hr>
...
<div class="code notranslate"><div>
	<em>areaObject</em>.hash</div></div>
<p>Set the hash property:</p>
<div class="code notranslate"><div>
	<em>areaObject</em>.hash=<i>anchorname</i></div></div>
<br>
...
<tr>
<td>String</td>
<td>The anchor part, including the hash sign (#), of the href attribute value</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_area_hash.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_area_hash.asp#top" target="_top">TOP</a> |
		<a href="prop_area_hash.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
