...
<html lang="en-US">
<head>
<title>HTML DOM Submit Object</title>
<style>a.menu_dom_obj_submit{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Submit</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_reset.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_text.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Submit Object</h2>
<p>The Submit object represents a submit button in an HTML form.</p>
<p>Clicking on a submit button sends the named contents of the form to the 
server.</p>
<p>For each &lt;input type=&quot;submit&quot;&gt; tag in an HTML form, a Submit object is created.</p>
<p>You can access a submit button by searching through the elements[] array of the form, or by using document.getElementById().</p>
<p><b>Tip:</b> Clicking on a submit button fires the onsubmit event!</p>
<hr>

<h2>Submit Object Properties</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_submit_disabled.asp">disabled</a></td>
    <td>Sets or returns whether the submit button is disabled, or not</td>
    </tr>  
  <tr>
    <td><a href="prop_submit_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the submit button</td>
  </tr>
  <tr>
    <td><a href="prop_submit_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of a submit button</td>
  </tr>
  <tr>
    <td><a href="prop_submit_type.asp">type</a></td>
    <td>Returns which type of form element the submit button is</td>
  </tr>
  <tr>
    <td><a href="prop_submit_value.asp">value</a></td>
    <td>Sets or returns the value of the value attribute of the submit 
	button</td>
  </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Submit object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_submit.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_submit.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_submit.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
