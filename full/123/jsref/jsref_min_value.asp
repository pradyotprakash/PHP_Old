...
<title>JavaScript MIN_VALUE Property</title>
<style>a.menu_jsref_min_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">MIN_VALUE</span> Property</h1>
...
<p>Return the smallest number possible in JavaScript:</p>
...
<div class="example_code notranslate">
5e-324</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_min_value" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The MIN_VALUE property returns the smallest number possible in JavaScript.</p>
<p>This static property has a value of 5e-324.</p>
<p><b>Note:</b> Numbers smaller than this are converted to 0.</p>
<p><b>Note:</b> MIN_VALUE is the closest number to 0 possible in JavaScript. NOT the most negative number, which is the negative MAX_NUMBER.</p>
<hr>

<h2>Always Use Number.MIN_VALUE</h2>
<p>MIN_VALUE is a static property of the JavaScript Number object. You can 
ony use it 
as Number.MIN_VALUE.</p>
<p>Using x.MIN_VALUE, where x is a number or Number object, will return 
undefined:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	var x = 100;<br>x.MIN_VALUE;</div>
<p>The value of x will be:</p>
<div class="example_code notranslate">
	undefined</div>
<br><a class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_min_value_obj" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>The MIN_VALUE property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Number.MIN_VALUE</div></div><h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A Number, 5e-324</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_min_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_min_value.asp#top" target="_top">TOP</a> |
		<a href="jsref_min_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
