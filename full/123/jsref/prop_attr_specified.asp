...
<title>HTML DOM specified Property</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_prop_attr_specified{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">specified</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Find out if an attribute has been specified or not:</p>
<div class="example_code notranslate">
	document.getElementById("demo").attributes[0].specified;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
	true
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_attr_specified" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The specified property returns <em>true</em> if the attribute is specified.</p>
<p>Returns <em>true</em> also if the attribute has been created but not been attached to an element yet.</p>
<p>Otherwise it returns <em>false</em>.</p>
<hr>
...
<p>The specified property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>attribute</em>.specified</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_attr_specified.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_attr_specified.asp#top" target="_top">TOP</a> |
		<a href="prop_attr_specified.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
