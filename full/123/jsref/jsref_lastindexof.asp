...
<style>a.menu_jsref_lastindexof{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">lastIndexOf()</span> Method</h1>
...
var str = &quot;Hello planet earth, you are a great planet.&quot;;<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_lastindexof" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The lastIndexOf() method returns the position of the last occurrence of a specified value in a string.</p>
<p><b>Note:</b> The string is searched from the end to the beginning, but returns the index starting at the beginning, at postion 0.</p>
<p>This method returns -1 if the value to search for never occurs.</p>
<p><b>Note:</b> The lastIndexOf() method is case sensitive!</p>
<p><b>Tip:</b> Also look at the <a href="jsref_indexof.asp">indexOf()</a> method.</p>
<hr>
...
<p>The lastIndexOf() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>string</i>.lastIndexOf(<em>searchvalue</em>,<em>start</em>)
</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <tr>
    <td><em>start</em></td>
    <td>Optional. The position where to start the search (searching backwards). If omitted, the 
	default value is the length of the string</td>
  </tr>
  </table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>Number</td>
<td>The position where the specified searchvalue occurs for the last time, or -1 if it never occurs</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Search a string for the last occurrence of "planet", starting the search at position 20:</p>
<div class="example_code notranslate">
var str = &quot;Hello planet earth, you are a great planet.&quot;;<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_lastindexof2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_lastindexof.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_lastindexof.asp#top" target="_top">TOP</a> |
		<a href="jsref_lastindexof.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
