...
<title>HTML DOM Textarea readOnly Property</title>
<style>a.menu_prop_textarea_readonly{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Textarea <span class="color_h1">readOnly</span> Property</h1>
...
<p>Find out if a text area is read-only or not:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myTextarea&quot;).readOnly;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">true</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_textarea_readonly">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The readOnly property sets or returns whether the contents of a text area is 
    read-only.</p>
<p>In a read-only text area, the content cannot be changed, but a user can tab 
to it, or highlight and copy the content from it.</p>
<p><strong>Tip: </strong>To prevent the user from interacting with the text 
area, use the <a href="prop_textarea_disabled.asp">disabled</a> property instead.</p>
<hr>
...
<p>The readOnly property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the readOnly property:</p>
<div class="code notranslate"><div>
	<em>textareaObject</em>.readOnly
</div></div>
<p>Set the readOnly property:</p>
<div class="code notranslate"><div>
	<em>textareaObject</em>.readOnly=true|false
</div></div>
<br>
...
<table class="reference notranslate">
	...
	<tr>
		...
		<ul>
			<li>true - The text area is read-only</li>
			<li>false - Default. The text area is changeable</li>
		</ul>
		</td>
	</tr>
	</table>
...
<tr>
<td>Boolean</td>
<td>Returns true if the text area is read-only, otherwise it returns false</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set a text area to be read-only:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myTextarea&quot;).readOnly=true;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_textarea_readonly2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_textarea_readonly.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_textarea_readonly.asp#top" target="_top">TOP</a> |
		<a href="prop_textarea_readonly.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
