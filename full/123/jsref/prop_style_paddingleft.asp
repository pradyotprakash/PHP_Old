...
<style>a.menu_prop_style_paddingleft{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">paddingLeft</span> Property</h1>
...
<p>Set the left padding of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myDiv&quot;).style.paddingLeft=&quot;50px&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_paddingleft">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The paddingLeft property sets or returns the left padding of an element.</p>
...
<p>The paddingLeft property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the paddingLeft property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.paddingLeft
</div></div>
<p>Set the paddingLeft property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.paddingLeft=&quot;<i>%</i>|<i>length</i>|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><i>%</i></td>
		<td>Defines the left padding in % of the width of the parent element</td>
	</tr>
	<tr>
		<td><i>length</i></td>
		<td>Defines the left padding in length units </td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The left padding is inherited from the 
		parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the left padding of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the left padding of a &lt;div&gt; element back to &quot;normal&quot;:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.paddingLeft=&quot;0px&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_paddingleft2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the left padding of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.paddingLeft);<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_paddingleft3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Difference between marginLeft and paddingLeft:</p>
<div class="example_code notranslate">
	function changeMargin()<br>{<br>document.getElementById(&quot;myDiv&quot;).style.marginLeft=&quot;100px&quot;;<br>
	}<br>function changePadding()<br>{<br>document.getElementById(&quot;myDiv2&quot;).style.paddingLeft=&quot;100px&quot;;<br>
	}<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_marginpaddingleft">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_padding-left.asp">padding-left property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_paddingleft.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_paddingleft.asp#top" target="_top">TOP</a> |
		<a href="prop_style_paddingleft.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
