...
<title>HTML DOM Style textShadow Property</title>
<style>a.menu_prop_style_textshadow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">textShadow</span> Property</h1>
...
<p>Add shadow to a text:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myP&quot;).style.textShadow=&quot;5px 5px 1px #ff0000,10px 
	10px 1px #0000ff&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_textshadow">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The textShadow property sets or returns one ore more shadow effects for a text.</p>
<hr>
...
<p>The textShadow property is supported in all major browsers.</p>
<p><strong>Note:</strong> The textShadow property is not supported in Internet 
Explorer 9 and earlier versions.</p>
<hr>

<h2>Syntax</h2>
<p>Return the textShadow property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.textShadow
</div></div>
<p>Set the textShadow property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.textShadow=&quot;none|<i>h-shadow v-shadow blur color</i>|inherit&quot;
</div></div>
<p><b>Note:</b> The textShadow property attaches one or more shadows to text. 
The property is a comma-separated list of shadows, each specified by 2 or 3 
length values and an optional color. Omitted lengths are 0.</p>
<table class="reference notranslate">
	...
	<tr>
		<td>none</td>
		<td>No shadow is drawn. This is default</td>
	</tr>
	<tr>
		<td><i>h-shadow</i></td>
	...
	<tr>
		<td><i>color</i></td>
		<td>Optional. The color of the shadow. Look at
		<a href="../cssref/css_colors_legal.asp">CSS Color Values</a> for a complete 
		list of possible color values</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the textShadow property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing a comma-separated list of shadow effects applied 
	to the text of the element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the text shadow:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myP&quot;).style.textShadow);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_textshadow2">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="../css/css3_text_effects.asp">CSS3 Text Effects</a></p>
<p>CSS reference: <a href="../cssref/css3_pr_text-shadow.asp">text-shadow property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_textshadow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_textshadow.asp#top" target="_top">TOP</a> |
		<a href="prop_style_textshadow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
