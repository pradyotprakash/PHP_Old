...
<title>Window parent Property</title>
<style>a.menu_prop_win_parent{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">parent</span> Property</h1>
...
<p>Alert the location of the parent window when opening the new window:</p>
<div class="example_code notranslate">
window.open(&quot;&quot;,&quot;&quot;,&quot;width=200,height=100&quot;);<br>
alert(window.parent.location);</div>
<br><a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_parent">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The parent property returns the parent window of the current window.</p>
<hr>
...
<p>The parent property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.parent</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The parent window of the current window</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_win_parent.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_win_parent.asp#top" target="_top">TOP</a> |
		<a href="prop_win_parent.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
