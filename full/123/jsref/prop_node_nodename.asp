...
<title>HTML DOM nodeName Property</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_prop_node_nodename{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">nodeName</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Get the node name of the body element:</p>
<div class="example_code notranslate">
	document.body.nodeName;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
	BODY
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_nodename" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The nodeName property returns the name of the specified node.</p>
<p>If the node is an element node, the nodeName property will return the tagname.</p>
<p>If the node is an attribute node, the nodeName property will return the name of the attribute.</p>
<p>For other node types, the nodeName property will return different names for different node types.</p>
...
<p>The nodeName property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>node</em>.nodeName</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A String, representing the name of the node</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_nodename.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_nodename.asp#top" target="_top">TOP</a> |
		<a href="prop_node_nodename.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
