...
<title>HTML DOM Form acceptCharset Property</title>
<style>a.menu_prop_form_acceptcharset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Form <span class="color_h1">acceptCharset</span> Property</h1>
...
<p>Return the character-set the server should use for form submission:</p>
<div class="example_code notranslate">
var x = document.getElementById(&quot;myForm&quot;).acceptCharset;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
ISO-8859-1</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_form_acceptcharset" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The acceptCharset property sets or returns the value of the accept-charset attribute in a form element.</p>
<p>The accept-charset attribute specifies the character-sets that are to be used 
for the form submission.</p>
<p>The default value is the reserved string &quot;UNKNOWN&quot; (indicates that the 
encoding equals the encoding of the document containing the &lt;form&gt; element).</p>
<hr>
...
<p>The acceptCharset property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the acceptCharset property:</p>
<div class="code notranslate"><div>
	<em>formObject</em>.acceptCharset
</div></div>
<p>Set the acceptCharset property:</p>
<div class="code notranslate"><div>
	<em>formObject</em>.acceptCharset=<i>character-set</i></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>A space-separated list of one or more character encodings that are to be 
	used for the form submission.
    <p>Common values:</p>
	<ul>
		<li>UTF-8 - Character encoding for Unicode</li>
		<li>ISO-8859-1 - Character encoding for the Latin alphabet</li>
	</ul>
	<p>In theory, any character encoding can be used, but no browser understands all of them. The more widely a character encoding is used, the better the 
	chance that a browser will understand it.</p>
	<p>To view all available character encodings, go to our <a href="../tags/ref_charactersets.asp">Character sets reference</a>.</p></td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>The value of the accept-charset attribute in the form element</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the value of the accept-charset attribute in a form to UTF-8:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myForm&quot;).acceptCharset=&quot;UTF-8&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_form_acceptcharset2">Try it yourself &raquo;</a>
</div>
<br><hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_form_acceptcharset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_form_acceptcharset.asp#top" target="_top">TOP</a> |
		<a href="prop_form_acceptcharset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
