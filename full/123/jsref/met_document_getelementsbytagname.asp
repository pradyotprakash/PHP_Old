...
<style>a.menu_met_document_getelementsbytagname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h2 class="example">Example</h2>
	<p class="example">Return a collection of all elements with the specified tag name:</p>
<div class="example_code notranslate">
	document.getElementsByTagName(&quot;P&quot;);<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_getelementsbytagname" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<h2>Definition and Usage</h2>
<p>The getElementsByTagName() method returns a collection of all elements in the document with the specified tagname, as a NodeList object.</p>
<p><strong>Tip:</strong> The parametervalue "*" returns all elements in the document.</p>
<hr/>
...
document.getElementsByTagName(<em>tagname</em>)</div></div>
...
<td><em>tagname</em></td>
<td>String</td>
<td>Required. The tagname of the elements you want to get</td>
</tr>
</table>
...
<td>A collection of elements with the specified tagname</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_getelementsbytagname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_getelementsbytagname.asp#top" target="_top">TOP</a> |
		<a href="met_document_getelementsbytagname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
