...
<title>HTML DOM removeChild Method</title>
...
<h1>HTML DOM <span class="color_h1">removeChild()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Remove an item from a list:</p>
<div class="example_code notranslate">
	var list=document.getElementById(&quot;myList&quot;);<br>
	list.removeChild(list.childNodes[0]);</div>
<p>Before removing:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_removechild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The removeChild() method removes a specified child node of the specified element.</p>
<p>Returns the removed node as a Node object, or <em>null</em> if the node does not exist.</p>
<hr/>
...
<i>node</i>.removeChild(<i>node</i>)</div></div>
