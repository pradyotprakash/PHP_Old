...
<style>a.menu_jsref_fromcharcode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">fromCharCode()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_fromcharcode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The fromCharCode() method converts Unicode values into characters.</p>

<p><b>Note:</b> This is a static method of the String object, and the syntax is always String.fromCharCode().</p>
<hr>
...
<p>The fromCharCode() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
String.fromCharCode(<em>n1</em>, <em>n2</em>, ..., <em>nX</em>)</div></div>
...
<tr>
<td>String</td>
<td>The character(s) representing the specified unicode number(s)</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Convert a set of Unicode values into characters:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_fromcharcode2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_fromcharcode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_fromcharcode.asp#top" target="_top">TOP</a> |
		<a href="jsref_fromcharcode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
