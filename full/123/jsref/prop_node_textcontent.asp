...
<title>HTML DOM textContent Property</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_prop_node_textcontent{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">textContent</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Get the text content of the first button element:</p>
<div class="example_code notranslate">
	document.getElementsByTagName("BUTTON")[0].textContent;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
Try it yourself
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_textcontent" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The textContent property sets or returns the textual content of the specified node,
<strong>and all its descendants</strong>.</p>
<p>
If you <em>set</em> the textContent proerty, any child nodes are removed and replaced by 
a single Text node containing the specified string.</p>
<p><strong>Tip:</strong> Sometimes this property can be used instead of the 
nodeValue property, but remember that this property returns the text of all 
child nodes as well.</p>
<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Get all the textual content of a list:</p>
<div class="example_code notranslate">
document.getElementById("myList).textContent;</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_textcontent2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The textContent property is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet Explorer 8 and earlier does not support this property.</p>
<hr>
<h2>Syntax</h2>
<p>Set the text content of a node:</p>
<div class="code notranslate"><div>
<em>node</em>.textContent=<em>text</em></div></div>
<p>Return the text content of a node:</p>
<div class="code notranslate"><div>
<em>node</em>.textContent</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A String, representing the text of the node and all its descendants</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_textcontent.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_textcontent.asp#top" target="_top">TOP</a> |
		<a href="prop_node_textcontent.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
