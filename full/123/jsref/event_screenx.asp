...
<title>screenX Event Attribute</title>
<style>a.menu_event_screenx{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">screenX</span> Event Attribute</h1>
...
<p>The screenX event attribute returns the horizontal coordinate (according to 
the users computer screen) of the mouse 
...
<p>Alert the coordinates of the mouse pointer, when you click a paragraph:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_screenx.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_screenx.asp#top" target="_top">TOP</a> |
		<a href="event_screenx.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
