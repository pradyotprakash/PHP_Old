...
<title>HTML DOM Node lastChild Property</title>
...
<h1>HTML DOM <span class="color_h1">lastChild</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the last child node in a list:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myList&quot;).lastChild;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_lastchild" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The lastChild property returns the last child node of the specified node, as a Node object.</p>
<hr>
...
<p>The lastChild property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>node</em>.lastChild</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The last child of the node, as a Node object</td>
</tr>
<tr>
	<th>DOM Version</th>
