...
<html lang="en-US">
<head>
<title>HTML DOM FileUpload Object</title>
<style>a.menu_dom_obj_fileupload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">FileUpload</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_checkbox.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_hidden.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>FileUpload Object</h2>
<p>The FileUpload object represents a single-line text input control and a 
browse button, in an HTML form.</p>
<p>This object allow file uploading to a server. Clicking on the browse button 
opens the file dialog box that allows a user to select a file to upload.</p>
<p>For each &lt;input type=&quot;file&quot;&gt; tag in an HTML form, a FileUpload object is created.</p>
<p>You can access a FileUpload object by searching through the elements[] array of the form, or by using document.getElementById().</p>

<hr>

<h2>FileUpload Object Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_fileupload_accept.asp">accept</a></td>
    <td>Sets or returns the value of the accept attribute of the FileUpload 
	object</td>
  </tr>
  <tr>
    <td><a href="prop_fileupload_disabled.asp">disabled</a></td>
    <td>Sets or returns whether the FileUpload button is disabled, or not</td>
    </tr> 
  <tr>
    <td><a href="prop_fileupload_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the FileUpload object</td>
  </tr>
  <tr>
    <td><a href="prop_fileupload_name.asp">name</a></td>
    <td>Sets or returns the value of the name attribute of the FileUpload object</td>
  </tr>
  <tr>
    <td><a href="prop_fileupload_type.asp">type</a></td>
    <td>Returns which type of form element the FileUpload object is</td>
  </tr>
  <tr>
    <td><a href="prop_fileupload_value.asp">value</a></td>
    <td>Returns the path or the name of the selected file</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The FileUpload object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_fileupload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_fileupload.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_fileupload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
