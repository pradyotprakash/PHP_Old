...
<title>HTML DOM Table deleteRow() Method</title>
<style>a.menu_met_table_deleterow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Table <span class="color_h1">deleteRow()</span> Method</h1>
...
<p>Delete the first row in a table:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myTable&quot;).deleteRow(0);</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_deleterow" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The deleteRow() method removes the row at the specified index from a table.</p>
<p><strong>Tip:</strong> Use the <a href="met_table_insertrow.asp">insertRow()</a> 
to create and insert a new row.</p>
<hr>
...
<p>The deleteRow() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>tableObject</em>.deleteRow(<i>index</i>)
</div></div>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>index</i></td>
		<td>Required in Firefox and Opera, optional in IE, Chrome and Safari. An integer that specifies the position of the row to delete (starts 
		at 0). The value of 0 results in that the first row will be deleted.<br>
		<br>The value of -1 can also be used; which result in that the last 
		row will be deleted.<br>
		<br>
		This parameter is required in Firefox and Opera, but optional in Internet 
		Explorer, Chrome and Safari.<br>
		<br>
		If this parameter is omitted, deleteRow() removes the last row in IE and 
		the first row in Chrome and Safari.</td>
	</tr>
</table>
<h2>Return Value</h2>
<table class="tecspec">
...
<div class="example">
<h2 class="example">Example</h2>
<p>Delete the row you click on:</p>
<div class="example_code notranslate">
	function deleteRow(r)<br>{<br>var i = r.parentNode.parentNode.rowIndex;<br>
	document.getElementById(&quot;myTable&quot;).deleteRow(i);<br>}</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_deleterow2">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_table_deleterow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_table_deleterow.asp#top" target="_top">TOP</a> |
		<a href="met_table_deleterow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
