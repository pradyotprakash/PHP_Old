...
<style>a.menu_jsref_tolocaleuppercase{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">toLocaleUpperCase()</span> Method</h1>
...
<div class="example_code notranslate">
	var str = &quot;Hello World!&quot;;<br>var res = str.toLocaleUpperCase();
</div>
<p>The result of <em>res</em> could be:</p>
<div class="example_code notranslate">
	HELLO WORLD!</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_tolocaleuppercase" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The toLocaleUpperCase() method converts a string to uppercase letters, 
...
<a href="jsref_touppercase.asp">toUpperCase()</a> method. However, for some 
locales, where language conflict with the regular Unicode case 
mappings occurs (such as Turkish), the results may vary.</p>
<p><strong>Note:</strong> The toLocaleUpperCase() method does not change the original 
string.</p>
<p><strong>Tip:</strong> Use the <a href="jsref_tolocalelowercase.asp">toLocaleLowerCase()</a> 
...
<p>The toLocaleUpperCase() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>string</i>.toLocaleUpperCase()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>String</td>
<td>The value of a string converted to uppercase according to the host's current 
locale</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_tolocaleuppercase.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_tolocaleuppercase.asp#top" target="_top">TOP</a> |
		<a href="jsref_tolocaleuppercase.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
