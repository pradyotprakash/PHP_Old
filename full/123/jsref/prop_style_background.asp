...
<title>HTML DOM Style background Property</title>
<style>a.menu_prop_style_background{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">background</span> Property</h1>
...
<p>Style the background of a document:</p>
<div class="example_code notranslate">
document.body.style.background=&quot;#f3f3f3 url('img_tree.png') no-repeat right 
top&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_background">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The background property sets or returns up to eight separate background 
properties, in a shorthand form.</p>
<p>With this property, you can set/return one or more of the following (in any 
order):</p>
<ul>
...
<p>The properties above can also be set with separate style properties. The use 
...
<p>The background property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the background property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.background
</div></div>
<p>Set the background property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.background=&quot;<i>color image
repeat attachment position size origin clip</i>&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><i><a href="prop_style_backgroundcolor.asp">color</a></i></td>
		<td>Sets the background color of an element</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_backgroundimage.asp">image</a></i></td>
		<td>Sets the background image for an element</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_backgroundrepeat.asp">repeat</a></i></td>
		<td>Sets how a background image will be repeated</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_backgroundattachment.asp">attachment</a></i></td>
		<td>Sets whether a background image is fixed or scrolls with the page</td>
	</tr>
	<tr>
		<td><i><a href="prop_style_backgroundposition.asp">position</a></i></td>
		<td>Sets the starting position of a background image</td>
	</tr>
	<tr>
		<td><i>size</i></td>
		<td>Sets the size of a background image</td>
	</tr>
	<tr>
		<td><i>origin</i></td>
		<td>Sets the background positioning area</td>
	</tr>
	<tr>
		<td><i>clip</i></td>
		<td>Sets the painting area of a background image</td>
	</tr>
</table>
...
<tr>
	...
	<td width="80%">transparent none repeat scroll 0% 0% auto padding-box 
	border-box</td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A String, representing the background of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set a background color for a document:</p>
<div class="example_code notranslate">
document.body.style.backgroundColor=&quot;red&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundcolor">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Set a background image for a document:</p>
<div class="example_code notranslate">
document.body.style.backgroundImage=&quot;url('img_tree.png')&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundimage">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set the background-image to be fixed (will not scroll):</p>
<div class="example_code notranslate">
document.body.style.backgroundAttachment=&quot;fixed&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundattachment">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Change the position of a background-image:</p>
<div class="example_code notranslate">
	document.body.style.backgroundPosition=&quot;top right&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundposition">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the background property values of a document:</p>
<div class="example_code notranslate">
	document.body.style.background;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_background2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/css3_pr_background.asp">background property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_background.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_background.asp#top" target="_top">TOP</a> |
		<a href="prop_style_background.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
