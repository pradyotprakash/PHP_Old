...
<html lang="en-US">
<head>
<title>HTML DOM Base Object</title>
<style>a.menu_dom_obj_base{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Base</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_area.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_pushbutton.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Base Object</h2>
<p>The Base object represents an HTML base element.</p>
<p>The base element is used to specify a default address or a default target for 
all links on a page.</p>
<p>For each &lt;base&gt; tag in an HTML document, a Base object is created.</p>

<hr>

<h2>Base Object Properties</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_base_href.asp">href</a></td>
    <td>Sets or returns the value of the href attribute in a base element</td>
  </tr>
  <tr>
    <td><a href="prop_base_target.asp">target</a></td>
    <td>Sets or returns the value of the target attribute in a base element</td>
  </tr>
</table>
<h2>Standard Properties and Events</h2>
<p>The Base object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_base.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_base.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_base.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
