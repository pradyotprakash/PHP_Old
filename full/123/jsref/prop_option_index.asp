...
<title>HTML DOM Option index Property</title>
<style>a.menu_prop_option_index{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Option <span class="color_h1">index</span> Property</h1>
...
<p>The index property sets or returns the index position of an option in a drop-down list.</p>
...
<p>The index property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the index property:</p>
<div class="code notranslate"><div>
	<em>optionObject</em>.index
</div></div>
<p>Set the index property:</p>
<div class="code notranslate"><div>
	<em>optionObject</em>.index=<i>integer</i>
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		...
		<td>
		Specifies 
		the index position of the option within a drop-down list</td>
	</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>Number</td>
<td>The index position of the option within a drop-down list. The index 
starts at 0.</td>
</tr>
</table>
<br>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Display the text and index of all options in a drop-down list:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;);<br>var txt = &quot;All options: &quot;;<br>
	var i;<br>for (i=0; i&lt;x.length; i++)<br>&nbsp; {<br>&nbsp; txt = txt + &quot;\n&quot; 
	+ x.options[i].text + &quot; has index: &quot; + x.options[i].index;<br>&nbsp; }<br>
	alert(txt);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_option_index2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_option_index.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_option_index.asp#top" target="_top">TOP</a> |
		<a href="prop_option_index.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
