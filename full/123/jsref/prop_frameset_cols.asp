...
<title>HTML DOM Frameset cols Property</title>
<style>a.menu_prop_frameset_cols{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Frameset <span class="color_h1">cols</span> Property</h1>
<a href="dom_obj_frameset.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Frameset Object Reference" /> Frameset Object</a>
<hr>

<h2>Definition and Usage</h2>

<p>The cols property sets or returns the value of the cols attribute in a frameset.</p>
<p>The cols attribute specifies the size of, and the number of frames in a 
frameset. Each frame’s width is specified in a comma-separated list.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>

framesetObject.cols=<i>values</i>
</div></div>

<p>The cols property can have one or more of the following values:</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>pixels</i></td>
    <td>The column size in pixels (like &quot;100px&quot; or just &quot;100&quot;)</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>The column size in percent of the available space (like &quot;50%&quot;)</td>
  </tr>
	<tr>
    <td>*</td>
    <td>The rest of the available space should be assigned this column</td>
  </tr>
	</table>
<br>
<hr>
...
<h2>Example</h2>
<p>Create a frameset 
with two columns. Each column is set to 50% of the browser window:</p>

<div class="code notranslate"><div>

&lt;html&gt;<br>
&lt;frameset id=&quot;main&quot; cols=&quot;50%,50%&quot;&gt;<br>
&nbsp; &lt;frame src=&quot;frame_cols.htm&quot;><br>
&nbsp; &lt;frame src=&quot;frame_a.htm&quot;><br>
&lt;/frameset&gt;<br>
&lt;/html&gt;
</div></div>

<p>The source code of &quot;frame_cols.htm&quot; is as follows:</p>
<div class="example">
...
&lt;head&gt;<br>
&lt;script&gt;<br>
function changeCols()<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;parent.document.getElementById(&quot;main&quot;).cols=&quot;30%,70%&quot;<br>
&nbsp;&nbsp;}<br>
function restoreCols()<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;parent.document.getElementById(&quot;main&quot;).cols=&quot;50%,50%&quot;<br>
&nbsp;&nbsp;}<br>
&lt;/script&gt;<br>
&lt;/head&gt;<br>
&lt;body&gt;<br>
...
value=&quot;Change column size&quot;><br>
&lt;input type=&quot;button&quot; onclick=&quot;restoreCols()&quot;
value=&quot;Restore column size&quot;><br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_frameset_cols">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_frameset.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Frameset Object Reference" /> Frameset Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_frameset_cols.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_frameset_cols.asp#top" target="_top">TOP</a> |
		<a href="prop_frameset_cols.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
