...
<style>a.menu_jsref_push{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Array <span class="color_h1">push()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_push" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The push() method adds new items to the end of an array, and returns the new length.</p>
<p><b>Note:</b> The new item(s) will be added at the end of the array.</p>
<p><b>Note:</b> This method changes the length of the array.</p>
<p><b>Tip:</b> To add items at the beginning of an array, use the <a href="jsref_unshift.asp">unshift()</a> method.</p>
<hr>
...
<p>The push() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>array</i>.push(<em>item1</em>, <em>item2</em>, ..., <em>itemX</em>)</div></div>
...
<tr>
<td>Number</td>
<td>The new length of the array</td>
</tr>
</table>
...
<table class="tecspec">
<tr>
	<th style="width:27%">JavaScript Version:</th>
	<td>1.2</td>
</tr>
</table>
<br>
...
<div class="example_code notranslate">
Banana,Orange,Apple,Mango,Kiwi,Lemon,Pineapple</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_push2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_push.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_push.asp#top" target="_top">TOP</a> |
		<a href="jsref_push.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
