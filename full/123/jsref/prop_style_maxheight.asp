...
<title>HTML DOM Style maxHeight Property</title>
<style>a.menu_prop_style_maxheight{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">maxHeight</span> Property</h1>
...
<p>Set the maximum height of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.maxHeight=&quot;15px&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_maxheight">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The maxHeight property sets or returns the maximum height of an element.</p>
<p>The maxHeight property has effect only on block-level elements or on elements 
with absolute or fixed position.</p>
<p><b>Note:</b> The height of an element can never be greater than the value 
specified by the maxHeight property.</p>
<p><strong>Tip:</strong> To set or return the minimum height of an element, use 
the <a href="prop_style_minheight.asp">minHeight</a> property.</p>
<hr>
...
<p>The maxHeight property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the maxHeight property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.maxHeight
</div></div>
<p>Set the maxHeight property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.maxHeight=&quot;none|<i>length|%</i>|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>none</td>
		<td>No limit on the height of the element. This is default</td>
	</tr>
	<tr>
		<td><i>length</i></td>
		<td>Defines the maximum height in length units</td>
	</tr>
	<tr>
		<td><i>%</i></td>
		<td>Defines the maximum height in % of the parent element</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the maxHeight property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the maximum height of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS2</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the maximum height of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.maxHeight);
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_maxheight2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_dim_max-height.asp">max-height property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_maxheight.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_maxheight.asp#top" target="_top">TOP</a> |
		<a href="prop_style_maxheight.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
