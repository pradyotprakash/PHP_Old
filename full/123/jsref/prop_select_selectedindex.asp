...
<title>HTML DOM Select selectedIndex Property</title>
<style>a.menu_prop_select_selectedindex{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Select <span class="color_h1">selectedIndex</span> Property</h1>
...
<p>Display the index and text of the selected option in a drop-down list:</p>
<div class="example_code notranslate">
var x = document.getElementById(&quot;mySelect&quot;).selectedIndex;<br>
var y = document.getElementById(&quot;mySelect&quot;).options;<br>
alert(&quot;Index: &quot; + y[x].index + &quot; is &quot; + y[x].text);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_option_index">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The selectedIndex property sets or returns the index of the selected option in a drop-down list.</p>
<p>The index starts at 0.</p>
<p><b>Note:</b> If the drop-down list allows multiple selections it will only return the index of the first option selected.</p>
<hr>
...
<p>The selectedIndex property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the selectedIndex property:</p>
<div class="code notranslate"><div>
	<em>selectObject</em>.selectedIndex</div></div>
<p>Set the selectedIndex property:</p>
<div class="code notranslate"><div>
	<em>selectObject</em>.selectedIndex=<i>number</i></div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><em>number</em></td>
		<td>
		Specifies the index of the selected option in a drop-down list</td>
	</tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>Number</td>
<td>The index of the selected option in the drop-down list. The index starts at 0</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Select the &lt;option&gt; element with index &quot;2&quot;:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;mySelect&quot;).selectedIndex=&quot;2&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_selectedindex">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_select_selectedindex.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_select_selectedindex.asp#top" target="_top">TOP</a> |
		<a href="prop_select_selectedindex.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
