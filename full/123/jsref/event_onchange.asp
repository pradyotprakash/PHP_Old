...
<style>a.menu_event_onchange{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">onchange</span> Event</h1>
...
<p>Execute a JavaScript when a user changes the 
content of an input field:</p>
<div class="example_code notranslate">
&lt;input type=&quot;text&quot; 
onchange=&quot;myFunction()&quot;&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onchange" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onchange event occurs when the value of an element has been changed.</p>
<p>For radiobuttons and checkboxes, the onchange event occurs when 
the checked state has been changed.</p>
...
&lt;<i>element</i>
onchange=&quot;<i>SomeJavaScriptCode</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>object</em>.onchange=function(){<i>SomeJavaScriptCode</i>};</div></div>
<br>
...
<p>The onchange event is supported in all major browsers.</p>
<hr>

<h2>onchange In HTML</h2>
<p>The onchange attribute can be used with:
&lt;input&gt;, &lt;select&gt;, and &lt;textarea&gt;.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_onchange.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_onchange.asp#top" target="_top">TOP</a> |
		<a href="event_onchange.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
