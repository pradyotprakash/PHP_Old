...
<style>a.menu_event_onkeyup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">onkeyup</span> Event</h1>
...
<p>Execute a JavaScript when a user releases a key:</p>
<div class="example_code notranslate">
  
    &lt;input type=&quot;text&quot; onkeyup=&quot;myFunction()&quot;&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onkeyup" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The onkeyup event occurs when the user releases a key (on the 
keyboard).</p>
<p><b>Tip:</b> The order of events related to the onkeyup event:</p>
<ol>
	<li>onkeydown</li>
	<li>onkeypress</li>
	<li>onkeyup</li>
...
&lt;<i>element</i>
onkeyup=&quot;<i>SomeJavaScriptCode</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>object</em>.onkeyup=function(){<i>SomeJavaScriptCode</i>};</div></div>
<br>
...
<p>The onkeyup event is supported in all major browsers.</p>
<hr>

<h2>onkeyup In HTML</h2>
<p>The onkeyup attribute can be used within ALL HTML elements, EXCEPT: &lt;base&gt;, &lt;bdo&gt;, &lt;br&gt;, 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_onkeyup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_onkeyup.asp#top" target="_top">TOP</a> |
		<a href="event_onkeyup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
