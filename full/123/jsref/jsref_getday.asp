...
<style>a.menu_jsref_getday{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">getDay()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_getday" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The getDay() method returns the day of the week (from 0 to 6) for the 
specified date.</p>
...
<p>The getDay() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.getDay()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_date_weekday" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_getday.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_getday.asp#top" target="_top">TOP</a> |
		<a href="jsref_getday.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
