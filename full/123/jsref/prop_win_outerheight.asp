...
<title>Window outerWidth and outerHeight Property</title>
<style>a.menu_prop_win_outerheight{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">outerWidth</span> and <span class="color_h1">outerHeight</span> Properties</h1>
...
<p>Get the window&#39;s height and width: (including toolbars/scrollbars):</p>
<div class="example_code notranslate">
	var w = window.outerWidth;<br>var h = window.outerHeight;</div>
<br><a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_outerheight">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The outerWidth property returns the outer width of a window, including all interface elements 
(like toolbars/scrollbars).</p>

<p>The outerHeight property returns the outer height of a window, including all interface elements 
(like toolbars/scrollbars).</p>

<p><strong>Note:</strong> Use the <a href="prop_win_innerheight.asp">
innerWidth and innerHeight</a> properties to get the width/height without toolbars/scrollbars.</p>
<hr>
...
<p>The outerWidth and outerHeight properties are supported in all major browsers.</p>
<p>Note: These properties are not supported in IE8 and earlier.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
window.outerWidth<br>
window.outerHeight</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td width="80%">An integer, representing the outer width and/or the outer height of the browser's 
	window, including all interface elements, in pixels</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_win_outerheight.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_win_outerheight.asp#top" target="_top">TOP</a> |
		<a href="prop_win_outerheight.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
