...
<title>HTML DOM Select remove() Method</title>
<style>a.menu_met_select_remove{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Select <span class="color_h1">remove()</span> Method</h1>
...
<p>Remove the selected option from the drop-down list:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;);<br>x.remove(x.selectedIndex);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_remove">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The remove() method is used to remove an option from a drop-down list.</p>
<p><strong>Tip:</strong> To add an option to a drop-down list, use the <a href="met_select_add.asp">add()</a> 
method.</p>
<hr>
...
<p>The remove() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>selectObject</em>.remove(<i>index</i>)
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><i>index</i></td>
		<td>Required. Specifies the index of the option to remove. Index starts 
		at 0</td>
	</tr>
	</table>
<h2>Return Value</h2>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Remove the option with index &quot;2&quot; from a drop-down list:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;);<br>x.remove(2);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_remove2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Remove the last option from a drop-down list:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySelect&quot;);<br>if (x.length&gt;0)<br>&nbsp; {<br>&nbsp; 
	x.remove(x.length-1);<br>&nbsp; }
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_remove3">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_select_remove.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_select_remove.asp#top" target="_top">TOP</a> |
		<a href="met_select_remove.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
