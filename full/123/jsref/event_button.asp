...
<title>button Event Attribute</title>
<style>a.menu_event_button{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">button</span> Event Attribute</h1>
...
<p>The button event attribute returns a number that indicates which mouse button was 
clicked when an event was triggered.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
event.button=0|1|2</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>0</td>
    <td>Specifies the left mouse-button</td>
  </tr>
	<tr>
    <td>1</td>
    <td>Specifies the middle mouse-button</td>
  </tr>
  <tr>
    <td>2</td>
    <td>Specifies the right mouse-button</td>
  </tr>
  </table>
  
<p><strong>Note:</strong> Internet Explorer 8 and earlier has different parameters:</p>
<table class="reference notranslate">
  <tr>
    <th style="width:20%">Parameter</th>
    <th>Description</th>
  ...
  <tr>
    <td>1</td>
    <td>Specifies the left mouse-button (IE8 and earlier)</td>
  </tr>
	<tr>
    <td>4</td>
    <td>Specifies the middle mouse-button (IE8 and earlier)</td>
  </tr>
  <tr>
    <td>2</td>
    <td>Specifies the right mouse-button</td>
...
<p><b>Note:</b> For a left-hand configured mouse, the parameter values are 
reversed.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_button.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_button.asp#top" target="_top">TOP</a> |
		<a href="event_button.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
