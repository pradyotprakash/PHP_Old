...
<title>HTML DOM Style backgroundPosition Property</title>
<style>a.menu_prop_style_backgroundposition{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">backgroundPosition</span> Property</h1>
...
<p>The backgroundPosition property sets or returns the position of a background-image 
within an element.</p>
<hr>
...
<p>The backgroundPosition property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the backgroundPosition property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.backgroundPosition
</div></div>
<p>Set the backgroundPosition property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.backgroundPosition=<em>value</em></div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		...
		bottom center<br>
		bottom right</td>
		<td>If you only specify one keyword, the other value will 
		be &quot;center&quot;.</td>
	</tr>
	<tr>
		<td><i>x% y%</i></td>
		<td>The x value indicates the horizontal position and the 
	...
	<tr>
		...
		specify one value, the other value will be 50%. You can mix % and units</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The setting of the background-position property is 
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the position of a background-image</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the position of the background-image in a &lt;div&gt; element to center bottom:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.backgroundPosition=&quot;center bottom&quot;; </div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundposition2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Change the position of the background-image in a &lt;div&gt; element to 200px horizontal and 40px 
vertical:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.backgroundPosition=&quot;200px 40px&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundposition3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the position of the background-image in a &lt;div&gt; element:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.backgroundPosition; <br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_backgroundposition4">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_background-image.asp">background-image property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_backgroundposition.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_backgroundposition.asp#top" target="_top">TOP</a> |
		<a href="prop_style_backgroundposition.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
