...
<style>a.menu_met_win_scrollby{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">scrollBy()</span> Method</h1>
...
<p>Scroll the content by 100px horizontally:</p>
<div class="example_code notranslate">
	window.scrollBy(100,0);</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_scrollby" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The scrollBy() method scrolls the content by the specified number of pixels.</p>
<p><b>Note:</b> For this method to work, the visible property of the window's scrollbar must be set to true!</p>
<hr>
...
<p>The scrollBy() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	window.scrollBy(<i>xnum,ynum</i>)</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>xnum</em></td>
    <td>Required. How many pixels to scroll by, along the x-axis (horizontal). 
	Positive values will scroll to the left, while negative values will scroll 
	to the left</td>
  </tr>
  <tr>
    <td><em>ynum</em></td>
    <td>Required. How many pixels to scroll by, along the y-axis (vertical). 
	Positive values will scroll up, while negative values scroll down</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="tecspec">
...
<div class="example">
<h2 class="example">Example</h2>
<p>Scroll the content by 100px vertically:</p>
<div class="example_code notranslate">
	window.scrollBy(0,100);</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_scrollby2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Scroll the content horizontally and vertically:</p>
	<div class="example_code notranslate">
		&lt;button onclick=&quot;scrollWin(0,100)&quot;&gt;Scroll down&lt;/button&gt;<br>&lt;button 
		onclick=&quot;scrollWin(0,-100)&quot;&gt;Scroll up&lt;/button&gt;<br>&lt;button onclick=&quot;scrollWin(100,0)&quot;&gt;Scroll 
		right&lt;/button&gt;<br>&lt;button onclick=&quot;scrollWin(-100,0)&quot;&gt;Scroll 
		left&lt;/button&gt;<br><br>&lt;script&gt;<br>function scrollWin(x,y)<br>{<br>
		window.scrollBy(x,y);<br>}<br>&lt;/script&gt;</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_scrollby3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_scrollby.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_scrollby.asp#top" target="_top">TOP</a> |
		<a href="met_win_scrollby.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
