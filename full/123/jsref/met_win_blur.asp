...
<title>Window blur() Method</title>
<style>a.menu_met_win_blur{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">blur()</span> Method</h1>
...
<p><strong>Tip:</strong> Use the <a href="met_win_focus.asp">focus()</a> method to 
...
<p>The blur() method is supported in all major browsers, except Opera.</p>
<hr>
...
myWindow.focus();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Assures that the new window gets focus</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_blur.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_blur.asp#top" target="_top">TOP</a> |
		<a href="met_win_blur.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
