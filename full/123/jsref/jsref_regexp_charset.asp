...
<title>RegExp [abc] Expression</title>
<style>a.menu_jsref_regexp_charset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript RegExp <span class="color_h1">[abc]</span> Expression</h1>
<p><a href="jsref_obj_regexp.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="RegExp Object Reference" /> JavaScript RegExp Object</a></p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_charset" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The [abc] expression is used to find any character between the brackets.</p>
<p>The characters inside the brackets can be any characters or span of 
characters:</p>
<ul>
	<li>[abcde..] - Any character between the brackets</li>
	<li>[A-Z] - Any character from uppercase A to uppercase Z</li>
	<li>[a-z] - Any character from lowercase a to lowercase z</li>
	<li>[A-z ]- Any character from uppercase A to lowercase z</li>
</ul>
<p><strong>Tip:</strong> Use the <a href="jsref_regexp_charset_not.asp">[^abc]</a> expression to find any character 
NOT between the brackets.</p>
<hr>
...
<p>The [abc] expression is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>

new RegExp(&quot;[<em>abc</em>]&quot;)<br>
<br>
or simply:<br>
<br>
/[<em>abc</em>]/
...
<div class="example">
<h2 class="example">Example</h2>
<p>Do a global search for the characters &quot;i&quot; and &quot;s&quot; in a 
string:</p>
<div class="example_code notranslate">
var str = &quot;Do you know if this is all there is?&quot;;<br>
var patt1 = /[is]/gi;</div>
<p>The <span class="marked">marked</span> text below shows where the expression gets a match:</p>
<div class="example_code notranslate">
	Do you know <span class="marked">i</span>f th<span class="marked">is</span> <span class="marked">is</span> all there <span class="marked">is</span>?
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_charset2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Do a global search for the character-span from lowercase &quot;a&quot; to lowercase &quot;h&quot; in a string:</p>
<div class="example_code notranslate">
var str = &quot;Is this all there is?&quot;;<br>
var patt1 = /[a-h]/g;
</div>
<p>The <span class="marked">marked</span> text below shows where the expression gets a match:</p>
<div class="example_code notranslate">
Is t<span class="marked">h</span>is <span class="marked">a</span>ll t<span class="marked">he</span>r<span class="marked">e</span> is?
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_charset3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Do a global search for the character-span from uppercase &quot;A&quot; to uppercase &quot;E&quot;:</p>
<div class="example_code notranslate">
var str = &quot;I SCREAM FOR ICE CREAM!&quot;;<br>
var patt1 = /[A-E]/g;</div>
<p>The <span class="marked">marked</span> text below shows where the expression gets a match:</p>
<div class="example_code notranslate">
	I S<span class="marked">C</span>R<span class="marked">EA</span>M FOR I<span class="marked">CE</span> <span class="marked">C</span>R<span class="marked">EA</span>M!</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_charset4" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Do a global search for the character-span from uppercase &quot;A&quot; to lowercase &quot;e&quot; 
(will search for all uppercase letters, but only lowercase letters from a to e.)</p>
<div class="example_code notranslate">
var str = &quot;I Scream For Ice Cream, is that OK?!&quot;;<br>var patt1 = /[A-e]/g;</div>
<p>The <span class="marked">marked</span> text below shows where the expression gets a match:</p>
<div class="example_code notranslate">
	<span class="marked">I</span> <span class="marked">Sc</span>r<span class="marked">ea</span>m <span class="marked">F</span>or <span class="marked">Ice</span> <span class="marked">C</span>r<span class="marked">ea</span>m, is th<span class="marked">a</span>t <span class="marked">OK</span>?!</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_charset5" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Do a global, case-insensitive search for the character-span [a-s]:</p>
<div class="example_code notranslate">
var str = &quot;I Scream For Ice Cream, is that OK?!&quot;;<br>var patt1 = /[a-s]/gi;</div>
<p>The <span class="marked">marked</span> text below shows where the expression gets a match:</p>
<div class="example_code notranslate">
	<span class="marked">I Scream For Ice Cream, is </span>t<span class="marked">ha</span>t<span class="marked"> OK</span>?!</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_charset6" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>A demonstration of &quot;g&quot; and &quot;gi&quot;-search for characters:</p>
<div class="example_code notranslate">
var str = &quot;THIS This this&quot;;<br>var patt1 = /[THIS]/g;<br><br>var str = &quot;THIS This 
	this&quot;;<br>var patt1 = /[THIS]/gi;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_charset_gi" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<br>
<hr>
<a href="jsref_obj_regexp.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="RegExp Object Reference" /> JavaScript RegExp Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_regexp_charset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_regexp_charset.asp#top" target="_top">TOP</a> |
		<a href="jsref_regexp_charset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
