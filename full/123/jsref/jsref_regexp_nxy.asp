...
<title>RegExp {X,Y} Quantifier</title>
<style>a.menu_jsref_regexp_nxy{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript RegExp <span class="color_h1">{X,Y}</span> Quantifier</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_regexp_nxy" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <i>n</i>{<i>X</i>,<i>Y</i>} quantifier matches any string that contains a sequence of X 
to Y <i>n</i>'s.</p>
<p><i>X</i> and <i>Y</i> must be a number.</p>
<hr>
...
<p>The {X,Y} quantifier is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>

new RegExp(&quot;<i>n</i>{<i>X,Y</i>}&quot;)<br>
<br>
or simply:<br>
<br>
/<i>n</i>{<i>X,Y</i>}/
...
<div class="code notranslate"><div>
new RegExp(&quot;<i>n</i>{<i>X,Y</i>}&quot;,&quot;g&quot;)<br>
<br>
or simply:<br>
<br>
	/\<i>n</i>{<i>X,Y</i>}/g</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_regexp_nxy.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_regexp_nxy.asp#top" target="_top">TOP</a> |
		<a href="jsref_regexp_nxy.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
