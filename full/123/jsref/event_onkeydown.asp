...
<style>a.menu_event_onkeydown{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">onkeydown</span> Event</h1>
...
<p>Execute a JavaScript when a user is pressing a key:</p>
<div class="example_code notranslate">
  
    &lt;input type=&quot;text&quot; onkeydown=&quot;myFunction()&quot;&gt;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onkeydown" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The onkeydown event occurs when the user is pressing a key (on the keyboard).</p>
<p><b>Tip:</b> The order of events related to the onkeydown event:</p>
<ol>
	<li>onkeydown</li>
	<li>onkeypress</li>
	<li>onkeyup</li>
...
&lt;<i>element</i>
onkeydown=&quot;<i>SomeJavaScriptCode</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>object</em>.onkeydown=function(){<i>SomeJavaScriptCode</i>};</div></div>
<br>
...
<p>The onkeydown event is supported in all major browsers.</p>
<hr>

<h2>onkeydown In HTML</h2>
<p>The onkeydown attribute can be used within ALL HTML elements, EXCEPT: &lt;base&gt;, &lt;bdo&gt;, &lt;br&gt;, 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_onkeydown.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_onkeydown.asp#top" target="_top">TOP</a> |
		<a href="event_onkeydown.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
