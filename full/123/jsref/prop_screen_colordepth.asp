...
<style>a.menu_prop_screen_colordepth{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Screen <span class="color_h1">colorDepth</span> Property</h1>
<p><a href="obj_screen.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Screen Object Reference" /> Screen Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the bit depth of the color palette:</p>
<div class="example_code notranslate">
	var x = &quot;Color Depth: &quot; + screen.colorDepth;<br>document.getElementById(&quot;demo&quot;).innerHTML=x;</div>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_screen_colordepth">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The colorDepth property returns the bit depth of the color palette for 
displaying images (in bits per pixel).</p>
<hr>
...
<p>The colorDepth property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
screen.colorDepth</div></div>
<h2>Return Value</h2>
...
Possible values:
<ul>
	<li>1 bit per pixel</li>
	<li>4 bits per pixel</li>
	<li>8 bits per pixel</li>
	<li>15 bits per pixel</li>
	<li>16 bits per pixel</li>
	<li>24 bits per pixel</li>
	<li>32 bits per pixel</li>
	<li>48 bits per pixel</li>
</ul>
	</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Display an alternate background color for 8 bit screens (to avoid that 8 bit 
screens, which do not support the modern color, uses an ugly substitute color 
instead):</p>
<div class="example_code notranslate">
if (screen.colorDepth&lt;=8)<br>
&nbsp; //simple blue background color for 8 bit screens<br>
&nbsp; document.body.style.background=&quot;#0000FF&quot;<br>
else<br>
&nbsp; //fancy blue background color for modern screens<br>
&nbsp; document.body.style.background=&quot;#87CEFA&quot;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_screen_colordepth2">Try it yourself &raquo;</a>
</div>

<br>
<div class="example">
<h2 class="example">Example</h2>
<p>A demonstration of all screen properties:</p>
	<div class="example_code notranslate">
		document.write(screen.width + &quot;*&quot; 
	+ screen.height);<br>document.write(screen.availWidth + &quot;*&quot; + 
	screen.availHeight);<br>document.write(screen.colorDepth);<br>document.write(screen.pixelDepth);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_screen_all">Try it yourself &raquo;</a>
</div>

<br>
<hr>
<a href="obj_screen.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Screen Object Reference" /> Screen Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_screen_colordepth.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_screen_colordepth.asp#top" target="_top">TOP</a> |
		<a href="prop_screen_colordepth.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
