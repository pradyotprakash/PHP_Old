...
<style>a.menu_jsref_toutcstring{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">toUTCString()</span> Method</h1>
...
<p>Convert a Date object to a string, according to universal time:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_toutcstring" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The toUTCString() method converts a Date object to a string, according to universal time.</p>
...
<p>The toUTCString() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.toUTCString()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>String </td>
<td>The UTC date and time as a string</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_toutcstring.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_toutcstring.asp#top" target="_top">TOP</a> |
		<a href="jsref_toutcstring.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
