...
<title>HTML DOM Style whiteSpace Property</title>
<style>a.menu_prop_style_whitespace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">whiteSpace</span> Property</h1>
...
<p>Preserve line breaks and whitespaces in a text:</p>
	<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.whiteSpace=&quot;pre&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_whitespace">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The whiteSpace property sets or returns how to handle tabs, line breaks and 
whitespace in a text.</p>
<hr>
...
<p>The whiteSpace property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the whiteSpace property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.whiteSpace
</div></div>
<p>Set the whiteSpace property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.whiteSpace=&quot;normal|nowrap|pre|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>normal</td>
		<td>Sequences of whitespace will collapse into a single whitespace. Text will wrap when necessary. This is default</td>
	</tr>
	<tr>
		<td>nowrap</td>
		<td>
	...
	<tr>
		<td>pre</td>
		<td>Whitespace is preserved by the browser. Text will only wrap on line breaks. Acts like the 
		&lt;pre&gt; tag in HTML</td>
	</tr>
    <tr>
		<td>pre-line</td>
		<td>Sequences of whitespace will collapse into a single whitespace. Text will wrap when necessary, and on line breaks</td>
	</tr>
	<tr>
		<td>pre-wrap</td>
		<td>Whitespace is preserved by the browser. Text will wrap when necessary, and on line breaks</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the whiteSpace property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing how white-space inside an element is handled</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<p>Return the whiteSpace property</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.whiteSpace);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_whitespace2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_text_white-space.asp">white-space property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_whitespace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_whitespace.asp#top" target="_top">TOP</a> |
		<a href="prop_style_whitespace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
