...
<title>HTML DOM Text maxLength Property</title>
<style>a.menu_prop_text_maxlength{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Text <span class="color_h1">maxLength</span> Property</h1>
...
<p>Return the maximum number of characters allowed in a specific text field:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myText&quot;).maxLength;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">30</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_text_maxlength">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The maxLength property sets or returns the value of the maxlength attribute 
of a text field.</p>
<p>The maxLength attribute specifies the maximum number of characters allowed in a text field.</p>
<p><strong>Tip:</strong> To set or return the width of a text field, in number 
of characters, use the <a href="prop_text_size.asp">size</a> property.</p>
<hr>
...
<p>The maxLength property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the maxLength property:</p>
<div class="code notranslate"><div>
	<em>textObject</em>.maxLength
</div></div>
<p>Set the maxLength property:</p>
<div class="code notranslate"><div>
	<em>textObject</em>.maxLength=<i>integer</i>
</div></div>
<br>
...
<tr>
<td>Number</td>
<td>The value of the maxlength attribute of the text field</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set the maximum number of characters allowed in a text field:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myText&quot;).maxLength=&quot;4&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_text_maxlength2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Jump to the next text field when a field's maxlength has been reached:</p>
<div class="example_code notranslate">
	if (y.length == x.maxLength)<br>&nbsp; {<br>&nbsp; var next = x.tabIndex;<br>&nbsp; 
	if (next&lt;document.getElementById(&quot;myForm&quot;).length)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;myForm&quot;).elements[next].focus();<br>&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp; }<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_text_autonext">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_text_maxlength.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_text_maxlength.asp#top" target="_top">TOP</a> |
		<a href="prop_text_maxlength.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
