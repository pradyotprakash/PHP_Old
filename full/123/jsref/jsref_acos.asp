...
<title>JavaScript acos() Method</title>
<style>a.menu_jsref_acos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">acos()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_acos" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The acos() method returns the arccosine of a number as a value value between 0 and PI radians.</p>
<p><b>Note:</b> If the parameter x is outside the range -1 to 1, the method will return NaN.</p>
<p><b>Tip:</b> -1 will return the value of PI.</p>
<hr>
...
<p>The acos() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.acos(<em>x</em>)</div></div>
...
<tr>
<td>Number</td>
<td>A Number, from 0 to PI, or NaN if the value is outside the range of -1 to 1</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_acos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_acos.asp#top" target="_top">TOP</a> |
		<a href="jsref_acos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
