...
<title>HTML DOM Style minHeight Property</title>
<style>a.menu_prop_style_minheight{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">minHeight</span> Property</h1>
...
<p>Set the minimum height of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.minHeight=&quot;100px&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_minheight">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The minHeight property sets or returns the minimum height of an element.</p>
<p>The minHeight property has effect only on block-level elements or on elements 
with absolute or fixed position.</p>
<p><strong>Tip:</strong> To set or return the maximum height of an element, use 
the <a href="prop_style_maxheight.asp">maxHeight</a> property.</p>
<hr>
...
<p>The minHeight property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the minHeight property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.minHeight
</div></div>
<p>Set the minHeight property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.minHeight=&quot;<i>length|%</i>|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><i>length</i></td>
		<td>Defines the minimum height in length units. Default is 0</td>
	</tr>
	<tr>
		<td><i>%</i></td>
		<td>Defines the minimum height in % of the parent element</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the minHeight property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the minimum height of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS2</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the minimum height of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.minHeight);
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_minheight2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_dim_min-height.asp">min-height property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_minheight.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_minheight.asp#top" target="_top">TOP</a> |
		<a href="prop_style_minheight.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
