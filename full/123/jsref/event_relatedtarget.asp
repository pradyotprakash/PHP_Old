...
<title>relatedTarget Event Attribute</title>
<style>a.menu_event_relatedtarget{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">relatedTarget</span> Event Attribute</h1>
...
<p>The relatedTarget event attribute returns the element related to the element that 
		triggered the event.</p>
<p>This attribute can be used with the mouseover event to indicate the element the 
...
<p>The following example returns the element the cursor just exited:</p>
<div class="example_code notranslate">
&lt;html&gt;<br>
&lt;head&gt;<br>
&lt;script&gt;<br>
function getRelElement(event)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;var txt=&quot;The cursor just exited the &quot;;<br>
&nbsp;&nbsp;txt=txt + event.relatedTarget.tagName + &quot; element.&quot;;<br>
&nbsp;&nbsp;alert(txt);<br>
&nbsp;&nbsp;}<br>
&lt;/script&gt;<br>
&lt;/head&gt;<br>
&lt;body&gt;<br>
<br>
&lt;p onmouseover=&quot;getRelElement(event)&quot;&gt;<br>
Mouse over this paragraph.&lt;/p&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" href="http://www.w3schools.com/js/tryit.asp?filename=try_dom_event_relatedtarget" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_event.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Event Object Reference" /> Event Object</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_relatedtarget.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_relatedtarget.asp#top" target="_top">TOP</a> |
		<a href="event_relatedtarget.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
