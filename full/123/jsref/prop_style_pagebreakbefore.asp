...
<title>HTML DOM Style pageBreakBefore Property</title>
<style>a.menu_prop_style_pagebreakbefore{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">pageBreakBefore</span> Property</h1>
...
<p>Always set a page break before each &lt;p&gt; element with id=&quot;footer&quot;:</p>
<div class="example_code notranslate">
document.getElementById(&quot;footer&quot;).style.pageBreakBefore=&quot;always&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="tryjsref_style_pagebreakbefore.htm">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The pageBreakBefore property sets or returns the page-break behavior before an element 
(for printing or print preview).</p>
<p><b>Note:</b> The pageBreakBefore property has no effect on absolutely positioned elements. 
The page break is only visible in a print preview or when printing.</p>
<hr>
...
<p>The pageBreakBefore property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the pageBreakBefore property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.pageBreakBefore
</div></div>
<p>Set the pageBreakBefore property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.pageBreakBefore=&quot;auto|always|avoid|emptystring|left|right|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>auto</td>
		<td>Insert a page break before the element if necessary. This is default</td>
	</tr>
	<tr>
		<td>always</td>
	...
	<tr>
		<td>&quot;&quot; (empty string)</td>
		<td>Page break is not inserted before the element</td>
	</tr>
	<tr>
		<td>left</td>
		<td>Insert one or two page breaks before the element, so the next page is 
		considered a left page</td>
	</tr>
	<tr>
		<td>right</td>
		<td>Insert one or two page breaks before the element, so the next page is 
		considered a right page</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the pageBreakBefore property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the page-break behavior before an element when 
	printing</td>
</tr>
<tr>
	<th>CSS Version</th>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/pr_print_pagebb.asp">page-break-before property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_pagebreakbefore.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_pagebreakbefore.asp#top" target="_top">TOP</a> |
		<a href="prop_style_pagebreakbefore.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
