...
<html lang="en-US">
<head>
<title>HTML DOM Checkbox Object</title>
<style>a.menu_dom_obj_checkbox{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Checkbox</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_button.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_fileupload.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Checkbox Object</h2>
<p>The Checkbox object represents a checkbox in an HTML form.</p>
<p>Checkboxes let a user select one or more options of a limited number of 
choices.</p>
<p>For each instance of an &lt;input type=&quot;checkbox&quot;&gt; tag in an HTML form, a Checkbox object is created.</p>
<p>You can access a Checkbox object by searching through the elements[] array of 
a form, or by using document.getElementById().</p>

<hr>

<h2>Checkbox Object Properties</h2>
...
<p>The Checkbox object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_checkbox.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_checkbox.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_checkbox.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
