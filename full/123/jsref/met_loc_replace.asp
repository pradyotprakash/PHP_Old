...
<style>a.menu_met_loc_replace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Location <span class="color_h1">replace()</span> Method</h1>
...
<p>Replace the current document:</p>
<div class="example_code notranslate">
	location.replace(&quot;http://www.w3schools.com&quot;);<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_loc_replace">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The replace() method replaces the current document with a new one.</p>
<p>The difference between this method and <a href="met_loc_assign.asp">assign()</a>, 
is that replace() removes the URL of the current document from the document 
history, meaning that it is not possible to use the &quot;back&quot; button to navigate 
back to the original document. </p>
<p><strong>Tip: </strong>Use the <a href="met_loc_assign.asp">assign()</a> 
method if you want to load a new document, and the option to navigate back to 
...
location.replace(<em>newURL</em>)</div></div>
...
<td>String</td>
<td>
Required. Specifies the URL of the page to navigate to</td>
</tr>
</table>
<h2>Return Value</h2>
<table class="tecspec">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_loc_replace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_loc_replace.asp#top" target="_top">TOP</a> |
		<a href="met_loc_replace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
