...
<style>a.menu_jsref_charat{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">charAt()</span> Method</h1>
...
<div class="example_code notranslate">
	H</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_charat" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The charAt() method returns the character at the specified index in a string.</p>
<p>The index of the first character is 0, the second character is 1, and so on.</p>
<p><strong>Tip:</strong> The index of the last character in a string is <em>
string</em>.length-1, the second last character is <em>string</em>.length-2, and 
so on (See &quot;More Examples&quot;).</p>
<hr>
...
<p>The charAt() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>string</i>.charAt(<em>index</em>)</div></div>
...
<tr>
<td>String</td>
<td>The character at the specified index, or an empty string if the index number 
is not found</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the last character of a string:</p>
<div class="example_code notranslate">
var str = &quot;HELLO WORLD&quot;;<br>
...
<div class="example_code notranslate">
D</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_charat2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_charat.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_charat.asp#top" target="_top">TOP</a> |
		<a href="jsref_charat.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
