...
<style>a.menu_prop_loc_hash{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Location <span class="color_h1">hash</span> Property</h1>
...
<p>Return the anchor portion of a URL. Assume that the current URL is http://www.example.com/test.htm#part2:</p>
<div class="example_code notranslate">
	var x = location.hash;<br>
	</div>
...
<p>The hash property sets or returns the anchor portion of a URL, including the hash 
sign (#).</p>
<p><strong>Tip:</strong> When you set the anchor portion, do not include the 
hash sign.</p>
<hr>
...
<div class="code notranslate"><div>
	location.hash</div></div>
<p>Set the hash property:</p>
<div class="code notranslate"><div>
	location.hash=<em>anchorname</em></div></div>
<br>
...
<tr>
<td>String</td>
<td>The anchor portion of a URL, including the hash sign (#). If there is no 
hash sign, an empty string is returned</td>
</tr>
</table>
<br>
...
<p><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_loc_hash_set">Set the 
anchor portion</a><br>
How to set the anchor portion of a URL.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_loc_hash.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_loc_hash.asp#top" target="_top">TOP</a> |
		<a href="prop_loc_hash.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
