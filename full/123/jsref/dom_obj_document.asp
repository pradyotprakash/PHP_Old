...
<html lang="en-US">
<head>
<title>HTML DOM Document Objects</title>
<style>a.menu_dom_obj_document{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>The HTML DOM <span class="color_h1">Document</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="obj_location.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_all.asp">Next Reference &raquo;</a></div>
</div>
<hr>
...
<p>When an HTML document is loaded into a web browser, it becomes a <strong>document object</strong>.</p>
<p>The document object is the root node of the HTML document and the &quot;owner&quot; of 
all other nodes:<br>(element nodes, text nodes, attribute nodes, and comment 
nodes).</p>
<p>The document object provides properties and methods to access 
all node objects, from within JavaScript.</p>
<p><b>Tip:</b> The document is a part of the window object and can be accessed 
as window.document.</p>
...
<p>The Document Object is supported in all major browsers.</p>

<hr>

<h2>Document Object Properties and Methods</h2>
...
<tr>
	...
	<td>Returns an adapded node from another document to this document.</td>
</tr>
<tr>
    <td><a href="coll_doc_anchors.asp">document.anchors</a></td>
    <td>Returns a collection of all the anchors in the document</td>
</tr>
<tr>
    <td>document.applets</td>
    <td>Returns a collection of all the applets in the document</td>
</tr>
<tr>
	<td><a href="prop_doc_baseuri.asp">document.baseURI</a></td>
	<td>Returns the absolute base URI of a document</td>
</tr>
<tr>
    <td>document.body</td>
    <td>Returns the body element of the document</td>
</tr>
<tr>
    <td><a href="met_doc_close.asp">document.close()</a></td>
    <td>Closes the output stream previously opened with document.open()</td>
</tr>
<tr>
    <td><a href="prop_doc_cookie.asp">document.cookie</a></td>
    <td>Returns all name/value pairs of cookies in the document</td>
</tr>
<tr>
	<td><a href="met_document_createattribute.asp">document.createAttribute()</a></td>
	<td>Creates an attribute node</td>
</tr>
<tr>
	<td><a href="met_document_createcomment.asp">document.createComment()</a></td>
	<td>Creates a Comment node with the specified text</td>
</tr>
<tr>
	<td><a href="met_document_createdocumentfragment.asp">document.createDocumentFragment()</a></td>
	<td>Creates an empty DocumentFragment node</td>
</tr>
<tr>
	<td><a href="met_document_createelement.asp">document.createElement()</a></td>
	<td>Creates an Element node</td>
</tr>
<tr>
	<td><a href="met_document_createtextnode.asp">document.createTextNode()</a></td>
	<td>Creates a Text node</td>
</tr>
<tr>
	<td><a href="prop_document_doctype.asp">document.doctype</a></td>
	<td>Returns the Document Type Declaration associated with the document</td>
</tr>
<tr>
	<td><a href="prop_document_documentelement.asp">document.documentElement</a></td>
	<td>Returns the Document Element of the document (the HTML element)</td>
</tr>
<tr>
    <td><a href="prop_doc_documentmode.asp">document.documentMode</a></td>
    <td>Returns the mode used by the browser to render the document</td>
</tr>
<tr>
	<td><a href="prop_document_documenturi.asp">document.documentURI</a></td>
	<td>Sets or returns the location of the document</td>
</tr>
<tr>
    <td><a href="prop_doc_domain.asp">document.domain</a></td>
    <td>Returns the domain name of the server that loaded the document</td>
</tr>
<tr>
	<td>document.domConfig</td>
	<td>Returns the configuration used when normalizeDocument() is invoked</td>
</tr>
<tr>
    <td><a href="coll_doc_forms.asp">document.forms</a></td>
    <td>Returns a collection of all the forms in the document</td>
</tr>
<tr>
	<td><a href="met_document_getelementbyid.asp">document.getElementById()</a></td>
	<td>Returns the element that has the ID attribute with the specified value</td>
</tr>
<tr>
    <td><a href="met_doc_getelementsbyname.asp">document.getElementsByName()</a></td>
    <td>Accesses all elements with a specified name</td>
</tr>
<tr>
	<td><a href="met_document_getelementsbytagname.asp">document.getElementsByTagName()</a></td>
	<td>Returns a NodeList containing all elements with the specified tagname</td>
</tr>
<tr>
    <td><a href="coll_doc_images.asp">document.images</a></td>
    <td>Returns a collection of all the images in the document</td>
</tr>
<tr>
	<td><a href="prop_document_implementation.asp">document.implementation</a></td>
	<td>Returns the DOMImplementation object that handles this document</td>
</tr>
<tr>
	<td><a href="met_document_importnode.asp">document.importNode()</a></td>
	<td>Imports a node from another document</td>
</tr>
<tr>
	<td><a href="prop_document_inputencoding.asp">document.inputEncoding</a></td>
	<td>Returns the encoding, character set, used for the document</td>
</tr>
<tr>
    <td><a href="prop_doc_lastmodified.asp">document.lastModified</a></td>
    <td>Returns the date and time the document was last modified</td>
</tr>
<tr>
    <td><a href="coll_doc_links.asp">document.links</a></td>
    <td>Returns a collection of all the links in the document</td>
</tr>
<tr>
	<td><a href="met_document_normalize.asp">document.normalize()</a></td>
	<td>Removes empty Text nodes, and joins adjacent nodes</td>
</tr>
<tr>
	<td><a href="met_document_normalizedocument.asp">document.normalizeDocument()</a></td>
	<td>Removes empty Text nodes, and joins adjacent nodes</td>
</tr>
<tr>
    <td><a href="met_doc_open.asp">document.open()</a></td>
    <td>Opens an HTML output stream to collect output from document.write()</td>
</tr>
<tr>
    <td><a href="prop_doc_readystate.asp">document.readyState</a></td>
    <td>Returns the (loading) status of the document</td>
</tr>
<tr>
    <td><a href="prop_doc_referrer.asp">document.referrer</a></td>
    <td>Returns the URL of the document that loaded the current document</td>
</tr>
<tr>
	<td><a href="met_document_renamenode.asp">document.renameNode()</a></td>
	<td>Renames the specified node</td>
</tr>
<tr>
	<td><a href="prop_document_stricterrorchecking.asp">document.strictErrorChecking</a></td>
	<td>Sets or returns whether error-checking is enforced or not</td>
</tr>
<tr>
    <td><a href="prop_doc_title.asp">document.title</a></td>
    <td>Sets or returns the title of the document</td>
</tr>
<tr>
    <td><a href="prop_doc_url.asp">document.URL</a></td>
    <td>Returns the full URL of the document</td>
</tr>
<tr>
    <td><a href="met_doc_write.asp">document.write()</a></td>
    <td>Writes HTML expressions or JavaScript code to a document</td>
</tr>
<tr>
    <td><a href="met_doc_writeln.asp">document.writeln()</a></td>
...
<h2>Warning !!!</h2>
<p>In the W3C DOM Core, the Document object 
inherits all properties and methods from the Node object.</p>
<p>Many of these properties and methods make no sense used on documents.</p>
<p><strong>Avoid using these node object properties 
and methods on 
HTML document objects:</strong></p>
...
<tr>
	...
	<td>Documents don't have attributes</td>
</tr>
<tr>
...
<tr>
	...
	<td>Documents don't have siblings</td>
</tr>
<tr>
	<td>document.nodeName</td>
	<td>This is always #document</td>
</tr>
<tr>
	<td>document.nodeType</td>
	<td>This is always 9 (DOCUMENT_NODE) </td>
</tr>
<tr>
	<td>document.nodeValue</td>
	<td>Documents don't have an node value</td>
</tr>
<tr>
	<td>document.ownerDocument</td>
	<td>Documents don't have an owner document</td>
</tr>
<tr>
	<td>document.ownerElement</td>
	<td>Documents don't have an owner element</td>
</tr>
<tr>
	<td>document.parentNode</td>
	<td>Documents don't have a parent node</td>
</tr>
<tr>
...
<tr>
	...
	<td>Documents don't have a text content</td>
</tr>
</table>
<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_document.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_document.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_document.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
