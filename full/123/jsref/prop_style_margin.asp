...
<title>HTML DOM Style margin Property</title>
<style>a.menu_prop_style_margin{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">margin</span> Property</h1>
...
<p>Set all four margins of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myDiv&quot;).style.margin=&quot;50px 10px 20px 30px&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_margin">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The margin property sets or returns the  
margins of an element.</p>
<p>This property can take from one to four values:</p>
<ul>
	<li>One value, like: div {margin: 50px} - all four 
	margins will be 50px</li>
	<li>Two values, like: div {margin: 50px 10px} - the 
	top and bottom margins will be 50px, left and right margins will be 10px</li>
	<li>Three values, like: div {margin: 50px 10px 20px}- 
	the top margin will be 50px, left and right margin will be 10px, bottom 
	margin will be 20px</li>
	<li>Four values, like: div {margin: 50px 10px 20px 30px} - the top 
	margin will be 50px, right margin will be 10px, bottom 
	margin will be 20px, left margin will be 30px</li>
</ul>
...
<p>The margin property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the margin property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.margin
</div></div>
<p>Set the margin property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.margin=&quot;<i>%</i>|<i>length</i>|auto|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td><i>%</i></td>
		<td>Defines the margins in % of the width of the parent element</td>
	</tr>
	<tr>
		<td><i>length</i></td>
		<td>Defines the margins in length units </td>
	</tr>
	<tr>
		<td>auto</td>
		<td>The browser sets the margins (all four margins will be equal)</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The margins are inherited from the 
		parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the margins of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change all four margins of a &lt;div&gt; element to &quot;25px&quot;:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.margin=&quot;25px&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_margin2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the margins of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.margin);<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_margin3">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Difference between the margin property and the padding property:</p>
<div class="example_code notranslate">
	function changeMargin()<br>{<br>document.getElementById(&quot;myDiv&quot;).style.margin=&quot;100px&quot;;<br>
	}<br>function changePadding()<br>{<br>document.getElementById(&quot;myDiv2&quot;).style.padding=&quot;100px&quot;;<br>
	}<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_margin_padding">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_margin.asp">margin property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_margin.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_margin.asp#top" target="_top">TOP</a> |
		<a href="prop_style_margin.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
