...
<p>normalize an element:</p>
<div class="example_code notranslate">
	xmlDoc.getElementById("demo").normalize(); </div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_normalize" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
