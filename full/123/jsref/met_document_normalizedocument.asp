...
<title>HTML DOM normalizeDocument() Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_document_normalizedocument{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">normalizeDocument()</span> Method</h1>
...
<p>Normalize an entire document:</p>
<div class="example_code notranslate">
	document.normalizeDocument();</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The normalizeDocument() method removes empty Text nodes, and joins adjacent Text nodes.</p>
<p>This method is not supported in any browser, but should work similar to the <a href="met_document_normalize.asp">normalize()</a> method.</p>
...
<p>The normalizeDocument() method is not supported in any of the major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
document.normalizeDocument()</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_document_normalizedocument.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_document_normalizedocument.asp#top" target="_top">TOP</a> |
		<a href="met_document_normalizedocument.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
