...
<title>HTML DOM Form action Property</title>
<style>a.menu_prop_form_action{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Form <span class="color_h1">action</span> Property</h1>
...
<p>Return where to send the form-data when a form is submitted:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;myForm&quot;).action;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	form_action.asp</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_form_action" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The action property sets or returns the value of the action attribute in a form.</p>
<p>The action attribute specifies where to send the form-data when a form is 
submitted.</p>
<hr>
...
<p>The action property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the action property:</p>
<div class="code notranslate"><div>
	<em>formObject</em>.action</div></div>
<p>Set the action property:</p>
<div class="code notranslate"><div>
	<em>formObject</em>.action=<i>URL</i></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>URL</i></td>
    <td>
	Specifies where to send the form-data when the form is submitted.<br><br>
	Possible values:
	<ul>
		<li>An absolute URL - points to another web site (like action=&quot;http://www.example.com/example.htm&quot;)</li>
		<li>A relative URL - points to a file within a web site (like action=&quot;example.htm&quot;)</li>
	</ul>
	  </td>
  </tr>
</table>
...
<tr>
<td>String</td>
<td>The value of the action attribute in the form element</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the action URL of a form:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myForm&quot;).action=&quot;form_action.asp&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_form_action2">Try it yourself &raquo;</a>
</div>
<br><hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_form_action.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_form_action.asp#top" target="_top">TOP</a> |
		<a href="prop_form_action.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
