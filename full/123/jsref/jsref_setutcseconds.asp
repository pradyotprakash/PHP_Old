...
<style>a.menu_jsref_setutcseconds{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">setUTCSeconds()</span> Method</h1>
...
<p>Set the seconds to 35, according to UTC time:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcseconds" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The setUTCSeconds() method sets the seconds of a date object, according to UTC time time.</p>
<p>This method can also be used to set the milliseconds.</p>
...
<p>The setUTCSeconds() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.setUTCSeconds(<em>sec</em>,<em>millisec</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>sec</em></td>
    <td>Required. An integer representing the seconds
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set both the seconds and milliseconds, according to UTC:</p>
<div class="example_code notranslate">
var d = new Date();<br>
d.setUTCSeconds(35,825);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcseconds2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_setutcseconds.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_setutcseconds.asp#top" target="_top">TOP</a> |
		<a href="jsref_setutcseconds.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
