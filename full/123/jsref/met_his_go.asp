...
<style>a.menu_met_his_go{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>History <span class="color_h1">go()</span> Method</h1>
<p><a href="obj_history.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="History Object Reference" /> History Object</a>
</p>
...
&nbsp;&nbsp;}<br>
&lt;/script&gt;<br><br>
&lt;body&gt;<br>&lt;button onclick=&quot;goBack()&quot;&gt;Go Back 2 Pages&lt;/button&gt;<br>
&lt;/body&gt;</div>
...
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_his_go">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The go() method loads a specific URL from the history list.</p>
<p><strong>Tip:</strong> You can also use the <a href="met_his_back.asp">back()</a> 
or <a href="met_his_forward.asp">forward()</a> method to load the previous or 
next URL in the history list.</p>
<hr>
...
<p>The go() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
history.go(<i>number</i>|<i>URL</i>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>number|URL</em></td>
    <td>Required. The parameter can either be a number which goes to the URL within the 
specific position (-1 goes back one page, 1 goes forward one page), or a string. 
The string must be a partial or full URL, and the function will go to the first 
URL that matches the string.</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="tecspec">
...
<div class="example">
<h2 class="example">Example</h2>
<p>Go forward one page (This example will not work if the next page does not 
exist in the history list):</p>
<div class="example_code notranslate">
	window.history.go(1)</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_his_go2" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<br>
<hr>
<a href="obj_history.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="History Object Reference" /> History Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_his_go.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_his_go.asp#top" target="_top">TOP</a> |
		<a href="met_his_go.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
