...
<title>JavaScript PI Property</title>
<style>a.menu_jsref_pi{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">PI</span> Property</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_pi" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The PI property returns the ratio of a circle's area to the square of its radius, approximately 3.14</p>
<hr>
...
<p>The PI property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.PI</div></div><h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A Number, representing PI</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_pi.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_pi.asp#top" target="_top">TOP</a> |
		<a href="jsref_pi.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
