...
<title>JavaScript log() Method</title>
<style>a.menu_jsref_log{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">log()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_log" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The log() method returns the natural logarithm (base E) of a number.</p>
<p><b>Note:</b> If the parameter x is negative, <em>NaN</em> is returned.</p>
<p><b>Note:</b> If the parameter x is 0, <em>-Infinity</em> is returned.</p>
<hr>
...
<p>The log() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.log(<em>x</em>)</div></div>
...
<tr>
<td>Number</td>
<td>The natural logarithm of a specified number</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Use the log() method on different numbers:</p>
<div class="example_code notranslate">
var a=Math.log(2.7183);<br>
var b=Math.log(2);<br>
var c=Math.log(1);<br>
var d=Math.log(0);<br>
var e=Math.log(-1);
...
<div class="example_code notranslate">
1.0000066849139877<br>
0.6931471805599453<br>
0<br>
-Infinity<br>
NaN
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_log2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_log.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_log.asp#top" target="_top">TOP</a> |
		<a href="jsref_log.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
