...
<h2 class="example">Example</h2>
	<p class="example">Return the first child node of an element:</p>
<div class="example_code notranslate">
	document.body.childNodes.item(0);</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_nodelist_item" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The item() method returns the node at the specified index in a node lists.</p>
<p>This syntax:</p>
<div class="example_code notranslate">
	document.body.childNodes.item(0);</div>
<p>Will produce the same result as this syntax:</p>
<div class="example_code notranslate">
	document.body.childNodes[0];</div>
<hr/>
...
<td><em>index</em></td>
<td>Number</td>
<td>Required. The index of the node you want to return, in the node list</td>
</tr>
</table>
