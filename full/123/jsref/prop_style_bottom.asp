...
<title>HTML DOM Style bottom Property</title>
<style>a.menu_prop_style_bottom{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">bottom</span> Property</h1>
...
<p>Set the bottom position of a &lt;button&gt; element:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myBtn&quot;).style.bottom=&quot;100px&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The bottom property sets or returns the bottom position of a positioned 
element.</p>
<p>This property specifies the bottom position of the element including padding, 
scrollbar, border and margin.</p>
<p><b>Tip:</b> A positioned element is an element with the position property set 
to: relative, absolute, or fixed.</p>
<p><strong>Tip:</strong> To set or return the top position of a positioned 
element, use the <a href="prop_style_top.asp">top</a> property.</p>
<hr>
...
<p>The bottom property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the bottom property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.bottom
</div></div>
<p>Set the bottom property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.bottom=&quot;auto|<i>length</i>|<i>%</i>|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		<td>auto</td>
		<td>Lets the browser set the bottom position. This is default</td>
	</tr>
	<tr>
		<td><i>length</i></td>
		<td>Defines the bottom position in length units. Negative values are 
		allowed</td>
	</tr>
	<tr>
		<td><i>%</i></td>
		<td>Sets the bottom position in %&nbsp;of the height of the parent element</td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The value of the bottom property is inherited from parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the bottom position of a positioned element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS2</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Using negative values - Set the bottom position of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.bottom=&quot;-100px&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_bottom2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the bottom position of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.bottom);<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_bottom3">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_pos_bottom.asp">bottom property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_bottom.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_bottom.asp#top" target="_top">TOP</a> |
		<a href="prop_style_bottom.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
