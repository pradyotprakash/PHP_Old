...
<title>HTML DOM parentNode Property</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_prop_node_parentnode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">parentNode</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Return the parentNode of an &lt;li&gt; element:</p>
<div class="example_code notranslate">
	document.getElementById("item1").parentNode;</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_parentnode" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The parentNode property returns the parent node of the specified node, as a Node object.</p>
<p>Returns <em>null</em> if the the specified node does not have a parent node.</p>
...
<p>The parentNode property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>node</em>.parentNode</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">The parent-node of a node, as a Node object</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_node_parentnode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_node_parentnode.asp#top" target="_top">TOP</a> |
		<a href="prop_node_parentnode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
