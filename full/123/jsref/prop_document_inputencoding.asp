...
<title>HTML DOM inputEncoding Property</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_prop_document_inputencoding{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">inputEncoding</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Display the character encoding for this document:</p>
<div class="example_code notranslate">
	document.inputEncoding;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
	ISO-8859-1
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_document_inputencoding" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The inputEncoding property returns the character encoding for the document.</p>
<p>The inputEncoding property returns the character encoding at the time of parsing, and will return <em>null</em> if the document is created in memory.</p>
<hr>
...
<p>The inputEncoding property is supported in all major browsers, except for Opera.</p>
<p><strong>Note:</strong> Internet explorer 8 and earlier does not support this property.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
document.inputEncoding</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td width="75%">A String, representing the document's character encoding</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_document_inputencoding.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_document_inputencoding.asp#top" target="_top">TOP</a> |
		<a href="prop_document_inputencoding.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
