...
<title>HTML DOM Area search Property</title>
<style>a.menu_prop_area_search{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Area <span class="color_h1">search</span> Property</h1>
...
<p>Return the query portion of the href attribute for a specific area in an 
image-map:</p>
<div class="example_code notranslate">
	var x =
	document.getElementById(&quot;venus&quot;).search;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	?id=venus</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_area_search" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The search property sets or returns the query portion of the href attribute value.</p>
<p>The query portion is the part of the URL after the 
question mark (?) (this is often used for parameter passing).</p>
<hr>
...
<p>The search property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the search property:</p>
<div class="code notranslate"><div>
	<em>areaObject</em>.search</div></div>
<p>Set the search property:</p>
<div class="code notranslate"><div>
	<em>areaObject</em>.search=<i>querystring</i></div></div>
<br>
<table class="reference notranslate">
  ...
  <tr>
    <td><em>querystring</em></td>
    <td>
	The search part of a URL</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>The querystring of the href attribute value, including the question mark (?)</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_area_search.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_area_search.asp#top" target="_top">TOP</a> |
		<a href="prop_area_search.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
