...
<style>a.menu_event_onclick{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">onclick</span> Event</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_onclick" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
&lt;<i>element</i>
onclick=&quot;<i>SomeJavaScriptCode</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="code notranslate"><div>
	<em>object</em>.onclick=function(){<i>SomeJavaScriptCode</i>};</div></div>
<br>
...
<p>The onclick event is supported in all major browsers.</p>
<hr>

<h2>onclick In HTML</h2>
<p>The onclick attribute can be used within ALL HTML elements, EXCEPT: &lt;base&gt;, &lt;bdo&gt;, &lt;br&gt;, 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_onclick.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_onclick.asp#top" target="_top">TOP</a> |
		<a href="event_onclick.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
