...
<style>a.menu_dom_obj_table{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">Table</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_style.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_tabledata.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Table Object</h2>
<p>The Table object represents an HTML table.</p>
<p>For each &lt;table&gt; tag in an HTML document, a Table object is created.</p>


<hr>

<h2>Table Object Collections</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="coll_table_cells.asp">cells</a></td>
    <td>Returns a collection of all &lt;td&gt; or &lt;th&gt; elements in a table</td>
  </tr>
  <tr>
    <td><a href="coll_table_rows.asp">rows</a></td>
    <td>Returns a collection of all &lt;tr&gt; elements in a table</td>
  </tr>
  <tr>
    <td><a href="coll_table_tbodies.asp">tBodies</a></td>
    <td>Returns a collection of all &lt;tbody&gt; elements in a table</td>
  </tr>
  </table>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<a href="prop_style_cssfloat.asp">style.cssFloat</a> instead.<br></span>Sets or returns 
	the alignment of a table according to surrounding text<br></td>
  </tr>
  <tr>
    <td>background</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_background.asp">
	style.background</a> instead.<br></span>Sets or returns 
	the background image of a table<br></td>
  </tr>
  <tr>
    <td>bgColor</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_backgroundcolor.asp">
	style.backgroundColor</a> instead.<br></span>Sets or returns 
	the background color of a table<br></td>
  </tr>
  <tr>
    <td>border</td>
    <td><span class="deprecated">Deprecated. Use <a href="prop_style_border.asp">style.border</a> 
	instead.<br></span>Sets or returns the width of 
	the table border.<br></td>
  </tr>
  <tr>
    <td><a href="prop_table_caption.asp">caption</a></td>
    <td>Returns the &lt;caption&gt; element of a table</td>
  </tr>
  <tr>
    <td>cellPadding</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_padding.asp">
	style.padding</a> 
	instead.<br></span>Sets or returns the amount of space between the cell 
    border and cell content<br></td>
  </tr>
  <tr>
    <td>cellSpacing</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_borderspacing.asp">style.borderSpacing</a> 
	instead.<br></span>Sets or returns the amount of space between the cells in a 
    table<br></td>
  </tr>
  <tr>
    <td>frame</td>
    <td><span class="deprecated">Not supported in HTML5.<br></span>Sets or returns which outer-borders (of a table) that should be 
	displayed</td>
  </tr>
  <tr>
    <td>height</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_height.asp">style.height</a> 
	instead.<br></span>Sets or returns 
	the height of a table<br></td>
  </tr>
  <tr>
    <td>rules</td>
    <td><span class="deprecated">Not supported in HTML5.<br></span>Sets or returns which inner-borders (between the cells) that 
should be displayed in a table</td>
  </tr>
  <tr>
    <td>summary</td>
    <td><span class="deprecated">Not supported in HTML5.<br></span>Sets or returns a description of the data in a table</td>
  </tr>
  <tr>
    <td><a href="prop_table_tfoot.asp">tFoot</a></td>
    <td>Returns a reference to the &lt;tfoot&gt; element of a table</td>
  </tr>
  <tr>
    <td><a href="prop_table_thead.asp">tHead</a></td>
    <td>Returns a reference to the &lt;thead&gt; element of a table</td>
  </tr>
  <tr>
    <td>width</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_width.asp">style.width</a> 
	instead.<br></span>Sets or returns 
	the width of the table<br></td>
  </tr>
  </table>

<h2>Table Object Methods</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_table_createcaption.asp">createCaption()</a></td>
    <td>Creates an empty &lt;caption&gt; element and adds it to the table</td>
  </tr>
  <tr>
    <td><a href="met_table_createtfoot.asp">createTFoot()</a></td>
    <td>Creates an empty &lt;tfoot&gt; element and adds it to the table</td>
  </tr>
  <tr>
    <td><a href="met_table_createthead.asp">createTHead()</a></td>
    <td>Creates an empty &lt;thead&gt; element and adds it to the table</td>
  </tr>
  <tr>
    <td><a href="met_table_deletecaption.asp">deleteCaption()</a></td>
    <td>Removes the first &lt;caption&gt; element from the table</td>
  </tr>
  <tr>
    <td><a href="met_table_deleterow.asp">deleteRow()</a></td>
    <td>Removes a row (&lt;tr&gt;) from the table</td>
  </tr>
  <tr>
    <td><a href="met_table_deletetfoot.asp">deleteTFoot()</a></td>
    <td>Removes the &lt;tfoot&gt; element from the table</td>
  </tr>
  <tr>
    <td><a href="met_table_deletethead.asp">deleteTHead()</a></td>
    <td>Removes the &lt;thead&gt; element from the table</td>
  </tr>
  <tr>
    <td><a href="met_table_insertrow.asp">insertRow()</a></td>
    <td>Creates an empty &lt;tr&gt; element and adds it to the table</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Table object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_table.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_table.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_table.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
