...
<title>HTML DOM Option disabled Property</title>
<style>a.menu_prop_option_disabled{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Option <span class="color_h1">disabled</span> Property</h1>
...
<p>Find out if the second option (index 1) in a drop-down list is disabled or not:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;pets&quot;);<br>document.getElementById(&quot;demo&quot;).innerHTML=x.options[1].disabled;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">true</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_option_disabled">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The disabled property sets or returns whether an option in a drop-down list is disabled, or not.</p>
...
<div class="code notranslate"><div>
	<em>optionObject</em>.disabled
</div></div>
<p>Set the disabled property:</p>
<div class="code notranslate"><div>
	<em>optionObject</em>.disabled=true|false
</div></div>
<br>
<table class="reference notranslate">
	...
	<tr>
		...
		<ul>
			<li>true - The option is disabled</li>
			<li>false - Default. The option is not disabled</li>
		</ul>
		</td>
	</tr>
</table>
...
<tr>
<td>Boolean</td>
<td>Returns true if the option is disabled, otherwise it returns false</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Disable the third option (index 2) in a drop-down list:</p>
	<div class="example_code notranslate">
		document.getElementById(&quot;pets&quot;).options[2].disabled=true;<br>
	</div>
	<p>The result will be:</p>
<div class="example_code notranslate">
	<select multiple="multiple"><option>Cat</option><option>Dog</option><option disabled>Horse</option></select>
</div>

<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_option_disabled2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_option_disabled.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_option_disabled.asp#top" target="_top">TOP</a> |
		<a href="prop_option_disabled.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
