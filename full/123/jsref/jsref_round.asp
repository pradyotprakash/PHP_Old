...
<title>JavaScript round() Method</title>
<style>a.menu_jsref_round{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">round()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_round" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The round() method rounds a number to the nearest integer.</p>
<p><strong>Note:</strong> 2.49 will be rounded down, 2.5 will be rounded up.</p>
<hr>
...
<p>The round() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Math.round(<em>x</em>)</div></div>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Round different numbers to the nearest integer:</p>
<div class="example_code notranslate">
var a=Math.round(2.60);<br>
var b=Math.round(2.50);<br>
var c=Math.round(2.49);<br>
var d=Math.round(-2.60);<br>
var e=Math.round(-2.50);<br>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_round2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_round.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_round.asp#top" target="_top">TOP</a> |
		<a href="jsref_round.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
