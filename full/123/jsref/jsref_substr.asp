...
<style>a.menu_jsref_substr{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">substr()</span> Method</h1>
...
<div class="example_code notranslate">
	ello</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_substr" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The substr() method extracts parts of a string, beginning at the character at the specified position, and returns the specified number of characters.</p>
<p><b>Tip:</b> To extract characters from the end of the string, use a negative start number (This does not work in IE 8 and earlier).</p>
<p><strong>Note:</strong> The substr() method does not change the original string.</p>
<hr>
...
<p>The substr() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>string</i>.substr(<em>start</em>,<em>length</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>length</em></td>
    <td>Optional. The number of characters to extract. If omitted, it extracts the 
...
<tr>
<td>String</td>
<td>A new string containing the extracted part of the text. If <em>length</em> 
is 0 or negative, an empty string is returned</td>
</tr>
</table>
...
<div class="example_code notranslate">
llo world!</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_substr2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="example_code notranslate">
	H</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_substr3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="example_code notranslate">
	!</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_substr4" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_substr.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_substr.asp#top" target="_top">TOP</a> |
		<a href="jsref_substr.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
