...
<title>HTML DOM Frameset rows Property</title>
<style>a.menu_prop_frameset_rows{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Frameset <span class="color_h1">rows</span> Property</h1>
...
<p>The rows property sets or returns the value of the rows attribute in a frameset.</p>
<p>The rows attribute specifies the size of, and the number of frames in a 
frameset. Each frame’s height is specified in a comma-separated list.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>

framesetObject.rows=<i>values</i>
</div></div>

<p>The rows property can have one or more of the following values:</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><i>pixels</i></td>
    <td>The row height in pixels (like &quot;100px&quot; or just &quot;100&quot;)</td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>The row height in percent of the available space (like &quot;50%&quot;)</td>
  </tr>
	<tr>
    <td>*</td>
    <td>The rest of the available space should be assigned this row</td>
  </tr>
	</table>
<br>
<hr>
...
<h2>Example</h2>
<p>Create a frameset 
with two rows. Each row is set to 50% of the browser window:</p>

<div class="code notranslate"><div>

&lt;html&gt;<br>
&lt;frameset id=&quot;main&quot; rows=&quot;50%,50%&quot;&gt;<br>
&nbsp;&nbsp;&lt;frame src=&quot;frame_rows.htm&quot;><br>
...
<p>The source code of &quot;frame_rows.htm&quot; is as follows:</p>
<div class="example">
...
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;parent.document.getElementById(&quot;main&quot;).rows=&quot;30%,70%&quot;<br>
&nbsp;&nbsp;}<br>
function restoreRows()<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;parent.document.getElementById(&quot;main&quot;).rows=&quot;50%,50%&quot;<br>
&nbsp;&nbsp;}<br>
&lt;/script&gt;<br>
&lt;/head&gt;<br>
&lt;body&gt;<br>
...
value=&quot;Change row size&quot;><br>
&lt;input type=&quot;button&quot; onclick=&quot;restoreRows()&quot;
value=&quot;Restore row size&quot;><br>
&lt;/form&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_frameset_rows">Try it yourself &raquo;</a>
</div>
<br><hr>
<a href="dom_obj_frameset.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Frameset Object Reference" /> Frameset Object</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_frameset_rows.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_frameset_rows.asp#top" target="_top">TOP</a> |
		<a href="prop_frameset_rows.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
