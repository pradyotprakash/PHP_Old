...
<style>a.menu_jsref_prototype_date{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript Date <span class="color_h1">prototype</span> Property</h1>
...
<p>Make a new date method that gives the date object a month-name property called myProp:</p>
<div class="example_code notranslate">
	Date.prototype.myMet=function()<br>{<br>if 
	(this.getMonth()==0){this.myProp=&quot;January&quot;};<br>if 
	(this.getMonth()==1){this.myProp=&quot;February&quot;};<br>if 
	(this.getMonth()==2){this.myProp=&quot;March&quot;};<br>if 
	(this.getMonth()==3){this.myProp=&quot;April&quot;};<br>if 
	(this.getMonth()==4){this.myProp=&quot;May&quot;};<br>if 
	(this.getMonth()==5){this.myProp=&quot;June&quot;};<br>if 
	(this.getMonth()==6){this.myProp=&quot;July&quot;};<br>if 
	(this.getMonth()==7){this.myProp=&quot;August&quot;};<br>if 
	(this.getMonth()==8){this.myProp=&quot;Spetember&quot;};<br>if 
	(this.getMonth()==9){this.myProp=&quot;October&quot;};<br>if 
	(this.getMonth()==10){this.myProp=&quot;November&quot;};<br>if 
	(this.getMonth()==11){this.myProp=&quot;December&quot;};<br>}
</div>
<p>Make a Date object, then call the myMet method:</p>
<div class="example_code notranslate">
var d = new Date();<br>
d.myMet();<br>
var monthname = d.myProp;
</div>
<p>The result of <em>monthname</em> will be:</p>
<div class="example_code notranslate">
<script>
var d = new Date();
d.myMet();
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_prototype_date" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The prototype constructor allows you to add new properties and methods to the Date() object.</p>
<p>When constructing a property, ALL date objects will be given the property, and it's value, as default.</p>
<p>When constructing a method, ALL date objects will have this method available.</p>
<p><b>Note:</b> Date.prototype does not refer to a single date object, but to the Date() object itself.</p>
<p><b>Note:</b> Prototype is a global object constructor which is available for all JavaScript objects.</p>
<hr>
...
<p>The prototype property is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
Date.prototype.<em>name</em>=<em>value</em></div></div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_prototype_date.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_prototype_date.asp#top" target="_top">TOP</a> |
		<a href="jsref_prototype_date.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
