...
<title>HTML DOM namespaceURI Property</title>
...
<h1>HTML DOM <span class="color_h1">namespaceURI</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Get the URI of the namespace for an XHTML document:</p>
<div class="example_code notranslate">
	document.documentElement.namespaceURI;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
http://www.w3.org/1999/xhtml
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_namespaceuri" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The namespaceURI property returns URI of the specified node&#39;s namespce.</p>
<p><strong>Note:</strong> An element node inherits the namespace of its parent 
node, therefore, all elements in an XHTML document has the namespaceURI &quot;http://www.w3.org/1999/xhtml&quot;.</p>
<hr>
...
<p>The namespaceURI property is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet Explorer 8 and earlier does not support this property.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>node</em>.namespaceURI</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:25%">Return Value:</th>
	<td>A String, representing the URI of the node's namespace</td>
</tr>
<tr>
	<th>DOM Version</th>
