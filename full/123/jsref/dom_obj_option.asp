...
<style>a.menu_dom_obj_option{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_object.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_select.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Option Object</h2>
<p>The Option object represents an option in a dropdown list in an HTML form.</p>
<p>For each &lt;option&gt; tag in an HTML form, an Option object is created.</p>
<p>You can access an Option object by searching through the elements[] array of 
a form, or by using document.getElementById().</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_option_defaultselected.asp">defaultSelected</a></td>
    <td>Returns the default value of the selected attribute</td>
  </tr>
    <tr>
    <td><a href="prop_option_disabled.asp">disabled</a></td>
    <td>Sets or returns whether an option is disabled, or not</td>
    </tr>
  
  <tr>
    <td><a href="prop_option_form.asp">form</a></td>
    <td>Returns a reference to the form that contains the option</td>
  </tr>
  <tr>
    <td><a href="prop_option_index.asp">index</a></td>
    <td>Sets or returns the index position of an option in a drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_option_selected.asp">selected</a></td>
    <td>Sets or returns the selected state of an option</td>
  </tr>
  <tr>
    <td><a href="prop_option_text.asp">text</a></td>
    <td>Sets or returns the text of an option</td>
  </tr>
  <tr>
    <td><a href="prop_option_value.asp">value</a></td>
    <td>Sets or returns the value of an option to be sent to the 
	server</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Option object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="dom_obj_option.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="dom_obj_option.asp#top" target="_top">TOP</a> |
		<a href="dom_obj_option.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
