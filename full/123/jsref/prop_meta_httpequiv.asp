...
<title>HTML DOM Meta httpEquiv Property</title>
<style>a.menu_prop_meta_httpequiv{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Meta <span class="color_h1">httpEquiv</span> Property</h1>
<p><a href="dom_obj_meta.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Meta Object Reference" /> Meta Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the HTTP header for the information in the content attribute:</p>
<div class="example_code notranslate">
	var x = document.getElementsByTagName(&quot;meta&quot;)[0].httpEquiv;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">
	content-type</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_meta_httpequiv" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The httpEquiv property sets or returns an HTTP header for the information in 
the content attribute.</p>
<p>The http-equiv attribute can be used to simulate an HTTP response header.</p>
<p>The value of the http-equiv attribute depends on the value of the content 
attribute.</p>
<p><b>Note:</b> If the name attribute is set, the http-equiv attribute should 
not be set.</p>
<hr>
...
<p>The httpEquiv property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<p>Return the httpEquiv property:</p>
<div class="code notranslate"><div>
	<em>metaObject</em>.httpEquiv
</div></div>
<p>Set the httpEquiv property:</p>
<div class="code notranslate"><div>
	<em>metaObject</em>.httpEquiv=<i>HTTP-header</i></div></div>
<p>Some commonly used <i>HTTP-header</i> values are:</p>
<table class="reference notranslate">
	...
	<tr>
		<td>cache-control</td>
		<td>Controls the caching mechanism to use for the document.
		<p>Available values:</p>
		<ul>
			<li>public - cached in public shared caches</li>
			<li>private - cached in private cache</li>
			<li>no-cache - not cached</li>
			<li>no-store - cached but not archived</li>
		</ul>
		<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;cache-control&quot; content=&quot;no-cache&quot;></p></td>
	</tr>
	<tr>
		<td>content-language</td>
		<td>Specifies the natural language(s) of the document (used 
		by search engines to categorize pages by language).
		<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;content-language&quot; content=&quot;en-US&quot;></p></td>
	</tr>-->
	<tr>
		<td>content-type</td>
		<td>Specifies the character set for the contents of the document.<p>
		<b>Tip:</b> It is recommended to always specify the character set.</p>
		<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;content-type&quot; content=&quot;text/html; charset=UTF-8&quot;></p></td>
	</tr>
	<tr>
		<td>default-style</td>
		<td>Specifies the preferred style sheet to use.<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;default-style&quot; content=&quot;<em>the 
		documents preferred stylesheet</em>&quot;></p>
		<p><strong>Note:</strong> The value of the content attribute above must 
		match the value of the ttitle attribute on a link element in the same 
		document, or it must match the value of the title attribute on a style 
		element in the same document.</p></td>
	</tr>
	<!--
	<tr>
		<td>date</td>
		<td>Specifies the date and time when the page was created.
		<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;date&quot; content=&quot;Wed, 16 Feb 2011 22:34:13 GMT&quot;></p></td>
	</tr>
	<tr>
		<td>expires</td>
		<td>Specifies the date and time when the page will expire.
		<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;expires&quot; content=&quot;Fri, 30 Dec 2011 12:00:00 GMT&quot;></p></td>
	</tr>
	<tr>
		<td>last-modified</td>
		<td>Specifies the last modification date.
		<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;last-modified&quot; content=&quot;Mon, 03 Jan 2011 17:45:57 GMT&quot;></p></td>
	</tr>
	<tr>
		<td>location</td>
		<td>Redirects the visitor to another location.
		<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;location&quot; content=&quot;URL=http://www.w3schools.com&quot;></p></td>
	</tr>-->
	<tr>
		<td>refresh</td>
		<td>Defines a time interval for the document to refresh itself.
		<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;refresh&quot; content=&quot;300&quot;></p>
		<p><strong>Note:</strong> The value &quot;refresh&quot; should be used carefully, 
		as it takes the control of a page away from the user. Using &quot;refresh&quot; will cause a failure in <a target="_blank" href="http://www.w3.org/WAI/intro/wcag.php">W3C's Web Content Accessibility Guidelines</a>.</p></td>
	</tr>
	<tr><!--
		<td>set-cookie</td>
		<td>Creates a cookie with specified name,expires date and value.
		<p>Example:</p>
		<p>&lt;meta http-equiv=&quot;set-cookie&quot; content=&quot;w3scookie=myContent;expires=Fri, 
		30 Dec 2011 12:00:00 GMT; path=http://www.w3schools.com&quot;&gt;</p></td>
	</tr>
	<tr>
		<td>window-target</td>
		<td>Specifies the name of the frame where the current document must be loaded</td>
	</tr>-->
</table>
<h2>Return Value</h2>
<table class="reference notranslate">
...
<tr>
<td>String</td>
<td>Information about the HTTP response message header</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the value of the http-equiv and content attributes. The 
following example will refresh the document every 30 seconds:</p>
<div class="example_code notranslate">
	document.getElementsByTagName(&quot;meta&quot;)[0].httpEquiv=&quot;refresh&quot;;<br>
	document.getElementsByTagName(&quot;meta&quot;)[0].content=&quot;30&quot;;</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_meta_httpequiv2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="dom_obj_meta.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Meta Object Reference" /> Meta Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_meta_httpequiv.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_meta_httpequiv.asp#top" target="_top">TOP</a> |
		<a href="prop_meta_httpequiv.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
