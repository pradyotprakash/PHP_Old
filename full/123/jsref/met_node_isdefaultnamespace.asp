...
<title>HTML DOM isDefaultNamespace Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_node_isdefaultnamespace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM<span class="color_h1"> isDefaultNamespace()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">See if the defined namespace is the default namespace:</p>
<div class="example_code notranslate" style="font-size:98%;">
	document.documentElement.isDefaultNamespace('http://www.w3.org/1999/xhtml');</div>
<p>The result will be:</p>
<div class="example_code notranslate">
true
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_isdefaultnamespace" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isDefaultNamespace() method returns <em>true</em> if the specified namespace is default, otherwise <em>false</em>.</p>
<hr/>
...
<p>The isDefaultNamespace() method is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet Explorer 8 and earlier does not support this method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>node</i>.isDefaultNamespace(<i>namespaceURI</i>)</div></div>
...
<td>String</td>
<td>Required. The URI of the namespace you want to check</td>
</tr>
</table>
...
<tr>
<td>Boolean</td>
<td><em>true</em> if the namespace is default, otherwise <em>false</em></td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_isdefaultnamespace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_isdefaultnamespace.asp#top" target="_top">TOP</a> |
		<a href="met_node_isdefaultnamespace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
