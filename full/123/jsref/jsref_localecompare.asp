...
<style>a.menu_jsref_localecompare{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">localeCompare()</span> Method</h1>
...
var str1 = &quot;ab&quot;;<br>var str2 = &quot;cd&quot;;<br>var n = str1.localeCompare(str2);
</div>
<p>The result of <em>n</em> will be:</p>
<div class="example_code notranslate">
	-1 // str1 is sorted before str2</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_localecompare" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The localeCompare() method compares two strings in the current locale.</p>
<p>The locale is based on the language settings of the browser.</p>
<p>The localeCompare() method returns a number indicating whether the <em>string</em> 
comes before, after or is equal as the <em>compareString</em> in <strong>sort order</strong>.</p>
<hr>
...
<p>The localeCompare() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>string</i>.localeCompare(<em>compareString</em>)</div></div>
...
the same as the <em>compareString</em> in sort order.
Returns one of three values:
<ul>
	<li>-1 if the reference string is sorted before the 
<em>compareString</em></li>
	<li>0 if the two strings are equal</li>
	<li>1 if the reference string is sorted after the <em>compareString</em></li>
</ul>
</td>
</tr>
</table>
...
<p>Compare two strings in the current locale:</p>
<div class="example_code notranslate">
var str1 = &quot;cd&quot;;<br>var str2 = &quot;ab&quot;;<br>var n = str1.localeCompare(str2);
</div>
<p>The result of <em>n</em> will be:</p>
<div class="example_code notranslate">
	1 // str1 is sorted after str2</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_localecompare2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Compare two equal strings in the current locale:</p>
<div class="example_code notranslate">
var str1 = &quot;ab&quot;;<br>var str2 = &quot;ab&quot;;<br>var n = str1.localeCompare(str2);
</div>
<p>The result of <em>n</em> will be:</p>
<div class="example_code notranslate">
	0 // the two strings are equal</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_localecompare3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_localecompare.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_localecompare.asp#top" target="_top">TOP</a> |
		<a href="jsref_localecompare.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
