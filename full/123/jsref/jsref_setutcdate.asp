...
<style>a.menu_jsref_setutcdate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">setUTCDate()</span> Method</h1>
...
<p>Set the day of the month, according to UTC:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcdate" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The setUTCDate() method sets the day of the month, according to the UTC time.</p>
...
<p>The setUTCDate() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.setUTCDate(<em>day</em>)
</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>day</em></td>
    <td>Required. An integer representing the day of a month.
...
<div class="example">
<h2 class="example">Example</h2>
<p>Set the day of the month to be the last day of the previous month:</p>
<div class="example_code notranslate">
var d = new Date();<br>
d.setUTCDate(0);
</div>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcdate2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example</h2>
<p>Set the day of the month, to a specified date:</p>
<div class="example_code notranslate">
var d = new Date("July 21, 1983 01:15:00");<br>
d.setUTCDate(15);
</div>
<p>The result of <em>d</em> will be:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_setutcdate3" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_setutcdate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_setutcdate.asp#top" target="_top">TOP</a> |
		<a href="jsref_setutcdate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
