...
<title>HTML DOM insertBefore Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_node_insertbefore{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">insertBefore()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Insert an item in a list:</p>
<div class="example_code notranslate">
	document.getElementById("myList").insertBefore(<em>newItem,existingItem</em>);</div>
<p>Before inserting:</p>
<div class="example_code notranslate">
<ul><li>Coffee</li><li>Tea</li></ul>
</div>
<p>After inserting:</p>
<div class="example_code notranslate">
<ul><li>Water</li><li>Coffee</li><li>Tea</li></ul>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_insertbefore" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The insertBefore() method inserts a node as a child, right before an existing 
child, which you specify.</p>
<p><strong>Tip:</strong> If you want to create a new list item, with text, remember to create the text as a Text node wich you append to the 
LI element, <em>then</em> insert the LI to the list.</p>
<p>You can also use the insertBefore method to insert/move an existing element.</p>
<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Move a list item from one list to another:</p>
<div class="example_code notranslate">
	var node=document.getElementById(&quot;myList2&quot;).lastChild;<br>var 
	list=document.getElementById(&quot;myList1&quot;);<br>
	list.insertBefore(node,list.childNodes[0]);</div>
<p>Before inserting:</p>
<div class="example_code notranslate">
<ul><li>Coffee</li><li>Tea</li></ul>
<ul><li>Water</li><li>Milk</li></ul>
</div>
<p>After insertBefore:</p>
<div class="example_code notranslate">
<ul><li>Milk</li><li>Coffee</li><li>Tea</li></ul>
<ul><li>Water</li></ul>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_insertbefore2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>The insertBefore() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>node</i>.insertBefore(<i>newnode,existingnode</i>)</div></div>
...
<td><em>newnode</em></td>
<td>Node object</td>
<td>Required. The node object you want to insert</td>
</tr>
<tr>
<td><em>existingnode</em></td>
<td>Node object</td>
<td>Optional. The child node you want to insert the new node before. When not 
specified, the insertBefore method will insert the <em>newnode</em> at the end</td>
</tr>
</table>
...
<table class="tecspec">
<tr>
	<th style="width:16%;">DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_insertbefore.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_insertbefore.asp#top" target="_top">TOP</a> |
		<a href="met_node_insertbefore.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
