...
<title>HTML DOM Style padding Property</title>
<style>a.menu_prop_style_padding{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">padding</span> Property</h1>
...
<p>Set the padding of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	document.getElementById(&quot;myDiv&quot;).style.padding=&quot;50px 10px 20px 30px&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_padding">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The padding property sets or returns the padding of an element.</p>
...
<ul>
	<li>One value, like: div {padding: 50px} - all four 
	sides will have a padding of 50px</li>
	<li>Two values, like: div {padding: 50px 10px} - the 
	top and bottom padding will be 50px, left and right padding will be 10px</li>
	<li>Three values, like: div {padding: 50px 10px 20px} - 
	the top padding will be 50px, left and right padding will be 10px, bottom 
	padding will be 20px</li>
	<li>Four values, like: div {padding: 50px 10px 20px 30px} - the top 
	padding will be 50px, right padding will be 10px, bottom 
	padding will be 20px, left padding will be 30px</li>
</ul>
<hr>
...
<p>The padding property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the padding property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.padding
</div></div>
<p>Set the padding property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.padding=&quot;<i>%</i>|<i>length</i>|inherit&quot;
</div></div>
<br>
...
<table class="reference notranslate">
	...
	<tr>
		<td><i>%</i></td>
		<td>Defines the padding in % of the width of the parent element</td>
	</tr>
	<tr>
		<td><i>length</i></td>
		<td>Defines the padding in length units </td>
	</tr>
	<tr>
		<td>inherit</td>
		<td>The padding is inherited from the 
		parent element</td>
	</tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the padding of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Change the padding of all four sides of a &lt;div&gt; element to &quot;25px&quot;:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.padding=&quot;25px&quot;;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_padding2">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Return the padding of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.padding);<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_padding3">Try it yourself &raquo;</a>
</div>
<br>
...
<p>CSS reference: <a href="../cssref/pr_padding.asp">padding property</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_padding.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_padding.asp#top" target="_top">TOP</a> |
		<a href="prop_style_padding.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
