...
<title>HTML DOM Image complete Property</title>
<style>a.menu_prop_img_complete{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Image <span class="color_h1">complete</span> Property</h1>
...
<p>Check to see if the image is finished loading:</p>
...
<div class="example_code notranslate">
	true</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_img_complete" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The complete property returns whether or not the browser is finished loading 
an image.</p>
<p>If the image is finished loading, the complete property returns true, otherwise it 
returns false.</p>
<hr>
...
<p>The complete property is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>imageObject</em>.complete
</div></div>
<h2>Return Value</h2>
...
<td>Boolean</td>
<td>
Returns a boolean value that indicates whether the browser is finished 
loading the image or not<br><br>Possible values:
<ul>
	<li>true - the loading is finished</li>
	<li>false - the loading is not finished</li>
</ul>
	</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Check to see if the image is finished loading on body onload:</p>
<div class="example_code notranslate">
&lt;body onload=&quot;myFunction()&quot;&gt;<br>
</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_img_complete2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_img_complete.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_img_complete.asp#top" target="_top">TOP</a> |
		<a href="prop_img_complete.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
