...
<style>a.menu_met_element_getelementsbytagname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">getElementsByTagName()</span> Method</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Change the text of the first list item in a list:</p>
<div class="example_code notranslate">
var list=document.getElementsByTagName(&quot;UL&quot;)[0]<br>
list.getElementsByTagName("LI")[0].innerHTML=&quot;Milk&quot;;<br>
</div>
	<p>Before changing the text:</p>
<div class="example_code notranslate">
<ul><li>Coffee</li><li>Tea</li></ul>
</div>
	<p>After changing the text:</p>
<div class="example_code notranslate">
<ul><li>Milk</li><li>Tea</li></ul>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_element_getelementsbytagname" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<h2>Definition and Usage</h2>
<p>The getElementsByTagName() method returns a collection of an elements's child elements with the specified tagname, as a NodeList object.</p>
<p><strong>Tip:</strong> The parametervalue "*" returns all of the element's child elements.</p>
<hr/>
...
<p>The getElementsByTagName() method is supported in all major browsers.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>element</em>.getElementsByTagName(<em>tagname</em>)</div></div>
...
<td><em>tagname</em></td>
<td>String</td>
<td>Required. The tagname of the child elements you want to get</td>
</tr>
</table>
...
<tr>
<td>NodeList object</td>
<td>A collection of the element's child elements with the specified tagname</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_element_getelementsbytagname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_element_getelementsbytagname.asp#top" target="_top">TOP</a> |
		<a href="met_element_getelementsbytagname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
