...
<title>Window resizeTo() Method</title>
<style>a.menu_met_win_resizeto{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">resizeTo()</span> Method</h1>
...
<div class="example_code notranslate">
	...
	// Opens a new window<br>}<br><br>function resizeWin()<br>{<br>myWindow.resizeTo(250,250);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Resizes the new window<br>
	myWindow.focus();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Assures that the new window gets focus<br>}<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_resizeto" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The resizeTo() method resizes a window to the specified width and height.</p>
...
<p>The resizeTo() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	<em>window</em>.resizeTo(<i>width,height</i>)</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>width</em></td>
    <td>Required. Sets the width of the window, in pixels</td>
  </tr>
  <tr>
    <td><em>height</em></td>
    <td>Required. Sets the height of the window, in pixels</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="tecspec">
...
<div class="example">
<h2 class="example">Example</h2>
<p>Using the resizeTo() method together with resizeBy():</p>
	<div class="example_code notranslate">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_resizeto.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_resizeto.asp#top" target="_top">TOP</a> |
		<a href="met_win_resizeto.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
