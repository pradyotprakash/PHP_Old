...
<title>HTML DOM isId Property</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_prop_attr_isid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">isId</span> Property</h1>
...
<h2 class="example">Example</h2>
	<p class="example">Find out if an attribute is the element's ID attribute or not:</p>
<div class="example_code notranslate">
	document.getElementById("demo").attributes[0].isId;</div>
<p>The result will be:</p>
<div class="example_code notranslate">
	true
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_attr_isid" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The isId property returns <em>true</em> if the attribute is of type ID, otherwise it returns <em>false</em>.</p>
<hr>
...
<p>The isId property is supported in all major browsers, except Internet Explorer and Opera.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<em>attribute</em>.isId</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_attr_isid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_attr_isid.asp#top" target="_top">TOP</a> |
		<a href="prop_attr_isid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
