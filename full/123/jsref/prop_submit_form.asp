...
<title>HTML DOM Submit form Property</title>
<style>a.menu_prop_submit_form{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Submit <span class="color_h1">form</span> Property</h1>
...
<p>Return the id of the form containing the &lt;input type="submit"&gt; element:</p>
<div class="example_code notranslate">
	var x = document.getElementById(&quot;mySubmit&quot;).form.id;</div>
<p>The result of <em>x</em> will be:</p>
<div class="example_code notranslate">myForm</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_submit_form">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The form property returns a reference to the form that contains the submit button.</p>
...
<tr>
<td>A reference to the form element containing the submit button. If the submit button is not 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_submit_form.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_submit_form.asp#top" target="_top">TOP</a> |
		<a href="prop_submit_form.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
