...
<title>Window setInterval() Method</title>
<style>a.menu_met_win_setinterval{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Window <span class="color_h1">setInterval()</span> Method</h1>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_setinterval" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
...
<a href="met_win_clearinterval.asp">clearInterval()</a> is called, or the window is 
closed.</p>
...
<p><strong>Tip:</strong> To execute a function only once, after a specified 
number of milliseconds, use the <a href="met_win_settimeout.asp">setTimeout()</a> method.</p>
<hr>
...
<p>The setInterval() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
setInterval(<em>function,milliseconds,lang</em>)</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Required. The intervals (in milliseconds) on how often to execute the 
	code</td>
  </tr>
  <tr>
    <td><em>lang</em></td>
    <td>Optional. JScript | VBScript | JavaScript</td>
  </tr>
</table>
<h2>Return Value</h2>
<table class="tecspec">
<tr>
<td>An integer with the ID value of the timer that is set. Use this value with the clearInterval() method to cancel the timer.</td>
</tr>
</table>
<br>
<hr>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Display the current time (the setInterval() method will execute the function 
once every 1 second, just like a digital watch):</p>
<div class="example_code notranslate">
	var myVar = setInterval(function(){myTimer()},1000);<br><br>function myTimer()<br>
	{<br>var d = new Date();<br>var t = d.toLocaleTimeString();<br>
	document.getElementById(&quot;demo&quot;).innerHTML=t;<br>}</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_setinterval2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example</h2>
<p>Using clearInterval() to stop time:</p>
<div class="example_code notranslate">
	var myVar = setInterval(function(){myTimer()},1000);<br><br>function myTimer()<br>
	{<br>var d = new Date();<br>var t = d.toLocaleTimeString();<br>
	document.getElementById(&quot;demo&quot;).innerHTML=t;<br>}<br><br>function myStopFunction()<br>
	{<br>clearInterval(myVar);<br>}</div>
<br>
<a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_win_setinterval_clearinterval" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_win_setinterval.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_win_setinterval.asp#top" target="_top">TOP</a> |
		<a href="met_win_setinterval.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
