...
<title>HTML DOM Style borderLeftColor Property</title>
<style>a.menu_prop_style_borderleftcolor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Style <span class="color_h1">borderLeftColor</span> Property</h1>
...
<p>Change the color of the left border of a &lt;div&gt; element to red:</p>
<div class="example_code notranslate">
document.getElementById(&quot;myDiv&quot;).style.borderLeftColor=&quot;red&quot;;</div><br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderleftcolor">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The borderLeftColor property sets or returns the color of the left border of an element.</p>
<hr>
...
<p>The borderLeftColor property is supported in all major browsers.</p>
<p><b>Note:</b> The value "inherit" is not supported in IE7 and earlier. IE8 requires a !DOCTYPE. IE9 and later support "inherit".</p>
<hr>

<h2>Syntax</h2>
<p>Return the borderLeftColor property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderLeftColor
</div></div>
<p>Set the borderLeftColor property:</p>
<div class="code notranslate"><div>
	<em>object</em>.style.borderLeftColor=&quot;<i>color</i>|transparent|inherit&quot;
</div></div>
<br>
<table class="reference notranslate">
  ...
  <tr>
    <td><i>color</i></td>
    <td>Specifies the color of the left border. Look at <a href="../cssref/css_colors_legal.asp">CSS Color Values</a> 
	for a complete list of possible color values. Default color is black</td>
  </tr>
  <tr>
    <td>transparent</td>
    <td>The color of the left border is transparent (underlying content will 
	shine through)</td>
  </tr>
  <tr>
    <td>inherit</td>
    <td>The color of the left border is inherited from the 
		parent element</td>
  </tr>
</table>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the color of an element's left border</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS1</td>
...
<div class="example">
<h2 class="example">Example</h2>
<p>Return the left border color of a &lt;div&gt; element:</p>
<div class="example_code notranslate">
	alert(document.getElementById(&quot;myDiv&quot;).style.borderLeftColor);</div>
<br>
<a target="_blank" class="tryitbtn" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_style_borderleftcolor2">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<p>CSS reference: <a href="../cssref/pr_border-left_color.asp">border-left-color property</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_style_borderleftcolor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_style_borderleftcolor.asp#top" target="_top">TOP</a> |
		<a href="prop_style_borderleftcolor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
