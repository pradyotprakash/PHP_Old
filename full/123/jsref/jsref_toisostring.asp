...
<title>JavaScript toISOString() Method</title>
<style>a.menu_jsref_toisostring{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">toISOString()</span> Method</h1>
...
<p>Return a Date object as a String, using the ISO standard:</p>
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_toisostring" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The toISOString() method converts a Date object into a string, using the ISO standard.</p>
<p>The standard is called ISO-8601 and the format is: YYYY-MM-DDTHH:mm:ss.sssZ</p>
<hr>
...
<p>The toISOString() method is supported in all major browsers.</p>
<p><strong>Note:</strong> This method is not supported in Internet Explorer 8 and earlier.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>Date</i>.toISOString()</div></div>
<h2>Parameters</h2>
<table class="tecspec">
<tr>
<td>None.</td>
...
<tr>
<td>String </td>
<td>The date and time using the ISO standard format</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_toisostring.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_toisostring.asp#top" target="_top">TOP</a> |
		<a href="jsref_toisostring.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
