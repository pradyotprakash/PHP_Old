...
<style>a.menu_jsref_utc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">UTC()</span> Method</h1>
<p><a href="jsref_obj_date.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Date Object Reference" /> JavaScript Date Object</a></p>
<div class="example">
<h2 class="example">Example</h2>
<p>Return the number of milliseconds between a specified date and midnight January 1 1970:</p>
<div class="example_code notranslate">
var d = Date.UTC(2012,02,30);<br>
</div>
<p>The result of <em>d</em> will be:</p>
<div class="example_code notranslate">
<script type="application/javascript">
document.write(Date.UTC(2012,02,30));
</script>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_utc" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The UTC() method returns the number of milliseconds between a specified date and midnight of January 1, 1970, according to universal time.</p>
<p><b>Tip: </b>The Universal Coordinated Time (UTC) is the time set by the World Time Standard.</p>
<p><b>Note: </b>UTC time is the same as GMT time.</p>
<hr>
...
<p>The UTC() method is supported in all major browsers.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
Date.UTC(<em>year</em>,<em>month</em>,<em>day</em>,<em>hours</em>,<em>minutes</em>,<em>seconds</em>,<em>millisec</em>)</div></div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>year</em></td>
    <td>Required. A four-digit value representing the year, negative values are allowed</td>
  </tr>
  <tr>
    <td><em>month</em></td>
    <td>Required. An integer representing the month
    <p>Expected values are 0-11, but other values are allowed:</p>
    <ul>
    	<li>-1 will result in the last month of the previous year</li>
    	<li>12 will result in the first month of the next year</li>    	
    	<li>13 will result in the second month of the next year</li>    	    	
    </ul>
    </td>
  </tr>
  <tr>
    <td><em>day</em></td>
    <td>Required. An integer representing the day of month
    <p>Expected values are 1-31, but other values are allowed:</p>
    <ul>
    	<li>0 will result in the last hour of the previous month</li>
    	<li>-1 will result in the hour before the last hour of the previous month</li>
    </ul>
	<p>If the month has 31 days:</p>
	<ul>
    	<li>32 will result in the first day of the next month</li>
    </ul>

    <p>If the month has 30 days:</p>
	<ul>
    	<li>32 will result in the second day of the next month</li>
    </ul>
    </td>
  </tr>
  <tr>
    <td><em>hour</em></td>
    <td>Optional. Default 0. An integer representing the hour.
    <p>Expected values are 0-23, but other values are allowed:</p>
    <ul>
    	<li>-1 will result in the last hour of the previous day</li>
    	<li>24 will result in the first hour of the next day</li>    	
    </ul>
    </td>
  </tr>
  <tr>
    <td><em>min</em></td>
    <td>Optional. Default 0. An integer representing the minutes.
  ...
  <tr>
    <td><em>sec</em></td>
    <td>Optional. Default 0. An integer representing the seconds
    <p>Expected values are 0-59, but other values are allowed:</p>
    <ul>
  ...
  <tr>
    ...
    <td>Optional. Default 0. An integer representing the milliseconds
...
<tr>
<td>Number</td>
<td>Milliseconds between the specified date-time and midnight January 1 1970</td>
</tr>
</table>
...
<table class="tecspec">
<tr>
	<th style="width:23%">JavaScript Version:</th>
	<td>1.0</td>
</tr>
</table>
...
<div class="example_code notranslate">
var d = new Date(Date.UTC(2012,02,30));<br>
</div>
<p>The result of <em>d</em> will be:</p>
<div class="example_code notranslate">
<script type="application/javascript">
...
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_utc2" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<br>
<hr>
<a href="jsref_obj_date.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Date Object Reference" /> JavaScript Date Object</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_utc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_utc.asp#top" target="_top">TOP</a> |
		<a href="jsref_utc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
