...
<style>a.menu_jsref_trim_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>JavaScript String <span class="color_h1">trim()</span> Method</h1>
...
<div class="example_code notranslate">
	Hello World!</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_trim" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The trim() method removes whitespace from both sides of a string.</p>
<p><strong>Note:</strong> The trim() method does not change the original string.</p>
<hr>
...
<p>The trim() method is supported in all major browsers.</p>
...
<tr>
<td>String</td>
<td>The string with removed whitespace</td>
</tr>
</table>
...
<div class="example">
<h2 class="example">Example</h2>
<p>For browsers that do not support this method, you can remove whitespaces from 
both sides of a string with a regular expression:</p>
<div class="example_code notranslate">
	function myTrim(x)<br>{<br>return x.replace(/^\s+|\s+$/gm,'');<br>}<br><br>
	function myFunction()<br>{<br>var str = myTrim(&quot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hello World!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot;);<br>alert(str);<br>
	}<br>
</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_trim2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jsref_trim_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jsref_trim_string.asp#top" target="_top">TOP</a> |
		<a href="jsref_trim_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
