...
<title>HTML DOM compareDocumentPosition Method</title>
<link rel="stylesheet" type="text/css" href="../stdtheme.css" />
<style>a.menu_met_node_comparedocumentposition{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>HTML DOM <span class="color_h1">compareDocumentPosition()</span> Method</h1>
<p><a href="dom_obj_all.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Element Object Reference"> Element Object</a></p>

<div class="example">
<h2 class="example">Example</h2>
	<p class="example">Find out where one paragraph is positioned compared to another paragraph:</p>
<div class="example_code notranslate">
	var p1=document.getElementById(&quot;p1&quot;);<br>
	var p2=document.getElementById(&quot;p2&quot;);<br>	
	p1.compareDocumentPosition(p2);</div>
	<p>The result will be:</p>
<div class="example_code notranslate">
4</div>
<br><a target="_blank" href="http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_node_compdocpos" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The compareDocumentPosition() method compares two nodes, and returns an integer describing where they are positioned in the document.</p>
<p>Look at the example above. The possible return values would specify:</p>
<p>1: No relationship, the two nodes do not belong to the same document.</p>
<p>2: The first node (p1) is positioned after the second node (p2).</p>
<p>4: The first node (p1) is positioned before the second node (p2).</p>
<p>8: The first node (p1) is positioned inside the second node (p2).</p>
<p>16: The second node (p2) is positioned inside the first node (p1).</p>
<p>32: No relationship, <em>or</em> the two nodes are two attributes on the same element.</p>
<p><strong>Note:</strong> The return value could also be a combination of 
values. I.e. the returnvalue 20 means that p2 is inside p1 (16) AND p1 is 
positioned before p2 (4).</p>
<hr/>
...
<p>The compareDocumentPosition() method is supported in all major browsers.</p>
<p><strong>Note:</strong> Internet Explorer 8 and earlier does not support this method.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
<i>node</i>.compareDocumentPosition(<i>node</i>)</div></div>
<h2>Parameters</h2>
...
<td><em>node</em></td>
<td>Node object</td>
<td>Required. Specifies the node to compare with the current node</td>
</tr>
</table>
...
<tr>
<td>Number</td>
<td>A Number representing where two nodes are positioned compared to each other
<p>Possible return values:</p>
<p>1 (<em>No relationship, the two nodes do not belong to the same document</em>)</p>
<p>2 (<em>The first node (p1) is positioned after the second node (p2)</em>)</p>
<p>4 (<em>The first node (p1) is positioned before the second node (p2)</em>)</p>
<p>8 (<em>The first node (p1) is positioned inside the second node (p2)</em>)</p>
<p>16 (<em>The second node (p2) is positioned inside the first node (p1)</em>)</p>
<p>32 (<em>No relationship, or the two nodes are two attributes on the same element</em>)</p>
...
<table class="tecspec">
<tr>
	<th style="width:18%;">DOM Version</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_node_comparedocumentposition.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_node_comparedocumentposition.asp#top" target="_top">TOP</a> |
		<a href="met_node_comparedocumentposition.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
