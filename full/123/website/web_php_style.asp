...
<head>
<title>PHP Styles</title>
<style>a.menu_web_php_style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">- Adding Style</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_php_website.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_php_database.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn PHP by building a web site from scratch.</p>
...
<p>In your web folder (DemoPHP), create a new CSS file named &quot;Site.css&quot;.</p>
...
<p>In your web folder (DemoPHP), create a new PHP file named &quot;Footer.php&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">Footer.php</h2>
<div class="example_code notranslate">
	&lt;p&gt;&amp;copy; &lt;?php echo date("Y"); ?&gt; W3Schools. All rights reserved.&lt;/p&gt;</div>
</div>
<br>
<hr>
<h2>Edit the Home Page</h2>
<p>In your &quot;DemoPHP&quot; folder, edit the file named &quot;Index.php&quot;.</p>
...
&lt;html&gt;<br />
&lt;head&gt;<br>&nbsp;
&lt;title>PHP Demo&lt;/title&gt;<br />
&nbsp;
<span class="marked">&lt;link href="Site.css" rel="stylesheet"></span><br />
&lt;/head><br />
    <br />
&lt;body><br>&nbsp; &lt;div id="main"&gt;<br>&nbsp;
&lt;h1&gt;Welcome to W3Schools&lt;/h1&gt; <br>
&nbsp; &lt;h2&gt;Web Site Main Ingredients&lt;/h2&gt;<br>
&nbsp; &lt;p&gt;A Home Page (Index.php)&lt;/p&gt;<br>
&nbsp;
&lt;p&gt;A Style Sheet (Site.css)&lt;/p&gt;<br>&nbsp;
	&lt;p&gt;Include files (Header.php, Footer.php)&lt;/p&gt;<br>
	<br>
<span class="marked">&lt;?php include("Footer.php"); ?&gt;</span><br>
	&lt;/div&gt;<br>
	<br>&lt;/body><br />
&lt;/html>
</div>
<br />
	<a class="showbtn" href="DemoPHP/showphp.asp?filename=demo_php_css" target="_blank">Run example &raquo;</a>
</div>
...
<p>You have created your first PHP site, with a main page (Index.php), a 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_php_style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_php_style.asp#top" target="_top">TOP</a> |
		<a href="web_php_style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
