...
<title>ASP.NET Web Forms Database</title>
<style>a.menu_webforms_database{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- Adding a Database</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webforms_style.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webforms_navigation.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>With Web Forms, you can easily display data from a database.</p>
...
<p>In the &quot;DemoWebForms&quot; folder, create a new ASPX file named &quot;Customers.aspx&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">Customers.aspx</h2>
<div class="example_code notranslate">
	&lt;%@ Page Title=&quot;Data&quot; MasterPageFile=&quot;Site.master&quot; %&gt;<br><br>&lt;%@ Import 
	Namespace=&quot;System.IO&quot; %&gt;<br>&lt;%@ Import Namespace=&quot;System.Data&quot; %&gt;<br>&lt;%@ 
	Import Namespace=&quot;System.Data.OleDb&quot; %&gt;<br><br><br>&lt;asp:Content 
	ID=&quot;Content1&quot; ContentPlaceHolderID=&quot;MainContent&quot; runat=&quot;Server&quot;&gt;<br>
	&lt;h1&gt;Customers&lt;/h1&gt;<br><br>&lt;%<br>Dim dbconn As OleDbConnection<br>Dim 
	objAdapter As OleDbDataAdapter<br>Dim objTable As DataTable<br>Dim objRow As 
	DataRow<br>Dim objDataSet As New DataSet()<br>dbconn=New 
	OledbConnection(&quot;Provider=Microsoft.Jet.OLEDB.4.0;data 
	source=C:\WebData\Northwind.mdb&quot;)<br>objAdapter=New OledbDataAdapter(&quot;SELECT 
	CompanyName,City,Country FROM Customers&quot;,dbconn)<br>objAdapter.Fill(objDataSet,&quot;myTable&quot;)<br>
	objTable=objDataSet.Tables(&quot;myTable&quot;)<br>response.write(&quot;&lt;table border='1'&gt;&quot;)<br>
	response.write(&quot;&lt;tr&gt;&lt;th&gt;Name&lt;/th&gt;&lt;th&gt;City&lt;/th&gt;&lt;th&gt;Country&lt;/th&gt;&lt;/tr&gt;&quot;)<br>for 
	each x in objTable.Rows<br>response.write(&quot;&lt;tr&gt;&quot;)<br>response.write(&quot;&lt;td&gt;&quot; &amp; 
	x(&quot;companyname&quot;) &amp; &quot;&lt;/td&gt;&quot;)<br>response.write(&quot;&lt;td&gt;&quot; &amp; x(&quot;city&quot;) &amp; &quot;&lt;/td&gt;&quot;)
	<br>response.write(&quot;&lt;td&gt;&quot; &amp; x(&quot;country&quot;) &amp; &quot;&lt;/td&gt;&quot;) <br>
	response.write(&quot;&lt;/tr&gt;&quot;) <br>next<br>response.write(&quot;&lt;/table&gt;&quot;)<br>
	dbconn.Close()<br>%&gt;<br><br>&lt;/asp:Content&gt;</div>
<br>
	<a class="showbtn" href="showaspx.asp?filename=demo_wf_002" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webforms_database.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webforms_database.asp#top" target="_top">TOP</a> |
		<a href="webforms_database.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
