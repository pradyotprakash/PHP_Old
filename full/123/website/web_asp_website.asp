...
<head>
<title>ASP Classic Website</title>
<style>a.menu_web_asp_website{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP Classic <span class="color_h1">- Creating a Website</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_asp_demo.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_asp_style.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn ASP Classic by building a web site from scratch.</p>
<p class="intro"><strong>Part I</strong>: Creating a Web Site.</p>

<hr>
<h2>Create a Website</h2>
<p>Create an empty web site named <strong>DemoASP</strong>.</p>
<p>If you want to learn how to create an empty web site, please go to the 
chapter <a href="web_site.asp">Web Empty Site</a>.</p>

<hr>
<h2>Create a Home Page</h2>
<p>In the "DemoASP" folder, create a new ASP file named <strong>Default.asp.</strong> </p>
<p>Put the following content inside the file:</p>
<div class="example">
...
&lt;p&gt;A Style Sheet (Site.css)&lt;/p&gt;<br>&nbsp;
	&lt;p&gt;Include files (Header.inc, Footer.inc)&lt;/p&gt;<br>
&lt;/body&gt;<br>
	<br>&lt;/html&gt;

</div>
<br />
	<a class="showbtn" href="DemoASP/showasp.asp?filename=demo_asp_default" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
<h2>Add an About Page</h2>
<p>In the &quot;DemoASP&quot; folder, create a new ASP file named &quot;<strong>About.asp</strong>&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">About.asp</h2>
	<div class="example_code notranslate">
...
&lt;/head&gt;<br>
	<br>&lt;body&gt;<br />
		&lt;h1&gt;About Us&lt;/h1&gt;
<br>&lt;p&gt;Lorem Ipsum Porem Lorem Ipsum Porem&lt;/p&gt;<br>&lt;/body&gt;<br>
		<br>&lt;/html&gt;<br>
</div>
</div>
<p>The about file above contains a heading and a paragraph. Please feel free to 
edit the content.</p>

<p>In the next chapters of this demo, we will add a style sheet to the web site, then we will add a database, and finally we will add navigation.</p>
    <br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_asp_website.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_asp_website.asp#top" target="_top">TOP</a> |
		<a href="web_asp_website.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
