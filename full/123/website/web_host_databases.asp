...
<style>a.menu_web_host_databases{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web Hosting <span class="color_h1">Database Technologies</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_host_technologies.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_host_types.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">MS SQL Server or Oracle for high traffic database-driven web 
sites.</p>
...
<p>There are 
many different database systems available for web hosting. The most common are 
MySQL, SQL Server, Oracle, and MS Access.</p>
<hr>
...
solution.</p>
<p>Access is not well suited for very high-traffic, and not as powerful as 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_host_databases.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_host_databases.asp#top" target="_top">TOP</a> |
		<a href="web_host_databases.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
