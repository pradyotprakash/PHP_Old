...
<head>
<title>ASP Classic AJAX</title>
<style>a.menu_web_asp_ajax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP Classic <span class="color_h1">- AJAX</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_asp_navigation.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_demo.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn ASP Classic by building a web site from scratch.</p>
<p class="intro"><strong>Part VII</strong>: Displaying Data Using AJAX. </p>
<hr>
...
<p>In your web folder (DemoASP), create a new ASP file named &quot;getCustomers.asp&quot;.</p>

<p>Put the following code inside the ASP file:</p>

<div class="example">
<h2 class="example">getCustomers.asp</h2>
<div class="example_code notranslate">
	&lt;%<br>response.ContentType=&quot;text/HTML&quot;<br>response.Charset=&quot;ISO-8859-1&quot;<br>
	<br>on error resume next<br>set conn=Server.CreateObject(&quot;ADODB.Connection&quot;)<br>
	conn.Provider=&quot;Microsoft.Jet.OLEDB.4.0&quot;<br>
	conn.Open(&quot;C:/WebData/Northwind.mdb&quot;)<br>set rs = 
	Server.CreateObject(&quot;ADODB.recordset&quot;)<br>sql=&quot;SELECT 
	CompanyName,City,Country FROM Customers&quot;<br><br>rs.Open sql, conn<br>if err 
	&lt;&gt; 0 then<br>&nbsp; response.write(err.description)<br>&nbsp; set rs=nothing<br>&nbsp; 
	set conn=nothing<br>else<br>&nbsp; response.write(&quot;&lt;table border='1'&gt;&quot;)<br>&nbsp; 
	response.write(&quot;&lt;tr&gt;&lt;th&gt;Name&lt;/th&gt;&lt;th&gt;City&lt;/th&gt;&lt;th&gt;Country&lt;/th&gt;&lt;/tr&gt;&quot;)<br>&nbsp; 
	do until rs.EOF<br>&nbsp;&nbsp;&nbsp; response.write(&quot;&lt;tr&gt;&quot;)<br>&nbsp;&nbsp;&nbsp; 
	for each x in rs.Fields<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	response.write(&quot;&lt;td&gt;&quot; &amp; x.value &amp; &quot;&lt;/td&gt;&quot;)<br>&nbsp;&nbsp;&nbsp; next<br>&nbsp;&nbsp;&nbsp; 
	response.write(&quot;&lt;/tr&gt;&quot;)<br>&nbsp;&nbsp;&nbsp; rs.MoveNext<br>&nbsp; loop<br>&nbsp; response.write(&quot;&lt;/table&gt;&quot;)<br>&nbsp; 
	rs.close<br>&nbsp; conn.close<br>end if<br>on error goto 0<br>%&gt;</div>
</div>
<p>The file above is a standard ASP file, returning only an HTML table. </p>
<hr>
<h2>Create an AJAX Browser Page</h2>
<p>In your &quot;DemoASP&quot; folder, create a new file named &quot;Ajax.html&quot;.</p>
...
<div class="example_code notranslate">
	...
	xmlhttp.open(&quot;GET&quot;,&quot;getCustomers.asp&quot;,true);<br>xmlhttp.send();<br>&lt;/script&gt;<br>
	<br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<br />
	<a class="showbtn" href="DemoASP/tryit.asp?filename=demo_asp_ajax" target="_blank">Try it Yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_asp_ajax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_asp_ajax.asp#top" target="_top">TOP</a> |
		<a href="web_asp_ajax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
