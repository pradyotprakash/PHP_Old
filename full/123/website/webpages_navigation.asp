...
<title>ASP.NET Web Pages Navigation</title>
<style>a.menu_webpages_navigation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Adding Navigation</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_security.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_ajax.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn ASP.NET Web Pages by building a web site from scratch.</p>
<p class="intro"><strong>Part VI</strong>: Adding a Navigation Menu.</p>
...
<hr>
<h2>Add a Navigation Menu</h2>
<p>To add a navigation menu, edit your layout file (Layout.cshtml).</p>

<p>Put the following (red marked) code inside the layout file:</p>
...
<br>
&lt;link rel=&quot;stylesheet&quot; 
href=&quot;Site.css&quot;&gt;<br>&lt;/head&gt;<br>&lt;body&gt;
<br><br>
<span class="marked">&lt;ul 
id=&quot;menu&quot;&gt;<br>&lt;li&gt;&lt;a href=&quot;Default&quot;&gt;Home&lt;/a&gt;&lt;/li&gt;
<br>
&lt;li&gt;&lt;a href=&quot;About&quot;&gt;About&lt;/a&gt;&lt;/li&gt;<br />
&lt;li&gt;&lt;a href=&quot;Customers&quot;&gt;Data&lt;/a&gt;&lt;/li&gt;<br />
&lt;li&gt;&lt;a href=&quot;Register&quot;&gt;Register&lt;/a&gt;&lt;/li&gt;<br>
&lt;li&gt;&lt;a href=&quot;Login&quot;&gt;Login&lt;/a&gt;&lt;/li&gt;<br>&lt;/ul&gt;</span>
<br><br>
&lt;div id=&quot;main&quot;&gt;
<br>@RenderBody()
<br>
...
<p>The layout file above, is a copy of the layout file from the previous chapter, with an added unordered list.</p>

<hr>
<h2>Edit The Style Sheet</h2>
<p>Now, edit your style sheet (Site.css):</p>
<p>Put the following (red marked) code inside the file:</p>

<div class="example">
<h2 class="example">Site.css</h2>
<div class="example_code notranslate">
    body<br>{<br>font: &quot;Trebuchet MS&quot;, Verdana, 
	sans-serif;<br>background-color: #5c87b2;<br>color: #696969;<br>}<br>#main<br>
	{<br>padding: 30px;<br>background-color: #ffffff;<br>border-radius: 0 0  
	4px 4px;<br>}<br>h1<br>
{<br>
font: Georgia, serif;<br>
border-bottom: 3px solid #cc9900;<br>
	color: #996600;<br>}<br />
    <br />
    /* Forms */
    <br />
    ...
    <br><span class="marked">/* Menu */<br />
    ul#menu<br>{<br>padding: 0px;<br>
	position: relative;<br>margin: 0;<br>}<br><br>ul#menu li<br>{<br>display: 
	inline;<br>}<br><br>ul#menu li a <br>{<br>background-color: #ffffff;<br>
	padding: 10px 20px;<br>text-decoration: none;<br>line-height: 2.8em;<br>
	color: #034af3;<br>border-radius: 4px 4px 0 0;<br>}<br><br>ul#menu li 
	a:hover<br>{<br>background-color: #e8eef4;<br>}
	</span></div>
    <br>
	<a class="showbtn" href="DemoWebPages/showcshtml.asp?filename=try_webpages_navigation" target="_blank">Run example &raquo;</a>

</div>
<p>The style sheet above, is a copy of the style sheet from the previous 
chapter, with added styles for an unordered list (marked red), and a small change in the border-radius style for the main window.</p>

<hr>
<h2>Congratulations</h2>
<p>You have added navigation to your website.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_security.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_ajax.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_navigation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_navigation.asp#top" target="_top">TOP</a> |
		<a href="webpages_navigation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
