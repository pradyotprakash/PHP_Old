...
<title>ASP.NET Web Pages Membership</title>
<style>a.menu_webpages_login{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Adding Login</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_database.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_security.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn ASP.NET Web Pages by building a web site from scratch.</p>
<p class="intro"><strong>Part IV</strong>: Adding Membership registration, and Login.</p>
...
<ul>
	<li>Create a WebSecurity database</li>
	<li>Initialize WebSecurity in AppStart</li>
	<li>Add a membership registration page</li>
	<li>Add a member login page</li>
</ul>

<hr>

<h2>The WebSecurity Object</h2>
...
<h2>Creating a Web Security Database</h2>
<p>A common way to add security to a web site, is to use an authentication 
database.</p>
    <p>In its simplest form, an authentication database contains a list of 
	registered users with passwords.</p>
<p>Create a new SQL Server Compact database in the <strong>App_Data</strong> 
folder of your web.</p>
<p>Name the database &quot;<strong>Users.sdf</strong>&quot;.</p>

<p>If you don't know how to create a database for your web, please go to the 
chapter <a href="web_database.asp">Web Database</a>.</p>


<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
You don't <strong>have</strong> to create a <strong>new</strong> database. 
...
<h2>Create an AppStart Page</h2>
<p>In your web folder (DemoWebPages), create a new page named <strong>_AppStart.cshtml</strong>. </p>
<p>Replace the content of the page with this code:</p>
...
<p>The code above will be run each time your web site (application) starts. It 
...
<p><strong>&quot;Users&quot;</strong> is the name of the database.</p>
<p><strong>&quot;UserProfile&quot;</strong> is the name of the database table that 
contains the user profile information.</p>
<p><strong>&quot;UserId&quot;</strong> is the name of the (integer) column that 
contains the user IDs. </p>
<p><strong>&quot;Email&quot;</strong> is the name of the (string) column that contains 
user names.</p>
<p><strong>true</strong> is a boolean value indicating that 
...
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
Although <strong>true</strong> indicates that the membership <strong>tables</strong> can be created automatically, the 
<strong>database</strong> <strong>itself</strong> 
must always exist.
</td>
</tr></table>
<br>
...
<h2>Edit The Style Sheet</h2>
<p>Edit your style sheet (Site.css):</p>
<p>Add the following CSS code to the end of the CSS file:</p>

<div class="example">
<h2 class="example">Site.css</h2>
<div class="example_code notranslate">
/* Forms */ <br>
fieldset label<br>{<br>display:block;<br>padding:4px;<br>}<br><br>input[type=&quot;text&quot;],input[type=&quot;password&quot;]<br>{<br>width:300px;<br>}<br>
<br>input[type=&quot;submit&quot;]<br>{<br>padding:4px;<br>}
</div>
</div>
<br>
<hr>

    <h2>Add a Registration Page</h2>
<p>In your web folder (DemoWebPages), create a new file named &quot;Register.cshtml&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">Register.cshtml</h2>
<div class="example_code notranslate">
	@{Layout = "Layout.cshtml";<br><br>// Initialize page<br>var email = "";<br>
	var password = "";<br>var confirmPassword = "";<br>var ErrorMessage = "";<br>
	<br>// If this is a POST request, validate and process data<br>if (IsPost)<br>
	{<br>&nbsp; email = Request.Form["email"];<br>&nbsp; password = Request.Form["password"];<br>&nbsp; 
	confirmPassword = Request.Form["confirmPassword"];<br><br>&nbsp; if (email.IsEmpty() 
	|| password.IsEmpty()) <br>&nbsp; {ErrorMessage = "You must specify both 
	email and password.";}<br><br>&nbsp; if (password != confirmPassword)<br>&nbsp; 
	{ErrorMessage = "Password and confirmation do not match.";}<br><br>&nbsp; // 
	If all information is valid, create a new account<br>&nbsp; if (ErrorMessage=="")<br>&nbsp;&nbsp;&nbsp; 
	{ <br>&nbsp;&nbsp;&nbsp; var db = Database.Open("Users");<br>&nbsp;&nbsp;&nbsp; 
	var user = db.QuerySingle("SELECT Email FROM UserProfile <br>&nbsp;&nbsp;&nbsp; WHERE LOWER(Email) 
	= LOWER(@0)", email);<br>&nbsp;&nbsp;&nbsp; if (user == null)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; db.Execute("INSERT INTO UserProfile (Email) 
	VALUES (@0)", email);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; WebSecurity.CreateAccount(email, 
	password, false);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Navigate back to the 
	homepage and exit<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Response.Redirect("Default.cshtml");<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; else<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {ErrorMessage 
	= "Email address is already in use.";}<br>&nbsp;&nbsp;&nbsp; }<br>}<br><br>if (ErrorMessage!="")<br>
	{<br>&lt;p&gt;@ErrorMessage&lt;/p&gt; <br>&lt;p&gt;Please correct the errors and try 
	again.&lt;/p&gt;<br>}<br><br>}<br><br>&lt;h1&gt;Register&lt;/h1&gt;<br>&lt;form method="post" 
	action=""&gt;<br>&lt;fieldset&gt;<br>&lt;legend&gt;Sign-up Form&lt;/legend&gt;<br>&lt;ol&gt;<br>&lt;li&gt;<br>
	&lt;label&gt;Email:&lt;/label&gt;<br>&lt;input type="text" id="email" name="email" /&gt;<br>
	&lt;/li&gt;<br>&lt;li&gt;<br>&lt;label&gt;Password:&lt;/label&gt;<br>&lt;input type="password" 
	id="password" name="password" /&gt;<br>&lt;/li&gt;<br>&lt;li&gt;<br>&lt;label&gt;Confirm 
	Password:&lt;/label&gt;<br>&lt;input type="password" id="confirmPassword" name="confirmPassword" 
	/&gt;<br>&lt;/li&gt;<br>&lt;li&gt;<br>&lt;p&gt;&lt;input type="submit" value="Register" /&gt;&lt;/p&gt;<br>
	&lt;/li&gt;<br>&lt;/ol&gt;<br>&lt;/fieldset&gt;<br>&lt;/form&gt;</div>
</div>
<br>
<hr>
<h2>Add a Login Page</h2>
<p>In your web folder (DemoWebPages), create a new file named &quot;Login.cshtml&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">Login.cshtml</h2>
<div class="example_code notranslate">
	@{Layout="Layout.cshtml";<br><br>// Initialize page<br>var username = "";<br>
	var password = "";<br>var ErrorMessage = "";<br><br>// If this is a POST 
	request, validate and process data<br>if (IsPost)<br>&nbsp; {<br>&nbsp; 
	username = Request.Form["username"];<br>&nbsp; password = Request.Form["password"];<br>&nbsp; 
	if (username.IsEmpty() || password.IsEmpty())<br>&nbsp;&nbsp;&nbsp; {ErrorMessage 
	= "You must specify a username and password.";}&nbsp; <br>&nbsp; else<br>&nbsp; 
	{<br>&nbsp; // Login, Navigate back to the homepage and exit<br>&nbsp; if (WebSecurity.Login(username, 
	password, false))<br>&nbsp;&nbsp;&nbsp; {Response.Redirect("Default.cshtml");}<br>&nbsp;&nbsp;&nbsp; 
	else<br>&nbsp;&nbsp;&nbsp; {ErrorMessage = "Login failed";}<br>&nbsp; }<br>}<br><br>if (ErrorMessage!="")
	<br>{<br>&lt;p&gt;@ErrorMessage&lt;/p&gt; <br>&lt;p&gt;Please correct the errors and try 
	again.&lt;/p&gt;<br>}<br><br>}<br><br>&lt;h1&gt;Login&lt;/h1&gt;<br>&lt;form method="post" 
	action=""&gt;<br>&lt;fieldset&gt;<br>&lt;legend&gt;Log In to Your Account&lt;/legend&gt;<br>&lt;ol&gt;<br>
	&lt;li&gt;<br>&lt;label&gt;Username:&lt;/label&gt;<br>&lt;input type="text" id="username" 
	name="username" /&gt;<br>&lt;/li&gt;<br>&lt;li&gt;<br>&lt;label&gt;Password:&lt;/label&gt;<br>&lt;input 
	type="password" id="password" name="password" /&gt;<br>&lt;/li&gt;<br>&lt;li&gt;<br>
	&lt;p&gt;&lt;input type="submit" value="login" /&gt;&lt;/p&gt;<br>&lt;/li&gt;<br>&lt;/ol&gt;<br>&lt;/fieldset&gt;<br>
	&lt;/form&gt;</div>
</div>
<br>
...
<p>You have added membership registration and login information to your website.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_database.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_security.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_login.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_login.asp#top" target="_top">TOP</a> |
		<a href="webpages_login.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
