...
<head>
<title>Web Forms AJAX</title>
<style>a.menu_webforms_ajax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- AJAX</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webforms_navigation.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_design.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn ASP.NET Web Forms by building a web site from scratch.</p>
<p class="intro"><strong>Part V</strong>: Displaying Data Using AJAX. </p>
<hr>
<h2>What We Will Do</h2>
<p>In this chapter we will:</p>
<ul>
	<li>Displaing data from the database using AJAX</li>
</ul>
<hr>
<h2>Create an AJAX Server Page</h2>
<p>In your web folder (DemoWebForms), create a new ASPX file named &quot;getCustomers.aspx&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">getCustomers.aspx</h2>
	<div class="example_code notranslate">
		&lt;%@ Import Namespace=&quot;System.IO&quot; %&gt;<br>&lt;%@ Import 
		Namespace=&quot;System.Data&quot; %&gt;<br>&lt;%@ Import Namespace=&quot;System.Data.OleDb&quot; 
		%&gt;<br><br>&lt;%<br>Dim dbconn As OleDbConnection<br>Dim objAdapter As 
		OleDbDataAdapter<br>Dim objTable As DataTable<br>Dim objRow As DataRow<br>
		Dim objDataSet As New DataSet()<br>dbconn=New 
		OledbConnection(&quot;Provider=Microsoft.Jet.OLEDB.4.0;data 
		source=C:\WebData\Northwind.mdb&quot;)<br>objAdapter=New 
		OledbDataAdapter(&quot;SELECT CompanyName,City,Country FROM Customers&quot;,dbconn)<br>
		objAdapter.Fill(objDataSet,&quot;customers&quot;)<br>
		objTable=objDataSet.Tables(&quot;customers&quot;)<br>objRow=objTable.Rows(0)<br>
		response.write(&quot;&lt;table border='1'&gt;&quot;)<br>
		response.write(&quot;&lt;tr&gt;&lt;th&gt;Name&lt;/th&gt;&lt;th&gt;City&lt;/th&gt;&lt;th&gt;Country&lt;/th&gt;&lt;/tr&gt;&quot;)<br>
		for each x in objTable.Rows<br>response.write(&quot;&lt;tr&gt;&quot;)<br>
		response.write(&quot;&lt;td&gt;&quot; &amp; x(&quot;companyname&quot;) &amp; &quot;&lt;/td&gt;&quot;)<br>
		response.write(&quot;&lt;td&gt;&quot; &amp; x(&quot;city&quot;) &amp; &quot;&lt;/td&gt;&quot;) <br>response.write(&quot;&lt;td&gt;&quot; &amp; 
		x(&quot;country&quot;) &amp; &quot;&lt;/td&gt;&quot;) <br>response.write(&quot;&lt;/tr&gt;&quot;) <br>next<br>
		response.write(&quot;&lt;/table&gt;&quot;)<br>dbconn.Close()<br>%&gt;</div>
</div>
<p>The file above is a standard ASPX file, returning only an HTML table. </p>
<hr>
<h2>Create an AJAX Browser Page</h2>
<p>In your &quot;DemoWebForms&quot; folder, create a new file named &quot;Ajax.html&quot;.</p>
<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">Ajax.html</h2>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>&lt;title&gt;ASP Demo&lt;/title&gt;<br>&lt;link 
	href=&quot;Site.css&quot; rel=&quot;stylesheet&quot;&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br>&lt;div id=&quot;main&quot;&gt;<br>
	&lt;h1&gt;Customers&lt;/h1&gt;<br>&lt;div id=&quot;t01&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;script&gt;<br>
	var xmlhttp;<br>if (window.XMLHttpRequest)<br>{// code for IE7+, Firefox, 
	Chrome, Opera, Safari<br>xmlhttp=new XMLHttpRequest();<br>}<br>else<br>{// 
	code for IE6, IE5<br>xmlhttp=new ActiveXObject(&quot;Microsoft.XMLHTTP&quot;);<br>}<br>
	xmlhttp.onreadystatechange=function()<br>{<br>if (xmlhttp.readyState==4 &amp;&amp; 
	xmlhttp.status==200)<br>{<br>
	document.getElementById(&quot;t01&quot;).innerHTML=xmlhttp.responseText;<br>}<br>}<br>
	xmlhttp.open(&quot;GET&quot;,&quot;getCustomers.aspx&quot;,true);<br>xmlhttp.send();<br>&lt;/script&gt;<br>
	<br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<br />
	<a class="showbtn" href="DemoWebForms/tryit.asp?filename=try_webforms_ajax" target="_blank">Try it Yourself &raquo;</a>
</div>
<br>
<hr>
<h2>Congratulations</h2>
<p>You have created your first data page using AJAX.</p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webforms_ajax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webforms_ajax.asp#top" target="_top">TOP</a> |
		<a href="webforms_ajax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
