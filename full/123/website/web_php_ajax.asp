...
<style>a.menu_web_php_ajax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">- AJAX</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_php_navigation.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_asp_demo.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn PHP Classic by building a web site from scratch.</p>
...
<p>In your web folder (DemoPHP), create a new PHP file named &quot;getCustomers.php&quot;.</p>

<p>Put the following code inside the PHP file:</p>

<div class="example">
<h2 class="example">getCustomers.php</h2>
<div class="example_code notranslate">
	&lt;?php<br>header('Content-Type: text/html; charset=ISO-8859-1');<br><br>//create an ADO connection and open the database<br>$conn = new 
	COM(&quot;ADODB.Connection&quot;);<br>
	$conn-&gt;open(&quot;PROVIDER=Microsoft.Jet.OLEDB.4.0;Data 
	Source=C:\WebData\Northwind.mdb&quot;);<br><br>//execute an SQL statement and 
	return a recordset<br>$rs = $conn-&gt;execute(&quot;SELECT CompanyName, City, 
	Country FROM Customers&quot;);<br>$num_columns = $rs-&gt;Fields-&gt;Count();<br><br>
	echo &quot;&lt;table border='1'&gt;&quot;; <br>echo 
	&quot;&lt;tr&gt;&lt;th&gt;Name&lt;/th&gt;&lt;th&gt;City&lt;/th&gt;&lt;th&gt;Country&lt;/th&gt;&lt;/tr&gt;&quot;;<br>while (!$rs-&gt;EOF) 
	//looping through the recordset (until End Of File)<br>{<br>echo &quot;&lt;tr&gt;&quot;;<br>
	for ($i=0; $i &lt; $num_columns; $i++) {<br>echo &quot;&lt;td&gt;&quot; . 
	$rs-&gt;Fields($i)-&gt;value . &quot;&lt;/td&gt;&quot;;<br>}<br>echo &quot;&lt;/tr&gt;&quot;;<br>$rs-&gt;MoveNext();<br>
	}<br>echo &quot;&lt;/table&gt;&quot;;<br><br>//close the recordset and the database 
	connection<br>$rs-&gt;Close();<br>$rs = null;<br>$conn-&gt;Close();<br>$conn = 
	null;<br>?&gt;</div>
</div>
<p>The file above is a standard PHP file, returning only an HTML table. </p>
<hr>
<h2>Create an AJAX Browser Page</h2>
<p>In your &quot;DemoPHP&quot; folder, create a new file named &quot;Ajax.html&quot;.</p>
...
<div class="example_code notranslate">
	...
	xmlhttp.open(&quot;GET&quot;,&quot;getCustomers.php&quot;,true);<br>xmlhttp.send();<br>&lt;/script&gt;<br>
	<br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<br />
	<a class="showbtn" href="DemoPHP/tryit.asp?filename=demo_php_ajax" target="_blank">Try it Yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_php_ajax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_php_ajax.asp#top" target="_top">TOP</a> |
		<a href="web_php_ajax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
