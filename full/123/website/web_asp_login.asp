...
<title>ASP Classic Membership</title>
<style>a.menu_web_asp_login{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP Classic <span class="color_h1">- Adding Login</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_asp_database.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_asp_security.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn ASP Classic by building a web site from scratch.</p>
...
<p>Create a new database. Give the database a proper 
name, like &quot;<strong>Users.mdb</strong>&quot;.</p>
...
<p>In the Users database, create a new table named Users with the following 
design:</p>
...
<p>
Add some users to the Users database:</p>
...
<p>In your web folder (DemoASP), create a new file named &quot;Register.asp&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">Register.asp</h2>
	<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>&lt;title&gt;ASP 
		Register&lt;/title&gt;<br>&lt;link 
	href=&quot;Site.css&quot; rel=&quot;stylesheet&quot;&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br>&lt;div id=&quot;main&quot;&gt;<br><br>&lt;%<br>email = &quot;&quot;<br>password = &quot;&quot;<br>confirmPassword = &quot;&quot;<br>ErrorMessage = &quot;&quot;<br>
	<br>if request.form &lt;&gt; &quot;&quot; then<br>&nbsp; email = Request.Form(&quot;email&quot;)<br>&nbsp; password 
	= Request.Form(&quot;password&quot;)<br>&nbsp; confirmPassword = 
	Request.Form(&quot;confirmPassword&quot;)<br><br>&nbsp; if email=&quot;&quot; or password=&quot;&quot; then<br>
	&nbsp;&nbsp;&nbsp;
	ErrorMessage = &quot;You must specify both email and password.&quot;<br>&nbsp; end if<br>&nbsp;
	if password &lt;&gt; confirmPassword then<br>&nbsp;&nbsp;&nbsp; ErrorMessage = &quot;Password and 
	confirmation do not match.&quot;<br>&nbsp; end if<br><br>&nbsp; if ErrorMessage = &quot;&quot; then <br>&nbsp;&nbsp;&nbsp; set conn = 
	Server.CreateObject(&quot;ADODB.Connection&quot;)<br>&nbsp;&nbsp;&nbsp; conn.Provider = 
	&quot;Microsoft.Jet.OLEDB.4.0&quot;<br>&nbsp;&nbsp;&nbsp; conn.Open(&quot;C:\WebData\Users.mdb&quot;)<br>&nbsp;&nbsp;&nbsp; set rs = 
	Server.CreateObject(&quot;ADODB.recordset&quot;)<br>&nbsp;&nbsp;&nbsp; rs.Open &quot;Select * FROM Users WHERE 
	Email = '&quot; &amp; email &amp; &quot;'&quot;, conn<br>&nbsp;&nbsp;&nbsp; if rs.EOF = true then<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; sql=&quot;INSERT 
	INTO Users (Email,Password,Role)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; VALUES ('&quot; &amp; email &amp; &quot;','&quot; &amp; password &amp; 
	&quot;','guest')&quot;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; conn.Execute(sql)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Response.Redirect(&quot;Default.asp&quot;)<br>
	&nbsp;&nbsp;&nbsp;
	else<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ErrorMessage = &quot;Email address is already in use.&quot;<br>&nbsp;&nbsp;&nbsp; end if<br>&nbsp; end 
	if<br>end if<br><br>if ErrorMessage &lt;&gt; &quot;&quot; then<br>&nbsp; response.write(&quot;&lt;p&gt;&quot; &amp; 
	ErrorMessage &amp; &quot;&lt;/p&gt;&quot;) <br>&nbsp; response.write(&quot;&lt;p&gt;Please correct the errors and 
	try again.&lt;/p&gt;&quot;) <br>end if<br>%&gt;<br><br>&lt;h1&gt;Register&lt;/h1&gt;<br>&lt;form method=&quot;post&quot; action=&quot;&quot;&gt;<br>
	&lt;fieldset&gt;<br>&lt;legend&gt;Sign-up Form&lt;/legend&gt;<br>&lt;ol&gt;<br>&lt;li&gt;<br>
	...
	name=&quot;confirmPassword&quot; /&gt;<br>&lt;/li&gt;<br>&lt;li&gt;<br>&lt;p&gt;&lt;input type=&quot;submit&quot; 
	value=&quot;Register&quot; /&gt;&lt;/p&gt;<br>&lt;/li&gt;<br>&lt;/ol&gt;<br>&lt;/fieldset&gt;<br>&lt;/form&gt;<br><br>
	&lt;!-- #include file=&quot;Footer.inc&quot; --&gt;<br>&lt;/div&gt;<br>&lt;/body&gt;<br>
		&lt;/html&gt;</div>
</div>
<br>
<hr>
<h2>Add a Login Page</h2>
<p>In your web folder (DemoWebPages), create a new file named &quot;Login.asp&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">Login.asp</h2>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>&lt;title&gt;ASP Login&lt;/title&gt;<br>&lt;link 
		href=&quot;Site.css&quot; rel=&quot;stylesheet&quot;&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br>&lt;div id=&quot;main&quot;&gt;<br><br>&lt;%<br>username = &quot;&quot;<br>
		password = &quot;&quot;<br>ErrorMessage = &quot;&quot;<br><br>if request.form &lt;&gt; &quot;&quot; then<br>
		&nbsp;
		username = Request.Form(&quot;username&quot;)<br>&nbsp; password = 
		Request.Form(&quot;password&quot;)<br>&nbsp; if username = &quot;&quot; or password = &quot;&quot; then<br>
		&nbsp;&nbsp;&nbsp;
		ErrorMessage = &quot;You must specify a username and password.&quot;<br>&nbsp; else<br>
		&nbsp;&nbsp;&nbsp;
		set conn = Server.CreateObject(&quot;ADODB.Connection&quot;)<br>&nbsp;&nbsp;&nbsp; conn.Provider = 
		&quot;Microsoft.Jet.OLEDB.4.0&quot;<br>&nbsp;&nbsp;&nbsp; conn.Open(&quot;C:\WebData\Users.mdb&quot;)<br>&nbsp;&nbsp;&nbsp; set rs 
		= Server.CreateObject(&quot;ADODB.recordset&quot;)<br>&nbsp;&nbsp;&nbsp; rs.Open &quot;Select * FROM Users 
		WHERE Email = '&quot; &amp; username &amp; &quot;'&quot;, conn<br>&nbsp;&nbsp;&nbsp; if rs.EOF = false then <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if 
		rs.fields(&quot;Password&quot;) = password then<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		Response.Redirect(&quot;Default.asp&quot;)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; end if<br>&nbsp;&nbsp;&nbsp; end if <br>&nbsp; ErrorMessage = 
		&quot;Login failed&quot;<br>&nbsp; end if <br>end if<br><br>if ErrorMessage &lt;&gt; &quot;&quot; then<br>
		&nbsp;
		response.write(&quot;&lt;p&gt;&quot; &amp; ErrorMessage &amp; &quot;&lt;/p&gt;&quot;) <br>
		&nbsp;
		response.write(&quot;&lt;p&gt;Please correct the errors and try again.&lt;/p&gt;&quot;) <br>
		end if<br>%&gt;<br><br>&lt;h1&gt;Login&lt;/h1&gt;<br>&lt;form method=&quot;post&quot; action=&quot;&quot;&gt;<br>&lt;fieldset&gt;<br>
		&lt;legend&gt;Log In to Your Account&lt;/legend&gt;<br>&lt;ol&gt;<br>&lt;li&gt;<br>
		&lt;label&gt;Username:&lt;/label&gt;<br>&lt;input type=&quot;text&quot; id=&quot;username&quot; 
		name=&quot;username&quot; /&gt;<br>&lt;/li&gt;<br>&lt;li&gt;<br>&lt;label&gt;Password:&lt;/label&gt;<br>
		&lt;input type=&quot;password&quot; id=&quot;password&quot; name=&quot;password&quot; /&gt;<br>&lt;/li&gt;<br>&lt;li&gt;<br>
		&lt;p&gt;&lt;input type=&quot;submit&quot; value=&quot;Login&quot; /&gt;&lt;/p&gt;<br>&lt;/li&gt;<br>&lt;/ol&gt;<br>
		&lt;/fieldset&gt;<br>&lt;/form&gt;<br><br>&lt;!-- #include file=&quot;Footer.inc&quot; --&gt;<br>&lt;/div&gt;<br>
		&lt;/body&gt;<br>&lt;/html&gt;</div>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_asp_login.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_asp_login.asp#top" target="_top">TOP</a> |
		<a href="web_asp_login.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
