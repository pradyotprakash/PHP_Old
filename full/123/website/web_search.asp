...
<title>Web SEO</title>
<style>a.menu_web_search{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WEB - <span class="color_h1">SEO</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_validate.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_tcpip.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Have you ever used a search engine? Do you wonder how to get
listed?</p>

<p class="intro">This page will help you to get listed in the most popular
search engines.</p>

<hr>

<h2>SEO - Search Engine Optimization</h2>
<p>Search engine optimization (SEO) is the process of improving the ranking 
(visibility) of a website in search engines. The higher (or more frequently) a 
web site is displayed in a search engine list (like Google), the more visitors 
it is expected to receive.</p>
<p>SEO considers how search engines work, what people search for, and which 
...
increase the number of links, is another SEO tactic.<br>
<br>
Effective search engine optimization may require changes to the HTML source code 
of a site and to the site content. SEO tactics should be incorporated into the 
website development and especially into the menus and navigation structure.<br>
<br>
Another class of techniques, known as black hat SEO or spamdexing, uses methods 
such as link farms, keyword stuffing and article spinning that degrade both the 
relevance of search results and the quality of user-experience with search 
engines. Search engines look for sites that employ these techniques in order to 
remove them from their indices.</p>

<hr>

<h2>Submit Your Site to Search Engines</h2>
<p>Web search engines (like Google) automatically add new web sites to their search index every 
time they crawl the web.</p>
<p>If your web site is new and unknown, it may take some time before your site 
is &quot;discovered&quot;. </p>
<p>Luckily most search engines invites you to submit your site: *</p>

<p><b>Google: </b><a target="_blank" href="http://www.google.com/addurl.html">http://www.google.com/addurl.html</a></p>
<p><b>Yahoo: </b><a target="_blank" href="http://search.yahoo.com/info/submit.html">http://search.yahoo.com/info/submit.html</a></p>
<p><b>Bing: </b><a target="_blank" href="http://www.bing.com/webmaster/SubmitSitePage.aspx">http://www.bing.com/webmaster/SubmitSitePage.aspx</a></p>
<p><b>Open Directory: </b><a target="_blank" href="http://www.dmoz.org/help/submit.html">http://www.dmoz.org/help/submit.html</a></p>

<p>Normally you will have to enter the full URL of your site including the 
http:// prefix.</p>
<p>Example: <a href="http://www.google.com/">http://www.mysite.com/</a></p>
<p>When you submit your site to a search engine, you only need to specify the top-level 
(home) page. You do not need to 
submit each page. The search engine will find the rest based on your links (keep your navigation 
menus tidy). </p>
<p>Sometimes you can also add keywords that describe the page, but don't expect 
these to affect how your site is ranked or listed.</p>
<p>Search engines indexes are updated on a regular basis. Changes to 
your site will be updated over time (monthly) and dead pages and links will disappear.</p>
<p>* Not all submitted URLs will be added, and you cannot predict or guarantee 
when or if your site will appear in a search result.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_validate.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_tcpip.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_search.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_search.asp#top" target="_top">TOP</a> |
		<a href="web_search.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
