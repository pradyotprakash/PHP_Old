...
<title>Web WAI</title>
<style>a.menu_web_wai{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web <span class="color_h1">WAI</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_quality.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_validate.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">WAI defines guidlines for web developers. </p>

<hr>

<h2>WAI - The Web Accessibility Initiative</h2>
<p>WAI (W3C,1997) is a set of guidelines intended for web developers and designers, 
about how to make the web accessible to people with disabilities.</p>
<p>The goal of these guidelines is accessibility, but they will also help make 
web contents available to more browsers (voice browsers, cell phones, hand-held 
devices), and to more users working in difficult environments (hands-free, 
strong light, darkness, bad sight, heavy noise). </p>

<p>If your website lacks WAI features (good contrast, resizable text, images with descriptions), 
people with disabilities will not be able to access your 
information. </p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>In fact: <b>Your site 
violates the rights of these people</b>.</td>
</tr></table>

<p>Reasons for making your site more accessible:</p>

<ul>
  <li>It will improve your reputation and your customer satisfaction</li>
  <li>It will increase your number of visitors</li>
  <li>It will let your visitors stay longer at your site</li>
    <li>It will make your site more usable for people with older equipment</li>
</ul>
...
<p>The alt attribute allows you to provide an alternative text for an image:</p>
...
<p>
Sometimes a web browser will not display your images. The reason could be one of 
many:</p>

<ul>
  <li>The user has turned off the display of images</li>
  <li>The browser is a mini browser without image display</li>
  <li>The browser is a voice browser</li>
</ul>
<p>
If you use the &quot;alt&quot; attribute, most browsers will at least display (or read) the 
&quot;alt&quot; text.</p>

<hr>
<h2>Don't Use Small Fonts</h2>
...
disabilities might have difficulties reading the 
text.</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>Don't force your 
visitors to enlarge the text size every time they visit your site.</td>
</tr></table>
<br>

<hr>
<h2>Chose the Best Letter and Line Spacing</h2>
<p>Text with close letter spacing is difficult to read.</p>
<p style="letter-spacing:+0.1mm;">Text with extra letter spacing is easy to read.</p>
<p style="letter-spacing:-0.2mm;">Text with reduced letter spacing is difficult to read.</p>

<p>Text with good line spacing<br>is easy to read</p>
<p style="line-height:80%">Text with reduced line spacing<br>is difficult to read</p>

<hr>
<h2>Avoid Fancy Fonts</h2>
<p>Normal fonts are easy to read.</p>
<p><i>Italic fonts are not so easy to read.</i></p>
<p style="font-family:cBlackadder ITC, Brush Script MT; font-size:150%;">This font is 
difficult to read....</p> 

<hr>
<h2>Avoid Poor Color Contrasts</h2>
<p>Black text on a white background, or white text on a black background, is best for people with viewing disabilities, 
and for display on bad equipment.</p>

<p>Grey text on a light background can give a poor contrast: </p>

<table>
<tr><td style="color:#aaaaaa;background-color:#ffffff;">Text color #AAAAAA on white background</td></tr>
<tr><td style="color:#666666;background-color:#ffffff;">Text color #666666 on white background</td></tr>
<tr><td style="color:#333333;background-color:#ffffff;">Text color #333333 on white background</td></tr>
<tr><td style="color:#000000;background-color:#ffffff;">Text color #000000 on white background</td></tr>
</table>

<p>Grey text on a dark background can also give a poor contrast: </p>


<table style="background-color:black;">
<tr><td style="color:#666666;background-color:#000000;">Text color #666666 on black background</td></tr>
<tr><td style="color:#aaaaaa;background-color:#000000;">Text color #AAAAAA on black background</td></tr>
<tr><td style="color:#cccccc;background-color:#000000;">Text color #CCCCCC on black background</td></tr>
<tr><td style="color:#ffffff;background-color:#000000;">Text color #FFFFFF on black background</td>
</tr>
</table>

<p>Some combinations - like black and red, black and blue, yellow and green - 
always strain the eye: </p>

<table>
<tr>
<td style="color:#000000;background-color:#ff0000;">Black text on a red background</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
<td style="color:#000000;background-color:#0000ff;">Black text on a blue background</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
<td style="color:#ffff00;background-color:#00ff00;">Yellow text on a green background</td>
</tr>
</table>

<p>And some combinations are not so bad:</p>
<table>
<tr>
<td style="color:#000000;background-color:#eeeeee;">Black text on a grey background</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
<td style="color:#000000;background-color:#F0F8FF;">Black text on a light blue</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
<td style="color:#000000;background-color:#FAEBD7;">Black text on antique white</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
<td style="color:#ffffff;background-color:#191970">White text on dark blue</td>
</tr>
</table>
<br>
...
<h2>Always Set Background Color</h2>
...
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>If you don't specify a background 
color, your text might be invisible.</td>
</tr></table>
<br>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_wai.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_wai.asp#top" target="_top">TOP</a> |
		<a href="web_wai.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
