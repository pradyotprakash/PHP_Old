...
<style>a.menu_web_design{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web <span class="color_h1">Design</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webforms_ajax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_quality.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Designing a web site needs careful thinking and planning.</p>
<p class="intro">The most important thing is to KNOW YOUR AUDIENCE.</p>
<hr>

<h2>Users are Scanners</h2>
<p><b>A typical visitor will NOT read the entire content of your Web page!</b></p>
<p>No matter how much useful information you put into a Web page, a visitor will only spend a few seconds scanning it before 
he/she decide whether to leave or to stay.</p>
<p>Be sure to make your point in the very first sentence of the page! After that, try to keep 
the user occupied 
with short paragraphs, and new headers down the page.</p>
<hr>

<h2>Less is More</h2>
<p>Keep the paragraphs as short as possible.</p>
<p>Keep the pages as short as possible.</p>
<p>Keep the chapters as short as possible.</p>
<p>Use a lot of space! Pages overloaded
with text will kill your audience.</p>
<p>If you have a lot to say, break your information into smaller chunks and 
place it on different pages!</p>

<hr>

<h2>Navigation</h2>
<p>Create a consistent navigation structure that is used by all the pages in your
Web site.</p>
<p>Don't
use hyperlinks inside each paragraph, to send visitors to every page
of your Web. This will destroy the feeling of a consistent navigation structure.</p>
<p>If you must use hyperlinks, add them to the bottom of a paragraph, or to the
menu.</p>
<hr>

<h2>Download Speed</h2>
<p>Sometimes developers are not aware of the fact
that some pages take a long time to download.</p>
<p>Most visitors will leave a Web page
that takes more than 7 seconds to download.</p>
<p>Test your web pages over a
low-speed modem connection. If your pages take a long time to download, consider removing graphic or multimedia content.</p>
<hr>

<h2>Let your Audience Speak!</h2>
<p>Feedback is a very good thing! </p>
<p>Your visitors are your
&quot;customers&quot;. Often they will give you some valuable hints about what you could have done better.</p>
<p>Provide a simple way to reach you, and you will get a lot of 
input from people with different skills and knowledge.</p>
<hr>

<h2>Visitor's Monitor</h2>
<p>Not everyone on the internet has the same monitor as you.</p>
<p>If
you design a Web site to be displayed on a monitor with a high
resolution, visitors with lower resolution monitors (like 800x600)
might have problems reading your pages.</p>

<p>Make sure you test your Web site on different
monitors.</p>

<p> Take a look at our <a href="../browsers/browsers_display.asp">browser display 
statistics</a> to see the trends in monitor development.</p>

<hr>

<h2>What Browsers Do They Use?</h2>

<p>Don't forget to test your Web site on
different browsers.</p>

<p>The most popular browsers today are Internet Explorer,  
Firefox and Google Chrome.</p>

<p>One wise thing to do when designing Web pages is to use 
correct HTML. Correct coding will help the browsers to 
display your pages correctly.</p>

<p>Take a look at our <a href="../browsers/browsers_stats.asp">browser
statistics</a> to see the trends in browser development.</p>

<hr>

<h2>What Plug-Ins Do They Have?</h2>
<p>Sound, video clips, or other
multimedia content might require the use of separate programs (plug-ins).</p>
<p>Be sure that your
visitors have access to the software needed to view them.</p>
<hr>

<h2>What About Disabilities?</h2>
<p>Some people have viewing or hearing disabilities.</p>
<p>They might try to read your pages with Braille or speech-based
browsers. Always add text alternatives for images and graphic elements.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="webforms_ajax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_quality.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_design.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_design.asp#top" target="_top">TOP</a> |
		<a href="web_design.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
