...
<head>
<title>ASP Classic Demonstration</title>
<style>a.menu_web_asp_demo{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP Classic <span class="color_h1">- Demonstration</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_php_ajax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_asp_website.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p>Learn ASP Classic by building a web site from scratch.</p>
<hr>
<h2>This is an ASP Classic Demonstration</h2>
<p>This demonstration will teach you ASP Classic by building a website from 
scratch:</p>
<ul>
	<li>Create a web site</li>
	<li>Add files and folders</li>
	<li>Add a consistent look</li>
...
at a demonstration.</p>
    <p>If you want to read our ASP Classic tutorial first, go to the
<a href="../asp/default.asp">ASP Tutorial</a>.</p>

<hr>
<h2>What Will We Create?</h2>
<p>This demonstration will create a web site where you can lists customers from 
a company database.</p>
<p>The web site will look like this:</p>
<iframe style="width:99.5%;height:750px;border:0" src="DemoASP/Default.asp">
</iframe>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_asp_demo.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_asp_demo.asp#top" target="_top">TOP</a> |
		<a href="web_asp_demo.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
