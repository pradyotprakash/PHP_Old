...
<title>ASP.NET Web Pages Adding Security</title>
<style>a.menu_webpages_security{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Adding Security</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_login.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_navigation.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn ASP.NET Web Pages by building a web site from scratch.</p>
<p class="intro"><strong>Part V</strong>: Adding Security.</p>

<hr>
<h2>What We Will Do</h2>
<p>In this chapter we will:</p>
<ul>
	<li>Add access restriction security to a web page</li>
</ul>

<hr>

<h2>Membership, Login, and Security</h2>
<p>In the previous chapter we added a registration page and a login page to the 
web site.</p>
<p>When a membership is registered, the user can login, with his email address 
and password.</p>
<p>However, user membership and login functions do not automatically restrict 
(or open) any access to the web site.</p>
<p>Security (access restrictions) has to be added to each of the web pages.</p>

<hr>

<h2>Adding Security to Pages</h2>
<p>Access restrictions (security) can easily be added to any web page.</p>
<p>Just put the following code inside the page:</p>

<div class="example">
<h2 class="example">Security Code:</h2>
<div class="example_code notranslate">
	if (!WebSecurity.IsAuthenticated)<br>{<br>Response.Redirect(&quot;Login.cshtml&quot;);<br>
	}</div>
</div>
<p>The code above executes an if test, asking if the user is logged in. If not, 
the user is redirected to the login page.</p>

<hr>

<h2>Preventing Access to the Database</h2>
<p>In our example, the page Customers.cshtml, lists customers from the 
&quot;Northwind&quot; database.</p>
<p>Add the security code at the beginning of the page:</p>
<div class="example">
<h2 class="example">Customers.cshtml</h2>
<div class="example_code notranslate">
@{<br><span class="marked">if (!WebSecurity.IsAuthenticated)<br>{<br>Response.Redirect(&quot;Login&quot;);<br>
	}<br>
	</span><br>Layout = &quot;Layout.cshtml&quot;;<br>var db = Database.Open(&quot;Northwind&quot;);&nbsp;<br>
var query = db.Query(&quot;SELECT CompanyName,City,Country FROM Customers&quot;);&nbsp;<br>
}<br>
&lt;html&gt;&nbsp;<br>
&lt;body&gt;&nbsp;<br>
&lt;h1&gt;Customers&lt;/h1&gt;&nbsp;<br>
...
{<br>
&lt;tr&gt;&nbsp;<br>
&lt;td&gt;@row.CompanyName&lt;/td&gt;&nbsp;<br>
&lt;td&gt;@row.City&lt;/td&gt;&nbsp;<br>
&lt;td&gt;@row.Country&lt;/td&gt;&nbsp;<br>
&lt;/tr&gt;&nbsp;<br>
}<br>
&lt;/table&gt;&nbsp;<br>
&lt;/body&gt;&nbsp;<br>
...
<p>The Customers page above, is a copy of the page from the previous chapter 
about databases.&nbsp; The security code (added at the beginning) is marked red.
</p>

<hr>

<h2>Congratulations</h2>
<p>You have added security to your web site, using the WebSecurity object.</p>
<p>For a full reference to the WebSecurity object, please visit our
<a href="../aspnet/webpages_ref_websecurity.asp">WebSecurity Object Reference</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_login.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_navigation.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_security.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_security.asp#top" target="_top">TOP</a> |
		<a href="webpages_security.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
