...
<style>a.menu_web_quality{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web <span class="color_h1">Quality</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_design.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_wai.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Using the newest web standards improves the quality of your web site.</p>

<hr>
<h2>Use HTML 5</h2>
<p>Writing your pages to the latest HTML5 standard, brings you as close as possible to perfection.</p>
<p>All HTML pages should contain a &lt;!DOCTYPE&gt; element to define which HTML version it conforms to. </p>
<p>The DOCTYPE gives important information to your browser so it can render your page faster and more 
consistently.</p>
<p>The DOCTYPE declaration also allows validating software to check the syntax of your page:</p>
...
<h2>Use Separate CSS Files</h2>

<p>Using Cascading Style Sheets (CSS) is the preferred way of separating content 
from style, in quality web pages. </p>
<p>Using CSS improves the quality of web sites and increases the readability for 
many different browsers.</p>
<p>Styles (sizes, fonts, colors, and more) should be set outside web pages, in 
separate CSS files. Using a separate CSS file will also greatly reduce your web site 
development costs. </p>
<p>With a separate CSS file you can change the style of HTML elements by rewriting 
one line of code. If you have used CSS inside your pages, you will have to edit all 
these pages.</p>

<hr>

<h2>Web Validation</h2>
<p>A validator is a software program that can check your web pages against 
the web standards.</p>
<p>When using a validator to check HTML and CSS documents, the validator returns a list of errors found, according to your chosen 
standard.</p>
<p>Make sure you make it a habit to validate all your web pages before 
publishing.</p>
...
the quality of your web site because:</p>

<ul>
  <li>It will be visible in search engine lists</li>
  <li>It is visible in the browser's title bar</li>
  <li>It will be displayed in the user's bookmark</li>
</ul>

<p>The title should be as short and descriptive as possible.</p>

<p>Make sure the title 
matches the content the user is looking for. Then it is more likely the user will click 
...
<p>&lt;title&gt;XML Introduction&lt;/title&gt;</p>
...
organized, and easy to understand HTML, CSS, JavaScript, XML, and SQL tutorials with lots of working examples and source code. &lt;/title&gt;</p>

<hr>
<h2>Heading Elements </h2>
<p>The &lt;h1&gt; element is used to describe the main heading of a web page.</p>
...
element for main headings. This will confuse most search engines and other software that will try 
to &quot;understand&quot; the structure of the web page.</p>
<p>Use &lt;h1&gt; for main headings, and &lt;h2&gt; and &lt;h3&gt; for lower level 
headings.</p>
<p>Try to structure your headings after this template:</p>
...
<p>If you don't like the default size for headers, use CSS 
to change it.</p>

<hr>
<h2>Character Sets</h2>

<p>All W3C standards (since 1996) defines an internal character set called Unicode (ISO 10646).</p>
<p>All modern web browsers are using this character set internally. Most 
documents transmitted over the Internet do not use the Unicode character set.
</p>
<p>Because of this, browsers and servers must have a 
way to agree about the character set used in the communication between them.</p>
<p>Labeling each document with the proper character set, is important for 
the quality of your web site.</p>
<p>For your HTML pages, always use the following meta element inside 
the &lt;head&gt; element:</p>

<div class="code notranslate"><div>
&lt;meta charset=&quot;x&quot;&gt;</div></div>

<p>Replace x with the character set you would like to use, like ISO-8859-1, UTF-8, or UTF-16.</p>
<hr>
...
<p>The date above could mean the 2nd of March, 2004. It could also mean 
the 4th of March, 2002. Or even the 3rd of April, 2002.</p>

<p>The International Standard Organization (ISO) has defined an international 
format for dates as &quot;yyyy-mm-dd&quot;, where yyyy is the year, mm is the 
month, and dd is the day.</p>

<p>When you use this ISO format, you can expect most visitors to understand your 
dates.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_quality.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_quality.asp#top" target="_top">TOP</a> |
		<a href="web_quality.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
