...
<head>
<title>ASP.NET Web Forms Styles</title>
<style>a.menu_webforms_style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- Adding Style</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webforms_website.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webforms_database.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn ASP.NET Web Forms by building a web site from scratch.</p>
<p class="intro"><strong>Part II</strong>: Adding CSS and a Standard Layout. </p>
<hr>
<h2>What We Will Do</h2>
<p>In this chapter we will:</p>
<ul>
	<li>Create a standard style sheet for the site</li>
	<li>Create a standard master page for the site</li>
</ul>
<hr>
<h2>Create a Style Sheet</h2>
<p>In your web folder (DemoWebForms), create a new CSS file named &quot;Site.css&quot;.</p>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>To create a CSS file, right-click the root folder and select &quot;New File&quot;. Then select a CSS file.</td>
</tr></table>

<p>Put the following code inside the CSS file:</p>
...
body<br>
{<br>
font: &quot;Trebuchet MS&quot;, Verdana, sans-serif;<br>
background-color: #5c87b2;<br>
color: #696969;<br>
}<br>
    <br />
#main<br>
...
border-bottom: 3px solid #cc9900;<br>color: #996600;<br>
}</div>
</div>
<p>The CSS file above defines the styles to be used used for</p>
<ul>
	<li>The HTML body element &lt;body&gt;</li>
	<li>The HTML element with id=&quot;main&quot; </li>
    <li>The HTML heading element &lt;h1&gt; </li>
</ul>

<hr>
<h2>Create a Master Page</h2>
<p>In your web folder (DemoWebForms), create a new master page named &quot;Site.master&quot;.</p>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>To create a Master file, right-click the root folder and select &quot;New File&quot;. Then select &quot;Master Page (VB)&quot;.</td>
</tr></table>

<p>Put the following code inside the master file:</p>

<div class="example">
<h2 class="example">Site.master</h2>
<div class="example_code notranslate">
...
&lt;title>&lt;/title&gt;<br />
&nbsp;
&lt;link href="Site.css" rel="stylesheet"><br />
&lt;/head><br />
    <br />
&lt;body><br />
...
&lt;asp:ContentPlaceHolder ID="MainContent" runat="server"/><br />
    &lt;p&gt;&amp;copy; &lt;%=DateTime.Now.Year%&gt; W3Schools. All rights reserved.&lt;/p&gt;<br />
&lt;/div><br />
&lt;/form><br />
&lt;/body><br />
&lt;/html>
...
<p>The master file above defines the layout of your web pages. It has a link to your 
style sheet file (Site.css), and an asp control (asp:ContentPlaceHolder), where your page content should be displayed.</p>

<hr>
<h2>Edit the Home Page</h2>
<p>In your &quot;DemoWebForms&quot; folder, edit the file named &quot;Default.aspx&quot;.</p>
<p>Change the content to the following:</p>

<div class="example">
<h2 class="example">Default.aspx</h2>
<div class="example_code notranslate">
&lt;%@ Page Title=&quot;Home&quot; MasterPageFile=&quot;Site.master&quot; %&gt;<br>
<br>
&lt;asp:Content ID=&quot;Content&quot; ContentPlaceHolderID="MainContent" runat="server"&gt;<br>&nbsp; &lt;h1&gt;Welcome to W3Schools&lt;/h1&gt; <br>
	&nbsp;
	&lt;h2&gt;Web Site Main Ingredients&lt;/h2&gt;<br>
	&nbsp;
	&lt;p&gt;A Home Page (Default.aspx)&lt;/p&gt;<br>
&nbsp;
&lt;p&gt;A Style Sheet (Site.css)&lt;/p&gt;<br>&nbsp;
	&lt;p&gt;A Layout File (Site.master)&lt;/p&gt;<br>
	&lt;/asp:Content&gt;</div>
<br /><a class="showbtn" href="showaspx.asp?filename=demo_wf_001" target="_blank">Run example &raquo;</a>
</div>
<p>The file starts with a reference to the layout file, otherwise it 
contains an asp control and a 
normal HTML markup. </p>

<hr>
<h2>Edit the About Page</h2>
<p>In your &quot;DemoWebForms&quot; folder, edit the file named &quot;About.aspx&quot;.</p>
<p>Change the content to the following:</p>

<div class="example">
<h2 class="example">About.aspx</h2>
<div class="example_code notranslate">
&lt;%@ Page Title=&quot;Home&quot; MasterPageFile=&quot;Site.master&quot; %&gt;<br>
<br>
&lt;asp:Content ID=&quot;Content&quot; ContentPlaceHolderID="MainContent" runat="server"&gt;<br>&nbsp;&lt;h1&gt;About 
	Us&lt;/h1&gt;
<br>&nbsp;&lt;p&gt;Lorem Ipsum Porem Lorem Ipsum Porem&lt;/p&gt;<br>&lt;/asp:Content&gt;</div>
<br>
</div>
<br>
<hr>
<h2>Congratulations</h2>
<p>You have created your first ASP.NET Web Forms site, with a main page (Default.aspx), a 
common template for all your pages (Site.master), and a common style sheet 
(Site.css).</p>
<p>In the next chapters of this tutorial, we will add a database to the web 
site. And finally we will add navigation.</p>

<hr>
<h2>Web Forms File Types</h2>
<p>Below is a list of ASP.NET Web Forms most common file types.</p>
...
<tr>
	<td>.htm / .html</td>
	<td>HTML Pages<br>Web pages to be viewed directly by the browser</td>
</tr>
<tr>
	<td>.css</td>
	<td>Style Sheets<br>Defines styles and formatting for the web site</td>
</tr>
<tr>
	<td>.js</td>
	<td>JavaScripts<br>Contains JavaScripts to be executed in the browser</td>
</tr>
<tr>
	<td>.aspx</td>
	<td>Web Forms<br>The core of ASP.NET. Web pages with ASP.NET code.</td>
</tr>
<tr>
	<td>.ascx</td>
	<td>Web User Controls<br>Contains code fragments to be used by multiple pages</td>
</tr>
<tr>
	<td>.asax</td>
	<td>Global Class<br>Global code (like startup code)</td>
</tr>
<tr>
	<td>.asmx</td>
	<td>Web Service<br>Contains callable web services</td>
</tr>
<tr>
	<td>.cs</td>
	<td>Class Files<br>Contains code in C#</td>
</tr>
<tr>
	<td>.vb</td>
	<td>Class Files<br>Contains code in Vb (Visual Basic)</td>
</tr>
<tr>
	<td>.config</td>
	<td>Web Configuration<br>Contains configuration information for the web site</td>
</tr>
<tr>
	<td>.master</td>
	<td>Master Pages<br>Define the global structure (look) of the web site</td>
</tr>
<tr>
	<td>.sitemap</td>
	<td>XML Sitemap</td>
...
<tr>
	<td>.xml</td>
	<td>Data stored in XML format</td>
</tr>
<tr>
	<td>.sdf</td>
	<td>SQL Server Compact Databases<br></td>
</tr>
<tr>
	<td>.mdf</td>
	<td>SQL Server Express (Access) Databases</td>
</tr>
</table>
<br><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webforms_style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webforms_style.asp#top" target="_top">TOP</a> |
		<a href="webforms_style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
