...
<style>a.menu_web_host_technologies{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web Hosting <span class="color_h1">Technologies</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_host_email.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_host_databases.asp">Next Chapter &raquo;</a></div>
</div>
...
plan to develop your web site using Microsoft Expression Web.</p>
...
<hr>
<h2>CGI</h2>
<p>CGI scripts are executables that 
will execute on the server to produce dynamic and interactive web pages.</p>
<p>Most ISPs offer some kind of CGI capabilities. 
ISPs often offer preinstalled, ready to run, guest-books, page-counters, and 
chat-forums solutions in CGI.</p>

<p>CGI is most common on Unix or Linux servers.</p>

<hr>
<h2>ASP - Active Server Pages</h2>
<p>
ASP is a server-side scripting technology developed by Microsoft.</p>
<p>
...
returned to the browser. Both VBScript and JavaScript can be used. </p>
<p>
...
directly into the HTML code.</p>
<p>
The PHP syntax is very similar to Perl and C.</p>
<p>
PHP is often used together with 
Apache (web server) on various operating systems. It also supports ISAPI and can 
be used with Microsoft's IIS on Windows.</p>
<p>
PHP supports many databases, such as MySQL, Informix, Oracle, Sybase, Solid, 
PostgreSQL, Generic ODBC, etc. </p>


<p>
If you want to learn more about PHP, <a href="../php/default.asp">please visit our 
PHP tutorial</a>.</p>
<hr>
...
dynamic web pages.</p>
<p>Cold Fusion is developed by Adobe.</p>
<hr>
...
<p>Expression Web is a website design tool developed by Microsoft.</p>

<p>Expression Web allows users to 
develop a web site without any deep knowledge of web development.</p>

<p>If you plan to use Expression Web, you should look for a Windows hosting solution.</p>

<hr>
<h2>Adobe Dreamweaver</h2>
<p>Dreamweaver is a website design tool owned by Adobe Systems.</p>
<p>Dreamweaver allow users to develop a web site without any deep knowledge of 
web development.</p>
<p>Dreamweaver has support for web technologies such as CSS, JavaScript, 
ASP.NET, 
ColdFusion, JavaServer Pages, and PHP.</p>
<p>Dreamweaver is available for both Mac and Windows operating systems.</p>

<hr>
<h2>Secure Server</h2>
<p>A secure server can transmit data encrypted.</p>
<p>If you plan to do online creditcard transactions, or other types of web 
communication that needs to be protected against unauthorized access, your ISP must provide a secure server.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_host_email.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_host_databases.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_host_technologies.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_host_technologies.asp#top" target="_top">TOP</a> |
		<a href="web_host_technologies.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
