...
<title>ASP.NET Web Pages WebMatrix</title>
<style>a.menu_webpages_website{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Creating a Web Site</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_demo.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_style.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<hr>
<h2>Create a Web Site</h2>
<p>Create an empty web site named <strong>DemoWebPages</strong>.</p>
...
<p>In the "DemoWebPages" folder, create a new CSHTML file named <strong>
Default.cshtml.</strong> </p>
...
&lt;/head&gt;<br>
	...
	&nbsp;
	&lt;p&gt;A Home Page (Default.cshtml)&lt;/p&gt;<br>
	&nbsp;
...
<br />
	<a class="showbtn" href="DemoWebPages/showcshtml.asp?filename=try_webpages_home" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
<h2>Add an About Page</h2>
<p>In the &quot;DemoWebPages&quot; folder, create a new CSHTML file named &quot;About.cshtml&quot;.</p>

<p>Put the following code inside the about file:</p>

<div class="example">
<h2 class="example">About.cshtml</h2>
	<div class="example_code notranslate">
...
&lt;/head&gt;<br><br>&lt;body&gt;<br>
&lt;h1&gt;About Us&lt;/h1&gt;<br>&lt;p&gt;Lorem Ipsum Porem Lorem Ipsum Porem&lt;/p&gt;<br>
		&lt;/body&gt;<br><br>&lt;/html&gt;</div>
</div>
