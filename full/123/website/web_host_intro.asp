...
<style>a.menu_web_host_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web Hosting <span class="color_h1">Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_tcpip.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_host_providers.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">How does the Internet work? How can I have my own Web Site?</p>
...
<ul>
	...
	<li>All the computers use a <b>communication protocol called HTTP</b></li>
</ul>
<hr>
...
<ul>
	...
	<li>Popular browsers are <b>Internet Explorer and Firefox</b></li>
</ul>
<hr>
...
<ul>
	...
	<li>An address may look like this: <b>http://www.example.com/default.htm</b></li>
</ul>
<hr>
...
<ul>
	...
	<li>To let others view your web pages, you must <b>publish your web site</b></li>
	<li>To publish your work, you must <b>copy your site to a web server</b></li>
	<li>Your own PC can act as a web server if it is <b>connected to a network</b></li>
...
public server.</p>
<p>Even if you can use your own PC as a web server, it is more 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_host_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_host_intro.asp#top" target="_top">TOP</a> |
		<a href="web_host_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
