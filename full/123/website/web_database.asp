...
<title>Web Building - Database</title>
<style>a.menu_web_database{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web Building <span class="color_h1">- Adding a Database</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_site.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_php_demo.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<p class="intro">How to add a database to your web site.</p>

<hr>

<h2>Displaying Data from Database</h2>
<p>In a web page, you can easily display data from a database.</p>
    <p>You can connect to an existing database, or you can create a new database.</p>

<hr>
<h2>Create a New Database</h2>
<p>In this chapter we will demonstrate how to create a new database using 
WebMatrix:</p>
<ul>
...
<p>WebMatrix includes an SQL Database design tool.</p>
<p>Follow the instructions below to create an SQL database called &quot;SmallBakery&quot;.</p>

<p>Open the Databases workspace and click <strong>New 
Database</strong> or <strong>Add a database</strong>.</p>
<p>WebMatrix will create a database with the same name as your site: &quot;Demo.sdf&quot;:</p>
<p><img src="pic_wp_sqldesign.jpg" alt="SQL Design" /></p>
<p><strong>Rename</strong> the database to &quot;SmallBakery.sdf&quot;.</p>
<p>Click <strong>New Table</strong>.</p>
<p>Name the new table &quot;<strong>Product</strong>&quot;.</p>
    <p>In the new table, create 4 columns named &quot;Id&quot;, &quot;Name&quot;, 
&quot;Description&quot;, and &quot;Price&quot;.</p>
<p>For all columns, set <strong>Allows Null</strong> to &quot;No&quot;. </p>
<p>For the &quot;Id&quot; column, Set <strong>Data Type</strong> to &quot;bigint&quot;, <strong>Is Primary Key</strong> 
to &quot;Yes&quot;, and <strong>Is Identity</strong> to 
&quot;Yes&quot;.</p>
<p>For the &quot;Name&quot; and &quot;Description&quot; columns, set <strong>Data Type</strong> to 
&quot;nvarchar(50)&quot;.</p>
<p>For the &quot;Price&quot; column, set <strong>Data 
Type</strong> to &quot;money&quot;.</p>
<p>When you are finished, your table design will look like this:</p>
<img src="pic_wp_database.gif" alt="Database" />
<p><strong>Allow Nulls=No</strong>, specifies that the column cannot be blank (empty). 
</p>
<p><strong>Is Primary Key?</strong>, tells the database that this will be the table's primary key.</p>
<p><strong>Is Identity?</strong>, tells the database to automatically assign a new Id number for every new record (starting at 1).</p>
<p><strong>Data 
Type=nvarchar(50)</strong>, specifies a variable 
length (max 50) character string data type.</p>
    <p>(The <strong>n</strong> in <strong>n</strong>varchar indicates that the character variable can hold international Unicode 
characters)</p>
<hr>

<h2>Adding Data to the Database</h2>
<p>Follow the instructions below to add some data to your database:</p>
    <p>Open the Products table (In the left pane, double-click SmallBakery.sdf, double-click Tables, and double-click Products).</p>
<p>Enter the following records:</p>
...
<p>
After you have finished your input, your screen should look much like this:</p>

<img src="pic_wp_products.gif" alt="Database" />
<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_database.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_database.asp#top" target="_top">TOP</a> |
		<a href="web_database.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
