...
<title>ASP.NET Web Forms Demo - Navigation</title>
<style>a.menu_webforms_navigation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- Adding Navigation</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webforms_database.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webforms_ajax.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn ASP.NET Web Forms by building a web site from scratch.</p>
<p class="intro"><strong>Part IV</strong>: Adding a Navigation Menu.</p>
...
<p>Edit the content of the master file (Site.master).</p>
<p>Put the following (red marked) code inside the file:</p>

<div class="example">
<h2 class="example">Site.master</h2>
<div class="example_code notranslate">
	&lt;%@ Master Language=&quot;VB&quot; %&gt;<br>&lt;!DOCTYPE html&gt;<br>
	<br>&lt;head 
	id=&quot;head&quot; runat=&quot;server&quot;&gt;<br>&lt;title&gt;&lt;/title&gt;<br>&lt;link href=&quot;Site.css&quot; 
	rel=&quot;stylesheet&quot;&gt;<br>&lt;/head&gt;<br><br>&lt;body&gt;<br>
	&lt;form id=&quot;form1&quot; runat=&quot;server&quot;&gt;<br>
<span class="marked">&lt;ul 
id=&quot;menu&quot;&gt;<br>&lt;li&gt;&lt;a href=&quot;Default.aspx&quot;&gt;Home&lt;/a&gt;&lt;/li&gt;<br />
...
&lt;/ul&gt;</span>
<br><br>&lt;div 
	id=&quot;main&quot;&gt;<br>&lt;asp:ContentPlaceHolder 
	ID=&quot;MainContent&quot; runat=&quot;server&quot;/&gt;<br>&lt;p&gt;&amp;copy; 
	&lt;%=DateTime.Now.year%&gt; 
	W3Schools. All rights reserved.&lt;/p&gt;<br>&lt;/div&gt;<br>&lt;/form&gt;<br>
	&lt;/body&gt;<br>&lt;/html&gt;<br>
	</div>
</div>
<p>The master file above, is a copy of the master file from the previous 
chapter, with an added unordered list (marked red).</p>

<hr>
<h2>Edit The Style Sheet</h2>
<p>Edit your your style sheet (Site.css):</p>
<p>Put the following (red marked) code inside the file:</p>
...
{<br>
padding: 20px;<br>
background-color: #ffffff;<br>border-radius: 0 4px 4px 4px;<br>
}<br>
    <br />
h1<br>
{<br>
...
{<br>
background-color: #e8eef4;<br>
}</span>
</div>
    <br>
	<a class="showbtn" href="DemoWebForms/showaspx.asp?filename=Demo_Default" target="_blank">Run example &raquo;</a>
</div>
<p>The style sheet above, is a copy of the style sheet from the previous 
chapter, with added styles for an unordered list (marked red).</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webforms_navigation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webforms_navigation.asp#top" target="_top">TOP</a> |
		<a href="webforms_navigation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
