...
<head>
<title>ASP.NET Web Pages Demo</title>
<style>a.menu_webpages_demo{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages  <span class="color_h1">- Demonstration</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_asp_ajax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_website.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>This is a Web Pages Demonstration</h2>
<p>This demonstration will teach you ASP.NET Web Pages by building a web site 
from scratch:</p>
<ul>
	<li>Create a web site</li>
	<li>Add a home page</li>
	<li>Add a style sheet</li>
	<li>Add a database</li>
	<li>Add login and security</li>
    <li>Add navigation</li>
	<li>Add Ajax support</li>
</ul>

<hr>

<h2>Would You Like to Read the Tutorial First?</h2>

<p>Many developers like to start learning a new technology by looking 
at a demonstration</p>
    <p>If you want to read our Web Pages tutorial first, go to the
<a href="../aspnet/webpages_intro.asp">ASP.NET Web Pages Tutorial</a>.</p>

<hr>
<h2>What Will We Create?</h2>
<p>This demonstration will create a web site where you can list customers from 
a company database.</p>
<p>The web site will look like this:</p>
<iframe style="width:99.5%;height:750px;border:0" src="DemoWebPages/Default.cshtml">
</iframe>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_demo.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_demo.asp#top" target="_top">TOP</a> |
		<a href="webpages_demo.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
