...
<style>a.menu_web_php_database{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">- Adding a Database</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_php_style.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_php_navigation.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<p class="intro">Learn PHP Classic by building a web site from scratch.</p>
<p class="intro"><strong>Part III</strong>: Adding a Database.</p>

<hr>
<h2>What We Will Do</h2>
<p>In this chapter we will:</p>
<ul>
	<li>Create a page to list data from a database</li>
</ul>
...
<p>With PHP, you can easily display data from a database.</p>
    <p>You can connect to an existing database, or create a new database from scratch.</p>
<p>In this example we will connect to an existing MS Access database.</p>
<p>You can download the database from this link: <a href="Data/Northwind.zip">
Northwind.zip</a></p>
<hr>

<h2>Adding a Customers Page</h2>
<p>In the &quot;DemoPHP&quot; folder, create a new PHP file named &quot;Customers.php&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">Customers.php</h2>
<div class="example_code notranslate">
&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>&lt;link rel="stylesheet" 
	href="Site.css"&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br>&lt;div id="main"&gt;<br>
	&lt;h1&gt;Customers&lt;/h1&gt;<br><br>&lt;?php<br>//create an ADO connection and open the 
	database<br>$conn = new COM("ADODB.Connection");<br>
	...
	null;<br>?&gt; <br><br>&lt;?php include("Footer.php"); ?&gt;<br><br>&lt;/div&gt;<br>&lt;/body&gt;<br>
	&lt;/html&gt;&nbsp;
</div>
<br>
	<a class="showbtn" href="DemoPHP/showphp.asp?filename=demo_php_data" target="_blank">Run example &raquo;</a>
</div>
<hr>

<h2>Creating a New Database</h2>
<p>Download an empty database from this link: <a href="Data/EmptyDatabase.zip">
Empty Database.zip</a></p>
<p>In the &quot;DemoPHP&quot; folder, create a new PHP file named &quot;CreateCustomers.php&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">CreateCustomers.php</h2>
<div class="example_code notranslate">
&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>&lt;link rel="stylesheet" 
	href="Site.css"&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br>&lt;div id="main"&gt;<br>
	&lt;h1&gt;Customers&lt;/h1&gt;<br><br>&lt;?php<br>//create an ADO connection and open the 
	database<br>$conn=new COM("ADODB.Connection");<br>
	$conn-&gt;open("PROVIDER=Microsoft.Jet.OLEDB.4.0;Data Source=C:\WebData\EmptyDatabase.mdb");<br>
	<br>$conn-&gt;execute(&quot;CREATE TABLE Customers 
	...
	NVARCHAR(255),Country NVARCHAR(255))&quot;);<br>$conn-&gt;close();<br>$conn=null;<br>?&gt; <br><br>&lt;?php include("Footer.php"); ?&gt;<br><br>&lt;/div&gt;<br>&lt;/body&gt;<br>
	&lt;/html&gt;&nbsp;
</div>
</div>
<br>
...
<p>You have added a database to your web project.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_php_style.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_php_navigation.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_php_database.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_php_database.asp#top" target="_top">TOP</a> |
		<a href="web_php_database.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
