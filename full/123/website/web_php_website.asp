...
<style>a.menu_web_php_website{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">- Creating a Website</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_php_demo.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_php_style.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>Create an empty PHP web site named <strong>DemoPHP</strong>.</p>
...
<p>In the "DemoPHP" folder, create a new PHP file named <strong>Index.php</strong>.</p>
...
<br />
	<a class="showbtn" href="DemoPHP/showphp.asp?filename=demo_php_default" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
<h2>Add an About Page</h2>
<p>In the &quot;DemoPHP&quot; folder, create a new PHP file named &quot;<strong>About.php</strong>&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">About.php</h2>
	<div class="example_code notranslate">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_php_website.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_php_website.asp#top" target="_top">TOP</a> |
		<a href="web_php_website.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
