...
<title>ASP.NET Web Pages Database</title>
<style>a.menu_webpages_database{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Adding a Database</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_style.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_login.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<ul>
	<li>Create a web page to list data from a database</li>
</ul>
...
<p>With Web Pages, you can easily display data from a database.</p>
<p>You can connect to an existing database, or create a new database from scratch.</p>
<p>In this example we will connect to an existing SQL Server Compact database.</p>
<p>If you want to learn how to create a database for your web, please go to the 
chapter <a href="web_database.asp">Web Database</a>.</p>
<hr>

<h2>Adding a Customers Page</h2>
<p>In the &quot;DemoWebPages&quot; folder, create a new CSHTML file named &quot;Customers.cshtml&quot;.</p>

<p>Replace the code in the file with the code from the example below:</p>

<div class="example">
<h2 class="example">Customers.cshtml</h2>
<div class="example_code notranslate">
<span class="marked">@{Layout = &quot;Layout.cshtml&quot;;<br>
...
&lt;th&gt;Country&lt;/th&gt;&nbsp;<br>
	&lt;/tr&gt;<br>
<span class="marked">@foreach(var row in query)<br>
{</span><br>
&lt;tr&gt;&nbsp;<br>
&lt;td&gt;<span class="marked">@row.CompanyName</span>&lt;/td&gt;&nbsp;<br>
&lt;td&gt;<span class="marked">@row.City</span>&lt;/td&gt;&nbsp;<br>
&lt;td&gt;<span class="marked">@row.Country</span>&lt;/td&gt;&nbsp;<br>
&lt;/tr&gt;&nbsp;<br>
<span class="marked">}</span><br>
&lt;/table&gt;&nbsp;<br>
&lt;/body&gt;&nbsp;<br>
&lt;/html&gt;</div>
<br><a class="showbtn" href="DemoWebPages/showcshtml.asp?filename=try_webpages_database" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
...
<p>The Database.Open(<em>name</em>) method will connect to a database in two 
steps:</p>
<p>First, it searches the application's App_Data folder for a database that 
matches the <em>name</em> parameter without the file-name extension.</p>
<p>If no file is found, it looks for a &quot;connection string&quot; in the 
application's Web.config file.</p>
<p>(A connection string contains information about how to connect to a database. It can include a file path, or the name of an SQL database, with full user name and password)</p>

<p>This two-step search makes it possible to test the application with a local 
database, and run the application on a web host using a connection string. </p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_database.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_database.asp#top" target="_top">TOP</a> |
		<a href="webpages_database.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
