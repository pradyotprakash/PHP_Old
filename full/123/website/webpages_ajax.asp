...
<head>
<title>Web Pages AJAX</title>
<style>a.menu_webpages_ajax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- AJAX</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_navigation.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webforms_demo.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>In your web folder (DemoWebPages), create a new CSHTML file named &quot;getCustomers.cshtml&quot;.</p>

<p>Put the following code inside the file:</p>

<div class="example">
<h2 class="example">getCustomers.cshtml</h2>
	<div class="example_code notranslate">
		@{<br>var db = Database.Open(&quot;Northwind&quot;); <br>var query = 
		db.Query(&quot;SELECT CompanyName,City,Country FROM Customers&quot;); <br>}<br>
		&lt;table border=&quot;1&quot;&gt; <br>&lt;tr&gt;<br>&lt;th&gt;Name&lt;/th&gt; <br>&lt;th&gt;City&lt;/th&gt; <br>
		&lt;th&gt;Country&lt;/th&gt; <br>&lt;/tr&gt;<br>@foreach(var row in query)<br>{<br>&lt;tr&gt;
		<br>&lt;td&gt;@row.CompanyName&lt;/td&gt; <br>&lt;td&gt;@row.City&lt;/td&gt; <br>
		&lt;td&gt;@row.Country&lt;/td&gt; <br>&lt;/tr&gt; <br>}<br>&lt;/table&gt;</div>
</div>
<p>The file above is a standard CSHTML file, returning only an HTML table. </p>
<hr>
<h2>Create an AJAX Browser Page</h2>
<p>In your &quot;DemoWebPages&quot; folder, create a new file named &quot;Ajax.html&quot;.</p>
<p>Put the following code inside the file:</p>
...
<div class="example_code notranslate">
	...
	xmlhttp.open(&quot;GET&quot;,&quot;getCustomers.cshtml&quot;,true);<br>xmlhttp.send();<br>&lt;/script&gt;<br>
	<br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<br />
	<a class="showbtn" href="DemoWebPages/tryit.asp?filename=try_webpages_ajax" target="_blank">Try it Yourself &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_ajax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_ajax.asp#top" target="_top">TOP</a> |
		<a href="webpages_ajax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
