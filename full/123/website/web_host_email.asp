...
<head>
<title>Web Hosting Email Services</title>
<style>a.menu_web_host_email{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web Hosting <span class="color_h1">E-mail Services</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_host_capacity.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_host_technologies.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Hosting services should include e-mail accounts and e-mail 
services.</p>
<hr>
<h2>E-mail Accounts</h2>

<p>Hosting solutions should include e-mail accounts for each person in your 
company.</p>
<p>E-mail addresses should appear something like this:</p>
<p><b>john@mycompany.com</b></p>
<p><b>john.doe@mycompany.com</b></p>
<p><b>jdoe@mycompany.com</b></p>
...
<p>The e-mails are received and held on your internet server until you pick it up with a client e-mail program, like 
Microsoft Outlook or Mozilla Thunderbird.</p>
...
protocol for sending and receiving e-mail.</p>

<p>
The e-mails are received, and held on your internet server, until you pick it up 
with a client e-mail program, like Microsoft Outlook or Mozilla Thunderbird.</p>
...
designed to support e-mail access on one single computer.</p>

<hr>

<h2>Web-based E-mail</h2>

<p>Web-based e-mail services enable you to access your e-mail via a web browser. 
...
<p>Examples of web-based e-mail services are Gmail and Hotmail.</p>

<hr>

<h2>E-mail Forwarding</h2>

<p>E-mail forwarding allows you to have multiple e-mail personalities.</p>

<p>With e-mail forwarding, you can setup aliases for other e-mail accounts like:</p>
...
<p>Some service providers offer mailing list capabilities. This is valuable 
if you plan to send out e-mails to a large number of users.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_host_capacity.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_host_technologies.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_host_email.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_host_email.asp#top" target="_top">TOP</a> |
		<a href="web_host_email.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
