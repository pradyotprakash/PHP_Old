...
<title>ASP.NET Web Pages Adding Style</title>
<style>a.menu_webpages_style{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Adding Style</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_website.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_database.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<ul>
	...
	<li>Create a standard layout file for the site</li>
	<li>Create a new home page for the site</li>
</ul>
<hr>
<h2>Create a Style Sheet</h2>
<p>In your web folder (DemoWebPages), create a new CSS file named &quot;Site.css&quot;.</p>
...
<p>The CSS file above defines the styles to be used for</p>
<ul>
...
<hr>
<h2>Create a Layout Page</h2>
<p>In your web folder (DemoWebPages), create a new CSHTML file named &quot;Layout.cshtml&quot;.</p>

<p>Put the following code inside the layout file:</p>

<div class="example">
<h2 class="example">Layout.cshtml</h2>
<div class="example_code notranslate">
&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
&lt;head&gt;<br>
&lt;link rel=&quot;stylesheet&quot; href=&quot;Site.css&quot;&gt;<br>
&lt;/head&gt;<br>
&lt;body&gt;<br>
<br>&lt;div id=&quot;main&quot;&gt;<br>
<span class="marked">@RenderBody()</span><br>
&lt;p&gt;&amp;copy; 2013 W3Schools. All rights reserved.&lt;/p&gt;<br>
&lt;/div&gt;<br><br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
</div>
<p>The layout file above defines the layout of your web pages. It has a link to your 
style sheet file (Site.css), and a call to the @RenderBody() function, where your page content should be displayed.</p>

<hr>
<h2>Edit the Home Page</h2>
<p>In your &quot;DemoWebPages&quot; folder, edit the file named &quot;Default.cshtml&quot;.</p>
<p>Change the content to the following:</p>

<div class="example">
<h2 class="example">Default.cshtml</h2>
<div class="example_code notranslate">
<span class="marked">
@{Layout=&quot;Layout.cshtml&quot;;}<br>
</span><br>
&lt;h1&gt;Welcome to W3Schools&lt;/h1&gt; <br>
<br>&lt;h2&gt;Web Site Main Ingredients&lt;/h2&gt;<br>
<br>&lt;p&gt;A Home Page (Default.cshtml)&lt;/p&gt;<br>
&lt;p&gt;A Layout File (Layout.cshtml)&lt;/p&gt;<br>
&lt;p&gt;A Style Sheet (Site.css)&lt;/p&gt;</div>
<br><a class="showbtn" href="DemoWebPages/showcshtml.asp?filename=try_webpages_homepage" target="_blank">Run example &raquo;</a>
</div>
...
<p>You have created your first web site, with a main page (Default.cshtml), a 
common template for all your pages (Layout.cshtml), and a common style sheet 
(Site.css).</p>
<p>In the next chapters of this tutorial, we will add a database to the web 
site. Then we will add login and security, and finally add navigation.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_website.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_database.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_style.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_style.asp#top" target="_top">TOP</a> |
		<a href="webpages_style.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
