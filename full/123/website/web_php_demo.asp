...
<style>a.menu_web_php_demo{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">- Demonstration</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_database.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_php_website.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>This is a PHP Demonstration</h2>
<p>PHP is one of the most popular programming models for creating web sites and 
web applications.</p>
<p>This demonstration will teach you PHP by building a website from scratch:</p>
<ul>
...
at a demonstration.</p>
    <p>If you want to read our PHP tutorial first, go to the
...
<iframe style="width:99.5%;height:750px;border:0" src="DemoPHP/Index.php">
</iframe>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_php_demo.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_php_demo.asp#top" target="_top">TOP</a> |
		<a href="web_php_demo.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
