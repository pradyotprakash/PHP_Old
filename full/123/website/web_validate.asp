...
<style>a.menu_web_validate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web <span class="color_h1">Validation</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_wai.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_search.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>Web Page Validator</h2>
<p>A validator is a software program that can check your web pages against the 
web standards.</p>
<p>When using a validator to check HTML, XHTML or CSS documents, the validator 
returns a list of errors found, according to your chosen standard.</p>
<p>Make sure you make it a habit to validate all your web pages before 
publishing.</p>

<hr>
<h2>Validate your HTML files with W3C</h2>

<form method="get" action="http://validator.w3.org/check" target="_blank">
<p>Input the address of the page you want to validate in the box below:</p>
<p><input name="uri" size="60" value="http://www.w3schools.com/html/demo_html.asp"/></p>
<p><input type="submit" value="Validate the page" /></p>
</form>

<hr>
<h2>Validate your CSS files with W3C</h2>

<form method="get" action="http://jigsaw.w3.org/css-validator/validator" target="_blank">
<p>Input the address of the css file that you want to validate in the box below:</p>
<p><input name="uri" size="60" value="http://www.w3schools.com/stdtheme.css"/>
<input style="visibility:hidden" type="radio" name="profile" value="css3" checked="checked">
<p><input type="submit" value="Validate the page" /></p>
</form>

<hr>
<h2>Validate your XHTML files with W3C</h2>

<p>An XHTML document is validated against a Document Type Definition (DTD).</p>
<p>You can read more about XHTML validation in our
<a href="../html/html_xhtml.asp">HTML tutorial</a>.</p>
...
<hr>
<h2>Validate your XML files with Internet Explorer</h2>

<form action="http://www.w3schools.com/dom/validator.asp" target="_blank" method="post">
<p>Input the address of the page you want to validate in the box below:</p>
<p><input type="text" name="xmlfile" size="50" value="http://www.w3schools.com/dom/note.xml" /></p>
<p><input type="submit" value="Validate the page" /></p>
</form>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_validate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_validate.asp#top" target="_top">TOP</a> |
		<a href="web_validate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
