...
<title>ASP Classic Database</title>
<style>a.menu_web_asp_database{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP Classic <span class="color_h1">- Adding a Database</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_asp_style.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_asp_login.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>With ASP, you can easily display data from a database.</p>
    <p>You can connect to an existing database, or create a new database from scratch.</p>
<p>In this example we will connect to an existing Microsoft Access database.</p>
<p>You can download the database from this link: <a href="Data/Northwind.zip">
Northwind.zip</a></p>
<hr>

<h2>Adding a Customers Page</h2>
<p>In the &quot;DemoASP&quot; folder, create a new ASP file named &quot;Customers.asp&quot;.</p>
...
&lt;html&gt;<br>
&lt;head&gt;<br>
&nbsp; &lt;title&gt;ASP Demo&lt;/title&gt;<br>&nbsp; 
&lt;link href=&quot;Site.css&quot; rel=&quot;stylesheet&quot;&gt;<br>&lt;/head&gt;<br><br>&lt;body&gt;<br>
	<br>&lt;div id=&quot;main&quot;&gt;<br>
	&lt;h1&gt;Customers&lt;/h1&gt; <br>&lt;%<br>set 
	...
	Server.CreateObject(&quot;ADODB.recordset&quot;)<br>rs.Open &quot;Select CompanyName, City, 
	Country FROM Customers&quot;, conn<br>%&gt;<br>&lt;table border=&quot;1&quot;&gt;<br>
	&lt;tr&gt;&lt;th&gt;Name&lt;/th&gt;&lt;th&gt;City&lt;/th&gt;&lt;th&gt;Country&lt;/th&gt;&lt;/tr&gt;<br>&lt;%do until rs.EOF%&gt;<br>
	&lt;tr&gt;<br>&lt;%for each x in rs.Fields%&gt;<br>&lt;td&gt;<br>&lt;%Response.Write(x.value)%&gt;<br>
	&lt;/td&gt;<br>&lt;%next%&gt;<br>&lt;/tr&gt;<br>&lt;%<br>rs.MoveNext<br>loop<br>%&gt;<br>&lt;/table&gt;<br>
	&lt;%<br>rs.close<br>conn.close<br>%&gt;<br>
<br>&lt;!-- #include=&quot;Footer.inc&quot; --&gt;<br>&lt;/div&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;&nbsp;
</div>
<br>
<a class="showbtn" href="DemoASP/showasp.asp?filename=demo_asp_data" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_asp_database.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_asp_database.asp#top" target="_top">TOP</a> |
		<a href="web_asp_database.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
