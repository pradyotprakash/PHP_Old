...
<head>
<title>Web Hosting Domain Names</title>
<style>a.menu_web_host_domains{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web Hosting <span class="color_h1">Domain Names</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_host_providers.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_host_capacity.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A domain name is a unique name for your web site.</p>
<p class="intro">Choosing a hosting solution should include domain name 
registration.</p>
<p class="intro">Your domain name should be easy to remember and easy to type. </p>
<hr>
<h2>What is a Domain Name?</h2>
<p>A domain name is a unique name for a web site, like <b>w3schools.com</b>.</p>
<p>Domain names must be registered. When domain names are registered, they are 
added to a large domain name register. In addition, information about the web site, 
including the IP address, is stored on a DNS server.</p>
<p>DNS stands for Domain Name System. A DNS server is responsible for informing 
all other computers on the Internet about the domain name and the web site 
address.</p>
<hr>
<h2>Registering a Domain</h2>
<p>Domains can be registered from domain name registration companies.</p>
<p>These companies provide interfaces to search for available domain names, and 
they offer a variety of domain name extensions that can be registered at the same 
time.</p>
<hr>
<h2>Choosing a Domain Name </h2>
<p>Choosing a domain name is a major step for any individual or organization.</p>
<p>New domain name extensions and 
creative thinking still offer thousands of excellent domain names!</p>
<p>When choosing a 
name, it is important to consider the purpose of a domain name, which is to 
provide an easy way to reach your web site.</p>
<p>The best domains have the 
following characteristics:</p>
<p><b>Short</b> - People don't like to type! A short domain name is easier  
to type, read, and remember.</p>
<p><b>Meaningful</b> - A short domain is nothing without meaning, 
34i4nh.com is not easy to enter or 
to remember. Select a domain that relates to your site in a way that people will 
understand.</p>
<p><b>Clear</b> - Clarity is important when selecting a domain name. Avoid 
a name that is difficult to spell or pronounce.</p>
<p><b>Exposure</b> - Names that are short and easy to remember are an asset. In addition to 
...
maintains a short, clear and meaningful domain name.</p>
<hr>
<h2>Sub Domains</h2>
<p>Most people are unaware that they use sub domains daily. 
...
be registered before a sub domain could be created.</p>
<p>Examples of sub 
domains used on the internet are http://store.apple.com and http://support.microsoft.com.</p>
<p>Sub domains can be requested from your web hosting provider.</p>
<hr>
<h2>False Domain Names - Directory Listings</h2>
<p>Some providers will offer you a name under their own name, like:&nbsp;
<b>www.theircompany.com/yourcompany/</b></p>
<p>This is not a real domain name, it is a directory - and you should try to 
avoid it.</p>
<p>Directory domains are not desirable, especially for companies.</p>
<p>Typically, directory domains are used for 
personal web sites and free web sites provided by an ISP, you may have seen 
<b>www.theircompany.com/~username</b> as an address.</p>
<p>Competition in 
...
<p>Another source for domain registrations is expired domains.</p>
<p>When you register 
...
<p>After you have chosen and registered your own domain name, make sure you 
use it on all your web pages, and on all your correspondence, like e-mail and 
traditional mail.</p>
<p>It is important to let other people be aware of your domain name, and to inform your 
partners and customers about your web site.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_host_providers.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_host_capacity.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_host_domains.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_host_domains.asp#top" target="_top">TOP</a> |
		<a href="web_host_domains.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
