...
<head>
<title>Web Hosting Capacities</title>
<style>a.menu_web_host_capacity{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web Hosting <span class="color_h1">Capacities</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="web_host_domains.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="web_host_email.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
very small. But if you look at the size of the 
images used inside these pages, you will often find 
the images larger than the page.</p>
...
<p>If you use a lot of images or graphic elements (or sound 
files or movies), you might need much more disk space.</p>
<p>Make sure you know your needs, before choosing a web 
host.</p>
<hr>
<h2>Monthly Traffic</h2>
<p>A small or medium web site will consume between 1GB and 5GB of data transfer per month.</p>
<p>Calculate the following: <i>average page size * expected page views per month</i></p>
<p>Example: If your average page size is 30KB and you 
expect 50,000 page views per month, you will need 0.03MB * 50,000 = 1.5GB.</p>
<p>Larger, commercial sites often consume more than 100GB of monthly traffic.</p>
<p>Before you sign up with a host provider, make sure to check this:</p>
<ul>
	<li>What are the restrictions on monthly transfer?</li>
	<li>Will the web site be closed if it exceeds the volume?</li>
	<li>Will you be billed a fortune if the web site exceeds the volume?</li>
...
character). Low-speed modems can transport 
...
<table class="reference notranslate">
  <tr>
    ...
    <th style="width:34%">Speed per second</th>
  </tr>
  <tr>
    <td>Modem</td>
    <td>Analog</td>
...
<p>Before you sign up with a host provider, surf some other web 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="web_host_capacity.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="web_host_capacity.asp#top" target="_top">TOP</a> |
		<a href="web_host_capacity.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
