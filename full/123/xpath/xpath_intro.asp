...
<style>a.menu_xpath_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XPath <span class="color_h1">Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xpath_nodes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XPath is a language for finding information in an XML document.</p>
<hr>
...
<img src="xpath1.gif" width="160" height="160" alt="XPath"></td>
<td>
<ul>
  ...
  <li>XPath is a W3C recommendation</li>
</ul>
</td>
</tr></table>
<br>
...
expressions look very much like the expressions you see when you work with a traditional computer file system.</p>
<hr>

<h2>XPath Standard Functions</h2>
<p>XPath includes over 100 built-in functions. There are functions for string values, numeric values, date and time comparison, node and QName 
manipulation, sequence manipulation, Boolean values, and more.</p>
<hr>
...
<p>You can read more about XSLT in our <a href="../xsl/default.asp">XSLT tutorial</a>.</p>
<p>XQuery and XPointer are both built on XPath expressions. XQuery 1.0 and XPath 2.0 share the same data model and support the same functions and operators.</p>
<p>You can read more about XQuery in our <a href="../xquery/default.asp">XQuery tutorial</a>.</p>
<hr>

<h2>XPATH is a W3C Recommendation</h2>
<p>XPath became a W3C Recommendation 16. November 1999.</p>
<p>XPath was designed to be used by XSLT, XPointer and other XML parsing software.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xpath_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xpath_intro.asp#top" target="_top">TOP</a> |
		<a href="xpath_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
