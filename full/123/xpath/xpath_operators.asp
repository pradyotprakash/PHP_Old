...
<style>a.menu_xpath_operators{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XPath <span class="color_h1">Operators</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xpath_axes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xpath_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An XPath expression returns either a node-set, a string, a 
Boolean, or a number.</p>

<hr>

<h2>XPath Operators</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xpath_operators.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xpath_operators.asp#top" target="_top">TOP</a> |
		<a href="xpath_operators.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
