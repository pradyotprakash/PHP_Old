...
<style>a.menu_xpath_syntax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XPath <span class="color_h1">Syntax</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xpath_nodes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xpath_axes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XPath uses path expressions to select nodes or node-sets in an XML document. 
The node is selected by following a path or steps.</p>
<hr>
...
&lt;book&gt;<br>
&nbsp;
&lt;title lang=&quot;eng&quot;&gt;Harry Potter&lt;/title&gt;<br>
&nbsp;
&lt;price&gt;29.99&lt;/price&gt;<br>
&lt;/book&gt;<br><br>
&lt;book&gt;<br>
&nbsp;
&lt;title lang=&quot;eng&quot;&gt;Learning XML&lt;/title&gt;<br>
&nbsp;
...
<p>XPath uses path expressions to select nodes in an XML document. The node is selected by following a path or steps. 
The most useful 
...
<p>In the table below we have listed some path expressions and the result of the 
expressions:</p>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td>/bookstore</td>
    <td>Selects the root element bookstore<p><b>Note:</b> If the path starts with a slash ( / ) it 
...
path to an element!</p></td>
  ...
  <tr>
    <td>//book</td>
    <td>Selects all book elements no matter where they are in the 
	document</td>
  </tr>
  <tr>
    <td>bookstore//book</td>
    <td>Selects all book elements that are descendant of the 
...
<p>Predicates are always embedded in square brackets.</p>

<p>In the table below we have listed some path expressions with predicates and the result of the 
expressions:</p>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    ...
    <td>Selects the last but one book element that is the child of the 
	bookstore element</td>
  </tr>
  <tr>
    <td>/bookstore/book[position()&lt;3]</td>
    <td>Selects the first two book elements that are children of the 
	bookstore element</td>
  </tr>
  <tr>
    <td>//title[@lang]</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xpath_syntax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xpath_syntax.asp#top" target="_top">TOP</a> |
		<a href="xpath_syntax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
