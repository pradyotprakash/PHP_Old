...
<style>a.menu_xpath_examples{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XPath <span class="color_h1">Examples</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xpath_operators.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xpath_summary.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Let's try to learn some basic XPath syntax by looking at some examples.</p>
<hr>
...
<p>Using XMLHttpRequest to load XML documents is supported in all modern 
browsers.</p>
...
<p>Unfortunately, there are different ways of dealing with XPath in Internet Explorer and other browsers.</p>
...
<p>Firefox, Chrome, Opera and Safari use the evaluate() method to select nodes from the 
XML document:</p>
<div class="code notranslate"><div>
...
<br>
<a target="_blank" href="tryit.asp?filename=try_xpath_select_cdnodes" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br>
<a target="_blank" href="tryit.asp?filename=try_xpath_select_cdnodes_first" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<br>
<a target="_blank" href="tryit.asp?filename=try_xpath_select_pricenodes_text" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br>
<a target="_blank" href="tryit.asp?filename=try_xpath_select_pricenodes_35" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
<br>
<a target="_blank" href="tryit.asp?filename=try_xpath_select_pricenodes_high" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xpath_operators.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xpath_examples.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xpath_examples.asp#top" target="_top">TOP</a> |
		<a href="xpath_examples.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
