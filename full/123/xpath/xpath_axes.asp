...
<style>a.menu_xpath_axes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XPath <span class="color_h1">Axes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xpath_syntax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xpath_operators.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Selects all ancestors (parent, grandparent, etc.) of the current node 
	and the current node itself</td>
  </tr>
  <tr>
    <td>attribute</td>
  ...
  <tr>
    ...
    <td>Selects all descendants (children, grandchildren, etc.) of the current node 
	and the current node itself</td>
  </tr>
  <tr>
    <td>following</td>
  ...
  <tr>
    <td>preceding</td>
    <td>Selects all nodes that appear before the current node in 
	the document, except ancestors, attribute nodes and namespace nodes</td>
  </tr>
  <tr>
...
<p>An absolute location path starts with a slash ( / ) and a relative location path does not. In both cases the location path consists of one or more steps, each separated by a slash:</p>

<div class="code notranslate"><div>

An absolute location path:<br><br>
/step/step/...<br><br>
A relative location path:<br><br>
step/step/...
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xpath_axes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xpath_axes.asp#top" target="_top">TOP</a> |
		<a href="xpath_axes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
