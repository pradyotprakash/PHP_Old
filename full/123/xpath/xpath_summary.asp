...
<title>XPath Summary</title>
<style>a.menu_xpath_summary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>You Have Learned XPath, <span class="color_h1">Now What?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xpath_examples.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xpath_functions.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>XPath Summary</h2>
<p>This tutorial has taught you how to find information in an XML document.</p>
<p>You have learned how to use XPath to navigate through elements and attributes 
in an XML document.</p>
<p>You have also learned how to use some of the standard functions that are 
built-in in XPath.</p>
<p>For more information on XPath, please look at our
<a href="xpath_functions.asp">XPath Reference</a>.</p>
<hr>
<h2>Now You Know XPath, What's Next?</h2>
<p>The next step is to learn about XSLT, XQuery, XLink, and XPointer.</p>
<p><b>XSLT</b></p>
...
<p><b>XQuery</b></p>
<p>XQuery is about querying XML data.</p>
<p>XQuery is designed to query anything that can appear 
as XML, including databases.</p>
<p>If you want to learn more about XQuery, please 
visit our <a href="../xquery/default.asp">XQuery tutorial</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xpath_summary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xpath_summary.asp#top" target="_top">TOP</a> |
		<a href="xpath_summary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
