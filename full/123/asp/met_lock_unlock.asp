...
<title>ASP Lock and Unlock Methods</title>
<style>a.menu_met_lock_unlock{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Lock and Unlock</span> Methods</h1>
<hr>
...
<p>The Lock method prevents other users from modifying the variables in the Application
object (used to ensure that only one client at a time can modify the Application
variables).</p>

<h3>Unlock Method</h3>

<p>The Unlock method enables other users to modify the variables stored in the Application object
(after it has been locked using the Lock method).</p>
...
<h3>Example</h3>
<p>The example below uses the Lock method to prevent more than one user from accessing the variable
visits at a time, and the Unlock method to unlock the locked object so that the next client can increment
the variable visits:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_lock_unlock.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_lock_unlock.asp#top" target="_top">TOP</a> |
		<a href="met_lock_unlock.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
