...
<style>a.menu_asp_inputforms{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Forms</span> and <span class="color_h1">User Input</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_procedures.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_cookies.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The Request.QueryString and Request.Form commands are used to retrieve user input from forms.</p>
<hr>
...
<p><a target="_blank" href="showasp.asp?filename=demo_reqquery">A form with method=&quot;get&quot;</a><br>
How to interact with the user, with the Request.QueryString command.</p>

<p><a target="_blank" href="showasp.asp?filename=demo_simpleform">A form with method=&quot;post&quot;</a><br>
...
<h2>User Input </h2>
<p>The Request object can be used to retrieve user information from forms.</p>
...
<p>User input can be retrieved with the Request.QueryString or Request.Form command.</p>
<hr>

<h2>Request.QueryString</h2>
<p>The Request.QueryString command is used to collect values in a form with method=&quot;get&quot;.</p>
<p>Information sent from a form with the GET method is visible to everyone (it will be displayed in the browser's address bar)
and has limits on the amount of information to send.</p>
<p>If a user typed &quot;Bill&quot; and &quot;Gates&quot; in the HTML form above, the URL sent to the server would look like this:</p>

<div class="code notranslate"><div>
http://www.w3schools.com/simpleform.asp?fname=Bill&amp;lname=Gates</div></div>

<p>Assume that &quot;simpleform.asp&quot; contains the following ASP script:</p>
...
<h2>Request.Form </h2>
<p>The Request.Form
command is used to collect values in a form with method=&quot;post&quot;.</p>
<p>Information sent from a form with the POST method 
is invisible to others and has no limits on the amount of information to send.</p>
<p>If a user typed &quot;Bill&quot; and &quot;Gates&quot; in the HTML form 
above, the URL sent to the server would look like this: </p>

<div class="code notranslate"><div>
http://www.w3schools.com/simpleform.asp</div></div>
...
Browser validation is faster and reduces the server load.</p>
<p>You should consider server validation if the user input will be
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_inputforms.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_inputforms.asp#top" target="_top">TOP</a> |
		<a href="asp_inputforms.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
