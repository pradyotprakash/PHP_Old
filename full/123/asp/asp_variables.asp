...
<style>a.menu_asp_variables{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Variables</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_syntax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_procedures.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><a target="_blank" href="showasp.asp?filename=demo_fornext2">Loop through the HTML headings</a><br>
How to loop through the six headings in HTML.</p>
...
<p>A variable declared outside a procedure can be accessed and changed by any script in the ASP file. </p>
<p>A variable declared inside a procedure is created and destroyed every time the procedure is executed. No scripts outside the procedure can access or change the variable. </p>
<p>To declare variables accessible to more than one ASP file, declare them as session variables or application variables.</p>

<h3>Session Variables</h3>
<p>Session variables are used to store information about ONE single user, and are available to all pages in one application. Typically information stored in session variables are name, id, and preferences.</p>

<h3>Application Variables </h3>
<p>Application variables are also available to all pages in one application. Application variables are used to store information about ALL users in one specific application.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_syntax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_procedures.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_variables.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_variables.asp#top" target="_top">TOP</a> |
		<a href="asp_variables.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
