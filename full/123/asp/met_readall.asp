...
<title>ASP ReadAll Method</title>
<style>a.menu_met_readall{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">ReadAll</span> Method</h1>
<hr>
...
<hr>
<p>The ReadAll method reads an entire TextStream file and returns the result as
a string.</p>

<p><b>Note:</b> This method is not suitable for large files (it wastes memory
resources).</p>
...
x=t.ReadAll<br>
t.close<br>
Response.Write(&quot;The text in the file is: &quot; &amp; x)<br>
%&gt;<br>
<br>
Output:<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_readall.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_readall.asp#top" target="_top">TOP</a> |
		<a href="met_readall.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
