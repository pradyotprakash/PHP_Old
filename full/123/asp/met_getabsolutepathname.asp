...
<title>ASP GetAbsolutePathName Method</title>
<style>a.menu_met_getabsolutepathname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetAbsolutePathName</span> Method</h1>
<hr>
...
<hr>
<p>The GetAbsolutePathName method returns the complete path from the root of the
...
<table class="reference notranslate">
  ...
  <tr>
    <td>path</td>
    <td>Required. The path to change to a complete path</td>
  </tr>
</table>
...
path=fs.GetAbsolutePathName(&quot;c:&quot;)<br>
...
dim fs,path<br>
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)<br>
path=fs.GetAbsolutePathName(&quot;mydoc.txt&quot;)<br>
response.write(path)<br>
%><br>
<br>
Output:<br>
...
dim fs,path<br>
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)<br>
path=fs.GetAbsolutePathName(&quot;private\mydoc.txt&quot;)<br>
response.write(path)<br>
%><br>
<br>
Output:<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_getabsolutepathname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_getabsolutepathname.asp#top" target="_top">TOP</a> |
		<a href="met_getabsolutepathname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
