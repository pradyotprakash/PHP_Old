...
<style>a.menu_asp_ref_drive{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Drive</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_textstream.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_file.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The Drive object is used to get information about a local disk drive or a network share.</p>
<hr>
...
<p><a target="_blank" href="showfile.asp?filename=demo_totalsize">Get the total size of a specified drive</a><br>
How to get the total size of a specified drive.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_availablespace">Get the available space of a specified drive</a><br>
How to get the available space of a specified drive.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_freespace">Get the free space of a specified drive</a><br>
How to get the free space of a specified drive.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_driveletter">Get the drive letter of a specified drive</a><br>
How to get the drive letter of a specified drive.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_drivetype">Get the drive type of a specified drive</a><br>
How to get the drive type of a specified drive.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_filesystem">Get the file system of a specified drive</a><br>
How to get the file system of a specified drive.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_isready">Is the drive ready?</a><br>
How to check whether a specified drive is ready.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_path">Get the path of a specified drive</a><br>
How to get the path of a specified drive.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_rootfolder">Get the root folder of a specified drive</a><br>
How to get the root folder of a specified drive.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_serialnumber">Get the serialnumber of a specified drive</a><br>
How to get the serialnumber of a specified drive.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns the amount of available space to a user on a
      specified drive or network share</td>
  </tr>
  <tr>
    <td><a href="prop_driveletter.asp">DriveLetter</a></td>
    <td>Returns one uppercase letter that identifies the local
      drive or a network share</td>
  </tr>
  <tr>
    <td><a href="prop_drivetype.asp">DriveType</a></td>
    <td>Returns the type of a specified drive</td>
  </tr>
  <tr>
    <td><a href="prop_filesystem.asp">FileSystem</a></td>
    <td>Returns the file system in use for a specified drive</td>
  </tr>
  <tr>
    <td><a href="prop_freespace.asp">FreeSpace</a></td>
    <td>Returns the amount of free space to a user on a
      specified drive or network share</td>
  </tr>
  <tr>
    <td><a href="prop_isready.asp">IsReady</a></td>
    <td>Returns true if the specified drive is ready and false if
      not</td>
  </tr>
  <tr>
    <td><a href="prop_path_drive.asp">Path</a></td>
    <td>Returns an uppercase letter followed by a colon that
      indicates the path name for a specified drive</td>
  </tr>
  <tr>
    <td><a href="prop_rootfolder.asp">RootFolder</a></td>
    <td>Returns a Folder object that represents the root folder of a specified
      drive</td>
  </tr>
  <tr>
    <td><a href="prop_serialnumber.asp">SerialNumber</a></td>
    <td>Returns the serial number of a specified drive</td>
  </tr>
  <tr>
    <td><a href="prop_sharename.asp">ShareName</a></td>
    <td>Returns the network share name for a specified drive</td>
  </tr>
  <tr>
    <td><a href="prop_totalsize.asp">TotalSize</a></td>
    <td>Returns the total size of a specified drive or network
      share</td>
  </tr>
  <tr>
    <td><a href="prop_volumename.asp">VolumeName</a></td>
    <td>Sets or returns the volume name of a specified drive</td>
  </tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_drive.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_drive.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_drive.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
