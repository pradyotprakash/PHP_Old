...
<title>ASP GetDrive Method</title>
<style>a.menu_met_getdrive{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetDrive</span> Method</h1>
<hr>
...
<hr>
<p>The GetDrive method returns a Drive object that is specified by the drivespec
parameter.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>drivespec</td>
    <td>Required. Can be a drive letter (c), or a drive letter
      followed by a colon (c:), or a drive letter followed by a colon and path separator
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_getdrive.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_getdrive.asp#top" target="_top">TOP</a> |
		<a href="met_getdrive.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
