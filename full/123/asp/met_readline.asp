...
<title>ASP ReadLine Method</title>
<style>a.menu_met_readline{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">ReadLine</span> Method</h1>
<hr>
...
<hr>
<p>The ReadLine method reads one line from a TextStream file and returns the
...
x=t.ReadLine<br>
t.close <br>
Response.Write(&quot;The first line in the file &quot;)<br>
Response.Write(&quot;contains this text: &quot; &amp; x)<br>
%&gt;<br>
<br>
Output:<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_readline.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_readline.asp#top" target="_top">TOP</a> |
		<a href="met_readline.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
