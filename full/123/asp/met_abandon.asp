...
<title>ASP Abandon Method</title>
<style>a.menu_met_abandon{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Abandon</span> Method</h1>
<hr>
...
<hr>
<p>The Abandon method destroys a user session.</p>

<p><b>Note:</b> When this method is called, the current Session object is not deleted until all of the script
on the current page have been processed. This means that it is possible to access session
variables on the same page as the call to Abandon, but not from another Web page.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_abandon.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_abandon.asp#top" target="_top">TOP</a> |
		<a href="met_abandon.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
