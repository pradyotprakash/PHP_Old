...
<title>ASP Read Method</title>
<style>a.menu_met_read{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Read</span> Method</h1>
<hr>
...
<hr>
<p>The Read method reads a specified number of characters from a TextStream file and returns the
...
<table class="reference notranslate">
  ...
  <tr>
    <td>numchar</td>
    <td>Required. The number of characters to read from the file</td>
  </tr>
</table>
...
x=t.Read(5)<br>
t.close<br>
Response.Write(&quot;The first five characters are: &quot; &amp; x)<br>
%&gt;<br>
<br>
Output:<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_read.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_read.asp#top" target="_top">TOP</a> |
		<a href="met_read.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
