...
<title>Run ASP on Your Computer</title>
<style>a.menu_asp_install{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Run ASP on <span class="color_h1">Your Own PC</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_syntax.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">You can run ASP on your own PC.</p>
<hr>

<h2>Your Windows PC as a Web Server</h2>
<ul>
  <li>Your own PC can act as a web server if you install IIS or PWS</li>
  <li>IIS or PWS turns your computer into a web server</li>
  <li>Microsoft IIS and PWS are free web server components</li>
</ul>
<hr>

<h2>IIS - Internet Information Server</h2>
<p>IIS is a set of Internet-based services for servers created by Microsoft for use with Microsoft Windows.</p>
<p>IIS comes with Windows 2000, XP, Vista, and Windows 7. It is also available for Windows NT.</p>
<p>IIS is easy to install and ideal for developing and testing web applications.</p>
<hr>

<h2>PWS - Personal Web Server</h2>
<p>PWS is for older Windows system like Windows 95, 98, and NT.</p>
<p>PWS is easy to install and can be used for developing and testing web applications including ASP.</p>
<p>We don't recommend running PWS for anything else than training. It is outdated and has security issues.</p>
<hr>

<h2>Windows Web Server Versions</h2>
<ul>
	<li>Windows 7 (all editions) come with IIS 7.5</li>
	<li>Windows Vista Business, Enterprise and Ultimate come with IIS 7</li>
	<li>Windows Vista Home Premium comes with IIS 7</li>
	<li>Windows Vista Home Edition does not support PWS or IIS</li>
	<li>Windows XP Professional comes with IIS 5.1</li>
	<li>Windows XP Home Edition does not support IIS or PWS</li>
	<li>Windows 2000 Professional comes with IIS 5.0</li>
	<li>Windows NT Professional comes with IIS 3 and also supports IIS 4</li>
	<li>Windows NT Workstation supports PWS and IIS 3</li>
	<li>Windows ME does not support PWS or IIS</li>
	<li>Windows 98 comes with PWS</li>
	<li>Windows 95 supports PWS</li>
</ul>
<hr>

<h2>How to Install IIS on Windows 7 and Windows Vista</h2>
<p>Follow these steps to install IIS:</p>
<ol>
	<li>Open the Control Panel from the Start menu</li>
	<li>Double-click Programs and Features</li>
	<li>Click &quot;Turn Windows features on or off&quot; (a link to the left)</li>
	<li>Select the check box for Internet Information Services (IIS), and click 
	OK</li>
</ol>
<p>After you have installed IIS, make sure you install all patches for bugs and security problems. (Run Windows Update).</p>
<hr>

<h2>How to Install IIS on Windows XP and Windows 2000</h2>
<p>Follow these steps to install IIS:</p>
<ol>
	<li>On the Start menu, click Settings and select Control Panel</li>
	<li>Double-click Add or Remove Programs</li>
	<li>Click Add/Remove Windows Components</li>
	<li>Click Internet Information Services (IIS)</li>
	<li>Click Details</li>
	<li>Select the check box for World Wide Web Service, and click OK</li>
	<li>In Windows Component selection, click Next to install IIS</li>
</ol>
<p>After you have installed IIS, make sure you install all patches for bugs and security problems. (Run Windows Update).</p>
<hr>

<h2>Test Your Web</h2>
<p>After you have installed IIS or PWS follow these steps:</p>
<ol>
  <li>Look for a new folder called <b>Inetpub</b> on your hard drive</li>
  <li>Open the Inetpub folder, and find a folder named <b>wwwroot</b></li>
  <li>Create a new folder, like &quot;MyWeb&quot;, under wwwroot</li>
  <li>Write some ASP code and save the file as &quot;test1.asp&quot; in the new folder</li>
  <li>Make sure your Web server is running (see below)</li>
  <li>Open your browser and type &quot;http://localhost/MyWeb/test1.asp&quot;, to 
	view your first web page</li>
</ol>
<p><b>Note:</b> Look for the IIS (or PWS) symbol in your start menu or task bar. The program has functions for starting and stopping the web server,
disable and enable ASP, and much more.</p>
<hr>

<h2>How to install PWS on Windows 95, 98, and Windows NT</h2>
<p>For Windows 98: Open the <b>Add-ons</b> folder on your Windows CD, find the
<b>PWS</b> folder and run <b>setup.exe</b> to install PWS.</p>
<p>For Windows 95 or Windows NT: Download &quot;Windows NT 4.0 Option Pack&quot; from Microsoft, and install PWS.</p>
<p>Test your web as described above.</p>
<hr>

<h2>How to install IIS on Windows Server 2003</h2>
<ol>
  <li>When you start the Windows Server 2003, you should see the <b>Manage Your Server wizard</b></li>
	...
	<li>Now, the wizard may ask for the <b>Server 2003 CD</b>. Insert the CD and let it run until it is finished, then click the Finish button</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_install.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_install.asp#top" target="_top">TOP</a> |
		<a href="asp_install.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
