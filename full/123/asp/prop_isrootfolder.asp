...
<title>ASP IsRootFolder Property</title>
<style>a.menu_prop_isrootfolder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">IsRootFolder</span> Property</h1>
<hr>
...
<hr>
<p>The IsRootFolder property returns true if the specified folder is the root
folder and false if not.</p>
...
if fo.IsRootFolder=true then<br>
&nbsp;&nbsp;Response.Write(&quot;The folder is the root folder!&quot;)<br>
else<br>
&nbsp;&nbsp;Response.Write(&quot;The folder is not the root folder!&quot;)<br>
end if <br>
set fo=nothing<br>
set fs=nothing<br>
%&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_isrootfolder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_isrootfolder.asp#top" target="_top">TOP</a> |
		<a href="prop_isrootfolder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
