...
<title>ASP DeleteFile Method</title>
<style>a.menu_met_deletefile{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">DeleteFile</span> Method</h1>
<hr>
...
<hr>
<p>The DeleteFile method deletes one or more specified files.
</p>

<p><b>Note:</b> An error will occur if you try to delete a file that doesn't exist.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      filename </td>
    <td> Required. The name of the file or files to delete
      (Wildcards are allowed)</td>
  </tr>
  <tr>
    <td>
      force </td>
    <td> Optional. A Boolean value that indicates whether read-only files
      will be deleted. True
      indicates that the read-only files will be deleted, False indicates that they
      will not be deleted. Default is False</td>
  </tr>
</table>
...
fs.CreateTextFile(&quot;c:\test.txt&quot;,True)<br>
if fs.FileExists(&quot;c:\test.txt&quot;) then<br>
&nbsp;&nbsp;fs.DeleteFile(&quot;c:\test.txt&quot;)<br>
end if<br>
set fs=nothing<br>
%>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_deletefile.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_deletefile.asp#top" target="_top">TOP</a> |
		<a href="met_deletefile.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
