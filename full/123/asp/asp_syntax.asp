...
<style>a.menu_asp_syntax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Basic Syntax Rules</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_install.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_variables.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">In our ASP tutorial, every example shows the hidden ASP source code. This will make it easier for you to understand how it works.</p>
<hr>

<h2>Write Output to a Browser</h2>
<p>An ASP file normally contains HTML tags, just like an HTML file. However, an ASP file can also contain server scripts, surrounded by the delimiters &lt;% and %&gt;.</p>
<p>Server scripts are executed on the server,<b> </b>and can contain any expressions, statements, procedures, or operators valid for the scripting language you prefer to use. </p>

<h3>The response.write Command</h3>
<p>The response.write command is used to write output to a browser. The following example sends the text &quot;Hello World&quot; to the browser:</p>
...
<br><a target="_blank" href="showasp.asp?filename=demo_text" class="showbtn">Show Example &raquo;</a>
</div>

<p>There is also a shorthand method for the response.write command. The following example also sends the text &quot;Hello World&quot; to the browser:</p>
...
<br><a target="_blank" href="showasp.asp?filename=demo_text_sh" class="showbtn">Show Example &raquo;</a>
</div>
<br>
<hr>

<h2>Using VBScript in ASP</h2>
<p>You can use several scripting languages in ASP. However, the default scripting language is VBScript:</p>
...
<p>To set JavaScript as the default scripting language for a particular page you must insert a language specification at the top of the page:</p>
...
&lt;/body&gt;<br>
&lt;/html&gt;</div></div>
<p><b>Note:</b> JavaScript is case sensitive! You will have to write your ASP code with uppercase letters and lowercase letters when the language requires it.</p>
<hr>
...
language, like PERL, REXX, or Python, you will have to install script engines for them.</p>
<hr>
...
<p><a target="_blank" href="showasp.asp?filename=demo_formatting">Add some HTML tags to a text</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_install.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_variables.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_syntax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_syntax.asp#top" target="_top">TOP</a> |
		<a href="asp_syntax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
