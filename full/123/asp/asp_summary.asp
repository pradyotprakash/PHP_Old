...
<title>ASP Summary</title>
<style>a.menu_asp_summary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>You Have Learned ASP, <span class="color_h1">Now What?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_quickref.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>ASP Summary</h2>
<p>This tutorial has taught you how to add server-side scripts to your web site, to make 
your web site more dynamic and interactive.</p>
<p>You have learned how to dynamically edit, change or add any content of a web 
...
<p>For more information on ASP, please look at our <a href="asp_examples.asp">
ASP examples</a>.</p>
<hr>
<h2>Now You Know ASP, What's Next?</h2>
<p>The next step is to learn SQL and ADO.</p>
<p><b>SQL</b></p>
<p>SQL is a standard computer language for accessing and manipulating database 
systems.</p>
<p>SQL statements are used to retrieve and update data in a database. SQL works 
with database programs like MS Access, DB2, Informix, MS SQL Server, Oracle, 
Sybase, and other database systems.</p>
<p>If you want to learn more about SQL, please 
visit our <a href="../sql/default.asp">SQL tutorial</a>.</p>
<p><b>ADO</b></p>
<p>ADO is a programming interface to access data in a database from a web site.</p>
<p>ADO uses SQL to query data in a database.</p>
<p>If you want to learn more about ADO, please 
visit our <a href="../ado/default.asp">ADO tutorial</a>.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_summary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_summary.asp#top" target="_top">TOP</a> |
		<a href="asp_summary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
