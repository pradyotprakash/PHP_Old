...
<style>a.menu_asp_ajax_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_contentrotator.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ajax_asp.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<p class="intro">AJAX is about updating parts of a web page, without reloading the whole page.</p>
<hr>
...
<p>Classic web pages, (which do not use AJAX) must reload the entire page if the 
content should change.</p>
<p>Examples of applications using AJAX: Google Maps, Gmail, Youtube, and 
Facebook tabs.</p>
<hr>

<h2>How AJAX Works</h2>
<p><img alt="AJAX" src="ajax.gif" width="569" height="324" /></p>
<hr>
...
<td>AJAX applications are browser- and platform-independent!</td>
</tr></table>
<br>
<hr>
...
<p><a target="_blank" href="http://www.google.com/">Google Suggest</a> 
...
<p>In our ASP tutorial, we will demonstrate how AJAX can update parts of a web 
page, without reloading the whole page. The server script will be written in ASP.</p>
<p>If you want to learn more about AJAX, visit our <a href="../ajax/default.asp">AJAX tutorial</a>.</p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ajax_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ajax_intro.asp#top" target="_top">TOP</a> |
		<a href="asp_ajax_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
