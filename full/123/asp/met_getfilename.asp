...
<title>ASP GetFileName Method</title>
<style>a.menu_met_getfilename{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetFileName</span> Method</h1>
<hr>
...
<hr>
<p>The GetFileName method returns a string that contains the file name or folder
...
<table class="reference notranslate">
  ...
  <tr>
    <td>path</td>
    <td>Required. The path to a specific file or folder</td>
  </tr>
</table>
<br>
<hr>
...
p=fs.getfilename(&quot;c:\test\test.htm&quot;)<br>
response.write(p)<br>
set fs=nothing<br>
%&gt;<br>
<br>
...
<p>Get a foldername:</p>
<div class="code notranslate"><div>

&lt;%<br>
dim fs,p<br>
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)<br>
p=fs.getfilename(&quot;c:\test\&quot;)<br>
response.write(p)<br>
set fs=nothing<br>
%&gt;<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_getfilename.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_getfilename.asp#top" target="_top">TOP</a> |
		<a href="met_getfilename.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
