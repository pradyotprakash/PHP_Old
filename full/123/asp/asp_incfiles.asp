...
<style>a.menu_asp_incfiles{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Including Files</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_applications.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_globalasa.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>The #include Directive</h2>
<p>You can insert the content of one ASP file into another ASP file before the
server executes it, with the #include directive.</p>
<p>The #include directive is used to create functions, headers, footers, or 
elements that will be reused on multiple pages.</p>
<hr>
...
<div class="code notranslate"><div>
&lt;!-- #include file =&quot;headers\header.inc&quot; --></div></div>
...
<p>In the sections above we have used the file extension ".inc" for included files. Notice that if a user tries to browse an INC file directly,
...
and one ASP file can include the same file more than once.</p>
<p><b>Important:</b> Included files are processed and inserted before the scripts are executed. The following script will NOT work because ASP executes the 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_incfiles.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_incfiles.asp#top" target="_top">TOP</a> |
		<a href="asp_incfiles.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
