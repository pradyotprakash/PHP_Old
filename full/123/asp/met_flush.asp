...
<title>ASP Flush Method</title>
<style>a.menu_met_flush{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Flush</span> Method</h1>
<hr>
...
<hr>
<p>The Flush method sends buffered HTML output immediately.</p>

<p><b>Note:</b> If response.Buffer is false, this method will cause a run-time
error.</p>
...
&lt;html&gt;<br>
&lt;body&gt;<br>
&lt;p&gt;I write some text, but I will control when the<br>
text will be sent to the browser.&lt;/p&gt;<br>
...
Output:<br>
<br>
I write some text, but I will control when the<br>
text will be sent to the browser.<br>
<br>
The text is not sent yet. I hold it back!<br>
<br>
OK, let it go!
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_flush.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_flush.asp#top" target="_top">TOP</a> |
		<a href="met_flush.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
