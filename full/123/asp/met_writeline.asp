...
<title>ASP WriteLine Method</title>
<style>a.menu_met_writeline{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">WriteLine</span> Method</h1>
<hr>
...
<hr>
<p>The WriteLine method writes a specified text and a new-line character to a TextStream file.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>text </td>
    <td>Optional. The text to write to the file. If you do not
      specify this parameter, a new-line character will be written to the file</td>
  </tr>
</table>
...
f.WriteLine(&quot;How are you today?&quot;)<br>
f.WriteLine(&quot;Goodbye!&quot;)<br>
f.close<br>
set f=nothing<br>
set fs=nothing<br>
%&gt;<br>
<br>
The file test.txt will look like this after executing the code above:<br>
<br>
Hello World!<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_writeline.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_writeline.asp#top" target="_top">TOP</a> |
		<a href="met_writeline.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
