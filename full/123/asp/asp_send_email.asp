...
<title>ASP Sending e-mail with CDOSYS</title>
<style>a.menu_asp_send_email{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Sending e-mail</span> with <span class="color_h1">CDOSYS</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_globalasa.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_response.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">CDOSYS is a built-in component in ASP. This component is used to send e-mails with ASP.</p>
<hr>
<h2>Sending e-mail with CDOSYS</h2>
<p>CDO (Collaboration Data Objects) is a Microsoft technology that is designed to simplify the creation of messaging applications.</p>
<p>CDOSYS is a built-in component in ASP. We will show you how to use this component to send e-mail with ASP.</p>

<h2>How about CDONTs?</h2>
<p>Microsoft has discontinued the use of CDONTs on Windows 2000, Windows XP and Windows 2003. If you have used CDONTs in your ASP applications, you should 
update the code and use the new CDO technology.</p>

<h2>Examples using CDOSYS</h2>
<p>Sending a text e-mail:</p>
...
<p>Sending a text e-mail with Bcc and CC fields:</p>
...
<p>Sending an HTML e-mail that sends a webpage from a website:</p>
...
<p>Sending an HTML e-mail that sends a webpage from a file on your computer:</p>
...
<p>Sending a text e-mail with an Attachment:</p>
...
<p>Sending a text e-mail using a remote server:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_send_email.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_send_email.asp#top" target="_top">TOP</a> |
		<a href="asp_send_email.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
