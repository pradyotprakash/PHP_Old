...
<title>ASP CreateObject Method</title>
<style>a.menu_met_createobject_server{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">CreateObject</span> Method</h1>
<hr>
...
<hr>
<p>The CreateObject method creates an instance of an object.&nbsp;
</p>

<p><b>Note:</b> Objects created with this method have page scope. They are destroyed
...
<table class="reference notranslate">
  ...
  <tr>
    <td>progID </td>
    <td> Required. The type of object to create</td>
  </tr>
</table>
<br>
<hr>
<h3>Example 1</h3>
<p>This example creates an instance of the server component MSWC.AdRotator:</p>
<div class="code notranslate"><div>
...
<h3>Example 2</h3>
<p>An object stored in a session variable is destroyed when the session
...
<br>
&lt;%<br>
Session("ad")=&quot;a new value"<br>
%>

</div></div>
<h3>Example 3</h3>
<p>You cannot create an instance of an object with the same name as a built-in
object:</p>
<div class="code notranslate"><div>

&lt;%<br>
Set Application=Server.CreateObject(&quot;Application")<br>
%>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_createobject_server.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_createobject_server.asp#top" target="_top">TOP</a> |
		<a href="met_createobject_server.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
