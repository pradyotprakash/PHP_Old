...
<style>a.menu_asp_ref_error{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">ASPError</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_server.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_filesystem.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The ASPError object displays information about errors in scripts.</p>
<hr>

<h2>The ASPError Object</h2>
<p>The ASPError object was implemented in ASP 3.0 and is available in IIS5 and later.</p>
<p>The ASPError object is used to display detailed information of any error that occurs
in scripts in an ASP page.</p>
<p><b>Note:</b> The ASPError object is created when Server.GetLastError is
called, so the error information can only be accessed by using the Server.GetLastError method.</p>
<p>The ASPError object's properties are described below (all properties are read-only):</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns the source of the error (was the error generated by ASP? By a scripting language? By an object?)</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="prop_asperrorobject.asp">Source</a></td>
    <td>Returns the actual source code of the line where the error occurred</td>
  </tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_error.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_error.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_error.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
