...
<title>ASP - AJAX and ASP</title>
<style>a.menu_asp_ajax_asp{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP - <span class="color_h1">AJAX and ASP</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ajax_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ajax_database.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<form action="asp_ajax_asp.asp"> 
First name: <input type="text" id="txt1" onkeyup="showHint(this.value)" />
</form>
<p>Suggestions: <span id="txtHint"></span></p> 
</div>
<br>
<a target="_blank" href="../ajax/tryit.asp?filename=tryajax_suggest" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
...
%&gt;</div></div>
<p>Explanation: If there is any text sent from the JavaScript (strlen($q) &gt; 0), the following happens:</p>
<ol>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ajax_asp.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ajax_asp.asp#top" target="_top">TOP</a> |
		<a href="asp_ajax_asp.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
