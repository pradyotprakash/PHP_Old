...
<title>ASP ParentFolder Property</title>
<style>a.menu_prop_parentfolder_folder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">ParentFolder</span> Property</h1>
<hr>
...
<hr>
<p>The ParentFolder property is used to return the folder object for the parent 
of the specified file or folder.</p>

<h3>Syntax</h3>

<div class="code notranslate"><div>

FileObject.ParentFolder<br>
<br>
...
set f=fs.GetFile(&quot;c:\asp\test\test.asp&quot;)<br>
Response.Write(&quot;The file test.asp is in the folder: &quot;)<br>
Response.Write(f.ParentFolder)<br>
set f=nothing<br>
set fs=nothing<br>
%&gt;<br>
<br>
...
dim fs,fo<br>
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)<br>
set fo=fs.GetFolder(&quot;c:\asp\test&quot;)<br>
Response.Write(&quot;The folder test is in the folder: &quot;)<br>
Response.Write(fo.ParentFolder)<br>
set fo=nothing<br>
set fs=nothing<br>
%&gt;<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_parentfolder_folder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_parentfolder_folder.asp#top" target="_top">TOP</a> |
		<a href="prop_parentfolder_folder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
