...
<title>ASP IsClientConnected Property</title>
<style>a.menu_prop_isclientconnected{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">IsClientConnected</span> Property</h1>
<hr>
...
<hr>
<p>The IsClientConnected property indicates if the client has disconnected from the server.</p>
...
&lt;%<br>
If response.IsClientConnected=true then<br>
&nbsp;&nbsp;response.write(&quot;The user is still connected!&quot;)<br>
else<br>
&nbsp;&nbsp;response.write(&quot;The user is not connected!&quot;)<br>
end if<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_isclientconnected.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_isclientconnected.asp#top" target="_top">TOP</a> |
		<a href="prop_isclientconnected.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
