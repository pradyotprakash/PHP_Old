...
<title>ASP Transfer Method</title>
<style>a.menu_met_transfer{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Transfer</span> Method</h1>
<hr>
...
<hr>
<p>The Transfer method sends (transfers) all the state information (all
application/session variables and all items in the request collections) created
in one ASP file to a second ASP file.
</p>

<p>When the second ASP page completes its tasks, it will NOT return to the first
ASP page (like the Execute method).
</p>

<p><b>Note:</b> The Transfer method is an efficient alternate for the Response.Redirect.
...
<table class="reference notranslate">
  ...
  <tr>
    <td>path</td>
    <td>Required. The location of the ASP file to which control should be
      transferred</td>
  </tr>
</table>
...
<br>
&lt;%<br>
response.write(&quot;Line 1 in File 1&lt;br>&quot;)<br>
Server.Transfer(&quot;file2.asp&quot;)<br>
response.write(&quot;Line 2 in File 1&lt;br>&quot;)<br>
%&gt;<br>
<br>
File2.asp:<br>
<br>
&lt;%<br>
response.write(&quot;Line 1 in File 2&lt;br>&quot;)<br>
response.write(&quot;Line 2 in File 2&lt;br>&quot;)<br>
%&gt;<br>
<br>
Output:<br>
<br>
...
<p>Also look at the Server.Execute method to see the difference between the
Server.Transfer and Server.Execute methods.</p>
<hr>
<a href="asp_ref_server.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Server Object Reference" /> Complete Server Object Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_transfer.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_transfer.asp#top" target="_top">TOP</a> |
		<a href="met_transfer.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
