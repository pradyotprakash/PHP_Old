...
<style>a.menu_asp_cookies{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Cookies</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_inputforms.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_sessions.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>In the example below, we will create a cookie named &quot;firstname&quot; and assign the value &quot;Alex&quot; to it:</p>
...
<p>It is also possible to assign properties to a cookie, like setting a date when the cookie should expire:</p>
...
<p>In the example below, we retrieve the value of the cookie named &quot;firstname&quot; and display it on a page:</p>
...
<p><b>Output:</b> Firstname=Alex</p>
<hr>

<h2>A Cookie with Keys</h2>
<p>If a cookie contains a collection of multiple values, we say that the cookie has Keys.</p>
<p>In the example below, we will create a cookie collection named &quot;user&quot;.
The &quot;user&quot; cookie has Keys that contains information about a user:</p>
...
how to do it (note that the code below checks if a cookie has Keys with the HasKeys property):</p>
...
<h3>2. Use a form</h3>
<p>You can use a form. The form passes the user input to &quot;welcome.asp&quot; when the user clicks on the Submit button:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_cookies.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_cookies.asp#top" target="_top">TOP</a> |
		<a href="asp_cookies.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
