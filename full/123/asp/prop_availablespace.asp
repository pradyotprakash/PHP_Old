...
<title>ASP AvailableSpace Property</title>
<style>a.menu_prop_availablespace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">AvailableSpace</span> Property</h1>
<hr>
...
<hr>
<p>The AvailableSpace property returns the amount of available space to a user on
the specified drive or network share.</p>

<p><b>Note:</b> The value returned is often equal to the value returned
by the FreeSpace property.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_availablespace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_availablespace.asp#top" target="_top">TOP</a> |
		<a href="prop_availablespace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
