...
<title>ASP Cookies Collection</title>
<style>a.menu_coll_cookies_response{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Cookies</span> Collection</h1>
<hr>
...
<hr>
<p>The Cookies collection is used to set or get cookie values. If the cookie
does not exist, it will be created, and take the value that is specified.</p>
...
Response.Cookies(name)[(key)|.attribute]=value<br>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name </td>
    <td> Required. The name of the cookie</td>
  </tr>
  <tr>
    <td>value </td>
    <td> Required for the Response.Cookies command. The value of the cookie</td>
  </tr>
  <tr>
    <td>attribute </td>
    <td> Optional. Specifies information about the cookie. Can be one of the following parameters:&nbsp;
      <ul>
        <li>Domain -&nbsp; Write-only. The cookie is sent only to requests to
          this domain</li>
        <li>Expires - Write-only. The date when the cookie expires. If no date is specified, the cookie will expire when the session
          ends</li>
        <li>HasKeys - Read-only. Specifies whether the cookie has keys (This is
          the only attribute that can be used with the Request.Cookies command)</li>
        <li>Path - Write-only. If set, the cookie is sent only to requests to this path. If
          not set, the application path is used</li>
        <li>Secure - Write-only. Indicates if the cookie is secure</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td>key </td>
    <td> Optional. Specifies the key to where the value is assigned</td>
  </tr>
</table>
<br>
<hr>
<h2>Examples</h2>
<p>The &quot;Response.Cookies&quot; command is used to create a cookie or to set
a cookie value:</p>
...
<p>In the code above, we have created a cookie named &quot;firstname&quot; and assigned
the value &quot;Alex&quot; to it.</p>
<p>It is also possible to assign some attributes to a cookie, like setting a
date when a cookie should expire:</p>
<div class="code notranslate"><div>
...
and it will expire from the user's computer at May 10, 2002.</p>
<p>The &quot;Request.Cookies&quot; command is used to get a cookie value.</p>
<p>In the example below, we retrieve the value of the cookie &quot;firstname&quot;
...
<p>A cookie can also contain a collection of multiple values. We say that the
cookie has Keys.</p>
...
<p>The code below reads all the cookies your server has sent to a user. Note
that the code checks if a cookie has Keys with the HasKeys property:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="coll_cookies_response.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="coll_cookies_response.asp#top" target="_top">TOP</a> |
		<a href="coll_cookies_response.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
