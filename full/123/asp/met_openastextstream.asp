...
<title>ASP OpenAsTextStream Method</title>
<style>a.menu_met_openastextstream{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">OpenAsTextStream</span> Method</h1>
<hr>
<a href="asp_ref_file.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="File Object Reference" /> Complete File Object Reference</a>
<hr>
<p>The OpenAsTextStream method opens the specified file and returns a TextStream object to access the file.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>mode </td>
    <td>Optional. How to open the file.<ul>
      <li>1 = ForReading - Open a file for reading. You cannot write to this file</li>
      <li>2 = ForWriting - Open a file for writing</li>
      <li>8 = ForAppending - Open a file and write to the end of the file</li>
    </ul>
    </td>
  </tr>
  <tr>
    <td>format </td>
    <td>Optional. The format of the file.<ul>
      <li>0 = TristateFalse - Default. Open the file as ASCII</li>
      <li>-1 = TristateTrue - Open the file as Unicode</li>
      <li>-2 = TristateUseDefault - Open the file using the system default&nbsp;</li>
    </ul>
    </td>
  </tr>
</table>
...
Set ts=f.OpenAsTextStream(ForWriting)<br>
ts.Write(&quot;Hello World!&quot;)<br>
ts.Close<br>
<br>
Set ts=f.OpenAsTextStream(ForReading)<br>
Response.Write(ts.ReadAll)<br>
ts.Close<br>
set ts=nothing<br>
set f=nothing<br>
set fs=nothing<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_openastextstream.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_openastextstream.asp#top" target="_top">TOP</a> |
		<a href="met_openastextstream.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
