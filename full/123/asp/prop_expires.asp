...
<title>ASP Expires Property</title>
<style>a.menu_prop_expires{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Expires</span> Property</h1>
<hr>
...
<hr>
<p>The Expires property sets how long (in minutes) a page will be cached on a
browser before it expires. If a user returns to the same page before it expires, the cached version is displayed.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>number</td>
    <td>The time in minutes before the page expires</td>
  </tr>
</table>
<h2>Examples</h2>
<h3>Example 1</h3>
<p>The following code indicates that the page will never be cached:</p>
<div class="code notranslate"><div>
...
<h3>Example 2</h3>
<p>The following code indicates that the page will expire after 1440 minutes (24
hours):</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_expires.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_expires.asp#top" target="_top">TOP</a> |
		<a href="prop_expires.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
