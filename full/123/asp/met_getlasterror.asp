...
<title>ASP GetLastError Method</title>
<style>a.menu_met_getlasterror{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetLastError()</span> Method (ASP 3.0)</h1>
<hr>
<a href="asp_ref_server.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Server Object Reference" /> Complete Server Object Reference</a>
<hr>
<p>The GetLastError method returns an ASPError object that describes the error condition that occurred.</p>

<p>By default, a Web site uses the file \iishelp\common\500-100.asp for
processing ASP errors. You can either use this file, or create your own. If you want to change the
ASP file for processing the 500;100 custom errors you can use the IIS snap-in.</p>

<p><b>Note:</b>   A 500;100 custom error will be generated if IIS encounters an error while processing
either an ASP file or the application's Global.asa file.&nbsp;</p>

<p><b>Note:</b> This method is available only before the ASP file has sent any content to the
browser.</p>
...
<p>In the example an error will occur when IIS tries to include the file, because the include statement is missing the file parameter:</p>

<div class="code notranslate"><div>

&lt;!--#include f=&quot;header.inc&quot; --><br>
&lt;%<br>
...
<p>In this example an error will occur when compiling the script, because the
&quot;next&quot; keyword is missing:</p>
...
<p>In this example an error will occur because the script attempts to divide by
0:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_getlasterror.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_getlasterror.asp#top" target="_top">TOP</a> |
		<a href="met_getlasterror.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
