...
<title>ASP GetFolder Method</title>
<style>a.menu_met_getfolder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetFolder</span> Method</h1>
<hr>
...
<hr>
<p>The GetFolder method returns a Folder object for the specified path.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>path</td>
    <td>Required. The path to a specific folder</td>
  </tr>
</table>
...
set f=fs.GetFolder(&quot;c:\test\&quot;)<br>
Response.Write(&quot;The folder was last modified on: &quot;)<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_getfolder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_getfolder.asp#top" target="_top">TOP</a> |
		<a href="met_getfolder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
