...
<title>ASP Timeout Property</title>
<style>a.menu_prop_timeout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Timeout</span> Property</h1>
...
<hr>
<p>The Timeout property sets or returns the timeout period for the Session object for this application, in minutes. If the user does not refresh or request a page within the timeout period, the session
will end.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>nMinutes </td>
    <td> The number of minutes a session can remain idle before the server terminates it.
    Default is 20 minutes</td>
  </tr>
</table>
<h3>Examples</h3>
<div class="code notranslate"><div>
...
<br>
response.write(&quot;&lt;p&gt;&quot;)<br>
response.write(&quot;Timeout is now: &quot; &amp; Session.Timeout)<br>
response.write(&quot;&lt;/p&gt;&quot;)<br>
%&gt;<br>
<br>
Output:<br>
<br>
Default Timeout is: 20<br>
<br>
Timeout is now: 30
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_timeout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_timeout.asp#top" target="_top">TOP</a> |
		<a href="prop_timeout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
