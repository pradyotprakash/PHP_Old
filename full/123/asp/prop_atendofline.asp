...
<title>ASP AtEndOfLine Property</title>
<style>a.menu_prop_atendofline{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">AtEndOfLine</span> Property</h1>
<hr>
...
<hr>
<p>The AtEndOfLine property returns a Boolean value. True indicates that the file pointer is
positioned immediately before the end-of-line marker in a TextStream file. Otherwise,
it returns False.</p>

<p><b>Note:</b>  This property will only work on a TextStream object that are open for reading.</p>
...
do while t.AtEndOfLine&lt;&gt;true<br>
&nbsp;&nbsp;x=t.Read(1)<br>
loop<br>
t.close<br>
Response.Write(&quot;The last character is: &quot; &amp; x)<br>
%&gt;<br>
<br>
Output:<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_atendofline.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_atendofline.asp#top" target="_top">TOP</a> |
		<a href="prop_atendofline.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
