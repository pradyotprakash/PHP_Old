...
<style>a.menu_asp_ref_application{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_request.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_session.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>An application on the Web may consists of several ASP files that work together to perform some purpose.
The Application object is used to tie these files together.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="met_contents_remove_app.asp">Contents.Remove</a></td>
    <td>Deletes an item from the Contents collection</td>
  </tr>
  <tr>
    <td><a href="met_contents_removeall_app.asp">Contents.RemoveAll()</a></td>
    <td>Deletes all items from the Contents collection</td>
  </tr>
  <tr>
    <td><a href="met_lock_unlock.asp">Lock</a></td>
    <td>Prevents other users from modifying the variables in the
      Application object</td>
  </tr>
  <tr>
    <td><a href="met_lock_unlock.asp">Unlock</a></td>
    <td>Enables other users to modify the variables in the Application object
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_application.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_application.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_application.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
