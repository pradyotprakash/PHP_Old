...
<title>ASP Buffer Property</title>
<style>a.menu_prop_buffer{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Buffer</span> Property</h1>
<hr>
...
<hr>
<p>The Buffer property specifies whether to buffer the output or not. When the
...
<p><b>Note:</b> If this property is set, it should be before the &lt;html&gt;
tag in the .asp file</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>flag </td>
    <td> A boolean value that specifies whether to buffer the page
      output or not.<p>False indicates no buffering. The server will send the output
      as it is processed. False is
      default for IIS version 4.0 (and earlier). Default for IIS version 5.0 (and
      later) is true.</p>
      <p>True indicates buffering. The server will not send output until all of the
...
<h2>Examples</h2>
<h3>Example 1</h3>
<p>In this example, there will be no output sent to the browser before the loop
is finished. If buffer was set to False, then it would write a line to the browser every time it went through the loop.</p>
<div class="code notranslate"><div>
...
&lt;html&gt;<br>
&lt;body&gt;<br>
&lt;p&gt;I write some text, but I will control when<br>
the text will be sent to the browser.&lt;/p&gt;<br>
&lt;p&gt;The text is not sent yet. I hold it back!&lt;/p&gt;<br>
&lt;p&gt;OK, let it go!&lt;/p&gt;<br>
&lt;%response.Flush%&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;
...
&lt;html&gt;<br>
&lt;body&gt;<br>
&lt;p&gt;This is some text I want to send to the user.&lt;/p&gt;<br>
&lt;p&gt;No, I changed my mind. I want to clear the text.&lt;/p&gt;<br>
&lt;%response.Clear%&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_buffer.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_buffer.asp#top" target="_top">TOP</a> |
		<a href="prop_buffer.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
