...
<title>ASP Move Method</title>
<style>a.menu_met_move_folder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Move</span> Method</h1>
<hr>
...
<hr>
<p>The Move method moves the specified file or folder from one location to 
another.</p>
...
FileObject.Move(destination)<br>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>destination</td>
    <td> Required. Where to move the file or folder. Wildcard 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_move_folder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_move_folder.asp#top" target="_top">TOP</a> |
		<a href="met_move_folder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
