...
<style>a.menu_asp_contentlinking{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Content Linking</span> Component</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_browser.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_contentrotator.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<div class="tryit_ex">
...
<p><a target="_blank" href="showaspfile.asp?filename=demo_contentlinking">The Content Linking Component</a><br>
Build a table of contents.</p>

<p><a target="_blank" href="showaspfile.asp?filename=demo_contentlinking2">The Content Linking Component 2</a><br>
Use the Content Linking Component to navigate between the pages in a text file.</p>
<hr>

<h2>ASP Content Linking Component</h2>
<p>The ASP Content Linking component is used to create a quick and easy navigation system!</p>
<p>The Content Linking component returns a Nextlink object that is used to hold a list of Web pages to be navigated.</p>
...
<p>First we create a text file - &quot;links.txt&quot;:</p>

<div class="code notranslate"><div>
asp_intro.asp	ASP Intro<br>
asp_syntax.asp	ASP Syntax<br>
asp_variables.asp	ASP Variables<br>
asp_procedures.asp	ASP Procedures
</div></div>

<p>The text file above contains the pages to be navigated. The pages must be listed in the same order you want them to be 
displayed, and it must also contain a description for each file name (use the tab key to separate file name from description).</p>
<p><b>Note:</b> If you want to add a page, or change the order of the pages in the list; you only have to 
modify the text file! The navigation will automatically be corrected!</p>
<p>Then we create an include file, &quot;nlcode.inc&quot;. The .inc file creates 
a NextLink object to navigate between the pages listed in &quot;links.txt&quot;.</p>
<p>&quot;nlcode.inc&quot;:</p>
...
<p>In each of the .asp pages listed in the text file &quot;links.txt&quot;, put one line of code: 
<b>&lt;!-- #include file=&quot;nlcode.inc&quot;--&gt;</b>. This line will include the code in
&quot;nlcode.inc&quot; on every page listed in &quot;links.txt&quot; and the navigation will work.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_contentlinking.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_contentlinking.asp#top" target="_top">TOP</a> |
		<a href="asp_contentlinking.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
