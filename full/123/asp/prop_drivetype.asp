...
<title>ASP DriveType Property</title>
<style>a.menu_prop_drivetype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">DriveType</span> Property</h1>
<hr>
...
<hr>
<p>The DriveType property returns a value that indicates the type of a specified drive.</p>
<p>This property can return one of the following values:</p>
<ul>
  <li>0 = unknown</li>
  <li>1 = removable</li>
  <li>2 = fixed</li>
...
set d=fs.GetDrive(&quot;a:&quot;)<br>
Response.Write(&quot;The drive type is: &quot; &amp; d.DriveType)<br>
set d=nothing<br>
set fs=nothing<br>
%&gt;<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_drivetype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_drivetype.asp#top" target="_top">TOP</a> |
		<a href="prop_drivetype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
