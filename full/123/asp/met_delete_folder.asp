...
<title>ASP Delete Method</title>
<style>a.menu_met_delete_folder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Delete</span> Method</h1>
<hr>
...
<hr>
<p>The Delete method deletes a specified file or folder.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>force</td>
    <td>Optional. A Boolean value that indicates whether a read-only file or folder are 
    to be deleted. True indicates that a read-only file/folder will be deleted and false indicates that
    it will not be deleted. Default is false.</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_delete_folder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_delete_folder.asp#top" target="_top">TOP</a> |
		<a href="met_delete_folder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
