...
<title>ASP FolderExists Method</title>
<style>a.menu_met_folderexists{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">FolderExists</span> Method</h1>
<hr>
...
<hr>
<p>The FolderExists method returns a Boolean value that indicates whether a
specified folder exists. It returns True if the folder exists and False if not.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      foldername </td>
    <td> Required. The name of the folder to check if exist</td>
  </tr>
</table>
...
if fs.FolderExists(&quot;c:\asp&quot;)=true then<br>
&nbsp;&nbsp;response.write(&quot;Folder c:\asp exists!&quot;)<br>
else<br>
&nbsp;&nbsp;response.write(&quot;Folder c:\asp does not exist!&quot;)<br>
end if<br>
set fs=nothing<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_folderexists.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_folderexists.asp#top" target="_top">TOP</a> |
		<a href="met_folderexists.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
