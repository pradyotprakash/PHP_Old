...
<title>ASP Ad Rotator</title>
<style>a.menu_asp_adrotator{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">AdRotator</span> Component</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ado.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_browser.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>ASP AdRotator Component</h2>
<p>The ASP AdRotator component creates an AdRotator object that displays a different image each time a user enters or refreshes a page. A
text file includes information about the images.</p>
<p><strong>Note:</strong> The AdRotator does not work with Internet Information Server 7 (IIS7).</p>
...
<p>Assume that we have the following text file, named &quot;ads.txt&quot;:</p>
...
Free Tutorials from W3Schools<br>
50<br>
xmlspy.gif<br>
...
<p>The lines below the asterisk in the text file above specifies the name of the images (ads) to be displayed, the
hyperlink addresses, the alternate text (for the images), and the display rates (in percent).</p>
<p>The first line in the text file above specifies what to happen when a visitor clicks on one of the images.
The redirection page (banners.asp) will receive a querystring with the URL to redirect to.</p>
<p><b>Tip:</b> To specify the height, width, and border of the image, you can insert the following lines under REDIRECT:</p>
...
<p>The &quot;banners.asp&quot; file looks like this:</p>
...
<br>
<a target="_blank" href="showaspfile.asp?filename=demo_adrotator" class="showbtn">Show Example &raquo;</a>
</div>
<p>That's all!!</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>Border</td>
    <td>Specifies the size of the borders around the advertisement</td>
    <td>&lt;%<br>
  ...
  <tr>
    <td>Clickable</td>
    <td>Specifies whether the advertisement is a hyperlink</td>
    <td>&lt;%<br>
    set adrot=Server.CreateObject(&quot;MSWC.AdRotator&quot;)<br>
  ...
  <tr>
    <td>TargetFrame</td>
    <td>Name of the frame to display the advertisement</td>
    <td>&lt;%<br>
    set adrot=Server.CreateObject(&quot;MSWC.AdRotator&quot;)<br>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns HTML that displays the advertisement in the page</td>
    <td>&lt;%<br>
    set adrot=Server.CreateObject(&quot;MSWC.AdRotator&quot;)<br>
    Response.Write(adrot.GetAdvertisement(&quot;ads.txt&quot;))<br>
    %&gt;</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_adrotator.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_adrotator.asp#top" target="_top">TOP</a> |
		<a href="asp_adrotator.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
