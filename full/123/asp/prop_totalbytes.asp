...
<title>ASP TotalBytes Property</title>
<style>a.menu_prop_totalbytes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">TotalBytes</span> Property</h1>
<hr>
...
<hr>
<p>The TotalBytes property is a read-only property that returns the total number of bytes the client sent in the body of the request.</p>
...
<p>The following code sets the variable a equal to the total number of bytes
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_totalbytes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_totalbytes.asp#top" target="_top">TOP</a> |
		<a href="prop_totalbytes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
