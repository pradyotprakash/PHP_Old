...
<style>a.menu_asp_ref_folder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Folder</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_file.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_dictionary.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The Folder Object is used to return information about a specified folder.</p>
<hr>
...
object and then instantiate the Folder object through the GetFolder method of the FileSystemObject object.</p>
<p>The following code uses the GetFolder method of the FileSystemObject object to instantiate the Folder object
and the DateCreated property to return the date when the specified folder was created:</p>
...
%&gt;<br><br>
Output:<br><br>
Folder created: 10/22/2008 10:01:19 AM</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns a collection of all the files in a
      specified folder</td>
  </tr>
  <tr>
    <td><a href="coll_subfolders.asp">SubFolders</a></td>
    <td>Returns a collection of all subfolders in a specified folder</td>
  </tr>
  </table>
<h3>Properties</h3>
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Sets or returns the attributes of a specified folder</td>
  </tr>
  <tr>
    <td><a href="prop_datecreated_folder.asp">DateCreated</a></td>
    <td>Returns the date and time when a specified folder was created</td>
  </tr>
  <tr>
    <td><a href="prop_datelastaccessed_folder.asp">DateLastAccessed</a></td>
    <td>Returns the date and time when a specified folder was last accessed</td>
  </tr>
  <tr>
    <td><a href="prop_datelastmodified_folder.asp">DateLastModified</a></td>
    <td>Returns the date and time when a specified folder was last modified</td>
  </tr>
  <tr>
    <td><a href="prop_drive_folder.asp">Drive</a></td>
    <td>Returns the drive letter of the drive where the specified 
    folder resides</td>
  </tr>
  <tr>
    <td><a href="prop_isrootfolder.asp">IsRootFolder</a></td>
    <td>Returns true if a folder is the root
      folder and false if not</td>
  </tr>
  <tr>
    <td><a href="prop_name_folder.asp">Name</a></td>
    <td>Sets or returns the name of a specified folder</td>
  </tr>
  <tr>
    <td><a href="prop_parentfolder_folder.asp">ParentFolder</a></td>
    <td>Returns the parent folder of a specified folder</td>
  </tr>
  <tr>
    <td><a href="prop_path_folder.asp">Path</a></td>
    <td>Returns the path for a specified folder</td>
  </tr>
  <tr>
    <td><a href="prop_shortname_folder.asp">ShortName</a></td>
    <td>Returns the short name of a specified folder (the 8.3 naming convention)</td>
  </tr>
  <tr>
    <td><a href="prop_shortpath_folder.asp">ShortPath</a></td>
    <td>Returns the short path of a specified folder (the 8.3 naming convention)</td>
  </tr>
  <tr>
    <td><a href="prop_size_folder.asp">Size</a></td>
    <td>Returns the size of a specified folder</td>
  </tr>
  <tr>
    <td><a href="prop_type_folder.asp">Type</a></td>
    <td>Returns the type of a specified folder</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Copies a specified folder from one location to another</td>
  </tr>
  <tr>
    <td><a href="met_delete_folder.asp">Delete</a></td>
    <td>Deletes a specified folder</td>
  </tr>
  <tr>
    <td><a href="met_move_folder.asp">Move</a></td>
    <td>Moves a specified folder from one location to another</td>
  </tr>
  <tr>
    <td><a href="met_createtextfile_folder.asp">CreateTextFile</a></td>
    <td>Creates a new text file in the specified folder and returns a TextStream object to
      access the
      file</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_folder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_folder.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_folder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
