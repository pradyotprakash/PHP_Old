...
<title>ASP CreateTextFile Method</title>
<style>a.menu_met_createtextfile_filesystem{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">CreateTextFile</span> Method</h1>
<hr>
<a href="asp_ref_filesystem.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="FileSystemObject Object Reference" /> Complete FileSystemObject Object Reference</a>
<hr>
<p>The CreateTextFile method creates a new text file in the current folder and returns a TextStream object that can be used to read from, or write to the file.
</p>
...
FileSystemObject.CreateTextFile(filename[,overwrite[,unicode]])<br>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      filename </td>
    <td> Required. The name of the file to create</td>
  </tr>
  <tr>
    <td>overwrite </td>
    <td>Optional. A Boolean value that indicates whether an existing file can be overwritten.
      True indicates that the file can be overwritten and False indicates that the
      file can not be overwritten. Default is True</td>
  </tr>
  <tr>
    <td>unicode </td>
    <td>Optional. A Boolean value that indicates whether the file is created as a Unicode or
      an ASCII file.
      True indicates that the file is created as a Unicode file, False indicates
      that the file is created as an ASCII file. Default is False</td>
  </tr>
</table>
<br>
<hr>
<h3>Example for the FileSystemObject object</h3>
...
<h3>Example for the Folder object</h3>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_createtextfile_filesystem.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_createtextfile_filesystem.asp#top" target="_top">TOP</a> |
		<a href="met_createtextfile_filesystem.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
