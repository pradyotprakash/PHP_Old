...
<title>ASP Write Method</title>
<style>a.menu_met_write{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Write</span> Method</h1>
<hr>
...
<hr>
<p>The Write method writes a specified text to a TextStream file.</p>

<p><b>Note:</b> This method write text to the TextStream file with no spaces or
line breaks between each string.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>text</td>
    <td>Required. The text to write to the file</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_write.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_write.asp#top" target="_top">TOP</a> |
		<a href="met_write.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
