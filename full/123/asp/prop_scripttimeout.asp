...
<title>ASP ScriptTimeout Property</title>
<style>a.menu_prop_scripttimeout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">ScriptTimeout</span> Property</h1>
...
<hr>
<p>The ScriptTimeout property sets or returns the maximum number of seconds a script can run before it is terminated.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>NumSeconds </td>
    <td> The maximum number of seconds a script can run before the server terminates it.
...
<h3>Example 2</h3>
<p>Retrieve the current value of the ScriptTimeout property:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_scripttimeout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_scripttimeout.asp#top" target="_top">TOP</a> |
		<a href="prop_scripttimeout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
