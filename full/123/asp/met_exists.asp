...
<title>ASP Exists Method</title>
<style>a.menu_met_exists{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Exists</span> Method</h1>
<hr>
...
<hr>
<p>The Exists method returns a Boolean value that indicates whether a specified key exists in the Dictionary
object. It returns true if the key exists, and false if not.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      key</td>
    <td> Required. The key value to search for</td>
  </tr>
</table>
...
d.Add &quot;s&quot;,&quot;Sweden&quot;<br>
<br>
if d.Exists(&quot;n&quot;)=true then<br>
&nbsp;&nbsp;Response.Write(&quot;Key exists!&quot;)<br>
else<br>
&nbsp;&nbsp;Response.Write(&quot;Key does not exist!&quot;)<br>
end if<br>
<br>
set d=nothing<br>
%&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_exists.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_exists.asp#top" target="_top">TOP</a> |
		<a href="met_exists.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
