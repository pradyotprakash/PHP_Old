...
<title>ASP Status Property</title>
<style>a.menu_prop_status{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Status</span> Property</h1>
<hr>
...
<hr>
<p>The Status property specifies the value of the status line returned by the server.</p>

<p><b>Tip:</b> Use this property to modify the status line returned by the server.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td> A three-digit number and a description of that code, like
      404 Not Found.<br>
      <b>Note:</b>&nbsp; Status values are defined in the HTTP specification.
    </td>
  </tr>
</table>
<h3>Examples</h3>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_status.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_status.asp#top" target="_top">TOP</a> |
		<a href="prop_status.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
