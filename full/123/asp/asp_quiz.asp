...
<style>a.menu_asp_quiz{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Quiz</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_examples.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_exam.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">You can test your ASP skills with W3Schools' Quiz.</p>
<hr>
<h2>The Test</h2>
<p>The test contains 20 questions and there is no time limit.</p>
<p>The test is not official, it's just a nice way to see how much you know, or don't know, about ASP.</p>
<hr>
...
<p>Good luck! <a target="_top" href="http://www.w3schools.com/quiztest/quiztest.asp?qtest=ASP">Start the
ASP Quiz</a></p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_quiz.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_quiz.asp#top" target="_top">TOP</a> |
		<a href="asp_quiz.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
