...
<style>a.menu_asp_applications{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Application</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_sessions.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_incfiles.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A group of ASP files that work together to perform some purpose is called an application.</p>
<hr>

<h2>Application Object</h2>
<p>An application on the Web may consist of several ASP files that work together to perform some purpose.
The Application object is used to tie these files together.</p>
<p>The Application object is used to store and access variables from any page, just like the Session object. The difference
is that ALL users share ONE Application object (with Sessions there is ONE Session object for EACH user).</p>
<p>The Application object holds information that will be used by many pages in the application (like database connection information).
...
<p>Application variables can be accessed and changed by any page in an application.</p>
...
<p>In the example above we have created two Application variables: &quot;vartime&quot; and &quot;users&quot;.</p>
...
<p>The Contents collection contains all application variables. You can loop through the Contents collection, to see what's stored in it:</p>
...
<p>You can loop through the StaticObjects collection, to see the values of all objects stored in the Application object:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_applications.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_applications.asp#top" target="_top">TOP</a> |
		<a href="asp_applications.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
