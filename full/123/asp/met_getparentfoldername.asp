...
<title>ASP GetParentFolderName Method</title>
<style>a.menu_met_getparentfoldername{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetParentFolderName</span> Method</h1>
<hr>
...
<hr>
<p>The GetParentFolderName method returns the name of the parent folder of the
last component in the specified path.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>path</td>
    <td>Required. The path for the file or folder whose parent folder name is to be returned</td>
  </tr>
</table>
<br>
<hr>
...
p=fs.GetParentFolderName(&quot;c:\winnt\cursors\3dgarro.cur&quot;)<br>
Response.Write(p)<br>
set fs=nothing<br>
%&gt;<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_getparentfoldername.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_getparentfoldername.asp#top" target="_top">TOP</a> |
		<a href="met_getparentfoldername.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
