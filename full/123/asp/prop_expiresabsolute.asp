...
<title>ASP ExpiresAbsolute Property</title>
<style>a.menu_prop_expiresabsolute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">ExpiresAbsolute</span> Property</h1>
<hr>
...
<hr>
<p>The ExpiresAbsolute property sets a date and time when a cached page on a
browser will
expire. If a user returns to the same page before this date/time, the cached version is displayed.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>date </td>
    <td> Specifies the date on which the page will expire.
      <p>If
  ...
  <tr>
    <td>time </td>
    <td> Specifies the time at which the page will expire.
      <p>If this parameter is not specified, the page will expire at midnight of
      the specified day.</p>
    </td>
  </tr>
</table>
<h3>Examples</h3>
<p>The following code indicates that the page will expire at 4:00 PM on October
11, 2012:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_expiresabsolute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_expiresabsolute.asp#top" target="_top">TOP</a> |
		<a href="prop_expiresabsolute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
