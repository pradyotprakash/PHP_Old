...
<title>ASP CodePage Property</title>
<style>a.menu_prop_codepage{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">CodePage</span> Property</h1>
<hr>
...
<p>The CodePage property specifies the  character set that will be used
when displaying dynamic content.</p>
<p>Example of some code pages:</p>
<ul>
  <li>1252 - American English and most European
languages</li>
  <li>932 - Japanese Kanji</li>
</ul>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>codepage</td>
    <td>Defines a code page (character set) for the system running the script engine</td>
  </tr>
</table>
<h3>Examples</h3>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_codepage.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_codepage.asp#top" target="_top">TOP</a> |
		<a href="prop_codepage.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
