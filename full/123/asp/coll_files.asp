...
<title>ASP Files Collection</title>
<style>a.menu_coll_files{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Files</span> Collection</h1>
<hr>
...
<hr>
<p>The Files collection returns a collection of all the files in a specified
folder.</p>
...
<br>
for each x in fo.files<br>
&nbsp;&nbsp;'Print the name of all files in the test folder<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="coll_files.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="coll_files.asp#top" target="_top">TOP</a> |
		<a href="coll_files.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
