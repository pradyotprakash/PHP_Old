...
<title>ASP GetExtensionName Method</title>
<style>a.menu_met_getextensionname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetExtensionName</span> Method</h1>
<hr>
...
<hr>
<p>The GetExtensionName method returns a string that contains the file extension name for the last component in a
specified path.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      path </td>
    <td> Required. The path for the file whose file extension name
...
Response.Write(fs.GetExtensionName(&quot;c:\test\test.htm&quot;))<br>
set fs=nothing<br>
%&gt;<br>
<br>
Output:<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_getextensionname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_getextensionname.asp#top" target="_top">TOP</a> |
		<a href="met_getextensionname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
