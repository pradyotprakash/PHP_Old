...
<title>ASP Form Collection</title>
<style>a.menu_coll_form{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Form</span> Collection</h1>
<hr>
...
<hr>
<p>The Form collection is used to retrieve the values of form elements from a form
that uses the POST method.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>element </td>
    <td> Required. The name of the form element from which the collection is to retrieve
      values</td>
  </tr>
  <tr>
    <td>index </td>
    <td> Optional. Specifies one of multiple values for a
      parameter. From 1 to Request.Form(parameter).Count.</td>
  </tr>
</table>
<br>
<hr>
...
<p>You can loop through all the values in a form request. If a user filled out a form by specifying two values -
...
&lt;%
for i=1 to Request.Form(&quot;color&quot;).Count<br>
&nbsp;&nbsp;Response.Write(Request.Form(&quot;color&quot;)(i) &amp; &quot;&lt;br>&quot;)<br>
next<br>
%&gt;
...
&lt;form action=&quot;submit.asp&quot; method=&quot;post&quot;&gt;<br>
&lt;p&gt;First name: &lt;input name=&quot;firstname&quot;&gt;&lt;/p&gt;<br>
&lt;p&gt;Last name: &lt;input name=&quot;lastname&quot;&gt;&lt;/p&gt;<br>
&lt;p&gt;Your favorite color:<br>
&lt;select name=&quot;color&quot;&gt;<br>
&lt;option&gt;Blue&lt;/option&gt;<br>
&lt;option&gt;Green&lt;/option&gt;<br>
&lt;option&gt;Red&lt;/option&gt;<br>
&lt;option&gt;Yellow&lt;/option&gt;<br>
&lt;option&gt;Pink&lt;/option&gt;<br>
&lt;/select&gt;<br>
&lt;/p&gt;<br>
...
<p>The following request might be sent:</p>
...
<p>Now we can use the information from the form in a script:&nbsp;</p>

<div class="code notranslate"><div>

Hi, &lt;%=Request.Form(&quot;firstname&quot;)%&gt;.&nbsp;<br>
...
<p>If you do not specify any element to display, like this:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="coll_form.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="coll_form.asp#top" target="_top">TOP</a> |
		<a href="coll_form.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
