...
<title>ASP Response Object</title>
<style>a.menu_asp_ref_response{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Response</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_send_email.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_request.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The ASP Response object is used to send output to the user from the server.</p>
<hr>
...
<p>
<a target="_blank" href="showasp.asp?filename=demo_formatting">Format text with HTML tags in ASP</a><br>
How to combine text and HTML tags with ASP.
</p>
<p>
<a target="_blank" href="showasp.asp?filename=demo_redirect">Redirect the user to a different URL</a><br>
How to redirect the user to a different URL.
</p>
<p>
<a target="_blank" href="showasp.asp?filename=demo_randomlink">Show a random link</a><br>
How to create a random link.</p>
<p>
...
<p>
<a target="_blank" href="showasp.asp?filename=demo_end">End a script in the middle of processing and return the result</a><br>
...
<p>
<a target="_blank" href="showasp.asp?filename=demo_isclientconnected">Check if the user is still connected to the server</a><br>
...
<p>
<a target="_blank" href="showasp.asp?filename=demo_charset">Set the name of the character set</a><br>
How to specify the name of the character set.
</p>
<hr>

<h2>Response Object</h2>
<p>The ASP Response object is used to send output to the user from the server. Its
collections, properties, and methods are described below:</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Sets a cookie value. If the cookie does not exist, it will be created,
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Specifies whether to buffer the page output or not</td>
  </tr>
  <tr>
    <td><a href="prop_cachecontrol.asp">CacheControl</a></td>
    <td>Sets whether a proxy server can cache the output generated
      by ASP or not</td>
  </tr>
  <tr>
    <td><a href="prop_charset.asp">Charset</a></td>
    <td>Appends the name of a character-set to the content-type
      header in the Response object</td>
  </tr>
  <tr>
    <td><a href="prop_contenttype.asp">ContentType</a></td>
    <td>Sets the HTTP content type for the Response object</td>
  </tr>
  <tr>
    <td><a href="prop_expires.asp">Expires</a></td>
    <td>Sets how long (in minutes) a page will be cached on a browser before it
      expires</td>
  </tr>
  <tr>
    <td><a href="prop_expiresabsolute.asp">ExpiresAbsolute</a></td>
    <td>Sets a date and time when a page cached on a browser will
      expire</td>
  </tr>
  <tr>
    <td><a href="prop_isclientconnected.asp">IsClientConnected</a></td>
    <td>Indicates if the client has disconnected from the server</td>
  </tr>
  <tr>
    <td><a href="prop_pics.asp">Pics</a></td>
    <td>Appends a value to the PICS label response header</td>
  </tr>
  <tr>
    <td><a href="prop_status.asp">Status</a></td>
    <td>Specifies the value of the status line returned by the
      server</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Adds a new HTTP header and a value to the HTTP response</td>
  </tr>
  <tr>
    <td><a href="met_appendtolog.asp">AppendToLog</a></td>
    <td>Adds a string to the end of the server log entry</td>
  </tr>
  <tr>
    <td><a href="met_binarywrite.asp">BinaryWrite</a></td>
    <td>Writes data directly to the output without any character conversion</td>
  </tr>
  <tr>
    <td><a href="met_clear.asp">Clear</a></td>
    <td>Clears any buffered HTML output</td>
  </tr>
  <tr>
    <td><a href="met_end.asp">End</a></td>
    <td>Stops processing a script, and returns the current result</td>
  </tr>
  <tr>
    <td><a href="met_flush.asp">Flush</a></td>
    <td>Sends buffered HTML output immediately</td>
  </tr>
  <tr>
    <td><a href="met_redirect.asp">Redirect</a></td>
    <td>Redirects the user to a different URL</td>
  </tr>
  <tr>
    <td><a href="met_write_response.asp">Write</a></td>
    <td>Writes a specified string to the output</td>
  </tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_response.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_response.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_response.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
