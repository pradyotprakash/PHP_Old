...
<style>a.menu_asp_ref_textstream{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">TextStream</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_filesystem.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_drive.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns true if the file pointer is positioned immediately
  ...
  <tr>
    ...
    <td>Returns true if the file pointer is at the end of a
      TextStream file, and false if not</td>
  </tr>
  <tr>
    <td><a href="prop_column.asp">Column</a></td>
    <td>Returns the column number of the current character position
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Reads a specified number of characters from a TextStream
      file and returns the result</td>
  </tr>
  <tr>
    <td><a href="met_readall.asp">ReadAll</a></td>
    <td>Reads an entire TextStream file and returns the result</td>
  </tr>
  <tr>
    <td><a href="met_readline.asp">ReadLine</a></td>
    <td>Reads one line from a TextStream file and returns the result</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Writes a specified text to a TextStream file</td>
  </tr>
  <tr>
    <td><a href="met_writeline.asp">WriteLine</a></td>
    <td>Writes a specified text and a new-line character to a TextStream file</td>
  </tr>
  <tr>
    <td><a href="met_writeblanklines.asp">WriteBlankLines</a></td>
    <td>Writes a specified number of new-line character to a TextStream file</td>
  </tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_textstream.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_textstream.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_textstream.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
