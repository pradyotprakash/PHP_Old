...
<title>ASP End Method</title>
<style>a.menu_met_end{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">End</span> Method</h1>
<hr>
...
<hr>
<p>The End method stops processing a script, and returns the current result.</p>

<p><b>Note:</b> This method will flush the buffer if Response.Buffer has been set to
true. If you do not want to return any output to the user, you should call Response.Clear first.</p>
...
Response.End<br>
%&gt;<br>
finished! It's too late to write more!&lt;/p&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;<br>
<br>
Output:<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_end.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_end.asp#top" target="_top">TOP</a> |
		<a href="met_end.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
