...
<title>ASP FileSystem Property</title>
<style>a.menu_prop_filesystem{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">FileSystem</span> Property</h1>
<hr>
<a href="asp_ref_drive.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Drive Object Reference" /> Complete Drive Object Reference</a>
<hr>
<p>The FileSystem property returns the file system in use for a specified drive.</p>

<p>This property will return one of the following:</p>

<ul>
  <li>FAT - for removable drives</li>
  <li>CDFS - for CD-ROM drives</li>
  <li>FAT, FAT32 or NTFS - for hard disks on Windows 2000 or Windows NT</li>
  <li>FAT or FAT32 - for hard disks on Windows 9x</li>
</ul>
...
Response.Write(&quot;The file system in use is: &quot; &amp; d.FileSystem)<br>
set d=nothing<br>
set fs=nothing<br>
%&gt;<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_filesystem.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_filesystem.asp#top" target="_top">TOP</a> |
		<a href="prop_filesystem.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
