...
<title>ASP QueryString Collection</title>
<style>a.menu_coll_querystring{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">QueryString</span> Collection</h1>
<hr>
...
<hr>
<p>The QueryString collection is used to retrieve the variable values in the HTTP query string.</p>

<p>The HTTP query string is specified by the values following the question mark
(?), like this:</p>

<p>&lt;a href= "test.asp?txt=this is a query string test&quot;&gt;Link with a
query string&lt;/a&gt;</p>

<p>The line above generates a variable named txt with the value &quot;this is a
query string test&quot;.</p>

<p>Query strings are also generated by form submission, or by a user typing a query into the address
bar of the browser.</p>

<p><b>Note:</b> If you want to send large amounts of data (beyond 100 kb) the Request.QueryString cannot be used.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>variable </td>
    <td> Required. The name of the variable in the HTTP query string to
      retrieve</td>
  </tr>
  <tr>
    <td>index </td>
    <td> Optional. Specifies one of multiple values for a variable. From 1 to
      Request.QueryString(variable).Count</td>
  </tr>
</table>
<br>
<hr>
...
<p>To loop through all the n variable values in a Query String:</p>

<p>The following request is sent:</p>
...
<p>and names.asp contains the following script:</p>

<div class="code notranslate"><div>

&lt;%<br>
for i=1 to Request.QueryString(&quot;n&quot;).Count<br>
&nbsp;&nbsp;Response.Write(Request.QueryString(&quot;n&quot;)(i) &amp; "&lt;br>&quot;)<br>
next<br>
%>

</div></div>

<p>The file names.asp would display the following:</p>
...
<p>The following string might be sent:</p>
...
<p>this results in the following QUERY_STRING value:</p>
...
<p>Now we can use the information in a script:&nbsp;</p>

<div class="code notranslate"><div>

Hi, &lt;%=Request.QueryString(&quot;name&quot;)%&gt;.&nbsp;<br>
...
<p>If you do not specify any variable values to display, like this:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="coll_querystring.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="coll_querystring.asp#top" target="_top">TOP</a> |
		<a href="coll_querystring.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
