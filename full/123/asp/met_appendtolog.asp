...
<title>ASP AppendToLog Method</title>
<style>a.menu_met_appendtolog{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">AppendToLog</span> Method</h1>
<hr>
...
<hr>
<p>The AppendToLog method adds a string to the end of server log entry for this request. You can call
...
<table class="reference notranslate">
  ...
  <tr>
    <td>string </td>
    <td> Required. The text to append to the log file (cannot contain any comma characters)</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_appendtolog.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_appendtolog.asp#top" target="_top">TOP</a> |
		<a href="met_appendtolog.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
