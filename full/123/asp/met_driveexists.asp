...
<title>ASP DriveExists Method</title>
<style>a.menu_met_driveexists{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">DriveExists</span> Method</h1>
<hr>
...
<hr>
<p>The DriveExists method returns a Boolean value that indicates whether a
...
<table class="reference notranslate">
  ...
  <tr>
    <td>drive</td>
    <td>Required. A drive letter or a complete path specification</td>
  </tr>
</table>
...
if fs.DriveExists(&quot;c:&quot;)=true then<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_driveexists.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_driveexists.asp#top" target="_top">TOP</a> |
		<a href="met_driveexists.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
