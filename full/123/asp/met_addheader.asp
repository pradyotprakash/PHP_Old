...
<title>ASP AddHeader Method</title>
<style>a.menu_met_addheader{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">AddHeader</span> Method</h1>
<hr>
...
<hr>
<p>The AddHeader method adds a new HTTP header and a value to the HTTP
response.&nbsp;</p>

<p><b>Note:</b> Once a header has been added, it cannot be removed.</p>

<p><b>Note:</b> In IIS 4.0 you have to call this method before any output is
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name </td>
    <td> Required. The name of the new header variable (cannot
      contain underscores)
  ...
  <tr>
    <td>value </td>
    <td> Required. The initial value of the new header variable
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_addheader.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_addheader.asp#top" target="_top">TOP</a> |
		<a href="met_addheader.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
