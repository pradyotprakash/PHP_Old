...
<title>ASP BinaryWrite Method</title>
<style>a.menu_met_binarywrite{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">BinaryWrite</span> Method</h1>
<hr>
...
<hr>
<p>The BinaryWrite method writes data directly to the output without any character conversion.</p>

<p><b>Tip:</b> This method is used to write image data (BLOB) from a database to
a browser.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>data </td>
    <td> Required. The binary information to be sent</td>
  </tr>
</table>
<br>
<hr>
<h3>Example</h3>
<p>If you have an object that generates an array of bytes, you can use BinaryWrite to send the bytes to an
application:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_binarywrite.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_binarywrite.asp#top" target="_top">TOP</a> |
		<a href="met_binarywrite.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
