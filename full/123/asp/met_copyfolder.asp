...
<title>ASP CopyFolder Method</title>
<style>a.menu_met_copyfolder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">CopyFolder</span> Method</h1>
<hr>
...
<hr>
<p>The CopyFolder method copies one or more folders from one location to
another.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      source </td>
    <td> Required. The folder or folders to copy (wildcards can be used)</td>
  </tr>
  <tr>
    <td>
      destination </td>
    <td> Required. Where to copy the folder or folders (wildcards cannot be used)</td>
  </tr>
  <tr>
    <td>
      overwrite </td>
    <td> Optional. A Boolean value that indicates whether an existing folder can be overwritten.
      True allows existing folders to be overwritten and False prevents existing
      folders from being overwritten. Default is True</td>
  </tr>
</table>
...
&lt;%<br>
'copy all the folders in c:\mydocuments\web<br>
'to the folder c:\webpages<br>
<br>
dim fs<br>
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)<br>
fs.CopyFolder &quot;c:\mydocuments\web\*&quot;,&quot;c:\webpages\&quot;<br>
set fs=nothing<br>
%&gt;<br>
<br>
&lt;%<br>
'copy only the folder test from c:\mydocuments\web<br>
'to the folder c:\webpages<br>
<br>
dim fs<br>
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)<br>
fs.CopyFolder &quot;c:\mydocuments\web\test&quot;,&quot;c:\webpages\&quot;<br>
set fs=nothing<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_copyfolder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_copyfolder.asp#top" target="_top">TOP</a> |
		<a href="met_copyfolder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
