...
<title>ASP Column Property</title>
<style>a.menu_prop_column{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Column</span> Property</h1>
<hr>
<a href="asp_ref_textstream.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="TextStream Object Reference" /> Complete TextStream Object Reference</a>
<hr>
<p>The Column property returns the column number of the current character
position in an input stream.</p>

<p><b>Note:</b> This property is 1 after a new line character is written (even before any other character is written).</p>
...
set f=fs.CreateTextFile(&quot;c:\test.txt&quot;)<br>
f.write(&quot;Hello World!&quot;)<br>
f.close<br>
<br>
set t=fs.OpenTextFile(&quot;c:\test.txt&quot;,1,false)<br>
do while t.AtEndOfStream&lt;&gt;true<br>
&nbsp;&nbsp;x=t.Read(1)<br>
&nbsp;&nbsp;y=t.Column-1<br>
loop<br>
t.close<br>
Response.Write(&quot;The last character in the text file is: &quot; &amp; x)<br>
Response.Write(&quot;&lt;br> at character position: &quot; &amp; y)<br>
%&gt;<br>
<br>
Output:<br>
<br>
The last character in the text file is: !<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_column.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_column.asp#top" target="_top">TOP</a> |
		<a href="prop_column.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
