...
<title>ASP ServerVariables Collection</title>
<style>a.menu_coll_servervariables{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">ServerVariables</span> Collection</h1>
<hr>
...
<hr>
<p>The ServerVariables collection is used to retrieve the server variable values.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td> Required. The name of the <a href="coll_servervariables.asp#sv"> server variable</a> to retrieve
    </td>
  </tr>
</table>

<h3><a name="sv">Server Variables</a></h3>
<table class="reference notranslate">
<tr>
...
<hr>
<h2>Examples</h2>
<p>You can loop through all of the server variables like this:</p>
<div class="code notranslate"><div>

&lt;%<br>
for each x in Request.ServerVariables<br>
&nbsp;&nbsp;response.write(x &amp; &quot;&lt;br>&quot;)<br>
next<br>
%&gt;

</div></div>
<p>The following example demonstrates how to find out the visitor's browser type, IP
address, and more:</p>
<div class="code notranslate"><div>
...
&lt;body&gt;<br>
&lt;p&gt;<br>
&lt;b&gt;You are browsing this site with:&lt;/b&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="coll_servervariables.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="coll_servervariables.asp#top" target="_top">TOP</a> |
		<a href="coll_servervariables.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
