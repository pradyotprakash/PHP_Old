...
<title>ASP DeleteFolder Method</title>
<style>a.menu_met_deletefolder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">DeleteFolder</span> Method</h1>
<hr>
...
<hr>
<p>The DeleteFolder method deletes one or more specified folders.
</p>

<p><b>Note:</b> An error will occur if you try to delete a folder that does not
exist.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>foldername</td>
    <td>Required. The name of the folder or folders to delete
      (Wildcards are allowed)</td>
  </tr>
  <tr>
    <td>force</td>
    <td>Optional. A Boolean value that indicates whether read-only folders will
      be deleted. True indicates that read-only
      folders will be deleted, False indicates that they will not be deleted.
      Default is False
    </td>
  </tr>
</table>
...
if fs.FolderExists(&quot;c:\temp&quot;) then<br>
&nbsp;&nbsp;fs.DeleteFolder(&quot;c:\temp&quot;)<br>
end if<br>
set fs=nothing<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_deletefolder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_deletefolder.asp#top" target="_top">TOP</a> |
		<a href="met_deletefolder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
