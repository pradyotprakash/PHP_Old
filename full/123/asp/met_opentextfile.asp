...
<title>ASP OpenTextFile Method</title>
<style>a.menu_met_opentextfile{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">OpenTextFile</span> Method</h1>
<hr>
...
<hr>
<p>The OpenTextFile method opens a specified file and returns a TextStream object
that can be used to access the file.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>fname</td>
    <td>Required. The name of the file to open</td>
  </tr>
  <tr>
    <td>mode</td>
    <td>Optional. How to open the file<br>
      1=ForReading - Open a file for reading. You cannot write to this file.<br>
      2=ForWriting - Open a file for writing.<br>
      8=ForAppending - Open a file and write to the end of the file.
    </td>
  </tr>
  <tr>
    <td>create </td>
    <td>Optional. Sets whether a new file can be created if the filename
  ...
  <tr>
    <td>format </td>
    <td>Optional. The format of the file<br>
      0=TristateFalse - Open the file as ASCII. This is default.<br>
      -1=TristateTrue - Open the file as Unicode.<br>
...
set f=fs.OpenTextFile(Server.MapPath(&quot;testread.txt&quot;),8,true)<br>
f.WriteLine(&quot;This text will be added to the end of file&quot;)<br>
f.Close<br>
set f=Nothing<br>
set fs=Nothing<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_opentextfile.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_opentextfile.asp#top" target="_top">TOP</a> |
		<a href="met_opentextfile.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
