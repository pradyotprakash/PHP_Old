...
<title>ASP ASPError Object Properties</title>
<style>a.menu_prop_asperrorobject{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">ASPError</span> Object Properties</h1>
<hr>
<a href="asp_ref_error.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="ASPError Object Reference" /> Complete ASPError Object Reference</a>
<hr>
<h3>ASPCode</h3>

<p>The ASPCode property returns an error code generated by IIS.</p>

<h3>ASPDescription</h3>

<p>The ASPDescription property returns a detailed description of the error.</p>

<h3>Category</h3>

<p>The Category property returns the source of the error (Was the error generated by IIS?
A scripting language? Or a component?).</p>

<h3>Column</h3>

<p>The Column property returns the column position within the ASP file that generated the error.</p>

<h3>Description</h3>

<p>The Description property returns a short description of the error.</p>

<h3>File</h3>

<p>The File property returns the name of the ASP file that generated the error.</p>

<h3>Line</h3>

<p>The Line property returns the number of the line within the ASP file that generated the error.</p>

<h3>Number</h3>

<p>The Number property returns the standard COM error code for the error.</p>

<h3>Source</h3>

<p>The Source property returns the actual source code of the line where the
error occurred.</p>
...
ASPError.ASPCode()<br>
ASPError.ASPDescription()<br>
ASPError.Category()<br>
ASPError.Column()<br>
ASPError.Description()<br>
ASPError.File()<br>
ASPError.Line()<br>
ASPError.Number()<br>
ASPError.Source()
...
&lt;%<br>
dim objErr<br>
set objErr=Server.GetLastError()<br>
<br>
response.write(&quot;ASPCode=" &amp; objErr.ASPCode)<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_asperrorobject.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_asperrorobject.asp#top" target="_top">TOP</a> |
		<a href="prop_asperrorobject.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
