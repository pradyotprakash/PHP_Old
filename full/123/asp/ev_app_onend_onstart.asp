...
<title>ASP Application_OnStart and Application_OnEnd Events</title>
<style>a.menu_ev_app_onend_onstart{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Application_OnStart</span> and <span class="color_h1">Application_OnEnd</span> Events</h1>
<hr>
...
<hr>
<h2>Application_OnStart Event</h2>

<p>The Application_OnStart event occurs before the first new session is created
(when the Application object is first referenced).</p>

<p>This event is placed in the Global.asa file.</p>

<p><b>Note:</b> Referencing to a Session, Request, or Response objects in the Application_OnStart event script
will cause an error.&nbsp;</p>

<h2> Application_OnEnd Event</h2>

<p>The Application_OnEnd event occurs when the application ends (when the web
server stops).</p>

<p>This event is placed in the Global.asa file.</p>

<p><b>Note:</b> The MapPath method cannot be used in the Application_OnEnd code.</p>
...
<br>
Sub Application_OnEnd()<br>
Application(&quot;totvisitors&quot;)=Application(&quot;visitors&quot;)<br>
End Sub<br>
<br>
Sub Application_OnStart<br>
...
&lt;body&gt;<br>
&lt;p&gt;<br>
There are &lt;%response.write(Application(&quot;visitors&quot;))%&gt;<br>
online now!<br>
&lt;/p&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_app_onend_onstart.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_app_onend_onstart.asp#top" target="_top">TOP</a> |
		<a href="ev_app_onend_onstart.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
