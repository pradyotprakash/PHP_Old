...
<title>ASP CopyFile Method</title>
<style>a.menu_met_copyfile{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">CopyFile</span> Method</h1>
<hr>
...
<hr>
<p>The CopyFile method copies one or more files from one location to another.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      source </td>
    <td> Required. The file or files to copy (wildcards can be used}</td>
  </tr>
  <tr>
    <td>
      destination </td>
    <td> Required. Where to copy the file or files (wildcards cannot be used}</td>
  </tr>
  <tr>
    <td>
      overwrite </td>
    <td> Optional. A Boolean value that specifies whether an existing file can be overwritten.
      True allows existing files to be overwritten and False prevents existing files
      from being overwritten. Default is True</td>
  </tr>
</table>
<br>
<hr>
...
fs.CopyFile &quot;c:\mydocuments\web\*.htm&quot;,&quot;c:\webpages\&quot;<br>
set fs=nothing<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_copyfile.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_copyfile.asp#top" target="_top">TOP</a> |
		<a href="met_copyfile.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
