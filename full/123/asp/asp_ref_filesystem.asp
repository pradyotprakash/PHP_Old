...
<style>a.menu_asp_ref_filesystem{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">FileSystemObject</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_error.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_textstream.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The FileSystemObject object is used to access the file system on 
a server.</p>
<hr>
...
How to get the name of the parent folder of a specified path.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_getfilename">Get file name</a><br>
How to get the file name of the last component in a specified path.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_getextensionname">Get the file extension</a><br>
How to get the file extension of the last component in a specified path.</p>

<p><a target="_blank" href="showfile.asp?filename=demo_getbasename">Get the base name of a file or folder</a><br>
How to get the base name of a file or folder, in a specified path.</p>
<hr>

<h2>The FileSystemObject Object</h2>

<p>The FileSystemObject object is used to access the file system on a server.</p>
<p>This object can manipulate files, folders, and directory paths. It is also
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns a collection of all Drive objects on the computer</td>
  </tr>
</table>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Appends a name to an existing path</td>
  </tr>
  <tr>
    <td><a href="met_copyfile.asp">CopyFile</a></td>
    <td>Copies one or more files from one location to another</td>
  </tr>
  <tr>
    <td><a href="met_copyfolder.asp">CopyFolder</a></td>
    <td>Copies one or more folders from one location to another</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Creates a text file and returns a TextStream object that
      can be used to read from, or write to the file</td>
  </tr>
  <tr>
    <td><a href="met_deletefile.asp">DeleteFile</a></td>
    <td>Deletes one or more specified files</td>
  </tr>
  <tr>
    <td><a href="met_deletefolder.asp">DeleteFolder</a></td>
    <td>Deletes one or more specified folders</td>
  </tr>
  <tr>
    <td><a href="met_driveexists.asp">DriveExists</a></td>
    <td>Checks if a specified drive exists</td>
  </tr>
  <tr>
    <td><a href="met_fileexists.asp">FileExists</a></td>
    <td>Checks if a specified file exists</td>
  </tr>
  <tr>
    <td><a href="met_folderexists.asp">FolderExists</a></td>
    <td>Checks if a specified folder exists</td>
  </tr>
  <tr>
    <td><a href="met_getabsolutepathname.asp">GetAbsolutePathName</a></td>
    <td>Returns the complete path from the root of the drive for
      the specified path</td>
  </tr>
  <tr>
    <td><a href="met_getbasename.asp">GetBaseName</a></td>
    <td>Returns the base name of a specified file or folder</td>
  </tr>
  <tr>
    <td><a href="met_getdrive.asp">GetDrive</a></td>
    <td>Returns a Drive object corresponding to the drive in a specified
      path</td>
  </tr>
  <tr>
    <td><a href="met_getdrivename.asp">GetDriveName</a></td>
    <td>Returns the drive name of a specified path</td>
  </tr>
  <tr>
    <td><a href="met_getextensionname.asp">GetExtensionName</a></td>
    <td>Returns the file extension name for the last component in a
      specified path</td>
  </tr>
  <tr>
    <td><a href="met_getfile.asp">GetFile</a></td>
    <td>Returns a File object for a specified path</td>
  </tr>
  <tr>
    <td><a href="met_getfilename.asp">GetFileName</a></td>
    <td>Returns the file name or folder name for the last component in a
      specified path</td>
  </tr>
  <tr>
    <td><a href="met_getfolder.asp">GetFolder</a></td>
    <td>Returns a Folder object for a specified path</td>
  </tr>
  <tr>
    <td><a href="met_getparentfoldername.asp">GetParentFolderName</a></td>
    <td>Returns the name of the parent folder of the last component in
      a specified path</td>
  </tr>
  <tr>
    <td><a href="met_getspecialfolder.asp">GetSpecialFolder</a></td>
    <td>Returns the path to some of Windows' special folders</td>
  </tr>
  <tr>
    <td><a href="met_gettempname.asp">GetTempName</a></td>
    <td>Returns a randomly generated temporary file or folder</td>
  </tr>
  <tr>
    <td><a href="met_movefile.asp">MoveFile</a></td>
    <td>Moves one or more files from one location to another</td>
  </tr>
  <tr>
    <td><a href="met_movefolder.asp">MoveFolder</a></td>
    <td>Moves one or more folders from one location to another</td>
  </tr>
  <tr>
    <td><a href="met_opentextfile.asp">OpenTextFile</a></td>
    <td>Opens a file and returns a TextStream object that can be used to access the
      file</td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_filesystem.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_filesystem.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_filesystem.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
