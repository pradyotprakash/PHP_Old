...
<title>ASP FileExists Method</title>
<style>a.menu_met_fileexists{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">FileExists</span> Method</h1>
<hr>
...
<hr>
<p>The FileExists method returns a Boolean value that indicates whether a
...
<table class="reference notranslate">
  ...
  <tr>
    <td>filename</td>
    <td>Required. The name of the file to check if exist</td>
  </tr>
</table>
<br>
<hr>
...
if fs.FileExists(&quot;c:\asp\introduction.asp&quot;) then<br>
&nbsp;&nbsp;response.write(&quot;File c:\asp\introduction.asp exists!&quot;)<br>
else<br>
&nbsp;&nbsp;response.write(&quot;File c:\asp\introduction.asp does not exist!&quot;)<br>
end if<br>
set fs=nothing<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_fileexists.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_fileexists.asp#top" target="_top">TOP</a> |
		<a href="met_fileexists.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
