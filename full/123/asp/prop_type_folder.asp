...
<title>ASP Type Property</title>
<style>a.menu_prop_type_folder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Type</span> Property</h1>
<hr>
...
<hr>
<p>The Type property is used to return the type of the 
...
<h3>Examples for the File object</h3>
<div class="code notranslate"><div>

&lt;%<br>
dim fs,f<br>
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)<br>
set f=fs.GetFile(&quot;c:test.txt&quot;)<br>
Response.Write(&quot;The file test.txt is of type: &quot;)<br>
Response.Write(f.Type)<br>
set f=nothing<br>
set fs=nothing<br>
%&gt;<br>
<br>
...
dim fs,f<br>
set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)<br>
set f=fs.GetFile(&quot;c:test.asp&quot;)<br>
Response.Write(&quot;The file test.asp is of type: &quot;)<br>
Response.Write(f.Type)<br>
set f=nothing<br>
set fs=nothing<br>
%&gt;<br>
...
Response.Write(&quot;The folder test is of type: &quot;)<br>
Response.Write(fo.Type)<br>
set fo=nothing<br>
set fs=nothing<br>
%&gt;<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_type_folder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_type_folder.asp#top" target="_top">TOP</a> |
		<a href="prop_type_folder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
