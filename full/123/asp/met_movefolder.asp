...
<title>ASP MoveFolder Method</title>
<style>a.menu_met_movefolder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">MoveFolder</span> Method</h1>
<hr>
...
<hr>
<p>The MoveFolder method moves one or more folders from one location to another.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>source</td>
    <td>Required. The path to the folder/folders to be moved. Can
      contain wildcard characters in the last component.</td>
  </tr>
  <tr>
    <td>destination </td>
    <td>Required. Where to move the folder/folders. Cannot contain
...
fs.MoveFolder &quot;c:\test\web\&quot;,&quot;c:\windows\&quot;<br>
set fs=nothing<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_movefolder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_movefolder.asp#top" target="_top">TOP</a> |
		<a href="met_movefolder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
