...
<style>a.menu_asp_ref_request{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Request</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_response.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_application.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The Request object is used to get information from a visitor.</p>
<hr>
<div class="tryit_ex">
...
<p><a target="_blank" href="showasp.asp?filename=demo_simplequerystring">Send query information when a user clicks on a link</a><br>
How to send query information to a page within a link, and retrieve that information on the
destination page (which is, in this example, the same page).</p>

<p><a target="_blank" href="showasp.asp?filename=demo_simplereqquery">A QueryString collection in its simplest use</a><br>
Use the QueryString collection to retrieve the values from a form (the form uses 
the get method - the information sent is visible to everybody).</p>

<p><a target="_blank" href="showasp.asp?filename=demo_reqquery">How to use information from forms</a><br>
How to use the values retrieved from a form.</p>
...
method - the information sent is invisible to others).</p>
...
How to get the visitor's browser type, IP address, and more.&nbsp;</p>
...
How to find
the total number of bytes the user sent in the Request object.</p>
<hr>

<h2>Request Object</h2>
<p>When a browser asks for a page from a server, it is called a request. The Request 
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns the total number of bytes the client sent in the
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_request.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_request.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_request.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
