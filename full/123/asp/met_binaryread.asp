...
<title>ASP BinaryRead Method</title>
<style>a.menu_met_binaryread{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">BinaryRead</span> Method</h1>
<hr>
...
<hr>
<p>The BinaryRead method is used to retrieve the data sent to the server from the client as part of a POST
...
<p><b>Note:</b> A call to Request.Form after a call to BinaryRead, and
vice-versa, will cause an error.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>count </td>
    <td> Required. Specifies how many bytes to read from the client

    </td>
  </tr>
</table>
<h3>Examples</h3>
<p>The following example uses the BinaryRead method to place the content of a request into a safe
array:</p>
<div class="code notranslate"><div>

&lt;%<br>
dim a,b<br>
a=Request.TotalBytes<br>
b=Request.BinaryRead(a)<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_binaryread.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_binaryread.asp#top" target="_top">TOP</a> |
		<a href="met_binaryread.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
