...
<style>a.menu_asp_ref_server{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Server</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_session.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_error.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The Server object is used to access properties and methods on the server.</p>
<hr>
...
<p><a target="_blank" href="showasp.asp?filename=demo_lastmodified">When was a file last modified?</a><br>
Check when a file was last modified.</p>

<p><a target="_blank" href="showasp.asp?filename=demo_textstream">Open a text file for reading</a><br>
Open &quot;Textfile.txt&quot; for reading.</p>

<p><a target="_blank" href="showasp.asp?filename=demo_hitcounter">Homemade hit counter</a></p>
<hr>

<h2>Server Object</h2>
<p>The ASP Server object is used to access properties and methods on the server. Its properties and methods are described below:</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_scripttimeout.asp">ScriptTimeout</a></td>
    <td>Sets or returns the maximum number of seconds a script can run before it is
      terminated</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_server.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_server.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_server.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
