...
<style>a.menu_asp_ref_file{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">File</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_drive.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_folder.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The File object is used to return information about a specified file.</p>
<hr>
...
<p><a target="_blank" href="showasp.asp?filename=demo_datelastmodified">When was the file last modified?</a><br>
How to get the date and time a specified file was last modified.</p>

<p><a target="_blank" href="showasp.asp?filename=demo_datelastaccessed">When was the file last accessed?</a><br>
How to get the date and time a specified file was last accessed.</p>

<p><a target="_blank" href="showasp.asp?filename=demo_attributes">Return the attributes of a specified file</a><br>
How to return the attributes of a specified file.</p>
<hr>

<h2>The File Object</h2>
<p>The File object is used to return information about a specified file.</p>
<p>To work with the properties and methods of the File object, you will have to 
...
FileSystemObject object or through the Files property of the Folder object.</p>
<p>The following code uses the GetFile method of the FileSystemObject object to
instantiate the File object and the DateCreated property to return the date when
the specified file was created:</p>
<div class="example">
...
Set f=fs.GetFile(&quot;c:\test.txt&quot;)<br>
Response.Write(&quot;File created: &quot; &amp; f.DateCreated)<br>
set f=nothing<br>
set fs=nothing<br>
%&gt;</div>
<br><a target="_blank" href="showasp.asp?filename=demo_datecreated" class="showbtn">Show Example &raquo;</a>
</div>
<p>The File object's properties and methods are described below:</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_attributes_file.asp">Attributes</a></td>
    <td>Sets or returns the attributes of a specified file</td>
  </tr>
  <tr>
    <td><a href="prop_datecreated_file.asp">DateCreated</a></td>
    <td>Returns the date and time when a specified file was created</td>
  </tr>
  <tr>
    <td><a href="prop_datelastaccessed_file.asp">DateLastAccessed</a></td>
    <td>Returns the date and time when a specified file was last accessed</td>
  </tr>
  <tr>
    <td><a href="prop_datelastmodified_file.asp">DateLastModified</a></td>
    <td>Returns the date and time when a specified file was last modified</td>
  </tr>
  <tr>
    <td><a href="prop_drive_file.asp">Drive</a></td>
    <td>Returns the drive letter of the drive where a specified 
    file or folder resides</td>
  </tr>
  <tr>
    <td><a href="prop_name_file.asp">Name</a></td>
    <td>Sets or returns the name of a specified file</td>
  </tr>
  <tr>
    <td><a href="prop_parentfolder_file.asp">ParentFolder</a></td>
    <td>Returns the folder object for the parent of the specified 
    file</td>
  </tr>
  <tr>
    <td><a href="prop_path_file.asp">Path</a></td>
    <td>Returns the path for a specified file</td>
  </tr>
  <tr>
    <td><a href="prop_shortname_file.asp">ShortName</a></td>
    <td>Returns the short name of a specified file (the 8.3 naming convention)</td>
  </tr>
  <tr>
    <td><a href="prop_shortpath_file.asp">ShortPath</a></td>
    <td>Returns the short path of a specified file (the 8.3 naming convention)</td>
  </tr>
  <tr>
    <td><a href="prop_size_file.asp">Size</a></td>
    <td>Returns the size, in bytes, of a specified file</td>
  </tr>
  <tr>
    <td><a href="prop_type_file.asp">Type</a></td>
    <td>Returns the type of a specified file</td>
  </tr>
</table>
<h3>Methods</h3>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="met_copy_file.asp">Copy</a></td>
    <td>Copies a specified file from one location to another</td>
  </tr>
  <tr>
    <td><a href="met_delete_file.asp">Delete</a></td>
    <td>Deletes a specified file</td>
  </tr>
  <tr>
    <td><a href="met_move_file.asp">Move</a></td>
    <td>Moves a specified file from one location to another</td>
  </tr>
  <tr>
    <td><a href="met_openastextstream.asp">OpenAsTextStream</a>&nbsp;</td>
    <td>Opens a specified file and returns a TextStream object to access
      the file</td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_file.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_file.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_file.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
