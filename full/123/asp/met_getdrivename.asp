...
<title>ASP GetDriveName Method</title>
<style>a.menu_met_getdrivename{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetDriveName</span> Method</h1>
<hr>
...
<hr>
<p>The GetDriveName method returns a string that contains the drive name of the specified path.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>path</td>
    <td>Required. The path that will return a drive name</td>
  </tr>
</table>
...
dname=fs.GetDriveName(&quot;c:\test\test.htm&quot;)<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_getdrivename.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_getdrivename.asp#top" target="_top">TOP</a> |
		<a href="met_getdrivename.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
