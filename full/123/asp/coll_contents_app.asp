...
<title>ASP Contents Collection</title>
<style>a.menu_coll_contents_app{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Contents</span> Collection</h1>
<hr>
<a href="asp_ref_application.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Application Object Reference" /> Complete Application Object Reference</a>
<hr>
<p>The Contents collection contains all the items appended to the application/session through a script
command.</p>

<p><b>Tip:</b> To remove items from the Contents collection, use the Remove and RemoveAll methods.</p>

<h2>Syntax</h2>

<div class="code notranslate"><div>

Application.Contents(Key)<br>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>key </td>
    <td> Required. The name of the item to retrieve</td>
  </tr>
</table>
<br>
<hr>
<h2>Examples for the Application Object</h2>
<h3>Example 1</h3>
<p>Notice that both name and objtest would be appended to the Contents collection:</p>
<div class="code notranslate"><div>

&lt;% <br>
Application(&quot;name&quot;)=&quot;W3Schools&quot;<br>
Set Application(&quot;objtest&quot;)=Server.CreateObject(&quot;ADODB.Connection&quot;)<br>
%&gt;

</div></div>
<h3>Example 2</h3>
<p>To loop through the Contents collection:</p>
<div class="code notranslate"><div>

&lt;%<br>
for each x in Application.Contents<br>
&nbsp;&nbsp;Response.Write(x &amp; &quot;=&quot; &amp; Application.Contents(x) &amp; &quot;&lt;br>&quot;)<br>
next<br>
%&gt;<br>
<br>
or:<br>
<br>
&lt;%<br>
For i=1 to Application.Contents.Count<br>
&nbsp;&nbsp;Response.Write(i &amp; &quot;=&quot; &amp; Application.Contents(i) &amp; &quot;&lt;br>&quot;)<br>
Next<br>
%&gt;
...
&lt;%<br>
Application(&quot;date&quot;)=&quot;2001/05/05&quot;<br>
Application(&quot;author&quot;)=&quot;W3Schools&quot;<br>
<br>
for each x in Application.Contents<br>
&nbsp;&nbsp;Response.Write(x &amp; &quot;=&quot; &amp; Application.Contents(x) &amp; &quot;&lt;br>&quot;)<br>
next<br>
...
<br>
<hr>
<h2>Examples for the Session Object</h2>
<h3>Example 1</h3>
<p>Notice that both name and objtest would be appended to the Contents collection:</p>
<div class="code notranslate"><div>

&lt;%<br>
Session(&quot;name&quot;)=&quot;Hege&quot;<br>
Set Session(&quot;objtest&quot;)=Server.CreateObject(&quot;ADODB.Connection&quot;)<br>
%&gt;
...
&lt;%<br>
for each x in Session.Contents<br>
&nbsp;&nbsp;Response.Write(x &amp; &quot;=&quot; &amp; Session.Contents(x) &amp; &quot;&lt;br>&quot;)<br>
next<br>
%&gt;<br>
<br>
or:<br>
<br>
&lt;%<br>
For i=1 to Session.Contents.Count<br>
&nbsp;&nbsp;Response.Write(i &amp; &quot;=&quot; &amp; Session.Contents(i) &amp; &quot;&lt;br>&quot;)<br>
Next<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="coll_contents_app.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="coll_contents_app.asp#top" target="_top">TOP</a> |
		<a href="coll_contents_app.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
