...
<title>ASP SubFolders Collection</title>
<style>a.menu_coll_subfolders{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">SubFolders</span> Collection</h1>
<hr>
...
<hr>
<p>The SubFolders collection returns a collection of all subfolders in a specified
folder.</p>
...
<br>
for each x in fo.SubFolders<br>
&nbsp;&nbsp;'Print the name of all subfolders in the test folder<br>
&nbsp;&nbsp;Response.write(x.Name &amp; &quot;&lt;br>&quot;)<br>
next<br>
<br>
set fo=nothing<br>
set fs=nothing<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="coll_subfolders.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="coll_subfolders.asp#top" target="_top">TOP</a> |
		<a href="coll_subfolders.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
