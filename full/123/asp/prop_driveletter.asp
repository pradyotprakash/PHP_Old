...
<title>ASP DriveLetter Property</title>
<style>a.menu_prop_driveletter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">DriveLetter</span> Property</h1>
<hr>
...
<hr>
<p>The DriveLetter property returns one uppercase letter that
identifies the local drive or a network share.</p>
...
Response.Write(&quot;The drive letter is: &quot; &amp; d.driveletter)<br>
set d=nothing<br>
set fs=nothing<br>
%&gt;<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_driveletter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_driveletter.asp#top" target="_top">TOP</a> |
		<a href="prop_driveletter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
