...
<title>ASP Clear Method</title>
<style>a.menu_met_clear{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Clear</span> Method</h1>
<hr>
...
<hr>
<p>The Clear method clears any buffered HTML output.</p>

<p><b>Note:</b> This method does not clear the response headers, only the
response body.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_clear.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_clear.asp#top" target="_top">TOP</a> |
		<a href="met_clear.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
