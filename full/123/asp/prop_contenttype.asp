...
<title>ASP ContentType Property</title>
<style>a.menu_prop_contenttype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">ContentType</span> Property</h1>
<hr>
...
<hr>
<p>The ContentType property sets the HTTP content type for the response object.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>contenttype </td>
    <td> A string describing the content type.
      <p>For a full list of content types, see your browser documentation or the
      HTTP specification.</td>
  </tr>
</table>
<h3>Examples</h3>
<p>If an ASP page has no ContentType property set, the default content-type header would be:</p>
<div class="code notranslate"><div>

content-type:text/html

</div></div>
<p>Some other common ContentType values:</p>
<div class="code notranslate"><div>

&lt;%response.ContentType=&quot;text/HTML&quot;%&gt;<br>
&lt;%response.ContentType=&quot;image/GIF&quot;%&gt;<br>
&lt;%response.ContentType=&quot;image/JPEG&quot;%&gt;<br>
&lt;%response.ContentType=&quot;text/plain&quot;%&gt;</div></div>
<p>This example will open an Excel spreadsheet in a browser (if the user has
Excel installed):</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_contenttype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_contenttype.asp#top" target="_top">TOP</a> |
		<a href="prop_contenttype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
