...
<title>ASP GetSpecialFolder Method</title>
<style>a.menu_met_getspecialfolder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetSpecialFolder</span> Method</h1>
<hr>
...
<hr>
<p>The GetSpecialFolder method returns the path to some of Windows' special
folders.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      foldername </td>
    <td> Required. The folder to be returned.<br>
      0=WindowsFolder - Contains files installed by the Windows operating system<br>
      1=SystemFolder - Contains libraries, fonts, and device drivers<br>
      2=TemporaryFolder - Used to store temporary files </td>
  </tr>
</table>
<br>
<hr>
...
set p=fs.GetSpecialFolder(1)<br>
Response.Write(p)<br>
set p=nothing<br>
set fs=nothing<br>
%&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_getspecialfolder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_getspecialfolder.asp#top" target="_top">TOP</a> |
		<a href="met_getspecialfolder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
