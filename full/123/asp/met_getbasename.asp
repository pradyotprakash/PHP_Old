...
<title>ASP GetBaseName Method</title>
<style>a.menu_met_getbasename{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetBaseName</span> Method</h1>
<hr>
...
<hr>
<p>The GetBaseName method returns the base name of a file or folder in the
specified path.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      path </td>
    <td> Required. The path for the file or folder whose base name is to be
      returned</td>
  </tr>
</table>
...
Response.Write(fs.GetBaseName(&quot;c:\winnt\cursors\3dgarro.cur&quot;))<br>
set fs=nothing<br>
%&gt;<br>
<br>
Output:<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_getbasename.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_getbasename.asp#top" target="_top">TOP</a> |
		<a href="met_getbasename.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
