...
<title>ASP Copy Method</title>
<style>a.menu_met_copy_folder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Copy</span> Method</h1>
<hr>
...
<hr>
<p>The Copy method copies the specified file or folder from one location to 
another.
</p>
...
FileObject.Copy(destination[,overwrite])<br>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      destination</td>
    <td> Required. Where to copy the file or folder. Wildcard 
    characters are not allowed</td>
  </tr>
  <tr>
    <td>
      overwrite</td>
    <td> Optional. A Boolean value indicating whether an existing file or folder can be overwritten.
      True indicates that the file/folder can be overwritten, false indicates that the
      file/folder
      cannot be overwritten. Default is true. </td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_copy_folder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_copy_folder.asp#top" target="_top">TOP</a> |
		<a href="met_copy_folder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
