...
<title>ASP Session_OnStart and Session_OnEnd Events</title>
<style>a.menu_ev_sess_onend_onstart{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Session_OnStart</span> and <span class="color_h1">Session_OnEnd</span> Events</h1>
<hr>
...
<hr>
<h2>Session_OnStart Event</h2>

<p>The Session_OnStart event occurs when the server creates a session.</p>

<p>This event is placed in the Global.asa file.</p>

<h2>Session_OnEnd Event</h2>

<p>The Session_OnEnd event occurs when the session ends (abandoned or times out).</p>

<p>This event is placed in the Global.asa file.</p>

<p><b>Note:</b> The MapPath method cannot be used in the Session_OnEnd code.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ev_sess_onend_onstart.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ev_sess_onend_onstart.asp#top" target="_top">TOP</a> |
		<a href="ev_sess_onend_onstart.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
