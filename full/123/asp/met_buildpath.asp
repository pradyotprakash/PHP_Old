...
<title>ASP BuildPath Method</title>
<style>a.menu_met_buildpath{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">BuildPath</span> Method</h1>
<hr>
...
<hr>
<p>The BuildPath method appends a name to an existing path.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>
      path </td>
    <td> Required. The path to append a name to</td>
  </tr>
  <tr>
    <td>
      name </td>
    <td> Required. The name to append to the path</td>
  </tr>
</table>
...
path=fs.BuildPath(&quot;c:\mydocuments&quot;,&quot;test&quot;)<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_buildpath.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_buildpath.asp#top" target="_top">TOP</a> |
		<a href="met_buildpath.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
