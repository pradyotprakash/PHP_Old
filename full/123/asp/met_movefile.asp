...
<title>ASP MoveFile Method</title>
<style>a.menu_met_movefile{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">MoveFile</span> Method</h1>
<hr>
...
<hr>
<p>The MoveFile method moves one or more files from one location to another.
</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>source</td>
    <td>Required. The path to the file/files to be moved. Can
      contain wildcard characters in the last component.</td>
  </tr>
  <tr>
    <td>destination</td>
    <td>Required. Where to move the file/files. Cannot contain
...
fs.MoveFile &quot;c:\web\*.gif&quot;,&quot;c:\images\&quot;<br>
set fs=nothing<br>
%&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_movefile.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_movefile.asp#top" target="_top">TOP</a> |
		<a href="met_movefile.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
