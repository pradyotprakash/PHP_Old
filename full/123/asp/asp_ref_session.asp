...
<style>a.menu_asp_ref_session{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_application.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ref_server.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
Return
a unique id for each user. The id is generated by the server.</p>
<p><a target="_blank" href="showasp.asp?filename=demo_gettimeout">A session's timeout</a><br>
Set and return the timeout (in minutes) of a session.</p>
<hr>
...
<table class="reference notranslate">
  <tr>
    <th style="width:32%">Collection</th>
    <th>Description</th>
  </tr>
  <tr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Specifies the character set that will be used when 
    displaying dynamic content</td>
  </tr>
  <tr>
    <td><a href="prop_lcid.asp">LCID</a></td>
    <td>Sets or returns an integer that specifies a location or
  ...
  <tr>
    ...
    <td>Returns a unique id for each user. The unique id is
      generated by the server</td>
  </tr>
  <tr>
    <td><a href="prop_timeout.asp">Timeout</a></td>
    <td>Sets or returns the timeout period (in minutes) for the
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Destroys a user session</td>
  </tr>
  <tr>
    <td><a href="met_contents_remove_sess.asp">Contents.Remove</a></td>
    <td>Deletes an item from the Contents collection</td>
  </tr>
  <tr>
    <td><a href="met_contents_removeall_sess.asp">Contents.RemoveAll()</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_session.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_session.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_session.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
