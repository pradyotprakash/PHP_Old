...
<style>a.menu_asp_ref_dictionary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Dictionary</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="asp_ref_folder.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_ado.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The Dictionary object stores information in name/value pairs.</p>
<hr>
...
How to create a Dictionary object, and then use the Exists method to check if a specified key exists.</p>

<p><a target="_blank" href="showasp.asp?filename=demo_items">Return an array of all items</a><br>
How to use the Items method to return an array of all the items.</p>

<p><a target="_blank" href="showasp.asp?filename=demo_keys">Return an array of all keys</a><br>
How to use the Keys method to return an array of all the keys.</p>

<p><a target="_blank" href="showasp.asp?filename=demo_item">Return the value of an item</a><br>
How to use the Item property to return the value of an item.</p>

<p><a target="_blank" href="showasp.asp?filename=demo_key">Set a key</a><br>
How to use the Key property to set a key in a Dictionary object.</p>

<p><a target="_blank" href="showasp.asp?filename=demo_count">Return the number of key/item pairs</a><br>
How to use the Count property to return the number of key/item pairs.</p>
<hr>
...
<ul>
  ...
  <li>When deleting an item from a Dictionary, the remaining items will   automatically shift up</li>
  <li>Dictionaries cannot be multidimensional, Arrays can</li>
  <li>Dictionaries have more built-in functions than Arrays</li>
  <li>Dictionaries work better than arrays on accessing random elements frequently</li>
...
&lt;%<br>
Dim d<br>
Set d=Server.CreateObject(&quot;Scripting.Dictionary&quot;)<br>
d.Add &quot;re&quot;,&quot;Red&quot;<br>
d.Add &quot;gr&quot;,&quot;Green&quot;<br>
d.Add &quot;bl&quot;,&quot;Blue&quot;<br>
d.Add &quot;pi&quot;,&quot;Pink&quot;<br>
...
%&gt;<br><br>
Output:<br><br>
The value of key gr is: Green</div></div>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Sets or returns the value of an item in a Dictionary object</td>
  </tr>
  <tr>
    <td><a href="prop_key.asp">Key</a></td>
    <td>Sets a new key value for an existing key value in a 
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Returns an array of all the items in a Dictionary
      object</td>
  </tr>
  <tr>
    <td><a href="met_keys.asp">Keys</a></td>
    <td>Returns an array of all the keys in a Dictionary
      object</td>
  </tr>
  <tr>
    <td><a href="met_remove.asp">Remove</a></td>
    <td>Removes one specified key/item pair from the Dictionary 
    object</td>
  </tr>
  <tr>
    <td><a href="met_removeall.asp">RemoveAll</a></td>
    <td>Removes all the key/item pairs in the Dictionary object</td>
  </tr>
</table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_ref_dictionary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_ref_dictionary.asp#top" target="_top">TOP</a> |
		<a href="asp_ref_dictionary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
