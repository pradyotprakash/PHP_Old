...
<style>a.menu_asp_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="asp_install.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An ASP file can contain text, HTML tags and scripts. Scripts in an ASP file are executed on the server.</p>
<hr>
...
<ul>
  ...
  <li>When a browser requests an ASP file, IIS passes the request to the ASP engine. The ASP engine reads the ASP file, line by line, and executes the scripts in the file. Finally, the ASP file is returned to the browser as plain HTML</li>
</ul>
<hr>
...
<ul>
  ...
  <li>Customize a Web page to make it more useful for individual users</li>
  <li>The advantages of using ASP instead of CGI and Perl, are those of simplicity and speed</li>
  <li>Provide security - since ASP code cannot be viewed from the browser</li>
...
<td><b>Note:</b> Because ASP scripts are executed on the server, the browser that displays the ASP file does not need to support scripting at all!</td>
</tr></table>
<br><br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="asp_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="asp_intro.asp#top" target="_top">TOP</a> |
		<a href="asp_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
