...
<title>ASP MapPath Method</title>
<style>a.menu_met_mappath{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">MapPath</span> Method</h1>
<hr>
...
<hr>
<p>The MapPath method maps a specified path to a physical path.</p>

<p><b>Note:</b> This method cannot be used in Session.OnEnd and Application.OnEnd.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>path </td>
    <td> Required. A relative or virtual path to map to a physical
...
<h2>Examples</h2>
<h3>Example 1</h3>
<p>For the example below, the file &quot;test.asp&quot; is located in C:\Inetpub\Wwwroot\Script.</p>
<p>The file &quot;test.asp&quot; (located in C:\Inetpub\Wwwroot\Script) contains the following code:</p>
<div class="code notranslate"><div>

&lt;%<br>
response.write(Server.MapPath(&quot;test.asp&quot;) &amp; &quot;&lt;br>&quot;)<br>
response.write(Server.MapPath(&quot;script/test.asp&quot;) &amp; &quot;&lt;br>&quot;)<br>
response.write(Server.MapPath(&quot;/script/test.asp&quot;) &amp; &quot;&lt;br>&quot;)<br>
response.write(Server.MapPath(&quot;\script&quot;) &amp; &quot;&lt;br>&quot;)<br>
...
c:\inetpub\wwwroot\script\script\test.asp<br>
c:\inetpub\wwwroot\script\test.asp<br>
...
<h3>Example 2</h3>
<p>How to use a relative path to return the relative physical path to the page that is being viewed in the
browser:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_mappath.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_mappath.asp#top" target="_top">TOP</a> |
		<a href="met_mappath.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
