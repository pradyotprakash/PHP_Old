...
<title>ASP GetTempName Method</title>
<style>a.menu_met_gettempname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">GetTempName</span> Method</h1>
<hr>
...
<hr>
<p>The GetTempName method returns a randomly generated temporary file or folder.</p>
...
&lt;%<br>
dim fs,tfolder,tname, tfile<br>
Set fs=Server.CreateObject(&quot;Scripting.FileSystemObject&quot;)&nbsp;<br>
Set tfolder=fs.GetSpecialFolder(2)<br>
tname=fs.GetTempName<br>
Set tfile=tfolder.CreateTextFile(tname)&nbsp;<br>
Response.write (tfile)<br>
%><br>
<br>
Output:<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_gettempname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_gettempname.asp#top" target="_top">TOP</a> |
		<a href="met_gettempname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
