...
<title>ASP Charset Property</title>
<style>a.menu_prop_charset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP <span class="color_h1">Charset</span> Property</h1>
<hr>
...
<hr>
<p>The Charset property appends the name of a character-set to the
      content-type header in the Response object. Default character set is
ISO-LATIN-1.</p>

<p><b>Note:</b> This property will accept any string, regardless of whether it
is a valid character set or not, for the name.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>charsetname </td>
    <td> A string that specifies a character set for the page</td>
  </tr>
</table>
<h3>Examples</h3>
<p>If an ASP page has no Charset property set, the content-type header would be:</p>
<div class="code notranslate"><div>

content-type:text/html

</div></div>
<p>If we included the Charset property:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_charset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_charset.asp#top" target="_top">TOP</a> |
		<a href="prop_charset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
