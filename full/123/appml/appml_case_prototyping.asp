...
<title>AppML Case Prototyping</title>
<style>a.menu_appml_case_prototyping{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">&lt;AppML&gt; </span>Case Study - Prototyping</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="appml_case_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="appml_case_models.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<hr>
<h2>Prototyping</h2>
<p>In this chapter we will set up a prototype model for each table in the database.</p>
<p>Prototypes are very handy starting point for developing applications.</p>

<hr>

<h2>Prototype Models</h2>
<p>First, create a folder for the prototypes. Name the folder Prototypes.</p>
<p>Then, create a prototype model for each table in the database. </p>
<p>Use SELECT * from each table, and save the models as XML files: </p>
<div class="example">
<h2 class="example">Model:&nbsp;Proto_Customers.xml</h2>
...
<br>
<h2 class="example">Model:&nbsp;Proto_Suppliers.xml</h2>
<div class="example_code notranslate">
&lt;appml&gt;<br>
&lt;datasource&gt;<br>
&nbsp; &lt;database&gt;<br>
...
<br>
<h2 class="example">Model: Proto_Products.xml</h2>
<div class="example_code notranslate">
&lt;appml&gt;<br>
&lt;datasource&gt;<br>
&nbsp; &lt;database&gt;<br>
...
<h2>Prototype Views</h2>
<p>Create a&nbsp;prototype view, save it as Demo_Prototype.html, and try it 
yourself:</p>
<div class="example">
<h2 class="example">View: Demo_Prototype.htm</h2>
<div class="example_code notranslate">
	&lt;h1&gt;Customers&lt;/h1&gt;<br>&lt;div id=&quot;List01&quot;&gt;&lt;/div&gt;<br><br>&lt;script src=&quot;appml.js&quot;&gt;&lt;/script&gt;<br>
	&lt;script&gt;<br>customers=new 
	AppML(&quot;appml.aspx&quot;,&quot;Prototypes/Customers&quot;);<br>customers.run(&quot;List01&quot;);<br>&lt;/script&gt;</div>
<br><a class="tryitbtn" href="tryit.asp?filename=Demo_Prototype" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>All Together Now</h2>
<p>Finally, with a little JavaScript coding, create a simple 
prototype page for all prototype models:</p>
<div class="example">
...
<div class="example_code notranslate">
	...
	AppML(&quot;appml.aspx&quot;,&quot;Prototypes/&quot; + pname);<br>app_obj.run(&quot;Place01&quot;);<br>}<br>
	&lt;/script&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<br><a class="tryitbtn" href="Demo_Prototype_Views.htm" target="_blank">Show it &raquo;</a>
</div>
<br>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="appml_case_prototyping.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="appml_case_prototyping.asp#top" target="_top">TOP</a> |
		<a href="appml_case_prototyping.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
