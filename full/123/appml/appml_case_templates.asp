...
<title>AppML Case Templates</title>
<style>a.menu_appml_case_templates{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">&lt;AppML&gt; </span>Case Study - HTML Templates</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="appml_case_models.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="appml_case_employees.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<hr>
<h2>Adding HTML Templates</h2>
<p>In this chapter we will demonstrate how to add HTML templates to HTML pages.</p>
...
&lt;td&gt;#Country#&lt;/td&gt;<br>&lt;/tr&gt;<br>&lt;/table&gt; <br><br>&lt;script src=&quot;appml.js&quot;&gt;&lt;/script&gt;<br>
	...
	customers=new AppML(&quot;appml.aspx&quot;,&quot;Models/Customers&quot;);<br>
	customers.run(&quot;List01&quot;,&quot;Template01&quot;);<br>&lt;/script&gt;</div>
<br><a class="tryitbtn" href="tryit.asp?filename=App_Customers_List" target="_blank">Try it yourself &raquo;</a>
</div>
<br>

<hr>

<h2>List Customers and Customers Forms</h2>
<p>Links between &lt;AppML&gt; list objects, and &lt;AppML&gt; forms can easily be added, using clever templates:</p>
<div class="example">
<h2 class="example">HTML - View</h2>
<div class="example_code notranslate">
...
customerForm=new AppML(&quot;appml.aspx&quot;,&quot;Models/Customers&quot;);<br>
customerForm.displayType=&quot;form&quot;;<br>customerForm.run(&quot;Form01&quot;,&quot;&quot;,id);<br>}<br>
&lt;/script&gt;
</div>
<br><a class="tryitbtn" href="tryit.asp?filename=App_Customers_Form" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
<hr>

<h2>List Customers and Customers Orders</h2>
<p>Links between &lt;AppML&gt; list objects and linked lists, can easily be added, using clever templates:</p>
<div class="example">
<h2 class="example">HTML - View</h2>
<div class="example_code notranslate">
...
&lt;td&gt;#Salesperson#&lt;/td&gt;<br>&lt;td&gt;#ShipperName#&lt;/td&gt;<br>&lt;/tr&gt;<br>&lt;/table&gt; <br>
<br>&lt;script src=&quot;appml.js&quot;&gt;&lt;/script&gt;<br>&lt;script&gt;<br>var customers,orders;<br>
customers=new AppML(&quot;appml.aspx&quot;,&quot;Models/Customers&quot;);<br>
customers.run(&quot;List01&quot;,&quot;Template01&quot;);<br>function openOrders(id)<br>{<br>
orders=new AppML(&quot;appml.aspx&quot;,&quot;Models/Orders&quot;);<br>
orders.setQuery(&quot;orders.customerid&quot;,id);<br>orders.commands=false;<br>
orders.run(&quot;Orders01&quot;,&quot;Template02&quot;);<br>}<br>&lt;/script&gt;
</div>
<br><a class="tryitbtn" href="tryit.asp?filename=App_Customers_Orders" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
<p>Finally, with a little code copying, we can finalize the project.</p>
<div class="example">

<h2 class="example">Customers List, Form, and Orders</h2>
<div class="example_code notranslate">
...
Customers=new AppML(&quot;appml.aspx&quot;,&quot;Models/Customers&quot;);<br>Customers.run(&quot;List01&quot;);<br>
<br>function openOrders(id)<br>{<br>var Orders=new 
AppML(&quot;appml.aspx&quot;,&quot;Models/Orders&quot;);<br>Orders.setQuery(&quot;orders.customerid&quot;,id);<br>
Orders.commands=false;<br>
Orders.run(&quot;List02&quot;);<br>}<br>&lt;/script&gt;</div>
<br><a class="tryitbtn" href="tryit.asp?filename=App_Customers" target="_blank">Try it yourself &raquo;</a>
</div>
<p>In the next chapters, you can see more applications with full source code.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="appml_case_templates.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="appml_case_templates.asp#top" target="_top">TOP</a> |
		<a href="appml_case_templates.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
