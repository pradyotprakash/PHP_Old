...
<title>AppML Case Intro</title>
<style>a.menu_appml_case_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">&lt;AppML&gt; </span>Case Study - Introduction</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="appml_reference.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="appml_case_prototyping.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">This case study demonstrates how to build a full &lt;AppML&gt; 
Internet application, with functions for listing, editing, and searching 
information from several tables in a database.</p>

<hr>

<h2>What We Will Build</h2>
<p>We will use an existing database called Demo.</p>
<p>For each table in the database we will: </p>
<ul>
	<li>Create prototype models</li>
	<li>Create prototype HTML pages</li>
	<li>Create application models</li>
	<li>&nbsp;Create HTML templates</li>
	<li>Create full applications</li>
</ul>

<hr>

<h2>The Demo Database</h2>
<p>For the case study we have used a subset of the Northwind database that comes 
preinstalled with MS Office.</p>
<p>This database is well known to many, and easy available for testing using 
both PHP, Classic ASP, and ASP.NET.</p>
<p>The demo database contains several tables with data much like this:</p>
<h2>Customers</h2>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="appml_reference.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="appml_case_prototyping.asp">Next 
	Chapter &raquo;</a></div>
</div>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="appml_case_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="appml_case_intro.asp#top" target="_top">TOP</a> |
		<a href="appml_case_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
