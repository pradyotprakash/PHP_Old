...
<title>jQuery pageloadfailed Event</title>
<style>a.menu_event_pageloadfailed{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pageloadfailed</span> Event</h1>
...
<div class="example_code notranslate">
    ...
    $(document).on(&quot;pageloadfailed&quot;,function(){<br>&nbsp; alert(&quot;Sorry, 
	requested page does not exist.&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pageloadfailed">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The pageloadfailed event was deprecated in jQuery version 1.4.0. Use the
<a href="event_pagecontainerloadfailed.asp">pagecontainerloadfailed</a> event instead.</span></p>
<p>The pageloadfailed event is triggered if the page load request fails.</p>
<p><strong>Related events:</strong></p>
<ul>
	<li><a href="event_pagebeforeload.asp">pagebeforeload</a> - triggered before any load request is made</li>
	<li><a href="event_pageload.asp">pageload</a> - triggered after the page has been successfully loaded and 
...
are fired. The first is pagebeforeload. The 2nd event will either be pageload or 
pageloadfailed.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pageloadfailed event occurs.
...
<p>
<a href="tryit.asp?filename=tryjqmob_events_pageload" target="_blank">A demonstration of 
related events</a><br>A demonstration of pageload and pageloadfailed.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pageloadfailed_func" target="_blank">The event object</a><br>
Using the event.type property to return the triggered event type.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pageloadfailed_url" target="_blank">The data object</a><br>
Using data.url 
to return the URL of the unsuccessful page load.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pageloadfailed_error" target="_blank">The data object</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pageloadfailed.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pageloadfailed.asp#top" target="_top">TOP</a> |
		<a href="event_pageloadfailed.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
