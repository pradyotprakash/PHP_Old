...
<title>jQuery pagebeforehide Event</title>
<style>a.menu_event_pagebeforehide{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pagebeforehide</span> Event</h1>
...
<p>Alert some text when the page we are transitioning away <strong>from</strong>, is about to be 
hidden:</p>
<div class="example_code notranslate">
  
    $(document).on(&quot;pagebeforehide&quot;,&quot;#pagetwo&quot;,function(){<br>&nbsp; alert(&quot;pagebeforehide 
	event fired - pagetwo is about to be hidden&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pagebeforehide">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pagebeforehide event is triggered on the &quot;from&quot; page, before the transition 
animation starts.</p>
...
<ul>
	...
	completes</li>
	<li><a href="event_pagebeforeshow.asp">pagebeforeshow</a> - Triggered on the &quot;to&quot; page, 
	before the transition animation 
	completes</li>
	<li><a href="event_pageshow.asp">pageshow</a> - Triggered on the &quot;to&quot; page, 
	after the transition animation completes</li>
</ul>
...
<div class="code notranslate"><div> 
    ...
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pagebeforehide2">Try it</a>
</div>
</div>
<p>To trigger the event for a specific page:</p>
<div class="code notranslate"><div> 
    $(&quot;document&quot;).on(&quot;pagebeforehide&quot;,&quot;<em>page</em>&quot;,function(event){...})
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pagebeforehide">Try it</a>
</div>
</div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pagebeforehide event occurs.
	...
	properties (e.g. event.target, event.type, etc.) See
		...
		nextPage, which returns the page we are transitioning to</li>
	</ul>
	  </td>
  </tr>
   <tr>
    <td><em>page</em></td>
    <td>Optional. Points to the id of the page to specify the pagebeforehide event for. 
...
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagebeforehide_func" target="_blank">The event object</a><br>
Using the event.timeStamp property.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagebeforehide_data" target="_blank">The 
data object</a><br>
Using the nextPage property to return the page we are transitioning to.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pagebeforehide.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pagebeforehide.asp#top" target="_top">TOP</a> |
		<a href="event_pagebeforehide.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
