...
<title>jQuery Mobile Form Select</title>
<style>a.menu_jquerymobile_form_select{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Mobile <span class="color_h1">Form Select Menus</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquerymobile_form_inputs.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquerymobile_form_sliders.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>jQuery Mobile Select Menus</h2>
<div style="text-align:center;">
<div style="float:left;text-align:center;width:410px;" class="desc">Select Menu on an Iphone:</div>
<div style="float:right;text-align:center;width:410px;" class="desc">Select Menu on an Android/SGS4 device:</div><br>
<img src="selectmenu.jpg" style="margin-left:9px;">
</div>

<p>The &lt;select&gt; element creates a drop-down 
list with several options. </p>
<p>The &lt;option&gt; elements inside the &lt;select&gt; element define the available options in 
the list:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
		&lt;form method=&quot;post&quot; action=&quot;demoform.asp&quot;&gt;<br>&nbsp; &lt;fieldset 
		class=&quot;ui-field-contain&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;label 
		for=&quot;day&quot;&gt;Select Day&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; &lt;select name=&quot;day&quot; id=&quot;day&quot;&gt;<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;option value=&quot;mon&quot;&gt;Monday&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;option value=&quot;tue&quot;&gt;Tuesday&lt;/option&gt;<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;option value=&quot;wed&quot;&gt;Wednesday&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/select&gt;<br>
		&nbsp;
		&lt;/fieldset&gt;<br>
		&lt;/form&gt;<br></div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_forms_select">Try it yourself &raquo;</a></div>
<p><strong>Tip:</strong> If you have a long list of options that are related, 
use the &lt;optgroup&gt; element inside &lt;select&gt;:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
		&lt;select name=&quot;day&quot; id=&quot;day&quot;&gt;<br>&nbsp;&nbsp;&lt;optgroup 
		label=&quot;Weekdays&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option value=&quot;mon&quot;&gt;Monday&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; 
		&lt;option value=&quot;tue&quot;&gt;Tuesday&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
		value=&quot;wed&quot;&gt;Wednesday&lt;/option&gt;<br>&nbsp; &lt;/optgroup&gt;<br>&nbsp; &lt;optgroup 
		label=&quot;Weekends&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
		value=&quot;sat&quot;&gt;Saturday&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
		value=&quot;sun&quot;&gt;Sunday&lt;/option&gt;<br>&nbsp; &lt;/optgroup&gt;<br>&lt;/select&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_forms_select_optgroup">Try it yourself &raquo;</a></div>
<br>
<hr>

<h2>Custom Select Menus</h2>
<p>The images on top of this page, shows how mobile platforms have their own way of showing a select menu. </p>
<p>If you want the select menu to display the same on all mobile devices, use jQuery's 
own custom select menu, the data-native-menu="false" attribute:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
		&lt;select name=&quot;day&quot; id=&quot;day&quot; <span class="marked">data-native-menu=&quot;false&quot;</span>&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_forms_select_native">Try it yourself &raquo;</a></div>
<br>
<hr>

<h2>Multiple Selections</h2>
<p>To select multiple options in the select menu, use the multiple attribute in 
the &lt;select&gt; element:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
		&lt;select name=&quot;day&quot; id=&quot;day&quot; 
		<span class="marked">multiple</span> data-native-menu=&quot;false&quot;&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_forms_select_multiple">Try it yourself &raquo;</a></div>
<br>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjqmob_forms_select_group" target="_blank">Using data-role=&quot;controlgroup&quot;</a><br>
How to group one or more selection menus.</p>

<p>
<a href="tryit.asp?filename=tryjqmob_forms_select_horizontal" target="_blank">Using data-type=&quot;horizontal&quot;</a><br>
How to group selection menus horizontally.</p>

<p>
<a href="tryit.asp?filename=tryjqmob_forms_select_mini" target="_blank">Using 
data-type=&quot;mini&quot;</a><br>
How to minify a selection menu.</p>

<p>
<a href="tryit.asp?filename=tryjqmob_forms_select_selected" target="_blank">Pre-selected options</a><br>
How to pre-select an option.</p>

<p>
<a href="tryit.asp?filename=tryjqmob_forms_select_popup" target="_blank">Popup Selections</a><br>
How to create a popup selection menu.</p>

<p>
<a href="tryit.asp?filename=tryjqmob_forms_collapsible" target="_blank">Collapsible Forms</a><br>
How to create collapsible forms.</p>

<p>
<a href="tryit.asp?filename=tryjqmob_forms_select_icon" target="_blank">Changing the default select icon</a><br>
How to change the icon of select menus (default is "arrow-d").</p>

<p>
<a href="tryit.asp?filename=tryjqmob_forms_select_iconpos" target="_blank">Changing the icon position</a><br>
How to change the icon position of select menus (default is right).</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquerymobile_form_select.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquerymobile_form_select.asp#top" target="_top">TOP</a> |
		<a href="jquerymobile_form_select.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
