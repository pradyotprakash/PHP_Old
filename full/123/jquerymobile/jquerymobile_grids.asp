...
<title>jQuery Mobile Grids</title>
<style>a.menu_jquerymobile_grids{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Mobile <span class="color_h1">Grids</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquerymobile_tables.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquerymobile_list_views.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>jQuery Mobile Layout Grids</h2>
<p>jQuery Mobile provides a set of CSS-based column layouts. However, column 
layouts are not generally recommended on a mobile device, due to the mobile's screen 
width. </p>
<p>But there are times you want to position smaller elements, like 
buttons or navigation tabs, side-by-side as if it was in a table. Then, columns 
are perfect.</p>
<p>Columns in a grid are of equal width (and 100% wide in total), with no border, background, 
margin or padding.</p>
<p>There are five layout grids that can be used:</p>
<table class="reference notranslate">
<tr>
<th style="width:18%">Grid Class</th>
<th style="width:12%">Columns</th>
<th style="width:36%">Column Widths</th>
...
<td>Within the column container, child elements can have the class 
ui-block-a|b|c|d|e, depending on the number of columns. The columns will float side-by-side. 
<br><br><strong>Example 1:</strong> For the ui-grid-a class (which is a 
two-column layout), you must specify two child elements of ui-block-a and ui-block-b.
<br><br><strong>Example 2:</strong> For ui-grid-b (three-column layout), add three child elements of ui-block-a, 
ui-block-b and ui-block-c.</td>
</tr></table>
<br>
<hr>

<h2>Customize Grids</h2>
<p>You can customize your column blocks by using CSS:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
		&lt;style&gt;<br>.ui-block-a, <br>.ui-block-b, <br>.ui-block-c <br>{<br>
		background-color: lightgray;<br>border: 1px solid black;<br>height: 
		100px;<br>font-weight: bold;<br>text-align: center;<br>padding: 30px;<br>
		}<br>&lt;/style&gt;<br></div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_grid_css">Try it yourself &raquo;</a></div>
<p>You can also customize your blocks by using inline styles:</p>
<div class="code notranslate">
<div class="auto-style1">
	&lt;div class="ui-block-a" style="border:1px solid 
	black;"&gt;&lt;span&gt;Text..&lt;/span&gt;&lt;/div&gt;</div>
</div>
<br>
<hr>

<h2>Multiple Rows</h2>
<p>It is also possible to have have multiple rows inside your columns.</p>
<p><strong>Note:</strong> The ui-block-a-class will always create a new line:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
		&lt;div class=&quot;ui-grid-b&quot;&gt;<br>&nbsp; &lt;div class=&quot;ui-block-a&quot;&gt;&lt;span&gt;Some 
		Text&lt;/span&gt;&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;ui-block-b&quot;&gt;&lt;span&gt;Some 
		Text&lt;/span&gt;&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;ui-block-c&quot;&gt;&lt;span&gt;Some 
		Text&lt;/span&gt;&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;ui-block-a&quot;&gt;&lt;span&gt;Some 
		Text&lt;/span&gt;&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;ui-block-b&quot;&gt;&lt;span&gt;Some 
		Text&lt;/span&gt;&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;ui-block-a&quot;&gt;&lt;span&gt;Some 
		Text&lt;/span&gt;&lt;/div&gt;<br>&lt;/div&gt;<br></div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_grid_multiple">Try it yourself &raquo;</a></div>
<br>
<hr>

<h2>Responsive Grids</h2>
<p>On small screens, it is not recommended to have too many buttons with text side-by-side on one row - as the text 
might get shortened.</p>
<p>For responsive grids, add the ui-responsive class to the container:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
		&lt;div class=&quot;ui-grid-b <span class="marked">ui-responsive&quot;</span>&gt;<br></div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_grid_responsive">Try it yourself &raquo;</a></div>
<br>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquerymobile_tables.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquerymobile_grids.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquerymobile_grids.asp#top" target="_top">TOP</a> |
		<a href="jquerymobile_grids.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
