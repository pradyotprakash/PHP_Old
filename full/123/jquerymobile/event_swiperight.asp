...
<title>jQuery swiperight Event</title>
<style>a.menu_event_swiperight{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">swiperight</span> Event</h1>
...
<p>Swipe over a &lt;p&gt; element in the right direction to hide it:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).on(&quot;swiperight&quot;,function(){<br>&nbsp; $(this).hide();<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_swiperight">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The swiperight event is triggered when the user press down and swipes over an element in the 
right direction (by more than 30px horizontally and less than 75px vertically).</p>
<p><strong>Related events:</strong></p>
<ul>
	<li><a href="event_swipe.asp">swipe</a> - triggered when the user swipes over an element horizontally 
	(left and right direction)</li>
	<li><a href="event_swipeleft.asp">swipeleft</a> - triggered when the user 
	swipes over an element in the left 
	direction</li>
</ul>
<hr>
...
<div class="code notranslate"><div> 
    $(&quot;<i>selector</i>&quot;).on(&quot;swiperight&quot;,function(event){...})
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the swiperight event occurs.<br>
...
<p>
<a href="tryit.asp?filename=tryjqmob_event_swiperight_function" target="_blank">The 
event object</a><br>
Using the 
event.target property to return which DOM element that triggered the swiperight event.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_swiperight.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_swiperight.asp#top" target="_top">TOP</a> |
		<a href="event_swiperight.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
