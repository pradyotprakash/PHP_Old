...
<style>a.menu_jquerymobile_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Mobile <span class="color_h1">Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquerymobile_install.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">jQuery Mobile is a web framework for creating 
mobile web applications.</p>
<hr>

<h2>What You Should Already Know</h2>
<p>Before you start studying jQuery Mobile, you should have a basic knowledge of:</p>
<ul>
	<li>HTML</li>
	<li>CSS</li>
	<li>jQuery</li>
...
<p>jQuery Mobile is a touch-optimized web framework for creating 
mobile web applications.</p>
<p>jQuery Mobile works on all popular smartphones and tablets:</p>
<img style="margin-top:14px;margin-bottom:12px;" src="jqmsupport.jpg" width="717" height="117">
<p>jQuery Mobile is built on top of the jQuery library, which makes it easy to learn if 
you already know jQuery. </p>
<p>It uses HTML5, CSS3, JavaScript and AJAX to accomplish its work 
for laying out pages with minimal scripting.</p>
<hr>

<h2>Why Use jQuery Mobile?</h2>
<p>jQuery Mobile takes the &quot;write less, do more&quot; to a new level: It 
automatically design web pages with an attractive and &quot;easy-to-use&quot; look, that 
will work the same way on all mobile devices.</p>
...
<ul>
	<li>Android and Blackberry is written in Java</li>
	<li>iOS is written in Objective C</li>
	<li>Windows Phone is written in C# and .net, etc.</li>
</ul>
<strong>jQuery Mobile solves this problem, as it only uses HTML, CSS and 
JavaScript, which is standard for all mobile web browsers!</strong></td>
</tr></table>
<br>
<hr>
<h2>Best Reading Experience</h2>
<p>Even though jQuery Mobile works on all mobile devices, it may have some 
compatibility issues on desktop computers (due to limited CSS3 support). </p>
<p><strong>For this tutorial, we recommend that you use the Google Chrome 
Browser for better reading experience.</strong></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquerymobile_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquerymobile_intro.asp#top" target="_top">TOP</a> |
		<a href="jquerymobile_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
