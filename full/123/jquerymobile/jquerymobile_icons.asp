...
<title>jQuery Mobile Buttons Icons</title>
<style>a.menu_jquerymobile_icons{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Mobile <span class="color_h1">Button Icons</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquerymobile_buttons.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquerymobile_popups.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">jQuery Mobile provides a set of icons that will make your buttons 
look more desirable.</p>
<hr>

<br>
<iframe src="tryjqmob_icon_app.htm" scrolling="no" frameborder="0" width="100%" height="324px" seamless></iframe>
<br><hr>

<h2>Adding Icons to jQuery Mobile Buttons</h2>
<p>To add an icon to your button, use the ui-icon class, and 
position the icon with an icon position class (ui-btn-icon<strong>-</strong><em>pos</em>):</p>
<div class="code notranslate">
<div>
	&lt;a href=&quot;#anylink&quot; class=&quot;ui-btn <span class="marked">ui-icon-search 
	ui-btn-icon-left&quot;</span>&gt;Search&lt;/a&gt;</div>
</div>
<p><strong>Note:</strong> For other buttons, like buttons in list views and 
forms, you must use the data-icon attribute. This will be explained in a later 
chapter.</p>
<p>Below we have listed some available icons that jQuery Mobile provide:</p>

<table class="reference notranslate">
<tr>
<th style="width:40%">Icon class</th>
...
<td><a target="_blank" class="tryitbtn" style="width:77px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=tryjqmob_icon_arrow-r">Try it</a></td>
</tr>
<tr>
<td><span style="text-align:left;">ui-icon-arrow-l</span></td>
<td>Left Arrow</td>
<td style="background-image:url('icons/arrow-l.jpg');background-repeat:no-repeat;background-position:center;"></td>
<td><a target="_blank" class="tryitbtn" style="width:77px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=tryjqmob_icon_arrow-l">Try it</a></td>
</tr>
<tr>
<td>ui-icon-info</td>
<td>Information</td>
<td style="background-image:url('icons/info.jpg');background-repeat:no-repeat;background-position:center;"></td>
<td><a target="_blank" class="tryitbtn" style="width:77px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=tryjqmob_icon_info">Try it</a></td>
</tr>
<tr>
...
<td><a target="_blank" class="tryitbtn" style="width:77px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=tryjqmob_icon_delete">Try it</a></td>
</tr>
<tr>
<td>ui-icon-audio</td>
<td>Speakers</td>
<td style="background-image:url('icons/audio.jpg');background-repeat:no-repeat;background-position:center;"></td>
<td><a target="_blank" class="tryitbtn" style="width:77px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=tryjqmob_icon_audio">Try it</a></td>
</tr>
<tr>
<td>ui-icon-back</td>
<td>Back</td>
<td style="background-image:url('icons/back.jpg');background-repeat:no-repeat;background-position:center;"></td>
<td><a target="_blank" class="tryitbtn" style="width:77px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=tryjqmob_icon_back">Try it</a></td>
</tr>
<tr>
...
<td><a target="_blank" class="tryitbtn" style="width:77px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=tryjqmob_icon_search">Try it</a></td>
</tr>
<tr>
<td>ui-icon-grid</td>
<td>Grid</td>
<td style="background-image:url('icons/grid.jpg');background-repeat:no-repeat;background-position:center;"></td>
<td><a target="_blank" class="tryitbtn" style="width:77px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=tryjqmob_icon_grid">Try it</a></td>
</tr>
<tr>
<td>ui-icon-lock</td>
<td>Padlock</td>
<td style="background-image:url('icons/lock.jpg');background-repeat:no-repeat;background-position:center;"></td>
<td><a target="_blank" class="tryitbtn" style="width:77px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=tryjqmob_icon_lock">Try it</a></td>
</tr>
<tr>
<td>ui-icon-home</td>
<td>Home</td>
<td style="background-image:url('icons/home.jpg');background-repeat:no-repeat;background-position:center;"></td>
<td><a target="_blank" class="tryitbtn" style="width:77px;padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=tryjqmob_icon_home">Try it</a></td>
</tr>
</table>
...
<p>You can specify one of four values for where the icon should be positioned in the button: top, 
right, bottom or left. </p>
<p>Use the ui-btn-icon class to specify the position:</p>
<div class="example">
	<h2 class="example">Icon Position for Link Buttons</h2>
<div class="example_code notranslate">
	&lt;a href=&quot;#anylink&quot; class=&quot;ui-btn <span class="marked">ui-icon-search ui-btn-icon-top&quot;</span>&gt;Top&lt;/a&gt;<br>&lt;a href=&quot;#anylink&quot; 
	class=&quot;ui-btn <span class="marked">ui-icon-search ui-btn-icon-right&quot;</span>&gt;Right&lt;/a&gt;<br>&lt;a href=&quot;#anylink&quot; 
	class=&quot;ui-btn <span class="marked">ui-icon-search ui-btn-icon-bottom&quot;</span>&gt;Bottom&lt;/a&gt;<br>&lt;a href=&quot;#anylink&quot; 
	class=&quot;ui-btn <span class="marked">ui-icon-search ui-btn-icon-left&quot;</span>&gt;Left&lt;/a&gt;<br></div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_icon_positions">Try it yourself &raquo;</a></div>
<br>
...
<td>If you do not specify the icon position for link buttons, the icon 
will not be shown.</td>
</tr></table> 
<br>
<hr>

<h2>Displaying Only The Icon</h2>
<p>To only display the icon, use &quot;notext&quot; as value for icon position:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;a href=&quot;#anylink&quot; class=&quot;ui-btn ui-icon-search 
	<span class="marked">ui-btn-icon-notext&quot;</span>&gt;Search&lt;/a&gt;<br></div>
	<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_icon_notext">Try it yourself &raquo;</a></div>
<br>
<hr>

<h2>Removing The Circle</h2>
<p>By default, all icons have a gray circle (disc) around them. To remove the circle, add the &quot;ui-nodisc-icon&quot; 
class to the element or its container:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;a href=&quot;#anylink&quot; class=&quot;ui-btn ui-icon-search 
	ui-btn-icon-left&quot;&gt;With circle (default)&lt;/a&gt;<br>&lt;a href=&quot;#anylink&quot; class=&quot;ui-btn ui-icon-search 
	ui-btn-icon-left <span class="marked">ui-nodisc-icon&quot;</span>&gt;Without circle&lt;/a&gt;<br></div>
	<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_icon_disc">Try it yourself &raquo;</a></div>
<br>
<hr>

<h2>Black or White Icons</h2>
<p>By default, all icons are white. To change the icon color to black, add the &quot;ui-alt-icon&quot; 
to the element or its container:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;a href=&quot;#anylink&quot; class=&quot;ui-btn ui-icon-search 
	ui-btn-icon-left ui-alt-icon&quot;&gt;White&lt;/a&gt;<br>&lt;a href=&quot;#anylink&quot; class=&quot;ui-btn ui-icon-search 
	ui-btn-icon-left ui-alt-icon <span class="marked">ui-alt-icon&quot;</span>&gt;Black&lt;/a&gt;<br></div>
	<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_icon_alt">Try it yourself &raquo;</a></div>
<br>
<hr>
...
<p><a href="tryit.asp?filename=tryjqmob_icon_disc2" target="_blank">Add the 
&quot;ui-nodisc-icon&quot; class to a container</a><br>
An example of the &quot;ui-nodisc-icon&quot; class added to a container.</p>

<p><a href="tryit.asp?filename=tryjqmob_icon_alt2" target="_blank">Add the 
&quot;ui-alt-icon&quot; class to a container</a><br>
An example of the &quot;ui-alt-icon&quot; class added to a container.</p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquerymobile_icons.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquerymobile_icons.asp#top" target="_top">TOP</a> |
		<a href="jquerymobile_icons.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
