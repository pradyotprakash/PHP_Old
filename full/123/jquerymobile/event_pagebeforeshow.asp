...
<title>jQuery pagebeforeshow Event</title>
<style>a.menu_event_pagebeforeshow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pagebeforeshow</span> Event</h1>
...
<p>Alert some text when the page we are transitioning <strong>to</strong>, is about to be shown:</p>
<div class="example_code notranslate">
  
    $(document).on(&quot;pagebeforeshow&quot;,&quot;#pagetwo&quot;,function(){<br>&nbsp; alert(&quot;pagebeforeshow 
	event fired - pagetwo is about to be shown&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pagebeforeshow">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pagebeforeshow event is triggered on the &quot;to&quot; page, before the transition 
animation starts.</p>
<p><strong>Related events:</strong></p>
<ul>
	<li><a href="event_pageshow.asp">pageshow</a> - Triggered on the &quot;to&quot; page, after the transition animation 
	completes</li>
	<li><a href="event_pagebeforehide.asp">pagebeforehide</a> - Triggered on the &quot;from&quot; page, before the transition 
	animation starts</li>
	<li><a href="event_pagehide.asp">pagehide</a> - Triggered on the &quot;from&quot; page, after the transition animation 
	completes</li>
</ul>
<p><strong>Note:</strong> This event is triggered every time a page transition 
starts/stops.</p>
<hr>
...
<div class="code notranslate"><div> 
    ...
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pagebeforeshow2">Try it</a>
</div>
</div>
<p>To trigger the event for a specific page:</p>
<div class="code notranslate"><div> 
    $(&quot;document&quot;).on(&quot;pagebeforeshow&quot;,&quot;<em>page</em>&quot;,function(event,data){...})
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pagebeforeshow">Try it</a>
</div>
</div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pagebeforeshow event occurs.
	<p>The function has two optional parameters:
	<ul>
		<li><strong>The event object</strong> - which can contain any jQuery event 
	properties (e.g. event.target, event.type, etc.) See
		<a href="../jquery/jquery_ref_events.asp">jQuery Events Reference</a> 
		for more information</li>
		<li><strong>The data object</strong> - contains one property, the 
		prevPage, which returns the page we are transitioning away from</li>
	</ul>
	  </td>
  </tr>
   <tr>
    <td><em>page</em></td>
    <td>Optional. Points to the id of the page to specify the pagebeforeshow event for. 
...
<p>
<a href="tryit.asp?filename=tryjqmob_events_page_transitions" target="_blank">A demonstration of 
related events</a><br>
A demonstration that shows when pagebeforeshow, 
pageshow, pagebeforehide and pagehide fire.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagebeforeshow_func" target="_blank">The event object</a><br>
Using the event.type property to return the triggered event type.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagebeforeshow_data" target="_blank">The 
data object</a><br>
Using the prevPage property to return the page we are transitioning away from.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pagebeforeshow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pagebeforeshow.asp#top" target="_top">TOP</a> |
		<a href="event_pagebeforeshow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
