...
<title>jQuery pageshow Event</title>
<style>a.menu_event_pageshow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pageshow</span> Event</h1>
...
<p>Alert some text when the page we are transitioning <strong>to</strong>, is shown:</p>
<div class="example_code notranslate">
  
    $(document).on(&quot;pageshow&quot;,&quot;#pagetwo&quot;,function(){<br>&nbsp; alert(&quot;pageshow 
	event fired - pagetwo is now shown&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pageshow">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pageshow event is triggered on the &quot;to&quot; page, after the transition 
animation completes.</p>
<p><strong>Related events:</strong></p>
<ul>
	<li><a href="event_pagebeforeshow.asp">pagebeforeshow</a> - Triggered on the &quot;to&quot; page, before the 
	transition animation starts</li>
...
<div class="code notranslate"><div> 
    ...
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pageshow2">Try it</a>
</div>
</div>
<p>To trigger the event for a specific page:</p>
<div class="code notranslate"><div> 
    $(&quot;document&quot;).on(&quot;pageshow&quot;,&quot;<em>page</em>&quot;,function(event,data){...})
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pageshow">Try it</a>
</div>
</div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pageshow event occurs.
   ...
   <tr>
    <td><em>page</em></td>
    <td>Optional. Points to the id of the page to specify the pageshow event for. 
...
<p>
<a href="tryit.asp?filename=tryjqmob_event_pageshow_func" target="_blank">The event object</a><br>
Using the event.type property to return the triggered event type.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pageshow_data" target="_blank">The 
data object</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pageshow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pageshow.asp#top" target="_top">TOP</a> |
		<a href="event_pageshow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
