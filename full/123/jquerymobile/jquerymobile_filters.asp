...
<title>jQuery Mobile Filters</title>
<style>a.menu_jquerymobile_filters{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Mobile <span class="color_h1">Filters</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquerymobile_list_content.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquerymobile_form_basic.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<iframe src="tryjqmob_filters_app.htm" scrolling="no" frameborder="0" width="100%" height="400px" seamless></iframe>
<br>
<hr>

<h2>Filterable Elements</h2>
<p>All elements that have more than one child element, can be filtered. </p>

<p><strong>How To Create a Search Field:</strong></p>
<ul>
	<li>The element you want to be filterable, must include the 
	data-filter=&quot;true&quot; attribute.</li>
	<li>Create an &lt;input&gt; element with a specified id and add the 
	data-type=&quot;search&quot; attribute. This will create a basic search field. Wrap 
	the &lt;input&gt; in a form, and add the &quot;ui-filterable&quot; class to the &lt;form&gt; element - this will adjust the margin 
	between the search field and the filterable element.</li>
	<li>Then, add the data-input attribute to the filterable element. 
	Its value must match the id of the &lt;input&gt; element.</li>
</ul>

<p>Below, we have created a filterable list view:</p>
<div class="example">
<h2 class="example">Search for elements in a list</h2>
<div class="example_code notranslate">
	<span class="marked">&lt;form class=&quot;ui-filterable&quot;&gt;<br>&nbsp; &lt;input id=&quot;myFilter&quot; 
	data-type=&quot;search&quot;&gt;<br>&lt;/form&gt;</span><br><br>&lt;ul data-role=&quot;listview&quot; 
	<span class="marked">data-filter=&quot;true&quot; data-input=&quot;#myFilter&quot;</span>&gt;<br>&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Adele&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
	&lt;li&gt;&lt;a href=&quot;#&quot;&gt;Billy&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Calvin&lt;/a&gt;&lt;/li&gt;<br>
	&lt;/ul&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_lists_filter">Try it yourself &raquo;</a></div>

<p><strong>Tip:</strong> Use a placeholder to specify a short hint that 
describes the expected value of the search field:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;input 
	id=&quot;myFilter&quot; data-type=&quot;search&quot; <span class="marked">placeholder=&quot;Search 
	for names..&quot;</span>&gt;<br></div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_lists_filter_placeholder">Try it yourself &raquo;</a></div>
<br>
<hr>

<h2>Custom Filter</h2>

<p>The text inside each child element is the actual text that is used for filtering (like &quot;Adele&quot; or &quot;B&quot; 
for &quot;Billy&quot;). However, if you want to filter the search to a custom filter text 
instead, you can add the data-filtertext attribute to any child element:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;li <span class="marked">data-filtertext=&quot;fav&quot;</span>&gt;&lt;a href=&quot;#&quot;&gt;Adele&lt;/a&gt;&lt;/li&gt;<br></div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_lists_filtertext">Try it yourself &raquo;</a></div>
<br>
...
<td>If you use the data-filtertext attribute on an 
element, the original text/content of that particular element is ignored for 
filtering (In the 
example above, you are no longer able to search for the list item &quot;Adele&quot;. You can only find Adele by typing the keywords &quot;f, a, v or fav&quot;.)</td>
</tr></table>
<br>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjqmob_filters_collapsibles" target="_blank">Filter Collapsible Lists</a><br>
How to filter a collapsible set of lists.</p>

<p>
<a href="tryit.asp?filename=tryjqmob_filters_tables" target="_blank">Filter Tables</a><br>
How to filter a table.</p>

<p>
<a href="tryit.asp?filename=tryjqmob_filters_div" target="_blank">Filter &lt;div&gt; elements</a><br>
How to filter a &lt;div&gt; element containing child &lt;p&gt; elements.</p>
<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquerymobile_filters.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquerymobile_filters.asp#top" target="_top">TOP</a> |
		<a href="jquerymobile_filters.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
