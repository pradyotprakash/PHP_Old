...
<title>jQuery pagecontainerbeforeload Event</title>
<style>a.menu_event_pagecontainerbeforeload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pagecontainerbeforeload</span> Event</h1>
...
<p>Alert some text before a load request is made:</p>
<div class="example_code notranslate">
  
    $(document).on(&quot;pagecontainerbeforeload&quot;,function(){<br>&nbsp; alert(&quot;pagecontainerbeforeload event 
	fired!&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pagecontainerbeforeload">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pagecontainerbeforeload event is triggered before any load request is made.</p>
...
<ul>
	...
	<li><a href="event_pagecontainerloadfailed.asp">pagecontainerloadfailed</a> - triggered if the page load request fails</li>
</ul>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pagecontainerbeforeload event occurs.
	...
	<ul>
	  ...
	  <strong>Note:</strong> You can manually handle the load request by 
	  calling the event.preventDefault() on the event object and resolve() or 
	  reject() on the deferred object contained in the data object.
	  </td>
  </tr>
  </table>
  <br>
...
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagecontainerbeforeload_func" target="_blank">The event object</a><br>
Using the event.type property to return the triggered event type.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagecontainerbeforeload_url" target="_blank">The data object</a><br>
Using the data.url to return the URL of the external page.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pagecontainerbeforeload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pagecontainerbeforeload.asp#top" target="_top">TOP</a> |
		<a href="event_pagecontainerbeforeload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
