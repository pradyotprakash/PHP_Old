...
<title>jQuery pagecontainerloadfailed Event</title>
<style>a.menu_event_pagecontainerloadfailed{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pagecontainerloadfailed</span> Event</h1>
<p><a href="jquerymobile_ref_events.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="jQuery Mobile Events" /> jQuery Mobile Events</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Alert some text when the page load request fails:</p>
<div class="example_code notranslate">
  
    $(document).on(&quot;pagecontainerloadfailed&quot;,function(){<br>&nbsp; alert(&quot;Sorry, 
	requested page does not exist.&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pagecontainerloadfailed">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pagecontainerloadfailed event is triggered if the page load request fails.</p>
<p><strong>Related events:</strong></p>
<ul>
	<li><a href="event_pagecontainerbeforeload.asp">pagecontainerbeforeload</a> - triggered before any load request is made</li>
	<li><a href="event_pagecontainerload.asp">pagecontainerload</a> - triggered after the page has been successfully loaded and 
	inserted into the DOM.</li>
</ul>
<p><strong>Note:</strong> These events are used for external pages -
Whenever an external page is loaded into the DOM, 2 events 
are fired. The first is pagecontainerbeforeload. The 2nd event will either be pagecontainerload or 
pagecontainerloadfailed.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>function(event,data)</td>
    <td>Required. Specifies the function to run when the pagecontainerloadfailed event occurs.
	<p>The function has two optional parameters:
	<p><strong>The event object</strong> - which can contain any jQuery event 
	properties (e.g. event.target, event.type, etc.) See
	<a href="../jquery/jquery_ref_events.asp">jQuery Events Reference</a> 
		for more information</p>
	<p><strong>The data object</strong> - contains the following:</p>
	<ul>
		<li><strong>url</strong> (string) - contains the absolute or relative URL of the 
		page (that was sent to $.mobile.loadPage())</li>
		<li><strong>absUrl</strong> (string) - contains the absolute reference of the URL</li>
		<li><strong>dataUrl</strong> (string) - contains the URL of the browser's 
		location</li>
		<li><strong>deferred</strong> (object) - contains resolve() or reject()</li>
		<li><strong>options</strong> (object) - contains the options that were sent to $.mobile.loadPage()</li>
		<li><strong>xhr </strong>(object) - contains the XMLHttpRequest object (Sent as the 3rd argument to $.ajax() 
		success callback)</li>
		<li><strong>textStatus</strong> (string or null) - contains the status 
		of the request (&quot;success&quot; or &quot;null&quot;) (Sent as the 2nd argument to $.ajax() error callback)</li>
		<li><strong>errorThrown</strong> - (null, string, object) - When an HTTP 
		error occurs, errorThrown receives the text of the HTTP status, such as 
		&quot;Not Found&quot; or &quot;Internal Server Error (sent as the 3rd argument to $.ajax()&nbsp; 
		error callback)</li>
	</ul>
	  </td>
  </tr>
...
<p>
<a href="tryit.asp?filename=tryjqmob_events_pagecontainerload" target="_blank">A demonstration of 
related events</a><br>A demonstration of pagecontainerload and pagecontainerloadfailed.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagecontainerloadfailed_func" target="_blank">The event object</a><br>
Using the event.type property to return the triggered event type.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagecontainerloadfailed_url" target="_blank">The data object</a><br>
Using data.url 
to return the URL of the unsuccessful page load.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagecontainerloadfailed_error" target="_blank">The data object</a><br>
Using data.errorThrown to return some text when a page is not found.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pagecontainerloadfailed.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pagecontainerloadfailed.asp#top" target="_top">TOP</a> |
		<a href="event_pagecontainerloadfailed.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
