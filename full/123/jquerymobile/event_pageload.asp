...
<title>jQuery pageload Event</title>
<style>a.menu_event_pageload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pageload</span> Event</h1>
...
<div class="example_code notranslate">
    ...
    $(document).on(&quot;pageload&quot;,function(){<br>&nbsp; alert(&quot;pageload event 
	fired!&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pageload">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The pageload event was deprecated in jQuery version 1.4.0. Use the
<a href="event_pagecontainerload.asp">pagecontainerload</a> event instead.</span></p>
<p>The pageload event is triggered after the page has been successfully loaded 
and inserted into the DOM.</p>
<p><strong>Related events:</strong></p>
<ul>
	<li><a href="event_pagebeforeload.asp">pagebeforeload</a> - triggered before 
	any load request is made</li>
	<li><a href="event_pageloadfailed.asp">pageloadfailed</a> - triggered if the 
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pageload event occurs.
...
<p>
<a href="tryit.asp?filename=tryjqmob_event_pageload_func" target="_blank">The event object</a><br>
Using the event.type property to return the triggered event type.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pageload_url" target="_blank">The data object</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pageload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pageload.asp#top" target="_top">TOP</a> |
		<a href="event_pageload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
