...
<style>a.menu_jquerymobile_events_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="jquerymobile_themes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquerymobile_events_touch.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Events = All the different visitor's actions that a web page can 
respond to.</p>
<hr>

<h2>jQuery Mobile Events</h2>
<p>You can use any standard <a href="../jquery/jquery_ref_events.asp">jQuery events</a> in jQuery Mobile.</p> 
<p>In addition, jQuery Mobile also offers several events that are tailor-made for 
mobile-browsing:</p>
<ul>
	<li>Touch events - triggers when a user touches the screen (tap and swipe)</li>
	<li>Scroll events - triggers when a user scrolls up and down</li>
	<li>Orientation events - triggers when the device rotates 
	vertically or horizontally</li>
	<li>Page events - triggers when a page is shown, hidden, created, loaded 
	and/or unloaded</li>
</ul>
...
<h2>Initializing jQuery Mobile Events</h2>
<p>In jQuery, you have learned to use the document ready event to prevent any jQuery 
code from running before the document is finished loading (is ready):</p>

<div class="example">
<h2 class="example">jQuery document ready event</h2>
<div class="example_code notranslate">
	&lt;script&gt;<br>$(document).ready(function(){<br><br>&nbsp;&nbsp; <i>// jQuery methods go here...<br></i><br>
});<br>&lt;/script&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_events_document_ready">Try it yourself &raquo;</a></div>
<p>However, in jQuery Mobile, we use the pagecreate event, which occurs when the 
page has been been created in the DOM, but before enhancement is complete.</p>
<p>The second parameter (&quot;<em>#pageone</em>&quot;) points to the id of the page to 
specify the events for:</p>
<div class="example">
<h2 class="example">jQuery Mobile pagecreate event</h2>
<div class="example_code notranslate">
	&lt;script&gt;<br>$(document).on(&quot;pagecreate&quot;,&quot;#pageone&quot;,function(){<br><br>&nbsp;&nbsp; <i>// jQuery 
	events go here...</i><br>
	<br>});<br>&lt;/script&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_events_pageinit">Try it yourself &raquo;</a></div>
<br>
...
<td>&nbsp;<strong>Note:</strong> The jQuery on() method is used to attach event 
handlers.</td>
</tr></table>
<p>The next chapters will describe each jQuery Mobile 
event in details.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquerymobile_events_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquerymobile_events_intro.asp#top" target="_top">TOP</a> |
		<a href="jquerymobile_events_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
