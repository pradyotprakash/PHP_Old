...
<title>jQuery Mobile Orientation Event</title>
<style>a.menu_jquerymobile_events_orientation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Mobile <span class="color_h1">Orientation Event</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquerymobile_events_scroll.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquerymobile_events_page.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>jQuery Mobile orientationchange Event</h2>
<p>The orientationchange event is triggered when the user rotates the mobile device vertically or horizontally.</p>
<div style="float:left;text-align:center;width:300px;" class="desc"><button id="btn">Rotate horizontally</button></div>
<div style="float:right;text-align:center;width:350px;" class="desc"><button id="btn2">Rotate vertically</button></div><br>
<br><br><br>
<div style="text-align:center;"><img class="iphone" src="iphone5.png" alt="Mobile"></div>
<br>
<br>

<p>To use the orientationchange event, attach it to the window object:</p>
<div class="code notranslate"><div>
	$(window).on(&quot;orientationchange&quot;,function(){<br>&nbsp; alert(&quot;The 
	orientation has changed!&quot;);<br>}); </div></div>
<p>The callback function can have one argument, the event object, which returns 
the orientation of the mobile device: "portrait" (the device is held in a 
vertical position) or "landscape" (the device is held in a horizontal position):</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(window).on(&quot;orientationchange&quot;,function(event){<br>&nbsp; 
	alert(&quot;Orientation is: &quot; + event.orientation);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_events_orientationchange">Try it yourself &raquo;</a></div>
<p>Because the orientationchange event is bound to the window object, we can 
use the window.orientation property to, for example, set different styles to distinguish 
between portrait and landscape views:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(window).on(&quot;orientationchange&quot;,function(){<br>&nbsp; if(window.orientation 
	== 0) // Portrait<br>&nbsp; {<br>&nbsp;&nbsp;&nbsp; $(&quot;p&quot;).css({&quot;background-color&quot;:&quot;yellow&quot;,&quot;font-size&quot;:&quot;300%&quot;});<br>&nbsp; 
	}<br>&nbsp; else // Landscape<br>&nbsp; {<br>&nbsp;&nbsp;&nbsp; $(&quot;p&quot;).css({&quot;background-color&quot;:&quot;pink&quot;,&quot;font-size&quot;:&quot;200%&quot;});<br>&nbsp; 
	}<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_events_orientationchange2">Try it yourself &raquo;</a></div>
<br>
...
<td>The window.orientation property returns 0 for portrait and 90 or -90 for 
landscape view.</td>
</tr></table>
<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquerymobile_events_orientation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquerymobile_events_orientation.asp#top" target="_top">TOP</a> |
		<a href="jquerymobile_events_orientation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
