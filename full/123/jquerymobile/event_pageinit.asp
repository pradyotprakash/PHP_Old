...
<title>jQuery pageinit Event</title>
<style>a.menu_event_pageinit{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pageinit</span> Event</h1>
...
<p>Alert some text when the page has been initialized and enhanced:</p>
<div class="example_code notranslate">
  
    $(document).on(&quot;pageinit&quot;,function(){<br>&nbsp; alert(&quot;pageinit 
	event fired!&quot;)<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pageinit">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The pageinit event was deprecated in jQuery version 1.4.0. Use the
<a href="event_pagecreate.asp">pagecreate</a> event instead.</span></p>
<p>The pageinit event is triggered when the page has been initialized and after 
jQuery Mobile has finished enhancing the page content. </p>
<p>Before version 1.4, this event was used instead of the jQuery DOM ready() 
method, to place all other jQuery events and functions. This is because it will work 
whether the page is loaded directly or through the AJAX call of another page. 
However, as of version 1.4, this has been replaced by the pagecreate event.</p>
<p><strong>Note:</strong> This event is only triggered once per &quot;page&quot; - Every 
time a page is loaded for the first time, jQuery Mobile caches pages in the DOM 
(memory), so when you navigate back from pagetwo to pageone (for 
example), this event will not fire, because then, pageone is already initialized.</p>
<p><strong>Related events:</strong></p>
<ul>
	<li><a href="event_pagebeforecreate.asp">pagebeforecreate</a> - triggered 
	when the page is about to be initialized, but before enhancement has begun</li>
	<li><a href="event_pagecreate.asp">pagecreate</a> - triggered when the page 
	is created, but before enhancement is complete</li>
</ul>
<hr>

<h2>Syntax</h2>
<p>To trigger the event for all pages in jQuery Mobile:</p>
<div class="code notranslate"><div> 
    $(&quot;document&quot;).on(&quot;pageinit&quot;,function(event){...})
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pageinit2">Try it</a>
</div>
</div>
<p>To trigger the event for a specific page:</p>
<div class="code notranslate"><div> 
    $(&quot;document&quot;).on(&quot;pageinit&quot;,&quot;<em>page</em>&quot;,function(event){...})
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pageinit3">Try it</a>
</div>
</div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pageinit event occurs<br>
	<br>The function has an optional event object, which can contain any jQuery event 
	properties (e.g. event.target, event.type, etc.) See
	<a href="../jquery/jquery_ref_events.asp">jQuery Events Reference</a> for 
	more information.</td>
  </tr>
   <tr>
    <td><em>page</em></td>
    <td>Optional. Points to the id of the page to specify the pageinit event for. 
	For internal pages, use <em>#id</em>. For external pages, use <em>
	externalfile.html</em>.</td>
  </tr>
  </table>
  <br>
<hr>
...
<p>
<a href="tryit.asp?filename=tryjqmob_events_page_initialization" target="_blank">A demonstration of pagebeforecreate 
and pagecreate</a><br>
A demonstration that shows when pagebeforecreate and pagecreate fire.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pageinit_function" target="_blank">The event object</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pageinit.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pageinit.asp#top" target="_top">TOP</a> |
		<a href="event_pageinit.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
