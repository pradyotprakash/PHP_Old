...
<title>jQuery pagebeforeload Event</title>
<style>a.menu_event_pagebeforeload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pagebeforeload</span> Event</h1>
...
<div class="example_code notranslate">
    ...
    $(document).on(&quot;pagebeforeload&quot;,function(){<br>&nbsp; alert(&quot;pagebeforeload event 
	fired!&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pagebeforeload">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p><span class="deprecated">The pagebeforeload event was deprecated in jQuery version 1.4.0. Use the
<a href="event_pagecontainerbeforeload.asp">pagecontainerbeforeload</a> event instead.</span></p>
<p>The pagebeforeload event is triggered before any load request is made.</p>
...
<ul>
	...
	<li><a href="event_pageloadfailed.asp">pageloadfailed</a> - triggered if the page load request fails</li>
</ul>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pagebeforeload event occurs.
...
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagebeforeload_func" target="_blank">The event object</a><br>
Using the event.type property to return the triggered event type.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagebeforeload_url" target="_blank">The data object</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pagebeforeload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pagebeforeload.asp#top" target="_top">TOP</a> |
		<a href="event_pagebeforeload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
