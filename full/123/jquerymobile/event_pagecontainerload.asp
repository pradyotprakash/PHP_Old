...
<title>jQuery pagecontainerload Event</title>
<style>a.menu_event_pagecontainerload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pagecontainerload</span> Event</h1>
...
<p>Alert some text when the external page has been successfully loaded and 
inserted into the DOM:</p>
<div class="example_code notranslate">
  
    $(document).on(&quot;pagecontainerload&quot;,function(){<br>&nbsp; alert(&quot;pagecontainerload event 
	fired!&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pagecontainerload">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pagecontainerload event is triggered after the page has been successfully loaded 
and inserted into the DOM.</p>
<p><strong>Related events:</strong></p>
<ul>
	<li><a href="event_pagecontainerbeforeload.asp">pagecontainerbeforeload</a> - triggered before 
	any load request is made</li>
	<li><a href="event_pagecontainerloadfailed.asp">pagecontainerloadfailed</a> - triggered if the 
	page load request fails</li>
</ul>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pagecontainerload event occurs.
	...
	<ul>
		...
		<li><strong>xhr </strong>(object) - contains the XMLHttpRequest object 
		(Sent as the 3rd argument to $.ajax() 
		success callback)</li>
...
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagecontainerload_func" target="_blank">The event object</a><br>
Using the event.type property to return the triggered event type.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagecontainerload_url" target="_blank">The data object</a><br>
Using data.url to return the URL of the external page.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pagecontainerload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pagecontainerload.asp#top" target="_top">TOP</a> |
		<a href="event_pagecontainerload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
