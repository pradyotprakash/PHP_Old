...
<title>jQuery Mobile Scroll Events</title>
<style>a.menu_jquerymobile_events_scroll{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Mobile <span class="color_h1">Scroll Events</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquerymobile_events_touch.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquerymobile_events_orientation.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">jQuery Mobile provides two scroll events: when scrolling starts 
and when scrolling stops.</p>
<hr>

<h2>jQuery Mobile Scrollstart</h2>
...
<div class="example_code notranslate">
	...
	scrolling!");<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_events_scrollstart">Try it yourself &raquo;</a></div>
<br>
...
<td><strong>Note:</strong> iOS devices freeze DOM manipulation during scrolls, 
which means that it is not possible to change something when the user scrolls. However, the jQuery team are working on a solution for this.</td>
</tr></table>
<br>
<hr>

<h2>jQuery Mobile Scrollstop</h2>
<p>The scrollstop event is triggered when the user stops to scroll the page:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	$(document).on("scrollstop",function(){<br>&nbsp; alert("Stopped scrolling!");<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_events_scrollstop">Try it yourself &raquo;</a></div>
<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquerymobile_events_scroll.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquerymobile_events_scroll.asp#top" target="_top">TOP</a> |
		<a href="jquerymobile_events_scroll.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
