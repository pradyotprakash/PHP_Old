...
<title>jQuery pagecreate Event</title>
<style>a.menu_event_pagecreate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pagecreate</span> Event</h1>
...
<p>Alert some text when the page has been created, but before enhancement is 
complete:</p>
<div class="example_code notranslate">
  
    $(document).on(&quot;pagecreate&quot;,function(){<br>&nbsp; alert(&quot;pagecreate 
	event fired!&quot;)<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pagecreate">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pagecreate event is triggered when the page has been created in the DOM 
(via ajax or other), but before jQuery Mobile has finished enhancing the page.</p>
<p>Use this event instead of the jQuery DOM ready() method to place all other 
jQuery events and functions, because it will work 
whether the page is loaded directly or through the AJAX call of another page. 
<strong>Note:</strong> Before version 1.4, we used the pageinit event 
(deprecated) to handle this.</p>
...
<p><strong>Tip:</strong> This event is also useful for user's that want to create 
their own custom widget enhancement:</p>
<div class="code notranslate"><div>
	$(document).on(&quot;pagecreate&quot;,&quot;#pagetwo&quot;,function(event){<br>&nbsp; $.(&quot;:jqmData(role='my-plugin')&quot;).myPlugin();<br>
	});</div></div>
<p><strong>Related events:</strong></p>
<ul>
	<li><a href="event_pagebeforecreate.asp">pagebeforecreate</a> - triggered when the page 
	is 
	about to be initialized, but before enhancement has begun</li>
</ul>
<hr>
...
<div class="code notranslate"><div> 
    ...
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pagecreate2">Try it</a>
</div>
</div>
<p>To trigger the event for a specific page:</p>
<div class="code notranslate"><div> 
    $(&quot;document&quot;).on(&quot;pagecreate&quot;,&quot;<em>page</em>&quot;,function(event){...})
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pagecreate3">Try it</a>
</div>
</div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pagecreate event occurs<br>
   ...
   <tr>
    <td><em>page</em></td>
    <td>Optional. Points to the id of the page to specify the pagecreate event for. 
...
and pagecreate fire.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagecreate_function" target="_blank">The event object</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pagecreate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pagecreate.asp#top" target="_top">TOP</a> |
		<a href="event_pagecreate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
