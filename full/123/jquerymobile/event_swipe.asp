...
<style>a.menu_event_swipe{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">swipe</span> Event</h1>
...
<p>Swipe over a &lt;p&gt; element to hide it:</p>
<div class="example_code notranslate">
  
    $(&quot;p&quot;).on(&quot;swipe&quot;,function(){<br>&nbsp; $(this).hide();<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_swipe">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The swipe event is triggered when the user press down and swipes over an element 
horizontally by more than 30px (and less than 75px vertically).</p>
<p><strong>Tip:</strong> You can swipe in both right and left direction.</p>
<p><strong>Related events:</strong></p>
<ul>
	<li><a href="event_swipeleft.asp">swipeleft</a> - triggered when the user 
	swipes over an element in the left direction</li>
...
<div class="code notranslate"><div> 
    $(&quot;<i>selector</i>&quot;).on(&quot;swipe&quot;,function(event){...})
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the swipe event occurs<br>
...
<p>
<a href="tryit.asp?filename=tryjqmob_event_swipe_function" target="_blank">The 
event object</a><br>
Using the 
event.target property to return which DOM element that triggered the swipe event.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_swipe.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_swipe.asp#top" target="_top">TOP</a> |
		<a href="event_swipe.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
