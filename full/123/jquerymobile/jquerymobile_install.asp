...
<title>jQuery Mobile Install</title>
<style>a.menu_jquerymobile_install{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Mobile <span class="color_h1">Install</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquerymobile_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquerymobile_pages.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>Adding jQuery Mobile to Your Web Pages</h2>
<p>There are two ways to start using jQuery Mobile on your web site. You can:</p>
<ul>
	<li>Include jQuery Mobile from a CDN (recommended)</li>
	<li>Download the jQuery Mobile library from jQuerymobile.com</li>
</ul>
<hr>
<h2>Include jQuery Mobile From a CDN</h2>
...
<td>A CDN (Content Delivery Network) is used to distribute often-used files 
across the web, making download speed faster for the user.</td>
</tr></table>
<p>As with jQuery core, there is nothing to install on your computer; you just 
include the following stylesheet (.css) and JavaScript libraries (.js) directly into your 
HTML page in able to get jQuery Mobile to work:</p>
<div class="example">
<h2 class="example">jQuery Mobile CDN:</h2>
<div class="example_code notranslate">
&lt;head&gt;<br>&lt;meta name=&quot;viewport&quot; content=&quot;width=device-width, 
	initial-scale=1&quot;&gt;<br>
	&lt;link rel=&quot;stylesheet&quot; href=&quot;http://code.jquery.com/mobile/1.4.1/jquery.mobile-1.4.1.min.css&quot;&gt;<br>
	&lt;script src=&quot;http://code.jquery.com/jquery-1.10.2.min.js&quot;&gt;&lt;/script&gt;<br>
	&lt;script src=&quot;http://code.jquery.com/mobile/1.4.1/jquery.mobile-1.4.1.min.js&quot;&gt;&lt;/script&gt;<br>
&lt;/head&gt;
</div>
<br><a target="_blank" href="tryit.asp?filename=tryjqmob_lib_jquery" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<table class="lamp" id="table2"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>The meta viewport tag in &lt;head&gt; specifies how the browser should 
control the page zoom level and dimensions. By default, mobile devices assume 
that pages are about 900 pixels wide. This is to make it work well 
with existing desktop sites, but the screens may look zoomed out and too wide. By 
setting the viewport attributes, the browser is set to the screen width of the 
device - and the content remains at the correct scale.</td>
</tr></table>
<br>
<hr>

<h2>Downloading jQuery Mobile</h2>
<p>If you want to host jQuery Mobile yourself, you can download the files from
<a target="_blank" href="http://jquerymobile.com/download/">jQuerymobile.com</a>.</p>

<div class="code notranslate"><div>
&lt;head&gt;<br>&lt;meta name=&quot;viewport&quot; content=&quot;width=device-width, 
	initial-scale=1&quot;&gt;<br>
	&lt;link rel=&quot;stylesheet&quot; href=&quot;jquery.mobile-1.4.1.css&quot;&gt;<br>&lt;script src=&quot;jquery.js&quot;&gt;&lt;/script&gt;<br>
	&lt;script src=&quot;jquery.mobile-1.4.1.js&quot;&gt;&lt;/script&gt;<br>
&lt;/head&gt;
</div></div>
<p><b>Tip:</b> Place the downloaded files in the same directory as the pages where you wish to use it.<br>
</p>
<table class="lamp" id="table1"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Do you wonder why we do not have type=&quot;text/javascript&quot; inside the &lt;script&gt; tag?</b><br><br>
This is not required in HTML5. JavaScript is the default scripting language in HTML5 and in all modern browsers!</td>
</tr></table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquerymobile_install.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquerymobile_install.asp#top" target="_top">TOP</a> |
		<a href="jquerymobile_install.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
