...
<title>jQuery orientationchange Event</title>
<style>a.menu_event_orientationchange{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">orientationchange</span> Event</h1>
...
<p>Alert some text when the user rotates the mobile device:</p>
<div class="example_code notranslate">
  
    $(window).on(&quot;orientationchange&quot;,function(){<br>&nbsp; alert(&quot;The 
	orientation has changed!&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_orientationchange">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The orientationchange event is triggered when the user rotates the mobile 
device vertically or horizontally.</p>
<p><strong>Note</strong>: To see the effect of the orientationchange event, the user must use a 
mobile device or a mobile emulator.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>
	Required. Specifies the function to run when the orientationchange event occurs. 
	<p>The function has an optional event object, which contains an orientation property 
	equal to either &quot;portrait&quot; or &quot;landscape&quot;. </p>
	<ul>
		<li>Portrait = device is held in a vertical position</li>
		<li>Landscape = device is held in a horizontal position</li>
	</ul>
	  </td>
  </tr>
  </table>
...
<p>
<a href="tryit.asp?filename=tryjqmob_events_orientationchange" target="_blank">The 
event object</a><br>
Using the event.orientation to return the orientation of the mobile device.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_events_orientationchange2" target="_blank">The 
window object</a><br>
Using the window.orientation property to set different styles between portrait 
and landscape views.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_orientationchange.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_orientationchange.asp#top" target="_top">TOP</a> |
		<a href="event_orientationchange.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
