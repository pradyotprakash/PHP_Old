...
<title>jQuery pagebeforecreate Event</title>
<style>a.menu_event_pagebeforecreate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">pagebeforecreate</span> Event</h1>
...
<p>Alert some text when the page is being initialized, but before enhancement 
has begun:</p>
<div class="example_code notranslate">
  
    $(document).on(&quot;pagebeforecreate&quot;,function(){<br>&nbsp; alert(&quot;pagebeforecreate 
	event fired!&quot;)<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_pagebeforecreate">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pagebeforecreate event is triggered when the page is about to be 
initialized and before jQuery Mobile has started enhancing the page.</p>
<p>Use this event to manipulate content before jQuery Mobile has had a chance to 
do so. For example, if you want to add data attributes via a script instead of 
in the HTML source (see example below).</p>
...
<div class="code notranslate"><div> 
    ...
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pagebeforecreate2">Try it</a>
</div>
</div>
<p>To trigger the event for a specific page:</p>
<div class="code notranslate"><div> 
    $(&quot;document&quot;).on(&quot;pagebeforecreate","<em>page</em>&quot;,function(event){...})
    <a target="_blank" class="playitbtn tryitbtnsyntax" href="tryit.asp?filename=tryjqmob_event_pagebeforecreate3">Try it</a>
</div>
</div>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the pagebeforecreate event occurs<br>
   ...
   <tr>
    <td><em>page</em></td>
    <td>Optional. Points to the id of the page to specify the pagebeforecreate event for. 
...
<p>
<a href="tryit.asp?filename=tryjqmob_event_pagebeforecreate4" target="_blank">
Manipulate content before jQuery Mobile has had a chance to do so</a><br>
Using the pagebeforecreate event to dynamically add an attribute.</p>

<p>
<a href="tryit.asp?filename=tryjqmob_event_pagebeforecreate_func" target="_blank">The event object</a><br>
Using the event.type property 
to return the triggered event type.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_pagebeforecreate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_pagebeforecreate.asp#top" target="_top">TOP</a> |
		<a href="event_pagebeforecreate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
