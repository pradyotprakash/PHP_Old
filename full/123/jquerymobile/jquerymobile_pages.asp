...
<style>a.menu_jquerymobile_pages{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery Mobile <span class="color_h1">Pages</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jquerymobile_install.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jquerymobile_transitions.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<td>
Even though jQuery Mobile works on all mobile devices, it may have some 
compatibility issues on desktop computers (due to limited CSS3 support).
<br><br>For this tutorial, we recommend that you use the Google Chrome 
Browser for better reading experience.</td>
</tr></table>

<p>Below, we have created a simple, standard jQuery Mobile page:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;body&gt;<br>&lt;div <span class="marked">data-role=&quot;page&quot;</span>&gt;<br><br>&nbsp; &lt;div 
	<span class="marked">data-role=&quot;header&quot;</span>&gt;<br>&nbsp;&nbsp;&nbsp; &lt;h1&gt;Welcome To My Homepage&lt;/h1&gt;<br>&nbsp; &lt;/div&gt;<br><br>&nbsp; 
	&lt;div <span class="marked">data-role=&quot;main&quot; class=&quot;ui-content&quot;</span>&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;I Am Now A Mobile Developer!!&lt;/p&gt;<br>&nbsp; 
	&lt;/div&gt;<br><br>&nbsp; &lt;div <span class="marked">data-role=&quot;footer&quot;</span>&gt;<br>&nbsp;&nbsp;&nbsp; &lt;h1&gt;Footer 
	Text&lt;/h1&gt;<br>&nbsp; &lt;/div&gt;<br><br>&lt;/div&gt;<br>&lt;/body&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_start">Try it yourself &raquo;</a></div>

<p><strong>Example explained:</strong></p>
<ul>
	<li>The data-role=&quot;page&quot; is the page displayed in the browser</li>
	<li>The data-role=&quot;header&quot; creates a toolbar at the top of the page (often 
	used for title or search buttons)</li>
	<li>The data-role=&quot;main&quot; defines the content of the page, 
	like text, images, buttons, forms, etc.</li>
	<li>The &quot;ui-content&quot; class adds extra padding and margin inside the page 
	content</li>
	<li>The data-role=&quot;footer&quot; creates a toolbar at the bottom of the page</li>
	<li>Inside these containers, you can add any HTML elements - paragraphs, 
	images, headings, lists, etc.</li>
</ul>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>The HTML5 data-* attributes are used throughout jQuery Mobile to create a 
&quot;touch-friendly&quot; and attractive look for mobile devices.</td>
</tr>
</table>
<br>
<hr>
<h2>Adding Pages in jQuery Mobile</h2>
<p>In jQuery Mobile, you can create multiple pages in a single HTML file.</p>
<p>Separate each page with a unique id and use the href attribute to link 
between them:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;div data-role=&quot;page&quot; <span class="marked">id=&quot;pageone&quot;</span>&gt;<br>
	&nbsp; &lt;div data-role=&quot;main&quot; class=&quot;ui-content&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a <span class="marked">href=&quot;#pagetwo&quot;</span>&gt;Go to 
	Page Two&lt;/a&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div data-role=&quot;page&quot; 
	<span class="marked">id=&quot;pagetwo&quot;</span>&gt;<br>&nbsp; &lt;div 
	data-role=&quot;main&quot; class=&quot;ui-content&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a <span class="marked">href=&quot;#pageone&quot;</span>&gt;Go to Page 
	One&lt;/a&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_pages">Try it yourself &raquo;</a></div>

<p><strong>Tip:</strong> The load time will be affected by web applications with a lot of content (i.e 
text, links, images, scripts etc). Use external files if you don't want to link 
pages internally:</p>
<div class="code notranslate">
<div class="auto-style1">
	&lt;a href=&quot;externalfile.html&quot;&gt;Go To External Page&lt;/a&gt;</div>
</div>
<br>
<hr>

<h2>Using Pages as Dialogs</h2>
<p>A dialog box is a type of window used to show special information or request input.</p>
<p>To create a dialog box that opens when a user taps on a link, add data-dialog=&quot;true&quot; 
to the page you want displayed as a dialog:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;div data-role=&quot;page&quot; id=&quot;pageone&quot;&gt;<br>&nbsp; &lt;div 
	data-role=&quot;main&quot; class=&quot;ui-content&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#pagetwo&quot;&gt;Go to Page Two&lt;/a&gt;<br>&nbsp; 
	&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div data-role=&quot;page&quot; 
	<span class="marked">data-dialog=&quot;true&quot;</span> id=&quot;pagetwo&quot;&gt;<br>&nbsp; &lt;div 
	data-role=&quot;main&quot; class=&quot;ui-content&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
	&lt;a href=&quot;#pageone&quot;&gt;Go to Page One&lt;/a&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_dialog">Try it yourself &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="jquerymobile_pages.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="jquerymobile_pages.asp#top" target="_top">TOP</a> |
		<a href="jquerymobile_pages.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
