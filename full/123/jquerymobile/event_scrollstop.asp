...
<title>jQuery scrollstop Event</title>
<style>a.menu_event_scrollstop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>jQuery <span class="color_h1">scrollstop</span> Event</h1>
...
<p>Alert some text when a user stops to scroll the page:</p>
<div class="example_code notranslate">
  
    $(document).on(&quot;scrollstop&quot;,function(){<br>&nbsp; alert(&quot;Stopped 
	scrolling!&quot;);<br>});</div>
<br>
<a target="_blank" class="tryitbtn" href="tryit.asp?filename=tryjqmob_event_scrollstop">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The scrollstop event is triggered when the user stops to scroll the page.</p>
<p><strong>Tip:</strong> This event is often attached to the document.</p>
<p><strong>Tip:</strong> The <a href="event_scrollstart.asp">scrollstart</a> event is triggered when the user starts 
to scroll the page.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div> 
    $(&quot;<em>selector</em>&quot;).on(&quot;scrollstop&quot;,function(event){...})
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the function to run when the scrollstop event occurs<br>
...
<p>
<a href="tryit.asp?filename=tryjqmob_event_scrollstop2" target="_blank">Count scroll stops</a><br>
Count the number of times the scrollstop event occurs.</p>
<p>
<a href="tryit.asp?filename=tryjqmob_event_scrollstop_function" target="_blank">The event object</a><br>
Using the event.target property to return which DOM element that triggered the scrollstop event.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="event_scrollstop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="event_scrollstop.asp#top" target="_top">TOP</a> |
		<a href="event_scrollstop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
