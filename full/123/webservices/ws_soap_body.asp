...
<title>SOAP Body Element</title>
<style>a.menu_ws_soap_body{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SOAP <span class="color_h1">Body</span> Element</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_soap_header.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_soap_fault.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The  SOAP Body element contains the actual SOAP message.</p>
<hr>

<h2>The SOAP Body Element</h2>
<p>The required SOAP Body element contains the actual SOAP message intended for the ultimate endpoint of the message. </p>
<p>Immediate child elements of the SOAP Body element may be namespace-qualified.</p>
...
<p>The example above requests the price of apples. Note that the m:GetPrice and 
the Item elements above are application-specific elements. They are not a part of the SOAP namespace. </p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_soap_body.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_soap_body.asp#top" target="_top">TOP</a> |
		<a href="ws_soap_body.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
