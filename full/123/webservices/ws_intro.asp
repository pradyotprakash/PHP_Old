...
<title>Introduction to Web Services</title>
<style>a.menu_ws_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">Introduction to</span> Web Services</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_example.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A few years ago Web services were not fast enough to be interesting.</p>
<hr>


<h2>What You Should Already Know</h2>
<p>Before you study web services you should have a basic understanding of XML and XML Namespaces.</p>
...
<ul>
	...
	<li>HTTP and XML is the basis for Web services</li>	
</ul>

<hr>


<h2>Interoperability has Highest Priority</h2>

<p>When all major platforms could access the Web using Web browsers, different 
platforms couldn't interact. For these platforms to work together, Web-applications 
were developed. </p>

<p>Web-applications are simply applications that run on the web. These are built 
around the Web browser standards and can be used by any browser on any 
platform.</p>

<hr>

<h2>Web Services take Web-applications to the Next Level</h2>

<p>By using Web services, your application can publish its function or message to 
the rest of the world.</p>

<p>Web services use XML to code and to decode data, and SOAP to transport it 
(using open protocols).</p>

<p>With Web services, your accounting department's Win 2k server's billing system 
can connect with your IT supplier's UNIX server.</p>
<hr>

<h2>Web Services have Two Types of Uses</h2>

<p><b>Reusable application-components.</b></p>

<p>There are things applications need very often. 
So why make these over and over again? </p>

<p>Web services can offer application-components like: currency conversion, 
weather reports, or even language translation as services. </p>

<p><b>Connect existing software.</b></p>
<p>Web services can help to solve the interoperability problem 
by giving different applications a way to link their data. </p>

<p>With Web services you can exchange data between different applications and 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_intro.asp#top" target="_top">TOP</a> |
		<a href="ws_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
