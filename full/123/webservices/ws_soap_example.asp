...
<style>a.menu_ws_soap_example{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SOAP <span class="color_h1">Example</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_soap_httpbinding.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_rdf_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>A SOAP Example</h2>
<p>In the example below, a GetStockPrice request is sent to a server. The request has a StockName parameter,
and a Price parameter that will be returned in the response. The namespace for the function is defined in &quot;http://www.example.org/stock&quot;.</p>

<h3>A SOAP request:</h3>
...
soap:encodingStyle=&quot;http://www.w3.org/2001/12/soap-encoding&quot;&gt;<br><br>
  &lt;soap:Body xmlns:m=&quot;http://www.example.org/stock&quot;&gt;<br>
&nbsp;  &lt;m:GetStockPrice&gt;<br>
      &nbsp;&nbsp;&nbsp;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_soap_example.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_soap_example.asp#top" target="_top">TOP</a> |
		<a href="ws_soap_example.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
