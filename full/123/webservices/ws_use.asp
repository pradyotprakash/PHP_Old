...
<title>Web Services - How to Use</title>
<style>a.menu_ws_use{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Web Services <span class="color_h1">How to Use</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_example.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_wsdl_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>Using the Web Service Example</h2>
<p>In the previous page we created a <a target="_blank" href="tempconvert.asmx">Web service</a>.</p>
<p>The FahrenheitToCelsius() function can be tested here: <a target="_blank" href="tempconvert.asmx?op=FahrenheitToCelsius">FahrenheitToCelsius</a></p>
<p>The CelsiusToFahrenheit() function can be tested here: <a target="_blank" href="tempconvert.asmx?op=CelsiusToFahrenheit">CelsiusToFahrenheit</a></p>
<p>These functions will send an XML response like this:</p>

<div class="code notranslate"><div>

&lt;?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot; ?&gt;<br>
&lt;string xmlns=&quot;http://tempuri.org/&quot;&gt;38&lt;/string&gt;</div></div>
<br>
<hr>

<h2>Put the Web Service on Your Web Site</h2>
<p>Using a form and the HTTP POST method, you can put the web service on your site, like this:</p>
<form target="_blank" action='http://www.w3schools.com/webservices/tempconvert.asmx/FahrenheitToCelsius' method="POST">                      
<table>
	<tr>
		<td>Fahrenheit to Celsius:</td>
		<td><input class="frmInput" type="text" size="30" name="Fahrenheit">
...
<table>
	<tr>
		...
		<td><input class="frmInput" type="text" size="30" name="Celsius">
		<input type="submit" value="Submit" class="button"></td>
	</tr>
</table>
</form>
...
<h2>How To Do It</h2>
<p>Here is the code to add the Web Service to a web page:</p>

<div class="code notranslate"><div>

&lt;form
action='tempconvert.asmx/FahrenheitToCelsius'<br>
method=&quot;post&quot; target=&quot;_blank&quot;&gt;<br>
&lt;table&gt;<br>
  &nbsp;
  &lt;tr&gt;<br>
    &nbsp;&nbsp;&nbsp;
    &lt;td&gt;Fahrenheit to Celsius:&lt;/td&gt;<br>
    &nbsp;&nbsp;&nbsp;
    &lt;td&gt;<br>
&nbsp;&nbsp;&nbsp; &lt;input class=&quot;frmInput&quot; type=&quot;text&quot;
    size=&quot;30&quot; name=&quot;Fahrenheit&quot;&gt;<br>
&nbsp;&nbsp;&nbsp; &lt;/td&gt;<br>
  &nbsp;
  &lt;/tr&gt;<br>
  &nbsp;
...
&lt;/form&gt;<br><br>
&lt;form
action='tempconvert.asmx/CelsiusToFahrenheit'<br>
method=&quot;post&quot; target=&quot;_blank&quot;&gt;<br>
&lt;table&gt;<br>
  &nbsp;
  &lt;tr&gt;<br>
    &nbsp;&nbsp;&nbsp;
    &lt;td&gt;Celsius to Fahrenheit:&lt;/td&gt;<br>
    &nbsp;&nbsp;&nbsp;
    &lt;td&gt;<br>
&nbsp;&nbsp;&nbsp; &lt;input class=&quot;frmInput&quot; type=&quot;text&quot;
    size=&quot;30&quot; name=&quot;Celsius&quot;&gt;<br>
&nbsp;&nbsp;&nbsp; &lt;/td&gt;<br>
  &nbsp;
  &lt;/tr&gt;<br>
  &nbsp;
...
&lt;/table&gt;<br>
&lt;/form&gt;</div></div>
<p>Substitute the &quot;tempconvert.asmx&quot; with the address 
of your web service like:</p>
<p>http://www.example.com/webservices/tempconvert.asmx</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_example.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_wsdl_intro.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_use.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_use.asp#top" target="_top">TOP</a> |
		<a href="ws_use.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
