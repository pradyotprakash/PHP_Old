...
<title>Introduction to OWL</title>
<style>a.menu_ws_rdf_owl{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Introduction to <span class="color_h1">OWL</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_rdf_dublin.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_rdf_reference.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">OWL is a language for processing web information.</p>
<hr>

<h2>What is OWL?</h2>

<ul>
	<li>OWL stands for Web Ontology Language</li>
	<li>OWL is built on top of RDF</li>
	<li>OWL is for processing information on the web</li>
	<li>OWL was designed to be interpreted by computers</li>
	<li>OWL was not designed for being read by people</li>
	<li>OWL is written in XML</li>
	<li>OWL has three sublanguages</li>
	<li>OWL is a W3C standard</li>
</ul>
<hr>

<h2>What is Ontology?</h2>

<p>Ontology is about the exact description of things and their 
relationships.</p>

<p>For the web, ontology is about the exact description of web information and 
relationships between web information.</p>
<hr>

<h2>Why OWL?</h2>
<p>OWL is a part of the &quot;Semantic Web Vision&quot; - a future where:</p>
<ul>
	<li>Web information has exact meaning</li>
	<li>Web information can be processed by computers</li>
	<li>Computers can integrate information from the web </li>
</ul>
<hr>

<h2>OWL was Designed for Processing Information</h2>
<p>OWL was designed to provide a common way to process the content of web 
information (instead of displaying it).</p>
<p>OWL was designed to be read by computer applications (instead of humans).</p>
<hr>

<h2>OWL is Different from RDF</h2>
<p>OWL and RDF are much of the same thing, but OWL is a stronger language with 
greater machine interpretability than RDF.</p>
<p>OWL comes with a larger vocabulary and stronger syntax than RDF.</p>
<hr>

<h2>OWL Sublanguages</h2>

<p>OWL has three sublanguages:</p>
<ul>
	<li>OWL Lite</li>
	<li>OWL DL (includes OWL Lite)</li>
	<li>OWL Full (includes OWL DL)</li>
</ul>
<hr>
<h2>OWL is Written in XML</h2>
<p>By using XML, OWL information can easily be exchanged between different types 
of computers using different types of operating system and application 
languages.</p>
<hr>
<h2>OWL is a Web Standard</h2>
<p>OWL became a W3C (World Wide Web Consortium) Recommendation in February 2004.</p>
<p>A W3C Recommendation is understood by the industry and the web community as a 
web standard. A W3C Recommendation is a stable specification developed by a W3C 
Working Group and reviewed by the W3C Membership.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_rdf_dublin.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_rdf_reference.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_rdf_owl.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_rdf_owl.asp#top" target="_top">TOP</a> |
		<a href="ws_rdf_owl.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
