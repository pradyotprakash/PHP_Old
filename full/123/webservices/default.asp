...
<h1>Web Services <span class="color_h1">Tutorial</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="../default.asp">&laquo; W3Schools Home</a></div>
<div class="next"><a class="chapter" href="ws_intro.asp">Next Chapter &raquo;</a></div>
</div>
<br>
<div class="tutintro">
<img src="http://www.w3schools.com/images/w3webservices.gif" alt="Web Services" />
<p class="intro">Web services are web application components.</p>
<p class="intro">Web services can be published, found, and used on the Web.</p>
<p class="intro">This tutorial introduces WSDL, SOAP, UDDI, and RDF.</p>
</div>
...
<ul>
	...
	<li>WSDL is an XML-based language for describing Web services.</li>
...
<ul>
  ...
  <li>SOAP is an XML based protocol for accessing Web Services.</li>
...
<ul>
	...
	<li>UDDI is a directory service where companies can search for Web services.</li>
	<li>UDDI is described in WSDL</li>
...
<h2>RDF</h2>
<ul>
  <li>RDF stands for Resource Description Framework</li>
