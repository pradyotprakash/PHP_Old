...
<title>WSDL and UDDI</title>
<style>a.menu_ws_wsdl_uddi{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WSDL and <span class="color_h1">UDDI</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_wsdl_binding.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_soap_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Universal Description, Discovery and Integration (UDDI) is a directory service where businesses can register and search for Web services.</p>
<hr>

<h2>What is UDDI</h2>
<p>UDDI is a platform-independent framework for describing services, discovering businesses, and integrating business services by using the Internet. </p>
<ul>
...
<h2>What is UDDI Based On?</h2>
<p>UDDI uses World Wide Web Consortium (W3C) and Internet Engineering Task Force (IETF) Internet standards such as XML, HTTP, and DNS protocols. </p>
<p>UDDI uses WSDL to describe interfaces to web services </p>
<p>Additionally, cross platform programming features are addressed by adopting 
SOAP, known as XML Protocol messaging specifications found at the W3C Web site.</p>
<hr>

<h2>UDDI Benefits</h2>
<p>Any industry or businesses of all sizes can benefit from UDDI.</p>
<p>Before UDDI, there was no Internet standard for businesses to reach their customers and partners with information about their 
products and services. Nor was there a method of how to integrate into each other's systems and processes.</p>
<p>Problems the UDDI specification can help to solve: </p>

<ul>
  <li>Making it possible to discover the right business from the millions currently online </li>
  <li>Defining how to enable commerce once the preferred business is discovered </li>
  <li>Reaching new customers and increasing access to current customers </li>
  <li>Expanding offerings and extending market reach </li>
  <li>Solving customer-driven need to remove barriers to allow for rapid participation in the global Internet economy </li>
  <li>Describing services and business processes programmatically in a single, open, and secure environment </li>
</ul>
<hr>

<h2>How can UDDI be Used</h2>
<p>If the industry published an UDDI standard for flight rate 
...
reservation interface.</p>
<hr>

<h2>Who is Supporting UDDI?</h2>
<p>UDDI is a cross-industry effort driven by all major platform and software 
...
leaders.</p>
<p>Over 220 companies are members of the UDDI community.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_wsdl_binding.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_soap_intro.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_wsdl_uddi.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_wsdl_uddi.asp#top" target="_top">TOP</a> |
		<a href="ws_wsdl_uddi.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
