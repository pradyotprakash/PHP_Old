...
<title>WSDL portType</title>
<style>a.menu_ws_wsdl_ports{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WSDL <span class="color_h1">PortType</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_wsdl_documents.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_wsdl_binding.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The <b>&lt;portType&gt;</b> element is the most important WSDL element.</p>
<hr>

<h2>WSDL - The &lt;portType&gt; Element</h2>
<p>The &lt;portType&gt; element defines <b>a web service</b>, the <b>operations</b> that can be performed, and the <b>messages</b> that are involved.</p>
<p>&lt;portType&gt; defines the connection point to a web service. It can be compared to a function library (or a module, or a class) 
in a traditional programming language. Each operation can be compared to a function in a traditional programming language.</p>
<hr>

<h2>Operation Types</h2>
<p>The request-response type is the most common operation type, but WSDL defines four types:</p>
<table class="reference notranslate">
  ...
  <tr>
    <td>One-way</td>
    <td>The operation can receive a message but will not return a 
    response</td>
  </tr>
  <tr>
    <td>Request-response</td>
    <td>The operation can receive a request and will return a 
    response</td>
  </tr>
  <tr>
    <td>Solicit-response</td>
    <td>The operation can send a request and will wait for a 
    response</td>
  </tr>
  <tr>
    <td>Notification</td>
    <td>The operation can send a message but will not wait for a 
    response</td>
  </tr>
  </table>
<br>
...
<p>A one-way operation example:</p>

<div class="code notranslate"><div>

&lt;message name=&quot;newTermValues&quot;&gt;<br>
   &nbsp;
...
&lt;portType name=&quot;glossaryTerms&quot;&gt;<br>
   &nbsp;
   &lt;operation name=&quot;setTerm&quot;&gt;<br>
      &nbsp;&nbsp;&nbsp;
      &lt;input name=&quot;newTerm&quot; message=&quot;newTermValues&quot;/&gt;<br>
   &nbsp;
   &lt;/operation&gt;<br>
&lt;/portType &gt;
</div></div>

<p>In the example above, the portType &quot;glossaryTerms&quot; defines a one-way operation called &quot;setTerm&quot;. </p>
<p>The &quot;setTerm&quot; operation allows input of new glossary terms messages using a &quot;newTermValues&quot; 
...
<p>In the example above, the portType &quot;glossaryTerms&quot; defines a request-response operation called &quot;getTerm&quot;.</p>
<p>The &quot;getTerm&quot; operation requires an input message called &quot;getTermRequest&quot; 
with a parameter called &quot;term&quot;, and will return an output message called &quot;getTermResponse&quot; 
with a parameter called &quot;value&quot;.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_wsdl_documents.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_wsdl_binding.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_wsdl_ports.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_wsdl_ports.asp#top" target="_top">TOP</a> |
		<a href="ws_wsdl_ports.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
