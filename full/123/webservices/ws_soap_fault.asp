...
<title>SOAP Fault Element</title>
<style>a.menu_ws_soap_fault{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SOAP <span class="color_h1">Fault</span> Element</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_soap_body.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_soap_httpbinding.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The  SOAP Fault element holds errors and 
status information for a SOAP message.</p>
<hr>

<h2>The SOAP Fault Element</h2>

<p class="MsoNormal">The optional SOAP Fault element is used to indicate error 
messages.</p>
<p class="MsoNormal">If a Fault element is present, it must appear as a child element
of the Body element. A Fault element can only appear once in a SOAP message.</p>
<p class="MsoNormal">The SOAP Fault element has the following sub elements:</p>

<table class="reference notranslate">
<tr>
<th style="width:25%">Sub Element</th>
<th>Description</th>
</tr>
<tr>
<td>&lt;faultcode&gt;</td>
...
<td>&lt;detail&gt;</td>
<td>
<p class="MsoNormal">Holds application specific error information related to the 
Body element</p>
</td>
</tr>
</table>
...
<p>The faultcode values defined below must be used in the faultcode element when 
describing faults:</p>
...
<td>An immediate child element of the Header element, with the mustUnderstand attribute set to &quot;1&quot;, was
  not understood</td>
</tr>
<tr>
<td>Client</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_soap_fault.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_soap_fault.asp#top" target="_top">TOP</a> |
		<a href="ws_soap_fault.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
