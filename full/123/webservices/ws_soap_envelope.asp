...
<style>a.menu_ws_soap_envelope{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SOAP <span class="color_h1">Envelope</span> Element</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_soap_syntax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_soap_header.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The SOAP Envelope element is the root element of a SOAP message.</p>
<hr>

<h2>The SOAP Envelope Element</h2>
<p>The required SOAP Envelope element is the root element of a SOAP message. This element defines the XML document as a SOAP message.</p>
...
soap:encodingStyle=&quot;http://www.w3.org/2001/12/soap-encoding&quot;&gt;<br>
  ...
  ...<br>
  &nbsp;
  Message information goes here<br>
  &nbsp;
  ...<br>
&lt;/soap:Envelope&gt;
</div></div>
...
<p>Notice the xmlns:soap namespace in the example above. It should always have the value of: &quot;http://www.w3.org/2001/12/soap-envelope&quot;.</p>
<p>The namespace defines the Envelope as a SOAP Envelope.</p>
<p>If a different namespace is used, the application generates an error and discards the message.</p>
<hr>

<h2>The encodingStyle Attribute</h2>
<p>The encodingStyle attribute is used to define the data types used in the 
document. This attribute may appear on any SOAP element, and applies to the element's contents and all child elements.</p>
<p>A SOAP message has no default encoding.</p>

<h4>Syntax</h4>

<div class="code notranslate"><div>
soap:encodingStyle=&quot;<i>URI</i>&quot;</div></div>
<h4>Example</h4>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_soap_envelope.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_soap_envelope.asp#top" target="_top">TOP</a> |
		<a href="ws_soap_envelope.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
