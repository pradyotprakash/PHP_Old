...
<title>WSDL Documents</title>
<style>a.menu_ws_wsdl_documents{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WSDL <span class="color_h1">Documents</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_wsdl_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_wsdl_ports.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A WSDL document is just a simple XML document.</p>
<p class="intro">It contains set of definitions to describe a web service.</p>
<hr>

<h2>The WSDL Document Structure</h2>
<p>A WSDL document describes a web service using these major elements:</p>
<table class="reference notranslate">
  ...
  <tr>
    <td>&lt;types&gt;</td>
    <td>A container for data type definitions used by the web service</td>
  </tr>
	<tr>
    <td>&lt;message&gt;</td>
    <td>A typed definition of the data being communicated</td>
  </tr>
  <tr>
    <td>&lt;portType&gt;</td>
    <td>A set of operations supported by one or more endpoints</td>
  </tr>
  <tr>
    <td>&lt;binding&gt;</td>
    <td>A protocol and data format specification for a particular 
	port type</td>
  </tr>
</table>
...
&lt;message&gt;<br>
  &nbsp;
  definition of the data being communicated....<br>
&lt;/message&gt;<br><br>
&lt;portType&gt;<br>
  &nbsp;
...
&lt;binding&gt;<br>
  &nbsp;
  protocol and data format specification....<br>
&lt;/binding&gt;<br><br>
&lt;/definitions&gt;
</div></div>

<p>A WSDL document can also contain other elements, like extension elements, and a service element that makes it possible to group together the definitions of 
several web services in one single WSDL document.</p>
<hr>

<h2>WSDL Ports</h2>
<p>The <b>&lt;portType&gt;</b> element is the most important WSDL element. </p>
<p>It describes a web service, the operations that can be performed, and the messages that are involved.</p>
<p>The &lt;portType&gt; element can be compared to a function library (or a module, or a class) 
in a traditional programming language.</p>
<hr>

<h2>WSDL Messages</h2>
<p>The <b>&lt;message&gt;</b> element defines the data elements of an operation.</p>
<p>Each message can consist of one or more parts. The parts can be compared 
to the parameters of a function call in a traditional programming language. </p>
<hr>

<h2>WSDL Types</h2>
<p>The <b>&lt;types&gt;</b> element defines the data types that are used by the web service.</p>
<p>For maximum platform neutrality, WSDL uses XML Schema syntax to define data types.</p>
<hr>

<h2>WSDL Bindings</h2>
<p>The <b>&lt;binding&gt;</b> element defines the data format and protocol for each port 
type.</p>
<hr>
...
&lt;message name=&quot;getTermRequest&quot;&gt;<br>
   &nbsp;
...
&lt;/message&gt;<br><br>
&lt;portType name=&quot;glossaryTerms&quot;&gt;<br>
  &nbsp;
...
<p>In this example the<b> &lt;portType&gt;</b> element defines &quot;glossaryTerms&quot; 
as the name of a <b>port</b>, and &quot;getTerm&quot; as the name of an <b>operation</b>.</p>

<p>The &quot;getTerm&quot; operation has an <b>input message</b> called &quot;getTermRequest&quot; 
and an <b>output message</b> called &quot;getTermResponse&quot;.</p>

<p>The<b> &lt;message&gt;</b> elements define the <b>parts</b> of each message and 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_wsdl_documents.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_wsdl_documents.asp#top" target="_top">TOP</a> |
		<a href="ws_wsdl_documents.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
