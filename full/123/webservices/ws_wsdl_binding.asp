...
<style>a.menu_ws_wsdl_binding{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WSDL <span class="color_h1">Bindings</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_wsdl_ports.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_wsdl_uddi.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">WSDL bindings defines the message format and protocol details for a web service.</p>
<hr>
  ...
  &lt;operation name=&quot;getTerm&quot;&gt;<br>
        ...
        &lt;input message=&quot;getTermRequest&quot;/&gt;<br>
              ...
              &lt;output message=&quot;getTermResponse&quot;/&gt;<br>
                ...
                &lt;/operation&gt;<br>
                &lt;/portType&gt;<br><br>
&lt;binding type=&quot;glossaryTerms&quot; name=&quot;b1&quot;&gt;<br>
&nbsp;&nbsp; &lt;soap:binding style=&quot;document&quot;<br>
&nbsp;&nbsp; transport=&quot;http://schemas.xmlsoap.org/soap/http&quot; /&gt;<br>
  &nbsp;&nbsp; &lt;operation&gt;<br>
    &nbsp;&nbsp;&nbsp;&nbsp; &lt;soap:operation
     soapAction=&quot;http://example.com/getTerm&quot;/&gt;<br>
    &nbsp;&nbsp;&nbsp;&nbsp; &lt;input&gt;&lt;soap:body use=&quot;literal&quot;/&gt;&lt;/input&gt;<br>
    &nbsp;&nbsp;&nbsp;&nbsp; &lt;output&gt;&lt;soap:body use=&quot;literal&quot;/&gt;&lt;/output&gt;<br>
  &nbsp;
  &lt;/operation&gt;<br>
&lt;/binding&gt;
</div></div>

<p>The<b> binding</b> element has two attributes - name and type.</p>

<p>The name attribute (you can use any name you want) defines the name of the 
binding, and the type attribute points to the port for the binding, in this case the &quot;glossaryTerms&quot; port.</p>

<p>The <b>soap:binding</b> element has two attributes - style and transport.</p>

<p>The style attribute can be &quot;rpc&quot; or &quot;document&quot;. In this case we use document. The transport attribute defines the SOAP protocol to use.
In this case we use HTTP.</p>

<p>The<b> operation</b> element defines each operation that the portType exposes.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_wsdl_binding.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_wsdl_binding.asp#top" target="_top">TOP</a> |
		<a href="ws_wsdl_binding.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
