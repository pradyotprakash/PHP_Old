...
<title>SOAP Header Element</title>
<style>a.menu_ws_soap_header{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>SOAP <span class="color_h1">Header</span> Element</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_soap_envelope.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_soap_body.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The  SOAP Header element contains header information.</p>
<hr>
...
<p>If the Header element is present, it must be the first child element of the Envelope element.</p>
<p><b>Note:</b> All immediate child elements of the Header element must be namespace-qualified.</p>
...
soap:encodingStyle=&quot;http://www.w3.org/2001/12/soap-encoding&quot;&gt;<br><br>
&lt;soap:Header&gt;<br>
&nbsp;
&lt;m:Trans xmlns:m=&quot;http://www.w3schools.com/transaction/&quot;<br>
&nbsp;
soap:mustUnderstand=&quot;1&quot;&gt;234<br>
&nbsp;
&lt;/m:Trans&gt;<br>
&lt;/soap:Header&gt;<br>...<br>
...<br>
...
<p>The example above contains a header with a &quot;Trans&quot; element, a &quot;mustUnderstand&quot; 
attribute with a value of 1, and a value of 234.</p>
<p>SOAP defines three attributes in the default namespace (&quot;http://www.w3.org/2001/12/soap-envelope&quot;). These attributes are: mustUnderstand, 
actor, and encodingStyle.</p>
<p>The attributes defined in the SOAP Header defines how a recipient should process the SOAP message.</p>
<hr>

<h2>The mustUnderstand Attribute</h2>
<p>The SOAP mustUnderstand attribute can be used to indicate whether a header entry is mandatory or optional for the recipient to process.</p>
<p>If you add mustUnderstand=&quot;1&quot; to a child element of the Header element it indicates that the receiver processing the Header must recognize the element. If 
the receiver does not recognize the element it will fail when processing the Header.</p>

<h3>Syntax</h3>

<div class="code notranslate"><div>
soap:mustUnderstand=&quot;0|1&quot;</div></div>
...
<h2>The actor Attribute</h2>
<p>A SOAP message may travel from a sender to a receiver by passing different 
endpoints along the message path. However, not all parts of a SOAP message may be intended for the ultimate 
endpoint, instead, it may be intended for one or more of the endpoints on the message path.</p>
<p>The SOAP actor attribute is used to address the Header element to a specific endpoint.</p>
...
&lt;m:Trans xmlns:m=&quot;http://www.w3schools.com/transaction/&quot;<br>
&nbsp;
soap:actor=&quot;http://www.w3schools.com/appml/&quot;&gt;234<br>
&nbsp;
&lt;/m:Trans&gt;<br>
&lt;/soap:Header&gt;<br>...<br>
...<br>&lt;/soap:Envelope&gt;
...
<p>The encodingStyle attribute is used to define the data types used in the 
document. This attribute may appear on any SOAP element, and it will apply to that 
element's contents and all child elements.</p>
<p>A SOAP message has no default encoding.</p>
<h3>Syntax</h3>

<div class="code notranslate"><div>
soap:encodingStyle=&quot;<i>URI</i>&quot;
</div></div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_soap_envelope.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_soap_header.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_soap_header.asp#top" target="_top">TOP</a> |
		<a href="ws_soap_header.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
