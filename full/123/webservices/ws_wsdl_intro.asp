...
<title>Introduction to WSDL</title>
<style>a.menu_ws_wsdl_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1><span class="color_h1">Introduction</span> to WSDL</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_use.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_wsdl_documents.asp">Next Chapter &raquo;</a></div>
</div>
<br>
<div class="tutintro">
<img src="http://www.w3schools.com/images/w3wsdl.gif" alt="WSDL">
<p class="intro">WSDL stands for Web Services Description Language.</p>
	<p class="intro">WSDL is a language for describing web services and how to 
	access them.</p>
	<p class="intro">WSDL is written in XML.</p>
</div>
...
<ul>
	<li>WSDL stands for Web Services Description Language</li>
	<li>WSDL is written in XML</li>
	<li>WSDL is an XML document</li>
	<li>WSDL is used to describe Web services</li>
	<li>WSDL is also used to locate Web services</li>
	<li>WSDL is a W3C recommendation</li>
</ul>

<hr>

<h2>WSDL Describes Web Services </h2>

<p>WSDL stands for Web Services Description Language.</p>

<p>WSDL is a document written in XML. The document describes a Web service. It specifies the location 
of the service and  
the operations (or methods) the service exposes.</p>

<hr>
<h2>WSDL is a W3C Recommendation</h2>

<p>WSDL became a W3C Recommendation 26. June 2007.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="ws_use.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="ws_wsdl_documents.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="ws_wsdl_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="ws_wsdl_intro.asp#top" target="_top">TOP</a> |
		<a href="ws_wsdl_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
