...
<style>a.menu_prop_webcontrol_checkboxlist_cellspacing{font-weight:bold;}</style>
<meta charset="utf-8">
...
table cells in the CheckBoxList.</p>
<p><b>Note:</b> This function only works if the RepeatLayout property is set to 
&quot;Table&quot; (default).</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>

&lt;asp:CheckBoxList CellSpacing=&quot;<i>pixels</i>&quot; runat=&quot;server&quot;&gt;<br>
<i>Some Content</i><br>
&lt;/asp:CheckBoxList&gt;
</div></div>
<br>
...
<p>The following example sets the CellSpacing property of a CheckBoxList control:</p>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_checkboxlist_cellspacing" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_checkboxlist_cellspacing.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_checkboxlist_cellspacing.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_checkboxlist_cellspacing.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
