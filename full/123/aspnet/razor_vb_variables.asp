...
<title>ASP.NET Razor VB Variables</title>
<style>a.menu_razor_vb_variables{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Razor <span class="color_h1">- VB Variables</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="razor_cs_logic.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="razor_vb_loops.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Variables are named entities used to store data.</p>
<hr>

<h2>Variables</h2>
<p>Variables are used to store data.</p>
<p>The name of a variable must begin with an alphabetic character and 
cannot contain whitespace or reserved characters. <br><br>A variable can be of a 
...
(103), date variables store date values, etc.<br><br>Variables are declared 
using the Dim keyword, or by using the type (if you want to declare the type), 
but ASP.NET can usually determine data types automatically.</p>

<div class="example">
<h2 class="example">Examples</h2>
<div class="example_code notranslate">
	// 
	Using the Dim keyword:<br>Dim greeting = &quot;Welcome to W3Schools&quot;<br>
	Dim counter = 103<br>Dim today = DateTime.Today<br><br>// Using data types:<br>
	Dim greeting As String = &quot;Welcome to W3Schools&quot;<br>Dim counter As Integer = 
	103<br>Dim today As DateTime = DateTime.Today
</div>
</div>
<br>
<hr>
...
<p>Below is a list of&nbsp; common data types:</p>
...
<tr>
<td>decimal</td>
<td>Decimal number (higher precision)</td>
<td>1037.196543</td>
</tr>
<tr>
<td>boolean</td>
...
<h2>Operators</h2>
<p>An operator tells ASP.NET what kind of command to perform in an expression.</p>
<p>&nbsp;The VB language supports many operators. Below is a list of common operators:</p>
...
<tr>
<td>+<br>-<br>*<br>/<br></td>
<td>Adds a value or variable.<br>Subtracts a value or variable.<br>Multiplies a 
value or variable.<br>Divides a value or variable.</td>
<td>i=5+5<br>i=5-5<br>i=5*5<br>i=5/5</td>
</tr>
<tr>
<td>+=<br>-=</td>
<td>Increments a variable.<br>Decrements a variable.</td>
<td>i += 1<br>i -= 1</td>
</tr>
<tr>
<td>=</td>
<td>Equality. Returns true if values are equal.</td>
<td>if i=10</td>
</tr>
<tr>
<td>&lt;&gt;</td>
<td>Inequality. Returns true if values are not equal.</td>
<td>if &lt;&gt;10 </td>
</tr>
<tr>
<td>&lt;<br>&gt;<br>&lt;=<br>&gt;=</td>
<td>Less than.<br>Greater than.<br>Less than or equal.<br>Greater than or equal.</td>
<td>if i&lt;10<br>if i&gt;10<br>if i&lt;=10<br>if i&gt;=10</td>
</tr>
<tr>
<td>&amp;</td>
<td>Adding strings (concatenation).</td>
<td>"w3" &amp; "schools"</td>
</tr>
<tr>
<td>.</td>
<td>Dot. Separate objects and methods.</td>
<td>DateTime.Hour</td>
</tr>
<tr>
<td>()</td>
<td>Parenthesis. Groups values.</td>
<td>(i+5)</td>
</tr>
<tr>
<td>()</td>
<td>Parenthesis. Passes parameters.</td>
<td>x=Add(i,5)</td>
</tr>
<tr>
<td>()</td>
<td>Parenthesis. Accesses values in arrays or collections.</td>
<td>name(3)</td>
</tr>
<tr>
<td>Not</td>
<td>Not. Reverses true or false.</td>
<td>if Not ready</td>
</tr>
<tr>
<td>And<br>OR</td>
<td>Logical AND.<br>Logical OR.</td>
<td>if ready And clear<br>if ready Or clear</td>
</tr>
<tr>
<td>AndAlso<br>orElse</td>
<td>Extended Logical AND.<br>Extended Logical OR.</td>
<td>if ready AndAlso clear<br>if ready OrElse clear</td>
</tr>
</table>
<br>
<hr>
...
<p>Converting from one data type to another is sometimes useful.<br><br>The most 
common example is to convert string input to another type, such as an integer or 
a date.</p>
<p>As a rule, user input comes as strings, even if the user entered a number. 
Therefore, numeric input values must be converted to numbers before they can be 
used in calculations.</p>
<p>Below is a list of common conversion methods:</p>
...
<tr>
<td>AsInt()<br>IsInt()</td>
<td>Converts a string to an integer.</td>
<td>if myString.IsInt() then<br>&nbsp;&nbsp; myInt=myString.AsInt()<br>end if</td>
</tr>
<tr>
<td>AsFloat()<br>IsFloat()</td>
<td>Converts a string to a floating-point number.</td>
<td>if myString.IsFloat() then<br>&nbsp;&nbsp; myFloat=myString.AsFloat()<br>end 
if</td>
</tr>
<tr>
<td>AsDecimal()<br>IsDecimal()</td>
<td>Converts a string to a decimal number.</td>
<td>if myString.IsDecimal() then<br>&nbsp;&nbsp; myDec=myString.AsDecimal()<br>
end if</td>
</tr>
<tr>
<td>AsDateTime()<br>IsDateTime()</td>
<td>Converts a string to an ASP.NET DateTime type.</td>
<td>myString=&quot;10/10/2012&quot;<br>myDate=myString.AsDateTime()</td>
</tr>
<tr>
<td>AsBool()<br>IsBool()</td>
<td>Converts a string to a Boolean.</td>
<td>myString=&quot;True&quot;<br>myBool=myString.AsBool()</td>
</tr>
<tr>
<td>ToString()</td>
<td>Converts any data type to a string.</td>
<td>myInt=1234<br>myString=myInt.ToString()</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="razor_vb_variables.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="razor_vb_variables.asp#top" target="_top">TOP</a> |
		<a href="razor_vb_variables.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
