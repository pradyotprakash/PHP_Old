...
<title>WebSecurity IsConfirmed Method</title>
<style>a.menu_met_websecurity_isconfirmed{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> IsConfirmed()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>IsConfirmed()</strong> method returns a value that indicates whether the specified user has been confirmed.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.IsConfirmed(<em>userName</em>);</div></div>
<br>
<hr>
...
<tr>
<td>Boolean</td>
<td><strong>true</strong> if the user is confirmed, 
...
<h2>Remarks</h2>
<p>The <strong>IsConfirmed()</strong> method checks the user account identified by the <strong>
<em>userName</em></strong> 
parameter. </p>
<p>If the membership has been confirmed (the user has confirmed the account by 
clicking an email link), the method returns <strong>true</strong>.</p>
<p>If a registration has not been confirmed, the user cannot log in.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_isconfirmed.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_isconfirmed.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_isconfirmed.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
