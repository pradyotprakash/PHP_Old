...
<head>
<title>ASP.NET Navigation</title>
<style>a.menu_aspnet_navigation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- Navigation</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_masterpages.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">ASP.NET has built-in navigation controls</p>
<hr>

<h2>Web Site Navigation</h2>
<p>Maintaining the menu of a large web site is difficult and time consuming.</p>
<p>In ASP.NET the menu can be stored in a file to make it easier to maintain. This file is normally called <b>web.sitemap</b>, and is stored in the root directory of the web.</p>
<p>In addition, ASP.NET has three new navigation controls:</p>
<ul>
	<li>Dynamic menus</li>
	<li>TreeViews</li>
	<li>Site Map Path</li>
...
<p>The following sitemap file is used in this tutorial:</p>
...
<ul>
	...
	<li>The &lt;siteMap&gt; tag can only have one &lt;siteMapNode&gt; child node (the &quot;home&quot; page)</li>
	<li>Each &lt;siteMapNode&gt; can have several child nodes (web pages)</li>
	<li>Each &lt;siteMapNode&gt; has attributes defining page title and URL</li>
</ul>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><b>Note:</b> The sitemap file must be placed in the root directory of the web and the 
URL attributes must be relative to the root directory.</td>
</tr></table>
<br>
<hr>

<h2>Dynamic Menu</h2>
<p>The &lt;asp:Menu&gt; control displays a standard site navigation menu. </p>
...
<p>The <b>&lt;asp:Menu&gt;</b> control in the example above is a placeholder for a server created navigation menu.</p>
...
<p>The <b>&lt;asp:SiteMapDataSource&gt;</b> control automatically connects to the default sitemap file (<b>web.sitemap</b>).</p>
<p><a target="_blank" href="w3services.aspx">Click here to see a demo of Menu, TreeView, and SiteMapPath</a></p>
<hr>

<h2>TreeView</h2>
<p>The &lt;asp:TreeView&gt; control displays a multi level navigation menu.</p>
<p>The menu looks like a tree with branches that can be opened or closed with + or - symbol. </p>
<p><b>Code Example:</b></p>
...
<p>The <b>&lt;asp:TreeView&gt;</b> control in the example above is a placeholder for a server created navigation menu.</p>
<p>The data source of the control is defined by the <b>DataSourceId</b> attribute. 
The <b>id=&quot;nav1&quot;</b> connects it to the&nbsp; <b>&lt;asp:SiteMapDataSource&gt;</b> control.</p>
<p>The <b>&lt;asp:SiteMapDataSource&gt;</b> control automatically connects to the default sitemap file (<b>web.sitemap</b>).</p>
<p><a target="_blank" href="w3services.aspx">Click here to see a demo of Menu, TreeView, and SiteMapPath</a></p>
...
<h2>SiteMapPath</h2>
<p>The SiteMapPath control displays the trail (navigation path) to the current page. The path acts as clickable links to previous pages.</p>
<p>Unlike the TreeView and Menu control the SiteMapPath control does <b>NOT</b> use a SiteMapDataSource. The SiteMapPath control uses the web.sitemap file by default.</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>Tips: If the SiteMapPath displays incorrectly, most likely there is a URL error 
(typo) in the web.sitemap file.</td>
</tr></table>
<p><b>Code Example:</b></p>
...
<p>The <b>&lt;asp:SiteMapPath&gt;</b> control in the example above is a placeholder for a server created site path display.</p>
<p><a target="_blank" href="w3services.aspx">Click here to see a demo of Menu, TreeView, and SiteMapPath</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_masterpages.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_navigation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_navigation.asp#top" target="_top">TOP</a> |
		<a href="aspnet_navigation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
