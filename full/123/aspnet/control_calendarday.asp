...
<title>ASP.NET CalendarDay Control</title>
<style>a.menu_control_calendarday{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">CalendarDay</span> Control</h1>
<hr>
...
<p>The CalendarDay control represents a day in a calendar control.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_calendarday_date.asp">Date</a></td>
    <td>The date variable of the date</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendarday_daynumbertext.asp">
	DayNumberText</a></td>
    <td>The day number(string) of a date</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendarday_isothermonth.asp">
	IsOtherMonth</a></td>
    <td>Specifies if the date in another month than the one displayed in the calendar</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendarday_isselectable.asp">IsSelectable</a></td>
    <td>Specifies if the date is selectable</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendarday_isselected.asp">IsSelected</a></td>
    <td>Specifies if the date is selected</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendarday_istoday.asp">IsToday</a></td>
    <td>Specifies if the date is today's date</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendarday_isweekend.asp">IsWeekend</a></td>
    <td>Specifies if the date is Saturday or Sunday</td>
    <td>1.0</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_calendarday.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_calendarday.asp#top" target="_top">TOP</a> |
		<a href="control_calendarday.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
