...
<title>ASP.NET ImageButton Control</title>
<style>a.menu_control_imagebutton{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">ImageButton</span> Control</h1>
<hr>
...
<p>The ImageButton control is used to display a clickable image.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_imagebutton_causesvalidation.asp">CausesValidation</a></td>
    <td>Specifies if a page is validated when an ImageButton control is clicked</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>CommandArgument</td>
    <td>Additional information about the command to perform</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>CommandName</td>
    <td>The command associated with the Command event</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>GenerateEmptyAlternateText</td>
    <td>Specifies whether or not the control creates an empty 
	string as an alternate text</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_imagebutton_onclientclick.asp">OnClientClick</a></td>
    <td>The name of the function to be executed when the image is clicked</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_imagebutton_postbackurl.asp">PostBackUrl</a></td>
    <td>The URL of the page to post to from the current page when 
	the ImageButton control is clicked</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td>runat</td>
  ...
  <tr>
    <td><a href="prop_webcontrol_imagebutton_validationgroup.asp">ValidationGroup</a></td>
    <td>The group of controls for which the ImageButton control causes 
	validation when it posts back to the server</td>
    <td>2.0</td>
  </tr>
</table>
<p><b>Note:</b> The properties of the <a href="control_image.asp">Image control</a> can also be used on the ImageButton control.</p>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_imagebutton">ImageButton</a><br>
Declare one ImageButton control and one Label control in an .aspx file. When the user clicks on the image, the 
getCoordinates subroutine is executed. The subroutine sends the message &quot;Coordinates: &quot; and the x and y coordinates of the click to the Label control.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_imagebutton.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_imagebutton.asp#top" target="_top">TOP</a> |
		<a href="control_imagebutton.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
