...
<title>ASP.NET HtmlInputCheckBox Control</title>
<style>a.menu_control_htmlinputcheckbox{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlInputCheckBox</span> Control</h1>
<hr>
...
<p>The HtmlInputCheckBox control is used to control an &lt;input type=&quot;checkbox&quot;&gt; element. In HTML, this element is used to create a checkbox.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Checked</td>
    <td>A Boolean value that specifies whether or not the element is to be checked</td>
  </tr>
  <tr>
    <td>Disabled</td>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>ServerChange</td>
    <td>Occurs when the state of the control has changed</td>
  </tr>
</table>
<br>
<hr>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlinputcheckbox">HTMLInputCheckbox</a><br>
...
the server sends the message &quot;You prefer blue!&quot; to the p element.<br>
</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlinputcheckbox.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlinputcheckbox.asp#top" target="_top">TOP</a> |
		<a href="control_htmlinputcheckbox.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
