...
<title>ASP.NET ValidationSummary Control</title>
<style>a.menu_control_validationsummary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">ValidationSummary</span> Control</h1>
<hr>
...
<p>The ValidationSummary control is used to display a summary of all validation errors occurred in a Web page.</p>
<p>The error message displayed in this control is specified by the ErrorMessage property of each validation control. If the ErrorMessage property of the 
validation control is not set, no error message is displayed for that validation control.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>DisplayMode</td>
    <td>How to display the summary. Legal values are:
    <ul>
      <li>BulletList</li>
      <li>List</li>
      <li>SingleParagraph</li>
    </ul>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td>ForeColor</td>
    <td>The fore color of the control</td>
  </tr>
  <tr>
    <td>HeaderText</td>
    <td>A header in the ValidationSummary control</td>
  </tr>
  <tr>
    <td>id</td>
  ...
  <tr>
    ...
    <td>A Boolean value that specifies whether the summary should be displayed in a message box or not</td>
  </tr>
  <tr>
    <td>ShowSummary</td>
    <td>A Boolean value that specifies whether the ValidationSummary control should be displayed or hidden</td>
  </tr>
</table>
<br>
<hr>
...
<h2>Examples</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_validationsum">Validationsummary</a><br>
Use the ValidationSummary control to write a bulleted list of fields that are required but left empty by the user.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_validationsum2">Validationsummary 2</a><br>
Use the ValidationSummary control to display a message box of the fields that are required but left empty by the user.</p>
<hr>
<a href="aspnet_refvalidationcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Validation Server Controls" /> Validation Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_validationsummary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_validationsummary.asp#top" target="_top">TOP</a> |
		<a href="control_validationsummary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
