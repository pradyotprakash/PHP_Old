...
<title>ASP.NET ShowGridLines Property</title>
<style>a.menu_prop_webcontrol_calendar_showgridlines{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">ShowGridLines</span> Property</h1>
<hr>
...
<p>The ShowGridLines property is used to specify whether or not to display 
borders between the days in the calendar.</p>
<p>By default this property is set as FALSE and the grid lines are not displayed. 
To show the grid lines the property must be set as TRUE.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>

&lt;asp:Calendar ShowGridLines=&quot;TRUE|FALSE&quot; runat=&quot;server&quot;<i> /&gt;</i>
</div></div>
<br>
<hr>
<div class="example">
<h2 class="example">Example</h2>
<p>The following example sets the ShowGridLines as TRUE:</p>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_calendar_showgridlines" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_calendar_showgridlines.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_calendar_showgridlines.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_calendar_showgridlines.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
