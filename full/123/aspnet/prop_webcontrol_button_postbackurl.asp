...
<style>a.menu_prop_webcontrol_button_postbackurl{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The PostBackUrl property is used to gets or sets the URL of the page to post when the Button control is clicked.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
&lt;asp:Button PostBackUrl=&quot;<i>string</i>&quot; runat=&quot;server&quot;<i> /&gt;</i></div></div>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<tr>
		<td>PostBackUrl</td>
		<td>A string specifying the URL of the page to post to. Default is an empty string, this causes the page to post back to itself</td>
	</tr>
</table>
<br>
<hr>
...
<p>The following example sets the post URL of a Button control:</p>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_button_postbackurl" class="showbtn">Show example &raquo;</a>
</div>
<br>
<hr>
<a href="control_button.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Button Control" /> Button Control</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_button_postbackurl.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_button_postbackurl.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_button_postbackurl.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
