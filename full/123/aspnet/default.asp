...
<h1>ASP.NET <span class="color_h1">Tutorial</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="../default.asp">&laquo; W3Schools Home</a></div>
<div class="next"><a class="chapter" href="aspnet.asp">Next Chapter &raquo;</a></div>
</div>
<br>
...
<tr>
<td style="width:32%;text-align:center;color:white;background:#73ad21">
<a class="h2aspnet" href="webpages_intro.asp">Web Pages</a><br>
<span style="font-size:15px">Single Pages Model</span>
</td>
<td style="width:1%"></td>
<td style="width:32%;text-align:center;color:white;background:#73ad21">
<a class="h2aspnet" href="mvc_intro.asp">MVC</a><br>
<span style="font-size:15px">Model View Controller</span>
</td>
<td style="width:1%"></td>
<td style="text-align:center;color:white;background:#73ad21">
<a class="h2aspnet" href="aspnet_intro.asp">Web Forms</a><br>
<span style="font-size:15px">Event Driven Model</span>
</td>
</tr>

<tr>
<td style="vertical-align:top;text-align:center;border:1px solid gray">
<br>Simplest ASP.NET model.<br><br>Similar to PHP and classic ASP.<br><br>Built-in 
templates and helpers for database, video, graphics, 
social media and more.</td>
<td>&nbsp;</td>
<td style="vertical-align:top;text-align:center;border:1px solid gray">
<br>MVC separates web applications into 3 different components:<br><br>Models 
for data<br>
Views for display<br>
Controllers for input<br>
</td>
<td>&nbsp;</td>
<td style="vertical-align:top;text-align:center;border:1px solid gray">
<br>The traditional ASP.NET event driven development model:<br><br>Web 
...
<p><strong>If you are new to ASP.NET, Web Pages is the perfect place to start. 
</strong> </p>
<p>Web Pages is the easiest development model for developing ASP.NET web sites.</p>
...
Helpers, including database, video, graphics, social networking and much more. </p>
<p><a href="webpages_intro.asp">Start learning ASP.NET Web Pages now!</a></p>

<hr>
<h2>MVC Tutorial</h2>
<p>MVC is a model for building web applications using a MVC (Model 
View Controller) design.</p>
<p><strong>If you want a lighter alternative to traditional ASP.NET, MVC is the place to start.</strong></p>
<p>In our MVC tutorial you will learn how to build web applications using a 
lightweight 
development model, integrated 
with all existing ASP.NET features, such as Master Pages, Security, and 
Authentication.</p>
<p><a href="mvc_intro.asp">Start learning ASP.NET MVC now!</a></p>
<hr>
<h2>Web Forms Tutorial</h2>
<p>Web Forms is the traditional ASP.NET model, based on event driven Web Forms and post 
backs.</p>
<p>Over the years, developers have used ASP.NET Web Forms to create many of the 
largest websites in the world.</p>
<p><strong>If you want to study the design model used by many web developers over the 
last 10 years, this is the place to start.</strong></p>
<p><a href="aspnet_intro.asp">Start learning ASP.NET Web Forms now!</a></p>
<hr>
<h2>Who Are These Tutorials For?</h2>
<p>The tutorials above are for anyone who wants to learn to build websites on 
the Microsoft ASP.NET platform, from hobby-related sites, to new, modern, and 
fully commercial webs.</p>
<p>Even if you are new to web programming, you should be able to follow the 
tutorials, but it will help if you have a basic understanding of HTML and CSS.</p>
<p>It will also help if you have a basic understanding of scripting languages 
like JavaScript or VB (Visual Basic).</p>
<p>Do you have a preference for VB over C#? Do you want to learn both languages? 
The good news are: In the W3Schools tutorials most code examples are in both 
languages.</p>
<p>If you are a professional web developer with prior ASP.NET experience, you 
can still learn a lot, since these tutorials covers a lot of new ASP.NET concepts, like HTML5, CSS3, JQuery, and more.</p>
