...
<title>ASP.NET Button OnClientClick Property</title>
<style>a.menu_prop_webcontrol_button_onclientclick{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Button <span class="color_h1">OnClientClick</span> Property</h1>
<hr>
...
<p>The OnClientClick property is used to sets a client side script to be run when the Button control is clicked.</p>
<p>The script specified in this property is run by the Button's event &quot;OnClick&quot; in addition to the predefined script.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
&lt;asp:Button OnClientClick=&quot;<i>function</i>&quot; runat=&quot;server&quot;<i> /&gt;</i></div></div>
<br>
...
<table class="reference notranslate">
  <tr>
	...
	<tr>
		<td>OnClientClick</td>
		<td>A client-side script to be run when button is clicked</td>
	</tr>
</table>
<br>
<hr>
...
<p>The following example runs two scripts when the Button control is clicked:</p>
...
&lt;asp:Button OnClick=&quot;script1&quot; OnClientClick=&quot;script2()&quot; <br>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_button_onclientclick" class="showbtn">Show example &raquo;</a>
</div>
<br>
<hr>
<a href="control_button.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Button Control" /> Button Control</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_button_onclientclick.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_button_onclientclick.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_button_onclientclick.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
