...
<title>ASP.NET TableRow Control</title>
<style>a.menu_control_tablerow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">TableRow</span> Control</h1>
<hr>
...
<p>The TableRow control is used in conjunction with the TableCell control and the Table control to create a  row in a table.</p>
<p><b>Tip:</b> The rows of a table are stored in the Rows collection of the Table control.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_tablerow_horizontalalign.asp">HorizontalAlign</a></td>
    <td>The horizontal alignment of the contents in the table row</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_tablerow_tablesection.asp">TableSection</a></td>
    <td>The location of a TableRow object in a Table control</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_tablerow_verticalalign.asp">VerticalAlign</a></td>
    <td>The vertical alignment of the contents in the table row</td>
    <td>1.0</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_tablerow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_tablerow.asp#top" target="_top">TOP</a> |
		<a href="control_tablerow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
