...
<title>ASP.NET Razor C# Variables</title>
<style>a.menu_razor_cs_variables{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Razor <span class="color_h1">- C# Variables</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="razor_syntax.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="razor_cs_loops.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<div class="example_code notranslate">
	// 
	Using the var keyword:<br>var greeting = &quot;Welcome to W3Schools&quot;;<br>var 
	counter = 103;<br>var today = DateTime.Today;<br><br>// Using data types:<br>
	string greeting = &quot;Welcome to W3Schools&quot;;<br>int counter = 103;<br>DateTime 
...
<p>&nbsp;The C# language supports many operators. Below is a list of&nbsp;common operators:</p>
...
<tr>
<td>[]</td>
<td>Brackets. Accesses values in arrays or collections.</td>
<td>name[3]</td>
</tr>
<tr>
<td>!</td>
...
<td>if (ready &amp;&amp; clear)<br>if (ready || clear)</td>
</tr>
</table>
<br>
<hr>
...
<td>if (myString.IsInt())<br>&nbsp; {myInt=myString.AsInt();}</td>
</tr>
<tr>
<td>AsFloat()<br>IsFloat()</td>
<td>Converts a string to a floating-point number.</td>
<td>if (myString.IsFloat())<br>&nbsp; {myFloat=myString.AsFloat();}</td>
</tr>
<tr>
<td>AsDecimal()<br>IsDecimal()</td>
<td>Converts a string to a decimal number.</td>
<td>if (myString.IsDecimal())<br>&nbsp; {myDec=myString.AsDecimal();}</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="razor_cs_variables.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="razor_cs_variables.asp#top" target="_top">TOP</a> |
		<a href="razor_cs_variables.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
