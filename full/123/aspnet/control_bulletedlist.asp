...
<title>ASP.NET BulletedList Control</title>
<style>a.menu_control_bulletedlist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">BulletedList</span> Control</h1>
<hr>
...
<p>The BulletedList control creates a list in bullet format.</p>
<p>Each item in a BulletedList control is defined by a ListItem element!</p>
<p><b>Note:</b> This class is new in ASP.NET 2.0.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_bulletedlist_bulletimageurl.asp">BulletImageUrl</a></td>
    <td>Specifies the URL of a custom bullet list image. Used if &quot;BulletStyle&quot; is 
	&quot;CustomImage&quot;</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_bulletedlist_bulletstyle.asp">BulletStyle</a></td>
    <td>Specifies the style of the bullet list</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_bulletedlist_displaymode.asp">DisplayMode</a></td>
    <td>Specifies the type of list displayed</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td>
	<a href="prop_webcontrol_bulletedlist_firstbulletnumber.asp">FirstBulletNumber</a></td>
    <td>Specify the start number of list items in an 
	ordered list</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td>runat</td>
    <td>Required. Specifies that the control is a server control.&nbsp; 
	Must be set to &quot;server&quot;</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_bulletedlist_target.asp">Target</a></td>
...
<p>The ListControl control covers all the base functions for list controls. The 
properties above applies to the BulletedList control.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_bulletedlist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_bulletedlist.asp#top" target="_top">TOP</a> |
		<a href="control_bulletedlist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
