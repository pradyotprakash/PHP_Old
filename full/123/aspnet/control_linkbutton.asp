...
<title>ASP.NET LinkButton Control</title>
<style>a.menu_control_linkbutton{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">LinkButton</span> Control</h1>
<hr>
...
<p>The LinkButton control is used to create a hyperlink button.</p>
<p><b>Note:</b> This control looks like a HyperLink control but has the same functionality as the Button control.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Specifies if a page is validated when a LinkButton control is clicked</td>
    <td>1.0</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="prop_webcontrol_linkbutton_onclientclick.asp">OnClientClick</a></td>
    <td>The name of the function to be executed when the LinkButton is clicked</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_linkbutton_postbackurl.asp">PostBackUrl</a></td>
    <td>The URL of the page to post to from the current page when the LinkButton control is clicked</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td><a href="prop_webcontrol_linkbutton_text.asp">Text</a></td>
    <td>The text on the LinkButton</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_linkbutton_validationgroup.asp">ValidationGroup</a></td>
    <td>The group of controls for which the LinkButton control causes validation when it posts back to the server</td>
    <td>2.0</td>
  </tr>
  </table>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_linkbutton">LinkButton</a><br>
Declare one LinkButton control and one Label control in an .aspx file. When the user clicks on the link, the lbClick subroutine is executed. The 
subroutine sends the text &quot;You clicked the LinkButton control&quot; to the Label control.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_linkbutton.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_linkbutton.asp#top" target="_top">TOP</a> |
		<a href="control_linkbutton.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
