...
<style>a.menu_prop_websecurity_isauthenticated{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity Property -<span class="color_h1"> IsAuthenticated</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>IsAuthenticated</strong> property is a boolean value that indicates whether the current user is authenticated 
(logged in).</p>
<p>The property value is a boolean <strong>true</strong> if the current user is 
authenticated, otherwise <strong>false</strong>.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate">
<div>
WebSecurity.IsAuthenticated</div></div>
<br>
<hr>
...
if (!WebSecurity.IsAuthenticated)<br>
{<br>
Response.Redirect(&quot;~/Account/Login&quot;);<br>
}</div>
</div>
<br>
<div class="example">
...
<div class="example_code notranslate">
if !WebSecurity.IsAuthenticated then<br>&nbsp; Response.Redirect(&quot;~/Account/Login&quot;)<br>
end if
</div>
</div>
<br>
...
<h2>Remarks</h2>
<p>The <strong>IsAuthenticated</strong> property is read only. It cannot be changed by code.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_websecurity_isauthenticated.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_websecurity_isauthenticated.asp#top" target="_top">TOP</a> |
		<a href="prop_websecurity_isauthenticated.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
