...
<title>ASP.NET WebPages Helpers Reference</title>
<style>a.menu_webpages_ref_helpers{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- More Helpers</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_ref_webmail.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="razor_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>ASP.NET Helpers - Objects References</h2>
<hr>
<h2>Analytics Object Reference (Google)</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th style="width:50%">Description</th>
</tr>
<tr>
<td>Analytics.GetGoogleHtml(<em>webPropertyId</em>)</td>
<td>
Renders the Google Analytics JavaScript code for the 
specified ID.</td></tr><tr>
<td>Analytics.GetStatCounterHtml(<em>project</em>,
<em>security</em>)</td><td>Renders the StatCounter 
Analytics JavaScript code for the specified project.</td></tr><tr>
<td>Analytics.GetYahooHtml(<em>account</em>)</td>
<td>
...
<tr>
<td>Bing.SearchBox(<em>[boxWidth]</em>)</td>
<td>
...
<td>Bing.AdvancedSearchBox(<em>[, boxWidth] [, 
resultWidth] [, resultHeight] <br>
...
<tr>
<tr>
<td>Chart(<em>width</em>, <em>height [, 
template] [, templatePath]</em>)</td><td>
Initializes a chart.</td></tr><tr>
<td>Chart.AddLegend(<em>[title] [, name]</em>)</td>
<td>
Adds a legend to a chart.</td></tr><tr>
<td>Chart.AddSeries(<em>[name] [, chartType] 
[, chartArea] <br>
&nbsp; [, axisLabel] [, legend] [, markerStep] [, xValue]
<br>
&nbsp; [, xField] [, yValues] [, yFields] [, options])</em></td>
<td>
Adds a series of values to the chart.</td></tr>
</table>
<br><hr>

<h2>Crypto Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<tr>
<td>Crypto.Hash(<em>string [, algorithm]</em>)
<br>
...
<h2>Facebook Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<tr>
<td>Facebook.LikeButton(<em>href [, 
buttonLayout] [, showFaces] [, width] [, height] <br>
[, action] [, font] [, colorScheme] [, refLabel]</em>)</td><td>
Lets Facebook users make a connection to pages.</td></tr>
</table>
<br><hr>

<h2>FileUpload Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<tr>
<td>FileUpload.GetHtml(<em>[initialNumberOfFiles] 
[</em>, <em>allowMoreFilesToBeAdded] <br>
...
<h2>GamerCard Object Reference</h2>
<table class="reference notranslate">
<tr>
...
<tr>
<td>GamerCard.GetHtml(<em>gamerTag</em>)</td>
<td>
...
<tr>
<td>Gravatar.GetHtml(<em>email [, imageSize] 
[, defaultImage] [, rating] <br>
...
<tr>
<td>Json.Encode(<em>object</em>)</td>
<td>
Converts a data object to a string in the JavaScript 
Object Notation (JSON) format. 
</td></tr><tr>
<td>Json.Decode(<em>string</em>)</td>
<td>
...
<h2>LinkShare Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<tr>
<td>LinkShare.GetHtml(<em>pageTitle [, 
pageLinkBack] [, twitterUserName] <br>
...
<h2>ModelState Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<h2>ObjectInfo Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<tr>
<td>ObjectInfo.Print(<em>value [, depth] [, 
...
<h2>Recaptcha Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<tr>
<td>Recaptcha.GetHtml(<em>[, publicKey] [, 
theme] [, language] [, tabIndex]</em>)</td><td>
Renders the reCAPTCHA verification test.</td></tr><tr>
<td>ReCaptcha.PublicKey <br>
ReCaptcha.PrivateKey</td><td>Sets public and 
private keys for the reCAPTCHA service. Normally you 
set these properties in the <em>_AppStart</em> page.</td></tr><tr>
<td>ReCaptcha.Validate(<em>[, privateKey]</em>)</td>
<td>
Returns the result of the reCAPTCHA test.</td></tr><tr>
</tr>
</table>
<br><hr>

<h2>ServerInfo Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<tr>
<td>ServerInfo.GetHtml()</td><td>Renders 
status information about ASP.NET Web Pages.</td></tr>
</table>
<br><hr>

<h2>Twitter Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<tr>
<td>Twitter.Profile(<em>twitterUserName</em>)</td>
<td>
Renders a Twitter stream for the specified user.</td></tr><tr>
<td>Twitter.Search(<em>searchQuery</em>)</td>
<td>
...
<tr>
<td>Video.Flash(<em>filename [, width, height]</em>)</td>
<td>
Renders a Flash video player for the specified file 
with optional width and height.</td></tr><tr>
<td>Video.MediaPlayer(<em>filename [, width, 
height]</em>)</td><td>Renders a Windows Media 
player for the specified file with optional width 
and height.</td></tr><tr>
<td>Video.Silverlight(<em>filename</em>, <em>
...
<h2>WebCache Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<tr>
<td>WebCache.Get(<em>key</em>)</td>
<td>
Returns the object specified by <em>key</em>, or 
null if the object is not found.</td></tr><tr>
<td>WebCache.Remove(<em>key</em>)</td>
<td>
Removes the object specified by <em>key</em> from 
the cache.</td></tr><tr>
<td>WebCache.Set(<em>key</em>, <em>value [, 
...
<tr>
<td>WebGrid(<em>data</em>)</td><td>Creates a 
new WebGrid object using data from a 
query.</td></tr><tr>
<td>WebGrid.GetHtml()</td><td>Renders markup 
to display data in an HTML table.</td></tr><tr>
<td>WebGrid.Pager()</td><td>Renders a pager 
for the WebGrid object.</td></tr>
</table>
<br><hr>

<h2>WebImage Object Reference</h2>
<table class="reference notranslate">
<tr>
<th style="width:50%">Helper</th>
<th>Description</th>
...
<tr>
<td>WebImage(<em>path</em>)</td><td>Loads an 
image from the specified path.</td></tr><tr>
<td>WebImage.AddImagesWatermark(<em>image</em>)</td>
<td>
Adds the specified image as a watermark.</td></tr><tr>
<td>WebImage.AddTextWatermark(<em>text</em>)</td>
<td>
Adds the specified text to the image.</td></tr><tr>
<td>WebImage.FlipHorizontal() <br>
WebImage.FlipVertical()</td><td>Flips the image 
horizontally or vertically.</td></tr><tr>
<td>WebImage.GetImageFromRequest()</td>
<td>
Loads an image when an image is posted to a page 
during a file upload.</td></tr><tr>
<td>WebImage.Resize(<em>width</em>,<em> height</em>)</td>
<td>
Resizes the image.</td></tr><tr>
<td>WebImage.RotateLeft() <br>
WebImage.RotateRight()</td><td>Rotates the image to 
the left or the right.</td></tr><tr>
<td>WebImage.Save(<em>path [, imageFormat]</em>)</td>
<td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_ref_helpers.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_ref_helpers.asp#top" target="_top">TOP</a> |
		<a href="webpages_ref_helpers.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
