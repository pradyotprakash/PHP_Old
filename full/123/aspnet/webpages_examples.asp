...
<title>ASP.NET Web Examples in C# and VB</title>
<style>a.menu_webpages_examples{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Examples in C# and VB</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_publish.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_ref_classes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn ASP.NET Web Pages by C# and Visual Basic examples.</p>
<hr>
<table class="reference notranslate" width="100%">
<tr>
<th style="font-size:120%">Examples in C#</th>
<th style="font-size:120%">Examples in VB</th>
</tr>

<tr>
<td>
<br><b>Basic Web Pages</b>
<p>
<a target="_blank" href="showfile_c.asp?filename=try_webpages_cs_001">Display Date and Time</a><br>
<a target="_blank" href="showfile_c.asp?filename=try_webpages_cs_002">Reusable Header and Footer</a><br>
<a target="_blank" href="showfile_c.asp?filename=try_webpages_cs_009">Basic HTML Form</a><br>
</p>
<p><a class="example" href="webpages_intro.asp">Examples Explained</a></p>
</td>

<td>
<br><b>Basic Web Pages</b><p>
<a href="showfile_vb.asp?filename=try_webpages_vb_001" target="_blank">Display Date and Time</a><br>
<a target="_blank" href="showfile_vb.asp?filename=try_webpages_vb_002">Reusable Header and Footer</a><br>
<a target="_blank" href="showfile_vb.asp?filename=try_webpages_vb_009">Basic HTML Form</a><br>
</p>
<p><a class="example" href="webpages_intro.asp">Examples Explained</a></p>
</td>
...
<br><b>Basic C#</b>
<p>
<a href="showfile_c.asp?filename=try_razor_cs_005" target="_blank">For Loop</a><br>
<a href="showfile_c.asp?filename=try_razor_cs_006" target="_blank">For Each Loop</a><br>
<a href="showfile_c.asp?filename=try_razor_cs_007" target="_blank">While Loop</a><br>
<a href="showfile_c.asp?filename=try_razor_cs_008" target="_blank">Array</a><br><br>
<a href="showfile_c.asp?filename=try_razor_cs_010" target="_blank">If Condition</a><br>
<a href="showfile_c.asp?filename=try_razor_cs_011" target="_blank">If Else Condition</a><br>
<a href="showfile_c.asp?filename=try_razor_cs_012" target="_blank">Else If Condition</a><br>
<a href="showfile_c.asp?filename=try_razor_cs_013" target="_blank">Switch Condition</a><br>
</p>
<p><a class="example" href="razor_intro.asp">Examples Explained</a></p>
</td>

<td>
<br><b>Basic VB</b>
<p>
<a href="showfile_vb.asp?filename=try_razor_vb_005" target="_blank">For Loop</a><br>
<a href="showfile_vb.asp?filename=try_razor_vb_006" target="_blank">For Each Loop</a><br>
<a href="showfile_vb.asp?filename=try_razor_vb_007" target="_blank">While Loop</a><br>
<a href="showfile_vb.asp?filename=try_razor_vb_008" target="_blank">Array</a><br><br>
<a href="showfile_vb.asp?filename=try_razor_vb_010" target="_blank">If Condition</a><br>
<a href="showfile_vb.asp?filename=try_razor_vb_011" target="_blank">If Else Condition</a><br>
<a href="showfile_vb.asp?filename=try_razor_vb_012" target="_blank">Else If Condition</a><br>
<a href="showfile_vb.asp?filename=try_razor_vb_013" target="_blank">Select Condition</a><br>
</p>
<p><a class="example" href="razor_intro.asp">Examples Explained</a></p>
</td>
</tr>
...
<td>
<br><b>Working with Databases</b>
<p>
<a target="_blank" href="showfile_c.asp?filename=try_webpages_cs_003">Display Database Data</a><br>
<a target="_blank" href="showfile_c.asp?filename=try_webpages_cs_004">Display Data with WebGrid</a><br>
</p>
<p><a class="example" href="webpages_database.asp">Examples Explained</a></p>
</td>

<td>
<br><b>Working with Databases</b>
<p>
<a target="_blank" href="showfile_vb.asp?filename=try_webpages_vb_003">Display Database Data</a><br>
<a target="_blank" href="showfile_vb.asp?filename=try_webpages_vb_004">Display Data with WebGrid</a><br>
</p>
<p><a class="example" href="webpages_database.asp">Examples Explained</a></p>
</td>
...
<td>
<br><b>Using the Chart Helper</b>
<p>
<a target="_blank" href="showfile_c.asp?filename=try_webpages_cs_005">Display a Bar Chart from an Array</a><br>
<a target="_blank" href="showfile_c.asp?filename=try_webpages_cs_006">Display a Bar Chart from a Database</a><br>
<a target="_blank" href="showfile_c.asp?filename=try_webpages_cs_007">Display a Pie Chart from a Database</a><br>
<a target="_blank" href="showfile_c.asp?filename=try_webpages_cs_008">Display a Pie Chart from an XML File</a><br>
</p>
<p><a class="example" href="webpages_chart.asp">Examples Explained</a></p>
</td>

<td>
<br><b>Using the Chart Helper</b>
<p>
<a target="_blank" href="showfile_vb.asp?filename=try_webpages_vb_005">Display a Bar Chart from an Array</a><br>
<a target="_blank" href="showfile_vb.asp?filename=try_webpages_vb_006">Display a Bar Chart from a Database</a><br>
<a target="_blank" href="showfile_vb.asp?filename=try_webpages_vb_007">Display a Pie Chart from a Database</a><br>
<a target="_blank" href="showfile_vb.asp?filename=try_webpages_vb_008">Display a Pie Chart from an XML File</a><br>
</p>
<p><a class="example" href="webpages_chart.asp">Examples Explained</a></p>
</td>
</tr>
...
<br/><br/>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_examples.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_ref_classes.asp">Next Chapter &raquo;</a></div>
</div>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_examples.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_examples.asp#top" target="_top">TOP</a> |
		<a href="webpages_examples.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
