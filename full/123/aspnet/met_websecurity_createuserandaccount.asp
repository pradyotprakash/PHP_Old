...
<title>WebSecurity CreateUserAndAccount Method</title>
<style>a.menu_met_websecurity_createuserandaccount{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> CreateUserAndAccount()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>CreateUserAndAccount()</strong> method creates a new account in the user database, using user name and 
password, and optionally lets you specify if the user must explicitly confirm 
the account.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.CreateUserAndAccount(<em>username, 
password, propertyValues, requireConfirmation</em>)</div></div>
<br>
<hr>
...
<tr>
<td><em>propertyValues</em></td>
<td>Object</td>
<td>A dictionary that contains additional user attributes</td>
</tr>
<tr>
<td><span style="font-style: italic">requireConfirmation</span></td>
<td>Boolean</td>
<td> <strong>true</strong> if the account must be confirmed using the token return value, 
default is
...
<tr>
<td>String</td>
<td>A token that can be sent to the user to confirm the account.</td>
</tr>
</table>
<br>
<hr>
...
<h2>Remarks</h2>
<p>The <strong>CreateUserAndAccount()</strong> method creates a new entry in the 
user profile table and then a corresponding entry in the membership table in the
<strong>WebSecurity database</strong>. </p>
<p>You can pass <strong>true</strong> for <em><strong>requireConfirmationToken</strong></em> 
parameter to require that the user account must be confirmed by the user. To 
confirm the account, you get the token as the return value from the <strong>
CreateUserAndAccount()</strong> method.</p>
<p>If you are manually maintaining the user profile table and only want to 
create a membership table entry for the user, call the <strong>CreateAccount()
...
<p>The <strong>CreateUserAndAccount()</strong> method also throws a <strong>MembershipCreateUserException</strong> if:</p>
<ul>
	<li>The username is empty</li>
	<li>The username already has a membership account</li>
	<li>The password is empty</li>
	<li>The password is too long</li>
	<li>The database operation failed</li>
</ul>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_createuserandaccount.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_createuserandaccount.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_createuserandaccount.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
