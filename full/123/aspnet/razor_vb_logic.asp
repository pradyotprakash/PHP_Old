...
<title>ASP.NET Razor VB Logic</title>
<style>a.menu_razor_vb_logic{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Razor <span class="color_h1">- VB Logic Conditions</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="razor_vb_loops.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Programming Logic: Execute code based on conditions.</p>
<hr>

<h2>The If Condition</h2>
<p>VB lets you execute code based on conditions.</p>
<p>To test a condition you use the <strong>if statement</strong>. The if 
statement returns true or false, based on your test:</p>
<ul>
	<li>The if statement starts a code block</li>
	<li>The condition is written between if and then</li>
	<li>The code between if ... then and end if is executed if the test is true</li>
</ul>
...
<div class="example_code notranslate">
	...
	price=50<br>End Code<br></span>&lt;html><br>&lt;body><br><span class="marked">@If price&gt;30 
	Then<br>&nbsp;&nbsp;&nbsp; @&lt;p&gt;The price is too high.&lt;/p&gt;<br>End 
	If<br></span>&lt;/body><br>&lt;/html>
</div>
<br>
	<a class="showbtn" href="showfile_vb.asp?filename=try_razor_vb_010" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
...
<p>An if statement can include an <strong>else condition</strong>.</p>
<p>The else condition defines the code to be executed if the condition is false.</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	<span class="marked">@Code<br>Dim 
	price=20<br>End Code<br></span>&lt;html&gt;<br>&lt;body&gt;<br>
	<span class="marked">@if price&gt;30 then<br>&nbsp;&nbsp;&nbsp; @&lt;p&gt;The price is too high.&lt;/p&gt;<br>
	Else<br>&nbsp;&nbsp;&nbsp; @&lt;p&gt;The price is OK.&lt;/p&gt;<br>End If <br></span>&lt;/body&gt;<br>&lt;/htmlV></div>
<br>
	<a class="showbtn" href="showfile_vb.asp?filename=try_razor_vb_011" target="_blank">Run example &raquo;</a>
</div>
<p><strong>Note:</strong> In the example above, if the first condition is true, it will be executed. 
The else condition covers &quot;everything else&quot;.</p>
<hr>

<h2>The ElseIf Condition</h2>

<p>Multiple conditions can be tested with an <strong>else if condition</strong>: </p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	<span class="marked">@Code<br>Dim 
	price=25<br>End Code<br></span>&lt;html&gt;<br>&lt;body&gt;<br>
	<span class="marked">@If price&gt;=30 Then<br>&nbsp;&nbsp;&nbsp; @&lt;p&gt;The price is 
	high.&lt;/p&gt;<br>ElseIf price&gt;20 And price&lt;30 <br>
	&nbsp;&nbsp;&nbsp; @&lt;p&gt;The price is OK.&lt;/p&gt;<br>Else<br>&nbsp;&nbsp;&nbsp; 
	@&lt;p&gt;The price is low.&lt;/p&gt;<br>End If&nbsp;&nbsp;&nbsp; <br></span>&lt;/body&gt;<br>&lt;/html&gt;</div>
<br>
	<a class="showbtn" href="showfile_vb.asp?filename=try_razor_vb_012" target="_blank">Run example &raquo;</a>
</div>
<p>In the example above, if the first condition is true, it will be executed.</p>
<p>If not, then if the next condition is true, this condition will be executed.</p>
<p>You can have any number of else if conditions.</p>
<p>If none of the if or else if conditions are true, the last else block 
(without a condition) covers &quot;everything else&quot;.</p>
<hr>

<h2>Select Conditions</h2>

<p>A <strong>select block</strong> can be used to test a number of individual conditions:</p>
...
<div class="example_code notranslate">
	...
	<span class="marked">
	@Code<br>Dim weekday=DateTime.Now.DayOfWeek<br>Dim day=weekday.ToString()<br>Dim message=&quot;&quot;<br>End Code<br></span>&lt;html&gt;<br>&lt;body&gt;<br>
	<span class="marked">
	...
	message=&quot;Today is &quot; &amp; day<br>End Select<br></span>&lt;p&gt;<span class="marked">@message</span>&lt;/p&gt;<br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<br>
	<a class="showbtn" href="showfile_vb.asp?filename=try_razor_vb_013" target="_blank">Run example &raquo;</a>
</div>
<p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="razor_vb_logic.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="razor_vb_logic.asp#top" target="_top">TOP</a> |
		<a href="razor_vb_logic.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
