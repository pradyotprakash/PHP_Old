...
<title>ASP.NET Hashtable</title>
<style>a.menu_aspnet_hashtable{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- The Hashtable Object</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_arraylist.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_sortedlist.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The Hashtable object contains items in key/value pairs.</p>
<hr>
...
<p><a target="_blank" href="showaspx.asp?filename=demo_hashtable_radio1">Hashtable RadiobuttonList 1</a></p>
<p><a target="_blank" href="showaspx.asp?filename=demo_hashtable_radio2">Hashtable RadiobuttonList 2</a></p>
<p><a target="_blank" href="showaspx.asp?filename=demo_hashtable_drop1">Hashtable DropDownList</a></p>
<hr>

<h2>Create a Hashtable</h2>
<p>The Hashtable object contains items in key/value pairs. The keys are used as indexes, and very quick searches can be made for values 
by searching through their keys.</p>
<p>Items are added to the Hashtable with the Add() method.</p>
<p>The following code creates a Hashtable named mycountries and four elements are added:</p>
...
if Not Page.IsPostBack then<br>
  &nbsp;
  dim mycountries=New Hashtable<br>
  &nbsp;
...
<br><a target="_blank" href="showaspx.asp?filename=demo_hashtable_radio1" class="showbtn">Show example &raquo;</a>
</div>
<p><b>Note:</b> You cannot choose the sort order of the items added to the Hashtable. To sort items alphabetically or numerically, use the SortedList object.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_arraylist.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_sortedlist.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_hashtable.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_hashtable.asp#top" target="_top">TOP</a> |
		<a href="aspnet_hashtable.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
