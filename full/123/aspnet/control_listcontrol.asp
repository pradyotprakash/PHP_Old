...
<title>ASP.NET ListControl Control</title>
<style>a.menu_control_listcontrol{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">ListControl</span> Control</h1>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Control Reference" /> Complete Web Control Reference</a>
<hr>
...
ListBox, and RadioButtonList classes.</p>
<p>The ListControl class allows you to specify the source of the data to 
populate the list control.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>A Boolean value that specifies whether list items are 
	cleared before data binding</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_listcontrol_autopostback.asp">AutoPostBack</a></td>
    <td>Specifies whether the form should be posted immediately 
	after the index of the selected item has changed or not</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>CausesValidation</td>
    <td>Specifies whether or not a page is validated when an item 
	in a list control is 
	clicked</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_listcontrol_datatextfield.asp">DataTextField</a></td>
    <td>A field in the data source to be displayed in the drop-down 
    list</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td>DataTextFormatString</td>
    <td>Formatting string used to specify how to display list data</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_listcontrol_datavaluefield.asp">DataValueField</a></td>
    <td>A field in the data source that specifies the value of each 
    selectable item in the drop-down list</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_listcontrol_items.asp">Items</a></td>
    <td>A collection of list items in the list</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td>runat</td>
	...
	<tr>
    <td><a href="prop_webcontrol_listcontrol_selectedindex.asp">SelectedIndex</a></td>
    <td>The index number of the selected item in a list</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_listcontrol_selecteditem.asp">
	SelectedItem</a></td>
    <td>The text of the selected item in a list</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_listcontrol_selectedvalue.asp">
	SelectedValue</a></td>
    <td>The value of the selected item in a list</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td>TagKey</td>
	...
	<tr>
    <td><a href="prop_webcontrol_listcontrol_text.asp">Text</a></td>
    <td>The value of the selected item in a list</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_listcontrol_validationgroup.asp">ValidationGroup</a></td>
  ...
  <tr>
    ...
    <td>The name of the function to be executed when the index of the selected item 
    has changed</td>
    <td>1.0</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_listcontrol.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_listcontrol.asp#top" target="_top">TOP</a> |
		<a href="control_listcontrol.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
