...
<title>ASP.NET AutoCompleteType Property</title>
<style>a.menu_prop_webcontrol_textbox_autocompletetype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">AutoCompleteType</span> Property</h1>
<hr>
<a href="control_textbox.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="TextBox Control Reference" /> 
 Complete TextBox Control Reference</a>
<hr>
<h2>Definition and Usage</h2>
<p>The AutoCompleteType property is used to set or return the AutoComplete 
category of a TextBox control.</p>
<p>The AutoComplete feature creates a list of values entered in a text box. When 
using the text box again, a list of values entered is displayed. The user can 
then select a value instead of retyping a previously entered value</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>

&lt;asp:TextBox AutoCompleteType=&quot;<i>cat</i>&quot; runat=&quot;server&quot;<i>/&gt;</i>
</div></div>
<br>
&nbsp;<table class="reference notranslate">
  <tr>
	...
	<tr>
		<td>cat</td>
		<td>Specifies the AutoComplete category.<p>Possible values:</p>
		<ul>
			<li>BusinessCity - City in the business category</li>
			<li>BusinessCountryRegion - Country/region in the business category</li>
			<li>BusinessFax - Fax number in the business category</li>
			<li>BusinessPhone - Phone number in the business category</li>
			<li>BusinessState - State in the business category</li>
			<li>BusinessStreetAddress - Street address&nbsp; in the business 
			category</li>
			<li>BusinessUrl - Web site URL in the business category</li>
			<li>BusinessZipCode - ZIP code in the business category</li>
			<li>Cellular - Phone number in the mobile-phone category</li>
			<li>Company - Business name in the business category</li>
			<li>Department - Department in the business category</li>
			<li>Disabled - AutoComplete feature is disabled</li>
			<li>DisplayName - Name to display in the user category</li>
			<li>Email - E-mail in the user category</li>
			<li>FirstName - First name in the user category</li>
			<li>Gender - Gender in the user category</li>
			<li>HomeCity - Home city in the user category</li>
			<li>HomeCountryRegion - Home country/region in the user category</li>
			<li>HomeFax - Fax number in the user category</li>
			<li>Homepage - Web site URL in the user category</li>
			<li>HomePhone - Phone number in the user category</li>
			<li>HomeState - Home state in the user category</li>
			<li>HomeStreetAddress - Home street in the user category</li>
			<li>HomeZipCode - ZIP code in the user category</li>
			<li>JobTitle - Job title in the user category</li>
			<li>LastName - Last name in the user category</li>
			<li>MiddleName - Middle name in the user category</li>
			<li>None - No category specified</li>
			<li>Notes - Extra information in the form</li>
			<li>Office - Office location in the business category</li>
			<li>Pager - Phone number in the pager category</li>
			<li>Search - Keywords in the search category</li>
		</ul>
		</td>
	</tr>
</table>
...
<p>The following example sets the AutoCompleteType mode to &quot;FirstName&quot;:</p>
<div class="example_code notranslate">
&lt;form runat=&quot;server&quot;&gt;<br>
&lt;asp:TextBox id=&quot;tb1&quot; runat=&quot;server&quot; AutoCompleteType=&quot;FirstName&quot; /&gt;<br>
&lt;/form&gt;
</div>
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_textbox_autocompletetype" class="showbtn">Show example &raquo;</a>
</div>
<hr>
<a href="control_textbox.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="TextBox Control Reference" /> Complete TextBox Control Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_textbox_autocompletetype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_textbox_autocompletetype.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_textbox_autocompletetype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
