...
<title>ASP.NET Web Pages Folders</title>
<style>a.menu_webpages_folders{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Folders</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_layout.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_global.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">This chapter is about folders and folder paths.</p>
<hr>
<p>In this chapter you will learn:</p>
<ul>
	<li>About Logical and Physical folder structures</li>
	<li>About Virtual and Physical names</li>
	<li>About web URLs and Paths</li>
</ul>
<hr>
<h2>Logical Folder Structure</h2>
<p>
Below is a typical folder structure for an ASP.NET web pages web: </p>
<img alt="Folders" src="31.jpg" width="494" height="113" style="border:1px solid lightgrey" />
<ul>
<li>The &quot;Account&quot; folder contains logon and security files</li>
<li>The &quot;App_Data&quot; folder contains databases and data files</li>
<li>The &quot;Images&quot; folder contains images</li>
	<li>The &quot;Scripts&quot; folder contains browser scripts</li>
<li>The &quot;Shared&quot; folder contains common files (like layout and style files)</li>
</ul>
<hr>
<h2>Physical Folder Structure</h2>
<p>
The physical  
structure for the &quot;Images&quot; folder at the website above might look like this on a computer:</p>
<p>
C:\Johnny\Documents\MyWebSites\Demo\Images <br> </p>
<hr>
<h2>Virtual and Physical Names</h2>
<p>
From the example above:</p>
<p>
The virtual name of a web picture might be &quot;Images/pic31.jpg&quot;.</p>
<p>
But the physical name is &quot;C:\Johnny\Documents\MyWebSites\Demo\Images\pic31.jpg&quot;</p>
<hr>
<h2>URLs and Paths</h2>
<p>URLs are used to access files from the web:
<a href="../html/html5_intro.asp">http://www.w3schools.com/html/html5_intro.asp</a> </p>
<p>The URL corresponds 
to a physical file on a server: C:\MyWebSites\w3schools\html\html5_intro.asp <br></p>
<p>A virtual 
path is shorthand to represent physical paths. If you use virtual paths, you can move your 
pages to a different domain 
(or server) without having to update the paths. </p>
<table style="width: 100%">
	<tr>
		<td>URL</td>
		<td>http://www.w3schools.com/html/html5_intro.asp</td>
	</tr>
	<tr>
		<td>Server name</td>
		<td>w3schools</td>
	...
	<tr>
		<td>Virtual path</td>
		<td>/html/html5_intro.asp</td>
	</tr>
	<tr>
		<td>Physical path</td>
		<td>C:\MyWebSites\w3schools\html\html5_intro.asp</td>
	</tr>
</table>
<p>The root on a disk drive is written like C:\, but the root on a web site is&nbsp; / 
(forward slash).</p>
<p>The virtual path of a 
web folder is (almost) never the same as the physical folder.</p>
<p>In your code you will, reference both the physical path and the virtual path, depending on what 
you are coding. </p>
<p>ASP.NET has 3 tools for working with folder paths: the ~ operator, the Server.MapPath method, 
and the Href method.</p>
<hr>
<h2>The ~ Operator</h2>
<p>To specify the virtual root in programming code, use the ~ operator.</p>
<p>If you use the ~ operator, instead of a path, you can move your website to a different folder or 
location without changing any code:</p>

<div class="code notranslate"><div>
var myImagesFolder = &quot;~/images&quot;;<br>
...
<hr>
<h2>The 
Server.MapPath Method</h2>
<p>The Server.MapPath method converts a virtual path (/default.cshtml) to a 
physical path that the server can understand (C:\Johnny\MyWebSited\Demo\default.cshtml).</p>
<p>You will use this method when you need to open data 
files located on the server (data files can only be accessed with a full 
physical path):</p>

<div class="code notranslate"><div>
	var pathName = &quot;~/dataFile.txt&quot;;<br>var fileName = Server.MapPath(pathName);</div></div>
<p>You will learn more about reading from (and writing to) data files on the server in 
the next chapter of this tutorial.</p>

<hr>
<h2>The Href Method</h2>
<p>The Href method converts a path used in the code to a path that the browser 
can understand (the browser cannot understand the ~ operator).</p>
<p>You use the Href method to create paths to resources like image files, and CSS files.</p>
<p>You will often use this method in HTML 
&lt;a&gt;, &lt;img&gt;, and &lt;link&gt; elements:</p>

<div class="code notranslate"><div>
@{var myStyleSheet = &quot;~/Shared/Site.css&quot;;}<br><br>&lt;!-- This creates a link 
to the CSS file. --&gt;<br>&lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; href=&quot;@Href(myStyleSheet)&quot; 
/&gt;<br><br>&lt;!-- Same as : --&gt;<br>&lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; href=&quot;/Shared/Site.css&quot; 
/&gt;</div></div>

<p>The Href method is a method of the WebPage Object.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_layout.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_global.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_folders.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_folders.asp#top" target="_top">TOP</a> |
		<a href="webpages_folders.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
