...
<title>WebSecurity ChangePassword Method</title>
<style>a.menu_met_websecurity_changepassword{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity - <span class="color_h1"> ChangePassword()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>ChangePassword()</strong> method changes the password for a specified user.</p>
<hr>

<h2>Syntax in C# and VB</h2>
<div class="code notranslate">
<div>
WebSecurity.ChangePassword(<em>userName, 
oldPassword, newPassword</em>)
</div>
</div>
<br>
<hr>
...
<tr>
<td>Boolean</td>
<td><strong>true</strong> if the password is changed, 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_changepassword.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_changepassword.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_changepassword.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
