...
<style>a.menu_mvc_controllers{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">- Controllers</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_layout.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_views.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">To learn ASP.NET MVC, we are Building an Internet Application.</p>
<p class="intro">Part IV: Adding a Controller.</p>

<hr>

<h2>The Controllers Folder</h2>
<p>The <strong>Controllers Folder</strong> contains the controller classes responsible for handling user input and responses.</p>
<p>MVC requires the name of all controllers to end with 
&quot;Controller&quot;.</p>
<p>In our example, Visual Web Developer has created the following files:
<strong>HomeController.cs</strong> (for the Home and About pages) and <strong>AccountController.cs</strong> 
(For the Log On pages):</p>
<p>
<img alt="Controllers" height="325" src="pic_mvc_controllers.jpg" width="202"></p>


<p>Web servers will normally map incoming URL requests directly to disk files on 
the server. For example: a URL request like &quot;http://www.w3schools.com/default.asp&quot; 
will map directly to the file &quot;default.asp&quot; at the root directory of the server.</p>
<p>The MVC framework maps differently. MVC maps URLs to methods. These methods 
are in classes called &quot;Controllers&quot;. </p>
<p>Controllers are responsible for processing incoming requests, handling input, 
saving data, and sending a response to send back to the client.</p>


<hr>

<h2>The Home controller</h2>
<p>The controller file in our application <strong>HomeController.cs</strong>, defines the two 
controls <strong>Index</strong> and <strong>About</strong>.</p>
<p>Swap the content of the HomeController.cs file with this:</p>
...
<br>namespace MvcDemo.Controllers<br>{<br>public class HomeController : Controller<br>{<br>
	public ActionResult Index()<br>{return View();}<br><br>public ActionResult 
	About()<br>{return View();}<br>}<br>}</div>
</div>
<br>
<hr>

<h2>The Controller Views</h2>


<p>The files <strong>Index.cshtml</strong> and <strong>About.cshtml</strong> in the Views folder defines the 
ActionResult views Index() and About() in the controller.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_controllers.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_controllers.asp#top" target="_top">TOP</a> |
		<a href="mvc_controllers.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
