...
<title>ASP.NET HtmlTextArea Control</title>
<style>a.menu_control_htmltextarea{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlTextArea</span> Control</h1>
<hr>
...
<p>The HtmlTextArea control is used to control a &lt;textarea&gt; element. In HTML, the &lt;textarea&gt; 
element is used to create a text area.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Cols</td>
    <td>The number of columns of the text area</td>
  </tr>
  <tr>
    <td>Disabled</td>
  ...
  <tr>
    <td>Name</td>
    <td>The unique name for the text area</td>
  </tr>
  <tr>
    <td>OnServerChange</td>
    <td>The name of the function to be executed when the contents of the textarea is changed</td>
  </tr>
  <tr>
    <td>Rows</td>
    <td>The number of visible rows of the text area</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td>Value</td>
    <td>The content of the textarea</td>
  </tr>
  <tr>
    <td>Visible</td>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmltextarea">HTMLTextarea</a><br>
...
&quot;You wrote: &quot; and the text the user wrote in the text area to the p element.</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmltextarea.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmltextarea.asp#top" target="_top">TOP</a> |
		<a href="control_htmltextarea.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
