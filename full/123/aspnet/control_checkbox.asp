...
<style>a.menu_control_checkbox{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">CheckBox</span> Control</h1>
<hr>
...
<p>The CheckBox control is used to display a check box.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>AutoPostBack</td>
    <td>Specifies whether the form should be 
    posted immediately after the Checked property has changed or not. Default is false</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>CausesValidation</td>
    <td>Specifies if a page is validated when a Button control is 
	clicked</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_checkbox_checked.asp">Checked</a></td>
    <td>Specifies whether the check box is 
    checked or not</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>InputAttributes</td>
    <td>Attribute names and values used for the Input element for 
	the CheckBox control</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td>LabelAttributes</td>
    <td>Attribute names and values used for the Label element for 
	the CheckBox control</td>
    <td>2.0</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="prop_webcontrol_checkbox_text.asp">Text</a></td>
    <td>The text next to the check box</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_checkbox_textalign.asp">TextAlign</a></td>
    <td>On which side of the check box the text should appear 
    (right or left)</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>ValidationGroup</td>
    <td>Group of controls for which the Checkbox control causes 
	validation when it posts back to the server</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td>OnCheckedChanged</td>
    <td>The name of the function to be executed when the Checked 
    property has changed</td>
    <td>&nbsp;</td>
  </tr>
  </table>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_checkbox">Checkbox</a><br>
Declare two TextBox controls and one CheckBox control in an .aspx file. Then create an event handler for the CheckedChanged 
event to copy the contents of a text box containing the home phone of a customer into a text box that contains the work phone.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_checkbox.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_checkbox.asp#top" target="_top">TOP</a> |
		<a href="control_checkbox.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
