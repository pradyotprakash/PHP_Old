...
<title>ASP.NET Web Pages Global Files</title>
<style>a.menu_webpages_global{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Global Pages</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_folders.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_forms.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">This chapter is about the global pages AppStart and PageStart.</p>
<hr>
...
exists, ASP.NET runs it the first time any page in the site is requested.</p>
<p>
Typical use for _AppStart is startup code and initialization of global values 
like counters and global names.</p>
<p>
<strong>Note 1:</strong> _AppStart should have the same file extension as your 
web pages, like: _AppStart.cshtml.&nbsp; </p>
<p>
<strong>Note 2: </strong>_AppStart has an underscore prefix. Because of this, 
the files cannot be browsed directly.</p>
<hr>
<h2>Before Every Page: _PageStart</h2>
<p>
Just like _AppStart runs before your site starts, you can write code that 
runs before any page in each folder.</p>
<p>
For each folder in your web, you can add a file named _PageStart.</p>
<p>
Typical use for _PageStart is setting the layout page for all pages in a 
folder, or checking that a user is logged in before running a page.</p>
<hr>
<h2>How Does it Work?</h2>
<p>
The following diagram shows how it works:</p>
<p>
<img alt="PageStart" height="316" src="pic_webpages_pagestart.jpg" width="630"></p>
<p>
When a request comes in, ASP.NET checks whether _AppStart exists. 
If so, and this is the first request to the site, _AppStart runs.</p>
<p>
Then ASP.NET checks whether _PageStart exists. If so, _PageStart runs, before the requested page.</p>
<p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_global.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_global.asp#top" target="_top">TOP</a> |
		<a href="webpages_global.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
