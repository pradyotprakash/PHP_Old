...
<title>ASP.NET SelectedItem Property</title>
<style>a.menu_prop_webcontrol_listcontrol_selecteditem{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">SelectedItem</span> Property</h1>
<hr>
...
<p>The SelectedItem property represents the text of a selected item in a list.</p>
<hr>
<div class="example">
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_listcontrol_selecteditem" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_listcontrol_selecteditem.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_listcontrol_selecteditem.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_listcontrol_selecteditem.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
