...
<style>a.menu_control_adrotator{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">AdRotator</span> Control</h1>
<hr>
...
<p>The AdRotator control is used to display a sequence of ad images.</p>
<p>This control uses an XML file to store the ad information. The XML file must begin and end with an &lt;Advertisements&gt; tag. 
Inside the &lt;Advertisements&gt; tag there may be several &lt;Ad&gt; tags which defines each ad.</p>
<p>The predefined elements inside the &lt;Ad&gt; tag are listed below:</p>
...
<table class="reference notranslate">
    ...
    <tr>
      <td>&lt;ImageUrl&gt;</td>
      <td>Optional. The path to the image file</td>
    </tr>
    <tr>
      <td>&lt;NavigateUrl&gt;</td>
      <td>Optional. The URL to link to if the user clicks the ad</td>
    </tr>
    <tr>
      <td>&lt;AlternateText&gt;</td>
      <td>Optional. An alternate text for the image</td>
    </tr>
    <tr>
      <td>&lt;Keyword&gt;</td>
      <td>Optional. A category for the ad</td>
    </tr>
    <tr>
      <td>&lt;Impressions&gt;</td>
      <td>Optional. The display rates in percent of the hits</td>
    </tr>
  </table>
<br>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_adrotator_advertisementfile.asp">AdvertisementFile</a></td>
    <td>Specifies the path to the XML file that contains ad information</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>AlternateTextField</td>
    <td>Specifies a data field to be used instead of the Alt text for an ad</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td>ImageUrlField</td>
    <td>Specifies a data field to be used instead of the ImageURL attribute for an ad</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td>KeywordFilter</td>
    <td>Specifies a filter to limit ads after categories</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>NavigateUrlField</td>
    <td>Specifies a data field to be used instead of the NavigateUrl attribute for an ad</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td><a href="prop_webcontrol_adrotator_target.asp">Target</a></td>
    <td>Specifies where to open the URL</td>
    <td>1.0</td>
  </tr>
</table>
...
<p><a target="_blank" href="showaspx.asp?filename=demo_adrotator">AdRotator</a><br>
Declare an AdRotator control. Then we create an event handler for the AdCreated event, in the .aspx file, to 
override the value of the NavigateUrl element in the XML file.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_adrotator.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_adrotator.asp#top" target="_top">TOP</a> |
		<a href="control_adrotator.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
