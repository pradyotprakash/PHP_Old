...
<title>ASP.NET RegularExpressionValidator Control</title>
<style>a.menu_control_regularexpvalidator{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">RegularExpressionValidator</span> Control</h1>
<hr>
...
<p>The RegularExpressionValidator control is used to ensure that an input value matches a specified pattern.</p>
<p><b>Note: </b>Both server- and client-side validation are performed unless the browser does not support client-side validation or the EnableClientScript property is set to false.</p>
...
<tr>
  ...
  <tr>
    <td>BackColor</td>
    <td>The background color of the RegularExpressionValidator control</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Specifies the expression used to validate input control. The expression validation syntax is different on the client than on the server. JScript is used 
    on the client. On the server, the language you have specified is used</td>
  </tr>
</table>
<br>
<hr>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_regularexpvalidator">RegularExpressionValidator</a><br>
...
displayed in the RegularExpressionValidator control.</p>
<hr>
<a href="aspnet_refvalidationcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Validation Server Controls" /> Validation Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_regularexpvalidator.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_regularexpvalidator.asp#top" target="_top">TOP</a> |
		<a href="control_regularexpvalidator.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
