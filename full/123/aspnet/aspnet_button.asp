...
<title>ASP.NET Button Controls</title>
<style>a.menu_aspnet_button{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- The Button Control</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_textbox.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_databinding.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<p class="intro">The Button control is used to display a push button.</p>
<hr>
...
<p>A form is most often submitted by clicking on a button.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_button.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_button.asp#top" target="_top">TOP</a> |
		<a href="aspnet_button.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
