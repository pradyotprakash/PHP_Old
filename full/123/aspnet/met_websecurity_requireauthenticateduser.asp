...
<title>WebSecurity RequireAuthenticatedUser Method</title>
<style>a.menu_met_websecurity_requireauthenticateduser{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> RequireAuthenticatedUser()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>RequireAuthenticatedUser</strong><strong>()</strong> method sets the HTTP status to 401 (Unauthorized) if the current user is not 
authenticated.</p>
<hr>
...
<div>
WebSecurity.RequireAuthenticatedUser()</div></div>
<br>
<hr>
...
<h2>Remarks</h2>
<p><strong>RequireAuthenticatedUser()</strong> only validates if the current user is authenticated. 
If the current user is not authenticated, the HTTP status is set to 401 
(Unauthorized).</p>
<p>To validate if the current user is a specific user (by ID or by name), use 
the <strong>RequireUser()</strong> method. To validate that a user is a member of 
a role (roles), use the <strong>RequireRoles()</strong> method.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_requireauthenticateduser.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_requireauthenticateduser.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_requireauthenticateduser.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
