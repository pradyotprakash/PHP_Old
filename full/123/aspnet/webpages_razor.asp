...
<title>ASP.NET Web Pages Razor</title>
<style>a.menu_webpages_razor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Adding Razor Code</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_layout.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">In this tutorial we will use Razor markup with C# and Visual 
Basic code</p>
<hr>
<h2>What is Razor?</h2>
<ul>
	<li>Razor is a markup syntax for adding server-based code to web pages</li>
	<li>Razor has the power of traditional ASP.NET markup, but is easier to 
	learn, and easier to use</li>
	<li>Razor is a server side markup syntax much like ASP and PHP</li>
	<li>Razor supports C# and Visual Basic programming languages</li>
</ul>
<hr>
<h2>Adding Razor Code</h2>
<p>Remember the web page from previous chapter:</p>
...
<p>Now add some Razor code to the example:</p>
...
<br>
<a class="showbtn" href="showfile_c.asp?filename=try_webpages_cs_001" target="_blank">
Run example &raquo;</a>
</div>

<p>The page contains ordinary HTML markup, with one addition: the @ marked Razor code.</p>
<p>The Razor code does all the work of determining the current time on the server and display it.
(You can specify formatting options, or just display the default)</p>
...
<p>If you want to learn more about Razor, and the C# and Visual Basic 
programming languages, go to the <a href="razor_intro.asp">Razor section</a> of 
this tutorial. </p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_razor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_razor.asp#top" target="_top">TOP</a> |
		<a href="webpages_razor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
