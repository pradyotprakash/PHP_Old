...
<title>ASP.NET RequiredFieldValidator Control</title>
<style>a.menu_control_reqfieldvalidator{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">RequiredFieldValidator</span> Control</h1>
<hr>
...
<p>The RequiredFieldValidator control is used to make an input control a required field.</p>
<p>With this control, the validation fails if the input value does not change from its initial value. By default, the initial value is an empty string (&quot;&quot;).</p>
<p><b>Note:</b> Leading and trailing spaces of the input value are removed before validation.</p>
<p><b>Note:</b> The InitialValue property does not set the default value for the input control. It indicates the value that you do <b>not</b> want the user to enter in the input control.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>BackColor</td>
    <td>The background color of the RequiredFieldValidator control</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>InitialValue</td>
    <td>Specifies the starting value of the input control. Default value is &quot;&quot;</td>
  </tr>
  <tr>
    <td>IsValid</td>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_reqfieldvalidator">RequiredFieldValidator</a><br>
Declare two TextBox controls, one Button control, and one RequiredFieldValidator control in an .aspx file. It 
shows how to use the RequiredFieldValidator control to make the &quot;txt_name&quot; textbox a required field.</p>
<hr>
<a href="aspnet_refvalidationcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Validation Server Controls" /> Validation Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_reqfieldvalidator.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_reqfieldvalidator.asp#top" target="_top">TOP</a> |
		<a href="control_reqfieldvalidator.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
