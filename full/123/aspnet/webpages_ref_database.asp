...
<title>ASP.NET Web Pages Database Reference</title>
<style>a.menu_webpages_ref_database{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Database Object</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_ref_websecurity.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_ref_webmail.asp">Next Chapter &raquo;</a></div>
</div>
...
<tr>
<td>Database.Execute(<em>SQLstatement [</em>,
<em>parameters])</em></td><td>Executes <em>
SQLstatement</em> (with optional parameters) such as 
INSERT, DELETE, or UPDATE and returns a count of 
affected records.</td></tr><tr>
<td>Database.GetLastInsertId()</td>
<td>
Returns the identity column from the most recently 
inserted row.</td></tr><tr>
<td>Database.Open(<em>filename</em>) <br>
...
from the <em>Web.config</em> file.</td></tr><tr>
<td>Database.OpenConnectionString(<em>connectionString</em>)</td>
<td>
Opens a database using the connection string. (This 
contrasts with Database.Open, which 
uses a connection string name.)</td></tr><tr>
<td>Database.Query(<em>SQLstatement[, 
...
<td>Database.QuerySingle(<em>SQLstatement</em>
<em>[, parameters]</em>)</td><td>Executes <em>
SQLstatement</em> (with optional parameters) and 
returns a single record.</td></tr><tr>
<td>Database.QueryValue(<em>SQLstatement</em>
<em>[, parameters]</em>)</td><td>Executes <em>
SQLstatement</em> (with optional parameters) and 
returns a single value.</td></tr></table>
<br><br>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_ref_websecurity.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_ref_webmail.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_ref_database.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_ref_database.asp#top" target="_top">TOP</a> |
		<a href="webpages_ref_database.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
