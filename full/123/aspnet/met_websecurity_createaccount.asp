...
<title>WebSecurity CreateAccount Method</title>
<style>a.menu_met_websecurity_createaccount{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> CreateAccount()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>CreateAccount()</strong> method creates a new account in the user database, using user name and 
...
WebSecurity.CreateAccount(<em>username, 
password, requireConfirmation</em>)</div></div>
<br>
<hr>
...
<p>The <strong>CreateAccount()</strong> method also throws a <strong>MembershipCreateUserException</strong> if:</p>
<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_createaccount.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_createaccount.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_createaccount.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
