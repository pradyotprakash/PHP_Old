...
<head>
<title>ASP.NET MVC Introduction</title>
<style>a.menu_mvc_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">Tutorial</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="razor_vb_logic.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_app.asp">Next Chapter &raquo;</a></div>
</div>
<br>

<div class="tutintro">
<img src="http://www.w3schools.com/images/w3aspnet.gif" alt="ASP.NET" />
<p>ASP.NET is a development framework for building web pages and web 
sites with HTML, CSS, JavaScript and server scripting.</p>
	<p>ASP.NET supports three different development models:<br>
Web Pages, MVC (Model View Controller), and Web Forms.</p>
<p><strong>THIS TUTORIAL COVERS MVC</strong></p>
</div>
<table style="font-size:20px" width="100%" cellpadding="8" cellspacing="0" border="0">
<tr>
<td style="width:32%;text-align:center;color:white;background:lightgrey">Web Pages</td>
<td style="width:2%"></td>
<td style="width:32%;text-align:center;color:white;background:#73ad21">MVC</td>
<td style="width:2%"></td>
<td style="width:32%;text-align:center;color:white;background:lightgrey">Web Forms</td>
</tr>
</table>
<br>

<hr>
<h2>The MVC Programming Model</h2>
<p>MVC is one of three ASP.NET programming models. </p>
<p>MVC is a framework for building web applications using a MVC (Model View 
Controller) design: </p>
<ul>
	<li>The Model represents the application core
	(for instance a list of 
	database records).</li>
	<li>The View displays the data
	(the database records).</li>
	<li>The Controller handles the input
	(to the database records). </li>
</ul>
<p>The MVC model also provides full control over HTML, CSS, and JavaScript.</p>

<hr>

<table width="100%"><tr>
<td><img src="27.jpg" alt="MVC" width="327px" height="314px" /></td>
<td style="vertical-align:top">
<p class="intro">The MVC model defines web <br>applications with 3 logic layers:</p>
<p class="intro">&nbsp;</p>
<p class="intro">The business layer (Model logic)</p>
<p class="intro">The display layer (View logic) </p>
<p class="intro">The input control (Controller logic)</p>
</td>
</tr></table>
<p><b>The Model</b> is the part of the application that handles the logic for the 
application data.<br>
Often model objects retrieve data (and store data) from a 
database.</p>
<p><b>The View</b> is the parts of the application that handles the display of the 
data.<br>
Most often the views are created from the model data.</p>
<p><b>The Controller</b> is the part of the application that handles user 
interaction.<br>
Typically controllers read data from a view, control user input, and send 
input data 
to the model.</p>
<p>The MVC separation helps you manage complex applications, because you can 
focus on one aspect a time. For example, you can focus on the view without 
depending on the business logic. It also makes it easier to test an application.</p>
<p>The MVC separation also simplifies group development. Different developers 
can work on the view, the controller logic, and the business logic in parallel.</p>

<hr>

<h2>Web Forms vs MVC</h2>
<p>The MVC programming model is a lighter alternative to traditional ASP.NET (Web Forms). 
...
<hr>
<h2>Visual Studio Express 2012/2010</h2>

<p>Visual Studio Express is a free version of Microsoft Visual Studio.</p>
<p>Visual Studio Express is a development tool tailor made for MVC (and Web Forms).</p>
<p>Visual Studio Express contains:
</p>
<ul>
<li>MVC and Web Forms</li>
<li>Drag-and-drop web controls and web components</li>
<li>A web server language (Razor using VB or C#)</li>
<li>A web server (IIS Express)</li>
<li>A database server (SQL Server Compact)</li>
<li>A full web development framework (ASP.NET)</li>
</ul>


<p>If you install Visual Studio Express, you will get more benefits from this 
tutorial.</p>
<p>If you want to install Visual Studio Express, click on one of these links:</p>
<p><a href="http://www.microsoft.com/web/handlers/webpi.ashx?command=getinstallerredirect&appid=VWDOrVs11AzurePack">
Visual Web Developer 2012</a> (If you have Windows 7 or 
Windows 8)</p>

<p><a href="http://www.microsoft.com/web/gallery/install.aspx?appid=VWDorVS2010SP1Pack">
Visual Web Developer 2010</a> (If you have Windows Vista or XP)</p>

<p><table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
After you have installed Visual Studio Express the first time, it pays to run the 
installation one more time, to install fixes and service packs. Just click on 
the link once more.</td>
</tr></table>
<br>
<hr>

<h2>ASP.NET MVC References</h2>
<p>At the end of this tutorial you will find a complete ASP.NET MVC reference.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_intro.asp#top" target="_top">TOP</a> |
		<a href="mvc_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
