...
<title>WebSecurity RequireUser Method</title>
<style>a.menu_met_websecurity_requireuser{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> RequireUser()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>RequireUser()</strong> method sets the HTTP status to 401 (Unauthorized) if the specified user is not 
logged on.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.RequireUser(userId)<br><br>or<br><br>WebSecurity.RequireUser(userName)</div></div>
<br>
<hr>
<h2>Parameters</h2>
...
<h2>Remarks</h2>
<p><strong>RequireUser()</strong> verifies that the current user is the specified 
user.</p>
<p>To validate that the user is authenticated, use <strong>
RequireAuthenticatedUser()</strong> instead. </p>
<p>To validate that a user is a member 
of a role (roles), use <strong>RequireRoles()</strong>.</p>
<p><strong>RequireUser()</strong> lets only the specified user access the web 
page. The recommended way to restrict access to a page is to create a role, 
and use the <strong>RequireRoles()</strong> method to verify that the  
user is a member of that role.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_requireuser.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_requireuser.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_requireuser.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
