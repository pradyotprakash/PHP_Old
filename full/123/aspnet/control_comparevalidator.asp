...
<title>ASP.NET CompareValidator Control</title>
<style>a.menu_control_comparevalidator{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">CompareValidator</span> Control</h1>
<hr>
...
<p>The CompareValidator control is used to compare the value of one input control to the value of another input control or to a fixed value.</p>
<p><b>Note:</b> If the input control is empty, the validation will succeed. Use the RequiredFieldValidator control to make the field required.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>BackColor</td>
    <td>The background color of the CompareValidator control</td>
  </tr>
  <tr>
    <td>ControlToCompare</td>
    <td>The name of the control to compare with</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Operator</td>
    <td>The type of comparison to perform. The operators are:
    <ul>
      <li>Equal</li>
      <li>GreaterThan</li>
  ...
  <tr>
    <td>Type</td>
    <td>Specifies the data type of the values to compare. The types are:
    <ul>
      <li>Currency</li>
      <li>Date</li>
      <li>Double</li>
  ...
  <tr>
    ...
    <td>A specified value to compare with</td>
  </tr>
</table>
<br>
<hr>
...
<h2>Examples</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_comparevalidator">CompareValidator</a><br>
Declare two TextBox controls, one Button control, and one CompareValidator control in an .aspx file. If 
validation fails, the text &quot;Validation Failed!&quot; will be displayed in red on a yellow background in the CompareValidator control.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_comparevalidator2">CompareValidator 2</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_comparevalidator.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_comparevalidator.asp#top" target="_top">TOP</a> |
		<a href="control_comparevalidator.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
