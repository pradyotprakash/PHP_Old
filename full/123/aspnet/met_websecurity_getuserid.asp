...
<title>WebSecurity GetUserId Method</title>
<style>a.menu_met_websecurity_getuserid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> GetUserId()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>GetUserId()</strong> method returns the ID for the specified user.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.GetUserId(<em>userName</em>)</div></div>
<br>
<hr>
...
<h2>Remarks</h2>
<p>The user ID is the primary key for the user information stored in the user 
database. </p>
<p>It is used to identify the user, both in the user profile table and in 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_getuserid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_getuserid.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_getuserid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
