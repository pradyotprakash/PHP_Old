...
<head>
<title>ASP.NET MVC Models</title>
<style>a.menu_mvc_models{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">- Models</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_database.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_security.asp">Next Chapter &raquo;</a></div>
</div>

<hr>
<p class="intro">To learn ASP.NET MVC, we are Building an Internet Application.</p>
<p class="intro">Part VII: Adding a Data Model.</p>

<hr>

<h2>MVC Models</h2>
<p>The MVC <strong>Model</strong> contains all application logic (business 
logic, validation logic, and data access logic), except pure view and controller 
logic.</p>
<p>With MVC, models both hold and manipulate application data.</p>

<hr>

<h2>The Models Folder</h2>
<p>The <strong>Models Folder</strong> contains the classes that represent the 
application model. </p>
<p>Visual Web Developer automatically creates an <strong>AccountModels.cs</strong> 
file that contains the models for application security. </p>
<p><strong>AccountModels</strong> 
contains a <strong>LogOnModel</strong>, a <strong>ChangePasswordModel</strong>, and 
a 
<strong>RegisterModel.</strong></p>

<hr>

<h2>Adding a Database Model</h2>
<p>The database model needed for this tutorial can be created with these simple steps:</p>
<ul>
	<li>In the <strong>Solution Explorer</strong>, right-click the <strong>
	Models</strong> folder, and select <strong>Add</strong> and <strong>Class</strong>.</li>
	<li>Name the class <strong>MovieDB.cs</strong>, and click <strong>Add</strong>.</li>
	<li>Edit the class:</li>
</ul>
...
<p>We have deliberately named the model class &quot;MovieDB&quot;. In the 
previous chapter, you saw the name &quot;MovieDBs&quot; (ending with s) used for the 
database table. It looks strange, but this is the naming convention you have to 
use to make the model connect to the database table. </p>
<hr>

<h2>Adding a Database Controller</h2>
<p>The database controller needed for this tutorial can be created with these simple steps:</p>
<ul>
	<li>Re-Build your project: Select <strong>Debug</strong>, and then <strong>
	Build MvcDemo</strong> from the menu.</li>
	<li>In the Solution Explorer, right-click the <strong>Controllers</strong> 
	folder, and select <strong>Add</strong> and <strong>Controller</strong></li>
	<li>Set controller name to <strong>MoviesController</strong></li>
	<li>Select template: <strong>Controller with read/write actions and views, 
	using Entity Framework</strong></li>
	<li>Select model class: <strong>MovieDB (MvcDemo.Models)</strong></li>
	<li>Select data context class: <strong>MovieDBContext (MvcDemo.Models)</strong></li>
	<li>Select views <strong>Razor (CSHTML)</strong></li>
	<li>Click <strong>Add</strong></li>
</ul>
<p>Visual Web Developer will create the following files:</p>
<ul>
	<li>A <strong>MoviesController.cs</strong> file in the <strong>Controllers</strong> 
	folder</li>
	<li>A <strong>Movies</strong> folder in the <strong>Views</strong> folder</li>
</ul>
<hr>

<h2>Adding Database Views</h2>
<p>The following files are automatically created in the Movies folder:</p>
<ul>
	<li>Create.cshtml</li>
	<li>Delete.cshtml</li>
...
<p>Congratulations. You have added your first MVC data model to your 
application.</p>
<p>Now you can click on the &quot;Movies&quot; tab :-)</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_models.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_models.asp#top" target="_top">TOP</a> |
		<a href="mvc_models.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
