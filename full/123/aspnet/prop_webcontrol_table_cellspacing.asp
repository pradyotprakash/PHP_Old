...
<style>a.menu_prop_webcontrol_table_cellspacing{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The CellSpacing property is used to get or set the amount of space (in 
pixels) between the cells in a table.</p>
<p><b>Note:</b> This property does not work in FireFox.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>

&lt;asp:Table CellSpacing=&quot;<i>px</i>&quot; runat=&quot;server&quot;&gt;<br>
<i>Some Content</i><br>
&lt;/asp:Table&gt;
</div></div>
&nbsp;<table class="reference notranslate">
  <tr>
	...
	<tr>
		<td>px</td>
		<td>Specifies how many pixels of space there is between the 
		cells</td>
	</tr>
</table>
<br>
...
<p>The following example sets the CellSpacing property of the Table control:</p>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_table_cellspacing" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_table_cellspacing.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_table_cellspacing.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_table_cellspacing.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
