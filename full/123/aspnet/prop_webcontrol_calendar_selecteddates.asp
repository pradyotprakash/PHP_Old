...
<title>ASP.NET SelectedDates Property</title>
<style>a.menu_prop_webcontrol_calendar_selecteddates{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">SelectedDates</span> Property</h1>
<hr>
...
<p>The SelectedDates property is used to get or set the selected dates from a calendar.<br>
</p>
<hr>
<div class="example">
<h2 class="example">Example</h2>
<p>The following example outputs the selected dates when a date is selected:</p>
<div class="example_code notranslate">
&lt;script language=&quot;VB&quot; runat=&quot;server&quot;&gt;<br>
Sub Change(obj As Object, e As EventArgs)<br>
&nbsp;&nbsp;Dim i As Integer<br>
&nbsp;&nbsp;For i = 0 To Cal1.SelectedDates.Count - 1<br>
&nbsp;&nbsp;&nbsp;&nbsp;Response.Write(Cal1.SelectedDates(i).ToShortDateString())<br>
...
SelectionMode=&quot;DayWeekMonth&quot;<br>
OnSelectionChanged=&quot;Change&quot; /&gt;<br>
&lt;/form&gt;
</div>
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_calendar_selecteddates" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_calendar_selecteddates.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_calendar_selecteddates.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_calendar_selecteddates.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
