...
<title>ASP.NET TextBox Control</title>
<style>a.menu_control_textbox{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">TextBox</span> Control</h1>
<hr>
...
<p>The TextBox control is used to create a text box where the user can input text.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_textbox_autocompletetype.asp">AutoCompleteType</a></td>
    <td>Specifies the AutoComplete behavior of a TextBox</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_textbox_autopostback.asp">AutoPostBack</a></td>
    <td>A Boolean value that specifies whether the control is 
	automatically posted back to the server when the contents change or not. 
	Default is false</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>CausesValidation</td>
    <td>Specifies if a page is validated when a Postback occurs</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_textbox_columns.asp">Columns</a></td>
    <td>The width of the textbox</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_textbox_maxlength.asp">MaxLength</a></td>
    <td>The maximum number of characters allowed in the textbox</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_textbox_readonly.asp">ReadOnly</a></td>
    <td>Specifies whether or not the text in the text box can be 
	changed</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_textbox_rows.asp">Rows</a></td>
    <td>The height of the textbox (only used if TextMode=&quot;Multiline&quot;)</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td><a href="prop_webcontrol_textbox_text.asp">Text</a></td>
    <td>The contents of the textbox</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_textbox_textmode.asp">TextMode</a></td>
    <td>Specifies the behavior mode of a TextBox control (SingleLine, MultiLine or Password)</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>ValidationGroup</td>
    <td>The group of controls that is validated when a Postback 
	occurs</td>
    <td>&nbsp;</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_textbox_wrap.asp">Wrap</a></td>
    <td>A Boolean value that indicates whether the contents of the 
	textbox should wrap or not</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td>OnTextChanged</td>
    <td>The name of the function to be executed when the text in 
	the textbox has changed</td>
    <td>&nbsp;</td>
  </tr>
  </table>
...
<h2>Examples</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_textbox">Textbox</a><br>
...
<p><a target="_blank" href="showaspx.asp?filename=demo_textbox2">Textbox 2</a><br>
Declare one TextBox control, one Button control, and one Label control in an .aspx file. When the 
submit button is triggered, the submit subroutine is executed. The submit 
subroutine copies the contents of the textbox to the Label control.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_textbox.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_textbox.asp#top" target="_top">TOP</a> |
		<a href="control_textbox.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
