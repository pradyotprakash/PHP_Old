...
<title>WebSecurity GetCreateDate Method</title>
<style>a.menu_met_websecurity_getcreatedate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity - <span class="color_h1"> GetCreateDate()</span></h1>
<hr>
...
<h2>Definition and Use</h2>
<p>The <strong>GetCreateDate()</strong> method returns the date and time when the specified membership account was created.</p>
<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.GetCreateDate(<em>userName</em>)</div></div>
<br>
<hr>
...
<tr>
<td>DateTime</td>
<td>The date and time the membership account was created</td>
</tr>
</table>
<br>
<hr>
...
<p>If the account creation date is not available, the <strong>GetCreatedDate()</strong> method returns 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_getcreatedate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_getcreatedate.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_getcreatedate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
