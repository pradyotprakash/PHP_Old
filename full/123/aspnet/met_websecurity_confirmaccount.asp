...
<title>WebSecurity ConfirmAccount Method</title>
<style>a.menu_met_websecurity_confirmaccount{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> ConfirmAccount()</span></h1>
<hr>
<a href="webpages_ref_websecurity.asp">
<img class="navup" src="http://www.w3schools.com/images/up.gif" alt="WebSecurity Object" /> WebSecurity Object</a>
<hr>

<h2>Definition</h2>
<p>The <strong>ConfirmAccount()</strong> method confirms and activates an account using a confirmation token.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.ConfirmAccount(<em>accountConfirmationToken</em>)</div></div>
<br>
<hr>
...
string message = &quot;&quot;;<br>
var confirmationToken = Request[&quot;confirmationCode&quot;];<br>
<br>
WebSecurity.Logout();<br><br>if (!confirmationToken.IsEmpty())<br>
{<br>
&nbsp;&nbsp;&nbsp; 
if (WebSecurity.ConfirmAccount(confirmationToken))<br>
&nbsp;&nbsp;&nbsp; {<br>
&nbsp;&nbsp;&nbsp; message = &quot;Registration confirmed&quot;;<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp; else<br>
&nbsp;&nbsp;&nbsp; {<br>
&nbsp;&nbsp;&nbsp; message = &quot;Could not 
...
<br>
<div class="example">
<h2 class="example">Example VB</h2>
<div class="example_code notranslate">
message = &quot;&quot;<br>confirmationToken = Request(&quot;confirmationCode&quot;)<br>
<br>
WebSecurity.Logout()<br>
<br>
if !confirmationToken.IsEmpty() then<br>
&nbsp;&nbsp;&nbsp;if WebSecurity.ConfirmAccount(confirmationToken) then<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message = &quot;Registration Confirmed&quot;<br>
&nbsp;&nbsp;&nbsp; else<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message = &quot;Could not confirm your registration&quot;<br>
&nbsp;&nbsp;&nbsp; end if
<br>
end if</div>
</div>
...
<tr>
<td><span style="font-style: italic">accountConfirmationToken</span></td>
<td>String</td>
<td>The confirmation tokene</td>
</tr>
</table>
<br>
<hr>
...
<tr>
<td>Boolean</td>
<td>&nbsp;<strong>true</strong> if the account is confirmed, otherwise
...
<p>Common procedure is to send the token to a user in an email, and ask the user 
to verify the identity (via a link to a confirmation page).</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_confirmaccount.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_confirmaccount.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_confirmaccount.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
