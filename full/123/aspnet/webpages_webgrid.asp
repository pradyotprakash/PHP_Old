...
<style>a.menu_webpages_webgrid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- The WebGrid Helper</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_helpers.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_chart.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<p class="intro">WebGrid - One of many useful ASP.NET Web Helpers.</p>
<hr>

<h2>Doing the HTML Yourself</h2>
<p>In a previous chapter, you displayed database data by using razor code,  
and doing the HTML markup yourself: </p>

<div class="example">
<h2 class="example">Database Example</h2>
...
&lt;td style=&quot;text-align:right&quot;&gt;<span class="marked">@row.Price</span>&lt;/td&gt;&nbsp;<br>
&lt;/tr&gt;&nbsp;<br>
...
&lt;/html&gt;</div>
<br>
	<a class="showbtn" href="showfile_c.asp?filename=try_webpages_cs_003" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>Using The WebGrid Helper</h2>
<p>Using the WebGrid helper is an easier way to display data.</p>
<p>The WebGrid helper:</p>
<ul>
	<li>Automatically sets up an HTML table to display data</li>
	<li>Supports different options for formatting</li>
	<li>Supports paging through data</li>
	<li>Supports Sorting by clicking on column headings</li>
</ul>
<div class="example">
<h2 class="example">WebGrid Example</h2>
<div class="example_code notranslate">
<span class="marked">@{&nbsp;<br>
var db = Database.Open(&quot;SmallBakery&quot;) ;&nbsp;<br>
var selectQueryString = &quot;SELECT * FROM Product ORDER BY Name&quot;;&nbsp;<br>
...
&lt;html&gt;&nbsp;<br>
&lt;head&gt;&nbsp;<br>
&lt;title&gt;Displaying Data Using the WebGrid Helper&lt;/title&gt;&nbsp;<br>
&lt;/head&gt;&nbsp;<br>
&lt;body&gt;&nbsp;<br>
&lt;h1&gt;Small Bakery Products&lt;/h1&gt;&nbsp;<br>
&lt;div id=&quot;grid&quot;&gt;&nbsp;<br>
<span class="marked">@grid.GetHtml()</span><br>
&lt;/div&gt;&nbsp;<br>
&lt;/body&gt;&nbsp;<br>
&lt;/html&gt;</div>
<br>
	<a class="showbtn" href="showfile_c.asp?filename=try_webpages_cs_004" target="_blank">Run example &raquo;</a>
</div>
<br>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_webgrid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_webgrid.asp#top" target="_top">TOP</a> |
		<a href="webpages_webgrid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
