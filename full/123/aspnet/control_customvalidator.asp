...
<title>ASP.NET CustomValidator Control</title>
<style>a.menu_control_customvalidator{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">CustomValidator</span> Control</h1>
<hr>
...
<p>The CustomValidator control allows you to write a method to handle the validation of the value entered.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>BackColor</td>
    <td>The background color of the CustomValidator control</td>
  </tr>
  <tr>
    <td>ClientValidationFunction</td>
    <td>Specifies the name of the client-side validation script function to be executed.
    <b>Note:</b> The script must be in a language that the browser supports, such as VBScript or JScript
    <p>With VBScript, the function must be in the form:</p>
    <p>Sub FunctionName (source, arguments)</p>
    <p>With JScript, the function must be in the form:</p>
    <p>Function FunctionName (source, arguments)</p></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Specifies the name of the server-side validation script function to be executed</td>
  </tr>
  <tr>
    <td>runat</td>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_customvalidator">CustomValidator</a><br>
...
will appear in the CustomValidator control.</p>
<hr>
<a href="aspnet_refvalidationcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Validation Server Controls" /> Validation Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_customvalidator.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_customvalidator.asp#top" target="_top">TOP</a> |
		<a href="control_customvalidator.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
