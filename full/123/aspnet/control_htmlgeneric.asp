...
<title>ASP.NET HtmlGeneric Control</title>
<style>a.menu_control_htmlgeneric{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlGeneric</span> Control</h1>
<hr>
...
<p>The HtmlGeneric control is used to control other HTML element not specified by a specific HTML server control,
like &lt;body&gt;, &lt;div&gt;, &lt;span&gt;, &lt;font&gt;, &lt;p&gt;, etc.</p>
<hr>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlinputbutton">HTMLGeneric</a><br>
Declare one HtmlInputText controls, one HtmlInputButton control, and one HtmlGeneric control (the &lt;p&gt; tag) in an .aspx file (remember to embed the controls 
inside an HtmlForm control). When the submit button is triggered, the submit subroutine is executed. The submit subroutine writes a welcome message to the p element.<br>
</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlgeneric.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlgeneric.asp#top" target="_top">TOP</a> |
		<a href="control_htmlgeneric.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
