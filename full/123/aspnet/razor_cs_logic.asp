...
<title>ASP.NET Razor C# Logic</title>
<style>a.menu_razor_cs_logic{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Razor <span class="color_h1">- C# Logic Conditions</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="razor_cs_loops.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="razor_vb_variables.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>C# lets you execute code based on conditions.</p>
<p>To test a condition you use an <strong>if statement</strong>. The if 
statement returns true or false, based on your test:</p>
<ul>
	<li>The if statement starts a code block</li>
	<li>The condition is written inside parenthesis</li>
	<li>The code inside the braces is executed if the test is true</li>
</ul>
...
<div class="example_code notranslate">
	...
	price=50;}<br></span>&lt;html><br>&lt;body><br><span class="marked">@if (price&gt;30)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;The price is too high.&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; 
	}<br></span>&lt;/body><br>&lt;/html>
</div>
<br>
	<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_010" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="example_code notranslate">
	<span class="marked">@{var 
	price=20;}<br></span>&lt;html&gt;<br>&lt;body&gt;<br>
	<span class="marked">@if (price&gt;30)<br>&nbsp;&nbsp;{<br>
	&nbsp; &lt;p&gt;The price is too high.&lt;/p&gt;<br>
	&nbsp; }<br>else<br>&nbsp; {<br>&nbsp;&nbsp;&lt;p&gt;The price is OK.&lt;/p&gt;<br>&nbsp;&nbsp;} <br></span>&lt;/body&gt;<br>&lt;/html></div>
<br>
	<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_011" target="_blank">Run example &raquo;</a>
</div>
...
<div class="example_code notranslate">
	<span class="marked">@{var 
	price=25;}<br></span>&lt;html&gt;<br>&lt;body&gt;<br>
...
&nbsp; {<br>&nbsp; &lt;p&gt;The price is 
	...
	&nbsp;&nbsp;{<br>&nbsp;&nbsp;&lt;p&gt;The price is low.&lt;/p&gt;<br>&nbsp;&nbsp;}&nbsp;&nbsp;&nbsp; <br></span>&lt;/body&gt;<br>&lt;/html&gt;</div>
<br>
	<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_012" target="_blank">Run example &raquo;</a>
</div>
...
<p>If none of the if and else if conditions are true, the last else block 
(without a condition) covers &quot;everything else&quot;.</p>
<hr>

<h2>Switch Conditions</h2>

<p>A <strong>switch block</strong> can be used to test a number of individual conditions:</p>
...
<div class="example_code notranslate">
	...
	<span class="marked">
	@{<br>var weekday=DateTime.Now.DayOfWeek;<br>var day=weekday.ToString();<br>var message=&quot;&quot;;<br>}<br></span>&lt;html&gt;<br>&lt;body&gt;<br>
	<span class="marked">
	...
	message=&quot;Today is &quot; + day;<br>&nbsp;&nbsp;&nbsp; break;<br>}<br></span>&lt;p&gt;<span class="marked">@message</span>&lt;/p&gt;<br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<br>
	<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_013" target="_blank">Run example &raquo;</a>
</div>
<p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="razor_cs_logic.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="razor_cs_logic.asp#top" target="_top">TOP</a> |
		<a href="razor_cs_logic.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
