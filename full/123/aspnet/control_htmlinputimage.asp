...
<title>ASP.NET HtmlInputImage Control</title>
<style>a.menu_control_htmlinputimage{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlInputImage</span> Control</h1>
<hr>
...
<p>The HtmlInputImage control is used to control an &lt;input type=&quot;image&quot;&gt; element. In HTML, this 
element is used to create an input button using an image, instead of a regular push-style button.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Align</td>
    <td>The alignment of the image</td>
  </tr>
  <tr>
    <td>Alt</td>
    <td>An alternate text to display for the image </td>
  </tr>
  <tr>
    <td>Attributes</td>
  ...
  <tr>
    <td>Border</td>
    <td>The width of the borders around the element</td>
  </tr>
  <tr>
    <td>Disabled</td>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlinputimage">HTMLInputImage</a><br>
...
button2 subroutine is executed. This subroutine sends the message &quot;You clicked the angry button!&quot; to the p element.</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlinputimage.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlinputimage.asp#top" target="_top">TOP</a> |
		<a href="control_htmlinputimage.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
