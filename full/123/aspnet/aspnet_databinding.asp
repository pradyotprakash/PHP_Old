...
<style>a.menu_aspnet_databinding{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- Data Binding</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_button.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_arraylist.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">We may use data binding to fill lists with selectable items from an imported data source, like a database, an XML file, or a script.</p>
<hr>
...
<p>The selectable items 
in each of the above controls are usually defined by one or more asp:ListItem controls, like this:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_databinding.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_databinding.asp#top" target="_top">TOP</a> |
		<a href="aspnet_databinding.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
