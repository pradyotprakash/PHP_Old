...
<title>ASP.NET Control Standard Properties</title>
<style>a.menu_prop_control_standard{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Control <span class="color_h1">Standard Properties</span></h1>
<hr>
...
<hr>
<h2>Properties</h2>
<p>The following table describes the properties inherited from the Control class:</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>AppRelativeTemplateSourceDirectory </td>
    <td>Gets or sets the application-relative virtual directory of 
	the Page or UserControl object that contains this control.</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_control_standard_bindingcontainer.asp">BindingContainer</a></td>
    <td>The control that contains this control's data binding</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_control_standard_clientid.asp">ClientID</a></td>
    <td>The server control id created by ASP.NET.</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td>Controls </td>
    <td>Gets a ControlCollection object that represents the child 
	controls for a specified server control in the UI hierarchy.</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td>EnableTheming</td>
    <td>A value indicating whether or not themes apply to the 
	control</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td>EnableViewState</td>
    <td>A value indicating whether or not the control persists its 
	view state, and the view state of any child controls it contains, to the 
	requesting client.</td>
    <td>1,0</td>
  </tr>
	<tr>
    <td><a href="prop_control_standard_id.asp">ID</a></td>
    <td>The id assigned to the control</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td><a href="prop_control_standard_namingcontainer.asp">NamingContainer</a></td>
    <td>A reference to the server control's naming container</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_control_standard_page.asp">Page</a></td>
    <td>A reference to the page that contains the control</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_control_standard_parent.asp">Parent</a></td>
    <td>A reference to the control's parent</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td>Site</td>
    <td>Information about the container of the current control (Get 
	value only)</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td>TemplateControl </td>
    <td>A reference to the template that contains the current 
	control</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td>TemplateSourceDirectory</td>
    <td>The virtual directory of the page/control that contains the 
	current control</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_control_standard_uniqueid.asp">UniqueID</a></td>
    <td>The unique id for the server control (Get value only)</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_control_standard_visible.asp">Visible</a></td>
    <td>A value indicating whether a control is rendered as UI</td>
    <td>1.0</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_control_standard.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_control_standard.asp#top" target="_top">TOP</a> |
		<a href="prop_control_standard.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
