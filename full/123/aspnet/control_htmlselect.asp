...
<title>ASP.NET HtmlSelect Control</title>
<style>a.menu_control_htmlselect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlSelect</span> Control</h1>
<hr>
...
<p>The HtmlSelect control is used to control a &lt;select&gt; element. In HTML, the &lt;select&gt; 
element is used to create a drop-down list.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>DataMember</td>
    <td>A name of a data table to use</td>
  </tr>
  <tr>
    <td>DataSource</td>
    <td>A data source to use</td>
  </tr>
  <tr>
    <td>DataTextField</td>
    <td>A field in the data source to be displayed in the drop-down list</td>
  </tr>
  <tr>
    <td>DataValueField</td>
    <td>A field in the data source that specifies the value of each selectable item in the drop-down list</td>
  </tr>
  <tr>
    <td>Disabled</td>
  ...
  <tr>
    <td>Items</td>
    <td>The list of items in the drop-down list</td>
  </tr>
  <tr>
    <td>Multiple</td>
    <td>Whether multiple items can be selected at a time</td>
  </tr>
  <tr>
    <td>OnServerChange</td>
    <td>The name of the function to be executed when the selected item has changed</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td>Size</td>
    <td>The number of visible items in the drop-down list</td>
  </tr>
  <tr>
    <td>Style</td>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlimage2">HTMLSelect</a><br>
Declare an HtmlImage and an HTMLSelect control in an .aspx file (remember to embed the controls inside an HtmlForm control). Then modify 
the src property of the HtmlImage control based on user choices. The value selected in the HtmlSelect control determines which image to display.</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlselect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlselect.asp#top" target="_top">TOP</a> |
		<a href="control_htmlselect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
