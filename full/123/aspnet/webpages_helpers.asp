...
<title>ASP.NET Web Pages Helpers</title>
<style>a.menu_webpages_helpers{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Helpers</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_database.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_webgrid.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<p class="intro">Web Helpers greatly simplifies web development and common 
programming tasks.</p>
<hr>

<h2>ASP.NET Helpers</h2>
<p>ASP.NET helpers are components that can be accessed by single lines of 
Razor code.</p>
<p>You can build your own helpers using Razor syntax stored as .cshtml files, or 
use built-in ASP.NET helpers.</p>
<p>You will learn how to use Razor helpers in the next chapters of this 
tutorial.</p>
<p>Below is a short description of some useful Razor helpers:</p>
<hr>

<h2>The WebGrid Helper</h2>
<p>The WebGrid helper simplifies the way to display data:</p>
<ul>
	<li>Automatically sets up an HTML table to display data</li>
	<li>Supports different options for formatting</li>
	<li>Supports paging (First, next, previous, last) through data</li>
	<li>Supports sorting by clicking on column headings</li>
</ul>
<hr>

<h2>The Chart Helper</h2>
<p>The &quot;Chart Helper&quot; can display chart images of different types with 
many formatting options and labels.</p>
<p>
...
<p>The WebMail helper provides functions for sending email messages using SMTP 
(Simple Mail Transfer Protocol).</p>
<hr>

<h2>The WebImage Helper</h2>
<p>The WebImage helper provides functionality to manage images in a web page.</p>
<p>Keywords: flip, rotate, resize, watermark.</p>
<hr>

<h2>Third Party Helpers</h2>
<p>With Razor you can take advantage of built-in or third party helpers to 
...
<h2>Installing Helpers</h2>

<p>Some helpers are already included with WebMatrix, but you can install others 
as well. </p>
<p>In the <a href="webpages_ref_helpers.asp">W3Schools Helper Reference</a> you can 
find a quick reference for included helpers and other helpers that you 
can install as part of a package called the ASP.NET Web Helpers Library. </p>
<p>If you have a web site created in WebMatrix, use the following procedure to 
install helpers: </p>
<ol>
	<li>In WebMatrix, open the <b>Site </b>workspace.</li>
	<li>Click on <b>Web Pages Administration</b>.</li>
	<li>Login to Web Pages Administration using a password *.</li>
	<li>Search for helpers using the <b>search field</b>.</li>
	<li>Click <b>install</b> to install your desired helpers.&nbsp; </li>
</ol>
<p>(* the first time you use Web Pages Administration, it will prompt 
you to create a password)</p>
<p><img border="0" src="04.jpg"></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_helpers.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_helpers.asp#top" target="_top">TOP</a> |
		<a href="webpages_helpers.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
