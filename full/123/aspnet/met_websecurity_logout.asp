...
<title>WebSecurity Logout Method</title>
<style>a.menu_met_websecurity_logout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> Logout()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>Logout()</strong> method logs out the current user. </p>
<hr>
...
// Log out the current user<br>WebSecurity.Logout();<br><br>// 
Redirect back to the homepage<br>Response.Redirect(&quot;~/&quot;);</div>
</div>
<br>
<div class="example">
...
that lets ASP.NET know on subsequent requests that the user has been logged in. </p>
<p>The <strong>Logout()</strong> method removes the authentication token, which has 
the effect of logging the user out.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_logout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_logout.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_logout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
