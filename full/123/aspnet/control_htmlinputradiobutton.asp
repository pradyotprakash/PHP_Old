...
<title>ASP.NET HtmlInputRadioButton Control</title>
<style>a.menu_control_htmlinputradiobutton{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlInputRadioButton</span> Control</h1>
<hr>
...
<p>The HtmlInputRadioButton control is used to control an &lt;input 
type=&quot;radio&quot;&gt; element. In HTML, this element is used to create a radiobutton.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Checked</td>
    <td>A Boolean value that specifies whether or not the element is to be selected</td>
  </tr>
  <tr>
    <td>Disabled</td>
  ...
  <tr>
    <td>runat</td>
    <td>Specifies that the element is a server control. Must be set to &quot;server&quot;</td>
  </tr>
  <tr>
    <td>Style</td>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlinputradiobutton">HTMLInputRadiobutton</a><br>
Declare three HtmlInputRadioButton controls, one HtmlInputButton control, and one HtmlGeneric control in an .aspx 
file (remember to embed the controls inside an HtmlForm control). When the submit button is triggered, the submit subroutine is executed. The 
submit subroutine may respond in three ways: if the radiobutton with id=&quot;r1&quot; is selected, the server sends the message &quot;Your favorite color is red&quot; to the 
p element. If the radiobutton with id=&quot;r2&quot; is selected, the server sends the message &quot;Your favorite color is green&quot; to the p element.
If the radiobutton with id=&quot;r3&quot; is selected, the server sends the message &quot;Your favorite color is blue&quot; to the p element.</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlinputradiobutton.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlinputradiobutton.asp#top" target="_top">TOP</a> |
		<a href="control_htmlinputradiobutton.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
