...
<title>ASP.NET Web Pages Objects</title>
<style>a.menu_webpages_objects{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Objects</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_forms.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_files.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">&nbsp;Web Pages is much often about Objects.</p>
<hr>
<h2>The Page Object</h2>
<p>You have already seen some Page Object methods in use:</p>
<div class="code notranslate"><div>
	@RenderPage(&quot;header.cshtml&quot;)<br><br>@RenderBody()<br>
</div></div>
<p>In the previous chapter you saw two Page Object properties being used (isPost, and 
Request):</p>
<div class="code notranslate"><div>
	If (isPost) {<br><br>if (Request[&quot;Choice&quot;] != null {<br>
</div></div>
<br>
<hr>
<h2>Some Page Object Methods<br>
</h2>
...
<tr>
	<td>href</td>
	<td>Builds a URL using the specified parameters</td>
</tr>
<tr>
	<td>RenderBody()</td>
	<td>Renders the portion of a content page that is not within a named 
	section (In layout pages)</td>
</tr>
<tr>
	<td>RenderPage(<em>page</em>)</td>
	<td>Renders the content of one page within another page</td>
</tr>
<tr>
	<td>RenderSection(<em>section</em>)</td>
	<td>Renders the content of a named section (In layout pages)</td>
</tr>
<tr>
	<td>Write(<em>object</em>)</td>
	<td>Writes the object as an HTML-encoded string</td>
</tr>
<tr>
	<td>WriteLiteral</td>
	<td>Writes an object without HTML-encoding it first.</td>
</tr>
</table>
<br>
<hr>
<h2>Some Page Object Properties<br>
</h2>
<table class="reference notranslate" style="width: 100%">
<tr>
...
<tr>
	<td>isPost</td>
	<td>Returns true if the HTTP data transfer method used by the client is a 
	POST request</td>
</tr>
<tr>
	<td>Layout</td>
	<td>Gets or sets the path of a layout page</td>
</tr>
<tr>
	<td>Page</td>
	<td>Provides property-like access to data shared between pages and layout 
	pages </td>
</tr>
<tr>
	<td>Request</td>
	<td>Gets the HttpRequest object for the current HTTP request</td>
</tr>
<tr>
	<td>Server</td>
	<td>Gets the HttpServerUtility object that provides web-page processing 
	methods</td>
</tr>
</table>
<br>
...
<p>The Page property of the Page Object, provides property-like access to data shared between pages and layout 
	pages.</p>
<p>You can use (add) your own properties to the Page property:</p>
<ul>
	<li>Page.Title</li>
	<li>Page.Version</li>
	<li>Page.anythingyoulike<br></li>
</ul>
<p>The pages property is very helpful. For instance, it makes it possible to set 
the page title in content files, and use it in the layout file:</p>

<div class="example">
<h2 class="example">Home.cshtml</h2>
<div class="example_code notranslate">
	<span class="marked">@{<br>Layout="~/Shared/Layout.cshtml";<br>Page.Title="Home Page"<br>}</span><br><br>
	&lt;h1&gt;Welcome to W3Schools&lt;/h1&gt; <br><br>&lt;h2&gt;Web Site Main Ingredients&lt;/h2&gt;<br>
	<br>&lt;p&gt;A Home Page (Default.cshtml)&lt;/p&gt;<br>&lt;p&gt;A Layout File (Layout.cshtml)&lt;/p&gt;<br>
...
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>&lt;title&gt;<span class="marked">@Page.Title</span>&lt;/title&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_objects.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_objects.asp#top" target="_top">TOP</a> |
		<a href="webpages_objects.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
