...
<title>ASP.NET HtmlTable Control</title>
<style>a.menu_control_htmltable{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlTable</span> Control</h1>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
<hr>

<h2>Definition and Usage</h2>
<p>The HtmlTable control is used to control a &lt;table&gt; element. In HTML, the &lt;table&gt; element is used to create a table.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Align</td>
    <td>Specifies the alignment of the table</td>
  </tr>
  <tr>
    <td>Attributes</td>
    <td>Returns all attribute name and value pairs of the element</td>
  </tr>
  <tr>
    <td>BGColor</td>
    <td>Specifies the background color of the table</td>
  </tr>
  <tr>
    <td>Border</td>
    <td>Specifies the width of the borders<p><b>Tip:</b> Set border=&quot;0&quot; to display tables with no borders! </td>
  </tr>
  <tr>
    <td>BorderColor</td>
    <td>Specifies the color of the borders</td>
  </tr>
  <tr>
    <td>CellPadding</td>
    <td>Specifies the space between the cell walls and contents</td>
  </tr>
  <tr>
    <td>CellSpacing</td>
    <td>Specifies the space between cells</td>
  </tr>
  <tr>
    <td>Disabled</td>
    <td>A Boolean value that indicates whether or not the control should be disabled. Default is false</td>
  </tr>
  <tr>
    <td>Height</td>
    <td>Specifies the height of the table</td>
  </tr>
  <tr>
    <td>id</td>
  ...
  <tr>
    <td>InnerHtml</td>
    <td>Sets or returns the content between the opening and closing tags of the HTML element.
    Special characters are not automatically converted to HTML entities</td>
  </tr>
  <tr>
    <td>InnerText</td>
    <td>Sets or returns all text between the opening and closing tags of the HTML element.
    Special characters are automatically converted to HTML entities</td>
  </tr>
  <tr>
    <td>Rows</td>
    <td>Returns an HtmlRowCollection object which represents all rows in the table</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td>Style</td>
    <td>Sets or returns the CSS properties that are applied to the control</td>
  </tr>
  <tr>
    <td>TagName</td>
    <td>Returns the element tag name</td>
  </tr>
  <tr>
    <td>Visible</td>
    <td>A Boolean value that indicates whether or not the control should be visible</td>
  </tr>
  <tr>
    <td>Width</td>
    <td>Specifies the width of the table</td>
  </tr>
</table>
<br>
<hr>
...
<h2>Examples</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmltable">HTMLTable</a><br>
Declare two HtmlSelect controls, one HtmlInputButton control, and one HtmlTable control in an .aspx file (remember to embed the controls 
inside an HtmlForm control). The user may choose number of cells and rows. When the submit button is triggered, the submit subroutine is executed. The submit 
subroutine generates the table based on what the user did input.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_htmltable2">HTMLTable 2</a><br>
Declare an HtmlTable control and an HtmlInputButton control in an .aspx file (remember to embed the controls inside an HtmlForm control).
When the submit button is triggered, the submit subroutine is executed. The submit subroutine modifies the background color and 
the border color of the table, it also changes the contents of the cells.</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmltable.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmltable.asp#top" target="_top">TOP</a> |
		<a href="control_htmltable.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
