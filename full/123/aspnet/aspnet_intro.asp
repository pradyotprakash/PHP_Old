...
<head>
<title>ASP.NET Web Forms Tutorial</title>
<style>a.menu_aspnet_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- Tutorial</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_reference.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_pages.asp">Next Chapter &raquo;</a></div>
</div>
<br>
...
<p><strong>THIS TUTORIAL COVERS WEB FORMS</strong></p>
</div>
<table style="font-size:20px" width="100%" cellpadding="8" cellspacing="0" border="0">
<tr>
<td width="32%" style="text-align:center;color:white;background:lightgrey">Web Pages</td>
<td width="2%"></td>
<td width="32%" style="text-align:center;color:white;background:lightgrey">MVC</td>
<td width="2%"></td>
<td width="32%" style="text-align:center;color:white;background:#73ad21">Web Forms</td>
</tr>
</table>
<br>
...
<p>If you want to take a look at a working Web Forms examples, follow the
<a href="../website/webforms_demo.asp">ASP.NET Web Forms Demo</a>.</p>

<hr>
<h2>What is Web Forms?</h2>
<p>Web Forms is one of the 3 programming models for creating ASP.NET web sites and 
web applications.</p>
<p>The other two programming models are Web Pages and MVC (Model, View, 
Controller).</p>

<p>Web Forms is the oldest ASP.NET programming model, with event driven web pages written as a combination of HTML, server controls, and 
server code.</p>
<p>Web Forms are compiled and executed on the server, which generates 
the HTML that displays the web pages. </p>
<p>Web Forms comes with hundreds of different web controls and web components to  
build user-driven web sites with data access.</p>
...
<p>Visual Studio Express is a development tool tailor made for Web Forms (and 
MVC).</p>
...
<h2>ASP.NET References</h2>
<p>At the end of this tutorial you will find a complete ASP.NET reference with objects, 
components, properties and methods.</p>

<p> <a href="aspnet_refhtmlcontrols.asp">ASP.NET Reference</a></p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_intro.asp#top" target="_top">TOP</a> |
		<a href="aspnet_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
