...
<style>a.menu_aspnet_arraylist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- The ArrayList Object</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_databinding.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_hashtable.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The ArrayList object is a collection of items containing a single data value.</p>
<hr>
...
<p><a target="_blank" href="showaspx.asp?filename=demo_arraylist_drop1">ArrayList DropDownList</a></p>
<p><a target="_blank" href="showaspx.asp?filename=demo_arraylist_radio1">ArrayList RadioButtonList</a></p>
<hr>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_arraylist_radio1" class="showbtn">Show example &raquo;</a>
</div>

<p>The DataSource property of the RadioButtonList control is set to the ArrayList and it defines the 
data source of the RadioButtonList control. The DataBind() method of the RadioButtonList control binds the data source with 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_arraylist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_arraylist.asp#top" target="_top">TOP</a> |
		<a href="aspnet_arraylist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
