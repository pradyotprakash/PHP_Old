...
<title>ASP.NET HtmlForm Control</title>
<style>a.menu_control_htmlform{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlForm</span> Control</h1>
<hr>
...
<p>The HtmlForm control is used to control a &lt;form&gt; element. In HTML, the &lt;form&gt; element is used to create a form.</p>
<p><b>Note:</b> All HTML server controls must be within the HtmlForm control!</p>
<p><b>Note:</b> You can only have one HtmlForm control on a single page!</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Action</td>
    <td>A URL that defines where to send the data when the form is submitted.
    <p><b>Note:</b> This attribute is always set to the URL of the page itself!</p>
    </td>
  </tr>
  <tr>
    <td>Attributes</td>
  ...
  <tr>
    <td>EncType</td>
    <td>The mime type used to encode the content of the form</td>
  </tr>
  <tr>
    <td>id</td>
  ...
  <tr>
    <td>InnerHtml</td>
    <td>Sets or returns the content between the opening and closing tags of the HTML element. Special characters are not automatically converted to HTML entities</td>
  </tr>
  <tr>
    <td>InnerText</td>
  ...
  <tr>
    <td>Method</td>
    <td>How the form posts data to the server. Legal values are: &quot;post&quot; and &quot;get&quot;. Default is &quot;post&quot;</td>
  </tr>
  <tr>
    <td>Name</td>
  ...
  <tr>
    <td>Target</td>
    <td>The target window to load the URL</td>
  </tr>
  <tr>
    <td>Visible</td>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlinputbutton">HTMLForm</a><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlform.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlform.asp#top" target="_top">TOP</a> |
		<a href="control_htmlform.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
