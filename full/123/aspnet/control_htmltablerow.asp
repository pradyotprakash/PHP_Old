...
<title>ASP.NET HtmlTableRow Control</title>
<style>a.menu_control_htmltablerow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlTableRow</span> Control</h1>
<hr>
...
<p>The HtmlTableRow control is used to control a &lt;tr&gt; element. In HTML, the &lt;tr&gt; 
element is used to create a table row.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Align</td>
    <td>The alignment of the row</td>
  </tr>
  <tr>
    <td>Attributes</td>
  ...
  <tr>
    <td>BGColor</td>
    <td>The background color of the row</td>
  </tr>
  <tr>
    <td>BorderColor</td>
  ...
  <tr>
    <td>Cells</td>
    <td>Returns the cells in this row</td>
  </tr>
  <tr>
    <td>Disabled</td>
  ...
  <tr>
    <td>VAlign</td>
    <td>The vertical alignment of cells in the row</td>
  </tr>
  <tr>
    <td>Visible</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmltablerow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmltablerow.asp#top" target="_top">TOP</a> |
		<a href="control_htmltablerow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
