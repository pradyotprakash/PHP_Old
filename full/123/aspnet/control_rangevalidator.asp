...
<title>ASP.NET RangeValidator Control</title>
<style>a.menu_control_rangevalidator{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">RangeValidator</span> Control</h1>
<hr>
<a href="aspnet_refvalidationcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Validation Server Controls" /> Validation Server Controls</a>
<hr>

<h2>Definition and Usage</h2>
<p>The RangeValidator control is used to check that the user enters an input value that falls between two values.
It is possible to check ranges within numbers, dates, and characters.</p>
<p><b>Note:</b> The validation will not fail if the input control is empty. Use the RequiredFieldValidator control to make the field required.</p>
<p><b>Note:</b> The validation will not fail if the input value cannot be converted to the data type specified. Use the CompareValidator control, with 
its Operator property set to ValidationCompareOperator.DataTypeCheck, to verify the data type of the input value.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>BackColor</td>
    <td>The background color of the RangeValidator control</td>
  </tr>
  <tr>
    <td>ControlToValidate</td>
    <td>The id of the control to validate</td>
  </tr>
  <tr>
    <td>Display</td>
    <td>The display behavior for the validation control. Legal values are:
    <ul>
      <li>None (the control is not displayed. Used to show the error message only in the ValidationSummary control)</li>
      <li>Static (the control displays an error message if validation fails. Space is reserved on the page for the message even if the input passes validation.</li>
      <li>Dynamic (the control displays an error message if validation fails. Space is not reserved on the page for the message if the input passes validation</li>
    </ul>
    </td>
  </tr>
  <tr>
    <td>EnableClientScript</td>
    <td>A Boolean value that specifies whether client-side validation is enabled or not</td>
  </tr>
  <tr>
    <td>Enabled</td>
    <td>A Boolean value that specifies whether the validation control is enabled or not</td>
  </tr>
  <tr>
    <td>ErrorMessage</td>
    <td>The text to display in the ValidationSummary control when validation fails.
    <b>Note:</b> This text will also be displayed in the validation control if the Text property is not set</td>
  </tr>
  <tr>
    <td>ForeColor</td>
    <td>The foreground color of the control</td>
  </tr>
  <tr>
    <td>id</td>
    <td>A unique id for the control</td>
  </tr>
  <tr>
    <td>IsValid</td>
    <td>A Boolean value that indicates whether the control specified by ControlToValidate is determined to be valid</td>
  </tr>
  <tr>
    <td>MaximumValue</td>
    <td>Specifies the maximum value of the input control</td>
  </tr>
  <tr>
    <td>MinimumValue</td>
    <td>Specifies the minimum value of the input control</td>
  </tr>
  <tr>
    <td>runat</td>
    <td>Specifies that the control is a server control. Must be set to &quot;server&quot;</td>
  </tr>
  <tr>
    <td>Type</td>
    <td>Specifies the data type of the value to check. The types are:
    <ul>
      <li>Currency</li>
      <li>Date</li>
      <li>Double</li>
  ...
  <tr>
    <td>Text</td>
    <td>The message to display when validation fails</td>
  </tr>
</table>
<br>
<hr>
...
<h2>Examples</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_rangevalidator">RangeValidator</a><br>
Declare one TextBox control, one Button control, and one RangeValidator control in an .aspx file. If validation 
fails, the text &quot;The date must be between 1/1/2002 and 31/5/2002!&quot; will be displayed in the RangeValidator control.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_rangevalidator2">RangeValidator 2</a><br>
...
fails, the text &quot;The value must be from 1 to 100!&quot; will be displayed in the RangeValidator control.</p>
<hr>
<a href="aspnet_refvalidationcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Validation Server Controls" /> Validation Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_rangevalidator.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_rangevalidator.asp#top" target="_top">TOP</a> |
		<a href="control_rangevalidator.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
