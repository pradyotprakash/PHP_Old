...
<title>ASP.NET TableCell Control</title>
<style>a.menu_control_tablecell{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">TableCell</span> Control</h1>
<hr>
...
<p>The TableCell control is used in conjunction with the Table control and the TableRow control to create a  cell in a table.</p>
<p><b>Tip:</b> The cells of each row are stored in the Cells collection of the <a href="control_tablerow.asp">TableRow control</a>.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>AssociatedHeaderCellID</td>
    <td>A list of table header cells associated with the TableCell 
	control</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_tablecell_columnspan.asp">ColumnSpan</a></td>
    <td>The number of columns this cell should span</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_tablecell_horizontalalign.asp">HorizontalAlign</a></td>
    <td>The horizontal alignment of the contents in the table cell</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_tablecell_rowspan.asp">RowSpan</a></td>
  ...
  <tr>
    <td><a href="prop_webcontrol_tablecell_text.asp">Text</a></td>
    <td>Specifies the text of the table cell</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_tablecell_verticalalign.asp">VerticalAlign</a></td>
    <td>The vertical alignment of the contents in the table cell</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_tablecell_wrap.asp">Wrap</a></td>
    <td>Specifies whether the cell's contents 
    should wrap or not</td>
    <td>1.0</td>
  </tr>
  </table>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_table">Table</a><br>
Declare two Table controls in an .aspx file.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_table2">Table 2</a><br>
Declare a Table control, three TableRow controls, and two TableCell controls in an .aspx file.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_tablecell.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_tablecell.asp#top" target="_top">TOP</a> |
		<a href="control_tablecell.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
