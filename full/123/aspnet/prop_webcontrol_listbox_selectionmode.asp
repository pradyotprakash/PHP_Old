...
<title>ASP.NET SelectionMode Property</title>
<style>a.menu_prop_webcontrol_listbox_selectionmode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">SelectionMode</span> Property</h1>
<hr>
...
<p>The SelectionMode property is used to get or set how a user is allowed to 
select ListBox items.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>

&lt;asp:ListBox SelectionMode=&quot;<i>mode</i>&quot; runat=&quot;server&quot;&gt;<br>
<i>Some Content</i><br>
&lt;/asp:ListBox&gt;
</div></div>
<br>
<table class="reference notranslate">
  <tr>
	...
	<tr>
		<td>mode</td>
		<td>Specifies how a users is allowed to select items.<p>Possible values:</p>
		<ul>
			<li>Single - Default. Multiple items can not be selected</li>
			<li>Multiple - Multiple items can be selected</li>
		</ul>
    	</td>
	</tr>
</table>
...
<p>The following example sets the SelectionMode of a ListBox control:</p>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_listbox_selectionmode" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_listbox_selectionmode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_listbox_selectionmode.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_listbox_selectionmode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
