...
<title>ASP.NET Label Control</title>
<style>a.menu_control_label{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">Label</span> Control</h1>
<hr>
...
<p>The Label control is used to display text on a page. The text is programmable.</p>
<p><b>Note:</b></b>&nbsp;This control lets you apply styles to its content!</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Text</td>
    <td>The text to display in the label</td>
  </tr>
</table>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_label">Label</a><br>
Declare one Label control, one TextBox control, and one Button control in an .aspx file. When the user clicks on the button, the submit subroutine is executed. The 
subroutine copies the content of the TextBox control to the Label control.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_label.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_label.asp#top" target="_top">TOP</a> |
		<a href="control_label.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
