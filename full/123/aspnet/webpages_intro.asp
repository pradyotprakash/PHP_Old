...
<head>
<title>ASP.NET Web Pages Tutorial</title>
<style>a.menu_webpages_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages  <span class="color_h1">- Tutorial</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_razor.asp">Next Chapter &raquo;</a></div>
</div>
<br>
...
sites with HTML, CSS, JavaScript and server scripting.</p>
	<p>ASP.NET supports three different development methods:<br>
Web Pages, MVC (Model View Controller), and Web Forms.</p>
<p><strong>THIS TUTORIAL COVERS WEB PAGES</strong>.</p>
</div>
<table style="font-size:20px" width="100%" cellpadding="8" cellspacing="0" border="0">
<tr>
<td width="32%" style="text-align:center;color:white;background:#73ad21">Web Pages</td>
<td width="2%"></td>
<td width="32%" style="text-align:center;color:white;background:lightgrey">
MVC</td>
<td width="2%"></td>
<td width="32%" style="text-align:center;color:white;background:lightgrey">
Web Forms</td>
...
<p>Many developers like to start learning a new technology by looking 
at working examples.</p>


<p>If you want to take a look at a working Web Pages example, follow the
<a href="../website/webpages_demo.asp">ASP.NET Web Pages Demo</a>.</p>

<hr>
<h2>Easy Learning with &quot;Run Example&quot;</h2>
<p>Our &quot;Run Example&quot; tool makes it easy to learn Web Pages.</p>
<p>It runs 
examples and displays the ASP.NET code and the HTML output simultaneously.</p>
<p>Click on the &quot;Run Example&quot; button to see how it works:</p>

<div class="example">
<h2 class="example">Web Pages Example</h2>
<div class="example_code notranslate">
&lt;html&gt;<br>
&lt;body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;Hello Web Pages&lt;/h1&gt;<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;The time is <span class="marked">@DateTime.Now</span>&lt;/p&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br>
	<a class="showbtn" href="showfile_c.asp?filename=try_webpages_cs_001" target="_blank">Run 
Example &raquo;</a>
</div>
<br>
<hr>

<h2>What is Web Pages?</h2>
<p>Web Pages is one of the 3 programming models for creating ASP.NET web sites and 
web applications.</p>
<p>The other two programming models are Web Forms and MVC (Model, View, 
Controller).</p>
<p>Web Pages is the simplest programming model for developing ASP.NET web pages. 
It provides an easy way to combine HTML, 
CSS, JavaScript and server code: </p>
<ul>
	<li>Easy to learn, understand, and use</li>
	<li>Built around single web pages</li>
	<li>Similar to PHP and Classic ASP</li>
	<li>Server scripting with Visual Basic or C#</li>
	<li>Full HTML, CSS, and JavaScript control </li>
</ul>
<p>Web Pages is easy extendable with programmable Web Helpers, including 
...
<p>If you are new to ASP.NET, Web Pages is the perfect place to start. </p>
<p>In our Web Pages tutorial you will learn how to combine HTML, CSS, JavaScript 
and server code, using the latest Razor server markup syntax with Visual Basic 
or C# .</p>
<p>You will also learn how to extend your web pages with programmable Web 
Helpers. </p>

<hr>

<h2>Web Pages Examples</h2>
<p>Learn by examples!</p>
<p>Because ASP.NET code is executed on the server, you
cannot view the code in your browser. You will only see the output as plain HTML. </p>
<p>At W3Schools every example displays the hidden 
ASP.NET code. This
makes it easier for you to understand how it works.</p>

<p> <a href="webpages_examples.asp">Web Pages Examples</a></p>

<hr>

<h2>Web Pages References</h2>
<p>At the end of this tutorial you will find a complete set of ASP.NET references with objects, 
components, properties and methods.</p>

<p> <a href="webpages_ref_classes.asp">Web Pages References</a></p>

<hr>

<h2>We Have Used WebMatrix</h2>
<p>In this tutorial, we have used WebMatrix.</p>
<p>WebMatrix is a simple but powerful free ASP.NET development tool from Microsoft, 
tailor made for Web Pages. </p>
<p>WebMatrix contains:</p>
<ul>
	<li>Web Pages examples and templates</li>
	<li>A web server language (Razor using VB or C#)</li>
	<li>A web server (IIS Express)</li>
	<li>A database server 
(SQL Server Compact)</li>
	<li>A full web development framework (ASP.NET)</li>
</ul>

<p>With WebMatrix you can start from scratch with an empty web site and a blank 
...
publishing.</p>
<p>The skills and code you develop with WebMatrix can seamlessly be transformed 
to fully professional ASP.NET applications.</p>
<p>If you want to try WebMatrix, follow the link below to install:</p>
<p><a target="_blank" href="http://www.microsoft.com/web/gallery/install.aspx?appid=WebMatrix">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_intro.asp#top" target="_top">TOP</a> |
		<a href="webpages_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
