...
<title>ASP.NET MVC - Publish</title>
<style>a.menu_mvc_publish{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">- Publishing the Website</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_htmlhelpers.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_reference.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn how to publish an MVC application without using 
Visual Web Developer.</p>
<hr>
<h2>
Publish Your Application Without Using Visual Web Developer</h2>
<p>
An ASP.NET MVC application can be published to a remote server by using 
the Publish commands in WebMatrix ,Visual Web Developer, or Visual Studio.</p>
<p>
This function copies all your application files, controllers, models, images, and all the 
required DLL files 
for MVC, Web Pages, Razor, Helpers, and SQL Server Compact (if a database is 
used).</p>
<p>
...
Web, or some other publishing software?</p>
<p>
<strong>Will you get a problem? Yes, you will. But you can solve it.</strong></p>
<p>
To perform a web copy, you have to know how to include the right files, what DDL 
files to copy, and where store them.</p>
<p>
...
<p>Before you continue, make sure your hosting computer runs the latest version 
of ASP.NET (4.0).</p>
<hr>
...
<p>Copy your website (all folders and content) from your development computer to 
an application folder on your remote hosting computer (server).</p>
<p>If your <strong>App_Data</strong> folder contains test data, don't copy the App_Data folder 
(see SQL Data below).</p>
<hr>

<h2>
3.
Copy the DLL Files</h2>
<p>On the remote server create a bin folder in the root of your application. (If 
you have installed Helpers, you already have a bin folder)</p>
<p>Copy everything from your folders:</p>
<p><strong>C:\Program Files (x86)\Microsoft ASP.NET\ASP.NET Web Pages\v1.0\Assemblies</strong></p>
<p><strong>C:\Program Files (x86)\Microsoft ASP.NET\ASP.NET MVC 3\Assemblies</strong></p>
<p>to your application's bin folder on the remote server.</p>
<hr>

<h2>4. Copy the SQL Server Compact DLL Files</h2>
<p>If your application has a SQL Server Compact database (an .sdf file in App_Data 
folder), you must copy the SQL Server Compact DLL files:</p>
<p>Copy everything from your folder:</p>
<p><strong>C:\Program Files (x86)\Microsoft SQL Server Compact Edition\v4.0\Private</strong></p>
<p>to your application's bin folder on the remote server.</p>
<p>Create (or edit) the Web.config file for your application:</p>
<div class="example">
<h2 class="example">Example C#</h2>
<div class="example_code notranslate">
	&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;<br>&lt;configuration&gt;<br>&lt;system.data&gt;<br>
	&lt;DbProviderFactories&gt;<br>&lt;remove invariant=&quot;System.Data.SqlServerCe.4.0&quot; /&gt;<br>
	<br>&lt;add invariant=&quot;System.Data.SqlServerCe.4.0&quot;<br>name=&quot;Microsoft SQL 
	Server Compact 4.0&quot;<br>description=&quot;.NET Framework Data Provider for Microsoft SQL 
	Server Compact&quot; type=&quot;System.Data.SqlServerCe.SqlCeProviderFactory, 
	System.Data.SqlServerCe, Version=4.0.0.1,Culture=neutral, PublicKeyToken=89845dcd8080cc91&quot; 
	/&gt;<br><br>&lt;/DbProviderFactories&gt;<br>&lt;/system.data&gt;<br>&lt;/configuration&gt;</div>
</div>
<br>
<hr>

<h2>5. Copy SQL Server Compact Data</h2>
<p>Do you have .sdf 
files in your App_Data folder that contains test data?</p>
<p>Do you want to publish the test data to the 
remote server?</p>
<p>Most likely not.</p>
<p>If you have to copy the SQL data files (.sdf files), you should delete 
everything in the database, and then copy the empty .sdf file from your development 
computer to the server. </p>
<p><strong>THAT'S IT. GOOD LUCK !</strong></p>
<br/>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_htmlhelpers.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_reference.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_publish.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_publish.asp#top" target="_top">TOP</a> |
		<a href="mvc_publish.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
