...
<title>ASP.NET Panel Control</title>
<style>a.menu_control_panel{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">Panel</span> Control</h1>
<hr>
...
<p>The Panel control is used as a container for other controls.</p>
<p><b>Tip:</b> This control is often used to generate controls by code and to display and hide groups of controls.</p>
<p><b>Note:</b> This control renders as an HTML &lt;div&gt; element.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_panel_backimageurl.asp">BackImageUrl</a></td>
    <td>Specifies a URL to an image file to display as a background for this control</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_panel_defaultbutton.asp">DefaultButton</a></td>
    <td>Specifies the ID of the default button in the Panel</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_panel_direction.asp">Direction</a></td>
    <td>Specifies the content display direction of the Panel</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_panel_groupingtext.asp">GroupingText</a></td>
    <td>Specifies the caption for the group of controls in the Panel</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_panel_horizontalalign.asp">HorizontalAlign</a></td>
    <td>Specifies the horizontal alignment of the content</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td><a href="prop_webcontrol_panel_scrollbars.asp">ScrollBars</a></td>
    <td>Specifies the position and visibility of scroll bars in the Panel</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_panel_wrap.asp">Wrap</a></td>
    <td>Specifies whether the content should wrap or not</td>
    <td>1.0</td>
  </tr>
  </table>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_panel">Panel</a><br>
Declare one Panel control, one CheckBox control, and one Button control in an .aspx file. When the user checks the CheckBox control, and the clicks the Refresh button, 
the Panel control will hide.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_panel.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_panel.asp#top" target="_top">TOP</a> |
		<a href="control_panel.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
