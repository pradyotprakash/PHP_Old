...
<title>WebSecurity GetPasswordChangeDate Method</title>
<style>a.menu_met_websecurity_getpasswordchangedate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> GetPasswordChangeDate()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>GetPasswordChangeDate()</strong> method returns the date and time 
a user's password was last changed.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
	WebSecurity.GetPasswordChangedDate(<em>userName</em>)</div></div>
<br>
<hr>
...
<td>DateTime</td>
<td>
<p>The date and time the password was last changed</p>
	</td>
</tr>
</table>
<br>
...
<h2>Remarks</h2>
<p>If the password has never been changed, the <strong>GetPasswordChangeDate()</strong> method returns 
<strong>DateTime.MinValue</strong>.</p>
<p>The value of DateTime.MinValue is 00:00:00.0000000, January 1, 0001.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_getpasswordchangedate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_getpasswordchangedate.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_getpasswordchangedate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
