...
<title>ASP.NET Date Property</title>
<style>a.menu_prop_webcontrol_calendarday_date{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">Date</span> Property</h1>
<hr>
...
<p>The Date property is used to get a date variable representing the date.<br>
</p>
<hr>
<div class="example">
<h2 class="example">Example</h2>
<p>The following example shows how to get the Date from a selected day 
in a calendar:</p>
<div class="example_code notranslate">
&lt;script runat=&quot;server&quot;&gt;<br>
Sub DaySelect(obj As Object, e As DayRenderEventArgs)<br>
&nbsp;&nbsp;If e.Day.IsSelected Then<br>
&nbsp;&nbsp;Label1.Text = e.Day.Date<br>
&nbsp;&nbsp;End If<br>
End Sub<br>
&lt;/script&gt;<br>
<br>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_calendarday_date" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_calendarday_date.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_calendarday_date.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_calendarday_date.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
