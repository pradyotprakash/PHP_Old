...
<title>ASP.NET ListBox Control</title>
<style>a.menu_control_listbox{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">ListBox</span> Control</h1>
<hr>
...
<p>The ListBox control is used to create a single- or multi-selection drop-down list.</p>
<p>Each selectable item in a ListBox control is defined by a ListItem element!</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_listbox_rows.asp">Rows</a></td>
    <td>The number of rows displayed in the list</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_listbox_selectionmode.asp">SelectionMode</a></td>
    <td>Allows single or multiple selections</td>
    <td>1.0</td>
  </tr>
  </table>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_listbox">Listbox</a><br>
Declare one ListBox control in an .aspx file. Then create an event handler for the Click event which displays some text 
and the selected item, in a Label control.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_listbox.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_listbox.asp#top" target="_top">TOP</a> |
		<a href="control_listbox.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
