...
<title>ASP.NET ListItem Control</title>
<style>a.menu_control_listitem{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">ListItem</span> Control</h1>
<hr>
...
<p>The ListItem control creates an item in a list.</p>
<p>This control is used with the list controls such as <a href="control_listbox.asp">&lt;asp:ListBox&gt;</a>, 
<a href="control_radiobuttonlist.asp">&lt;asp:RadioButtonList&gt;</a> and <a href="control_bulletedlist.asp">&lt;asp:BulletedList&gt;</a>.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>Attributes</td>
    <td>Optional. A collection of attribute name and value pairs for the ListItem that are not directly supported by the class</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_listitem_enabled.asp">Enabled</a></td>
    <td>Optional. Specifies if the item is enabled or disabled</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_listitem_selected.asp">Selected</a></td>
    <td>Optional. Specifies whether or not the item is selected</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_listitem_text.asp">Text</a></td>
    <td>Optional. The text displayed in the ListItem</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_listitem_value.asp">Value</a></td>
    <td>Optional. The value of the the ListItem.</td>
    <td>1.0</td>
  </tr>
  </table>
...
<p>For a full description, go to <a href="prop_webcontrol_standard.asp">Web 
Control Standard Attributes</a>.</p>
...
<p>It is possible to use the Text or Value properties and the inner HTML text to set the text displayed for an item in the list.</p>

<h2>Example</h2>
<div class="code notranslate"><div>
&lt;asp:ListItem Value=&quot;Text1&quot; Text=&quot;Text2&quot;&gt;Text3&lt;/asp:ListItem&gt;</div></div>

<p>Depending on the combination of the three, different texts are shown and 
values used. The table below shows all possible combinations and their results:</p>
<table class="reference notranslate">
	<tr>
		<th>Inner HTML</th>
		<th>Text Property</th>
...
<p><b>Note:</b> The Text and Value properties have a default value of an empty string. Because of this it is possible to have empty list items.</p>
<hr>

<h2>Examples</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_listitem">Basic ListItem in BulletedList</a><br>
A BulletedList control with two ListItems in an .aspx file.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_listitem_text">ListItems with different properties in ListBox</a><br>
A ListBox control with some ListItems in an .aspx file. The items in the list uses different properties to show the ListItem text.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_listitem_disabled">ListItem disabled in ListBox</a><br>
A ListBox control with one of the ListItems disabled.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_listitem_selected">ListItem selected in RadioButtonList</a><br>
A RadioButtonList control with one of the ListItems selected.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_listitem.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_listitem.asp#top" target="_top">TOP</a> |
		<a href="control_listitem.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
