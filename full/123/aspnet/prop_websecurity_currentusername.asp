...
<title>WebSecurity CurrentUserName Property</title>
<style>a.menu_prop_websecurity_currentusername{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity Property -&nbsp;<span class="color_h1">CurrentUserName</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>CurrentUserName</strong> property is the name of the current user 
in the user profile table in the <strong>WebSecurity</strong> database.</p>

<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.CurrentUserName</div></div>
<br>
<hr>
...
value=WebSecurity.CurrentUserName<br>
End Code<br>
<br>
&lt;p&gt;Welcome @value&lt;/p&gt;
</div></div>
...
<h2>Remarks</h2>
<p>The <strong>CurrentUserName </strong> property is read only. It cannot be changed by code.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_websecurity_currentusername.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_websecurity_currentusername.asp#top" target="_top">TOP</a> |
		<a href="prop_websecurity_currentusername.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
