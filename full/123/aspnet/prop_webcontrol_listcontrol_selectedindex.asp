...
<style>a.menu_prop_webcontrol_listcontrol_selectedindex{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The SelectedIndex property represents the index number of a selected item in a list.<br>
</p>
<hr>
<div class="example">
<h2 class="example">Example</h2>
<p>The following example gets the Index from a ListItem in a RadioButtonList control:</p>
<div class="example_code notranslate">
&lt;script runat=&quot;server&quot;&gt;<br>
Sub Change(obj As Object, e As EventArgs)<br>
&nbsp;&nbsp;Response.Write(&quot;Selected index: &quot; &amp; rb1.SelectedIndex)<br>
End Sub<br>
&lt;/script&gt;<br>
<br>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_listcontrol_selectedindex" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_listcontrol_selectedindex.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_listcontrol_selectedindex.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_listcontrol_selectedindex.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
