...
<title>WebSecurity ResetPassword Method</title>
<style>a.menu_met_websecurity_resetpassword{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> ResetPassword()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>ResetPassword()</strong> method resets a user password using a password token.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.ResetPassword(<em>passwordResetToken,newPassword)</em></div></div>
<br>
<hr>
<h2>Parameters</h2>
...
<tr>
<td><em>passwordResetToken</em></td>
<td>String</td>
<td>The password token</td>
</tr>
<tr>
...
<tr>
<td>Boolean</td>
<td><strong>true</strong> if the password was changed, 
otherwise <strong>false</strong></td>
</tr>
</table>
<br>
<hr>
...
password.</p>
<p>The ResetPassword method requires a password <strong>reset token</strong>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_resetpassword.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_resetpassword.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_resetpassword.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
