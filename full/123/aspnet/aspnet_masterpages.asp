...
<style>a.menu_aspnet_masterpages{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- Master Pages</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_dbconnection.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_navigation.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Master pages provide templates for other pages on your web site. </p>
<hr>

<h2>Master Pages</h2>
<p>Master pages allow you to create a consistent look and behavior for all the pages (or group of pages) in your web application.</p>
<p>A master page provides a template for other pages, with shared layout and functionality. The master page 
...
<p>The content pages contain the content you want to display.</p>
<p>When users request the content page, ASP.NET merges the pages to produce output that combines the layout of the master page with the content of the content page.</p>
<hr>
...
&lt;html&gt;<br>
&lt;body&gt;<br>
&lt;h1&gt;Standard Header From Masterpage&lt;/h1&gt;<br>&lt;asp:ContentPlaceHolder id=&quot;CPH1&quot; runat=&quot;server&quot;&gt;<br>
&lt;/asp:ContentPlaceHolder&gt;<br>&lt;/body&gt;<br>
&lt;/html&gt;</div></div>

<p>The master page above is a normal HTML page designed as a template for other pages.</p>
<p>The <b>@ Master</b> directive defines it as a master page.</p>
<p>The master page contains a placeholder tag <b>&lt;asp:ContentPlaceHolder&gt;</b> for individual content.</p>
<p>The <b>id=&quot;CPH1&quot;</b> attribute identifies the placeholder, allowing many placeholders in the same master page.</p>
...
<td><strong>Note:</strong> The master page can also contain code, allowing dynamic content.</td>
</tr></table>
<br>
<hr>
...
&lt;%@ Page MasterPageFile=&quot;master1.master&quot; %&gt;<br><br>
&lt;asp:Content
ContentPlaceHolderId=&quot;CPH1&quot; runat=&quot;server&quot;&gt;<br>&nbsp;
&lt;h2&gt;Individual Content&lt;/h2&gt;<br>
&nbsp;
&lt;p&gt;Paragraph 1&lt;/p&gt;<br>
&nbsp;
&lt;p&gt;Paragraph 2&lt;/p&gt;<br>
...
<p>The content page contains a content tag <b>&lt;asp:Content&gt;</b> with a reference to the master page (ContentPlaceHolderId=&quot;CPH1&quot;).</p>
<p>This content page was saved with the name <b>&quot;mypage1.aspx&quot;</b>.</p>
<p>When the user requests this page, ASP.NET merges the content page with the master page.</p>
<p><a target="_blank" href="mypage1.aspx">Click to display mypage1.aspx.</a></p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><strong>Note:</strong> The content text must be inside the &lt;asp:Content&gt; tag. No content is allowed outside the tag.</td>
</tr></table>
<br>
<hr>
...
<p>The content page above demonstrates how .NET controls can be inserted into the content page just like an into an ordinary page.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_masterpages.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_masterpages.asp#top" target="_top">TOP</a> |
		<a href="aspnet_masterpages.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
