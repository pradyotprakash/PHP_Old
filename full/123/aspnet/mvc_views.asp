...
<head>
<title>ASP.NET MVC Views</title>
<style>a.menu_mvc_views{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">- Views</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_controllers.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_database.asp">Next Chapter &raquo;</a></div>
</div>

<hr>
<p class="intro">To learn ASP.NET MVC, we are Building an Internet Application.</p>
<p class="intro">Part V: Adding Views for Displaying 
the Application.</p>

<hr>
<h2>The Views Folder</h2>
<p>The <strong>Views</strong> folder stores the files (HTML files) related to 
the display of the application (the user interfaces). These files may have the extensions html, asp, aspx, cshtml, and vbhtml, 
depending on the language content.</p>
...
<h2>ASP.NET File Types</h2>
<p>The following HTML file types can be found in the Views Folder: </p>
<table class="reference notranslate">
<tr><th>File Type</th><th>Extention</th></tr>
<tr><td>Plain HTML</td><td>.htm or .html</td></tr>
<tr><td>Classic ASP</td><td>.asp</td></tr>
<tr><td>Classic ASP.NET</td><td>.aspx</td></tr>
<tr><td>ASP.NET Razor C#</td><td>.cshtml</td></tr>
<tr><td>ASP.NET Razor VB</td><td>.vbhtml</td></tr>
</table>
<br>
<hr>

<h2>The Index File</h2>
<p>The file Index.cshtml represents the Home page of the application. It is 
the application's default file (index file).</p>
<p>Put the following content in the file:</p>
<div class="code notranslate">
<div>@{ViewBag.Title = &quot;Home Page&quot;;}<br><br>&lt;h1&gt;Welcome to 
	W3Schools&lt;/h1&gt;<br>
	<br>&lt;p&gt;Put Home Page content here&lt;/p&gt;</div>
</div>
<br>
<hr>

<h2>The About File</h2>
<p>The file About.cshtml represent the About page of the application.</p>
<p>Put the following content in the file:</p>
<div class="code notranslate">
<div>@{ViewBag.Title = &quot;About Us&quot;;}<br><br>
	&lt;h1&gt;About Us&lt;/h1&gt;<br><br>&lt;p&gt;Put About Us content here&lt;/p&gt;</div>
</div>
<br>
<hr>

<h2>Run the Application</h2>
<p>Select Debug, Start Debugging (or F5) from the Visual Web Developer menu.</p>
<p>Your application will look like this:</p>
<p>
<img alt="MVC Application" height="336" src="pic_mvc_app.jpg" width="634"><br>
</p>
<p>Click on the &quot;Home&quot; tab and the &quot;About&quot; tab to see how it works.</p>
<hr>

<h2>Congratulations</h2>
<p>Congratulations. You have created your first MVC Application.</p>
<p><strong>Note:</strong> You cannot click on the &quot;Movies&quot; tab yet. We will add 
code for the &quot;Movies&quot; tab in the next chapters of this tutorial.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_controllers.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_database.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_views.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_views.asp#top" target="_top">TOP</a> |
		<a href="mvc_views.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
