...
<title>WebSecurity GeneratePasswordResetToken Method</title>
<style>a.menu_met_websecurity_generatepasswordresettoken{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> GeneratePasswordResetToken()</span></h1>
<hr>
<a href="webpages_ref_websecurity.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="WebSecurity Object" /> 
WebSecurity Object</a>
<hr>

<h2>Definition</h2>
<p>The <strong>GeneratePasswordResetToken()</strong> method generates a password reset token that can be sent to a user in email.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.GeneratePasswordResetToken(<em>userName, expiration</em>)</div></div>
<br>
<hr>
...
<tr>
<td><em>expiration</em></td>
<td>Integer</td>
<td>The time in minutes until the token expires. Default is 1440 (24 hours)</td>
</tr>
</table>
<br>
<hr>
...
<p>Any access to the <strong>WebSecurity</strong> object throws an <strong>InvalidOperationException</strong> if:</p>
<ul>
	<li>The <strong>InitializeDatabaseConnection()</strong> method has not been called</li>
	<li><strong>SimpleMembership</strong> is not initialized (or disabled in the website configuration)</li>
</ul>
<hr>

<h2>Remarks</h2>
<p>Use the <strong>ResetPassword()</strong> method if the user has forgotten his 
password. The <strong>ResetPassword()</strong> method requires a password <strong>reset token</strong>.</p>
<p>A confirmation token can be created by the <strong>CreateAccount()</strong>,
<strong>CreateUserAndAccount()</strong>, or <strong>GeneratePasswordResetToken()</strong> methods.</p>
<p>The password can be reset by code, but the common procedure is to send an 
email to the user (with the token and a link to a page) so he can confirm the 
new password with the new token:</p>
<div class="code notranslate"><div>
@{<br>newPassword = Request["newPassword"];<br>
confirmPassword = Request[&quot;confirmPassword"];<br>
token = Request["token"];<br>if isPost<br>
{<br>
&nbsp;&nbsp;&nbsp; // input testing is ommitted here to save space<br>&nbsp;&nbsp;&nbsp;
retunValue = ResetPassword(token, newPassword);
<br>
}<br>}<br>&lt;h1&gt;Change Password&lt;/h1&gt;<br><br>&lt;form method=&quot;post&quot; action=&quot;&quot;&gt;<br><br>
&lt;label for=&quot;newPassword&quot;&gt;New Password:&lt;/label&gt; <br>&lt;input type=&quot;password&quot; 
id=&quot;newPassword&quot; name=&quot;newPassword&quot; title=&quot;New password&quot; /&gt;<br><br>&lt;label 
for=&quot;confirmPassword&quot;&gt;Confirm Password:&lt;/label&gt; <br>&lt;input type=&quot;password&quot; 
id=&quot;confirmPassword&quot; name=&quot;confirmPassword&quot; title=&quot;Confirm new password&quot; /&gt;<br>
<br>&lt;label for=&quot;token&quot;&gt;Pasword Token:&lt;/label&gt; <br>&lt;input type=&quot;text&quot; 
id=&quot;token&quot; name=&quot;token&quot; title=&quot;Password Token&quot; /&gt;<br><br>&lt;p 
class=&quot;form-actions&quot;&gt;<br>&lt;input type=&quot;submit&quot; value=&quot;Change Password&quot; 
title=&quot;Change password&quot; /&gt;<br>&lt;/p&gt;<br><br>&lt;/form&gt;
</div>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_generatepasswordresettoken.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_generatepasswordresettoken.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_generatepasswordresettoken.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
