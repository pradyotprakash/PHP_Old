...
<title>ASP.NET HtmlInputHidden Control</title>
<style>a.menu_control_htmlinputhidden{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlInputHidden</span> Control</h1>
<hr>
...
<p>The HtmlInputHidden control is used to control an &lt;input type=&quot;hidden&quot;&gt; element. In HTML, this element is used to create a hidden input field.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Value</td>
    <td>The value of the hidden field</td>
  </tr>
  <tr>
    <td>Visible</td>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>ServerChange</td>
    <td>When the content of the element has changed</td>
  </tr>
</table>
<br>
<hr>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlinputhidden">HTMLInputHidden</a><br>
...
equal to value of the input field and then displays the value of the hidden field in the p element.</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlinputhidden.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlinputhidden.asp#top" target="_top">TOP</a> |
		<a href="control_htmlinputhidden.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
