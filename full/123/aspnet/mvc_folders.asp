...
<head>
<title>ASP.NET MVC Folders</title>
<style>a.menu_mvc_folders{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">- Application Folders</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_app.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_layout.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">To learn ASP.NET MVC, we are Building an Internet application</p>
<p class="intro">Part II: Exploring the Application Folders</p>

<hr>
<h2>MVC Folders</h2>

<p>A typical ASP.NET MVC web application has the following folder content:</p>
<table>
<tr><td>
<table style="width:100%">
<tr>
<td style="width:200px">
<img alt="Solution" height="289" src="pic_mvc_solution.jpg" width="170">&nbsp;</td>
<td style="width:50px">&nbsp;</td>
<td style="text-align:center">
<p><b>Application information</b></p>
<p>Properties<br>References</p>
<p><b>Application folders</b></p>
App_Data Folder<br>Content Folder<br>
Controllers Folder<br>
Models Folder<br>
Scripts Folder<br>
Views Folder<br>
<p><b>Configuration files</b></p>
<p>Global.asax<br>packages.config<br>Web.config</p>
</td>
</tr></table>
</td></tr>
</table>

<p>The folder names are equal in all MVC applications. The MVC 
framework is based on default naming. Controllers are in the Controllers folder, Views are in the Views 
folder, and Models are in the Models folder. You don't have to use the folder names in 
your application code.</p>
<p>Standard naming reduces the amount of code, and makes it easier for developers 
to understand MVC projects.</p>
<p>Below is a brief summary of the content of each folder: </p>

<hr>
<h2>The App_Data Folder</h2>
<p>The <strong>App_Data</strong> folder is for storing application data. </p>
<p>We will add 
an SQL database to the App_Data folder, later in this tutorial.</p>

<hr>
<h2>The Content Folder</h2>
<p>The <strong>Content</strong> folder is used for static files like style sheets (css 
files), icons and images.</p>
<p>Visual Web Developer automatically adds a <strong>themes</strong> folder to the 
Content folder. The themes folder is filled with 
jQuery styles and pictures. In this project you can delete the themes folder.</p>
<p>Visual Web Developer also adds a standard style sheet file 
to the project: the file <strong>Site.css</strong> in the content folder. The 
style sheet file is the file to edit 
when you want to change the style of the application.</p>
<p><img alt="Content" height="316" src="pic_mvc_content.jpg" width="170"></p>
<p>We will edit the style sheet file (Site.css) file in the next chapter of this 
tutorial.</p>
<hr>
<h2>The Controllers Folder</h2>
<p>The Controllers folder contains the controller classes responsible for handling user input 
and responses.</p>
<p>MVC requires the name of all controller files to end with 
&quot;Controller&quot;. </p>
<p>Visual Web Developer has created a Home controller (for the Home and the About page) 
and an Account controller (for Login pages):</p>
<p>
<img alt="Controllers" height="325" src="pic_mvc_controllers.jpg" width="202"></p>
<p>We will create more controllers later in this 
tutorial.</p>

<hr>
<h2>The Models Folder</h2>
<p>The Models folder contains the classes that represent  
the application models. Models hold and manipulate application data.</p>
<p>We will create models (classes) in a later chapter of this tutorial.</p>

<hr>
<h2>The Views Folder</h2>
<p>The Views folder stores the HTML files related to the display of the 
application (the user interfaces). </p>
<p>The Views folder contains one folder for each controller.&nbsp;</p>
<p>Visual Web Developer has created an Account folder, a Home folder, and a 
Shared folder (inside the Views folder).</p>
<p>The Account folder contains pages for registering and logging in to user 
accounts.</p>
<p>The Home folder is used for storing application pages like the home page and 
the about page.</p>
<p>The Shared folder is used to store 
views shared between controllers (master pages and layout pages). </p>
<p><img alt="Views" height="437" src="pic_mvc_views.jpg" width="229">&nbsp;</p>

<p>We will edit the layout files in the next chapter of this tutorial.</p>

<hr>
<h2>The Scripts Folder</h2>
<p>The Scripts folder stores the JavaScript files of the 
application.</p>
<p>By default Visual Web Developer fills this folder with standard MVC, Ajax, 
and jQuery files:</p>
<p><img alt="Scripts" height="623" src="pic_mvc_scripts.jpg" width="291">&nbsp;</p>
<p><strong>Note:</strong> The files named &quot;modernizr&quot; are JavaScript files used 
for supporting HTML5 and CSS3 features in the application. </p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_folders.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_folders.asp#top" target="_top">TOP</a> |
		<a href="mvc_folders.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
