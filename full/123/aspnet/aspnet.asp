...
<title>ASP.NET</title>
<style>a.menu_aspnet{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="next"><a class="chapter" href="webpages_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>Classic ASP - Active Server Pages</h2>
<p>Active Server Pages (ASP), also known as Classic ASP, was introduced in 1998 
as Microsoft's first server side scripting engine. </p>
<p>ASP is a technology that enables
scripts in web pages to be executed by an Internet server.</p>
<p>ASP pages have the file extension .asp, and are normally written in VBScript.</p>
<p>If you want to learn Classic ASP, <a href="../asp/default.asp">
visit our Classic ASP Tutorial</a>.</p>

<hr>

<h2>ASP.NET</h2>
<p>ASP.NET is a new ASP generation. It 
is not compatible with Classic ASP, but ASP.NET may include Classic 
ASP.</p>
<p>ASP.NET pages are compiled, which makes them faster than Classic ASP.</p>
<p>ASP.NET has better language support, a large set of user controls, XML-based
components, and integrated user authentication.</p>

<p>ASP.NET pages have the extension .aspx, and are normally written in VB (Visual Basic) 
or C# (C sharp).</p>

<p>User controls 
in ASP.NET can be written in different languages, including  
C++ and Java.</p>
<p>When a browser requests an ASP.NET file, the ASP.NET engine reads the file, compiles and executes the scripts in the file, 
and returns the result to the browser as plain HTML.</p>

<hr>

<h2>ASP.NET Razor</h2>
<p>Razor is a new and simple markup syntax for embedding server code into 
ASP.NET web pages, much like Classic ASP. </p>


<p>Razor has the power of traditional ASP.NET, 
but is easier to use and easier to learn.</p>

<hr>

<h2>ASP.NET Programming Languages</h2>
<p>This tutorial covers the following programming languages:</p>
<ul>
...
<h2>ASP.NET Server Technologies</h2>
<p>This tutorial covers the following server technologies:</p>
<ul>
	<li>Web Pages (with Razor syntax)</li>
	<li>MVC (Model View Controller)</li>
	<li>Web Forms (traditional ASP.NET)</li>
</ul>

<hr>

<h2>ASP.NET Development Tools</h2>

<p>ASP.NET supports the following development tools:</p>
<ul>
	<li>WebMatrix</li>
...
<p>This tutorial uses WebMatrix for Web Pages, and Visual Web Developer for MVC 
and Web Forms.</p>

<hr>

<h2>ASP.NET File Extensions</h2>
<ul>
<li>Classic ASP files have the file extension .asp</li> 
<li>ASP.NET files have the file extension .aspx</li> 
<li>ASP.NET files with Razor C# syntax have the file extension .cshtml</li>
<li>ASP.NET files with Razor VB syntax have the file extension .vbhtml</li>
</ul>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet.asp#top" target="_top">TOP</a> |
		<a href="aspnet.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
