...
<style>a.menu_control_radiobutton{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">RadioButton</span> Control</h1>
<hr>
...
<p>The RadioButton control is used to display a radio button.</p>
<p><b>Tip:</b> To create a set of radio buttons using data binding, use the RadioButtonList control!</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>AutoPostBack</td>
    <td>A Boolean value that specifies whether the form should be 
    posted immediately after the Checked property has changed or not. Default is 
    false</td>
  </tr>
  <tr>
    <td>Checked</td>
    <td>A Boolean value that specifies whether the radio button is 
    checked or not</td>
  </tr>
  <tr>
    <td>id</td>
  ...
  <tr>
    <td>GroupName</td>
    <td>The name of the group to which this radio button belongs</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Text</td>
    <td>The text next to the radio button</td>
  </tr>
  <tr>
    <td>TextAlign</td>
    <td>On which side of the radio button the text should appear 
    (right or left)</td>
  </tr>
  </table>
<br>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_radiobutton">Radiobutton</a><br>
...
id=&quot;green&quot; is selected, the server sends the message &quot;You selected Blue&quot; to the Label control.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_radiobutton.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_radiobutton.asp#top" target="_top">TOP</a> |
		<a href="control_radiobutton.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
