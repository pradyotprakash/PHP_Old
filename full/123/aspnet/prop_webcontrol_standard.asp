...
<title>ASP.NET Web Control Standard Properties</title>
<style>a.menu_prop_webcontrol_standard{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Control <span class="color_h1">Standard Properties</span></h1>
<hr>
...
<hr>
<h2>Properties</h2>
<p>The following table describes the properties inherited from the WebControl class:</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_standard_accesskey.asp">AccessKey</a></td>
    <td>The keyboard key for accessing a 
	control</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>Attributes</td>
    <td>The collection of attributes applied to a control</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_standard_backcolor.asp">BackColor</a></td>
    <td>The background color of a control</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_standard_bordercolor.asp">BorderColor</a></td>
    <td>The border color of a control</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_standard_borderstyle.asp">BorderStyle</a></td>
    <td>The border style of a control</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_standard_borderwidth.asp">BorderWidth</a></td>
    <td>The border width of a control</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_standard_cssclass.asp">CssClass</a></td>
    <td>The CSS class 
	applied to a control</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_standard_enabled.asp">Enabled</a></td>
    <td>A value indicating whether or not control 
	is enabled</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_standard_font.asp">Font</a></td>
    <td>The font attributes for the control</td>
    <td>1,0</td>
  </tr>
	<tr>
    <td>EnableTheming</td>
    <td>Whether or not themes apply for a control</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_standard_forecolor.asp">ForeColor</a></td>
    <td>The foreground color of the control</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_standard_height.asp">Height</a></td>
    ...
    <td>IsEnabled</td>
    <td>A value indicating whether or not control 
	is enabled (Get value only)</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td>SkinID</td>
    <td>The skin of the control</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_standard_style.asp">Style</a></td>
    <td>The inline CSS style of the control</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_standard_tabindex.asp">TabIndex</a></td>
    <td>The tab order of the control</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_standard_tooltip.asp">ToolTip</a></td>
    <td>The text that appears when the user rests 
	the mouse pointer over a control</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_base_width.asp">Width</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_standard.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_standard.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_standard.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
