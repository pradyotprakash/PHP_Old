...
<style>a.menu_aspnet_refwebcontrols{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- Server Controls</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_refhtmlcontrols.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_refvalidationcontrols.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Web server controls are special ASP.NET tags understood by the server.</p>
<hr>

<h2>Web Server Controls</h2>
<p>Like HTML server controls, Web server controls are also created on the server and 
they require a runat=&quot;server&quot; attribute to work. However, Web server controls do not 
necessarily map to any existing HTML elements and they may represent more complex elements.</p>
...
<table class="reference notranslate">
  <tr>
    <th style="width:30%">Web Server Control</th>
    <th>Description</th>
  </tr>
  <tr>
    <td><a href="control_adrotator.asp">AdRotator</a></td>
    <td>Displays a sequence of images</td>
  </tr>
  <tr>
    <td><a href="control_button.asp">Button</a></td>
    <td>Displays a push button</td>
  </tr>
  <tr>
    <td><a href="control_calendar.asp">Calendar</a></td>
    <td>Displays a calendar</td>
  </tr>
  <tr>
    <td><a href="control_calendarday.asp">CalendarDay</a></td>
    <td>A day in a calendar control</td>
  </tr>
  <tr>
    <td><a href="control_checkbox.asp">CheckBox</a></td>
    <td>Displays a check box</td>
  </tr>
  <tr>
    <td><a href="control_checkboxlist.asp">CheckBoxList</a></td>
  ...
  <tr>
    <td><a href="control_dropdownlist.asp">DropDownList</a></td>
    <td>Creates a drop-down list</td>
  </tr>
  <tr>
    <td><a href="control_hyperlink.asp">HyperLink</a></td>
    <td>Creates a hyperlink</td>
  </tr>
  <tr>
    <td><a href="control_image.asp">Image</a></td>
    <td>Displays an image</td>
  </tr>
  <tr>
    <td><a href="control_imagebutton.asp">ImageButton</a></td>
    <td>Displays a clickable image</td>
  </tr>
  <tr>
    <td><a href="control_label.asp">Label</a></td>
    <td>Displays static content which is programmable (lets you 
    apply styles to its content)</td>
  </tr>
  <tr>
    <td><a href="control_linkbutton.asp">LinkButton</a></td>
    <td>Creates a hyperlink button</td>
  </tr>
  <tr>
    <td><a href="control_listbox.asp">ListBox</a></td>
    <td>Creates a single- or multi-selection drop-down list</td>
  </tr>
  <tr>
    <td><a href="control_listitem.asp">ListItem</a></td>
    <td>Creates an item in a list</td>
  </tr>
  <tr>
    <td><a href="control_literal.asp">Literal</a></td>
    <td>Displays static content which is programmable(does not let 
    you apply styles to its content)</td>
  </tr>
  <tr>
    <td><a href="control_panel.asp">Panel</a></td>
    <td>Provides a container for other controls</td>
  </tr>
  <tr>
    <td><a href="control_placeholder.asp">PlaceHolder</a></td>
    <td>Reserves space for controls added by code</td>
  </tr>
  <tr>
    <td><a href="control_radiobutton.asp">RadioButton</a></td>
    <td>Creates a radio button</td>
  </tr>
  <tr>
    <td><a href="control_radiobuttonlist.asp">RadioButtonList</a></td>
    <td>Creates a group of radio buttons</td>
  </tr>
  <tr>
    <td><a href="control_bulletedlist.asp">BulletedList</a></td>
  ...
  <tr>
    <td><a href="control_style.asp">Style</a></td>
    <td>Sets the style of controls</td>
  </tr>
  <tr>
    <td><a href="control_table.asp">Table</a></td>
    <td>Creates a table</td>
  </tr>
  <tr>
    <td><a href="control_tablecell.asp">TableCell</a></td>
    <td>Creates a table cell</td>
  </tr>
  <tr>
    <td><a href="control_tablerow.asp">TableRow</a></td>
    <td>Creates a table row</td>
  </tr>
  <tr>
    <td><a href="control_textbox.asp">TextBox</a></td>
    <td>Creates a text box</td>
  </tr>
  <tr>
    <td><a href="control_xml.asp">Xml</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_refwebcontrols.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_refwebcontrols.asp#top" target="_top">TOP</a> |
		<a href="aspnet_refwebcontrols.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
