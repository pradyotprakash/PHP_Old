...
<title>ASP.NET ShowTitle Property</title>
<style>a.menu_prop_webcontrol_calendar_showtitle{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">ShowTitle</span> Property</h1>
<hr>
...
<p>The ShowTitle property is used to specify whether or not to display the 
title in the calendar.</p>
<p>By default this property is set as TRUE and the calendar title are displayed. 
To remove the title the property must be set as FALSE.</p>
<p><b>Note: </b>Hiding the title hides the name of the month and the next and 
previous month links</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>

&lt;asp:Calendar ShowTitle=&quot;TRUE|FALSE&quot; runat=&quot;server&quot;<i> /&gt;</i>
</div></div>
<br>
<hr>
<div class="example">
<h2 class="example">Example</h2>
<p>The following example sets the ShowTitle as FALSE:</p>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_calendar_showtitle" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_calendar_showtitle.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_calendar_showtitle.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_calendar_showtitle.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
