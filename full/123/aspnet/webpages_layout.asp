...
<title>ASP.NET Web Pages Layout</title>
<style>a.menu_webpages_layout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Page Layout</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_razor.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_folders.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">With Web Pages it is easy to create a web site with a 
consistent layout.</p>
<hr>
<h2>A Consistent Look</h2>
<p>On the Internet you will discover many web sites with a consistent look and 
feel:</p>
<ul>
	<li>Every page have the same header</li>
	<li>Every page have the same footer</li>
	<li>Every page have the same style and layout</li>
</ul>
<p>With Web Pages this can be done very efficiently. You can have reusable 
blocks of content (content blocks), like headers and footers, in separate files.</p>
<p>You can 
also define a consistent layout for all your pages, using a layout template 
(layout file).</p>
<hr>
<h2>Content Blocks</h2>
<p>Many websites have content that is displayed on every 
page (like headers and footers).</p>
<p>With Web Pages you can use the <b>@RenderPage()</b> method to import content from separate 
files.</p>
<p>Content block (from another file) can be imported anywhere in a web page, and 
can contain text, markup, and code, just like any regular web page. </p>
<p>Using common headers and footers as an example, this saves you a lot of work. You don't have to write the 
same content in every page, and when you change the header or footer files, the 
content is 
updated in all your pages.</p>
...
&lt;html&gt;<br>
&lt;body&gt;<br>
<span class="marked">@RenderPage(&quot;header.cshtml&quot;)</span><br>
&lt;h1&gt;Hello Web Pages&lt;/h1&gt; <br>
&lt;p&gt;This is a paragraph&lt;/p&gt;<br>
<span class="marked">@RenderPage(&quot;footer.cshtml&quot;)</span><br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<br>
	<a class="showbtn" href="showfile_c.asp?filename=try_webpages_cs_002" target="_blank">Run example &raquo;</a>
</div>
<br>

<hr>
<h2>Using a Layout Page</h2>
<p>In the previous section, you saw that including the same content in many 
web pages is easy.</p>
<p>Another approach to creating a consistent look is to use a layout page. A layout page 
...
according to the layout page (template).</p>
<p>The layout page is just like a normal web page, except from a call to the
<strong>@RenderBody()</strong> method where the content page will be 
included.</p>
<p>Each content page must start with a <strong>Layout directive</strong>.</p>
<p>This is how it looks in code:</p>

<div class="example">
<h2 class="example">Layout Page:</h2>
<div class="example_code notranslate">
&lt;html&gt;<br>&lt;body&gt;<br>&lt;p&gt;This is header text&lt;/p&gt;<br>
<span class="marked">@RenderBody()</span><br>
&lt;p&gt;&amp;copy; 2012 W3Schools. All rights reserved.&lt;/p&gt;<br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<br>
<h2 class="example">Any Web Page:</h2>
<div class="example_code notranslate">
<span class="marked">@{Layout=&quot;Layout.cshtml&quot;;}</span><br>
	<br>&lt;h1&gt;Welcome to W3Schools&lt;/h1&gt;<br>
	<br>&lt;p&gt;<br>Lorem ipsum dolor sit amet, consectetur adipisicing elit,sed do eiusmod tempor 
incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis 
nostrud exercitation ullamco laborisnisi ut aliquip ex ea commodo consequat.<br>&lt;/p&gt;
</div>
<br>
<a class="showbtn" href="showfile_c.asp?filename=try_webpages_cs_011" target="_blank">Run example &raquo;</a>
</div>
<br>

<hr>
<h2>D.R.Y. - Don't Repeat Yourself</h2>
<p>With two ASP.NET tools, Content Blocks and Layout Pages, you can give your 
web applications a consistent look.</p>
<p>These tools also save you a lot of work, since you don't have to repeat the 
same information on all pages. Centralizing markup, style, and code makes web 
applications much more manageable and easier to maintain.</p>

<hr>
<h2>Preventing Files from Being Browsed</h2>
<p>With ASP.NET, files with a name that starts with an underscore cannot be 
browsed from the web.</p>
<p>If you want to prevent your content blocks or layout files from being viewed 
by your users, rename the files to:</p>
<p>_header.cshtm</p>
<p>_footer.cshtml</p>
<p>_Layout.cshtml</p>
...
<p>With ASP.NET, the common way to hide sensitive information (database passwords, 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_layout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_layout.asp#top" target="_top">TOP</a> |
		<a href="webpages_layout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
