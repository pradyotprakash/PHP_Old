...
<title>ASP.NET Web Pages PHP</title>
<style>a.menu_webpages_php{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- PHP</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_email.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_publish.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Attention PHP Developers. Web Pages can be written in PHP.</p>
<hr>
<h2>WebMatrix Supports PHP</h2>
<p>At first look, WebMatrix only supports Microsoft technologies. This is not 
true. In WebMatrix you can write full PHP applications with MySQL and all.</p>
<hr>
<h2>Create a PHP Site</h2>
<p>In the chapter <a href="webpages_website.asp">ASP.NET Web Pages - Create a Web 
Site</a> you created a new empty web site named &quot;Demo&quot;, with a new empty page of 
the type &quot;CSHTML&quot;.</p>
<p>Repeat the process, create an empty site named &quot;Demo_PHP&quot;, enable PHP (see 
picture below), create a new empty page of the type PHP, name it &quot;index.php&quot;, 
and you have created your first PHP site.&nbsp;&nbsp; </p>
<p><img alt="Screenshoot" height="402" src="21.jpg" width="548"></p>
<hr>
<h2>Create a PHP Page</h2>

<p>Put the following code inside the &quot;index.php&quot; file:</p>

<div class="example">
<h2 class="example">index.php</h2>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>
	<span class="marked">&lt;?php<br>phpinfo();<br>?&gt;</span><br>
	<br>&lt;/body&gt;<br>
	&lt;/html&gt;</div>
</div>
<p>Run the file and see PHP at work.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_php.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_php.asp#top" target="_top">TOP</a> |
		<a href="webpages_php.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
