...
<title>WebSecurity UserExists Method</title>
<style>a.menu_met_websecurity_userexists{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> UserExists()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>UserExists()</strong> method indicates if the user exists in the WebSecurity database. </p>
<hr>
...
<tr>
<td>Boolean</td>
<td><strong>true</strong> if the user exists, 
...
<h2>Remarks</h2>
<p>The <strong>UserExists()</strong> method only verifies that the user exists in the user profile 
table.</p>
<p>It does <strong>not</strong> verify that a membership account exists for that 
user, or that the user is confirmed, or logged in.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_userexists.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_userexists.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_userexists.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
