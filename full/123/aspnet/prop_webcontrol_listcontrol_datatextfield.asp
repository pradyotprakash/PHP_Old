...
<title>ASP.NET DataTextField Property</title>
<style>a.menu_prop_webcontrol_listcontrol_datatextfield{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">DataTextField</span> Property</h1>
<hr>
...
<p>The DataTextField property specifies which field from the DataSource to bind 
to the Text property of each item in the control.</p>
<hr>
<div class="example">
...
<p>The XML file used in the example is <a target="_blank" href="countries.xml">countries.xml</a></p><hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_listcontrol_datatextfield.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_listcontrol_datatextfield.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_listcontrol_datatextfield.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
