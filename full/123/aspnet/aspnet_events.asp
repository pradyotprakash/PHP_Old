...
<style>a.menu_aspnet_events{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- Events</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_controls.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_forms.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An Event Handler is a subroutine that executes code for a given event.</p>
<hr>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_pageload" class="showbtn">Show example &raquo;</a>
</div>
<p><b>Note:</b> The Page_Load event contains no object references or event 
arguments!</p>
<hr>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_pageispostback" class="showbtn">Show example &raquo;</a>
</div>
<p>The example above will write the &quot;The date and time is....&quot; message only the 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_events.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_events.asp#top" target="_top">TOP</a> |
		<a href="aspnet_events.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
