...
<title>ASP.NET Web Pages Reference WebMail</title>
<style>a.menu_webpages_ref_webmail{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- WebMail Object</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_ref_database.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_ref_helpers.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<p class="intro">With the WebMail object you can easily send emails from a web page.</p>
<hr>

<h2>Description</h2>
<p>The <strong>WebMail Object</strong> provides email for 
ASP.NET Web Pages using SMTP (Simple Mail Transfer Protocol).</p>
<hr>

<h2>Example</h2>
<p>See an example in the chapter: <a href="webpages_email.asp">Web Pages Email</a>.</p>
<hr>
...
<tr>
<td>SmtpServer</td>
<td>The name the SMTP server that will send the emails</td>
</tr>

<tr>
<td>SmtpPort</td>
<td>The port the server will use to send SMTP emails</td>
</tr>

<tr>
<td>EnableSsl</td>
<td>True, if the server should use SSL encryption</td>
</tr>

<tr>
<td>UserName</td>
<td>The name of the SMTP account used to send the email</td>
</tr>

<tr>
<td>Password</td>
<td>The password of the SMTP account</td>
</tr>

<tr>
<td>From</td>
<td>The email to appear in the from address</td>
</tr>
...
<tr>
<td>Send()</td>
<td>Sends an email message to an SMTP server for delivery</td>
</tr>
</table>
<p>The Send() method has the following parameters:</p>
<table class="reference notranslate">
<tr>
...
<td>to</td>
<td>String</td>
<td>The Email recipients (separated by semicolon)</td>
</tr>
...
<td>from</td>
<td>String</td>
<td>The email of the sender </td>
</tr>

<tr>
<td>cc</td>
<td>String</td>
<td>The cc emails (separated by semicolon)</td>
</tr>
...
<td>isBodyHtml</td>
<td>Boolean</td>
<td>True if the email body is in HTML</td>
</tr>
...
<p>To use the WebMail helper, you need access to an SMTP server. SMTP is the 
...
might be able to use your ordinary email provider.</p>
<p>&nbsp;In order to send an email you will need:</p>
<ul>
	<li>The name of the SMTP server </li>
	<li>The port number (most often 25) </li>
	<li>An email user name</li>
	<li>An email password</li>
</ul>
...
feeds your <strong>WebMail Object</strong> with initial values.</p>
<p>Please substitute:</p>
<p><strong>smtp.example.com</strong> with the name the SMTP server that will be used to 
send the emails.</p>
<p><strong>25</strong> with the port number the server will use to send SMTP 
transactions (emails).</p>
<p><strong>false</strong> with true, if the server should use SSL (Secure Socket 
Layer) encryption.</p>
<p><strong>support@example.com</strong> with the name of the SMTP email account used to send 
emails.</p>
<p>p<strong>assword</strong> with the password of the SMTP email account.</p>
<p><strong>john@example </strong>with the email to appear in the from address.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_ref_webmail.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_ref_webmail.asp#top" target="_top">TOP</a> |
		<a href="webpages_ref_webmail.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
