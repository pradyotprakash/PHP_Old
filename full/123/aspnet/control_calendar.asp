...
<style>a.menu_control_calendar{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">Calendar</span> Control</h1>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
<hr>

<h2>Definition and Usage</h2>
<p>The Calendar control is used to display a calendar in the browser.</p>
<p>This control displays a one-month calendar that allows the user to select dates and move to the next and previous months.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_calendar_caption.asp">Caption</a></td>
    <td>The caption of the calendar</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_captionalign.asp">CaptionAlign</a></td>
    <td>The alignment of the caption text</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_cellpadding.asp">CellPadding</a></td>
    <td>The space, in pixels, between the cell walls and contents</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_cellspacing.asp">CellSpacing</a></td>
    <td>The space, in pixels, between cells</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_dayheaderstyle.asp">DayHeaderStyle</a></td>
    <td>The style for displaying the names of the days</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_daynameformat.asp">DayNameFormat</a></td>
    <td>The format for displaying the names of the days</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_daystyle.asp">DayStyle</a></td>
    <td>The style for displaying days</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_firstdayofweek.asp">FirstDayOfWeek</a></td>
    <td>What should be the first day of week</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_nextmonthtext.asp">NextMonthText</a></td>
    <td>The text displayed for the next month link</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_nextprevformat.asp">NextPrevFormat</a></td>
    <td>The format of the next and previous month links</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_nextprevstyle.asp">NextPrevStyle</a></td>
    <td>The style for displaying next and previous month links</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_othermonthdaystyle.asp">OtherMonthDayStyle</a></td>
    <td>The style for displaying days that are not in the current 
    month</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_prevmonthtext.asp">PrevMonthText</a></td>
    <td>The text displayed for the previous month link</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>runat</td>
    <td>Specifies that the control is a server control.&nbsp; Must 
    be set to &quot;server&quot;</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_selecteddate.asp">SelectedDate</a></td>
    <td>The selected date</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_selecteddates.asp">SelectedDates</a></td>
    <td>The selected dates</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_selecteddaystyle.asp">SelectedDayStyle</a></td>
    <td>The style for selected days</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_selectionmode.asp">SelectionMode</a></td>
    <td>How a user is allowed to select dates</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_selectmonthtext.asp">SelectMonthText</a></td>
    <td>The text displayed for the month selection link</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_selectorstyle.asp">SelectorStyle</a></td>
    <td>The style for the month and weeks selection links</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_selectweektext.asp">SelectWeekText</a></td>
    <td>The text displayed for the week selection link</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_showdayheader.asp">ShowDayHeader</a></td>
    <td>A Boolean value that specifies whether the days of the week 
    header should be shown</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_showgridlines.asp">ShowGridLines</a></td>
    <td>A Boolean value that specifies whether the grid lines between days should be shown</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_shownextprevmonth.asp">ShowNextPrevMonth</a></td>
    <td>A Boolean value that specifies whether the next and previous month links should be shown</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_showtitle.asp">ShowTitle</a></td>
    <td>A Boolean value that specifies whether the title of the calendar should be shown</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_titleformat.asp">TitleFormat</a></td>
    <td>The format for the title of the calendar</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_titlestyle.asp">TitleStyle</a></td>
    <td>The style of the title of the calendar</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_todaydaystyle.asp">TodayDayStyle</a></td>
    <td>The style for today's date</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_todaysdate.asp">TodaysDate</a></td>
    <td>Today's date</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>UseAccessibleHeader</td>
    <td>Specifying whether to use the &lt;th&gt; element for the day headers instead of the &lt;td&gt; element</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_visibledate.asp">VisibleDate</a></td>
    <td>The date that specifies the month that is currently visible in the calendar</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_calendar_weekenddaystyle.asp">WeekendDayStyle</a></td>
    <td>The style for weekends</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>OnDayRender</td>
    <td>The name of the function to be executed when when each day cell is created</td>
    <td>&nbsp;</td>
  </tr>
	<tr>
    <td>OnSelectionChanged</td>
    <td>The name of the function to be executed when the user selects a day, week, or month</td>
    <td>&nbsp;</td>
  </tr>
	<tr>
    <td>OnVisibleMonthChanged</td>
    <td>The name of the function to be executed when the user navigates to a different month</td>
    <td>&nbsp;</td>
  </tr>
  </table>

<h2>Web Control Standard Properties</h2>
<div class="code notranslate"><div>
AccessKey, Attributes, BackColor, BorderColor, BorderStyle, BorderWidth, CssClass, Enabled, Font, EnableTheming, 
ForeColor, Height, IsEnabled, SkinID, Style, TabIndex, ToolTip, Width</div></div>

<p>For a full description, go to <a href="prop_webcontrol_standard.asp">Web Control Standard Attributes</a>.</p>

<h2>Control Standard Properties</h2>
<div class="code notranslate"><div>
AppRelativeTemplateSourceDirectory, BindingContainer, ClientID, Controls, EnableTheming, EnableViewState, ID, NamingContainer, 
Page, Parent, Site, TemplateControl, TemplateSourceDirectory, UniqueID, Visible</div></div>

<p>For a full description, go to <a href="prop_control_standard.asp">Control Standard Attributes</a>.</p>
<hr>
...
<p><a target="_blank" href="showaspx.asp?filename=demo_calendar">Calendar</a><br>
Declare a Calendar control in its simplest use.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_calendar2">Calendar 2</a><br>
Declare a Calendar control where the days are displayed with full names in blue, the 
weekends are displayed in red on a yellow background, and the current date is 
displayed with a green background.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_calendar3">Calendar 3</a><br>
Declare a Calendar control where the days are displayed with full names, the user may 
select a day, a week, or the whole month, and the selected day/week/month is displayed with a grey background color.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_calendar.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_calendar.asp#top" target="_top">TOP</a> |
		<a href="control_calendar.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
