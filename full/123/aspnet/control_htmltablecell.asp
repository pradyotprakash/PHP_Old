...
<title>ASP.NET HtmlTableCell Control</title>
<style>a.menu_control_htmltablecell{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlTableCell</span> Control</h1>
<hr>
...
<p>The HtmlTableCell control is used to control &lt;td&gt; and &lt;th&gt; elements. In HTML, these 
elements are used to create table cells and header table cells.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Align</td>
    <td>The horizontal alignment of cell content</td>
  </tr>
  <tr>
    <td>Attributes</td>
  ...
  <tr>
    <td>BGColor</td>
    <td>The background color of the cell</td>
  </tr>
  <tr>
    <td>BorderColor</td>
    <td>The color of the borders</td>
  </tr>
  <tr>
    <td>ColSpan</td>
    <td>The number of columns this cell should span</td>
  </tr>
  <tr>
    <td>Disabled</td>
  ...
  <tr>
    <td>Nowrap</td>
    <td>A Boolean value that specifies whether or not the text within this control should wrap</td>
  </tr>
  <tr>
    <td>RowSpan</td>
    <td>The number of rows this cell should span</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td>Style</td>
    <td>Gets the CSS properties that are applied to the control</td>
  </tr>
  <tr>
    <td>TagName</td>
  ...
  <tr>
    <td>VAlign</td>
    <td>The vertical alignment of cell content</td>
  </tr>
  <tr>
    <td>Visible</td>
...
Declare an HtmlTable control and an HtmlInputButton control in an .aspx file (remember to embed the controls 
inside an HtmlForm control). When the submit button is triggered, the submit subroutine is executed. The submit subroutine modifies the background color and 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmltablecell.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmltablecell.asp#top" target="_top">TOP</a> |
		<a href="control_htmltablecell.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
