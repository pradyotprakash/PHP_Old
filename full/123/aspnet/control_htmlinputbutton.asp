...
<title>ASP.NET HtmlInputButton Control</title>
<style>a.menu_control_htmlinputbutton{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlInputButton</span> Control</h1>
<hr>
...
<p>The HtmlInputButton control is used to control &lt;input type=&quot;button&quot;&gt;, &lt;input type=&quot;submit&quot;&gt;,
and &lt;input type=&quot;reset&quot;&gt; elements. In HTML, these elements are used to create a command button, a submit button, and a reset button.</p>
<hr>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlinputbutton">HTMLInputbutton</a><br>
...
inside an HtmlForm control). When the submit button is triggered, the submit subroutine is executed. The submit subroutine writes a welcome message to the p element.</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlinputbutton.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlinputbutton.asp#top" target="_top">TOP</a> |
		<a href="control_htmlinputbutton.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
