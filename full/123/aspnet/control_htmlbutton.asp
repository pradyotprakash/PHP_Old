...
<title>ASP.NET HtmlButton Control</title>
<style>a.menu_control_htmlbutton{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlButton</span> Control</h1>
<hr>
...
<p>The HtmlButton control is used to control a &lt;button&gt; element. In HTML, the &lt;button&gt; element is used to create a push button.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>OnServerClick</td>
    <td>The name of the function to be executed when the button is clicked</td>
  </tr>
  <tr>
    <td>runat</td>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlbutton">HTMLButton</a><br>
Declare two HtmlButton controls in an .aspx file (remember to embed the control 
inside an HtmlForm control). Next, write an event handler that specifies what to happen when a button is clicked.</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlbutton.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlbutton.asp#top" target="_top">TOP</a> |
		<a href="control_htmlbutton.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
