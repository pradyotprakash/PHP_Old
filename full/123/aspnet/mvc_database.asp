...
<head>
<title>ASP.NET MVC Database</title>
<style>a.menu_mvc_database{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">- SQL Database</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_views.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_models.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">To learn ASP.NET MVC, we are Building an Internet Application.</p>
<p class="intro">Part VI: Adding a Database.</p>

<hr>

<h2>Creating the Database</h2>
<p>Visual Web Developer comes with a free SQL database called SQL Server 
Compact.</p>
<p>The database needed for this tutorial can be created with these simple steps:</p>
<ul>
	<li>Right-click the <strong>App_Data</strong> folder in the <strong>Solution 
	Explorer</strong> window</li>
	<li>Select <strong>Add, New Item</strong></li>
	<li>Select <strong>SQL Server Compact Local Database *</strong></li>
	<li>Name the database
	<strong>Movies.sdf</strong>.</li>
	<li>Click the <strong>Add</strong> button</li>
</ul>
<p><strong>*</strong> If SQL Server Compact Local Database is not an option, you 
have not installed SQL Server Compact on your computer. Install it from this 
link: <a href="http://www.microsoft.com/web/gallery/install.aspx?appid=SQLCE;SQLCEVSTools_4_0">SQL 
Server Compact</a></p>
<p>Visual Web Developer automatically creates the database in the App_Data 
folder.</p>
<p><strong>Note:</strong> In this tutorial it is expected that you have some 
knowledge about SQL databases. If you want to study this topic first, please 
visit our <a href="../sql/default.asp">SQL Tutorial</a>.</p>

<hr>

<h2>Adding a Database Table</h2>
<p>Double-clicking the <strong>Movies.sdf</strong> file in the <strong>App_Data</strong> folder will open 
a <strong>Database Explorer</strong> window.</p>
<p>To create a new table in the database, right-click the <strong>Tables</strong> folder, and 
select <strong>Create Table</strong>. </p>
...
<p><strong>ID</strong> is an integer (whole number) used to identify each record 
in the table.</p>
<p><strong>Title</strong> is a 100 character text column to store the name of 
the movie.</p>
<p><strong>Director</strong> is a 100 character text column to store the 
director's name.</p>
<p><strong>Date</strong> is a datetime column to store the release date of the 
movie.</p>
<p>After creating the columns described above, you must make the ID column the 
table's primary key (record identifier). To do this, click on the column 
name (ID) and select <strong>Primary Key</strong>. Also, in the <strong>
Column Properties</strong> window, set the <strong>Identity</strong> property to <strong>
True</strong>: </p>
<p><img alt="DB Explorer" height="543" src="pic_mvc_dbexplorer.jpg" width="615"></p>
<p>When you have finished creating the table columns, save the table and name it
<strong>MovieDBs</strong>.</p>
<p><strong>Note:</strong></p>
<p>We have deliberately named the table &quot;MovieDBs&quot; (ending with s). 
In the next chapter, you will see the name &quot;MovieDB&quot; used for the data model. It 
looks strange, but this is the naming convention you have to use to make the 
controller connect to the database table. </p>

<hr>

<h2>Adding Database Records</h2>
<p>You can use Visual Web Developer to add some test records to the movie 
database.</p>
<p>Double-click the <strong>Movies.sdf</strong> file in the <strong>App_Data</strong> 
folder.</p>
<p>Right-click the <strong>MovieDBs</strong> table in the Database Explorer window and select
<strong>Show Table Data</strong>.</p>
...
<p><strong>Note:</strong> The ID column is updated automatically. You should not edit it.</p>
<hr>

<h2>Adding a Connection String</h2>
<p>Add the following element to the <strong>&lt;connectionStrings&gt;</strong> element 
in your <strong>Web.config</strong> file:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_database.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_database.asp#top" target="_top">TOP</a> |
		<a href="mvc_database.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
