...
<title>ASP.NET HtmlImage Control</title>
<style>a.menu_control_htmlimage{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlImage</span> Control</h1>
<hr>
...
<p>The HtmlImage control is used to control an &lt;img&gt; element. In HTML, the &lt;img&gt; element is used to display an image.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>Align</td>
    <td>How to align the image according to surrounding elements. Legal values are:
    <ul>
      <li>top</li>
      <li>middle</li>
      <li>bottom</li>
  ...
  <tr>
    <td>Border</td>
    <td>The width of the borders around the image</td>
  </tr>
  <tr>
    <td>Disabled</td>
  ...
  <tr>
    <td>Src</td>
    <td>The URL of the image to display</td>
  </tr>
  <tr>
    <td>Style</td>
...
<h2>Examples</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlimage">HTMLImage</a><br>
Declare an HtmlImage control in an .aspx file (remember to embed the control inside an HtmlForm control).
Then we modify the src, alt and border properties of the HtmlImage control in an event 
...
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlimage2">HTMLImage 2</a><br>
...
choices. The value selected in the HtmlSelect control determines which image to display.</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlimage.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlimage.asp#top" target="_top">TOP</a> |
		<a href="control_htmlimage.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
