...
<title>ASP.NET Web Pages - Publish</title>
<style>a.menu_webpages_publish{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Publishing the Website</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_php.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn how to publish a Web Pages application without using WebMatrix.</p>
<hr>
<h2>
Publish Your Application Without Using WebMatrix</h2>
<p>
An ASP.NET Web Pages application can be published to a remote server by using 
the Publish commands in WebMatrix (or Visual Studio).</p>
<p>
...
<p>If your application contains data, <strong>don't copy the data</strong> 
(see point 4 below).</p>
    </td>
</tr></table>
...
3.
    The DLL Files</h2>
<p>Make sure the bin folder, on your remote hosting computer, contains the same dll files as on your development computer.</p>
<p>After copying the bin folder, it should contain files like this:</p>
<p>&nbsp;Microsoft.Web.Infrastructure.dll<br />
    NuGet.Core.dll<br />
    System.Web.Helpers.dll<br />
    System.Web.Razor.dll<br />
    System.Web.WebPages.Administration.dll<br />
    System.Web.WebPages.Deployment.dll<br />
    System.Web.WebPages.dll<br />
    System.Web.WebPages.Razor.dll<br />
    WebMatrix.Data.dll<br />
    WebMatrix.WebData</p>
<hr>

<h2>4. Copy Your Data</h2>
<p>If your application contains data or a database. For instance an SQL Server Compact database (a .sdf file in App_Data 
folder), consider the following:</p>
<p>Do you want to publish your test data to the 
remote server?</p>
<p>Most likely not.</p>
    <p>If you have test data on your development computer, it may overwrite production data on your remote hosting computer.</p>
<p>If you have to copy an SQL database (.sdf file), perhaps you should delete 
...
<br/>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_php.asp">&laquo; Previous</div>
<div class="next"><a class="chapter" href="webpages_examples.asp">Next Chapter &raquo;</a></div>
</div>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_publish.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_publish.asp#top" target="_top">TOP</a> |
		<a href="webpages_publish.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
