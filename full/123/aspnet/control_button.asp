...
<title>ASP.NET Button Control</title>
<style>a.menu_control_button{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">Button</span> Control</h1>
<hr>
...
<p>A submit button does not have a command name and it posts the Web page 
back to the server when it is clicked. It is possible to write an event handler 
to control the actions performed when the submit button is clicked.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_button_causesvalidation.asp">CausesValidation</a></td>
    <td>Specifies if a page is validated when a button is 
	clicked</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>CommandArgument</td>
    <td>Specifies additional information about the command to perform</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>CommandName</td>
    <td>Specifies the command associated with the Command event</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_button_onclientclick.asp">OnClientClick</a></td>
    <td>Specifies the name of the function to be executed when a button is 
	clicked</td>
    <td>2.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_button_postbackurl.asp">PostBackUrl</a></td>
    <td>Specifies the URL of the page to post to from the current page when 
  ...
  <tr>
    <td><a href="prop_webcontrol_button_text.asp">Text</a></td>
    <td>Specifies the text on a button</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_button_usesubmitbehavior.asp">UseSubmitBehavior</a></td>
    <td>Specifies whether or not a button uses 
	the browser's submit mechanism or the ASP.NET postback mechanism</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_button_validationgroup.asp">ValidationGroup</a></td>
    <td>Specifies the group of controls a button causes 
	validation, when it posts back to the server</td>
    <td>2.0</td>
  </tr>
</table>
...
<p><a target="_blank" href="showaspx.asp?filename=demo_button">Button</a><br>
Declare a submit Button control. Then create an event handler for the Click event which changes the text on the button.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_button2">Button 2</a><br>
Declare a submit Button control. Then create an event handler for the Click event which changes the text and the style of the button.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_button.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_button.asp#top" target="_top">TOP</a> |
		<a href="control_button.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
