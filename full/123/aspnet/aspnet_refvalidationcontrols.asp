...
<style>a.menu_aspnet_refvalidationcontrols{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- Validation Controls</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_refwebcontrols.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="default.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Validation server controls are used to validate user-input.</p>
<hr>

<h2>Validation Server Controls</h2>
<p>A Validation server control is used to validate the data of an input control. 
If the data does not pass validation, it will display an error message to the user.</p>
...
<table class="reference notranslate">
  <tr>
    <th style="width:40%">Validation Server Control</th>
    <th>Description</th>
  </tr>
  <tr>
    <td><a href="control_comparevalidator.asp">CompareValidator</a></td>
    <td>Compares the value of one input control to the value of 
    another input control or to a fixed value</td>
  </tr>
  <tr>
    <td><a href="control_customvalidator.asp">CustomValidator</a></td>
    <td>Allows you to write a method to handle the validation of 
    the value entered</td>
  </tr>
  <tr>
    <td><a href="control_rangevalidator.asp">RangeValidator</a></td>
    <td>Checks that the user enters a value that falls between two 
    values</td>
  </tr>
  <tr>
    <td><a href="control_regularexpvalidator.asp">RegularExpressionValidator</a></td>
    <td>Ensures that the value of an input control matches a 
    specified pattern</td>
  </tr>
  <tr>
    <td><a href="control_reqfieldvalidator.asp">RequiredFieldValidator</a></td>
    <td>Makes an input control a required field</td>
  </tr>
  <tr>
    <td><a href="control_validationsummary.asp">ValidationSummary</a></td>
    <td>Displays a report of all validation errors occurred in a 
    Web page</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_refvalidationcontrols.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_refvalidationcontrols.asp#top" target="_top">TOP</a> |
		<a href="aspnet_refvalidationcontrols.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
