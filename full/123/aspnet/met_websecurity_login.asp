...
<title>WebSecurity Login Method</title>
<style>a.menu_met_websecurity_login{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> Login()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>Login()</strong> method logs in a specified user, using a 
username and a password.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.Login(<em>userName, 
password, persistCookie</em>)</div></div>
<br>
<hr>
...
if (WebSecurity.Login(username,password))<br>{<br>&lt;p&gt;Welcome&lt;/p&gt;<br>}<br>
else<br>{<br>&lt;p&gt;Incorrect username or password.&lt;/p&gt;<br>}</div>
</div>
<br>
<div class="example">
<h2 class="example">Example VB</h2>
<div class="example_code notranslate">
if WebSecurity.Login(username,password)<br>&lt;p&gt;Welcome&lt;/p&gt;<br>else<br>
&lt;p&gt;Incorrect username or password&lt;/p&gt;<br>end if
</div>
</div>
<br>
<hr>
...
<tr>
<td><em>persistCookie</em></td>
<td>String</td>
<td> <strong>true</strong> to specify 
that the authentication token in the cookie should be persisted beyond the 
current session; otherwise <strong>false</strong>. Default is false.</td>
</tr>
</table>
<br>
<hr>
...
<tr>
<td>Boolean</td>
<td><strong>true</strong> if the user is logged in, 
...
<hr>
<h2>Remarks</h2>
<p>When a user is logged in, ASP.NET sets an authentication token in a cookie 
that lets ASP.NET know on subsequent requests that the user has been logged in. 
If <strong><em>persistCookie</em></strong> is false, the token is valid only until the user closes the 
browser.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_login.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_login.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_login.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
