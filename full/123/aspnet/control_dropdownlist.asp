...
<style>a.menu_control_dropdownlist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">DropDownList</span> Control</h1>
<hr>
...
<p>The DropDownList control is used to create a drop-down list.</p>
<p>Each selectable item in a DropDownList control is defined by a ListItem element!</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_dropdownlist_selectedindex.asp">
	SelectedIndex</a></td>
    <td>The index of a selected item</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>OnSelectedIndexChanged</td>
    <td>The name of the function to be executed when the index of the selected item has changed</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>runat</td>
...
<p>For a full description, go to <a href="control_listcontrol.asp">ListControl Standard Attributes.</a></p>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_dropdownlist">DropdownList</a><br>
Declare one DropDownList control in an .aspx file. Then create an event handler for the Click event which displays some text and the selected item, in a Label control.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_dropdownlist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_dropdownlist.asp#top" target="_top">TOP</a> |
		<a href="control_dropdownlist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
