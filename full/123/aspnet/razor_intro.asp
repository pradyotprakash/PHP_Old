...
<title>ASP.NET Razor Markup</title>
<style>a.menu_razor_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Razor <span class="color_h1">- Markup</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_ref_helpers.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="razor_syntax.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Razor is not a programming language. It's a server side markup language. </p>
<hr>
<h2>What is Razor?</h2>
<p>Razor is a markup syntax that 
lets you embed server-based code (Visual Basic and C#) into web pages.</p>
<p>Server-based code can create dynamic web content on the fly, while a web page 
...
but it is easier to use, and easier to learn.<br></p>

<hr>

<h2>Razor Syntax</h2>
<p>Razor uses a syntax very similar to PHP and Classic ASP.</p>

<p>Razor:</p>

<div class="code notranslate"><div>
	&lt;ul&gt;<br>@for (int i = 0; i &lt; 10; i++) {<br>&lt;li&gt;@i&lt;/li&gt;<br>}<br>&lt;/ul&gt;</div></div>

<p>PHP:</p>

<div class="code notranslate"><div>
	&lt;ul&gt;<br>&lt;?php <br>for ($i = 0; $i &lt; 10; $i++) {<br>echo(&quot;&lt;li&gt;$i&lt;/li&gt;&quot;);<br>}
	<br>?&gt;<br>&lt;/ul&gt;</div></div>

<p>Web Forms (and Classic ASP):</p>

<div class="code notranslate"><div>
&lt;ul&gt;<br>&lt;% for (int i = 0; i &lt; 10; i++) { %&gt;<br>&lt;li&gt;&lt;% =i %&gt;&lt;/li&gt;<br>&lt;% } %&gt;<br>
&lt;/ul&gt;&nbsp;
</div></div>
<br>
<hr>
...
Razor code.</p>
<p>You can build your own helpers using Razor syntax, or 
...
<p>Razor supports both C# (C sharp) and VB (Visual Basic).</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_ref_helpers.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="razor_syntax.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="razor_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="razor_intro.asp#top" target="_top">TOP</a> |
		<a href="razor_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
