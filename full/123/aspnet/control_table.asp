...
<title>ASP.NET Table Control</title>
<style>a.menu_control_table{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">Table</span> Control</h1>
<hr>
...
<p>The Table control is used in conjunction with the TableCell control and the TableRow control to create a  table.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_table_backimageurl.asp">BackImageUrl</a></td>
    <td>A URL to an image to use as an background for the table</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_table_caption.asp">Caption</a></td>
    <td>The caption of the table</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_table_captionalign.asp">
	CaptionAlign</a></td>
    <td>The alignment of the caption text</td>
    <td>2.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_table_cellpadding.asp">CellPadding</a></td>
    <td>The space between the cell walls and contents</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_table_cellspacing.asp">CellSpacing</a></td>
    <td>The space between cells</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_table_gridlines.asp">GridLines</a></td>
    <td>The gridline format in the table</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_table_horizontalalign.asp">HorizontalAlign</a></td>
    <td>The horizontal alignment of the table in the page</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>Rows</td>
    <td>A collection of rows in the Table</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>runat</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_table.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_table.asp#top" target="_top">TOP</a> |
		<a href="control_table.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
