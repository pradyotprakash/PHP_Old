...
<title>ASP.NET Button UseSubmitBehavior Property</title>
<style>a.menu_prop_webcontrol_button_usesubmitbehavior{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>Button <span class="color_h1">UseSubmitBehavior</span> Property</h1>
<hr>
<a href="control_button.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Button Control" /> Button Control</a>
<hr>
<h2>Definition and Usage</h2>
<p>The UseSubmitBehavior property specifies if the Button control uses the browser's built-in submit function or the ASP.NET postback mechanism.</p>
<p>This property is set to TRUE if the control uses the browser's submit function. FALSE otherwise. Default value is TRUE.</p>
<p>When set to FALSE, ASP.NET adds a client-side script to post the form. This enables control developers to use the GetPostBackEventReference method to return 
the client postback event for the Button.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
&lt;asp:Button UseSubmitBehavior=&quot;TRUE|FALSE&quot; runat=&quot;server&quot;<i> /&gt;</i>
</div></div>
<br>
<hr>
...
<p>The following example uses the ASP.NET postback mechanism:</p>
<div class="example_code notranslate">
&lt;script runat=&quot;server&quot;&gt;<br>
Sub SubmitBtn(obj As Object, e As EventArgs)<br>
&nbsp;&nbsp;lblMsg.Text = &quot;Submitted using the ASP.NET postback mechanism.&quot;<br>
End Sub<br>
&lt;/script&gt;<br>
<br>
...
Text=&quot;Submit&quot; onclick=&quot;SubmitBtn&quot; <br>
UseSubmitBehavior=&quot;FALSE&quot; /&gt;&lt;br /&gt;<br>
<br>
&lt;asp:label id=&quot;lblMsg&quot; runat=&quot;server&quot;/&gt;<br>
&lt;/form&gt;
</div>
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_button_usesubmitbehavior" class="showbtn">Show example &raquo;</a>
</div>
<br>
<hr>
<a href="control_button.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Button Control" /> Button Control</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_button_usesubmitbehavior.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_button_usesubmitbehavior.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_button_usesubmitbehavior.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
