...
<style>a.menu_aspnet_pages{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- HTML Pages</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_controls.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
&lt;center&gt;<br>
&lt;h2&gt;Hello W3Schools!&lt;/h2&gt;<br>
&lt;/center&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;</div></div>

<p>If you want to try it yourself, save the code in a file called &quot;<b>firstpage.htm</b>&quot;, and create a 
link to the file like this: <a target="_blank" href="firstpage.htm">firstpage.htm</a></p>
<hr>
...
create a link to the file like this: <a target="_blank" href="dynpage.asp">dynpage.asp</a></p>
<hr>
...
create a link to the file like this: <a target="_blank" href="dynpage.aspx">dynpage.aspx</a></p>
<hr>

<h2>ASP.NET vs Classic ASP</h2>
<p>The previous examples didn't demonstrate any differences between ASP.NET and Classic ASP.</p>
<p>As you can see from the two latest examples there are no differences between the two ASP and ASP.NET pages.</p>
<p>In the next chapters you will see how server controls make ASP.NET more powerful than Classic ASP. </p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_controls.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_pages.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_pages.asp#top" target="_top">TOP</a> |
		<a href="aspnet_pages.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
