...
<title>ASP.NET Razor C# Syntax</title>
<style>a.menu_razor_syntax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Razor <span class="color_h1">- C# and VB Code Syntax</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="razor_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="razor_cs_variables.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Razor supports both C# (C sharp) and VB (Visual Basic).</p>
<hr>
...
<div class="example">
<h2 class="example">C# Example</h2>
<div class="example_code notranslate">
&lt;!-- Single statement block --&gt;<br>
<span class="marked">@{ var myMessage =	&quot;Hello World&quot;; }</span><br><br>
...
<br>
<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_001" target="_blank">	Run example &raquo;</a>
</div>
<br>
<hr>
<h2>Main Razor Syntax Rules for VB</h2>
<ul>
	<li>Razor code blocks are enclosed in @Code ... End Code</li>
	<li>Inline expressions (variables and functions) start with @</li>
	<li>Variables are declared with the Dim keyword</li>
	<li>Strings are enclosed with quotation marks</li>
	<li>VB code is not case sensitive</li>
	<li>VB files have the extension .vbhtml</li>
</ul>
...
<div class="example_code notranslate">
&lt;!-- Single statement block &nbsp;--&gt;&nbsp;<br>
<span class="marked">@Code dim myMessage = &quot;Hello World&quot; End Code</span><br>
&nbsp;<br>
&lt;!-- Inline expression or variable --&gt;&nbsp;<br>
...
<br>
<a class="showbtn" href="showfile_vb.asp?filename=try_razor_vb_001" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
<h2>How Does it Work?</h2>
<p>Razor is a simple programming syntax for embedding server code in web pages. </p>
<p>Razor syntax is based on the ASP.NET framework, the part of the Microsoft.NET Framework that's specifically designed for creating web 
applications. &nbsp;</p>
<p>The Razor syntax gives you all the power of ASP.NET, but is using a simplified 
syntax that's easier to learn if you're a beginner, and makes you more 
productive if you're an expert. </p>
<p>Razor web pages can be described as HTML pages with two kinds of content: 
HTML content and Razor code. </p>
<p>When the server reads the page, it runs the Razor code first, before it sends 
...
no different than static HTML content.</p>
<p>ASP.NET web pages with Razor syntax have the special file extension cshtml 
(Razor using C#) or vbhtml (Razor using VB). </p>
<hr>
<h2>Working With Objects</h2>
<p>Server coding often involves objects.<br><br>The &quot;Date&quot; object is a typical 
built-in ASP.NET object, but objects can also be self-defined, a web page, a text box, a file, 
a database record, etc.<br><br>Objects may have methods they can perform. A 
...
and so on.<br><br>Objects 
also have properties that describe their characteristics. A database record 
might have a FirstName and a LastName property (amongst others). </p>
<p>The ASP.NET 
...
access some properties of the Date object:<br></p>
...
<br>
<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_002" target="_blank">	Run example &raquo;</a>
</div>
<br>
<hr>

<h2>If and Else Conditions</h2>
<p>An important feature of dynamic web pages is that you can determine what to 
do based on conditions.</p>
<p>The common way to do this is with the if ... else statements:</p>
...
<br>
<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_003" target="_blank">	Run example &raquo;</a>
</div>
...
<p>Another important feature of dynamic web pages is that you can read user 
input.</p>
<p>Input is read by the Request[] function, and posting (input) is tested by the 
IsPost condition:</p>
...
&lt;/body&gt;<br>&lt;/html&gt;</div>
<br>
<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_004" target="_blank">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="razor_syntax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="razor_syntax.asp#top" target="_top">TOP</a> |
		<a href="razor_syntax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
