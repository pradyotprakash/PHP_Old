...
<style>a.menu_prop_websecurity_currentuserid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity Property - <span class="color_h1">CurrentUserId</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>CurrentUserId</strong> property is the ID (primary key) for the current user in 
...
<div>
WebSecurity.CurrentUserId</div></div>
<br>
<hr>
...
@{<br>
int value;<br>
value=WebSecurity.CurrentUserId;<br>
}<br>
<br>
...
<h2>Remarks</h2>
<p>The <strong>CurrentUserId</strong> property is read only. It cannot be changed by code.</p>
<p>The property is used to identify the user in the <strong>WebSecurity</strong> 
database, both in the user profile table and in 
the membership table.</p>
<hr>

<h2>Errors and Exceptions</h2>
<p>The <strong>CurrentUserId</strong> property returns -1 if there is no current 
user logged in. </p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_websecurity_currentuserid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_websecurity_currentuserid.asp#top" target="_top">TOP</a> |
		<a href="prop_websecurity_currentuserid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
