...
<title>WebSecurity InitializeDatabaseConnection Method</title>
<style>a.menu_met_websecurity_initializedatabaseconnection{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> InitializeDatabaseConnection()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>InitializeDatabaseConnection()</strong> method initializes the WebSecurity database. </p>
<p>The method initializes the 
<strong>WebSecurity</strong> system by connecting to the database that contains user and 
membership information.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.InitializeDatabaseConnection(<em>connectionString, userTableName, 
userIdColumn, userNameColumn, autoCreateTables</em>)</div></div>
<br>
<hr>
...
<td>String</td>
<td>
<p>The name of your <strong>WebSecurity</strong> database (se remarks)</p>
	</td>
</tr>
<tr>
<td><em>userTableName</em></td>
<td>String</td>
<td>The database <strong>table</strong> that contains the user profile information</td>
</tr>
<tr>
<td><em>userIdColumn</em></td>
<td>String</td>
<td>The database <strong>column</strong> that contains the user IDs (primary keys)</td>
</tr>
<tr>
<td><em>userNameColumn</em></td>
<td>String</td>
<td>The database <strong>column</strong> that contains the user names</td>
</tr>
<tr>
<td><em>autoCreateTables</em></td>
<td>Boolean</td>
<td> <strong>true</strong> indicates that 
...
<h2>Remarks</h2>
<p>If you are using SQL Server Compact, <em><strong>connectionString</strong></em> 
should be the name of the WebSecurity database (without the .sdf file name 
extension). Otherwise it should be the name of a connection string in the web 
configuration (web.config file).</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>
&nbsp;Even if <strong><em>autoCreateTables</em></strong> can force the database <strong>tables</strong> 
to be created automatically, the 
<strong>database</strong> itself 
must always exist.
</td>
</tr></table>
<br>
...
<p>The <strong>InitializeDatabaseConnection()</strong> method throws an <strong>InvalidOperationException</strong> if:</p>
<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_initializedatabaseconnection.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_initializedatabaseconnection.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_initializedatabaseconnection.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
