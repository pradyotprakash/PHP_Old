...
<head>
<title>ASP.NET MVC Security</title>
<style>a.menu_mvc_security{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">- Security</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_models.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_htmlhelpers.asp">Next Chapter &raquo;</a></div>
</div>

<hr>
<p class="intro">To learn ASP.NET MVC, we are Building an Internet Application.</p>
<p class="intro">Part VIII: Adding Security.</p>

<hr>

<h2>MVC Application Security</h2>
...
file that contains the models for application authentication. </p>
...
<p><img alt="Model" src="10.jpg" width="632px" height="336px" ></p>

<hr>
<h2>The Change Password Model</h2>
<div class="code notranslate">
	<div>public class ChangePasswordModel<br>{<br><br>[Required]<br>[DataType(DataType.Password)]<br>
		[Display(Name = &quot;Current password&quot;)]<br>public string OldPassword { get; 
		set; }<br><br>[Required]<br>[StringLength(100, ErrorMessage = &quot;The {0} 
		must be at least {2}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; characters long.&quot;, 
		MinimumLength = 6)]<br>[DataType(DataType.Password)]<br>[Display(Name = 
		&quot;New password&quot;)]<br>public string NewPassword { get; set; }<br><br>[DataType(DataType.Password)]<br>
		[Display(Name = &quot;Confirm new password&quot;)]<br>[Compare(&quot;NewPassword&quot;, 
		ErrorMessage = &quot;The new password and confirmation password do not 
		match.&quot;)]<br>public string ConfirmPassword { get; set; }<br><br>}<br></div>
</div>
<br>
<hr>
<h2>The Logon Model</h2>
<div class="code notranslate">
	<div>public class LogOnModel<br>{<br><br>[Required]<br>[Display(Name = &quot;User 
		name&quot;)]<br>public string UserName { get; set; }<br><br>[Required]<br>[DataType(DataType.Password)]<br>
		[Display(Name = &quot;Password&quot;)]<br>public string Password { get; set; }<br>
		<br>[Display(Name = &quot;Remember me?&quot;)]<br>public bool RememberMe { get; 
		set; }<br><br>}</div>
</div>
<br>
<hr>
<h2>The Register Model</h2>
<div class="code notranslate">
	<div>public class RegisterModel<br>{<br><br>[Required]<br>[Display(Name = 
		&quot;User name&quot;)]<br>public string UserName { get; set; }<br><br>[Required]<br>
		[DataType(DataType.EmailAddress)]<br>[Display(Name = &quot;Email address&quot;)]<br>
		public string Email { get; set; }<br><br>[Required]<br>[StringLength(100, 
		ErrorMessage = &quot;The {0} must be at least {2} characters long.&quot;, 
		MinimumLength = 6)]<br>[DataType(DataType.Password)]<br>[Display(Name = 
		&quot;Password&quot;)]<br>public string Password { get; set; }<br><br>[DataType(DataType.Password)]<br>
		[Display(Name = &quot;Confirm password&quot;)]<br>[Compare(&quot;Password&quot;, 
		ErrorMessage = &quot;The password and confirmation password do not match.&quot;)]<br>
		public string ConfirmPassword { get; set; }<br><br>}<br></div>
</div>
<br>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_security.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_security.asp#top" target="_top">TOP</a> |
		<a href="mvc_security.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
