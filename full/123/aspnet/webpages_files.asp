...
<title>ASP.NET Web Pages Files</title>
<style>a.menu_webpages_files{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Files</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_objects.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_database.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">This chapter is about working with text files.</p>
<hr>
<h2>Working with Text Files</h2>
<p>In a previous chapter, we looked at web data stored in a database.</p>
<p>Your web site may also have data stored in text files.</p>
<p>Text files used to store data is often called flat files. Common text file 
formats are .txt, .xml, and .csv (comma-delimited values). </p>
<p><strong>In this chapter you will learn:</strong></p>
<ul>
	<li>How to read and display data from a text file</li>
</ul>
<hr>
<h2>Add a Text File Manually</h2>
<p>In the example to follow, you will need a text file to work with.</p>
<p>On your web site, if you don't have an App_Data folder, create one. 
In the App_Data folder, create a new file named Persons.txt.</p>
...
<p>The example below shows how to display data from a text file: &nbsp;</p>
...
<div class="example_code notranslate">
	...
	html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;h1&gt;Reading Data from a File&lt;/h1&gt;<br>
...
<br>
<a target="_blank" href="showfile_c.asp?filename=try_webpages_cs_019" class="showbtn">Run example &raquo;</a>
</div>

<h2>Example explained</h2>
<p><strong>Server.MapPath</strong> finds the exact text file path.</p>
<p><strong>File.ReadAllLines</strong> opens the text file and reads all lines 
from the file into an array.</p>
<p>For each <strong>dataItem</strong> in each <strong>dataline</strong> of the 
array the data is displayed.</p>
<hr>
<h2>Displaying Data from an Excel File</h2>
<p>With Microsoft Excel, you can save a spreadsheet as a comma separeted text 
file (.csv file). When you do so, each row in the spreadsheet is saved as a text 
line, and each data column is separated by a comma. </p>
<p>You can use the example above to read an Excel .csv file (just change the 
file name to the name of the Excel file).</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_files.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_files.asp#top" target="_top">TOP</a> |
		<a href="webpages_files.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
