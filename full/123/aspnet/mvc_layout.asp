...
<head>
<title>ASP.NET MVC Pages and Layout</title>
<style>a.menu_mvc_layout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">- Styles and Layout</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_folders.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_controllers.asp">Next Chapter &raquo;</a></div>
</div>
<br>

<hr>
<p class="intro">To learn ASP.NET MVC, we are Building an Internet Application.</p>
<p class="intro">Part III: Adding Styles and a Consistent Look (Layout).</p>

<hr>

<h2>Adding a Layout</h2>
<p>The file _Layout.cshtml represent the layout of each page in the application. It is located in the 
Shared folder inside the Views folder.</p>
<p>Open the file and swap the content with this:</p>

<div class="code notranslate"><div>
&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>&lt;meta charset=&quot;utf-8&quot; /&gt;<br>
&lt;title&gt;<span class="marked">@ViewBag.Title</span>&lt;/title&gt;<br>&lt;link href=&quot;<span class="marked">@Url.Content(&quot;~/Content/Site.css&quot;)</span>&quot; rel=&quot;stylesheet&quot; type=&quot;text/css&quot; /&gt;<br>&lt;script src=&quot;<span class="marked">@Url.Content(&quot;~/Scripts/jquery-1.5.1.min.js&quot;)</span>&quot;&gt;&lt;/script&gt;<br>&lt;script src=&quot;<span class="marked">@Url.Content(&quot;~/Scripts/modernizr-1.7.min.js&quot;)</span>&quot;&gt;&lt;/script&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br>&lt;ul id=&quot;menu&quot;&gt;<br>
&lt;li&gt;<span class="marked">@Html.ActionLink(&quot;Home&quot;, &quot;Index&quot;, &quot;Home&quot;)</span>&lt;/li&gt;<br>&lt;li&gt;<span class="marked">@Html.ActionLink(&quot;Movies&quot;, 
&quot;Index&quot;, &quot;Movies&quot;)</span>&lt;/li&gt;<br>&lt;li&gt;<span class="marked">@Html.ActionLink(&quot;About&quot;, &quot;About&quot;, 
&quot;Home&quot;)</span>&lt;/li&gt;<br>&lt;/ul&gt; <br>&lt;section id=&quot;main&quot;&gt;<br>
	<span class="marked">@RenderBody()</span><br>
&lt;p&gt;Copyright W3schools 2012. All Rights Reserved.&lt;/p&gt;<br>&lt;/section&gt;<br>&lt;/body&gt;<br>&lt;/html&gt;</div></div>

<hr>

<h2>HTML Helpers</h2>
<p>In the code above, HTML helpers are used to modify HTML output:</p>
<p>@Url.Content() - URL content will be inserted here.</p>
<p>@Html.ActionLink() - HTML link will be inserted here.</p>
<p>You will learn more about HTML helpers in a later chapter of this tutorial.</p>

<hr>

<h2>Razor Syntax</h2>
<p>In the code above, the code marked red are C# using Razor markup. </p>
<p>@ViewBag.Title - The page title will be inserted here. </p>
<p>@RenderBody() - The page content will be rendered here. </p>
<p>You can learn about Razor markup for both C# and VB (Visual Basic) in our <a href="razor_intro.asp">Razor tutorial</a>. </p>

<hr>

<h2>Adding Styles</h2>
<p>The style sheet for the application is called Site.css. It is located in the 
Content folder.</p>
<p>Open the file Site.css and swap the content with this:</p>

<div class="code notranslate"><div>
body<br>{<br>font: &quot;Trebuchet MS&quot;, Verdana, sans-serif;<br>background-color: 
#5c87b2;<br>color: #696969;<br>}<br>h1<br>{<br>border-bottom: 3px solid 
#cc9900;<br>font: Georgia, serif;<br>color: #996600;<br>}<br>#main<br>{<br>
padding: 20px;<br>background-color: #ffffff;<br>border-radius: 0 4px 4px 
4px;<br>}<br>a<br>{<br>color: #034af3; <br>}<br>/* Menu Styles 
------------------------------*/ <br>ul#menu<br>{<br>padding: 0px;<br>
position: relative;<br>margin: 0;<br>}<br>ul#menu li<br>{<br>display: 
inline;<br>}<br>ul#menu li a <br>{<br>background-color: #e8eef4;<br>padding: 
10px 20px;<br>text-decoration: none;<br>line-height: 2.8em;<br>/*CSS3 
properties*/<br>border-radius: 4px 4px 0 0;<br>}<br>ul#menu li a:hover<br>{<br>
background-color: #ffffff;<br>} <br>/* Forms Styles 
------------------------------*/ <br>fieldset<br>{<br>padding-left: 12px;<br>
} <br>fieldset label<br>{<br>display: block;<br>padding: 4px;<br>}<br>
input[type=&quot;text&quot;], input[type=&quot;password&quot;]<br>{<br>width: 300px;<br>}<br>
input[type=&quot;submit&quot;]<br>{<br>padding: 4px;<br>}<br>/* Data Styles 
------------------------------*/ <br>table.data<br>{<br>background-color:#ffffff;<br>
border:1px solid #c3c3c3;<br>border-collapse:collapse;<br>width:100%;<br>}<br>
table.data th<br>{<br>background-color:#e8eef4;<br>border:1px solid #c3c3c3;<br>
padding:3px;<br>}<br>table.data td <br>{<br>border:1px solid #c3c3c3;<br>
padding:3px;<br>}
</div></div>
<br>
<hr>

<h2>The _ViewStart File</h2>
<p>The _ViewStart file in the Shared folder (inside the Views folder) contains 
the following content:</p>

<div class="code notranslate"><div>
@{Layout = &quot;~/Views/Shared/_Layout.cshtml&quot;;}</div></div>
<p>This code is automatically added to all views displayed by the application. </p>
<p>If you remove this file, you must add this line to all   
views. </p>
<p>You will learn more about views in a later chapter of this tutorial.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_layout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_layout.asp#top" target="_top">TOP</a> |
		<a href="mvc_layout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
