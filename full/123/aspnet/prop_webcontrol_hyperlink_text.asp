...
<style>a.menu_prop_webcontrol_hyperlink_text{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The Text property is used to set or return the text of a HyperLink control.</p>
<h2>Syntax</h2>
...
&nbsp;<table class="reference notranslate">
  <tr>
	...
	<tr>
		<td>string</td>
		<td>A string that specifies the text on the hyperlink control</td>
	</tr>
</table>
<br>
<hr>
...
<p>The following example sets the text on a HyperLink control:</p>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_hyperlink_text" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_hyperlink_text.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_hyperlink_text.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_hyperlink_text.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
