...
<head>
<title>ASP.NET MVC HTML Helpers</title>
<style>a.menu_mvc_htmlhelpers{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">- HTML Helpers</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_security.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_publish.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">HTML Helpers are used to modify HTML output</p>

<hr>

<h2>HTML Helpers</h2>
<p>With MVC, HTML helpers are much like traditional ASP.NET Web Form controls. </p>
<p>Just like web form controls in ASP.NET, HTML helpers are used to modify HTML. 
But HTML helpers are more lightweight. Unlike Web Form controls, an HTML helper 
does not have an event model and a view state.</p>
<p>In most cases, an HTML helper is just a method that returns a string.</p>
<p>With MVC, you can create your own helpers, or use the built in HTML helpers.</p>

<hr>

<h2>Standard HTML Helpers</h2>
<p>MVC includes standard helpers for the most common types of HTML 
elements, like HTML links and HTML form elements.</p>

<hr>

<h2>HTML Links</h2>
<p>The easiest way to render an HTML link in is to use the HTML.ActionLink() 
helper. </p>
<p>With MVC, the Html.ActionLink() does not link to a view. It creates a link to 
a controller action.</p>
<p>Razor Syntax:</p>
<div class="code notranslate">
<div>@Html.ActionLink(&quot;About this Website&quot;, &quot;About&quot;)</div>
</div>
<p>ASP Syntax:</p>
<div class="code notranslate">
<div>&lt;%=Html.ActionLink(&quot;About this Website&quot;, &quot;About&quot;)%&gt;</div>
</div>
<p>The first parameter is the link text, and the second parameter is the name of 
the controller action.</p>
<p>The Html.ActionLink() helper above, outputs the following HTML:</p>
<div class="code notranslate">
<div>&lt;a href=&quot;/Home/About&quot;&gt;About this Website&lt;/a&gt;</div>
</div>
<p>The Html.ActionLink() helper as several properties:</p>
<table class="reference notranslate">
<tr><th>Property</th><th>Description</th></tr>
<tr><td>.linkText</td><td>The link text (label)</td></tr>
<tr><td>.actionName</td><td>The target action</td></tr>
<tr><td>.routeValues</td><td>The values passed to the action</td></tr>
<tr><td>.controllerName</td><td>The target controller</td></tr>
<tr><td>.htmlAttributes</td><td>The set of attributes to the link</td></tr>
<tr><td>.protocol</td><td>The link protocol</td></tr>
<tr><td>.hostname</td><td>The host name for the link</td></tr>
<tr><td>.fragment</td><td>The anchor target for the link</td></tr>
</table>
<p><strong>Note:</strong> You can pass values to a controller action. For 
example, you can pass the id of a database record to a database edit action:</p>
<p>Razor Syntax C#:</p>
<div class="code notranslate">
<div>@Html.ActionLink(&quot;Edit Record&quot;, &quot;Edit&quot;, new {Id=3})</div>
</div>
<p>Razor Syntax VB:</p>
<div class="code notranslate">
<div>@Html.ActionLink(&quot;Edit Record&quot;, &quot;Edit&quot;, New With{.Id=3})</div>
</div>
<p>The Html.ActionLink() helper above, outputs the following HTML:</p>
<div class="code notranslate">
<div>&lt;a href=&quot;/Home/Edit/3&quot;&gt;Edit Record&lt;/a&gt;</div>
</div>

<hr>

<h2>HTML Form Elements</h2>
<p>There following HTML helpers can be used to render (modify and output) HTML 
form elements:</p>
<ul>
	<li>BeginForm()</li>
	<li>EndForm()</li>
...
<p>ASP.NET Syntax C#:</p>
<div class="code notranslate">
<div>&lt;%= Html.ValidationSummary(&quot;Create was unsuccessful. Please correct the 
	errors and try again.&quot;) %&gt;<br>&lt;% using (Html.BeginForm()){%&gt;<br>&lt;p&gt;<br>
	&lt;label for=&quot;FirstName&quot;&gt;First Name:&lt;/label&gt;<br>&lt;%= Html.TextBox(&quot;FirstName&quot;) 
	%&gt;<br>&lt;%= Html.ValidationMessage(&quot;FirstName&quot;, &quot;*&quot;) %&gt;<br>&lt;/p&gt;<br>&lt;p&gt;<br>
	&lt;label for=&quot;LastName&quot;&gt;Last Name:&lt;/label&gt;<br>&lt;%= Html.TextBox(&quot;LastName&quot;) %&gt;<br>
	&lt;%= Html.ValidationMessage(&quot;LastName&quot;, &quot;*&quot;) %&gt;<br>&lt;/p&gt;<br>&lt;p&gt;<br>&lt;label 
	for=&quot;Password&quot;&gt;Password:&lt;/label&gt;<br>&lt;%= Html.Password(&quot;Password&quot;) %&gt;<br>&lt;%= 
	Html.ValidationMessage(&quot;Password&quot;, &quot;*&quot;) %&gt;<br>&lt;/p&gt;<br>&lt;p&gt;<br>&lt;label 
	for=&quot;Password&quot;&gt;Confirm Password:&lt;/label&gt;<br>&lt;%= Html.Password(&quot;ConfirmPassword&quot;) 
	%&gt;<br>&lt;%= Html.ValidationMessage(&quot;ConfirmPassword&quot;, &quot;*&quot;) %&gt;<br>&lt;/p&gt;<br>&lt;p&gt;<br>
	&lt;label for=&quot;Profile&quot;&gt;Profile:&lt;/label&gt;<br>&lt;%= Html.TextArea(&quot;Profile&quot;, new 
	{cols=60, rows=10})%&gt;<br>&lt;/p&gt;<br>&lt;p&gt;<br>&lt;%= Html.CheckBox(&quot;ReceiveNewsletter&quot;) 
	%&gt;<br>&lt;label for=&quot;ReceiveNewsletter&quot; style=&quot;display:inline&quot;&gt;Receive 
	Newsletter?&lt;/label&gt;<br>&lt;/p&gt;<br>&lt;p&gt;<br>&lt;input type=&quot;submit&quot; value=&quot;Register&quot; 
	/&gt;<br>&lt;/p&gt;<br>&lt;%}%&gt;<br></div>
</div>
<br><br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_htmlhelpers.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_htmlhelpers.asp#top" target="_top">TOP</a> |
		<a href="mvc_htmlhelpers.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
