...
<style>a.menu_control_radiobuttonlist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">RadioButtonList</span> Control</h1>
<hr>
...
<p>The RadioButtonList control is used to create a group of radio buttons.</p>
<p>Each selectable item in a RadioButtonList control is defined by a ListItem element!</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_radiobuttonlist_cellpadding.asp">CellPadding</a></td>
    <td>The amount of pixels between the border and the contents of the table cell</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_radiobuttonlist_cellspacing.asp">CellSpacing</a></td>
    <td>The amount of pixels between table cells</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td>
	<a href="prop_webcontrol_radiobuttonlist_repeatcolumns.asp">RepeatColumns</a></td>
    <td>The number of columns to use when displaying the radio 
	button group</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td>
	<a href="prop_webcontrol_radiobuttonlist_repeatdirection.asp">RepeatDirection</a></td>
    <td>Specifies whether the radio button group should be repeated 
	horizontally or vertically</td>
    <td>1.0</td>
  </tr>
	<tr>
    <td><a href="prop_webcontrol_radiobuttonlist_repeatlayout.asp">RepeatLayout</a></td>
    <td>The layout of the radio button group</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td><a href="prop_webcontrol_radiobuttonlist_textalign.asp">TextAlign</a></td>
    <td>On which side of the radio button the text should appear</td>
    <td>1.0</td>
  </tr>
  </table>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_radiobuttonlist">RadiobuttonList</a><br>
Declare one RadioButtonList control, one Button control, and one Label control in an .aspx file. Then we 
create an event handler for the Click event which displays some text and the selected item, in a Label control.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_radiobuttonlist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_radiobuttonlist.asp#top" target="_top">TOP</a> |
		<a href="control_radiobuttonlist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
