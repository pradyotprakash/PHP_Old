...
<style>a.menu_aspnet_forms{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- HTML Forms</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_events.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_viewstate.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><b>Note:</b> An .aspx page can only contain ONE &lt;form runat=&quot;server&quot;&gt; control!</p>

<p>If you select view source in an .aspx page containing a form with no name, 
...
&lt;form name=&quot;_ctl0&quot; method=&quot;post&quot; action=&quot;page.aspx&quot; id=&quot;_ctl0&quot;&gt;<br><br>
...some code<br><br>
&lt;/form&gt;</div></div>
<br>
<hr>
...
<p>A form is most often submitted by clicking on a button. The Button server control in ASP.NET has the following format:</p>

<div class="code notranslate"><div>
&lt;asp:Button id=&quot;id&quot; text=&quot;label&quot; OnClick=&quot;sub&quot; runat=&quot;server&quot; /&gt;</div></div>

<p>The id attribute defines a unique name for the button and the text attribute assigns a label 
to the button. The onClick event handler specifies a named subroutine to execute.</p>

<p>In the following example we declare a Button control in an .aspx file. A button click runs a subroutine which changes the text on the button:</p>
<p><a target="_blank" href="showaspx.asp?filename=demo_button">Example</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_events.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_viewstate.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_forms.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_forms.asp#top" target="_top">TOP</a> |
		<a href="aspnet_forms.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
