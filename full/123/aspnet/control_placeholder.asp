...
<title>ASP.NET PlaceHolder Control</title>
<style>a.menu_control_placeholder{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">PlaceHolder</span> Control</h1>
<hr>
...
<p>The PlaceHolder control is used to reserve space for controls added by code.</p>
<p><b>Note:</b> The PlaceHolder control does not produce any visible output (it only acts as a container for other controls on the Web page).</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_placeholder.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_placeholder.asp#top" target="_top">TOP</a> |
		<a href="control_placeholder.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
