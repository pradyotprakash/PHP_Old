...
<title>WebSecurity CurrentUserId Property</title>
<style>a.menu_prop_websecurity_hasuserid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity Property -<span class="color_h1"> HasUserId</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>HasUserId</strong> property is a boolean value that indicates whether the current user has a user ID in 
the <strong>WebSecurity</strong> database.</p>
<p>The property value is a boolean <strong>true</strong> if the current user has a user 
ID. The default is <strong>false</strong>.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate">
<div>
WebSecurity.HasUserId</div></div>
<br>
<hr>
...
@{<br>bool value;<br>value=WebSecurity.HasUserId;<br>}<br>&lt;p&gt;It is @value 
...
value=WebSecurity.HasUserId<br>
End Code<br>
<br>
...
<h2>Remarks</h2>
<p>The <strong>HasUserID</strong> property is read only. It cannot be changed by code.</p>

<p>The <strong>HasUserId</strong> property only verifies that the user has an ID in the 
<strong>WebSecurity</strong> database. It 
does not verify that the user account is valid (confirmed), or that the user is logged in. </p>
<p>Use the <strong>IsConfirmed()</strong> method to verify that the user is confirmed.</p>
<p>Use <strong>IsAuthenticated</strong> property to verify that the user is logged in.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_websecurity_hasuserid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_websecurity_hasuserid.asp#top" target="_top">TOP</a> |
		<a href="prop_websecurity_hasuserid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
