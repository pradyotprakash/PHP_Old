...
<title>WebSecurity IsCurrentUser Method</title>
<style>a.menu_met_websecurity_iscurrentuser{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> IsCurrentUser()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>IsCurrentUser()</strong> method compares a provided username with the logged in user's username.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate">
<div>
WebSecurity.IsCurrentUser(<em>userName</em>)</div></div>
<br>
<hr>
...
<td>String</td>
<td>The user name to compare</td>
</tr>
</table>
<br>
<hr>
...
<tr>
<td>Boolean</td>
<td><strong>true</strong> if the <strong><em>userName</em></strong> parameter matches the 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_iscurrentuser.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_iscurrentuser.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_iscurrentuser.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
