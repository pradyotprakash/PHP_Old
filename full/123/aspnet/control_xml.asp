...
<style>a.menu_control_xml{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">XML</span> Control</h1>
<hr>
...
<p>The XML control is used to display an XML document or the results of an XSL Transform.</p>
<p><b>Note:</b> At least one of the XML Document properties must be set or no XML document is displayed.</p>
<p>You can also specify an XSLT document that will format the XML document before it is written to the output. You can format the XML 
document with the Transform property or the TransformSource property.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>Document</td>
    <td>Deprecated. Specifies an XML document using a System.Xml.XmlDocument 
    object</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>DocumentContent</td>
    <td>Specifies an XML string</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_xml_documentsource.asp">DocumentSource</a></td>
    <td>Specifies a path to an XML file to display</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>EnableTheming</td>
  ...
  <tr>
    <td>Transform</td>
    <td>Formats the XML document using a 
    System.Xml.Xsl.XslTransform object</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>TransformArgumentList</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
	<tr>
    <td>TransformSource</td>
    <td>Specifies a path to an XSL Transform file</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_xml">XML</a><br>
How to use the Xml control to display the result of an XSL Transform.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_xml.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_xml.asp#top" target="_top">TOP</a> |
		<a href="control_xml.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
