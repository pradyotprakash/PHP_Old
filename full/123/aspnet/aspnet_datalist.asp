...
<style>a.menu_aspnet_datalist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- The DataList Control</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_repeater.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_dbconnection.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
the control. However, the DataList control adds a table around the data items by default.</p>
<hr>
...
the control. However, the DataList control adds a table around the data items by default. The DataList control may be bound to a database table,
an XML file, or another list of items. Here we will show how to bind an XML file to a DataList control.</p>
...
gridlines=&quot;both&quot; runat=&quot;server&quot;&gt;<br>
<br>
&lt;HeaderTemplate&gt;<br>
My CD Catalog<br>
&lt;/HeaderTemplate&gt;<br>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_datalist1" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
footerstyle-font-italic=&quot;true&quot;&gt;<br>
<br>
&lt;HeaderTemplate&gt;<br>
My CD Catalog<br>
&lt;/HeaderTemplate&gt;<br>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_datalist2" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_datalist3" class="showbtn">Show example &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_repeater.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_datalist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_datalist.asp#top" target="_top">TOP</a> |
		<a href="aspnet_datalist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
