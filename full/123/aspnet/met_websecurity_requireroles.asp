...
<title>WebSecurity RequireRoles Method</title>
<style>a.menu_met_websecurity_requireroles{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>WebSecurity -<span class="color_h1"> RequireRoles()</span></h1>
<hr>
...
<h2>Definition</h2>
<p>The <strong>RequireRoles()</strong> method sets the HTTP status to 401 (Unauthorized) if the current user is not in all 
of the specified roles.</p>
<hr>

<h2>C# and VB Syntax</h2>
<div class="code notranslate"><div>
WebSecurity.RequireRoles(roles)</div></div>
<br>
<hr>
...
WebSecurity.RequireRoles(&quot;Admin&quot;, &quot;Poweruser&quot;);</div>
</div>
<br>
<div class="example">
...
<td><em>roles</em></td>
<td>String</td>
<td>A comma separated list of roles the current user must be in.</td>
</tr>
</table>
<br>
<hr>
...
<h2>Remarks</h2>
<p><strong>RequireRoles()</strong> validates that the current user is a member of 
<strong>all</strong> of the specified roles. If the user is not a member of <strong>all</strong> 
of the specified roles, the HTTP status is set to 401 (Unauthorized).</p>
<p>To validate that the user is authenticated, use the <strong>
RequireAuthenticatedUser()</strong> method. </p>
<p>To validate that the current user is a 
specific user, use the <strong>RequireUser()</strong> method.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="met_websecurity_requireroles.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="met_websecurity_requireroles.asp#top" target="_top">TOP</a> |
		<a href="met_websecurity_requireroles.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
