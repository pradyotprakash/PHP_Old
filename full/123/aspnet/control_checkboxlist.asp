...
<title>ASP.NET CheckBoxList Control</title>
<style>a.menu_control_checkboxlist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">CheckBoxList</span> Control</h1>
<hr>
...
<p>The CheckBoxList control is used to create a multi-selection check box group.</p>
<p>Each selectable item in a CheckBoxList control is defined by a ListItem element!</p>
<p><b>Tip:</b> This control supports data binding!</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_checkboxlist_cellpadding.asp">CellPadding</a></td>
    <td>The amount of pixels between the border and the contents of the table cell</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_checkboxlist_cellspacing.asp">CellSpacing</a></td>
    <td>The amount of pixels between table cells</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_checkboxlist_repeatcolumns.asp">RepeatColumns</a></td>
    <td>The number of columns to use when displaying the check box group</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_checkboxlist_repeatdirection.asp">RepeatDirection</a></td>
    <td>Specifies whether the check box group should be repeated horizontally or vertically</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td><a href="prop_webcontrol_checkboxlist_repeatlayout.asp">RepeatLayout</a></td>
    <td>The layout of the check box group</td>
    <td>1.0</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td><a href="prop_webcontrol_checkboxlist_textalign.asp">TextAlign</a></td>
    <td>On which side of the check box the text should appear</td>
    <td>1.0</td>
  </tr>
  </table>

<h2>ListControl Standard Properties</h2>
...
<p>The ListControl control covers all the base functions for list controls. 
Controls that inherits from this control include the CheckBoxList, DropDownList, 
ListBox, and RadioButtonList controls.</p>
<p>For a full description, go to <a href="control_listcontrol.asp">ListControl 
Standard Attributes.</a></p>
...
<p>For a full description, go to <a href="prop_control_standard.asp">Control 
Standard Attributes</a>.</p>
<hr>

<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_checkboxlist">CheckBoxList</a><br>
Declare one CheckBoxList control in an .aspx file. Then we create an event handler for the SelectedIndexChanged event. The 
selectable list contains six check boxes. When a user checks one of the boxes, the page is immediately posted back to the server, and the Check subroutine is 
executed. The subroutine loops through the control's Items collection and tests each item's Selected property. The selected items are then displayed in the Label control.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_checkboxlist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_checkboxlist.asp#top" target="_top">TOP</a> |
		<a href="control_checkboxlist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
