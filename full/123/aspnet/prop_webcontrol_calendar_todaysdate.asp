...
<title>ASP.NET TodaysDate Property</title>
<style>a.menu_prop_webcontrol_calendar_todaysdate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">TodaysDate</span> Property</h1>
<hr>
...
<p>The TodaysDate property is used to get or set the current date from a calendar.</p>
<p>If this property is not set, this date will be the date on the server.<br>
</p>
<hr>
<div class="example">
<h2 class="example">Example</h2>
<p>The following example shows a outputs today's date:</p>
<div class="example_code notranslate">
&lt;script language=&quot;VB&quot; runat=&quot;server&quot;&gt;<br>
Sub Page_Load<br>
&nbsp;&nbsp;Response.Write(&quot;Today is: &quot;)<br>
&nbsp;&nbsp;Response.Write(cal1.TodaysDate.ToShortDateString())<br>
End Sub<br>
&lt;/script&gt;<br>
<br>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_prop_webcontrol_calendar_todaysdate" class="showbtn">Show example &raquo;</a>
</div>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="prop_webcontrol_calendar_todaysdate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="prop_webcontrol_calendar_todaysdate.asp#top" target="_top">TOP</a> |
		<a href="prop_webcontrol_calendar_todaysdate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
