...
<style>a.menu_control_literal{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">Literal</span> Control</h1>
<hr>
...
<p>The Literal control is used to display text on a page. The text is programmable.</p>
<p><b>Note:</b></b> This control does not let you apply styles to its content!</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="prop_webcontrol_literal_text.asp">Text</a></td>
    <td>Specifies the text to display</td>
    <td>1.0</td>
  </tr>
</table>
...
<h2>Examples</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_literal">Literal</a><br>
Declare one Literal control which displays some static text in an .aspx file.</p>

<p><a target="_blank" href="showaspx.asp?filename=demo_literal2">Literal 2</a><br>
Declare one Literal control and one Button control in an .aspx file. When the user clicks on the 
button, the submit subroutine is executed. The subroutine changes the text of the Literal control.</p>
<hr>
<a href="aspnet_refwebcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="Web Server Controls" /> Web Server Controls</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_literal.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_literal.asp#top" target="_top">TOP</a> |
		<a href="control_literal.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
