...
<title>ASP.NET Web Pages Email</title>
<style>a.menu_webpages_email{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- The WebMail Helper</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_chart.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_php.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The WebMail Helper - One of many useful ASP.NET Web Helpers.</p>
<hr>

<h2>The WebMail Helper</h2>
<p>The WebMail Helper makes it easy to send an email from a web application 
using SMTP (Simple Mail transfer Protocol).</p>
...
called _AppStart.cshtml with the following content:</p>
...
WebMail properties to your AppStart page:</p>
...
<p><strong>SmtpServer:</strong> The name the SMTP server that will be used to 
send the emails.</p>
<p><strong>SmtpPort:</strong> The port the server will use to send SMTP 
transactions (emails).</p>
<p><strong>EnableSsl:</strong> True, if the server should use SSL (Secure Socket 
Layer) encryption.</p>
<p><strong>UserName:</strong> The name of the SMTP email account used to send 
the email.</p>
<p><strong>Password:</strong> The password of the SMTP email account.</p>
<p><strong>From:</strong> The email to appear in the from address (often the 
same as UserName).</p>
<hr>
...
<p>
Then create an input page, and name it Email_Input:</p>
<div class="example">
...
<p>The purpose of the input page is to collect information, then 
submit the data to a new page that can send the information as an email.</p>
<hr>

<h2>
Third: Create An Email Send Page</h2>
<p>
Then create the page that will be used to send the email, and name it Email_Send:</p>
...
<p>For more information about sending emails from a ASP.NET Web Pages application, please see 
the: <a href="webpages_ref_webmail.asp">WebMail Object Reference</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_chart.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_php.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_email.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_email.asp#top" target="_top">TOP</a> |
		<a href="webpages_email.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
