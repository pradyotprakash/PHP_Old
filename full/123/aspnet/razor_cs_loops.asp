...
<title>ASP.NET Razor C# Loops and Arrays</title>
<style>a.menu_razor_cs_loops{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Razor <span class="color_h1">- C# Loops and Arrays</span></h1>

<div class="chapter">
<div class="prev"><a class="chapter" href="razor_cs_variables.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="razor_cs_logic.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Statements can be executed repeatedly in loops.</p>
<hr>

<h2>For Loops</h2>
<p>If you need to run the same statements repeatedly, you can program a loop.</p>
<p>If you know how many times you want to loop, you can use a <strong>for loop</strong>. This 
kind of loop is especially useful for counting up or counting down:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;html&gt;<br>&lt;body&gt;<br><span class="marked">@for(var i = 10; i &lt; 21; i++)<br>&nbsp;&nbsp;&nbsp; {&lt;p&gt;Line @i&lt;/p&gt;}<br></span>&lt;/body><br>&lt;/html>
</div>
<br>
<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_005" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
...
<p>If you work with a collection or an array, you often use a <strong>for each loop</strong>.</p>
<p>A collection is a group of similar objects, and the for each loop lets 
you carry out a task on each item. The for each loop walks through a 
collection until it is finished.</p>
<p>The example below walks through the ASP.NET Request.ServerVariables 
collection.</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;html&gt;<br>&lt;body&gt;<br>&lt;ul&gt;<br><span class="marked">@foreach (var x in 
Request.ServerVariables)<br>&nbsp;&nbsp;&nbsp; {&lt;li&gt;@x&lt;/li&gt;}<br></span>&lt;/ul&gt;<br>
&lt;/body&gt;<br>&lt;/html&gt;</div>
<br>
<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_006" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
...
<p>The <strong>while loop</strong> is a general purpose loop. </p>
<p>A while loop begins with the while keyword, followed by parentheses, where you 
specify how long the loop continues, then a block to repeat.</p>
<p>While loops typically add to, or subtract from, a 
variable used for counting.</p>
<p>In the example below, the += operator adds 1 to the variable i, each time the 
loop runs.</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;html&gt;<br>&lt;body&gt;<br><span class="marked">@{<br>var i = 0;<br>while (i &lt; 5)<br>&nbsp;&nbsp;&nbsp; 
{<br>&nbsp;&nbsp;&nbsp; i += 1;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Line @i&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; 
}<br>}</span><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<br>
<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_007" target="_blank">Run example &raquo;</a>
</div>
<br>
<hr>
...
<p>An array is useful when you want to store similar variables but don't want to 
create a separate variable for each of them:</p>
...
<div class="example_code notranslate">
	...
	members.Length;<br>string x = members[2-1];<br>}<br></span>&lt;html&gt;<br>&lt;body&gt;<br>&lt;h3&gt;Members&lt;/h3&gt;<br>
	<span class="marked">@foreach (var person in 
	members)<br>{<br>&lt;p&gt;@person&lt;/p&gt;<br>}</span><br>&lt;p&gt;The number of names 
	in Members are <span class="marked">@len</span>&lt;/p&gt;<br>&lt;p&gt;The person at 
	position 2 is <span class="marked">@x</span>&lt;/p&gt;<br>&lt;p&gt;Kai is now in 
	position <span class="marked">@i</span>&lt;/p&gt;<br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<br>
<a class="showbtn" href="showfile_c.asp?filename=try_razor_cs_008" target="_blank">Run example &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="razor_cs_variables.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="razor_cs_loops.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="razor_cs_loops.asp#top" target="_top">TOP</a> |
		<a href="razor_cs_loops.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
