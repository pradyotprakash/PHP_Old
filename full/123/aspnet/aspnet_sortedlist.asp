...
<title>ASP.NET SortedList</title>
<style>a.menu_aspnet_sortedlist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Forms <span class="color_h1">- The SortedList Object</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_hashtable.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="aspnet_xml.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The SortedList object combines the features of both the ArrayList object and the Hashtable object.</p>
<hr>
...
<p><a target="_blank" href="showaspx.asp?filename=demo_sortedlist_radio1">SortedList RadiobuttonList 1</a></p>
<p><a target="_blank" href="showaspx.asp?filename=demo_sortedlist_radio2">SortedList RadiobuttonList 2</a></p>
<p><a target="_blank" href="showaspx.asp?filename=demo_sortedlist_drop1">SortedList DropDownList</a></p>
<hr>

<h2>The SortedList Object</h2>
...
<p>Items are added to the SortedList with the Add() method. A SortedList can be sized to its final size with the TrimToSize() method.</p>
<p>The following code creates a SortedList named mycountries and four elements are added:</p>
...
<h2>Data Binding</h2>
<p>A SortedList object may automatically generate the text and values to the following controls:</p>
<ul>
...
<br><a target="_blank" href="showaspx.asp?filename=demo_sortedlist_radio1" class="showbtn">Show example &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="aspnet_hashtable.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="aspnet_sortedlist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="aspnet_sortedlist.asp#top" target="_top">TOP</a> |
		<a href="aspnet_sortedlist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
