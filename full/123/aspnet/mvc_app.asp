...
<head>
<title>ASP.NET MVC Web Application</title>
<style>a.menu_mvc_app{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET MVC <span class="color_h1">- Internet Application</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="mvc_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="mvc_folders.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">To learn ASP.NET MVC, we will Build an Internet Application</p>
<p class="intro">Part I: Creating the Application</p>

<hr>
<h2>What We Will Build</h2>
<p>We will build an Internet application that supports adding, editing, deleting, 
and listing of information stored in a database.</p>

<hr>
<h2>What We Will Do</h2>
<p>Visual Web Developer offers different templates for building web applications.</p>
<p>We will use 
<strong>Visual Web Developer</strong> to create an empty MVC Internet application 
with <strong>HTML5 markup</strong>.</p>
<p>When the empty Internet application is created, we will gradually add code to 
the application until it is fully finished. We will use <strong>C#</strong> as 
the programming language, and the newest <strong>Razor</strong> server code 
markup. </p>
<p>Along the way we will explain the content, the code, and all the components 
of the application. </p>

<hr>
<h2>Creating the Web Application</h2>
<p>If you have Visual Web Developer installed, start Visual Web Developer and 
select <strong>New Project</strong>. 
Otherwise just read and learn.</p>
<p>
<img alt="New Project" height="448" src="pic_mvc_new_project.jpg" width="523"></p>
<p>In the New Project dialog box:</p>
<ul>
	<li>Open the <b>Visual C#</b> templates</li>
	<li>Select the template <b>ASP.NET MVC 3 Web 
Application</b></li>
	<li>Set the project name to <b>MvcDemo</b></li>
	<li>Set the disk location to something like <b>c:\w3schools_demo</b></li>
	<li>Click <b>OK</b></li>
</ul>
<p>When the New Project Dialog Box opens:</p>
<ul>
	<li>Select the <b>Internet Application</b> template</li>
	<li>Select the <b>Razor Engine</b></li>
	<li>Select <b>HTML5 Markup</b></li>
	<li>Click <strong>OK</strong></li>
</ul>
<p>Visual Studio Express will create a project much like this:</p>
<p><img alt="Mvc Explorer" height="462" src="pic_mvc_explorer.jpg" width="630">&nbsp;</p>
<p>We will explore the content of the files and folders in the next chapter of 
this tutorial.</p>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="mvc_app.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="mvc_app.asp#top" target="_top">TOP</a> |
		<a href="mvc_app.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
