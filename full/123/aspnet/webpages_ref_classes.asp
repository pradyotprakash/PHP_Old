...
<title>ASP.NET Web Pages Classes Reference</title>
<style>a.menu_webpages_ref_classes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET Web Pages <span class="color_h1">- Classes</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="webpages_examples.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="webpages_ref_websecurity.asp">Next Chapter &raquo;</a></div>
	<br>
</div>
<hr>
...
following example:</td></tr><tr>
<td>RenderBody()</td><td>(Layout pages) 
Renders the content of a content page that is not in 
any named sections.</td></tr><tr>
<td>RenderPage(<em>path</em>,<em> values</em>)
<br>
...
position (example 1) or key (example 2).</td></tr><tr>
<td>RenderSection(<em>sectionName [, required 
= </em>true|false<em>]</em>)</td><td>(Layout pages) 
Renders a content section that has a name. Set <em>
required</em> to false to make a section optional.</td></tr><tr>
<td>Request.Cookies[<em>key</em>]</td>
<td>
Gets or sets the value of an HTTP cookie.</td></tr><tr>
<td>Request.Files[<em>key</em>]</td>
<td>Gets 
the files that were uploaded in the current request.</td></tr><tr>
<td>Request.Form[<em>key</em>]</td>
<td>Gets 
data that was posted in a form (as strings). 
Request[<em>key</em>] checks both the Request.Form and the Request.QueryString collections.</td>
</tr><tr>
<td>Request.QueryString[<em>key</em>]</td>
<td>
...
<td>Request.Unvalidated(<em>key</em>) <br>
Request.Unvalidated().QueryString|Form|Cookies|Headers[<em>key</em>]</td>
<td>
...
potentially dangerous content.</td></tr><tr>
<td>Response.AddHeader(<em>name</em>, <em>
value</em>)</td><td>Adds an HTTP server header to 
the response. 
</td></tr><tr>
<td>Response.OutputCache(<em>seconds</em> <em>
...
in the page request.</td></tr><tr>
<td>Response.Redirect(<em>path</em>)</td>
<td>
Redirects the browser request to a new location.</td></tr><tr>
<td>Response.SetStatus(<em>httpStatusCode</em>)</td>
<td>
Sets the HTTP status code sent to the browser.</td></tr><tr>
<td>Response.WriteBinary(<em>data</em> <em>[, 
mimetype]</em>)</td><td>Writes the contents of <em>
data</em> to the response with an optional MIME 
type.</td></tr><tr>
<td>Response.WriteFile(<em>file</em>)</td>
<td>
Writes the contents of a file to the response.</td></tr><tr>
<td>@section(<em>sectionName</em>) { <em>
content</em> }</td><td>(Layout pages) Defines a 
content section that has a name.</td></tr><tr>
<td>Server.HtmlDecode(<em>htmlText</em>)</td>
<td>
Decodes a string that is HTML encoded.</td></tr><tr>
<td>Server.HtmlEncode(<em>text</em>)</td>
<td>
Encodes a string for rendering in HTML markup.</td></tr><tr>
<td>Server.MapPath(<em>virtualPath</em>)</td>
<td>
Returns the server physical path for the specified 
virtual path.</td></tr><tr>
<td>Server.UrlDecode(<em>urlText</em>)</td>
<td>
Decodes text from a URL.</td></tr><tr>
<td>Server.UrlEncode(<em>text</em>)</td>
<td>
Encodes text to put in a URL.</td></tr><tr>
<td>Session[<em>key</em>]</td><td>Gets or 
sets a value that exists until the user closes the 
browser.</td></tr><tr>
<td>ToString()</td><td>Displays a string 
representation of the object's value.</td></tr><tr>
<td>UrlData[<em>index</em>]</td><td>Gets 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="webpages_ref_classes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="webpages_ref_classes.asp#top" target="_top">TOP</a> |
		<a href="webpages_ref_classes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
