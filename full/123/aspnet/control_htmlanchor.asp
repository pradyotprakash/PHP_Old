...
<title>ASP.NET HtmlAnchor Control</title>
<style>a.menu_control_htmlanchor{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>ASP.NET <span class="color_h1">HtmlAnchor</span> Control</h1>
<hr>
...
<p>The HtmlAnchor control is used to control an &lt;a&gt; element. In HTML, the &lt;a&gt; element is used to create a hyperlink.
The hyperlink may link to a bookmark or to another Web page.</p>
<hr>
...
<tr>
  ...
  <tr>
    <td>HRef</td>
    <td>The URL target of the link</td>
  </tr>
  <tr>
    <td>id</td>
  ...
  <tr>
    <td>OnServerClick</td>
    <td>The name of the function to be executed when the link is clicked</td>
  </tr>
  <tr>
    <td>runat</td>
  ...
  <tr>
    <td>Target</td>
    <td>The target window to open</td>
  </tr>
  <tr>
    <td>Title</td>
    <td>A title to be displayed by the browser (like the title attribute of the img element)</td>
  </tr>
  <tr>
    <td>Visible</td>
...
<h2>Example</h2>
<p><a target="_blank" href="showaspx.asp?filename=demo_htmlanchor">HTMLAnchor</a><br>
Declare two HtmlAnchor controls in an .aspx file (remember to embed the control 
inside an HtmlForm control). Then modify the URL, target, and title of the HtmlAnchor controls in an 
event handler (an event handler is a subroutine that executes code for a given 
event). The Page_Load event is one of many events that ASP .NET understands.<br>
</p>
<hr>
<a href="aspnet_refhtmlcontrols.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="HTML Server Controls" /> HTML Server Controls</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="control_htmlanchor.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="control_htmlanchor.asp#top" target="_top">TOP</a> |
		<a href="control_htmlanchor.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
