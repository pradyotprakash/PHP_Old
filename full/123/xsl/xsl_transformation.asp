...
<style>a.menu_xsl_transformation{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT - <span class="color_h1">Transformation</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_templates.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Example study: How to transform XML into XHTML using XSLT.</p>
<p class="intro">The details of this example will be explained in the next chapter.</p>
<hr>

<h2>Correct Style Sheet Declaration</h2>
<p>The root element that declares the document to be an XSL style sheet is &lt;xsl:stylesheet&gt; or &lt;xsl:transform&gt;.</p>
<p><b>Note:</b> &lt;xsl:stylesheet&gt; and &lt;xsl:transform&gt; are completely synonymous and either can be used!</p>
...
<p>To get access to the XSLT elements, attributes and features we must declare the XSLT namespace at the top of the document.</p>
<p>The xmlns:xsl=&quot;http://www.w3.org/1999/XSL/Transform&quot; points to the official W3C XSLT namespace. If you use this 
...
that can be clicked to expand or collapse the element structure. <strong>Tip: To view 
the raw XML source, right-click in XML file and select &quot;View Source&quot;!</strong></p>
...
&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;<br>
<span class="marked">&lt;?xml-stylesheet type=&quot;text/xsl&quot; href=&quot;cdcatalog.xsl&quot;?&gt;</span><br>
&lt;catalog&gt;<br>
  &nbsp;
  &lt;cd&gt;<br>
    &nbsp;&nbsp;&nbsp;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xsl_transformation.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xsl_transformation.asp#top" target="_top">TOP</a> |
		<a href="xsl_transformation.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
