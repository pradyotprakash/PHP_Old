...
<title>XSLT &lt;xsl:fallback&gt; Element</title>
<style>a.menu_el_fallback{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:fallback&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:fallback&gt; element specifies an alternate code to run if&nbsp; 
the XSL processor does not support an XSL element.</p>
<hr>
...
<p>This example is supposed to loop through each &quot;title&quot; element with a
...
<br>
&lt;xsl:template match=&quot;catalog/cd&quot;&gt;<br>
&nbsp;&nbsp;&lt;xsl:loop select=&quot;title&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:fallback&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:for-each select=&quot;title&quot;&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_fallback.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_fallback.asp#top" target="_top">TOP</a> |
		<a href="el_fallback.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
