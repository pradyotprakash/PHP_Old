...
<title>XSLT current() Function</title>
<style>a.menu_func_current{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">current()</span> Function</h1>
<hr>
<a href="xsl_functions.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Function Reference" /> Complete XSLT Function Reference</a>
<hr>

<h2>Definition and Usage</h2>

<p>The current() function returns a node-set that contains only the current node. 
Usually the current node and the context node are the same.</p>
...
<p>However, there is one difference. Look at the following XPath expression: &quot;catalog/cd&quot;. 
...
means that on each step of evaluation, the &quot;.&quot; has a different meaning.</p>

<p>The following line:</p>

<p>&lt;xsl:apply-templates select=&quot;//cd[@title=current()/@ref]&quot;/&gt;</p>

<p>will process all cd elements that have a title attribute with value equal to 
the value of the current node's ref attribute.</p>

<p>This is different from</p>

<p>&lt;xsl:apply-templates select=&quot;//cd[@title=./@ref]&quot;/&gt;</p>

<p>that will process all cd elements that have a title attribute and a ref 
...
&nbsp;&nbsp;&lt;html&gt;<br>
&nbsp;&nbsp;&lt;body&gt;<br>
&nbsp;&nbsp;&lt;xsl:for-each select=&quot;catalog/cd/artist&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;Current node: &lt;xsl:value-of select=&quot;current()&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;br /&gt;<br>
&nbsp;&nbsp;&lt;/xsl:for-each&gt;<br>
&nbsp;&nbsp;&lt;/body&gt;<br>
&nbsp;&nbsp;&lt;/html&gt;<br>
...
&lt;/xsl:stylesheet&gt;
	...
	<a target="_blank" href="cdcatalog_current.xsl">View the XSL file</a>, and
	<a target="_blank" href="cdcatalog_current.xml">View the result</a>.</p>
<hr>
<a href="xsl_functions.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Function Reference" /> Complete XSLT Function Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_current.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_current.asp#top" target="_top">TOP</a> |
		<a href="func_current.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
