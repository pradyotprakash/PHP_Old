...
<title>XSLT &lt;xsl:variable&gt; Element</title>
<style>a.menu_el_variable{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:variable&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:variable&gt; element is used to declare a local or global variable.</p>
<p><b>Note:</b> The variable is global if it's declared as a top-level element, 
and local if it's declared within a template.</p>
<p><b>Note:</b> Once you have set a variable's value, you cannot change or modify that value!</p>
<p><b>Tip:</b> You can add a value to a variable by the content of the &lt;xsl:variable&gt; 
element OR by the select attribute!</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>name</td>
    <td>Required. Specifies the name of the variable</td>
  </tr>
  <tr>
    <td>select</td>
    <td>expression</td>
    <td>Optional. Defines the value of the variable</td>
  </tr>
</table>

<h3>Example 1</h3>
<p>If the select attribute is present, the &lt;xsl:variable&gt; element cannot contain 
...
<h3>Example 2</h3>
<p>If the &lt;xsl:variable&gt; element only contains a name attribute, and 
there is no content, then the value of the variable is an empty string: </p>
<div class="code notranslate"><div>
...
<h3>Example 3</h3>
<p>The following example adds a value to the variable &quot;header&quot; by the content of the &lt;xsl:variable&gt; 
element:</p>
<div class="code notranslate"><div>
...
&nbsp;&nbsp;&lt;body&gt;<br>
&nbsp;&nbsp;&lt;table&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:copy-of select=&quot;$header&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:for-each select=&quot;reference/record&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;tr&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:if category=&quot;XML&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;td&gt;&lt;xsl:value-of select=&quot;element&quot;/&gt;&lt;/td&gt;<br>
...
&nbsp;&nbsp;&lt;table&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:copy-of select=&quot;$header&quot; /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:for-each select=&quot;table/record&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;tr&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:if category=&quot;XSL&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;td&gt;&lt;xsl:value-of select=&quot;element&quot;/&gt;&lt;/td&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;td&gt;&lt;xsl:value-of select=&quot;description&quot;/&gt;&lt;/td&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/xsl:if&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/tr&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_variable.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_variable.asp#top" target="_top">TOP</a> |
		<a href="el_variable.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
