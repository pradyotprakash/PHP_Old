...
<style>a.menu_el_template{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The &lt;xsl:template&gt; element contains rules to apply when a specified node is matched.</p>
<p>The match attribute is used to associate the template with an XML element. 
The match attribute can also be used to define a template for a whole branch of 
the XML document (i.e. match=&quot;/&quot; defines the whole document).</p>
<p><b>Note:</b> &lt;xsl:template&gt; is a top-level element.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>name</td>
    <td>Optional. Specifies a name for the template.<p><b>Note: </b>If this attribute is
      omitted there must be a match attribute</p></td>
  </tr>
  <tr>
    <td>match</td>
    <td>pattern</td>
    <td>Optional. The match pattern for the template.<p><b>Note: </b>If this attribute is
      omitted there must be a name attribute</p></td>
  </tr>
  <tr>
    <td>mode</td>
    <td>mode</td>
    <td>Optional. Specifies a mode for this template</td>
  </tr>
  <tr>
    <td>priority</td>
    <td>number</td>
    <td>Optional. A number which indicates the numeric priority of the template</td>
  </tr>
</table>
...
<p>
<a target="_blank" href="cdcatalog.xml">View the XML file</a>,
<a target="_blank" href="cdcatalog_apply.xsl">View the XSL file</a>, and
<a target="_blank" href="cdcatalog_apply.xml">View the result</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_template.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_template.asp#top" target="_top">TOP</a> |
		<a href="el_template.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
