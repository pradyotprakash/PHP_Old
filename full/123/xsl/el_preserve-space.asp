...
<title>XSLT &lt;xsl:preserve-space&gt;&nbsp; and &lt;xsl:strip-space&gt; Elements</title>
<style>a.menu_el_preserve-space{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:preserve-space&gt;&nbsp;</span> and <span class="color_h1">&lt;xsl:strip-space&gt;</span> Elements</h1>
<hr>
...
<p>The &lt;xsl:preserve-space&gt; element is used to define the elements for which white space should be preserved.</p>
<p>The &lt;xsl:strip-space&gt; element is used to define the elements for which white space should be removed.</p>
<p><b>Note: </b>Preserving white space is the default setting, so using the &lt;xsl:preserve-space&gt; element
is only necessary if&nbsp; the &lt;xsl:strip-space&gt; element is used.</p>
<p><b>Note: </b>The &lt;xsl:preserve-space&gt; element and the &lt;xsl:strip-space&gt; element are top-level elements.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>

&lt;xsl:preserve-space elements=&quot;list-of-element-names&quot;/&gt;<br>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td><p>Required. A white space separated list of element names 
    for which white space should be preserved/removed.</p>
      <p><b>Note:</b> The list can also contain &quot;*&quot; and &quot;prefix:*&quot;
      so that all elements or
      all elements from a particular namespace can be joined</p>
    </td>
  </tr>
</table>
<h3>Example 1</h3>

<p>In the example below we preserve white space nodes for title and artist 
...
<br>
&lt;xsl:strip-space elements=&quot;country company price year&quot; /&gt;<br>
&lt;xsl:preserve-space elements=&quot;title artist&quot; /&gt;<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_preserve-space.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_preserve-space.asp#top" target="_top">TOP</a> |
		<a href="el_preserve-space.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
