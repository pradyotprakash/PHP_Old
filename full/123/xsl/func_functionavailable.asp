...
<title>XSLT function-available() Function</title>
<style>a.menu_func_functionavailable{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">function-available()</span> Function</h1>
<hr>
...
<p>The function-available() function returns a Boolean value that indicates whether the 
function specified is supported by the XSLT 
processor.</p>

<p>You may test the XSLT functions and the inherited 
XPath functions.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>string</td>
    <td>Required. Specifies the function to test</td>
  </tr>
  </table>
...
&lt;body&gt;<br>
&lt;xsl:choose&gt;<br>
&lt;xsl:when test=&quot;function-available('sum')&quot;&gt;<br>
&lt;p&gt;sum() is supported.&lt;/p&gt;<br>
&lt;/xsl:when&gt;<br>
&lt;xsl:otherwise&gt;<br>
&lt;p&gt;sum() is not supported.&lt;/p&gt;<br>
&lt;/xsl:otherwise&gt;<br>
&lt;/xsl:choose&gt;<br>
&lt;xsl:choose&gt;<br>
&lt;xsl:when test=&quot;function-available('current')&quot;&gt;<br>
&lt;p&gt;current() is supported.&lt;/p&gt;<br>
&lt;/xsl:when&gt;<br>
&lt;xsl:otherwise&gt;<br>
&lt;p&gt;current() is not supported.&lt;/p&gt;<br>
&lt;/xsl:otherwise&gt;<br>
&lt;/xsl:choose&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;<br>
...
&lt;/xsl:stylesheet&gt;
    ...
    <p><a target="_blank" href="functionavailable.xsl">View the XSL file</a> and
	<a target="_blank" href="functionavailable.xml">View the result</a><br>
    </p>
<hr>
<a href="xsl_functions.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Function Reference" /> Complete XSLT Function Reference</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_functionavailable.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_functionavailable.asp#top" target="_top">TOP</a> |
		<a href="func_functionavailable.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
