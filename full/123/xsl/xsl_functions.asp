...
<style>a.menu_xsl_functions{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">Functions</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_w3celementref.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="default.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XQuery 1.0, XPath 2.0, and XSLT 2.0 share the same functions 
library.</p>
<hr>
<h2>XSLT Functions</h2>
<p>XSLT includes over 100 built-in functions. There are functions for string 
values, numeric values, date and time comparison, node and QName manipulation, 
sequence manipulation, Boolean values, and more.</p>
<table class="lamp"><tr>
...
http://www.w3.org/2005/xpath-functions</td>
</tr></table>
...
<p><a href="../xpath/xpath_functions.asp">The reference of all the built-in XSLT 
2.0 functions is located in our XPath tutorial.</a></p>
<p>In addition, there are the following built-in XSLT functions:</p>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="func_current.asp">current()</a></td>
    <td>Returns the current node</td>
  </tr>
  <tr>
    <td><a href="func_document.asp">document()</a></td>
    <td>Used to access the nodes in an external XML document</td>
    </tr>
  <tr>
    <td><a href="func_elementavailable.asp">element-available()</a></td>
    <td>Tests whether the element specified is supported by the XSLT processor</td>
  </tr>
  <tr>
    <td><a href="func_formatnumber.asp">format-number()</a></td>
    <td>Converts a number into a string</td>
    </tr>
  <tr>
    <td><a href="func_functionavailable.asp">function-available()</a></td>
    <td>Tests whether the function specified is supported by the XSLT processor</td>
    </tr>
  <tr>
    <td><a href="func_generateid.asp">generate-id()</a></td>
    <td>Returns a string value that uniquely identifies a specified node</td>
    </tr>
  <tr>
    <td><a href="func_key.asp">key()</a></td>
    <td>Returns a node-set using the index specified by an &lt;xsl:key&gt; element</td>
  </tr>
  <tr>
    <td><a href="func_systemproperty.asp">system-property()</a></td>
    <td>Returns the value of the system properties</td>
  </tr>
  <tr>
    <td><a href="func_unparsedentityuri.asp">unparsed-entity-uri()</a></td>
    <td>Returns the URI of an unparsed entity</td>
  </tr>
  </table>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xsl_functions.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xsl_functions.asp#top" target="_top">TOP</a> |
		<a href="xsl_functions.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
