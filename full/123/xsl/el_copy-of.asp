...
<title>XSLT &lt;xsl:copy-of&gt; Element</title>
<style>a.menu_el_copy-of{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:copy-of&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:copy-of&gt; element creates a copy of the current node.</p>
<p><b>Note:</b> Namespace nodes, child nodes, and attributes of the current node 
are automatically copied as well!</p>
<p><b>Tip:</b> This element can be used to insert multiple copies of the same 
node into different places in the output.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>select</td>
    <td>expression</td>
    <td>Required. Specifies what to be copied</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_copy-of.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_copy-of.asp#top" target="_top">TOP</a> |
		<a href="el_copy-of.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
