...
<style>a.menu_el_number{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:number&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:number&gt; element is used to determine the integer position of the 
current node in the source. It is also used to format a number.</p>
<hr>
...
from=&quot;expression&quot;<br>
value=&quot;expression&quot;<br>
format=&quot;formatstring&quot;<br>
lang=&quot;languagecode&quot;<br>
letter-value=&quot;alphabetic|traditional&quot;<br>
grouping-separator=&quot;character&quot;<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>count</td>
    <td>expression</td>
    <td>Optional. An XPath expression that specifies what nodes are 
    to be counted</td>
  </tr>
  <tr>
    <td>level</td>
    <td>single<br>
      multiple<br>
      any</td>
    <td>Optional. Controls how the sequence number is assigned<p>
  ...
  <tr>
    <td>from</td>
    <td>expression</td>
    <td>Optional. An XPath expression that specifies where the 
    counting will start</td>
  </tr>
  <tr>
    <td>value</td>
    <td>expression</td>
    <td>Optional. Specifies a user-provided number that is used in 
    place of a sequence generated number</td>
  </tr>
  <tr>
    <td>format</td>
    <td>formatstring</td>
    <td>Optional. Defines the output format for the number. Can be 
  ...
  <tr>
    <td>lang</td>
    <td>languagecode</td>
    <td>Optional. Specifies the language alphabet to be used for 
    the numbering (Not supported by Netscape 6)</td>
  </tr>
  <tr>
    <td>letter-value</td>
    <td>alphabetic<br>
      traditional</td>
    <td>Optional. Specifies whether the numbering in the selected 
    language is alphabetic or traditional. The default is alphabetic</td>
  </tr>
  <tr>
    <td>grouping-separator</td>
    <td>character</td>
    <td>Optional. Specifies what character should be used to 
    separate groups of digits. The default is the comma</td>
  </tr>
  <tr>
    <td>grouping-size</td>
    <td>number</td>
    <td>Optional. Specifies how many digits are in the groups that 
    are being separated by the character specified in the grouping-separator 
    attribute. The default is 3</td>
  </tr>
</table>
<h3>Example 1</h3>
...
&lt;xsl:number value=&quot;250000&quot; grouping-separator=&quot;.&quot;/&gt;<br>
<br>
Output:<br>
<br>
250.000
...
&lt;xsl:number value=&quot;250000&quot; grouping-size=&quot;2&quot;/&gt;<br>
<br>
Output:<br>
<br>
25,00,00
...
&lt;xsl:number value=&quot;12&quot; grouping-size=&quot;1&quot;<br>
grouping-separator=&quot;#&quot; format=&quot;I&quot;/&gt;<br>
<br>
Output:<br>
<br>
X#I#I
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_number.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_number.asp#top" target="_top">TOP</a> |
		<a href="el_number.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
