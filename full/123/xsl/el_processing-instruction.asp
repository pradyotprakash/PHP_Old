...
<title>XSLT &lt;xsl:processing-instruction&gt; Element</title>
<style>a.menu_el_processing-instruction{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:processing-instruction&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:processing-instruction&gt; element writes a processing instruction to the output.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>process-name</td>
    <td>Required. Specifies the name of the processing instruction
    </td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_processing-instruction.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_processing-instruction.asp#top" target="_top">TOP</a> |
		<a href="el_processing-instruction.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
