...
<style>a.menu_xsl_languages{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSL <span class="color_h1">Languages</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<h2>CSS = Style Sheets for HTML</h2>

<p>HTML uses predefined tags, and the meaning of each tag is <b> well
understood</b>.</p>

<p>The &lt;table&gt; tag in HTML defines a table - and a browser knows <b> 
how to display it</b>.</p>

<p>Adding styles to HTML elements are simple. Telling a browser to display 
an element 
in a special font or
color, is easy with CSS.&nbsp;</p>
<hr>

<h2>XSL = Style Sheets for XML</h2>
<p>XML does not use predefined tags (we can use any tag-names we like), and 
therefore the meaning of each tag is <b>not well understood</b>.</p>
<p>A
...
documents.</p>
<p>To learn more about XPath and XSL-FO, visit our
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xsl_languages.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xsl_languages.asp#top" target="_top">TOP</a> |
		<a href="xsl_languages.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
