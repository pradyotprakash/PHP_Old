...
<title>XSLT &lt;xsl:element&gt; Element</title>
...
<h1>XSLT <span class="color_h1">&lt;xsl:element&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:element&gt; element is used to create an element node in the output document.</p>
<hr>
...
name=&quot;name&quot;<br>
namespace=&quot;URI&quot;<br>
use-attribute-sets=&quot;namelist&quot;&gt;<br>
<br>
&nbsp;&nbsp;&lt;!-- Content:template --&gt;<br>
<br>
&lt;/xsl:element&gt;
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>name</td>
    <td>Required. Specifies the name of the element to be created 
    (the value of the name attribute can be set to an expression that is 
    computed at run-time, like this: &lt;xsl:element name=&quot;{$country}&quot; /&gt;</td>
  </tr>
  <tr>
    <td>namespace</td>
    <td>URI</td>
    <td>Optional. Specifies the namespace URI of the element (the 
    ...
    namespace=&quot;{$someuri}&quot;/&gt;</td>
  </tr>
  <tr>
    <td>use-attribute-sets</td>
    <td>namelist</td>
    <td>Optional. A white space separated list of attribute-sets
      containing attributes to be added to the element</td>
  </tr>
</table>
...
<a target="_blank" href="cdcatalog_element.xsl">View the XSL file</a>, and
<a target="_blank" href="cdcatalog_element.xml">View the result</a>.</p>
<hr>
<a href="xsl_w3celementref.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Element Reference" /> Complete XSLT Element Reference</a>
				<hr />
				<!-- SmallPS -->
