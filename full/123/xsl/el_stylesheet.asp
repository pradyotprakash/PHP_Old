...
<title>XSLT &lt;xsl:stylesheet&gt; and &lt;xsl:transform&gt; Elements</title>
<style>a.menu_el_stylesheet{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:stylesheet&gt;</span> and <span class="color_h1">&lt;xsl:transform&gt;</span> Elements</h1>
<hr>
...
<p>The &lt;xsl:stylesheet&gt; and &lt;xsl:transform&gt; elements are completely 
synonymous elements. Both are used to define the root element of the style sheet.</p>
<hr>
...
id=&quot;name&quot;<br>
version=&quot;version&quot;<br>
extension-element-prefixes=&quot;list&quot;<br>
exclude-result-prefixes=&quot;list&quot;&gt;<br>
<br>
&nbsp;&nbsp;&lt;!-- Content:(&lt;xsl:import&gt;*,top-level-elements) --&gt;<br>
<br>
&lt;/xsl:stylesheet&gt;
...
<table class="reference notranslate">
  ...
  <tr>
    <td>version</td>
    <td>version</td>
    <td>Required. Specifies the XSLT version of the style sheet</td>
  </tr>
  <tr>
    <td>extension-element-prefixes</td>
    <td>list</td>
    <td>Optional. A white space separated list of namespace
      prefixes used for extension elements&nbsp;<p>This attribute is not 
    supported by Netscape 6</p></td>
  </tr>
  <tr>
    <td>exclude-result-prefixes</td>
    <td>list</td>
    <td>Optional. A white space separated list of namespace
      prefixes that should not be sent to the output</td>
  </tr>
  <tr>
    <td>id</td>
    <td>name</td>
    <td>Optional. A unique id for the style sheet<p>This attribute 
    is not supported by Netscape 6</p></td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_stylesheet.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_stylesheet.asp#top" target="_top">TOP</a> |
		<a href="el_stylesheet.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
