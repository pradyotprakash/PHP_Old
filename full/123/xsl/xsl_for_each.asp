...
<style>a.menu_xsl_for_each{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:for-each&gt;</span> Element</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_value_of.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_sort.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The &lt;xsl:for-each&gt; element allows you to do looping in XSLT.</p>
<hr>
...
<br><a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=cdcatalog_ex3" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p><b>Note:</b> The value of the <b>select</b> attribute is an XPath expression.
...
<p>We can also filter the output from the XML file by adding a criterion to the 
select attribute in the &lt;xsl:for-each&gt; element.</p>
<p><b>&lt;xsl:for-each select=&quot;catalog/cd[artist='Bob Dylan']&quot;&gt;</b></p>
<p>Legal filter operators are:</p>
<ul>
  <li>=&nbsp; (equal)</li>
  <li>!= (not equal)</li>
  <li>&amp;lt; less than</li>
...
<p>Take a look at the adjusted XSL style sheet:</p>
...
<br><a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=cdcatalog_filter" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_value_of.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xsl_for_each.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xsl_for_each.asp#top" target="_top">TOP</a> |
		<a href="xsl_for_each.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
