...
<title>XSLT &lt;xsl:param&gt; Element</title>
<style>a.menu_el_param{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:param&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:param&gt; element is used to declare a local or global parameter.</p>
<p> <b>Note:</b> The parameter is global if it's declared as a top-level element, 
...
<table class="reference notranslate">
  ...
  <tr>
    <td>select</td>
    <td>expression</td>
    <td>Optional. Specifies an XPath expression that specifies a 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_param.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_param.asp#top" target="_top">TOP</a> |
		<a href="el_param.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
