...
<title>XSLT document() Function</title>
<style>a.menu_func_document{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">document()</span> Function</h1>
<hr>
...
<p>The document() function is used to access nodes in an external XML 
document. The external XML document must be valid and parsable.</p>

<p>One way to use this function is to look up data in an external document. For 
example we want to find the Celsius value from a Fahrenheit value and we refer to a 
document that contains some pre-computed results:</p>

<p>&lt;xsl:value-of select=&quot;document('celsius.xml')/celsius/result[@value=$value]&quot;/&gt;</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>object</td>
    <td>Required. Defines an URI to an external XML document</td>
  </tr>
  <tr>
    <td>node-set</td>
    <td>Optional. Used to resolve relative URI</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_document.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_document.asp#top" target="_top">TOP</a> |
		<a href="func_document.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
