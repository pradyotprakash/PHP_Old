...
<title>XSLT &lt;xsl:apply-templates&gt; Element</title>
<style>a.menu_el_apply-templates{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:apply-templates&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:apply-templates&gt; element applies a template to the current 
element or to the current element's child nodes.</p>
<p>If we add a select attribute to the &lt;xsl:apply-templates&gt; element it will 
...
&lt;xsl:apply-templates select=&quot;expression&quot; mode=&quot;name&quot;&gt;<br>
<br>
&nbsp;&nbsp;&lt;!-- Content:(xsl:sort|xsl:with-param)* --&gt;<br>
<br>
&lt;/xsl:apply-templates&gt;
...
<table class="reference notranslate">
  ...
  <tr>
    <td>select</td>
    <td>expression</td>
    <td>Optional. Specifies the nodes to be processed. An asterisk 
    selects the entire node-set. If this attribute is omitted, all child nodes 
    of the current node will be selected</td>
  </tr>
  <tr>
    <td>mode</td>
    <td>name</td>
    <td>Optional. If there are multiple ways of processing defined 
    for the same element, distinguishes among them</td>
  </tr>
</table>
...
<p>Wrap a single h1 element around all the title elements which are children of 
message:</p>
...
&nbsp;&nbsp;&lt;h1&gt;&lt;xsl:apply-templates select=&quot;title&quot;/&gt;&lt;/h1&gt;<br>
&lt;/xsl:template&gt;<br>
<br>
&lt;/xsl:stylesheet&gt;
...
<p>Wrap a single h1 element around all the child nodes of message that have the 
mode attribute set to &quot;big&quot;:</p>
<div class="code notranslate"><div>
...
<br>
&lt;xsl:template match=&quot;message&quot;&gt;<br>
&nbsp;&nbsp;&lt;h1&gt;&lt;xsl:apply-templates select=&quot;*&quot; mode=&quot;big&quot;/&gt;&lt;/h1&gt;<br>
&lt;/xsl:template&gt;<br>
<br>
&lt;/xsl:stylesheet&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_apply-templates.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_apply-templates.asp#top" target="_top">TOP</a> |
		<a href="el_apply-templates.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
