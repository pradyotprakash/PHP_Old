...
<title>XSLT &lt;xsl:apply-imports&gt; Element</title>
<style>a.menu_el_apply-imports{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:apply-imports&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:apply-imports&gt; element applies a template rule from an
imported style sheet.</p>

<p>Template rules in imported style sheets have lower precedence than template 
...
<p>Suppose we have a style sheet called &quot;standard.xsl&quot; that contains a template rule for message 
elements:</p>
...
<p>Another style sheet could import &quot;standard.xsl&quot;, and modify the message
...
xmlns:xsl=&quot;http://www.w3.org/1999/XSL/Transform&quot;&gt;<br>
<br>
&lt;xsl:import href=&quot;standard.xsl&quot;/&gt;<br>
<br>
&lt;xsl:template match=&quot;message&quot;&gt;<br>
&nbsp;&nbsp;&lt;div style=&quot;border:solid blue&quot;&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_apply-imports.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_apply-imports.asp#top" target="_top">TOP</a> |
		<a href="el_apply-imports.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
