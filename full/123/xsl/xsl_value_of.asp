...
<style>a.menu_xsl_value_of{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_templates.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_for_each.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The &lt;xsl:value-of&gt; element is used to extract the value of a selected node.</p>
<hr>
...
<br><a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=cdcatalog_ex2" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<h2>Example Explained</h2>
<p><b>Note:</b> The <b>select</b> attribute, in the example above, contains an XPath expression.
An XPath expression works like navigating a file system; a forward slash (/) selects subdirectories.</p>

<p>The result from the example above was a little disappointing; only one line of data was copied from the XML document to the output. In the next chapter you will learn how to use the <b>&lt;xsl:for-each&gt;</b>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xsl_value_of.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xsl_value_of.asp#top" target="_top">TOP</a> |
		<a href="xsl_value_of.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
