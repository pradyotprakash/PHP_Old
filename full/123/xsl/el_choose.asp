...
<style>a.menu_el_choose{font-weight:bold;}</style>
<meta charset="utf-8">
...
<hr>
<a href="xsl_w3celementref.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Element Reference" /> XSLT Element Reference</a>
<hr>


<h2>Definition and Usage</h2>
<p>The &lt;xsl:choose&gt; element is used in conjunction with &lt;xsl:when&gt; and &lt;xsl:otherwise&gt; 
to express multiple conditional tests.</p>
<p>If no &lt;xsl:when&gt; is true, the content of &lt;xsl:otherwise&gt; is processed.</p>
<p>If no &lt;xsl:when&gt; is true, and no &lt;xsl:otherwise&gt; element is present, nothing is created.</p>
<p><b>Tip:</b> For simple conditional testing, use the &lt;xsl:if&gt; element instead.</p>
<hr>
...
&lt;xsl:choose&gt;<br>
<br>
&nbsp;&nbsp;&lt;!-- Content:(xsl:when+,xsl:otherwise?) --&gt;<br>
<br>
&lt;/xsl:choose&gt;
...
<br>
<a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=tryxsl_choose" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>Declare a variable named &quot;color&quot;. Set its value to
the color attribute of the current element. If the current element has no
color attribute, the value of &quot;color&quot; will be &quot;green&quot;:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_choose.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_choose.asp#top" target="_top">TOP</a> |
		<a href="el_choose.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
