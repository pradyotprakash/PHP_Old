...
<title>XSLT &lt;xsl:key&gt; Element</title>
<style>a.menu_el_key{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:key&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:key&gt; element is a top-level element which declares a named key that can be used
in the style sheet with the key() function.</p>
<p><b>Note:</b> A key does not have to be unique!</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>name</td>
    <td>Required. Specifies the name of the key</td>
  </tr>
  <tr>
    <td>match</td>
    <td>pattern</td>
    <td>Required. Defines the nodes to which the key will be 
    applied</td>
  </tr>
  <tr>
    <td>use</td>
    <td>expression</td>
    <td>Required. The value of the key for each of the 
      nodes</td>
  </tr>
</table>
<h3>Example 1</h3>

<p>Suppose you have an XML file called &quot;persons.xml&quot;:</p>

<div class="code notranslate"><div>

&lt;persons&gt;<br>
&nbsp;&nbsp;&lt;person name=&quot;Tarzan&quot; id=&quot;050676&quot;/&gt;<br>
&nbsp;&nbsp;&lt;person name=&quot;Donald&quot; id=&quot;070754&quot;/&gt;<br>
&nbsp;&nbsp;&lt;person name=&quot;Dolly&quot; id=&quot;231256&quot;/&gt;<br>
&lt;/persons&gt;
...
<br>
&lt;xsl:key name=&quot;preg&quot; match=&quot;person&quot; use=&quot;@id&quot;/&gt;<br>
<br>
&lt;xsl:template match=&quot;/&quot;&gt;<br>
&nbsp;&nbsp;&lt;html&gt;<br>
&nbsp;&nbsp;&lt;body&gt;<br>
&nbsp;&nbsp;&lt;xsl:for-each select=&quot;key('preg','050676')&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_key.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_key.asp#top" target="_top">TOP</a> |
		<a href="el_key.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
