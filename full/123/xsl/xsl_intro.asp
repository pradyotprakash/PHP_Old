...
<style>a.menu_xsl_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_languages.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_transformation.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XSLT is a language for transforming XML documents into XHTML 
documents or to other XML documents.</p>
<p class="intro">XPath is a language for navigating in XML documents.</p>
<hr>
...
<h2>What is XSLT?</h2>
<ul>
  <li>XSLT stands for XSL Transformations</li>
	<li>XSLT is the most important part of XSL</li>
	<li>XSLT transforms an XML document into another XML document</li>
	<li>XSLT uses XPath to navigate in XML documents</li>
	<li>XSLT is a W3C Recommendation</li>
</ul>
<hr>
<h2>XSLT = XSL Transformations</h2>
<p>XSLT is the most important part of XSL.</p>
<p>XSLT is used to transform an XML document into another XML document, or another
...
element.</p>
<p>With XSLT you can add/remove elements and attributes to or from the output file. 
...
<p>A common way to describe the transformation process is to say that 
<b>XSLT transforms an XML source-tree into an XML result-tree</b>.</p>
<hr>

<h2>XSLT Uses XPath</h2>
<p>XSLT uses XPath to find information in an XML document. XPath is used to 
navigate through elements and attributes in XML documents.</p>
<p>If you want to study XPath first, please read our
<a href="../xpath/default.asp">XPath Tutorial</a>.</p>
<hr>

<h2>How Does it Work?</h2>
<p>In the transformation process, XSLT uses XPath to define parts of the source
...
<h2>XSLT Browser Support</h2>
<p>All major browsers have support for XML and XSLT.</p>
<p>Internet Explorer supports XML, XSLT, and XPath from version 6.</p>
<p>Chrome supports XML, XSLT, and XPath from version 1.</p>
<p>Firefox supports XML, XSLT, and XPath from version 3.</p>
<p>Safari supports XML and XSLT from version 3.</p>
<p>Opera supports XML, XSLT, and XPath from version 9.</p>
<hr>

<h2>XSLT is a W3C Recommendation</h2>
<p>XSLT became a W3C Recommendation 16. November 1999.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_languages.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_transformation.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xsl_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xsl_intro.asp#top" target="_top">TOP</a> |
		<a href="xsl_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
