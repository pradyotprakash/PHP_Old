...
<title>XSLT &lt;xsl:with-param&gt; Element</title>
<style>a.menu_el_with-param{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:with-param&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:with-param&gt; element defines the value of a parameter to be passed into a template.</p>
<p><b>Note:</b> The value of the name attribute of &lt;xsl:with-param&gt; must match a 
name in an &lt;xsl:param&gt; element (the &lt;xsl:with-param&gt; element is ignored if there is no match). </p>
<p><b>Note:</b> The &lt;xsl:with-param&gt; element is allowed within &lt;xsl:apply-templates&gt; 
and &lt;xsl:call-template&gt;.</p>
<p><b>Tip:</b> You can add a value to the parameter by the content of the &lt;xsl:with-param&gt; 
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>name</td>
    <td>Required. Specifies the name of the parameter</td>
  </tr>
  <tr>
    <td>select</td>
    <td>expression</td>
    <td>Optional. An XPath expression that defines the value of the parameter</td>
  </tr>
</table>
<h3>Example 1</h3>
...
<br>
&lt;xsl:variable name=&quot;xx&quot;&gt;<br>
&nbsp;&nbsp;&lt;html&gt;<br>
&nbsp;&nbsp;&lt;body&gt;<br>
&nbsp;&nbsp;&lt;xsl:call-template name=&quot;show_title&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:with-param name=&quot;title&quot; /&gt;<br>
&nbsp;&nbsp;&lt;/xsl:call-template&gt;<br>
&nbsp;&nbsp;&lt;/body&gt;<br>
&nbsp;&nbsp;&lt;/html&gt;<br>
&lt;/xsl:variable&gt;<br>
<br>
&lt;xsl:template name=&quot;show_title&quot; match=&quot;/&quot;&gt;<br>
&nbsp;&nbsp;&lt;xsl:param name=&quot;title&quot; /&gt;<br>
&nbsp;&nbsp;&lt;xsl:for-each select=&quot;catalog/cd&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;Title: &lt;xsl:value-of select=&quot;$title&quot; /&gt;&lt;/p&gt;<br>
&nbsp;&nbsp;&lt;/xsl:for-each&gt;<br>
&lt;/xsl:template&gt;<br>
<br>
&lt;/xsl:stylesheet&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_with-param.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_with-param.asp#top" target="_top">TOP</a> |
		<a href="el_with-param.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
