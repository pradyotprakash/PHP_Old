...
<style>a.menu_xsl_client{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_apply_templates.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_server.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">XSLT can be used to transform the document to XHTML in your browser.</p>
<hr>
...
<div class="example_code notranslate">
	&lt;html&gt;<br>&lt;head&gt;<br>&lt;script&gt;<br>function loadXMLDoc(filename)<br>{<br>if (window.ActiveXObject)<br>&nbsp; 
	{<br>&nbsp; xhttp = new ActiveXObject(&quot;Msxml2.XMLHTTP&quot;);<br>&nbsp; }<br>else
	<br>&nbsp; {<br>&nbsp; xhttp = new XMLHttpRequest();<br>&nbsp; }<br>
	xhttp.open(&quot;GET&quot;, filename, false);<br>try {xhttp.responseType = &quot;msxml-document&quot;} 
	catch(err) {} // Helping IE11<br>xhttp.send(&quot;&quot;);<br>return xhttp.responseXML;<br>
	}<br><br>function displayResult()<br>{<br>xml = loadXMLDoc(&quot;cdcatalog.xml&quot;);<br>
	xsl = loadXMLDoc(&quot;cdcatalog.xsl&quot;);<br>// code for IE<br>if (window.ActiveXObject 
	|| xhttp.responseType == &quot;msxml-document&quot;)<br>&nbsp; {<br>&nbsp; ex = 
	xml.transformNode(xsl);<br>&nbsp; document.getElementById(&quot;example&quot;).innerHTML 
	= ex;<br>&nbsp; }<br>// code for Chrome, Firefox, Opera, etc.<br>else if (document.implementation 
	&amp;&amp; document.implementation.createDocument)<br>&nbsp; {<br>&nbsp; 
	xsltProcessor = new XSLTProcessor();<br>&nbsp; 
	xsltProcessor.importStylesheet(xsl);<br>&nbsp; resultDocument = 
	xsltProcessor.transformToFragment(xml, document);<br>&nbsp; 
	document.getElementById(&quot;example&quot;).appendChild(resultDocument);<br>&nbsp; }<br>
	}<br>&lt;/script&gt;<br>&lt;/head&gt;<br>&lt;body onload=&quot;displayResult()&quot;&gt;<br>&lt;div 
	id=&quot;example&quot; /&gt;<br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<br><a target="_blank" href="tryit.asp?filename=cdcatalog" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p><b>Tip:</b> If you don't know how to write JavaScript, please can study our <a href="../js/default.asp">JavaScript tutorial</a>.</p>

<h2>Example Explained:</h2>
<p><b>The loadXMLDoc() function does the following:</b></p>
<ul>
	<li>Create an XMLHttpRequest object</li>
	<li>Use the open() and send() methods of the XMLHttpRequest object to send a 
	request to a server</li>
	<li>Get the response data as XML data</li>
</ul>
<p><b>The displayResult() function is used to display the XML file styled by the 
XSL file:</b></p>
<ul>
	<li>Load XML and XSL files</li>
	<li>Test what kind of browser the user has</li>
	<li>If Internet Explorer:<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xsl_client.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xsl_client.asp#top" target="_top">TOP</a> |
		<a href="xsl_client.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
