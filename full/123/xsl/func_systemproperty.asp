...
<title>XSLT system-property() Function</title>
<style>a.menu_func_systemproperty{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">system-property()</span> Function</h1>
<hr>
...
<p>The system-property() function returns the value of the system property 
specified by the name.</p>

<p>System properties in the XSLT namespace:</p>

<ul>
  <li>xsl:version - The version of XSLT implemented by the processor</li>
  <li>xsl:vendor - The vendor of the XSLT processor </li>
  <li>xsl:vendor-url - The URL identifying the vendor of the XSLT processor</li>
</ul>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>string</td>
    <td>Required. Specifies the system property to return the value 
    of </td>
  </tr>
  </table>
...
&lt;/xsl:stylesheet&gt;
    ...
    <p><a target="_blank" href="systemproperty.xsl">View the XSL file</a> and
	<a target="_blank" href="systemproperty.xml">View the result</a><br>
    </p>
<hr>
<a href="xsl_functions.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Function Reference" /> Complete XSLT Function Reference</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_systemproperty.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_systemproperty.asp#top" target="_top">TOP</a> |
		<a href="func_systemproperty.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
