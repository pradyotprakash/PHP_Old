...
<title>XSLT &lt;xsl:sort&gt; Element</title>
<style>a.menu_el_sort{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:sort&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:sort&gt; element is used to sort the output.</p>
<p><b>Note:</b> &lt;xsl:sort&gt; is always within &lt;xsl:for-each&gt; or &lt;xsl:apply-templates&gt;.</p>
<hr>
...
data-type=&quot;text|number|qname&quot;<br>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Optional. Specifies which node/node-set to sort on</td>
  </tr>
  <tr>
    <td>lang</td>
    <td>language-code</td>
    <td>Optional. Specifies which language is to be used by the 
    sort</td>
  </tr>
  <tr>
    <td>data-type</td>
    <td>text<br>
      number<br>
      qname</td>
    <td>Optional. Specifies the data-type of the data to be sorted. Default is &quot;text&quot;<br>
    </td>
    </tr>
  <tr>
    <td>order</td>
    <td>ascending<br>
      descending</td>
    <td>Optional. Specifies the sort order. Default is &quot;ascending&quot;</td>
  </tr>
  <tr>
    <td>case-order</td>
    <td>upper-first<br>
      lower-first</td>
    <td>Optional. Specifies whether upper- or lowercase letters are 
    to be ordered first</td>
  </tr>
  </table>
<br>
<hr>
...
<br>
<a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=tryxsl_sort" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="xsl_w3celementref.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Element Reference" /> XSLT Element Reference</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_sort.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_sort.asp#top" target="_top">TOP</a> |
		<a href="el_sort.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
