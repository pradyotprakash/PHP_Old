...
<title>XSLT generate-id() Function</title>
<style>a.menu_func_generateid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">generate-id()</span> Function</h1>
<hr>
...
<p>The generate-id() function returns a string value that uniquely identifies a specified node.</p>

<p>If the node-set specified is empty, an empty string is returned. If you omit 
the node-set parameter, it defaults to the current node.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>node-set</td>
    <td>Optional. Specifies on which node-set to generate a unique id </td>
  </tr>
  </table>
...
&lt;li&gt;<br>
&lt;a href=&quot;#{generate-id(artist)}&quot;&gt;<br>
&lt;xsl:value-of select=&quot;artist&quot; /&gt;&lt;/a&gt;<br>
&lt;/li&gt;<br>
&lt;/xsl:for-each&gt;<br>
&lt;/ul&gt;<br>
&lt;hr /&gt;<br>
&lt;xsl:for-each select=&quot;catalog/cd&quot;&gt;<br>
Artist: &lt;a name=&quot;{generate-id(artist)}&quot;&gt;<br>
&lt;xsl:value-of select=&quot;artist&quot; /&gt;&lt;/a&gt;<br>
&lt;br /&gt;<br>
...
&lt;/xsl:stylesheet&gt;
	...
	<a target="_blank" href="cdcatalog_generateid.xsl">View the XSL file</a>, 
	and <a target="_blank" href="cdcatalog_generateid.xml">View the result</a>.</p>
<hr>
<a href="xsl_functions.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Function Reference" /> Complete XSLT Function Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_generateid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_generateid.asp#top" target="_top">TOP</a> |
		<a href="func_generateid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
