...
<style>a.menu_el_for-each{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>The &lt;xsl:for-each&gt; element loops through each node in a specified node set.</p>
<hr>
...
&lt;/xsl:stylesheet&gt;</div>
<br>
<a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=tryxsl_for-each_title" class="tryitbtn">Try it yourself &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_for-each.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_for-each.asp#top" target="_top">TOP</a> |
		<a href="el_for-each.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
