...
<title>XSLT Summary</title>
<style>a.menu_xsl_summary{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>You Have Learned XSLT, <span class="color_h1">Now What?</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_editors.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>XSLT Summary</h2>
<p>This tutorial has taught you how to use XSLT to transform 
XML documents into other formats, like XHTML.</p>
<p>You have learned how to add/remove elements and attributes to or from the 
output file.</p>
<p>You have also learned how to rearrange and sort elements, perform tests and 
make decisions about which elements to hide and display.</p>
<p>For more information on XSLT, please look at our
<a href="xsl_w3celementref.asp">XSLT reference</a>.</p>
<hr>
<h2>Now You Know XSLT, What's Next?</h2>
<p>XSL includes 3 languages: XSLT, XPath and XSL-FO, so the next step is to learn about XPath and XSL-FO.</p>
<p><b>XPath</b></p>
<p>XPath is used 
to navigate through elements and attributes in an XML document.</p>
<p>XPath is a major element in the W3C's XSL standard. An understanding of 
XPath is fundamental for advanced use of XML.</p>
<p>Without any XPath knowledge, you will not be able to create XSLT documents.</p>
<p>If you want to learn more about the XPath, please 
visit our <a href="../xpath/default.asp">XPath tutorial</a>.</p>
<p><b>XSL-FO</b></p>
<p>XSL-FO describes the formatting of XML data 
for output to screen, paper or other media.</p>
<p>XSL-FO documents are XML files with information about the output layout and 
output content.</p>
<p>If you want to learn more about XSL-FO, please visit our
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xsl_summary.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xsl_summary.asp#top" target="_top">TOP</a> |
		<a href="xsl_summary.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
