...
<title>XSLT &lt;xsl:decimal-format&gt; Element</title>
<style>a.menu_el_decimal-format{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:decimal-format&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:decimal-format&gt; element defines the characters and symbols to be
used when converting numbers into strings, with the format-number() function.</p>
<p>All countries do not use the same characters for separating the decimal part
from the integer part, and for grouping digits. With the &lt;xsl:decimal-format&gt; element
you can change special characters to other symbols.</p>
<p>This element is a top level element.</p>
<p>The format-number() function can refer to the &lt;xsl:decimal-format&gt; element by name.</p>
<hr>
...
name=&quot;name&quot;<br>
decimal-separator=&quot;char&quot;<br>
grouping-separator=&quot;char&quot;<br>
infinity=&quot;string&quot;<br>
minus-sign=&quot;char&quot;<br>
NaN=&quot;string&quot;<br>
percent=&quot;char&quot;<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>name</td>
    <td>Optional. Specifies a name for this format</td>
  </tr>
  <tr>
    <td>decimal-separator</td>
    <td>char</td>
    <td>Optional. Specifies the decimal point character. Default is &quot;.&quot;</td>
  </tr>
  <tr>
    <td>grouping-separator</td>
    <td>char</td>
    <td>Optional. Specifies the thousands separator character.
      Default is &quot;,&quot;</td>
  </tr>
  <tr>
    <td>infinity</td>
    <td>string</td>
    <td>Optional. Specifies the string used to represent infinity. Default is
      &quot;Infinity&quot;</td>
  </tr>
  <tr>
    <td>minus-sign</td>
    <td>char</td>
    <td>Optional. Specifies the character to represent negative numbers.
      Default is &quot;-&quot;</td>
  </tr>
  <tr>
    <td>NaN</td>
    <td>string</td>
    <td>Optional. Specifies the string used when the value is not a
      number&quot;. Default is &quot;NaN&quot;</td>
  </tr>
  <tr>
    <td>percent</td>
    <td>char</td>
    <td>Optional. Specifies the percentage sign character.
      Default is &quot;%&quot;</td>
  </tr>
  <tr>
    <td>per-mille</td>
    <td>char</td>
    <td>Optional. Specifies the per thousand sign character.
      Default is &quot;&#8240;&quot;</td>
  </tr>
  <tr>
    <td>zero-digit</td>
    <td>char</td>
    <td>Optional. Specifies the digit zero character. Default is &quot;0&quot;</td>
  </tr>
  <tr>
    <td>digit</td>
    <td>char</td>
    <td>Optional. Specifies the character used to indicate a place where a digit is
      required. Default is #</td>
  </tr>
  <tr>
    <td>pattern-separator</td>
    <td>char</td>
    <td>Optional. Specifies the character used to separate positive 
...
<p>The example below shows how to format to European currency (note that the third argument in format-number() refers to the 
name of the &lt;xsl:decimal-format&gt; element:</p>
...
<br>
&lt;xsl:decimal-format name=&quot;euro&quot;<br>
decimal-separator=&quot;,&quot; grouping-separator=&quot;.&quot;/&gt;<br>
<br>
&lt;xsl:template match=&quot;/&quot;&gt;<br>
&lt;xsl:value-of<br>
select=&quot;format-number(26825.8, '#.###,00', 'euro')&quot;/&gt;<br>
&lt;/xsl:template&gt;<br>
<br>
&lt;/xsl:stylesheet&gt;<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_decimal-format.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_decimal-format.asp#top" target="_top">TOP</a> |
		<a href="el_decimal-format.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
