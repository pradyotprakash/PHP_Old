...
<style>a.menu_el_value-of{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:value-of&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:value-of&gt; element can be used to select the value of an XML element 
and add it to the output.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>select</td>
    <td>expression</td>
    <td>Required. An XPath expression that specifies which 
    node/attribute to extract the value from. It works like navigating a file 
	system where a forward slash (/) selects subdirectories.</td>
  </tr>
  <tr>
    <td>disable-output-escaping</td>
    <td>yes<br>
      no</td>
    <td>Optional. &quot;yes&quot; indicates that special characters (like 
    &quot;&lt;&quot;) should be output as is. &quot;no&quot; indicates that special characters (like 
    &quot;&lt;&quot;) should be output as &quot;&amp;lt;&quot;. Default is &quot;no&quot;</td>
  </tr>
</table>
<br>
<hr>
...
<h2>Examples</h2>
<p>The example below puts the values from the first title and artist elements 
and puts it in a table:</p>
...
<br><a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=tryxsl_value-of" class="tryitbtn">Try it yourself &raquo;</a></div>
...
&lt;/xsl:stylesheet&gt;</div>
<br>
<a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=tryxsl_for-each" class="tryitbtn">Try it yourself &raquo;</a></div>
<br>
<hr>
<a href="xsl_w3celementref.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Element Reference" /> XSLT Element Reference</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_value-of.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_value-of.asp#top" target="_top">TOP</a> |
		<a href="el_value-of.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
