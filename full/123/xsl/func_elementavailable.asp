...
<title>XSLT element-available() Function</title>
<style>a.menu_func_elementavailable{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">element-available()</span> Function</h1>
<hr>
...
<p>The element-available() function returns a Boolean value that indicates whether the element specified is supported by the XSLT 
processor.</p>

<p>This function can only be used to test elements that can occur in a template 
body. These elements are: </p>

<ul>
  <li>xsl:apply-imports</li>
  <li>xsl:apply-templates</li>
  <li>xsl:attributes</li>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>string</td>
    <td>Required. Specifies the element to test</td>
  </tr>
  </table>
...
&lt;body&gt;<br>
&lt;xsl:choose&gt;<br>
&lt;xsl:when test=&quot;element-available('xsl:comment')&quot;&gt;<br>
&lt;p&gt;xsl:comment is supported.&lt;/p&gt;<br>
&lt;/xsl:when&gt;<br>
&lt;xsl:otherwise&gt;<br>
&lt;p&gt;xsl:comment is not supported.&lt;/p&gt;<br>
&lt;/xsl:otherwise&gt;<br>
&lt;/xsl:choose&gt;<br>
&lt;xsl:choose&gt;<br>
&lt;xsl:when test=&quot;element-available('xsl:delete')&quot;&gt;<br>
&lt;p&gt;xsl:delete is supported.&lt;/p&gt;<br>
&lt;/xsl:when&gt;<br>
&lt;xsl:otherwise&gt;<br>
&lt;p&gt;xsl:delete is not supported.&lt;/p&gt;<br>
&lt;/xsl:otherwise&gt;<br>
&lt;/xsl:choose&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;<br>
...
&lt;/xsl:stylesheet&gt;
    ...
    <p><a target="_blank" href="elementavailable.xsl">View the XSL file</a> and
	<a target="_blank" href="elementavailable.xml">View the result</a>.<br>
    </p>
<hr>
<a href="xsl_functions.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Function Reference" /> Complete XSLT Function Reference</a>
				<hr />
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_elementavailable.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_elementavailable.asp#top" target="_top">TOP</a> |
		<a href="func_elementavailable.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
