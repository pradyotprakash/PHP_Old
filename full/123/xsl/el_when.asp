...
<title>XSLT &lt;xsl:when&gt; Element</title>
<style>a.menu_el_when{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:when&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:when&gt; element is used to specify an action for the &lt;xsl:choose&gt; element. 
The &lt;xsl:when&gt; element evaluates an expression, and if it returns true, an 
action is performed.</p>
<p><b>Note:</b> The &lt;xsl:when&gt; element is used in conjunction with &lt;xsl:choose&gt; and &lt;xsl:otherwise&gt; 
to express multiple conditional tests.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies a Boolean expression to be tested</td>
  </tr>
</table>

<h3>Example 1</h3>
<p>The code below will add a pink background-color to the artist column WHEN the 
price of the cd is higher than 10.</p>
<div class="code notranslate"><div>
...
<p><a target="_blank" href="cdcatalog.xml">View the XML file</a>,
<a target="_blank" href="cdcatalog_choose.xsl">View the XSL file</a>, and
<a target="_blank" href="cdcatalog_choose.xml">View the result</a>.</p>

<h3>Example 2</h3>
<p>Declare a variable named &quot;color&quot;. Set its value to the color attribute of the 
current element. If the current element has no color attribute, the value of 
&quot;color&quot; will be &quot;green&quot;: </p>
<div class="code notranslate"><div>

&lt;xsl:variable name=&quot;color&quot;&gt;<br>
&nbsp;&nbsp;&lt;xsl:choose&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:when test=&quot;@color&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:value-of select=&quot;@color&quot;/&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/xsl:when&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:otherwise&gt;green&lt;/xsl:otherwise&gt;<br>
&nbsp;&nbsp;&lt;/xsl:choose&gt;<br>
&lt;/xsl:variable&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_when.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_when.asp#top" target="_top">TOP</a> |
		<a href="el_when.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
