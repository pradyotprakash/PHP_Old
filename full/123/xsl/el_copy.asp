...
<title>XSLT &lt;xsl:copy&gt; Element</title>
<style>a.menu_el_copy{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:copy&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:copy&gt; element creates a copy of the current node.&nbsp;</p>
<p><b>Note:</b> Namespace nodes of the current node are automatically copied 
as well, but child nodes and attributes of the current node are not automatically copied!</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>

&lt;xsl:copy use-attribute-sets=&quot;name-list&quot;&gt;<br>
<br>
&nbsp;&nbsp;&lt;!-- Content:template --&gt;<br>
<br>
&lt;/xsl:copy&gt;
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Optional. A white space separated list of attribute-sets
      to apply to the output node, if the node is an element</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_copy.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_copy.asp#top" target="_top">TOP</a> |
		<a href="el_copy.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
