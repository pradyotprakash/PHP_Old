...
<style>a.menu_xsl_choose{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:choose&gt;</span> Element</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_if.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_apply_templates.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The &lt;xsl:choose&gt; element is used in conjunction with &lt;xsl:when&gt; and &lt;xsl:otherwise&gt; to express multiple 
conditional tests.</p>
<hr>
...
&lt;xsl:choose&gt;<br>
  &nbsp;
  &lt;xsl:when test=&quot;<i>expression</i>&quot;&gt;<br>
    &nbsp;&nbsp;&nbsp;
    ... some output ...<br>
  &nbsp;
  &lt;/xsl:when&gt;<br>
...
<h2>Where to put the Choose Condition</h2>
<p>To insert a multiple conditional test against the XML file, add the &lt;xsl:choose&gt;, &lt;xsl:when&gt;, and &lt;xsl:otherwise&gt; elements to the XSL file:</p>
    ...
    &lt;table border=&quot;1&quot;&gt;<br>
      ...
      &lt;tr&gt;<br>
        ...
        &lt;td&gt;&lt;xsl:value-of select=&quot;title&quot;/&gt;&lt;/td&gt;<br>
      	<span class="marked">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;xsl:choose&gt;<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &lt;xsl:when test=&quot;price &amp;gt; 10&quot;&gt;</span><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &lt;td bgcolor=&quot;#ff00ff&quot;&gt;<br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &lt;xsl:value-of select=&quot;artist&quot;/&gt;&lt;/td&gt;<br>
          <span class="marked">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/xsl:when&gt;<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &lt;xsl:otherwise&gt;</span><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &lt;td&gt;&lt;xsl:value-of select=&quot;artist&quot;/&gt;&lt;/td&gt;<br>
          <span class="marked">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/xsl:otherwise&gt;<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &lt;/xsl:choose&gt;</span><br>
      &nbsp;&nbsp;&nbsp;
      &lt;/tr&gt;<br>
...
<br><a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=cdcatalog_choose" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>The code above will add a pink background-color to the &quot;Artist&quot; column WHEN the price of the CD is higher than 10.</p>
<hr>

<h2>Another Example</h2>
<p>Here is another example that contains two &lt;xsl:when&gt; elements:</p>
...
<br><a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=cdcatalog_choose2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<p>The code above will add a pink background color to the &quot;Artist&quot; column WHEN the 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xsl_choose.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xsl_choose.asp#top" target="_top">TOP</a> |
		<a href="xsl_choose.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
