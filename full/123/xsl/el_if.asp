...
<style>a.menu_el_if{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:if&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:if&gt; element contains a template that will be applied only if a specified condition is true.</p>
<p><b>Tip:</b> Use &lt;xsl:choose&gt; in conjunction with &lt;xsl:when&gt; and &lt;xsl:otherwise&gt; to 
express multiple conditional tests!</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>test</td>
    <td>expression</td>
    <td>Required. Specifies the condition to be tested</td>
  </tr>
</table>
<br>
<hr>
...
<p>Select the values of title and artist IF the price of the CD is higher than 
10:</p>
...
<br>
<a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=tryxsl_if" class="tryitbtn">Try it yourself &raquo;</a>
</div>

<p>Display the title of each CD. Insert &quot;, &quot; between each CD-title if it is not 
the last CD or the last but one. If it is the last CD, add &quot;!&quot; behind the title. 
If it is the last but one CD, add &quot;, and &quot; behind the title:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/xsl:if&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:if test=&quot;position()=last()-1&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:text&gt; and &lt;/xsl:text&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/xsl:if&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:if test=&quot;position()=last()&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:text&gt;!&lt;/xsl:text&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/xsl:if&gt;<br>
...
<br>
<a target="_blank" href="tryxslt.asp?xmlfile=cdcatalog&amp;xsltfile=tryxsl_if2" class="tryitbtn">Try it yourself &raquo;</a>
</div>
<br>
<hr>
<a href="xsl_w3celementref.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Element Reference" /> XSLT Element Reference</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_if.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_if.asp#top" target="_top">TOP</a> |
		<a href="el_if.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
