...
<title>XSLT &lt;xsl:call-template&gt; Element</title>
<style>a.menu_el_call-template{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:call-template&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:call-template&gt; element calls a named template.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>

&lt;xsl:call-template name=&quot;templatename&quot;&gt;<br>
<br>
&nbsp;&nbsp;&lt;!-- Content:xsl:with-param* --&gt;<br>
<br>
&lt;/xsl:call-template&gt;
...
<table class="reference notranslate">
  ...
  <tr>
    <td>name</td>
    <td>templatename</td>
    <td>Required. Specifies the name of the template to be called</td>
  </tr>
</table>
<h3>Example 1</h3>
...
&lt;xsl:template match=&quot;car&quot;&gt;<br>
&nbsp;&nbsp;&lt;xsl:call-template name=&quot;description&quot;/&gt;<br>
&lt;/xsl:template&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_call-template.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_call-template.asp#top" target="_top">TOP</a> |
		<a href="el_call-template.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
