...
<title>XSLT unparsed-entity-uri() Function</title>
<style>a.menu_func_unparsedentityuri{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">unparsed-entity-uri()</span> Function</h1>
<hr>
...
<p>The unparsed-entity-uri() function returns the URI of an unparsed entity. The 
name of the entity must match the passed argument. If there is no such entity an 
empty string is returned.</p>

<p>If the DTD contains the following declaration:</p>

<p>&lt;!ENTITY pic SYSTEM &quot;http://www.w3schools.com/picture.jpg&quot; NDATA JPEG&gt;</p>

<p>the following expression:</p>

<p>unparsed-entity-uri('pic')</p>

<p>will return the URI for the file &quot;picture.jpg&quot;.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>string</td>
    <td>Required. Specifies the name of an unparsed entity</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_unparsedentityuri.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_unparsedentityuri.asp#top" target="_top">TOP</a> |
		<a href="func_unparsedentityuri.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
