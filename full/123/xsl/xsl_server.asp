...
<style>a.menu_xsl_server{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_client.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_editxml.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">To make XML data available to all kind of browsers, we 
can transform the XML document on the
SERVER and send it&nbsp; back to the browser as XHTML.</p>
<hr>
...
can transform the XML document on the
server and send back to the browser as XHTML.</p>
  ...
  &lt;body&gt;<br>
    ...
    &lt;table border=&quot;1&quot;&gt;<br>
      ...
      &lt;tr bgcolor=&quot;#9acd32&quot;&gt;<br>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &lt;th style=&quot;text-align:left&quot;=&quot;left&quot;&gt;Artist&lt;/th&gt;<br>
      &nbsp;&nbsp;&nbsp;
      &lt;/tr&gt;<br>
      &nbsp;&nbsp;&nbsp;
...
<h2>PHP Code: Transform XML to XHTML on the Server</h2>
<p>Here is the PHP source code needed to transform the XML file to XHTML on the server:</p>

<div class="code notranslate"><div>

	&lt;?php<br>// Load XML file<br>$xml = new DOMDocument;<br>$xml-&gt;load('cdcatalog.xml');<br>
	<br>// Load XSL file<br>$xsl = new DOMDocument;<br>$xsl-&gt;load('cdcatalog.xsl');<br><br>// 
	Configure the transformer<br>$proc = new XSLTProcessor;<br><br>// Attach the xsl 
	rules<br>$proc-&gt;importStyleSheet($xsl);<br>
	<br>echo $proc-&gt;transformToXML($xml);<br>?&gt;
</div></div>

<p><b>Tip:</b> If you don't know how to write PHP, please study our
<a href="../php/default.asp">PHP tutorial</a>.</p>
<p><a href="cdcatalog.php" target="_blank">See how it works with PHP</a>.</p>
<hr>

<h2>ASP Code: Transform XML to XHTML on the Server</h2>
...
<p><a href="cdcatalog.asp" target="_blank">See how it works with ASP</a>.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="xsl_client.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="xsl_editxml.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="xsl_server.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="xsl_server.asp#top" target="_top">TOP</a> |
		<a href="xsl_server.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
