...
<title>XSLT &lt;xsl:output&gt; Element</title>
<style>a.menu_el_output{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:output&gt;</span> Element</h1>
<hr>
<a href="xsl_w3celementref.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Element Reference" /> Complete XSLT Element Reference</a>
<hr>


<h2>Definition and Usage</h2>
<p>The &lt;xsl:output&gt; element defines the format of the output document.</p>
<p><b>Note</b>: &lt;xsl:output&gt; is a top-level element, and must appear as a
child node of &lt;xsl:stylesheet&gt; or &lt;xsl:transform&gt;.</p>
<hr>
...
&lt;xsl:output<br>
method=&quot;xml|html|text|name&quot;<br>
version=&quot;string&quot;<br>
encoding=&quot;string&quot;<br>
omit-xml-declaration=&quot;yes|no&quot;<br>
standalone=&quot;yes|no&quot;<br>
doctype-public=&quot;string&quot;<br>
doctype-system=&quot;string&quot;<br>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>xml<br>
      ...
      text<br>
      name</td>
    <td>Optional. Defines the output format. The default is XML 
    (but if the first child of the root node is &lt;html&gt; and there are no 
    preceding text nodes, then the default is HTML)<p>Netscape 6 only supports 
    &quot;html&quot; and &quot;xml&quot;</p></td>
  </tr>
  <tr>
    <td>version</td>
    <td>string</td>
    <td>Optional. Sets the W3C version number for the output format 
    (only used with method=&quot;html&quot; or method=&quot;xml&quot;)</td>
  </tr>
  <tr>
    <td>encoding</td>
    <td>string</td>
    <td>Optional. Sets the value of the encoding attribute in the 
    output</td>
  </tr>
  <tr>
    ...
    <td>yes<br>
      no</td>
    <td>Optional. &quot;yes&quot; specifies that the XML
      declaration (&lt;?xml...?&gt;) should be omitted in the output.
      &quot;no&quot; specifies that the XML declaration should be included in
      the output. The default is &quot;no&quot;</td>
  </tr>
  <tr>
    <td>standalone</td>
    <td>yes<br>
      no</td>
    <td>Optional. &quot;yes&quot; specifies that a standalone 
    ...
    <p>This attribute is not supported by Netscape 6</p></td>
  </tr>
  <tr>
    <td>doctype-public</td>
    <td>string</td>
    <td>Optional. Sets the value of the PUBLIC attribute of the 
    DOCTYPE declaration in the output</td>
  </tr>
  <tr>
    <td>doctype-system</td>
    <td>string</td>
    <td>Optional. Sets the value of the SYSTEM attribute of the 
    DOCTYPE declaration in the output</td>
  </tr>
  <tr>
    <td>cdata-section-elements</td>
    <td>namelist</td>
    <td>Optional. A white-space separated list of elements whose 
    text contents should be written as CDATA sections</td>
  </tr>
  <tr>
    <td>indent</td>
    <td>yes<br>
      no</td>
    <td>Optional. &quot;yes&quot; indicates that the output should
      be indented according to its hierarchic structure. &quot;no&quot; indicates that the 
    output should not be indented according to its hierarchic structure.<p>This 
    attribute is not supported by Netscape 6</p></td>
  </tr>
  <tr>
    <td>media-type</td>
    <td>string</td>
    <td>Optional. Defines the MIME type of the output. The default 
    is &quot;text/xml&quot; 
    <p>This attribute is not supported by Netscape 6</p></td>
  </tr>
</table>
...
<h3>Example 1</h3>
<p>The output in this example will be an XML document, version 1.0. The
character encoding is set to &quot;UTF-8&quot; and the output will be indented for
readability:</p>
<div class="code notranslate"><div>
...
<h3>Example 2</h3>
<p>The output in this example will be an HTML document, version 4.0. The
character encoding is set to &quot;UTF-8&quot; and the output will be indented for
readability:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_output.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_output.asp#top" target="_top">TOP</a> |
		<a href="el_output.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
