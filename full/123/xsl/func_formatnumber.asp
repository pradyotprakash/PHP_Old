...
<title>XSLT format-number() Function</title>
...
<h1>XSLT <span class="color_h1">format-number()</span> Function</h1>
<hr>
...
<p>The format-number() function is used to convert a number into a string.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>number</td>
    <td>Required. Specifies the number to be formatted</td>
  </tr>
  <tr>
    <td>format</td>
    <td>Required. Specifies the format pattern. Here are some of 
    the characters used in the formatting pattern:<ul>
      <li>0 (Digit)</li>
      <li># (Digit, zero shows as absent)</li>
      <li>. (The position of the decimal point Example: ###.##)</li>
      <li>, (The group separator 
      for thousands. Example: ###,###.##)</li>
      <li>% (Displays the number as a percentage. Example: ##%)</li>
      <li>; (Pattern separator. The first pattern will be used for positive numbers 
      and the second for negative numbers)</li>
    </ul>
    </td>
  </tr>
  <tr>
...
&lt;xsl:value-of select='format-number(500100, &quot;###,###.00&quot;)' /&gt;<br>
&lt;br /&gt;<br>
&lt;xsl:value-of select='format-number(0.23456, &quot;#%&quot;)' /&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;<br>
&lt;/xsl:template&gt;<br>
<br>
&lt;/xsl:stylesheet&gt;
    ...
    <p><a target="_blank" href="formatnumber.xsl">View the XSL file</a> and
	<a target="_blank" href="formatnumber.xml">View the result</a>.</p>
<hr>
<a href="xsl_functions.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="XSLT Function Reference" /> Complete XSLT Function Reference</a>
				<hr />
				<!-- SmallPS -->
