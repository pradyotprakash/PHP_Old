...
<title>XSLT &lt;xsl:message&gt; Element</title>
<style>a.menu_el_message{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>XSLT <span class="color_h1">&lt;xsl:message&gt;</span> Element</h1>
<hr>
...
<p>The &lt;xsl:message&gt; element writes a message to the output. This element is primarily used to report errors.</p>
<p>This element can contain almost any other XSL element (&lt;xsl:text&gt;, &lt;xsl:value-of&gt;, etc.).</p>
<p>The terminate attribute gives you the choice to either quit or continue the processing when an error occurs.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>

&lt;xsl:message terminate=&quot;yes|no&quot;&gt;<br>
<br>
&nbsp;&nbsp;&lt;!-- Content:template --&gt;<br>
<br>
&lt;/xsl:message&gt;
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>yes<br>
      no</td>
    <td>Optional. &quot;yes&quot; terminates the processing after
...
<p>Check if artist is an empty string. If yes, we quit the XSL processor and 
display a message:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;Title: &lt;xsl:value-of select=&quot;title&quot;/&gt;&lt;br /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;Artist:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:if test=&quot;artist=''&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;xsl:message terminate=&quot;yes&quot;&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Error: Artist is an empty string!<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/xsl:message&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/xsl:if&gt;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="el_message.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="el_message.asp#top" target="_top">TOP</a> |
		<a href="el_message.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
