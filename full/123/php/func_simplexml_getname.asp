...
<title>PHP getName() Function</title>
<style>a.menu_func_simplexml_getname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">getName()</span> Function</h1>
...
<p>Return the name of the XML element and the children:</p>
<div class="example_code notranslate">
	&lt;?php<br>$xml=&lt;&lt;&lt;XML<br>&lt;?xml version="1.0" standalone="yes"?&gt;<br>&lt;cars&gt;<br>&nbsp; 
	&lt;car id="1"&gt;Volvo&lt;/car&gt;<br>&nbsp; &lt;car id="2"&gt;BMW&lt;/car&gt;<br>&nbsp; &lt;car 
	id="3"&gt;Saab&lt;/car&gt; <br>&lt;/cars&gt;<br>XML;<br><br>$sxe=new 
	SimpleXMLElement($xml);<br>echo $sxe-&gt;getName() . "&lt;br&gt;";<br>foreach 
	($sxe-&gt;children() as $child)<br>&nbsp; {<br>&nbsp; echo $child-&gt;getName() . 
	"&lt;br&gt;";<br>&nbsp; }<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_getname">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getName() function returns the name of the XML element.</p>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns the name of the XML tag referenced by the 
	SimpleXMLElement object, as a string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.1.3+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_getname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_getname.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_getname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
