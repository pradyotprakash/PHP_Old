...
<title>PHP fileowner() Function</title>
<style>a.menu_func_filesystem_fileowner{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fileowner()</span> Function</h1>
<hr>
...
<p>The fileowner() function returns the user ID (owner) of the specified file.</p>
<p>This function returns the user ID on success or 
FALSE on failure.</p>
<h2>Syntax</h2>
...
<p><b>Note:</b> The results of this function are cached. Use clearstatcache() to 
clear the cache.</p>
<p><b>Note:</b> This function doesn't produce meaningful results on Windows 
systems.</p>
<p><b>Tip:</b> Use posix_getpwuid() to convert the user ID to a user name.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fileowner.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fileowner.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fileowner.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
