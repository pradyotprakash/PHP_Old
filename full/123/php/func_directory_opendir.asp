...
<title>PHP opendir() Function</title>
<style>a.menu_func_directory_opendir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">opendir()</span> Function</h1>
...
<p>Open a directory, read its contents, then close:</p>
<div class="example_code notranslate">
&lt;?php<br>$dir = &quot;/images/&quot;;<br><br>// Open a directory, and read its contents<br>if 
	(is_dir($dir)){<br>&nbsp; if ($dh = opendir($dir)){<br>&nbsp;&nbsp;&nbsp; 
	while (($file = readdir($dh)) !== false){<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	echo &quot;filename:&quot; . $file . &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp; 
	closedir($dh);<br>&nbsp; }<br>}<br>?&gt;</div>
<p>Result:</p>
<div class="example_code notranslate">
filename: cat.gif<br>
filename: dog.gif<br>
...
<p>The opendir() function opens a directory handle.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	opendir(<em>path,context</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>path</em></td>
    <td>Required. Specifies the directory path to be opened</td>
  </tr>
  <tr>
    <td><em>context</em></td>
...
<tr>
	...
	<td style="width:80%">Returns the directory handle resource on success. FALSE on 
	failure. Throws an error of level E_WARNING if path is not a valid 
	directory, or if the directory cannot be opened due to permission 
	restrictions or filesysytem errors. You can hide the error output of 
	opendir() by adding '@' to the front of the function name</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0+</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 5.0: The path parameter now supports the <strong>ftp://</strong> URL 
	wrapper</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_directory_opendir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_directory_opendir.asp#top" target="_top">TOP</a> |
		<a href="func_directory_opendir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
