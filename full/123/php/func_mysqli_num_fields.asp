...
<title>PHP mysqli_num_fields() Function</title>
<style>a.menu_func_mysqli_num_fields{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_num_fields()</span> Function</h1>
...
<p>Return the number of fields (columns) in a result set:</p>
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	<br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; // Return the 
	number of fields in result set<br>&nbsp; 
	$fieldcount=mysqli_num_fields($result);<br>&nbsp; printf(&quot;Result set has %d 
	fields.\n&quot;,$fieldcount);<br>&nbsp; // Free result 
...
<p>The mysqli_num_fields() function returns the number of fields (columns) in a result set.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_num_fields(<em>result</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns the number of fields in the result set</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_num_fields.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_num_fields.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_num_fields.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
