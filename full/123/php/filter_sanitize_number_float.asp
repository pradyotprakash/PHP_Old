...
<title>PHP FILTER_SANITIZE_NUMBER_FLOAT Filter</title>
<style>a.menu_filter_sanitize_number_float{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_SANITIZE_NUMBER_FLOAT</span> Filter</h1>
<hr>
...
<p>The FILTER_SANITIZE_NUMBER_FLOAT filter removes all illegal characters from a 
float number.</p>
<p>This filter allows digits and + - by default</p>
<ul>
	<li>Name: &quot;number_float&quot;</li>
	<li>ID-number: 520</li>
</ul>
<p>Possible flags:</p>
<ul>
	<li>FILTER_FLAG_ALLOW_FRACTION - Allow fraction separator (like . )</li>
	<li>FILTER_FLAG_ALLOW_THOUSAND - Allow thousand separator (like , )</li>
	<li>FILTER_FLAG_ALLOW_SCIENTIFIC - Allow scientific notation (like e and E)</li>
</ul>
<hr>
<h2>Example</h2>
...
&lt;?php<br>
$number=&quot;5-2f+3.3pp&quot;;<br>
<br>
var_dump(filter_var($number, FILTER_SANITIZE_NUMBER_FLOAT,<br>
FILTER_FLAG_ALLOW_FRACTION));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_sanitize_number_float.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_sanitize_number_float.asp#top" target="_top">TOP</a> |
		<a href="filter_sanitize_number_float.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
