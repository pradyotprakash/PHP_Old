...
<title>PHP mt_srand() Function</title>
<style>a.menu_func_math_mt_srand{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mt_srand()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_mt_srand">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The mt_srand() function seeds the Mersenne Twister random number generator.</p>
<p><b>Tip:</b> From PHP 4.2.0, the random number generator is seeded automatically 
and there is no need to use this function. </p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	mt_srand(<em>seed</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>seed</em></td>
    <td>Optional. Specifies the seed value</td>
  </tr>
  </table>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 4.2.0: Random number generator is now seeded automatically</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_mt_srand.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_mt_srand.asp#top" target="_top">TOP</a> |
		<a href="func_math_mt_srand.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
