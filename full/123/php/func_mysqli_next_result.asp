...
<title>PHP mysqli_next_result() Function</title>
<style>a.menu_func_mysqli_next_result{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_next_result()</span> Function</h1>
...
<p>Perform multiple queries against the database. Use mysqli_next_result() function 
to prepare the next result set:</p>
...
<p>The mysqli_next_result() function prepares the next result set from 
<a href="func_mysqli_multi_query.asp">mysqli_multi_query()</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_next_result(<em>connection</em>)<em>;</em></div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_next_result.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_next_result.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_next_result.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
