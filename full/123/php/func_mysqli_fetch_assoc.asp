...
<title>PHP mysqli_fetch_assoc() Function</title>
<style>a.menu_func_mysqli_fetch_assoc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_fetch_assoc()</span> Function</h1>
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	$result=mysqli_query($con,$sql)<br><br>// Associative array<br>
	$row=mysqli_fetch_assoc($result);<br>printf (&quot;%s 
...
<p>The mysqli_fetch_array() function fetches a result row as an associative array.</p>
<p><strong>Note:</strong> Fieldnames returned from this function are case-sensitive.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_fetch_assoc(<em>result</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an associative array of strings representing the fetched 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_fetch_assoc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_fetch_assoc.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_fetch_assoc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
