...
<title>PHP chgrp() Function</title>
<style>a.menu_func_filesystem_chgrp{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">chgrp()</span> Function</h1>
<hr>
...
<p>The chgrp() function changes the usergroup of the specified file.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>group</td>
    <td>Required. Specifies the new group. Can be a group name or a 
	group ID</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_chgrp.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_chgrp.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_chgrp.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
