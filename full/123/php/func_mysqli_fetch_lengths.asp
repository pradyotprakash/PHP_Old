...
<title>PHP mysqli_fetch_lengths() Function</title>
<style>a.menu_func_mysqli_fetch_lengths{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_fetch_lengths()</span> Function</h1>
...
<p>Return the length of the fields in the result set:</p>
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT * FROM Persons ORDER BY Lastname&quot;;<br>
	<br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; 
	$row=mysqli_fetch_row($result);<br><br>&nbsp; // Display field lengths<br>&nbsp; 
	foreach (mysqli_fetch_lengths($result) as $i=&gt;$val)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
	printf(&quot;Field %2d has length: %2d\n&quot;,$i+1,$val);<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp; // Free result 
...
<p>The mysqli_fetch_lengths() function returns the length of the fields in the result set.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_fetch_lengths(<em>result</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an array if integer that represents the size of each 
	field (column). FALSE if an error occurs</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_fetch_lengths.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_fetch_lengths.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_fetch_lengths.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
