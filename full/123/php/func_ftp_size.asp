...
<title>PHP ftp_size() Function</title>
<style>a.menu_func_ftp_size{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_size()</span> Function</h1>
...
<p>Get size of a file on the FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$file = &quot;serverfile.txt&quot;;<br>
	<br>// get size of $file<br>$fsize = ftp_size($ftp_conn, $file);<br>if 
	($fsize != -1)<br>&nbsp; {<br>&nbsp; echo &quot;$file is $fsize bytes.&quot;;<br>&nbsp; 
	}<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error getting file size.&quot;;<br>&nbsp; }<br>
...
<p>The ftp_size() function returns the size of a specified file on the FTP server.</p>
<p><b>Note:</b> Not all FTP servers support this function!</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_size(<em>ftp_connection,file</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>file</em></td>
    <td>Required. Specifies the server file to check</td>
  </tr>
</table>
<br>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns the file size in bytes on success, or -1 on 
	error</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_size.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_size.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_size.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
