...
<title>PHP localtime() Function</title>
<style>a.menu_func_date_localtime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">localtime()</span> Function</h1>
...
<p>Print local time as an indexed and as an associative array:</p>
<div class="example_code notranslate">

&lt;?php<br>
	print_r(localtime());<br>echo &quot;&lt;br&gt;&lt;br&gt;&quot;;<br>
	print_r(localtime(time(),true));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_localtime">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The localtime() function returns the local time.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
localtime(<em>timestamp,is_assoc);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies a Unix timestamp that defaults to the current local time, 
	time(), if no <em>timestamp</em> is specified</td>
  </tr>
  <tr>
    <td><em>is_assoc</em></td>
    <td>Optional. Specifies whether to return an associative or indexed array. FALSE 
	= the array returned is an indexed array. TRUE = the 
	array returned is an associative array. FALSE is default.
<p>The keys of the associative array are:</p>
<ul>
		<li>[tm_sec] - seconds</li>
		<li>[tm_min] - minutes</li>
		<li>[tm_hour] - hour</li>
		<li>[tm_mday] - day of the month</li>
		<li>[tm_mon] - month of the year (January=0)</li>
		<li>[tm_year] - Years since 1900</li>
		<li>[tm_wday] - Day of the week (Sunday=0)</li>
		<li>[tm_yday] - Day of the year</li>
		<li>[tm_isdst] - Is daylight savings time in effect</li>
</ul></td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an array that contains the components of a Unix 
	timestamp </td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_localtime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_localtime.asp#top" target="_top">TOP</a> |
		<a href="func_date_localtime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
