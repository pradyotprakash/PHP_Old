...
<title>PHP date_timestamp_get() Function</title>
<style>a.menu_func_date_timestamp_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_timestamp_get()</span> Function</h1>
...
<p>Return the Unix timestamp for today's date and time:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$date=date_create();<br>echo date_timestamp_get($date);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_timestamp_get">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_timestamp_get() function returns the Unix timestamp.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_timestamp_get(<em>object);</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns the Unix timestamp that represents the date</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.3+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_timestamp_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_timestamp_get.asp#top" target="_top">TOP</a> |
		<a href="func_date_timestamp_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
