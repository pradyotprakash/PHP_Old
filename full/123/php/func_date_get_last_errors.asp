...
<title>PHP date_get_last_errors() Function</title>
<style>a.menu_func_date_get_last_errors{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_get_last_errors()</span> Function</h1>
...
<p>Return the warnings and errors while parsing a date string:</p>
<div class="example_code notranslate">
&lt;?php<br>
	date_create(&quot;gyuiyiuyui%&amp;&amp;/&quot;);<br>
	print_r(date_get_last_errors());<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_get_last_errors">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_get_last_errors() function returns the warnings/errors found while parsing a date string.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	date_get_last_errors();</div></div>

<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td style="width:80%">Returns an array that contains information about the 
	errors/warnings</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_get_last_errors.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_get_last_errors.asp#top" target="_top">TOP</a> |
		<a href="func_date_get_last_errors.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
