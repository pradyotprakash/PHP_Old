...
<title>PHP chroot() Function</title>
<style>a.menu_func_directory_chroot{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">chroot()</span> Function</h1>
...
<p>Change the root directory:</p>
<div class="example_code notranslate">
&lt;?php<br>// Change root directory<br>
	chroot(&quot;/path/to/chroot/&quot;);<br><br>// Get current directory<br>
	echo getcwd();<br>?&gt;</div>
<p>Result:</p>
<div class="example_code notranslate">
	/</div>
...
<p>The chroot() function changes the root directory of the current process to
<em>directory</em>, and changes the current working directory to &quot;/&quot;.</p>
<p><strong>Note:</strong> This function requires root privileges, and is only 
available to GNU and BSD systems, and only when using the CLI, CGI or Embed 
SAPI. This function is not implemented on Windows platforms.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	chroot(<em>directory</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the path to change the root directory to</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_directory_chroot.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_directory_chroot.asp#top" target="_top">TOP</a> |
		<a href="func_directory_chroot.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
