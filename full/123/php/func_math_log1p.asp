...
<title>PHP log1p() Function</title>
<style>a.menu_func_math_log1p{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">log1p()</span> Function</h1>
...
<p>Return log(1+number) for different numbers:</p>
<div class="example_code notranslate">
&lt;?php<br>
echo(log1p(2.7183) . &quot;&lt;br&gt;&quot;);<br>
echo(log1p(2) . &quot;&lt;br&gt;&quot;);<br>
echo(log1p(1) . &quot;&lt;br&gt;&quot;);<br>
echo(log1p(0));<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_log1p">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The log1p() function returns log(1+number), computed in a way that is 
accurate even when the value of <em>number</em> is close to zero.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	log1p(<em>number</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the number to process</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">log(1+number)</td>
</tr>
<tr>
	<th>Return Type:</th>
	<td>Float</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 5.3: The log1p() function is now available on all platforms</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_log1p.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_log1p.asp#top" target="_top">TOP</a> |
		<a href="func_math_log1p.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
