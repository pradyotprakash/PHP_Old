...
<style>a.menu_func_simplexml_count{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Count the children of the car nodes:</p>
<div class="example_code notranslate">
	&lt;?php<br>$xml=&lt;&lt;&lt;XML<br>&nbsp; &lt;cars&gt;<br>&nbsp;&nbsp;&nbsp; &lt;car 
	name=&quot;Volvo&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;child/&gt;<br>&nbsp;&nbsp;&nbsp; &lt;child/&gt;<br>&nbsp;&nbsp;&nbsp; 
	&lt;child/&gt;<br>&nbsp;&nbsp;&nbsp; &lt;child/&gt;<br>&nbsp; &lt;/car&gt;<br>&nbsp; &lt;car name=&quot;BMW&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;child/&gt;<br>
	&nbsp;&nbsp;&nbsp;
	&lt;child/&gt;<br>&nbsp; &lt;/car&gt;<br>&lt;/cars&gt;<br>XML;<br><br>$elem=new 
	SimpleXMLElement($xml);<br>foreach ($elem as $car)<br>&nbsp; {<br>&nbsp; printf(&quot;%s has %d 
	children.&lt;br&gt;&quot;, $car['name'], $car-&gt;count());<br>&nbsp; }<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_count">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The count() function counts the children of a specified node.</p>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns the number of children of an element</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.3+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_count.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_count.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_count.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
