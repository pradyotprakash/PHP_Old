...
<title>PHP printf() Function</title>
<style>a.menu_func_string_printf{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">printf()</span> Function</h1>
...
<div class="example_code notranslate">
	...
	&lt;?php<br>$number = 9;<br>$str = &quot;Beijing&quot;;<br>printf(&quot;There are %u 
	million bicycles in %s.&quot;,$number,$str);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_printf">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The printf() function outputs a formatted string.</p>
...
<p><b>Note: </b>If there are more % signs than arguments, you must use placeholders. A placeholder is 
inserted after the % sign, 
and consists of the argument- number and &quot;\$&quot;. See example two.</p>
...
printf(<em>format,arg1,arg2,arg++</em>)
...
printf(&quot;%f&quot;,$number);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_printf2">Run example &raquo;</a>
</div>
<br>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_printf3">Run example &raquo;</a>
</div>
<br>
...
<div class="example_code notranslate">
	...
	&lt;?php<br>$str1 = &quot;Hello&quot;;<br>$str2 = &quot;Hello world!&quot;;<br><br>printf(&quot;[%s]&lt;br&gt;&quot;,$str1);<br>
	printf(&quot;[%8s]&lt;br&gt;&quot;,$str1);<br>printf(&quot;[%-8s]&lt;br&gt;&quot;,$str1);<br>printf(&quot;[%08s]&lt;br&gt;&quot;,$str1); <br>printf(&quot;[%'*8s]&lt;br&gt;&quot;,$str1);<br>printf(&quot;[%8.8s]&lt;br&gt;&quot;,$str2);
	<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_printf5">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_printf.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_printf.asp#top" target="_top">TOP</a> |
		<a href="func_string_printf.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
