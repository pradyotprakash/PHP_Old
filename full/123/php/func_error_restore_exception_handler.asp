...
<title>PHP restore_exception_handler() Function</title>
<style>a.menu_func_error_restore_exception_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">restore_exception_handler()</span> Function</h1>
<hr>
...
<p>The restore_exception_handler() function restores the previous exception handler.</p>
<p>This function is used to restore the previous exception handler after changing 
it with the set_exception_handler() function. </p>
...
<p><b>Tip:</b> The previous exception handler could be the built in exception handler or 
...
<b>Fatal error</b>: Uncaught exception 'Exception' with message<br>
'Uncaught Exception occured' in C:\webfolder\test.php:4<br>
Stack trace: #0 {main} thrown in <b>C:\webfolder\test.php</b> on line <b>4</b>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_error_restore_exception_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_error_restore_exception_handler.asp#top" target="_top">TOP</a> |
		<a href="func_error_restore_exception_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
