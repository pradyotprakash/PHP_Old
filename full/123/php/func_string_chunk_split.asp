...
<style>a.menu_func_string_chunk_split{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">chunk_split()</span> Function</h1>
...
<p>Split the string after each character and add a &quot;.&quot; after each split:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_chunk_split">Run example &raquo;</a>
</div>
<hr>
...
<p><b>Note:</b> This function does not alter the original string.</p>
<hr>
...
chunk_split(<em>string,length,end</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>length</em></td>
    <td>Optional. A number that defines the length of the chunks. 
	Default is 76</td>
  </tr>
  <tr>
    <td><em>end</em></td>
    <td>Optional. A string that defines what to place at the end of 
...
<tr>
	...
	<td style="width:80%">Returns the split string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>Split the string after each sixth character and add a "..." after each split:</p>
<div class="example_code notranslate">
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_chunk_split2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_chunk_split.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_chunk_split.asp#top" target="_top">TOP</a> |
		<a href="func_string_chunk_split.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
