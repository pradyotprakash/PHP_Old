...
<title>PHP array_diff_assoc() Function</title>
<style>a.menu_func_array_diff_assoc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_diff_assoc()</span> Function</h1>
...
&lt;?php<br>
	...
	$a2=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;);<br><br>$result=array_diff_assoc($a1,$a2);<br>
	print_r($result);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff_assoc">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_diff_assoc() function compares <strong>the keys and values</strong> 
...
array_diff_assoc(<em>array1,array2,array3...</em>);</div></div>
<br>
...
<p>Compare the<strong> keys and values</strong> of two arrays, and 
return the differences:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;,&quot;d&quot;=&gt;&quot;yellow&quot;);<br>
	$a2=array(&quot;e&quot;=&gt;&quot;red&quot;,&quot;f&quot;=&gt;&quot;green&quot;,&quot;g&quot;=&gt;&quot;blue&quot;);<br><br>
	$result=array_diff_assoc($a1,$a2);<br>print_r($result);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff_assoc2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Compare the<strong> keys and values</strong> of three arrays, and 
return the differences:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;,&quot;d&quot;=&gt;&quot;yellow&quot;);<br>
	$a2=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;f&quot;=&gt;&quot;green&quot;,&quot;g&quot;=&gt;&quot;blue&quot;);<br>$a3=array(&quot;h&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;g&quot;=&gt;&quot;blue&quot;);<br>
	<br>$result=array_diff_assoc($a1,$a2,$a3);<br>print_r($result);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff_assoc3">Run example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_diff_assoc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_diff_assoc.asp#top" target="_top">TOP</a> |
		<a href="func_array_diff_assoc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
