...
<title>PHP in_array() Function</title>
<style>a.menu_func_array_in_array{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">in_array()</span> Function</h1>
...
<p>Search for the value &quot;Glenn&quot; in an array and output some text:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_in_array">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The in_array() function searches an array for a specific value.</p>
<p><b>Note:</b> If the search parameter is a string and the type parameter is 
set to TRUE, the search is case-sensitive.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
in_array(<em>search,array,type</em>)
</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>search</em></td>
    <td>Required. Specifies the what to search for</td>
  </tr>
	<tr>
    <td><em>array</em></td>
    <td>Required. Specifies the array to search</td>
  </tr>
  <tr>
    <td><em>type</em></td>
    <td>
	Optional. If this parameter is set to TRUE, the in_array() function 
...
<tr>
	...
	<td style="width:80%">Returns TRUE if the value is found in the array, or FALSE 
	otherwise</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 4.2, the search parameter may now be an array</td>
</tr>
</table>
<br>
<hr>
...
<div class="example_code notranslate">
&lt;?php<br>
	$people = array(&quot;Peter&quot;, &quot;Joe&quot;, &quot;Glenn&quot;, &quot;Cleveland&quot;, 23);<br><br>if (in_array(&quot;23&quot;, 
	$people, TRUE))<br>&nbsp; {<br>&nbsp; echo &quot;Match found&lt;br&gt;&quot;;<br>&nbsp; }<br>
	else<br>&nbsp; {<br>&nbsp; echo &quot;Match not found&lt;br&gt;&quot;;<br>&nbsp; } <br>if (in_array(&quot;Glenn&quot;,$people, 
	TRUE))<br>&nbsp; {<br>&nbsp; echo &quot;Match found&lt;br&gt;&quot;;<br>&nbsp; }<br>else<br>&nbsp; 
	{<br>&nbsp; echo &quot;Match not found&lt;br&gt;&quot;;<br>&nbsp; }<br><br>if (in_array(23,$people, 
	TRUE))<br>&nbsp; {<br>&nbsp; echo &quot;Match found&lt;br&gt;&quot;;<br>&nbsp; }<br>else<br>&nbsp; 
	{<br>&nbsp; echo &quot;Match not found&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_in_array2">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_in_array.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_in_array.asp#top" target="_top">TOP</a> |
		<a href="func_array_in_array.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
