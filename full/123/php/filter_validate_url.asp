...
<title>PHP FILTER_VALIDATE_URL Filter</title>
<style>a.menu_filter_validate_url{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_VALIDATE_URL</span> Filter</h1>
<hr>
...
<p>The FILTER_VALIDATE_URL filter validates value as a URL.</p>
<ul>
...
<p>Possible&nbsp; flags:</p>
<ul>
	<li>FILTER_FLAG_SCHEME_REQUIRED - Requires URL to be an RFC compliant URL 
	(like http://example)</li>
	<li>FILTER_FLAG_HOST_REQUIRED - Requires URL to include host name (like 
	http://www.example.com)</li>
	<li>FILTER_FLAG_PATH_REQUIRED - Requires URL to have a path after the domain 
	name (like www.example.com/example1/test2/)</li>
	<li>FILTER_FLAG_QUERY_REQUIRED - Requires URL to have a query string (like &quot;example.php?name=Peter&amp;age=37&quot;)</li>
</ul>
<hr>
<h2>Example 1</h2>
...
&lt;?php<br>
$url = &quot;example.php?name=Peter&amp;age=37&quot;;<br>
<br>
if(!filter_var($url, FILTER_VALIDATE_URL,<br>
FILTER_FLAG_QUERY_REQUIRED))<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo &quot;URL is not valid&quot;;<br>
&nbsp;&nbsp;}<br>
else<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_validate_url.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_validate_url.asp#top" target="_top">TOP</a> |
		<a href="filter_validate_url.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
