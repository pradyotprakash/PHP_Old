...
<title>PHP utf8_encode() Function</title>
<style>a.menu_func_xml_utf8_encode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">utf8_encode()</span> Function</h1>
<hr>
...
<p>The utf8_encode() function encodes an ISO-8859-1 string to UTF-8.</p>
<p>Unicode is a universal standard, and has been developed to describe all 
possible characters of all languages plus a lot of symbols with one unique 
number for each character/symbol. </p>
<p>However, it is not always possible to transfer a Unicode character to another 
computer reliably. UTF-8 has been developed to transfer a Unicode character from 
one computer to another</p>
<p>This function returns the encoded string on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_utf8_encode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_utf8_encode.asp#top" target="_top">TOP</a> |
		<a href="func_xml_utf8_encode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
