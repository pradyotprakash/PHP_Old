...
<title>PHP strncasecmp() Function</title>
<style>a.menu_func_string_strncasecmp{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strncasecmp()</span> Function</h1>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strncasecmp">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strncasecmp() function compares two strings.</p>
<p><b>Note:</b> The strncasecmp() is binary-safe and case-insensitive.</p>
<p><strong>Tip:</strong> This function is similar to the
<a href="func_string_strcasecmp.asp">strcasecmp()</a> function, except that 
strcasecmp() does not have the length parameter. </p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

strncasecmp(<em>string1,string2,length</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>length</em></td>
    <td>Required. Specify the number of characters from each string 
	to be used in the comparison</td>
  </tr>
  </table>
...
&lt;?php<br>echo strncasecmp(&quot;Hello&quot;,&quot;Hello&quot;,6);<br>echo &quot;&lt;br&gt;&quot;;<br>echo strncasecmp(&quot;Hello&quot;,&quot;hELLo&quot;,6);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strncasecmp2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strncasecmp.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strncasecmp.asp#top" target="_top">TOP</a> |
		<a href="func_string_strncasecmp.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
