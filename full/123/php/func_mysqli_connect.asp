...
<title>PHP mysqli_connect() Function</title>
<style>a.menu_func_mysqli_connect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_connect()</span> Function</h1>
...
<p>The mysqli_connect() function opens a new connection to the MySQL server.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_connect(<em>host,username,password,dbname,port,socket</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an object representing the connection to the MySQL 
	server</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_connect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_connect.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_connect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
