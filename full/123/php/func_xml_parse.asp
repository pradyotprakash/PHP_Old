...
<title>PHP xml_parse() Function</title>
<style>a.menu_func_xml_parse{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_parse()</span> Function</h1>
<hr>
...
<p>The xml_parse() function parses an XML document.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>end</td>
    <td>Optional. If this parameter is TRUE, the data in the &quot;xml&quot; 
	parameter is the last piece of data sent in this parse.<p><b>Note:</b> 
	Entity errors are reported at the end of the parse. And will only show if 
	the &quot;end&quot; parameter is TRUE</td>
  </tr>
  </table>
<br>
...
<p><b>Tip:</b> To create an XML parser, use the 
xml_parser_create() function.</p>
...
<h2>Example 2</h2>
<p>Using the same XML file but displaying the XML data in another way:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_parse.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_parse.asp#top" target="_top">TOP</a> |
		<a href="func_xml_parse.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
