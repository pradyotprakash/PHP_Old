...
<title>PHP mysqli_select_db() Function</title>
<style>a.menu_func_mysqli_select_db{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_select_db()</span> Function</h1>
...
<p>Change the default database for the connection:</p>
...
&nbsp;&nbsp;}<br><br>// ...some PHP code for database &quot;my_db&quot;...<br><br>// 
	Change database to &quot;test&quot;<br>mysqli_select_db($con,&quot;test&quot;);<br><br>// 
	...some PHP code for database &quot;test&quot;...<br><br>mysqli_close($con);<br>
?&gt;
</div>
</div>
<hr>
...
<p>The mysqli_select_db() function is used to change the default database for the connection.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_select_db(<em>connection,dbname</em>)<em>;</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>dbname</em></td>
    <td>Required. Specifies the default database to be used</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_select_db.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_select_db.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_select_db.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
