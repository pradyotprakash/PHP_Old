...
<title>PHP number_format() Function</title>
<style>a.menu_func_string_number_format{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">number_format()</span> Function</h1>
...
<div class="example_code notranslate">
	...
	&lt;?php<br>echo number_format(&quot;1000000&quot;).&quot;&lt;br&gt;&quot;;<br>echo number_format(&quot;1000000&quot;,2).&quot;&lt;br&gt;&quot;;<br>
	echo number_format(&quot;1000000&quot;,2,&quot;,&quot;,&quot;.&quot;);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_number_format">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The number_format() function formats a number with grouped thousands.</p>
<p><b>Note:</b> This function supports one, two, or four parameters (not three).</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

number_format(<em>number,decimals,decimalpoint,separator</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. The number to be formatted. If no other 
	parameters are set, the number will be formatted without decimals and with 
	comma (,) as the thousands separator.</td>
  </tr>
  <tr>
    <td><em>decimals</em></td>
    <td>Optional. Specifies how many decimals. If this parameter is 
	set, the number will be formatted with a dot (.) as decimal point</td>
  </tr>
  <tr>
    <td><em>decimalpoint</em></td>
    <td>Optional. Specifies what string to use for decimal point</td>
  </tr>
  <tr>
    <td><em>separator</em></td>
    <td>Optional. Specifies what string to use for thousands 
	separator. Only the first character of separator is used. For example, &quot;xxx&quot; 
	will give the same output as &quot;x&quot; <br><br><b>Note:</b> If this parameter is given, 
	all other parameters are required as well</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the formatted number</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 5.4, this function supports multiple bytes in the parameters
	<em>decimalpoint</em> and <em>separator</em>. Only the first byte of each 
	separator was used in older versions.</td>
</tr>
</table>
<br>
<hr>
...
<p>You want to return a price: One parameter will round the number (it will be 
formatted without decimals). 
Two parameters should give the result you want:</p>
<div class="example_code notranslate">

	&lt;?php<br>$num = 1999.9;<br>$formattedNum = number_format($num).&quot;&lt;br&gt;&quot;;<br>
	echo $formattedNum;<br>$formattedNum = number_format($num, 2);<br>echo 
	$formattedNum;<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_number_format2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_number_format.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_number_format.asp#top" target="_top">TOP</a> |
		<a href="func_string_number_format.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
