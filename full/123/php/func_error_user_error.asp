...
<title>PHP user_error() Function</title>
<style>a.menu_func_error_user_error{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">user_error()</span> Function</h1>
<hr>
...
<p>The user_error() function creates a user-defined error message.</p>
<p>The user_error() function is used to trigger an error message at a 
...
condition when running a script runtime.</p>
<p>This function returns FALSE if a non valid error type is specified, and TRUE 
otherwise.</p>
<p>This function is an alias of the <a href="func_error_trigger_error.asp">
trigger_error()</a> function.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>error_message</td>
    <td>Required. Specifies the error message. Limited to 1024 
	characters in length</td>
  </tr>
  <tr>
    <td>error_types</td>
    <td>Optional. Specifies the error type for this error message.<p>
	Possible error types:</p>
	<ul>
		<li>E_USER_ERROR - Fatal user-generated run-time error. Errors that can 
		not be recovered from. Execution of the script is halted</li>
		<li>E_USER_WARNING - Non-fatal user-generated run-time warning. 
		Execution of the script is not halted</li>
		<li>E_USER_NOTICE - Default. User-generated run-time notice. The script found 
...
if ($test&gt;1)<br>
{<br>
user_error(&quot;A custom error has been triggered&quot;);<br>
}<br>
?&gt;
...
<b>Notice</b>: A custom error has been triggered<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_error_user_error.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_error_user_error.asp#top" target="_top">TOP</a> |
		<a href="func_error_user_error.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
