...
<title>PHP mt_rand() Function</title>
<style>a.menu_func_math_mt_rand{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mt_rand()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_mt_rand">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The mt_rand() function generates a random integer using the Mersenne Twister algorithm.</p>
<p><b>Tip:</b> This function produces a better random value, and is 4 times faster than
<a href="func_math_rand.asp">rand()</a>.</p>
<p><strong>Tip:</strong> If you want a random integer between 10 and 100 (inclusive), use mt_rand (10,100).</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mt_rand();<br><br>or<br><br>mt_rand(<em>min,max</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>min</em></td>
    <td>Optional. Specifies the lowest number to be returned. Default is 0</td>
  </tr>
  <tr>
    <td><em>max</em></td>
    <td>Optional. Specifies the highest number to be returned. Default is
	<a href="func_math_mt_getrandmax.asp">mt_getrandmax()</a></td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">A random integer between <em>min</em> (or 0) and <em>max</em> 
	(or mt_getrandmax() inclusive). Returns FALSE if <em>max</em> &lt; <em>min</em></td>
</tr>
<tr>
	<th>Return Type:</th>
	<td>Integer</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 4.2.0: Random number generator is seeded automatically<br>PHP 5.3.4: 
	Issues an E_WARNING and returns FALSE if <em>max</em> &lt; <em>min</em></td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_mt_rand.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_mt_rand.asp#top" target="_top">TOP</a> |
		<a href="func_math_mt_rand.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
