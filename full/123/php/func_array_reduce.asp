...
<title>PHP array_reduce() Function</title>
<style>a.menu_func_array_reduce{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_reduce()</span> Function</h1>
...
<p>Send the values in an array to a user-defined function and return a string:</p>
...
print_r(array_reduce($a,&quot;myfunction&quot;));<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_reduce">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The array_reduce() function sends the values in an array to a user-defined function, and returns a string.</p>
<p><strong>Note:</strong> If the array is empty and initial is not passed, this 
function returns NULL.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
array_reduce(<em>array,myfunction,initial</em>)
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the name of the function</td>
  </tr>
  <tr>
    <td><em>initial</em></td>
    <td>Optional. Specifies the initial value to send to the function</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns the resulting value</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.5+</td>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 5.3.0, the <em>initial</em> parameter accepts multiple types 
	(mixed). Versions prior to PHP 5.3.0, only allowed integer.</td>
</tr>
</table>
<br>
<hr>
...
<p>With the initial parameter:</p>
<div class="example_code notranslate">
&lt;?php<br>
function myfunction($v1,$v2)<br>
{<br>
...
$a=array(&quot;Dog&quot;,&quot;Cat&quot;,&quot;Horse&quot;);<br>
print_r(array_reduce($a,&quot;myfunction&quot;,5));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_reduce2">Run example &raquo;</a>
</div>
<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_reduce3">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_reduce.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_reduce.asp#top" target="_top">TOP</a> |
		<a href="func_array_reduce.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
