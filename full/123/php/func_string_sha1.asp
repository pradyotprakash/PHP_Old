...
<title>PHP sha1() Function</title>
<style>a.menu_func_string_sha1{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">sha1()</span> Function</h1>
...
<p>Calculate the SHA-1 hash of the string &quot;Hello&quot;:</p>
...
echo sha1($str);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_sha1">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The sha1() function calculates the SHA-1 hash of a string.</p>
<p>The sha1() function uses the US Secure 
Hash Algorithm 1.</p>
<p>From RFC 3174 - 
The US Secure Hash Algorithm 1: <i>&quot;SHA-1 produces a 160-bit output called 
...
signature as was used by the creator of the digital signature.&quot;</i></p>
<p><strong>Tip:</strong> To calculate the SHA-1 hash of a file, use the
<a href="func_string_sha1_file.asp">sha1_file()</a> function.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

sha1(<em>string,raw</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>raw</em></td>
    <td>Optional. Specify hex or binary output 
	format:<ul>
		<li>TRUE - Raw 20 character binary format</li>
		<li>FALSE - Default. 40 character hex number</li>
	</ul>
	  </td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the calculated SHA-1 hash on success, or FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<p>Print the result of sha1():</p>
<div class="example_code notranslate">

	&lt;?php <br>$str = &quot;Hello&quot;; <br>echo &quot;The string: &quot;.$str.&quot;&lt;br&gt;&quot;; <br>echo 
	&quot;TRUE - Raw 20 character binary format: &quot;.sha1($str, TRUE).&quot;&lt;br&gt;&quot;; <br>echo 
	&quot;FALSE - 40 character hex number: &quot;.sha1($str).&quot;&lt;br&gt;&quot;; <br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_sha12">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Print the result of sha1() and then test it: </p>
<div class="example_code notranslate">

	&lt;?php<br>$str = &quot;Hello&quot;;<br>echo sha1($str);<br><br>if (sha1($str) == 
	&quot;f7ff9e8b7bb2e09b70935a5d785e0cc5d9d0abf0&quot;)<br>&nbsp; {<br>&nbsp; echo &quot;&lt;br&gt;Hello 
	world!&quot;;<br>&nbsp; exit;<br>&nbsp; }<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_sha13">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_sha1.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_sha1.asp#top" target="_top">TOP</a> |
		<a href="func_string_sha1.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
