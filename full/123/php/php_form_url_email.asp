...
<style>a.menu_php_form_url_email{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Forms - Validate E-mail and URL</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_form_required.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_form_complete.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">This chapter show how to validate names, e-mails, and URLs.</p>
<hr>

<h2>PHP - Validate Name</h2>
<p>The code below shows a simple way to check if the name field only contains 
...
if (!preg_match(&quot;/^[a-zA-Z ]*$/&quot;,$name))<br>&nbsp; 
	{<br>&nbsp; $nameErr = &quot;Only letters and white space allowed&quot;; <br>&nbsp; }</div>
</div>
<br>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><strong>The preg_match() function searches a string for pattern, returning true if 
the pattern exists, and false otherwise.</strong></td>
</tr></table>
<br>
<hr>

<h2>PHP - Validate E-mail</h2>
<p>The code below shows a simple way to check if an e-mail address syntax is 
valid. If the e-mail address syntax is not valid, then store an error message:</p>
<div class="code notranslate"><div>
$email = test_input($_POST[&quot;email&quot;]);<br>
if (!preg_match(&quot;/([\w\-]+\@[\w\-]+\.[\w\-]+)/&quot;,$email))<br>&nbsp; {<br>&nbsp; 
	$emailErr = &quot;Invalid email format&quot;; <br>&nbsp; }</div></div>
<br>
<hr>

<h2>PHP - Validate URL</h2>
<p>The code below shows a way to check if a URL address syntax is 
...
<div class="code notranslate"><div>
	$website = test_input($_POST[&quot;website&quot;]);<br>if 
	(!preg_match(&quot;/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+&amp;@#\/%?=~_|!:,.;]*[-a-z0-9+&amp;@#\/%=~_|]/i&quot;,$website))<br>&nbsp; 
	{<br>&nbsp;&nbsp;$websiteErr = &quot;Invalid URL&quot;; <br>&nbsp;&nbsp;}</div>
</div>
<br>
<hr>
...
<div class="example_code notranslate">
	...
	$website = &quot;&quot;;<br><br>if ($_SERVER[&quot;REQUEST_METHOD&quot;] == &quot;POST&quot;)<br>{<br>&nbsp; 
	if (empty($_POST[&quot;name&quot;]))<br>&nbsp;&nbsp;&nbsp; {$nameErr = &quot;Name is 
	required&quot;;}<br>&nbsp; else<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
	$name = test_input($_POST[&quot;name&quot;]);<br>&nbsp;&nbsp;&nbsp; // check if name 
	only contains letters and whitespace<br>&nbsp;&nbsp;&nbsp; if 
	(!preg_match(&quot;/^[a-zA-Z ]*$/&quot;,$name))<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	$nameErr = &quot;Only letters and white space allowed&quot;; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp; if (empty($_POST[&quot;email&quot;]))<br>&nbsp;&nbsp;&nbsp; 
	{$emailErr = &quot;Email is required&quot;;}<br>&nbsp; else<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
	$email = test_input($_POST[&quot;email&quot;]);<br>&nbsp;&nbsp;&nbsp; // check if 
	e-mail address syntax is valid<br>&nbsp;&nbsp;&nbsp; if 
	(!preg_match(&quot;/([\w\-]+\@[\w\-]+\.[\w\-]+)/&quot;,$email))<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $emailErr = &quot;Invalid email format&quot;; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp; if (empty($_POST[&quot;website&quot;]))<br>&nbsp;&nbsp;&nbsp; 
	{$website = &quot;&quot;;}<br>&nbsp; else<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
	$website = test_input($_POST[&quot;website&quot;]);<br>&nbsp;&nbsp;&nbsp; // check if 
	URL address syntax is valid (this regular expression also allows dashes in 
	the URL)<br>&nbsp;&nbsp;&nbsp; if 
	(!preg_match(&quot;/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+&amp;@#\/%?=~_|!:,.;]*[-a-z0-9+&amp;@#\/%=~_|]/i&quot;,$website))<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $websiteErr = &quot;Invalid URL&quot;; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp; if (empty($_POST[&quot;comment&quot;]))<br>&nbsp;&nbsp;&nbsp; 
	{$comment = &quot;&quot;;}<br>&nbsp; else<br>&nbsp;&nbsp;&nbsp; {$comment = 
	test_input($_POST[&quot;comment&quot;]);}<br><br>&nbsp; if (empty($_POST[&quot;gender&quot;]))<br>&nbsp;&nbsp;&nbsp; 
	{$genderErr = &quot;Gender is required&quot;;}<br>&nbsp; else<br>&nbsp;&nbsp;&nbsp; 
	{$gender = test_input($_POST[&quot;gender&quot;]);}<br>}<br>?&gt;</div>
<br><a class="showbtn" href="showphp.asp?filename=demo_form_validation_special" target="_blank">Run example &raquo;</a>
</div>
<p>The next step is to show how to prevent the form from emptying all the input 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_form_url_email.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_form_url_email.asp#top" target="_top">TOP</a> |
		<a href="php_form_url_email.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
