...
<title>PHP ord() Function</title>
<style>a.menu_func_string_ord{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ord()</span> Function</h1>
...
<p>Return the ASCII value of &quot;h&quot;:</p>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_ord">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The ord() function returns the ASCII value of the 
first character of a string.</p>
<hr>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. The string to get an ASCII value from</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns the ASCII value as an integer</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_ord.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_ord.asp#top" target="_top">TOP</a> |
		<a href="func_string_ord.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
