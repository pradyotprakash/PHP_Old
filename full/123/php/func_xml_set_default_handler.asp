...
<title>PHP xml_set_default_handler() Function</title>
<style>a.menu_func_xml_set_default_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_set_default_handler()</span> Function</h1>
<hr>
...
<p>The xml_set_default_handler() function sets the default data handler 
for the XML parser.</p>
<p>This function specifies what function to be called whenever the parser finds 
data in the XML file.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td>handler</td>
    <td>Required. Specifies a function to be used as an event 
	handler</td>
  </tr>
  </table>
<p>The Function specified by the &quot;handler&quot; parameter must have two 
parameters:<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<tr>
    <td>data</td>
    <td>Required. Specifies a variable containing the data 
...
<p><b>Note:</b> The data_handler parameter can also be an array containing an 
...
<br>
function default($parser,$data)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo $data;<br>
&nbsp;&nbsp;}<br>
<br>
...
<p>If you select &quot;View source&quot; in the browser window, you will see the following 
HTML:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_set_default_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_set_default_handler.asp#top" target="_top">TOP</a> |
		<a href="func_xml_set_default_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
