...
<title>PHP date_time_set() Function</title>
<style>a.menu_func_date_time_set{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_time_set()</span> Function</h1>
...
&lt;?php<br>
	$date=date_create(&quot;2013-05-01&quot;);<br>date_time_set($date,13,24);<br>echo 
	date_format($date,&quot;Y-m-d H:i:s&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_time_set">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_time_set() function sets the time.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_time_set(<em>object,hour,minute,second);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>hour</em></td>
    <td>Required. Specifies the hour of the time</td>
  </tr>
  <tr>
    <td><em>minute</em></td>
    <td>Required. Specifies the minute of the time</td>
  </tr>
  <tr>
    <td><em>second</em></td>
    <td>Optional. Specifies the second of the time. Default is 0</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_time_set.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_time_set.asp#top" target="_top">TOP</a> |
		<a href="func_date_time_set.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
