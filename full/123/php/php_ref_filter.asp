...
<html lang="en-US">
<head>
<title>PHP 5 Filter Functions</title>
<style>a.menu_php_ref_filter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Filter</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_filesystem.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_ftp.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP Filter Introduction</h2>
<p>This PHP filters is used to validate and filter data coming from insecure sources, 
like user input.</p>
<hr>

<h2>Installation</h2>
<p>As of PHP 5.2.0, the filter functions are enabled by default. There is no installation 
needed to use these functions.</p>
<hr>

<h2>Runtime Configurations</h2>
...
<table class="reference notranslate">
  <tr>
    ...
    <th style="width:16%">Changeable</th>
  </tr>
    <tr>
    <td>filter.default</td>
    <td>Filter all $_GET, $_POST, $_COOKIE, $_REQUEST and $_SERVER data by this 
	filter. Accepts the name of the filter you like to use by default. See the 
	filter list for the list of the filter names</td>
    <td>&quot;unsafe_raw&quot;</td>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="func_filter_has_var.asp">filter_has_var()</a></td>
    <td>Checks if a variable of a specified input type exist</td>
  </tr>
  <tr>
    <td><a href="func_filter_id.asp">filter_id()</a></td>
    <td>Returns the ID number of a specified filter</td>
  </tr>
  <tr>
    <td><a href="func_filter_input.asp">filter_input()</a></td>
    <td>Get input from outside the script and filter it</td>
  </tr>
  <tr>
    <td><a href="func_filter_input_array.asp">filter_input_array()</a></td>
    <td>Get multiple inputs from outside the script and filters 
	them</td>
  </tr>
  <tr>
    <td><a href="func_filter_list.asp">filter_list()</a></td>
    <td>Returns an array of all supported filters</td>
  </tr>
  <tr>
    <td><a href="func_filter_var_array.asp">filter_var_array()</a></td>
    <td>Get multiple variables and filter them</td>
  </tr>
  <tr>
    <td><a href="func_filter_var.asp">filter_var()</a></td>
    <td>Get a variable and filter it</td>
  </tr>
  </table>
<br>
<hr>

<h2>PHP Filter List</h2>
<p>Validate Filters:</p>
<table class="reference notranslate">
  <tr>
    <th style="width:50%">ID Name</th>
	<th style="width:50%">Description</th>
  </tr>
    <tr>
	<td><a href="filter_validate_boolean.asp">FILTER_VALIDATE_BOOLEAN</a></td>
	<td>Return TRUE for &quot;1&quot;, &quot;true&quot;, &quot;on&quot; and &quot;yes&quot;, FALSE for &quot;0&quot;, 
	&quot;false&quot;, &quot;off&quot;, &quot;no&quot;, and &quot;&quot;, NULL otherwise</td>
    </tr>
	<tr>
    <td><a href="filter_validate_email.asp">FILTER_VALIDATE_EMAIL</a></td>
	<td>Validate value as e-mail</td>
    </tr>
	<tr>
	<td><a href="filter_validate_float.asp">FILTER_VALIDATE_FLOAT</a></td>
	<td>Validate value as float</td>
    </tr>
  <tr>
	<td><a href="filter_validate_int.asp">FILTER_VALIDATE_INT</a></td>
	<td>Validate value as integer, optionally from the specified range</td>
  </tr>
    <tr>
	<td><a href="filter_validate_ip.asp">FILTER_VALIDATE_IP</a></td>
	<td>Validate value as IP address, optionally only IPv4 or IPv6 or not from private or reserved ranges</td>
    </tr>
  <tr>
	<td><a href="filter_validate_regexp.asp">FILTER_VALIDATE_REGEXP</a></td>
	<td>Validate value against regexp, a Perl-compatible regular expression</td>
  </tr>
  <tr>
	<td><a href="filter_validate_url.asp">FILTER_VALIDATE_URL</a></td>
	<td>Validate value as URL, optionally with required components</td>
  </tr>
  </table>

<p>Sanitize Filters:</p>
<table class="reference notranslate">
  <tr>
    <th style="width:50%">ID Name</th>
	<th style="width:50%">Description</th>
    ...
    <tr>
	<td><a href="filter_sanitize_email.asp">FILTER_SANITIZE_EMAIL</a></td>
	<td>Remove all characters, except letters, digits and !#$%&amp;'*+-/=?^_`{|}~@.[]</td>
    </tr>
	<tr>
	<td><a href="filter_sanitize_encoded.asp">FILTER_SANITIZE_ENCODED</a></td>
	<td>URL-encode string, optionally strip or encode special characters</td>
    </tr>
	<tr>
	<td><a href="filter_sanitize_magic_quotes.asp">FILTER_SANITIZE_MAGIC_QUOTES</a></td>
	<td>Apply addslashes()</td>
    </tr>
	<tr>
	<td><a href="filter_sanitize_number_float.asp">FILTER_SANITIZE_NUMBER_FLOAT</a></td>
	<td>Remove all characters, except digits, +- and optionally .,eE</td>
    </tr>
	<tr>
	<td><a href="filter_sanitize_number_int.asp">FILTER_SANITIZE_NUMBER_INT</a></td>
	<td>Remove all characters, except digits and +-</td>
    </tr>
	<tr>
	<td><a href="filter_sanitize_special_chars.asp">FILTER_SANITIZE_SPECIAL_CHARS</a></td>
	<td>HTML-escape '&quot;&lt;&gt;&amp; and characters with ASCII value less than 32</td>
    </tr>
  <tr>
  ...
  <tr>
	<td><a href="filter_sanitize_string.asp">FILTER_SANITIZE_STRING</a></td>
	<td>Strip tags, optionally strip or encode special characters</td>
  </tr>
  <tr>
	<td><a href="filter_sanitize_stripped.asp">FILTER_SANITIZE_STRIPPED</a></td>
	<td>Alias of &quot;string&quot; filter</td>
  </tr>
  <tr>
	<td><a href="filter_sanitize_url.asp">FILTER_SANITIZE_URL</a></td>
	<td>Remove all characters, except letters, digits and $-_.+!*'(),{}|\\^~[]`&lt;&gt;#%&quot;;/?:@&amp;=</td>
  </tr>
  <tr>
	<td><a href="filter_unsafe_raw.asp">FILTER_UNSAFE_RAW</a></td>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="filter_callback.asp">FILTER_CALLBACK</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_filter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_filter.asp#top" target="_top">TOP</a> |
		<a href="php_ref_filter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
