...
<style>a.menu_func_filesystem_fgetcsv{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fgetcsv()</span> Function</h1>
<hr>
...
<p>The fgetcsv() function parses a line from an open file, checking for
<span lang="en-us">CSV fields</span>.</p>
<p>The fgetcsv() function stops returning on a new line, at the specified length, 
or at EOF, whichever comes first.</p>
<p>This function returns the CSV fields in an array on success, or FALSE on 
failure and EOF.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>length</td>
    <td>Optional. Specifies the maximum length of a line. Must be 
	...
	slightly slower.<p><b>Note:</b> This parameter is required in versions prior to 
	PHP 5</td>
  </tr>
  <tr>
    <td>separator</td>
    <td>Optional. A character that specifies the field separator.  
	Default is comma ( , )</td>
  </tr>
  <tr>
    <td>enclosure</td>
    <td>Optional. A character that specifies the field enclosure 
	character. Default is &quot;</td>
  </tr>
  </table>
<br>
<hr>
<h2>Tips and Notes</h2>
<p><b>Tip:</b> Also see the fputcsv() function.</p>
<hr>
...
Kai Jim, Refsnes, Stavanger, Norway<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fgetcsv.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fgetcsv.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fgetcsv.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
