...
<title>PHP array_merge_recursive() Function</title>
<style>a.menu_func_array_merge_recursive{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_merge_recursive()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_merge_recursive">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_merge_recursive() function merges one ore more arrays into one array.</p>
<p>The difference between this function and the <a href="func_array_merge.asp">array_merge()</a> function is when two or more array elements have the same key.
Instead of override the keys, the array_merge_recursive() function makes the value as an array.</p>
<p><b>Note:</b> If you assign only one array to the array_merge_recursive() function,
it will behave exactly the same as the <a href="func_array_merge.asp">array_merge()</a> function.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

array_merge_recursive(<em>array1,array2,array3...</em>)
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_merge_recursive.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_merge_recursive.asp#top" target="_top">TOP</a> |
		<a href="func_array_merge_recursive.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
