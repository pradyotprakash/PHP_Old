...
<title>PHP strripos() Function</title>
<style>a.menu_func_string_strripos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strripos()</span> Function</h1>
...
<p>Find the position of the last occurrence of &quot;php&quot; inside the 
string:</p>
<div class="example_code notranslate">

	&lt;?php<br>
	echo strripos(&quot;I love 
	php, I love php too!&quot;,&quot;PHP&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strripos">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strripos() function finds the position of the last occurrence of a string inside 
another string.</p>
<p><b>Note:</b> The strripos() function is case-insensitive.</p>
<p>Related functions:</p>
<ul>
	<li><a href="func_string_stripos.asp">stripos()</a> - Finds the position of 
	the first occurrence of a string inside another string (case-insensitive)</li>
	<li><a href="func_string_strpos.asp">strpos()</a> - Finds the position of 
	the first occurrence of a string inside another string (case-sensitive)</li>
	<li><a href="func_string_strrpos.asp">strrpos()</a> - Finds the position of 
	the last occurrence of a string inside another string (case-sensitive)</li>
</ul>
<hr>
<h2>Syntax</h2>
...
strripos(<em>string,find,start</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>find</em></td>
    <td>Required. Specifies the string to find</td>
  </tr>
  <tr>
    <td><em>start</em></td>
    <td>Optional. Specifies where to begin the search</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the position of the last occurrence of a string 
	inside another string, or FALSE if the string is not found. <strong>Note:</strong> 
	String positions start at 0, and not 1.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 5.0, the <em>find</em> parameter may now be a string of more 
	than one character<br><br>The <em>start</em> parameter was added in PHP 5.0</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strripos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strripos.asp#top" target="_top">TOP</a> |
		<a href="func_string_strripos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
