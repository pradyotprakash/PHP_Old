...
<title>PHP sha1_file() Function</title>
<style>a.menu_func_string_sha1_file{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">sha1_file()</span> Function</h1>
...
<p>Calculate the SHA-1 hash of the text file &quot;test.txt&quot;:</p>
<div class="example_code notranslate">

&lt;?php<br>
$filename = &quot;test.txt&quot;;<br>
$sha1file = sha1_file($filename);<br>
echo $sha1file;<br>
?&gt;</div>
...
<p>The sha1_file() function calculates the SHA-1 hash of a file.</p>
<p>The sha1_file() function uses the US Secure Hash 
Algorithm 1.</p>
<p>From RFC 3174 - 
...
<p>This function returns the calculated SHA-1 hash on success, or FALSE on failure.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

sha1_file(<em>file,raw</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>file</em></td>
    <td>Required. The file to be calculated</td>
  </tr>
  <tr>
    <td><em>raw</em></td>
    <td>Optional. A boolean value that specifies hex or binary output 
	format:<ul>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>raw</em> parameter became optional in PHP 5.0<br><br>As of PHP 5.1, it is 
	possible to use sha1_file() with wrappers, e.g. <strong>
	sha1_file(&quot;http://w3schools.com/..&quot;)</strong></td>
</tr>
</table>
<br>
...
<p>Store the SHA-1 hash of &quot;test.txt&quot; in a file:</p>
<div class="example_code notranslate">

&lt;?php<br>
$sha1file = sha1_file(&quot;test.txt&quot;);<br>
file_put_contents(&quot;sha1file.txt&quot;,$sha1file);<br>
?&gt;</div>
<p>Test if &quot;test.txt&quot; has been changed (that is if the 
SHA-1 hash has been changed):</p>
<div class="example_code notranslate">

&lt;?php<br>
$sha1file = file_get_contents(&quot;sha1file.txt&quot;);<br>
if (sha1_file(&quot;test.txt&quot;) == $sha1file)<br>
&nbsp;&nbsp;{<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_sha1_file.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_sha1_file.asp#top" target="_top">TOP</a> |
		<a href="func_string_sha1_file.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
