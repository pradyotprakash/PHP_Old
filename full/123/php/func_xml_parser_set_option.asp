...
<title>PHP xml_parser_set_option() Function</title>
<style>a.menu_func_xml_parser_set_option{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_parser_set_option()</span> Function</h1>
<hr>
...
<p>The xml_parser_set_option() function sets options in an XML parser.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td>option</td>
    <td>Required. Specifies option to set. Possible values:<ul>
		<li>XML_OPTION_CASE_FOLDING - Specifies if case-folding is enabled. 
		Enabled by default. Can be 1 (TRUE) or 0 (FALSE)</li>
		<li>XML_OPTION_SKIP_TAGSTART - Specifies how many characters should be 
		skipped in the beginning of a tag name</li>
		<li>XML_OPTION_SKIP_WHITE - Specifies whether to skip values consisting 
		of whitespace characters. Can be 1 (TRUE) or 0 (FALSE)</li>
		<li>XML_OPTION_TARGET_ENCODING - Specifies which target encoding to use 
		in this XML parser. By default, it is set to the same as the 
		xml_parser_create() function. Supported target encodings are ISO-8859-1, 
		US-ASCII and UTF-8.</li>
	</ul>
	</td>
  </tr>
  <tr>
    <td>value</td>
    <td>Required. Specifies options new value</td>
  </tr>
  </table>
<br>
...
<br>
xml_parser_set_option($xmlparser, XML_OPTION_SKIP_WHITE, 1);<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_parser_set_option.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_parser_set_option.asp#top" target="_top">TOP</a> |
		<a href="func_xml_parser_set_option.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
