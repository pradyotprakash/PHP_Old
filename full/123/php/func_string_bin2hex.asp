...
<title>PHP bin2hex() Function</title>
<style>a.menu_func_string_bin2hex{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">bin2hex()</span> Function</h1>
...
<p>Convert &quot;Hello World!&quot; to hexadecimal values:</p>
<div class="example_code notranslate">

	&lt;?php <br>$str = bin2hex(&quot;Hello World!&quot;);<br>echo($str); <br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_bin2hex">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The bin2hex() function converts a string of ASCII characters to hexadecimal 
values. The string can be converted back using the pack() function.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. The string to be converted</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the hexadecimal value of the converted string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>Convert a string value from binary to hex and back:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_bin2hex2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_bin2hex.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_bin2hex.asp#top" target="_top">TOP</a> |
		<a href="func_string_bin2hex.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
