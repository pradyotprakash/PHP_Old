...
<title>PHP time_sleep_until() Function</title>
<style>a.menu_func_misc_time_sleep_until{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">time_sleep_until()</span> Function</h1>
...
<p>Delay the execution of the current script until 10 seconds:</p>
<div class="example_code notranslate">
&lt;?php<br>// wake up ten seconds from now<br>
time_sleep_until(time()+10);<br>
?&gt;</div>
<br>
</div>
<hr>
...
<p>The time_sleep_until() function delays execution of the current script until 
the specified 
time.</p>
<p><strong>Note:</strong> This function throws an error if the specified number 
is negative.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
time_sleep_until(<em>timestamp</em>)
</div></div><br>
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the time to wake</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_time_sleep_until.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_time_sleep_until.asp#top" target="_top">TOP</a> |
		<a href="func_misc_time_sleep_until.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
