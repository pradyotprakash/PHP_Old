...
<style>a.menu_func_array_walk{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_walk()</span> Function</h1>
...
<p>Run each array element in a user-defined function:</p>
...
array_walk($a,&quot;myfunction&quot;);<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_walk">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_walk() function runs each array element in a user-defined function. 
The array's keys and values are parameters in the function.</p>
<p><b>Note:</b> You can change an array element's value in the user-defined 
function by specifying the first parameter as a reference: &amp;$value (See Example 
2).</p>
<p><strong>Tip:</strong> To work with deeper arrays (an array inside an array), 
use the <a href="func_array_walk_recursive.asp">array_walk_recursive()</a> 
function.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
array_walk(<em>array,myfunction,parameter...</em>)
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>array</em></td>
    <td>Required. Specifying an array</td>
  </tr>
  <tr>
    <td><em>myfunction</em></td>
    <td>Required. The name of the user-defined function</td>
  </tr>
  <tr>
    <td><em>parameter,...</em></td>
    <td>Optional. Specifies a parameter to the user-defined function. 
	You can assign one parameter to the function, or as many as you like</td>
  </tr>
</table>
...
<div class="example_code notranslate">
&lt;?php<br>
function myfunction($value,$key,$p)<br>
{<br>
echo &quot;$key $p $value&lt;br&gt;&quot;;<br>
}<br>
$a=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;);<br>
array_walk($a,&quot;myfunction&quot;,&quot;has the value&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_walk2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Change an array element's value. (Notice the &amp;$value)</p>
<div class="example_code notranslate">
&lt;?php<br>
function myfunction(&amp;$value,$key)<br>
{<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_walk3">Run example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_walk.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_walk.asp#top" target="_top">TOP</a> |
		<a href="func_array_walk.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
