...
<title>PHP hebrevc() Function</title>
<style>a.menu_func_string_hebrevc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">hebrevc()</span> Function</h1>
...
<p>Reverse the display of Hebrew characters, and convert new lines(\n) into &lt;br&gt;: </p>
<div class="example_code notranslate">

&lt;?php<br>
echo hebrevc(&quot;ב חשון התשסג\nב חשון התשסג&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_hebrevc">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The hebrevc() function converts Hebrew text from a right-to-left flow to a 
left-to-right flow. It also converts new lines (\n) into &lt;br&gt;.</p>
<p><b>Tip:</b> hebrevc() and <a href="func_string_hebrev.asp">hebrev()</a> can convert Hebrew logical text (the 
...
hebrevc(<em>string,maxcharline</em>)
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_hebrevc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_hebrevc.asp#top" target="_top">TOP</a> |
		<a href="func_string_hebrevc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
