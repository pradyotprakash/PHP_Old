...
<title>PHP zip_read() Function</title>
<style>a.menu_func_zip_read{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">zip_read()</span> Function</h1>
<hr>
...
<p>The zip_read() function reads the next file in a open zip archive.</p>
<p>This function returns a resource containing a file within the zip archive on success, or FALSE 
if there is no more entries to read.</p>
<h2>Syntax</h2>
...
<p><b>Tip:</b> The resource returned by zip_read() can be used by the zip_entry... 
functions.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_zip_read.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_zip_read.asp#top" target="_top">TOP</a> |
		<a href="func_zip_read.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
