...
<title>PHP ftruncate() Function</title>
<style>a.menu_func_filesystem_ftruncate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftruncate()</span> Function</h1>
<hr>
...
<p>The ftruncate() function truncates an open file to the specified length.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the open file to truncate</td>
  </tr>
  <tr>
    <td>size</td>
    <td>Required. Specifies the new file size</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_ftruncate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_ftruncate.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_ftruncate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
