...
<title>PHP money_format() Function</title>
<style>a.menu_func_string_money_format{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">money_format()</span> Function</h1>
...
<p>International en_US format:</p>
<div class="example_code notranslate">

&lt;?php<br>
$number = 1234.56;<br>
setlocale(LC_MONETARY,&quot;en_US&quot;);<br>
echo money_format(&quot;The price is %i&quot;, $number);<br>
?&gt;</div>
...
<p>The money_format() function returns a string formatted as a currency string.</p>
<p>This function inserts a formatted number where there is a percent (%) 
sign in the main string.</p>
<p><b>Note: </b>The money_format() function does not work on Windows platforms.</p>
<p><strong>Tip:</strong> This function is often used together with the
<a href="func_string_setlocale.asp">setlocale()</a> function.</p>
<p><strong>Tip:</strong> To view all available language codes, 
	go to our <a href="../tags/ref_language_codes.asp" target="_blank">Language 
	code reference.</a></p>
<hr>
<h2>Syntax</h2>
...
money_format(<em>string,number</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to be formatted and how to format the variables in it.<p>Possible format values:</p>

	<p>Padding and Flags:</p>
    <ul>
	<li>=<i>f</i> - Specifies the character (f) to be used as padding (Example: 
	%=t this uses &quot;t&quot; as padding). Default is space</li>
	<li>^ - Removes the use of grouping characters</li>
	<li>+ or ( - Specifies how to show positive and negative numbers. If &quot;+&quot; is used, the local setting for + and - will be used (usually a sign in front 
	of negative numbers, and nothing in front of positive numbers). If &quot;(&quot; is used, negative numbers are enclosed in parenthesis. Default is 
	&quot;+&quot;</li>
	<li>! - Stops the use of currency symbols in the output string</li>
	<li>- If &quot;-&quot; is used, all fields are left-justified. Default is 
	right-justified</li>
    </ul>

	<p>Field width:</p>
	<ul>
	<li><i>x</i> - Specifies the minimum field width (x). Default is 0</li>
	<li>#<i>x</i> - Specifies the maximum number (x) of digits expected to the left of the decimal point. 
	This is used to keep formatted output aligned in the same columns. If the number of 
	digits are bigger than x, this specification is ignored</li>
	<li>.<i>x</i> - Specifies the maximum number (x) of digits 
	expected to the right of the decimal point. If x is 0, the decimal point and 
	the digits to it's right will not be shown. Default is local settings</li>
	</ul>
	
	<p>Conversion characters:</p>
	<ul>
	<li>i - The number is formatted to international currency format</li>
	<li>n - The number is formatted to national currency format</li>
	<li>% - Returns the % character</li>
	</ul>

	<p><b>Note:</b> If multiple format values are used, they must be in the same order as shown above.</p>
	<p><b>Note:</b> This function is affected by local settings.</p></td>
  </tr>
	<tr>
    <td><em>number</em></td>
    <td>Required. The number to be inserted at 
	the %-sign in the format string</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the formatted string. Characters before and after 
	the formatting string will be returned unchanged. Non-numeric number causes 
	returning NULL and emitting E_WARNING</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.3.0+</td>
...
<p>International format (Germany) with 2 decimals:</p>
<div class="example_code notranslate">

&lt;?php<br>
$number = 1234.56;<br>
setlocale(LC_MONETARY,&quot;de_DE&quot;);<br>
echo money_format(&quot;%.2n&quot;, $number);<br>
?&gt;</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">

	1 234,56 EUR</div><br></div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Negative number, US national format with () to indicate negative numbers and 
2 digits of right precision and &quot;*&quot; as a fill character:</p>
<div class="example_code notranslate">
...
<hr>
<p><a href="php_ref_string.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP String Reference" /> PHP String Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_money_format.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_money_format.asp#top" target="_top">TOP</a> |
		<a href="func_string_money_format.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
