...
<style>a.menu_func_misc_connection_status{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">connection_status()</span> Function</h1>
...
<p>Return the connection satus:</p>
<div class="example_code notranslate">

&lt;?php<br>switch (connection_status())<br>
{<br>
case CONNECTION_NORMAL:<br>
&nbsp;&nbsp;$txt = 'Connection is in a normal state';<br>
&nbsp;&nbsp;break;<br>
case CONNECTION_ABORTED:<br>
&nbsp;&nbsp;$txt = 'Connection aborted';<br>
&nbsp;&nbsp;break;<br>
case CONNECTION_TIMEOUT:<br>
&nbsp;&nbsp;$txt = 'Connection timed out';<br>
&nbsp;&nbsp;break;<br>
case (CONNECTION_ABORTED &amp; CONNECTION_TIMEOUT):<br>
&nbsp;&nbsp;$txt = 'Connection aborted and timed out';<br>
&nbsp;&nbsp;break;<br>
default:<br>
&nbsp;&nbsp;$txt = 'Unknown';<br>
&nbsp;&nbsp;break;<br>
...
echo $txt;<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_connection_status">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The connection_status() function returns the current connection status.</p>
<p>Possible 
values that can be returned are: </p>
<ul>
	<li>0 - CONNECTION_NORMAL - connection is running normally</li>
	<li>1 - CONNECTION_ABORTED - connection is aborted by user or network error</li>
	<li>2 - CONNECTION_TIMEOUT -&nbsp; connection timed out</li>
	<li>3 - CONNECTION_ABORTED &amp; CONNECTION_TIMEOUT</li>
</ul>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
connection_status()</div></div><br>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td style="width:80%">Returns the connection status bitfield</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_connection_status.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_connection_status.asp#top" target="_top">TOP</a> |
		<a href="func_misc_connection_status.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
