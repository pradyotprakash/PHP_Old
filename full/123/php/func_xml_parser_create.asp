...
<title>PHP xml_parser_create() Function</title>
<style>a.menu_func_xml_parser_create{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_parser_create()</span> Function</h1>
<hr>
...
<p>The xml_parser_create() function creates an XML parser.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<p><b>Note:</b> In PHP 5, the input encoding is automatically detected. In 
	PHP 4 and older versions, this paramterer specifies the character encoding 
	for the input and output</p>
...
<p><b>Tip:</b> To create an XML parser with namespace support, use the 
xml_parser_create_ns() function instead.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_parser_create.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_parser_create.asp#top" target="_top">TOP</a> |
		<a href="func_xml_parser_create.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
