...
<style>a.menu_php_file{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">File Handling</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_includes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_file_upload.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The fopen() function is used to open files in PHP.</p>
<hr>

<h2>Opening a File</h2>
<p>The fopen() function is used to open files in PHP.</p>
<p>The first parameter of this function contains the name of the file to be opened and the 
second parameter specifies in which mode the file should be opened:</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>r+</td>
    <td>Read/Write. Starts at the beginning of the file</td>
  </tr>
  <tr>
    <td>w</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_file.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_file.asp#top" target="_top">TOP</a> |
		<a href="php_file.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
