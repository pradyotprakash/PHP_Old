...
<title>PHP date_default_timezone_set() Function</title>
<style>a.menu_func_date_default_timezone_set{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_default_timezone_set()</span> Function</h1>
...
<p>Set the default timezone:</p>
<div class="example_code notranslate">
&lt;?php<br>
	date_default_timezone_set(&quot;Asia/Bangkok&quot;);<br>echo 
	date_default_timezone_get();<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_default_tz_set">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_default_timezone_set() function sets the default timezone used by all date/time functions in the script.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	date_default_timezone_set(<em>timezone</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the timezone to use, like &quot;UTC&quot; or &quot;Europe/Paris&quot;. 
	List of valid timezones:
	<a target="_blank" href="http://www.php.net/manual/en/timezones.php">
	http://www.php.net/manual/en/timezones.php</a></td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns FALSE if the <em>timezone</em> is not valid. TRUE 
	otherwise</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>Changelog:</th>
	<td>From PHP 5.1.2+; This function started to validate the <em>timezone</em> 
	parameter. From PHP 5.3+; Throws an E_WARNING instead of E_STRICT</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_default_timezone_set.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_default_timezone_set.asp#top" target="_top">TOP</a> |
		<a href="func_date_default_timezone_set.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
