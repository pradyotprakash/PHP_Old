...
<title>PHP date_default_timezone_get() Function</title>
<style>a.menu_func_date_default_timezone_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_default_timezone_get()</span> Function</h1>
...
<p>Return the default timezone:</p>
<div class="example_code notranslate">
&lt;?php<br>
	echo date_default_timezone_get();<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_default_tz_get">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_default_timezone_get() function returns the default timezone used by all date/time functions in the script.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_default_timezone_get();</div></div>

<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td style="width:80%">Returns the timezone as a string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.1+</td>
...
<tr>
	<th>Changelog:</th>
	<td>From PHP 5.4+; The timezone is no longer guessed from information in 
	OS, and the TZ variable is no longer used</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_default_timezone_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_default_timezone_get.asp#top" target="_top">TOP</a> |
		<a href="func_date_default_timezone_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
