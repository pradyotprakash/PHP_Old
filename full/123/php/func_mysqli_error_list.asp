...
<title>PHP mysqli_error_list() Function</title>
<style>a.menu_func_mysqli_error_list{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_error_list()</span> Function</h1>
...
<p>Return a list of errors for the most recent function call, if any:</p>
...
&nbsp;&nbsp;}<br><br>// Perform a query, check for error<br>if 
	(!mysqli_query($con,&quot;INSERT INTO Persons (FirstName)
VALUES ('Glenn')&quot;))<br>&nbsp; {<br>&nbsp; print_r(mysqli_error_list($con));<br>&nbsp; }<br>
...
<p>The mysqli_errno() function returns a list of errors for the most recent function call, if any.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_error_list(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns a list of errors. Each as an associative array with 
	errno (error code), error (error text), and sqlstate</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_error_list.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_error_list.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_error_list.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
