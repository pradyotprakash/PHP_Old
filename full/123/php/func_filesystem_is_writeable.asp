...
<title>PHP is_writeable() Function</title>
<style>a.menu_func_filesystem_is_writeable{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">is_writeable()</span> Function</h1>
<hr>
...
<p>The is_writeable() function checks whether the specified file is writeable.</p>
<p>This function returns TRUE if the file is writeable.</p>
<p>This function is an alias of the is_writable() function.</p>
<h2>Syntax</h2>
...
&lt;?php<br>
$file = &quot;test.txt&quot;;<br>
if(is_writeable($file))<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo (&quot;$file is writeable&quot;);<br>
&nbsp;&nbsp;}<br>
else<br>
&nbsp;&nbsp;{<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_is_writeable.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_is_writeable.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_is_writeable.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
