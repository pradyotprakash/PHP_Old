...
<title>PHP array_product() Function</title>
<style>a.menu_func_array_product{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_product()</span> Function</h1>
...
<p>Calculate and return the product of an array:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_product">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The array_product() function calculates and returns the product of an array.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

array_product(<em>array</em>)
...
<tr>
	...
	<td style="width:80%">Returns the product as an integer or float</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.1.0+</td>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 5.3.6, the product of an empty array is 1. Before PHP 
	5.3.6, this function would return 0 for an empty array.</td>
</tr>
</table>
<br>
<hr>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_product2">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_product.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_product.asp#top" target="_top">TOP</a> |
		<a href="func_array_product.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
