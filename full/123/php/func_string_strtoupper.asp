...
<style>a.menu_func_string_strtoupper{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strtoupper()</span> Function</h1>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strtoupper">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strtoupper() function converts a string to 
uppercase.</p>
...
<ul>
	...
	<li><a href="func_string_lcfirst.asp">lcfirst()</a> - converts the 
	first character of a string to lowercase</li>
...
<tr>
	...
	<td style="width:80%">Returns the the uppercased string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strtoupper.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strtoupper.asp#top" target="_top">TOP</a> |
		<a href="func_string_strtoupper.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
