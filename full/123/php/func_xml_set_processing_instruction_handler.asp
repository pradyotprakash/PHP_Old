...
<title>PHP xml_set_processing_instruction_handler() Function</title>
<style>a.menu_func_xml_set_processing_instruction_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_set_processing_instruction_handler()</span> Function</h1>
<hr>
...
<p>The xml_set_processing_instruction_handler() function specifies a function to be called 
when the parser finds a processing instruction in the XML document.</p>
<p>A processing instruction is enclosed in &lt;? and ?&gt; delimiters and contains a a 
target followed by data.</p>
<p>Example: In this case the processing instruction associates a style sheet 
with an XML document:</p>

<div class="code notranslate"><div>

&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;<br>
<b>&lt;?xml-stylesheet href=&quot;default.xsl&quot; type=&quot;text/xml&quot;?&gt;</b><br>
&lt;note&gt;<br>
&lt;to&gt;Tove&lt;/to&gt;<br>
&lt;from&gt;Jani&lt;/from&gt;<br>
...
<p>The Function specified by the &quot;handler&quot; parameter must have three parameters:<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<tr>
    <td>target</td>
    <td>Required. Specifies a variable containing processing 
...
&nbsp;&nbsp;}<br>
<br>
function pi_handler($parser, $target, $data)<br>
&nbsp;&nbsp;{<br>
...
xml_set_processing_instruction_handler($parser, &quot;pi_handler&quot;);<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_set_processing_instruction_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_set_processing_instruction_handler.asp#top" target="_top">TOP</a> |
		<a href="func_xml_set_processing_instruction_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
