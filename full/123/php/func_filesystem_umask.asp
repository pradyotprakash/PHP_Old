...
<title>PHP umask() Function</title>
<style>a.menu_func_filesystem_umask{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">umask()</span> Function</h1>
<hr>
...
<p>The umask() function changes the file permissions for files.</p>
<p>This function sets PHP's umask to <i>mask</i> &amp; 0777 and returns the old 
umask. However, if you call umask() without any arguments, it returns the current umask.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>mask</td>
    <td>Optional. Specifies the new permissions. Default is 0777<p>
	The mode parameter consists of four numbers:</p>
	<ul>
		<li>The first number is always zero 
		</li>
		<li>The second number specifies permissions for the owner 
		</li>
		<li>The third number specifies permissions for the owner's user group 
		</li>
	...
	numbers):</p>
	<ul>
		<li>1 = execute permissions 
		</li>
		<li>2 = write permissions 
		</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_umask.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_umask.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_umask.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
