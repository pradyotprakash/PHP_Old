...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_mail.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_error.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
that checks the &quot;from&quot; field in the form:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;return FALSE;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>?&gt;<br><br>&lt;h2&gt;Feedback Form&lt;/h2&gt;<br>&lt;?php<br>// 
	display form if user has not clicked submit<br>if (!isset($_POST[&quot;submit&quot;]))<br>&nbsp; 
	{<br>&nbsp; ?&gt;<br>&nbsp; &lt;form method=&quot;post&quot; action=&quot;&lt;?php echo 
	$_SERVER[&quot;PHP_SELF&quot;];?&gt;&quot;&gt;<br>&nbsp; From: &lt;input type=&quot;text&quot; name=&quot;from&quot;&gt;&lt;br&gt;<br>&nbsp; 
	Subject: &lt;input type=&quot;text&quot; name=&quot;subject&quot;&gt;&lt;br&gt;<br>&nbsp; Message: &lt;textarea 
	rows=&quot;10&quot; cols=&quot;40&quot; name=&quot;message&quot;&gt;&lt;/textarea&gt;&lt;br&gt;<br>&nbsp; &lt;input 
	type=&quot;submit&quot; name=&quot;submit&quot; value=&quot;Submit Feedback&quot;&gt;<br>&nbsp; &lt;/form&gt;<br>&nbsp; 
	&lt;?php <br>&nbsp; }<br>else<br>&nbsp; // the user has submitted the form<br>&nbsp; 
	{<br>&nbsp; // Check if the &quot;from&quot; input field is filled out<br>&nbsp; if (isset($_POST[&quot;from&quot;]))<br>&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp; // Check if &quot;from&quot; email address is valid<br>
&nbsp;
...
&nbsp;&nbsp;else<br>
&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $from = 
	$_POST[&quot;from&quot;]; // sender<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $subject = 
	$_POST[&quot;subject&quot;];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $message = 
	$_POST[&quot;message&quot;];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // message lines should 
	not exceed 70 characters (PHP rule), so wrap it<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	$message = wordwrap($message, 70);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // send 
	mail<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_secure_mail.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_secure_mail.asp#top" target="_top">TOP</a> |
		<a href="php_secure_mail.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
