...
<title>PHP cal_info() Function</title>
<style>a.menu_func_cal_cal_info{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">cal_info()</span> Function</h1>
...
<p>Return information about the Gregorian calendar:</p>
<div class="example_code notranslate">
&lt;?php<br>
	print_r(cal_info(0));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_cal_info">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cal_info() function returns information about a specified calendar.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	cal_info(<em>calendar);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies a number that indicates which calendar to return 
	information about:
	<ul>
	  ...
	  <p><strong>Tip:</strong> If the <em>calendar</em> parameter is omitted, 
	  cal_info() returns info about all calendars</p>
	  </td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an array containing calendar elements like:
	<ul>
		<li>calname</li>
		<li>calsymbol</li>
		<li>month</li>
...
<tr>
	<th>Changelog:</th>
	<td>In PHP 5.0 the <em>calendar</em> parameter became optional</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_cal_info.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_cal_info.asp#top" target="_top">TOP</a> |
		<a href="func_cal_cal_info.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
