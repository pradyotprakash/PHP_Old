...
<title>PHP ftp_site() Function</title>
<style>a.menu_func_ftp_site{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_site()</span> Function</h1>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// try to send 
	SITE command<br>
	if (ftp_site($ftp_conn, 
	&quot;chmod 777 serverfile.txt&quot;))<br>&nbsp; {<br>&nbsp; echo 
	&quot;Command executed successfully&quot;;<br>&nbsp; }<br>else<br>&nbsp; 
	{<br>&nbsp; echo &quot;Command failed&quot;;<br>&nbsp; }<br>
...
<p>The ftp_site() function sends an FTP SITE command to the FTP server.</p>
<p><strong>Note:</strong> SITE commands vary from server to server. 
They are useful for handling OS specific features such as file permissions and group membership.</p>
<p><b>Tip:</b> To see what SITE commands are available, send the REMOTEHELP command using 
the <a href="func_ftp_raw.asp">ftp_raw()</a> function.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_site(<em>ftp_connection,command</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>command</em></td>
    <td>Required. Specifies the SITE command (this parameter is not escaped)</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_site.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_site.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_site.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
