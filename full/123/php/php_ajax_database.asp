...
<style>a.menu_php_ajax_database{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ajax_php.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ajax_xml.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<form action="php_ajax_database.asp"> 
...
<p>The database table we use in the example above looks like this:</p>
...
<p>When a user selects a user in the dropdown list above, a function called &quot;showUser()&quot; is executed. The 
...
<p>The showUser() function does the following:</p>
<ul>
	<li>Check if a person is selected</li>
...
<h2>The PHP File</h2>
<p>The page on the server called by the JavaScript above is a PHP file called &quot;getuser.php&quot;.</p>
<p>The source code in &quot;getuser.php&quot; runs a query against a MySQL database, and returns the result in an HTML 
table:</p>
<div class="code notranslate"><div>
&lt;?php<br>$q = intval($_GET['q']);<br>
<br>
...
&nbsp;&nbsp;}<br>
<br>
mysqli_select_db($con,&quot;ajax_demo&quot;);<br>
...
<p>Explanation: When the query is sent from the JavaScript to the PHP file, the following happens:</p>
<ol>
	<li>PHP opens a connection to a MySQL server</li>
	<li>The correct person is found</li>
	<li>An HTML table is created, filled with data, and sent back to the &quot;txtHint&quot; 
	placeholder</li>
</ol>
<br>
<div class="chapter">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ajax_database.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ajax_database.asp#top" target="_top">TOP</a> |
		<a href="php_ajax_database.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
