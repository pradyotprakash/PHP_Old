...
<title>PHP xml_get_error_code() Function</title>
<style>a.menu_func_xml_get_error_code{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_get_error_code()</span> Function</h1>
<hr>
...
<p>The xml_get_error_code() function gets the XML parser error code.</p>
<p>This function returns the error code on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_get_error_code.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_get_error_code.asp#top" target="_top">TOP</a> |
		<a href="func_xml_get_error_code.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
