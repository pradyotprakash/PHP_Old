...
<title>PHP is_link() Function</title>
<style>a.menu_func_filesystem_is_link{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">is_link()</span> Function</h1>
<hr>
...
<p>The is_link() function checks whether the specified file is a link.</p>
<p>This function returns TRUE if it is a link.</p>
<h2>Syntax</h2>
...
if(is_link($link))<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo (&quot;$link is a link&quot;);<br>
&nbsp;&nbsp;}<br>
else<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo (&quot;$link is not a link&quot;);<br>
&nbsp;&nbsp;}<br>
?&gt; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_is_link.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_is_link.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_is_link.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
