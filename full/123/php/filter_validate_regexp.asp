...
<title>PHP FILTER_VALIDATE_REGEXP Filter</title>
<style>a.menu_filter_validate_regexp{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_VALIDATE_REGEXP</span> Filter</h1>
<hr>
...
<p>The FILTER_VALIDATE_REGEXP filter validates value against a Perl-compatible 
regular expression.</p>
<ul>
	<li>Name: &quot;validate_regexp&quot;</li>
	<li>ID-number: 272</li>
</ul>
<p>Possible options:</p>
<ul>
	<li>regexp - specifies the regular expression to validate against</li>
</ul>
<hr>
<h2>Example</h2>
...
&lt;?php<br>
$string = &quot;Match this string&quot;;<br>
<br>
var_dump(filter_var($string, FILTER_VALIDATE_REGEXP,<br>
array(&quot;options&quot;=&gt;array(&quot;regexp&quot;=&gt;&quot;/^M(.*)/&quot;))))<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_validate_regexp.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_validate_regexp.asp#top" target="_top">TOP</a> |
		<a href="filter_validate_regexp.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
