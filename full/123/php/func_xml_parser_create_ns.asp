...
<title>PHP xml_parser_create_ns() Function</title>
<style>a.menu_func_xml_parser_create_ns{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_parser_create_ns()</span> Function</h1>
<hr>
...
<p>The xml_parser_create_ns() function creates an XML parser with namespace 
support.</p>
<p>This function returns a resource handle to be used by other XML functions on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>encoding</td>
    <td>Optional. Specifies the output encoding. Default in PHP 
	5.0.2 and newer is UTF-8<p>Possible values:</p>
	<ul>
		<li>ISO-8859-1</li>
		<li>UTF-8</li>
		<li>US-ASCII.</li>
	...
	this paramterer specifies the character encoding for the input and output.</p>
	<p><b>Note: </b>In PHP 5.0.0 and 5.0.1, default output charset is ISO-8859-1.</td>
  </tr>
  <tr>
    <td>separator</td>
    <td>Optional. Specifies the output separator for tag name and 
	namespace. Default is &quot; : &quot;</td>
  </tr>
  </table>
<br>
...
<p><b>Tip:</b> To free the xml parser, use the xml_parser_free() function.</p>
<p><b>Tip:</b> To create an XML parser without namespace support, use the 
xml_parser_create() function instead.</p>
...
&lt;?php<br>
$xmlparser = xml_parser_create_ns();<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_parser_create_ns.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_parser_create_ns.asp#top" target="_top">TOP</a> |
		<a href="func_xml_parser_create_ns.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
