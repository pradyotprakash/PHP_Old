...
<title>PHP simplexml_load_string() Function</title>
<style>a.menu_func_simplexml_load_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">simplexml_load_string()</span> Function</h1>
<p><a href="php_ref_simplexml.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP SimpleXML Reference" /> PHP SimpleXML Reference</a></p>
<div class="example">
<h2 class="example">Example</h2>
<p>Convert a well-formed XML string into a SimpleXMLElement object, then output keys and elements 
of the 
object:</p>
<div class="example_code notranslate">
	&lt;?php<br>$note=&lt;&lt;&lt;XML<br>&lt;note&gt;<br>&lt;to&gt;Tove&lt;/to&gt;<br>&lt;from&gt;Jani&lt;/from&gt;<br>&lt;heading&gt;Reminder&lt;/heading&gt;<br>
	&lt;body&gt;Don't forget me this weekend!&lt;/body&gt;<br>&lt;/note&gt;<br>XML;<br><br>
	$xml=simplexml_load_string($note);<br>print_r($xml);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_load_string">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The simplexml_load_string() function converts a well-formed XML string into a SimpleXMLElement object.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
simplexml_load_string(<em>data,classname,options,ns,is_prefix</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>data</em></td>
    <td>Required. Specifies a well-formed XML string</td>
  </tr>
	<tr>
    <td><em>classname</em></td>
    <td>Optional. Specifies the class of the new object</td>
  </tr>
  <tr>
    <td><em>options</em></td>
    <td>Optional. Specifies additional Libxml parameters. Is set by 
	specifying the option and 1 or 0 (TRUE or FALSE, e.g. LIBXML_NOBLANKS(1))<p>
	Possible values:</p>
	<ul>
		<li>LIBXML_COMPACT - Activate nodes allocation optimization (may 
		speed up application)</li>
		<li>LIBXML_DTDATTR - Set default DTD attributes</li>
		<li>LIBXML_DTDLOAD - Load external subset</li>
		<li>LIBXML_DTDVALID - Validate with the DTD</li>
		<li>LIBXML_NOBLANKS - Remove blank nodes</li>
		<li>LIBXML_NOCDATA - Merge CDATA as text nodes</li>
		<li>LIBXML_NOEMPTYTAG - Expand empty tags (e.g. &lt;br/&gt; to &lt;br&gt;&lt;/br&gt;), 
		only available in the DOMDocument-&gt;save() and DOMDocument-&gt;saveXML() 
		functions</li>
		<li>LIBXML_NOENT - Substitute entities</li>
		<li>LIBXML_NOERROR - Do not show error reports</li>
		<li>LIBXML_NONET - Disable network access while loading documents</li>
		<li>LIBXML_NOWARNING - Do not show warning reports</li>
		<li>LIBXML_NOXMLDECL - Drop the XML declaration when saving a document</li>
		<li>LIBXML_NSCLEAN - Remove redundant namespace declarations</li>
		<li>LIBXML_PARSEHUGE - Sets XML_PARSE_HUGE flag, which relaxes any 
		hardcoded limit from the parser. This affects limits like maximum depth 
		of a document and limits of the size of text nodes</li>
		<li>LIBXML_XINCLUDE - Implement XInclude substitution</li>
		<li>LIBXML_ERR_ERROR - Get recoverable errors</li>
		<li>LIBXML_ERR_FATAL - Get fatal errors</li>
		<li>LIBXML_ERR_NONE - Get no errors</li>
		<li>LIBXML_ERR_WARNING - Get simple warnings</li>
		<li>LIBXML_VERSION - Get libxml version (e.g. 20605 or 20617)</li>
		<li>LIBXML_DOTTED_VERSION - Get dotted libxml version (e.g. 2.6.5 or 
		2.6.17)</li>
	</ul>
	</td>
  </tr>
	<tr>
    <td><em>ns</em></td>
    <td>Optional. Specifies a namespace prefix or URI</td>
  </tr>
  <tr>
    <td><em>is_prefix</em></td>
    <td>Optional. Specifies a Boolean value. TRUE if <em>ns</em> is a prefix. 
	FALSE if <em>ns</em> is a URI. Default is FALSE</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns a SimpleXMLElement object on success. FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<p>Output the data from each element in the XML string:</p>
<div class="example_code notranslate">
	&lt;?php<br>$note=&lt;&lt;&lt;XML<br>&lt;note&gt;<br>&lt;to&gt;Tove&lt;/to&gt;<br>&lt;from&gt;Jani&lt;/from&gt;<br>&lt;heading&gt;Reminder&lt;/heading&gt;<br>
	&lt;body&gt;Don't forget me this weekend!&lt;/body&gt;<br>&lt;/note&gt;<br>XML;<br><br>
	$xml=simplexml_load_string($note);<br>echo $xml-&gt;to . &quot;&lt;br&gt;&quot;;<br>echo 
	$xml-&gt;from . &quot;&lt;br&gt;&quot;;<br>echo $xml-&gt;heading . &quot;&lt;br&gt;&quot;;<br>echo $xml-&gt;body;<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_load_string2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Output the element's name and data for each child node in the XML string:</p>
<div class="example_code notranslate">
	&lt;?php<br>$note=&lt;&lt;&lt;XML<br>&lt;note&gt;<br>&lt;to&gt;Tove&lt;/to&gt;<br>&lt;from&gt;Jani&lt;/from&gt;<br>&lt;heading&gt;Reminder&lt;/heading&gt;<br>
	&lt;body&gt;Don't forget me this weekend!&lt;/body&gt;<br>&lt;/note&gt;<br>XML;<br><br>
	$xml=simplexml_load_string($note);<br>echo $xml-&gt;getName() . &quot;&lt;br&gt;&quot;;<br><br>
	foreach($xml-&gt;children() as $child)<br>&nbsp; {<br>&nbsp; echo 
	$child-&gt;getName() . &quot;: &quot; . $child . &quot;&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_load_string3">Run example &raquo;</a>
</div>
<br>
<hr>
<a href="php_ref_simplexml.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP SimpleXML Reference" /> PHP SimpleXML Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_load_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_load_string.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_load_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
