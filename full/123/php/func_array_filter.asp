...
<title>PHP array_filter() Function</title>
<style>a.menu_func_array_filter{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_filter()</span> Function</h1>
...
<div class="example_code notranslate">
	&lt;?php<br>function test_odd($var)<br>{<br>return($var &amp; 1);<br>}<br><br>
	$a1=array(&quot;a&quot;,&quot;b&quot;,2,3,4);<br>print_r(array_filter($a1,&quot;test_odd&quot;));<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_filter">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_filter() function filters the values of an array using a callback 
function.</p>
<p>This function passes each value of the input array to the callback function. 
If the callback function returns true, the current value from input is returned 
into the result array. Array keys are preserved. </p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>

array_filter(<em>array,callbackfunction</em>);</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>array</em></td>
    <td>Required. Specifies the array to filter</td>
  </tr>
  <tr>
    <td><em>callbackfunction</em></td>
    <td>Required. Specifies the callback function to use</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_filter.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_filter.asp#top" target="_top">TOP</a> |
		<a href="func_array_filter.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
