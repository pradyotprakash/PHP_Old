...
<title>PHP ftp_fput() Function</title>
<style>a.menu_func_ftp_fput{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_fput()</span> Function</h1>
...
<p>Open local file, and upload it to a file on the FTP server:</p>
<div class="example_code notranslate">
&lt;?php<br>
	// connect and login to FTP server<br>
	$ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or 
	die(&quot;Could not connect to $ftp_server&quot;);<br>$login 
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// open file for 
	reading<br>$file = 
	&quot;test.txt&quot;;<br>$fp = fopen($file,&quot;r&quot;);<br><br>// upload file<br>if (ftp_fput($ftp_conn, 
	&quot;somefile.txt&quot;, $fp, FTP_ASCII))<br>&nbsp; {<br>&nbsp; echo &quot;Successfully 
	uploaded $file.&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error uploading 
	$file.&quot;;<br>&nbsp; }<br><br>// close this connection and file handler<br>ftp_close($ftp_conn);<br>
	fclose($fp);<br>?&gt;
</div>
</div>
<hr>
...
<p>The ftp_fput() function uploads from an open file and saves it to a file on 
the FTP server.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_fput(<em>ftp_connection,remote_file,open_file,mode,startpos</em>);
</div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_fput.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_fput.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_fput.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
