...
<title>PHP FILTER_UNSAFE_RAW Filter</title>
<style>a.menu_filter_unsafe_raw{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_UNSAFE_RAW</span> Filter</h1>
<hr>
...
<p>The FILTER_UNSAFE_RAW filter does nothing, or encodes and strips 
...
<p>This filter does nothing if no flags are specified</p>
<ul>
	<li>Name: &quot;unsafe_raw&quot;</li>
	<li>ID-number: 516</li>
</ul>
<p>Possible flags:</p>
<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_unsafe_raw.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_unsafe_raw.asp#top" target="_top">TOP</a> |
		<a href="filter_unsafe_raw.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
