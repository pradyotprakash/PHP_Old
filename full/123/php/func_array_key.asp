...
<title>PHP key() Function</title>
<style>a.menu_func_array_key{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">key()</span> Function</h1>
...
<p>Return the element key from the current internal pointer position:</p>
<div class="example_code notranslate">
&lt;?php<br>
$people=array(&quot;Peter&quot;,&quot;Joe&quot;,&quot;Glenn&quot;,&quot;Cleveland&quot;);<br>
echo &quot;The key from the current position is: &quot; . key($people);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_key">Run example &raquo;</a>
</div>
<hr>
<h2>Definition and Usage</h2>

<p>The key() function returns the element key from the current internal pointer 
position.</p>
<p>This function returns FALSE 
on error.</p>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns the key of the array element 
	that is currently being pointed to by the internal pointer</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_key.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_key.asp#top" target="_top">TOP</a> |
		<a href="func_array_key.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
