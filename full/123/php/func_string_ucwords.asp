...
<style>a.menu_func_string_ucwords{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ucwords()</span> Function</h1>
...
<p>Convert the first character of each word to uppercase: </p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_ucwords">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The ucwords() function converts the first character of each word in a string to uppercase.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_ucwords.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_ucwords.asp#top" target="_top">TOP</a> |
		<a href="func_string_ucwords.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
