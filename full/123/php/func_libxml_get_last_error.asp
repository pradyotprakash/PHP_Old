...
<title>PHP libxml_get_last error() Function</title>
<style>a.menu_func_libxml_get_last_error{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">libxml_get_last_error()</span> Function</h1>
<hr>
...
<p>The libxml_get_last_error() function gets the last error from the libxml error buffer</p>
<p>This function returns an error object on success, and FALSE on failure or if there 
are no errors in the libxml error buffer.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_libxml_get_last_error.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_libxml_get_last_error.asp#top" target="_top">TOP</a> |
		<a href="func_libxml_get_last_error.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
