...
<style>a.menu_php_ajax_xml{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ajax_database.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ajax_livesearch.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>When a user selects a CD in the dropdown list above, a function called &quot;showCD()&quot; is executed. The 
...
&lt;/select&gt;<br>
&lt;/form&gt;<br>&lt;div id=&quot;txtHint&quot;&gt;&lt;b&gt;CD info will be listed here...&lt;/b&gt;&lt;/div&gt;<br><br>
&lt;/body&gt;<br>
&lt;/html&gt;</div></div>
...
<p>The page on the server called by the JavaScript above is a PHP file called &quot;getcd.php&quot;.</p>
<p>The PHP script loads an XML document, &quot;<a target="_blank" href="cd_catalog.xml">cd_catalog.xml</a>&quot;, runs a query against the XML file, and returns the result as HTML:</p>
<div class="code notranslate"><div>
...
<p>When the CD query is sent from the JavaScript to the PHP page, the following 
happens:</p>
<ol>
	<li>PHP creates an XML DOM object</li>
	<li>Find all &lt;artist&gt; elements that matches the 
	name sent from the JavaScript</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ajax_xml.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ajax_xml.asp#top" target="_top">TOP</a> |
		<a href="php_ajax_xml.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
