...
<title>PHP chmod() Function</title>
<style>a.menu_func_filesystem_chmod{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">chmod()</span> Function</h1>
<hr>
...
<p>The chmod() function changes permissions of the specified file.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>mode</td>
    <td>Required. Specifies the new permissions.<p>The mode 
...
&lt;?php<br>
// Read and write for owner, nothing for everybody else<br>
chmod(&quot;test.txt&quot;,0600);<br>
<br>
// Read and write for owner, read for everybody else<br>
chmod(&quot;test.txt&quot;,0644);<br>
<br>
// Everything for owner, read and execute for everybody else<br>
chmod(&quot;test.txt&quot;,0755);<br>
<br>
// Everything for owner, read for owner's group<br>
chmod(&quot;test.txt&quot;,0740);<br>
?&gt; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_chmod.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_chmod.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_chmod.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
