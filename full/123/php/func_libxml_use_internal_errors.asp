...
<title>PHP libxml_use_internal_errors() Function</title>
<style>a.menu_func_libxml_use_internal_errors{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">libxml_use_internal_errors()</span> Function</h1>
<hr>
<a href="php_ref_libxml.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP libxml Reference" /> Complete PHP libxml Reference</a>
<hr>

<h2>Definition and Usage</h2>

<p>The libxml_use_internal_errors() function disables standard libxml errors and 
enables user error handling.</p>
<p>This function returns the previous value of the use_lib_errors parameter.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>user_errors</td>
    <td>Optional. Specifies if user error handling should be 
	enabled. Default is FALSE</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_libxml_use_internal_errors.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_libxml_use_internal_errors.asp#top" target="_top">TOP</a> |
		<a href="func_libxml_use_internal_errors.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
