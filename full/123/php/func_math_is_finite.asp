...
<title>PHP is_finite() Function</title>
<style>a.menu_func_math_is_finite{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">is_finite()</span> Function</h1>
...
<p>Check whether a value is finite or not:</p>
<div class="example_code notranslate">
&lt;?php<br>
echo is_finite(2) . &quot;&lt;br&gt;&quot;;<br>
echo is_finite(log(0)) . &quot;&lt;br&gt;&quot;;<br>
echo is_finite(2000);<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_is_finite">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The is_finite() function checks whether a value is finite or not.</p>
<p>This function returns true (1) if the specified value is a finite number, otherwise it returns false/nothing.</p>
<p>The value is finite if it is within the allowed range for a PHP float on this platform.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	is_finite(<em>value</em>);</div></div>
<br>
...
<tr>
	...
	<td style="width:80%">TRUE if <em>value</em> is a finite number, FALSE otherwise</td>
</tr>
	<tr>
	<th>Return Type:</th>
	<td>Boolean</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_is_finite.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_is_finite.asp#top" target="_top">TOP</a> |
		<a href="func_math_is_finite.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
