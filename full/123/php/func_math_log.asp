...
<title>PHP log() Function</title>
<style>a.menu_func_math_log{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">log()</span> Function</h1>
...
<p>Return the natural logarithm of different numbers:</p>
<div class="example_code notranslate">
&lt;?php<br>
echo(log(2.7183) . &quot;&lt;br&gt;&quot;);<br>
echo(log(2) . &quot;&lt;br&gt;&quot;);<br>
echo(log(1) . &quot;&lt;br&gt;&quot;);<br>
echo(log(0);<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_log">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The log() function returns the natural logarithm of a number, or the 
logarithm of <em>number</em> to <em>base</em>.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	log(<em>number,base</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the value to calculate the logarithm for</td>
  </tr>
  <tr>
    <td><em>base</em></td>
    <td>Optional. The logarithmic base to use. Default is 'e'</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">The natural logarithm of a number, or the logarithm of <em>
	number</em> to <em>base</em></td>
</tr>
<tr>
	<th>Return Type:</th>
	<td>Float</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 4.3: The base parameter were added</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_log.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_log.asp#top" target="_top">TOP</a> |
		<a href="func_math_log.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
