...
<style>a.menu_func_filesystem_fopen{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fopen()</span> Function</h1>
<hr>
...
<p>The fopen() function opens a file or URL.</p>
<p>If fopen() fails, it returns FALSE and an error on failure. You can hide the 
error output by adding an '@' in front of the function name.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>mode</td>
    <td>Required. Specifies the type of access you require to the 
	file/stream.<p>Possible values:</p>
	<ul>
		<li>&quot;r&quot; (Read only. Starts at the beginning of the file)</li>
		<li>&quot;r+&quot; (Read/Write. Starts at the beginning of the 
		file)</li>
		<li>&quot;w&quot; (Write only. Opens and clears the contents of file; or creates a new 
		file if it doesn't exist)</li>
		<li>&quot;w+&quot; (Read/Write. Opens and clears the contents of file; or creates a new 
		file if it doesn't exist)</li>
		<li>&quot;a&quot; (Write only. Opens and writes to the end of the file or creates a new 
		file if it doesn't exist)</li>
		<li>&quot;a+&quot; (Read/Write. Preserves file content by writing to the end of the 
		file)</li>
		<li>&quot;x&quot; (Write only. Creates a new file. Returns FALSE and an error if 
		file already exists)</li>
		<li>&quot;x+&quot; (Read/Write. Creates a new file. Returns FALSE and an error 
		if file already exists)</li>
	</ul>
	</td>
  </tr>
	<tr>
    <td>include_path</td>
    <td>Optional. Set this parameter to '1' if you want to search 
	for the file in the include_path (in php.ini) as well</td>
  </tr>
	<tr>
    <td>context</td>
    <td>Optional. Specifies the context of the file handle. 
	Context is a set of options that can modify the behavior of a stream</td>
  </tr>
  </table>
<br>
...
<p><b>Note:</b> When writing to a text file, be sure to use the correct 
...
$file = fopen(&quot;/home/test/test.txt&quot;,&quot;r&quot;);<br>
$file = fopen(&quot;/home/test/test.gif&quot;,&quot;wb&quot;);<br>
$file = fopen(&quot;http://www.example.com/&quot;,&quot;r&quot;);<br>
$file = fopen(&quot;ftp://user:password@example.com/test.txt&quot;,&quot;w&quot;);<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fopen.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fopen.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fopen.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
