...
<title>PHP fputs() Function</title>
<style>a.menu_func_filesystem_fputs{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fputs()</span> Function</h1>
<hr>
...
<p>The fputs() writes to an open file.</p>
<p>The function 
	will stop at the end of the file or when it reaches the specified length, whichever comes first.</p>
<p>This function returns the number of bytes written on 
success, or FALSE on failure.</p>
<p>The fputs() function is an alias of the fwrite() function.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td>string</td>
    <td>Required. Specifies the string to write to the open file</td>
  </tr>
	<tr>
    <td>length</td>
    <td>Optional. Specifies the maximum number of bytes to write</td>
  </tr>
	</table>
<br>
<hr>
...
echo fputs($file,&quot;Hello World. Testing!&quot;);<br>
fclose($file);<br>
?&gt; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fputs.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fputs.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fputs.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
