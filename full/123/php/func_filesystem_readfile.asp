...
<style>a.menu_func_filesystem_readfile{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">readfile()</span> Function</h1>
<hr>
...
<p>This function returns the number of bytes read on success, or FALSE 
...
<p><b>Tip:</b> You can use a URL as a filename with this function if the fopen 
wrappers have been enabled in the php.ini file.</p>
<hr>
...
There are two lines in this file.<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_readfile.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_readfile.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_readfile.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
