...
<title>PHP strcspn() Function</title>
<style>a.menu_func_string_strcspn{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strcspn()</span> Function</h1>
...
<p>Print the number of characters found in &quot;Hello world!&quot; before the character 
&quot;w&quot;:</p>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strcspn">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strcspn() function returns the number of characters (including 
whitespaces) found in a string 
before any part of the specified characters are found.</p>
<p><strong>Tip:</strong> Use the <a href="func_string_strspn.asp">strspn()</a> 
function to the number of characters found in the string that contains only 
characters from a specified character list.</p>
...
strcspn(<em>string,char,start,length</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td><em>char</em></td>
    <td>Required. Specifies the characters to search for</td>
  </tr>
  <tr>
    <td><em>start</em></td>
    <td>Optional. Specifies where in string to start</td>
  </tr>
  <tr>
    <td><em>length</em></td>
    <td>Optional. Specifies the length of the string (how much of 
	the 
	string to search)</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the number of characters found in a string before 
	any part of the specified characters are found</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>start</em> and <em>length</em> parameters were added in PHP 4.3</td>
</tr>
</table>
<br>
...
<p>Using all parameters to print the number of characters found in &quot;Hello 
world!&quot; before the character &quot;w&quot;:</p>
<div class="example_code notranslate">

&lt;?php<br>
echo strcspn(&quot;Hello world!&quot;,&quot;w&quot;,0,6); 
	// The start position is 0 and the length of the search string is 6.<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strcspn2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strcspn.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strcspn.asp#top" target="_top">TOP</a> |
		<a href="func_string_strcspn.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
