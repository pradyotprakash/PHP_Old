...
<title>PHP gregoriantojd() Function</title>
<style>a.menu_func_cal_gregoriantojd{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">gregoriantojd()</span> Function</h1>
...
<p>Convert a Gregorian date to a Julian Day Count and back to a Gregorian date:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$jd=gregoriantojd(6,20,2007);<br>echo $jd . &quot;&lt;br&gt;&quot;;<br>echo jdtogregorian($jd);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_gregoriantojd">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The gregoriantojd() function converts a date from the Gregorian Calendar to a Julian Day Count.</p>
<p><strong>Note:</strong> Although this function can handle dates back to 4714 B.C., notice that the Gregorian
calendar was not instituted until 1582, and some countries did not accept it until much later (Britain converted in 1752,
USSR in 1918, and Greece in 1923). Most European countries used the Julian calendar prior the Gregorian.</p>
<p><strong>Tip:</strong> Look at the <a href="func_cal_jdtogregorian.asp">jdtogregorian()</a> function to convert
a Julian Day Count to a Gregorian date.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	gregoriantojd(<em>month,day,year);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>year</em></td>
    <td>Required. Specifies the year as a number between -4714 and 9999</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_gregoriantojd.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_gregoriantojd.asp#top" target="_top">TOP</a> |
		<a href="func_cal_gregoriantojd.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
