...
<style>a.menu_func_ftp_put{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_put()</span> Function</h1>
...
<p>Upload local file to a file on the FTP server:</p>
...
<p>The ftp_put() function uploads a file to the FTP server.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_put(<em>ftp_connection,remote_file,local_file,mode,startpos</em>);
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the path of the file to upload</td>
  </tr>
	<tr>
    <td><em>mode</em></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_put.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_put.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_put.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
