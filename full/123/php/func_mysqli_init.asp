...
<title>PHP mysqli_init() Function</title>
<style>a.menu_func_mysqli_init{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_init()</span> Function</h1>
...
<p>Use of the mysqli_init() function:</p>
<div class="example_code notranslate">
	&lt;?php<br>$con=mysqli_init();<br>if (!$con)<br>&nbsp; {<br>&nbsp; 
...
<p>The mysqli_init() function initializes MySQLi and returns an object to use 
with the <a href="func_mysqli_real_connect.asp">mysqli_real_connect()</a> function.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mmysqli_init();</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_init.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_init.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_init.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
