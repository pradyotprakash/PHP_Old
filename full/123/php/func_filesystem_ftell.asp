...
<title>PHP ftell() Function</title>
<style>a.menu_func_filesystem_ftell{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftell()</span> Function</h1>
<hr>
...
<p>The ftell() function returns the current position in an open file.</p>
<p>Returns the current file pointer position, or FALSE on failure.</p>
<h2>Syntax</h2>
...
<br>
// print current position<br>
echo ftell($file);<br>
<br>
// change current position<br>
fseek($file,&quot;15&quot;);<br>
<br>
// print current position again<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_ftell.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_ftell.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_ftell.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
