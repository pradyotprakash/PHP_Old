...
<title>PHP timezone_offset_get() Function</title>
<style>a.menu_func_date_timezone_offset_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">timezone_offset_get()</span> Function</h1>
...
<p>Return the timezone offset from GMT:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$tz=timezone_open(&quot;Asia/Taipei&quot;);<br>
	$dateTimeOslo=date_create(&quot;now&quot;,timezone_open(&quot;Europe/Oslo&quot;));<br>echo 
	timezone_offset_get($tz,$dateTimeOslo);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_timezone_offset_get">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The timezone_offset_get() returns the timezone offset from GMT.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
timezone_offset_get<em>(object,datetime);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>object</em></td>
    <td>Required. Specifies a DateTimeZone object returned by
	<a href="func_date_timezone_open.asp">timezone_open()</a></td>
  </tr>
  <tr>
    <td><em>datetime</em></td>
    <td>Required. Specifies a date/time to compute the offset from</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the timezone offset in seconds on success. FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_timezone_offset_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_timezone_offset_get.asp#top" target="_top">TOP</a> |
		<a href="func_date_timezone_offset_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
