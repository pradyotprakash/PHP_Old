...
<title>PHP xml_set_external_entity_ref_handler() Function</title>
<style>a.menu_func_xml_set_external_entity_ref_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_set_external_entity_ref_handler()</span> Function</h1>
<hr>
...
<p>The xml_set_external_entity_ref_handler() function specifies a function to be called 
when the parser finds an external entity in the XML document.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td>handler</td>
    <td>Required. Specifies a function to be called when the parser finds 
...
<table class="reference notranslate">
  ...
  <tr>
	...
	identifier (system_id) of the external entity. Currently, this is always 
	NULL</td>
  </tr>
	<tr>
    <td>system_id</td>
    <td>Required. Specifies the system identifier for the external 
	entity</td>
  </tr>
	<tr>
    <td>public_id</td>
    <td>Required. Specifies the public identifier for the external 
	entity</td>
  </tr>
  </table>
<br>
...
&nbsp;&nbsp;}<br>
<br>
function ext_ent_handler($parser,$ent,$base,$sysID,$pubID)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo &quot;$ent&lt;br /&gt;&quot;;<br>
&nbsp;&nbsp;echo &quot;$sysID&lt;br /&gt;&quot;;<br>
&nbsp;&nbsp;echo &quot;$pubID&lt;BR /&gt;&quot;;<br>
...
xml_set_external_entity_ref_handler($parser, &quot;ext_ent_handler&quot;);<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_set_external_entity_ref_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_set_external_entity_ref_handler.asp#top" target="_top">TOP</a> |
		<a href="func_xml_set_external_entity_ref_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
