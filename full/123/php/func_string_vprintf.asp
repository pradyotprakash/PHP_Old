...
<title>PHP vprintf() Function</title>
<style>a.menu_func_string_vprintf{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">vprintf()</span> Function</h1>
...
<p>Output a formatted string:</p>
<div class="example_code notranslate">

	&lt;?php<br>$number = 9;<br>$str = &quot;Beijing&quot;;<br>vprintf(&quot;There are %u million 
	bicycles in %s.&quot;,array($number,$str));<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_vprintf">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The vprintf() function outputs a formatted string.</p>
<p>Unlike printf(), the arguments in vprintf(), are placed in an array. The 
...
<p><b>Tip:</b> Related functions: <a href="func_string_sprintf.asp">sprintf()</a>,
<a href="func_string_printf.asp">printf()</a>,
...
<ul>
    ...
    <td>Required. An array with arguments to be inserted at 
	the % signs in the format string</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the length of the outputted string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.1.0+</td>
...
$num1 = 123;<br>
$num2 = 456;<br>
vprintf(&quot;%f%f&quot;,array($num1,$num2));<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_vprintf2">Run example &raquo;</a>
</div>
<br>
...
&lt;?php<br>
$number = 123;<br>
vprintf(&quot;With 2 decimals: %1\$.2f<br>
&lt;br&gt;With no decimals: %1\$u&quot;,array($number));<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_vprintf3">Run example &raquo;</a>
</div>
<br>
...
<p>Using printf() to demonstrate all possible format values: </p>
<div class="example_code notranslate">

	&lt;?php<br>$num1 = 123456789;<br>$num2 = -123456789;<br>$char = 50; // The 
	ASCII Character 50 is 2<br><br>// Note: The format value &quot;%%&quot; returns a 
	percent sign<br>printf(&quot;%%b = %b &lt;br&gt;&quot;,$num1); // Binary number<br>printf(&quot;%%c 
	= %c &lt;br&gt;&quot;,$char); // The ASCII Character<br>printf(&quot;%%d = %d &lt;br&gt;&quot;,$num1); 
	// Signed decimal number<br>printf(&quot;%%d = %d &lt;br&gt;&quot;,$num2); // Signed decimal 
	number<br>printf(&quot;%%e = %e &lt;br&gt;&quot;,$num1); // Scientific notation (lowercase)<br>
	printf(&quot;%%E = %E &lt;br&gt;&quot;,$num1); // Scientific notation (uppercase)<br>printf(&quot;%%u 
	= %u &lt;br&gt;&quot;,$num1); // Unsigned decimal number (positive)<br>printf(&quot;%%u = %u 
	&lt;br&gt;&quot;,$num2); // Unsigned decimal number (negative)<br>printf(&quot;%%f = %f &lt;br&gt;&quot;,$num1); 
	// Floating-point number (local settings aware)<br>printf(&quot;%%F = %F &lt;br&gt;&quot;,$num1); 
	// Floating-point number (not local settings aware)<br>printf(&quot;%%g = %g &lt;br&gt;&quot;,$num1); 
	// Shorter of %e and %f<br>printf(&quot;%%G = %G &lt;br&gt;&quot;,$num1); // Shorter of %E 
	and %f<br>printf(&quot;%%o = %o &lt;br&gt;&quot;,$num1); // Octal number<br>printf(&quot;%%s = %s 
	&lt;br&gt;&quot;,$num1); // String<br>printf(&quot;%%x = %x &lt;br&gt;&quot;,$num1); // Hexadecimal 
	number (lowercase)<br>printf(&quot;%%X = %X &lt;br&gt;&quot;,$num1); // Hexadecimal number 
	(uppercase)<br>printf(&quot;%%+d = %+d &lt;br&gt;&quot;,$num1); // Sign specifier (positive)<br>
	printf(&quot;%%+d = %+d &lt;br&gt;&quot;,$num2); // Sign specifier (negative)<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_printf4">Run example &raquo;</a>
</div>
<br>
...
<div class="example_code notranslate">
	...
	&lt;?php<br>$str1 = &quot;Hello&quot;;<br>$str2 = &quot;Hello world!&quot;;<br><br>vprintf(&quot;[%s]&lt;br&gt;&quot;,array($str1));<br>
	vprintf(&quot;[%8s]&lt;br&gt;&quot;,array($str1));<br>vprintf(&quot;[%-8s]&lt;br&gt;&quot;,array($str1));<br>
	vprintf(&quot;[%08s]&lt;br&gt;&quot;,array($str1)); <br>vprintf(&quot;[%'*8s]&lt;br&gt;&quot;,array($str1));<br>
	vprintf(&quot;[%8.8s]&lt;br&gt;&quot;,array($str2)); <br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_vprintf4">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_vprintf.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_vprintf.asp#top" target="_top">TOP</a> |
		<a href="func_string_vprintf.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
