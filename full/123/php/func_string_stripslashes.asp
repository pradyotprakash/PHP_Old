...
<title>PHP stripslashes() Function</title>
<style>a.menu_func_string_stripslashes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">stripslashes()</span> Function</h1>
...
<p>Remove the backslash:</p>
<div class="example_code notranslate">

&lt;?php<br>
echo stripslashes(&quot;Who\'s Peter Griffin?&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_stripslashes">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The stripslashes() function removes backslashes added by the 
<a href="func_string_addslashes.asp">addslashes()</a> 
function.</p>
<p><b>Tip:</b> This function can be used to clean up data retrieved from a 
database or from an HTML form.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

stripslashes(<em>string</em>)
...
<tr>
	...
	<td style="width:80%">Returns a string with backslashes stripped off</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_stripslashes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_stripslashes.asp#top" target="_top">TOP</a> |
		<a href="func_string_stripslashes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
