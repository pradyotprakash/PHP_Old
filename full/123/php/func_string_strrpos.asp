...
<title>PHP strrpos() Function</title>
<style>a.menu_func_string_strrpos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strrpos()</span> Function</h1>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strrpos">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strrpos() function finds the position of the last occurrence of a string inside 
another string.</p>
<p><b>Note:</b> The strrpos() function is case-sensitive.</p>
...
<ul>
	...
	<li><a href="func_string_strripos.asp">strripos()</a> - Finds the position 
	of the last occurrence of a string inside another string (case-insensitive)</li>
</ul>
<hr>
<h2>Syntax</h2>
...
strrpos(<em>string,find,start</em>)
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strrpos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strrpos.asp#top" target="_top">TOP</a> |
		<a href="func_string_strrpos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
