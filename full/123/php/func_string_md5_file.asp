...
<title>PHP md5_file() Function</title>
<style>a.menu_func_string_md5_file{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">md5_file()</span> Function</h1>
...
<p>Calculate the MD5 hash of the text file &quot;test.txt&quot;:</p>
<div class="example_code notranslate">

&lt;?php<br>
$filename = &quot;test.txt&quot;;<br>
$md5file = md5_file($filename);<br>
echo $md5file;<br>
?&gt;</div>
...
<p>The md5_file() function calculates the MD5 hash of a file.</p>
<p>The md5_file() function uses the RSA Data Security, Inc. MD5 Message-Digest 
Algorithm.</p>
<p>From RFC 1321 - 
...
<p>To calculate the MD5 hash of a string, use the <a href="func_string_md5.asp">
md5()</a> function.</p>
<hr>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>raw</em> parameter was added in PHP 5.0<br><br>As of PHP 5.1, it is 
	possible to use md5_file() with wrappers, e.g. <strong>
	md5_file(&quot;http://w3schools.com/..&quot;)</strong></td>
</tr>
</table>
...
<p>Store the MD5 hash of &quot;test.txt&quot; in a file:</p>
<div class="example_code notranslate">

&lt;?php<br>
$md5file = md5_file(&quot;test.txt&quot;);<br>
file_put_contents(&quot;md5file.txt&quot;,$md5file);<br>
?&gt;</div>
<p>Test if &quot;test.txt&quot; has been changed (that is if the 
MD5 hash has been changed):</p>
<div class="example_code notranslate">

&lt;?php<br>
$md5file = file_get_contents(&quot;md5file.txt&quot;);<br>
if (md5_file(&quot;test.txt&quot;) == $md5file)<br>
&nbsp;&nbsp;{<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_md5_file.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_md5_file.asp#top" target="_top">TOP</a> |
		<a href="func_string_md5_file.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
