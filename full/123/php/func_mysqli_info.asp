...
<title>PHP mysqli_info() Function</title>
<style>a.menu_func_mysqli_info{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_info()</span> Function</h1>
...
<p>Return information about the most recently executed query:</p>
...
&nbsp;&nbsp;}<br><br>// Perform queries<br>$sql1=&quot;CREATE TABLE testPersons LIKE 
	Persons&quot;<br>mysqli_query($con,$sql1);<br>$sql2=&quot;INSERT INTO testPersons 
	SELECT * FROM Persons ORDER BY LastName LIMIT 10&quot;<br>
mysqli_query($con,$sql2);<br><br>// Print info about most recently executed 
	query<br>echo mysqli_info($con); <br>
...
<p>The mysqli_info() function returns information about the most recently executed query.</p>
<p>This function works with the following query types:</p>
<ul>
...
mysqli_info(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns a string that contains additional info about the 
	most recently executed query</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_info.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_info.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_info.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
