...
<title>PHP readdir() Function</title>
<style>a.menu_func_directory_readdir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">readdir()</span> Function</h1>
...
<p>The readdir() function returns the name of the next entry in a directory.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	readdir(<em>dir_handle</em>);</div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns the entry name (filename) on success. FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_directory_readdir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_directory_readdir.asp#top" target="_top">TOP</a> |
		<a href="func_directory_readdir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
