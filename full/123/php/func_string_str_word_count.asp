...
<style>a.menu_func_string_str_word_count{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">str_word_count()</span> Function</h1>
...
<p>Count the number of words found in the string &quot;Hello World!&quot;:</p>
<div class="example_code notranslate">

&lt;?php<br>
echo str_word_count(&quot;Hello world!&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_word_count">Run example &raquo;</a>
</div>
<hr>
...
str_word_count(<em>string,return,char</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>return</em></td>
    <td>Optional. Specifies the return value of the 
	str_word_count() function.<p>Possible values:</p>
	<ul>
		<li>0 - Default. Returns the number of words found</li>
		<li>1 - Returns an array with the words from the string</li>
		<li>2 - Returns an array where the key is the position of the word in 
		the string, and value is the actual word</li>
	</ul>
	</td>
  </tr>
  <tr>
    <td><em>char</em></td>
    <td>Optional. Specifies special characters to be considered as 
	words.</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a number or an array, depending on the chosen <em>
	return</em> parameter</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.3.0+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>char</em> parameter was added in PHP 5.1</td>
</tr>
</table>
<br>
...
<p>Return an array with the words from the string:</p>
<div class="example_code notranslate">

&lt;?php<br>
print_r(str_word_count(&quot;Hello world!&quot;,1));<br>
?&gt;

</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_word_count2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Return an array where the key is the position of the word in the string, and 
value is the actual word:</p>
<div class="example_code notranslate">

&lt;?php<br>
print_r(str_word_count(&quot;Hello world!&quot;,2));<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_word_count3">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 3</h2>
<p>Without and with the char parameter:</p>
<div class="example_code notranslate">

&lt;?php<br>
print_r(str_word_count(&quot;Hello world &amp; good morning!&quot;,1));<br>
print_r(str_word_count(&quot;Hello world &amp; good morning!&quot;,1,&quot;&amp;&quot;));<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_word_count4">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_str_word_count.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_str_word_count.asp#top" target="_top">TOP</a> |
		<a href="func_string_str_word_count.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
