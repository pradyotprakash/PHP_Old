...
<title>PHP array_column() Function</title>
<style>a.menu_func_array_column{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_column()</span> Function</h1>
...
<p>Get column of last names from a recordset:</p>
<div class="example_code notranslate">
	&lt;?php<br>// An array that represents a possible record set returned from a 
	database<br>$a = array(<br>&nbsp; array(<br>&nbsp;&nbsp;&nbsp; 'id' =&gt; 5698,<br>&nbsp;&nbsp;&nbsp; 
	'first_name' =&gt; 'Peter',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Griffin',<br>&nbsp; 
	),<br>&nbsp; array(<br>&nbsp;&nbsp;&nbsp; 'id' =&gt; 4767,<br>&nbsp;&nbsp;&nbsp; 
	'first_name' =&gt; 'Ben',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Smith',<br>&nbsp; 
	)<br>&nbsp; array(<br>&nbsp;&nbsp;&nbsp; 'id' =&gt; 3809,<br>&nbsp;&nbsp;&nbsp; 
	'first_name' =&gt; 'Joe',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Doe',<br>&nbsp; 
	)<br>);<br><br>$last_names = 
	array_column($a, 'last_name');<br>print_r($last_names);<br>?&gt;
</div>
<p>Output:</p>
<div class="example_code notranslate">Array<br>(<br>&nbsp; [0] =&gt; Griffin<br>&nbsp; 
	[1] =&gt; Smith<br>&nbsp; [2] =&gt; Doe<br>)</div>
<br>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The array_column() function returns the values from a single column in the input array.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
array_column(<em>array</em>,<em>column_key</em>,<em>index_key</em>);
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>array</td>
    <td>Required. Specifies the multi-dimensional array (record-set) to use</td>
  </tr>
  <tr>
    <td>column_key</td>
    <td>Required. An integer key or a string key name of the column of values to 
	return. This parameter can also be NULL to return complete arrays (useful 
	together with index_key to re-index the array)</td>
  </tr>
  <tr>
    <td>index_key</td>
    <td>Optional. The column to use as the index/keys for the returned array</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an array of values that represents a single 
	column from the input array </td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.5+</td>
...
<h2>More Examples</h2>
<div class="example">
<h2 class="example">EExample 1</h2>
<p>Get column of last names from a recordset, indexed by the &quot;id&quot; column:</p>
<div class="example_code notranslate">
	&lt;?php<br>// An array that represents a possible record set returned from a 
	database<br>$a = array(<br>&nbsp; array(<br>&nbsp;&nbsp;&nbsp; 'id' =&gt; 5698,<br>&nbsp;&nbsp;&nbsp; 
	'first_name' =&gt; 'Peter',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Griffin',<br>&nbsp; 
	...
	'first_name' =&gt; 'Joe',<br>&nbsp;&nbsp;&nbsp; 'last_name' =&gt; 'Doe',<br>&nbsp; 
	)<br>);<br><br>$last_names = array_column($a, 'last_name', 'id');<br>print_r($last_names);<br>
	?&gt; </div>
<p>Output:</p>
<div class="example_code notranslate">Array<br>(<br>&nbsp; [5698] =&gt; Griffin<br>&nbsp; 
	[4767] =&gt; Smith<br>&nbsp; [3809] =&gt; Doe<br>)</div>
<br>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_column.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_column.asp#top" target="_top">TOP</a> |
		<a href="func_array_column.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
