...
<title>PHP cal_to_jd() Function</title>
<style>a.menu_func_cal_cal_to_jd{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">cal_to_jd()</span> Function</h1>
...
<p>Convert 20th of June, 2007 (Gregorian calendar) to Julian Day Count:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$d=cal_to_jd(CAL_GREGORIAN,6,20,2007);<br>echo $d;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_cal_to_jd">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cal_to_jd() function converts a date in a specified calendar to Julian Day Count.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
cal_to_jd(<em>calendar,month,day,year);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the calendar to convert from. Must be one of the 
	following values:
	<ul>
		<li>CAL_GREGORIAN</li>
		<li>CAL_JULIAN</li>
  ...
  <tr>
    <td><em>month</em></td>
    <td>Required. Specifies the month as a number</td>
  </tr>
  <tr>
    <td><em>day</em></td>
    <td>Required. Specifies the day as a number</td>
  </tr>
  <tr>
    <td><em>year</em></td>
    <td>Required. Specifies the year as a number</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_cal_to_jd.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_cal_to_jd.asp#top" target="_top">TOP</a> |
		<a href="func_cal_cal_to_jd.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
