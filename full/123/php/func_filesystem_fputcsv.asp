...
<title>PHP fputcsv() Function</title>
<style>a.menu_func_filesystem_fputcsv{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fputcsv()</span> Function</h1>
<hr>
...
<p>The fputcsv() function formats a line as CSV and writes it to an open 
file.</p>
<p>This function returns the length of the written string, or FALSE on failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the open file to write to</td>
  </tr>
  <tr>
    <td>fields </td>
    <td>Required. Specifies which array to get the data from</td>
  </tr>
	<tr>
    <td>separator</td>
...
<p><b>Tip:</b> Also see the fgetcsv() function.</p>
...
$list = array<br>
(<br>
&quot;Peter,Griffin,Oslo,Norway&quot;,<br>
&quot;Glenn,Quagmire,Oslo,Norway&quot;,<br>
);<br>
<br>
$file = fopen(&quot;contacts.csv&quot;,&quot;w&quot;);<br>
<br>
foreach ($list as $line)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;fputcsv($file,explode(',',$line));<br>
&nbsp;&nbsp;}<br>
<br>
fclose($file);
?&gt;
...
<p>The CSV file will look like this after the code above has been executed:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fputcsv.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fputcsv.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fputcsv.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
