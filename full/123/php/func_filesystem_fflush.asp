...
<title>PHP fflush() Function</title>
<style>a.menu_func_filesystem_fflush{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fflush()</span> Function</h1>
<hr>
...
<p>The fflush() function writes all buffered output to an open file.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the open file stream to check</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fflush.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fflush.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fflush.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
