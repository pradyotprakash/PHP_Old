...
<html lang="en-US">
<head>
<title>PHP 5 Introduction</title>
<style>a.menu_php_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_install.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">PHP scripts are executed on the server.</p>
<hr>
...
<li>PHP costs nothing, it is free to download and use</li> 
</ul>
...
<td>PHP is simple for beginners<b>.<br><br>
</b>PHP also offers many advanced features for professional programmers.</td>
</tr></table>
<br>
<hr>
...
<ul>
	...
	<li>PHP can create, open, read, write, and close files on the server</li>
	...
	<li>PHP can restrict users to access some pages on your website</li>
...
<ul>
  ...
  <li>PHP is free. Download it from the official PHP resource: <a target="_blank" href="http://www.php.net/">
  www.php.net</a></li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_intro.asp#top" target="_top">TOP</a> |
		<a href="php_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
