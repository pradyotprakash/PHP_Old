...
<title>PHP array_diff_key() Function</title>
<style>a.menu_func_array_diff_key{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_diff_key()</span> Function</h1>
...
<p>Compare the <strong>keys</strong> of two arrays, and return the differences:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;);<br>$a2=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;c&quot;=&gt;&quot;blue&quot;,&quot;d&quot;=&gt;&quot;pink&quot;);<br>
	<br>$result=array_diff_key($a1,$a2);<br>print_r($result);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff_key">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_diff_key() function compares <strong>the keys</strong> 
...
array_diff_key(<em>array1,array2,array3...</em>);</div></div>
<br>
...
<p>Compare the<strong> keys </strong>of two indexed arrays, and return the 
differences:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;red&quot;,&quot;green&quot;,&quot;blue&quot;,&quot;yellow&quot;);<br>$a2=array(&quot;red&quot;,&quot;green&quot;,&quot;blue&quot;);<br><br>
	$result=array_diff_key($a1,$a2);<br>print_r($result);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff_key2">Run example &raquo;</a>
</div>

<br>
<div class="example">
<h2 class="example">Example 2</h2>
<p>Compare the<strong> keys </strong>of three arrays, and return the 
differences:</p>
<div class="example_code notranslate">
&lt;?php<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff_key3">Run example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_diff_key.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_diff_key.asp#top" target="_top">TOP</a> |
		<a href="func_array_diff_key.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
