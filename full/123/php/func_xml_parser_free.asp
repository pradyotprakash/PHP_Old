...
<title>PHP xml_parser_free() Function</title>
<style>a.menu_func_xml_parser_free{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_parser_free()</span> Function</h1>
<hr>
...
<p>The xml_parser_free() function frees an an XML parser.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>parser</td>
    <td>Required. Specifies XML parser to free</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_parser_free.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_parser_free.asp#top" target="_top">TOP</a> |
		<a href="func_xml_parser_free.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
