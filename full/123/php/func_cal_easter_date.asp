...
<title>PHP easter_date() Function</title>
<style>a.menu_func_cal_easter_date{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">easter_date()</span> Function</h1>
...
<p>Print the easter date for different years:</p>
<div class="example_code notranslate">
&lt;?php<br>
	echo easter_date() . &quot;&lt;br /&gt;&quot;;<br>echo date(&quot;M-d-Y&quot;,easter_date()) . &quot;&lt;br 
	/&gt;&quot;;<br>echo date(&quot;M-d-Y&quot;,easter_date(1975)) . &quot;&lt;br /&gt;&quot;;<br>echo 
	date(&quot;M-d-Y&quot;,easter_date(1998)) . &quot;&lt;br /&gt;&quot;;<br>echo 
	date(&quot;M-d-Y&quot;,easter_date(2007));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_easter_date">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The easter_date() function returns the Unix timestamp for midnight on Easter of a given year.</p>
<p><strong>Tip:</strong> The date of Easter Day is defined as the Sunday after the first full moon which
falls on or after the Spring Equinox (21st March).</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
easter_date(<em>year);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>year</em></td>
    <td>Optional. Specifies a year between 1970 and 2037. Default is the current year, local time</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the easter date as a unix timestamp</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>In PHP 4.3 the <em>year</em> parameter became optional</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_easter_date.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_easter_date.asp#top" target="_top">TOP</a> |
		<a href="func_cal_easter_date.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
