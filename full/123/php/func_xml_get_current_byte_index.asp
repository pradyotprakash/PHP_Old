...
<title>PHP xml_get_current_byte_index() Function</title>
<style>a.menu_func_xml_get_current_byte_index{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_get_current_byte_index()</span> Function</h1>
<hr>
...
<p>The xml_get_current_byte_index() function gets the byte index for 
an XML parser.</p>
<p>This function returns the current byte index on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_get_current_byte_index.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_get_current_byte_index.asp#top" target="_top">TOP</a> |
		<a href="func_xml_get_current_byte_index.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
