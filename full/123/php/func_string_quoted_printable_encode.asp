...
<title>PHP quoted_printable_encode() Function</title>
<style>a.menu_func_string_quoted_printable_encode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">quoted_printable_encode()</span> Function</h1>
<hr>
...
<p>The quoted_printable_encode() function converts an 8-bit string to a 
quoted-printable string.</p>
...
quoted_printable_encode(<em>string</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the 8-bit string to be converted</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_quoted_printable_encode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_quoted_printable_encode.asp#top" target="_top">TOP</a> |
		<a href="func_string_quoted_printable_encode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
