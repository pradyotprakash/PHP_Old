...
<title>PHP gettimeofday() Function</title>
<style>a.menu_func_date_gettimeofday{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">gettimeofday()</span> Function</h1>
...
&lt;?php<br>
	// Print the array from gettimeofday()<br>print_r(gettimeofday());<br><br>// 
	Print the float from gettimeofday()<br>echo gettimeofday(true);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_gettimeofday">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The gettimeofday() function returns the current time.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	gettimeofday(<em>return_float);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>return_float</em></td>
    <td>Optional. When set to TRUE, a float instead of an array is returned. Default is 
	FALSE</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an associative array by default, with the following 
	array keys:<br>
<ul>
	<li>[sec] - seconds since the Unix Epoch</li>
	<li>[usec] - microseconds</li>
	<li>[minuteswest] - minutes west of Greenwich </li>
	<li>[dsttime] - type of dst correction </li>
</ul>
	If the <em>return_float</em> parameter is set to true, a float is returned
	</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>Changelog:</th>
	<td>PHP 5.1.0: The <em>return_float</em> parameter was added</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_gettimeofday.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_gettimeofday.asp#top" target="_top">TOP</a> |
		<a href="func_date_gettimeofday.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
