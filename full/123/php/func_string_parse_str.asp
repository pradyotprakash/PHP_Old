...
<title>PHP parse_str() Function</title>
<style>a.menu_func_string_parse_str{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">parse_str()</span> Function</h1>
...
<p>Parse a query string into variables:</p>
<div class="example_code notranslate">

&lt;?php<br>
parse_str(&quot;name=Peter&amp;age=43&quot;);<br>
echo $name.&quot;&lt;br&gt;&quot;;<br>
	echo $age;<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_parse_str">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The parse_str() function parses a query string into variables.</p>

<b>Note:</b> If the array parameter is not set, variables set by this function will overwrite existing 
	variables of the same name.<p><b>Note:</b> The magic_quotes_gpc setting in the php.ini file affects the output of this 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to parse</td>
  </tr>
  <tr>
    <td><em>array</em></td>
    <td>Optional. Specifies the name of an array to store the variables. 
	This parameter indicates that the variables will be stored in an array.</td>
  </tr>
</table>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>array</em> parameter was added in PHP 
	4.0.3</td>
</tr>
</table>
<br>
...
<p>Store the variables in an array: </p>
<div class="example_code notranslate">

&lt;?php<br>
parse_str(&quot;name=Peter&amp;age=43&quot;,$myArray);<br>
print_r($myArray);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_parse_str2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_parse_str.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_parse_str.asp#top" target="_top">TOP</a> |
		<a href="func_string_parse_str.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
