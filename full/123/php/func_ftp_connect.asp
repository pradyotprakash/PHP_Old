...
<title>PHP ftp_connect() Function</title>
<style>a.menu_func_ftp_connect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_connect()</span> Function</h1>
...
<p>Connect, login, and close an FTP connection:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	something...<br><br>// close connection<br>ftp_close($ftp_conn); <br>?&gt;
</div>
</div>
<hr>
...
<p>The ftp_connect() function opens an FTP connection to the specified host.</p>
<p>When the connection is open, you can run FTP functions against the server. </p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_connect(<em>host,port,timeout</em>);
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>host</em></td>
    <td>Required. Specifies the FTP server to connect to. Can be a 
	domain address or an IP address. This parameter should not be prefixed with &quot;ftp://&quot; or 
	have any trailing slashes</td>
  </tr>
	<tr>
    <td><em>port</em></td>
    <td>Optional. Specifies the port of the FTP server. Default is 
	port 21</td>
  </tr>
  <tr>
    <td><em>timeout</em></td>
    <td>Optional. Specifies the timeout for all subsequent network operations. 
...
<tr>
	...
	<td style="width:80%">Returns an FTP stream on success or FALSE on error</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>The <em>timeout</em> parameter was added in PHP 4.2.0</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_connect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_connect.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_connect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
