...
<title>PHP mysqli_fetch_all() Function</title>
<style>a.menu_func_mysqli_fetch_all{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_fetch_all()</span> Function</h1>
...
<p>Fetch all rows and return the result-set as an associative array:</p>
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	$result=mysqli_query($con,$sql);<br><br>// Fetch all<br>mysqli_fetch_all($result,MYSQLI_ASSOC);<br>
	<br>// Free result 
...
<p>The mysqli_fetch_all() function fetches all result rows and returns the 
result-set as an associative array, a numeric array, or both.</p>
<p><strong>Note:</strong> This function is available only with MySQL Native Driver.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_fetch_all(<em>result,resulttype</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an array of associative or numeric arrays holding 
	the result rows</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_fetch_all.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_fetch_all.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_fetch_all.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
