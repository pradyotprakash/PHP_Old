...
<style>a.menu_php_ref_zip{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Zip File</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_xml.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_timezones.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP Zip File Introduction</h2>
<p>The Zip files functions allows you to read ZIP files.</p>
<hr>

<h2>Installation</h2>
<p>For the Zip file functions to work on your server, these libraries must be 
installed:</p>
<ul>
	<li>The ZZIPlib library by Guido Draheim:
	<a target="_blank" href="http://zziplib.sourceforge.net/download.html">Download the ZZIPlib 
	library</a></li>
	<li>The Zip PELC extension: <a target="_blank" href="http://snaps.php.net/">Download the Zip 
	PELC extension</a></li>
</ul>
<p><b>Installation on Linux Systems</b></p>
<p><b>PHP 5+:</b> Zip functions and the Zip library is not enabled by default 
and must be downloaded from the links above. Use the
<i>--with-zip=DIR</i> configure option to include Zip support.</p>
<p><b>Installation on Windows Systems</b></p>
<p><b>PHP 5+:</b> Zip functions is not enabled by default, so the php_zip.dll 
and the ZZIPlib library must be downloaded from the link above. php_zip.dll must 
be enabled inside of php.ini. </p>
<p>To enable any PHP extension, the PHP extension_dir setting (in the php.ini 
file) should be set to the directory where the PHP extensions are 
located. An example extension_dir value is c:\php\ext.</p>
<hr>

<h2>PHP Zip File Functions</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="func_zip_close.asp">zip_close()</a></td>
    <td>Closes a ZIP file</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_zip_entry_close.asp">zip_entry_close()</a></td>
    <td>Closes an entry in the ZIP file</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_zip_entry_compressedsize.asp">zip_entry_compressedsize()</a></td>
    <td>Returns the compressed size of an entry in the ZIP file</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_zip_entry_compressionmethod.asp">zip_entry_compressionmethod()</a></td>
    <td>Returns the compression method of an entry in the ZIP file</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_zip_entry_filesize.asp">zip_entry_filesize()</a></td>
    <td>Returns the actual file size of an entry in the ZIP file</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_zip_entry_name.asp">zip_entry_name()</a></td>
    <td>Returns the name of an entry in the ZIP file</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_zip_entry_open.asp">zip_entry_open()</a></td>
    <td>Opens an entry in the ZIP file for reading</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_zip_entry_read.asp">zip_entry_read()</a></td>
    <td>Reads from an open entry in the ZIP file</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_zip_open.asp">zip_open()</a></td>
    <td>Opens a ZIP file</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_zip_read.asp">zip_read()</a></td>
    <td>Reads the next entry in a ZIP file</td>
    <td>4</td>
  </tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_zip.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_zip.asp#top" target="_top">TOP</a> |
		<a href="php_ref_zip.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
