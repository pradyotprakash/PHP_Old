...
<title>PHP mysqli_connect_error() Function</title>
<style>a.menu_func_mysqli_connect_error{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_connect_error()</span> Function</h1>
...
<p>Return an error description from the last connection error, if any:</p>
...
<p>The mysqli_connect_error() function returns the error description from the last connection error, if any.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_connect_error()<em>;</em></div></div>

<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td style="width:80%">Returns a string that describes the error. NULL if no error 
	occurred</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_connect_error.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_connect_error.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_connect_error.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
