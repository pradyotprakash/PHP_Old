...
<title>PHP header() Function</title>
<style>a.menu_func_http_header{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">header()</span> Function</h1>
<hr>
...
<p>The header() function sends a raw HTTP header to a client.</p>
<p>It is important to notice that header() must be called before any actual 
...
// The output above is before the header() call<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>string</td>
    <td>Required. Specifies the header string to send</td>
  </tr>
	<tr>
    <td>replace</td>
    <td>Optional. Indicates whether the header should replace 
	previous or add a second header. Default is TRUE (will replace). FALSE 
	(allows multiple headers of the same type)</td>
  </tr>
  <tr>
    <td>http_response_code</td>
    <td>Optional. Forces the HTTP response code to the specified 
	value (available in PHP 4.3 and higher)</td>
  </tr>
  </table>
<br>
...
<p><b>Note:</b> Since PHP 4.4 this function prevents more than one header to be 
sent at once. This is a protection against header injection attacks.</p>
<hr>
<h2>Example 1</h2>
<p>Prevent page caching:</p>
...
<p><b>Note:</b> There are options that users may set to change the browser's 
default caching settings. By sending the headers above, you should override any 
of those settings and force the browser to not cache!</p>

<hr>
<h2>Example 2</h2>
<p>Let the user be prompted to save a generated PDF file (Content-Disposition 
header is used to supply a recommended filename and force the browser to display 
the save dialog box): </p>
...
<br>
// It will be called downloaded.pdf<br>
header(&quot;Content-Disposition:attachment;filename='downloaded.pdf'&quot;);<br>
<br>
// The PDF source is in original.pdf<br>
...
<p><b>Note:</b> There is a bug in Microsoft IE 5.5 that prevents this from 
working. The bug can be resolved by upgrading to Service Pack 2 or later.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_http_header.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_http_header.asp#top" target="_top">TOP</a> |
		<a href="func_http_header.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
