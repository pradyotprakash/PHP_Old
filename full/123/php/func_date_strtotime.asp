...
<style>a.menu_func_date_strtotime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strtotime()</span> Function</h1>
...
<p>Parse English textual datetimes into Unix timestamps:</p>
<div class="example_code notranslate">
&lt;?php<br>
echo(strtotime(&quot;now&quot;) . &quot;&lt;br&gt;&quot;);<br>
echo(strtotime(&quot;3 October 2005&quot;) . &quot;&lt;br&gt;&quot;);<br>
echo(strtotime(&quot;+5 hours&quot;) . &quot;&lt;br&gt;&quot;);<br>
echo(strtotime(&quot;+1 week&quot;) . &quot;&lt;br&gt;&quot;);<br>
echo(strtotime(&quot;+1 week 3 days 7 hours 5 seconds&quot;) . &quot;&lt;br&gt;&quot;);<br>
echo(strtotime(&quot;next Monday&quot;) . &quot;&lt;br&gt;&quot;);<br>
echo(strtotime(&quot;last Sunday&quot;));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_strtotime">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The strtotime() function parses an English textual datetime into a 
Unix timestamp (the number of seconds since January 1 1970 00:00:00 GMT).</p>
<p><b>Note:</b> If the year is specified in a two-digit format,  values between 0-69 are mapped to 2000-2069
and values between 70-100 are mapped to 1970-2000.</p>
<p><strong>Note:</strong> Be aware of dates in the m/d/y or d-m-y formats; if 
...
date_create_from_format() when possible.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>time</em></td>
    <td>Required. Specifies a date/time string</td>
  </tr>
  <tr>
    <td><em>now</em></td>
    <td>Optional. Specifies the timestamp used as a base for the calculation of 
	relative dates</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a timestamp on success. FALSE 
	on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>Changelog:</th>
	<td>PHP 5.3.0: Now relative time formats such as this week, previous week, 
	last week, and next week interprets a week period of Monday through Sunday, 
	rather then a 7-day period relative to the current date/time<br>PHP 5.3.0: 
	Now 24:00 is a valid format<br>PHP 5.2.7: In earlier versions, if requesting 
	a given occurrence of a given weekday in a month where that weekday was the 
	first day of the month it would incorrectly add one week to the returned 
	timestamp. This has been corrected now<br>PHP 5.1.0: Returns FALSE on 
	failure (earlier versions returns -1), and issues E_STRICT and E_NOTICE time 
	zone errors<br>PHP 5.0.2: Now correctly computes &quot;now&quot; and other relative 
	times from current time, not from today's midnight <br>PHP 5.0.0: Allows 
	microseconds (but they are ignored)</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_strtotime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_strtotime.asp#top" target="_top">TOP</a> |
		<a href="func_date_strtotime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
