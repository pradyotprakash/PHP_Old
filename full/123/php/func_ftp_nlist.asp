...
<title>PHP ftp_nlist() Function</title>
<style>a.menu_func_ftp_nlist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_nlist()</span> Function</h1>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// get file list 
	of current directory<br>$file_list = ftp_nlist($ftp_con, &quot;.&quot;);<br>var_dump($file_list);<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_nlist() function returns a list of files in the specified directory on the FTP server.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_nlist(<em>ftp_connection,dir</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>dir</em></td>
    <td>Required. Specifies the directory to be listed. Use &quot;.&quot; to get the 
...
<tr>
	...
	<td style="width:80%">Returns an array of file names on success or FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_nlist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_nlist.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_nlist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
