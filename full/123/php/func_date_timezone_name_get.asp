...
<title>PHP timezone_name_get() Function</title>
<style>a.menu_func_date_timezone_name_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">timezone_name_get()</span> Function</h1>
...
<p>Return the name of the timezone:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$tz=timezone_open(&quot;Europe/Paris&quot;);<br>
	echo timezone_name_get($tz);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_timezone_name_get">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The timezone_name_get() returns the name of the timezone.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
timezone_name_get<em>(object);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>object</em></td>
    <td>Required. Specifies a DateTimeZone object</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a timezone name from the
	<a href="php_ref_timezones.asp">list of timezones</a></td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.2+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_timezone_name_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_timezone_name_get.asp#top" target="_top">TOP</a> |
		<a href="func_date_timezone_name_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
