...
<title>PHP is_nan() Function</title>
<style>a.menu_func_math_is_nan{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">is_nan()</span> Function</h1>
...
<p>Check whether a value is 'not-a-number':</p>
<div class="example_code notranslate">
&lt;?php<br>
	echo is_nan(200) . &quot;&lt;br&gt;&quot;;<br>echo is_nan(acos(1.01));<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_is_nan">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The is_nan() function checks whether a value is 'not a number'.</p>
<p>This function returns true (1) if the specified value is 'not a number', otherwise it returns false/nothing.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	is_nan(<em>value</em>);</div></div>
<br>
...
<tr>
	...
	<td style="width:80%">TRUE if <em>value</em> is 'not a number', FALSE otherwise</td>
</tr>
	<tr>
	<th>Return Type:</th>
	<td>Boolean</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_is_nan.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_is_nan.asp#top" target="_top">TOP</a> |
		<a href="func_math_is_nan.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
