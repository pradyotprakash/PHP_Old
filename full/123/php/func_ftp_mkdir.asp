...
<style>a.menu_func_ftp_mkdir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_mkdir()</span> Function</h1>
...
<p>Create a new directory on the FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$dir = &quot;images&quot;;<br>
	<br>// try to create directory $dir<br>if (ftp_mkdir($ftp_conn, $dir))<br>&nbsp; 
	{<br>&nbsp; echo &quot;Successfully created $dir&quot;;<br>&nbsp; }<br>else<br>&nbsp; 
	{<br>&nbsp; echo &quot;Error while creating $dir&quot;;<br>&nbsp; }<br>
...
<p>The ftp_mkdir() function creates a new directory on the FTP server.</p>
<h2>Syntax</h2>

<div class="code notranslate"><div>
ftp_mkdir(<em>ftp_connection,dir</em>);
</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td><em>dir</em></td>
    <td>Required. Specifies the name of the directory to create</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns the name of the new directory on success, or FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_mkdir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_mkdir.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_mkdir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
