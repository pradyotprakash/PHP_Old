...
<style>a.menu_func_string_strpos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strpos()</span> Function</h1>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strpos">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strpos() function finds the position of the first occurrence of a 
string inside another string.</p>
<p><b>Note:</b> The strpos() function is case-sensitive.</p>
...
strpos(<em>string,find,start</em>)
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strpos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strpos.asp#top" target="_top">TOP</a> |
		<a href="func_string_strpos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
