...
<div class="next"><a class="chapter" href="php_intro.asp">Next Chapter &raquo;</a></div>
</div>
<br>

<div class="tutintro">
<img src="http://www.w3schools.com/images/w3php.gif" alt="PHP" width="100" height="132">
<p>PHP is a server scripting language, and is a powerful tool for making dynamic and interactive Web pages 
quickly.</p>
<p>PHP is a widely-used, free, and efficient alternative to competitors such as Microsoft's ASP.</p>
</div>

<hr><h2>Easy Learning with &quot;Show PHP&quot;</h2>
...
<br><a target="_blank" href="showphp.asp?filename=demo_intro" class="showbtn">Run example &raquo;</a>
</div>
<p><b>Click on the &quot;Run example&quot; button to see how it works.</b></p>
<br>

<hr><h2>PHP 5 References</h2>
<p>At W3Schools you will find complete references of all PHP functions:</p>
<ul>
	<li><a href="php_ref_array.asp">Array functions</a></li>
	<li><a href="php_ref_calendar.asp">Calendar functions</a></li>
	<li><a href="php_ref_date.asp">Date functions</a></li>
	<li><a href="php_ref_directory.asp">Directory functions</a></li>
	<li><a href="php_ref_error.asp">Error functions</a></li>
	<li><a href="php_ref_filesystem.asp">Filesystem functions</a></li>
	<li><a href="php_ref_filter.asp">Filter functions</a></li>
	<li><a href="php_ref_ftp.asp">FTP functions</a></li>
	<li><a href="php_ref_http.asp">HTTP functions</a></li>
	<li><a href="php_ref_libxml.asp">LibXML functions</a></li>
	<li><a href="php_ref_mail.asp">Mail functions</a></li>
	<li><a href="php_ref_math.asp">Math functions</a></li>
	<li><a href="php_ref_misc.asp">Misc functions</a></li>
	<li><a href="php_ref_mysqli.asp">MySQLi functions</a></li>	
	<li><a href="php_ref_simplexml.asp">SimpleXML functions</a></li>
	<li><a href="php_ref_string.asp">String functions</a></li>
	<li><a href="php_ref_xml.asp">XML Parser functions</a></li>
	<li><a href="php_ref_zip.asp">Zip functions</a></li>
</ul>
