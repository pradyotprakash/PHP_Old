...
<style>a.menu_php_mysql_insert{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP MySQL <span class="color_h1">Insert Into</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_mysql_create.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_mysql_select.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>The first form doesn't specify the column names where the data will be 
inserted, only their values:</p>
<div class="code notranslate"><div>
INSERT INTO table_name<i><br>
</i>VALUES (value1, value2, value3,...)
</div></div>
...
<p>To learn more about SQL, please visit our <a href="../sql/default.asp">SQL tutorial</a>.</p>
<p>To get PHP to execute the statements above we must use the mysqli_query() function. This function is used to 
send a query or command to a MySQL connection.</p>

<h3>Example</h3>
<p>In the previous chapter we created a table named &quot;Persons&quot;, with 
three columns; &quot;FirstName&quot;, &quot;LastName&quot; and 
&quot;Age&quot;. We will use the same table in this example. The following 
example adds two new records to the &quot;Persons&quot; table:</p>
<div class="code notranslate"><div>
&lt;?php<br>
...
<p>Then, the mysqli_query() function executes the INSERT INTO statement, and a new record will be added to the 
&quot;Persons&quot; table.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_mysql_insert.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_mysql_insert.asp#top" target="_top">TOP</a> |
		<a href="php_mysql_insert.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
