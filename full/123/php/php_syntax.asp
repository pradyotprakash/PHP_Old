...
<style>a.menu_php_syntax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Syntax</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_install.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_variables.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The PHP script is executed on the server, and the plain HTML result is sent back to the browser.</p>
<hr>
...
<div class="example_code notranslate">
	...
	echo &quot;Hello World!&quot;;<br>?&gt;</span><br><br>
    &lt;/body&gt;<br>
    &lt;/html&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_syntax">Run example &raquo;</a>
</div>
<p><strong>Note:</strong> PHP statements are terminated by semicolon (;). The 
closing tag of a block of PHP code also automatically implies a semicolon (so 
you do not have to have a semicolon terminating the last line of a PHP block).</p>
<hr>

<h2>Comments in PHP</h2>
<p>A comment in PHP code is a line that is not read/executed as part of the 
program. Its only purpose is to be read by someone who is editing the code!</p>
<p>Comments are useful for:</p>
<ul>
	<li>To let others understand what you are doing - Comments let other 
	programmers understand what you were doing in each step (if you work in a 
	group)</li>
	<li>To remind yourself what you did - Most programmers have experienced 
	coming back to their own work a year or two later and having to re-figure 
	out what they did. Comments can remind you of what you were thinking when 
	you wrote the code</li>
</ul>
<p>PHP supports three ways of commenting:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;!DOCTYPE html&gt;<br>
...
/*<br>
This is a multiple lines comment block<br>that spans over more than<br>one line<br>
*/<br>
?&gt;</span><br><br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_syntax_comments">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>PHP Case Sensitivity</h2>
<p>In PHP, all user-defined functions, classes, and keywords (e.g. if, else, while, 
echo, etc.) are NOT case-sensitive.</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_syntax_case1">Run example &raquo;</a>
</div>

<p>However; in PHP, all variables are case-sensitive.</p>
...
<div class="example_code notranslate">
	...
	&lt;html&gt;<br>
    &lt;body&gt;<br><br>
    <span class="marked">&lt;?php<br>$color=&quot;red&quot;;<br>
	echo &quot;My car is &quot; . $color . &quot;&lt;br&gt;&quot;;<br>echo &quot;My house is &quot; . $COLOR . 
	&quot;&lt;br&gt;&quot;;<br>echo &quot;My boat is &quot; . $coLOR . &quot;&lt;br&gt;&quot;;<br>?&gt;</span><br><br>
    &lt;/body&gt;<br>
    &lt;/html&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_syntax_case2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_syntax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_syntax.asp#top" target="_top">TOP</a> |
		<a href="php_syntax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
