...
<title>PHP mkdir() Function</title>
<style>a.menu_func_filesystem_mkdir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mkdir()</span> Function</h1>
<hr>
...
<p>The mkdir() function creates a directory.</p>
<p>This function returns TRUE on 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>mode</td>
    <td>Optional. Specifies permissions. By default, the mode is 
	0777 (widest possible access).<p>The mode 
	...
	<tr>
    <td>recursive</td>
    <td>Optional. Specifies if the recursive mode is set (added in 
	PHP 5)</td>
  </tr>
  <tr>
    <td>context</td>
    <td>Optional. Specifies the context of the file handle. Context 
...
<p><b>Note:</b> The mode parameters is ignored on Windows platforms.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_mkdir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_mkdir.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_mkdir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
