...
<title>PHP ezmlm_hash() Function</title>
<style>a.menu_func_mail_ezmlm_hash{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ezmlm_hash()</span> Function</h1>
...
<p>Calculate the hash value for an email address:</p>
<div class="example_code notranslate">
&lt;?php<br>$user = &quot;someone@example.com&quot;;<br>$hash = ezmlm_hash($user);<br><br>
	echo &quot;The hash value for $user is: $hash.&quot;;<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ezmlm_hash() function calculates the hash value needed when keeping EZMLM 
mailing lists in a MySQL database.</p>
<p>This function accepts an email address, for which it calculates an integer 
hash value. This value is compatible with the EZMLM mailing list manager, and 
can then be used with the EZMLM database for user management. </p>

<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
ezmlm_hash(<em>address</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>address</em></td>
    <td>Required. Specifies the email address being hashed</td>
  </tr>
</table>
...
<tr>
	...
	parameter, or FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.2+</td>
...
<a href="php_ref_mail.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Mail Reference" /> PHP Mail Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mail_ezmlm_hash.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mail_ezmlm_hash.asp#top" target="_top">TOP</a> |
		<a href="func_mail_ezmlm_hash.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
