...
<html lang="en-US">
<head>
<title>PHP 5 Installation</title>
<style>a.menu_php_install{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Installation</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_syntax.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>If your server has activated support for PHP you do not 
need to do anything.</p>
<p>Just create some .php files, place them in your web directory, and the server 
will automatically parse them for you.</p>
<p>You do not need to compile anything or install any extra tools.</p>
<p>Because PHP is free, most web hosts 
offer PHP support.</p>
<hr>
...
<td><p><b>Tip:</b> To get PHP up and running immediately for Windows, you can:</p>
<p><a href="http://www.microsoft.com/web/webmatrix/" target="_blank">
Download WebMatrix</a></p>
</td>
</tr></table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_install.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_install.asp#top" target="_top">TOP</a> |
		<a href="php_install.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
