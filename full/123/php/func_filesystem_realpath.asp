...
<title>PHP realpath() Function</title>
<style>a.menu_func_filesystem_realpath{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">realpath()</span> Function</h1>
<hr>
...
<p>The realpath() function returns the absolute pathname.</p>
<p>This function removes all symbolic links (like '/./', '/../' and extra '/') 
and returns the absolute pathname.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_realpath.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_realpath.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_realpath.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
