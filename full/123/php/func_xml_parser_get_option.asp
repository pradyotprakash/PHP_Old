...
<title>PHP xml_parser_get_option() Function</title>
<style>a.menu_func_xml_parser_get_option{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_parser_get_option()</span> Function</h1>
<hr>
...
<p>The xml_parser_get_option() function gets options from an XML parser.</p>
<p>This function returns the options value on success, or FALSE and an error on 
failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td>option</td>
    <td>Required. Specifies option to get. Possible values:<ul>
...
<br>
echo xml_parser_get_option($xmlparser, XML_OPTION_CASE_FOLDING);<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_parser_get_option.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_parser_get_option.asp#top" target="_top">TOP</a> |
		<a href="func_xml_parser_get_option.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
