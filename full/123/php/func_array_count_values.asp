...
<title>PHP array_count_values() Function</title>
<style>a.menu_func_array_count_values{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_count_values()</span> Function</h1>
...
<p>Count all the values of an array:</p>
<div class="example_code notranslate">
&lt;?php<br>
$a=array(&quot;A&quot;,"Cat","Dog","A","Dog");<br>
print_r(array_count_values($a));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_count_values">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The array_count_values() function counts all the values of an array.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>

array_count_values(<em>array</em>)</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>array</em></td>
    <td>Required. Specifying the array to count values of</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an associative array, where the keys are the 
	original array's values, and the values are the number of occurrences</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_count_values.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_count_values.asp#top" target="_top">TOP</a> |
		<a href="func_array_count_values.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
