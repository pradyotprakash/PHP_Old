...
<title>PHP parse_ini_file() Function</title>
<style>a.menu_func_filesystem_parse_ini_file{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">parse_ini_file()</span> Function</h1>
<hr>
...
<p>The parse_ini_file() function parses a configuration (ini) file and returns 
the settings in it in an array.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the ini file to check</td>
  </tr>
  <tr>
    <td>process_sections</td>
    <td>Optional. If set to TRUE, it returns is a 
	multidimensional array with section names and settings included. Default is FALSE</td>
  </tr>
  </table>
<br>
<hr>
...
<p><b>Tip:</b> This function can be used to read in your own application's 
configuration files, and has nothing to do with the php.ini file.</p>
<p><b>Note:</b> The following reserved words must not be used as keys for ini 
files: null, yes, no, true, and false. Furthermore, there are also some reserved 
characters that must not be used in the keys: {}|&amp;~![()&quot;.</p>

<hr>

<h2>Example 1</h2>

<p>Contents of &quot;test.ini&quot;:</p>
...
&lt;?php<br>
print_r(parse_ini_file(&quot;test.ini&quot;));<br>
?&gt;
...
[you] =&gt; Peter<br>
[first] =&gt; http://www.example.com<br>
[second] =&gt; http://www.w3schools.com<br>
)
...
<p>PHP code (with process_sections set to true):</p>

<div class="code notranslate"><div>

&lt;?php<br>
print_r(parse_ini_file(&quot;test.ini&quot;,true));<br>
?&gt; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_parse_ini_file.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_parse_ini_file.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_parse_ini_file.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
