...
<style>a.menu_func_mysqli_ping{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_ping()</span> Function</h1>
...
&nbsp;&nbsp;}<br><br>// Check if server is alive<br>if (mysqli_ping($con))<br>&nbsp; 
	{<br>&nbsp; echo &quot;Connection is ok!&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; 
	echo &quot;Error: &quot;. mysqli_error($con);<br>&nbsp; }<br><br>mysqli_close($con);<br>
?&gt;
</div>
</div>
<hr>
...
<p>The mysqli_ping() function pings a server connection, or tries to reconnect if the connection has gone down.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_ping(<em>connection</em>)<em>;</em></div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_ping.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_ping.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_ping.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
