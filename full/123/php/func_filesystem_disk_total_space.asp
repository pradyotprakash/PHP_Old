...
<title>PHP disk_total_space() Function</title>
<style>a.menu_func_filesystem_disk_total_space{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">disk_total_space()</span> Function</h1>
<hr>
...
<p>The disk_total_space() function returns the total space, in bytes, of the 
specified 
directory.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_disk_total_space.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_disk_total_space.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_disk_total_space.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
