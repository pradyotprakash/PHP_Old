...
<style>a.menu_php_mysql_select{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP MySQL <span class="color_h1">Select</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_mysql_insert.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_mysql_where.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The SELECT statement is used to select data from a database.</p>
<hr>
...
tutorial</a>.</p>
<p>To get PHP to execute the statement above we must use the mysqli_query() function. This function is used to 
send a query or command to a MySQL connection.</p>

<h3>Example</h3>
<p>The following example selects all the data stored in the &quot;Persons&quot; table 
(The * character selects all the data in the table):</p>
<div class="code notranslate"><div>
...
<p>The example above stores the data returned by the mysqli_query() function in the $result variable.</p>
<p>Next, we use the mysqli_fetch_array() function to return the first row from the recordset as an 
array. Each call to mysqli_fetch_array() returns the next row in 
the recordset. The while loop loops through all the records in the recordset. To print the value of each row, we use the PHP $row variable ($row['FirstName'] and $row['LastName']).</p>
...
<p>The following example selects the same data as the example above, but will 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_mysql_select.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_mysql_select.asp#top" target="_top">TOP</a> |
		<a href="php_mysql_select.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
