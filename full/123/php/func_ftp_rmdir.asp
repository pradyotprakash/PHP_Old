...
<title>PHP ftp_rmdir() Function</title>
<style>a.menu_func_ftp_rmdir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_rmdir()</span> Function</h1>
...
<p>Delete a directory on FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$dir = &quot;php/&quot;;<br>
	<br>// try to delete $dir<br>
	if (ftp_rmdir($ftp_conn, $dir))<br>&nbsp; {<br>&nbsp; echo 
	&quot;Directory $dir deleted&quot;;<br>&nbsp; }<br>else<br>&nbsp; 
	{<br>&nbsp; echo &quot;Problem deleting $dir&quot;;<br>&nbsp; }<br>
...
<p>The ftp_rmdir() function deletes a directory on the FTP server.</p>
<p><strong>Note:</strong> A directory must be empty before it can be deleted!</p>
<p><strong>Tip:</strong> Use the <a href="func_ftp_mkdir.asp">ftp_mkdir()</a> 
function to create a new directory.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_rmdir(<em>ftp_connection,dir</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td><em>dir</em></td>
    <td>Required. Specifies the <strong>empty</strong> directory to delete</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_rmdir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_rmdir.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_rmdir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
