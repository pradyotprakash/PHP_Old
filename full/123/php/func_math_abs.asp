...
<style>a.menu_func_math_abs{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">abs()</span> Function</h1>
...
&lt;?php<br>
echo(abs(6.7) . &quot;&lt;br&gt;&quot;);<br>echo(abs(-6.7) . &quot;&lt;br&gt;&quot;);<br>
echo(abs(-3) . &quot;&lt;br&gt;&quot;);<br>
echo(abs(3));<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_abs">Run example &raquo;</a>
</div>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies a number. If the number is of 
	type float, the return type is also float, otherwise it is integer</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">The absolute value of the number </td>
</tr>
<tr>
	<th>Return Type:</th>
	<td>Float / Integer</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_abs.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_abs.asp#top" target="_top">TOP</a> |
		<a href="func_math_abs.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
