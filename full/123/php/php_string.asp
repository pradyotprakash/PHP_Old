...
<style>a.menu_php_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">String Functions</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_datatypes.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_constants.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A string is a sequence of characters, like &quot;Hello world!&quot;.</p>
<hr>
...
<h2>The PHP strlen() function</h2>
<p>The strlen() function returns the length of a string, in characters.</p>
<p>The example below returns the length of the string &quot;Hello world!&quot;:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_string_length">Run example &raquo;</a>
</div>

<p>The output of the code above will be: 12</p>
<p><strong>Tip:</strong> strlen() is often used in loops or other functions, when it is 
important to know when a string ends. (i.e. in a loop, we might want to stop 
the loop after the last character in a string).</p>
<hr>

<h2>The PHP strpos() function</h2>
<p>The strpos() function is used to search for a specified character or text within a string.</p>
<p>If a match is found, it will return the character position of the first match. If no match is found, it will return FALSE.</p>
<p>The example below searches for the text &quot;world&quot; in the string &quot;Hello world!&quot;:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_string_pos">Run example &raquo;</a>
</div>

<p>The output of the code above will be: 6.</p>
<p><strong>Tip:</strong> The position of the string &quot;world&quot; in the example above is 6. 
The reason that it is 6 (and not 7), is that the first character position in the string is 0, and not 1.</p>
<hr>

<h2>Complete PHP String Reference</h2>
<p>For a complete reference of all string functions, go to our complete <a href="php_ref_string.asp">PHP String Reference</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_string.asp#top" target="_top">TOP</a> |
		<a href="php_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
