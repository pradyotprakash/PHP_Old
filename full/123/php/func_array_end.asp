...
<title>PHP end() Function</title>
<style>a.menu_func_array_end{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">end()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_end">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The end() function moves the internal pointer to, and outputs, the last element 
in the array.</p>
<p>Related methods:</p>
<ul>
...
<tr>
	...
	<td style="width:80%">Returns the value of the last element in the array on 
	success, or FALSE if the array is empty</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_end.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_end.asp#top" target="_top">TOP</a> |
		<a href="func_array_end.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
