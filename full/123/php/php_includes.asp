...
<style>a.menu_php_includes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Include Files</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_date.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_file.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP include and require Statements</h2>
<p>In PHP, you can insert the content of one PHP file into another PHP file before the 
server executes it.</p>
<p>The include and require statements are used to insert useful codes written in 
other files, in the flow of execution.</p>
<p><b>Include and require are identical, except upon failure:</b></p>
<ul>
	<li>require will produce a fatal error (E_COMPILE_ERROR) and stop the script</li>
	<li>include will only produce a warning (E_WARNING) and the script 
	will continue</li>
</ul>
...
<h2>PHP include and require Statement</h2>

<h3>Basic Example</h3>
<p>Assume that you have a standard header file, called &quot;header.php&quot;. To include 
the header file in a page, use include/require:</p>
<div class="code notranslate"><div>
...
<h3>Example 2</h3>
<p>Assume we have a standard menu file that should be used on all 
pages.</p>
<p>&quot;menu.php&quot;:</p>
<div class="code notranslate"><div>

echo '&lt;a href=&quot;/default.php&quot;&gt;Home&lt;/a&gt;<br>
&lt;a href=&quot;/tutorials.php&quot;&gt;Tutorials&lt;/a&gt;<br>
&lt;a href=&quot;/references.php&quot;&gt;References&lt;/a&gt;<br>
&lt;a href=&quot;/examples.php&quot;&gt;Examples&lt;/a&gt; <br>
&lt;a href=&quot;/about.php&quot;&gt;About Us&lt;/a&gt; <br>
&lt;a href=&quot;/contact.php&quot;&gt;Contact Us&lt;/a&gt;';</div></div>
...
<h3>Example 3</h3>
<p>Assume we have an include file with some variables defined (&quot;vars.php&quot;):</p>
<div class="code notranslate"><div>
...
$car='BMW';<br>
?&gt;</div></div>
<p>Then the variables can be used in the calling file:</p>
<div class="code notranslate"><div>
...
echo &quot;I have a $color $car&quot;; // I have a red BMW<br>
?&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_includes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_includes.asp#top" target="_top">TOP</a> |
		<a href="php_includes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
