...
<title>PHP mysqli_real_connect() Function</title>
<style>a.menu_func_mysqli_real_connect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_real_connect()</span> Function</h1>
<p><a href="php_ref_mysqli.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP MySQLi Reference" /> PHP MySQLi Reference</a></p>
<div class="example">
<h2 class="example">Example</h2>
<p>Open a new connection to the MySQL server:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$con=mysqli_init();<br>if (!$con)<br>&nbsp; {<br>&nbsp; 
	die(&quot;mysqli_init failed&quot;);<br>&nbsp; }<br><br>if 
	(!mysqli_real_connect($con,&quot;localhost&quot;,&quot;my_user&quot;,&quot;my_password&quot;,&quot;my_db&quot;))<br>&nbsp; 
	{<br>&nbsp; die(&quot;Connect Error: &quot; . mysqli_connect_error());<br>&nbsp; }<br>
...
<p>The mysqli_real_connect() function opens a new connection to the MySQL server.</p>
<p>The mysqli_real_connect() function differs from <a href="func_mysqli_connect.asp">mysqli_connect()</a> in the 
following ways:</p>
<ul>
	<li>mysqli_real_connect() requires a valid object created by 	<a href="func_mysqli_init.asp">mysqli_init()</a></li>
	<li>mysqli_real_connect() can be used with mysqli_options() to set different options for the connection</li>
	<li>mysqli_real_connect() has a flag parameter</li>
</ul>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_real_connect(<em>connection,host,username,password,dbname,port,socket,flag</em>)<em>;</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the MySQL connection to use</td>
  </tr>
  <tr>
    <td><em>host</em></td>
    <td>Optional. Specifies a host name or an IP address</td>
  </tr>
  <tr>
    <td><em>username</em></td>
    <td>Optional. Specifies the MySQL username</td>
  </tr>
  <tr>
    <td><em>password</em></td>
    <td>Optional. Specifies the MySQL password</td>
  </tr>
  <tr>
    <td><em>dbname</em></td>
    <td>Optional. Specifies the default database to be used</td>
  </tr>
  <tr>
    <td><em>port</em></td>
    <td>Optional. Specifies the port number to attempt to connect to the MySQL 
	server</td>
  </tr>
  <tr>
    <td><em>socket</em></td>
    <td>Optional. Specifies the socket or named pipe to be used</td>
  </tr>
  <tr>
    <td><em>flag</em></td>
    <td>Optional. Specifies different connection options. Possible values:<br>
    <ul><li>MYSQLI_CLIENT_COMPRESS - Use compression protocol</li>
		<li>MYSQLI_CLIENT_FOUND_ROWS - Return number of matched rows (not 
		affected rows)</li>
		<li>MYSQLI_CLIENT_IGNORE_SPACE - Allow spaces after function names. Make 
		function names reserved words</li>
		<li>MYSQLI_CLIENT_INTERACTIVE - Allow interactive_timeout seconds of 
		inactivity before closing connection</li>
		<li>MYSQLI_CLIENT_SSL - Use SSL encryption</li></ul>
...
<a href="php_ref_mysqli.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP MySQLi Reference" /> PHP MySQLi Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_real_connect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_real_connect.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_real_connect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
