...
<title>PHP chop() Function</title>
<style>a.menu_func_string_chop{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">chop()</span> Function</h1>
...
<p>Remove characters from the right end of a string:</p>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_chop">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The chop() function removes whitespaces or other predefined characters 
from the right end of a string.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	string. <br>
	The following characters are removed if the 
	charlist parameter is empty:<ul>
		<li>&quot;\0&quot; - NULL</li>
		<li>&quot;\t&quot; - tab</li>
		<li>&quot;\n&quot; - new line</li>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>charlist</em> parameter was added in PHP 4.1.0</td>
</tr>
</table>
<br>
<hr>
...
<p>Remove newlines (\n) from the right end of a string:</p>
<div class="example_code notranslate">
	&lt;?php<br>$str = "Hello World!\n\n";<br>echo $str;<br>echo chop($str);<br>?&gt;
</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br><br>&lt;body&gt;<br><br>Hello World!<br><br>Hello World!<br><br>&lt;/body&gt;<br>
	&lt;/html&gt;
</div>
...
<br>
<a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_chop2">Run example &raquo;</a>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_chop.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_chop.asp#top" target="_top">TOP</a> |
		<a href="func_string_chop.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
