...
<title>PHP strtr() Function</title>
<style>a.menu_func_string_strtr{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strtr()</span> Function</h1>
...
<p>Replace the characters &quot;ia&quot; in the string with &quot;eo&quot;:</p>
<div class="example_code notranslate">

&lt;?php<br>
echo strtr(&quot;Hilla Warld&quot;,&quot;ia&quot;,&quot;eo&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strtr">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strtr() function translates certain characters in a string.</p>
<p><b>Note:</b> If the from and to parameters are different in length, both will be formatted to 
the length of the shortest.</p>
<hr>
<h2>Syntax</h2>
...
strtr(<em>string,from,to</em>)

</div></div>
<p>or</p>
<div class="code notranslate"><div>

strtr(<em>string,array</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to translate</td>
  </tr>
  <tr>
    <td><em>from</em></td>
    <td>Required (unless array is used). Specifies what characters 
	to change</td>
  </tr>
  <tr>
    <td><em>to</em></td>
  ...
  <tr>
    <td><em>array</em></td>
    <td>Required (unless to and from is used). An array containing 
	what to change from as key, and what to change to as value</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the translated string. <br>If the <em>array</em> 
	parameter contains a key which is an empty string (&quot;&quot;), it will return 
	FALSE.</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<p>Replace the string &quot;Hello world&quot; with &quot;Hi earth&quot;:</p>
<div class="example_code notranslate">

	&lt;?php<br>
$arr = array(&quot;Hello&quot; =&gt; &quot;Hi&quot;, &quot;world&quot; =&gt; &quot;earth&quot;);<br>
echo strtr(&quot;Hello world&quot;,$arr);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strtr2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strtr.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strtr.asp#top" target="_top">TOP</a> |
		<a href="func_string_strtr.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
