...
<title>PHP str_rot13() Function</title>
<style>a.menu_func_string_str_rot13{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">str_rot13()</span> Function</h1>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_rot13">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The str_rot13() function performs the ROT13 encoding on a string.</p>
<p>The ROT13 encoding shifts every letter 13 places in the alphabet. Numeric 
and non-alphabetical characters remains untouched.</p>
<p><b>Tip:</b> Encoding and decoding are done by the same function. If you pass 
an encoded string as argument, the original string will be returned.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

str_rot13(<em>string</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to encode</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the ROT13 version of the encoded string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.2.0+</td>
...
<tr>
	<th>Changelog:</th>
	<td>Before PHP 4.3, the <em>string</em> was also modified, as if it was 
	passed by reference</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_str_rot13.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_str_rot13.asp#top" target="_top">TOP</a> |
		<a href="func_string_str_rot13.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
