...
<title>PHP vsprintf() Function</title>
<style>a.menu_func_string_vsprintf{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">vsprintf()</span> Function</h1>
...
<p>Write a formatted string to a variable:</p>
<div class="example_code notranslate">

	&lt;?php<br>$number = 9;<br>$str = &quot;Beijing&quot;;<br>$txt = vsprintf(&quot;There are %u 
	million bicycles in %s.&quot;,array($number,$str));<br>echo $txt;<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_vsprintf">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The vsprintf() function writes a formatted string to a 
variable.</p>
<p>Unlike sprintf(), the arguments in vsprintf(), are placed in an array. The 
...
<a href="func_string_vfprintf.asp">vfprintf()</a>,
<a href="func_string_printf.asp">printf()</a>, <a href="func_string_sprintf.asp">
sprintf()</a> and <a href="func_string_vprintf.asp">vprintf()</a>.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

vsprintf(<em>format,argarray</em>)
...
<tr>
	...
	<td style="width:80%">Returns array values as a formatted string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.1.0+</td>
...
$num1 = 123;<br>
$num2 = 456;<br>
$txt = vsprintf(&quot;%f%f&quot;,array($num1,$num2));<br>
echo $txt;<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_vsprintf2">Run example &raquo;</a>
</div>
<br>
...
echo $txt;<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_vsprintf3">Run example &raquo;</a>
</div>
<br>
...
<p>Using sprintf() to demonstrate all possible format values: </p>
<div class="example_code notranslate">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_sprintf4">Run example &raquo;</a>
</div>
<br>
...
<div class="example_code notranslate">
	...
	&lt;?php<br>$str1 = &quot;Hello&quot;;<br>$str2 = &quot;Hello world!&quot;;<br><br>echo vsprintf(&quot;[%s]&quot;,array($str1)).&quot;&lt;br&gt;&quot;;<br>
	echo vsprintf(&quot;[%8s]&quot;,array($str1)).&quot;&lt;br&gt;&quot;;<br>echo vsprintf(&quot;[%-8s]&quot;,array($str1)).&quot;&lt;br&gt;&quot;;<br>
	echo vsprintf(&quot;[%08s]&quot;,array($str1)).&quot;&lt;br&gt;&quot;; <br>echo vsprintf(&quot;[%'*8s]&quot;,array($str1)).&quot;&lt;br&gt;&quot;;<br>
	echo vsprintf(&quot;[%8.8s]&quot;,array($str2)).&quot;&lt;br&gt;&quot;; <br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_vsprintf4">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_vsprintf.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_vsprintf.asp#top" target="_top">TOP</a> |
		<a href="func_string_vsprintf.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
