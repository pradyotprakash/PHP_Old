...
<title>PHP tempnam() Function</title>
<style>a.menu_func_filesystem_tempnam{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">tempnam()</span> Function</h1>
<hr>
...
<p>The tempnam() function creates a temporary file with a unique filename in the specified 
directory.</p>
<p>This function returns the new temporary filename, or FALSE on failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>dir</td>
    <td>Required. Specifies the directory of where to create the temp file</td>
  </tr>
  <tr>
    <td>prefix</td>
    <td>Required. Specifies the start of the filename</td>
  </tr>
  </table>
<br>
...
<p><b>Note: </b>If the specified directory does not exist, tempnam() may 
generate a file in the system's temporary directory.</p>
<p><b>Tip:</b> See also tmpfile()</p>
<hr>
...
&lt;?php<br>
echo tempnam(&quot;C:\inetpub\testweb&quot;,&quot;TMP0&quot;);<br>
?&gt; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_tempnam.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_tempnam.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_tempnam.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
