...
<title>PHP ftp_cdup() Function</title>
<style>a.menu_func_ftp_cdup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_cdup()</span> Function</h1>
...
<p>Output current directory name, then change to parent directory:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// change the 
	current directory to php<br>
	ftp_chdir($ftp_conn, &quot;php&quot;);<br>
	<br>// change to the parent directory<br>if (ftp_cdup($ftp_conn))<br>&nbsp; 
	{ <br>&nbsp; echo &quot;Successfully changed to parent directory.&quot;;<br>&nbsp; }<br>
	else<br>&nbsp; {<br>&nbsp; 
	echo &quot;cdup failed.&quot;;<br>&nbsp; }<br><br>// output current 
	directory name<br>echo ftp_pwd($ftp_conn);<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_cdup() function changes to the parent directory on the FTP server.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_cdup(<em>ftp_connection</em>);</div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_cdup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_cdup.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_cdup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
