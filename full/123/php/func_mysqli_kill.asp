...
<title>PHP mysqli_kill() Function</title>
<style>a.menu_func_mysqli_kill{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_kill()</span> Function</h1>
...
<p>The mysqli_kill() function asks the server to kill a MySQL thread specified by the <em>processid</em> parameter.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_kill(<em>connection,processid</em>)<em>;</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. The thread ID returned from
	<a href="func_mysqli_thread_id.asp">mysqli_thread_id()</a></td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_kill.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_kill.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_kill.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
