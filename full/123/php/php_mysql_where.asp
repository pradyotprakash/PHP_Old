...
<html lang="en-US">
<head>
<title>PHP MySQL Where Clause</title>
<style>a.menu_php_mysql_where{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP MySQL <span class="color_h1">The Where Clause</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_mysql_select.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_mysql_order_by.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>The WHERE clause is used to extract only those records that fulfill a specified 
criterion.</p>
<h3>Syntax</h3>
...
<h3>Example</h3>
<p>The following example selects all rows from the &quot;Persons&quot; table where 
&quot;FirstName='Peter'&quot;:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_mysql_where.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_mysql_where.asp#top" target="_top">TOP</a> |
		<a href="php_mysql_where.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
