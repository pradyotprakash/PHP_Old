...
<title>PHP addAttribute() Function</title>
<style>a.menu_func_simplexml_addattribute{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">addAttribute()</span> Function</h1>
...
<p>Add an attribute to the root 
element and to the body element:</p>
<div class="example_code notranslate">
	...
	$xml=new SimpleXMLElement($note);<br>$xml-&gt;addAttribute(&quot;type&quot;,&quot;private&quot;);<br>
	$xml-&gt;body-&gt;addAttribute(&quot;date&quot;,&quot;2013-01-01&quot;);<br>
	<br>echo $xml-&gt;asXML();<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_addattribute">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The addAttribute() function adds an attribute to the SimpleXML element.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	addAttribute(<em>name,value,ns</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>name</em></td>
    <td>Required. Specifies the name of the attribute to add</td>
  </tr>
  <tr>
    <td><em>value</em></td>
    <td>Optional. Specifies the value of the attribute</td>
  </tr>
	<tr>
    <td><em>ns</em></td>
    <td>Optional. Specifies a namespace for the attribute</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_addattribute.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_addattribute.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_addattribute.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
