...
<style>a.menu_php_forms{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Form Handling</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_superglobals.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_form_validation.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The PHP superglobals $_GET and $_POST are used to collect form-data.</p>
<hr>
...
<br><a class="showbtn" href="showphp.asp?filename=demo_form_post" target="_blank">Run example &raquo;</a>
</div>
...
<br><a class="showbtn" href="showphp.asp?filename=demo_form_get" target="_blank">Run example &raquo;</a>
</div>
...
<h2>GET vs. POST</h2>
<p>Both GET and POST create an array (e.g. array( key =&gt; value, 
...
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><strong>Developers prefer POST for sending form data.</strong></td>
</tr></table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_forms.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_forms.asp#top" target="_top">TOP</a> |
		<a href="php_forms.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
