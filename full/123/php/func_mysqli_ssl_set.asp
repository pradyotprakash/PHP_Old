...
<title>PHP mysqli_ssl_set() Function</title>
<style>a.menu_func_mysqli_ssl_set{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_ssl_set()</span> Function</h1>
...
<p>Create an SSL connection:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$con=mysqli_init();<br>if (!$con)<br>&nbsp; {<br>&nbsp; 
	die(&quot;mysqli_init failed&quot;);<br>&nbsp; }<br><br>
	mysqli_ssl_set($con,&quot;key.pem&quot;,&quot;cert.pem&quot;,&quot;cacert.pem&quot;,NULL,NULL); <br><br>if 
...
<p>The mysqli_ssl_set() function is used to establish secure connections using 
SSL. However, this function does nothing unless OpenSSL support is enabled.</p>
<p><strong>Note:</strong> This function must be called before
<a href="func_mysqli_real_connect.asp">mysqli_real_connect()</a>.</p>
<p><strong>Note:</strong> MySQL Native Driver does not support SSL before PHP 
5.3.3. MySQL Native Driver is enabled by default on Microsoft Windows from PHP 5.3+.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_ssl_set(<em>connection,key,cert,ca,capath,cipher</em>)<em>;</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>key</em></td>
    <td>Required. Specifies the path name to the key file</td>
  </tr>
  <tr>
    <td><em>cert</em></td>
    <td>Required. Specifies the path name to the certificate file</td>
  </tr>
  <tr>
    <td><em>ca</em></td>
    <td>Required. Specifies the path name to the certificate authority file</td>
  </tr>
  <tr>
    <td><em>capath</em></td>
    <td>Required. Specifies the pathname to a directory that contains trusted 
	SSL CA certificates in PEM format</td>
  </tr>
  <tr>
    <td><em>cipher</em></td>
    <td>Required. Specifies a list of allowable ciphers to use for SSL 
	encryption</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Always TRUE. If SSL setup is incorrect,
	<a href="func_mysqli_real_connect.asp">mysqli_real_connect()</a> will return 
	an error when you try to connect</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_ssl_set.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_ssl_set.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_ssl_set.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
