...
<title>PHP sscanf() Function</title>
<style>a.menu_func_string_sscanf{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">sscanf()</span> Function</h1>
...
&lt;?php<br>
$str = &quot;age:30 weight:60kg&quot;;<br>
sscanf($str,&quot;age:%d weight:%dkg&quot;,$age,$weight);<br>
// show types and values<br>
var_dump($age,$weight);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_sscanf">Run example &raquo;</a>
</div>
<hr>

<p>The sscanf() function parses input from a string according to a specified format. 
The sscanf() function parses a string into variables based on the format string.</p>
<p>If only two parameters are passed to this function, the data will be returned 
...
variables contain NULL.</p>
<p>Related functions:</p>
<ul>
	<li><a href="func_string_printf.asp">printf()</a> - outputs a formatted 
	string</li>
	<li><a href="func_string_sprintf.asp">sprintf()</a> - writes a formatted 
	string to a variable</li>
</ul>
<hr>
<h2>Syntax</h2>
...
sscanf(<em>string,format,arg1,arg2,arg++</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to read</td>
  </tr>
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the format to use.<p>Possible format values:</p>
<ul>
	...
	<tr>
    <td><em>arg1</em></td>
    <td>Optional. The first variable to store data in</td>
  </tr>
  <tr>
    <td><em>arg2</em></td>
    <td>Optional. The second variable to store data in</td>
  </tr>
  <tr>
    <td><em>arg++</em></td>
    <td>Optional. The third, fourth, and so on, to store data in</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">If only two parameters are passed to this function, the data will be returned 
as an array. Otherwise, if optional parameters are passed, the data parsed are 
stored in them. If there are more specifiers than variables to contain them, an 
error occurs. However, if there are less specifiers than variables, the extra 
variables contain NULL.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.1+</td>
...
<p>Using the format values %s, %d and %c:</p>
<div class="example_code notranslate">

	&lt;?php<br>$str = &quot;If you divide 4 by 2 you'll get 2&quot;;<br>$format = sscanf($str,&quot;%s 
	%s %s %d %s %d %s %s %c&quot;);<br>print_r($format);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_sscanf2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_sscanf.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_sscanf.asp#top" target="_top">TOP</a> |
		<a href="func_string_sscanf.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
