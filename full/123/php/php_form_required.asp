...
<style>a.menu_php_form_required{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Forms - Required Fields</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_form_validation.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_form_url_email.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">This chapter show how to make input fields required and create error messages if needed.</p>
<hr>

<h2>PHP - Required Fields</h2>

<p>From the validation rules table on the previous page, we see that the &quot;Name&quot;, &quot;E-mail&quot;, and 
...
<p>In the following code we have added some new variables: $nameErr, $emailErr, 
...
<br>&nbsp;
if (empty($_POST[&quot;name&quot;]))<br>&nbsp;&nbsp;&nbsp; {$nameErr = &quot;Name is required&quot;;}<br>&nbsp; else<br>&nbsp;&nbsp;&nbsp; {$name = test_input($_POST[&quot;name&quot;]);}<br><br>&nbsp; if (empty($_POST[&quot;email&quot;]))<br>
&nbsp;&nbsp;&nbsp;
{$emailErr = &quot;Email is required&quot;;}<br>&nbsp; else<br>&nbsp;&nbsp;&nbsp; {$email = 
test_input($_POST[&quot;email&quot;]);}<br><br>&nbsp; if (empty($_POST[&quot;website&quot;]))<br>
&nbsp;&nbsp;&nbsp;
{$website = &quot;&quot;;}<br>&nbsp; else<br>&nbsp;&nbsp;&nbsp; {$website = test_input($_POST[&quot;website&quot;]);}<br><br>&nbsp; if (empty($_POST[&quot;comment&quot;]))<br>&nbsp;&nbsp;&nbsp; {$comment = &quot;&quot;;}<br>&nbsp; else<br>&nbsp;&nbsp;&nbsp; {$comment = test_input($_POST[&quot;comment&quot;]);}<br><br>&nbsp; if 
(empty($_POST[&quot;gender&quot;]))<br>&nbsp;&nbsp;&nbsp; {$genderErr = &quot;Gender is required&quot;;}<br>&nbsp; else<br>
&nbsp;&nbsp;&nbsp;
{$gender = test_input($_POST[&quot;gender&quot;]);}<br>}<br>?&gt;</div></div>
<br>
<hr>
...
<div class="example_code notranslate">
	...
	Name: &lt;input type=&quot;text&quot; name=&quot;name&quot;&gt;<br>&lt;span class=&quot;error&quot;&gt;* 
	&lt;?php echo $nameErr;?&gt;&lt;/span&gt;<br>
	&lt;br&gt;&lt;br&gt;<br>E-mail:<br>&lt;input type=&quot;text&quot; name=&quot;email&quot;&gt;<br>&lt;span 
	class=&quot;error&quot;&gt;* &lt;?php echo $emailErr;?&gt;&lt;/span&gt;<br>&lt;br&gt;&lt;br&gt;<br>
	Website:<br>&lt;input type=&quot;text&quot; name=&quot;website&quot;&gt;<br>&lt;span 
	class=&quot;error&quot;&gt;&lt;?php echo $websiteErr;?&gt;&lt;/span&gt;<br>&lt;br&gt;&lt;br&gt;<br>
	&lt;label&gt;Comment: &lt;textarea name=&quot;comment&quot; rows=&quot;5&quot; 
	cols=&quot;40&quot;&gt;&lt;/textarea&gt;<br>&lt;br&gt;&lt;br&gt;<br>
	Gender:<br>&lt;input type=&quot;radio&quot; name=&quot;gender&quot;  
	value=&quot;female&quot;&gt;Female<br>&lt;input type=&quot;radio&quot; name=&quot;gender&quot; value=&quot;male&quot;&gt;Male<br>
	&lt;span class=&quot;error&quot;&gt;* &lt;?php echo $genderErr;?&gt;&lt;/span&gt;<br>&lt;br&gt;&lt;br&gt;<br>&lt;input 
	type=&quot;submit&quot; name=&quot;submit&quot; value=&quot;Submit&quot;&gt; <br>
	<br>&lt;/form&gt;
</div>
<br><a class="showbtn" href="showphp.asp?filename=demo_form_validation_required" target="_blank">Run example &raquo;</a>
</div>
<p>The next step is to validate the input data, that is &quot;Does the Name field 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_form_required.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_form_required.asp#top" target="_top">TOP</a> |
		<a href="php_form_required.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
