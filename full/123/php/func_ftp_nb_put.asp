...
<title>PHP ftp_nb_put() Function</title>
<style>a.menu_func_ftp_nb_put{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_nb_put()</span> Function</h1>
...
<p>Upload local file (non-blocking) to a file on the FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	&quot;localfile.txt&quot;;<br>$server_file = 
	&quot;serverfile.txt&quot;;<br><br>// initiate upload<br>$d = ftp_nb_put($ftp_conn, 
	$server_file, $local_file, FTP_BINARY)<br><br>while ($d == FTP_MOREDATA)<br>&nbsp; 
	{<br>&nbsp; // do whatever you want<br>&nbsp; // continue uploading<br>&nbsp; $d = ftp_nb_continue($ftp_conn);<br>&nbsp; }<br>
	<br>if ($d != FTP_FINISHED)<br>&nbsp; {<br>&nbsp; echo &quot;Error uploading 
	$local_file&quot;;<br>&nbsp; exit(1);<br>&nbsp; }<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_nb_put() function uploads a file to the FTP server (non-blocking).</p>
<p><strong>Tip:</strong> This function (as opposite to
<a href="func_ftp_put.asp">ftp_put()</a>) 
...
ftp_nb_put(<em>ftp_connection,remote_file,local_file,mode,startpos</em>);
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the path of the local file to upload</td>
  </tr>
	<tr>
    <td><em>mode</em></td>
  ...
  <tr>
    ...
    <td>Optional. Specifies the position in the remote file to start uploading 
	to</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_nb_put.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_nb_put.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_nb_put.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
