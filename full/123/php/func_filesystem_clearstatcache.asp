...
<title>PHP clearstatcache() Function</title>
<style>a.menu_func_filesystem_clearstatcache{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">clearstatcache()</span> Function</h1>
<hr>
...
<p>The clearstatcache() function clears the file status cache.</p>
<p>PHP caches data for some functions for better performance. If a file is 
being checked several times in a script, you might want to avoid caching to get 
correct results. To do this, use the clearstatcache() function.</p>
<h2>Syntax</h2>
...
<p><b>Tip:</b> Functions that are caching:</p>
<ul>
	<li>stat()</li>
	<li>lstat()</li>
	<li>file_exists()</li>
...
// truncate file<br>
ftruncate($file,100);<br>
fclose($file);<br>
<br>
//Clear cache and check filesize again<br>
clearstatcache();<br>
echo filesize(&quot;test.txt&quot;);<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_clearstatcache.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_clearstatcache.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_clearstatcache.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
