...
<style>a.menu_php_looping_for{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">for</span> Loops</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_looping.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_functions.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">PHP for loops execute a block of code a specified number of times.</p>
<hr>
...
for (<i>init counter; test counter; increment counter</i>)<br>
&nbsp;
{<br>
...
<ul>
	...
	<li><i>test counter</i>: Evaluated for each loop iteration. If it evaluates to TRUE, the loop continues. If it evaluates to FALSE, the loop ends.</li>
...
&lt;?php <br>for ($x=0; $x&lt;=10; $x++)<br>
&nbsp;
{<br>
	&nbsp; echo &quot;The number is: 
	$x &lt;br&gt;&quot;;<br>&nbsp; } <br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_loop_for">Run example &raquo;</a>
</div>
<br>
<hr>
...
<h3>Syntax</h3>
<div class="code notranslate"><div>
foreach ($<i>array </i>as<i> </i>$<i>value</i>)<br>
&nbsp;
{<br>
&nbsp;&nbsp;<i>code to be executed;</i><br>
&nbsp;
...
<p>For every loop iteration, the value of the 
current array element is assigned to $value and the array pointer is moved by 
one, until it reaches the last array element.</p>
<p>The following example demonstrates a loop that will output the values of  the 
given array ($colors):</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;?php <br>$colors = array(&quot;red&quot;,&quot;green&quot;,&quot;blue&quot;,&quot;yellow&quot;); <br>foreach ($colors as 
	$value)<br>&nbsp; {<br>&nbsp; echo &quot;$value &lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_loop_foreach">Run example &raquo;</a>
</div>
<p>You will learn more about arrays in a later chapter.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_looping_for.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_looping_for.asp#top" target="_top">TOP</a> |
		<a href="php_looping_for.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
