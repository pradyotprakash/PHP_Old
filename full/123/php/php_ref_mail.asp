...
<html lang="en-US">
<head>
<title>PHP 5 Mail Functions</title>
<style>a.menu_php_ref_mail{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Mail</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_libxml.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_math.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP Mail Introduction</h2>
<p>The mail() function allows you to send emails directly from a script.</p>
<hr>

<h2>Requirements</h2>
<p>For the mail functions to be available, PHP requires an installed and working 
email system. The program to be used is defined by 
the configuration settings in the php.ini file.</p>
<hr>

<h2>Installation</h2>
<p>The mail functions are part of the PHP core. There is no installation 
needed to use these functions.</p>
<hr>

<h2>Runtime Configuration</h2>
<p>The behavior of the mail functions is affected by settings in php.ini:&nbsp;</p>
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>&quot;0&quot;</td>
    <td>Add X-PHP-Originating-Script that will include UID of the script 
	followed by the filename. For PHP 5.3.0 and above</td>
    <td>PHP_INI_PERDIR</td>
  </tr>
  <tr>
    <td>mail.log</td>
    <td>NULL</td>
    <td>The path to a log file that will log all mail() calls. Log&nbsp; include 
	full path of script, line number, To address and headers. For PHP 5.3.0 and 
	above </td>
    <td>PHP_INI_PERDIR</td>
  </tr>
  <tr>
    <td>SMTP</td>
    <td>&quot;localhost&quot;</td>
    <td>Windows only: The DNS name or IP address of the SMTP 
	server</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>smtp_port</td>
    <td>&quot;25&quot;</td>
    <td>Windows only: The SMTP port number. For PHP 4.3.0 and above</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>sendmail_from</td>
    <td>NULL</td>
    <td>Windows only: Specifies the &quot;from&quot; address to be used 
	when sending mail from mail()</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>sendmail_path</td>
    <td>&quot;/usr/sbin/sendmail -t -i&quot;</td>
    <td>Specifies where the sendmail program can be found. This directive works 
	also under Windows. If set, SMTP, smtp_port and sendmail_from are ignored </td>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="func_mail_ezmlm_hash.asp">ezmlm_hash()</a></td>
    <td>Calculates the hash value needed by EZMLM</td>
  </tr>
  <tr>
    <td><a href="func_mail_mail.asp">mail()</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_mail.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_mail.asp#top" target="_top">TOP</a> |
		<a href="php_ref_mail.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
