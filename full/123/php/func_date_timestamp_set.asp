...
<title>PHP date_timestamp_set() Function</title>
<style>a.menu_func_date_timestamp_set{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_timestamp_set()</span> Function</h1>
...
<p>Set the date and time based on a Unix timestamp:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$date=date_create();<br>date_timestamp_set($date,1371803321);<br>echo 
	date_format($date,&quot;U = Y-m-d H:i:s&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_timestamp_set">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_timestamp_set() function sets the date and time based on a Unix timestamp.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_timestamp_set(<em>object,unixtimestamp);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>unixtimestamp</em></td>
    <td>Required. Specifies a Unix timestamp representing the date</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_timestamp_set.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_timestamp_set.asp#top" target="_top">TOP</a> |
		<a href="func_date_timestamp_set.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
