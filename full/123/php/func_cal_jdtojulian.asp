...
<title>PHP jdtojulian() Function</title>
<style>a.menu_func_cal_jdtojulian{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">jdtojulian()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_jdtojulian">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The jdtojulian() function converts a Julian Day Count to a Julian date.</p>
<p><strong>Tip:</strong> Look at the <a href="func_cal_juliantojd.asp">juliantojd()</a> function to convert
a Julian date to a Julian Day Count.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	jdtojulian(<em>jd);</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns a Julian date in format &quot;month/day/year&quot;</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_jdtojulian.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_jdtojulian.asp#top" target="_top">TOP</a> |
		<a href="func_cal_jdtojulian.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
