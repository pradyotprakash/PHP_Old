...
<title>PHP date_sunrise() Function</title>
<style>a.menu_func_date_sunrise{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_sunrise()</span> Function</h1>
...
<p>Return the sunrise time for Lisbon, Portugal today:</p>
<div class="example_code notranslate">
&lt;?php<br>
// Lisbon, Portugal:<br>
// Latitude: 38.4 North, Longitude: 9 West<br>
// Zenith ~= 90, offset: +1 GMT<br><br>
echo(&quot;Lisbon, Portugal: Date: &quot; . date(&quot;D M d Y&quot;));<br>
echo(&quot;&lt;br&gt;Sunrise time: &quot;);<br>
echo(date_sunrise(time(),SUNFUNCS_RET_STRING,38.4,-9,90,1));<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_sunrise">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_sunrise() function returns the sunrise time for a specified day and location.</p>
<p><strong>Tip:</strong> Look at the <a href="func_date_sunset.asp">date_sunset()</a> function 
to return the sunset time for a specified day and location.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_sunrise(<em>timestamp,format,latitude,longitude,zenith,gmtoffset);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the timestamp of the day from which the sunrise time is taken</td>
  </tr>
  <tr>
    <td><em>format</em></td>
    <td>
	<p>Optional. Specifies how to return the result:</p>
	<ul>
		<li>SUNFUNCS_RET_STRING (returns the result as string. e.g. 16:46) (This 
		is default)</li>
		<li>SUNFUNCS_RET_DOUBLE (returns the result as float. e.g. 16.78243132)</li>
		<li>SUNFUNCS_RET_TIMESTAMP (returns the result as integer (timestamp). 
		e.g. 1095034606)</li>
	</ul>
	  </td>
  </tr>
  <tr>
    ...
    <td>Optional. Specifies the latitude of the location. Defaults 
	to North. To specify a value for South, pass in a negative 
	value</td>
  </tr>
  <tr>
    <td><em>longitude</em></td>
    <td>Optional. Specifies the longitude of the location. Defaults to East. To specify a 
	value for West, pass in a 
	negative value</td>
  </tr>
  <tr>
    <td><em>zenith</em></td>
    <td>Optional. Defaults to date.sunrise_zenith</td>
  </tr>
  <tr>
    <td><em>gmtoffset</em></td>
    <td>Optional. Specifies the difference between GMT and local time in hours</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the time of the sunrise, in the specified <em>format,
	</em>on success. FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<tr>
	<th>Changelog:</th>
	<td>From PHP 5.1.0 this function issues E_STRICT and E_NOTICE time zone 
	errors</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_sunrise.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_sunrise.asp#top" target="_top">TOP</a> |
		<a href="func_date_sunrise.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
