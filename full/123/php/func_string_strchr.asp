...
<title>PHP strchr() Function</title>
<style>a.menu_func_string_strchr{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strchr()</span> Function</h1>
...
<p>Find the first occurrence of &quot;world&quot; inside &quot;Hello world!&quot; and return the 
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strchr">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strchr() function searches for the first occurrence of a string inside 
another string.</p>
<p>This function is an alias of the<a href="func_string_strstr.asp"> strstr()</a> function.</p>

<p><b>Note:</b> This function is binary-safe.</p>

<p><b>Note:</b> This function is case-sensitive. For a case-insensitive search, 
use <a href="func_string_stristr.asp">stristr()</a> function.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

strchr(<em>string,search,before_search</em>);</div></div><br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to search</td>
  </tr>
  <tr>
    <td><em>search</em></td>
    <td>Required. Specifies the string to search for. If this 
	parameter is a number, it will search for the character matching the ASCII 
	value of the number</td>
  </tr>
  <tr>
    <td><em>before_search</em></td>
    <td>Optional. A boolean value whose default is &quot;false&quot;. If set 
	to &quot;true&quot;, it returns the part of the string before the first occurrence of the <em>
	search</em> parameter.</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the rest of the string (from the matching point), or 
	FALSE, if the string to search for is not found.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>before_search</em> parameter was added in PHP 5.3</td>
</tr>
</table>
<br>
...
<p>Search a string for the ASCII value of &quot;o&quot; and return the rest of the string:</p>
<div class="example_code notranslate">

	&lt;?php<br>
echo strchr(&quot;Hello world!&quot;,111);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strchr2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Return the part of the string before the first occurence of &quot;world&quot;:</p>
<div class="example_code notranslate">

	&lt;?php<br>
echo strchr(&quot;Hello world!&quot;,&quot;world&quot;,true);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strchr3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strchr.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strchr.asp#top" target="_top">TOP</a> |
		<a href="func_string_strchr.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
