...
<title>PHP show_source() Function</title>
<style>a.menu_func_misc_show_source{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">show_source()</span> Function</h1>
...
<p>Using a test file (&quot;test.php&quot;) to output the file with the PHP syntax highlighted:</p>
<div class="example_code notranslate">
&lt;html&gt;<br>
&lt;body&gt;<br>
&lt;?php<br>
	show_source(&quot;test.php&quot;);<br>
?&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<p>The browser output of the code above could be (depending on the content in your file):</p>
<div class="example_code notranslate">
<span style="COLOR: #000000">&lt;html&gt;<br>
&lt;body&gt;<br>
<span style="COLOR: #0000bb">&lt;?php<br>
</span><span style="color: #007700">echo&nbsp;</span><span style="COLOR: #007700">(</span><span style="COLOR: #dd0000">&quot;test.php&quot;</span><span style="COLOR: #007700">);<br>
</span><span style="COLOR: #0000bb">?&gt;<br>
</span>&lt;/body&gt;<br>&lt;/html&gt;</span></div>

<p>The HTML output of the code above could be (View Source):</p>
<div class="example_code notranslate">
	<span style="COLOR: #000000">&lt;html&gt;<br>&lt;body&gt;<br>&lt;code&gt;&lt;span 
	style=&quot;color: #000000&quot;&gt;<br>&amp;lt;html&amp;gt;<br>&lt;br /&gt;&amp;lt;body&amp;gt;<br>&lt;br /&gt;&lt;span 
	style=&quot;color: #0000BB&quot;&gt;&amp;lt;?php<br>&lt;br /&gt;&lt;/span&gt;&lt;span style=&quot;color: 
	#007700&quot;&gt;echo&amp;nbsp;(&lt;/span&gt;&lt;span style=&quot;color: #DD0000&quot;&gt;&quot;test.php&quot;&lt;/span&gt;&lt;span 
	style=&quot;color: #007700&quot;&gt;);<br>&lt;br /&gt;&lt;/span&gt;&lt;span style=&quot;color: #0000BB&quot;&gt;?&amp;gt;<br>
	&lt;br /&gt;&lt;/span&gt;&amp;lt;/body&amp;gt;<br>&lt;br /&gt;&amp;lt;/html&amp;gt;&lt;/span&gt;<br>&lt;/code&gt;<br>&lt;/body&gt;<br>&lt;/html&gt;</span></div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_show_source">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The show_source() function outputs a file with the PHP syntax 
highlighted. The syntax is highlighted by using HTML tags.</p>
<p>The colors used for highlighting can be set in the php.ini file or with the ini_set() function.</p>
<p>show_source() is an alias of <a href="func_misc_highlight_file.asp">highlight_file()</a>.</p>
<p><b>Note:</b> When using this function, the entire file will be displayed - including passwords and any other 
sensitive information!</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
show_source(<em>filename,return</em>)
</div></div><br>
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the file to display</td>
  </tr>
  <tr>
    <td><em>return</em></td>
    <td>Optional. If this parameter is set to TRUE, this function will return 
...
<tr>
	...
	<td style="width:80%">If the <em>return</em> parameter is set to TRUE, this 
	function returns the highlighted code as a string instead of printing it 
	out. Otherwise, it returns TRUE on success, or FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 4.2.1, this function is now also affected by safe_mode and 
	open_basedir. However, safe_mode was removed in PHP 5.4.<br><br>The return 
	parameter was added in PHP 4.2.0.</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_show_source.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_show_source.asp#top" target="_top">TOP</a> |
		<a href="func_misc_show_source.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
