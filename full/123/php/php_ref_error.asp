...
<style>a.menu_php_ref_error{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Error and Logging</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_directory.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_filesystem.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP Error and Logging Introduction</h2>
<p>The error and logging functions allows error handling and logging.</p>
<p>The error functions allow users to define error handling rules, and modify 
the way the errors can be logged.</p>
<p>The logging functions allow users to log applications and send log messages 
to email, system logs or other machines.</p>
<hr>

<h2>Installation</h2>
<p>The error and logging functions are part of the PHP core. There is no installation needed 
to use these functions.</p>
<hr>

<h2>PHP Error and Logging Functions</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Gets the last error occurred</td>
    <td>5</td>
  </tr>
  <tr>
    <td><a href="func_error_log.asp">error_log()</a></td>
    <td>Sends an error to the server error-log, to a file or to a remote 
	destination</td>
    <td>4</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Sets a user-defined function to handle errors</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_error_set_exception_handler.asp">set_exception_handler()</a></td>
    <td>Sets a user-defined function to handle exceptions</td>
    <td>5</td>
  </tr>
  <tr>
    <td><a href="func_error_trigger_error.asp">trigger_error()</a></td>
    <td>Creates a user-defined error message</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_error_user_error.asp">user_error()</a></td>
    <td>Alias of trigger_error()</td>
    <td>4</td>
  </tr>
  </table>
<br>
...
<h2>PHP Error and Logging Constants</h2>
<p><b>PHP</b>: indicates the earliest version of PHP that supports the 
  constant. </p>
<table class="reference notranslate">
  <tr>
    <th style="width:5%">Value</th>
    <th style="width:35%">Constant</th>
    <th style="width:55%">Description</th>
    <th style="width:5%">PHP</th>
  </tr>
  <tr>
  ...
  <tr>
    <td>16</td>
    <td>E_CORE_ERROR</td>
    <td>Fatal errors at PHP startup. This is like an E_ERROR in the PHP core</td>
    <td>4</td>
  </tr>
  <tr>
    <td>32</td>
    <td>E_CORE_WARNING</td>
    <td>Non-fatal errors at PHP startup. This is like an E_WARNING in the PHP core</td>
    <td>4</td>
  </tr>
  <tr>
    <td>64</td>
    <td>E_COMPILE_ERROR</td>
    <td>Fatal compile-time errors. This is like an E_ERROR generated by the Zend Scripting Engine</td>
    <td>4</td>
  </tr>
  <tr>
    <td>128</td>
    <td>E_COMPILE_WARNING</td>
    <td>Non-fatal compile-time errors. This is like an E_WARNING generated by the Zend Scripting Engine</td>
    <td>4</td>
  </tr>
  <tr>
    <td>256</td>
  ...
  <tr>
    <td>2048</td>
    <td>E_STRICT</td>
    <td>Run-time notices. PHP suggest changes to your code to help interoperability and compatibility of the code</td>
    <td>5</td>
  </tr>
  <tr>
    <td>4096</td>
  ...
  <tr>
    <td>6143&nbsp;</td>
    <td>E_ALL</td>
    <td>All errors and warnings, except of level E_STRICT</td>
    <td>5</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_error.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_error.asp#top" target="_top">TOP</a> |
		<a href="php_ref_error.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
