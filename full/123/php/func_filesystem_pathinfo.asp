...
<title>PHP pathinfo() Function</title>
<style>a.menu_func_filesystem_pathinfo{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">pathinfo()</span> Function</h1>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>path</td>
    <td>Required. Specifies the path to check</td>
  </tr>
  <tr>
    <td>options</td>
    <td>Optional. Specifies which array elements to return. Default is 
	all<p>Possible values:</p>
	<ul>
		<li>PATHINFO_DIRNAME - return only dirname</li>
		<li>PATHINFO_BASENAME - return only basename</li>
		<li>PATHINFO_EXTENSION - return only extension</li>
	</ul>
	</td>
  </tr>
  </table>
...
<p><b>Note:</b> The pathinfo() function returns a string if not all elements are 
requested.</p>
<hr>
...
&lt;?php<br>
print_r(pathinfo(&quot;/testweb/test.txt&quot;,PATHINFO_BASENAME));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_pathinfo.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_pathinfo.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_pathinfo.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
