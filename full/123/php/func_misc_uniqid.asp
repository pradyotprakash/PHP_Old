...
<title>PHP uniqid() Function</title>
<style>a.menu_func_misc_uniqid{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">uniqid()</span> Function</h1>
...
<div class="example_code notranslate">
	&lt;?php<br>echo uniqid();<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_uniqid">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The uniqid() function generates a unique ID based on the microtime (current time in 
microseconds).</p>
<p><b>Note:</b> The generated ID from this function is not optimal, because it 
is based on the system time. To generate an extremely difficult to predict ID, 
use the <a href="func_string_md5.asp">md5()</a> function.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
uniqid(<em>prefix,more_entropy</em>)
</div></div><br>
<table class="reference notranslate">
  ...
  <tr>
    <td><em>prefix</em></td>
    <td>Optional. Specifies a prefix to the unique ID (useful if two scripts generate ids at exactly the same microsecond)</td>
  </tr>
  <tr>
    <td><em>more_entropy</em></td>
    <td>Optional. Specifies more entropy at the end of the 
...
<tr>
	...
	<td style="width:80%">Returns the unique identifier, as a string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>prefix</em> parameter became optional in PHP 5.0.<br><br>The 
	limit of 114 characters long for <em>prefix</em> was raised in PHP 4.3.1.</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_uniqid.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_uniqid.asp#top" target="_top">TOP</a> |
		<a href="func_misc_uniqid.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
