...
<style>a.menu_php_ajax_rss_reader{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP Example - <span class="color_h1">AJAX RSS Reader</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ajax_livesearch.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ajax_poll.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>The following example will demonstrate an RSS reader, where the RSS-feed is loaded into a webpage without reloading:</p>
<form> 
...
<p>When a user selects an RSS-feed in the dropdown list above, a function called &quot;showRSS()&quot; is executed. The 
...
&lt;/form&gt;<br>
&lt;br&gt;<br>
&lt;div id=&quot;rssOutput&quot;&gt;RSS-feed will be listed here...&lt;/div&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;
...
<p>The page on the server called by the JavaScript above is a PHP file called &quot;getrss.php&quot;:</p>
<div class="code notranslate"><div>
...
<p>When a request for an RSS feed is sent from the JavaScript, the following 
happens:</p>
<ul>
	<li>Check which feed was selected</li>
	<li>Create a new XML DOM object</li>
	<li>Load the RSS document in the xml variable</li>
	<li>Extract and output elements from the channel element</li>
	<li>Extract and output elements from the item elements</li>
</ul>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ajax_livesearch.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ajax_rss_reader.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ajax_rss_reader.asp#top" target="_top">TOP</a> |
		<a href="php_ajax_rss_reader.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
