...
<title>PHP fileperms() Function</title>
<style>a.menu_func_filesystem_fileperms{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fileperms()</span> Function</h1>
<hr>
...
<p>The fileperms() function returns the permissions for a file or directory.</p>
<p>This function returns the permission as a number on success or 
FALSE on failure.</p>
<h2>Syntax</h2>
...
<h2>Example 2</h2>
<p>Display permissions as an octal value:</p>

<div class="code notranslate"><div>

&lt;?php<br>
echo substr(sprintf(&quot;%o&quot;,fileperms(&quot;test.txt&quot;)),-4);<br>
?&gt; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fileperms.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fileperms.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fileperms.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
