...
<title>PHP uksort() Function</title>
<style>a.menu_func_array_uksort{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">uksort()</span> Function</h1>
...
<p>Sort the elements of the $arr array by keys using a user-defined comparison function:</p>
<div class="example_code notranslate">
&lt;?php<br>
	function my_sort($a,$b)<br>{<br>if ($a==$b) return 0;<br>return 
	($a&lt;$b)?-1:1;<br>}<br><br>$arr=array(&quot;a&quot;=&gt;4,&quot;b&quot;=&gt;2,&quot;c&quot;=&gt;8,d=&gt;&quot;6&quot;);<br>
	uksort($arr,&quot;my_sort&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_uksort">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The uksort() function sorts an array by keys using a user-defined  
	comparison function.</p>

<p><strong>Tip:</strong> Use the <a href="func_array_uasort.asp">uasort()</a> 
function to sort an array by values using a user-defined comparison function.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	uksort(<em>array,myfunction</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. A string that define a callable comparison function. The 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_uksort.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_uksort.asp#top" target="_top">TOP</a> |
		<a href="func_array_uksort.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
