...
<title>PHP rsort() Function</title>
<style>a.menu_func_array_rsort{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">rsort()</span> Function</h1>
...
<p>Sort the elements of the $cars array in descending alphabetical order:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$cars=array(&quot;Volvo&quot;,&quot;BMW&quot;,&quot;Toyota&quot;);<br>rsort($cars);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_rsort">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The rsort() function sorts an indexed array in descending order.</p>
<p><strong>Tip:</strong> Use the <a href="func_array_sort.asp">sort()</a> 
function to sort an indexed array in ascending order.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	rsort(<em>array,sortingtype</em>);
</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>array</em></td>
    <td>Required. Specifies the array to sort</td>
  </tr>
  <tr>
    <td><em>sortingtype</em></td>
    <td>Optional. Specifies how to compare the array elements/items. Possible values:
    <ul>
		<li>0 = SORT_REGULAR - Default. Compare items normally (don't change types)</li>
		<li>1 = SORT_NUMERIC - Compare items numerically</li>
		<li>2 = SORT_STRING - Compare items as strings</li>
		<li>3 = SORT_LOCALE_STRING - Compare items as strings, based on current locale</li>
		<li>4 = SORT_NATURAL - Compare items as strings using natural ordering</li>
		<li>5 = SORT_FLAG_CASE - </li>
	</ul>
    </td>
  </tr>
</table>
...
<p>Sort the elements of the $numbers array in descending numerical order:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$numbers=array(4,6,2,22,11);<br>rsort($numbers);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_rsort2">Run example &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example 2</h2>
<p>Compare the items numerically and sort the elements of the $cars array in descending order:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$cars=array(&quot;Volvo&quot;,&quot;BMW&quot;,&quot;Toyota&quot;);<br>rsort($cars,SORT_NUMERIC);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_rsort3">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_rsort.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_rsort.asp#top" target="_top">TOP</a> |
		<a href="func_array_rsort.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
