...
<title>PHP scandir() Function</title>
<style>a.menu_func_directory_scandir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">scandir()</span> Function</h1>
<p><a href="php_ref_directory.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Directory" /> PHP Directory Reference</a></p>
<div class="example">
<h2 class="example">Example</h2>
<p>List files and directories inside the images directory:</p>
<div class="example_code notranslate">
&lt;?php<br>$dir = &quot;/images/&quot;;<br><br>// Sort in ascending order - 
	this is default<br>$a = scandir($dir);<br><br>// Sort in descending order<br>$b = 
	scandir($dir,1);<br><br>print_r($a);<br>print_r($b);<br>?&gt;</div>
<p>Result:</p>
<div class="example_code notranslate">
	Array<br>(<br>[0] =&gt; .<br>[1] =&gt; ..<br>[2] =&gt; cat.gif<br>[3] =&gt; dog.gif<br>
	[4] =&gt; horse.gif<br>[5] =&gt; myimages<br>)<br>Array<br>(<br>[0] =&gt; myimages<br>[1] =&gt; horse.gif<br>[2] =&gt; 
	dog.gif<br>[3] =&gt; cat.gif<br>[4] =&gt; ..<br>[5] =&gt; .<br>) 
</div>
<br>
</div>
<hr>
...
<p>The scandir() function returns an array of files and directories of the specified directory.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	scandir(<em>directory,sorting_order,context</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the directory to be scanned</td>
  </tr>
  <tr>
    <td><em>sorting_order</em></td>
    <td>Optional. Specifies the sorting order. Default sort order is 
	alphabetical in ascending order (0). Set to SCANDIR_SORT_DESCENDING or 1 to sort in 
	alphabetical descending order, or SCANDIR_SORT_NONE to return the result 
	unsorted&nbsp; </td>
  </tr>
  <tr>
    <td><em>context</em></td>
    <td>Optional. Specifies the context of the directory handle. Context is a 
	set of options that can modify the behavior of a stream</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an array of files and directories on success. FALSE on 
	failure. Throws an error of level E_WARNING if directory is not a directory</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.0+</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 5.4: The sorting_order constants were added</td>
</tr>
</table>
<br>
<hr>

<a href="php_ref_directory.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Directory" /> PHP Directory Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_directory_scandir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_directory_scandir.asp#top" target="_top">TOP</a> |
		<a href="func_directory_scandir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
