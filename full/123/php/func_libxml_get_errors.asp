...
<title>PHP libxml_get_errors() Function</title>
<style>a.menu_func_libxml_get_errors{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">libxml_get_errors()</span> Function</h1>
<hr>
...
<p>The libxml_get_errors() function gets errors from the the libxml error buffer</p>
<p>This function returns an array of error objects, and an empty array if there 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_libxml_get_errors.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_libxml_get_errors.asp#top" target="_top">TOP</a> |
		<a href="func_libxml_get_errors.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
