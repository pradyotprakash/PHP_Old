...
<title>PHP jddayofweek() Function</title>
<style>a.menu_func_cal_jddayofweek{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">jddayofweek()</span> Function</h1>
...
<p>Return the weekday of 13th January, 1998:</p>
<div class="example_code notranslate">
&lt;?php<br>
$jd=gregoriantojd(1,13,1998);<br>echo jddayofweek($jd,1);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_jddayofweek">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The jddayofweek() function returns the day of the week.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
jddayofweek(<em>jd,mode);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>mode</em></td>
    <td>Optional. Specifies how to return the weekday. Can have one of the following values:
    <ul>
		<li>0 - Default. Returns the weekday as an integer (0=Sunday, 1=Monday, 
		etc.)</li>
		<li>1 - Returns the weekday as a string (Sunday, Monday, etc.)</li>
		<li>2 - Returns the weekday as a string, abbreviated form (Sun, Mon, 
		etc.)</li>
	</ul>
	  </td>
  </tr>
...
<tr>
	...
	<td style="width:80%">Returns the Gregorian weekday as a string or integer 
	(depends on the <em>mode</em> parameter)</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_jddayofweek.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_jddayofweek.asp#top" target="_top">TOP</a> |
		<a href="func_cal_jddayofweek.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
