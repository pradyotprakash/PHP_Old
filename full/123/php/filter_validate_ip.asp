...
<title>PHP FILTER_VALIDATE_IP Filter</title>
<style>a.menu_filter_validate_ip{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_VALIDATE_IP</span> Filter</h1>
<hr>
...
<p>The FILTER_VALIDATE_IP filter validates the value as an IP address.</p>
<ul>
	<li>Name: &quot;validate_ip&quot;</li>
	<li>ID-number: 275</li>
</ul>
<p>Possible&nbsp; flags:</p>
<ul>
	<li>FILTER_FLAG_IPV4 - Requires the value to be a valid IPv4 IP (like 
	255.255.255.255)</li>
	<li>FILTER_FLAG_IPV6 - Requires the value to be a valid IPv6 IP (like 
	2001:0db8:85a3:08d3:1319:8a2e:0370:7334)</li>
	<li>FILTER_FLAG_NO_PRIV_RANGE - Requires that the value is not within an RFC 
	specified private range IP (like 192.168.0.1)</li>
	<li>FILTER_FLAG_NO_RES_RANGE - Requires that the value is not within the 
	reserved IP range. This flag takes both IPV4 and IPV6 values</li>
</ul>
<hr>
<h2>Example 1</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_validate_ip.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_validate_ip.asp#top" target="_top">TOP</a> |
		<a href="filter_validate_ip.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
