...
<title>PHP FILTER_SANITIZE_URL Filter</title>
<style>a.menu_filter_sanitize_url{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_SANITIZE_URL</span> Filter</h1>
<hr>
...
<p>The FILTER_SANITIZE_URL filter removes all illegal URL characters from a 
string.</p>
...
&lt;?php<br>
$var=&quot;http://www.w3schooåøls.coøm&quot;;<br>
<br>
var_dump(filter_var($var, FILTER_SANITIZE_URL));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_sanitize_url.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_sanitize_url.asp#top" target="_top">TOP</a> |
		<a href="filter_sanitize_url.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
