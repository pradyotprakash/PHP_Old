...
<title>PHP zip_close() Function</title>
<style>a.menu_func_zip_close{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">zip_close()</span> Function</h1>
<hr>
...
<p>The zip_close() function closes a zip archive opened by the zip_open() 
function.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>zip</td>
    <td>Required. Specifies the zip resource to close (a zip file 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_zip_close.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_zip_close.asp#top" target="_top">TOP</a> |
		<a href="func_zip_close.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
