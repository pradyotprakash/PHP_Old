...
<title>PHP mysqli_autocommit() Function</title>
<style>a.menu_func_mysqli_autocommit{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_autocommit()</span> Function</h1>
...
<p>Turn off auto-committing, make some queries, then commit the queries:</p>
...
VALUES ('Glenn','Quagmire',33)&quot;);<br>
	<br>// Commit transaction<br>mysqli_commit($con);<br><br>// Close connection<br>
	mysqli_close($con);<br>?&gt;
</div>
</div>
<hr>
...
<p>The mysqli_autocommit() function turns on or off auto-committing database modifications.</p>
...
connection, and the <a href="func_mysqli_rollback.asp">mysqli_rollback()</a> 
function, which rolls back the current transaction.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_autocommit(<em>connection,mode</em>)<em>;</em></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>mode</em></td>
    <td>Required. FALSE turns auto-commit off. TRUE turns auto-commit on (and 
	commits any waiting queries)</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_autocommit.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_autocommit.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_autocommit.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
