...
<title>PHP fwrite() Function</title>
<style>a.menu_func_filesystem_fwrite{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fwrite()</span> Function</h1>
<hr>
...
<p>The fwrite() writes to an open file.</p>
<p>The function 
	will stop at the end of the file or when it reaches the specified length, whichever comes first.</p>
<p>This function returns the number of bytes written, or FALSE on failure.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fwrite.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fwrite.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fwrite.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
