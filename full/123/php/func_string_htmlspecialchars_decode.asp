...
<title>PHP htmlspecialchars_decode() Function</title>
<style>a.menu_func_string_htmlspecialchars_decode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">htmlspecialchars_decode()</span> Function</h1>
...
<p>Convert the predefined HTML entities &quot;&amp;lt;&quot; (less than) and &quot;&amp;gt;&quot; 
(greater than) to characters: </p>
<div class="example_code notranslate">
	&lt;?php<br>$str = &quot;This is some &amp;lt;b&amp;gt;bold&amp;lt;/b&amp;gt; text.&quot;;<br>echo htmlspecialchars_decode($str);<br>
	?&gt;</div>
...
<div class="example_code notranslate">
	...
	This is some <strong>bold</strong> text.</div>
<br>
</div>
<hr>
...
<p>The htmlspecialchars_decode() function converts some predefined HTML entities to 
characters.</p>
<p>HTML entities that will be decoded are:</p>
<ul>
	<li>&amp;amp; becomes &amp; (ampersand)</li>
	<li>&amp;quot; becomes &quot; (double quote)</li>
	<li>&amp;#039; becomes ' (single quote)</li>
	<li>&amp;lt; becomes &lt; (less than)</li>
	<li>&amp;gt; becomes &gt; (greater than)</li>
</ul>
<p>The htmlspecialchars_decode() function is the opposite of
<a href="func_string_htmlspecialchars.asp">htmlspecialchars()</a>.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

htmlspecialchars_decode(<em>string,flags</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to decode</td>
  </tr>
	<tr>
    <td><em>flags</em></td>
    <td>Optional. Specifies how to handle quotes and which document 
	type to use.<p>The available quote styles 
	are:</p>
	<ul>
		<li>ENT_COMPAT - Default. Decodes only double quotes</li>
		<li>ENT_QUOTES - Decodes double and single quotes</li>
		<li>ENT_NOQUOTES - Does not decode any quotes</li>
	</ul>
...
<tr>
	...
	<td style="width:80%">Returns the converted string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.1.0+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The additional flags for specifying the used doctype; ENT_HTML401, ENT_HTML5, 
	ENT_XML1 and ENT_XHTML were added in PHP 5.4<br></td>
</tr>
</table>
<br>
<hr>
...
<p>Convert some predefined HTML entities to characters: </p>
<div class="example_code notranslate">

&lt;?php<br>
$str = &quot;Jane &amp;amp; &amp;#039;Tarzan&amp;#039;&quot;;<br>
echo htmlspecialchars_decode($str, 
	ENT_COMPAT); // Will only convert double quotes<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo htmlspecialchars_decode($str, ENT_QUOTES); 
	// Converts double and single quotes<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo htmlspecialchars_decode($str, ENT_NOQUOTES); 
	// Does not convert any quotes<br>
?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
...
<p>Convert the predefined HTML entities to double quotes: </p>
<div class="example_code notranslate">
	&lt;?php<br>
	$str = 'I love &amp;quot;PHP&amp;quot;.';<br>echo htmlspecialchars_decode($str, ENT_QUOTES); 
	// Converts double and single quotes<br>
	?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="example_code notranslate">
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_htmlspecialchars_decode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_htmlspecialchars_decode.asp#top" target="_top">TOP</a> |
		<a href="func_string_htmlspecialchars_decode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
