...
<title>PHP mysqli_multi_query() Function</title>
<style>a.menu_func_mysqli_multi_query{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_multi_query()</span> Function</h1>
...
<p>Perform multiple queries against the database:</p>
...
&nbsp;&nbsp;}<br><br>$sql = &quot;SELECT Lastname FROM Persons ORDER BY LastName;&quot;;<br>
	$sql .= &quot;SELECT Country FROM Customers&quot;;<br><br>// Execute multi 
	query<br>if (mysqli_multi_query($con,$sql))<br>{<br>&nbsp; do<br>&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp; // Store first result set<br>&nbsp;&nbsp;&nbsp; if 
	($result=mysqli_store_result($con))<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	while ($row=mysqli_fetch_row($result))<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; printf(&quot;%s\n&quot;,$row[0]);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; mysqli_free_result($con);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; while (mysqli_next_result($con));<br>}<br><br>mysqli_close($con);<br>
?&gt;
</div>
</div>
<hr>
...
<p>The mysqli_multi_query() function performs one or more queries against the database. 
The queries are separated with a semicolon.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_multi_query(<em>connection,query</em>)<em>;</em></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>query</em></td>
    <td>Required. Specifies one or more queries, seperated with semicolon</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">FALSE if the first query fails</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_multi_query.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_multi_query.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_multi_query.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
