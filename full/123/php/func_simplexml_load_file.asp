...
<title>PHP simplexml_load_file() Function</title>
<style>a.menu_func_simplexml_load_file{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">simplexml_load_file()</span> Function</h1>
...
<p>Convert an XML file into a SimpleXMLElement object, then output keys and elements 
of the 
object:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$xml=simplexml_load_file(&quot;note.xml&quot;);<br>print_r($xml);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_load_file">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The simplexml_load_file() function converts the specified XML file into a SimpleXMLElement object.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
simplexml_load_file(<em>file,classname,options,ns,is_prefix</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>file</em></td>
    <td>Required. Specifies the path to the XML file</td>
  </tr>
	<tr>
...
<p>Output the data from each element in the XML file:</p>
<div class="example_code notranslate">
	&lt;?php<br>$xml=simplexml_load_file(&quot;note.xml&quot;);<br>echo $xml-&gt;to . &quot;&lt;br&gt;&quot;;<br>
	echo $xml-&gt;from . &quot;&lt;br&gt;&quot;;<br>echo $xml-&gt;heading . &quot;&lt;br&gt;&quot;;<br>echo 
	$xml-&gt;body;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_load_file2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Output the element's name and data for each child node in the XML file:</p>
<div class="example_code notranslate">
&lt;?php<br>
$xml=simplexml_load_file(&quot;note.xml&quot;);<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_load_file3">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_load_file.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_load_file.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_load_file.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
