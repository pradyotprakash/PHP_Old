...
<html lang="en-US">
<head>
<title>PHP 5 Array Functions</title>
<style>a.menu_php_ref_array{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Array</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_exam.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_calendar.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<h2>Installation</h2>
<p>The array functions are part of the PHP core. There is no installation 
needed to use these functions.</p>
<hr>

<h2>PHP 5 Array Functions&nbsp;</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Compare arrays, and returns the differences (compare keys and values, using a user-defined 
	key comparison function)</td>
  </tr>
  <tr>
    <td><a href="func_array_diff_ukey.asp">array_diff_ukey()</a></td>
    <td>Compare arrays, and returns the differences (compare keys only, using a 
	user-defined key comparison function)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Compare arrays, and returns the matches (compare keys and values, using a user-defined 
	key comparison function)</td>
  </tr>
  <tr>
    <td><a href="func_array_intersect_ukey.asp">array_intersect_ukey()</a></td>
    <td>Compare arrays, and returns the matches (compare keys only, using a 
	user-defined key comparison function)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Replaces the values of the first array with the values from following 
	arrays</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Compare arrays, and returns the differences (compare values only, using a user-defined 
	key comparison function)</td>
  </tr>
  <tr>
    <td><a href="func_array_udiff_assoc.asp">array_udiff_assoc()</td>
    <td>Compare arrays, and returns the differences (compare keys and values, using 
	a built-in function to compare the keys and a user-defined 
	function to compare the values)</td>
  </tr>
  <tr>
    <td><a href="func_array_udiff_uassoc.asp">array_udiff_uassoc()</a></td>
    <td>Compare arrays, and returns the differences (compare keys and values, using 
	two user-defined 
	key comparison functions)</td>
  </tr>
  <tr>
    <td><a href="func_array_uintersect.asp">array_uintersect()</a></td>
    <td>Compare arrays, and returns the matches (compare values only, using a user-defined 
	key comparison function)</td>
  </tr>
  <tr>
    <td><a href="func_array_uintersect_assoc.asp">array_uintersect_assoc()</a></td>
    <td>Compare arrays, and returns the matches (compare keys and values, using 
	a built-in function to compare the keys and a user-defined 
	function to compare the values)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Applies a user function recursively to every member of an 
	array</td>
  </tr>
  <tr>
    <td><a href="func_array_arsort.asp">arsort()</a></td>
    <td>Sorts an associative array in descending order, according 
	to the value</td>
  </tr>
  <tr>
    <td><a href="func_array_asort.asp">asort()</a></td>
    <td>Sorts an associative array in ascending order, according to 
	the value</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Imports variables into the current symbol table from an 
	array</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Sorts an array using a case insensitive &quot;natural order&quot; 
	algorithm</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Sorts an array using a user-defined  
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_array.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_array.asp#top" target="_top">TOP</a> |
		<a href="php_ref_array.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
