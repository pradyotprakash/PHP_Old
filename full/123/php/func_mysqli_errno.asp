...
<title>PHP mysqli_errno() Function</title>
<style>a.menu_func_mysqli_errno{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_errno()</span> Function</h1>
...
<p>Return the last error code for the most recent function call, if any:</p>
...
VALUES ('Glenn')&quot;))<br>&nbsp; {<br>&nbsp; echo(&quot;Errorcode: &quot; . 
	mysqli_errno($con));<br>&nbsp; }<br>
...
<p>The mysqli_errno() function returns the last error code for the most recent function call, if any.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_errno(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an error code value. Zero if no error 
	occurred</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_errno.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_errno.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_errno.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
