...
<html lang="en-US">
<head>
<title>PHP libxml Functions</title>
<style>a.menu_php_ref_libxml{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">libxml</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_http.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_mail.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP libxml Introduction</h2>
<p>The libxml functions and constants are used together with SimpleXML, XSLT and 
DOM functions.</p>
<hr>

<h2>Installation</h2>
<p>These functions require the libxml package. 
<a target="_blank" href="http://www.xmlsoft.org/downloads.html">Download at xmlsoft.org</a></p>
<hr>

<h2>PHP libxml Functions</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="func_libxml_clear_errors.asp">libxml_clear_errors()</a></td>
    <td>Clear libxml error buffer</td>
    <td>5</td>
  </tr>
  <tr>
    <td><a href="func_libxml_get_errors.asp">libxml_get_errors()</a></td>
    <td>Retrieve array of errors</td>
    <td>5</td>
  </tr>
  <tr>
    <td><a href="func_libxml_get_last_error.asp">libxml_get_last_error()</a></td>
    <td>Retrieve last error from libxml</td>
    <td>5</td>
  </tr>
  <tr>
    <td>libxml_set_streams_context()</td>
    <td>Set the streams context for the next libxml document load 
	or write</td>
    <td>5</td>
  </tr>
  <tr>
    <td><a href="func_libxml_use_internal_errors.asp">libxml_use_internal_errors()</a></td>
    <td>Disable libxml errors and allow user to fetch error 
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Set small nodes allocation optimization. This may improve 
  ...
  <tr>
    ...
    <td>Change empty tags (e.g. &lt;br/&gt; to &lt;br&gt;&lt;/br&gt;), 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_libxml.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_libxml.asp#top" target="_top">TOP</a> |
		<a href="php_ref_libxml.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
