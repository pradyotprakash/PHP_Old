...
<title>PHP vfprintf() Function</title>
<style>a.menu_func_string_vfprintf{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">vfprintf()</span> Function</h1>
...
<p>Write some text to a text file named &quot;test.txt&quot;:</p>
<div class="example_code notranslate">

	&lt;?php<br>$number = 9;<br>$str = &quot;Beijing&quot;;<br>$file = fopen(&quot;test.txt&quot;,&quot;w&quot;);<br>
	echo vfprintf($file,&quot;There are %u million bicycles in %s.&quot;,array($number,$str));<br>
	?&gt;</div>
<p>The output of the code above will be:</p>
<div class="example_code notranslate">
	40
</div>
<p>The following text will be written to the file "test.txt":</p>
<div class="example_code notranslate">

	There are 9 million bicycles in Beijing.</div>
<br>
</div>
<hr>
...
<p>The vfprintf() function writes a formatted string to a 
specified output stream (example: file or database).</p>
<p>Unlike fprintf(), the arguments in vfprintf(), are placed in an array. The 
...
<p><b>Tip:</b> Related functions: <a href="func_string_fprintf.asp">fprintf()</a>, 
<a href="func_string_printf.asp">printf()</a>, <a href="func_string_sprintf.asp">
sprintf()</a>, <a href="func_string_vprintf.asp">vprintf()</a> and
<a href="func_string_vsprintf.asp">vsprintf()</a>.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

vfprintf(<em>stream,format,argarray</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>stream</em></td>
    <td>Required. Specifies where to write/output the string</td>
  </tr>
  <tr>
    <td><em>format</em></td>
...
<tr>
	...
	<td style="width:80%">Returns the length of the written string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
vfprintf($file,&quot;%f%f&quot;,array($num1,$num2));<br>
?&gt;</div>
<p>The following text will be written to the file &quot;test.txt&quot;:</p>
<div class="example_code notranslate">

123.000000456.000000</div>
</div>
<br>
...
$number = 123;<br>
$file = fopen(&quot;test.txt&quot;,&quot;w&quot;);<br>
vfprintf($file,&quot;With 2 decimals: %1\$.2f<br>
\nWith no decimals: %1\$u&quot;,array($number));<br>
?&gt;</div>
<p>The following text will be written to the file &quot;test.txt&quot;:</p>
<div class="example_code notranslate">

With 2 decimals: 123.00<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_vfprintf.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_vfprintf.asp#top" target="_top">TOP</a> |
		<a href="func_string_vfprintf.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
