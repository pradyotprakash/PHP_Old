...
<title>PHP xml_set_character_data_handler() Function</title>
<style>a.menu_func_xml_set_character_data_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_set_character_data_handler()</span> Function</h1>
<hr>
...
<p>The xml_set_character_data_handler() function sets the character data handler 
for the XML parser.</p>
<p>This function specifies what function to be called when the parser finds 
character data in the XML file.</p>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	<tr>
    <td>data</td>
    <td>Required. Specifies a variable containing the character data 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_set_character_data_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_set_character_data_handler.asp#top" target="_top">TOP</a> |
		<a href="func_xml_set_character_data_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
