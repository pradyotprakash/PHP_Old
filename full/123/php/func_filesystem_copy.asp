...
<title>PHP copy() Function</title>
<style>a.menu_func_filesystem_copy{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">copy()</span> Function</h1>
<hr>
...
<p>The copy() function copies a file.</p>

<p>This function returns TRUE on success and FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the file to copy</td>
  </tr>
  <tr>
    <td>to_file</td>
    <td>Required. Specifies the file to copy to</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_copy.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_copy.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_copy.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
