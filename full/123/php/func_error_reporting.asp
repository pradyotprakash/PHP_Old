...
<style>a.menu_func_error_reporting{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">error_reporting()</span> Function</h1>
<hr>
...
<p>The error_reporting() function specifies which errors are reported.</p>
<p>This function sets which errors are reported for the duration of the current 
script.</p>
<p>This funtion returns the old error_reporting level.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>report_level</td>
    <td>Optional. Specifies the error report level for the current 
	script. Value number and constant name are accepted, however, constant names 
	are recommended for compatibility for future PHP versions</td>
  </tr>
	</table>
<h2>Report levels</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td>1</td>
    <td>E_ERROR</td>
    <td>Fatal run-time errors. Errors that can not be recovered 
  ...
  <tr>
    ...
    <td>4</td>
    <td>E_PARSE</td>
    <td>Compile-time parse errors. Parse errors should only be 
  ...
  <tr>
    <td>16</td>
    <td>E_CORE_ERROR</td>
    <td>Fatal errors at PHP startup. This is like an E_ERROR in the 
	PHP core</td>
  </tr>
  <tr>
    <td>32</td>
    <td>E_CORE_WARNING</td>
    <td>Non-fatal errors at PHP startup. This is like an E_WARNING 
	in the PHP core</td>
  </tr>
  <tr>
    <td>64</td>
    <td>E_COMPILE_ERROR</td>
    <td>Fatal compile-time errors. This is like an E_ERROR 
	generated by the Zend Scripting Engine</td>
  </tr>
  <tr>
    <td>128</td>
    <td>E_COMPILE_WARNING</td>
    <td>Non-fatal compile-time errors. This is like an E_WARNING 
	generated by the Zend Scripting Engine</td>
  </tr>
  <tr>
    <td>256</td>
  ...
  <tr>
    ...
    <td>Non-fatal user-generated warning. This is like an E_WARNING 
  ...
  <tr>
    <td>2048</td>
    <td>E_STRICT</td>
    <td>Run-time notices. PHP suggest changes to your code to help 
  ...
  <tr>
    <td>8191</td>
    <td>E_ALL</td>
    <td>All errors and warnings, except level E_STRICT (E_STRICT 
...
<br>
//Report runtime errors<br>
error_reporting(E_ERROR | E_WARNING | E_PARSE);<br>
<br>
//Report all errors<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_error_reporting.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_error_reporting.asp#top" target="_top">TOP</a> |
		<a href="func_error_reporting.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
