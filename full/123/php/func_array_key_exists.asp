...
<title>PHP array_key_exists() Function</title>
<style>a.menu_func_array_key_exists{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_key_exists()</span> Function</h1>
...
<p>Check if the key &quot;Volvo&quot; exists in an array:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a=array(&quot;Volvo&quot;=&gt;&quot;XC90&quot;,&quot;BMW&quot;=&gt;&quot;X5&quot;);<br>if (array_key_exists(&quot;Volvo&quot;,$a))<br>&nbsp; 
	{<br>&nbsp; echo &quot;Key exists!&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; 
	echo &quot;Key does not exist!&quot;;<br>&nbsp; }<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_key_exists">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_key_exists() function checks an array for a specified key,
and returns true if the key exists and false if the key does not exist.</p>
<p><b>Tip:</b> Remember that if you skip the key when you specify an array,
an integer key is generated, 
starting at 0 and increases by 1 for each value. (See example 2)</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

array_key_exists(<em>key,array</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>key</em></td>
    <td>Required. Specifies the key</td>
  </tr>
  <tr>
    <td><em>array</em></td>
...
<tr>
	<th>Return Value:</th>
	<td>Returns TRUE if the key exists and 
	FALSE if the key does not exist</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.7+</td>
...
<p>Check if the key &quot;Toyota&quot; exists in an array:</p>
<div class="example_code notranslate">

&lt;?php<br>
	$a=array(&quot;Volvo&quot;=&gt;&quot;XC90&quot;,&quot;BMW&quot;=&gt;&quot;X5&quot;);<br>if (key_exists(&quot;Toyota&quot;,$a))<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo &quot;Key exists!&quot;;<br>
&nbsp;&nbsp;}<br>
else<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_key_exists2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Check if the integer key &quot;0&quot; exists in an array:</p>
<div class="example_code notranslate">

&lt;?php<br>
$a=array(&quot;Volvo&quot;,&quot;BMW&quot;);<br>
if (array_key_exists(0,$a))<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo &quot;Key exists!&quot;;<br>
&nbsp;&nbsp;}<br>
else<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_key_exists3">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_key_exists.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_key_exists.asp#top" target="_top">TOP</a> |
		<a href="func_array_key_exists.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
