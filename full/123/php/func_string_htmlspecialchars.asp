...
<title>PHP htmlspecialchars() Function</title>
<style>a.menu_func_string_htmlspecialchars{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">htmlspecialchars()</span> Function</h1>
...
<p>Convert the predefined characters &quot;&lt;&quot; (less than) and &quot;&gt;&quot; (greater than) to HTML entities: </p>
<div class="example_code notranslate">
	&lt;?php<br>$str = &quot;This is some &lt;b&gt;bold&lt;/b&gt; text.&quot;;<br>echo htmlspecialchars($str);<br>
	?&gt;</div>
...
<div class="example_code notranslate">
	...
	This is some &lt;b&gt;bold&lt;/b&gt; text.</div>
<br>
<a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_htmlspecialchars">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The htmlspecialchars() function converts some predefined characters to HTML entities.</p>
...
<p><strong>Tip:</strong> To convert special HTML entities back to characters, 
use the <a href="func_string_htmlspecialchars_decode.asp">
...
htmlspecialchars(<em>string,flags,character-set,double_encode</em>)
...
<p>Convert some predefined characters to HTML entities: </p>
<div class="example_code notranslate">
	&lt;?php<br>
$str = &quot;Jane &amp; 'Tarzan'&quot;;<br>
echo htmlspecialchars($str, ENT_COMPAT); // Will only convert double quotes<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo htmlspecialchars($str, ENT_QUOTES); // Converts double and single quotes<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo htmlspecialchars($str, ENT_NOQUOTES); // Does not convert any quotes<br>
	?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
...
<br>
<a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_htmlspecialchars2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Convert double quotes to HTML entities: </p>
<div class="example_code notranslate">
	&lt;?php<br>
	$str = 'I love &quot;PHP&quot;.';<br>echo htmlspecialchars($str, ENT_QUOTES); 
	// Converts double and single quotes<br>
	?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
...
<div class="example_code notranslate">
	...
	I love &quot;PHP&quot;.</div>
<br>
<a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_htmlspecialchars3">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_htmlspecialchars.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_htmlspecialchars.asp#top" target="_top">TOP</a> |
		<a href="func_string_htmlspecialchars.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
