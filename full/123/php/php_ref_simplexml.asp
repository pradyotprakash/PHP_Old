...
<style>a.menu_php_ref_simplexml{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">SimpleXML</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_mysqli.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_string.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP SimpleXML Introduction</h2>
<p>The SimpleXML extension provides is a simple way of getting an XML element's 
name and text, if you 
know the XML document's layout.</p>
<p>SimpleXML converts an XML document into a SimpleXMLElement object.</p>
<p>This object can then be processed, like any other object, with normal property 
selectors and array iterators.</p>
<p><strong>Tip:</strong> Compared to DOM or the Expat parser, SimpleXML just takes a few lines of code 
to read text data from an element. </p>
<hr>

<h2>Installation</h2>
<p>The SimpleXML extension requires PHP 5.</p>
<p>As of PHP 5, the SimpleXML functions are part of the PHP core. No installation is required to use these functions.</p>
<hr>

<h2>PHP 5 SimpleXML Functions</h2>
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Formats the SimpleXML object's data in XML (version 1.0)</td>
  </tr>
  <tr>
    <td><a href="func_simplexml_attributes.asp">attributes()</a></td>
    <td>Returns attributes and values within an XML tag</td>
  </tr>
  <tr>
    <td><a href="func_simplexml_children.asp">children()</a></td>
    <td>Finds the children of a specified node</td>
  </tr>
  <tr>
    <td><a href="func_simplexml_count.asp">count()</a></td>
  ...
  <tr>
    ...
    <td>Returns the name of the XML tag referenced by the SimpleXML element</td>
  </tr>
  <tr>
	...
	<tr>
    <td><a href="func_simplexml_asxml.asp">saveXML()</a></td>
    <td>Alias of <a href="func_simplexml_asxml.asp">asXML()</a></td>
  </tr>
	<tr>
    ...
    <td>Converts an XML file into a SimpleXMLElement object</td>
  </tr>
	<tr>
    <td><a href="func_simplexml_load_string.asp">simplexml_load_string()</a></td>
    <td>Converts an XML string into a SimpleXMLElement object</td>
  </tr>
	<tr>
...
<h2>PHP 5 SimpleXML Iteration Functions</h2>
<table class="reference notranslate">
  <tr>
    <th style="width:30%">Function</th>
    <th style="width:70%">Description</th>
  ...
  <tr>
    <td>hasChildren()</td>
    <td>Cheks whether the current element has children</td>
  </tr>
  <tr>
    <td>key()</td>
    <td>Return the current key</td>
  </tr>
  <tr>
    <td>next()</td>
  ...
  <tr>
    <td>rewind()</td>
    <td>Rewind to the first element</td>
  </tr>
  <tr>
    <td>valid()</td>
    <td>Check whether the current element is valid</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_simplexml.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_simplexml.asp#top" target="_top">TOP</a> |
		<a href="php_ref_simplexml.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
