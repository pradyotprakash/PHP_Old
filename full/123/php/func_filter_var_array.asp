...
<title>PHP filter_var_array() Function</title>
<style>a.menu_func_filter_var_array{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filter_var_array()</span> Function</h1>
<hr>
...
<p>The filter_var_array() function gets multiple variables and optionally 
filters them</p>

<p>This function is useful for filtering many values without calling filter_var() 
over and over.</p>
<p>Returns an array of values of the requested variables on success or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
	...
	<tr>
		<td>array</td>
		<td>Required. Specifies an array with string keys 
		containing the data to filter</td>
	</tr>
	<tr>
		<td>args</td>
...
Reference</a> for possible filters to use with this function.</p>
<hr>
<h2>Example</h2>
...
&nbsp;&nbsp;);<br>
<br>
print_r(filter_var_array($arr, $filters));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filter_var_array.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filter_var_array.asp#top" target="_top">TOP</a> |
		<a href="func_filter_var_array.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
