...
<style>a.menu_php_mysql_intro{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">MySQL Introduction</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_filter.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_mysql_connect.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">With PHP, you can connect to and manipulate databases.</p>
<p class="intro">MySQL is the most popular database system used with PHP.</p>
...
<p>The data in MySQL is stored in tables. A table is a collection of related data, and it consists of columns 
and rows.</p>
<p>Databases are useful when storing information categorically. A company may 
...
<p>If you don't have a PHP server with a MySQL Database, you can download MySQL 
...
<p>One great thing about MySQL is that it can be scaled down to support embedded 
database applications. Maybe it is because of this many people 
think that MySQL can only handle small and medium-sized systems.</p>
<p>The truth is that MySQL is the de-facto standard database system for web sites 
with HUGE volumes of both data and end users (like Friendster, Yahoo, 
and Google).</p>
<p>Look at <a target="_blank" href="http://www.mysql.com/customers/">
http://www.mysql.com/customers/</a> for an overview of companies using 
MySQL.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_filter.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_mysql_intro.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_mysql_intro.asp#top" target="_top">TOP</a> |
		<a href="php_mysql_intro.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
