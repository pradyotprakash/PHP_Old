...
<title>PHP stripos() Function</title>
<style>a.menu_func_string_stripos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">stripos()</span> Function</h1>
...
<p>Find the position of the first occurrence of &quot;php&quot; inside the 
string:</p>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_stripos">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The stripos() function finds the position of the first occurrence of a 
string inside another string.</p>
<p><b>Note:</b> The stripos() function is case-insensitive.</p>
...
stripos(<em>string,find,start</em>)
...
<tr>
	...
	<td style="width:80%">Returns the position of the first occurrence of a string 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_stripos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_stripos.asp#top" target="_top">TOP</a> |
		<a href="func_string_stripos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
