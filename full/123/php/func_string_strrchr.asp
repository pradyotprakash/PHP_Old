...
<style>a.menu_func_string_strrchr{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strrchr()</span> Function</h1>
...
<h2 class="example">Example</h2>
	<p>Search a string for &quot;world&quot;, and return 
	all characters from this position to the end of the string:</p>
<div class="example_code notranslate">

&lt;?php<br>
echo strrchr(&quot;Hello world!&quot;,&quot;world&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strrchr">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strrchr() function finds the position of the last occurrence of a string 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>char</em></td>
    <td>Required. Specifies the string to find. If this  
...
<tr>
	...
	<td style="width:80%">Returns all characters from the last occurrence of a string 
	within another string, to the end of the main string, or FALSE if the 
	character is not found</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>Search a string for &quot;What&quot;, and return all characters from this position to the 
end of the string:</p>
<div class="example_code notranslate">
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strrchr2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Search a string for the ASCII value of &quot;e&quot; (101) and return all 
characters from this position to the end of the string: </p>
<div class="example_code notranslate">

	&lt;?php<br>
echo strrchr(&quot;Hello world!&quot;,101);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strrchr3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strrchr.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strrchr.asp#top" target="_top">TOP</a> |
		<a href="func_string_strrchr.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
