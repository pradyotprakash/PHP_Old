...
<style>a.menu_func_mysqli_data_seek{font-weight:bold;}</style>
<meta charset="utf-8">
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	<br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; // Seek to 
	row number 15<br>&nbsp; mysqli_data_seek($result,14);<br><br>&nbsp; // Fetch 
	row<br>&nbsp; $row=mysqli_fetch_row($result);<br><br>&nbsp; printf 
	(&quot;Lastname: %s Age: %s\n&quot;, $row[0], $row[1]);<br><br>&nbsp; // Free result 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>offset</em></td>
    <td>Required. Specifies the field offset. Must be between 0 and the total 
	number of rows - 1</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_data_seek.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_data_seek.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_data_seek.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
