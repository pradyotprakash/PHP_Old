...
<title>PHP mysqli_get_client_stats() Function</title>
<style>a.menu_func_mysqli_get_client_stats{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_get_client_stats()</span> Function</h1>
...
<p>Return stats about client per-process:</p>
...
&nbsp;&nbsp;}<br><br>print_r(mysqli_get_client_stats());<br>
...
<p>The mysqli_get_client_stats() function returns statistics about client per-process.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_get_client_stats()<em>;</em></div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td style="width:80%">Returns an array with client stats on success. FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_get_client_stats.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_get_client_stats.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_get_client_stats.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
