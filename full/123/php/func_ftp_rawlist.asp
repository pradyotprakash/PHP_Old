...
<title>PHP ftp_rawlist() Function</title>
<style>a.menu_func_ftp_rawlist{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_rawlist()</span> Function</h1>
...
<p>Get list of files with file information:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// get the file 
	list for /<br>$filelist = ftp_rawlist($ftp_conn, &quot;/&quot;);<br><br>// close connection<br>ftp_close($ftp_conn);<br>
	<br>// output $filelist<br>var_dump($filelist);<br>?&gt;
</div>
...
{<br>
[0] =&gt; 
	string(57) &quot;drw-rw-rw- 1 user group 0 Jan 03 08:33 images&quot;<br>
[1] =&gt; string(62) &quot;-rw-rw-rw- 1 user group 160 Feb 16 13:54 php&quot;<br>
[2] =&gt; string(75) &quot;-rw-rw-rw- 1 user group 20 Feb 14 12:22 test&quot;<br>
} 
</div>
</div>
<hr>
...
<p>The ftp_rawlist() function returns a list of files with file information 
(from a specified directory on the FTP server).</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_rawlist(<em>ftp_connection,dir,recursive</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>dir</em></td>
    <td>Required. Specifies the directory path. May include arguments for the 
	LIST command. <strong>Tip:</strong> Use &quot;.&quot; to specify the 
	current directory</td>
  </tr>
  <tr>
    <td><em>recursive</em></td>
    <td>Optional. By default, this function sends a &quot;LIST&quot; command to the 
	server. However, if the recursive parameter is set to TRUE, it sends a &quot;LIST 
	-R&quot; command</td>
  </tr>
</table>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an array where each element corresponds to one 
	line of text. No parsing is performed</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>The <em>recursive</em> parameter was added in PHP 4.3</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_rawlist.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_rawlist.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_rawlist.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
