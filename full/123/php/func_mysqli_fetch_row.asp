...
<title>PHP mysqli_fetch_row() Function</title>
<style>a.menu_func_mysqli_fetch_row{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_fetch_row()</span> Function</h1>
...
<p>Fetch rows from a result-set:</p>
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	<br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; // Fetch one 
	and one row<br>&nbsp; while ($row=mysqli_fetch_row($result))<br>&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp; printf (&quot;%s (%s)\n&quot;,$row[0],$row[1]);<br>&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp; // Free result 
...
<p>The mysqli_fetch_row() function fetches one row from a result-set and returns it as an enumerated array.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_fetch_row(<em>result</em>)<em>;</em></div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_fetch_row.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_fetch_row.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_fetch_row.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
