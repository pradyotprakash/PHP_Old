...
<style>a.menu_func_string_str_ireplace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">str_ireplace()</span> Function</h1>
...
<p>Replace the characters &quot;WORLD&quot; (case-insensitive) in the string &quot;Hello world!&quot; with &quot;Peter&quot;:</p>
<div class="example_code notranslate">

&lt;?php<br>
echo str_ireplace(&quot;WORLD&quot;,&quot;Peter&quot;,&quot;Hello world!&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_ireplace">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The str_ireplace() function replaces some characters with some other 
...
<ul>
	...
	<li>If the string to be searched is an array, find and replace is performed with every 
	array element</li>
	<li>If both find and replace are arrays, and replace has fewer elements than 
	find, an empty string will be used as replace</li>
	<li>If find is an array and replace is a string, the replace string will 
	be used for every find value</li>
</ul>
<p><b>Note: </b>This function is case-insensitive. Use the
<a href="func_string_str_replace.asp">str_replace()</a> function to perform 
a case-sensitive search.</p>
...
str_ireplace(<em>find,replace,string,count</em>)
...
<tr>
	<th>Changelog:</th>
	<td>The <em>count</em> parameter was added in PHP 5.0</td>
</tr>
</table>
<br>
<hr>
...
<p>Using str_replace() with an array and a count 
variable:</p>
<div class="example_code notranslate">
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_ireplace2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Using str_replace() with  
less elements in replace than find:</p>
<div class="example_code notranslate">

	&lt;?php<br>
$find = array(&quot;HELLO&quot;,&quot;WORLD&quot;); // This function is 
	case-insensitive<br>
$replace = array(&quot;B&quot;);<br>
$arr = array(&quot;Hello&quot;,&quot;world&quot;,&quot;!&quot;);<br>
print_r(str_ireplace($find,$replace,$arr));<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_ireplace3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_str_ireplace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_str_ireplace.asp#top" target="_top">TOP</a> |
		<a href="func_string_str_ireplace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
