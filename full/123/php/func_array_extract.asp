...
<title>PHP extract() Function</title>
<style>a.menu_func_array_extract{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">extract()</span> Function</h1>
...
<p>Assign the values &quot;Cat&quot;, &quot;Dog&quot; and &quot;Horse&quot; to the variables $a, $b and $c:</p>
<div class="example_code notranslate">
&lt;?php<br>
$a = &quot;Original&quot;;<br>
$my_array = array(&quot;a&quot; =&gt; &quot;Cat&quot;,&quot;b&quot; =&gt; &quot;Dog&quot;, &quot;c&quot; =&gt; &quot;Horse&quot;);<br>
extract($my_array);<br>
echo &quot;\$a = $a; \$b = $b; \$c = $c&quot;;<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_extract">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The extract() function imports variables into the local symbol table from an 
array.</p>
<p>This function uses array keys as variable names and values as variable 
values. For each element it will create a variable in the current symbol table. </p>
<p>This function returns the number of variables extracted on success.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
extract(<em>array,extract_rules,prefix</em>)
</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>array</em></td>
    <td>Required. Specifies the array to use</td>
  </tr>
  <tr>
    <td><em>extract_rules</em></td>
    <td>Optional. The extract() function checks for invalid 
	variable names and collisions with existing variable names. This parameter 
	specifies how invalid and colliding names are treated.<p>Possible values:</p>
	<ul>
		<li>EXTR_OVERWRITE - Default. On collision, the existing variable is 
		overwritten</li>
		<li>EXTR_SKIP - On collision, the existing variable is not overwritten</li>
		<li>EXTR_PREFIX_SAME - On collision, the variable name will be given a 
		prefix</li>
		<li>EXTR_PREFIX_ALL - All variable names will be given a prefix</li>
		<li>EXTR_PREFIX_INVALID - Only invalid or numeric variable names will be 
		given a prefix</li>
		<li>EXTR_IF_EXISTS - Only overwrite existing variables in the current 
		symbol table, otherwise do nothing</li>
		<li>EXTR_PREFIX_IF_EXISTS - Only add prefix to variables if the same 
		variable exists in the current symbol table</li>
		<li>EXTR_REFS - Extracts variables as references. The imported variables 
		are still referencing the values of the array parameter</li>
	</ul>
    </td>
  </tr>
  <tr>
    <td><em>prefix</em></td>
    <td>Optional. If EXTR_PREFIX_SAME, EXTR_PREFIX_ALL, 
	EXTR_PREFIX_INVALID or EXTR_PREFIX_IF_EXISTS are used in the extract_rules 
	parameter, a specified prefix is required.
    <br><br>This parameter specifies the prefix. The prefix is automatically 
	separated from the array key by an underscore character.</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns&nbsp; the number of variables extracted on success</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>extract_rules</em> value EXTR_REFS was added in PHP 4.3.<br><br>
	The <em>extract_rules</em> values EXTR_IF_EXISTS and EXTR_PREFIX_IF_EXISTS 
	were added in PHP 4.2.<br><br>As of PHP 4.0.5, this function now returns the 
	number of variables extracted.<br><br>The<em> extract_rules</em> value 
	EXTR_PREFIX_INVALID was added in PHP 4.0.5.<br><br>As of PHP 4.0.5, the <em>
	extract_rules</em> value EXTR_PREFIX_ALL now includes numeric variables as 
	well.</td>
</tr>
</table>
<br>
...
<p>Using all parameters:</p>
<div class="example_code notranslate">
&lt;?php<br>
$a = &quot;Original&quot;;<br>
$my_array = array(&quot;a&quot; =&gt; &quot;Cat&quot;, &quot;b&quot; =&gt; &quot;Dog&quot;, &quot;c&quot; =&gt; &quot;Horse&quot;);<br>
<br>
extract($my_array, EXTR_PREFIX_SAME, &quot;dup&quot;);<br>
<br>
echo &quot;\$a = $a; \$b = $b; \$c = $c; \$dup_a = $dup_a&quot;;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_extract2">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_extract.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_extract.asp#top" target="_top">TOP</a> |
		<a href="func_array_extract.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
