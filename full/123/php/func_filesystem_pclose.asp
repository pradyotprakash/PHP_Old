...
<title>PHP pclose() Function</title>
<style>a.menu_func_filesystem_pclose{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">pclose()</span> Function</h1>
<hr>
...
<p>The pclose() function closes a pipe opened by popen().</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>pipe</td>
    <td>Required. Specifies the pipe opened by popen()</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_pclose.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_pclose.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_pclose.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
