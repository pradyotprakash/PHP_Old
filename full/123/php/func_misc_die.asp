...
<title>PHP die() Function</title>
<style>a.menu_func_misc_die{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">die()</span> Function</h1>
...
<p>Print a message and exit the current script:</p>
<div class="example_code notranslate">

&lt;?php<br>$site = &quot;http://www.w3schools.com/&quot;;<br>
fopen($site,&quot;r&quot;)<br>
or die(&quot;Unable to connect to $site&quot;);<br>
?&gt;</div>
<br>
</div>
<hr>
...
<p>The die() function prints a message and exits the current script.</p>
<p>This function is an alias of the <a href="func_misc_exit.asp">exit()</a> function.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>message</em></td>
    <td>Required. Specifies the message or status number to write before exiting 
	the script.
	The status number will not be written to the output.</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_die.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_die.asp#top" target="_top">TOP</a> |
		<a href="func_misc_die.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
