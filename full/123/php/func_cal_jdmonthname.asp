...
<title>PHP jdmonthname() Function</title>
<style>a.menu_func_cal_jdmonthname{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">jdmonthname()</span> Function</h1>
...
<p>Return the abbreviated Gregorian monthname of 13th January, 1998:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$jd=gregoriantojd(1,13,1998);<br>echo jdmonthname($jd,0);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_jdmonthname">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The jdmonthname() function returns a month name.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	jdmonthname(<em>jd,mode);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>jd</em></td>
    <td>Required. A Julian Day number</td>
  </tr>
  <tr>
    <td><em>mode</em></td>
    <td>Optional. Specifies which calendar to convert the Julian Day 
	Count to, and how the month name is to be returned. Mode values:
	<ul>
		<li>0 - Gregorian - abbreviated form (Jan, Feb, Mar, etc.)</li>
		<li>1 - Gregorian (January, February, March, etc.)</li>
		<li>2 - Julian - abbreviated form (Jan, Feb, Mar, etc.)</li>
		<li>3 - Julian (January, February, March, etc.)</li>
		<li>4 - Jewish (Tishri, Heshvan, Kislev, etc.)</li>
		<li>5 - French Republican (Vendemiaire, Brumaire, Frimaire, etc.)</li>
	</ul>
	  </td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the month name for the specified Julian Day and <em>
	calendar</em></td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_jdmonthname.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_jdmonthname.asp#top" target="_top">TOP</a> |
		<a href="func_cal_jdmonthname.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
