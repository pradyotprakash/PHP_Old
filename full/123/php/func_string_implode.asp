...
<style>a.menu_func_string_implode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">implode()</span> Function</h1>
...
echo implode(&quot; &quot;,$arr);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_implode">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The implode() function returns a string from the elements of an array.</p>
<p><b>Note:</b> The implode() function accept its parameters in either order. However, for consistency with 
<a href="func_string_explode.asp">explode()</a>, 
you should use the documented order of arguments.</p>
<p><b>Note:</b> The separator parameter of implode() is optional. However, it is recommended to
always use two parameters for backwards compatibility.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies what to put between the array elements. 
	Default is &quot;&quot; (an empty string)</td>
  </tr>
  <tr>
    <td><em>array</em></td>
    <td>Required. The array to join to a string</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a string from elements of an array</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>separator</em> parameter became optional in PHP 4.3.0</td>
</tr>
</table>
<br>
<hr>
...
<p>Separate the array elements with different characters:</p>
<div class="example_code notranslate">

	&lt;?php<br>$arr = array('Hello','World!','Beautiful','Day!');<br>echo 
	implode(&quot; 
	&quot;,$arr).&quot;&lt;br&gt;&quot;;<br>echo implode(&quot;+&quot;,$arr).&quot;&lt;br&gt;&quot;;<br>echo 
	implode(&quot;-&quot;,$arr).&quot;&lt;br&gt;&quot;;
	<br>echo implode(&quot;X&quot;,$arr);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_implode2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_implode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_implode.asp#top" target="_top">TOP</a> |
		<a href="func_string_implode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
