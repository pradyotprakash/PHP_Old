...
<title>PHP crc32() Function</title>
<style>a.menu_func_string_crc32{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">crc32()</span> Function</h1>
...
<p>Print the result of crc32():</p>
<div class="example_code notranslate">

	&lt;?php<br>$str = crc32(&quot;Hello World!&quot;);<br>printf(&quot;%u\n&quot;,$str);<br>?&gt;

</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_crc32">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The crc32() function calculates a 32-bit CRC (cyclic redundancy checksum) for 
a string.</p>
<p>This function can be used to validate data integrity.</p>
<p><b>Tip:</b> To ensure that you get the correct string 
...
may display in incorrect and negative numbers.</p>
<hr>
<h2>Syntax</h2>
...
<tr>
	...
	<td style="width:80%">Returns the crc32 checksum of <em>string</em> as an integer</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.1+</td>
...
<p>In this example we will print the result of crc32() with and without the &quot;%u&quot; 
formatter (note that the result is equal):</p>

<div class="code notranslate"><div>

&lt;?php<br>
$str = crc32(&quot;Hello world!&quot;);<br>
echo 'Without %u: '.$str.&quot;&lt;br&gt;&quot;;<br>
echo 'With %u: ';<br>
printf(&quot;%u&quot;,$str);<br>
?&gt;
...
<p>In this example we will print the result of crc32() with and without the &quot;%u&quot; 
formatter (note that the result is not equal):</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_crc32.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_crc32.asp#top" target="_top">TOP</a> |
		<a href="func_string_crc32.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
