...
<style>a.menu_func_ftp_chdir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_chdir()</span> Function</h1>
...
<p>Change directory, then output directory name:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	current directory to php<br>ftp_chdir($ftp_conn, &quot;php&quot;);<br><br>// output current directory name (/php)<br>
...
<p>The ftp_chdir() function changes the current directory on the FTP server.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_chdir(<em>ftp_connection,directory</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the directory to change to</td>
  </tr>
  </table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_chdir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_chdir.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_chdir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
