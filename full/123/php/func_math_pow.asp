...
<title>PHP pow() Function</title>
<style>a.menu_func_math_pow{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">pow()</span> Function</h1>
...
&lt;?php<br>
	echo(pow(2,4) . &quot;&lt;br&gt;&quot;);<br>echo(pow(-2,4) . &quot;&lt;br&gt;&quot;);<br>echo(pow(-2,-4) . 
	&quot;&lt;br&gt;&quot;);<br>echo(pow(-2,-3.2));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_pow">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The pow() function returns x raised to the power of y.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
pow(<em>x,y</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>x</em></td>
    <td>Required. Specifies the base to use</td>
  </tr>
  <tr>
    <td><em>y</em></td>
    <td>Required. Specifies the exponent</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">x raised to the power of y</td>
</tr>
<tr>
	<th>Return Type:</th>
	<td>&nbsp;Integer if possible, Float otherwise</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 4.0.6: Will now return integer if possible. Earlier it only returned 
	float<br>PHP 4.2.0: No warning is issued on errors</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_pow.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_pow.asp#top" target="_top">TOP</a> |
		<a href="func_math_pow.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
