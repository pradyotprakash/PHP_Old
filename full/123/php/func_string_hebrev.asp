...
<title>PHP hebrev() Function</title>
<style>a.menu_func_string_hebrev{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">hebrev()</span> Function</h1>
...
<p>Reverse the display of Hebrew characters: </p>
<div class="example_code notranslate">

&lt;?php<br>
echo hebrev(&quot;ב חשון התשסג&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_hebrev">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The hebrev() function converts Hebrew text from a right-to-left flow to a 
left-to-right flow.</p>
<p><b>Tip:</b> hebrev() and <a href="func_string_hebrevc.asp">hebrevc()</a> can convert Hebrew logical text (the 
...
for displaying Hebrew text on the web.</p>
<hr>
...
hebrev(<em>string,maxcharline</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. A Hebrew text</td>
  </tr>
  <tr>
    <td><em>maxcharline</em></td>
    <td>Optional. Specifies maximum characters for each line. 
	hebrev() will avoid breaking words if possible</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the visual string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_hebrev.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_hebrev.asp#top" target="_top">TOP</a> |
		<a href="func_string_hebrev.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
