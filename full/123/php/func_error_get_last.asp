...
<title>PHP error_get_last() Function</title>
<style>a.menu_func_error_get_last{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">error_get_last()</span> Function</h1>
<hr>
...
<p>The error_get_last() function gets the last error that occured.</p>
<p>This funtion returns the last occured error in an array, or NULL if no errors 
have occured.</p>
<p>The error array returned contains 4 keys and values:</p>
<ul>
	<li>[type] - Error type</li>
	<li>[message] - Error message</li>
	<li>[file] - The file where the error occurred</li>
...
(<br>
[type] =&gt; 8<br>
[message] =&gt; Undefined variable: test<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_error_get_last.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_error_get_last.asp#top" target="_top">TOP</a> |
		<a href="func_error_get_last.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
