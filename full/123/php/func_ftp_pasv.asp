...
<title>PHP ftp_pasv() Function</title>
<style>a.menu_func_ftp_pasv{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_pasv()</span> Function</h1>
...
<p>Turn passive mode on and upload a file to the FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// turn passive 
	mode on<br>ftp_pasv($ftp_conn, true);<br><br>$file = 
	&quot;localfile.txt&quot;;<br><br>// upload file<br>if (ftp_put($ftp_conn, 
	&quot;serverfile.txt&quot;, $file, FTP_ASCII))<br>&nbsp; {<br>&nbsp; echo &quot;Successfully 
	uploaded $file.&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error uploading 
	$file.&quot;;<br>&nbsp; }<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_pasv() function turns passive mode on or off.</p>
<p>In passive mode, data connections are initiated by the client, 
not the server. This is useful if the client is behind a firewall.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_pasv(<em>ftp_connection,pasv</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>pasv</em></td>
    <td>Required. Specifies the passive mode. Possible values:<ul>
		<li>TRUE (passive mode on)</li>
		<li>FALSE (passive mode off)</li>
	</ul></td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns TRUE on success or FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_pasv.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_pasv.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_pasv.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
