...
<style>a.menu_php_looping{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">while</span>  Loops</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_switch.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_looping_for.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">PHP while loops execute a block of code while 
the specified condition is true.</p>
<hr>

<h2>PHP Loops</h2>
<p>Often when you write code, you want the same block of code to run over and 
over again in a row. Instead of adding several almost equal code-lines in a script, we 
can use loops to perform a task like this.</p>
<p>In PHP, we have the following looping statements:</p>
<ul>
  <li><b>while </b>- loops through a block of code as long as the specified condition is true</li>
  <li><b>do...while</b> - loops through a block of code once, and then repeats the loop 
  as long as the specified condition is true</li>
  <li><b>for </b>- loops through a block of code a specified number of times</li>
  <li><b>foreach </b>- loops through a block of code for each element in an 
  array</li>
</ul>
<hr>
...
<p>The example below first sets a variable $x to 1 ($x=1;). Then, the while loop will continue to run as long as $x is less than, or equal to 5. $x will increase by 1 each time 
the loop runs ($x++;):</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php <br>$x=1; <br>while($x&lt;=5)<br>&nbsp; {<br>&nbsp; echo &quot;The number is: 
	$x &lt;br&gt;&quot;;<br>&nbsp; $x++;<br>&nbsp; } <br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_loop_while">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>The PHP do...while Loop</h2>
<p>The do...while loop will always execute the block of code once, it 
will then check the condition, and repeat the loop while the specified condition is true.</p>
<h3>Syntax</h3>
<div class="code notranslate"><div>
do<br>
&nbsp;
...
<p>The example below first sets a variable $x to 1 ($x=1;). Then, the do while 
loop will write some output, and then increment the variable $x with 1. Then the condition is checked (is 
$x less than, or equal to 5?), and the loop will continue to run as long as $x is less than, or equal to 5:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php <br>$x=1; <br>do<br>&nbsp; {<br>&nbsp; echo &quot;The number is: 
	$x &lt;br&gt;&quot;;<br>&nbsp; $x++;<br>&nbsp; }<br>while ($x&lt;=5)<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_loop_do_while">Run example &raquo;</a>
</div>

<p>Notice that in a do while loop the condition is tested AFTER executing 
the statements within the loop. This means that the do while loop would execute 
its statements at least once, even if the condition fails the first time.</p>
<p>The example below sets the $x variable to 6, then it runs the loop, <strong>
and then the condition is checked</strong>:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php <br>$x=6; <br>do<br>&nbsp; {<br>&nbsp; echo &quot;The number is: 
	$x &lt;br&gt;&quot;;<br>&nbsp; $x++;<br>&nbsp; }<br>while ($x&lt;=5)<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_loop_do_while2">Run example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_looping.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_looping.asp#top" target="_top">TOP</a> |
		<a href="php_looping.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
