...
<title>PHP convert_uudecode() Function</title>
<style>a.menu_func_string_convert_uudecode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">convert_uudecode()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_convert_uudecode">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The convert_uudecode() function decodes a uuencoded string.</p>
<p>This function is often used together with the 
<a href="func_string_convert_uuencode.asp">convert_uuencode()</a> function.</p>
<hr>
...
<table class="reference notranslate"> 
  <tr>
    ...
    <th style="width:80%">DDescription</th>
  </tr>  
  <tr>
    <td><em>string</em></td>
    <td>Required. The uuencoded string to decode</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the decoded data as a string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_convert_uudecode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_convert_uudecode.asp#top" target="_top">TOP</a> |
		<a href="func_string_convert_uudecode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
