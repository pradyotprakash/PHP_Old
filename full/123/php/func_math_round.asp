...
<title>PHP round() Function</title>
<style>a.menu_func_math_round{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">round()</span> Function</h1>
<p><a href="php_ref_math.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Math Reference" /> PHP Math Reference</a></p>
<div class="example">
...
echo(round(0.50) . &quot;&lt;br&gt;&quot;);<br>
echo(round(0.49) . &quot;&lt;br&gt;&quot;);<br>
echo(round(-4.40) . &quot;&lt;br&gt;&quot;);<br>
echo(round(-4.60));<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_round">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The round() function rounds a floating-point number.</p>
<p><strong>Tip:</strong> To round a number UP to the nearest integer, look at the
<a href="func_math_ceil.asp">ceil()</a> function.</p>
<p><strong>Tip:</strong> To round a number DOWN to the nearest integer, look at the
<a href="func_math_floor.asp">floor()</a> function.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
round(<em>number,precision,mode</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the value to round</td>
  </tr>
  <tr>
    <td><em>precision</em></td>
    <td>Optional. Specifies the number of decimal digits to round to. Default is 
	0</td>
  </tr>
  <tr>
    <td><em>mode</em></td>
    <td>Optional. Specifies a constant to specify the rounding mode:
	<ul>
		<li>PHP_ROUND_HALF_UP - Default. Rounds <em>number</em> up to <em>precision</em> 
		decimal, when it is half way there. Rounds 1.5 to 2 and -1.5 to -2</li>
		<li>PHP_ROUND_HALF_DOWN - Round <em>number</em> down to <em>precision</em> 
		decimal places, when it is half way there. Rounds 1.5 to 1 and -1.5 to -1</li>
		<li>PHP_ROUND_HALF_EVEN - Round <em>number</em> to <em>precision</em> decimal 
		places towards the next even value</li>
		<li>PHP_ROUND_HALF_ODD - Round <em>number</em> to <em>precision</em> 
		decimal places towards the next odd value</li>
	</ul>
	  </td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">The rounded value</td>
</tr>
<tr>
	<th>Return Type:</th>
	<td>Float</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 5.3: The mode parameter was added</td>
</tr>
</table>
<br>
<hr>
...
<p>Round numbers to two decimals:</p>
<div class="example_code notranslate">
&lt;?php<br>
	echo(round(4.96754,2) . &quot;&lt;br&gt;&quot;);<br>echo(round(7.045,2) . &quot;&lt;br&gt;&quot;);<br>
	echo(round(7.055,2));<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_round2">Run example &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example 2</h2>
<p>Round numbers using the constants:</p>
<div class="example_code notranslate">
&lt;?php<br>
	echo(round(1.5,0,PHP_ROUND_HALF_UP) . &quot;&lt;br&gt;&quot;);<br>
	echo(round(-1.5,0,PHP_ROUND_HALF_UP) . &quot;&lt;br&gt;&quot;);<br><br>
	echo(round(1.5,0,PHP_ROUND_HALF_DOWN) . &quot;&lt;br&gt;&quot;);<br>
	echo(round(-1.5,0,PHP_ROUND_HALF_DOWN) . &quot;&lt;br&gt;&quot;);<br><br>
	echo(round(1.5,0,PHP_ROUND_HALF_EVEN) . &quot;&lt;br&gt;&quot;);<br>
	echo(round(-1.5,0,PHP_ROUND_HALF_EVEN) . &quot;&lt;br&gt;&quot;);<br><br>
	echo(round(1.5,0,PHP_ROUND_HALF_ODD) . &quot;&lt;br&gt;&quot;);<br>
	echo(round(-1.5,0,PHP_ROUND_HALF_ODD));<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_round3">Run example &raquo;</a>
</div>
<br>
<hr>
<a href="php_ref_math.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Math Reference" /> PHP Math Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_round.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_round.asp#top" target="_top">TOP</a> |
		<a href="func_math_round.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
