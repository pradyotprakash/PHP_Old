...
<title>PHP strnatcasecmp() Function</title>
<style>a.menu_func_string_strnatcasecmp{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strnatcasecmp()</span> Function</h1>
...
<p>Compare two strings using a &quot;natural&quot; algorithm (case-insensitive):</p>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strnatcasecmp">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strnatcasecmp() function compares two strings using a &quot;natural&quot; algorithm.</p>
...
less than 2.</p>
<p><b>Note:</b> The strnatcasecmp() is case-insensitive.</p>
...
strnatcasecmp(<em>string1,string2</em>)
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strnatcasecmp.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strnatcasecmp.asp#top" target="_top">TOP</a> |
		<a href="func_string_strnatcasecmp.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
