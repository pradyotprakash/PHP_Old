...
<title>PHP cos() Function</title>
<style>a.menu_func_math_cos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">cos()</span> Function</h1>
...
<p>Return the cosine of different numbers:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_cos">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cos() function returns the cosine of a number.</p>
<p><b>Note:</b> <span class="sansserif">The <span class="mono">cos()</span> 
function returns a numeric value between -1 and 1, which represents the cosine of the angle.</span></p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	cos(<em>number</em>);</div></div>
<br>
...
<tr>
	...
	<td style="width:80%">The cosine of <em>number</em></td>
</tr>
<tr>
	<th>Return Type:</th>
	<td>Float</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_cos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_cos.asp#top" target="_top">TOP</a> |
		<a href="func_math_cos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
