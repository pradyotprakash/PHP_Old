...
<title>PHP strftime() Function</title>
<style>a.menu_func_date_strftime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strftime()</span> Function</h1>
<p><a href="php_ref_date.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Date/Time" /> PHP Date/Time Reference</a></p>
<div class="example">
<h2 class="example">Example</h2>
<p>Format local date and time according to locale settings:</p>
<div class="example_code notranslate">
&lt;?php<br>
	echo(strftime(&quot;%B %d %Y, %X %Z&quot;,mktime(20,0,0,12,31,98)).&quot;&lt;br&gt;&quot;);<br>
	setlocale(LC_ALL,&quot;hu_HU.UTF8&quot;);<br>echo(strftime(&quot;%Y. %B %d. %A. %X %Z&quot;));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_strftime">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The strftime() function formats a local time and/or date according to locale settings.</p>
<p><strong>Tip:</strong> Also look at the <a href="func_date_gmstrftime.asp">gmstrftime()</a> function,
which formats a GMT/UTC time and/or date according to locale settings.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
strftime(<em>format,timestamp);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies how to return the result:<ul>
		...
		<li>%e - day of the month (1 to 31)</li>
		<li>%g - like %G, but without the century</li>
		<li>%G - 4-digit year corresponding to the ISO week number (see %V).</li>
		<li>%h - same as %b</li>
		<li>%H - hour, using a 24-hour clock (00 to 23)</li>
		<li>%I - hour, using a 12-hour clock (01 to 12)</li>
		<li>%j - day of the year (001 to 366)</li>
		<li>%m - month (01 to 12)</li>
		<li>%M - minute</li>
		...
		<li>%u - weekday as a number (1 to 7), Monday=1. Warning: In Sun Solaris 
		Sunday=1</li>
		<li>%U - week number of the current year, starting with the first Sunday 
		as the first day of the first week</li>
		<li>%V - The ISO 8601 week number of the current year (01 to 53), where 
		week 1 is the first week that has at least 4 days in the current year, 
		and with Monday as the first day of the week</li>
		<li>%W - week number of the current year, starting with the first Monday 
		as the first day of the first week</li>
		<li>%w - day of the week as a decimal, Sunday=0</li>
		<li>%x - preferred date representation without the time</li>
		<li>%X - preferred time representation without the date</li>
		<li>%y - year without a century (range 00 to 99)</li>
		<li>%Y - year including the century</li>
		<li>%Z or %z - time zone or name or abbreviation</li>
  ...
  <tr>
    ...
    <td>Optional. Specifies a Unix timestamp that represents the date and/or 
	time to be formatted. Default is the current local time (time())</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a string formatted according <em>format</em> using 
	the given <em>timestamp</em>. Month and weekday names and other 
	language-dependent strings respect the current locale set with setlocale()</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>PHP 5.1.0: Now issues E_STRICT and E_NOTICE time 
	zone errors<br></td>
</tr>
</table>
<br>
...
<a href="php_ref_date.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Date/Time" /> PHP Date/Time Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_strftime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_strftime.asp#top" target="_top">TOP</a> |
		<a href="func_date_strftime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
