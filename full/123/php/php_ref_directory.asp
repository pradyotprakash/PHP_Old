...
<html lang="en-US">
<head>
<title>PHP 5 Directory Functions</title>
<style>a.menu_php_ref_directory{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Directory</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_date.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_error.asp">Next Chapter &raquo;</a></div>
</div>
<hr>

<h2>PHP Directory Introduction</h2>
<p>The directory functions allow you to retrieve information about directories 
and their contents.</p>
<hr>

<h2>Installation</h2>
<p>The PHP directory functions are part of the PHP core. No installation is required to use these functions.</p>
<hr>

<h2>PHP 5 Directory Functions</h2>
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="func_directory_chdir.asp">chdir()</a></td>
    <td>Changes the current directory</td>
  </tr>
  <tr>
    <td><a href="func_directory_chroot.asp">chroot()</a></td>
    <td>Changes the root directory</td>
  </tr>
    <tr>
    <td><a href="func_directory_closedir.asp">closedir()</a></td>
    <td>Closes a directory handle</td>
    </tr>
  <tr>
    <td><a href="func_directory_dir.asp">dir()</a></td>
    <td>Returns an instance of the Directory class</td>
  </tr>
  <tr>
    <td><a href="func_directory_getcwd.asp">getcwd()</a></td>
    <td>Returns the current working directory</td>
  </tr>
  <tr>
    <td><a href="func_directory_opendir.asp">opendir()</a></td>
    <td>Opens a directory handle</td>
  </tr>
  <tr>
    <td><a href="func_directory_readdir.asp">readdir()</a></td>
    <td>Returns an entry from a directory handle</td>
  </tr>
  <tr>
    <td><a href="func_directory_rewinddir.asp">rewinddir()</a></td>
    <td>Resets a directory handle</td>
  </tr>
  <tr>
    <td><a href="func_directory_scandir.asp">scandir()</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_directory.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_directory.asp#top" target="_top">TOP</a> |
		<a href="php_ref_directory.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
