...
<title>PHP strcoll() Function</title>
<style>a.menu_func_string_strcoll{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strcoll()</span> Function</h1>
...
&lt;?php<br>
setlocale (LC_COLLATE, 'NL');<br>
echo strcoll(&quot;Hello World!&quot;,&quot;Hello World!&quot;);<br>
echo &quot;&lt;br&gt;&quot;;<br>
<br>
setlocale (LC_COLLATE, 'en_US');<br>
echo strcoll(&quot;Hello World!&quot;,&quot;Hello World!&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strcoll">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strcoll() function compares two strings.</p>

<p>The comparison of the strings may vary depending on the locale settings (A&lt;a 
or A&gt;a).</p>

<p><b>Note:</b> The strcoll() is case-sensitive but not binary-safe.</p>
<p><b>Note:</b> If the current locale is C or POSIX, this function works the 
same way as <a href="func_string_strcmp.asp">strcmp()</a>.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

strcoll(<em>string1,string2</em>)
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 4.2.3, this function now works on win32</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strcoll.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strcoll.asp#top" target="_top">TOP</a> |
		<a href="func_string_strcoll.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
