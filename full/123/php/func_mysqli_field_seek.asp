...
<title>PHP mysqli_field_seek() Function</title>
<style>a.menu_func_mysqli_field_seek{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_field_seek()</span> Function</h1>
...
<p>Set the field cursor to the first field (column) in the result set, then get 
the field info with mysqli_fetch_field() and print the field's 
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	...
	info for 1st column (&quot;Lastname&quot;)<br>&nbsp; mysqli_field_seek($result,0);<br>&nbsp; 
...
<p>The mysqli_field_seek() function sets the field cursor to the given field offset.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_field_seek(<em>result,fieldnr</em>)<em>;</em></div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_field_seek.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_field_seek.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_field_seek.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
