...
<style>a.menu_func_mysqli_fetch_array{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_fetch_array()</span> Function</h1>
...
<p>Fetch a result row as a numeric array and as an associative array:</p>
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	$result=mysqli_query($con,$sql)<br><br>// Numeric array<br>
	$row=mysqli_fetch_array($result,MYSQLI_NUM);<br>printf (&quot;%s 
	(%s)\n&quot;,$row[0],$row[1]);<br><br>// Associative array<br>
	$row=mysqli_fetch_array($result,MYSQLI_ASSOC);<br>printf (&quot;%s 
	(%s)\n&quot;,$row[&quot;Lastname&quot;],$row[&quot;Age&quot;]);<br>
	<br>// Free result 
	set<br>mysqli_free_result($result);<br>
...
<p>The mysqli_fetch_array() function fetches a result row as an associative array, a numeric array, or both.</p>
<p><strong>Note:</strong> Fieldnames returned from this function are case-sensitive.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_fetch_array(<em>result,resulttype</em>)<em>;</em></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies what type of array that should be produced. Can be 
...
<tr>
	...
	<td style="width:80%">Returns an array of strings that corresponds to the fetched 
	row. NULL if there are no more rows in result-set</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_fetch_array.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_fetch_array.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_fetch_array.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
