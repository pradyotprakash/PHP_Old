...
<title>PHP array_replace_recursive() Function</title>
<style>a.menu_func_array_replace_recursive{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_replace_recursive()</span> Function</h1>
...
<p>Replace the values of the first array with the values from the second array 
recursively:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;a&quot;=&gt;array(&quot;red&quot;),&quot;b&quot;=&gt;array(&quot;green&quot;,&quot;blue&quot;),);<br>
	$a2=array(&quot;a&quot;=&gt;array(&quot;yellow&quot;),&quot;b&quot;=&gt;array(&quot;black&quot;));<br>print_r(array_replace_recursive($a1,$a2));<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_replace_recursive">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_replace_recursive() function replaces the values of the first array with the 
values from following arrays recursively.</p>
...
multiple arrays are used, values from later arrays will overwrite the previous 
ones.</p>
<p><strong>Note:</strong> If you do not specify a key for each array, this 
function will behave exactly the same as the <a href="func_array_replace.asp">
array_replace()</a> function.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
array_replace_recursive(<em>array1,array2,array3...</em>)
</div></div>
<br>
...
&lt;?php<br>
	$a1=array(&quot;a&quot;=&gt;array(&quot;red&quot;),&quot;b&quot;=&gt;array(&quot;green&quot;,&quot;blue&quot;));<br>
	$a2=array(&quot;a&quot;=&gt;array(&quot;yellow&quot;),&quot;b&quot;=&gt;array(&quot;black&quot;));<br>
	$a3=array(&quot;a&quot;=&gt;array(&quot;orange&quot;),&quot;b&quot;=&gt;array(&quot;burgundy&quot;));<br>print_r(array_replace_recursive($a1,$a2,$a3));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_replace_recursive2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Differences between array_replace() and array_replace_recursive():</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;a&quot;=&gt;array(&quot;red&quot;),&quot;b&quot;=&gt;array(&quot;green&quot;,&quot;blue&quot;),);<br>
	$a2=array(&quot;a&quot;=&gt;array(&quot;yellow&quot;),&quot;b&quot;=&gt;array(&quot;black&quot;));<br><br>$result=array_replace_recursive($a1,$a2);<br>
	print_r($result);<br><br>$result=array_replace($a1,$a2);<br>print_r($result);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_replace_recursive3">Run example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_replace_recursive.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_replace_recursive.asp#top" target="_top">TOP</a> |
		<a href="func_array_replace_recursive.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
