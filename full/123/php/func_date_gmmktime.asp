...
<title>PHP gmmktime() Function</title>
<style>a.menu_func_date_gmmktime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">gmmktime()</span> Function</h1>
...
<p>Return the Unix timestamp for a GMT date. Then use it to find the day of that 
date:</p>
<div class="example_code notranslate">

&lt;?php<br>
	// Prints: October 3, 1975 was on a Friday<br>echo &quot;Oct 3, 1975 was on a 
	&quot;.date(&quot;l&quot;, gmmktime(0,0,0,10,3,1975));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_gmmktime">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The gmmktime() function returns the Unix timestamp for a GMT date.</p>
<p><b>Tip:</b> This function is identical to <a href="func_date_mktime.asp">mktime()</a> except the passed parameters 
represents a GMT date.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
gmmktime(<em>hour,minute,second,month,day,year,is_dst</em>);</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>is_dst</em></td>
    <td>Optional. Parameters always represent a GMT date so is_dst doesn't 
...
<tr>
	...
	<td style="width:80%">Returns an integer Unix timestamp</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>PHP 5.1.0: The <em>is_dst</em> parameter was deprecated</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_gmmktime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_gmmktime.asp#top" target="_top">TOP</a> |
		<a href="func_date_gmmktime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
