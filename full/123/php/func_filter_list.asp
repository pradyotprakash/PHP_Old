...
<title>PHP filter_list() Function</title>
<style>a.menu_func_filter_list{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filter_list()</span> Function</h1>
<hr>
...
<p>The filter_list() function returns an array of all supported filters.</p>
<h2>Syntax</h2>
...
<p><b>Note:</b> The results of this function is not the filter ID, but filter 
names. Use the filter_id() function to get the filter ID</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filter_list.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filter_list.asp#top" target="_top">TOP</a> |
		<a href="func_filter_list.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
