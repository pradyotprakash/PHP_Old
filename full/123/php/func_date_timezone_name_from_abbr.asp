...
<title>PHP timezone_name_from_abbr() Function</title>
<style>a.menu_func_date_timezone_name_from_abbr{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">timezone_name_from_abbr()</span> Function</h1>
...
<p>Return the timezone name from abbreviation:</p>
<div class="example_code notranslate">
&lt;?php<br>
	echo timezone_name_from_abbr(&quot;EST&quot;) . &quot;&lt;br&gt;&quot;;<br>echo 
	timezone_name_from_abbr(&quot;&quot;,7200,0);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_tz_name_from_abbr">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The timezone_name_from_abbr() returns the timezone name from abbreviation.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
timezone_name_from_abbr(<em>abbr,gmtoffset,isdst);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>abbr</em></td>
    <td>Required. Specifies the timezone abbreviation</td>
  </tr>
  <tr>
    <td><em>gmtoffset</em></td>
    <td>Optional. Specifies the offset from GMT in seconds. Default is -1, which 
	means that first found timezone corresponding to abbr is returned. 
	Otherwise exact offset is searched. If not found, the first timezone with any offset is returned</td>
  </tr>
  <tr>
    <td><em>isdst</em></td>
    <td>
	Optional. Specifies daylight saving time indicator.<ul>
		<li>-1 = Default. Whether the timezone has daylight saving or not is not 
		taken into consideration when searching</li>
		<li>&nbsp;1 = Means that the <em>gmtoffset</em> 
	is an offset with daylight saving in effect</li>
		<li>0 = Means that the <em>gmtoffset</em> is an offset without daylight saving in effect
		</li>
	</ul>
	  </td>
  </tr>
...
<tr>
	...
	<td style="width:80%">Returns the timezone name on success. FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_timezone_name_from_abbr.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_timezone_name_from_abbr.asp#top" target="_top">TOP</a> |
		<a href="func_date_timezone_name_from_abbr.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
