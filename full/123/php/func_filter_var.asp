...
<title>PHP filter_var() Function</title>
<style>a.menu_func_filter_var{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filter_var()</span> Function</h1>
<hr>
...
<p>The filter_var() function filters a variable with the specified filter.<br>
<br>
Returns the filtered data on success or FALSE on failure.</p>
<h2>Syntax</h2>
...
&lt;?php<br>
if(!filter_var(&quot;someone@example....com&quot;, FILTER_VALIDATE_EMAIL))<br>
&nbsp;{<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filter_var.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filter_var.asp#top" target="_top">TOP</a> |
		<a href="func_filter_var.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
