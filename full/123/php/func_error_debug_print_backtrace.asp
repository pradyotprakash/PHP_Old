...
<title>PHP debug_print_backtrace() Function</title>
<style>a.menu_func_error_debug_print_backtrace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">debug_print_backtrace()</span> Function</h1>
<hr>
...
<p>The debug_print_backtrace() function prints a backtrace.</p>
<p>This function displays data from the code that led up to the 
debug_print_backtrace() function.</p>
...
#0 three(Cleveland, Brown) called at [C:\webfolder\test.php:8]<br>
#1 two(Glenn, Quagmire) called at [C:\webfolder\test.php:4]<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_error_debug_print_backtrace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_error_debug_print_backtrace.asp#top" target="_top">TOP</a> |
		<a href="func_error_debug_print_backtrace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
