...
<title>PHP FILTER_SANITIZE_EMAIL Filter</title>
<style>a.menu_filter_sanitize_email{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_SANITIZE_EMAIL</span> Filter</h1>
<hr>
...
<p>The FILTER_SANITIZE_EMAIL filter removes all illegal e-mail characters from a 
string.</p>
<p>This filter allows all letters, digits and $-_.+!*'{}|^~[]`#%/?@&amp;=</p>
<ul>
	<li>Name: &quot;email&quot;</li>
	<li>ID-number: 517</li>
</ul>
...
&lt;?php<br>
$var=&quot;some(one)@exa\\mple.com&quot;;<br>
<br>
var_dump(filter_var($var, FILTER_SANITIZE_EMAIL));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_sanitize_email.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_sanitize_email.asp#top" target="_top">TOP</a> |
		<a href="filter_sanitize_email.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
