...
<title>PHP linkinfo() Function</title>
<style>a.menu_func_filesystem_linkinfo{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">linkinfo()</span> Function</h1>
<hr>
...
<p>The linkinfo() function returns information about a hard link.</p>
<p>This function returns a device ID, or FALSE on failure.</p>
<h2>Syntax</h2>
...
<p><b>Note:</b> This is not an HTML link, but a link in the filesystem.</p>

<p><b>Note:</b> This function is not implemented on Windows.</p>
<hr>
<a href="php_ref_filesystem.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Filesystem Reference" /> Complete PHP Filesystem Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_linkinfo.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_linkinfo.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_linkinfo.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
