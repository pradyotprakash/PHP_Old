...
<style>a.menu_php_if_else{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">if...else...elseif</span> Statements</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_operators.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_switch.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<ul>
  <li><b>if statement</b> - executes some code only if a specified condition is true</li>
  <li><b>if...else statement</b> - executes some code if a condition is true and another code if the condition is false</li>
	<li><b>if...elseif....else statement</b>  - selects one of several blocks of code to be executed</li>
  <li><b>switch statement</b> - selects one of many blocks of code to be executed</li>
</ul>
<hr>

<h2>PHP - The if Statement</h2>
<p>The if statement is used to execute some code <strong>only if a specified condition is true</strong>.</p>

<h3>Syntax</h3>
<div class="code notranslate"><div>
if (<i>condition</i>)<br>
&nbsp; {<i><br>
&nbsp; code to be executed if condition is true</i>;<i><br>
&nbsp; </i>}
</div></div>

<p>The example below will output &quot;Have a good day!&quot; if the current time 
(HOUR) is less than 20:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_if">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>PHP - The if...else Statement</h2>
<p>Use the if....else statement to execute some code <strong>if a condition is true and another code if the 
condition is false</strong>.</p>
...
<p>The example below will output &quot;Have a good day!&quot; if the current time is less 
than 20, and &quot;Have a good night!&quot; otherwise:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;?php<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_if_else">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>PHP - The if...elseif....else Statement</h2>
<p>Use the if....elseif...else statement to <strong>select one of several blocks of code to be executed</strong>.</p>
<h3>Syntax</h3>
<div class="code notranslate"><div>
if (<i>condition</i>)<br>
&nbsp; {<br>
...
<p>The example below will output &quot;Have a good morning!&quot; if the current time is less than 10,
and &quot;Have a good day!&quot; if the current time is less than 20. Otherwise it will output &quot;Have a good night!&quot;:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;?php<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_if_elseif">Run example &raquo;</a>
</div>
<br>
<hr>
<h2>PHP - The switch Statement</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_if_else.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_if_else.asp#top" target="_top">TOP</a> |
		<a href="php_if_else.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
