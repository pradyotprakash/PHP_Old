...
<title>PHP fgets() Function</title>
<style>a.menu_func_filesystem_fgets{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fgets()</span> Function</h1>
<hr>
...
<p>The fgets() function returns a line from an open file.</p>
<p>The fgets() function stops returning on a new line, at the specified length, 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the file to read from</td>
  </tr>
  <tr>
    <td>length</td>
    <td>Optional. Specifies the number of bytes to read. Default is 1024 bytes.</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fgets.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fgets.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fgets.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
