...
<style>a.menu_php_xml_dom{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">XML DOM</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_xml_parser_expat.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_xml_simplexml.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The built-in DOM parser makes it possible to process XML documents in PHP.</p>
<hr>

<h2>What is DOM?</h2>
<p>The W3C DOM provides a standard set of objects for HTML and XML documents, 
and a standard interface for accessing and manipulating them.</p>
<p>The W3C DOM is separated into different parts (Core, XML, and HTML) and 
different levels (DOM Level 1/2/3):</p>
<ul>
	<li>&nbsp;Core DOM - defines a standard set of objects for any structured document</li>
	<li>XML DOM - defines a standard set of objects for XML documents</li>
	<li>HTML DOM - defines a standard set of objects for HTML documents</li>
</ul>
<p>If you want to learn more about the XML DOM, please visit our <a href="../dom/default.asp">XML DOM tutorial</a>.</p>
<hr>
...
<p>When XML generates, it often contains white-spaces between the nodes. The XML 
DOM parser treats these as ordinary elements, and if you are not aware of them, 
they sometimes cause problems.</p>
<hr>

<p>If you want to learn more about the XML DOM, please visit our
<a href="../dom/default.asp">XML DOM tutorial</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_xml_dom.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_xml_dom.asp#top" target="_top">TOP</a> |
		<a href="php_xml_dom.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
