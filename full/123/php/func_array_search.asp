...
<title>PHP array_search() Function</title>
<style>a.menu_func_array_search{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_search()</span> Function</h1>
...
<p>Search an array for the value &quot;red&quot; and return its key:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;);<br>echo array_search(&quot;red&quot;,$a);<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_search">Run example &raquo;</a>
</div>
<hr>
...
array_search(<em>value,array,strict</em>)
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>value</em></td>
    <td>Required. Specifies the value to search for</td>
  </tr>
  <tr>
    <td><em>array</em></td>
    <td>Required. Specifies the array to search in</td>
  </tr>
  <tr>
    <td><em>strict</em></td>
    <td>Optional. If this parameter is set to TRUE, then this 
	function will search for identical elements in the array. Possible values:
    <ul><li>true</li><li>false - Default</li></ul>
...
<tr>
	...
	<td style="width:80%">Returns the key of a value if it is found in the array, and 
	FALSE otherwise. If the value is found in the array more than once, the 
	first matching key is returned.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.5+</td>
...
<tr>
	<th>Changelog:</th>
	<td>This function returns NULL if invalid parameters are passed to it (this 
	applies to all PHP functions as of 5.3.0).<br><br>As of PHP 4.2.0, this 
	function returns FALSE on failure instead of NULL.</td>
</tr>
</table>
<br>
<hr>
...
<p>Search an array for the value 5 and return its key (notice the &quot;&quot;):</p>
<div class="example_code notranslate">
&lt;?php<br>
$a=array(&quot;a&quot;=&gt;&quot;5&quot;,&quot;b&quot;=&gt;5,&quot;c&quot;=&gt;&quot;5&quot;);<br>
echo array_search(5,$a,true);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_search2">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_search.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_search.asp#top" target="_top">TOP</a> |
		<a href="func_array_search.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
