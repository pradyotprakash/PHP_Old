...
<title>PHP glob() Function</title>
<style>a.menu_func_filesystem_glob{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">glob()</span> Function</h1>
<hr>
...
<p>The glob() function returns an array of filenames or directories matching a 
specified pattern.</p>
<p>This function returns an array of files/directories, or FALSE on failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>flags</td>
    <td>Optional. Specifies special settings.<p>Possible values:</p>
	<ul>
		...
		<li>GLOB_ERR - (added in PHP 5.1) Stop on errors (errors are ignored by 
		default)</li>
	</ul>
	</td>
  </tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_glob.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_glob.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_glob.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
