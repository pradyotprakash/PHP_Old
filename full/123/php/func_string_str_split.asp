...
<title>PHP str_split() Function</title>
<style>a.menu_func_string_str_split{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">str_split()</span> Function</h1>
...
<p>Split the string &quot;Hello&quot; into an array:</p>
<div class="example_code notranslate">

&lt;?php<br>
print_r(str_split(&quot;Hello&quot;));<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_split">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The str_split() function splits a string into an array.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to split</td>
  </tr>
  <tr>
    <td><em>length</em></td>
    <td>Optional. Specifies the length of each array 
	element. Default is 1</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">If length is less than 1, the str_split() function will return 
FALSE. <b>&nbsp;</b>If length is larger than the length of string, the entire string will 
be returned as the only element of the array.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
&lt;?php<br>
print_r(str_split(&quot;Hello&quot;,3));<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_split2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_str_split.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_str_split.asp#top" target="_top">TOP</a> |
		<a href="func_string_str_split.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
