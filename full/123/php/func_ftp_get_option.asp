...
<style>a.menu_func_ftp_get_option{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_get_option()</span> Function</h1>
...
<p>Return the timeout used for network operations:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// could return 
	90<br>echo ftp_get_option($ftp_conn,FTP_TIMEOUT_SEC);<br>
...
<p>The ftp_get_option() function returns runtime options of the current FTP connection.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_get_option(<em>ftp_connection,option</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>option</em></td>
    <td>Required. Specifies the runtime option to return. 
	Possible values:<ul>
		<li>FTP_TIMEOUT_SEC - Returns the timeout used for 
		network operations</li>
		<li>FTP_AUTOSEEK - Returns TRUE if this option is on, FALSE otherwise</li>
	</ul>
	</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns the value on success, or FALSE if the given 
	option is not supported (a warning message is also thrown)</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.2+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_get_option.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_get_option.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_get_option.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
