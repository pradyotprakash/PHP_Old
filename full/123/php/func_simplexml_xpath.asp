...
<title>PHP xpath() Function</title>
<style>a.menu_func_simplexml_xpath{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xpath()</span> Function</h1>
<hr>
<a href="php_ref_simplexml.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP SimpleXML Reference" /> Complete PHP SimpleXML Reference</a>
<hr>

<h2>Definition and Usage</h2>
<p>The xpath() function runs an XPath query on the XML document.</p>
<p>This function returns an array of SimpleXMLElements on success, and FALSE of failure.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
class SimpleXMLElement<br>
{<br>
string xpath(path)<br>
}
</div></div>
<br>
<table class="reference notranslate">
  ...
  <tr>
    <td>path</td>
    <td>Required. Specifies what to search for in the XML document</td>
  </tr>
	</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_xpath.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_xpath.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_xpath.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
