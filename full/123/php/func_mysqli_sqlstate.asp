...
<title>PHP mysqli_sqlstate() Function</title>
<style>a.menu_func_mysqli_sqlstate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_sqlstate()</span> Function</h1>
...
<p>Return the SQLSTATE error code for the last MySQL operation:</p>
...
&nbsp;&nbsp;}<br><br>// Table Persons already exists, so we should get an error<br>
	$sql=&quot;CREATE TABLE Persons (Firstname VARCHAR(30),Lastname VARCHAR(30),Age 
	INT)&quot;<br>if (!mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; echo &quot;SQLSTATE 
	error: &quot;. mysqli_sqlstate($con);<br>&nbsp; }<br>
	<br>// Close connection<br>
	mysqli_close($con);<br>?&gt;
</div>
</div>
<hr>
...
<p>The mysqli_sqlstate() function returns the SQLSTATE error code for the last error.</p>
<p>The error code consists of five characters. &quot;00000&quot; indicates no error. The 
values are specified by ANSI SQL and ODBC.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_sqlstate(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns a string that contains the SQLSTATE error code for 
	the last error</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_sqlstate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_sqlstate.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_sqlstate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
