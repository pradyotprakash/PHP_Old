...
<title>PHP localeconv() Function</title>
<style>a.menu_func_string_localeconv{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">localeconv()</span> Function</h1>
...
<p>Find the United States locale numeric formatting information:</p>
<div class="example_code notranslate">

&lt;?php<br>
setlocale(LC_ALL,&quot;US&quot;);<br>
$locale_info = localeconv();<br>
print_r($locale_info);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_localeconv">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The localeconv() function returns an array containing local numeric and 
monetary formatting 
information.</p>
<p>The localeconv() function will return the following array elements:</p>
<ul>
	<li>[decimal_point] - Decimal point character</li>
	<li>[thousands_sep] - Thousands separator</li>
	...
	<li>[p_sign_posn] - Formatting options:<ul>
		<li>0 - Parentheses surround the quantity and currency symbol</li>
		<li>1 - The + sign is placed in front of the quantity and 
		currency symbol</li>
		<li>2 - The + sign is placed after the quantity and currency symbol</li>
		<li>3 - The + sign is placed immediately in front of the 
		currency symbol</li>
		<li>4 - The + sign is placed immediately after the currency symbol</li>
	</ul></li>
	<li>[n_sign_posn] - Formatting options:<ul>
		<li>0 - Parentheses surround the quantity and currency symbol</li>
		<li>1 - The - sign is placed in front of the quantity and 
		currency symbol</li>
		<li>2 - The - sign is placed after the quantity and currency symbol</li>
	...
	<li>[grouping] - Array displaying how numbers are grouped (example: 3 
	indicates 1 000 
	000)</li>
	<li>[mon_grouping] - Array displaying how monetary numbers are grouped 
	(example: 2 indicates 1 00 00 00)</li>
</ul>

<p><b>Tip:</b> To define locale settings, see the 
...
<tr>
	...
	<td style="width:80%">Returns data based upon the current locale as set by 
	setlocale()</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_localeconv.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_localeconv.asp#top" target="_top">TOP</a> |
		<a href="func_string_localeconv.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
