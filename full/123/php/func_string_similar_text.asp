...
<title>PHP similar_text() Function</title>
<style>a.menu_func_string_similar_text{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">similar_text()</span> Function</h1>
...
<p>Calculate the similarity between two strings and return the matching 
characters:</p>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_similar_text">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The similar_text() function calculates the similarity between two strings.</p>
<p>It can also calculate the similarity of the two strings in percent.</p>
<p><b>Note:</b> The <a href="func_string_levenshtein.asp">levenshtein()</a> function is faster than the similar_text() 
...
similar_text(<em>string1,string2,percent</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string1</em></td>
    <td>Required. Specifies the first string to be compared</td>
  </tr>
  <tr>
    <td><em>string2</em></td>
    <td>Required. Specifies the second string to be compared</td>
  </tr>
  <tr>
    <td><em>percent</em></td>
    <td>Optional. Specifies a variable name for storing the 
	similarity in percent</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the number of matching characters of two strings</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>Calculate the similarity between two strings in percent:</p>
<div class="example_code notranslate">

	&lt;?php<br>
similar_text(&quot;Hello World&quot;,&quot;Hello Peter&quot;,$percent);<br>
echo $percent;<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_similar_text2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_similar_text.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_similar_text.asp#top" target="_top">TOP</a> |
		<a href="func_string_similar_text.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
