...
<title>PHP connection_aborted() Function</title>
<style>a.menu_func_misc_connection_aborted{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">connection_aborted()</span> Function</h1>
...
<p>Create a function (check_abort()) that writes a log message if a client 
aborts the script:</p>
<div class="example_code notranslate">

&lt;?php<br>function check_abort()<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;if (connection_aborted())<br>
&nbsp;&nbsp;error_log (&quot;Script $GLOBALS[SCRIPT_NAME]&quot; .<br>
&nbsp;&nbsp;&quot;$GLOBALS[SERVER_NAME] was aborted by the user.&quot;);<br>
&nbsp;&nbsp;}<br>
<br>
// Some script to be executed here<br>
<br>
// Call the check_abort function when the script ends<br>
register_shutdown_function(&quot;check_abort&quot;);<br>
?&gt;</div>
<br>
</div>
<hr>
...
<p>The connection_aborted() function checks whether the client has disconnected.</p>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns 1 if the connection has been aborted, otherwise it 
	returns 0</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_connection_aborted.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_connection_aborted.asp#top" target="_top">TOP</a> |
		<a href="func_misc_connection_aborted.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
