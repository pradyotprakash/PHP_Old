...
<style>a.menu_php_xml_simplexml{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_xml_dom.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ajax_intro.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">PHP SimpleXML handles the most common XML tasks and leaves the rest 
for other extensions.</p>
<hr>

<h2>What is PHP SimpleXML?</h2>
<p>SimpleXML is new in PHP 5.</p>
<p>The SimpleXML extension provides is a simple way of getting an XML element's 
name and text.</p>
<p>Compared to DOM or the Expat parser, SimpleXML just takes a few lines of code 
to read text data from an XML element. </p>
<p>SimpleXML converts the XML document (or XML string) into an object, like this:</p>
<ul>
	<li>Elements are converted to single attributes of the SimpleXMLElement 
	object. When there's more than one element on one level, they are 
	...
	<li>Text inside elements is converted to strings. If an 
	element has more than one text node, they will be arranged in the order they 
	are found</li>
</ul>
<p>SimpleXML is fast and easy to use when performing tasks like:</p>
<ul>
	<li>Reading/Extracting data from XML files/strings</li>
	<li>Editing text nodes or attributes</li>
</ul>
<p>However, when dealing with advanced XML, you are better off 
using the Expat parser or the XML DOM.</p>

<hr>

<h2>Installation</h2>
<p>As of PHP 5, the SimpleXML functions are part of the PHP core. No installation is required to use these functions.</p>
<hr>

<h2>PHP SimpleXML Examples</h2>
...
<p>Now we want to output different information from the XML file above:</p>
<div class="example">
<h2 class="example">Example 1</h2>
<p>Output keys and elements of the $xml variable (which is a SimpleXMLElement 
object):</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_simplexml">Run example &raquo;</a>
</div>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_simplexml2">Run example &raquo;</a>
</div>
<p>The output of the code above will be:</p>
<div class="code notranslate"><div>
Tove<br>
...
<p>Output the element's name and data for each child node:</p>
<div class="example_code notranslate">
&lt;?php<br>
$xml=simplexml_load_file(&quot;note.xml&quot;);<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_simplexml3">Run example &raquo;</a>
</div>
...
<a href="php_ref_simplexml.asp">PHP SimpleXML Reference.</a><br>
</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_xml_dom.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_xml_simplexml.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_xml_simplexml.asp#top" target="_top">TOP</a> |
		<a href="php_xml_simplexml.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
