...
<title>PHP count_chars() Function</title>
<style>a.menu_func_string_count_chars{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">count_chars()</span> Function</h1>
...
<p>Return a string with all the different characters used in &quot;Hello World!&quot; (mode 3): </p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_count_chars">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The count_chars() function returns information about characters used in a 
string (for example, how many times an ASCII character occurs in a string, or 
which characters that have been used or not been used in a string). </p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. The string to be checked</td>
  </tr>
  <tr>
    <td><em>mode</em></td>
    <td>Optional. Specifies the return modes. 
	0 is default. The different return modes are:<ul>
	<li>0 - an array with the ASCII value as key and number of occurrences as value</li>
	<li>1 - an array with the ASCII value as key and number of occurrences as value, 
	only lists occurrences greater than zero</li>
	<li>2 - an array with the ASCII value as key and number of occurrences as value, 
	only lists occurrences equal to zero are listed</li>
	<li>3 - a string with all the different characters used</li>
	<li>4 - a string with all the unused characters</li>
</ul></td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Depending on the specified <em>mode</em> parameter</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>Return a string with all the unused characters in &quot;Hello World!&quot; (mode 4): </p>
<div class="example_code notranslate">
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_count_chars2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>In this example we will use count_chars() with mode 1 to check the string. 
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_count_chars3">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 3</h2>
<p>Another example of counting how many times an ASCII character occurs in a 
string:&nbsp; </p>
<div class="example_code notranslate">

	&lt;?php<br>$str = "PHP is pretty fun!!";<br>$strArray = count_chars($str,1);<br>
	<br>foreach ($strArray as $key=&gt;$value)<br>&nbsp; {<br>echo "The character &lt;b&gt;'".chr($key)."'&lt;/b&gt; 
	was found $value time(s)&lt;br&gt;";<br>&nbsp; }<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_count_chars4">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_count_chars.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_count_chars.asp#top" target="_top">TOP</a> |
		<a href="func_string_count_chars.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
