...
<title>PHP get_browser() Function</title>
<style>a.menu_func_misc_get_browser{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">get_browser()</span> Function</h1>
...
<p>Look up the browscap.ini file and return the capabilities of the browser:</p>
<div class="example_code notranslate">
&lt;?php<br>echo $_SERVER['HTTP_USER_AGENT'];<br>$browser = get_browser();<br>
	print_r($browser);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_get_browser">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The get_browser() function looks up the user's browscap.ini file and returns 
the capabilities of the user's browser.</p>

<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
get_browser(<em>user_agent,return_array</em>)
</div></div><br>
<table class="reference notranslate">
  ...
  <tr>
    <td><em>user_agent</em></td>
    <td>Optional. Specifies the name of an HTTP user agent. 
	Default is the value of $HTTP_USER_AGENT. You can bypass this parameter with 
	NULL</td>
  </tr>
  <tr>
    <td><em>return_array</em></td>
    <td>Optional. If this parameter is set to TRUE, the function 
	will return an array instead of an object</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an object or an array with information about the 
	user's browser on success, or FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>return_array</em> parameter was added in PHP 4.3.2</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_get_browser.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_get_browser.asp#top" target="_top">TOP</a> |
		<a href="func_misc_get_browser.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
