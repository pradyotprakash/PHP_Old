...
<title>PHP ftp_set_option() Function</title>
<style>a.menu_func_ftp_set_option{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_set_option()</span> Function</h1>
...
<p>Set timeout for network operations:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// set network 
	operation timeout to 120 seconds<br>echo ftp_set_option($ftp_conn,FTP_TIMEOUT_SEC,120);<br>
...
<p>The ftp_set_option() function sets runtime options of the current FTP connection.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_set_option(<em>ftp_connection,option,value</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>option</em></td>
    <td>Required. Specifies the runtime option to set. 
	Possible values:<ul>
  ...
  <tr>
    <td><em>value</em></td>
    <td>Required. Specifies the value of the <em>option</em> parameter</td>
  </tr>
</table>
<br>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns TRUE if the option could be set, or FALSE if 
	not (a warning message is also thrown)</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.2+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_set_option.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_set_option.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_set_option.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
