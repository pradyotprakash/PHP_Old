...
<title>PHP registerXPathNamespace() Function</title>
<style>a.menu_func_simplexml_registerxpathnamespace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">registerXPathNamespace()</span> Function</h1>
...
<p>Create a namespace context for the next XPath query:</p>
<div class="example_code notranslate">
	&lt;?php<br>$xml=&lt;&lt;&lt;XML<br>&lt;book xmlns:chap=&quot;http://example.org/chapter-title&quot;&gt;<br>&nbsp; 
	&lt;title&gt;My Book&lt;/title&gt;<br>&nbsp; &lt;chapter id=&quot;1&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
	&lt;chap:title&gt;Chapter 1&lt;/chap:title&gt;<br>&nbsp;&nbsp;&nbsp; &lt;para&gt;Donec velit. 
	Nullam eget tellus...&lt;/para&gt;<br>&nbsp; &lt;/chapter&gt;<br>&nbsp; &lt;chapter id=&quot;2&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
	&lt;chap:title&gt;Chapter 2&lt;/chap:title&gt;<br>&nbsp;&nbsp;&nbsp; &lt;para&gt;Lorem ipsum 
	dolor sit amet....&lt;/para&gt;<br>&nbsp; &lt;/chapter&gt;<br>&lt;/book&gt;<br>XML;<br><br>
	$sxe=new SimpleXMLElement($xml);<br>
	$sxe-&gt;registerXPathNamespace('c','http://example.org/chapter-title');<br>
	$result=$sxe-&gt;xpath('//c:title');<br>foreach ($result as $title)<br>&nbsp; {<br>&nbsp; 
	echo $title . &quot;&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_regxpathnamespace">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The registerXPathNamespace() function creates a namespace context for the next XPath query.</p>
<p>This function is useful if a namespace prefix is changed in an XML document. 
The registerXPathNamespace() function will create a prefix for specified namespace, so that
the affected XML nodes can be accessed without altering the application code too much.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
registerXPathNamespace(<em>prefix</em>,<em>ns</em>);</div></div>
<br>
<table class="reference notranslate"> 
  <tr>
	...
	<tr>
    <td><em>prefix</em></td>
    <td>Required. Specifies the namespace prefix to use in the XPath query for the namespace given in <em>ns</em></td>
  </tr>
	<tr>
    <td><em>ns</em></td>
    <td>Required. Specifies the namespace to use for the XPath query</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns TRUE on success. FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.2+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_registerxpathnamespace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_registerxpathnamespace.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_registerxpathnamespace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
