...
<style>a.menu_func_string_nl2br{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">nl2br()</span> Function</h1>
...
<p>Insert line breaks where newlines (\n) occur in the string: </p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_nl2br">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The nl2br() function inserts HTML line breaks (&lt;br&gt; or &lt;br /&gt;) in front 
of each newline (\n) in a string.</p>
<hr>
<h2>Syntax</h2>
...
<tr>
    <td><em>xhtml&nbsp;</em></td>
    <td>Optional. A boolean value that indicates whether or not to 
	use XHTML compatible line breaks:
	<ul>
...
<tr>
	<th>Changelog:</th>
	<td>Before PHP 4.0.5, this function inserted &lt;br&gt;. After PHP 
4.0.5 it inserts the XHTML compliant &lt;br /&gt;<br><br>The <em>xhtml</em> parameter was 
	added in PHP 5.3.</td>
</tr>
</table>
<br>
...
<p>Insert line breaks where newlines (\n) occur, using the xhtml parameter: </p>
<div class="example_code notranslate">

&lt;?php<br>
echo nl2br(&quot;One line.\nAnother line.&quot;,false);<br>
?&gt;
...
<br>
<a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_nl2br2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_nl2br.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_nl2br.asp#top" target="_top">TOP</a> |
		<a href="func_string_nl2br.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
