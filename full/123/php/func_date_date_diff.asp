...
<title>PHP date_diff() Function</title>
<style>a.menu_func_date_date_diff{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_diff()</span> Function</h1>
...
&lt;?php<br>
	$date1=date_create(&quot;2013-03-15&quot;);<br>$date2=date_create(&quot;2013-12-12&quot;);<br>
	$diff=date_diff($date1,$date2);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_diff">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_diff() function returns the difference between two DateTime objects.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_diff(<em>datetime1,datetime2,absolute);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>datetime1</em></td>
    <td>Required. Specifies a DateTime object</td>
  </tr>
  <tr>
    <td><em>datetime2</em></td>
    <td>Required. Specifies a DateTime object</td>
  </tr>
  <tr>
    <td><em>absolute</em></td>
    <td>Optional. Specifies a Boolean value. TRUE indicates that the 
	interval/difference MUST be positive. Default is FALSE</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a DateInterval object on success that represents the 
	difference between the two dates. FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.3+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_date_diff.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_date_diff.asp#top" target="_top">TOP</a> |
		<a href="func_date_date_diff.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
