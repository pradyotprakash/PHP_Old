...
<title>PHP fpassthru() Function</title>
<style>a.menu_func_filesystem_fpassthru{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fpassthru()</span> Function</h1>
<hr>
...
<p>The fpassthru() function reads all data from the current position in an 
open file, until EOF, and writes the result to the output buffer.</p>
<p>This function returns the number of characters passed or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the open file or resource to read from</td>
  </tr>
  </table>
<br>
...
<p><b>Note:</b> When using fpassthru() on a binary file on Windows, remember to open the file in binary mode.</p>
<p><b>Tip:</b> Call rewind() to set the file pointer to the beginning of 
the file if you have already written to the file.</p>
<p><b>Tip:</b> If you just want to dump the contents of a file to the output buffer, without 
first modifying it, use the readfile() function instead.</p>
<hr>
...
fgets($file);<br>
<br>
// Send rest of the file to the output buffer<br>
echo fpassthru($file);<br>
<br>
fclose($file);<br>
?&gt; 
...
There are three lines in this file.<br>
This is the last line.59

</div></div>
<p>59 indicates the number of characters passed.</p>
<hr>

<h2>Example 2</h2>
<p>Dump index page of a www server:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fpassthru.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fpassthru.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fpassthru.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
