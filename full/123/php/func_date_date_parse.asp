...
<title>PHP date_parse() Function</title>
<style>a.menu_func_date_date_parse{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_parse()</span> Function</h1>
...
<p>Return an associative array with detailed information about a specified date:</p>
<div class="example_code notranslate">
&lt;?php<br>
	print_r(date_parse(&quot;2013-05-01 12:30:45.5&quot;));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_parse">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_parse() function returns an associative array with detailed information about a specified date.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_parse(<em>date);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>date</em></td>
    <td>Required. Specifies a date (in a format accepted by
	<a href="func_date_strtotime.asp">strtotime()</a>)</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an associative array containing information about the parsed 
	date on success. FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.2+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_date_parse.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_date_parse.asp#top" target="_top">TOP</a> |
		<a href="func_date_date_parse.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
