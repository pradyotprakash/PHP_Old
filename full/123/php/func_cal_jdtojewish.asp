...
<title>PHP jdtojewish() Function</title>
<style>a.menu_func_cal_jdtojewish{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">jdtojewish()</span> Function</h1>
...
<p>Convert a Julian Day Count to a Jewish date:</p>
<div class="example_code notranslate">
&lt;?php<br>
$jd=jdtojewish(1789430); <br>echo $jd;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_jdtojewish">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The jdtojewish() function converts a Julian Day Count to a Jewish date.</p>
<p><strong>Tip:</strong> Look at the <a href="func_cal_jewishtojd.asp">jewishtojd()</a> function to convert
a Jewish date to a Julian Day Count.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
jdtojewish(<em>jd,hebrew,fl);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>hebrew</em></td>
    <td>Optional. When set to TRUE it indicates Hebrew output format. FALSE is 
	default</td>
  </tr>
  <tr>
    <td><em>fl</em></td>
    <td>Optional. Defines the Hebrew output format. The available formats are:
    <ul>
...
<tr>
	...
	<td style="width:80%">Returns a Jewish date in format &quot;month/day/year&quot;</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>hebrew</em> parameter was added in PHP 4.3, and the <em>fl</em> 
	parameter was added in PHP 5.0</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_jdtojewish.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_jdtojewish.asp#top" target="_top">TOP</a> |
		<a href="func_cal_jdtojewish.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
