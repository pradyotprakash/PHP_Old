...
<title>PHP FILTER_SANITIZE_SPECIAL_CHARS Filter</title>
<style>a.menu_filter_sanitize_special_chars{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_SANITIZE_SPECIAL_CHARS</span> Filter</h1>
<hr>
...
<p>The FILTER_SANITIZE_SPECIAL_CHARS filter HTML-escapes special characters.</p>
<p>This filter is used to escape &quot;&lt;&gt;&amp; and characters with ASCII value below 32</p>
<ul>
	<li>Name: &quot;special_chars&quot;</li>
	<li>ID-number: 515</li>
</ul>
<p>Possible flags:</p>
<ul>
...
&lt;?php<br>
$url=&quot;Is Peter &lt;smart&gt; &amp; funny?&quot;;<br>
<br>
var_dump(filter_var($url,FILTER_SANITIZE_SPECIAL_CHARS));<br>
?&gt;
...
string(37) &quot;Is Peter &amp;<span class="entity">lt;</span>smart&amp;<span class="entity">gt;</span> &amp;<span class="entity">amp;</span> funny?&quot;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_sanitize_special_chars.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_sanitize_special_chars.asp#top" target="_top">TOP</a> |
		<a href="filter_sanitize_special_chars.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
