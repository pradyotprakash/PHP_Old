...
<title>PHP asXML() Function</title>
<style>a.menu_func_simplexml_asxml{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">asXML()</span> Function</h1>
...
<p>Format the SimpleXML object's data in XML (version 1.0):</p>
<div class="example_code notranslate">
	...
	$xml=new SimpleXMLElement($note);<br>echo $xml-&gt;asXML();<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_asxml">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The asXML() function formats the SimpleXML object's data in XML (version 1.0).</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	asXML(<em>filename</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the name of the file to write the data tod</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a string on success. FALSE on failure. If the <em>
	filename</em> parameter is specified, it returns TRUE on success, FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_asxml.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_asxml.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_asxml.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
