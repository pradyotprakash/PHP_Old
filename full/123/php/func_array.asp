...
<style>a.menu_func_array{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array()</span> Function</h1>
...
<p>Create an indexed array named $cars, assign three elements to it, and then 
print a text containing the array values:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array">Run example &raquo;</a>
</div>
<hr>
...
<ul>
  <li><b>Indexed arrays</b> - Arrays with numeric index</li>
...
<h2>Syntax</h2>
<p>Syntax for indexed arrays:</p>
<div class="code notranslate"><div>
	array(<em>value1,value2,value3,etc.</em>);</div></div>

<p>Syntax for associative arrays:&nbsp;</p>
<div class="code notranslate"><div>
	array(<em>key=&gt;value,key=&gt;value,key=&gt;value,etc.</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td>key</td>
    <td>Specifies the key (numeric or string)</td>
  </tr>
  <tr>
    <td>value</td>
...
<tr>
	...
	<td style="width:80%">Returns an array of the parameters</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 5.4, it is possible to use a short array syntax, which 
	replaces array() with []. <br>E.g. $cars=[&quot;Volvo&quot;,&quot;BMW&quot;]; instead of
	$cars=array(&quot;Volvo&quot;,&quot;BMW&quot;);</td>
</tr>
</table>
<br>
<hr>
...
<p>Create an associative array named $age:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$age=array(&quot;Peter&quot;=&gt;&quot;35&quot;,&quot;Ben&quot;=&gt;&quot;37&quot;,&quot;Joe&quot;=&gt;&quot;43&quot;);<br>echo &quot;Peter is &quot; . 
	$age['Peter'] . &quot; years old.&quot;;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Loop through and print all the values of an indexed array:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$cars=array(&quot;Volvo&quot;,&quot;BMW&quot;,&quot;Toyota&quot;);<br>
	$arrlength=count($cars);<br><br>for($x=0;$x&lt;$arrlength;$x++)<br>&nbsp; {<br>&nbsp; 
	echo $cars[$x];<br>&nbsp; echo &quot;&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array3">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 3</h2>
<p>Loop through and print all the values of an associative array:</p>
<div class="example_code notranslate">
	&lt;?php<br>$age=array(&quot;Peter&quot;=&gt;&quot;35&quot;,&quot;Ben&quot;=&gt;&quot;37&quot;,&quot;Joe&quot;=&gt;&quot;43&quot;);<br>
	<br>foreach($age as $x=&gt;$x_value)<br>&nbsp; {<br>&nbsp; echo &quot;Key=&quot; . $x . 
	&quot;, Value=&quot; . $x_value;<br>&nbsp; echo &quot;&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array4">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 4</h2>
<p>Create a multidimensional array:</p>
<div class="example_code notranslate">
	&lt;?php<br>// A two-dimensional array:<br>$cars=array<br>&nbsp; (<br>&nbsp; 
	array(&quot;Volvo&quot;,100,96),<br>&nbsp; array(&quot;BMW&quot;,60,59),<br>&nbsp; 
	array(&quot;Toyota&quot;,110,100)<br>&nbsp; );<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array5">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array.asp#top" target="_top">TOP</a> |
		<a href="func_array.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
