...
<title>PHP FILTER_VALIDATE_INT Filter</title>
<style>a.menu_filter_validate_int{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_VALIDATE_INT</span> Filter</h1>
<hr>
...
<p>The FILTER_VALIDATE_INT filter validates value as integer.</p>
<ul>
	<li>Name: &quot;int&quot;</li>
	<li>ID-number: 257</li>
</ul>
...
<ul>
	<li>min_range - specifies the minimum integer value</li>
	<li>max_range - specifies the maximum integer value</li>
	<li>FILTER_FLAG_ALLOW_OCTAL - allows octal number values</li>
	<li>FILTER_FLAG_ALLOW_HEX - allows hexadecimal number values</li>
</ul>
<hr>

<h2>Tips and Notes</h2>

<p><b>Note: </b>When specifying options in an array. The options must be in an 
associative multidimensional array with the name &quot;options&quot;. See example below</p>
<hr>
<h2>Example</h2>
...
$var=300;<br>
<br>
$int_options = array(&quot;options&quot;=&gt;<br>
array(&quot;min_range&quot;=&gt;0, &quot;max_range&quot;=&gt;256));<br>
<br>
var_dump(filter_var($var, FILTER_VALIDATE_INT, $int_options));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_validate_int.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_validate_int.asp#top" target="_top">TOP</a> |
		<a href="filter_validate_int.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
