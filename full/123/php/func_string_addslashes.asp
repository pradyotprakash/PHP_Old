...
<style>a.menu_func_string_addslashes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">addslashes()</span> Function</h1>
...
<p>Add a backslash in front of each double quote (&quot;):</p>
<div class="example_code notranslate">

	&lt;?php <br>$str = addslashes('What does &quot;yolo&quot; mean?');<br>echo($str); <br>?&gt; 
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_addslashes">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The addslashes() function returns a string with backslashes in front of 
...
<p><b>Tip:</b> This function can be used to prepare a string for storage in a 
database and database queries.</p>
<p><b>Note:</b> PHP runs addslashes() on all GET, POST, and COOKIE data by 
...
<p>Add backslashes to the predefined characters in a string:</p>
<div class="example_code notranslate">

&lt;?php<br>
$str = &quot;Who's Peter Griffin?&quot;;<br>
echo $str . &quot; This is not safe in a database query.&lt;br&gt;&quot;;<br>
echo addslashes($str) . &quot; This is safe in a database query.&quot;;<br>
?&gt;

</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_addslashes2">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_addslashes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_addslashes.asp#top" target="_top">TOP</a> |
		<a href="func_string_addslashes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
