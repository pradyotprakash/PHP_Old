...
<title>PHP debug_backtrace() Function</title>
<style>a.menu_func_error_debug_backtrace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">debug_backtrace()</span> Function</h1>
<hr>
...
<p>The debug_backtrace() function generates a backtrace.</p>
<p>This function displays data from the code that led up to the 
debug_backtrace() function.</p>
<p>Returns an associative array. The possible returned elements are as follows: </p>
<table class="reference notranslate">
	...
	<tr>
		<td>function</td>
		<td>string</td>
		<td>The current function name</td>
	</tr>
	<tr>
		<td>line</td>
		<td>integer</td>
	...
	<tr>
		<td>type</td>
		<td>string</td>
		<td>The current call type. Possible calls:<ul>
			<li>Returns: &quot;-&gt;&quot;&nbsp; - Method call</li>
			<li>Returns: &quot;::&quot;&nbsp; - Static method call</li>
			<li>Returns nothing - Function call</li>
		</ul>
		</td>
	</tr>
	<tr>
		<td>args</td>
		<td>array</td>
		<td>If inside a function, this lists the functions arguments. If inside 
an included file, this lists the included file name </td>
	</tr>
</table>
...
&lt;?php<br>
function one($str1, $str2)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;two(&quot;Glenn&quot;, &quot;Quagmire&quot;);<br>
&nbsp;&nbsp;}<br>
function two($str1, $str2)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;three(&quot;Cleveland&quot;, &quot;Brown&quot;);<br>
&nbsp;&nbsp;}<br>
function three($str1, $str2)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;print_r(debug_backtrace());<br>
&nbsp;&nbsp;}<br>
<br>
one(&quot;Peter&quot;, &quot;Griffin&quot;);<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_error_debug_backtrace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_error_debug_backtrace.asp#top" target="_top">TOP</a> |
		<a href="func_error_debug_backtrace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
