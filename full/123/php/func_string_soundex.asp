...
<title>PHP soundex() Function</title>
<style>a.menu_func_string_soundex{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">soundex()</span> Function</h1>
...
<p>Calculate the soundex key of "Hello":</p>
...
echo soundex($str);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_soundex">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The soundex() function calculates the soundex key of a string.</p>
<p>A soundex 
key is a four character long alphanumeric string that represent English 
pronunciation of a word.</p>
<p>The soundex() function can be used for spelling applications.</p>

<p><b>Note:</b> The soundex() function creates the same key for similar 
sounding words.</p>
<p><b>Tip:</b> <a href="func_string_metaphone.asp">metaphone()</a> is more accurate than soundex(), because metaphone() knows the basic rules of English pronunciation. </p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

soundex(<em>string</em>)
...
<tr>
	...
	<td style="width:80%">Returns the soundex key of the string on success, or FALSE on failure.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>Using the soundex() function on two similar sounding words: </p>
<div class="example_code notranslate">
...
echo soundex($str);<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo soundex($str2);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_soundex2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_soundex.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_soundex.asp#top" target="_top">TOP</a> |
		<a href="func_string_soundex.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
