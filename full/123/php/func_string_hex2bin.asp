...
<title>PHP hex2bin() Function</title>
<style>a.menu_func_string_hex2bin{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">hex2bin()</span> Function</h1>
...
<p>Convert hexadecimal values to ASCII characters:</p>
<div class="example_code notranslate">

&lt;?php<br>echo hex2bin(&quot;48656c6c6f20576f726c6421&quot;);<br>
?&gt;</div>
...
<p>The hex2bin() function converts a string of hexadecimal values to ASCII 
characters.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. The hexadecimal value to be converted</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the ASCII character of the converted string, 
	or FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.4.0+</td>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 5.4.1, a warning is thrown if the string is of odd 
	length. In PHP 5.4.0, the string was silently accepted, but the last byte 
	was removed.<br><br>As of PHP 5.5.1, a warning is thrown if the string is 
	invalid hexadecimal string.</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_hex2bin.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_hex2bin.asp#top" target="_top">TOP</a> |
		<a href="func_string_hex2bin.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
