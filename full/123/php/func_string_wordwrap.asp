...
<style>a.menu_func_string_wordwrap{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">wordwrap()</span> Function</h1>
...
<p>Wrap a string into new lines when it reaches a specific length:</p>
<div class="example_code notranslate">

	&lt;?php<br>
$str = &quot;An example of a long word is: Supercalifragulistic&quot;;<br>
echo wordwrap($str,15,&quot;&lt;br&gt;\n&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_wordwrap">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The wordwrap() function wraps a string into new lines when it reaches a specific 
length.</p>
<p><b>Note:</b> This function may leave white spaces at the beginning of a line.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

wordwrap(<em>string,width,break,cut</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to break up into lines</td>
  </tr>
	<tr>
    <td><em>width</em></td>
    <td>Optional. Specifies the maximum line width. Default is 75</td>
  </tr>
	<tr>
    <td><em>break</em></td>
    <td>Optional. Specifies the characters to use as 
	break. Default is &quot;\n&quot;</td>
  </tr>
  <tr>
    <td><em>cut</em></td>
...
<tr>
	...
	<td style="width:80%">Returns the string broken into lines on success, or FALSE on 
	failure.</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>cut</em> parameter was added in PHP 4.0.3</td>
</tr>
</table>
<br>
...
echo wordwrap($str,15,&quot;&lt;br&gt;\n&quot;,TRUE);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_wordwrap2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Wrap a string into new lines:</p>
<div class="example_code notranslate">
	&lt;?php<br>
$str = &quot;An example of a long word is: Supercalifragulistic&quot;;<br>
echo wordwrap($str,15);<br>
...
An example of a long word is: Supercalifragulistic </div>
<br>
<a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_wordwrap3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_wordwrap.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_wordwrap.asp#top" target="_top">TOP</a> |
		<a href="func_string_wordwrap.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
