...
<title>PHP mysqli_field_count() Function</title>
<style>a.menu_func_mysqli_field_count{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_field_count()</span> Function</h1>
...
<p>Assume we have a &quot;Friends&quot; table that has 3 fields and 20 rows. Return the number of columns for the most recent query:</p>
...
&nbsp;&nbsp;}<br><br>mysqli_query($con,&quot;SELECT * FROM Friends&quot;);<br>// Get 
	number of columns - will always return 3<br>mysqli_field_count($con);<br>
...
<p>The mysqli_field_count() function returns the number of columns for the most recent query.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_field_count(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an integer that represents the number of columns in 
	the result set</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_field_count.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_field_count.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_field_count.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
