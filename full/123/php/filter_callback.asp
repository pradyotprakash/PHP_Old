...
<title>PHP FILTER_CALLBACK Filter</title>
<style>a.menu_filter_callback{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_CALLBACK</span> Filter</h1>
<hr>
...
<p>The FILTER_CALLBACK filter calls a user defined function to filter the value.</p>
<p>This filter gives us full control over the data filtering</p>
<p>The specified functions must be in an 
associative array with the name &quot;options&quot;. See example below</p>
<ul>
	<li>Name: &quot;callback&quot;</li>
	<li>ID-number: 1024</li>
</ul>
<hr>

<h2>Tips and Notes</h2>

<p><b>Tip: </b>You can create your own user defined function or use an existing 
PHP function</p>
<hr>
<h2>Example 1</h2>
<p>Using a user defined function:</p>
...
&nbsp;&nbsp;}<br>
<br>
$string = &quot;Peter is a great guy!&quot;;<br>
<br>
...
<hr>
<h2>Example 2</h2>
<p>Using an existing PHP function</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_callback.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_callback.asp#top" target="_top">TOP</a> |
		<a href="filter_callback.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
