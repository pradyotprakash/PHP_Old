...
<title>PHP timezone_version_get() Function</title>
<style>a.menu_func_date_timezone_version_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">timezone_version_get()</span> Function</h1>
...
<p>Return the version of the timezone db:</p>
<div class="example_code notranslate">
&lt;?php<br>
	echo timezone_version_get();<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_tz_version_get">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The timezone_version_get() function returns the version of the timezone db.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
timezone_version_get();</div></div>

<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td style="width:80%">Returns the version of the timezone db as a string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.3+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_timezone_version_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_timezone_version_get.asp#top" target="_top">TOP</a> |
		<a href="func_date_timezone_version_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
