...
<title>PHP getdate() Function</title>
<style>a.menu_func_date_getdate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">getdate()</span> Function</h1>
...
<p>Return date/time information of the current local date/time:</p>
<div class="example_code notranslate">

&lt;?php<br>
print_r(getdate());<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_getdate">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getdate() function returns date/time information of a timestamp or the current local date/time.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	getdate(<em>timestamp);</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an associative array with information related to the 
	timestamp:<ul>
	<li>[seconds] - seconds</li>
	<li>[minutes] - minutes</li>
	<li>[hours] - hours</li>
	<li>[mday] - day of the month</li>
	<li>[wday] - day of the week</li>
		<li>[mon] - month</li>
	<li>[year] - year</li>
	<li>[yday] - day of the year</li>
	<li>[weekday] - name of the weekday</li>
	<li>[month] - name of the month</li>
		<li>[0] - seconds since Unix Epoch</li>
</ul>
	</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_getdate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_getdate.asp#top" target="_top">TOP</a> |
		<a href="func_date_getdate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
