...
<style>a.menu_func_string_substr_count{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">substr_count()</span> Function</h1>
...
<p>Count the number of times &quot;world&quot; occurs in the string:</p>
<div class="example_code notranslate">
&lt;?php<br>
echo substr_count(&quot;Hello world. The world is nice&quot;,&quot;world&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_count">Run example &raquo;</a>
</div>
<hr>

<p>The substr_count() function counts the number of times a substring occurs in a string.</p>
<p><strong>Note:</strong> The substring is case-sensitive.</p>
<p><strong>Note:</strong> This function does not count overlapped substrings (see example 2).</p>
<p><strong>Note:</strong> This function generates a warning if the start 
parameter plus the length parameter is greater than the string length (see example 3).</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
substr_count(<em>string,substring,start,length</em>)
</div></div><br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td><em>substring</em></td>
    <td>Required. Specifies the string to search for </td>
  </tr>
	<tr>
    <td><em>start</em></td>
    <td>Optional. Specifies where in string to start searching</td>
  </tr>
  <tr>
    <td><em>length</em></td>
    <td>Optional. Specifies the length of the search</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the&nbsp; the number of times the substring occurs 
	in the string</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>start</em> and <em>length</em> parameters were added in PHP 5.1</td>
</tr>
</table>
<br>
<hr>
...
<div class="example_code notranslate">
&lt;?php<br>
	$str = &quot;This is nice&quot;;<br>echo strlen($str).&quot;&lt;br&gt;&quot;; // Using strlen() to 
	return the string length<br>echo substr_count($str,&quot;is&quot;).&quot;&lt;br&gt;&quot;; // The 
	number of times &quot;is&quot; occurs in the string<br>echo substr_count($str,&quot;is&quot;,2).&quot;&lt;br&gt;&quot;; 
	// The string is now reduced to &quot;is is PHP&quot;<br>echo substr_count($str,&quot;is&quot;,3).&quot;&lt;br&gt;&quot;; 
	// The string is now reduced to &quot;s is PHP&quot;<br>echo substr_count($str,&quot;is&quot;,3,3).&quot;&lt;br&gt;&quot;; 
	// The string is now reduced to &quot;s i&quot;<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_count2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Overlapped substrings:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$str = &quot;abcabcab&quot;; <br>echo substr_count($str,&quot;abcab&quot;); // This function 
	does not count overlapped substrings<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_count3">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 3</h2>
<p>If the start and length parameters exceeds the string length, this function 
will output a warning: </p>
<div class="example_code notranslate">
&lt;?php<br>
	echo $str = &quot;This is nice&quot;;<br>substr_count($str,&quot;is&quot;,3,9);<br>
?&gt;
</div>
<p>This will output a warning because the length value exceeds the string length (3+9 is greater than 12)</p>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_substr_count.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_substr_count.asp#top" target="_top">TOP</a> |
		<a href="func_string_substr_count.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
