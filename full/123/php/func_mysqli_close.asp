...
<style>a.menu_func_mysqli_close{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_close()</span> Function</h1>
...
<p>Close a previously opened database connection:</p>
...
<p>The mysqli_close() function closes a previously opened database connection.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_close(<em>connection</em>)<em>;</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the MySQL connection to close</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_close.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_close.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_close.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
