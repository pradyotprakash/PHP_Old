...
<title>PHP filter_input() Function</title>
<style>a.menu_func_filter_input{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filter_input()</span> Function</h1>
<hr>
...
<p>The filter_input() function gets external variables (like form input) and 
filters them.</p>
<p>This function is used to validate variables form insecure sources such as 
user input.</p>
...
<p>Returns the filtered data on success, FALSE on failure or NULL if the 
&quot;variable&quot; parameter is not set.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
	...
	<tr>
		<td>variable</td>
		<td>Required. Specifies the variable to filter</td>
	</tr>
	<tr>
		<td>filter</td>
		<td>Optional. Specifies the ID of the filter to use. 
		Default is FILTER_SANITIZE_STRING.&nbsp; Check the
		<a href="php_ref_filter.asp">Complete PHP Filter Reference</a> for 
		possible filters<p>A filter ID can be an ID name (like FILTER_VALIDATE_EMAIL) 
		or an ID number (like 274)</td>
	</tr>
	<tr>
		<td>options</td>
		<td>Optional. Specifies an associative array of flags/options or 
		a single flag/option. Check each filter for possible options and flags</td>
	</tr>
</table>
...
<hr>
<h2>Example</h2>
<p>In this example we use the filter_input() function to filter a POST variable. 
The received POST variable is a valid e-mail address:</p>

<div class="code notranslate"><div>

&lt;?php<br>
if (!filter_input(INPUT_POST, 'email', FILTER_VALIDATE_EMAIL))<br>
&nbsp;&nbsp;{<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filter_input.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filter_input.asp#top" target="_top">TOP</a> |
		<a href="func_filter_input.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
