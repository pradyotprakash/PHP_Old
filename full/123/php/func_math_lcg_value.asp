...
<title>PHP lcg_value() Function</title>
<style>a.menu_func_math_lcg_value{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">lcg_value()</span> Function</h1>
...
<p>Return a pseudo random number in a range between 0 and 1:</p>
<div class="example_code notranslate">
&lt;?php<br>
echo lcg_value();<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_lcg_value">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The lcg_value() function returns a pseudo random number in a range between 0 and 1.</p>
<hr>
...
<tr>
	...
	<td style="width:80%">A pseudo random float value in a range between 0 and 1</td>
</tr>
	<tr>
	<th>Return Type:</th>
	<td>Float</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_lcg_value.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_lcg_value.asp#top" target="_top">TOP</a> |
		<a href="func_math_lcg_value.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
