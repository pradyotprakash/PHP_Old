...
<title>PHP jdtounix() Function</title>
<style>a.menu_func_cal_jdtounix{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">jdtounix()</span> Function</h1>
...
<p>Convert a Gregorian date to a Julian Day Count; then convert the Julian Day Count to Unix timestamp:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$jd=gregoriantojd(10,3,1975);<br>echo jdtounix($jd);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_jdtounix">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The jdtounix() function converts Julian Day Count to Unix timestamp.</p>
<p><strong>Note:</strong> This function will return false if the parameter <em>jd</em> is not inside the Unix epoch
(which means that the Gregorian years must be between 1970 and 2037 OR that jd &gt;= 2440588 and jd &lt;= 2465342).
The time returned is local time.</p>
<p><strong>Tip:</strong> Look at the <a href="func_cal_unixtojd.asp">unixtojd()</a> function to convert 
Unix timestamp to Julian Day Count.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	jdtounix<em>(jd);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>jd</em></td>
    <td>Required. A Julian Day number between 2440588 and 2465342</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the Unix timestamp for the start of the specified Julian day</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_jdtounix.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_jdtounix.asp#top" target="_top">TOP</a> |
		<a href="func_cal_jdtounix.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
