...
<title>PHP FILTER_SANITIZE_STRIPPED Filter</title>
<style>a.menu_filter_sanitize_stripped{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_SANITIZE_STRIPPED</span> Filter</h1>
<hr>
...
<p>The FILTER_SANITIZE_STRIPPED filter strips or encodes unwanted characters.</p>
<p>This filter is an alias of the FILTER_SANITIZE_STRING filter</p>
<p>This filter removes data that is potentially harmful for your application. It 
is used to strip tags and remove or encode unwanted characters.</p>
<ul>
	<li>Name: &quot;stripped&quot;</li>
	<li>ID-number: 513</li>
</ul>
<p>Possible options and flags:</p>
<ul>
	<li>FILTER_FLAG_NO_ENCODE_QUOTES - This flag does not encode quotes</li>
	<li>FILTER_FLAG_STRIP_LOW - Strip characters with ASCII value below 32</li>
	<li>FILTER_FLAG_STRIP_HIGH - Strip characters with ASCII value above 32</li>
	<li>FILTER_FLAG_ENCODE_LOW - Encode characters with ASCII value below 32</li>
	<li>FILTER_FLAG_ENCODE_HIGH - Encode characters with ASCII value above 32</li>
	<li>FILTER_FLAG_ENCODE_AMP - Encode the &amp; character to &amp;amp;</li>
</ul>
<hr>
<h2>Example</h2>
...
&lt;?php<br>
$var=&quot;&lt;b&gt;Peter Griffin&lt;b&gt;&quot;;<br>
<br>
var_dump(filter_var($var, FILTER_SANITIZE_STRIPPED));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_sanitize_stripped.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_sanitize_stripped.asp#top" target="_top">TOP</a> |
		<a href="filter_sanitize_stripped.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
