...
<title>PHP md5() Function</title>
<style>a.menu_func_string_md5{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">md5()</span> Function</h1>
...
<p>Calculate the MD5 hash of the string &quot;Hello&quot;:</p>
...
echo md5($str);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_md5">Run example &raquo;</a>
</div>
<hr>
...
<p>The md5() function uses the RSA Data Security, Inc. MD5 Message-Digest 
Algorithm.</p>
<p>From RFC 1321 - 
The MD5 Message-Digest Algorithm: <i>&quot;The MD5 message-digest algorithm takes as 
...
<p>To calculate the MD5 hash of a file, use the
<a href="func_string_md5_file.asp">md5_file()</a> function.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>raw</em></td>
    <td>Optional. Specifies hex or binary output 
	format:<ul>
...
<tr>
	...
	<td style="width:80%">Returns the calculated MD5 hash on success, or FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<p>Print the result of md5():</p>
<div class="example_code notranslate">

	&lt;?php <br>$str = &quot;Hello&quot;; <br>echo &quot;The string: &quot;.$str.&quot;&lt;br&gt;&quot;; <br>echo 
	&quot;TRUE - Raw 16 character binary format: &quot;.md5($str, TRUE).&quot;&lt;br&gt;&quot;; <br>echo 
	&quot;FALSE - 32 character hex number: &quot;.md5($str).&quot;&lt;br&gt;&quot;; <br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_md52">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Print the result of md5() and then test it: </p>
<div class="example_code notranslate">

	&lt;?php<br>$str = &quot;Hello&quot;;<br>echo md5($str);<br><br>if (md5($str) == 
	&quot;8b1a9953c4611296a827abf8c47804d7&quot;)<br>&nbsp; {<br>&nbsp; echo &quot;&lt;br&gt;Hello 
	world!&quot;;<br>&nbsp; exit;<br>&nbsp; }<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_md53">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_md5.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_md5.asp#top" target="_top">TOP</a> |
		<a href="func_string_md5.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
