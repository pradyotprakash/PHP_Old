...
<title>PHP str_getcsv() Function</title>
<style>a.menu_func_string_str_getcsv{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">str_getcsv()</span> Function</h1>
...
<p>The str_getcsv() function parses a string for fields in CSV format and 
returns an array containing the fields read.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

	str_getcsv(<em>string,separator,enclosure,escape</em>)
...
<table class="reference notranslate"> 
 ...
 <tr>
    <td><em>escape</em></td>
    <td>Optional. A character that specifies the escape character. Default is backslash (\)</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the CSV fields in an array</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.3.0+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_str_getcsv.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_str_getcsv.asp#top" target="_top">TOP</a> |
		<a href="func_string_str_getcsv.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
