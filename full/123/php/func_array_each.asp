...
<title>PHP each() Function</title>
<style>a.menu_func_array_each{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">each()</span> Function</h1>
...
<p>Return the current element key and value, and move the internal pointer 
forward:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_each">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The each() function returns the current element key and value, and moves the internal pointer 
forward.</p>
<p>This element key and value is returned in an array with four elements. Two 
elements (1 and Value) for the element value, and two elements (0 and Key) for 
the element key. </p>
<p>Related methods:</p>
<ul>
	<li><a href="func_array_current.asp">current()</a> - returns the value of 
	the current element in an array</li>
	<li><a href="func_array_end.asp">end()</a> - moves the internal pointer to, and outputs, the last element in 
	the array</li>
	<li><a href="func_array_next.asp">next()</a> - moves the internal pointer to, and outputs, the next element in 
	the array</li>
	<li><a href="func_array_prev.asp">prev()</a> - moves the internal pointer to, and outputs, the previous element 
	in the array</li>
	<li><a href="func_array_reset.asp">reset()</a> - moves the internal pointer to the first element of the array</li>
</ul>
<hr>
...
<tr>
	...
	Returns the current element key and value. This element key and value is 
	returned in an array with four elements. Two elements (1 and Value) for the 
	element value, and two elements (0 and Key) for the element key. This 
	function returns FALSE if there are no more array elements</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>Same example as the one on top of the page, but with a loop to output the 
whole array:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$people = array(&quot;Peter&quot;, &quot;Joe&quot;, &quot;Glenn&quot;, &quot;Cleveland&quot;);<br><br>
	reset($people);<br><br>while (list($key, $val) = each($people))<br>&nbsp; {<br>&nbsp; 
	echo &quot;$key =&gt; $val&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_each2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>A demonstration of all related methods:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$people = array(&quot;Peter&quot;, &quot;Joe&quot;, &quot;Glenn&quot;, &quot;Cleveland&quot;);<br><br>echo 
	current($people) . &quot;&lt;br&gt;&quot;; // The current element is Peter<br>echo 
	next($people) . &quot;&lt;br&gt;&quot;; // The next element of Peter is Joe<br>echo 
	current($people) . &quot;&lt;br&gt;&quot;; // Now the current element is Joe<br>echo prev($people) . &quot;&lt;br&gt;&quot;; 
	// The previous element of Joe is Peter<br>echo end($people) . &quot;&lt;br&gt;&quot;; // 
	The last element is Cleveland<br>echo prev($people) . &quot;&lt;br&gt;&quot;; // The 
	previous element of Cleveland is Glenn<br>echo current($people) . &quot;&lt;br&gt;&quot;; // 
	Now the current element is Glenn<br>echo reset($people) . &quot;&lt;br&gt;&quot;; // Moves 
	the internal pointer to the first element of the array, which is Peter<br>
	echo next($people) . &quot;&lt;br&gt;&quot;; // The next element of Peter is Joe<br><br>
	print_r (each($people)); // Returns the key and value of the current element 
	(now Joe), and moves the internal pointer forward<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_internal_pointer">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_each.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_each.asp#top" target="_top">TOP</a> |
		<a href="func_array_each.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
