...
<style>a.menu_php_date{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Date()</span> Function</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_arrays_multi.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_includes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The PHP date() function is used to format a time and/or date.</p>
<hr>
...
<td>A timestamp is a sequence of 
characters, denoting the date and/or time at which a certain event occurred.</td>
</tr></table>
...
<p>The required <i>format</i> parameter in the date() function specifies how to format the date/time.</p>
...
<p>A list of all the characters that can be used in the <i>format</i> parameter, can 
be found in our PHP Date reference, <a href="func_date_date.asp">date() function</a>.</p>
<p>Other characters, like&quot;/&quot;, &quot;.&quot;, or &quot;-&quot; can also be inserted between the 
letters to add additional formatting:</p>
...
<p>The optional <i>timestamp</i> parameter in the date() function specifies a timestamp. If you do not 
specify a timestamp, the current date and time will be used.</p>
<p>The mktime() function returns the Unix timestamp for a date.</p>
<p>The Unix timestamp contains the number of seconds between the Unix Epoch 
(January 1 1970 00:00:00 GMT) and the time specified.</p>
...
<p>For a complete reference of all date functions, go to our
<a href="php_ref_date.asp">complete PHP Date Reference</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_date.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_date.asp#top" target="_top">TOP</a> |
		<a href="php_date.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
