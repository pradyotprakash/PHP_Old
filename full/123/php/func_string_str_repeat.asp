...
<style>a.menu_func_string_str_repeat{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">str_repeat()</span> Function</h1>
...
<p>Repeat the string &quot;.&quot; 13 times:</p>
<div class="example_code notranslate">

&lt;?php<br>
echo str_repeat(&quot;.&quot;,13);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_repeat">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The str_repeat() function repeats a string a specified number of times.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

str_repeat(<em>string,repeat</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to repeat</td>
  </tr>
  <tr>
    <td><em>repeat</em></td>
    <td>Required. Specifies the number of times the string will be 
	repeated. Must be greater or equal to 0</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the repeated string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_str_repeat.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_str_repeat.asp#top" target="_top">TOP</a> |
		<a href="func_string_str_repeat.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
