...
<title>PHP getrandmax() Function</title>
<style>a.menu_func_math_getrandmax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">getrandmax()</span> Function</h1>
...
<p>Return largest possible random value that can be returned by rand():</p>
<div class="example_code notranslate">
&lt;?php<br>
echo(getrandmax()); <br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_getrandmax">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getrandmax() function returns the largest possible value that can be 
returned by <a href="func_math_rand.asp">rand()</a>.</p>
<hr>
...
<tr>
	...
	<td style="width:80%">The largest possible value returned by rand()</td>
</tr>
	<tr>
	<th>Return Type:</th>
	<td>Integer</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_getrandmax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_getrandmax.asp#top" target="_top">TOP</a> |
		<a href="func_math_getrandmax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
