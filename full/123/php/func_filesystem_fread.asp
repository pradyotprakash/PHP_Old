...
<style>a.menu_func_filesystem_fread{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fread()</span> Function</h1>
<hr>
...
<p>The fread() reads from an open file.</p>
<p>The function 
	will stop at the end of the file or when it reaches the specified length, whichever comes first.</p>
<p>This function returns the read string, or FALSE on failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the open file to read from</td>
  </tr>
	<tr>
    <td>length</td>
    <td>Required. Specifies the maximum number of bytes to read</td>
  </tr>
  </table>
<br>
...
<h2>Example 2</h2>
<p>Read entire file:</p>

<div class="code notranslate"><div>

&lt;?php<br>
$file = fopen(&quot;test.txt&quot;,&quot;r&quot;);<br>
fread($file,filesize(&quot;test.txt&quot;));<br>
fclose($file);<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fread.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fread.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fread.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
