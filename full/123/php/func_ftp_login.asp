...
<title>PHP ftp_login() Function</title>
<style>a.menu_func_ftp_login{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_login()</span> Function</h1>
...
&lt;?php<br>// connect to FTP server<br>
	$ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or 
	die(&quot;Could not connect to $ftp_server&quot;);<br><br>// login<br>if (@ftp_login($ftp_conn, $ftp_username, $ftp_userpass))<br>&nbsp; 
	{<br>&nbsp; echo &quot;Connection established.&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Couldn't 
	establish a connection.&quot;;<br>&nbsp; }<br><br>// do 
...
<p>The ftp_login() function logs in to the specified FTP connection.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_login(<em>ftp_connection,username,password</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the username to login with</td>
  </tr>
  <tr>
    <td><em>password</em></td>
    <td>Required. Specifies the password to login with</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns TRUE on success or FALSE and a warning on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_login.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_login.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_login.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
