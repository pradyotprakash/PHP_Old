...
<style>a.menu_php_ajax_livesearch{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ajax_xml.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ajax_rss_reader.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">AJAX can be used to create more user-friendly and interactive searches.</p>
<hr>

<h2>AJAX Live Search</h2>
<p>The following example will demonstrate a live search, where you get search results while you type.</p>
...
<p>The results in the example above are found in an XML file
(<a target="_blank" href="links.xml">links.xml</a>). To make this 
...
<p>The source code in &quot;livesearch.php&quot; searches an XML file for titles matching the search string and returns the result:</p>
<div class="code notranslate"><div>
&lt;?php<br>
...
<ul>
	...
	<li>Sets the correct url and title in the &quot;$response&quot; variable.
	If more than one match is found, all matches are added to the variable</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ajax_livesearch.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ajax_livesearch.asp#top" target="_top">TOP</a> |
		<a href="php_ajax_livesearch.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
