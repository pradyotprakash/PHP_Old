...
<style>a.menu_func_ftp_delete{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_delete()</span> Function</h1>
...
<p>Delete a file on the FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	&quot;php/test.txt&quot;;<br><br>// try to delete file<br>if (ftp_delete($ftp_conn, 
	$file))<br>&nbsp; {<br>&nbsp; echo &quot;$file deleted&quot;;<br>&nbsp; }<br>else<br>&nbsp; 
	{<br>&nbsp; echo &quot;Could not delete $file&quot;;<br>&nbsp; }<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_delete() function deletes a file on the FTP server.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_delete(<em>ftp_connection,file</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>file</em></td>
    <td>Required. Specifies the path of the file to delete</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_delete.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_delete.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_delete.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
