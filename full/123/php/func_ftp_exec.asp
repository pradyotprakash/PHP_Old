...
<style>a.menu_func_ftp_exec{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_exec()</span> Function</h1>
...
<p>Request for execution of a command on the FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$command = &quot;ls-al 
	&gt; somefile.txt&quot;;<br>
	<br>// execute command<br>
if (ftp_exec($ftp_conn,$command))<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo &quot;$command executed successfully.&quot;;<br>
&nbsp;&nbsp;}<br>
else<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo &quot;Execution of $command failed.&quot;;<br>
&nbsp;&nbsp;}<br>
	<br>
	// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_exec() function requests for execution of a command on the FTP server.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_exec(<em>ftp_connection,command</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>command</em></td>
    <td>Required. Specifies the command to execute</td>
  </tr>
</table>
<br>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns TRUE if command was executed successfully; 
	FALSE otherwise</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_exec.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_exec.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_exec.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
