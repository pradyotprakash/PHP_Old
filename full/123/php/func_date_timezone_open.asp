...
<title>PHP timezone_open() Function</title>
<style>a.menu_func_date_timezone_open{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">timezone_open()</span> Function</h1>
...
<p>Create a new DateTimeZone object, then return the name of the timezone:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$tz=timezone_open(&quot;Europe/Paris&quot;);<br>
	echo timezone_name_get($tz);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_timezone_open">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The timezone_open() creates a new DateTimeZone object.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
timezone_open(<em>timezone);</em></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies a timezone<br><br><strong>Tip:</strong>
...
<tr>
	...
	<td style="width:80%">Returns the DateTimeZone object on success. FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_timezone_open.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_timezone_open.asp#top" target="_top">TOP</a> |
		<a href="func_date_timezone_open.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
