...
<title>PHP mysqli_free_result() Function</title>
<style>a.menu_func_mysqli_free_result{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_free_result()</span> Function</h1>
...
<p>Fetch rows from a result-set, then free the memory associated with the result:</p>
...
<p>The mysqli_free_result() function frees the memory associated with the result.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_free_result(<em>result</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">No return value</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_free_result.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_free_result.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_free_result.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
