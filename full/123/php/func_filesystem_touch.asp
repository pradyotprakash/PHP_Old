...
<title>PHP touch() Function</title>
<style>a.menu_func_filesystem_touch{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">touch()</span> Function</h1>
<hr>
...
<p>The touch() function sets the access and modification time of the specified 
file.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>filename</td>
    <td>Required. Specifies the file to touch</td>
  </tr>
  <tr>
    <td>time</td>
    <td>Optional. Sets the time. The current system time is set by 
	default</td>
  </tr>
  <tr>
    <td>atime</td>
    <td>Optional. Sets the access time. Default is the current 
	system time if no parameters are set, or the same as the time parameter if 
	that parameter is set</td>
  </tr>
  </table>
<br>
...
<p><b>Note:</b> If the specified file does not exist, it will be created.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_touch.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_touch.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_touch.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
