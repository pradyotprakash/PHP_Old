...
<title>PHP xml_set_element_handler() Function</title>
<style>a.menu_func_xml_set_element_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_set_element_handler()</span> Function</h1>
<hr>
...
<p>The xml_set_element_handler() function specifies functions to be called at 
the start and end of an element in the XML document.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td>start</td>
    <td>Required. Specifies a function to be called at the start of 
	an element</td>
  </tr>
  <tr>
    <td>end</td>
    <td>Required. Specifies a function to be called at the end of 
	an element</td>
  </tr>
  </table>
<p>The Function specified by the &quot;start&quot; parameter must have three parameters:<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	from the XML file as a string</td>
  </tr>
	<tr>
    <td>data</td>
    <td>Required. Specifies an array containing the elements 
	attributes from the XML file as a string</td>
  </tr>
  </table>
<p>The Function specified by the &quot;end&quot; parameter must have two parameters:<br>
...
<p><b>Note:</b> The start and end parameters can also be an array containing an 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_set_element_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_set_element_handler.asp#top" target="_top">TOP</a> |
		<a href="func_xml_set_element_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
