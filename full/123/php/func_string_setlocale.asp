...
<title>PHP setlocale() Function</title>
<style>a.menu_func_string_setlocale{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">setlocale()</span> Function</h1>
...
<p>Set the locale to US English and then back to default again:</p>
<div class="example_code notranslate">

	&lt;?php<br>
echo setlocale(LC_ALL,&quot;US&quot;);<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo setlocale(LC_ALL,NULL);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_setlocale">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The setlocale() function sets locale information.</p>
<p>Locale information is language, monetary, time and other information specific 
for a geographical area.</p>

<p><b>Note:</b> The setlocale() function changes the locale only for the current 
script.</p>

<p><b>Tip:</b> The 
locale information can be set to system default with setlocale(LC_ALL,NULL)</p>
<p><strong>Tip:</strong> To get numeric formatting information, see the
<a href="func_string_localeconv.asp">localeconv()</a> function.</p>
<hr>
...
setlocale(<em>constant,location</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies what locale information should be set.<p>
	Available constants:</p>
	<ul>
		<li>LC_ALL - All of the below</li>
		<li>LC_COLLATE -&nbsp; Sort order</li>
		<li>LC_CTYPE - Character classification and conversion (e.g. all 
		characters should be lower or upper-case)</li>
		<li>LC_MESSAGES - System message formatting</li>
		<li>LC_MONETARY - Monetary/currency formatting</li>
		<li>LC_NUMERIC - Numeric formatting</li>
		<li>LC_TIME - Date and time formatting</li>
	</ul>
	</td>
  </tr>
  <tr>
    <td><em>location</em></td>
    <td>Required. Specifies what country/region to set the locale 
	information to. Can be a string or an array. It is possible to pass multiple 
	locations.<br><br>If the location is NULL or the empty string &quot;&quot;, the 
	location names will be set from the values of environment variables with the 
	same names as the constants above, or from &quot;LANG&quot;.<br><br>If the location is &quot;0&quot;, the location setting is not affected, 
	only the current setting is returned.<br><br>If the location is an array, setlocale() will try each array element until it finds a valid language or 
	region code. This is very useful if a region is known under different names 
	on different systems.<p><b>Note:</b> To view all available language codes, 
...
<tr>
	...
	<td style="width:80%">Returns the current locale settings, or FALSE on 
	failure. The return value depends on the system that PHP is running.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>Passing constant as a string was deprecated in PHP 4.2.0. Use the 
	available constants instead. Passing them as a string will result in a 
	warning message. <br><br>Passing multiple <em>locations</em> became possible in PHP 
	4.3.0.<br><br>If a string is passed to the constant parameter instead of one 
	of the LC_ constants, this function throws an E_DREPRECATED notice as of PHP 
	5.3.0.</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_setlocale.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_setlocale.asp#top" target="_top">TOP</a> |
		<a href="func_string_setlocale.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
