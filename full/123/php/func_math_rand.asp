...
<style>a.menu_func_math_rand{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">rand()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_rand">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The rand() function generates a random integer.</p>
<p><strong>Tip:</strong> If you want a random integer between 10 and 100 (inclusive), use rand (10,100).</p>
<p><b>Tip:</b> The <a href="func_math_mt_rand.asp">mt_rand()</a> function produces a better random value, and is 4 times 
faster than rand().</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	rand();<br><br>or<br><br>rand(<em>min,max</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<a href="func_math_getrandmax.asp">getrandmax()</a></td>
  </tr>
  </table>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 4.2.0: Random number generator is seeded automatically</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_rand.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_rand.asp#top" target="_top">TOP</a> |
		<a href="func_math_rand.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
