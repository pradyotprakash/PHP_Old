...
<html lang="en-US">
<head>
<title>PHP HTTP Functions</title>
<style>a.menu_php_ref_http{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">HTTP</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_ftp.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_libxml.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP HTTP Introduction</h2>
<p>The HTTP functions let you manipulate information sent to the browser by the 
Web server, before any other output has been sent.</p>
<hr>

<h2>Installation</h2>
<p>The directory functions are part of the PHP core. There is no installation needed to use these functions.</p>
<hr>

<h2>PHP HTTP Functions</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="func_http_header.asp">header()</a></td>
    <td>Sends a raw HTTP header to a client</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_http_headers_list.asp">headers_list()</a></td>
    <td>Returns a list of response headers sent (or ready to send)</td>
    <td>5</td>
  </tr>
  <tr>
    <td><a href="func_http_headers_sent.asp">headers_sent()</a></td>
    <td>Checks if / where the HTTP headers have been sent</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_http_setcookie.asp">setcookie()</a></td>
    <td>Sends an HTTP cookie to a client</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_http_setrawcookie.asp">setrawcookie()</a></td>
    <td>Sends an HTTP cookie without URL encoding the cookie value</td>
    <td>5</td>
  </tr>
  </table>
<br>
<hr>
<h2>PHP HTTP Constants</h2>
<p><b>None.</b><br></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_ftp.asp">&laquo; Previous</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_http.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_http.asp#top" target="_top">TOP</a> |
		<a href="php_ref_http.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
