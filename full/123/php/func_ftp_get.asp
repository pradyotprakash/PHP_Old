...
<style>a.menu_func_ftp_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_get()</span> Function</h1>
...
<p>Download a file from the FTP server, and save it into a local file:&nbsp;</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	&quot;server.zip&quot;;<br><br>// download server file<br>if (ftp_get($ftp_conn, 
	$local_file, $server_file, FTP_ASCII))<br>&nbsp; {<br>&nbsp; echo &quot;Successfully 
	written to $local_file.&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error 
	downloading 
	$server_file.&quot;;<br>&nbsp; }<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_get() function gets (downloads) a file from the FTP server, and saves it 
into a local file.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_get(<em>ftp_connection,local_file,server_file,mode,startpos</em>);</div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_get.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
