...
<title>PHP date_sunset() Function</title>
<style>a.menu_func_date_sunset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_sunset()</span> Function</h1>
...
<p>Return the sunset time for Lisbon, Portugal today:</p>
...
<p>The date_sunset() function returns the sunset time for a specified day and location.</p>
<p><strong>Tip:</strong> Look at the <a href="func_date_sunrise.asp">date_sunrise()</a> function 
to return the sunrise time for a specified day and location.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	date_sunset(<em>timestamp,format,latitude,longitude,zenith,gmtoffset);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the timestamp of the day from which the sunset time 
	is taken</td>
  </tr>
  <tr>
    <td><em>format</em></td>
  ...
  <tr>
    <td><em>zenith</em></td>
    <td>Optional. Defaults to date.sunset_zenith</td>
  </tr>
  <tr>
...
<tr>
	...
	<td style="width:80%">Returns the time of the sunset, in the specified <em>format,
...
<tr>
	<th>Changelog:</th>
	<td>From PHP 5.1.0 this function generates E_STRICT and E_NOTICE time zone 
	errors</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_sunset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_sunset.asp#top" target="_top">TOP</a> |
		<a href="func_date_sunset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
