...
<title>PHP filter_has_var() Function</title>
<style>a.menu_func_filter_has_var{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filter_has_var()</span> Function</h1>
<hr>
...
<p>The filter_has_var() function checks if a variable of a specified input type 
exist.</p>
...
<table class="reference notranslate">
	...
	<tr>
		<td>type</td>
		<td>Required. Specifies the type to check for<p>Possible 
		input types:</p>
		<ul>
			<li>INPUT_GET</li>
			<li>INPUT_POST</li>
	...
	<tr>
		<td>variable</td>
		<td>Required. Specifies the variable to check</td>
	</tr>
</table>
<br>
<hr>
...
<h2>Example</h2>
<p>In this example the input variable &quot;name&quot; is sent to the PHP page:</p>

<div class="code notranslate"><div>

&lt;?php<br>
if(!filter_has_var(INPUT_GET, &quot;name&quot;))<br>
&nbsp;{<br>
&nbsp;echo(&quot;Input type does not exist&quot;);<br>
&nbsp;}<br>
else<br>
&nbsp;{<br>
&nbsp;echo(&quot;Input type exists&quot;);<br>
&nbsp;}<br>
?&gt;

</div></div>

<p>The output of the code should be something like this:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filter_has_var.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filter_has_var.asp#top" target="_top">TOP</a> |
		<a href="func_filter_has_var.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
