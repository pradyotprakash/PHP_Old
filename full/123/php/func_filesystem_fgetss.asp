...
<title>PHP fgetss() Function</title>
<style>a.menu_func_filesystem_fgetss{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fgetss()</span> Function</h1>
<hr>
...
<p>The fgetss() function returns a line, with HTML and PHP tags removed, from an open file.</p>
<p>The fgetss() function stops returning on a new line, at the specified length, 
or at EOF, whichever comes first.</p>
<p>This function returns FALSE on failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>length</td>
    <td>Optional. Specifies the number of bytes to read. Default is 
	1024 bytes.<p><b>Note:</b> This parameter is required in versions prior to 
	PHP 5</p></td>
  </tr>
  <tr>
    <td>tags</td>
    <td>Optional. Specifies tags that will not be removed</td>
  </tr>
  </table>
...
<p>The source of the output above will be:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fgetss.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fgetss.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fgetss.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
