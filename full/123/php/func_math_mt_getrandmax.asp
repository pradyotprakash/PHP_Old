...
<title>PHP mt_getrandmax() Function</title>
<style>a.menu_func_math_mt_getrandmax{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mt_getrandmax()</span> Function</h1>
...
<p>Return largest possible random value that can be returned by mt_rand():</p>
<div class="example_code notranslate">
&lt;?php<br>
echo(mt_getrandmax()); <br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_mt_getrandmax">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The mt_getrandmax() function returns the largest possible value that can be returned by
<a href="func_math_mt_rand.asp">mt_rand()</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	mt_getrandmax();</div></div>

<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td style="width:80%">The largest possible value returned by mt_rand()</td>
</tr>
	<tr>
	<th>Return Type:</th>
	<td>Integer</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_mt_getrandmax.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_mt_getrandmax.asp#top" target="_top">TOP</a> |
		<a href="func_math_mt_getrandmax.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
