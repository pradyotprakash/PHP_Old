...
<title>PHP convert_uuencode() Function</title>
<style>a.menu_func_string_convert_uuencode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">convert_uuencode()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_convert_uuencode">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The convert_uuencode() function encodes a string using the uuencode 
algorithm.</p>

<p><b>Note:</b> This function encodes all 
...
<a href="func_string_convert_uudecode.asp">convert_uudecode()</a> function 
before using the data again.</p>
<p><b>Note:</b> Uuencoded data is about 35% larger than the original.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. The string to uuencode</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the uuencoded data</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<p>Encode a string and then decode it:</p>
<div class="example_code notranslate">

	&lt;?php<br>$str = &quot;Hello world!&quot;;<br>// Encode the string<br>$encodeString = 
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_convert_encode_decode">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_convert_uuencode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_convert_uuencode.asp#top" target="_top">TOP</a> |
		<a href="func_string_convert_uuencode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
