...
<title>PHP set_file_buffer() Function</title>
<style>a.menu_func_filesystem_set_file_buffer{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">set_file_buffer()</span> Function</h1>
<hr>
...
<p>The set_file_buffer() function sets the buffer size of an open 
file.</p>
<p>Output using fwrite() is normally buffered at 8K. So, if two processes 
...
processes to write).</p>
<p>This function returns 0 on success, otherwise it returns EOF.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>buffer</td>
    <td>Required. Specifies the buffer size in bytes</td>
  </tr>
  </table>
<br>
...
<p><b>Tip:</b> This function is an alias of stream_set_write_buffer().</p>
<hr>

<h2>Example</h2>
<p>Create an unbuffered stream:</p>
...
if ($file)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;set_file_buffer($file,0);<br>
&nbsp;&nbsp;fwrite($file,&quot;Hello World. Testing!&quot;);<br>
&nbsp;&nbsp;fclose($file);<br>
&nbsp;&nbsp;}<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_set_file_buffer.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_set_file_buffer.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_set_file_buffer.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
