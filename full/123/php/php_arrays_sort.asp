...
<style>a.menu_php_arrays_sort{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Sorting Arrays</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_arrays.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_superglobals.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The elements in an array can be sorted in alphabetical or numerical order, descending or ascending.</p>
<hr>
...
<ul>
	...
	<li>asort() - sort associative arrays in ascending order, according to the 
	value</li>
	<li>ksort() - sort associative arrays in ascending order, according to the 
	key</li>
	<li>arsort() - sort associative arrays in descending order, according to the 
	value</li>
	<li>krsort() - sort associative arrays in descending order, according to the 
	key</li>
</ul>
<hr>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_sort_alpha">Run example &raquo;</a>
</div>

<p>The following example sorts the elements of the $numbers array in ascending 
numerical order:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_sort_num">Run example &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_rsort_alpha">Run example &raquo;</a>
</div>
<p>The following example sorts the elements of the $numbers array in descending 
numerical order:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_rsort_num">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>Sort Array in Ascending Order, According to Value - asort()</h2>
<p>The following example sorts an associative array in ascending order, 
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_asort">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>Sort Array in Ascending Order, According to Key - ksort()</h2>
<p>The following example sorts an associative array in ascending order, 
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_ksort">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>Sort Array in Descending Order, According to Value - arsort()</h2>
<p>The following example sorts an associative array in descending order, 
according to the value:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_arsort">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>Sort Array in Descending Order, According to Key - krsort()</h2>
<p>The following example sorts an associative array in descending order, 
according to the key:</p>
<div class="example">
<h2 class="example">Example</h2>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_krsort">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>Complete PHP Array Reference</h2>
<p>For a complete reference of all array functions, go to our complete <a href="php_ref_array.asp">PHP Array Reference</a>.</p>
<p>The reference contains a brief description, and examples of use, for each function!</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_arrays_sort.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_arrays_sort.asp#top" target="_top">TOP</a> |
		<a href="php_arrays_sort.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
