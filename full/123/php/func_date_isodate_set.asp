...
<title>PHP date_isodate_set() Function</title>
<style>a.menu_func_date_isodate_set{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_isodate_set()</span> Function</h1>
...
<p>Set the ISO date to the 5th week in 2013:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$date=date_create();<br>date_isodate_set($date,2013,5);<br>echo 
	date_format($date,&quot;Y-m-d&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_isodate_set">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_isodate_set() function sets a date according to the ISO 8601 standard, using weeks and day
offsets (instead of using a specific date).</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_isodate_set(<em>object,year,week,day);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<a href="func_date_date_create.asp">date_create()</a></td>
  </tr>
  <tr>
    <td><em>year</em></td>
    <td>Required. Specifies the year of the date</td>
  </tr>
  <tr>
    <td><em>week</em></td>
    <td>Required. Specifies the week of the date</td>
  </tr>
  <tr>
    <td><em>day</em></td>
    <td>Optional. Specifies the offset from the first day of the week. Default 
	is 1</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a DateTime object on success. FALSE 
	on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_isodate_set.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_isodate_set.asp#top" target="_top">TOP</a> |
		<a href="func_date_isodate_set.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
