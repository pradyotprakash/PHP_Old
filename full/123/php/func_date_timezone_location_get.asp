...
<title>PHP timezone_location_get() Function</title>
<style>a.menu_func_date_timezone_location_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">timezone_location_get()</span> Function</h1>
...
<p>Return location information for the given timezone:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$tz=timezone_open(&quot;Asia/Taipei&quot;);<br>
	echo 
	timezone_location_get($tz);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_timezone_location_get">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The timezone_location_get() returns location information for the given timezone.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
timezone_location_get<em>(object);</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an array that contains location information for the timezone</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.3+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_timezone_location_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_timezone_location_get.asp#top" target="_top">TOP</a> |
		<a href="func_date_timezone_location_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
