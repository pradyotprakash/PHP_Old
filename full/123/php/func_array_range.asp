...
<title>PHP range() Function</title>
<style>a.menu_func_array_range{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">range()</span> Function</h1>
...
<p>Create an array containing a range of elements from &quot;0&quot; to &quot;5&quot;:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_range">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The range() function creates an array containing a range of elements.</p>
<p>This function returns an array of elements from low to high.</p>
<p><b>Note:</b> If the low parameter is higher than the high parameter, the 
range array will be from high to low.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
range(<em>low,high,step</em>)
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>low</em></td>
    <td>Required. Specifies the lowest value of the array</td>
  </tr>
  <tr>
    <td><em>high</em></td>
    <td>Required. Specifies the highest value of the array</td>
  </tr>
  <tr>
    <td><em>step</em></td>
    <td>Optional. Specifies the increment used in the range. 
	Default is 1</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns an array of elements from <em>low</em> to <em>high</em></td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>step</em> parameter was added in PHP 5.0.<br><br>In PHP 
	versions 4.1.0 through 4.3.2, this function sees numeric strings as strings 
	and not integers. The numeric strings will be used for character sequences, 
	e.g., &quot;5252&quot; is treated as &quot;5&quot;.<br><br>Support for character sequences and 
	decrementing arrays was added in PHP 4.1.0. Character sequence values are 
	limited to a length of one. If the length is higher than one, 
	only the first character is used. Before this version, range() only 
	generated incrementing integer arrays. </td>
</tr>
</table>
<br>
<hr>
...
<p>Return an array of elements from &quot;0&quot; to &quot;50&quot; and increment by 10.</p>
<div class="example_code notranslate">
&lt;?php<br>
$number = range(0,50,10);<br>
print_r ($number);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_range2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Using letters - return an array of elements from &quot;a&quot; to &quot;d&quot;</p>
<div class="example_code notranslate">
&lt;?php<br>
$letter = range(&quot;a&quot;,&quot;d&quot;);<br>
print_r ($letter);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_range3">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_range.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_range.asp#top" target="_top">TOP</a> |
		<a href="func_array_range.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
