...
<title>PHP filter_input_array() Function</title>
<style>a.menu_func_filter_input_array{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filter_input_array()</span> Function</h1>
<hr>
<a href="php_ref_filter.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Filter Reference" /> Complete PHP Filter Reference</a>
<hr>

<h2>Definition and Usage</h2>

<p>The filter_input_array() function gets multiple external variables (like form 
input) and filters them.</p>
<p>This function is useful for filtering several input variables without calling filter_input() 
over and over.</p>
<p>This function can get input from several sources:</p>
<ul>
	<li>INPUT_GET</li>
	<li>INPUT_POST</li>
	<li>INPUT_COOKIE</li>
...
<p>Returns an array of filtered data on success, FALSE on failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
	...
	<tr>
		<td>input_type</td>
		<td>Required. Specifies the input type. See possible types 
		in list above</td>
	</tr>
	<tr>
		<td>filter_args</td>
		<td>Optional. Specifies an array of filter arguments. A 
		valid array key is a variable name and a valid value is 
		a filter ID, or an array specifying the filter, 
		flags and options.<p>This parameter can also be a single filter ID, if so, 
		all values in the input array are filtered by the specified filter<p>A filter ID can be an ID name (like FILTER_VALIDATE_EMAIL) 
		or an ID number (like 274)</td>
	</tr>
</table>
<br>
<hr>
...
<p><b>Tip:</b> Check the <a href="php_ref_filter.asp">Complete PHP Filter 
Reference</a> for possible filters to use with this function.<br>
</p>
<hr>
<h2>Example</h2>
<p>In this example we use the filter_input_array() function to filter three POST variables. 
The received POST variables is a name, an age and an e-mail address:</p>
...
&nbsp;&nbsp;&quot;name&quot; =&gt; array<br>
&nbsp;&nbsp;&nbsp;&nbsp;(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;filter&quot;=&gt;FILTER_CALLBACK,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;flags&quot;=&gt;FILTER_FORCE_ARRAY,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;options&quot;=&gt;&quot;ucwords&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;),<br>
&nbsp;&nbsp;&quot;age&quot; =&gt; array<br>
&nbsp;&nbsp;&nbsp;&nbsp;(<br>
...
&nbsp;&nbsp;);<br>
print_r(filter_input_array(INPUT_POST, $filters));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filter_input_array.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filter_input_array.asp#top" target="_top">TOP</a> |
		<a href="func_filter_input_array.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
