...
<title>PHP basename() Function</title>
<style>a.menu_func_filesystem_basename{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">basename()</span> Function</h1>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>suffix</td>
    <td>Optional. Specifies a file extension.
	If the filename has this file extension, the file extension will not show</td>
  </tr>
  </table>
<br>
...
&lt;?php<br>
$path = &quot;/testweb/home.php&quot;;<br>
<br>
//Show filename with file extension<br>
echo basename($path) .&quot;&lt;br/&gt;&quot;;<br>
<br>
//Show filename without file extension<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_basename.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_basename.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_basename.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
