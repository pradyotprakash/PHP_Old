...
<title>PHP utf8_decode() Function</title>
<style>a.menu_func_xml_utf8_decode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">utf8_decode()</span> Function</h1>
<hr>
...
<p>The utf8_decode() function decodes a UTF-8 string to ISO-8859-1.</p>
<p>This function decodes a string, previously encoded with the utf8_encode() 
function, back to ISO-8859-1.</p>
<p>This function returns the decoded string on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_utf8_decode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_utf8_decode.asp#top" target="_top">TOP</a> |
		<a href="func_xml_utf8_decode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
