...
<style>a.menu_func_array_usort{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">usort()</span> Function</h1>
...
<p>Sort the elements of the $a array using a user-defined comparison function:</p>
<div class="example_code notranslate">
&lt;?php<br>
	function my_sort($a,$b)<br>{<br>if ($a==$b) return 0;<br>return 
	($a&lt;$b)?-1:1;<br>}<br><br>$a=array(4,2,8,6);<br>usort($a,&quot;my_sort&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_usort">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The usort() function sorts an array using a user-defined  
	comparison function.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	usort(<em>array,myfunction</em>);
</div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_usort.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_usort.asp#top" target="_top">TOP</a> |
		<a href="func_array_usort.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
