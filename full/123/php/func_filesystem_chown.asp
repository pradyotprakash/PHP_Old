...
<title>PHP chown() Function</title>
<style>a.menu_func_filesystem_chown{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">chown()</span> Function</h1>
<hr>
...
<p>The chown() function changes the owner of the specified file.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>owner</td>
    <td>Required. Specifies the new owner. Can be a user name or a 
	user ID.</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_chown.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_chown.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_chown.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
