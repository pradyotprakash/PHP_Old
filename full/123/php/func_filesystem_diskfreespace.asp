...
<title>PHP diskfreespace() Function</title>
<style>a.menu_func_filesystem_diskfreespace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">diskfreespace()</span> Function</h1>
<hr>
...
<p>The diskfreespace() function returns the free space, in bytes, of the 
specified 
directory.</p>
<p>This function is an alias of the disk_free_space() function.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>directory</td>
    <td>Required. Specifies the directory to check</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_diskfreespace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_diskfreespace.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_diskfreespace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
