...
<title>PHP tmpfile() Function</title>
<style>a.menu_func_filesystem_tmpfile{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">tmpfile()</span> Function</h1>
<hr>
...
<p>The tmpfile() function creates a temporary file with a unique name in 
read-write (w+) mode.</p>
<h2>Syntax</h2>
...
<p><b>Note:</b> The temporary file is automatically removed when it is closed 
with fclose(), or when the script ends.</p>
<p><b>Tip:</b> See also tempnam()</p>
...
$temp = tmpfile();<br>
<br>
fwrite($temp, &quot;Testing, testing.&quot;);<br>
//Rewind to the start of file<br>
rewind($temp);<br>
//Read 1k from file<br>
echo fread($temp,1024);<br>
<br>
//This removes the file<br>
fclose($temp);<br>
?&gt; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_tmpfile.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_tmpfile.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_tmpfile.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
