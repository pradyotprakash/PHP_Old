...
<title>PHP mysqli_real_escape_string() Function</title>
<style>a.menu_func_mysqli_real_escape_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_real_escape_string()</span> Function</h1>
...
<p>Escape special characters in a string:</p>
...
&nbsp;&nbsp;}<br><br>mysqli_query($con,&quot;CREATE TABLE myPersons LIKE Persons&quot;);<br>
	<br>$newpers=&quot;Da'Silva&quot;<br><br>// This query will fail, cause we did not 
	escape $newpers<br>mysqli_query($con,&quot;INSERT into myPersons (Lastname) 
	VALUES ('$newpers')&quot;);<br><br>
	$newpers=mysqli_real_escape_string($con,$newpers);<br><br>// This query will 
	work, cause we escaped $newpers<br>mysqli_query($con,&quot;INSERT into myPersons 
	(Lastname) VALUES ('$newpers')&quot;);<br><br>mysqli_close($con);<br>
?&gt;
</div>
</div>
<hr>
...
<p>The mysqli_real_escape_string() function escapes special characters in a 
string for use in an SQL statement.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_real_escape_string(<em>connection,escapestring</em>)<em>;</em></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. The string to be escaped. Characters encoded are NUL (ASCII 
	0), \n, \r, \, ', &quot;, and Control-Z.</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the escaped string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_real_escape_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_real_escape_string.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_real_escape_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
