...
<title>PHP base_convert() Function</title>
<style>a.menu_func_math_base_convert{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">base_convert()</span> Function</h1>
...
<p>Convert a hexadecimal number to octal number:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$hex = &quot;E196&quot;; <br>echo base_convert($hex,16,8); <br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_base_convert">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The base_convert() function converts a number from one number base to another.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
base_convert(<em>number,frombase,tobase</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the number to convert</td>
  </tr>
  <tr>
    <td><em>frombase</em></td>
    <td>Required. Specifies the original base of number. Has to be between 2 and 
	36, inclusive. Digits in numbers with a base higher than 10 will be 
	represented with the letters a-z, with a meaning 10, b meaning 11 and z 
	meaning 35</td>
  </tr>
  <tr>
    <td><em>tobase</em></td>
    <td>Required. Specifies the base to convert to. Has to be between 2 and 36, 
	inclusive. Digits in numbers with a base higher than 10 will be represented 
	with the letters a-z, with a meaning 10, b meaning 11 and z meaning 35</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">The <em>number</em> converted to the specified base</td>
</tr>
	<tr>
	<th>Return Type:</th>
	<td>String</td>
...
<p>&nbsp;Convert an octal number to a decimal number:</p>
<div class="example_code notranslate">
&lt;?php<br>
$oct = &quot;0031&quot;;<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_base_convert2">Run example &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example 2</h2>
<p>&nbsp;Convert an octal number to a hexadecimal number:</p>
<div class="example_code notranslate">
&lt;?php<br>
$oct = &quot;364&quot;;<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_base_convert3">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_base_convert.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_base_convert.asp#top" target="_top">TOP</a> |
		<a href="func_math_base_convert.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
