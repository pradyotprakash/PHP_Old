...
<title>PHP rad2deg() Function</title>
<style>a.menu_func_math_rad2deg{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">rad2deg()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_rad2deg">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The rad2deg() function converts a radian value to a degree value.</p>
<p><strong>Tip:</strong> To convert a degree value to a radian value, look at the
<a href="func_math_deg2rad.asp">deg2rad()</a> function.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
rad2deg(<em>number</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies a radian value to convert</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">The equivalent of <em>number</em> in degrees</td>
</tr>
	<tr>
	<th>Return Type:</th>
	<td>Float</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_rad2deg.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_rad2deg.asp#top" target="_top">TOP</a> |
		<a href="func_math_rad2deg.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
