...
<title>PHP array_diff_ukey() Function</title>
<style>a.menu_func_array_diff_ukey{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_diff_ukey()</span> Function</h1>
...
comparison function), and return the differences:</p>
<div class="example_code notranslate">
	&lt;?php<br>function myfunction($a,$b)<br>{<br>if ($a===$b)<br>&nbsp; {<br>&nbsp; 
	return 0;<br>&nbsp; }<br>&nbsp; return ($a&gt;$b)?1:-1;<br>}<br><br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;);<br>$a2=array(&quot;a&quot;=&gt;&quot;blue&quot;,&quot;b&quot;=&gt;&quot;black&quot;,&quot;e&quot;=&gt;&quot;blue&quot;);<br>
	<br>$result=array_diff_ukey($a1,$a2,&quot;myfunction&quot;);<br>print_r($result);<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff_ukey">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_diff_ukey() function compares <strong>the keys</strong> 
of two (or more) arrays,
and returns the differences.</p>
<p><strong>Note:</strong> This function uses a user-defined function to compare 
the keys!</p>
<p>This function compares the keys of two (or more) arrays, and return an array that contains the entries from <em>
array1</em> that are not present in <em>array2 </em>or
<em>array3</em>, etc.</p>
<hr>
...
array_diff_ukey(<em>array1,array2,array3...,myfunction</em>);</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Required. A string that define a callable comparison function. The 
...
function to compare the keys), and return the differences:</p>
<div class="example_code notranslate">
	&lt;?php<br>function myfunction($a,$b)<br>{<br>if ($a===$b)<br>&nbsp; {<br>&nbsp; 
	return 0;<br>&nbsp; }<br>&nbsp; return ($a&gt;$b)?1:-1;<br>}<br><br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;);<br>$a2=array(&quot;a&quot;=&gt;&quot;black&quot;,&quot;b&quot;=&gt;&quot;yellow&quot;,&quot;d&quot;=&gt;&quot;brown&quot;);<br>
	$a3=array(&quot;e&quot;=&gt;&quot;purple&quot;,&quot;f&quot;=&gt;&quot;white&quot;,&quot;a&quot;=&gt;&quot;gold&quot;);<br><br>$result=array_diff_ukey($a1,$a2,$a3,&quot;myfunction&quot;);<br>
	print_r($result);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff_ukey2">Run example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_diff_ukey.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_diff_ukey.asp#top" target="_top">TOP</a> |
		<a href="func_array_diff_ukey.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
