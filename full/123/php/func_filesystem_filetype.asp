...
<title>PHP filetype() Function</title>
<style>a.menu_func_filesystem_filetype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filetype()</span> Function</h1>
<hr>
...
<p>The filetype() function returns the file type of a specified file or 
directory.</p>
<p>This function returns the one of seven possible values on success or 
FALSE on failure.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_filetype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_filetype.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_filetype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
