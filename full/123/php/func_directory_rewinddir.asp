...
<title>PHP rewinddir() Function</title>
<style>a.menu_func_directory_rewinddir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">rewinddir()</span> Function</h1>
...
filename: cat.gif<br>
filename: dog.gif<br>
filename: horse.gif<br>filename: cat.gif<br>
filename: dog.gif<br>
filename: horse.gif
</div>
<br>
...
<p>The rewinddir() function resets the directory handle created by <a href="func_directory_opendir.asp">opendir()</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
rewinddir(<em>dir_handle</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>dir_handle</em></td>
    <td>Optional. Specifies the directory handle resource previously opened with
	<a href="func_directory_opendir.asp">opendir()</a>. If this parameter is not 
	specified, the last link opened by opendir() is assumed</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_directory_rewinddir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_directory_rewinddir.asp#top" target="_top">TOP</a> |
		<a href="func_directory_rewinddir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
