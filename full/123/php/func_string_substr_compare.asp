...
<title>PHP substr_compare() Function</title>
<style>a.menu_func_string_substr_compare{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">substr_compare()</span> Function</h1>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_compare">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The substr_compare() function compares two strings from a specified start position.</p>
<p><b>Tip:</b> This function is binary-safe and optionally case-sensitive.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
substr_compare(<em>string1,string2,startpos,length,case</em>)
</div></div><br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string1</em></td>
    <td>Required. Specifies the first string to compare</td>
  </tr>
	<tr>
    <td><em>string2</em></td>
    <td>Required. Specifies the second string to compare</td>
  </tr>
	<tr>
    <td><em>startpos</em></td>
    <td>Required. Specifies where to start comparing in  
	string1. If negative, it starts counting from the end of the string</td>
  </tr>
	<tr>
    <td><em>length</em></td>
    <td>Optional. Specifies how much of string1 to compare</td>
  </tr>
  <tr>
    <td><em>case</em></td>
    <td>Optional. A boolean value that specifies whether or not to perform a case-sensitive 
	compare:
	<ul>
		<li>FALSE - Default. Case-sensitive</li>
...
<tr>
	...
	<td style="width:80%">This function returns:
<ul>
	<li>0 - if the two strings are equal</li>
	<li>&lt;0 - if string1 (from startpos) is less than string2</li>
	<li>&gt;0 - if string1 (from startpos) is greater than string2</li>
</ul>If length is equal or greater than length of string1, this function returns FALSE. 
</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 5.1, it is now possible to use a negative <em>startpos</em></td>
</tr>
</table>
<br>
<hr>
...
<p>Compare two strings, when start position in string1 for the comparison is 6th:</p>
<div class="example_code notranslate">
&lt;?php<br>
echo substr_compare(&quot;Hello world&quot;,&quot;world&quot;,6);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_compare2">Run example &raquo;</a>
</div>
<br>
...
<div class="example_code notranslate">
	&lt;?php<br>echo substr_compare(&quot;world&quot;,&quot;or&quot;,1,2); <br>echo substr_compare(&quot;world&quot;,&quot;ld&quot;,-2,2);
	<br>echo substr_compare(&quot;world&quot;,&quot;orl&quot;,1,2); <br>echo substr_compare(&quot;world&quot;,&quot;OR&quot;,1,2,TRUE);
	<br>echo substr_compare(&quot;world&quot;,&quot;or&quot;,1,3); <br>echo substr_compare(&quot;world&quot;,&quot;rl&quot;,1,2);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_compare3">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 3</h2>
<p>Different return values:</p>
<div class="example_code notranslate">
	&lt;?php<br>echo substr_compare(&quot;Hello world!&quot;,&quot;Hello world!&quot;,0); // the 
	two strings are equal<br>echo substr_compare(&quot;Hello world!&quot;,&quot;Hello&quot;,0); // 
	string1 is greater than string2<br>echo substr_compare(&quot;Hello world!&quot;,&quot;Hello 
	world! Hello!&quot;,0); // str1 is less than str2<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_compare4">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_substr_compare.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_substr_compare.asp#top" target="_top">TOP</a> |
		<a href="func_string_substr_compare.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
