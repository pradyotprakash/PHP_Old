...
<title>PHP array_multisort() Function</title>
<style>a.menu_func_array_multisort{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_multisort()</span> Function</h1>
<p><a href="php_ref_array.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Array Reference" /> PHP Array Reference</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Return a sorted array in ascending order:</p>
<div class="example_code notranslate">
&lt;?php<br>
$a=array(&quot;Dog&quot;,&quot;Cat&quot;,&quot;Horse&quot;,&quot;Bear&quot;,&quot;Zebra&quot;);<br>
array_multisort($a);<br>
print_r($a);<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_multisort">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_multisort() function returns a sorted array. You can assign one or 
more arrays. The function sorts the first array, and the other arrays follow, 
then, if two or more values are the same, it sorts the next array, and so on.</p>
<p><b>Note:</b> String keys will be maintained, but numeric keys will be re-indexed, starting at 0 and increase by 1.</p>
<p><b>Note:</b> You can assign the sorting order and the sorting type parameters after each array. 
If not specified, each array parameter uses the default values.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
array_multisort(<em>array1,sorting order,sorting type,array2,array3...</em>)
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>array1</em></td>
    <td>Required. Specifies an array</td>
  </tr>
  <tr>
    <td><em>sorting order</em></td>
    <td>Optional. Specifies the sorting order. Possible values:
    	<ul>
    	<li>SORT_ASC - Default. Sort in ascending order (A-Z)</li>
    	<li>SORT_DESC - Sort in descending order (Z-A)</li>
    	</ul>
    </td>
  </tr>
  <tr>
    <td><em>sorting type</em></td>
    <td>Optional. Specifies the type to use, when comparing elements. Possible values:
    	<ul>
    	<li>SORT_REGULAR - Default. Compare elements normally (Standard ASCII)</li>
    	<li>SORT_NUMERIC - Compare elements as numeric values</li>
    	<li>SORT_STRING - Compare elements as string values</li>
			<li>SORT_LOCALE_STRING - Compare elements as string, based on the 
			current locale (can be changed using 			<a href="func_string_setlocale.asp">setlocale()</a>)</li>
			<li>SORT_NATURAL - Compare elements as strings using &quot;natural 
			ordering&quot; like <a href="func_array_natsort.asp">natsort()</a></li>
			<li>SORT_FLAG_CASE - Can be combined (bitwise OR) with SORT_STRING 
			or SORT_NATURAL to sort strings case-insensitively</li>
    	</ul>
    </td>
  </tr>
  <tr>
    <td><em>array2</em></td>
    <td>Optional. Specifies an array</td>
  </tr>
  <tr>
    <td><em>array3</em></td>
    <td>Optional. Specifies an array</td>
...
<tr>
	...
	<td style="width:80%">Returns TRUE on success or FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The sorting type SORT_NATURAL and SORT_FLAG_CASE were added in PHP 5.4.<br>
	<br>The sorting type SORT_LOCALE_STRING was added in PHP 5.3.</td>
</tr>
</table>
<br>
<hr>
...
&lt;?php<br>
$a1=array(&quot;Dog&quot;,&quot;Cat&quot;);<br>
$a2=array(&quot;Fido&quot;,&quot;Missy&quot;);<br>
array_multisort($a1,$a2);<br>
print_r($a1);<br>
print_r($a2);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_multisort2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>See how it sorts when two values are the same:</p>
<div class="example_code notranslate">
&lt;?php<br>
$a1=array(&quot;Dog&quot;,&quot;Dog&quot;,&quot;Cat&quot;);<br>
$a2=array(&quot;Pluto&quot;,&quot;Fido&quot;,&quot;Missy&quot;);<br>
array_multisort($a1,$a2);<br>
print_r($a1);<br>
print_r($a2);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_multisort3">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 3</h2>
<p>Using sorting parameters:</p>
<div class="example_code notranslate">
	&lt;?php<br>$a1=array(&quot;Dog&quot;,&quot;Dog&quot;,&quot;Cat&quot;);<br>$a2=array(&quot;Pluto&quot;,&quot;Fido&quot;,&quot;Missy&quot;);<br>array_multisort($a1,SORT_ASC,$a2,SORT_DESC);<br>print_r($a1);<br>print_r($a2);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_multisort4">Run example &raquo;</a>
</div>

<br>
<div class="example">
<h2 class="example">Example 4</h2>
<p>Merge two arrays and sort them as numbers, in descending order:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(1,30,15,7,25);<br>$a2=array(4,30,20,41,66);<br>$num=array_merge($a1,$a2);<br>
	array_multisort($num,SORT_DESC,SORT_NUMERIC);<br>print_r($num);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_multisort5">Run example &raquo;</a>
</div>
<br>

<hr>
<a href="php_ref_array.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Array Reference" /> PHP Array Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_multisort.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_multisort.asp#top" target="_top">TOP</a> |
		<a href="func_array_multisort.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
