...
<style>a.menu_php_constants{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Constants</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_string.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_operators.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Constants are like variables except that once they are defined 
they cannot be changed or undefined.</p>
<hr>

<h2>PHP Constants</h2>

<p>A constant is an identifier (name) for a simple value. The value cannot be 
changed during the script.</p>
<p>A valid constant name starts with a letter or underscore (no $ sign before 
the constant name).</p>
<p><strong>Note:</strong> Unlike variables, constants are automatically global across 
the entire script.</p>
<hr>

<h2>Set a PHP Constant</h2>

<p>To set a constant, use the define() function - it takes three parameters: The 
first parameter defines the name of the constant, the second parameter defines 
the value of the constant, and the optional third parameter specifies whether the 
constant name should be case-insensitive. Default is false.</p>
<p>The example below creates a <strong>case-sensitive constant</strong>, with the value of 
&quot;Welcome to W3Schools.com!&quot;:</p>
<div class="example">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_constant1">Run example &raquo;</a>
</div>

<p>The example below creates a <strong>case-insensitive constant</strong>, with the value of 
&quot;Welcome to W3Schools.com!&quot;:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
&lt;?php<br>
	define(&quot;GREETING&quot;, &quot;Welcome to W3Schools.com!&quot;, true);<br>echo 
	greeting;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_constant2">Run example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_constants.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_constants.asp#top" target="_top">TOP</a> |
		<a href="php_constants.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
