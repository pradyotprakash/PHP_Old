...
<title>PHP date_date_set() Function</title>
<style>a.menu_func_date_date_set{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_date_set()</span> Function</h1>
...
<p>Return a new DateTime object, set a new date, and then format the date:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$date=date_create();<br>date_date_set($date,2020,10,30);<br>echo 
	date_format($date,&quot;Y/m/d&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_date_set">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_date_set() function sets a new date.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_date_set(<em>object,year,month,day);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>month</em></td>
    <td>Required. Specifies the month of the date</td>
  </tr>
  <tr>
    <td><em>day</em></td>
    <td>Required. Specifies the day of the date</td>
  </tr>
  </table>
...
<tr>
	<th>Changelog:</th>
	<td>From PHP 5.3+; changed the return value from NULL to DateTime (on 
	success)</td>
</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_date_set.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_date_set.asp#top" target="_top">TOP</a> |
		<a href="func_date_date_set.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
