...
<title>PHP array_sum() Function</title>
<style>a.menu_func_array_sum{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_sum()</span> Function</h1>
...
<p>Return the sum of all the values in the array (5+15+25):</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_sum">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The array_sum() function returns the sum of all the values in the array.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
array_sum(<em>array</em>)
</div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns the sum of all the values in an array</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>PHP versions prior to 4.2.1 modified the passed array itself and 
	converted strings to numbers (which often converted them to zero, depending 
	on their value)</td>
</tr>
</table>
<br>
...
<p>Return the sum of all the values in the array (52.2+13.7+0.9):</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a=array(&quot;a&quot;=&gt;52.2,&quot;b&quot;=&gt;13.7,&quot;c&quot;=&gt;0.9);<br>echo array_sum($a);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_sum2">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_sum.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_sum.asp#top" target="_top">TOP</a> |
		<a href="func_array_sum.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
