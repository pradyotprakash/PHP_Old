...
<title>PHP highlight_file() Function</title>
<style>a.menu_func_misc_highlight_file{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">highlight_file()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_highlight_file">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The highlight_file() function outputs a file with the PHP syntax 
highlighted. The syntax is highlighted by using HTML tags.</p>
<p><strong>Tip:</strong> The colors used for highlighting can be set in the php.ini file or with the ini_set() function.</p>
...
highlight_file(<em>filename,return</em>)
</div></div><br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_highlight_file.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_highlight_file.asp#top" target="_top">TOP</a> |
		<a href="func_misc_highlight_file.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
