...
<html lang="en-US">
<head>
<title>PHP Connect to the MySQL Server</title>
<style>a.menu_php_mysql_connect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Connect to the MySQL Server</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_mysql_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_mysql_create.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Use the PHP mysqli_connect() function to open a new connection 
to the MySQL server.</p>
<hr>

<h2>Open a Connection to the MySQL Server</h2>
<p>Before we can access data in a database, we must open a connection to 
the MySQL server.</p>
<p>In PHP, this is done with the mysqli_connect() function.</p>
<h3>Syntax</h3>
...
<table class="reference notranslate">
	...
	<tr>
		<td>dbname</td>
		<td>Optional. The default database to be used when performing queries</td>
	</tr>
</table>
<p><b>Note:</b> There are more available parameters, but the ones listed above are the most important.</p>

<p>In the following example we store the connection in a variable ($con) for later use in the script:</p>
<div class="code notranslate"><div>
&lt;?php<br>// Create connection<br>
...
<p>The connection will be closed automatically when the script ends. To close the 
connection before, use the mysqli_close() function:</p>
<div class="code notranslate"><div>
&lt;?php<br>
$con=mysqli_connect(&quot;example.com&quot;,&quot;peter&quot;,&quot;abc123&quot;,&quot;my_db&quot;);<br>
	<br>// Check connection<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_mysql_connect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_mysql_connect.asp#top" target="_top">TOP</a> |
		<a href="php_mysql_connect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
