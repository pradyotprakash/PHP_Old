...
<title>PHP move_uploaded_file() Function</title>
<style>a.menu_func_filesystem_move_uploaded_file{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">move_uploaded_file()</span> Function</h1>
<hr>
...
<p>The move_uploaded_file() function moves an uploaded file to a new location.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>newloc</td>
    <td>Required. Specifies the new location for the file</td>
  </tr>
  </table>
<br>
...
<p><b>Note:</b> This function only works on files uploaded via HTTP POST.</p>
<p><b>Note:</b> If the destination file already exists, it will be overwritten.</p>
<hr>
<a href="php_ref_filesystem.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Filesystem Reference" /> Complete PHP Filesystem Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_move_uploaded_file.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_move_uploaded_file.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_move_uploaded_file.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
