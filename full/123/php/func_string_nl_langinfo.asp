...
<title>PHP nl_langinfo() Function</title>
<style>a.menu_func_string_nl_langinfo{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">nl_langinfo()</span> Function</h1>
<hr>
...
<p>The nl_langinfo() function returns specific local information.</p>

<p><b>Note:</b> This function does not work on Windows platforms.</p>
<p><b>Tip:</b> Unlike the <a href="func_string_localeconv.asp">localeconv()</a> function, 
which returns all local formatting information, the nl_langinfo() function 
returns specific information.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>element</em></td>
    <td>Required. Specifies which element to return. Must be one of 
	the following elements:<p>Time and Calendar:</p>
	<ul>
		<li>ABDAY_(1-7) - Abbreviated name of the numbered day of the week</li>
		<li>DAY_(1-7) - Name of the numbered day of the week (DAY_1 = Sunday)</li>
		<li>ABMON_(1-12) - Abbreviated name of the numbered month of the year</li>
		<li>MON_(1-12) - Name of the numbered month of the year</li>
		<li>AM_STR - String for Ante meridian</li>
		<li>PM_STR - String for Post meridian</li>
		<li>D_T_FMT - String that can be used as the format string for strftime() to represent time and date</li>
		<li>D_FMT - String that can be used as the format string for strftime() 
		to represent date</li>
		<li>T_FMT - String that can be used as the format string for strftime() 
		to represent time</li>
		<li>T_FMT_AMPM - String that can be used as the format string for strftime() to represent time in 12-hour format with ante/post meridian</li>
		<li>ERA - Alternate era</li>
		<li>ERA_YEAR - Year in alternate era format</li>
		<li>ERA_D_T_FMT - Date and time in alternate era format (string can be 
		used in strftime())</li>
		<li>ERA_D_FMT - Date in alternate era format (string can be used in strftime())</li>
		<li>ERA_T_FMT - Time in alternate era format (string can be used in strftime())</li>
	</ul>
	<p>Monetary Category:</p>
	<ul>
		<li>INT_CURR_SYMBOL - Currency symbol (example: USD)</li>
	<li>CURRENCY_SYMBOL - Currency symbol (example: $)</li>
	<li>CRNCYSTR - Same as CURRENCY_SYMBOL</li>
		<li>MON_DECIMAL_POINT - Monetary decimal point character</li>
	<li>MON_THOUSANDS_SEP - Monetary thousands separator</li>
	<li>POSITIVE_SIGN - Positive value character</li>
	<li>NEGATIVE_SIGN -Negative value character</li>
		<li>MON_GROUPING - Array displaying how monetary numbers are grouped 
	(example: 1 000 000)</li>
		<li>INT_FRAC_DIGITS - International fractional digits</li>
		<li>FRAC_DIGITS - Local fractional digits</li>
		<li>P_CS_PRECEDES - True (1) if currency symbol is placed in front of a 
	positive value, False (0) if it is placed behind</li>
		<li>P_SEP_BY_SPACE - True (1) if there is a spaces between the 
	    currency symbol and a positive value, False (0) otherwise</li>
		<li>N_CS_PRECEDES - True (1) if currency symbol is placed in front of a 
	negative value, False (0) if it is placed behind</li>
		<li>N_SEP_BY_SPACE - True (1) if there is a spaces between the 
	    currency symbol and a negative value, False (0) otherwise</li>
		<li>P_SIGN_POSN - Formatting setting. Possible return values:<ul>
			<li>0 - Parentheses surround the quantity and currency symbol</li>
			<li>1 - The sign string is placed in front of the quantity and 
		    currency symbol</li>
			<li>2 - The sign string is placed after the quantity and currency 
            symbol</li>
			<li>3 - The sign string is placed immediately in front of the 
		    currency symbol</li>
			<li>4 - The sign string is placed immediately after the currency 
            symbol</li>
		</ul></li>
	<li>N_SIGN_POSN - Formatting setting. Possible return values:<ul>
		<li>0 - Parentheses surround the quantity and currency symbol</li>
		<li>1 - The sign string is placed in front of the quantity and 
		currency symbol</li>
		<li>2 - The sign string is placed after the quantity and currency symbol</li>
		<li>3 - The sign string is placed immediately in front of the 
		currency symbol</li>
		<li>4 - The sign string is placed immediately after the currency symbol</li>
	</ul>
	</li>
	</ul>
	<p>Numeric Category:</p>
	<ul>
		<li>DECIMAL_POINT - Decimal point character</li>
		<li>RADIXCHAR - Same as DECIMAL_POINT</li>
		<li>THOUSANDS_SEP - Separator character for thousands</li>
		<li>THOUSEP - Same as THOUSANDS_SEP</li>
		<li>GROUPING - Array displaying how numbers are grouped (example: 1 
		000 000)</li>
	</ul>
	<p>Messaging Category:</p>
	<ul>
		<li>YESEXPR - Regex string for matching 'yes' input</li>
		<li>NOEXPR - Regex string for matching 'no' input</li>
		<li>YESSTR - Output string for 'yes'</li>
		<li>NOSTR - Output string for 'no'</li>
	</ul>
	<p>Code set Category:</p>
	<ul>
		<li>CODESET Return a string with the name of the character encoding.
		</li>
	</ul>
	</td>
  </tr>
...
<tr>
	...
	<td style="width:80%">Returns the specific information on success, or FALSE on failure.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.1.0+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_nl_langinfo.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_nl_langinfo.asp#top" target="_top">TOP</a> |
		<a href="func_string_nl_langinfo.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
