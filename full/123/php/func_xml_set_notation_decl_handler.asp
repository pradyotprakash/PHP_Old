...
<title>PHP xml_set_notation_decl_handler() Function</title>
<style>a.menu_func_xml_set_notation_decl_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_set_notation_decl_handler()</span> Function</h1>
<hr>
...
<p>The xml_set_notation_decl_handler() function specifies a function to be called 
when the parser finds a notation declaration in the XML document.</p>
...
<p>The Function specified by the &quot;handler&quot; parameter must have five parameters:<br>
...
<table class="reference notranslate">
  ...
  <tr>
	...
	notation declaration</td>
  </tr>
	<tr>
    <td>base</td>
    <td>Required. Specifies the base for resolving the system 
	identifier (system_id) of the notation declaration. Currently, this is always 
	NULL</td>
  </tr>
	<tr>
    <td>system_id</td>
    <td>Required. Specifies a variable containing the system identifier for the notation 
	declaration</td>
  </tr>
	<tr>
    <td>public_id</td>
    <td>Required. Specifies a variable containing the public identifier for the notation 
	declaration</td>
  </tr>
  </table>
<br>
...
&nbsp;&nbsp;}<br>
<br>
function not_decl_handler($parser,$not,$base,$sysID,$pubID)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo &quot;$not&lt;br /&gt;&quot;;<br>
&nbsp;&nbsp;echo &quot;$sysID&lt;br /&gt;&quot;;<br>
&nbsp;&nbsp;echo &quot;$pubID&lt;BR /&gt;&quot;;<br>
...
xml_set_notation_decl_handler($parser, &quot;not_decl_handler&quot;);<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_set_notation_decl_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_set_notation_decl_handler.asp#top" target="_top">TOP</a> |
		<a href="func_xml_set_notation_decl_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
