...
<title>PHP ftp_ssl_connect() Function</title>
<style>a.menu_func_ftp_ssl_connect{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_ssl_connect()</span> Function</h1>
...
<p>Open a secure SSL-FTP connection:</p>
<div class="example_code notranslate">
&lt;?php<br>// set up basic SSL connection<br>$ftp_server = &quot;123.123.123.123&quot;;<br>
	$ftp_conn = ftp_ssl_connect($ftp_server) or 
	die(&quot;Could not connect to $ftp_server&quot;);<br><br>// login<br>$login 
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// then do 
	something...<br>
	<br>// close SSL connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_ssl_connect() function opens a secure SSL-FTP connection.</p>
<p>When the connection is open, you can run FTP functions against the server.</p>
<p><strong>Note:</strong> This function is only available if both the ftp module 
and the OpenSSL support is built statically into PHP. </p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_ssl_connect(<em>host,port,timeout</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>host</em></td>
    <td>Required. Specifies the FTP server address. Can be a 
	domain address or an IP address. This parameter should not be prefixed with &quot;ftp://&quot; or 
	have any trailing slashes</td>
  </tr>
	<tr>
    <td><em>port</em></td>
    <td>Optional. Specifies the port to connect to. Default is 
	21</td>
  </tr>
  <tr>
    <td><em>timeout</em></td>
    <td>Optional. Specifies the timeout for network operations. 
	Default is 90 seconds</td>
  </tr>
</table>
<br>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns a SSL-FTP stream on success or FALSE on error</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.3+</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>In PHP 5.2.2 this function returns FALSE if it cannot use an SSL 
	connection, instead of fallbacking to a non-SSL connection</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_ssl_connect.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_ssl_connect.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_ssl_connect.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
