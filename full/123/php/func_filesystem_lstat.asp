...
<title>PHP lstat() Function</title>
<style>a.menu_func_filesystem_lstat{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">lstat()</span> Function</h1>
<hr>
...
<p>The lstat() function returns information about a file or symbolic link.</p>
<p>This function returns an array with the following elements:</p>
<ul>
	<li>[0] or [dev] - Device number</li>
	<li>[1] or [ino] - Inode number</li>
	<li>[2] or [mode] - Inode protection mode</li>
	<li>[3] or [nlink] - Number of links</li>
	<li>[4] or [uid] - User ID of owner</li>
	<li>[5] or [gid] - Group ID of owner</li>
	<li>[6] or [rdev] - Inode device type</li>
	<li>[7] or [size] - Size in bytes</li>
	<li>[8] or [atime] - Last access (as Unix timestamp)</li>
	<li>[9] or [mtime] - Last modified (as Unix timestamp)</li>
	<li>[10] or [ctime] - Last inode change (as Unix timestamp)</li>
	<li>[11] or [blksize] - Blocksize of filesystem IO (if supported)</li>
	<li>[12] or [blocks] - Number of blocks allocated</li>
</ul>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the file to check</td>
  </tr>
  </table>
<br>
...
<p><b>Note:</b> The results from this function will differ from server to server. The array 
may 
contain the number index, the name index, or both.</p>

<p><b>Note:</b> The result of this function are cached. Use clearstatcache() to 
clear the cache.</p>
<p><b>Tip:</b> This function is similar to stat(), except that if the file 
parameter is a symbolic link, the status of the symlink is returned (not the 
status of the file pointed to by the symlink).</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_lstat.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_lstat.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_lstat.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
