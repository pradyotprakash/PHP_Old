...
<style>a.menu_php_functions{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_looping_for.asp">« Previous</a></div>
<div class="next"><a class="chapter" href="php_arrays.asp">Next Chapter »</a></div>
</div>
<hr>
<p class="intro">The real power of PHP comes from its functions; it has more 
than 1000 built-in functions.</p>
<hr>
...
<p><strong>Note:</strong> A function name can start with a letter or underscore 
(not a number).</p>
<p><strong>Tip:</strong> Give the function a name that reflects what the 
function does!</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>Remember that function names are case-insensitive.</td>
</tr></table>

<p>In the example below, we create a function named "writeMsg()". The opening 
...
world!". To call the function, just write its name:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>function writeMsg()<br>{<br>echo "Hello world!";<br>
	}<br><br>writeMsg(); // call the function<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_function1">
	Run example »</a>
</div>
<br>
<hr>
...
<p>Information can be passed to functions through arguments. An argument is just 
like a variable.</p>
<p>Arguments are specified after the function name, inside the parentheses. You 
can add as many arguments as you want, just seperate them with a comma. </p>

<p>The following example has a function with one argument ($fname). When the 
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>function familyName($fname)<br>{<br>echo "$fname Refsnes.&lt;br&gt;";<br>
	}<br><br>familyName("Jani");<br>familyName("Hege");<br>
	familyName("Stale");<br>familyName("Kai Jim");<br>familyName("Borge");<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_function2">
	Run example »</a>
</div>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>function familyName($fname,$year)<br>{<br>echo "$fname Refsnes. 
	Born in $year &lt;br&gt;";<br>}<br><br>familyName("Hege","1975");<br>
	familyName("Stale","1978");<br>familyName("Kai Jim","1983");<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_function3">
	Run example »</a>
</div>
<br>
<hr>
...
<p>The following example shows how to use a default parameter. If we call the 
function setHeight() without arguments it takes the default value as argument:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>function setHeight($minheight=50)<br>{<br>echo "The height is : 
	$minheight &lt;br&gt;";<br>}<br><br>setHeight(350);<br>setHeight(); // will use 
	the default value of 50<br>setHeight(135);<br>setHeight(80);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_function4">
	Run example »</a>
</div>
<br>
<hr>
...
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>function sum($x,$y)<br>{<br>$z=$x+$y;<br>return $z;<br>}<br><br>
	echo "5 + 10 = " . sum(5,10) . "&lt;br&gt;";<br>echo "7 + 13 = " . sum(7,13) . 
	"&lt;br&gt;";<br>echo "2 + 4 = " . sum(2,4);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_function5">
	Run example »</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_functions.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_functions.asp#top" target="_top">TOP</a> |
		<a href="php_functions.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
