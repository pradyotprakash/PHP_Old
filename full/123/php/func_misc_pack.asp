...
<title>PHP pack() Function</title>
<style>a.menu_func_misc_pack{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">pack()</span> Function</h1>
...
<p>Pack data into a binary string:</p>
<div class="example_code notranslate">
	&lt;?php<br>echo pack(&quot;C3&quot;,80,72,80);<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_pack">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The pack() function packs data into a binary string.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

pack(<em>format,args+</em>)
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>args+</em></td>
    <td>Optional. Specifies one or more arguments to be packed</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a binary string containing data</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The &quot;Z&quot; code was added in PHP 5.5 with the same functionality as &quot;a&quot; for 
	Perl compatibility</td>
</tr>
</table>
<br>
<hr>
...
<p>Pack data into a binary string:</p>
<div class="example_code notranslate">
	&lt;?php<br>echo pack(&quot;C*&quot;,80,72,80);<br>
	?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_pack2">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_pack.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_pack.asp#top" target="_top">TOP</a> |
		<a href="func_misc_pack.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
