...
<title>PHP chr() Function</title>
<style>a.menu_func_string_chr{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">chr()</span> Function</h1>
...
<p>Return characters from different ASCII values:</p>
<div class="example_code notranslate">

&lt;?php<br>
echo chr(52) . &quot;&lt;br&gt;&quot;; // Decimal value<br>
echo chr(052) . &quot;&lt;br&gt;&quot;; // Octal value<br>
echo chr(0x52) . &quot;&lt;br&gt;&quot;; // Hex value<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_chr">Run example &raquo;</a>
</div>
<hr>
...
<p>The ASCII value can be specified in decimal, octal, or hex values. Octal 
values are defined by a leading 0, while hex values are defined by a leading 0x.</p>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns the specified character</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>Using the octal value 046 to add the ASCII Character: &amp;.</p>
<div class="example_code notranslate">

	&lt;?php<br>$str = chr(046);<br>
	echo(&quot;You $str me forever!&quot;);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_chr2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Using the decimal values 43 and 61 to add the ASCII Characters: + and =.</p>
	<div class="example_code notranslate">

		&lt;?php <br>$str = chr(43);<br>$str2 = chr(61);<br>echo(&quot;2 $str 2 
		$str2 4&quot;); <br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_chr3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_chr.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_chr.asp#top" target="_top">TOP</a> |
		<a href="func_string_chr.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
