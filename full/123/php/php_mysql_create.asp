...
<html lang="en-US">
<head>
<title>PHP Create Database and Tables</title>
<style>a.menu_php_mysql_create{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Create Database and Tables</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_mysql_connect.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_mysql_insert.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A database holds one or more tables.</p>
<hr>

<h2>Create a Database</h2>
<p>The CREATE DATABASE statement is used to create a database in MySQL.</p>
<p>We must add the CREATE DATABASE statement to the mysqli_query() function to 
execute the command.</p>
<p>The following example creates a database named &quot;my_db&quot;:</p>
...
// Create database<br>
	...
	if (mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; echo &quot;Database my_db 
	created successfully&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error 
	creating database: &quot; . mysqli_error($con);<br>&nbsp; }<br>
?&gt;
...
<p>We must add the CREATE TABLE statement to the mysqli_query() function to 
execute the command.</p>
<p>The following example creates a table named &quot;Persons&quot;, with 
...
<br>
// Create table<br>
	$sql=&quot;CREATE TABLE Persons(FirstName CHAR(30),LastName CHAR(30),Age INT)&quot;;<br>
<br>
// Execute query<br>
	if (mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; echo &quot;Table persons 
	created successfully&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error 
	creating table: &quot; . mysqli_error($con);<br>&nbsp; }<br>
?&gt;

</div></div>
<p><b>Note:</b> When you create a field of type CHAR, you must 
specify the maximum length 
of the field, e.g. CHAR(50).</p>
<p>The data type specifies what type of data the column can hold. For a complete 
reference of all the data types available in MySQL, go to our complete
<a href="../sql/sql_datatypes.asp">Data Types reference</a>.<br>
</p>
<hr>

<h2>Primary Keys and Auto Increment Fields</h2>
<p>Each table in a database should have a  
primary key field.</p>
...
record.</p>
<p>The following example sets the PID field as the primary key field. The 
...
field by 1 each time a new record is added. To ensure that the primary key field 
cannot be null, we must add the NOT NULL setting to the field:</p>
<div class="code notranslate"><div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_mysql_create.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_mysql_create.asp#top" target="_top">TOP</a> |
		<a href="php_mysql_create.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
