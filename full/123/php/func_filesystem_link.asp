...
<title>PHP link() Function</title>
<style>a.menu_func_filesystem_link{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">link()</span> Function</h1>
<hr>
...
<p>The link() function creates a hard link from the existing target with the 
specified name link.</p>
...
<p><b>Note:</b> This function will not work on remote files.</p>
<hr>
<a href="php_ref_filesystem.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Filesystem Reference" /> Complete PHP Filesystem Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_link.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_link.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_link.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
