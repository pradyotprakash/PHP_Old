...
<title>PHP strspn() Function</title>
<style>a.menu_func_string_strspn{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strspn()</span> Function</h1>
...
<p>Return the number of characters found in the string "Hello world!" that 
contains the characters "kHlleo":</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strspn">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strspn() function returns the number of characters found in the string 
that contains only characters from the charlist parameter.</p>
<p><strong>Tip:</strong> Use the <a href="func_string_strcspn.asp">strcspn()</a> 
function to return the number of characters found in a string before any part of 
the specified characters are found.</p>
...
strspn(<em>string,charlist,start,length</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the characters to find</td>
  </tr>
  <tr>
    <td><em>start</em></td>
    <td>Optional. Specifies where in the string to start</td>
  </tr>
  <tr>
    <td><em>length</em></td>
    <td>Optional. Defines the length of the string</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the number of characters found in the string that 
	contains only characters from the <em>charlist</em> parameter.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>Return the number of characters found in the string &quot;abcdefand" that 
contains the characters "abc":</p>
<div class="example_code notranslate">

	&lt;?php<br>
echo strspn(&quot;abcdefand&quot;,&quot;abc&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strspn2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strspn.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strspn.asp#top" target="_top">TOP</a> |
		<a href="func_string_strspn.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
