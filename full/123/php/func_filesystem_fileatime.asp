...
<title>PHP fileatime() Function</title>
<style>a.menu_func_filesystem_fileatime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fileatime()</span> Function</h1>
<hr>
...
<p>The fileatime() function returns the last access time of the specified file.</p>
<p>This function returns the last access time as a Unix timestamp on success, 
FALSE on failure.</p>
<h2>Syntax</h2>
...
clear the cache.</p>
<p><b>Note:</b> Some Unix systems have access time updates disabled, because 
...
echo &quot;&lt;br /&gt;&quot;;<br>
echo &quot;Last access: &quot;.date(&quot;F d Y H:i:s.&quot;,fileatime(&quot;test.txt&quot;));<br>
?&gt; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fileatime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fileatime.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fileatime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
