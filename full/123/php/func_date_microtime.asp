...
<style>a.menu_func_date_microtime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">microtime()</span> Function</h1>
...
<p>Return the current Unix timestamp with microseconds:</p>
<div class="example_code notranslate">
&lt;?php<br>
	echo(microtime());<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_microtime">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The microtime() function returns the current Unix timestamp with microseconds.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	microtime(<em>get_as_float);</em></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>get_as_float</em></td>
    <td>Optional. When set to TRUE it specifies that the function should return 
	a float, instead of a string. Default is FALSE</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the string &quot;microsec sec&quot; by default, where sec is 
	the number of seconds since the Unix Epoch (0:00:00 January 1, 1970 GMT), 
	and microsec is the microseconds part. If the
	<em>get_as_float</em> parameter is set to TRUE, it returns a float 
	representing the current time in seconds since the Unix epoch accurate to 
	the nearest microsecond</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>PHP 5.0.0: Added the <em>get_as_float</em> parameter</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_microtime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_microtime.asp#top" target="_top">TOP</a> |
		<a href="func_date_microtime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
