...
<style>a.menu_func_string_addcslashes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">addcslashes()</span> Function</h1>
...
<p>Add a backslash in front of the character &quot;W&quot;:</p>
<div class="example_code notranslate">

	&lt;?php <br>$str = addcslashes(&quot;Hello World!&quot;,&quot;W&quot;);<br>echo($str); <br>?&gt;

</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_addcslashes">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The addcslashes() function returns a string with backslashes in front of 
the specified characters.</p>
<p><strong>Note:</strong> The addcslashes() function is case-sensitive.</p>
<p><b>Note:</b> Be careful using 
addcslashes() on 0 (NULL), r (carriage return), n (newline), t (form feed), f 
...
addcslashes(<em>string,characters</em>)
</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to be escaped</td>
  </tr>
  <tr>
    <td><em>characters</em></td>
    <td>Required. Specifies the characters or range of characters 
	to be escaped</td>
  </tr>
</table>
...
<p>Add backslashes to certain characters in a string:</p>
<div class="example_code notranslate">

&lt;?php<br>
$str = &quot;Welcome to my humble Homepage!&quot;;<br>
echo $str.&quot;&lt;br&gt;&quot;;<br>
echo addcslashes($str,'m').&quot;&lt;br&gt;&quot;;<br>
echo addcslashes($str,'H').&quot;&lt;br&gt;&quot;;<br>
?&gt;

</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_addcslashes2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Add backslashes to a range of characters in a string:</p>
<div class="example_code notranslate">

&lt;?php<br>
$str = &quot;Welcome to my humble Homepage!&quot;;<br>
echo $str.&quot;&lt;br&gt;&quot;;<br>
echo addcslashes($str,'A..Z').&quot;&lt;br&gt;&quot;;<br>
echo addcslashes($str,'a..z').&quot;&lt;br&gt;&quot;;<br>
echo addcslashes($str,'a..g');<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_addcslashes3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_addcslashes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_addcslashes.asp#top" target="_top">TOP</a> |
		<a href="func_string_addcslashes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
