...
<title>PHP xml_get_current_line_number() Function</title>
<style>a.menu_func_xml_get_current_line_number{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_get_current_line_number()</span> Function</h1>
<hr>
...
<p>The xml_get_current_line_number() function gets the current line number for 
an XML parser.</p>
<p>This function returns the current line number on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_get_current_line_number.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_get_current_line_number.asp#top" target="_top">TOP</a> |
		<a href="func_xml_get_current_line_number.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
