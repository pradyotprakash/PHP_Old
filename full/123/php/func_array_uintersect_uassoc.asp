...
<title>PHP array_uintersect_uassoc() Function</title>
<style>a.menu_func_array_uintersect_uassoc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_uintersect_uassoc()</span> Function</h1>
...
<p>Compare the <strong> keys and values</strong> of two arrays (using two 
user-defined functions for comparison) and return the matches:</p>
<div class="example_code notranslate">
&lt;?php<br>
	function myfunction_key($a,$b)<br>{<br>if ($a===$b)<br>&nbsp; {<br>&nbsp; 
	return 0;<br>&nbsp; }<br>&nbsp; return ($a&gt;$b)?1:-1;<br>}<br><br>function myfunction_value($a,$b)<br>{<br>if 
	($a===$b)<br>&nbsp; {<br>&nbsp; return 0;<br>&nbsp; }<br>&nbsp; return 
	($a&gt;$b)?1:-1;<br>}<br><br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;);<br>$a2=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;green&quot;);<br>
	<br>$result=array_uintersect_uassoc($a1,$a2,&quot;myfunction_key&quot;,&quot;myfunction_value&quot;);<br>
	print_r($result);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_uintersect_uassoc">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_uintersect_uassoc() function compares <strong>the keys and values</strong> of two or 
more arrays, and returns the matches.</p>
<p><strong>Note: </strong>This function uses <strong>two</strong> user-defined functions for 
comparison; the key is used in the first function and the value is used in the 
second!</p>
<p>This function compares the keys and values of two (or more) arrays, and return an 
array that contains the entries from <em>array1</em> that are present in <em>array2, array3, 
</em>etc.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
array_uintersect_uassoc(<em>array1,array2,array3...,myfunction_key,myfunction_value</em>)
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>array1</em></td>
    <td>Required. The array to compare from</td>
  </tr>
  <tr>
    <td><em>array2</em></td>
    <td>Required. An array to compare against</td>
  </tr>
  <tr>
    <td><em>array3,...</em></td>
    <td>Optional. More arrays to compare against</td>
  </tr>
  <tr>
    <td><em>myfunction_key</em></td>
    <td>Required. The name of the user-defined function that compares 
    the array keys.<br>A string that define a callable comparison function. The 
	comparison function must return an integer &lt;, =, or &gt; than 0 if the first 
	argument is &lt;, =, or &gt; than the second argument</td>
  </tr>
  <tr>
    <td><em>myfunction_value</em></td>
    <td>Required. The name of the user-defined function that compares 
    the array values.<br>A string that define a callable comparison function. 
	The comparison function must return an integer &lt;, =, or &gt; than 0 if the 
	first argument is &lt;, =, or &gt; than the second argument.</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns an array containing the entries from <em>
	array1</em> that are present in all of the other arrays</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_uintersect_uassoc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_uintersect_uassoc.asp#top" target="_top">TOP</a> |
		<a href="func_array_uintersect_uassoc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
