...
<style>a.menu_func_zip_entry_open{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">zip_entry_open()</span> Function</h1>
<hr>
...
<p>The zip_entry_open() function opens a zip archive entry for reading.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>zip</td>
    <td>Required. Specifies the zip resource to read (a zip file 
	opened with zip_open() )</td>
  </tr>
	<tr>
    <td>zip_entry</td>
    <td>Required. Specifies the zip entry resource to open (a zip 
	entry 
	opened with zip_read() )</td>
  </tr>
	<tr>
    <td>mode</td>
    <td>Optional. Specifies the type of access you require to the 
	zip archive.<p><b>Note:</b> In PHP 5, mode is ignored and is always &quot;rb&quot;. 
	This is because zip support in PHP is read only</td>
  </tr>
  </table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_zip_entry_open.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_zip_entry_open.asp#top" target="_top">TOP</a> |
		<a href="func_zip_entry_open.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
