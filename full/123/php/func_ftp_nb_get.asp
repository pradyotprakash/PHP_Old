...
<title>PHP ftp_nb_get() Function</title>
<style>a.menu_func_ftp_nb_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_nb_get()</span> Function</h1>
...
<p>Download a file from the FTP server, and save it into a local file (non-blocking):&nbsp;</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$local_file = 
	&quot;local.zip&quot;;<br>$server_file = 
	&quot;server.zip&quot;;<br><br>// initiate download<br>$d = ftp_nb_get($ftp_conn, 
	$local_file, $server_file, FTP_ASCII)<br><br>while ($d == FTP_MOREDATA)<br>&nbsp; 
	...
	$server_file&quot;;<br>&nbsp; exit(1);<br>&nbsp; }<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_nb_get() function gets (downloads) a file from the FTP server, and saves it 
...
ftp_nb_get(<em>ftp_connection,local_file,server_file,mode,startpos</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the local file path (will be overwritten if the file 
	already exists)</td>
  </tr>
	<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_nb_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_nb_get.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_nb_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
