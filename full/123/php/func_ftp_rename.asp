...
<title>PHP ftp_rename() Function</title>
<style>a.menu_func_ftp_rename{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_rename()</span> Function</h1>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$old_file = &quot;oldfile.txt&quot;;<br>
	$new_file = &quot;newfile.txt&quot;;<br><br>// try to rename $old_file to $new_file<br>
	if (ftp_rename($ftp_conn, $old_file, $new_file))<br>&nbsp; {<br>&nbsp; echo 
	&quot;Renamed $old_file to $new_file&quot;;<br>&nbsp; }<br>else<br>&nbsp; 
	{<br>&nbsp; echo &quot;Problem renaming $old_file to $new_file&quot;;<br>&nbsp; }<br>
...
<p>The ftp_rename() function renames a file or directory on the FTP server.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_rename(<em>ftp_connection,oldname,newname</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td><em>oldname</em></td>
    <td>Required. Specifies the file or directory to rename</td>
  </tr>
	<tr>
    <td><em>newname</em></td>
    <td>Required. Specifies the new name of the file or directory</td>
  </tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_rename.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_rename.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_rename.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
