...
<title>PHP zip_entry_close() Function</title>
<style>a.menu_func_zip_entry_close{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">zip_entry_close()</span> Function</h1>
<hr>
...
<p>The zip_entry_close() function closes a zip archive opened by the 
zip_entry_open() function.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  <tr>
	...
	<tr>
    <td>zip_entry</td>
    <td>Required. Specifies the zip entry resource to close (a zip 
	entry 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_zip_entry_close.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_zip_entry_close.asp#top" target="_top">TOP</a> |
		<a href="func_zip_entry_close.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
