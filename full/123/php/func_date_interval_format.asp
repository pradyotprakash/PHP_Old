...
<title>PHP date_interval_format()/DateInterval::format() Function</title>
<style>a.menu_func_date_interval_format{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_interval_format()</span> Function</h1>
...
<p>Calculate the interval between two dates, then format the interval:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$date1=date_create(&quot;2013-01-01&quot;);<br>$date2=date_create(&quot;2013-02-10&quot;);<br>
	$diff=date_diff($date1,$date2);<br><br>// %a outputs the total number of 
	days<br>echo $diff-&gt;format(&quot;Total number of days: %a.&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_interval_format">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_interval_format() function is an alias of DateInterval::format().</p>
<p>The DateInterval::format() function is used to format the interval.&nbsp;</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
DateInterval::format(<em>format);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the format. The following characters can be 
	used in the <em>format</em> parameter string:
	<ul>
		<li>% - Literal %</li>
		<li>Y - Year, at least 2 digits with leading zero (e.g 03)</li>
		<li>y - Year (e.g 3)</li>
		<li>M - Month, with leading zero (e.g 06)</li>
		<li>m - Month (e.g 6)</li>
		<li>D - Day, with leading zero (e.g 09)</li>
		<li>d - Day (e.g 9)</li>
		<li>a - Total number of days as a result of date_diff()</li>
		<li>H - Hours, with leading zero (e.g 08, 23)</li>
		<li>h - Hours (e.g 8, 23)</li>
		<li>I - Minutes, with leading zero (e.g 08, 23)</li>
		<li>i - Minutes (e.g 8, 23)</li>
		<li>S - Seconds, with leading zero (e.g 08, 23)</li>
		<li>s - Seconds (e.g 8, 23)</li>
		<li>R - Sign &quot;-&quot; when negative, &quot;+&quot; when positive</li>
		<li>r - Sign &quot;-&quot; when negative, empty when positive</li>
	</ul>
	  <p><strong>Note:</strong> Each format character must be prefixed by a % 
	  sign!</p>
	  </td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the formatted interval</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.3+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_interval_format.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_interval_format.asp#top" target="_top">TOP</a> |
		<a href="func_date_interval_format.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
