...
<title>PHP quoted_printable_decode() Function</title>
<style>a.menu_func_string_quoted_printable_decode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">quoted_printable_decode()</span> Function</h1>
...
<p>Decode a quoted-printable string to an 8-bit ASCII string:</p>
...
Hello<br>
world.</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_quoted_pd">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The quoted_printable_decode() function decodes a quoted-printable string to 
an 8-bit ASCII string.</p>
<p><b>Tip:</b> Data encoded in quoted-printable are unlikely to be modified by 
...
through a character-translating, or line-wrapping gateway.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

quoted_printable_decode(<em>string</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the quoted-printable string to be 
	decoded</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the 8-bit ASCII string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_quoted_printable_decode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_quoted_printable_decode.asp#top" target="_top">TOP</a> |
		<a href="func_string_quoted_printable_decode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
