...
<title>PHP mysqli_query() Function</title>
<style>a.menu_func_mysqli_query{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_query()</span> Function</h1>
...
<p>Perform queries against the database:</p>
...
&nbsp;&nbsp;}<br><br>// Perform queries <br>mysqli_query($con,&quot;SELECT * 
	FROM Persons&quot;);<br>
...
<p>The mysqli_query() function performs a query against the database.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_query(<em>connection,query,resultmode</em>)<em>;</em></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>query</em></td>
    <td>Required. Specifies the query string</td>
  </tr>
  <tr>
    <td><em>resultmode</em></td>
    <td>
	<p>Optional. A constant. Either:</p>
	<ul>
		<li>MYSQLI_USE_RESULT (Use this if we have to retrieve large amount of 
		data)</li>
		<li>MYSQLI_STORE_RESULT (This is default)</li>
	</ul>
	  </td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">For successful SELECT, SHOW, DESCRIBE, or EXPLAIN queries it 
	will return a mysqli_result object. For other successful queries it will 
	return TRUE. FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<tr>
	<th>Changelog:</th>
	<td>PHP 5.3.0 added the ability for async queries</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_query.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_query.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_query.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
