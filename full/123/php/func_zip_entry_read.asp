...
<title>PHP zip_entry_read() Function</title>
<style>a.menu_func_zip_entry_read{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">zip_entry_read()</span> Function</h1>
<hr>
<a href="php_ref_zip.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Zip File Reference" /> Complete PHP Zip File Reference</a>
<hr>

<h2>Definition and Usage</h2>

<p>The zip_entry_read() function gets the contents from a open zip archive entry.</p>
<p>This function returns the content of the entry on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  <tr>
	...
	<tr>
    <td>zip_entry</td>
    <td>Required. Specifies the zip entry resource to read (a zip 
	entry 
	opened with zip_read() )</td>
  </tr>
	<tr>
    <td>length</td>
    <td>Optional. Specifies the number of bytes (uncompressed size) 
	to return. Default is 1024</td>
  </tr>
  </table>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;echo &quot;&lt;p&gt;&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;echo &quot;Name: &quot; . zip_entry_name($zip_entry) . &quot;&lt;br /&gt;&quot;;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (zip_entry_open($zip, $zip_entry))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;echo &quot;File Contents:&lt;br/&gt;&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$contents = zip_entry_read($zip_entry);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;echo &quot;$contents&lt;br /&gt;&quot;;<br>
...
<p>The output of the code depends on the contents of the zip archive:</p>

<div class="code notranslate"><div>

Name: ziptest.txt<br>
File Contents:<br>
Hello World! This is a test for a the zip functions in PHP.<br>
<br>
Name: htmlziptest.html<br>
File Contents:
<h1>Hello World!</h1>
This is a test for a the <b>zip functions</b> in PHP.
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_zip_entry_read.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_zip_entry_read.asp#top" target="_top">TOP</a> |
		<a href="func_zip_entry_read.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
