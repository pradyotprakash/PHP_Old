...
<title>PHP usleep() Function</title>
<style>a.menu_func_misc_usleep{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">usleep()</span> Function</h1>
...
<p>Delay execution of the current script for 5 seconds (5000000 microseconds):</p>
<div class="example_code notranslate">
&lt;?php<br>echo date('h:i:s') . &quot;&lt;br&gt;&quot;;<br><br>//sleep for 5 seconds<br>
	usleep(5000000);<br><br>//start again<br>echo date('h:i:s');<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_usleep">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The usleep() function delays execution of the current script for a specified number of 
microseconds (a microsecond equals one millionth of a second).</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>microseconds</em></td>
    <td>Required. Specifies the number of microseconds to delay the 
	script</td>
  </tr>
  </table>
...
<tr>
	<th>Changelog:</th>
	<td>This function did not work on Windows platforms until PHP 5</td>
</tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_usleep.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_usleep.asp#top" target="_top">TOP</a> |
		<a href="func_misc_usleep.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
