...
<title>PHP ignore_user_abort() Function</title>
<style>a.menu_func_misc_ignore_user_abort{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ignore_user_abort()</span> Function</h1>
...
<p>Set to false (default) - client aborts will cause the script to stop running:</p>
<div class="example_code notranslate">
&lt;?php<br>ignore_user_abort();<br>
?&gt;</div>
...
<p>The ignore_user_abort() function sets whether a remote client can abort the 
running of a script.</p>
<p><b>Tip:</b> You can call this function without an 
argument, to return the current setting.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ignore_user_abort(<em>setting</em>)
</div></div><br>
<table class="reference notranslate">
  ...
  <tr>
    <td><em>setting</em></td>
    <td>Optional. TRUE ignores user aborts in 
	a script (the script will continue to run). This is FALSE by default, 
	meaning that client aborts will cause the script to stop running </td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the previous value of the user-abort setting</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_ignore_user_abort.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_ignore_user_abort.asp#top" target="_top">TOP</a> |
		<a href="func_misc_ignore_user_abort.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
