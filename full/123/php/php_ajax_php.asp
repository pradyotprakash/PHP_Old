...
<style>a.menu_php_ajax_php{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ajax_intro.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ajax_database.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<form action="php_ajax_php.asp"> 
First name: <input type="text" id="txt1" onkeyup="showHint(this.value)" size="20">
</form>
...
<h2>The PHP File</h2>
<p>The page on the server called by the JavaScript above is a PHP file called &quot;gethint.php&quot;.</p>
<p>The source code in &quot;gethint.php&quot; checks an array of names, and returns the corresponding name(s) to the 
browser:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ajax_php.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ajax_php.asp#top" target="_top">TOP</a> |
		<a href="php_ajax_php.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
