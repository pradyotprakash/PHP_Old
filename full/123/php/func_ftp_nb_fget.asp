...
<title>PHP ftp_nb_fget() Function</title>
<style>a.menu_func_ftp_nb_fget{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_nb_fget()</span> Function</h1>
<p><a href="php_ref_ftp.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP FTP Reference" /> PHP FTP Reference</a></p>
<div class="example">
<h2 class="example">Example</h2>
<p>Download a file from the FTP server, and save it to an open local file 
(non-blocking):</p>
<div class="example_code notranslate">
&lt;?php<br>// connect and login to FTP server<br>
	$ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or 
	die(&quot;Could not connect to $ftp_server&quot;);<br>$login 
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$server_file = 
	&quot;somefile.txt&quot;;<br><br>// open local file to write to<br>$local_file = 
	&quot;local.txt&quot;;<br>$fp = fopen($local_file,&quot;w&quot;);<br><br><br>// initiate download<br>$d = ftp_nb_fget($ftp_conn, 
	$fp, $server_file, FTP_BINARY)<br><br>while ($d == FTP_MOREDATA)<br>&nbsp; 
	{<br>&nbsp; // do whatever you want<br>&nbsp; // continue downloading<br>&nbsp; $d = ftp_nb_continue($ftp_conn);<br>&nbsp; }<br>
	<br>if ($d != FTP_FINISHED)<br>&nbsp; {<br>&nbsp; echo &quot;Error downloading 
	$server_file&quot;;<br>&nbsp; exit(1);<br>&nbsp; }<br><br>// close connection and file 
	handler<br>ftp_close($ftp_conn);<br>fclose($fp);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_nb_fget() function gets (downloads) a file from the FTP server, and saves it 
into an open local file (non-blocking).</p>
<p><strong>Tip:</strong> This function (as opposite to
<a href="func_ftp_fget.asp">ftp_fget()</a>) 
...
ftp_nb_fget(<em>ftp_connection,open_file,server_file,mode,startpos</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>ftp_connection</em></td>
    <td>Required. Specifies the FTP connection to use</td>
  </tr>
	<tr>
    <td><em>open_file</em></td>
    <td>Required. Specifies an open local file in which we store the data</td>
  </tr>
	<tr>
	...
	<tr>
    <td><em>mode</em></td>
    <td>Required. Specifies the transfer mode. Possible values: FTP_ASCII or FTP_BINARY</td>
  </tr>
  <tr>
    <td><em>startpos</em></td>
    <td>Optional. Specifies the position in the remote file to start downloading 
	from</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">This function returns one of the following values:
<ul>
	<li>FTP_FAILED (send/receive failed)</li>
	<li>FTP_FINISHED (send/receive completed)</li>
	<li>FTP_MOREDATA (send/receive in progress)</li>
</ul>
	</td>
</tr>
<tr>
...
<a href="php_ref_ftp.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP FTP Reference" /> PHP FTP Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_nb_fget.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_nb_fget.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_nb_fget.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
