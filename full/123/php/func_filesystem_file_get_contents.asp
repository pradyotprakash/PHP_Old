...
<style>a.menu_func_filesystem_file_get_contents{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">file_get_contents()</span> Function</h1>
<hr>
...
<p>The file_get_contents() reads a file into a string.</p>
<p>This function is the preferred way to read the contents of a file into 
a string. Because it will use memory mapping techniques, if this is supported 
by the server, to 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>path</td>
    <td>Required. Specifies the file to read</td>
  </tr>
	<tr>
    <td>include_path</td>
	...
	<tr>
    <td>start</td>
    <td>Optional. Specifies where in the file to start reading. 
	This parameter was added in PHP 5.1</td>
  </tr>
  <tr>
    <td>max_length</td>
    <td>Optional. Specifies how many bytes to read. This parameter 
	was added in PHP 5.1</td>
  </tr>
  </table>
<br>
...
<p><b>Tip:</b> This function is binary-safe (meaning that both binary data, like 
images, and character data can be written with this function).</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_file_get_contents.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_file_get_contents.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_file_get_contents.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
