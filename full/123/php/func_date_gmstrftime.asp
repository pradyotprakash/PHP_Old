...
<title>PHP gmstrftime() Function</title>
<style>a.menu_func_date_gmstrftime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">gmstrftime()</span> Function</h1>
...
<p>Format GMT/UTC date and time according to locale settings:</p>
<div class="example_code notranslate">

&lt;?php<br>
	echo(gmstrftime(&quot;%B %d %Y, %X %Z&quot;,mktime(20,0,0,12,31,98)).&quot;&lt;br&gt;&quot;);<br>
	setlocale(LC_ALL,&quot;hu_HU.UTF8&quot;);<br>echo(gmstrftime(&quot;%Y. %B %d. %A. %X %Z&quot;));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_gmstrftime">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The gmstrftime() function formats a GMT/UTC time and/or date according to locale settings.</p>
<p><strong>Tip:</strong> Also look at the <a href="func_date_strftime.asp">strftime()</a> function, 
which formats a local time and/or date according to locale settings.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
gmstrftime(<em>format,timestamp);</em></div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_gmstrftime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_gmstrftime.asp#top" target="_top">TOP</a> |
		<a href="func_date_gmstrftime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
