...
<title>PHP mysqli_get_charset() Function</title>
<style>a.menu_func_mysqli_get_charset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_get_charset()</span> Function</h1>
...
<p>Return a character set object, with its properties:</p>
...
&nbsp;&nbsp;}<br><br>var_dump(mysqli_get_charset($con));<br>
...
<p>The mysqli_get_charset() function returns a character set object.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_get_charset(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns a character set object with the following properties:<br>
	<ul>
		<li>charset - character set name</li>
		<li>collation - collation name</li>
		<li>dir - directory the charset was fetched from or &quot;&quot;</li>
		<li>min_length - min character length in bytes</li>
		<li>max_length - max character length in bytes</li>
		<li>number - internal character set number</li>
		<li>state - character set status</li>
	</ul>
	</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_get_charset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_get_charset.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_get_charset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
