...
<title>PHP next() Function</title>
<style>a.menu_func_array_next{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">next()</span> Function</h1>
...
<p>Output the value of the current and the next element in the array:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_next">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The next() function moves the internal pointer to, and outputs, the next element 
in the array.</p>
<p>Related methods:</p>
<ul>
...
<tr>
	...
	<td style="width:80%">Returns the value of the next element in the array on 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_next.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_next.asp#top" target="_top">TOP</a> |
		<a href="func_array_next.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
