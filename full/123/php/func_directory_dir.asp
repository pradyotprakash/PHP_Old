...
<title>PHP dir() Function</title>
<style>a.menu_func_directory_dir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">dir()</span> Function</h1>
...
<p>Use the dir() function:</p>
<div class="example_code notranslate">
	&lt;?php <br>$d = dir(getcwd());<br><br>echo &quot;Handle: &quot; . $d-&gt;handle . &quot;&lt;br&gt;&quot;;<br>
	echo &quot;Path: &quot; . $d-&gt;path . &quot;&lt;br&gt;&quot;;<br><br>while (($file = $d-&gt;read()) !== 
	false){ <br>&nbsp; echo &quot;filename: &quot; . $file . &quot;&lt;br&gt;&quot;; <br>} <br>
	$d-&gt;close(); <br>?&gt;</div>
<p>Result:</p>
<div class="example_code notranslate">
	Handle: Resource id #2<br>Path: /etc/php<br>filename: .<br>filename: ..<br>
	filename: ajax.gif<br>filename: books.xml<br>filename: cdcatalog.xml<br>
	filename: cd_catalog.xml<br>filename: default.asp<br>filename: 
	demo_array.asp<br>filename: demo_array.htm<br>...<br>
	...<br>...</div>
<br>
</div>
<hr>
...
<p>The dir() function returns an instance of the Directory class. This function 
is used to read a directory, which includes the following:</p>
<ul>
	<li>The given directory is opened</li>
	<li>The two properties handle and path of dir() are available</li>
	<li>Both handle and path properties have three methods: read(), rewind(), 
	and close()</li>
</ul>
<hr>
...
dir(<em>directory,context</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the directory to open</td>
  </tr>
  <tr>
    <td><em>context</em></td>
    <td>Optional.</td>
...
<tr>
	...
	<td style="width:80%">Returns an instance of the Directory class. FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_directory_dir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_directory_dir.asp#top" target="_top">TOP</a> |
		<a href="func_directory_dir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
