...
<title>PHP mysqli_set_charset() Function</title>
<style>a.menu_func_mysqli_set_charset{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_set_charset()</span> Function</h1>
...
<p>Set the default client character set:</p>
...
&nbsp;&nbsp;}<br><br>// Change character set to utf8<br>
	mysqli_set_charset($con,&quot;utf8&quot;);<br><br>mysqli_close($con);<br>
?&gt;
</div>
</div>
<hr>
...
<p>The mysqli_set_charset() function specifies the default character set to be 
used when sending data from and to the database server.</p>
<p><strong>Note:</strong> For this function to work on a Windows platform, you 
need MySQL client library 4.1.11 or above (for MySQL 5.0 you need 5.0.6 or above). </p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_set_charset(<em>connection,charset</em>)<em>;</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>charset</em></td>
    <td>Required. Specifies the default character set</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_set_charset.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_set_charset.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_set_charset.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
