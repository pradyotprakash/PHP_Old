...
<title>PHP jewishtojd() Function</title>
<style>a.menu_func_cal_jewishtojd{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">jewishtojd()</span> Function</h1>
...
<p>Convert a Jewish date to a Julian Day Count:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$jd=jewishtojd(6,20,2007);<br>echo $jd;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_jewishtojd">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The jewishtojd() function converts a date from the Jewish Calendar to a Julian Day Count.</p>
<p><strong>Note:</strong> Although this function can handle dates back to year 1 (3761 B.C.), notice that
in the beginning there was no formula to determine the start of a month. A new month was started when the
new moon was first observed.</p>
<p><strong>Tip:</strong> Look at the <a href="func_cal_jdtojewish.asp">jdtojewish()</a> function to convert
a Julian Day Count to a Jewish date.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	jewishtojd(<em>month,day,year);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>year</em></td>
    <td>Required. Specifies the year as a number between 1 and 9999</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_jewishtojd.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_jewishtojd.asp#top" target="_top">TOP</a> |
		<a href="func_cal_jewishtojd.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
