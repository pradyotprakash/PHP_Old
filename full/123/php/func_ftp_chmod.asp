...
<title>PHP ftp_chmod() Function</title>
<style>a.menu_func_ftp_chmod{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_chmod()</span> Function</h1>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$file = &quot;php/test.txt&quot;;<br>
	<br>// Try to set read and write for owner and read for everybody else<br>
	if (ftp_chmod($ftp_conn, 0644, $file) !== false)<br>&nbsp; {<br>&nbsp; echo 
	&quot;Successfully chmoded $file to 644.&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; 
	echo &quot;chmod failed.&quot;;<br>&nbsp; }<br>
	<br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_chmod() function sets permissions on the specified file via FTP.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_chmod(<em>ftp_connection,mode,file</em>);
</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td><em>mode</em></td>
    <td>Required. Specifies the new permissions.<p>This 
	parameter consists of four numbers:</p>
	<ul>
		<li>The first number is always zero</li>
		<li>The second number specifies permissions for the OWNER</li>
		<li>The third number specifies permissions for the OWNER's USER GROUP</li>
		<li>The fourth number specifies permissions for EVERYBODY ELSE</li>
	</ul>
	<p>Possible values (to set multiple permissions, add up the following 
	numbers):</p>
	<ul>
		<li>1 = execute permissions</li>
		<li>2 = write permissions</li>
		<li>4 = read permissions</li>
	</ul>
	</td>
  </tr>
	<tr>
    <td><em>file</em></td>
    <td>Required. Specifies the file to set permissions on</td>
  </tr>
	</table>
<br>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns the new file permissions on success or FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_chmod.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_chmod.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_chmod.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
