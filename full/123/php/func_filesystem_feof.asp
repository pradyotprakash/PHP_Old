...
<title>PHP feof() Function</title>
<style>a.menu_func_filesystem_feof{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">feof()</span> Function</h1>
<hr>
...
<p>This function returns TRUE if an error occurs, or if EOF has been reached. 
...
<p><b>Tip:</b> The feof() function is useful for looping through data of unknown length.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_feof.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_feof.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_feof.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
