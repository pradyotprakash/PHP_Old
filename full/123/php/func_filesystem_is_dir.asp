...
<title>PHP is_dir() Function</title>
<style>a.menu_func_filesystem_is_dir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">is_dir()</span> Function</h1>
<hr>
...
<p>The is_dir() function checks whether the specified file is a directory.</p>
<p>This function returns TRUE if the directory exists.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_is_dir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_is_dir.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_is_dir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
