...
<title>PHP headers_list() Function</title>
<style>a.menu_func_http_headers_list{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">headers_list()</span> Function</h1>
<hr>
...
<p>The headers_list() function returns a list of response headers sent (or ready to send) to a client.</p>
<p>This function returns an array of headers.</p>
...
<p><b>Tip:</b> To determine whether or not the headers have been sent yet, use 
the headers_sent() function.</p>
<hr>
<h2>Example 1</h2>
...
&lt;?php<br>
setcookie(&quot;TestCookie&quot;,&quot;SomeValue&quot;');<br>
header(&quot;X-Sample-Test: foo&quot;);<br>
...
<br>
&lt;?php<br>
// What headers are to be sent?<br>
var_dump(headers_list());<br>
?&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
...
array(4)<br>
{<br>
[0]=&gt; string(23) &quot;X-Powered-By: PHP/5.1.1&quot;<br>
[1]=&gt; string(19) &quot;Set-Cookie: TestCookie=SomeValue&quot;<br>
[2]=&gt; string(18) &quot;X-Sample-Test: foo&quot;<br>
[3]=&gt; string(24) &quot;Content-type: text/plain&quot;<br>
}
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_http_headers_list.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_http_headers_list.asp#top" target="_top">TOP</a> |
		<a href="func_http_headers_list.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
