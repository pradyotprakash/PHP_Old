...
<title>PHP ceil() Function</title>
<style>a.menu_func_math_ceil{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ceil()</span> Function</h1>
...
<p>Round numbers up to the nearest integer:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_ceil">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ceil() function rounds a number UP to the nearest integer, if necessary.</p>
...
<tr>
	...
	<td style="width:80%">The value rounded up to the nearest integer</td>
</tr>
<tr>
	<th>Return Type:</th>
	<td>Float</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_ceil.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_ceil.asp#top" target="_top">TOP</a> |
		<a href="func_math_ceil.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
