...
<title>PHP xml_set_unparsed_entity_decl_handler() Function</title>
<style>a.menu_func_xml_set_unparsed_entity_decl_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_set_unparsed_entity_decl_handler()</span> Function</h1>
<hr>
<a href="php_ref_xml.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP XML Reference" /> Complete PHP XML Reference</a>
<hr>

<h2>Definition and Usage</h2>

<p>The xml_set_unparsed_entity_decl_handler() function specifies a function to be called 
when the parser an unparsed entity in the XML document.</p>
<p>This function returns TRUE on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>parser</td>
    <td>Required. Specifies XML parser to use</td>
  </tr>
	<tr>
    <td>handler</td>
    <td>Required. Specifies a function to be when the parser finds 
	a notation declaration</td>
  </tr>
  </table>
<p>The Function specified by the &quot;handler&quot; parameter must have six parameters:<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>parser</td>
    <td>Required. Specifies a variable containing the XML parser 
	calling the handler</td>
  </tr>
	<tr>
    <td>name</td>
    <td>Required. Specifies a variable containing the name of the 
	entity</td>
  </tr>
	<tr>
    <td>base</td>
    <td>Required. Specifies a variable containing the base for resolving the system 
	identifier (system_id) of the entity. Currently, this is always 
	NULL</td>
  </tr>
	<tr>
    <td>system_id</td>
    <td>Required. Specifies a variable containing the system 
	identifier for the entity</td>
  </tr>
	<tr>
    <td>public_id</td>
    <td>Required. Specifies a variable containing the public identifier for the 
	entity</td>
  </tr>
	<tr>
    <td>notation</td>
    <td>Required. Specifies a variable containing the notation 
	identifying the data type of the entity</td>
  </tr>
  </table>
<br>
<hr>
...
<p><b>Note:</b> The handler parameter can also be an array containing an 
object reference and a method name.</p>
...
&nbsp;&nbsp;}<br>
<br>
function unparsed_ent_handler($parser,$entname,<br>
$base,$sysID,$pubID,$notname)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;print &quot;$entname&lt;br /&gt;&quot;;<br>
&nbsp;&nbsp;print &quot;$sysID&lt;br /&gt;&quot;;<br>
&nbsp;&nbsp;print &quot;$pubID&lt;br /&gt;&quot;;<br>
...
xml_set_unparsed_entity_decl_handler($parser,<br>
&quot;unparsed_ent_handler&quot;);<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_set_unparsed_entity_decl_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_set_unparsed_entity_decl_handler.asp#top" target="_top">TOP</a> |
		<a href="func_xml_set_unparsed_entity_decl_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
