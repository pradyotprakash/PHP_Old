...
<title>PHP FILTER_SANITIZE_NUMBER_INT Filter</title>
<style>a.menu_filter_sanitize_number_int{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_SANITIZE_NUMBER_INT</span> Filter</h1>
<hr>
...
<p>The FILTER_SANITIZE_NUMBER_INT filter removes all illegal characters from a 
number.</p>
<p>This filter allows digits and . + -</p>
<ul>
	<li>Name: &quot;number_int&quot;</li>
	<li>ID-number: 519</li>
</ul>
<hr>
<h2>Example</h2>
...
$number=&quot;5-2+3pp&quot;;<br>
<br>
var_dump(filter_var($number, FILTER_SANITIZE_NUMBER_INT));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_sanitize_number_int.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_sanitize_number_int.asp#top" target="_top">TOP</a> |
		<a href="filter_sanitize_number_int.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
