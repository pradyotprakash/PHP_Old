...
<title>PHP html_entity_decode() Function</title>
<style>a.menu_func_string_html_entity_decode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">html_entity_decode()</span> Function</h1>
...
<p>Convert HTML entities to characters:</p>
<div class="example_code notranslate">
	&lt;?php<br>$str = &quot;&amp;lt;&amp;copy; W3S&amp;ccedil;h&amp;deg;&amp;deg;&amp;brvbar;&amp;sect;&amp;gt;&quot;;<br>echo html_entity_decode($str);<br>
	?&gt;</div>
...
<p>The html_entity_decode() function converts HTML entities to characters.</p>
<p>The html_entity_decode() function is the opposite of
<a href="func_string_htmlentities.asp">htmlentities()</a>.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

html_entity_decode(<em>string,flags,character-se</em>t)
...
<tr>
	...
	to UTF-8 in PHP 5<br><br>The additional flags for specifying the used doctype; ENT_HTML401, ENT_HTML5, 
	ENT_XML1 and ENT_XHTML were added in PHP 5.4<br><br>Support for multi-byte 
	encodings was added in PHP 5.0<br></td>
</tr>
</table>
<br>
...
<p>Convert some HTML entities to characters: </p>
<div class="example_code notranslate">
...
<p>Convert some HTML entities to characters, using the Western European character-set:</p>
<div class="example_code notranslate">
&lt;?php<br>
$str = &quot;My name is &amp;Oslash;yvind &amp;Aring;sane. I&amp;#039;m Norwegian.&quot;;<br>
echo html_entity_decode($str, ENT_QUOTES, &quot;ISO-8859-1&quot;);<br>
?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
&lt;body&gt;<br>
My name is Øyvind Åsane. I'm Norwegian.<br>
&lt;/body&gt;<br>
&lt;/html&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_html_entity_decode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_html_entity_decode.asp#top" target="_top">TOP</a> |
		<a href="func_string_html_entity_decode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
