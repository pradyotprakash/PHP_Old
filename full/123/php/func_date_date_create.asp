...
<title>PHP date_create() Function</title>
<style>a.menu_func_date_date_create{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_create()</span> Function</h1>
...
<p>Return a new DateTime object, and then format the date:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_create">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_create() function returns a new DateTime object.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	date_create(<em>time,timezone);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>time</em></td>
    <td>Optional. Specifies a date/time string. NULL indicates the current time</td>
  </tr>
  <tr>
    <td><em>timezone</em></td>
    <td>Optional. Specifies the timezone of <em>time</em>. Default is the current timezone.<br><br><strong>Tip:</strong>
	<a href="php_ref_timezones.asp">Look at a list of all supported timezones in PHP</a></td>
  </tr>
  </table>
...
<tr>
	<th>Changelog:</th>
	<td>From PHP 5.3+; an exception is thrown if an invalid date is specified</td>
</tr>
</table>
<br>
<hr>
...
<p>Return a new DateTime object (with a given timezone), and then format the date 
and time:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$date=date_create(&quot;2013-03-15 23:40:00&quot;,timezone_open(&quot;Europe/Oslo&quot;));<br>
	echo date_format($date,&quot;Y/m/d H:iP&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_create2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_date_create.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_date_create.asp#top" target="_top">TOP</a> |
		<a href="func_date_date_create.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
