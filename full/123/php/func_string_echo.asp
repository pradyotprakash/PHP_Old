...
<style>a.menu_func_string_echo{font-weight:bold;}</style>
<meta charset="utf-8">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_echo">Run example &raquo;</a>
</div>
<hr>
...
<p><b>Note: </b>The echo() function is not 
...
error.</p>
<p><b>Tip:</b> The echo() function is 
slightly faster than <a href="func_string_print.asp">print()</a>.</p>
<p><b>Tip:</b> The echo() function also has a shortcut syntax. Prior to PHP 
5.4.0, this syntax only works with the short_open_tag configuration setting 
enabled.</p>
<hr>
<h2>Syntax</h2>
...
<p>Write the value of the string variable (<span lang="no-bok">$str)</span> to 
the output:</p>
<div class="example_code notranslate">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_echo2">Run example &raquo;</a>
</div>
<br>
...
<p>Write the value of the string variable (<span lang="no-bok">$str)</span> to 
the output, including HTML tags:</p>
<div class="example_code notranslate">

	&lt;?php<br>$str = &quot;Hello world!&quot;;<br>echo $str;<br>echo &quot;&lt;br&gt;What 
	a nice day!&quot;;<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_echo3">Run example &raquo;</a>
</div>
<br>
...
<div class="example_code notranslate">
	...
	&lt;?php<br>$str1=&quot;Hello world!&quot;;<br>$str2=&quot;What a nice day!&quot;;<br>echo $str1 . 
	&quot; &quot; . $str2;<br>?&gt;&nbsp;

</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_echo4">Run example &raquo;</a>
</div>
<br>
...
<div class="example_code notranslate">
	...
	&lt;?php<br>$age=array(&quot;Peter&quot;=&gt;&quot;35&quot;);<br>echo &quot;Peter is &quot; . $age['Peter'] . &quot; 
	years old.&quot;;<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_echo5">Run example &raquo;</a>
</div>
<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_echo6">Run example &raquo;</a>
</div>
<br>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_echo7">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 7</h2>
<p>Difference of single and double quotes. Single quotes will print the variable 
...
echo 'Roses are $color';<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_echo8">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 8</h2>
<p>Shortcut syntax (will only work with the short_open_tag configuration setting 
enabled): </p>
<div class="example_code notranslate">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_echo9">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_echo.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_echo.asp#top" target="_top">TOP</a> |
		<a href="func_string_echo.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
