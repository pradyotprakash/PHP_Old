...
<title>PHP fscanf() Function</title>
<style>a.menu_func_filesystem_fscanf{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fscanf()</span> Function</h1>
<hr>
...
<p>The fscanf() function parses the input from an open file according to the 
specified format.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>format</td>
    <td>Required. Specifies the format.<p>Possible format values:</p>
<ul>
	<li>%% - Returns a percent sign</li>
	<li>%b - Binary number</li>
	<li>%c - The character according to the ASCII value</li>
	<li>%d - Signed decimal number</li>
	<li>%e - Scientific notation (e.g. 1.2e+2)</li>
	<li>%u - Unsigned decimal number</li>
...
<p>Note: Any whitespace in the format string matches any whitespace in the input 
stream. This means that a tab (\t) in the format string can match a single space 
character in the input stream.</p>
<hr>
<a href="php_ref_filesystem.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Filesystem Reference" /> Complete PHP Filesystem Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fscanf.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fscanf.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fscanf.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
