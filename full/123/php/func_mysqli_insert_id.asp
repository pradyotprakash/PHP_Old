...
<title>PHP mysqli_insert_id() Function</title>
<style>a.menu_func_mysqli_insert_id{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_insert_id()</span> Function</h1>
...
<p>Assume that the Persons table has an auto-generated id field. Return the id 
used in the last query:</p>
...
&nbsp;&nbsp;}<br><br>mysqli_query($con,&quot;INSERT INTO Persons (FirstName,LastName,Age) <br>
VALUES ('Glenn','Quagmire',33)&quot;);<br><br>// Print auto-generated id<br>echo 
	&quot;New record has id: &quot; . mysqli_insert_id($con); <br>
...
<p>The mysqli_insert_id() function returns the id (generated with AUTO_INCREMENT) used in the last query.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_insert_id(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an integer with the value of the AUTO_INCREMENT 
	field that was updated by the last query. If the number is &gt; max integer 
	value, it will return a string. Returns zero if there were no update or no 
	AUTO_INCREMENT field</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_insert_id.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_insert_id.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_insert_id.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
