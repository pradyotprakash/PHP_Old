...
<title>PHP date_parse_from_format() Function</title>
<style>a.menu_func_date_parse_from_format{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_parse_from_format()</span> Function</h1>
...
<p>Return an associative array with detailed information about a specified date, according to the specified format:</p>
<div class="example_code notranslate">
&lt;?php<br>
print_r(date_parse_from_format(&quot;mmddyyyy&quot;,&quot;05122013&quot;));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_parse_from_format">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_parse_from_format() function returns an associative array with detailed information about 
a specified date, according to the specified format.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_parse_from_format(<em>format,date);</em></div></div>
<br>
<table class="reference notranslate"> 
  <tr>
    ...
    <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the format (a format accepted by
	<a href="func_date_create_from_format.asp">date_create_from_format()</a>)</td>
    </tr>
  <tr>
    <td><em>date</em></td>
    <td>Required. A string that specifies a date</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an associative array containing information about 
	the specified date on success</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.3+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_parse_from_format.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_parse_from_format.asp#top" target="_top">TOP</a> |
		<a href="func_date_parse_from_format.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
