...
<title>PHP children() Function</title>
<style>a.menu_func_simplexml_children{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">children()</span> Function</h1>
...
<p>Find the children of the note node:</p>
<div class="example_code notranslate">
	&lt;?php<br>$note=&lt;&lt;&lt;XML<br>&lt;note&gt;<br>&lt;to&gt;Tove&lt;/to&gt;<br>&lt;from&gt;Jani&lt;/from&gt;<br>
	&lt;heading&gt;Reminder&lt;/heading&gt;<br>&lt;body&gt;Don't 
	forget me this weekend!&lt;/body&gt;<br>&lt;/note&gt;<br>XML;<br><br>
	$xml=simplexml_load_string($note);<br>foreach ($xml-&gt;children() as $child)<br>&nbsp; 
	{<br>&nbsp; echo &quot;Child node: &quot; . $child . &quot;&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_children">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The children() function finds the children of a specified node.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	children(<em>ns,is_prefix</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  <tr>
	...
	<tr>
    <td><em>ns</em></td>
    <td>Optional. Specifies an XML namespace</td>
  </tr>
	<tr>
    <td><em>is_prefix</em></td>
    <td>Optional. Specifies a Boolean value. If TRUE, <em>ns</em> is regarded as a prefix. 
	If FALSE, <em>ns</em> is regarded as a namespace URL</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a SimpleXMLElement object</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.0.1+</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>The <em>is_prefix</em> parameter was added</td>
</tr>
</table>
<br>
<hr>
...
<p>Find the children of the body node:</p>
<div class="example_code notranslate">
	&lt;?php<br>$note=&lt;&lt;&lt;XML<br>&lt;note&gt;<br>&lt;to&gt;Tove&lt;/to&gt;<br>&lt;from&gt;Jani&lt;/from&gt;<br>
	&lt;heading&gt;Reminder&lt;/heading&gt;<br>&lt;body&gt;&lt;span&gt;Important!&lt;/span&gt; Don't forget me 
	this weekend!&lt;/body&gt;<br>&lt;/note&gt;<br>XML;<br><br>
	$xml=simplexml_load_string($note);<br>foreach ($xml-&gt;body[0]-&gt;children() as 
	$child)<br>&nbsp; {<br>&nbsp; echo &quot;Child node: &quot; . $child . &quot;&lt;br&gt;&quot;;<br>&nbsp; 
	}<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_children2">Run example &raquo;</a>
</div>
<br>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_children.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_children.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_children.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
