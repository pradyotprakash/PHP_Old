...
<title>PHP srand() Function</title>
<style>a.menu_func_math_srand{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">srand()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_srand">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The srand() function seeds the random number generator (<a href="func_math_rand.asp">rand()</a>).</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_srand.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_srand.asp#top" target="_top">TOP</a> |
		<a href="func_math_srand.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
