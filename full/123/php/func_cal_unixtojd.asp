...
<title>PHP unixtojd() Function</title>
<style>a.menu_func_cal_unixtojd{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">unixtojd()</span> Function</h1>
...
<p>Convert Unix timestamp to Julian Day Count:</p>
<div class="example_code notranslate">
&lt;?php<br>
echo unixtojd();<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_unixtojd">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The unixtojd() function converts Unix timestamp to Julian Day Count.</p>
<p><strong>Note: </strong>Unix timestamp indicates the number of seconds since midnight of January 1, 1970 (Gregorian Calendar).</p>
<p><strong>Tip:</strong> Look at the <a href="func_cal_jdtounix.asp">jdtounix()</a> function to convert
Julian Day Count to Unix timestamp.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	unixtojd(<em>timestamp);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies A unix timestamp to convert</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the Julian Day number for a Unix timestamp (seconds 
	since 1.1.1970), or for the current day if no <em>timestamp</em> is given</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_unixtojd.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_unixtojd.asp#top" target="_top">TOP</a> |
		<a href="func_cal_unixtojd.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
