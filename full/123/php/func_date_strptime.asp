...
<title>PHP strptime() Function</title>
<style>a.menu_func_date_strptime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strptime()</span> Function</h1>
...
<p>Parse a time/date generated with strftime():</p>
<div class="example_code notranslate">
&lt;?php<br>
$format=&quot;%d/%m/%Y %H:%M:%S&quot;;<br>
$strf=strftime($format);<br>
echo(&quot;$strf&quot;);<br>
print_r(strptime($strf,$format));<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The strptime() function parses a time/date generated with <a href="func_date_strftime.asp">strftime()</a>.</p>
<p><b>Note:</b> This function is not implemented on Windows platforms!</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
strptime(<em>date,format);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>date</em></td>
    <td>Required. The string to parse (e.g. returned from strftime())</td>
  </tr>
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the format used in the date:<ul>
...
<tr>
	...
	<td style="width:80%">This function returns an array with the date parsed on success. FALSE on failure.
	<p>The meaning of the returning array keys are:</p>
<ul>
	<li>[tm_sec] - seconds (0-61)</li>
	<li>[tm_min] - minutes (0-59) </li>
	<li>[tm_hour] - hour (0-23)</li>
	<li>[tm_mday] - day of the month (1-31)</li>
	<li>[tm_mon] - months since January (0-11)</li>
	<li>[tm_year] - years since 1900</li>
	<li>[tm_wday] - days since Sunday (0-6)</li>
	<li>[tm_yday] - days since January 1 (0-365)</li>
	<li>[unparsed] - the date part which was not recognized using the specified 
	format, if any</li>
</ul>
	</td>
</tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_strptime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_strptime.asp#top" target="_top">TOP</a> |
		<a href="func_date_strptime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
