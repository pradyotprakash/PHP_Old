...
<style>a.menu_php_mail{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_sessions.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_secure_mail.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">PHP allows you to send e-mails directly from a script.</p>
<hr>

<h2>The PHP mail() Function</h2>
<p>It is common to send input data from a web form to an email 
address (typically to the webmaster's email address).</p>
<p>PHP provides a convenient way to send email with the mail() function.</p>
<p><b>Syntax</b></p>
<div class="code notranslate"><div>
mail(<em>to,subject,message,headers,parameters</em>)
</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>subject</em></td>
    <td>Required. Specifies the email's subject line.
    <b>Note:</b> This parameter cannot contain any newline characters</td>
  </tr>
  <tr>
    <td><em>message</em></td>
    <td>Required. Specifies the actual email body (the message to be sent). Each line should 
	be separated with a LF (\n). Lines should not exceed 70 characters</td>
  </tr>
  <tr>
    <td><em>headers</em></td>
    <td>Optional. Specifies additional headers such as &quot;From&quot;, &quot;Cc&quot;, &quot;Bcc&quot;, etc. The additional headers should be separated with a CRLF (\r\n)</td>
  </tr>
  <tr>
...
<td><strong>Note:</strong> To use the PHP mail() function, PHP requires an installed 
and working email system. The program to be used is defined by the configuration 
settings in the php.ini file. Read more in our <a href="php_ref_mail.asp">PHP 
Mail reference</a>.</td>
</tr></table>
<br>
<hr>
...
<p>Assume we have the following PHP code on a page:</p>
<div class="code notranslate"><div>
	&lt;h2&gt;Feedback Form&lt;/h2&gt;<br>&lt;?php<br>// display form if user has 
	not clicked submit<br>if (!isset($_POST[&quot;submit&quot;]))<br>&nbsp; {<br>&nbsp; ?&gt;<br>&nbsp; 
	&lt;form method=&quot;post&quot; action=&quot;&lt;?php echo $_SERVER[&quot;PHP_SELF&quot;];?&gt;&quot;&gt;<br>&nbsp; 
	From: &lt;input type=&quot;text&quot; name=&quot;from&quot;&gt;&lt;br&gt;<br>&nbsp; Subject: &lt;input 
	type=&quot;text&quot; name=&quot;subject&quot;&gt;&lt;br&gt;<br>&nbsp; Message: &lt;textarea rows=&quot;10&quot; 
	cols=&quot;40&quot; name=&quot;message&quot;&gt;&lt;/textarea&gt;&lt;br&gt;<br>&nbsp; &lt;input type=&quot;submit&quot; 
	name=&quot;submit&quot; value=&quot;Submit Feedback&quot;&gt;<br>&nbsp; &lt;/form&gt;<br>&nbsp; &lt;?php <br>&nbsp; 
	}<br>else<br>&nbsp; // the user has submitted the form<br>&nbsp; {<br>&nbsp; 
	// Check if the &quot;from&quot; input field is filled out<br>&nbsp; if (isset($_POST[&quot;from&quot;]))<br>&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp; $from = $_POST[&quot;from&quot;]; // sender<br>&nbsp;&nbsp;&nbsp; 
	$subject = $_POST[&quot;subject&quot;];<br>&nbsp;&nbsp;&nbsp; $message = 
	$_POST[&quot;message&quot;];<br>&nbsp;&nbsp;&nbsp; // message lines should not exceed 
	70 characters (PHP rule), so wrap it<br>&nbsp;&nbsp;&nbsp; $message = 
	wordwrap($message, 70);<br>&nbsp;&nbsp;&nbsp; // send mail<br>&nbsp;&nbsp;&nbsp; 
	mail(&quot;webmaster@example.com&quot;,$subject,$message,&quot;From: $from\n&quot;);<br>&nbsp;&nbsp;&nbsp; 
	echo &quot;Thank you for sending us feedback&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; 
	}<br>?&gt;<br>
</div></div>

<p>Example explained:</p>
<ul>
	<li>If the form has not been submitted; display the HTML feedback form</li>
	<li>When the user clicks on the submit button, check if the &quot;from&quot; input 
	field is filled out</li>
	<li>Get the input data from form </li>
	<li>Send mail with PHP mail() function</li>
</ul>

<table class="lamp"><tr>
<th style="width:34px"><img src="http://www.w3schools.com/images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td><strong>Prevent email injection in PHP!!</strong>
<p>In the code above, it is not possible to choose/change the recipient email 
address as it is hardcoded in the script. You might think this is enough to 
prevent email injection, but this is wrong! </p>
<p>The code above is not secure, and can be used by spammers to spam others.
In the next chapter we will discuss vulnerabilities in e-mail scripts, and how to 
check user input to make it more secure.</p>
</td>
</tr></table>
<br>
<hr>
...
<p>For more information about the PHP mail() function, visit our
<a href="php_ref_mail.asp">PHP Mail Reference</a>.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_mail.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_mail.asp#top" target="_top">TOP</a> |
		<a href="php_mail.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
