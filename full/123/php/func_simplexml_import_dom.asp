...
<title>PHP simplexml_import_dom() Function</title>
<style>a.menu_func_simplexml_import_dom{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">simplexml_import_dom()</span> Function</h1>
...
<p>Take a node of a DOM document and make it into a SimpleXML node:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$dom=new domDocument;<br>
	$dom-&gt;loadXML(&quot;&lt;note&gt;&lt;to&gt;Tove&lt;/to&gt;&lt;from&gt;Jani&lt;/from&gt;&lt;/note&gt;&quot;);<br>
	$x=simplexml_import_dom($dom);<br>echo $x-&gt;from;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_import_dom">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The simplexml_import_dom() function returns a SimpleXMLElement object from a DOM node.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
simplexml_import_dom(<em>node,classname</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>node</em></td>
    <td>Required. Specifies a DOM element node</td>
  </tr>
	<tr>
...
<p>Output the title of the second book node in the DOM document:</p>
<div class="example_code notranslate">
	&lt;?php<br>$dom=new domDocument;<br>
	$dom-&gt;loadXML(&quot;&lt;books&gt;&lt;book&gt;&lt;title&gt;Title1&lt;/title&gt;&lt;/book&gt;&lt;book&gt;&lt;title&gt;Title2&lt;/title&gt;&lt;/book&gt;&lt;/books&gt;&quot;);<br>
	$x=simplexml_import_dom($dom);<br>echo $x-&gt;book[1]-&gt;title;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_import_dom2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_import_dom.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_import_dom.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_import_dom.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
