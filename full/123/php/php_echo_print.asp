...
<style>a.menu_php_echo_print{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">echo and print Statements</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_variables.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_datatypes.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">In PHP there is two basic ways to get output: echo and print.</p>
<p class="intro">In this tutorial we use echo (and print) in almost every 
example. So, this chapter contains a little more info about those two output 
statements.</p>
<hr>

<h2>PHP echo and print Statements</h2>
<p>There are some differences between echo and print:</p>
<ul>
	<li>echo - can output one or more strings</li>
	<li>print - can only output one string, and returns always 1</li>
</ul>
<p><strong>Tip:</strong> echo is marginally faster compared to print as echo does not return any value.</p>
<hr>

<h2>The PHP echo Statement</h2>
<p>echo is a language construct, and can be used with or without parentheses: 
echo or echo().</p>
<p><strong>Display Strings</strong></p>
<p>The following example shows how to display different strings with the echo 
command (also notice that the strings can contain HTML markup):</p>
<div class="example">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_echo1">Run example &raquo;</a>
</div>
<p><strong>Display Variables</strong></p>
<p>The following example shows how to display strings and variables with the echo 
command:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>$txt1=&quot;Learn PHP&quot;;<br>$txt2=&quot;W3Schools.com&quot;;<br>
	$cars=array(&quot;Volvo&quot;,&quot;BMW&quot;,&quot;Toyota&quot;);<br><br>echo $txt1;<br>echo 
	&quot;&lt;br&gt;&quot;;<br>echo &quot;Study PHP at $txt2&quot;;<br>echo &quot;My car is a {$cars[0]}&quot;;<br>
	?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_echo2">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>The PHP print Statement</h2>
<p>print is also a language construct, and can be used with or without 
parentheses: 
print or print().</p>
<p><strong>Display Strings</strong></p>
<p>The following example shows how to display different strings with the print 
command (also notice that the strings can contain HTML markup):</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_print1">Run example &raquo;</a>
</div>
<p><strong>Display Variables</strong></p>
<p>The following example shows how to display strings and variables with the 
print 
command:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>$txt1=&quot;Learn PHP&quot;;<br>$txt2=&quot;W3Schools.com&quot;;<br>
	$cars=array(&quot;Volvo&quot;,&quot;BMW&quot;,&quot;Toyota&quot;);<br><br>print $txt1;<br>print &quot;&lt;br&gt;&quot;;<br>
	print &quot;Study PHP at $txt2&quot;;<br>print &quot;My car is a {$cars[0]}&quot;;<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_print2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_echo_print.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_echo_print.asp#top" target="_top">TOP</a> |
		<a href="php_echo_print.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
