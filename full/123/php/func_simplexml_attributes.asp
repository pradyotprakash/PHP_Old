...
<title>PHP attributes() Function</title>
<style>a.menu_func_simplexml_attributes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">attributes()</span> Function</h1>
...
<p>Return attributes and values within the XML body element:</p>
<div class="example_code notranslate">
	&lt;?php<br>$note=&lt;&lt;&lt;XML<br>&lt;note&gt;<br>&lt;to&gt;Tove&lt;/to&gt;<br>&lt;from&gt;Jani&lt;/from&gt;<br>
	&lt;heading&gt;Reminder&lt;/heading&gt;<br>&lt;body date=&quot;2013-01-01&quot; type=&quot;private&quot;&gt;Don't 
	forget me this weekend!&lt;/body&gt;<br>&lt;/note&gt;<br>XML;<br><br>
	$xml=simplexml_load_string($note);<br>foreach($xml-&gt;body[0]-&gt;attributes() as 
	$a =&gt; $b)<br>&nbsp; {<br>&nbsp; echo $a,'=&quot;',$b,&quot;\&quot;&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_attributes">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The attributes() function returns attributes and values within an XML tag.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	attributes(<em>ns,is_prefix</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  <tr>
	...
	<tr>
    <td><em>ns</em></td>
    <td>Optional. Specifies a namespace for the retrieved attributes</td>
  </tr>
	<tr>
...
<tr>
	...
	<td style="width:80%">Returns a SimpleXMLElement object on success</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.0.1+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_attributes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_attributes.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_attributes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
