...
<title>PHP mysqli_error() Function</title>
<style>a.menu_func_mysqli_error{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_error()</span> Function</h1>
...
<p>Return the last error description for the most recent function call, if any:</p>
...
VALUES ('Glenn')&quot;))<br>&nbsp; {<br>&nbsp; echo(&quot;Error description: &quot; . 
	mysqli_error($con));<br>&nbsp; }<br>
...
<p>The mysqli_error() function returns the last error description for the most recent function call, if any.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_error(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns a string with the error description. &quot;&quot; if no error 
	occurred</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_error.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_error.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_error.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
