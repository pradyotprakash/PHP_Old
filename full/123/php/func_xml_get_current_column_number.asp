...
<title>PHP xml_get_current_column_number() Function</title>
<style>a.menu_func_xml_get_current_column_number{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_get_current_column_number()</span> Function</h1>
<hr>
...
<p>The xml_get_current_column_number() function gets the current column number for 
an XML parser.</p>
<p>This function returns the current column number on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;// parse the data chunk<br>
&nbsp;&nbsp;if (!xml_parse($xmlparser,$xmldata,feof($fp)))<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;die( print &quot;ERROR: &quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;. xml_error_string(xml_get_error_code($xmlparser))<br>
&nbsp;&nbsp;&nbsp;&nbsp;. &quot;&lt;br /&gt;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;. &quot;Line: &quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;. xml_get_current_line_number($xmlparser)<br>
&nbsp;&nbsp;&nbsp;&nbsp;. &quot;&lt;br /&gt;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;. &quot;Column: &quot;<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_get_current_column_number.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_get_current_column_number.asp#top" target="_top">TOP</a> |
		<a href="func_xml_get_current_column_number.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
