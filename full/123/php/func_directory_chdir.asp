...
<title>PHP chdir() Function</title>
<style>a.menu_func_directory_chdir{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">chdir()</span> Function</h1>
...
&lt;?php<br>// Get current directory<br>
	echo getcwd() . &quot;&lt;br&gt;&quot;;<br><br>// Change directory<br>
	chdir(&quot;images&quot;);<br><br>// Get current directory<br>
	echo getcwd();<br>
	?&gt;
</div>
<p>Result:</p>
<div class="example_code notranslate">
	/home/php<br>/home/php/images
</div>
<br>
</div>
<hr>
...
<p>The chdir() function changes the current directory.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	chdir(<em>directory</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the new current directory</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">TRUE on success. FALSE on failure. Throws an error of level 
	E_WARNING on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_directory_chdir.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_directory_chdir.asp#top" target="_top">TOP</a> |
		<a href="func_directory_chdir.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
