...
<title>PHP ftp_raw() Function</title>
<style>a.menu_func_ftp_raw{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_raw()</span> Function</h1>
...
<p>Connect to FTP server and execute commands:</p>
<div class="example_code notranslate">
&lt;?php<br>// connect to FTP server<br>
	$ftp_server = &quot;ftp.example.com&quot;;<br>$ftp_conn = ftp_connect($ftp_server) or 
	die(&quot;Could not connect to $ftp_server&quot;);<br><br>// the two lines 
	below is the same as: ftp_login($ftp_conn,&quot;john&quot;,&quot;secretpassword&quot;);<br>
	ftp_raw($ftp_conn, &quot;USER john&quot;);<br>ftp_raw($ftp_conn, &quot;PASS 
	secretpassword&quot;);<br><br>?&gt;</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_raw() function sends a raw command to the FTP server.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_raw(<em>ftp_connection,command</em>);</div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns the server's response as an array of strings</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_raw.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_raw.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_raw.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
