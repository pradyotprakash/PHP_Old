...
<title>PHP file_exists() Function</title>
<style>a.menu_func_filesystem_file_exists{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">file_exists()</span> Function</h1>
<hr>
...
<p>The file_exists() function checks whether or not a file or directory exists.</p>
<p>This function returns TRUE if the file or directory exists, otherwise it 
returns FALSE.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_file_exists.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_file_exists.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_file_exists.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
