...
<title>PHP date_format() Function</title>
<style>a.menu_func_date_date_format{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_format()</span> Function</h1>
...
&lt;?php<br>
	$date=date_create(&quot;2013-03-15&quot;);<br>echo date_format($date,&quot;Y/m/d H:i:s&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_format">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_format() function returns a date formatted according to the specified format.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_format(<em>object,format);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the format for the date</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the formatted date as a string. FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.2+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_date_format.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_date_format.asp#top" target="_top">TOP</a> |
		<a href="func_date_date_format.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
