...
<title>PHP array_fill() Function</title>
<style>a.menu_func_array_fill{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_fill()</span> Function</h1>
...
<p>Fill an array with values:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array_fill(3,4,&quot;blue&quot;);<br>print_r($a1);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_fill">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The array_fill() function fills an array with values.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
array_fill(<em>index,number,value</em>);</div></div>
<br>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>index</em></td>
    <td>Required. The first index of the returned array</td>
  </tr>
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the number of elements to insert</td>
  </tr>
  <tr>
    <td><em>value</em></td>
    <td>Required. Specifies the value to use for filling the array</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns the filled array</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.2+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_fill.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_fill.asp#top" target="_top">TOP</a> |
		<a href="func_array_fill.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
