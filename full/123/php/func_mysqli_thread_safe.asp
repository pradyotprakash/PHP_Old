...
<title>PHP mysqli_thread_safe() Function</title>
<style>a.menu_func_mysqli_thread_safe{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_thread_safe()</span> Function</h1>
...
<p>The mysqli_thread_safe() function returns whether the client library is compiled as thread-safe.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_thread_safe()<em>;</em></div></div>

<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td style="width:80%">Returns TRUE if the client library is thread-safe. FALSE 
	otherwise</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_thread_safe.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_thread_safe.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_thread_safe.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
