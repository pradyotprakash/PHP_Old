...
<title>PHP time_nanosleep() Function</title>
<style>a.menu_func_misc_time_nanosleep{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">time_nanosleep()</span> Function</h1>
...
<p>Delay execution of the current script for 3,5 seconds:</p>
<div class="example_code notranslate">
&lt;?php<br>if (time_nanosleep(3,500000000) === true)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo &quot;Slept for three and a half a second&quot;;<br>
&nbsp;&nbsp;}<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_nanosleep">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The time_nanosleep() function delays execution of the current script for a 
specified number of seconds and nanoseconds.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
time_nanosleep(<em>seconds,nanoseconds</em>)
</div></div><br>
<table class="reference notranslate">
  ...
  <tr>
    <td><em>seconds</em></td>
    <td>Required. Specifies the number of seconds to delay the 
	script</td>
  </tr>
  <tr>
    <td><em>nanoseconds</em></td>
    <td>Required. Specifies the number of&nbsp; nanoseconds to delay the 
	script (must be less than 1,000,000,000)</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">
	Returns TRUE on success, or FALSE on failure.<br><br>If the call was 
	interrupted by a signal, an associative array will be returned with the 
	number of seconds or nanoseconds remaining in the delay.<br>
	</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>Changelog:</th>
	<td>This function did not work on Windows platforms until PHP 5.3.0</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_time_nanosleep.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_time_nanosleep.asp#top" target="_top">TOP</a> |
		<a href="func_misc_time_nanosleep.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
