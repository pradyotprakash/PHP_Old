...
<title>PHP popen() Function</title>
<style>a.menu_func_filesystem_popen{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">popen()</span> Function</h1>
<hr>
...
<p>The popen() function opens a pipe to the program specified in the command 
parameter.</p>
<p>This function returns FALSE if an error occurs.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>mode</td>
    <td>Required. Specifies the connection mode.<p>Possible values:</p>
	<ul>
		<li>r: Read only</li>
		<li>w: Write only (opens and clears existing file or creates a new file)</li>
	</ul>
	</td>
  </tr>
	</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_popen.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_popen.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_popen.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
