...
<style>a.menu_php_switch{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">switch</span> Statement</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_if_else.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_looping.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>Use the switch statement to <strong>select one of many blocks 
of code to be executed</strong>.</p>
<h3>Syntax</h3>
...
code from running into the next case automatically. The <strong>default</strong> statement is used if no 
match is found.</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_switch">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_switch.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_switch.asp#top" target="_top">TOP</a> |
		<a href="php_switch.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
