...
<title>PHP mysqli_get_server_info() Function</title>
<style>a.menu_func_mysqli_get_server_info{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_get_server_info()</span> Function</h1>
...
<p>Return the MySQL server version:</p>
...
&nbsp;&nbsp;}<br><br>echo mysqli_get_server_info($con);<br>
...
<p>The mysqli_get_server_info() function returns the MySQL server version.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_get_server_info(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns a string that represents the MySQL server version
	</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_get_server_info.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_get_server_info.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_get_server_info.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
