...
<title>PHP filesize() Function</title>
<style>a.menu_func_filesystem_filesize{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filesize()</span> Function</h1>
<hr>
...
<p>The filesize() function returns the size of the specified file.</p>
<p>This function returns the file size in bytes on success or 
FALSE on failure.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_filesize.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_filesize.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_filesize.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
