...
<title>PHP convert_cyr_string() Function</title>
<style>a.menu_func_string_convert_cyr_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">convert_cyr_string()</span> Function</h1>
...
&lt;?php<br>
$str = &quot;Hello world! זרו&quot;;<br>
echo $str . &quot;&lt;br&gt;&quot;;<br>
echo convert_cyr_string($str,'w','a');<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_convert_cyr_string">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The convert_cyr_string() function converts a string from one Cyrillic character-set to another.</p>
<p>The supported Cyrillic character-sets are:</p>
<ul>
	<li>k - koi8-r</li>
...
convert_cyr_string(<em>string,from,to</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. The string to convert</td>
  </tr>
  <tr>
    <td><em>from</em></td>
    <td>Required. A character that specifies what Cyrillic character-set to 
	convert from</td>
  </tr>
  <tr>
    <td><em>to</em></td>
    <td>Required. A character that specifies what Cyrillic character-set 
	to convert to</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_convert_cyr_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_convert_cyr_string.asp#top" target="_top">TOP</a> |
		<a href="func_string_convert_cyr_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
