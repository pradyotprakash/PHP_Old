...
<style>a.menu_php_file_upload{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_file.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_cookies.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p>In this script we add some restrictions to the file upload. The user may upload 
.gif, .jpeg, and .png files; and the file size must be under 20 kB:</p>
<div class="code notranslate"><div>

&lt;?php<br>
$allowedExts = array(&quot;gif&quot;, &quot;jpeg&quot;, &quot;jpg&quot;, &quot;png&quot;);<br>
	$temp = explode(&quot;.&quot;, $_FILES[&quot;file&quot;][&quot;name&quot;]);<br>$extension = end($temp);<br>
if ((($_FILES[&quot;file&quot;][&quot;type&quot;] == &quot;image/gif&quot;)<br>
|| ($_FILES[&quot;file&quot;][&quot;type&quot;] == &quot;image/jpeg&quot;)<br>
|| ($_FILES[&quot;file&quot;][&quot;type&quot;] == &quot;image/jpg&quot;)<br>|| 
	($_FILES[&quot;file&quot;][&quot;type&quot;] == &quot;image/pjpeg&quot;)<br>|| ($_FILES[&quot;file&quot;][&quot;type&quot;] == 
	&quot;image/x-png&quot;)<br>
...
<p>The script above checks if the file already exists, if it does not, it copies the file to a 
folder called &quot;upload&quot;.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_file.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_cookies.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_file_upload.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_file_upload.asp#top" target="_top">TOP</a> |
		<a href="php_file_upload.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
