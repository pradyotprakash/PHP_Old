...
<style>a.menu_php_mysql_order_by{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP MySQL <span class="color_h1">Order By Keyword</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_mysql_where.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_mysql_update.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">The ORDER BY keyword is used to sort the data in a recordset.</p>
<hr>
...
<p>If you want to sort the records in a descending order, you can use the DESC 
keyword.</p>
...
and sorts the result by the &quot;Age&quot; column:</p>
<div class="code notranslate"><div>
...
&nbsp;&nbsp;}<br>
<br>
$result = mysqli_query($con,&quot;SELECT * FROM Persons ORDER BY age&quot;);<br>
<br>
...
<p>It is also possible to order by more than one column. When ordering by more than one column, the second column is only used if 
the values in the first column are equal:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_mysql_order_by.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_mysql_order_by.asp#top" target="_top">TOP</a> |
		<a href="php_mysql_order_by.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
