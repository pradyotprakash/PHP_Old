...
<title>PHP getDocNamespaces() Function</title>
<style>a.menu_func_simplexml_getdocnamespaces{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">getDocNamespaces()</span> Function</h1>
...
<p>Return the namespaces declared in the root of the XML document:</p>
<div class="example_code notranslate">
	&lt;?php<br>$xml=&lt;&lt;&lt;XML<br>&lt;?xml version=&quot;1.0&quot; standalone=&quot;yes&quot;?&gt;<br>&lt;cars 
	xmlns:c=&quot;http://w3schools.com/ns&quot;&gt;<br>&nbsp; &lt;c:car id=&quot;1&quot;&gt;Volvo&lt;/c:car&gt;<br>&nbsp; 
	&lt;c:car id=&quot;2&quot;&gt;BMW&lt;/c:car&gt;<br>&nbsp; &lt;c:car id=&quot;3&quot;&gt;Saab&lt;/c:car&gt; <br>&lt;/cars&gt;<br>XML;<br><br>
	$sxe=new SimpleXMLElement($xml);<br>$ns=$sxe-&gt;getDocNamespaces();<br>
	print_r($ns);<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_getdocnamespaces">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The getDocNamespaces() function returns the namespaces declared in an XML document.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	getDocNamespaces(<em>recursive</em>,<em>from_root</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  <tr>
    ...
    <td>Optional.&nbsp; Specifies a Boolean value. If TRUE, all namespaces 
	declared in parent and child nodes are returned. 
	If FALSE, only namespaces declared in root node is returned. Default is 
	FALSE</td>
  </tr>
	<tr>
    <td><em>from_root</em></td>
    <td>Optional. Specifies a Boolean value. TRUE check namespaces from the root 
	of the XML doc. FALSE check namespaces under a child node. Default is TRUE</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns an array of namespace names with their associated 
	URIs</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 5.4: The <em>from_root</em> parameter was added</td>
</tr>
</table>
<br>
<hr>
...
<p>Return all namespaces declared in parent and child nodes of the XML document:</p>
<div class="example_code notranslate">
	&lt;?php<br>$xml=&lt;&lt;&lt;XML<br>&lt;?xml version=&quot;1.0&quot; standalone=&quot;yes&quot;?&gt;<br>&lt;cars 
	xmlns:c=&quot;http://w3schools.com/ns&quot;&gt;<br>&nbsp; &lt;c:car id=&quot;1&quot;&gt;Volvo&lt;/c:car&gt;<br>&nbsp; 
	&lt;c:car id=&quot;2&quot;&gt;BMW&lt;/c:car&gt;<br>&nbsp; &lt;c:car id=&quot;3&quot; a:country=&quot;Sweden&quot; 
	xmlns:a=&quot;http://w3schools.com/country&quot;&gt;Saab&lt;/c:car&gt; <br>&lt;/cars&gt;<br>XML;<br>
	<br>$sxe=new SimpleXMLElement($xml);<br>$ns=$sxe-&gt;getDocNamespaces(TRUE);<br>
	var_dump($ns);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_getdocnamespaces2">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_getdocnamespaces.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_getdocnamespaces.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_getdocnamespaces.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
