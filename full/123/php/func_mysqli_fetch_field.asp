...
<title>PHP mysqli_fetch_field() Function</title>
<style>a.menu_func_mysqli_fetch_field{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_fetch_field()</span> Function</h1>
...
<p>Return the next field (column) in the result set, then print each field's 
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	...
	information for all fields<br>&nbsp; while 
	($fieldinfo=mysqli_fetch_field($result))<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
...
<p>The mysqli_fetch_field() function returns the next field (column) in the result set, as an object.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_fetch_field(<em>result</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<ul>
		...
		<li>def - reserved for default values, currently always &quot;&quot;</li>
		<li>db - database (new in PHP 5.3.6) </li>
		<li>catalog - catalog name, always &quot;def&quot; (since PHP 5.3.6)</li>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_fetch_field.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_fetch_field.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_fetch_field.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
