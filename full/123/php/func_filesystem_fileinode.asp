...
<title>PHP fileinode() Function</title>
<style>a.menu_func_filesystem_fileinode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fileinode()</span> Function</h1>
<hr>
...
<p>The fileinode() function returns the inode of the specified file.</p>
<p>This function returns the inode number of the file on success, 
FALSE on failure.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fileinode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fileinode.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fileinode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
