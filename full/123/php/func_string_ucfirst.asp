...
<title>PHP ucfirst() Function</title>
<style>a.menu_func_string_ucfirst{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ucfirst()</span> Function</h1>
...
<p>Convert the first character of &quot;hello&quot; to uppercase: </p>
<div class="example_code notranslate">

	&lt;?php<br>echo ucfirst(&quot;hello world!&quot;);<br>?&gt;

</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_ucfirst">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ucfirst() function converts the first character of a string to uppercase.</p>
<p>Related functions:</p>
<ul>
	<li><a href="func_string_lcfirst.asp">lcfirst()</a> - converts the first 
	character of a string to lowercase</li>
	<li><a href="func_string_ucwords.asp">ucwords() </a>- converts the first 
	character of each word in a string to uppercase</li>
	<li><a href="func_string_strtoupper.asp">strtoupper()</a> - converts a 
	string to uppercase</li>
	<li><a href="func_string_strtolower.asp">strtolower()</a> - converts a 
	string to lowercase</li>
</ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_ucfirst.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_ucfirst.asp#top" target="_top">TOP</a> |
		<a href="func_string_ucfirst.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
