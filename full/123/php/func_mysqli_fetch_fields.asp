...
<title>PHP mysqli_fetch_fields() Function</title>
<style>a.menu_func_mysqli_fetch_fields{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_fetch_fields()</span> Function</h1>
...
<p>Return an array of objects that represent the fields (columns) in a result set, then print 
each field's 
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	...
	information for all fields<br>&nbsp; $fieldinfo=mysqli_fetch_fields($result);<br><br>&nbsp; 
	foreach 
	($fieldinfo as $val)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
	printf(&quot;Name: %s\n&quot;,$val-&gt;name);<br>&nbsp;&nbsp;&nbsp; printf(&quot;Table: 
	%s\n&quot;,$val-&gt;table);<br>&nbsp;&nbsp;&nbsp; printf(&quot;max. Len: 
	%d\n&quot;,$val-&gt;max_length);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; // Free result 
...
<p>The mysqli_fetch_fields() function returns an array of objects that represent the fields (columns) in a result set.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_fetch_fields(<em>result</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an array of objects containing field definition information. 
	FALSE if no info is available. The objects have the following properties:
	<ul>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_fetch_fields.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_fetch_fields.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_fetch_fields.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
