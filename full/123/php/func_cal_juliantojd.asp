...
<title>PHP juliantojd() Function</title>
<style>a.menu_func_cal_juliantojd{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">juliantojd()</span> Function</h1>
...
<p>Convert a Julian date to a Julian Day Count and back to a Julian date:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$jd=juliantojd(6,20,2007);<br>echo $jd . &quot;&lt;br&gt;&quot;;<br>echo jdtojulian($jd);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_juliantojd">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The juliantojd() function converts a date from the Julian Calendar to a Julian Day Count.</p>
<p><strong>Note:</strong> Although this function can handle dates back to 4713 B.C., notice that the Julian
...
being used worldwide is the Gregorian calendar. The <a href="func_cal_gregoriantojd.asp">gregoriantojd()</a> function
can be used to convert such dates to their Julian Day count.</p>
<p><strong>Tip:</strong> Look at the <a href="func_cal_jdtojulian.asp">jdtojulian()</a> function to convert a
Julian Day Count to a Julian date.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	juliantojd(<em>month,day,year);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>month</em></td>
    <td>Required. Specifies the month as a number from 1 to 12</td>
  </tr>
  <tr>
    <td><em>day</em></td>
    <td>Required. Specifies the day as a number from 1 to 31</td>
  </tr>
  <tr>
    <td><em>year</em></td>
    <td>Required. Specifies the year as a number between -4713 and 9999</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a Julian Day number</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_juliantojd.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_juliantojd.asp#top" target="_top">TOP</a> |
		<a href="func_cal_juliantojd.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
