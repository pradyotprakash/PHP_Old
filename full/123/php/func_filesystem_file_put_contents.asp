...
<style>a.menu_func_filesystem_file_put_contents{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">file_put_contents()</span> Function</h1>
<hr>
...
<p>The file_put_contents() writes a string to a file.</p>
<p>This function follows these rules when accessing a file:</p>
<ol>
	<li>If FILE_USE_INCLUDE_PATH is set, check the include path for a copy of 
	*filename*</li>
	<li>Create the file if it does not exist</li>
	<li>Open the file</li>
	<li>Lock the file if LOCK_EX is set</li>
	<li>If FILE_APPEND is set, move to the end of the file. Otherwise, clear the 
	file content</li>
	<li>Write the data into the file</li>
	<li>Close the file and release any locks</li>
</ol>
<p>This function returns the number of character written into the file on 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the file to write to. If the file 
	does not exist, this function will create one </td>
  </tr>
	<tr>
    <td>data</td>
    <td>Required. The data to write to the file. Can be a string, 
	an array or a data stream</td>
  </tr>
	<tr>
    <td>mode</td>
    <td>Optional. Specifies how to open/write to the file. Possible 
	values:<ul>
	...
	is a set of options that can modify the behavior of a stream.</td>
  </tr>
	</table>
<br>
...
<p><b>Note:</b> Use FILE_APPEND to avoid deleting the existing content of the 
file.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_file_put_contents.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_file_put_contents.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_file_put_contents.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
