...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_cookies.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_mail.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">A PHP session variable is used to store information about, or 
change settings for a user session. Session variables hold information about one 
single user, and are available to all pages in one application.</p>
<hr>

<h2>PHP Session Variables</h2>
<p>When you are working with an application, you open it, do some changes and 
...
the user has left the website. If you need a permanent storage you may want to store the data in a database.</p>
...
cookie or is propagated in the URL.</p>
<hr>

<h2>Starting a PHP Session</h2>
<p>Before you can store user information in your PHP session, you must 
first start up the session.</p>
...
<p>The code above will register the user's session with the server, allow you to 
start saving user information, and assign a UID 
for that user's session.</p>
<hr>

<h2>Storing a Session Variable</h2>
<p>The correct way to store and retrieve session variables is to use the 
PHP $_SESSION variable:</p>
<div class="code notranslate"><div>
...
<p>In the example below, we create a simple page-views counter. The isset() 
function checks if the &quot;views&quot; variable has already been set. If &quot;views&quot; has 
been set, we can increment our counter. If &quot;views&quot; doesn't exist, we create a &quot;views&quot; 
variable, and set it to 1:</p>
<div class="code notranslate"><div>
...
<p>If you wish to delete some session data, you can use the unset() or the 
...
<p><b>Note:</b> session_destroy() will reset your session and you will lose all 
your stored session data.</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_cookies.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_mail.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_sessions.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_sessions.asp#top" target="_top">TOP</a> |
		<a href="php_sessions.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
