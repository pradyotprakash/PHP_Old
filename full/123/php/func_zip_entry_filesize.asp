...
<title>PHP zip_entry_filesize() Function</title>
<style>a.menu_func_zip_entry_filesize{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">zip_entry_filesize()</span> Function</h1>
<hr>
...
<p>The zip_entry_filesize() function returns the original file size (before 
compression) of a zip archive entry.</p>
<h2>Syntax</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_zip_entry_filesize.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_zip_entry_filesize.asp#top" target="_top">TOP</a> |
		<a href="func_zip_entry_filesize.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
