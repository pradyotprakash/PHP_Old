...
<title>PHP mktime() Function</title>
<style>a.menu_func_date_mktime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mktime()</span> Function</h1>
...
<p>Return the Unix timestamp for a date. Then use it to find the day of that date:</p>
<div class="example_code notranslate">
&lt;?php<br>
	// Prints: October 3, 1975 was on a Friday<br>echo &quot;Oct 3, 1975 was on a 
	&quot;.date(&quot;l&quot;, mktime(0,0,0,10,3,1975));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_mktime">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The gmmktime() function returns the Unix timestamp for a date.</p>
<p><b>Tip:</b> This function is identical to <a href="func_date_gmmktime.asp">gmmktime()</a> except the passed parameters 
represents a date (not a GMT date).</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mktime(<em>hour,minute,second,month,day,year,is_dst</em>);</div>
</div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>hour</em></td>
    <td>Optional. Specifies the hour</td>
  </tr>
  <tr>
    <td><em>minute</em></td>
    <td>Optional. Specifies the minute</td>
  </tr>
  <tr>
    <td><em>second</em></td>
    <td>Optional. Specifies the second</td>
  </tr>
  <tr>
    <td><em>month</em></td>
    <td>Optional. Specifies the month</td>
  </tr>
  <tr>
    <td><em>day</em></td>
    <td>Optional. Specifies the day</td>
  </tr>
  <tr>
    <td><em>year</em></td>
    <td>Optional. Specifies the year</td>
  </tr>
  <tr>
    <td><em>is_dst</em></td>
    <td>Optional. Set this parameter to 1 if the time is during daylight savings 
	...
	<b>Note:</b> This parameter became deprecated in PHP 5.1.0. The new 
	timezone handling features should be used instead</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an integer Unix timestamp. FALSE on error</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>PHP 5.3.0: Throws E_DEPRECATED if the <em>is_dst</em> parameter is used<br>
	PHP 5.1.0: The <em>is_dst</em> parameter was deprecated. If mktime() is 
	called with no arguments, it now throws E_STRICT notice. Use the time() 
	function instead.<br></td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_mktime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_mktime.asp#top" target="_top">TOP</a> |
		<a href="func_date_mktime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
