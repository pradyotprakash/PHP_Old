...
<title>PHP mysqli_get_host_info() Function</title>
<style>a.menu_func_mysqli_get_host_info{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_get_host_info()</span> Function</h1>
...
<p>Return the MySQL server hostname and connection type:</p>
...
&nbsp;&nbsp;}<br><br>echo mysqli_get_host_info($con);<br>
...
<p>The mysqli_get_host_info() function returns the MySQL server hostname and the connection type.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_get_host_info(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns a string that represents the MySQL server hostname 
	and the connection type</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_get_host_info.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_get_host_info.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_get_host_info.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
