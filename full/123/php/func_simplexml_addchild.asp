...
<title>PHP addChild() Function</title>
<style>a.menu_func_simplexml_addchild{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">addChild()</span> Function</h1>
...
<p>Add a child element to the body 
element and a footer element:</p>
<div class="example_code notranslate">
	...
	$xml=new SimpleXMLElement($note);<br><br>// Add a child element to the body 
	element<br>$xml-&gt;body-&gt;addChild(&quot;date&quot;,&quot;2013-01-01&quot;);<br><br>// Add a child 
	element after the last element inside note<br>
	$footer=$xml-&gt;addChild(&quot;footer&quot;,&quot;Some footer text&quot;);<br><br>echo 
	$xml-&gt;asXML();<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_addchild">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The addChild() function adds a child element to the SimpleXML element.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	addChild(<em>name,value,ns</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>name</em></td>
    <td>Required. Specifies the name of the child element to add</td>
  </tr>
  <tr>
    <td><em>value</em></td>
    <td>Optional. Specifies the value of the child element</td>
  </tr>
	<tr>
    <td><em>ns</em></td>
    <td>Optional. Specifies a namespace for the child element</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a SimpleXMLElement object that represents the child 
	added to the XML</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml_addchild.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml_addchild.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml_addchild.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
