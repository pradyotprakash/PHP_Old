...
<title>PHP ftp_nb_continue() Function</title>
<style>a.menu_func_ftp_nb_continue{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_nb_continue()</span> Function</h1>
...
<p>Download a file from the server, continue downloading (non-blocking) while 
doing something else:&nbsp;</p>
<div class="example_code notranslate">
&lt;?php<br>// initiate download<br>$d = ftp_nb_get($ftp_conn, 
	&quot;local.txt&quot;, &quot;server.txt&quot;, FTP_BINARY)<br><br>while ($d == FTP_MOREDATA)<br>&nbsp; 
	{<br>&nbsp; // do whatever you want<br>&nbsp; // continue downloading<br>&nbsp; $d = ftp_nb_continue($ftp_conn);<br>&nbsp; }<br>
	<br>if ($d != FTP_FINISHED)<br>&nbsp; {<br>&nbsp; echo &quot;Error downloading file.&quot;;<br>&nbsp; exit(1);<br>&nbsp; }<br><br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_nb_continue() function continues to receive/send a file to the FTP server.</p>
<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_nb_continue(<em>ftp_connection</em>);</div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_nb_continue.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_nb_continue.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_nb_continue.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
