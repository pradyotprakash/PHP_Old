...
<style>a.menu_php_arrays_multi{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Multidimensional Arrays</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_form_complete.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_date.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An array can also contain another array as a value, which in 
turn can hold other arrays as well. In such a way we can create two- or 
...
<div class="example_code notranslate">
	...
	array(&quot;Toyota&quot;,110,100)<br>&nbsp; );<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_multi">Run example &raquo;</a>
</div>
<hr>

<h2>PHP - Multidimensional Arrays</h2>
<p>A multidimensional array is an array containing one or more arrays.</p>
<p>In a multidimensional array, each element in the main array can also be an array. 
And each element in the sub-array can be an array, and so on.</p>
<h3>Example</h3>
<p>In this example we create a multidimensional array, with automatically 
assigned ID keys:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_arrays_multi.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_arrays_multi.asp#top" target="_top">TOP</a> |
		<a href="php_arrays_multi.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
