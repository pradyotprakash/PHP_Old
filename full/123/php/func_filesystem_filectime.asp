...
<title>PHP filectime() Function</title>
<style>a.menu_func_filesystem_filectime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filectime()</span> Function</h1>
<hr>
...
<p>The filectime() function returns the last time the specified file was changed.</p>
<p>This function checks for the inode changes as well as regular changes. Inode 
changes is when permissions, owner, group or other metadata is changed.</p>
<p>This function returns the last change time as a Unix timestamp on success, 
FALSE on failure.</p>
<h2>Syntax</h2>
...
clear the cache.</p>
<p><b>Tip:</b> Use the filemtime() function to return the last time the file 
content was changed.</p>
<hr>
...
echo &quot;&lt;br /&gt;&quot;;<br>
echo &quot;Last change: &quot;.date(&quot;F d Y H:i:s.&quot;,filectime(&quot;test.txt&quot;));<br>
?&gt; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_filectime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_filectime.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_filectime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
