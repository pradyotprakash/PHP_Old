...
<style>a.menu_php_arrays{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_functions.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_arrays_sort.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">An array stores multiple values in one single variable:</p>
<div class="example">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_num">Run example &raquo;</a>
</div>
<hr>
...
<p>The solution is to create an array!</p>
...
<p>The index can be assigned automatically (index 
...
<p>The following example creates an indexed array named $cars, assigns three 
elements to it, and then prints a text containing the array values:</p>
...
<p>The count() function is used to return the length (the number of elements) of 
an array:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_length">Run example &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_num_loop">Run example &raquo;</a>
</div>
<br>
<hr>
...
$age=array(&quot;Peter&quot;=&gt;&quot;35&quot;,&quot;Ben&quot;=&gt;&quot;37&quot;,&quot;Joe&quot;=&gt;&quot;43&quot;);</div></div>
<p>or:</p>
<div class="code notranslate"><div>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_assoc">Run example &raquo;</a>
</div>
<br>
<hr>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_array_assoc_loop">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>Multidimensional Arrays</h2>
<p><a href="php_arrays_multi.asp">Multidimensional arrays</a> will be explained in the 
PHP advanced section.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_arrays.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_arrays.asp#top" target="_top">TOP</a> |
		<a href="php_arrays.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
