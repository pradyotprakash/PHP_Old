...
<html lang="en-US">
<head>
<title>PHP MySQL Delete From</title>
<style>a.menu_php_mysql_delete{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP MySQL <span class="color_h1">Delete</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_mysql_update.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_db_odbc.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
...
<p><b>Note:</b> Notice the WHERE clause in the DELETE syntax. The WHERE clause 
specifies which record or records that should be deleted. If you omit the WHERE 
clause, all records will be deleted!<p>To learn more about SQL, please visit our <a href="../sql/default.asp">SQL 
tutorial</a>.</p>
...
<p>The following example deletes all the records in the &quot;Persons&quot; table 
where LastName='Griffin':</p>
<div class="code notranslate"><div>
&lt;?php<br>
...
&nbsp;&nbsp;}<br>
<br>
mysqli_query($con,&quot;DELETE FROM Persons WHERE LastName='Griffin'&quot;);<br>
<br>
mysqli_close($con);<br>
?&gt;
</div></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_mysql_delete.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_mysql_delete.asp#top" target="_top">TOP</a> |
		<a href="php_mysql_delete.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
