...
<title>PHP xml_parse_into_struct() Function</title>
<style>a.menu_func_xml_parse_into_struct{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_parse_into_struct()</span> Function</h1>
<hr>
...
<p>The xml_parse_into_struct() function parses XML data into an array.</p>
<p>This function parses the XML data into 2 arrays:</p>
<ul>
	<li>Value array - containing the data from the parsed XML</li>
	<li>Index array - containing pointers to the location of the values in the 
	Value array</li>
</ul>
<p>This function returns 1 on success, or 0 on 
failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td>xml</td>
    <td>Required. Specifies XML data to parse</td>
  </tr>
  <tr>
    <td>value_arr</td>
    <td>Required. Specifies the target array for the XML data</td>
  </tr>
  <tr>
    <td>index_arr</td>
    <td>Optional. Specifies the target array for index data</td>
  </tr>
  </table>
<br>
...
<p><b>Note:</b> The xml_parse_into_struct() function returns 1 for success and 0 
for failure.&nbsp; This is not the same as TRUE and FALSE.</p>
...
<br>
// open a file and read data<br>
$fp = fopen($xmlfile, 'r');<br>
$xmldata = fread($fp, 4096);<br>
<br>
xml_parse_into_struct($xmlparser,$xmldata,$values);<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;[type] =&gt; complete<br>
&nbsp;&nbsp;&nbsp;&nbsp;[level] =&gt; 2<br>
&nbsp;&nbsp;&nbsp;&nbsp;[value] =&gt; Don't forget me this weekend!<br>
&nbsp;&nbsp;&nbsp;&nbsp;)<br>
[8] =&gt; Array<br>
&nbsp;&nbsp;(<br>
&nbsp;&nbsp;[tag] =&gt; NOTE<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_parse_into_struct.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_parse_into_struct.asp#top" target="_top">TOP</a> |
		<a href="func_xml_parse_into_struct.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
