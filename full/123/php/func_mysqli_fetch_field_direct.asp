...
<title>PHP mysqli_fetch_field_direct() Function</title>
<style>a.menu_func_mysqli_fetch_field_direct{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_fetch_field_direct()</span> Function</h1>
...
<p>Return meta-data for a single field (column) in the result set, then print 
the field's 
name, table, and max length:</p>
<div class="example_code notranslate">
&lt;?php<br>
$con=mysqli_connect(&quot;localhost&quot;,&quot;my_user&quot;,&quot;my_password&quot;,&quot;my_db&quot;);<br>
	// Check connection<br>
	if (mysqli_connect_errno($con))<br>
&nbsp;&nbsp;{<br>
&nbsp; echo &quot;Failed to connect to MySQL: &quot; . mysqli_connect_error();<br>
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	<br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; // Get field 
	information for &quot;Age&quot;<br>&nbsp; $fieldinfo=mysqli_fetch_field_direct($result,1);<br>
	<br>&nbsp; 
	printf(&quot;Name: %s\n&quot;,$fieldinfo-&gt;name);<br>&nbsp; printf(&quot;Table: 
	%s\n&quot;,$fieldinfo-&gt;table);<br>&nbsp; printf(&quot;max. Len: 
	%d\n&quot;,$fieldinfo-&gt;max_length);<br><br>&nbsp; // Free result 
	set<br>&nbsp; mysqli_free_result($result);<br>}<br>
...
<p>The mysqli_fetch_field_direct() function returns meta-data for a single field (column) in the result set, as an object.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_fetch_field_direct(<em>result,fieldnr</em>)<em>;</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>result</em></td>
    <td>Required. Specifies a result set identifier returned by mysqli_query(), 
	mysqli_store_result() or mysqli_use_result()</td>
  </tr>
  <tr>
    <td><em>fieldnr</em></td>
    <td>Required. Specifies the field number. Must be an integer between 0 and 
	number of fields - 1</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an object containing field definition information. 
	FALSE if no info is available. The object has the following properties:
	<ul>
		<li>name - name of the column</li>
		<li>orgname - original column name (if an alias is specified)</li>
		<li>table - name of table</li>
		<li>orgtable - original table name (if an alias is specified)</li>
		<li>def - default value for this field</li>
		<li>max_length - maximum width of field</li>
		<li>length - width of field as specified in table definition</li>
		<li>charsetnr - character set number for the field</li>
		<li>flags - bit-flags for the field</li>
		<li>type - data type used for the field</li>
		<li>decimals - for integer fields; the number of decimals used</li>
	</ul>
	</td>
</tr>
<tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_fetch_field_direct.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_fetch_field_direct.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_fetch_field_direct.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
