...
<title>PHP restore_error_handler() Function</title>
<style>a.menu_func_error_restore_error_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">restore_error_handler()</span> Function</h1>
<hr>
...
<p>The restore_error_handler() function restores the previous error handler.</p>
<p>This function is used to restore the previous error handler after changing 
it with the set_error_handler() function. </p>
...
<p><b>Tip:</b> The previous error handler could be the built in error handler or 
...
&lt;?php<br>
//custom error handler function<br>
...
&nbsp;&nbsp;}<br>
<br>
//set user-defined error handler<br>
...
&nbsp;&nbsp;}<br>
<br>
//restore built-in error handler<br>
restore_error_handler();<br>
<br>
//trigger error again<br>
if ($test&gt;1)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;trigger_error(&quot;A custom error has been triggered&quot;);<br>
&nbsp;&nbsp;}<br>
...
Error on line 14 in C:\webfolder\test.php<br>
<br>
<b>Notice</b>: A custom error has been triggered in <b><br>
C:\webfolder\test.php</b> on line <b>21</b>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_error_restore_error_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_error_restore_error_handler.asp#top" target="_top">TOP</a> |
		<a href="func_error_restore_error_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
