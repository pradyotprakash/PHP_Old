...
<title>PHP ftp_systype() Function</title>
<style>a.menu_func_ftp_systype{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_systype()</span> Function</h1>
...
<p>Get the system type of the FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>// get system 
	type<br>if ($type = ftp_systype($ftp_conn))<br>&nbsp; {<br>&nbsp; echo 
	&quot;System type is: $type&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo 
	&quot;Could not get system type.&quot;;<br>&nbsp; }<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
...
<p>The ftp_systype() function returns the system type identifier of the FTP server.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_systype(<em>ftp_connection</em>);</div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns the system type on success, or FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_systype.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_systype.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_systype.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
