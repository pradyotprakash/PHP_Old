...
<title>PHP mysqli_rollback() Function</title>
<style>a.menu_func_mysqli_rollback{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_rollback()</span> Function</h1>
...
<p>Turn off auto-committing, make some queries, commit the queries, then roll 
back the current transaction:</p>
...
&nbsp;&nbsp;}<br><br>// Set autocommit to off<br>mysqli_autocommit($con,FALSE);<br>
	<br>// Insert some values <br>mysqli_query($con,&quot;INSERT INTO Persons (FirstName,LastName,Age)<br>
VALUES ('Peter','Griffin',35)&quot;);<br>
mysqli_query($con,&quot;INSERT INTO Persons (FirstName,LastName,Age) <br>
VALUES ('Glenn','Quagmire',33)&quot;);<br>
	<br>// Commit transaction<br>mysqli_commit($con);<br><br>// Rollback 
	transaction<br>mysqli_rollback($con);<br><br>// Close connection<br>
	mysqli_close($con);<br>?&gt;
</div>
</div>
<hr>
...
<p>The mysqli_rollback() function rolls back the current transaction for the specified database connection.</p>
<p><strong>Tip:</strong> Also look at the <a href="func_mysqli_commit.asp">mysqli_commit() 
</a>function, which commits the current transaction for the specified database 
connection, and the <a href="func_mysqli_autocommit.asp">
mysqli_autocommit()</a> function, which turns on or off auto-committing database modifications.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_rollback(<em>connection</em>)<em>;</em></div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_rollback.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_rollback.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_rollback.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
