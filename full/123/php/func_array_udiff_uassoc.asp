...
<title>PHP array_udiff_uassoc() Function</title>
<style>a.menu_func_array_udiff_uassoc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_udiff_uassoc()</span> Function</h1>
...
&lt;?php<br>
	...
	<br>$result=array_udiff_uassoc($a1,$a2,&quot;myfunction_key&quot;,&quot;myfunction_value&quot;);<br>
	print_r($result);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_udiff_uassoc">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_udiff_uassoc() function compares <strong>the keys and values</strong> of two or 
more arrays, and returns the differences.</p>
...
array that contains the entries from <em>array1</em> that are not present in <em>array2
</em>or<em> array3, </em>etc.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

array_udiff_uassoc(<em>array1,array2,array3...,myfunction_key,myfunction_value</em>)
...
<tr>
	...
	array1</em> that are not present in any of the other arrays</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_udiff_uassoc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_udiff_uassoc.asp#top" target="_top">TOP</a> |
		<a href="func_array_udiff_uassoc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
