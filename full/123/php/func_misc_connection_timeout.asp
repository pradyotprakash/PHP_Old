...
<title>PHP connection_timeout() Function</title>
<style>a.menu_func_misc_connection_timeout{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">connection_timeout()</span> Function</h1>
...
<p><span class="deprecated">The connection_timeout() function was deprecated and removed in PHP version 4.0.5.</span></p> 
<p>The connection_timeout() function checks whether the script has timed out.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
connection_timeout()</div></div><br>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td style="width:80%">Returns 1 if the script has timed out, otherwise it returns 
	0</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_connection_timeout.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_connection_timeout.asp#top" target="_top">TOP</a> |
		<a href="func_misc_connection_timeout.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
