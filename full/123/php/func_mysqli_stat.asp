...
<title>PHP mysqli_stat() Function</title>
<style>a.menu_func_mysqli_stat{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_stat()</span> Function</h1>
...
&nbsp;&nbsp;}<br><br>echo &quot;System status: &quot;. mysqli_stat($con); <br>
...
<p>The mysqli_stat() function returns the current system status.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_stat(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns a string that describes the server status. FALSE if 
	an error occured</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_stat.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_stat.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_stat.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
