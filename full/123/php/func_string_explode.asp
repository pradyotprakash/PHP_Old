...
<style>a.menu_func_string_explode{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">explode()</span> Function</h1>
...
<p>Break a string into an array:</p>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_explode">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The explode() function breaks a string into an array.</p>
<p><b>Note:</b> The &quot;separator&quot; parameter cannot be an empty string.</p>
...
<div class="code notranslate"><div>
	...
	explode(<em>separator,string,limit</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>limit</em></td>
    <td>Optional. Specifies the number of array elements to return. <p>Possible values:</p>
	<ul>
		<li>Greater than 0 - Returns an array with a maximum of <em>limit</em> 
		element(s)</li>
		<li>Less than 0 - Returns an array except for the last <em>-limit</em> 
		elements()</li>
...
<tr>
	...
	<td style="width:80%">Returns an array of strings</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>limit</em> parameter was added in PHP 4.0.1, and support for negative <em>
	limits</em> were added in PHP 5.1.0</td>
</tr>
</table>
<br>
...
<p>Using the limit parameter to return a number of array elements: </p>
<div class="example_code notranslate">

	&lt;?php<br>$str = 'one,two,three,four';<br><br>// zero limit<br>print_r(explode(',',$str,0));<br>
	<br>// positive limit<br>print_r(explode(',',$str,2));<br><br>// negative 
	limit <br>print_r(explode(',',$str,-1));<br>?&gt; 
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_explode2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_explode.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_explode.asp#top" target="_top">TOP</a> |
		<a href="func_string_explode.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
