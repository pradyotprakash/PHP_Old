...
<title>PHP date_timezone_get() Function</title>
<style>a.menu_func_date_timezone_get{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_timezone_get()</span> Function</h1>
...
<p>Return the timezone of the given DateTime object:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$date=date_create(null,timezone_open(&quot;Europe/Paris&quot;));<br>
	$tz=date_timezone_get($date);<br>echo timezone_name_get($tz);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_timezone_get">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_timezone_get() function returns the time zone of the given DateTime object.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	date_timezone_get(<em>object);</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns a DateTimeZone object on success. FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_timezone_get.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_timezone_get.asp#top" target="_top">TOP</a> |
		<a href="func_date_timezone_get.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
