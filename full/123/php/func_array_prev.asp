...
<title>PHP prev() Function</title>
<style>a.menu_func_array_prev{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">prev()</span> Function</h1>
...
<p>Output the value of the current, next and previous element in the array:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_prev">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The prev() function moves the internal pointer to, and outputs, the previous 
...
<tr>
	...
	<td style="width:80%">Returns the value of the previous element in the array on 
	success, or FALSE if there are no more elements</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_prev.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_prev.asp#top" target="_top">TOP</a> |
		<a href="func_array_prev.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
