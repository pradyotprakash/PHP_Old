...
<title>PHP levenshtein() Function</title>
<style>a.menu_func_string_levenshtein{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">levenshtein()</span> Function</h1>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_levenshtein">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The levenshtein() function returns the Levenshtein distance between two 
strings.</p>
<p>The Levenshtein distance is the number of characters you have to replace, 
insert or delete to transform string1 into string2.</p>
<p>By default, PHP gives each operation (replace, insert, and delete) equal 
weight. However, you can define the cost of each operation by setting the 
optional insert, replace, and delete parameters.</p>
<p><b>Note:</b> The levenshtein() function is not case-sensitive.</p>
<p><b>Note:</b> The levenshtein() function is faster than the similar_text() 
function. However, similar_text() will give you a more accurate 
result with less modifications needed.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

levenshtein(<em>string1,string2,insert,replace,delete</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string1</em></td>
    <td>Required. First string to compare</td>
  </tr>
  <tr>
    <td><em>string2</em></td>
    <td>Required. Second string to compare</td>
  </tr>
  <tr>
    <td><em>insert</em></td>
    <td>Optional. The cost of inserting a character. 
	Default is 1</td>
  </tr>
  <tr>
    <td><em>replace</em></td>
    <td>Optional. The cost of replacing a character. 
	Default is 1</td>
  </tr>
  <tr>
    <td><em>delete</em></td>
    <td>Optional. The cost of deleting a character. 
	Default is 1</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the Levenshtein distance between the two argument 
	strings or -1, if one of the strings exceeds 255 characters</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.1+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_levenshtein.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_levenshtein.asp#top" target="_top">TOP</a> |
		<a href="func_string_levenshtein.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
