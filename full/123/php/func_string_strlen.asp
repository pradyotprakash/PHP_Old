...
<style>a.menu_func_string_strlen{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strlen()</span> Function</h1>
...
<p>Return the length of the string &quot;Hello&quot;:</p>
<div class="example_code notranslate">

	&lt;?php<br>echo strlen(&quot;Hello&quot;);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strlen">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strlen() function returns the length of a string.</p>
<hr>
<h2>Syntax</h2>
...
<tr>
	...
	<td style="width:80%">Returns the length of a string on success, and 0 if the 
	string is empty</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>Changelog:</th>
	<td>Before PHP 5.3.0, this function treated arrays as the string <em>Array</em>, thus 
	returning a string length of 5 and emitting an E_NOTICE level error.</td>
</tr>
</table>
<br>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strlen2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strlen.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strlen.asp#top" target="_top">TOP</a> |
		<a href="func_string_strlen.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
