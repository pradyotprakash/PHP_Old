...
<title>PHP array_slice() Function</title>
<style>a.menu_func_array_slice{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_slice()</span> Function</h1>
...
<p>Start the slice from the third array element, and return 
the rest of the elements in the array:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a=array(&quot;red&quot;,&quot;green&quot;,&quot;blue&quot;,&quot;yellow&quot;,&quot;brown&quot;);<br>print_r(array_slice($a,2));<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_slice">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The array_slice() function returns selected parts of an array.</p>
<p><b>Note:</b> If the array have string keys, the returned array will always preserve the keys (See example 4).</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
array_slice(<em>array,start,length,preserve</em>)
</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>start</em></td>
    <td>Required. Numeric value. Specifies where the function will start the slice.
    0 = the first element.
    If this value is set to a negative number, the function will start slicing that far from the last element.
    -2 means start at the second last element of the array.<br></td>
  </tr>
  <tr>
    <td><em>length</em></td>
    <td>Optional. Numeric value. Specifies the length of the returned array.
  ...
  <tr>
    ...
    <td>Optional. Specifies if the function should preserve or 
	reset the keys. Possible values:<ul><li>true -&nbsp; Preserve keys</li><li>false - 
      Default. Reset keys</li></ul>
    </td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns selected parts of an array</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The <em>preserve</em> parameter was added in PHP 5.0.2</td>
</tr>
</table>
<br>
<hr>
...
<p>Start the slice from from the second array element, and return only two 
elements:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a=array(&quot;red&quot;,&quot;green&quot;,&quot;blue&quot;,&quot;yellow&quot;,&quot;brown&quot;);<br>print_r(array_slice($a,1,2));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_slice2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Using a negative start parameter:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a=array(&quot;red&quot;,&quot;green&quot;,&quot;blue&quot;,&quot;yellow&quot;,&quot;brown&quot;);<br>print_r(array_slice($a,-2,1));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_slice3">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 3</h2>
<p>With the preserve parameter set to true:</p>
<div class="example_code notranslate">
	&lt;?php<br>$a=array(&quot;red&quot;,&quot;green&quot;,&quot;blue&quot;,&quot;yellow&quot;,&quot;brown&quot;);<br>print_r(array_slice($a,1,2,true));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_slice4">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 4</h2>
<p>With both string and integer keys:</p>
<div class="example_code notranslate">
	&lt;?php<br>
	$a=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;,&quot;d&quot;=&gt;&quot;yellow&quot;,&quot;e&quot;=&gt;&quot;brown&quot;);<br>
	print_r(array_slice($a,1,2));<br><br>
	$a=array(&quot;0&quot;=&gt;&quot;red&quot;,&quot;1&quot;=&gt;&quot;green&quot;,&quot;2&quot;=&gt;&quot;blue&quot;,&quot;3&quot;=&gt;&quot;yellow&quot;,&quot;4&quot;=&gt;&quot;brown&quot;);<br>
	print_r(array_slice($a,1,2));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_slice5">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_slice.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_slice.asp#top" target="_top">TOP</a> |
		<a href="func_array_slice.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
