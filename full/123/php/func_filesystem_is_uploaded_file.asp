...
<title>PHP is_uploaded_file() Function</title>
<style>a.menu_func_filesystem_is_uploaded_file{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">is_uploaded_file()</span> Function</h1>
<hr>
...
<p>The is_uploaded_file() function checks whether the specified file is uploaded via 
HTTP POST.</p>
<p>This function returns TRUE if the file is uploaded via HTTP POST.</p>
<h2>Syntax</h2>
...
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo (&quot;$file is uploaded via HTTP POST&quot;);<br>
&nbsp;&nbsp;}<br>
else<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo (&quot;$file is not uploaded via HTTP POST&quot;);<br>
&nbsp;&nbsp;}<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_is_uploaded_file.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_is_uploaded_file.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_is_uploaded_file.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
