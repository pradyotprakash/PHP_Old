...
<title>PHP array_diff() Function</title>
<style>a.menu_func_array_diff{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_diff()</span> Function</h1>
...
&lt;?php<br>
	...
	$a2=array(&quot;e&quot;=&gt;&quot;red&quot;,&quot;f&quot;=&gt;&quot;green&quot;,&quot;g&quot;=&gt;&quot;blue&quot;);<br><br>$result=array_diff($a1,$a2);<br>print_r($result);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_diff() function compares <strong>the values</strong> of two (or more) arrays,
and returns the differences.</p>
<p>This function compares the values of two (or more) arrays, and return an array that contains the entries from <em>
...
array_diff(<em>array1,array2,array3...</em>);</div></div>
<br>
...
&lt;?php<br>
	...
	<br>$result=array_diff($a1,$a2,$a3);<br>print_r($result);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff2">Run example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_diff.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_diff.asp#top" target="_top">TOP</a> |
		<a href="func_array_diff.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
