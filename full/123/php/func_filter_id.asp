...
<title>PHP filter_id() Function</title>
<style>a.menu_func_filter_id{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filter_id()</span> Function</h1>
<hr>
...
<p>The filter_id() function returns the ID number of a specified filter.</p>
<p>Returns the filter ID number on success, or NULL if the filter does not exist.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
	...
	<tr>
		<td>filter_name</td>
		<td>Required. Specifies the filter to get the id from.<br>
		<br>
		Must be a filter name (not a filter ID name), use the <a href="func_filter_list.asp">
		filter_list()</a> function for name of all supported filters</td>
	</tr>
</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filter_id.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filter_id.asp#top" target="_top">TOP</a> |
		<a href="func_filter_id.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
