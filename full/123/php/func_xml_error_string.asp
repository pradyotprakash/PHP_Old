...
<title>PHP xml_error_string() Function</title>
<style>a.menu_func_xml_error_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_error_string()</span> Function</h1>
<hr>
...
<p>The xml_error_string() function gets the XML parser error description.</p>
<p>This function returns the error description on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>errorcode</td>
    <td>Required. Specifies error code to use. The error code is 
	the return value from the xml_get_error_code() function</td>
  </tr>
	</table>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_error_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_error_string.asp#top" target="_top">TOP</a> |
		<a href="func_xml_error_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
