...
<title>PHP date_timezone_set() Function</title>
<style>a.menu_func_date_timezone_set{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_timezone_set()</span> Function</h1>
...
<p>Set the timezone for the DateTime object:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$date=date_create(&quot;2013-05-25&quot;,timezone_open(&quot;Indian/Kerguelen&quot;));<br>echo 
	date_format($date,&quot;Y-m-d H:i:sP&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_timezone_set">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_timezone_set() function sets the time zone for the DateTime object.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_timezone_set(<em>object,timezone);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>object</em></td>
    <td>Required. Specifies a DateTime object returned by
	<a href="func_date_date_create.asp">date_create()</a>. This function 
	modifies this object</td>
  </tr>
  <tr>
    <td><em>timezone</em></td>
    <td>Required. Specifies a DateTimeZone object that represents the desired 
	time zone.<br><br><strong>Tip:</strong>
...
<tr>
	...
	<td style="width:80%">Returns the DateTime object for method chaining. FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>Changelog:</th>
	<td>PHP 5.3.0: Changed the return value from NULL to DateTime</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_timezone_set.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_timezone_set.asp#top" target="_top">TOP</a> |
		<a href="func_date_timezone_set.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
