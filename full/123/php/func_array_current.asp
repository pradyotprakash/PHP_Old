...
<title>PHP current() Function</title>
<style>a.menu_func_array_current{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">current()</span> Function</h1>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_current">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The current() function returns the value of the current element in an array.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_current.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_current.asp#top" target="_top">TOP</a> |
		<a href="func_array_current.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
