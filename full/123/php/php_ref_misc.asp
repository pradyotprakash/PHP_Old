...
<html lang="en-US">
<head>
<title>PHP Misc. Functions</title>
<style>a.menu_php_ref_misc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Misc.</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_math.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_mysqli.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP Miscellaneous Introduction</h2>
<p>The misc. functions were only placed here because none of the other 
categories seemed to fit.</p>
<hr>

<h2>Installation</h2>
<p>The misc. functions are part of the PHP core. No installation is required to 
use these functions.</p>
<hr>

<h2>Runtime Configuration</h2>
<p>The behavior of the misc. functions is affected by settings in the php.ini file.</p>
<p>Misc. configuration options:</p>
<table class="reference notranslate">
  <tr>
    <th style="width:20%">Name</th>
    <th style="width:46%">Description</th>
    <th style="width:16%">Default</th>
    <th style="width:28%">Changeable</th>
  </tr>
  <tr>
    <td>ignore_user_abort</td>
    <td>FALSE indicates that scripts will be terminated as soon as 
  ...
  <tr>
    ...
    <td>Color for highlighting a string in PHP syntax</td>
    <td>&quot;#DD0000&quot;</td> 
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>highlight.comment</td>
    <td>Color for highlighting PHP comments</td>
    <td>&quot;#FF8000&quot;</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>highlight.keyword</td>
     <td>Color for syntax highlighting PHP keywords (e.g. 
  ...
  <tr>
    <td>highlight.bg</td>
    <td><span class="deprecated">Removed in PHP 5.4.0.</span> Color for background</td>
    <td>&quot;#FFFFFF&quot;</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>highlight.default</td>
       <td>Default color for PHP syntax</td>
    <td>&quot;#0000BB&quot;</td>
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>highlight.html</td>
    <td>Color for HTML code</td>
    <td>&quot;#000000&quot;</td> 
    <td>PHP_INI_ALL</td>
  </tr>
  <tr>
    <td>browscap</td>
    <td>Name and location of browser-capabilities file (e.g. 
	browscap.ini) </td>
    <td>NULL</td>
...
<h2>PHP Miscellaneous Functions</h2>
<table class="reference notranslate">
  <tr>
  ...
  <tr>
    <td><a href="func_misc_connection_aborted.asp">
	connection_aborted()</a></td>
    <td>Checks whether the client has disconnected</td>
  </tr>
  <tr>
    <td><a href="func_misc_connection_status.asp">
	connection_status()</a></td>
    <td>Returns the current connection status</td>
  </tr>
  <tr>
    <td><a href="func_misc_connection_timeout.asp">connection_timeout()</a></td>
    <td><span class="deprecated">Deprecated in PHP 4.0.5.</span> Checks whether the script 
	has timed out</td>
  </tr>
  <tr>
    <td><a href="func_misc_constant.asp">constant()</a></td>
    <td>Returns the value of a constant</td>
  </tr>
  <tr>
    <td><a href="func_misc_define.asp">define()</a></td>
    <td>Defines a constant</td>
  </tr>
  <tr>
    <td><a href="func_misc_defined.asp">defined()</a></td>
    <td>Checks whether a constant exists</td>
  </tr>
  <tr>
    <td><a href="func_misc_die.asp">die()</a></td>
    <td>Prints a message and exits the current script</td>
     </tr>
  <tr>
    <td><a href="func_misc_eval.asp">eval()</a></td>
    <td>Evaluates a string as PHP code</td>
  </tr>
  <tr>
    <td><a href="func_misc_exit.asp">exit()</a></td>
    <td>Prints a message and exits the current script</td>
  </tr>
  <tr>
    <td><a href="func_misc_get_browser.asp">get_browser()</a></td>
  ...
  <tr>
    <td><a href="func_misc_highlight_file.asp">highlight_file()</a></td>
    <td>Outputs a file with the PHP syntax highlighted</td>
  </tr>
  <tr>
    <td><a href="func_misc_highlight_string.asp">highlight_string()</a></td>
    <td>Outputs a string with the PHP syntax highlighted</td>
  </tr>
  <tr>
    <td><a href="func_misc_ignore_user_abort.asp">
	ignore_user_abort()</a></td>
    <td>Sets whether a remote client can abort the running of a 
	script</td>
  </tr>
  <tr>
    <td><a href="func_misc_pack.asp">pack()</a></td>
    <td>Packs data into a binary string</td>
  </tr>
  <tr>
    <td>php_check_syntax()</td>
    <td>Deprecated in PHP 5.0.5</td>
  </tr>
  <tr>
    <td><a href="func_misc_strip_whitespace.asp">
	php_strip_whitespace()</a></td>
    <td>Returns the source code of a file with PHP comments and whitespace 
	removed</td>
  </tr>
  <tr>
    <td><a href="func_misc_show_source.asp">show_source()</a></td>
    <td>Alias of highlight_file()</td>
  </tr>
  <tr>
    <td><a href="func_misc_sleep.asp">sleep()</a></td>
    <td>Delays code execution for a number of seconds</td>
  </tr>
  <tr>
    <td>sys_getloadavg()</td>
    <td>Gets system load average</td>
  </tr>
  <tr>
    <td><a href="func_misc_time_nanosleep.asp">time_nanosleep()</a></td>
    <td>Delays code execution for a number of seconds and nanoseconds</td>
  </tr>
  <tr>
    <td><a href="func_misc_time_sleep_until.asp">time_sleep_until()</a></td>
    <td>Delays code execution until a specified time</td>
  </tr>
  <tr>
    <td><a href="func_misc_uniqid.asp">uniqid()</a></td>
    <td>Generates a unique ID</td>
  </tr>
  <tr>
    <td><a href="func_misc_unpack.asp">unpack()</a></td>
    <td>Unpacks data from a binary string</td>
  </tr>
  <tr>
    <td><a href="func_misc_usleep.asp">usleep()</a></td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_misc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_misc.asp#top" target="_top">TOP</a> |
		<a href="php_ref_misc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
