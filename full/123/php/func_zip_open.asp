...
<title>PHP zip_open() Function</title>
<style>a.menu_func_zip_open{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">zip_open()</span> Function</h1>
<hr>
...
<p>The zip_open() function opens a zip archive for reading.</p>
<p>This function returns a open zip file resource on success, or FALSE on 
failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>filename</td>
    <td>Required. Specifies filename and path of the zip file to 
	open</td>
  </tr>
  </table>
<br>
...
<p><b>Tip:</b> The opened zip file resource can be used later with the zip_read() 
and zip_close() functions.</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_zip_open.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_zip_open.asp#top" target="_top">TOP</a> |
		<a href="func_zip_open.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
