...
<style>a.menu_func_array_unique{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_unique()</span> Function</h1>
...
&lt;?php<br>
	$a=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;red&quot;);<br>print_r(array_unique($a));<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_unique">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The array_unique() function removes duplicate values from an array. If two or 
more array values are the same, the first appearance will be kept and the other will be removed.</p>
<p><b>Note:</b> The returned array will keep the <b>first</b> array item's key 
type.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
array_unique(<em>array</em>)
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <ul>
        <li>SORT_STRING - Default. Compare items as strings</li>
		<li>SORT_REGULAR - Compare items normally (don't change types)</li>
		<li>SORT_NUMERIC - Compare items numerically</li>
		<li>SORT_LOCALE_STRING - Compare items as strings, based on current locale</li>
	</ul>
    </td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns the filtered array</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.1+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The default value of <em>sortingtype</em> was changed back to 
	SORT_STRING in PHP 5.2.10.<br><br>The default value of <em>sortingtype</em> 
	was changed to SORT_REGULAR in PHP 5.2.9. Prior to this version, the default 
	value was SORT_STRING.</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_unique.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_unique.asp#top" target="_top">TOP</a> |
		<a href="func_array_unique.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
