...
<title>PHP setrawcookie() Function</title>
<style>a.menu_func_http_setrawcookie{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">setrawcookie()</span> Function</h1>
<hr>
<a href="php_ref_http.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP HTTP Reference" /> Complete PHP HTTP Reference</a>
<hr>

<h2>Definition and Usage</h2>

<p>The setrawcookie() function sends an HTTP cookie without URL encoding the 
cookie value.</p>
<p>A cookie is a variable, sent by the server to the browser. A cookie is typically a small text file 
that the server embeds on the user's computer. Each time the same computer 
requests a page with a browser, it will send the cookie too.</p>
<p>The name of the cookie is automatically assigned to a variable of the same 
name. For example, if a cookie was sent with the name &quot;user&quot;, a variable is 
automatically created called $user, containing the cookie value.</p>
<p>A cookie must be assigned before 
any other output is sent to the client.</p>
...
<table class="reference notranslate"> 
  <tr>
	...
	<tr>
    <td>name</td>
    <td>Required. Specifies the name of the cookie</td>
  </tr>
	<tr>
    <td>value</td>
    <td>Required. Specifies the value of the cookie</td>
  </tr>
	<tr>
    <td>expire</td>
    <td>Optional. Specifies when the cookie expires.<p>
	...
	the browser closes).</td>
  </tr>
	<tr>
    <td>path</td>
    <td>Optional. Specifies the server path of the cookie<p>If set 
	...
	the cookie is being set in.</td>
  </tr>
	<tr>
    <td>domain</td>
    <td>Optional. Specifies the domain name of the cookie.<p>To 
	...
	available in the www subdomain</td>
  </tr>
	<tr>
    <td>secure</td>
    <td>Optional. Specifies whether or not the cookie should only 
	be transmitted over a secure HTTPS connection. TRUE indicates that the 
	cookie will only be set if a secure connection exists. Default is FALSE.</td>
  </tr>
  </table>
<br>
...
or by $_COOKIE[&quot;user&quot;]. </p>
<p><b>Note:</b> The setrawcookie() function is exactly the same as setcookie() 
except that the cookie value will not be automatically URL encoded when sent to 
the client.</p>
<hr>
<h2>Example 1</h2>
<p>Set and send cookie examples:</p>

<div class="code notranslate"><div>

&lt;?php<br>
$value = &quot;my cookie value&quot;;<br>
<br>
// send a simple cookie<br>
setrawcookie(&quot;TestCookie&quot;,$value);<br>
?&gt;<br>
<br>
&lt;html&gt;<br>
&lt;body&gt;<br>
...
$value = &quot;my cookie value&quot;;<br>
<br>
// send a cookie that expires in 24 hours<br>
setrawcookie(&quot;TestCookie&quot;,$value, time()+3600*24);<br>
?&gt;<br>
<br>
&lt;html&gt;<br>
&lt;body&gt;<br>
...
<h2>Example 2</h2>
<p>Different ways of retrieving the value of the cookie (after the cookie has 
been set): </p>
...
<p>
The output of the code above will be:</p>
...
<h2>Example 3</h2>
<p>Delete a cookie by setting the expiration date to a date/time in the past: </p>

<div class="code notranslate"><div>

&lt;?php<br>
// Set the expiration date to one hour ago<br>
setrawcookie (&quot;TestCookie&quot;, &quot;&quot;, time() - 3600);<br>
?&gt;<br>
<br>
&lt;html&gt;<br>
&lt;body&gt;<br>
...
<h2>Example 4</h2>
<p>Create an array cookie: </p>

<div class="code notranslate"><div>

&lt;?php<br>
setrawcookie(&quot;cookie[three]&quot;,&quot;cookiethree&quot;);<br>
setrawcookie(&quot;cookie[two]&quot;,&quot;cookietwo&quot;);<br>
setrawcookie(&quot;cookie[one]&quot;,&quot;cookieone&quot;);<br>
<br>
// print cookies (after reloading page)<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_http_setrawcookie.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_http_setrawcookie.asp#top" target="_top">TOP</a> |
		<a href="func_http_setrawcookie.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
