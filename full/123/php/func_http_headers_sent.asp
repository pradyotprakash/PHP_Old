...
<title>PHP headers_sent() Function</title>
<style>a.menu_func_http_headers_sent{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">headers_sent()</span> Function</h1>
<hr>
...
<p>The headers_sent() function checks if / where the HTTP headers have been sent.</p>
<p>This function returns TRUE if headers has been sent or FALSE if not.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  <tr>
	...
	<tr>
    <td>file,line</td>
    <td>Optional. If the file and line parameters are set, 
	headers_sent() will put the PHP source file name and line number where 
	output started in the file and line variables</td>
  </tr>
  </table>
<br>
...
<p><b>Note:</b> You can't add more header lines using header() once the header 
block has already been sent.</p>
<p><b>Note:</b> The optional file and line parameters were added in PHP 4.3.</p>
<hr>
<h2>Example 1</h2>
...
&lt;?php<br>
// If no headers are sent, send one<br>
if (!headers_sent())<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;header(&quot;Location: http://www.w3schools.com/&quot;);<br>
&nbsp;&nbsp;exit;<br>
&nbsp;&nbsp;}<br>
?&gt;<br>
<br>
...
<hr>
<h2>Example 2</h2>
<p>Using the optional file and line parameters:</p>

<div class="code notranslate"><div>

&lt;?php<br>
// $file and $line are passed in for later use<br>
// Do not assign them values beforehand<br>
if (!headers_sent($file, $line))<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;header(&quot;Location: http://www.w3schools.com/&quot;);<br>
&nbsp;&nbsp;exit;<br>
&nbsp;&nbsp;// Trigger an error here<br>
&nbsp;&nbsp;}<br>
else<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo &quot;Headers sent in $file on line $line&quot;;<br>
&nbsp;&nbsp;exit;<br>
&nbsp;&nbsp;}<br>
?&gt;<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_http_headers_sent.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_http_headers_sent.asp#top" target="_top">TOP</a> |
		<a href="func_http_headers_sent.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
