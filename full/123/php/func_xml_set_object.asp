...
<title>PHP xml_set_object() Function</title>
<style>a.menu_func_xml_set_object{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">xml_set_object()</span> Function</h1>
<hr>
...
<p>The xml_set_object() function allows a parser to be used within an object.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td>object</td>
    <td>Required. Specifies the object to set the parser to</td>
  </tr>
  </table>
...
var $xmlparser;<br>
<br>
function XMLParser()<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;$this-&gt;xmlparser = xml_parser_create();<br>
&nbsp;&nbsp;xml_set_object($this-&gt;xmlparser, $this);<br>
&nbsp;&nbsp;xml_set_character_data_handler($this-&gt;xmlparser,&quot;char&quot;);<br>
&nbsp;&nbsp;xml_set_element_handler($this-&gt;xmlparser, &quot;start_tag&quot;,&quot;end_tag&quot;);<br>
&nbsp;&nbsp;}<br>
<br>
function parse($data)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;xml_parse($this-&gt;xmlparser, $data);<br>
&nbsp;&nbsp;}<br>
<br>
function parse_File($xmlfile)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;$fp = fopen($xmlfile, 'r');<br>
&nbsp;&nbsp;while ($xmldata = fread($fp, 4096))<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;if<br>
&nbsp;&nbsp;&nbsp;&nbsp;(!xml_parse($this-&gt;xmlparser, $xmldata))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//If error<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;die( print &quot;ERROR: &quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;. xml_error_string(xml_get_error_code($this-&gt;xmlparser))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;. &quot;&lt;br /&gt;Line: &quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;. xml_get_current_line_number($this-&gt;xmlparser)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;. &quot;&lt;br /&gt;Column: &quot;<br>
...
&nbsp;&nbsp;}<br>
<br>
function start_tag($xmlparser, $tag, $attributes)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;print $tag . &quot;&lt;br /&gt;&quot;;<br>
&nbsp;&nbsp;}<br>
<br>
function end_tag(){}<br>
<br>
function char($xmlparser,$data)<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo $data . &quot;&lt;br /&gt;&quot;;<br>
&nbsp;&nbsp;}<br>
<br>
function close_Parser()<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;xml_parser_free($this-&gt;xmlparser);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
$myxmlparser = new XMLParser();<br>
$myxmlparser-&gt;parse_File(&quot;test.xml&quot;);<br>
$myxmlparser-&gt;close_parser();<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_xml_set_object.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_xml_set_object.asp#top" target="_top">TOP</a> |
		<a href="func_xml_set_object.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
