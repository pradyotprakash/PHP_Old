...
<title>PHP mysqli_get_server_version() Function</title>
<style>a.menu_func_mysqli_get_server_version{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_get_server_version()</span> Function</h1>
...
<p>Return the MySQL server version as an integer:</p>
...
&nbsp;&nbsp;}<br><br>echo mysqli_get_server_version($con);<br>
...
<p>The mysqli_get_server_version() function returns the MySQL server version as an integer.</p>
<p>The MySQL server version is returned in the following format: 
main_version*10000 + minor_version*100 + sub_version. E.g. 5.1.0 is returned as 50100.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_get_server_version(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an integer that represents the MySQL server version
	</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_get_server_version.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_get_server_version.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_get_server_version.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
