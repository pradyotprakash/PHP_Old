...
<style>a.menu_func_filesystem_file{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">file()</span> Function</h1>
<hr>
...
<p>The file() reads a file into an array.</p>
<p>Each array element contains a line from the file, with newline still attached.</p>
<h2>Syntax</h2>
...
<p><b>Tip:</b> This function became binary-safe in PHP 4.3. (meaning that both binary data, like 
...
Array<br>
(<br>
[0] =&gt; Hello World. Testing testing!<br>
[1] =&gt; Another day, another line.<br>
[2] =&gt; If the array picks up this line,<br>
[3] =&gt; then is it a pickup line?<br>
) 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_file.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_file.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_file.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
