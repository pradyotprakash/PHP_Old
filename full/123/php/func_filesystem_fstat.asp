...
<title>PHP fstat() Function</title>
<style>a.menu_func_filesystem_fstat{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fstat()</span> Function</h1>
<hr>
...
<p>The fstat() function returns information about an open file.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the open file to check</td>
  </tr>
  </table>
<br>
...
<p><b>Tip:</b> This function is similar to stat(), except that with this 
function the file must be open.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fstat.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fstat.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fstat.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
