...
<title>PHP str_pad() Function</title>
<style>a.menu_func_string_str_pad{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">str_pad()</span> Function</h1>
...
<p>Pad to the right side of the string, to a new length of 20 characters: </p>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_pad">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The str_pad() function pads a string to a new length.</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

str_pad(<em>string,length,pad_string,pad_type</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to pad</td>
  </tr>
  <tr>
    <td><em>length</em></td>
    <td>Required. Specifies the new string length. If this value 
	is less than the original length of the string, nothing will be done</td>
  </tr>
  <tr>
    <td><em>pad_string</em></td>
    <td>Optional. Specifies the string to use for padding. Default is 
	whitespace</td>
  </tr>
  <tr>
    <td><em>pad_type</em></td>
    <td>Optional. Specifies what side to pad the string.<p>Possible values:</p>
	<ul>
		<li>STR_PAD_BOTH - Pad to both sides of the string. If not an even 
		number, the right side gets the 
		extra padding</li>
		<li>STR_PAD_LEFT - Pad to the left side of the string</li>
		<li>STR_PAD_RIGHT - Pad to the right side of the string. This is default</li>
	</ul>
	  </td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the padded string</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.1+</td>
...
<p>Pad to the left side of the string:</p>
<div class="example_code notranslate">
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_pad2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 1</h2>
<p>Pad to both sides of the string: </p>
<div class="example_code notranslate">
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_pad3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_str_pad.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_str_pad.asp#top" target="_top">TOP</a> |
		<a href="func_string_str_pad.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
