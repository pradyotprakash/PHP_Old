...
<title>PHP strtok() Function</title>
<style>a.menu_func_string_strtok{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">strtok()</span> Function</h1>
...
<p>Split string one by one:</p>
	<p>In the example below, note that it is only the first call to strtok() that uses the string argument. 
...
the string argument again:</p>
<div class="example_code notranslate">

	&lt;?php<br>$string = &quot;Hello world. Beautiful day today.&quot;;<br>$token = 
	strtok($string, &quot; &quot;);<br><br>while ($token != false)<br>{<br>echo &quot;$token&lt;br&gt;&quot;;<br>
	$token = strtok(&quot; &quot;);<br>}
<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_strtok">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The strtok() function splits a string into smaller strings (tokens).</p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

strtok(<em>string,split</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>split</em></td>
    <td>Required. Specifies one or more split characters</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a string token</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_strtok.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_strtok.asp#top" target="_top">TOP</a> |
		<a href="func_string_strtok.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
