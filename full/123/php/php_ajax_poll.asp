...
<style>a.menu_php_ajax_poll{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ajax_rss_reader.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_examples.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>AJAX Poll</h2>
<p>The following example will demonstrate a poll where the result is shown without reloading.</p>
<div id="poll">
...
<p>When a user choose an option above, a function called &quot;getVote()&quot; is executed. The 
function is triggered by the &quot;onclick&quot; event:</p> 
...
<ul>
	...
	<li>Notice that a parameter (vote) is added to the URL (with the value of 
	the yes or no option)</li>
</ul>

<hr>
<h2>The PHP File</h2>

<p>The page on the server called by the JavaScript above is a PHP file called &quot;poll_vote.php&quot;:</p>
<div class="code notranslate"><div>
...
<p>The value is sent from the JavaScript, and the following 
happens:</p>
<ol>
	<li>Get the content of the &quot;poll_result.txt&quot; file</li>
	<li>Put the content of the file in variables and add one to the selected 
	variable</li>
...
<p>The first number represents the &quot;Yes&quot; votes, the second number represents the 
&quot;No&quot; votes.</p>
<p><b>Note:</b> Remember to allow your web server to edit the text file. Do <b>
NOT</b> give everyone access, just the web server (PHP).</p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ajax_rss_reader.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_examples.asp">Next Chapter &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ajax_poll.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ajax_poll.asp#top" target="_top">TOP</a> |
		<a href="php_ajax_poll.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
