...
<title>PHP filegroup() Function</title>
<style>a.menu_func_filesystem_filegroup{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filegroup()</span> Function</h1>
<hr>
...
<p>The filegroup() function returns the group ID of the specified file.</p>
<p>This function returns the group ID on success or FALSE on failure.</p>
...
<p><b>Note:</b> The result of this function are cached. Use clearstatcache() to clear the cache.</p>
<p><b>Note:</b> This function doesn't produce meaningful results on Windows systems.</p>
<p><b>Tip:</b> Use posix_getgrgid() to convert the group ID to a group name.</p>
<hr>

<h2>Example</h2>
<div class="code notranslate"><div>
&lt;?php<br>
echo filegroup(&quot;test.txt&quot;);<br>
?&gt; 
</div></div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_filegroup.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_filegroup.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_filegroup.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
