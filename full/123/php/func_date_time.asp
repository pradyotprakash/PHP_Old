...
<style>a.menu_func_date_time{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">time()</span> Function</h1>
...
<p>Return the current time as a Unix timestamp, then format it to a date:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_time">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The time() function returns the current time in the number of seconds since 
the Unix Epoch (January 1 1970 00:00:00 GMT).</p>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns an integer containing the current time as a Unix 
	timestamp</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_time.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_time.asp#top" target="_top">TOP</a> |
		<a href="func_date_time.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
