...
<title>PHP filemtime() Function</title>
<style>a.menu_func_filesystem_filemtime{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">filemtime()</span> Function</h1>
<hr>
...
<p>The filemtime() function returns the last time the file content was modified.</p>
...
&lt;?php<br>
echo filemtime(&quot;test.txt&quot;);<br>
echo &quot;&lt;br /&gt;&quot;;<br>
echo &quot;Last modified: &quot;.date(&quot;F d Y H:i:s.&quot;,filemtime(&quot;test.txt&quot;));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_filemtime.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_filemtime.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_filemtime.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
