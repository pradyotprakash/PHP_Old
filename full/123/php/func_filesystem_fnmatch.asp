...
<title>PHP fnmatch() Function</title>
<style>a.menu_func_filesystem_fnmatch{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fnmatch()</span> Function</h1>
<hr>
...
<p>The fnmatch() function matches a filename or string against the specified pattern.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>pattern</td>
    <td>Required. Specifies the pattern to search for</td>
  </tr>
  <tr>
    <td>string</td>
    <td>Required. Specifies the string or file check</td>
  </tr>
  <tr>
    <td>flags</td>
    <td>Optional.</td>
...
<p><b>Note:</b> This function is not implemented on Windows 
platforms.</p>
<hr>

<h2>Example</h2>
<p>Checking a color name against a shell wildcard pattern:</p>

<div class="code notranslate"><div>

&lt;?php<br>
$txt = &quot;My car is darkgrey...&quot;<br>
if (fnmatch(&quot;*gr[ae]y&quot;,$txt))<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;echo &quot;some form of gray ...&quot;;<br>
&nbsp;&nbsp;}<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fnmatch.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fnmatch.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fnmatch.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
