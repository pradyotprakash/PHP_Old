...
<title>PHP set_exception_handler() Function</title>
<style>a.menu_func_error_set_exception_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">set_exception_handler()</span> Function</h1>
<hr>
...
<p>The set_exception_handler() function sets a user-defined function to handle 
exceptions.</p>
<p>This function is used to create a way of handling exceptions during 
runtime.</p>
<p>This function returns the old exception handler, or NULL on failure or if no 
previous handler is defined.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>exception_function</td>
    <td>Required. Specifies the function to be called when 
	an uncaught exception occurs.<p>This function must be defined before calling 
	the set_exception_handler() function. The exception handler function 
	requires one 
	parameter, which is the exception object that was thrown</td>
  </tr>
  	</table>
<br>
<hr>
...
<p><b>Tip:</b> The script will stop executing after the exception handler is 
called.</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_error_set_exception_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_error_set_exception_handler.asp#top" target="_top">TOP</a> |
		<a href="func_error_set_exception_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
