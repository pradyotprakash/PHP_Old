...
<title>PHP frenchtojd() Function</title>
<style>a.menu_func_cal_frenchtojd{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">frenchtojd()</span> Function</h1>
...
<p>Convert a French Republican date to a Julian Day Count and back to a French Republican date:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$jd=frenchtojd(3,3,14);<br>echo $jd . &quot;&lt;br&gt;&quot;;<br>echo jdtofrench($jd);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_frenchtojd">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The frenchtojd() function converts a date from the French Republican Calendar to a Julian Day Count.</p>
<p><strong>Tip:</strong> The French Republican Calendar is a calendar proposed during the French Revolution,
and used by the French government for about twelve years from late 1793. This function only convert dates in
years 1 through 14 (Gregorian dates 22 September 1792 - 22 September 1806).</p>
<p><strong>Tip:</strong> Look at the <a href="func_cal_jdtofrench.asp">jdtofrench()</a> function
to convert a Julian Day Count to a French Republican date.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	frenchtojd(<em>month,day,year);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>month</em></td>
    <td>Required. Specifies the month as a number from 1 to 13</td>
  </tr>
  <tr>
    <td><em>day</em></td>
    <td>Required. Specifies the day as a number from 1 to 30</td>
  </tr>
  <tr>
    <td><em>year</em></td>
    <td>Required. Specifies the year as a number from 1 to 14</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_frenchtojd.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_frenchtojd.asp#top" target="_top">TOP</a> |
		<a href="func_cal_frenchtojd.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
