...
<title>PHP mysqli_stmt_init() Function</title>
<style>a.menu_func_mysqli_stmt_init{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_stmt_init()</span> Function</h1>
...
<p>Initialize a statement and return an object to use with 
...
&nbsp;&nbsp;}<br><br>$city=&quot;Sandnes&quot;;<br><br>// Create a prepared statement<br>
	$stmt=mysqli_stmt_init($con);<br><br>if (mysqli_stmt_prepare($stmt,&quot;SELECT 
	District FROM City WHERE Name=?&quot;))<br>&nbsp; {<br><br>&nbsp; // Bind 
	parameters<br>&nbsp; mysqli_stmt_bind_param($stmt,&quot;s&quot;,$city);<br><br>&nbsp; 
	// Execute query<br>&nbsp; mysqli_stmt_execute($stmt);<br><br>&nbsp; // Bind 
	result variables<br>&nbsp; mysqli_stmt_bind_result($stmt,$district);<br><br>&nbsp; 
	// Fetch value<br>&nbsp; mysqli_stmt_fetch($stmt);<br><br>&nbsp; printf(&quot;%s 
	is in district %s&quot;,$city,$district);<br><br>&nbsp; // Close statement<br>&nbsp; 
	mysqli_stmt_close($stmt);<br>&nbsp; }<br>
...
<p>The mysqli_stmt_init() function initializes a statement and returns an object suitable for mysqli_stmt_prepare().</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_stmt_init(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns an object</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_stmt_init.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_stmt_init.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_stmt_init.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
