...
<title>PHP max() Function</title>
<style>a.menu_func_math_max{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">max()</span> Function</h1>
...
<p>Find highest value with the max() function:</p>
<div class="example_code notranslate">
&lt;?php<br>
	echo(max(2,4,6,8,10) . &quot;&lt;br&gt;&quot;);<br>echo(max(22,14,68,18,15) . &quot;&lt;br&gt;&quot;);<br>
	echo(max(array(4,6,8,10)) . &quot;&lt;br&gt;&quot;);<br>echo(max(array(44,16,81,12)));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_max">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The max() function returns the highest value in an array, or the highest value of several specified values.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	max(<em>array_values</em>);<br><br>or<br><br>max(<em>value1,value2,...</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>array_values</em></td>
    <td>Required. Specifies an array containing the values</td>
  </tr>
  <tr>
    <td><em>value1,value2,...</em></td>
    <td>Required. Specifies the values to compare (must be at least two values)</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">The numerically highest value</td>
</tr>
<tr>
	<th>Return Type:</th>
	<td>Mixed</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_max.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_max.asp#top" target="_top">TOP</a> |
		<a href="func_math_max.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
