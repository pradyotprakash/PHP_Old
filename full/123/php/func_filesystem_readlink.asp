...
<title>PHP readlink() Function</title>
<style>a.menu_func_filesystem_readlink{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">readlink()</span> Function</h1>
<hr>
...
<p>The readlink() function returns the target of a symbolic link.</p>
<p>This function returns the target of the link on success, or FALSE on failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>linkpath</td>
    <td>Required. Specifies the link path to check</td>
  </tr>
  </table>
<br>
...
&lt;?php<br>
echo readlink(&quot;/user/testlink&quot;);<br>
?&gt; 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_readlink.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_readlink.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_readlink.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
