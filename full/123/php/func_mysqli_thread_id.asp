...
<title>PHP mysqli_thread_id() Function</title>
<style>a.menu_func_mysqli_thread_id{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_thread_id()</span> Function</h1>
...
<p>Return the thread ID for the current connection, then kill the connection:</p>
...
&nbsp;&nbsp;}<br><br>// Get thread id<br>$t_id=mysqli_thread_id($con);<br><br>// 
	Kill connection<br>mysqli_kill($con,$t_id);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The mysqli_thread_id() function returns the thread ID for the current 
connection. The connection can then be killed with the
<a href="func_mysqli_kill.asp">mysqli_kill()</a> function.</p>
<p><strong>Note:</strong> If the connection is broken and you reconnect, the 
thread ID will be changed. Therefore; get the thread ID only when you need it. </p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_thread_id(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns the thread ID for the current connection</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_thread_id.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_thread_id.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_thread_id.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
