...
<title>PHP mysqli_options() Function</title>
<style>a.menu_func_mysqli_options{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_options()</span> Function</h1>
...
&lt;?php<br>
	...
	die(&quot;mysqli_init failed&quot;);<br>&nbsp; }<br><br>
	mysqli_options($con,MYSQLI_READ_DEFAULT_FILE,&quot;myfile.cnf&quot;);<br><br>if 
...
<p>The mysqli_options() function sets extra connect options and affect behavior for a connection.</p>
<p>The mysqli_options() function can be called several times to set several options.</p>
<p><strong>Note:</strong> The mysqli_options() function should be called after
<a href="func_mysqli_init.asp">mysqli_init()</a> and before
<a href="func_mysqli_real_connect.asp">mysqli_real_connect()</a>.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_options(<em>connection,option,value</em>)<em>;</em></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>option</em></td>
    <td>Required. Specifies the option to set. Can be one of the following 
	values:<ul>
		<li>MYSQLI_OPT_CONNECT_TIMEOUT - connection timout in seconds</li>
		<li>MYSQLI_OPT_LOCAL_INFILE - enable/disable use of LOAD LOCAL INFILE</li>
		<li>MYSQLI_INIT_COMMAND - command to execute after connecting to MySQL 
		server</li>
		<li>MYSQLI_READ_DEFAULT_FILE - read options from named file instead of 
		my.cnf</li>
		<li>MYSQLI_READ_DEFAULT_GROUP - read options from named group from 
		my.cnf or the file specified in MYSQLI_READ_DEFAULT_FILE</li>
		<li>MYSQLI_SERVER_PUBLIC_KEY - RSA public key file used with SHA-256 
  ...
  <tr>
    <td><em>value</em></td>
    <td>Required. Specifies the value for the <em>option</em></td>
  </tr>
  </table>
...
<tr>
	<th>Changelog:</th>
	<td>The MYSQLI_SERVER_PUBLIC_KEY option was added in PHP 5.5</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_options.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_options.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_options.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
