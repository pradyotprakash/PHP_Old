...
<title>PHP fmod() Function</title>
<style>a.menu_func_math_fmod{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fmod()</span> Function</h1>
...
<p>Return the remainder of x/y:</p>
<div class="example_code notranslate">
&lt;?php<br>
$x = 7;<br>$y = 2;<br>$result = fmod($x,$y);<br>
echo $result;<br>// $result equals 1, because 2 * 3 + 1 = 7 <br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_fmod">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The fmod() function returns the remainder (modulo) of x/y.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	fmod(<em>x,y</em>);</div></div>
<br>
...
<tr>
	...
	<td style="width:80%">The floating point remainder of x/y</td>
</tr>
	<tr>
	<th>Return Type:</th>
	<td>Float</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_fmod.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_fmod.asp#top" target="_top">TOP</a> |
		<a href="func_math_fmod.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
