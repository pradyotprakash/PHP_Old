...
<title>PHP metaphone() Function</title>
<style>a.menu_func_string_metaphone{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">metaphone()</span> Function</h1>
...
<p>Calculate the metaphone key of "World":</p>
<div class="example_code notranslate">

&lt;?php<br>
echo metaphone(&quot;World&quot;);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_metaphone">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The metaphone() function calculates the metaphone key of a string.</p>
<p>A metaphone 
key represents how a string sounds if said by an English 
speaking person.</p>
<p>The metaphone() function can be used for spelling applications.</p>

<p><b>Note:</b> The metaphone() function creates the same key for similar 
sounding words.</p>
<p><b>Note:</b> The generated metaphone keys vary in length.</p>

<p><b>Tip:</b> metaphone() is more accurate than the 
<a href="func_string_soundex.asp">soundex()</a> 
function, because metaphone() knows the basic rules of English pronunciation. </p>
<hr>
<h2>Syntax</h2>

<div class="code notranslate"><div>

metaphone(<em>string,length</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>length</em></td>
    <td>Optional. Specifies the maximum length of the metaphone key</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the metaphone key of the string on success, or FALSE on failure.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>Using the metaphone() function on two similar sounding words: </p>
<div class="example_code notranslate">
...
$str2 = &quot;Assistants&quot;;<br>
<br>
echo metaphone($str);<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo metaphone($str2);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_metaphone2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Using the length parameter: </p>
<div class="example_code notranslate">
...
$str2 = &quot;Assistants&quot;;<br>
<br>
echo metaphone($str,5);<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo metaphone($str2,5);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_metaphone3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_metaphone.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_metaphone.asp#top" target="_top">TOP</a> |
		<a href="func_string_metaphone.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
