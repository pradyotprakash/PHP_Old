...
<title>PHP is_infinite() Function</title>
<style>a.menu_func_math_is_infinite{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">is_infinite()</span> Function</h1>
...
<p>Check whether a value is infinite or not:</p>
<div class="example_code notranslate">
&lt;?php<br>
echo is_infinite(2) . &quot;&lt;br&gt;&quot;;<br>
echo is_infinite(log(0)) . &quot;&lt;br&gt;&quot;;<br>
echo is_infinite(2000);<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_math_is_infinite">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The is_infinite() function checks whether a value is infinite or not.</p>
<p>This function returns true (1) if the specified value is an infinite number, otherwise it returns false/nothing.</p>
<p>The value is infinite if it is outside the allowed range for a PHP float on this platform.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
is_infinite(<em>value</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>value</em></td>
    <td>Required. Specifies the value to check</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">TRUE if <em>value</em> is an infinite number, FALSE otherwise</td>
</tr>
	<tr>
	<th>Return Type:</th>
	<td>Boolean</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_math_is_infinite.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_math_is_infinite.asp#top" target="_top">TOP</a> |
		<a href="func_math_is_infinite.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
