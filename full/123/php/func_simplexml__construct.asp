...
<title>PHP __construct() Function</title>
<style>a.menu_func_simplexml__construct{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">__construct()</span> Function</h1>
...
<p>Create a new SimpleXMLElement object, then output the content of the body 
node:</p>
...
$xml=new SimpleXMLElement($note);<br>
echo $xml-&gt;body;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_construct">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The __construct() function creates a new SimpleXMLElement object.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	__construct(<em>data,options,data_is_url,ns,is_prefix</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>data</em></td>
    <td>Required. Specifies A well-formed XML string or the path or URL to an 
	XML document if data_is_url is TRUE</td>
  </tr>
  <tr>
    <td><em>options</em></td>
	...
	<tr>
    <td><em>data_is_url</em></td>
    <td>Optional. TRUE specifies that <em>
	data</em> is a path/URL to an XML document instead of string data. Default 
	is FALSE</td>
  </tr>
	<tr>
    <td><em>ns</em></td>
...
<tr>
	...
	<td style="width:80%">Returns a SimpleXMLElement object that represents <em>data</em></td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.0.1+</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 5.1.2: <em>options</em> and <em>data_is_url</em> parameters added.<br>PHP 
	5.2: <em>ns</em> and <em>is_prefix</em> parameters added.</td>
</tr>
</table>
<br>
<hr>
...
<h2>More Examples</h2>
<p>Assume we have the following XML file, &quot;<a href="note.xml" target="_blank">note.xml</a>&quot;:</p>
<div class="code notranslate"><div>
...
<p>Create a SimpleXMLElement object from a URL:</p>
<div class="example_code notranslate">
	&lt;?php<br>$xml=new SimpleXMLElement(&quot;note.xml&quot;,NULL,TRUE);<br>echo 
	$xml-&gt;asXML();<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_simplexml_construct2">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_simplexml__construct.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_simplexml__construct.asp#top" target="_top">TOP</a> |
		<a href="func_simplexml__construct.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
