...
<style>a.menu_php_operators{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Operators</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_constants.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_if_else.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">This chapter shows the different operators that can be used in PHP scripts.</p>
<hr>
...
<p>The example below shows the different results of using the different arithmetic operators:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php <br>$x=10; <br>$y=6;<br>echo ($x + $y); // outputs 16<br>echo ($x - $y); 
	// outputs 4<br>echo ($x 
	* $y); // outputs 60<br>echo ($x / $y); // outputs 1.6666666666667 <br>echo ($x % $y); 
	// outputs 4 <br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_operator_arithmetic">Run example &raquo;</a>
</div>
<br>
<hr>

<h2>PHP Assignment Operators</h2>
<p>The PHP assignment operators is used to write a value to a variable.</p>
...
<p>The example below shows the different results of using the different assignment operators:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php <br>$x=10; <br>echo $x; // outputs 10<br><br>$y=20; <br>$y += 100;<br>
	echo $y; // outputs 120<br><br>$z=50;<br>$z -= 25;<br>echo $z; // outputs 25<br>
	<br>$i=5;<br>$i *= 6;<br>echo $i; // outputs 30<br><br>$j=10;<br>$j /= 5;<br>
	echo $j; // outputs 2<br><br>$k=15;<br>$k %= 4;<br>echo $k; // outputs 3<br>
	?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_operator_assignment">Run example &raquo;</a>
</div>
<br>
<hr>
...
<td>Now $txt2 contains &quot;Hello world!&quot;</td>
</tr>
<tr>
<td>.=</td>
<td>Concatenation assignment</td>
<td>$txt1 = &quot;Hello&quot;<br>$txt1 .= &quot; world!&quot;</td>
<td>Now $txt1 contains &quot;Hello world!&quot;</td>
</tr>
</table>
<p>The example below shows the results of using the string operators:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>$a = &quot;Hello&quot;;<br>$b = $a . &quot; world!&quot;;<br>echo $b; // 
	outputs Hello world! <br><br>$x=&quot;Hello&quot;;<br>$x .= &quot; world!&quot;;<br>echo $x; // outputs Hello world! <br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_operator_string">Run example &raquo;</a>
</div>
<br>
<hr>
...
<p>The example below shows the different results of using the different 
increment/decrement operators:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>$x=10; <br>echo ++$x; // outputs 11<br><br>$y=10; <br>echo $y++; // 
	outputs 10<br><br>$z=5;<br>echo --$z; // outputs 4<br><br>$i=5;<br>echo 
	$i--; // outputs 5<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_operator_increment">Run example &raquo;</a>
</div>
<br>
<hr>
...
<p>The example below shows the different results of using some of the comparison operators:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>$x=100; <br>$y=&quot;100&quot;;<br><br>var_dump($x == $y);<br>
	echo &quot;&lt;br&gt;&quot;;<br>var_dump($x === 
	$y);<br>echo &quot;&lt;br&gt;&quot;;<br>var_dump($x != $y);<br>echo &quot;&lt;br&gt;&quot;;<br>var_dump($x !== $y);<br>echo &quot;&lt;br&gt;&quot;;<br><br>$a=50;<br>$b=90;<br><br>var_dump($a &gt; $b);<br>echo 
	&quot;&lt;br&gt;&quot;;<br>var_dump($a &lt; $b);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_operator_comparison">Run example &raquo;</a>
</div>
<br>
<hr>
...
<td>Union</td>
<td>$x + $y</td>
<td>Union of $x and $y (but duplicate keys are not overwritten)</td>
</tr>
<tr>
<td>==</td>
<td>Equality</td>
...
<td>Identity</td>
<td>$x === $y</td>
<td>True if $x and $y have the same key/value pairs in the same order and of 
the same types</td>
</tr>
<tr>
<td>!=</td>
...
<p>The example below shows the different results of using the different array operators:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>$x = array(&quot;a&quot; =&gt; &quot;red&quot;, &quot;b&quot; =&gt; &quot;green&quot;); <br>$y = array(&quot;c&quot; =&gt; 
	&quot;blue&quot;, &quot;d&quot; =&gt; &quot;yellow&quot;); <br>$z = $x + $y; // union of $x and $y<br>var_dump($z);<br>var_dump($x == $y);<br>var_dump($x === $y);<br>
	var_dump($x != $y);<br>var_dump($x &lt;&gt; $y);<br>var_dump($x !== $y);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_operator_array">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_operators.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_operators.asp#top" target="_top">TOP</a> |
		<a href="php_operators.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
