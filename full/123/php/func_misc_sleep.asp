...
<title>PHP sleep() Function</title>
<style>a.menu_func_misc_sleep{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">sleep()</span> Function</h1>
...
<p>Delay execution of the current script for 5 seconds:</p>
<div class="example_code notranslate">
&lt;?php<br>echo date('h:i:s') . &quot;&lt;br&gt;&quot;;<br>
<br>
...
echo date('h:i:s');<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_sleep">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The sleep() function delays execution of the current script for a specified number of 
seconds.</p>
<p><strong>Note:</strong> This function throws an error if the 
specified number of seconds is negative.</p>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns 0 on success, or FALSE on error.<br><br>This 
	function returns a non-zero value if the call was interrupted by a signal. 
	On Windows, this value will always be <strong>192</strong>, which is the 
	value of the WAIT_IO_COMPLETION constant within the Windows API. On other 
	platforms, the return value will be the number of seconds left to sleep.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>Before PHP 5.3.4, this function always returns NULL when sleep 
	has occurred on Windows.</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_sleep.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_sleep.asp#top" target="_top">TOP</a> |
		<a href="func_misc_sleep.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
