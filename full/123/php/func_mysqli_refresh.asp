...
<title>PHP mysqli_refresh() Function</title>
<style>a.menu_func_mysqli_refresh{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_refresh()</span> Function</h1>
...
<p>The mysqli_refresh() function refreshes tables or caches, or resets the replication server information.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_refresh(<em>connection,options</em>)<em>;</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>options</em></td>
    <td>The options to refresh. Can be one of more of the following (separated 
	by OR):
	<ul>
		<li>MYSQLI_REFRESH_GRANT - Refreshes the grant tables</li>
		<li>MYSQLI_REFRESH_LOG - Flushes the logs</li>
		<li>MYSQLI_REFRESH_TABLES - Flushes the table cache</li>
		<li>MYSQLI_REFRESH_HOSTS - Flushes the host cache</li>
		<li>MYSQLI_REFRESH_STATUS - Resets the status variables</li>
		<li>MYSQLI_REFRESH_THREADS - Flushes the thread cache</li>
		<li>MYSQLI_REFRESH_SLAVE - Resets the master server info, and restarts 
		the slave</li>
		<li>MYSQLI_REFRESH_MASTER - Removes the binary log files in the binary 
		log index, and truncates the index file</li>
	</ul>
	  </td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_refresh.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_refresh.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_refresh.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
