...
<title>PHP crypt() Function</title>
<style>a.menu_func_string_crypt{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">crypt()</span> Function</h1>
<hr>
...
<p>The crypt() function returns a string encrypted using DES, Blowfish, 
or MD5 algorithms.</p>
<p>This function behaves different on different operating systems, some operating 
systems supports more than one type of encryption. PHP checks what algorithms 
are available and what algorithms to use when it is installed.</p>
<p>The exact algorithm depends on the format and length of the salt parameter.
...
specific 
encryption method.</p>
<p>There are some constants that are used together with the crypt() function. 
The value of these constants are set by PHP when it is installed.</p>
<p>Constants:</p>
<ul>
	<li>[CRYPT_SALT_LENGTH] - The length of the default encryption. With 
	standard DES encryption, the length is 2</li>
	<li>[CRYPT_STD_DES] - The Standard DES-based encryption has a 2 character salt 
	from the alphabet &quot;./0-9A-Za-z&quot;. Using invalid characters in the salt will 
	cause the function to fail.</li>
	<li>[CRYPT_EXT_DES] - The Extended DES encryption has a 9 character salt 
	...
	function to fail.</li>
	<li>[CRYPT_MD5] - The MD5 
encryption has a 12 character salt starting with $1$</li>
	<li>[CRYPT_BLOWFISH] - The Blowfish encryption has a salt starting with 
	...
	outside this range will cause the function to fail.</li>
	<li>[CRYPT_SHA_256] - The SHA-256 encryption has a 16 character salt starting with&nbsp; 
	$5$. <span lang="no-bok">&nbsp;If the salt string starts with &quot;rounds=&lt;N&gt;$&quot;, 
	...
	nearest limit.</span></li>
	<li>[CRYPT_SHA_512] - The SHA-512 encryption has a 16 character salt starting with $6$.
	<span lang="no-bok">&nbsp;If the salt string starts with &quot;rounds=&lt;N&gt;$&quot;, the 
...
<p>On systems where this function supports multiple algorithms, the constants 
above are set to &quot;1&quot; if supported and &quot;0&quot; otherwise.</p>
<p><b>Note:</b> There is no decrypt function. The crypt() function uses a one-way algorithm.</p>
<hr>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>str</em></td>
    <td>Required. Specifies the string to be encoded</td>
  </tr>
  <tr>
    <td><em>salt</em></td>
    <td>Optional. A string used to increase the number of 
...
<tr>
	...
	<td style="width:80%">Returns the encoded string or a string that is shorter than 
	13 characters and is guaranteed to differ from the salt on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>$2x$ and $2y$ Blowfish modes were added in PHP 5.3.7 to deal with 
	potential high-bit attacks. <br><br>The constants SHA-256 and SHA-512 were 
	added in PHP 5.3.2.<br><br>As of PHP 5.3.2, Blowfish behaviour on invalid 
	rounds returns the &quot;failure&quot; string (&quot;*0&quot; or &quot;*1&quot;), instead of falling back 
	to DES.<br><br>As of PHP 5.3.0, PHP contains its own 
...
<p>In this example we will test the different algorithms:</p>
<div class="example_code notranslate">

&lt;?php<br>// 2 character salt<br>
	if (CRYPT_STD_DES == 1)<br>{<br>echo &quot;Standard DES: &quot;.crypt('something','st').&quot;\n&lt;br&gt;&quot;;
	<br>}<br>else<br>{<br>echo &quot;Standard DES not supported.\n&lt;br&gt;&quot;;<br>}<br><br>
	// 4 character salt<br>if (CRYPT_EXT_DES == 1)<br>{<br>echo &quot;Extended DES: 
	&quot;.crypt('something','_S4..some').&quot;\n&lt;br&gt;&quot;;<br>}<br>else<br>{<br>echo 
	&quot;Extended DES not supported.\n&lt;br&gt;&quot;;<br>}<br><br>// 12 character salt 
	starting with $1$ <br>if (CRYPT_MD5 == 1)<br>{<br>echo &quot;MD5: 
	&quot;.crypt('something','$1$somethin$').&quot;\n&lt;br&gt;&quot;; <br>}<br>else<br>{<br>echo 
	&quot;MD5 not supported.\n&lt;br&gt;&quot;;<br>}<br><br>// Salt starting with $2a$. The two 
	digit cost parameter: 09. 22 characters <br>if (CRYPT_BLOWFISH == 1)<br>{<br>
	echo &quot;Blowfish: &quot;.crypt('something','$2a$09$anexamplestringforsalt$').&quot;\n&lt;br&gt;&quot;;
	<br>}<br>else<br>{<br>echo &quot;Blowfish DES not supported.\n&lt;br&gt;&quot;;<br>}<br><br>
	// 16 character salt starting with $5$. The default number of rounds is 
	5000.<br>if (CRYPT_SHA256 == 1) <br>{<br>echo &quot;SHA-256: 
	&quot;.crypt('something','$5$rounds=5000$anexamplestringforsalt$').&quot;\n&lt;br&gt;&quot;; }<br>
	else<br>{<br>echo &quot;SHA-256 not supported.\n&lt;br&gt;&quot;;<br>}<br><br>// 16 
	character salt starting with $5$. The default number of rounds is 5000.<br>
	if (CRYPT_SHA512 == 1) <br>{<br>echo &quot;SHA-512: 
	&quot;.crypt('something','$6$rounds=5000$anexamplestringforsalt$'); <br>}<br>else<br>
	{<br>echo &quot;SHA-512 not supported.&quot;;<br>}<br>
?&gt;</div>
<p>The output of the code above could be (depending on the operating system):</p>
<div class="example_code notranslate">

	Standard DES: stqAdD7zlbByI<br>Extended DES: _S4..someQXidlBpTUu6<br>MD5: 
	$1$somethin$4NZKrUlY6r7K7.rdEOZ0w.<br>Blowfish: 
	$2a$09$anexamplestringforsaleLouKejcjRlExmf1671qw3Khl49R3dfu<br>SHA-256: 
	$5$rounds=5000$anexamplestringf$KIrctqsxo2wrPg5Ag/hs4jTi4PmoNKQUGWFXlVy9vu9<br>
	SHA-512: 
	$6$rounds=5000$anexamplestringf$Oo0skOAdUFXkQxJpwzO05wgRHG0dhuaPBaOU/<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_crypt.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_crypt.asp#top" target="_top">TOP</a> |
		<a href="func_string_crypt.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
