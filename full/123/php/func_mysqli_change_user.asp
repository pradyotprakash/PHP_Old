...
<title>PHP mysqli_change_user() Function</title>
<style>a.menu_func_mysqli_change_user{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_change_user()</span> Function</h1>
...
<p>Change the user of the specified database 
	connection:</p>
...
&nbsp;&nbsp;}<br><br>// Reset all and select a new database<br>
	mysqli_change_user($link, &quot;my_user&quot;, &quot;my_password&quot;, &quot;my_test&quot;);<br><br>
	mysqli_close($con);<br>
?&gt;
</div>
</div>
...
<p>The mysqli_change_user() function changes the user of the specified database connection, and sets the current database.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_change_user(<em>connection,username,password,dbname);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the MySQL username</td>
  </tr>
  <tr>
    <td><em>password</em></td>
    <td>Required. Specifies the MySQL password</td>
  </tr>
  <tr>
    <td><em>dbname</em></td>
    <td>Required. Specifies the database to change to</td>
  </tr>
  </table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_change_user.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_change_user.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_change_user.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
