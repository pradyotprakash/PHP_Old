...
<title>PHP FILTER_SANITIZE_ENCODED Filter</title>
<style>a.menu_filter_sanitize_encoded{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_SANITIZE_ENCODED</span> Filter</h1>
<hr>
...
<p>The FILTER_SANITIZE_ENCODED filter strips or URL-encodes unwanted characters.</p>
<p>It works a lot like the urlencode() function.</p>
<ul>
	<li>Name: &quot;encoded&quot;</li>
	<li>ID-number: 514</li>
</ul>
...
&lt;?php<br>
$url=&quot;http://www.w3schools.com&quot;;<br>
<br>
var_dump(filter_var($url,FILTER_SANITIZE_ENCODED));<br>
?&gt;
...
string(30) &quot;http%3A%2F%2Fwww.w3schools.com&quot;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_sanitize_encoded.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_sanitize_encoded.asp#top" target="_top">TOP</a> |
		<a href="filter_sanitize_encoded.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
