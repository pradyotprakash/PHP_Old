...
<title>PHP date_sun_info() Function</title>
<style>a.menu_func_date_sun_info{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_sun_info()</span> Function</h1>
...
<p>Return information about sunset/sunrise and twilight begin/end on 1st 
January, 2013, for latitude 31.7667, longitude 35.2333:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$sun_info=date_sun_info(strtotime(&quot;2013-01-01&quot;),31.7667,35.2333);<br>foreach 
	($sun_info as $key=&gt;$val)<br>&nbsp; {<br>&nbsp; echo &quot;$key: &quot; . 
	date(&quot;H:i:s&quot;,$val) . &quot;&lt;br&gt;&quot;;<br>&nbsp; }<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_sun_info">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_sun_info() function returns an array containing information about sunset/sunrise 
and twilight begin/end, for a specified day and location.</p>
...
<p><strong>Tip:</strong> Look at the <a href="func_date_sunset.asp">
date_sunset()</a> function to return the sunset time for a specified day and location.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	date_sun_info(<em>timestamp,latitude,longitude);</em></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies a timestamp</td>
  </tr>
  <tr>
    <td><em>latitude</em></td>
    <td>Required. Specifies the latitude in degrees</td>
  </tr>
  <tr>
    <td><em>longitude</em></td>
    <td>Required. Specifies the longitude in degrees</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an array on success. FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.1.2+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_sun_info.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_sun_info.asp#top" target="_top">TOP</a> |
		<a href="func_date_sun_info.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
