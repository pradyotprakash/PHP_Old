...
<title>PHP set_error_handler() Function</title>
<style>a.menu_func_error_set_error_handler{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">set_error_handler()</span> Function</h1>
<hr>
...
<p>The set_error_handler() function sets a user-defined function to handle 
errors.</p>
<p>This function is used to create your own way of handling errors during 
runtime.</p>
<p>This function returns the old error handler, or NULL on failure.</p>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the function to be run at errors</td>
  </tr>
  <tr>
    <td>error_types</td>
    <td>Optional. Specifies on which errors report levels the 
	user-defined error will be shown. Default is &quot;E_ALL&quot;.&nbsp; See 
	table below for possible error report levels</td>
  </tr>
	</table>
<h2>error_function</h2>
<h2>Syntax</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td>error_context</td>
    <td>Optional. Specifies an array that points to the active 
...
<p><b>Tip:</b> The standard PHP error handler is completely 
bypassed if this function is used, and the user-defined error handler must 
terminate the script (die() ) if necessary<br>
<br>
<b>Note:</b>
If errors occur before the script is executed the custom 
error handler cannot be used since it is not registered at that time</p>
<hr>
...
<b>Custom error:</b> [1024] A custom error has been triggered<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_error_set_error_handler.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_error_set_error_handler.asp#top" target="_top">TOP</a> |
		<a href="func_error_set_error_handler.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
