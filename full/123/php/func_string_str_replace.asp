...
<style>a.menu_func_string_str_replace{font-weight:bold;}</style>
<meta charset="utf-8">
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_replace">Run example &raquo;</a>
</div>
<hr>
...
<p><b>Note: </b>This function is case-sensitive. Use the
<a href="func_string_str_ireplace.asp">str_ireplace()</a> function to perform a 
...
<tr>
	<th>Changelog:</th>
	<td>The <em>count</em> parameter was added in PHP 5.0<br><br>Before PHP 
	4.3.3, this function experienced trouble when using arrays as both <em>find</em> 
	and <em>replace</em> parameters, which caused empty <em>find</em> indexes to 
	be skipped without advancing the internal pointer on the <em>replace</em> 
	array. Newer versions will not have this problem.<br><br>As of PHP 4.0.5, 
	most of the parameters can now be an array</td>
</tr>
</table>
<br>
<hr>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_replace2">Run example &raquo;</a>
</div>
<br>
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_str_replace3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_str_replace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_str_replace.asp#top" target="_top">TOP</a> |
		<a href="func_string_str_replace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
