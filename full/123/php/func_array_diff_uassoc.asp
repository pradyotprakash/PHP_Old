...
<title>PHP array_diff_uassoc() Function</title>
<style>a.menu_func_array_diff_uassoc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_diff_uassoc()</span> Function</h1>
...
<p>Compare the<strong> keys and values</strong> of two arrays (use a user-defined 
...
<div class="example_code notranslate">
	...
	<br>$result=array_diff_uassoc($a1,$a2,&quot;myfunction&quot;);<br>print_r($result);<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff_uassoc">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_diff_uassoc() function compares <strong>the keys and values</strong> 
...
the keys!</p>
<p>This function compares the keys and values of two (or more) arrays, and return an array that contains the entries from <em>
array1</em> that are not present in <em>
array2 </em>or <em>array3</em>, etc.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>

array_diff_uassoc(<em>array1,array2,array3...,myfunction</em>);</div></div>
<br>
...
<p>Compare the<strong> keys and values</strong> of three arrays (use a user-defined 
function to compare the keys), and return the differences:</p>
<div class="example_code notranslate">
	&lt;?php<br>function myfunction($a,$b)<br>{<br>if ($a===$b)<br>&nbsp; {<br>&nbsp; 
	return 0;<br>&nbsp; }<br>&nbsp; return ($a&gt;$b)?1:-1;<br>}<br><br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;);<br>$a2=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;d&quot;=&gt;&quot;blue&quot;);<br>
	$a3=array(&quot;e&quot;=&gt;&quot;yellow&quot;,&quot;a&quot;=&gt;&quot;red&quot;,&quot;d&quot;=&gt;&quot;blue&quot;);<br><br>$result=array_diff_uassoc($a1,$a2,$a3,&quot;myfunction&quot;);<br>
	print_r($result);<br>
	?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_diff_uassoc2">Run example &raquo;</a>
</div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_diff_uassoc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_diff_uassoc.asp#top" target="_top">TOP</a> |
		<a href="func_array_diff_uassoc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
