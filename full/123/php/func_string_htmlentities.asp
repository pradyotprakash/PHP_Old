...
<title>PHP htmlentities() Function</title>
<style>a.menu_func_string_htmlentities{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">htmlentities()</span> Function</h1>
...
<p>Convert some characters to HTML entities: </p>
<div class="example_code notranslate">
	&lt;?php<br>$str = &quot;&lt;© W3Sçh°°¦§&gt;&quot;;<br>echo htmlentities($str);<br>
	?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
&lt;body&gt;<br>
	&amp;lt;&amp;copy; W3S&amp;ccedil;h&amp;deg;&amp;deg;&amp;brvbar;&amp;sect;&amp;gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;

</div>
<p>The browser output of the code above will be:</p>
<div class="example_code notranslate">

	&lt;© W3Sçh°°¦§&gt;</div>
<br>
<a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_htmlentities">Run example &raquo;</a>
</div>
<hr>
...
<p><strong>Tip:</strong> To convert HTML entities back to characters, use the
<a href="func_string_html_entity_decode.asp">html_entity_decode()</a> function.</p>
<p><strong>Tip:</strong> Use the
<a href="func_string_get_html_translation_table.asp">
get_html_translation_table()</a> function to return the translation table used 
by htmlentities(). </p>
<hr>
<h2>Syntax</h2>
...
htmlentities(<em>string,flags,character-set,double_encode</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to convert</td>
  </tr>
	<tr>
    <td><em>flags</em></td>
    <td>Optional. Specifies how to handle quotes, invalid encoding 
	and the used document type.<p>The available quote styles 
	are:</p>
	<ul>
		<li>ENT_COMPAT - Default. Encodes only double quotes</li>
		<li>ENT_QUOTES - Encodes double and single quotes</li>
		<li>ENT_NOQUOTES - Does not encode any quotes</li>
	</ul>
	<p>Invalid encoding:</p>
	<ul>
		<li>ENT_IGNORE - Ignores invalid encoding instead of having the function 
		return an empty string. Should be avoided, as it may have security 
		implications.</li>
		<li>ENT_SUBSTITUTE - Replaces invalid encoding for a specified character 
		set with a Unicode Replacement Character U+FFFD (UTF-8) or &amp;#FFFD; 
		instead of returning an empty string.</li>
		<li>ENT_DISALLOWED - R<span lang="no-bok">eplaces code points that are 
		invalid in the specified doctype with a Unicode Replacement Character 
		U+FFFD (UTF-8) or &amp;#FFFD;</span></li>
	</ul>
		<p>Additional flags for specifying the used doctype:</p>
	<ul>
		<li>ENT_HTML401 - Default. Handle code as HTML 4.01</li>
		<li>ENT_HTML5 - Handle code as HTML 5</li>
		<li>ENT_XML1 - Handle code as XML 1</li>
		<li>ENT_XHTML - Handle code as XHTML</li>
	</ul>
		</td>
  </tr>
  <tr>
    ...
    <td>Optional. A boolean value that specifies whether to encode existing html 
	entities or not. <ul>
		<li>TRUE - Default. Will convert everything</li>
		<li>FALSE - Will not encode existing html entities</li>
	</ul>
	</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns the converted string<br><br><span lang="no-bok">If 
	the <em>string</em> contains invalid encoding, it will return an empty 
	string, unless either the ENT_IGNORE or ENT_SUBSTITUTE flags are set</span></td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	...
	to UTF-8 in PHP 5<br><br>ENT_SUBSTITUTE, ENT_DISALLOWED, ENT_HTML401, ENT_HTML5, 
	ENT_XML1 and ENT_XHTML were added in PHP 5.4<br><br>ENT_IGNORE was added in 
	PHP 5.3<br><br>The <em>double_encode</em> parameter was added in PHP 5.2.3<br>
	<br>The <em>character-set</em> parameter was added in PHP 4.1</td>
</tr>
</table>
<br>
<hr>
...
&lt;?php<br>
$str = &quot;Jane &amp; 'Tarzan'&quot;;<br>
echo htmlentities($str, ENT_COMPAT); // Will only convert double quotes<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo htmlentities($str, ENT_QUOTES); // Converts double and single quotes<br>
echo &quot;&lt;br&gt;&quot;;<br>
echo htmlentities($str, ENT_NOQUOTES); // Does not convert any quotes<br>
?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
...
<br>
<a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_htmlentities2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Convert some characters to HTML entities using the Western European 
character-set: </p>
	<div class="example_code notranslate">
		&lt;?php<br>$str = &quot;My name is Øyvind Åsane. I'm Norwegian.&quot;;<br>echo 
...
<p>The HTML output of the code above will be (View Source):</p>
<div class="example_code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br>My name is &amp;Oslash;yvind 
	&amp;Aring;sane. I&amp;#039;m Norwegian.<br>&lt;/body&gt;<br>&lt;/html&gt;

</div>
<p>The browser output of the code above will be:</p>
<div class="example_code notranslate">

	My name is Øyvind Åsane. I'm Norwegian.</div>
<br>
<a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_htmlentities3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_htmlentities.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_htmlentities.asp#top" target="_top">TOP</a> |
		<a href="func_string_htmlentities.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
