...
<title>PHP setcookie() Function</title>
<style>a.menu_func_http_setcookie{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">setcookie()</span> Function</h1>
<hr>
...
<p>The setcookie() function sends an HTTP cookie to a client.</p>
...
<p><b>Note:</b> The value of the cookie will automatically be URL encoded when 
you send the cookie (and automatically decoded when received). If 
you don't want this, you can use setrawcookie() instead.</p>
<hr>
<h2>Example 1</h2>
...
setcookie(&quot;TestCookie&quot;,$value, time()+3600*24);<br>
?&gt;<br>
<br>
&lt;html&gt;<br>
&lt;body&gt;<br>
...
setcookie(&quot;cookie[one]&quot;,&quot;cookieone&quot;);<br>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_http_setcookie.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_http_setcookie.asp#top" target="_top">TOP</a> |
		<a href="func_http_setcookie.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
