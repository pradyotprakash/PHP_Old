...
<title>PHP fseek() Function</title>
<style>a.menu_func_filesystem_fseek{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fseek()</span> Function</h1>
<hr>
...
<p>The fseek() function seeks in an open file.</p>
<p>This function moves the file pointer from its current position to a new 
position, forward or backward, specified by the number of bytes.</p>
<p>This function returns 0 on success, or -1 on failure. Seeking past EOF will 
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies the open file to seek in</td>
  </tr>
  <tr>
    <td>offset</td>
    <td>Required. Specifies the new position (measured in bytes 
	from the beginning of the file)</td>
  </tr>
  <tr>
    <td>whence</td>
    <td>Optional. (added in PHP 4). Possible values:<ul>
		<li>SEEK_SET - Set position equal to offset. Default</li>
		<li>SEEK_CUR - Set position to current location plus offset</li>
		<li>SEEK_END - Set position to EOF plus offset (to move 
		to a position before EOF, the offset must be a negative value)</li>
	</ul>
	</td>
  </tr>
  </table>
...
<p><b>Tip:</b> Find the current position by using ftell()!</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fseek.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fseek.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fseek.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
