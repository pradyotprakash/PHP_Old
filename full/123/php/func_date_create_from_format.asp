...
<title>PHP date_create_from_format() Function</title>
<style>a.menu_func_date_create_from_format{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">date_create_from_format()</span> Function</h1>
...
<p>Return a new DateTime object formatted according to the specified format:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$date=date_create_from_format(&quot;j-M-Y&quot;,&quot;15-Mar-2013&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date_create_from_format">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date_create_from_format() function returns a new DateTime object formatted according to 
the specified format.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date_create_from_format(<em>format,time,timezone);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the format to use. The following characters can be 
	used in the <em>format</em> parameter string:
	<ul>
		<li>d - Day of the month; with leading zeros</li>
		<li>j - Day of the month; without leading zeros</li>
		<li>D - Day of the month (Mon - Sun)</li>
		<li>l - Day of the month (Monday - Sunday)</li>
		<li>S - English suffix for day of the month (st, nd, rd, th)</li>
		<li>F - Monthname (January - December)</li>
		<li>M - Monthname (Jan-Dec)</li>
		<li>m - Month (01-12)</li>
		<li>n - Month (1-12)</li>
		<li>Y - Year (e.g 2013)</li>
		<li>y - Year (e.g 13)</li>
		<li>a and A - am or pm</li>
		<li>g - 12 hour format with leading zeros</li>
		<li>h - 12 hour format without leading zeros</li>
		<li>G - 24 hour format with leading zeros</li>
		<li>H - 12 hour format without leading zeros</li>
		<li>i - Minutes with leading zeros</li>
		<li>s - Seconds with leading zeros</li>
		<li>u - Microseconds (up to six digits)</li>
		<li>e, O, P and T - Timezone identifier</li>
		<li>U - Seconds since Unix Epoch</li>
		<li>(space)</li>
		<li># - One of the following separation symbol: ;,:,/,.,,,-,(,)</li>
		<li>? - A random byte</li>
		<li>* - Rondom bytes until next separator/digit</li>
		<li>! - Resets all fields to Unix Epoch</li>
		<li>| - Resets all fields to Unix Epoch if they have not been parsed yet</li>
		<li>+ - If present, trailing data in the string will cause a warning, 
		not an error</li>
	</ul>
	  </td>
  </tr>
  <tr>
    <td><em>time</em></td>
    <td>Required. Specifies a date/time string. NULL indicates the current date/time</td>
  </tr>
  <tr>
    <td><em>timezone</em></td>
    <td>Optional. Specifies the timezone of <em>time</em>. Default is the 
	current timezone</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns a new DateTime object on success. FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.3+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_create_from_format.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_create_from_format.asp#top" target="_top">TOP</a> |
		<a href="func_date_create_from_format.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
