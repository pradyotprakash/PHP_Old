...
<title>PHP ftp_fget() Function</title>
<style>a.menu_func_ftp_fget{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_fget()</span> Function</h1>
...
<p>Download a file from the FTP server, and save it to an open local file:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	&quot;local.txt&quot;;<br>$fp = fopen($local_file,&quot;w&quot;);<br><br>// download server file 
	and save it to open local file<br>if (ftp_get($ftp_conn, 
	$fp, $server_file, FTP_ASCII, 0))<br>&nbsp; {<br>&nbsp; echo &quot;Successfully 
	written to $local_file.&quot;;<br>&nbsp; }<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error 
	downloading 
	$server_file.&quot;;<br>&nbsp; }<br><br>// close connection and file 
...
<p>The ftp_fget() function gets (downloads) a file from the FTP server, and saves it 
into an open local file.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_fget(<em>ftp_connection,open_file,server_file,mode,startpos</em>);</div></div>
<br>
...
<tr>
	<th>PHP Changelog:</th>
	<td>The <em>startpos</em> parameter was added in PHP 4.3.0</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_fget.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_fget.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_fget.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
