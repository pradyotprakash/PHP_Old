...
<title>PHP mysqli_more_results() Function</title>
<style>a.menu_func_mysqli_more_results{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_more_results()</span> Function</h1>
...
<p>The mysqli_more_results() function checks if there are any more results from a multi query.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_more_results(<em>connection</em>)<em>;</em></div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_more_results.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_more_results.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_more_results.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
