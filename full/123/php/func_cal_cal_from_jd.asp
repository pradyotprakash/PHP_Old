...
<title>PHP cal_from_jd() Function</title>
<style>a.menu_func_cal_cal_from_jd{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">cal_from_jd()</span> Function</h1>
...
<p>Convert a Julian Day Count into a date of in the Gregorian calendar:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$d=unixtojd(mktime(0,0,0,6,20,2007));<br>
	print_r(cal_from_jd($d,CAL_GREGORIAN));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_cal_from_jd">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cal_from_jd() function converts a Julian Day Count into a date of a specified calendar.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	cal_from_jd(<em>jd,calendar);</em></div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>jd</em></td>
    <td>Required. Specifies a Julian Day as an integer</td>
  </tr>
  <tr>
    <td><em>calendar</em></td>
    <td>Required. Specifies the calendar to convert to. Must be one of the 
	following values:
	<ul>
		<li>CAL_GREGORIAN</li>
		<li>CAL_JULIAN</li>
...
<tr>
	...
	<td style="width:80%">Returns an array that contains calendar information like:
	<ul>
		<li>date in form &quot;month/day/year&quot;</li>
		<li>month</li>
		<li>year</li>
		<li>day of week</li>
		<li>abbreviated and full names of weekday and 
	month</li>
	</ul>
	</td>
</tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_cal_from_jd.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_cal_from_jd.asp#top" target="_top">TOP</a> |
		<a href="func_cal_cal_from_jd.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
