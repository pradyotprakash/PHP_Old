...
<title>PHP mysqli_commit() Function</title>
<style>a.menu_func_mysqli_commit{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_commit()</span> Function</h1>
...
<p>The mysqli_commit() function commits the current transaction for the specified database connection.</p>
<p><strong>Tip:</strong> Also look at the <a href="func_mysqli_autocommit.asp">mysqli_autocommit()</a> function,
which turns on or off auto-committing database modifications, and the
<a href="func_mysqli_rollback.asp">mysqli_rollback()</a> function, which rolls back the current transaction.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_commit(<em>connection</em>)<em>;</em></div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_commit.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_commit.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_commit.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
