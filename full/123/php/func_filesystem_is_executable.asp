...
<title>PHP is_executable() Function</title>
<style>a.menu_func_filesystem_is_executable{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">is_executable()</span> Function</h1>
<hr>
...
<p>The is_executable() function checks whether the specified file is executable.</p>
<p>This function returns TRUE if the file is executable.</p>
<h2>Syntax</h2>
...
clear the cache.</p>
<p><b>Note:</b> The is_executable() function became available with Windows in 
PHP 5.0</p>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_is_executable.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_is_executable.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_is_executable.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
