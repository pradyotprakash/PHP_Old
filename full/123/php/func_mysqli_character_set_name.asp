...
<title>PHP mysqli_character_set_name() Function</title>
<style>a.menu_func_mysqli_character_set_name{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_character_set_name()</span> Function</h1>
...
<p>Return the default character set for the database connection:</p>
...
&nbsp;&nbsp;}<br><br>$charset=mysqli_character_set_name($con);<br>echo &quot;Default 
	character set is: &quot; . $charset;<br><br>mysqli_close($con);<br>
?&gt;
</div>
</div>
<hr>
...
<p>The mysqli_character_set_name() function returns the default character set for the database connection.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_character_set_name(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">The default character set for the specified connection</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_character_set_name.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_character_set_name.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_character_set_name.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
