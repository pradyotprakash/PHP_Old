...
<style>a.menu_func_array_map{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_map()</span> Function</h1>
...
<p>Send each value of an array to a function, multiply each value by itself, and 
return an array with the new values:</p>
<div class="example_code notranslate">
&lt;?php<br>
	function myfunction($v)<br>{<br>&nbsp; return($v*$v);<br>}<br><br>
	$a=array(1,2,3,4,5);<br>print_r(array_map(&quot;myfunction&quot;,$a));<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_map">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_map() function sends each value of an array to a user-made function,
and returns an array with new values, given by the user-made function.</p>
<p><b>Tip:</b> You can assign one array to the function, or as many as you like.</p>

<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
array_map(<em>myfunction,array1,array2,array3</em>...)
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>myfunction</em></td>
    <td>Required. The name of the user-made function, or null</td>
  </tr>
  <tr>
    <td><em>array1</em></td>
...
<tr>
	...
	<td style="width:80%">Returns an array containing the values 
	of <em>array1</em>, after applying the user-made function to each one</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0.6+</td>
...
<p>Using a user-made function to change the values of an array:</p>
<div class="example_code notranslate">
&lt;?php<br>
	function myfunction($v)<br>{<br>if ($v===&quot;Dog&quot;)<br>&nbsp; {<br>&nbsp; return 
	&quot;Fido&quot;;<br>&nbsp; }<br>return $v;<br>}<br><br>$a=array(&quot;Horse&quot;,&quot;Dog&quot;,&quot;Cat&quot;);<br>
	print_r(array_map(&quot;myfunction&quot;,$a));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_map2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Using two arrays:</p>
<div class="example_code notranslate">
&lt;?php<br>
	function myfunction($v1,$v2)<br>{<br>if ($v1===$v2)<br>&nbsp; {<br>&nbsp; 
	return &quot;same&quot;;<br>&nbsp; }<br>return &quot;different&quot;;<br>}<br><br>$a1=array(&quot;Horse&quot;,&quot;Dog&quot;,&quot;Cat&quot;);<br>
	$a2=array(&quot;Cow&quot;,&quot;Dog&quot;,&quot;Rat&quot;);<br>print_r(array_map(&quot;myfunction&quot;,$a1,$a2));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_map3">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 3</h2>
<p>Change all letters of the array values to uppercase:</p>
<div class="example_code notranslate">
&lt;?php<br>
	function myfunction($v) <br>{<br>$v=strtoupper($v);<br>&nbsp; return $v;<br>
	}<br><br>$a=array(&quot;Animal&quot; =&gt; &quot;horse&quot;, &quot;Type&quot; =&gt; &quot;mammal&quot;);<br>print_r(array_map(&quot;myfunction&quot;,$a));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_map4">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 4</h2>
<p>Assign null as the function name:</p>
<div class="example_code notranslate">
	&lt;?php<br>$a1=array(&quot;Dog&quot;,&quot;Cat&quot;);<br>
$a2=array(&quot;Puppy&quot;,&quot;Kitten&quot;);<br>
print_r(array_map(null,$a1,$a2));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_map5">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_map.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_map.asp#top" target="_top">TOP</a> |
		<a href="func_array_map.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
