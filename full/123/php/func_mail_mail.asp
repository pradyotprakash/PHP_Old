...
<style>a.menu_func_mail_mail{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mail()</span> Function</h1>
<p><a href="php_ref_mail.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Mail Reference" /> PHP Mail Reference</a></p>
<div class="example">
<h2 class="example">Example</h2>
<p>Send a simple email:</p>
<div class="example_code notranslate">
&lt;?php<br>// the message<br>$msg = &quot;First line of text\nSecond line of text&quot;;<br>
<br>
// use wordwrap() if lines are longer than 70 characters<br>
...
mail(<em>to,subject,message,headers,parameters</em>);</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>message</em></td>
    <td>Required. Defines the message to be sent. Each line should be separated with a LF (\n).
    Lines should not exceed 70 characters.
	<p><b>Windows note:</b> If a full stop is found on the beginning 
	of a line in the message, it might be removed. To solve this problem, replace the 
	full stop with a double dot:<br>
	&lt;?php<br>
	$txt = str_replace(&quot;\n.&quot;, &quot;\n..&quot;, $txt);<br>
	?&gt;</p></td>
  </tr>
  <tr>
	...
	<p><b>Note:</b> When sending an email, it must contain a From header.
	This can be set with this parameter or in the php.ini file.</p></td>
  </tr>
  <tr>
    <td><em>parameters</em></td>
    <td>Optional. Specifies an additional parameter to the sendmail program
...
<tr>
	...
	<td style="width:80%">Returns the hash value of the <em>address</em> 
	parameter, or FALSE on failure. <b>Note:</b> Keep in mind that even if the 
	email was accepted for delivery, it does NOT mean the email is actually sent 
	and received!
	</td>
</tr>
<tr>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 4.3.0: (Windows only) All custom headers (like From, Cc, Bcc and 
	Date) are supported, and are not case-sensitive.<br>PHP 4.2.3: The <em>
	parameter</em> parameter is disabled in safe mode<br>PHP 4.0.5: The <em>
	parameter</em> parameter was added </td>
</tr>
</table>
<br>
<hr>
...
<h2>Example 2</h2>
<p>Send an email with extra headers:</p>
<div class="code notranslate"><div>

&lt;?php<br>
$to = &quot;somebody@example.com&quot;;<br>
...
&lt;?php<br>
$to = &quot;somebody@example.com, somebodyelse@example.com&quot;;<br>
...
&lt;/head&gt;<br>
&lt;body&gt;<br>
&lt;p&gt;This email contains HTML Tags!&lt;/p&gt;<br>
&lt;table&gt;<br>
&lt;tr&gt;<br>
&lt;th&gt;Firstname&lt;/th&gt;<br>
&lt;th&gt;Lastname&lt;/th&gt;<br>
...
&quot;;<br>
<br>
// Always set content-type when sending HTML email<br>
...
<hr>
<a href="php_ref_mail.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Mail Reference" /> Complete PHP Mail Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mail_mail.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mail_mail.asp#top" target="_top">TOP</a> |
		<a href="func_mail_mail.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
