...
<title>PHP flock() Function</title>
<style>a.menu_func_filesystem_flock{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">flock()</span> Function</h1>
<hr>
...
<p>The flock() function locks or releases a file.</p>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td>file</td>
    <td>Required. Specifies an open file to lock or release</td>
  </tr>
  <tr>
    <td>lock</td>
    <td>Required. Specifies what kind of lock to use.<p>Possible 
	values:</p>
	<ul>
		<li>LOCK_SH - Shared lock (reader). Allow other processes to access the 
		file</li>
		<li>LOCK_EX - Exclusive lock (writer). Prevent other 
		processes from accessing the file</li>
		<li>LOCK_UN - Release a shared or exclusive lock</li>
		<li>LOCK_NB - Avoids blocking other processes while locking</li>
	</ul>
	</td>
  </tr>
  <tr>
    <td>block</td>
    <td>Optional. Set to 1 to block other processes while locking</td>
  </tr>
  </table>
<br>
<hr>
...
<p><b>Note:</b> These locks only apply to the current PHP process. Other 
processes can modify or delete a PHP-locked file if permissions allow.</p>
<p><b>Note:</b> flock() is mandatory under Windows.</p>
<p><b>Tip:</b> The lock is released also by fclose(), which is called automatically when 
...
<br>
// exclusive lock<br>
if (flock($file,LOCK_EX))<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;fwrite($file,&quot;Write something&quot;);<br>
&nbsp;&nbsp;// release lock<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_flock.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_flock.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_flock.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
