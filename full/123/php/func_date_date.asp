...
<style>a.menu_func_date_date{font-weight:bold;}</style>
<meta charset="utf-8">
...
<p>Format a local date and time and return the formatted date strings:</p>
<div class="example_code notranslate">
&lt;?php<br>
	// Prints the day<br>echo date(&quot;l&quot;) . &quot;&lt;br&gt;&quot;;<br><br>// Prints the day, 
	date, month, year, time, AM or PM<br>echo date(&quot;l jS \of F Y h:i:s A&quot;);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_date">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The date() function formats a local date and time, and returns the formatted date string.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
date(<em>format,timestamp);</em></div></div>
<br>
...
<tr>
	<th>Changelog:</th>
	<td>PHP 5.1.0: Added E_STRICT and E_NOTICE time zone errors. Valid range of 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_date.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_date.asp#top" target="_top">TOP</a> |
		<a href="func_date_date.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
