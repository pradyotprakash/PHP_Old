...
<style>a.menu_func_ftp_alloc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_alloc()</span> Function</h1>
...
<p>Allocate space for a file and upload file to the FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$file = 
	&quot;/test/myfile&quot;;<br><br>// allocate space<br>if (ftp_alloc($ftp_conn, filesize($file), 
	$result))<br>&nbsp; {<br>&nbsp; echo &quot;Space allocated on server. Sending 
	$file.&quot;;<br>&nbsp; ftp_put($ftp_conn, &quot;/files/myfile&quot;, $file, FTP_BINARY);<br>&nbsp; 
	}<br>else<br>&nbsp; {<br>&nbsp; echo &quot;Error! Server said: 
	$result&quot;;<br>&nbsp; }<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ftp_alloc() function allocates space for a file to be uploaded to the FTP server.</p>
<p><b>Note:</b> Many FTP servers do not support this command!</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_alloc(<em>ftp_connection,filesize,result</em>);</div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the number of bytes to allocate</td>
  </tr>
	<tr>
    <td><em>result</em></td>
    <td>Optional. Specifies a variable to store the server response in</td>
  </tr>
</table>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_alloc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_alloc.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_alloc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
