...
<title>PHP array_merge() Function</title>
<style>a.menu_func_array_merge{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_merge()</span> Function</h1>
...
<p>Merge two arrays into one array:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;red&quot;,&quot;green&quot;);<br>$a2=array(&quot;blue&quot;,&quot;yellow&quot;);<br>print_r(array_merge($a1,$a2));<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_merge">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_merge() function merges one or more arrays into one array.</p>
<p><b>Tip:</b> You can assign one array to the function, or as many as you like.</p>
<p><b>Note:</b> If two or more array elements have the same key, the last one overrides the others.</p>
<p><b>Note:</b> If you assign only one array to the array_merge() function, and the keys are integers,
the function returns a new array with integer keys starting at 0 and increases by 1 for each value (See 
Example 
1 below).</p>
<p><strong>Tip:</strong> The difference between this function and the
<a href="func_array_merge_recursive.asp">array_merge_recursive()</a> function is 
when two or more array elements have the same key. Instead of override the keys, 
the array_merge_recursive() function makes the value as an array.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
array_merge(<em>array1,array2,array3...</em>)
</div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns the merged array</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 5.0, this function only accept parameters of type array</td>
</tr>
</table>
<br>
<hr>
...
<p>Merge two associative arrays into one array:</p>
<div class="example_code notranslate">
&lt;?php<br>
$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;);<br>
$a2=array(&quot;c&quot;=&gt;&quot;blue&quot;,&quot;b&quot;=&gt;&quot;yellow&quot;);<br>
print_r(array_merge($a1,$a2));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_merge2">Run example &raquo;</a>
</div>
<br>
<div class="example">
<h2 class="example">Example 2</h2>
<p>Using only one array parameter with integer keys:</p>
<div class="example_code notranslate">
&lt;?php<br>
$a=array(3=&gt;&quot;red&quot;,4=&gt;&quot;green&quot;);<br>
print_r(array_merge($a));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_merge3">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_merge.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_merge.asp#top" target="_top">TOP</a> |
		<a href="func_array_merge.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
