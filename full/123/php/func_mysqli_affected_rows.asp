...
<title>PHP mysqli_affected_rows() Function</title>
<style>a.menu_func_mysqli_affected_rows{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_affected_rows()</span> Function</h1>
...
<p>Print out affected rows from different queries:</p>
...
&nbsp;&nbsp;}<br><br>// Perform queries and print out affected rows<br>mysqli_query($con,&quot;SELECT * 
	FROM Persons&quot;);<br>echo &quot;Affected rows: &quot; . mysqli_affected_rows($con);<br><br>
mysqli_query($con,&quot;DELETE FROM Persons WHERE Age&gt;32&quot;);<br>echo &quot;Affected 
	rows: &quot; . mysqli_affected_rows($con);<br>
...
<p>The mysqli_affected_rows() function returns the number of affected rows in the previous 
SELECT, INSERT, UPDATE, REPLACE, or DELETE query.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_affected_rows(<em>connection</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">An integer &gt; 0 indicates the number of rows affected. 0 
	indicates that no records where affected. -1 indicates that the query 
	returned an error</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_affected_rows.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_affected_rows.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_affected_rows.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
