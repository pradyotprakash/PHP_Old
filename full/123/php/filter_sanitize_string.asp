...
<title>PHP FILTER_SANITIZE_STRING Filter</title>
<style>a.menu_filter_sanitize_string{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">FILTER_SANITIZE_STRING</span> Filter</h1>
<hr>
...
<p>The FILTER_SANITIZE_STRING filter strips or encodes unwanted characters.</p>
...
<ul>
	...
	<li>FILTER_FLAG_STRIP_HIGH - Strip characters with ASCII value above 127</li>
	<li>FILTER_FLAG_ENCODE_LOW - Encode characters with ASCII value below 32</li>
	<li>FILTER_FLAG_ENCODE_HIGH - Encode characters with ASCII value above 127</li>
...
<br>
var_dump(filter_var($var, FILTER_SANITIZE_STRING));<br>
?&gt;
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="filter_sanitize_string.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="filter_sanitize_string.asp#top" target="_top">TOP</a> |
		<a href="filter_sanitize_string.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
