...
<title>PHP array_splice() Function</title>
<style>a.menu_func_array_splice{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_splice()</span> Function</h1>
...
<p>Remove elements from an array and replace it with new elements:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;,&quot;d&quot;=&gt;&quot;yellow&quot;);<br>
	$a2=array(&quot;a&quot;=&gt;&quot;purple&quot;,&quot;b&quot;=&gt;&quot;orange&quot;);<br>array_splice($a1,0,2,$a2);<br>
	print_r($a1);<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_splice">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The array_splice() function removes selected elements from an array and 
replaces it with new elements. The function also returns an array with the 
removed elements.</p>

<p><b>Tip:</b> If the function does not remove any elements (length=0), the 
replaced array will be inserted from the position of the start parameter (See 
Example 2).</p>
<p><b>Note:</b> The keys in the replaced array are not preserved.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
array_splice(<em>array,start,length,array</em>)
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>start</em></td>
    <td>Required. Numeric value. Specifies where the function will start 
    removing elements.
    0 = the first element.
  ...
  <tr>
    <td><em>length</em></td>
    <td>Optional. Numeric value. Specifies how many elements will 
  ...
  <tr>
    <td><em>array</em></td>
    <td>Optional. Specifies an array with the elements that will be 
    inserted to the original array. If it's only one element, it can be a 
    string, and does not have to be an array.</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns the array consisting of the extracted elements</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<p>The same example as the example on top of the page, but the output is the returned array:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;,&quot;c&quot;=&gt;&quot;blue&quot;,&quot;d&quot;=&gt;&quot;yellow&quot;);<br>
	$a2=array(&quot;a&quot;=&gt;&quot;purple&quot;,&quot;b&quot;=&gt;&quot;orange&quot;);<br>print_r(array_splice($a1,0,2,$a2));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_splice2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>With the length parameter set to 0:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;0&quot;=&gt;&quot;red&quot;,&quot;1&quot;=&gt;&quot;green&quot;);<br>
	$a2=array(&quot;0&quot;=&gt;&quot;purple&quot;,&quot;1&quot;=&gt;&quot;orange&quot;);<br>array_splice($a1,1,0,$a2);<br>
	print_r($a1);<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_splice3">Run example &raquo;</a>
</div>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_splice.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_splice.asp#top" target="_top">TOP</a> |
		<a href="func_array_splice.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
