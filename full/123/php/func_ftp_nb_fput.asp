...
<title>PHP ftp_nb_fput() Function</title>
<style>a.menu_func_ftp_nb_fput{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_nb_fput()</span> Function</h1>
...
<p>Open local file, and upload it (non-blocking) to a file on the FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	&quot;serverfile.txt&quot;;<br><br>// open local file<br>$local_file = 
	&quot;localfile.txt&quot;;<br>$fp = fopen($local_file,&quot;r&quot;);<br><br>// initiate 
	upload<br>$d = ftp_nb_fput($ftp_conn, 
	$server_file, $fp, FTP_BINARY)<br><br>while ($d == FTP_MOREDATA)<br>&nbsp; 
...
<p>The ftp_nb_fput() function uploads an open local file to the FTP server (non-blocking).</p>
...
ftp_nb_fput(<em>ftp_connection,remote_file,open_file,mode,startpos</em>);
</div></div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_nb_fput.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_nb_fput.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_nb_fput.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
