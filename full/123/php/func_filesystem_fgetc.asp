...
<title>PHP fgetc() Function</title>
<style>a.menu_func_filesystem_fgetc{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">fgetc()</span> Function</h1>
<hr>
...
<p>The fgetc() function returns a single character from an open file.</p>
<h2>Syntax</h2>
...
<p><b>Note:</b> This function is slow and should not be used on large files. If 
...
<h2>Example 2</h2>
<p>Read file character by character:</p>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_fgetc.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_fgetc.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_fgetc.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
