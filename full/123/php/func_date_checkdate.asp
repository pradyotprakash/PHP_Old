...
<title>PHP checkdate() Function</title>
<style>a.menu_func_date_checkdate{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">checkdate()</span> Function</h1>
...
<p>Check if several dates are valid Gregorian dates:</p>
<div class="example_code notranslate">
&lt;?php<br>
	var_dump(checkdate(12,31,-400));<br>echo &quot;&lt;br&gt;&quot;;<br>
	var_dump(checkdate(2,29,2003));<br>echo &quot;&lt;br&gt;&quot;;<br>
	var_dump(checkdate(2,29,2004));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_checkdate">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The checkdate() function is used to validate a Gregorian date.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
checkdate(<em>month,day,year);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>month</em></td>
    <td>Required. Specifies the month as a number between 1 and 12</td>
  </tr>
  <tr>
    <td><em>day</em></td>
    <td>Required. Specifies the day as a number between 1 and 31</td>
  </tr>
  <tr>
    <td><em>year</em></td>
    <td>Required. Specifies the year as a number between 1 and 32767</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">TRUE if the date is valid. FALSE otherwise</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_date_checkdate.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_date_checkdate.asp#top" target="_top">TOP</a> |
		<a href="func_date_checkdate.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
