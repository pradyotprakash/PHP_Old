...
<title>PHP cal_days_in_month() Function</title>
<style>a.menu_func_cal_cal_days_in_month{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">cal_days_in_month()</span> Function</h1>
...
<p>Get the number of days in a month for a specified year and calendar:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$d=cal_days_in_month(CAL_GREGORIAN,10,2005);<br>echo &quot;There was $d days in 
	October 2005&quot;;<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_cal_days_in_month">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cal_days_in_month() function returns the number of days in a month for a specified year and calendar.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
	cal_days_in_month(<em>calendar,month,year);</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the calendar to use. Look at the
	<a href="php_ref_calendar.asp">PHP Calendar Constants</a></td>
  </tr>
  <tr>
    <td><em>month</em></td>
    <td>Required. Specifies the month in the selected calendar</td>
  </tr>
  <tr>
    <td><em>year</em></td>
    <td>Required. Specifies the year in the selected calendar</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">The number of days in the selected month, in the given 
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_cal_cal_days_in_month.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_cal_cal_days_in_month.asp#top" target="_top">TOP</a> |
		<a href="func_cal_cal_days_in_month.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
