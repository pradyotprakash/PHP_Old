...
<html lang="en-US">
<head>
<title>PHP 5 Calendar Functions</title>
<style>a.menu_php_ref_calendar{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Calendar</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_array.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_date.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP Calendar Introduction</h2>
<p>The calendar extension contains functions that simplifies converting between different calendar formats.</p>
<p><strong>It is based on the Julian Day Count, which is a count of days starting from January 1st, 4713 B.C.</strong></p>
<p><strong>Note:</strong> To convert between calendar formats, you must first convert to Julian Day Count, then to the calendar of your choice.</p>
<p><strong>Note:</strong> The Julian Day Count is not the same as the Julian Calendar!</p>
<hr>
...
<h2>PHP 5 Calendar Functions</h2>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><a href="func_cal_cal_days_in_month.asp">cal_days_in_month()</a></td>
    <td>Returns the number of days in a month for a specified year and 
	calendar</td>
  </tr>
  <tr>
    <td><a href="func_cal_cal_from_jd.asp">cal_from_jd()</a></td>
    <td>Converts a Julian Day Count into a date of a specified 
	calendar</td>
  </tr>
  <tr>
    <td><a href="func_cal_cal_info.asp">cal_info()</a></td>
    <td>Returns information about a specified calendar</td>
  </tr>
  <tr>
    <td><a href="func_cal_cal_to_jd.asp">cal_to_jd()</a></td>
    <td>Converts a date in a specified calendar to Julian Day Count</td>
  </tr>
  <tr>
    <td><a href="func_cal_easter_date.asp">easter_date()</a></td>
    <td>Returns the Unix timestamp for midnight on Easter of a 
	specified 
	year</td>
  </tr>
  <tr>
    <td><a href="func_cal_easter_days.asp">easter_days()</a></td>
    <td>Returns the number of days after March 21, that the Easter 
	Day is in a specified year</td>
  </tr>
  <tr>
    <td><a href="func_cal_frenchtojd.asp">frenchtojd()</a></td>
    <td>Converts a French Republican date to a 
	Julian Day Count</td>
  </tr>
  <tr>
    <td><a href="func_cal_gregoriantojd.asp">gregoriantojd()</a></td>
    <td>Converts a Gregorian date to a Julian Day Count</td>
  </tr>
  <tr>
    <td><a href="func_cal_jddayofweek.asp">jddayofweek()</a></td>
    <td>Returns the day of the week</td>
  </tr>
  <tr>
    <td><a href="func_cal_jdmonthname.asp">jdmonthname()</a></td>
    <td>Returns a month name</td>
  </tr>
  <tr>
    <td><a href="func_cal_jdtofrench.asp">jdtofrench()</a></td>
    <td>Converts a Julian Day Count to a French Republican 
	date</td>
  </tr>
  <tr>
    <td><a href="func_cal_jdtogregorian.asp">jdtogregorian()</a></td>
    <td>Converts a Julian Day Count to a Gregorian date</td>
  </tr>
  <tr>
    <td><a href="func_cal_jdtojewish.asp">jdtojewish()</a></td>
    <td>Converts a Julian Day Count to a Jewish date</td>
  </tr>
  <tr>
    <td><a href="func_cal_jdtojulian.asp">jdtojulian()</a></td>
    <td>Converts a Julian Day Count to a Julian date</td>
  </tr>
  <tr>
    <td><a href="func_cal_jdtounix.asp">jdtounix()</a></td>
    <td>Converts Julian Day Count to Unix timestamp</td>
  </tr>
  <tr>
    <td><a href="func_cal_jewishtojd.asp">jewishtojd()</a></td>
    <td>Converts a Jewish date to a Julian Day Count</td>
  </tr>
  <tr>
    <td><a href="func_cal_juliantojd.asp">juliantojd()</a></td>
    <td>Converts a Julian date to a Julian Day Count</td>
  </tr>
  <tr>
    <td><a href="func_cal_unixtojd.asp">unixtojd()</a></td>
    <td>Converts Unix timestamp to Julian Day Count</td>
  </tr>
</table>

<h2>PHP 5 Predefined Calendar Constants</h2>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_calendar.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_calendar.asp#top" target="_top">TOP</a> |
		<a href="php_ref_calendar.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
