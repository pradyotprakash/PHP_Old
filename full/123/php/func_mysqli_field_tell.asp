...
<title>PHP mysqli_field_tell() Function</title>
<style>a.menu_func_mysqli_field_tell{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_field_tell()</span> Function</h1>
...
<p>Get field info for all fields, then get 
the current field with mysqli_field_tell() and print each column's 
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	<br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br><br>&nbsp; // Get 
	field info for all fields<br>&nbsp; while 
	($fieldinfo=mysqli_fetch_field($result))<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
	// Get field cursor position<br>&nbsp;&nbsp;&nbsp; 
	$currentfield=mysqli_field_tell($result);<br>&nbsp;&nbsp;&nbsp; <br>&nbsp;&nbsp;&nbsp; 
	printf(&quot;Column %d:\n&quot;, $currentfield);<br>&nbsp;&nbsp;&nbsp; printf(&quot;Name: 
	%s\n&quot;, $fieldinfo-&gt;name);<br>&nbsp;&nbsp;&nbsp; printf(&quot;Table: %s\n&quot;, 
	$fieldinfo-&gt;table);<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp; // Free result 
...
<p>The mysqli_field_tell() function returns the position of the field cursor.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_field_tell(<em>result</em>)<em>;</em></div></div>
<br>
...
<tr>
	...
	<td style="width:80%">Returns the current offset of the field cursor</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_field_tell.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_field_tell.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_field_tell.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
