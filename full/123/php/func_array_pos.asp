...
<title>PHP pos() Function</title>
<style>a.menu_func_array_pos{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">pos()</span> Function</h1>
...
<p>Output the value of the current element in an array:</p>
...
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_pos">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The pos() function returns the value of the current element in an array.</p>
<p>This function is an alias of the <a href="func_array_current.asp">current()</a> function.</p>
<p>Every array has an internal pointer to its &quot;current&quot; element, which is 
initialized to the first element inserted into the array. </p>

<p><b>Tip:</b> This function does not move the arrays internal pointer. </p>
<p>Related methods:</p>
<ul>
	...
	<li><a href="func_array_each.asp">each()</a> - returns the current element key and value, and moves the internal 
	pointer forward</li>
</ul>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns the value of the current element in an array, or FALSE on empty elements or elements with no value</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_pos.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_pos.asp#top" target="_top">TOP</a> |
		<a href="func_array_pos.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
