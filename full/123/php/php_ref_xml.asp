...
<style>a.menu_php_ref_xml{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">XML Parser</span> Functions</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="php_ref_string.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_ref_zip.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<h2>PHP XML Parser Introduction</h2>
<p>The XML functions lets you parse, but not validate, XML documents.</p>
<p>XML is a data format for standardized structured document exchange. More 
information on XML can be found in our 
<a target="_blank" href="../xml/default.asp">XML Tutorial</a>.</p>
<p>This extension uses the Expat XML parser.</p>
<p>Expat is an event-based parser, it views an XML document as a series of 
events. When an event occurs, it calls a specified function to handle it.</p>
<p>Expat is a non-validating parser, and ignores any DTDs linked to a document. 
However, if the document is not well formed it will end with an error message.</p>
<p>Because it is an event-based, non validating parser, Expat is fast and well 
suited for web applications.</p>
<p>The XML parser functions lets you create XML parsers and define handlers for XML 
events.</p>
<hr>

<h2>Installation</h2>
<p>The XML functions are part of the PHP core. There is no installation 
needed to use these functions.</p>
<hr>

<h2>PHP XML Parser Functions</h2>
...
<table class="reference notranslate">
  <tr>
    ...
    <th style="width:5%">PHP</th>
  </tr>
  <tr>
    <td><a href="func_xml_utf8_decode.asp">utf8_decode()</a></td>
    <td>Decodes an UTF-8 string to ISO-8859-1</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_utf8_encode.asp">utf8_encode()</a></td>
    <td>Encodes an ISO-8859-1 string to UTF-8</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_error_string.asp">xml_error_string()</a></td>
    <td>Gets an error string from the XML parser</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_get_current_byte_index.asp">xml_get_current_byte_index()</a></td>
    <td>Gets the current byte index from the XML parser</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_get_current_column_number.asp">xml_get_current_column_number()</a></td>
    <td>Gets the current column number from the XML parser</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_get_current_line_number.asp">xml_get_current_line_number()</a></td>
    <td>Gets the current line number from the XML parser</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_get_error_code.asp">xml_get_error_code()</a></td>
    <td>Gets an error code from the XML parser</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_parse.asp">xml_parse()</a></td>
    <td>Parses an XML document</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_parse_into_struct.asp">xml_parse_into_struct()</a></td>
    <td>Parse XML data into an array</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_xml_parser_create_ns.asp">xml_parser_create_ns()</a></td>
    <td>Create an XML parser with namespace support</td>
    <td>4</td>
  </tr>
	<tr>
    <td><a href="func_xml_parser_create.asp">xml_parser_create()</a></td>
    <td>Create an XML parser</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_parser_free.asp">xml_parser_free()</a></td>
    <td>Free an XML parser</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_parser_get_option.asp">xml_parser_get_option()</a></td>
    <td>Get options from an XML parser</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_parser_set_option.asp">xml_parser_set_option()</a></td>
    <td>Set options in an XML parser</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_character_data_handler.asp">xml_set_character_data_handler()</a></td>
    <td>Set handler function for character data</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_default_handler.asp">xml_set_default_handler()</a></td>
    <td>Set default handler function</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_element_handler.asp">xml_set_element_handler()</a></td>
    <td>Set handler function for start and end element of elements</td>
    <td>3</td>
  </tr>
	<tr>
    <td>xml_set_end_namespace_decl_handler()</td>
    <td>Set handler function for the end of namespace declarations</td>
    <td>4</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_external_entity_ref_handler.asp">xml_set_external_entity_ref_handler()</a></td>
    <td>Set handler function for external entities</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_notation_decl_handler.asp">xml_set_notation_decl_handler()</a></td>
    <td>Set handler function for notation declarations</td>
    <td>3</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_object.asp">xml_set_object()</a></td>
    <td>Use XML Parser within an object</td>
    <td>4</td>
  </tr>
	<tr>
    <td><a href="func_xml_set_processing_instruction_handler.asp">xml_set_processing_instruction_handler()</a></td>
    <td>Set handler function for processing instruction</td>
    <td>3</td>
  </tr>
	<tr>
    <td>xml_set_start_namespace_decl_handler()</td>
    <td>Set handler function for the start of namespace 
	declarations</td>
    <td>4</td>
  </tr>
  <tr>
    <td><a href="func_xml_set_unparsed_entity_decl_handler.asp">xml_set_unparsed_entity_decl_handler()</a></td>
    <td>Set handler function for unparsed entity declarations</td>
    <td>3</td>
  </tr>
  </table>
<br>
...
<h2>PHP XML Parser Constants</h2>
<table class="reference notranslate">
  <tr>
    <th>Constant</th>
  </tr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_ref_xml.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_ref_xml.asp#top" target="_top">TOP</a> |
		<a href="php_ref_xml.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
