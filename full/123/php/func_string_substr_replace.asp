...
<title>PHP substr_replace() Function</title>
<style>a.menu_func_string_substr_replace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">substr_replace()</span> Function</h1>
...
<p>Replace &quot;Hello&quot; with &quot;world&quot;:</p>
<div class="example_code notranslate">

&lt;?php<br>
echo substr_replace(&quot;Hello&quot;,&quot;world&quot;,0);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_replace">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The substr_replace() function replaces a part of a string with another string.</p>
<p><b>Note:</b> If the start parameter is a negative number and length is less than or equal 
to start, length becomes 0.</p>
...
substr_replace(<em>string,replacement,start,length</em>)
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>string</em></td>
    <td>Required. Specifies the string to check</td>
  </tr>
	<tr>
    <td><em>replacement</em></td>
    <td>Required. Specifies the string to insert</td>
  </tr>
	<tr>
    <td><em>start</em></td>
    <td>Required. Specifies where to start replacing in the string<ul>
		<li>A positive number - Start replacing at the specified position in the string</li>
		<li>Negative number - Start replacing at the specified position from the end of the string</li>
		<li>0 - Start replacing at the first character in the string</li>
	</ul>
		</td>
  </tr>
  <tr>
    <td><em>length</em></td>
    <td>Optional. Specifies how many characters should be replaced. 
	Default is the same length as the string.<ul>
		<li>A positive number - The length of string to be replaced</li>
		<li>A negative number - How many characters should be left at end of string 
		after replacing</li>
		<li>0 - Insert instead of replace</li>
	</ul>
	</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the replaced string. If the string is an array then 
	the array is returned</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 4.3.3, all parameters now accept arrays</td>
</tr>
</table>
<br>
...
<p>Start replacing at the 6th position in the string (replace &quot;world&quot; with 
&quot;earth&quot;):</p>
<div class="example_code notranslate">
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_replace2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>Start replacing at the 5th position from the end of the string (replace &quot;world&quot; with 
&quot;earth&quot;):</p>
<div class="example_code notranslate">
...
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_replace3">Run example &raquo;</a>
</div>
<br>
...
<p>Insert &quot;Hello&quot; at the beginning of &quot;world&quot;:</p>
<div class="example_code notranslate">

&lt;?php<br>
echo substr_replace(&quot;world&quot;,&quot;Hello &quot;,0,0);<br>
?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_replace4">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 4</h2>
<p>Replace multiple strings at once. Replace &quot;AAA&quot; in each string with &quot;BBB&quot;:</p>
<div class="example_code notranslate">

	&lt;?php<br>$replace = array(&quot;1: AAA&quot;,&quot;2: AAA&quot;,&quot;3: AAA&quot;);<br>echo implode(&quot;&lt;br&gt;&quot;,substr_replace($replace,'BBB',3,3));<br>
	?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_string_substr_replace5">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_string_substr_replace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_string_substr_replace.asp#top" target="_top">TOP</a> |
		<a href="func_string_substr_replace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
