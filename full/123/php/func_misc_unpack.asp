...
<title>PHP unpack() Function</title>
<style>a.menu_func_misc_unpack{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">unpack()</span> Function</h1>
<p><a href="php_ref_misc.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Misc Reference" /> PHP Misc Reference</a></p>

<div class="example">
<h2 class="example">Example</h2>
<p>Unpack data from a binary string:</p>
<div class="example_code notranslate">
	&lt;?php<br>$data = &quot;PHP&quot;;<br>
print_r(unpack(&quot;C*&quot;,$data));<br>
	?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_unpack">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The unpack() function unpacks data from a binary string.</p>
<hr>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><em>format</em></td>
    <td>Required. Specifies the format to use when packing data.<p>
	Possible values:</p>
	<ul>
		<li>a - NUL-padded string</li>
		<li>A - SPACE-padded string</li>
		<li>h - Hex string, low nibble first</li>
		<li>H - Hex string, high nibble first</li>
		<li>c - signed char</li>
		<li>C - unsigned char</li>
		<li>s - signed short (always 16 bit, machine byte order)</li>
		<li>S - unsigned short (always 16 bit, machine byte order)</li>
		<li>n - unsigned short (always 16 bit, big endian byte order)</li>
		<li>v - unsigned short (always 16 bit, little endian byte order)</li>
		<li>i - signed integer (machine dependent size and byte order)</li>
		<li>I - unsigned integer (machine dependent size and byte order)</li>
		<li>l - signed long (always 32 bit, machine byte order)</li>
		<li>L - unsigned long (always 32 bit, machine byte order)</li>
		<li>N - unsigned long (always 32 bit, big endian byte order)</li>
		<li>V - unsigned long (always 32 bit, little endian byte order)</li>
		<li>f - float (machine dependent size and representation)</li>
		<li>d - double (machine dependent size and representation)</li>
		<li>x - NUL byte</li>
		<li>X - Back up one byte</li>
		<li>Z - NUL-padded string</li>
		<li>@ - NUL-fill to absolute position </li>
	</ul>
	</td>
  </tr>
  <tr>
    <td>data</td>
    <td>Required. Specifies the binary data to be unpacked</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns an array on success, or FALSE on failure.</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	<th>Changelog:</th>
	<td>As of PHP 5.5.0, following changes were made for Perl compatibility:<br>
	<br>The &quot;a&quot; code now retains trailing NULL bytes.<br>The 
	&quot;A&quot; code now strips all trailing ASCII whitespace.<br>The &quot;Z&quot; code was added 
	for NULL-padded strings, and removes trailing NULL bytes.</td>
</tr>
</table>
<br>
<hr>
...
<div class="example_code notranslate">
	&lt;?php<br>$data = &quot;PHP&quot;;<br>
print_r(unpack(&quot;C*myint&quot;,$data));<br>
	?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_unpack2">Run example &raquo;</a>
</div>
<br>
...
<p>Unpack data:</p>
<div class="example_code notranslate">
	&lt;?php<br>$bin = pack(&quot;c2n2&quot;,0x1234,0x5678,65,66);<br>
print_r(unpack(&quot;c2chars/n2int&quot;,$bin));<br>
	?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_misc_unpack3">Run example &raquo;</a>
</div>
<br>
<hr>

<a href="php_ref_misc.asp"><img class="navup" src="http://www.w3schools.com/images/up.gif" alt="PHP Misc Reference" /> PHP Misc Reference</a>
				<hr />
				<!-- SmallPS -->
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_misc_unpack.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_misc_unpack.asp#top" target="_top">TOP</a> |
		<a href="func_misc_unpack.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
