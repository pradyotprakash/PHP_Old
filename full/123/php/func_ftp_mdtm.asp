...
<style>a.menu_func_ftp_mdtm{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">ftp_mdtm()</span> Function</h1>
...
<p>Get last modified time for a file on the FTP server:</p>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	= ftp_login($ftp_conn, $ftp_username, $ftp_userpass);<br><br>$file = &quot;somefile.txt&quot;;<br>
	<br>// get the last modified time<br>$lastchanged = ftp_mdtm($ftp_conn, 
	$file);<br>if ($lastchanged != -1)<br>&nbsp; {<br>&nbsp; echo &quot;$file was 
	last modified on : &quot; . date(&quot;F d Y H:i:s.&quot;,$lastchanged);<br>&nbsp; }<br>
	else<br>&nbsp; 
	{<br>&nbsp; echo &quot;Could not get last modified&quot;;<br>&nbsp; }<br>
...
<p>The ftp_mdtm() function returns when the specified file was last modified.</p>
<p><strong>Note:</strong> Not all servers support this function, and this 
function does not work on directories.</p>

<h2>Syntax</h2>
<div class="code notranslate"><div>
ftp_mdtm(<em>ftp_connection,file</em>);
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Required. Specifies the FTP connection to login to</td>
  </tr>
	<tr>
    <td><em>file</em></td>
...
<tr>
	...
	<td style="width:80%">Returns the last modified time as a Unix timestamp, or 
	-1 on error</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_ftp_mdtm.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_ftp_mdtm.asp#top" target="_top">TOP</a> |
		<a href="func_ftp_mdtm.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
