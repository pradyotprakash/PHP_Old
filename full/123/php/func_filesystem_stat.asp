...
<title>PHP stat() Function</title>
<style>a.menu_func_filesystem_stat{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">stat()</span> Function</h1>
<hr>
...
<p>The stat() function returns information about a file.</p>
...
<table class="reference notranslate">
  ...
  <tr>
    <td><i>filename</i></td>
    <td>Required. Specifies the path to the file</td>
  </tr>
  </table>
<br>
...
&lt;?php<br>
$stat = stat('test.txt');<br>
echo 'Acces time: ' .$stat['atime'];<br>
echo '&lt;br /&gt;Modification time: ' .$stat['mtime'];<br>
echo '&lt;br /&gt;Device number: ' .$stat['dev'];<br>
?&gt; 
...
Access time: 1141633430<br>
Modification time: 1141298003<br>
Device number: 0
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_filesystem_stat.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_filesystem_stat.asp#top" target="_top">TOP</a> |
		<a href="func_filesystem_stat.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
