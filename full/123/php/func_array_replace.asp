...
<title>PHP array_replace() Function</title>
<style>a.menu_func_array_replace{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">array_replace()</span> Function</h1>
...
<p>Replace the values of the first array ($a1) with the values from the second 
array ($a2):</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;red&quot;,&quot;green&quot;);<br>$a2=array(&quot;blue&quot;,&quot;yellow&quot;);<br>
	print_r(array_replace($a1,$a2));<br>
?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_replace">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The array_replace() function replaces the values of the first array with the 
values from following arrays.</p>
<p><b>Tip:</b> You can assign one array to the function, or as many as you like.</p>
<p>If a key from array1 exists in array2, values from array1 will be replaced by 
the values from array2. If the key only exists in array1, it will be left as it 
is (See Example 1 below).</p>
<p>If a key exist in array2 and not in array1, it will be created in array1 (See 
Example 2 below).</p>
<p>If multiple arrays are used, values from later arrays will overwrite the 
previous ones (See Example 3 below).</p>
<p><strong>Tip:</strong> Use <a href="func_array_replace_recursive.asp">array_replace_recursive()</a> to replace the values of array1 with the values 
from following arrays recursively.</p>
<hr>
<h2>Syntax</h2>
<div class="code notranslate"><div>
array_replace(<em>array1,array2,array3...</em>)
</div></div>
<br>
...
<table class="reference notranslate"> 
  ...
  <tr>
    <td><em>array2</em></td>
    <td>Optional. Specifies an array which will replace the values 
	of <em>array1</em></td>
  </tr>
  <tr>
    <td><em>array3,...</em></td>
    <td>Optional. Specifies more arrays to replace the values 
	of <em>array1 </em> and<em> array2, etc.</em> Values from later arrays will overwrite 
...
<tr>
	...
	<td style="width:80%">Returns the replaced array, or NULL if an error occurs</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.3.0+</td>
...
<p>If a key from array1 exists in array2, and if the key only exists in array1:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;b&quot;=&gt;&quot;green&quot;);<br>$a2=array(&quot;a&quot;=&gt;&quot;orange&quot;,&quot;burgundy&quot;);<br>
	print_r(array_replace($a1,$a2));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_replace2">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 2</h2>
<p>If a key exists in array2 and not in array1:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;a&quot;=&gt;&quot;red&quot;,&quot;green&quot;);<br>$a2=array(&quot;a&quot;=&gt;&quot;orange&quot;,&quot;b&quot;=&gt;&quot;burgundy&quot;);<br>
	print_r(array_replace($a1,$a2));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_replace3">Run example &raquo;</a>
</div>

<br>
<div class="example">
<h2 class="example">Example 3</h2>
<p>Using three arrays - the last array ($a3) will overwrite the previous ones 
($a1 and $a2):</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;red&quot;,&quot;green&quot;);<br>$a2=array(&quot;blue&quot;,&quot;yellow&quot;);<br>$a3=array(&quot;orange&quot;,&quot;burgundy&quot;);<br>
	print_r(array_replace($a1,$a2,$a3));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_replace4">Run example &raquo;</a>
</div>
<br>

<div class="example">
<h2 class="example">Example 4</h2>
<p>Using numeric keys - If a key exists in array2 and not in array1:</p>
<div class="example_code notranslate">
&lt;?php<br>
	$a1=array(&quot;red&quot;,&quot;green&quot;,&quot;blue&quot;,&quot;yellow&quot;);<br>
	$a2=array(0=&gt;&quot;orange&quot;,3=&gt;&quot;burgundy&quot;);<br>print_r(array_replace($a1,$a2));<br>?&gt;
</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_func_array_replace5">Run example &raquo;</a>
</div>
<br>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_array_replace.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_array_replace.asp#top" target="_top">TOP</a> |
		<a href="func_array_replace.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
