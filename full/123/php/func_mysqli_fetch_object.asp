...
<title>PHP mysqli_fetch_object() Function</title>
<style>a.menu_func_mysqli_fetch_object{font-weight:bold;}</style>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">mysqli_fetch_object()</span> Function</h1>
...
<p>Return the current row of a result set, then print each field's value:</p>
...
&nbsp;&nbsp;}<br><br>$sql=&quot;SELECT Lastname,Age FROM Persons ORDER BY Lastname&quot;;<br>
	<br>if ($result=mysqli_query($con,$sql))<br>&nbsp; {<br>&nbsp; while 
	($obj=mysqli_fetch_object($result))<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
	printf(&quot;%s (%s)\n&quot;,$obj-&gt;Lastname,$obj-&gt;Age);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; // Free result 
...
<p>The mysqli_fetch_object() function returns the current row of a result set, as an object.</p>
<p><strong>Note:</strong> Fieldnames returned from this function are case-sensitive.</p>
<hr>

<h2>Syntax</h2>
<div class="code notranslate"><div>
mysqli_fetch_object(<em>result,classname,params</em>)<em>;</em></div></div>
<br>
<table class="reference notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. Specifies the name of the class to instantiate, set the 
	properties of, and return</td>
  </tr>
  <tr>
    <td><em>params</em></td>
    <td>Optional. Specifies an array of parameters to pass to the constructor 
	for <em>classname</em> objects</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns an object with string properties for the fetched 
	row. NULL if there are no more rows in the result set</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5+</td>
...
<tr>
	<th>Changelog:</th>
	<td>The ability to return as a different object was added in PHP 5.0.0</td>
</tr>
</table>
<br>
<hr>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="func_mysqli_fetch_object.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="func_mysqli_fetch_object.asp#top" target="_top">TOP</a> |
		<a href="func_mysqli_fetch_object.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
