...
<style>a.menu_php_datatypes{font-weight:bold;}</style>
<meta charset="utf-8">
...
<div class="chapter">
<div class="prev"><a class="chapter" href="php_echo_print.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="php_string.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">String, Integer, Floating point numbers, Boolean, Array, Object, NULL.<br>
</p>
<hr>
...
<div class="example_code notranslate">
	&lt;?php <br>$x = &quot;Hello world!&quot;;<br>echo $x;<br>echo &quot;&lt;br&gt;&quot;; <br>$x = 
	'Hello world!';<br>echo $x;<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_datatypes_string">Run example &raquo;</a></div>
<br>
<hr>
...
<ul>
	...
	<li>Integers can be specified in three formats: decimal (10-based), 
	hexadecimal (16-based - prefixed with 0x) or octal (8-based - prefixed with 0)</li>
</ul>
<p>In the following example we will test different numbers. The PHP var_dump() 
function returns the data type and value of variables:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php <br>$x = 5985;<br>var_dump($x);<br>echo &quot;&lt;br&gt;&quot;; <br>$x = 
	-345; // negative number <br>var_dump($x);<br>echo &quot;&lt;br&gt;&quot;; <br>$x = 0x8C; // 
	hexadecimal number<br>var_dump($x);<br>echo &quot;&lt;br&gt;&quot;;<br>$x = 047; // octal 
	number<br>var_dump($x);<br>?&gt;</div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_datatypes_integer">Run example &raquo;</a></div>
<br>
<hr>

<h2>PHP Floating Point Numbers</h2>
<p>A floating point number is a number with a decimal point or a number in exponential form.</p>
<p>In the following example we will test different numbers. The PHP var_dump() 
function returns the data type and value of variables:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php <br>$x = 10.365;<br>var_dump($x);<br>echo &quot;&lt;br&gt;&quot;; <br>$x 
	= 2.4e3;<br>var_dump($x);<br>echo &quot;&lt;br&gt;&quot;; <br>$x = 8E-5;<br>var_dump($x);<br>
	?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_datatypes_float">Run example &raquo;</a></div>
<br>
<hr>
...
<div>
	$x=true;<br>
	$y=false;</div></div>
<p>Booleans are often used in conditional testing. You will learn more about 
conditional testing in a later chapter of this tutorial.</p>
<hr>

<h2>PHP Arrays</h2>
<p>An array stores multiple values in one single variable.</p>
<p>In the following example we create an array, and then use the PHP var_dump() 
function to return the data type and value of the array:</p>
<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php <br>$cars=array(&quot;Volvo&quot;,&quot;BMW&quot;,&quot;Toyota&quot;);<br>var_dump($cars);<br>
	?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_datatypes_array">Run example &raquo;</a></div>
...
<p>First we must declare a class of object. For this, we use the class keyword. 
A class is a structure that can contain properties and methods.</p>
<p>We then define the data type in the object class, and then we use the data type in instances of that class:</p>

<div class="example">
<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>class Car<br>{<br>&nbsp; var $color;<br>&nbsp; function 
	Car($color=&quot;green&quot;) <br>&nbsp; {<br>&nbsp;&nbsp;&nbsp; $this-&gt;color = 
	$color;<br>&nbsp; }<br>&nbsp; function what_color() <br>&nbsp; {<br>&nbsp;&nbsp;&nbsp; 
	return $this-&gt;color;<br>&nbsp; }<br>}<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_datatypes_object">Run example &raquo;</a></div>

<p>You will learn more about objects in a later chapter of this tutorial.</p>
<hr>

<h2>PHP NULL Value</h2>
<p>The special NULL value represents that a variable has no value. NULL is the 
only possible value of data type NULL.</p>
<p>The NULL value identifies whether a variable is empty or not. Also useful to 
differentiate between the empty string and null values of databases.</p>
<p>Variables can be emptied by setting the value to NULL:</p>
<div class="example">
	<h2 class="example">Example</h2>
<div class="example_code notranslate">
	&lt;?php<br>$x=&quot;Hello world!&quot;;<br>$x=null;<br>var_dump($x);<br>?&gt; </div>
<br><a target="_blank" class="showbtn" href="showphp.asp?filename=demo_datatypes_null">Run example &raquo;</a></div>
...
<div class="footer">
	...
	<div id="footerAbout">
		<a href="php_datatypes.asp" onclick="displayError();return false" style="word-spacing:normal;">REPORT ERROR</a> |
		<a href="../default.asp" target="_top">HOME</a> |
		<a href="php_datatypes.asp#top" target="_top">TOP</a> |
		<a href="php_datatypes.asp" target="_blank" onclick="printPage();return false">PRINT</a> |
